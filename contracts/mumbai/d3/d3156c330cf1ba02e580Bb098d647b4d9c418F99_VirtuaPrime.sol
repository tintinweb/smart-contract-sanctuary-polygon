...
contract VirtuaPrime is ERC721Tradable{
       ...
       constructor(address eventContract) ERC721Tradable("Land-VMZ", "VMZ",0x1E0049783F008A0085193E00003D00cd54003c71,"https://assetsmeta.bimtvist.com/monsterzone/", 0x1536EF5C6172C8a34c640F527e0cF674aA4DC82D, 500, eventContract) {
    }
...
contract ERC721PresetMinterPauserAutoId is Context, ERC721Enumerable, ERC721Burnable, ERC721Pausable, ERC2981 {
    ...
    //royalty info
    // address private _royaltyReciver = 0x48911a18E9CF6E14B00946db8c14fcCC0005F018;
    // uint96  private _feeNumerator = 500;// 5%
    ...
    function mint(address to, uint256 tokenId) public virtual {
        ...
        _mint(to, tokenId);
        // _setTokenRoyalty(tokenId, _royaltyReciver, _feeNumerator);
    }
