...
contract Mint_Callback_Friend_Borealis is ERC721Enumerable, Ownable {
    using Strings for uint256;

    address constant server_address =
        0xe73dCcC485A1feA5AE623Dfb5c0137e1662E74D6;

    constructor() ERC721("Callback Friend Borealis", "CFB") Ownable() {}

    mapping(uint256 => string) private _tokenURIs;
    uint256 private counter = 0;
    uint256 private max_quantity = 50;
