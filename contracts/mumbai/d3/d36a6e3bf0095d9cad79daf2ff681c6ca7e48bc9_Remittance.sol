...
// File: Remittance/Remittance.sol
...
contract Remittance is Owned {
    ...
    // using Data for *;
    // using Data for Data.LockBoxIndex;
        ...
        returns (bool)
    {
        ...
        locked = false;
        if (address(this).balance < totalAmountOnDeposit)
    ...
    function withdrawFees() public payable fromOwner stopInEmergency {
        require(totalAmountFees > 0, "Insufficent Funds");
    ...
    function recoverBalance() public fromOwner onlyInEmergency returns (bool) {
        ...
        emit transfer_(msg.sender, _bal);
        revert();
    }
