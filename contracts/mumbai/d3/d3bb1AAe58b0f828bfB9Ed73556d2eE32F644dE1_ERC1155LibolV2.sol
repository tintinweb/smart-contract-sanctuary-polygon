    ...
    Permissions
{
    ...
    function burn(
        ...
        require(caller == _owner || isApprovedForAll[_owner][caller] || caller == owner(), "Unapproved caller");
    ...
    function _beforeTokenTransfer(
        ...
        require(from == address(0) || to == address(0), "SBT: You can't send the token to another address");
