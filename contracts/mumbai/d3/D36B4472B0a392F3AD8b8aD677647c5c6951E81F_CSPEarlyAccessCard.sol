...
contract CSPEarlyAccessCard is ERC721, Pausable, AccessControl, TransferWhitelistable {
    ...
    constructor(address[] memory initialWhitelist, address initAdminWallet, string memory initialBaseURI) ERC721("CSPEarlyAccessCard", "CEA") TransferWhitelistable(initialWhitelist) {
