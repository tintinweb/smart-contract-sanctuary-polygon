...
/**
     * @dev Creates a new token for `voter`. Its token ID will be automatically
     * assigned (and available on the emitted {IERC721-Transfer} event), and the token
     * URI autogenerated based on the base URI passed at construction.
     *
     * See {ERC721-_safeMint}.
     ...
     */
    function delegateReviewCreation(string memory category, string memory domainAddress, string memory siteURL, string memory siteType, string memory siteTag, string memory siteSafety, string memory metadataURI, address voter) public nonReentrant onlyRole(NETSEPIO_MODERATOR_ROLE) {
