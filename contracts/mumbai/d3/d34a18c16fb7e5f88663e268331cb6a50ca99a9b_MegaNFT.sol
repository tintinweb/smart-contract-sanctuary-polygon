...
// File: contracts/Copy_MegaNFT.sol
...
// https://megafans.mypinata.cloud/ipfs/QmXG4j7CkuCCTsGzAzeyFhXm2TP1TpFhhf6PPiMgLMUFCo/
...
contract MegaNFT is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor(
        ...
        baseTokenURI = "https://megafans.mypinata.cloud/ipfs/QmXG4j7CkuCCTsGzAzeyFhXm2TP1TpFhhf6PPiMgLMUFCo/";
    }
    ...
    function internalMint(address _to, uint256 num) public onlyOwner {
        require(!contractPaused, "Sale Paused!");
        require(totalSupply() + num <= maxSupply, "Max supply reached!");
