...
contract Stakeable is IERC721Receiver, Ownable, ReentrancyGuard {
    ...
    IERC20 public rewardToken = IERC20(0xdB158dCD8689e6aa924B866a18d4D285621D9Ec4);
    address public erc721Contract = 0x31030Daf8e8F7D6862f191BbF9dB2Cafaf52F58A;
    IERC721 public stakeableNFT = IERC721(erc721Contract);
    ...
    function onERC721Received(address _op, address _from, uint256 _token, bytes memory) public virtual override returns (bytes4) {
        ...
        staking.rentalFee = 0; //not needed for most projects
        staking.coffer = 0;

        nftByID[_token] = staking;
        nftByOwner[_op].push(_token);
    ...
    function receiveReward(uint256 _tokenID) nonReentrant public {
        uint earned = checkWork(_tokenID) + nftByID[_tokenID].coffer;
