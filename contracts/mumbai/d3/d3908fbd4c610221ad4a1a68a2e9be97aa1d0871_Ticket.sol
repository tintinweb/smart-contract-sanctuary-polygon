...
// File contracts/TicketContract.sol
...
contract Ticket is ERC721A {
    ...
    address public smartTixAddress;
    ...
    function setBaseURI(string memory _newBaseURI) external {
        require(msg.sender == smartTixAddress);
        require(
    ...
    function withdrawFunds() external {
        ...
        (bool s2, ) = smartTixAddress.call{value: smartTixFee}("");
        require(s2);
    }
}