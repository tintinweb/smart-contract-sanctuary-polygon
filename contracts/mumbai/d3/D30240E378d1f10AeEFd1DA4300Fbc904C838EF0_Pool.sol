...
// File contracts/interfaces/IPoolActions.sol
...
// File contracts/interfaces/IPoolEvents.sol
...
// File contracts/interfaces/IMintCallback.sol
...
SwapData public swapDataPublic;
bool public willUpTickPublic;
uint160 public limitSqrtPPublic;
  modifier lock() {
  ...
  function swap(
    ...
    swapDataPublic = swapData;
    willUpTickPublic = willUpTick;
    limitSqrtPPublic = limitSqrtP;
    // verify limitSqrtP
    if (willUpTick) {
      require(
