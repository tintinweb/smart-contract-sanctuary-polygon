...
import {ForjClaimLogic} from "contracts/utils/ForjClaimLogic.sol";
import {Strings} from "@openzeppelin/contracts/utils/Strings.sol";

contract ERC1155SBTClaim is ForjClaimLogic {
    ...
    function initialize(
        ...
        _treasuryInitialize(msg.sender, _multisig, _treasuryWallet);
        _claimInitialize(_merkleRoot, _startTimestamp, _endTimestamp, _claimIds);
...
import "./ERC1155SBTClaim.sol";
import "./utils/ForjFactoryEvents.sol";

contract ERC1155SBTClaimFactory is ForjFactoryEvents {
    function createTemplate(
        ...
        ERC1155SBTClaim clone = new ERC1155SBTClaim();
        clone.initialize(
            _multisig,
            _treasuryWallet,
            _baseURI,
        ...
        clone.transferOwnership(_multisig);
        emit TemplateCreated(address(clone), "ERC1155SBTClaim");
    }
}
...
contract ForjFactoryEvents {
    event TemplateCreated(address addr, string nameTemplate);
}
