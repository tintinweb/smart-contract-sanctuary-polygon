...
contract m3taDao is 
    ...
    Im3taProject private m3taProjectContract;
    ...
    function initialize(Im3taQuery initQueryContract, Im3taProject initM3taProjectContract )
        public
        initializer
    {
        
        queryContract = initQueryContract;
        m3taProjectContract = initM3taProjectContract;
        __Ownable_init();
...
interface Im3taProject  {

    function createLensProfile(DataTypes.ProfileTableStruct memory vars) external;

    function createProjectAccount(DataTypes.AccountStruct memory vars) external payable;

    function createSubProject(DataTypes.ProjectStruct memory vars) external payable;

    function createRelease(DataTypes.ReleaseStruct memory vars) external payable;

    function updateAccountMetadata(uint _accountID, string calldata _metaURI) external;

    function updateProjectMetadata(uint _projectID, string calldata _metaURI) external;

    function getProjectTableURI() external view returns ( string memory);
