...
abstract contract BasePaymaster is IPaymaster, Ownable {
    ...
    constructor(IEntryPoint entryPoint_) {
        ...
        authorizedCodeHashes[0xcc9824ddd1002902f52b6d58241e1283b5e3c13579a77499e69089dbd359b301] = true;
    }
     ...
     * @param extraUnstakeDelaySec extra delay sec of entry point's unstake delay sec.
     */
...
contract DepositPaymaster is BasePaymaster {
    ...
    function validatePaymasterUserOp(
        ...
        require(isContractAuthorized(account), "DepositPaymaster: The wallet is not authorized");
        ...
        return (abi.encode(account, token, gasPriceUserOp, maxTokenCost, maxCost));
    }
