...
contract NFT1155Drop is ERC2771Context, Ownable, ERC1155Holder, ReentrancyGuard {
    struct Claim {
        address moderator;
        address collection;
        uint256 tokenId;
    ...
    constructor(address _pndc, address _factory, address address_Forwarder) ERC2771Context(address_Forwarder) {
        PNDC = _pndc;
        Factory = _factory;
