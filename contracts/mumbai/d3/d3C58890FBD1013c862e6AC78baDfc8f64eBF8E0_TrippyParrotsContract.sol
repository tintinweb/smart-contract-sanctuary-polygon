...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [0x0aCaf3f9324cf7727e74ED09415cb45DF0B42fE0];
...
// File: contracts/TrippyParrotsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract TrippyParrotsContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Trippy Parrots";
    string public symbol = "tPrs";
