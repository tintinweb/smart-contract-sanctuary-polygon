...
contract CrednetialNFT is ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("Credential NFT", "GatewayNFT") {}

    /**
     * @dev A method to mint NFT
     * 		Mint is allowed only once for the same user.
    ...
    function mint(address to, string memory _tokenURI) external virtual {
        // require(mintCounter[to] == 0, "Not allowed to mint than ONCE.");
