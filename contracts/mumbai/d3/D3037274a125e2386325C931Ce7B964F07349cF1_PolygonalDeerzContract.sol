...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x6033662Cb88964dEd75C0D5A0c88E9A968Dc56de];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 30, 100 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmaiLS2ZFRcXF4navc8Z3y47TWEhLfaZSf3joYUh3vpr5H/";
...
// File: contracts/PolygonalDeerzContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PolygonalDeerzContract is RamppERC721A {
    constructor() RamppERC721A("PolygonalDeerz", "POLYZ"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/HdeCd3lFZK2WE1NxJdB3/contract-metadata";
    }
}