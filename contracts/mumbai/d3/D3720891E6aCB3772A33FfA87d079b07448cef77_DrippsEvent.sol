...
abstract contract EventQuote is OwnableUpgradeable {
	  ...
	  address private _quote;
		...
		/**
     * @dev Sets the value of the `quote` address.
     */
    ...
    /**
     * @dev Returns the value of the `quote` address.
     */
...
ERC721BurnableUpgradeable, EventStarts, EventEnds, EventPlace, EventLatitude, EventLongtitude,
EventPrice, EventQuote, EventCanceled {
    ...
    function safeMint(address to, string memory uri)
				...
				whenNotPaused
		{
				...
				if (price() > 0) {
					uint balance = quote() == 0x0000000000000000000000000000000000000000 ?
					msg.sender.balance:
					IERC20(quote()).balanceOf(msg.sender);
					require(msg.sender == owner() || balance >= price(), "DrippsEvent: insufficient balance");
				}
