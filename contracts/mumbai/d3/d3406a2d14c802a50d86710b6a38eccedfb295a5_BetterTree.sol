...
contract BetterTree is  ReentrancyGuard, ERC721Enumerable, Ownable{
    ...
    address public vrf = 0xF51986Be66AceC5bb671feC00503e877f66006B6;
    ...
    modifier isMinter(){
        require(_msgSender() == minter, "Non-minter");
        _;
    }
    ...
    function _minting(address _user,  uint8 _cause, uint256 _treeValue)internal{
            ...
            IVRF(vrf).requestRandomWords(tokenId, address(this), _treeValue);
    ...
    modifier isPollen(){
        ...
        require(_msgSender() == pollinator, "Error: Pollinators only");
        _;
