 ...
 */
    ...
    function turnWheel(address tokenAddress, uint amount) public isNotInBlackList(msg.sender) {
        ...
        if (tokenAmount[tokenAddress] >= award) {
            ...
            tokenAmount[tokenAddress] -= award;
            ...
            tokenAmount[outTokenAddress] -= amount;
        }
 ...
 */
     ...
     */
    function rand(uint max) public view returns(uint256)
    {
     ...
     */
    function randomExchangeRate() public view returns (uint) {
