...
interface IMagpieTokenManager {
    ...
    function getDepositInfo(uint256 toChainId, address tokenAddress) external view returns (TokenConfig memory); /* getDepositInfo */

    function getTransferInfo(address tokenAddress) external view returns (TokenConfig memory); /* getTransferInfo */
}
