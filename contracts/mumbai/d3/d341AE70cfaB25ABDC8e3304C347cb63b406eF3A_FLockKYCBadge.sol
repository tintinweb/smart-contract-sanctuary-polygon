...
import "./interfaces/IERC721ASoulbound.sol";

contract FLockKYCBadge is ERC721A, ERC721ABurnable, IERC721ASoulbound, Ownable {
    ...
    function mint(
        ...
        require(!hashes[_mintHash], "Mint hash already existent");
        require(
            _verify(_hash(msg.sender, _mintHash), _signature),
            "Invalid signature"
        );

        hashes[_mintHash] = true;
