...
contract CERTOKEN is ERC721URIStorage, Ownable {
    ...
    //     require(owner() == msg.sender || isApprovedForAll(owner(), msg.sender), "CERTOKEN: Only contract owner or approved address can call this function");
    //     _;
    // }

    // function transferNFT(address to, uint256 tokenId) public onlyContractOwner {
