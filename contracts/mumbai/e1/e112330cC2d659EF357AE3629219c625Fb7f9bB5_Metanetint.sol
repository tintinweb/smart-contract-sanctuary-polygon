...
contract Metanetint is ERC20, ERC20Burnable {
    ...
    // mapping(uint => uint) public allProposal;
    ...
    function withdrawUserVote(uint _proposalId) public {
        ...
        // transferFrom(address(this), address(userVote.wallet), amount);
    ...
    function withdrawCreatorVote(uint _proposalId) public {
        ...
        _mint(
            allProposal[_proposalId].depositWallet,
    ...
    function _calcValidProposal(uint _proposalId) private {
        ...
        // require(allProposal[_proposalId].expiryDate > block.timestamp , 'proposal expiry date');
        if (allProposal[_proposalId].expiryDate > block.timestamp) {
            ...
            // uint t = (totalSupply() * 10) / 100;
            // if (
            //     yesCount + noCount > t &&
            //     ((yesCount / (yesCount + noCount)) * 100) > 60
            // ) {
