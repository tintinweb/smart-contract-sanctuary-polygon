...
contract KiteFighter is ERC721, Ownable, ReentrancyGuard, BaseRelayRecipient {
  ...
  function getSnapshot() public view returns (address[] memory) {
    // TODO implement this function to return array of current Gen0 holders
    // Any changes to the function signature must be reflected in the KiteComponent contract at line 8
