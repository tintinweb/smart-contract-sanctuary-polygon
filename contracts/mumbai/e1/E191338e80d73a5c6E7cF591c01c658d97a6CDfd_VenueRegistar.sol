...
interface IVenueRegistar {
    ...
    function setTokenCreator(address tokenCreator, bool admit) external;
...
contract SuperOwnerUpgradable is OwnableUpgradeable {
    ...
    function __SuperOwner_init(address superOwner_, address owner) internal onlyInitializing {
...
import "./SuperOwnerUpgradable.sol";
    ...
    ERC165
{
    ...
    mapping(address => bool) public isTokenCreator; //EOAs which can mint on behalf of stripe credit card payment
    ...
    function initialize(
        ...
        price = publicPrice;
        isTokenCreator[tokenCreator_] = true;
        __SuperOwner_init(superOwner, owner);
    ...
    /// @inheritdoc IVenueRegistar
    function setTokenCreator(address tokenCreator, bool admit) external virtual override onlyOwner {
        isTokenCreator[tokenCreator] = admit;
    }
