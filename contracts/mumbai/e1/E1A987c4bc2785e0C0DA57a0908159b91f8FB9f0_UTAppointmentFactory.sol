...
contract UTAppointmentFactory is Ownable, BlackHolePrevention {
    ...
    uint256     public constant     version              = 20230510;

    uint8       public constant     traitType            = 4;            // Appointment
    ...
    function addTrait(
        ...
        require(
            crAddr != address(0),
            "UTAppointmentFactory: Invalid community ID"
        );
        ...
        require(
            ERC721 != address(0),
            "UTAppointmentFactory: Token not installed"
        );
