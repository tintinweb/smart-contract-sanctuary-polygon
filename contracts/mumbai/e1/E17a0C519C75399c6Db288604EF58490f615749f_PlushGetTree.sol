...
contract PlushGetTree is Ownable {
    ...
    function mint(address _mintAddress, uint256 _amount, string memory _type) public {
        ...
        require(plushController.getWalletAmountTrans(msg.sender) >= _amount, "Not enough balance.");
...
contract PlushController is Ownable {
    ...
    function getWalletAmountTrans(address _address) external view returns(uint256)
    {
        return plushCoinWallets.getWalletAmount(_address);
    }
}
