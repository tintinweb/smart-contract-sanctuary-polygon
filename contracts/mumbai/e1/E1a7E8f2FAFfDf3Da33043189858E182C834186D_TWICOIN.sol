...
abstract contract TIP is ContractTools, ERC20 {
  ...
  uint8 private constant TIP_MIN_LENGTH = 8;
  uint8 private constant TIP_MAX_LENGTH = 30;
...
contract TWICOIN is ITWICOIN, VERIFY, TIP{
  ...
  uint8 private twiUserNameMinLength = 4;
  uint8 private twiUserNameMaxLength = 15;
  ...
  uint256 constant SEC_PER_DAY = 86400;
    ...
    function setVerifyConfig(
        ...
        uint8 twiUserNameMinLength_,
        uint8 twiUserNameMaxLength_) public virtual onlyOwner{
...
abstract contract ContractTools{
    ...
    modifier _isStrValid(string memory str,uint8 minLength,uint8 maxLength,bool notAllNum) {
