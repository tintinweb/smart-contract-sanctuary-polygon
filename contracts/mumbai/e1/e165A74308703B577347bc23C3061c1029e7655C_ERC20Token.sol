...
/**
 * @dev ERC20Token implementation with Mint, Cap, AntiWhale capabilities
 */
contract ERC20Token is ERC20Base, AntiWhaleToken, ERC20Mintable, ERC20Capped, Ownable, FeeProcessor {
    ...
    constructor(
        ...
        FeeProcessor(feeReceiver_, 0xe9dd1a7059f12d1972e75a7e2d8f43bfc942b2ade63270e9ba41da72a4fa5c5c)
    {
