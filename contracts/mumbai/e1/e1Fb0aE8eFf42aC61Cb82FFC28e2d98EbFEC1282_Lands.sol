...
contract Lands is ERC1155('Lands'), ERC1155Burnable, ERC1155Supply, ERC1155Pausable, Ownable {
	using Strings for uint256;
	string public name = 'Lands';
	...
	function uri(uint256 id) public view override returns (string memory) {
		return string(abi.encodePacked(uriPrefix, id.toString(), uriSuffix));
	}
}