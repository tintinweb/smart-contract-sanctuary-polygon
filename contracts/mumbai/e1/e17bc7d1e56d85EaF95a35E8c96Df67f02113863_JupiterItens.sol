...
contract JupiterItens is ERC1155, SimpleAccessControl 
{
    ...
    constructor() public ERC1155("https://webazaar-meta-api.herokuapp.com/detail/{id}")
    {
        _contractURI = "https://webazaar-meta-api.herokuapp.com";
        name = "Bazaar ERC1155 Collection";
        mint(5);
        mint(1);
        mint(5);
        mint(10);
