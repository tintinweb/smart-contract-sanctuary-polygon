...
import {IFootEarnMarketPlace} from "./interfaces/IFootEarnMarketPlace.sol";

import {FEN} from "./FEN.sol";
import {FootEarn} from "./FootEarn.sol";

import {OrderTypes} from "./libraries/OrderTypes.sol";
import {SignatureChecker} from "./libraries/SignatureChecker.sol";

contract FootEarnMarketPlace is IFootEarnMarketPlace, ReentrancyGuard, Ownable {
    using SafeERC20 for IERC20;

    using OrderTypes for OrderTypes.MakerOrder;
    using OrderTypes for OrderTypes.TakerOrder;

    address public immutable FEN_ADDRESS;
    address public immutable FACTORY_NFT;
    ...
    constructor(
        ...
        DOMAIN_SEPARATOR = keccak256(
            abi.encode(
                ...
                0xbf8549c8c1dba3bb6ad96820aaa66c0ebbdfe0e24b0231629337d3289a155599, // keccak256("FootEarnMarketPlace")
    ...
    function matchAskWithTakerBid(
        ...
        (bool isExecutionValid, uint256 tokenId) = canExecuteTakerBid(
            takerBid,
            makerAsk
        );
        ...
        // Execution part 2/2
        _transferNonFungibleToken(makerAsk.signer, takerBid.taker, tokenId);
    ...
    function _transferNonFungibleToken(
        ...
        require(
            FootEarn(FACTORY_NFT).ownerOf(tokenId) == from,
            "Transfer: Not owner"
        );

        // If one is found, transfer the token
        FootEarn(FACTORY_NFT).safeTransferFrom(from, to, tokenId);
    }
    ...
    function _validateOrder(
        ...
        require(
            makerOrder.currency == FEN_ADDRESS,
