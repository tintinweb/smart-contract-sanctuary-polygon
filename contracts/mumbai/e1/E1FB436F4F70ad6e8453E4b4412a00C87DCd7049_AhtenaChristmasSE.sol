...
// File: contracts/AhtenaChristmas.sol
...
contract AhtenaChristmasSE is ERC721A, ERC2981, OperatorFilterer, Ownable {
    using ECDSA for bytes32;
    
    bool public operatorFilteringEnabled;
    mapping(bytes4 => bool) public functionLocked;

    uint256 MAX_MINTS = 300;
    uint256 MAX_SUPPLY = 300;
    ...
    constructor(
       ...
       ERC721A("ATHENA RETURNS SE", "ARS")
       
    {
       setHiddenMetadataUri("https://storage.googleapis.com/athenareturns/special_edition/2022Christmas/");
    ...
    returns (uint256[] memory)
  {
    ...
    while (ownedTokenIndex < ownerTokenCount && currentTokenId <= MAX_MINTS) {
