...
// Sources flattened with hardhat v2.12.0-esm.1 https://hardhat.org
...
library Strings {
    ...
    function toHexString(uint256 value, uint256 length) internal pure returns (string memory) {
        ...
        require(value == 0, "Strings: hex length insuf.");
        return string(buffer);
    }
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        ...
        require(to != owner, "ERC721: Invalid owner");

        require(_msgSender() == owner || isApprovedForAll(owner, _msgSender()), "ERC721: Approval error");
    ...
    function transferFrom(address from, address to, uint256 tokenId) public virtual override {
        ...
        require(_isApprovedOrOwner(_msgSender(), tokenId), "ERC721: Approval error");
    ...
    function _transfer(address from, address to, uint256 tokenId) internal virtual {
        require(ERC721.ownerOf(tokenId) == from, "ERC721: Invalid owner");
...
abstract contract ERC721Enumerable is ERC721, IERC721Enumerable {
    ...
    function tokenOfOwnerByIndex(address owner, uint256 index) public view virtual override returns (uint256) {
        require(index < ERC721.balanceOf(owner), "ERC721Enum: index out of bounds");
    ...
    function tokenByIndex(uint256 index) public view virtual override returns (uint256) {
        require(index < ERC721Enumerable.totalSupply(), "ERC721Enum: index out of bounds");
    ...
    function _beforeTokenTransfer(
        ...
        if (batchSize > 1) {
            ...
            revert("ERC721Enum: not supported");
        }
...
// File contracts/Catcontract.sol
...
// File contracts/interface/ICatMarketplace.sol
...
// File contracts/CatMarketplace.sol
...
uint256 fee = offer.price * 10 / 100;
uint256 priceToSeller = offer.price - fee;

offer.seller.transfer(priceToSeller);
