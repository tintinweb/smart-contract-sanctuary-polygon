 ...
 * @notice This contract handles minting Check-Hash-At The Players tokens.
 */
contract CheckHashAtThePlayers is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xD3879d0351e45ef6c7552114A90B67005316210c;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xF6408691b273BD06Ba445aa3251Eced67b79863F;
    ...
    address[] public payoutAddresses = [
        0xF6408691b273BD06Ba445aa3251Eced67b79863F
    ];
    ...
    string public name = "Check-Hash-At The Players";
    string public symbol = "CHAPLRS";
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeiatm6myor6rkkep3ywxkcpxpyiga74gmip452awip5vat3iznytcq/{id}"
        )
        RevokableOperatorFilterer(
