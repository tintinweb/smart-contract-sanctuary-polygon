...
contract ChubbyApeLogic is Ownable {
    ...
    ////////////////Whitelist Start////////////////
    uint8 public WhitelistAmountLimit = 50;
    ...
    function GetMATICPrice() public view returns (uint256) {
        //Mainnet ETH / USD 0xF9680D99D6C9589e2a93a78A04A279e509205945
        //Mumbai ETH / USD 0x0715A7794a1dc8e42615F059dD6e406A6594651A
    ...
    function WhitelistMintByMATIC(
        ...
        require(_amount > 0 && _amount <= WhitelistAmountLimit); //Check _amount
        require(
            msg.value >=
        ...
        require(_amount <= WhitelistAmountLimit); //Check AmountLimit
    ...
    ///#region FreeMint
    //Pubilc FreeMint
    function FreeMint(uint16 _amount) public {
        require(isSaleActive(4)); //FreeMint period check
        require(
            (_amount + _FreeMintSetting.Minted) <= _FreeMintSetting.TotalSupply,
            "limit is exceed"
        ); //Check FreeMint TotalSupply
        require(
            ChubbyAPE.balanceOf(msg.sender) < FreeMintPerLimit,
            "You cannot buy more"
        ); //ChubbyAPE limit
        require(
