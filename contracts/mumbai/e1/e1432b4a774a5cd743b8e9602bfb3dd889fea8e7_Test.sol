...
contract Test is ERC721, ERC721Enumerable, Ownable {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://ipfs.filebase.io/ipfs/QmX6zyYPoazdGfpPmq6K7zUKDjyPFrARreg2m3cuSFLS1a/";
    }
    ...
    return string(
        abi.encodePacked(
            "https://ipfs.filebase.io/ipfs/QmX6zyYPoazdGfpPmq6K7zUKDjyPFrARreg2m3cuSFLS1a/",
