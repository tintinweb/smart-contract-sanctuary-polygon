...
contract i3WPNFT is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, EIP712, ERC721Votes {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor()
        ERC721("i2 Waste PowerTech Non-Fungible Token", "i3WPNFT")
        EIP712("i2 Waste PowerTech Non-Fungible Token", "1")
    {}

    function createNFT(address to, string memory uri) public onlyOwner returns (uint256) {
