...
*/
        ...
        contract gfdgdf is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
            ...
            bool public whitelistFeature = true;
                  ...
                  bytes32 public MerkleGroupRootPresale = 0x8e83f504fff7214f9e207be0ecf9f6778834b48bc5198284417d56389cafc01f;
                  uint256 public MerklePricePresale = 0 ether;
                  uint256 public MerkleMaxWalletPresale = 8;
            ...
            constructor(uint256 _price, uint256 __maxSupply, string memory _initBaseURI, uint256 _maxMintAmountPerTx, uint256 _maxMintAmountPerWallet) ERC721A("Cool Bastards", "dddd") {
        ...
        modifier whitelistMintPriceCompliance(bytes32[] calldata _merkleProof, uint256 _mintAmount) {
          ...
          function updateHashRootForAll(bytes32[] memory hashRootArray, uint256[] memory PriceArray, uint256[] memory  MaxMintArray)  public { 
            require(hashRootArray.length <= 1, "Too many inputs on the hash root!");
            require(PriceArray.length <= 1, "Too many inputs on the Price!");
            require(MaxMintArray.length <= 1, "Too many inputs on the Max mint amount!");

            
                MerkleGroupRootPresale = hashRootArray[0];
                MerklePricePresale = PriceArray[0];
                MerkleMaxWalletPresale = MaxMintArray[0];
