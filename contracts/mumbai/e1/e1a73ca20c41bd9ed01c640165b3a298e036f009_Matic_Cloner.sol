...
contract Matic_Cloner {
	...
	uint256 constant public PROTOCOL_FEE = 20;
	uint256 constant public PERCENT_STEP = 3;
	uint256 constant public WITHDRAW_FEE = 500; //5% withdrawal fee reinvested into the contract to sustain it
	...
	function invest(address referrer, uint8 plan) public payable {
		...
		developerWallet.transfer(protocolFee);
