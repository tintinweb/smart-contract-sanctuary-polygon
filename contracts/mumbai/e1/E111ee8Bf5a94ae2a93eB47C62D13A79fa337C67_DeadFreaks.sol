...
contract DeadFreaks is ERC721, ERC2981, Ownable, ReentrancyGuard, NonblockingReceiver {
  ...
  function mintActive() external view returns(bool) {
    return block.timestamp >= mintActiveFrom;
  }
  ...
  nonReentrant
  {
    require(block.timestamp >= mintActiveFrom, "Mint inactive");
  ...
  function revealDone() external onlyOwner {
  ...
  function _beforeTokenTransfer(
    ...
    require(!isRevealing, "Transfer is paused while reveal is in progress");
  }
  ...
  function traverseChains(uint16 _chainId, uint tokenId) public payable {
    ...
    require(!isRevealing, "Traversal is paused while reveal is in progress");
