...
contract KRKite_PresaleOne {
    ...
    constructor() {
        address payable kRKiteDevWallet = payable(
            0xeB57105d129dea644d3F044d37ee0f631C4f7505 //NTC
        );
        admin = 0xB9FDf25E7f1762aBB48c7feD7C289237015c6FC5; //NTC
        KRKiteDevWallet = kRKiteDevWallet;
        token = IERC20(0x5efCCEDC5efc69538D75B1b55Fa36E04adB67E36); //NTC
    }
    ...
    function getPresaleEndDate(uint daysToExtend) public view returns (uint) {
        require(
