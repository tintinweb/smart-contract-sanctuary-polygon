...
// File: contracts/ClitPix.sol


pragma solidity ^0.8.1;


contract ClitPix is ERC721Enumerable {
  /**
  @dev events
 */
 ...
 */
  ...
  function contractURI() public pure returns (string memory) {
    return
      string(
        'https://ipfs.io/ipfs/Qmd72e5RTyxbTLCbUfzRsyVLoyjEcw9FaSGnoEwfRqnvC3'
      );
  }
 ...
 */
  ...
  function mint(uint256 _amount) public payable {
    require(nextTokenId <= maxTokenId, 'Must not exceed maximum');
