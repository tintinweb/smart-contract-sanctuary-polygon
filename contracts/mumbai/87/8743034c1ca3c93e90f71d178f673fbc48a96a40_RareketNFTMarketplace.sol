...
contract RareketNFTMarketplace is Pausable, ERC721Holder {
    ...
    uint private marketplaceBalance;
    ...
    function updateFixPriceOrder(address _tokenAddress, uint256 _tokenId, uint256 _newPrice) public whenNotPaused{
        ...
        orderByTokenId[_tokenAddress][_tokenId].askingPrice = _newPrice;
    ...
    function _createBid(address _tokenAddress, uint256 _tokenId,  uint256 value)  internal   {
        ...
        if(bid.bidId != 0) { // Not first bid
            ...
            if(block.timestamp.add( 10 seconds) > order.expiryTime) // If this bid came in last 10 minutes of Auction, reset timer to 10 minutes.
            {
                orderByTokenId[_tokenAddress][_tokenId].expiryTime = block.timestamp.add(10 seconds);
            }
        ...
        } else // First bid
        {
            ...
            orderByTokenId[_tokenAddress][_tokenId].expiryTime =  block.timestamp.add(1 minutes); // 1 day auction time
