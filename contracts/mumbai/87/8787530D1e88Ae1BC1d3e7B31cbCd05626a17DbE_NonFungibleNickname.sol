...
contract NonFungibleNickname is ERC721Burnable, Pausable, Ownable {
    ...
    function generateCard(uint256 tokenId) public returns (string memory) {
        bytes memory svg = abi.encodePacked(
            ...
            '<path fill="#0C91F9" d="M0 0 H250 V250 H0 V0 z"/>',
            '<g id="Group-6" transform="translate(70.000000, 105.000000)">',
            '<text text-anchor="middle" id="domain" font-family="system-ui, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Ubuntu, Helvetica Neue, Oxygen, Cantarell, sans-serif" font-size="20" font-weight="bold" fill="#FFFFFF">',
