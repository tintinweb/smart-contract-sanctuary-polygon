...
contract Marketplace is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    /// @notice Platform fee (1 = 10**18, 1 = 1USDC) (DO NOT ENTER IN WEI)
    ...
    constructor(
        ...
        platformFee = _platformFee * 10**18;
    ...
    function updateListingAdmin(
        ...
        listedItem.payToken = _payToken;
        listedItem.pricePerItem = _newPrice;
        emit ItemUpdated(_owner, _nftAddress, _tokenId, _payToken, _newPrice);
    }
    ...
    function registerRoyalty(
        ...
        require(INFTFactory(addressRegistry.factory()).exists(_nftAddress), "invalid nft address");
    ...
    function updatePlatformFeeRecipient(address payable _platformFeeRecipient) external onlyOwner {
        ...
        emit UpdatePlatformFeeRecipient(feeReceipient);
    }
    ...
    function _validPayToken(address _payToken) internal view {
        require(
            (addressRegistry.treasuryManagement() != address(0) &&
                ITreasuryManagement(addressRegistry.treasuryManagement()).whitelistedToken(_payToken)),
            "invalid pay token"
        );
    }
