...
contract MobulaPrivateSale is Ownable {
    ...
    uint private constant MAX_USDC_ALLOWED_PER_USER = 10;
    ...
    function deposit(uint256 _amount, bytes32[] calldata _proof) public callerIsUser {
        require(USDC.balanceOf(address(this)) + _amount ** 18 <= MAX_USDC_ALLOWED);
        ...
        USDC.transferFrom(msg.sender, address(this), _amount ** 18);
    }
