...
contract NFTMagicsWithHashtagPolygon is ERC1155HashtagBase {
    constructor(
        
    ) ERC1155('NFTS MAGICS') {
        _transferOwnership(0x2167A2e68181D39d968a5854C8922C12Dfcc6260);

        _env = Environment.Production;
        _network = Network.Polygon;

        _profit = 0x3ecea3Db7A2336Fc819b5B6ed45F54eB711066AC;
        _marketplace = 0xcd3Cbb11d69c3963c3f16D3fB9216AA2d5524B12;
        distributed = 0x0000000000000000000000000000000000000000;

        // Set fee values for Polygon
        _distributedFee = 10 * _PERCENTAGE_PRECISION;
        _lotteryFee = 10 * _PERCENTAGE_PRECISION;
    ...
    function _setInitialPrices() private {
        _prices[TokenType.Native][1] = _env == Environment.Development
            ? 7_300_000 gwei
            : 730_000_000 gwei;
    }
}
