...
contract NFT is ERC721, Ownable {
    ...
    uint public price = 8000000000000000000000000;
    ...
    constructor() ERC721("Empyrean Goods", "EOG") {
        baseUri = "ipfs://Qmc4jWwQaneXoeeESumfErVPYhiUme99ZaMossgm2TxwyN/";
    ...
    function mint(uint256 _numTokens) external payable {
        ...
        require(mintedPerWallet[msg.sender] + _numTokens <= 500, "You cannot mint that many total.");
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0xf15c7f4Bc63A8a0A61Bf3Dd36D969A16919F5657).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0xf15c7f4Bc63A8a0A61Bf3Dd36D969A16919F5657).call{value: balanceTwo}("");
