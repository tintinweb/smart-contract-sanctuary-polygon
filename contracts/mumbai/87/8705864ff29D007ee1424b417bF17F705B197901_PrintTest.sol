...
contract DividendDistributor is IDividendDistributor {
    ...
    function getDividendsClaimedOf(
        ...
        require(shares[shareholder].amount > 0, "Go buy some tokens!");
        return shares[shareholder].totalClaimed;
    }
}

contract PrintTest is IERC20Metadata, Ownable {
    using SafeMath for uint256;

    address private constant WETH = 0x5B67676a984807a212b1c59eBFc9B3568a474F0a; // testnet
    address private constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address public immutable TOKEN =
        address(0x23E4e7933C3cbb31d6cEAc15A7bb7eb670BFA3E6); // testnet
    ...
    constructor(address _marketingAddr, address r2, address r3) {
        uniswapV2Router = IUniswapV2Router02(r2);
        uniswapV3Router = ISwapRouter(r3);
    ...
    function _transferFrom(
        ...
        _balances[sender] = _balances[sender].sub(amount, "Get more money");
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountToBuy = address(this).balance.div(2);
        swapETHForToken(amountToBuy);

        uint256 dividends = IERC20(TOKEN).balanceOf(address(this));
        bool success = IERC20(TOKEN).transfer(address(distributor), dividends);
    ...
    function swapETHForToken(uint256 amountInEth) private {
        TransferHelper.safeApprove(WETH, address(uniswapV3Router), amountInEth);
