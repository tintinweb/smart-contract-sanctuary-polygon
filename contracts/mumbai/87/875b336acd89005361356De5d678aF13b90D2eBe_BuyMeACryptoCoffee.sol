...
contract BuyMeACryptoCoffee is ERC721, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    constructor(string memory _uri, uint _coffeePrice) ERC721("BuyMeACryptoCoffee", "BMACC") {
        uri = _uri;
