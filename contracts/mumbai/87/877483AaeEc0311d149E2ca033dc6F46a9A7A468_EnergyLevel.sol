...
contract EnergyLevel is Multicall, HSystemChecker {
    ...
    bytes32 constant public PET_TOKEN = keccak256("PET");
    bytes32 constant public CAT_TOKEN = keccak256("CAT");
    ...
    /// @return energyLevel3 - Energy Level 3 in uint16
    /// @return energyLevel4 - Energy Level 4 in uint16
    function _unpack(uint64 packedEnergyLevel) internal pure returns (
        uint16 energyLevel1,
        uint16 energyLevel2,
        uint16 energyLevel3,
        uint16 energyLevel4
