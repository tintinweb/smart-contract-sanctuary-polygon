...
contract Insurance is FunctionsClient, ConfirmedOwner {
  ...
  constructor(address oracle, address linkMaticPrice) FunctionsClient(oracle) ConfirmedOwner(msg.sender) {
  ...
  function estimateInsurance(
    ...
    newInsuranceData.latNe = args[0];
    newInsuranceData.longNe = args[1];
    newInsuranceData.latSe = args[2];
    newInsuranceData.longSe = args[3];
    newInsuranceData.latSw = args[4];
    newInsuranceData.longSw = args[5];
    newInsuranceData.latNw = args[6];
    newInsuranceData.longNw = args[7];
    newInsuranceData.configParam = args[8];
    newInsuranceData.currentDay = args[9];
    newInsuranceData.startDay = args[10];
    newInsuranceData.endDay = args[11];
