...
contract Chest is ERC721, VRFConsumerBaseV2 {
  ...
  event Spawned(uint256 indexed token, uint256 lat, uint256 long, uint256 tier);
  event Claimed(address indexed owner, uint256 indexed tokenId, uint256 lat, uint256 long, uint256 tier);
