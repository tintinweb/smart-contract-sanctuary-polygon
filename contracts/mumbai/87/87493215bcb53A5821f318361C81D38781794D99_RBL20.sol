...
contract RBL20 is Context, IERC20, Ownable {
  ...
  event Updated_Price(address indexed buyer, uint256 buyamount, uint256 fromprice, uint256 toprice, uint256 wasrebalance);
  ...
  function BuyToken(uint256 _amountUSD) public returns (bool) {
    ...
    emit Updated_Price(msg.sender,_amountUSD,beforeprice,tokenout[1],tokenout[2]);
    return true;
  }
