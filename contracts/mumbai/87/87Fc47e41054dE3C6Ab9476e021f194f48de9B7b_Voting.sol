...
contract Voting {
    ...
    mapping(address => uint) public checkBal;
    /**
     * castVote
    ...
    function castVote(bool _decision, uint _proposalId) external {
        ...
        if (
            ...
            if (_decision) {
                ...
                onlyForVotes[_proposalId].push(forVotedData(msg.sender, block.timestamp, bal));
                ...
                voteState[_proposalId][msg.sender].timestamp = block.timestamp;
                onlyAgainstVotes[_proposalId].push(againstVotedData(msg.sender, block.timestamp, bal));
