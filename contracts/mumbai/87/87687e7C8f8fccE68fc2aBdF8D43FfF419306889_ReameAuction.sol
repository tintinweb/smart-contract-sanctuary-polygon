...
contract ReameAuction is AccessControlUpgradeable, ERC1155HolderUpgradeable
{
    ...
    function cancel(
        ...
        reameNft.safeTransferFrom(address(this), _auction.owner, _auction.tokenId, _auction.amount, "");
    ...
    {
        require(reameNft.balanceOf(msg.sender, _tokenId) >= _amount, "not enough tokens");
        ...
        payable external
    {
        ...
        reameNft.safeTransferFrom(address(this), msg.sender, _auction.tokenId, _auction.amount, "");
        ...
        external
    {
        ...
        if (_lastBid.bidId == 0) { // no bidder
            ...
            reameNft.safeTransferFrom(address(this), _lastBid.owner, _auction.tokenId, _auction.amount, "");
        }
