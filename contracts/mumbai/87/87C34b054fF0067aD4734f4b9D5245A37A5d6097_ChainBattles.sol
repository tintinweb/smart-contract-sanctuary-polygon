...
// Deployed at 0x87C34b054fF0067aD4734f4b9D5245A37A5d6097
...
contract ChainBattles is ERC721URIStorage  {
    ...
    function generateCharacter(uint256 tokenId) public returns(string memory){
        ...
        bytes memory svg = abi.encodePacked(
            ...
            '<text x="50%" y="80%" class="base" dominant-baseline="middle" text-anchor="middle">', "Strength: ",getLife(tokenId),'</text>',
            '</svg>'
        );
        return string(
            abi.encodePacked(
