...
contract SimpleERC721 is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor(string memory name, string memory sym, string memory baseuri, uint256 max) ERC721(name, sym) {
        _maxSupply = max;
        _baseuri = baseuri;
    }
    ...
    function publicMint() public {
        require(totalSupply() < _maxSupply, "Maximum supply already reached");
