...
// File: contract/Onchain_Database_v1.sol

/*
SPDX-License-Identifier: MIT
    shimadamasafumi On-chain Database v1 {
        SEQUENCE {
            [TimestampOfRegistrationDate(Unixtime), WorkId No., InventoryNumber, Title_en, Title_ja, Material, Edition, Term&Year, Size, ImageURL, Details, Exhibition, Status, ArtistMemo]
        }
...
contract Onchain_Database_v1 is ERC721URIStorage {
    ...
    constructor() ERC721("shimadamasafumi", "sm") {

        _owner = msg.sender;
        _sequence = "[TimestampOfRegistrationDate(Unixtime), WorkId No., InventoryNumber, Title_en, Title_ja, Material, Edition, Term&Year, Size, ImageURL, Details, Exhibition, Status, ArtistMemo]";
    ...
    function dropNFT(address recipient, string memory tokenURI) external onlyOwner {
