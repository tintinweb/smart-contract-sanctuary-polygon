    ...
    UUPSUpgradeable
{
    ...
    function setCreatorEarning(uint256 _tokenId, uint256 _fee) public {
        ...
        require(_fee <= 10, "CREATOR_EARNING_OVER_LIMIT");

        mCreator[_tokenId] = OCreator(msg.sender, _fee);
        emit ESetCreatorEarning(msg.sender, _tokenId, _fee);
    }
