...
abstract contract Base_ZingNFT_721_PSI is
    IERC2981,
    Ownable,
    Pausable,
    ERC721PsiBurnable
...
import "./library/Base_ZingNFT_721_PSI.sol";

/**
 * @title ZingArt_NFT721_PSI
 * ZingArt_NFT721_PSI - ERC721Psi
 */
contract ZingArt_NFT721_PSI is Base_ZingNFT_721_PSI {
    using Strings for uint256;
    ...
    */
    ...
    function _isApprovedOrOwner(
        ...
        address owner = ERC721Psi.ownerOf(tokenId);
