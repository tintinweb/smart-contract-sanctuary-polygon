...
contract MintPassNFTNew is ERC721, ERC721URIStorage, Pausable, Ownable, ERC721Burnable, ERC2981, DefaultOperatorFilterer {
    ...
    // mint Metaverse NFT
    //function mintMintPass(address recipient, string memory uri, address royaltFeeReceiver, uint96 fee) public payable returns(uint256){
    function mintMintPass(address recipient, string memory uri, address royaltFeeReceiver, uint96 fee) public returns(uint256){

        // WETH address on mainnet
        // address public constant WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
        // set the mint price
        //require(msg.value >= 1000000000000000, "Not enough MATIC sent; check price!"); 
        //payable(address(0x1f6A403347fd2d335d14Dc3f1AEb21D9192cF166)).transfer(1000000000000000);
        (bool success) = IERC20(0x7D1AfA7B718fb893dB30A3aBc0Cfc608AaCfeBB0).transferFrom(msg.sender, 0x1f6A403347fd2d335d14Dc3f1AEb21D9192cF166, 1000000000000000);
        require(success);
