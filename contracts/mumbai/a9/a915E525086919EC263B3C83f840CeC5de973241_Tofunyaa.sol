...
// SPDX-License-Identifier: UNLICWNSED
...
contract Tofunyaa is IERC721 {
    ...
    string internal nftName = "Nyaa";
    string internal nftSymbol = "nya";
    ...
    function mint(uint256 numberOfNfts) external payable reentrancyGuard {
        ...
        require(
            numberOfNfts <= 5,
            "You can not buy more than 5 NFTs at once"
        );
        require(
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked(
                    "ipfs://QmUmZyBNszschxGHQJtcFwu1K9sH78raRm7bQhuakXp6vU/",
                    toString(_tokenId),
                    ".json"
                )
            );
    ...
    modifier onlyTokenOwner(uint256 _tokenId) {
        require(_tokenId < 100, "Nyaa number is wrong");
