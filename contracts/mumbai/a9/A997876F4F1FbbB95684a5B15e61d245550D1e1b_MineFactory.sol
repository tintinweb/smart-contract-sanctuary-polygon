...
//矿山工厂合约
contract MineFactory is ReentrancyGuard, Ownable, Pausable{
    ...
    address mglobeGameERC1155Address;

    //操作员数组
    mapping(address => bool) private operators;

    constructor(address _mglobeGameERC1155Address){
        mglobeGameERC1155Address = _mglobeGameERC1155Address;
...
contract Child {
    ...
    //矿山总储备量
    uint public ore_total_reserves;

    //矿山保有量
    uint public ore_inventory;
