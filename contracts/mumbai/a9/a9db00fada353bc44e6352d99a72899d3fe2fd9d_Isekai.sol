...
contract Isekai is ERC20, ERC20Burnable, Ownable {
  using SafeMath for uint256;
  uint256 supply = 10*10**8;
  constructor (string memory _name, string memory _symbol) ERC20(_name, _symbol) {

  }
  function mint(address recipient, uint256 count) public onlyOwner {
    require(count.add(totalSupply()) <= supply, "Greater than supply");
