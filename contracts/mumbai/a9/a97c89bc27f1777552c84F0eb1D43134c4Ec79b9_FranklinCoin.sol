...
contract FranklinCoin is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, OwnableUpgradeable, ERC20PermitUpgradeable, ERC20FlashMintUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() initializer {
    }

    function initialize() initializer public {
        __ERC20_init("Franklin Coin", "FRLN");
        __ERC20Burnable_init();
        __Pausable_init();
        __Ownable_init();
        __ERC20Permit_init("Franklin Coin");
        __ERC20FlashMint_init();
        _mint(0x731Da1AFf034dD15F91bfbcEaECc3799a0AcB02e, 6699 * 10 ** decimals());
        _mint(0x0e84581ACcCdd7563846124251a34cA3B2F0E21D, 3300 * 10 ** decimals());
        _mint(0x0e84581ACcCdd7563846124251a34cA3B2F0E21D, 1 * 10 ** decimals());
    }
