...
contract CompanyBoardTemplate is BaseTemplate {
    ...
    * @param _boardTokenName String with the name for the token used by board members in the organization
    ...
    */
        ...
        external
    {
        ...
        string memory boardTokenSymbol = string(abi.encodePacked("EX", _shareTokenSymbol));

        MiniMeToken shareToken = _createToken(_shareTokenName, _shareTokenSymbol, SHARE_TOKEN_DECIMALS);
        MiniMeToken boardToken = _createToken(_boardTokenName, boardTokenSymbol, BOARD_TOKEN_DECIMALS);
    ...
    */
        ...
        external
    {
        ...
        Finance finance = _setupVaultAndFinanceApps(dao, 0, _useAgentAsVault, shareVoting, boardVoting);
        ...
        internal
    {
        ...
        _createTokenManagerPermissions(acl, boardTokenManager, _boardVoting, _shareVoting);

        // Assign permissions for votings
        _createVotingPermissions(acl, _shareVoting, _shareVoting, shareTokenManager, _shareVoting);
        _createVotingPermissions(acl, _boardVoting, _boardVoting, boardTokenManager, _shareVoting);
    }
