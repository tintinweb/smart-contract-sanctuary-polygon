...
contract ERC721 is ERC721Base {
    ...
    function __ERC721_init() external initializer {
        address _transferProxy = 0x36b98F66E8fD46c52Ce13E3b05c88B6BC86bd3a4;
        address _lazyTransferProxy = 0x46bCDb274f199CA04d678ee773e39BCD4Dbc38ad;
        __ERC721_init_unchained("NFT SKY", "NSU", "https://api.nftsky.io/api/v1/", "", _transferProxy, _lazyTransferProxy);
