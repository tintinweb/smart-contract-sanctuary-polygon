...
contract Equipment is ERC1155, Ownable, ERC1155Burnable, ERC1155Supply {
  ...
  function safeBatchTransferFrom(
    ...
    for (uint256 i = 0; i < length; ) {
      ...
      require(availableBalance >= amounts[i], "Not enough unlocked");
      unchecked {
        ++i;
      }
    }
  ...
  function burn(
    ...
    require(availableBalance >= value, "Not enough unlocked");
  ...
  function burnBatch(
    ...
    for (uint256 i = 0; i < length; ) {
      ...
      require(availableBalance >= values[i], "Not enough unlocked");
      unchecked {
        ++i;
      }
    }
