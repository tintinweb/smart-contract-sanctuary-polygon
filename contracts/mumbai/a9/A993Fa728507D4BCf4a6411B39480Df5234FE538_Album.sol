...
contract ExampleToken is OnChainMusicMetadata {
    function setupSongMetadata() internal {
        ...
        credits[1].push(Collaborator("sweetman.eth", "smart contract engineer"));
    ...
    function getAudio() public pure returns (Audio memory) {
        ...
        Lyrics memory lyrics = Lyrics("TODO", "TODO");
    ...
    function getPublishingData() internal pure returns (PublishingData memory) {
        ...
        string
            memory description = "TODO";
        string memory recordLabel = "Infinati";
        string memory publisher = "Infinati";
        string
            memory location = "TODO";
        string
            memory releaseDate = "TODO";
        return PublishingData(title, description, recordLabel, publisher, location, releaseDate);
    }

    function getAuctionQuantitative() internal pure returns(AudioQuantitative memory) {
    ...
    function getAuctionQualitative() internal pure returns(AudioQualitative memory) {
