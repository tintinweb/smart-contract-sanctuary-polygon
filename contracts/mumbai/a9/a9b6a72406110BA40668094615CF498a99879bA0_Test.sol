...
contract Test is ReentrancyGuard, Ownable {
    ...
    constructor(IERC721 _nftCollection, IERC20 _rewardsToken, uint256 _inflation) {
    ...
    uint256 private rewardsPerHour = inflation;
