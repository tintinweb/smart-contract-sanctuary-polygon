...
contract SeedVault is Initializable, OwnableUpgradeable, EIP712Upgradeable {
    ...
    modifier onlyVaultDevice(uint256 account) {
        require(registry.isDeviceActive(account, msg.sender), "Must be active device of account");
        _;
    }
    ...
    function addSeed(
        ...
        require(registry.isDeviceActive(accountID, msg.sender), "Must be active device of account");
