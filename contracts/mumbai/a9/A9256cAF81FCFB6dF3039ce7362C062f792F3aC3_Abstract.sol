...
contract Abstract is ERC721, Ownable {
    ...
    constructor() ERC721("Abstract", "ABS") {
        baseUri = "ipfs://bafybeicym33brfx5kbmldgwkdyqmcbqkthhslafywriyqhgnrrc4xkyapa/";
   ...
   function mint(uint256 _numTokens) external payable {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
     ...
     function _baseURI() internal view virtual override returns (string memory) {
        return "https://ipfs.io/ipfs/bafybeicym33brfx5kbmldgwkdyqmcbqkthhslafywriyqhgnrrc4xkyapa/";
    }
