...
contract GameItems is Ownable, ERC2981, ERC721URIStorage {
    ...
    constructor() ERC721 ("GamingItem", "GMNI") {
        ...
        return string(abi.encodePacked(
            ...
            Base64.encode(
                bytes(abi.encodePacked(
                    '{"name": "Gaming #', Strings.toString(tokenId),'",', 
                    '"description": "Gaming is great!!!", ',
                    '"attributes": ',
