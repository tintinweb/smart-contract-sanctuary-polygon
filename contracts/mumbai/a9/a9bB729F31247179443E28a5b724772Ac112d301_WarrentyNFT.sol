...
contract WarrentyNFT is ERC721, ERC721URIStorage{
    ...
    function getTokenUri(string memory _name, string memory _product) private pure returns(string memory){
    ...
    function mint(string memory _name, string memory _product) public {
        uint256 unique_id = block.timestamp;
        _safeMint(msg.sender,unique_id);
        _setTokenURI(unique_id,getTokenUri(_name,_product));
    }
