...
/// Airdrop NFT contract, no public mint method, only admin can airdrop
/// @custom:security-contact [email protected]
contract DfansSBT is ERC721, ERC721Royalty, ERC721Pausable, Ownable {
    ...
    constructor(
        ...
        uint256 _defaultMintPrice, // not used right now, keep params same as others
     ...
     * - `price` here has no use, just keep params being same as other contracts
