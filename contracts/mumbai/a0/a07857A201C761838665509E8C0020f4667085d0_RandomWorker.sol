...
contract RandomWorker is AccessControl {
        ...
        returns (ResultStorage memory resultStorage)
    {
        ...
        resultStorage.finalHair = uint32((randomStorage.randomHair % 61) + 1);
        resultStorage.finalExpress = uint32(
            (randomStorage.randomExpress % 16) + 1
        );
    ...
    {
        if (rarity == 0) {
            finalRandom = uint32((rarityNums % 12) + 1);
        } else if (rarity == 1) {
            ...
            finalRandom = uint32((rarityNums % 4) + 1);
        }
        return (finalRandom);
    }
