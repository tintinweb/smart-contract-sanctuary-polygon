...
// File: /contracts/LUXON/utils/SuperOperators.sol
...
contract ERC721LUXON is Context, ERC165, IERC721, IERC721Metadata, SuperOperators {
...
contract LCT is ERC721LUXON {
    constructor() ERC721LUXON("Lux-On Character NFT", "LCT") {}

    mapping(uint256 => string) characterInfo;

    function mintLuxOn(address mintUser, uint256 quantity, string[] memory characterId) external onlySuperOperator {
