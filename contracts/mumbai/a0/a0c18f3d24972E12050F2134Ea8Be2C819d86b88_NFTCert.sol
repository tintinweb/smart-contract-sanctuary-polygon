...
contract NFTCert is INFTCert, Ownable, AccessControl {
    ...
    function registerCerts(EnergyCertInput[] calldata certInputs) external override onlyOwner {
    ...
    function setDefaultVals() private {
        energyTypes["NONE"] = true;
        energyTypes["WIND"] = true;
        energyTypes["SOLAR"] = true;

        locations["NONE"] = true;
        locations["GERMANY"] = true;
        locations["BRITAIN"] = true;
    }
