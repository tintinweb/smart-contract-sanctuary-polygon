...
contract TableHolders is Initializable, ERC721Upgradeable, AccessControlUpgradeable, UUPSUpgradeable, ERC721HolderUpgradeable {
    ...
    function createTableTest(
        ...
        // _tableland = TablelandDeployments.get();
        ITablelandTables tland = ITablelandTables(0x4b48841d4b32C4650E4ABc117A03FE8B51f38F68);
        // Execute the Create statement
        uint256 tableId = tland.createTable(
            address(this), 
            statement
        );
        // uint256 tableId = 0;
