    ...
    ERC721URIStorage
{
    ...
    modifier onlyWorkshop() {
        require(rotamAccess.accessLevels(msg.sender) == RotamAccess.AccessLevel.Workshop, "Only authorized Workshop");
        _;
    }

    modifier onlyManufacturer() {
        require(rotamAccess.accessLevels(msg.sender) == RotamAccess.AccessLevel.Manufacturer, "Only authorized Manufacturer");
        _;
    }
