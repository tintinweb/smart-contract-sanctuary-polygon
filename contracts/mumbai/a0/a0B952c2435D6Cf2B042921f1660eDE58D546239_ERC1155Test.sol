...
contract ERC1155Test is ERC1155, Ownable {
    ...
    constructor() ERC1155("https://api.nft-testing.xyz") {
    }
    ...
    function _checkMaximumAndIncreaseSupply(uint256 id, uint256 amount) private {
        require((mintedTokenSupply[id] + amount) <= maxTokenSupply[id], "ERC1155Test: maximum is reached for this token id.");
    ...
    function burn(
        ...
        require(
            ...
            "ERC1155Test: caller is not owner nor approved"
        );
