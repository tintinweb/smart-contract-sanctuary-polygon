...
abstract contract Upgradeable is ReentrancyGuarded {
    ...
    mapping(bytes => mapping(address => uint256)) public claimedAmountPerUser; // airdropEvent => account => amount
    // address erc721OfferHandlerAddress;
    mapping(bytes32 => mapping(address => uint256)) _nonces;
    // address erc721BuyHandlerAddress;
    mapping(bytes => bool) public invalidAirdropEvent; // airdropEvent => true/false
