...
contract NidhiLegacyNFT is ERC721URIStorage, AccessControl {
    ...
    function mint(address minter, string memory imageURI)
        external
        onlyRole(MINTER_ROLE)
    {
        string memory tokenURI;
        _safeMint(minter, ++_tokenIds);
        _setTokenURI(_tokenIds, tokenURI = _formatTokenURI(imageURI));
