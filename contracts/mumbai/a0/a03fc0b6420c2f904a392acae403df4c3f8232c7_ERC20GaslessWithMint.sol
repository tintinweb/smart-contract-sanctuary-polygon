...
// ERC20Gasless library with Governance.
contract ERC20GaslessWithMint is
    Ownable,
    ERC20Upgradeable,
    ...
    Metadata
{
    ...
    function init(bytes calldata _encodedData) external initializer {
        address mintTo;
        ...
        (
            ...
            _encodedData,
            (string, string, address, uint256, string, address, address, uint8)
        );
        ...
        _updateMeta(address(this), address(0), tokenURL);
    }
    ...
    function permit(
        ...
        require(holder == ecrecover(digest, v, r, s), "ERC20: INVALID-PERMIT");
        require(
            expiry == 0 || block.timestamp <= expiry,
            "ERC20: PERMIT-EXPIRED"
        );
        require(nonce == nonces[holder]++, "ERC20: INVALID-NONCE");
    ...
    function delegateBySig(
        ...
        require(
            signatory != address(0),
            "ERC20::delegateBySig: invalid signature"
        );
        require(
            nonce == nonces[signatory]++,
            "ERC20::delegateBySig: invalid nonce"
        );
        require(
            block.timestamp <= expiry,
            "ERC20::delegateBySig: signature expired"
        );
        ...
        returns (uint256)
    {
        require(
            ...
            "ERC20::getPriorVotes: not yet determined"
        );
    ...
    function _delegate(address delegator, address delegatee) internal {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying ERC20s (not scaled);
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber = safe32(
            block.number,
            "ERC20::_writeCheckpoint: block number exceeds 32 bits"
        );
