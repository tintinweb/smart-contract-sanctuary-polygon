...
contract GetHiiTest5 is ERC721, ERC721Enumerable, Pausable, Ownable {
    ...
    constructor() ERC721("Get Hii Test 5", "Hi!") {}
    ...
    returns (uint256) {
        ...
        _tokenIds.increment(); // Begin at Id #1 instead of #0
        uint256 newItemId = _tokenIds.current();
        require(msg.value > _setPrice(newItemId), "Your balance is too low to mint.");
        _mint(msg.sender, newItemId);
        _setTokenURI(newItemId, uri);
        _setColors(newItemId, bgColor, fgColor);
        return newItemId;
