...
// @title AAVE Interest Yielding (AIY) Simple Gift Box
// @notice Simple Gift Box with added AAVE integration
...
// @title Simple Gift Box
// @notice Gift box with no unwrap requirements
contract SimpleGiftBox is IGiftBox, ERC721Holder, ERC165 {
  ...
  // @name Get Type
  // @notice Used to determine the specific kind of GiftBox
  function getType() external virtual pure returns(string memory){
    return "SIMPLE";
  }
