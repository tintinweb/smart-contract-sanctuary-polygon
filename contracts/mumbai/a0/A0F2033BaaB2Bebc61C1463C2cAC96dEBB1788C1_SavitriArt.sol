...
contract SavitriArt is ERC1155, Ownable, ERC1155Supply, ContextMixin, NativeMetaTransaction {
    // Contract name
    string public name;

    constructor()
        ERC1155("https://bafybeifnkjxb5uwzdevv67ajskphda4dyfg2kaqzj25ckn5wtdizlut2vi.ipfs.dweb.link/{id}.json")
    {
        name = "Savitri Artworks";
        _initializeEIP712(name);
    }

    function contractURI() public pure returns (string memory) {
        return "https://nft.auroville.org/savitri-art-collection.json";
    }
