...
contract drop1 is Ownable, ERC721A, ReentrancyGuard, DefaultOperatorFilterer  {
    ...
    address public revealContract = 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4; // reveal contract (mumbai)
    ...
    function setRevealContract(address _contract) external onlyOwner {
    ...
    function burnAndRedeem(uint256 tokenId) external nonReentrant {
        require(msg.sender == revealContract, "Invalid burner address");
        // burn tokens in for loop
       _burn(tokenId, false);
    }
