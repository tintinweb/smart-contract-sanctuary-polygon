...
ReentrancyGuard
{
    ...
    {
        string memory _URI = (tokenId >= (1 << 128)) ? string.concat(uri(0), Strings.toString(tokenId), ".json") :
        (tokenId < (10000 << 64))? string.concat(uri(0), Strings.toString(tokenId), ".json") : string.concat(uri(0), "badge.json");
        return _URI;
    }
