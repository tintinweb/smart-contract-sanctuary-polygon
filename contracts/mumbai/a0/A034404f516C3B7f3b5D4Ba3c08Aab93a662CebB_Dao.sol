...
//0xA034404f516C3B7f3b5D4Ba3c08Aab93a662CebB
...
contract Dao {
    ...
    constructor(){
        ...
        validTokens=
        [2515235678762612778672690097999478724832325143761954817609236089335411900417];
        }


    //struct is effectively kind of object that stores different variables then we can say have multiple of these proposals mapped in a mapping on to store all the different proposal on our smart contract
    struct proposal{
        uint256 id;
        bool exists;
        string description;
