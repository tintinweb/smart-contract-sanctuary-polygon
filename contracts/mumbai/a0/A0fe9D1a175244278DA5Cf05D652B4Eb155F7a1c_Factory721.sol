...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new NexityNFTUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        NexityNFTUser721Token token = NexityNFTUser721Token(address(addr));
...
contract NexityNFTUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
