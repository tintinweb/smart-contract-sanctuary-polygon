...
import "./sport_v2.sol";
contract SPORTV3 is SPORTV2 {
   
    function setBetV2Address(ESkillzStraightBetV2 _bet) external onlyOwner {
        ESkillzBetV2 = _bet;
    }  
}
...
contract ESkillzStraightBetV2 is ESkillzStraightBet {
    ...
    function  CreateSPGameV2(address _sender, uint256 amount) external onlySportContract{
      ...
      GameIDs++;
      sportV2.transferFrom(_sender, address(this), amount);
    ...
    function SetSPGameResultV2(uint256 GameID, uint256 result) external {
        ...
        sportV2.transfer(gamebetting[GameID][0].player, amountToWinner);
        sportV2.transfer(feeReceiver, amountToESkillz);
    ...
    function SetMPGameResultV2(uint256 GameID) external {
        ...
        if(msg.sender == gamebetting[GameID][0].player) {
            ...
            sportV2.transfer(gamebetting[GameID][1].player, amountToWinner);
