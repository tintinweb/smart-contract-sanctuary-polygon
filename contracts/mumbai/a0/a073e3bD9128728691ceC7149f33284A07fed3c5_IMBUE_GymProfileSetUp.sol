...
contract IMBUE_GymProfileSetUp {
    ...
    function transferRevenue() public onlyOwner  {
        ...
        for(uint256 index = 0; index < GymArr.length; index++){
            ...
            if(viewDescription[GymArr[index].GymOwner].totalRevenue > 0) {
                ...
                daiInstance.transfer(GymArr[index].GymOwner, uint256(viewDescription[GymArr[index].GymOwner].totalRevenue));
    ...
    function withdraw() public onlyOwner{
        uint256 bal = address(daiInstance).balance;
        bool success = daiInstance.transfer(msg.sender, bal);
        require(success, "transfer failed");
    }
