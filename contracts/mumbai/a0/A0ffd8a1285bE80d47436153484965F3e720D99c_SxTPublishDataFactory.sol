...
contract UserRequestUint256 is UserRequest {
     ...
     * @param ownerAddress - Address that will be set as owner of UserRequest contract
     */
...
contract UserRequestBytes is UserRequest {
     ...
     */
    function getDecodedStringResponse() external view returns(string memory decodedStringResponse) {
        decodedStringResponse = abi.decode(currentResponse, (string));
    }
}
