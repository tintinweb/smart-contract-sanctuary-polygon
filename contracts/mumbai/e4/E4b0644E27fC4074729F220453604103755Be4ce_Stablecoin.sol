...
// Mock contract for testing only
/* solhint-disable */
contract Stablecoin is ERC20PresetFixedSupply {
    ...
    constructor(uint256 initialSupply) ERC20PresetFixedSupply("USD Coin", "USDC", initialSupply, msg.sender) {
        DOMAIN_SEPARATOR = makeDomainSeparator("USD Coin", "2");
    }
    ...
    function permit(
        ...
        require(recover(DOMAIN_SEPARATOR, v, r, s, data) == owner, "EIP2612: invalid signature");
