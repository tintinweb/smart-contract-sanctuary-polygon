...
contract ChainBattles is ERC721URIStorage {
	...
	function generateCharacter(uint256 tokenId) public view returns (string memory) {
		...
		bytes memory svg = abi.encodePacked(
			...
			'<text xml:space="preserve" text-anchor="start" font-family="Noto Sans JP" font-size="24" id="svg_2" y="270" x="321" stroke-width="0" stroke="#000" fill="#000000">level:',profile.level,'</text>',
			'<text xml:space="preserve" text-anchor="start" font-family="Noto Sans JP" font-size="24" id="svg_3" y="309" x="312" stroke-width="0" stroke="#000" fill="#000000">speed:',profile.speed,'</text>',
			'<text xml:space="preserve" text-anchor="start" font-family="Noto Sans JP" font-size="24" id="svg_4" y="346" x="290" stroke-width="0" stroke="#000" fill="#000000">strength:',profile.strength,'</text>',
			'</g>',
			'</svg>'
		);
