...
contract DevilEyes is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Devil Eyes", "DVLE") {
    setHiddenMetadataUri("ipfs://Qmed9wedvcDzgqCqtgwf26xp2rKJmW44mZHnPMWTyGeySF/hidden.json");
  }
