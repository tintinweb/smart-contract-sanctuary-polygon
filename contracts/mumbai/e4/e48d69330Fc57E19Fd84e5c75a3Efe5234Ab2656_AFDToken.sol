...
Blockchain: Polygon
Token Name: African Diaspora Coin
Token Symbol: AFD
Total Supply: 1.2 Trillion
Decimals: 18
Exchange: QuickSwap
Liquidity: 5%
Redistribute: 4%
Owners/ Marketing Wallet: 5%
Auto Burning: 1.5%

*/

contract AFDToken is Context, IERC20, Ownable {
    ...
    uint256 public _tTotal = 1200000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string public _name = "African Diaspora Coin";
    string public _symbol = "AFD";
    uint8 public _decimals = 18;
    uint256 public maxWalletToken = 12000000000 * 10**18; //1%
    
    uint256 public _taxFee = 40; // 40 = 4%
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 50; // 5% 
    uint256 private _previousLiquidityFee = _liquidityFee;
    
    uint256 public _burnFee = 15; // 15 = 1.5%
    uint256 private _previousBurnFee = _burnFee;

    uint256 public _marketingFee = 50; // 5% 
