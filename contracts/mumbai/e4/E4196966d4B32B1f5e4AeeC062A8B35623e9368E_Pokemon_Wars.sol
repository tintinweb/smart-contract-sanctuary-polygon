...
contract Pokemon_Wars is ERC1155LazyMint {
  ...
  */
    function burn(
        ...
        uint256 id,
        uint256 amount
    ) external override isGameActive CheckGameTime {
        require(
            msg.sender == account || balanceOf[msg.sender][2] > 0,
            "Not Token Owner or no level 3 pickachu"
        );
  ...
  */
    function verifyClaim(
        ...
        require(
            ...
            "Already got a level 1 pickachu"
        );
        require(
            balanceOf[msg.sender][1] == 0,
            "Already got a level 2 pickachu"
        );
        require(
            balanceOf[msg.sender][2] == 0,
            "Already got a level 3 pickachu"
        );
    }
  ...
  */
    function attack(address _victim) external isGameActive CheckGameTime {
        require(
            balanceOf[msg.sender][2] > 0,
            "You don't own a level 3 pickachu to attack"
        );
