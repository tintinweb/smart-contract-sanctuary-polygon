...
contract CollectionContract is ERC721Base, PermissionsEnumerable {
    ...
    function updateTokenNicknames(uint256 _tokenId, string calldata _nickname) public onlyRole(NICKNAMER_ROLE) {
