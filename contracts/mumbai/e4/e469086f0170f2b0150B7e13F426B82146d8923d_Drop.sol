    ...
    IERC2981
{
    ...
    function _validatePublicMint(
        ...
        require(phaseStates[phaseIndex].totalMinted <= phases[phaseIndex].maxPerPhase, "Exceeds phase supply");
    ...
    function validatePublicMint(
        ...
        if (phaseStates[phaseIndex].totalMinted > phases[phaseIndex].maxPerPhase)
            return "Exceeds phase supply";
