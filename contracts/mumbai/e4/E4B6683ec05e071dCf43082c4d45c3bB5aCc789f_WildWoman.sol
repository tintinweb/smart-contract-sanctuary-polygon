...
contract WildWoman is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxSupply = 324;
  uint256 public maxMintAmountPerTx = 2;

  bool public paused = true;
  bool public revealed = false;

  constructor() ERC721("Wild Woman", "WLDWMN") {
    setHiddenMetadataUri("ipfs://bafybeihrpqb4ab6okozkxij5idpwxxlbcggxpscugru2ihwwyz4iwb5zgy/hidden.json");
  }
