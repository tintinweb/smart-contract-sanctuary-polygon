...
contract Web_Kids is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
    uint256 public MAX_SUPPLY = 10;

    
    uint256 public TEAM_SUPPLY = 9;
    
    bool public IS_TEAM_ACTIVE = false;

    
    uint256 public TEAM_TX_LIMIT = 1;

    
    uint256 public TEAM_WALLET_LIMIT = 1;

    
    uint256 public TEAM_PRICE = 0 ether;
    ...
    mapping(address => uint) public TEAM_Minted;

    bool public _revealed = false;

    string private baseURI = "";
    string private preRevealURI = "https://ipfs.w3bmint.xyz/ipfs/QmZVtToarKhDbWHhb5DLL3UV9t8KYgMojKA6W4ATMZxp2L";
    ...
    constructor() ERC721A("Web_Kids", "WKDS") {
        
        
        _safeMint(0x72681A21D1E5a1a63aC35380167149eF570B55Fb, 1);
    }
    ...
    function TEAMMint(address to, uint256 numberOfTokens) external isSecured(TEAM_PRICE * numberOfTokens) payable {
        validateMint(IS_TEAM_ACTIVE, TEAM_COUNT, TEAM_SUPPLY, TEAM_Minted[msg.sender], TEAM_WALLET_LIMIT, TEAM_TX_LIMIT, numberOfTokens, true);
        addressBlockBought[to] = block.timestamp;
        TEAM_Minted[to] += numberOfTokens;
        TEAM_COUNT += numberOfTokens;
    ...
    function toggleTEAMMintStatus() external onlyOwner {
        IS_TEAM_ACTIVE = !IS_TEAM_ACTIVE;
    }

    // SUPPLY CHANGERS
    
    function setTEAMSupply(uint256 _supply) external onlyOwner {
        TEAM_SUPPLY = _supply;
    }
    ...
    function withdraw() external onlyOwner {
        ...
        (bool successFinal, ) = payable(0x72681A21D1E5a1a63aC35380167149eF570B55Fb).call{ value: address(this).balance }("");
