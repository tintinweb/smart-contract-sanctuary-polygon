    ...
    AccessControlUpgradeable
{
    ...
    mapping(address => TokenDetails) public tokenRegister;
    ...
    @dev Initializes the contract with a master token and sets the owner and admin role.
    @param _masterToken The address of the master token.
    ...
    */
    ...
    /**
     * @dev Transfers tokens from the specified token contract to the specified recipient.
    ...
    /**
     * @dev Transfers tokens from one account to another using the specified token contract.
     * @param _tokenAddress The address of the token contract.
    ...
    /**
     * @dev Approves the specified recipient to spend the specified amount of tokens from the specified token contract.
     * @param _tokenAddress The address of the token contract.
     * @param _to The address of the recipient.
    ...
    function tokenMint(
        ...
        emit mintToken(_tokenAddress, _to, _amount, uniqueId);
    }
    ...
    function registerTokens(
        ...
        tokenRegister[_tokenAddress] = TokenDetails({
        ...
        storeTokenDetails.push(tokenRegister[_tokenAddress]);
    ...
    function unregisterTokens(address _tokenAddress) external {
        ...
        TokenDetails memory details = tokenRegister[_tokenAddress];
    ...
    /**
     * @dev Returns an array of all the registered tokens.
