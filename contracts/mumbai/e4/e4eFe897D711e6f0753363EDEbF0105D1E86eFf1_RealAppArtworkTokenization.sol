...
// File: Contracts/20221212/IRealASSETCredRedeem.sol
...
// enable recovery key
//
interface IRealASSETCred is IERC1155 {
...
// File: Contracts/20221212/RealABSTRACTTokenization.sol
...
/*
  ...
  ############################################
    ...
    Real Matter Technology Limited (c) 2022
      ...
      Tokenization Application Interface
        of RealAssetCredReem Contract
*/
...
// RealASSETCredRedeem.sol
//
abstract contract RealAbstractTokenization is Context {
    ...
    IRealASSETCred public realContract;
    ...
    function _checkInterfaceOwner() 
        ...
        require(
            ...
            "RealInterface: caller is not the Interface Owner"
        );
    }
    function adminNewInterfaceOwnership(
        ...
        return string ("Interface ownership transferred");
    }      
    ...
    function adminStartRealContract(
        ...
        require (
            ...
            "RealInterface: real Contract cannot be zero address"
        );
        realContract = IRealASSETCred(_realContractAddr);
        statusRecoveryKey = realContract.statusRecoveryKey();
        statusContract = realContract.statusInterface();

        string memory realText = "Interface to Real Contract started  = ";
    ...
    // 
    function read_Asset_Credential()
        public view returns (string memory, string memory, string memory, string memory, string memory){

        string memory realText0 = "Real Asset Credential : [1] Chain , [2] DID Credential , [2] Asset Collection , [3] Redeem Token";
        //uint256 realNumber1 = block.chainid();          // current blockchain ID // still not working for all EVMs
        string memory realText1 = "Polygon";
        string memory realText2 = realContract.readAssetDidCredential();
        string memory realText3 = realContract.readAssetCollectionName();
        string memory realText4 = realContract.readRedeemSymbol();
        return (realText0, realText1, realText2, realText3, realText4);
    }
    function read_Asset_Token()
        public view returns (string memory, string memory, uint256, uint256, uint256){

        string memory realText0 = "Real Asset Token Information : [1] Type , [2] Token ID , [3] Edition number , [4] Asset supply";
        string memory realText1 = "ERC1155";
        uint256 realNumber2 = realContract.readAssetTokenId();
        uint256 realNumber3 = realContract.readAssetIdNext() - 1;
        uint256 realNumber4 = realContract.readAssetTotalSupply();
        return (realText0, realText1, realNumber2, realNumber3, realNumber4);
    }
    // read Real Contract about values of redeem token information
    function read_Redeem_Token()
        public view returns (string memory, string memory, string memory, string memory, uint256, uint256){

        string memory realText0 = "Redeem Token information : [1] Type , [2] Name , [3] Symbol , [4] Decimals , [5] Redeem Supply";
    ...
    function read_ContractPool()
        ...
        string memory realText0 = "Real Asset Contract Addresses : [1] Contract Owner, [2] Contract Pool";
        address realAddr1 = realContract.owner();
        address realAddr2 = address(realContract);
        string memory realText3 = "Redeem Token Contract Addresses : [4] Contract Owner, [5] Contract Pool";
    ...
    function read_Holder_BalanceOf(
        ...
        string memory realText0 = "Real balance of this holder : [1] Asset , [2] Redeem Allowance, [3] Redeem Claimed";
    ...
    function read_Token_BalanceOf(
        ...
        string memory realText0 = "Real balance of this holder : [1] Token ID , [2] Asset|Edition , [3] Redeem Allowance, [4] Redeem Claimed";
    ...
    function adminWriteAboutAll(
        ...
        if (bytes(_aboutThisAsset).length > 0)     
            aboutThisAsset = _aboutThisAsset;
        if (bytes(_aboutThisTokenization).length > 0)     
        ...
        if (bytes(_about).length > 0)     
            ...
            about = "Real-world Asset Tokenization by Real Matter Technology (C) 2022";
    }
...
// File: Contracts/20221212/RealAPPArtworkTokenization.sol
...
/*
  ...
  ############################################
    ...
    Real Matter Technology Limited (c) 2022
      ...
      Artwork Asset Tokens in ERC1155 NFT
       Asset Redemption with Redeem Tokens
...
// Interface Contract to access the real contract
//
contract RealAppArtworkTokenization is RealAbstractTokenization {
    ...
    // from the Real Contract owner
    // only original NFT asset at assetId.ID_ASSET = 1
    function owner_Mint_More_Artwork_AssetToken(
        address toHolder,
        uint256 moreSupply) 
        public {
    ...
    // mint additional Asset Edition on top of the first NFT
    // auto tokenId > 1
    function owner_Mint_New_EditionToken(
        address editionOwner,
        string memory editionURI,
        uint256 editionSupply)
        ...
        string memory realText0 = "New edition of Artwork minted [Token ID , New total Supply]";
        uint256 realNumber1 = _editionId;
