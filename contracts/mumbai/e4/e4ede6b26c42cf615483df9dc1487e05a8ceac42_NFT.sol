...
contract NFT is ERC721, Ownable {
    ...
    string private _tokenIds;

    constructor() payable ERC721("NFT Name", "SYMBOL") {
    ...
    // Public Functions
    function mint(uint256 _numTokens, address recipient) external payable {        
        ...
        for(uint256 i = 1; i <= _numTokens; ++i) {
            ...
            _safeMint(recipient, curTotalSupply + i);
        }
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0xF4E00d71d285F65d824175E6C709B1CF01A68383).call{value: balanceOne}("");
