...
contract Token is IToken, ERC1404, AgentRoleUpgradeable, TokenStorage {
    ...
    /**
     * @dev override both IToken (for interfacing with external contracts) and AgentRoleUpgradeable parent contract
     */
...
contract TokenStorage {
    ...
    /**
     * @notice default transfer restriction codes and messages codes 0-3 are reserved, add more restriction checks and codes on the child contract
     */
