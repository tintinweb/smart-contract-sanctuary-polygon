...
contract DealmintrFactory is Ownable {
    ...
    uint256 index = 0;
    event CreateCollection(address to,address from);
    constructor(string memory _baseURI){
     ...
     uint256 maxBatchSize) external {
        ...
        emit CreateCollection(address(this),address(_dealmintr));
     }
    ...
    Ownable
{
    ...
    function batchmint(
        ...
        for (uint256 i = 0; i < quantity; i++) {
            _mint(to, totalSupply(), royaltyRecipient, royaltyValue);
