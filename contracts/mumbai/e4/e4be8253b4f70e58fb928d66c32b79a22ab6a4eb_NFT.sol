...
// File: contracts/cossacks_test.sol
...
contract NFT is ERC721Enumerable, Ownable {
  ...
  uint256 public cost = 0.16 ether; //цена за минт 1 нфт
  uint256 public maxSupply = 10000; // количество нфт в вашей коллекции
  uint256 public maxMintAmount = 100; //количество нфт которое можно сминтить при 1 транзакции
  uint256 public nftPerAddressLimit = 100; //максимальное колечество нфт которое может сминтить 1 адрес
  ...
  address payable commissions = payable(0x5102f14E494540950Bb942e5d507b6E2509c8820); // адрес куда будут поступать коммисии с перепродаж ваших нфт, вместо моего адреса напиши свой
