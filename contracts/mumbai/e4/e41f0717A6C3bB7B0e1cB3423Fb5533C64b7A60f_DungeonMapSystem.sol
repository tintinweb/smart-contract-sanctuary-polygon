    ...
    GameRegistryConsumerUpgradeable
{
    ...
    function setDungeonMap(
        ...
        uint256 dungeonEntity = EntityLibrary.tokenToEntity(
            address(this),
            dungeon
        );
        ...
        _setDungeonMap(dungeonEntity, dungeonMap);
    }
    ...
    function getDungeonMap(
        uint256 dungeon
    ) external view virtual override returns (DungeonMap memory) {
        return dungeonMaps[dungeon];
    }
    ...
    function getDungeonNode(
        ...
        return dungeonMaps[dungeon].nodes[node];
    }
    ...
    function getDungeonNodeEnemy(
        ...
        return dungeonMaps[dungeon].nodes[node].enemies[enemyIndex];
    }
    ...
    function getDungeonNodeLoots(
        ...
        return dungeonMaps[dungeon].nodes[node].loots;
    }
    ...
    function _setDungeonMap(
        ...
        dungeonMaps[dungeon] = dungeonMap;

        // Emit dungeon created event.
        emit DungeonMapUpdated(dungeon, dungeonMap.startAt, dungeonMap.endAt);

        // Emit an event for each node in the dungeon map.
        DungeonNode memory node;
