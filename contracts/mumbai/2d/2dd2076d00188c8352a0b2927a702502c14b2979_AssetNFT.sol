...
// OpenZeppelin Contracts (lastupdated v4.7.0) (token/ERC721/IERC721.sol)
...
contract AssetNFT is ERC721Enumerable, IAssetNFT, Ownable {
    ...
    function createAsset(
        ...
        require(initialMetadata.dueDate > initialMetadata.fundsAdvancedDate + 20 days, "Asset due within 20 days");
