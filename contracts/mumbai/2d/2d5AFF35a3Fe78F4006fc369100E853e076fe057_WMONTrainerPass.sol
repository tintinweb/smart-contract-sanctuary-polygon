...
contract WMONTrainerPass is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    require(supply + _mintAmount <= guard, "We are on boarding a few users at a time, please wait for next minting round");
  ...
  function setCost(uint256 _newCost) public onlyOwner {
    ...
    function setGuard(uint256 _newMint) public onlyOwner {
    guard = _newMint;
  }
