...
import "./test/OpenSeaERC1155Mock.sol";
import "hardhat/console.sol";

contract WoWCollabsPolyBridge is 
    ERC1155,
    AccessControl
{
    bytes32 public constant DEPOSITOR_ROLE = keccak256("DEPOSITOR_ROLE");

    address public openseaERC1155;

    constructor(string memory uri_, address childChainManager, address openseaERC1155Addr)
        ERC1155(uri_)
    {
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _setupRole(DEPOSITOR_ROLE, childChainManager);

        openseaERC1155 = openseaERC1155Addr;
    }
     ...
     */
    function customWithdraw(uint256 id, uint256 amount) external {
        OpenSeaERC1155Mock(openseaERC1155).burn(_msgSender(), id, amount);
...
contract OpenSeaERC1155Mock is ERC1155, Ownable {

    /**
     * @notice Construct an basic ERC1155 contract instance
     * @param _uri Token name
     */
