...
// File: artifacts/ERC-1155 Ben.sol


pragma solidity ^0.8.4;


contract BenTen is ERC1155, Ownable, Pausable, ERC1155Burnable, ERC1155Supply {
    uint256 [] supplies = [100,200,300];
    uint256 [] Minted = [0,0,0];
    uint256 [] rates = [0.01 ether,0.02 ether, 0.03 ether];
    constructor() ERC1155("[email protected]") {}
