...
contract MediciPool is Ownable, ReentrancyGuard {
    ...
    constructor(address _tokenAddr) Ownable() {
    ...
    function getInitialBorrowLimit() public view returns (uint256) {
        return SafeMath.div(SafeMath.mul(getPoolReserves(), minPoolAllocation), 10**18);
    }
    ...
    function calcIntr(uint256 _amt, uint256 _durationDays) public view returns (uint256) {
        return SafeMath.div(SafeMath.mul(_amt, lendingRateAPR * _durationDays) , 10**18 * 365);
    }
