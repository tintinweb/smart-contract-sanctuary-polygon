...
contract FactoryMarketplaceERC1155 {
    KeySpaceERC1155NFTMarketplace[] public deployedContracts;
    ...
    event ERC1155NFTMarketplaceCreated(
        address owner,
    ...
    function deployNFTMarketplaceContract(
        ...
        KeySpaceERC1155NFTMarketplace newContract = new KeySpaceERC1155NFTMarketplace(
            _feePercent,
            _listingFee,
            _marketplaceId,
            _originatingWallet
        ...
        emit ERC1155NFTMarketplaceCreated(
            msg.sender,
            address(newContract),
            _marketplaceId
        );
