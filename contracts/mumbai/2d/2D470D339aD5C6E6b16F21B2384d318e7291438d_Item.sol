...
contract Item is ERC721, Ownable{
    ...
    constructor (address _auraAddress, address _fuseBlockAddress) ERC721 ("Item NFT", "IN") {
    ...
    function mint(address _address, uint256 _amount, string memory _tokenURI) public onlyFuseBlock{
