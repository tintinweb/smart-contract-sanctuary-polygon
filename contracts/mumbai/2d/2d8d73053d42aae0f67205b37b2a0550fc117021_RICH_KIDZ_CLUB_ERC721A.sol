...
/* 	IERC20 public constant USDC = IERC20(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48);
	...
	IERC20 public constant USDC = IERC20(0x92B6d70E1745B264FAF7599e647e56b183D8Dc26);
	IERC20 public constant USDT = IERC20(0x92B6d70E1745B264FAF7599e647e56b183D8Dc26);
    ...
    function markAsRedeemed(uint256[] calldata tokenIds) public onlyOwner {
		for(uint256 tokenId = 0; tokenId < tokenIds.length; tokenId = tokenId.unsafeInc()) {
            require(_exists(tokenIds[tokenId]), "Token does not exist");
    ...
    function tokenURI(uint256 tokenId) public view override returns(string memory) {
        ...
        if (isRedeemed)
        return string(abi.encodePacked(_revealedBaseURI, _toString(tokenId),"/NFTRedeemed"));
		else
		return string(abi.encodePacked(_revealedBaseURI, _toString(tokenId),"/NFTNoRedeemed"));
    }
