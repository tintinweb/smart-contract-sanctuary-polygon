...
contract SupplierUtilityContract is AccessControl, ERC1155 {
    ...
    */
    event SetContractURI(string contract_uri);
    ...
    * @notice This function can only be called by a contract with `FACTORY_CONTRACT_ROLE`
    */
    function setURI(uint256 _id, string memory _newuri) public onlyRole(FACTORY_CONTRACT_ROLE) {
        _setURI(_id,_newuri);
    }
    ...
    * @notice This function can only be called by a contract with `SUPPLIER_CONTRACT_ROLE`
    */
    function mint(address account, uint256 id, uint256 amount, string memory _newuri, bytes memory data) public onlyRole(SUPPLIER_CONTRACT_ROLE) {
