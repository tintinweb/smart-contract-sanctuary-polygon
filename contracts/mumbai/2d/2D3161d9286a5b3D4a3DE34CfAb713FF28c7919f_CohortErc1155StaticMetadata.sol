...
contract CohortErc1155StaticMetadata is ERC1155PresetMinterPauser, ERC1155Supply {
    string public name;
    ...
    constructor(
        ...
        setUri(_tokenMetadataUri);
    }

    function setContractMetadataUri(string memory _contractMetadataUri) public {
        require(
            hasRole(MINTER_ROLE, _msgSender()),
            "Must have minter role to set contract metadata"
        );
    ...
    function setUri(string memory newuri) public {
        require(
            hasRole(MINTER_ROLE, _msgSender()),
            "Must have minter role to set token metadata"
        );
        _setURI(newuri);
    }
