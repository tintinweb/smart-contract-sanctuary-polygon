...
contract XYZC is Ownable, ReentrancyGuard {
    using SafeMath for uint256;

    uint256 public developerFee = 600; // 600 : 6 %. 10000 : 100 %
    uint256 public rewardPeriod = 1 days;
    uint256 public withdrawPeriod = 9 weeks;
    uint256 public apr = 160; // 160 : 1.6 %. 10000 : 100 %
