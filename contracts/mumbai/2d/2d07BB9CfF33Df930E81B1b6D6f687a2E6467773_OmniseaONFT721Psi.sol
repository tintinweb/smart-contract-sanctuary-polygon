...
contract OmniseaONFT721Psi is ONFT721Core, IOmniseaONFT721Psi, ERC721Psi, IERC2981Royalties, ReentrancyGuard {
    ...
    address private immutable _lzEndpoint = 0xf69186dfBa60DdB133E91E9A4B5673624293d8F8;
    IOmniseaDropsScheduler private immutable _scheduler = IOmniseaDropsScheduler(0xF5a7BaBd4647E512839e671AF72818d1280DaA01);
    IOmniseaPaymentsManager private immutable _paymentsManager;
    ...
    constructor(
        ...
        _paymentsManager = IOmniseaPaymentsManager(IOmniseaDropsManager(dropsManager).paymentsManager());
    }
