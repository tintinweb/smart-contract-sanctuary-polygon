...
contract PepesAJoke is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard { 
  ...
  string public uri = 'ipfs://QmTMo21zVafXpYcMb1k9RsxNNzufgtcEq6vdZZoPro3gY9/';  // Instant reveal // SHOULD CHANGED
  
  uint256 public cost = 0.0002 ether; // SHOULD CHANGED
  uint256 public maxSupply = 6969;
  uint256 public maxPerWallet = 10; 
  bool public paused = true;  
  address public PROJECT_WALLET = 0x41d8120807012fE2109dF898C2009dA155a676fb; //Owner // SHOULD CHANGED
  address public DEV_WALLET = 0xd43D74Ea757A5565374b90844B8AaD7DE5A84E58; //DEV // SHOULD CHANGED

  constructor() ERC721A("ASDASDA", "ASDASDA") {} // SHOULD CHANGED
