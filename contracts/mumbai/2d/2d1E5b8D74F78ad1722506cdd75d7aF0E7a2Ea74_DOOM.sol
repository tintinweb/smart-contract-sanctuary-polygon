...
contract DOOM is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, OwnableUpgradeable, ERC20PermitUpgradeable, ERC20VotesUpgradeable {
    ...
    // Address of the main app
    address public appAddress;

    // Address of the handles app
    ...
    function setAddresses(address _app, address _handles) public onlyAdmins{
        appAddress = _app;
    ...
    // Mint the amount of DOOM you want (in ether)
    function publicMint(uint256 amount) public whenNotPaused payable {
        ...
        sendValue(payable(vaultAddress), address(this).balance);
    ...
    // Pulled from Address.sol from OZ
    function sendValue(address payable recipient, uint256 amount)  internal {
        require(address(this).balance >= amount, "Address: insufficient balance");
