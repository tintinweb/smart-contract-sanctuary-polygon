...
contract TAHI3 is ERC721, Ownable {
  using Strings for uint256;
  ...
  //cost = 20 Matic.
  uint256 public cost = 20000000000000000000 wei;
  ...
  constructor() ERC721("Tahi 3 Collection", "TH3C") {
  ...
  function withdraw() public onlyOwner {
    ...
    // This will pay Charity Wallet 20% of the initial sale.
     (bool hs, ) = payable(0xCeDC49Fa570d4185D6676C11C2fEd5e4B80CcAAD).call{value: address(this).balance * 20 / 100}("");
    require(hs);
