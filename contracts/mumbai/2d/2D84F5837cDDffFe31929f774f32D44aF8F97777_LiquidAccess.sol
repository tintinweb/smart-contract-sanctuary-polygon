                ...
                Base64.encode(
                    bytes(
                        abi.encodePacked(
                            ...
                            '"image": "https://liquidaccess-public.s3.amazonaws.com/icon.png",',
                            '"attributes": [',
        ...
        string(
            abi.encodePacked(
                ...
                Base64.encode(
                    bytes(
                        abi.encodePacked(
                            '{"name": "LA contract name", "description": "LA contract description", "image": "https://liquidaccess-public.s3.amazonaws.com/icon.png", "seller_fee_basis_points": 500, "fee_recipient": "0x9f3bD266ff67481d70751b5f8bd223A94601b71e"  }'
                        )
                    )
                )
            )
