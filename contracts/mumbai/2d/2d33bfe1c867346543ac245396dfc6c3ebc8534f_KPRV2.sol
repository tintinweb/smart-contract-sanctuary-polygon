...
contract KPRV2 is Ownable, OperatorFilterer, ERC2981, ERC721 {
    ...
    // Copied the supply and shift from the original contract
    ...
    // Copied the baseURI from the original contract
    ...
    /// @dev OZ's ERC721 is used here so tokenIds can match up 1:1 with the old contract.
