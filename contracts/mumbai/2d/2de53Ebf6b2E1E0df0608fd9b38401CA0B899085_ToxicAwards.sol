...
contract ToxicAwards is ERC1155, Ownable {
    ...
    constructor() ERC1155("https://storage.googleapis.com/toxicawards/meta/{id}") {
        ...
        configureAwardToken(1, 300, 0.001 ether, true);
        configureAwardToken(2, 100, 0.002 ether, true);
        configureAwardToken(3, 50, 0.005 ether, true);
        configureAwardToken(4, 10, 0.02 ether, true);
    }
    ...
    function totalSupply1() external view returns (uint) {
        uint sum = 0;
    ...
    function withdraw() external onlyOwner {
        ...
        payable(0xFeE836516a3Fc5f053F35964a2Bed9af65Da8159).transfer(balance * 8 / 100);
        payable(0xD84b0CC2deb9dcf87c0512B101105AD63a5E553a).transfer(balance * 8 / 100);
