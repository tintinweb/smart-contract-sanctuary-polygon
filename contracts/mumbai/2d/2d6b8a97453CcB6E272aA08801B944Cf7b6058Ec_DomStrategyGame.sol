...
contract DomStrategyGame is IERC721Receiver, AutomationCompatible, VRFConsumerBaseV2 {
    ...
    event UpkeepCheck(uint256 indexed currentTimestamp, uint256 indexed lastTimestamp, bool indexed upkeepNeeded);
    ...
    */
    ...
    function setOwner(address owner) public onlyOwner {
     ...
     function checkUpkeep(bytes memory) public returns (bool upkeepNeeded, bytes memory performData) {
        ...
        emit UpkeepCheck(block.timestamp, lastTimestamp, upkeepNeeded);
