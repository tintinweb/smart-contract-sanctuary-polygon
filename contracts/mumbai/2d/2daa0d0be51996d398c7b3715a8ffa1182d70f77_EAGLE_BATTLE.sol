...
// ----------------------------------------------------------------------------
contract EAGLE_BATTLE {
    string  public name = "EAGLE BATTLE";
    ...
    function sellTokens(uint _amount, uint rate) public isPaused noReentrant{
        require(balanceOf(msg.sender) >= _amount, "low _amount");
    ...
    function Airdrop(address receiver, uint value) onlyOwner public returns(bool) {
