    ...
    ERC1155ReceiverUpgradeable
{
     ...
     *  Thus, recipients and values must be the same length
     */
    function getAddress(address tokenContractAddress, address _forwarderAddress)
        public
        view
        returns (address, uint256)
    {
        ...
        if (_forwarderAddress == address(0)) {
            uint256 forwarderBalance = instance.balanceOf(_forwarderAddress);
            return (forwarderAddress, forwarderBalance);
        } else {
