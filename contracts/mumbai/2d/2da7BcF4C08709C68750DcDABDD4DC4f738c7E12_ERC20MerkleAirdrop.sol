...
contract ERC20MerkleAirdrop is Ownable {
    ...
    bytes32 public immutable merkleRoot = 0x6a0a4ef51db34479fa4a8e1c5633459dfa863c1b23b29dd2004ce59bf860f877;
    ...
    uint256 public immutable startAt = 1671273781097;
    uint256 public immutable endAt = 1672425000000;

    //id of airdrop created in database
    uint256 public immutable airdropID = 29;

    //comes from template too
    uint256 public immutable totalTokens = 0x8ac7230489e80000;
    uint256 public claimedTokens  = 0;
    uint256 public availableTokens = 10000000000000000000;
