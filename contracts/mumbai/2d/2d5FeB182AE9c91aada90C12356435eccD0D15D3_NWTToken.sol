...
contract NWTToken is ERC20, Ownable {
    ...
    uint256 public maxTxAmount = 9000000000 * (10**18); // Initial Max Tx Amount
    uint256 public maxOwnedAmount = 9000000000 * (10**18);
    ...
    constructor() ERC20("Ninja Warrior Token", "NWT") {
        ...
        _mint(0x3bc41Cf2f21c03E182Fc3167Bdeda7F6B7eBF674, 100000000 * (10**18));
        ...
        onlyOwner
    {
        ...
        totalFeesOnBuy = redistributionFeeOnBuy
            .add(teamFeeOnBuy)
            .add(marketingFeeOnBuy)
            .add(liquidityFeeOnBuy)
            .add(charityFeeOnBuy);
        totalFeesOnSell = redistributionFeeOnSell
            .add(teamFeeOnSell)
            .add(marketingFeeOnSell)
            .add(liquidityFeeOnSell)
            .add(charityFeeOnSell);
    ...
    function swapTokens(uint256 tokenAmount) private {
        ...
        if (nativeForRedistribution > 0) {
            transferNativeToRedistributionWallet(nativeForRedistribution);
        }
        if (nativeForTeam > 0) {
