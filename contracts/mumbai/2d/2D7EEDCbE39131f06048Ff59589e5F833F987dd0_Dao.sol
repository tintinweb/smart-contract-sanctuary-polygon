...
contract Dao {
	...
	constructor() {
		...
		validTokens = [50950578424440834126685482647016227519072956219506415086999753848389254512641];
	}
	...
	function createProposal (string memory _description, address[] memory _canVote) public {
		...
		//To set the validity period of this proposal, 100 is the time for 100 blocks to be created onto the blockchain
	...
	//Function to count the votes to check whether this proposal was passed or not
