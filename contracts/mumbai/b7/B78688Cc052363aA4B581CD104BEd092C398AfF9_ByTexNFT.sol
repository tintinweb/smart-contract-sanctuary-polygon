...
// import "contracts/IBasicMetaTransaction.sol";
// import "hardhat/console.sol";

contract ByTexNFT is BasicMetaTransaction, ERC721URIStorageUpgradeable, OwnableUpgradeable {
    ...
    function mint(address merchant, uint256 tokenId, string memory tokenURI) external onlyOwner {
    ...
    function burn(uint256 tokenId) external {
        if (_msgSender() != address(exchange)) {
