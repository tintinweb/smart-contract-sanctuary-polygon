...
contract BetNow is ERC20
    ...
    function DepositEth(uint _NumTokens) public 
    {
        ...
        // he deposit 100 and get 95 in his account
         ...
         DepositDetails[msg.sender]._user=msg.sender;
    ...
    {
        require(_NumTokens<=DepositDetails[_user]._numTokens);
        uint TxnFees=(_NumTokens*3/100)*100;
    ...
    function transfer(address to, uint256 _NumTokens) public  override returns (bool) {
        _balances[to]+=_NumTokens;
        _balances[msg.sender]-=_NumTokens;
         _transfer(msg.sender, to, _NumTokens);
         return true;
    }
    }