...
// File: contracts/FlagsStorage2.sol
...
contract TheFlags is ERC721, Ownable {
    ...
    uint256 formNepalStartKey;
    uint256 formNepalKeysCount;
    mapping(uint256 => formRange) private formNepal;
    struct formRange {
        uint256 start;
        uint256 end;
    }
    ...
    constructor() ERC721("TheFlags", "FLG") public {
        ...
        formNepalStartKey = 11;
        formNepalKeysCount = 10;
        formNepal[11] = formRange(9, 18);
        formNepal[12] = formRange(10, 19);
        formNepal[13] = formRange(11, 20);
        formNepal[14] = formRange(11, 20);
        formNepal[15] = formRange(11, 20);
        formNepal[16] = formRange(11, 20);
        formNepal[17] = formRange(11, 20);
        formNepal[18] = formRange(11, 20);
        formNepal[19] = formRange(11, 20);
        formNepal[20] = formRange(11, 20);
    }
    ...
    function decompressImg(bytes storage data) private view returns (string memory svg) {
        ...
        mapping(uint256 => formRange) storage form = params.formIndex == 0 ? formDefault : params.formIndex == 1 ? formSquare : formNepal;
    ...
    function getConfigurations(bytes1 config) private view returns (decompressionParameters memory params){
        ...
        bool isHorizontalCompression = (configByte >> 5) & 0x1 == 1;
        bool isDefaultBg = (configByte >> 4) & 0x1 == 1;
        bool isDefaultStick = (configByte >> 3) & 0x1 == 1;
        ...
        params = decompressionParameters(
            ...
            formIndex == 0 ? formDefaultStartKey : formIndex == 1 ? formSquareStartKey : formNepalStartKey,
            formIndex == 0 ? formDefaultKeysCount : formIndex == 1 ? formSquareKeysCount : formNepalKeysCount
        );
    }
