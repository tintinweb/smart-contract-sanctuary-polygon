...
contract AlligatorMerge is Ownable, VRFConsumerBaseV2, IMergeGators {
    ...
    function merge(uint256 _1st, uint256 _2nd, uint256 _3rd) public payable {
        ...
        bytes memory skeleton = abi.encode(
            _1stType[0],
            _2ndType[0],
            _3rdType[0],
            _4thType[0],
        ...
        bytes memory levels = abi.encode(
            _1stType[1],
            _2ndType[1],
            _3rdType[1],
            _4thType[1],
        ...
        bytes memory mergeParams = abi.encodeWithSignature("merge(uint256, uint256, uint256, address, bytes, bytes)",
        _1st, _2nd, _3rd, msg.sender, skeleton, levels);
...
contract AlligatorMergeMock is AlligatorMerge {
    ...
    //11
    address constant collection = 0xB6668abaD33f6c9CC17D43801f66d8903f86e26D;
