...
//----------Voting
    ...
    function createProposal(
        ...
        ProposalList[proposalCounter] = Proposal(coordinator,title,description,0,0,startDate,endDate,proposalURI);


        emit ProposalCreated(groupId,title,description,proposalCounter,startDate,endDate,proposalURI);
    }
