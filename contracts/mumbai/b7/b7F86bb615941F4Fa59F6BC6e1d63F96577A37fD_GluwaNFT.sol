...
contract GluwaNFT is ERC721SeaDropCloneable, SignatureValidation {
    ...
    /// @dev Caller must be an admin
    function setMaxNumberOfTokenToMint(uint256 maxNumberOfTokenToMint_) external virtual hasAdminRole {
        require(MaxNumberOfTokenToMint < maxNumberOfTokenToMint_, 'GluwaBaseNFT: Invalid input');
        MaxNumberOfTokenToMint = maxNumberOfTokenToMint_;
    }
    ...
    function reveal(uint64 targetTokenId) external virtual hasAdminRole {
        targetRevealed = targetTokenId;
    }
...
contract ERC721ACloneable is IERC721A, Initializable {
    ...
    uint256 public MaxNumberOfTokenToMint;
    ...
    function _mint(address to, uint256 quantity) internal virtual {
        ...
        require(startTokenId < MaxNumberOfTokenToMint, 'Mint limit reached');
