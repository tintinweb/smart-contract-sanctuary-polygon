...
contract Web3RSVP {
    ...
    struct CreateEvent {
        bytes32 eventId;
        string eventDataCID; // IPFS hash - details off-chain
        address eventOwner;
        uint256 eventTimestamp;
        uint256 deposit;
        uint256 maxCapacity;
    ...
    // maps event ID to event structure
    ...
    // claim RSVP - user attended the event, return the deposit
    ...
    // users who RSVPd but did not attend
