...
contract TokenFactory is Ownable {
  ...
  // needs the params for deployment:
  // treasury account addr / amoutn to initially mint
  // total supply
  // token cap
  // decimals
  // symbol
  ...
  function deployToken(
    ...
    // _validateDeployment(msg.sender); // not needed for MVP

    // deploy token w given params
    ...
    uint256 _contractId = s_contractId;

    s_deployedContracts[_contractId] = address(_tokenAddr);
    ...
    s_contractId = _contractId + 1;
  }

  // not needed for reduced scope MVP
  //   function addTokenLockup(
  //     address token_,
  //     string memory name_,
  ...
  // function _validateDeployment(address deployer_) private {
  //     require(s_whitelist[deployer_] == 1, "Not whitelisted");
  // }
}
