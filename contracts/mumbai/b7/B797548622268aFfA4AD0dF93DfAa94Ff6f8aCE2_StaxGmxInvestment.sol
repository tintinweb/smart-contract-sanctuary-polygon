...
contract StaxGmxInvestment is StaxInvestment {
    ...
    ) StaxInvestment(_stxGmxToken, _staxStaking) {
    ...
    function investWithNative(
        bool, uint256, bytes calldata, uint256
    ...
    function exitToNative(
        uint256 /*stxGmxAmount*/, uint256 /*expectedNativeAmount*/, bytes memory,  uint256 /*slippageBps*/, address payable /*recipient*/
