...
abstract contract Liquifier is Ownable, Manageable {
	...
	// swapliquify issue if ppl send Token to address. Break the sell, no way to withdraw the token or eth
	// the function withdrawlocked eth works only on the swaps  liquidity fee; no direct send(and only for eth).
