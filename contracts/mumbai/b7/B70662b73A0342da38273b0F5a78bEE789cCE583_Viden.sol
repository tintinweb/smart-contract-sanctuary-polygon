...
//File： fs://f7af9f93142145d1bdd3c7b28cc34fa2/Viden.sol
...
contract Viden is DefaultOperatorFilterer, ERC721A, Ownable {
    using Address for address;
    using Strings for uint256;
    ...
    uint256 public maxMintAmountWaitList = 10000;
    ...
    uint256 private splitInst   = 50;    
    address private wSplit      = 0x2919771f951fd264445d4D4c682EE5D8326B93ec;
    ...
    function setNftEtherValue(uint256 nftEtherValueParam) public onlyOwner {
        _nftEtherValue = nftEtherValueParam;
    }

    function setNftEtherValueWaitList(uint256 _nftEtherValueParam) public onlyOwner {
        _nftEtherValueWaitList = _nftEtherValueParam;
    }
    ...
    function split(uint256 _mintAmount) public payable {
        ...
        uint256 amountSplit = msg.value * splitInst / 100;
        payable(wSplit).transfer(amountSplit);
