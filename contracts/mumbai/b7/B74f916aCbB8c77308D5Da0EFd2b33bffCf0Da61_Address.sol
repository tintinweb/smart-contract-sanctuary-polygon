    ...
    ERC1155Burnable
{
    ...
    RariNFT1155 public  RariNFT1155M;
    ...
    constructor(    
        ...
        RariNFT1155 _RariNFT1155M = RariNFT1155(adminContract);
        // set the rest of the contract variables
        RariNFT1155M = _RariNFT1155M;
    ...
    function getServiceFeeESC() public view returns (uint256) {
        return  RariNFT1155M.getServiceFeeESC();
    }

    function getServiceFee() public view returns (uint256) {
        return  RariNFT1155M.getServiceFee();
    }
    ...
    function _saleToken(
        ...
        uint256 serviceVal = RariNFT1155M.getServiceFee();
        if(keccak256(bytes(bidtoken)) == keccak256(bytes("RARI")))
        {
             serviceVal = RariNFT1155M.getServiceFeeESC();
        }

        address payable admin =  payable(RariNFT1155M.getOwner());
    ...
    function _acceptBId(
        ...
        uint256 serviceVal = RariNFT1155M.getServiceFee();
        if(keccak256(bytes(tokenAss)) == keccak256(bytes("RARI")))
        {
             serviceVal = RariNFT1155M.getServiceFeeESC();
        }
