...
contract GroupFacet is IGroup {
    function join(address member) external payable override {
        LibGroup._join(member);
    }

    function join() external payable override {
        LibGroup._join();
    }
