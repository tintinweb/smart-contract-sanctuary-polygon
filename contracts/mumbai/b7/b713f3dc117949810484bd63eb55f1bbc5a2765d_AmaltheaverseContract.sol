...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmRAmTacLgDFLQzDDDCkdNxdPZxWaBdKnRk3BcuLVBFYUz/";
...
// File: contracts/AmaltheaverseContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AmaltheaverseContract is RamppERC721A {
    constructor() RamppERC721A("Amaltheaverse", "AMTV"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/ez7cKViyBUKaLCYhDlxB/contract-metadata";
    }
}
