...
contract MyCustomNFT is ERC721SeaDrop {
    ...
    /**
     * @notice Batch transfer NFTs to a specified recipient.
     * @dev The caller must be the contract owner.
     * @param recipient The address to which NFTs will be transferred.
     * @param tokenIds The array of token IDs to be transferred.
     */
    function batchTransfer(address recipient, uint256[] calldata tokenIds) external onlyOwner {
