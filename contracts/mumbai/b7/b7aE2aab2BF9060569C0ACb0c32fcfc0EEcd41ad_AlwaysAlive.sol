...
contract YieldAggregator {
    ...
    // This is actually the aMATIC Token Address
    address aWETHTokenAddress = 0x89a6AE840b3F8f489418933A220315eeA36d11fF;
    ...
    function withdrawMatic(uint256 amount, address kin) public {
        bool approved = IERC20(aWETH).approve(WETHGateWayAddress, amount);
