...
contract ERC721 {
    ...
    uint256 private totalSupply = 48;
    ...
    constructor() {
        tokenName = "ERC721";
        tokenSymbol = "NFT";
        baseURI = "https://nftstorage.link/ipfs/bafybeig3fwb47bn5k2cm72riblhtyh7og4nog3s5wklbenpof4gfrjuap4/";
    }
    ...
    function mint(address _to, uint256 _tokenId) public {
        ...
        require(tokensMinted <= totalSupply, "Please mint less than Max NFT (Total NFTs: 48)");
        tokensMinted += 1;
        owners[_tokenId] = _to;
        nftsOf[_to].push(_tokenId);
        balances[_to] += 1;
