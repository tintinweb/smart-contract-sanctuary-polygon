    ...
    ERC1155SupplyUpgradeable
{
    ...
    function uri(uint256 tokenId) public view virtual override returns (string memory) {
        return string(abi.encodePacked("https://storage.googleapis.com/e3go-metadatas/", StringsUpgradeable.toHexString(address(this)), "/", StringsUpgradeable.toString(tokenId)));
    }
