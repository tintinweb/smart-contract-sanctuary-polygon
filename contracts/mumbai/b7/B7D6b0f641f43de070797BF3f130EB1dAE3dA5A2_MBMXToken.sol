...
contract MBMXToken is ERC20Upgradeable, OwnableUpgradeable, PausableUpgradeable {
    ...
    */
    function revertTransfer(bytes32 msgHash) public {
...
contract SecuredTransfer is Ownable {
    ...
    */
     ...
     * @param from sender address
    */
    function getUserSentTransfers(address from) public onlyOwner view returns (transactionInfo[] memory) {
    ...
    */
    ...
    onlyOwner 
    {
        ...
        require(info.to != address(0), "SafeTransfer: invalid hash");
