...
// Contract module which provides a basic access control mechanism, where there is an account (an owner) that 
// can be granted exclusive access to specific functions.

contract EyeNFT is ERC721Enumerable, Ownable {
    using Strings for uint256; // what is this

    string public baseURI;
    string public baseExtension = ".json";
    uint256 public cost = 5 ether; // general 
    uint256 public presaleCost = 3 ether; // Presale
    uint256 public maxSupply = 50;
    uint256 public maxMintAmount = 4; //per wallet
    bool public paused = false;
    mapping(address => bool) public whitelisted;
    mapping(address => bool) public presaleWallets;
    // address public reciever = 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4;
    ...
    function getContractBalance() public view returns(uint256){
        return address(this).balance; //contract balance
    }
