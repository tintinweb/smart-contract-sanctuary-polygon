...
// File: contracts/LP Farms/StrategyV3.sol
...
contract StrategyV3 is Ownable, ReentrancyGuard, Pausable {
    ...
    address public farmContractAddress  = 0xE876eCE104c50bBfBA473A78500CB1d41b8d732D ; // address of farm, eg, PCS, Thugs etc.
    uint256 public pid = 1; // pid of pool in farmContractAddress
    address public wantAddress = 0x69B126538e89194EC895250f5ad196D364c8FB67;
    address public token0Address = 0x65B1A7066D51499DC6F5284c81645d6051D2ca67;
    address public token1Address = 0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889;
    address public earnedAddress = 0xA643d0bC2EA22C31968740C793af6420AAAbe00b;
    address public uniRouterAddress = 0x0Ba6C5bB5C515584B6dC2ee5C7afF40c393d9799; // uniswap, pancakeswap etc
    address public buybackRouterAddress = 0x0Ba6C5bB5C515584B6dC2ee5C7afF40c393d9799; // uniswap, pancakeswap etc
    uint256 public routerDeadlineDuration = 300;  // Set on global level, could be passed to functions via arguments

    address public wbnbAddress = 0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889;
    ...
    function deposit(uint256 _amount)
        ...
        returns (uint256)
    {
        uint256 pool = IERC20(wantAddress).balanceOf(address(this));
        ...
        user.cakeAtLastUserAction = user.shares.mul(IERC20(wantAddress).balanceOf(address(this))).div(totalShares);
        ...
        nonReentrant
    {
        ...
        uint256 currentAmount = (IERC20(wantAddress).balanceOf(address(this)).mul(_shares)).div(totalShares);
        user.shares = user.shares.sub(_shares);
        totalShares = totalShares.sub(_shares);

        uint256 bal = IERC20(wantAddress).balanceOf(address(this));
        if (bal < currentAmount) {
            uint256 balWithdraw = currentAmount.sub(bal);
            IXswapFarm(farmContractAddress).withdraw(pid, balWithdraw);
            uint256 balAfter = IERC20(wantAddress).balanceOf(address(this));
        ...
        IERC20(wantAddress).safeTransfer(msg.sender, currentAmount);
    }
