...
contract GaiaLand is ERC721, Ownable {
  ...
  address private immutable PGAIAAddress =
    0xa8b062dE9dB7D22D6Ad6ef64Dc6FE53B3cba4A80;

  bytes32 public merkleRoot = 0x59623e1560b4a1e77ba4790607eaeaac52b6092a874289e332132c601e4a8f77;
  mapping(address => uint256) public whiteListAmountsMap;
  ...
  function setWhiteListMerkle(bytes32 merkle) external onlyOwner {
    merkleRoot = merkle;
  }
  ...
  function selectedMintGaiaLandToken(
    ...
    // require(whiteListAmountsMap[msg.sender] + numberOfGoodLands + numberOfRegularLands <= amount, 'WhiteList OverAmount');

    // bytes32 node = keccak256(abi.encodePacked(index, msg.sender, amount));
    // require(MerkleProof.verify(merkleProof, merkleRoot, node), 'Invalid proof.');

    // whiteListAmountsMap[msg.sender] = whiteListAmountsMap[msg.sender] + numberOfGoodLands + numberOfRegularLands;
