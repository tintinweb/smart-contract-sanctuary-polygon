    ...
    CrowdsaleAccessControl
{
    ...
    /**
     * @dev owner can set new cap through the setter function
     * @param _cap new value for cap
     */
    ...
    function buyTokensPresale(bytes32[] calldata _proof) public payable {
        ...
        if (purchase[_beneficiary] == 0) {
            require(
                isValidMerkleProof(_beneficiary, _proof),
...
abstract contract Crowdsale {
    ...
    //For empty call data (and any value)
