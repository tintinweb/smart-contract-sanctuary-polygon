    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 15, 15) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeihno3qai77v3h63tvnbxo5bqvahyzqnq6hcfl2in7lijqu4pecefi/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/KK57lydVWScmtkLQUkze/contract-metadata";
  }
...
// File: contracts/Numbernft2Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Numbernft2Contract is ERC721APlus {
    constructor() ERC721APlus("number nft 2", "nn2"){}
}
