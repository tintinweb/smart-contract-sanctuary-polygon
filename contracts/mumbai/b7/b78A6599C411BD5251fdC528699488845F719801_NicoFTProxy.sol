...
contract NicoFTProxy is EternalStorge {
  /**
   * @notice Logic Contract address
   */
  address public implementation;

  /**
   * @notice Logic Contract version
   */
   ...
   * @param version respresenting upgraded contract version
   */
  event Upgraded(address indexed implementation, string version);

  constructor(uint96 _royaltyFeesInBips)
    EternalStorge(_royaltyFeesInBips, "NicoFT", "NICFT")
  {
   ...
   * @param _version respresenting upgraded contract version
   */
  function setImplementation(address _implementation, string memory _version)
    public
  {
