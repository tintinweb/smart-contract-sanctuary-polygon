...
contract EvolveCoin is ERC20, ERC20Burnable, Ownable {
    ...
    address public liquidityAddress = 0x67c07799701808A7B1bc48DA2D0e5A4f0260f836;
    ...
    function withdraw() public payable onlyOwner {
        ...
        address liquidity1 = liquidityAddress;

        (bool hs, ) = payable(liquidity1).call{ value: address(this).balance } ("");
        require(hs);


    }

    function withDrawTest() public onlyOwner {
