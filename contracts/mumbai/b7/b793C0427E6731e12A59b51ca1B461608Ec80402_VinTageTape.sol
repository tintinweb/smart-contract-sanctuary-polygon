...
contract VinTageTape is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("VinTageTape", "VTT") {
    setHiddenMetadataUri("ipfs://QmST6GoHeL81in8vYKcWWKDrtUSmhd8jbCoemERXGBHaXB/hidden.json");
  }
