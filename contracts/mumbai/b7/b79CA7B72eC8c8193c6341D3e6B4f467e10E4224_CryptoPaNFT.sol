...
contract CryptoPaNFT is 
    ...
    //=============== variable =======================
        ...
        uint256 private __3thPrice = 0.0005 ether; // final mint price
        uint256 private __2ndPrice = 0.00035 ether; // level 2 mint price
        uint256 private __1stPrice = 0.00025 ether; // level 1 mint price
        uint256 private __3thLevel =30 ; // final level
        uint256 private __2ndLevel =15 ; // 2nd level
        uint256 private __MintPrice =__1stPrice ; // Default mint price
    ...
    //=============== calc function ======================
        ...
        function _getPrice() internal {
            uint256 totalMinted = totalSupply();
            __MintPrice=__1stPrice;
            if (totalMinted<=__3thLevel && totalMinted>__2ndLevel) {
                __MintPrice= __2ndPrice;
            }
            else if (totalMinted>__3thLevel) {
                __MintPrice= __3thPrice;
            }
        }
    //====================================================
        constructor() ERC721("CryptoPaNFT", "CPA") {
            _setDefault();
        }
    ...
    //=========================================
        ...
        function Mint(uint256 _numberToMint) external payable whenMintIsLive {
            ...
            if (totalMinted<__3thLevel && totalMinted+_numberToMint>__3thLevel) {
                _numberToMint=__3thLevel-totalMinted;
            }
            else if (totalMinted<__2ndLevel && totalMinted+_numberToMint>__2ndLevel) {
                _numberToMint=__2ndLevel-totalMinted;
            }
