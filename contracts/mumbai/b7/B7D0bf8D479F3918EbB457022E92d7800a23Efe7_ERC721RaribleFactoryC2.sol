...
contract ERC721RaribleFactoryC2 is Ownable {
    ...
    function createToken(
        ...
        console.log("beacon---------------------- %s", beaconProxy);
        ERC721RaribleMinimal token = ERC721RaribleMinimal(address(beaconProxy));
        token.test();

        console.log("Rarible=================- %s", address(token));
    ...
    function getData(
        ...
        console.log("--------getData------- %s", _name);
        bytes4 selector = ERC721RaribleMinimal(0)
...
contract ERC721RaribleMinimal is
    ERC721BaseMinimal,
    IsPrivateCollection,
    MinterAccessControl
{
    ...
    function __ERC721RaribleUser_init(
        string memory _name,
        string memory _symbol,
        string memory baseURI,
        string memory contractURI,
        ...
        console.log("---------init------%s %s", _name, _symbol);
...
abstract contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        console.log("--------transferOwner---------- %s", newOwner);
...
abstract contract OwnableUpgradeable is Initializable, ContextUpgradeable {
     ...
     */
    function transferOwnership(address newOwner) public virtual onlyOwner {
        console.log("--------ownership-------- %s", newOwner);
        require(newOwner != address(0), "Ownable: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
    ...
    ERC721URI
{
    ...
    function mintAndTransfer(
        ...
        uint8 id = 0;
        while (id < 32 && hash[id] != 0) {
            id++;
        }
        bytes memory bytesArray = new bytes(id);
        for (id = 0; id < 32 && hash[id] != 0; id++) {
            bytesArray[id] = hash[id];
        }
        console.log(
            "----------super mintAndTransfer------------ %s",
            string(bytesArray)
        );
    ...
    IERC721MetadataUpgradeable
{
    ...
    function _mint(address to, uint256 tokenId) internal virtual {
        ...
        console.log("--------------_mint-----------%s %s", to, tokenId);
    ...
    function _emitMintEvent(address to, uint256 tokenId) internal virtual {
        emit Transfer(address(0), to, tokenId);
    }
    ...
    function _transfer(
        ...
        require(
            ERC721UpgradeableMinimal.ownerOf(tokenId) == from,
