...
contract CreatorDAO is Initializable, OwnableUpgradeable, ERC2771ContextUpgradeable  {
    ...
    /*
        ...
        ········································|···························|·············|······························
        |  Methods                              ·               15 gwei/gas               ·       1583.52 usd/eth       │
        ·····················|··················|·············|·············|·············|···············|··············
        |  CreatorDAO        ·  setTreasury     ·          -  ·          -  ·      30238  ·            1  ·       0.72  │
        ·····················|··················|·············|·············|·············|···············|··············
    */
    ...
    ERC2771ContextUpgradeable  
{
    ...
    address constant DEFAULT_TREASURY = address(0x299eBF438F19823b7dF7720966e63C25995C3556);
    ...
    function initialize(
        ...
        royaltiesBasisPoints = (_royaltyBips <= 0) ? DEFAULT_PERCENTAGE : _royaltyBips;
    ...
    function getTreasury(address _creatorDAO) public view returns (address) {
        ...
        returns (address, uint256)
    {
        return (
            royaltiesAddress,
            (royaltiesBasisPoints * salePrice) / DEFAULT_PERCENTAGE
        );
    }
    ...
    */
    function mintToCaller(
        ...
        uint256 commission = calculateFee(msg.value, DEFAULT_PERCENTAGE);
        (bool com, ) = payable(DEFAULT_TREASURY).call{value: commission}("");
        require(com);

        uint256 balance = msg.value - commission;
        (bool os, ) = payable(getTreasury(daoContract)).call{value: balance}("");
        require(os);

        primarySalesRevenue += msg.value;
    ...
    function calculateFee(uint256 value, uint256 fee) internal pure returns(uint256) {
        uint256 result = SafeMath.div(SafeMath.mul(SafeMath.div(value, 1e3), fee), 10);
        return result;
    }
...
contract GenericProxyFactory is ERC2771ContextUpgradeable {
    ...
    function createDAOProxy(Config.DaoProxy memory _config) public {
        ...
        GenericProxy newProxy = new GenericProxy(
            master, data, MinimalForwarder(minimalForwarder)
        );

        emit ProxyCreated(address(newProxy));
    }

    function createCollectionProxy(Config.CollectionProxy memory _config) public {
        ...
        if(_config.isCollection) {
            Config.Deployment memory _deployConfig = _config.collection.deployConfig;
    ...
    function createMembershipProxy(Config.CollectionProxy memory _config) public {
...
interface IERC721Collection {
  ...
  function setRoyaltyAddress(address) external;
}
    ...
    ERC2771ContextUpgradeable  
{
    ...
    function getTotalSupply(string memory _tierId) public view returns(uint256) {
        bytes32 _givenTier = sha256(abi.encode(_tierId));
...
contract RoyaltySplitter is Initializable, OwnableUpgradeable, ERC2771ContextUpgradeable
{
    ...
    uint256 private DEFAULT_PERCENTAGE = 1000; // 10%

    mapping(address => uint256) private _shares;
    mapping(address => uint256) private _released;
    address[] private _payees;

    address payable private DEFAULT_TREASURY=payable(address(0xEab2B6b5a76d5878a7B5D97d7F6812Da09A30953));
    ...
    function release(address payable account) public virtual {
        ...
        // // Get commission and proceed with send
        // uint256 commission = calculateFee(payment, DEFAULT_PERCENTAGE);
        // (bool com, ) = DEFAULT_TREASURY.call{value: commission}("");
        // require(com);
        
        // uint256 balance = payment - commission;
    ...
    function _pendingPayment(
        ...
        // uint256 commission = calculateFee(totalClaimable, DEFAULT_PERCENTAGE);
