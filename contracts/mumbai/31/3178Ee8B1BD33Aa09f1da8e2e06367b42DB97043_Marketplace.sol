...
contract Marketplace is Exchange, IMarketplace, IERC721Receiver {
    ...
    function sellFractionInitial(
        ...
        (uint256 tokenToKeep, uint256 tokenToSell) = factory.initialTnftSplit(voucher);
        ...
        usdc.safeTransferFrom(address(this), tokenOwner, usdc.balanceOf(address(this)));
    }
    ...
    function buyFraction(
        ...
        if (share == remainingShare) {
            ...
            //to send usdc that marketplace received after fractionalizing
            usdc.safeTransferFrom(address(this), existing.seller, usdc.balanceOf(address(this)));
        }
    }
