...
import "../../traits/implementers/BadgeUInt8Implementer.sol";


contract BadgeUInt8Factory is BlackHolePrevention {
    ...
    event BadgeUint8ImplementerCreated(address b8,address traitRegAddress,uint16 _traitId,uint8 _defaultValue);
    ...
    function createBadgeUint8Implementer(
        uint32 communityId,
        ...
        BadgeUint8Implementer b8 = new BadgeUint8Implementer(traitRegAddress,_traitId,_defaultValue);
        ...
        emit BadgeUint8ImplementerCreated(address(b8),traitRegAddress,_traitId,_defaultValue);
    }

    // const NUMERIC_BADGE_TYPE = await StickerbookFactory.UINT8_BADGE() // 105
    //     let numBadge = {
    //         id: 4, 
    //         name : "NUMERIC BADGE",
    //         traitType: NUMERIC_BADGE_TYPE,
    //         start: 0, 
    //         end: 6000 ,
    //         storageImplementer: badge.address,
    //         ipfsHash: ""
    //     }
    ...
    function findMyTraitRegistry(uint32 projectID,  string memory traitRegistryName) internal returns (CommunityRegistry myCommunityRegistry,address traitRegAddress) {
        ...
        require(myCommunityRegistry.isUserCommunityAdmin(COMMUNITY_REGISTRY_ADMIN,msg.sender),"BadgeUInt8Factory Factory : unauthorised");
...
contract BadgeUint8Implementer is TraitUint8ValueImplementer {

    uint8          immutable    defaultValue;
    mapping (uint16 => bool)    used;


    constructor(address _registry, uint16 _traitId, uint8 _defaultValue) TraitUint8ValueImplementer(_registry,_traitId) {
