...
contract DCAStrategyManager is Ownable, AccessControl {
    ...
    function getStrategy(uint256 strategyId)
        public
        view
        returns (DCATypes.StrategyData memory)
    {
    ...
    function getUserStrategy(address user, uint256 strategyId)
        public
        view
        returns (DCATypes.UserStrategyData memory)
    {
    ...
    function getStrategiesInfo(uint256[] memory strategiesIds, address user)
        external
        view
        returns (DCATypes.StrategyInfoResponse[] memory)
    {
    ...
    function participate(uint256 id, uint256 weeklyAmount)
        public
        payable
        strategyExists(id)
    {
    ...
    function _removeFromStrategy(uint256 id, address user)
        internal
        strategyExists(id)
    {
    ...
    function getStrategyParticipantsLength(uint256 strategyId)
        public
        view
        returns (uint256)
    {
    ...
    function _collectFromAsset(uint256 strategyId, uint32 maxLoopIterations)
        internal
        returns (uint32)
    {
