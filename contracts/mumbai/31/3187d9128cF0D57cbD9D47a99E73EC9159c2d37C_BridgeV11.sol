    ...
    PermissionsEnumerable
{
    ...
    function createCollection(
        ...
        collectionSigner[proxyAddress][_signer] = true;
    ...
    function deleteCollection(
        ...
        require(
            collectionContracts[_index] == _contractAddress &&
                collectionSigner[_contractAddress][_signer] == true,
            "Bad address"
        );

        delete collectionSigner[_contractAddress][_signer];
    ...
    function bridgeOut(
        ...
        assetIdOwner[address(_collectionContract)][_assetId] = _owner;
    ...
    function addSigner(IBridgeableERC721 _collectionContract, address _signer)
        ...
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        collectionSigner[address(_collectionContract)][_signer] = true;
    }

    /// @dev Removes the signer from a collection
    function removeSigner(address _collectionContract, address _signer)
        external
        virtual
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
    ...
    function hasSigner(address _collection, address _signer)
        external
        view
        returns (bool)
    {
    ...
    function _canSignBridgeRequest(address _signer, address _collectionContract)
        internal
        view
        virtual
        returns (bool)
