...
contract LotteryGame is VRFConsumerBase, KeeperCompatibleInterface {
   ...
   constructor(uint64 _entryAmount, uint64 _maxPrize) VRFConsumerBase(_vrfCoordinator, _linkToken) payable {
    ...
    function changeMaxPrize(uint128 _maxPrize) public onlyOwner {
       maxPrize = _maxPrize;
    }

     function changeEntryAmount(uint128 _entryAmount) public onlyOwner {
       entryAmount = _entryAmount;
    }
    ...
    function getEntryAmount() public view returns(uint) {
     ...
     function getLotteryDay() public view returns(uint) {
        return lotteryDay;
    }
