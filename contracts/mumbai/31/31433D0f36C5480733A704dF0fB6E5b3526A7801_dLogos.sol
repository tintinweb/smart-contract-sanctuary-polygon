...
contract dLogos {
    ...
    event SplitsAddressSet(address indexed _owner, address indexed _splitsAddress);
    ...
    */
    ...
    /*
    * @dev Sets Split address for a logo.
    */
    function setSplitsAddress(
        ...
        emit SplitsAddressSet(msg.sender, _splitsAddress);
    }
