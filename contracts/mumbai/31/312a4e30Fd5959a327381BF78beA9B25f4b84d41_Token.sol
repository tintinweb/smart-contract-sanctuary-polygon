...
contract Token is IERC20, Ownable {
    ...
    /* Address of receiver of vesting amount */
    mapping(address => uint256[]) public receiverIDs;
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue)
        ...
        returns (bool _success)
    {
        if(_allowances[msg.sender][spender] < subtractedValue) revert("Insufficient allowance to decrease");
