...
contract ERC721GameInventoryV1 is UUPSUpgradeable, OwnableUpgradeable, VersionAware {
    ...
    function initialize(IManagers _managers, address _authorizedAddress, address payable _treasury) external initializer {
        versionAwareContractName = "ERC721 Game Inventory: V1";
		managers = _managers;
