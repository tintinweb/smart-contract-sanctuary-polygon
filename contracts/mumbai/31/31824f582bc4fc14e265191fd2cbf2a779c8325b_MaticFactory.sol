...
contract MaticFactory{
    ...
    uint256 private constant MIN_WITHDRAW = 0.00004 ether;
    uint256 private constant MIN_ADEP = 0.00004 ether;
    uint256 private constant MIN_DEP = 0.0004 ether;
    uint256 private constant MAX_DEP = 36000000 ether;
    uint256 private constant MAX_DEP_CNT = 365000000365454;
    ...
    uint256 private constant PLAN_TERM = 9999999999999 days;
    uint256 private constant TIME_STEP = 30 minutes;
    ...
    function _calculateDividends(uint256 _amount, uint256 _dailyInterestRate, uint256 _now, uint256 _start) private pure returns (uint256) {
        return (_amount * _dailyInterestRate / 10000 * (_now - _start)) / (TIME_STEP_DRAW);
    }
