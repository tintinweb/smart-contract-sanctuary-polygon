...
contract NFTSale is ERC721, Ownable, ReentrancyGuard {
    ...
    constructor(
        uint256 _wl_MINT_PRICE,
        uint256 _pub_MINT_PRICE
    ) ERC721("Cry ElePants", "CEN") {
        _supply.increment();
        wl_MINT_PRICE = _wl_MINT_PRICE;
        pub_MINT_PRICE = _pub_MINT_PRICE;
    }
    ...
    function togglePubMintActive(bool _status) external onlyOwner {
        pubMintActive = _status;
    }
