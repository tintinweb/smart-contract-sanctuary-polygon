    ...
    Pausable
{
     ...
     */
    // modifier (address _from) {
    //     require(
    //         _from == _msgSender() || isApprovedForAll(_from, _msgSender()),
    //         "ERC1155Tradable#: CALLER_NOT_ALLOWED"
    //     );
    //     _;
    // }
     ...
     */
    function burn( address _from, uint256 _id, uint256 _quantity)public virtual  {
 ...
 */
abstract contract  AssetContract is ERC1155Tradable {
...
contract AssetContractShared is AssetContract, ReentrancyGuard
 {
     ...
     */
    function setProxyRegistryAddress(address _address) public  {
     ...
     */
    function addSharedProxyAddress(address _address) public  {
     ...
     */
    function disableMigrate() public  {
     ...
     */
    function migrate(Ownership[] memory _ownerships) public  {
     ...
     */
    function setCreator(uint256 _id, address _to) public  {
        // require(
        //     _to != address(0),
