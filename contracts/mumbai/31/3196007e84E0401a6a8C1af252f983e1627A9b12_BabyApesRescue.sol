...
contract ERC721Namable is ERC721Enumerable {
    ...
    uint256 public bioChangePrice = 60 ether;
...
contract BabyApesRescue is ERC721Namable, Ownable {
    ...
    // Tracks the amount of Baby Apes NFTs an address holds
    ...
    function airdropOG(
        ...
        for (uint256 i = 0; i < _tokenIds.length; i++) {
            ...
            bananaBar.updateReward(_ogHolders[i], address(0));
    ...
    function handleMint(address _to, bool isSteal)
        private
        returns (bool, uint256)
    {
        ...
        emit BabyApesRescueMinted(maxTokenIdMinted, msg.sender, _to, isSteal);
        return (isSteal, maxTokenIdMinted);
    }
