...
contract OnChainMusicMetadata is MusicStructs {
        ...
        returns (string[47] memory)
    {
        ...
        values[17] = title;
        values[18] = _projectMetadata.artwork.imageUri;
        values[19] = _projectMetadata.artwork.imageMimeType;
        values[20] = _projectMetadata.artwork.imageNft;
        values[21] = description;
        values[22] = _projectMetadata.projectType;
        values[23] = _projectMetadata.publishingData.releaseDate;
        values[24] = _projectMetadata.publishingData.recordLabel;
        values[25] = _projectMetadata.publishingData.publisher;
        values[26] = _projectMetadata.upc;
        ...
        values[41] = _projectMetadata.publishingData.title;
        values[42] = bpm;
        values[43] = songKey;
