...
contract CrookedSnouts is VRFConsumerBaseV2, ERC721URIStorage {
  ...
  function create() public {
    ...
    uint256 bg = userRequest.randomNumbers[0];
    uint256 face = userRequest.randomNumbers[1];
    uint256 eyes = userRequest.randomNumbers[2];
    uint256 head = userRequest.randomNumbers[3];
    uint256 mouth = userRequest.randomNumbers[4];
    uint256 nose = userRequest.randomNumbers[5];
