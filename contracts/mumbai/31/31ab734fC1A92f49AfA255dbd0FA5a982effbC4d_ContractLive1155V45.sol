...
// File: contracts/1155_Base/Contract Base1155 V45.sol
/*
...
contract ContractLive1155V45 is ERC1155, Ownable, ERC2981, DefaultOperatorFilterer, ContextMixin, RoyaltiesV2Impl { 
    ...
    function safeTransferFrom(address from, address to, uint256 tokenId, uint256 amountCopys, bytes memory data) public override onlyAllowedOperator(from) onlyOwner {                          
        super.safeTransferFrom(from, to, tokenId, amountCopys, data);
    }

    function safeBatchTransferFrom(address from, address to, uint256[] memory tokenIds, uint256[] memory amountCopys, bytes memory data) public override onlyAllowedOperator(from) onlyOwner {  
