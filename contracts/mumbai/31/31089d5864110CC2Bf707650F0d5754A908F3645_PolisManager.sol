...
contract PolisManager is IAccessControlHolder, IPolisManager, IERC721Receiver {
    ...
    modifier onlyOneTokenLockedByUser(uint256 tokenId) {
...
interface IPolis is IERC721A {
    ...
    /**
     * @notice Funciton allows upgrade the level of the senate.
     * @param tokenId Id of the token to upgrade.
     * @param level Level to upgrade.
     */
