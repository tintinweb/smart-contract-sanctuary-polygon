 ...
 */
contract ChinaChicClaim is ChinaChicProof, Pausable, ReentrancyGuard {
    ...
    // State variables
    // ------------------------------------------------------------------------
    uint256 public rewardPerTokenId;
    ...
    function deposit(uint256 amount) public onlyOwner {
        ...
        rewardPerTokenId = amount / MAX_SUPPLY;
...
abstract contract ChinaChicProof is Ownable {
    ...
    function hashMessage(
        ...
        bytes32 hash = keccak256(
            abi.encodePacked(
                keccak256(
                    "ChinaChicSignedProof(address sender,string nonce,string ids,address verifier)"
                ),
                sender,
                nonce,
                ids,
