...
contract PoolContract is Initializable, Proxied, AccessControl {
    ...
    event WithdrawStuckTokens(address indexed token, address indexed to, uint256 amount);
    event AssetsDistributed(address indexed to, address indexed token, uint256 amount);
    ...
    function approve(
        ...
        emit Approve(_token, _spender, _amount);
    }
    ...
    function withdrawStuckTokens(
        ...
        emit WithdrawStuckTokens(_token, _to, amount);
    }
    ...
    function distributeAssets(
        ...
        emit AssetsDistributed(_to, _token, _amount);
    }
