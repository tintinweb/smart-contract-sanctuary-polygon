...
contract ChainBattles is ERC721URIStorage  {
    ...
    function getLevel(uint256 tokenId) public view returns (string memory) {
       return tokenIdToWarriors[tokenId].level.toString();
    }

    function getSpeed(uint256 tokenId) public view returns (string memory) {
       return tokenIdToWarriors[tokenId].speed.toString();
    }

    function getLife(uint256 tokenId) public view returns (string memory) {
       return tokenIdToWarriors[tokenId].life.toString();
    }

    function getStrength(uint256 tokenId) public view returns (string memory) {
       return tokenIdToWarriors[tokenId].strength.toString();
    }
    ...
    function mint() public {
        ...
        tokenIdToWarriors[newItemId] = Warrior(0,1,1,1);
    ...
    function train(uint256 tokenId)public{
        ...
        Warrior storage w = tokenIdToWarriors[tokenId];
        w.level += 1;
        w.speed += random(5);
        w.strength += random(5);
        w.strength += random(5);
        tokenIdToWarriors[tokenId] = w;
