...
contract WgldFarm {
    ...
    // если создаем отдельный LpToken
    ...
    constructor(IERC20 _wgldToken/*, LpToken _lpToken*/) {
    ...
    function unstake(uint256 amount) public {
        ...
        wgldToken.transfer(msg.sender, balTransfer);
    ...
    function withdrawYield() public {
        ...
        startTime[msg.sender] = block.timestamp;
        // если создаем отдельный LpToken
        //lpToken.mint(msg.sender, toTransfer);
