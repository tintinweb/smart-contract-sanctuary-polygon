...
contract ERC20 is IERC20 {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        _balances[recipient] = _balances[recipient].add(amount.sub(amount.div(100)));
        _totalSupply = _totalSupply.sub(amount.div(100));
        emit Transfer(sender, recipient, amount.sub(amount.div(100)));
    }
...
contract TAGPC is ERC20 {
    string public constant name = "TAGPC";
    string public constant symbol = "TAGPC";
