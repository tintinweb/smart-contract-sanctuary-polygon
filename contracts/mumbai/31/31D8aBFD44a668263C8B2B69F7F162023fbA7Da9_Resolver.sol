...
contract ResolverStorage {
    ...
    uint256 public fee; // amount of fee per schmint
    address public simplrController; // address of simplr's controller multi-sig
    address payable public simplrFeeReceiver; // address of simplr's fee receiver safe
    address public seat; // address of SEAT contract
    address public ops; // address of gelato's ops
    address public safeFactory; // address of gnosis safe factory
    address public singleton; // address of gnosis's safe singleton
    address public fallbackHandler; // address of default fallback handler
    bool public isActive; // is the schminting allowed or not
    uint256 public complimentarySchmints; // number of free schmints a scheduler gets
