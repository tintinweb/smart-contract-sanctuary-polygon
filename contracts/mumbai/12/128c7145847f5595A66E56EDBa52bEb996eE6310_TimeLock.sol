...
// SPDX-License-Identifier: MIT
// This contract owns the box contract
...
contract TimeLock is TimelockController{
    ...
    // minDelay: Once proposal passes, how long you have to wait before executing

    // Proposers: List of addresses that can propose

    // executors: List of address that can execute when a proposal passes
