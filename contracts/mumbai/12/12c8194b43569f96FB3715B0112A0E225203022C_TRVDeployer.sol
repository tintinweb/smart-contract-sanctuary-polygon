...
contract TRVDeployer is Ownable {
  ...
  // 0x5eeFBBBDaE58b99C7d736B05D8A12d3352eb83f0 deployed deployer
  ...
  constructor() {
    ...
    elements[4] = 0x9264411334e71deF428a843f48a6F1fe6639eE44; // new
    elements[5] = 0xDc536984599E9B87683b032a0E13C4EB45f66933; // new
    elements[6] = 0x224Bf9832fE554Af54b301B2Ed7Ac0aE76F0DFF7; // new
    elements[7] = 0xCA183b35a7AAc9Cc84cF9eba8ef3BB59D6dF3254; // new
  ...
  function bindingUtils() external onlyOwner {
    IAll(elements[4]).bindZooKeeper(elements[10]);
    IAll(elements[0]).grantMaster(elements[4], elements[10]);
  }
  ...
  function bindingRoleForService(address _service) internal {
    ...
    IAll(elements[0]).grantMaster(_service, elements[4]);
