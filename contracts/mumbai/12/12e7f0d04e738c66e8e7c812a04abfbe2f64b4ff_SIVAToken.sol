...
/**
 * @dev Implementation of the {IERC20Recyclable} interface.
 * 
 */
contract ERC20Recyclable is ERC20, AccessControl, IERC20Recyclable {
    ...
    /**
     * @dev Set minter `utility` contract `hasAccess` to allocation minting.
     * - Requires Admin Role
     */
    function setMinter(
        address utility,
    ...
    /**
     * @dev Set burner `utility` contract `hasAccess` to burning own tokens.
     * - Requires Admin Role
     */
    function setBurner(
        address utility,
    ...
    /**
     * @dev Set recycler `utility` contract `hasAccess` to minting and burning.
     * - Requires Admin Role
     */
    ...
    /**
     * @dev Release allocated `amount` from `utility` contract allocation.
     * - Requires Admin Role
     * - Requires allocation to be released
...
contract SIVAToken is ERC20Recyclable {
    constructor() ERC20Recyclable("Siva Token", "SIVA", 100000000 ether) {}
}