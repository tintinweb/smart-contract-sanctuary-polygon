...
import {GELATO_RELAY_DEV} from "./constants/Addresses.sol";
...
contract CounterRelayContextDev is GelatoRelayContext {
    uint256 public counter;

    event IncrementCounter(uint256 newCounterValue);

    modifier onlyGelatoRelayDev() {
        require(msg.sender == GELATO_RELAY_DEV, "onlyGelatoRelayDev");
        _;
    }

    // this function increments a counter after paying Gelato successfully using the helper methods
    function increment() external onlyGelatoRelayDev {
...
address constant GELATO_RELAY_DEV = 0x016b111E609Cd65a5Cd334B60ca54C905B0c6FFD;