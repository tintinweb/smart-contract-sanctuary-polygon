...
contract kanan is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("KANAN", "KNA") {
    setHiddenMetadataUri("ipfs://QmV5f3znH49uLiMygpwrHAMGML2zmhXxH8UwTn1HzYdMot/Erc721_Data_1.json");
  }
