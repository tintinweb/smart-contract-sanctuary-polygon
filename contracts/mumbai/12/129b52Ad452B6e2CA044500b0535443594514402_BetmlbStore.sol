...
contract BetmlbStore {
  ...
  function createBetData(uint256 _betId, string memory _betDate, string memory _game, string memory _teams, string memory _market, string memory _place, uint256 _stake, uint256 _odds, uint256 _profitloss, string memory _status, string memory _site) public {
