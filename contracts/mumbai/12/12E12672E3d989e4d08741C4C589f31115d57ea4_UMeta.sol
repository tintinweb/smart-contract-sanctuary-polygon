...
contract UMeta is ERC721A, AccessControl {
    string private _baseTokenURI = "https://api.metastadium.io/token/poap/";
    ...
    */
    function mint(
        ...
        // adding custom event for mint with user, tokenid and mintType
        uint256 updatedIndex = _currentIndex;
        uint256 end = _currentIndex + _quantity;
        for (updatedIndex; updatedIndex < end; updatedIndex++) {
            emit MintPOAP(_user, updatedIndex, _mintType);
        }
