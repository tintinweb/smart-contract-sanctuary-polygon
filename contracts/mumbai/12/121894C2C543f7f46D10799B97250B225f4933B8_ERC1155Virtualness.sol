...
import "../protocol-v1/lib/Signature.sol";
...
contract ERC1155Virtualness is  
    ...
    event Mint(address indexed Minter, uint256 indexed tokenId, uint256 indexed supply );
    ...
    */
    function initialize(string memory _contratctUri) external initializer {
        __ERC1155_init("");
        __ERC1155Roles_init();
    ...
    */
    function mint(
        ...
        require(supply[_tokenId] == 0, "supply incorrect");

        LibPart.Part[] memory creatorsOfToken;
        ...
        mint_(msg.sender, _tokenId, _supply, "");

        emit Mint(msg.sender, _tokenId, _supply);
    }
    ...
    */
    function lazyMint(
        ...
        if (minter != _to) {
            ...
            emit TransferSingle(sender, minter, _to, data.tokenId, _amount);
        } else {
            emit TransferSingle(sender, address(0), _to, data.tokenId, _amount);
        }
