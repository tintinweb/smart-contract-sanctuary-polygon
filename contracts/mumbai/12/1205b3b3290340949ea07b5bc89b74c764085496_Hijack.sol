...
contract Hijack is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xb79f96646d04bfa53556Fa21134c20E1756bF11A); // Marketing Address
    ...
    string private _name = "Hijack";
    string private _symbol = "HJA";
    ...
    function _transfer(
        ...
        require(!_isBlacklisted[from] && !_isBlacklisted[to], "ERROR: Wallet is blacklisted!");
