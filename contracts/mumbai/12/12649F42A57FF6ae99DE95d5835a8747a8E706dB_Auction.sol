...
// File: contracts/auctionContract.sol
...
contract Auction is IERC721Receiver, Ownable {
    ...
    constructor(IWonderGameCharacterInventory _wonder) {
    ...
    function onERC721Received(
        ...
        require(_from == admin, "Only receives nft from admin account");
        nftId = _tokenId;
        return this.onERC721Received.selector;
    }

    function start(uint256 endtime, uint256 startingBid) external onlyOwner {
        require(!started, "started");
        require(msg.sender == admin, "not admin");
        require(nftId != 0, "No nft has been received by auction contract");
        require(
    ...
    function bid() external payable {
        ...
        require(msg.value > highestBid, "bid value should be greater than current bid value");
    ...
    function withdraw() external {
        require(ended, "Can Only withdraw after auction has ended");
    ...
    function end() external onlyOwner {
        ...
        if (highestBidder != address(0)) {
            ...
            wonderGame.safeTransferFrom(address(this), admin, nftId);
        }
        delete nftId;
