...
contract NebulaDropsCollectible is ERC1155, Ownable ,
 ...
 IERC2981,  Pausable, ContextMixin {
    ...
    constructor(string memory _name, string memory _uri, address _dropArtist, uint256 _totalTokens,
     uint256 _artistRoyaltyPercent, address _nebulaMarketplaceContract) 
    ERC1155(_uri) 
    { 
