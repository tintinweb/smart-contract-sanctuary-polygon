...
contract BellaResellV3 is Initializable, UUPSUpgradeable, ReentrancyGuardUpgradeable, AccessControlUpgradeable, PausableUpgradeable {
    ...
    function incrementSomeValue() public {
        someValue += 10;
    }
