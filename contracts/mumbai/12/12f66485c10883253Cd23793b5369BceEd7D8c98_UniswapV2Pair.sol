...
contract UniswapV2Pair is IUniswapV2Pair, UniswapV2ERC20 {
    ...
    // string public name = 'CobraDex: Pair';
    ...
    function _update(uint balance0, uint balance1, uint112 _reserve0, uint112 _reserve1) private {
        require(balance0 <= uint112(int112(-1)) && balance1 <= uint112(int112(-1)), 'CobraDex: OVERFLOW');
    ...
    function swap(uint amount0Out, uint amount1Out, address to) external override lock {
        ...
        (uint112 _reserve0, uint112 _reserve1,) = getReserves(); // gas savings
        require(amount0Out < _reserve0 && amount1Out < _reserve1, 'CobraDex: INSUFFICIENT_LIQUIDITY');
        ...
        { // scope for reserve{0,1}Adjusted, avoids stack too deep errors
            ...
            require(balance0Adjusted * balance1Adjusted >= uint(_reserve0) * _reserve1 * (1000**2), 'CobraDex: K');
        }
...
contract UniswapV2ERC20 is IUniswapV2ERC20 {
    ...
    string public override constant name = 'CobraDex';
    string public override constant symbol = 'CBRA-LP';
