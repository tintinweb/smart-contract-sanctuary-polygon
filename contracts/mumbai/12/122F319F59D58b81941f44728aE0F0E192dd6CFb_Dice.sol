...
contract Dice is Game {
    ...
    constructor(
        ...
        // bankAddress, chainlinkCoordinatorAddress, 1, LINK_ETH_feedAddress
        0x19586dce3909aDE4FB4ecA23FE163B65bD09758b,
    ...
    ReentrancyGuard
{
    ...
    function getChainlinkVRFCost(address token) public view returns (uint256) {
        ...
        function getRandomeId(address tokenAddress)public  returns(uint256 id){
        Token memory token = tokens[tokenAddress];
        id= _chainlinkConfig.chainlinkCoordinator.requestRandomWords(
            _chainlinkConfig.keyHash,
            bank.getVRFSubId(tokenAddress),
            _chainlinkConfig.requestConfirmations,
            token.VRFCallbackGasLimit,
