...
contract SwapAdapterV2 {
    ...
    /**
    withdraw unnecessary WETH that was send to the function contracts that  didnt need to be transferred by the user .
    ...
    **/
    ...
    /**
    for fetching other ERC20 kind of  transfer .
    */
    ...
    /**
    getting the result from the tokenBalance.
    */
    ...
    /**
    swapping all the tokens  of given address (defined path[0]) into the resulting tokens  .
    fee being the  value taken by the creator of the pool .
    Fee possible levels : 500, 3000, 10000
    amountOutMin is the minimum output of the swapped amount 
    */
    ...
    /**
    calling the internal swap function based on the specific parameters.
    ...
    /** 
    this is done for the single path swap
    */
