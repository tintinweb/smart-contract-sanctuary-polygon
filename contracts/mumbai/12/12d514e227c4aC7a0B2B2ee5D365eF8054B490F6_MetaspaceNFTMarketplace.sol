...
contract MetaspaceNFTMarketplace is Ownable, ReentrancyGuard {
    ...
    struct PlatformData {
        ...
        mapping(IERC20 => uint256) totalRoyaltyEarned;
        mapping(IERC20 => uint256) totalPlatformFeesEarned;
        uint256 totalNFTSold;
        mapping(IERC20 => uint256) totalVolumeTraded;
    }

    // Mapping of supported Currencies
    mapping(IERC20 => bool) public isSupportedCurrency;
        ...
        zeroAddressCheck(_feeReceiver)
    {
        ...
        isSupportedCurrency[MATIC] = true;
    }
    ...
    function listNFT(
        ...
        require(isSupportedCurrency[_currency] == true, "Unsupported currency");
    ...
    function getTotalFeesCollected(
        ...
        external
        view
        returns (uint256 platformFeesEarned, uint256 royaltyEarned)
    {
        return (
            platformData.totalPlatformFeesEarned[_currency],
            platformData.totalRoyaltyEarned[_currency]
        );
    }
    ...
    function updateSupportedCurrency(
        ...
        isSupportedCurrency[_currency] = updateStatus;
    }
