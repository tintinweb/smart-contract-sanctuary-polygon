...
// File: contracts\polygon\UpsideCollectionV2.sol
...
contract UpsideCollectionV2 is
    Initializable,
    ...
    OwnableUpgradeable
{
    ...
    string private constant SIGNING_DOMAIN = 'AX NFT Collection';
    ...
    function batchMint(
        ...
        require(
            ...
            'tokenIds length does not match recipients length.'
        );
        require(
            tokenIds.length == tokenUris.length,
            'tokenIds length does not match tokenUris length.'
        );
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            ...
            _mint(msg.sender, tokenIds[i], /* amount= */ 1, /* data= */ '');
