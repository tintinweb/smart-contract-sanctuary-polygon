...
contract SkylabBase is ERC721Enumerable, Ownable {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        if (pilotAddress != address(0)) {
            ...
            pilotSubUrl = string(abi.encodePacked(_aviationPilotIds[tokenId].toString(), "/"));
        }

        return _skylabMetadata.generateTokenMetadataa(
            tokenId.toString(), 
            string(abi.encodePacked(_pilotAddressesToUrls[pilotAddress], pilotSubUrl, tokenLevelString, ".png")),
            tokenLevelString,
            pilotString
        );
    }
...
contract SkylabTournament is SkylabBase {
    using Strings for uint;
    ...
    constructor(string memory baseURI) SkylabBase(baseURI, "SkylabTournament", "SKYLAB_TOURNAMENT") {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        return _skylabMetadata.generateTokenMetadataa(
            tokenId.toString(), 
            string(abi.encodePacked(_pilotAddressesToUrls[pilotAddress], pilotSubUrl, "Round", _aviationRounds[tokenId].toString(), "/", tokenLevelString, ".png")),
            tokenLevelString,
            pilotString
        );
    }
