...
library MapLib {
     ...
     */
    function set(mapping(string => bytes32) storage map, string memory key, bytes32 value) internal returns (bool) {
     ...
     * Time complexity: O(1)
     */
    function tryGet(mapping(string => bytes32) storage map, string memory key) internal view returns (string memory) {
