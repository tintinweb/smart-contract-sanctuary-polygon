...
contract Asset is ERC721, Ownable, ReentrancyGuard {
    ...
    function createAsset(string memory assetType, string memory assetDetails, string memory assetURI, uint256 _totalShares, uint256 priceUSD) public onlyAuthorizedOwner returns (uint256) {
        ...
        require(priceUSD > 0, "Asset: priceUSD must be greater than 0");
    ...
    function buyAssetShares(uint256 assetId, uint256 shares) public payable {
        ...
        uint256 pricePerShareUSD = assets[assetId].priceUSD;
