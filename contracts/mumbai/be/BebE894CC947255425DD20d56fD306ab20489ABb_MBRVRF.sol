...
import "../erc721a/contracts/ERC721RM.sol";
...
contract MBRVRF is ERC721r, AccessControl, Pausable, ReentrancyGuard {
    // ================== //
    //  Variable section  //
    // ================== //
    ...
    uint256 public mysteryBoxPrice = 0; // 100 = 1 USD
    ...
    modifier checkMintCond(uint256 quantity) {
        require(totalSupply() < MAX_SUPPLY, "MysteryBox already sold out!");
        require(totalSupply() + quantity <= MAX_SUPPLY, "Mint over supply");
        _;
    }

    constructor() ERC721r("Mystery Box Chainlink", "MBCL", MAX_SUPPLY, 313) {
    ...
    function setTicketPrice(uint256 _mysteryBoxPrice)
        public
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
