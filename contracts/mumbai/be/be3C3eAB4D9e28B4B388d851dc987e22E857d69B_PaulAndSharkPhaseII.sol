...
contract PaulAndSharkPhaseII is ERC1155, Ownable {
    ...
    function mint(uint8 _id, uint16 _qty, bytes32 _nonce, bytes calldata _signature) public payable checkFee
        checkTokenId(_id) checkLimit(_id, _qty)
        onlyPaper(keccak256(abi.encode(_id, _qty)), _nonce, _signature)
    {
