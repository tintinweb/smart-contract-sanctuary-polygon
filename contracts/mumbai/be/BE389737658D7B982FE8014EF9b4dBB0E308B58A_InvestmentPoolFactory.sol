...
contract InvestmentPoolFactory is Ownable {
    ...
    event InvestmentPoolCreated(address indexed investmentPoolAddress);
    ...
    function configure(
        ...
        address _investmentReferralAddress,
        address _exchangeRateProxyAddress,
        address _baseTokenContractAddress,
        address _quoteTokenContractAddress        
    ) onlyOwner public {
    ...
    function createInvestmentPool(      
        ...
        emit InvestmentPoolCreated(address(_investmentPool));
    }    
