...
contract WonderGameMinter is WonderGameMinterAccessControl, WonderVRFGeneratorV2 {
    ...
    constructor(IWonderGameCharacterInventory _wonder, uint64 _subscriptionId) WonderVRFGeneratorV2(_subscriptionId) WonderGameMinterAccessControl() {
        wonderGame = _wonder;
    }
    ...
    function addMaxCounts(uint256[] memory _characters, uint256[] memory _maxCounts) external onlyRole(HANDLER_ROLE) {
...
import "./WonderVRFAccessControl.sol";
