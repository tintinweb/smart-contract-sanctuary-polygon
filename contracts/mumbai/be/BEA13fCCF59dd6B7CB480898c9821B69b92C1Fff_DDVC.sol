...
contract DDVC is ERC1155, Ownable {
    ...
    //
    // cost of tokens
    uint256 public costGold = 2 ether;
    uint256 public costSilver = 1 ether;
    uint256 public costBlack = 0.5 ether;
    //
    ...
    uint256 public maxSupplyBlack = 190;
    uint256 public maxSupplySilver = 190;
    uint256 public maxSupplyGold = 190;
    //
    ...
    modifier mintCompliance(uint256 _mintAmount,uint256 _nftType) {
        ...
        require(_mintAmount <= 10, "You can't buy more than 10 nfts");
    ...
    return supplyBlack.current() + supplySilver.current() + supplyGold.current();
    }
