...
contract TokenshopEnglishAuction is Ownable {
    ...
    function createAuction(uint256 _tokenId, uint256 _price) external {
        ...
        TokenshopERC721.transferFrom(msg.sender, address(this), _tokenId);
    ...
    function _trade(
        ...
        (
            ...
            address artist
        ) = TokenshopERC721.getStateInfo(_tokenId);
        ...
        if (!isSecondarySale) {
            ...
            TokenshopERC721.setSecondarySale(_tokenId);
        } else {
