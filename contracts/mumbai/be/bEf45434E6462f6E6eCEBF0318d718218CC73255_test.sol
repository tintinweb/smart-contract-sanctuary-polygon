...
contract test is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
    ...
    uint256 public PHASE_PRICE = 1 ether;
    ...
    function PHASEMint(uint256 numberOfTokens) external isSecured(PHASE_PRICE * numberOfTokens) payable {
        ...
        PHASE_Minted[msg.sender] += numberOfTokens;
