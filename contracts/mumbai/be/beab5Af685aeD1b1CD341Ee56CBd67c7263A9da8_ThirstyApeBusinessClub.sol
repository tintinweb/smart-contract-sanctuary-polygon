...
contract ThirstyApeBusinessClub is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Thirsty Ape", "TABC") {
    setHiddenMetadataUri("ipfs://Qma1qHrYkQBa9fMfkS4Ag9C5ufyBRsu5vtFUvygKQvmr6s/hidden.json");
  }
