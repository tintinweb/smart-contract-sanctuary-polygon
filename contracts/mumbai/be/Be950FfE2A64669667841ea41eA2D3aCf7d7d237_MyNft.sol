...
contract MyNft is ERC721, Ownable, ERC2981 {
    ...
    uint256 public immutable supply = 7;
    ...
    constructor() ERC721("test4", "test") {
        _baseTokenURI = "https://test-api.nftool.io/generator-server/api/contract/v1/qqEfLYrJ5bgVO06N1/1610518937722228737/metadata/";
