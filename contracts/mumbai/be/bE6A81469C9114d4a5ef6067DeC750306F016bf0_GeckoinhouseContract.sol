    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 39, 18000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmYRkpUYKukATr84Je4iw6w5YoLGBfNQPeWQi1YC8pnisY/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 18000");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 18000");
    ...
    function mintToMultipleERC20(address _to, uint256 _amount, address _erc20TokenContract) public payable {
      require(_amount >= 1, "Must mint at least 1 token");
      require(_amount <= maxBatchSize, "Cannot mint more than max mint per transaction");
      require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 18000");
      require(mintingOpen == true, "Minting is not open right now!");
...
// File: contracts/GeckoinhouseContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GeckoinhouseContract is RamppERC721A {
    constructor() RamppERC721A("geckoinhouse", "GH"){}
}
