...
contract NetU21Coin is ERC20, AccessControl   {
    ...
    function faucetMint() public {
        ...
        setUpLine(msg.sender, WithNotMLM);
    }
    ...
    //payable functions
    function PayForFullTranfer(uint amount) external payable returns (bool){
