...
contract Buk is ERC1155, IERC1155Receiver, Ownable, ReentrancyGuard{
    ...
    function bookRoom(Booking[] memory booking,address user) external {                 
    ...
    function cancelBookingUser(uint256 id, address user) external {
    ...
    function preCheckIn(uint256 id) external {
