...
contract GasMonster is ERC721A, VRFConsumerBaseV2, ChainlinkClient, Ownable, Pausable {
	...
	function triggerUpgrade(uint256 tokenId) external {
		...
		require(
			...
			'Upgrade already in process. If request will not complete in 15 minutes, you will be able request upgrade again'
		);
	...
	function fulfillRandomWords(uint256 _requestId, uint256[] memory _randomWords) internal override {
		...
		for (uint8 i = 0; i < tokenIds.length; i++) {
			...
			LastUpgrades[tokenIds[i]] = Upgrade(false, 0);
