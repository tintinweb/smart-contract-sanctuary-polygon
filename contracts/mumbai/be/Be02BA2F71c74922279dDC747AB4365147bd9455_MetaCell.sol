...
contract MetaCell is ERC721, ICellRepository, Ownable {
    ...
    function createMetaCell() external override onlyOwner {
        _createMetaCell(msg.sender, 0);
    }

    function _createMetaCell(address _user, uint256 _tokenId) internal {
...
abstract contract ICellRepository is Multicall {
    ...
    function createMetaCell() external virtual;
