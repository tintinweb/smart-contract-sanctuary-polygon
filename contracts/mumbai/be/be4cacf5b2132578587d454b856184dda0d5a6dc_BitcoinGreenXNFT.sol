...
contract BitcoinGreenXNFT is ERC721, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721("BitcoinGreen", "XNFTs") {
        maxSupply = 80000;
    ...
    function convertBitcoinToMatic() public view returns (uint256) {
        ...
        uint256 btcValue;
        uint256 bitcoinGreenValue;
        uint256 bitcoinGreenValueInMATIC;
        uint256 maticValue;
        ...
        bitcoinGreenValue = btcValue / 10; // 1 Bitcoin Green value in USD
        maticValue = ((10**18) * uint256(maticPrice)) / maticDecimals; // ETH value in USD
        finalMaticValue = (((10**18) * btcValue) / maticValue) * (1 ether);
        bitcoinGreenValueInMATIC = ((finalMaticValue / 10**18) / 10); // 1 Bitcoin Green value in MATIC
        return bitcoinGreenValueInMATIC;
    }
}