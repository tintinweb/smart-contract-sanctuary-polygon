    ...
    LiquidityPoolManagerImplementationPointer
{
    ...
    function createPlanetWithTokens(
        ...
        require(
            planetValue >= creationMinPrice || planetValue == 0,
    ...
    function stakeTokensOnPlanet(
        uint256 _planetId,
        uint256 planetValue
    ) external nonReentrant onlyPlanetOwner checkPermissions(_planetId) whenNotPaused universeSet{
        address sender = _msgSender();
        require(
        ...
        planet.planetValue += planetValue;
        planet.lastProcessingTimestamp = currentTime;
        planet.rewardMult = tierLevel[0];

        emit Stake(sender, _planetId, planetValue);
    }
