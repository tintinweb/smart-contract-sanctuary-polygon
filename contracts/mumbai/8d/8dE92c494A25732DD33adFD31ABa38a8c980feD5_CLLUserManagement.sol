...
contract CLLUserManagement is CLStorage {
        ...
        modNotUser( _walletAddr )
    {
        ...
        emit evtProposal( proposalEvent.addProposal, propId, proposalType.newUser, "Founder Invitation" );
        ...
        emit evtVoted( propId,  true, _owner, "Founder Invitation" );
        ...
        public
    {
        ...
        mapInvitationUser[ arrDataPropUser[ propDataId ].walletAddr ] = _propId;
        ...
        external
    {
        ...
        if(
            0 != nftInvitation.balanceOf( realSender ) ||
            ( address(0) != whiteListNFT && 0 != IERC721( whiteListNFT ).balanceOf( realSender ) )
        ) {
            bool isManager = false;
            string memory name = "NFT Whitelisting";
            ...
            if( 0 != propId ) {
                ...
                isManager = arrDataPropUser[ propDataId ].isManager;
                name = arrDataPropUser[ propDataId ].name;
                delete mapInvitationUser[ realSender ];
            }
