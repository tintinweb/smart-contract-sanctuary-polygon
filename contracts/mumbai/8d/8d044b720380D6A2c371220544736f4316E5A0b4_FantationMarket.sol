...
contract FantationMarket {
    ...
    function CreateMarketItem(
        ...
        require(msg.value == creatingPrice, "Must pay the creating price");
        ...
        if(address(this) != owner) {
            payable(owner).transfer(creatingPrice);
        }
