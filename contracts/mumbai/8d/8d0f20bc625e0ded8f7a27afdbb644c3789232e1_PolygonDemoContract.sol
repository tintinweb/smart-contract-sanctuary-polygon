...
// File: contracts/PolygonDemoContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PolygonDemoContract is RamppERC721A {
    constructor() RamppERC721A("Polygon Demo", "PD"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/wOLri11iQ9PxZaxuiDgV/contract-metadata";
    }
}
