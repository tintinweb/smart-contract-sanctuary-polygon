...
// aka an NFT that cannot be transferred. Soulflake requires the sender to pay
...
contract SoulFlake is ERC721, ERC721Enumerable, AccessControl, Ownable {
  ...
  // This constructor function grants admin role to the default_owner and
  ...
  function getSvg(uint256 tokenId) public view returns (string memory) {
    ...
    parts[6] = "'; var test = atob(input); document.querySelector('.themeText').innerText = test;</script></foreignObject><rect x='38.5' y='38.5' width='60' height='17' rx='1.5' stroke='white'/></svg>";
    ...
    returns (string memory)
  {
    ...
    string memory json = Base64.encode(
      abi.encodePacked(
        '{"description":"Send a Soulflake greeting with optional MATIC tokens to any address.","external_url":"https://soulflake.xyz/","name":"',
