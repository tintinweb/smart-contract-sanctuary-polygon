...
contract DefaultHoldingPeriod is ICompliance, Ownable {
    ...
    string public constant COMPLIANCE_ERROR = "COMPLIANCE_RESTRICTION";
    ...
    /**
     * @dev 1404 compliance, after token restriction checks, compliance checks are done and returns a uint8 numeric code for restriction
     */
    ...
    /**
     * @dev 1404 compliance, if restriction code does not exist on the token contract, get the message from compliance contract
     */
    function restrictionMessage(uint8 _restrictionCode) external override view returns(string memory) {
