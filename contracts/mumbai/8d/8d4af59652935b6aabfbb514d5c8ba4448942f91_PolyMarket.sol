...
contract PolyMarket is ERC721, ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("VWPOLYNFT", "VWPNFT") {}

        function mint(string memory _tokenURI, uint256 royalty, bytes32[] calldata _merkleProof ) public returns (uint256) 
        {
