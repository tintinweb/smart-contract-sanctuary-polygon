...
contract MintNFT is ERC721Enumerable, ERC2771Context, Ownable {
    ...
    constructor(
        MintRallyForwarder forwarder // Initialize trusted forwarder
    ) ERC721("MintRally", "MR") ERC2771Context(address(forwarder)) {}
