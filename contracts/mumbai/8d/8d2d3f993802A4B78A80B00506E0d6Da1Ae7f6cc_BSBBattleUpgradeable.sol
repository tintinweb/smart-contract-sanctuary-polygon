...
contract BSBBattleUpgradeable is Initializable, BSBBaseGameModeUpgradeable, VRFConsumerBaseUpgradeable {
    ...
    function enroll(CollectionItems[] memory collectionItems_) public {
    ...
    function disEnroll(CollectionItems[] memory collectionItems_) external {
    ...
    function stackInSquad(CollectionItems memory collectionItems_, uint leaderId_) external {
    ...
    function unStackFromSquad(CollectionItems memory collectionItems_) external {
    ...
    function claimRewards(CollectionItems[] memory collectionItems_) public {
...
abstract contract BSBBaseGameModeUpgradeable is BSBBaseUpgradeable, IBSBTypes {
    ...
    function _unStakeItems(CollectionItems memory collectionItems_, address owner_) internal {
        for (uint256 i = 0; i < collectionItems_.assets.length; ++i) {
    ...
    function _stakeItems(CollectionItems memory collectionItems_, address owner_) internal {
        for (uint256 i = 0; i < collectionItems_.assets.length; ++i) {
