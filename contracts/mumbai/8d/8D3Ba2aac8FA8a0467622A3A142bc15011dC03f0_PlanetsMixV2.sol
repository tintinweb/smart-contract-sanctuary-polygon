...
// File: contracts/721_Base/721_Base_37.sol
/*
    +---------------------------------------------------------------------------------------------------------------------------------------------------------+
    |    written by:                                                                                                                                          |    
    |                                                                                                                                                         |
...
contract PlanetsMixV2 is ERC721, Ownable, ERC2981, DefaultOperatorFilterer, ContextMixin, RoyaltiesV2Impl { 
    ...
    function tokenURI(uint256 _tokenId) public view virtual override onlyOwner returns (string memory) {   
