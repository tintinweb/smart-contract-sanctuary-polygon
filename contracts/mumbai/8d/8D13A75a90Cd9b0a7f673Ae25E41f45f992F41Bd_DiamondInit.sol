...
contract DiamondInit {
    ...
    function init(
        ...
        LibDiamond.diamondStorage().erc1155Storage.name = name_;
        LibDiamond.diamondStorage().erc1155Storage.symbol = symbol_;

        LibDiamond.diamondStorage().erc1155Storage.contractUri = contractUri_;
        LibDiamond.diamondStorage().erc1155Storage.uri = "";
        // LibDiamond
        //     .diamondStorage()
        //     .erc1155Storage
        //     .maximumSupply = maximumSupply_;
        LibDiamond.diamondStorage().erc1155Storage.tokenId++;
