    ...
    IDerivedRuleModule
{
    ...
    ) FeeModuleBase(moduleGlobals) ModuleBase(opTreeHub, hub) {}
    ...
    function initializeDerivedRuleModule(
        ...
        if (
            ...
            recipient == address(0) ||
            amount == 0 ||
            endTime > block.timestamp + ONE_MONTH
        ) revert Errors.InitParamsInvalid();

        _dataByDerivedRuleByCollectionId[collectionId].mintLimit = mintLimit;
        _dataByDerivedRuleByCollectionId[collectionId].profileId = profileId;
