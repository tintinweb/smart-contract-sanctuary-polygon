...
contract StakeInTheTown is Staking721Base {
    ...
    function getMultiplierRewardSettings() external view onlyOwner returns (uint256, bool, uint256, string memory, uint256) {
        return (
            rewardMultiplier,
            multiplierToggle,
    ...
    function getFixedRewardSettings() external view onlyOwner returns (uint256, bool, uint256, string memory, uint256) {
        return (
            fixedReward,
            fixedRewardToggle,
