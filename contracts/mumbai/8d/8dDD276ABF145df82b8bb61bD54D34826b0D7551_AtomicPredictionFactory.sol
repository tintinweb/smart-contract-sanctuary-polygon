...
contract AtomicPredictionFactory is Ownable, CloneBase {
    event AtomicPredictionLaunched(uint256 _id, address _atomicPrediction);
    ...
    function _createAtomicPrediction(
        ...
        (, , , , , , , , , , rewardToken, rewardTokenAmount) = abi.decode(
            _implementationData,
            (
                address,
                address,
        ...
        TransferHelper.safeTransfer(
            rewardToken,
            atomicPredictionLibrary,
            rewardTokenAmount
        );
        atomicPredications.push(atomicPredictionLibrary);

        emit AtomicPredictionLaunched(_id, atomicPredictionLibrary);
    }
    ...
    function createAtomicPrediction(
        ...
        _createAtomicPrediction(_id, _implementationData);
