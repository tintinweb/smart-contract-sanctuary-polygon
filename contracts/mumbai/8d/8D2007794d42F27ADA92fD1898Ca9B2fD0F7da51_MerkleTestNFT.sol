...
contract MerkleTestNFT is ERC721A, Ownable {
  ...
  constructor() ERC721A("Testnet x Collection", "XYZ") {
  ...
  function mint(uint256 _mintAmount) public payable callerIsUser {
    // Is required sale states active
  ...
  function setMaxOgMint(uint256 _limit) public onlyOwner {
    maxOgMint = _limit;
  }
