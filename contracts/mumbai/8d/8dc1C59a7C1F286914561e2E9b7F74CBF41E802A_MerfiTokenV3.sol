...
contract Authorizable is Initializable, OwnableUpgradeable {
    mapping(address => bool) public authorized;

    event AddedAuthorized(address _user);
    event RemovedAuthorized(address _user);

   function __Authorizable_init() internal virtual onlyInitializing {
        __Ownable_init();
    }
...
// File src/infra/token/MerfiTokenV3.sol



contract MerfiTokenV3 is
    Initializable,
    ERC20Upgradeable,
    ...
    Authorizable
{
    ...
    function totalLockSSSSS() public view returns (uint256) {
        return _totalLock;
    }

    function totalLockSSSSSxxxxxxx() public view returns (uint256) {
        return _totalLock;
    }
