...
// File: contracts/BettingGameNew.sol

//SPDX-License-Identifier: Unlicense
pragma solidity ^0.8.7;


contract WagerGame is VRFConsumerBase {
    ...
    require(msg.value >= 1050000000000000000, 'Error, msg.value must be >= 1 MATIC');

    require(bet<=1, 'Error, accept only 0 and 1');

    require(address(this).balance>=msg.value, 'Error, insufficent vault balance');

    wager = msg.value - 50000000000000000;
    
    games[gameId] = Game(gameId, bet, wager, payable(msg.sender));
    ...
    function withdrawMatic(uint256 amount) external payable onlyAdmin {
