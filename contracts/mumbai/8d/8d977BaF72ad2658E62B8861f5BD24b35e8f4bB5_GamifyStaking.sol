...
contract GamifyStaking is ERC1155Holder, Ownable, ReentrancyGuard, Pausable, DSMath {
    ...
    ************************************************************************************/
    ...
    function stake(uint256 _amount, uint8 _timelock, bool _boost) external nonReentrant whenNotPaused {
        ...
        if (_timelock == 12) {
            require(this.isSuperVaultUnlocked(_msgSender()), "Staking: super vault locked");
        }
    ...
    ************************************************************************************/
    ...
    function isSuperVaultUnlocked(address _staker) external view returns (bool isUnlocked) {
        isUnlocked = false;
