...
contract ArbitrageBot is Ownable {
    ...
    address immutable WETH = 0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889; //mumbai
    ...
    function calcBorrowAmount(OrderedReserves memory reserves) internal pure returns (uint256 amount) {
        ...
        // Note: this workaround is only suitable for ERC20 token with 18 decimals, have to manage the tokens with 6 decimals later
