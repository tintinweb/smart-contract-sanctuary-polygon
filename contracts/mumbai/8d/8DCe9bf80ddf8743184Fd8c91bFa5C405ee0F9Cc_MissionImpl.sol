...
contract MissionImpl is MissionBase {
    ...
    function mintGoldRewards() external {
        require(!goldMinted, "ERROR: REWARDS HAVE BEEN MINTED");
    ...
    function _mintSilverRewards() internal {
        require(!silverMinted, "ERROR: REWARDS HAVE BEEN MINTED");
    ...
    function _mintBronzeRewards() internal {
        require(!bronzeMinted, "ERROR: REWARDS HAVE BEEN MINTED");
