...
pragma solidity ^0.8.17;
    ...
    contract Crowdsale {
        ...
        function claimVesting() public {
            ...
            uint256 claimableAmount = vestingInfo[recipient].claimAmount;
            require(token.transfer(recipient, claimableAmount), "Unable to transfer tokens");
            vestingInfo[recipient].claimAmount = 0;
            claimable_store = 0;
            claimtime = block.timestamp;
            accumulatedTokens = 0;
            timeStart2 = block.timestamp;
