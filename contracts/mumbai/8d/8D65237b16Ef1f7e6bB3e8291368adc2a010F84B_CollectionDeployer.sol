...
contract CollectionDeployer is OwnableUpgradeable {
     ...
     */
    function deployCollection(string memory name, string memory symbol, string memory baseURI) external {
     ...
     * @param tokenId id of the token
     */
    function mint(Collection collection, address to, uint256 tokenId) external {
