...
contract ExchangeChallenge is IExchangeChallenge, Ownable{
    ...
    function addChallenge(
        ...
        uint256 airdropEndAt)external  override returns (uint256){
            ...
            require(MARKET_TOKEN.balanceOf(seller) >= uint256(YAAS_FEES).mul(submissionLimit) , "Challenge Exchange: Insufficient balance");
            ...
            MARKET_TOKEN.transferFrom(_msgSender(), owner(), submissionLimit.mul(YAAS_FEES));
