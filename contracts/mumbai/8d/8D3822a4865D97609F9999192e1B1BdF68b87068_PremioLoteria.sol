...
contract PremioLoteria is VRFConsumerBase, Ownable{
   ...
   */
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal virtual override  {
        ...
        emit FirstPrizeWinner(players[firstPrizeWinnerIndex]);
        emit SecondPrizeWinner(players[secondPrizeWinnerIndex]);
        emit ThirdPrizeWinner(players[thirdPrizeWinnerIndex]);
    }
