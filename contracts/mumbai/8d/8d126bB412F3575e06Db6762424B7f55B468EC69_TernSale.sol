/* Made with ♥ by kachurun (https://t.me/zx_crypto) */
 ...
 *  ░█░ ██▄ █▀▄ █░▀█ ▄ █▄▄ █▀▄ ░█░ █▀▀ ░█░ █▄█   ▄▀░░   █▄▄ █▄█ █░▀░█ █░▀░█ █▄█ █░▀█ █ ░█░ ░█░   █ █▄▄ █▄█ █░▀█ ▄█
 *
 *  TG Channel: https://t.me/terncrypto
*/
contract TernSale is ERC721Enumerable, Ownable {
    ...
    uint256 public constant MAX_ELEMENTS = 120;
    uint public constant MAX_MINT_COUNT = 1;
    ...
    constructor(
        ...
        // setPaymentToken(0x0000000000000000000000000000000000000000);
    }
    ...
    function mint(bytes memory signature) public onlySigned(signature) {
        ...
        uint tokensMinted = IERC721(address(this)).balanceOf(msg.sender);

        require(tx.origin == msg.sender,        "Not allowed");
        require(saleState == true,              "Sale not live");
        require(supply + count <= MAX_ELEMENTS, "Exceeds maximum mint supply");
        require(tokensMinted < MAX_MINT_COUNT,  "You can't mint so much");
