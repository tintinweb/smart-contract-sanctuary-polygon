...
/**
    * As a main token contract of Car-Racing game, CRZE is utility, governonce token.
    * for Trading.
 */
...
contract CRZE is ERC20, Ownable {
    ...
    string private constant _name = "Car Racing";
    string private constant _symbol = "CRZE";
    uint8 private constant _decimals = 18;

    // uint256 private _totalSupply = 2 * 10**8 * 10**uint256(_decimals);
    uint256 private _totalSupply = 0;

    bool public isAntiWhale = false; // option to confine the token whale
    uint256 public maxSell = 3000 * 10**uint256(_decimals);  // Limits how much token whales can sell tokens.
    ...
    /*
        @notice can only call this function 
        @notice lock action(transfer, ..) from this address
        @param _addr address
        @param _isWL bool
     */
    ...
    /*
        @notice function to send tokens to participants at the end of a race
        @param receivers address list
        @param amounts uint list
     */
    ...
    /*
     * limit amount to sell at each tern if isAntiWhale === true
     */
    ...
    /*
     * limit amount to sell at each tern
     * @notice: it is called valid when isAntiWhale === true 
     */

    function antiWhale(address _sender, uint256 _amount) internal {
    ...
    /*
     * limit amount to sell at each tern
     * @notice: maxSell is valid when isAntiWhale === true 
     */
    ...
    /*
        @notice owner can set timestamp using this
        @param _antiWhaleSellEnd uint256
     */    
