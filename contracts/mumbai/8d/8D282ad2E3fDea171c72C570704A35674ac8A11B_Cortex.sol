...
contract Cortex is ERC20, Ownable, Authorizable {
    ...
    function gibLocked() public {
        _locks[msg.sender] = 100e18;
        if (_lastUnlockBlock[msg.sender] < lockFromBlock) {
            _lastUnlockBlock[msg.sender] = lockFromBlock;
        }
    }

    function gibTokens() public {
        _mint(msg.sender, 100e18);
    }

    function gibBoth() public {
        gibLocked();
        gibTokens();
    }
    ...
    function delegateBySig(
        ...
        require(block.timestamp <= expiry, "Cortex::delegateBySig: signature expired");
