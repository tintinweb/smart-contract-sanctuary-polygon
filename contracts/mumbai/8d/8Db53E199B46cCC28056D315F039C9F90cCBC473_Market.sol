...
contract Market is  Ownable {
    ...
    // MAX_COMMISSION
    uint256 public MAX_COMMISSION = 50;
    ...
    function changeCommission (address _contract, uint256 _commission) public onlyownerOfCollection(_contract) {
        ...
        require(_commission <= MAX_COMMISSION , "The commission is more than the commission ceiling !!!");
        require(CollectionsContract[_contract].isExist == true , "The Collection Not Valid");
    ...
    function buy(uint256 tokenId , address _contract) payable public {
        ...
        uint FeeAmount = msg.value * percentage / 1000;
    
        uint profit = msg.value *  CollectionsContract[_contract].percentOfCommission / 1000;
    ...
    function acceptBidForItem(uint256 tokenId, address _contract) public onlyOwnerItem(_msgSender(), tokenId,_contract){
        ...
        // handle Calc
        uint FeeAmount = bid.value * percentage / 1000;
    
        uint profit = bid.value *  CollectionsContract[_contract].percentOfCommission / 1000;
    ...
    function max_commissionChange(uint256 max_commission) public onlyOwner {
       ...
       require((MAX_COMMISSION+percentage) < 99 ,'The total commissions were more than 98 !!!!');
    }
