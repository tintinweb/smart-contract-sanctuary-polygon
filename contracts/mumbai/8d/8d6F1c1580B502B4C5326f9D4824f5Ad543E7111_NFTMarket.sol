...
contract NFTMarket is ReentrancyGuard {
    ...
    mapping(uint256 => mapping(address => DirectSale)) private tokenIdToSale;    
    ...
    function createDirectSale(
        ...
        require(tokenIdToSale[tokenId][nftContract].endTime == 0, "NFTSale : Token already in sale");

        tokenIdToSale[tokenId][nftContract] = DirectSale(
            tokenId,
            payable(msg.sender),
            startDate,
    ...
    function finalizeDirectSale(
        ...
        DirectSale storage sale = tokenIdToSale[tokenId][nftContract];
    ...
    function getTokenprice(uint256 tokenId, address nftContract) public view returns(uint256) {
        return tokenIdToSale[tokenId][nftContract].salePrice;
    }
