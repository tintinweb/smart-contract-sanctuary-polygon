...
contract EventTicketsNFT is ERC1155Base, PrimarySale, SignatureMintERC1155, EventOrgAccess, ERC1155Holder {
    ...
    returns (uint256 solvedTokenId) {
        ...
        require(
            _req.quantity <= this.getRemainingTickets(_req.externalId),
