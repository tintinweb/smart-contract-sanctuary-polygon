...
'- Name: DYOPS
- Symbol: DYOPS
- ERC20 token on Polygon Blockchain
- Utility Token
- Decimals: 8
- Total Supply: 50,000,000,000,000
- Burn 3% on every transaction - Burn owner can change percentages anytime
For marketing collection = 0x615498aC78996c1EE196cdD2A3a4E24B10647737
- Marketing is for 2% on transaction
- No reflection
- Blacklist fucntion
...
contract DYOPSTOKEN is Context, IERC20, Ownable {
    ...
    uint256 public _tTotal = 50000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string public _name = "DYOPS";
    string public _symbol = "DYOPS";
    ...
    address public marketingWallet = 0x615498aC78996c1EE196cdD2A3a4E24B10647737 ;
    ...
    constructor() {
        _rOwned[_msgSender()] = _rTotal;
         IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xbdd4e5660839a088573191A9889A262c0Efc0983); // Testnet
