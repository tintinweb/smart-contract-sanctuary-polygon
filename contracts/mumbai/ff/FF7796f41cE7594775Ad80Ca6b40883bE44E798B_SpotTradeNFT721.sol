...
interface IERC721 is IERC165 {
    ...
    function mintAndTransfer(address from, address to, address[] memory _royaltyAddress, uint256[] memory royaltyFee, string memory _tokenURI, bytes memory data)external returns(uint256);
}
...
contract SpotTradeNFT721 is ERC721 {
    ...
    function createCollectible(string memory tokenURI, address[] memory royalty, uint256[] memory royaltyFee, Sign memory sign) external returns (uint256) {
