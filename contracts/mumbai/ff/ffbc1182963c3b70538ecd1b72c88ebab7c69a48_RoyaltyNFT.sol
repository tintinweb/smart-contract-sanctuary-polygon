...
// pragma solidity >=0.7.0 <0.9.0;import "./LibPart.sol";
pragma solidity >=0.7.0 <0.9.0;
...
// File: contracts/erc721-royalties.sol
...
//=======================================================================================================
//=======================================================================================================
// REPLACE "ContractName" WITH VALUE OF "NAME" IN constructor() ERC721 BELOW
...
//=======================================================================================================
//=======================================================================================================
// REPLACE "NAME" WITH THE NAME OF YOUR CONTRACT (WITH SPACES) AND SYMBOL WITH STOCK SYMBOL LIKE VALUE
// REPLACE "CID" WITH THE HIDDEN METADATA CID IN IPFS (NO TRAILING SLASH)

  constructor() ERC721("RoyaltyNFT", "RLTYNFT") {
    setHiddenMetadataUri("ipfs://QmX24TxFd2BcZSyq2tMd1g9A8q8gs2itVTmzCFgFgGdNi6");
  }
