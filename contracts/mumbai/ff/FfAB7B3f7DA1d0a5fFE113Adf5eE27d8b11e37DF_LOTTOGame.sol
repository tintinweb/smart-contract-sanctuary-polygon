...
contract LOTTOGame is VRFConsumerBaseV2, ConfirmedOwner {
    ...
    function settleBet(uint256 gameId) public {
        ...
        if(counter<6){
            ...
            bets[gameId][msg.sender].isJackpotAvailable = true;
    ...
    {
        require(bets[gameId][msg.sender].isJackpotAvailable,"No reward available");
    ...
    function declareResult() internal {
        uint256 _gameId = getCurrentGameId() - 1;
        ...
        returns (uint256 requestId)
    {
        ...
        gameResult[_gameId].time = block.timestamp;
        return requestId;
    }
    ...
    function getBetDetails(uint256 _betId, address _address)
        public
        view
        returns (bet memory)
    {
