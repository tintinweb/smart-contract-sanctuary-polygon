...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xa37830fbD90F70534De0a887F40e087c78098f06];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://Qmef3ZzD949cmUGhrAifhDb4eNKM3BmGXwjYLQSyqPVCXg/";
...
contract ArtgalleriesdaodocumentsContract is RamppERC721A {
    constructor() RamppERC721A("ART GALLERIES DAO DOCUMENTS", "ARTGALDD"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/qSN1sWbIVANVjc5Fx13L/contract-metadata";
    }
}
