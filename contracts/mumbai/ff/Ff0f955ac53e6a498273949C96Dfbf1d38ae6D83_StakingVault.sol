...
contract StakingVault is Vault {
    ...
    //Write Functions
	/** TEST INFO
	 * Fonksiyon çağırıldığında 'Use_depositToStakingContract()' hatasının döndüğü gözlemlenmiştir.
	 */
    ...
    //Managers Function
	/** TEST INFO
	 **** Cannot use staking vault to transfer tokens to invalid address
	 * Bir Manager tarafından staking contract yerine cüzdan adresine çekim yapılması denendiğinde 'InvalidStakingContract()' hatası döndüğü gözlemlenmiştir.
	 
	 **** Managers can deposit staking cotract from staking vault
	 * 3 manager tarafından staking contractına 5000 token transfer edilmesinin başarılı olduğu gözlemlenmiştir.
	 */
