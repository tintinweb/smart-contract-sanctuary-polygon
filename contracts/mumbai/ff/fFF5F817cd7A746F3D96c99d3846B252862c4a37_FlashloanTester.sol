...
//import {} from "@aave/core-v3/contracts/flashloan/interfaces/IFlashLoanSimpleReceiver.sol";
...
contract FlashloanTester is FlashLoanSimpleReceiverBase {
  ...
  function executeOperation(
    ...
    (
      ...
      uint256 debtToCover,
      bool recieveABool
    ) = abi.decode(_params, (address, address, address, uint256, bool));
    
    
    POOL.liquidationCall(collateralAsset, debtAsset, user, debtToCover, recieveABool);
  ...
  function initiateFlashloan(
    ...
    // create lending pool instance
    IPool lendingPool = POOL;
    
    // call flashloan simple, this will call executeOperation
