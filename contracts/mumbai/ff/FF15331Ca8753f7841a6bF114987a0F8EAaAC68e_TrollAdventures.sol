 ...
 * @notice This contract handles minting Troll Adventures tokens.
 */
contract TrollAdventures is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xe818E873f2B9CBB35C0BF14c4291491FD5de3645;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x9571B14092c202C2e5827404A3F220372Cd02f34;
    ...
    string public name = "Troll Adventures";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeih3go6ie7ndft24mj5tlwlbpv7c3aafjqcsvxqglcgulcmiji4epa/{id}"
        )
        RevokableOperatorFilterer(
