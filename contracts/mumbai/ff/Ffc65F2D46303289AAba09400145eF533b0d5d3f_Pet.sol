    ...
    ERC2981ContractWideRoyalties
{
    ...
    constructor() ERC721("Pet", "PET") ERC3664(attrBaseURI) {
        _mint(PET_NFT, "PET", "pet", "");
        _mint(HAT_NFT, "HAT", "hat", "");
        _mint(GLASS_NFT, "GLASS", "glass", "");
        _mint(HAND_NFT, "HAND", "hand", "");
        _mint(PANTS_NFT, "PANTS", "pants", "");
        _mint(CLOTH_NFT, "GLASS", "cloth", "");

        mintWithLevel(Level, "LEVEL", "level", "", 10);
        _mint(Species, "SPECIES", "species", "");
        _mint(Friendship, "FRIENDSHIP", "friendship", "");
        _mint(Characteristic, "CHARACTERISTIC", "characteristic", "");
        _mint(State, "STATE", "state", "");
        isSalesActive = true;
    }
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC3664, ERC721Enumerable, ERC2981Base)
        returns (bool)
    {
        return
