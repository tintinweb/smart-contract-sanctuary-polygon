...
contract NFT is ERC721, Ownable{
    ...
    //ADMIN FUNCTIONS
    event UpdateMintToAddress(
    address _mintToAddress
    );
    function updateMintToAddress(address _mintToAddress) external onlyOwner {
        mintToAddress = _mintToAddress;
        emit UpdateMintToAddress(_mintToAddress);
    }
