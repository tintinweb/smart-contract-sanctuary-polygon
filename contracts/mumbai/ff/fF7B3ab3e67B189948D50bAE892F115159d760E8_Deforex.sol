...
contract Deforex is IDeforex, Ownable, MixinResolver {
    ...
    uint256 public constant FEE_LEVERAGE_PERCENT = 1e17; // 10%
    ...
    bytes32 private constant QUOTER_V2_CONTRACT = "QuoterV2";
    ...
    uint256 public _ifPercent = 1e17; // 10%
        ...
        returns (bytes32[] memory addresses)
    {
        ...
        addresses[2] = QUOTER_V2_CONTRACT;
        addresses[3] = INSURANCE_FUND_CONTRACT;
    }
    ...
    function _resolveAddressesFinish() internal override {
        ...
        _quoter = IQuoterV2(requireAndGetAddress(QUOTER_V2_CONTRACT));
        ...
        )
    {
        ...
        // uint256 rate = (amountOut * 1e18) / balance;

        extraProfit =
            ((balance - position.amountOut) * ((amountOut * 1e18) / balance)) /
            1e18;
    ...
    function _distributionActive(
        ...
        uint256 feeForLeverage = (amountOut *
            _calcFeeLeverage(position.timestamp)) / 1e18;
        uint256 feeToIf = (feeForLeverage * _ifPercent) /
            1e18 +
    ...
    function _calcFeeLeverage(uint256 dateStart)
        internal
        view
        returns (uint256)
    {
