...
function Timestamp(uint256 _First_Round_Start_Date,
        uint256 _First_Round_End_Date,
        uint256 _Second_Round_End_Date,
        uint256 _Third_Round_End_Date) public returns(bool){
        First_Round_Start_Date = _First_Round_Start_Date;
        First_Round_End_Date = _First_Round_End_Date;
        Second_Round_End_Date = _Second_Round_End_Date;
        Third_Round_End_Date = _Third_Round_End_Date;
        ...
        returns (uint256 _Txid)
    {
        ...
        if (
            ...
            //     uint256 _actualToWallet;
            //     uint256 _SecondBonusAmount = SecondRoundBonusTokens /
            //         SecondRoundnumToken_initialToken;
            //     SecondRBonusAmount = _SecondBonusAmount;
            //     _actualToWallet =
            //         numberOfTokens[_TxCount][_buyer] +
            //         (numberOfTokens[_TxCount][_buyer] * SecondRBonusAmount);
            //     numberOfTokens[_TxCount][_buyer] = _actualToWallet;
            // }
        ...
        //ROUND 3 : Private VCs (31 Oct.- 06 Nov) Tokens 62,500
            ...
            //     _actualToWallet =
            //         numberOfTokens[_TxCount][_buyer] +
            //         (numberOfTokens[_TxCount][_buyer] * ThirdRBonusAmount);
            //     numberOfTokens[_TxCount][_buyer] = _actualToWallet;
            // }
            // uint256 txIndex = transactions.length;
        ...
        //ROUND 4 : Public 07 October Tokens 200,000
            ...
            // uint256 txIndex = transactions.length;
            emit EForthroundTranfer(_TxCount, msg.sender, _buyer, numOfTokens);
    ...
    function calcuationofTotalSold() public returns  (bool){
    ...
    function TransferToWallets(address _user, uint256 _txIndex)
        public
        returns (bool)
    {
        require(
        ...
        uint256 Fraction=10**decimals;
        if (locktime[_txIndex][_user]>_firstroundStacking_Period){
        ...
        else if (locktime[_txIndex][_user]>_secondroundStacking_Period){
