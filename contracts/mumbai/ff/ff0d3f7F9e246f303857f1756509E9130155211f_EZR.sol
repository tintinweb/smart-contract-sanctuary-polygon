    ...
    function _transfer(
        ...
        unchecked {
            ...
            if(!isContract(from) && !isContract(to)) {
                ...
                // TODO : EST address 
                _balances[0xD44d5088f6eb0a0Aed56B2065478737030acEA94] = SafeMath.div(_feesAmount, 2); 
            }
...
contract EZR is IEZR, ERC20, ERC20Burnable, Pausable, AccessControl {
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    constructor() ERC20("EZR", "EZR") {
