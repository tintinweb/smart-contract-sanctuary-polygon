...
contract Loan is ERC721, LoanAdmin, SignatureLoan {
    ...
    constructor() ERC721("LoanNFT", "LNT") {}
    ...
    function beginLoan(
        ...
        LoanItem memory loan = LoanItem({
            ...
            loanDuration: _loanDuration.mul(1 days),    // unit is day
        ...
        uint256 adminFee = _computeAdminFee(msg.value, uint256(loanAdminFeeInBasisPoints));
        payable(_lender).transfer(msg.value.sub(adminFee));
