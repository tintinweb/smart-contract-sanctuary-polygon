...
// contract post challenges 0xff1854Ba6F08c157f2F0F8865A1b32F64A527b66
...
struct Trait {
  ...
  uint courage;
    ...
    bytes memory svg = abi.encodePacked(
        ...
        '<text x="50%" y="50%" class="base" dominant-baseline="middle" text-anchor="middle">', "Grit: ",getGrit(tokenId),'</text>',
        '<text x="50%" y="50%" class="base" dominant-baseline="middle" text-anchor="middle">', "Empathy: ",getEmpathy(tokenId),'</text>',
        '<text x="50%" y="50%" class="base" dominant-baseline="middle" text-anchor="middle">', "Courage: ",getCourage(tokenId),'</text>',
        '</svg>'
    );
    return string(
        abi.encodePacked(
   ...
   function train(uint256 tokenId) public {
        ...
        _trait.empathy = currentGrit + getRandomNumber(currentGrit);
