...
contract CoasterPunks is ERC721, ERC721Enumerable, Ownable, ERC721Burnable {

    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private _tokenIdCounter;
    uint256 private tokenPrice = 222000000000000000000; // 222 MATIC
    ...
    address  CoasterPunksWallet = 0x206F41C296e3c91cA59d027C5f51BCcb8984158A;
    ...
    constructor() ERC721("CoasterPunks", "CP") { 
    ...
    function withdraw() external onlyOwner {
        ...
        uint256 balance = address(this).balance;
        require(balance > 0);
        payable(CoasterPunksWallet).transfer((balance * 1000) / 1000);
    }
