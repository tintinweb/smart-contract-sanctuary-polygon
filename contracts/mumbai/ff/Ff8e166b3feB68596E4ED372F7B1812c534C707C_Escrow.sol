...
/**
 * @title Custom Offer Escrow Contract V4
 * @author Noman Aziz
 */
...
contract Escrow is Initializable, UUPSUpgradeable {
    // State Variables
    ...
    address public constant IDEA_TOKEN =
        0xB293DfbDAfdE43cd79B54F98214402ffa895d056;
     ...
     * No escrow fee deducted on using IDEA_TOKEN or when both buyerFeeWaived & sellerFeeWaived discounts are applied
     * Half escrow fee is deducted in case buyer has IDEA_TOKENS in his account greater than equal to MINIMUM_IDEA_BALANCE
     * or when buyerFeeWaived or sellerFeeWaived discounts are applied
    ...
    function _calculateEscrowFee(
        ...
        if (
            offers[offerId].paymentToken == IDEA_TOKEN ||
            (offers[offerId].buyerFeeWaived && offers[offerId].sellerFeeWaived)
        ) {
            fee = 0;
        } else if (
            ideaTokenBalance >= minIDEABalance ||
            offers[offerId].buyerFeeWaived ||
            offers[offerId].sellerFeeWaived
        ) {
    ...
    /**
     * Used to apply escrow fee discounts to an offer
     * @param offerId id of the offer
     * @param buyerDiscount indicating discount applied to buyer
     * @param sellerDiscount indicating discount applied to seller
     */
    function applyDiscount(
        ...
        offers[offerId].buyerFeeWaived = buyerDiscount;
        offers[offerId].sellerFeeWaived = sellerDiscount;
    }
