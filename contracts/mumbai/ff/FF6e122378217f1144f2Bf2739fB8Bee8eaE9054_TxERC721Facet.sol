...
/******************************************************************************\
/// @title Portal - TxERC721 Facet
/// @dev This contract provides functions for user to deposit listed ERC721 token into the portal.
/******************************************************************************/
...
contract TxERC721Facet is IOperations {
    /* ------ TYPE & VARIABLES ------ */
    ...
    /// @notice Deposit a listed ERC721 token to the portal.
    ...
    function depositERC721(IERC721 _tokenAddress, uint88 _tokenId) external {
        ...
        require(balanceAfter - balanceBefore == 1, "TE721F: Invalid deposit amount");
        require(_tokenAddress.ownerOf(_tokenId) == address(this), "TE721: Invalid owner");
