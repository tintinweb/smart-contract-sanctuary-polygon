...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface, Ownable {
    ...
    event PlayerAddedBalance(uint256 gameId, address player, uint256 addedBalance, uint256 totalBalance);
    ...
    function addBalance() public payable {
        ...
        emit PlayerAddedBalance(s_gameId, msg.sender, balanceWithoutFee, s_totalBalance);
    }
    ...
    function fulfillRandomWords(uint256 requestId, uint256[] memory randomWords) internal override  {
        ...
        emit GameEnded(s_gameId, winner, requestId);
