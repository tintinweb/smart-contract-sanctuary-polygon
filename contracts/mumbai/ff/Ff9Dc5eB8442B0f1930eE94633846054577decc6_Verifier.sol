...
contract Verifier is Context {
        ...
        return
            keccak256(
                abi.encode(
                    ...
                    137, // uint256 chainId
                    address(0xAFaC06586574d87E36b00F1Fa083B372dE232e16) // address verifyingContract
                )
            );
    }
    ...
    function isValid(DataTypes.Draft memory draft, bytes memory signature)
        public
        view
        returns (bool)
    {
    ...
    function displayHash(DataTypes.Draft memory draft)
        public
        view
        returns (bytes32)
    {
        return hashDraft(draft);
    }
}
