...
contract SimpleTimelock {
    ...
    function setBeneficiary(address beneficiaryAddress_, uint256 tokenAmount_)
        public
        virtual
    {
        require(
        ...
        console.log(
            "Beneficiary set '%s' to '%s' ('%s' with release time)",
            beneficiaryAddress_,
            tokenAmount_,
            _releaseTime
        );
    ...
    function calculateTokensToUnlock(
        ...
        uint256 unlockTimes = diff.div(_unlockInterval);
