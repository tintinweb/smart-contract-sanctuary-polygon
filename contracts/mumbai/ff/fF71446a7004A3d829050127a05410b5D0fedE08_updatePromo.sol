...
contract updatePromo{
 ...
 // updatePromoCode
   function updatePromoCode ( uint64 eventIDs, string memory promoCode, PromoCodes[] memory _promoCodes, uint64 newIds) external
    // onlyOwner whenNotPaused
    { 
        ...
        if (newIds == 0){
                              ...
                              promoIsValid[promoCode][newIds] = true;
   }
}
}