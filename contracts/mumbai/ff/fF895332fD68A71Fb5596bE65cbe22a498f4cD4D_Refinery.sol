    ...
    */
    ...
    function compiledAttributes (uint256 _tokenId) internal view returns (string memory) {
        ...
        traits =  string(abi.encodePacked(
            ...
            attributeForTypeAndValue("Gold NFT Units", uint2str(tokenCounter[_tokenId])),',',
            attributeForTypeAndValue("Estimated Price (USD)", uint2str(averagePrice(_tokenId))),',',
            attributeForTypeAndValue("Total Weight", uint2str(TokenDetails[_tokenId].weight)),',',
            attributeForTypeAndValue("Average Purity (%)", uint2str(averagePurity(_tokenId)/100))
        ));
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        string memory imageToken = "https://thumbs.dreamstime.com/b/gold-pour-5074800.jpg";
        string memory metadata = string(abi.encodePacked(
             '{"name":"Refinery Gold NFT"',',',
            '"description":"Este es un token de refineria bla bla bla"',',',
            '"image":"',imageToken,'"',',',
