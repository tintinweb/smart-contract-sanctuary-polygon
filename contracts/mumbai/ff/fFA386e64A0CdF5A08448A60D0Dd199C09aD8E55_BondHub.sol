...
contract BondHub is BondNFTBase, VersionedInitializable, BondMultiState, HubStorage, IBondHub {
    ...
    modifier onlyGovOrLzHub() {
        _validateCallerIsGovernanceOrLzHubProxy();
        _;
    }
    ...
    /// @inheritdoc IBondHub
    function setLzHubProxy(address lzHubProxy) external override onlyGov {
        _setLzHubProxy(lzHubProxy);
    }
    ...
    function whitelistProfileCreator(
        ...
        bool whitelist
    ) external override onlyGovOrLzHub {
    ...
    function deployApplicationFollowModule(
        ...
        return InteractionLogic.deployApplicationFollowModule(ownerAddress, id);
    }
    ...
    function _setLzHubProxy(address lzHubProxy) internal {
        address prevlzHubProxy = _lzHubProxy;
        _lzHubProxy = lzHubProxy;
        emit Events.LzHubProxySet(msg.sender, prevlzHubProxy, lzHubProxy, block.timestamp);
    }
    ...
    function _validateCallerIsGovernanceOrLzHubProxy() internal view {
        if (msg.sender != _governance && msg.sender != _lzHubProxy)
            revert Errors.NotGovernanceOrLzHubProxy();
    }
    ...
    /// @inheritdoc IBondHub
    function getLzHubProxy() external view override returns (address) {
        return _lzHubProxy;
    }
}
