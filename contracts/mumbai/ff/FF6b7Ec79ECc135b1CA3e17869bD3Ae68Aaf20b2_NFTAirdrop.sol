...
/**
 * @dev {NFTAirdrop} contract, including:
 *
...
contract NFTAirdrop is Ownable {
    ...
    /**
     * @notice Only whitelisted users can call redeem.
     *
     * @param _account Address of user which will be minted NFTs.
     * @param _proof Merkle Proof.
     */
    function redeem(address _account, bytes32[] calldata _proof) public {
        require(
    ...
    function batchRedeem(
        ...
        for (uint i = 0; i < _totalMinting; i++) {
            redeem(_account, _proof);
        }
    }
