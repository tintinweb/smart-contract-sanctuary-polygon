...
contract YOSSART is BaseNFT {
    using Counters for Counters.Counter;

    uint256 private constant _minTokenType = 1;

    Counters.Counter private _tokenIDCounter;

    constructor() BaseNFT("summer school art test", "SSAT") {}
    ...
    function _requireValidTokenType(uint256 tokenType_) private pure {
        require(_minTokenType <= tokenType_, "ECD: invalid token type");
    }
