...
contract BTCv2Rewards is ERC20, ERC20Burnable, Ownable {

  mapping(address => bool) controllers;
  
  constructor() ERC20("BTCv2Rewards", "Bv2Rs") { }
...
contract BTC2NFT is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721("BTC2NFT", "BTCv2") {}
        // internal
        function _baseURI() internal view virtual override returns (string memory) {
        return "ipfs://QmZCGbKyohNyab7RK83MNrSWA6CuxuDbYnNAjy3o9ywr6y/";
    }
        // public
...
contract NFTStaking is Ownable, IERC721Receiver {
  ...
  mapping(uint256 => Stake) public vault; 
   ...
   constructor(BTC2NFT _nft, BTCv2Rewards _token) { 
    nft = _nft;
    token = _token;
  }
