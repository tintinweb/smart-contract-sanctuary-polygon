...
contract Characters is ERC721, ERC721Enumerable, Ownable {
    ...
    function encodeProps(character_properties memory character_props) internal pure returns (string memory props_part){
        props_part = string.concat(
                                ', {"trait_type": "strength", "value": ', Strings.toString(character_props.str),
                                '}, {"trait_type": "vitality", "value": ', Strings.toString(character_props.vit),
                                '}, {"trait_type": "dexterity", "value": ', Strings.toString(character_props.dex),
    ...
    function encodeStats(character_stats memory _stats) internal pure returns (string memory stats_part){
        stats_part = string.concat(
                            ', {"trait_type": "Attack", "value": ', Strings.toString(_stats.atk),
                            '}, {"trait_type": "Defense", "value": ', Strings.toString(_stats.def),
                            '}, {"trait_type": "Evade Chance", "value": ', Strings.toString(_stats.eva),
                            '}, {"trait_type": "HP", "value": ', Strings.toString(_stats.hp),
                            '}, {"trait_type": "Penetration Chance", "value": ', Strings.toString(_stats.pen),
                            '}, {"trait_type": "Critical Chance", "value": ', Strings.toString(_stats.crit),
                            '}, {"trait_type": "Luck", "value": ', Strings.toString(_stats.luck),
                            '}, {"trait_type": "Energy Restoration", "value": ', Strings.toString(_stats.energy_regen),
