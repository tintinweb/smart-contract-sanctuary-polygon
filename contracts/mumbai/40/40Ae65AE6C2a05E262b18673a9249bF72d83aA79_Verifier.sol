...
interface IVerifier {
    ...
    function verifyExitProof(bytes32 _rootHash, uint8 _chainId, uint32 _accountId, uint8 _subAccountId, address _owner, uint16 _tokenId, uint16 _srcTokenId, uint128 _amount, uint256[] calldata _proof) external returns (bool);
}
...
contract Config {
    ...
    uint256 internal constant BLOCK_PERIOD = 1 seconds;
