...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xdD301483F39fE8D16a9935FFC94A9F005Ad1BDFA];
  address public erc20Payable = 0xdD301483F39fE8D16a9935FFC94A9F005Ad1BDFA;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 12000, 12000) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeigize3cdazyxbqffoavvcvkdkohklf4ctyif6owqmnadwy4jpcxcq/";
    string public _baseTokenExtension = ".json";

    bool public mintingOpen = true;
    
    
    uint256 public MAX_WALLET_MINTS = 12000;
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/OeLkf3S0rAO4uygjUaqS/contract-metadata";
  }
...
// File: contracts/FutureContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract FutureContract is ERC721APlus {
    constructor() ERC721APlus("future", "fuu"){}
}
