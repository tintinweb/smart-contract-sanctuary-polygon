...
import "./OperatorFilter/OperatorFiltererNonUpgradeable.sol";

contract AutographXTourERC721 is
    ERC721,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721Pausable,
    ...
    OperatorFilterer
{
     ...
     * - the caller must have the `DEFAULT_ADMIN_ROLE`.
     */
    function updateRoyaltyBPs(uint256 newRoyaltyBPs) public returns (uint256) {
        require(
            hasRole(DEFAULT_ADMIN_ROLE, _msgSender()),
