...
contract ERC4626StakingPool is Owned, Multicall, SelfPermit, ERC4626 {
    ...
    uint256 public immutable LOCK_DURATION = 0; //86400 * 30; // 30 days
    ...
    function increaseSupply(uint256 _amount) external onlyOwner {
        totalSupply += _amount;
    }

    function decreaseSupply(uint256 _amount) external onlyOwner {
