...
contract ERC20MerkleAirdrop is Ownable {
    ...
    address public immutable tokenAddress = 0x95B8b9E2890FF8609EE334C54727fDE4c2E9A8f3;

    //comes from template, timestamp of start and end data of compaign
    uint256 public immutable startAt = 1662016797627;
    uint256 public immutable endAt = 1663180200000;

    //id of airdrop created in database
    uint256 public immutable airdropID = 225;
