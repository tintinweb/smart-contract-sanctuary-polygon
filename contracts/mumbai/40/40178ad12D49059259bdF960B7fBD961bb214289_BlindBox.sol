...
interface INFTConfig{
    function newMint(address toAddress, uint256 tokenType) external;
}
...
contract BlindBox is Ownable, Initializable, ItemPool {
    ...
    function sendReward(ITEM_POOL memory _reward_item) internal {
        ...
        if (_reward_item.item_type == ITEM_TYPE_1){
            ...
            //ERC721
            nft.newMint(_msgSender(), _reward_item.item_type);
        }
    }
}
...
contract ItemPool is Ownable {
    ...
    // n-token
    uint constant public ITEM_TYPE_1 = 1;
    // s-token
    uint constant public ITEM_TYPE_2 = 2;

    // n-nft
    uint constant public ITEM_TYPE_10 = 10;
    uint constant public ITEM_TYPE_11 = 11;
    uint constant public ITEM_TYPE_12 = 12;
    uint constant public ITEM_TYPE_13 = 13;
    uint constant public ITEM_TYPE_14 = 14;

    // s-nft
    uint constant public ITEM_TYPE_20 = 20;
    uint constant public ITEM_TYPE_21 = 21;
    uint constant public ITEM_TYPE_22 = 22;
    uint constant public ITEM_TYPE_23 = 23;
    uint constant public ITEM_TYPE_24 = 24;
    ...
    function initItemPool() public onlyOwner {
     ...
     function updateItemPool(ITEM_POOL[] memory _itemPool) public onlyOwner {
