...
contract Dao{
    ...
    uint256[] public validTokens;
     IdaoContract daoContract;      //reference to balaceOf interface

     constructor(){
        owner = msg.sender;
        nextProposal = 1;
        daoContract = IdaoContract(0x2953399124F0cBB46d2CbACD8A89cF0599974963);
        validTokens = [38847207390994177525203518286377614023083498490266232974451199770841533382676];
    }
    struct proposal{
        uint256 id;
        bool exists;
      ...
      //mapping to make uints public (as a feature of dao)
    ...
    function checkVoteEligibility(uint256 _id, address _voter) private view returns (
     ...
     function createProposal(string memory _description, address[] memory _canVote) public {
        ...
        proposal storage newProposal = Proposals[nextProposal];  //initially nextProposal=1
        ...
        nextProposal++;   //incrementing nextProposal
    }
