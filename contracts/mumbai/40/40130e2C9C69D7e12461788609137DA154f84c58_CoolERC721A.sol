...
import './utils/CoolUpgradeableERC721ErrorsAndEvents.sol';
  ...
  ErrorsAndEvents
{
  ...
  /// @dev Designed to reflect a constant in child contracts
  ...
  function mint(address to, uint256 amount) external onlyMinter {
    ...
    unchecked {
      if (nextTokenId + amount > MAX_LIMIT) {
  ...
  function addMinter(address minter) external onlyManager {
  ...
  function removeMinter(address minter) external onlyManager {
