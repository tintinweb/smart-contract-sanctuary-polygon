...
contract RealE {
    ...
    // Functions Users Reviews

    function addReview (uint256 productId, uint256 rating, string calldata comment, 
    address user) external {
        ...
        //Update review_struct y user_reviews
    ...
    function likeReview(uint productId, uint256 reviewIndex, address user) external {
