...
/* STAKING MECHANICS */
    ...
    function setCropTokenAddress(address rewardTokenAddr) public onlyOwner() {
    ...
    //deposit function. 
    function deposit(uint256[] calldata tokenIds) external whenNotPaused requireStakingNftToken requireCropToken {
    ...
    //withdrawal function.
    function withdraw(uint256[] calldata tokenIds) external whenNotPaused requireStakingNftToken requireCropToken nonReentrant() {
        claimRewards(tokenIds);
