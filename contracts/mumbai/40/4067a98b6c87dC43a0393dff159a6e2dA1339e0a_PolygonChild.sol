...
// File @openzeppelin/contracts/vendor/polygon/[email protected]
...
// File @openzeppelin/contracts/crosschain/polygon/[email protected]
...
// File contracts/PolygonChild.sol
...
contract PolygonChild is CrossChainEnabledPolygonChild, AccessControlCrossChain {
    ...
    function setNumberForParentChain(uint256 number_) external onlyRole(DEFAULT_ADMIN_ROLE) {
        number = number_;
    }
    ...
    function getEncodedSetNumberData(
        uint256 newNumber
    ) external pure returns (bytes memory) {
        return
            abi.encodeWithSelector(
                this.setNumberForParentChain.selector,
                newNumber
            );
    }
}