...
contract HomoRegistry is Homo {
    ...
    bytes32 public constant BASE_NODE= 0x22f7ffeaaad6e7521792b950a2fc614a219b299aff178d82c186a6d51e1b8771;
     ...
     * @param ttl The TTL in seconds.
     */
    function setNameResolver(bytes32 node, address resolver, uint64 ttl) external virtual override {
        address user = records[node].user;
    ...
    function setOwner(bytes32 node, address owner) public virtual override authorised(node) {
     ...
     // 将name的User更换
    function setNameUser(address to,string memory name)external {
