...
contract BattleShroomsGenOne is ERC721Enumerable, Ownable {
    ...
    uint256 private _price = 20000000000000000 wei;  // 0.02  changed price for test purp
    uint256 private _botHolderDiscont = 10000000000000000 wei;
    ...
    constructor() ERC721("Via Protocol test NFT", "VIATEST") {}
    ...
    function mintShroom(uint256 num) public payable {
        ...
        require( num <= maxPerTx, "Exceeds maximum amount of VIA per tx" );
        require( supply + num <= MAX_SUPPLY - _giftReserved - _presaleReserved, "Exceeds maximum VIA supply" );
    ...
    function mintPresaleShroom() public payable {
        ...
        require( supply + 1 <= _presaleReserved, "Exceeds maximum VIA presale reserved supply" );
        require( balance == 0, "You already have some VIA" );
    ...
    function giveAway(address _to, uint256 _amount) external onlyOwner() {
        require( _amount <= _giftReserved, "Exceeds reserved gift VIA supply" );
