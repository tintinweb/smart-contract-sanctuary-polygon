...
contract MojoMultiplier is ERC721, ERC721Enumerable, Ownable {
	...
	uint256 public PRICE = 20000000 gwei;
	...
	constructor(string memory _name, string memory _symbol, string memory _initTokenURI) ERC721(_name, _symbol) {
		setTokenUri(_initTokenURI);
	}
	
	function claimFree() external {
		require(!claimPaused, "Claim Free Paused");
	...
	function mintFree(bytes calldata _signature) external payable {
