    ...
    Initializable
{
    ...
    // medium win odds
    uint16 public constant MEDIUM_WIN_ODDS = 50; // 0.5%
    // small win odds
    uint16 public constant SMALL_WIN_ODDS = 200; // 2%
    ...
    uint256 public constant MEDIUM_WIN_PCT = 200; // 2%
    // small win percentage (prize pool)
    uint256 public constant SMALL_WIN_PCT = 20; // 0.2%
