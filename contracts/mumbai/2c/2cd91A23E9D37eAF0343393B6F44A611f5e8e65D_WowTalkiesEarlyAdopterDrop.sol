  ...
  ERC1155BurnableUpgradeable
{
  ...
  function registerToken(uint256 _tokenId, uint256 _supply) external adminOnly {
  ...
  function pauseToken(uint256 _tokenId, bool _pauseStatus) external adminOnly {
  ...
  function burn(uint256 tokenId, uint256 value) external {
    ...
    super.burn(_msgSender(), tokenId, value);
    emit TokenBurned(_msgSender(), tokenId, value);
  }
