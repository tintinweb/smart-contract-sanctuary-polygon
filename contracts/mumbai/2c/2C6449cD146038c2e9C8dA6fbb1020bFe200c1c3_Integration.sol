...
/// @dev
contract Integration is Initializable{
    ...
    function initialize (address roleContract,address payable bankContract, address integration_approveContract,address payable governorContract) initializer public  {
    ...
    /// @notice Get current Reference to Bank Address.
    /// @dev Get current Reference to Bank Address.
    /// @return address DataFeed Address.
    function getBank() 
    onlyAdmin
    public view returns (address) {
