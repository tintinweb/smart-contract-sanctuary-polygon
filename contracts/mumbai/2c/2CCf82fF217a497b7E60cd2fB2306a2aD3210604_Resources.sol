...
/**
 * @title Resources - ERC1155 contract to represent Resources in the PV Gaming Ecosystem
 * 
 * @author Jack Chuma
 */
contract Resources is ERC1155, AccessControl {
    ...
    /**
     * @notice Called by whitelisted address to mint new resources
     * @param _to Address to mint assets to
     * @param _id Resource ID to add
     * @param _amount Amount of resource to mint
     */
    function mint(
        address _to,
        uint256 _id,
