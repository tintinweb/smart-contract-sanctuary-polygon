    ...
    ITokenERC721
{
        ...
        returns (string memory)
    {
        ...
        string[4] memory background = ["Grey", "Tuinien", "Pink", "Blue"];
        string[4] memory Tuinier = ["Tuinier 30", "Maurino", "Naief", "Verstandig"];
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                ...
                                onchain[_tokenId],
                                '", "attributes": [',
                                '{ "trait_type": "Tuinier",         "value":"', Tuinier[_tokenId] ,      '"},',
                                '{ "trait_type": "Background",      "value":"', background[_tokenId] ,   '"}',
                                ']}'
                            )
                        )
                    )
