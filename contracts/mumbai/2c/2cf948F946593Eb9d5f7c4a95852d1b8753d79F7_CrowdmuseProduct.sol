...
contract CrowdmuseProduct is ERC721, ERC721URIStorage, ERC721Enumerable, ERC2981, ReentrancyGuard, Ownable {
  ...
  function buyNFT(address _to, string memory garmentType) public nonReentrant returns (uint256 _tokenId) {
    ...
    require(inventoryGarmentsRemaining[keccak256(abi.encodePacked(garmentType))] > 0, "None of this type remaining");
