...
contract DummyNFT_V2 is ERC721, ReentrancyGuard, Signable {
    ...
    Types.WithdrawalAddress[] public withdrawalAddresses;
    ...
    constructor(
        ...
        address _owner,
        Types.WithdrawalAddress[] memory _withdrawalAddresses
    ) ERC721(_name, _symbol) Signable(_owner) {
    ...
    function setProxyTrackingContract(
        IProxyTracking proxyTrackingContract_
    ) external onlyOwner {
...
library Errors {
    ...
    error MismatchTokenIdsAndValues();
