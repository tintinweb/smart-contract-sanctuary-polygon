 ...
 */
contract daddyusernamenft is ERC721, ReentrancyGuard, Ownable
{
	struct Username
	{
		string username;
	...
	uint public username_price = 10000000000000;
	 ...
	 */
	constructor() ERC721("DAD-username-nft", "DUNAME") Ownable()
	{
	}
	...
	function tokenURI(uint256 _token_id) public view override returns(string memory)
	{
		...
		string memory json = string(
			abi.encodePacked(
                ...
                '"attributes": [{"trait_type": "background color", "value": "', username.bg_color, '"}],',
