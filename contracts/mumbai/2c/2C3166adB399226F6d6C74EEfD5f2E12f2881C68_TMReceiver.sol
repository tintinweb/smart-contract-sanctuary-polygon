...
contract TMReceiver is IRateProvider, OwnableUpgradeable {
    // Global state
    ...
    function processMessageFromRoot(uint256 stateId, address rootMessageSender, bytes calldata data) external {
        ...
        require(rootMessageSender == tmSender, "Root sender not authorized");
    ...
    function setSender(address _tmSender) external onlyOwner {
        tmSender = _tmSender;
    }
}