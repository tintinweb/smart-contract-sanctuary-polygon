...
contract HBDToken is ERC721, Ownable {
    ...
    function tokenURI(uint256) public view override returns (string memory) {
        ...
        bytes memory dataURI = abi.encodePacked(
            "{",
            '"name": "Nazuna 24th Birthday Countdown",',
            unicode'"description": "Happy 23rd Birthday🎉",',
            '"attributes": [{"display_type": "date", "trait_type": "birthday", "value": 938390400}],',
