...
contract sUSDR is AddressAccessor, ERC20Permit {
    ...
    event Rebase(uint256 indexed blockNumber, uint256 supplyDelta);
        ...
        onlyRole(MINTER_ROLE)
    {
        ...
        require(amount_ <= MAX_UINT256 - totalSupply(), "max supply exceeded");
    ...
    function rebase(uint256 supplyDelta) external onlyRole(CONTROLLER_ROLE) {
        ...
        if (supplyDelta > 0) {
            ...
            uint256 maxSupplyDelta = MAX_UINT256 - totalSupply();
