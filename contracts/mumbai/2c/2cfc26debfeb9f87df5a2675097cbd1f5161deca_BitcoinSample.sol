...
contract BitcoinSample is ERC721, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721("BitcoinOrange", "XNFTs") {
        maxSupply = 320000;
    ...
    function convertBitcoinToMatic() public view returns (uint256) {
        ...
        uint256 btcValue;
        uint256 bitcoinOrangeValue;
        uint256 bitcoinOrangeValueInMATIC;
        uint256 maticValue;
        ...
        bitcoinOrangeValue = btcValue / 10000; // 1 Bitcoin Orange value in USD
        maticValue = ((10**18) * uint256(maticPrice)) / maticDecimals; // ETH value in USD
        finalMaticValue = (((10**18) * btcValue) / maticValue) * (1 ether);
        bitcoinOrangeValueInMATIC = ((finalMaticValue / 10**18) / 10000);
        return (bitcoinOrangeValueInMATIC);
    }
}