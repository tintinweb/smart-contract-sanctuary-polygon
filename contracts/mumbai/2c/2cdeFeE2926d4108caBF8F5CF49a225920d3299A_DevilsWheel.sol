...
contract DevilsWheel is VRFConsumerBase, ERC20, Ownable {
  ...
  address bet_token = 0x9Eef61eE71574887Fc4697Ba5250d5270b603D1d;
    ...
    public
  {
    ...
    if (current_shares <= 0) {
      ...
      _mint(
        msg.sender,
        BASE_SHARES * ((added_liquidity / 100) * 95)
      );
      _mint(
        owner(),
        BASE_SHARES * ((added_liquidity / 100) * 5)
      );
      return;
    }
