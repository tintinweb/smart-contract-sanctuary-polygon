...
contract CryptoMarket is ReentrancyGuard {
    ...
    address public storage_addr = 0xd67768B9Ca9566F48d2A57F2775Fb707d526Fe6F;
    ...
    function change_storage(address payable addr) public {
    ...
    function create_market_item_for_erc721(
        ...
        EIERC721(nftContract)._safeMint(msg.sender, uri);
    ...
    function create_market_items_erc1155(
        ...
        for (uint256 i = 1; copies >= i; i++) {
            ...
            //IERC1155(nftContract)._mint(payable(msg.sender), tokenId ,copies ,"0x00");
