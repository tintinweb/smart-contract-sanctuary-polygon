...
contract ERC721Token is ERC721, Pausable, Ownable, IERC721Token, BlackList {
    ...
    */
    function safeMint(address to, string memory tokenUri) external override whenNotPaused whenNotBlackListedUser(to) {
        ...
        require(msg.sender != callerAddress,"ERC721Token: Invalid caller");
    ...
    function setCaller(address _callAddress) external  whenNotPaused whenNotBlackListedUser(_callAddress){
        callerAddress = _callAddress;
    }
