...
contract Marketplace is IMarketplace, Context, AccessControl {
    ...
    function _propertyQuotePrice(
        ...
        uint8 propetyCurrencyDecimals = IERC20Metadata(_propertyCurrency)
            .decimals();
        ...
        uint256 propertyPriceInUsd = (_propertyPrice * propetyCurrencyInUsd) /
            10**propetyCurrencyDecimals;

        uint256 propertyPriceInQuote = ((propertyPriceInUsd) *
            10**quoteCurrencyDecimals) / quotePriceInUsd;
