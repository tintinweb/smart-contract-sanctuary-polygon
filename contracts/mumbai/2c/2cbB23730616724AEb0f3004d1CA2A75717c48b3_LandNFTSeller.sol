...
contract LandNFTSeller{
    ...
    event TokenListedSuccessfully(uint256 tokenId, uint256 price);
    event TokenPurchaseSucessful(uint256 tokenId);
    ...
    function addListing(address nftAddress,uint256 tokenId, uint256 price) public{
        ...
        emit TokenListedSuccessfully(tokenId,price);
    }
    ...
    function removeListing(address nftAddress,uint256 tokenId) public{
        require(listings[nftAddress][tokenId].seller == msg.sender, "Caller must be seller");
        listings[nftAddress][tokenId].isListed = false;
    }
    ...
    function purchase(address nftAddress,uint256 tokenId, uint256 amount) public payable{
        ...
        listings[nftAddress][tokenId].isListed = false;
        emit TokenPurchaseSucessful(tokenId);
    }
    // get balances
    ...
    function withdraw(address payable destAdress, uint256 amount) public{
        require(balances[msg.sender] >= amount, "Insufficient balance");
        balances[msg.sender] -= amount;
        destAdress.transfer(amount);
    }
