...
contract PoolConfigurator is VersionedInitializable, IPoolConfigurator {
  ...
  /// @inheritdoc IPoolConfigurator
  function setReserveInterestRates(address asset, uint256 borrowRate, uint256 prxyRate, uint256 prxyRate2) public override onlyPoolAdmin {
    _pool.setReserveInterestRates(asset, borrowRate, prxyRate, prxyRate2);
  }
...
library ConfiguratorInputTypes {
  struct InitReserveInput {
    ...
    uint256 prxyRate2;      // PRXY APR (collateral)
