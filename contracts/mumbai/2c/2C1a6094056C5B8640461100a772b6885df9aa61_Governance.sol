...
contract Governance is Governor, GovernorCompatibilityBravo, GovernorVotes, GovernorVotesQuorumFraction, GovernorTimelockControl {
        ...
        GovernorTimelockControl(_timelock)
    {
        ...
        regulation.votingDelay = 86400;
        regulation.votingPeriod = 604800;
    ...
    function setVotingPeriod(uint newVotingPeriod) public onlyGovernance {
        require(newVotingPeriod != 0, "setVotingPeriod: new voting period is zero");
        regulation.votingPeriod = newVotingPeriod;
    }
    ...
    function votingPeriod() public view override returns (uint256) {
        return regulation.votingPeriod;
    }
}