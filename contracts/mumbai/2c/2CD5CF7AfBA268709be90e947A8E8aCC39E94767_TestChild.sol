...
// File: contracts/SampleChild.sol
...
contract TestChild is FxBaseChildTunnel, Ownable {
    /*///////////////////////////////////////////////////////////////
                            STORAGE
    /////////////////////////////////////////////////////////////*/


    uint256 public rewardsRate = 15 ether;
    ...
    IERC20 public token = IERC20(0xab8DA8f28ff5e1B86bc649700c7E478d320E808E);
    ...
    function _processMessageFromRoot(
        ...
        action
            ? processStake(from, count)
            : processUnstake(from, count);
    }
    ...
    function earned(address account) public view returns (uint256) {
        return
            rewardsPerSecond(account) * (block.timestamp - lastUpdated[account]);
    }

    function rewardsPerSecond(address account) internal view returns (uint256) {
        return balances[account] * (rewardsRate / 1 days);
    }
