...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, Ownable{
 ...
 contract TraderTesting is ERC721{
    ...
    uint256 public giftMintLimit = 30;              //  Gift mint limit
    
    uint256 public giftMintId = 10001;
    uint256 public publicMintId = 1;

    uint256 public mintPrice = 1 * 10 ** 17 ;        // minting price 0.1 matic
    ...
    constructor() ERC721("TraderTesting", "TTT"){}
...
/*
  ...
  */
    ...
    function airDropToken(address _address, uint256 _tokenID) public isHalt onlyOwner{
        require(_tokenID > 0 && _tokenID <= 10050, "You have passed wrong value");
        airDropMinted++;
        totalMinted++;
