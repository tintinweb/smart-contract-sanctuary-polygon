 ...
 * @notice This contract handles minting BraveBrew's World of #Freedom tokens.
 */
contract BraveBrewsWorldOfFreedom is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x3B7ebaE489245F57608d868C75CDf595EC7F64BD;
    ...
    address public royaltyAddress = 0xFD15308cd7464a10f6A3aD5635A04e32171238fD;
    address[] public payoutAddresses = [
        0x3D58f6cf1F839e4340d748E356Ae8166ad6EEf42,
        0xAC71DF8e7dec6b1f4183A3a33EDc5ced722774d4
    ];
    ...
    string public baseTokenURI =
        "ipfs://bafybeidvwgjfdflhyswgwskm2ur7pikswpofe2bpwfc55y5eybupz7zmz4/";
    // Maximum supply of tokens that can be minted
    uint256 public MAX_SUPPLY = 344;
    // Total number of tokens available for minting in the presale
    uint256 public PRESALE_MAX_SUPPLY = 75;
    // Fee paid to HeyMint per NFT minted
    uint256 public heymintFeePerToken;
    uint256 public presaleMintsAllowedPerAddress = 1;
    uint256 public presaleMintsAllowedPerTransaction = 344;
    uint256 public presalePrice = 75 ether;
    uint256 public publicMintsAllowedPerAddress = 344;
    uint256 public publicMintsAllowedPerTransaction = 344;
    uint256 public publicPrice = 175 ether;
    // The respective share of funds to be sent to each address in payoutAddresses in basis points
    uint256[] public payoutBasisPoints = [9500, 500];
    uint96 public royaltyFee = 500;

    constructor(address _crossmintAddress, uint256 _heymintFeePerToken)
        ERC721A("BraveBrew's World of #Freedom", "B3Wo#F")
        RevokableOperatorFilterer(
