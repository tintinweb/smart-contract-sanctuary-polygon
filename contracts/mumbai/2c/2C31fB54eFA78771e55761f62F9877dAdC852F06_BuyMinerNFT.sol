...
contract BuyMinerNFT is Ownable {
    ...
    function buyMinNFT() lock public payable {
        require(msg.value.mod(priceMinMiner) == 0, "The amount of MATIC is incorrect.");
        uint256 creatNumber = msg.value.div(priceMinMiner);
    ...
    function buyMidNFT() lock public payable {
        require(msg.value.mod(priceMidMiner) == 0, "The amount of MATIC is incorrect.");
        uint256 creatNumber = msg.value.div(priceMidMiner);
        require(creatNumber > 0, "You need pay enough MATIC.");
    ...
    function buyMaxNFT() lock public payable {
        require(msg.value.mod(priceMaxMiner) == 0, "The amount of MATIC is incorrect.");
        uint256 creatNumber = msg.value.div(priceMaxMiner);
        require(creatNumber > 0, "You need pay enough MATIC.");
