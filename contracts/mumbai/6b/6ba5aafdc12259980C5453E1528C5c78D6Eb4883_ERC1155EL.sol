...
contract ERC1155EL is Initializable, ERC1155URIStorageUpgradeable, UUPSUpgradeable, OwnableUpgradeable {
    using CountersUpgradeable for CountersUpgradeable.Counter;

    // Contract name for opensea
    string public name;
    ...
    /**
     * @dev Anyone creates `amount` new tokens for `to`, of token type `id`
     */
    ...
    /**
     * @dev Destroys `amoount` tokens of token type `id` from `from`
     */
