...
contract BadBunnyYachtClub is ERC721rEnumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public whiteListCost = 0.000020 ether;
    uint256 public cost = 0.000025 ether;
    ...
    function removeAddressFromAirdropList(address addressToRemove) external onlyOwner {
