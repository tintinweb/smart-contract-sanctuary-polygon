...
contract PrintzNft is ERC721A, Ownable, ReentrancyGuard {
    ...
    modifier mintCompliance(address _receiver, uint256 _mintAmount) {
        ...
        require(_numberMinted(_receiver) < MAX_MINTS_PER_WALLET, "Reciever Has Exceeded the limit");
    ...
    function mintForAddress(
        address _receiver,
        uint256 _mintAmount
    ) external payable mintCompliance(_receiver, _mintAmount) {
        _safeMint(_receiver, _mintAmount);
    }
