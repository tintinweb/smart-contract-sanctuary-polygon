 ...
 */
abstract contract ERC721Burnable is
    Context,
    ERC721,
    Ownable
{
...
interface TattooMoneyNFT721Ori {
...

{
    ...
    TattooMoneyNFT721Ori public TattooMoneyNFT721Sing;


     constructor(uint256 id , address _whitelistAdmin, address originalContract,string memory type1,address  address1,string memory type2,address address2) 
        ERC721("TattooMoneyNFT", "TattooMoneyNFT")    
    {   
        _tid = id; 
        deci = 18;
        ...
        TattooMoneyNFT721Ori _TattooMoneyNFT721 = TattooMoneyNFT721Ori(originalContract);
        // set the rest of the contract variables
        TattooMoneyNFT721Sing = _TattooMoneyNFT721;

        tokentype[type1] = address1;
        tokentype[type2] = address2;
    }
    ...
    function newtokenasbid(
        ...
        serviceValue = TattooMoneyNFT721Sing.getServiceFee();
        address payable admin =  payable(TattooMoneyNFT721Sing.getOwner());
