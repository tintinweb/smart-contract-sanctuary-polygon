...
contract Mystery is Initializable, ERC721Upgradeable, ERC721BurnableUpgradeable, OwnableUpgradeable, EIP712Upgradeable, ERC721VotesUpgradeable, UUPSUpgradeable {
    ...
    function initialize() initializer public {
        __ERC721_init("MysteryGirlfriend", "MGF");
        __ERC721Burnable_init();
        __Ownable_init();
        __EIP712_init("MysteryGirlfriend", "1");
        __ERC721Votes_init();
        __UUPSUpgradeable_init();
        baseuri = "https://bafybeiampl2zrvyd6nonnkilpgepx7wgonlvoii6yjb6asdnqd7ytl7sqm.ipfs.nftstorage.link/metadata/";
    }
    ...
    // reveal baseuri
    function revealURI(string memory revealUri) public onlyOwner{
        baseuri = revealUri;
    }
    ...
    function safeMint(address to) public onlyOwner {
        ...
        require(tokenId <= TotalSupply, "Max token supply reached");
