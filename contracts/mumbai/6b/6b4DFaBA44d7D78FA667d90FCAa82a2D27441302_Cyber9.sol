...
contract Cyber9 is ERC721Enumerable, Ownable, RNG, VRFConsumerBase {
    ...
    uint256 public maxSupply = 15; //CHANGE BACK TO 9000
    uint256 public maxMintPerTx = 10;
    uint256 public cost = 50 ether;
    uint256 private attackCD = 1 days;
    uint256 private defeatedCD = 300; //CHANGE BACK TO 3 DAYS
    uint256 private startFrom = 9; //Start the random mint from
    uint256 constant public MAX_LEVEL = 10; //CHANGE BACK TO 50
    ...
    function freeMint(uint256 _badgeId) external {
     ...
     function mintLogic(uint256 _amount) private {
        ...
        for(uint256 i=0; i<_amount;i++) {
            ...
            characters[_newId].setStats(1,_hp, _strength,_agility,_intelligence,_dexterity,_luck,375000);
