...
contract OpusDiamond {
    ...
    constructor(IDiamondCut.FacetCut[] memory _diamondCut, ConstructorArgs memory _args) {
        ...
        LibERC2771Context.setTrustedForwarder(address(_args.trustedForwarder));
        LibDiamond.diamondCut(_diamondCut, _args.init, _args.initCalldata);

        s.tokenName = _args.tokenName;
        s.tokenSymbol = _args.tokenSymbol;
        s.tokenUri = _args.tokenUri;
        s.categories.push("Contribution");
