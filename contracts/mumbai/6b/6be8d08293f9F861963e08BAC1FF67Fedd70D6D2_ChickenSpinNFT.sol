...
contract ChickenSpinNFT is ERC721Enumerable, ERC721Votes, AccessControl {
    ...
    constructor(address _admin, address _treasury, address _dev) ERC721("ChickenSpinNFT", "CHK") EIP712("ChickenSpinNFT", "1") {
