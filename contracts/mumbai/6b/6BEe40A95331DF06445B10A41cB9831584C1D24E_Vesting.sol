    ...
    PausableUpgradeable
{
    ...
    function isUpgrader(address wallet) public view returns (bool) {
    ...
    function _onlyUpgradeWallet() private view {
        require(
            _upgrades[_msgSender()],
            "Vesting : Sender is not upgrade wallet"
        );
    }
