...
contract SocialMisFits is ERC721Enumerable, Ownable, Pausable {
    ...
    mapping(address => mapping(string => uint256)) private gameAttributes;
    ...
    function setAttributes(string memory _attribute) public onlyOwner {        
    ...
    function userUpgradeAttributes(string memory _attribute, uint256 _value) public {        
        gameAttributes[msg.sender][_attribute] = _value;
    }
