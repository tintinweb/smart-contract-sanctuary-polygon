...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 15, 5000 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmbCZbJnMPnroQQeZTGqkdEBcjpLRNpyodno9kTWrnjwck/";
...
contract GoldenHandCatsContract is RamppERC721A {
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/FhnLo0UolLw6NXCkQo8X/contract-metadata";
    }
}
