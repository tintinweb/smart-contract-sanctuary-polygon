...
contract ve is IERC721, IERC721Metadata {
    ...
    uint internal constant MAXTIME = 10 * 30 * 86400;
    int128 internal constant iMAXTIME = 10 * 30 * 86400;
    ...
    string constant public name = "veFBA";
    string constant public symbol = "veFBA";
    ...
    function _create_lock(uint _value, uint _lock_duration, address _to) internal returns (uint) {
        ...
        require(unlock_time <= block.timestamp + MAXTIME, 'Voting lock can be 10 months max');
