...
contract Guestbook is Initializable, ERC2771ContextUpgradeable(address(0x75bA5Af8EFFDCFca32E1e288806d54277D1fde99)), AccessControlUpgradeable {
    ...
    function signGuestbook(string memory _message) public {
        ...
        emit NewEntry(_msgSender(), _message, block.timestamp);
    }
