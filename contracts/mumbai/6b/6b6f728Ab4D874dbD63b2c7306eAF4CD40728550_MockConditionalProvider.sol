...
// File: contracts/IConditionalProvider.sol
...
// File: contracts/ConditionalProvider.sol
...
// File: contracts/MockConditionalProvider.sol

pragma solidity ^0.8.0;


contract MockConditionalProvider is ConditionalProvider {
    function isEligible(address _address) external view override returns (bool _isEligible) {
        _isEligible = false;
    }
}