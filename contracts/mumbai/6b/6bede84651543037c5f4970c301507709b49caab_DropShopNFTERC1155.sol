    ...
    RoyaltiesV2Impl
{
    ...
    */
     ...
     * but can be changed as per requirement
     */
    function bulkMint(address to, uint256[] calldata amounts,bytes calldata data) external only(MINTER_ROLE) {
     ...
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC1155Upgradeable, AccessControl) returns (bool) {
