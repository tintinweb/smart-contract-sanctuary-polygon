...
contract CapTable {
	...
	address public visAddr = 0x4382Ba37F5Fff804e96620A1CE168694FF8c53DC;
	...
	constructor() {
		...
		shares[0] = 33_000_000 * (10 ** 18) - 33000000;
		shares[1] = (23_999_987 - 20_013) * (10 ** 18) - 23979974;
		shares[2] = 9_000_000 * (10 ** 18) - 9000000;
		shares[3] = 7_250_000 * (10 ** 18) - 7250000;
		shares[4] = 7_250_000 * (10 ** 18) - 7250000;
		shares[5] = 6_500_000 * (10 ** 18) - 6500000;
		shares[6] = 6_500_000 * (10 ** 18) - 6500000;
		shares[7] = 5_000_000 * (10 ** 18) - 5000000;
	}
	...
	function releaseFunds() external {
		IERC20 visContract = IERC20 (visAddr);
