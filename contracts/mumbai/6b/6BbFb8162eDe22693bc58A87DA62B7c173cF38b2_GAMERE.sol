...
contract GAMERE is BEP20 {
    ...
    mapping(address => uint) public minting_limit;
    ...
    function _mint(address account, uint256 amount) internal override {
        require(minting_limit[account] >= amount, "Insufficient minting limit");
        minting_limit[account] -= amount;
