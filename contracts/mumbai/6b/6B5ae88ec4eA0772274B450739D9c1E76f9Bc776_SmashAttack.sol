...
contract SmashAttack is ERC1155LazyMint {
    ...
    function burn(
        ...
        require(
            msg.sender == account ||
                balanceOf[msg.sender][2] > 0 || // Iron Sword
                balanceOf[msg.sender][POWER_UP_ID] > 0 || // Attack Power-Up
                balanceOf[msg.sender][DEFENSE_ID] > 0, // Defense Power-Up
            "NOT_TOKEN_OWNER or Iron Sword or Power-Up"
        );
        ...
        if (defenses[victim] > 0) {
            ...
            if (balanceOf[attacker][POWER_UP_ID] > 0) {
                ...
                if (remainingUses == 1) {
                    ...
                    // Defense power-up successfully defended the attack once, reduce the remaining uses
                    defenses[victim]--;
                    _burn(attacker, highestLevelWeapon, 1);
                    _mint(victim, 3, 1, "");
                    emit Defended(attacker, victim);
        ...
        gameNotPaused
    {
        ...
        emit UsedAttackPowerUp(msg.sender, victims);
    }
