...
// File contracts/NeoPunksDNA.sol



pragma solidity ^0.8.9;

contract NeoPunksDNA {
    ...
    // TODO: Implementar Chainlink para el número random https://docs.chain.link/vrf/v2/introduction 
...
contract NeoPunks is ERC721, ERC721Enumerable, Ownable, NeoPunksDNA {
    ...
    constructor(uint256 _maxSupply) ERC721("NeoPunks", "NPKS") {
        maxSupply = _maxSupply;
    }

    function mint() public onlyOwner {
        uint256 current = _tokenIdCounter.current();
        require(current < maxSupply, "No NeoPunks left :(");
    ...
    returns(string memory)
    {
        ...
        string memory jsonURI = Base64.encode(
            abi.encodePacked(
                '{ "name": "NeoPunks #',
                _tokenId.toString(),
                '", "description": "NeoPunks are randomized Avataaars stored on chain to teach DApp development on Platzi", "image": "',
                image,
                '"}'
            )
        );
    ...
    /** 
     * TODO: Recibir ethers en cada minteo
     *  */
}