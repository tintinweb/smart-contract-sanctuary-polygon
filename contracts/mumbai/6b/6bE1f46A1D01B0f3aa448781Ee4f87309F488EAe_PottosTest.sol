...
contract BaseSBT is ERC721Enumerable, IERC4906, Ownable, Pausable {
...
contract PottosTest is BaseSBT {
    ...
    constructor() BaseSBT("PottosTest", "PT") {}
    ...
    function airdropByType(
        ...
        require(!_isAirdroppeds[to_], "PI: already airdropped");
    ...
    function bulkAirdropByType(
        ...
        for (uint256 i = 0; i < tos_.length; i++) {
            require(!_isAirdroppeds[tos_[i]], "PI: already airdropped");
    ...
    function _requireValidTokenType(uint256 tokenType_) private pure {
        require(1 <= tokenType_ && tokenType_ <= 16, "PI: invalid token type");
    }
    ...
    function _airdropByType(address to_, uint256 tokenType_) private {
        ...
        console.log("airdrop to %s tokenID %s", to_, tokenID);

        _mint(to_, tokenID, tokenType_);

        _tokenIDCounter.increment();

        emit airdropByTypeEvent(to_, tokenID, tokenType_);
    }
