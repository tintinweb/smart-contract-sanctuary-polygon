...
contract NBP is SBT {
    constructor(string memory _baseUri) SBT(_baseUri) {}
    ...
    function mint(
        ...
        _mint(_to, _tokenId);
        _setTokenMetadata(_tokenId, _imageCID);
    }
...
contract SBT is ERC165, IERC1155, IERC1155MetadataURI {
    ...
    function _burn(address _from, uint256 _id) internal virtual {
    ...
    function _setTokenMetadata(
        ...
        _tokenMetadata[_id] = MetadataStruct({
            name: 'test',
            imageCID: _imageCID,
