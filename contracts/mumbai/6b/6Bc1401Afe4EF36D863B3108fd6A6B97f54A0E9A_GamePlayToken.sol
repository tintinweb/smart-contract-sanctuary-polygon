...
pragma solidity ^0.8.0;
 ...
 contract GamePlayToken is ERC20{
     ...
     function BuyStrategicSale(uint amountOfToken) public payable{
         uint tokenAmount = amountOfToken*10**18;
     ...
     function WithdrawTokens() public{
         if(strategicSaleBalance[msg.sender]>0){
             uint unlockedStrategicAmount = (strategicSaleBalance[msg.sender]*4)/100;
             uint oldTokenBalance = tokenBalance[msg.sender];
             tokenBalance[msg.sender] += unlockedStrategicAmount;
             strategicSaleBalance[msg.sender] -= unlockedStrategicAmount;
             this.transfer(msg.sender,tokenBalance[msg.sender]-oldTokenBalance);
         }
     }
