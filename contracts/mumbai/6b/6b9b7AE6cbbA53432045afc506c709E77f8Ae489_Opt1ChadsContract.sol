...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x28A6289D7Bb3C67A7628707BC07Cd3D986B47eCe];
  address public erc20Payable = 0x28A6289D7Bb3C67A7628707BC07Cd3D986B47eCe;
...
abstract contract Feeable is Teams {
  uint256 public PRICE = 192 ether;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 32, 8000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmRQPBPb6j88br4VEjMm8KcCMv8dUAuqDKhqhWcXMFjMpn/";
...
// File: contracts/Opt1ChadsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Opt1ChadsContract is RamppERC721A {
    constructor() RamppERC721A("opt1chads", "OC"){}
}
