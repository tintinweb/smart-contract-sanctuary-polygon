...
contract MothersOfEarth is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://QmX1RJQxRrwfd79uHsDTMW2FNAGBuupttCDmHRmaLHm8sg/";
  string public uriSuffix = ".json";
  string public hiddenMetadataUri;
  
  uint256 public cost = 108 ether;
  ...
  constructor() ERC721("Mothers Of Earth", "MOE") {
    setHiddenMetadataUri("ipfs://QmX1RJQxRrwfd79uHsDTMW2FNAGBuupttCDmHRmaLHm8sg/hidden.json");
  }
