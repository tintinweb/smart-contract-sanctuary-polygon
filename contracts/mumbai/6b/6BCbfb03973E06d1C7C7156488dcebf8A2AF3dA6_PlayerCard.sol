...
contract ERC721Psi is Initializable, Context, ERC165, IERC721, IERC721Metadata {
    ...
    // State Variables
    ///////////////////
    uint256 private constant _BITMASK_ADDRESS = (1 << 160) - 1;     // The mask of the lower 160 bits for addresses.
    bytes32 private constant _TRANSFER_EVENT_SIGNATURE = 0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef; // The `Transfer` event signature is given by: `keccak256(bytes("Transfer(address,address,uint256)"))`.
    ...
    /*** @dev Mapping of tokenID owners */
    mapping(uint256 => address) internal _owners;
    /*** @dev Mapping of tokenApprovals */
    mapping(uint256 => address) private _tokenApprovals;
    /*** @dev Mapping of operatorApprovals */
...
contract PlayerCard is ERC721Psi, Manageable {
    ...
    function initialize(
        ...
        _initialize(name_, symbol_, uri_);
    }

    function safeMint(address to, uint256 amount) external onlyManager {
        _safeMint(to, amount);
    }
}
