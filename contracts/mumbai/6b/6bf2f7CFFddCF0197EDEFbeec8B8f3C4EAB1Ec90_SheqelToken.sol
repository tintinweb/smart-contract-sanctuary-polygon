...
contract Reserve {
    ...
    function sellPrice() public view returns (uint256) {
        ...
        // WORKS return ((totalShq * buyPriceWithTax())) / (shqInReserve - 1); // Price in USDC (6 decimals)
        ...
        return ((totalShq * buyPriceWithTax()) - usdcInReserve) / (shqInReserve - 1); // Price in USDC (6 decimals)
    }
