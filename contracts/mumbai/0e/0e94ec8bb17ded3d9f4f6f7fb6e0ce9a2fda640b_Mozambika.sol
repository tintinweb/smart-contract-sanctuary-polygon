    ...
    ERC1155BurnableUpgradeable
{
    ...
    uint private constant COLLECTION_SIZE = 10000;

    // Mapping of token ID to supply
    mapping(uint256 => uint256) public tokenSupply;
    mapping(uint256 => bool) public frozenTokens;

    uint public constant MAX_MINT_PER_TRANSACTION = 10;

    uint public constant MAX_MINT_PER_PLAYER = 100;

    uint private PLAYER_MINT_FEE = 0.00001 ether;
    ...
    function _mintToken(
        ...
        require(
            _mintedAmount[player] + amount <= MAX_MINT_PER_PLAYER,
            "Mozambika: Cannot mint more than allowed limit per player"
        );
    ...
    function _mintBatchToken(
        ...
        require(
            _mintedAmount[player] + totalAmount <= MAX_MINT_PER_PLAYER,
            "Mozambika: Cannot mint more than allowed limit per player"
        );
        require(
            totalAmount <= MAX_MINT_PER_TRANSACTION,
            "Mozambika: Cannot mint more thab allowed limit per trasaction"
        );
    ...
    function playerMint(
        ...
        require(msg.value >= totalPrice, "Mozambika: Insufficient mint fee");
    ...
    function batchPlayerMint(
        ...
        require(msg.value >= totalAmount, "Mozambika: Insufficient mint fee");
