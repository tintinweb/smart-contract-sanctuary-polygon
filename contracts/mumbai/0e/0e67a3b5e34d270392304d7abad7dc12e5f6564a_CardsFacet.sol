...
contract CardsFacet is Modifiers {
    ...
    function createCard(CreateCardArgsStruct calldata _args) external onlyTrustedForwarder {
        ...
        s.tokenMetadata[tokenId] = MetadataStruct({
            ...
            role: _args.role,
            category: LibStrings.lower(_args.category),
...
library LibCategories {
    ...
    function validateCategory(string memory _category) internal view returns (bool) {
        require(bytes(_category).length != 0, "LibCategories: Category must be at least 0 characters");
    ...
    function updateCategory(uint256 _index, string calldata _category) internal {
        ...
        require(s.categories.length > _index, "LibCategories: Index out of bounds");
    ...
    function deleteCategory(uint256 _index) internal {
        ...
        require(count >= 2, "LibCategories: Cannot delete all categories");
