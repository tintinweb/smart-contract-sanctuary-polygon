...
contract TimeLockPool is BasePool, ITimeLockPool {
    ...
    function deposit(uint256 _amount, uint256 _duration, address _receiver) external override {
        ...
        IUtilityManager(utilityManager).updateStakedAmount(1, _amount);
        IUtilityManager(utilityManager).updateTotalValueLockedAmount(1, _amount, 1);
    ...
    function withdraw(uint256 _depositId, address _receiver) external {
        ...
        IUtilityManager(utilityManager).updateTotalValueLockedAmount(1, userDeposit.amount, 0);
...
contract FossilMaticLPPool is TimeLockPool {
    constructor(
        string memory _name,
        string memory _symbol,
        address _depositToken,
