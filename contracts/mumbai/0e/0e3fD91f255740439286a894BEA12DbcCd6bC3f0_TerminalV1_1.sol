...
contract TerminalV1_1 is Operatable, ITerminalV1_1, ITerminal, ReentrancyGuard, Ownable {
  ...
  */
  ...
  function pay(
    ...
    return _pay(_projectId, 10**18, _beneficiary, _memo, _preferUnstakedTickets);
  }
  ...
  function setProjectPayWhiteLists(uint256 _projectId,address _whiteListAddress,bool _state) external {
    
    require(projects.ownerOf(_projectId) == msg.sender ,'TV1_1::setFee: NotProjectOwner');
    //set 
