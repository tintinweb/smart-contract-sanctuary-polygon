...
contract PartyHorses is ERC721A, Ownable {
    ...
    uint256 public constant TREASURY_SUPPLY = 1;
    uint256 public constant MARKETING_SUPPLY = 1;

    uint256 public constant MAX_PUBLIC_SUPPLY =
        MAX_SUPPLY - TEAM_SUPPLY - TREASURY_SUPPLY - MARKETING_SUPPLY;

    uint256 public constant PRIVATE_MINT_PRICE = 0.00148 ether;
    uint256 public constant PUBLIC_MINT_PRICE = 0.002 ether;

    constructor() ERC721A("Party Horses", "PARTYHORSE") {}
    ...
    function mint(uint256 count) external payable {
        require(publicSaleActive, "Private sale not currently active");
