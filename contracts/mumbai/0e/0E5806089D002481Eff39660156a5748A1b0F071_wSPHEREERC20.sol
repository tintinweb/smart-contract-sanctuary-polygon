...
contract wSPHEREERC20 is ERC20 {
    ...
    function wrap( uint _amount ) external returns ( uint ) {
        ...
        uint value = SPHEREtoDYSON( _amount );
    ...
    function unwrap( uint _amount ) external returns ( uint ) {
        ...
        uint value = DYSONToSPHERE( _amount );
    ...
    /**
        ...
        @return uint
     */
    function DYSONToSPHERE( uint _amount ) public view returns ( uint ) {
        return _amount.mul( ISphereToken(SPHERE).currentIndex() ).div( 10 ** decimals() );
    }
    ...
    /**
        ...
        @return uint
     */
    function SPHEREtoDYSON( uint _amount ) public view returns ( uint ) {
        return _amount.mul( 10 ** decimals() ).div( ISphereToken(SPHERE).currentIndex() );
    }
