...
// File: LilRockstar.sol

pragma solidity >=0.8.0 <0.9.0;


contract LilRockstar is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  constructor() ERC721A("LilRockstar Token", "ROCC") {
    setUriPrefix("");
    setHiddenMetadataUri("https://ipfs.io/ipfs/QmQp44Ewcci28YUYtNLeyynZPWvRBoqLhjQCYoQiSFdjaV/hidden.json");
  }
