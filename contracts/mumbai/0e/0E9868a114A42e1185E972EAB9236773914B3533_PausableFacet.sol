...
import {PausableStorage} from "../base/PausableStorage.sol";
import {IPausableInternal} from "../interfaces/IPausableInternal.sol";
...
import {PausableStorage} from "./base/PausableStorage.sol";
import {PausableInternal} from "./internal/PausableInternal.sol";
import {AccessControlInternal} from "@solidstate/contracts/access/access_control/AccessControl.sol";

/**
 * @title Pausable security control module.
 */
contract PausableFacet is PausableInternal, AccessControlInternal, IPausable {
    using PausableStorage for PausableStorage.Layout;

    function pause() public onlyRole(PausableStorage.SUPER_MANAGER_LEVEL) {
        _pause();
    }

    function unpause() public onlyRole(PausableStorage.SUPER_MANAGER_LEVEL) {
        _unpause();
    }
