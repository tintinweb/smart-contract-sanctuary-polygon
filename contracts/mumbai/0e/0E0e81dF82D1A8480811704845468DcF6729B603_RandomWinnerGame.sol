...
// SPDX-License-Identifier: MIT
//Contract 0x0E0e81dF82D1A8480811704845468DcF6729B603
pragma solidity ^0.8.4;
import "@openzeppelin/contracts/access/Ownable.sol";
import "@chainlink/contracts/src/v0.8/VRFConsumerBase.sol";

//Contract for RandomWinnerGame
//Build a lottery game today, each game will have a max number of players and an entry fee
...
contract RandomWinnerGame is VRFConsumerBase, Ownable {
    ...
    //Max the number of players in the game
    ...
    //Constructor inherits a VRFconsumerBase
    ...
    //function join game is called when a player wants to join the game

    function joinGame() public payable {
        require(gameStarted, "Game is not currently running");
        require(msg.value == entryFee, "Value is not equal to entry fee");
