...
contract TUWCollection is AbstractERC1155Factory  {

    uint256 public tokensInCirculation;

    constructor( ) ERC1155("")  {
        name_ = "TUW World Collection";
        symbol_ = "UTWW";
    ...
    {
        _mint(_to, tokensInCirculation, total_supply, "");
        tokensInCirculation++;
    }
...
abstract contract AbstractERC1155Factory is Pausable, ERC1155Supply, ERC1155Burnable,ContextMixin, IERC2981, Ownable {
