...
contract ZoidbergNFTs is ERC721Base, Permissions {
    ...
    // this function is only callable by the admin role members
    ...
    function mintTo(address _to, string memory _tokenURI) public virtual override {
       ...
       // actuall the mint the NFT (using the underlying logic)
