...
contract LV3 is ERC721, Ownable, MerkleProof{
    using SafeMath for uint256;
    ...
    bytes32 public merkleRoot = 0x4d4d4ba00893bcc51eba64e152ce5b450c511ac6f7bcb354756272ae8dc81ffe;
    ...
    function mintMotorFor(uint256 numberOfTokens,bytes32[] calldata _merkleProof) public payable {
        require(isSaleActive, "Sale is not active");
        require(numberOfTokens <= maxPerTx, "No more than 20 tokens per transaction");
        require(totalSupply().add(numberOfTokens) <= maxMotor, "Purchase would exceed max supply of Motor");
