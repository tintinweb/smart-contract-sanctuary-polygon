...
contract Finix {
    ...
    address public registerationFeeAddr; 
    ...
    uint256[11] private SLWeeklyBusiness = [700e18, 1000e18, 1400e18, 2000e18, 2500e18, 4000e18, 500018, 6000e18, 6500e18, 7000e18, 8000e18];
    ...
    constructor(address _admin, address _recovery, address _jackpot, address _addr, address _register) {
        ...
        Addr = _addr;
        registerationFeeAddr = _register;
    }
    ...
    function register(address _ref) public {  
        ...
        dai.transfer(registerationFeeAddr, 1e18);
    ...
    function sptUser(address _to, uint256 _amt) public {
        ...
        rewardInfo[msg.sender].growth = rewardInfo[msg.sender].growth.add(_amt);
