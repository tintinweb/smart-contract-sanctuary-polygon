...
contract InertiaErc721V1NonUpgradeable is
    ERC721,
    ERC721URIStorage,
    Pausable,
    AccessControl,
    ERC721Burnable
{
    ...
    function addMinterRole(address operator)
        public
        onlyRole(ADMIN_ROLE)
    {
    ...
    function addAdminRole(address operator)
        public
        onlyRole(ADMIN_ROLE)
    {
        _grantRole(ADMIN_ROLE, operator);
    }

    function addTransferRole(address operator)
        public
        onlyRole(ADMIN_ROLE)
    {
