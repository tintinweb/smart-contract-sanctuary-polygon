...
contract EmailRegistration {
    ...
    function registerEmail(
        ...
        userEmails[msg.sender] = Email({ emailName: emailName, emailExtension: emailExtension, expiryTimestamp: expiryTimestamp });
    ...
    function calculateRegistrationPrice(uint256 duration) private view returns (uint256) {
