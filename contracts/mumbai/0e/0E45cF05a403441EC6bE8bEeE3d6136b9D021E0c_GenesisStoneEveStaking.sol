...
contract GenesisStoneEveStaking is AccessControl {
    ...
    // Constants
    uint8 constant MINT_TYPE_NORMAL = 0;
    uint8 constant MINT_TYPE_MYTHIC = 1;
    uint8 constant MINT_TYPE_FIVE = 2;
    uint8 constant MINT_TYPE_TEN = 3;
    uint16 constant MAX_GENESISSTONE_NFTS = 1000;
