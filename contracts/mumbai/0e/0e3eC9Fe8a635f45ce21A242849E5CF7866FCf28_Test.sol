...
contract Test is ERC20, Ownable {
    ...
    event SwapThresholdsChanged(
        uint _lpSwapThreshold,
        uint _marketingSwapThreshold
    );
    ...
    function _transfer(
        ...
        if (
            (isLiquidityPair[from] || isLiquidityPair[to]) && !inSwapAndLiquify
        ) {
