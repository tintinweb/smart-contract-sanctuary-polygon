...
contract MyToken is ERC20, Ownable {
    uint256 public mintLimitPerAccount;
    ...
    constructor(
        uint256 _mintLimitPerAccount,
        uint256 _mintAmount,
        uint256 _mintCost
    ) ERC20("My Token", "MTK") {
        mintLimitPerAccount = _mintLimitPerAccount;
    ...
    function mintToken() public payable {
        ...
        require(block.timestamp > lastMint[msg.sender] + mintLimitPerAccount, "Already minted today");
