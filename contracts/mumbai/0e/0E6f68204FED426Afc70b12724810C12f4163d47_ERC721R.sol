...
// Refund if mint is not succesfull after certain amount of time , till when mint will be live. (refund function)
// first 100 user will get some reward, 50% of the mint price back
 ...
 * the Metadata and Enumerable extension. Built to optimize for lower gas during batch mints as well as adding refund and raffle contract
 *
...
contract ERC721R is   Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable, Ownable{
    ...
    constructor(string memory name_, string memory symbol_, uint _collectionSize,uint _mintStartTime, uint _mintEndTime, uint _mintPrice) {
