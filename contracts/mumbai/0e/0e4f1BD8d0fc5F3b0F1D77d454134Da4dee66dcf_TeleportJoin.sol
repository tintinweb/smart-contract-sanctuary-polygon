...
contract TeleportJoin {
    ...
    constructor(bytes32 ilk_, bytes32 domain_) {
        wards[msg.sender] = 1;
    ...
    function setDebt(bytes32 domain_, int256 debt_) external {
        debt[domain_] = debt_;
    }

    function setLine(bytes32 domain_, uint256 line_) external {
        line[domain_] = line_;
    }
