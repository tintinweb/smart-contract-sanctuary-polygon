...
contract AcapzVestingWallet is Initializable,  UUPSUpgradeable, VestingWalletUpgradeable {

    function initialize(address tokenVault) external  initializer {
        __VestingWallet_init(tokenVault, 1650063692+600, 600);
