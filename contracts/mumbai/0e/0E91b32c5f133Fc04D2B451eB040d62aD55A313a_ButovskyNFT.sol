...
contract ButovskyNFT is ERC721, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    event Minted(address to, uint256 tokenId, string cid);
        ...
        onlyOnce
    {
        ...
        string memory cid = "QmPfkEZxDQLSJE2TEgFuxzm6Q7fFKsGSMmVkLKcyZgubhx/1.json"; // currently there is only one json of test folder with this CID

        _safeMint(msg.sender, tokenId);
        _setTokenURI(tokenId, cid);

        emit Minted(msg.sender, tokenId, cid);
    }
