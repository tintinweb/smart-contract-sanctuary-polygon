...
interface KeeperCompatibleInterface {
    function checkUpkeep(bytes calldata checkUpkeep) external returns (bool upkeepNeeded, bytes memory performData);
    function performUpkeep(bytes calldata performUpkeep) external;
}
/**
...
contract VRFv2Consumer is VRFConsumerBaseV2, KeeperCompatibleInterface {
