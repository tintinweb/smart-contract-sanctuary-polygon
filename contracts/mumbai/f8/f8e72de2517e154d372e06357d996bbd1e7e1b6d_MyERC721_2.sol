...
contract MyERC721_2 is ERC721 {
    ...
    constructor() payable ERC721('2myNFT', '2MyNFT') {
        maxSupply = 10000;
    }
    ...
    function approve_with_sig(address spender, uint256 tokenId, bytes memory signature, address signer, uint timestamp) external {
        string memory message = string(abi.encodePacked('approve_nft\nSignerAddress:', Strings.toHexString(signer), '\nSpenderAddress:', Strings.toHexString(spender), '\nNftAddress:', Strings.toHexString(address(this)), '\nId:', Strings.toString(tokenId), '\nTimestamp:', Strings.toString(timestamp)));
        ...
        require(
            ...
            "ERC721: approve_with_sig signer is not token owner or approved for all"
        );
