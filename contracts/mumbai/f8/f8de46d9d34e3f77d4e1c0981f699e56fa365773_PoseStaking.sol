...
contract PoseStaking is IPoseStaking, Ownable, ERC165 {
    ...
    IPoseRegistry public poseRegistry;
    IPoseDelegationRegistry public delegationRegistry;
    ...
    function setRegistry(address registryAddress) external onlyOwner {
        poseRegistry = IPoseRegistry(registryAddress);
    }

    function setDelegation(address delegationAddress) external onlyOwner {
        delegationRegistry = IPoseDelegationRegistry(delegationAddress);
    }
