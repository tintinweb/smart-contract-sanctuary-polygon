...
contract BTCLHourlyLottery is AutomationCompatible, AutomatedRandomness, ReentrancyGuard {
    ...
    uint256 private ticketPrice = 0.005 ether;  // 0.005 MATIC x 1 ticket price
    uint256 private ticketFee   = 0.0005 ether; // 0.0005 MATIC ticket fee
    uint256 private minPlayers  = 10;           // min 10 tickets per round
    uint256 private maxPlayers  = 100;          // max 100 ticket per round
    uint256 private minutesUntilDraw  = 10;     // 10 in minutes
