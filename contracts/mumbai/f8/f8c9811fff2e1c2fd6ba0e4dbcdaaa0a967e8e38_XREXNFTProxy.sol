...
// File: contracts/ERC721Upgradable.sol
...
abstract contract ERC721UpgradableAbstract is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable,
AccessControlEnumerableUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    function initialize(string memory name, string memory symbol, address minter) initializer public {
    ...
    function safeMint(address to, uint256 tokenId, string memory uri) public nonReentrant onlyRole(MINTER_ROLE) {
        _safeMint(to, tokenId);
    ...
    function supportsInterface(bytes4 interfaceId) public view override(ERC721Upgradeable, ERC721EnumerableUpgradeable, AccessControlEnumerableUpgradeable) returns (bool) {
        return super.supportsInterface(interfaceId);
    }

    function setTokenURI(uint256 tokenId, string memory uri) public virtual onlyRole(MINTER_ROLE) {
        _setTokenURI(tokenId, uri);
    }
    /**
     * @dev This empty reserved space is put in place to allow future versions to add new
...
abstract contract ERC721ProxyAbstract is TransparentUpgradeableProxy {
    constructor(
        address logic,
        address proxyAdmin,
        string memory name,
        ...
        abi.encodeWithSelector(
            ERC721UpgradableAbstract.initialize.selector,
            name,
            symbol,
            minter
        )
...
// File: contracts/XREXNFT.sol


pragma solidity ^0.8.15;


contract XREXNFT is ERC721UpgradableAbstract {
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() initializer {}
}

contract XREXNFTProxy is ERC721ProxyAbstract {
    constructor(
        address logic,
        address proxyAdmin,
        string memory name,
        string memory symbol,
        address minter
    ) ERC721ProxyAbstract(logic, proxyAdmin, name, symbol, minter) {
    }
}