    ...
    
{
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/Wm1skHgOAms7u4DCmOyw/contract-metadata";
  }
...
// File: contracts/VanguardTradesSignalsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract VanguardTradesSignalsContract is ERC721APlus {
    constructor() ERC721APlus("Vanguard Trades Signals", "VTS"){}
}
