...
contract Ticketing is ERC721, Ownable{
    ...
    event TicketPurchased(uint indexed eventId, address indexed buyerAddress, uint indexed ticketsCount);
    ...
    function buyTickets( uint _eventId, uint _ticketCount) public {
        ...
        emit TicketPurchased( _eventId, address(msg.sender), _ticketCount);
