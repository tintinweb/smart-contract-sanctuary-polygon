...
contract NFTPersonalNameSignatureCollection is ERC721Base, PrimarySale, SignatureNameMintERC721 {
    /*//////////////////////////////////////////////////////////////
                            Constructor
    //////////////////////////////////////////////////////////////*/
     ...
     */
    function mintWithSignature(MintNameRequest calldata _req, bytes calldata _signature)
        external
        payable
        virtual
        override
...
abstract contract SignatureNameMintERC721 is EIP712, ISignatureMintERC721 {
    using ECDSA for bytes32;

    bytes32 private constant TYPEHASH =
        keccak256(
            "MintNameRequest(address to,address royaltyRecipient,uint256 royaltyBps,address primarySaleRecipient,string uri,uint256 quantity,uint256 pricePerToken,address currency,uint128 validityStartTimestamp,uint128 validityEndTimestamp,bytes32 uid, string name)"
        );
 ...
 * 
 *  This signature has an additional field called name which will be used for reserving a name for the NFT.
 *
...
interface ISignatureMintERC721 {
     ...
     *  @param name A unique name that will be registered
     */
