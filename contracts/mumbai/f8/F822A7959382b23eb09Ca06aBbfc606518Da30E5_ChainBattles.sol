...
//TODO: implement pseudo random number generation for status
//TODO: update train function to update stats as level increases
//check out Keccak256, block timestamp, block difficulty
...
contract ChainBattles is ERC721URIStorage {
    ...
    function random() internal returns (uint256) {
        //return uint256(keccak256(block.timestamp, msg.sender, nonce++)) % 10;
        return
            uint256(
                keccak256(
