...
contract lbtestv2d is VRFV2WrapperConsumerBase,ConfirmedOwner,ReentrancyGuard {
   ...
   // Mumbai 0xeeB482F3981D004C6199cA21F331Dc33EE639f0a // Mainnet 0x527a819db1eb0e34426297b03bae11F2f8B3A19E
        ...
        VRFV2WrapperConsumerBase(linkAddress, wrapperAddress) 
    {
        ...
        lottoWeekly = IluckblocksWeekly(0x3bE89503Af61832902f5D612bdC2EBB21293ec9c);
        weeklyContract = 0x3bE89503Af61832902f5D612bdC2EBB21293ec9c;

        lbNodes = IluckblocksNodes(0x5dC238A1D62717BB1079E60fCCF747d13409563b);
    ...
    function autoSpin(address _caller, uint256[] calldata _nodes) public nonReentrant {
        ...
        require(block.timestamp > lastAutoSpin + 864,"draw timestamp still not reached.");
         ...
         if(getJackpotinUSD() >= minimumPot && registeredsAccts.length >= 25){ 
            ...
            if(block.timestamp > lastAutoSpin + 867 && reset == false){    // if no node activates in 5 minutes period queue resets
