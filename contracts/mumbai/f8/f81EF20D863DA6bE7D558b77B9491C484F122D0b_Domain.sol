...
contract Domain is ERC721URIStorage{
   ...
   string svgPartTwo = '</text></svg>';
    ...
    constructor (string memory _tld)payable ERC721("Fuck Name service", "NNS")  {
        tld = _tld;
        console.log("welcome to my domain name service");
    }
    ...
    function register(string calldata name) external payable{
        ...
        require(domains[name] == address(0),"address should not be zero");
