...
// File: contracts/BurnManagerAccessControl.sol

pragma solidity ^0.8.0;


abstract contract BurnManagerAccessControl is AccessControl {
    ...
    modifier whenNotPaused {
        require(!isPaused, "BurnManager is paused");
        _;
    }
...
contract PolygonBurnManager is BurnManagerAccessControl, FxBaseChildTunnel {
    ...
    address public latesttokenOwner;
    uint256[] public latestburnttokens;
    ...
    ) external view onlyRole(HANDLER_ROLE) {
    ...
    function addBurnData(address _user, uint256[] memory _tokenIds) internal {
        ...
        latesttokenOwner = _user;
        latestburnttokens = _tokenIds;
    }
    ...
    function _processMessageFromRoot(
        ...
        (address tokenOwner, uint256[] memory tokenIds) = abi.decode(
            data,
            (address, uint256[])
        );
