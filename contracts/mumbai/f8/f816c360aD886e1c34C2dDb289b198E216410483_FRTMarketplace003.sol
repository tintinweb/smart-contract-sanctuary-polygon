...
contract FRTMarketplace003 is AccessControl{
    ...
    /******TO BE REMOVED CODE******/
    function getNftsByAddress(address _NFTOwner) external view returns( uint256[] memory _nfts){
        return NFTOwners[_NFTOwner];
        // if(NFTOwners[_NFTOwner].length == 0){
        //     return _nfts;
        // }
        // for(uint _i; _i < NFTOwners[_NFTOwner].length; i++ ){
        //     NFTOwners[_NFTOwner].length
        // }
    }
}
