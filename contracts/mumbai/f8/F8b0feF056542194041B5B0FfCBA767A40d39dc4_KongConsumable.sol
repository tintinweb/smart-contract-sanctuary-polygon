...
contract KongConsumable is ERC1155("some uri"), Ownable {
	...
	modifier authorised() {
		require(authorisedCallers[msg.sender] || msg.sender == owner(), "KongConsumable: Not authorised caller");
		_;
	}
	...
	function safeTransferFrom(
        ...
        override
    {
		require(!locked[id], "KongConsumable: voucher ID is locked");
        ...
        override
    {
		for (uint256 i = 0; i < ids.length; i++)
			require(!locked[ids[i]], "KongConsumable: voucher ID is locked");
