...
contract GIBTokenEthereum is ERC20, Ownable {
    uint256 public transactionFeeRate = 1; // 1% transaction fee on buy and sell
    address public collectionWallet = 0x0B7780f1a0108a556c0ac27F265496aC2a4ad95B;
    ...
    constructor() ERC20("GIB Token Ethereum", "$GIB") {
        ...
        _isWhiteListedFromFee[collectionWallet] = true;
    }
    ...
    function _transfer(
        ...
        if (recipient == uniswapV2Pair || sender == uniswapV2Pair) {
            ...
            super._transfer(sender, collectionWallet, fee);
        }
        }
        }
    ...
    function setTax(uint256 amount) public onlyOwner {
        transactionFeeRate = amount;
    }

    function setTaxCollectionWallet(address _wallet) public onlyOwner {
