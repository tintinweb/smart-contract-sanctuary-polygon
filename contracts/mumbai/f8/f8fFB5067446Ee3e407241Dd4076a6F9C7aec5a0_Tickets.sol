...
contract Tickets is ERC721LazyMint {
    ERC1155Base public immutable receipt;
    ...
    constructor(
        ...
        receipt = ERC1155Base(_receiptAddress);
    }
    ...
    {
        require(
            receipt.balanceOf(_claimer, 0) >= _quantity,
            "You don't own enough Receipt NFTs"
        );
    }
    ...
    function transferTokensOnClaim(address _receiver, uint256 _quantity)
        ...
        returns (uint256)
    {
        receipt.burn(_receiver, 0, _quantity);
