...
contract HTokenHelper is HTokenHelperI, Ownable {
  ...
  function getUnderlyingPriceInUSD(HTokenI _hToken) public view override returns (uint256) {
    return (internalUnderlyingPriceInUSD(_hToken) * DENOMINATOR) / _hToken.decimals();
  }
  ...
  function internalUnderlyingPriceInUSD(HTokenI _hToken) public view returns (uint256) {
