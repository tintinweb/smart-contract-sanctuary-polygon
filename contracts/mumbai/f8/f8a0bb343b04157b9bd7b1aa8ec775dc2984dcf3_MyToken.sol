...
contract MyToken is ERC1155, Ownable, ERC1155URIStorage {
    constructor() ERC1155("https://ipfs.io/ipfs/") {}

    uint  public cryptokitties = 0;
    uint  public cryptopunks = 1;

    function setURI(uint256 _id, string memory _uri) public  {
        _setURI(_id,_uri);
    }

    function mintBatch(uint256[] memory ids,string[] memory uris)
        public
    {
        for(uint256 i = 0;i<ids.length;i++){
