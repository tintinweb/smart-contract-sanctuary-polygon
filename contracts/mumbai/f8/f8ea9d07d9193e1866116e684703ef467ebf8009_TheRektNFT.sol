...
contract TheRektNFT is ERC721Enumerable {
    using Strings for uint256;

    string public baseURI;
    string public baseExtension = ".json";
    uint256 public cost = 0.076 ether;
    uint256 public presaleCost = 0.076 ether;
    uint256 public maxSupply = 10000;
    
    uint256 public maxMintAmount = 76;
    ...
    function mint(address _to, uint256 tokenId, uint256 price,uint256 _mintAmount) public payable{
    ...
    function priceOf(uint256 tokenId) public view returns (uint256) {
        require(_exists(tokenId), "ERC721Enumerable: nonexistent token");
    ...
    function setPresaleCost(uint256 _newCost) public {
    ...
    function addPresaleUser(address _user) public {
        presaleWallets[_user] = true;
    }

    function add100PresaleUsers(address[100] memory _users) public {
        for (uint256 i = 0; i < 2; i++) {
            presaleWallets[_users[i]] = true;
        }
    }

    function removePresaleUser(address _user) public {
