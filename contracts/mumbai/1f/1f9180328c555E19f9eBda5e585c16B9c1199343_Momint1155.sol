    ...
    ITokenERC1155
{
    ...
    bytes32 private constant MODULE_TYPE = bytes32("MomintERC1155");
    ...
    /// @dev Market Address => whether it is approved or not
    ...
    ///     =====   Approval overrides  =====
    function setApprovalForAll(address operator, bool approved) public virtual override(ERC1155Upgradeable, IERC1155Upgradeable) {
        require(_approvedMarketplaces[operator], "Invalid Marketplace");
        super.setApprovalForAll(operator, approved);
    }

    function setApprovedMarketplace(address market, bool approved) public onlyRole(DEFAULT_ADMIN_ROLE) {
