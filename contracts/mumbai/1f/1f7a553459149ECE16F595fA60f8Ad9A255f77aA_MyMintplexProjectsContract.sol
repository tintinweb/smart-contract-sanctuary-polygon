...
abstract contract TimedDrop is Teams {
  ...
  */
  ...
  uint256 public allowlistDropTime = 1672527660;
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x92D271D75F40ddED70F7258adC6cc85374f9BBb2];
  address public erc20Payable = 0x92D271D75F40ddED70F7258adC6cc85374f9BBb2;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "http://test.com/meta/";
...
// File: contracts/MyMintplexProjectsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MyMintplexProjectsContract is RamppERC721A {
    constructor() RamppERC721A("My Mintplex Projects", "MINTPLEXX"){}
}
