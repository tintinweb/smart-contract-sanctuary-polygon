...
contract CollectionFactory is ICollectionFactory {
    ...
    function createCollection(string memory name, string memory image, string memory symbol) public onlyCollectionCreator override returns (address) {
...
contract Collection is ERC721, ERC721URIStorage {
    ...
    constructor(string memory collectionName, string memory collectionImage, string memory symbol, address _owner) ERC721(collectionName, symbol) {
