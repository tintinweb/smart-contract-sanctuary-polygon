...
// File: contract-66176cc6bf_flattened_flattened.sol
...
contract Trace is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() {
        _disableInitializers();
    }
    ...
    function abc() public view returns (uint8) {
        return 88;
    }
