...
contract EthermonStaking is EthermonStakingBasic {
    ...
    uint16[] public daysAdvantage = [75, 80, 85, 90, 95, 100];
    ...
    function depositeTokens(
        ...
        if (activeStakers <= 1) {
            ...
            // EmonPerPeriod = (totalStaked * EmonPeriodMultiplier) / (365 * 24);
    ...
    function updateTokens(
        ...
        uint256 emonPerPeriod = stakingData.miscData(2); //stakingData.EmonPerPeriod();
        ...
        if (currentTime >= data.endTime) {
            ...
            // totalStaked = totalStaked - _emons;
            newSumTeamPower -= data.teamPower;
            totalStaked -= data.emons;
