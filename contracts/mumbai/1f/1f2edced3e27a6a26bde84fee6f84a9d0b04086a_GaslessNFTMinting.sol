...
// File contracts/solidity.sol


pragma solidity ^0.8.0;
contract GaslessNFTMinting is ERC721, Ownable {
    ...
    function mint(address to, uint256 tokenId, bytes calldata signature) external {
        bytes32 messageHash = keccak256(abi.encodePacked(msg.sender, to, tokenId, _nonces[msg.sender]));
        require(messageHash.recover(signature) == owner(), "GaslessNFTMinting: invalid signature");
