...
contract PalehorseNFT1155V1 is ERC1155 {
    ...
    */
    ...
    function verifySign(string memory tokenURI, Sign memory sign, address signer) internal view {
    ...
    function mint(string memory uri, uint256 supply, uint256 fee, Sign memory sign,address signer)  public {
        require(whitelist[signer], "User is not whiteListed user");
        verifySign(uri, sign,signer);
