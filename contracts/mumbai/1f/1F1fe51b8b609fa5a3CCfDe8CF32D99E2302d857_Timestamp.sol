        ...
        for (uint256 i = 0; i < data.length; i++) {
            ...
            for (uint256 j = 0; j < eosLength; j++) {
                ...
                if (
                    ...
                    item.e1.field5 == data[i].field5 &&
                    item.e1.field6 == data[i].field6 &&
                    item.e1.field7 == data[i].field7 &&
                    item.e1.field8 == data[i].field8 &&
                    item.e1.field9 == data[i].field9
                ) {
                    output[i] = true;
                }
                ...
                if (
                    ...
                    item.e2.field5 == data[i].field5 &&
                    item.e2.field6 == data[i].field6 &&
                    item.e2.field7 == data[i].field7 &&
                    item.e2.field8 == data[i].field8 &&
                    item.e2.field9 == data[i].field9
                ) {
                    output[i] = true;
                }
                if (
                    ...
                    item.e3.field5 == data[i].field5 &&
                    item.e3.field6 == data[i].field6 &&
                    item.e3.field7 == data[i].field7 &&
                    item.e3.field8 == data[i].field8 &&
                    item.e3.field9 == data[i].field9
                ) {
                    output[i] = true;
                }
                if (
                    ...
                    item.e4.field5 == data[i].field5 &&
                    item.e4.field6 == data[i].field6 &&
                    item.e4.field7 == data[i].field7 &&
                    item.e4.field8 == data[i].field8 &&
                    item.e4.field9 == data[i].field9
                ) {
                    output[i] = true;
                }
