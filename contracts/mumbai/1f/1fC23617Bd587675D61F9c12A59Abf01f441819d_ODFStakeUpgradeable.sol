...
import "../../contracts/contracts-upgradeable/ODFStakeUpgradeable.sol";

contract $ODFStakeUpgradeable is ODFStakeUpgradeable {
    bytes32 public __hh_exposed_bytecode_marker = "hardhat-exposed";
...
import "../../../contracts/contracts/interfaces/IODFStake.sol";
...
contract ODFStakeUpgradeable is Initializable, IODFStake, OwnableUpgradeable {
    ...
    function unStake(uint256 id_) external {
        ...
        stakingToken.transfer(msg.sender, rewards + amount);
        delete stakes[id_];
