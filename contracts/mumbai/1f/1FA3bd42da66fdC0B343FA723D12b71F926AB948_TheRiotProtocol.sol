...
contract TheRiotProtocol {
    ...
    function _addDevice(
        ...
        _deviceCount += 1;
        IRiotDeviceNFT(nftContract).safeMint(uint256(uint160(_deviceId)), msg.sender, _uri);
    }
     ...
     */
    function setSubscriberAddress(address _deviceId, address _subscriber) public {
