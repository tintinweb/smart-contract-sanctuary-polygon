    ...
    ReentrancyGuardUpgradeable
{
    ...
    function calculateInterest(Deposit memory deposit)
        public
        view
        returns (uint256)
    {
    ...
    function isStaking(Deposit memory deposit) public view returns (bool) {
        return (deposit.user == msg.sender &&
            deposit.amount > 0 &&
            deposit.startdate > 0);
    }
    ...
    modifier isAllowedToBurn() {
        require(
            isBurnable(msg.sender),
            "This address is not allowed to be burned."
        );
        _;
    }
