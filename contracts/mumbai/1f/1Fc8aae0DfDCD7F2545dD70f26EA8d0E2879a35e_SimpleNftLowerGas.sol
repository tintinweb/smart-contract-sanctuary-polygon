...
// File: contracts/TheInkblotPsychic-ERC721.sol



// Amended by TheInkblotPsychic
/**
    !Disclaimer!
...
contract SimpleNftLowerGas is ERC721, Ownable {
  ...
  constructor() ERC721("The Inkblot Psychic", "TIP") {
    setHiddenMetadataUri("ipfs://QmQh3TEtBcrvNyfcN3DWFe8ZisipfAZuqurDh54mqasihR/_metadata.json");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x4fEF5fbe152FCa577a9aBFD337Cdd2a2B8a15648).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
