...
contract CollectionController is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable{
    ...
    mapping (string => bool) private layerHashes;
    ...
    */
     ...
     */
    function mintNFT(uint256 collectionId, string calldata uri, uint256 fee, string memory layerHash, bytes memory signature) payable external nonReentrant {        
     ...
     */
    function isLayerMinted(string memory layerHash) public view returns(bool){
