...
contract BoredApeWhatApe is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://QmQ3f1QDbX951BANB3roCFEgyb4aniy9gk7WQ9iYhTsZQd/";
  ...
  constructor() ERC721("BoredApeWhatApe", "BAWA") {
    setHiddenMetadataUri("ipfs://QmWpioX7kMvgjDE9JAfGpaS1sBr7nyaQvRM3mKbvnYYo5K/hidden.json");
  }
