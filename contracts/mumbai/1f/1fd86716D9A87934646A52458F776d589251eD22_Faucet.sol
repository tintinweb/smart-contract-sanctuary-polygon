...
contract Faucet is Ownable {
    ...
    uint256 public amountAllowed = 4192;
    ...
    // Emit event
    event FaucetUsedBy(address sender, uint256 tokenId);

    constructor() payable {
        
    }

    function getAmountAllowed() public view returns (uint) {
    ...
    function requestTokens(address payable _requestor) public payable {
        ...
        emit FaucetUsedBy(msg.sender, amountAllowed);

        //updates locktime 1 day from now
        lockTime[msg.sender] = block.timestamp + 86400;
    }
}
