...
contract PerpetualTreasury is PerpetualBaseFunctions, IFunctionList, IPerpetualTreasury {
     ...
     */
    function addLiquidity(uint8 _poolId, int128 _fTokenAmount) external override nonReentrant {
     ...
     */
    function _validateLiquidityData(uint8 _poolId, int128 _fAmount) internal view {
