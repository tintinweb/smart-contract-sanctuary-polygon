...
contract DAO {
  ...
  constructor(){
    ...
    validTokens = [40764116145304696374999278829702489113978586803239029290129279889755290468353];
  }
  ...
  function createProposal(string memory _description,address[] memory _canVote) public {
    ...
    emit proposalCreates(nextProposal,_description,_canVote.length,msg.sender);
    nextProposal++;
  }
