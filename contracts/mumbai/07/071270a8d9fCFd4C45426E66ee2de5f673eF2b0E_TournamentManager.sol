...
contract TournamentManager is Ownable {
    ...
    function close(
        ...
        closePrecond(id, NATIVE, winners.length);
    ...
    function close(
        ...
        closePrecond(id, joinToken, winners.length);
        ...
        for (uint256 index = 0; index < winners.length; index++) {
            ...
            bool isSuccess = IERC20(tournaments[id].prizeToken).transferFrom(
                _msgSender(),
                winners[index],
                distribAmount
            );
    ...
    function closePrecond(
        ...
        require(
            tournaments[id].joinToken == joinToken,
            "Error close, joinToken doesn't match tournament joinToken"
        );
    }
