...
contract OracleManagerFixedEpoch is IOracleManagerFixedEpoch {
  ...
  function getMissedEpochPriceUpdates(
    ...
    .latestRoundData();
    uint256 _maxNumberOfMissedEpochs = _getMaximumNumberOfMissedEpochs(
      _latestExecutedEpochIndex,
      timestampReusableVariable
    );

    uint256 _numberOfMissedEpochs = Math.min(_maxNumberOfMissedEpochs, _numberOfUpdatesToTryFetch);
  ...
  {
    require(_numberOfUpdatesToTryFetch > 0, "Need to fetch some data");
