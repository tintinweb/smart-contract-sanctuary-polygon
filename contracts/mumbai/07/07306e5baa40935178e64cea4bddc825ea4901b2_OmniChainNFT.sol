...
// File: contracts/OmnichainNFT_adopted2.sol
...
contract OmniChainNFT is Ownable, ERC721, ILayerZeroReceiver {
    ...
    uint256 MAX = 100;
    uint256 gas = 350000;
    uint256 public_price = 50000000000000000; // 0.05 eth in wei
    ...
    function mint() external payable {
        require(msg.value == public_price, "ONFT: Wrong amount of ETH sent");
    ...
    function crossChain(
        ...
        require(
            msg.value >= messageFee // "Must send enough value to cover messageFee"
        );
    ...
    function setPublic_price(uint256 _public_price)
        public
        onlyOwner
    {
