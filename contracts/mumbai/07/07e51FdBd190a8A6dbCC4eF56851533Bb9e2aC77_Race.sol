...
contract Race {
    ...
    event CreateGame(address gameAddr, string title, address bundleAddr);
    ...
    function settle(
        ...
        require(playerList.length == opList.length, "");
        require(opList.length == amountList.length, "");
        GameState storage gameState = games[_gameAddr];
