 ...
 * @notice This contract handles minting ERC-155Collection tokens.
 */
contract ERC155Collection is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x6Ea3aC9c33453eAfD31FfC0680b280142b39d478;
    ...
    string public name = "ERC-155Collection";
    string public symbol = "ERC155";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeierkxedwzss7jye4fftgbupgbaowox5pdp5mpfauftxm7nkatnibq/{id}"
        )
        RevokableOperatorFilterer(
