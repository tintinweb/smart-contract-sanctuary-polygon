...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new NFTseaUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        NFTseaUser1155Token token = NFTseaUser1155Token(address(addr));
...
contract NFTseaUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
