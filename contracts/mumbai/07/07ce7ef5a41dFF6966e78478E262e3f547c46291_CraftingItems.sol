...
contract CraftingItems is ERC1155Upgradeable {
    ...
    constructor() public ERC1155Upgradeable() {
        // _mint(msg.sender, PART, 10**18, "");
        // _mint(msg.sender, FIRE_CRYSTAL, 10**18, "");
        // _mint(msg.sender, WATER_CRYSTAL, 10**18, "");
        // _mint(msg.sender, EARTH_CRYSTAL, 10**18, "");
        // _mint(msg.sender, LIGHTNING_CRYSTAL, 10**18, "");
    }

    function mintParts(address _address, uint256 amount) public {
        _mint(_address, PART, amount, '');
    }

    function burnParts(address _address, uint256 amount) public {
        _burn(_address, PART, amount);
    }

    function mintFireCrystals(address _address, uint256 amount) public {
        _mint(_address, FIRE_CRYSTAL, amount, '');
    }

    function burnFireCrystals(address _address, uint256 amount) public {
        _burn(_address, FIRE_CRYSTAL, amount);
    }

    function mintWaterCrystals(address _address, uint256 amount) public {
        _mint(_address, WATER_CRYSTAL, amount, '');
    }

    function burnWaterCrystals(address _address, uint256 amount) public {
        _burn(_address, WATER_CRYSTAL, amount);
    }

    function mintEarthCrystal(address _address, uint256 amount) public {
        _mint(_address, EARTH_CRYSTAL, amount, '');
    }

    function burnEarthCrystals(address _address, uint256 amount) public {
        _burn(_address, EARTH_CRYSTAL, amount);
    }

    function mintLightningCrystals(address _address, uint256 amount) public {
        _mint(_address, LIGHTNING_CRYSTAL, amount, '');
    }

    function burnLightningCrystals(address _address, uint256 amount) public {
