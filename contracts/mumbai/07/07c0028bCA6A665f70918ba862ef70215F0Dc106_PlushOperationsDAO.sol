...
import "./PlushGovernorVotesUpgradeable.sol";
...
contract PlushOperationsDAO is Initializable, GovernorUpgradeable, GovernorSettingsUpgradeable, GovernorCountingSimpleUpgradeable, PlushGovernorVotesUpgradeable, GovernorVotesQuorumFractionUpgradeable, GovernorTimelockControlUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
  /// @custom:oz-upgrades-unsafe-allow constructor
  constructor() initializer {}

  function initialize(IVotesUpgradeable _token, IVotesUpgradeable _tokenErc721, TimelockControllerUpgradeable _timelock) initializer public
  {
    tokenErc20 = _token;
    ...
    __GovernorVotes_init(_token, _tokenErc721);
  ...
  function getVotes(address account, uint256 blockNumber) public view override(IGovernorUpgradeable, GovernorVotesUpgradeable, PlushGovernorVotesUpgradeable) returns (uint256)
  {
 ...
 * _Available since v4.3._
 */
abstract contract PlushGovernorVotesUpgradeable is Initializable, GovernorUpgradeable {
    IVotesUpgradeable public tokenErc20;
    IVotesUpgradeable public tokenErc721;

    function __GovernorVotes_init(IVotesUpgradeable tokenAddressErc20, IVotesUpgradeable tokenAddressErc721) internal onlyInitializing {
        __GovernorVotes_init_unchained(tokenAddressErc20, tokenAddressErc721);
    }

    function __GovernorVotes_init_unchained(IVotesUpgradeable tokenAddressErc20, IVotesUpgradeable tokenAddressErc721) internal onlyInitializing {
        tokenErc20 = tokenAddressErc20;
        tokenErc721 = tokenAddressErc721;
    }
     ...
     */
    function getVotes(address account, uint256 blockNumber) public view virtual override returns (uint256) {
        return tokenErc721.getPastVotes(account, blockNumber) * tokenErc20.getPastVotes(account, blockNumber);
    }
