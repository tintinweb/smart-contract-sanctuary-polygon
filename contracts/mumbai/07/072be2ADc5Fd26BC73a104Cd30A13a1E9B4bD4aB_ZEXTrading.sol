...
// File: contracts\interfaces\ZEXPairInfosInterface.sol

pragma solidity 0.8.15;

interface ZEXPairInfosInterface{
...
// File: contracts\interfaces\ZEXReferralsInterface.sol

pragma solidity 0.8.15;

interface ZEXReferralsInterface{
...
// File: contracts\ZEXTrading.sol

pragma solidity 0.8.15;

contract ZEXTrading is Delegatable {

    // Contracts (constant)
    StorageInterface public immutable storageT;
    NftRewardsInterface public immutable nftRewards;
    ZEXPairInfosInterface public immutable pairInfos;
    ZEXReferralsInterface public immutable referrals;
    ...
    constructor(
        ...
        NftRewardsInterface _nftRewards,
        ZEXPairInfosInterface _pairInfos,
        ZEXReferralsInterface _referrals,
        uint _maxPosDai,
    ...
    function openTrade(
        ...
        NftRewardsInterface.OpenLimitOrderType orderType, // LEGACY => market
        ...
        if(orderType != NftRewardsInterface.OpenLimitOrderType.LEGACY){
    ...
    function executeNftOrder(
        ...
        if(orderType == StorageInterface.LimitOrder.OPEN){
            ...
            if(orderType == StorageInterface.LimitOrder.LIQ){
                ...
                require(orderType != StorageInterface.LimitOrder.SL || t.sl > 0,
                    "NO_SL");
                require(orderType != StorageInterface.LimitOrder.TP || t.tp > 0,
                    "NO_TP");
            }
        }

        NftRewardsInterface.TriggeredLimitId memory triggeredLimitId =
        ...
        || nftRewards.timedOut(triggeredLimitId)){
            ...
            if(orderType == StorageInterface.LimitOrder.OPEN){
                ...
                StorageInterface.OpenLimitOrder memory l = storageT.getOpenLimitOrder(
