...
contract FeePlannerV2 is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function getExpiredFee() external view returns(uint256) {
        return expiredFee;
    }
    ...
    function setExpiredFee(uint256 _expiredFee) external onlyOwner {
        expiredFee = _expiredFee;
    }
