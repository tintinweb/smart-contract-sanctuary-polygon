...
contract WeeklyRaffle is WeeklyRaffleAccessControl, INFTMintInitiator, WonderVRFGeneratorV2 {
    ...
    constructor(
        ...
        newWeeklyConfig.endTimestamp = startTimestamp + 60;
        winnerCount = 40;
    }
    ...
    function drawWeeklyRaffle(
        ...
        newWeeklyConfig.startTimestamp = config.startTimestamp + 60;
        newWeeklyConfig.endTimestamp = config.endTimestamp + 60;
