...
abstract contract Ownable is Context {
	 ...
	 */
	constructor() {
		_setOwner(0xe5D011D949C9ef5aE8279fC1982ADe0234FD342a);
	}
...
contract Imka is ERC721Enumerable, Ownable, ReentrancyGuard {
	...
	uint256 public constant TIME_FOR_GROWN = 1687950187739;
	address public founder = 0xe5D011D949C9ef5aE8279fC1982ADe0234FD342a;
	...
	string private _name = "imka";
	string private _symbol = "IMK";
	string private _baseTokenURI = "https://lab.cryptodo.app/create?type=ERC721_CONTRACT&network=POLYGON";
