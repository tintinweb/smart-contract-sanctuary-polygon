...
abstract contract ERC1155Base is ERC1155BurnableUpgradeable, ERC1155URIStorageUpgradeable, ERC1155PausableUpgradeable, ERC1155DefaultApproval {
    string public name;
...
abstract contract ERC1155URIStorageUpgradeable is Initializable, ERC1155Upgradeable {
    ...
    // NOTE: I COPYPASTED OPENZEPPELIN CODE ONLY TO MAKE THIS INTERNAL
...
contract WinAmpNft is ERC1155Lazy, AccessControlUpgradeable {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(AccessControlUpgradeable, ERC1155Lazy) returns (bool) {
        return AccessControlUpgradeable.supportsInterface(interfaceId) || ERC1155Lazy.supportsInterface(interfaceId);
    }
