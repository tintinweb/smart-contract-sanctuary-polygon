...
contract ChainBattles is ERC721URIStorage {
    ...
    function generatePseudoRandomNum() internal view returns(uint256){  
    ...
    function mint() public {
        ...
        tokenIdToCharStats[newItemId] = characterStats(
            0, 
            generatePseudoRandomNum() % 10, // speed
            generatePseudoRandomNum() % 10, // strength
            generatePseudoRandomNum() % 10  // life
        );
