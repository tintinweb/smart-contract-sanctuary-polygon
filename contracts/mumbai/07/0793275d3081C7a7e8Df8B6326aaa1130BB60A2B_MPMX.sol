...
{    
    ...
    struct InternalSale
    {
        ...
        uint _SaleProceeds;       // [2] -> _SaleProceeds
    ...
    MintPass MintPassSale = MintPass(
        ...
        676,        // [5] -> _SecondsBetweenPriceDecay
    ...
    function __OverrideMintPassParameters(
        ...
        MintPassSale._StartingBlockUnixTimestamp = StartingBlockTimestamp;
    ...
    function __OverrideMintPackParameters(
        ...
        MintPackSale._StartingBlockUnixTimestamp = StartingBlockTimestamp;
    ...
    {
        require(block.timestamp > MintPassSale._StartingBlockUnixTimestamp, "MPMX: Mint Pack Sale Has Not Started");
    ...
    {
        require(block.timestamp > MintPackSale._StartingBlockUnixTimestamp, "MPMX: Mint Pack Sale Has Not Started");
    ...
    function ViewBlockInformation() public view returns (
        ...
        if(block.timestamp > MintPassSale._StartingBlockUnixTimestamp) { _SecondsUntilSale = 0; }
        if(block.timestamp < MintPassSale._StartingBlockUnixTimestamp) { _SecondsAfterSale = 0; }
        return(
            block.timestamp, 
