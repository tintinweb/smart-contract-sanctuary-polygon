...
contract test002Proxy is OpsTaskCreator, Ownable {
    ...
    address public XD = 0x92d2d17B42cB60558C19e412756eE0Fd40DAD317;
    ...
    function swapToken(address _user, bytes32 _md5) external {
        (bool success,) = XD.delegatecall(abi.encodeWithSelector(test002K.swapToken.selector, _user, _md5));
        //require(success, "x0128");
    }
