...
contract ADFMARKET is Initializable , IERC721ReceiverUpgradeable , IERC1155ReceiverUpgradeable, ERC165Upgradeable,  OwnableUpgradeable {
        ...
        isStart(_NFTAddress , _TokenID , _startPrice)
    {
        ...
        auction memory _auction = auction({
            ...
            _endTime        : block.timestamp + 3 seconds, 
            _Started        : true,
            _Ended          : false
        });
    ...
    event buyNFTs(address _NFTAddress , uint256 _tokenId , uint256 _amount);
    ...
    {   
        ...
        emit buyNFTs(_NFTAddress , _TokenID , msg.value);
    }
