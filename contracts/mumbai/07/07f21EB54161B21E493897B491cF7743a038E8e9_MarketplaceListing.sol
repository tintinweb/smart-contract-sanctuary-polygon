...
contract MarketplaceListing is Ownable {
    ...
    function _generateRandom(string memory key) 
    ...
    function createListing(
        ...
        uint256 index = _generateRandom(string(abi.encodePacked(nftAddress, '/',tokenId)));

        if (
            keccak256(abi.encodePacked(_listings[index].listingId)) ==
