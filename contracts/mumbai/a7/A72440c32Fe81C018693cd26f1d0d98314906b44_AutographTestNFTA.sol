...
import "./interfaces/IERC721ABurnableUpgradeable.sol";
import "./extensions/ERC721AQueryableUpgradeable.sol";
import "./interfaces/IERC721AQueryableUpgradeable.sol";
...

{
    ...
    */
        ...
        payable
    {
        ...
        require(hasRole(MINTER_ROLE, _msgSenderERC721A()), "AutographNFT: must have minter role to mint");
    ...
    (
        ...
        virtual
    {
        require(hasRole(MINTER_ROLE, _msgSender()), "AutographNFT: must have minter role to set token uri");
    ...
    */
        ...
        virtual
    {
        require(
            ...
            "AutographNFT: must have pauser role to pause"
        );
        ...
        virtual
    {
        require
            (hasRole(PAUSER_ROLE, _msgSenderERC721A()),
            "AutographNFT: must have pauser role to unpause"
        );
