    ...
    ErrorCodes
{
    ...
    function bootstrap() external onlyAdmin {
        ...
        for (uint256 i=0; i < listingIdTracker; i++){
            ...
            uint256[] memory listingsArray = _tokenListings[currentListing.assetContract][currentListing.tokenId];
            arrLength = listingsArray.length;
                if(arrLength == 0)
