...
// File: contracts/LFG-NFT.sol


pragma solidity ^0.8.0;


contract LFG is ERC721Enumerable {
  /**
  @dev events
 */
 ...
 */
  ...
  {
    return string(abi.encodePacked(baseURI, '/', Strings.toString(_tokenId), '.jpeg'));
  }
 ...
 */
  ...
  function mintNFT() public payable returns (uint256 _tokenId) {
    return mintNFTTo(msg.sender);
  }

  function mintNFTTo(address _to) public payable returns (uint256 _tokenId) {
