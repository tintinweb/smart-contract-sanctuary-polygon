...
// File: contracts/sermstyle.sol

pragma solidity ^0.8.14;

contract Sermstyle is ERC721A, Ownable {
    using Strings for uint256;

    uint256 public constant RESERVED_TOKENS = 1;
    uint256 public constant FOR_SALE_TOKENS = 9999 - RESERVED_TOKENS;
    address public constant RESERVED_TOKENS_ADDRESS = 0x5252C556E7ac18E47c81328d26f47098C36f4BDF;
    ...
    uint256 public tokenPrice = 173 ether;

    uint256 public maxTokensPerAddress = 9999;

    uint256 public presaleTotalLimit = FOR_SALE_TOKENS;

    mapping(address => bool) public whitelisted;

    string public tokenBaseURI = "ipfs://QmcC2FcXW6DSKHwsUcrWiLJKnRD8h41tHB43RS2pJ8YZst/";

    uint256 public soldAmount = 0;
    mapping(address => uint256) public purchased;

    constructor() ERC721A("Sermstyle", "Sermstyle") {
    ...
    function getMaxTokensAllowed(address target) public view returns (uint256) {
        uint256 maxAllowedTokens = maxTokensPerAddress;
        ...
        }else if(currentStage == STAGE_STOPPED){
            maxAllowedTokens = 0;
        }
    ...
    function getContractInfo(address target, uint256 amount) external view returns (
        ...
        _bundlePrice = bundlePrice(amount); 
