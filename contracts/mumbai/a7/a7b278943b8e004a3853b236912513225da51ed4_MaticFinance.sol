...
contract MaticFinance {
	...
	// uint256 constant public WITHDRAW_MIN_AMOUNT = 30 ether; // 15 MATIC
	// uint256 constant public WITHDRAW_MAX_AMOUNT = 80000 ether; // 15 MATIC
	uint256 constant public INVEST_MIN_AMOUNT = 0.01 ether; // 15 MATIC
	uint256 constant public WITHDRAW_MIN_AMOUNT = 0.01 ether; // 15 MATIC
	uint256 constant public WITHDRAW_MAX_AMOUNT = 8000 ether; // 15 MATIC
	...
	function withdraw() public {
		...
		require((totalAmountL + totalAmountU) <= WITHDRAW_MAX_AMOUNT, "max withdraw is 80,000 MATIC");
	...
	function getUserAvailable(address userAddress) public view returns(uint256) {
		...
		return getUserReferralBonus(userAddress) + U + L;
	}
