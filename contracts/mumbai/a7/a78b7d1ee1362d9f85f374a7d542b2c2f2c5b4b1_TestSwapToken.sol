...
contract ERC20SwappableInput is ERC20, ERC20Detailed, Ownable {
    ...
    function swap(address outputToken, address payee, uint256 inputAmount) external returns (bool) {
        ...
        uint256 outputAmount = inputAmount.mul(10 ** uint256(ERC20Detailed(address(outputContract)).decimals())).div(10 ** uint256(decimals())).mul(9999).div(100000);
...
/**
 * @title TestSwapToken
 * @dev Version 1 of the ERC20 token contract for TestSwapToken
 */
contract TestSwapToken is ERC20, ERC20Detailed, ERC20Mintable, ERC20Burnable, ERC20SwappableInput, ERC20SwappableOutput {
    using SafeMath for uint256;

    /**
     * @dev After deployment, 10,000,000 tokens will be minted for swap testing.
     */
    constructor () public ERC20Detailed("TestSwapToken", "TST", 3) { }
}