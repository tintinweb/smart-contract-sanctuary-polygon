...
contract MarketHistory is IMarketHistory, AccessHandler {
    ...
    uint256 private marketCounter;  // TODO: remove for prod? Can overflow
    ...
    /**
     * @notice Makes a market for testing. // TODO: Remove/disable before prod deploy?
     */
    ...
    {
        marketCounter++; // Can eventually overflow
        bytes32 hash = keccak256(abi.encode(marketCounter));
        addMarket(hash);
    }
