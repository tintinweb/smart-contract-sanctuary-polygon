...
contract OptionsVault is Withdraw, ITrufinVault {
    ...
    /// @param _startFrom The address of the user to start the iteration from, set to zero address to start from the
    /// first user
    ...
    /// @param _startFrom The address to start the position readjustment from, set to zero address to start from the
    /// first user
    ...
    /// @param _startFrom The address of the user to start the iteration from, set to zero address to start from the first user.
    /// @return _toContinue The value of next user in the loop to continue iterating through
...
contract Withdraw is Deposit {
    ...
    function completeWithdraw() public {
        ...
        e_V -= amountOfAsset1ToWithdraw;
        u_V -= amountOfAsset2ToWithdraw;
    ...
    ReentrancyGuardUpgradeable
{
    ...
    uint256 internal n_T; // Amount of shares in the vault that have remained from the previous epoch.
...
interface ISwapVault {
    ...
    event Withdrawed(bytes32 indexed poolId, bytes32 requestId, uint256 amount);
