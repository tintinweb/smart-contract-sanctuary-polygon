...
contract RestaurantMenu {
    ...
    function addMenuItem(string memory _restaurantName, string memory _name, uint256 _price, string memory _ingredientsAndOrigins) public {
        restaurantMenus[msg.sender].push(MenuItem(_restaurantName, _name, _price, _ingredientsAndOrigins));
    }
