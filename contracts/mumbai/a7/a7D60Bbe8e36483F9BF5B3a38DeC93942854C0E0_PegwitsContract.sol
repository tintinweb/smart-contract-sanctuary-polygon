...
//*********************************************************************//
//
//    ____  ___  ____ __      __(_) /______
//    / __ \/ _ \/ __ `/ | /| / / / __/ ___/
//   / /_/ /  __/ /_/ /| |/ |/ / / /_(__  ) 
//  / .___/\___/\__, / |__/|__/_/\__/____/  
// /_/         /____/                       
//
//*********************************************************************//
//*********************************************************************//
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeifhzladh6554afnbkgs724dcbld5wnghvb5p3qfbp7ugjs5rkp3si/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/eL0Gde7fKgGZ2tP2elp4/contract-metadata";
  }
...
// File: contracts/PegwitsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PegwitsContract is ERC721APlus {
    constructor() ERC721APlus("pegwits", "PEGWITS"){}
}
