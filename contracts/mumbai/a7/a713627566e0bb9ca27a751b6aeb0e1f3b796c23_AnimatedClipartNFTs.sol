...
contract AnimatedClipartNFTs is ERC721A,Whitelist {
  ...
  mapping(address => uint256) public addressMintedGeneralsaleBalance;
  ...
  function _baseURI() internal view virtual override returns (string memory) {
    ...
    function mint(uint _mintAmount) public payable {
        ...
        if(block.timestamp < generalSaleTime) {
            ...
            uint256 ownerMintedCount = addressMintedGeneralsaleBalance[msg.sender];
            ...
            addressMintedGeneralsaleBalance[msg.sender] = addressMintedGeneralsaleBalance[msg.sender].add(addressMintedGeneralsaleBalance[msg.sender]);
            _safeMint(msg.sender, _mintAmount);
        }
    }
  ...
  function  getMintedCount(address user) public view returns(uint256) {
      return addressMintedGeneralsaleBalance[user].add(addressMintedPresaleBalance[user]);
  }
