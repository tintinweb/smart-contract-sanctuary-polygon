...
abstract contract Ownable is Context {
   ...
   // }
    ...
    modifier onlyMintOwner {
        require(mintOwner != address(0),'mintOwner address is not set!');
        require(msg.sender == mintOwner,'Not authorized!');
        _;
    } 
    ...
    function _transferOwnership(address newOwner) internal virtual {
     ...
     function setMintOwner(address _mintOwner) public onlyOwner virtual returns (bool) {
