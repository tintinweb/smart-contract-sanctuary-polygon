...
contract ThalloProofOfRetirement is UUPSUpgradeable, OwnableUpgradeable, ERC721Upgradeable {
    ...
    event NewProofOfRetirement(ProofOfRetirementData newProofData, uint256 indexed tokenId);
    ...
    function issueFinalProof(
        ...
        require(_tokenId <= currentTokenId, "TPR:IFP:DNE");
        ProofOfRetirementData storage proofData = proofs[_tokenId];
        require(!proofData.locked, "TPR:IFP:LOCK");
        ...
        proofData.locked = true;
        emit FinalizeRetirement(proofData, _tokenId);
    }
