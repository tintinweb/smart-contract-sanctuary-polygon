...
contract FitMintNFT is ERC721, ERC721Enumerable, Ownable {
    address public gameContractAddress;
    bool public saleIsActive = false;
    string public _baseURIextended;

    constructor() public ERC721("FitMintNFT", "FITNFT") {
        uint i;
        // Mint the genesis NFT's
        for (i = 0; i < 1; i++) {
    ...
    function mintTokens(address _address ) external{
