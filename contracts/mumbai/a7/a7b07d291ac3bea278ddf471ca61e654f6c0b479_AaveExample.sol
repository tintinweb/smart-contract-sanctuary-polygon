...
contract AaveExample is Initializable {
    using SafeERC20Upgradeable for IERC20Upgradeable;

    IERC20Upgradeable public constant dai = IERC20Upgradeable(0x6B175474E89094C44Da98b954EedeAC495271d0F);
    IaToken public constant aToken = IaToken(0x028171bCA77440897B824Ca71D1c56caC55b68A3);
    IAaveLendingPool public constant aaveLendingPool = IAaveLendingPool(0x87870Bca3F3fD6335C3F4ce8392D69350B4fA4E2);
    ...
    function userDepositDai(uint256 _amountInDai) external {
        dai.safeTransferFrom(msg.sender, address(this), _amountInDai);
    ...
    function userWithdrawDai(uint256 _amountInDai) external {
        ...
        dai.safeTransferFrom(address(this), msg.sender, _amountInDai);
    }
}