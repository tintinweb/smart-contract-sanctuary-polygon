...
contract DigitalAudioTracks is ERC1155 {
    ...
    //Roles
    bytes32 private immutable STREAM_PROVIDER_ROLE = keccak256("PROVIDER");
    bytes32 private immutable APPROVED_ISSUER = keccak256("ISSUER");
    //Share Definition
    // struct Shares {
    ...
    constructor(
        ...
        standardTokenFee = 15;//_standardTokenFee;
        standardBundleFee = 15;//_standardBundleFee;
        stanardRoyalty = 15;//_stanardRoyalty;
        //TODO: Set up Roles
    ...
    // modifier isDATAdmin() {
    //     require(isProjectAdmin(), "Only Admins are permitted to make this change");
    //     _;
    // }
    ...
    // modifier isProjectAdmin {
    //     require(_admins.contains(msg.sender), "Access denied, only project admins can perform this action");
    //     _;
    // }
    ...
    function issueToken(
        ...
        uint256 _exportRoyalty,
        uint256 _sampleRoyalty,
        uint256 _remixRoyalty,
...
contract ArtistAgreement is ERC1155 {
    ...
    function getRemixPublishRate() public view returns (uint256) {
        return usageTerms.royalties[TokenConsumptionTerms.SAMPLE_ACTION];
    }

    function getSamplePublishRate() public view returns (uint256) {
        return usageTerms.royalties[TokenConsumptionTerms.REMIX_ACTION];
    }

    function getResaleRoyalty() public view returns (uint256) {
