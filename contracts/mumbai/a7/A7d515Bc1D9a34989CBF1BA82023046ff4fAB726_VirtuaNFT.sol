...
contract VirtuaNFT is ERC721Tradable{
       ...
       constructor(address eventContract) ERC721Tradable("Guardians-Test", "GDT",0x1E0049783F008A0085193E00003D00cd54003c71,"https://assetsmeta.bimtvi.com/", 0x1536EF5C6172C8a34c640F527e0cF674aA4DC82D, 750, eventContract) {
    }
    ...
    DefaultOperatorFilterer
{
    ...
    string public constant provenanceHash = ""; //provinance hash will be set here
    address public proxyRegistryAddress;
    uint256 public revealTime = 1625097600; // July 1st, 2021 12:00:00 AM UTC
...
// this function is without reveailing system
    ...
    function tokenURI(
        ...
        if (block.timestamp >= revealTime) {
            return
                string(
                    abi.encodePacked(getBaseURI(), Strings.toString(_tokenId))
                );
        } else {
