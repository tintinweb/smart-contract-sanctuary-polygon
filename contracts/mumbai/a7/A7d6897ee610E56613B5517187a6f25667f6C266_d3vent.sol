...
contract d3vent {
    ...
    string public actionIdChain = "wid_staging_034a32eef8f9c2d4ac2cca30890c2e76";   //on-chain engine id
    string public actionIdCloud = "wid_staging_7a9456d25763ab09db907a6e9fdd289a";   //cloud engine id
    ...
    function verifyChainId(
        ...
        worldId.verifyProof(
            ...
            abi.encodePacked(signal).hashToField(),
            nullifierHash,
            abi.encodePacked(actionIdChain).hashToField(),
            proof
        );
    ...
    function verifyCloudId(
        ...
        worldId.verifyProof(
            ...
            abi.encodePacked(signal).hashToField(),
            nullifierHash,
            abi.encodePacked(actionIdCloud).hashToField(),
            proof
        );
