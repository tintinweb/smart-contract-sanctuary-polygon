    ...
    ERC721DropStorageV1
{
    ...
    ///  @param _presaleEditionSize Number of editions that can be minted during presale. Presale editions have no impact on editionSize (mints during public sale).
        ...
        returns (IERC721Drop.SaleDetails memory)
    {
        return
            IERC721Drop.SaleDetails({
                ...
                maxSupply: config.editionSize + config.presaleEditionSize,
