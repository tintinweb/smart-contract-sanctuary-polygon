...
contract MECHANFTMINING1 {
	...
	constructor(address payable wallet, address payable _developer) public {
        ...
        plans.push(Plan(1, 90)); // SL Mecha 
        plans.push(Plan(1, 80)); // L Mecha
        plans.push(Plan(1, 75)); // SR Mecha
		plans.push(Plan(1, 70)); // R Mecha (Compounding)
        plans.push(Plan(1, 70)); // COMM Mecha (Compounding)
        plans.push(Plan(1, 70)); // UNC Mecha (Compounding)
	}
