...
// Contract deployed to Mumbai polygon testnet contract @  0xE67eF9a886a4E33FD0f5391D40bbAaF9694E70bD
contract ChainWar is ERC721URIStorage{ 
    ...
    mapping(uint256 => Levels) public tokenIds2Levels;
...
/* function getTokenURI(uint256 tokenId) public returns (string memory){
    ...
    function getTokenURL(uint256 tokenId) public returns(string memory){
     ...
     function mint(uint256 _tokenId, uint256 _level, uint256 _speed, bool _strenght, bool _live) public returns(uint256) {
         _tokenIds.increment();
          Levels memory Ids = tokenIds2Levels[_tokenId];
          Ids.level = _level;
          Ids.speed = _speed;
          Ids.strenght = _strenght;
          Ids.life = _live;

            ooops.push(Ids);

            uint256 tokenId = ooops.length -1;

         uint256 newItemId= _tokenIds.current();
         _safeMint(msg.sender, newItemId);
         tokenIds2Levels[newItemId];
