...
contract Battle {
    ...
    \*/
    function getAllActive(uint _start) public view returns(uint[] memory, uint[] memory, uint[] memory) {
        uint count = 0;
    ...
    function resign(uint _id) public returns(bool) {
        ...
        uint _burnFee = (Gamelist[_id].stakes * 2) * 8 / 100;
        ...
        uint _LPStakingFee = (Gamelist[_id].stakes * 2) * 1 / 100;
