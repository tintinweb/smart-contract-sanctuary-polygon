...
contract Ownable is Context {
  ...
  /**
   * @dev Initialize the Ownable. It will set the initial sender as the owner
   */
  function intialize() public virtual {
    require(_isInitialized == false, 'Ownable: contract is already initialized');
    _owner = _msgSender();
    _isInitialized = true;
  }
