...
contract FunctionsConsumer is FunctionsClient, ConfirmedOwner {
  ...
  string public sourceCode = string(abi.encodePacked( "const sqlText = args[0]\r\n" ,
    "const resourceId = args[1] \r\n" ,
    "const userId = args[2] \r\n" ,
    "const response = await Functions.makeHttpRequest({ \r\n" ,
    "    url: 'https://fd82-125-99-200-130.in.ngrok.io/v1/query/Uint256', \r\n" ,
    "    method: 'POST',\r\n" ,
    "    timeout: 9000,\r\n" ,
    "    headers: {\r\n" ,
    "        'Content-Type': 'application/json'\r\n" ,
    "    },\r\n" ,
    "    data: { 'resourceId': resourceId, 'sqlText': sqlText, 'userId': userId, 'publicKey': secrets.publicKey, 'privateKey': secrets.privateKey }\r\n" ,    "})\r\n" ,
