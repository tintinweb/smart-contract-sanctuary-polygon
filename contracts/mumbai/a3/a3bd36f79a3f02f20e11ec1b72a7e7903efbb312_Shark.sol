...
// File: github/BasedFinance/based-finance-contracts/contracts/interfaces/IOracle.sol
...
// File: github/BasedFinance/based-finance-contracts/contracts/lib/SafeMath8.sol
...
// File: github/BasedFinance/based-finance-contracts/contracts/Based.sol
...
contract Shark is ERC20Burnable, Operator {
     ...
     */
    constructor() ERC20("Sea Finance", "Shark") {
    ...
    function _getBasedPrice() internal view returns (uint256 _basedPrice) {
        try IOracle(basedOracle).consult(address(this), 1e18) returns (uint144 _price) {
            ...
            revert("Based: failed to fetch Shark price from Oracle");
        }
    }
    ...
    /**
     * @notice Operator mints Shark to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of Shark to mint to
