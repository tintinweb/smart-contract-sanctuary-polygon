...
contract CHRONOFi is Context, IERC20, Ownable {
    ...
    string private _name = "CHRONOFi";
    string private _symbol = "CFC";
    ...
    function setLiqAmt(uint256 amt) external onlyOwner() {
        numTokensSellToAddToLiquidity = amt * 10**18; 
    }
