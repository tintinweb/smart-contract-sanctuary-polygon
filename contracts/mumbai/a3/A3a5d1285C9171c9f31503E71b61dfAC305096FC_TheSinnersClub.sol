...
contract TheSinnersClub is ERC721Enumerable, Ownable {
  ...
  string public notRevealURI="https://gateway.pinata.cloud/ipfs/Qmch5v4XuNu6BpKuchYGiL2iVmAZw7gCSWpo7DV47PeGcZ";
  address[] public WW;
  ...
  constructor()
    ERC721("The Sinners Club", "TSC") { 
        // setBaseURI(_initBaseURI); setnotRevealURI(_initnotRevealURI);
        }
