...
contract YourContract {
  ...
  constructor(address _feeToken) {
    ...
    require(_feeToken != address(0),"tokenAddress cannot be ZERO_ADDRESS");
    feeToken = _feeToken;
  }
  ...
  function setPurpose(string memory newPurpose, uint256 amount) public {
    // 🙋🏽‍♂️ you can add error handling!
    require(amount != 0, "Amount should not be 0");
    require(amount >= 1 ether, "Must spend at least 1 ETHIN token");  
