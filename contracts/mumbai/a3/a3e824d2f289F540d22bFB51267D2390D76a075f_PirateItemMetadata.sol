    ...
    is IPirateItemMetadata 
{
    ...
    function getPirateItem(uint256 tokenId) override public view returns (PirateItem memory) {
        return tokenIdToPirateItem[tokenId];
    }

    function getTokenTraits(uint256 tokenId) override public view returns (TokenTrait[] memory) {
