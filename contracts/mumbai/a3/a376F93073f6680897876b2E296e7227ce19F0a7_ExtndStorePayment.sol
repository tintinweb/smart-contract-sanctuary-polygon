...
import "../ExtndOperator/IExtndOperator.sol";

contract ExtndStorePayment is Ownable, SignatureVerify {
    // ----- EVENTS ----- //
    ...
    IExtndOperator public operator;
    uint256 internal constant TREASURY_INDEX = 0;

    // ----- CONSTRUCTOR ----- //
    constructor(uint256 _pnetworkId, IExtndOperator uniqOperator) {
