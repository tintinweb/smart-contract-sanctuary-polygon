...
contract VickreyAuction {
   ...
   */
    ...
    {
        require(_amount < auctions[_endUser][_auctionId].reward,'_amount must be less than reward');        require(_amount > auctions[_endUser][_auctionId].minimumPayout,'_amount must be greater than minimumPayout');
   ...
   */
        ...
        returns (bool success)
    {
        ...
        auctions[_endUser][_auctionId].secondHighestBid = auctions[_endUser][_auctionId].highestBid;        auctions[_endUser][_auctionId].highestBid = _amount;
