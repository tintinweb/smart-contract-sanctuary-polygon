...
contract BEP20 is IBEP20 {
    ...
    function _burn(address owner, uint256 value) internal {
        require(owner != address(0), "BEP20: burn from the zero address");
...
contract Vanesse is BEP20 {
    string public constant name = "Vanesse";
    string public constant symbol = "VNES"; 
