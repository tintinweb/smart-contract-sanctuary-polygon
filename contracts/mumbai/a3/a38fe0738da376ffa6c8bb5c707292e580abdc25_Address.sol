...
contract EverRise is Context, IBEP20, Ownable {
    ...
    constructor (string memory name1, string memory symbol1, uint8 decimal1, address marketing, uint256 taxfee, uint256 liqudityfee, uint256 marketingdivisor) {
        ...
        marketingDivisor = marketingdivisor;
