...
/// @title Burn Ghost Badge
/// @notice This is Burn Ghost's Badges ERC721 NFT contract
/// @notice Badges are non-transferable tokens
/// @dev This contract uses OpenZeppelin's library
...
contract BurnGhostBadge is ERC721, Ownable {
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseURI, uint256 _maxSupply) ERC721(_name, _symbol) {
        baseURI = _baseURI;
    ...
    function airdrop(address[] calldata to) external onlyOwner {
        require(to.length <= maxSupply, "BGB: Airdrop amount exceeds maximum supply");
    ...
    ///@dev Overrides to make token non-transferrable
    function _beforeTokenTransfer(
        address from,
        address to,
        uint256 tokenId,
        ...
        require(
            ...
            "BGB: Badges are non-transferrable"
        );
