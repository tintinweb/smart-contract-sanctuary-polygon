...
contract KwikTrustFactory is AccessControl {
    ...
    /**
     * @dev Deploy KwikTrust Brand NFT contract
     * @param _name Name of contract
     * @param _symbol Symbol of contract
     * @param _minterAddress Minter Address
     * @param _validatorAddress validator address of lazy minting
     * @dev Error Details
     * - 0x01: Invalid Deployer
     */
    ...
    function deployMintingContract(
        ...
        require(hasRole(DEPLOYER_ROLE, msg.sender), "0x01");
