...
contract DaoContract is BaseContract {
    ...
    */
    function bind(address _referrerAddress) external {
        ...
        // 推荐人地址不能为0地址
        require(_referrerAddress != address(0), "t01");
        // 推荐人地址不能为调用者地址
        require(_referrerAddress != _user, "t02");
        // 调用者的推荐人地址必须为空
    ...
    function invest(uint256 _amount) external {
        ...
        address _user = msg.sender;
        require(_amount >= userInfoList[_user]._lastInvestAmount, "t07");
        userInfoList[_user]._lastInvestAmount = _amount;
        ...
        //必须有推荐人
        require(_referrer != address(0), "t01");
    ...
    function claimDaoReward(uint256 _type) external {
        //必须1-5之间
        require(_type > 0 && _type < maxDaoType + 1, "t10");
        address _user = msg.sender;
        _updateStaticRewad(_user);
    ...
    function _transferReward(address _user, uint256 _pendingReward, string memory _type) private {
        ...
        require(remainingCredit >= _pendingReward, "t10");
        // 减去已转移的奖励数量
