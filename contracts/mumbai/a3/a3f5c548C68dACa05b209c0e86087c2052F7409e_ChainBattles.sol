...
// Smart contract deployed to 0xa3f5c548C68dACa05b209c0e86087c2052F7409e
contract ChainBattles is ERC721URIStorage  {
        ...
        bytes memory svg = abi.encodePacked(
            ...
            '<defs>',
                ...
                '<linearGradient id="grad2" x1="0%" y1="0%" x2="100%" y2="0%">',
                    '<stop offset="0%" style="stop-color:rgb(175,0,255);stop-opacity:1" />',
                    '<stop offset="100%" style="stop-color:rgb(0,25,255);stop-opacity:1" />',
                '</linearGradient>',
            '</defs>',
            '<style>.base { font-family: serif; font-size: 14px; font-weight: bold }</style>',
            '<rect width="100%" height="100%" fill="url(#grad1)" />',
            '<text x="50%" y="40%" class="base" dominant-baseline="middle" text-anchor="middle" fill="url(#grad2)">',"Warrior",'</text>',
            '<text x="50%" y="50%" class="base" dominant-baseline="middle" text-anchor="middle" fill="url(#grad2)">', "Level: ",getLevel(tokenId),'</text>',
            '<text x="50%" y="60%" class="base" dominant-baseline="middle" text-anchor="middle" fill="url(#grad2)">', "Health: ",getHealth(tokenId),'</text>',
            '<text x="50%" y="70%" class="base" dominant-baseline="middle" text-anchor="middle" fill="url(#grad2)">', "Power: ",getPower(tokenId),'</text>',
            '<text x="50%" y="80%" class="base" dominant-baseline="middle" text-anchor="middle" fill="url(#grad2)">', "Defense: ",getDefense(tokenId),'</text>',
            '</svg>'
        );
        return string(
            abi.encodePacked(
    ...
    function mint() public {
        ...
        tokenIdToLevels[newItemId].health = random(25);
        tokenIdToLevels[newItemId].power = random(10);
    ...
    function train(uint256 tokenId) public {
        ...
        tokenIdToLevels[tokenId].health = currentHealth + random(25);
        tokenIdToLevels[tokenId].power = currentPower + random(10);
