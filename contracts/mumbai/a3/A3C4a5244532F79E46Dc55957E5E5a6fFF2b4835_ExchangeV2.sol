...
abstract contract ExchangeV2Core is Initializable, OwnableUpgradeable, AssetMatcher, TransferExecutor, OrderValidator, ITransferManager {
    ...
    */
    ...
    function validateFull(LibOrder.Order memory order, bytes memory signature) internal {
...
abstract contract OrderValidator is Initializable, ContextUpgradeable, EIP712Upgradeable {
    ...
    event DebugLog(string name, address value, string name2, address value2);
    ...
    function validate(LibOrder.Order memory order, bytes memory signature) internal  {
        if (order.salt == 0) {
            ...
            if (_msgSender() != order.maker) {
                ...
                emit DebugLog("Signer verigication signer:", signer, "order.maker:", order.maker);
