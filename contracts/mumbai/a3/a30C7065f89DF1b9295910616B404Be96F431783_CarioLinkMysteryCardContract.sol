...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0xb99A2BdAbBA4349c3A3ef69e8323348b1E3C015E];
...
// File: contracts/CarioLinkMysteryCardContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract CarioLinkMysteryCardContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "CarioLink Mystery Card";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/1wxb2kQQmvsEHNua96Z6/contract-metadata";
  }
