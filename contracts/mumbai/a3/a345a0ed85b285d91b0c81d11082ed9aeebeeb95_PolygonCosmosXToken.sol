...
contract PolygonCosmosXToken is PolygonBaseERC20TokenUpgradeable {
    // decimals is set to 18 by default
    string private constant _NAME = "Cosmos X";
    string private constant _SYMBOL = "CX";
    ...
    IChildToken
{
    ...
    function deposit(address user, bytes calldata depositData) external override {
        require(_childChainManager == msg.sender, "IntellaX: sender is not child chain manager");
        ...
        notBlacklisted(_msgSender())
    {
        ...
        require(!paused(), "IntellaX: token transfer while paused");
    }
