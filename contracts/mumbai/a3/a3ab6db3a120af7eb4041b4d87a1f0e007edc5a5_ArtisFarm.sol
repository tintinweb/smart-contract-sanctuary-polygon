...
contract ArtisFarm is IERC777Recipient {
    ...
    address public artisTokenAddress = 0x63231d5060Da555026980d67F3d8758805b27E83;
    ...
    constructor() {
        artisToken = ERC777(artisTokenAddress);
    ...
    */
    function tokensReceived(
        ...
        require(from == msg.sender, "Caller must sender of tokens... Ya bih.");
        require(amount > 0, "Must stake more than zero... Ya bih.");
        require(to > address(this), "Must send tokens to this address... Ya bih.");
        require(
            artisToken.balanceOf(address(this)) == totalARTISLocked + amount,
            "Only ARTIS accepted... Ya bih."
        );
