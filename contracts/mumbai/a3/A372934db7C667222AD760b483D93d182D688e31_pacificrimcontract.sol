...
contract pacificrimcontract is Ownable {
    ...
    uint256 public perTransactionCount; // in case of public sale
    ...
    constructor(
        ...
        whitelistTime = _whitelistTime; //1670893169; // whitelist mint 23-12-22 00:15:00
        publicsaleTime = _publicsaleTime; //1679854169; // public sale 23-12-22 01:00:00

        presaleDuration = 5 minutes;
        whitelistDuration = 5 minutes;
        publicsaleDurattion = 7 minutes;
    ...
    function mint(
        ...
        if (
            ...
            require(
                tokenId.length <= perTransactionCount,
    ...
    function updatePerTransactionCount(uint256 count) public onlyOwner {
        require(count != 0, "cannot set to zero");
        perTransactionCount = count;
