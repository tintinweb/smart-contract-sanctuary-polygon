...
// File contracts/Staking180.sol



pragma solidity ^0.8.13;
/// @title Prozium staking contract
...
contract Staking180 is Pausable, ReentrancyGuard, Ownable  {
    ...
    function estimatedReward(address account) public view returns (uint256) {
        return balances[account] * rewardRate[account]/100/2;
    }
