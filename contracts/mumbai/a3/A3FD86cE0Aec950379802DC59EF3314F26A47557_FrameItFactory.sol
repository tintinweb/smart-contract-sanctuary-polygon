...
contract FrameItFactory is IFrameItFactory, Ownable {
    ...
    event FrameItCollectionCreated(address indexed _nft, address indexed _lootBox, address indexed _salesSplitter, address _owner, string _nftUri, string _lootBoxUri);
    ...
    function createCollection(
        ...
        IFrameItSalesSplitter(salesSplitter).initialize(msg.sender, _splitPercentagesInBips, _splitWallets, lootBox, address(this));
        ...
        emit FrameItCollectionCreated(nft, lootBox, salesSplitter, msg.sender, _nftUri, _lootBoxUri);
    }
