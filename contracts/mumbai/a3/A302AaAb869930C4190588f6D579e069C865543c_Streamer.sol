...
contract Streamer {
    ...
    constructor(string memory name, string memory symbol, uint256 supply, address _stf, address host, address cfa, int96 _unitFlowRate, address _nft) {
