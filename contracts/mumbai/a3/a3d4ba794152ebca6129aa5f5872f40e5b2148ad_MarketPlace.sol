...
contract MarketPlace{
    ...
    event OfferingPlaced(bytes32 indexed offeringId, address indexed hostContract, address indexed offerer,  uint tokenId, uint256 price, string uri);
    ...
    function placeOffering (address _offerer, address _hostContract, uint _tokenId, uint256 _price) external {
