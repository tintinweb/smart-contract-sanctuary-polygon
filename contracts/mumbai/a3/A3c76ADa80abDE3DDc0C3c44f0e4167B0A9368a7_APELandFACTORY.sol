    ...
    BlackList
{
    ...
    function lazyMint(
        ...
        require(
            hasRole(
                SIGNER_ROLE,
                getSigner(account, id, amount, tokenUri, data, signature)
            ),
    ...
    function prepareHash(
        ...
        return
            keccak256(
                abi.encodePacked(to, ids, amounts, tokenUri, data, APELAND_HASH)
            );
    }
    ...
    function getSigner(
        ...
        bytes32 hash = prepareHash(to, ids, amounts, tokenUri, data)
...
contract APELandFACTORY is AccessControlEnumerable, BlackList {
    ...
    function deploy(address account) external {
