...
contract ERC1155Token is ERC2771Context, ERC1155Supply, ERC1155Burnable, Ownable {
    ...
    constructor(string memory contractName, string memory uri, address trustedForwarder) ERC1155(uri) ERC2771Context(trustedForwarder) {
        name=contractName;
    }
