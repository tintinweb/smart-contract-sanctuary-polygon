...
contract WINU is Context, IERC20, IERC20Metadata, Ownable {
    ...
    string private _name = "Warcraft Inu";
    ...
    function showWInuNationDonors() external view returns (address[] memory) {
        return _donors;
    }

    function showWInuNationBurners() external view returns (address[] memory) {
        return _burners;
    }
