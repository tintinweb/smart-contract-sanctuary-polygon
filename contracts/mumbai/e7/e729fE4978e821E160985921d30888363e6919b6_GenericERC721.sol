...
contract GenericERC721 is ERC721Enumerable {
    ...
    function mint(address _to, string memory _tokenURI) public {
        require(bytes(_tokenURI).length > 0, "GenericERC721: tokenURI not valid");
    ...
    */
    function tokenURI(uint _tokenID) public view virtual override returns (string memory) {
        require(_exists(_tokenID), "GenericERC721: tokenID not exist");
