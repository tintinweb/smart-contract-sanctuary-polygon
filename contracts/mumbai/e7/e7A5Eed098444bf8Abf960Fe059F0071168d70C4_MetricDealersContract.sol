...
//
//    __  ___    __      _       ___           __          
//   /  |/  /__ / /_____(_)___  / _ \___ ___ _/ /__ _______
//  / /|_/ / -_) __/ __/ / __/ / // / -_) _ `/ / -_) __(_-<
// /_/  /_/\__/\__/_/ /_/\__/ /____/\__/\_,_/_/\__/_/ /___/
//                                                         
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xC296Ebc8a3B2BCdC02c80F0492a68Ff5f875F166];
  address public erc20Payable = 0xC296Ebc8a3B2BCdC02c80F0492a68Ff5f875F166;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeihpkyrsdjyl757j6qg7qw3yzrg2d4dgg43kad5jugofzs4eg6ndnm/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/tyGuz9SJTmsFJU8jXuCL/contract-metadata";
  }
...
// File: contracts/MetricDealersContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MetricDealersContract is ERC721APlus {
    constructor() ERC721APlus("Metric Dealers", "MD"){}
}
