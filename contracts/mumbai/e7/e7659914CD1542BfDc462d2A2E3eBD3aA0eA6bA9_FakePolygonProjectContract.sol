...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x40C423d16D1A9B90535cAD9D54ba4a2766D066DA];
  address public erc20Payable = 0x40C423d16D1A9B90535cAD9D54ba4a2766D066DA;
...
abstract contract Feeable is Teams {
  uint256 public PRICE = 69.42 ether;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 69420) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmWE9j42jMtwCu9fBEkUZaaFCqegN74nHMKSHcUsbLy9HE/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/8k6Rhhj65CZgMhq63vew/contract-metadata";
  }
...
// File: contracts/FakePolygonProjectContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract FakePolygonProjectContract is RamppERC721A {
    constructor() RamppERC721A("Fake Polygon Project", "DNSPLYGN"){}
}
