...
/// @custom:security-contact [email protected]
contract Solbeatz721 is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, ERC721BurnableUpgradeable, ERC721RoyaltyUpgradeable, DefaultOperatorFiltererUpgradeable,  OwnableUpgradeable, UUPSUpgradeable, ISolbeatz721 {
    ...
    function mint(AssetData calldata data, address to) external returns (uint256)
    {
        uint256 tokenId = _tokenIdCounter.current();
        _safeMint(to, tokenId);
