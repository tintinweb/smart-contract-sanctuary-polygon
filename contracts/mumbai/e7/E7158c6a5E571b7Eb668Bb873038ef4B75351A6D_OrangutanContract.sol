...
//
//   ____                          __          
//  / __ \_______ ____  ___ ___ __/ /____ ____ 
// / /_/ / __/ _ `/ _ \/ _ `/ // / __/ _ `/ _ \
...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x5de3d0442a0Db267b08dFCB3D0378B3EBE51cd26];
...
// File: contracts/OrangutanContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract OrangutanContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/t5FkllsWNoX32hQfeuEc/contract-metadata";
  }
