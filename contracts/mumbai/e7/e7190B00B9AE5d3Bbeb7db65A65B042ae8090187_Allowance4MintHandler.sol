...
import "cryptotattooerz-nft/contracts/CryptoTattooerzERC721Token.sol";

/**
 * @title This is the CryptoTattooerz implementation for ERC721 NFT direct sale
 ...
 * @author tazous
 */
contract CryptoTattooerzNFTMintDirectSale is BaseCryptoTattooerzTokenDirectSale {
    ...
    BaseCryptoTattooerzTokenDirectSale(proxyHubAddress_, priceHandlerAddress_, nftAddress_,
     ...
     */
    function getERC721() private view returns (CryptoTattooerzERC721Token) {
        return CryptoTattooerzERC721Token(_getTokenAddress(getTOKEN()));
    }
    ...
    function _transfer(address buyer, uint256 amount) internal override {
        CryptoTattooerzERC721Token nftContract = getERC721();
        // Randomly select & mint each NFT one after each other
        while(amount > 0) {
            amount--;
            nftContract.mintTo(buyer);
        }
    }
    /**
...
/**
 * @title This is the CryptoTattooerz implementation for ERC721 NFT free mint
 * @author tazous
 */
contract CryptoTattooerzNFTMint4Free is CryptoTattooerzNFTMintDirectSale {
    ...
    CryptoTattooerzNFTMintDirectSale(proxyHubAddress_, address(0), nftAddress_, TOKEN_,
