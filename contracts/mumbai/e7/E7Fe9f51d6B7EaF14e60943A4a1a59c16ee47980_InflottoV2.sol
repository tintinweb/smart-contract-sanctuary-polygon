    ...
    KeeperCompatibleInterface
{
    ...
    uint256 private s_inflationUpper = 12500;
    uint256 private s_inflationLower = 7000;

    uint256 private s_tokenIds;

    /* Events */
    event PlayerAdded(address indexed player, uint256 ticket, uint256 tokenId);
    ...
    function enterCallback(uint256 requestId, uint256 randomNumber) private {
        ...
        emit PlayerAdded(s_ticketRequests[requestId], randomNumber, s_tokenIds);
    }
