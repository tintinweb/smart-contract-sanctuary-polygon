...
contract TokenFactory is Initializable, BasicMetaTransaction {
    ...
    function initialize(address _masterToken,address _tokenProxy, address _admin)
        external
        initializer
    {
    ...
    function createClone(address implementation) public returns (address instance) {
       assembly {
            let ptr := mload(0x40)
