...
contract ICO is ReentrancyGuard, AccessControl {
    ...
    function buyToken(
        ...
        if (paymentType == 0) {
            ...
            IERC20(paymentDetails[paymentType].paymentTokenAddress)
                .safeTransferFrom(msg.sender, address(this), tokenAmount);
        }
    ...
    function getToken(
        ...
        data =
            (amount * tokenAmount) /
            (10 ** paymentDetails[paymentType].decimal);
    }
    ...
    function recoverToken(
        ...
        IERC20(_tokenAddress).safeTransfer(walletAddress, amount);
    }
