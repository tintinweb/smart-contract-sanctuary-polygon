...
contract AdAsset1155 is MultiNFTradeableUpgradeable {
    ...
    */
        ...
        initializer
    {
        ...
        __EIP712_init_unchained("AdAsset1155", "1.0");
    ...
    function contractURI() public pure returns (string memory) {
        return "https://cros-adasset-dev.azurewebsites.net/contract/adasset/metadata/";
        /*
            return  "{"
    ...
    OwnableUpgradeable
{
    ...
    */
    ...
    {
        // if OpenSea's ERC71 Proxy Address is detected, auto-return true
    ...
    function batchMintNonFungibleTokens(
        ...
        for (uint256 i = 0; i < tokenTypes_.length; i++) {
            /* solhint-disable-next-line reason-string */        
            require(
                tokenTypes_[i].isNonFungibleType(),
                "Tokens can be created from token-type (upper-128 bits, lower-128 must be zero)"
            );
            /* solhint-disable-next-line reason-string */
            require(
