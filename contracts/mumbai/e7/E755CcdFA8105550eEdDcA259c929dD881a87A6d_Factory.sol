...
contract Factory is IFactory, IOwnable {
    ...
    function setDefaultStableUSD(address usd) external onlyOwner {
        defUSD = IERC20(usd);
    }
    ...
    function majorityShareTakeover(
        ...
        //take market price
        (uint256 weSellAt, , , , ) = priceManager
            .getPriceOracleForCategory(tnft)
            .usdcPrice(tnft, fingerprint, 0);
        //increase it to aboveMarketPrice
        uint256 aboveMarketPrice = (weSellAt * majorityAboveMarket) / 10000;
