...
contract EmailRegistration {
    ...
    constructor() {
        ...
        emailRegistrationPrice = 5000000000000000000; // 0.1 ether in wei
        emailRenewalPrice = 7000000000000000000; // 0.2 ether in wei
        emailRegistrationDuration = 2 minutes; // Default registration duration
        emailExpiryDuration = 2 minutes; // Default expiry duration
    }
...
function registerEmail(
    ...
    function isEmailRegisteredByEmail(string memory email) public view returns (bool) {
        address walletAddress = emailToWallet[toLower(email)];
