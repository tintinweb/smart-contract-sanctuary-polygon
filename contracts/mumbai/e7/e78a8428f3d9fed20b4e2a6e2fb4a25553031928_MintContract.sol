...
/**
 * @notice Represents CriptobeerERC721 Smart Contract
 */
contract ICriptobeerERC721 {
    /**
...
contract MintContract is Ownable {
     ...
     */
    ICriptobeerERC721 public immutable nft;
    ...
    constructor(address _nftaddress) Ownable() {
        nft = ICriptobeerERC721(_nftaddress);
    }
    ...
    /**
     * @notice Function to mint one NFT.
     ...
     *
     * @param code. The code received from store.
     * @param proof. The Merkle Proof of the user.
     */
    function mint(string memory code, bytes32[] calldata proof)
        external
        payable
        returns (bool)
    {
        ...
        require(merkleRoot != "", "MINT NOT STARTED");

        require(
            addressToMints[_msgSender()] + amount <= 1,
