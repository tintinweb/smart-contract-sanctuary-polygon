...
// File: interfaces/IMoonChessCollection.sol
...
interface IMoonChessCollection is IERC165 {
...
// File: contracts/MoonChessGame.sol
...
contract MoonChessGame is ERC1155Holder, Ownable, ReentrancyGuard {
    ...
    modifier onlyGame() {
        require(msg.sender == gameAddress || msg.sender == owner());
        _;
    }
