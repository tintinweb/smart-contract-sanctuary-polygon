...
contract TriklV1 {
     ...
     * @param _subscriber - Address of subscriber form mapping
     * msg.value - Total amount paid by User
     */
    function subscribe(address _expertAddress, address _subscriber)
        external
        payable
    {
        ...
        addressToMany[_expertAddress].push(_subscriber);
    }
