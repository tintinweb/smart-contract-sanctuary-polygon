...
contract Raffle is VRFConsumerBaseV2, HSystemChecker, Multicall {
    ...
    /// @param raffleId - Identifier of Raffle
    /// @param ticketAmount - Number of tickets user bought
    event LogBuyTicket(address buyer, uint256 raffleId, uint256 ticketAmount);
    ...
    function buyTicket(
        ...
        require(
            raffle.maxTicketCount == 0 ||
                tickets.totalMinted() + ticketAmount <= raffle.maxTicketCount,
        ...
        emit LogBuyTicket(buyer, raffleId, ticketAmount);
    }
    ...
    function burnTickets(
        ...
        tickets.batchBurn(owner, ticketIds);
