...
interface IUser is IYousovStructs {
    ...
    function checkWalletPassword(string memory walletPassword) view external  returns (bool validPassword , Wallet memory wallet);
    event SecretUpdated();
...
contract User is IUser {
    ...
    function checkWalletPassword(string memory walletPassword) view external override returns (bool validPassword , Wallet memory userWallet) {
