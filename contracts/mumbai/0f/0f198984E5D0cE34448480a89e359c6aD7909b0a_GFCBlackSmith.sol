...
contract GFCBlackSmith is Ownable, Whitelist, VRFConsumerBase {
    ...
    //In case we need to pause weapon forge
    bool public asteroidsPaused;

    uint256 vialTotalSupply;
    uint256 vialMaxCap;
    ...
    function forgeAsteroids() public {
        require(!asteroidsPaused, "The contract have been paused");
        require(vialTotalSupply+1 <= vialMaxCap, "No more vials can be minted");
        require(s_results[msg.sender] == 0, "Random number pending or rolled");
    ...
    function setVialMaxCap(uint256 _vialMaxCap) external onlyOwner {
		vialMaxCap = _vialMaxCap;
	}
    ...
    function toggleAsteroidsPaused() public onlyOwner{
        asteroidsPaused = !asteroidsPaused;
    }
