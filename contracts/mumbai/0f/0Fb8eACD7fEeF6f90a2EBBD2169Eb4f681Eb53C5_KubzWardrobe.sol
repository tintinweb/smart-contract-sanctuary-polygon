...
contract KubzWardrobe is ERC721xDummy, DefaultOperatorFiltererUpgradeable {
    ...
    event TraitItemBurn(string itemId, uint256 tokenId, address owner);
    ...
    function initialize(
        ...
        ERC721xDummy.__ERC721x_init("KubzWardrobe", "KWR");
    ...
    // function airdropCollectionListWithAmounts(
    ...
    //     for (uint256 i = 0; i < tbas.length; ) {
    //         safeMint(tbas[i], amounts[i]);
    //         unchecked {
    //             i++;
    //         }
    //     }
    ...
    function mint(
        ...
        string memory action = string.concat("kwr-mint/", itemId);
        ...
        require(
            ...
            "Not owner of requested collection"
        );
