    ...
    ReentrancyGuardUpgradeable
{
     ...
     */
    function bid(uint256 lotId, uint256 amount) external nonReentrant {
        Lot storage _lot = lots[lotId];
        ...
        if (_bids.length > 0) {
            ...
            require(amount > _minBidAmount, "bid too low");
    ...
    /**
     * @notice Return last bid collateral
     * @param lotId - ID of the lot instance (index)
     */
     ...
     */
    function initialize(address adminAddress, address collateralAddress)
        external
        initializer
    {
