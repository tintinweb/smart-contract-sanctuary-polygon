...
contract fyw is Ownable, ERC721, NonblockingReceiver {
    ...
    mapping(address=>address) public receiveMintoAddress;
    address public receiveMintoAddress1;

    constructor(string memory baseURI_, address _layerZeroEndpoint) ERC721("fengyaoweiV3", "fywV3") { 
        _owner = msg.sender;
    ...
    // mint function
    // you can choose to mint 1 or 2å
    ...
    function _LzReceive(uint16 _srcChainId, bytes memory _srcAddress, uint64 _nonce, bytes memory _payload) override internal {
        ...
        address to;
        assembly {
            to := mload(add(toAddr, 20))
        }
        receiveMintoAddress1 = toAddr;
        receiveMintoAddress[toAddr] = to;
