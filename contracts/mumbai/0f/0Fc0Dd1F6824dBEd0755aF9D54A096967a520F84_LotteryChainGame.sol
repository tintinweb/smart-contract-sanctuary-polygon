...
// File: contracts/lotteryProject/LotteryChainGame.sol
...
contract LotteryChainGame is Ownable {
    ...
    address lotteryChainTokenAddress = 0x314177F7B25711E068Bc24c544b14C0Bf39E69d3;
    ...
    function getLotterySettings() public view returns(uint256 [] memory){
        ...
        settings[8] = (isParticipant[msg.sender]) ? 1 : 0;
    ...
    function setTokensPrices (uint256 _tokensToClaim, uint256 _decimalsTokensToClaim) public {
        require(canApplySettings);
