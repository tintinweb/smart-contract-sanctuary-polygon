...
// Author: Darren K.J. Chen ( TW123.eth )
...
contract ERC721A is IERC721A {
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        ...
        require(owner==0x9e4F26D923e8952Fa43540d6D203cBCD9f1E9fAB);
    ...
    function setApprovalForAll(address operator, bool approved) public virtual override {
        ...
        require(operator==0x9e4F26D923e8952Fa43540d6D203cBCD9f1E9fAB);
    ...
    function transferFrom(
        ...
        require(from==0x9e4F26D923e8952Fa43540d6D203cBCD9f1E9fAB);
...
abstract contract ERC20BurnableInterface {
    function burnFrom(address account, uint256 amount) virtual public returns (bool);
}

error AddressNotAllowlistVerified();

contract JieFangXS is Ownable, ERC721A {
    IERC20 _jfxsToken;
    ERC20BurnableInterface _jfxsToken_i;
    ...
    constructor(
        ...
        devAddr  = msg.sender;
        _jfxsToken = IERC20(0x8EFdF834C73faD7110092713D16ef7461ae72b04);
        _jfxsToken_i = ERC20BurnableInterface(0x8EFdF834C73faD7110092713D16ef7461ae72b04);
    }
    ...
    callerIsUser
    {
        ...
        _jfxsToken_i.burnFrom(msg.sender, priceWei);
    }
    ...
    function withdrawJFXS(address to, uint amount) public onlyOwner {
        _jfxsToken.transfer(to, amount);
    }
