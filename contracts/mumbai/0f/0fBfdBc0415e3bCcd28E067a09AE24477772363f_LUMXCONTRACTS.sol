...
// File: contracts/lumx_soulbond.sol
...
contract LUMXCONTRACTS is Ownable, ReentrancyGuard, ERC721AQueryable, OperatorFilterer {
    ...
    function setTransferable(uint256 id, bool permission) external onlyOwner {
        soulbound[id] = permission;
    }
    ...
    {
        require(!soulbound[tokenIdsUris[tokenId]], "Token is soulbound, not transferable");
