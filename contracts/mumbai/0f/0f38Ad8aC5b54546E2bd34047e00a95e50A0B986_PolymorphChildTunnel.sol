...
abstract contract FxBaseChildTunnel is IFxMessageProcessor {
    ...
    event MessageSent(address indexed userAddress, bytes message);
     ...
     */
    function _sendMessageToRoot(address userAddress, bytes memory message) internal {
        emit MessageSent(userAddress, message);
    }
