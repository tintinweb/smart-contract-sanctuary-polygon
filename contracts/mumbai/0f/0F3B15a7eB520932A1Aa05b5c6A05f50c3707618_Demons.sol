...
contract Demons is Ownable, ERC165, ERC721 {
  ...
  constructor() ERC721("Devious Demon Dudes", "DEMON") {
    _setBaseURI("https://us-central1-demon-5183b.cloudfunctions.net/app/v1/");
  }
    ...
    returns (string memory)
  {
    ...
    if (bytes(folder).length > 0) {
      return string(abi.encodePacked(ipfsUri, folder, "/", tokenId.toString()));
    }
