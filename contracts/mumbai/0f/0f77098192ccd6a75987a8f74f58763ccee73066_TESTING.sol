...
contract TESTING is ERC721A, OperatorFilterer, Ownable, ReentrancyGuard {
    ...
    uint256 public teamMintLimit = 400;
    uint256 public frenslistMintCost = 0.005 ether;
    uint256 public publicMintCost = 0.007 ether;
    uint256 public maxFreeFrenslistMintLimit = 1;
    ...
    constructor(string memory _initBaseURI) ERC721A("TESTING", "TT") {
    ...
    modifier mintCompliance(uint256 _mintAmount) {
        require(balanceOf(msg.sender) < 5 - balanceOf(msg.sender), "You have already minted 5!");
    ...
    function frenslistMint(uint256 _mintAmount, bytes32[] calldata proof) public payable mintCompliance(_mintAmount) nonReentrant {
        ...
        if(balanceOf(_msgSender()) > 0) {
            ...
            require(msg.value >= (_mintAmount - 1) * frenslistMintCost, "Insufficient Funds2!");
        }
