...
contract Product020802 is Ownable {
    ...
    function createPolicy(PolicyParams memory policyParams) external onlyPartnerOrWakam(policyParams.hashedPartnershipCode) {
        ...
        policy.hashedPartnershipCode = policyParams.hashedPartnershipCode;
    ...
    function cancelPolicy(
        ...
        bool hasNoClaim
    ) external onlyPartnerOrWakam(allPolicies[onChainPolicyId].hashedPartnershipCode) {
...
abstract contract Ownable {
    ...
    mapping(bytes32 => mapping(address => bool)) private _partnerAddressesByHashedPartnershipCode;
    ...
    modifier onlyPartnerOrWakam(bytes32 hashedPartnershipCode) {
        require(
            _partnerAddressesByHashedPartnershipCode[hashedPartnershipCode][msg.sender] || wakamAddresses[msg.sender],
    ...
    function addPartnerAddress(address newPartnerAddress, bytes32 hashedPartnershipCode) external onlyWakam {
        _partnerAddressesByHashedPartnershipCode[hashedPartnershipCode][newPartnerAddress] = true;
    }

    function removePartnerAddress(address partnerAddressToRemove, bytes32 hashedPartnershipCode) external onlyWakam {
        _partnerAddressesByHashedPartnershipCode[hashedPartnershipCode][partnerAddressToRemove] = false;
    }
    ...
    function isPartnerAddress(address wakamAddressToCheck, bytes32 hashedPartnershipCode) external view returns (bool) {
        return _partnerAddressesByHashedPartnershipCode[hashedPartnershipCode][wakamAddressToCheck];
    }
}