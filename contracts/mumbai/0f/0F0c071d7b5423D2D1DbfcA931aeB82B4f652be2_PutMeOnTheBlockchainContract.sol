...
//
//  +-+-+-+ +-+-+ +-+-+ +-+-+-+ +-+-+-+-+-+-+-+-+-+-+
//  |P|u|t| |M|e| |O|n| |T|h|e| |B|l|o|c|k|c|h|a|i|n|
//  +-+-+-+ +-+-+ +-+-+ +-+-+-+ +-+-+-+-+-+-+-+-+-+-+
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x000000000000000000000000000000000000dEaD];
...
// File: contracts/PutMeOnTheBlockchainContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract PutMeOnTheBlockchainContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Put Me On The Blockchain";
    string public symbol = "PUTMEON";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/p0auGPt1Wwlkw8PJaYIc/contract-metadata";
  }
