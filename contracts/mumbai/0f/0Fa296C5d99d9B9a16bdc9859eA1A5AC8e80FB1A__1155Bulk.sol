 ...
 * @notice This contract handles minting 1155 bulk tokens.
 */
contract _1155Bulk is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xBEA92eAD791237ba0372e68D8Db3607520c4eF59;
    ...
    string public name = "1155 bulk";
    string public symbol = "1b";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeifbtyn2ysnk2kmjyqrwiachoefqfeavztdme6ujtauqxjuupx77ba/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenPublicMintsPerAddress[2] = 12;
        tokenPresaleMaxSupply[2] = 12;
