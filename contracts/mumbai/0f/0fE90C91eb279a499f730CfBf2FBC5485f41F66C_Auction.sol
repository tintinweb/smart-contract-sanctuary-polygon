...
contract Auction {
    ...
    function getInforOffer(string memory _indexId, string memory _subOfferId)
        public
        view
        returns (
            uint256,
        ...
        )
    {
        ...
        string memory _idcollection = collectionNFT.getTokenIdToCollectionId(
    ...
    function getInforListing(string memory _indexId)
        public
        view
        returns (
            string memory,
    ...
    function listingNFTFixedPrice(
        ...
        processEvent(arrayString, _tokenId, _requestId, "LIST_FIXED_PRICE");
    }
    ...
    function listingNFTAuction(
        ...
        processEvent(arrayString, _tokenId, _requestId, "LIST_AUCTION");
    }
    ...
    function buyFixPrice(
        ...
        string memory _listingId = stanNFT.getTokenToListing(_tokenId);
        require(
        ...
        processEvent(arrayString, _tokenId, _requestId, "BUY_NFT");
    }
    ...
    function makeOfferFixedPrice(
        ...
        processEvent(arrayString, _tokenId, _requestId, "MAKE_OFFER_WITH_NFT");
    }
    ...
    function reOffer(
        ...
        processEvent(arrayString, tokenId, _requestId, "RE_OFFER");
    }
    ...
    function acceptOfferPvP(
        ...
        processEvent(arrayString, tokenId, _requestId, "ACCEPT_OFFER_WITH_NFT");
    }
    ...
    function cancelOfferPvP(
        ...
        string[] memory arrayString = new string[](0);
        processEvent(arrayString, tokenId, _requestId, "CANCEL_OFFER_WITH_NFT");
    }
    ...
    function transferNFTPvP(
        ...
        processEvent(arrayString, _tokenId, _requestId, "TRANSFER_NFT_PVP");
    }
        ...
        checkValidAmout(_amount)
    {
        ...
        processEvent(arrayString, 0, _requestId, "DEPOSIT");
    }
    ...
    function withdraw(uint256 _amount, string memory _requestId) external {
        ...
        processEvent(arrayString, 0, _requestId, "WITHDRAW");
    }
        ...
        checkStateOfAution(_auctionId)
    {
        ...
        processEvent(arrayString, tokenId, _requestId, "FINISH_AUCTION");
    }
}
...
interface IStanNFT {
    ...
    function updateTokenToListing(string memory _listing, uint256 _tokenId)
        external;
