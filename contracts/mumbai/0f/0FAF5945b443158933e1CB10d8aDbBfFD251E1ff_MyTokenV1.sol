...
contract AntiSnipeV1 is OwnableUpgradeable {
    ...
    //     require(block.timestamp >= (block.timestamp + delay), "Function is locked for a certain time period");
    //     _;
    // }

    modifier antiMinimumTime() {
        require(
            block.timestamp >= (lastCall[msg.sender] + snipeLimit),
    ...
    function setSnipeLimit(uint256 _limit) external onlyOwner {
        snipeLimit = _limit;
    }
...
import "./AntiSnipe1.sol";
import "./IPlayToEarn.sol";
    ...
    IPlayToEarn
{
    ...
    modifier maxTokensWaletLimit(address to, uint amount) {
        require(
    ...
    modifier checkGas() {
        require(
            ...
            "Gas price exceeds the maximum allowed"
        );
        _;
    }
