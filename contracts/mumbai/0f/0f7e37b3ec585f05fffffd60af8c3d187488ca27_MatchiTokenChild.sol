...
contract NativeMetaTransaction is EIP712Base {
    ...
    function executeMetaTransaction(
        ...
        nonces_[userAddress] = nonces_[userAddress].add(1);
...
// File: contracts/child/ChildToken/MatchiTokenChild.sol
...
contract MatchiTokenChild is ERC777, Pausable, IChildToken, AccessControl, NativeMetaTransaction, ContextMixin, Votes {
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant DEPOSITOR_ROLE = keccak256("DEPOSITOR_ROLE");

    constructor(address childChainManager, address[] memory defaultOperators)
    ...
    function withdraw(uint256 amount) external {
        _burn(_msgSender(), amount, "Withdraw", "");
    }
