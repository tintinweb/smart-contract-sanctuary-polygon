...
contract AuctionPureV2 is Initializable {
    ...
    function listingNFTAuction(
        ...
        bool _isWhiteList,
        AuctionStructure.feeStanSystem calldata _feeStanSystem
        ...
        require(
            (paramStanFund.result &&
                paramStanFund.userStanFund >= _feeStanSystem.stanFee) ||
                _isWhiteList,
            "InvalidBalance"
        );
    ...
    function placeBidAuction(
        ...
        require(
            (paramStanFund.result &&
                ...
                (_amount + _feeStanSystem.stanFee)) || _isWhiteList,
            "InvalidBalance"
        );
        AuctionStructure.Listing memory listingInstance = listing
        ...
        if (!_isWhiteList)
            stanFund.set(
                (_reOffer(paramsReOffer) + _feeStanSystem.stanFee),
                AuctionStructure.Operator.MINUS,
                _maker
            );
    ...
    function _processFinishAuction(
        ...
        AuctionStructure.puchasing memory params = AuctionStructure.puchasing(
            ...
            infoInstance.maker,
            infoInstance.amount,
            feeStanSystem.ratioStanServiceFeeVal,
            feeStanSystem.ratioStanServiceFeeDenomination,
            infoInstance.tokenId,
            AuctionStructure.Method.AUCTION,
