...
contract FunctionsConsumer is FunctionsClient, ConfirmedOwner {
    ...
    * 1. Get access to chainlink functions for your EVM walet address on https://chainlinkcommunity.typeform.com/requestaccess
    ...
    *   i. Create new subscription with the wallet that you got approved in step-1
        ii. Fund the Subscription with LINK tokens
        iii. Add your deployed contract as consumer in the subscription
    * 6. For running a request execute the executeRequest() with appropriate parameters
    * 7. For running a request with View Name, call runRequestView() with appropriate parameters
    */
     ...
     *
     * @return decoded string value of latest response
     */
