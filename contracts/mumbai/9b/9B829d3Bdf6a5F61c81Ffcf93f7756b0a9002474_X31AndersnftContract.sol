    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 25, 13000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmfS3w1FQUEBJUvX8WWrtFkLm2B6D6NKBwJiyLnv7JghLk/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 13000");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 13000");
    ...
    function mintToMultipleERC20(address _to, uint256 _amount, address _erc20TokenContract) public payable {
      require(_amount >= 1, "Must mint at least 1 token");
      require(_amount <= maxBatchSize, "Cannot mint more than max mint per transaction");
      require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 13000");
      require(mintingOpen == true, "Minting is not open right now!");
...
// File: contracts/X31AndersnftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract X31AndersnftContract is RamppERC721A {
    constructor() RamppERC721A("31andersnft", "31n"){}
}
