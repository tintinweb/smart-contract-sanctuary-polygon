...
/**
 * @notice Represents CervejaVersoERC721 Smart Contract
 */
contract ICervejaVersoERC721 {
    /**
...
contract MintContract is Ownable {
     ...
     */
    ICervejaVersoERC721 public immutable nft;
    ...
    mapping(string => bool) private codeToMints;
    ...
    constructor(address _nftaddress) Ownable() {
        nft = ICervejaVersoERC721(_nftaddress);
    }
    ...
    function mint(
        ...
        bytes32 leaf = keccak256(abi.encodePacked(amount, code));
        require(MerkleProof.verify(proof, merkleRoot, leaf), "INVALID PROOF");

        /// @dev Verifies that user can mint based on the provided parameters.
        require(codeToMints[code] == false, "CODE ALREADY USED");
