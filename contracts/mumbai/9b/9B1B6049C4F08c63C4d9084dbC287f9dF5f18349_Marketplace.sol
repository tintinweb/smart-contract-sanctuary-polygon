...
contract Marketplace is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function _buyItem(
        ...
        IERC20(_payToken).safeTransferFrom(_msgSender(), _owner, price);
    ...
    function createOffer(
        ...
        offers[_nftAddress][_tokenId][_msgSender()] = Offer(IERC20(_payToken), _quantity, _pricePerItem, _deadline);
