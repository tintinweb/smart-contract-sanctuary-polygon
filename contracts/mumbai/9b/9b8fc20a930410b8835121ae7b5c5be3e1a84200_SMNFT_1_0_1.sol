...
// File: contracts/smnft_1_0_2.sol
...
contract SMNFT_1_0_1 is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    uint256 public finalMaxSupply = 10000; // maxSupply
    uint256 public maxMintAmount = 10; // maxMintAmount

    uint256 public currentMaxSupply = 20; // ***
    ...
    */
    ...
    /////
    constructor() ERC721("SMNFT", "NFT") {
        setBaseURI("ipfs://QmRKHdRdAQFedyE8QL4sNQ7ZVaRqvypQMp9PYuRGs64yxp/");
    }
    ...
    */
    ...
    function setFinalMaxSupply() public onlyOwner {
        if (totalSupply() == currentMaxSupply) {
            finalMaxSupply = currentMaxSupply * 2;
        }
    }
