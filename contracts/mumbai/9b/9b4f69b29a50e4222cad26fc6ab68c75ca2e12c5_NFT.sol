...
contract NFT is ERC721, Ownable {
        ...
        ERC721("NFT", "NFT")
    {
        ...
        // _totalMinted, _totalSupply are initialized to 1, since starting at 0 leads to higher gas cost for the first minter
    ...
    /**
     * @notice Return totalMinted
     * @return uint256
     */
    function totalMinted() public view returns (uint256) {
        return _totalMinted.current() - 1;
    }
     ...
     * @return _tokenId
     */
    function mint() public payable onlyOwner returns (uint256 _tokenId) {
        _tokenId = mintTo(_msgSender());
    }
