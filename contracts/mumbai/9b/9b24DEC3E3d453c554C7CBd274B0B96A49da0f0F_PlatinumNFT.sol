...
contract PlatinumNFT is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl, ERC721Burnable {
    ...
    constructor(uint256 maxSupply, uint256 maxMint, address _paperKeyManagerAddress) ERC721("PlatinumNFT", "PNFT") {
    ...
    returns (string memory)
    {
        ...
        } else if (totalSupply() + quantity > _maxSupply) {
