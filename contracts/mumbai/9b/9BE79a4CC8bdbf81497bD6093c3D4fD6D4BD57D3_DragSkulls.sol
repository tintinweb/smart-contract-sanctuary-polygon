...
contract DragSkulls is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://QmQr9TcSaQLMKLbcn28GPXtAafbausoCr1wuk8VRnF9c59/";
  ...
  constructor() ERC721("Drag Skulls", "DS") {
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x6a653AB38B86bCaFDf96d6e2aDfd1d1420A6F140).call{value: address(this).balance * 50 / 100}("");
    require(hs);
    // =============================================================================
