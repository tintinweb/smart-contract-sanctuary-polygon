...
contract Roles{
    ...
    function createPrivateSpatialData(string memory _title,string memory _description,string memory _fileURL,string memory _thumnailURL,string memory _imageURL,int32 _imageryDate,string memory _dataHash,string memory _country,string memory _state,string memory _district) public{
