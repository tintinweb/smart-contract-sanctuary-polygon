...
//*********************************************************************//
//
//     _______ __  _              _   ______________
//    / ____(_) /_(_)___ ___     / | / / ____/_  __/
//   / /_  / / __/ / __ `__ \   /  |/ / /_    / /   
//  / __/ / / /_/ / / / / / /  / /|  / __/   / /    
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xF302114F6be4eEE2C5d9dB0fe46e3d30449D6E7a];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xF302114F6be4eEE2C5d9dB0fe46e3d30449D6E7a;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeify3a4v7m2jrq7we5hycjpb7c3k6dq7xtxktflio2m72rbcsjifea/";
...
// File: contracts/FitimNftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract FitimNftContract is RamppERC721A {
    constructor() RamppERC721A("Fitim NFT", "FMTI"){}
}
