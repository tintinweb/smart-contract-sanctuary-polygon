...
//Deployed to mumbai at 0x9B4B1FB9a67759b05DfC5f2216723f24f837E78c
...
contract DynamicNFT is ERC721URIStorage {
    ...
    constructor () ERC721 ("Xaler's Dynamic NFT", "XALRAJ"){
    ...
    function generateCharacter(uint256 tokenId) public returns(string memory){
        ...
        bytes memory svg = abi.encodePacked(
            ...
            '<text x="50%" y="15%" class="base" dominant-baseline="middle" text-anchor="middle"><tspan class="nivel"> #', tokenId.toString(), '</tspan>',"  Friend's dynamic Collection",'</text>',
    ...
    function getTokenURI(uint256 tokenId) public returns (string memory){
        bytes memory dataURI = abi.encodePacked(
            '{',
                '"name": "Xaler`s Dynamic NFT #', tokenId.toString(), '",',
                '"description": "Dynamic NFT to train and increase your capabilities ",',
