...
contract Admin is Initializable, AccessControl, BasicMetaTransaction, ISafe {
    ...
    event BuyForwardContract(address instance, uint256 amount, address buyer,string forwardBuyID);
    ...
    function forwardBuy(
        ...
        emit BuyForwardContract(_forwardAddress, _tokenAmount, _buyer,forwardBuyID);
    }
    ...
    function forwardClaimLeftToken(address _forwardAddress,string memory _claimLeftTokenID) external {
        uint256 amount = IForward(_forwardAddress).tokenAvailable();
        IForward(_forwardAddress).claimLeftToken(_msgSender());
        emit ForwardClaimLeftToken(_forwardAddress, _msgSender(), amount,_claimLeftTokenID);
    }
