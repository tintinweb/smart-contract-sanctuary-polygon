...
contract Chat {
    ...
    constructor() {
        ...
        users[0xC399F96Fb4f190799b7E59C7Efba022F7AfDA378] = User("tina", "[email protected]", true,0xC399F96Fb4f190799b7E59C7Efba022F7AfDA378, false);
        userAddresses.push(0xC399F96Fb4f190799b7E59C7Efba022F7AfDA378);
        usersByName["tina"] = 0xC399F96Fb4f190799b7E59C7Efba022F7AfDA378;
  ...
  //--------------------------------------------------------------------------------------   
   ...
   require(walletAddress != address(0), "User with given address does not exist.");
    ...
    function sendMessage(address[] memory receivers, string calldata subject, string calldata message, bool isShareable) external {
        require(
