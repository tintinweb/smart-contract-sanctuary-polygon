...
contract Whitelist is AccessControl {
     ...
     */
    function addAddress(address _address) external onlyRole(SUPER_ADMIN) {
        require(
    ...
    function removeAddress(address _address) external onlyRole(SUPER_ADMIN) {
        require(
    ...
    Whitelist
{
    ...
    modifier onlyValidAddress(){
        require(msg.sender == forwarder || hasRole(SUPER_ADMIN, _msgSender()) ,"only owner can call this function");
        _;
    }

    function changeForwarder(address _newOwner) external onlyRole(SUPER_ADMIN) {
        forwarder = _newOwner;
    }
    /**
     ...
     */
    function resetTokenRoyalty(uint256 _tokenId) external onlyRole(SUPER_ADMIN) {
     ...
     */
    function deleteDefaultRoyalty() external onlyRole(SUPER_ADMIN) {
