...
contract DPSGameSettings is Ownable {
    ...
    constructor() {
        ...
        doubloonPerUpgradePart = 1e18;

        doubloonsPerSupportShipType[SUPPORT_SHIP_TYPE.SLOOP_STRENGTH] = 1e18;
        doubloonsPerSupportShipType[SUPPORT_SHIP_TYPE.SLOOP_LUCK] = 1e18;
        doubloonsPerSupportShipType[SUPPORT_SHIP_TYPE.SLOOP_NAVIGATION] = 1e18;

        doubloonsPerSupportShipType[SUPPORT_SHIP_TYPE.CARAVEL_STRENGTH] = 2 * 1e18;
        doubloonsPerSupportShipType[SUPPORT_SHIP_TYPE.CARAVEL_LUCK] = 2 * 1e18;
        doubloonsPerSupportShipType[SUPPORT_SHIP_TYPE.CARAVEL_NAVIGATION] = 2 * 1e18;

        doubloonsPerSupportShipType[SUPPORT_SHIP_TYPE.GALLEON_STRENGTH] = 3 * 1e18;
        doubloonsPerSupportShipType[SUPPORT_SHIP_TYPE.GALLEON_LUCK] = 3 * 1e18;
        doubloonsPerSupportShipType[SUPPORT_SHIP_TYPE.GALLEON_NAVIGATION] = 3 * 1e18;

        supportShipsSkillBoosts[SUPPORT_SHIP_TYPE.SLOOP_STRENGTH] = 30;
        supportShipsSkillBoosts[SUPPORT_SHIP_TYPE.SLOOP_LUCK] = 30;
        supportShipsSkillBoosts[SUPPORT_SHIP_TYPE.SLOOP_NAVIGATION] = 30;

        supportShipsSkillBoosts[SUPPORT_SHIP_TYPE.CARAVEL_STRENGTH] = 40;
        supportShipsSkillBoosts[SUPPORT_SHIP_TYPE.CARAVEL_LUCK] = 40;
        supportShipsSkillBoosts[SUPPORT_SHIP_TYPE.CARAVEL_NAVIGATION] = 40;
        ...
        artifactsSkillBoosts[ARTIFACT_TYPE.COMMON_STRENGTH] = 30;
        artifactsSkillBoosts[ARTIFACT_TYPE.COMMON_LUCK] = 30;
        artifactsSkillBoosts[ARTIFACT_TYPE.COMMON_NAVIGATION] = 30;

        artifactsSkillBoosts[ARTIFACT_TYPE.RARE_STRENGTH] = 40;
        artifactsSkillBoosts[ARTIFACT_TYPE.RARE_LUCK] = 40;
        artifactsSkillBoosts[ARTIFACT_TYPE.RARE_NAVIGATION] = 40;

        artifactsSkillBoosts[ARTIFACT_TYPE.EPIC_STRENGTH] = 50;
        artifactsSkillBoosts[ARTIFACT_TYPE.EPIC_LUCK] = 50;
        artifactsSkillBoosts[ARTIFACT_TYPE.EPIC_NAVIGATION] = 50;

        artifactsSkillBoosts[ARTIFACT_TYPE.LEGENDARY_STRENGTH] = 60;
        artifactsSkillBoosts[ARTIFACT_TYPE.LEGENDARY_LUCK] = 60;
        artifactsSkillBoosts[ARTIFACT_TYPE.LEGENDARY_NAVIGATION] = 60;
    }
