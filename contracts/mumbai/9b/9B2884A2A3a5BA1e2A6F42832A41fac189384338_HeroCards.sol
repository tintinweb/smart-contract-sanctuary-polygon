...
{
    /** @dev Initial Base Contract URI */
    string private TOKEN_URI;
    /** @dev Initial Contract URI */
    string private CONTRACT_URI;
    // Constant for Minter Role
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    // constant for Proxy Registry of Open Sea
    address proxyRegistryAddress;
    /**
     * @dev Event indicating a BASE URL change
    ...
    /**
     * @dev Implementation / Instance of paused methods() in the ERC721A.
     * @dev See {ERC721APausable}.
    ...
    /**
     * @dev Expose Equivalent to `_safeMint(to, quantity)`.
