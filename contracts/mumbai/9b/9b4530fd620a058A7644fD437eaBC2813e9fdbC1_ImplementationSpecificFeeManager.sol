...
contract ImplementationSpecificFeeManager is Ownable {
    ...
    {
        ImplementationFeeInfo memory feeInfo = implementationFeeInfos[msg.sender];
    ...
    function updateImplementaionFeesInfo(
        ...
        ImplementationFeeInfo storage feeInfo = implementationFeeInfos[_implementation];
    ...
    function getImplementationFeeInfo(address _implementation)
        external
        view
        returns (uint256 _feeAmount, address _feeToken)
    {
        ImplementationFeeInfo memory feeInfo = implementationFeeInfos[_implementation];
