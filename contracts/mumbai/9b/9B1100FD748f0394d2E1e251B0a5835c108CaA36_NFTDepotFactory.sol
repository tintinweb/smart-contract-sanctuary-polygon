...
contract NFTDepotFactory is Ownable {
    ...
    event NFTDeployed(address indexed _nft, string _name, string _symbol);
    ...
    function deployNFT(uint256 _index, string memory _name, string memory _symbol) public {
        require(nftTemplates[_index] != address(0), "Template does not exist");
        ...
        _nftTemplate.initialize(_name, _symbol);

        emit NFTDeployed(collection, _name, _symbol);
    }
...
contract ERC721Template is Initializable, ERC721Upgradeable, ERC721URIStorageUpgradeable, ERC721BurnableUpgradeable, OwnableUpgradeable {
