  ...
  UUPSUpgradeable 
{
    ...
    whenNotPaused
  {
    ...
    emit NewNFTContractDeployed(newContractAddr, msg.sender, contractID, keccak256(abi.encodePacked("ERC1155")), CUT_RECEIVER, keccak256(abi.encodePacked(collectionName)));
  }
