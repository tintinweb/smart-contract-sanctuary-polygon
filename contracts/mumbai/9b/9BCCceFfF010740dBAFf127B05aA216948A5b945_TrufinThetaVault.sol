...
contract TrufinThetaVault is TrufinVault, TrufinThetaVaultStorage {
    ...
    function commitAndClose() external nonReentrant {
        ...
        console.log("lockedAmountC1: ", vaultState.lockedAmount);
        //slither-disable-next-line reentrancy-no-eth, reentrancy-benign        
        _closeShort();
        console.log("lockedAmountC2: ", vaultState.lockedAmount);
        ...
        console.log("lockedAmountC3: ", vaultState.lockedAmount);
    }
...
.
    ...
    function _completeWithdraw() internal returns (uint256) {
        ...
        if (isAfterCommitAndClose && IMasterWhitelist(WHITELIST).isVaultWhitelisted(msg.sender)) {
