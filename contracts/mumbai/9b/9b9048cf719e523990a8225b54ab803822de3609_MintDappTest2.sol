...
contract MintDappTest2 is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxTotalSupply = 20; // количество нфт в вашей коллекции
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    require(supply + _mintAmount <= maxTotalSupply, "max NFT limit exceeded");
