...
import "./interfaces/IBolagetWave.sol";

contract BolagetWave is IBolagetWave, ERC721Enumerable, Ownable {
    using Strings for uint256;
    // Base Token URI
    ...
    constructor(uint256 _maxSupply) ERC721("BolagetWave", "BWAVE") {
