...
contract Factory {
    ...
    */
    ...
    function deployERC1155(string memory _contractName, string[] memory uris, bool[] memory tiers, uint[] memory amounts)
        public
        payable
        returns (address)
    {
        ...
        // create contract
        LeafContract t = new LeafContract(_contractName, msg.sender, marketplaceAddress);
        tokens.push(t);
    ...
    */
    ...
    //     emit ERC1155Minted(address(tokens[_index]), amount);
    // }
