...
contract Vault is VRFConsumerBaseV2 {
    ...
    uint256 public referralJackpot = 40000000;
    ...
    mapping(address => uint256) public userToBatch;
    mapping(uint256 => uint256) public gameToWinningBatch;
    ...
    function addMemberToPool(address _address, uint256 _referralCode) public {
        ...
        userToBatch[_address] = totalBatches;
    ...
    function fulfillRandomWords(
        ...
        gameToWinningBatch[gameId] = randomNumber;
