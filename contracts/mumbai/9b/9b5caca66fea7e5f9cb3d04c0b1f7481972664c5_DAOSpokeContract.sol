...
contract MetaHumanGovernor is Governor, GovernorSettings, CrossChainGovernorCountingSimple,
    ...
    */
    ...
    GovernorSettings(1 /* 1 block */, 5 /* 1 minute */, 0) //TODO:prod in production voting period needs to be changed to some reasonable value, right now it's 5 blocks for testing
