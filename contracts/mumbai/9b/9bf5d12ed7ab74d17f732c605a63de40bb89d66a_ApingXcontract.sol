...
// This contract is a sole property of APING X and all rights reserved .
 contract ApingXcontract is ERC721, Ownable {
    ...
    function _setTokenURI(uint256 tokenId, string memory _tokenURI, address _Address) internal virtual {
...
//Send price  in wei for _TokenPrice
    function mint(
       // address _to,
        ...
        _setTokenURI(_tokenId, tokenURI_, msg.sender);
...
function approve(uint256 _tokenId, address _from) internal virtual {
    ...
    function _checkexists(uint256 tokenId) public view returns(bool) {
        if(_exists(tokenId)){
           return true ;
        }
        else{
