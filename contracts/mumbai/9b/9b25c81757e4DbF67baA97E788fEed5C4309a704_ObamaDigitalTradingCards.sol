...
// File: contracts/Obama Digital Trading Cards.sol
...
contract ObamaDigitalTradingCards is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxSupply = 45000;
  uint256 public maxMintAmountPerTx = 50;

  bool public paused = false;
  bool public revealed = false;

  constructor() ERC721("Obama Digital Trading Cards", "ODTC") {
    setHiddenMetadataUri("ipfs://QmU5p5shfTWDGexEDNT3PKCULUpXK2CZVxTWjcHRFGotHV/hidden.json");
  }
