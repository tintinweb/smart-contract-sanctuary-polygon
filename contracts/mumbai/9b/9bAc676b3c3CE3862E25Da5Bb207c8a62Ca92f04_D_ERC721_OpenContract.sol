...
contract D_ERC721_OpenContract is Ownable, AccessControl, ERC721 {
     ...
     */
    event DynamicERC721Minted(address receiver, string uri, string backendTokenKey, uint256 tokenId);
    ...
    constructor(
        ...
        require(bytes(name_).length != 0, "D_ERC721_OpenContract: Incorrect name");
        require(bytes(symbol_).length != 0, "D_ERC721_OpenContract: Incorrect symbol");
        require(bytes(contractUri_).length != 0, "D_ERC721_OpenContract: Incorrect contract Uri");
    ...
    function mint(
        ...
        require(bytes(uri_).length != 0, "D_ERC721_OpenContract: Uri cannot be empty");
        require(_backendTokenKeyToId[backendTokenKey_] == 0, "D_ERC721_OpenContract: Mint need to be unique");
     ...
     */
    function changeNFT(string memory backendTokenKey_, string memory uri_) external onlyRole(DEFAULT_ADMIN_ROLE) {
        require(_backendTokenKeyToId[backendTokenKey_] != 0, "D_ERC721_OpenContract: No token exist with this name");
    ...
    function tokenURI(uint256 tokenId_) public view virtual override returns (string memory) {
        require(_exists(tokenId_), "D_ERC721_OpenContract: URI query for nonexistent token");
     ...
     */
    function tokenOwner(string memory backendTokenKey_) external view onlyRole(DEFAULT_ADMIN_ROLE) returns (address) {
        uint256 tokenId = _backendTokenKeyToId[backendTokenKey_];
     ...
     */
    function getTokenKeyId(string memory tokenKey_) external view returns (uint256) {
