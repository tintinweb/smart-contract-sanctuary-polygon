...
import "@layerzerolabs/solidity-examples/contracts/token/onft/extension/ONFT721A.sol";

contract LilPudgyONFT is ONFT721A {
    string public baseTokenURI;

    constructor(uint256 _minGasToTransfer, address _lzEndpoint) ONFT721A("LilPudgys", "LP",_minGasToTransfer, _lzEndpoint) {}

    function setBaseURI(string memory baseURI) public onlyOwner {
        baseTokenURI = baseURI;
    }
    
    function mintTokens(uint256 _quanity) public payable {
