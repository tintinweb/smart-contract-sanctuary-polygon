...
contract EIESTIEN {
    ...
    address internal TEAM_ADDRESS = 0xAA1E1Ea6E32888A67D37c87FCcd19B5414ac2398;
    ...
    mapping(address => uint256) internal freezesSinceLastSellCrop;
    ...
    function handleFreeze(bool postDeposit) private {
        ...
        freezesSinceLastSellCrop[msg.sender] = Math.add(
            freezesSinceLastSellCrop[msg.sender],
            1
        );
    ...
    function sellCrop() public {
        ...
        lastFreeze[msg.sender] = block.timestamp;
        freezesSinceLastSellCrop[msg.sender] = 0;
    ...
    function getConcurrentFreezes(address adr) public view returns (uint256) {
        return freezesSinceLastSellCrop[adr];
    }
