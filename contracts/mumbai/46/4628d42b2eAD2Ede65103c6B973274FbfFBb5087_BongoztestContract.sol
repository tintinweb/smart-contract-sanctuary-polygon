...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1673286900;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x406BF3bDbBA86624718C4423924a0923eca49f40];
  address public erc20Payable = 0x406BF3bDbBA86624718C4423924a0923eca49f40;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiga4cxrub4ou6oxh5e4klbgndyw25rytbzp42hykdn2nwoz3hhuhu/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/7qH6WWyorht1mhXWo3u6/contract-metadata";
  }
...
// File: contracts/BongoztestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BongoztestContract is RamppERC721A {
    constructor() RamppERC721A("Bongoz test", "Bongo"){}
}
