...
contract PosterFactory is ERC1155OnChainMetadata {
    ...
    function createPosterMetadata(
        uint256 _tokenId,
        string memory _name,
        string memory _description,
        string memory _imageUri
    ) internal {
        _setValue(_tokenId, key_token_name, abi.encode(_name));
        _setValue(_tokenId, key_token_description, abi.encode(_description));
        _setValue(_tokenId, key_token_image, abi.encode(_imageUri));
    }
    ...
    function createPoster(
        ...
        createPosterMetadata(id, _name, _description, _imageUri);
