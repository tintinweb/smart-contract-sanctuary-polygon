...
contract BGI_DAO is Ownable {   
    ...
    function valuateDAO(uint valNew) public onlyOwner {
        valCents = valNew;
    } // updates valuation of DAO assets

    function getDAOValue() public view returns (uint) {
        return valCents;
    ...
    function userWithdrawAllMoney(address user) public onlyOwner {
