...
contract DarkxFlipXfactory {
    ...
    function withdrawAssets(address tokenAddress, uint256 amount ) public {
        require(msg.sender == owner, "Only the owner can add tokens to the whitelist.");
    ...
    function getBalanceBase() public view returns (uint256) {
        return address(this).balance;
    }

    function withdrawBase(address payable _to) public {
