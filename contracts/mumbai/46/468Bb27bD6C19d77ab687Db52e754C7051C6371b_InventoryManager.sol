...
contract InventoryManager {
    ...
    function getTokenURI(string memory character, uint256 numberCard, string memory weapon, uint8 speed,  uint8 attack, uint8 defence, Status status) public view returns (string memory) {
