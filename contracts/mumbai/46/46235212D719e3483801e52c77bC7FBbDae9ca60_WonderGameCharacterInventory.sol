...
// File: contracts/WonderlandAccessControl.sol
...
abstract contract WonderlandAccessControl is AccessControl {
    ...
    modifier whenNotPaused {
        require(!isPaused, "Wonder Game Character Staking is paused");
        _;
    }
...
contract WonderGameCharacterInventory is ERC721, WonderlandAccessControl {
   ...
   function mintBatch(address _to, uint256[] memory _tokenIds,string[] memory _secondaryTokenUris, uint256 _generation) public {
    ...
    function mint(address _to,uint256 _tokenId,string memory _secondaryTokenUri,uint256 _generation)public {
    ...
    function setSecondaryTokenUri(uint256 _tokenId, string memory _tokenUri) public  {
