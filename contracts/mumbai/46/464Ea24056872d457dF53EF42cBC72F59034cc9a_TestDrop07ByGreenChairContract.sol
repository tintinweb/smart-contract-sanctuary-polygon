...
abstract contract Feeable is Teams, ProviderFees {
  uint256 public PRICE = 0.01000000000899992 ether;
    ...
    
{
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/TWuavJYNMGxV1TpFY9Cs/contract-metadata";
  }
...
// File: contracts/TestDrop07ByGreenChairContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TestDrop07ByGreenChairContract is ERC721APlus {
    constructor() ERC721APlus("Test Drop 07 by GreenChair", "GCTDRO7"){}
}
