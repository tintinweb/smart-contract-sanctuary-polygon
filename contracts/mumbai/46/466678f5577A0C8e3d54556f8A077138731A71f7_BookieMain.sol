...
contract BookieMain is IBookieMain, AccessHandler {
    ...
    ILockBox private feeLockBox; // Just used as an address
 ...
 */
     ...
     * @param _feeLockBox The fee LockBox contract address.
    ...
    function settleBet(bytes32 betHash) external override {
        ...
        console.log("Return to LP:", paidToLP.div(1 ether));
        console.log("Paid fee:", paidToFee.div(1 ether));
