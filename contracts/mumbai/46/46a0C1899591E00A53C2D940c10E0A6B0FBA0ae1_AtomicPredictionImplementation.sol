    ...
    ReentrancyGuardUpgradeable
{
    ...
    IERC20 public inputToken; // IERC20 input token address
    IERC20 public rewardToken; // IERC20 reward token address
    ...
    function betBear(
        ...
        if (isLiquidityManagerEnabled) {
            IERC20(inputToken).approve(liquidityManager, amount);
    ...
    function claimTreasury() external nonReentrant onlyAdmin {
        ...
        treasuryAmount = 0;
        inputToken.safeTransfer(adminAddress, currentTreasuryAmount);

        emit TreasuryClaim(currentTreasuryAmount);
    }

    function withdrawRewards(uint256 _amount) external nonReentrant onlyAdmin {
        rewardToken.safeTransfer(adminAddress, _amount);
    }
