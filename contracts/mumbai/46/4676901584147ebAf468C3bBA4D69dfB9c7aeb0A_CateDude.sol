...
contract CateDude is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Cate Dude", "CATDUDE") {
    setHiddenMetadataUri("ipfs://QmZhUHxUQjhiX8BQdaQFKu1otTgrM6zAK2zUjSVuLxfXFq/hidden.json");
  }
