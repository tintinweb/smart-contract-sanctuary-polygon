...
contract MarketSentiment {
    ...
    struct ticker {
        ...
        uint256 up;
        uint256 down;
        mapping(address => bool) Voters; //keep track of all pickers for this ticker
    }
    ...
    mapping(string => ticker) private Tickers; //prend une string et en fait un Ticker

    function addTicker(string memory _ticker) public {
        require(msg.sender == owner, "Only the owner can create tickers");
        ticker storage newTicker = Tickers[_ticker];
        newTicker.exists = true;
        tickersArray.push(_ticker); //add ticker to our array
    }
