    ...
    ERC20VotesUpgradeable
{
    ...
    function setPoolName(string memory _poolName)
        external
    ...
    function initLpTokenPrice(uint256 _initLpTokenPrice)
        external
        onlyRole(MANAGER_ROLE)
    {
    ...
    function updateStakedToken(address _tokenAddress)
        public
        onlyRole(MANAGER_ROLE)
    {
    ...
    function withdrawToTreasury(uint256 _withdrawalAmount)
        external
        onlyRole(MANAGER_ROLE)
    {
        ...
        require(
            ...
            "HOUSEPOOL:Withdrawal Amount is more than the allowed amount"
        );
        bool success = ILFIToken(STAKED_TOKEN).transfer(
            treasury,
            _withdrawalAmount
        ...
        require(
            success == true,
            "HOUSEPOOL: Treasury Withdrawal was not successful"
        );
