...
interface CryptoChimeraInterface is IERC721 {
    ...
    function tokensOfOwner(address owner, uint256 from_index) external view returns (uint256[] memory tokenIds);
    ...
    function transferForFactory(uint256 tokenId, address recipient) external;
...
interface CryptoChimeraFactoryInterface {
    event TaskInQueueAdded(uint8 taskTypeId, uint8 addedTasksBefore, uint8 currencyTypePayed, address indexed recipient, uint256 arg2, uint256 arg3);
