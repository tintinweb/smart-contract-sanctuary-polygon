...
import "./EvmPyrpose721CrossmintUSDCTokenStorage.sol";
import "@openzeppelin/contracts/access/Ownable.sol";
import "@openzeppelin/contracts/utils/Strings.sol";

contract EvmPyrpose721CrossmintUSDC is EvmPyrpose721CrossmintUSDCTokenStorage, Ownable {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        // If there is no specific URI for this token, return the base URI
...
contract EvmPyrpose721CrossmintUSDCTokenStorage is ERC721 {
    using Counters for Counters.Counter;
