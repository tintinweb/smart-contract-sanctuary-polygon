...
contract MmmContract is Ownable {
    ...
    function transferIn(address account, uint256 value) external {
    ...
    // GETMAVRO
    function GetMavro(address account, uint256 value) external onlyCaller {
    ...
    //  ENDHELP
    function EndHelp(address account, uint256 value) external onlyCaller {
        require(pusdt.balanceOf(account) >= value);
        pusdt.transferFrom(account, address(this), value);
    }

    //  PUTHELP
    function PutHelp(address account, uint256 value) external onlyCaller {
