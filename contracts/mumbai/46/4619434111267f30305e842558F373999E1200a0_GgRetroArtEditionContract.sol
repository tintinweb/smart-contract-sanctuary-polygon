...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x01d70Be9066d014884c8aDd3A8c1328F37460aF5];
  address public erc20Payable = 0x01d70Be9066d014884c8aDd3A8c1328F37460aF5;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 99, 999) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiay5wbej2halrmiitmisj7kyp6fq73of5uilncyk3f2uwyp5y6yui/";
    string public _baseTokenExtension = ".json";

    bool public mintingOpen = true;
    bool public isRevealed;
    
    uint256 public MAX_WALLET_MINTS = 99;
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/SoMKCUPkQlDgiJuDc4fr/contract-metadata";
  }
...
// File: contracts/GgRetroArtEditionContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GgRetroArtEditionContract is ERC721APlus {
    constructor() ERC721APlus("GG Retro Art Edition", "GGART"){}
}
