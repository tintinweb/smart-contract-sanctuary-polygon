...
/// @title: Tellie 1155 Creator Contract (inspired by manifold.xyz)
/// @author: tell.ie
...
contract Tellie1155Collection is ERC1155CreatorCore, BaseRelayRecipient, UUPSUpgradeable {
    ...
    function initialize(
        ...
        if (stewardWallet != address(0x0)) {
            // For managing the transfer of NFTs via Tellie's marketplace
            setApprovalForAll(stewardWallet, true);
            // For changing the base contract URI
            approveAdmin(stewardWallet);
            emit AdminApproved(stewardWallet, _msgSender());
        }
    }
