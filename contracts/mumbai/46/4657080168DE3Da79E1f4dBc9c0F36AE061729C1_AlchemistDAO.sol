...
contract AlchemistDAO {
     ...
     */
    function mic() public view returns (address) {
        return _mic;
    }
     ...
     */
    function alchemist() public view returns (address) {
        return _alchemist;
    }

    /**
     * @dev Returns the AlchemistBank address
     */
     ...
     */
    function totalWithdrawalOf() public view returns (uint256) {
    ...
    function withdraw (uint256 tokenId) public returns(uint256){
        ...
        uint256 totalAmount = __mic.balanceOf(_alchemistBank) + totalWithdrawal;
        ...
        require(__mic.balanceOf(_alchemistBank) + totalWithdrawal == totalAmount, 'Withdrawal failed');
     ...
     */
    function withdrawnOf(uint256 tokenId) public view returns(uint256){
        require(tokenId >= 1000 && tokenId <= 4000, 'TokenId out of range');
