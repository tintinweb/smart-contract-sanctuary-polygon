...
interface IMarketplace {
    ...
    function unlistNftFromMarketplace(uint listId) external returns(bool);
    function listNftToMarketplace(uint256 orderId, SaleType _type) external returns(uint256);
...
contract SwapContract is Ownable, ReentrancyGuard{
    ...
    */
    function cancelSwap(uint256 swapId) external {
        ...
        marketplace.unlistNftFromMarketplace(swapOrder[swapId].listId);
    ...
    */
    function swapToken(uint256 tokenId,
        ...
        listId = marketplace.listNftToMarketplace(swapId, IMarketplace.SaleType.Swap);
    ...
    */
    ...
    function _swapping(Offers storage off, Swap storage swapOriginal, uint256 offerId, uint256 swapId) internal {
        ...
        marketplace.unlistNftFromMarketplace(swapOriginal.listId);
