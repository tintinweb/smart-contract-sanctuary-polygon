    ...
    PausableUpgradeable
{
    ...
    /**
        @dev
        @param information [0] name, [1] symbol, [2] uri_
     */
    function initialize(string[] calldata information) public initializer {
        name = information[0];
        symbol = information[1];

        __ERC1155_init(information[2]);
        __Ownable_init();
        __Pausable_init();
    }
