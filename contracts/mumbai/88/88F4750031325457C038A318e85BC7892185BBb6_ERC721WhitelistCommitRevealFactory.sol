...
contract ERC721WhitelistCommitRevealFactory {
    event CreatedTemplateERC721WhitelistCommitReveal(address addr);
    function createTemplate(
        ...
        emit CreatedTemplateERC721WhitelistCommitReveal(address(clone));
    }
}