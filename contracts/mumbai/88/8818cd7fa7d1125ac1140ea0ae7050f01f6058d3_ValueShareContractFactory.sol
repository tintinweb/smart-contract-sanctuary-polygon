...
contract ValueShareContractFactory {
    ...
    function createValueShareContract() public {
        _createValueShareContract(_erc721FactoryAddress, _fixedExchangeAddress, _oceanAddress);
    }

    function _createValueShareContract(address erc721FactoryAddress, address fixedExchangeAddress, address oceanAddress) public {
