 ...
 * calls ERC20(Address 0x4A6901c365d8f1B1864bb5A7CD3F104Ce46E07E8)'s at transferFrom function  with variable sender as (the address that called this function), variable recipient as (the address of this contract), variable amount as _nosTokens
...
*/
	function sendInTokens(uint256 _nosTokens) public {
		...
		ERC20(address(0x4A6901c365d8f1B1864bb5A7CD3F104Ce46E07E8)).transferFrom(msg.sender, address(this), _nosTokens);
 ...
 * checks that (ERC20(Address 0x4A6901c365d8f1B1864bb5A7CD3F104Ce46E07E8)'s at balanceOf function  with variable recipient as (the address of this contract)) is greater than or equals to (nosCreditsPerToken with element _tokenId)
 * if (nosCreditsPerToken with element _tokenId) is strictly greater than 0 then (calls ERC20(Address 0x4A6901c365d8f1B1864bb5A7CD3F104Ce46E07E8)'s at transfer function  with variable recipient as (the address that called this function), variable amount as (nosCreditsPerToken with element _tokenId))
 * calls ERC20(Address 0xd875313ba1F7c7261FB2d2d4C2459fF69bfF12A7)'s at transferFrom function  with variable sender as (the address that called this function), variable recipient as (the address of this contract), variable amount as (((claimCoinPrice0) * (nosCreditsPerToken with element _tokenId)) / (10**18))
 * checks that (ERC20(Address 0xd875313ba1F7c7261FB2d2d4C2459fF69bfF12A7)'s at balanceOf function  with variable recipient as (the address of this contract)) is greater than or equals to (((((claimCoinPrice0) * (nosCreditsPerToken with element _tokenId)) / (10**18)) * (claimCoinPrice0SourceSplit0)) / (100))
 * if (((((claimCoinPrice0) * (nosCreditsPerToken with element _tokenId)) / (10**18)) * (claimCoinPrice0SourceSplit0)) / (100)) is strictly greater than 0 then (calls ERC20(Address 0xd875313ba1F7c7261FB2d2d4C2459fF69bfF12A7)'s at transfer function  with variable recipient as Address 0x82137f52C632043410Fcc95C17254CDaE1E93824, variable amount as (((((claimCoinPrice0) * (nosCreditsPerToken with element _tokenId)) / (10**18)) * (claimCoinPrice0SourceSplit0)) / (100)))
...
*/
	function claim(uint256 _tokenId) public {
		...
		require((ERC20(address(0x4A6901c365d8f1B1864bb5A7CD3F104Ce46E07E8)).balanceOf(address(this)) >= nosCreditsPerToken[_tokenId]), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		if ((nosCreditsPerToken[_tokenId] > uint256(0))){
			ERC20(address(0x4A6901c365d8f1B1864bb5A7CD3F104Ce46E07E8)).transfer(msg.sender, nosCreditsPerToken[_tokenId]);
		}
		ERC20(address(0xd875313ba1F7c7261FB2d2d4C2459fF69bfF12A7)).transferFrom(msg.sender, address(this), ((claimCoinPrice0 * nosCreditsPerToken[_tokenId]) / uint256(10**18)));
		...
		if ((((((claimCoinPrice0 * nosCreditsPerToken[_tokenId]) / uint256(10**18)) * claimCoinPrice0SourceSplit0) / uint256(100)) > uint256(0))){
			ERC20(address(0xd875313ba1F7c7261FB2d2d4C2459fF69bfF12A7)).transfer(address(0x82137f52C632043410Fcc95C17254CDaE1E93824), ((((claimCoinPrice0 * nosCreditsPerToken[_tokenId]) / uint256(10**18)) * claimCoinPrice0SourceSplit0) / uint256(100)));
		}
 ...
 * checks that (ERC20(Address 0x4A6901c365d8f1B1864bb5A7CD3F104Ce46E07E8)'s at balanceOf function  with variable recipient as (the address of this contract)) is greater than or equals to totalToDrain
 * if totalToDrain is strictly greater than 0 then (calls ERC20(Address 0x4A6901c365d8f1B1864bb5A7CD3F104Ce46E07E8)'s at transfer function  with variable recipient as (the address that called this function), variable amount as totalToDrain)
*/
	function drain() public onlyOwner {
		...
		require((ERC20(address(0x4A6901c365d8f1B1864bb5A7CD3F104Ce46E07E8)).balanceOf(address(this)) >= totalToDrain), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		if ((totalToDrain > uint256(0))){
			ERC20(address(0x4A6901c365d8f1B1864bb5A7CD3F104Ce46E07E8)).transfer(msg.sender, totalToDrain);
		}
	}
 ...
 * The function takes in 0 variables. It can be called by functions both inside and outside of this contract. It does the following :
 * checks that the function is called by the owner of the contract
 * checks that (ERC20(Address 0xd875313ba1F7c7261FB2d2d4C2459fF69bfF12A7)'s at balanceOf function  with variable recipient as (the address of this contract)) is greater than or equals to claimCoinPrice0SourceAmtInBank
 * if claimCoinPrice0SourceAmtInBank is strictly greater than 0 then (calls ERC20(Address 0xd875313ba1F7c7261FB2d2d4C2459fF69bfF12A7)'s at transfer function  with variable recipient as (the address that called this function), variable amount as claimCoinPrice0SourceAmtInBank)
 * updates claimCoinPrice0SourceAmtInBank as 0
*/
	function claimCoinPrice0SourceTaxWithdrawAmt() public onlyOwner {
		require((ERC20(address(0xd875313ba1F7c7261FB2d2d4C2459fF69bfF12A7)).balanceOf(address(this)) >= claimCoinPrice0SourceAmtInBank), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		if ((claimCoinPrice0SourceAmtInBank > uint256(0))){
			ERC20(address(0xd875313ba1F7c7261FB2d2d4C2459fF69bfF12A7)).transfer(msg.sender, claimCoinPrice0SourceAmtInBank);
		}
