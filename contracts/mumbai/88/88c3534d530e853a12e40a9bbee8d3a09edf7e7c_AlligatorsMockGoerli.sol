...
contract Alligators is
    ...
    */
    ...
    function createMerged(uint8[] memory anatomy_, uint8[] memory lvls_) internal {
        _anatomy[_currentIndex] = NFTAnatomy(
            {
                trait1: Trait1(anatomy_[0]), 
                trait2: Trait2(anatomy_[1]),
                trait3: Trait3(anatomy_[2]),
                trait4: Trait4(anatomy_[3]),
                trait5: Trait5(anatomy_[4]),
                trait6: Trait6(anatomy_[5]),
                trait7: Trait7(anatomy_[6])
            });
            _lvl[_currentIndex] = NFTLevel(
                {
                    trait1Lvl: lvls_[0],
