...
contract Messenger {
    ...
    function sendPublicMessage(string memory _text) external canSendMessage(msg.sender) {
        ...
        emit PublicMessageSent(msg.sender, _text);
    }

    function sendPrivateMessage(address _recipient, string memory _text) external canSendMessage(msg.sender) {
