...
contract OrderFiller is Initializable {
    ...
    event OrderFilled(
        ...
        uint128[] makerTokenFilledAmounts,
    ...
    struct OrderInfo {
        ...
        uint128[] MakerTokenAmountFilled;
        uint128 _takerFill;
        uint128 _makerFill;
    }
    ...
    function fillBuyOrder(
        ...
        info.MakerTokenAmountFilled = new uint128[](info.makerOrdersToFill);
        ...
        for (uint256 i = 0; i <= info.makerOrdersToFill - 1; i++) {
            ...
            info.MakerTokenAmountFilled[i] = info._makerFill;
        }

        // Fill talent token orders
        takerOrder.takerToken.approve(exchangeProxyAddress, takerOrder.makerAmount);
        // For every order submitted
        ...
        info.MakerTokenAmountFilled,
        info.makerFill
    );
        return (info.MakerTokenAmountFilled, info.makerFill);
    }
    ...
    function fillSellOrder(
        ...
        return (info.MakerTokenAmountFilled, takerTakerFillAmount);
    }
