...
// File: contracts/EpixMonkeyz.sol
...
contract NFT is ERC721, Ownable {
    ...
    uint public constant MAX_TOKENS = 10001;
    uint private constant TOKENS_RESERVED = 1;
    uint public price = 2000000000000000;
    ...
    constructor() ERC721("Epix Monkeyz", "EMZ") {
        baseUri = "ipfs://bafybeidvxkcfsclqg2m3spqjm3m4t4eujxydqqn675xrp2lashs2txwlnm/";
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0x752331bE31C4e07a5D6DE1E62866D835f610825C).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0x752331bE31C4e07a5D6DE1E62866D835f610825C).call{value: balanceTwo}("");
