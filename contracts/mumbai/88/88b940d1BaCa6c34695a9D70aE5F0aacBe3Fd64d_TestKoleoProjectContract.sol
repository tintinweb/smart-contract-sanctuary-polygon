...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmPKZwRUenwtLbnojPhPFenATfXCmW6M4ZDHdFr5RjdqZg/";
...
// File: contracts/TestKoleoProjectContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TestKoleoProjectContract is RamppERC721A {
    constructor() RamppERC721A("Test Koleo Project", "TKP"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/EOrNlXKPBi7VR5uAReMi/contract-metadata";
    }
}
