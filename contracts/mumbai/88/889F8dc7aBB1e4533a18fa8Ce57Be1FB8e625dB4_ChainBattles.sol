...
// Deployed to Polygon Mumbai: 0x889F8dc7aBB1e4533a18fa8Ce57Be1FB8e625dB4
...
contract ChainBattles is ERC721URIStorage {
        ...
        returns (string memory)
    {
        bytes memory svg = abi.encodePacked(
            ...
            "Level: ",
            tokenIdToAttributes[_tokenId].level.toString(),
            "</text>",
    ...
    function train(uint256 _tokenId) public {
        ...
        uint256 newLevel = tokenIdToAttributes[_tokenId].level + 1;
