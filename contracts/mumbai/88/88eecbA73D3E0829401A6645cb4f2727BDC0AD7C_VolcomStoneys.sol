...
contract VolcomStoneys is PunchableERC721{

    uint16 maxStoneys = 1991;

    constructor(uint _reservedIDs, string memory name, string memory symbol) PunchableERC721(_reservedIDs, maxStoneys, name, symbol){}
}
...
contract PunchableERC721 is ERC721WhiteListMint{
    ...
    constructor(uint _reservedIDs,  uint16 _maxSupply, string memory name, string memory symbol) ERC721WhiteListMint(_reservedIDs, _maxSupply, name, symbol){}
 ...
 *****************************************************************************************/
  ...
  constructor(uint _reservedIDs, uint16 _maxSupply, string memory name, string memory symbol) SDKERC721(_reservedIDs, name, symbol){
