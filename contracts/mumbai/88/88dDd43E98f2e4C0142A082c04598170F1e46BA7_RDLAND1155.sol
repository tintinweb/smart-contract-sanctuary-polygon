...
contract RDLAND1155 is ERC1155 {
    IRDLANDWhitelistInterface rdlandWhitelist;
    ...
    constructor(
        ...
        owner = msg.sender;
        newTokenId = 1;
        rdlandWhitelist = IRDLANDWhitelistInterface(whitelistAddress);
    ...
    modifier isWhitelisted(address _accountAddress) {
        require(
            rdlandWhitelist.isWhitelisted(_accountAddress),
    ...
    */
    ...
    function mint(
        ...
        _mint(newTokenId, supply, uri, fee);
