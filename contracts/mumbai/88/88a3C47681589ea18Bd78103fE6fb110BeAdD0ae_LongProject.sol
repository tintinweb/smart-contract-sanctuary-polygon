...
contract LongProject is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
    uint256 public MAX_SUPPLY = 12;

    
    uint256 public TEST_SUPPLY = 11;
    
    bool public IS_TEST_ACTIVE = false;

    
    uint256 public TEST_TX_LIMIT = 2;

    
    uint256 public TEST_WALLET_LIMIT = 5;

    
    uint256 public TEST_PRICE = 0 ether;
    ...
    mapping(address => uint) public TEST_Minted;

    bool public _revealed = false;

    string private baseURI = "";
    string private preRevealURI = "https://ipfs.w3bmint.xyz/ipfs/QmdqWm7z643gMcBXJBH22an3Gf6UDoZVLDCmbLNWCMuMe5";

    mapping(address => uint256) addressBlockBought;

    address public constant RL_ADDRESS = 0xc9b5553910bA47719e0202fF9F617B8BE06b3A09; 

    constructor() ERC721A("LongProject", "TEST") {
        
        
        _safeMint(0x88e8FEdbA48f186392F4AB52D056c83A2F86Fc6F, 1);
    }
    ...
    function TESTMint(uint256 numberOfTokens) external isSecured(TEST_PRICE * numberOfTokens) payable {
        validateMint(IS_TEST_ACTIVE, TEST_COUNT, TEST_SUPPLY, TEST_Minted[msg.sender], TEST_WALLET_LIMIT, TEST_TX_LIMIT, numberOfTokens, true);
        addressBlockBought[msg.sender] = block.timestamp;
        TEST_Minted[msg.sender] += numberOfTokens;
    ...
    function withdraw() external onlyOwner {
        ...
        (bool successFinal, ) = payable(0x88e8FEdbA48f186392F4AB52D056c83A2F86Fc6F).call{ value: address(this).balance }("");
