...
import "./HeftyverseUser721Token.sol";
...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new HeftyverseUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        HeftyverseUser721Token token = HeftyverseUser721Token(address(addr));
...
contract HeftyverseUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
