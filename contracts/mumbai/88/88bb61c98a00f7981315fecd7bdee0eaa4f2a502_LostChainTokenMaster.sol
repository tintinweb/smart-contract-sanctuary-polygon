    ...
    UUPSUpgradeable
{
    ...
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor(LostChainForwarder forwarder) ERC2771ContextUpgradeable(address(forwarder)) {
        _disableInitializers();
    }

    function initialize(address rbaLinkerAddress) public initializer {
        require(rbaLinkerAddress != address(0x0), 'LCTM: RBA linker is zero address');
    ...
    function TESTING10() external pure returns (bool) {
        return true;
    }
}