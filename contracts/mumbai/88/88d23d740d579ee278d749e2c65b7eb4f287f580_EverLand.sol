...
contract EverLand is ERC721Enumerable, Ownable {
  ...
  address private PGAIAA = 0xa8b062dE9dB7D22D6Ad6ef64Dc6FE53B3cba4A80;

  uint256 private m_EpicPrice = 350; // $350
  uint256 private m_RegularPrice = 175; // $175

  bytes32 private m_MerkleRoot = 0x10ecb9d889e1598909eb7612b970271ba6aacdc8f4342c9faf48c4ae9deb3f69;

  uint256 private m_Reserve = 50000;

  bool private m_IsMintable = true;
  bool private m_IsPublic = true;
  bool private m_IsActive = true;
  ...
  constructor() ERC721('TEever', 'TEEVER') {
  ...
  function mint(
    ...
    require(_landType == 1 || _landType == 0);
    require(_landSize >= 0 && _landSize < 5);
    uint256 gaiaUSDC = (((79357452196816930849001 * (10**18)) / uint256(1868548345305467327315244)) * 1588085682360 * (10**12)) / uint256(1586020149070416559561266);
