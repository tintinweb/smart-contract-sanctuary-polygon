...
contract CustomContract is Pausable, AccessControl, ReentrancyGuard {
    ...
    /**
     * @notice Check if target avatar has the same avatar type with another one
     * @param _targetAvatarType represents the id of an avatar
     * @param _currentAvatarType represents the id of an avatar
     */
