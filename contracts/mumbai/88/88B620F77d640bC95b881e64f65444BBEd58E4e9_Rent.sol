...
contract Rent is ERC721URIStorage, Ownable{
  ...
  struct PropertyData{
    ...
    uint64 pricePerSecond; // (price/ 30 days) Can be changed, if there is a specific conflict resolution route;
    uint32 endRentDate;
  }
  ...
  function newRent(uint id, uint cantOfMonths) public {
    ...
    property.pricePerSecond = uint32(property.price / 30 days);
