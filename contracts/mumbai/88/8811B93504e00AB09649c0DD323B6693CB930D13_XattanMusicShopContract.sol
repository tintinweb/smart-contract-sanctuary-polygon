...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0xb93c577157b11cec46f50E4520057315aC72e71F];
...
// File: contracts/XattanMusicShopContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract XattanMusicShopContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "XATTAN Music Shop";
    string public symbol = "CMRXMs";
  ...
  */
  function mintToMultiple(address _to, uint256 _id, uint256 _qty) public payable whenNotPaused {
    ...
    **/
    function redeem(uint256 tokenId, address redemptionContract, uint256 ftokenId) public payable {
        ...
        if(msg.value != (details.redemptionSurcharge[redemptionContract] + PROVIDER_FEE)) revert InvalidPayment();
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/0bnp9JwEwtEUi1rw3Lrl/contract-metadata";
  }
