...
contract nftcx is Ownable {
    ...
    function upgradeToGold(uint256 _swapOutAmount) external {
        ...
        if (swapConfig.useAutoSwap) {
            ...
            swapConfig.routerAddress.swapExactTokensForTokensSupportingFeeOnTransferTokens(swapConfig.swapInAmount, _swapOutAmount.mul(uint256(100).sub(swapConfig.slippage).div(100)), _swapPath, _user, block.timestamp);
        }
