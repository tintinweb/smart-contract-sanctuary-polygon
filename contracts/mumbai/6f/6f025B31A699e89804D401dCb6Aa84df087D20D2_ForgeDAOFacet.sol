...
import "../libraries/ForgeLibDiamond.sol";
...
contract ForgeDAOFacet is Modifiers {
    ...
    function setDiamonds(address _aavegotchiDiamond, address _wearableDiamond) external {
        ForgeLibDiamond.setDiamonds(_aavegotchiDiamond, _wearableDiamond);
    }
...
library ForgeLibDiamond {
    ...
    function setDiamonds(address _aavegotchiDiamond, address _wearableDiamond) internal {
        DiamondStorage storage ds = diamondStorage();
