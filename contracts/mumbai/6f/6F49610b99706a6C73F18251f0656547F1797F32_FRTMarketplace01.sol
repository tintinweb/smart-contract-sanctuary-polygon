...
contract FRTMarketplace01 is AccessControl{
    ...
    */
     ...
     *
     */
    function downloadNFTForTesting(uint256 _tokenId) public{
    ...
    /**  
     * @dev Returns if contract is approved to transfer NFTs or not.
     *
     * @param _tokenId uint256, Module/NFT ID  
     *
     * @return bool
