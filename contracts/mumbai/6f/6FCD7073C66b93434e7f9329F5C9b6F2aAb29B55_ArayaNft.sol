...
// File contracts/common/ERC1155/IERC1155Metadata.sol
...
// File contracts/common/ERC1155/IERC1155MetadataURI.sol
...
// File contracts/common/libraries/Address.sol
...
// File contracts/common/ERC1155/ERC1155.sol
...
// File contracts/common/OpenSeaCompatible.sol
...
contract ArayaNft is ERC1155, AccessControl, OpenSeaCompatible, NativeMetaTransaction, ContextMixin
{
    ...
    constructor() ERC1155("Araya NFT", "ARAYANFT", "uri") {
        _initializeEIP712("Araya");
        _setRoleAdmin(MINTER_ROLE, ROOT_ROLE);
        _setRoleAdmin(BRIDGER_ROLE, ROOT_ROLE);
        setMintingLimit(1, 1000);
        setMintingLimit(2, 1000);
        setMintingLimit(3, 1000);
    }
    ...
    */
    function initialMint(address account, uint256 id, uint256 amount, bytes calldata data) public {
    ...
    */
    function setMintingLimit(uint256 id, uint256 limit) public {
