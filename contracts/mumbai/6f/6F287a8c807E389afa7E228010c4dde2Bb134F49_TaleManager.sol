...
contract TaleContract {
    ...
    mapping(uint256 => address) public _chapterNumberToAddress;
    ...
    function dropNewChapter(
        ...
        _chapterNumberToAddress[chapterCount] = address(chapterContract);
    ...
    ///@notice get chapter by address
    function getChapterAddressByNumber(uint256 _num)
        public
        view
        returns (address)
    {
        return _chapterNumberToAddress[_num];
    }
    ...
    ///@notice get the tale name
    function getTaleName() public view returns (string memory) {
        return taleName;
    }
...
contract ChapterContract {
    ...
    address public authorAddress;
    ///@notice the chapter image cover
    string public chapterImageCover;
    ...
    constructor(
        ...
        description = _description;
        chapterImageCover = _chapterImageURI;
    }
    ...
    ///@notice gets the chapter description
    function getChapterDescription() public view returns (string memory) {
        return description;
    }

    ///@notice gets the chapter image cover
    function getChapterImageCover() public view returns (string memory) {
        return chapterImageCover;
    }
}
