...
contract CoinageBridge is Context, Ownable {
    ...
    string private _symbol = "CAGE Bridge";

    event Crossed(address indexed sender, address indexed tokenAddress, uint256 value, uint256 chainId);

    constructor() {
        changeTollOperator(0xCABc1207E4D78830b9DF3f5D69598794380D518D);
    }
    ...
    function cross(
        ...
        emit Crossed(_msgSender(), tokenAddress, amount, chainId);
    }
