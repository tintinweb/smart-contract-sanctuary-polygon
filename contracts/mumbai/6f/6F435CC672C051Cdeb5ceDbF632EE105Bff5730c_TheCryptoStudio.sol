...
contract TheCryptoStudio is ERC1155
{
    ...
    string private constant SPACE_ARTISTS_SCHEMA = "spaceName text, space_artist text";
    ...
    function socialSpaceCreation(string memory spaceName , string memory space_group , string memory imageCID) public payable{
        ...
        string memory addArtist = SQLHelpers.spaceArtistInsertion(SPACE_ARTISTS_TABLE_PREFIX, space_artists_tableID, spaceName, Strings.toHexString(msg.sender));
    ...
    function addSpaceArtist(string memory spaceName, address artist) public {
        ...
        string memory addArtist = SQLHelpers.spaceArtistInsertion(SPACE_ARTISTS_TABLE_PREFIX, space_artists_tableID, spaceName, Strings.toHexString(artist));
        runSQL(space_artists_tableID,addArtist);
    }
    ...
    function deleteSpaceArtist(string memory spaceName, address artist) public {
        ...
        string memory filters = string.concat("space_artist=",Strings.toHexString(artist)," and ","spaceName='",spaceName,"'");
...
library SQLHelpers {
    ...
    function spaceArtistInsertion(string memory SPACE_ARTISTS_TABLE_PREFIX, uint256 space_artists_tableID, string memory  spaceName , string memory artist) internal view returns(string memory){
        return toInsert(
            SPACE_ARTISTS_TABLE_PREFIX,
            space_artists_tableID,
            "spaceName, space_artist",
            string.concat(
                quote(spaceName),
                ",",
                quote(artist)
