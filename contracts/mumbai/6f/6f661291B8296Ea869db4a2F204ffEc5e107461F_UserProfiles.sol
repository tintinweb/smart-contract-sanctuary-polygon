...
contract UserProfiles {
    ...
    constructor(address _kutils, uint256 _maxURILength, uint256 _maxBioLength, uint256 _maxFollowing, uint256 _networkID) {
    ...
    */
    ...
    function setNFTAsAvatar(address _nftContract, uint256 tokenId, uint256 groupID) public {
    ...
    function setAvatar(address profileAddress, string calldata imageURI, address _nftContract, uint256 tokenId, string memory metadata, uint256 _networkID) public onlyApproved {
        // Save image URI
