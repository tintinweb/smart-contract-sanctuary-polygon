...
contract GetHiiTest7 is ERC721, ERC721Enumerable, Pausable, Ownable {
    ...
    constructor() ERC721("Get Hii Test 7", "Hi!") {}
    ...
    returns(uint256) {
        ...
        else if (tokenId >= 11 && tokenId <= 100) {
            price = basePrice * 10;
        }
        else if (tokenId >= 111 && tokenId <= 1000) {
            price = basePrice * 100;
        }
        else {
