...
contract MmmContract is Ownable {
    ...
    // GETMAVRO
    function BuyMavro(address account, uint256 value) external {
    ...
    //  GETHELP
    function PutHelp(address account, uint256 value) external {
        uint vTotal;
        uint vOnes;
        uint vTwos;
        uint vThrs;
    ...
    //  ENDHELP
    function EndHelp(address account, uint256 value) external {
        require(pusdt.balanceOf(account) >= value);
        pusdt.transfer(address(this), value);
    }
