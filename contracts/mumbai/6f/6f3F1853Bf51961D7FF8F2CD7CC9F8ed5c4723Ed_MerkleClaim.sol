...
contract MerkleClaim is Ownable {
  ...
  function hasClaimed(address to) public view returns (bool){
    return _hasClaimed[merkleVersion][to];
  }
  ...
  function claim(address to, uint256 amount, bytes32[] calldata proof) external {
    ...
    if (_hasClaimed[merkleVersion][to]) revert AlreadyClaimed();
    ...
    _hasClaimed[merkleVersion][to] = true;
