...
// File: contracts/NFTMarketUpgradeable.sol
    ...
    PausableUpgradeable
{
    ...
    function updateListingPrice(uint256 _listingPrice) public payable nonReentrant onlyOwner {
    ...
    function createToken(string memory NftURI, uint256 price) public payable returns (uint256) {
        _tokenIds.increment();
