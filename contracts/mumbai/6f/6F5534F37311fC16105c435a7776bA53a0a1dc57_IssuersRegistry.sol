...
contract IssuersRegistry is AccessControl, IRegistry {
    ...
    struct Issuer {
        ...
        address issuer;
        string name;
        // public key used to encrypt data if need to send some data to the issuer or verify its signature
        bytes publicKey;
        // Map of subjects the Issuer is authorized to issue
        // to the dateTime it was granted
        string[] subjects;
        // Date/time (seconds from 1970) from which the Issuer Registry was suspended and all credentials after will be invalid
