...
contract MockVotes is ERC721, ERC721Votes {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721('MockVotes', 'NFT') EIP712('MockVotes', '1') {}
...
contract NFTFactory {
    function newNFT() public returns (address) {
        MockVotes nft = new MockVotes();
