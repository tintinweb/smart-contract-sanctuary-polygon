...
contract CrocoKingLegendaryMinter is Ownable {
  ...
  uint8 public maxPerUser = 3;

  IERC721_ public nftContract;
  ...
  function updateNftContrcat(IERC721_ _newAddress) public onlyOwner {
    nftContract = IERC721_(_newAddress);
  }
