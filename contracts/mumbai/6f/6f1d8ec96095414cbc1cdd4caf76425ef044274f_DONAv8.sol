...
contract DONAv8 is IToken, Ownable {
    ...
    string private constant _name = "DONASWAP VERSION 8";
    string private constant _symbol = "DONAv8";
    ...
    // Recieve native coins from active router when swapping
