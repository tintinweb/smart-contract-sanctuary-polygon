...
contract ThriEstates {
    ...
    address constant public RealEstateNFTAddress = 0x8Fee4cEf96fc5F85260E4512E9Fd2441849953C1;
    address constant public MarketPlaceAddress = 0xe21bBC525B7F580bC1102b19dE2fE2735480Fc40;
    address constant public DocumentAddress = 0xAf351e6F382CEb02fb322adA580FB09760e36dd8;

    function listProperty(string memory _estateURI, string memory _documentURI, uint256 _cost) public {
        uint256 estateID = RealEstateNFT(RealEstateNFTAddress).createEstate(_estateURI, msg.sender);
        Document(DocumentAddress).uploadEstateDocument(estateID, _documentURI, msg.sender);
        Marketplace(MarketPlaceAddress).listEstate(estateID, _cost, msg.sender);
    }
