...
contract FactoryERC1155 {
    ...
    */
    ...
    function isMinter(uint _index, address sender) public view returns (bool){ 
    
    	return (tokens[_index].isMinter(sender));
    }
    ...
    */
    ...
    function getNextIdToMint(uint256 _index) public view returns (uint id) { 
    
    	return tokens[_index].getNextIdToMint(indexToOwner[_index]);
    }
...
contract ERC1155Token is ERC1155, Ownable {
    ...
    */
    ...
    function getNextIdToMint(address owner ) public view returns (uint amount) { 
