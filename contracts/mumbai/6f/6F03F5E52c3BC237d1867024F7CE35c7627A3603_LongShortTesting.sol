...
contract LongShortTesting is LongShort {
  ...
  function SEPARATE_MARKET_CONTRACT_INDEX_START() internal pure override returns (uint256) {
    return 4;
  }
}
...
contract LongShort is ILongShort, AccessControlledAndUpgradeable {
  ...
  mapping(uint32 => Market) separateMarketContracts;
  ...
  function registerMarketContract(
    string calldata syntheticName,
    string calldata syntheticSymbol,
    ...
    require(
      ...
      "registering and seeding market failed"
    );
    separateMarketContracts[marketIndex] = marketContract;
  ...
  */
    ...
    requireMarketExists(marketIndex)
  {
    if (marketIndex < SEPARATE_MARKET_CONTRACT_INDEX_START()) {
      ...
      separateMarketContracts[marketIndex].updateSystemState();
    }
  }
  ...
  function mintLongNextPrice(uint32 marketIndex, uint256 amount) external override {
    if (marketIndex < SEPARATE_MARKET_CONTRACT_INDEX_START()) {
      ...
      separateMarketContracts[marketIndex].mintNextPriceFor(amount, msg.sender, true);
    }
  }
  ...
  function mintShortNextPrice(uint32 marketIndex, uint256 amount) external override {
    if (marketIndex < SEPARATE_MARKET_CONTRACT_INDEX_START()) {
      ...
      separateMarketContracts[marketIndex].mintNextPriceFor(amount, msg.sender, false);
    }
  }
  ...
  function redeemLongNextPrice(uint32 marketIndex, uint256 tokens_redeem) external override {
    if (marketIndex < SEPARATE_MARKET_CONTRACT_INDEX_START()) {
      ...
      separateMarketContracts[marketIndex].redeemNextPriceFor(tokens_redeem, msg.sender, true);
    }
  }
  ...
  function redeemShortNextPrice(uint32 marketIndex, uint256 tokens_redeem) external override {
    if (marketIndex < SEPARATE_MARKET_CONTRACT_INDEX_START()) {
      ...
      separateMarketContracts[marketIndex].redeemNextPriceFor(tokens_redeem, msg.sender, false);
    }
  }
    ...
    virtual
  {
    if (marketIndex < SEPARATE_MARKET_CONTRACT_INDEX_START()) {
      ...
      separateMarketContracts[marketIndex].executeOutstandingNextPriceSettlementsUser(user);
    }
  }
