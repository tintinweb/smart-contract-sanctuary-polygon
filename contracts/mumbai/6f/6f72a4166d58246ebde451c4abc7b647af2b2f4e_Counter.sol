...
// File: docs.chain.link/samples/Automation/20230603automationcounter.sol
...
contract Counter is AutomationCompatibleInterface {
    ...
    event stamp(uint256 indexed _parcontract);
    ...
    function change_num() public returns (uint256){
        num_test = num_test + 1;
        return(num_test);
