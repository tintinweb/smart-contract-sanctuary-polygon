...
contract Vader is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI)  ERC721("My nft3", "NFT3") {
        setBaseURI(baseURI);
    }
    ...
    function mintNFT(uint _tokenId) public payable checkTokenStatus(_tokenId) {
        require(msg.value >= PRICE, "Not enough balance to purchase NFTs.");
        _safeMint(msg.sender, _tokenId);
        soldedTokenIds.push(_tokenId);
        emit MintNft(msg.sender, _tokenId);
    }
