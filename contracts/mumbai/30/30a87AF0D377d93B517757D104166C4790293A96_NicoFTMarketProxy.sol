...
contract NicoFTMarketProxy is MarketEternalStorage, ERC1967Proxy {
  /**
...
contract MarketEternalStorage is Ownable {
   ...
   */
  mapping(address => mapping(uint256 => uint256)) public sellRequests; // owner => tokenAddress => tokenId => price

  /**
   * @notice Mapping storage for payer's addresses
   */
  mapping(address => mapping(uint256 => mapping(address => uint256)))
    public paymentInfoMap; // owner => tokenAddress => tokenId => address
}
