...
//    @@@    ::   :::  @@@@@@@   :: ::::  ::: ::::  @@@@@@@   :   : :  ::         ::  @@@@@@@     \\
    ...
    string private constant SPACE_SCHEMA = "tokenID text, trait_type text, value text, space_owner text";
    ...
    string private constant SPACE_GROUP_SCHEMA = "spaceName text, groupID text";
    ...
    function mint_your_Art(string memory name , string memory image , string memory animation , string memory audioCID, string memory description ,string memory spaceName) public payable {
        ...
        SQLHelpers.toInsert(
                SPACES_TABLE_PREFIX,
                spacesTableID,
                "tokenID, trait_type, value, space_owner",
                string.concat(
                    SQLHelpers.quote((Strings.toString(tokenID.current()))),
                    ",",
                    SQLHelpers.quote("spaceName"),
