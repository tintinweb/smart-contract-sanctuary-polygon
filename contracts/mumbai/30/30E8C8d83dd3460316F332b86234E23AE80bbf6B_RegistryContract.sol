...
contract RegistryContract is Initializable, Proxied, OwnableUpgradeable, IRegistryContract {
    ...
    function setReferalClassicContract(address _referalClassicContract) external override onlyOwner {
