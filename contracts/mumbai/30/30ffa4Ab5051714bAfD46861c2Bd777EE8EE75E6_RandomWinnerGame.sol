...
contract RandomWinnerGame is VRFConsumerBase, Ownable {
   ...
   /**
   * constructor inherits a VRFConsumerBase and initiates the values for 
keyHash, fee and gameStarted
   ...
   * @param vrfKeyHash ID of public key against which randomness is 
generated
   */
    ...
    /**
    * startGame starts the game by setting appropriate values for all the 
variables
    */
...
onlyOwner {
    ...
    /**
    * fulfillRandomness is called by VRFCoordinator when it receives a 
valid VRF proof.
    * This function is overrided to act upon the random number generated 
by Chainlink VRF.
    * @param requestId  this ID is unique for the request we sent to the 
VRF Coordinator
    * @param randomness this is a random unit256 generated and returned to 
us by the VRF Coordinator
   */
...
internal virtual override  {
    ...
    /**
    * getRandomWinner is called to start the process of selecting a random 
winner
    */
