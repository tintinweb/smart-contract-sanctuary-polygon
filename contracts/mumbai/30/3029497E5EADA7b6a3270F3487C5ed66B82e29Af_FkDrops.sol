...
contract FkDrops is ERC721Drop {
    ...
    ERC721Drop("Flipkart Drop", "FKD", _royaltyRecipient, _royaltyBps, _primarySaleRecipient){}
    ...
    function _beforeClaim(
        ...
        require(presentInAllowList(_address), "Not present in the allow list");
    }
