...
contract  FullOnchainTest6 is ERC721Enumerable, ERC721Permit("FullOnchainTest6NFT:Token"), ERC721Mintable, ReentrancyGuard, Ownable {
    ...
    string[1000] private letters ;
    string[1000] private fontColors ;
    string[1000] private backgroundColors ;
    uint256 counter = 0;
    mapping (uint256 => uint256) idNumber;
    ...
    function setInfo(string memory _letter, string memory _fontColor, string memory _backgroundColor, uint256 _tokenId) public onlyOwner {
        ...
        letters[_tokenId] = _letter;
        fontColors[_tokenId] = _fontColor;
        backgroundColors[_tokenId] = _backgroundColor;
        idNumber[_tokenId] = counter;
        counter++;
    }
    ...
    function tokenURI(uint256 _tokenId) public override view returns (string memory) {
        ...
        parts[1] = getFontColor(idNumber[_tokenId]);

        parts[2] = '; font-family: serif; font-size: 30px; }</style><rect width="100%" height="100%" fill="';

        parts[3] = getBackgroundColor(idNumber[_tokenId] );

        parts[4] = '" /><text x="30" y="170" class="base">';

        parts[5] = getLetter(idNumber[_tokenId] );
