...
contract AddressManager {
    ...
    address public disputesAddress;
    ...
    constructor(
        ...
        disputesAddress = address(_disputesAddress);
        ...
        _disputesContract = Disputes(_disputesAddress);
    }
    ...
    function updateAccessControlAddress(
        ...
        _disputesContract.updateAccessControlContract(
    ...
    function updateAuctionAddress(
        ...
        auctionAddress = address(_auctionAddress);
        _auctionContract = LandjaxAuction(_auctionAddress);
        _disputesContract.updateAuctionContract(_auctionAddress);
    ...
    function updatedisputesAddress(
        address _disputesAddress
    ) public onlyAuthorized {
        disputesAddress = _disputesAddress;
        _disputesContract = Disputes(_disputesAddress);
        emit disputesUpdated(_disputesAddress, msg.sender);
    }
...
contract LandjaxNft is ERC721URIStorage, ReentrancyGuard {
    ...
    constructor(address _accessController) ERC721("LandJax", "LAND") {
        tokenIdCounter = 0;
        accessController = LandjaxAccessControl(_accessController);
    }
