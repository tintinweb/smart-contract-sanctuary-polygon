...
contract MoogDao is 
   ...
   uint256 internal  groupId;
     ...
     */
    function initialize(IQuery initQueryContract ,IContributor initContributorContract, IPost initPostContract, IWorldID _worldId)
        public
        initializer
    {
        worldId = _worldId;
...
/// @param input User's input, used as the signal. Could be something else! (see README)
    ...
    function createProjectProfile(string memory title, string memory _imageUri, string memory _bannerUri, string memory _projectUri,
        uint256 root,
        uint256 nullifierHash,
