 ...
 */
contract HotWallet is AccessControlEnumerable {
    ...
    ) internal view returns (address[] memory coldWalletAddresses) {
     ...
     */
    function _findColdWalletIndex(address coldWalletAddress, address hotWalletAddress) internal view returns (uint256) {
    ...
    function _addColdWalletToHotWallet(
        ...
        if (coldWalletIndex == NOT_FOUND) {
            hotWalletToColdWallets[hotWalletAddress].push(WalletLink(coldWalletAddress, expirationTimestamp));
        }
    }
    ...
    function _setColdWalletToHotWallet(
        ...
        coldWalletToHotWallet[coldWalletAddress] = WalletLink(hotWalletAddress, expirationTimestamp);
