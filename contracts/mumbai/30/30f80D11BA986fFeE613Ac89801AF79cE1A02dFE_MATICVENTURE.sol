...
contract MATICVENTURE {
	...
	uint256 constant public INVEST_MIN_AMOUNT =0.1 ether; //10 ether;
	...
	uint256 constant public PERCENTS_DIVIDER = 1000;
 	uint256 constant public TIME_STEP =1 minutes; //24 hours;
    uint256 constant public CONTRACT_BALANCE_STEP =1 ether; //1000000 ether;
    uint constant public WITHDRAW_COOLDOWN	= 5 minutes;
