...
contract IGIERC721 is ERC721URIStorage, EIP712, AccessControl {
    ...
    constructor(
        ...
        require(_athlete != address(0), "athelete null address");
        require(
            _royalty + _fee >= 0 && _royalty + _fee <= 10000,
            "invalid percentage"
        );
    }
