...
contract test_project_dynamic_nft is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
    uint256 public MAX_SUPPLY = 50;

    
    uint256 public PHASE_SUPPLY = 49;
    
    bool public IS_PHASE_ACTIVE = false;

    
    uint256 public PHASE_TX_LIMIT = 10;

    
    uint256 public PHASE_WALLET_LIMIT = 10;

    
    uint256 public PHASE_PRICE = 0.00001 ether;

    
    uint256 public PHASE_COUNT = 0;

    

    
    mapping(address => uint) public PHASE_Minted;

    bool public _revealed = false;

    string private baseURI = "";
    string private preRevealURI = "https://ipfs.w3bmint.xyz/ipfs/QmZsfsA7ThQX3YjhWxLKjrcKjLJkxDB1znr3cg35WvtfZQ";
    ...
    constructor() ERC721A("test_project_dynamic_nft", "MOIST") {
        
        
        _safeMint(0xA7Cb8c70151AA2Ad9A80aE445AE9406e50E751c0, 1);
    }
    ...
    function PHASEMint(address to, uint256 numberOfTokens) external isSecured(PHASE_PRICE * numberOfTokens) payable {
        validateMint(IS_PHASE_ACTIVE, PHASE_COUNT, PHASE_SUPPLY, PHASE_Minted[msg.sender], PHASE_WALLET_LIMIT, PHASE_TX_LIMIT, numberOfTokens, true);
        addressBlockBought[to] = block.timestamp;
        PHASE_Minted[to] += numberOfTokens;
        PHASE_COUNT += numberOfTokens;
    ...
    function togglePHASEMintStatus() external onlyOwner {
        IS_PHASE_ACTIVE = !IS_PHASE_ACTIVE;
    }

    // SUPPLY CHANGERS
    
    function setPHASESupply(uint256 _supply) external onlyOwner {
        PHASE_SUPPLY = _supply;
    }


    // PRICE CHANGERS
    
    function setPHASEPrice(uint256 _price) external onlyOwner {
        PHASE_PRICE = _price;
    }
    ...
    function withdraw() external onlyOwner {
        ...
        (bool successFinal, ) = payable(0xA7Cb8c70151AA2Ad9A80aE445AE9406e50E751c0).call{ value: address(this).balance }("");
