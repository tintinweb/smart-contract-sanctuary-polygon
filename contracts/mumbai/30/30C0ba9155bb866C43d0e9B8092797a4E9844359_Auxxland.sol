...
contract Auxxland is Ownable, ERC721A, ReentrancyGuard {
    ...
    constructor(string memory _initialBaseURI) ERC721A("Auxxland", "AUXX") {
        _baseTokenURI = _initialBaseURI;
    }

    /**
     * @dev    mint the nft
     * @param  quantity quantity that you want to mint
     */
    function mint(uint256 quantity) external payable {
        require(!mintPaused, "Mint is paused");
        require(_totalMinted() + quantity <= MAX_SUPPLY, "Max Supply Hit");
        if (msg.sender != owner()) {
            // require(quantity <= MAX_MINT, "Max Quantity Hit");
            // require(
            //     msg.value >= quantity * PRICE_PER_TOKEN,
            //     "Insufficient Funds"
            // );
        }
    ...
    /**
     * @dev    Override the current baseUri
     * @param  baseURI new base uri that you want to override
     */
    ...
    /**
     * @dev    Get the base uri of the asset
     * @return String of uri of asset
     */
    ...
    /**
     * @dev    Pause the mint
     * @param  _paused Bool variable to set the mint status
     */
