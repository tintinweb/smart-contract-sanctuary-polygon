...
contract RunbitShoes is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl, ERC721Burnable {
    struct MetaData {
        uint8  transferable;
        uint8  upgradeable;
        uint8  level;
    ...
    constructor(address admin) ERC721("Runbit Shoes", "RBS") {
    ...
    //     require(tokenMetaData(tokenId).transferable == 1, "Transfer not allowed for this token!");
