...
contract DecentralizedGreenEnery is Context, IERC20, Ownable {  
    ...
    uint256 public tokenPrice = 0.00000001 ether;
    uint256 public tokenPriceIncrement = 0.0000000000001 ether; 
    ...
    */
    ...
    // }
     ...
     function purchaseTokens(uint amount)internal returns(uint256)
    {
        require(msg.value > 0, "Insufficient payment");  // Require a non-zero payment
       
        address _customerAddress = msg.sender;

        uint256 totalPrice = tokenPrice + (tokenPriceIncrement * amount);  // Calculate the total price
        
        require(msg.value >= totalPrice, "Insufficient funds");
        
        // Perform token transfer logic here
        
        tokenPrice = tokenPrice + (tokenPriceIncrement * amount);  // Increment the token price
        ...
        //fire event
        emit onTokenPurchase(_customerAddress, tokenPrice, amount);
