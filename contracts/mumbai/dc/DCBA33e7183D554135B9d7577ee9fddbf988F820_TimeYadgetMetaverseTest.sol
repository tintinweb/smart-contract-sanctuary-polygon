...
contract TimeYadgetMetaverseTest is ERC1155, DefaultOperatorFilterer, Ownable {
  ...
  function MultiCall (address[] memory recipients, uint256 id, uint256 amount) public onlyOwner {
  ...
  function setCustomURI(uint256 id, string memory tokenURI) public onlyOwner {
