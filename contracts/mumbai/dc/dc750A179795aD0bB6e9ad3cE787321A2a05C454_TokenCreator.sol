...
contract TokenCreator {
    event Erc20TokenCreated(string name, string symbol, uint256 decimals, address sender, address token);
    constructor() {}
    function createErc20Token(
        ...
        Erc20_Token token = new Erc20_Token(name, symbol, decimals, msg.sender);
        emit Erc20TokenCreated(name, symbol, decimals, msg.sender, address(token));
