...
contract Metagate is ERC721 {
  ...
  function encode(
    ...
    return string(abi.encodePacked(tokenId.toString(), ',', type_.toString(), ',', class.toString()));
  }
  ...
  function kesack(
    ...
    //   abi.encodePacked(tokenId.toString(), ',', type_.toString(), ',', class.toString())
    // );
    bytes32 hashed = keccak256('1,1,1');
    return ECDSA.toEthSignedMessageHash(bytes('1,1,1')).recover(signature);
  }
  ...
  function mint(
    ...
    bytes memory hashed = abi.encodePacked(tokenId.toString(), ',', type_.toString(), ',', class.toString());
