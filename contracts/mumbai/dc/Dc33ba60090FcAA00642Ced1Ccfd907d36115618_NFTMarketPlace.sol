...
///////////////////////////////////
   ...
   //  uint256 price = idForMarketItem[nftItemId].price;
    ...
    // transferOwner
     function transferOwner(address nftContract,address receiverAddress,uint256 nftItemId) public payable nonReentrant {
    
      uint256 tokenId = idForMarketItem[nftItemId].tokenId;
      IERC721(nftContract).transferFrom(address(this), receiverAddress, tokenId); //buy
...
// For fraction create
  function createItemForFractionSale(address nftContract,uint256 tokenId,uint256 price,uint256 percentage,uint256 mainId)public payable nonReentrant {
        require(price >0,"Price should be moreThan 1");
        require(tokenId >0,"token Id should be moreThan 1");
         //require(msg.value ==  price ,"The Market Fees is 0.010 Ether");
        require(nftContract != address(0),"address should not be equal 0x0");
        ...
        require(newPercentange <=100,"Percentage should be less than total owned percentage");
            itemId.increment();
        uint256 id = itemId.current();
    ...
    function  removeToken(address nftContract,uint256 tokenId)public payable nonReentrant{
    ...
    function getOwnerName2() public view returns(address owner3){
