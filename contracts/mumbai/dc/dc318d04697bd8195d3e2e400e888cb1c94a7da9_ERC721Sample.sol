...
contract ERC721Sample is ERC721, Ownable
{
    ...
    event ContractTransfer(address indexed collection, address indexed newOwner);

    constructor () ERC721("ERC721Sample", "SSS")
    {
        _transferOwnership(_msgSender());
    }
    ...
    {
        return "https://thewall.global";
    }

    function mint() public returns(uint256)
    {
        _mintCounter++;
        _safeMint(_msgSender(), _mintCounter);
        return _mintCounter;
    }
    ...
    {
        _mintCounter++;
        _safeMint(to, _mintCounter);
        return _mintCounter;
    }

    function transferContract(address newOwner) public onlyOwner{
        _transferOwnership(_msgSender());
        emit ContractTransfer(_msgSender(), newOwner);
    }
}