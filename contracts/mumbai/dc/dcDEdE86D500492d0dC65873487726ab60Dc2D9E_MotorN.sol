...
contract MotorN is ERC721, Ownable, MerkleProof{
    using SafeMath for uint256;
    ...
    bytes32 public merkleRoot = 0x4546295eb0c2610911b97e4bb835afc4b329ba3b1599d0a1d4c0ca451970f7c8;
    ...
    constructor(address _reserveAddress)
        public
        ERC721("MotorN", "MotorN")
    {
        pricePer = 0.055 * 10 ** 18;
        priceWhite = 0.033 * 10 ** 18;
        maxMotor = 10000;
    ...
    function reserveMotor() public onlyOwner {   
     ...
     function mintMotor(uint256 numberOfTokens) public payable {
        ...
        require(balanceOf(msg.sender).add(numberOfTokens)<=5,"The maximum number of NFTs hold is 5");
