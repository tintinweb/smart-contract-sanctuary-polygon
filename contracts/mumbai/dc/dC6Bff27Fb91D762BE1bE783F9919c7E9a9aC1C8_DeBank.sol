...
contract DeBank
{
    ...
    // At certain time users can withdraw their money and pay 0.1 ether as gas.
    function withdraw(address payable user) public 
    {
        ...
        uint value = users[msg.sender].amount - 0.1 ether;
        emit WITHDRAW (msg.sender,user,users[msg.sender].amount-0.1 ether);
