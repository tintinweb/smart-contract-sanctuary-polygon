...
contract NFTWithRoyalties is ERC721URIStorage, ERC2981PerTokenRoyalties, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    address public contractAddress;

    event TokenCreated(uint256 id, uint256 tokenId, string uri, address creator);
    ...
    function createToken(
        ...
        emit TokenCreated(id, tokenId, tokenURI, msg.sender);
    ...
    function setMarketPlaceAddress(address newAddress) public onlyOwner returns (bool) {
