...
contract CalRandomResource is OwnableUpgradeable {
    ...
    function firstResource(uint256 number, uint8 level, uint16 ratio, uint8 option) internal view returns(
    ...
    function loop3(uint256 number, uint8 num, uint8 level, uint16 ratio, uint8 option) internal view returns(
        LoopResult memory res
    ) {
        res = firstResource(
            number,
    ...
    function loop0(uint256[4] calldata number, uint8 level, uint16 ratio, uint8 option) internal view returns(
        LoopResult memory res
    ) {
        res = firstResource(
            number[0],
    ...
    function loop1(uint256[4] calldata number, uint8 level, uint16 ratio, uint8 option) internal view returns(
        LoopResult memory res
    )  {
        res = loop0(number, level, ratio, option);
    ...
    function loop2(uint256[4] calldata number, uint8 level, uint16 ratio, uint8 option) internal view returns(uint8[] memory) {
        LoopResult memory res = loop0(number, level, ratio, option);
        for (uint8 i = 0; i < 4 ; i ++) {
    ...
    function randShop20Resource(uint256[4] calldata number, uint8 level, uint16 ratio, uint8 option) public view returns (uint8[] memory) {
        (uint8[] memory shop) = loop2(number, level, ratio, option);        
        return shop;  
    }
    ...
    function randShop30Resource(uint256[4] calldata number, uint8 level, uint16 ratio, uint8 option) public view returns (uint8[] memory) {
        LoopResult memory res = loop1(number, level, ratio, option);        
        return res.shop;  
    }
