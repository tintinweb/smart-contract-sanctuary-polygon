...
contract ClaimTokens is Ownable, ReentrancyGuard, Pausable {
    ...
    uint256[] public tokensToBeClaimed = [5,5,5];

    address[] public whitelistUsers = [0x5baA0f14D09864929c5fC8AbDfDc466dcb72be9d, 0x64DC48F2Ae171f7Ae966f15844eF2f8751665110, 0x9AF3DA360C8723bcA17CE6d0784565680EC29370];
    ...
    function Claim() external nonReentrant whenNotPaused {
        ...
        token.safeTransferFrom(owner(), msg.sender, claimedTokens);
