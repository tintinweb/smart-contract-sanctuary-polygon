...
import "./AdashNonUniqueCollectible.sol";
import "./AdashUniqueCollectible.sol";

contract AdashFactory is Ownable {
    using SafeMath for uint256;

    AdashUniqueCollectible private impl;
    AdashNonUniqueCollectible private implMultiple;
    ...
    constructor(
        AdashNonUniqueCollectible _implMultiple,
        AdashUniqueCollectible _impl,
        address _registry,
        address _exchange
    ) {
    ...
    function setProxyRegistry(address _registry) external onlyOwner {
        require(
            ...
            "AdashFactory::SAME REGISTRY ADDRESS"
        );
    ...
    function setNewExchange(address _exchange) external onlyOwner {
        require(
            ...
            "AdashFactory::SAME EXCHANGE ADDRESS"
        );
    ...
    function newCollection(
        ...
        AdashUniqueCollectible(newCollection_).initialize(
            _name,
            _symbol,
            _tokenURI,
    ...
    function newCollectionMultipleSupply(
        ...
        AdashNonUniqueCollectible(newCollection_).initialize(
            _name,
            _symbol,
            _tokenURI,
            _proxyRegistryAddress,
