...
abstract contract ERC1155Base is ERC1155BurnableUpgradeable, ERC1155URIStorageUpgradeable, ERC1155DefaultApproval {
    string public name;
    string public symbol;


    mapping(uint256 => LibPart.Part[]) internal creators;
    mapping(uint => uint) internal supply;
    mapping(uint => uint) internal minted;
...
abstract contract ERC1155Lazy is IERC1155LazyMint, Mint1155Validator, RoyaltiesV2Impl, ERC1155Base {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC1155Upgradeable, RoyaltiesV2Impl) returns (bool) {
        return interfaceId == LibERC1155LazyMint._INTERFACE_ID_MINT_AND_TRANSFER   // don't know where rarible devs got this interfaceId
...
import "./rarible/tokens/erc-1155/ERC1155Lazy.sol";

contract WinAmpNft is ERC1155Lazy {
    event CreateERC1155RaribleUser(address owner, string name, string symbol);  // for rarible
