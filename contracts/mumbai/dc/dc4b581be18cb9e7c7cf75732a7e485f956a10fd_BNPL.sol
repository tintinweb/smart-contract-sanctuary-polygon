...
contract BNPL is BNPLAdmin, ERC721{
    ...
    function OwnerEnters(address _nftAddress, uint256 _tokenId, uint256 _price) public {
        ...
        (bool success, ) = _nftAddress.call(abi.encodeWithSelector(IERC721(_nftAddress).transferFrom.selector, msg.sender, address(this), _tokenId));
