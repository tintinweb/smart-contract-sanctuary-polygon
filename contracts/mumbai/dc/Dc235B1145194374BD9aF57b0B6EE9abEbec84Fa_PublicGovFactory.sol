...
contract PublicGovFactory is Initializable, UUPSUpgradeable, PausableUpgradeable, OwnableUpgradeable, AdminProxyManager, IPublicGovFactory{
    // d2 = 2 decimal
    uint256 public override gasForDestinationLzReceive;
    uint64 public override operationalPercentage_d2;
    uint64 public override marketingPercentage_d2;
    ...
    address public override saleImplementation;
    ...
    function createProject(
        ...
        project = address(new ERC1967Proxy(saleImplementation, data));
    ...
    /**
     * @dev Set sale implementation
     * @param _saleImplementation Sale implementation address
     */
    function setSaleImplementation(address _saleImplementation) external override onlyOwner{
        require(_saleImplementation != address(0), "bad");
     ...
     */
    function setGasForDestinationLzReceive(uint256 _gasForDestinationLzReceive) external override onlyOwner{
        require(_gasForDestinationLzReceive > 0, "bad");
     ...
     * @param _crossChainManager Cross chain manager address
     ...
     */
    function config(address _crossChainManager, address _savior, address _keeper, address _operational, address _marketing, address _treasury) external override onlyOwner{
        require(_crossChainManager != address(0) && _savior != address(0) && _keeper != address(0) &&_operational != address(0) && _marketing != address(0) && _treasury != address(0), "bad");
