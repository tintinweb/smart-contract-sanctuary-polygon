  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x87B23553aFfAFe941715C2387f221f660d84B394);
        ...
        */
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, "Cannot mint over supply cap of 2000");
    ...
    // File: contracts/alohaPineapplesTestContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract AlohaPineapplesTestContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Aloha Pineapples Test", "ALOHAP", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmQEsakhk6ejYELp7fzaJJ6eme9Pyvw9xh5voFbd4KEPfn/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/XNMUyEfL1UhXLmWXNoLq/contract-metadata";
        }
    }