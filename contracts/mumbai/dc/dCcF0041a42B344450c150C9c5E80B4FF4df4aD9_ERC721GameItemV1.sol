    ...
    VersionAware
{
    ...
    function initialize(
        ...
        versionAwareContractName = "ERC721 Game Item: V1";
        managers = _managers;
        mintCost = _mintCost;
    ...
    function supportsInterface(
        ...
        view
        virtual
        override(ERC165StorageUpgradeable, IERC165Upgradeable, ERC721EnumerableUpgradeable)
        returns (bool)
    {
        return super.supportsInterface(interfaceId);
    }

    function getContractNameWithVersion() external view virtual override returns (string memory) {}
}
...
interface IERC721GameItem is IERC721EnumerableUpgradeable {
