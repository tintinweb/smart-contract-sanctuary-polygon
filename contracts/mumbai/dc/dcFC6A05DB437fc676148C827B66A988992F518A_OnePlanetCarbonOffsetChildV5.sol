...
function initialize() public initializer {
    ...
    function isApprovedAndOffset(address spender, address operator, uint tokens, string calldata message) public returns (bool success) {
        checkApproved = ERC721Interface(address(msg.sender));
        msgSenderAddress = address(msg.sender);      
        spenderAddress = spender;
        operatorAddress = operator;
        isApproved = checkApproved.isApprovedForAll(spender, operator);
