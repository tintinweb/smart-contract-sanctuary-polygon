    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeifs2ym4olijba53qcmfamtwqqw6ppjahd5oj2oolo37jagzaj5bcy/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/UldQwudkHRJnPIVCUMPX/contract-metadata";
  }
...
// File: contracts/AlienBoardingAcessCardContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AlienBoardingAcessCardContract is RamppERC721A {
    constructor() RamppERC721A("Alien Boarding Acess Card", "bapmnft"){}
}
