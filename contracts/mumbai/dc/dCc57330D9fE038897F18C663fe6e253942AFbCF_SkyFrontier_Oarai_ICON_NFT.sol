...
contract SkyFrontier_Oarai_ICON_NFT is Context, ERC721Enumerable, Pausable, Ownable, ContextMixin, NativeMetaTransaction, DefaultOperatorFilterer {
...
//	require( !paused() );
	...
	require( (_currentTokenId[ctype].current()<10000), "mint: Token supply exceeded" );
	...
	uint ctype = tokenId / 10000;
	uint token = tokenId % 10000;
