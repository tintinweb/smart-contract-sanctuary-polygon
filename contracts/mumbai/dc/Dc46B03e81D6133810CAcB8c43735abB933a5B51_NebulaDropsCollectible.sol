...
contract NebulaDropsCollectible is ERC1155, Ownable {
    ...
    mapping(string => ApprovedDrops4Minting) private dropToAllowedDrop;
    ...
    /* Approve owners to ..*/
    function approveDrops(string memory _dropid, address _allowedowner, string memory _dropname, string memory _dropipfsuri) public onlyOwner
    {
    ...
    // /* this will return a list of all whitelisted Marketplaces..*/
    // function fetchApprovedDropsList() public view returns(ApprovedDrops4Minting[] memory) {
    //   return dropToAllowedDrop; 
    // }
