...
contract BearBet is EnetScoresConsumer, ReentrancyGuard {
    /** CONSTANTS */
    ...
    function withdrawToken(uint amount) public onlyOwner nonReentrant {
    ...
    function resolveWinner(
        bytes32 _requestIdGameCreate,
        bytes32 _requestIdGameResolve,
        uint256 _idx
    ) public onlyOwner {
        //Obtengo el GameId para el partido especifico
