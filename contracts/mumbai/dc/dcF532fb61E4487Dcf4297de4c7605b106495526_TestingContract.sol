...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1675328700;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x4799cFDC147CfA2B5d0521A72346C4dfeAA6126A];
  address public erc20Payable = 0x4799cFDC147CfA2B5d0521A72346C4dfeAA6126A;
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 100, 1) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafkreidtfy4wobyx6ou6fw4adgncbyb7cg7c5uushbjgk4a26wpl73v4vi/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/vaBCeNxXl5UkRKgiEnbu/contract-metadata";
  }
...
contract TestingContract is RamppERC721A {
    constructor() RamppERC721A("Testing", "ERC20"){}
}
