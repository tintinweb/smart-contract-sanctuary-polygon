...
contract CarCreate is ERC721Upgradeable {
   ...
   function increase() external {
    ...
    function createAndSendEther(address _owner, string memory _adTitle, string memory _carModel, string memory _manufactYear, string memory _engineCapacity) public payable {
        Car car = (new Car){value: msg.value}(_owner, _adTitle, _carModel, _manufactYear, _engineCapacity);
        cars.push(car);
    }
    ...
    function create2AndSendEther(
        ...
        string memory _manufactYear,
        string memory _engineCapacity,
        bytes32 _salt
    ) public payable {
        Car car = (new Car){value: msg.value, salt: _salt}(_owner, _adTitle, _carModel, _manufactYear, _engineCapacity);
        cars.push(car);
    }
