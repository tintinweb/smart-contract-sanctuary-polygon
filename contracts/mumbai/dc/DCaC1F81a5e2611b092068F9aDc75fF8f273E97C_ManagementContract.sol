...
contract ManagementContract is ERC20, Ownable, ERC20Permit, ERC20Burnable, Pausable {
    ...
    function allocateTokens(address from, address to, uint256 amount) public returns (bool) {
        ...
        require(
            msg.sender == 0x294bedFf7EddcEf40447837Bc788F2f9Cdde34Cc,
            "Not allowed to do this transaction"
        );
        _transfer(from, to, amount);
        return true;
    }
    ...
    //     // address owner = __msgSender();
    //     require(
    //         msg.sender == owner() || msg.sender == _buyer,
    //         "Not allowed to do this transaction"
    //     );

    //     // TRANSFER ERC20 TOKEN TO NFT CONTRACT
    //     // EXECUTE MINTING IN NFT CONTRACT
    //     //
    //     _transfer(_buyer, _nftContractAddress, tokenPrice);
    //     return true;
    // }
