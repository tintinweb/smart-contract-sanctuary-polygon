    ...
    ERC1155EnumerableUpgradeable
{
    ...
    /**
     * @dev Sets the max purchase limit of a token, used in marketplace
     */
    function setMaxQuantityToPurchaseLimit(uint256 _maxQuantity) external onlyAdmin{
        require(
            _maxQuantity >= 1, 
            throwError(MAX_QUANTITY_MUST_BE_GREATER_THAN_ZERO)
        );
        maxQuantityToPurchaseLimit = _maxQuantity;
    }
