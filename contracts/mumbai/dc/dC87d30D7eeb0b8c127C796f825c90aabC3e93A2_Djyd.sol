...
abstract contract Ownable is Context {
	 ...
	 */
	constructor() {
		_setOwner(0x0f702527A28c5893D52a19B01eb71Ab9137Ac77A);
	}
...
contract Djyd is ERC721Enumerable, Ownable, ReentrancyGuard {

	uint256 public TOKEN_MAX_AMOUNT = 300;
	uint256 public TOKEN_PER_TX = 30;
	uint256 public TOKEN_PER_WALLET = 60;
	uint256 public PRICE = 50 ether;
	uint256 public constant TIME_FOR_GROWN = 1687009939000;
	address public founder = 0x0f702527A28c5893D52a19B01eb71Ab9137Ac77A;
	...
	string private _name = "djyd";
	string private _symbol = "DYJ";
	string private _baseTokenURI = "https://lab.cryptodo.app/ru/create?type=ERC721_CONTRACT&network=POLYGON3";
