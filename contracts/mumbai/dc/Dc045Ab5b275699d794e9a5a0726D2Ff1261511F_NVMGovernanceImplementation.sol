    ...
    NVMGovernanceStorageV1
{
    ...
    function initialize(
        ...
        require(
            INVMTimelock(_timelock).admin() == address(this),
            "Invalid timelock admin"
        );
        require(
            _quorumVotesPercentage >= _proposalThresholdPercentage,
            "Invalid quorum votes"
        );
    ...
    function cancel(uint256 _proposalId) external override {
        ...
        require(
            msg.sender == _proposal.proposer ||
                getPriorVotes(_proposal.proposer, sub256(block.number, 1)) <
                proposalThreshold(),
     ...
     */
    function state(uint256 _proposalId) public override view returns (ProposalState) {
        ...
        if (_proposal.canceled) {
            ...
            _proposal.forVotes < quorumVotes()
        ) {
     ...
     */
    function setQuorumVotesPercentage(uint256 _newQuorumVotesPercentage) external override onlyOwner {
        require(
            _newQuorumVotesPercentage >= proposalThresholdPercentage,
            "Invalid quorum votes"
        );
     ...
     */
    function setVotingPeriod(uint256 _newVotingPeriod) external override virtual onlyOwner {
     ...
     */
    function setProposalThresholdPercentage(uint256 _newProposalThresholdPercentage) external override onlyOwner {
