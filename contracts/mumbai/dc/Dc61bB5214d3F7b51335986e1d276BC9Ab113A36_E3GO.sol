    ...
    ERC1155SupplyUpgradeable
{
    ...
    function uri(uint256 tokenId) public view virtual override returns (string memory) {
        return exists(tokenId) ? string(abi.encodePacked(_baseURI, "{id}")) : _baseURI;
    }
        ...
        initializer
    {
        ...
        _wallet = wallet_;
        _baseURI = string(abi.encodePacked("https://storage.googleapis.com/e3go-metadatas/", StringsUpgradeable.toHexString(address(this)), "/"));
