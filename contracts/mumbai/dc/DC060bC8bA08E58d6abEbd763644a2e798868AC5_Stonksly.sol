...
contract Stonksly is IStonksly, Ownable {
    ...
    address public immutable s_stonkslyWallet;
    ...
    address[] public s_sTokensAddresses;
    mapping(address => bool) public s_sTokens;
    mapping(uint256 => Request) public s_requests;
    mapping(address => uint256) public s_liquidityProviders;
