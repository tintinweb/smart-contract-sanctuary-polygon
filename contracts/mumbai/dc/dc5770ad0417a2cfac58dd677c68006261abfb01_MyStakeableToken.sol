...
contract ERC20Stakeable is ERC20, ERC20Burnable {
    ...
    uint256 public rewardsPerHour = 2850; // 0.00285%/h or 25% APR originalmente 285

    // Minimum amount to stake
    uint256 public minStake = 10 * 10**decimals();

    // Compounding frequency limit in seconds
    uint256 public compoundFreq = 60; //4 hours original 14400
        ...
        returns (uint256 rewards)
    {
        return (((((block.timestamp - stakers[_staker].timeOfLastUpdate) /
            60) * stakers[_staker].deposited) * rewardsPerHour) / 10000000);  // 60 original 3600
    }
}
