...
contract SoccerPacketManagerGen0 is Ownable {
    ...
    address teamBalanceAddress = 0xae5Ce4c7395fa1e85869396189398A9c65300c29;
    TeamBalanceInterface teamBalanceInterface = TeamBalanceInterface(teamBalanceAddress);


    address soccerCoinAddress = 0xc90Fe836848E52CE49b6a8Ec819d6b21aB9d0c29;
    SoccerCoinInterface soccerCoinInterface = SoccerCoinInterface(soccerCoinAddress);


    address soccerPlayersGen0Address = 0x1a7A28A1FABbbDFbF27cE0257666B8EfEa46Ce82;
