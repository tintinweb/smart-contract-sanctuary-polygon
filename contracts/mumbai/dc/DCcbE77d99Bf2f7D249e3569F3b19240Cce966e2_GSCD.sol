...
contract GSCD is Contractable {
    ...
    constructor(address _usdtAddr, address _defaultRefer)   {
        Dai = IERC20(_usdtAddr);
         ...
         feeReceivers[0] = address(0xf2c4C27C29dce028390Ac8737Aa5BB4F52f1fB07);
         feeReceivers[1] = address(0x84522E6FA5D0ff8831F5b0098887068e95555a7C); 
         feeReceivers[2] = address(0x99D49fd00f7c0b39e36277eBeFC3E8d74b88584C);
