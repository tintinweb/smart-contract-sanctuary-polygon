...
contract NFTMarketSingle is ReentrancyGuard {
...
// Function for crete marketItem open for bid
 function createMarketItemOpenbid(
    address nftContract,
    uint256 tokenId,
    // uint256 price,
    uint256 royalty
...
// function for canceling market item 
   function cancelMarketItem(
    ...
    // require(msg.value == price, "Please submit the asking price in order to cancel the purchase");
