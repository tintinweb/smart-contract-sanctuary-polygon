      ...
      constructor() ERC721("Chain Battles","CHBTLS"){
       ...
       //It's concatanate strings to create nft
        bytes memory svg = abi.encodePacked(
            ...
            '<text x="50%" y="50%" class="base" dominant-baseline="middle" text-anchor="middle">', "Strength: ",getLevels(tokenId).strength.toString(),'</text>',
            '<text x="50%" y="50%" class="base" dominant-baseline="middle" text-anchor="middle">', "life: ",getLevels(tokenId).life.toString(),'</text>',
            '</svg>'
        );
