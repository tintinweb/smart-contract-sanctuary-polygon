 ...
 */
abstract contract MaticContext {
 ...
 */
contract MaticERC20 is MaticContext, MaticIERC20 {
    using MaticSafeMath for uint256;
    using MaticAddress for address;
 ...
 */
abstract contract AccessControl is MaticContext {
    using MaticEnumerableSet for MaticEnumerableSet.AddressSet;
    using MaticAddress for address;

    struct RoleData {
        MaticEnumerableSet.AddressSet members;
        bytes32 adminRole;
    }
...
contract EIP712Base is MaticInitializable {
    struct EIP712Domain {
        string name;
        string version;
