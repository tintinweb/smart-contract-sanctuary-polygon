...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x11A5821C838faC4Dc0AaA2648F60135E3FFaDbfB];
  address public erc20Payable = 0x11A5821C838faC4Dc0AaA2648F60135E3FFaDbfB;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 30, 10000) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeifojkavqmqkahq5wdltdy5xsay6cizk6g46mua6jgnlpxj54ps3b4/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/HoIPtyuwu0FZelxAX5Oh/contract-metadata";
  }
...
// File: contracts/TreepixelearthContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TreepixelearthContract is RamppERC721A {
    constructor() RamppERC721A("Treepixelearth", "TRE"){}
}
