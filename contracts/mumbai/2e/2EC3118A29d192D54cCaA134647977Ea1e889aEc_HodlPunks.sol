    ...
    KeeperCompatibleInterface
{
    ...
    function safeMint(address to) public onlyOwner {
        ...
        string memory prefix = _metadataFilePrefixUp;
    ...
    function performUpkeep(
        ...
        if ((block.timestamp - _lastTimestamp) > _interval) {
            ...
            if (latestPrice > _currentPrice) {
                updateAllTokensUris(TokenVariant.UP);
            } else {
                updateAllTokensUris(TokenVariant.DOWN);
            }
    ...
    function updateAllTokensUris(TokenVariant variant) internal {
        string memory prefix = variant == TokenVariant.UP
