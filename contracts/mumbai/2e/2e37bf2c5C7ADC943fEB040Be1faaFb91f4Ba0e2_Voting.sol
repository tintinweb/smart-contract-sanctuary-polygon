...
contract Voting {
    ...
    event addpools(uint256 poolId, address manager);
    event voterid(uint256 poolId, address cadidateadd);
    ...
    function addPools(
        ...
        counter = counter + 1;
          emit addpools(_uniqueId, _address);
    ...
    function vote(uint256 _pool_Id) public {
        ...
        address cadidateadd = pools[_pool_Id].cadidate_address;
        votes[cadidateadd] += _pool_Id;

        emit voterid(_pool_Id, cadidateadd);
