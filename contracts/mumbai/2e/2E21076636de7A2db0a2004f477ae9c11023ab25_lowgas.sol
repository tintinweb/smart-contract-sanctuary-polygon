...
contract lowgas is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "lowgas";
  ...
  constructor() ERC721("lowgas", "lgs") {
    setHiddenMetadataUri("ipfs://QmUmc1Xwn46nRYevZVXGXtyunSeUNS7dRRFMdVfz24FVd3/hidden.json");
  }
