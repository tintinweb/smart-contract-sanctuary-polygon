  ...
  AccessControl
{
    ...
    returns (uint256) 
  {
    ...
    sortedProposalList.addProposalId(msg.sender, targets, values, calldatas, description, proposalDeadline(_proposalId) + EXTRA_DELAY);
    return _proposalId;
  }
    ...
    returns (uint256) 
  {
    ...
    sortedQueueAndExecutionList.addProposalId(msg.sender, targets, values, calldatas, description, block.timestamp + timelockControlloer.getMinDelay() + EXTRA_DELAY);
    return proposalId;
  }
