...
// File: contracts/TestAiDogeContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract TestAiDogeContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Test Ai Doge";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/Dq98BCtbJZnrChZsUUjy/contract-metadata";
  }
