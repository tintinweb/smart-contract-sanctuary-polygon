...
//
//     ____                  __               __  ___          
//    / __ \____ _____  ____/ /___ _____     /  |/  /___ _____ 
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x58858F7f00B24395B58b54Dc431B930dC2E39958,0xabC7050A87E4e4E4AAb1289932aD165D01c42eAa,0xaa10552054908453B3B70e5b3DC3C4cc60C266A8];
  address public erc20Payable = 0x58858F7f00B24395B58b54Dc431B930dC2E39958;
  uint256[] public payableFees = [50,45,5];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1500, 6666) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmdS5btPKwpk5sV2JSWowvt5jVXnMBaawF6uVPRJyor4w1/";
...
// File: contracts/PandanManContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PandanManContract is RamppERC721A {
    constructor() RamppERC721A("Pandan Man", "PDM"){}
}
