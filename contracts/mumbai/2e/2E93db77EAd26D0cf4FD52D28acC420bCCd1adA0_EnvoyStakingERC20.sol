    ...
    */
    ...
    function updateWeightBatch(address[] memory stakeholders_, uint[] memory weights_) public onlyOwner{
        ...
        for(uint i = 0; i < stakeholders_.length; i++){
            ...
            // //console.log('updating %s with w %s, max is %s', i, weights_[i], maxWeight());
            // Update balance distributions with new weight
            aggregatedBalances.moveToDifferentWeight(
                stakeholder.weight,
                weights_[i],
    ...
    function withdrawFunds(uint withdrawalId) public {
       ...
       //console.log(stakeholder.withdrawals.length);
        ...
        // console.log('start: %s, releaseDate: %s, left: %s',  block.timestamp, withdrawal.releaseDate, timeToEnd);
    ...
    function calculateRewards(address stakeholderAddress, uint endPeriod) public view returns(uint reward, StakeholderLib.Stakeholder memory stakeholder) {
        ...
        // //console.log('Last claimed and start of loop: %s', stakeholder.lastClaimed);
        // //console.log('EndOfLoop: %s', endOfLoop);

        for (uint p = stakeholder.lastClaimed;
            p < endOfLoop;
            p++) {
            // //console.log('Rewarding period %s', p);
            ...
            if(simulationRewardPeriod.totalWeightedStakingBalance > 0){
                ...
                // //console.log('Reward for period: %s', simulationRewardPeriod.rewardPerPeriod);

                // //console.log('Stakeholders balance %s', stakeholder.stakingBalance);
                // //console.log('Already claimed rewards: %s', stakeholder.claimedRewards);
                // //console.log('Total weighted stakingbalance: ', simulationRewardPeriod.totalWeightedStakingBalance);
                // //console.log('New calculated reward: %s', newReward);                
                // if(p+3 > endOfLoop){
                //     console.log('(%s) latestRewardPeriod: %s', p, latestRewardPeriod());
                //     // console.log('(%s) totalWeightedStakingBalance: %s', p, simulationRewardPeriod.totalWeightedStakingBalance);
                //     console.log('(%s) unlocking: %s', p, (p % Constants.periodsForExtraReward == 0)|| p == maxNumberOfPeriods);
                //     console.log('(%s) reward per period: %s', p, simulationRewardPeriod.rewardPerPeriod);
                //     // console.log('(%s) stakeholder stakingBalance: %s', p, stakeholder.stakingBalance);
                //     // console.log('(%s) stakeholder claimedRewards: %s', p, stakeholder.claimedRewards);
                //     // console.log('(%s) stakeholder lockedRewards: %s', p, stakeholder.lockedRewards);
                //     console.log('(%s) Adding %s to : %s', p, newReward, stakeholder.claimedRewards);
                //     console.log('(%s) setting %s to : %s', p, stakeholder.lockedRewards, lockedRewards);
                // }
...
library AggregatedBalanceLib {
    ...
    function moveToDifferentWeight(
        ...
        internal {
            ...
            // console.log('previous old w: %s has %s', oldWeight, balances[oldWeight].weightCounts);
            // console.log('previous new w: %s has %s', newWeight, balances[newWeight].weightCounts);
            balances[oldWeight].weightCounts--;
            balances[newWeight].weightCounts++;

            // console.log('new old w: %s has %s', oldWeight, balances[oldWeight].weightCounts);
            // console.log('new new w: %s has %s', newWeight, balances[newWeight].weightCounts);
