...
contract PatreonFactory {
    Patreon[] public deployedPatreons;
    ...
    function getDeployedPatreon() public view returns (Patreon[] memory) {
        return deployedPatreons;
    }

    function psubscribe(uint256 patreonIndex) public {
        Patreon(address(deployedPatreons[patreonIndex])).subscribe();
    }
}
// pragma solidity ^0.8.4;
