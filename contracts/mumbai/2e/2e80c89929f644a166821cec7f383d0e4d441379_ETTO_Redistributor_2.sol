...
contract ETTO_Redistributor_2 is IERC777Recipient, ReentrancyGuard { 
    ...
    function getRandomNumber1() private view returns (uint256) {
        ...
        uint256 randomNumber = uint256(hash) % 199 + 2;
        return randomNumber;
    }
    ...
    function getRandomNumber4() private view returns (uint256) {
        ...
        bytes32 hash = keccak256(abi.encodePacked(random));
        uint256 randomNumber = uint256(hash) % 210 + 2;
        return randomNumber;
    }
    ...
    function getRandomNumber5() private view returns (uint256) {
        ...
        bytes32 hash = keccak256(abi.encodePacked(random));
        uint256 randomNumber = uint256(hash) % 220 + 2;
        return randomNumber;
    }
    ...
    function getRandomNumber6() private view returns (uint256) {
        ...
        bytes32 hash = keccak256(abi.encodePacked(random));
        uint256 randomNumber = uint256(hash) % 230 + 2;
        return randomNumber;
    }
