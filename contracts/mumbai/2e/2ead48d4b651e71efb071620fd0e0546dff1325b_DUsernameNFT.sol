 ...
 */
contract DUsernameNFT is ERC721, ReentrancyGuard, Ownable
{
	struct Username
	{
		string username;
	...
	uint public username_price = 100000000000000;
	uint public total_usernames = 0;
	uint public max_username_supply = 10000;


	
	constructor() ERC721("DAD-username-NFT", "DAD-Username") Ownable()
	{
