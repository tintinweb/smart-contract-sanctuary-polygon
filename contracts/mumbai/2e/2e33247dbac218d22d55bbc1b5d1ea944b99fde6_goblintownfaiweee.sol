...
// File: contracts/goblintownfaiweee.sol
...
contract goblintownfaiweee is ERC721A, Ownable, ReentrancyGuard{
    uint256 public constant maxSupply = 9000;
    uint public _price = 0.006 ether;
    uint256 public maxBuyPerTx = 7;
    bool public paused;
    

    constructor() ERC721A("goblintownfaiweee", "GTFE") {
        paused = true;
    }
    // Read the price
