...
contract StakerValidator is Ownable {
  ...
  constructor(address _staker, address _realtor, address _buildings, address _foxHen, address _crops, address _farmer, address _energy, address _henHouse, address _foxDen) {
