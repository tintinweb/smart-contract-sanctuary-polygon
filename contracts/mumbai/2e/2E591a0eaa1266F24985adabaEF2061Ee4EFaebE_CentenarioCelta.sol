...
//         // uint256 variance = getPriceInMatic() * slippage/100;
//         // require(getPriceInMatic() - variance <= msg.value, "Value send to high");
//         // require(getPriceInMatic() + variance >= msg.value, "Value send to low");
