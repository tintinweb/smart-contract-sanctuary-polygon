...
contract Ewallet {
    ...
    modifier lesserThanMiniPoolProfitTracker(uint256 amount) {
     ...
     function addToMiniPoolProfit(uint256 _profit, uint256 _individualID, uint256 _teamID, uint256 _amount) public {
     ...
     function subtractFromMiniPoolProfit(uint256 _individualID, uint256 _teamID, uint256 _amount) public lesserThanMiniPoolProfitTracker(_amount) {
