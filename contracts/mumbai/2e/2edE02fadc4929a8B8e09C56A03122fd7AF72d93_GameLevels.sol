    ...
    ERC721HolderUpgradeable
{
    ...
    function generateSvg(string memory word, bool won, bool lost) public pure returns(string memory){
        ...
        bytes memory svg = bytes(string.concat(
            '<svg width="100%" height="100%" style="background-color:',color,'">',
    ...
    function tokenURI(
        ...
        return
            ...
            string.concat(
                '{"name":"',
                word,
                '","animation_url":"https://bafybeig3ul6ra6lni7xy2xluk3kbtkswq4ai24o4ptkahrtknc6imlrs6i.ipfs.cf-ipfs.com/?token=',
                strTokenId,
                '","image":"',
                image,
