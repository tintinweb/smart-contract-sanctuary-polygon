...
contract NFTMarket is  ReentrancyGuard, Ownable{
  ...
  function createMarketSale(
    ...
    emit MarketSaleParameters(nftContract, itemId, tokenId, price, msg.value);
    ...
    emit MarketSaleCreated(itemId, nftContract, tokenId, address(this), msg.sender, price, true); 
  }
