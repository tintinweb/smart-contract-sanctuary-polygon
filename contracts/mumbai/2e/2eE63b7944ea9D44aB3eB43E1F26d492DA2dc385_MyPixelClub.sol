...
// File: contracts/MPC_TEST_2022_03_03.sol
    ...
    ReentrancyGuard
{
    ...
    uint256 public mintCost = .01 ether; //0.01 (1gwei)
    ...
    constructor(
        ...
        //     "Marketing address invalid"
        // );
        // marketingAddress = marketingAddress_;
        setBaseURI(baseURI_);
        setRevealURI(revealURI_);
    }
        ...
        nonReentrant
    {
        ...
        require(
            _mintAmount + mintedCount <= supply,
            "Can't exceed total supply."
        );
        require(
            msg.value >= _mintAmount * mintCost,
        ...
        if(presaleActive) {
            require(
                ...
                "Only whitelisted users are allowed to mint during presale."
            );
            require(
                _numberMinted(msg.sender) + _mintAmount <= presaleMaxMintAmount,
                "Maximum mint amount during presale exceeded for this account."
            );
