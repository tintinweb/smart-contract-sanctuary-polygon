...
contract SxTRelayProxy is Initializable, OwnableUpgradeable, ISxTRelay {
    ...
    function requestQueryString2D(
        ...
        bytes32 requestId = logicContract.requestQueryString2D(
            query, 
            resourceId,
            callerContract,
            callbackFunctionId,
    ...
    function requestQueryUint256(
        ...
        bytes32 requestId = logicContract.requestQueryUint256(
            query, 
            resourceId,
            callerContract,
            callbackFunctionId,
    ...
    function requestQueryBytes(
        ...
        bytes32 requestId = logicContract.requestQueryBytes(
            query, 
            resourceId,
            callerContract,
            callbackFunctionId,
    ...
    function requestQueryString(
        ...
        bytes32 requestId = logicContract.requestQueryString(
            query, 
            resourceId,
            callerContract,
            callbackFunctionId,
    ...
    function requestViewString2D(
        ...
        bytes32 requestId = logicContract.requestViewString2D(
            viewName,
            callerContract,
            callbackFunctionId,
            chainlinkJobId
    ...
    function requestViewUint256(
        ...
        bytes32 requestId = logicContract.requestViewUint256(
            viewName,
            callerContract,
            callbackFunctionId,
            chainlinkJobId
    ...
    function requestViewBytes(
        ...
        bytes32 requestId = logicContract.requestViewBytes(
            viewName,
            callerContract,
            callbackFunctionId,
            chainlinkJobId
    ...
    function requestViewString(
        ...
        bytes32 requestId = logicContract.requestViewString(
            viewName,
            callerContract,
            callbackFunctionId,
            chainlinkJobId
    ...
    function queryResponseString2D(bytes32 requestId, string[][] calldata data) external override { 
        logicContract.queryResponseString2D(
            requestId,
            data
        );
    }
    ...
    function queryResponseUint256(bytes32 requestId, uint256 data) external override { 
        logicContract.queryResponseUint256(
            requestId,
            data
        );
    }
    ...
    function queryResponseBytes(bytes32 requestId, bytes calldata data) external override { 
        logicContract.queryResponseBytes(
            requestId,
            data
        );
    }
    ...
    function queryResponseString(bytes32 requestId, string calldata data) external override { 
        logicContract.queryResponseString(
            requestId,
            data
        );
    }
