...
contract ChainBattles is ERC721URIStorage {
    ...
    function train(uint256 tokenId) public {
        ...
        _attributes.strength = strength + getRandomNumber(10);

        uint256 speed = _attributes.speed;
        _attributes.speed = speed + getRandomNumber(10);

        uint256 intellect = _attributes.intellect;
        _attributes.intellect = intellect + getRandomNumber(10);

        uint256 hitPoints = _attributes.hitPoints;
        _attributes.hitPoints = hitPoints + 100;
