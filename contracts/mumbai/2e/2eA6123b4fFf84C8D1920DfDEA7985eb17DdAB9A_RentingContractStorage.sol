...
contract RentingContractStorage is Context, IRentingContract, RBAC {
    ...
    function createListingInfo(BattleSet memory bs, uint rt, address owner, uint coin, uint256 _price,
        bool _perpetual, address[] memory whitelist, uint revenueShare) external onlyManager {
        _createListingInfo(bs, rt, owner, coin, _price, _perpetual, whitelist, revenueShare);
    }

    function _createListingInfo(BattleSet memory bs, uint rt, address owner, uint coin, uint256 _price,
        bool _perpetual, address[] memory whitelist, uint revenueShare) private {
    ...
    function createRenting(BattleSet memory bs, uint rt, uint coin, uint256 price, address owner, address renter,
    ...
    function editCollection(uint256 id, uint coin, uint256 price, uint rentingType, bool perpetual, uint revenueShare) external onlyManager {
