...
contract Fraction is ERC721, ERC721Enumerable, Pausable, ERC721Burnable, ERC721Royalty, AccessControlled {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    bytes32 internal MINTER = keccak256("MINTER");

    constructor(address _authority) ERC721("Fraction", "FRCT")  AccessControlled(IAuthority(_authority)) {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://metadata.songchain.ens.re/";
    }
    ...
    function safeMint(address to) public onlyRole(MINTER) returns (uint256) {
