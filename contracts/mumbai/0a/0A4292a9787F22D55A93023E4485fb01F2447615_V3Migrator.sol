...
import '../v3-core/contracts/interfaces/IBestDexV3Factory.sol';
import '../v3-core/contracts/interfaces/IBestDexV3Pool.sol';
...
abstract contract PoolInitializer is IPoolInitializer, PeripheryImmutableState {
    ...
    function createAndInitializePoolIfNecessary(
        ...
        pool = IBestDexV3Factory(factory).getPool(token0, token1, fee);

        if (pool == address(0)) {
            pool = IBestDexV3Factory(factory).createPool(token0, token1, fee);
            IBestDexV3Pool(pool).initialize(sqrtPriceX96);
        } else {
            (uint160 sqrtPriceX96Existing, , , , , , ) = IBestDexV3Pool(pool).slot0();
...
/// @notice Wraps BestDex V3 positions in a non-fungible token interface which allows for them to be transferred
/// and authorized.
...
interface IPeripheryImmutableState {
    /// @return Returns the address of the BestDex V3 factory
...
/// @title V3 Migrator
/// @notice Enables migration of liqudity from BestDex v2-compatible pairs into BestDex v3 pools
interface IV3Migrator is IMulticall, ISelfPermit, IPoolInitializer {
    struct MigrateParams {
        address pair; // the BestDex v2-compatible pair
...
library PoolAddress {
    // bytes32 internal constant POOL_INIT_CODE_HASH = 0xaf7d8aa5e9655f03fd381ac8d227f678ab24be5de68616f59ed8a543a795a27e;
    bytes32 internal constant POOL_INIT_CODE_HASH = 0x37ab1722d9d06c580a20625aeac2074f40117f6bb705f2139addd2dab6c98d1c;
    // bytes32 internal constant POOL_INIT_CODE_HASH = 0xa8025cfdb6f58fe8a5522e186843cc898914d0be019425b3b846b16f28461f9b;
    ...
    /// @param factory The BestDex V3 factory contract address
...
contract V3Migrator is IV3Migrator, PeripheryImmutableState, PoolInitializer, Multicall, SelfPermit {
    ...
    function migrate(MigrateParams calldata params) external override {
        ...
        IBestDexV2Pair(params.pair).transferFrom(msg.sender, params.pair, params.liquidityToMigrate);
        (uint256 amount0V2, uint256 amount1V2) = IBestDexV2Pair(params.pair).burn(address(this));
