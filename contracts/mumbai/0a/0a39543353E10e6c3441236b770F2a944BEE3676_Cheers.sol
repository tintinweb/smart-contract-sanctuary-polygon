...
contract Cheers is ERC1155, Ownable, ERC1155Supply {
    ...
    mapping(address => uint) public addessToTokenNumber;

    constructor() ERC1155("https://bafybeigujxesb6nndcotvcivzgoejbaymhjk3ajlld5fpi7l6kf7d2ju5e.ipfs.w3s.link/") {}
