...
contract AlligatorMerge is Ownable, VRFConsumerBaseV2, IMergeGators {
    ...
    function merge(uint256 _1st, uint256 _2nd, uint256 _3rd) public payable returns (bool[3] memory theMultiCallStat) {
        ...
        (bool success, ) = alligatorsAddress.call(abi.encodeWithSignature("createSkeleton(uint8, uint8, uint8, uint8, uint8, uint8, uint8)",
            _1stType[0],
            _2ndType[0],
            _3rdType[0],
            _4thType[0],
        ...
        (bool success0, ) = alligatorsAddress.call(abi.encodeWithSignature("createLevels(uint8, uint8, uint8, uint8, uint8, uint8, uint8)",
            _1stType[1],
            _2ndType[1],
            _3rdType[1],
            _4thType[1],
        ...
        (bool success1, ) = alligatorsAddress.call(abi.encodeWithSignature("merge(uint256, uint256, uint256, address)", _1st, _2nd, _3rd, msg.sender));
        _mergePrize(msg.sender);
        return [success, success0, success1];
    }
    ...
    function _compareTrait(uint256 _1st, uint256 _2nd, uint256 _3rd, uint8 _index) internal view returns (uint8[2] memory) {
...
contract AlligatorMergeMock is AlligatorMerge {
    ...
    uint256 constant taxPay_ = 0.0000001 ether;
    uint256 constant rewardPoolBPS = 10; 
    uint256 constant rewardPoolDistro = 1; 
    //11
    address constant collection = 0x4E1Eb608C7F643cD7e564B8Ffa3497a38d1052A8;
