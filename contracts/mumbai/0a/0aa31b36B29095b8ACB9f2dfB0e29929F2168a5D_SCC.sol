...
contract SCC is ERC721AUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    string private _baseTokenURI;

    address private constant ADMIN = 0xC5B4F2A7Ea7F675Fca6EF734d6F06FFB40dFC93F;
    ...
    function initialize() initializerERC721A initializer public {
        __ERC721A_init('SCC', 'SCC');
        __Ownable_init();
        __ReentrancyGuard_init();
    }

    function mint(uint256 quantity) external payable nonReentrant {
        _mint(_getAdmin(), quantity);
    }
