...
contract GachaItems is ERC1155, AccessControl, Ownable, ERC2981 {
    bytes32 public MINTER_ROLE = keccak256("MINTER_ROLE");
    string private _uri;

    constructor(string memory uri_, uint96 _royaltyFeeNumerator) ERC1155(uri_) {
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _setDefaultRoyalty(msg.sender, _royaltyFeeNumerator);
        _uri = uri_;
    }
