...
contract Ratings {
    ...
    function AddRating(string memory site, RatingDto memory rating) public {
        ...
        Index memory useriSteIndex = _userSiteRatingsIndex[msg.sender][site];
