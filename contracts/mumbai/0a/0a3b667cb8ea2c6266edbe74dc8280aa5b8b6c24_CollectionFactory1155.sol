...
import "./NiftyCollection1155.sol";
...
contract CollectionFactory1155 is Initializable, OwnableUpgradeable, PausableUpgradeable {
     ...
     * @param _royalty contract level royalty
     * @param _uri contract metadata uri
     */
    function create1155Collection(
        ...
        NiftyCollection1155 collection = new NiftyCollection1155(_name, _symbol, _royalty, _uri, msg.sender);
        ...
        emit Collection1155Created(msg.sender, address(collection), _royalty, _uri, block.timestamp);
...
import "./template/Niftyco1155Default.sol";

/**
 * @title NiftyCollection
...
contract NiftyCollection1155 is Pausable, Ownable, Niftyco1155Default {
    ...
    constructor(
        ...
        string memory _uri,
        address _admin
    ) Niftyco1155Default(name, symbol, _royalty, _uri, _admin) {
        _tokenIdCounter.increment();
        transferOwnership(_admin);
    }

    function mint(address account, uint256 amount) public override whenNotPaused {
        Niftyco1155Default.mint(account, amount);
    }
    ...
    function mintBatch(
        ...
        Niftyco1155Default.mintBatch(to, amounts, data);
    }
}
...
contract Niftyco1155Default is ERC1155, ERC2981, Pausable, ERC1155Burnable, ERC1155Supply, AccessControl, Role {
    using Counters for Counters.Counter;
    ...
    constructor(
        ...
        symbol = _symbol;
        _tokenIds.increment();
        _setDefaultRoyalty(_admin, _royalty);
    ...
    function setDefaultRoyalty(address _creator, uint96 _royalty) public onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function mint(address account, uint256 amount) public virtual onlyRole(DEFAULT_ADMIN_ROLE) {
