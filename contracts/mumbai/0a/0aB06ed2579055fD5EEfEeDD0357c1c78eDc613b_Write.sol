...
contract Write is IExecutePlugin, BasePluginWithRules {
    ...
    function execute(
        ...
        (address _communityId , address _repostFromCommunity, , , , , , , uint256 _subscriptionId) =
        abi.decode(_data,(address, address, address, string, uint256, string[], bool, bool, uint256));
        ...
        checkRuleWithNftId(RulesList.POST_PLACING_RULES, _communityId, _sender, _subscriptionId);
