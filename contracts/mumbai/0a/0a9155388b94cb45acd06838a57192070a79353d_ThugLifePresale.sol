...
contract ThugLifePresale is Ownable {
    using SafeMath for uint;

    address public tokenAddr;
    
    uint256 public tokenPriceMatci = 62500000000000;  //1BNB=16000 THUG TOKEN 
    ...
    uint256 public maxContribution = 10e30; //10
    uint256 public hardCap = 1e40; 
    ...
    function ExchangeBNBforToken(address _addr, uint256 _amount) private {
        ...
        bnbAmount = ((amount.mul(10 ** uint256(tokenDecimal)).div(tokenPriceMatci)).mul(10 ** uint256(tokenDecimal))).div(10 ** uint256(tokenDecimal));
    ...
    function buyToken() public payable {
            ...
            amountRaisedMATIC = amountRaisedMATIC + (msg.value);
            bnbAmount = ((amount.mul(10 ** uint256(tokenDecimal)).div(tokenPriceMatci)).mul(10 ** uint256(tokenDecimal))).div(10 ** uint256(tokenDecimal));
