...
contract ReworkedMarmottIsERC1155 is ERC1155, ERC2981, Ownable, ReentrancyGuard {
    ...
    uint public maxByFreeMint = 1; // Max number of NFTs that can be minted by free mint
    uint public maxByReservation = 1; // Max number of NFTs that can be minted by reservation
    uint public maxByWhitelist = 1; // Max number of NFTs that can be minted by whitelist
    ...
    */
    function mint(uint idToMint, bytes32[] calldata _proof) public payable nonReentrant {
        ...
        if (currentStep == Step.FreeMint) {
            ...
            require(freeMintByWallet[msg.sender] + 1 <= maxByFreeMint, "Max free mint reached");
            ...
            require(reservationMintByWallet[msg.sender] + 1 <= maxByReservation, "Max reservation mint reached");
            ...
            require(firstWhitelistMintByWallet[msg.sender] + 1 <= maxByWhitelist, "Max first whitelist mint reached");
            ...
            require(msg.value >= whitelistPrice, "Not enought ether");
            require(secondWhitelistMintByWallet[msg.sender] + 1 <= maxByWhitelist, "Max second whitelist mint reached");
