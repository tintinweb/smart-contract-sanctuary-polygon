    ...
    KeeperCompatibleInterface
{
    ...
    mapping(ISwixCity => mapping(uint256 => mapping(uint256 => uint256))) public bookingIndexes;
        ...
        override
    {
        ...
        bookingIndexes[city][leaseIndex][nights[0]] = i;
        ...
        uint256 endNight    = nights.length + nights[0] - 1;
    ...
    function _deleteBooking(uint256 bookingIndex) internal {
        ...
        emit BookingIndexUpdated(bookingIndex, bookings.length);
    }
    ...
    function getBookingIndex(
        ...
        returns (uint256)
    {
        uint256 index = bookingIndexes[city][leaseIndex][startNight];
        if (index == 0) {
            require(bookings[0].city == city);
            require(bookings[0].leaseIndex == leaseIndex);
            require(bookings[0].start == startNight);
        }
        return index;
    }
