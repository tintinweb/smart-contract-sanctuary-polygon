...
contract ERC20 is Context, IERC20, Pausable, Ownable, ReentrancyGuard {
    ...
    /**
     * @dev Recover ERC20 tokens from contract address.
     */
    function tokenRecover(address contractAddress, uint256 amount)
        external
        onlyOwner
        whenNotPaused
        nonReentrant
    {
        require(
            ...
            "ERC20: Address cant be zero address"
        );
...
contract SampleSaleToken is ERC20 {
    constructor() ERC20("farmsent", "FARMSENT", 18) {
