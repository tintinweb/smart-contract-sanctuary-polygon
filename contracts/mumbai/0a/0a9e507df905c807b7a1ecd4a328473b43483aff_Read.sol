...
// File contracts/account/interfaces/IAccount.sol
...
// File contracts/community/interfaces/ICommentData.sol
...
// File contracts/community/interfaces/ICommunityBlank.sol
pragma solidity 0.8.19;
...
// File contracts/community/interfaces/ISinglePostData.sol
pragma solidity 0.8.19;
...
// File contracts/registry/interfaces/IRegistry.sol
pragma solidity 0.8.19;
...
// File contracts/tokens/subscription/interfaces/ISubscription.sol
...
// File contracts/libraries/UserLib.sol
pragma solidity 0.8.19;
library UserLib {
...
// File contracts/plugins/BasePlugin.sol
pragma solidity 0.8.19;
...
// File contracts/plugins/PluginsList.sol
...
// File contracts/tokens/nft/interfaces/INFT.sol
pragma solidity 0.8.19;
...
// File contracts/plugins/singlepost/Read.sol
pragma solidity 0.8.19;
contract Read is BasePlugin {
    ...
    function read(
        ...
        uint256 paymentType = postData.paymentType;
        if (paymentType > 0) {
            if (sender == address(0)) {
                postData.ipfsHash = "";
            } else {
                require(registry.hasAnyPayment(sender, paymentType), "Read: the user did not pay for access");
            }
        }
