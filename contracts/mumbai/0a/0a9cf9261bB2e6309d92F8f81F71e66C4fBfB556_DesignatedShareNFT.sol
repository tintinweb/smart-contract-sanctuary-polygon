...
contract DesignatedShareNFT is ERC721 {
    ...
    function getTokenIdsByAddress(address owner) internal view returns (uint256[] memory){
        return (ownerToTokenIds[owner]);
    }

    function getAddressByTokenId(uint256 _tokenId) internal view returns (Share[] memory){
