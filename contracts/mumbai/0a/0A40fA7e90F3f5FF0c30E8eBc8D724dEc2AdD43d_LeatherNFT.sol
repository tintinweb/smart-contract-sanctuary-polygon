...
import "./interfaces/ILeatherNFT.sol";

contract LeatherNFT is ILeatherNFT, ERC721Enumerable, Governable {
    ...
    /// @notice Cannot mint tokens when pause is set as true.
    bool public paused;
    ...
    */
    constructor(
        ...
        address _governance
    ) ERC721(_name, _symbol) Governable(_governance) {
    ...
    */
    function mint(address _user, uint256 _tokenID) external override {
        _safeMint(_user, _tokenID);
        _setApprovalForAll(_user, address(this), true);
    }
    ...
    ***************************************/
    ...
    /**
     * @notice Pauses or unpauses mint.
    ...
    */
    ...
    /**
     * @notice Sets new registry.
     * Can only be called by the current governance.
     * @param _registry The new registry address;
    */
    function setRegistry(address _registry) public override onlyGovernance {
        require(_registry != address(0x0), "zero address registry");
        registry = _registry;
    }
    ...
    ***************************************/
    ...
    /**
     * @notice Override _beforeTokenTransfer hook from ERC721 standard to ensure nfts are non-transferable, and only one can be minted per user.
...
interface ILeatherNFT {
    ...
    /// @notice Emitted when token uri is set
