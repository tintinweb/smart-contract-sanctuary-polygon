...
contract PolygonBusinessCard is ERC1155, ERC2771Context, Ownable  {
    ...
    constructor(string memory _name, string memory _symbol, address _forwarder, string memory _uri) ERC1155("") ERC2771Context(_forwarder) {
        name = _name;
        symbol = _symbol;
    ...
    function mint() public {
        require(!isClaimed[_msgSender()], "NFT already claimed with this address!");
        require(totalNFTMinted < maxSupply, "Max supply reached!");
        totalNFTMinted += 1;
