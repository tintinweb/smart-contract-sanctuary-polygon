...
contract OmContract is SemaphoreCore, SemaphoreGroups {
    ...
    // event ProposalCreated(uint256 indexed groupId,string indexed title, string description, uint256 indexed proposalId,uint256 startDate,uint256 endDate,string fileUri);// OK
...
//----------Voting
    ...
    function addData(
        ...
        dataList[dataFileCounter] = dataStructure(dataFileCounter,title,size,msg.sender,block.timestamp,IpfsURI,groupId);
