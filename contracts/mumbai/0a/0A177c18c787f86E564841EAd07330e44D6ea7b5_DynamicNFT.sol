...
contract DynamicNFT is Initializable, ERC1155URIStorageUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function mint(address recipient, uint256 amount, string memory tokenURI) public {
    ...
    function _authorizeUpgrade(address newImplementaition) internal override onlyOwner {}
}
