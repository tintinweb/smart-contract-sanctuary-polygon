    ...
    BatchMintMetadata
{
        ...
        onlyAdmin
    {
        ...
        require(balanceOf[address(jackpotPrizeWinner)][ _tokenId] > 0, "No tickets issued for this draw");
        
        uint256 mainPrizeAmount = balanceOf[address(jackpotPrizeWinner)][ _tokenId] * 1250;
        // Transfer for main prize for winner
        IERC20(payoutTokenAddress).transfer(jackpotPrizeWinner, mainPrizeAmount);
        ...
        for (uint256 index = 0; index < smallPrizeWinners; index++) {
            ...
            require(balanceOf[address(smallWinner)][ _tokenId] > 0, "No tickets issued for this draw");
            IERC20(payoutTokenAddress).transfer(smallWinner, 1000);
        }
    }
