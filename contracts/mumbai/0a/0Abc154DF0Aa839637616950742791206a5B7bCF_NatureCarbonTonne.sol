...
contract NatureCarbonTonne is Pool {
    ...
    function initialize() external virtual initializer {
        ...
        __Ownable_init_unchained();
        __Pausable_init_unchained();
        __ERC20_init_unchained('BuckMint Protocol: Nature Carbon Tonne', 'NCT');
...
/// ERC20 compliant token that acts as a pool for BCO2 tokens
//slither-disable-next-line unprotected-upgrade
    ...
    PoolStorage
{
    ...
    /// @notice Deposit function for pool that accepts BCO2s and mints pool token 1:1
    ...
    /// @notice Checks whether incoming BCO2s match the accepted criteria/attributes
...
abstract contract PoolStorage is PoolStorageV1, PoolStorageV1_1, PoolStorageV1_2, PoolStorageV1_3 {}