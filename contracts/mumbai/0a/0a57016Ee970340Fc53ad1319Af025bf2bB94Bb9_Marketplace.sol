...
contract Marketplace is Ownable{
    ...
    function buyRental(Order memory sellOrder, bytes memory sellSignature, uint256 numberOfRentals) external payable{
        ...
        doPaymentTransfer(totalPayment, sellOrder.maker, sellOrder.payment, platformPayment);
    ...
    function doPaymentTransfer(uint256 totalPayment, address seller, Payment memory payment, uint256 platformPayment) internal {
