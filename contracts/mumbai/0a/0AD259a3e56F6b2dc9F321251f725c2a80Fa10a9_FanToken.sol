...
contract ERC20 is IERC20, IERC20Metadata, Admin, ReEntrancyGuard {
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public virtual
                                                    activeContract override returns (bool) {
        _validateTransfer(recipient, amount);
...
contract FanToken is ERC20 {
    ...
    function buyTokensWithMATIC(uint256 _amountOfTokens) public payable
        ...
        //      with a message.
        uint priceUpdated = _updateMaticPrice();
        
        uint256 priceInWei = ((tokenPrice) * _amountOfTokens) * 1e9; /* 1e9 = unit  */
        uint256 result     = (priceInWei / uint(lastMaticPrice)) * 1e9;
        require((priceUpdated == 2) || (msg.value >= result), "The MATIC price just change. Check again.");
     ...
     */
    function _updateMaticPrice() public returns (uint) {
