...
contract Web3MakeoversSoulbounds is ERC5633, AccessControl, Ownable {
    bytes32 public constant ADMIN_ROLE = keccak256('ADMIN_ROLE');

    mapping(uint => bool) private initialized;

    event TokenMinted(address indexed to, uint tokenId, uint amount);
    event TokenInitialized(uint indexed tokenId, string tokenUri, bool isSoulbound);
    ...
    function initializeToken(
        ...
        emit TokenInitialized(_tokenId, _tokenUri, _soulbound);
    }
