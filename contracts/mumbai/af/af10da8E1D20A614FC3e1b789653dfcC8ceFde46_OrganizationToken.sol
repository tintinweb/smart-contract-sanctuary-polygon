...
contract OrganizationToken is Initializable, 
    ERC20Upgradeable, 
    ...
    function snapshot() public onlyRole(EXECUTOR_ROLE) {
        _snapshot();
    }

    function mint(address to, uint256 amount) public onlyRole(EXECUTOR_ROLE) {
        _mint(to, amount);
    }

    function burn(address to, uint256 amount) public onlyRole(EXECUTOR_ROLE) {
        _burn(to, amount);
    }
