...
// File contracts/EMAstronaut.sol
...
contract EMAstronaut is ERC721A, ERC721APausable, ERC721AQueryable, Ownable {
    ...
    constructor(string memory name_, string memory symbol_, string memory baseUri_, string memory notRevealedUri_)
    ...
    function safeMint(address to, uint256 quantity) external{
        require(_operators[_msgSender()], "Not an operator");
        _safeMint(to, quantity);
    }
