...
contract UTBETSUSDCStaking is Ownable {
    ...
    uint256 public constant StakeThreshold = 0.001 ether;
    ...
    function stake(uint256 _amount) public {
        require(_amount >= StakeThreshold, "Have to stake at least 1 lp.");
    ...
    function poolNewRewardRate() public view returns (uint256) {
        ...
        uint256 rewardRate = pool.totalStakedAmount == 0
            ? 0
            : poolReward * StakeThreshold / pool.totalStakedAmount;
        return rewardRate;
    }
    ...
    function claimableAmount(address _holder) public view returns (uint256) {
        ...
        return stakeOfAddress[_holder].claimableAmount + rewardRate * stakeOfAddress[_holder].depositAmount / StakeThreshold;
    }
}
