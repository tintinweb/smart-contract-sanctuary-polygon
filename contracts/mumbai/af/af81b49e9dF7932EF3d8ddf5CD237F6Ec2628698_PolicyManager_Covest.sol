	...
	ReentrancyGuardUpgradeable
{
		...
		returns (bool)
	{
		(uint256 _valueSub, , uint256 _percentSub, string memory _orgSub) = SUB
			.checkSubsidized(
				msg.sender,
				_buyPolicyParams.asset,
				_buyPolicyParams.pricing[0] * 10**_buyPolicyParams.pricing[2],
				poolId
			);
		...
		checkAsset(_buyPolicyParams.asset)
	{
		...
		uint256 _value = _buyPolicyParams.pricing[0] *
			10**_buyPolicyParams.pricing[2];
		require(
		...
		require(
			_buyPolicyParams.pricing[2] == _ERC20.decimals(),
	 ...
	 * @param _coveragePeriodDays The day of the policy will cover.
