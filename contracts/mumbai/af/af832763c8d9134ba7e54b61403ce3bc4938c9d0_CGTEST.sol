...
contract CGTEST is ERC721Enumerable, Ownable {
  ...
  uint256 public cost = 420000000000000000; // 0.025 eth ( cost in wei )
  ...
  address public firstWallet = 0x13D67436b4fD1Ea8AEe2003813d7bE785C1479E4;
  address public secondWallet = 0xde9b65c28A597585bce9b24D5240180C31A7b7b5;
  address public thirdWallet = 0xea92907fad773428E0767948a8d262D22895Be12;
  address public fourthWallet = 0x905bDBd418756c0d0781C95D71CDC3F0ddA5E395;  
...
if (msg.sender != owner()) {
        ...
        if (presale == true) {
            ...
            /*if(whitelisted [msg.sender] == true) {
               require(supply + 1 <= presaleSupply, "Max supply for Presale One reached!");
