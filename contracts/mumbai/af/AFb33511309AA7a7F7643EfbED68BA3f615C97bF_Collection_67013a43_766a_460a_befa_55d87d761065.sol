...
contract Collection_67013a43_766a_460a_befa_55d87d761065 is ERC721A, Ownable,  ContextMixin, ReentrancyGuard{
  uint256 public constant maxSupply = 20;
  uint public _price = 10 ether;
  uint256 public maxBuyPerTx = 1;
  bool public paused;
  string public _metaURI = "https://ipfs.moralis.io:2053/ipfs/QmQSXStxMFbYreFnr1Ceks3SU2xVyVgJSCNGxzRMzUDf65/collection/67013a43-766a-460a-befa-55d87d761065.json";
  // Metadata URI
  string private _baseTokenURI = "https://ipfs.moralis.io:2053/ipfs/QmYc2HA3QLKysfYY9PgJ2DchG44cva19HZ2cFsgSowiVpY/metadata/";


  constructor() ERC721A("Test esam", "test-esam-87") {
    paused = true;
  }
  // Read the price
  ...
  function collectionMint(uint256 _qty) external onlyOwner {
