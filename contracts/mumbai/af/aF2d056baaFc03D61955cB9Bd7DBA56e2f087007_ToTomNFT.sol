...
contract ToTomNFT is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    constructor(string memory _name, string memory _simbol)
        ERC721(_name, _simbol)
    {}
    ...
    function crossmint(address _to, string memory uri) public payable {
        require(mintPrice == msg.value, "Incorrect value sent");
