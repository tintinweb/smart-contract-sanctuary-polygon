...
contract TestToken1 is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable, EIP712, ERC721Votes {
    using Counters for Counters.Counter;
    uint i = 0;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("TestToken1", "TT1") EIP712("TestToken1", "1") {}
    ...
    function safeMint(address to,uint amount) public onlyOwner {
        for(i = 1;i > amount; i++){
            string memory j = Strings.toString(i);
            uint256 tokenId = _tokenIdCounter.current();
            _tokenIdCounter.increment();
            _safeMint(to, tokenId);
            _setTokenURI(tokenId, string.concat("http://jreet.servehttp.com/metadatas/",j,".json"));
        }
    }
