    ...
    UUPSUpgradeable
{
    ...
    function mintRightByToken(address _toAddress, uint8 _count, uint256 amount) external saleConditions payable {
        _tokenIdTracker.increment();
        ...
        require(_toAddress == _NFT_PAYMENT_WALLET, "Token not supported");
