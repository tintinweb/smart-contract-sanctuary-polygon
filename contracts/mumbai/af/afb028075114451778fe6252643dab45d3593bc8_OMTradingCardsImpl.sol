...
// File: contracts/interfaces/INFTArtGenUpgradeable.sol



pragma solidity ^0.8.7;

interface INFTArtGenUpgradeable {
  /**
   *
  ...
  IOMTradingCards
{
  ...
  function __OMTradingCards_init(address _erc721Address, uint256 _commission)
    internal
    onlyInitializing
  {
    __ERC1155_init("");
  ...
  function openPack(uint256 _tokenId, uint256 _count) external {
    ...
    INFTArtGenUpgradeable erc721 = INFTArtGenUpgradeable(erc721Address);
  ...
  function uri(uint256 _tokenId)
    public
    view
    override(ERC1155Upgradeable, IOMTradingCards)
...
// File: contracts/OMTradingCardsImpl.sol




contract OMTradingCardsImpl is OMTradingCards, UUPSUpgradeable {
  function initialize(address _erc721Address, uint256 _commission)
    public
    initializer
  {
    __OMTradingCards_init(_erc721Address, _commission);
  }
