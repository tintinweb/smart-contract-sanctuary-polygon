...
contract MetaOMaticM6 is IPOLYCONTRACTM6 {
    ...
    constructor() public {
      ...
      maincontract=IPOLYCONTRACTMAIN(0x48f1d4E49ee72B76E9981128A52D2B70b3D03079);
    ...
    function _Withdrawal() public {
      uint256 amount = _UserM6Bonus[msg.sender].availableBonus;
      _UserM6Bonus[msg.sender].usedBonus += amount;
      _UserM6Bonus[msg.sender].availableBonus -= amount; 
