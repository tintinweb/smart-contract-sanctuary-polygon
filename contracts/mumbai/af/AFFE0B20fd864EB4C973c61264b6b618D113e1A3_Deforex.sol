...
contract Deforex is IDeforex, Ownable {
        ...
        returns (PositionParams storage params, uint256 amountOut)
    {
        ...
        require(
            params.status == PositionStatus.OPEN,
            "Deforex: Position is not open"
        );
    ...
    function _distributionActive(
        ...
        IAlp(alpAddr).returnReserve(position.amount * (position.leverage - 1));
        ...
        )
    {
        ...
        IAlp(alpAddr).returnReserve(leverageAmoutOut);
