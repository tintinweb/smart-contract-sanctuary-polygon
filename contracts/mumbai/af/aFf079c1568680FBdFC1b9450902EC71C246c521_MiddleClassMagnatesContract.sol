...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1655668800;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1655478000;
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x44758F73b9459F788D6D0fbE905724FdaEEa873C];
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 250) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeigyu35fruepvupr2kpkva4keoijzzn4mhr4nnembfvnohh6mqq33a/";
...
// File: contracts/MiddleClassMagnatesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MiddleClassMagnatesContract is RamppERC721A {
    constructor() RamppERC721A("Middle Class Magnates", "MCMAGS"){}
}
