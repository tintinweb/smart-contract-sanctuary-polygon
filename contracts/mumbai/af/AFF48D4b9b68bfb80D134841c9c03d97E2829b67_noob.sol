...
contract noob is ERC721SignatureMint {
        ...
        returns (address signer)
    {
        ...
        //_setTokenURI(tokenIdToMint, _req.uri);
        //_safeMint(receiver, _req.quantity);
        uint256 rewardsshera = _req.quantity * 10**18;
        rewardsToken.transfer(receiver, rewardsshera);
        emit TokensMintedWithSignature(signer, receiver, 2, _req);
    }
}