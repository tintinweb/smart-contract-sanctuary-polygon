...
contract HollandStakingContract is Ownable, ReentrancyGuard {
    ...
    uint256 constant internal durationMonth = 1 days;
    ...
    // uint256 constant public rewardsClamingCooldown = 7 days;
    uint constant public rewardsClamingCooldown = 10 minutes;
