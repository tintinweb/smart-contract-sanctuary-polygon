...
contract CRPoolProxy is Ownable, ERC1155Holder {
    ...
    function updateWeight(
        ...
        uint256 cost = ICRPool(_pool).getUpdateWeightCost(_token, _newWeight);
    ...
    function removeToken(address _pool, address _token) external {
        ...
        uint256 xLPTCost = ICRPool(_pool).getRemoveTokenCost(_token);
...
interface ICRPool is IERC20 {
    ...
    function getUpdateWeightCost(address token, uint256 newWeight) external returns (uint256);
    ...
    function getRemoveTokenCost(address _token) external returns (uint256);
