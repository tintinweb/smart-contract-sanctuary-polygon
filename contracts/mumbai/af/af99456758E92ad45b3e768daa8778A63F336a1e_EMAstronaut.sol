...
contract EMAstronaut is ERC721A, ERC721APausable, ERC721AQueryable, Ownable {
    ...
    function safeMint(address to, uint256 quantity) external{
        require(_operators[_msgSender()], "EMAstronaut(safeMint): Not an operator");
        _safeMint(to, quantity);
    }

    function burn(uint256 tokenId) external {
        require(_operators[_msgSender()], "EMAstronaut(burn): Not an operator");
        _burn(tokenId);
    }
    ...
    function _beforeTokenTransfers(
        ...
        require(_operators[_msgSender()], "EMAstronaut(tranfer): Not an operator");
