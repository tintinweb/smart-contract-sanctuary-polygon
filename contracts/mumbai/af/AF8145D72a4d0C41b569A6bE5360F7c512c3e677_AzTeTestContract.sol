...
// File: contracts/AzTeTestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract AzTeTestContract is 
    ERC1155,
    Ownable, 
    Pausable, 
    ERC1155Supply, 
    ...
    Allowlist
{
    ...
    */
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/MmvQgXeli1cjmd0c2LGN/contract-metadata";
    }
