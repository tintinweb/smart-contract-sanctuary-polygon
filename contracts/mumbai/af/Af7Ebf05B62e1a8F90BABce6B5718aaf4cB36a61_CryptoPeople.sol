    ...
    AccessControlUpgradeable
{
    ...
    function setAdmin(address newAdminAddress) public onlyRole(DEFAULT_ADMIN_ROLE) {
        if (newAdminAddress == address(0)) revert InvalidAddress(newAdminAddress);
    ...
    function setMinter(address newMinterAddress) public onlyRole(DEFAULT_ADMIN_ROLE) {
        if (newMinterAddress == address(0)) revert InvalidAddress(newMinterAddress);
    ...
    function setRoyaltyCollector(address royaltyCollector) public onlyRole(DEFAULT_ADMIN_ROLE) {
        if (royaltyCollector == address(0)) revert InvalidAddress(royaltyCollector);
	 ...
	 */
	function _burn(uint256 tokenId) internal override(ERC721RoyaltyUpgradeable, ERC721URIStorageUpgradeable, ERC721Upgradeable) {
