...
contract Ukraine is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    event MintToken(address indexed operator, uint256[] ids, uint256 price);
    ...
    function mint(
        ...
        bytes32 hash = hashTransaction(msg.sender, tokenId[0], nonce);
        ...
        emit MintToken(msg.sender, tokenId, publicSaleNFTPrice * tokenId.length);
    }
    ...
    function hashTransaction(
        ...
        bytes32 hash = keccak256(
            abi.encodePacked(
                ...
                keccak256(abi.encodePacked(sender, ti, nonce))
            )
        );
