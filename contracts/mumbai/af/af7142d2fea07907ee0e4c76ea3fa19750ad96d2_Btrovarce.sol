...
contract Btrovarce is ERC721, Ownable {
    ...
    function buy(uint256 tokenId , address _constant) payable public {
        ...
        IERC721 buyOfContract =  collection.contractAddressCollection; 
        ...
        address ownerCollection =  collection.ownerOfCollection; // owner collection for send profit
        ...
        uint profitAmount = msg.value * collection.percentOfCommission / 100;

        
        uint sellerAmount = (msg.value  - FeeAmount);
        uint profit = (msg.value  - profitAmount);
    ...
    function acceptBidForItem(uint256 tokenId, address _contract) public onlyOwnerItem(_msgSender(), tokenId,_contract){
       ...
       // handle Calc
        ...
        uint profitAmount = bid.value* collection.percentOfCommission / 100;
