...
contract BuddieThePlatypus is ERC721, ERC721URIStorage, PaymentSplitter, Ownable {
    ...
    constructor(string memory _URI,  address[] memory _payees,  uint256[] memory _shares) 
        ERC721("Buddie the Platypus", "BUDD") 
    ...
    function publicMint(address to)
        ...
        public
    {
        require(msg.value == 12 ether, "Not enough Matic to mint.");
        require(count +1 <= TOTAL, "No more Buddies to mint.");
