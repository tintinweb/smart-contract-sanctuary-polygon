 ...
 */
contract ERC1155SlabsCollection is
    ERC1155Supply,
    ERC2771Context,
    Authorizable,
    Whitelist,
    ERC2981
{
    ...
    function batchCreate(
        ...
        require(
            ...
            "_amount length must be equal to uri"
        );
        ...
        override
    {
        if (operator.isContract()) {
            require(
                ...
                "ERC1155-Collection: Only whitelist is allowed"
            );
        }
