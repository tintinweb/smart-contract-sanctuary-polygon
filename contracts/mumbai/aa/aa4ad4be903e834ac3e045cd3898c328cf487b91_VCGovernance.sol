...
contract VCGovernance {
    ...
    function setupProtocol(
        ...
        address[] memory noFeeAccounts = new address[](3);
        noFeeAccounts[0] = _marketplaceFixedPrice1155;
        noFeeAccounts[1] = _marketplaceFixedPrice721;
        noFeeAccounts[2] = _marketplaceAuction721;
        starter.addNoPoolFeeAccounts(noFeeAccounts);
