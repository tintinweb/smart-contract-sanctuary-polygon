    ...
    return string(abi.encodePacked(
      string(abi.encodePacked(
        ...
        _getSvg2(
          ...
          2,
          s.palette,
          string(abi.encodePacked("breed", toString(s.breed), "color", toString(s.palette)))
        ),
      ...
      /* Head (A/B) */
        _getSvg2(
          ...
          s.head,
          isMale_ ? 
            string(abi.encodePacked("breed", toString(s.breed), "head", toString(s.head), "a")) :
            string(abi.encodePacked("breed", toString(s.breed), "head", toString(s.head), "b"))
        ),
      /* Hat (A/B) */
      _getSvg1(
        isMale_ ? 3 : 4,
