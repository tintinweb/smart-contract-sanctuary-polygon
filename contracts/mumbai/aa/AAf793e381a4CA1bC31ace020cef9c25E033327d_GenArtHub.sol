...
contract GenArtHub is ERC721Enumerable, Ownable, IGenArtHub {
  ...
  */
  ...
  function updateProjectDescription(uint256 _projectId, string memory _description) public onlyArtist(_projectId) {
    projects[_projectId].description = _description;
  }

  function updateProjectWebsite(uint256 _projectId, string memory _website) public onlyArtist(_projectId) {
    projects[_projectId].website = _website;
  }

  function updateProjectLicense(uint256 _projectId, string memory _license) public onlyArtist(_projectId) {
  ...
  function updateProjectAdditionalPayee(uint256 _projectId, address payable _additionalPayee, uint256 _additionalPayeePercentage) public onlyArtist(_projectId) {
  ...
  function updateProjectTokenURI(uint256 _projectId, uint256 _tokenId, string memory _tokenURI) public onlyUnlocked(_projectId) onlyArtistOrWhitelisted(_projectId) {
  ...
  /**
    Getters
  */
  function projectDetails(uint256 _projectId) public view
  returns (
  ...
  function projectScriptInfo(uint256 _projectId) external view
  returns (
  ...
  function getRoyaltyData(uint256 _tokenId) public view
    returns (
      address artistAddress,
      address additionalPayee,
      uint256 additionalPayeePercentage,
