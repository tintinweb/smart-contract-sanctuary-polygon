...
//File： fs://1d83365b474845bda1456aeac640cf46/NFT.sol
...
contract NFT is DefaultOperatorFilterer, ERC721A, Ownable {
    ...
    constructor() ERC721A("NFT Project", "NFTP") {
        contractUri = "https://gateway.pinata.cloud/ipfs/QmQnEmQriVKPEQ5y1EneAKHREWsRB4XjQdsFE3rX2dWqhD";
        nftUri = "https://gateway.pinata.cloud/ipfs/QmQnEmQriVKPEQ5y1EneAKHREWsRB4XjQdsFE3rX2dWqhD";
        contractOwner = msg.sender;
    } 

    function mint(uint256 _amount) public payable {
        uint256 supply = totalSupply();
        require(msg.value > 0, "Voce precisa informar um valor");
        require(_amount > 0, "Voce precisa informar a quantidade de NFTs que voce precisa");
        require(_amount <= maxSupply, "Quantidade de NFTs superior do permitido no momento");
        require(msg.value >= (price * _amount), "Voce precisa informar o valor em crypto correto");
        require(supply + _amount <= maxSupply, "Quantidade de NFTs superior do permitido no momento");
    ...
    function setTokenURI(string memory _nftURI) external onlyOwner {
        nftUri = _nftURI;
    }
    ...
    function destroy() public onlyOwner {
        require(msg.sender == contractOwner, "Apenas o dono do contrato pode executar");
        selfdestruct(payable(contractOwner));
    }

    function burn(uint256 _tokenId) external {
        require(ownerOf(_tokenId) == msg.sender || msg.sender == contractOwner, "Voce nao tem permissao");
        _burn(_tokenId);
    }
