...
contract MainBridge {
    ...
    function bridgeTokens (address sideToken,address _requester, uint _bridgedAmount, bytes32 _mainDepositHash)  private {
    ...
    function returnTokens (address sideToken,address _requester, uint _bridgedAmount, bytes32 _sideDepositHash) private {
