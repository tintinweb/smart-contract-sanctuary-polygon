...
contract METASENSYS_Diamond_Package  is ERC721Enumerable, Ownable
{
   ...
   uint256 public DiamondCounter=0;
//    uint256 public DiamondCounter=0;
//    uint256 public DiamindCounter=0;    
        ...
        uint public DiamondPrice= 0.0089581 ether;
    ...
    constructor() ERC721("METASENSYS_Diamond_Package", "MSSG")  {
     _baseURI= "https://metasensys.mypinata.cloud/ipfs/QmP4YzjoVh4UZarpwUtvMyXXVPuzo2rokkg6wzABnC4dfN/";
    // contractURI();
    }
    ...
    function mint(uint chosenAmount) public payable isSaleOpen
    {
            ...
            require(DiamondPrice.mul(chosenAmount) == msg.value, "Sent ether value is incorrect");
    ...
    function Change_DiamondPrice(uint slPrice) public onlyOwner{
        DiamondPrice=slPrice;
    } 
