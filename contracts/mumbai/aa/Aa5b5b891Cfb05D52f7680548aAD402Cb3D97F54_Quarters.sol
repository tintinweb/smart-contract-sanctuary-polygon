...
// SPDX-License-Identifier: MIT
// OpenZeppelin Contracts (last updated v4.6.0) (token/ERC20/extensions/draft-ERC20Authorization.sol)
...
abstract contract ERC20Authorization is ERC20, IEIP3009, EIP712 {
    ...
    string internal constant INVALID_NONCE_ERROR =
        "EIP3009: invalid nonce is used";
    ...
    function getNonceInByte(address owner) external view returns (bytes32) {
        Counters.Counter storage nonce = _nonces[owner];
        return convert(nonce.current());
    }
    ...
    function _transferWithAuthorization(
       ...
       // require(convert(_useNonce(from)) == nonce, INVALID_NONCE_ERROR);
        require(
