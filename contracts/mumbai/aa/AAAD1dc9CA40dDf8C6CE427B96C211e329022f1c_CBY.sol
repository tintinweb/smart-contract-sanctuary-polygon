...
contract CBY is ERC20 {
    ...
    address public feeReceiver = 0xa7B7D3dAfFAF0476B9Bf70bD4a83fb5A7A8672e5;
    uint256 public feePercent = 200;
    ...
    */
    ...
    function setFeePercent(uint256 _feePercent) external {
        require(msg.sender == owner, "Only fee receiver can call this function");
