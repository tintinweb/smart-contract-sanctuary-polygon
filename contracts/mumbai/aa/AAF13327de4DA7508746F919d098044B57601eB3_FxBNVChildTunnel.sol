    ...
    ReentrancyGuard
{
    ...
    function _mapToken(bytes memory syncData) internal returns (address) {
        (address rootToken, address childToken) = abi
            .decode(syncData, (address, address));
        ...
        require(
            childToRootTokens[childToken]==address(0x0),
            "FxERC721ChildTunnel: ALREADY_MAPPED"
        );
    ...
    function withdraw(
        ...
        IBNVTokenBase childTokenContract = IBNVTokenBase(childToken);
        ...
        require(
            childToken != address(0x0) &&
                ...
                rootToken == childToRootTokens[childToken],
