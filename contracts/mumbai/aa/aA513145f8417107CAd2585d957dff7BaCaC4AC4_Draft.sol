...
contract Draft is ERC721, ERC2981, Pausable, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721("MyToken", "MTK") {
    ...
    setMintStatus("VIP_ALLOWLIST", 0.0055 ether, 2);
    setMintStatus("PREMIUM_ALLOWLIST", 0.0066 ether, 2);
    setMintStatus("PUBLIC", 0.0077 ether, 10);
  ...
  function mint(
    ...
    require(isSignatureValid(msg.sender, keccak256(abi.encodePacked(_doc, _nonce)), _docSignature), "Not allowed");
