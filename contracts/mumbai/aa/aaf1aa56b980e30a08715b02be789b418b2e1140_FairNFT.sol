...
/**
 * @title Fai NFT ERC721 contract
 * @notice This contract is a template for creating ERC721 contracts
 */
contract FairNFT is
    ERC721,
    ERC721Enumerable,
    ...
    Ownable
{
    ...
    /**
     * @notice Contract constructor that sets token name and symbol
     */
    constructor(
        string memory name,
    ...
    /**
     * @notice Requests Chainlink VRF random words to be used as seed for the NFT Shuffler
     * @dev Only the owner can call this function
     * @return requestId The ID of the request
     */
    function requestRandomWords() public onlyOwner returns (uint256 requestId) {
        require(seed == 0, "Seed has already been set");
        uint256 requestPrice = vrfWrapper.calculateRequestPrice(
            requestConfig.callbackGasLimit
        );
        require(
            linkTokenContract.balanceOf(msg.sender) >= requestPrice,
            "Not enough LINK tokens"
        );

        linkTokenContract.transferFrom(msg.sender, address(this), requestPrice);
     ...
     * @dev Only the VRF Coordinator can call this function
    ...
    function fulfillRandomWords(
        ...
        seed = randomWords[0];
        requestIdToRandomNumber[requestId] = seed;
    }

    /**
     * @notice Enable or disable the allow list
     * @param _isAllowListActive Whether the allow list should be active
     */
    ...
    /**
     * @notice Set the allow list for addresses
     * @param addresses The list of addresses to allow
     * @param numAllowedToMint The number of tokens each allowed address can mint
     */
    ...
    /**
     * @notice Check the number of tokens an address can mint
     * @param addr The address to check
     * @return The number of tokens the address can mint
     */
    ...
    /**
     * @notice Mint tokens if the sender is on the allow list
    ...
    /**
     * @dev Internal function to return the base URI for a token
    ...
    /**
     * @notice Set the provenance record for the token collection
     * @param provenance The provenance record to set
     */
    ...
    /**
     * @notice Reserve tokens for the contract owner
     * @param n The number of tokens to reserve
     */
    ...
    /**
     * @notice Set the sale state of the token
    ...
    /**
     * @notice Mint tokens if the sale is active
     * @param numberOfTokens The number of tokens to mint
     */
