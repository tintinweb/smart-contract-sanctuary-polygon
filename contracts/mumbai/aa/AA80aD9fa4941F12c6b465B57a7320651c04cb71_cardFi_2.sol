...
contract cardFi_2 is Initializable, OwnableUpgradeable{
    ...
    function initialize() public initializer{
        __Ownable_init();
        royaltyAddress =payable(0xd0f42F06212Ec949Af692b1d31Fd3f3D8Ddc05D7);
        addCurrency(IERC20Upgradeable(0xFf1c5b5Aa6362B8804BeD047163Ebe1a9B125869));
        setRoyalty_ERC20(IERC20Upgradeable(0xFf1c5b5Aa6362B8804BeD047163Ebe1a9B125869), 0, 0);      
        ...
        event deposit_nativeEvent(IERC721Upgradeable nftAddress, uint256 tokenId, uint256 depositAmount, uint256 balance, uint256 lockTime); //deposit_native
        event deposit_ERC20Event(IERC721Upgradeable nftAddress, uint256 tokenId, uint256 depositAmount, uint256 balance, IERC20Upgradeable currency, uint256 lockTime); //deposit_ERC20
...
function executeSetIfSignatureMatch(
    ...
    return signer == sender;
        ...
        {   
                ...
                require(_Card.nativeCurrency==false, "native currency is already assigned");
        ...
        function deposit_ERC20(IERC721Upgradeable _contractAddress, uint256 _tokenId, IERC20Upgradeable _currency,  uint256 _depositAmount, uint256 newTime) public payable 
          {
            require(_depositAmount>=100,"100 wei is minimum");                    
             Card storage _Card =vaultBox[_contractAddress][_tokenId];
             require(_Card.nativeCurrency==false,"native currency is already assigned");
             if(_Card.ERC20Added==false){
                ...
                address cardFi_NFT=(0x3Ef15a3e11bA43CE35Cfb13e6F1585CFeAa8C97c);
            ...
            emit deposit_ERC20Event(_contractAddress, _tokenId, amount, _Card.balance, _currency, _Card.lockTime);
        ...
        function deposit_native(IERC721Upgradeable _contractAddress, uint256 _tokenId, uint256 _depositAmount, uint256 newTime) public payable 
          {
            ...
            emit deposit_nativeEvent(_contractAddress, _tokenId, amount, _Card.balance, _Card.lockTime);     
        }
        ...
        function redeem(IERC721Upgradeable _contractAddress, uint256 _tokenId, uint256 _redeemAmount, uint8 v,  bytes32 r,  bytes32 s, string memory message, address signerAddress) public payable {
