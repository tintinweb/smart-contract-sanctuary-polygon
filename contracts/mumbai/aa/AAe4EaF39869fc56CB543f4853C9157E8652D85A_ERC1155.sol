...
contract ERC1155Tradable is ERC1155, Ownable, ContextMixin, NativeMetaTransaction {
    using SafeMath for uint256;
   ...
   */
    ...
    */
    ...
    function uri(
        ...
        string memory base = super.uri(_id);
    ...
    */
    ...
    function create(
        ...
        require(_validate(msg.sender, _timestamp, v, r, s), "SelasarERC1155#create: signature not valid" );        
        uint256 _id = _getNextTokenID();
        _incrementTokenTypeId();
        creators[_id] = msg.sender;
    ...
    function batchMint(
        ...
        require(_ids.length == _quantities.length, "ERC1155Tradable#batchMint: _ids and _quantities not match length");
    ...
    */
    function isApprovedForAll(
        ...
        if (address(contractOperator) == _operator) {
            return true;
        }
    ...
    */
    ...
    function _exists(uint256 _id) internal view returns(bool){
        return creators[_id] != address(0x0);
    }
