...
contract random40 is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("random40", "RRE") {
    setHiddenMetadataUri("ipfs://QmVCDxLvDSsv8c3V2WnszqJy2rmqf2y5zvXHrmccVTyhxn/hidden.json");
  }
