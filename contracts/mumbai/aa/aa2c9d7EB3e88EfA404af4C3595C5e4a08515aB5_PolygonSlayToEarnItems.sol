...
import "@maticnetwork/pos-portal/contracts/child/ChildToken/ChildMintableERC1155.sol";
import "@openzeppelin/contracts/utils/Address.sol";
import "@openzeppelin/contracts/utils/Strings.sol";
import "./ISlayToEarnItems.sol";

contract PolygonSlayToEarnItems is ISlayToEarnItems, ERC1155, IChildToken, AccessControlMixin, NativeMetaTransaction, ContextMixin {

    bytes32 public constant DEPOSITOR_ROLE = keccak256("DEPOSITOR_ROLE");
    bytes32 public constant INVENTORY_ADMIN_ROLE = keccak256("INVENTORY_ADMIN_ROLE");

    constructor(string memory tokenMetadataBaseUri, address childChainManager) public ERC1155(tokenMetadataBaseUri) {

        _setupContractId("PolygonSlayToEarnItems");
    ...
    function mintBatch(
        ...
        _mintBatch(player, items, amounts, data);
    }
    ...
    function deposit(address user, bytes calldata depositData) external override only(DEPOSITOR_ROLE) {
        ...
        require(
            user != address(0),
            "PolygonSlayToEarnItems: INVALID_DEPOSIT_USER"
        );
    ...
    function mint(
        ...
        uint256 amount,
        bytes calldata data
    ) external only(INVENTORY_ADMIN_ROLE) {
