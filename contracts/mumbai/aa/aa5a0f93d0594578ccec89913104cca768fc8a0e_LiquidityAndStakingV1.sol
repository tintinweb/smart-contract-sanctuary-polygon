...
contract LiquidityAndStakingV1 is OwnableUpgradeable {
    ...
    function initialize() public initializer {
        ...
        GainTokenAddress = 0xae0b417fEd233E5985D152a355E570F29608D7bc;
    ...
    function stake(uint256 _amount, address _lp_address) external virtual {
        require(
            isLpTokenValid(_lp_address) || stakeToken[_lp_address],
    ...
    function addStakeTokenContract(address _token_address, bool _status)
        external
        onlyOwner
    {
