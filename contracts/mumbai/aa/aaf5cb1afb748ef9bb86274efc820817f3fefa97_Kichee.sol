...
contract Kichee is IERC20 {
    ...
    */
    ...
    //Buy new tokens functions 
    function buyTokensByMatic(string calldata _metaData) payable checkHardCaps(priceMatic.mul(msg.value), msg.sender) external {
    ...
    function setUserHardCap(uint256 _userHardCap, uint256 _userMinCap) onlyOwner public{
    ...
    function whitelistForClaim(address[] calldata _userAddress, uint256[] calldata _amount) onlyOwner external returns(bool){
