...
library TokenRefLibrary {
    ...
    function toRef(
        ...
        require(tokenId <= MAX_UINT96, "tokenId is larger than packable max");
...
import "../libraries/TokenRefLibrary.sol";
    ...
    ITokenTemplateSystem
{
     ...
     * @return base64-encoded fully-formed tokenURI
     */
    function generateTokenURI(address tokenContract, uint256 tokenId)
        public
        view
    ...
    function setTemplate(
        ...
        _traitsProvider().setTraitUint256(
            ...
            TokenRefLibrary.toRef(address(this), templateId)
        );
    }
     ...
     * @return Returns the template token for the given token contract/token id, if it exists
     */
    function getTemplate(address tokenContract, uint256 tokenId)
        external
        view
    ...
    function _getTemplate(
        ...
        if (
            ...
            return TokenRefLibrary.fromRef(templateId);
        }
