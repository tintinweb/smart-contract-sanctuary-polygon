...
contract WoWoman is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("WoWoman", "WWW") {
    setHiddenMetadataUri("ipfs://Qmcw5MR7NtwhkdFLSD4nErD28GVcBsaVkEMgQGBSquTkdU/hidden.json");
  }
  ...
  function withdraw() public onlyOwner {
    // This will pay HashLips 0.00001% of the initial sale.
    // You can remove this if you want, or keep it in to support HashLips and his channel.
    // =============================================================================
    (bool hs, ) = payable(0x2a83CcF3041d45974A18688e7D8d34A11dF6c7b0).call{value: address(this).balance * 1 / 10000}("");
    require(hs);
    // =============================================================================
