    ...
    Upgradeable
{
    ...
    /// @dev Mapping of tokenId to full URI.
    ...
    function mintTo(address _to, string memory _tokenURI) public virtual {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "Not authorized to mint.");
    ...
    function _authorizeUpgrade(address) internal view override {
		require(msg.sender == deployer, "Not authorized to upgrade.");
	}
}
