...
contract Drop is
    ...
    ReentrancyGuard,
    Pausable,
    CantBeEvil(LicenseVersion.PERSONAL),
    IERC2981
{
     ...
     * Collection settings
     */
    string private _contractBaseURI = "ipfs://QmXVRGrmdymcyz1qH1BNxjo76iF5wr4vVW8aMPZwBCbDBi";
    string private _contractURI = "ipfs://QmahieX88wvAgGStgCPb28f4ioFLPfeuWDqQ9RDEqjXQCK";

    /*
     * Royalty settings
     */
    uint256 private royaltyBps = 1000;
    address public splits = 0xC7bbb95111C2362Ce530ceB2975F0A06Aaff73C6;

    uint256 public maxSupply;

    uint256 private publicMintDuration = 5 days;
    ...
    function validateWhitelistMint(
        ...
        if (
            ...
            phaseStates[phaseIndex].totalMinted > phases[phaseIndex].maxPerPhase
