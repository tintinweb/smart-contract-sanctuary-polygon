...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        // Aplicar el burn
        uint256 burnAmount = (amount * _burnPercentage) / 100;
        uint256 transferAmount = amount - burnAmount;

        _balances[sender] = senderBalance - amount;
        _balances[recipient] += transferAmount;
        _totalSupply -= burnAmount; // Reducir la cantidad total en circulación
    ...
    function setBurnPercentage(uint256 burnPercentage) public {
        require(msg.sender == _owner, "Only the owner can update the burn percentage");
        require(burnPercentage <= 100, "Burn percentage cannot be more than 100");
