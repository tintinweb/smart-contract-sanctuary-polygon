...
contract TokenVesting is Ownable, ReentrancyGuard {
    ...
    int256 public inflowPrice = 250000;
    int256 public maticUsd = 63904700;
    int256 public _tokensPerEth = maticUsd / inflowPrice;
    // getLatestPrice() / inflowPrice;
    uint256 public tokensPerEth = uint256(_tokensPerEth);
    
    mapping (bytes => bool) usedWhitelistSigs;

   address private adminWalletAddress = payable(0xbB8147C106Fb64E93f74Ec38ecC3e09aDf4F5A25);
    ...
    function createVestingSchedule(
        ...
        /*
            address _beneficiary -> address of user
            uint256 _start -> linux timestamp
            uint256 _cliff -> seconds period - 3 months
            uint256 _duration -> seconds period - 12 months - 31556926 seconds
            uint256 _slicePeriodSeconds -> slice period
            bool _revocable -- default false
            uint256 _amount -> total balance
    ...
    function getCliffTime() internal view virtual returns (uint256 time) {
