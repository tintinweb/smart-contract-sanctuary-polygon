...
contract ChainBattles is ERC721URIStorage {
    ...
    // Define the generateCharacter function to generate the SVG image of our NFT
    function generateCharacter(uint256 tokenId) public returns (string memory) {
        // The bytes type(dynamic array up to 32 bytes) can store stings and integers.
        ...
        // The SVG code takes the return value of functions and
        // use it to populate the stats property.
    ...
    // Create the getStrenght Function to retrieve the NFT Strenght
    function getStrenght(uint256 tokenId) public view returns (string memory) {
        uint256 strenght = tokenIdToStats[tokenId].strenght;
    ...
    // create a new NFT - inizialize the level value - set the token URI.
    function mint() public {
        ...
        // create a new item in the tokenIdToStats mapping and assign its values to 0
        tokenIdToStats[newItemId].level = 0;
        tokenIdToStats[newItemId].speed = 0;
        tokenIdToStats[newItemId].strenght = 0;
