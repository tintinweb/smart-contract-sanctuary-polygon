...
contract MoveNFT is ERC721AQueryable, ReentrancyGuard, Ownable {
    ...
    string public uriPrefix =
        "ar://zv3zOJwAucMZtD6K7et22M9bP-jbzgB7IqBCAAo9KO0/";
    using Strings for uint256;

    constructor() ERC721A("MoveNFT NFT", "MNFT") {}
    ...
    function mint(uint256 quantity) public payable {
        ...
        require(quantity > 0, "Invalid mint ammount!");
        require(msg.value >= quantity * SALE_PRICE, "Insufficient funds!");
    ...
    //     return
    //         "https://ipfs.io/ipfs/QmXv5qt3s2CDqxsDYFV4yUbrQ8FKpdcbjXcRegkr1q1M7B";
    // }
