...
contract StockERC1155 is ERC1155SupplyUpgradeable, OwnerPausable {
    ...
    function inWhitelist2(address user) external view returns(bool) {
        return _whitelist[user];
    }
...
contract OwnerPausable is ContextUpgradeable, PausableUpgradeable {
