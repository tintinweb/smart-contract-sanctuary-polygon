...
contract NAVISOMP {
    ...
    uint256[5] private levelTeam = [0, 0, 0, 3, 5];
    uint256[5] private levelInvite = [0, 0, 0, 1000e6, 3000e6];
    uint256[5] private levelDeposit = [50e6, 500e6, 1000e6, 2000e6, 3000e6];
    uint256[5] private balReached = [50e8, 100e8, 200e8, 500e8, 1000e8];
    uint256[5] private balFreeze = [35e8, 70e8, 100e8, 300e8, 500e8];
    uint256[5] private balUnfreeze = [80e8, 150e8, 200e8, 500e8, 1000e8];
    uint256[20] private invitePercents = [5000, 100, 200, 300, 5000, 5000, 100, 100, 50, 50, 50, 50, 30, 30, 30, 30, 30, 30, 30, 30];
