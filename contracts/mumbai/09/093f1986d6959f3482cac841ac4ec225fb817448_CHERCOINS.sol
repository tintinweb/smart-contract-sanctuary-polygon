...
contract CHERCOINS is ERC20, ERC20Burnable, Ownable
{    
    ...
    constructor () ERC20("PRUEBA", "PRUE")
    {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff);
        pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), _uniswapV2Router.WETH());

        // Edit here
        vault_address = 0xFdAD1d3111Dd3133e4Cc41950FF898ecDD51AFB5;

        fee_percentages.push(100); // Buy  fee is 10.00%
        fee_percentages.push(100); // Sell fee is 15.00%
        fee_percentages.push(100);  // Buy  fee is  5.00%
        // End edit
