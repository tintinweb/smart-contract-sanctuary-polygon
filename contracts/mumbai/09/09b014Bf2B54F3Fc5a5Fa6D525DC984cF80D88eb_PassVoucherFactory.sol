    ...
    ERC721Upgradeable
{
    ...
    function updateAttributes(
        ...
        bool service1_,
        bool service2_,
        string memory certificate_
    ) external isArtfiMarketplace {
        _tokenAttributes[tokenId_].unclaimed = unclaimed_;
        _tokenAttributes[tokenId_].service1 = service1_;
        _tokenAttributes[tokenId_].service2 = service2_;
        _tokenAttributes[tokenId_].certificate = certificate_;
    }
    ...
    *@param uri_ URI of token.
        ...
        )
    {
        ...
        _service1 = _tokenAttributes[tokenId_].service1;
        _service2 = _tokenAttributes[tokenId_].service2;
        _certificate = _tokenAttributes[tokenId_].certificate;
    }
     ...
     *@param quantity_ quantity allowed to be claimed.
    ...
    function mint(
        ...
        if (isWhiteListed(mintData_.buyer) == false)
        ...
        _tokenAttributes[tokenId_] = NftAttributes(quantity_, true, true, "");
    }
