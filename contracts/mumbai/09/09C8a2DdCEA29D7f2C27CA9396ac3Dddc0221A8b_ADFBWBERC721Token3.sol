...
contract ADFBWBERC721Token3 is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, OwnableUpgradeable {
    ...
    function initialize() initializer public {
        __ERC721_init("Art de finance nft3", "ADFNFT3");
    ...
    function _beforeConsecutiveTokenTransfer(address from , address to , uint256, uint96 size) 
        internal 
        override(ERC721Upgradeable , ERC721EnumerableUpgradeable)
    {
