...
contract SmartContractProva20230601 is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    function generate(uint id, string memory hashCode, address portfolio, string memory tokenUri) public onlyOwner {
    ...
    function burn(uint id, string memory hashCode) public onlyOwner { 
        require(id > 0 && id <= _TOTAL, "ID Bottiglia non appartenente alla collezione");
        require(_verify(id, hashCode), "Bottiglia non valida");
        require(_collection[id-1].status == _STATUS_OK, "Stato Bottiglia KO");
        require(_collection[id-1].service == _SERVICE_ENABLED, "Servizi non abilitati");
    ...
    function _verify(uint id, string memory hashCode) private view onlyOwner returns (bool) {
