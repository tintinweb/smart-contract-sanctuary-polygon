...
contract SDKERC721 is ERC721, Ownable{
 ...
 //EID
 mapping (uint256 => uint256) private EID;

 //Metadata per _nftID
 mapping (uint256 => string) private nftTokenUri;
 ...
 *****************************************************************************************/
 function contractURI(string memory _Uri) external onlyOwner {
     _contractURI = _Uri;
 }
 ...
 *****************************************************************************************/
 function mint(address _to, uint256 _tID, uint256 _eID) external onlyOwner {
 ...
 *****************************************************************************************/
 function mint(address _to, uint256 _tID, uint256 _eID, string memory _Uri) external onlyOwner {
   super._mint(_to, _tID);
   EID[_tID] = _eID;
   nftTokenUri[_tID] = _Uri;
 ...
 *****************************************************************************************/
 ...
 /*****************************************************************************************
     @dev: gets the metadata for a specific experience ID.
     @param _eID: Token experience ID to query
 *****************************************************************************************/
//  function experienceURI(uint256 _eID) public view returns (string memory) {
//    return tokenUri[_eID];
//  }


 /*****************************************************************************************
     _nftUriEmpty: Helper function to determine if Token URI is empty of not for given NFT
 ...
 *****************************************************************************************/
 function _nftUriEmpty(uint256 _tID) internal view returns (bool) {
   require(_exists(_tID), "ERC721Metadata: URI query for nonexistent token");
   string memory empty = "";
   return keccak256(bytes(nftTokenUri[_tID])) == keccak256(bytes(empty));
 }
 ...
 *****************************************************************************************/
 function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
   ...
   if (bytes(globalMetadata).length < 1){
     return globalMetadata;

   }else if(_nftUriEmpty(tokenId)){
...
//  function highestId() public view returns (uint256) {
//    uint maxGap = 1000;
//    uint gap=0;
//    uint i = 1;
//    while(gap < maxGap){
//       if (bytes(_exists(i)).length!=0){
//           gap=0;
//       }else{
//           gap++;
//         }
