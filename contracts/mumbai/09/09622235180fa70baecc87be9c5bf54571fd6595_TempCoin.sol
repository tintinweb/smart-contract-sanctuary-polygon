...
contract TempCoin is ERC20, Ownable {
    ...
    constructor() payable ERC20("TempCoin", "temp") {
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            uint256 bnbShare = (developmentFeeOnBuy + developmentFeeOnSell) + (rewardsFeeOnBuy + rewardsFeeOnSell) + (marketingFeeOnBuy + marketingFeeOnSell);
