...
contract DoRequest {
    ...
    struct request {
        ...
        uint256 beneficiaryPhone;
        uint256 beneficiaryAadhar;
    ...
    function fileRequest(
        ...
        uint256 _beneficiaryPhone,
        uint256 _beneficiaryAadhar
    ) public {
        ...
        newRequest.beneficiaryName = _beneficiaryName;
        newRequest.beneficiaryPhone = _beneficiaryPhone;
        newRequest.beneficiaryAadhar = _beneficiaryAadhar;
