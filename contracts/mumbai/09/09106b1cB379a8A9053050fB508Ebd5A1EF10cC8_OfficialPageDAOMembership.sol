...
contract OfficialPageDAOMembership is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl, ERC721Burnable {
    ...
    uint256 diamondPrice = 0.025 * (10 ** 18);
    ...
    // These functions get the supply for Silver and Diamond NFTs, keeping track of each separately.

    function getSilverSupply() public view returns (uint256) {
        return _silverSupply;
    }

    function getDiamondSupply() public view returns (uint256) {
        return _diamondSupply;
    }
