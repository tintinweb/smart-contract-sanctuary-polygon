...
contract MarketplaceV2 is Ownable, ReentrancyGuard {
    ...
    */
    ...
    function mintMultiple(
        ...
        bytes32 _msgHash = ECDSA.toEthSignedMessageHash(
            keccak256(abi.encodePacked(msg.sender, _nftContract, _tokenIds))
        );
        _validateSig(msg.sender, _msgHash, _signatures[0]);
        bytes32 verifierMsg = keccak256(_signatures[0]);
        require(
        ...
        _nftContr.mintBatch(msg.sender, _tokenIds);
    }
}
