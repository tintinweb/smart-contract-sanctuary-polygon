...
contract BigLand is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("BigLand", "BIG") {
    setHiddenMetadataUri("ipfs://Qmc9ZBNF2xsmJuFkdp3943qP81LK2VCN7X52TyP2jUCm3Z/hidden.json");
    buildings.push(Building("ZERO", 0,0,0,0,0,0));
    buildings.push(Building("one", 0,0,0,0,0,0));
    buildings.push(Building("two", 0,0,0,0,0,0));
  }
