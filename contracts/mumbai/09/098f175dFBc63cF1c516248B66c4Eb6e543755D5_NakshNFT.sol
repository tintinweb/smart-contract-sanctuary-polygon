...
contract NakshNFT is ERC721URIStorage {
    ...
    event Mint(address indexed creator,uint indexed tokenId, string indexed tokenURI, string title, string description, string artistName);
    ...
    */
    ...
    string memory description, string memory artistName) public virtual onlyArtist returns (uint256 _tokenId) {
        ...
        emit Mint(msg.sender, tokenId, _tokenURI, title, description, artistName);
        return tokenId;
    }
    ...
    */
    ...
    string[] memory description, string memory artistName) public virtual onlyArtist returns (uint256[] memory _tokenId) {
        ...
        emit Mint(msg.sender, tokenId, _tokenURI[i], title[i], description[i], artistName);
    ...
    */
    ...
    string[] memory description, string[] memory artistName) public virtual onlyAdmin returns (uint256[] memory _tokenId) {
        ...
        emit Mint(_creator[i],tokenId, _tokenURI[i], title[i], description[i], artistName[i]);
