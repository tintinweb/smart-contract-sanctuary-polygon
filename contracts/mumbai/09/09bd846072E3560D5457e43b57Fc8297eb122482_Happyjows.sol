...
contract Happyjows is ERC721Enumerable, Ownable {
    ...
    constructor(IOwlDescriptor newDescriptor) ERC721("Happy Owls", "HOWLS") {
...
contract OwlDescriptorV2 is IOwlDescriptor {
    ...
    function getFeet(uint256 seed, uint256 colorSeed)
        private
        pure
        returns (Trait memory)
    {
