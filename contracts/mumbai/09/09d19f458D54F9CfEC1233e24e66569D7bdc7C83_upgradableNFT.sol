...
contract upgradableNFT is ERC721A, Ownable {
    ...
    constructor() ERC721A("upgradableNFT", "Level") {
        ...
        ownerContract = _msgSenderERC721A();
    }

    modifier ownerCheck() {
        require(
            _msgSenderERC721A() == ownerContract,
    ...
    function mintTrutsNFT() public {
        ...
        emit NewNFTMinted(_msgSenderERC721A(), itemId, tokenURI(itemId));
