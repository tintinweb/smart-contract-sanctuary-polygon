...
contract MarketCore is Initializable, PausableUpgradeable, OrderValidator, TransferManager {
    ...
    function checkMatchAssetsTest (LibOrder.Order memory orderLeft, LibOrder.Order memory orderRight) public pure returns (LibAsset.AssetType memory) {
    ...
    function matchOrders(
        ...
        require(orderRight.taker == address(0), "leftOrder.taker verification failed");
