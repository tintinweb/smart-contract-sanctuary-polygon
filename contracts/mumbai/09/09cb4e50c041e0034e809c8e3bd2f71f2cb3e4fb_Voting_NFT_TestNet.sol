...
// File: contracts/Voting_NFT_Testnet.sol
...
contract Voting_NFT_TestNet is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl,
ERC721Burnable, EIP712, ERC721Votes {
using Counters for Counters.Counter;
...
constructor()
ERC721("TBADAO Voting NFT", "TBADAONFT")
EIP712("TBADAO Voting NFT", "1")
{
...
// If the 'to' address has already minted a token, the transaction will revert.
function safeMint(address to, string memory uri) public onlyRole(MINTER_ROLE) {
require(!_hasMinted[to], "This address has already minted a token");
