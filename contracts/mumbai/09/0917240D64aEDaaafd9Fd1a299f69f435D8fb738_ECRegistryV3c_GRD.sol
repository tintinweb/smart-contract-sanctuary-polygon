...
contract ECRegistryV3c_GRD is ECRegistryV3c {
    ...
    constructor(address _communityRegistry) {
        ...
        myCommunityRegistry = CommunityRegistry(_communityRegistry);
    }
}
    ...
    */
    ...
    function addTrait(
        ...
        for (uint8 i = 0; i < _newTraits.length; i++) {
            ...
            // not needed setTraitControllerAccess(owner(), newTraitId, true);
