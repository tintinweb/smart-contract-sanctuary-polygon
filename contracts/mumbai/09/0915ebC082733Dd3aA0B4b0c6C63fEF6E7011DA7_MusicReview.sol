...
// Deployed on Mumbai at 0x0Bf2976FB29fc574480391256e923dB4833C75dB
...
contract MusicReview is ERC721, ERC721URIStorage, Ownable {
  ...
  */
  function mint(string memory title, string memory body) public {
    ...
    tokenIdToReviews[tokenId] = Review({
      title: string.concat('# ', tokenId.toString(), ': ', title),
      body: body,
      upvotes: 0
    });
  ...
  */
  function tokenURI(
    ...
    return string(abi.encodePacked(base, Base64.encode(json)));
  }
