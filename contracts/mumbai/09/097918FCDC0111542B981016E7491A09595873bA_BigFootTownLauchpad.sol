...
contract BigFootTownLauchpad is Ownable {
    using SafeERC20 for IERC20;

    //token attributes
    string public constant NAME = "BigfootTown Lauchpad"; //name of the contract
    ...
    // CONSTRUCTOR
    constructor(
        uint256 _maxCap, //200000000000000000000000000
        uint256 _saleStartTime, //1648278000
        uint256 _saleEndTime, // 1648288800
        address payable _projectOwner, // 0x11Ec65c2F9DFc2C9306b5Bfc79E2584dCAF7625C
        uint256 _tierOneValue, // 1000000000000000000
        uint256 _tierTwoValue, // 2000000000000000000
        uint256 _totalparticipants, // 5000
        address _tokenAddress // /0x8b07B04f461C85236Cf97C6f9242934d66ccdB34
    ) {
        maxCap = _maxCap;
    ...
    function updateTierValues(uint256 _tierOneValue, uint256 _tierTwoValue)
        external
        onlyOwner
    {
        tierOneMaxCap = _tierOneValue;
