...
contract n is IERC721L, ERC721AQueryable, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("n", "n") {
        _mintStages.push(MintStageInfo({cost: 0, walletLimit: 20, merkleRoot: 0x0, maxStageSupply: 0, startTimeUnixSeconds: 1686844844, endTimeUnixSeconds: 1692028844}));
    }
