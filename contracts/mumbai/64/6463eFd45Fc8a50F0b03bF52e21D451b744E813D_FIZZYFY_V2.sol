...
contract FIZZYFY_V2 
{
    ...
    uint256[5] private balDown = [10e18, 30e18, 100e18, 500e18, 1000e18];
    uint256[5] private balDownRate = [1000, 1500, 2000, 5000, 6000]; 
    uint256[5] private balRecover = [15e18, 50e18, 150e18, 500e18, 1000e18];
    ...
    constructor() public {
        ...
        feeReceivers[0] = address(0x5dE021eb0464369E4D5F83555A6E634EBcCB3372);
		feeReceivers[1] = address(0xA99f96DB6D5a5C6E92e179DDE79a97cb1105cCA0);
		feeReceivers[2] = address(0xCB1bA6548c4897b750C5384470F7276bE89a8a03);
		feeReceivers[3] = address(0x89D9A85a574DBf5e1eEdEDE3ce33106439e6e8F7);
    ...
    function _distributeDeposit(uint256 _amount) private {
		...
		uint256 luck = _amount.mul(liquidityPoolPercents).div(baseDivider);
        Dai.transfer(feeReceivers[0], fee.div(4));
        Dai.transfer(feeReceivers[1], fee.div(4));
        Dai.transfer(feeReceivers[2], fee.div(4));
        Dai.transfer(feeReceivers[3], fee.div(4));
        Dai.transfer(liquidityAddr, luck);        
        liquidityPool = liquidityPool.add(luck);
    }
	...
	function _calLevelNow(address _user) private view returns(uint256) {
        ...
        if(total >= 1000e18){
            ...
            if(total >= 2000e18 && user.teamNum >= 200 && maxTeam >= 75000e18 && otherTeam >= 75000e18){
                levelNow = 5;
