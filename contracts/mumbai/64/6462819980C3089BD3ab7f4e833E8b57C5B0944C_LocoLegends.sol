...
contract LocoLegends is ERC721, ReentrancyGuard, Ownable {
    using Counters for Counters.Counter;
    uint256 public constant MAX_TOKEN_ID = 200000000000000000000;
    uint256 public constant MAX_MULTIMINT = 100;


    constructor() ERC721("Loco Legends # 27-05-2022", "BLL#27-05-2022") {}

    /** MINTING **/

    Counters.Counter private supplyCounter;

    function mint(uint256[] calldata ids) public onlyOwner nonReentrant {
