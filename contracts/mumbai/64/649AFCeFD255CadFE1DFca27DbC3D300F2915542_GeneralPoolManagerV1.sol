...
contract GeneralPairPoolV1 is IGeneralPoolV1, ERC1155Supply {
    ...
    function addLiquidity() external override onlyPoolManager {
    ...
    function removeLiquidity(
        ...
        require(resultOpened, "result not open");
    ...
    function submitResult(uint8 option) external override onlyPoolManager {
        ...
        require(resultOpened == false, "result opened");
    ...
    function claim(address to) public override returns (uint256 amount) {
        require(to != address(0), "to is address zero");
        require(
    ...
    function claim(address to, uint256[] memory rounds) external override returns (uint256 amount) {
        return claim(to);
    }
}
