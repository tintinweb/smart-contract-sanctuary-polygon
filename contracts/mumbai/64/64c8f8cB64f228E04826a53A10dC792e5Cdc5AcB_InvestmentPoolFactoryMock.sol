...
contract InvestmentPool is IInitializableInvestmentPool, SuperAppBase, OwnableUpgradeable {
    ...
    address payable public gelatoOpsAddress;
    ...
    function setOnlyGelatoOps() public {
        gelatoOps = IOps(gelatoOpsAddress);
    }

    function setOnlyGelato() public {
        gelato = IOps(gelatoOpsAddress).gelato();
    }
