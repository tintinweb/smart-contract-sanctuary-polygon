...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x9f9058047d24dE913048B388A3B7c12a0786dF23];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmY13gWqndLVQ2uqLgERshyj6ynxWpZ1WwQidiLP8AZkCK";
...
// File: contracts/theMothershipProjectTestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheMothershipProjectTestContract is RamppERC721A {
    constructor() RamppERC721A("The Mothership Project Test", "MSPT"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/mtJGyMIZ1VzziVJFtFFE/contract-metadata";
    }
}