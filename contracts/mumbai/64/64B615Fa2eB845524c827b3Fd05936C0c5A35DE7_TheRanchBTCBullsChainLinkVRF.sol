...
contract TheRanchBTCBullsCommunity is 
    ...
    */
    ...
    function initialize() public initializer {
        ...
        maxSupply = 9;
        mintingCost = 350;
        mintingPrices[9] =  mintingPricesInfo(19,360);  
        mintingPrices[19] = mintingPricesInfo(29,370);
        mintingPrices[29] = mintingPricesInfo(39,380);
        mintingPrices[39] = mintingPricesInfo(49,390);
        mintingPrices[49] = mintingPricesInfo(59,400);
        mintingPrices[59] = mintingPricesInfo(69,410);
        mintingPrices[69] = mintingPricesInfo(79,420);
        mintingPrices[79] = mintingPricesInfo(89,430);
        mintingPrices[89] = mintingPricesInfo(100,440);
            ...
            if (btcBullOwners[_address].WBTC_Balance > 0){
                if (btcBullOwners[_address].maintenanceFeeBalance != 0){
                    if (btcBullOwners[_address].lastRewardDate != currentRewardingDate) {
                        ...
                        if (btcBullOwners[_address].maintenanceFeesStanding == 4){
