...
contract MY_NEW_CONTRACT is ERC721Enumerable, Ownable, RoyaltiesV2Impl {
    using Strings for uint256;
    ...
    // mint single token with provided token URI and return ne token ID
    function mint(
        address recipient,
        string memory uri
    ...
    function mintWithAmount(uint256 _mintAmount) public payable {
