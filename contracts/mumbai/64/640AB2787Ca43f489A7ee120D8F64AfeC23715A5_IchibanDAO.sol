...
contract IchibanDAO is ZKPVerifier, VRFConsumerBaseV2, ReentrancyGuard{
    ...
    mapping(address => bool) public verifyMerchants;
    ...
    // todo: 要改為用polygon ID提供的proof做授權
    function addVerifyMerchant(address _merchant) external onlyOwner {
        verifyMerchants[_merchant] = true;
    }
        ...
        nonReentrant 
    {
        ...
        emit PlayPhysicalPrizeGame(gameId, msg.sender, playRounds, physicalPrizeGame.pendingPrizeCount);
    }
    ...
    function sendNotificationTest() external
    {
