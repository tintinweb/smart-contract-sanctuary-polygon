...
contract SwapContract is Ownable {
    ...
    // MetacToken : 0xF82F9352A6d4f99805782840eAE3EB4D76DcD0e9; //for mainnet
    ...
    function depositMATICForLockToken() public payable {
        require(getUSDCAmount(msg.value) >= minDepositAmount, "Minimum amount is 2.5USDC");
        
        uint256 usdcAmount = getUSDCAmount(msg.value);
        uint256 tokenAmount = getTokensAmount(usdcAmount);
    ...
    function getTokensAmount(uint256 usdcAmount) public view returns(uint256) {
        uint256 tokensAmount = (usdcAmount.mul(1e18).div(tokensAmountForUSDC))*1e18;
        return tokensAmount;
    }
