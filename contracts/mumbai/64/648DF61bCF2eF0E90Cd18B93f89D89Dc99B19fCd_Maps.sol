...
uint constant DOOR_MOD_STEP = 22; // NOTE: For now, this MUST be divisible with DOOR_CHANCE
...
contract Maps is Ownable {
    ...
    function _buildMap(BCTypes.Map storage _newMap) internal {
        // TODO: This is occassionally getting stuck in a corner
        ...
        while (numToPlace > 0 && stackCount > 0) { // TODO: Need to track stack count to avoid crash on error if all rooms not placed
            ...
            int[4] memory order = [int(0), 1, 2, 3];
            ...
            for (uint i = 0; i < order.length; i++) {
                ...
                if (found[neighbor.row][neighbor.col] == false || _newMap.board[current.row][current.col].doors[utils.getDirectionBetween(current, neighbor)] == 0) {
                    if (availableDoors == 0 || utils.smallIntBetweenVals(0, 99) < DOOR_CHANCE - doorModifier) {
                        ...
                        // TODO: DRY This?
                        if (order[i] == 0 && _newMap.board[current.row][current.col].doors[0] == 0) {
                            // North
                        ...
                        } else if (order[i] == 1 && _newMap.board[current.row][current.col].doors[1] == 0) {
                            // South
                        ...
                        } else if (order[i] == 2 && _newMap.board[current.row][current.col].doors[2] == 0) {
                            // East
                        ...
                        } else if (order[i] == 3 && _newMap.board[current.row][current.col].doors[3] == 0){
                            // West
