...
import "./CarrotFactoryNft1155.sol";
...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new CarrotFactoryUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        CarrotFactoryUser1155Token token = CarrotFactoryUser1155Token(address(addr));
...
contract CarrotFactoryUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
