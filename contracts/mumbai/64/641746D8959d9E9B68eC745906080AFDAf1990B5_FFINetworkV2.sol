...
contract FFINetworkV2 {
    ...
    uint256[7] public stakingPackages = [1 ether,2 ether,3 ether,4 ether,5 ether,6 ether,7 ether];
    ...
    uint256[10] public downline_business = [0 ether,1 ether,2 ether,3 ether,4 ether,5 ether,6 ether,7 ether,8 ether,9 ether];
