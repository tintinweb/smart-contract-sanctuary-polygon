...
contract Whale is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund, address _team1Fund) public ERC20("SHARK Shares", "WHALE") {
        _mint(msg.sender, 1 ether); // mint 1 SHARK Share for initial pools deployment
