    ...
    UUPSUpgradeable
{
    ...
    mapping(string => uint256) public reference_id_token_id;
    ...
    function _mintAnElement(
        ...
        require(reference_id_token_id[reference_id]== 0 , 'Reference Id for the token is available');
        _safeMint(_toAddress, tokenId);
        reference_id_token_id[reference_id] = tokenId;
        emit AvatarMinted(
            tokenId,
            _toAddress,
            _byAddress,
        ...
        onlyRole(ADMIN_ROLE)
    {
        ...
        require(
            reference_id_token_id[referenceId] == 0,
            "Reference Id already present"
        );
        reference_id_token_id[referenceId] = tokenId;
    }
