...
contract Storage {
    address[] public  dest_address = new address[](4);
    address[] public  swapRouter = new address[](2);
    // consist of the swapAdapter addresses (wrapper around the contracts).
    uint[] shares = [3,2,1];
    mapping(uint => address) swapAdapter;
    ...
    constructor() {
        ...
        // swapAdapter : 1 .univ2  2. uniV3.
        swapRouter.push(0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45);
        swapRouter.push(0xE592427A0AEce92De3Edee1F18E0157C05861564);
    ...
    function getSwapAdapter(uint versionIndex) public view returns (address) {
        return swapAdapter[versionIndex];
    }

    /**
    setting swap adapter, latest version will be 
    */
    function setSwapAdapter(uint versionIndex,address _newSwapAdapter) public {
        require(ownerAddress == msg.sender, "not call by owner");
         swapAdapter[versionIndex] = _newSwapAdapter;
    }
