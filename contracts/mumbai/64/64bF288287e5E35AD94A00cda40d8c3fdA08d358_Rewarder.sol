...
contract Rewarder is IRewarder, SybelAccessControlUpgradeable, ContentBadges, ListenerBadges, PushPullReward {
    ...
    event TestContentPool(uint256 contentId, uint256 amount);
    event TestReward(uint256 totalReward, uint256 userReward, uint256 ownedReward);
    ...
    function computeRewardForContent(
        ...
        if (hasOnePaidFraktion) {
            ...
            emit TestContentPool(contentId, contentPoolReward);
        ...
        emit TestReward(totalReward, userReward, ownerReward);
