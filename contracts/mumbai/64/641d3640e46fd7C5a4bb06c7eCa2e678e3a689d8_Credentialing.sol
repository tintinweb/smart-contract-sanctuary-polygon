...
contract Credentialing is Ownable {
    ...
    */
    ...
    mapping(address => string) private storeLicense;
     ...
     */
    function credentialize(address _driverAddress, string memory _licenseNumber, string memory _ipfsUrl) external onlyAdmin{
        ...
        storeLicense[_driverAddress] = _licenseNumber;
     ...
     */
    function editCredential(address _driverAddress, string memory _licenseNumber, string memory _ipfsUrl) external onlyAdmin{
        Registration regDriver = Registration(registrationConc);
        require(regDriver.isDriverRegistered(_driverAddress), "The address is not registered in the registration contract");
