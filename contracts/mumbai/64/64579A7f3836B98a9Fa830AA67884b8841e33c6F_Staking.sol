...
contract Staking {
    ...
    // Parameters
    uint128 public constant VALIDATOR_THRESHOLD = 1000000000000000000; // 1 ether
    ...
    function _stake() private {
        require(
            !_isStaker(msg.sender) && !_isSigner(msg.sender),
            "accounts that called staked(signer) must not call this stake() function. If you still want to call, just calling unstake"
        );
