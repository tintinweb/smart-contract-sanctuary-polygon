    ...
    IGoldFeverSwap
{
    ...
    function initialize(address admin, address ngl_) public initializer {
        __GoldFeverSwap_init(admin, ngl_);
    }

    function __GoldFeverSwap_init(address admin, address ngl_) internal onlyInitializing {
        __ReentrancyGuard_init();
        __GoldFeverSwap_init_unchained(admin, ngl_);
        __UUPSUpgradeable_init();
    }

    function __GoldFeverSwap_init_unchained(address admin, address ngl_) internal onlyInitializing {
        _setupContractId("GoldFeverSwap");
    ...
    function createOfferForSpecifiedOwner(
        address nftContract,
        uint256[] memory fromNftIds,
        uint256 fromNglAmount,
        uint256[] memory toNftIds,
    ...
    function cancelOffer(uint256 offerId) external nonReentrant {
        require(
            ...
            "GoldFeverSwap: Offer is not for swap"
        );
        require(
            idToOffer[offerId].fromAddress == _msgSender(),
            "GoldFeverSwap: Only seller can cancel"
        );
    ...
    function rejectOffer(uint256 offerId) external nonReentrant {
        ...
        require(
            idToOffer[offerId].toAddress == _msgSender(),
            "GoldFeverSwap: Only buyer can reject"
        );
        address fromAddress = idToOffer[offerId].fromAddress;
        uint256[] memory fromNftIds = idToOffer[offerId].fromNftIds;
        uint256 fromNglAmount = idToOffer[offerId].fromNglAmount;
    ...
    function acceptOffer(uint256 offerId) external nonReentrant {
        ...
        address msgSender = _msgSender();
        require(
            idToOffer[offerId].toAddress == msgSender,
            "GoldFeverSwap: Only offered address can accept"
        );
        address fromAddress = idToOffer[offerId].fromAddress;
        uint256[] memory fromNftIds = idToOffer[offerId].fromNftIds;
        uint256 fromNglAmount = idToOffer[offerId].fromNglAmount;
        ...
        ngl.transferFrom(msgSender, fromAddress, toNglAmount);
        ...
        ngl.transfer(msgSender, fromNglAmount);
        for (uint256 i = 0; i < fromNftIds.length; i++) {
            IERC721Upgradeable(nftContract).safeTransferFrom(
                address(this),
                msgSender,
        ...
        emit OfferSwapped(offerId, msgSender);
    }
