...
}// File contracts/templates/BlacklistBurnMintTxFeeTemplate.sol
...
contract BlacklistBurnMintTxFeeTemplate is 
    ERC20Base, 
    BlacklistFeature, 
    ERC20BurnFeature, 
    ERC20MintFeature, 
    TxFeeFeatureAlt
{
    ...
    function _beforeTokenTransfer_hook(
        ...
        address to,
        uint256 amount
    )  internal virtual override(BlacklistFeature, TxFeeFeatureAlt) {
