...
// File: Dynamic NFT/Character.sol
...
contract Character is ERC721URIStorage, Ownable {
  ...
  string public notRevealedUri = "ipfs://QmczFcJvf8vYficMPp8uZ6b31QKiZMLky6EvFREcVWUK4R/character-hidden.json"; // <-- link to metadata for e.g. hidden opensea listing of token
  ...
  mapping(address => string[]) public userOwnedTokens; // <-- Get user minted token from wallet
  ...
  * also employs example of token owner condition
  ...
  function contractURI() public pure returns (string memory) {
    return "ipfs://QmczFcJvf8vYficMPp8uZ6b31QKiZMLky6EvFREcVWUK4R/characters.json"; // Contract-level metadata
  }
    ...
    mintCompliance(_mintAmount)
  {
    ...
    userOwnedTokens[msg.sender].push(tokenURI(newCharID));
