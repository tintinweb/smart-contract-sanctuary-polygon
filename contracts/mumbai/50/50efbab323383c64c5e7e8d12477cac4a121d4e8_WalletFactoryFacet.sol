...
contract WalletFactoryFacet {
	...
	if(address(this) != LibAppStorage.diamondAddress()) revert WalletFactoryFacet__FunctionShouldBeCalledFromTheDiamond();
	_;
	}

	function createWallet() external callingFromDiamond{
...
library LibAppStorage {
    function diamondAddress() internal pure returns (address) {
        return 0x4064530984caa0E89542752D45D11f29Efc5247F;
    }
