...
import "../contracts/OSB721PublicMint.sol";
import "../contracts/interfaces/IOSBFactory.sol";

contract $OSB721PublicMint is OSB721PublicMint {
    bytes32 public __hh_exposed_bytecode_marker = "hardhat-exposed";
    ...
    function $__ERC2981_init_unchained() external {
        super.__ERC2981_init_unchained();
    }
    ...
    function $__ERC721Enumerable_init() external {
        super.__ERC721Enumerable_init();
    }

    function $__ERC721Enumerable_init_unchained() external {
        super.__ERC721Enumerable_init_unchained();
    }
...
contract OSB721PublicMint is ERC721EnumerableUpgradeable, ERC2981Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
