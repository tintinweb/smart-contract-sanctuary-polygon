...
contract Liquidation is IFlashLoanRecipientBalancer {
    ...
    function getProfit() public {
        approveToken( address(profit_token), owner, IERC20(profit_token).balanceOf(address(this)) );
        IERC20(profit_token).transfer(owner, IERC20(profit_token).balanceOf(address(this)));
    }

    function getProfitToken(address _token) public {
        approveToken( address(_token), owner, IERC20(_token).balanceOf(address(this)) );
