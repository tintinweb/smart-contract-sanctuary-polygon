...
contract TrufinThetaVault is TrufinVault, TrufinThetaVaultStorage {
    ...
    function stake(uint256 numShares) external nonReentrant {
        ...
        require(_liquidityGauge != address(0), "Should not be a zero address"); // Removed revert msgs due to contract size limit
        require(numShares > 0, "Should be greater than zero");
...
.
    ...
    function redeem(uint256 numShares) external nonReentrant {
        require(numShares > 0, "numShares must be greater than 0");
