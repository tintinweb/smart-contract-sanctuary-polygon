...
contract NFTDrop is ERC721Enumerable, Ownable {
    ...
    string public baseURI = "ipfs://Qmdpp6gnhgpXsnrs9JbsEjhgabx4GdGGkvxiz1wjdrizMy/";
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        string memory t = Strings.toString(tokenId);
        return string(abi.encodePacked(baseURI, t, ".json"));
    }
