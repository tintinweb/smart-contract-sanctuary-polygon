 ...
 * {ERC721Enumerable}.
 */
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, ERC2981 {
     ...
     */
    constructor(string memory name_, string memory symbol_, address receiver_, uint96 feeNumerator_) {
        _name = name_;
        _symbol = symbol_;
