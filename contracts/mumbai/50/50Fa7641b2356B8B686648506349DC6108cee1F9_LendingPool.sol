...
contract LendingPool is Ownable, ReentrancyGuard {
    ...
    function createPool(
        ...
        require(
            ...
            isDailyPool || lockingPeriod >= ONE_YEAR_IN_SECONDS, // temporarily used for testing
    ...
    function _getWithdrawableAmount(
        ...
        uint256 _payoutTimes = (block.timestamp - depositTime) /
            (isDailyPool ? ONE_DAY_IN_SECONDS : ONE_YEAR_IN_SECONDS); // temporarily used for testing
