...
contract LensBalus {
    ...
    event AnnouncementCreated(uint256 indexed id, string infoCid, string contentCid, uint256[] partnerRequests);
...
interface ILensHub {
     ...
     */
    function setState(LensDataTypes.ProtocolState newState) external;
     ...
     */
    function setDefaultProfileWithSig(LensDataTypes.SetDefaultProfileWithSigData calldata vars)
        external;
     ...
     */
    function setFollowModuleWithSig(LensDataTypes.SetFollowModuleWithSigData calldata vars) external;
     ...
     */
    function setDispatcherWithSig(LensDataTypes.SetDispatcherWithSigData calldata vars) external;
     ...
     */
    function setProfileImageURIWithSig(LensDataTypes.SetProfileImageURIWithSigData calldata vars)
        external;
     ...
     */
    function setFollowNFTURIWithSig(LensDataTypes.SetFollowNFTURIWithSigData calldata vars) external;
     ...
     * @return uint256 An integer representing the comment's publication ID.
     */
    function commentWithSig(LensDataTypes.CommentWithSigData calldata vars) external returns (uint256);
     ...
     * @return uint256[] An array of integers representing the minted follow NFTs token IDs.
     */
    function followWithSig(LensDataTypes.FollowWithSigData calldata vars)
        external
        returns (uint256[] memory);
     ...
     * @return uint256 An integer representing the minted token ID.
     */
    function collectWithSig(LensDataTypes.CollectWithSigData calldata vars) external returns (uint256);
     ...
     *
     * @return tuple First, the address of the collectNFT associated with the queried publication, second, a boolean
     * True if the the collectNFT is deployed, false otherwise.
     */
    function getCollectNFT(uint256 profileId, uint256 pubId) external view returns (address, bool);
    ...
    function getPub(uint256 profileId, uint256 pubId)
        external
        view
        returns (LensDataTypes.PublicationStruct memory);
     ...
     */
    function getPubType(uint256 profileId, uint256 pubId) external view returns (LensDataTypes.PubType);
