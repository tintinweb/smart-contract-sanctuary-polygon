...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xd7d762F4b2129B22213c9363DF753f8E43F7dE34];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 20, 9999 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://api.yourproject.com/deadp/";
...
// File: contracts/OmniDeadPoolContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OmniDeadPoolContract is RamppERC721A {
    constructor() RamppERC721A("Omni DeadPool ", "DEADP"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/9I5X5k4TiJdf6SfirvRD/contract-metadata";
    }
}
