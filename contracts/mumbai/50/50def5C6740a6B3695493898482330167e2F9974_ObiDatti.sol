...
contract ObiDatti is ERC721, ERC721URIStorage, Ownable, EIP712, AccessControl {
    ...
    constructor(address minter) ERC721("ObiDatti", "ODN") EIP712(SIGNING_DOMAIN, SIGNING_VERSION) {
        _setupRole(MINTER_ROLE, minter);
    }


    function mintNFT(address _to, ObiDattiVoucher calldata _voucher) public payable {
    ...
    function _hash(ObiDattiVoucher calldata voucher) internal view returns(bytes32){
        return _hashTypedDataV4(keccak256(abi.encode(
            //function selector
            keccak256("ObiDattiVoucher(uint256 tokenId,uint256 price,string uri)"),
            voucher.tokenId,
            voucher.price,
    ...
    function _verify(ObiDattiVoucher calldata voucher) internal view returns(address){
