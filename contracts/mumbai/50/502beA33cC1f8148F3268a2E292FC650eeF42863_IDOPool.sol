...
contract IDOPool is Ownable, Pausable, KLAYDAOWhitelist {
    ...
    function buyTicket(
        ...
        require(_verifyBuyTicket(_to, _amount, _id, _quantity, proof), "POOL:INVALID_MERKLE");
    ...
    function _verifyBuyTicket(
        ...
        return (verifyBuyTicket(_candidate, _amount, _id, _quantity, proof));
    }
...
contract KLAYDAOWhitelist {
    ...
    function verifyBuyTicket(
        ...
        return MerkleProof.verify(proof, rootBuy, leaf);
    }
