...
contract ChainBattles is ERC721URIStorage {
    ...
    function getSpeed(uint256 tokenId) public returns(string memory) {
        nftChange = NftChange(tokenIdtoLevels[tokenId], tokenIdtoSpeed[tokenId], tokenIdtoStrength[tokenId], tokenIdtoLife[tokenId]);
        return nftChange.speed.toString();
    }

    function getStrength(uint256 tokenId) public returns(string memory) {
        nftChange = NftChange(tokenIdtoLevels[tokenId], tokenIdtoSpeed[tokenId], tokenIdtoStrength[tokenId], tokenIdtoLife[tokenId]);
        return nftChange.strength.toString();
    }

    function getLife(uint256 tokenId) public returns(string memory) {
        nftChange = NftChange(tokenIdtoLevels[tokenId], tokenIdtoSpeed[tokenId], tokenIdtoStrength[tokenId], tokenIdtoLife[tokenId]);
    ...
    function mint() public {
        ...
        tokenIdtoSpeed[newItemId] = 50;
        tokenIdtoStrength[newItemId] = 100;
    ...
    function train(uint256 tokenId) public {
        ...
        tokenIdtoSpeed[tokenId] = currentSpeed + 50;
        tokenIdtoStrength[tokenId] = currentStrength + 100;
