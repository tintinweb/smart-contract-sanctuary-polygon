...
contract ERC721Token is ERC721AQueryable, Ownable, AccessControl {
    ...
    /**
     * @dev function to mint nft to a specific address.
    ...
    /**
     * @dev function to mint tokens in bulk for airdrop purposes.
     * @param recipients The array of addresses that will receive the tokens.
     */
    function mintAirdrop(address[] calldata recipients) external onlyOwner {
        require(recipients.length > 0, "No recipients");
        require(totalSupply() + recipients.length <= maxSupply, "Not enough supply left.");
