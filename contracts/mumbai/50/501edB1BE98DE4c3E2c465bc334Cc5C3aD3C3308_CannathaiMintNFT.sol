...
contract CannathaiMintNFT is ERC721A, Ownable, ReentrancyGuard, AccessControl{
    ...
    uint8 MAX_PRIVATESALE_MINTS = 5;
    uint8 MAX_PUBLICSALE_MINTS = 10;
    uint8 MAX_MINTS = 50;
    uint16 MAX_SUPPLY = 2000;
    uint16 MAX_PRIVATESALE_SUPPLY = 300;
    uint16 MAX_PUBLICSALE_SUPPLY = 9700;
    ...
    function mintPublicSale(uint8 quantity) external payable nonReentrant whenPublicSaleNotPaused {
        ...
        require(quantity <= MAX_PUBLICSALE_MINTS, "Exceeded the Public Sale limit");
