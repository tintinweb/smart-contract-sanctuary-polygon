...
interface INursery {
    ...
    function getKittyPrice() external view returns (uint256);
...
// File: Kitty/interfaces/IOracle.sol
...
// File: Kitty/interfaces/IBasisAsset.sol
...
// File: Kitty/utils/ContractGuard.sol
...
// File: github.com/OpenZeppelin/openzeppelin-contracts/blob/v3.4.0/contracts/utils/Context.sol
...
// File: github.com/OpenZeppelin/openzeppelin-contracts/blob/v3.4.0/contracts/access/Ownable.sol
...
// File: github.com/OpenZeppelin/openzeppelin-contracts/blob/v3.4.0/contracts/GSN/Context.sol
...
// File: github.com/OpenZeppelin/openzeppelin-contracts/blob/v3.4.0/contracts/utils/ReentrancyGuard.sol
...
// File: github.com/OpenZeppelin/openzeppelin-contracts/blob/v3.4.0/contracts/utils/Address.sol
...
// File: github.com/OpenZeppelin/openzeppelin-contracts/blob/v3.4.0/contracts/math/SafeMath.sol
...
// File: github.com/OpenZeppelin/openzeppelin-contracts/blob/v3.4.0/contracts/token/ERC20/IERC20.sol
...
// File: github.com/OpenZeppelin/openzeppelin-contracts/blob/v3.4.0/contracts/token/ERC20/SafeERC20.sol
...
// File: github.com/OpenZeppelin/openzeppelin-contracts/blob/v3.4.0/contracts/math/Math.sol
...
contract Treasury is ContractGuard {
    ...
    function initialize(
        ...
        supplyTiers = [0 ether, 200000 ether, 400000 ether, 600000 ether, 800000 ether, 2000000 ether, 4000000 ether, 8000000 ether, 20000000 ether];
