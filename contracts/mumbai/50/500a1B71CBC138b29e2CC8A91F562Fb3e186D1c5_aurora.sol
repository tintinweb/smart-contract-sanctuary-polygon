...
contract aurora is ERC1155{
    ...
    //     _uris[tokenId] = uri; 
    // }
    function mintFlight() public payable{
    ...
    function mintTrain() public payable{
        require(msg.value == 0.1 ether, "insufficient ether");
    ...
    function mintCruise() public payable{
        require(msg.value == 0.1 ether, "insufficient ether");
    ...
    function mintHotel() public payable{
        require(msg.value == 0.1 ether, "insufficient ether");
