...
contract EMPackageSaleManager is Pausable, Ownable {
    ...
    updateSaleStape
    {
        ...
        require(
            ...
            "EMPackageSaleManager(guildSale): Max supply exceeded"
        );
    ...
    updateSaleStape
    {
        ...
        //      require(totalPackagesCount <= MAX_SUPPLY, "EMPackageSaleManager(publicSale): Max supply exceeded");
        // } else{
        //     require(isWhiteListed(msg.sender, _proof), "EMPackageSaleManager(publicSale): Not whiteListed");
        //     require(privateSaleCount <= MAX_PRIVATE, "EMPackageSaleManager(publicSale): Max supply exceeded");
        //     isPrivateSale = true;
        // }
        ...
        payable(RefundManager).call{value: msg.value}("");
