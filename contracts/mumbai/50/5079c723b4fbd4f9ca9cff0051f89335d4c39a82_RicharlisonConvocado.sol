...
contract RicharlisonConvocado is ERC721A, Ownable {
    using Address for address;
    using Strings for uint256;
    ...
    uint256 private _nftEtherValue = 15530000000000000;
    ...
    ) ERC721A("Richarlison Convocado", "RCH") {
