...
contract Marketplace1155_V4 is 
  Initializable, 
  OwnableUpgradeable, 
  ...
  UUPSUpgradeable 
{
    ...
    whenNotPaused
  {
    ...
    emit MarketItemSale(itemID, msg.sender, marketItem.seller, amount, price, mainFee, marketFee, royaltyFee);
    ...
    whenNotPaused
  {
    ...
    emit ResellItemSale(itemID, resellID, msg.sender, offer.seller, amount, price, mainFee, marketFee, royaltyFee);
    ...
    if (offer.amountToSell == 0) {
      ...
      emit ResellItemSold(itemID, resellID, offer.seller, offer.price);
    }
  }
