...
contract TxERC20Facet is IOperations {
    ...
    function depositERC20(IERC20 _tokenAddress, uint88 _amount) external {
        ...
        require(depositAmount > 0, "TE20F: Deposit amount is invalid");

        Deposit memory deposit = Deposit({from: msg.sender, listingId: listingId, tokenId: 0, amount: depositAmount});
