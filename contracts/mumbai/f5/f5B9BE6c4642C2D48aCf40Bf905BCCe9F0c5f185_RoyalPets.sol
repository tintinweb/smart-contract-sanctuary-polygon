...
contract RoyalPets is ERC721URIStorage, ERC2981, DefaultOperatorFilterer, Ownable {
  ...
  uint256 public royaltiesBasisPoints = 150;
  address public royaltiesAddress = address(0x287f0B854a2Ba9Dc3E8572c68bDabD949819F119);
  string public contractName = "TESTNAME";

  constructor() ERC721("RoyalPets", "RP") {
    setContractURI("https://ipfs.io/ipfs/bafkreig45twl5mtmpwpdo3vteffjb33dwawhfmgigbk7upihuddcaxuhle");
  ...
  //           '", "fee_recipient": "0x287f0B854a2Ba9Dc3E8572c68bDabD949819F119" }' // Where seller fees will be paid to.}
  //       )
  //   );
  //   _contractURI = string(abi.encodePacked(
