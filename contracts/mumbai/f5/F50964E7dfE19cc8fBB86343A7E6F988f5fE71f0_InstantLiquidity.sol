    ...
    IERC721Receiver
{
    ...
    function withdrawTnft(ITangibleNFT _nft, uint256 _tokenId) external onlyFactoryAdmin {
         require(_nft.ownerOf(_tokenId) == address(this), "IL not owner");
         _nft.safeTransferFrom(address(this), msg.sender, _tokenId);
         delete instantMarketplace[address(_nft)][_tokenId];
    }

    function withdrawFTnft(ITangibleFractionsNFT _ftnft, uint256 _tokenId) external onlyFactoryAdmin {
