...
interface IVault {
    ...
    function cumulativeFundingRates2(address _token) external view returns (int256);
...
interface IVaultUtils {
    ...
    function getFundingFee2(address _account, address _collateralToken, address _indexToken, bool _isLong, uint256 _size, int256 _entryFundingRate2) external view returns (int256);
    ...
    function getNextFundingRate(address _token) external view returns (uint256);
    function getNextFundingRate2(address _token) external view returns (int256);
