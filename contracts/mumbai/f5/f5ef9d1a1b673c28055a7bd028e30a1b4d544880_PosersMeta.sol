...
contract PosersMeta is Ownable {
    ...
    uint constant public TRAIT_COUNT = 8;
    uint constant public MAX_ASSETS = 41;
    uint32 public EULER = 31;

    string[TRAIT_COUNT] public TRAIT_ORDER = ['type', 'skin', 'outfit', 'eyes', 'hats', 'mouth', 'bg', 'hairstyle'];
    uint32[TRAIT_COUNT] public DRAW_ORDER = [6, 1, 0, 5, 7, 2, 3, 4];
    ...
    function tokenMeta(uint tokenId, uint tokenSeed) public view returns (string memory){
        ...
        bytes memory name = abi.encodePacked("fuder #", Strings.toString(tokenId));
