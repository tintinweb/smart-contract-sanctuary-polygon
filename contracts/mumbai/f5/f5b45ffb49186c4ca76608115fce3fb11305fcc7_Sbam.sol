...
contract Sbam is Ownable, ERC721, ERC721Enumerable, ERC721Royalty, EIP712, ERC721Votes {
    ...
    constructor(address payable payee_) ERC721("Sbam", "SBAM") EIP712("Sbam", "1") {
        require(payee_ != address(0), "Sbam::constructor: payee cannot be zero address");
    ...
    function batchMint(address to, uint256 amount) external onlyOwner {
        require(totalSupply() + amount <= maxSupply, "Sbam::batchMint insufficient supply");
    ...
    function mint() external payable {
        require(msg.value >= price, "Sbam::mint: insufficient payment");
        require(totalSupply() < maxSupply, "Sbam::mint: insufficient supply");
