...
contract EternalNFT is ERC721URIStorage {
    ...
    string[] element = ["Fire", "Wind", "Wave", "Earth", "Thunder", "Space", "Time"];

    string[] weapon = ["Sword", "Spear", "Shield", "Hammer", "Saber", "Axe", "Bow"];

    string[] rank = ["Lord", "King", "Emperor", "Venerable", "Ancestor", "Saint", "God"];
