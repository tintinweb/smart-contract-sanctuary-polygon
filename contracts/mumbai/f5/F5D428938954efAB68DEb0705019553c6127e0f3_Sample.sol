...
contract Sample is Ownable{
    ...
    // 合格証NFTのコントラクトを取得する
    constructor(IERC721 _erc721Contract, IERC721 _erc721PresentContract) {
        erc721Contract = _erc721Contract;
        erc721PresentContract = _erc721PresentContract;
    }
    ...
    function test() public {
        erc721PresentContract.safeTransferFrom(address(this), msg.sender, 0);
    }
