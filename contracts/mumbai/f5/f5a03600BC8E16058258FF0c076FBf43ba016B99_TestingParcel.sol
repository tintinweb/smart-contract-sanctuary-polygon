...
contract TestingParcel is ERC721, ReentrancyGuard, Ownable, ContextMixin {
    ...
    function tokenURI(uint256 tokenId) public override view returns (string memory) {
        string[10] memory i;
        i[0] = '{\n\t\"name\": \"Metaverse TestingParcel Testing\",\n';
        ...
        return bytes(output).length > 0 ? output: "";
    }
    ...
    public nonReentrant {
        ...
        _mint(msg.sender, tokenNow); // trying to minting
