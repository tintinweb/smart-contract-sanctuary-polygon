    ...
    IERC2981
{
    ...
    mapping(uint256 => bool) private convertable;
        ...
        returns (address)
    {
        ...
        require(newMinted <= supply[data.tokenId], "more than supply");
        ...
        require((data.tokenId << 160) >> 40 == 0, "Token id is wrong");
    ...
    function mintAndTransfer(
        ...
        require(isApprovedForAll(minter, data.creator) || _msgSender() == data.creator, "Not approved");
    ...
    function convertPass( address account, uint256 id, uint256 amount ) external virtual {
        ...
        for (uint256 i = 0; i < amount; i++) {
            uint256 newTokenId = ((id >> 96 ) << 96) + tokenIdCounter[id] << 40 + passId;
