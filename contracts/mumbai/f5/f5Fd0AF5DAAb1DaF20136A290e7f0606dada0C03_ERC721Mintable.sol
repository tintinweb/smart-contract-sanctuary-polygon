 ...
 * @author gotbit
 * @dev Implementation of the mintable ERC721 collection for creating 
 * proxy contracts through CollectionFactory contract
 */
contract ERC721Mintable is IERC721Mintable, ERC721Upgradeable {
     ...
     * @param creator_ ERC721 collection creator
     ...
     * Doesn't require the token id to be minted.
     * @param tokenId ERC721 token id
     * @return Token URI
     */
    function tokenURI(uint256 tokenId)
        public
        view
        override(IERC721Mintable, ERC721Upgradeable)
