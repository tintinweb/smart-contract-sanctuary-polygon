...
contract NFTin{
    ...
    function _setRating(address _user, uint _newRating) external {  //external by develop
    ...
    function _setProfile(ProfileInfo calldata _profile) external{ //external by develop
        ...
        profiles[_profile.profileAddress] = _profile;
    }

    function _setLike(uint _postNum, address _profile) external { //external by develop
