...
import "../contracts/MasterRegistry.sol";

contract $MasterRegistry is MasterRegistry {
    bytes32 public __hh_exposed_bytecode_marker = "hardhat-exposed";

    constructor() {}

    function $_presetProjectDetails(uint256 _projectId,uint256 _factoryId,string calldata _projectName,string calldata _projectBannerUrl,address _owner,bool _state) external {
        super._presetProjectDetails(_projectId,_factoryId,_projectName,_projectBannerUrl,_owner,_state);
    }
