...
contract BreedingAuction is ClockAuction {
    constructor(address _nftAddress, uint256 _cut)
        ClockAuction(_nftAddress, _cut)
    {}
        ...
        whenNotPaused
    {
        ...
        nonFungibleContract.addBreedingRights(_tokenId, msg.sender);
    }
}
...
contract UIAMToken is AllelePlantBase, GeoLocation {
    ...
    function createGen2(uint256 _parentId, uint256 total) external {
        ...
        require(
            ownerOf(_parentId) == msg.sender || _owns(msg.sender, _parentId),
