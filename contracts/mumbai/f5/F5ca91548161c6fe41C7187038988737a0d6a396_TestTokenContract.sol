...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xb2CF1Db250Fa38810565b15005144Bb87f959794,0x041E89e9C5eEDD80dd62D0E7eEE3F0e191cdD459];
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 10001) { }
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://opensea.mypinata.cloud/ipfs/QmZxDanojLvjgzhMe1gBaNdMygqh743xYH4uZpcZVshxUc/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 10001");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 10001");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 10001");
...
contract TestTokenContract is RamppERC721A {
    constructor() RamppERC721A("TestToken", "TTKN"){}
}
