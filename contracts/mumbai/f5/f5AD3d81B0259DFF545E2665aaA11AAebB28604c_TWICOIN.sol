...
abstract contract TIP is ContractTools, ERC20 {
  ...
  mapping(bytes => mapping(address => uint256)) private tipReceiveRecord;
  ...
  uint256 internal constant MAX_TIP_AMOUNT = 1000000000000000000;


    //event: create a tip
    event SetTip(address indexed creatorAddress, uint256 tipAmount, uint256 maxRecipientCount, 
   ...
   /**
   * setTip
   * @param tipCode_  tip redemption code
   ...
   */
    function setTip(string memory tipCode_,
        ...
        _buildTip(tipCode, tipAmount_, maxRecipientCount_, isRandomDistribution_, isVerifiedRecipient_, startTime_, endTime_);
    ...
    function _buildTip(bytes memory tipCode, 
        ...
        _transferToDepositer(callerAddress,tipAmount);
        ...
        emit SetTip(callerAddress, tipAmount, maxRecipientCount_, isRandomDistribution_, isVerifiedRecipient_, startTime_, endTime_);
    }
    ...
    */
    function getTip(string calldata tipCode_)  
        ...
        require(tipReceiveRecord[tipCode][callerAddress] < tipInfo.startTime ,"410");
        ...
        tipReceiveRecord[tipCode][callerAddress] = block.timestamp;
        
        _transferFromDepositer(callerAddress, receivedAmount);
        emit GetTip(callerAddress, receivedAmount, block.timestamp);
