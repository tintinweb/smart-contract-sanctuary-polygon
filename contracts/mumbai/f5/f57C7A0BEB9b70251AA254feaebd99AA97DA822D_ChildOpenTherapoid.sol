...
/// @title ChildOpenTherapoid
/// @notice ERC-20 implementation of ChildOpenTherapoid token
contract ChildOpenTherapoid is ERC20, Ownable, Pausable {
    ...
    ) ERC20("ScienceCoinChildStage", "SCICS") {
        //solhint-disable-next-line reason-string
        require(
    ...
    function deposit(address user, bytes calldata depositData) external {
        ...
        // `amount` token getting minted here & equal amount gets locked in RootChainManager
