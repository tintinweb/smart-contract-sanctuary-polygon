...
contract MATICBOOST {
	...
	constructor(address payable wallet, address payable _developer) public {
        ...
        plans.push(Plan(21, 85)); // 8.5% per day for 21 days
        plans.push(Plan(28, 70)); // 7% per day for 28 days
		plans.push(Plan(14, 157)); // 15.7% per day for 14 days (at the end)
        plans.push(Plan(21, 151)); // 15.1% per day for 21 days (at the end)
