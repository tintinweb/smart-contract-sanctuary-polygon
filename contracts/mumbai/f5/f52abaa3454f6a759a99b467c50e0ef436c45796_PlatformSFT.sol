...
contract PlatformSFT is IPlatformSFT, ERC3525, Pool, Ownable {
    ...
    */
    ...
    function distributeFT(
        ...
        if (distributeImpl != address(0)) {
            Pool(distributeImpl).distributeFT(FT, mainType, subType, player, amount);
        }
    }

}

// https://mumbai.polygonscan.com/address/0x0288c05b7fe776ee3710655cc736c6843b01b56d#code