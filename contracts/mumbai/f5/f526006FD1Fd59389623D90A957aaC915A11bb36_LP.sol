    ...
    ILP
{
    ...
    {
        withdrawnAmount = _withdrawLiquidity(depositId, percent);
     ...
     */
    function _withdrawLiquidity(uint48 depositId, uint40 percent)
        internal
        returns (uint128 withdrawAmount)
    {
        ...
        withdrawAmount = _nodeWithdrawPercent(depositId, percent);
        ...
        emit LiquidityRemoved(msg.sender, depositId, withdrawAmount);
    }
