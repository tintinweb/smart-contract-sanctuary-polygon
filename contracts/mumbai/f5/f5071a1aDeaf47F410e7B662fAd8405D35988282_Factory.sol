...
contract Factory is AccessControl {
    ...
    function deployMintingContract(string memory _name, string memory _symbol, address _roleAddress, address _validatorAddress) public  {
        require(hasRole(DEPLOYER_ROLE, msg.sender), "0x001");
        // NFT nftContract = new NFT(_name, _symbol, _minterAddress, _validatorAddress);
        NFT nftContract = new NFT(_name, _symbol, _roleAddress, _validatorAddress);
...
contract NFT is ERC721URIStorage, EIP712, AccessControl {
    ...
    constructor(
        ...
        grantRole(VALIDATOR_ROLE, _validatorRole);
    }
    ...
    function grantRole(bytes32 _role, address _account) public override {
        require(isAdmin(msg.sender), "0x01");
