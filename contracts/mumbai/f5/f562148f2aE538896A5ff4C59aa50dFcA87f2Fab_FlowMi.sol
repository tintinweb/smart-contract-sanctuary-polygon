...
contract FlowMi is VRFConsumerBaseV2 {
    ...
    IWETH private imatic;
    IWETH private iWmatic;
    IWETH private iaWmatic;
    ...
    constructor(
        ...
        // IWeths
        //imatic = IWeth(maticTokenAddress);
        iWmatic = IWETH(wmaticTokenAddress);
        //iaWmatic = IWeth(awmaticTokenAddress);
    ...
    function flowmiFollow(address _profileid) public payable {
        ...
        if (
            ...
            s_profileToRaffles[_profileid]++;
            requestRandomWords();

            //  withdraw(maticAddress, (i_goal - 1) * i_flowmiCost);
        } else {
            //wrap
            //iWmatic.approve(address(this), fraction * i_flowmiCost);
            //imatic.approve(address(this), fraction * i_flowmiCost);
            iWETHGateway.depositETH{value: fraction * i_flowmiCost}(
                address(POOL),
                address(this),
                0
            );
