...
contract Fish is ONFT721 {
    uint private startId;
    uint public constant maxSupply = 10000000;
    ...
    function setMintPrice(uint _mintprice) external {
    ...
    function mint(uint _amount) external payable {
        ...
        require(
            tokenId + _amount < startId + maxSupply,
