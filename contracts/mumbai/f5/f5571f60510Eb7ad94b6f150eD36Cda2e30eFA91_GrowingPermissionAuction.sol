...
contract GrowingPermissionAuction is ClockAuction {
    ...
    function createAuction(
        ...
        require(isOnAuction(_tokenId) == false, "GrowingPermissionAuction: Already on Auction");
        ...
        whenNotPaused
    {
        ...
        nonFungibleContract.addGrowingPermission(_tokenId, msg.sender);
    }
}
...
contract ClockAuction is Pausable, Ownable, ClockAuctionBase {
    ...
    ///  ownership of the NFT if enough Ether is supplied.
    /// @param _tokenId - ID of token to bid on.
    function bid(uint256 _tokenId, uint256 _bidAmount) external virtual whenNotPaused {
        // _bid will throw if the bid or funds transfer fails
        _bid(_tokenId, _bidAmount);
