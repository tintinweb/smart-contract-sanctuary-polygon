...
contract ERC20MerkleAirdrop is Ownable {
    ...
    bytes32 public immutable merkleRoot = 0xa30314becb049bbb3b71a7a408317ce6b00571a6f9a8416f12c97ae2c8010bcc;

    //this value should be set by template; ERC20 token address that will be used for airdrop
    address public immutable tokenAddress = 0x0000000000000000000000000000000000001010;
    ...
    uint256 public immutable totalTokens = 0x470de4df820000;
    uint256 public claimedTokens  = 0;
    uint256 public availableTokens = 20000000000000000;
