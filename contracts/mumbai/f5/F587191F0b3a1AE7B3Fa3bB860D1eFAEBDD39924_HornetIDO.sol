...
contract HornetIDO is Ownable, ReentrancyGuard, PaymentSplitter, LogisticVRGDA {
    ...
    uint256 private VRGDASale;

    uint256 public publicPrice = 0.00001 ether;
    uint256 public whitelistPrice = 0.000005 ether;
    ...
    constructor (
        ...
        LogisticVRGDA (
            0.00001e18, // Launch price
            0.31e18, // Price decay percent.
            int256(_maxSale),
            0.00023e18 // Time scale.
        )
    {
    ...
    nonReentrant {
        ...
        /// safety check
        require(msg.value >= allocation.fmul(hornetPrice(), FixedPointMathLib.WAD), "HORNET IDO : Wrong price");
    ...
    nonReentrant {
        ...
        /// safety check
        require(msg.value == (whitelistPrice*allocation), "HORNET IDO : Wrong price");
        
        amountAllocated[msg.sender] += allocation;
        currentSale += allocation;
        VRGDASale += allocation/1e18;
    ...
    function hornetPrice() public view returns (uint256) {
        // We need checked math here to cause underflow
        // before minting has begun, preventing mints.
        uint256 timeSinceStart = block.timestamp - idoStart;
        
        uint256 VRGDAPrice = getVRGDAPrice(toDaysWadUnsafe(timeSinceStart), VRGDASale);

        if (VRGDAPrice < publicPrice) return publicPrice;
