...
contract BlindBox is OwnableUpgradeable, ItemPool, ReentrancyGuardUpgradeable {
    ...
    uint256 public user_buy_count_n;
    uint256 public user_buy_count_s;
    ...
    function buyBox(uint amount, uint boxType) external payable nonReentrant
    {
        ...
        if(boxType == ITEM_TYPE_1)
        {
            ...
            require(user_buy_count_n + amount <= max_count_user_n, "amount limit");
        ...
        else
        {
            ...
            require(user_buy_count_s + amount <= max_count_user_s, "amount limit");
