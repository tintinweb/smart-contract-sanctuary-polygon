...
contract BadExpressions is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  using Strings for uint256;

  constructor(string memory customBaseURI_) ERC721("Bad Expressions", "BE") {
    customBaseURI = customBaseURI_;

    allowedMintCountMap[owner()] = 20;
  }
  ...
  uint256 public constant PRICE = 200000000000000;

  Counters.Counter private supplyCounter;

  function mint(TokenParameters calldata parameters) public payable nonReentrant
  {
    ...
    require(msg.value >= PRICE, "Insufficient payment, 0.0002 ETH per item");
  ...
  string private customContractURI = "https://theraritynft.com";
  ...
  {
    return (address(this), (salePrice * 720) / 10000);
  }
