 ...
 * @notice This contract handles minting Larisa tokens.
 */
contract Larisa is ERC1155Supply, Ownable, Pausable, ReentrancyGuard, ERC2981 {
    using ECDSA for bytes32;

    // Used to validate authorized presale mint addresses
    address private presaleSignerAddress =
        0xF8164555aab6e7EeCe409492d705181E8FCE1A5a;
    ...
    address public royaltyAddress = 0x3ed5d446eE46a7f695fEC94fb525C49521D2ddFe;
    address[] public payoutAddresses = [
        0x3ed5d446eE46a7f695fEC94fb525C49521D2ddFe
    ];
    ...
    string public name = "Larisa";
    string public symbol = "LARA";
    ...
    constructor(address _blocklistContractAddress)
        ERC1155(
            "ipfs://bafybeieu4ypqfbgvhnkgxfbzbi7shqippi3fv42q2p7yze3ll7pt5xlsre/{id}"
        )
    {
        blocklistContractAddress = _blocklistContractAddress;
        _setDefaultRoyalty(royaltyAddress, royaltyFee);
        tokenMaxSupply[1000000] = 100;
        tokenPublicPrice[1000000] = 0.01 ether;
        tokenPublicMintsPerAddress[1000000] = 5;
        tokenPublicSaleStartTime[1000000] = 1675803600;
        tokenPublicSaleEndTime[1000000] = 1738962000;
        tokenUsePublicSaleTimes[1000000] = true;
        tokenPresaleMaxSupply[1000000] = 500;
        tokenPresalePrice[1000000] = 0.01 ether;
        tokenPresaleMintsPerAddress[1000000] = 5;
        tokenPresaleSaleStartTime[1000000] = 1675803600;
        tokenPresaleSaleEndTime[1000000] = 1675850401;
        tokenUsePresaleTimes[1000000] = true;
        require(
