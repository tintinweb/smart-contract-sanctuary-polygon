...
contract ChainBattles is ERC721URIStorage {
        ...
        )
    {
        ...
        uint256 speed = characters.strength;
    ...
    function train(uint256 tokenId) public {
        ...
        Characters storage currentCharacter = tokenIdToCharacters[tokenId];
        currentCharacter.levels = currentCharacter.levels + 1;
        currentCharacter.hp = currentCharacter.hp + 100;
        currentCharacter.strength = currentCharacter.strength + 50;
        currentCharacter.speed = currentCharacter.speed + 60;
