...
contract Decentrawood is ERC20 {
    ...
    address constant public admin = 0x418084C5E6a34790c954D45Fc8eB8524a540E860;
    address constant public marketingTeamAddress = 0xde5222980234799300DD7f6D324E10435D1bD692;
    address constant public developmentTeamAddress = 0xF9dAF9cC3835b78591f09b22FDC6F552D9aE6E76;
    address constant public strategicAllianceTeamAddress = 0xd4E7371E22F1DdEca24b797473F6CBCfB0CA4BB0;
    address constant public airdropWalletAddress = 0x4A8CA6F4e245a3573A88Fbe5925F445BC1724419;
    address constant public liquidityWalletAddress = 0xcF6418116002B1e5681Cd3279aAB579E53742910;
    ...
    function getTokenAllotment(address _address, address _referedTo, uint256 _amount) internal  {
        ...
        allotmentCount = allotmentCount + 1;
        Allotment memory alt = Allotment(allotmentCount, _referedTo, _address, block.timestamp, _amount);
        allotments[allotmentCount] = alt;
        totalTokensPurchased[_address] = totalTokensPurchased[_address].add(_amount);
        userAllotmentIds[_address].push(allotmentCount);
	...
	function buyToken(uint256 _amount, address referrer) public  {
		...
		if (ref.referrer == address(0)) {
			if (referals[referrer].referalIds.length > 0 && referrer != msg.sender) {
			...
			for (uint256 i = 0; i < 6; i++) {
				if (upline != address(0)) {
					referals[upline].levels[i] = referals[upline].levels[i].add(1);
