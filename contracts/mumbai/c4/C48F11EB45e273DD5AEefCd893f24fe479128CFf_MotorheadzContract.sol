...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x276842aBe4392DBe65d9901368ee639F11336674];
  address public erc20Payable = 0x276842aBe4392DBe65d9901368ee639F11336674;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 50, 17000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmPXn9g19Kwo6xvJdA685uRfqWBMSkZ5fSDft3ofEWytXd/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 17000");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 17000");
    ...
    function mintToMultipleERC20(address _to, uint256 _amount, address _erc20TokenContract) public payable {
      require(_amount >= 1, "Must mint at least 1 token");
      require(_amount <= maxBatchSize, "Cannot mint more than max mint per transaction");
      require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 17000");
      require(mintingOpen == true, "Minting is not open right now!");
...
// File: contracts/MotorheadzContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MotorheadzContract is RamppERC721A {
    constructor() RamppERC721A("motorheadz", "MH"){}
}
