...
/**
 * @title A version manager and NFT-ChanceRoom collection that holds _implementations, _templates and
 * cloned chanceRooms.
...
contract ChanceRoomFactory is ERC721Upgradeable, ERC721EnumerableUpgradeable, OwnableUpgradeable {
    ...
    /**
     * @dev Returns a list of cloneable verified implementation names.
     */
    ...
    /**
     * @dev Returns a list of useable verified template names.
     */
    ...
    /**
     * @dev Returns a list of all versions of a template in a raw.
     */
