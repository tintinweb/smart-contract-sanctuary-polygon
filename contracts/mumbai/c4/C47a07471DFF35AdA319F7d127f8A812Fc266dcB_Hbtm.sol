...
contract Hbtm is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Hbtm", "HBM") {
    setHiddenMetadataUri("ipfs/QmQEnTbxHDvSd2EK5NHn3JdsvcWwtVLEX5tWaoE1g9xvjr/hidden.json");
    buildings.push(Building("ZERO", 0,0,0,0,0,0));
    buildings.push(Building("House", 1,3,2,2,0,3));
    buildings.push(Building("Abdelghani House", 5,5,2,3,4,5));
