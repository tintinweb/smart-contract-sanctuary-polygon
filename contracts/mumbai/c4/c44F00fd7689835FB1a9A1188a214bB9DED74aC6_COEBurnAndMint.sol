  ...
  ReentrancyGuard
{
  ...
  function finishOpenFP() public nonReentrant {
    ...
    NftInterface(ethernalsAddress).adminMint(
      msg.sender,
      randomWords[1] % 5, //TODO: maybe just use static amount of types
      1,
      1
    );
    ...
    NftInterface(adventurersAddress).adminMint(
      msg.sender,
      randomWords[2] % 9, //TODO: maybe just use static amount of types
      1,
      1
    );
    console.log("minting card backs...");
    NftInterface(cardBacksAddress).adminMint(msg.sender, 0, 1, 1); //silver
    NftInterface(cardBacksAddress).adminMint(msg.sender, 1, 1, 1); //gold
