...
contract RandomWinnerGame is VRFConsumerBase, Ownable {
   ...
   */
   ...
   /**
   * startGame starts the game by setting appropriate values for all game by setting appropriate values for all the variables
   */
...
function joinGame() public payable {
   ...
   */
    ...
    */
    ...
    // Fallback function is called when, msg.data must be empty
