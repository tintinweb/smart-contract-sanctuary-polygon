...
library PriceLibV1 {
  ...
  function getNPMLiquidityPairInStablecoin(IStore s, uint256 amountIn) external view returns (uint256) {
    return getPriceOracleInternal(s).consultLP(amountIn);
  }
...
library RoutineInvokerLibV1 {
  ...
  function _updateNPMPrice(IStore s) private {
