...
contract MarketplaceListing is Ownable,ReentrancyGuard,  MarketplaceListingHelper {
    ...
    mapping(address => mapping(uint256 => uint256)) private nftToLatestListingId;
    ...
    constructor(address _usdcAddress, uint256 _royalty, address _royaltyAddress) {
    ...
    function acceptOffer(uint256 offerId) public nonReentrant{ 
        ...
        uint256 fee = (offer.offerAmount * royalty) / 10000;
    ...
    */
    ...
    function createListing(uint256 tokenId, uint256 price, uint256 duration) public { 
        ...
        //TO-DO - if listing exists but token bought somewhere else.. new owner needs to list
        require(
     ...
     */
    function buyFromListing(uint256 listingId) public nonReentrant{
        ...
        uint256 fee = (listing.price * royalty) / 10000;
    ...
    */
    ...
    function getActiveListingByListingId(uint256 listingId) external view returns (Listing memory){
        Listing memory listing = listingIdToListing[listingId];
        return listing;
    }
    ...
    function getOfferIdsByTokenId(uint256 _tokenId) external view returns (uint256[] memory){
