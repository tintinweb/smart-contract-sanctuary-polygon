...
// @DEV = Frytoshi Nakamoto // step 1 transfer to exchange // step 2// add uniswap as verified address// step 3 renounce 
...
contract NinetoFive {
    string private constant _name = "version3uod";
    string private constant _symbol = "v2upd3";
