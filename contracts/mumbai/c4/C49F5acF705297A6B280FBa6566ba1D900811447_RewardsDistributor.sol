...
contract RewardsDistributor is ImmutableModule {
    ...
    /** @dev Recipient is a module, governed by Carbon Starter governance */
    constructor(
        address _nexus,
    ...
    /**
     * @dev Allows the Carbon Starter governance to add a new FundManager
    ...
    /**
     * @dev Allows the Carbon Starter governance to remove inactive FundManagers
 ...
 */
abstract contract ImmutableModule {
