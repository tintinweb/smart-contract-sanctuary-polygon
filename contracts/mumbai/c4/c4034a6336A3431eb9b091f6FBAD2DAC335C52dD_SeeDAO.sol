...
contract SeeDAO is ERC1155, Ownable{
    ...
    //铸造新 ID NFT
    function ownerMint(uint256 _tokenID,uint256 _amount,uint256 _totalAmount) public onlyOwner { 
        ...
        emit OwnerMint(address(this),msg.sender,_tokenID,_amount,_totalAmount);
    } 
