...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x5ADDa22610468Ea9e6D72773C43A6B44D0CBd360];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeid2yn3agiwbhcdgb55ks4ojuskxbi2d6dittzmnf6hzyajz45nzam/";
...
contract MrWhiteBirdsGoldenTicketsContract is RamppERC721A {
    constructor() RamppERC721A("Mr White Birds Golden Tickets", "DMND"){}
}
