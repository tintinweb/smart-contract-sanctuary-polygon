...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x72e6E64cdE38cEb04Ce52CAC5b426AF8402D20c6];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 3, 2999 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmUkgEz2QiqkbU9cKUg4twgNyZyj7LH65vD6JHEBGDihPE/";

    bool public mintingOpen = true;
    
    uint256 public PRICE = 165 ether;
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 2999");
        _safeMint(_to, 1);
    }
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 2999");
...
// File: contracts/brandedApesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BrandedApesContract is RamppERC721A {
    constructor() RamppERC721A("Branded Apes", "BASC"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/LVWiZDNuoF7oWdaWz3ju/contract-metadata";
    }
}