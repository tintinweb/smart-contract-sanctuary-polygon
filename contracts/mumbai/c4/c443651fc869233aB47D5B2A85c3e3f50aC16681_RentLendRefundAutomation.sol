...
contract RentLendMarketplace is ReentrancyGuard, IRentLendMarketplace {
    ...
    function checkAndReturnRentedAutomation() external {
        require(
...
contract RentLendRefundAutomation is AutomationCompatibleInterface {
        ...
        returns (bool upkeepNeeded, bytes memory performData)
    {
        ...
        upkeepNeeded = _refunds > 0;
    }

    function performUpkeep(bytes calldata /*performData*/) external override {
        rentLendMktAddress.checkAndMarkRefundAutomation();
    }
