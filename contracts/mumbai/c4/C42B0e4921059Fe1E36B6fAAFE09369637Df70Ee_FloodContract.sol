...
//*********************************************************************//
//
//   _____    _       U  ___ u   U  ___ u  ____    
//  |" ___|  |"|       \/"_ \/    \/"_ \/ |  _"\   
// U| |_  uU | | u     | | | |    | | | |/| | | |  
// \|  _|/  \| |/__.-,_| |_| |.-,_| |_| |U| |_| |\ 
//  |_|      |_____|\_)-\___/  \_)-\___/  |____/ u 
//  )(\\,-   //  \\      \\         \\     |||_    
// (__)(_/  (_")("_)    (__)       (__)   (__)_)   
//
//*********************************************************************//
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1664491800;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1664082000;
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x73955fe5AB095F201d55aB50b0F60aB38eB74C13];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x73955fe5AB095F201d55aB50b0F60aB38eB74C13;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  uint256 public PRICE = 14 ether;
  uint256 public EARLY_MINT_PRICE = 10 ether;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeidke37rswltb3eu2qrwvxdihfzwehbpn5bwqbqdywt5j5ituksnxe/";
...
// File: contracts/FloodContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract FloodContract is RamppERC721A {
    constructor() RamppERC721A("Flood", "Flood"){}
}
