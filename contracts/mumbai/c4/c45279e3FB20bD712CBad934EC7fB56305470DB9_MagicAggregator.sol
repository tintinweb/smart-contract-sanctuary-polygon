...
contract MagicAggregator is IMagicAggregator, Ownable {
    ...
    function batchTransfer721(
        ...
        for (uint i=0; i<contracts.length; i++) {
            ...
            //     emit batchTransfer721Response(false, bytes(data), contracts[i], to_addresses[i], token_ids[i]);
            // } catch (bytes memory data) {
            //     // This is executed in case revert() was used
            //     // or there was a failing assertion, division
            //     // by zero, etc. inside getData.
            //     emit batchTransfer721Response(false, data, contracts[i], to_addresses[i], token_ids[i]);
            // }
        }
    }
