...
contract EverNowStaking is Ownable, Pausable {
    ...
    uint256 public minUSDStaking = 10; // usd
        ...
        returns (StakeParameters memory)
    {
        ...
        if (level == 1) {
            return (StakeParameters(10, 15 minutes, 30 minutes)); //548 from cliff date
        } else if (level == 2) {
            return (StakeParameters(10, 30 minutes , 45 minutes)); //548 from cliff date
        } else {
