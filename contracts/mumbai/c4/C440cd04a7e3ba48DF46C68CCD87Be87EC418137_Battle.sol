...
contract Battle {
    ...
    /*\
    returns all stats at once
    \*/
    function getAllStatsOf(address _add) public view returns(player memory) {
        return stats[_add];
    }
    ...
    \*/
    function getAllActive(uint _start) public view returns(uint[] memory, uint[] memory, uint) {
        uint count = 0;
        ...
        return (_id, _times, block.timestamp);
    }
