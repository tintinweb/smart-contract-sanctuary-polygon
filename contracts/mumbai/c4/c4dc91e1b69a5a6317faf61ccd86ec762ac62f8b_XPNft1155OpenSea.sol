...
// File contracts/BridgeNFTBatch.sol
...
// File contracts/XPNft1155OpenSea.sol
...
contract XPNft1155OpenSea is ERC1155, Ownable, BridgeNFTBatch, ERC2981, DefaultOperatorFilterer {
	struct SetRoyalty {
		address receiver;
    ...
    /* Use in testnets or with precautions on the mainnet */
        ...
        returns (string memory)
    {
        ...
        /* If required hex-encoded replace the last line with: */
        string memory hexstringtokenID;
        hexstringtokenID = uint2hexstr(_tokenID);
        return string(abi.encodePacked(_baseURI, hexstringtokenID));
