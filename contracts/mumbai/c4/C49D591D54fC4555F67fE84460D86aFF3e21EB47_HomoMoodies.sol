...
// File: contracts/HomoMoodies.sol
...
contract HomoMoodies is ERC721, Ownable {
    ...
    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmXj7waXfBMnEPnf9rZFCUpnENpEn5eoCu61Eabfv4gqVV/";  
    uint public maxFreeNFTPerWallet = 0;
    uint public maxMintsPerWallet = 15;

    address public authorizedSigner = 0x5172c410aD20d27763c686Ada1458d2c00e145D3;  
    uint public claimingStartTimestamp = 1635285600; // 27 oct 2021 01:00
    uint public mintingStartTimestamp = 1635292800;  // 27 oct 2021 03:00

    uint public totalSupply;
    mapping(address => uint) public claimedNFTs;
    mapping(address => uint) public mintedNFTs;

    constructor() ERC721 ("Homo Moodies", "HM") {
        mintNFTs(1);
    }
    ...
    function withdraw() external onlyOwner {
        ...
        //require(payable(authorizedSigner).send(percent * 100));
