      ...
      string(
        abi.encodePacked(
          _getText(
            ...
            '300.702',
            Strings.toString(
              ParseUtils._parseWeiToEth(_ticketPrice * _maxTickets)
            )
          ),
          _getText(
            '82.438',
            '418.62',
            Strings.toString(ParseUtils._parseWeiToEth(_ticketPrice))
          ),
          _getText(
            '82.438',
            '640.601',
            string(abi.encode(' #', Strings.toString(_ticketId)))
          ),
          _getText(
            '82.438',
            '528.605',
            string(abi.encode(_maxTickets, '/', _numberTickets))
          ),
