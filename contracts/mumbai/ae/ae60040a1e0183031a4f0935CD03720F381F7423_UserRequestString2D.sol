...
// File: contracts/UserRequestString2D.sol
...
contract UserRequestString2D is UserRequest, ConfirmedOwner {
    ...
    ISxTResponseStorage public responseStorageContract;
     ...
     */
    constructor (ISxTRelayProxy sxtRelayAddress, LinkTokenInterface chainlinkTokenAddress, ISxTResponseStorage storageContract)
        UserRequest(sxtRelayAddress, chainlinkTokenAddress)
        ConfirmedOwner(msg.sender)
    {
        responseStorageContract = storageContract;
    }
    ...
    function saveQueryResponse(bytes32 requestId, string[][] calldata data, string calldata errorMessage) external {
        responseStorageContract.saveResponse(requestId, data, errorMessage);
    }
}