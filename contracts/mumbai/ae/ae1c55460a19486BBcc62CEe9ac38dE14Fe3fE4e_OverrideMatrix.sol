...
contract OverrideMatrix is AccessControl {
    ...
    uint256 public baseLocationPrice = 1e18;
    uint256 public basePlatformRate = 25e16;
    ...
    constructor(address _usdt, address _noReferPlatform, address _feePlatform, address _initAcc) {
        // 0x5D330e32933DFF0f0d90eF9D9132FA823f91F2B5
        _grantRole(DEFAULT_ADMIN_ROLE, 0x50A30c6dE1dE43B7eB5be8774Db8bac45f3007A3);
        // 0x68368Ce26663B461A5dAf301E05f4119Da222E76
        _grantRole(SETENV_ROLE, 0x50A30c6dE1dE43B7eB5be8774Db8bac45f3007A3);
        // 0x67BCfc3828a451c8BbBD5c075Ec5beEDAA03C635
    ...
    function accInfo(address account, uint256 grade) public view returns (bool isPauseAutoNewGrant, bool isPauseAutoReVoted) {
