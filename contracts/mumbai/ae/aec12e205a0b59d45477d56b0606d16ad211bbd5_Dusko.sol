    ...
    ERC2981
{
	...
	mapping(address => uint256) public mainList;

    //address[] private firstPayees = [0xF34ddAf8984E115700AEf4EfDC5cb1Bec69785D3,0x83159A9bfcB232f5b91e540FAA29A3CCede3A14B,0xD8f9B770fe183463a1ECF45b72CBb8a460047CdB];
    address[] private firstPayees = [0x6FB41ceF906388936F5B3f2708dE5E854d83f693,0x1888FF943d99626A9048528CE9b167B36C521691,0x61C5727E4143CAd9525325b77183695884a57e7e];
	...
	function mint(uint256 _mintAmount) external payable nonReentrant {
        ...
        if (presale && !mainSale) {
            ...
            mainList[msg.sender] += _mintAmount;
        } else {
            require(mainList[msg.sender] + _mintAmount <= maxMint, "Dusko: Must mint less than the max");
            mainList[msg.sender] += _mintAmount;
        }
