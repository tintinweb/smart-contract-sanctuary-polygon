...
contract Account is Ownable {
    ...
    constructor(address _utilityTokenAddress) {
        require(
     ...
     */
    function increaseUTBalance(address _address, uint256 _amount)
        external
        onlyOwner
    {
        require(!isAddressUnique(_address), "Account: user doesn't exist");
    ...
    function getBalances(address _address, address _token)
        external
        view
        returns (uint256)
    {
