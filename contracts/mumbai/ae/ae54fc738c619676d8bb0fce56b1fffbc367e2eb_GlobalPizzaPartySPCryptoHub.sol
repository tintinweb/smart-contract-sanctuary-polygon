...
//File： fs://1503b335bd14491eb65f2c1dcc527de0/Contrato.sol
...
contract GlobalPizzaPartySPCryptoHub is ERC721A, Ownable {
  using Address for address;
  using Strings for uint256;
  ...
  uint256 private _nftEtherValue = 9 ether;
  ...
  ) ERC721A("GlobalPizzaPartySPCryptoHub", "MAU") {
