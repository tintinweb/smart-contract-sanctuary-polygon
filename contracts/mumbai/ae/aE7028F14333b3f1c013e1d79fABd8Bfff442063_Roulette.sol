...
contract Roulette is VRFConsumerBaseV2, Ownable {
  ...
  */
  function spinWheel() external onlyOwner {
    ...
    b.wheelSpun = true;
    // console.log('from contract requestId : ', requestId);
    ...
    override
  {
    ...
    // console.log('From contract BetId :', _betId);
    // console.log('From contract time :', betIdToBets[_betId].time);
    // console.log(
    //   'From contract  betIdToBets[_betId].randomNumber :',
    //   betIdToBets[_betId].randomNumber
    // );
    random = randomValueBtwRange;
