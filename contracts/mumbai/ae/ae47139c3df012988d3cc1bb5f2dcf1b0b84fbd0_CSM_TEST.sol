...
=== 'CSM_TEST Token' Token contract with following features ===
    => BEP20 Compliance
...
-------------------------------------------------------------------
 Copyright (c) 2022 onwards CSM_TEST
-------------------------------------------------------------------
*/ 
...
contract CSM_TEST is owned {
    
    using SafeMath for uint256;

    string constant private _name = "CSM_TEST";
    string constant private _symbol = "CSM_TEST";
    uint256 constant private _decimals = 8;
    uint256 private _totalSupply;                       
    uint256 private maxSupply = 16000000 * (10**_decimals);
