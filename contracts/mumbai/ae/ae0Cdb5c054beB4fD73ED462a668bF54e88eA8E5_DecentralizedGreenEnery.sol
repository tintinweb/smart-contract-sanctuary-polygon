 ...
 function _transferStandard(address sender, address recipient, uint256 tAmount) private {
    ...
    */
    ...
    function sell(uint256 _amountOfTokens) public {
        ...
        uint256 totalburn = _tokens.sub(_marketing).sub(_reward).sub(_autoBurn);         // Burn the sold tokens
        ...
        //Fire event
        emit onTokenSell(_wallet, _tokens, totalburn);
    }
    ...
    function purchaseTokens(uint256 _incomingMatic)internal returns(uint256){
        ...
        //fire event
        emit onTokenPurchase(msg.sender, _incomingMatic, _amountOfTokens);
