    ...
    AccessControl
{
    ...
    function purchase(
        ...
        require(
            (IERC1155(sale.tokenAddress).balanceOf(_msgSender(), sale.tokenId) +
        ...
        // Transfer USDC
        usdcInstance.safeTransferFrom(_msgSender(), address(this), totalPrice);
        usdcInstance.transfer(modaTreasury, fee);
        usdcInstance.transfer(sale.beneficiary, totalPrice - fee);
        sale.tokenAmount -= _tokenAmount;
