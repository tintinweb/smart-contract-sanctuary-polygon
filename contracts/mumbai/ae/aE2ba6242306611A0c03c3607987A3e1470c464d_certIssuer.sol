...
contract certIssuer{
    ...
    Dados[] certificados;
    Dados private dado;
    function add(uint  _id, string memory _aluno, string memory _matricula, string memory _curso , string memory _instituicao, string memory _data, string memory _link, string memory _cpf) private {
