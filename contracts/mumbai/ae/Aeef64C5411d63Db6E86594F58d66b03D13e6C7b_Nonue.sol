...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x3813e82e6f7098b9583FC0F33a962D02018B6803);
...
contract Nonue is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0x3813e82e6f7098b9583FC0F33a962D02018B6803;
    address public WBNB = 0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Nonue";
    string constant _symbol = "NONUE";
    ...
    function swapBack() internal swapping {
        ...
        try distributor.deposit{value: amountBNBReflection}() {} catch Error(string memory reason) {
            emit LogError(reason);
        }
