...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x34380c46f506C61d30e29C67842037d2e1b37263];
  address public erc20Payable = 0x34380c46f506C61d30e29C67842037d2e1b37263;
...
abstract contract EarlyMintIncentive is Teams, ERC721A, ProviderFees {
  ...
  uint256 public earlyMintTokenIdCap = 124;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://nftstorage.link/ipfs/QmPTZnVPUnRLEWpZFkDSLdDXo48FF1LB3xeX4bDqcNxcud/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/lVvhpGFwSYAV8oUB7vIS/contract-metadata";
  }
...
contract TestyContract is ERC721APlus {
    constructor() ERC721APlus("testy", "tsttttt"){}
}
