...
contract Alligators is
    ...
    */
    ...
    function merge3alligators(uint256 _1st, uint256 _2nd, uint256 _3rd, address merger) external {
        ...
        require(tokenIdType[_1st] == 1 && tokenIdType[_2nd] == 1 && tokenIdType[_3rd] == 1, "FailedBitch");
...
contract MergeGators is Ownable, VRFConsumerBaseV2, IMergeGators {
    ...
    function merge3NFTs(uint256 _1st, uint256 _2nd, uint256 _3rd) public payable {
        ...
        require(success == true, "LowCallFailed");
...
contract MergeGatorsMock is MergeGators {
    ...
    address payable collection_ = payable(0xE05CCAeC90bD18bdD16a4414b4573bcEA108927f);
