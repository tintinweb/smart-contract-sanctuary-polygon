...
contract RealtyOracleTangible is AdminAccess, IPriceOracle, PriceConverter {
    ...
    mapping(uint256 => uint256) private additionals;
        ...
        returns (uint256)
    {
        ...
        uint256 GBPToUSD = (uint256(price) * conversionPremium) / 10000;
        ...
        )
    {
        ...
        uint256 _lockedAmount = converGBPToUSD(additionals[localFingerprint]);
    ...
    function setConversionPremium(uint256 _premium) external onlyAdmin {
        conversionPremium = _premium;
    }
