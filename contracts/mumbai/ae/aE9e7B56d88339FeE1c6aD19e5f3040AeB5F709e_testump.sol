...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x50E74F005F9003b1904FA0bcC3cAAcaEf97B0DE5;
...
contract testump is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x21f9E395ABf408392E06f2b7FA45386768d94b0B;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 500000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "testum";
    string private _symbol = "testum";
