    ...
    KeeperCompatibleInterface
{
    ...
    */
    ...
    function getLatestPrice() public view returns (int256) {
        ...
        // }
        // return (result / 10);
        int256 stakePrice = (price * 1e18 * creating_staking_contract_fee) /
            int256(10**(priceFeed.decimals()));
        return stakePrice;
    }
...
contract Staking is ReentrancyGuard {
    /**
    @dev keeps the owner address and CAN NOT be changed after setting for the first time during construction
     */
    ...
    */
    ...
    function getLatestPrice() public view returns (int256) {
        (, int256 price, , , ) = priceFeed.latestRoundData();
        int256 stakePrice = (price * 1e18) / int256(10**(priceFeed.decimals()));
        return stakePrice;
    }
    ...
    @notice only owner can perform this action
     */
    function set_fee(int256 _new_fee) public nonReentrant onlyOwner {
        fee = _new_fee;
