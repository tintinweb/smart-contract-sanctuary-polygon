...
contract SFUSDStake is Ownable {
    ...
    function deposit(uint256 _amount) external {
        ...
        if (investors[msg.sender].totalRewardAmount >= _amount) {
            ...
            investors[msg.sender].totalRewardAmount = investors[msg.sender]
                .totalRewardAmount
                .sub(_amount);
            depositState[_id].compoundedInvestment = _amount.sub(depositFee);
        } else {
            ...
            depositState[_id].pocketInvestment = _amount.sub(depositFee).sub(investors[msg.sender].totalRewardAmount);
            ...
            investors[msg.sender].pocketInvestment = investors[msg.sender].pocketInvestment.add(_amount.sub(depositFee).sub(investors[msg.sender].totalRewardAmount));
    ...
    function migrateInvestorToV2(
        ...
        if (investors[_investor].totalRewardAmount >= _amount) {
            ...
            depositState[_id].pocketInvestment = _amount.sub(investors[_investor].totalRewardAmount);
            ...
            investors[_investor].pocketInvestment = investors[_investor].pocketInvestment.add(_amount.sub(investors[_investor].totalRewardAmount));
