...
contract Tracking {
    ...
    event ShipmentCreated(address indexed sender, address indexed receiver, uint256 pickupTime, uint256 distance,uint256 price, string  productId );
  ...
  emit ShipmentCreated(sender, _receiver, _pickupTime, _distance, _price,_productId);
}
