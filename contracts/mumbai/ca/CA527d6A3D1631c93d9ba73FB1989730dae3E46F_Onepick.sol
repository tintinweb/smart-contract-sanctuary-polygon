...
contract Onepick is ERC721A, Ownable {
    uint256 collectionSize;

    string internal baseTokenUri;

    constructor(string memory _tokenBaseUri) ERC721A("One Pick NFT", "One Pick NFT") {
    ...
    function safeMint(uint256 _quantity, address receiver) public onlyOwner {
