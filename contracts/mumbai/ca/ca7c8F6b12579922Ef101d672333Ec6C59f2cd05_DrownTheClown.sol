...
contract DrownTheClown is ReentrancyGuard {
    ...
    constructor(IERC20 _gbarsToken, uint256 _costToPlay, uint256 _playerLimit, uint256 _sideBetCost, uint256 _gbarsEmit, uint256[3] memory _gamePurses) {
        admin = msg.sender;
    ...
    function joinGame() public payable nonReentrant {
        ...
        // TODO : SWITCH TO MATIC : should be done
...
//                paymentToken.transfer(winnerAddresses[i], winningAmount);
        ...
        if (sideBetsCheck[triWinners] > 0){
            ...
            // TODO : SWITCH TO MATIC: should be done
            balanceOf[sideBetWinner] +=  getSideBetPool();
//            paymentToken.transfer(sideBetWinner, getSideBetPool());
            ...
            // TODO : SWITCH TO MATIC: should be done (not needed)
...
//        paymentToken.transfer(admin, ((gamePrizePool * houseCut) / 100));
    ...
    function claimWinnings() public nonReentrant {
        ...
        // Get the amount to claim and set to zero before sending to prevent ddos
        uint256 amountToClaim = balanceOf[msg.sender];
        balanceOf[msg.sender] = 0;

        // Send the winnings
        (bool sent, ) = msg.sender.call{value: amountToClaim}("");
        require(sent, "Failed to claim winnings");
    }
