...
contract Grow2Earn is ERC721URIStorage {
    ...
    function makeAgaveNFT(string memory imageURI, string memory animationURI) public {
    ...
    function updateTokenURI(uint256 tokenId, string memory imageURI, string memory animationURI) public {
