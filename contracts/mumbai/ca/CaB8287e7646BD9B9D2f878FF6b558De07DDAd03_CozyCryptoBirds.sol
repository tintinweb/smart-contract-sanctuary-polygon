...
contract CozyCryptoBirds is ERC721, Ownable, RandomlyAssigned {
  ...
  string public baseURI = "https://ipfs.io/ipfs/QmPNZTZ18z7khWpxESGWMTKfW6Z4KCs3dJ1Gd3jjimo7t5/";

  constructor() 
    ERC721("CozyCryptoBirds", "CCB")
    RandomlyAssigned(10000,100) // Max. 10000 NFTs available; Start counting from 1 (instead of 0)
    {
