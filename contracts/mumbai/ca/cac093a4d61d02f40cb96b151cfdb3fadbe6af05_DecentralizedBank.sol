...
contract DecentralizedBank {
    ...
    function PayAnonymously( address payable PayeeAddress, uint PayAmount) public {
        require(HolyRecords[msg.sender] >= PayAmount, "you cannot withdraw what you donot possess.");
        HolyRecords[msg.sender] -= PayAmount;
