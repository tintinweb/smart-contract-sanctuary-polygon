...
contract EthermonExchange is BasicAccessControl {
    ...
    */
    function getEmonRatesFromEth(uint256 _amount)
        ...
        returns (uint256)
    {
        uint256 wrappedEmon = (emonPrice * _amount) / ethPrice;
    ...
    /**
        ...
        @return Price in ETH
    */
    function getEthRatesEmon(uint256 _amount) public view returns (uint256) {
        uint256 wrappedEth = (ethPrice * _amount) / emonPrice;
