...
/// @title The RoboNouns NFT descriptor
...
contract RoboNounsDescriptor is IRoboNounsDescriptor, Ownable {
     ...
     */
    function dataURI(uint256 tokenId, IRoboNounsSeeder.Seed memory seed) public view override returns (string memory) {
     ...
     */
    function generateSVGImage(IRoboNounsSeeder.Seed memory seed) external view override returns (string memory) {
     ...
     */
    function _getPartsForSeed(IRoboNounsSeeder.Seed memory seed) internal view returns (bytes[] memory) {
