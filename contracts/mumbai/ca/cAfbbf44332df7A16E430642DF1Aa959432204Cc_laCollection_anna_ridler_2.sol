...
contract laCollection_anna_ridler_2 is
    ERC721A,
    LaCollectionAccess,
    ReentrancyGuard
{
    ...
    function safeTransferFrom(
        ...
        lastTransferBlockNumber = deltaBlocks();
