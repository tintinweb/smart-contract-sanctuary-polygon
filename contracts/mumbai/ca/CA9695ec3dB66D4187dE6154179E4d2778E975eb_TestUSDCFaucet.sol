...
contract TestUSDCFaucet is Ownable {
    ...
    uint256 public faucetDripAmount = 10_000;

    // timeout after claiming
    uint256 public constant timeout = 1 days;

    // Sets the addresses of the Owner and the underlying token
    constructor(IERC20Metadata _token) Ownable() {
        token = _token;
    }
    ...
    function send() external {
        ...
        nextRequestAt[msg.sender] = block.timestamp + timeout;
