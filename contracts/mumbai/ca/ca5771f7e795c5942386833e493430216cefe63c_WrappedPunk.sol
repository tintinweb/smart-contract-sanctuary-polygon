...
contract WrappedPunk is Ownable, ERC721Enumerable, Pausable {
    ...
    // Instance of CryptoPunks smart contract
    ICryptoPunk internal _punkContract;

    /**
     * @dev Initializes the contract settings
     */
    constructor(ICryptoPunk punkContract_) ERC721("Wrapped Cryptopunks", "WPUNKS") {
        _punkContract = punkContract_;
    }

    /**
     * @dev Gets address of CryptoPunks smart contract
     */
    ...
    function mint(uint256 punkIndex) public whenNotPaused {
        ...
        _punkContract.setInitialOwner(sender, punkIndex);
    ...
    function burn(uint256 punkIndex) public whenNotPaused {
        ...
        // Transfers ownership of punk on original CryptoPunks smart contract to caller
