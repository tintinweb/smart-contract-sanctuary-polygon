...
contract Config is OwnableUpgradeable {
    ...
    AuctionStructure.feeStanService public feeStanService;
    ...
    function initialize(
        ...
        feeStanSystem = _feeStanSystem;
        feeStanFixed = _feeStanFixed;
        feeStanService = _feeStanService;
    }
    ...
    function getFeeStanService()
        external
        view
        returns (AuctionStructure.feeStanService memory)
    {
        return feeStanService;
    }
}
