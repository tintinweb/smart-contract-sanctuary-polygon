...
contract NFT is ERC721URIStorage, EIP712, Ownable {
        ...
        EIP712(SIGNING_DOMAIN, SIGNATURE_VERSION)
    {
        ...
        _grantRole(MINTER_ROLE, _roleAddress);
        _grantRole(VALIDATOR_ROLE, _roleAddress);
    }
    ...
    function _grantRole(bytes32 _role, address _account) public onlyOwner  {
    ...
    function _revokeRole(bytes32 _role, address _account) public onlyOwner {
        if (hasRole(_role, _account)) {
    ...
    function _setupRole(bytes32 _role, address _account) public onlyOwner {
