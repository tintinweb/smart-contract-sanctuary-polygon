...
contract Vibe is ERC20, Ownable {
    ...
    constructor (
        ...
        postMintCampaign.transferOwnership(address(this));
    ...
    function addFundsForPostMint(uint256 _amount) private {
    ...
    emit FundsAddedForpostMint(_amount);
    }

    function addFundsManually(uint256 _amount) external onlyOwner {
        addFundsForPostMint(_amount);
    }
