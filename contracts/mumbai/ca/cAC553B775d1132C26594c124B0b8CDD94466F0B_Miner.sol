...
contract Miner is ERC721Upgradeable {
    ...
    function setGovernance(address _governance) external onlyAuthorized {
        require(_governance != address(0), "setGovernance to the zero address");
        governance = _governance;
    }

    function mintByGovernance(uint256 numberOfToken, address to) public onlyGovernance {
    ...
    modifier onlyGovernance() {
        require(msg.sender == _owner, "not governance");
        _;
    }
