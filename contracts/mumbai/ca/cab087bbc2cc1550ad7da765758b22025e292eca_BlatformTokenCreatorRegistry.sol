...
// File: contracts/IBlatformTokenCreatorRegistry.sol
 ...
 */
interface IBlatformTokenCreatorRegistry {
    /**
     * @dev Gets the creator of the token
     * @param _tokenId uint256 ID of the token
     * @return address of the creator
...
// File: contracts/BlatformTokenCreatorRegistry.sol
 ...
 * @title IERC1155 Non-Fungible Token Creator basic interface
 */
contract BlatformTokenCreatorRegistry is Ownable, IBlatformTokenCreatorRegistry {
    ...
    /////////////////////////////////////////////////////////////////////////
    /**
     * @dev Set Blatform contract address
     * @param _blatform uint256 ID of the token
     */
    function setBlatform(address _blatform) external onlyOwner {
        blatform = _blatform;
    }
    ...
    function setTokenCreator(
        ...
        require(msg.sender == blatform || msg.sender == owner(), "setTokenCreator::only blatform and owner allowed");
     ...
     * @param _oldBlatformAddress get the token ids from the old Blatform contract.
    ...
    function restore(address _oldAddress, address _oldBlatformAddress, uint256 _startIndex, uint256 _endIndex) external onlyOwner {
        BlatformTokenCreatorRegistry oldContract = BlatformTokenCreatorRegistry(_oldAddress);
