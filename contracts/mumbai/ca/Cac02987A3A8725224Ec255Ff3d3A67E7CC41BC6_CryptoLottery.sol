...
contract CryptoLottery is ERC20 {
     ...
     */
        uint256 __token_reward = 0;
        uint256 __fee_value = 0;
        uint256 ___all_eth_reward = 0;
            ...
            if (_tickets[round][number].win_count == 0) {
                ...
                __token_reward += _tickets[round][number].token_reward;
            }
            ...
            if (
                ...
                __fee_value += (_fee * (_ticket_price * 2)) / 100;

                ___all_eth_reward += _tickets[round][number].eth_reward;
            }
            ...
            if (
                ...
                __fee_value += (_fee * (_ticket_price * 5)) / 100;
            ...
            if (
                ...
                __fee_value += (_fee * (_ticket_price * 10)) / 100;
            ...
            if (
                ...
                __fee_value += (_fee * (_ticket_price * 50)) / 100;
            ...
            if (
                ...
                __fee_value += ((_fee * (_ticket_price * 100)) / 100);
            ...
            _token_reward += __token_reward;
            _fee_value += __fee_value;
            _all_eth_reward += ___all_eth_reward;
