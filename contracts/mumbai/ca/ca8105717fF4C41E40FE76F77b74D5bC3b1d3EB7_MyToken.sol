...
contract MyToken is ERC20Authorization, Swap {
    using SafeMath for uint256;
    string public TokenName = "Quarters";
    string public TokenSymbol = "Q";

    uint256 public kusdtRate = 571;
    ...
    constructor(address _q2)
        ERC20(TokenName, TokenSymbol)
        ERC20Authorization(TokenName)
    {
        q2 = _q2;
    }
    ...
    function setKusdtRate(uint256 rate) public onlyOwner {
     ...
     */
    function changeFactoryAddress(address newFactoryAddress) public onlyOwner {
        ...
        returns (uint256)
    {
        ...
        if (swapFromDex) {
            ...
            // exchange(address(kusdt), q2, Q2BurnAmount);
...
contract Swap is Ownable {
    ...
    function exchangeKctPos(
        ...
        //  */
        // factory.exchangeKctPos(
        //     tokenA,
        //     amountA,
        //     tokenB,
        //     estimatePos(tokenA, tokenB, amountA, path),
        //     path
        // );
    }
