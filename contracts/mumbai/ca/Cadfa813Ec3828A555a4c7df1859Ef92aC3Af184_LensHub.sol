...
contract LensHub is LensNFTBase, VersionedInitializable, LensMultiState, LensHubStorage, ILensHub {
    uint256 internal constant REVISION = 5;
    ...
    function createProfile(
        ...
        if (!ILensHub(address(this)).isProfileCreatorWhitelisted(msg.sender))
                ...
                abi.encodePacked(
                    ...
                    Base64.encode(
                        abi.encodePacked(
                            ...
                            '","description":"',
                            handleWithAtSymbol,
                            ' - Trip Protocol Profile","image":"data:image/svg+xml;base64,',
