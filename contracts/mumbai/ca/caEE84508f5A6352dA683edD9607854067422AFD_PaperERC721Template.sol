    ...
    PaperVerification
{
    ...
    constructor(
        ...
        PaperVerification("Paper", "0.0.1", _paperKey)
    {
        setCost(_cost);
...
contract PaperVerification is EIP712 {
    ...
    function _checkValidity(
        ...
        console.logBytes(_data.signature);
        ...
        console.log("Paper key ", _paperKey);
        bool canMint = !minted[_data.nonce];
        ...
        require(canMint, "Mint request already processed");
    }
...
library PaperMintData {
    ...
    function hashData(MintData calldata _data) internal view returns (bytes32) {
        ...
        console.log("_data.recipient", _data.recipient);
        console.log("_data.quantity", _data.quantity);
        console.log("_data.nonce", _data.nonce);
