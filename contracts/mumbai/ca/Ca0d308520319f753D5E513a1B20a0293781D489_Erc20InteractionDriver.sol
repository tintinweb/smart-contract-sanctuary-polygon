...
contract TokenCooperatableDriverContract is CooperatableDriver ,ITokenOperatableTemplate,ERC165 {
    ...
    /*Template interface override but leave false empty.*/
    //function get_template_ids(uint256,uint256) external view virtual override returns (uint256[] memory){return new uint256[](0);}
...
contract Erc20InteractionDriver is Erc20CooperatableDriverContract,IERC20InteractionDriver {
    ...
    function get_driver_token_contract() external virtual override returns (address){return get_token_contract_address();}
    function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
        return
...
interface ITokenInteractionDriver {
    ...
    function get_driver_token_contract() external returns (address);
}
