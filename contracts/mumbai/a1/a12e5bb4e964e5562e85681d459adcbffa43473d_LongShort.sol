  ...
  */
  ...
  function initializePools(
    ...
    for (uint256 i = 0; i < initPools.length; i++) {
      ...
      // console2.log("initialize marketTieredLeverage - pool type", uint256(initPools[i].poolType));
      // console2.log("initialize marketTieredLeverage - pool name", initPools[i].name);
      // console2.log("initialize marketTieredLeverage - seedAmount", seedAmount);
    }
    ...
    // console2.log("initialize marketTieredLeverage - amountToLockInYieldManager",amountToLockInYieldManager);
  ...
  function getNumberOfPools(bool isLong) public returns (uint256) {
    if (isLong) {
      return numberOfPoolsOfType[uint8(PoolType.LONG)];
    } else {
      return numberOfPoolsOfType[uint8(PoolType.SHORT)];
    }
  }
  ...
  function calculateActualLiquidity() public view returns (uint256 actualLiquidity) {
    for (uint8 poolType = uint8(PoolType.SHORT); poolType <= uint8(PoolType.LONG); poolType++) {
      uint256 maxPoolIndex = numberOfPoolsOfType[poolType];
      for (uint256 poolIndex = 0; poolIndex < maxPoolIndex; poolIndex++) {
        actualLiquidity += pools[PoolType(poolType)][poolIndex].value;
      }
    }
  }
  ...
  function _rebalanceMarketPools(
    ...
    console2.log("previousPrice: ", uint256(previousPrice));
    console2.log("currentPrice: ", uint256(epochToExecute.oraclePrice));
  ...
  function _rebalanceMarketPoolsCalculatePriceAndExecuteBatches(
    ...
    console2.log("");
    console2.log(">>>>>>>>>>_rebalanceMarketPoolsCalculatePriceAndExecuteBatches>>>>>>>>>>");
    uint256[2] memory totalEffectiveLiquidityPoolType = calculateEffectiveLiquidity();
    console2.log(
      "_rebalanceMarketPoolsCalculatePriceAndExecuteBatches totalEffectiveLiquidityPoolType long",
      totalEffectiveLiquidityPoolType[1]
    );
    console2.log(
      "_rebalanceMarketPoolsCalculatePriceAndExecuteBatches totalEffectiveLiquidityPoolType short",
      totalEffectiveLiquidityPoolType[0]
    );
    console2.log(
      "_rebalanceMarketPoolsCalculatePriceAndExecuteBatches previousPrice",
      uint256(previousPrice)
    );
    console2.log(
      "_rebalanceMarketPoolsCalculatePriceAndExecuteBatches epochToExecute.oraclePrice",
      uint256(epochToExecute.oraclePrice)
    );
    console2.log(
      "_rebalanceMarketPoolsCalculatePriceAndExecuteBatches epochToExecute.associatedEpochIndex",
      uint256(epochToExecute.associatedEpochIndex)
    );
    ...
    if (valueChange < 0) {
      console2.log(
        "_rebalanceMarketPoolsCalculatePriceAndExecuteBatches valueChange [neg]",
        uint256(-valueChange)
      );
    } else {
      console2.log(
        "_rebalanceMarketPoolsCalculatePriceAndExecuteBatches valueChange",
        uint256(valueChange)
      );
    }
    ...
    for (uint8 poolType = uint8(PoolType.SHORT); poolType <= uint8(PoolType.LONG); poolType++) {
      ...
      for (uint8 poolIndex = 0; poolIndex < maxPoolIndex; poolIndex++) {
        console2.log(
          "----------_rebalanceMarketPoolsCalculatePriceAndExecuteBatches loop----------"
        );
        console2.log(
          "_rebalanceMarketPoolsCalculatePriceAndExecuteBatches loop poolIndex",
          poolIndex
        );
        console2.log(
          "_rebalanceMarketPoolsCalculatePriceAndExecuteBatches loop pooltype",
          poolType
        );
        ...
        if (valueChangeForPool < 0) {
          console2.log(
            "_rebalanceMarketPoolsCalculatePriceAndExecuteBatches valueChangeForPool [neg]",
            uint256(-valueChangeForPool)
          );
        } else {
          console2.log(
            "_rebalanceMarketPoolsCalculatePriceAndExecuteBatches valueChangeForPool",
            uint256(valueChangeForPool)
          );
        }
        console2.log(
          "_rebalanceMarketPoolsCalculatePriceAndExecuteBatches pools[PoolType(poolType)][poolIndex].value before",
          pools[PoolType(poolType)][poolIndex].value
        );
        ...
        console2.log(
          "_rebalanceMarketPoolsCalculatePriceAndExecuteBatches pools[PoolType(poolType)][poolIndex].value after",
          pools[PoolType(poolType)][poolIndex].value
        );
        ...
        console2.log(
          "_rebalanceMarketPoolsCalculatePriceAndExecuteBatches tokenSupply",
          tokenSupply
        );
        ...
        console2.log("_rebalanceMarketPoolsCalculatePriceAndExecuteBatches price", price);
        ...
        console2.log("_rebalanceMarketPoolsCalculatePriceAndExecuteBatches after batch");
      }
    }
  ...
  function _updateSystemStateInternal() internal virtual {
    ...
    if (
      ...
      console2.log("<<<<<<<<<<_updateSystemStateInternal short circuit<<<<<<<<<<\n");
    ...
    console2.log(
      "_updateSystemStateInternal before loop numberOfEpochsToExecute",
    ...
    for (
      ...
      console2.log(
        "----------_updateSystemStateInternal inside loop epochToExecuteIndex",
        epochToExecuteIndex
      );
      ...
      console2.log("_updateSystemStateInternal done everything before setting price");
      previousPrice = epochToExecute.oraclePrice;
      console2.log("_updateSystemStateInternal done everything after setting price");
      console2.log(
        "_updateSystemStateInternal inside for loop end- epochToExecuteIndex",
        epochToExecuteIndex
      );
    }

    console2.log(
      "_updateSystemStateInternal after loop currentEpochStartTimestamp",
      currentEpochStartTimestamp
    );
    console2.log(
      "_updateSystemStateInternal after loop previousEpochEndTimestamp",
      epochInfo.previousEpochEndTimestamp
    );
    console2.log(
      "_updateSystemStateInternal after loop diff",
      currentEpochStartTimestamp - epochInfo.previousEpochEndTimestamp
    );

    console2.log("_updateSystemStateInternal inside if");
    ...
    console2.log(
      "_updateSystemStateInternal inside if latestExecutedEpochIndex",
      epochInfo.latestExecutedEpochIndex
    );
    console2.log(
      "_updateSystemStateInternal inside if getCurrentEpochIndex()",
      oracleManager.getCurrentEpochIndex()
    );
    console2.log(
      "_updateSystemStateInternal inside if previousEpochIndex",
      epochInfo.previousEpochIndex
    );
    console2.log(
      "================================================================================="
    );
    ...
    console2.log("<<<<<<<<<<_updateSystemStateInternal<<<<<<<<<<\n");
  }
  ...
  function _mint(
    ...
    console2.log("_mint after transfer currentEpoch", currentEpoch);
    ...
    if (
      ...
      console2.log("_mint first if branch (in mewt) amount", amount);
      pools[poolType][pool].nextEpoch_batched_amountPaymentToken_deposit += amount;
    } else {
      console2.log("_mint first if branch (not in mewt) amount", amount);
      user_paymentToken_depositAction[user][poolType][pool].amount += amount;
  ...
  function _redeem(
    ...
    uint32 currentEpoch = epochInfo.previousEpochIndex + 1;
    console2.log("_redeem after transfer currentEpoch", currentEpoch);
    ...
    if (
      ...
      console2.log("_redeem first if branch (in mewt) amount", amount);
      pools[poolType][pool].nextEpoch_batched_amountSyntheticToken_redeem += amount;
    } else {
      console2.log("_redeem first if branch (not in mewt) amount", amount);
      user_syntheticToken_redeemAction[user][poolType][pool].amount += amount;
  ...
  function _executePoolOutstandingUserMints(
    ...
    console2.log("\n>>>>>>>>>>_executePoolOutstandingUserMints>>>>>>>>>>");
    ...
    if (
      ...
      console2.log(
        "_executePoolOutstandingUserMints currentUserAction.correspondingEpoch",
        currentUserAction.correspondingEpoch
      );
      console2.log("_executePoolOutstandingUserMints syntheticToken_price", syntheticToken_price);
      console2.log(
        "_executePoolOutstandingUserMints currentUserAction.amount",
      ...
      console2.log(
        "_executePoolOutstandingUserMints before transfer amountSyntheticTokenToMint",
        amountSyntheticTokenToMint
      );

      ISyntheticToken(syntheticToken).transfer(user, amountSyntheticTokenToMint);

      console2.log("_executePoolOutstandingUserMints after transfer");
      ...
      if (currentUserAction.nextEpochAmount > 0) {
        ...
        if (secondaryOrderEpoch <= epochInfo.latestExecutedEpochIndex) {
          // then also execute
          syntheticToken_price = syntheticToken_priceSnapshot[secondaryOrderEpoch][poolType][pool];
    ...
    console2.log("<<<<<<<<<<_executePoolOutstandingUserMints<<<<<<<<<<\n");
  }
  ...
  function _executePoolOutstandingUserRedeems(
    ...
    console2.log("\n>>>>>>>>>>_executePoolOutstandingUserRedeems>>>>>>>>>>");
    ...
    if (
      ...
      console2.log(
        "_executePoolOutstandingUserRedeems currentUserAction.correspondingEpoch",
        currentUserAction.correspondingEpoch
      );
      console2.log("_executePoolOutstandingUserRedeems syntheticToken_price", syntheticToken_price);
      console2.log(
        "_executePoolOutstandingUserRedeems currentUserAction.amount",
        uint256(currentUserAction.amount)
      );
      console2.log(
        "_executePoolOutstandingUserRedeems before transfer amountPaymentTokenToSend",
        amountPaymentTokenToSend
      );

      IYieldManager(yieldManager).transferPaymentTokensToUser(user, amountPaymentTokenToSend);

      console2.log("_executePoolOutstandingUserRedeems after transfer");
    ...
    console2.log("<<<<<<<<<<_executePoolOutstandingUserRedeems<<<<<<<<<<\n");
  }
  ...
  function _handleTotalPaymentTokenValueChangeForMarketWithYieldManager(
    ...
    if (totalPaymentTokenValueChangeForMarket > 0) {
      ...
      console2.log(
        "_handleTotalPaymentTokenValueChangeForMarketWithYieldManager first if totalPaymentTokenValueChangeForMarket",
        uint256(totalPaymentTokenValueChangeForMarket)
      );
    } else if (totalPaymentTokenValueChangeForMarket < 0) {
      // NB there will be issues here if not enough liquidity exists to withdraw
  ...
  function _batchConfirmOutstandingPendingActionsPool(
    ...
    console2.log("");
    console2.log(">>>>>>>>>>_batchConfirmOutstandingPendingActionsPool>>>>>>>>>>");
    ...
    console2.log(
      "_batchConfirmOutstandingPendingActionsPool batched_amountPaymentToken_deposit",
      pool.batched_amountPaymentToken_deposit
    );
    console2.log(
      "_batchConfirmOutstandingPendingActionsPool nextEpoch_batched_amountPaymentToken_deposit",
      pool.nextEpoch_batched_amountPaymentToken_deposit
    );
    console2.log("_batchConfirmOutstandingPendingActionsPool synth price", price);
    console2.log(
      "_batchConfirmOutstandingPendingActionsPool currentEpochIndex",
      oracleManager.getCurrentEpochIndex()
    );
    console2.log(
      "_batchConfirmOutstandingPendingActionsPool latestExecutedEpochIndex",
      epochInfo.latestExecutedEpochIndex
    );
    console2.log(
      "_batchConfirmOutstandingPendingActionsPool (getCurrentEpochIndex() >= latestExecutedEpochIndex + 3)",
      (oracleManager.getCurrentEpochIndex() >= epochInfo.latestExecutedEpochIndex + 3)
    );
    console2.log(
      "_batchConfirmOutstandingPendingActionsPool (oracleManager.getCurrentEpochIndex() == epochInfo.latestExecutedEpochIndex + 2 && not in MEWT)",
    ...
    if (
      ...
      console2.log("_batchConfirmOutstandingPendingActionsPool inside if");
      if (
        pool.nextEpoch_batched_amountPaymentToken_deposit > 0 &&
        pool.batched_amountPaymentToken_deposit == 0
      ) {
        console2.log("_batchConfirmOutstandingPendingActionsPool inside if inside if");
        ...
        pool.batched_amountPaymentToken_deposit = pool.nextEpoch_batched_amountPaymentToken_deposit;
        pool.nextEpoch_batched_amountPaymentToken_deposit = 0;
        syntheticToken_priceSnapshot[associatedEpochIndex][PoolType(poolType)][poolIndex] = price;

        if (changeInMarketValue_inPaymentToken >= 0) {
          console2.log(
            "_batchConfirmOutstandingPendingActionsPool inside if inside else changeInMarketValue_inPaymentToken",
            uint256(changeInMarketValue_inPaymentToken)
          );
        }
        if (changeInSupply_syntheticToken >= 0) {
          console2.log(
            "_batchConfirmOutstandingPendingActionsPool inside if inside else changeInSupply_syntheticToken",
            uint256(changeInSupply_syntheticToken)
          );
        }
      }
    }
    ...
    if (
      ...
      console2.log("_batchConfirmOutstandingPendingActionsPool redeem inside if");
      if (
        pool.nextEpoch_batched_amountSyntheticToken_redeem > 0 &&
        pool.batched_amountSyntheticToken_redeem == 0
      ) {
        console2.log("_batchConfirmOutstandingPendingActionsPool redeem inside if inside if");
        ...
        if (changeInMarketValue_inPaymentToken >= 0) {
          console2.log(
            "_batchConfirmOutstandingPendingActionsPool redeem inside if inside else changeInMarketValue_inPaymentToken",
            uint256(changeInMarketValue_inPaymentToken)
          );
        } else {
            console2.log(
                         "_batchConfirmOutstandingPendingActionsPool redeem inside if inside else changeInMarketValue_inPaymentToken [neg]",
                         uint256(-changeInMarketValue_inPaymentToken)
                         );
        }
        if (changeInSupply_syntheticToken >= 0) {
          console2.log(
            "_batchConfirmOutstandingPendingActionsPool redeem inside if inside else changeInSupply_syntheticToken",
            uint256(changeInSupply_syntheticToken)
          );
        } else {
            console2.log(
                         "_batchConfirmOutstandingPendingActionsPool redeem inside if inside else changeInSupply_syntheticToken [neg]",
                         uint256(-changeInSupply_syntheticToken)
                         );
        }
      }
    ...
    if (changeInSupply_syntheticToken < 0) {
      console2.log(
        "_batchConfirmOutstandingPendingActionsPool changeInSupply_syntheticToken [neg]",
        uint256(-changeInSupply_syntheticToken)
      );
    } else {
      console2.log(
        "_batchConfirmOutstandingPendingActionsPool changeInSupply_syntheticToken",
        uint256(changeInSupply_syntheticToken)
      );
    }
...
contract OracleManagerFixedEpoch {
  ...
  function inMewt() public returns (bool) {
  ...
  function getMissedEpochPriceUpdates(
    ...
    while (_missedEpochExecution._isSearchingForMissedEpochExecutionInfo && latestRoundId >= _missedEpochExecution._currentOracleIndex) {
  ...
  */
  function _beforeTokenTransfer(
    ...
    if (sender != market && sender != address(0)) {
      ...
      MarketTieredLeverage(market).executeOutstandingNextPriceSettlementsUser(sender);
    }
