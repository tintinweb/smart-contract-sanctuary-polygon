...
// File contracts/ABCPunks.sol

pragma solidity ^0.8.0;

contract ABCPunks is ERC721Enumerable, Ownable {
  ...
  constructor() ERC721("ABC Punks", "PUNKS") {}
  ...
  function mintNFTs(uint256 _count) public payable {
    ...
    require(msg.value >= PRICE.mul(_count), "Need more ABC");
