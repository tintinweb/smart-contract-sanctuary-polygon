...
contract CheckExecutor is Executor, SecuredTokenTransfer, Ownable {
    ...
    function checkTokenBalance(bytes memory checkMsg) public pure returns (uint256 amount) {
    ...
    function getReceviedAmount() public view  returns (uint256){
