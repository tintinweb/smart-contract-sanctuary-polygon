...
*/
        ...
        contract LaunchifiOnPolygon is ERC721A, Ownable, ReentrancyGuard{
            ...
            constructor(uint256 _price, uint256 __maxSupply, string memory _initBaseURI, uint256 _maxMintAmountPerTx, uint256 _maxMintAmountPerWallet) ERC721A("Launchifi on Polygon", "LOP") {
