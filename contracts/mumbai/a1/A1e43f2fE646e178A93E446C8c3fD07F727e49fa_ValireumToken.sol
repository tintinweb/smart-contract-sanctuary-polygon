...
contract ValireumToken is ERC20, ERC20Burnable {
    ...
    uint256 public preSalePrice = 0.00000002 ether; // PreSale Price -- Limited to the first 100 participant
    uint256 public pubSalePrice = 0.00000003 ether; // Public Sale Price --
    ...
    uint256 _paymentMatches = 3; // How many match payment required for the seeders to get paid
    uint256 _maxPayment = 4;
    uint256 oldSeedCount = 197;
    ...
    function getSaleInfo () public view returns (uint256 price, bool saleLive, string memory activeStage, uint256 available, uint256 SaleProgress){
        ...
        uint256 preSaleCount = _seederIds.current() - oldSeedCount; // 197 is the number of old VLM contract holders we added in the constructor.
