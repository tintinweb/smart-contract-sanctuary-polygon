...
contract PlushVestingSeedInvestorsPool is IPlushVestingSeedInvestorsPool, Initializable, PausableUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    /**
     * @notice Reserve of a slot by USDT
     */
    ...
    /**
     * @notice Reserve of a slot by USDC
     */
    ...
    /**
     * @notice Complete purchase of a slot by USDT
     */
    ...
    /**
     * @notice Complete purchase of a slot by USDC
     */
    ...
    /**
     * @notice Cancel reserve slot manually
     */
    ...
    /**
     * @notice Sell slot manually
     * @param wallet address of the user to which we sell this slot
     */
    ...
    /**
     * @notice Reserve slot manually
     * @param wallet address of the user to which we reserve this slot
     */
    ...
    /**
     * @notice Returns whether the slot was sold
     * @return bool slot was sold
     */
    ...
    /**
     * @notice Returns whether the slot was reserved
     * @return bool slot was reserved
     */
...
interface IPlushVestingSeedInvestorsPool {
    ...
    * @notice Returns how many tokens are unlock
    ...
    /// @notice Emitted when user reserve slot by USDT
    event ReserveByUSDT(
        address indexed receiver,
        uint256 amount
    );

    /// @notice Emitted when user reserve slot by USDC
    event ReserveByUSDC(
        address indexed receiver,
        uint256 amount
    );

    /// @notice Emitted when user sell slot by USDT
    event SellByUSDT(
        address indexed receiver,
        uint256 amount
    );

    /// @notice Emitted when user sell slot by USDC
    event SellByUSDC(
        address indexed receiver,
        uint256 amount
    );

    /// @notice Emitted when user sell slot
    event SellManually(
        address indexed receiver,
        uint256 amount
    );
