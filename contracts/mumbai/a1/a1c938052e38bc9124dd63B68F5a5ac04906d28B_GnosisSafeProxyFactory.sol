...
import "contracts/Core/interfaces/IWhitelisting.sol";
import "contracts/Core/interfaces/IAdmin.sol";
import "@openzeppelin/contracts/proxy/utils/Initializable.sol";

/// @title Proxy Factory - Allows to create new proxy contact and execute a message call to the new proxy within one transaction.
/// @author Stefan George - <[email protected]>
contract GnosisSafeProxyFactory is BasicMetaTransaction {
    event ProxyCreation(GnosisSafeProxy proxy, address singleton);
    event FundCreation(GnosisSafeProxy proxy, address singleton, string fundID);
    ...
    {
        require(whitelisting.isKYCDone(_msgSender()), "Not KYC");
