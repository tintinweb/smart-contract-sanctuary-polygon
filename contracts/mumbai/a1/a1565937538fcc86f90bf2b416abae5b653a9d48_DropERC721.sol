    ...
    IDropERC721
{
    ...
    /// @dev Max bps in the RS system.
    uint256 private constant MAX_BPS = 10_000;

    /// @dev The RS contract with fee related information.
    IRSFee private immutable rswebFee;
    ...
    constructor(address _rswebFee) initializer {
        rswebFee = IRSFee(_rswebFee);
    }
    ...
    function collectClaimPrice(
        ...
        (address rsFeeRecipient, uint256 rsFeeBps) = rswebFee.getFeeInfo(address(this), FeeType.PRIMARY_SALE);
