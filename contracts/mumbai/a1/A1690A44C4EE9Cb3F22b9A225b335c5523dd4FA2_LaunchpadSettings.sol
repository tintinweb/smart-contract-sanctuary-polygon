...
contract LaunchpadSettings is ILaunchpadSettings, Ownable {
    ...
    struct Settings {
        ...
        uint256 creationFee; // absolute fee in GLMR used by generator on launchpad creation
    ...
    constructor() public {
        ...
        settings.creationFee = 5e17; // 0.5 GLMR
     ...
     * @param _creationFee absolute fee in GLMR charged on launchpad creation
