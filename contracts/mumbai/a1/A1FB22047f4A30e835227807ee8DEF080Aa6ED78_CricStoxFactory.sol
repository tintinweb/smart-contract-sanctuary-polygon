...
contract CricStoxFactory is Ownable {
    ...
    /**
        ...
        * @param buyToken_ The address of token to buy pool tokens.
        * @param pools_ The array of addresses of pools.
        * @param poolShares_ The array of shares for every pool.
        */
    function createPlayerStox(string memory name_, string memory symbol_, uint8 decimals_, address buyToken_, address[] memory pools_, uint256[] memory poolShares_) external onlyOwner {
        ...
        bool success = ICricStoxMaster(cricStoxMasterAddress).buyExactStoxForTokens(address(playerStox), buyToken_, amount, totalShares);
