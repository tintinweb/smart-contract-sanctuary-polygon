    ...
    Royalties
{
    ...
    function updateRoyalties(uint256 tokenId, LibPart.Part[] memory royalties)
        public
        virtual
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
    ...
    function updateRoyaltiesForAll(LibPart.Part[] memory royalties)
        public
        virtual
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
...
// const ERC721ClaimableV2 = await ethers.getContractFactory('ERC721ClaimableV2');
// const erc721ClaimableV2 = await ERC721ClaimableV2.deploy('ME Test', 'MET', '0x9399BB24DBB5C4b782C70c2969F58716Ebbd6a3b', '0x58807baD0B376efc12F5AD86aAc70E78ed67deaE', '0x69aFB95996970D07eFBCb46Bdc16223fac18FB84', 'ipfs://QmccoRwdqeZqg5zLr1gPDAaS2JDX5x4df6NPp2d1qCC526', [["0x69aFB95996970D07eFBCb46Bdc16223fac18FB84", "1000"]], 5);
