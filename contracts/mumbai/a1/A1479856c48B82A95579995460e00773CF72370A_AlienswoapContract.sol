...
abstract contract Feeable is Teams {
  uint256 public PRICE = 331 ether;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 18, 8989) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmVuuPxqhhLfYFhGq9WVkDc3zzb9rWNp9ux6xrcoMUJZCq/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 8989");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 8989");
    ...
    function mintToMultipleERC20(address _to, uint256 _amount, address _erc20TokenContract) public payable {
      require(_amount >= 1, "Must mint at least 1 token");
      require(_amount <= maxBatchSize, "Cannot mint more than max mint per transaction");
      require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 8989");
      require(mintingOpen == true, "Minting is not open right now!");
...
// File: contracts/AlienswoapContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AlienswoapContract is RamppERC721A {
    constructor() RamppERC721A("alienswoap", "aw"){}
}
