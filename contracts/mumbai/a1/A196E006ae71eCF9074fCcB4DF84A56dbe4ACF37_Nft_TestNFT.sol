...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
	...
	function _baseURI() internal view virtual returns (string memory) {
		return "https://ipfs.infura.io/ipfs/QmRDaVQh9oPG3Qq3SFRyTb9ZCbHrzAAJc9dGjdx9PhhUWM/";
	}
...
contract Nft_TestNFT is ERC721Enumerable {
 ...
 * checks that ((totalSupply) + (_amt)) is less than or equals to 14
...
*/
	function mint(uint256 _amt) public payable {
		...
		require(((totalSupply() + _amt) <= uint256(14)), "Exceeded Total Supply");
		require(((balanceOf(msg.sender) + _amt) <= uint256(7)), "Exceeded Individual Supply Constraints");
		require((msg.value == (_amt * uint256(50000000000000000))), "Wrong Fee");
 ...
 * if reveal then (returns super.tokenURI with variable _tokenId as tokenId as output) otherwise (returns "https://ipfs.infura.io/ipfs/QmbLf1hcBDm69vVJR69qNJwxXdY2ST9eA9vakRxsb9HzQh" as output)
...
*/
	function tokenURI(uint256 tokenId) public view override returns (string memory) {
		...
		if (reveal){
			...
			return "https://ipfs.infura.io/ipfs/QmbLf1hcBDm69vVJR69qNJwxXdY2ST9eA9vakRxsb9HzQh";
		}
	}
}