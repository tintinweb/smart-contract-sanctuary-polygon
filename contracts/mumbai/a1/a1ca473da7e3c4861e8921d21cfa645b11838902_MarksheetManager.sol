...
contract MarksheetManager is Ownable {
    ...
    function uploadMarksheet(string[] memory _rollNumbers, string[] memory _marksheetLink, string memory _class) public onlyTeacher
    {
    ...
    function getMarksheet(string memory _class, string memory _rollNumber) public payable {
        require(msg.value == 1 ether, "MarksheetManager: Less amount sent");
