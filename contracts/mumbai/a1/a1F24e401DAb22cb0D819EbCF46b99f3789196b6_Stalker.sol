...
//TODO Change
contract Stalker is Ownable, ERC721, ERC2981, Treasury {
  ...
  //TODO change name
  uint256 public immutable Stalker_SUPPLY;
  ...
  //TODO change name
  uint256 _Stalker_SUPPLY
  )
    //TODO change name
    ERC721("Stalker", "STALK")
    ...
    //Sets the max supply
    //TODO Change name
    Stalker_SUPPLY = _Stalker_SUPPLY;
  ...
  /// @dev Whitelist signing is performed off chain, via the Stalker website backend
  ...
  function buyPresale(
    ...
    require((totalSupply + numberOfTokens) <= Stalker_SUPPLY, "Total Supply limit reached");
  ...
  function buyPublic(uint256 numberOfTokens) external payable {
    ...
    require(numberOfTokens > 0, "Should mint atleast 1 NFT");
    require(totalSupply + numberOfTokens <= Stalker_SUPPLY, "Total supply maxed out");
  ...
  function totalLeftToMint() view external returns(uint256){
    return Stalker_SUPPLY - totalSupply;
  }
  ...
  */
    ...
    onlyOwner
  {
    ...
    require(supplyLimit <= Stalker_SUPPLY, "Invalid supply limit");
  ...
  function rollStartIndex() external onlyOwner {
    ...
    randomizedStartIndex = (number % Stalker_SUPPLY) + 1;
  ...
  */
  ...
  Fetches the token URI of token id = tokenId. It will return base URI.
  */
