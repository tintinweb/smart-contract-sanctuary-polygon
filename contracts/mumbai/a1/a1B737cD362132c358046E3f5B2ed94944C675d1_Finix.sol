...
contract Finix {
    ...
    uint256 private constant lotteryDuration = 5 minutes;
    ...
    function Lottery(uint256 _guess) public {
        ...
        allLotteryRecord[curLotteryDay][_guess].push(msg.sender);
    ...
    function distributeLotteryPool() public {
        ...
        uint256 _lastDay = curLotteryDay;
        ...
        lotteryLastDistributed = block.timestamp;
        curLotteryDay = curLotteryDay.add(1);
    }
