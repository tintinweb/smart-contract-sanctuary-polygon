...
library PancakeLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'ce97d9ae4f6df89426146451a3131681d4047da355ac99602fda30d1f927ba7f' // init code hash
            ))));
    }
...
// ["0x5434576d30896E96CD8EBd13626918B60C11050a", "0x00fF437b6e43EE7B1be0C9CFB2273E2605150d68"]