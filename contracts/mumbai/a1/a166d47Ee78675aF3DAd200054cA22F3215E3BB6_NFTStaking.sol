...
// File: https://github.com/AndrewKellyDev/sharklabs-contracts/SharkTeethToken.sol
...
contract NFTStaking is Ownable, IERC721Receiver {
  ...
  SharkTeethToken token;

  // maps tokenId to stake
  mapping(uint256 => Stake) public vault; 

   constructor(ERC721Enumerable _nft, SharkTeethToken _token) { 
    nft = _nft;
    token = _token;
  }
