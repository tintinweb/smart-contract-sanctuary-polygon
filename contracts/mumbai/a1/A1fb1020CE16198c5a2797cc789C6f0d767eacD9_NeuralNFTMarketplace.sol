...
contract NeuralNFTMarketplace is ReentrancyGuard {
    ...
    event ApprovedNftAddress(address indexed owner, address indexed nftAddress, string abiHash);
     ...
     * @param nftAddress The address of the contract of the NFT
     */
    function approveNftAddress(address nftAddress, string memory abiHash) public {
        ...
        emit ApprovedNftAddress(msg.sender, nftAddress, abiHash);
    }
