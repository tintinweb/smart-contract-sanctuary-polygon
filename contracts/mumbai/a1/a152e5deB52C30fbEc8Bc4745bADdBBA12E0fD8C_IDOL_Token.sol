...
contract IDOL_Token {
    ...
    mapping(uint256 => mapping(address => bool)) private alreadyTranferred;
        ...
        returns (uint256)
    {
     ...
     function PublicBuy(address _buyer, uint256 numOfTokens, bool _NeedStack )
        ...
        returns (uint256){
            ...
            emit EForthroundTranfer(Id2, msg.sender, _buyer, numOfTokens,block.timestamp,0);
        ...
        returns (bool)
    {
        ...
        require(alreadyTranferred[_txIndex][_user]==false,"already Tranferred");
            IDOLToWallet = (numberOfTokens[_txIndex][_user]+((numberOfTokens[_txIndex][_user]*FirstRBonusAmount)));
            
        balances[_user] += IDOLToWallet;
        alreadyTranferred[_txIndex][_user]=true;
        ...
        returns (bool)
    {
        ...
        require(calcuationofTotal >=1, "Transfer to liquidty Pool First" );
        require(alreadyTranferred[_txIndex][_user]==false,"already Tranferred");
            IDOLToWallet = (numberOfTokens[_txIndex][_user]+((numberOfTokens[_txIndex][_user]*SecondRBonusAmount)));
        balances[_user] += IDOLToWallet;
        alreadyTranferred[_txIndex][_user]=true;
        ...
        returns (bool)
    {
        ...
        require(calcuationofTotal >=1, "Transfer to liquidty Pool First" );
        require(alreadyTranferred[_txIndex][_user]==false,"already Tranferred");
            IDOLToWallet = (numberOfTokens[_txIndex][_user]+((numberOfTokens[_txIndex][_user]*ThirdRBonusAmount)));
        balances[_user] += IDOLToWallet;
        alreadyTranferred[_txIndex][_user]=true;
        ...
        
    {
        ...
        require(calcuationofTotal >=1, "Transfer to liquidty Pool First" );
        require(alreadyTranferred[_txIndex][_user],"already Tranferred");
            IDOLToWallet = (numberOfTokens[_txIndex][_user]+((numberOfTokens[_txIndex][_user]*ForthRBonusAmount)));
        balances[_user] += IDOLToWallet;
        alreadyTranferred[_txIndex][_user]=true;
