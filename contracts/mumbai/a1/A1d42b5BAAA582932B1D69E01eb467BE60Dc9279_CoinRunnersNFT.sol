...
contract CoinRunnersNFT is ERC721Enumerable, Ownable {
    ...
    IERC20 public paymentToken = IERC20(0x869eAe08017f621f8bd32C973660Aa5fc4d204BF);
    
    string private _contractURI;
    string private _tokenBaseURI = "https://coinrunners-api.onrender.com/api/metadata/";
    ...
    function buy(uint qty) external {
        ...
        paymentToken.transferFrom(msg.sender, address(this), qty * COINRUNNERS_MINT_PRICE);
    }
    ...
    function withdraw() external onlyOwner {
        paymentToken.transfer(_splitter, paymentToken.balanceOf(address(this)));
    }
