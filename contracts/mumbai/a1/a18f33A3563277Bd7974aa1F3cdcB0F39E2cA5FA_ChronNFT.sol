...
// File: contracts/Library/vouchers.sol
    ...
    EIP712Upgradeable
{
    ...
    // event globalOf(uint256 _tokenId, uint256 _offerNo, uint256 _offeredPrice);
    // event singleOf(
    //     uint256 _offerNo,
    //     uint256 _tokenId,
    //     address _account,
    ...
    //     require(tokenDet[_tokenId].supply > 0, "IT"); //Invalid Token
    //     require(
    //         _offeredPrice >
    //             (tokenDet[_tokenId].price * tokenDet[_tokenId].supply),
    //         "PL"
    //     ); //Price too low
    //     IERC20(usdc).transferFrom(msg.sender, address(this), _offeredPrice);
    ...
    //     ] = _offeredPrice;
    //     emit globalOf(_tokenId, offered._globalOfferNo, _offeredPrice);
    // }
    ...
    // ) external {
    //     require(tokenDet[_tokenId].supply > 0, "IT"); //Invalid Token
    //     require(_offeredPrice > tokenDet[_tokenId].price * _quantity, "PL"); //Price too low
    //     IERC20(usdc).transferFrom(msg.sender, address(this), _offeredPrice);
    //     offer storage offered = Offers[_tokenId][msg.sender];
    ...
    //     require(tokenDet[_tokenId].supply > 0, "IT"); //Invalid Token
    //     require(
    //         Offers[_tokenId][msg.sender].globalOffers[_globalOfferNo] != 0,
    //         "IO"
    //     ); //Invalid Offer No.
    //     require(
    //         _newOfferedPrice >
    //             Offers[_tokenId][msg.sender].globalOffers[_globalOfferNo],
    //         "IOP"
    //     ); //Inavlid Offer Price
    //     uint256 priceDifference = _newOfferedPrice -
    //         (Offers[_tokenId][msg.sender].globalOffers[_globalOfferNo]);
    //     IERC20(usdc).transferFrom(msg.sender, address(this), priceDifference);
    //     Offers[_tokenId][msg.sender].globalOffers[
    //         _globalOfferNo
    //     ] += priceDifference;
    // }

    // function upgradeSingleOffer(
    //     uint256 _tokenId,
    ...
    //     if (_isGlobal) {
    //         require(
    //             Offers[_tokenId][msg.sender].globalOffers[_OfferNo] != 0,
    //             "IO"
    //         ); //Invalid Offer No.
    //         require(
    //             Offers[_tokenId][msg.sender].globalOffers[_OfferNo] > 0,
    //             "AR"
    //         ); //Already Refunded
    //         uint256 paidPrice = Offers[_tokenId][msg.sender].globalOffers[
    //             _OfferNo
    //         ];
    //         uint256 acquiredSharesprice = balanceOf(msg.sender, _tokenId) *
    //             (paidPrice / tokenDet[_tokenId].supply);
    ...
    //             "AR"
    //         ); //Already Refunded
    //         uint256 refundPrice = Offers[_tokenId][msg.sender]
    //             .singleOffers[_OfferNo]
    //             .offeredAmount;
    //         Offers[_tokenId][msg.sender]
    //             .singleOffers[_OfferNo]
        ...
        return
            _hashTypedDataV4(
                keccak256(
                    abi.encode(
                        keccak256(
                            "offerDetails(address offerer, uint256 tokenId, uint256 offeredPrice, uint256 quantityAsked, uint256 offeree)"
                        ),
    ...
    // function makeOffer(voucher.offer memory offerDetails, bool _isGlobal) external {
    //     if(_isGlobal)
    //     IERC20(usdc).transferFrom(msg.sender, address(this), offerDetails.offeredPrice);
    // }
    // else{
        ...
        external
    {
        ...
        //  else {
        //     require(
        //         offerDetails.offerer != verifyOfferDetails(offerDetails),
        //         "IO"
        //     ); //Invalid Offerer
        //     uint256 price = offerDetails.offeredPrice;
        //     uint256 transferAmount = offerDetails.quantityAsked;
        //     IERC20(usdc).transferFrom(
        //         offerDetails.offerer,
        //         offerDetails.offeree,
        //         price
    ...
    function setRoyalty(uint96 _royalty) external onlyOperator {
        royaltyAmount = _royalty;
        emit voucher.royalty(royaltyAmount);
    }

    function setAdmin(address _newAdmin) external onlyOperator {
        require(_newAdmin != address(0), "ZA"); //Zero Address
        admin = _newAdmin;
    }

    function addOperator(address _account, bool _status) external onlyOperator {
        require(_account != address(0), "ZA"); //Zero Addresss
        operators[_account] = _status;
    }

    // function viewGlobalOffer(uint256 _tokenId, uint256 _globalOfferNo)
    //     public
    //     view
    //     returns (uint256 _offeredPrice)
    // {
    //     _offeredPrice = Offers[_tokenId][msg.sender].globalOffers[
    //         _globalOfferNo
    //     ];
    //     return _offeredPrice;
    // }

    // function viewSingleOffer(uint256 _tokenId, uint256 _singleOfferNo)
    //     public
    //     view
    //     returns (singleOffer memory offerDetails)
    // {
    //     offerDetails = Offers[_tokenId][msg.sender].singleOffers[
    //         _singleOfferNo
    //     ];
    //     return offerDetails;
    // }
