...
contract Draft is ERC721, ERC2981, Pausable, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721("MyToken", "MTK") {
    ...
    setMintStatus("ALLOWLIST", 0.0077 ether, 2);
    setMintStatus("PREMIUM_ALLOWLIST", 0.0088 ether, 2);
    setMintStatus("PUBLIC", 0.01 ether, 10);

    setActiveMintStatus("ALLOWLIST");
  }
  ...
  function mint(
    ...
    require(
      isSignatureValid(_signer, keccak256(abi.encodePacked(msg.sender, activeMintStatus, _nonce)), _signature),
      "Not allowed"
    );
    require(msg.value >= price(), "Not enough eth");

    nonceUsed[_nonce] = true;
    _addMintedByAddress(activeMintStatus, _msgSender(), _amount);
