...
contract onChainTest is ERC721A, ReentrancyGuard, Ownable, DefaultOperatorFilterer, OnChainMetadata {
    ...
    uint256 linksEverCount;
 
 
    function setPromoURI(string memory promoURL, uint256 tokenId, uint256 otherId) external payable {
        require(((ownerOf(tokenId) == msg.sender) && (msg.value >= 0.001 ether ) ) || ((tokenLevel[otherId]>tokenLevel[tokenId]) && (msg.value >= (0.001 ether * (tokenLevel[tokenId] +1) ) ) ));
    ...
    function setColor(uint256 tokenId,uint256 hue,uint256 sat,uint256 lum) external payable {
        require(ownerOf(tokenId) == msg.sender && msg.value >= 0.001 ether );
        // require(hue < 361);
        // require(sat < 101);
        // require(lum < 101);
    ...
    constructor() ERC721A("on Chain Test", "onchain") {
  ...
  function tokenURI(uint256 id) public view override returns (string memory) {
    ...
    function _buildTokenURI(uint256 id) internal view returns (string memory) {
        require(_exists(id), "tokenId doesn't exist");
        ...
        bytes memory image = abi.encodePacked(
            ...
            Base64.encode(
                bytes(
                    abi.encodePacked(
                        '<?xml version="1.0" encoding="UTF-8"?><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 400 400" preserveAspectRatio="xMidYMid meet"><style type="text/css"><![CDATA[text { font-family: monospace; font-size: 21px;} .st0{fill-rule:evenodd;clip-rule:evenodd;} .h1 {font-size: 40px; font-weight: 600;}]]></style><text class="h1" x="50" y="250" >Smart Contract</text><text class="h1" x="50" y="275" >Monkey</text><text x="0" y="300"> Owner Promoted Link</text><text x="0" y="325"><a href="',
                        promotionURLs[id],
                        '">',
                        promotionURLs[id],
                        '</a></text><g fill="hsl(',
            ...
            string(
                abi.encodePacked(
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                '{"name":"on chain nft", "image":"',
                                image,
                                unicode'", "description": "testing on chain metadata",',
                                '"attributes": [{"trait_type": "Metadata","value": "OnChain"},{"trait_type": "Power","value": "colorSwap"},{"trait_type": "Token Level","value":',
