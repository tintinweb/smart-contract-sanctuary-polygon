...
contract Alligators is
    ...
    */
    ...
    function anatomy(
        uint256 _tokenId
    ) internal view returns (uint8[7] memory _traits) {
    ...
    function tokenType(
        uint256 _tokenId
    ) internal view returns (uint8 _type) {
    ...
    function joker_level(
        uint256 _tokenId
    ) internal view returns (uint8 _level) {
...
contract MergeGators is Ownable, VRFConsumerBaseV2, IMergeGators {
    ...
    address private alligatorsAddr;
    ...
    function merge3NFTs(uint256 _1st, uint256 _2nd, uint256 _3rd) public payable {
        ...
        (bool success, ) = address(alligators).call(mergeParams);

        require(success == true, "LowCallsFailed");
...
contract MergeGatorsMock is MergeGators {
    ...
    address payable collection_ = payable(0x9F58E1d1A78befD3521b7dDf2923d56628E1E303);
