...
contract VinoxGatingPass is ERC721ABase, UUPSUpgradeable, ERC2981, GatingStorage {
    ...
    function supportsInterface(bytes4 interfaceId) public view override(ERC721ABase, ERC2981) returns (bool) {
        return ERC721ABase.supportsInterface(interfaceId) || ERC2981.supportsInterface(interfaceId);
    }
}
...
abstract contract ERC721ABase is Initializable, ERC721AQueryableUpgradeable, FixinAccessControlUpgradeable, ReentrancyGuardUpgradeable {
    //baseURI for the token metadata
