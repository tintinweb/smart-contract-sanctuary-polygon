...
contract CrypTotoro is ERC721A, Ownable {
    using Strings for uint256;

    uint256 public MAX_SUPPLY = 3000;
    uint256 public MAX_MINT = 20;
    uint256 public SALE_PRICE = 0.0009 ether;
    bool public mintStarted = false;

    string public baseURI = "ipfs://QmV2cJr3FqW1AuyM2Jh6UaFcHtKwPNTLoVwveUELaetEDF/";
    mapping(address => uint256) public mintPerWallet;

    constructor() ERC721A("CrypTotoro", "TOTORO") {}
