...
contract BasicVault is Ownable, AccessControlEnumerable {
    IERC20 private token;
    uint256 public maxWithdrawAmount;
    bool public withdrawEnabled;
    bytes32 public constant WITHDRAWER_ROLE = keccak256('WITHDRAWER_ROLE');

    function setWithdrawEnabled(bool _isEnabled) public onlyOwner {
        withdrawEnabled = _isEnabled;
    }
    ...
    modifier onlyWithdrawer() {
        require(owner() == _msgSender()||hasRole(WITHDRAWER_ROLE, _msgSender()), "Caller is not a withdrawer role.");
        _;
    }
}
