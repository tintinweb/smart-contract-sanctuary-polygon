...
contract HCC is Context, ERC165, Ownable, IERC721Metadata {
    ...
    uint public constant MAX_TOKENS_SUPPLY = 110;

    string private constant NAME = 'Hadem Creators Community';

    string private constant SYMBOL = 'HCC NFT';
    ...
    */
    ...
    /**
     * @dev Function mints one NFT and sends to the address
     *
