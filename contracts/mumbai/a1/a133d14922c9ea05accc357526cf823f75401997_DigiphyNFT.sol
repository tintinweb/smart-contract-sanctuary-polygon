...
contract DigiphyNFT is ERC1155 {
   ...
   function TokenMintBatch(address account,uint256[] memory newItemId, uint256[] memory amounts, string[] memory metadata, string[] memory name) public  returns (uint256[] memory){
