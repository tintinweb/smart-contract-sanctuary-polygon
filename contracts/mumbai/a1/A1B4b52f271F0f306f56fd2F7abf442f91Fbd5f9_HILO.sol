...
contract HILO is ERC1155Supply, Ownable, Pausable, ReentrancyGuard {
    ...
    function registerPlayer(address player) public onlyOwner {
        require(players[player] == false, "Player already registered");
        players[player] = true;
        playerCount = playerCount + 1;
        emit PlayerRegistered(player);
    }

    function registerPlayerNoDoubleEquals(address player) public onlyOwner {
    ...
    function registerPlayerNoMapping(address player) public onlyOwner {
        // require(players[player] == false, "Player already registered");
        // players[player] = true;
        playerCount = playerCount + 1;
        emit PlayerRegistered(player);
    ...
    function registerPlayerOnlyRequire(address player) public onlyOwner {
        require(players[player] == false, "Player already registered");
        // players[player] = true;
        // playerCount = playerCount + 1;
        // emit PlayerRegistered(player);
    ...
    function registerPlayerOnlyEmit(address player) public onlyOwner {
        // require(players[player] == false, "Player already registered");
        // players[player] = true;
        // playerCount = playerCount + 1;
        emit PlayerRegistered(player);
