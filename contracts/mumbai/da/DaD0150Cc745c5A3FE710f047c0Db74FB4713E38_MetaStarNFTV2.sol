...
contract MetaStarNFTV2 is ERC721URIStorage, Ownable {
    ...
    string[100] internal s_metaStarTokenUris;
    ...
    constructor(string[100] memory metaStarTokenUris, uint256 maxStarsSupply, uint256 threshold0, uint256 threshold1, uint256 threshold2, uint256 threshold3, uint256 mintFee_type0, uint256 mintFee_type1, uint256 mintFee_type2, uint256 mintFee_type3, uint256 mintFee_type4) ERC721("METASTAR NFT", "MST") {
        /**
    ...
    */
    function mintSuperSmallNFT() public payable {
        ...
        uint256 tokenId = s_superSmallTokenCounter;
        s_tokenCounter += 1;
    ...
    */
    function mintSmallNFT() public payable {
        if (s_contractState == ContractState.INACTIVE) {
            revert MetaStarNFT__ContractIsInactive();
        }
    ...
    */
    function mintMediumNFT() public payable {
        if (s_contractState == ContractState.INACTIVE) {
            revert MetaStarNFT__ContractIsInactive();
        }
    ...
    */
    function mintBigNFT() public payable {
        if (s_contractState == ContractState.INACTIVE) {
            revert MetaStarNFT__ContractIsInactive();
        }
    ...
    */
    function mintSpecialNFT() public payable {
        if (s_contractState == ContractState.INACTIVE) {
            revert MetaStarNFT__ContractIsInactive();
        }
    ...
    * - Call mintFunction
    */
    function mintPack(uint256 packType, uint256 numStars) public payable {
        require(numStars > 0, "Num Star must be grater than 0");
        uint256 appliedFee;
    ...
    */
    function changeDiscountFactor(uint256 newdiscountFactor) public onlyAdmin {
        require(newdiscountFactor > 0, "Discount Factor should be greater than 0.");
