...
contract LandNFT is ERC721 {
    ...
    function mintLandNFT(string[4] memory coordinates, string memory ownerName, string memory aadhaar, string memory khasra) public returns (uint256) {
        _tokenIds.increment();
        uint256 tokenId = _tokenIds.current();
        _lands[tokenId] = Land(coordinates, ownerName, aadhaar, khasra);
    ...
    function getKhasra(uint256 tokenId) public view returns (string memory) {
        return _lands[tokenId].khasra;
    }
}