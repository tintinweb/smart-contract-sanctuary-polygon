...
contract ERC721MintableWithSlots is ERC721Mintable, IERC721MintableWithSlotsInitializable{
    ...
    function initialize_ERC721MintableWithSlots(bytes calldata initializerEncoded_) initializer override public {

        (string memory name_, string memory symbol_, string memory contractURI_, address owner_, uint256 slotStart_, uint256 slotEnd_, address system_) = this.decodeInitializer_ERC721MintableWithSlots(initializerEncoded_);
        _initialize_ERC721MintableWithSlots(name_, symbol_, contractURI_, owner_, slotStart_, slotEnd_, system_);
    }

    function _initialize_ERC721MintableWithSlots(string memory name_, string memory symbol_, string memory contractURI_, address owner_, uint256 slotStart_,
        uint256 slotEnd_, address system_) onlyInitializing internal {
    ...
    function decodeInitializer_ERC721MintableWithSlots(bytes calldata initializerEncoded_) override external pure returns (string memory, string memory, string memory, address, uint256,
        uint256, address){
        return abi.decode(initializerEncoded_[4:], (string, string, string, address, uint256, uint256, address));
    }
    ...
    function encodeInitializer(string memory name_, string memory symbol_, string memory contractURI_, address owner_, uint256 slotStart_,
        ...
        return abi.encodeWithSelector(
            IERC721MintableWithSlotsInitializable.initialize_ERC721MintableWithSlots.selector,
            name_,
            symbol_,
            contractURI_,
            owner_,
...
interface IERC721MintableWithSlotsInitializable {
    ...
    function initialize_ERC721MintableWithSlots(bytes calldata initializerEncoded_) external;

    function encodeInitializer(string memory name_, string memory symbol_, string memory contractURI_, address owner_, uint256 slotStart_,
        uint256 slotEnd_, address system_) external returns (bytes memory);
