    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeifen3gxwvbnxbjsis23ry36fyxtsrtiycnoaudnafgcjzoxjutybu/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/vBiin9kRMxOttGL4594R/contract-metadata";
  }
...
// File: contracts/RPv2SoundGuardianGiftsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract RPv2SoundGuardianGiftsContract is RamppERC721A {
    constructor() RamppERC721A("RPv2 Sound Guardian Gifts", "RPSG"){}
}
