...
interface IDepositManager {
    /**
     * @dev Purchase Storage from with accepted stable token
     */
    function addDeposit(address _tokenAddress, uint256 _amount) external returns (bool);

    /**
     * @dev set Cost of Storagr
     */
    function setCostOfStorage(uint256 newCost) external;

    /*
     * @dev Remove Token from Allowed List
     *
     * Args:
     * tokenAddress on the Network
     *
     *
     * Requirement:
    ...
    function addToken(address _tokenAddress, uint256 rate) external;
    ...
    function setWhiteListAddress(address _address, bool _status) external;
    ...
    /*
     * @dev
     * give approval to spend to a designated Account
     */
