...
event GameStarted(uint256 gameId, uint8 maxPlayers, uint256 entryFee);
    ...
    constructor(address vrfCoordinator,address linkToken,bytes32 _keyhash,uint _fee)VRFConsumerBase(vrfCoordinator,linkToken)
    {
        keyHash=_keyhash;
        fee=_fee;
        gameStarted=false;
    ...
    function joinGame()public payable{
        ...
        require(msg.value==entryFee,"Enter correct Entry fee");
