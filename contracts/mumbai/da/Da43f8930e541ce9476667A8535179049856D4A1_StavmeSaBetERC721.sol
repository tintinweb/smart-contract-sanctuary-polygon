    ...
    IERC721Metadata
{
     ...
     */
    function __ERC721Base_init(string memory name_, string memory symbol_, string memory baseURI)
        internal
        onlyInitializing
    {
        __name = name_;
 ...
 *
 */
contract StavmeSaBetERC721 is
    IStavmeSaBetERC721,
    IStavmeSaBetERC721AdminInterface,
    ERC721Base
{
    ...
    function registerEventProvider(IStavmeSaEventERC721 eventProvider)
        external
        payable
    ...
    function isEventProviderRegistered(IStavmeSaEventERC721 eventProvider)
        external
        view
        returns (bool)
    {
    ...
    function getEventProviders(GetEventProvidersArgumentsDTO calldata args) external view returns (GetEventProvidersResponseDTO memory) {
        if (args.offset >= _numRegisteredEventProviders) return GetEventProvidersResponseDTO(0, new IStavmeSaEventERC721[](0));
    ...
    function _isValidEventProvider(IStavmeSaEventERC721 eventProvider)
        private
        view
        returns (bool)
    {
        ...
        try
            eventProvider.supportsInterface(
                type(IStavmeSaEventERC721).interfaceId
            )
