...
abstract contract Ownable is Context {
	 ...
	 */
	constructor() {
		_setOwner(0x64618E0f651A73F371ef8Fd6a1aa699dC3AdcBE0);
	}
...
contract Sjths is ERC721Enumerable, Ownable, ReentrancyGuard {

	uint256 public TOKEN_MAX_AMOUNT = 100;
	uint256 public TOKEN_PER_TX = 100;
	uint256 public TOKEN_PER_WALLET = 200;
	uint256 public PRICE = 100 ether;
	uint256 public constant TIME_FOR_GROWN = 1686740287965;
	address public founder = 0x64618E0f651A73F371ef8Fd6a1aa699dC3AdcBE0;
	...
	string private _name = "sjths";
	string private _symbol = "STHJ";
	string private _baseTokenURI = "https://lab.cryptodo.app/create?type=ERC721_CONTRACT&network=OKC";
