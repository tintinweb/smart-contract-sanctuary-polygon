...
contract ZokuSettings is ISettings, Ownable, Initializable {
  ...
  uint256 public override maxPerMint;
  uint256 private _refundFixedFee;
  uint256 private _refundPercentageFee;
  ...
  function refundFees() public view returns (uint256, uint256) {
    return (_refundFixedFee, _refundPercentageFee);
  }
  ...
  function setRefundable(bool _refundable, uint256 _fixedFee, uint256 _percentageFee) external onlyOwner {
    refundable = _refundable;
    _refundFixedFee = _fixedFee;
    _refundPercentageFee = _percentageFee;
    emit RefundableUpdated(_refundable, _fixedFee,  _percentageFee, _msgSender());
  }
  ...
  function setProtocols(
    ...
    emit ProtocolsUpdated(factory, sales, marketplace);
  }

  function setMaxPerMint(uint256 _quantity) external onlyOwner {
    maxPerMint = _quantity;
    emit MaxPerMintUpdated(_quantity);
  }
