    ...
    AccessControlUpgradeable
{
    ...
    function setMinter(address _minter) public onlyRole(DEFAULT_ADMIN_ROLE) validation(_minter) {
     ...
     * @param _amount amount of usdc token to be deposited
     **/

    function buy(uint256 _amount) public {
        uint256 requiredUsdc = _amount * 10**4;
        require(
    ...
    function sell(uint256 _amount) public {
        ...
        usdc.transfer(_msgSender(), _amount * 10**4);
