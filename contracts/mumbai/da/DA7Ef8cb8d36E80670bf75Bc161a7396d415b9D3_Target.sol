...
contract Target is IXReceiver, Ownable {
    ...
    address public Esource =
        address(0x985D36be8Ed36DBA7037334EEB338df3c634fff7);
    ...
    function xReceive(
        ...
        sender = _originSender;
        uint256 Amount = abi.decode(_callData, (uint256));

        // if (_originSender == Esource) {
        ...
        userInfo[msg.sender].usdcSupplied += Amount;
        // } else {
        //     greeting = "Hello borrow";

        //     _borrowFor(Amount);

        //     userInfo[msg.sender].usdcBorrowed += Amount;
        // }
    }
