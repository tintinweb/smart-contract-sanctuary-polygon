...
contract YexleAppian is ERC721Burnable, Ownable {
    ...
    */
    function mint(address l1Address, address _to, uint256 _tokenId, string memory _tokenUri) external onlyAdmin{
        ...
        if(l1Address == L1Approver){
            ...
            string memory local = string(abi.encodePacked("https://ipfs.io/ipfs/",_tokenUri));
    ...
    */
    function returnAllUriForLandOwner(address landOwnerAddress) external view returns(string[] memory allUris){
