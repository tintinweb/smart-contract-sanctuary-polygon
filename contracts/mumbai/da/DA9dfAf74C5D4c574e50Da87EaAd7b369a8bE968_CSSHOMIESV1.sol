    ...
    ERC2771ContextUpgradeable
{
    ...
    function initialize(
        ...
        _grantRole(MINTER_ROLE, _minters[0]);
        _grantRole(MINTER_ROLE, _minters[1]);
    ...
    function minterMint(uint256[] calldata ids) public onlyRole(MINTER_ROLE) {
        uint256 count = ids.length;
