...
contract Marketplace is ReentrancyGuard {
    ...
    function createMarketSale(address nftContractAddress, uint256 marketItemId) public payable nonReentrant {
        ...
        if (seller == creator) {
           ...
           payable(account).transfer(fee);
            ...
            uint256 sellerfee = msg.value * 20 / 100;
    ...
    /**
     * @dev compare strings in Solidity
     */
    ...
    /**
     * @dev Fetches market items according to the its requested address property 
     */
