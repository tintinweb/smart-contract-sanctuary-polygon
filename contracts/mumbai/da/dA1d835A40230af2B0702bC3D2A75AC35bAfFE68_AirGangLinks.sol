...
contract AirGangLinks is Ownable, ReentrancyGuard {
    ...
    /**
     * @notice Gets the links associated with a specific Air Gang.
     * @param airGangID The Air Gang ID.
     * @return The Air Gang links data.
     */
    function getLinks(
        uint256 airGangID
    ) public view returns (AirGangLinksData memory) {
        return airGangIDToData[airGangID];
    }
