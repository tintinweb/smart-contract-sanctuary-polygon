...
contract Factory is AccessControl, Initializable, BasicMetaTransaction {
    ...
    function setMintAgent(address _mintAgent) public {
    ...
    function deployIdentity(
        ...
        bool _isLibrary
    ) public onlyRole(Owner_Role) returns (address) {
    ...
    function _initProxy(
        ...
        (success, ) = proxy.call(abi.encodeWithSelector(0xb422d830,address(this)));
    ...
    function createForward(
        ...
        console.log(IToken(_token).allowance(_fund,forwardInstance));
    ...
    function tokenMint(address _to,uint _amount,address _token) external {
        console.log("in mint",msg.sender);
        IToken(_token).mint(_to,_amount);

    }
    function batchMintTokens(address[] calldata _toList, uint256[] calldata _amounts,address _token) external {
        console.log("in batch mint",msg.sender);
