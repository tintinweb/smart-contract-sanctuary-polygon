...
constructor() {
     name = "BIDASSET"; // Sets the name of the token, i.e BIDASSET
     symbol = "BIDASS"; // Sets the symbol of the token, i.e BIDASS
     decimals = 5; // Sets the number of decimal places
     totalSupply = 100000000000 ; // Holds an initial supply of coins
