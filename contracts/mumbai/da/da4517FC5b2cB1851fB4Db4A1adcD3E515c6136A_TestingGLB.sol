...
contract TestingGLB is ERC721, Ownable {
    ...
    string public notRevealedUri = "ipfs://QmWKXC8WLZrkhyVvYLnCRWzsNssaq2GcGpMQKqbhDAwvzJ/0.json";
  ...
  function whitelistMint(bytes32[] calldata _merkleProof, uint256[] calldata _position, uint256 _mintAmount) public payable whitelistMintCompliance(_mintAmount){
