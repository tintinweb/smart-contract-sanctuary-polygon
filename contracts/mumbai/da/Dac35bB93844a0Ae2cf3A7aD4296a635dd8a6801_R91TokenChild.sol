    ...
    VestingUpgradeable
{
    ...
    function initialize(address childChainManagerProxy_, address trustedForwarder_) public initializer {
        __ERC20_init(
            "ROVI Token",
            "ROVI",
           childChainManagerProxy_,
           trustedForwarder_
        );
    }
    ...
    function __ERC20_init(
        ...
        __Vesting_init();
        __Context_init();
        __ERC20_init_unchained(name_, symbol_, childChainManagerProxy_);
    ...
    /**
     * @dev Return the ChildChain Manager Proxy address.
     */
    function childChainManagerProxy() public view virtual returns (address) {
    ...
    /**
     * @dev Should be callable only by owner to update teh child chain manager proxy address
     */
    function updateChileChainManagerProxy(address childChainManagerProxy_)
        public
        onlyRole(DEFAULT_ADMIN_ROLE)
        returns (bool success)
    {
        require(
            childChainManagerProxy_ != address(0),
            "ChildChainManagerProxy: childChainManagerProxy is the zero address"
        );
        _childChainManagerProxy = childChainManagerProxy_;
        return true;
    }
    ...
    {
        require(
            _childChainManagerProxy == _msgSender(),
            "ChildChainManagerProxy: only Polygon ChildChainProxy can deposit"
        );
