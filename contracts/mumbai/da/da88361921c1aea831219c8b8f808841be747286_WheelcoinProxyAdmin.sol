...
contract WheelcoinProxyAdmin is Initializable, WheelcoinRoles, ProxyAdmin {
    ...
    function __WheelcoinProxyAdmin_init() public initializer {
        WheelcoinRoles.__WheelcoinRoles_init();
    }

    function changeProxyAdmin(TransparentUpgradeableProxy proxy, address newAdmin) public override onlyRole(ADMIN_ROLE) {
        proxy.changeAdmin(newAdmin);
    }

    function upgrade(TransparentUpgradeableProxy proxy, address implementation) public override onlyRole(UPGRADER_ROLE) {
        proxy.upgradeTo(implementation);
    }
    /* solhint-disable indent, bracket-align,  no-unused-vars*/
    function upgradeAndCall(TransparentUpgradeableProxy proxy, address implementation, bytes memory data) public payable override onlyRole(UPGRADER_ROLE) {
