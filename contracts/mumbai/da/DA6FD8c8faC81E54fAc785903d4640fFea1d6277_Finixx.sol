...
contract Finixx {
    ...
    uint256 private constant poolTimeStep = 15 minutes;
    ...
    uint256 private constant lotteryDuration = 15 minutes;
    ...
    uint256 private NormalPercents = 7000;
    uint256 private freezePercents = 5000;
    uint256 private SL1Percents = 5000;
    uint256 private SL2Percents = 3500;
    ...
    function withdraw() public {
        if(block.timestamp.sub(lotteryLastDistributed) >= timestep) {
            distributeLotteryPool();
        }
    ...
    function getRegisterationData(address _user) public view returns(uint256, uint256) {
        return (userInfo[_user].registered[0], userInfo[_user].registered[1]);
    }
