...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x59Fc3FF7de65f7b6a13d203B548DC150401A1b80];
...
// File: contracts/antiCatCatClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AntiCatCatClubContract is RamppERC721A {
    constructor() RamppERC721A("Anti-Cat Cat Club", "AntiCat"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/B1YGirD31QrbD0IjGDP0/contract-metadata";
    }
}