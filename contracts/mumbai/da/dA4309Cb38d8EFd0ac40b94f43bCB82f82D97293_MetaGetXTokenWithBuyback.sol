...
interface MetaGetXToken {
    function transfer(address, uint256) external returns (bool);
}

contract MetaGetXTokenWithBuyback is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "MetaGetX Token";
    string private _symbol = "MEGTX";
    ...
    uint256 internal _tokenTotal = 20000000000 *10**18; // 20 Billion totalSupply
    ...
    uint256 public _taxFee = 0; // 10 = 0.1%
    uint256 public _buybackv1Fee = 0; // 100 = 1.00%
    uint256 public _buybackv2Fee = 0; // 100 = 1.00%
    uint256 public _burningFee = 0; // 100 = 1.0%
    
    uint256 public _maxTxAmount = 25000000 * 10**18; // 25 Million inicial max transfer
    ...
    address public buybackv1Address  = 0x1cbcFC0340549C0f4006Ed95B52B00Cd48772aa1;      // BuyBackv1 Address
    address public buybackv2Address  = 0xb8640eB9Cc99E7d87426094298E85c61271CFaED;      // BuyBackv2 Address
    ...
    // function to allow admin to transfer token from this contract
    function TransferToken(address payable recipient, uint256 amount) public onlyOwner {
        recipient.transfer(amount);
    }
    
    // function to allow admin to transfer tokens from this contract
    function transferEveryTokens(address _tokenAddress, address _to, uint256 _amount) public onlyOwner {
        MetaGetXToken(_tokenAddress).transfer(_to, _amount);
    }
