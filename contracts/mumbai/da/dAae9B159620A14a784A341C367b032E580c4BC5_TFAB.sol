...
contract TFAB is ERC20Burnable, ERC20Blacklisted, ApprovalCaller {
  // bridge gate address
  ...
  modifier onlyBridge() {
    require(msg.sender == bridge, "TFAB: CALLER_NO_BRIDGE");
    _;
  }

  constructor(address _bridge) ERC20Blacklisted("Test MetalCore Token", "TFAB") {
    require(_bridge != address(0), "TFAB: BRIDGE_ADDRESS_INVALID");
    bridge = _bridge;
  }
  ...
  function mint(
    ...
    require(msg.sender == owner() || msg.sender == bridge, "TFAB: CALLER_NO_OWNER_BRIDGE");
    require(_amount != 0, "TFAB: ZERO_AMOUNT");
