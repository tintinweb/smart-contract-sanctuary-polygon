...
contract Player is ERC1155 {
    ...
    mapping (address => uint256) public battry ;
   // address payToken = 0x514ad20A3e656Fcad9dEAaf757F70a4e07e87ECB;
  //  address rewardToken = 0x2b09D106910c7609C6665966BB78cAB0AA12cE10;
    uint256 costvalue = 2000 * 10 ** 18;
    uint256 rewardSilver = 3 * 10 ** 18;
    uint256 rewardGold = 5 * 10 ** 18;
    uint256 rewardDiamond = 8 * 10 ** 18;
    address payToken;
    address rewardToken;
    ...
    function insert(address a,address b)external{
      payToken = a;
      rewardToken = b;
    }
    ...
    function transfer() external payable{
      ...
      if (balanceOf(msg.sender, 0) == 0){
        ...
        require(IERC20(payToken).balanceOf(msg.sender) >= costvalue);
        ...
        battry[msg.sender] = 3;
        //if (battry[msg.sender] == 0){battry[msg.sender] = 3;} 
        } 
        ...
        battry[msg.sender] = 5;
       // if (battry[msg.sender] == 0){battry[msg.sender] = 5;} 
        }
      else if (balanceOf(msg.sender, 2) == 0 && msg.value == 10 ** 15){
        _safeTransferFrom(address(this), msg.sender, 2, 1, "");
        memberPlan[msg.sender][2] = true;
        battry[msg.sender] = 8;
       // if (battry[msg.sender] == 0){battry[msg.sender] = 8;} 
    } else {revert();}
    }

    function reward() external{
    
        if (battry[msg.sender] > 0 && memberPlan[msg.sender][2] == true ){
        battry[msg.sender] -= 1;
        IERC20(rewardToken).transfer(msg.sender, rewardDiamond);
        } 
      else if (battry[msg.sender] > 0 && memberPlan[msg.sender][1] == true ){
        battry[msg.sender] -= 1;
        IERC20(rewardToken).transfer(msg.sender, rewardGold);
        }
      else if (battry[msg.sender] > 0 && memberPlan[msg.sender][0] == true ){
        battry[msg.sender] -= 1;
    ...
    function charge() external{
        ...
        if (battry[msg.sender] == 0 && memberPlan[msg.sender][2] == true ){
        IERC20(rewardToken).transferFrom(msg.sender, address(this), 1 * 10 ** 18);
        burnt += 1;
        battry[msg.sender] = 8;
        } 
      else if (battry[msg.sender] == 0 && memberPlan[msg.sender][1] == true ){
