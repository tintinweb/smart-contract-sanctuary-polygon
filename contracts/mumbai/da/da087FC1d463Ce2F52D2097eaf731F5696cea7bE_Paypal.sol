...
//1. Define the Owner of the smart contract 
...
//2. Create Struct and Mappping for request, transaction & name
...
//3. Add a name to wallet address
...
//6. Get all requests sent to a User
...
//7. Get all historic transactions user has been apart of
