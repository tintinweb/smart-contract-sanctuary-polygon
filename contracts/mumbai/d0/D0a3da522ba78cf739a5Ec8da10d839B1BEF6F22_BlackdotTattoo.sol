...
import "./WhitelistNFT.sol";
 ...
 contract BlackdotTattoo is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable {

     using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("BlackdotTattoo", "BDT") {}
    ...
    function safeMint(address _whitelistAddress, address to, string memory uri) public onlyOwner {
        uint256 tokenId = _tokenIdCounter.current();
        require(WhitelistNFT(_whitelistAddress).getWhitelistInformation(), "Error: Whitelist is disabled");
        require(WhitelistNFT(_whitelistAddress).verifyUserAddress(msg.sender), "Error: Sender is not whitelisted");
