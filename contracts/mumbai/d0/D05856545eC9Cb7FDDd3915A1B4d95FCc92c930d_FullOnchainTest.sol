...
contract  FullOnchainTest is ERC721Enumerable, ERC721Permit("FullOnchainTestNFT:Token"),  ReentrancyGuard, Ownable {
    ...
    constructor() ERC721("FullOnchainTestNFT:Token", "FULL TEST") Ownable() {}


    function setInfo(uint256 _id) private onlyOwner {
