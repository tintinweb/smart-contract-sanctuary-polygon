...
contract EthMint is ERC721, Ownable {
    ...
    constructor(
        ...
        require(_royalties != address(0), "Zero Royalties");
    ...
    /**
     * @dev Mints a new token for all users
     */
    ...
    /**
     * @dev Mints a new token for the owner
     */
