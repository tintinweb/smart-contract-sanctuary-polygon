...
contract mallowAuctions is Ownable{
    ...
    function verify(AuctionRequest calldata _auctionR, uint8 _v, bytes32 _r, bytes32 _s, address _sender) public view returns (bool) {
        ...
        bytes32 digest = keccak256(abi.encodePacked(
            ...
            keccak256(abi.encode(
                ...
                _auctionR.Auction_ID,
                keccak256(bytes(_auctionR.Auction_Type)),
                _auctionR.Entry_Price,
                _auctionR.Nonce
            ))
        ));
