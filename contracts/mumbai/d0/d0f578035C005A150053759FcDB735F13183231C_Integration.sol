...
contract Integration {
    ...
    /// @param amount_integration USD to be sended to account, when proposal for integration is succesfull executed
    /// @param amount_approve USD to be sended, when approve will be confirmed 
