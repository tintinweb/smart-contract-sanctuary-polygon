...
contract Factory is AccessControl {
    ...
    /**
     * @dev Deployment of new KwikTrust Minting contract
     * @param _name NAME of contract
     * @param _symbol SYMBOL of contract
     * @param _minterAddress Minter Role, who can mint NFT
     * @param _validatorAddress Validator Role, who can verify signature of lazy minted NFT
     */
...
contract NFT is ERC721URIStorage, EIP712, AccessControl {
    ...
    {
        _setupRole(DEFAULT_ADMIN_ROLE, _minterAddress);
        grantRole(MINTER_ROLE, _minterAddress);
        emit deployContract("Roles Granted");
        grantRole(VALIDATOR_ROLE, _validatorAddress);
    }
