...
contract lyncrentTime is ReentrancyGuard {
        ...
        public
    {
        ...
        console.log("renterStructArray start length", renterStructArray.length);
        ...
        console.log("length later", renterStructArray.length);
    }
    ...
    function checkAndReturnRentedNfts() public onlyOwner {
