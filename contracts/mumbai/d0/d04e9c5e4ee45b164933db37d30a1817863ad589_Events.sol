...
interface IVenue {
    function bookVenue(uint256 tokenId, address tokenAddress, uint256 feeAmount) external;
...
contract Events  is EventMetadata {
    ...
    event EventAdded(uint256 indexed tokenId, string name, string _type, string description, uint256 startTime, uint256 endTime,  string tokenCID,
    ...
    function buyTicket(uint256 tokenId, address tokenAddress, uint256 ticketPrice) external payable {
        ...
        uint256 eventTokenId = getInfo[tokenId].venueTokenId;
    ...
    function checkPaymentToken(uint256 tokenId, address tokenAddress, uint256 feeAmount) internal {
        address eventOrganiser = getInfo[tokenId].eventOrganiser;
