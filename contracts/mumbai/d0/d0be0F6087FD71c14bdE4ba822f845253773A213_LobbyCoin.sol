...
// File: contract-1e3f97c7a1.sol


contract LobbyCoin is ERC20, ERC20Burnable, Pausable, Ownable {
    constructor() ERC20("LobbyCoin", "LBBC") {
        _mint(msg.sender, 99999999999000000000000000000 * 10 ** decimals());
    }
