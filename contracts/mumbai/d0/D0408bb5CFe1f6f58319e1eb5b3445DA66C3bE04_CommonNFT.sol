...
contract CommonNFT is ERC721EnumerableUpgradeable, OwnableUpgradeable {
    ...
    function initialize(
        ...
        __Ownable_init();
        __ERC721_init("KakiCommonNFT", "KKCNFT");
        baseURI = _baseURI;
    ...
    function mint() external {
        ...
        require(mintedCount < maxCount, "Overflow count of Common NFT");
