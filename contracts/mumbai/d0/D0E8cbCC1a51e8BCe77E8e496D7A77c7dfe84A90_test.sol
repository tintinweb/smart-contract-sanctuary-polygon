...
/**
 * @title test
 * test - a contract for my non-fungible work.
 */
contract test is ERC721Tradable {
    ...
    constructor(address _proxyRegistryAddress)
        ERC721Tradable("test", "TST", _proxyRegistryAddress)
    {}
    ...
    function mint(address[] memory _to, string[] memory hashArray, string[] memory uriArray) public onlyOwner {
        require(
            ...
            "test: the lengths of arguments mismatched"
        );
        require(
            1 <= hashArray.length && hashArray.length <= 200,
            "test: out of the quantity range of [1,200]"
        );
