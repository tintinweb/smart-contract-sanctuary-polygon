...
//*********************************************************************//
//
//   ________            ___         __  _ _____      _       __   _____           
//  /_  __/ /_  ___     /   |  _____/ /_(_) __(_)____(_)___ _/ /  / ___/__  ______ 
//   / / / __ \/ _ \   / /| | / ___/ __/ / /_/ / ___/ / __ `/ /   \__ \/ / / / __ \
//  / / / / / /  __/  / ___ |/ /  / /_/ / __/ / /__/ / /_/ / /   ___/ / /_/ / / / /
// /_/ /_/ /_/\___/  /_/  |_/_/   \__/_/_/ /_/\___/_/\__,_/_/   /____/\__,_/_/ /_/ 
//                                                                                 
//
//*********************************************************************//
//*********************************************************************//
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeihjsfs2yjby676kxmw6q4ntohkg4qxnla6m56zwronikvbalfvocq/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 2");
...
// File: contracts/TheArtificialSunContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheArtificialSunContract is RamppERC721A {
    constructor() RamppERC721A("The Artificial Sun", "ARTIFICIAL"){}
}