...
// File: contracts/SDLC/docNFT.sol
...
contract NFT is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("Ice-App NFT", "Nft") {       
    }

    function mint(string calldata cid, address _address)external onlyOwner{
        require(saleIsActive, "Sale is not open yet!");
        uint256 tokenId = totalSupply();
        _mint(_address, tokenId);
        _setTokenURI(tokenId, cid);
        emit ItemCreated(_address, tokenId);
