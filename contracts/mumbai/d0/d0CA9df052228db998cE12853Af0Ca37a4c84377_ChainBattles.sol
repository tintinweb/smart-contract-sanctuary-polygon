...
contract ChainBattles is ERC721URIStorage  {
    ...
    function generateCharacter(uint256 tokenId) public returns(string memory){
        ...
        bytes memory svg = abi.encodePacked(
            ...
            '<text x="50%" y="50%" class="base" dominant-baseline="middle" text-anchor="middle">', "Level: ",'<tspan x="0" dy="1.2em">', getLevel(tokenId), '</tspan></text>',
            '<text x="50%" y="50%" class="base" dominant-baseline="middle" text-anchor="middle">', "Speed: ",'<tspan x="0" dy="1.2em">', getSpeed(tokenId), '</tspan></text>',
            '<text x="50%" y="50%" class="base" dominant-baseline="middle" text-anchor="middle">', "Strength: ",'<tspan x="0" dy="1.2em">', getStrength(tokenId), '</tspan></text>',
            '<text x="50%" y="50%" class="base" dominant-baseline="middle" text-anchor="middle">', "Life: ",'<tspan x="0" dy="1.2em">', getLife(tokenId), '</tspan></text>',
            '</svg>'
        );
        return string(
            abi.encodePacked(
