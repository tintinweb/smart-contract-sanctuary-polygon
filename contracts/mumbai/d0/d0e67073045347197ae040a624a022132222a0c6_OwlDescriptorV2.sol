...
// File: contracts/OwlDescriptorV2.sol
...
contract OwlDescriptorV2 is IOwlDescriptor {
 ...
 function getColor(uint256 seed) private pure returns (Color memory) {
    if (seed == 10) {
        return Color("#E91E63", "Cerise Pink");
    } else if (seed == 11) {
        return Color("#4CAF50", "Shamrock Green");
    } else if (seed == 12) {
        return Color("#2196F3", "Dodger Blue");
    } else if (seed == 13) {
        return Color("#9C27B0", "Purple");
    } else if (seed == 14) {
        return Color("#FF9800", "Tangerine");
    } else if (seed == 15) {
        return Color("#03A9F4", "Sky Blue");
    } else if (seed == 16) {
        return Color("#CDDC39", "Lime Green");
    } else if (seed == 17) {
        return Color("#FFC107", "Amber");
    } else if (seed == 18) {
        return Color("#FF5722", "Vermilion");
    } else if (seed == 19) {
        return Color("#795548", "Raw Umber");
    } else if (seed == 20) {
        return Color("#00BCD4", "Turquoise");
    } else if (seed == 21) {
        return Color("#9E9E9E", "Slate Gray");
    } else if (seed == 22) {
        return Color("#673AB7", "Deep Purple");
    } else if (seed == 23) {
        return Color("#FFEB3B", "Canary Yellow");
    } else if (seed == 24) {
        return Color("#FF5722", "Cinnabar");
    } else if (seed == 25) {
        return Color("#4CAF50", "Forest Green");
    } else if (seed == 26) {
        return Color("#2196F3", "Azure");
    } else if (seed == 27) {
        return Color("#795548", "Dark Brown");
    } else if (seed == 28) {
        return Color("#F44336", "Scarlet");
    } else if (seed == 29) {
