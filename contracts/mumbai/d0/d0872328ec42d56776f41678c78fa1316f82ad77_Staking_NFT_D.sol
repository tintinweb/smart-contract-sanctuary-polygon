...
contract Staking_NFT_D is Ownable, ReentrancyGuard, Pausable {
    ...
    uint256 constant REQUIRED_STAKE_TOKENS = 5 * 10 ** 18; // if your token has 18 decimals
    ...
    uint256 private rewardsPerMinute = 1000000000000000000;
...
//функция для просмотра оставшихся минут стэйкинга
