...
contract PrimaryIndexTokenLeverage is Initializable, AccessControlUpgradeable, ReentrancyGuardUpgradeable
{
    ...
    //  * @param amountReceive The amount of tokens received. 
    //  */
    // function _checkSlippage(uint collateralTokenCount, uint maxSlippage, uint amountReceive) internal pure {
    //     uint realRate = amountReceive * decimalPercent / collateralTokenCount;
