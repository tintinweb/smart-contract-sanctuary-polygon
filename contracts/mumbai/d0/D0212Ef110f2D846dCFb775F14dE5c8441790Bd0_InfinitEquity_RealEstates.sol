...
contract InfinitEquity_RealEstates is ERC721, ERC721Enumerable, ReentrancyGuard, Ownable, AccessControl {
	...
	constructor(address _referralContractAddress) ERC721("Infinit Equity - Real Estates", "Real Estate") Ownable() {
	...
	function tokenURI(uint _tokenId) public view override returns (string memory) {
        ...
        json[0] = string(
			abi.encodePacked('{',
                '"name": "Infinit Real Estate #', t(_tokenId), '",',
