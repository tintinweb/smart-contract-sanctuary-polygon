...
contract Passport is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
    ...
    uint256 public PHASE_PRICE = 0.0001 ether;
    ...
    string private preRevealURI = "https://ipfs.w3bmint.xyz/ipfs/QmWknDwNfRDKYEBfixTrtKmXg5BCQb5qQTQATovHYTFn2d";
    ...
    constructor() ERC721A("Passport", "PASSPORT") {
