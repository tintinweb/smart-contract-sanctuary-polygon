...
contract florece is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_, address proxyRegistryAddress_)
    ERC721("Criptoria Test", "CRIPTORIA")
  {
  ...
  uint256 public constant MAX_MULTIMINT = 25;
  ...
  function mint(uint256 count) public nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 25 at a time");
