    ...
    UUPSUpgradeable
{
    ...
    {
        AllowedCrypto.push(
            TokenInfo({paytoken: _paytoken, costvalue: _costvalue * 10**18})
        );
    }
    ...
    //     uint256 landPrice
    // ) public payable {
    //     TokenInfo storage tokens = AllowedCrypto[tokenId];
    //     IERC20 paytoken;
    ...
    //         safeMint(msg.sender, landId[i - 1], uri);
