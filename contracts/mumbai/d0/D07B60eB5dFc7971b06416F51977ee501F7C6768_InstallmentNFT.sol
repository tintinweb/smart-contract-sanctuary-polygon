...
contract InstallmentNFT is Initializable, UUPSUpgradeable, OwnableUpgradeable, AccessControlUpgradeable, ReentrancyGuardUpgradeable {
    ...
    */
     ...
     * @param _orderId - order id of order.
     */
    function cancelOrderInstallmentNFT(bytes32 _orderId) external onlyRole(WORKER_ROLE) whenInstallmentNotPaused{
