...
contract DTA1155 is ERC1155, ERC2981Base, AccessControl {
    RoyaltyInfo private _royalties;
    bytes32 public constant URI_SETTER_ROLE = keccak256("URI_SETTER_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant BURN_ROLE = keccak256("BURN_ROLE");
    string private _name = "DTA Collection V1";

    event burnNFT(address from, address to, uint256 id, uint256 amount);

    constructor() ERC1155("https://gateway.pinata.cloud/ipfs/QmUbYfuTGNpNfFdMzSmkSVZxC5iGhaDpcR8YH8gJgDb2xo/{id}.json") {
    ...
    /// @param from the burn token address
    /// @param id id of the token id
    /// @param amount amount of the token type to burn
    function burn(address from, uint256 id, uint256 amount) public onlyRole(MINTER_ROLE) {
        _burn(from, id, amount);
        emit burnNFT(from, msg.sender, id, amount);
    }
    ...
    /// @param value id of the token type to mint
