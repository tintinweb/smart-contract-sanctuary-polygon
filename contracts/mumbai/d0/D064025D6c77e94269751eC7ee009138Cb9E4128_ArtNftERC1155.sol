...
contract ArtNftERC1155 is IArtNftERC1155, ERC2981, AccessControl, ERC1155Supply {
     ...
     * @dev Indicates whether any token exist with a given id, or not.
     */
    function exists(uint256 id) public view override(IArtNftERC1155, ERC1155Supply) returns (bool) {
        return ERC1155Supply.totalSupply(id) > 0;
    }
    ...
    function supportsInterface(
        bytes4 interfaceId
    ) public view virtual override(IArtNftERC1155, ERC2981, AccessControl, ERC1155) returns (bool) {
        return
