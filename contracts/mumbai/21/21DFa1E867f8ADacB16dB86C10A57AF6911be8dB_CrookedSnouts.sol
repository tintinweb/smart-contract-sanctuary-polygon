...
contract CrookedSnouts is VRFConsumerBaseV2, ERC721URIStorage {
  ...
  function create() public {
    ...
    // attributes[0] = backgrounds[bg - 1];
    // attributes[1] = faces[face - 1];
    // attributes[2] = eyes[eye - 1];
    // attributes[3] = heads[head - 1];
    // attributes[4] = mouths[mouth - 1];
    // attributes[5] = noses[nose - 1];
    ...
    string memory tokenURI = formatTokenURI(imageURI, name);
  ...
  function formatTokenURI(string memory imageURI, string memory name) internal pure returns(string memory tokenURI) {
    ...
    tokenURI = string(abi.encodePacked( 
      ...
      Base64.encode(
        bytes(abi.encodePacked(
          ...
          '"attributes": [',
            // '{ "trait_type": "Background", "value": ', attributes[0], '},',
            // '{ "trait_type": "Face", "value": ', attributes[1], '},',
            // '{ "trait_type": "Eyes", "value": ', attributes[2], '},',
            // '{ "trait_type": "Head", "value": ', attributes[3], '},',
            // '{ "trait_type": "Mouth", "value": ', attributes[4], '},',
            // '{ "trait_type": "Nose", "value": ', attributes[5], '}',
            '{ "trait_type": "Background", "value": "aqua" },',
            '{ "trait_type": "Face", "value": "gold" },',
            '{ "trait_type": "Eyes", "value": "ggg" },',
            '{ "trait_type": "Head", "value": "corona" },',
            '{ "trait_type": "Mouth", "value": "some" },',
            '{ "trait_type": "Nose", "value": "worm" }',
          ']',
          '"image": "',
          imageURI,
          '"',
