...
function getLevels(uint256 tokenId) public view returns (string memory) {
   return features[tokenId].level.toString();
}
function getSpeed(uint256 tokenId) public view returns (string memory) {
     return features[tokenId].speed.toString();
}
function getLife(uint256 tokenId) public view returns (string memory) {
    return features[tokenId].life.toString();
}
function getStrength(uint256 tokenId) public view returns (string memory) {
    return features[tokenId].strength.toString();
}
...
function mint() public {
    ...
    _safeMint(msg.sender, newItemId);
     features[newItemId] = Feature(0, 0 ,0, 0);   
...
function train(uint256 tokenId) public {
   ...
   features[tokenId] = Feature(features[tokenId].level + 1, features[tokenId].life + 5, features[tokenId].strength + 10, features[tokenId].speed + 25);
