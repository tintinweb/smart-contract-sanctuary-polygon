...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x40F2a9eaFb6558d0177cACf2c723de8fa39DB4Ab];
  address public erc20Payable = 0x40F2a9eaFb6558d0177cACf2c723de8fa39DB4Ab;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 21000) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeifuv6x2vts5ln37sdigx3lopwi3a6ureki6l4j6vhkg6vlytrhtne/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/PesVu6KhtKjkeFeMImnD/contract-metadata";
  }
...
// File: contracts/MoodofmanContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MoodofmanContract is ERC721APlus {
    constructor() ERC721APlus("MOODOFMAN", "MM"){}
}
