...
contract Entice_NFT is ERC721, PullPayment, Ownable {
  ...
  /// @dev Sets the total supply.
  function setTotalSupply(uint256 _totalSupply) public onlyOwner {
    require(totalSupply < _totalSupply, 'Total supply can not be less than current supply');
