...
contract LazyMintNFT is ILazyMinting, ITokenRoyalties, ERC1155Supply, EIP712 {
    ...
    // tokenId => max token to be minted
    // mapping(uint256 => uint256) private maxTokens;
    ...
    function getTotalSupply(uint256 id)
        external
        view
        override
        returns (uint256)
        ...
        returns (uint256[] memory, address[] memory)
    {
        ...
        return (royalties_.amount, royalties_.recipient);
    }
    ...
    function setTokenRoyalty(
        ...
        require(
            value.length == recipient.length,
            "setTokenRoyalty: array length mismatch"
        );
    ...
    function redeem(
        ...
        // require(value >= voucher.price, "redeem: Insufficient Funds!!");
    ...
    function _beforeTokenMint(
        ...
        // );
        require(
            creator[id] == address(0) || creator[id] == to_,
...
interface ILazyMinting {
    ...
    function setCreator(uint id, address _creator) external;
