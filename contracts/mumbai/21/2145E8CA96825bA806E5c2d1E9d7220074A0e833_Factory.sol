...
contract Factory {
    ...
    function deploy(
        ...
        addr = address(
            new YoloUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        YoloUser721Token token = YoloUser721Token(address(addr));
