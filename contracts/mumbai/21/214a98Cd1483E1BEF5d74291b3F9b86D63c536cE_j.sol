...
contract j is IERC721L, ERC721AQueryable, Ownable, ReentrancyGuard {
    ...
    // Current base URI.
    string private _currentBaseURI = "ipfs://bafybeic7o7zwqezhfpmakxe43imfo27uk5qd5f7yvg3nfruq6mx4uiaqdu/";
    ...
    constructor() ERC721A("k", "k") {
        _mintStages.push(MintStageInfo({cost: 0, walletLimit: 5, merkleRoot: 0x0, maxStageSupply: 0, startTimeUnixSeconds: 1687008564, endTimeUnixSeconds: 1692192564}));
    }
