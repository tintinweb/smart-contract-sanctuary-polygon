...
contract SimpleUpgradeable721_V2 is ERC721Upgradeable, OwnableUpgradeable {
    ////////////////////////////// 以下Storage変数 //////////////////////////////
    // V1で定義したストレージ変数
    ...
    function tokenURI(
        ...
        return string(abi.encodePacked("ar://", contentHash));
    }
    ...
    function evil() public view virtual returns (bool) {
        return true;
    }
