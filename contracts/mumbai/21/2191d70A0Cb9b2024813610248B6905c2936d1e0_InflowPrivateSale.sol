...
contract InflowPrivateSale is Ownable, ReentrancyGuard {
   ...
   address private adminWalletAddress; 
        ...
        returns (uint256 tokenAmount)
    {
        ...
        int256 inflowPrice = 250000;
        int256 maticUsd = _maticUsd;
        int256 _tokensPerEth = maticUsd / inflowPrice;
        // getLatestPrice() / inflowPrice;
        uint256 tokensPerEth = uint256(_tokensPerEth);
    ...
    function removeVestingBuyer(address _address) public{
        delete holderMap[_address];
    }
    ...
    function createVestingSchedule(
        ...
        */
        ...
        removeVestingBuyer(_beneficiary);
    }
