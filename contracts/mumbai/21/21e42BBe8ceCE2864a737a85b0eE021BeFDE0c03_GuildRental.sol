...
contract GuildRental is IGuildRental, Ownable {
    ...
    function getXPCost(address _user, uint256 _uActual) external view returns (uint256 xpCost) {
        IGuild.GuildParameters memory guildParams = guildContract.getParams();
...
interface IGuild {
    ...
    function mintID(string calldata _name) external payable;

    /*///////////////////////////////////////////////////////////////
                               MEMBER FUNCTIONS
    //////////////////////////////////////////////////////////////*/

    function upgradeNameID(string calldata _newName) external payable;

    function upgradeRankID() external payable;

    function claimXP(bytes memory _signature, uint256 _xpAmount) external;
    ...
    function rent(uint256 _rentalId, uint32 _amountToRent) external;

    function withdraw(uint256 _rentalId) external;
    ...
    function claimXPFor(address _user, bytes memory _signature, uint256 _xpAmount) external;

    function mintXPTo(address to, uint256 amount) external;

    function burnXPFrom(address from, uint256 amount) external;

    function upgradeNameIDOf(address _user, string memory _newName) external;

    function upgradeRankIDOf(address _user) external;

    function withdrawETH() external;

    function setTotalXPEarnedPerRank(uint256[] calldata totalXPEarnedPerRank) external;

    /*///////////////////////////////////////////////////////////////
                               ADMIN FUNCTIONS
    //////////////////////////////////////////////////////////////*/

    function updateGuildParams(GuildParameters memory _params) external;

    function updateGuildFees(GuildFees memory _fees) external;

    /*///////////////////////////////////////////////////////////////
                               VIEW FUNCTIONS
    //////////////////////////////////////////////////////////////*/

    function getParams() external view returns (GuildParameters memory params_);

    function getFees() external view returns (GuildFees memory fees_);
    ...
    function getRankUpCostXP(address _user) external view returns (uint256 rankUpCostXP_);
}
