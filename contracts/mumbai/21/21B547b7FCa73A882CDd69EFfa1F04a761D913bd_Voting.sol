...
//    uint numberOfVoters;
    ...
    constructor(ElectionInfo memory _info, address _owner ){
        info = ElectionInfo(_info.name, _info.year, _info.stateElections, _info.nationalElections);
        owner = _owner;
    }
...
// setter
    ...
    //         voterInfoMapping[_voters[i]] = VoterInfo(false);
    ...
    function castVote(uint _candidateId) public {
        ...
        voterAddressList.push(msg.sender);
