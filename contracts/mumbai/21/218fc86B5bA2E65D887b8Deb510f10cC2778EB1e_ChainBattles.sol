...
contract ChainBattles is ERC721URIStorage {
	...
	function generateCharacter(uint256 tokenId) public view returns (string memory) {
		...
		bytes memory svg = abi.encodePacked(
			'<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350">',
				...
				'<text x="50%" y="50%" class="base" dominant-baseline="middle" text-anchor="middle">Levels: ', profile.level, '</text>',
				'<text x="50%" y="50%" class="base" dominant-baseline="middle" text-anchor="middle">Speed: ', profile.speed, '</text>',
				'<text x="50%" y="50%" class="base" dominant-baseline="middle" text-anchor="middle">Strength: ', profile.strength, '</text>',
			'</svg>'
		);
	...
	function mint() public {
		...
		tokenIdToLevels[newItemId] = CharacterProfile(0,0,0);
