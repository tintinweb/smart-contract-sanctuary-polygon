...
contract SigmaSheepSociety is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI, address _fundWallet) ERC721("Sigma Sheep Society", "SSS")  {
    ...
    function MINT(uint256 num) public payable {
        ...
        require( supply + num <= _limit - _reserved,   "Exceeds maximum supply" );
