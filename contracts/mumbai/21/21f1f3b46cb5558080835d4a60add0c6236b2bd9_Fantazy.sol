 ...
 */
 ...
 contract Fantazy is Ownable, ReentrancyGuard{
    ...
    function Joinevent(
        ...
        uint256 limit = poollimit[eventID][currentpoolId];
        address[] memory pimp = pools[pool].userarray;
...
///////////////////
    ...
    function getCommissionusdt(uint256 poolid) public view returns(uint256){
        //address[] memory me = pools[poolid].userarray;
        uint me = usdtcount[poolid];
        return me.mul(pools[poolid].entryfee)
                        .mul(commission1)
                        .div(1000);
    }
