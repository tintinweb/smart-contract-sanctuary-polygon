        ...
        for (uint i=0; i < msgIDs.length; i++) {
            ...
            if (msgMapMap[thisBucketKey][msgIDs[i]]){
                ...
                if (validPost){
                    ...
                    thisData[13] = thisMsgData.msgStats.tipERC20Amount;
                    thisData[14] = thisMsgData.commentID;

                    // Get the formatted message
                    allData[i] = MessageFormat.buildMsg(thisData, thisMsgData.message, thisMsgData.postedBy, thisMsgData.hashtags, thisMsgData.taggedAccounts, thisMsgData.uri, thisMsgData.inGroups, thisMsgData.msgStats.tipContract);
                }
            }
        }
