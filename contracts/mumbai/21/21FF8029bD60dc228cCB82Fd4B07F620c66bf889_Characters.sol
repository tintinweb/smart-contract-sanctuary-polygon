                ...
                Base64.encode(
                    bytes(
                        abi.encodePacked(
                            ...
                            '", "attributes": [',
                            '{"trait_type": "character_class", "value": "', uri_details.name,'"}, {"trait_type": "strength", "value": "',  Strings.toString(character_props.str),'"}, {"trait_type": "vitality", "value": "', abi.encodePacked(character_props.vit),'"}, {"trait_type": "dexterity", "value": "',  Strings.toString(character_props.dex),'"}, ',
                            '{"trait_type": "experience", "value": "', Strings.toString(character_props.exp),'"}, {"trait_type": "element", "value": "', CharacterLibrary.getElement(character_props.element),'"}, {"display_type": "boost_percentage", "trait_type": "',CharacterLibrary.getTalent(character_props.talent),'", "value": 10}, {"trait_type": "mood", "value": "',uri_details.mood,'"}',
                            ']}'
                        )
                    )
                )
