...
contract MintRequests is Initializable, ReentrancyGuardUpgradeable, PausableUpgradeable, EIP712Upgradeable {
    ...
    */
        ...
        returns (uint256 requestID)
    {
        ...
        console.log(signer);
        require(IWhitelist(addressRegistry.whitelistContract()).hasRoleAdmin(signer), "not an admin");
        _submitRequest(
            voucher.isMultiToken,
            voucher.deployAndMint,
            true,
            voucher.existingAddress,
            voucher.recipient,
            voucher.owner,
            voucher.tokenUri1155,
            voucher.name,
            voucher.symbol,
            voucher.tokenUri,
            voucher.supply
    ...
    /**
    @notice Method for submitting a request (INTERNAL)
    */
    ...
    /**
    @notice Method overloaded
    @notice Method for submitting a request (INTERNAL)

    //TODO: To be removed after integrating royalties
    */
    function _submitRequest(
        ...
        emit RequestSubmitted(
            ...
            _request.supply,
            _request.expirationDate,
            0x0000000000000000000000000000000000000000, // to be replaced
            1 // to be replaced
        );
    }
    ...
    */
    function updateRequest(
        ...
        require(
            _request.owner == msg.sender || IWhitelist(addressRegistry.whitelistContract()).hasRoleAdmin(msg.sender),
    ...
    */
    ...
    function getRequests(uint256 _index) external view returns (Requests memory) {
