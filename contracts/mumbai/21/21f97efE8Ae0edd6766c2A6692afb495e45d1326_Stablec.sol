...
contract Stablec is ERC20, ERC20Burnable, MultiSign {

    constructor(address[] memory signers) ERC20("Stablec", "STB") MultiSign(signers) {

    }

    function mint(address to, uint256 amount) public {
        bytes32 functionHash = keccak256("mint");
        signFunction(functionHash, true, keccak256(abi.encodePacked(to, amount)));
