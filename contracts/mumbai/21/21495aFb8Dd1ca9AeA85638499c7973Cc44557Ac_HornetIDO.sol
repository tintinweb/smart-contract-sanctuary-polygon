...
contract HornetIDO is Ownable, ReentrancyGuard, PaymentSplitter, LogisticVRGDA {
    ...
    constructor (
        ...
        LogisticVRGDA (
            ...
            toWadUnsafe(_maxSale), // Max gobblers mintable via VRGDA.
    ...
    nonReentrant {
        /// safety check
        require(currentSale + allocation <= maxSale, "HORNET IDO : IDO is sold out");
        ...
        /// safety check
        require(msg.value == (hornetPrice()*allocation), "HORNET IDO : Wrong price");
    ...
    function hornetPrice() public view returns (uint256) {
        ...
        return getVRGDAPrice(toDaysWadUnsafe(timeSinceStart), currentSale);
    }
