...
import "../access/MarketplaceAccess721IPFS.sol";
...
contract RecipientsUniqueDrop is
    Ownable,
    ReentrancyGuard,
    DropRole,
    MarketplaceAccess721IPFS
{
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(MarketplaceAccess721IPFS, AccessControl)
        returns (bool)
    {
...
/// @author Amit Molek
/// @dev This contract overrides the setApprovalForAll for ERC721IPFS
/// to only allow access for permitted marketplaces/operators
abstract contract MarketplaceAccess721IPFS is
    ERC721IPFS,
