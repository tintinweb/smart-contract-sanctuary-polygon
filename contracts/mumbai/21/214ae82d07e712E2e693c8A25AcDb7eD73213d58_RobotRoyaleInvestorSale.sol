...
contract RobotRoyaleInvestorSale is ERC721Holder, Ownable {
    ...
    function purchase(uint _amount) public payable {
        // require money sent equal or greater than price of amount of NFTs ordered, refund superflous amount
        // get balanceof contract, enumerate according to purchase amount and transfer
