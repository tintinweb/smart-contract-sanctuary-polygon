...
contract LittleHaitiNFT is Ownable, ERC721Pausable {
    ...
    address public littleHaitiAddress;
    ...
    constructor(string memory _defaultURI) ERC721("LittleHaiti", "LHT") {
        defaultURI = _defaultURI;
        treasuryAddress = msg.sender;
        littleHaitiAddress = msg.sender;
    ...
    function setLittleHaiti(address _littleHaitiAddress) public onlyOwnerOrManager{
        littleHaitiAddress = _littleHaitiAddress;
    }
    ...
    function withdraw() public onlyOwner {
        ...
        require(littleHaitiAddress != address(0),"Little Haiti Address is NULL");
        (bool sent1, ) = treasuryAddress.call{value: address(this).balance * 10000 /100000}("");
        (bool sent2, ) = littleHaitiAddress.call{value: address(this).balance}("");
        require(sent1, "Failed to withdraw for Treasury");
        require(sent2, "Failed to withdraw for Little Haiti");
    }
