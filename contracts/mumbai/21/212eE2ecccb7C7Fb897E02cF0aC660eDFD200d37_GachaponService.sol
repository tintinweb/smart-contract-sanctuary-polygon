    ...
    ERC1155HolderUpgradeable
{
    ...
    function removeGachaponItems(
        ...
        gacha.gachaIdxActualSize--;
        _removeGachaponIndex(gacha, _gachaIdx);
     ...
     * @param _itemsList - array of set of gachapon item.
     */
    function verifyAndAddItems(Gacha storage _gacha, Item[][] memory _itemsList)
        internal
    {
    ...
    function _removeGachaponIndex(Gacha storage _gacha, uint256 _gachaIdx) internal {
        _gacha.itemsIdByGachaIdx[_gachaIdx] = _gacha.itemsIdByGachaIdx[
            _gacha.gachaIdxCurrentSize - 1
        ];
