...
contract ERC721Staking is ReentrancyGuard {
   ...
   mapping(address => Staker) public stakers;
    ...
    // value of now.
    function stake(uint256 _tokenId, uint256 _stakeOption) external nonReentrant {
        ...
        // Create StakedToken
        StakedToken memory stakedToken = StakedToken(msg.sender, _tokenId, block.timestamp, _stakeOption);
    ...
    function withdraw(uint256 _tokenId) external nonReentrant {
        ...
        require(hasFulfilledStake(stakers[msg.sender].stakedTokens[index]), "You must unstake, not withdraw");
    ...
    function unstake(uint256 _tokenId) external nonReentrant {
        ...
        require(!hasFulfilledStake(stakers[msg.sender].stakedTokens[index]), "You must withdraw, not unstake");
    ...
    function checkTokenType(uint256 _tokenId) internal pure returns (string memory) {
