    ...
    IMilestoneTracker
{
    ...
    function setupTokens() external onlyOwner {
        ...
        tokenMultipliers[EnergyConstants.CWATT] = MAX_BPS;
        tokenMultipliers[EnergyConstants.XWATT] = MAX_BPS;
        tokenMultipliers[EnergyConstants.LWATT] = MAX_BPS;
        tokenMultipliers[EnergyConstants.NWATT] = MAX_BPS;
        tokenMultipliers[EnergyConstants.PWATT] = MAX_BPS;
        tokenMultipliers[EnergyConstants.SWATT] = MAX_BPS;
        tokenMultipliers[EnergyConstants.VWATT] = MAX_BPS;
    }
    ...
    function lastMilestoneUnlocked(address account) external view returns (uint256) {
