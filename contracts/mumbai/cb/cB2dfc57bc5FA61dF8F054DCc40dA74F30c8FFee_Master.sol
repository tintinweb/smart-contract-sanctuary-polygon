...
import "./WhiskyNFT.sol";

pragma solidity 0.7.6;
pragma experimental ABIEncoderV2;

contract Master is Initializable {
    ...
    address payable public whiskyTreasury;
    ...
    function createCollection(
        ...
        bytes memory bytecode = type(WhiskyNFT).creationCode;
        ...
        WhiskyNFT(collection).initialize(whiskyTreasury, _name, _name, "https://ipfs.io/ipfs/");
...
abstract contract WhiskyTreasuryNode is Initializable {
     ...
     */
    function _initializeWhiskyTreasuryNode(
...
/**
 * @notice Holds a reference to the Whisky Market and communicates fees to 3rd party marketplaces.
 */
    ...
    NFT721Creator
{
        ...
        )
    {
        ...
        recipients[0] = getWhiskyTreasury();
    ...
    WhiskyAdminRole
{
    ...
    /**
     * @notice Allows a creator to mint an NFT and set approval for the Whisky marketplace.
    ...
    /**
     * @notice Allows a creator to mint an NFT and have creator revenue/royalties sent to an alternate address.
     * Also sets approval for the Whisky marketplace.  This can be used by creators the first time they mint an NFT to
...
/**
 * @title Whisky NFTs implemented using the ERC-721 standard.
 * @dev This top level file holds no data directly to ease future upgrades.
 */
contract WhiskyNFT is
    WhiskyTreasuryNode,
    ERC165Upgradeable,
    HasSecondarySaleFees,
    ERC721Upgradeable,
    ...
    NFT721Mint
{
    ...
    // /**
    //  * @notice Allows a Whisky admin to update NFT config variables.
