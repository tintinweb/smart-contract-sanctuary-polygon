...
import {
    TrufinThetaVaultStorage
} from "../../storage/TrufinThetaVaultStorage.sol";
...
abstract contract TrufinThetaVaultStorage {
    ...
    /**
     * @dev LiquidityGauge contract for the vault
     */
...
// SPDX-License-Identifier: MIT
// Source: https://github.com/curvefi/curve-dao-contracts/blob/
// 3156684fd7ca424ec4c56b2c8d898b77afa78496/contracts/gauges/LiquidityGaugeV4.vy
pragma solidity =0.8.4;
...
interface ILiquidityGauge {
    ...
    * @dev Depositting also claims pending reward tokens by default
    * @param _value Number of tokens to deposit
    * @param _addr Address to deposit for
    * @param _claim_rewards Flag to claim pending rewards in the same call
    */
    function deposit(
        uint256 _value,
        address _addr,
    ...
    ERC20Upgradeable
{
    ...
    function baseInitialize(
        ...
        Vault.VaultParams calldata _vaultParams
    ) internal /*initializer*/ { //modifier /*initializer*/ shouldn't call twice, but this contract is 
