    ...
    EIP712Upgradeable
{
    ...
    /// @inheritdoc IERC1155StoreGeneric
    function buyTokens(
        BuyTokenInputs calldata saleInputs,
        address _currency,
        bool _optInBonuses,
    ...
    function onPaper(
        ...
        bytes32 _nonce,
        bytes calldata _signature
    ) external onlyPaper(keccak256(abi.encode(saleInputs)), _nonce, _signature) {
...
interface IERC1155StoreGeneric {
     ...
     */
    function buyTokens(
        BuyTokenInputs calldata inputs,
        address _currency,
        bool _optInBonuses,
        bool _optInCategories
    ) external payable;
     ...
     */
    function onPaper(
        BuyTokenInputs calldata _paperInputs,
        bytes32 _nonce,
        bytes calldata _signature
    ) external;
