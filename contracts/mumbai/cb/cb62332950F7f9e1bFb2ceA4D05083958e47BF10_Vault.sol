...
contract Vault is Initializable, OwnableUpgradeable {
    ...
    function privateBuy(
        ...
        require(usdAmount > 0, "USD Amount should not be 0");
        ...
        uint256 rxbAmount = (usdAmount * 10 ** _rxbToken.decimals()) /
            _rxbToken.price();
    ...
    function withdraw(address usdToken, uint256 amount) external onlyOwner {
        ...
        IERC20Upgradeable(usdToken).transfer(owner(), amount);
