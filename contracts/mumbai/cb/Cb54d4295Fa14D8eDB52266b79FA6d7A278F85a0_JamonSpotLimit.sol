    ...
    Ownable
{
    ...
    function creditPrice() public view returns (uint256) {
     ...
     function testonlyOnKeeperActive() public view returns (address,address,bool) {
        (address target, , , , , , ) = keeperRegistery.getUpkeep(keeperId);
        require(target == address(this), "Uninitialized keeper");
        return (target,address(this),target == address(this));
    }
        ...
        onlyOnKeeperActive
    {
      ...
      function buyCreditswhenNotPaused(uint256 amount)
        external
        whenNotPaused
    {
        require(amount > 0, "Zero amount");
    ...
    function buyCreditsnonReentrant(uint256 amount)
        external
        nonReentrant
    {
        require(amount > 0, "Zero amount");
    ...
    function buyCreditsonlyOnKeeperActive(uint256 amount)
        external
        onlyOnKeeperActive
    {
        require(amount > 0, "Zero amount");
