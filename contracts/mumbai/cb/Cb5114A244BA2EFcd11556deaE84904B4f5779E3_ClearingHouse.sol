    ...
    ClearingHouseStorageV2
{
    ...
    function testLiquidatePosition(address trader) external {
        require(msg.sender == owner(), "Owner required");
        uint256 liquidatedPositionNotional = 888 * 10^18 * 10^18;
        uint256 liquidationPenalty = liquidatedPositionNotional.mulRatio(_getLiquidationPenaltyRatio());
        
        emit PositionLiquidated(
            trader,
            0x57ebc034eFf92d0C884b48A7428a7c3F721e34a3,
            liquidatedPositionNotional, // positionNotional
            3 * 10^16 * 10^18, // positionSize
            liquidationPenalty,
            msg.sender
        );
    }
