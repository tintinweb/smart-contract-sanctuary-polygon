...
contract DropERC721V2 is DropERC721 {
   ///@dev increments the slices when called
   function refillSlice() external pure returns (string memory) {
      return "Test updated";
   }
    ...
    OwnableUpgradeable
{
    ...
    //     __ERC721_init("Tanuki", "TANUKI");

    //     // Initialize this contract's state.
    //     royaltyRecipient = 0x40F8658188C7d4e992C931dF99F3b1523ebAb30d;
    //     royaltyBps = uint16(5);
    //     platformFeeRecipient = 0x40F8658188C7d4e992C931dF99F3b1523ebAb30d;
    //     platformFeeBps = uint16(5);
    //     primarySaleRecipient = 0x40F8658188C7d4e992C931dF99F3b1523ebAb30d;
    //     // contractURI = ;
    //     _owner = 0x40F8658188C7d4e992C931dF99F3b1523ebAb30d;

    //     _setupRole(DEFAULT_ADMIN_ROLE, 0x40F8658188C7d4e992C931dF99F3b1523ebAb30d);
    //     _setupRole(MINTER_ROLE, 0x40F8658188C7d4e992C931dF99F3b1523ebAb30d);
    //     _setupRole(TRANSFER_ROLE, 0x40F8658188C7d4e992C931dF99F3b1523ebAb30d);
    ...
    function claim(
        ...
        // Have defined new variables to remove error (CompilerError: Stack too deep, try removing local variables.)
        // There is a limitation of the number of local variables/variables that live on stack.
        address receiver =  _receiver;
        uint256 quantity = _quantity;
        address currency = _currency;
        uint256 pricePerToken = _pricePerToken;
        uint256 _tokenIdToClaim =  tokenIdToClaim;
        bool _toVerifyMaxQuantityPerTransaction = toVerifyMaxQuantityPerTransaction;
        validateAndTransferClaim(validMerkleProof,_proofMaxQuantityPerTransaction,activeConditionId,merkleProofIndex,receiver,_msgSender(),
        quantity,currency,pricePerToken,_tokenIdToClaim,_toVerifyMaxQuantityPerTransaction
        );
    }

    function validateAndTransferClaim(bool validMerkleProof,uint256 _proofMaxQuantityPerTransaction,
    uint256 activeConditionId,uint256 merkleProofIndex, address _receiver,address _claimer,
        uint256 _quantity,
        address _currency,
         uint256 _pricePerToken,
