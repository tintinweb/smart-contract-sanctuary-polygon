...
//   / ___/____  ____ _      __/ __/ /___ _/ /____/__  /
//   \__ \/ __ \/ __ \ | /| / / /_/ / __ `/ //_/ _ \/ / 
//  ___/ / / / / /_/ / |/ |/ / __/ / /_/ / ,< /  __/ /__
// /____/_/ /_/\____/|__/|__/_/ /_/\__,_/_/|_|\___/____/
//                                                      
//
//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x31073cdcdC04119451f89a9d9B37D08B5eC5CcBe];
  address public erc20Payable = 0x31073cdcdC04119451f89a9d9B37D08B5eC5CcBe;
...
abstract contract Feeable is Teams {
  uint256 public PRICE = 5.55 ether;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeicfhr5untusrdb3rkd6puquhrvaua4ctell6vmtjemskwknv4ruay/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/gTyiu5ABwgKTI0MtMhu9/contract-metadata";
  }
...
// File: contracts/NuclearSnowflakeZContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NuclearSnowflakeZContract is ERC721APlus {
    constructor() ERC721APlus("Nuclear SnowflakeZ", "NSNOW"){}
}
  /*******************************************************/
  /*                                                     */
