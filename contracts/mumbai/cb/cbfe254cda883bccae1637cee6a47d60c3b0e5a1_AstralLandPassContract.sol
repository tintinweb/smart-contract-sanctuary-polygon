...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x92667C8Aa16519aff1b68757020B013E9AB06305];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 4, 1111 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://ipfs.io/ipfs/QmNapHrtmk4ZvMVPJMjP48uhyDbqya4aAjmQYzbuVSUE6u/";
...
// File: contracts/AstralLandPassContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AstralLandPassContract is RamppERC721A {
    constructor() RamppERC721A("Astral Land Pass", "ALP"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/NGgOdURZsnoP76OJFgTC/contract-metadata";
    }
}
