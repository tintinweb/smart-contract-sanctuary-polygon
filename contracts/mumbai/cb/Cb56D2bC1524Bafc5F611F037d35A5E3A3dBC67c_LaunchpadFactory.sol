...
contract LaunchpadFactory is OwnableUpgradeable, CloneBase {
    ...
    event ImplementationAdded(uint256 _id, address _newImplementation);
    ...
    // Upgradable initialzer function
    ...
    /**
     * It is used to create tokensale based on implementation id using
     * minial proxy pattern.
     *
     * @param _id Implementation id.
     * @param _implementationData Encoded data.
     */
    function _launchCrowdsale(uint256 _id, bytes memory _implementationData)
        internal
        returns (address)
    {
        ...
        require(address(projectToken) != address(0), "Cant be Zero address");
    ...
    /**
     * It is used to launch crowdsale.
     *
     * @param _id Implementation id.
     * @param _implementationData Encoded data.
     * @param _feeManagerEncodedData Encoded data.
    ...
    function launchCrowdsale(
        ...
        address crowdSaleAddress = _launchCrowdsale(_id, _implementationData);
        _handleFeeManager(_id, _feeManagerEncodedData);
        return crowdSaleAddress;
    }

    /**
     * It is used to launch crowdsale with referral info.
     *
     * @param _id Implementation id.
     ...
     *
     * @return Address of new crowdsale.
     */
