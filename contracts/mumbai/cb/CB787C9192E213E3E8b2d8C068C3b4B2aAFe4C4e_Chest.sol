...
contract Chest is ERC721, VRFConsumerBaseV2 {
  ...
  uint32 numWords = 3; // We need 3 radnom number for lat, long and tier
  ...
  constructor() VRFConsumerBaseV2(vrfCoordinator) ERC721('ShizoChest', 'ShizoChest') {
  ...
  function fulfillRandomWords(
    ...
    tiers[nextTokenId.current()] = (randomWords[2] % (_maxTier - _minTier + 1)) + _minTier;
  }
