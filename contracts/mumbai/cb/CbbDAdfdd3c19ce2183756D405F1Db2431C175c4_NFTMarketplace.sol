...
contract NFTMarketplace is Context, Ownable, Pausable, ReentrancyGuard {
    ...
    address private DistantCollections;
    ...
    */
    ...
    function addProtocol(address _protocol, string calldata _name, uint8 _protocolFee, uint8 _securityFee) external onlyOwner {
    ...
    */
    ...
    function isDistantCollection(address _address) external view returns (bool){
        return _address == DistantCollections;
    }
}