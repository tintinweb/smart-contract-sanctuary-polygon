...
contract Vault1155ERM is ERC20("", ""), IERC1155Receiver {
    ...
    uint256 private constant S_NOT_INITIALIZED = 0;
    ...
    function initialize(
        ...
        require(_status == S_NOT_INITIALIZED, "Already initialized");

        // Configure ERC20. Requires both of these to be 'internal' not 'private'.
        _name = name;
        _symbol = symbol;
