  ...
  ReentrancyGuard
{
  ...
  uint32 private callbackGasLimit = 2000000;
  ...
  constructor(
    ...
    VRFConsumerBaseV2(0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266)
  ...
  function addCardType(uint256 _cardType, Library.Rarity _rarity) public {
    ...
    if (_rarity == Library.Rarity.Basic) {
      basicCardTypes.push(_cardType);
    } else if (_rarity == Library.Rarity.Common) {
      commonCardTypes.push(_cardType);
    } else if (_rarity == Library.Rarity.Uncommon) {
      uncommonCardTypes.push(_cardType);
    } else if (_rarity == Library.Rarity.Rare) {
      rareCardTypes.push(_cardType);
    } else if (_rarity == Library.Rarity.Epic) {
      epicCardTypes.push(_cardType);
    } else if (_rarity == Library.Rarity.Legendary) {
      legendaryCardTypes.push(_cardType);
    }
  }
  ...
  function finishOpenFP() public nonReentrant {
    ...
    NftInterface(adventurersAddress).adminMint(
      msg.sender,
      randomWords[1] % NftInterface(adventurersAddress).totalTypes(),
      1,
      1
    );
