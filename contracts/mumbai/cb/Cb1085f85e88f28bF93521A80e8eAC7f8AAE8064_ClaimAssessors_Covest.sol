...
contract ClaimAssessors_Covest is Initializable, UUPSUpgradeable, ReentrancyGuardUpgradeable {
	...
	function isClaimAssessors(address _user) public view returns (bool) {
		IStaking.StakingData memory _StakingData = S.stakingData(_user, IStaking.StakingTypes.CA);
		IStaking.WorkType memory _dataType = S.workData(IStaking.StakingTypes.CA);
	...
	function withdraw(
		...
		require(PDS.isBlacklistUser(_worker) != true, "Policy: This _user are Blacklist.");
		require(PDS.isBlacklistAssetsUser(_worker, _asset) != true, "Policy: This Assets of you are Blacklist.");
