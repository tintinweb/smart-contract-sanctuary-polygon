...
contract ERC721Royalties is ERC721Royalty, ERC721Enumerable, ERC721Pausable, Ownable {
    ...
    address payable constant royaltyReciver = payable(0x7e29AaF8Ee81347C9a49F7BEDb9D6927a89C8B23);

    // set address of royalty reciver
    address payable constant nftHolder = payable(0x7e29AaF8Ee81347C9a49F7BEDb9D6927a89C8B23);
    ...
    function _mintSingleNFT() private {
        ...
        _safeMint(nftHolder, newTokenID);
        _tokenIds.increment();
    }
    ...
    //set max supply of the NFTs to make it varibale
