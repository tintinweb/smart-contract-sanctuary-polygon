 ...
 * `ERC20` functions.
 */
contract TestToken is Context, ERC20, ERC20Detailed {

    /**
     * @dev Constructor that gives _msgSender() all of existing tokens.
     */
    string tokenName = "TestToken";
    string tokenTicker = "ATTkn";
    
    event SignalEvent (bool);
    ...
    function GetSomeTokens() external {
        _mint(_msgSender(), 50 * (10 ** uint256(decimals())));
    }
