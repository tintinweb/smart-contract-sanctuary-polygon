 ...
 * @notice This contract handles minting FF4 Armory Vault Keys tokens.
 */
contract FF4ArmoryVaultKeys is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xc6BbaE1dC68D0ff88a7c02Ca39674DbF2608A9cC;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x287Fd38517540f31f9D14771AD39fB799c9cdFb6;
    address[] public payoutAddresses = [
        0x287Fd38517540f31f9D14771AD39fB799c9cdFb6
    ];
    ...
    string public name = "FF4 Armory Vault Keys";
    string public symbol = "FF4 AVK";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeia6zvzwrevetn667xn73v7ndjgvxpyqoefjfad6ojqxxchmuk7374/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[1] = 700;
        tokenPublicPrice[1] = 0 ether;
        tokenPublicMintsPerAddress[1] = 700;
        tokenPresaleMaxSupply[1] = 700;
        tokenPresalePrice[1] = 0 ether;
        tokenPresaleMintsPerAddress[1] = 0;
        tokenMaxSupply[2] = 1198;
        tokenPublicPrice[2] = 0 ether;
        tokenPublicMintsPerAddress[2] = 1198;
        require(
