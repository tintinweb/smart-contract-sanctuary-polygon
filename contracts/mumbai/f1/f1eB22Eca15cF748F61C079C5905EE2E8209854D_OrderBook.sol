...
abstract contract ERC4626 is ERC20 {
    ...
    event Deposit(string name, address indexed caller, address indexed owner, uint256 assets, uint256 shares);
    ...
    function deposit(uint256 assets, address receiver) public virtual returns (uint256 shares) {
        ...
        emit Deposit("Deposit", msg.sender, receiver, assets, shares);
