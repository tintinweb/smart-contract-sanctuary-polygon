 ...
 * @notice This contract handles minting Passarinho que som é esse tokens.
 */
contract PassarinhoQueSomEEsse is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x6c991dA45e95114deD17021A16D4c22184798eeB;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x65fd434112567D3B7Ea7e10d1F6AA1EDB8BC2806;
    ...
    string public name = "Passarinho que som  esse";
    string public symbol = "PSQ";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeigirtm6xhvdqczvif3fyb7f7igyobkg3xzsh6522lajdu5q2bna24/{id}"
        )
        RevokableOperatorFilterer(
