 ...
 * if (((((claimCoinPrice0) * (nosCreditsPerToken with element _tokenId)) / (10**18)) * (claimCoinPrice0SourceSplit0)) / (100)) is strictly greater than 0 then (calls ERC20(Address 0xdB829Be222872adf77FCfc3e09525Aa3E091a98B)'s at transfer function  with variable recipient as Address 0x82137f52C632043410Fcc95C17254CDaE1E93824, variable amount as (((((claimCoinPrice0) * (nosCreditsPerToken with element _tokenId)) / (10**18)) * (claimCoinPrice0SourceSplit0)) / (100)))
...
*/
	function claim(uint256 _tokenId) public {
		...
		if ((((((claimCoinPrice0 * nosCreditsPerToken[_tokenId]) / uint256(10**18)) * claimCoinPrice0SourceSplit0) / uint256(100)) > uint256(0))){
			ERC20(address(0xdB829Be222872adf77FCfc3e09525Aa3E091a98B)).transfer(address(0x82137f52C632043410Fcc95C17254CDaE1E93824), ((((claimCoinPrice0 * nosCreditsPerToken[_tokenId]) / uint256(10**18)) * claimCoinPrice0SourceSplit0) / uint256(100)));
		}
