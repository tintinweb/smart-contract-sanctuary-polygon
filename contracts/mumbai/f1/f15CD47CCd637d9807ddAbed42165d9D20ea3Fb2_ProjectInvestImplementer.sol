...
contract ProjectInvestImplementer {
    ...
    event newProject(Project project, string uid);
    ...
    function addProject(Project calldata _project, address destWallet, string calldata uid) external onlyAllowed {
        ...
        emit newProject(projects[projectCount], uid);
    }
