...
//.....................................................................................Reward Income.......................................
        ...
        if(silver_Referral[msg.sender].TeamIncome >= 2500000 ether && silver_Referral[msg.sender].Userincome >= 50000)
        {
            ...
            Wallet[msg.sender] += 100000 ether;
        }
...
//............................................................................................Sponsor used..................................
    function withdraw_Wallet_Amount(uint256 _amount) external
    {
        ...
        Wallet[msg.sender].sub(_amount); 
        User[_msgSender()].amount_Pool_B.sub(_amount);
    }
