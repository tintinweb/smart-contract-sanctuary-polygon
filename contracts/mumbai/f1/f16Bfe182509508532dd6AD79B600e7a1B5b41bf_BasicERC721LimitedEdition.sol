...
interface IBasicERC721LimitedEdition is
    Royalty,
    IERC721Upgradeable
{
    /**
    ...
    IBasicERC721LimitedEdition
{
    ...
    /// @dev The maxamium of tokens supplied.
    ...
    function initialize(
        ...
        __EIP712_init("BasicERC721LimitedEdition", "1");
    ...
    function getInfo() external view returns (string memory, string memory, uint256) {
        return (name(), "TokenERC721", initialDate);
    }
    ...
    {
        // require(tokenIdMinted < maxSupply, "Exceed Maximum Supply");
    ...
    /// @dev Lets a module admin set the maxSupply for contract-level.
