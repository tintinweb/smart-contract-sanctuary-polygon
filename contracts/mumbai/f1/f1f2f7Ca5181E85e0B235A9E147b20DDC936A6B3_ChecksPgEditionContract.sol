...
//*********************************************************************//
//
//    ________              __                    ____  ______   ______    ___ __  _           
//   / ____/ /_  ___  _____/ /_______            / __ \/ ____/  / ____/___/ (_) /_(_)___  ____ 
//  / /   / __ \/ _ \/ ___/ //_/ ___/  ______   / /_/ / / __   / __/ / __  / / __/ / __ \/ __ \
// / /___/ / / /  __/ /__/ ,< (__  )  /_____/  / ____/ /_/ /  / /___/ /_/ / / /_/ / /_/ / / / /
// \____/_/ /_/\___/\___/_/|_/____/           /_/    \____/  /_____/\__,_/_/\__/_/\____/_/ /_/ 
//                                                                                             
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1675665000;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xa7FD3A9219f8Fa35572022D7609526Cb158B5B6C,0x9A301aD0E995AEa11D59b9CE3f9D339Bec6FB906,0x8e552d5135Fe6B2449796e11Cc4a5c63AAd2ba58,0x8de6c283f8E221b854b1F41Eea842E9be96B644e,0x004e3787633031DDDB2fB0c67b2D1b71FD684832];
  address public erc20Payable = 0xa7FD3A9219f8Fa35572022D7609526Cb158B5B6C;
  uint256[] public payableFees = [20,20,20,20,20];
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 500, 20202) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmdDkhdGgw1CAZuxuSwbPjxmnSeEqtLuiafYumw5MmVcWH/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/YjCV3xtXXK4JZRevgzoa/contract-metadata";
  }
...
// File: contracts/ChecksPgEditionContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ChecksPgEditionContract is ERC721APlus {
    constructor() ERC721APlus("Checks  PG Edition", "CPGE"){}
}
