...
// address patient_address;
    struct Script {
        bytes patient_wallet_address;
            ...
            string medication;
            string dob;
    bytes patient_physical_address;
...
// Text message confirmation to patient:
    ...
    function _createScript(
        ...
        string memory _dob,
        bytes memory _patient_physical_address,
                // string memory _quantity,
        uint256 _quantity,
                // uint256 _quantityPrescribed,
                // string memory _npi,
        bytes memory _doctor_name,
        bytes memory _doctor_dea,
    ...
    public returns (uint256) {
        ...
        Script memory _rx = Script({
            ...
            // dateFilled: 0, // string dateFilled;
...
//updated ScriptWritten on 6/9/23 v.12.7 prep, removed address and only using string patient_wallet_string     
        ...
        //     _patient_wallet_address,
        //     _patient_name, //string
        //     _medication, //string
        //     _quantity, //uint256
        //     0,  //quantityFilled uint256
        //     _date_prescribed, // string date
...
// ******** JUST Fill DATES ****************************************************************************************** //
    ...
    function getDoctorInfo(
        ...
        return string(abi.encodePacked("Prescriber: ", getDoctor(tokenId), " - DEA#: ", getDoctorDea(tokenId)));
            // string(abi.encodePacked("Patient: ", rx.patient_wallet, " - DOB: ", rx.dob));        
    }
