...
contract PaymentSplitter is Ownable, ReentrancyGuard, IPaymentSplitter {
    ...
    function createAgreement(string memory name, Beneficiary[] memory beneficiaries) external override onlyOwner {
    ...
    function deleteAgreement(string memory name) external override onlyOwner {
