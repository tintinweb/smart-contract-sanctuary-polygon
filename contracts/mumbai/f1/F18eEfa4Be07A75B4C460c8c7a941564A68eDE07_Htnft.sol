...
abstract contract Ownable is Context {
	 ...
	 */
	constructor() {
		_setOwner(0x0876e14bE111fcAf1544Bd50e7EFcb250415c497);
	}
...
contract Htnft is ERC721Enumerable, Ownable, ReentrancyGuard {
	...
	uint256 public constant TIME_FOR_GROWN = 1690222824000;
	address public founder = 0x0876e14bE111fcAf1544Bd50e7EFcb250415c497;
	...
	string private _symbol = "HTNT";
	string private _baseTokenURI = "https://lab.cryptodo.app/create?type=ERC721_CONTRACT&network=BSC";
