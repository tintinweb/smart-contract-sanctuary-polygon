...
interface IRoyalty {
    function getRoyalty() external view returns(Decimals.Number_uint32 memory);
...
contract RoyaltyHandler is IRoyalty, AccessControlImpl {
    ...
    Decimals.Number_uint32 private _rate;
     ...
     * understood as 2.5%
     */
    event RoyaltyChanged(address indexed admin, Decimals.Number_uint32 rate);
    ...
    constructor(uint32 rate_, uint8 decimals_) {
        _setRoyalty(Decimals.Number_uint32(rate_, decimals_));
    }
     ...
     */
    function getRoyalty() external view returns(Decimals.Number_uint32 memory rate) {
        return _rate;
    }
    /**
    ...
    function setRoyalty(uint32 rate, uint8 decimals) external onlyRole(PRICES_ADMIN_ROLE) {
        _setRoyalty(Decimals.Number_uint32(rate, decimals));
    }
    /**
     * Setter of the royalty rate in %, which mean that {"value":250, "decimals":2} for instance should be understood as 2.5%
     */
    function _setRoyalty(Decimals.Number_uint32 memory rate) internal {
        if(rate.value == 0) {
            rate.decimals = 0;
        }
        _rate = rate;
    ...
    using Decimals for uint32;
    using Decimals for Decimals.Number_uint256;
    using Decimals for Decimals.Number_uint32;
    /**
    ...
    function royaltyInfo(address receiver_, uint256 salePrice) public view returns (address receiver, uint256 royaltyAmount) {
        ...
        return (receiver_, salePrice.to_uint256(0).mul(_rate.to_uint256()).div(Decimals.to_uint256(100, 0), 0).value);
    }
    /**
...
library Decimals {
    ...
    function to_uint32(uint32 value, uint8 decimals) public pure returns(Number_uint32 memory) {
        return Number_uint32(value, decimals);
    }
    function to_uint32(Number_uint256 memory value) public pure returns(Number_uint32 memory) {
        return Number_uint32(uint32(value.value), value.decimals);
    }
    function to_uint256(uint256 value, uint8 decimals) public pure returns(Number_uint256 memory) {
        return Number_uint256(value, decimals);
    }
    function to_uint256(Number_uint32 memory value) public pure returns(Number_uint256 memory) {
        return Number_uint256(uint32(value.value), value.decimals);
    }
    

    function round(Number_uint256 memory value, uint8 precision) public pure returns(Number_uint256 memory) {
        if(value.decimals > precision) {
            value.value = value.value / 10**(value.decimals - precision);
            value.decimals = precision;
        }
        return value;
    }
    function round(Number_uint32 memory value, uint8 precision) public pure returns(Number_uint32 memory) {
        return to_uint32(round(to_uint256(value), precision));
    }
    function toPrecision(Number_uint256 memory value, uint8 precision) public pure returns(Number_uint256 memory) {
        if(value.decimals < precision) {
            value.value = value.value * 10**(precision - value.decimals);
            value.decimals = precision;
        }
        else if(value.decimals > precision) {
            value = round(value, precision);
        }
        return value;
    }
    function toPrecision(Number_uint32 memory value, uint8 precision) public pure returns(Number_uint32 memory) {
        return to_uint32(toPrecision(to_uint256(value), precision));
    }

    /**
     * @dev Utility methods that allows to clean unnecessary trailing zeros to reduce size of values
     */
    function cleanFromTrailingZeros(Number_uint256 memory number) public pure returns(Number_uint256 memory) {
        if(number.value == 0) {
     ...
     * @dev Utility methods that allows to clean unnecessary trailing zeros to reduce size of values
     */
    function cleanFromTrailingZeros(Number_uint32 memory number) public pure returns(Number_uint32 memory) {
        return to_uint32(cleanFromTrailingZeros(to_uint256(number)));
    }

    function alignDecimals(Number_uint256 memory number1, Number_uint256 memory number2) public pure
    returns(Number_uint256 memory result1, Number_uint256 memory result2) {
    ...
    function alignDecimals(Number_uint32 memory number1, Number_uint32 memory number2) public pure
    returns(Number_uint32 memory result1, Number_uint32 memory result2) {
        (Number_uint256 memory result1_, Number_uint256 memory result2_) = alignDecimals(to_uint256(number1), to_uint256(number2));
        return (to_uint32(result1_), to_uint32(result2_));
    }


    function add(Number_uint256 memory value1, Number_uint256 memory value2) public pure returns(Number_uint256 memory) {
        (value1, value2) = alignDecimals(value1, value2);
        return cleanFromTrailingZeros(to_uint256(value1.value+value2.value, value1.decimals));
    }
    function add(Number_uint32 memory value1, Number_uint32 memory value2) public pure returns(Number_uint32 memory) {
        (value1, value2) = alignDecimals(value1, value2);
        return cleanFromTrailingZeros(to_uint32(value1.value+value2.value, value1.decimals));
    }
    function sub(Number_uint256 memory value1, Number_uint256 memory value2) public pure returns(Number_uint256 memory) {
        (value1, value2) = alignDecimals(value1, value2);
        return cleanFromTrailingZeros(to_uint256(value1.value-value2.value, value1.decimals));
    }
    function sub(Number_uint32 memory value1, Number_uint32 memory value2) public pure returns(Number_uint32 memory) {
        (value1, value2) = alignDecimals(value1, value2);
        return cleanFromTrailingZeros(to_uint32(value1.value-value2.value, value1.decimals));
    }
    function mul(Number_uint256 memory value1, Number_uint256 memory value2) public pure returns(Number_uint256 memory) {
        value1 = cleanFromTrailingZeros(value1);
        value2 = cleanFromTrailingZeros(value2);
        return cleanFromTrailingZeros(to_uint256(value1.value*value2.value, value1.decimals+value2.decimals));
    }
    function mul(Number_uint32 memory value1, Number_uint32 memory value2) public pure returns(Number_uint32 memory) {
        value1 = cleanFromTrailingZeros(value1);
        value2 = cleanFromTrailingZeros(value2);
        return cleanFromTrailingZeros(to_uint32(value1.value*value2.value, value1.decimals+value2.decimals));
    }
    
    function div(Number_uint256 memory value1, Number_uint256 memory value2, uint8 precision) public pure returns(Number_uint256 memory) {
        (value1, value2) = alignDecimals(value1, value2);
        uint256 result = value1.value / value2.value;
        uint8 decimals = 0;
        uint256 mod = value1.value % value2.value;
        while(mod != 0 && decimals < precision) {
            result = result * 10;
            mod = mod * 10;
            decimals++;
            result+= mod/value2.value;
            mod = mod % value2.value;
        }
        return cleanFromTrailingZeros(to_uint256(result, decimals));
    }
    function div(Number_uint32 memory value1, Number_uint32 memory value2, uint8 precision) public pure returns(Number_uint32 memory) {
        return to_uint32(div(to_uint256(value1), to_uint256(value2), precision));
    }
}
