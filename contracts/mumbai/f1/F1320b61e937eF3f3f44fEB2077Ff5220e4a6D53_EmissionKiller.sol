...
contract EmissionKiller is IERC20, ERC20, Ownable {
    ...
    IMasterChef public constant chef = IMasterChef(0x76315ffF3518c7A1102527763e6f2fc45a6FD411);
    IERC20 public constant DOOBIE = IERC20(0xb25cF6697E4eCDd1960da585B4B2C7746EA2da03);
    ...
    function claimDOOBIE() public onlyOwner returns (bool) {
        chef.deposit(pid, 0);
        return true;
    }
    ...
    function destroy(uint amount, bool claim) public onlyOwner returns (bool) {
        ...
        DOOBIE.transfer(0x000000000000000000000000000000000000dEaD, amount);
        return true;
    }
    ...
    function destroyAll(bool claim) external onlyOwner returns (bool) {
        ...
        destroy(DOOBIE.balanceOf(address(this)), false);
        return true;
    }
    ...
    function divertAll(address target, bool claim) external onlyOwner returns (bool) {
        ...
        divert(DOOBIE.balanceOf(address(this)), target, false);
        return true;
    }
}
