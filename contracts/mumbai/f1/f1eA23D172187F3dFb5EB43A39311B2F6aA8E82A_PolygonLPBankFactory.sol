...
contract PolygonLPBankFactory is Initializable, PausableUpgradeable, OwnableUpgradeable {
    ...
    mapping(address => mapping(IERC20Upgradeable => address[])) public getLPBanks;
     ...
     */
    function getCreatedLPBanksByToken(address _creator, IERC20Upgradeable _lpToken)
        public
        view
     ...
     */
    function getCreatedLPBanksLengthByToken(address _creator, IERC20Upgradeable _lpToken)
        public
        view
        returns (uint256)
    {
    ...
    function registerLPBank(
        ...
        require(_lpToken != IERC20Upgradeable(address(0)), "LPBankFactory::ZERO_ADDRESS");
        require(
        ...
        bytes memory bytecode = type(PolygonLPBank).creationCode;
