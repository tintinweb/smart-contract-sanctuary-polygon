...
contract EtheremonTrade is EthermonEnum, BasicAccessControl, SafeMathEthermon {
    ...
    //         block.timestamp
    //     );
    //     EventOfferBorrowingItem(msgSender(), _objId, _price, _releaseTime);
    // }
    ...
    //     EventRemoveOfferBorrowingItem(msgSender(), _objId);
    // }
    ...
    //     EventGetBackItem(msgSender(), borrowItem.borrower, _objId);
    // }
