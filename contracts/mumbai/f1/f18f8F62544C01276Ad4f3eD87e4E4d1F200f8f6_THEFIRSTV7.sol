...
contract THEFIRSTV7 is ERC721, ERC721Enumerable, Ownable, AccessControl, ReentrancyGuard {
  ...
  string internal royaltyURI = "https://harti.mypinata.cloud/ipfs/Qmae6nStuZq1iUixVLhHESW7Q2mzy1ZvnSPZhbNqEsLKi5";
  ...
  bytes32 public constant ADMIN = keccak256("MIME-ADMIN");
  bytes32 public constant MINTER = keccak256("MIME-MINTER");
  ...
  function publicMint(address _to, uint256 tokenId, uint256 _mintAmount) public payable {
    require(!locked, "Sorry, this function is locked!");
