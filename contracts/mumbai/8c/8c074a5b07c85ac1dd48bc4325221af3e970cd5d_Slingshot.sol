...
interface ISlingshot is IERC20, IERC165 {
    /**
     * @dev Pauses any token transfer function in the erc20 contract.
     */
    function pause() external;

    /**
     * @dev Unpauses token transfer functions if they are paused.
     */
...
contract Slingshot is ERC20, ERC20Pausable, Adminable, ISlingshot, ERC165 {
    address public immutable treasury;

    constructor(address _treasury) ERC20("Slingshot", "SLING") {
        require(_treasury != address(0), "Slingshot: invalid address");
        treasury = _treasury;
        _mint(_treasury, 5_000_000_000 * 10**18);
    }
