...
contract RandomWinnerGame is VRFConsumerBase, Ownable {
    ...
    /**
    * constructor inhereits a VRFConsumerbase and initiates te values for keyHash, fee and gameStarted
    ...
    * @param vrfKeyHash ID of ublic key against wich randomness is generated    
    */
    ...
    /**
    * startGame starts the game by setting appropiate values for all the variables
    */
    function startGame(uint8 _maxPlayers, uint256 _entryFee) public onlyOwner {
        ...
        gameStarted = true;
        // setup the emtryFee for the game
        entryFee = _entryFee;
        gameId += 1;
     ...
     */
     function joinGame() public payable {
        // Check if a game is already unning
        ...
        // add the sender to te players list
     ...
     * getRandomWinner is called 
     ...
     to start te process of selecting a random winner 
     */
    function getRandomWinner() private returns (bytes32 requestId) {
        // LINK is an internal interface for Link token found within the VRFConsumerBase
        // Here we use the balanceOf method from tat interface to make sure that our
        // contract has enough link so that we can request the VRFConsumerBase
