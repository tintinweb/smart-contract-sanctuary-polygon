...
contract Comic is ERC721, Pausable, Ownable {
    ...
    /**
     * @dev mint comic token to an address
     * Requirements:
     * - Only for Owner.
     */
    ...
    /**
     * @dev approve an asset for an operator
     * Requirements:
     * - not in black list
     */
    function approve(address to, uint256 tokenId) public virtual override notBlacklist{
    ...
    /**
     * @dev locking scam user
     * Requirements:
     * - Only for admin.
     * - admin cannot lock themself
     */
    ...
    function burn(uint256 _tokenId) external {
        ...
        _burn(_tokenId);
        emit burnRecord(_tokenId,  msg.sender);
    }
