...
contract ReniPay is Ownable {
    ...
    function makePayment(address _token, uint256 _amountInUSD) public payable {
        ...
        if (_token != stableCoin && _token != address(0)) {
            ...
            _tokenAmount = requiredTokenAmount(_amountInUSD, _path);
    ...
    function requiredTokenAmount(uint256 _amountInUSD, address[] memory _path) public view returns (uint256 _tokenAmount) {
