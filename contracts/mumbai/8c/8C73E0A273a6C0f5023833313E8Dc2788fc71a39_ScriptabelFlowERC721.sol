...
import "@beehiveinnovation/rain-protocol/contracts/interpreter/deploy/IExpressionDeployerV1.sol";
import "@beehiveinnovation/rain-protocol/contracts/interpreter/run/StandardInterpreter.sol";
import {AllStandardOps} from "@beehiveinnovation/rain-protocol/contracts/interpreter/ops/AllStandardOps.sol";
import {ERC721Upgradeable as ERC721} from "@openzeppelin/contracts-upgradeable/token/ERC721/ERC721Upgradeable.sol";
import "@beehiveinnovation/rain-protocol/contracts/array/LibUint256Array.sol";
import {ReentrancyGuardUpgradeable as ReentrancyGuard} from "@openzeppelin/contracts-upgradeable/security/ReentrancyGuardUpgradeable.sol";
import "@beehiveinnovation/rain-protocol/contracts/flow/libraries/LibFlow.sol";
import "@beehiveinnovation/rain-protocol/contracts/math/FixedPointMath.sol";
import "@beehiveinnovation/rain-protocol/contracts/idempotent/LibIdempotentFlag.sol";
import "@beehiveinnovation/rain-protocol/contracts/flow/FlowCommon.sol";
import "@beehiveinnovation/rain-protocol/contracts/sentinel/LibSentinel.sol";
...
/// @title FlowERC721
contract ScriptabelFlowERC721 is ReentrancyGuard, FlowCommon, ERC721 {
        ...
        returns (string memory)
    {
        ...
        uint256[][] memory context_ = LibUint256Array
            .arrayFrom(uint256(uint160(ownerOf(tokenId))))
            .matrixFrom();

        uint256[] memory stack = _interpreter.eval(
            _expression,
        ...
        return
            string(
                abi.encodePacked(
                    bytes32ToString(bytes32(stack[0])),
                    bytes32ToString(bytes32(stack[1])),
                    bytes32ToString(bytes32(stack[2])),
                    stack[3].toString(),
                    ".json"
                )
            );
...
library OpCaller {
    ...
    function caller(InterpreterState memory, Operand, StackTop stackTop_)
        internal
        view
        returns (StackTop)
    {
