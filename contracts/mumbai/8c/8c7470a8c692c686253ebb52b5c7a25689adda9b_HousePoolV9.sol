    ...
    ERC20VotesUpgradeable
{
    ...
    function unStake(address to, uint256 amount) public {
        ...
        console.log("maxWithdrawalAmount inside Unstake");
        console.logInt(maxUserWithdrawalAmount);
        console.logInt( ceil(maxUserWithdrawalAmount,int256(10**(pool_decimals*2))));
        require(
            int256(amount) <= ceil(maxUserWithdrawalAmount, int256(10**(pool_decimals*2))),
    ...
    function getMaxWithdrawal(address _user) public view returns (int256) {
        ...
        if (voi.expectedValue <  userEVTracker[_user]) {
            ...
            console.log(XlpTokenPrice);
            console.log(XlpTokenPrice * balanceOf(_user)/10**18);
