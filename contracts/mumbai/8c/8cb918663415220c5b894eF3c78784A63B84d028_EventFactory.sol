    ...
    function swapExactInputSingle() external payable returns(uint amountOut)
    {
        ISwapRouter.ExactInputSingleParams memory params = 
            ISwapRouter.ExactInputSingleParams ({
                tokenIn: address(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2),                 //The contract address of the inbound token.
                tokenOut: address(0xE93Afbb39158dDFc9A1de45904EE94B19975FB58),                  //The contract address of the outbound token."
                fee: 3000,                   //The swap fee for swapping in the pool.
                ...
                amountIn: msg.value,           //Amount of TokenIn.      
