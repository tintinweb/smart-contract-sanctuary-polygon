...
contract MyToken1 is ERC20, Ownable, ERC20Permit{
    ...
    constructor() ERC20("MyToken", "MTK")ERC20Permit() {}
    ...
    function postForSale(uint256 price) external onlyOwner{
        salePrice = price;
        forSale = true;
    }
    ...
    function redeem(uint256 _amount) external{
        require(canRedeem,"Redeeption not available");
