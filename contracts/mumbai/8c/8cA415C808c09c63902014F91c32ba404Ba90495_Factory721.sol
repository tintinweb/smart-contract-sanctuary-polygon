...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new ChapterXNFTUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        ChapterXNFTUser721Token token = ChapterXNFTUser721Token(address(addr));
...
contract ChapterXNFTUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
