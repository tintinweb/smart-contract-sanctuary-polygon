...
contract MetaParaVerseV2 is ERC20, Ownable {
    ...
    function buyToken(uint256 amount) external {
        ...
        uint256 tokenAmount = amount * ZEROES;
    ...
    function tokenPriceConversion(uint256 usdtAmount) external view returns(uint256) {
        uint256 tokenAmount = ((1 * PRICE_ZEROES) / PRICE) * usdtAmount;
        return tokenAmount;
    }
