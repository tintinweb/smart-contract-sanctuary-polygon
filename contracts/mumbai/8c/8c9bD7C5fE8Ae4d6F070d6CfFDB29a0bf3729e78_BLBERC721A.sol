...
contract MGYERC721A is Ownable,ERC4907A, ReentrancyGuard, ERC2981,OperatorFilterer,ERC4906{
  ...
  //get WL all status
  function getWhitelistedStatus(uint256 wlNum_,address address_, uint256 maxmint_,bytes32[] memory proof_) external view returns (bool,uint256,uint256,bool,uint256) {
    if(wlNum_ == 0){
