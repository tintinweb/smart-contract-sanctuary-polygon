...
"138001","76001","15001","95001","50001","167001","11001","106001","92001","94001","18001","35001"];
    ...
    function CreatePreSale( uint256 _startTime,
                            ...
                            uint256 _price, 
                            uint256 _supportMax,
                            uint256 _bidMax) external onlyCOO onlyFinish{
        require(_startTime < block.timestamp ,"startTime must be greater than now!");
        require(_startTime > _endTime ,"startTime must be less than endTime!");                
        require(_endTime > block.timestamp ,"endTime must be greater than now!");
    ...
    function Support() external payable onlyStart CanFinish{
