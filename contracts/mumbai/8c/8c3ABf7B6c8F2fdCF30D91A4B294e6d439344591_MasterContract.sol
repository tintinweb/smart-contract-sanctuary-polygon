...
contract MasterContract {
    ...
    function registerUser(string calldata _domain,string calldata _username, address _address) public{
    ...
    function registerIpfsHash(string calldata _username,string calldata _ipfsHash) public{
       User memory user = users[_username];
