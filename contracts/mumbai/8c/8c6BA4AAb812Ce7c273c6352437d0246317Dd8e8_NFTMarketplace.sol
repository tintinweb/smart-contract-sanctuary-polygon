...
contract NFTMarketplace is ERC721URIStorage {
    ...
    //test addresses
    address payable Unikfame = payable(0x8EDcC9F5234ac1134b11a93a76AAC5eA9fE0EF39); // 60%
    address payable Wesley = payable(0x438fCcA554fD2ddA4B418d8108fc54a43904C84e); // 2.5%
    address payable Gaetan = payable(0x2aD4d5833E3864215Ba16A70a5c16B6efFA4B7Ab); // 2.5%
    address payable Sam = payable(0x2d772381573b931Bb07C9B4975517623C49762da); // 8%
    address payable Mike = payable(0xe8b227d74A54546A51d5FEF8fcA8dA91fF9eB340); // 1%
    address payable Dev = payable(0xce2f09F6762341e1764729d4cf65A6a1B8Bbd18D); // 1%
    ...
    constructor() ERC721("MarketPlaceDigital", "MPD") {
