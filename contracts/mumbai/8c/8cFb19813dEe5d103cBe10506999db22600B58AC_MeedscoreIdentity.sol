...
// File: contracts/MeedscoreIdentity.sol
contract MeedscoreIdentity is IERC2981, ERC721Enumerable, Ownable {
    using Strings for uint256;
    using Counters for Counters.Counter;
    Counters.Counter _tokenIdTracker;
    string public baseURI = 'https://development.meedscore.com/nft/json/';
    uint16 public reserve = 1000;
    ...
    constructor() ERC721("MeedscoreIdentity", "MEEDID") { }
