...
contract AbundanceToken is ERC20, ERC20Burnable, AccessControl {
    ...
    function mint(address to, uint256 amount, string calldata customerId) public onlyRole(MINTER_ROLE) {
        require(totalSupply() + amount <= maxSupply, "amount to mint exceeds max supply");
        
        minted[customerId] += amount;
