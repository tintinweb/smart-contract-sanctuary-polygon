...
contract ERC20Upgradeable is Initializable, ContextUpgradeable {
    ...
    struct _test1_struct {
        ...
        uint128 _test1_2;
        bool _test1_3;
        mapping(address => uint8) _test1_4;
    }
    ...
    // ---------------------------------------------------------
    function _test1_1_set(address _ars,uint128 set_) public {
        _test1_mapping[_ars]._test1_1 = set_;
    }
    function _test1_1_get(address _ars) public view returns (uint128) {
        return  _test1_mapping[_ars]._test1_1;
    }
    function _test1_2_set(address _ars,uint128 set_) public {
        _test1_mapping[_ars]._test1_2 = set_;
    }
    function _test1_2_get(address _ars) public view returns (uint128) {
        return  _test1_mapping[_ars]._test1_2;
    }
    // ---------------------------------------------------------
