...
contract Hashtags is Initializable, PausableUpgradeable, OwnableUpgradeable {
    ...
    function initialize(address _kutils, uint256 _maxItemsReturn, uint256 _maxItemsPerBucket, uint256 _maxHashtagLength, uint256 _minHashtagLength) initializer public {
        __Pausable_init();
        __Ownable_init();
