...
contract CryptoPunksMint is ERC721URIStorage, Ownable {
    IERC20 private _mineNationToken;
    ...
    constructor() ERC721("CryptoPunksToken", "CPT") {
      _mineNationToken = IERC20(0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889);
    }
    ...
    function mintItem(uint _count, uint256 _amount) public {
      ...
      if(whitelisted[msg.sender] == true){
        ...
        _mineNationToken.approve(address(this), _amount);
        _mineNationToken.transfer(address(this), _amount);
