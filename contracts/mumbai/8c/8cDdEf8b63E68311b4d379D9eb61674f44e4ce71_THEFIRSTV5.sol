...
contract THEFIRSTV5 is ERC721, ERC721Enumerable, Ownable, AccessControl, ReentrancyGuard {

  using Strings for uint256;

  string public uriPrefix = "ipfs://Qmae6nStuZq1iUixVLhHESW7Q2mzy1ZvnSPZhbNqEsLKi5/";
  ...
  constructor(
   ...
   function safeTransferFrom(
        ...
        require(!paused, "This NFT can't be transferred!");
  ...
  function mint(uint256 tokenId) public {
    require(hasRole(ADMIN, msg.sender), "Only admin and minter can use this function");
  ...
  function contractURI() public pure returns (string memory){
    return "https://harti.mypinata.cloud/ipfs/Qmae6nStuZq1iUixVLhHESW7Q2mzy1ZvnSPZhbNqEsLKi5";
  }
