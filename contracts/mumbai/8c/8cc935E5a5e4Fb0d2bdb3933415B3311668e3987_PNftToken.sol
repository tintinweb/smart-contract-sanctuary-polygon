...
import "./erc721Tradable/ERC721Tradable.sol";
 ...
 * Inspired and borrowed by/from the opensea Creature NFT contract.
 * https://github.com/ProjectOpenSea/opensea-creatures/blob/master/contracts/Creature.sol
 */
contract PNftToken is ERC721Tradable {
    constructor(
        address _owner,
        address _proxyRegistryAddress,
        string memory _name,
        string memory _symbol
    ) ERC721Tradable(_owner, _proxyRegistryAddress, _name, _symbol) {}
}
    ...
    DefaultOwnable
{
    ...
    constructor(
        ...
        require(
            _owner != address(0) && _proxyRegistryAddress != address(0),
            "Zaro address"
        );
