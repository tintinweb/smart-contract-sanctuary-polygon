...
contract BitcoinBlackXNFT is ERC721, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721("BitcoinBlack", "XNFTs") {
        maxSupply = 10000;
    ...
    function convertBitcoinToMatic() public view returns (uint256) {
        ...
        uint256 btcValue;
        uint256 bitcoinBlackValue;
        uint256 bitcoinBlackValueInMATIC;
        uint256 maticValue;
        ...
        bitcoinBlackValue = btcValue; // 1 Bitcoin Orange value in USD
        maticValue = ((10**18) * uint256(maticPrice)) / maticDecimals; // ETH value in USD
        finalMaticValue = (((10**18) * btcValue) / maticValue) * (1 ether);
        bitcoinBlackValueInMATIC = (finalMaticValue / 10**18); // 1 Bitcoin Orange value in USD
        return bitcoinBlackValueInMATIC;
    }
}