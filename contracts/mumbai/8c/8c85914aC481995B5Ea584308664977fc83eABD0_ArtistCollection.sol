    ...
    Royalties
{
    ...
    bytes32 private constant _MINT_SIGNED_TYPEHASH =
        keccak256(
            "MintNFT(address sender,address to,string tokenURI,bytes32 tokenNonce,address receiver,"
            "uint256 basisPoints)"
        );

    bytes32 private constant _MINT_EDITIONS_SIGNED_TYPEHASH =
        keccak256(
            "MintNFTEditions(address sender,address to,string[] tokenURIs,bytes32 tokenNonce,address receiver,"
            "uint256 basisPoints)"
        );
    ...
    function allowSignedMinting() public view returns (bool) {
        return _allowSignedMinting;
    }

    function setAllowSignedMinting(bool val) public {
        require(
    ...
    function mintAndTransfer(
        ...
        _mintNoPermission(msg.sender, _tokenURI, receiver, basisPoints);
    ...
    function mint(
        ...
        _mintNoPermission(to, _tokenURI, receiver, basisPoints);
    }
    ...
    function mintEditions(
        ...
        _mintEditionsNoPermission(to, _tokenURIs, receiver, basisPoints);
    }
