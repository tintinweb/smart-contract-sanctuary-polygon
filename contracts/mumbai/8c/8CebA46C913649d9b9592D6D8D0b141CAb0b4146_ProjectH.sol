...
contract ProjectH is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
  ...
  uint256 public PRESALE_SUPPLY = 19;
  ...
  uint256 public PRESALE_COUNT = 0;
    ...
    string private preRevealURI = "https://ipfs.w3bmint.xyz/ipfs/QmaWMa1jovfVZfUftLUDLWPHF9zrDNUkpf6n3JrrRSSWiD/pre-reveal";

    mapping(address => uint256) addressBlockBought;

    address public constant RL_ADDRESS = 0xc9b5553910bA47719e0202fF9F617B8BE06b3A09; 

    constructor() ERC721A("ProjectH", "JSN") {
