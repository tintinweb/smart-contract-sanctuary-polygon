...
contract FeeCollector {
    ...
    function updateReward() external {
        ...
        uint reward = WETH(payable(WETH_ADDRESS)).balanceOf(address(this));
...
contract FeeCollectorFactory is IFeeCollectorFactory {
    function createFeeCollector(address WETH, address fanToken) external override returns (address) {
