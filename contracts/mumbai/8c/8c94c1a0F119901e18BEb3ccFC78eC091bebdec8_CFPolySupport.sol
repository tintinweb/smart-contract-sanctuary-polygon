...
ReentrancyGuard
{
    ...
    string public name = "CFPoly Supporter Badge";
    ...
    {
        string memory _URI = (tokenId >= (1 << 128)) ? string.concat(uri(0), "premiumBadge.json") : string.concat(uri(0), "badge.json");
        return _URI;
    }
    ...
    function support() payable public whenNotPaused
    {
        ...
        _mint(msg.sender, regularTokenId, 1, "");
        emit SupporterBadgeIssued(msg.sender, msg.value, regularTokenId, block.timestamp);
        regularTokenId++;
    }
