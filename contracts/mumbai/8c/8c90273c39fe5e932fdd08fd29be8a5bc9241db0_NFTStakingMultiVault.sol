...
contract NFTRewards is ERC20, ERC20Burnable, Ownable {
  ...
  uint256 constant MAXIMUMSUPPLY=5000000*10**18;

  constructor() ERC20("NFTRewards", "Fs") { 
...
// File: contracts/NFTStakingMultiVault.sol
...
contract NFTStakingMultiVault is Ownable, IERC721Receiver {
