//SPDX-License-Identifier: MIT
  ...
  contract RandomWinnerGame is VRFConsumerBase, Ownable{
    ...
    uint256 public fee;
    //ID of public key aganist which randomness is generated
    ...
    //emmitted when a someone(player) joins the game
    event PlayerJoined(uint256 gameId, address player);
    //emmitted when the game ends
   ...
   */
    ...
    function joinGame() public payable {
        ...
        //add the sender to the playlist
    ...
    //fufillRandomness is called by VRFCoordinator when it receives a valid VRF proof.
    //This function is overide to act upon the random number generated by Chainlink VRF.
    ...
    function getRandomWinner() private returns (bytes32 requestId){
        ...
        //Here we use the balanceOF method from the interface to make sure that our
