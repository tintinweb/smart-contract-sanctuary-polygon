...
contract PocariSweatCMProductionFestival2023 is BaseSBT {
    ...
    constructor()
        BaseSBT("POCARI SWEAT CM Production Festival 2023", "POCARI2023CM")
    {}
    ...
    function airdrop(address to_) external onlyMinter whenNotPaused {
        require(!_isAirdroppeds[to_], "POCARI2023CM: already airdropped");
    ...
    function bulkAirdrop(
        ...
        for (uint256 i = 0; i < tos_.length; i++) {
            require(
                ...
                "POCARI2023CM: already airdropped"
            );
