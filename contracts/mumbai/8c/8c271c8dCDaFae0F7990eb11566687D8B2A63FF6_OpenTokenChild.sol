...
contract OpenTokenChild is IFxERC20,ERC20 {
    ...
    function initialize(
        ...
        require(fxManager_ == address(0x0) && connectedToken_ == address(0x0), "Open Token is already initialized");
        ownerAddr = owner_;
        boostEmissionerAddr = owner_;
        stackEmissionerAddr = owner_;
    ...
    function setFxManager(address fxManager_) public onlyByOwner {
        _fxManager = fxManager_;
    }
    ...
    function openmint(address to_, uint256 amount_, uint256 t_) public onlyByOwner {
    ...
    function openMintBatch(address to_, uint256[] memory timeList_, uint256[] memory amountList_) public onlyByOwner {
