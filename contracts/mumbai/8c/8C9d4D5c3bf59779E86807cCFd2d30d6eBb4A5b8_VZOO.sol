    ...
    Ownable
{
    ...
    /// Limit collection to 10.000 VZOO Gorilla NFTs
    ...
    uint256 private _maxMintTeam = 50;
    uint256 private _maxMintPerAddress = 25;
    ...
    /// @dev Security switches can be changed after deployment
    ...
    /// Mints _amount of token to owner for sale
    /// @param _amount of token to create
    ...
    /// @return bool true if requested bulk amount can be minted, false if it exceeds max supply
    ...
    /// @return bool true if minting and owning limits not exceeded, otherwise return false
    ...
    /// @return bool current state of the sale
