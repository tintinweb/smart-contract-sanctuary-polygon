...
contract ContractC is OwnableUpgradeable, ContractA {
    ...
    newStruct UpdatedStruct;

    function getValues() public view returns (uint256, uint256) {
        return (UpdatedStruct.myIntA, UpdatedStruct.myIntB);
    }
    ...
    function setValues(
        ...
        UpdatedStruct.myIntA += intA;
        UpdatedStruct.myIntB += intB;
