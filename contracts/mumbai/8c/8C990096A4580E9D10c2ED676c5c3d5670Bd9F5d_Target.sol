...
contract Target is IXReceiver, Ownable {
    ...
    address public Esource =
        address(0x444D5d819d483e706F3Fa2393F3ba022829f8e64);
    address public Dsource =
        address(0xCF54c8f15Ce9f193EA5747C06A2f62E1B71b5d20);
    ...
    function xReceive(
        ...
        if (flag == 3) {
            ...
            debt = dToken.balanceOf(address(this));

            dToken.repay(0, type(uint256).max);

            uint256 curr_debt = dToken.balanceOf(address(this));

            userInfo[user].usdcBorrowed -= Amount;

            sendPong(debt - curr_debt, uint8(3));
        }
    }
