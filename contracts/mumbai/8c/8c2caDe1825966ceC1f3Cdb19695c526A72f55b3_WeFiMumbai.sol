...
contract WeFiMumbai is OFTV2, ERC20Permit, ERC20Votes {
    constructor(address _layerZeroEndpoint, uint8 _sharedDecimals) OFTV2("WeFi", "WEFI", _sharedDecimals, _layerZeroEndpoint) ERC20Permit("WeFi") {
    }
