...
// Deployed at 0x2B1989B7a4E5723399bBB350B45D12654C2E46A8
...
contract ChainBattles is ERC721URIStorage {
    ...
    function generateCharacter(uint _tokenId) view public returns (string memory){
        ...
        '<style>.base { fill: white; font-family: fantasy; font-size: 18px; }</style>',
        '<style>.level { fill: rgb(182, 164, 164); font-family:monospace; font-size: 14px; }</style>'
