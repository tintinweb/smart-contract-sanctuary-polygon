...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x5ADDa22610468Ea9e6D72773C43A6B44D0CBd360];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x5ADDa22610468Ea9e6D72773C43A6B44D0CBd360;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeieepn4mpeuv7uxofuitmsoqpzbc3ewjmai2ijieyp2nvouvh7zfyy/";
...
// File: contracts/MrWhiteBirdsGoldenTicketsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MrWhiteBirdsGoldenTicketsContract is RamppERC721A {
    constructor() RamppERC721A("Mr White Birds Golden Tickets", "WBGT"){}
}
