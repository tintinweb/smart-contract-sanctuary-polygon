...
//
//    _____                       ___            
//   / ___/____ _____ ___  ____  / (_)___  ____ _
//   \__ \/ __ `/ __ `__ \/ __ \/ / / __ \/ __ `/
//  ___/ / /_/ / / / / / / /_/ / / / / / / /_/ / 
// /____/\__,_/_/ /_/ /_/ .___/_/_/_/ /_/\__, /  
//                     /_/              /____/   
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x8183e905E5818B2E9f8e01ab2AB6477De6001438];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmbjHH53L1JLccfCHdsbCVYgYeDPC2mQW1MumrXs7TVg8o/";

    bool public mintingOpen = true;
    
    uint256 public PRICE = 0.01 ether;
    
    uint256 public MAX_WALLET_MINTS = 16;
...
// File: contracts/SamplingContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SamplingContract is RamppERC721A {
    constructor() RamppERC721A("Sampling", "SAMP"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/5n8neBkFCeYrT6GvLQAL/contract-metadata";
    }
}
