...
library SmartRouterHelper {
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) public pure returns (ISkeletonPool) {
        return ISkeletonPool(computeAddress(deployer, getPoolKey(tokenA, tokenB, fee)));
    }

    /// @notice Returns the address of a valid SkeletonSwap V3 Pool
    /// @param deployer The contract address of the SkeletonSwap V3 deployer
    ...
    function verifyCallback(
        ...
        address tokenB,
        uint24 fee
    ) public view returns (ISkeletonPool pool) {
    ...
    function verifyCallback(address deployer, PoolKey memory poolKey)
        public
        view
        returns (ISkeletonPool pool)
    {
        pool = ISkeletonPool(computeAddress(deployer, poolKey));
