...
contract PhroToken is ERC20Burnable, Ownable, AccessControl
{
    ...
    */
    ...
    // ReentrancyGuard()
    constructor(address _newOwner) ERC20("Pharo Token", "PHRO") ERC20Burnable() {
        // Mint
        _setupRole(PharoConstants.OPERATOR_ROLE, _newOwner);
        _setupRole(DISTRIBUTOR_ROLE, _newOwner);
        ...
        _mint(0xc316Efa8aD1046b0DEf528e17E6f4136072731F7, 10000000 ether); // Jax Pharo Foundry Account
...
library PharoConstants
{
    ...
    enum CoverPolicyStatus { INITIALIZING, ACTIVE, INACTIVE, PENDING, CLOSED, OPEN, REJECTED }
