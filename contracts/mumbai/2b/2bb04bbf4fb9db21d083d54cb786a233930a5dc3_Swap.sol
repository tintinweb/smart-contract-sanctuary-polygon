...
/// @param owner : Owner of this offer
/// @param nonce : Nonce for this owner
...
/// @dev Open Ended Loan offer struct to be used to making collection
///      collection specific offers and trait level offers
/// @param nftCollateralContract : Address of the NFT contract
...
/// @dev Main loan struct that stores the details of an ongoing
///      loan. This struct is used to create hashes and store them in
///      promissory tokens
