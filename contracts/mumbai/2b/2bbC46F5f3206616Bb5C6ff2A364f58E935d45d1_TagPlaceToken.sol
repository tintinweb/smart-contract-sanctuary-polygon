...
import "./crosschain/CrossChainEnabledPolygonChildUpgradeable.sol";
import "./crosschain/CrossChainEnabledAnyswapUpgradeable.sol";

/// @custom:security-contact [email protected]
contract TagPlaceToken is
    Initializable,
    ERC20Upgradeable,
    ...
    CrossChainEnabledAnyswapUpgradeable
{
    ...
    function initialize(address fxChild, address anyswapRouter) public initializer {
        __ERC20_init("tagPlace", "TAGD");
        __ERC20Burnable_init();
        __Pausable_init();
        __AccessControl_init();
        __ERC20Permit_init("tagPlace");
        __ERC20Votes_init();
     ...
     */
    function _checkRole(bytes32 role) internal view virtual override(AccessControlCrossChainUpgradeable, AccessControlUpgradeable) {
        if (_isCrossChain()) {
...
import "@openzeppelin/contracts-upgradeable/vendor/polygon/IFxMessageProcessorUpgradeable.sol";
import "@openzeppelin/contracts-upgradeable/proxy/utils/Initializable.sol";
    ...
    AccessControlCrossChainUpgradeable
{
        ...
        onlyInitializing
    {
        ...
        if(router != address(0)) _grantRole(_crossChainRoleAlias(ANYSWAP_BRIDGE_ROLE), router);
    }
     ...
     */
    function _isCrossChain() internal view virtual override returns (bool) {
        return hasRole(_crossChainRoleAlias(ANYSWAP_BRIDGE_ROLE), _msgSender());
    }
