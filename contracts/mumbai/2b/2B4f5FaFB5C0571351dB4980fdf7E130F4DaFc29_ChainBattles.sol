...
contract ChainBattles is ERC721URIStorage {
    ...
    function getHealth(uint256 tokenId) public view returns (string memory) {
        uint256 health = tokenIdToWarrior[tokenId].health;
        return health.toString();
    }

    function getDefense(uint256 tokenId) public view returns (string memory) {
        uint256 defense = tokenIdToWarrior[tokenId].defense;
    ...
    function mint() public {
        ...
        warrior memory newWarrior = warrior(1, random(10), random(10), random(10));
        tokenIdToWarrior[newItemId] = newWarrior;
//        tokenIdToLevels[newItemId].level = 1;
//        tokenIdToLevels[newItemId].health = random(10);
//        tokenIdToLevels[newItemId].defense = random(10);
//        tokenIdToLevels[newItemId].strength = random(10);
    ...
    function train(uint256 tokenId) public {
        ...
        warrior memory selectedWarrior = tokenIdToWarrior[tokenId];
        if(random(10) > selectedWarrior.level)
        {
            selectedWarrior.level++;
            selectedWarrior.defense++;
            selectedWarrior.health++;
