...
contract SoccerDnasGen0 is Ownable{
    ...
    function getDnaLength () public view returns(uint256) {
        return DNAs.length;
    }

    function getDna (uint256 index) public view returns(string memory){
        return DNAs[index];
    }

    function deleteDna (uint256 index) public {
