...
contract ArtheBalls is Ownable, ERC721A , ERC2981 {

    using Strings for uint;
    string public baseURI;
    //address private artheosAddress = 0xEc0eAbf773908b361B5c3Def745D89feeD95a580;
    address private testAddress = 0x386B91E7161435DEf55695EbE16C520BAda32aB0;


    //Constructor
    constructor(string memory _baseURI, address _royaltyReceiver, uint16 _royaltyBasisPoints)
    ERC2981(_royaltyReceiver, _royaltyBasisPoints)
    ERC721A("ArtheBalls", "BALL") {
        baseURI= _baseURI;
        _safeMint(testAddress, 40);
    }
    ...
    */
    function withdraw() external {
        address payable to = payable(testAddress);
...
contract ERC2981 is Ownable {

    address public royaltyReceiver;
    uint16 public royaltyBasisPoints;

    constructor(address _royaltyReceiver, uint16 _royaltyBasisPoints) {
