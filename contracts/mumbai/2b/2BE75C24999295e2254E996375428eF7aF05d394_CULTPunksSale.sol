    ...
    AccessControlUpgradeable
{
    ...
    event setBlacklistUserEvent(address indexed _user, bool _status);
    event setAddressToMintsPublicNFTEvent(address indexed _user, uint256 _amount);
    event setAddressToMintsWLNFTEvent(address indexed _user, uint256 _amount);
    ...
    function validatePhaseSpecificPurchase(
        ...
        if (phase == 1) {
            ...
            {   
                ...
                addressToMintsWLSpot[msg.sender] = addressToMintsWLSpot[msg.sender] + amount;
            } else if(MerkleProofUpgradeable.verify(proofWL3, merkleRootSpotThree, leaf) == true && MerkleProofUpgradeable.verify(proofWL2, merkleRootSpotTwo, leaf) == true)
            {   
                if(addressToMintsWLNFT[msg.sender] > 0) {
                    require((addressToMintsWLSpot[msg.sender] + amount) <= addressToMintsWLNFT[msg.sender], "BUY AMOUNT EXCEEDS MAX FOR USER WL");
                } else {
                ...
                addressToMintsWLSpot[msg.sender] = addressToMintsWLSpot[msg.sender] + amount;
            } else if(MerkleProofUpgradeable.verify(proofWL3, merkleRootSpotThree, leaf) == true && MerkleProofUpgradeable.verify(proofWL1, merkleRootSpotOne, leaf) == true)
            {   
                if(addressToMintsWLNFT[msg.sender] > 0) {
                    require((addressToMintsWLSpot[msg.sender] + amount) <= addressToMintsWLNFT[msg.sender], "BUY AMOUNT EXCEEDS MAX FOR USER WL");
                } else {
                ...
                addressToMintsWLSpot[msg.sender] = addressToMintsWLSpot[msg.sender] + amount;
            } else if(MerkleProofUpgradeable.verify(proofWL3, merkleRootSpotThree, leaf) == true) {
                if(addressToMintsWLNFT[msg.sender] > 0) {
                    require((addressToMintsWLSpot[msg.sender] + amount) <= addressToMintsWLNFT[msg.sender], "BUY AMOUNT EXCEEDS MAX FOR USER WL");
                } else {
                    require((addressToMintsWLSpot[msg.sender] + amount) <= wlPerSpotMint, "BUY AMOUNT EXCEEDS MAX FOR USER");
    ...
    function updateAddressToMintsWLNFT(address _user, uint256 _amount) external onlyOwner {
        ...
        emit setAddressToMintsWLNFTEvent(_user, _amount);
    }
    ...
    function updateAddressToMintsPublicNFT(address _user, uint256 _amount) external onlyOwner {
        ...
        emit setAddressToMintsPublicNFTEvent(_user, _amount);
    }
