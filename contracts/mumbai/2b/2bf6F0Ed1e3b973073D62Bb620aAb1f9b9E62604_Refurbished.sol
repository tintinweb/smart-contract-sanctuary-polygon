...
contract Refurbished is ERC721Enumerable, AccessControl {
    ...
    event MintRefurbished();
    event BurnRefurbished();

    constructor() ERC721("Refurbished", "RFRB") {
