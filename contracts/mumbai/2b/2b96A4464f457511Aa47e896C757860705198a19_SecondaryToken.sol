...
contract SecondaryToken is ERC20, ERC20Burnable, ERC20Pausable, AccessControl, ReentrancyGuard {
    ...
    function claimSelf(uint256 _amount, uint256 _deadline, bytes memory _signature)
        external
        nonReentrant
    {
        require(
        ...
        require(
            ...
            "CS:Invalid Signature in claiming"
        );
