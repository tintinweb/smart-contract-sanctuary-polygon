...
import "./SigningWhitelist.sol";
import "@openzeppelin/contracts-upgradeable/token/ERC20/IERC20Upgradeable.sol";



contract PolyYetiGame is OwnableUpgradeable, YetiSigner, ReentrancyGuardUpgradeable, signerChecker {

    iYeti yeti;
    IERC20Upgradeable frxst;
    ...
    function levelup(Signer memory rarity, uint[] memory tokenIds) external onlyOwner{
        ...
        require(getSigner(rarity) == account, "Not Account");
    ...
    function addManyToPalace(Signer memory rarity, uint[] memory tokenIds, uint8 activityId) external onlyOwner{
...
contract YetiSigner is EIP712Upgradeable{
    ...
    string private  SIGNING_DOMAIN; //= "Yeti-Migration";
...
contract signerChecker is EIP712Upgradeable{
