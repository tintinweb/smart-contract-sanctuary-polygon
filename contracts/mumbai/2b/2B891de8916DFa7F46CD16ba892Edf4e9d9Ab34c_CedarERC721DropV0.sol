...
abstract contract BaseCedarERC721DropV0 is ICedarERC721DropV0 {
    function supportedFeatures() override public pure returns (string[] memory features) {
        ...
        features[2] = "issuance/ICedarNFTIssuance.sol:ICedarNFTIssuanceV0";
        features[3] = "lazymint/ICedarNFTLazyMint.sol:ICedarNFTLazyMintV0";
        features[4] = "IMulticallable.sol:IMulticallableV0";
        features[5] = "standard/IERC721.sol:IERC721V0";
    }
    ...
    function supportsInterface(bytes4 interfaceID) virtual override public view returns (bool) {
        return (interfaceID == type(IERC165Upgradeable).interfaceId) || ((interfaceID == type(ICedarFeaturesV0).interfaceId) || ((interfaceID == type(ICedarVersionedV0).interfaceId) || ((interfaceID == type(ICedarNFTIssuanceV0).interfaceId) || ((interfaceID == type(ICedarNFTLazyMintV0).interfaceId) || ((interfaceID == type(IMulticallableV0).interfaceId) || (interfaceID == type(IERC721V0).interfaceId))))));
    }
