...
contract ERC777Proxy is Context, IERC777, IERC20 {
    ...
    constructor(address underlying) {
        _underlying = IERC20Metadata(underlying);
    ...
    {
        return
            _underlying.allowance(tokenHolder, address(this)) ==
            type(uint256).max &&
            (operator == tokenHolder || _operators[tokenHolder][operator]);
    }
    ...
    function authorizeOperator(address operator) public virtual override {
        ...
        _underlying.approve(operator, type(uint256).max);
    ...
    function revokeOperator(address operator) public virtual override {
        ...
        _underlying.approve(operator, 0);
