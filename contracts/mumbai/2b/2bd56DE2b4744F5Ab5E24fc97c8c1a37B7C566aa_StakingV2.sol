...
contract StakingV2 is ReentrancyGuard, Ownable {
    ...
    function _calculateRewardAndUpdate(
        ...
        console.log("rewardPerPeriodLength:", rewardPerPeriodLength);
    ...
    function harvest(
        ...
        console.log(
            "Total reward for harvest Position",
        ...
        harvestPosition.isRewardClaimed = true;
    ...
    function withdraw(
        ...
        if (totalReward > pools[withdrawPosition.id].totalRewardAmount) {
            totalReward = 0;
        } else {
