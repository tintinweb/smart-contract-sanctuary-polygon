    ...
    DefaultOperatorFilterer
{
    ...
    constructor() ERC721A("Dream Cars Collection Benz 6X6 G", "DCC6X6G") {
        admins[msg.sender] = true;
    }

    modifier onlyAdmin() {
        require(admins[_msgSender()], "DCC6X6G: Caller is not the admin");
        _;
    }
        ...
        returns (string memory)
    {
        require(
            _exists(tokenId),
            "DCC6X6G: URI query for nonexistent token"
        );
        ...
        onlyAdmin
    {
        ...
        require(total + totalQuantity <= MAX_ELEMENTS, "DCC6X6G: Max limit");
