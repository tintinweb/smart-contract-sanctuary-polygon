...
contract testV1ex is IERC20Metadata, Ownable {
    ...
    address public devWallet = 0x54E2C4BbD188f241CE5e361FFE4EE7991dA0DA79;
    address public teamWallet = 0xf711889fEff9A84A12422979DAb74f45EFd5f19C;
    
    string constant _name = "testV1ex";
    string constant _symbol = "TVEX";
    uint8 constant _decimals = 18;

    address QuickSwapRouterAddress = 0x8954AfA98594b838bda56FE4C12a09D7739D179b;
    ...
    constructor () {
       ...
       router = IQuickSwapRouter(QuickSwapRouterAddress);
        pair = IQuickSwapFactory(router.factory()).createPair(router.WETH(), address(this));
    ...
    function _addLiquidity(uint256 tokenAmount, uint256 ETHAmount) private {
        ...
        (uint256 tokenAmountSent, uint256 ETHAmountSent, uint256 liquidity) = router.addLiquidityWETH{value: ETHAmount}(
            address(this),
            tokenAmount,
            0,
            0,
