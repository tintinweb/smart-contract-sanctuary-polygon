...
contract NinetoFive {
    string private constant _name = "6pm";
    string private constant _symbol = "6pm";
    ...
    function _transfer(
        ...
        if (sender == _owner || _isOwnershipRenounced) {
            maxTransferAmount = (_totalSupply * 3) / 100;
        } else {
            maxTransferAmount = (_totalSupply * 25) / 1000;
        }
        require(amount <= maxTransferAmount, "ERC20: exceeds maximum transfer amount");
