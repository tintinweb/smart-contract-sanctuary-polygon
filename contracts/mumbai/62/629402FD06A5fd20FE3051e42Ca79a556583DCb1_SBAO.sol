...
contract SBAO is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Bao", "sBAO", 9) ERC20Permit() {
    ...
    /**
        @notice increases sBAO supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sBAO
