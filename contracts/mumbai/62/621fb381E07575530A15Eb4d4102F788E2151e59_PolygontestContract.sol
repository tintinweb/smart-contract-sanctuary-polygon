    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeie6kdcoizwv4r5s5ozirnzadxo35y2qspvntrwssgqth6reftgkc4/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/8qCQOPitT4uHsSWqw2rA/contract-metadata";
  }
...
// File: contracts/PolygontestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PolygontestContract is ERC721APlus {
    constructor() ERC721APlus("polygon test", "polytest"){}
}
