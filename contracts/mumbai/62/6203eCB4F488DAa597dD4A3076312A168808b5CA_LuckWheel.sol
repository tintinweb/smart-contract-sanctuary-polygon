...
contract LuckWheel is Initializable, ILuckWheel {  
  ...
  uint constant public CHECKINS_TO_SILVER_WHEEL = 7;
  uint constant public CHECKINS_TO_GOLDEN_WHEEL = 28;
    ...
    ) 
  {
    ...
    return (
      checkinCount / CHECKINS_TO_SILVER_WHEEL, 
      checkinCount /CHECKINS_TO_GOLDEN_WHEEL, 
      checkinCount, 
  ...
  function spinGoldenWheel() external override {
    ...
    _accountCheckin[msg.sender].count -= CHECKINS_TO_GOLDEN_WHEEL;
  ...
  function spinSilverWheel() external override {
    ...
    _accountCheckin[msg.sender].count -= CHECKINS_TO_SILVER_WHEEL;
