...
contract PlanManager is IPlanManager, Initializable, OwnableUpgradeable {
    ...
    mapping(uint256 => Plan[]) private merchantTokenIdToPlans;
        ...
        returns (uint256 planIndex)
    {
        ...
        merchantTokenIdToPlans[merchantTokenId].push(plan);
        planIndex = merchantTokenIdToPlans[merchantTokenId].length - 1;
    }
    ...
    {
        plans = merchantTokenIdToPlans[merchantTokenId];
    }
}
