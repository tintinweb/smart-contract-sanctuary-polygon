...
contract TESTSTICKSLAST is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("TESTSTICKSLAST", "TSTSL") {
    setHiddenMetadataUri("ipfs://QmNTV9LUzxcwn38gS3Qg2n8wxibLBeJJNmQgrVQafeDu4Q/hidden.json");
  }
