...
contract g is IERC721L, ERC721AQueryable, Ownable, ReentrancyGuard {
    ...
    // Current base URI.
    string private _currentBaseURI = "ipfs://bafybeidcwkzk353nbnw57ftg7dev6anstqykpkwendfe53rjsxknfpaaou/";
    ...
    constructor() ERC721A("g", "g") {
        _mintStages.push(MintStageInfo({cost: 0, walletLimit: 10, merkleRoot: 0x0, maxStageSupply: 0, startTimeUnixSeconds: 1686845146, endTimeUnixSeconds: 1692029146}));
    }
