...
contract FunkyBoar is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Funky Boar", "FUNKYBOAR") {
    setHiddenMetadataUri("ipfs://QmeY2nrovuo2dznsNNQCnRvFm4wzvKkijzd2S8Gkeh6VDC/hidden.json");
  }
