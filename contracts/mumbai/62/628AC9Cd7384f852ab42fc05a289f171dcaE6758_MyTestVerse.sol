...
// File: contracts/MyTestVerse.sol
...
contract MyTestVerse is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("MyTestVerse", "MYTEST") {
    setHiddenMetadataUri("ipfs://__CID__/hidden.json");
    buildings.push(Building("ZERO",0,0,0,0,0,0));
    buildings.push(Building("House",1,3,2,2,0,3));
    buildings.push(Building("Rasagna House",2,5,4,10,0,6));
    buildings.push(Building("Girish House",1,6,2,10,0,0));
    buildings.push(Building("Dhhievat House",1,1,2,7,0,-7));
    buildings.push(Building("Dhisana House",2,3,1,-9,0,-9));
    buildings.push(Building("Library",1,3,3,-4,0,2));
    buildings.push(Building("Gallery",2,5,2,-2,0,5));
    buildings.push(Building("House",2,6,1,-10,0,4));
    buildings.push(Building("Temple",3,1,3,-4,0,-5));
    buildings.push(Building("Mall",2,2,3,-10,0,0));
    buildings.push(Building("Zym",3,2,2,-3,0,-2));
  }
