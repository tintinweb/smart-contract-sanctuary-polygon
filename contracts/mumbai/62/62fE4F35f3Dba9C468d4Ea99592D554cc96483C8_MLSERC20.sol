...
contract MLSERC20 is ERC20, ERC20Burnable, Pausable, Ownable, ERC20FlashMint {
    constructor(string memory name_, string memory symbol_, uint initialSupply_) ERC20(name_, symbol_) {
        // _mint(msg.sender, initialSupply_); //open this line and comment the next one for testing
