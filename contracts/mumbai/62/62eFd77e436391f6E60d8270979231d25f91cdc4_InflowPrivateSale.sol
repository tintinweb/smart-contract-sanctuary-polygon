...
contract InflowPrivateSale is Ownable, ReentrancyGuard {
    ...
    ) public onlyOrigin nonReentrant {
    ...
    */
        ...
        onlyIfVestingScheduleNotRevoked(vestingScheduleId)
    {
        ...
        holderMap[msg.sender].amountTotal =
            holderMap[msg.sender].amountTotal -
            amount;
    }
    ...
    function updatePriceConsumerAddress(address newTokenAddr) public onlyOwner {
        _priceConsumer = newTokenAddr;
    }
