...
contract CrookedSnouts is VRFConsumerBaseV2, ERC721URIStorage {
  ...
  function create() public {
    ...
    string memory svg = string(
      ...
      string memory tokenURI = formatTokenURI(imageURI, usersTokenId);
  ...
  function formatTokenURI(string memory imageURI, uint128 tokenId) internal pure returns(string memory tokenURI) {

    string memory baseURL = "data:application/json;base64,";
    string memory name = string(abi.encodePacked("Crooked Snout #", Strings.toString(tokenId)));
