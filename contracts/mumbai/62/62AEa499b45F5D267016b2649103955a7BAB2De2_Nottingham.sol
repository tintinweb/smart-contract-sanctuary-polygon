...
contract Nottingham is KeeperCompatibleInterface, VRFConsumerBaseV2, ERC721Holder, Ownable{
    ...
    function fulfillRandomWords(
      ...
      uint256[] memory randomWords
        ...
        //at this point if the next epoch is a revolution then it has gotten the shillings for this epoch, and wont get anymore, so we need to like save
        //the total number of shillings
        //need to do some stuff here for revolutions, like storing shillings accumulated, resetting values once it is done
    }
