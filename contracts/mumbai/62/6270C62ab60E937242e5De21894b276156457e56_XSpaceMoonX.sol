...
contract XSpaceMoonX {
	...
	constructor(address payable wallet, uint256 startDate) public {
        ...
        plans.push(Plan(1, 1000000)); //7%
        plans.push(Plan(14, 80)); //8%
        plans.push(Plan(21, 75)); //7.5%
        plans.push(Plan(28, 70)); //7%%
	}
