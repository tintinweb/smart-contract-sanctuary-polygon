...
contract CryptoGala is ERC721Enumerable, Ownable {

    using Strings for uint256;

    string _baseTokenURI;

    address addr_1 = 0xbB96aDb0a85FD5eA6Ad254685a209C188130B310;
    
    //reserved for giveaways
    uint256 private _reserved = 10;

    uint256 private _price = 35 ether;
    bool public _paused = false;

    constructor(string memory baseURI) ERC721("CryptoGala", "CG")  {
        setBaseURI(baseURI);
