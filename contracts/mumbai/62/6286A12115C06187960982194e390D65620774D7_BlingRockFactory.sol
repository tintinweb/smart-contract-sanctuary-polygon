...
contract BlingRockFactory {
    ...
    event CollectibleMinted(address tokenContract, uint256 tokenId, string id);
    ...
    function deployCollection(
        ...
        emit CollectionCreated(address(t), index, _id);
        return address(t);
    }
    ...
    //     BlingRockCollection token = require(
    //         token.balanceOf(collectibleOwner, tokenId) >= amount,
    ...
    //         ""
    //     );
    //     collectibleOwner.transfer(msg.value);
    // }
}
