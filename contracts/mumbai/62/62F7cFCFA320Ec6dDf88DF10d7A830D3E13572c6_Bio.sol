...
contract Bio is ERC721URIStorage {
    ...
    function mint(string memory tokenURI) public returns (uint256) {
        // Check that sender does not have bio
        require(balanceOf(msg.sender) == 0, "Account already has a token");
        // Mint token
    ...
    /**
     * Orerride function before token transfer.
     */
    function _beforeTokenTransfer(
        ...
        // Check that only zero address can transfer token
