...
Opening a new platform so that customers can make their own asset management rather than large institutions. And with that, to build a stable asset management service in the virtual asset market. That is the vision of XXX. Blockchain is an important tool for shaping the future of finance. In particular, DeFi and NFT are the biggest topics in the new virtual asset market. We will create services for our customers by continuously upgrading until the day that all digital assets are freely traded in the decentralized financial market.
...
XXXX also provides a staking service for NFT assets, a new asset service.
