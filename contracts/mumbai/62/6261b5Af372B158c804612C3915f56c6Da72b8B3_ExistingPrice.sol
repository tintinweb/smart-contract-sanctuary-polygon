...
// File: getExistingPrice.sol


pragma solidity ^0.8.0;


//rinkeby 0x18431fd88adF138e8b979A7246eb58EA7126ea16
//0x840c23e39F9D029fFa888F47069aA6864f0401D7

contract ExistingPrice is UsingTellor {

constructor(address payable _tellorAddress) UsingTellor(_tellorAddress) {}

    event getPrice (bytes _price, uint256 _timestamp);

    bytes public queryData = abi.encode("SpotPrice", abi.encode("dai", "usd"));
    bytes32 public queryId = keccak256(queryData);

    function getSpotPrice() external {
        (bool ifRetrieve, bytes memory _price,  uint256 _timestamp ) =
            getDataBefore(queryId, block.timestamp - 1 hours);
            
        require(ifRetrieve, "Price was not received");
        emit getPrice (_price, _timestamp);
