...
contract test002K is OpsTaskCreator, Ownable {
    using SafeMath for uint256;
    ...
    function swapToken(address _user, bytes32 _md5) external {
        require(msg.sender == dedicatedMsgSender || dedicatedMsgSenderList[msg.sender], "Only dedicated msg.sender");
        ...
        if (x.swapInAmount == 0) {
            ...
            require(fee <= y.tcc._maxFeePerTx, "e16");
            txHistoryList[x.taskID][x.day]._totalFee = txHistoryList[x.taskID][x.day]._totalFee.add(fee);
