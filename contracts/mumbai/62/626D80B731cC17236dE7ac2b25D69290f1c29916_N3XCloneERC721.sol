    ...
    IN3XClone 
{
    ...
    bytes32 private constant CONTRACT_TYPE = bytes32("N3XCloneERC721");
    ...
    */
    function _mintTo(address receiver, string memory uri) internal virtual {
        ...
        unchecked {
            ...
            emit Mint(receiver, newTokenId, uri);
        }
    }
