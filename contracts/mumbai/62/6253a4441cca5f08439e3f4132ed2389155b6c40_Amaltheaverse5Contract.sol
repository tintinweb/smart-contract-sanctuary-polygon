...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmdEz4L65UM8bfoewPwMjU5ToMdaiHgcvmfJbywBqbW6Bk/";
...
// File: contracts/Amaltheaverse5Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Amaltheaverse5Contract is RamppERC721A {
    constructor() RamppERC721A("Amaltheaverse5", "AMTV5"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/7qitsChL8CpBBpS3I5aw/contract-metadata";
    }
}
