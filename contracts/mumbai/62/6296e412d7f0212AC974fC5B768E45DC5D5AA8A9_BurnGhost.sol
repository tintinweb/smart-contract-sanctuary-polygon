...
contract BurnGhost is ERC1155, Ownable {
    ...
    constructor()
        ERC1155("https://s2lp2oc1t8.execute-api.us-east-1.amazonaws.com/dev/nft/{id}.json")
    {
    ...
    function mint(string memory metadata, uint256 amount, address receiver) public onlyOwner {
        require(
            _metadataToId[metadata] > 0,
