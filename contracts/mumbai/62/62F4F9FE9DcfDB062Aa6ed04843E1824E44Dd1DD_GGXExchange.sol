...
import {SignatureChecker} from "../libraries/SignatureVerifier.sol";
...
/**
 * @title GGX Exchange
 * @notice It is the core contract of the GGX exchange.
**/

contract GGXExchange is IExchange, ReentrancyGuard, Ownable {
    ...
    address public protocolFeeRecipient; // NOT NEEDED FOR NOW
    ...
    constructor(
        ...
        DOMAIN_SEPARATOR = keccak256(
            abi.encode(
                ...
                0x52ddedd1f151477695afe8d6312cbddc0459368665e3e82757b8ee34f9db1cd5, // keccak256("GGXExchange")
     ...
     */
    function executeOrderWithoutSignatureVerificationOptimized(address collection, address buyer, address seller, uint256 tokenId)
        external
    {
        // require(msg.sender == owner(), "Order: Owner");
        IERC721(collection).safeTransferFrom(buyer, seller, tokenId);
    }
     ...
     */
    function executeOrderWithoutSignatureVerification(OrderTypes.TakerOrder calldata takerBid, OrderTypes.MakerOrder calldata makerAsk)
        external
        nonReentrant
    {
        ...
        IERC721(makerAsk.collection).transferFrom(makerAsk.signer, takerBid.taker, tokenId);
     ...
     * @param makerAsk maker ask order
     */
    function executeOrderWithNativeToken(
        OrderTypes.TakerOrder calldata takerBid,
        OrderTypes.MakerOrder calldata makerAsk
    ) external payable override nonReentrant {
        require((makerAsk.isOrderAsk) && (!takerBid.isOrderAsk), "Order: Wrong sides");
        require(msg.sender == takerBid.taker, "Order: Taker must be the sender");
        require(takerBid.price == msg.value, "Order: Msg.value too low or high");
        ...
        // Execution part 1/2
        _transferFeesAndFundsWithNativeToken(
            makerAsk.strategy,
            makerAsk.signer,
            takerBid.price,
            0
     ...
     * @param makerAsk maker ask order
     */
    function executeOrderWithoutCurrency(OrderTypes.TakerOrder calldata takerBid, OrderTypes.MakerOrder calldata makerAsk)
        external
        override
        nonReentrant
    {
     ...
     * @param takerBid taker ask order
     * @param makerAsk maker bid order
     */
    function executeOrderWithCurrency(OrderTypes.TakerOrder calldata takerBid, OrderTypes.MakerOrder calldata makerAsk)
        external
        override
        nonReentrant
    {
        ...
        // Execution part 1/2
        _transferNonFungibleToken(makerAsk.collection, msg.sender, makerAsk.signer, tokenId, amount);
     ...
     * @param minPercentageToAsk minimum percentage of the gross amount that goes to ask
     */
    function _transferFeesAndFundsWithNativeToken(
        address strategy,
        address to,
        uint256 amount,
        uint256 minPercentageToAsk
        ...
        // 1. Protocol fee
        {
            ...
            // Check if the protocol fee is different than 0 for this strategy
            if ((protocolFeeRecipient != address(0)) && (protocolFeeAmount != 0)) {
                (bool sent, ) = protocolFeeRecipient.call{value: msg.value}("");
                require(sent, "Failed Transfer for Native Token");
                finalSellerAmount -= protocolFeeAmount;
            }
        }
    ...
    function _validateOrder(OrderTypes.MakerOrder calldata makerOrder, bytes32 orderHash) internal view {
        ...
        // Verify the amount is not 0 -> CHECK IF THIS IS NEEDED
...
library OrderTypes {
    ...
    struct MakerOrder {
        ...
        address strategy; // strategy for protocol rewards
