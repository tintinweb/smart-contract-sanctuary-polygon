...
contract CompetitionFactory is ICompetitionFactory, Ownable {
    ...
    function createCompetition(
        ...
        info.addr = Create3.create3(
            _competitionId,
            abi.encodePacked(
            abi.encodePacked(_getCreationCode(CompetitionImpl.BASE), abi.encode(address(this)))
            )
        );
    ...
    function createPredictableCompetition(
        ...
        info.addr = Create3.create3(
            _competitionId,
            abi.encodePacked(
            abi.encodePacked(_getCreationCode(CompetitionImpl.PREDICTABLE), abi.encode(address(this)))
            )
        );
