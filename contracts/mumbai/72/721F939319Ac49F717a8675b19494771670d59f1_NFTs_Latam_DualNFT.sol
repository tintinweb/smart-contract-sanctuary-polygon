    ...
    ITokenERC721
{
        ...
        initializer
    {
        ...
        string memory _name = "Dual NFT V1";
        ...
        __EIP712_init("NFTs_Latam_DualNFT", "1");
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                ...
                                "Tuinier #30",
                                '", "description":"',
                                "This interesting approach of having a two-in-one NFT (both On-Chain and Off-chain art under the same contract & with the same token ID) was developed for the EtherTulip V2 concept bid by Tulip30 and Ecuadorian developers NFTsLATAM. You will be able to randomly display one or the other each time you refresh the metadata on Opensea. This will allow the owner to have a forever pfp on-chain and also enjoy the beautiful art than can be digitalized on a blockchain using ipfs (although relying on centralized storage). We have created an NFT that contains the best of the two worlds.",
                                '", "image": "',
                                //"data:image/img;base64,",
                                onchain[_tokenId],
                                '", "attributes": [',
                                '{ "trait_type": "Author",                  "value": "TULIP30" },',
                                '{ "trait_type": "EtherTulip",              "value": "30" },',
                                '{ "trait_type": "On-Chain Background",     "value": "Peach" },',
                                '}'
                            )
                        )
                    )
