    ...
    ERC721BurnableUpgradeable
{
    ...
    uint32 public minted; // nft minted
    uint32 public cap; // max nfts that can be minted

    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() initializer {}

    function initialize() public initializer {
        __ERC721_init("Pikaso", "PIKASO");
        ...
        cap = 10000; // max nfts that can be minted
    }
    ...
    function mint(uint256 tokenId) external {
        require(minted < cap, "max have been minted");
        minted += 1;
