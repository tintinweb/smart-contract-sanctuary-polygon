...
import "@maticnetwork/pos-portal/contracts/child/ChildChainManager/ChildChainManager.sol";

contract MaticChildChainManager is ChildChainManager {
  /**
   * @notice ChildChainManager constructor
   */
  constructor() public {}
}
