...
contract PolarDepositContract is AccessControl, EIP712 {
    ...
    constructor(address acceptToken, address owner, address priceAggregator) EIP712("PolarDepositContract", "1.0.0") {
    ...
    */
    ...
    function depositNativeToken() payable external {
        ...
        uint depositedNativeTokenPrice = msg.value * uint(nativeTokenPrice) / 1 ether;
        uint quantity = depositedNativeTokenPrice * 1e3 * QUANTITY_DECIMAL / PUBLIC_SALE_PRICE / 1e8;
