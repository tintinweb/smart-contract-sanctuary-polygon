    ...
    ResourceImplementationPointer
{
    ...
    function initialize(address _treasury) external initializer {
        ...
        _baseURIExtended = "ipfs://QmNW4NR5Q2U5Wc9GHMkmVA7wQHwx7oCfmUJfauSswFdLoo/";
    }
    ...
    function airdropNFTs(
        uint256[] memory NFTs // NFTs should be sorted in order
    ) external nonReentrant whenNotPaused onlyOwner {
        address sender = _msgSender();
        require(
            NFTs.length > 0 && NFTs.length < 100,
        ...
        for (uint256 index = 0; index < NFTs.length; index++) {
            ...
            require(
                maxSupply >= NFTs[index],
                "NFTs: total supply can never exceed max supply"
            );

            _nfts[NFTs[index]] = NFTEntity({
                id: NFTs[index],
            ...
            _mint(sender, NFTs[index]);
            airdropList.push(NFTs[index]);
        }
    }
