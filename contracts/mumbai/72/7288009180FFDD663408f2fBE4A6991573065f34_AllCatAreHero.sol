...
contract AllCatAreHero is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_, address proxyRegistryAddress_)
    ERC721("All Cat Are Hero ", "ACAH")
  {
  ...
  uint256 public constant MINT_LIMIT_PER_WALLET = 10000;
  ...
  uint256 public constant MAX_MULTIMINT = 10000;

  uint256 public constant PRICE = 58000000000000000000;
  ...
  function mint(uint256 count) public payable nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 10000 at a time");

    require(
      msg.value >= PRICE * count, "Insufficient payment, 58 ETH per item"
    );
