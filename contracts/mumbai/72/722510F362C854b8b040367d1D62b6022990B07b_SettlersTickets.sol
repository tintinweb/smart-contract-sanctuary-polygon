...
// File: SettlersTickets contract

pragma solidity 0.8.1;

contract SettlersTickets is ERC1155, ERC1155Holder {
    ...
    constructor() ERC1155("https://bafybeib4g7hewm2qwjgoatikznli3rrjnutet5t34lajsbb54gw4z7vh7u.ipfs.infura-ipfs.io/foundingSettlersTicket.json") {
        ...
        name = "Metanoia Discount Ticket";
        symbol = "TICKET";
    }

    function mintNewTicketCollection(address to, uint amount) public /*onlyOwner*/ {
        nextTokenID++;
        _mint(to, nextTokenID-1, amount, "");
    }
