...
import "@opengtl/contracts/contracts/token/ERC20/ERC20BoundMintableUpgradeable.sol";
...
contract PrimeGamesToken is AccessControlUpgradeable, ERC20CappedUpgradeable, ERC20PermitUpgradeable, 
    ERC20VotesUpgradeable, UUPSUpgradeable, ERC20BoundMintableUpgradeable {

    bytes32 public constant UPGRADER_ROLE = keccak256("UPGRADER_ROLE");

    bool private _mintingInProgress;

    modifier onlyWhileMinting {
        require(_mintingInProgress, "PrimeGamesToken: minting finished");
        _;
    }
    ...
    function initialize(string calldata name_, string calldata symbol_, uint256 cap_, uint256 defaultMinterCap_) public initializer {
        __ERC20_init(name_, symbol_);
        __ERC20Capped_init(cap_);
        __ERC20BoundMintableUpgradeable_init(defaultMinterCap_);
    ...
    function mintingFinished() public view returns (bool) {
        return !_mintingInProgress;
    }

    function finishMinting() public onlyRole(DEFAULT_ADMIN_ROLE) {
        require(_mintingInProgress, "PrimeGamesToken: minting is already finished");
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount) 
        internal virtual override(ERC20Upgradeable, ERC20BoundMintableUpgradeable)
    {
...
abstract contract ERC20BoundMintableUpgradeable is AccessControlUpgradeable, ERC20Upgradeable {
    ...
    function defaultMintingCap() public view returns (uint256) {
        return _defaultCap;
    }
