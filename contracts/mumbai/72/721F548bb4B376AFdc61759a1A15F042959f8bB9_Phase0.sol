...
contract Phase0 is ERC721, ERC721Burnable, ERC721Enumerable, Ownable{
    ...
    */
    function randomTokenId() internal returns(uint16 resultNumber){
        ...
        _randomNumbers.pop();
        emit randomNumberEvent(resultNumber);
        return resultNumber;
    }
    ...
    */
    function redeem(uint256 ticketId) external {
        ...
        IERC721Burn(ticketAddress).burnNFT(ticketId, msg.sender);
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://ipfs.io/ipfs/QmWQg5fT4niRBVANzubBhREgQ3fYFRtKvrJPt8JoJTKQxe/";
    }
