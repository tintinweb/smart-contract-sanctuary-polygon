 ...
 **/
contract OasisXNFT721 is ERC721A, Pausable {
     ...
     * @param merkleRoot_ merkle tree root of the hashed whitelist addresses
    ...
    function changeMintBeneficiary(address beneficiary) public onlyOwner {
        require(
            ...
            "OasisXNFT721: Minting beneficiary cannot be address 0"
        );
        require(
            beneficiary != _mintingBeneficiary,
            "OasisXNFT721: beneficiary cannot be same as previous"
        );
     ...
     **/
    function isLimitExceeded() public view returns (bool) {
        require(
     ...
     **/
    function _isAllowedToMint(bytes32[] memory proof_)
        internal
        view
        returns (bool)
    {
     ...
     **/
    function _checkLimit(address minter) internal view returns (bool) {
        require(
            _numberMinted(minter) < _mintsPerAddressLimit,
...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata, Initializable {
    ...
    function initialize721A(string memory name_, string memory symbol_) internal onlyInitializing{
        _name = name_;
        _symbol = symbol_;
        _currentIndex = _startTokenId();
    }
