...
contract Presale {
    ...
    uint256 public constant MAX_ALLOC_USDC = 50000 * 1e6; // USDC max allocation for each presale buyer
    ...
    uint256 public constant IDS = 2e7 * 1e18; // Total SBCToken amount for presale : 20,000,000 SBC
