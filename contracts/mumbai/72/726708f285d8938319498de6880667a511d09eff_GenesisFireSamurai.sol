...
contract GenesisFireSamurai is ERC1155, ERC2981, Ownable, ReentrancyGuard, Pausable {
    ...
    constructor() ERC1155("https://bafybeibhy6teapy6fyjssflkhdku23zrar2ocdbuw6nmlznaaz5rl464qm.ipfs.dweb.link/?filename=GenesisFireSamurai.json") {
        name = "Genesis Fire Samurai";
        symbol = "GFS";
        // royaltyBalancer = IRoyaltyBalancer(_royaltyBalancer);
        // baseURI = "https://gateway.pinata.cloud/ipfs/QmR1wBS9tw5Tb4VFeodTc71EKUfRQNgUPKguMMoS6RFyRc";
        // _contractURI = "https://gateway.pinata.cloud/ipfs/QmR1wBS9tw5Tb4VFeodTc71EKUfRQNgUPKguMMoS6RFyRc";
    ...
    function claimFreeTokens(address to, uint256 amount) public nonReentrant whenNotPaused onlyFreeMintEligibled {
    ...
    function supportsInterface(bytes4 interfaceId) // тестить
        public
        view
        virtual
    ...
    function uri(uint256 tokenId) public view override returns (string memory) {
        ...
        // string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Genesis Fire Samurai", "description": "Collection of the first "historical" Fire Samurai. Lifetime royalties for minters. Airdrops & rewards for holders.", "image": "ipfs://QmeJhCdV99ATH4aVLSF2mDZWm8J9D4KwPeEtvbfqZfBQ4M", "animation_url": "ipfs://QmbgufA7uEaUMAGWRX9b65KBSVfKkkc6sqtkhSNLhNDxZf"}'))));
        // return string(abi.encodePacked('data:application/json;base64,', json));
        return "https://bafybeibhy6teapy6fyjssflkhdku23zrar2ocdbuw6nmlznaaz5rl464qm.ipfs.dweb.link/?filename=GenesisFireSamurai.json";
    }
