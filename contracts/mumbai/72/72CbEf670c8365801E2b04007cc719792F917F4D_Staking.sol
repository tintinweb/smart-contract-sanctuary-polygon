...
contract Staking is Initializable, OwnableUpgradeable, ManageableUpgradeable {
    ...
    function initialize(Init memory init) public initializer {
        ...
        NFT = IERC721Upgradeable(init.nft);
    ...
    // TODO: TEST
    function boostStaking(uint256 nftId, uint256 index) public {
        NFT.transferFrom(_msgSender(), address(0), nftId);
        stakes[_msgSender()][index].apy += nftBonus;
    }
