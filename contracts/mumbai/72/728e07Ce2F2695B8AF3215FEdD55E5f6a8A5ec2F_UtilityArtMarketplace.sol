...
contract UtilityArtMarketplace is Ownable {
    ...
    function createSell(
        ...
        require(nft.ownerOf(_tokenId) == msg.sender, "no");
    ...
    function cancelListedNFT(address _nft, uint256 _tokenId) external {
        ...
        require(listedNFT.seller == msg.sender, "no");
    ...
    function buy(
        ...
        require(!listedNft.sold, "ns");
        require(_price >= listedNft.price, "ip");
    ...
    function cancelOffer(address _nft, uint256 _tokenId) external {
        ...
        require(offer.offerer == msg.sender, "no");
        require(!offer.accepted, "oa");
    ...
    function acceptOfferNFT(
        ...
        UtilityArtNFT nft = UtilityArtNFT(offer.nft);
        address royaltyRecipient = nft.getRoyaltyRecipient();
        uint256 royaltyFee = nft.getRoyaltyFee();
    ...
    function createAuction(
        ...
        IERC721 nft = IERC721(_nft);
        require(nft.ownerOf(_tokenId) == msg.sender, "no");
        require(_endTime > _startTime, "it");
    ...
    function cancelAuction(address _nft, uint256 _tokenId) external {
        ...
        require(auction.creator == msg.sender, "nc");
        require(block.timestamp < auction.startTime, "as");
        require(auction.lastBidder == address(0), "ab");
    ...
    function placeBid(
        ...
        require(block.timestamp >= auctionNfts[_nft][_tokenId].startTime, "as");
        require(block.timestamp <= auctionNfts[_nft][_tokenId].endTime, "ae");
        require(
            _bidPrice >=
    ...
    function completeBid(address _nft, uint256 _tokenId) external {
        require(!auctionNfts[_nft][_tokenId].success, "ar");
        require(
            msg.sender == owner() ||
        ...
        UtilityArtNFT UnikNft = UtilityArtNFT(_nft);
