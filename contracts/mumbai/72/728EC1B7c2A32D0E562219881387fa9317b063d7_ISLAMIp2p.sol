...
*/
    ...
    function createOrder(
        ...
        allOrders[369].push(orderDetails
        (
                _type,
                orN, 
                msg.sender,
    ...
    function cancleOrder() external nonReentrant{
        ...
        fixOrders(_orderNumber);
        canCreateOrder[msg.sender] = true;
    }
    function fixOrders(uint256 _orderNumber) internal{
        /*for(uint i = _orderNumber; i < allOrders[369].length-1 ; i++){
            allOrders[369][_orderNumber] = allOrders[369][i+1];
        }*/
        allOrders[369][_orderNumber] = allOrders[369][allOrders[369].length - 1];
        allOrders[369].pop();
    }
