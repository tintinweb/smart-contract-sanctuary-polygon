...
contract cryptoChicken is ERC721URIStorageUpgradeable, OwnableUpgradeable, ICryptoChicken{
    ...
    function tokenURI(uint256 tokenId)public view virtual override returns (string memory){
        ...
        return string(abi.encodePacked("https://sayblowe-asset.s3.amazonaws.com/token-json/", StringsUpgradeable.toString(tokenId), "-token-uri.json"));
    }
...
interface ICryptoChicken {
    /**
     * @dev Emitted when new tokens are minted by CryptoChicken.
    */
