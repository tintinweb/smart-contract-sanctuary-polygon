...
contract LittlebitsNFT is VRFConsumerBaseV2, ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    uint public ME_MINT_PRICE = 0.01 ether;
    ...
    function ADMIN_registerCharacters(Character[] memory newCharacters) public onlyOwner {
        uint newCharactersLength = newCharacters.length;
        for (uint i = 0; i < newCharactersLength; i++) {
    ...
    function ADMIN_setAllowlistProtection(bool state) public onlyOwner {
