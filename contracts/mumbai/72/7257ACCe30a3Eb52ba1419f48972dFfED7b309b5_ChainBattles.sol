...
contract ChainBattles is ERC721URIStorage {
    ...
    function getLevel(uint256 tokenId) public view returns (string memory) {
        uint256 result = tokenIdToCharacteristics[tokenId].level;
        return result.toString();
    }

    function getSpeed(uint256 tokenId) public view returns (string memory) {
        uint256 result = tokenIdToCharacteristics[tokenId].speed;
        return result.toString();
    }

    function getStrength(uint256 tokenId) public view returns (string memory) {
        uint256 result = tokenIdToCharacteristics[tokenId].strength;
        return result.toString();
    }

    function getLife(uint256 tokenId) public view returns (string memory) {
        uint256 result = tokenIdToCharacteristics[tokenId].life;
        return result.toString();
    }
    ...
    function mint() public {
        ...
        tokenIdToCharacteristics[newItemId].speed = random() % 100;
        tokenIdToCharacteristics[newItemId].strength = random() % 100;
        tokenIdToCharacteristics[newItemId].life = random() % 100;
