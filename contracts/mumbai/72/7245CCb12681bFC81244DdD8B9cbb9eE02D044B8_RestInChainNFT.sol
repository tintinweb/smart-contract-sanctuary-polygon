...
contract RestInChainNFT is ERC721URIStorage, Ownable {
    ...
    function updateNFTData(uint256 itemId, string memory title, string memory subtitle, string[] memory descriptions) public {
    ...
    function sendToYard(uint256 tokenId) public {
        safeTransferFrom(ERC721.ownerOf(tokenId), address(this), tokenId);
    }
