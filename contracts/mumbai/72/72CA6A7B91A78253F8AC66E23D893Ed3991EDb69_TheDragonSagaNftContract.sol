...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x30506890D62Fa314779Ff3a928Ce2722cD579db4,0xFB5Dd3f0b468141Fd8d557295129533486dD8699];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 66, 6666 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmVFzwUVHvEJFmcB27zemcTxK8yQtxZSgqxDUuK3emnmCQ/";

    bool public mintingOpen = true;
    
    uint256 public PRICE = 166 ether;
...
// File: contracts/TheDragonSagaNftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheDragonSagaNftContract is RamppERC721A {
    constructor() RamppERC721A("The Dragon Saga NFT", "TDSNFT"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/43W9WijoGyH0kbGOEIT7/contract-metadata";
    }
}
