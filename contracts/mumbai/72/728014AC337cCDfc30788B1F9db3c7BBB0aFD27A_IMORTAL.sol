...
contract IMORTAL is Ownable, ERC20Burnable  {
    ...
    uint256 public windowOpens = 1681835250;
    uint256 public windowCloses = 1718560720;
    ...
    modifier mintRequirements(uint256 quantity, address to) {
        ...
        require(block.timestamp >= windowOpens && block.timestamp <= windowCloses, "Purchase window closed.");
        _;
    }
    ...
    function setWindow(uint256 _windowOpens, uint256 _windowCloses) external onlyOwner {
