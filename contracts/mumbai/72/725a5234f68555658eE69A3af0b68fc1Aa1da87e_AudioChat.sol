...
function deleteAudioChat(bytes32 audio_chat_id) public onlyOwner {
    //PLANNED, LIVE, CANCELED, READY, FINISHED
...
function updateAudioChat(bytes32 audio_event_id, string memory new_cid, uint256 start_at, bool is_indexed) public onlyOwner {
