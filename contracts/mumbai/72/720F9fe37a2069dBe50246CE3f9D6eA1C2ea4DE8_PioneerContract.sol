...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x7D25CB84CdfBDAF9A35dF24Be0a854E4D9d96f9d];
...
// File: contracts/PioneerContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract PioneerContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Pioneer";
    string public symbol = "pioneer";
