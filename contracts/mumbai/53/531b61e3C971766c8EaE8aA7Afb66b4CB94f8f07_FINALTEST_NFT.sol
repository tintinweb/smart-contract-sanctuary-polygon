...
contract FINALTEST_NFT is ERC721Royalty, Ownable, ContextMixin, ReentrancyGuard, AccessControl {
    ...
    constructor() ERC721("FinalTesting","Final") {
        _grantRole(DEFAULT_ADMIN_ROLE, 0x8d8d4ae71e3079F83C1d5e316810Ff214Ef88b0a);
        _grantRole(URI_SETTER_ROLE, 0x8d8d4ae71e3079F83C1d5e316810Ff214Ef88b0a);
        _grantRole(ADDING_LIST_ROLE, 0x8d8d4ae71e3079F83C1d5e316810Ff214Ef88b0a);
        _grantRole(FEE_CHANGER_ROLE, 0x8d8d4ae71e3079F83C1d5e316810Ff214Ef88b0a);
    }
