...
/// @author Panoram / @Mike_Bello90
/// @notice You can use this contract to calculate adn pay the user rewards for Minters(Builders), Holders and Rents.
contract RewardsPayer is AccessControl, HelperRewardsContract, IMortgageInterest, IUserRewards{
    ...
    /// @param _walletsUsers - Array of user wallets for which we must make the calculation. The relayer must filter the wallets to avoid duplicates.
    ...
    /// @dev CUANDO EL NUMERO DE WALLETS PARA LA QUE SE CALCULARA EL REWARD SEA MUY ALTO, EL AUTOTASK DEBE MANDAR A LLAMAR,
    ...
    /// @return PrePayPerNFT - the amount to pay per NFT in base 18 (18 decimals).
    ...
    /// @return PayPerNFT - the rent amount to pay per NFT in base 18 (18 decimals).
