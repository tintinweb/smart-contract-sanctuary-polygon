...
contract ParaAccount is ERC721Enumerable {
    ...
    function getAccount(uint256 tokenId, address implementation_) external view returns (address account) {
        return registry.account(implementation_, block.chainid, address(this), tokenId, SALT);
    }
}