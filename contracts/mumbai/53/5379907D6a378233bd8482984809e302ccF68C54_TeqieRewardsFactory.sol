...
import './TeqieRewards.sol';

contract TeqieRewardsFactory is Ownable {
    // immutables
    ...
    function deploy(address stakingToken, uint rewardAmount, uint256 rewardsDuration) public onlyOwner {
        ...
        info.stakingRewards = address(new TeqieRewards(/*_rewardsDistribution=*/ address(this), rewardsToken, stakingToken));
    ...
    function notifyRewardAmount(address stakingToken) public {
        ...
        if (info.rewardAmount > 0 && info.duration > 0) {
            ...
            TeqieRewards(info.stakingRewards).notifyRewardAmount(rewardAmount, duration);
        }
    }
...
contract TeqieRewards is RewardsDistributionRecipient, ReentrancyGuard {
