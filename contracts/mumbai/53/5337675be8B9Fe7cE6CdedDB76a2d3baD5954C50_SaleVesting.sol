...
contract SaleVesting is Context, Ownable, Initializable {
    ...
    IERC20 USDT = IERC20(0x95c4DB27f334e110Ac03613dE3823dD828D7e73E); // ERC20
    IERC20 USDC = IERC20(0x891f7C06a724Be869e02452CB7B5bF3e160132f1); // ERC20
    IERC20 BUSD = IERC20(0x16bDd11bFBb5ae07C378d80E12E2eeB49145D346); // ERC20
    IERC20 ElChai = IERC20(0xdb1bf8Bd69688a52A9303Eb59A3da305d5BF3f7c); // ERC20
    ...
    uint256 private TGE;
    uint256 private biWeekly = 180; // 1209600
