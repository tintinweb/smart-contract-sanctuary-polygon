...
// File: contracts/AbstractMintTokenFactory.sol
...
// File: contracts/SaveUkraineFactory.sol
...
contract SaveUkraineFactory is  AbstractMintTokenFactory  {
    ...
    function claim(
        ...
        uint256 excessPayment = msg.value.sub(tokenCost);
        if (excessPayment > 0) {
    ...
    function claimMultiple(
        ...
        require(arrayIsUnique(tokenIndexs), "Claim: claim cannot contain duplicate merkle proof indexes");
