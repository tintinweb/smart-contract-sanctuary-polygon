...
contract ActualLazyMint721Contract is ERC721LazyMint {
    constructor(
        string memory _name,
    ...
    //     uint256 _quantity
    // ) public view  {
    //     require(_tokenId == 0, "Doctor approval required");
    //     require(_quantity == 1, "You can only fill one script at a time");
    // }
