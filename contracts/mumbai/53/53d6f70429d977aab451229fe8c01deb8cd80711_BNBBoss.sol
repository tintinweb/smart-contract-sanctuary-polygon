...
contract BNBBoss {
	...
	uint256 constant public DEVELOPER_FEE = 25;
	...
	uint256 WITHDRAW_FEE_1 = 10; //5%
	uint256 WITHDRAW_FEE_2 = 10; //10%
	...
	constructor(address payable wallet, address payable _developer) public {
        ...
        plans.push(Plan(0, 0)); // 8% per day for 14 days
        plans.push(Plan(0, 0)); // 7.5% per day for 21 days
        plans.push(Plan(0, 0)); // 7% per day for 28 days
		plans.push(Plan(10, 200)); // 20% per day for 14 days (at the end, compounding)
        plans.push(Plan(20, 200)); // 7.5% per day for 21 days (at the end, compounding)
        plans.push(Plan(40, 50)); // 7% per day for 28 days (at the end, compounding)
	}
