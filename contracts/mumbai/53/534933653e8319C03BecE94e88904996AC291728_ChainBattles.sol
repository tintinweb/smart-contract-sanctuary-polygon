      ...
      constructor() ERC721("Chain Battles","CHBTLS"){
       ...
       function generateCharacter(uint256 tokenId) public view returns(string memory){
        ...
        bytes memory svg = abi.encodePacked(
            ...
            '<text x="10%" y="20%" class="base" dominant-baseline="middle" text-anchor="start">',"Warrior",'</text>',
            '<text x="10%" y="40%" class="base" dominant-baseline="middle" text-anchor="start">', "Level: ",getLevels(tokenId).level.toString(),'</text>',
            '<text x="10%" y="50%" class="base" dominant-baseline="middle" text-anchor="start">', "Speed: ",getLevels(tokenId).speed.toString(),'</text>',
            '<text x="10%" y="60%" class="base" dominant-baseline="middle" text-anchor="start">', "Strength: ",getLevels(tokenId).strength.toString(),'</text>',
            '<text x="10%" y="70%" class="base" dominant-baseline="middle" text-anchor="start">', "life: ",getLevels(tokenId).life.toString(),'</text>',
            '</svg>'
        );
