...
contract ERC1155Dao is IERC1155Dao, Ownable, Pausable, Auction {
     ...
     * @param tokenIdRef   Id of the token being transferred. (Reference)
     ...
     * @param tokenIdRef        id of the token being put into or pull out from an auction. (Reference)
     ...
     * @param tokenIdRef        id of the token being listed. (Reference)
     * @param serialNo          serial number of that particular token.
     ...
     * @param tokenIdRef    id of the token being activated. (Reference)
     ...
     * @param tokenIdRef            id of the token being lended. (Reference)
     * @param serialNo              serial number of the token.
     ...
     * @param tokenIdRef        id of the token. (Reference)
     * @param serialNo          serial number of the token.
    ...
    function buyFromContract(
        ...
        emit TransferSingle(address(this), buyer, tokenId, tokenId, serialNo);
    }
    ...
    function buyFromUser(
        ...
        emit TransferSingle(from, to, tokenId, tokenId, serialNo);
    }
    ...
    function activateToken(
        ...
        emit TokenActivate(tokenId, tokenId, serialNo, block.timestamp);
    }
...
contract Auction is IAuction {
     ...
     *
     * Signature for Bid(string,string,uint256,address,uint256,uint256,bool) : `0x1d6ea0a7`
     *
     * @param tokenId       Id of the token being bidded on.
     * @param tokenIdRef    Id of the token being bidded on. (Reference)
     * @param serialNo      serial number of token assigned to that token.
    ...
    function _revokeBid(
        ...
        emit Bid(tokenId, tokenId, serialNo, msg.sender, 0, 0, false);
    }
