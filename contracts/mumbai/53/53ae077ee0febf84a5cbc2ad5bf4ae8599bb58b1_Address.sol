...
// File: contracts/zhunai.sol



/**
    Welcome to the Spoiled Bear Club that her mother spoiled so much. Some appear normal.
    Some look weird. And some are just damn cool! Maybe you have a few.
*/
...
contract Zhunai is ERC721Enumerable, Ownable {
  using Strings for uint256;
