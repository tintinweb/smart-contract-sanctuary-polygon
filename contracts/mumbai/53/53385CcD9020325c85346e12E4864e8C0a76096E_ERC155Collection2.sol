 ...
 * @notice This contract handles minting ERC-155Collection2 tokens.
 */
contract ERC155Collection2 is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xFc16bB2aE64e695F146Df15fD8c01A650F08BE36;
    ...
    string public name = "ERC-155Collection2";
    string public symbol = "ERC1552";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeic4wh4ddocgadpsv3mnnh5eeud25aot3c5dgyooyltftjjugb2ix4/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[324124] = 5;
        tokenPublicPrice[324124] = 0 ether;
        tokenPublicMintsPerAddress[324124] = 5;
        require(
