    ...
    BasicMetaTransaction
{
    ...
    mapping(uint256 => uint256) public TotalMUSDbyEstateID;
    mapping(uint256 => uint256) public withdrawnMUSDByEstateID;
    //------------Modifiers-------------------------//
    ...
    function getVestedTokenAmount(uint256 _estateID)
        ...
        returns (uint256)
    {
        //require(,"Vesting: vesting for estateID not added");
        IICO.ICO_SetupStruct memory icoData = ICO.getICOinfo(_estateID);
        IDEED.Agreement memory deedData = DEED.agreements(_estateID);
        ...
        onlyPropertyOwner(_estateID, _msgSender())
    {
        ...
        // require( propertyOwnerToken[_estateID][claimAddress]>0);
        balanceStruct storage tempAdminStruct = getAdminBalance[_estateID][
            claimAddress
        ];
    ...
    function withdraw(
        ...
        if (
            withdrawnMUSDByEstateID[_estateID] + musd >
            TotalMUSDbyEstateID[_estateID]
        ) {
