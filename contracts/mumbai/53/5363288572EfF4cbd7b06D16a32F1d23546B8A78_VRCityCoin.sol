    ...
    ReentrancyGuard
{
    ...
    constructor(uint32 _reserveRatio, address _USDCAddress)
    ...
    function purchase(uint256 _usdcAmount) external override nonReentrant {
        ...
        uint256 purchaseAmount = getPurchaseAmount(_usdcAmount);
...
interface IVesting {
     ...
     * @param recipient is the address to which the withdrawal was made.
...
interface IVRCityCoin is IERC20 {
     ...
     * @param _daiAmount is the number of stablecoins 
     for which the purchase of tokens was made.
     */
    function purchase(uint256 _daiAmount) external;
     ...
     */
    function getPurchaseAmount(uint256 _daiAmount)
        external
        view
        returns (uint256);
     ...
     * @dev The exchange rate is calculated by the Bancor formula. 
     * @param _tokenAmount is the number of tokens sold .
     * @return daiAmount - the amount of stablecoins.
     */
    function getSaleAmount(uint256 _tokenAmount)
        external
        view
