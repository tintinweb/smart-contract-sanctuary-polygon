 ...
 * Coin Address : 0xdec594Fb53B0c7fC78C198D9dA715049b46b0250
 * Number of schemes : 1
 ...
 * ERC20 Transfer : 0xdec594Fb53B0c7fC78C198D9dA715049b46b0250, _stakeAmt
...
*/
	function stake(uint256 _stakeAmt) public {
		...
		ERC20(0xdec594Fb53B0c7fC78C198D9dA715049b46b0250).transferFrom(msg.sender, address(this), _stakeAmt);
...
*/
	function unstake(uint256 _unstakeAmt) public {
		...
		require((ERC20(0xdec594Fb53B0c7fC78C198D9dA715049b46b0250).balanceOf(address(this)) >= (_unstakeAmt + interestToRemove)), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		ERC20(0xdec594Fb53B0c7fC78C198D9dA715049b46b0250).transfer(msg.sender, (_unstakeAmt + interestToRemove));
...
*/
	function withdrawInterestWithoutUnstaking(uint256 _withdrawalAmt) external {
		...
		require((ERC20(0xdec594Fb53B0c7fC78C198D9dA715049b46b0250).balanceOf(address(this)) >= _withdrawalAmt), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		ERC20(0xdec594Fb53B0c7fC78C198D9dA715049b46b0250).transfer(msg.sender, _withdrawalAmt);
...
*/
	function withdrawToken(uint256 _amt) public onlyOwner {
		require((ERC20(0xdec594Fb53B0c7fC78C198D9dA715049b46b0250).balanceOf(address(this)) >= (_amt + totalAccumulatedInterest() + totalStakedAmount())), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		ERC20(0xdec594Fb53B0c7fC78C198D9dA715049b46b0250).transfer(msg.sender, _amt);
	}
}