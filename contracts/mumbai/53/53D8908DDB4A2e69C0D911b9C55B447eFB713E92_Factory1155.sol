...
import "./OwnGoMVBUser1155Token.sol";
...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new GoMVBUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        GoMVBUser1155Token token = GoMVBUser1155Token(address(addr));
...
contract GoMVBUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
