...
contract IbrahimStaking is Ownable, ReentrancyGuard {
    ...
    mapping(uint256 => stakeInfo) public stakedTokenInfo;
    ...
    stakingIsEnabled
    {
        ...
        stakedTokenInfo[tokenId] = stakeInfo(tokenId, msg.sender, block.timestamp);
    ...
    function unstake(
        ...
        delete stakedTokenInfo[tokenId];
    ...
    function getAllStakedList() public view returns(stakeInfo[] memory) {
        ...
        for(uint256 i = 0; i < stakedTokenList.length; i++) {
            stakedTokens[i] = stakedTokenInfo[stakedTokenList[i]];
        }
        return stakedTokens;
    }
