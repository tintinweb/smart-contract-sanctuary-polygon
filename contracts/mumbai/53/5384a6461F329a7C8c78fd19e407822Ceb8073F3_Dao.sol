...
contract Dao{
    ...
    constructor(){
        owner=msg.sender;
        nextProposal=1;
        daoContract=IdaoContract(0xC58020AA2E32712085EFCA3c2a6b9cBAf25B0105);
        validTokens=[89332013039134258429252004933257445937238068498758493960448920098722283520012];
    }
    ...
    function voteOnProposal(uint256 _id,bool _vote) public{
        require(Proposals[_id].exists,"This Proposal does nor exist");
        require(checkVoteEligibility(_id, msg.sender),"You can vote on this Proposal");
