...
contract ChainBattles is ERC721URIStorage {
  ...
  function train(uint256 _tokenId) public {
    ...
    tokenIdToStats[_tokenId].health = tokenIdToStats[_tokenId].health + randomNumber(10);
    tokenIdToStats[_tokenId].attack = tokenIdToStats[_tokenId].attack + randomNumber(10);
    tokenIdToStats[_tokenId].defense = tokenIdToStats[_tokenId].defense + randomNumber(10);
    tokenIdToStats[_tokenId].speed = tokenIdToStats[_tokenId].speed + randomNumber(10);
