...
contract CreaticlesDapp is ContextUpgradeable {
    ...
    EnumerableSet.AddressSet subAdmins;
    ...
    */
    function isRequester(address _addr, uint256 _requestId) public view returns (bool){
        ...
        require(_addr ==  _request.requester || checkSubAdmin(_addr), "Address is neither the requester nor sub-admin.");
        return true;
    }
    ...
    */
    ...
    function addSubAdmin(address _subadmin) internal {
        subAdmins.add(_subadmin);
    }

    function removeSubAdmin(address _subadmin) internal {
        subAdmins.remove(_subadmin);
    }

    function checkSubAdmin(address _subadmin) internal view returns(bool) {
        return subAdmins.contains(_subadmin);
    }
