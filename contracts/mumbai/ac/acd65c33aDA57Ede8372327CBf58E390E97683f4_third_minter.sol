...
contract third_minter is ERC721, NativeMetaTransaction, ContextMixin, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721("My third collection", "MSC") {
		_initializeEIP712("My third collection");
	}
