...
contract AaveLeverageModule is ModuleBase, ReentrancyGuard, Ownable, IModuleIssuanceHook {
     ...
     */
    function updateAllowedMatrixToken(IMatrixToken matrixToken, bool status) external onlyOwner {
     ...
     */
    function updateAnyMatrixAllowed(bool anyMatrixAllowed) external onlyOwner {
