...
contract CircleNFTSimple is ERC721, Ownable {
    using Strings for uint256;
    ...
    function setRadius(uint256 tokenId, uint256 radius) public {
        require(_exists(tokenId), "not exist");
        require(radius <= maxRadius, "circle would exceed max radius");
        require(radius >= 0, "circle would have neg radius");
        radii[tokenId] = radius;
    }
