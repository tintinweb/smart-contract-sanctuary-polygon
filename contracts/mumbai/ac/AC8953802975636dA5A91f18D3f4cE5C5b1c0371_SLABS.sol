...
contract SLABS is ERC20 {
    ...
    uint8 private _decimal = 2; // cents decimals digits amount
    ...
    */
    ...
    constructor(string memory name, string memory symbol, uint _initialSupply) ERC20(name, symbol) {
        // Constructor on deploy contract: "Starter Labs","SLABS",10000000
    ...
    // Override the decimals to 2 decimals to look like a stable coin or a minimal decimals
