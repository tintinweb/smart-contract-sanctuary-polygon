...
import "contracts/Interfaces/IFractionToken.sol";
import "contracts/Interfaces/INoCapFactory.sol";
import "hardhat/console.sol";

contract NoCapFractionTokenFactory is Initializable, OwnableUpgradeable {
    ...
    function init(address _tokenTemplate, address _admin, address _identityRegistry, address _noCapFactroy) external initializer{
    ...
    function deployTokenForNFT(string memory _name, string memory _symbol,uint8 _decimals, uint256 _tokenId, uint256 _maxFractions) external returns(address) {
        ...
        IFractionToken(tokenST).init(_name, _symbol, _decimals, msg.sender, _tokenId,identityRegistry,_maxFractions,msg.sender);
        return tokenST;    
    }
