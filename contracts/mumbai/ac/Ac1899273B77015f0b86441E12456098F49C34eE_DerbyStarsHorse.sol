...
contract DerbyStarsHorse is ERC721, HorseProperty {
    ...
    function mintSoul(uint256 soulTokenId) public {
        ...
        nonOriginTokenId += 1;
        motherTokenIds[nonOriginTokenId] = derbyStarsSoul.motherTokenIds(soulTokenId);
        fatherTokenIds[nonOriginTokenId] = derbyStarsSoul.fatherTokenIds(soulTokenId);
    ...
    function setProperties(uint256 tokenId) external {
        ...
        properties[tokenId] = breedingCalculator.calculateProperties(
            properties[motherTokenIds[tokenId]],
            properties[fatherTokenIds[tokenId]],
