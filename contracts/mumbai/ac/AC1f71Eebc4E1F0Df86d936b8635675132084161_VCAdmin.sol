...
interface IVCAdmin {
    struct ParamsSetup {
        ...
        address _marketplaceFixedPricePocNft;
        address _marketplaceAuctionPocNft;
        address _marketManager;
    }

    event ProtocolSetup(ParamsSetup params);
    ...
    function setStarer(address _starter) external;
...
contract VCAdmin is IVCAdmin {
    ...
    IArtNftERC1155 public artNft1155;
    IArtNftERC721 public artNft721;
    ...
    function setupProtocol(ParamsSetup calldata params) external {
        ...
        pool = IVCPool(params._vcPool);
        starter = IVCStarter(params._vcStarter);
        artNft1155 = IArtNftERC1155(params._artNft1155);
        artNft721 = IArtNftERC721(params._artNft721);
        marketManager = IVCMarketManager(params._marketManager);

        IVCMarketplace(params._marketplaceFixedPrice1155).setAdmin(params._marketManager);
        IVCMarketplace(params._marketplaceFixedPrice721).setAdmin(params._marketManager);
        IVCMarketplace(params._marketplaceAuction721).setAdmin(params._marketManager);
        IVCMarketplace(params._marketplaceFixedPricePocNft).setAdmin(params._marketManager);
        IVCMarketplace(params._marketplaceAuctionPocNft).setAdmin(params._marketManager);

        _setPoCNft(params._pocNft);
        _setCurrency(params._currency);
        _setStarter(params._vcStarter);
        _setPool(params._vcPool);

        artNft721.setApproverRole(params._marketManager, true);
        artNft1155.setApproverRole(params._marketManager, true);

        artNft1155.setMinterRole(params._marketplaceFixedPrice1155, true);
        artNft721.setMinterRole(params._marketplaceFixedPrice721, true);
        artNft721.setMinterRole(params._marketplaceAuction721, true);
        _protocolSetup = true;

        emit ProtocolSetup(params);
    }
...
interface IVCMarketplace {
    ...
    function setMinPoolFeeBps(uint96 _minTotalFeeBps) external;
