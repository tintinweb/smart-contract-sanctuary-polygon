...
contract PaymentReceiver is IAccessControlHolder, IPaymentReceiver {
    ...
    function buyGems(
        ...
        _ensureSignatureIsNotExceeded(_deadline);
        paymentToken.transferFrom(msg.sender, treasury, _price);
    ...
    function _ensureSignatureIsNotExceeded(uint256 _deadline) internal view {
        if (block.timestamp > _deadline) {
            revert SignatureExceeded(_deadline);
        }
    }
}