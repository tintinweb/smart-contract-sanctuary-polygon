...
contract Staking {
    ...
    // Map of addresses to their staked balance
    mapping (address => uint256) public stakes;
    
    // Event for when someone stakes tokens
    ...
    function stake(uint256 amount) public {
        // Require the caller to have enough tokens
        ...
        // Update the staker's staked balance
    ...
    function unstake(uint256 amount) public {
        // Require the caller to have enough staked tokens
        require(stakes[msg.sender] >= amount, "Not enough staked tokens");
        
        // Transfer the unstaked tokens back to the contract
