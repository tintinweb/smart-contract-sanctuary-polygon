...
contract NFT is ERC721, Ownable {
    ...
    constructor() ERC721("Andron_Test9", "ANDT9") {
        baseUri = "ipfs://QmXyN4Q3BTonGndQsNgQNSYmi8Ezw6ZdFMZdrNqN4dDWx3/";
    ...
    // Public Functions
    function mintthatnft(uint256 _numTokens) public payable {
        ...
        require(_numTokens * price / 5 <= msg.value, "Insufficient funds.");
