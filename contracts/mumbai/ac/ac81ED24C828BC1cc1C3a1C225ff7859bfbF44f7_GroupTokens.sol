...
contract GroupTokens is ERC721Upgradeable, ERC721EnumerableUpgradeable, PausableUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    */
    ...
    function updateDetails(uint256 tier1, uint256 tier2, uint256 tier3, uint256 tier4, uint256 _maxGroupNameSize) public onlyAdmins {
    ...
    */
    function mintGroup(string calldata groupName) public payable whenNotPaused nonReentrant {
        ...
        // Send the funds to the vault for minting
    ...
    */
    function checkMultiSigLock(uint256 tokenID) public view returns (address) {
        // Show the Multi Sig Address
        if (multiSigLock[tokenID].isLocked){
    ...
    */
    function isMultiSigLocked(uint256 tokenID) public view returns (bool[2] memory) {
        ...
        if (multiSigLock[tokenID].lockedBy != ownerOf(tokenID)){
            isAddrAdded = true;
        }
    ...
    */
    ...
    function updateGroupMetadata(uint256 groupID) internal {
