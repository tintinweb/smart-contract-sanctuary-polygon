...
contract ChainBattlesV3 is ERC721URIStorage {
    ...
    function generateCharacter(uint256 tokenId) public returns (string memory) {
        bytes memory svg = abi.encodePacked(
            ...
            '<rect width="100%" height="50%" fill="#654321" />',
            "<g>",
            '<svg x="30%" y="10%" fill="#000000" width="60px" height="60px" viewBox="0 0 128 128" enable-background="new 0 0 128 128" version="1.1" xml:space="preserve" xmlns="http://www.w3.org/2000/svg">',
            ...
            "</svg>",
            "</g>",
            '<text x="56%" y="19%" class="base" dominant-baseline="middle" text-anchor="middle">',
            "Warrior",
            "</text>",
            '<text x="50%" y="32%" class="base" dominant-baseline="middle" text-anchor="middle">',
            "Level: ",
            getLevels(tokenId),
            "</text>",
            '<text x="50%" y="42%" class="base" dominant-baseline="middle" text-anchor="middle">',
            "Strength: ",
            getStr(tokenId),
            "</text>",
            "</svg>"
