 ...
 * @notice EARLY ADOPTERS - maxAmount: 12.000.000, cliff: 2 months, vesting: 16 months, tgePercent: 6%
 ...
 * @notice LIQUIDITY/MARKET MAKING - maxAmount: 4.000.000, cliff: 0 months, vesting: 0 months
 * @notice STAKING REWARDS - maxAmount: 83.000.000, cliff: 0 months, vesting: 0 months
 * @notice RESERVE - maxAmount: 4.000.000, cliff: 0 months, vesting: 4 months, tgePercent: 5%
 */
contract ENFVesting is AccessControl, ReentrancyGuard {
    ...
    constructor(IERC20 tokenAddress) {
        ...
        _vestingDetails[4] = VestingDetails("EARLY ADOPTERS", 12_000_000 * 1e18, 2 * 30 days, 16 * 30 days, 600, 0);
        ...
        _vestingDetails[8] = VestingDetails("STAKING REWARDS", 83_000_000 * 1e18, 0 * 30 days, 0 * 30 days, 0, 0);
        _vestingDetails[9] = VestingDetails("RESERVE", 4_000_000 * 1e18, 0 * 30 days, 4 * 30 days, 500, 0);
    }
