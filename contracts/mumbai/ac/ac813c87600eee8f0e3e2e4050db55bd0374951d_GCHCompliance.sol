...
// File: contracts/compliance/legacy/deployed/GCHCompliance.sol
...
contract GCHCompliance is ApproveTransfer, CountryWhitelisting {
    /**
    ...
    */
    ...
    function canTransfer(address _from, address _to, uint256 _value) external view override returns (bool) {
        if (
            !complianceCheckOnApproveTransfer(_from, _to, _value) ||
            !complianceCheckOnCountryWhitelisting(_from, _to, _value))
        {
            return false;
        }
        return true;
