...
contract AddressBook is Initializable, WheelcoinRoles {
    ...
    function setAddress(string calldata _contractName, address _addr) public onlyRole(ADMIN_ROLE) {
        _contracts[_contractName] = _addr;
        emit AddressSet(_contractName, _addr);
    }

    //TODO: Think about permissions
    function removeAddress(string calldata _contractName) public onlyRole(ADMIN_ROLE) {
        delete _contracts[_contractName];
        emit AddressSet(_contractName, address(0));
    }

    function getAddress(string calldata _contractName) public view returns (address _addr) {
