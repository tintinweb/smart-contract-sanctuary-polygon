...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x9Da9B979F0Ec55ce9e3C16c05D74aef3eD090c85];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 10, 2750 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmYMC8ALMvttquQwcWrh9d7orxVGd5gJoMwcd6xV8jkvZi/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 2750");
        _safeMint(_to, 1);
    }
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 2750");
...
// File: contracts/HybridGreyCollectionVol1Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract HybridGreyCollectionVol1Contract is RamppERC721A {
    constructor() RamppERC721A("Hybrid Grey Collection Vol 1", "HGC"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/2EhCDNGfWqGN74bZyfhE/contract-metadata";
    }
}
