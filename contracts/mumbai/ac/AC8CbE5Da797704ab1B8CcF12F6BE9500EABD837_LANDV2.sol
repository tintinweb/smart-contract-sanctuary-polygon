    ...
    UUPSUpgradeable
{
    function initialize() public initializer {
        __ERC721_init("Coderblock World", "LAND");
        __Ownable_init();
    ...
    function authorizeDeploy(address beneficiary) external onlyProxyOwner {
        require(beneficiary != address(0), "Beneficiary cannot be the zero address, invalid");
        require(authorizedDeploy[beneficiary] == false, "Beneficiary is already authorized");
    ...
    function _encodeTokenId(int256 x, int256 y) internal pure returns (uint256 results) {
        require(
    ...
    mapping(uint256 => address) _holderOf;
    ...
    function _authorizeUpgrade(address newImplementation) internal override onlyOwner {
        currentContract = newImplementation;
    }
}
...
import "./upgradeable/ProxyStorage.sol";
import "./Land/LANDStorage.sol";

contract Storage is ProxyStorage, LANDStorage {}
