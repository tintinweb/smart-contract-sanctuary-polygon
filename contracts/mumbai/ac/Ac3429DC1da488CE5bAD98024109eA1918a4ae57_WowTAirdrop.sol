  ...
  ERC721URIStorageUpgradeable
{
  ...
  function mintTo(
    ...
    points.reducePoints(to, nftPoints);
  }
  ...
  function getNFT(
    ...
    public
    view
    returns (string memory, string memory, address, string memory, uint256)
  {
    string memory communityName = tokenToCommunity[_tokenId];
    CommunityDetails storage communityDetail = communityDetails[communityName];
    require(_tokenId < _tokenIdCounter.current(), 'Invalid post ID');
