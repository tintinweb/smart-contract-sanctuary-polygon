...
contract CardContract is ERC721, Ownable {
    ...
    function mergeCard(string memory tokenId,string[] memory burnedTokenId) public view returns(uint256){
        //bisogna sistemare la cosa dei "medias"
        //la carta che si trasforma, ha la image nei medias, in base a cosa si trasforma
        //madias -> una struct, di struct, perche se ├¿ alternative coombo non si sa con quale si deve trasformare
