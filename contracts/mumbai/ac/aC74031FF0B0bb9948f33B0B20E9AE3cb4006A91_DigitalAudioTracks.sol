...
contract DigitalAudioTracks is ERC1155 {
    ...
    function testFunctionExecute(string calldata _val) public {
        testVal = _val;
    }
    ...
    function issueToken(
    ...
    ) public payable { //onlyProjectAdmin payable
        ...
        //(bool paymentSuccess, ) = payable(address(this)).call{ value: msg.value}("");
        //require(paymentSuccess, "Payment was not successful");
        //{
...
contract ArtistAgreement is ERC1155 {
    ...
    constructor(
        ...
        ERC1155("https://app.paradimeaudio.com/api/NFT/ArtistAgreement/Token/{id}.json") { //isValidCreatorStakes(_owners, _residualOwners) 
...
library TokenConsumptionTerms {
    ...
    */
     ...
     */
    function addAdmin(PermissionsAndRoyalties storage self, address _newAdmin) external { //isAdmin(self)
