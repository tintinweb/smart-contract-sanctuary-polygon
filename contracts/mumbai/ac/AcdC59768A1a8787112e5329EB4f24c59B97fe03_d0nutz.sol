...
contract d0nutz is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("d0nutz", "DNTZ") {}

    function setWhiteListContract(
        address _newContractAddress
    ) public onlyOwner {
        _whitelistContract = _newContractAddress;
    }
    ...
    function mint() public payable onlyWhenNotPaused {
        require(msg.sender == _whitelistContract, "Not authorized");
        require(tokenIds < maxTokenIds, "Exceed maximum d0nutz supply");
        tokenIds += 1;
