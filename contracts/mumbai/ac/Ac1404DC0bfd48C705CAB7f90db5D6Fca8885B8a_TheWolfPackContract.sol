...
//*********************************************************************//
//
//   ________            _       __      ______   ____             __  
//  /_  __/ /_  ___     | |     / /___  / / __/  / __ \____ ______/ /__
//   / / / __ \/ _ \    | | /| / / __ \/ / /_   / /_/ / __ `/ ___/ //_/
//  / / / / / /  __/    | |/ |/ / /_/ / / __/  / ____/ /_/ / /__/ ,<   
// /_/ /_/ /_/\___/     |__/|__/\____/_/_/    /_/    \__,_/\___/_/|_|  
//                                                                     
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xC52E19ccbaCa6932bd071966C11ed48183c9555b];
  address public erc20Payable = 0xC52E19ccbaCa6932bd071966C11ed48183c9555b;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 2023) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://metadata.mintfoundry.xyz/c/6tuBBYNzPbhXiucOHw1x/token/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/wktG8Fs4AaRUJmlB5pln/contract-metadata";
  }
...
// File: contracts/TheWolfPackContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheWolfPackContract is ERC721APlus {
    constructor() ERC721APlus("The Wolf Pack", "TWP"){}
}
