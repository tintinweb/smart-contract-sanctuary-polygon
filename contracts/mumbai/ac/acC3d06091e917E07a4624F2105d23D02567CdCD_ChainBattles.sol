...
contract ChainBattles is ERC721URIStorage {
    ...
    uint256 private initialNumber = 0;
    ...
    function getLevels(uint256 tokenId) public view returns (string memory) {
        Character storage character = tokenIdToLevels[tokenId];
    ...
    // function getCharacters(uint256 tokenId) public view returns (string memory) {
    ...
    function mint() public {
        ...
        tokenIdToLevels[newItemId] = Character(
            random(10), random(100), random(150), random(200)
        );
    ...
    function train(uint256 tokenId) public {
        ...
        Character storage character = tokenIdToLevels[tokenId];
        tokenIdToLevels[tokenId] = Character(
            character.level + 1, 
            character.speed + 1,
