...
// File: contracts/Asgardiumv2.sol
...
contract Asgardiumv2 is Context, IERC20, Ownable {
    ...
    address payable public _taxPool =
        payable(address(0x9f215DC6B8c8eE6356D9c68b78407Cb0Ff869e8f));

    string private _name = "Asgardiumv2";
    string private _symbol = "AS2";
    ...
    uint256 public _maxTxAmount = 5 * 10**10 * 10**18; // 0.5% of total supply
    uint256 public _maxWalletSize = 2 * 10**11 * 10**18; // 2% of total supply

    event botAddedToBlacklist(address account);
    event botRemovedFromBlacklist(address account);

	//buyFee.tax and sellFee.tax  goes to holders as reflection reward for every transaction 
    ...
    constructor() {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
			...
			//testnet: 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff
