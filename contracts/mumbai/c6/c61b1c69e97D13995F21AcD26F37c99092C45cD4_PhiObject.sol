...
contract PhiObject is ERC1155Supply, BaseObject {
     ...
     */
    function getPhiObject(address to, uint256 tokenId) external onlyOwner {
...
abstract contract BaseObject is MultiOwner, IERC2981, ReentrancyGuard {
    ...
    function setCreator(uint256 tokenId, address payable creator) public virtual onlyOwner {
    ...
    function getCreator(uint256 tokenId) external view returns (address payable) {
