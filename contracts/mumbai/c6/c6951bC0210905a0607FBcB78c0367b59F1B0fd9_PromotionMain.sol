...
contract PromotionMain is ReentrancyGuard /*,ZkConnect */ {
    ...
    constructor() // bytes16 sismoAppId,
    ...
    function claimPromotion(
        ...
        address claimer // bytes memory zkConnectResponse, // bytes calldata encodedParams, // uint root, // uint nullifierHash, // uint[8] calldata worldcoinProof
    ) public {
        // Verifications
