...
contract Market1155 is ERC1155Holder, ReentrancyGuard {
    ...
    function setListingPrice(uint256 _price) public {
        require(msg.sender == owner, "You_are_not_allow");
        listingPrice = _price;
    }
    ...
    function createMarketItem(
        ...
        require(
            isContract(nftContract) == true,
            "Collection is not contract address"
        );
        require(msg.sender == owner, "You_are_not_allow");
    ...
    function createBatchMarketSale(
        ...
        require(idLength == amounts.length, "Amounts & Ids are not match");
        ...
        if (allItems.length == idLength) {
            ...
            // console.log(279, totalCollection, totalPurchase);
            require(
                totalCollection > totalPurchase,
                "You can't buy all collection"
            );
        }
    ...
    function createPaperMarketGift(
        ...
        require(isContract(paper) == true, "wrong Paper's address");
        require(isContract(receiver) != true, "Receiver can' be contract");
        require(msg.sender != receiver, "You can't gift to yourself");
        require(receiver != address(0), "You can't destroy the token");
        require(
            IToken1155(paper).isApprovedForAll(msg.sender, address(this)) == true,
        ...
        require(
            // IToken1155(token).balanceOf(market, tokenId) >= _quantity,
             IToken1155(paper).balanceOf(address(msg.sender), tokenId) >= amount,
    ...
    function createBatchMarketGift(
        ...
        nonReentrant
    {
        require(isContract(receiver) != true, "Receiver can't be contract");
        require(msg.sender != receiver, "You can't gift to yourself");
        require(receiver != address(0), "You can't destroy the token");
        ...
        require(tokenIdLen == amounts.length, "Amounts & Ids are not match");
