...
contract LaunchpadV1 is Ownable, ReentrancyGuard 
{
    ...
    //zenda - 0x0636FE4e3710d9340e2f20137967f187211EB8F30x0636FE4e3710d9340e2f20137967f187211EB8F3
    //usdt  - 0x0636FE4e3710d9340e2f20137967f187211EB8F3
    ...
    {
        require(block.timestamp >= startWhitelistPhase,"whitelist has not been started yet");
        require(block.timestamp <= endWhitelistPhase,"whitelist have ended");
        _;
    }

    modifier onlyFCFSPhase()
    {
        require(block.timestamp > endWhitelistPhase,"whitelist have not ended");
        require(block.timestamp <= endFCFSPhase,"FCFS phase have ended");
        _;
    }

    modifier onlyDistributionPhase()
    {
        require(vestingStartTimestamp > 0, "Vesting has not yet intiated");
        require(block.timestamp > vestingStartTimestamp, "Vesting has not yet started");
        _;
    }
        ...
        returns(bool) 
    {
        ...
        require(total == 100, "total of ratios should be 100");
