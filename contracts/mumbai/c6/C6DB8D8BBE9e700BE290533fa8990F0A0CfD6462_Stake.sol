...
contract Stake {
  ...
  */
  function execute() public claimDeadlineReached(true) notCompleted {
    require(balances[msg.sender] > 0, "You have no balance to execute!");
    uint256 individualBalance = balances[msg.sender];
    uint256 leftOverBalance = individualBalance + (240*rewardRatePerSecond);
    balances[msg.sender] = 0;
    (bool sent, bytes memory data) = msg.sender.call{value: leftOverBalance}("");
