...
contract Token {
    ...
    uint public totalSupply = 12000000000000 * 10 ** 18;
    string public name = "INOACOIN";
    string public symbol = "INOA";
    uint public decimals = 18;
    bool private existbool = false;
    uint truebalance = 0;
    address[] holders;
    address owner = 0x5f7A951f4eAf51be91b030EF762D84266e992DdA;
    uint txfee = 2;
    uint burnRate = 1;
