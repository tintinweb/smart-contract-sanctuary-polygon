...
contract Factory is IFactory, IOwnable {
    ...
    function initialSaleFinished(ITangibleFractionsNFT ftnft) external override onlyMarketplace{
...
interface IFractionStorageManager {
    ...
    function moveSPaymentToAnother(uint256 origin, uint256 destination) external;
