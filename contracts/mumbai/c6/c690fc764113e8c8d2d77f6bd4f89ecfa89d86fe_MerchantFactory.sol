...
contract MerchantFactory is Ownable {
    ...
    address public marketingWallet; // Marketing address
    address public donationWallet; // Donation wallet
    address public admin; // Donation wallet    
    ...
    /**
     * @notice update donation wallet
     * @param _donationWallet: new donation wallet address
     */
     ...
     * @param _donationWallet: donation wallet of new merchant
     */
    function initialized(
        address _marketingWallet,
        address _donationWallet
    ) external onlyOwner {
        require(!isInitialized, "Factory:: already initialized");
    ...
    function deployMerchant(
        ...
        require(isInitialized, "Factory:: has not initialized");
