...
contract MobLDN is ERC1155, Ownable {
    using Strings for uint256;

    string public constant INITIAL_BASEURI =
        "https://nftstorage.link/ipfs/bafybeibcauaxkipbs4z6eo2hgztnknvlz6wxl2cirum6llmd5c4uehw2em/";

    string public name = "Internet of Mobility Mobsters - London";
    string public symbol = "MOBLDN";
