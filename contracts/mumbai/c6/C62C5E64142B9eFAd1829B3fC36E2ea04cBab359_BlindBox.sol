...
contract BlindBox is OwnableUpgradeable, ItemPool, ReentrancyGuardUpgradeable {
    ...
    uint256 constant public all_count_n = 480;
    uint256 constant public all_count_s = 520;
    ...
    function updateMaxCountUserN(uint256 maxCount) external onlyOwner
    {
        max_count_user_n = maxCount;
    }

    function updateMaxCountUserS(uint256 maxCount) external onlyOwner
    {
        max_count_user_s = maxCount;
    }

    function updateStartEndTime(uint256 _startTime, uint256 _endTime) external onlyOwner
    {
        start_time = _startTime;
        end_time = _endTime;
    }

    function random(uint256 boxType, uint256 index) public view returns (uint256)
    {
    ...
    function buyBox(uint256 amount, uint256 boxType) external payable nonReentrant
    {
        ...
        if (boxType == ITEM_TYPE_1)
        {
            require(valid_count_n >= amount, "amount error");
            require(user_buy_count_n[_msgSender()] + amount <= max_count_user_n, "amount limit");
            init_item_pool = item_pool_n;
            init_total_weight = total_weight_n;
        }
        else
        {
            require(valid_count_s >= amount, "amount error");
            require(user_buy_count_s[_msgSender()] + amount <= max_count_user_s, "amount limit");
        ...
        {
            uint256 random_val = random(boxType, i);
            uint256 tmp_sum = 0;
        ...
        if (boxType == ITEM_TYPE_1)
        {
            ...
            valid_count_n -= amount;
            user_buy_count_n[_msgSender()] += amount;
        }
        else
        {
            total_weight_s = init_total_weight;
            valid_count_s -= amount;
            user_buy_count_s[_msgSender()] += amount;
        }
    }
    ...
    function sendReward(ITEM_POOL memory _reward_item) internal
    {
        ...
        {
            //ERC20 N
            token_n.transfer(_msgSender(), _reward_item.item_amount * (10 ** 18));
        }
        else if (_reward_item.item_type == ITEM_TYPE_2)
        {
            //ERC20 S
            token_s.transfer(_msgSender(), _reward_item.item_amount * (10 ** 18));
        }
        else
        {
            //ERC721
...
abstract contract ItemPool {
    ...
    function _initItemPoolN() internal
    {
        ...
        item_pool_n.push(ITEM_POOL(1, 40, 100, 5000));
        item_pool_n.push(ITEM_POOL(1, 40, 200, 3500));
        item_pool_n.push(ITEM_POOL(1, 40, 500, 1200));
        item_pool_n.push(ITEM_POOL(1, 40, 100, 1000));
        item_pool_n.push(ITEM_POOL(1, 40, 200, 500));
        item_pool_n.push(ITEM_POOL(1, 40, 500, 100));
        item_pool_n.push(ITEM_POOL(10, 40, 1, 5000));
        item_pool_n.push(ITEM_POOL(11, 50, 1, 3500));
        item_pool_n.push(ITEM_POOL(12, 50, 1, 1200));
        item_pool_n.push(ITEM_POOL(13, 50, 1, 250));
        item_pool_n.push(ITEM_POOL(14, 50, 1, 50));
    ...
    function _initItemPoolS() internal
    {
        ...
        item_pool_s.push(ITEM_POOL(2, 50, 100, 250));
        item_pool_s.push(ITEM_POOL(2, 50, 200, 250));
        item_pool_s.push(ITEM_POOL(2, 40, 500, 50));
        item_pool_s.push(ITEM_POOL(2, 50, 100, 1000));
        item_pool_s.push(ITEM_POOL(2, 50, 200, 500));
        item_pool_s.push(ITEM_POOL(2, 40, 500, 100));
        item_pool_s.push(ITEM_POOL(20, 40, 1, 5000));
        item_pool_s.push(ITEM_POOL(21, 50, 1, 3500));
        item_pool_s.push(ITEM_POOL(22, 50, 1, 1200));
        item_pool_s.push(ITEM_POOL(23, 50, 1, 250));
        item_pool_s.push(ITEM_POOL(24, 50, 1, 50));
