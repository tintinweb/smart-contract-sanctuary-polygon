...
contract CertificateNFT is ERC721, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    string constant NOT_TRANSFER = "NOT transfer";
    string constant ADDR_NOT_LIST = "Address not in list";

    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    mapping(address => CertificateLibrary.Certificate)
        internal listCertificates;
    ...
    constructor() ERC721("NFT Certificate Token", "NFTCERT") {}
    ...
    function mintCertificate(
        ...
        public
        onlyOwner
        isValidSoulbounbAddress(merkleProof, _address)
        returns (uint256)
    {
        CertificateLibrary.Certificate memory certNFT = listCertificates[
            _address
        ];
        require(certNFT.CertificateId == 0, HAS_TOKEN);
        ...
        certNFT = CertificateLibrary.Certificate(
            _doc,
            _name,
            block.timestamp,
            newItemId,
        ...
        listCertificates[_address] = certNFT;
        ...
        onlyOwner
    {
        ...
        delete listCertificates[_address];
        super._burn(tokenId);
    }
