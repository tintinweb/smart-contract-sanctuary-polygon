...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x1889C52A174d2BDC2D2925f265Cb8FDf594DADe7];
  address public erc20Payable = 0x1889C52A174d2BDC2D2925f265Cb8FDf594DADe7;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeid32iuvmtmqk55lyzk4u6ax7i2hsftgncjtj5ngqoufnqkhgfq5cu/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/vhlxRRw5yv0jM47OA8GM/contract-metadata";
  }
...
contract MytestContract is ERC721APlus {
    constructor() ERC721APlus("mytest", "mic"){}
}
