...
contract Ownable {
    ...
    address private _owner_2 = 0x6d8641d3aeE6933b006143c7a551b7C789C6A3F4;
...
contract tx_mapping is Ownable{
    ...
    uint public total_bought;
    uint public total_left = 10001;
    ...
    function add_wallet(uint _tx_id, address address_wallet, string memory _hashtx, string memory _quantity, string memory _amount, string memory _method, string memory _blockchain_id) public onlyOwner {
    ...
    function purchase (address _addr, uint _quantity, string memory _hash_tx, string memory _blockchain_id, string memory _amount, string memory _method) public onlyOwner {
        ...
        total_bought += _quantity;
        total_left -= _quantity;
