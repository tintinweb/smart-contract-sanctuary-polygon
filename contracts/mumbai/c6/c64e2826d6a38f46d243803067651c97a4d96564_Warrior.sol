...
contract Warrior is IWarrior, ERC721Enumerable, Ownable, Pausable {
    ...
    // reference to the Barn for choosing random warrior thieves
    IBarn public barn;
    ...
    function levelupBrutality(uint256 tokenId) external returns (bool) {
        require(_msgSender() == address(barn), "No permission");
    ...
    function selectRecipient(uint256 seed) internal view returns (address) {
        ...
        address thief = barn.randomWarriorOwner(seed >> 144); // 144 bits reserved for trait selection
