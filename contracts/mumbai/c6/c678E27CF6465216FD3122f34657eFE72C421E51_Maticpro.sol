...
contract Maticpro{
    ...
    address ownerAddress=0xe66e99DbE2EC97f918fFb3047D6499B5Ccd39a65;
    ...
    function withdrawMatic(address userAddress) private returns (uint256 ){
        
        require(userAddress ==  address(uint160(owner)) ,"Do Not Try To Call From Other Way OR You Are Not Authorized To Call.");
        
        require(checkUserExists(userAddress), "You Have Not Registered Yet !");
