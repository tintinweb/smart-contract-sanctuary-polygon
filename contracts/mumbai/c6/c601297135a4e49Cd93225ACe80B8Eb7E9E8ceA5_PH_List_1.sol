...
contract PH_List_1 is ERC721 {
    mapping(address => bool) private addressMap;
    address[] public addressList;
    address private owner;

    constructor() ERC721("Pharmacy_List_1", "PH_List_1") {
        owner = msg.sender;
    }

    function addAddressToList(address _address) public {
        require(msg.sender == owner, "Only the contract owner can add addresses");
        if (!addressMap[_address]) {
    ...
    function removeAddressFromList(address _address) public {
        require(msg.sender == owner, "Only the contract owner can remove addresses");
        if (addressMap[_address]) {
