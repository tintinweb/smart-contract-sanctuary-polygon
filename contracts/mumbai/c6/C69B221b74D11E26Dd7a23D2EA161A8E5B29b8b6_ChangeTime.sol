...
contract ChangeTime is IExecutePlugin, BasePlugin {

    constructor(address _registry) {
        PLUGIN_VERSION = 1;
        PLUGIN_NAME = PluginsList.SAFE_DEAL_CHANGE_TIME;
    ...
    function execute(
        ...
        require(ISafeDeal(registry.safeDeal()).changeTime(vars),
            "ChangeTime: wrong exec"
        );
