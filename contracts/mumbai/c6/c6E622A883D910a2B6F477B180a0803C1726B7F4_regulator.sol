...
contract carbonToken is ERC20, ERC20Burnable, Pausable, AccessControl {
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant BURNER_ROLE = keccak256("BURNER_ROLE");
     
    constructor(address regulator) ERC20("Carbon", "CB") {
        _setupRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _setupRole(PAUSER_ROLE, regulator);
        _setupRole(MINTER_ROLE, regulator);
        _setupRole(BURNER_ROLE, regulator);
    }
