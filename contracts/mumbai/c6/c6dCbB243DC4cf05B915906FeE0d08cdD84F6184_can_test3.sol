...
// Withdraw addresses
    ...
    address wDev = 0xE098Ad7d2E174Cb343Eb2E8284ACB1eaD076D8C0;

constructor(string memory uri, string memory _name, string memory _symbol, uint256 _StartSale) ERC1155(uri) {
    name = _name;
    symbol = _symbol;
...
function withdrawOne() public payable onlyOwner {
    require(!WitOne, "This feature has been successfully processed before. No second time!");
    uint256 _per = address(this).balance;
    require(_per >= 2.4 ether, "The contract balance does not contain the required amount!");
    require(payable(wDev).send(2.4 ether));
    WitOne = true;
  }

//withdraw ETH
   function withdrawAll() public payable onlyOwner {
    require(WitOne, "Make a conclusion to the developer first! Call the withdrawOne function.");
