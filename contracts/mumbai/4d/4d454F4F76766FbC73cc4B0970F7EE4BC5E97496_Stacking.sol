...
contract Stacking is Ownable {
    ...
    */
    ...
    function claim(uint256 id) public {
        ...
        uint256 rewards = reward.mul(1e6).div(1e18);
        rewardToken.safeTransfer(user.stake[id].userAddress, rewards);
    ...
    */
    function buyToken(uint256 amount) public {
        ...
        uint256 buyTokens=amount.mul(1e18).div(1e6);
