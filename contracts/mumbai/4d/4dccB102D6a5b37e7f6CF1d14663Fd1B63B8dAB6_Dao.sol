...
interface IdaoContract {
    // Metamask account address + Opensea NFT token id
...
contract Dao {
    ...
    uint256[] public validTokens; // NFT tokens
    IdaoContract daoContract;

    // daoContract: Contract address of opensea NFT
    // validTokens: Token id of opensea NFT
    constructor() {
        owner = msg.sender;
        nextProposal = 1;
        daoContract = IdaoContract(0x2953399124F0cBB46d2CbACD8A89cF0599974963);
        validTokens = [
            35019597326854399085891554817777414922340061880252406697329990561789527457802
        ];
    }
    ...
    struct proposal {
        ...
        uint256 votesUp;
        uint256 votesDown;
        address[] canVote; // Wallet addresses that have NFTs and can vote
        uint256 maxVotes;
    ...
    // Event tells the result of proposal
    event proposalCount(uint256 id, bool passed);

    // Check if _proposalist (account) hold any of the valid token (NFT tokens)
