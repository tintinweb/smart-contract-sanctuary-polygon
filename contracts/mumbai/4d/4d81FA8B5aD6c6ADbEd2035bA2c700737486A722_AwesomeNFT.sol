...
contract AwesomeNFT is ERC721 {
  ...
  constructor() ERC721("AwesomeNFT", "ANFT") {
  ...
  function mintToken() external {
    require(_counter < 50, "Total Supply is already 50");
    _counter++;
  ...
  function _baseURI() internal pure override returns (string memory) {
        return "ipfs://QmaHeZ4cUJSpghS4tRYxjCVKkxFaPvza5V7no3YWQFMPuk/"; // CID наших json
    }
}