...
contract WrasslersAuctionConfig is  GBMInitiator {
    ...
    function addAuctionRound(uint256 startTime, uint256 endTime) external {
...
contract GBMInitiator is IGBMInitiator, Ownable {
