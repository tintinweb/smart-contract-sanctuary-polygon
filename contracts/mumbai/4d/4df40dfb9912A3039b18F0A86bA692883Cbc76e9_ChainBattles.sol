...
contract ChainBattles is ERC721URIStorage {
    ...
    function train(uint256 tokenId) public {
        ...
        tokenIdtoStats[tokenId].levels = currentLevel + randMod(5);

        // Increase HP
        uint256 currentHp = tokenIdtoStats[tokenId].hp;
        tokenIdtoStats[tokenId].hp = currentHp + randMod(10);
        ...
        tokenIdtoStats[tokenId].speed = currentSpeed + randMod(10);
