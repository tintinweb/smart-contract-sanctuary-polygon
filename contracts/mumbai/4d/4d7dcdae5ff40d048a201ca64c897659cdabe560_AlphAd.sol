...
// File contracts/MyAlpAd

pragma solidity ^0.8.0;

contract AlphAd is ERC721Enumerable, Ownable {
  ...
  uint256 public constant priceToMint = 0.02 ether;
  ...
  function mint(uint256 n) payable public {
    ...
    require(mintedSoFar + n <= maxSupply, "Not enough left to mint");
  ...
  function _whitelistToadzBuilders() private {
    _whitelistedAddresses[0x2cf6A758F5e693bD1e11337581F47C0100b573e5] = true;
  }
