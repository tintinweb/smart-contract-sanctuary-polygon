...
contract LandSalePayment is Ownable, ReentrancyGuard{
    ...
    //for admin signature verification
    address private adminAddress;
    address payable private withdrawAddress;

    bool public ethPaymentEnabled;
    ...
    event adminMintedItem(string _category, uint256 _tokenId, address _beneficiary);
    ...
    event TVKAddressUpdated(address newAddress);
    ...
    //roles to be defined
    constructor(address _TVKaddress, address _NFTaddress, string[] memory _category,bool[] memory _slotDependency, uint256[] memory _priceInUSD, uint256[] memory _maxCategorySupply, uint256[3][16] memory _slot/*, uint256[] memory _startTime, uint256[] memory _endTime*/, uint256[5][16] memory _slotSupply){
        ...
        for(uint index=0; index<_slot.length; index++){
            ...
            // slot[_slot[index]].startTime = _startTime[index];
            // slot[_slot[index]].endTime = _endTime[index];
            slotCount++;
    ...
    function set() internal{
        ...
        slot[1].slotSupply["SMALL"].maxSlotCategorySupply = 0;
        slot[2].slotSupply["SMALL"].maxSlotCategorySupply = 0;
        slot[3].slotSupply["SMALL"].maxSlotCategorySupply = 0;
        slot[4].slotSupply["SMALL"].maxSlotCategorySupply = 0;
        slot[5].slotSupply["SMALL"].maxSlotCategorySupply = 16;
        slot[6].slotSupply["SMALL"].maxSlotCategorySupply = 16;
        slot[7].slotSupply["SMALL"].maxSlotCategorySupply = 16;
        slot[8].slotSupply["SMALL"].maxSlotCategorySupply = 16;
        slot[9].slotSupply["SMALL"].maxSlotCategorySupply = 16;
        slot[10].slotSupply["SMALL"].maxSlotCategorySupply = 16;
        slot[11].slotSupply["SMALL"].maxSlotCategorySupply = 16;
        slot[12].slotSupply["SMALL"].maxSlotCategorySupply = 16;
        slot[13].slotSupply["SMALL"].maxSlotCategorySupply = 16;
        slot[14].slotSupply["SMALL"].maxSlotCategorySupply = 16;
        slot[15].slotSupply["SMALL"].maxSlotCategorySupply = 16;
        slot[16].slotSupply["SMALL"].maxSlotCategorySupply = 16;

       
        slot[1].slotSupply["MEDIUM"].maxSlotCategorySupply = 0;
        slot[2].slotSupply["MEDIUM"].maxSlotCategorySupply = 0;
        slot[3].slotSupply["MEDIUM"].maxSlotCategorySupply = 0;
        slot[4].slotSupply["MEDIUM"].maxSlotCategorySupply = 0;
        slot[5].slotSupply["MEDIUM"].maxSlotCategorySupply = 0;
        slot[6].slotSupply["MEDIUM"].maxSlotCategorySupply = 0;
        slot[7].slotSupply["MEDIUM"].maxSlotCategorySupply = 0;
        slot[8].slotSupply["MEDIUM"].maxSlotCategorySupply = 0;
        slot[9].slotSupply["MEDIUM"].maxSlotCategorySupply = 16;
        slot[10].slotSupply["MEDIUM"].maxSlotCategorySupply = 16;
        slot[11].slotSupply["MEDIUM"].maxSlotCategorySupply = 16;
        slot[12].slotSupply["MEDIUM"].maxSlotCategorySupply = 16;
        slot[13].slotSupply["MEDIUM"].maxSlotCategorySupply = 16;
        slot[14].slotSupply["MEDIUM"].maxSlotCategorySupply = 16;
        slot[15].slotSupply["MEDIUM"].maxSlotCategorySupply = 16;
        slot[16].slotSupply["MEDIUM"].maxSlotCategorySupply = 16;
        
        
        slot[1].slotSupply["LARGE"].maxSlotCategorySupply = 16;
        slot[2].slotSupply["LARGE"].maxSlotCategorySupply = 16;
        slot[3].slotSupply["LARGE"].maxSlotCategorySupply = 16;
        slot[4].slotSupply["LARGE"].maxSlotCategorySupply = 16;
        slot[5].slotSupply["LARGE"].maxSlotCategorySupply = 16;
        slot[6].slotSupply["LARGE"].maxSlotCategorySupply = 16;
        slot[7].slotSupply["LARGE"].maxSlotCategorySupply = 16;
        slot[8].slotSupply["LARGE"].maxSlotCategorySupply = 16;
        slot[9].slotSupply["LARGE"].maxSlotCategorySupply = 16;
        slot[10].slotSupply["LARGE"].maxSlotCategorySupply = 16;
        slot[11].slotSupply["LARGE"].maxSlotCategorySupply = 16;
        slot[12].slotSupply["LARGE"].maxSlotCategorySupply = 16;
        slot[13].slotSupply["LARGE"].maxSlotCategorySupply = 16;
        slot[14].slotSupply["LARGE"].maxSlotCategorySupply = 16;
        slot[15].slotSupply["LARGE"].maxSlotCategorySupply = 16;
        slot[16].slotSupply["LARGE"].maxSlotCategorySupply = 16;

        
        slot[1].slotSupply["CONDO"].maxSlotCategorySupply = 16;
        slot[2].slotSupply["CONDO"].maxSlotCategorySupply = 16;
        slot[3].slotSupply["CONDO"].maxSlotCategorySupply = 16;
        slot[4].slotSupply["CONDO"].maxSlotCategorySupply = 16;
        slot[5].slotSupply["CONDO"].maxSlotCategorySupply = 16;
        slot[6].slotSupply["CONDO"].maxSlotCategorySupply = 16;
        slot[7].slotSupply["CONDO"].maxSlotCategorySupply = 16;
        slot[8].slotSupply["CONDO"].maxSlotCategorySupply = 16;
        slot[9].slotSupply["CONDO"].maxSlotCategorySupply = 16;
        slot[10].slotSupply["CONDO"].maxSlotCategorySupply = 16;
        slot[11].slotSupply["CONDO"].maxSlotCategorySupply = 16;
        slot[12].slotSupply["CONDO"].maxSlotCategorySupply = 16;
        slot[13].slotSupply["CONDO"].maxSlotCategorySupply = 16;
        slot[14].slotSupply["CONDO"].maxSlotCategorySupply = 16;
        slot[15].slotSupply["CONDO"].maxSlotCategorySupply = 16;
        slot[16].slotSupply["CONDO"].maxSlotCategorySupply = 16;

        
        slot[1].slotSupply["GIGA"].maxSlotCategorySupply = 16;
        slot[2].slotSupply["GIGA"].maxSlotCategorySupply = 16;
        slot[3].slotSupply["GIGA"].maxSlotCategorySupply = 16;
        slot[4].slotSupply["GIGA"].maxSlotCategorySupply = 16;
        slot[5].slotSupply["GIGA"].maxSlotCategorySupply = 16;
        slot[6].slotSupply["GIGA"].maxSlotCategorySupply = 16;
        slot[7].slotSupply["GIGA"].maxSlotCategorySupply = 16;
        slot[8].slotSupply["GIGA"].maxSlotCategorySupply = 16;
        slot[9].slotSupply["GIGA"].maxSlotCategorySupply = 16;
        slot[10].slotSupply["GIGA"].maxSlotCategorySupply = 16;
        slot[11].slotSupply["GIGA"].maxSlotCategorySupply = 16;
        slot[12].slotSupply["GIGA"].maxSlotCategorySupply = 16;
        slot[13].slotSupply["GIGA"].maxSlotCategorySupply = 16;
        slot[14].slotSupply["GIGA"].maxSlotCategorySupply = 16;
        slot[15].slotSupply["GIGA"].maxSlotCategorySupply = 16;
        slot[16].slotSupply["GIGA"].maxSlotCategorySupply = 16;
    }
    ...
    function buyLandWithTVK(uint256 _slot, string memory _category, uint256 _tokenId, bytes32 _hash, bytes memory _signature) public {
        ...
        require(recover(_hash,_signature) == adminAddress,"Landsale: Invalid signature!");
        ...
        slotCheck(_slot, _category, _tokenId, msg.sender);
    ...
    function adminMint(uint256 _tokenId, string memory _category, address _beneficiary) public onlyOwner {
        require(landCategory[_category].status,"Landsale: Invalid caetgory!");
    ...
    function slotCheck(uint256 _slot, string memory _category, uint256 _tokenId, address _beneficiary) internal {

        if(landCategory[_category].slotIndependent){
            mintLand(_slot,_category, _tokenId, _beneficiary);
    ...
    function mintLand(uint256 _slot,string memory _category, uint256 _tokenId, address _beneficiary) internal {
        require(landCategory[_category].mintedCategorySupply.add(1) <= landCategory[_category].maxCategorySupply,"LandSale: Max category supply reached!");
