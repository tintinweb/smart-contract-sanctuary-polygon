...
// contract BlueChipGenesis is Ownable, AccessControl, Pausable, ERC721AntiScam, DefaultOperatorFilterer, ERC2981 {
     ...
     *  @notice ★運営ウォレット要確認！！
     */
    address constant TREASURY_ADDRESS_1 = 0x86B051C0ec066657B0a877d6EF97e79Fa6E69A90;
    address constant TREASURY_ADDRESS_2 = 0x86B051C0ec066657B0a877d6EF97e79Fa6E69A90;
    /**
     *  @notice ★ロイヤリティ受領アドレス要確認！！
     */
    ...
    constructor() ERC721Psi("BlueChip Genesis", "BCG") {
        ...
        /**
         *  @notice ★デプロイ前に以下をセットすること！！
         *
         *  _safeMint(TREASURY_ADDRESS_1,500);
         *  _safeMint(TREASURY_ADDRESS_2,400);
         */
    ...
    //////////////////////////////////////////////////////////////*/
    /**
     * @dev setTokenLock()とsetWalletLock()は持ち主に加え、ADMINも操作できるようにしました
    ...
    /**
     * @notice オーバーライドするために、ERC721Psi.solの_startTokenId()にvirtualを追加済
     * @dev tokenId=0をミントしてバーンする方法に変更
     */
