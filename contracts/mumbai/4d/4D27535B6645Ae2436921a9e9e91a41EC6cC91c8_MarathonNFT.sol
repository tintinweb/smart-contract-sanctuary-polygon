...
contract MarathonNFT is ERC1155Upgradeable, AccessControlUpgradeable {
    ...
    event Mint(address account, uint256 amount, uint256 tokenId, string nftType, string uri);
    ...
    function mintNew(
        ...
        emit Mint(account, amount,tokenId, nftType, _uri);
    }
    ...
    function mintOld(
        ...
        emit Mint(account, amount, nftId, nftType, _tokenURIs[nftId]);
    }
    ...
    function setURI(string memory _uri) external onlyRole(ADMIN) {
        _setURI(_uri);
    }
