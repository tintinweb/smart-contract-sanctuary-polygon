...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 277;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeienqzkzonmcfkxqbsowetyqzkkegrclllam3wzmzpctqebytioql4/";
...
// File: contracts/HouseofChicksContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract HouseofChicksContract is RamppERC721A {
    constructor() RamppERC721A("House of Chicks", "CHICK"){}
}
