...
contract TunedCoin is ERC20, AccessControl, IMintBurnERC20 {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant BURNER_ROLE = keccak256("BURNER_ROLE");
    uint256 private immutable _supplyCap;
    uint256 private _totalMinted = 0;

    constructor(uint256 _cap) ERC20("TunedCoin", "TUC") {
    ...
    /**
     * @notice Mint specified amount to specified address
     * @dev Only callable by wallet with MINTER_ROLE
     * @param to Receiver address of the tokens
     * @param amount Amount of tokens to mint
     */
    function mint(address to, uint256 amount) external override onlyRole(MINTER_ROLE) {
        require((_totalMinted + amount) <= _supplyCap, "Supply cap reached");
    ...
    /**
     * @notice Burn specific amount from sender
     * @dev Only callable by wallet with BURNER_ROLE
     ...
     */
    function getSupplyCap() external view override returns (uint256) {
        return _supplyCap;
    }
