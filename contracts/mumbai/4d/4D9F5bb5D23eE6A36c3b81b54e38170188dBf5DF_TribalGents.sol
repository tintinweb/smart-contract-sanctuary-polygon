...
contract TribalGents is ERC721, IERC2981, ReentrancyGuard, Ownable {
  ...
  uint256 public constant PRICE = 29000000000000000000;
  ...
  function mint(uint256 count) public payable nonReentrant onlyOwner {
    ...
    require(
      msg.value >= PRICE * count, "Insufficient payment, 29 ETH per item"
    );
