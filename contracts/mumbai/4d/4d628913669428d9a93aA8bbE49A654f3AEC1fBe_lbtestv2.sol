...
contract lbtestv2 is VRFV2WrapperConsumerBase,ConfirmedOwner,ReentrancyGuard {
        ...
        VRFV2WrapperConsumerBase(linkAddress, wrapperAddress) 
    {
        ...
        lottoWeekly = IluckblocksWeekly(0x7C6F1ef9fCFedcd3A95c98BeC71899F82a6252e4);
        weeklyContract = 0xfD166888239ae8AB866f7643f9CA2fF17659B8BA;
    ...
    function swapTokensToUSD(uint256 tokenAmount, address user, uint typeSwap) private {
        ...
        uint256 prevBalance = btc.balanceOf(address(this));
        ...
        uint256 nowBalance = btc.balanceOf(address(this));
