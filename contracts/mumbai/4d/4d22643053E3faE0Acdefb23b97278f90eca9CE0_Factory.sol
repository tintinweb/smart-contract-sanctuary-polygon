...
contract Factory is Initializable, OwnableUpgradeable {
    // address of the master copy of the contract
    ...
    // creates a new contract based on EIP-1667
    function createContract(
        ...
        address clone = Clones.cloneDeterministic(TOKEN_ADDRESS, salt);
        ...
        Nft(clone).setData(
            ...
            _rootHash,
            _timestamp,
            _whitelistMintingAmount,
            _paperKeyManagerAddress,
            _paperKey
        );
