...
contract NftContract is ERC721Enumerable, AccessControl {
    ...
    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        ...
        writer = writer.writeStringProperty("description", "NFTGCO Collection of Avatars for games");
        writer = writer.writeStringProperty("external_url", "");
        writer = writer.writeStringProperty("image", "");
        writer = writer.writeStringProperty("name", "NFTGCO");
        ...
        for (i; i < currentAvatar.attributes.length; i++) {
            writer = writer.writeStartObject();
            writer = writer.writeStringProperty("trait_type", parts[i]);
            writer = writer.writeStringProperty("value", currentAvatar.attributes[i].toString());
