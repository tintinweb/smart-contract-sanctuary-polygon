...
contract ERC6551Registry is IERC6551Registry {
    ...
    struct WorldCoinVerificationParams {
        address signal;
        uint256 root;
    ...
    function verifyWorldCoin(WorldCoinVerificationParams calldata worldcoinData)
        public
    {
        require(
            userNullifiers[worldcoinData.signal] == 0,
            "User already verified"
        );
        worldId.verifyProof(
            worldcoinData.root,
            groupId,
            abi.encodePacked(worldcoinData.signal).hashToField(),
            worldcoinData.nullifierHash,
            externalNullifier,
            worldcoinData.proof
        );
        userNullifiers[worldcoinData.signal] = worldcoinData.nullifierHash;
    }
