...
interface IRentingContractStorage is IRentingContract {
    ...
    function createListingInfo(BattleSet memory bs, RentingType rt, address owner, Coin coin, uint256 _price, bool _perpetual) external;
...
contract BattleSetManagerContract is IRentingContract, TokensManager, AccountManagers {
    ...
    function listBattleSetFixedPrice(uint256 landId, uint256[] memory botIds, Coin coin, uint256 price,
        ...
        storageContract.createListingInfo(bs, RentingType.FIXED_PRICE, _msgSender(), coin, price, perpetual);
    }
