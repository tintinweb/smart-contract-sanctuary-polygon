    ...
    UUPSUpgradeable
{
    ...
    event ForwarderContractUpdated(address forwarder_);
    // event ArenaAttackedSet(uint256 indexed arenaId, bool isAttacked);
    ...
    // function setArenaAttacked
    // function setArenaAttacked(uint256 arenaId, bool isAttacked) external only(GAME_SERVER_ROLE) {
