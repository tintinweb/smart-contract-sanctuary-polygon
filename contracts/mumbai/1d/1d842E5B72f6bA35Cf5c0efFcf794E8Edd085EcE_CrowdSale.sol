...
contract CrowdSale is Crowdsale, FinalizableCrowdsale, UUPSUpgradeable{
    ...
    function buyToken(address _beneficiary) external payable onlyWhileOpen whenNotPaused{
      ...
      require((_purchasedAmount[_beneficiary][round] + msg.value) <= purchaseLimitInWei, "Maximum purchase Limit existed for this round");
    ...
    function checkBuyTokensLimit(address _beneficiary) external view onlyWhileOpen whenNotPaused returns(uint256){
