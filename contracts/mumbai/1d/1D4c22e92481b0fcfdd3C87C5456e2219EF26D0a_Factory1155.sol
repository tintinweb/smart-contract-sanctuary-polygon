...
import "./OwnConstructArtNFT1155.sol";
...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new ConstructArtUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        ConstructArtUser1155Token token = ConstructArtUser1155Token(address(addr));
...
contract ConstructArtUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
