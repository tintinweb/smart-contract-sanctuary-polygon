...
// File: heftiverse/contracts/Relayer/BasicMetaTransaction.sol
...
// File: heftiverse/contracts/Template.sol
...
contract Template is ERC721URIStorageUpgradeable, ERC2981Upgradeable, EIP712Upgradeable, BasicMetaTransaction{
    ...
    function _hash(NFTvoucher calldata voucher) internal view returns (bytes32) {
        return _hashTypedDataV4(keccak256(abi.encode(
            keccak256(
                "NFTvoucher(uint256 tokenId, uint256 price, string tokenUri, address royaltyKeeper, uint96 royaltyFees)"
            ),
            voucher.tokenId,
            voucher.price,
    ...
    function redeem(NFTvoucher calldata _voucher, address redeemer) public {
        ...
        _safeMint(signer, _voucher.tokenId, _voucher.tokenUri, _voucher.royaltyKeeper, _voucher.royaltyFees);
