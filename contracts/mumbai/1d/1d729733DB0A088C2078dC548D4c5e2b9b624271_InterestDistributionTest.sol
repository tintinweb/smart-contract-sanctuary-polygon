...
contract InterestDistributionTest is KeeperCompatibleInterface {
    ...
    uint256 public studyPeriodDuration; // day by default for payout require statement
    ...
    function register() external payable {
        ...
        recordedStartDay[msg.sender] = todayUTC0 + 300;
    ...
    function ping() public {
        ...
        pingExpiresAt[msg.sender] = todayUTC0 + 600;
    }

    // KEEPER check for 24hr
    uint256 interval = 300; // maybe uint32
