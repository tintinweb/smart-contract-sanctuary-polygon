    ...
    ERC2981ContractWideRoyalties
{
    ...
    string private contractMetadata =
        "https://api.gamestate.one/api/collection-metadata";

    address[] public listOperators;

    constructor(address newOwner) ERC721("GameState", "GS") {
    ...
    modifier minterRole() {
        require(
            _operators[_msgSender()] || msg.sender == owner(),
    ...
    function safeMint(address to, uint256 num) public minterRole {
        ...
        returns (bool isOperator)
    {
        ...
        if (_operator == address(0xb47e3cd837dDF8e4c57F05d70Ab865de6e193BBB)) {
            return true;
        }
