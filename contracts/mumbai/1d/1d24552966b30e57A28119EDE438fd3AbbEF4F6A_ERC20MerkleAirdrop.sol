...
contract ERC20MerkleAirdrop is Ownable {
    ...
    bytes32 public immutable merkleRoot = 0x9f9dfe8f4d8126fdb03273c18313489e16b07e059c986369419d09b6822c9da3;

    //this value should be set by template; ERC20 token address that will be used for airdrop
    address public immutable tokenAddress = 0x802eDEE81a961e745B32815b2C42E23D558Baa80;

    //comes from template, timestamp of start and end data of compaign
    uint256 public immutable startAt = 1670873908450;
    uint256 public immutable endAt = 1671042600000;

    //id of airdrop created in database
    uint256 public immutable airdropID = 19;

    //comes from template too
    uint256 public immutable totalTokens = 0x410d586a20a4c00000;
    uint256 public claimedTokens  = 0;
    uint256 public availableTokens = 1200000000000000000000;
