...
contract ERC721VaultFactory is Ownable, Pausable {
  ...
  function mint(string memory _name, string memory _symbol, address _token, uint256 _id, uint256 _supply, uint256 _listPrice, uint256 _fee,address _tokenCenter) external whenNotPaused returns(uint256) {
