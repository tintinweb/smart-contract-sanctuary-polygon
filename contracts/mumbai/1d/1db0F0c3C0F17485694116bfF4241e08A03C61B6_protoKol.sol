...
contract protoKol is iProtoKol {
    ...
    function createCampaign(
        ...
        //Include IMO part, platform revenue. Transfer the amount to project Treasury.
            ...
            if (_tgePer == 10000) {
                ...
                console.log("Hello from condition",_vestingInfo.isVestingInEnabled);
            }
   ...
   */
    ...
    function _blackListedKOLFundsHandling(
        ...
        if (_reward != 0) {
            // uint256 balance = (campaigns[_campaignId].campaignData.presaleAmount * 10**IERC20(preSale).decimals()) /10**18;

            // if(balance < _reward){

            //     campaigns[_campaignId].campaignData.presaleAmount -= balance;
            //     investedCampaignDetails[msg.sender][_campaignId].claimedReward += balance;
            //     _safeTransfer(preSale, msg.sender, balance);

            //     leftOverReward = eligibleRwd - balance - investedCampaignDetails[msg.sender][_campaignId].claimedReward;
            //     console.log("leftOverReward", leftOverReward);
            // }else{
