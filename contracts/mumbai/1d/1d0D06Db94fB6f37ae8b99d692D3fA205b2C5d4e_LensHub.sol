 ...
 *      1. Both Follow & Collect NFTs invoke an LensHub callback on transfer with the sole pure of emitting an event.
...
contract LensHub is LensNFTBase, VersionedInitializable, LensMultiState, LensHubStorage, ILensHub {
        ...
        returns (uint256)
    {
        console.log(msg.sender);
         if (!_profileCreatorWhitelisted[msg.sender]) revert Errors.ProfileCreatorNotWhitelisted();
            ...
            console.log("Updating Profile Counter");
    ...
    {
        console.log("Calling from Lens Hub");
    ...
    function _createPost(
        ...
        console.log("_createPost1");
        unchecked {
        console.log("_createPost2");
            uint256 pubId = ++_profileById[profileId].pubCount;
        console.log("_createPost3");
    ...
    function _validateCallerIsProfileOwnerOrDispatcher(uint256 profileId) internal view {
        ...
        console.log(_dispatcherByProfile[profileId]);
...
library PublishingLogic {
    ...
    function createProfile(
        ...
        console.log("Publishing Logic 1");
        console.log(vars.handle);
        _validateHandle(vars.handle);
        console.log("Publishing Logic 2");

        if (bytes(vars.imageURI).length > Constants.MAX_PROFILE_IMAGE_URI_LENGTH)
            revert Errors.ProfileImageURILengthInvalid();
        console.log("Publishing Logic 3");

        bytes32 handleHash = keccak256(bytes(vars.handle));
        console.log("Publishing Logic 4");

        if (_profileIdByHandleHash[handleHash] != 0) revert Errors.HandleTaken();

        console.log("Publishing Logic 5");
        ...
        console.log("Publishing Logic 6");
        ...
        console.log("Publishing Logic 7");

        _emitProfileCreated(profileId, vars, followModuleReturnData);
        console.log("Publishing Logic 8");
    }
    ...
    function createPost(
        ...
        console.log("Publishing Logic1");
        _pubByIdByProfile[profileId][pubId].contentURI = contentURI;
        console.log("Publishing Logic2");

        // Collect module initialization
        console.log("Publishing Logic3");
    ...
    function _validateHandle(string calldata handle) private view {
        console.log("Validate Handle 1");
        bytes memory byteHandle = bytes(handle);
        console.log("Validate Handle 2");
        if (byteHandle.length == 0 || byteHandle.length > Constants.MAX_HANDLE_LENGTH)
            revert Errors.HandleLengthInvalid();
        console.log("Validate Handle 3");

        uint256 byteHandleLength = byteHandle.length;
        console.log("Validate Handle 4");
