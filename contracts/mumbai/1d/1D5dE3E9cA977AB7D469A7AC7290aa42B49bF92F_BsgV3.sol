...
contract BsgV3 {
   ...
   function initialize( address _defaultRefer, address payable _feeReceivers1, address payable _feeReceivers2,Newpolygon _token) public{
    ...
    function getWalletDetails(address _user) public view returns(uint actualAmount ,uint fixAmount){
        actualAmount = walletInfo[_user].actualAmount;
        fixAmount = walletInfo[_user].fixAmount;
    }
