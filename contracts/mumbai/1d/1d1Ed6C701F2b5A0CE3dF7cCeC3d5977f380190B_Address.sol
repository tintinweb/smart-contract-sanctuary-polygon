...
// File: contracts/RoyalBugsNFT.sol
...
contract RoyalBugsNFT is ERC1155, Pausable, Ownable, ERC1155Supply {
    ...
    constructor()
        ERC1155("ipfs://QmQjiS6KJZYdSGeeBY1t2H8k5JqY4KPE1Zy9Hav14TyaZJ")
    {}

    
    //*****Edit Public Mint and AllowList Mint*****//
 ...
 //***Allowlist Function****//
   function setAllowList(address[] calldata addresses) external onlyOwner
   {
    ...
    function allowListMint(uint256 id, uint256 amount) public payable{
        require(allowListMintOpen, "WhiteList is Closed");
        require(allowList[msg.sender], "YOU ARE NOT IN THE WHITELIST");
   ...
   //Supply Tracking//
    ...
    {   
        ...
        require(msg.value <= publicPrice * amount, "ERROR! Not Enough Money");
        mint(id, amount);
       ...
       function mint(uint256 id, uint256 amount) internal {
         require(purchasesPerWallet[msg.sender] + amount <=maxPerWallet, "ERROR! WALLET LIMIT REACHED");
         require(id <10, "SORRY! ITS LOOKS LIKE YOU ARE TRYING TO MINT WRONG NFT");
