...
contract Bridged_ERC20_ZARA is
    Ownable,
    ERC20_ML_AnyswapV6
{
    //========================
    ...
    {        
        ...
        //tax timeline
        taxTimeline.push(TaxTimeline({ beforeTimestamp: 1682608827, tier: 3}));
        taxTimeline.push(TaxTimeline({ beforeTimestamp: 1682607827, tier: 2}));
        taxTimeline.push(TaxTimeline({ beforeTimestamp: 1682606827, tier: 1}));               
    }
