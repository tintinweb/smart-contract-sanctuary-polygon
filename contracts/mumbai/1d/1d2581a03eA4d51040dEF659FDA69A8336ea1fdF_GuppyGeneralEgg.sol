...
/**
 * @title Guppy General Egg
 * @dev ERC721 Token for the Guppy General Egg project
 * Deployed on 20 April 2022
 */
contract GuppyGeneralEgg is ERC721Enumerable, ERC721Burnable, ERC721Pausable, AccessControlEnumerable {
    ...
    // Safeguars, we need to up this limit manually with the STAFF_ROLE
     ...
     * See {ERC721}.
     */
    constructor() ERC721("Guppy General Egg", "GENERAL_EGG") {
    ...
    /**
     * @dev As ERC721Enumerable, ERC721 and AccessControlEnumerable include supportsInterface we need to override all three.
     */
    ...
    /**
     * @dev As ERC721, ERC721Enumerable and ERC721Pausable include _beforeTokenTransfer we need to override all three.
     */
    function _beforeTokenTransfer(address from, address to, uint256 tokenId) internal virtual override(ERC721Enumerable, ERC721Pausable, ERC721) {
      super._beforeTokenTransfer(from, to, tokenId);
    }


    /**
     * @dev Flip the boolean state of mintIsActive to enable/disable minting
     */
    function flipMintIsActiveState() external {
    ...
    /**
     * @dev Change the max tokens minted
     */
    ...
    function mint(address to) external {
        require(hasRole(MINT_ROLE, _msgSender()), "Must have mint role to call this function.");
        require(mintIsActive, "Mint must be active.");

        require(totalSupply() + 1 <= maxTokens, "Purchase would exceed max total supply.");
