...
contract HighValuePoX is AccessControl, ERC2771Context {
    bytes32 public constant CREATOR = keccak256("CREATOR");
    bytes32 public constant MULTISIG = keccak256("MULTISIG");
    INgageN public nftAddress;

    /**
     * @dev Constructor for HighValuePoX contract
     ...
     */
    function setNFTAddress(address _nftAddress) public onlyHVPoXAdmin {
        require(
    ...
    function transferNFT(
        ...
        require(
            hasRole(MULTISIG, _msgSender()),
            "PoX: Only MULTISIG with valid signature"
        );
    ...
    function transferNFTBatch(
        ...
        require(
            hasRole(MULTISIG, _msgSender()),
            "PoX: Only MULTISIG valid signature"
        );
