...
contract LottolocoCardsT01 is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public maxTokenIdWhitelisted = 1000;
  uint256 public constant refundPeriod = 2 days;
  ...
  function isRefundGuaranteeActive() public view returns (bool) {
    return !isSoldOut() && block.timestamp <= refundEndTime;
  }
