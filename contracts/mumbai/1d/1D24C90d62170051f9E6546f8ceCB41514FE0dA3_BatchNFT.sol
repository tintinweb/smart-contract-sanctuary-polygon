...
contract BatchNFT is Ownable, ERC721Enumerable, BatchReveal, VRFConsumerBase {
    ...
    constructor(string memory _baseURI, string memory _unrevealedURI)
      ...
      VRFConsumerBase(0x8C7382F9D8f56b33781fE506E897a4F1e2d17255, 0x326C977E6efc84E512bB9C30f76E30c160eD06FB) 
      {
        ...
        linkCoordinator = 0x8C7382F9D8f56b33781fE506E897a4F1e2d17255;
    ...
    function requestRandomSeed(uint s_fee) public returns (bytes32 requestId) {
        require(totalsSupply >= (lastTokenRevealed + REVEAL_BATCH_SIZE), "totalsSupply too low");
