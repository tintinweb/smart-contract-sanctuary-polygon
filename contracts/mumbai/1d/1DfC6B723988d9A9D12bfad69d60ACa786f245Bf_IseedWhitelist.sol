...
contract IseedWhitelist is Ownable, ERC1155 {
    ...
    bool public IseedContractAddressSetted = false;
    ...
    function burnWhitelistForIseed (address _user, uint256 _amount, uint256 _id) external returns(bool) {
        require(msg.sender == IseedContractAddress && IseedContractAddressSetted, "User not approved");
    ...
    function setBaseExtsension (string memory _baseExtension) public onlyOwner {
    ...
    function setIseedContractAddress (address _iseedContractAddress) public onlyOwner {
        require(!IseedContractAddressSetted, "Iseed contract address already setted");
        IseedContractAddress = _iseedContractAddress;
        IseedContractAddressSetted = true;
    }
