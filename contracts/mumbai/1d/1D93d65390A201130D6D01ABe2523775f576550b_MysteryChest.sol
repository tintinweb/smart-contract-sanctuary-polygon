...
/*
In the forest lived an adventurous CITIZEN: a thrill-seeking Sasquatch. 
He had a knack for action sports and was always ready to conquer every HURDLE. 
One day, with SHORT notice, he made a WISE choice. 
He decided to take on the town's SECOND peak, dismissing any fears.

Ignoring any potential CRITIC, he embarked on his daring VOYAGE. 
Each twist and turn on the snow-covered slope revealed a new ASPECT of his skill. 
However, as the sun began to set, his day was far from over. The Sasquatch had one final __________ to CONQUER.

REFUSING to __________ his daily ritual, he geared up for the last ride under the starlit sky. 
And as the moon lit up the mountain, he finally unwound, sitting by the fire for a well-deserved __________.
*/
    ...
    ERC2981
{
    ...
    string public uriOfImage =
        "https://uploads-ssl.webflow.com/648aefd84aed70cbe42f9db3/64afd568cc7e8ea28351c16e_1000px.gif";

    bool public operatorFilteringEnabled;
    address public preferredOperatorAddress;
    ...
    constructor() ERC721A("Shredding Sassy Chests", "MCHEST") {
     ...
     * @dev This is only for accidental MATIC deposits, not for the ERC20 Tokens raised from the sale of the NFTs
     */
    ...
    /// @dev Registers (or unregisters) the current contract to a subscription contract for operator filtering
