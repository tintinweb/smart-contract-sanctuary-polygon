...
contract BTFLY  {
    ...
    constructor(address _daiAddress, address[3] memory _feeReceivers)  {
    ...
    function _calLevelNow(address _user) private view returns(uint256) {
        ...
        if(total >= 1000e18){
            ...
            if(total >= 2000e18 && user.teamNum >= 6 && maxTeam >= 50000e18 && otherTeam >= 50000e18){
                levelNow = 5;
            }else if(user.teamNum >= 5 && maxTeam >= 10000e18 && otherTeam >= 10000e18){
                levelNow = 4;
            }else{
                levelNow = 3;
            }
    ...
    function _deposit(address _user, uint256 _amount) private {
        ...
        require(_amount <= maxDeposit, "you reach max amount deposit");
