...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x49f986482823eC322601bA2820Fe5EBD5eb1Ed08];
  address public erc20Payable = 0x49f986482823eC322601bA2820Fe5EBD5eb1Ed08;
...
abstract contract Feeable is Teams {
  uint256 public PRICE = 108 ether;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 50, 21000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmSwHxZYQQk7od8SqkuDFEMFmvuBhhLqDSwxzZQi9SQmQa/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 21000");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 21000");
    ...
    function mintToMultipleERC20(address _to, uint256 _amount, address _erc20TokenContract) public payable {
      require(_amount >= 1, "Must mint at least 1 token");
      require(_amount <= maxBatchSize, "Cannot mint more than max mint per transaction");
      require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 21000");
      require(mintingOpen == true, "Minting is not open right now!");
...
// File: contracts/Tag1ComicsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Tag1ComicsContract is RamppERC721A {
    constructor() RamppERC721A("tag1comics", "TC"){}
}
