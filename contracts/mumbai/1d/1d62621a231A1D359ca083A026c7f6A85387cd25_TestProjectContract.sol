...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x038f7F8A44768b8A91d8B4489EA952Ed324B5b25];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x038f7F8A44768b8A91d8B4489EA952Ed324B5b25;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 150) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmbiBxmH8tSfDSZbjekQ6qTrJXAZu8acAY2vNhVHx4yyLy/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 150");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 150");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 150");
...
// File: contracts/TestProjectContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TestProjectContract is RamppERC721A {
    constructor() RamppERC721A("Test Project", "TEST"){}
}
