...
contract PBT is ERC721ReadOnly {
    ...
    function _getChipAddrForChipSignature(
        ...
        // Can't be too much elapsed time between the moment of the signature and the execution
        if (
