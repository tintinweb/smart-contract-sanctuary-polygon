...
contract ShinoViPlatform is Initializable {
    ...
    */
    ...
    function createERC721(
        ...
        address _nft = shinoViNFTFactory.create(
          _name,
          _symbol,
          _metadata,
          _owner,
    ...
    function createERC1155(
        ...
        address _nft = shinoViMultiNFTFactory.create(
          _name,
          _symbol,
          _metadata,
          _owner,
    ...
    function ERC20TransferFrom(address _token, address _from, address _to, uint256 _amount) isAdmin public {
    ...
    function getShinoViNFTFactory() public returns (address) {
        return address(shinoViNFTFactory);
    }

    function getShinoViMultiNFTFactory() public returns (address) {
        return address(shinoViMultiNFTFactory);
    }
