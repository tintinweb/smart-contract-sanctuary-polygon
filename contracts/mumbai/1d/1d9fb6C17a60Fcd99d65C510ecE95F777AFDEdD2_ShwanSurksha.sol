...
contract ShwanSurksha {
    ...
    function claimPolicy(bytes32 policyId) public {
        ...
        require(isClaimable[_policy.owner], "Verify claim first");
    ...
    function getIsClaimable(bytes32 policyId) public view returns (bool) {
        Policy memory _policy = policy[policyId];
        return isClaimable[_policy.owner];
    }
}