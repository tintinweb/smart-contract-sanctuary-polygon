...
// openzeppelin contract version 4.7.3, compiler version - 0.8.17+commit.8df45f5f
...
contract AkemonaERC20Perk is ERC20, Pausable, AccessControl {
  ...
  function distributeTokens(address[] calldata toAddresses, uint256[] calldata amounts)
    public
    onlyRole(DEFAULT_ADMIN_ROLE)
  {
    ...
    require(ERC20.totalSupply() + totalAmount <= _maxSupply, 'Not enough supply');
