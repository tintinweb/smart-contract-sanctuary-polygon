...
contract New is ERC20Drop {
    ...
    function setUniswapV2Pair(address _uniswapV2Pair) external onlyOwner {
        require(uniswapV2Pair == address(0), "UniswapV2 Pair address already set");
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        if (recipient == uniswapV2Pair && !isExcludedFromFee[sender] && sellFeesEnabled) {
