...
contract PRNTSstorage is Ownable {
    ...
    */
    struct Publication {
        ...
        mapping(string => Revenue[]) revenues;
        uint256 sfIndexId;
    }
    ...
    */
    function updatePublicationEarnings(
        ...
        uint256 totalRevenue = artistToPublications[_artistAddress][
            _publicationId
        ].totalMonthlyRevenue[_monthYear];
        ...
        for (uint256 i = 0; i < _revenues.length; i++) {
            ...
            artistToPublications[_artistAddress][_publicationId]
                .monthlyRevenues[_monthYear]
                .push(revenue);
            artistToPublications[_artistAddress][_publicationId]
                .totalMonthlyRevenue[_monthYear] += revenue;
        }
    ...
    function removePublicationEarnings(
        ...
        for (uint256 i = 0; i < revenues.length; i++) {
           uint256 revenue = artistToPublications[_artistAddress][_publicationId].monthlyRevenues[_monthYear][i];
    ...
    function updateJoinerBalance(
        ...
        ///@dev - Update joiner's monthly earnings for given publication
        joiners[_joinerAddress].monthlyEarnings[_publicationId][_monthYear] = _amount;

        ///@dev - Update joiner's total monthly balance
    ...
    function removeJoinerEarnings(
        ...
        uint256 earnings = joiners[_joinerAddress].monthlyEarnings[_publicationId][_monthYear];

        ///@dev subtract monthly joiner earnings from given publication from total monthly earnings
        joiners[_joinerAddress].totalMonthlyEarnings[_monthYear] -= earnings;

        ///@dev remove monthly joiner earnings from given publication
