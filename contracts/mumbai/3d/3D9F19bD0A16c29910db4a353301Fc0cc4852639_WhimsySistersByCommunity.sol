...
contract WhimsySistersByCommunity is ERC721, Ownable {
    ...
    mapping(uint => bool) public isSisterTokenUsed;

    bool osAutoApproveEnabled = true;
    address public openseaConduit = 0x1E0049783F008A0085193E00003D00cd54003c71;
    IERC721 public sisters = IERC721(0xf37627b300bd3402e713d87F178bDd96106699fB);
    ...
    function mintWith(uint sisterId) external {
        ...
        require(!isSisterTokenUsed[sisterId], "This token already used");

        isSisterTokenUsed[sisterId] = true;
