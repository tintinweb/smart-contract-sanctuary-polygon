...
contract PolyGalz is Ownable, ERC721A,  ReentrancyGuard {
     ...
     */
    function mintPresale(uint256 numberOfTokens) public payable isSecured(2) {
   ...
   /**
     * Presale mint function
     */
    function mint(uint256 numberOfTokens) public payable isSecured(1) {
