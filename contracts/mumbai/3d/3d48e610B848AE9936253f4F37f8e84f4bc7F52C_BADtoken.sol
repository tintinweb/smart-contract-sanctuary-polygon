...
import {Ownable} from "openzeppelin3/access/Ownable.sol";
import {ERC20} from "openzeppelin3/token/ERC20/ERC20.sol";
import {ERC20Burnable} from "openzeppelin3/token/ERC20/ERC20Burnable.sol";
...
contract BADtoken is ERC20Burnable, Ownable {
    ...
    constructor() ERC20("Demo Gold Token", "DGLD") Ownable() {
        // _owner = _msgSender();
