...
contract Sixdecimal is ERC20 {
    ...
    constructor(string memory name, string memory symbol) public ERC20(name, symbol) {
        uint256 fixedSupply = 1e6 * 10**18; // Since 6 is the number of decimals
    ...
    function distributeToken(address[] memory listUser, uint256 amount) public {
