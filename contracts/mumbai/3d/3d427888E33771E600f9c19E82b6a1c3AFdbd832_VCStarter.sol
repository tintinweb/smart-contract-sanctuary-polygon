...
contract VCStarter {
    ...
    event SttrProjectClosed(address indexed project);
    ...
    function fundProject(
        ...
        address lab = _fund(_project, _currency, _amount);
    ...
    // starter needs to know core team
    function activateProject(address _project) external {
        _onlyCoreTeam();

        VCProject(_project).activateProject();
        emit SttrProjectActivated(_project);
    }

    function closeProject(address _project) external {
        _onlyLabOwner(_project);

        VCProject(_project).closeProject();
        emit SttrProjectClosed(_project);
    }
