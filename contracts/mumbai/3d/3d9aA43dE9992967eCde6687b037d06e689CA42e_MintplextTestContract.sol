...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x6Cf6A0384be2e95179c692047361F8Fa944a8BdA];
...
// File: contracts/MintplextTestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract MintplextTestContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "MintplextTest";
    string public symbol = "MINTTT1";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/fRVYDfk9isXPJEAOZVp5/contract-metadata";
  }
