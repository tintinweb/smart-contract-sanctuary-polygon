...
// File: contracts/Pologon_Test_LG.sol
...
contract PolyGon_Test_NFT is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Polygon Test NFT", "PTNFT") {
    setHiddenMetadataUri("ipfs://QmfLJ5ywm8HsGfjLJDhxf8hSzfW7QwBpo7FoczY5WjZQpt/hidden.json");
  }
