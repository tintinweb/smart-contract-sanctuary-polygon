...
contract Marketplace is Ownable {
    ...
    function initialize(address _owner, address _acceptedToken) public {
        ...
        require(_acceptedToken != address(0), "Marketplace#constructor: INVALID_ACCEPTED_TOKEN");
    ...
    function _createOrder(
        ...
        address getApproved = nftRegistry.getApproved(assetId);

        console.log("block.timestamp: %d", block.timestamp);

        console.log("assetOwner: %s", assetOwner);

        console.log("getApproved(assetId): %s", getApproved);
        ...
        bytes32 orderId = keccak256(
            abi.encodePacked(block.timestamp, assetOwner, assetId, nftAddress, priceInWei)
        );
    ...
    function _requireERC721(address nftAddress) internal view {
        require(nftAddress != address(0), "MarketplaceV2#_requireERC721: INVALID_NFT_ADDRESS");
    ...
    function _executeOrder(
        ...
        nftRegistry.setApprovalForAll(msg.sender, true);
