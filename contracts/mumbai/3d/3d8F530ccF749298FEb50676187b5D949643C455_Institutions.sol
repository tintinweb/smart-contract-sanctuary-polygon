...
contract Institutions is Initializable, PausableUpgradeable, AccessControlUpgradeable {
    ...
    modifier onlyUncertifiedStudent(uint256 courseId, address studentAddress) {
        require(!students[courseId][studentAddress].isCertified, "Student is already certified");
        _;
    }
}
