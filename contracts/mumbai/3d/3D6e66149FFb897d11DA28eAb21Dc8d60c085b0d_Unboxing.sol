...
contract Unboxing is Ownable, ERC721Holder {
    ...
    function unbox(uint256 numBoxes) public returns (bool result) {
        ...
        for (uint256 i = 0; i < numBoxes; i++) {
            ...
            // 3. Mint Badge and attach to NFT inventory
            terminus.mint(address(this), badgePoolID, 1, "");
            inventory.equip(
                tokenId,
                badgeSlot,
                1155,
        ...
        token.approve(address(this), numVILTokens);
        // 5. Transfer Tokens to msg.sender
