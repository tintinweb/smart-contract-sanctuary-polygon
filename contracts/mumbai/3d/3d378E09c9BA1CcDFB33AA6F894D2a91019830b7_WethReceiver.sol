...
contract WethReceiver is EIP712MetaTransaction {
 ...
 // Protect public function with passcode
  ...
  function setPasscode(bytes32 passcode_) external {
    require(msgSender() == address(dbiliaToken), "WethReceiver#setPasscode: wrong caller");
    passcode = passcode_;
  }

  function setDbiliaToken(address _newDbiliaToken) external {
    require(msgSender() == dbiliaToken.owner(), "WethReceiver#setDbiliaToken: wrong owner");
