 ...
 * @notice This contract handles minting After 77 Years [Test] tokens.
 */
contract After77YearsTest is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xDF104135c891beEDc0fd2b9E9314690e5d1Dc3cF;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xA2944098eE88B83B10f13194afcBf1d72916c58b;
    address[] public payoutAddresses = [
        0xA2944098eE88B83B10f13194afcBf1d72916c58b
    ];
    ...
    string public baseTokenURI =
        "ipfs://bafybeigip6gea32tmzkigk63ypx36zxfnwaixiunyuzp76flauvn4smnku/";
    // Maximum supply of tokens that can be minted
    uint256 public MAX_SUPPLY = 77;
    // Total number of tokens available for minting in the presale
    uint256 public PRESALE_MAX_SUPPLY = 8;
    // Fee paid to HeyMint per NFT minted
    uint256 public heymintFeePerToken;
    uint256 public presaleEndTime = 1683320400;
    uint256 public presaleMintsAllowedPerAddress = 1;
    uint256 public presaleMintsAllowedPerTransaction = 77;
    uint256 public presalePrice = 0.025 ether;
    uint256 public presaleStartTime = 1680901200;
    uint256 public publicMintsAllowedPerAddress = 77;
    uint256 public publicMintsAllowedPerTransaction = 77;
    uint256 public publicPrice = 0.077 ether;
    uint256 public publicSaleEndTime = 1996331119;
    uint256 public publicSaleStartTime = 1683385200;
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC721A("After 77 Years [Test]", "A77YRS-Test")
        RevokableOperatorFilterer(
     ...
     */
    function setUsePublicSaleTimes(bool _usePublicSaleTimes)
        external
        onlyOwner
    {
        require(
        ...
        originalUser
    {
        ...
        require(publicSaleTimeIsActive(), "PUBLIC_SALE_TIME_IS_NOT_ACTIVE");
        require(
