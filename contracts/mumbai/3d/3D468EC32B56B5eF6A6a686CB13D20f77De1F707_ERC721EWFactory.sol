...
contract ERC721EWFactory is ERC721FactoryWide, IERC721EFactory, SuperOwner {
...
contract ERC721EW is IERC721EW, ERC721AMarketplace, SuperOwner, AccessControl {
    ...
    InterfaceVenueRegistar internal _venueRegistar;
    ...
    function buyTickets(
        ...
        if(merkleRoot != "") {
            ...
            if(isTokenCreator) wallet = receiver;
