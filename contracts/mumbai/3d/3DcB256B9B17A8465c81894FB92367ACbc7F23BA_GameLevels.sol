    ...
    ERC721HolderUpgradeable
{
    ...
    function generateSvg(string memory word, bool won, bool lost) public pure returns(string memory){
        ...
        bytes memory svg = abi.encodePacked(
            ...
            '<tspan wrap="soft" letter-spacing="5" fill="',
            fill,
            '">',
            word,
            '</tspan>',
    ...
    function tokenURI(
        ...
        return
            string.concat(
                ...
                word,
                '","animation_url":"https://testnet.tableland.network/chain/80001/tables/',
                strTokenId,
                '","image":"',
                image,
                ...
                StringsUpgradeable.toString(stored.games[tokenId].remaining),
                '"}]}'
            );
    }
