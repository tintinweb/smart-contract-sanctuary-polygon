...
//
//    __  ___         _       _       __   _ ___   
//   /  |/  /_ _____ (_)___  (_)__   / /  (_) _/__ 
//  / /|_/ / // (_-</ / __/ / (_-<  / /__/ / _/ -_)
// /_/  /_/\_,_/___/_/\__/ /_/___/ /____/_/_/ \__/ 
//                                                 
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x8f91aacaa67686744ae9a1316aBddDb137E66493];
...
// File: contracts/MusicisLifeContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract MusicisLifeContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Music is Life";
    string public symbol = "Musiclife";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/LmwN6tL0IzPeOpwSV8KJ/contract-metadata";
  }
