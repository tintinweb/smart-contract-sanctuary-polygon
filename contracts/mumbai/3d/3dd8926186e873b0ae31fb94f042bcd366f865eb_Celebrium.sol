...
contract Celebrium is ERC721Enumerable, Ownable {
  ...
  address private OtherAddress2 = 0xC73d0f5b8b7788dd6A3C8332B1ce766E33F3A84e;
  ...
  constructor(string memory baseURI) ERC721("Celebrium Genesis Collection Alpha: Doug E. Fresh", "CELEBRIUM") {
    setBaseURI(baseURI);
  }
