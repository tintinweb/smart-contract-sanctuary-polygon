...
function payReward(uint256 amount) public returns (bool){
  ...
  function donateETHToRestaurant(uint256 amount, uint _restaurantId, string memory _tokenURI) external {
