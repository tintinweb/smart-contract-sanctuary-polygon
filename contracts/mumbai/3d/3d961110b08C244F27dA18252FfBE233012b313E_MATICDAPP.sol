...
contract MATICDAPP {
	...
	uint256 constant public INVEST_MIN_AMOUNT = 1e17; // 0.1 Matic  
	uint256[] public REFERRAL_PERCENTS 	= [100, 100, 100, 200, 300, 400, 500, 600, 700, 800];
	uint256[] public SEED_PERCENTS 		= [100, 100, 100, 200, 300, 400, 500, 600, 700, 800];
	...
	function getUserDividends(address userAddress) public view returns (uint256) {
		...
		for (uint256 i = 0; i < user.deposits.length; i++) {
			uint256 finish = user.deposits[i].start.add(plans[user.deposits[i].plan].time.mul(1 seconds));
	...
	function getUserSeedIncome(address userAddress) public view returns (uint256){
		...
		for	(uint256 y=1; y<= count; y++)
		{
			...
			for (uint256 i = 0; i < downline.deposits.length; i++) {
				uint256 finish = downline.deposits[i].start.add(plans[downline.deposits[i].plan].time.mul(1 seconds));
