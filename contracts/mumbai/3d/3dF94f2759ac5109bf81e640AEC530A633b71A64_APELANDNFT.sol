...
$$ |  $$ |$$ |      $$ |      $$ |      $$ |  $$ |$$ |\$$$ |$$ |  $$ |      $$ |\$$$ |$$ |         $$ |   
$$ |  $$ |$$ |      $$$$$$$$\ $$$$$$$$\ $$ |  $$ |$$ | \$$ |$$$$$$$  |      $$ | \$$ |$$ |         $$ |   
\__|  \__|\__|      \________|\________|\__|  \__|\__|  \__|\_______/       \__|  \__|\__|         \__|
*/
    ...
    AccessControlEnumerable
{
     ...
     */
    function _delayChangeWait(uint48 newDelay)
        internal
        view
        virtual
        returns (uint48)
     ...
     * May emit a DefaultAdminTransferCanceled event.
     */
    function _setPendingDefaultAdmin(address newAdmin, uint48 newSchedule)
        private
    {
...
abstract contract BlackList is AccessControlDefaultAdminRules {
    using EnumerableSet for EnumerableSet.AddressSet;
    ...
    function _addToBlackList(address account) private {
    ...
    function _removeFromBlackList(address account) private {
        require(account != address(0), "account: Zero Address");
    ...
    BlackList
{
    ...
    constructor()
        ERC721("APELAND", "APELAND")
        AccessControlDefaultAdminRules(86400, _msgSender())
    {
        address msgSender = _msgSender();
        _grantRole(PAUSER_ROLE, msgSender);
        _grantRole(BLOCKER_ROLE, msgSender);
        _grantRole(SIGNER_ROLE, msgSender);
    }
    ...
    function lazyMint(
        ...
        require(
            hasRole(SIGNER_ROLE, getSigner(to, tokenId, uri, signature)),
    ...
    function prepareHash(
        ...
        return
            keccak256(
                abi.encodePacked(to, tokenId, uri, address(this), APELAND_HASH)
            );
    }
    ...
    function _beforeTokenTransfer(
        ...
        require(!isBlackListed(from), "BlackList: from is BlackListed");
        require(!isBlackListed(to), "BlackList: to is BlackListed");
        require(
            !isBlackListed(_msgSender()),
            "BlackList: msgSender is BlackListed"
        );
    }
    ...
    function getSigner(
        ...
        bytes32 hash = prepareHash(to, tokenId, uri).toEthSignedMessageHash();
        require(!isSigExist[hash], "validateSignature: Is Exist");
