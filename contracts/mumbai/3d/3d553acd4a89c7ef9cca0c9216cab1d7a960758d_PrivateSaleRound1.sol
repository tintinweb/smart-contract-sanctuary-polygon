...
contract PrivateSaleRound1  is Ownable {
    ...
    constructor(uint256 _rate, address _usdt, uint256 _hardcap, uint256 _allowedUserBalance, uint256 _minAmount)  {
        rate = _rate;
        usdt = IERC20(_usdt);
        presaleOver = true;
        hardcap = _hardcap;
    ...
    function changeMinAmount(uint256 _minAmount) onlyOwner public {
        minAmount = _minAmount;
    }
