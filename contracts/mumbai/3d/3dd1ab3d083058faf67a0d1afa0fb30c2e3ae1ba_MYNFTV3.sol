    ...
    UUPSUpgradeable
{
    ...
    event TestGetter(string indexed _log);
    event TestGetterV3(string indexed _log);
    ...
    function testGetter() public returns (string memory, uint256) {
        emit TestGetter("TestGetter");

        return (contractName, contractVersion);
    }

    function testGetterV3() public returns (string memory, uint256) {
        emit TestGetterV3("TestGetterV3");
