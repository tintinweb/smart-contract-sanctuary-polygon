...
// PixelPark interfaces
import {ICurrencyManager} from "./shared/interfaces/ICurrencyManager.sol";
import {IExecutionManager} from "./shared/interfaces/IExecutionManager.sol";
import {IExecutionStrategy} from "./shared/interfaces/IExecutionStrategy.sol";
import {IRoyaltyFeeManager} from "./shared/interfaces/IRoyaltyFeeManager.sol";
import {IPixelParkExchange} from "./shared/interfaces/IPixelParkExchange.sol";
import {ITransferManagerNFT} from "./shared/interfaces/ITransferManagerNFT.sol";
import {ITransferSelectorNFT} from "./shared/interfaces/ITransferSelectorNFT.sol";
import {IWETH} from "./shared/interfaces/IWETH.sol";

// PixelPark libraries
import {OrderTypes} from "./shared/libraries/OrderTypes.sol";
import {SignatureChecker} from "./shared/libraries/SignatureChecker.sol";

/**
 * @title PixelParkExchange
 * @notice It is the core contract of the PixelPark exchange.
 */
contract PixelParkExchange is IPixelParkExchange, ReentrancyGuard, Ownable {
    ...
    constructor(
        ...
        DOMAIN_SEPARATOR = keccak256(
            abi.encode(
                ...
                0x24ebb0b4c62741b010affe35bffec3c46479d236eda1c208a76efee3b314137c, // keccak256("PixelParkExchange")
...
/**
 * @title OrderTypes
 * @notice This library contains order types for the PixelPark exchange.
 */
library OrderTypes {
