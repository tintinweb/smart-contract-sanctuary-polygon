...
contract LimitOrderBookFactory is Ownable {
    ...
    uint8 public constant CANCEL_DELAY_SEC = 10; // number of seconds before order can be cancelled
    uint16 public constant POSTING_FEE_TBPS = 5; // 0.5bps posting fee that can be rebated (not for cancel)
