...
contract ABTProofTestContract {
    ...
    function testVerifyProof(
        ...
        bytes32 result = verifier.verifyProof({
...
contract ABTProofVerifier is FunctionsClient, ConfirmedOwner {
    ...
    uint64 public subscriptionId = 1313;
    ...
    event RequestInitialized(bytes32 indexed requestId);
    ...
    function verifyProof(
        ...
        require(gasLimit > 0, "Gas limit is not set");
        ...
        // emit RequestInitialized(req.requestId);
        ...
        dynamicArgs[0] = _key;
        dynamicArgs[1] = _zkproof;
        dynamicArgs[2] = _publicSignals;
