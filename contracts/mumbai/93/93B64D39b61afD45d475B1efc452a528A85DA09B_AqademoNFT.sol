...
contract AqademoNFT is ERC721AQueryable, DefaultOperatorFilterer, Ownable {
    ...
    function mint(uint256 _count) external payable callerIsUser {
        ...
        require(msg.value >= mintPrice * _count, "Insuffient Payable amount sent.");
