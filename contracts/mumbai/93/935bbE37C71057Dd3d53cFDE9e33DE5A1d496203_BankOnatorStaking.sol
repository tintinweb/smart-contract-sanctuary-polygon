...
contract BankOnatorStaking is Ownable, ReentrancyGuard {
    ...
    constructor(address token) {
        addMembership(1 * 10 ** DECIMAL, 2);
        addMembership(500000 * 10 ** DECIMAL, 4);
        addMembership(1000000 * 10 ** DECIMAL, 6);
        addMembership(1500000 * 10 ** DECIMAL, 8);
        setToken(token);
    }
    ...
    function stake(uint256 tokens) external nonReentrant {
        ...
        _stakes[msg.sender].stakedAmount += tokens;
