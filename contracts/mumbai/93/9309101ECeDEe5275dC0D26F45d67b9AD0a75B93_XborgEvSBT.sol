...
contract XborgEvSBT is ERC721URIStorage {
    address owner;
    string URI;
    ...
    constructor() ERC721("XBorg EV.io achievements", "XBORG EV SBT") {
    owner = msg.sender;
    ...
    function claimSBT () public returns(uint256){
        ...
        URI = "https://gateway.pinata.cloud/ipfs/QmR5Pon5pAMtqnmPvA2mzpcXDjEAakvwdAU5sSxrxSyzTi";
