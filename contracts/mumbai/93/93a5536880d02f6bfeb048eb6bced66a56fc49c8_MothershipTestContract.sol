...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
    ...
    // File: contracts/mothershipTestContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract MothershipTestContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Mothership Test", "MSHTEST", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmedHX9g3DWAjEBP971MiHpJMN1M7pRTfeBHRp7wVtPLh3/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/HXsbislTtfrVeLprheoT/contract-metadata";
        }
    }