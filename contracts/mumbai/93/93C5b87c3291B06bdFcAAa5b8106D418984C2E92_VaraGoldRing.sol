...
contract VaraGoldRing is IPOLYCONTRACT {
    ...
    mapping (address => SystemRingBonusDetails) public _SystemRingBonusDetails;
    ...
    function _PlaceInRing1(address user) private {
      ...
      if((Length%ringWidth)==0){
         ...
         _SystemRingBonusDetails[placementId].totalRingBonus += rewardRing1;
         _SystemRingBonusDetails[placementId].totalRing1Bonus += rewardRing1;
         //Comment Distribution Start Here
    ...
    function _PlaceInRing2(address user) private {
      ...
      if((Length%ringWidth)==0){
         ...
         _SystemRingBonusDetails[placementId].totalRingBonus += rewardRing2;
         _SystemRingBonusDetails[placementId].totalRing2Bonus += rewardRing2;
         //Comment Distribution Start Here
    ...
    function _PlaceInRing3(address user) private {
      ...
      if((Length%ringWidth)==0){
         ...
         _SystemRingBonusDetails[placementId].totalRingBonus += rewardRing3;
         _SystemRingBonusDetails[placementId].totalRing3Bonus += rewardRing3;
         //Comment Distribution Start Here
    ...
    function _PlaceInRing4(address user) private {
      ...
      if((Length%ringWidth)==0){
         ...
         _SystemRingBonusDetails[placementId].totalRingBonus += rewardRing4;
         _SystemRingBonusDetails[placementId].totalRing4Bonus += rewardRing4;
         //Comment Distribution Start Here
    ...
    function _PlaceInRing5(address user) private {
      ...
      if((Length%ringWidth)==0){
         ...
         _SystemRingBonusDetails[placementId].totalRingBonus += rewardRing5;
         _SystemRingBonusDetails[placementId].totalRing5Bonus += rewardRing5;
         //Comment Distribution Start Here
    ...
    function _PlaceInRing6(address user) private {
      ...
      if((Length%ringWidth)==0){
         ...
         _SystemRingBonusDetails[placementId].totalRingBonus += rewardRing6;
         _SystemRingBonusDetails[placementId].totalRing6Bonus += rewardRing6;
         //Comment Distribution Start Here
    ...
    function _PlaceInRing7(address user) private {
      ...
      if((Length%ringWidth)==0){
         ...
         _SystemRingBonusDetails[placementId].totalRingBonus += rewardRing7;
         _SystemRingBonusDetails[placementId].totalRing7Bonus += rewardRing7;
         //Comment Distribution Start Here
    ...
    function _PlaceInRing8(address user) private {
      ...
      if((Length%ringWidth)==0){
         ...
         _SystemRingBonusDetails[placementId].totalRingBonus += rewardRing8;
         _SystemRingBonusDetails[placementId].totalRing8Bonus += rewardRing8;
         //Comment Distribution Start Here
    ...
    function _PlaceInRing9(address user) private {
      ...
      if((Length%ringWidth)==0){
         ...
         _SystemRingBonusDetails[placementId].totalRingBonus += rewardRing9;
         _SystemRingBonusDetails[placementId].totalRing9Bonus += rewardRing9;
         //Comment Distribution Start Here
    ...
    function _PlaceInRing10(address user) private {
      ...
      if((Length%ringWidth)==0){
         ...
         _SystemRingBonusDetails[placementId].totalRingBonus += rewardRing10;
         _SystemRingBonusDetails[placementId].totalRing10Bonus += rewardRing10;
         //Comment Distribution Start Here
         _PlaceInRing9(placementId);
      }
    }
