...
contract SaleRound is ReferralSystem, ISaleRound, AccessControl {
     ...
     *@param availableCurrencies stable coins will be available for the purchasing MGB
     ...
     * @dev See {IPrivateSale-buyMGB}.
     */
    function buyMGB(address referrer) external payable isFinish {
