...
contract PFP_Beaver_Again is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
    uint256 public MAX_SUPPLY = 50;

    
    uint256 public PRESALE_SUPPLY = 25;
    uint256 public PUBLIC_SUPPLY = 24;
    ...
    string private preRevealURI = "https://ipfs.w3bmint.xyz/ipfs/QmXfabSsgFKq6jhFUXqfC1zdGKfj7ui7e1QfV7Gq5BobxK";
    ...
    constructor(
        bytes32 _Presale) ERC721A("PFP_Beaver_Again", "BEAVERAGAIN") {
        
        PRESALE_ROOT = _Presale;
        
        _safeMint(0xb89317E86DC1D39BF8F5Ba93ae362B361726282b, 1);
    }
    ...
    function PRESALEMint(address to, uint256 numberOfTokens, bytes32[] memory proof) external isSecured(PRESALE_PRICE * numberOfTokens) payable {
