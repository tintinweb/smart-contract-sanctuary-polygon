...
contract Hazim is ERC4973, IERC4907, Ownable {
    ...
    function mint(
        ...
        require(phase() == 0 || phase() == 2, "Venda indisponivel no momento");
    ...
    function split(uint256 _mintAmount, uint64 _flat, uint8 _discountFlag) public payable {
        ...
        } else if (_discountFlag == 31) {
            verifyDiscount = DiscountCode.DISCOUNT_310;
        } else if (_discountFlag == 32) {
            verifyDiscount = DiscountCode.DISCOUNT_320;
        } else if (_discountFlag == 33) {
            verifyDiscount = DiscountCode.DISCOUNT_330;
        } else if (_discountFlag == 34) {
            verifyDiscount = DiscountCode.DISCOUNT_340;
        } else if (_discountFlag == 35) {
            verifyDiscount = DiscountCode.DISCOUNT_350;
        } else if (_discountFlag == 36) {
            verifyDiscount = DiscountCode.DISCOUNT_360;
        } else if (_discountFlag == 37) {
            verifyDiscount = DiscountCode.DISCOUNT_370;
        } else if (_discountFlag == 38) {
            verifyDiscount = DiscountCode.DISCOUNT_380;
        } else if (_discountFlag == 39) {
            verifyDiscount = DiscountCode.DISCOUNT_390;
        } else if (_discountFlag == 40) {
            verifyDiscount = DiscountCode.DISCOUNT_400;
        } else if (_discountFlag == 41) {
            verifyDiscount = DiscountCode.DISCOUNT_410;
        } else if (_discountFlag == 42) {
            verifyDiscount = DiscountCode.DISCOUNT_420;
        } else if (_discountFlag == 43) {
            verifyDiscount = DiscountCode.DISCOUNT_430;
        } else if (_discountFlag == 44) {
            verifyDiscount = DiscountCode.DISCOUNT_440;
        } else if (_discountFlag == 45) {
            verifyDiscount = DiscountCode.DISCOUNT_450;
        } else if (_discountFlag == 46) {
            verifyDiscount = DiscountCode.DISCOUNT_460;
        } else if (_discountFlag == 47) {
            verifyDiscount = DiscountCode.DISCOUNT_470;
        } else if (_discountFlag == 48) {
            verifyDiscount = DiscountCode.DISCOUNT_480;
        } else if (_discountFlag == 49) {
            verifyDiscount = DiscountCode.DISCOUNT_490;
        } else if (_discountFlag == 50) {
            verifyDiscount = DiscountCode.DISCOUNT_500;
        } else {
            verifyDiscount = DiscountCode.NO_DISCOUNT;
        }
    ...
    function applyDiscount(DiscountCode discount) public pure returns (uint256) {
        if (discount == DiscountCode.NO_DISCOUNT) {
            ...
            return 300;
        } else if (discount == DiscountCode.DISCOUNT_310) {
            return 310;
        } else if (discount == DiscountCode.DISCOUNT_320) {
            return 320;
        } else if (discount == DiscountCode.DISCOUNT_330) {
            return 330;
        } else if (discount == DiscountCode.DISCOUNT_340) {
            return 340;
        } else if (discount == DiscountCode.DISCOUNT_350) {
            return 350;
        } else if (discount == DiscountCode.DISCOUNT_360) {
            return 360;
        } else if (discount == DiscountCode.DISCOUNT_370) {
            return 370;
        } else if (discount == DiscountCode.DISCOUNT_380) {
            return 380;
        } else if (discount == DiscountCode.DISCOUNT_390) {
            return 390;
        } else if (discount == DiscountCode.DISCOUNT_400) {
            return 400;
        } else if (discount == DiscountCode.DISCOUNT_410) {
            return 410;
        } else if (discount == DiscountCode.DISCOUNT_420) {
            return 420;
        } else if (discount == DiscountCode.DISCOUNT_430) {
            return 430;
        } else if (discount == DiscountCode.DISCOUNT_440) {
            return 440;
        } else if (discount == DiscountCode.DISCOUNT_450) {
            return 450;
        } else if (discount == DiscountCode.DISCOUNT_460) {
            return 460;
        } else if (discount == DiscountCode.DISCOUNT_470) {
            return 470;
        } else if (discount == DiscountCode.DISCOUNT_480) {
            return 480;
        } else if (discount == DiscountCode.DISCOUNT_490) {
            return 490;
        } else if (discount == DiscountCode.DISCOUNT_500) {
            return 500;
        } else {
