...
// File: mynft/contracts/mynft.sol
...
contract MovieCard is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl, ERC721Burnable {
    struct MetaData {
        string name;
        string director;
        string local;
    ...
    constructor() ERC721("Movie Card", "MC") {
