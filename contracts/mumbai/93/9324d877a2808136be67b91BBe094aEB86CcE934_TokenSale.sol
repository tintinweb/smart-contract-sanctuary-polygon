...
contract TokenSale {
    ...
    function buyTokens(uint256 usdtAmount, address referralCodeOwner) public {
        ...
        if (
            ...
            referrers[referralCodeOwner] != address(0)
        ) {
    ...
    function claimTokens() public {
        ...
        // Calculate the maximum claim amount (10% of the tokenClaims)
        uint256 maxClaimAmount = tokenClaims[msg.sender] / 10;
    ...
    function claimReferralBonus() public {
        ...
        // Calculate the maximum Ref claim amount (10% of the referralBonuses)
        uint256 referralBonus = referralBonuses[msg.sender] / 10;
        ...
        require(
            tokenToSell.transfer(msg.sender, referralBonus),
