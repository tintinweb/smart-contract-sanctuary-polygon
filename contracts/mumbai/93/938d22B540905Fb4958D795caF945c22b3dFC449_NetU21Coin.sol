...
contract NetU21Coin is ERC20, AccessControl   {
    ...
    uint256 public tokensPerMATIC = 1 * (10 ** decimals()); // token price for MATIC
    uint256 public tokenPrice = 1 * (10 ** decimals()); //price in Matic x 1 Netu21 token
    uint256 public tokensFaucetMint = 210; //amount requested in faucet
    ...
    uint public MATICxFullTransfer = 1 * (10 ** decimals()); // MATIC amount for full transfer
    ...
    //admin functions
    function updatePriceTokensPerMATIC(uint256 amount) public onlyRole(DEFAULT_ADMIN_ROLE){
