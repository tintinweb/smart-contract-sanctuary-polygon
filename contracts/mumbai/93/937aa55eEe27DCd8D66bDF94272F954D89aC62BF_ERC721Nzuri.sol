...
contract ERC721Nzuri is ERC721PresetMinterPauserAutoId, ContextMixin, NativeMetaTransaction, IERC721Nzuri, Ownable {
 ...
 */
    ...
    function mintItem(address to) public virtual override returns(uint256 tokenId) {
...
interface IERC721Nzuri is IERC721 {
    function mintItem(address to) external returns(uint256 tokenId);
}
