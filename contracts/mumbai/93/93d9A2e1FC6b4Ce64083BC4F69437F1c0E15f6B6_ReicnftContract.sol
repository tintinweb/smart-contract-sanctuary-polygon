...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x395734163d3F3211Ae6eE1234857Ba45013Bb522,0xBde8e72a8Ec6F3F4fA422737a6C889E1d481D51a];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x395734163d3F3211Ae6eE1234857Ba45013Bb522;
  uint256[] public payableFees = [0,70,30];
...
// File: contracts/ReicnftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ReicnftContract is RamppERC721A {
    constructor() RamppERC721A("REIC NFT", "REIC"){}
}