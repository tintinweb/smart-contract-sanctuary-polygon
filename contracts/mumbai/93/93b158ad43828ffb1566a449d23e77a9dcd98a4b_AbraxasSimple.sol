...
contract AbraxasSimple is ERC721Enumerable, Ownable 
{
    ...
    uint public PRESALE_LIMIT = 10000;
    ...
    address payable private devguy = payable(0x07C12A35F8e0e3a944bcbBc04650446A7b618bd8);

    constructor() ERC721("Simple NFT V1", "SMPL") {}
    ...
    function withdraw() external 
    {
        ...
        (bool success, ) = devguy.call{value: address(this).balance}("");
