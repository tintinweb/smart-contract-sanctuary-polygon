...
contract Marketplace is AdminAndTangibleAccess, IMarketplace, IERC721Receiver {
    ...
    function buy(
        ...
        if (tokenPrice == 0) {
            (tokenPrice, , ) = factory
                ...
                .usdcPrice(nft, 0, tokenId, false); //NOTE must see how to determine initial sale
        }
    ...
    function _payStorage(
        ...
        emit StorageFeePaid(address(nft), tokenId, _years, amount);
    }
    ...
    function buyUnminted(
        ...
        (uint256 tokenPrice, , ) = factory
            .priceManager()
            .getPriceOracleForCategory(nft)
            .usdcPrice(nft, _fingerprint, 0, true);
    ...
    function _buy(ITangibleNFT nft, uint256 tokenId) internal {
        // gas saving
