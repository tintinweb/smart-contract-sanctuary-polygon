...
contract ChainBattles is ERC721URIStorage {
	...
	function initializeStat(uint256 tokenId) private {
		...
		tokenIdtoStat[tokenId] = Stat({
			...
			level: 1,
			hp: baseStat % 2 == 0 ? baseStat + 2 : baseStat + 2,
			mp: baseStat % 2 == 0 ? baseStat - 2 : baseStat + 2,
			str: baseStat % 2 == 0 ? baseStat - 1 : baseStat + 1,
			mag: baseStat % 2 == 0 ? baseStat + 1 : baseStat - 1,
			agi: baseStat % 2 == 0 ? baseStat + 1 : baseStat - 1
		});
	}
