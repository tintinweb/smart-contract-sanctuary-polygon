...
contract JPEGXPool is Ownable, ERC721Holder {
    ...
    uint256 immutable epochduration = 7 days;
    uint256 immutable interval = 6 days / 24;
    ...
    event SetFloorPrice(uint256 _epoch, uint256 _florPrice);
    event SetStrikePrice(uint256[] _strikePrices, uint256[] _floorPrices);
