...
contract AlterOS is Ownable, ReentrancyGuard {
  ...
  function createListing(
    ...
    // }
    require(keccak256(abi.encodePacked(_listings[_listingId].listingId)) != keccak256(abi.encodePacked(_listingId)),"Listing already existed for current listing Id");
    ...
    nonReentrant
  {
    ...
    // }
    require(listing.state == State.INITIATED,"Listing is in wrong state. Aborting.");
    ...
    uint256 fee = listing.price*((_marketplaceFee/1000000000000000000)/100);
