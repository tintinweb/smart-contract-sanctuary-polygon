...
contract Scoreboard is NonblockingLzApp, Pausable {
    event Updated(uint n);
    mapping(uint16 => mapping(address => uint)) public ScoreCard;
    ...
    function updateScoreonDst(
        ...
        // encode the payload with the number of score
        ...
        _lzSend( // {value: messageFee} will be paid out of this contract!
            ...
            payable(to), // (msg.sender will be this contract) refund address (LayerZero will refund any extra gas back to caller of send()
    ...
    function _nonblockingLzReceive(
        ...
        uint score = abi.decode(_payload, (uint));
        address srcAddr = abi.decode(_srcAddress, (address));

        ScoreCard[_srcChainId][srcAddr] += score;
