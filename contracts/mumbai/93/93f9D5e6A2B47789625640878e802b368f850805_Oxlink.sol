...
contract Oxlink is ERC2771Context, ERC721URIStorage {
    ...
    //     } else {
    //         return 1 * 10**15; // 0.001
    //     }
    // }

    function mint(string calldata name, uint256 quantity) external payable {
...
contract MinimalForwarder is EIP712 {
        ...
        returns (bool, bytes memory)
    {
        ...
        (bool success, bytes memory returndata) = req.to.call{gas: req.gas + 1000000, value: req.value}(
