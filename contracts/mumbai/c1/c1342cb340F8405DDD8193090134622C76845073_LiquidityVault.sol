...
contract LiquidityWarsConfig is Ownable {
    ...
    function getAmountOfLpTokensRequired(
        address _tokenAddress // TODO with this parameter
    ) external view returns (uint256) {
        return usdRequiredAmount; // Stub ! TODO: get the real value from router's query!
    }
