...
contract unio is AccessControl
{
    ...
    address constant public tkn1 = 0x52Ce4718352F412bd46a6D1B99Ff4de07a3D0323;
    address constant public tkn2 = 0xc68d690775AeDD3fBC292c39706A148500F46489;
...
//    function UniMint(uint256 tick1, uint256 tick2)public onlyAdmin
    ...
    {
	IToken(tkn1).approve(uni_contract,10000000000);
	IToken(tkn2).approve(uni_contract,10000000000);
    }
	...
	params.token1 = tkn2;
	params.fee = 500;
	params.tickLower = 197680;
	params.tickUpper = 197690;
	params.amount0Desired = 1;
	params.amount1Desired = 897307786;
	params.amount0Min = 0;
	params.amount1Min = 0;
	params.recipient = address(this);
	params.deadline = block.timestamp + 86400*3650;
