...
contract MATIC_GROW {
    ...
    function deposit_add(address user_address,address _referer,uint256 amount) public  onlyInitiator{
        require(amount>=25e18,"Minimum 25 MATIC allowed to invest");
       ...
       // aggregator.transfer(amount.mul(5).div(100));
