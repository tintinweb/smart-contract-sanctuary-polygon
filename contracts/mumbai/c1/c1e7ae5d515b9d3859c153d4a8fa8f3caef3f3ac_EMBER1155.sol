...
contract ERC1155 is Context, ERC165, IERC1155 {
    ...
    function changeCreator(address _creator) external onlyOwner returns(bool) {
        require(address(0) != _creator, "Operator address is zero address");
        emit OperatorChanged(creator, _creator);
        creator = _creator;
        return true;
    }
    ...
    */    
    ...
    function getCreator() external view virtual override returns(address) {
        return creator;
    }
