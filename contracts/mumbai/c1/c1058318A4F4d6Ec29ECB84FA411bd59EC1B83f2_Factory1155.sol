...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new TopProspectUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        TopProspectUser1155Token token = TopProspectUser1155Token(address(addr));
...
contract TopProspectUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
