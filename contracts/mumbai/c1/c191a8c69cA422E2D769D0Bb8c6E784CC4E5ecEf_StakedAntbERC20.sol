...
contract StakedAntbERC20 is ERC20Permit, Ownable {
    ...
    constructor() ERC20('Staked ANTB', 'sANTB', 9) ERC20Permit() {
    ...
    /**
        @notice increases sANTB supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sANTB
