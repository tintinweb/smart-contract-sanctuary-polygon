...
contract StanNFTV2 is ERC721A {
    ...
    function setCollectionNFT(
        address _collectionNFTAdrress
    ) external onlyOwner {
        collectionNFT = ICollectionNFT(_collectionNFTAdrress);
    }

    function setAuthorizers(
        address[] calldata _caller,
        bool _allowed
    ) external onlyOwner {
