...
contract LaunchpadTest is ERC721, ERC721Enumerable, Pausable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    uint256 MAX_SUPPLY = 1000;
    
    constructor() ERC721("Launchpad Test", "TST") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://ipfs.filebase.io/ipfs/QmSz41NqSWXdbFpp7oV3igxmPVGoSE4rENnWH7ehbQi99L/";
    }
    ...
    function tokenURI(uint256 id) public pure override returns (string memory) {
        return
            string(
                abi.encodePacked(
                    "https://ipfs.filebase.io/ipfs/QmSz41NqSWXdbFpp7oV3igxmPVGoSE4rENnWH7ehbQi99L/",
                    Strings.toString(id),
                    ".json"
                )
            );
