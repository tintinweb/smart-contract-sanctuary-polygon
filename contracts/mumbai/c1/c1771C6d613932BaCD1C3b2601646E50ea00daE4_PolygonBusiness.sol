...
contract PolygonBusiness{
  ...
  function initialize(address payable _admin, address payable _admin2) public {
	require(IsInitinalized==false,"You can use it only one time");
	    ...
	    requiredDirectbusiness = [1000,2000,3000,4000,5000,6000,7000,8000,9000,10000];
        defaultPackages = [100 ether,500 ether,2000 ether ,5000 ether,10000 ether];
    ...
    function invest(address referrer) public payable {
		...
		require(msg.value >= INVEST_MIN_AMOUNT,'Min invesment 100 MATIC');
