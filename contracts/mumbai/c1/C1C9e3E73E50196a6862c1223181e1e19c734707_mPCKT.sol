...
//        isSwapping = false;
    ...
    function _beforeTokenTransfer(
     ...
     // pull erc20 tokens out of the contract, needed for migrations/emergencies 
    function withdrawToken(IERC20 _tokenContract, uint256 _amount) public onlyOwner {
        _tokenContract.transfer(address(owner()), _amount);
    }
...
/*
    ...
    function lock(uint256 _nftId) public nonReentrant {
        ...
        require(userLocks[msg.sender][_nftId].tokenAmount == 0 && nftInfo[_nftId].lastGiven != address(msg.sender), 'Cant Lock');
...
/*
    ...
    function unLockNft(uint256 _nftId) public nonReentrant {
        require(activeFeatures.vaultActive && activeFeatures.giveNfts && userNftLocks[msg.sender][_nftId].amount > 0, 'Not Locked');
    ...
    function useNft(uint256 _nftId) public isInitialized nonReentrant{
        ...
        if(minerNftInfo[_nftId].nftType == 2){
            ...
            claimedWorkers[msg.sender] = adjustTokenShares(minerNftInfo[_nftId].amount);
