...
contract LiquidAccess is ERC721, ERC721Enumerable, ERC2981, Ownable, IERC4906 {
    ...
    string private _nftDescription = "This token gives you premium access to Aloha Browser. You may extend the expiration date by simply using the browser. Owners of the Genesis Pass will receive drops from future collaborations. Visit [alohabrowser.com](https://alohabrowser.com/) to activate your pass. Powered by [Liquid Access](https://liquidaccess.com/).";
    string private _nftImage = "https://liquidaccess-public.s3.amazonaws.com/aloha-genesis.png";
    ...
    string private _contractImage = "https://liquidaccess-public.s3.amazonaws.com/aloha.png";
