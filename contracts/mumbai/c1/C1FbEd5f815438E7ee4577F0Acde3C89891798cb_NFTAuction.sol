...
//contract NFTMarketplace is ERC1155 {
    ...
    function createToken(string memory creator, string memory tokenURI, uint256 price, uint tier, uint num, uint _time) public onlyOwner returns (uint) {
        ...
        for(uint i = 0; i < actualcount; i++)
        {
          ...
          createMarketItem(tokenURINums[tokenURI] + i,newTokenId, price, _tokenURI, _time);
    ...
    function fetchOwnableItems() public view returns(uint256){
    ...
    function fetchAuctionItems() public view returns (MarketItem[] memory) {
        ...
        for (uint i = 0; i < totalItemCount; i++) {
          ...
          if ( idToMarketItem[i + 1].isAuction ) {
              itemCount += 1;
          }
        }
    ...
    function fetchItemsByFeatureInfluencers() public view returns (MarketItem[] memory) {
      ...
      for (uint i = 0; i < totalItemCount; i++) {
        ...
        if (influencer_featured[idToMarketItem[i + 1].creator] && (idToMarketItem[i + 1].isAuction)
