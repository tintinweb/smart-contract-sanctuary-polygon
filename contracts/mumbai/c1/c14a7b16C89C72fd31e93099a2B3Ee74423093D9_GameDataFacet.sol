...
contract GameDataFacet is ChainlinkClient{
   ...
   event ScoreUpdated(string gameId);
    ...
    function getWeeklySchedulep1(string memory _date, string memory _limit) external onlyHost {
    ...
    function getWeeklySchedulep2(string memory _date, string memory _limit) external onlyHost {
    BigBoardManagerLib.ChainlinkNode memory c = BigBoardManagerLib.getNode();
    ...
    function getAwayScoresForGame(string memory _gameId) external onlyHost {
    BigBoardManagerLib.ChainlinkNode memory c = BigBoardManagerLib.getNode();
    ...
    function getHomeScoresForGame(string memory _gameId) external onlyHost {
    BigBoardManagerLib.ChainlinkNode memory c = BigBoardManagerLib.getNode();
    ...
    function getGameData(string memory _gameId) external onlyHost {
        BigBoardManagerLib.ChainlinkNode memory c = BigBoardManagerLib.getNode();
