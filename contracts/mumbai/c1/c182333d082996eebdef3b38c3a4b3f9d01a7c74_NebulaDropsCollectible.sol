...
contract NebulaDropsCollectible is ERC1155, Ownable {
    ...
    function mint(address _nebulaMarketplace, uint256 _amount, bool _cardpay) 
        public  payable  
     {
       ...
       // if(mintedTokensByArtists[_dropid].tokensMinted > 0){
        ...
        _setApprovalForAll(_msgSender(), _nebulaMarketplace, true);
    ...
    function mintBatch(
       // uint256 _initialId,
     address _nebulaMarketplace, uint256 _amount, uint256  _totalNoOfTokens, bool _cardpay) 
        public payable
    {
        // string memory _name, string memory _newuri, 
        ApprovedArtists4Minting memory _approvedArtist =   allowArtistToMintTokens[msg.sender];
