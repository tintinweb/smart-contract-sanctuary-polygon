...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x9C66DCEAff3ce1FA4fAd85A06EedEF3ce613bEF0,0x6809F8D7FC7F86b87BA6308666D78462Cf003337,0xf3EE172360f8cf5F165f89A14fa80Ab233dcE9e3];
  uint256[] public payableFees = [5,47,47,1];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 2, 831 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeig52fnalfsj645fsubgkhxw53vnzd6ckpmb4nfjinzikcf27zylta/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 831");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 831");
...
contract TestingContract is RamppERC721A {
    constructor() RamppERC721A("Testing", "TTTT"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/1VqqrHyDV99WDtwODGut/contract-metadata";
    }
}
