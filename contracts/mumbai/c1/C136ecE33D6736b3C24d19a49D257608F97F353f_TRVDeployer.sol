...
contract TRVDeployer is Ownable {
  ...
  // 12 -> rental keeper // new
  mapping(uint256 => address) public elements;

  // 0x20f167a63fC519f1df52B0CCc135939C04188DB1 deployed deployer
  ...
  constructor() {
    ...
    elements[4] = 0x672a94C09e2bb7CB6155D46d6F1dEA18C2271887; // new
    ...
    // rental
    elements[12] = 0x7c0475C58b474d27deC9A104E63e2EC17BbE7ef8; // new
  }
  ...
  function bindingUtils() external onlyOwner {
    ...
    IAll(elements[4]).bindRentalKeeper(elements[12]);

    IAll(elements[0]).grantMaster(elements[4], elements[10]);
    IAll(elements[0]).grantMaster(elements[4], elements[12]);
  }
...
interface IAll {
  ...
  function bindRentalKeeper(address) external;
