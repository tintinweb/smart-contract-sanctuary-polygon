...
contract Metasensys  is ERC721Enumerable, Ownable
{
   ...
   uint256 public DiamindCounter=0;    
    ...
    bool public isSilver_mintPaused = true;
    bool public isGold_mintPaused = true;
    bool public isDiamond_mintPaused = true;
 ...
 constructor() ERC721("METASENSYS", "MS")  {
     _baseURI= "https://sloopyseals.mypinata.cloud/ipfs/QmQq3EDFArKuzXcK68cFcK2j7HsKz9akV7uDHVGEci9H4G/";
    // contractURI();
    }
    ...
    function mint(uint chosenAmount) public payable isSaleOpen
    {
            ...
            require(SilverPrice.mul(chosenAmount) == msg.value, "Sent ether value is incorrect");
              for (uint i = 0; i < chosenAmount; i++) {
                 ...
                 SilverCounter++;
                 isGold_mintPaused=true;
                 isDiamond_mintPaused=true;

            }
            if(isGold_mintPaused ==false)
            {
            require(GoldPrice.mul(chosenAmount) == msg.value, "Sent ether value is incorrect");
              for (uint i = 0; i < chosenAmount; i++) {
                 ...
                 GoldCounter++;
                                  isDiamond_mintPaused=true;
                                  isSilver_mintPaused=true;


            }
            if(isDiamond_mintPaused ==false)
            {
      ...
      function Change_GoldPrice_Price (uint goldprice) public onlyOwner{
        GoldPrice=goldprice;
    }
    ...
    function Change_SilverPrice(uint slPrice) public onlyOwner{
     ...
     function Change_DiamondPrice(uint Diamondprice) public onlyOwner{
   ...
   function getSilverprice() public view returns(uint256){
    ...
    function flipSilverStatus() public onlyOwner {
        isSilver_mintPaused = !isSilver_mintPaused;
    }  
    
    function flipGoldStatus() public onlyOwner {
        isGold_mintPaused = !isGold_mintPaused;
    }  
    
    function flipDiamindStatus() public onlyOwner {
        isDiamond_mintPaused = !isDiamond_mintPaused;
    }
