...
contract MerkleAirdrop is Ownable, Pausable, ReentrancyGuard {
    ...
    function claimTokens(
        ...
        require(_recipient != address(0), "MerkleAirdrop: invalid recipient address");
        ...
        require(_recipient == msg.sender, "MerkleAirdrop: only recipient can initiate their own claim");
