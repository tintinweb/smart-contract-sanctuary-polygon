...
contract EPOS is Ownable {
    ...
    function register(
        ...
        uint256 _decimalfactor = decimalfactor;
        ...
        token.transfer(referredBy, _tokenTransfered);
        ...
        token.transfer(owner, amount - _tokenTransfered);
        ...
        userAssets[msg.sender].withdrawableAsset +=
            ...
            price[priceIndex];
        userAssets[msg.sender].totalAsset += _amount* decimalfactor / price[priceIndex];
        _currentId++;
        ...
        emit Registeration(msg.sender, referredBy, _amount*decimalfactor , block.timestamp);
    }
