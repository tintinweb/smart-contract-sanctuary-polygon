...
contract MatchMaker is VRFConsumerBaseV2, ReentrancyGuard, Ownable {
    ...
    function getEarnings() external view returns (TournamentStruct[] memory) {
       uint256[] memory _paidTournaments = paidTournamentIds[msg.sender];
       TournamentStruct[] memory tournaments;
