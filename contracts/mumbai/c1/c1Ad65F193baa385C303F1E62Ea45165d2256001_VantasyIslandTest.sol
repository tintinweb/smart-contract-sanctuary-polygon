 ...
 * @notice This contract handles minting Vantasy-island-test tokens.
 */
contract VantasyIslandTest is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x3d1e0dbfA6BFB8555587cAAd896487743899d982;
    ...
    string public name = "Vantasy-island-test";
    string public symbol = "VANT";
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeifs5qfrap2cajnr7t7f3ibckgfjuijbpg4f6sha56m22tk6nsw5t4/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenPublicSaleStartTime[1] = 1684042200;
        tokenPublicSaleEndTime[1] = 2002143406;
