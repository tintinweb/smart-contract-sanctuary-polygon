...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x943bFF4FE1Bbf409E3490971DC82A5E48d0642f3];
  address public erc20Payable = 0x943bFF4FE1Bbf409E3490971DC82A5E48d0642f3;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1000, 2998) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeicmb5s3kymhurksbsjbfr2lp6fq7xoidgumaequtn62jymm42u2ju/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/8JvmyAc7vqPeVJ2kokBm/contract-metadata";
  }
...
// File: contracts/BadBunnyContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BadBunnyContract is ERC721APlus {
    constructor() ERC721APlus("Bad Bunny", "BB"){}
}
