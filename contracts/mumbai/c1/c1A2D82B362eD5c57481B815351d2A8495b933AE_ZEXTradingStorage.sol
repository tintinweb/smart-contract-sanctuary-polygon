...
// File: contracts\interfaces\PoolInterface.sol
...
// File: contracts\interfaces\PausableInterface.sol
...
// File: contracts\ZEXTradingStorage.sol
...
contract ZEXTradingStorage {
    ...
    TokenInterface public token = TokenInterface(0x7075cAB6bCCA06613e2d071bd918D1a0241379E2);
    NftInterface[5] public nfts = [
        NftInterface(0xF9A4c522E327935BD1F5a338c121E14e4cc1f898),
        NftInterface(0x77cd42B925e1A82f41d852D6BE727CFc88fddBbC),
        NftInterface(0x3378AD81D09DE23725Ee9B9270635c97Ed601921),
        NftInterface(0x02e2c5825C1a3b69C0417706DbE1327C2Af3e6C2),
        NftInterface(0x2D266A94469d05C9e06D52A4D0d9C23b157767c2)
    ];
    ...
    struct OpenLimitOrder{
        ...
        uint pairIndex;
        uint index;
        uint positionSize;          // 1e18 (DAI or ZEX2)
    ...
    event NftsUpdated(NftInterface[5] nfts);
    ...
    function updateNfts(NftInterface[5] memory _nfts) external onlyGov{
