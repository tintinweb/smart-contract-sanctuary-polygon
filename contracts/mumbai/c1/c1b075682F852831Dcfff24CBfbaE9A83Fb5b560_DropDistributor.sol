...
contract DropDistributor {
    ...
    constructor(IERC20 token_, address _owner) {
        token = token_;
        owner = _owner;
    ...
    function setDropAmount(uint256 dropAmount) public onlyOwner{
        ...
        external 
    {
        ...
        emit Claimed(msg.sender,setAmount);
    }
