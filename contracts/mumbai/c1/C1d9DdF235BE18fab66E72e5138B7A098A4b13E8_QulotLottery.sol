...
contract QulotLottery is ReentrancyGuard, IQulotLottery, Ownable {
    ...
    event RoundClose(uint256 roundId, uint256 totalAmount, uint256 totalTickets, uint256 endTime);
    event RoundDraw(uint256 roundId, uint32[] numbers);
    event RoundReward(uint256 roundId, uint256 amountTreasury, uint256 amountInjectNextRound);
