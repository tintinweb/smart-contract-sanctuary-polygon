...
contract LongShort is ILongShort, AccessControlledAndUpgradeable {
  ...
  function registerPoolMarketContract(
    ...
    uint256 initialMarketSeedForEachMarketSide, // TODO rename to effective liquidity
    address oracleManager,
    address yieldManager,
    IMarketTieredLeverage.PoolInfo[] memory launchPools
  ) external adminOnly {
  ...
  */
    ...
    requireMarketExists(marketIndex)
  {
    ...
    if (marketIndex < SEPARATE_MARKET_CONTRACT_INDEX_START()) {
      ...
      IMarketTieredLeverage(separateMarketContracts[marketIndex]).updateSystemState();
    }
  }
  ...
  function mintLong(
    ...
    IMarketTieredLeverage(separateMarketContracts[marketIndex]).mintLongFor(
      pool,
      amount,
      msg.sender
    );
  ...
  function mintShort(
    ...
    IMarketTieredLeverage(separateMarketContracts[marketIndex]).mintShortFor(
      pool,
      amount,
      msg.sender
    );
  ...
  function redeemLong(
    ...
    IMarketTieredLeverage(separateMarketContracts[marketIndex]).redeemLongFor(
      pool,
      tokens_redeem,
      msg.sender
    );
  ...
  function redeemShort(
    ...
    IMarketTieredLeverage(separateMarketContracts[marketIndex]).redeemShortFor(
      pool,
      tokens_redeem,
      msg.sender
    );
 ...
 */
    ...
    virtual
  {
    if (marketIndex < SEPARATE_MARKET_CONTRACT_INDEX_START()) {
      ...
      IMarketTieredLeverage(separateMarketContracts[marketIndex])
...
interface IMarketTieredLeverage {
  ...
  function pools(PoolType, uint256)
    external
    view
    returns (
      address token,
