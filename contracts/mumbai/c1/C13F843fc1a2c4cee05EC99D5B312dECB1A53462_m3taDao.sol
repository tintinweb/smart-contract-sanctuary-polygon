...
//     :       :   : :  : :: : :  :::  :: : :       :        ::        ::      :: ::::  ::: ::::  ::         ::  :: : :    \\
    ...
    function createLensProfile(DataTypes.ProfileTableStruct memory vars) public {
        // to , profId , ProfHex , metadataTable null values ;
        ...
        payable
    {
        ...
        //  founder address , accountID , metadataTable  & accountHex null values
    ...
    function createSubProject(DataTypes.ProjectStruct memory vars)
        ...
        payable
    {
        // sender , projectID , metadataTable  & projectHex null values
    ...
    // Update metadata for an Account/Organization/Team
