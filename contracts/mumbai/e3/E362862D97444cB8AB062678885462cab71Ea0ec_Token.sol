...
contract Token is ERC20, Ownable , ERC20Burnable {
    ...
    /**
     * @notice owner transfers amount to buyer
     * @param to addess of buyer
     * @param amount amount of tokens to mint (in wei value)
     *
     * transfer of ether happens offline
    */
   function transfer(address to, uint256 amount) public override onlyOwner returns (bool) {
        ...
        require(amount > 0, "Amountshould be greater than 0");
        //if (to == address(0)) {
    ...
    function peggedTo() external pure returns(string memory){
        return "Silver in USD";
    }
