...
contract NTStakeReward is ReentrancyGuardUpgradeable, AccessControlEnumerableUpgradeable {
    ...
    function RewardTo(address to, uint256 rewardAmount) public {
        require(hasRole(MINTER_ROLE, msg.sender));
        rewardToken.mintTo(msg.sender, rewardAmount);
