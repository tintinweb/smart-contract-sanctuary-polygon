...
contract MockViciERC20 is ViciERC20 {
    ...
    function freeMint(address _toAddress, uint256 _amount) public {
        ...
        tokenData.mint(
            this,
            ERC20MintData(owner(), CREATOR_ROLE_NAME, _toAddress, _amount)
        );
 ...
 * - CREATOR_ROLE_NAME: can mint/burn tokens
    ...
    EIP712
{
        ...
        whenNotPaused
    {
        tokenData.mint(
            this,
            ERC20MintData(_msgSender(), CREATOR_ROLE_NAME, toAddress, amount)
        );
        ...
        whenNotPaused
    {
        tokenData.burn(
            this,
            ERC20BurnData(_msgSender(), CREATOR_ROLE_NAME, fromAddress, amount)
        );
