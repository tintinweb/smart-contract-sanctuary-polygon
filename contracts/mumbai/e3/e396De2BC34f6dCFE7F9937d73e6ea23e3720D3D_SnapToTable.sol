...
contract SnapToTable is Initializable, ERC721Upgradeable, OwnableUpgradeable, UUPSUpgradeable, ERC721HolderUpgradeable {
    ...
    function getName(uint256 tableId) private returns(string memory) {
        string.concat(
            "snapshot_",
            StringsUpgradeable.toString(block.chainid),
            "_",
    ...
    function getRow(IERC721EnumerableUpgradeable nft, uint256 index) private returns (string memory){
