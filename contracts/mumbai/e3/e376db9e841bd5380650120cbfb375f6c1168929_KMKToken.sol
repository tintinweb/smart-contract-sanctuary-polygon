...
// File: contracts/ERC20-KMK-Child-1.sol
...
contract KMKToken is ERC20, AccessControl/*, ERC20Pausable*/ {
    ...
    constructor(address _childChainManagerProxy) ERC20("KMK Token Test (Child) 1", "KMKTC1") {
    ...
    function deposit(address user, bytes calldata depositData) external {
        ...
        _mint(user, amount);        // 與官方範例不同(修改版)
    }

    function withdraw(uint256 amount) external {
        // https://docs.polygon.technology/docs/develop/ethereum-polygon/pos/mapping-assets/
        _burn(msg.sender, amount);  // 與官方範例不同(修改版)
    }
