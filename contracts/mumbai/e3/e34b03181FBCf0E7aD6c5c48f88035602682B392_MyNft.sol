...
contract MyNft is ERC721, Ownable, ERC2981 {
    ...
    address[] public withdrawAddresses = [0xcc0756D7586Ec64B44F7fdf2f023829e03dAaa4f];
    ...
    constructor() ERC721("BBB", "BB") {
        _baseTokenURI = "https://test-nft-tool-gateway-api.tuoluo.net/generator-server/api/contract/v1/1599707590277267457/metadata/1";
        _setDefaultRoyalty(0xcc0756D7586Ec64B44F7fdf2f023829e03dAaa4f, uint96(320));
    }
