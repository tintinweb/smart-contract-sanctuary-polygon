...
contract NicoFTProxy is EternalStorage, Proxy {
  /**
   * @notice Proxy Manager
   */
  address internal immutable _manager;

  constructor(uint96 _royaltyFeesInBips) EternalStorage("NicoFT", "NICFT") {
  ...
  /**
   * @notice Hook that is called before falling back to the implementation.
   */
  ...
  /**
   * @notice Set new logic contract address.
   * @param _newImplementation representing the address of the upgraded implementation
   */
  function setImplementation(address _newImplementation) public {
    require(_newImplementation != address(0), "implementation must be valid");
    require(msg.sender == _manager, "invalid owner");
