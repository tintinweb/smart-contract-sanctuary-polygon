...
contract CartoonisticsPuzzlePieces is ERC721A, Ownable, ERC2981, DefaultOperatorFilterer {
    ...
    constructor(string memory _initBaseURI, string memory _initNotRevealedUri, string memory _contractURI) ERC721A("Cartoonistics Puzzle Pieces", "CPP") {
