...
contract THEWORKINGDOG is ERC721A, Ownable {
  uint256 public maxSupply = 3388;
  address wallet1 = 0x4736FF6529724E4a38E60B220B8405F9a2144e97 ;
  address wallet2 = 0x3E034Dc9b877E103eB5E29102133503CdFdA60C5 ;
  constructor() ERC721A("THE WORKING DOG", "TWD", "ipfs://jason/") {
    _safeMint(wallet1, 2000) ;
  }

  // 1388 
  function mintTo( uint256 quantity ) external onlyOwner{
    require( totalSupply() +  quantity < maxSupply ) ;
    _safeMint(wallet2, quantity) ;
  }
