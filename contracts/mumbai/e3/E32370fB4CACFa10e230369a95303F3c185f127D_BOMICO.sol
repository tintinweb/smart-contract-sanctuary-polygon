    ...
    */
    ...
    contract BOMICO is Pausable{
        ...
        constructor(IERC20 _bom, IERC20 _matic, IERC20 _busd, IERC20 _usdt, IERC20 _usdc, address _masterWallet) {
            require(address(_bom) != address(0), "BOM address cannot be zero");
            require(address(_matic) != address(0), "Matic address cannot be zero");
            require(address(_busd) != address(0), "BUSD address cannot be zero");
            require(address(_usdt) != address(0), "USDT address cannot be zero");
            require(address(_usdc) != address(0), "USDC address cannot be zero");

            require(_masterWallet != address(0), "Masterwallet cannot be zero");
            bom = _bom;
            matic = _matic;
            busd = _busd;
            usdt = _usdt;
        ...
        function invest(uint amount, uint8 id) external payable whenNotPaused returns(uint bomTokenAmount) {
            WhitelistRound storage wlRound = _whiteListRounds[_curRound];
        ...
        function claim(uint amount) whenNotPaused external {
        ...
        function claimAll() whenNotPaused external {
