...
abstract contract PriceStabilizer {
    ...
    function getDerivedPrice(uint8 _decimals, int256 _target, int256 _qtyForOne)
    public
    view
    returns (int256)
    {
        ...
        return (basePrice * decimals / quotePrice) / _qtyForOne;
    }


    function getConvertedQuote(int256 _target, int256 qtyForOne) public view returns(int256) {
    return getDerivedPrice(18, _target, qtyForOne);
    }
...
contract PriceStabilizerLabzMatics is PriceStabilizer {
    ...
    function _stabilize(int256 _target, int256 qtyForOne) internal virtual returns(int256) {
        int256 _quote= getConvertedQuote(_target, qtyForOne);
    ...
    function stabilize(int256 _target, int256 qtyForOne) public returns(int256) {
        return _stabilize(_target, qtyForOne);
    }
