...
contract MillionadaGold_f {
    ...
    uint public lottery_draw_latest_block = 43712322;
    uint public month_lottery_draw_latest_block = 43712322;
    uint public year_lottery_draw_latest_block = 43712322;
    ...
    //function onERC20Receive(address from, uint256 amount) external returns (bool) {
        ...
        //if(block.number - lottery_draw_latest_block > 1000)
        {
            ...
            month_jackpot += getBalanceUSDT()/100;
            year_jackpot += getBalanceUSDT()/100;
            dev_fee += getBalanceUSDT()/1000;
            
            uint draw_value =  getBalanceUSDT() - month_jackpot - year_jackpot - dev_fee;
            winnerSend(IERC20(deposit_token), address(participants[winner]), draw_value);
