...
contract TheContract is ERC721A, ERC2981, Ownable, ReentrancyGuard {
  enum MintPhase {
    PreSale,
    Sale,
    PostSale
  ...
  uint256 public constant PRICE_IN_WEI = 215 ether;  // $85 / $0.3996 = 212,7127127127 => 215 https://coinmarketcap.com/currencies/polygon/
