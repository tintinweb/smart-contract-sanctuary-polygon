...
contract Ramendesu_flat is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://QmdLECtFiVjiYnvNNbAuzkyVN5BSiXcsX8bbPhn84aTirY";
  ...
  constructor() ERC721("ramensukidesuka", "RAMEN") {
