...
contract Example is ERC721, Ownable, PaymentSplitter {
    ...
    function mintNFT(uint256 amountTokens, address _to) public payable {
        ...
        require (msg.value == (getPrice(_to).mul(amountTokens)), "Amount of Ether incorrect, try again.");
        ...
        if (preSaleIsActive) {
            ...
            reserveListPreSaleCounter[_to] += amountTokens;
        }
