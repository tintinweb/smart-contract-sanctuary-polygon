    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiarluqrcsjthpz3jn42rdm4vzs64vkkm7syndh2inw3slscimggqq/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/vSUzewxOv8ESHznJCEzR/contract-metadata";
  }
...
// File: contracts/HappywartestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract HappywartestContract is ERC721APlus {
    constructor() ERC721APlus("Happywartest", "MINTPLEX"){}
}
