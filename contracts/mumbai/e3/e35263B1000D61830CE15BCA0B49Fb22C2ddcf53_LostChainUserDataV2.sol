...
contract LostChainUserDataV2 is CustomERC2771ContextUpgradeable, UUPSUpgradeable {
    ...
    function TEMPUPDATEWALLETADDRESS(
        address first,
        address second,
        string calldata uid
    ) public onlyRole('DEFAULT_ADMIN_ROLE', msg.sender) {
        wallets[first] = false;
        wallets[second] = true;

        userWalletLink[uid].walletAddress = second;
    }
