...
contract freshProduce is ERC721Enumerable, Ownable {
    ...
    bool public dailyLimitReached;
    bool public standOn;
    
    string public METADATA = "";
    
    constructor(string memory baseURI) 
        ERC721("freshproduce", "FP") public{
            setBaseURI(baseURI);
        }
    ...
    function onefruitforyou(address _patronaddy) public onlyOwner {
        ...
        require(!dailyLimitReached,                                     "fruit stand is all out for today");
        ...
        _safeMint( _patronaddy, supply + 1 );
    }
    ...
    function fruitforthepeople(address[] calldata _patronaddies) public onlyOwner {
        ...
        require(standOn,                                             "fruit stand is closed");
        require(!dailyLimitReached,                                  "fruit stand is all out for today");
        require(_patronaddies.length <= (11-(supply % 10)),        "Not enough fruits left in the day for this many addresses");
        
        if((supply + _patronaddies.length - 1) % 10 == 0 ){
            dailyLimitReached = true;
        }
    ...
    function resetDailyLimit() public onlyOwner {
