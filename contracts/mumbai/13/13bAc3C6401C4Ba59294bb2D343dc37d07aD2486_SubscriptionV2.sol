...
contract SubscriptionV2 is ISubscription , MultiSig{
    ...
    function getListOfSubscriptionsForUser () external onlyOwner view returns (Subscription[] memory subscriptions_, uint256 total_) {
