...
// File: contracts/TestFreePayable.sol


pragma solidity ^0.8.9;


contract TestFreePayable is AccessControl {
    ...
    constructor(
        ...
        uint256 finneys = 101000; // finneys = 1/1000 Ether (0.00x Ether)
        _price = 1000000000000000 * finneys; // wei = 1/10**18 Ether
        ...
        payable
    {
        if (!hasRole(FREE_FROM_CHARGE_ROLE, msg.sender)) {
            ...
            require(msg.value == _price, "/!\\ Wrong value sent");
