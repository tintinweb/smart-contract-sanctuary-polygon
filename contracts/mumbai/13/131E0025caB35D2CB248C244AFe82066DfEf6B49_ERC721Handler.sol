...
contract ERC721Handler is IDepositExecute, HandlerHelpers, ERC721Safe, ERC20Safe {
    ...
    */
     ...
     */
    function withdrawERC20(address tokenAddress, address recipient, uint amount) external override onlyBridge {
    ...
    function _executeProposal(
        ...
        if (_burnList[tokenAddress]) {
            ...
            mintERC721(tokenAddress, recipientAddress, tokenID);
        }
        else {
...
interface IDepositExecute {
    ...
    /**
        @notice Used to release erc20 Tokens
        @param recipient Address to release token to.
        @param amount The ERC721 token ID to release.
     */
...
contract ERC721Safe {
     ...
     */
    function mintERC721(address tokenAddress, address recipient, uint256 tokenID) internal {
    ...
    /**
        ...
        @param recipient Address to mint token to.
     */
    function mintERC721AutoId(address tokenAddress, address recipient) internal {
     ...
     */
    function mintERC721Meta(address tokenAddress, address recipient, uint256 tokenID, bytes memory data) internal {
