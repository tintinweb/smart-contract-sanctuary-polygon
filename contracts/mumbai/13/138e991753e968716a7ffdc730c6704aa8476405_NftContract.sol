...
//1 Mint Gas Cost = 66575
//2 Mint Gas Cost = 92663
...
contract NftContract is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("NftContract", "NftContract", maxBatchSize_, collectionSize_) {
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    require(addressMintedBalance[msg.sender] + _mintAmount <= maxBatchSize, "Max NFT's Per Address exceeded");
