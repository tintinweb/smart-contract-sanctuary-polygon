    ...
    ErrorCodes
{
    ...
    function createListing(ListingParameters calldata _params) public override {
        ...
        require(
            !_safeListing[_params.assetContract][_params.tokenId],
            throwError(ALREADY_LISTED)
        );
        ...
        _safeListing[_params.assetContract][_params.tokenId] = true;
        listingIdTracker += 1;
    ...
    function buy(
        ...
        if (targetListing.quantity == 0)
            _safeListing[targetListing.assetContract][
                targetListing.tokenId
            ] = false;
    }
