...
contract AviatorCoin is ERC20, ERC20Burnable, Pausable, Ownable {
    constructor() ERC20("Aviator Coin", "AVT") {}
    uint public price;
    ...
    function mint(address to, uint256 amount) public  payable {
        require(msg.value == (price*amount), "Not enough amount provided");
        _mint(to, amount);
    }
