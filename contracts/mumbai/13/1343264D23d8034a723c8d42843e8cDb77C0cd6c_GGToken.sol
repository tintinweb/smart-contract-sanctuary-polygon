...
contract GGToken is ERC20("GGToken", "GG"), Ownable {
    ...
    constructor(address[] memory partnersWallets, address devWallet, address communityWallet, address _distributeContract) public {
    ...
    function recyclePotion() public {
        require(POTIONS(potContract).balanceOf(msg.sender, 500)>0);
        POTIONS(potContract).burnPotion(msg.sender,500);
