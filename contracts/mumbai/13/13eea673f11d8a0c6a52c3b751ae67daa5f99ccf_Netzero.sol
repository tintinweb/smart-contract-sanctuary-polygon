...
contract Netzero is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    uint256[] public netzerotoken;

    event netzerotokenid (
        address from,
        uint id

    );

    constructor() ERC721("Netzero", "NetzeroNFT") {
    }
