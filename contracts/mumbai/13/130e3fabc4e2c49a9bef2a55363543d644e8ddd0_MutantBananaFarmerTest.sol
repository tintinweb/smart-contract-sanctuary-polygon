...
contract MutantBananaFarmerTest is ERC721Enumerable, Ownable {

    uint256 public apePrice = 20000000000000000;
    ...
    string public baseURI = "https://ipfs.io/ipfs/QmcAvhngQ3sM5EsFiVn8XeDccBENLF3vLwQE3vJ3U2TKK3";
    ...
    constructor() ERC721("MutantBananaFarmerTest", "MPHMBF"){
    whitelist[0x8B6C5793D18509993A1C843851aD49C1BE4B864f].exists = true;
    whitelist[0xA6Ad6353F06d8baE06929fC2c5707C707fB9da50].exists = true;
    ...
    function PresaleMint(uint256 numberOfTokens) public payable{
        ...
        require(numberOfTokens > 0 && tokensMinted + numberOfTokens <= ApeSup, "Purchase would exceed current max supply of MPHMBF's");
        require(whitelist[msg.sender].presalemints + numberOfTokens <= 10,"This Wallet has already minted its 10 reserved MPHMBF's");
        require(msg.value >= apePrice * numberOfTokens, "ETH value sent is too little for this many MPHMBF's");
    ...
    function mintApeRaffle(uint numberOfTokens) public payable {
        ...
        require(tokensMinted + numberOfTokens <= ApeSup, "Purchase would exceed max supply of MPHMBF's");
        require(msg.value >= apePrice * numberOfTokens, "ETH value sent is too little for this many MPHMBF's");
        require(((addressesThatMinted[msg.sender] + numberOfTokens) * 100) <= (ApeSup * 10), "You have already minted 10 in this 100 set");
