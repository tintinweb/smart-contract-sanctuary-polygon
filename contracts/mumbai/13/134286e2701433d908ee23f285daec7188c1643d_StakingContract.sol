...
contract StakingContract is Ownable {
    ...
    function getAccRewardPerTokenStaked(IERC20 _stakeToken, IERC20 _rewardToken, uint256 poolIndex) external view returns(uint256) {
        return allPoolsDetailedInfo[_stakeToken][_rewardToken][poolIndex].accRewardPerTokenStaked;
    }
