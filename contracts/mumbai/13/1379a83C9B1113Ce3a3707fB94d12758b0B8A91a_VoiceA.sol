    ...
    UUPSUpgradeable
{
    ...
    function setApprovalForAll(address operator, bool approved) public override(IVoiceA, ERC721AUpgradeable) onlyAllowedOperatorApproval(operator) {
        super.setApprovalForAll(operator, approved);
    }

    function approve(address operator, uint256 tokenId) public override(IVoiceA, ERC721AUpgradeable) onlyAllowedOperatorApproval(operator) {
    ...
    function safeTransferFrom(
        ...
        address to,
        uint256 tokenId
    ) public override(IVoiceA, ERC721AUpgradeable) onlyAllowedOperator(from) {
        require(
