...
// File: contracts/future-creation crypto-club.sol
...
contract futurecerationcryptoclub is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("future creation crypto club", "FCCC") {
    setHiddenMetadataUri("ipfs://QmVPXBQeJ93k495ft6qGW91qR8NN4fXkd1hDBov6yKZyHT/{id}.json");
  }
