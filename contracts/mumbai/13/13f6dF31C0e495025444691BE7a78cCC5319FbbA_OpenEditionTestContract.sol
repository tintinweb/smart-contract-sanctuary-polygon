...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x11B4E83BC3e9605F03E2A4C34BD09567be5aeBBE];
  address public erc20Payable = 0x11B4E83BC3e9605F03E2A4C34BD09567be5aeBBE;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://ipfs://QmesCqLsMWkkjxonXVYVz9CF8m6kkB6Yq2QRcc55ke9sFp//";
...
// File: contracts/OpenEditionTestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OpenEditionTestContract is RamppERC721A {
    constructor() RamppERC721A("Open Edition Test", "OPEN"){}
}