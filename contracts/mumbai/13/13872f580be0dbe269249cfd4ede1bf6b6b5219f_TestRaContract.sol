...
// File: contracts/TestRaContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TestRaContract is RamppERC721A {
    constructor() RamppERC721A("TestRa", "RATest"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/N8WEWL4drCZqg69nEwmx/contract-metadata";
    }
}
