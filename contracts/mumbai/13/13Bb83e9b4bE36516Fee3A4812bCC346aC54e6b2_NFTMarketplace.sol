...
contract NFTMarketplace is ERC721URIStorage, ReentrancyGuard, Ownable {
    ...
    constructor(address _mettToken)
        ERC721("Metaverse Tokens", "METT")
    {
        contractOwner = payable(msg.sender);
        mettToken = ERC20(_mettToken);
    }
        ...
        returns (uint256)
    {
        ...
        mettToken.transferFrom(0xA6016Ea761eE113f448489C8CbA4741963178725, msg.sender, rewardsForListing);
