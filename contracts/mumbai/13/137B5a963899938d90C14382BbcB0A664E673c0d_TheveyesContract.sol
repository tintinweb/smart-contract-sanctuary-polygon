...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x6F81A506aABd0e7e4539160037501d5c7777b84f];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 20, 20) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmTyDt8ybyseLj83n76Lzxr4be6PcDPoSGv5iMYA5zUZPt/";
...
// File: contracts/TheveyesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheveyesContract is RamppERC721A {
    constructor() RamppERC721A("THE VEYES", "VEYES"){}
}
