...
contract FuckingBirds is ERC721Enumerable, AccessControl {
    ...
    function mintBirds_payable(uint numberOfTokens) external payable {
        require(saleIsActive, "Sale must be active to mint");
        require(numberOfTokens <= maxToMint, "Invalid amount to mint");
        require(totalSupply() + numberOfTokens <= maxMintSupply, "Purchase exceeds max supply");
        require(msg.value > mintPrice * numberOfTokens, "need more matic");
