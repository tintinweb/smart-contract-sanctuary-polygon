...
contract ERC1155MockAssetManager is ERC1155, IAssetManager {
    ...
    function trustedMint(address _to, uint _tokenId, uint _amount) external override trustedOnly {
        _mint(_to, _tokenId, _amount, "");
    }

    function trustedBatchMint(address _to, uint[] calldata _tokenIds, uint[] calldata _amounts) external override trustedOnly {
        _mintBatch(_to, _tokenIds, _amounts, "");
    }

    function trustedBurn(address _from, uint _tokenId, uint _amount) external override trustedOnly {
        _burn(_from, _tokenId, _amount);

    }

    function trustedBatchBurn(address _from, uint[] calldata _tokenIds, uint[] calldata _amounts) external override trustedOnly {
