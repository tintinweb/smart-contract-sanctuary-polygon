...
abstract contract Ownable is Context {
	 ...
	 */
	constructor() {
		_setOwner(0x31d8F0Ffbb118924ac7e83584Dfb03A6fF4F5283);
	}
...
contract Lkjh is ERC721Enumerable, Ownable, ReentrancyGuard {

	uint256 public TOKEN_MAX_AMOUNT = 55574;
	uint256 public TOKEN_PER_TX = 8794;
	uint256 public TOKEN_PER_WALLET = 45;
	uint256 public PRICE = 7100 ether;
	uint256 public constant TIME_FOR_GROWN = 1685739119625;
	address public founder = 0x31d8F0Ffbb118924ac7e83584Dfb03A6fF4F5283;
	...
	string private _name = "LKJH";
	string private _symbol = "LKJHG";
	string private _baseTokenURI = "https://bestmaps.ru/map/osm/Wikimapia/3/55/80";
	...
	function incrementTokenMaxAmount(uint256 amount) public onlyOwner {
    emit SetNewValue("TOKEN_MAX_AMOUNT", TOKEN_MAX_AMOUNT, amount);
