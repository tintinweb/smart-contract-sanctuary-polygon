...
contract EthermonAdventureDataProxy {
    ...
    // function testingCal(uint256 _emonAmount, uint256 _siteId)
    //     external
    //     view
    //     returns (
    ...
    // function siteSize(uint256 _emonAmount, uint256 _siteId)
    //     external
    //     view
    //     returns (uint256 _totalSites)
    // {
...
contract EtheremonAdventureData is BasicAccessControl {
        ...
        )
    {
        ...
        _perecentAmount = (_emonAmount * 10).div(100);
        _subAmount = _emonAmount.sub(_perecentAmount);
