    ...
    IERC1155ReceiverUpgradeable
{
    ...
    /// @dev Only assets from NFT contracts with asset role can be listed, when listings are restricted by asset address.
    bytes32 private constant CURRENCY_ROLE = keccak256("CURRENCY_ROLE");
    ...
    constructor(
        address _nativeTokenWrapper, // initializer
        ...
        address[] memory _trustedForwarders = new address[](1);

        _trustedForwarders[0] = address(0);
        ...
        // Carbify Token polygon Mainet
        _setupRole(CURRENCY_ROLE, 0xeB551DA01212fCEce48009965BbB7D44665B2861);
        // USDC Token polygon Mainet
        _setupRole(CURRENCY_ROLE, 0xeB551DA01212fCEce48009965BbB7D44665B2861);
        // Setup Wrapped Matic polygon Mainet
        _setupRole(CURRENCY_ROLE, _nativeTokenWrapper);
    ...
    //     _setupRole(LISTER_ROLE, address(0));
    //     // Carbify Token polygon Mainet
    //     _setupRole(CURRENCY_ROLE, 0xB6a5ae40e79891E4DeAdAd06C8A7cA47396Df21C);
    //     // USDC Token polygon Mainet
    //     _setupRole(CURRENCY_ROLE, 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174);
    //     // Setup Wrapped Matic polygon Mainet
    //     _setupRole(CURRENCY_ROLE, _nativeTokenWrapper);
    ...
    function createListing(ListingParameters memory _params) external override {
        ...
        require(
            hasRole(CURRENCY_ROLE, address(0)) ||
                hasRole(CURRENCY_ROLE, _params.currencyToAccept),
            "!CURRENCY"
        );
    ...
    function updateListing(
        ...
        require(
            hasRole(CURRENCY_ROLE, address(0)) ||
                hasRole(CURRENCY_ROLE, _currencyToAccept),
            "!CURRENCY"
        );
