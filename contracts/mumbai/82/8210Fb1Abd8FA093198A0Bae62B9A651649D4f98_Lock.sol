...
contract OnChainMusicMetadata is MusicStructs {
        ...
        returns (string[47] memory)
    {
        ...
        values[10] = string(
            abi.encode("'", _tokenMetadata[_tokenId].tags, "'")
        );
        values[11] = Strings.toString(
            _tokenMetadata[_tokenId]
                .song
                .audio
                .songDetails
        ...
        values[17] = title;
        values[18] = artworkUri;
        values[19] = artworkMimeType;
        values[20] = "null";
        ...
        values[37] = "null";
        values[38] = "null";
        values[39] = '[{"name":"sweetman eth","collaboratorType":"creator"}]';
...
contract MusicStructs {
    ...
    struct ProjectMetadata {
        PublishingData projectPublishingData;
