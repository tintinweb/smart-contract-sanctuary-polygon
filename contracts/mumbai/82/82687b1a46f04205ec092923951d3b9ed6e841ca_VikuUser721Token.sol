...
// File: contracts/VikuUser721Token.sol
...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new VikuUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        VikuUser721Token token = VikuUser721Token(address(addr));
