  ...
  ReentrancyGuard
{
  ...
  /**
    ...
    *
    * @param _royaltyReceiver creator of card
  ...
  ) public isActive onlyDbilia returns (uint256) {
  ...
  function batchMintWithFiatw2user(
    ...
    require(
      _editionIdStart <= _editionIdEnd,
      "invalid editionIdStart or editionIdEnd"
    );
