...
contract SafeOperationsFacet is ReentrancyGuard, Initializable {
    ...
    //             msg.sender
    //         );
    //         console.log("Safe opened with %s apTokens", apTokens);
    ...
    //             msg.sender
    //         );
    //         console.log("Deposited %s apTokens to Safe", apTokens);
    ...
    //     require(
    //         apTokenMax >= _amount,
    //         "SafeOps: Insufficient withdrawal allowance"
    //     );
    ...
    //         safeManagerContract.setSafeStatus(
    //             msg.sender,
    //             _index,
    //             cacheInit.activeToken,
    //             2
    ...
    //     require(
    //         _amount <= maxBorrow,
    //         "SafeOps: Insufficient funds for borrow amount"
    //     );
    ...
    //  */
    // function repay(uint _index, uint _amount) external nonReentrant {
    //     // First, get the Safe params.
    //     CacheInit memory cacheInit;
    ...
    //  */
    // function computeBorrowAllowance(
    ...
    //     // E.g., 20,000bp.
    //     MCR = safeManagerContract.getActiveToDebtTokenMCR(
    //         _activeToken,
    //         _debtToken
    //     );
    ...
    //     maxBorrow =
    //         ((((assets - oFeeTokens) * 10_000) / MCR) * activeTokenPrice) /
    //         10**18;
    // }
    ...
    // {
    //     if (safeManagerContract.getSafeStatus(_owner, _index) != 1)
    //         return (0, 0);
    ...
    //     // First, find the ActivePool contract of the activeToken.
    //     address _activePool = safeManagerContract.getActivePool(
    //         cacheInit.activeToken
    //     );
    ...
    //     if (cacheInit.debtToken == address(0))
    //         return (cacheVal.bal, activeTokenBal);

    //     uint activeTokenPrice = priceFeedContract.getPrice(
    //         cacheInit.activeToken
    //     );
    //     console.log("activeToken price: %s", activeTokenPrice);
    ...
    //     uint locked = (cacheVal.debt * debtTokenPrice * MCR) /
    //         (10**18 * 10_000);
    ...
    //         return (0, 0);
    //     } else {
    //         activeTokenMax = (collateral - locked).divPrecisely(
    //             activeTokenPrice
    //         );
    ...
    //         .divPrecisely(_debtAmount * debtTokenPrice)
    //         .mulTruncate(10_000);
    // }
