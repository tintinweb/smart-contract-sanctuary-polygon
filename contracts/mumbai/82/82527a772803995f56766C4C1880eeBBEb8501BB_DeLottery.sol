...
contract DeLottery
{
    ...
    function winner () public
    {
        ...
        emit WINNER (players[index],(address(this).balance - (counter*0.01 ether)));
        players[index].transfer((address(this).balance - (counter * 0.01 ether))); // The owner get counter*0.01 ether as gas 
