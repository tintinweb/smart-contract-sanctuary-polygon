...
contract ERC721Factory is ReentrancyGuard, Context {
    ...
    event ERC721Deployed(address indexed from, address indexed contractAddr, string name, string symbol);

    function totalOf() public view returns (uint256) {
        return _contracts.length;
    }

    function addressOf(uint256 index) public view returns (address contractAddr) {
