...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
  ...
  // mapping for token creator
    ...
    uint256 private _totalSupply = 5987;
    ...
    function contractCreator() external view returns(address) {
        return _owner;
    }
    ...
    */
    ...
    function createCollectible( address from, string memory tokenURIs) external virtual override returns (uint256) {
        require(msg.sender == operator,"Mint: caller doesn't have role to Mint");
        _operatorApprovals[from][operator] = true;
