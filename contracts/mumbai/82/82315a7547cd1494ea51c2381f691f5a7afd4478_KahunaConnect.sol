...
// File: contracts/KahunaConnect.sol

pragma solidity ^0.8.4;

contract KahunaConnect is ERC721, Ownable, ReentrancyGuard {
    ...
    uint256 public freePass = 1;
    string private _baseTokenURI = "";

    mapping(address => uint256) public addressMintedBalance;

    constructor() ERC721("KahunaConnect", "KahunaConnect") {}
        ...
        returns (string memory)
    {
        ...
        return bytes(_baseTokenURI).length > 0 ? _baseTokenURI : "";
    }
    ...
    function presaleMint(uint8 _amount, bytes32[] memory proof)
        external
        payable
        callerIsUser
    {
        ...
        uint256 count = _amount * freePass + _amount;
    ...
    function setFreePass(uint256 _newFreePass) external onlyOwner {
        freePass = _newFreePass;
    }
