...
contract Domains is ERC721URIStorage {
  ...
  function register(string calldata name) public payable {
    ...
    string(
      abi.encodePacked(
        '{"name": "',
        _name,
        '", "description": "A domain on the WTF name service", "image": "data:image/svg+xml;base64,',
    ...
    //calculate the price of the domain
  ...
  //Function for the contract owner to withdraw collected amount
