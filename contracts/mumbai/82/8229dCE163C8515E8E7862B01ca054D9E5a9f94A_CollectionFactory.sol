...
contract CollectionFactory {
    ...
    function createCollection(
        ...
        ERC1155Y collection = new ERC1155Y(
            _name, _symbol, _maxSupplyPerToken, _maxMintPerWallet, _tokenPrice, _platformAddress, _platformRoyalty, _creatorAddress, _creatorRoyalty
        );
...
contract Platform {
    ...
    uint256 internal minPlatformRoyalty = 5000;
    uint256 internal minTokenPrice = 30000000000000000000; // In Wei (MATIC)
    uint256 internal mintCallPrice = 3000000000000000; // In Wei (MATIC)
