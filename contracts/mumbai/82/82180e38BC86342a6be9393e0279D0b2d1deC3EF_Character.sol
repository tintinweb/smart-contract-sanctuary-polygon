...
// File: docs.chain.link/samples/VRF/nft1.sol
...
contract Character is ERC721URIStorage, Ownable {
	...
	uint256 public maxMintAmountPerTx = 5; // <-- max mints per tx
	uint256 public perAddressLimit = 5; // <-- max
	...
	string baseUrl = "ipfs://QmQCShTta8hyotL3fcjN22rBE8by81zXigXi9B6asrBkXK/";
	...
	// Char2[maxSupply] public _tokenDetails;
	...
	constructor() ERC721("TestRandom", "RAND") {
  ...
  //   return string(abi.encodePacked(a, b, c, d, e));
	...
	// function originUrl(uint256 id) returns (string){
	// 	return "ipfs://QmQCShTta8hyotL3fcjN22rBE8by81zXigXi9B6asrBkXK/{id}.json"; 
	// }
		...
		mintCompliance(_mintAmount)
	{
		...
		for (uint256 i = 1; i <= _mintAmount; i++) {
			...
			//  append(baseUrl,newCharID,_json);

			_safeMint(msg.sender, newCharID);
			_setTokenURI(newCharID,_url);
