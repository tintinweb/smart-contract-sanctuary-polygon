...
contract TeamsStakingDeadlines is OwnableUpgradeable {
     ...
     * @notice Set array of cardImages to team id. Only owner (back-end) can call this function. Team id can't be 0.
        ...
        * @param _teamId team id
        */
    function setCardImagesToTeam(uint256[] calldata _cardImageIds, uint256 _teamId) external onlyOwner nonZeroTeamId(_teamId) {
    ...
    /**
     * @notice Set staking deadline for a team. Only owner (back-end) can call this function. Team id can't be 0.
     * @param _teamId Team id.
     ...
     */
    function getCardImageTeamDeadline(uint256 _cardImageId) public view returns (uint256) {
     ...
     * @return Team name.
     */
    function getCardImageTeamName(uint256 _cardImageId) public view returns (string memory) {
