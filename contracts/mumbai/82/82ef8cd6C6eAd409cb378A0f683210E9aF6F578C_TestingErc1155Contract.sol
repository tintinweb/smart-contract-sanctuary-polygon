...
abstract contract hasWalletCap is Ownable {
    using SafeMath for uint256;
    mapping (uint256 => bool) public walletCapEnabled;
    ...
    */
    ...
    /**
    * @dev Get curernt wallet cap for token
    * @param _id token id to query against
    */
...
// File: contracts/TestingErc1155Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract TestingErc1155Contract is 
    ERC1155,
    Ownable, 
    Pausable, 
    ERC1155Supply, 
    ...
    Allowlist
{
    ...
    string public name = "TestingERC1155";
    ...
    */
    ...
    function contractURI() public pure returns (string memory) {
      return "http://localhost:5001/nft-rampp/us-central1/app/ylJqGHFS07lNRuHnEFEH/contract-metadata";
    }
