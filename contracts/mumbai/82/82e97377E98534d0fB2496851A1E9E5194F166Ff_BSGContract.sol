...
contract BSGContract is Ownable{
    ...
    function checkLevel2(address _address) public view returns(bool,uint256)
    {
    ...
    function checkLevel3(address _address) public view returns(bool,uint256)
    {
    ...
    function checkLevel4(address _address) public view returns(bool,uint256)
    {
    ...
    function checkLevel5(address _address) public view returns(bool,uint256)
    {
    ...
    function _distributeCTO() public{
        if(block.timestamp > lastDistribute.add(timeStep))
        {
            ...
            lastDistribute = block.timestamp;
            dailyDistributedTime[countDay] = DailyPool ;
            DailyPool = 0;
            countDay = countDay.add(1);
        }
    }
