...
mapping ( uint256 => Drawcheck) public DrawBase;
    ...
    uint256[10] public ProcentChest = [17,16,14,12,11,9,8,6,4,3];
    uint256[10] public number_of_chests_=[100,90,80,60,50,40,20,15,10,5];
   ...
   function Get_Track_1_2_3_4_5 (uint256 num_Track) public virtual override view returns( uint256 One_chests_MITI_1, uint256 One_chests_USDT_1,
