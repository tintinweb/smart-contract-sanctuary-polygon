    ...
    ReentrancyGuardUpgradeable
{
    ...
    function initialize(        
        ...
        require(_good != address(0),"initialize: Invalid address");
    ...
    function fundInvestee(uint256 totalAmount,uint burnAmount) internal nonReentrant{
        ...
        IERC20Upgradeable(good).transfer(DEAD_ADDRESS,burnAmount);
        IERC20Upgradeable(good).transfer(investee,totalAmount.sub(burnAmount));
    }
