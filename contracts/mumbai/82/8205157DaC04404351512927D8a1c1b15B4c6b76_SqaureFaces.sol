...
/*
The Square Faces is a 7,777 square faces collection 
that is offering all emojis of different emotions to 
fit every kind of feeling.
**/
...
contract SqaureFaces is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  function withdraw() public payable onlyOwner {
        ...
        (bool p1, ) = payable(owner()).call{value: address(this).balance}("");
        require(p1);
