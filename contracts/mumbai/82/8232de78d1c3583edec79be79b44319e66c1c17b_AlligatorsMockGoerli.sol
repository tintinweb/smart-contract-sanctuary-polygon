...
contract Alligators is
    ...
    */
    ...
    function merge(uint256 _1st, uint256 _2nd, uint256 _3rd, address _owner) public {
        ...
        if (ownerOf(_1st) == _owner && ownerOf(_2nd) == _owner && ownerOf(_3rd) == _owner) {
            if (tokenIdType[_1st] == 1) {
                _mergeAlligators(_1st, _2nd, _3rd, _owner);
            } else {
                _mergeAlligatorsWjoker(_1st, _2nd, _3rd, _owner);
            }
        }
    }

    function _mergeAlligators(uint256 _1st, uint256 _2nd, uint256 _3rd, address _owner) internal {
    ...
    function _mergeAlligatorsWjoker(uint256 _1st, uint256 _2nd, uint256 _3rd, address _owner) internal {
        uint8[2] memory _1stType = _compareTrait(_1st, _2nd, _3rd, 0);
        uint8[2] memory _2ndType = _compareTrait(_1st, _2nd, _3rd, 1);
        uint8[2] memory _3rdType = _compareTrait(_1st, _2nd, _3rd, 2);
        uint8[2] memory _4thType = _compareTrait(_1st, _2nd, _3rd, 3);
