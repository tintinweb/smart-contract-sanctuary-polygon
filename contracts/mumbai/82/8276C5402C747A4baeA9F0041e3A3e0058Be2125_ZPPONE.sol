...
contract ZPPONE is ERC721, Ownable {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return
            "https://gateway.pinata.cloud/ipfs/QmTshumWBt6ULnkBd4HYxgC4cy3S3qWEM6PTZuv1WrEkFw/";
    }
        ...
        returns (string memory)
    {
        require(
            _exists(tokenId),
            "ERC721 Metadata: URI query for nonexistence token!"
        );
    ...
    function mint(
        ...
        require(
            walletMintCount[msg.sender] + 1 <= maxMintPerAddress,
            "Exceeded Mint Amount"
        );
        require(
            verifyMessage(_hashMessage, _v, _r, _s, recipient),
            "You need to Sign Before Minting"
        );
    ...
    function mintMobile(address recipient, uint256 quantity)
        public
        payable
        virtual
        returns (uint256)
