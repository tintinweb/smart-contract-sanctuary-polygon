...
contract DigitalAssetsUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
...
import "./DigitalAssetsUser1155Token.sol";
...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new DigitalAssetsUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        DigitalAssetsUser1155Token token = DigitalAssetsUser1155Token(address(addr));
