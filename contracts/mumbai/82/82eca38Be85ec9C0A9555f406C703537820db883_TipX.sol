...
//const x = await TipX.deployed()
//await x.createNewTip("title","description","3000000000000000000")
//await x.giveTip(1, {from: '0x5fC5b5Ee8E1379705e1Ee49eFec41A1250C0069f', value: '1000000000000000000'})
//await x.giveTip(1, {from: '0xFB6A014460d2e78c3CE159565497f3620e15B955', value: '2000000000000000000'})
//await x.withdrawMoney(1)
//await x.allUserTips('0x26F4492e36DC9CA434232E411818541005dcC2B9',0)