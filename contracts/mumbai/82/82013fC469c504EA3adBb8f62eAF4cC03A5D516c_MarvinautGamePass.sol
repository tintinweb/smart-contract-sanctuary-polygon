...
contract MarvinautGamePass is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, Pausable {
  ...
  constructor() ERC721('MarvinautGamepass', 'MVG') {}
  ...
  function _mintGamePass(address _to, uint256 _mintAmount) internal {
    ...
    require(_tokenSupply + _mintAmount < maxSupply + 1, 'NotEnoughTokenLeft');
  ...
  function upgradeGamePass(
    ...
    require(_hashedMessage.toEthSignedMessageHash().recover(signature) == signer, 'InvalidSigner');
