...
contract MetaMaster {
    ...
    address constant public USDTAddress = 0xd9145CCE52D386f254917e481eB44e9943F39138;
    ...
    function deposit(uint256 _USDTAmount, address _referrer) public {
        require(_USDTAmount % 50 == 0 && _USDTAmount > 0 && _USDTAmount <= 5000 , "Invalid USDT Amount");
