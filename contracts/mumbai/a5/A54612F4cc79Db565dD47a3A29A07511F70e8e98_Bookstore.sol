...
contract Bookstore is ERC1155URIStorage{
	...
	string public baseUri = "https://ipfs.io/ipfs/bafybeiaovxrwhbliwzwrcxgakzxrs55me6ulryfk7iwkqajipt2g5le5tq/book.json";
	...
	tokenCounter+=1;
	if(compareStrings(_myUri,"")){
	_setURI(newTokenId, baseUri);
	} else { 
