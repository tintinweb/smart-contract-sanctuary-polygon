...
contract AdminControl is Initializable, OwnableUpgradeable {
    ...
    //INVESTOR MANAGEMENT
    function hasInvestorManagement(address _address) public view returns (bool) {
        return adminPermissions[_address].role == Role.SUPER_ADMIN ? true : adminPermissions[msg.sender].investorManagement;
    }
    ...
    //CHAIN MANAGEMENT
    function hasChainManagement(address _address) public view returns (bool) {
        return adminPermissions[_address].role == Role.SUPER_ADMIN ? true : adminPermissions[msg.sender].chainManagement;
    }
...
contract ChainManagement is Initializable {
    ...
    function initialize(address adminControlAddress) public initializer {
        adminControl = AdminControl(adminControlAddress);
    }
