...
contract NFTFShips is Ownable,ERC721,ERC721Enumerable {
    ...
    function contractURI() public view returns (string memory) {
        ...
        Base64.encode(
            ...
            abi.encodePacked(
                '{"name":"',
                "NFTFShips",
                '", "description":"Amazing spaceships for beautiful games. An educational project by NFT Factory", "external_link": "http://nft-factory.club", "image":"ipfs://QmUgC7uMEYFLMqRTARrixwrE9mrgjgHz3gmGJb8xb43WqT/196.png"}'
            )
            )
        )
        )
