...
contract ERC20FixedPriceAllocator is Ownable, Initializable, ReentrancyGuard {
    ...
    function initialize(
        ...
        name = _config.name;
        //TODO check if allocationToken = ventureToken, and not address0 then check supply. else check balance and transfer
        // Venture newVenture = Venture(_config.venture);
        // require(newVenture.tokenSupply() > totalTokensForAllocation, "FixedPriceAllocator: Venture has insufficient token supply");
    ...
    function setAllocationToken(
        ...
        // TODO Jubi fee...
        uint256 jubiAllocationFee = ((totalAllocationTokenAllocated * jubiFee) /
            1e18);
        SafeERC20.safeTransferFrom(
            _allocationToken,
            msg.sender,
            address(this),
            (totalAllocationTokenAllocated + jubiAllocationFee)
        );
        allocation[jubiFundsAddress] = jubiAllocationFee;
