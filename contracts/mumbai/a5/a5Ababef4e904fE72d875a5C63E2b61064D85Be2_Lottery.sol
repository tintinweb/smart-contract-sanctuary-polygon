...
contract Lottery is Ownable, VRFConsumerBase, KeeperCompatible {
    ...
    address public DAO = 0xd9145CCE52D386f254917e481eB44e9943F39138;
    uint256 public winnerNFT;
    address payable public lotteryWinner;
    uint256[] public registered;
    uint256[] public tokenIds = IEGVC(0xF8A236c5247dc27A5218B96140f9D03CACD291f1).walletOfOwner(msg.sender);
