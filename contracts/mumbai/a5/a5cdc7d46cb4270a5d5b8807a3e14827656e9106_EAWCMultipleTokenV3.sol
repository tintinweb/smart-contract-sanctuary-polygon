...
contract EAWCMultipleTokenV3 is  Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, PausableUpgradeable, AccessControlUpgradeable, ERC721BurnableUpgradeable {
    ...
    function bulkMint(address to, string memory baseUri, uint256 amount) public onlyRole(MINTER_ROLE) {
