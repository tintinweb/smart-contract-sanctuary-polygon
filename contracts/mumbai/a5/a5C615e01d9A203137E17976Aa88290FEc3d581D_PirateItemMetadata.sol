    ...
    is IPirateItemMetadata 
{
    ...
    function getPirateItemSymbol(uint256 tokenId) override public view returns (bytes32) {
        return tokenIdToPirateItem[tokenId].symbol;
    }
