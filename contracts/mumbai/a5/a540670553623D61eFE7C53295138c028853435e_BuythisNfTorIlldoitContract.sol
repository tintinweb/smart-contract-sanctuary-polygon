...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x02dC871d0C9421A8CB0704A514aC1106B88A05B0];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://Qma6TLRg7ZP6krWZAApXJt8wdTvNvNpujQpXVP79LPZkv6/";
...
// File: contracts/BuythisNfTorIlldoitContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BuythisNfTorIlldoitContract is RamppERC721A {
    constructor() RamppERC721A("Buy this 0xNFT or I ll do it", "0xdoit"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/wCx2M6kZQ0Wyl4o5ZqbZ/contract-metadata";
    }
}
