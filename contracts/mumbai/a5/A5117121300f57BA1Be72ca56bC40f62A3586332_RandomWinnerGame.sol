...
contract RandomWinnerGame is VRFConsumerBase, Ownable {
    ...
    uint256 public fee;
    //ID of public key against which randomeness is generated
   ...
   */
    ...
    function startGame (uint8 _maxPlayers, uint256 _entryFee) public onlyOwner {
        ...
        gameStarted  = true;
        //setup the entry fee or the game
        entryFee = _entryFee;
        gameId += 1;
    ...
    function joinGame() public payable {
        ...
        require(msg.value ==entryFee, "value not equal to the entry fee");
        //check if there is still some space left in the game to add another player
        require(players.length < maxPlayers, "Game i full");
        // add the sender to the players list
        players.push(msg.sender);
        emit PlayerJoined(gameId, msg.sender);
        //If the list is full, start the selection process
    ...
    */ 
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal virtual override {
        ...
        // For this, we mod it with the players.length value
    ...
    /**
     * getRandomwinner is called to start the process of selecting a random number
     */

    function getRandomWinner() private returns (bytes32 requestId) {
        // lINK is an inernal interface for Link token found within the VRFConsumerBase 
        ...
        // requestRandomeness is a function within the VRFConsumerBase
        // it starts with the process of rndomness generation
