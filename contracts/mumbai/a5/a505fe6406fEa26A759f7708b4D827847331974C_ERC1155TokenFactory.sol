...
contract ERC1155Token is ERC1155Supply, ERC1155Burnable, Ownable {
    ...
    modifier onlyMintersAndOwner() {
        require(minters[msg.sender] || isOwner(), "Only the minters addresses or the owner can call this function");
    ...
    function mint(address to, uint256  id,  uint256 amount, bytes memory data) public onlyMintersAndOwner {  
        _validateMint(id,amount);
        _mint(to,id,amount,data);
    }

    function batchMint(address to, uint256[] memory  ids,  uint256[] memory amounts, bytes memory data) public onlyMintersAndOwner {  
