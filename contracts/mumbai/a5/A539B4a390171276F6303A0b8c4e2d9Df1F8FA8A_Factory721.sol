...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new NebulaUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        NebulaUser721Token token = NebulaUser721Token(address(addr));
...
contract NebulaUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
