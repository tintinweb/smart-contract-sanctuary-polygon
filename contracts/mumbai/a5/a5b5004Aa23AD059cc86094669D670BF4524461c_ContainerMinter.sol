...
contract ContainerMinter is AccessControl, Withdrawable {
    ...
    Container private immutable _container = Container(address(0x217516A77990747cDDAF8C1507E060DB3862d09C)); // Mumbai
    IERC20 private immutable _usdc = IERC20(address(0x025208D62e86A443AE9e17B0922607Fe2A0cDF93)); // Mumbai Mock

    bool public mintActive = true; // TODO: Put back to false when deploying to mainnet

    uint256 public mintingFee = 200 * 10**6; // 200 USDC (with 6 decimals)

    bytes32 public merkleRoot = 0x7a572680fcbc02c44e058c0796ab94bdf452d9a5b963ded7eeb56824acd62c33;
