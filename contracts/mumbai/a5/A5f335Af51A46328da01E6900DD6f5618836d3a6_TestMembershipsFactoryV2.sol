...
import { MembershipsFactory } from "../memberships/MembershipsFactory.sol";

contract TestMembershipsFactoryV2 is MembershipsFactory {
    address public v2InitializerVar;
    ...
    function initializeV2(address _v2InitializerVar) external reinitializer(2) {
        v2InitializerVar = _v2InitializerVar;
    }
...
contract MembershipsFactory is Initializable, OwnableUpgradeable, IMembershipsFactory {
    ...
    function deployMembershipsAtVersion(
        ...
        if (_membership.airdropToken != address(0) && _membership.airdropAmount != 0) {
            IERC20Upgradeable(_membership.airdropToken).safeTransferFrom(
                msg.sender,
                membershipsProxy,
