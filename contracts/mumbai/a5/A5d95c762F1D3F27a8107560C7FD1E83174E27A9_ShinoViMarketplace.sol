...
interface IShinoViPlatform {
    ...
    function ERC20TransferFrom(address _token, address _from, address _to, uint256 _amount) external;
...
contract ShinoViMarketplace is Initializable, ReentrancyGuardUpgradeable  {
   ...
   */
        ...
        nonReentrant
    {
        ...
        shinoViPlatform.safeTransferFrom(_nft, msg.sender, address(shinoViPlatform), _tokenId, _amount);
        ...
        nonReentrant
    {
        ...
        shinoViPlatform.safeTransferFrom(_nft, address(shinoViPlatform), msg.sender, _tokenId, thisNFT.amount);
        ...
        nonReentrant
    {
        ...
        shinoViPlatform.ERC20TransferFrom(nft.payableToken, msg.sender, address(shinoViPlatform), _offerPrice);
        ...
        nonReentrant
    {
        ...
        shinoViPlatform.ERC20TransferFrom(offer.payableToken, address(shinoViPlatform), offer.offerer, offer.offerPrice);
        ...
        nonReentrant
    {
        ...
        shinoViPlatform.safeTransferFrom(_nft, address(shinoViPlatform), msg.sender, _tokenId, auction.amount);
    }
        ...
        nonReentrant
    {
        ...
        shinoViPlatform.ERC20TransferFrom(auction.payableToken, msg.sender, address(shinoViPlatform), _bidPrice);
        ...
        if (auction.winningBidder != address(0)) {
            ...
            shinoViPlatform.ERC20TransferFrom(auction.payableToken, address(shinoViPlatform), previousBidder, previousBidPrice);
        }
    ...
    function processTransaction(Transaction memory t) private {
        ...
        if (t.transferFrom == true) {
            ...
            // finally transfer NFT
            safeTransferFrom(t.nft, address(shinoViPlatform), t.buyer, t.tokenId, t.amount);
