...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x6741e75816e8C0B6F40a99598747CA26cb7dD687];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://Qmdq8GoeK8DhqLjJcKx4j8eACdjb9mPqA3ck4BbSn37RBB/";
...
contract MyNftRamppProjectContract is RamppERC721A {
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/t4s0dBTDS6xMht80TT8c/contract-metadata";
    }
}
