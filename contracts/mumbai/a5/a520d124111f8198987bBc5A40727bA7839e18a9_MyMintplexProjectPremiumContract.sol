...
// File: contracts/MyMintplexProjectPremiumContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract MyMintplexProjectPremiumContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "My Mintplex Project Premium";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/5NgfPnXHjaLWg2e63I3F/contract-metadata";
  }
