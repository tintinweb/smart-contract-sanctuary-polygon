...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [0x0F6064557564836C26eEDAb6d7903bB45682F597];
...
// File: contracts/CesarDonePhotographyContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract CesarDonePhotographyContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Cesar Done Photography";
    string public symbol = "CDPhotos";
