 ...
 * {ERC721Enumerable}.
 */
contract ERC721Upgradeable is Initializable, ContextUpgradeable, IERC2981Upgradeable,ERC165Upgradeable, IERC721Upgradeable, IERC721MetadataUpgradeable {
...
contract Collections is Initializable, ERC721Upgradeable, ERC721BurnableUpgradeable, OwnableUpgradeable {
      ...
      event minted(address userAddress , uint256 tokenId);


    function initialize() initializer public {
        tokenID=1;
        __ERC721_init("Collections", "NFTs");
