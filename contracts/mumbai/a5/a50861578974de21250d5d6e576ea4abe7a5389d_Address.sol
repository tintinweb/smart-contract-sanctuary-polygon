...
//*********************************************************************//
//
//  _____                _ _      ______          _          ______       _   _   _     ______             
// |_   _|              (_) |     | ___ \        | |         | ___ \     | | | | | |    | ___ \            
//   | | ___  __ _ _   _ _| | __ _| |_/ /_ _ _ __| |_ _   _  | |_/ / ___ | |_| |_| | ___| |_/ /_ _ ___ ___ 
//   | |/ _ \/ _` | | | | | |/ _` |  __/ _` | '__| __| | | | | ___ \/ _ \| __| __| |/ _ \  __/ _` / __/ __|
//   | |  __/ (_| | |_| | | | (_| | | | (_| | |  | |_| |_| | | |_/ / (_) | |_| |_| |  __/ | | (_| \__ \__ \
//   \_/\___|\__, |\__,_|_|_|\__,_\_|  \__,_|_|   \__|\__, | \____/ \___/ \__|\__|_|\___\_|  \__,_|___/___/
//              | |                                    __/ |                                               
//              |_|                                   |___/                                          
//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable {
  address[] public payableAddresses = [0x60bC9dC186e1F054D062c8646669664499E30135];
...
abstract contract TPERC721A is 
    Ownable,
    ERC721A,
    Withdrawable,
    ...
    ) ERC721A(tokenName, tokenSymbol, 100, 3000 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmVRXF239SB6C1eQLW7igMcxVbowA266gF7U1qMriJ3n8v/";
    ...
    */
    function mintToAL(address _to, bytes32[] calldata _merkleProof) public payable {
        require(onlyAllowlistMode == true && mintingOpen == true, "Whitelist minting is closed");
        require(isAllowlisted(_to, _merkleProof), "Address is not in Whitelist!");
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 3000");
      
        require(msg.value == PRICE, "Value to send needs to be exactly the mint fee!");
        _safeMint(_to, 1);
    ...
    */
     ...
     * This is a convenience function for the contract user
     */
...
// File: contracts/TequilaPartyBottlePassContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TequilaPartyBottlePassContract is TPERC721A {
    constructor() TPERC721A("TequilaParty BottlePass", "TPBP"){}

    function contractURI() public pure returns (string memory) {
      return "https://gateway.pinata.cloud/ipfs/Qmeia42MCrUam3HTAZHBDWJJjGyMpUEJLrcrd79MSD7trB";
    }
}