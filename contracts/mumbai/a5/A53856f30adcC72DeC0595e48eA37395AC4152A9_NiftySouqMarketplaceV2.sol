...
contract NiftySouqMarketplaceV2 is Initializable{
    ...
    modifier isNiftyPauser() {
        if (
            (_pauser != msg.sender) &&
            (!_niftySouqMarketplaceManager.isPauser(msg.sender))
        ) revert GeneralError("NS:102");
        _;
    }
    ...
    //  */
    // function pause() public isNiftyPauser {
    //     _pause();
    // }
    ...
    //  * @dev Only by pauser role
    //  */
    // function unpause() public isNiftyPauser {
    //     _unpause();
    // }
     ...
     */
    function blockListUpdate(address _address, bool _value)
        public
        isNiftyPauser
    {
