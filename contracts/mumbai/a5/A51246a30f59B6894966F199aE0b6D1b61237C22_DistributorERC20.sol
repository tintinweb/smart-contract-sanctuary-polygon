...
contract DistributorERC20 is AccessControl {
     ...
     */
    constructor(address _token, address _distributionCreator, address _validator) {
    ...
    function createDistribution(
        ...
        require(
            hasRole(DISTRIBUTION_CREATOR_ROLE, msg.sender), 
            "Caller is not a distribution creator."
        );
    ...
    function claim(
        ...
        bytes32 message = keccak256(
            abi.encodePacked(msg.sender, _amount, block.chainid, _salt)
        ); 
