...
contract NotAuthGreeter is IXReceiver {
  ...
  event callData(address msgSender, address originSender, uint32 origin);
  ...
  function xReceive(
    ...
    emit callData(msg.sender, _originSender, _origin);
