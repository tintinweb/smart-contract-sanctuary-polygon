...
import "fx_portal/contracts/fx_portal/FxRoot.sol";
import "fx_portal/contracts/FxERC721ChildTunnel.sol";

import "../TheSquidsChild.sol";

contract TestTheSquidsChild is TheSquidsChild {
  // solhint-disable-next-line
  constructor(address childTunnel_) TheSquidsChild(childTunnel_) {}

  function mintOwner(address to_, uint256 amount_) external {
...
contract TheSquidsChild is TheSquidsBase, FxERC721 {
  ...
  function _mint(address to_, uint256 tokenId_) internal virtual override(FxERC721, ERC721) {
