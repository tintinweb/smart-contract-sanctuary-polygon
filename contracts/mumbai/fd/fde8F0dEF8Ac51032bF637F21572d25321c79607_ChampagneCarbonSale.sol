...
contract ChampagneCarbonSale is Ownable {
    ...
    CalvadosCoquerel public immutable calvadosCoquerel;

    Phase public currentPhase;

    constructor(
        address _calvadosCoquerelAddress,
        address _collection,
        address[] memory _team,
        uint256[] memory _teamShares
    ) {
        calvadosCoquerel = CalvadosCoquerel(_calvadosCoquerelAddress);
    ...
    function preMint(
        ...
        if (token == address(0)) {
            ...
            calvadosCoquerel.batchMint(to, amount);
        } else {
