...
contract WowTCommunityReview is OwnableUpgradeable, AccessControlUpgradeable {
  //Movie
  struct Movie {
    uint256 id;
    string movieName;
  ...
  mapping(uint256 => mapping(address => UserInput)) userReview;
  ...
  //   uint256 allAvgRating = movie.rating / movie.totalReviewed;
  //   // if (movieDetails[_movieId].totalReviewed > 0)
  //   //   allAvgRating =
  //   //     movieDetails[_movieId].avgRating /
  //   //     movieDetails[_movieId].totalReviewed;

  //   return (movie.movieName, allAvgRating);
  // }
  ...
  //     return userReview[_movieId][_msgSender()].comments;
  //   }

  //   function getCurrentUserRating(uint256 _movieId) public view returns (uint256) {
  //     require(_movieId >= 0, 'movieId should be greater than zero');

  //     return userReview[_movieId][_msgSender()].rating;
  //   }
