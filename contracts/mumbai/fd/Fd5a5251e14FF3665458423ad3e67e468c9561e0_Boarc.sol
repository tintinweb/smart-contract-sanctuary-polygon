...
contract Boarc is ERC721Enumerable, Ownable {
    ...
    event NewBaseURI(string _baseTokenURI);
    ...
    function setBaseURI(string memory _baseTokenURI) public onlyOwner {
        ...
        emit NewBaseURI(_baseTokenURI);
    }

    function mintNFTs(uint256 _count) public onlyOwner {
        require(_count > 0, "Amount of minting NFT need to be greater than zero");
