...
// File: openzeppelin-solidity/contracts/access/IAccessControl.sol
...
// File: contracts/LOCAccess.sol


pragma solidity 0.8.9;


abstract contract LOCAccess is AccessControl {
...
// File: contracts/LOCOZExtension.sol
...
abstract contract LOCOZExtension is LOCAccess, ERC721Enumerable {
    string private _uri =
        "https://meta.locgame.io/0x02b9eb23975857B91499d71D6c4B5cFC1E122B98/";

    event BaseURISet(string indexed baseURI);

    constructor(address admin, address minter)
        LOCAccess(admin, minter)
        ERC721("LOCGame | LegendsOfCrypto", "LOC")
    {}
...
// File: contracts/LOCGameNFTCollection.sol


pragma solidity 0.8.9;


contract LOCGameNFTCollection is LOCOZExtension {
    constructor(address admin, address minter) LOCOZExtension(admin, minter) {}
