    ...
    IDropERC721
{
    ...
    function claim(
        ...
        validateAndTransferClaim(validMerkleProof,_proofMaxQuantityPerTransaction,activeConditionId,merkleProofIndex,claimer,
        quantity,currency,pricePerToken,_tokenIdToClaim,toVerifyMaxQuantityPerTransaction
        );
    }

    function validateAndTransferClaim(bool validMerkleProof,uint256 _proofMaxQuantityPerTransaction,
    uint256 activeConditionId,uint256 merkleProofIndex, address _receiver,
        uint256 _quantity,
        address _currency,
         uint256 _pricePerToken,
    ...
    function verifyClaim(
        ...
        (uint256 lastClaimTimestamp, uint256 nextValidClaimTimestamp) = getClaimTimestamp(_conditionId, _receiver);
