...
contract TokenFactory is Initializable, BasicMetaTransaction {
    ...
    function setTokenProxy(address _address) external validation(_address) {
        require(admin.hasRole(OPERATOR, _msgSender()), "OnlyOperator");
        tokenProxy = _address;
    }
    ...
    function createClone(address implementation)
        public
    ...
    function createToken(
        ...
        address Clone = createClone(tokenProxy);
        // address Clone = address(new OwnedUpgradeabilityProxy());
        IOwnedUpgradeability(Clone).initialize(address(this));
        // console.log("cloned");
        // console.log(IOwnedUpgradeability(Clone).proxyOwner());
        ...
        IOwnedUpgradeability(Clone).transferProxyOwnership(owner_);
