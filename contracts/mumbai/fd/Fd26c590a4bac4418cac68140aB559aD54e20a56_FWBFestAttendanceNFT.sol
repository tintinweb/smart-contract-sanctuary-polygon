...
contract FWBFestAttendanceNFT is Ownable, ERC721, EIP712MetaTransaction {
    ...
    IERC721 private immutable _requiredToken;
    ...
    constructor(address trustedAddress, address requiredTokenAddress)
        ERC721("FWB FEST ATTENDANCE NFT", "FWBFEST")
        EIP712MetaTransaction("FWBFest", "0.1.0")
    {
        _trustedAddress = trustedAddress;
        _requiredToken = IERC721(requiredTokenAddress);
    }
    ...
    function isEligible(address user) public view returns (bool) {
        return _requiredToken.balanceOf(user) >= 1;
    }
