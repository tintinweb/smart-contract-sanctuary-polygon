...
contract ContractAFacet{
    ...
    modifier AdminAccess() {
        require(LibDiamond.contractOwner() == msg.sender,"Only admin can access these functions");
        _;
    }

    function getAdminFromA() public view returns(address){
        return LibDiamond.contractOwner();
    }
    function getAdminFromAagain() public view returns(address){
