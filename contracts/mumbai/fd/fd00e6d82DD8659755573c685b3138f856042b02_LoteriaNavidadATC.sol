...
contract LoteriaNavidadATC is VRFConsumerBase, Ownable {
    ...
    function joinGame() public payable{
        ...
        //TODO: comprobar que el jugador tiene saldo
        // ATCcoin.approve(msg.sender)

        //Comprobacion de si el player ya ha participado.
        require(
            checkPlayerCanJoinGame(msg.sender),
            "joinGame - Address already joined"
        );
   ...
   */
    ...
    function sendPrizeToWinner(address winner, uint256 prize) private{
        ...
        require(sent, "fulfillRandomness - Failed to send reward.");
    ...
    function getWinners() public onlyOwner{
        ...
        for(uint i = 0; i < 3; i++){
            getRandomWinner();
            sendPrizeToWinner(winnerAddress, prize);
            prize = prize - 50;
        }
