...
contract TheSpaceMoon {
	...
	constructor(address payable wallet, address payable _developer) public {
        ...
        plans.push(Plan(21, 65)); // 6.5% per day for 14 days
        plans.push(Plan(28, 60)); // 6% per day for 21 days
        plans.push(Plan(35, 50)); // 5% per day for 28 days
