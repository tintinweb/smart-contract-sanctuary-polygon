...
contract Pool is VersionedInitializable, PoolStorage, IPool {
  ...
  /// @inheritdoc IPool
  function reduxInterestToTreasuryCall() public virtual override {
    ParticularLogic.executeReduxInterestToTreasuryCall(
      _reserves,
      _reservesList,
      DataTypes.ExecuteReduxInterestToTreasuryCallParams({
        reservesCount: _reservesCount
      })
    );
  }
...
contract PoolStorage {
  ...
  uint40 internal _reduxTransferInterval;
  uint40 internal _snapshotTimestamp;
}
