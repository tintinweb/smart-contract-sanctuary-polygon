...
contract Auction {
    ...
    function setFeeSystem(
        ...
        feeSystem.userFeeFinishAuction = _userFeeFinishAuction;
    }
    ...
    function purchaseProcessing(
        ...
        require(
            (_method == DataStructure.Method.BUY &&
        ...
        if (_method == DataStructure.Method.BUY) {
            ...
            stanFund[_buyer] = _method == DataStructure.Method.AUCTION
                ? stanFund[_buyer]
    ...
    function placeBidAuction(
        ...
        uint256 fee = (_amount * feeSystem.userFeeFinishAuction) / 100;
        address _maker = msg.sender;
        require(
            auctionIdToAuction[_auctionId].state ==
                DataStructure.StateOfAution.ACTIVE,
            "You are not allowed to place bid this auction"
        );
        require(
            stanFund[_maker] >= (_amount + fee),
            "Your Stan Fund is not afford to proceed this function"
        );
        (
            ,
        ...
        checkValidAmout(_amount)
    {
        ...
        processEvent(0, _requestId, "DEPOSIT", DataStructure.PlatForm.WEB);
    }
    ...
    function withdraw(uint256 _amount, bytes memory _requestId) external {
        ...
        processEvent(0, _requestId, "WITHDRAW", DataStructure.PlatForm.WEB);
    }
