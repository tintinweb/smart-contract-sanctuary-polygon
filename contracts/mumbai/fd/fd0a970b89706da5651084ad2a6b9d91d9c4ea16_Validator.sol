...
// File: contracts/ValidatorMATICtest.sol
...
contract Validator is Ownable {
    ...
    uint256 constant NETWORK = 1;  // ETH mainnet = 1, Ropsten = 3,Kovan - 42, BSC_TESTNET = 97, BSC_MAINNET = 56, MATIC = 137, MATIC_TESTNET = 80001
    ...
    constructor (address _oracle) {
        ...
        //tokenPriceFeed[address(1)] = IPriceFeed();    // BNB/USD

        tokenPriceFeed[address(2)] = IPriceFeed(0x0715A7794a1dc8e42615F059dD6e406A6594651A);    // ETH/USD

        tokenPriceFeed[address(4)] = IPriceFeed(0xd0D5e3DB44DE05E9F294BB0a3bEEaF030DE24Ada);    // MATIC/USD
        ...
        //tokenPriceFeed[address(1)] = IPriceFeed(0x82a6c4AF830caa6c97bb504425f6A66165C2c26e);    // BNB/USD

        //tokenPriceFeed[address(2)] = IPriceFeed(0xF9680D99D6C9589e2a93a78A04A279e509205945);    // ETH/USD
    ...
    function checkBalances(address foreignFactory, address[] calldata users) external returns(uint256) {
        ...
        uint256 myId = ICompanyOracle(companyOracle).getBalance(NETWORK, foreignFactory, users);
    ...
    function oracleCallback(uint256 requestId,uint256[] calldata balances) external returns(bool) {
