...
contract FlipCoin is VRFV2WrapperConsumerBase{
    ...
    constructor() payable  VRFV2WrapperConsumerBase(chainlinkaddress,vrfWraypperAddress)
    {
    ...
    function checkContractBalance() public view  returns (uint256 _balance) {
    ...
    uint16 constant requestConfirmations = 4;
    ...
    function AddEthToContract(uint256 id) public payable returns(bool)
    {
