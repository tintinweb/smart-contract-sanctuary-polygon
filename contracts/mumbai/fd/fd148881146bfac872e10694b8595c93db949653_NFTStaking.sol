...
// File contracts/NFTVariableRarity.sol
...
contract NFTStaking is Ownable, ReentrancyGuard {
   ...
   // EnumerableSet.AddressSet private stakersArray;
    ...
    /**
     * @dev Claim rewards for the msg.sender external function
     */
                ...
                )
    {
        ...
        return (
                ...
                _availableRewards,
                _availableRewards + stakes[_user].claimedRewards
                );
    }
    /**
        ...
        returns (uint256 _rewards)
    {
        ...
        if( poolInfo.startStakingTime <= _stake.timestampLastUpdate){
            ...
            // staking started and still ongoing
                ...
                // staking but ended but user has not claimed yet
