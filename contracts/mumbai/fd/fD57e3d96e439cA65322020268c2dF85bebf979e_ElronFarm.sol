...
contract LPTokenWrapper {
    ...
    IERC20 public x = IERC20(0xea9A139EB851fFcB854B432e4e84B410161cdfb6);
...
contract ElronFarm is LPTokenWrapper, Ownable{
    IERC20 public Elron = IERC20(0xea9A139EB851fFcB854B432e4e84B410161cdfb6);
    IERC20 public USDT = IERC20(0x037879AFa640393B83Da5114FfA105301F558158);
    ...
    uint256 public periodFinish = block.timestamp + 1 seconds;
