    ...
    VRFConsumerBaseV2Upgradeable
{
    ...
    constructor(
        ...
        //      ^(Jason: it is 'okay'; good to run a test that checks that this can't be initialised though because testing everything regardless is good)
    ...
    function initialize(
        ...
        callbackGasLimit = 1000000; // TODO: set accurately
        numWords = 2;
        gas = 500000;
    ...
    function validateUniqueness(
        ...
        // require(
        //     layerComboAlreadyUsed(layer2, layer3, layer4, layer5, layer6),
        //     "Non unique mint!"
        // );
    ...
    /// @param tokenId - token id to mint it with, note this can fall outside of the startIndex & endIndex
