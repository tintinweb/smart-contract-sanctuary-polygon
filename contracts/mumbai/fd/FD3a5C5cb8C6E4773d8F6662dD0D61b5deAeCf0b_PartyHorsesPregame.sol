...
contract PartyHorsesPregame is ERC721A, Ownable {
    ...
    modifier callerIsUser() {
        require(tx.origin == msg.sender, "don't call from a contract");
        _;
    }
    ...
    function privateMint(bytes calldata _allowlistSignature) external payable {
        require(verifySignature(keccak256(abi.encode(msg.sender)), _allowlistSignature));
    ...
    function verifySignature(bytes32 hash, bytes memory signature) private view callerIsUser returns(bool) {
