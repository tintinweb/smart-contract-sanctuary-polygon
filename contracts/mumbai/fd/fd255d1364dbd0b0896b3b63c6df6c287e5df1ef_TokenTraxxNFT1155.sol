    ...
    IERC1155Custom
{
   ...
   /**
     ...
     */
    function setBaseURI(string calldata baseUri) external virtual onlyMaintainer {
    ...
    function burnTraxx(
        ...
        require(msg.sender == account && (balanceOf(account, id) >= value), throwError(ONLY_TOKEN_OWNER));
        _burn(account, id, value);
