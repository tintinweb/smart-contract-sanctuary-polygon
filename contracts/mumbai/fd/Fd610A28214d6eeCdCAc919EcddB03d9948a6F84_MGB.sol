...
contract MGB is ReflectToken, AccessControl {
    ...
    function setOwner(address newOnwer) external {
        require(msg.sender == _owner, "you are not owner"); //maybe use grantRole() function?!
...
abstract contract ReflectToken is Context, IERC20, Ownable {
    ...
    function excludeAccount(address account) public onlyOwner {
        console.log("EXCLUDE ACCOUNT CALL");
        require(
            !_isExcluded[account],
     ...
     * @dev Adding DEX account in list
     */
    function _addAccountInDex(address account, bool value) internal {
        _dexList[account] = value;
