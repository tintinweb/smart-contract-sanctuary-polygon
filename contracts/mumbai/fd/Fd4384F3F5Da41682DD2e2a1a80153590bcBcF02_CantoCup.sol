    ...
    ERC2981Upgradeable
{
    ...
    function initialize(address _royaltyReceiver, uint96 _royaltyFeeBasisPoints) public initializer {
        // TODO: change NFT NAME, NFT SYMBOL
        __ERC721_init("CantoCup", "CUP");
    ...
    function mint(address _recipient, uint256 _quantity) external onlyRole(ROLE_MINTER) {
        require(_recipient != address(0), "zero address");
        require(_quantity > 0, "zero quantity");
    
        uint256 _startTokenId = _tokenCounter + 1;
        for (uint256 i = 0; i < _quantity; i++) {
            _safeMint(_recipient, _startTokenId + i);
        }
        // increase token counter
        _tokenCounter = _tokenCounter + _quantity;
    }
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(AccessControlUpgradeable, ERC721EnumerableUpgradeable, ERC2981Upgradeable)
        returns (bool)
    {
