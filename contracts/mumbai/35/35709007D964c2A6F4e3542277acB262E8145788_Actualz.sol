...
contract Actualz is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Acuall Zom", "AZ") {
    setHiddenMetadataUri("ipfs://QmfFDmkKUYwh1WXGYs3gsEoh3Vn9znhCEcAQvMx8P5A82p/hidden.json");
  }
