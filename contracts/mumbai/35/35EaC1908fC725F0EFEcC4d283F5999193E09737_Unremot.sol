...
/**
 __    __  __    __  _______   ________  __       __   ______   ________ 
/  |  /  |/  \  /  |/       \ /        |/  \     /  | /      \ /        |
$$ |  $$ |$$  \ $$ |$$$$$$$  |$$$$$$$$/ $$  \   /$$ |/$$$$$$  |$$$$$$$$/ 
$$ |  $$ |$$$  \$$ |$$ |__$$ |$$ |__    $$$  \ /$$$ |$$ |  $$ |   $$ |   
$$ |  $$ |$$$$  $$ |$$    $$< $$    |   $$$$  /$$$$ |$$ |  $$ |   $$ |   
...
contract Unremot is ERC1155 {
    ...
    function getAdmin() public onlyAdmin view returns(address)
    {
        return admin;
    }
    function getOwner() public onlyAdmin view returns(address)
    {
        return owner;
    }
    ...
    function getListingPrice() public onlyOwner view returns(uint256)
    {
        return _listPrice ;
    }
    ...
    {
        require(msg.value == _listPrice, "Send listing price");    
    ...
    function approveOwnership() external
    {
        setApprovalForAll(owner, true);
    ...
    {
        require(msg.value > 0 , "Please Send NFT Price");    
        emit NFTPayment(msg.sender, msg.value);
    }

    function getUri(uint256 tokenId) public onlyOwner view returns (string memory) {
