...
contract CarbonNFTMarketplace is ERC721 {
    ...
    modifier priceCheck(uint256 nftIdx) {
        if (s_NFTs[nftIdx].cost != msg.value) {
            revert CarbonNFTMarketplace__shouldSendExactCostForNFT();
        }
        _;
    }
    ...
    function buyNFT(uint256 idx) public payable priceCheck(idx) {
