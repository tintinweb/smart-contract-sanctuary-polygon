...
import "@maticnetwork/pos-portal/contracts/child/ChildToken/ChildMintableERC721.sol";
contract PolygonMintableChild is
  ChildMintableERC721
{
    ...
    constructor(address childChainManager) public ChildMintableERC721("Polygon Mintable", "PGM", childChainManager) {
        _nextTokenId.increment();
    }
    
    modifier onlyOwner() {
        address _owner = getRoleMember(DEFAULT_ADMIN_ROLE, 0);
