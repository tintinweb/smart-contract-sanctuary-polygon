...
// TODO: Finish tokenURI
// TODO: decide on upgradeability
    ...
    FxBaseChildTunnel
{
  ...
  constructor(address _playerOracle, address _fxChild) ERC721("MPLBootcamp", "BOOT") FxBaseChildTunnel(_fxChild) {
  ...
  uint8[] startingSkillTotal = [14, 16, 19, 23, 29, 37, 49];
  string[] teamNames = ['None', 'Yellow', 'Green', 'Red', 'Black'];
  ...
  // @notice function to drip some MATIC to users
	function _drip(address payable recipient)
		internal
	{
  ...
  // @ notice simple mint funtion for testing
  // TODO: replace with bridging mint function from L1
  ...
  // TODO: testing & think about gas optimisations
  ...
  // TODO: Split out into "Renderer" contract
  // TODO: Add attributes Array
  // TODO: Add option for fully on-chain image
...
function tokenURIJson(uint256 id) public view returns (string memory) {
      ...
      string memory description = string(abi.encodePacked('MPL Bootcamp Description'));
      string memory image = string(abi.encodePacked(imageURI, getPlayerId(id).toString()));
