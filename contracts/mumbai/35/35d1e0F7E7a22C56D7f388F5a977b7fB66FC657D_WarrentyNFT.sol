...
contract WarrentyNFT is ERC721, ERC721URIStorage{
    ...
    function generateCharacter() private pure returns (string memory) {
    ...
    function getTokenUri() private view returns(string memory){
        string memory dataURI = Base64.encode(bytes(string(abi.encodePacked(
            '{"name": "', attribute._name, '",',
                    ...
                    '"attributes": [{"trait_type": "Speed", "value": ', attribute._serial, '},',
                    '{"trait_type": "Attack", "value": ', attribute._product, '},',
                    '{"trait_type": "Defence", "value": ', attribute._date, '},',
                    '{"trait_type": "Material", "value": "', attribute._name, '"}',
                    ']}'
        ))));
