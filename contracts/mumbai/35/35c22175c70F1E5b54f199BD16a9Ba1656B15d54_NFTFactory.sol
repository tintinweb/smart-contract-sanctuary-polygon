...
contract NFTFactory is Ownable {
    ...
    event NewCollection(address indexed collection, address indexed owner, string indexed name, string symbol, string contractURI);

    function createCollection(string memory _name, string memory _symbol, string memory _contractURI, address[] memory whitelistAddresses) public returns (address) {
        ...
        emit NewCollection(address(newCol), msg.sender, _name, _symbol, _contractURI);
