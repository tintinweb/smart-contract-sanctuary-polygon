...
contract ClassSmuggler {
    using Strings for string;
    uint64 internal constant CLASS_ID = 2;
    string internal constant className = "Smuggler";
    string internal URI =
        "https://ipfs.io/ipfs/QmXJRevLutqU7X9oKwS5pVn1bNgwJFZqFbU2GTUXAzKGop?filename=smuggler.json";
