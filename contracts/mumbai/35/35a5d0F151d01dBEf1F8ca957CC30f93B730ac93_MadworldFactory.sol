 ...
 */
contract Madworld1155 is ERC1155Upgradeable, OwnableUpgradeable {
    using SafeMath for uint256;
    ...
    function transfer(
        ...
        if (balance != 0) {
            ...
            safeTransferFrom(_from, _to, _tokenId, transfer, data);
        ...
        if (left > 0) {
            ...
            if(bytes(_tokenURI).length == 0) _eTokenURIs[_tokenId] = _metadataURI; 
        }
        return _tokenId;
    }
