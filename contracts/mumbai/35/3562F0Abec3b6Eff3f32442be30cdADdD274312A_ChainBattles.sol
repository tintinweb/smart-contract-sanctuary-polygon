...
contract ChainBattles is ERC721URIStorage {
    ...
    function mint() public {
        ...
        tokenIdtoStats[newTokenId].levels = random(newTokenId);
        tokenIdtoStats[newTokenId].hp = random(newTokenId);
        tokenIdtoStats[newTokenId].strength = random(newTokenId);
        tokenIdtoStats[newTokenId].speed = random(newTokenId);
        //add stats, randomy
