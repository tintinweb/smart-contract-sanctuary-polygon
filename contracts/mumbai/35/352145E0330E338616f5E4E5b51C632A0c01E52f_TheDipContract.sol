...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1686496260;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x3Aa7E5b52b85153e91135a15F4e2C25925af2522,0xEEF6Ef5009f417FD2bC616D76Fc16e85eEd8AB7A,0xB4B5eb1dFD281C7988897903D8bb1034BA84c24e,0xFb8F404375668cB5272659E29a9262ca9b7749A6];
  address public erc20Payable = 0x3Aa7E5b52b85153e91135a15F4e2C25925af2522;
  uint256[] public payableFees = [25,25,25,25];
...
abstract contract Feeable is Teams, ProviderFees {
  uint256 public PRICE = 11.11 ether;
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 11, 1100) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeib23wh6kug2mc4ynl67irjg3xuvdlns6imrjheazwwxfmao6jsrs4/";
    string public _baseTokenExtension = ".json";

    bool public mintingOpen = false;
    bool public isRevealed;
    
    uint256 public MAX_WALLET_MINTS = 11;
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/dNf76hozoTx2fd9VOu3n/contract-metadata";
  }
...
// File: contracts/TheDipContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheDipContract is ERC721APlus {
    constructor() ERC721APlus("The Dip", "DIPSHIT"){}
}
