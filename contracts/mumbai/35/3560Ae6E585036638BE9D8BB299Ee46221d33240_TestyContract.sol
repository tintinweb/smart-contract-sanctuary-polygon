...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x6809F8D7FC7F86b87BA6308666D78462Cf003337,0x000000000000000000000000000000000000dEaD];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 1, 831 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeibeycz7cdbq7bffhntvy4t7yjre2axajepgtq3vfqbrhpmlik5gea/";
...
contract TestyContract is RamppERC721A {
    constructor() RamppERC721A("testy", "TESTY"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/vMDrANEaBPf7kuOGDmOS/contract-metadata";
    }
}
