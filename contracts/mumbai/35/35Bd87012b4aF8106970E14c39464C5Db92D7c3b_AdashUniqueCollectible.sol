...
contract AdashUniqueCollectible is
    AdashRoyalty,
    ERC721Upgradeable,
    OwnableUpgradeable
{
        ...
        returns (uint256)
    {
        ...
        _saveRoyalty(newTokenId, _royalty);
        _incrementTokenId();
        return newTokenId;
    }
    ...
    /**
     * Override isApprovedForAll to whitelist user's Adash proxy accounts to enable gas-less listings.
     */
    function isApprovedForAll(address owner, address operator)
        ...
        returns (bool)
    {
        // Whitelist Adash proxy contract for easy trading.
