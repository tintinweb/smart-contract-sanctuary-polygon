...
// File: contracts/NFTAccessMintGasless.sol
...
contract NFTAccessMint is ERC721URIStorage, Ownable, ERC2771Recipient {
    ...
    constructor(string memory collectionName, string memory symbol, address forwarder)  ERC721(collectionName, symbol) {
    ...
    function mintNFT() public returns (uint256) {
        require(_tokenIds.current() <= _totalSupply, "Max suppy reached. Cannot mint further !");
        _tokenIds.increment();
