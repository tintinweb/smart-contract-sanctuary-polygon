...
//
//     __ ____ __ _
//    / |/ (_)___ ___ _________ ___                 ____ / /______(_)
//   / /|_/ / / __ \/ _ \ / ___/ __ `__ \/ __ \ / __/ ___/ /
//  / / / / / / / __/ (__ ) / / / / / /_/ / / /_/ / / /  
// /_/ /_/_/_/ /_/\___/ /____/_/ /_/ /_/ .___/ \__/_/ /_/   
//                                      /_/       
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x865af3fb4B9d3A26Df351DE1D60A16B57927AA2f];
...
// File: contracts/MinesmptriContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract MinesmptriContract is 
    ERC1155,
    Ownable, 
    Pausable, 
    ERC1155Supply, 
    ...
    Allowlist
{
    ...
    string public name = "Mine smp tri";
    ...
    */
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/CTHWty4OuQH7YdbOBjQ2/contract-metadata";
    }
