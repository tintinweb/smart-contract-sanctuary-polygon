...
contract ChainBattles is ERC721URIStorage {
        ...
        returns (string memory)
    {
        ...
        return
            string(
                abi.encodePacked(
                    "Level: ",
                    attributes.level.toString(),
                    "; Speed: ",
                    attributes.speed.toString(),
                    "; Strength: ",
                    attributes.strength.toString(),
                    "; Life: ",
                    attributes.life.toString()
                )
            );
    }
    ...
    {
        Attributes memory attributes = tokenIdToAttributes[tokenId];
        require(attributes.level > 0, "TokenId not found");
    ...
    function randomAttributeIncrement(uint256 seed)
        private
        view
        returns (uint256)
    {
