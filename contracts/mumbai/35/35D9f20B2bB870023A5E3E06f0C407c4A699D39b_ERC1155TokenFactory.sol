...
contract ERC1155TokenFactory{
    ...
    function createERC1155(string memory contractName, string memory uri, string[] memory tokensName,uint256[] memory tokensMaxSupply, address trustedForwarder) public {
        ERC1155Token erc1155Contract = new ERC1155Token(contractName, uri, trustedForwarder);
