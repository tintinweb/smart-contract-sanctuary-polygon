...
contract    ACommerceContract     is  ERC721
{
    ...
    constructor() ERC721("NSTP_V5", "NSTP")
    {
        serviceWallet = owner();
        ...
        if (block.chainid==5 || block.chainid==80001) 
        {
            ...
            mintingCurrencyToken = 0x879bad9DcD7e7f79B598a632103984FC090DA00D;      /* // WERT       0xfe4F5145f6e09952a5ba9e956ED0C25e3Fa4c7F1;      // PAPER XYZ contract       0xDa30ee0788276c093e686780C25f6C9431027234;      // CROSSMINT */
        }
    }
    ...
    event   CreateOnrampArticleByEmail();
    ...
    event   DispatchApprovedAmounts(uint articleId, uint merchantId, address from,address to, uint merchantAmount,uint feeAmount, uint totalAmount);
...
/*
                        ...
                        returns(TArticle memory)
    {
      unchecked
      {
        ...
        if (isOnramp==false)        // MINTING MODE, do this ==>
        {
            ++articleNftIndex;
