 ...
 * (based on the amount of time that has passed since the last transaction, the amount of Tokens staked and the amount of ERC20 Reward Tokens distributed per minute so that the amount of ERC20
 ...
 */
contract NFT_Staking_R is Ownable, ReentrancyGuard, Pausable {
    ...
    /**
     * @dev The amount of ERC20 Reward Tokens accrued per minute.
     */
    uint256 private rewardsPerMinute = 16666666666666667;
     ...
     * @param _nftCollection - The address ofthe ERC721 Collection.
...
/**
 * @notice Function used to update rewards.
...
/**
 * @notice Function used to calculate the rewards earned by a user.
 * @param _stakerAddress - The address of the staker.
 * @return The amount of ERC20 Reward Tokens earned by the user.
 */
...
/**
 * @notice Function used to set the rewards per minute.
 * @param _newRewardsPerMinute - The new amount of ERC20 Reward Tokens accrued per minute.
 */
...
/**
 * @notice Function used to pause the contract.
 */
...
/**
 * @notice Function used to unpause the contract.
 */
