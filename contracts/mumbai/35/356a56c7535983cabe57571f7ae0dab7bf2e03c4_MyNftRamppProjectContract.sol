  ...
  function _beforeTokenTransfer(
    ...
    contract MyNftRamppProjectContract is ERC721Tradable {
        ...
        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmS91n5zkFw5sUr6QQVvXek4ziMrSSjgiZWp97ossrRQTv/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/GAr0oTZSHqKdrkB7o2kW/contract-metadata";
        }
    }