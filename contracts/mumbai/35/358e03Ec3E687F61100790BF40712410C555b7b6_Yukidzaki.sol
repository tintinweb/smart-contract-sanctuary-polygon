...
// File: @openzeppelin/contracts-upgradeable[email protected]/token/ERC721/extensions/ERC721URIStorageUpgradeable.sol
...
/// @custom:security-contact xxxxxxxxxx
contract Yukidzaki is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    uint256 public allowListMintPrice = 0 ether;
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://QmSxyE9WvUxpo1yZ41HMWFEs1hkqF1XVkXWtEBKb43A2GG/";
    }
    ...
    function editeMintPrice(
        uint _publicMintPrice,
        uint _allowListMintPrice
    ) external onlyOwner{
        publicMintPrice = _publicMintPrice;
        allowListMintPrice = _allowListMintPrice;
    }

     function editeMaxSupply(
        uint _maxSupply 
    ) external onlyOwner{
    ...
    // Add publicMint and allowListMint 
    function allowListMint() public payable {        
        require(allowListMintOpen, "Allow list Mint Closed");
        require(allowList[msg.sender], "You are not on the allow list");
        require(msg.value == allowListMintPrice * 1 ether, "Not Enough Funds"); 
        internalMint();
    }
    ...
    function publicMint() public payable {
        ...
        // require(msg.value == publicMintPrice * 1 ether, "Not Enough Funds");
        internalMint();
    }
    ...
    function setAllowList(address[] calldata addresses) external  onlyOwner{
     ...
     function deleteAllowList(address[] calldata addresses) external  onlyOwner{
        for(uint256 i = 0; i < addresses.length; i++){
