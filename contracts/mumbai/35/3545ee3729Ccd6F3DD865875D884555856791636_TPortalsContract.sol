...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1669860840;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1669083540;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x4f0e5A1685155CAAF0c235834aDac1248e91ECE3];
  address public erc20Payable = 0x4f0e5A1685155CAAF0c235834aDac1248e91ECE3;
    ...
    , TimedDrop
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 193) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeicdhtxqwb2f2qc4tcs7seosql2mfdvnwlstynsy34zmyfxyy6czwm/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 193");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 193");
    ...
    function mintToMultipleERC20(address _to, uint256 _amount, address _erc20TokenContract) public payable {
      require(_amount >= 1, "Must mint at least 1 token");
      require(_amount <= maxBatchSize, "Cannot mint more than max mint per transaction");
      require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 193");
      require(mintingOpen == true && onlyAllowlistMode == false, "Public minting is not open right now!");
      require(publicDropTimePassed() == true, "Public drop time has not passed!");
...
// File: contracts/TPortalsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TPortalsContract is RamppERC721A {
    constructor() RamppERC721A("TPortals", "TPORTALS"){}
}
