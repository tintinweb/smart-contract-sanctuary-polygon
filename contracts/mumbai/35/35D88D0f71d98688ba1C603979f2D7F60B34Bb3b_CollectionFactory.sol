...
contract ERC1155Y is ERC1155Opensea {
    ...
    constructor(
        ...
        require(platformRoyalty >= minPlatformRoyalty, string(abi.encodePacked("Platform royalty must be equal or bigger than ", minPlatformRoyalty)));
        require((platformRoyalty + creatorRoyalty) == 10000, "Creator address cannot be NullAddress");
        require(_tokenPrice > minTokenPrice, string(abi.encodePacked("Token price at least must be ", minTokenPrice, " MATIC")));
...
contract Platform {
    ...
    uint256 internal minTokenPrice = 30; // In Matic
