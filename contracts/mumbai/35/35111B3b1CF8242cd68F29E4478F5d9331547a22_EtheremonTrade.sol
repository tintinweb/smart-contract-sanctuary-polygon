...
contract EtheremonTrade is BasicAccessControl {
    bool public  onTrade = false;
    function isOnTrading(uint256 _objId)  view external returns (bool) {
        false;
    }
    function getOnTrade(uint256 _objId) view external returns (string memory) {
        1;
    }
    function getOnTradeBool(uint256 _objId) view external returns (bool) {
        false;
    }
