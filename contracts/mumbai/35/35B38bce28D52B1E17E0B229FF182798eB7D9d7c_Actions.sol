...
contract Actions is Ownable {
    ...
    event ActionCompleteEvent(BCTypes.Game game, BCTypes.Player player, BCTypes.Action action);
        ...
        ) public payable
    {
        ...
        // TODO: CRITICAL -> Make sure game exists
        ...
        if (_action == BCTypes.Action.PASS) {
            ...
            if (utils.resolveChallenge(uint8(currentChar.traits.hack), firstRefDoor.vsHack)) {
                maps.setDoorFromPos(
                    currentGame.mapId,
                    currentPlayer.position.row,
                    currentPlayer.position.col,
            ...
            if (utils.resolveChallenge(uint8(currentChar.traits.breach), firstRefDoor.vsBreach)) {
                maps.setDoorFromPos(
                    currentGame.mapId,
                    currentPlayer.position.row,
                    currentPlayer.position.col,
        ...
        emit ActionCompleteEvent(currentGame, currentPlayer, _action);
    }
