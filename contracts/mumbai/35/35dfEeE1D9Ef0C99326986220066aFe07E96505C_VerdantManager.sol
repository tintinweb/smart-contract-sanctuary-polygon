...
import {EZeroAddress, EInvalidPaymentMethod} from "../libraries/Error.sol";

contract VerdantManager is
    IVerdantManager,
    Initializable,
    OwnableUpgradeable,
    PausableUpgradeable
{
    ...
    // Verifier of order signature
    address public verifier;
    // Address to receive revenue
    ...
    function getCommissionSellerByTokenId(
        ...
        (
            ...
            uint256 _branchId,
            uint256 _collectionId
        ) = callGetCategoryToken(_tokenId);

        return
            getCommissionSeller(_categoryId, _branchId, _collectionId, _minter);
    }
    ...
    function getCommissionBuyerByTokenId(
        ...
        return
            getCommissionBuyer(_categoryId, _branchId, _collectionId, _minter);
    }
