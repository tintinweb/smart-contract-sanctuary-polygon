...
contract limitOrderAndNormalSwapTokenProxy is OpsTaskCreator, Ownable {
    ...
    function massGetUserTokenInfo(address _user) public view returns (tokenInfoItem2[] memory _itemList) {
    ...
    function massGetUserTokenInfoByList(address _user, uint256[] memory _indexList) public view returns (tokenInfoItem2[] memory _itemList) {
