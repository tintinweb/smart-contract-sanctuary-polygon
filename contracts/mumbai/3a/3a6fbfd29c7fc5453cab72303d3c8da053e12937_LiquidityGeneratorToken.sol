...
contract LiquidityGeneratorToken is BaseToken, Ownable, IERC20{
    ...
    function _transfer(
        ...
        //if any account belongs to _isIncludedInFee account then remove the fee
