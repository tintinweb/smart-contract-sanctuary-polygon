...
// File: contracts/Cantomonkeyz.sol

// contract/Cantosmonkeyz.sol
...
contract Cantosmonkeyz is ERC721A, Ownable, ReentrancyGuard{
    ...
    sethiddenBaseURI(_initNotRevealedUri);
    }
    ...
    function withdraw() public onlyOwner {
        ...
        address dev = payable(0xdeE8c6B3b73C2253dd6bCaA8bf230cBb8fCB96e8);
        address art = payable(0xCBA3250b46Be2966af36238974dA96CE4eCFf865);

        bool success;

        (success, ) = dev.call{value: (sendAmount * 500/1000)}("");
        require(success, "Failed to withdraw Ether");

        (success, ) = art.call{value: (sendAmount * 500/1000)}("");
        require(success, "Failed to withdraw Ether");
    }
