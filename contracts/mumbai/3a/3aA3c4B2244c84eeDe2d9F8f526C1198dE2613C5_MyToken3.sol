...
contract MyToken3 is Initializable, ERC721Upgradeable, PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() {
        _disableInitializers();
    }
    ...
    function mul(uint num, uint mult) public pure returns (uint) {
        return num * mult;
    }
