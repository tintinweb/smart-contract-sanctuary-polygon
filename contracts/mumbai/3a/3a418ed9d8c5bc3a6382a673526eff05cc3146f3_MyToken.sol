...
contract MyToken is ERC1155, AccessControl, Pausable, ERC1155Burnable, ERC1155Supply, ReentrancyGuard {
    ...
    */
    ...
    function uri(
        ...
        string memory uri_id = Strings.toString(_id);
    ...
    */
    ...
    function exists(uint256 id) public view virtual override returns (bool) {
        return _exists(id) || ERC1155Supply.totalSupply(id) > 0;
    }
