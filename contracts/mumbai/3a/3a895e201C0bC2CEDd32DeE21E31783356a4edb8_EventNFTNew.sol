...
contract EventNFTNew is Ownable, ERC721URIStorage {
    ...
    function getContractDetail() public view returns (string memory, string memory, string memory, bool, uint, uint, string memory) {
        return (
            eventName,
            eventLogo,
            eventLocation,
    ...
    function getAllEventDetails() public view returns (DailyEvent[] memory) {
        return dailyEvents;
    }
