...
contract GamingNft is ERC721, Ownable, ReentrancyGuard{
    ...
    IERC20 gamingToken = IERC20(0x267c876aA5eF0f2Fd2d69C318Af69625974e5CDD);
    ...
    */
    ...
    function set(uint256 _raritylvl, uint256 newPrice,uint256 maxLimit,uint256 minLimit,uint256 _maxLimit,uint256 _minLimit) external onlyOwner {
        _rarities[_raritylvl].rarityPrice = newPrice;
        _rarities[_raritylvl].maxRarityLimit = maxLimit;
        _rarities[_raritylvl].minRarityLimit = minLimit;
        _rarities[_raritylvl].maxCharacterLimit = _maxLimit;
        _rarities[_raritylvl].minCharacterLimit = _minLimit;
    }
