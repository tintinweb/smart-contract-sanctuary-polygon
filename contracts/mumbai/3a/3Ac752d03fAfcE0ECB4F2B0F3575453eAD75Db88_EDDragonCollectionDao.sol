...
/**
 * @title Eternity Partner(Collection) Deck DAO
 *
 * @notice DAO used to distributes funds from the
 *         Eternity Deck game
 */
contract EDDragonCollectionDao is Ownable {
  /**
  ...
  * Dao house edge
  */
  uint public collectionAttribution = 2_000;
  
   /**
  * Dao house edge
  */
  uint public marketplaceRoyalty = 1_000;
