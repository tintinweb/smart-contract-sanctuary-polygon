...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x60b7E2409c84eF943F4c35DE022947cFAf320419];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 10, 99999 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://api.arhamsoft.com/A.soft/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 99999");
        _safeMint(_to, 1);
    }
...
// File: contracts/ArhamSoftPvtLtdContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ArhamSoftPvtLtdContract is RamppERC721A {
    constructor() RamppERC721A("ArhamSoft Pvt Ltd", "ASoft"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/Uj5I85mY6YULzQ9fDOvx/contract-metadata";
    }
}