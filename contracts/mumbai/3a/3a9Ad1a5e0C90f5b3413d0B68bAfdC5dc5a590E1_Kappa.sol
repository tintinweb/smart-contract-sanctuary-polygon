...
contract Kappa is ERC1155, Ownable {
    ...
    constructor() ERC1155("ipfs://bafybeigyhk23sa52un4odb3ghvznejxvpnft5kzrdw7vik3vy3qtdxloxe/{id}.json") {
        
    }

    function uri(uint256 _tokenId) public view virtual override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeigyhk23sa52un4odb3ghvznejxvpnft5kzrdw7vik3vy3qtdxloxe/", Strings.toString(_tokenId), ".json"));
    }
