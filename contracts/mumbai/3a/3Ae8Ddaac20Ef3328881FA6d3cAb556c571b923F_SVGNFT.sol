...
contract SVGNFT is ERC721URIStorage, Ownable, VRFConsumerBaseV2 {
    ...
    constructor(
        ...
        bytes32 _keyhash
    ) ERC721("StatNFT", "STT") VRFConsumerBaseV2(_vrfcoordinator) {
    ...
    function createNft() public {
        ...
        string memory tokenURI = getTokenURI(tokenCounter);
    ...
    function updateNft(uint256 _tokenId) public {
        ...
        requestIdToTokenId[_tokenId] = s_requestId;
    ...
    function revealUpdate(uint256 _tokenId) public {
        ...
        string memory svgURI = getTokenURI(_tokenId);
        //console.log("New URI: ", svgURI);
        _setTokenURI(_tokenId, svgURI);
        console.log(tokenIdToStat[_tokenId].health);
        console.log(tokenIdToStat[_tokenId].strength);
        console.log(tokenIdToStat[_tokenId].stamina);
    }
    ...
    {
        string memory initailURI = "data:application/json;base64,";
        string memory finalURI = string(
            Base64.encode(
                abi.encodePacked(
                    ...
                    "'name': 'StatCardNFT #",
                    (_tokenId).toString(),
                    "' ,'description': 'Randomly generated stat card!',",
                    "'image': '",
        ...
        // console.log(
        //     "TokenURI:",
        //     string(abi.encodePacked(initailURI, finalURI))
        // );
        string memory mainURI = string(abi.encodePacked(initailURI, finalURI));
        return mainURI;
    }

    function getImageURI(uint256 _tokenId) public view returns (string memory) {
        string memory initialURI = "data:image/svg+xml;base64,";
        ...
        string memory finalURI = string(abi.encodePacked(initialURI, svg));
        return finalURI;
    }
}
