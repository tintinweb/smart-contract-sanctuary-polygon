...
// File: contracts/SlopSwapSideBridge.sol


pragma solidity ^0.8.0;


contract SlopSwapSideBridge {
    ...
    function initializeBridge (address _childTokenAddress) onlyOwner external {
        sideToken = IERC20SD(_childTokenAddress);
