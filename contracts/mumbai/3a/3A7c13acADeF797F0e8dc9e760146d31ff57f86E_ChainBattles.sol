...
// the strings library requires the math.sol library???
// the HH compiler is telling me that the import is there, but I don't see it- so import that
...
// left off at "Create the Mint Function"
