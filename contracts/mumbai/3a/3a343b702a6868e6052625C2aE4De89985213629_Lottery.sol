...
contract Lottery is VRFConsumerBaseV2, ILottery, Roles {
    ...
    function drawACard() external override notPaused {
    ...
    function draw10Cards() external override notPaused {
        address player = _msgSender();
        address supplier = address(this);
...
interface ILottery {
    ...
    function drawACard() external;

    function draw10Cards() external;
