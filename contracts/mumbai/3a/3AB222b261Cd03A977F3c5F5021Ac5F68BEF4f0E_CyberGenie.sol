...
contract CyberGenie is Ownable, ERC721A {
    ...
    uint16 public constant MAX_MINT_PER_ADDRESS = 5;
    // Max token supply
    uint256 public constant MAX_SUPPLY = 5000;
    // Minted reserved token count
    uint256 public constant MINTED_RESERVE = 0;
    // Max reserved tokens
    ...
    modifier validateDiscount(uint16 _discount) {
     ...
     *
     */
    function setPartnersSCList(address _address, uint16 _discount)
        external
        onlyOwner
    ...
    function airdropOwner(address[] calldata _addrs, uint256[] calldata _counts)
        ...
        onlyOwner
    {
        require(MINTED_RESERVE <= MAX_RESERVE, "CG: Exceeded max reserve");
