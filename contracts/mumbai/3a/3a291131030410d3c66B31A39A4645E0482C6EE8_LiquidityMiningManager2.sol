...
contract LiquidityMiningManager2 is Initializable, ReentrancyGuardUpgradeable, TokenSaver {
    ...
    // testing only
    function setRewardsSource(uint256 myTestValue) external {
...
contract TokenSaver is AccessControlEnumerableUpgradeable {
    ...
    function __TokenSaver_init() internal {
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
    }
