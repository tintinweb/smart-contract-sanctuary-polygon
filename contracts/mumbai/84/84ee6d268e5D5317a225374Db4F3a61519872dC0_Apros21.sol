...
pragma solidity 0.8.11;
    ...
    constructor() ERC20("Apros21", "APROS21") {
   ...
   _transfer(_msgSender(), recipient, amount);
    ...
    _transfer(_msgSender(), lotteryAddress, royaltyFee);
    //destinations[i].lotteryAddress.transfer(royaltyFee);
