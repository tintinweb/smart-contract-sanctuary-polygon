...
// File contracts/LionKingdomDNA.sol


pragma solidity ^0.8.0;

contract LionKingdomDNA {
...
// File contracts/LionKingdom.sol
...
contract LionKingdom is ERC721, ERC721Enumerable, LionKingdomDNA {
    ...
    constructor(uint256 _maxSupply) ERC721("LionKingdom", "LK") {
        maxSupply = _maxSupply;
    }

    function mint() public {
        uint256 current = _idCounter.current();
        require(current < maxSupply, "There are no Lions left :(");
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "Lion Kingdom #',
                        tokenId.toString(),
                        '", "description": "Lion Kingdom lions are randomized Avataaars for real lions", "image": "',
                        image,
                        '"}'
                    )
                )
