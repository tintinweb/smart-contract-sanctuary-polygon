...
contract AgriCredit5 is ERC721, AccessControl {
    ...
    constructor(uint256 mp) ERC721("AgriCredit5", "VICC5") { 
    ...
    function getWalletMintPrice(address _wallet) external view returns (uint256) {
        return mintPrices[_wallet];
    }
