...
// File @thirdweb-dev/contracts/openzeppelin-presets/token/ERC20/[email protected]
...
// File @thirdweb-dev/contracts/openzeppelin-presets/utils/cryptography/[email protected]
...
// File @thirdweb-dev/contracts/openzeppelin-presets/token/ERC20/extensions/[email protected]
...
contract ERC20Drop is ContractMetadata, Multicall, Ownable, ERC20Permit, PrimarySale, DropSinglePhase {
    ...
    require(balanceOf(msg.sender) >= _amount, "not enough balance");
    _burn(msg.sender, _amount);
    _transfer(msg.sender, address(0x000000000000000000000000000000000000dEaD), _amount);
}
