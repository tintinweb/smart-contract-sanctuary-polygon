...
contract ERC1155Upgradeable is  ERC165Upgradeable, IERC1155Upgradeable, IERC2981Upgradeable,OwnableUpgradeable {
   ...
   mapping(uint256 => string) private _tokenURIs;
    ...
    function __ERC1155(string memory _baseUri) internal {
        tokenURIPrefix=_baseUri;
    }
...
contract TariNFT1155 is ERC1155Upgradeable {
    ...
    function init(string memory _baseURI,address _operator, string memory __name, string memory __symbol)external initializer{
               operator=_operator;
               _name=__name;
               _symbol=__symbol;
                __Ownable_init();
