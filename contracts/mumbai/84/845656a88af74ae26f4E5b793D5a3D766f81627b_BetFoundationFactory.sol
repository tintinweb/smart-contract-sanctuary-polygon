...
contract BetFoundationFactory is TokenConfig,IBetFoundationFactory {
    ...
    function resolveBet(address betAddress_,uint finalOption_,bytes32[] memory hash_,bytes memory maker_,bytes memory taker_,bool isCustomized_) external override returns(bool) {
    ...
    function banBet(address betAddress_) external override isAdmin(admin) returns(bool) {
