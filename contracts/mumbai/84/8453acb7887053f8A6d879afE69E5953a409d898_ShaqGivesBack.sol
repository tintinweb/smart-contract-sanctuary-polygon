...
contract ShaqGivesBack is ERC721, Ownable {
  ...
  address constant mumbaiUSDC = 0xb9b2Ff74B98f4D9C5B150dC26D1683a6D99128D3;

  constructor(
  ) ERC721("ShaqGivesBack","FSD") {
    _tokenIds.increment();
  }
  ...
  function mintWithUSDC(address recipient, uint256 total) public {
    ...
    require(total == 1, "Price must be 1.");
    IERC20 mumbaiUSDCContract = getMumbaiUSDCContract();
    mumbaiUSDCContract.transferFrom(msg.sender, recipient, total);
  ...
  function getMumbaiUSDCContract() internal view returns (IERC20) {
     return IERC20(mumbaiUSDC);
  }
