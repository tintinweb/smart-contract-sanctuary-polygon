...
contract ERC721WithPermit is ERC721, EIP712Base, AccessControl, Pausable, PlatformFee {
  ...
  /**
    ...
    *
    */
  function addAllowedTokenForTransfer(address tokenAddress) external whenNotPaused onlyRole(DEFAULT_ADMIN_ROLE) {
  ...
  /**
    ...
    *
    */
  function removeAllowedTokenForTransfer(uint index, address tokenAddress) external whenNotPaused onlyRole(DEFAULT_ADMIN_ROLE) {
  ...
  /**
    ...
    *
    */
  function isAllowedTokenForTransfer(address tokenAddress) external view whenNotPaused returns (bool) {
  ...
  /**
    ...
    *
    */
  function getAllowedTokensForTransfer() public view whenNotPaused returns (address[] memory) {
  ...
  /**
    ...
    *
    */
  function updateTokenUri(uint256 tokenId, string memory tokenUri) external whenNotPaused onlyRole(DEFAULT_ADMIN_ROLE) {
    _tokenUris[tokenId] = tokenUri;
  }
