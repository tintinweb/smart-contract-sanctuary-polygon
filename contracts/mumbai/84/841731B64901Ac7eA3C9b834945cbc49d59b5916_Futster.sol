...
contract Futster is ERC721, ERC721Enumerable, Pausable, ERC721Burnable, ERC721Royalty, AccessControlled {
    ...
    function setBaseURI(string memory _newURI) public onlyGovernor returns (string memory) {
        baseURI = _newURI;
        emit BaseURIChanged(baseURI);
        return baseURI;
    }

    function setURISuffix(string memory _newSuffix) public onlyGovernor returns (string memory) {
        suffixURI = _newSuffix;
        return suffixURI;
    }
