...
contract CarvAchievements is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Ownable {
        ...
        override(ERC721, ERC721Enumerable)
    {
        if (from != address(0) && to != address(0)) {
            require(_transferable, "CarvAchievements: Achievement badges are not directly transferable. Use Carv to migrate badges among wallets you own");
        }
    ...
    function migrate(address to, uint256 tokenId) external onlyOwner {
