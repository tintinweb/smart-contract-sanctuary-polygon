...
contract DoubleOrNothing is VRFConsumerBaseV2 {
    ...
    address immutable s_vrf_coordinator;
    bytes32 immutable s_keyHash;
    bool[2] public DECIDER = [true, false];
    ...
    function fulfillRandomWords(
        ...
        uint256 randomNum = (s_randomWords[1] % 2);
        if (DECIDER[randomNum] == true) {
            ...
            requestIdToPlayer[s_requestId] = address(0); // is this neccesary??
            requestIdToPlayerToAmount[request_id][player] = 0;
