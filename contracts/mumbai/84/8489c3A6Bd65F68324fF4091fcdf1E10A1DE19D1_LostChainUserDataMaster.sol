...
contract LostChainUserDataMaster is CustomERC2771ContextUpgradeable, UUPSUpgradeable {
    ...
    function TESTING18() external pure returns (bool) {
        return true;
    }
}
...
abstract contract CustomERC2771ContextUpgradeable is Initializable, ContextUpgradeable {
    ...
    function isTrustedForwarder(address forwarder) private view returns (bool) {
