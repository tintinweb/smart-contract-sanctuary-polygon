...
contract Test {
    ...
    mapping(uint => address) public randomIdToAddress;
    ...
    event Registration(address indexed investor, address indexed referrer, uint256 indexed investorId, uint256 referrerId, uint256 random_id);
    ...
    {
        require(id>100000 && randomIdToAddress[id]==address(0), "invalid id!");
        ...
        randomIdToAddress[id] = userAddress;
        ...
        emit Registration(userAddress, referrerAddress, users[userAddress].id, users[referrerAddress].id, id);
    }
