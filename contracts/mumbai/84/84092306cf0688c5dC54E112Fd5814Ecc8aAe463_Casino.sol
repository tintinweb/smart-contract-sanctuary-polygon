...
contract Casino is Ownable {
    ...
    // User address => casino profits at moment of stake (recalculated at each stake)
    mapping(address => uint) public casinoProfitWhenStaked;
    ...
    function balanceOfWithRewards(address walletAddress) public view returns (uint256 balance) {
        balance =  (this.totalSupply() * balanceOf[walletAddress] / stakedAmount);
    }
