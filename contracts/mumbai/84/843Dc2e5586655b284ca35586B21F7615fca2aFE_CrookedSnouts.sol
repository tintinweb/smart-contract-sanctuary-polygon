...
contract CrookedSnouts is VRFConsumerBaseV2, ERC721URIStorage {
  ...
  // payment modifier deleted
  function requestNumbers() public payable activeRequest maximumSupply {
  ...
  function create() public alreadyMinted firstRequestNumbers returns(string memory) {
