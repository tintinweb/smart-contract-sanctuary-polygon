...
contract AIC is ERC721, Ownable {
    ...
    string private _tokenBaseURI =
        "https://gateway.pinata.cloud/ipfs/Qmbo3azCxkdtqfYNcf981itDsL44kb3jTtRLTSPpSJ2ZNJ/";
    ...
    function gift(address[] calldata receivers) external onlyOwner {
        require(
            _tokensMinted.current() + receivers.length <= AIC_MAX,
            "EXCEED_MAX"
        );
    ...
    function withdraw() external onlyOwner {
        ...
        payable(0x3FD45f7fc6da24A360E75aFF9DE577ab5fbdcfE7).transfer(
            (currentBalance * 500) / 1000
        );
        payable(0xbF6c44be5AC250B30726E9405d4fD80Bd16A1ae2).transfer(
            (currentBalance * 115) / 1000
        );
        payable(0x773DAaCda9E4d7C7955BCef1fbF807D318501F44).transfer(
            (currentBalance * 115) / 1000
        );
        payable(0xf05eA4Bcee0245020e9aCF59dFDaF4deD01292a5).transfer(
            (currentBalance * 70) / 1000
        );
        payable(0xbbDC03ab8238eE062fC55673379F905ec1174921).transfer(
            (currentBalance * 100) / 1000
        );
        payable(0x11111F01570EeAA3e5a2Fd51f4A2f127661B9834).transfer(
