...
contract RandomWinnerGame is VRFConsumerBase, Ownable {
    //chainlink variables
    // The amount of LINK to send the request
    uint256 public fee;
    //id of the pub key against which randomness is generated
    bytes32 public keyHash;
    //address of the players
    address[] public players;
    //max number of players in one game
    uint8 maxPlayers;
    // variable to indiciate if the game has started or not
    ...
    /**
     * fulfill randomness is called by VRFCoordinator when it receives a valid VRF proof
