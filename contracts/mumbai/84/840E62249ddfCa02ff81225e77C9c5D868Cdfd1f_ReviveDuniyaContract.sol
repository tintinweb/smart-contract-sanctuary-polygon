...
//
//    ___           _            ___            _          
//   / _ \___ _  __(_)  _____   / _ \__ _____  (_)_ _____ _
//  / , _/ -_) |/ / / |/ / -_) / // / // / _ \/ / // / _ `/
// /_/|_|\__/|___/_/|___/\__/ /____/\_,_/_//_/_/\_, /\_,_/ 
//                                             /___/       
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x9872421a71E1b12CBF62E649B121e394c9BC1ed7,0x6f7FfD13F3a43802C72C951c87C2471b8CDA0d42];
  address public erc20Payable = 0x9872421a71E1b12CBF62E649B121e394c9BC1ed7;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://Qmc6ryp5tHYrA8vMVWbQweLTQh783PB3zhZ4ZEYZwrADTW/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/sdNIRzExYkFzt45fo5xO/contract-metadata";
  }
...
// File: contracts/ReviveDuniyaContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ReviveDuniyaContract is ERC721APlus {
    constructor() ERC721APlus("Revive Duniya", "DUN"){}
}
