...
contract NFTMarket is ReentrancyGuard {
    ...
    function changeListingPrice(uint _listingPrice) external {
    ...
    function createMarketItem(bool _pNFT,address _nftContract, uint256 _tokenId, uint256 _price/* , uint _amount */) public payable nonReentrant {
        ...
        uint allowance = tskToken.allowance(msg.sender, address(this)); // TODO HAY QUE HACERLO DESDE FUERA, PORQUE TIENE QUE FIRMAR
