...
function createNewEvent(
    ...
    // hash together a few values to generate an eventID based on other things passed in to generate a hash
    // this is to stop eventid colisions incase some one event data is the same
...
//function to mass confirm all rsvps to event
...
//this function checks in attendees and returns their deposit
...
//this function withdraws deposits of people who didn’t show up to the event and send them to the event organizer:
