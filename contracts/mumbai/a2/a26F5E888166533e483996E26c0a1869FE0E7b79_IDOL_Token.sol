...
contract IDOL_Token {
    ...
    event ETrasactionsIndex (uint txnIndex);
 ...
 function BuyTkens(address _buyer, uint256 numOfTokens)
        ...
        
    {
        ...
        if (block.timestamp > First_Round_End_Date && block.timestamp <= Second_Round_End_Date) {
            require(numOfTokens >=20000000000000000000 && numOfTokens >=5000000000000000000000,"buy Between Miniimum 20 tokens and maximum 5000 Tokens");
        ...
        //ROUND 3 : Private VCs (31 Oct.- 06 Nov) Tokens 62,500
            ...
            require(numOfTokens >=500000000000000000000 && numOfTokens >=12500000000000000000000,"buy Between Miniimum 500 tokens and maximum 12500 Tokens");
        ...
        //ROUND 4 : Public 07 October Tokens 200,000
            ...
            require(numOfTokens >=10000000000000000000 && numOfTokens >=12500000000000000000000,"buy Between Miniimum 10 tokens and maximum 12500 Tokens");
            ThirdroundBuy_Time = block.timestamp;
               require(numOfTokens <= ThirdRoundnumToken);
                require(
                    ThirdRoundnumToken_initialToken + numOfTokens <= ThirdRoundnumToken
