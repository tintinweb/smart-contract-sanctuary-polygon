...
contract Phase3 is ERC721, ERC721Burnable,DefaultOperatorFilterer, ERC721Enumerable, Ownable{
    ...
    */
    function claim(uint256 phase2NFTId) external {
        require(IERC721(phase2Address).ownerOf(phase2NFTId) == msg.sender, "Phase3: You are not the owner of this NFT");
        require(alreadyClaimed[phase2NFTId] == false, "Phase3: NFT already claimed for this token");
        require(_randomNumbers.length != 0, "Phase3: All NFT has been already minted");
