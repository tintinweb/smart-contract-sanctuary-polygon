 ...
 */
interface IMSTokenERC721 is IERC721Upgradeable {
...
import { IMSTokenERC721 } from "../interfaces/token/IMSTokenERC721.sol";
  ...
  IMSTokenERC721
{
  ...
  bytes32 private constant MODULE_TYPE = bytes32("MSTokenERC721");
  ...
  /// @dev Lets a module admin set the URI for tokenId.
  function setTokenURI(
    uint256 _tokenId,
    string calldata _newUri
  ) external onlyRole(DEFAULT_ADMIN_ROLE) {
    require(_tokenId < nextTokenIdToMint, "Token has not been minted.");
