...
// Contract deployed to 0xa2527a1C6290a417C081e442553B2CFb8b6a964f
...
contract ChainBattles is ERC721URIStorage  {
    ...
    function train(uint256 tokenId) public {
        ...
        tokenIdToVariables[tokenId].hp = currentHp + random(5);
        uint256 currentStrength = tokenIdToVariables[tokenId].strength;
        tokenIdToVariables[tokenId].strength = currentStrength + random(5);
        uint256 currentSpeed = tokenIdToVariables[tokenId].speed;
        tokenIdToVariables[tokenId].speed = currentSpeed + random(5);
