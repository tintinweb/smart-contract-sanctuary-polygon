...
// File contracts/UpgradableNFT.sol
...
contract UpgradableNFT is Initializable,ERC721EnumerableUpgradeable,OwnableUpgradeable,UUPSUpgradeable {

    function initialize() initializer public {
        __ERC721_init("Upgradable NFT", "UNFT");
        __Ownable_init();
    ...
    function mint(uint amount) external {
        require(totalSupply() + amount < 10,"Limit exceeded");
