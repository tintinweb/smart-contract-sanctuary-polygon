...
contract Trust_Global is Ownable {
    ...
    constructor(address _token) public {
        ...
        for (uint8 i = 6; i <= LAST_LEVEL; i++) {          
            gR3Pool_User[i].push(id1);
            gR6Pool_User[i].push(id1);          
        }         
        userIds[1] = id1;
    }
    ...
    function _distributeTopGR3Pool(uint256 _dayNow) private {
        uint8[5] memory rates = [35,25,20,15,5];
    ...
    function _distribute3DirectPool(uint256 _dayNow) private {
