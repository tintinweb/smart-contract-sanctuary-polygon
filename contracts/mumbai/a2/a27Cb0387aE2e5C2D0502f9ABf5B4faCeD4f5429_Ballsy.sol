...
//  _______       __      ___      ___        ________  ___  ___  
// |   _  "\     /""\    |"  |    |"  |      /"       )|"  \/"  | 
// (. |_)  :)   /    \   ||  |    ||  |     (:   \___/  \   \  /  
// |:     \/   /' /\  \  |:  |    |:  |      \___  \     \\  \/   
// (|  _  \\  //  __'  \  \  |___  \  |___    __/  \\    /   /    
...
contract Ballsy is MinteebleERC721A, DefaultOperatorFilterer {
    constructor()
        MinteebleERC721A("Ballsy", "BALL", 10000, 250000000000000)
    {
        revealed = true;
        paused = false;
        setBaseUri("ipfs://bafybeietezl4xmpqrkqb6q5vfnygchcgzk6gsesxdyjx2vag2urunyogge/");
        _safeMint(owner(), 1);
    }
