...
contract DTTDTestAirdropContract is ERC721, Ownable {
    ...
    constructor() ERC721("Test Airdrop 2", "TAD2") {
    ...
    function airdrop(address _receiver, uint256[] calldata token_ids)
        external
        onlyOwner
    {
        mintNFTs(_receiver, token_ids);
    }

    function mintNFTs(address _receiver, uint256[] memory token_ids)
        internal
        maxSupplyCheck(token_ids.length)
    {
