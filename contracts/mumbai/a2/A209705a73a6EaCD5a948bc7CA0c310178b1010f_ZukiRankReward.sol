...
contract ZukiRankReward is Ownable, Pausable, ReentrancyGuard {
    ...
    event Claim(address indexed userAddress, uint256 gpAmount, uint256 zpAmount, uint256 zkAmount);
    ...
    constructor() {
        ...
        ranks[16] = 80;
        ranks[17] = 62;
        campaigns[1] = Campaign(1,10000000000000000000000,100000000000000000000000, 100000000000000000000000,1645671600,1678804025,0);
    }
