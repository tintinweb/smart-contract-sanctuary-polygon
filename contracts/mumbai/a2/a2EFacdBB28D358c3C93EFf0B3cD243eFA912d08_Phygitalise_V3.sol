...
contract Phygitalise_V3 is ERC721A, ERC2981, ReentrancyGuard, AccessControl {

    //@notice _tokenURIs is an array value used for assigning tokenURIs to tokenIds.

    mapping(uint256 => string) private _tokenURIs;

    //@notice Minter holds current contract Minter.
    ...
    //@notice Minter the event is emited at the time of changeMinter function invoke. 
    //@param previousMinter address of the previous contract owner.
    //@param newMinter address of the new contract owner.
    ...
    constructor(address admin, address _minter) ERC721A("Phygitalise_V3", "Phygitalise_V3") {
        owner = admin;
        minter = _minter;
    ...
    //@notice changeMinter for transferring contract Minter position to new Minter address.
    //@param newMinter address of new Minter.
    //@return bool value always true. 
    /** restriction: the ADMIN_ROLE address only has the permission to 
    chnage the contract Minter position to new wallet address.*/
    //@dev see{Accesscontrol}.
