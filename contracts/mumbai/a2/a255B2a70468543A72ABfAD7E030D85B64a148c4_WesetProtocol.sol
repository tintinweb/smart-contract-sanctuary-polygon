    ...
    DefaultOperatorFilterer
{
    ...
    function _collectPriceOnClaim(
        ...
        ///@dev - check price for native token
...
library CurrencyTransferLib {
    ...
    address public constant NATIVE_TEST =
    ...
    function transferCurrency(
        ...
        ///@dev - check token is an accepted
        if (
            _currency != NATIVE_TOKEN ||
            _currency != NATIVE_TEST ||
            _currency != USDC ||
            _currency != USDT ||
            _currency != DAI ||
            _currency != USDC_MUMBAI ||
            _currency != USDC_TEST
        ) {
            revert("Must send correct token");
        }
