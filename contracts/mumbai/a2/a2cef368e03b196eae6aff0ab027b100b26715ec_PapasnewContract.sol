...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
    ...
    // File: contracts/papasnewContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract PapasnewContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("papasnew", "ppn", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "https://ipfs.io/ipfs/QmTCXU4DF5Y575xQGXNtTL9VUtJVbVhJPXuSMWn2Rrnvz6/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/yovKjG6H3z5fFSToetmG/contract-metadata";
        }
    }