...
contract SmartOracle is Ownable, Pausable {
    ...
    function updatePrice(uint256 price, bytes[] memory updatePriceData) external onlyGelatoMsgSender {
         pyth.updatePriceFeeds(updatePriceData);
    ...
    function getPrice() view public returns(Price memory) {
        return currentPrice;
    }
