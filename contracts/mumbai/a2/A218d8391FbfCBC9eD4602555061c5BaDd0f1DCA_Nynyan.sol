...
contract Nynyan is Governor, GovernorSettings, GovernorCompatibilityBravo, GovernorVotes, GovernorVotesQuorumFraction, GovernorTimelockControl {
    constructor(IVotes _token, TimelockController _timelock)
        Governor("Nynyan")
        GovernorSettings(1 /* 1 block */, 14 /* 3 minute */, 0)
