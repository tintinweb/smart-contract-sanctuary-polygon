	...
	ReentrancyGuardUpgradeable
{
	...
	event SignatureApproved(
		...
		uint16 indexed riskCoefficient,
	 ...
	 */
	uint16 public constant maxRiskCoefficient = 10000;
	 ...
	 * @param _riskCoefficient The uint16 value of riskCoefficient.
	 *
	 * Requirements:
	 ...
	 */
	function approveUser(address _user, uint16 _riskCoefficient)
		public
		nonReentrant
		isReady
		isUnderWriter
	 ...
	 *  - `_user` Must not be UnderWriter.
	 */
	function reApproveUser(address _user, uint16 _riskCoefficient)
		public
		nonReentrant
		isReady
		isSuperManager
	 ...
	 * @param _user The user address.
	 * @return The uint16 value of riskCoefficient.
	 */
	function riskCoefficientOfUser(address _user) public view returns (uint16) {
	 ...
	 * @return riskCoefficient The uint16 value of riskCoefficient.
	 */
	function riskProfileUser(address _user)
		public
		view
		returns (bool approved, uint16 riskCoefficient)
	{
		return (
