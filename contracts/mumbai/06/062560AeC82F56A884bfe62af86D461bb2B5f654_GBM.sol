...
contract GBM is IGBM, IERC1155TokenReceiver, IERC721TokenReceiver, AccessControl {
    ...
    constructor(address _ERC20Currency, address _initiatorKeeper) {
        owner = msg.sender;
        ERC20Currency = _ERC20Currency;
        _setupRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _setupRole(INITIATOR_ROLE, msg.sender);
        _grantRole(INITIATOR_ROLE, _initiatorKeeper);
    }
    ...
    function registerOrModifyAuctionToken(
        ...
        modifyAnAuctionToken(
            ...
            _initiator,
            index,
            index <= eRC1155_tokensUnderAuction[_contract][_tokenId]
        );
    }
