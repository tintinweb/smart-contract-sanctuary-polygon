...
contract MintPassNFTNew is ERC721, ERC721URIStorage, Pausable, Ownable, ERC721Burnable, ERC2981, DefaultOperatorFilterer {
    ...
    //address payable public constant MintPriceReceipient = 0x1f6A403347fd2d335d14Dc3f1AEb21D9192cF166;
    ...
    function mintMintPass(address recipient, string memory uri, address royaltFeeReceiver, uint96 fee) public payable returns(uint256){
        ...
        //(bool success) = payable(address(0x1f6A403347fd2d335d14Dc3f1AEb21D9192cF166)).transfer(10);
        payable(address(0x1f6A403347fd2d335d14Dc3f1AEb21D9192cF166)).transfer(100000000000000);
        //address(0x1f6A403347fd2d335d14Dc3f1AEb21D9192cF166).transfer(100);
        //require(success);
