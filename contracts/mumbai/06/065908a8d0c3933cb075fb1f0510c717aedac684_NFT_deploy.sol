...
contract NFT_deploy is ERC721, Ownable {
  using Strings for uint256;
  ...
  function _mintAllLoop(address _receiver) internal {
  ...
  //onlyOwner function  
  function mintAllForAddress(address _receiver) public mintCompliance() onlyOwner {
    _mintAllLoop(_receiver);
  }
