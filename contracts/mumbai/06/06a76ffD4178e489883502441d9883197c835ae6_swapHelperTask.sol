...
contract swapHelperTask is OpsTaskCreator, Ownable {
    ...
    event createTaskE(uint256 taskAmount, bytes32 taskId, address execAddress, bytes execData, ModuleData moduleData, address feeToken);
    ...
    function createTask(uint256 _INTERVAL) external payable {
        bytes memory execData = abi.encodeCall(this.swapCot, ());
        ...
        emit createTaskE(taskAmount, id, address(this), execData, moduleData, ETH);
