...
contract GSNERC1155Permit is Managable, ERC165, IERC1155, IERC1155MetadataURI, EIP712 {
    ...
    function maxId() public view virtual returns (uint256) {
        return _maxId;
    }
    ...
    function uri(uint256 id) public view virtual override returns (string memory) {
        require(
            exists(id),
            "GSNERC1155Permit: this id is not minted"
        );
        return string(abi.encodePacked(_uri, _metadataHash[id]));
    }

    function balanceOf(address account, uint256 id) public view virtual override returns (uint256) {
        require(account != address(0), "GSNERC1155Permit: balance query for the zero address");
    ...
    {
        require(accounts.length == ids.length, "GSNERC1155Permit: accounts and ids length mismatch");
    ...
    function addMetadataHash(
        ...
        require(
            id <= maxId(),
            "GSNERC1155Permit: Max id elapsed"
        );
    ...
    function burn(
        ...
        require(
            ...
            "GSNERC1155Permit: caller is not owner nor approved"
        );
    ...
    function mint(
        ...
        require(
            ...
            "GSNERC1155Permit: Max supply reached!"
        );
    ...
    function safeTransferFromWithPermit(
        ...
        require(
            ...
            "GSNERC1155Permit: You are not permitted, please check your signature"
        );
    ...
    function safeBatchTransferFrom(
        ...
        require(
            from == _msgSender() || isApprovedForAll(from, _msgSender()),
            "GSNERC1155Permit: transfer caller is not owner nor approved"
        );
    ...
    function _verifySafeTransferFromWithPermit(
        ...
        require(block.timestamp <= deadline, "GSNERC1155Permit: expired deadline");
    ...
    function _safeTransferFrom(
        ...
        require(to != address(0), "GSNERC1155Permit: transfer to the zero address");
        ...
        require(fromBalance >= amount, "GSNERC1155Permit: insufficient balance for transfer");
        unchecked {
    ...
    function _safeBatchTransferFrom(
        ...
        require(ids.length == amounts.length, "GSNERC1155Permit: ids and amounts length mismatch");
        require(to != address(0), "GSNERC1155Permit: transfer to the zero address");
    ...
    function _mint(
        ...
        require(to != address(0), "GSNERC1155Permit: mint to the zero address");
    ...
    function _burn(
        ...
        require(from != address(0), "GSNERC1155Permit: burn from the zero address");
        ...
        uint256 fromBalance = _balances[id][from];
        require(fromBalance >= amount, "GSNERC1155Permit: burn amount exceeds balance");
        unchecked {
            _balances[id][from] = fromBalance - amount;
        }
    ...
    function _setApprovalForAll(
        ...
        require(owner != operator, "GSNERC1155Permit: setting approval status for self");
        ...
        if (to.isContract()) {
            try IERC1155Receiver(to).onERC1155Received(operator, from, id, amount, data) returns (bytes4 response) {
                if (response != IERC1155Receiver.onERC1155Received.selector) {
                    revert("GSNERC1155Permit: ERC1155 rejected tokens");
                }
            } catch Error(string memory reason) {
                revert(reason);
            } catch {
                revert("GSNERC1155Permit: transfer to non ERC1155Receiver implementer");
            }
        }
    }
