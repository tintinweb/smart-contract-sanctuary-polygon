...
contract InitFacet is ERC721AUpgradeable {
    ...
    modifier onlyOwnerCan() {
		if(LibDiamond.contractOwner() != msg.sender) revert AvatarNFT__isNotOwner();
		_;
	}
    ...
    // function awardNFT(address recipient, string memory tokenURI) public returns (uint256) {
