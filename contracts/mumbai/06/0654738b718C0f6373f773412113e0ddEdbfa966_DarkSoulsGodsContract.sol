...
// File: contracts/DarkSoulsGodsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract DarkSoulsGodsContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "DarkSoulsGods";
    string public symbol = "DSG";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/XnDo4I5MIKRiWejPLdQV/contract-metadata";
  }
