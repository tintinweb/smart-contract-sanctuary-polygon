...
contract Staking is Ownable {
    ...
    */
    function startStaking() public onlyOwner {
        require(hasStart == false, "Staking is already running!");
        hasStart = true;
    }
    ...
    */
    function pauseStaking() public onlyOwner {
        require(hasStart == true, "Staking is already paused!");
        hasStart = false;
    }
    ...
    */
    function setDepositLimits(uint256 minimumAmount, uint256 maximumAmount) public {
    ...
    */
    function deposit(uint256 amount, uint256 months) public {
        require(hasStart == true, "Staking is paused right now!");
    ...
    */
    function claimRewards(uint256 id) public {
        ...
        require(wholeMonthsPassed != 0, "Must wait at least a month rewards can be claimed!");
