...
contract XyzStudio is
  ERC721Mintable,
  ERC721Permit("XyzStudio"),
  Ownable,
  ERC721URIStorage
{
  ...
  constructor() ERC721("XyzStudio", "Xyz") {
    setDefaultURI(
      "https://anime-bank.com/api/metadata/?name=xyzstudio&token_id="
    );
...
abstract contract ERC721Mintable is ERC721Enumerable, IERC721Mintable, AccessControl {
    ...
    function mint(address to, uint256 tokenId) virtual override public {
		require(
