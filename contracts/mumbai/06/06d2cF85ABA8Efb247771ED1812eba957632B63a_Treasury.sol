...
contract Treasury is Ownable, ITreasury, CommonModifiers {
    constructor(
        ...
        if(_pusdAddress == address(0)) revert AddressExpected();
        if(_loanAgentAddress == address(0)) revert AddressExpected();
    ...
    function addReserveStablecoin(
        ...
        if(newStableCoin == address(0)) revert AddressExpected();
