...
contract ChainBattles is ERC721URIStorage  {
    ...
    bytes memory svg = abi.encodePacked(
        ...
        '<text x="50%" y="500%" class="base" dominant-baseline="middle" text-anchor="middle">', "Strength:",getStrength(tokenId),'</text>'
        '<text x="50%" y="600%" class="base" dominant-baseline="middle" text-anchor="middle">', "Speed:",getSpeed(tokenId),'</text>'
