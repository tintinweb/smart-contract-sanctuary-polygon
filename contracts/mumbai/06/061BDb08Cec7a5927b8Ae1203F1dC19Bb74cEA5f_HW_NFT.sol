...
contract HW_NFT is ERC721AQueryable, Ownable, ReentrancyGuard {

  using Strings for uint256;

  bytes32 public merkleRoot;

  string public uriPrefix = "ipfs://QmQn5PxgDu93vbp6mA1StK4EB7BMTeThCBdUwKMYTgnDZg/";
  ...
  IERC20 usdtToken = IERC20(0xE097d6B3100777DC31B34dC2c58fB524C2e76921);
  ...
  modifier mintPriceCompliance(uint256 _mintAmount) {
       // Check if user has approved the contract to transfer USDT on their behalf
    uint256 allowance = usdtToken.allowance(msg.sender, address(this));
    require(allowance >= cost * _mintAmount, "USDT allowance not granted");

    // Transfer USDT to the contract as payment for the NFT minting
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    if(!timerExpired()){
        require(IERC721(0x0D32D70730efB5610d7D3BFFfa6E87bA750B8163).balanceOf(msg.sender) >= 1,"Not a Holder :( wait for Public Mint");
    }
     _safeMint(_msgSender(), _mintAmount);
