...
contract RewardDistributor is Initializable, AccessControlUpgradeable, PausableUpgradeable {
    ...
    mapping(address => mapping(address =>bool)) public isDirect;
    ...
    function claimRewards(
        ...
        require(!(_isDirectClaim && isDirect[msg.sender][_token]), "Invalid direct claim");
        ...
        if (_isDirectClaim) {
            isDirect[msg.sender][_token] = true;
