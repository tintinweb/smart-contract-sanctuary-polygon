...
/**
 * Stick Bob is an NFT collection focused on the idea of
 * creating passive opportunity by taking advantage of universal utility.
 * Becoming a Stick Bob grants you access to member only opportunities. 
 */

contract StickBobClub is ERC721Enumerable, Ownable {
    using Strings for uint256;
