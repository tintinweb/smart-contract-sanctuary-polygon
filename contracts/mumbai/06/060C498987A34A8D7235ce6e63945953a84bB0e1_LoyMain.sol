...
// File: solidity/contracts/security/ReentrancyGuard.sol
...
// File: solidity/contracts/utils/Context.sol
...
// File: solidity/contracts/security/Pausable.sol
...
// File: solidity/contracts/access/Ownable.sol
...
abstract contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "ocinto");
        _;
    }
...
// File: solidity/contracts/utils/introspection/IERC165.sol
...
// File: solidity/contracts/token/ERC1155/IERC1155.sol
...
// File: solidity/contracts/token/ERC1155/IERC1155Receiver.sol
...
// File: solidity/contracts/token/ERC1155/extensions/IERC1155MetadataURI.sol
...
// File: solidity/contracts/utils/Address.sol
...
library Address {
    ...
    {
        return functionCall(target, data, "alcf");
    }
    ...
    function functionCallWithValue(
        ...
        require(isContract(target), "actn");
    ...
    function functionStaticCall(
        ...
        require(isContract(target), "asctn");
    ...
    function functionDelegateCall(
        ...
        require(isContract(target), "adctn");
...
// File: solidity/contracts/utils/introspection/ERC165.sol
...
// File: solidity/contracts/token/ERC1155/ERC1155.sol
...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    function balanceOf(address account, uint256 id) public view virtual override returns (uint256) {
        require(account != address(0), "ebqftza");
    ...
    function balanceOfBatch(address[] memory accounts, uint256[] memory ids)
        ...
        returns (uint256[] memory)
    {
        require(accounts.length == ids.length, "eaailm");
    ...
    function setApprovalForAll(address operator, bool approved) public virtual override {
        require(_msgSender() != operator, "esasfs");
    ...
    function _safeTransferFrom(
        ...
        require(fromBalance >= amount, "eibft");
        unchecked {
    ...
    function _safeBatchTransferFrom(
        ...
        require(ids.length == amounts.length, "eiaalm");
        require(to != address(0), "etttza");
    ...
    function _mint(
        ...
        require(account != address(0), "emttza");
    ...
    function _burn(
        ...
        require(account != address(0), "ebftza");
        ...
        require(accountBalance >= amount, "ebaeb");
        unchecked {
...
// File: solidity/contracts/meta-transactions/ContextMixin.sol
...
// File: solidity/contracts/meta-transactions/Initializable.sol
...
// File: solidity/contracts/meta-transactions/EIP712Base.sol
...
// File: solidity/contracts/meta-transactions/NativeMetaTransaction.sol
...
// File: solidity/contracts/ProxyRegistry.sol
...
// File: solidity/contracts/ERC1155Tradable.sol
    ...
    NativeMetaTransaction
{
    ...
    function _burn(
        ...
        require(account != address(0), "ebbfza");
        require(amount > 0, "ebalto");
    ...
    function _burnBatch(
        ...
        require(account != address(0), "ebfza");
        require(
            ids.length == amounts.length,
            "eialm"
        );
...
// File: solidity/contracts/AssetContract.sol
...
// File: solidity/contracts/AssetContractShared.sol
...
// File: solidity/BacktopStore.sol


pragma solidity ^0.8.9;
contract LoyMain is AssetContractShared {
    constructor()
        AssetContractShared(
            "Loy City",
            "LoyMainCity",
