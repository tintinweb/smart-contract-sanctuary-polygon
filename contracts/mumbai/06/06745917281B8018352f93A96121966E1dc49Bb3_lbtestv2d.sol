...
contract lbtestv2d is VRFV2WrapperConsumerBase,ConfirmedOwner,ReentrancyGuard {
   ...
   // Mumbai 0xeeB482F3981D004C6199cA21F331Dc33EE639f0a // Mainnet 0x527a819db1eb0e34426297b03bae11F2f8B3A19E
        ...
        VRFV2WrapperConsumerBase(linkAddress, wrapperAddress) 
    {
        ...
        lottoWeekly = IluckblocksWeekly(0x2E17aa0388b3179Eb654201aE3021f8e827bb72E);
        weeklyContract = 0x2E17aa0388b3179Eb654201aE3021f8e827bb72E;

        lbNodes = IluckblocksNodes(0x222A4303B9c85b71408B44E26D3212ffCbD498ff);
        ...
        require(block.timestamp > lastAutoSpin + 864,"draw timestamp still not reached.");
         ...
         if(getJackpotinUSD() >= minimumPot && registeredsAccts.length >= 25){ 
            ...
            if(lbNodes.getUserActivation(_caller,0) == false){
                ...
                if(block.timestamp > lastAutoSpin + 1164 && reset == false){    // if no node activates in 5 minutes period queue resets
