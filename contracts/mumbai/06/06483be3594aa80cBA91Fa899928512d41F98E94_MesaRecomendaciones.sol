...
contract MesaRecomendaciones {
    ...
    function verRecomendacion(uint256 recomendacionID) public view returns(string memory recomendacion, string memory activo, string memory cliente, uint fecha) {
        ...
        return(recomendacion, activo, cliente, fecha);
    }
}