...
// File: contracts/TrafalgarContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract TrafalgarContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/7SM2kJnL31F7PT0zCPvj/contract-metadata";
  }
