...
import "./interfaces/ILEATHER.sol";

/**
 * @title Leather Token (LEATHER)
 * @author leather.tv
 * @notice The native governance token of the Leather Protocol.
*/
contract LEATHER is ILEATHER, ERC20Permit, Governable {
    ...
    ***************************************/
    ...
    /**
     * @notice Constructs the Leather Token contract.
     * @param _governance The address of the governance.
    */
    // solhint-disable-next-line no-empty-blocks
    constructor(address _governance) ERC20("leather", "LTHR") ERC20Permit("leather") Governable(_governance) { }
    ...
    ***************************************/
    ...
    /**
     * @notice Mints new LTHR token to the receiver account.
     * Can only be called by authorized minters.
     * @param _account The receiver of new tokens.
     * @param _amount The number of new tokens.
     */
    function mint(address _account, uint256 _amount) external override {
        require(isMinter(_account), "!minter");
        _mint(_account, _amount);
    }

    /**
     * @notice Burns LEATHER token from msg.sender.
    ...
    ***************************************/
    ...
    /**
     * @notice Returns true if account is authorized to mint LEATHER token.
     * @param _account Account to query.
     * @return status True if account can mint, false otherwise.
    */
    function isMinter(address _account) public view override returns (bool status) {
        return _minters.contains(_account);
    }
    ...
    */
    function numOfMinters() external override view returns (uint256 count) {
        return _minters.length();
    }

    /**
     * @notice Returns the minter at the given index.
     * @param _index The index to query.
     * @return signer The address of the signer.
    */
    function getSigner(uint256 _index) external override view returns (address signer) {
    ...
    */
    function addMinter(address _minter) external onlyGovernance override {
        require(_minter != address(0x0), "zero address minter");
    ...
    */
    function removeMinter(address _minter) external onlyGovernance override {
 ...
 * @notice The native governance token of the Leather Protocol.
*/
interface ILEATHER is IERC20Metadata {
    ...
    ***************************************/
     ...
     * @return status True if account can mint, false otherwise.
    */
    function isMinter(address _account) external returns (bool status);
    ...
    */
     ...
     * @return signer The address of the signer.
    */
    function getSigner(uint256 _index) external returns (address signer);
