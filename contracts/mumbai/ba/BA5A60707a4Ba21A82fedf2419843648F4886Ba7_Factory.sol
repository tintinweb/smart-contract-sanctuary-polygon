...
import "./UmiverseUser721Token.sol";
...
contract Factory {
    ...
    function deploy(
        ...
        addr = address(
            new UmiverseUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        UmiverseUser721Token token = UmiverseUser721Token(address(addr));
...
contract UmiverseUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
