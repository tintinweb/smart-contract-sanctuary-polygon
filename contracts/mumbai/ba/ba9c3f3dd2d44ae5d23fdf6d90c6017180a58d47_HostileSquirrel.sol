...
contract HostileSquirrel is Context, Ownable, ERC721A, PriceConsumerV3 {
    ...
    // Price of each token
    uint256 public initial_price_fiat = 1000000000000000000;
    uint256 public price_fiat;

    // Maximum limit of tokens that can ever exist
    uint256 public constant MAX_SUPPLY = 3333;
    uint256 public constant MAX_PRESALE_SUPPLY = 500;
    uint256 public constant MAX_MINT_PER_TX = 3333;
    ...
    constructor() ERC721A("Hostile Squirrel", "HS") {
    ...
    // @dev Set a different price in case MATIC FIAT changes drastically
