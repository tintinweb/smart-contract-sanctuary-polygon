...
interface IMVDAOUpgradeable is IERC20Upgradeable, IERC165Upgradeable {
    /**
    ...
    UUPSUpgradeable
{
    ...
    function initialize(address _treasury) external initializer {
        require(_treasury != address(0), "MVDAO: invalid address");
        __ERC20_init("Test Token", "MVD");
        ...
        returns (bool)
    {
        return interfaceId == type(IERC20Upgradeable).interfaceId ||
            interfaceId == type(IMVDAOUpgradeable).interfaceId ||
