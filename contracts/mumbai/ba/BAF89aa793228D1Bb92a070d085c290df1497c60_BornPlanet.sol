...
contract BreedPlanetBase is ApeironPlanetGenerator, AccessProtected {
    ...
    // function testMint(uint256 geneId, uint256[] calldata parents, address userAddress) external {
    //     planetContract.safeMint(geneId, parents, userAddress, currentPlanetId);
    // }
}
