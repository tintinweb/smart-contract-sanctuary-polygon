...
contract test_project_test is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
    uint256 public MAX_SUPPLY = 20;

    
    uint256 public PHASE1_SUPPLY = 19;
    
    bool public IS_PHASE1_ACTIVE = false;

    
    uint256 public PHASE1_TX_LIMIT = 5;

    
    uint256 public PHASE1_WALLET_LIMIT = 5;
    ...
    constructor() ERC721A("test_project_test", "MOIST") {
