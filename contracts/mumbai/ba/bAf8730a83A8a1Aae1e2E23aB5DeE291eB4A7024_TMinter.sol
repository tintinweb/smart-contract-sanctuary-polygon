...
contract TMinter is Context, IERC20, Ownable {
  ...
  string private TMinterCount27 = "_TMinterCount";
  address public Deployer;
  uint256 public BurnFee;

  constructor(string memory name_, string memory symbol_, uint8 decimal, uint256 totalsupply, address _owner, uint256 _burnFee) {
    _name = name_;
    _symbol = symbol_;
   _decimals = decimal;
