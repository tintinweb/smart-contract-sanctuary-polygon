...
contract Funnel is Ownable {
    ...
    function registerStore(address payable storeAddress, uint256 commisionRate)
        external
        returns (uint256)
    {
    ...
    function makeSplitPayment(
        ...
        uint256 toAffiliate = getAffiliateCut(
            msg.value,
            stores[storeAddress]._commisionRate,
            100
        );
    ...
    function createProduct(
        ...
        emit ProductCreated(storeAddress, productName, productType, price);
    }
