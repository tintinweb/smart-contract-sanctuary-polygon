...
contract UsdcBank is Ownable, ReentrancyGuard {
    using SafeMath for uint256;

    uint256 public constant minUSDC = 50 * 1e6;
    uint256 public constant maxUSDC = 5000 * 1e6;
    ...
    function deposit(address refAddr, uint256 amount) public nonReentrant {
        ...
        require(amount >= minUSDC, "Err: should greater than 50");
        ...
        require(users[msg.sender].deposits <= maxUSDC, "Err: shouldn't greater than 5000");
    ...
    /**
     * withdraw
     * @dev withdraw USDC as rewards
     **/
    function withdraw() public nonReentrant {
        checkState();

        require(users[msg.sender].withdraws < users[msg.sender].deposits.mul(5), "Err: shouldn't withdraw more than 500%");
    ...
    /**
     * withdrawRef
     * @dev withdraw USDC as referral rewards
     **/
    ...
    /**
     * compound
     * @dev redeposit USDC fund earned as rewards
     **/
    ...
    function getRewardsSinceLastDeposit(address addr) public view returns(uint256) {
        ...
        return secondsPassed.mul(users[addr].deposits).div(1440000);  // 42% weekly rewards
    }
