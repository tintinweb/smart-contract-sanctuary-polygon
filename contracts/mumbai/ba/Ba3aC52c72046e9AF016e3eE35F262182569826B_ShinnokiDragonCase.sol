...
contract ShinnokiDragonCase is TwoStage, ERC721ABurnableUpgradeable {
  ...
  function initialize(
    ...
    __ERC721A_init("ShinnokiDragonCase", "ShinnokiDragonCase");
    __Ownable_init();
    __AdminManager_init_unchained();
    ...
    setPrice(uint8(Stage.Whitelist), 0.05 ether);
