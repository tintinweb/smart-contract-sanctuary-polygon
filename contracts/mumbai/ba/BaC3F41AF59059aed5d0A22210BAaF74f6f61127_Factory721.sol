...
import "./MetaMorphisUserToken721.sol";
...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new MetaMorphisUserToken721{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        MetaMorphisUserToken721 token = MetaMorphisUserToken721(address(addr));
...
contract MetaMorphisUserToken721 is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
