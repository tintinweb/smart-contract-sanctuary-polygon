...
contract KOKODI is ERC721A, Ownable {
    ...
    uint constant public MAX_SUPPLY = 60;
    ...
    uint public presaleStartTimestamp = 1643628900;
    uint public publicSaleStartTimestamp = 1643629200;
    ...
    address public proxyRegistryAddress = 0xb5c64B6BdA4d6f71BC5D167f1356e4e50ef9c21C;
    ...
    function withdraw() external onlyOwner {
        ...
        payable(0xC844476D47E6661fadBd5E905a053D3B6BBce763).transfer(balance * 75 / 1000);
        payable(0x39f527e945ac1c2f74dC5d049e1f67848652e7e7).transfer(balance * 75 / 1000);
        // alpha mint
        payable(0x021E23CC1CC5dE3338E0639BBaDFd61035b9F3dF).transfer(balance * 7 / 100);
        ...
        payable(0xD31aE467026815b0b8f520E764215c64c3FD0A41).transfer(balance * 65 / 100);
    }
