...
contract Finde {
    ...
    // votes to indexs and uris
    mapping(uint256 => uint256[]) public upVoteToIndexs; // upVote => [indexs]
    ...
    function addURI(
        ...
        if (addressToIndex[msg.sender] == 0) {
            ...
            // add to country uris
            countryToUris[indexToProvider[addressToIndex[msg.sender]].country]
                .push(_uri);
        }
