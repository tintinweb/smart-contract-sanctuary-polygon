...
contract MetadataParcel is ERC721URIStorage, OnChainMetadata {
    ...
    string public image;
    constructor(string memory name, string memory symbol, string memory _image, string memory _imageContract) ERC721(name, symbol) {
        ...
        _addValue(_contractMetadata, key_contract_image, abi.encode(insertImageURI(_imageContract)));
    ...
    /* Insert Blockchain */
    function insertBlockchainURI(string memory _blockchain) public pure returns (string memory) {
        string memory insertBlockchain = _blockchain;
        return string(abi.encodePacked(insertBlockchain));
    }

    /* Insert Metaverse Type */
    function insertMetaverseTypeURI(string memory _metaverseType) public pure returns (string memory) {
        string memory insertMetaverseType = _metaverseType;
        return string(abi.encodePacked(insertMetaverseType));
    }

    /* Insert Metaverse Size */
    function insertMetaverseSizeURI(string memory _metaverseSize) public pure returns (string memory) {
        string memory insertMetaverseSize = _metaverseSize;
        return string(abi.encodePacked(insertMetaverseSize));
    }
    ...
    function formatTokenURI(string memory nameURI, string memory descURI, string memory blockchainURI, string memory typeURI, string memory sizeURI, string memory imageURI) public pure returns (string memory)
    {
    ...
    /* Mints the token */
    function mintNftParcel(string memory _blockchain, string memory _type, string memory _size) public {
        string memory nameURI = insertNameURI("NFT Parcel");
        string memory descURI = insertDescURI("Testing NFT Parcel metadata to test on-chain and svg image");
        string memory blockchainURI = insertBlockchainURI(_blockchain);
        string memory typeURI = insertMetaverseTypeURI(_type);
        string memory sizeURI = insertMetaverseSizeURI(_size);
        string memory imageURI = insertImageURI(image);
        string memory tokenURI = formatTokenURI(nameURI, descURI, blockchainURI, typeURI, sizeURI, imageURI);
