...
contract HousePool
{
    ...
    function Transfer(uint _amount)public noReentrancy isGranted  
    {
        ...
        require(_amount <= maxProfit,"The amount should not be greater than maxprofit");
    ...
    function emergencyWithdrawwithSpecifiedAmount(address  _recipient,uint _amount) external onlyOwner{
        require(_recipient != address(0));
        require(_amount >0,"The specified amount needs to be greater than zero");
        require(address(this).balance >= _amount,"The amount specified is out of balance");
