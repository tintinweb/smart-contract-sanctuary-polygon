...
contract ERC721OnChainMetadata is ERC721, OnChainMetadata {
    ...
    function setTeamTraits() private {
        _setValue(
            ...
            abi.encode("sweetman.eth")
        );
        _setValue(1, key_token_attributes_trait_value, abi.encode("host"));
        _setValue(1, key_token_attributes_display_type, abi.encode(""));
        _setValue(
            1,
            key_token_attributes_trait_type,
            abi.encode("Dwight Torculus")
        );
        _setValue(1, key_token_attributes_trait_value, abi.encode("CEO"));
        _setValue(1, key_token_attributes_display_type, abi.encode(""));
        _setValue(
            1,
            key_token_attributes_trait_type,
            abi.encode("Garrett Hughes")
        );
        _setValue(1, key_token_attributes_trait_value, abi.encode("CTO"));
        _setValue(1, key_token_attributes_display_type, abi.encode(""));
        _setValue(1, key_token_attributes_trait_type, abi.encode("cxy.eth"));
        _setValue(1, key_token_attributes_trait_value, abi.encode("collector"));
        _setValue(1, key_token_attributes_display_type, abi.encode(""));
    }
