...
contract TestDesktopMU is ERC721, Ownable, ERC2981, DefaultOperatorFilterer, ContextMixin, RoyaltiesV2Impl { 
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual onlyOwner override(ERC721, ERC2981) returns (bool) {
    ...
    function setRoyaltyRariableMintable(uint _tokenId, address payable _receiverRoyalty, uint96 _royaltyFeesInBips) external onlyOwner { 
        LibPart.Part[] memory _royalties = new LibPart.Part[](1);
    ...
    function burnAreaTokenAtOnce(uint256 _areaStart, uint256 _areaEnd) public onlyOwner {
        require(!paused, "The contract is paused!");
    ...
    function burnSingleForMint(uint256 _burnTokenId, uint256 _mintTokenId) public virtual onlyOwner {
        require(!paused, "The contract is paused!");
