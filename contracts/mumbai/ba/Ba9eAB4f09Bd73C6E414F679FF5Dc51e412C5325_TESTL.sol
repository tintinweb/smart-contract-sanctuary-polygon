...
contract TESTL is ERC2981, ERC721Enumerable, Ownable, Pausable {
    using Strings for uint;
    IPaperKeyManager paperKeyManager;

    IERC20 public constant USDC = IERC20(0xe6b8a5CF854791412c1f6EFC7CAf629f5Df1c747); // 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174

    uint256 public immutable price = 10000 gwei; //0.01
    uint256 public immutable MAX_SUPPLY = 10;
    ...
    modifier mintCompliant(
        ...
        require(amountPerWallet[_recipient] + _quantity <= 3, "MINT:You already purchased this pass 3 times!");
    ...
    function getClaimIneligibilityReason(
        ...
        if ( totalSupply() + _quantity > MAX_SUPPLY ) {
            ...
            return "Invalid quantity, you can only buy 3 passes";
        } else if (amountPerWallet[_recipient] + _quantity > MAX_MINT_AMOUNT) {
            return "You can only buy 3 passes!";
        } else if ( paused() ) {
