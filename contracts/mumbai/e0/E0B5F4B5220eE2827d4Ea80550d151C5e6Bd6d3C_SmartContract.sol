...
contract SmartContract is ERC721A, ERC2981, Ownable, ReentrancyGuard {
  ...
  string constant _name = 'Smart Contract';
  string constant _symbol = 'SC';
  string constant baseUri = 'ipfs://xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx';
  string constant uriSuffix = '.json';
  string constant contractUri = 'ipfs://xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx/collection.json';
  string constant hiddenMetadataUri = 'ipfs://xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx/hidden.json';

  uint256 immutable mintPrice = 0.001 ether;
  uint256 immutable maxSupply = 1000;
  uint256 immutable maxMintAmountPerTx = 10;
  uint256 immutable maxMintAmountPerWallet = 10;
