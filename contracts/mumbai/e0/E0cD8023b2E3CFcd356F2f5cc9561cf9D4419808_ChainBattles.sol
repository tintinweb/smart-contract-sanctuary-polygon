...
contract ChainBattles is ERC721URIStorage  {
    ...
    function getCharacterValues(uint256 tokenId) public view returns (
        uint256 speed, 
        uint256 strenght,
        uint256 life) {
            speed = tokenIdToCharacter[tokenId].speed;
            strenght = tokenIdToCharacter[tokenId].strenght;
            life = tokenIdToCharacter[tokenId].life;
        }
    ...
    function mint() public {
        ...
        tokenIdToCharacter[newItemId].strenght = 0;
     ...
     function train(uint256 tokenId) public {
        ...
        if(tmp == 0) {
            ...
            tokenIdToCharacter[tokenId].strenght += 1;
        }
        else {
            tokenIdToCharacter[tokenId].life += 1;
        }
