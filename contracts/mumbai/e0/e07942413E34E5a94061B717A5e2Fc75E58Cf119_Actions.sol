...
interface GamesInterface {
    ...
    function extApplyEffect(uint _playerId, uint _gameId, uint _eventId, uint _effectNumb) external;
}
...
contract Actions is Ownable {
        ...
        ) public payable
    {
        ...
        if (_action == BCTypes.Action.PASS) {
            ...
            games.extApplyEffect(_playerId, _gameId, currentRoom.eventNum, 0);
        } else {
