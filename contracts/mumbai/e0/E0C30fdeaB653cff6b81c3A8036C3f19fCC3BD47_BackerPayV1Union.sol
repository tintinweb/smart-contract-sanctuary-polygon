...
contract BackerPayV1Union is IBackerPayV1Union {
    ...
    function createPayment(
        ...
        uint256 _paymentId = union.allPaymentsLength++;
    ...
    function paymentToken(
        ...
        emit Ledger(paymentId, tokenAddr, msg.sender, union.ownerAcct, amount, commission);
    ...
    function ownerWithdraw(address tokenAddr) external onlyOwnerOper {
        uint256 subBalance;
        for (uint256 i = 0; i < union.allPaymentsLength; i++) {
