...
function whiteListAddress(address _voterAddress, string memory _name, uint _aadarNum ) public {
        ...
        Voter memory voter = Voter({registered: true, voted: false,name: _name,aadarNum:_aadarNum, giveVote:0x0000000000000000000000000000000000000000});

          aadartocandidates[_aadarNum]=_voterAddress;
    ...
    function putVote(address _candidateAddress) public {
        ...
        voterList[msg.sender].giveVote = _candidateAddress;
    ...
    function removeVoter(address _VoterAddress) public {
        require(
            voterList[_VoterAddress].registered == true,
            "Voter not registered"
        );
   ...
   function showVoterInfo () public view  returns ( Voter memory)
   {
require(votingStarted==false,"  After voting stop");
    return  voterList[msg.sender];
