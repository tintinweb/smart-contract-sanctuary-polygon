...
contract BlueBird is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable {
    ...
    function mintFromMatic() external payable checkBalance(address(msg.sender).balance,msg.value){
        ...
        if(minter4minted["ecosystem"]*1e18+ mintPrice/1e18 > minter4amount["ecosystem"]*1e18){
        ...
        minter4minted["ecosystem"] = minter4minted["ecosystem"]+mintPrice/1e18;
        _mint(msg.sender, value);
        emit mintFromMaticEvent(msg.sender, mintPrice/1e18, mintPrice);
    }
