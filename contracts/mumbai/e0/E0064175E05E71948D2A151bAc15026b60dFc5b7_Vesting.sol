...
contract Vesting is ReentrancyGuard, Ownable  {
    ...
    // Deposit/Timelock specific amount after which will be added to beneficiary address
    ...
    // Withdraw function to be called by beneficiary //Frontend
    ...
    function getLatestBeneficiaryId(address beneficiary) public view returns(uint) {
        uint[] memory ids = getBeneficiaryIds(beneficiary);
