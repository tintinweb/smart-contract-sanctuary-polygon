...
contract FayreMarketplaceCore is FayreMultichainBaseUpgradable {
    ...
    */
    ...
    event SaleIsPending(uint256 indexed saleId, TradeRequest tradeRequest, address buyer, uint256 price, uint256 timestamp, uint256 blockNumber);
    ...
    event FreeOfferIsPending(uint256 indexed bidId, TradeRequest tradeRequest, address seller, uint256 timestamp, uint256 blockNumber);
    ...
    function finalizeSale(uint256 saleId) external {
        ...
        emit SaleIsPending(saleId, saleTradeRequest, buyer, price, block.timestamp, block.number);
    }
    ...
    function acceptFreeOffer(uint256 bidId) external {
        ...
        emit FreeOfferIsPending(bidId, bidTradeRequest, _msgSender(), block.timestamp, block.number);
    }
