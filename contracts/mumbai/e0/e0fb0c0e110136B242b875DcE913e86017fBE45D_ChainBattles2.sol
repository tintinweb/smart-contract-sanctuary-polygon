...
contract ChainBattles2 is ERC721URIStorage {
    ...
    function getSpeed(uint256 tokenId) public view returns (string memory) {
        uint256 Speed = tokenIdToLevels[tokenId].Level;
        return Speed.toString();
    }

    function getStrength(uint256 tokenId) public view returns (string memory) {
        uint256 Strength = tokenIdToLevels[tokenId].Level;
        return Strength.toString();
    }

    function getLife(uint256 tokenId) public view returns (string memory) {
        uint256 Life = tokenIdToLevels[tokenId].Level;
...
function mint() public {
    ...
    tokenIdToLevels[newItemId] = Levels(random(50), random(50), random(50), random(50));
