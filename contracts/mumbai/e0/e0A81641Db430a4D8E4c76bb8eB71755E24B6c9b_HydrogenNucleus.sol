...
interface IERC3156FlashBorrower {
     ...
     * @param data Arbitrary data structure, intended to contain user-defined parameters.
     * @return magicValue The keccak256 hash of "ERC3156FlashBorrower.onFlashLoan".
     */
...
interface IERC2612Permitter {
     ...
     * @param s secp256k1 signature
     */
    function erc2612Permit(address token, uint256 amount, uint256 deadline, uint8 v, bytes32 r, bytes32 s) external;
     ...
     * @param signature secp256k1 signature
     */
    function erc2612Permit(address token, uint256 amount, uint256 deadline, bytes calldata signature) external;
     ...
     * @param s secp256k1 signature
     */
    function erc2612Permit(address token, uint256 nonce, uint256 expiry, bool allowed, uint8 v, bytes32 r, bytes32 s) external;
}
