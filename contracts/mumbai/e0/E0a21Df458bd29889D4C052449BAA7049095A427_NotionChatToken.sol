...
* 
* Smart conntract to grant access to notion chat with the condition that they have to pay a minimum of $0.01 to mint the NFT. 
...
contract NotionChatToken is ERC721Base {
   ...
   */
   ...
   /**
    * @dev createToken mint the ERC721 Token / NFT with the check that the user has paid minimum
    */
  function createToken() public payable
   {
       ...
       string memory tokenURI = "https://ipfs.io/ipfs/QmPVzn4XdD7PduvnpLQMdLaysCs3NZr3Kx9UhbrFVG56p1";
