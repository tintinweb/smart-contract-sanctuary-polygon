...
// File: contracts/helpers/Types.sol
...
// File: contracts/helpers/AutomateReady.sol
...
// File: contracts/helpers/AutomateTaskCreator.sol
...
contract Betting is Ownable, RrpRequesterV0, AutomateTaskCreator {
    ...
    function getHouseHand(bytes calldata randomNumber) internal pure returns(uint8 houseHand){
        houseHand = uint8((abi.decode(randomNumber, (uint256))) % 5);
    }

    function setWinner(bytes32 requestId) internal returns(bool success, string memory winner){
