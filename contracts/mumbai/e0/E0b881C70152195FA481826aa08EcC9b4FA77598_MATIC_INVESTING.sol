...
contract MATIC_INVESTING {
    ...
    uint40 public TIME_STEP = 1 minutes;//24 hours;
    uint8 public Daily_ROI = 10;
    uint8 public MAX_ROI = 50;
    uint256 public MIN_INVESTMENT = 0.01 ether;
    uint256 public MIN_WITHDRAW = 0.05 ether;
    uint256 public MIN_REINVESTMENT = 0.01 ether;//100 ether;
    uint256 public REFERRAL_STEP = 2;//10;
    uint256 public REGISTRATION_BONUS = 0.01 ether;
    ...
    function reinvest() external{ 
        ...
        require(amount >= MIN_REINVESTMENT, "Minimum deposit amount is 0.05 trx");
