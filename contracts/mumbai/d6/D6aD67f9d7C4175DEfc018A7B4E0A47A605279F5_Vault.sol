    ...
    Initializable
{
    ...
    // basis odds
    uint256 public constant BASIS_ODDS = 1000;
    // jackpot odds
    uint8 public constant JACKPOT_ODDS = 5;
    // big consolation odds
    uint8 public constant BIG_CONSOLATION_ODDS = 10;
    // medium consolation odds
    uint8 public constant MEDIUM_CONSOLATION_ODDS = 30;

    // jackpot percentage (prize pool)
    uint256 public constant JACKPOT_PCT = 5000;
    // medium consolation percentage (price)
    uint256 public constant BIG_CONSOLATION_PCT = 8000;
    // medium consolation percentage (price)
    uint256 public constant MEDIUM_CONSOLATION_PCT = 5000;
    // small consolation percentage (price)
    uint256 public constant SMALL_CONSOLATION_PCT = 2000;
    ...
    // events
    event ValueAddedToPrizePool(uint8 id, address currency, uint256 value);
    event LowPrizePoolBalance(uint8 id, address currency);
    event FeeCharged(
        uint8 id,
        address digger,
        address currency,
    ...
    event Jackpot(uint8 id, address digger, address currency, uint256 amount);
    ...
    event Donation(address from, address currency, uint256 amount);
    event Withdrawal(
        address from,
        address to,
        address currency,
