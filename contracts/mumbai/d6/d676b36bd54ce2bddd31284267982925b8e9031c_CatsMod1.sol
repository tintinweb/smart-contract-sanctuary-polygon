...
// File: contracts/ICatsDescriptor.sol
...
contract CatsMod1 is ERC721Enumerable, Ownable {
    event SeedUpdated(uint256 indexed tokenId, uint256 seed);

    mapping(uint256 => uint256) internal seeds;
    ICatsDescriptor public descriptor;
    uint256 public maxSupply = 10000;
    bool public minting = false;
    bool public canUpdateSeed = true;

    constructor(ICatsDescriptor newDescriptor) ERC721("CatsMod1", "MOD1") {
    ...
    function setDescriptor(ICatsDescriptor newDescriptor) external onlyOwner {
        descriptor = newDescriptor;
    }
