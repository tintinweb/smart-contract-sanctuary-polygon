...
contract Leveler is ILeveler, Ownable {
    ...
    event LevelPriceChange(uint256 id, uint256 price);

    event IdPriceChange(uint256 id, uint256 price);
    ...
    function setPriceById(uint256 _tokenId, uint256 _price) external onlyOwner {
        ...
        emit IdPriceChange(_tokenId, _price);
    }
        ...
        onlyOwner
    {
        ...
        emit LevelPriceChange(_levelId, _price);
    }
