...
import {MINTER_ROLE, HEALTH_TRAIT_ID, CURRENT_HEALTH_TRAIT_ID} from "../Constants.sol";
...
// Time limit for Boss battles
// uint32 constant BOSS_BATTLE_COOLDOWN_TIME = 12 hours;
uint32 constant BOSS_BATTLE_COOLDOWN_TIME = 2 minutes;

// Time limit for active Boss battle to complete
// uint32 constant BOSS_BATTLE_TIME_LIMIT = 10 minutes;
uint32 constant BOSS_BATTLE_TIME_LIMIT = 2 minutes;
