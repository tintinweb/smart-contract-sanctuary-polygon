    ...
    function tokenMetadata(uint256 tokenId, bool isDwarf, uint8[15] calldata traitarray) public view returns (string memory) {
        ...
        string memory metadata = string(
            abi.encodePacked(
                ...
                isDwarf ? "Dwarf #" : "Troll #",
                tokenId.toString(),
                '", "description": "Dwarfs are working for the prosperity of their people. But the harmful trolls dont mind getting their share. No IPFS. No API. All stored and generated 100% on-chain", "image": "data:image/svg+xml;base64,',
                base64(bytes(svg)),
                '", "attributes":',
