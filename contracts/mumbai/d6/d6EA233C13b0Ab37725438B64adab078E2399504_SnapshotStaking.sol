...
contract SnapshotStaking is ISnapshotStaking, Ownable, ReentrancyGuard
{
    ...
    function getUserUnlocks(uint pid) public view override  returns (uint[] memory)
    {
        return userInfo[pid][msg.sender].timestamps;
    }

    function getUserUnlockAmount(uint pid, uint timestamp) public view override returns (uint)
    {
