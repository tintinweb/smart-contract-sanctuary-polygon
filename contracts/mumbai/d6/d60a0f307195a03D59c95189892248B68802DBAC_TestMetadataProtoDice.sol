...
contract TestMetadataProtoDice is ERC721URIStorage, Ownable {
  ...
  constructor() ERC721("TestNftFixAndFlex", "TNFT") {
    ...
    uint8 newRarity = 0;
    string memory _tokenURI = "ipfs://QmdCGcMUwNYfEdujmfnMk5xhRm3VADFGqbbKphZ1hTgnnJ/00_protodice_common.json";
    ...
    newRarity = 1;
    _tokenURI = "ipfs://QmdCGcMUwNYfEdujmfnMk5xhRm3VADFGqbbKphZ1hTgnnJ/01_protodice_rare.json";
    _safeMint(msg.sender, newCharID);
    _setTokenURI(newCharID, _tokenURI);
    newChar = TestChar(
      newCharID,
    ...
    newCharID = _tokenIds.current();
    newRarity = 2;
    _tokenURI = "ipfs://QmdCGcMUwNYfEdujmfnMk5xhRm3VADFGqbbKphZ1hTgnnJ/02_protodice_epic.json";
    _safeMint(msg.sender, newCharID);
    _setTokenURI(newCharID, _tokenURI);
    newChar = TestChar(
      newCharID,
    ...
    newCharID = _tokenIds.current();
    newRarity = 3;
    _tokenURI = "ipfs://QmdCGcMUwNYfEdujmfnMk5xhRm3VADFGqbbKphZ1hTgnnJ/03_protodice_myth.json";
    _safeMint(msg.sender, newCharID);
    _setTokenURI(newCharID, _tokenURI);
    newChar = TestChar(
      newCharID,
    ...
    newCharID = _tokenIds.current();
    newRarity = 4;
    _tokenURI = "ipfs://QmdCGcMUwNYfEdujmfnMk5xhRm3VADFGqbbKphZ1hTgnnJ/04_protodice_legendary.json";
    _safeMint(msg.sender, newCharID);
    _setTokenURI(newCharID, _tokenURI);
    newChar = TestChar(
      newCharID,
  ...
  function contractURI() public pure returns (string memory) {
        return "ipfs://QmdCGcMUwNYfEdujmfnMk5xhRm3VADFGqbbKphZ1hTgnnJ/protodice.json";
  }
    ...
    mintCompliance()
  {
    ...
    { // Common
      newRarity = 0;
      _tokenURI = "ipfs://QmdCGcMUwNYfEdujmfnMk5xhRm3VADFGqbbKphZ1hTgnnJ/00_protodice_common.json";
      _safeMint(msg.sender, newCharID);
      _setTokenURI(newCharID, _tokenURI);
    }
