    ...
    CarbonOffsetBatchesStorage
{
    ...
    function updateStatus(uint256 tokenId, BatchStatus newStatus)
        internal
        virtual
    {
    ...
    function confirmBatch(uint256 tokenId)
        external
        virtual
        onlyVerifier
        whenNotPaused
    ...
    function _confirmBatch(uint256 _tokenId) internal {
        ...
        require(
            nftList[_tokenId].status != BatchStatus.Confirmed,
        ...
        updateStatus(_tokenId, BatchStatus.Confirmed);
    }
        ...
        whenNotPaused
    {
        ...
        updateStatus(tokenId, BatchStatus.Rejected);
    }
        ...
        whenNotPaused
    {
        ...
        updateStatus(tokenId, BatchStatus.Pending);
    }
    ...
    function confirmBatchWithVintage(
        ...
        require(
            ...
            'Vintage is already set and cannot be changed; use confirmBatch instead'
        );
        _linkWithVintage(tokenId, projectVintageTokenId);
        _confirmBatch(tokenId);
    }
    ...
    function tokenize(
        ...
        address tco2 = _getTCO2ForBatchTokenId(tokenId);
        require(tco2 != address(0), 'TCO2 not found');
        string memory registry = IToucanCarbonOffsets(tco2).standardRegistry();
        require(supportedRegistries[registry], 'Unsupported registry');
        ...
        require(amount != 0, 'No TCO2 minted');
