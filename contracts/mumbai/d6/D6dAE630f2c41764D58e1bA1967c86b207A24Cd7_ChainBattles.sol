...
// Deployed to Mumbai Poygon Testnet at 0xcCdB27F5B297e8De580ccf21F8883fF9C60F5074
...
contract ChainBattles is ERC721URIStorage  {
    ...
    function generateCharacter(uint256 tokenId) public view returns (string memory) {
        bytes memory svg = abi.encodePacked(
            ...
            "<text x='50%' y='80%' class='base' dominant-baseline='middle' text-anchor='middle'>Life:",getLife(tokenId)," km/h</text>",
            "</svg>"
        );
        return string(
            abi.encodePacked(
    ...
    function train(uint256 tokenId) public {
        ...
        track = Track(current.id, current.level+1, current.speed+5, current.strength+10, current.life+25);
