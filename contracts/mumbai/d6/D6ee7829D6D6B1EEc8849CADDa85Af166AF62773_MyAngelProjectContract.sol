...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x76713821424e866b365Be8512B47f0A16F85d3b4];
...
// File: contracts/MyAngelProjectContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract MyAngelProjectContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "My Angel Project";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/wv0fZ1fa2kO5ZgGI1Kwx/contract-metadata";
  }
