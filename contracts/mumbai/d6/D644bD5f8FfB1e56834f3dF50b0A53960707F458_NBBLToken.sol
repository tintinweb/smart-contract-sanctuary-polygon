...
import "./../types/NBBLAccessControlled.sol";

contract NBBLToken is INBBL, ERC20, NBBLAccessControlled {
    using SafeMath for uint256;

    constructor(address _authority)
        ERC20("NBBL_TOKEN", "NBBL", 18)
        NBBLAccessControlled(INBBLAuthority(_authority))
    {}
