...
function mintNFT(string memory _tokenURI) public returns (uint256) {
  uint256 newItemId = _tokenIds.current() + 1; // Increment the token ID and assign it to newItemId

  require(!isMinted[newItemId], "NFT has already been minted"); // Check if NFT has already been minted
