...
contract MockERC20 is ERC20,
    ...
    constructor (string memory _name, string memory _symbol) ERC20(_name, _symbol) EIP712MetaTransaction(_name, "1") {}

    function mint(address to, uint256 amount) public {
        require(_msgSender() == owner() || _msgSender() == minter, "not allowed to mint");
        _mint(to, amount);
    }
    ...
    **/
    ...
    /**
    * @dev Emulate USDT Polygon that has sepErator instead of sepArator
    **/
