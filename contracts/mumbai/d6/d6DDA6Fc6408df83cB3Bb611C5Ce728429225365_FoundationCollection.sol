   ...
   uint256 max = 4294967296;
    ...
    for(uint i = 0; i < _amount; i++) {
      ...
      while(max_ind>min_ind+1){
        ...
        if(randomNumber < getNLQty(av_ind)){
          min_ind=av_ind;
        }else{
          max_ind=av_ind;
        }
...
function calculateBuyback(uint160[] calldata _tokenIds) public view returns (uint256 floorValue, uint256 bonusEarned, uint256 buyback, bool allAces) {
  ...
  for(uint8 i = 1; i < payoutDeck.length; i++) {
    ...
    for(uint8 i=0;i<13;i++){
      ...
      buyback = (win_value * (buyBackValue / 10**10 ) * 10**10 ) / 10**8;
...
function forceRemoveCommit(address _address) external onlyRole(SUPPORT) {
 ...
 /**
  ...
  function getNLQty(uint8 _index) public view returns(uint64){
        require(_index >=0 && _index <=52, "wrong _index");
        if(_index == 0)return 0;
        if(_index == 1)return 4294967296;
        if(_index == 2)return 3601900746;
        if(_index == 3)return 2908834196;
        if(_index == 4)return 2215767646;
        if(_index == 5)return 1522701096;
        if(_index == 6)return 1291678912;
        if(_index == 7)return 1060656728;
        if(_index == 8)return 829634544;
        if(_index == 9)return 598612360;
        if(_index == 10)return 506203487;
        if(_index == 11)return 413794614;
        if(_index == 12)return 321385741;
        if(_index == 13)return 228976868;
        if(_index == 14)return 192013318;
        if(_index == 15)return 155049768;
        if(_index == 16)return 118086218;
        if(_index == 17)return 81122668;
        if(_index == 18)return 68801485;
        if(_index == 19)return 56480302;
        if(_index == 20)return 44159119;
        if(_index == 21)return 31837936;
        if(_index == 22)return 26909463;
        if(_index == 23)return 21980990;
        if(_index == 24)return 17052517;
        if(_index == 25)return 12124044;
        if(_index == 26)return 10152655;
        if(_index == 27)return 8181266;
        if(_index == 28)return 6209877;
        if(_index == 29)return 4238488;
        if(_index == 30)return 3581358;
        if(_index == 31)return 2924228;
        if(_index == 32)return 2267098;
        if(_index == 33)return 1609968;
        if(_index == 34)return 1347116;
        if(_index == 35)return 1084264;
        if(_index == 36)return 821412;
        if(_index == 37)return 558560;
        if(_index == 38)return 453419;
        if(_index == 39)return 348278;
        if(_index == 40)return 243137;
        if(_index == 41)return 137996;
        if(_index == 42)return 111711;
        if(_index == 43)return 85426;
        if(_index == 44)return 59141;
        if(_index == 45)return 32856;
        if(_index == 46)return 26285;
        if(_index == 47)return 19714;
        if(_index == 48)return 13143;
        if(_index == 49)return 6572;
        if(_index == 50)return 4929;
        if(_index == 51)return 3286;
        if(_index == 52)return 1643;
    }
