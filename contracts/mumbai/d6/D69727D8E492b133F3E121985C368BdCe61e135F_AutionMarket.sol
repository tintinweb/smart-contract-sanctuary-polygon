...
contract AutionMarket is ERC721Holder, Ownable, ReentrancyGuard {
    ...
    event AutionCancel(address indexed collection, address indexed seller, uint256 indexed tokenId);
    event Trade(
        address indexed collection, 
        uint256 indexed tokenId, 
        address indexed seller,
    ...
    function createAution(
        ...
        emit AutionNew(_collection, msg.sender, _tokenId, _startPrice, _endPrice, _duration, block.timestamp);
    }
    ...
    function cancelAution(address _collection, uint256 _tokenId) external nonReentrant {
        ...
        emit AutionCancel(_collection, msg.sender, _tokenId);
    ...
    function bid(address _collection, uint256 _tokenId) external payable nonReentrant {
        ...
        emit Trade(_collection, _tokenId, aution.seller, msg.sender, _price, netPrice);
    }
