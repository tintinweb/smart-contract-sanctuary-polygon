...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xC37B229107A12aBdCc47b26c3B2696cD8f8678Eb];
  address public erc20Payable = 0xC37B229107A12aBdCc47b26c3B2696cD8f8678Eb;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "https://ipfs.io/ipfs/QmY1wYqwXEBU3MHVURAfnkh5Ujhcf1cGqt3xqS6zRoFxjX/";
...
contract TestProjectContract is RamppERC721A {
    constructor() RamppERC721A("Test Project", "MTEST"){}
}
