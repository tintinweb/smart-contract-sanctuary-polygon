...
//    function setOptionManager(address _manager, bool _isManager) external;
...
//    function directPoolDeposit(address _token) external;
    ...
    function optionPoolDeposit(address _token) external;
    function optionPoolWithdraw(address _token, address _to, uint256 _amount) external;
...
interface IDlpManager {
    function dlp() external view returns (address);
    function usdg() external view returns (address);
