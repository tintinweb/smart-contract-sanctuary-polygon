...
contract UniqPaymentProxyV3 is Ownable, EIP712, ERC1155Holder, IERC721Receiver {
    ...
    IUniqRedeemV2 public redeem;

    // ----- CONSTRUCTOR ----- //
    constructor(uint256 _pnetworkId, address _signer, address _redeem) EIP712("Uniqly", "1") {
        _networkId = _pnetworkId;
        signer = _signer;
        redeem = IUniqRedeemV2(_redeem);
    }
    ...
    function _processERC721(ERC721TokenData[] memory erc721Tokens) internal {
        ...
        if (erc721Tokens[0].toBurn == RedeemTypes.RedeemOnly) {
            ...
            _redeemTokens(erc721Tokens[0].tokenAddress, ids, purposes);
            return;
        }
