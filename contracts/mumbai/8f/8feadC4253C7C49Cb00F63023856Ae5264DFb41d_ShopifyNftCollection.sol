...
contract ShopifyNftCollection is ERC1155, Ownable, ERC1155Metadata_URI {
    ...
    constructor(string memory contractUri, string memory baseUri, address manager) public {
    ...
    modifier ownerOrManager() {
        require(isOwner() || (msg.sender == _manager && _manager != address(0)));
        _;
    }
    ...
    function createBulk(uint256 _tokensCount) ownerOrManager
        external
