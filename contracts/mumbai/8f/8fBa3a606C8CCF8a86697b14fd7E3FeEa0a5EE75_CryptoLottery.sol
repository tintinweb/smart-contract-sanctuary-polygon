...
contract CryptoLottery is CrowdSale, Lending {
    ...
    */
    ...
    uint private constant _ico_price = 20000000000000; // one token price
    uint private constant _ico_soft_cap = 100000 * 10 ** 18;
    uint private constant _interval = 86400;
    uint private constant _ticket_p = 1 * 10 ** 18;
...
contract Lending is Events {
    ...
    uint256 public percentDay = 40; //0.04%
    ...
    function changePercentDay(uint256 _percentDay) external _onlyOwner {
