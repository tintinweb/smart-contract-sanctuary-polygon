...
contract NoLaughTime is Ownable, ERC721A, DefaultOperatorFilterer {
  ...
  uint256 public  MAX_REROLLS = 200;
  uint256 public  MAX_REROLLS_COLOR = 500;
  uint256 public  LIMIT_MINT_TRANSACTION = 10;
  uint256 public  REROLL_PRICE = 0.008 ether;
  uint256 public  REROLL_COLOR_PRICE = 0.004 ether;
  uint256 public  Mint_Price = 0.0038 ether;
  uint256 public  Free_Public = 3;
  ...
  //Withdraw address
  address t1 = 0x0d6ae715f24679B06a20e03cA635b467dEd1159f; //
  ...
  constructor(InterfaceDescriptor descriptor_) ERC721A("NoLaughTime", unicode"Ⓐ") {
...
function trait4getTraits(uint256 tokenId) internal view returns (uint16[] memory){
 ...
 //return Man
        ...
        abi.encodePacked(
          ...
          base64(
            abi.encodePacked(
              ...
              '", "description": "NoLaugh will live forever through the Ethereum blockchain and remain happy and free.", "traits": [',
              properties,
  ...
  function Reroll(uint256 _tokenId) external payable {
    ...
    CountSellForCity[_tokenId] = uint256(0);
  }
