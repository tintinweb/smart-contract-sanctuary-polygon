...
// File: contracts/Kiliki/kilikiNFT.sol
...
interface NinfyDropsInterface {
    ...
    function reserve(uint256 _amount , address _wallet ) external;
...
contract KilikiClubNFT is NinfyDropsInterface, ERC721, Ownable {
    ...
    function reserve(uint256 _amount , address _wallet) external onlyOwner override {
 ...
 function _reservemint(uint256 _amount , address _wallet) internal {
    ...
    function freeMint(uint256 _amount) external payable override {
        ...
        require(totalSupply.add(_amount) <= 500, "Not more free tokens left. Max 500");
