...
contract BSG is Ownable {
    ...
    function deposit(address referrer, uint256 _amount) external {
        ...
        require(!safeguard && !isContract(msg.sender),"Wrong");
    ...
    function updatedData(address[2] memory _feeReceivers, uint256 _depositFee, uint256 _tradingSplit, uint256 _level4royalty, uint256 _level4allow, uint256 _level5royalty, uint256 _level5allow, uint256 _widthfeePercents) external onlyOwner returns(bool)
    {
