...
contract ChainBattles is ERC721URIStorage {
        ...
        returns (string memory)
    {
        ...
        bytes memory svg = abi.encodePacked(
            ...
            "<style>.base { fill: white; font-family: serif; font-size: 14px; } .base.life { fill: #00DD00; }</style>",
            ...
            "</text>",
            '<text x="50%" y="60%" class="base life" fill= dominant-baseline="middle" text-anchor="middle">',
            "Life: ",
