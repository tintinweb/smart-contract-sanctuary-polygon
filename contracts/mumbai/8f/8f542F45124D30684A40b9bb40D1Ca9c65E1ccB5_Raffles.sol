...
contract Raffles is Ownable {
    ...
    bytes32 private KEY = 0x6e75b569a01ef56d18cab6a8e71e6600d6ce853834d4a5748b720d06f878b3a4;
    uint256 private FEE = 0.0001 * 10 ** 18;
    ...
    function i_raffle(uint256 index) private view returns (Raffle) {
        require(_raffles.length != 0 && index < _raffles.length, "No such raffle");
        return Raffle(address(_raffles[index]));
    }
    ...
    function setEntries(uint256 index, address[] memory addresses) public onlyOwner {
        return i_raffle(index).setEntries(addresses);
    }
