...
contract JustPool is ERC20Upgradeable, OwnableUpgradeable, AccessControlUpgradeable {
    ...
    modifier onlyRoll() {
        require(msg.sender == roll);
        _;
    }

    function setRoll(address newRoll) public onlyOwner {
        roll = newRoll;
    }
    ...
    function getReward(uint256 amount, address winner) public onlyRoll {
        payable(winner).transfer(amount);
    }

    constructor(address roll_) {
        roll = roll_;
    }
