  ...
  */
  ...
  abstract contract Allowlist is Ownable {
        ...
        Allowlist
    {
        ...
        string private IPFSTokenURI = "ipfs://QmUnaDjuEpVJ9wzuenowTvHabLmuyWjNGsHXYBNFY5Yq1s/";
        ...
        constructor(
            ...
            payableAddresses.push(0x24344575810583417E128FC09Cc1cEa43F11559c);
    ...
    // File: contracts/deadTurtleSocietyContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract DeadTurtleSocietyContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Dead Turtle Society", "DTS", _proxyRegistryAddress)
        {}

        

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/unqX68uE1hSTxQHZ9wFx/contract-metadata";
        }
    }