    ...
    Ownable
{
    ...
    uint256 public MAX_MINT_TEAM = 50;
    ...
    function mintTo(address _to) public onlyOwner whenNotPaused {
    ...
    {
        if (_msgSender() != owner()) {
            require(value >= (option * _price), "amount is not correct");
        }
        return true;
    }
...
// File contracts/interfaces/IFactoryERC721.sol
