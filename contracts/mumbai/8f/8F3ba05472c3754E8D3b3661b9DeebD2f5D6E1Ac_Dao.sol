...
contract Dao {
    ...
    constructor(){
        ...
        validTokens = [13017907643376218452231581139665914764793622937529787987480258660811430428673]; // this helps determine owner of the contract listing the first minted nft in the collection
    }
