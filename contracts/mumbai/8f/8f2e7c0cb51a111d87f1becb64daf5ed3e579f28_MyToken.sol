...
contract MyToken is ERC1155 {
    uint256 public constant SADPUNK = 1;

    constructor() ERC1155("https://gateway.pinata.cloud/ipfs/QmQcsmTUt82itZP22zShEC16xJctL5rnpR341UaoBCmGSu/{id}.json") {
        _mint(msg.sender, SADPUNK, 10, "");
    }

    function uri(uint256 _tokenid) override public pure returns (string memory) {
        return string(
            abi.encodePacked(
                "https://gateway.pinata.cloud/ipfs/QmQcsmTUt82itZP22zShEC16xJctL5rnpR341UaoBCmGSu/",
