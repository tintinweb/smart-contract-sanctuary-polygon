...
contract PremiumChallenge is ReentrancyGuard {
    ...
    // join to challenge
    function join() external payable nonReentrant senderIsAddress challengeStateIsValidForJoin participantNotJoined {
        ...
        emit PrizeRewardChanged(_platformTokenAddress, prizePool[_platformTokenAddress]);
    }
