...
// contract deployed to 0x982221A7A9B5DD97905634B1d31496eB323bAf4f
...
contract ChainBattles is ERC721URIStorage {
    ...
    function mint() public {
        ...
        tokenIdtoLevels[newItemId].speed = uint(keccak256(abi.encodePacked(block.timestamp,block.difficulty,  
        msg.sender))) % 100;
        tokenIdtoLevels[newItemId].strength = uint(keccak256(abi.encodePacked(block.timestamp,block.difficulty,  
        msg.sender))) % 100;
        tokenIdtoLevels[newItemId].life = uint(keccak256(abi.encodePacked(block.timestamp,block.difficulty,  
        msg.sender))) % 100;
