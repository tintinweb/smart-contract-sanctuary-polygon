...
contract SwapTest is Ownable, Pausable {
    IERC20 public USDC;
	MintableContract public USDV;
	...
	function buy(uint256 amount) public whenNotPaused onlyWhitelisted(msg.sender) {
