 ...
 * @notice This contract handles minting Test show tokens.
 */
contract TestShow is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x172fE4Ea342E881ea14124daC5925313de0F7b99;
    ...
    address public royaltyAddress = 0x9850bD25e57a1bb1E895833FE44fE4D913d01CCD;
    address[] public payoutAddresses = [
        0x9850bD25e57a1bb1E895833FE44fE4D913d01CCD
    ];
    ...
    constructor(uint256 _heymintFeePerToken, address _crossmintAddress)
        ERC1155(
            "ipfs://bafybeiclcox3tboh3kinw6a6srdmva53xhicpib5egx5jafmnrdnf7o524/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenPublicPrice[1] = 0.00777 ether;
        tokenPublicMintsPerAddress[1] = 1;
        tokenPublicSaleStartTime[1] = 1685451600;
        tokenPublicSaleEndTime[1] = 1685462400;
        tokenUsePublicSaleTimes[1] = true;
        tokenPresaleMaxSupply[1] = 10000;
        tokenPresalePrice[1] = 0 ether;
        tokenPresaleMintsPerAddress[1] = 1;
        tokenPresaleSaleStartTime[1] = 1685397600;
        tokenPresaleSaleEndTime[1] = 1685444401;
