...
// File: contracts/bladersRaffle.sol


pragma solidity >=0.8.0 <0.9.0;


contract bladersRaffle is AccessControl, ReentrancyGuard, VRFConsumerBaseV2, ConfirmedOwner {
    ...
    function entry(uint64 _raffleId, uint16 _qty, address _receiptAddress, uint256 _price) internal {
        ...
        if (_price != uint256(raffle.price) * _qty * 1e12) revert("Incorrect amount");
