    ...
    Ownable
{
    ...
    */
    ...
    onlyOpenCase(escrowId)
    {
        ...
        uint256 nftId1 = NFTContract.mintEscrowNft(
            ...
            escrowId,
            true,
            "this should be a url to metadata"
        );
    ...
    */
    ...
    onlyParticipatingParty(escrowId)
    {
        ...
        transferFundsToParty(escrowAssetsA[escrowId], NFTContract.ownerOf(escrows[escrowId].nftA));
        transferFundsToParty(escrowAssetsB[escrowId], NFTContract.ownerOf(escrows[escrowId].nftB));
    ...
    */
    ...
    onlyCaseResolver(escrowId)
    {
        ...
        if (partyAWon) {
            transferFundsToParty(assetsA, NFTContract.ownerOf(escrows[escrowId].nftA));
            transferFundsToParty(assetsB, NFTContract.ownerOf(escrows[escrowId].nftA));
        } else {
            transferFundsToParty(assetsA, NFTContract.ownerOf(escrows[escrowId].nftB));
            transferFundsToParty(assetsB, NFTContract.ownerOf(escrows[escrowId].nftB));
        }
        escrows[escrowId].closed = true;
