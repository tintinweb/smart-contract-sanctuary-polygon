 ...
 * @notice This contract handles minting Oska test collection Mystery Box tokens.
 */
contract OskaTestCollectionMysteryBox is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    string public baseTokenURI =
        "ipfs://bafybeid2ygmfj25wxdcwxavhwcep5lpb2sl5hzcs6dxhrlcfqmeofkohha/";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC721A("Oska test collection Mystery Box", "OTCMB")
        RevokableOperatorFilterer(
