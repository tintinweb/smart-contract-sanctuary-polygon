...
contract OnDripDL is ERC721, ERC2981, ERC721URIStorage, AccessControlEnumerable {
    ...
    uint96 royaltyFeeBips = 2; //Only Platform Can Set Roylaties Vendor Cannot
...
contract OnDripFactory {
    ...
    function createDLCollection(
        ...
        OnDripDL dlAddress = new OnDripDL(_name, _symbol, _platformAddress, _vendorAddress, _nftMarketPlace);
