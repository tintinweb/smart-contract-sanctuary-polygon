...
contract SuckySucky is Ownable, ERC721A, PaymentSplitter, DefaultOperatorFilterer, ERC721AQueryable {
    ...
    constructor(address[] memory _team, uint[] memory _teamShares, string memory _baseURI) ERC721A("SUCKY SUCKY", "10BUCKY")
