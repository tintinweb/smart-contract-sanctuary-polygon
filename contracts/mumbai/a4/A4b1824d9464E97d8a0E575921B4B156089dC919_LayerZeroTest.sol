...
// File: contracts/layer zero/layer-zero.sol
...
contract LayerZeroTest is NonblockingLzApp {
    ...
    constructor(address _lzEndpoint) NonblockingLzApp(_lzEndpoint) {
       if (_lzEndpoint == 0xf69186dfBa60DdB133E91E9A4B5673624293d8F8) destChainId = 10112;
       if (_lzEndpoint == 0x7dcAD72640F835B0FA36EFD3D6d3ec902C7E5acf) destChainId = 10109;
    }
    ...
    function send(address[] memory _addresses,uint[] memory _ids) public payable {
