...
contract CedarERC721DropFactory is Ownable, ICedarDeployerEventsV4, ICedarImplementationVersionedV0 {
    ...
    constructor(address _greenlistManagerAddress) {
        ...
        emit CedarImplementationDeployed(address(implementation), major, minor, patch, "ICedarERC721DropV2");
    }
...
import "../generated/impl/BaseCedarERC721DropV2.sol";
    ...
    BaseCedarERC721DropV2
{
    ...
    function tokenURI(uint256 _tokenId) public view override(ERC721Upgradeable, ICedarNFTMetadataV0) returns (string memory) {
...
// Filename: './BaseCedarERC721DropV2.sol'
...
abstract contract BaseCedarERC721DropV2 is ICedarERC721DropV2 {
    function supportedFeatures() override public pure returns (string[] memory features) {
        ...
        features[9] = "metadata/ICedarNFTMetadata.sol:ICedarNFTMetadataV0";
