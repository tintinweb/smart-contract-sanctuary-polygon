...
contract SimpleNftLowerGas is ERC721, Ownable {
 ...
 Building[] public buildings;
  ...
  constructor() ERC721("NehaVerse", "NV") {
    ...
    buildings.push(Building("Library",1,6,2,10,0,0));
    buildings.push(Building("Cool House",1,1,2,7,0,-7));
    buildings.push(Building("Shop",2,3,1,-9,0,-9));
    buildings.push(Building("Gym",1,3,3,-4,0,2));
    buildings.push(Building("Pet Shop",2,5,2,-2,0,5));
    buildings.push(Building("Ray Shop",2,6,1,-10,0,4));
    buildings.push(Building("Office",4,1,4,5,0,0));
    buildings.push(Building("Hospital",3,1,3,-4,0,-5));
    buildings.push(Building("Ghost House",2,2,3,-10,0,0));
    buildings.push(Building("beach house",3,2,2,-3,0,-2));
  }
