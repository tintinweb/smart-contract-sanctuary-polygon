    ...
    function getTokenURI(uint256 tokenId) public view returns (string memory){
        bytes memory dataURI = abi.encodePacked(
            '{',
                ...
                '"attributes":',
                    ' "0": "trait_type": "Program", "value": "Function"',
                    ' "1": "trait_type": "Function", "value": "Signature and Verification"',
                    ' "2": "trait_type": "Token standard", "value": "ERC721"',
                    ' "3": "trait_type": "Support level", "value": "', getLevel(tokenId), '"',
            '}'
        );
        return string(
            abi.encodePacked(
