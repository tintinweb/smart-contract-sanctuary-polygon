...
contract BoleroPaymentSplitter {
    ...
    modifier onlyManagement() {
        require(
            msg.sender == bolero.management() || msg.sender == multisigWallet,
     ...
     *******************************************************************************/
    function setMultisigWallet(address _multisigWallet) public onlyManagement {
    ...
    function addPayee(
        ...
        require(
            _totalShares + shares_ <= 10000,
            "PaymentSplitter: Maximum percentage reached, please reorganize shares!"
        );
        console.log("The new shares will be ", _totalShares);
