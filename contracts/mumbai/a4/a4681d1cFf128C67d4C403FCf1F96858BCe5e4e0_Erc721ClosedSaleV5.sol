...
abstract contract Erc721SaleV5 is AccessControlV5, ERC721, ERC721Royalty, ERC721Pausable {
  ...
  function updateRoleRoyaltyPayout(
    ...
    //  Update Roles first, and then verify MultiSig. This ensures :
    //  - that current Msg Signers cannot be removed in the same Msg.
    //  - that the Signer threshold is not compromised.
