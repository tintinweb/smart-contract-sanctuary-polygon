...
contract SC2 is Ownable, OverflowToken, IAxelarExecutable {
    ...
    function sellOrderForEABCD_Bridge(uint amount, uint256 balance, string memory destinationChain, address walletAddress) public payable{
        ...
        IBEP20(_BUSDADDRESS).transferFrom(msg.sender, address(this), BUSD_For_eABCD);
