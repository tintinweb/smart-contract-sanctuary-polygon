...
contract Crolio {
    ...
    event InvestedInBucket(uint256 indexed bucketId, uint256 amountInvested, address indexed investorAddress, address[] tokens, uint256[] holdingsBought);
    event WithdrawnFromBucket(uint256 indexed bucketId, uint256 amountOut, address indexed investorAddress, address[] tokens, uint256[] holdingsSold);
