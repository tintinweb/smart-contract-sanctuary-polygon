    ...
    RetirementCertificatesStorage
{
    ...
    function registerEvent(
        ...
        uint256 retiredCO2inKg = amount / 1e15;
        require(retiredCO2inKg != 0, 'Less than a kilo');
        ...
        retirements[eventCounter].retiredCO2inKg = retiredCO2inKg;
    ...
    /// @dev The return amount is denominated in kilos, no decimals included as in TCO2s.
    /// For example, 100 means 100 kilos.
        ...
        returns (uint256 amount)
    {
        ...
        for (uint256 i; i < eventIds.length; ++i) {
            amount += retirements[eventIds[i]].retiredCO2inKg;
        }
    }
}
...
contract RetirementCertificatesStorage {
    struct Data {
