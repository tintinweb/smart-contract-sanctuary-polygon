...
contract MyNft is ERC721, Ownable, ERC2981 {
    ...
    address[] public withdrawAddresses = [0x8a6EaBB88b1C038bf88307dDD450B3d6cA343aEe, 0xa5693946e3B46f83A61B8Ab8868A04fE4150fE04];
    uint256[] public withdrawPercentages = [20, 80];


    bytes32 public merkleRoot = 0;

    constructor() ERC721("T1", "ABCDE") {
        _baseTokenURI = "https://api.nftool.io/generator-server/api/contract/v1/kYloXbyuGtdoLAGX1/1611198336678588418/metadata/";
