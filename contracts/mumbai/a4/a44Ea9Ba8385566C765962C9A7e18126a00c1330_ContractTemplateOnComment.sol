...
//コントラクト名をプロジェクト名に変更=================================
contract ContractTemplateOnComment is ERC721A, ERC2981, Ownable {
//==================================================================

    //下記を任意の直に置き換えてください========================================================================================
    address internal constant SERVICE_OWNER = 0x0000000000000000000000000000000000000000; //手数料を受け取るウォレットのアドレス
    uint96 internal constant SERVICE_FEE_RATIO = 5; //手数料%
    //===================================================================================================
    ...
    constructor(
        ...
        //[Start]プレセールでallowListを使用する場合のみインクルード================================
        address[] memory allowList
        //[End]プレセールでallowListを使用する場合のみインクルード================================
    ) ERC721A(name, symbol) {
    ...
    */
    function mint(uint256 quantity) external payable {
        ...
        if (mintQuantities[msg.sender] + quantity > _publicPerWalletMaximum) revert InvalidQuantity();
        if (quantity > _publicPerTransactionMaximum) revert InvalidQuantity();
    ...
    */
    ...
    //[Start]プレセールを行う場合のみインクルード==================================================================
    uint256 internal constant _presaleSupply = 1000; //プレセールの販売個数
    uint256 internal _preSalePrice = 0.1 ether; //プレセールの販売価格
    uint256 internal _prePerWalletMaximum = 5; //プレセールのウォレットあたりの購入上限
    uint256 internal _prePerTransactionMaximum = 3; //プレセールの1購入あたりの購入上限
    ...
    */
    function presale(
        ...
        if (mintQuantities[msg.sender] + quantity > _prePerWalletMaximum) revert InvalidQuantity();
        if (quantity > _prePerTransactionMaximum) revert InvalidQuantity();
    ...
    */
    ...
    //[Start]バーン可能にする場合のみこの関数を追加==================================================================
    /**
    * @notice Burn your own NFT
    * @param tokenId NFT token Id
    */
    function burn(uint256 tokenId) external {
        _burn(tokenId, true);
    }
    //[End]バーン可能にする場合のみこの関数を追加==================================================================
}
...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _checkContractOnERC721Received(
        ...
        return false; //Don't go through here
    }
