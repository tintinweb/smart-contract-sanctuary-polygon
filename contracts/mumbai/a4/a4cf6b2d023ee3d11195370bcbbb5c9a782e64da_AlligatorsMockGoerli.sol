...
contract Alligators is
    ...
    */
    ...
    function merge3alligators(uint256 _1st, uint256 _2nd, uint256 _3rd, address merger) external {
        ...
        bool state = _mergeAlligators(_1st, _2nd, _3rd, merger);
        require(state,"Fail");
    }
    ...
    function mergeWjoker(uint256 _1st, uint256 _2nd, uint256 _3rd, address merger) external {
        ...
        if (ownerOf(_1st) != merger || ownerOf(_2nd) != merger || ownerOf(_3rd) != merger) revert callErr();
        bool state = _mergeWjoker(_1st, _2nd, _3rd, merger);
        require(state, "Fail");
    }
    ...
    */
    ...
    function _mergeAlligators(uint256 _1st, uint256 _2nd, uint256 _3rd, address merger) internal returns (bool state) {
    ...
    function _mergeWjoker(uint256 _1st, uint256 _2nd, uint256 _3rd, address merger) internal returns (bool state) {
