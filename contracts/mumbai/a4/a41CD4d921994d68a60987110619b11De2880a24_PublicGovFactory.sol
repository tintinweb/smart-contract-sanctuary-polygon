...
contract PublicGovFactory is
     ...
     * @param _saleGateway Cross chain manager address
     ...
     */
    function config(address _saleGateway, address _savior, address _keeper, address _operational, address _marketing, address _treasury) external override onlyOwner{
        require(_saleGateway != address(0) && _savior != address(0) && _keeper != address(0) &&_operational != address(0) && _marketing != address(0) && _treasury != address(0), "bad");
