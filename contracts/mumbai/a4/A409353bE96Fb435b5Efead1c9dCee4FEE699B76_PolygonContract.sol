    ...
    
{
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/Vqf8DvZjfF7xgId8p6X7/contract-metadata";
  }
...
// File: contracts/PolygonContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PolygonContract is RamppERC721A {
    constructor() RamppERC721A("Polygon", "test"){}
}
