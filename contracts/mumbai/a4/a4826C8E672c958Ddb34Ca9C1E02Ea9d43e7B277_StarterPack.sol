...
contract StarterPack is AccessControlEnumerable, Ownable, ReentrancyGuard {
    // ONLY ALLOW BUSD
    using SafeERC20 for ERC20;
    ERC20 public BUSD;
    FEN public FENToken;
    FootEarn public FactoryNFT;
    ...
    uint256 public totalUserPackSold = 0;

    uint256 public totalGuildPack;
    uint256 public totalGuildPackSold = 0;
    ...
    function userPack() public checkSaleRequirements {
        ...
        BUSD.safeTransferFrom(_msgSender(), address(this), pricePack);
        ...
        checkSalePremiumRequirements()
    {
        ...
        totalGuildPackSold++;
        poolUser[_msgSender()] += (pricePack * 60) / 100;
        FENToken.mint(_msgSender(), ((pricePack * 40) / 100) / 10 ** BUSD.decimals() * privateSalePrice);
        emit BuyGuildPack(
            nonce - 1,
            (nonce - 1) * 10,
            nonce * 10 - 1,
