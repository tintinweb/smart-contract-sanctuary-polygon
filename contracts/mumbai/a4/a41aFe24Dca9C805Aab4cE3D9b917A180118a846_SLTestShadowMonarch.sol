...
interface ISLShadowMonarch {
     ...
     *  Base
     */
    function setOfferingContract(address _offeringContract) external;
    ...
    ShadowMonarchError
{
    ...
    address internal offeringContract;
    ...
    UUPSUpgradeable
{
    ...
    modifier onlyOfferingContract() {
        _onlyOfferingContract();
        _;
    }

    function _onlyOfferingContract() private view {
        if (_msgSender() != offeringContract) {
    ...
    function mint(address _to, uint256 _amount) external onlyOfferingContract {
        _mints(_to, _amount);
    }
