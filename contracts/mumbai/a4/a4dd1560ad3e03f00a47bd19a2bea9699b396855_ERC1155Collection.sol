    ...
    ReentrancyGuard
{
    ...
    // NFT collection custodian
    address public custodian;

    // TODO: Add functions for the following variables
    // Mint limit per transaction
    uint256 public MAX_TX_MINT = 10000;

    // Unique MINTER_ROLE hash
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    // Unique MAINTAINER_ROLE hash
    ...
    function mintBatch(
        ...
        require(
            count <= MAX_TX_MINT,
            "ERC1155Collection: exceeds max mint limit per transaction"
        );

        _mintBatch(custodian, ids, amounts, "");
