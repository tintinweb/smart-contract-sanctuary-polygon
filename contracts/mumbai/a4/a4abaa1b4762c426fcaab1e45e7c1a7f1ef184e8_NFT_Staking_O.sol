...
// File: contracts/rabochi_staking_kontrakt.sol
...
contract NFT_Staking_O is Ownable, ReentrancyGuard, Pausable {
...
function calculateRewards(address _stakerAddress) private view returns (uint256) {
    ...
    uint256 minutesElapsed = timeSinceLastUpdate / SECONDS_IN_MINUTE;
