...
contract FutToken is ERC20, ERC20Burnable, ERC20Permit {
    ...
    constructor(uint256 _startingDate, address _privateSale, address _publicSale, address _stakingRewards, address _gamingIssuance, address _soccerClubs, address _futsterTeam, address _preLaunchTeam, address _advisors) ERC20("Fut Token", "FUT") ERC20Permit("Fut Token") {
