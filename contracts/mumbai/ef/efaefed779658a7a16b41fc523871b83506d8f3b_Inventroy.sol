...
contract Inventroy {
    ...
    function addAndUpdateMaterial(
        ...
        Types.Item memory newRawMaterial = Types.Item({
            ...
            Price: _price,
            IsAdded: true,
            itemState: Types.State.ProduceByProducer,
            PrebookCount: 0
        });
    ...
    // fetch all the added Inventory materials function with modifieds as well.
        ...
        returns (Types.Item memory)
    {
     ...
     // @Manufacturer can update and Add Products
    function addAndUpdateProduct(
        ...
        Types.manfItem memory manufProduct_ = Types.manfItem({
            ...
            prebookCount: 0,
            itemState: Types.State.ManufacturedByManufacturer
        });
        ...
        emit ManufacturedProductAdded(
            ...
            _availableDate,
            _expiryDate,
            Types.State.ManufacturedByManufacturer
            );
        }
    }
