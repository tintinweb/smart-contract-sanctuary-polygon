...
contract SFUSDStake is Ownable {
    ...
    function deposit(uint256 _amount) external {
        ...
        if (investors[msg.sender].totalRewardAmount >= _amount) {
            ...
            investors[msg.sender].pocketInvestment = _amount.sub(depositFee).sub(investors[msg.sender].totalRewardAmount);
        }
    ...
    function migrateInvestorToV2(
        ...
        if (investors[_investor].totalRewardAmount >= _amount) {
            ...
            investors[_investor].pocketInvestment = _amount.sub(investors[_investor].totalRewardAmount);
        }
    ...
    function removeInvestor(address _investor) public onlyAdmin{
        ...
        capitalLockedPool = capitalLockedPool.sub(totalAmountLocked);
