...
contract GeniosClub is IGeniosClub {
  ...
  struct G3X2 {
    address CurrentRef;
    uint256 FirstTotalTeam;
    uint256 SecondTotalTeam;
  ...
  struct G3X7 {
    ...
    uint256 FirstTotalTeam;
    uint256 SecondTotalTeam;
    uint256 ThirdTotalTeam;
    uint256 FourthTotalTeam;
    uint256 FifthTotalTeam;
    uint256 SixthTotalTeam;
    uint256 SeventhTotalTeam;
    address[] FirstLevelRefs;
    address[] SecondLevelRefs;
  ...
  struct Plat {
    ...
    uint256 TotalParticipantsEarnings;
  }
  ...
  function _buyNewLevelG3X2(address userAddr, uint8 level) internal {
    ...
    address freeG3X2Ref = findFreeG3X2Referrer(userAddr, level);
    updateG3X2Referrer(userAddr, freeG3X2Ref, level);
    emit Upgrade(userAddr, freeG3X2Ref, 1, level);
  }
  ...
  function _buyNewLevelG3X7(address userAddr, uint8 level) internal {
    ...
    address freeG3X7Referrer = findFreeG3X7Referrer(userAddr, level);
    updateG3X7Referrer(userAddr, freeG3X7Referrer, level);
    emit Upgrade(userAddr, freeG3X7Referrer, 1, level);
  }
  ...
  function updateG3X2Referrer(
    ...
    if (Users[refAddr].G3X2Matrix[level].FirstLevelRefs.length < 3) {
      ...
      Users[refAddr].G3X2Matrix[level].FirstTotalTeam++;
      ...
      Users[ref].G3X2Matrix[level].SecondTotalTeam++;
    ...
    Users[refAddr].G3X2Matrix[level].SecondTotalTeam++;
  ...
  function updateG3X2RefSecondLevel(
    ...
    if (refAddr != Id1) {
      ...
      emit Reinvest(refAddr, freeRefAddr, userAddr, 1, level);

      updateG3X2Referrer(refAddr, freeRefAddr, level);
    } else {
      emit Reinvest(Id1, address(0), userAddr, 1, level);
  ...
  function updateG3X7Referrer(
    ...
    if (
      ...
      emit RankEarners(refAddr, level);
    }
    ...
    if (Users[refAddr].G3X7Matrix[level].FirstLevelRefs.length < 3) {
      ...
      Users[refAddr].G3X7Matrix[level].FirstTotalTeam++;
      ...
      Users[ref_currentRef].G3X7Matrix[level].SecondTotalTeam++;
      ...
      Users[userAddr].G3X7Matrix[level].CurrentRef = refAddr;
      Users[refAddr].G3X7Matrix[level].SecondTotalTeam++;
      ...
      Users[ref_currentRef].G3X7Matrix[level].ThirdTotalTeam++;
      ...
      Users[userAddr].G3X7Matrix[level].CurrentRef = refAddr;
      Users[refAddr].G3X7Matrix[level].ThirdTotalTeam++;
      ...
      Users[ref_currentRef].G3X7Matrix[level].FourthTotalTeam++;
      ...
      Users[userAddr].G3X7Matrix[level].CurrentRef = refAddr;
      Users[refAddr].G3X7Matrix[level].FourthTotalTeam++;
      ...
      Users[ref_currentRef].G3X7Matrix[level].FifthTotalTeam++;
      ...
      Users[userAddr].G3X7Matrix[level].CurrentRef = refAddr;
      Users[refAddr].G3X7Matrix[level].FifthTotalTeam++;
      ...
      Users[ref_currentRef].G3X7Matrix[level].SixthTotalTeam++;
      ...
      Users[userAddr].G3X7Matrix[level].CurrentRef = refAddr;
      Users[refAddr].G3X7Matrix[level].SixthTotalTeam++;
      ...
      Users[ref_currentRef].G3X7Matrix[level].SeventhTotalTeam++;
    ...
    Users[refAddr].G3X7Matrix[level].SeventhTotalTeam++;
  ...
  function sendTokenDividends(
    ...
    if (matrix == 1) {
      ...
      Users[userAddr].G3X2Earnings += amount;
      Users[userAddr].TotalEarnings += amount;

      Platform.G3X2TotalEarnings += amount;
      Platform.TotalParticipantsEarnings += amount;
      ...
      for (uint8 i = 1; i <= 7; i++) {
        ...
        Users[userAddr].G3X7Earnings += amount;
        Users[userAddr].TotalEarnings += amount;
  ...
  function usersG3X2Matrix(
    ...
    return
      G3X2({
        ...
        FirstTotalTeam: Users[userAddr].G3X2Matrix[level].FirstTotalTeam,
        SecondTotalTeam: Users[userAddr].G3X2Matrix[level].SecondTotalTeam,
  ...
  function usersG3X7Matrix(
    ...
    return
      G3X7({
        ...
        FirstTotalTeam: Users[userAddr].G3X7Matrix[level].FirstTotalTeam,
        SecondTotalTeam: Users[userAddr].G3X7Matrix[level].SecondTotalTeam,
        ThirdTotalTeam: Users[userAddr].G3X7Matrix[level].ThirdTotalTeam,
        FourthTotalTeam: Users[userAddr].G3X7Matrix[level].FourthTotalTeam,
        FifthTotalTeam: Users[userAddr].G3X7Matrix[level].FifthTotalTeam,
        SixthTotalTeam: Users[userAddr].G3X7Matrix[level].SixthTotalTeam,
        SeventhTotalTeam: Users[userAddr].G3X7Matrix[level].SeventhTotalTeam,
...
interface IGeniosClub {
  ...
  event RankEarners(address indexed user, uint8 indexed level);
}
