 ...
 * @notice This contract handles minting my very cool and epic nft project tokens.
 */
contract MyVeryCoolAndEpicNftProject is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address public royaltyAddress = 0x41d89C1e3c2DDFDCd63e1A5B85880C8c24E818D6;
    address[] public payoutAddresses = [
        0x41d89C1e3c2DDFDCd63e1A5B85880C8c24E818D6
    ];
    ...
    constructor(address _crossmintAddress)
        ERC721A("my very cool and epic nft project", "EPIC")
        RevokableOperatorFilterer(
