    ...
    OwnableUpgradeable
{
    ...
    * 2 for Line => 5 numbers and reward = 5x the amount bet
    ...
    */
    ...
    function _safeStartRound(uint256 epoch) internal virtual{
        ...
        require(
            rounds[epoch - 1].endTime != 0 && block.timestamp >= (rounds[epoch - 1].endTime),
            "Roulette: Round n-1 not ended"
        );
        require(
            block.timestamp >= (rounds[epoch - 1].endTime).add(startBuffer),
