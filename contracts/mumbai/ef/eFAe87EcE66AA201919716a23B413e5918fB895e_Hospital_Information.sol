 ...
 */
    ...
    _setupRole(DEFAULT_ADMIN_ROLE, msg.sender); // Set the deployer as the initial admin
 ...
 */    
    ...
    function updateHospitalInfo(
       string memory _name,
        ...
        hospitals[_address].name =  _name;
        hospitals[_address].hospitalAddress = _address;
        hospitals[_address].contactInfo = _contactInfo;
        hospitals[_address].facilitiesAndServices = _facilitiesAndServices;
