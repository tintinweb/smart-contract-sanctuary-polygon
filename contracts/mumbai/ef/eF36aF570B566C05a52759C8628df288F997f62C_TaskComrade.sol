...
/**
 * @title TaskComrade for registering taskers and collect registration fees
 * @author Shivali Sharma @ EthOnline 2022 
 **/

contract TaskComrade {
    ...
    function register() public payable returns (uint _registrationId){
