...
//   ____     ____    U  ___ u   ____    U _____ u ____     
//  / __"| uU|  _"\ u  \/"_ \/U |  _"\ u \| ___"|// __"| u  
// <\___ \/ \| |_) |/  | | | | \| |_) |/  |  _|" <\___ \/   
//  u___) |  |  __/.-,_| |_| |  |  _ <    | |___  u___) |   
//  |____/>> |_|    \_)-\___/   |_| \_\   |_____| |____/>>  
//   )(  (__)||>>_       \\     //   \\_  <<   >>  )(  (__) 
//  (__)    (__)__)     (__)   (__)  (__)(__) (__)(__)      


contract Spores is ERC721A, Ownable {

    string public baseURI = "none";

    string private _contractURI;
    IPaperKeyManager private _paperKeyManager;


    constructor() ERC721A("Spores", "SPORE"){}
    ...
    modifier onlyPaper(bytes32 _hash, bytes32 _nonce, bytes calldata _signature) {
        bool success = _paperKeyManager.verify(_hash, _nonce, _signature);
    ...
    // ADMIN CONTROL
    function setPaperKeyManager(address _paperKeyManagerAddress) external onlyOwner {
        _paperKeyManager = IPaperKeyManager(_paperKeyManagerAddress);
    }

    function registerPaperKey(address _paperKey) external onlyOwner {
    	require(_paperKeyManager.register(_paperKey), "Error registering key");
    }
    ...
    // PAPER CONTROL
    function mintTo(address _recipient, uint256 _amount, bytes32 _nonce, bytes calldata _signature)
        external
        onlyPaper(keccak256(abi.encode(_recipient,_amount)), _nonce, _signature)
    {
        ...
        returns (string memory)
    {
        ...
        // Only one image, so return the only URI
        return
            string(
                abi.encodePacked(
                    baseURI
