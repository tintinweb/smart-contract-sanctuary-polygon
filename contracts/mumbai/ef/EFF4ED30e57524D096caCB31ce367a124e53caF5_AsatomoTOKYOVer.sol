...
contract AsatomoTOKYOVer is 
    ...
    function minter(address to, uint256 tokenId) public onlyRole(MINTER) {
        require(!paused, "Cannot transfer the token");
    ...
    function safeTransferFrom(address from, address to, uint256 tokenId)public override{
      require(!locked, "Cannot transfer token");
