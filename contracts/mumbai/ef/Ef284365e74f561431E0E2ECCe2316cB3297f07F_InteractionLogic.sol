...
interface ILensHub {
     ...
     */
    function follow(string calldata followType,uint256[] calldata profileIds, bytes[] calldata datas)
        external
   ...
   // function collectWithSig(DataTypes.CollectWithSigData calldata vars) external returns (uint256);
     ...
     */
    function getFollowNFT(string calldata followType, uint256 profileId) external view returns (address);
