    ...
    IERC1155ReceiverUpgradeable
{
    ...
    // Exempts addresses from platform fees
    mapping(address => bool) public isWhitelisted;
    
    //Returns bool status of Active/Invactive MarketListings 
    ...
    function buy(
        ...
        /* -------------------------------------------------------------------------- */
        /*                                new Addition                                */
        if(targetListing.quantity - _quantityToBuy <= 0){
        _removeListingFromOwnerEnumeration(
            targetListing.listingId,
            targetListing.tokenOwner
        );
        ...
        onlyExistingListing(_listingId)
    {
        ...
        /* -------------------------------------------------------------------------- */
        /*                                new Addition                                */
        if(targetListing.quantity - targetOffer.quantityWanted <= 0){
        _removeListingFromOwnerEnumeration(
            targetListing.listingId,
            _msgSender()
        );
    ...
    function payout(
        ...
        returns (address royaltyFeeRecipient, uint256 royaltyFeeAmount) {
            if(isWhitelisted[_listing.assetContract]){
                platformFeeCut = 0;
            }
...
// ["0xC5D0D9032b010988c88bAB7d0402ffe0Fe4b8Dc5", 0, 1687345249, 3600, 250, "0x718e5F6784E5bCB14D052770aFb175b55c03f7b4", 10, 20, 0]
    ...
    function setWhitelistVal(address _address , bool val) public onlyRole(DEFAULT_ADMIN_ROLE) {
        isWhitelisted[_address] = val;
    }
