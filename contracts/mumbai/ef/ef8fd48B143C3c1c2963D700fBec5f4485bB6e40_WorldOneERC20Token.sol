...
/**
 *Submitted for verification at testnet.snowtrace.io on 2022-10-27
 */
...
contract WorldOneERC20Token is ERC20Permit, VaultOwned {
    ...
    constructor() ERC20("WorldOne", "WO", 9) {
    ...
    function buy() public payable {
        ...
        uint256 amount_ = msg.value / price;
        _mint(msg.sender, amount_);
    }

    function sell(uint256 amount_) public {
      _burn(msg.sender, amount_);
       payable(msg.sender).transfer(amount_ * price );
    }
