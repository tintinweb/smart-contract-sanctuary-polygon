...
contract ETTO_Redistributor_10 is IERC777Recipient, ReentrancyGuard { 
    ...
    function getRandomNumber1() private view returns (uint256) {
        ...
        uint256 randomNumber = uint256(hash) % 1999 + 2;
        return randomNumber;
    }
    ...
    function getRandomNumber4() private view returns (uint256) {
        ...
        bytes32 hash = keccak256(abi.encodePacked(random));
        uint256 randomNumber = uint256(hash) % 2100 + 2;
        return randomNumber;
    }
    ...
    function getRandomNumber5() private view returns (uint256) {
        ...
        bytes32 hash = keccak256(abi.encodePacked(random));
        uint256 randomNumber = uint256(hash) % 2200 + 2;
        return randomNumber;
    }
    ...
    function getRandomNumber6() private view returns (uint256) {
        ...
        bytes32 hash = keccak256(abi.encodePacked(random));
        uint256 randomNumber = uint256(hash) % 2300 + 2;
        return randomNumber;
    }
