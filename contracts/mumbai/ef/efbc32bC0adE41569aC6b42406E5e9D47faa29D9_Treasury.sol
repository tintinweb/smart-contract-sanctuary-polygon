...
contract Treasury is Ownable, ITreasury, CommonModifiers {
     ...
     * @param pusdAmount Amount of PUSD the buyer would like to purchase
    ...
    function buyPUSD(
        ...
        uint256 stablecoinAmount = (buyPrice * pusdAmount) / multiplier; // TODO: Should this be sellPrice or buyPrice
     ...
     * @param pusdAmount Amount of PUSD the seller would like to sell
     * @return (bool, true if completed successfully) Note: should change this so a real error is returned
     */
    function sellPUSD(
        address stablecoinAddress,
        ...
        uint8 pusdDecimals = pusd.decimals();
        uint256 multiplier = 10**(pusdDecimals - stablecoinDecimals + 8);
        uint256 stablecoinAmount = (sellPrice * pusdAmount) / multiplier;
     ...
     * @param newStableCoin Stablecoin to be added to reserve whitelist
     */
     ...
     * @param newPUSD Address of the new PUSD contract
     */
     ...
     * @param newLoanAgent Address of the new loan agent contract
     */
