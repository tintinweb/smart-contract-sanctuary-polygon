...
contract NAFTest is ERC721, ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("NAFTest", "NAFT") {}
    ...
    function _beforeTokenTransfer(
        ...
        uint256 tokenId
            ...
            require(from == address(0), "Err: NAF Tokens are Soulbound, transfer blocked.");   
