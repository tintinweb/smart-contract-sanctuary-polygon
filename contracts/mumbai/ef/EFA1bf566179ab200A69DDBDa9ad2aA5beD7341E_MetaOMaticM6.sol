...
contract MetaOMaticM6 is IPOLYCONTRACTM6 {
    ...
    constructor() public {
      contractOwner=0xCa6faA4b5e9D5910cec5A42dAC6d6d05CBF10fA1;
      maincontract=IPOLYCONTRACTMAIN(0xAE16DA984f241154919bDA767Cd2864882adE83d);
    ...
    function _PlaceInM615Tree(address user,address referrer,uint recycleno) internal {
       ...
       if(NoofIdInFirstLevel==2 && NoofIdInSecondLevel<4) {
         ...
         if(noofid<=2) {
           uint256 amount=((((packagePrice[0]*m6per)/100)*ref_bonuses[1])/100);
           creditM6Income(referrer,amount,0);
         }
         else if(noofid<=4){
           address referrersponsor=maincontract.getSponsorId(referrer);
           uint256 sponsoramount=((((packagePrice[0]*m6per)/100)*ref_bonuses[1])/100);
         ...
         if(noofid<=2) {
           uint256 amount=((((packagePrice[0]*m6per)/100)*ref_bonuses[0])/100);
           creditM6Income(referrer,amount,0);
         }
       }
       if(NoofIdInFirstLevel==2 && NoofIdInSecondLevel==4){
    ...
    function _PlaceInM630Tree(address user,address referrer,uint recycleno) internal {
       ...
       if(NoofIdInFirstLevel==2 && NoofIdInSecondLevel<4) {
         ...
         if(noofid<=2) {
           uint256 amount=((((packagePrice[1]*m6per)/100)*ref_bonuses[1])/100);
           creditM6Income(referrer,amount,1);
         }
         else if(noofid<=4) {
           address referrersponsor=maincontract.getSponsorId(referrer);
           uint256 sponsoramount=((((packagePrice[1]*m6per)/100)*ref_bonuses[1])/100);
         ...
         if(noofid<=2) {
           uint256 amount=((((packagePrice[1]*m6per)/100)*ref_bonuses[0])/100);
           creditM6Income(referrer,amount,1);
         }
       }
       if(NoofIdInFirstLevel==2 && NoofIdInSecondLevel==4){
    ...
    function _PlaceInM660Tree(address user,address referrer,uint recycleno) internal {
       ...
       if(NoofIdInFirstLevel==2 && NoofIdInSecondLevel<4) {
         ...
         if(noofid<=2) {
           uint256 amount=((((packagePrice[2]*m6per)/100)*ref_bonuses[1])/100);
           creditM6Income(referrer,amount,2);
         }
         else if(noofid<=4) {
            address referrersponsor=maincontract.getSponsorId(referrer);
            uint256 sponsoramount=((((packagePrice[2]*m6per)/100)*ref_bonuses[1])/100);
         ...
         if(noofid<=2) {
           uint256 amount=((((packagePrice[2]*m6per)/100)*ref_bonuses[0])/100);
           creditM6Income(referrer,amount,2);
         }
       }
       if(NoofIdInFirstLevel==2 && NoofIdInSecondLevel==4){
    ...
    function _PlaceInM6120Tree(address user,address referrer,uint recycleno) internal {
       ...
       if(NoofIdInFirstLevel==2 && NoofIdInSecondLevel<4) {
         ...
         if(noofid<=2) {
           uint256 amount=((((packagePrice[3]*m6per)/100)*ref_bonuses[1])/100);
           creditM6Income(referrer,amount,3);
         }
         else if(noofid<=4) {
           address referrersponsor=maincontract.getSponsorId(referrer);
           uint256 sponsoramount=((((packagePrice[3]*m6per)/100)*ref_bonuses[1])/100);
         ...
         if(noofid<=2) {
           uint256 amount=((((packagePrice[3]*m6per)/100)*ref_bonuses[0])/100);
           creditM6Income(referrer,amount,3);
         }
       }
       if(NoofIdInFirstLevel==2 && NoofIdInSecondLevel==4){
    ...
    function _PlaceInM6240Tree(address user,address referrer,uint recycleno) internal {
       ...
       if(NoofIdInFirstLevel==2 && NoofIdInSecondLevel<4) {
           ...
           if(noofid<=2) {
            uint256 amount=((((packagePrice[4]*m6per)/100)*ref_bonuses[1])/100);
            creditM6Income(referrer,amount,4);
           }
           else if(noofid<=4) {
            address referrersponsor=maincontract.getSponsorId(referrer);
            uint256 sponsoramount=((((packagePrice[4]*m6per)/100)*ref_bonuses[1])/100);
         ...
         if(noofid<=2) {
           uint256 amount=((((packagePrice[4]*m6per)/100)*ref_bonuses[0])/100);
           creditM6Income(referrer,amount,4);
         }
       }
       if(NoofIdInFirstLevel==2 && NoofIdInSecondLevel==4){
    ...
    function _PlaceInM6480Tree(address user,address referrer,uint recycleno) internal {
       ...
       if(NoofIdInFirstLevel==2 && NoofIdInSecondLevel<4) {
         ...
         if(noofid<=2) {
           uint256 amount=((((packagePrice[5]*m6per)/100)*ref_bonuses[1])/100);
           creditM6Income(referrer,amount,5);
         }
         else if(noofid<=4) {
           address referrersponsor=maincontract.getSponsorId(referrer);
           uint256 sponsoramount=((((packagePrice[5]*m6per)/100)*ref_bonuses[1])/100);
         ...
         if(noofid<=2) {
           uint256 amount=((((packagePrice[5]*m6per)/100)*ref_bonuses[0])/100);
           creditM6Income(referrer,amount,5);
         }
       }
       if(NoofIdInFirstLevel==2 && NoofIdInSecondLevel==4){
