...
// import {ReservesPool} from "./utils/ReservesPool.sol";
...
contract ERC4626Vault is BaseERC4626 {
    ...
    event LockDurationUpdated(uint newDuration);
    ...
    uint256 public LOCK_DURATION; //86400 * 30; // 30 days
    ...
    function initialize(
        ...
        LOCK_DURATION = 0;
        fees = 375;
        // _init(address(new ReservesPool()));
        address manager = address(IFinder(_finder).getManager());
        _setTokenAdmin(manager);
        isInitialized = true;
    }

    // TODO: remove this becauese this is covereed in baseERC4626
    // modifier
    ...
    function _leave(address who, uint256 amount) internal view {
        ...
        _require(
            ...
            Errors.WITHDRAWING_BEFORE_TIME
        );
    }
    ...
    function deposit(
        ...
        shares = super.deposit(assets, receiver); // TODO: to review this
    ...
    function borrow(
        ...
        external
        onlyMarketplaceBorrowerRole
        returns (uint256 actualBorrowAmount)
    {
        console.log("This is total amount in bbtry", _amount);
        console.log("fees", fees);
        console.log("PERCENTAGE_BASED_POINT", PERCENTAGE_BASED_POINT);
        // deducting fees
        uint256 _fee = (_amount * fees) / PERCENTAGE_BASED_POINT;
        actualBorrowAmount = _amount - _fee;
        console.log("This is amount of tokens in bbtry", actualBorrowAmount);
    ...
    function buyPropertyTokens(
        ...
        MintableBurnableSyntheticTokenPermitUpgradeable(_propertyBasecurrency)
            .approve(
                msg.sender,
                _repayAmount * 10 // TODO: to change this, and make this scalable
            );
    ...
    function notiftyRewardToGauge(
        ...
        // _rewardAmount *= (10 ** 12); // TODO : make decimals  dynamic
        ...
        if (_rewardToTransfer > 0) {
            ...
            //         _rewardToTransfer
            //     );
            //     ICustomVault(customVault).stake(_rewardToTransfer);
            // }
    ...
    function updateLockDuration(
        ...
        emit LockDurationUpdated(_durationInSeconds);
    }
    ...
    MintableBurnableSyntheticTokenPermitUpgradeable
{
    ...
    //     address _initialOwner,
    //     address _finder
    // ) MintableBurnableSyntheticTokenPermitUpgradeable(_name, _symbol, _asset.decimals()) {
    //     asset = _asset;
    //     finder = IFinder(_finder);
    //     _setRoleAdmin(MAINTAINER_ROLE, DEFAULT_ADMIN_ROLE);
    //     _setupRole(MAINTAINER_ROLE, _initialOwner);
