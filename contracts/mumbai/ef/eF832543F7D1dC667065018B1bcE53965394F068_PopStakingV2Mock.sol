...
contract PopStakingV2Mock is IPopStakingV2, Ownable, ReentrancyGuard {
    ...
    constructor (
        ...
        _stakingType = [294, 588, 1260, 3780, 7560, 15330];
    }
    ...
    function getRewardPerBlock(uint256 blockNumber) public view override returns (uint256 perBlockReward) {
        if (blockNumber >= _startBlockNumber) {
            ...
            perBlockReward = _releasePerBlock + (epic + 1) * _linearRate * 1e18 / 10000;
        }
    }
