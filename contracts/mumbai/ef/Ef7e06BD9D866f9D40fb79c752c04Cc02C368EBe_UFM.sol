...
contract UFM {
    ...
    function registeredFp(uint256 __fp_id, address __token_contract, uint256 __fp_quantity, uint256 __fp_quantity_sold) external onlyAdmin {
        ...
        fp_quantity_sold[__fp_id] = __fp_quantity_sold;
