    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://api.sneakerheads.xyz/sneaker/";
...
// File: contracts/CobaNftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CobaNftContract is RamppERC721A {
    constructor() RamppERC721A("Coba NFT", "Coba NFT"){}
}
