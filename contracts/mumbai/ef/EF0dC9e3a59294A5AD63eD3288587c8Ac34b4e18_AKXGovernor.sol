...
contract AKXGovernor is Governor, GovernorSettings, GovernorCountingSimple, GovernorVotes, GovernorVotesQuorumFraction, GovernorTimelockControl {
    constructor(IVotes _token, TimelockController _timelock)
        Governor("AKXGovernor")
        GovernorSettings(5 /* 1 block */, 45818 /* 1 week */, 10000)
