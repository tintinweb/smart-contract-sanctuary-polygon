...
contract TestToken5 is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable, EIP712, ERC721Votes {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("TestToken5", "TT5") EIP712("TestToken5", "1") {}
    ...
    function bulkMint(address to,string memory uri,uint amount) public onlyOwner{
