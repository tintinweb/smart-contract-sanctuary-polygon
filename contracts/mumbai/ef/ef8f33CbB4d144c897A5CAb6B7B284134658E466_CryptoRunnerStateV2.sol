...
@dev V2 reduces the start run gas requirements by removing the return of CryptoRunner
*/
contract CryptoRunnerStateV2 is RegisterableUpgradeableBase {
    /**
    ...
    */
    ...
    string: Run ID
    */
    function startRun(bytes calldata data_) external virtual onlyGameplayEnabled() {
