...
contract NFTMarketplaceV2 is INFTMarketplaceV2, NFTMarketplace, PausableUpgradeable, EIP712 {
    ...
    function buyItem(address tokenAddress, uint tokenId) public payable nonReentrant whenNotPaused override(INFTMarketplace, NFTMarketplace) {
    ...
    function matchOrders(
        ...
        if (
            makerOrder.maker == address(0) ||
            takerOrder.maker == address(0)
        ) {
            revert Unauthorized();
        }
    ...
    function _transferERC20Tokens(
        ...
        (address makerTakeAssetAddress, uint makerTakeAssetAmount) = abi.decode(makerOrder.takeAsset.data, (address, uint));
