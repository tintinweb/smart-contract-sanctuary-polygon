	...
	ReentrancyGuardUpgradeable
{
		...
		onlyPolicyManager
	{
		...
		_policyIdData[_issuePolicyParams.policyId] = PolicyIdData(
			...
			_issuePolicyParams.buyValue,
			_issuePolicyParams.maxCoverage,
		...
		totalPoliciesValue += _issuePolicyParams.buyValue;
		allPoliciesValueBeforeCalculate += _issuePolicyParams.buyValue;

		totalPoliciesCoverageValue += _issuePolicyParams.maxCoverage;
		allPoliciesCoverageValueBeforeCalculate += _issuePolicyParams
			.maxCoverage;
