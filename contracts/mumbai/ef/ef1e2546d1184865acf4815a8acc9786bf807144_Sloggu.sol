...
contract Sloggu is ERC721EnumerableCustom, Ownable {
    ...
    string private _baseTokenURI = "ipfs://QmUrqSm7A5QE9hqK8UpznqUmTbFFsyR2gn133t4AzkFMx6/";
    string private _tokenURISuffix = ".json";

    bool public isContractLocked = false;
    bool public publicSaleOpen = false;

    constructor() ERC721Custom("Sloggu", "Sloggu") {}
    
    function mintNFT(uint256 quantity, address recipient) public {
        ...
        require(quantity <= maxPerWallet - balanceOf(recipient), "Order exceeds max tokens per wallet");
        require(supply + quantity <= maxSupply - reserved, "Mint order exceeds supply");
