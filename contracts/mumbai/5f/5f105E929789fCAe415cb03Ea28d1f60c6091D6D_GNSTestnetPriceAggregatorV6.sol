...
// File: contracts\interfaces\CallbacksInterfaceV6.sol
...
// File: contracts\GNSTestnetPriceAggregatorV6.sol
...
contract GNSTestnetPriceAggregatorV6 is ChainlinkClient {
    using Chainlink for Chainlink.Request;
    
    // Contracts (constant)
    StorageInterfaceV5 immutable storageT;
    LpInterfaceV5 immutable tokenDaiLp;
    ...
    constructor(address[] memory _nodes, PairsStorageInterfaceV6 _pairsStorage, address _nftRewards, StorageInterfaceV5 _storageT, LpInterfaceV5 _tokenDaiLp) {
