...
// File: https://github.com/LayerZero-Labs/solidity-examples/blob/main/contracts/token/onft/IONFT721Core.sol
...
// File: https://github.com/LayerZero-Labs/solidity-examples/blob/main/contracts/token/onft/ONFT721Core.sol
...
// File: https://github.com/LayerZero-Labs/solidity-examples/blob/main/contracts/token/onft/IONFT721.sol
...
// File: https://github.com/LayerZero-Labs/solidity-examples/blob/main/contracts/token/onft/ONFT721.sol
...
// File: contracts/GrapeEscape_RARE.sol
...
contract GrapeEscape_RARE is ONFT721 {
    constructor(address _layerZeroEndpoint)
        ONFT721("GrapeEscape_RARE", "GER", 1, _layerZeroEndpoint)
    {
    ...
    string _baseTokenURI = "https://ipfs.io/ipfs/";
    ...
    function setBaseURI(string memory baseURI) public {
        ...
        // emit MetadataUpdate(_tokenIds.current());
    }

    function mintNextToken(address _owner, uint256 _tokenId)
        external
        returns (bool)
    {
        _tokenIds.increment();
        return mint(_owner, _tokenIds.current());

        // return mint(_owner, _tokenIds.current(), _rarity, _ipfsHash);
    }

    function mint(address _owner, uint256 _tokenId) internal returns (bool) {
        require(
