...
contract SiteOwners is ChainlinkClient {
    using Chainlink for Chainlink.Request;
    ...
    string _extension = "/owner-address";

    // The link contract
    IERC20 _link;

    event SiteOwnerAddedEvent(string site, address owner, bytes32 requestId, uint256 time);
    event SiteOwnerRequestAddedEvent(string site, address owner, bytes32 requestId, uint256 time);
    event SiteOwnerFailedEvent(bytes32 requestId, uint256 time);
    
    constructor() {
        setChainlinkToken(0x326C977E6efc84E512bB9C30f76E30c160eD06FB);
        oracle = 0x40193c8518BB267228Fc409a613bDbD8eC5a97b3;
        jobId = "d8fcf41ee8984d3b8b0eae7b74eca7dd";
        _link = IERC20(0x326C977E6efc84E512bB9C30f76E30c160eD06FB);
    ...
    function verifyUrlOwner(string memory site) public returns (bytes32 requestId)
    {
        ...
        _link.transferFrom(msg.sender, address(this), fee);
    ...
    * Get the site owner
    */
    function getSiteOwner(string memory site) public view returns(address){
