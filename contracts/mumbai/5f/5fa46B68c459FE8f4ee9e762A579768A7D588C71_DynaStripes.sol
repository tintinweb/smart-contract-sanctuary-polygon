...
library DynaTraits {
    ...
    function getTraits(DynaModel.DynaParams memory dynaParams) internal pure returns (string memory) {
        ...
        string memory tintTraits = string(abi.encodePacked("{\"trait_type\": \"tint color\", \"value\": \"", StringUtils.smallUintToString(dynaParams.tintRed), " ", StringUtils.smallUintToString(dynaParams.tintGreen), " ", StringUtils.smallUintToString(dynaParams.tintBlue), " ", StringUtils.smallUintToString(dynaParams.tintAlpha), "\"}")); 
