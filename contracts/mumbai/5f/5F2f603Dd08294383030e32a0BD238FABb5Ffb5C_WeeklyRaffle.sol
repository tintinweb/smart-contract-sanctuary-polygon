    ...
    WonderVRFGeneratorV2
{
    ...
    mapping(uint256 => uint256) requestForWeeks;
    ...
    constructor(
        ...
        newWeeklyConfig.endTimestamp = startTimestamp + 600;
        winnerCount = 40;
    }
    ...
    function drawWeeklyRaffle(
        ...
        requestId = super.requestRandomWords(1, _callbackGasLimit);
        ...
        requestForWeeks[requestId] = _weekNumber;

        uint256 newWeek = _weekNumber + 1;

        WeeklyRaffleConfig storage newWeeklyConfig = weeklyConfigs[newWeek];
        newWeeklyConfig.startTimestamp = config.startTimestamp + 600;
        newWeeklyConfig.endTimestamp = config.endTimestamp + 600;
    ...
    function processRandomness(uint256 _requestId, uint256[] memory _numWords)
        ...
        override
    {
        uint256 weekNumber = requestForWeeks[_requestId];
        require(
