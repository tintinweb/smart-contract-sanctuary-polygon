...
contract Contract is ERC721Drop {
    ...
    /**
    @dev Cumulative per-token lodging, excluding the current period.
     */
     ...
     */
    function setLodgingOpen(bool) public onlyOwner {
        lodgingOpen = true;
    }
    ...
    */
        ...
        onlyApprovedOrOwner(tokenId)
    {
        uint256 start = lodgingStarted[tokenId];
        if (start == 0) {
            require(lodgingOpen == true, "Sassy: Lodging closed");
