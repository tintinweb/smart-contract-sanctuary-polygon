...
contract Hivemind is HivemindV1Storage, HivemindI, ErrorReporter, Ownable {
  ...
  function borrowAllowed(
    ...
    (, uint256 shortfall) = getHypotheticalAccountLiquidityBorrowInternal(_borrower, _hToken, _collection, _borrowAmount);
  ...
  function repayBorrowAllowed(
    ...
    (, uint256 shortfall) = getHypotheticalAccountLiquidityBorrowInternal(_borrower, _hToken, _collection, 0);
  ...
  function getHypotheticalAccountLiquidity(
    ...
    if (_redeemTokens > 0) (liquidity, shortfall) = getHypotheticalAccountLiquidityRedeemInternal(_account, _hToken, _redeemTokens);
      ...
      (liquidity, shortfall) = getHypotheticalAccountLiquidityBorrowInternal(_account, _hToken, _collection, _borrowAmount);
  }
