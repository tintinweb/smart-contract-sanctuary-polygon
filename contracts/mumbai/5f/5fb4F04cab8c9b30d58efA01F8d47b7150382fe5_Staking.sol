 ...
 * Staking of : Coin Coin_DPtest
 * Coin Address : 0xe37E09404ffeE046C21f7A9B206b5990B0110439
 * Number of schemes : 1
...
*/
	function withdrawReferral(uint256 _amt) public {
		...
		ERC20(0xe37E09404ffeE046C21f7A9B206b5990B0110439).transfer(msg.sender, _amt);
 ...
 * ERC20 Transfer : 0xe37E09404ffeE046C21f7A9B206b5990B0110439, _stakeAmt
...
*/
	function stake(uint256 _stakeAmt) public {
		...
		ERC20(0xe37E09404ffeE046C21f7A9B206b5990B0110439).transferFrom(msg.sender, address(this), _stakeAmt);
...
*/
	function unstake(uint256 _unstakeAmt) public {
		...
		ERC20(0xe37E09404ffeE046C21f7A9B206b5990B0110439).transfer(msg.sender, (((_unstakeAmt * (uint256(1000000) - uint256(50000))) / uint256(1000000)) + ((interestToRemove * (uint256(1000000) - uint256(50000))) / uint256(1000000))));
 ...
 * The function takes in 0 variables. It can be called by functions both inside and outside of this contract. It does the following :
 * creates an internal variable total with initial value 0
 * repeat numberOfAddressesCurrentlyStaked times with loop variable i0 :  (creates an internal variable thisRecord with initial value addressMap with element addressStore with element Loop Variable i0; and then updates total as (total) + (thisRecord with element accumulatedInterestToUpdateTime))
 * returns total as output
*/
	function totalAccumulatedInterest() public view returns (uint256) {
		...
		for (uint i0 = 0; i0 < numberOfAddressesCurrentlyStaked; i0++){
			record memory thisRecord = addressMap[addressStore[i0]];
			total  = (total + thisRecord.accumulatedInterestToUpdateTime);
		}
		return total;
	}
...
*/
	function withdrawPrincipalTax0() public {
		...
		ERC20(0xe37E09404ffeE046C21f7A9B206b5990B0110439).transfer(msg.sender, taxPrincipalBank0);
...
*/
	function withdrawInterestTax0() public {
		require((msg.sender == address(0xcb2A7dAF65bd94e74E1a0393912aD0fcc4a50c7f)), "Not the withdrawal address");
		ERC20(0xe37E09404ffeE046C21f7A9B206b5990B0110439).transfer(msg.sender, taxInterestBank0);
