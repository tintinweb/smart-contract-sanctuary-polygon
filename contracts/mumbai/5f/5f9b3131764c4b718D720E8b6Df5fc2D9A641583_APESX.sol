...
contract APESX is ERC721, ERC721Burnable, Ownable {
    ...
    uint256 public whiteListPrice = 0.01 ether ; // 0.1
    uint256 public publicSalePrice = 0.02 ether ; // 0.2
    uint256 public lastSalePrice = 0.2 ether ;
    uint256 public firstDutchPrice = 10 ether ;
    uint256 public secondDutchPrice = 10 ether ;
    ...
    bool public firstWaveAllow = true ;
    ...
    uint256 private firstAuctionStartDate = 1645208460 ;
    uint256 private secondAuctionStartDate = 1647669600 ;

    constructor() ERC721("APES X CLUB", "AXC", "ipfs://Qmb8DMCjd46YxRnugisQB9jms88AiNcGmdWqves41xRwTy/") {}
