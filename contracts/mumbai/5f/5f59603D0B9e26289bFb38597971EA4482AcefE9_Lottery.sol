...
contract Lottery is Ownable, VRFConsumerBase, KeeperCompatible {
    ...
    address public DAO = 0x43fF4c91A57F94Dd72004f0B0e8b5d256fde7fE0;
    uint256 public winnerNFT;
    address payable public lotteryWinner;
    uint256[] public registered;
    uint256[] public tokenIds = IEGVC(0x8b08705786485e66d3CceB6B473e1AD24Cc475ea).walletOfOwner(msg.sender);
...
constructor()
    ...
    function register(uint256 _tokenID) public returns (string memory) {
        ...
        tokenIds = IEGVC(0x8b08705786485e66d3CceB6B473e1AD24Cc475ea).walletOfOwner(msg.sender);
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        lotteryWinner = payable(IEGVC(0x8b08705786485e66d3CceB6B473e1AD24Cc475ea).ownerOf(winnerNFT));
    ...
    return IEGVC(0x8b08705786485e66d3CceB6B473e1AD24Cc475ea).walletOfOwner(msg.sender);
    }
