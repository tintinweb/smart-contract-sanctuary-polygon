...
contract lbtestv2d is VRFV2WrapperConsumerBase,ConfirmedOwner,ReentrancyGuard {
   ...
   // Mumbai 0xeeB482F3981D004C6199cA21F331Dc33EE639f0a // Mainnet 0x527a819db1eb0e34426297b03bae11F2f8B3A19E
    ...
    function swapTokensToUSD(uint256 tokenAmount, address user, uint typeSwap) private {
        ...
        uint256 amountInToken = (tokenAmount * 10**18) / tprice;  // refund value in token
    ...
    function getRandomNumber() internal returns (uint256 requestId) {
        ...
        if(contractBalance >= minimumPrize*3){
            ...
            swapTokensToUSD((5 * 10**18),address(this),0);
           ...
           if(idInPosition == index){
            ...
            if(clearUserTicket(owner,drawId,trackedTicket.id)){       
                ...
                if(stableDecimals < 18){
                 swapTokensToUSD((refundValue * 10**(18 - stableDecimals)),msg.sender,1);
                }else{
