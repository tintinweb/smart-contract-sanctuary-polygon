    ...
    NativeMetaTransaction
{
    ...
    constructor() ERC721A("ANIMAL", "ANIMAL") {
        _initializeEIP712("ANIMAL");
        baseTokenURI = "https://cdn.nftstar.com/animal/metadata/";
        collectionURI = "https://cdn.nftstar.com/animal/meta-animal.json";
        ...
        onlyRole(MINER_ROLE)
    {
        require(
            ...
            "ANIMAL: The two arrays are not equal in length"
        );
    ...
    function pause() public virtual {
        require(
            ...
            "ANIMAL: must have pauser role to pause"
        );
        _pause();
    }
    ...
    function unpause() public virtual {
        require(
            hasRole(PAUSER_ROLE, _msgSender()),
            "ANIMAL: must have pauser role to unpause"
        );
        _unpause();
    }
