...
contract AminoChainCellLine is ERC721 {
    ...
    function getTokenData(
        ...
        public
        view
        returns (uint _batchId, DonationData memory _batchData, SampleData memory _tokenData)
    {
        return (batchId[tokenId], batchData[batchId[tokenId]], sampleData[tokenId]);
    }

    function getBatchBalance(address addy, uint batch) public view returns (uint _batchBalance) {
