...
contract UriGenerator is IUriGenerator, Ownable {
    ...
    function getSvgLeft(string memory a, string memory b) internal view returns(string memory) {
        return string(abi.encodePacked(
            sa, a, sb, b, sc
        ));
    }

    function getSvgRight(string memory c, string memory d, string memory e) internal view returns(string memory) {
        return string(abi.encodePacked(
            c, sd, d, se, e, sf
        ));
    }
