...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x8D15E9D6aB931B6b430757D868075D8c55c74f29];
...
// File: contracts/FinanflixContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract FinanflixContract is RamppERC721A {
    constructor() RamppERC721A("Finanflix ", "FFF"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/hLcmRu7UEztivq9WIGHR/contract-metadata";
    }
}
