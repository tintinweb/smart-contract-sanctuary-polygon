...
contract NFTMarketplace is Context, Ownable, Pausable, ReentrancyGuard {
     ...
     */
    function collectionRecentListings(address _collection)
        external
        view
     ...
     * @param _collection address to check offers from
     */
    function availableListingsAndOffers(address _collection)
        public
        view
    ...
    */
    ...
    function acceptOffer(
        ...
        require(
            offerExists[_collection][_offerer].contains(_tokenId),
            "Offer doesn't exist"
        );
    ...
    */
    function proxyRemoveOffer(
        ...
        require(
            offerExists[_collection][_offerCreator].contains(_tokenId),
            "Offer doesn't exist"
        );
        ...
        offerExists[_collection][_offerCreator].remove(_tokenId);
