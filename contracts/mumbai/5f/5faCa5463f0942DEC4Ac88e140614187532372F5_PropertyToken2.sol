...
interface IClaimIssuer is IIdentity {
    ...
    function getRecoveredAddress(bytes calldata sig, bytes32 dataHash)
        external
        pure
        returns (address);
...
interface IIdentityRegistryStorage {
    ...
    // role setter
    function transferOwnershipOnIdentityRegistryStorage(address _newOwner)
        external;
...
import "contracts/ERC3643/contracts/compliance/modular/IModularCompliance.sol";
import "@openzeppelin/contracts/token/ERC20/IERC20.sol";
