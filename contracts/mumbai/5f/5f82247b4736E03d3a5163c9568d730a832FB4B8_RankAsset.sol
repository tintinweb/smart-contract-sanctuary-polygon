...
contract RankAsset is Ownable, ERC721A {
    ...
    constructor() ERC721A("RankAsset", "RNKA") {}

    function publicMint(uint256 quantity) external payable {
        require(isPublicSaleActive, "Mint is disabled");
        ...
        require(msg.value >= quantity * price, "Incorrect MATIC amount");
    ...
    function setMaxSupply(uint256 _maxSupply) external onlyOwner {
        require(
            ...
            "New max suppy should be greater or equal to current number of minted tokens"
        );
