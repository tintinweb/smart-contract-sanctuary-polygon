...
contract Fish_Species_01_Extension is Ownable {
    ...
    function preCreate(uint16 _valueType, uint256 tokenId, uint256 creature_valueType_balance, bool breeding) private {
        require(valueType == _valueType, "Invalid Value Type");
...
contract Fish_Species_01 is GameBase {
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        if(gameRandomnessToGameResult[requestId].gameId != 0) {
            completeGame(tokenId, requestId, randomness);
            return;
        }
        ...
        if(tokenIdBreedingRandomId[requestId] != 0) {
            ...
            fish_Species_01_Extension.breed(creature_valueType[tokenId], tokenId, creature_parentNo_parent[tokenId][1], creature_parentNo_parent[tokenId][2], kill, contract_points_value_balance_forType[creature_valueType[tokenId]], randomness);
        ...
        fish_Species_01_Extension.mint(creature_valueType[tokenId], tokenId, contract_points_value_balance_forType[creature_valueType[tokenId]], randomness);
    ...
    mapping(bytes32 => uint256) internal tokenIdBreedingRandomId;
...
abstract contract RandomBase is VRFConsumerBase 
{
    /**
    * Declare Chainlink VRF parameters
    */ 
    ...
    constructor()
        ...
        */
        ...
        /**
        * #########################################
        * Set Chainlink oaramsChainlink 
        * ##########################################
        */ 
        keyHash = 0x6e75b569a01ef56d18cab6a8e71e6600d6ce853834d4a5748b720d06f878b3a4;
        fee = 0.0005 * 10 ** 18; // 0.0005 LINK (Varies by network)
    }
}
...
abstract contract GameBase is RandomBase, NftMinter
{
    ...
    mapping(bytes32 => GameResult) internal gameRandomnessToGameResult;
    ...
    function completeGame(uint256 tokenId, bytes32 requestId, uint256 randomness) internal {
