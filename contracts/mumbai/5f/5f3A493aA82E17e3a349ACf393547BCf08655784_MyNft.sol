...
contract MyNft is ERC721, Ownable, ERC2981 {
    uint256 public price = 0.00456 ether;
    uint256 public maxPerWallet = 10;
    uint256 public maxPerTransaction = 10;

    uint256 public presalePrice = 0.000123 ether;
    ...
    address[] public withdrawAddresses = [0xf0b3A0d711ade594b5bBB9D4248Ff36DE192dc71];
    ...
    constructor() ERC721("TEST", "NFT") {
        _baseTokenURI = "https://test-api.nftool.io/generator-server/api/contract/v1/JFuFZDd5z30xw8TA0/1610533835125657602/metadata/";
        _setDefaultRoyalty(0xf0b3A0d711ade594b5bBB9D4248Ff36DE192dc71, uint96(500));
    }
