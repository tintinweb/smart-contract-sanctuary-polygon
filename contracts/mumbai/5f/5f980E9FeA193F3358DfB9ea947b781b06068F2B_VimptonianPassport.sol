...
UTILITY:-
-Access to Vimpto Worlds.
-Movement tracking rewards.

MAX SUPPLY:-
-Unlimited NFTs.

 */
contract VimptonianPassport is Ownable, ERC721Enumerable, ReentrancyGuard {

    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private _tokenIds;
    constructor() ERC721("VimptonianPassport", "VP") {}
    ...
    function mintPassport(address mintTo)
        public
        nonReentrant
        returns (uint256)
    {
