    ...
    ERC721HolderUpgradeable
{
    ...
    function contractURI() public view returns (string memory) {
        return
            string.concat(
                "https://testnet.tableland.network/query?extract=true&unwrap=true&s=SELECT json('",
                string.concat(
                    ...
                    '"image":"https://nftstorage.link/ipfs/bafkreibahfxzpiarlfaes37bljy5tycvubo4gdzbtptpvc36iitnekukwe"',
