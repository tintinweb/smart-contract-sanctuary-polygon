...
contract MyToken is ERC20, AccessControl {
    ...
    function setBurner(address burnerAddress) public onlyRole(DEFAULT_ADMIN_ROLE) {
        require(burnerAddress != address(0), "Address zero is not a valid contract address");
    ...
    function setSender(address senderAddress) public onlyRole(DEFAULT_ADMIN_ROLE) {
        require(senderAddress != address(0), "Address zero is not a valid contract address");
