...
contract CelarisSeller is  Ownable , ReentrancyGuard,Pausable{
    ...
    function getContractData() public view returns (uint256,uint256,uint256,uint256) {        
        return (whiteWineIdsToMint.length,redWineIdsToMint.length,euroPrice,getWeiPrice(1));
    }
