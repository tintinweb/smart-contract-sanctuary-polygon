...
contract BankOnatorStaking is Ownable, ReentrancyGuard, Pausable {
    ...
    uint256 constant DECIMAL = 9;
    uint256 constant APYBASE = 31536000; // in seconds = 365 days

    uint256 public lastRewardTime = 1716197418;
    ...
    function unstake(uint256 unstakeAmount) external nonReentrant {
        ...
        if (resultingStakeAmt == 0) {
            ...
            staker.lastStakedTime = currentTime < lastRewardTime
                ? currentTime
                : lastRewardTime;
        }
    ...
    function claim() external whenNotPaused {
        ...
        stakeDetails.lastStakedTime = currentTime < lastRewardTime
            ? currentTime
            : lastRewardTime;
