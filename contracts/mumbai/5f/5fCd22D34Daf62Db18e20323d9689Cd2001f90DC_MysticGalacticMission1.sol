...
contract MysticGalacticMission1 is ERC721, Ownable, Pausable, AccessControlEnumerable, ReentrancyGuard {
     ...
     */
    function setPrice(uint256 _usdPrice) public onlyOwnerOrAdmin {
        usdPrice = _usdPrice;
    ...
    function getCurrentPrice() public view returns (uint256) {
        return Util.convertUSDtoMATIC(usdPrice, priceFeed);
    }
    ...
    function mint() public payable nonReentrant whenNotPaused returns (string memory) {
        ...
        require(msg.value >= getCurrentPrice(), "Funds sent is less than the price of token");
...
library Util {
     ...
     */
    function convertUSDtoMATIC(uint256 usdAmount, AggregatorV3Interface priceFeed) public view returns (uint256) {
