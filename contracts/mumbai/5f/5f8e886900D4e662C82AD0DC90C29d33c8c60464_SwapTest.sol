...
interface SwapRouter is ISwapRouter {
...
contract SwapTest {
    ...
    constructor(address usdc, address uniswapRouter) {
        _usdc = IERC20(usdc);
    ...
    function usdcToMatic(uint256 amount) public {
    ...
    function maticToUsdc(uint256 amount) public {
        ISwapRouter.ExactInputSingleParams memory params = ISwapRouter
            .ExactInputSingleParams({
