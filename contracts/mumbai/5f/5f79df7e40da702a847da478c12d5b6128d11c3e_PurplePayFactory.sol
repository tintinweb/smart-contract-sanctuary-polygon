...
// File: contracts/PurplePayFactory.sol
...
contract MerchantWallet is Ownable {
    ...
    event PaymentRecieved(string orderId, uint amount, address sender, address merchantWallet);

    receive() external payable { }

    function recievePayments(string memory orderId) payable public {
        ...
        emit PaymentRecieved(orderId, msg.value, msg.sender, address(this));
    }
