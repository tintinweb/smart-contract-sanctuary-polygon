...
// File: contracts/UpgradeableChildERC20/ERC20.sol
...
// File: contracts/common/ChainConstants.sol
...
// File: contracts/UpgradeableChildERC20/UChildERC20.sol
...
// File: contracts/PolygonToken_v1.sol

pragma solidity 0.6.6;


contract PolygonToken_v1 is UChildERC20 {
    constructor()
        public
        UChildERC20()
    {}
...
abstract contract Pauser is Common {
...
abstract contract Rescuer is Pauser  {
...
abstract contract Prohibiter is Pauser {
...
abstract contract Admin is Rescuer,Prohibiter {
...
abstract contract Owner is Admin {
...
// File: contracts/PolygonToken_v2.sol

pragma solidity 0.6.6;



contract PolygonToken_v2 is PolygonToken_v1, Owner{
    ...
    function initializeRoles(
        ...
        external
    {
        require(owner == address(0), "roles initialized");
    ...
    function changeName(string calldata name_) external onlyRescuer {
        setName(name_);
    ...
    function permit(
        ...
        require(deadline == 0 || now <= deadline, "PERMIT-EXPIRED");
