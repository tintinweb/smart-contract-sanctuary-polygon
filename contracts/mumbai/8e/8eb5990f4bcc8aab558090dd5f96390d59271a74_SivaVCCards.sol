...
contract SivaVCCards is ERC721Enumerable, Ownable {
    ...
    uint256[] public typeLockedBlocks = [
        ...
        0,
        0,
        20000,//7300000,//~180 days
        20000,//7300000,//~180 days
        20000,//7300000,//~180 days
        40000,//14600000,//~365 days
        40000,//14600000,//~365 days
        40000//14600000//~365 days
    ];
    ...
    string[] public typeImage = [
        "ipfs://bafybeihey2cl3w4yya4c7y6m6lbewxcqdrbqif5xtnrpzc657vwmqj4c2e/siva-silver-edition-small.json",
        "ipfs://bafybeihey2cl3w4yya4c7y6m6lbewxcqdrbqif5xtnrpzc657vwmqj4c2e/siva-silver-edition-medium.json",
        "ipfs://bafybeihey2cl3w4yya4c7y6m6lbewxcqdrbqif5xtnrpzc657vwmqj4c2e/siva-silver-edition-large.json",
        "ipfs://bafybeihey2cl3w4yya4c7y6m6lbewxcqdrbqif5xtnrpzc657vwmqj4c2e/siva-gold-edition-small.json",
        "ipfs://bafybeihey2cl3w4yya4c7y6m6lbewxcqdrbqif5xtnrpzc657vwmqj4c2e/siva-gold-edition-medium.json",
        "ipfs://bafybeihey2cl3w4yya4c7y6m6lbewxcqdrbqif5xtnrpzc657vwmqj4c2e/siva-gold-edition-large.json",
        "ipfs://bafybeihey2cl3w4yya4c7y6m6lbewxcqdrbqif5xtnrpzc657vwmqj4c2e/siva-black-edition-small.json",
        "ipfs://bafybeihey2cl3w4yya4c7y6m6lbewxcqdrbqif5xtnrpzc657vwmqj4c2e/siva-black-edition-medium.json",
        "ipfs://bafybeihey2cl3w4yya4c7y6m6lbewxcqdrbqif5xtnrpzc657vwmqj4c2e/siva-black-edition-large.json"
    ];
    ...
    function mint(
        ...
        require(typeIndex[cardType] + amount <= typeLimit[cardType], "Siva VC Cards: Card limit reached.");
    ...
    function tokenURI(
        ...
        if (address(uriExtension) != address(0)) {
            ...
            string memory name = string(abi.encodePacked(
                typeName[_card.cardType], ' #', _card.number.toString()
            ));
            string memory attributes = string(abi.encodePacked(
                '"attributes": [{"trait_type": "Card Type", "value": "', typeName[_card.cardType], '"}',
                ', {"trait_type": "Card Number", "value": "', _card.number.toString(), '/', typeLimit[_card.cardType].toString(), '}'
            ));
            ...
            string memory json = base64(bytes(string(abi.encodePacked(
                '{"name": "', name,
                '", "description": "Siva VC Cards description... "',
