...
*/
    ...
    constructor(
        ...
        seller = _seller;
        polyWallet = factoryContract.owner();
    ...
    function addAdmin(address _newAdmin) external onlyOwnerAndAdmin {
    ...
    function removeAdmin(address _admin) external onlyOwnerAndAdmin {
    ...
    function setPolyDAO(address _DAO) external onlyOwnerAndAdmin {
    ...
    function setPolyNFT(address _polyNFT) external onlyOwnerAndAdmin {
    ...
    function setAllowMintNFT(bool _true_false) external onlyOwnerAndAdmin {
    ...
    function setCurrencyDecimals() internal {
        (, uint8 returnedDecimals) = factoryContract.allowedCurrencies(token);
