...
contract MyNft is ERC721, Ownable, ERC2981 {
    ...
    uint256 public presaleMaxPerWallet = 0;
    uint256 public presaleMaxPerTransaction = 0;

    uint256 public immutable presaleSupply = 0;
    ...
    address[] public withdrawAddresses = [0xd5F75aBe2F0F2a1104fE219830216f85204c1d26, 0xcc0756D7586Ec64B44F7fdf2f023829e03dAaa4f];
    uint256[] public withdrawPercentages = [10, 90];


    bytes32 public merkleRoot = 0;

    constructor() ERC721("OMS", "o") {
        _baseTokenURI = "https://test-nft-tool-gateway-api.tuoluo.net/generator-server/api/contract/v1/1603658670918332417/metadata/";
        _setDefaultRoyalty(0xcc0756D7586Ec64B44F7fdf2f023829e03dAaa4f, uint96(1000));
    }
