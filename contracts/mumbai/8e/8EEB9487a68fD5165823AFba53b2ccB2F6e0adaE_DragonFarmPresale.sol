...
contract DragonFarmPresale is ReentrancyGuard, Ownable, PaymentSplitter {
    ...
    event PresaleSaleOpen();
    event EnterPresaleSale(address who, uint256 alloc);
    ...
    nonReentrant {
        ...
        emit EnterPresaleSale(_msgSender(), amount);
    }

    function startPresaleSale() external onlyOwner {
        open = true;
        emit PresaleSaleOpen();
    }
