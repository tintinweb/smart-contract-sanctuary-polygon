...
contract RGSeatNFTTailor is ERC721A, Ownable {
    ...
    function mintNFT(uint256 _quantity, address _wallet) public isOperator {
        ...
        require(
            ...
            "Purchase would exceed maxSupply of NFTs"
        );
        require(
            balanceOf(_wallet) < maxMintPerWallet,
            "maxMintPerWallet has been reached for this wallet"
        );
