...
contract RSUMarketplace is ReentrancyGuard, Pausable, AccessControl {
    ...
    function createOrder (
        ...
        emit CreateOrderEvent(nftContract, orderId, tokenId, expiration, _refundPrice, msg.sender, startPrice, tokenAddress, marketType, true);
    }
    ...
    function bidAuction (
        ...
        emit BiddingEvent(orderData.nftContract, orderId, orderData.tokenId, bidPrice, true);
    }
    ...
    function ownerApproveOffer(uint256 offerId) public nonReentrant{
        ...
        offers[msg.sender][offerId].offererAccExp = block.timestamp + 3 days;
    }
