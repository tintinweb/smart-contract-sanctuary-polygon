...
// File: HeftyVerse/heftiverse/contracts/Relayer/BasicMetaTransaction.sol
...
// File: HeftyVerse/heftiverse/contracts/libraries/VoucherLib.sol
...
// File: HeftyVerse/heftiverse/contracts/interfaces/INFTTemplate.sol
...
// File: HeftyVerse/heftiverse/contracts/CustomAccessControl.sol
 ...
 */
abstract contract CustomAccessControl is Context, IAccessControl, ERC165 {
    struct RoleData {
    ...
    modifier onlyRole(bytes32 role) {
        _checkRole(role, super._msgSender());
        _;
    }
...
// File: HeftyVerse/heftiverse/contracts/Marketplace.sol
...
contract HeftyVerseMarketplace is EIP712("Heftyverse_MarketItem","1"), CustomAccessControl, BasicMetaTransaction {
    ...
    function BuyCustodial2NonCustodial(HeftyVerseBuyer memory buyer,HeftyVerseSeller memory seller) internal {
        ...
        //payment transfer
        token.transferFrom(buyer.buyer, treasury, buyer.pricePaid - royaltyAmount);
        // nft transfer
        IERC721(seller.nftAddress).transferFrom(seller.owner, buyer.buyer, seller.tokenID);
    }
    ...
    function BuyNonCustodial2Custodial(HeftyVerseBuyer memory buyer,HeftyVerseSeller memory seller) internal {
        ...
        token.transferFrom(treasury, receiver , royaltyAmount);
        //payment transfer
        token.transferFrom(treasury, seller.owner, buyer.pricePaid - royaltyAmount);
        //nft transfer
        IERC721(seller.nftAddress).transferFrom(seller.owner, buyer.buyer, seller.tokenID);
    }
    ...
    function BuyNonCustodial2NonCustodial(HeftyVerseBuyer memory buyer,HeftyVerseSeller memory seller) internal {
        ...
        token.transferFrom(treasury, receiver , royaltyAmount); 
        //payment transfer
        token.transferFrom(buyer.buyer, seller.owner, buyer.pricePaid - royaltyAmount);
        //nft transfer
        IERC721(seller.nftAddress).transferFrom(seller.owner, buyer.buyer, seller.tokenID);
    }
