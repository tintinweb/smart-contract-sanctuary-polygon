...
contract TwentyfourX7_Tech is ERC721URIStorage, Ownable {
  ...
  // Set of addresses that are allowed to interact with the contract
     address[] public whitelist;

  mapping(uint256 => NFTListing) private _listings;

  // Boolean flag for whether the contract is paused
   bool public paused;
  ...
  constructor() ERC721("24x7Tech", "24x7") {
    Owner = msg.sender;
