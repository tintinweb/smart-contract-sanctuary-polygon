...
import "./interfaces/IBoaxNFT.sol";
import "@openzeppelin/contracts/utils/Counters.sol";
import "@openzeppelin/contracts/access/Ownable.sol";

contract BoaxEnglishAuction is Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private auctionId;
    // solhint-disable-next-line
    IBoaxNFT private BoaxERC721;
    ...
    function createAuction(uint256 _tokenId, uint256 _price) external {
        ...
        BoaxERC721.transferFrom(msg.sender, address(this), _tokenId);
    ...
    function _trade(
        ...
        (
            ...
            address artist
        ) = BoaxERC721.getStateInfo(_tokenId);
        ...
        if (!isSecondarySale) {
            BoaxERC721.setSecondarySale(_tokenId);
        } else {
     ...
     */
    constructor(address boaxERC721) {
        require(boaxERC721 != address(0), "Invalid address");

        BoaxERC721 = IBoaxNFT(boaxERC721);
    }
}
