...
contract Assetha is ERC721B, Ownable, NonblockingReceiver {
    ...
    uint256 public mintPrice = 70 ether;
    uint256 public preMintPrice = 50 ether;
    uint256 public earlyQuitPrice = 25 ether;
    uint256 public maxFreeMints = 10;
    uint256 public maxPreMints = 100;
    uint256 public tokensPerWhitelistedAddress = 2;

    uint256 private nextToken = 5001;
    uint256 private startIndex_ = 5001;
    uint256 private endIndex_ = 6000;
