...
contract Swap is BEP20, Whitelist {
     ...
     * @param min_liquidity Minimum number of SLSL sender will mint if total SLSL supply is greater than 0.
     * @param max_tokens Maximum number of tokens deposited. Deposits max amount if total SLSL supply is 0.
