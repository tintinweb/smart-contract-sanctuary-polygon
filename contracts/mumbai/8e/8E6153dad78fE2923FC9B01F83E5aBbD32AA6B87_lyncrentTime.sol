...
contract lyncrentTime is ReentrancyGuard {
    address _owner;
    enum NFTStandard {
        E721,
        E1155
        ...
        )
    {
        ...
        tokenSellerStorage.tokenQuantity = _tokenQuantity;
        tokenSellerStorage.pricePerDay = _price;
        tokenSellerStorage.maxRentDuration = _maxRentDuration * 1 days;
    ...
    function checkTokenDurationExp()
        public
        view
        returns (RentersArrayStruct[] memory)
    {
        ...
        console.log(renterStructArray.length);
        uint256 k = 0;
    ...
    function checkAndReturnRentedNfts() external {
        ...
        console.log("owner and caller", _owner, msg.sender);
        RentersArrayStruct[] memory getExpired = checkTokenDurationExp();
