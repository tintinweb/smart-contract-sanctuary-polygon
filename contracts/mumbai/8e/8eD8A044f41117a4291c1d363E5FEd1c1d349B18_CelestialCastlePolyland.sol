 ...
 */
contract CelestialCastlePolyland is Ownable, IERC721Receiver, ICelestialCastle {
    ...
    modifier onlyPortal() {
        require(
            msg.sender == address(portalPolyland),
    ...
    function retrieveFreaks(
        ...
        for (uint256 i = 0; i < freakIds.length; i++) {
            ...
            if (tokenExists) {
                ...
                freaksNGuilds.setFreakAttributes(
                    freakIds[i],
                    freakAttributes[i]
                );
            } else {
    ...
    function retrieveCelestials(
        ...
        for (uint256 i = 0; i < celestialIds.length; i++) {
            ...
            if (tokenExists) {
                ...
                freaksNGuilds.setCelestialAttributes(
                    celestialIds[i],
                    celestialAttributes[i]
                );
            } else {
                freaksNGuilds.mintCelestial(
                    owner,
                    celestialIds[i],
                    celestialAttributes[i]
                );
