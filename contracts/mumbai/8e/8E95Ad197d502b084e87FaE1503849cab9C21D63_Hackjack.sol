    ...
    function fulfillRandomRequest(
        ...
        uint8 randomWord
            ...
            if (requestIndexToRequestInfo[requestIndex].requestType == requestType.dealNewHandPlayer) {
                ...
                if (hands[requestIndexToRequestInfo[requestIndex].handId].isWon || hands[requestIndexToRequestInfo[requestIndex].handId].isLostToDealer || 
                hands[requestIndexToRequestInfo[requestIndex].handId].isTied) {
                    return;
                }
                ...
                if (hands[requestIndexToRequestInfo[requestIndex].handId].dealerTotal > 21) {
                    hands[requestIndexToRequestInfo[requestIndex].handId].isWon = true;
