...
// SPDX-License-Identifier: MIT
/*
@author Aayush Gupta. Twitter: @Aayush_gupta_ji Github: AAYUSH-GUPTA-coder
 */
...
contract NFTMarketplace is ERC721URIStorage {
    ...
    // the price for placing NFT in our marketplace
    uint256 public listingPrice = 0.050 ether;

    // Address of marketplace OWNER
    ...
    // storing market status of NFT 
    mapping(uint256 => MarketItem) private idToMarketItem;


    /**
     * @dev constructor setting the onwer address
     */
    constructor() ERC721("BOBDAO","BD"){
        owner = payable(msg.sender);
    }

    /**
     * @dev updateListingPrice setting the price for NFT listing
     * @param _listingPrice getting the updated price of NFT listing
     */
    function updateListingPrice(uint256 _listingPrice) public payable {
        require(owner == msg.sender, "Only marketplace can change the listing price");
        // if(onwer != msg.sender){
        //     revert NOT_ONWER();
        // }
...
/**
    ...
    function fetchMarketItems() public view returns (MarketItem[] memory) {
        uint256 itemCount = _tokenIds.current(); // 20
        uint256 unsoldItemCount = _tokenIds.current() - _itemsSold.current(); // 20 -6 = 14
