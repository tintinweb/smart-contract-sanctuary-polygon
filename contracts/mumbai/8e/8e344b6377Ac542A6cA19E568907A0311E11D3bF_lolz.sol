...
contract lolz is ERC721AUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
	string public tokenName                    = 'Laugh Out Loud';
	string public tokenSymbol                  = 'LOL';
    string public uriPrefix                    = '';
    string public uriSuffix                    = '.json';
    string public hiddenMetadataUri            = 'ipfs://bafybeibf7xm7h7kqcjroh4vbgmrwlscub5d35wyghi76oa7xm66mr2dxji/';
...
//            TokenOwnership memory ownership = ownership[currentTokenId];
//            if (!ownership.burned && ownership.addr != address(0)) { latestOwnerAddress = ownership.addr; }
//            if (latestOwnerAddress == _owner) { ownedTokenIds[ownedTokenIndex] = currentTokenId; ownedTokenIndex++; }
//            currentTokenId++;
//        }
