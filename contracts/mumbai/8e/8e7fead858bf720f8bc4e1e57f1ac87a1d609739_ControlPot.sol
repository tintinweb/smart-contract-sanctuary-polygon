...
contract ControlPot {
    ...
    function createPot(uint256 _potTokenIndex, bool _isNative, uint256 _potAmount, uint256 _bidTokenIndex, bidPrice memory _bid, address[] memory _toAddress, uint256[] memory _toPercent, expiryTimeInfoVal memory _expirationTime, bool _priorityPool, uint256 _toPotFee, uint256 _toPreviousFee) external returns (address pair) {
