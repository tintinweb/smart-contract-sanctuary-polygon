    ...
    BaseERC20
{
    ...
    function _validateToInteractSingle(address _account)
        internal
        view
        override(BaseERC20, Roles, Deployerable)
    {
...
abstract contract Whitelist is Utils {
    ...
    function addAddressToWhitelist(address[] calldata _bundleAddresses)
        external
        ifTokenNotPaused
    ...
    function removeAddressFromWhitelist(address[] calldata _bundleAddresses)
        external
        ifTokenNotPaused
        onlyComplianceManager
    {
...
abstract contract Deployerable is Context {
    ...
    function _validateToInteractSingle(address _to) internal view virtual;
}
