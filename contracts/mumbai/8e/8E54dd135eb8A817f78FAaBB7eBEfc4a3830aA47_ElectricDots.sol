...
contract ElectricDots is ERC721, Ownable {
    ...
    uint public mintPrice = 0.000003 ether;
    ...
    function backgroundColors(
        ...
        string[8] memory bgColors = [
            "#F3D54E", // Yellow electric
            "#6889B7", // Blue lightning
            "#7C9F68", // Green circuit
            "#F2A359", // Orange voltage
            "#9C9C9C", // Gray metallic
            "#D55F4A", // Red current
            "#2C2C2C", // Black cable
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                '{"name": "Electric Dots #',
                                uint2str(tokenId),
                                '", "description": "Electric Dots are an assortment of 1M fully on-chain, randomly generated, electric dots", "attributes": "", "image":"data:image/svg+xml;base64,',
