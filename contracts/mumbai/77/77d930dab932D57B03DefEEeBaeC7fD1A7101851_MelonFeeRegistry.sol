...
/**
 * @title MelonFeeRegistry
 */
contract MelonFeeRegistry is IMelonFeeRegistry, OwnableRoles {
    // =============================================================
    //                           CONSTANTS
    // =============================================================
     ...
     */
    address public override melonFeeAddress;
    ...
    constructor(address melonFeeAddress_, uint16 platformFeeBPS_)
        onlyValidMelonFeeAddress(melonFeeAddress_)
        onlyValidPlatformFeeBPS(platformFeeBPS_)
    {
        melonFeeAddress = melonFeeAddress_;
    ...
    /**
     * @inheritdoc IMelonFeeRegistry
     */
    function setMelonFeeAddress(address melonFeeAddress_)
        external
        onlyOwner
        onlyValidMelonFeeAddress(melonFeeAddress_)
    {
        melonFeeAddress = melonFeeAddress_;
        emit MelonFeeAddressSet(melonFeeAddress_);
    }
    ...
    /**
     * @dev Restricts the melon fee address to be address(0).
     * @param melonFeeAddress_ The melon fee address.
     */
    modifier onlyValidMelonFeeAddress(address melonFeeAddress_) {
        if (melonFeeAddress_ == address(0)) revert InvalidMelonFeeAddress();
        _;
    }
