...
contract SubTokenManager is ISubTokenManager, Initializable ,ERC721EnumerableUpgradeable, OwnableUpgradeable {
    ...
    function initialize() public initializer {
        __ERC721_init("S10N Sub Token", "SST");
        __Ownable_init();
    }
    ...
    function _beforeTokenTransfer(address from, address to, uint256 tokenId) internal override(ERC721EnumerableUpgradeable) {
        ...
        if (from != to && from != address(0)) {
            ...
            if (plan.isSBT) revert("can not transfer SBT");
        }
