...
// }b
    ...
    function heldMatic() public view onlyOwner returns (uint256) {
        return _heldMatic;
    }
    
    function withdraw() public onlyOwner {
        uint256 amountToWithdraw = _heldMatic;
        _heldMatic = 0;
        (bool sent,) = payable(owner()).call{value: amountToWithdraw}("");
        require(sent, "Failed to send Matic to contract owner");
    }
