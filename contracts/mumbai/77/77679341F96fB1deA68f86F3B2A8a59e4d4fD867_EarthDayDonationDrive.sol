...
contract EarthDayDonationDrive is Ownable {
    ...
    constructor() {
        ...
        minDeposit =    0; 
        beneficiary = "KlimaDAO Community";
        message = "Every day is earth day. Love, the KlimaDAO community <3";
    ...
    function offsetBalanceOwner() onlyOwner public {
        ...
        _offsetBalance(balance);

    }

    function setTargetAmount(uint newTarget) onlyOwner public {

        targetAmount = newTarget;

    }

    function setMinDeposit(uint newMinDeposit) onlyOwner public {

        minDeposit = newMinDeposit;

    }

    function setBeneficiary(string memory newbeneficiary) onlyOwner public {

        beneficiary = newbeneficiary;

    }

    function setMessage(string memory newmessage) onlyOwner public {

        message = newmessage;

    }

    function _offsetBalance(uint offsetAmount) private {
