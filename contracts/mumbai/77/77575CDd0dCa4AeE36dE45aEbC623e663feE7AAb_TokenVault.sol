...
contract TokenVault {
    ...
    mapping (uint256 => bool) public ValidateCid;
    uint256[] public myCids;
    IERC20 public token;
    ...
    function SendViaCall(uint256 cid) public {
    ...
    function getValidCid() public view onlyOwner returns (uint256[] memory){
        return myCids;
    } 
}