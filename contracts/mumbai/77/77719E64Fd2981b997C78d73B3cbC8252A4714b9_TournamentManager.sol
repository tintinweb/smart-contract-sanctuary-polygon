...
contract TournamentManager is VRFConsumerBaseV2 {
  ...
  function createTeam(uint256[5] memory gotchis, uint256 gotchiLeader, uint32[5][2] memory gotchiFormation, string memory teamName) public {
    ...
    require(checkGotchiFormationValidity(gotchiFormation) == true, "Gotchi formation not valid");
  ...
  function checkGotchiFormationValidity(uint32[5][2] memory gotchiFormation) public pure returns (bool) {
