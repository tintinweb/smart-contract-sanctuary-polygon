...
contract VSMFounderPass is URISwitchable, ERC721, Ownable {  
	...
	// True if a specified proxy contract is given authority over this contract
	bool private _proxyApproved;
	address private _proxyAddress;

    constructor(address _operator, bool approveProxy, address proxy) ERC721("VSM01", "VSM_01") {
        operator = _operator;
    ...
    function _isApprovedOrOwner(address spender, uint256 tokenId) internal view override returns (bool) {
        return super._isApprovedOrOwner(spender, tokenId) || (_proxyApproved && spender == _proxyAddress);
    }
}
