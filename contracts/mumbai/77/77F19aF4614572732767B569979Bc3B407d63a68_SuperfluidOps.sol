...
contract SuperfluidOps {
    ...
    function createAction(
        FlowChangeType _flowChangeType,
        uint256 _actionTime,
        address _token,
        address _receiver,
        int96 _flowRate
    ...
    function checker(
        ...
        if (!_getBooleanFlowOperatorPermissions(permissions, _flowChangeType)) {
            execPayload = bytes(
    ...
    function _getCallAgreementData(
        ...
        if (_flowChangeType == FlowChangeType.CREATE_FLOW)
        ...
        if (_flowChangeType == FlowChangeType.UPDATE_FLOW)
            data = abi.encodeWithSelector(
        ...
        if (_flowChangeType == FlowChangeType.DELETE_FLOW)
            data = abi.encodeWithSelector(
