...
contract Web3Us3r is ERC721URIStorage {
    address payable public owner;

    //registrations
    mapping(string => address) public usernames;
    //users section
    mapping(string => string) public qts; //k
    mapping(string => string) public socs; //k
    mapping(string => string) public fbs; //k
    mapping(string => string) public mojis;
    mapping(string => string) public smojis;
    mapping(string => string) public xsmojis;
    mapping(string => string) public urls;
    mapping(string => string) public brnds;
    //brands section
    mapping(string => string) public clrs;
    mapping(string => string) public c2s;
    mapping(string => string) public qtbrnds;
    //user theme
    ...
    constructor() payable ERC721("WEB3USER", "WEB3USER") {
        owner = payable(msg.sender);
    }

    function registerName(string calldata name) public payable {
        require(usernames[name] == address(0));
        require(StringUtils.strlen(name) >= 1 && StringUtils.strlen(name) <= 18);
    ...
    function getNameAddress(string calldata name) public view returns (address) {
    ...
    function setBrnd(string calldata name, string calldata brnd) public payable {
      require(usernames[name] == msg.sender);
      brnds[name] = brnd;
    }

    function setMoji(string calldata name, string calldata moji) public payable {
      require(usernames[name] == msg.sender);
      mojis[name] = moji;
    }
    ...
    function hello() public onlyOwner {
