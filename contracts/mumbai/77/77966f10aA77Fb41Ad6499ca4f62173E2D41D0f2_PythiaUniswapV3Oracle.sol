...
import "@pythia-oracle/pythia-periphery/contracts/oracles/proto/uniswap/ManagedUniswapV3Oracle.sol";

contract PythiaUniswapV3Oracle is ManagedUniswapV3Oracle {
    constructor(
        ...
        address quoteToken_,
        uint256 period_
    ) ManagedUniswapV3Oracle(liquidityAccumulator_, uniswapFactory_, initCodeHash_, poolFees_, quoteToken_, period_) {}
}
