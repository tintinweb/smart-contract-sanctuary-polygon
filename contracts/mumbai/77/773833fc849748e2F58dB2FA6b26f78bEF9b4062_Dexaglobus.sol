...
contract Dexaglobus is Ownable{
    ...
    uint256 private constant dayReward2Percents = 750000000000000000000;
    ...
    constructor() public
    {
     BUSD = IERC20(0x710b2cb6E53E38583CB15C724A9024B3343082EA);
        ...
        feeReceivers = [0xC353bC8E1C4d3C6F4870D83262946E8C32e126b3, 0xC353bC8E1C4d3C6F4870D83262946E8C32e126b3, 0xC353bC8E1C4d3C6F4870D83262946E8C32e126b3];
        startTime = block.timestamp;
        lastDistribute = block.timestamp;
    ...
    function JUTTO_Deposit(address _tokenAddress, uint256 _tokenAmount) public {
    ...
    function BUSD_Deposit(address _tokenAddress, uint256 _tokenAmount) public {
    ...
    function _calLevelNow(address _user) private view returns(uint256) {
        ...
        if(total >= 200e18){
            ...
            if(total >= 200e18 && user.teamNum >= 4 && maxTeam >= 100e18 && otherTeam >= 100e18){
                levelNow = 5;
