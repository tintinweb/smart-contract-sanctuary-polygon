...
abstract contract ERC721Stakeable is Ownable{
    ...
    */
     modifier updateReward {
        ...
        uint256 periodPrize = _getTotalPrizesForPeriod(_msgSender());
         _resetStakerTimers(_msgSender());
        _totalRewardsPool -= periodPrize;
        unclaimedPrizes[_msgSender()] += periodPrize;
        _;
    }
...
contract GBotStaking is ERC721Receiver, ERC721Stakeable, ReentrancyGuard  {
    ...
    // stake
    function stake(uint256 tokenId) stakingNotFinished updateReward nonReentrant public {
    ...
    // claim prize
    function claimPrizes() nonReentrant updateReward public {        
    ...
    // withdraw
    function withdraw(uint256 tokenId) nonReentrant updateReward public {        
    ...
    // withdraw all
    function withdrawAll() updateReward virtual public {
