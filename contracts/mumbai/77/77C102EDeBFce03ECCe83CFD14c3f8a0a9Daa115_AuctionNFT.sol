...
contract AuctionNFT is Ownable, IERC721Receiver {
    ...
    event AuctionCreated(address indexed _tokenAddress, uint256 indexed _tokenId , uint256 auctionEnd , uint256 minBid , uint256 highestBid ,  address highestBidder  );
    event AuctionSettled(address indexed _tokenAddress, uint256 indexed _tokenId , uint256 auctionEnd , uint256 minBid ,  uint256 highestBid , address highestBidder   );
    ...
    function _resetAuction(address _tokenAddress, uint256 _tokenId) internal { 
         ...
         emit AuctionSettled(_tokenAddress, _tokenId ,  auctions[_tokenAddress][_tokenId].auctionEnd , auctions[_tokenAddress][_tokenId].minBid  , auctions[_tokenAddress][_tokenId].highestBid  , auctions[_tokenAddress][_tokenId].highestBidder   );
    ...
    function createAuction(
        ...
        emit AuctionCreated(_NFTContract, _tokenId , _auctionEnd , _minBid , 0 , address(0)  );
    }
