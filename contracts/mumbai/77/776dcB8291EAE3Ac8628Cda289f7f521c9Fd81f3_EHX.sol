...
contract EHX is ERC20, Ownable, AuthorizedRole {
    ...
    constructor(address stableCoin,address router) ERC20("Eterna", "EHX") {
        ...
        // console.log("dexRouter",address(dexRouter), dexRouter.factory(),dexRouter.WETH());
        ...
        lpPairEth = IDexFactory(dexRouter.factory()).createPair(address(this), address(dexRouter.WETH()));
        // console.log("whitelist pending");
