...
contract ABArenaBattles is AccessControl {
    ...
    uint64 public bestAngel = 300; //experience of the top angel in the game.
    ...
    function getAuraEffects(uint64 battleId) public {
        uint16 power;
        uint16 speed;
        uint16 defenseBuff;
        uint8 accSeriesId;
    ...
    function auraPassive(uint64 battleId) public {
    ...
    function beforeRound(uint64 battleId) public {
    ...
    function getOrder(uint64 battleId) public returns (bool) {
        ...
        if (chance >= (30 + Battles[battleId].angelTeam.speed)) {
