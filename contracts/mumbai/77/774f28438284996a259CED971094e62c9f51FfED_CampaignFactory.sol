...
contract ERC1155Token is ERC1155, Ownable {
    ...
    /*
    constructor is executed when the campaign contract calls its own deployERC1155 method
    */
...
contract CampaignFactory {
    ...
    // BasicProjectInfos[] public basicProjectInfos;
    ...
    function createCampaign(
        ...
        newCampaign.deployERC1155(_name, _rewards[0].ImageLink);

        // BasicProjectInfos memory newBasicProjectInfos = BasicProjectInfos({
        //     name: _name,
        ...
        //     imageUrl: _imageUrl,
        //     manager: msg.sender,
        //     campaignNFT: address(newCampaign.campaignNFT()),
        //     campaign: address(newCampaign)
        // });

        // basicProjectInfos.push(newBasicProjectInfos);
        ...
        emit campaignCreated(
            ...
            _pdfUrl,
            _videoUrl,
            address(newCampaign.campaignNFT()),
            address(newCampaign)
        );
    }
    ...
    // function getBasicProjectInfos()
    //     public
    //     view
    //     returns (BasicProjectInfos[] memory)
    // {
...
contract Campaign {
    ...
    ERC1155Token public campaignNFT;
    ...
    function contribute(uint256 _amount) external {
        require(
            _amount > rewards[0].contribution,
    ...
    function deployERC1155(
        ...
        campaignNFT = new ERC1155Token(_contractName, _uri);

        emit ERC1155Created(msg.sender, address(campaignNFT));
        return address(campaignNFT);
    }
    ...
    function mintERC1155(
        ...
        campaignNFT.setURI(_URI);
        campaignNFT.mint(tx.origin, _id, amount);
        emit ERC1155Minted(campaignNFT.owner(), address(campaignNFT), amount);
    }
    ...
    {
        return (name, shortDescription, category, endAt, imageUrl);
    }
