...
contract Evm721Starterdaip is ERC721, Ownable {
    ...
    uint256 public price = 1 * 10 ** 18; // 1 daip (because daip is a 6 decimal ERC20 token)
    string public baseUri = "https://bafkreifyb5jetemu2qf2pbid7246kvsumzsqim5z3jabr5zrb3fukh35ki.ipfs.nftstorage.link";

    constructor() payable ERC721("EVM 721 Starter daip", "daipXMPL") {
        daip = IERC20(0xa23d5DCD944BB156cCcE1f2a3938208ae5f770a3);
    }
    ...
    {
        daip.transferFrom(msg.sender, address(this), price * _quantity);
    ...
    /**
     * uint256 _newPrice - this price must include 18 decimal points
     * for example: 10 daip == 10_000_000
     * handle in function
     */
    ...
    function setdaipAddress(IERC20 _daip) public onlyOwner {
        daip = _daip;
    }

    function withdraw() public onlyOwner {
        daip.transfer(msg.sender, daip.balanceOf(address(this)));
    }
