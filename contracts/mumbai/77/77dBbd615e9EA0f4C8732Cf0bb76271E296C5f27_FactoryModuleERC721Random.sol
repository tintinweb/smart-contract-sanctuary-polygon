...
import "./DStorageERC721Random.sol";

/**
 * @title Factory module for dStorage ERC721 random
 *
 * @notice this implements a factory module to create a new instance of the
 * dStorage ERC721 random token contract
 */
contract FactoryModuleERC721Random is IFactoryModule {
    // members
    address private immutable vrfCoordinator;
    address private immutable vrfLink;
    bytes32 private immutable vrfKeyHash;
    uint256 private immutable vrfFee;
    ...
    function createToken(
        ...
        DStorageERC721Random token = new DStorageERC721Random(
            name,
            symbol,
            uri,
            "",
