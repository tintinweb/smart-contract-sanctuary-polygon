...
contract PosterFactory is ERC1155OnChainMetadata {
    ...
    mapping(uint256 => uint256) private posterSupply;
    // Mapping of PosterID => Max # of Editions.
    mapping(uint256 => uint256) private posterMaxSupply;
    ...
    function createGiveaway(
        ...
        CountersUpgradeable.increment(tokenId);
        uint256 id = CountersUpgradeable.current(tokenId);
