...
contract ArtheBalls is Ownable, ERC721A , ERC2981 {
    ...
    //address private artheosAddress = 0xEc0eAbf773908b361B5c3Def745D89feeD95a580; // REAL ADDRESS
    address private artheosAddress = 0x386B91E7161435DEf55695EbE16C520BAda32aB0; // TEST ADDRESS

    //Constructor
    constructor(string memory _baseURI, uint16 _royaltyBasisPoints)
    ERC2981(artheosAddress, _royaltyBasisPoints)
    ERC721A("ArtheBalls", "BALL") {
        baseURI= _baseURI;
        _safeMint(artheosAddress, 40);
    }
    ...
    */
    function withdraw() external {
        address payable to = payable(artheosAddress);
