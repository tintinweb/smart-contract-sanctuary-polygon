    ...
    ERC721Burnable    
{
    ...
    event mintEve(string name, uint256 indexed tokenId, uint256 indexed price, string ipfsimage, string ipfsmetadata);
    event OrderPlace(
        address indexed from,
        uint256 indexed tokenId,
    ...
    returns (uint256)
    {
        ...
        emit mintEve(name, tokenId, value, ipfsimage, ipfsmetadata);
        return tokenId;
    }
    ...
    // Need to check below functions are need or not
