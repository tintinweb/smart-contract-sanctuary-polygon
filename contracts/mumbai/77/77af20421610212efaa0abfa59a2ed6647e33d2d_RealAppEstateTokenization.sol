...
// File: Contracts/20221212/RealAPPEstateTokenization.sol
...
/*
  ...
  ############################################
    ...
    Real Matter Technology Limited (c) 2022
       ...
       Asset Redemption for Redeem Tokens
...
// Interface Contract to access the real contract
//
contract RealAppEstateTokenization is RealAbstractTokenization {
    ...
    // REMARK : the only-checking is balanceOf[From]
    //
    function holder_Receive_Divident(
        address fromPool,
        //address to,
        uint256 redeemAmount_decimal18) 
        public {
    ...
    // from the Real Contract owner
    // only original NFT asset at assetId.ID_ASSET = 1
    function owner_Mint_More_RealEstate_AssetToken(
        address toHolder,
        uint256 moreSupply)
        public {
    ...
    // mint additional Asset Edition on top of the first NFT
    // auto tokenId > 1
    function owner_Mint_New_RealEstate_ExtensionToken(
        address editionOwner,
        string memory editionURI,
        uint256 editionSupply)
        ...
        string memory realText0 = "New edition of Real Estate minted [Token ID , New total Supply]";
        uint256 realNumber1 = _editionId;
