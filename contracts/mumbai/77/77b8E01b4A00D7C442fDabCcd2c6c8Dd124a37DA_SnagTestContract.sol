...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x7d70c37FeA96103419e2A5f82548086b50bA3726];
...
// File: contracts/SnagTestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract SnagTestContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/KiBCEqq3ETgQ7rolCwxH/contract-metadata";
  }
