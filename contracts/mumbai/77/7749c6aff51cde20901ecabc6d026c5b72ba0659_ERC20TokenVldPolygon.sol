...
/**
 * @title ERC20 token with EIP-3009 extension (https://github.com/ethereum/EIPs/blob/master/EIPS/eip-3009.md)
 * @author Mikhail Strelkov <[email protected]>
 */
contract ERC20TokenVldPolygon is ERC20Burnable, EIP712Domain {

    /**
     * @param _totalSupply Total supply of tokens, minted to account deploying this contract
     */
    constructor(uint256 _totalSupply, string memory name, string memory symbol) ERC20(name, symbol) public {
