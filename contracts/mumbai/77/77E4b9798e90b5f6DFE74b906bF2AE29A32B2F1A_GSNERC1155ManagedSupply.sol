...
contract GSNERC1155ManagedSupply is Managable, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    function uri(uint256 id) public view virtual override returns (string memory) {
        require(
            exists(id),
            "GSNERC1155ManagedSupply: this id is not minted"
        );
        return string(abi.encodePacked(_uri, _metadataHash[id]));
    }

    function balanceOf(address account, uint256 id) public view virtual override returns (uint256) {
        require(account != address(0), "GSNERC1155ManagedSupply: balance query for the zero address");
    ...
    {
        require(accounts.length == ids.length, "GSNERC1155ManagedSupply: accounts and ids length mismatch");
    ...
    function addBatchMaxSupply(
        ...
        for(uint256 a; a < ids.length; a++){
            require(
                ids[a] <= maxId(),
                "GSNERC1155ManagedSupply: Max id elapsed"
            );
    ...
    function burn(
        ...
        require(
            ...
            "GSNERC1155ManagedSupply: caller is not owner nor approved"
        );
    ...
    function mint(
        ...
        require(
            ...
            "GSNERC1155ManagedSupply: Max supply reached!"
        );
    ...
    function safeBatchTransferFrom(
        ...
        require(
            from == _msgSender() || isApprovedForAll(from, _msgSender()),
            "GSNERC1155ManagedSupply: transfer caller is not owner nor approved"
        );
    ...
    function _safeTransferFrom(
        ...
        require(to != address(0), "GSNERC1155ManagedSupply: transfer to the zero address");
        ...
        require(fromBalance >= amount, "GSNERC1155ManagedSupply: insufficient balance for transfer");
        unchecked {
    ...
    function _safeBatchTransferFrom(
        ...
        require(ids.length == amounts.length, "GSNERC1155ManagedSupply: ids and amounts length mismatch");
        require(to != address(0), "GSNERC1155ManagedSupply: transfer to the zero address");
    ...
    function _mint(
        ...
        require(to != address(0), "GSNERC1155ManagedSupply: mint to the zero address");
    ...
    function _burn(
        ...
        require(from != address(0), "GSNERC1155ManagedSupply: burn from the zero address");
        ...
        uint256 fromBalance = _balances[id][from];
        require(fromBalance >= amount, "GSNERC1155ManagedSupply: burn amount exceeds balance");
        unchecked {
            _balances[id][from] = fromBalance - amount;
        }
    ...
    function _setApprovalForAll(
        ...
        require(owner != operator, "GSNERC1155ManagedSupply: setting approval status for self");
        ...
        if (to.isContract()) {
            try IERC1155Receiver(to).onERC1155Received(operator, from, id, amount, data) returns (bytes4 response) {
                if (response != IERC1155Receiver.onERC1155Received.selector) {
                    revert("GSNERC1155ManagedSupply: ERC1155 rejected tokens");
                }
            } catch Error(string memory reason) {
                revert(reason);
            } catch {
                revert("GSNERC1155ManagedSupply: transfer to non ERC1155Receiver implementer");
            }
        }
    }
