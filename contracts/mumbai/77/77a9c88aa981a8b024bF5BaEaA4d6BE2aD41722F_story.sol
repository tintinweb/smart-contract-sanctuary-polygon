        ...
        return
            string(
                abi.encodePacked(
                    ...
                    '</tspan></text><text fill="#fff" font-family="Times" font-size="10" font-weight="400"><tspan x="10" y="40">',
                    abi.encodePacked("INCIDENT: ", _incident.incident),
                    '</tspan></text><text fill="#fff" font-family="times" font-size="10" font-weight="400"><tspan x="10" y="270">',
                    abi.encodePacked("STORY: #", Strings.toString(_storyId)),
                    '</tspan></text><text fill="#fff" font-family="times" font-size="10" font-weight="400"><tspan x="10" y="290">',
