...
contract BurnToClaim is ERC721LazyMint {
 ...
 function verifyClaim(address _claimer, uint256 _quantity)
        ...
        override
    {
        ...
        require(mainNFT.balanceOf(_claimer) >= _quantity, "You don't own enough main NFTs");
        // - They own an NFT from the SerumClone contract
        require(burnNFT.balanceOf(_claimer, 0) >= _quantity, "You don't own enough burn NFTs");
    }
