...
contract Whitelist {
    ...
    // ユーザのアドレスがホワイトリスト登録されているかを返すマッピング
    ...
    function removeUserAddressFromWhitelist(address _whitelistedAddress)
        public
        onlyOwner
    {
        require(
            whitelistedAddresses[_whitelistedAddress],
