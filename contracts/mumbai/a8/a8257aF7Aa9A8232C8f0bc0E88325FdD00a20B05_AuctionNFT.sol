...
contract AuctionNFT is Ownable {
    ...
    function setMinimumBidPercentage(uint256 _minimumBidPercentage)
        external
        onlyOwner
    {
        minimumBidPercentage = _minimumBidPercentage;
    }

    function setOwnersCut(uint256 _ownersCut) external onlyOwner {
    ...
    function _transferNFTAndPaySeller(address _tokenAddress, uint256 _tokenId)
        internal
    {
        auctions[_tokenAddress][_tokenId].NFTContract.safeTransferFrom(
            address(this),
            auctions[_tokenAddress][_tokenId].highestBidder,
            _tokenId,
            auctions[_tokenAddress][_tokenId].amount,
            ""
        );
    ...
    function _resetAuction(address _tokenAddress, uint256 _tokenId) internal {
        emit AuctionSettled(
            _tokenAddress,
            _tokenId,
            auctions[_tokenAddress][_tokenId].auctionEnd,
            auctions[_tokenAddress][_tokenId].minBid,
            auctions[_tokenAddress][_tokenId].highestBid,
            auctions[_tokenAddress][_tokenId].highestBidder,
            auctions[_tokenAddress][_tokenId].nftSeller,
            auctions[_tokenAddress][_tokenId].amount
        );
    ...
    {
        require(
            auctions[_tokenAddress][_tokenId].nftSeller == msg.sender,
            "NFTAuction:: Only nftSeller can cancel auction"
        );
        auctions[_tokenAddress][_tokenId].NFTContract.safeTransferFrom(
            address(this),
            auctions[_tokenAddress][_tokenId].nftSeller,
    ...
    function _createAuction(
        ...
        NFTContract.safeTransferFrom(_msgSender(), address(this), _tokenId,_amount,"");
        ...
        auctions[_NFTContract][_tokenId].amount = _amount;
    ...
    function createAuction(
        ...
        _createAuction(_NFTContract, _tokenId, _minBid, _auctionEnd,_amount);
        emit AuctionCreated(
            _NFTContract,
            _tokenId,
            _auctionEnd,
    ...
    function rescueMATICFromContract() external onlyOwner {
