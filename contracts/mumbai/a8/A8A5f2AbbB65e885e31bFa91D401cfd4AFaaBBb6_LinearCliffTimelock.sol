...
contract LinearCliffTimelock is ReentrancyGuard, AccessControlEnumerable {
    bytes32 public constant CLAIMER_ROLE = keccak256("CLAIMER_ROLE");

    string private constant ERROR_NOT_ALLOWED = 'ERROR_NOT_ALLOWED';
    ...
    function initialize(
        ...
        require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender), ERROR_NOT_ALLOWED);
    ...
    function withdraw() public nonReentrant mustBeInitialized {
        require(msg.sender == beneficiary || hasRole(CLAIMER_ROLE, msg.sender), ERROR_NOT_ALLOWED);
