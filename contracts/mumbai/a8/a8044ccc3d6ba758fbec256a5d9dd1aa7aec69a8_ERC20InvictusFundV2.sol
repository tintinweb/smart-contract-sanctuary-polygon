...
contract ERC20InvictusFundV2 is OwnableUpgradeable, ERC20PresetMinterPauserUpgradeable {
  ...
  function queueInvestment(
    ...
    investments.push(Investment(amount, time, chainId, index, investmentTicker, transactionHash, investor));
    emit InvestmentRequest(amount, time, investmentTicker, transactionHash, investor, chainId, index);
  }
