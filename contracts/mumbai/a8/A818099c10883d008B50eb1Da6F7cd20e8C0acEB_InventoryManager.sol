...
contract Bodies2 {
string public constant body4 ="body4";
string public constant body5 ="body5";
string public constant body6 ="body6";
...
contract Helms2 {
string public constant helms4 ="helms4";
string public constant helms5 ="helms5";
string public constant helms6 ="helms6";
...
string public constant mainhand4 ="mainhand4";
string public constant mainhand5 ="mainhand5";
string public constant mainhand6 ="mainhand6";
...
string public constant offhand4 ="offhand4";
string public constant offhand5 ="offhand5";
string public constant offhand6 ="offhand6";
...
contract InventoryManager {
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                ...
                                svg,
                                '",',
                                getAttributes(body_, helm_, mainhand_, offhand_),
                                '}'
                            )
                        )
                    )
    ...
    function getAttributes(uint8 body_, uint8 helm_, uint8 mainhand_, uint8 offhand_) public pure returns (string memory) {
       return string(abi.encodePacked(
           '"attributes": [',
