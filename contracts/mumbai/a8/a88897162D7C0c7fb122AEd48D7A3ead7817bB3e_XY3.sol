...
// File: interfaces/ILoanStatus.sol
...
// File: interfaces/IFlashExecPermits.sol
...
// File: interfaces/IServiceFee.sol
...
// File: interfaces/IDelegateV3.sol
...
contract InterceptorManager is AccessControl {
    ...
    function InterceptorManager_init() public {
        require(!initialized, "InterceptorManager Contract is already initialized");
    }
...
contract Config is AccessControl, Pausable, ReentrancyGuard, IConfig {
     ...
     */
    function Config_init(address _admin, address _addressProvider) public {
...
contract LoanStatus is ILoanStatus {
    ...
    uint32 public totalNumLoans;
    mapping(uint32 => LoanState) private loanStatus;

    bool private initialized;

    function LoanStatus_init() public {
        require(!initialized, "LoanStatus Contract is already initialized");
        totalNumLoans = 100000;
    }
