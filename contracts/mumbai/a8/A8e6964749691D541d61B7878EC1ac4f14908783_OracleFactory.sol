...
contract OracleFactory is Ownable, OracleInterfaceID {
    ...
    function _submitUpdates(
        ...
        try IPyth(_feed).updatePriceFeedsIfNecessary{ value: _fee }(_updates, _ids, _times) {
            needed = true;
    ...
    function updatePriceFeeds(
        ...
        if (numPythOracles == _priceIds.length || numPythOracles == 0) {
            ...
            if (!_submitUpdates(priceFeed, fee, _updateData, _priceIds, _publishTimes)) {
                revert("not needed");
            }
        } else {
            ...
            bool needed;
            {
                ...
                needed = _submitUpdates(pyth, pythFee, updates, ids, times);
            }
            {
                // remaining oracles
                ...
                needed = needed || _submitUpdates(onDemandFeed, onDemandFee, updates, ids, times);
            }
