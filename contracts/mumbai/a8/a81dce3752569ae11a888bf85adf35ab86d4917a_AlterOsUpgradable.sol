    ...
    ReentrancyGuardUpgradeable
{
    ...
    function buyAssetFromListing(
        ...
        emit ListingSold(msg.sender,listing.seller,listing.creators,listingId,block.timestamp,assetId);
    }
    ...
    function getBalance() public view returns (uint256) {
        require(contractOwner == msg.sender, "Only owner can get balance");
        return address(this).balance;
    }

    function withdraw() external virtual {
        require(contractOwner == msg.sender, "Only owner can withdraw amount");
