...
contract Lobby is Ownable {
    ...
    event EnlistedMultiPlayer(uint lobbyNumber, uint charId);
    event EnlistedSoloPlayer(uint gameNumber, uint charId);
    ...
    function enlistForMission(uint _charId, address charOwner) public {
        ...
        emit EnlistedMultiPlayer(lobbies.length-1, _charId);
    }
    ...
    function enlistSolo(uint _charId, address charOwner) public {
        ...
        emit EnlistedMultiPlayer(gameStarted, _charId);
