...
contract OwnaLendingBorrowing {
    ...
    */
    ...
    function borrowLoan(uint256 _id , address _borrower,uint256 _amount) public {
        ...
        uint256 totalLenderDebt = repayWithMonthly.add(repayLoanInterestFee).add(_amount); // added
        ...
        //Store val in Structure of FixBorrow
         ...
         fixBorrow[fix.fixedId].lenderTotalDebt = totalLenderDebt; // added
         ...
         emit FixBorrow(fixBorrow[fix.fixedId].borrower, fixBorrow[fix.fixedId].loanAmount, fixBorrow[fix.fixedId].lender,  fixBorrow[fix.fixedId].totalRepayDebt, fixBorrow[fix.fixedId].cummulatedMonthlyInterest, fixBorrow[fix.fixedId].dailyFixInterest);
            ...
            uint256 totalLenderDebt = repayLoanInterestFee.add(repayMonthlyInterest).add(repayAcceptableDebt).add(_amount); // added
            ...
            flexibleBorrow[flexible.flexibleId].totalRepayDebt = totalLenderDebt; // added
            ...
            emit FlexibleBorrow(flexibleBorrow[flexible.flexibleId].loanAmount, flexibleBorrow[flexible.flexibleId].lender,  flexibleBorrow[flexible.flexibleId].totalRepayDebt, flexibleBorrow[flexible.flexibleId].cummulatedFlexibleInterest,flexibleBorrow[flexible.flexibleId].dailyFlexibleInterest);
