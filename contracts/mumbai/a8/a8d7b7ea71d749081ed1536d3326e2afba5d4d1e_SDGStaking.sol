...
contract SDGStaking is IStaking, AccessControlUpgradeable, ReentrancyGuardUpgradeable {
    ...
    IERC20 _usdc;
    IBorderlessNFT _nft;
    CountersUpgradeable.Counter _epochCounter;
    CountersUpgradeable.Counter _initiativesCounter;
    EnumerableSetUpgradeable.AddressSet _activeStrategies;
    EnumerableSetUpgradeable.UintSet _activeInitiatives;
    ...
    mapping(StakeStatus => EnumerableSetUpgradeable.UintSet) _stakeStatusToStakeIds;
    mapping(uint256 => Initiative) _initiatives;

    function initialize(address nft, address usdc) public initializer {
