...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    function enterRaffle(uint256) public payable {
        // revert()
        ...
        )
    {
        ...
        bool hasPlayers = (s_playerAddr.length > 0);
    ...
    function fulfillRandomWords(
        ...
        uint256 indexOfWinner = randomWords[0] % s_playerAddr.length;
        address payable recentWinner = s_playerAddr[indexOfWinner];
        s_recentWinner = recentWinner;
        s_playerAddr = new address payable[](0);
        s_raffleState = RaffleState.OPEN;
        s_lastTimeStamp = block.timestamp;
