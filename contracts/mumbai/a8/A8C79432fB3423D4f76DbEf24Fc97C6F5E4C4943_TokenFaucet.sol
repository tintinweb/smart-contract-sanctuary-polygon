...
contract TokenFaucet is ReentrancyGuard, Ownable {
    ...
    // one day
    uint256 public timeCycle = 86400; // 1 days
    ...
    function faucet(
        ...
        require(tokens.contains(_token), "Token does not supports");
        require(faucetAccountCached[msg.sender][_token] + timeCycle < block.timestamp, "Only faucet once per day");
