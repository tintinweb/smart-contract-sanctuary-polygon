    ...
    IAdventure
{
    ...
    function initialize(
        ...
        // 1h speed up potion
        allowedPotions[16711718] = true;
        // 3h speed up potion
        allowedPotions[16711782] = true;
        // 6h speed up potion
        allowedPotions[16711816] = true;
        // exp potion
        allowedPotions[16711832] = true;
        // strength potion
        allowedPotions[16711854] = true;
        reviveProduct = 31;
        finishImmediatelyProduct = 32;
    }
    ...
    function revive(uint256 ottoId_) external onlyEOA ottoCanRevive(ottoId_) {
        uint256 passId = _ottoPass[ottoId_];
        Pass storage p = _passes[passId];
        ...
        STORE.buy(msg.sender, reviveProduct, 1);
        p.revived = true;
        _award(p.ottoId);
    ...
    function canFinishAt(uint256 ottoId_) public view returns (uint256) {
        return latestPassOf(ottoId_).canFinishedAt;
    }
        ...
        ottoInAdventure(ottoId)
    {
        ...
        _passes[_ottoPass[ottoId]].canFinishedAt -= sec;
    }
    ...
    function setExpMultiplier(uint256 ottoId, uint32 multiplier)
        ...
        ottoInAdventure(ottoId)
    {
        _passes[_ottoPass[ottoId]].expMultiplier = multiplier;
    }
    ...
    function setItemAmountMultiplier(uint256 ottoId, uint32 multiplier)
        ...
        ottoInAdventure(ottoId)
    {
        _passes[_ottoPass[ottoId]].itemAmountMultiplier = multiplier;
    }
