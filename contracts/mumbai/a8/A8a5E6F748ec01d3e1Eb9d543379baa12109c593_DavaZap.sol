...
contract DavaZap is AccessControl, ReentrancyGuard {
    bytes32 public constant MANAGER_ROLE = keccak256("MANAGER_ROLE");
    IPartCollection public partCollection;

    event PartsCreateAndMinted(
        address indexed beneficiary,
        bytes32 categoryId,
        string title,
        string description,
        string ipfsHash,
        IPartCollection.Attribute[] attributes,
        uint256 maxSupply
    );

    constructor(address _partCollection) {
        partCollection = IPartCollection(_partCollection);
    ...
    function createAndMintAll(
        ...
        uint256 partId = partCollection.numberOfParts();

        partCollection.createPart(
            categoryId,
            title,
            description,
            ipfsHash,
        ...
        partCollection.mint(receiver, partId, maxSupply, "0x");
        emit PartsCreateAndMinted(
            receiver,
            categoryId,
            title,
            description,
