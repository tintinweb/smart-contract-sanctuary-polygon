...
contract TokenSale is ERC1155NoTransfer, Ownable, Pausable {
    ...
    //Mumbai
    address public yetiAdr = address(0x8AC5393A4af246DF921426eb2F6654440E9A0D25);
    address public frxstAdr = address(0x5A14e38B1faC27C5FBAD6e97539dc2979A434A9c);
    address public proxyAdr = address(0x1140085a68344b95e6e2859CA076Cba25B55348B);
    address public wethAdr = address(0x195fe6EE6639665CCeB15BCCeB9980FC445DFa0B);
    ...
    function BuyTokenForWeth(uint _nftId, uint _quantity) external PreReq(_nftId) whenNotPaused() {
        ...
        bool suc1 = weth.balanceOf(msg.sender) > price;
        require(suc1, 'weth balance insufficient');
        bool suc2 = weth.transferFrom(msg.sender, address(this), price);
        require(suc2, 'transfer failed');
    ...
    function BuyTokenForFrxst(uint _nftId, uint _quantity) external PreReq(_nftId) whenNotPaused() {
        ...
        bool suc1 = frxst.balanceOf(msg.sender) > price;
        require(suc1, 'frxst balance insufficient');
        bool suc2 = frxst.transferFrom(msg.sender, address(this), price);
        require(suc2, 'transfer failed');
        _mint(msg.sender, _nftId, _quantity, "");
