...
contract XPOLY is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 100000*10**uint256(_decimals);//100.000
    uint256 private constant _tTotal = 1000000*10**uint256(_decimals);//1.000.000
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = 'XPOLY';
    string private constant _symbol = 'XPY';
