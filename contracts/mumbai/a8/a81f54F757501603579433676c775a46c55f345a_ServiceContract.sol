...
contract ServiceContract is Ownable {
    ...
    function detachGolem(uint256 _golemTokenId) public {
        ...
        require(shrineTokenIdToPlaced[shrineTokenId], "ERR: Detach Golem - Shrine is not placed");
    ...
    function attachGolem(uint256 _shrineTokenId, uint256 _golemTokenId) external {
        ...
        require(shrineTokenIdToPlaced[_shrineTokenId], "ERR: Attach Golem - Shrine is not placed");
