...
contract SoulNotes is ERC721, ERC721Enumerable, AccessControl, Ownable {
  using Strings for uint256;
  uint256 counter = 100;
  struct SoulData {
    string message;
  ...
  IERC20 token =  IERC20(0x835378C18277E298df46C21451334E99e0a03928);
  uint256 public price = 0.000 ether ;
  uint256 public cost = 1 * 10**18 ;
  address public bank = 0x1c7C2FB462C6b2fC1067a12aB2ed13BA17dc2Dd5;
  mapping(uint256 => SoulData) public stickies;
  string public style =
  ...
  constructor() ERC721("Soul Notes", "THANKS") {
    _grantRole(DEFAULT_ADMIN_ROLE, 0x495B9F696B8b2af0c123a1a424f1F2364FCba9a8);
    _transferOwnership(0x495B9F696B8b2af0c123a1a424f1F2364FCba9a8);
  }
  ...
  function mint(
    ...
    token.transferFrom(msg.sender, bank , cost);
  ...
  function getSvg(uint256 tokenId) public view returns (string memory) {
    ...
    parts[
      4
    ] = "</style><foreignObject x='76' y='130' width='490' height='420'><div xmlns= 'http://www.w3.org/1999/xhtml' > <p id='text' class='bodyText'> soulnotes </p></div><script>var input = '";
    ...
    returns (string memory)
  {
    ...
    string memory json = Base64.encode(
      abi.encodePacked(
        '{"description":"send notes to any ETH wallet.","external_url":"https://projectvibe.xyz/","name":"',
        bytes(title).length > 0 ? title : "Note #",
  ...
  function _transfer(
    ...
    if (stickies[tokenId].isSBT) revert("SBTs cannot be transferred");
