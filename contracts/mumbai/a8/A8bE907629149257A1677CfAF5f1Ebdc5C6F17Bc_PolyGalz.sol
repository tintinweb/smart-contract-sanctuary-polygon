...
// File: PolyWRLD/IERC721Receiver.sol
...
contract PolyGalz is Ownable, ERC721A,  ReentrancyGuard, Pausable {

    string public baseURI;
    uint256 public teamSupply = 50;
    uint256 public constant price = 149 ether;
    uint256 public constant WLprice = 99 ether;
    uint public maxMintPerAccount = 500;
    uint256 public maxPolyGalz = 10000;
    ...
    modifier isSecured(uint8 mintType) {
        ...
        if(mintType == 2) {
            ...
            require(earlyAccessAddresses[msg.sender], "Not whitelisted");
        }
        _;
    }
     ...
     */
    function mintPresale(uint256 numberOfTokens) public payable nonReentrant whenNotPaused isSecured(2) {
        require(msg.value == WLprice * numberOfTokens, "INSUFFICIENT_PAYMENT");
        require(mintedforPresale[msg.sender] + numberOfTokens <= maxMintPerAccount, "EXCEEDS_MAX_PRESALE_MINT" );
        require(totalSupply() + numberOfTokens <= maxPolyGalz, "EXCEEDS_MAX_SUPPLY" );
   ...
   /**
    ...
    /**
     * Mint PolyGalz for the Team
     */
    function mintForTeam(uint256 numberOfTokens) external 
    
    
    nonReentrant 
    
    whenNotPaused onlyOwner {
        require(teamSupply > 0, "NFTS_FOR_THE_TEAM_HAVE_BEEN_MINTED");
        require(numberOfTokens <= teamSupply, "EXCEEDS_MAX_MINT_FOR_TEAM");
    ...
    /**
     * Returns PolyGalz of the Caller
     */
