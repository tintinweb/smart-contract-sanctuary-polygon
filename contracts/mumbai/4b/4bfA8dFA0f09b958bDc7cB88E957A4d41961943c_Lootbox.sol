...
contract Lootbox is ERC721URIStorage {
    uint public boxPrice = 0.001 ether; // Price per box. 1000000000000000 wei
    uint public maxItems = 35; // Max items that can be minted.
    ...
    function _baseURI() internal view virtual override returns (string memory) {
        // Change the CID to your own uploaded metadata in IPFS if applicable.
