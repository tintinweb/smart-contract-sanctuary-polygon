...
contract VRFBeacon is VRFBeaconOCR, VRFBeaconDKGClient {
    ...
    function requestAccountRecoveryEnrollment(bytes calldata publicKeyBytes) external {
    ...
    function getMostRecentEnrollRequest() external view returns (EnrollRequest memory) {
