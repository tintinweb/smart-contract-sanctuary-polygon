    ...
    AuctionSaleUpgradeable
{
    ...
    function preSaleChecks(address _nftAddress, uint256 _tokenId)
        internal
        returns (address)
    {
        require(
    ...
    function createSaleAuction(
        ...
        (saleReference.seller) = preSaleChecks(_nftAddress, _tokenId);
    ...
    function createSaleFixedPrice(
        ...
        (_seller) = preSaleChecks(_nftAddress, _tokenId);
    ...
    function _buy(uint256 _saleId) internal override {
        ...
        _payout(referenceFixedSale.seller, referenceFixedSale.fixedPrice);
    ...
    function _finishAuction(uint256 _saleId) internal override {
        ...
        // if there was a successful bid, pay the seller and transfer the token to the buyer
            ...
            // pay the seller, and distribute cuts
            _payout(referenceAuction.seller, referenceAuction.currentPrice);
            _transfer(
                referenceAuction.nftContract,
    ...
    PausableUpgradeable
{
     ...
     */
    function _payout(address _seller, uint256 _amount) internal {
