...
//    address[] public allBuyerAddress;
    ...
    IERC20 public USDT = IERC20(0xD05bffce7C7219e0ED48ad5f656043F43ecf6143);
    IERC20 public USDC = IERC20(0x3C0695560404BBd5Fc09e02E8924ed5eA8d9d776);
    struct TokenSale{
        uint soldToken;
        uint tokenForSale;
    }
    ...
    function getTokenAmountFromUSD(uint256 _usdAmount) public pure returns (uint256) {
        return (_usdAmount / 10**6) *1e18 * 100 / 5;
    }
    ...
    function buyWithToken(uint _tokentype, uint _amount) public {
        ...
        uint256 buyToken = getTokenAmountFromUSD(_amount);
    ...
    function withdrawStableCoins(address receiver, uint256 _amount) external onlyowner {
        require(isICOOver()==false,"It's not time to withdraw");
        USDT.transfer(receiver, _amount);
