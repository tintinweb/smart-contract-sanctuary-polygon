    ...
    PaymentBadgesAccessor
{
        ...
        returns (uint256)
    {
        ...
        require(
            rareSupply < 100,
            "SYB: Initial rare supply cant' be greater than 100"
        );
        require(
            epicSupply < 50,
