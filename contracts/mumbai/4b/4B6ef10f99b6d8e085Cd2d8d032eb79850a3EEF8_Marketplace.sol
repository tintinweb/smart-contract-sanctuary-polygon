...
contract Marketplace is Initializable, ERC721Upgradeable{
    ...
    address private collectionImplementation;
    ...
    function createCollection(string memory _collectionName, string memory _symbole) public returns (address) {
        ...
        // Test Collection instance with initialize
        collectionImplementation = address(new CollectionProxyOLD());
        CollectionProxyOLD(collectionImplementation).initialize(payable(address(this)),payable(msg.sender));
        return address(collectionImplementation);
    }
