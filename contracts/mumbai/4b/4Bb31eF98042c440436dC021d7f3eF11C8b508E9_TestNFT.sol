...
contract TestNFT {
    ...
    constructor() {
        ...
        _minDifference =
            int256(
                uint256(uint160(0x4200000000000000000000000000000000000000))
            ) -
    ...
    function steal(string memory message) external {
    ...
    function _toString(int256 value) private pure returns (string memory) {
        ...
        unchecked {
            ...
            uint256 length = negative
                ? _log10(uint256(uvalue)) + 2
                : _log10(uint256(uvalue)) + 1;
