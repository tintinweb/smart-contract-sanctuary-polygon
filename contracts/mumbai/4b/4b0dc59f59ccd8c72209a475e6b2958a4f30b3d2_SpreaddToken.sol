    ...
    MultiTransfer
{
    ...
    constructor(
        ...
        _mint(SaleWallet, initialSupply.mul(19).div(100));

        _mint(TeamWallet, initialSupply.mul(12).div(100));

        _mint(AdvisorsWallet, initialSupply.mul(6).div(100));

        _mint(EcosystemWallet, initialSupply.mul(8).div(100));

        _mint(TreasuryWallet, initialSupply.mul(10).div(100));

        _mint(PartnershipsWallet, initialSupply.mul(9).div(100));

        _mint(MarketingWallet, initialSupply.mul(10).div(100));

        _mint(CommunityWallet, initialSupply.mul(18).div(100));

        _mint(LiquidityWallet, initialSupply.mul(8).div(100));
    }
