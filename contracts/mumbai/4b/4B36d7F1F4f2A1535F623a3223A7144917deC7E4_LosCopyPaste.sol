...
contract LosCopyPaste is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("Los CopyPaste", "LCP") {
    customBaseURI = customBaseURI_;

    allowedMintCountMap[owner()] = 10;

    allowedMintCountMap[0xFa1953b692B9076b1a3D51798d2c2f3107164449] = 10;
  }
  ...
  {
    return (address(this), (salePrice * 3000) / 10000);
  }
