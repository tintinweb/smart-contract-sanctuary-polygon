...
contract PokemonGenesisSlab_RareMint is TokenDropBase {
    ...
    constructor()
        TokenDropBase(
            ...
            11.9 * 10**18, // 391 MATIC on Polygon (subject to be updated before the drop)
            ...
            0xb90Ff1E92244d5b8d27Cd4dA0E269242f3D073b6, // RareMint Registry deployed on Polygon Testnet
