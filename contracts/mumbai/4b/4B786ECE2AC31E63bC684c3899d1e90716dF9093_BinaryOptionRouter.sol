...
contract BinaryOptionRouter is AccessControl, IBinaryOptionRouter {
    using SafeERC20 for ERC20;
    uint16 public MAX_WAIT_TIME = 1 minutes;
    ...
    function setMaxWaitTime(uint16 _maxWaitTime)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        MAX_WAIT_TIME = _maxWaitTime;
    }
    ...
    function initiateTrade(
        ...
        IBinaryOptions optionsContract = IBinaryOptions(
            targetContract
        );
    ...
    function _openQueuedTrade(uint256 queueId, uint256 price) internal {
        ...
        uint256 amount;
        uint256 revisedFee;
        IBinaryOptions.OptionParams
            memory optionParams = IBinaryOptions.OptionParams(
                queuedTrade.expectedStrike,
                0,
                queuedTrade.period,
                queuedTrade.isAbove,
