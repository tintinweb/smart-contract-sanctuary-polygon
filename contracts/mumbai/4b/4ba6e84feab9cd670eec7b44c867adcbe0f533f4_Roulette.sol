...
contract Roulette is VRFConsumerBaseV2, ERC20, Ownable {
    ...
    constructor(
        ...
        bytes32 _keyHash,
        uint _fee
    )  ERC20("DOUBI_TOKEN", "DOUBI") VRFConsumerBaseV2(_vrfCoordinator) public {
        keyHash = _keyHash;
        fee = _fee; 
     ...
     * @param s signature param for the permit function
     */
    function rollBets(Bet[] memory bets,  uint256 nonce, uint expiry, bool allowed, uint8 v, bytes32 r, bytes32 s) public {
        uint256 amount = 0;
