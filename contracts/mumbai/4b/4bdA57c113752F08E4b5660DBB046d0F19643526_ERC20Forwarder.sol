...
contract ERC20Forwarder is ERC20ForwarderStorage, Ownable {
    ...
    function _verifySigEIP712(
        ...
        // console.log(block.timestamp + 20);
        require(
    ...
    function permitAndExecuteEIP712(
        ...
        uint256 initialGas = gasleft();
        //DAI permit
        console.log(permitOptions.owner);
        ...
        // console.log(IERC20(req.token).allowance(permitOptions.owner,permitOptions.spender));
        (success, ret) = _executeEIP712(req, domainSeparator, sig);
    ...
    function _transferHandler(
        ...
        console.log("executionGas----------->", executionGas);
        console.log("tokenGasPrice----------->", req.tokenGasPrice);
        charge = ((req.tokenGasPrice*(executionGas))*(BasisPoint))/(10000);
        console.log(charge);
        if (!safeTransferRequired[req.token]) {
            console.log("Safe Transfer is not allowed");
            ...
            console.log("Safe Transfer is  allowed");
