    ...
    UUPSUpgradeable
{
    ...
    function initialize(
        ...
        _marketAddress = address(0x2545943C4d9f6F4A617cEAbA91bd13eD37DeF1aD);
    }
    ...
    function adminUpdateMarketplaceAddress(address marketAddress)
        external
        onlyRole(ADMIN_ROLE)
    {
        ...
        returns (bool isOperator)
    {
        ...
        if (_operator == address(_marketAddress)) {
            return true;
        }
