...
library PlayerStorageLib {
    ...
    function _getTransferParams() internal view returns (address gateway, address contractOnChain) {
        TransferStorage storage s = diamondStorageTransfer();
...
contract PlayerFacet is ERC721FacetInternal {
    ...
    function getTransferParams() external view {
        PlayerStorageLib._getTransferParams();
    }
