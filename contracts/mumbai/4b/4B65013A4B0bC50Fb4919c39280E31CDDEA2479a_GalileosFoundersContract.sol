...
//   / ____/___ _/ (_) /__  ____ ( )_____   / ____/___  __  ______  ____/ /__  __________
//  / / __/ __ `/ / / / _ \/ __ \|// ___/  / /_  / __ \/ / / / __ \/ __  / _ \/ ___/ ___/
// / /_/ / /_/ / / / /  __/ /_/ / (__  )  / __/ / /_/ / /_/ / / / / /_/ /  __/ /  (__  ) 
// \____/\__,_/_/_/_/\___/\____/ /____/  /_/    \____/\__,_/_/ /_/\__,_/\___/_/  /____/  
//                                                                                       
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xFE7a4D2c78B5C77C4fcF7D4a17DCd4C802C8D50D];
  address public erc20Payable = 0xFE7a4D2c78B5C77C4fcF7D4a17DCd4C802C8D50D;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeicdwjug6v5gnwgsulzdug2e3myb723ip3ytkyr2fq34htfpfk3rai/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/HvpibpMGaFmpFUOuKD51/contract-metadata";
  }
