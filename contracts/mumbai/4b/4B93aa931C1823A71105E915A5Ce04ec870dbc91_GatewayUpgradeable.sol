    ...
    ReentrancyGuardUpgradeable
{
    ...
    event ValsetUpdatedEvent(uint64 indexed _newValsetNonce, uint64 _eventNonce, address[] _validators, uint64[] _powers);
    ...
    function updateValset(
        ...
        eventNonce++;
        emit ValsetUpdatedEvent(_newValset.valsetNonce, eventNonce, _newValset.validators, _newValset.powers);
    }
    ...
    function initialize(
        ...
        eventNonce++;
        emit ValsetUpdatedEvent(valsetNonce, eventNonce, _validators, _powers);
        // Constructor Fx
    }
