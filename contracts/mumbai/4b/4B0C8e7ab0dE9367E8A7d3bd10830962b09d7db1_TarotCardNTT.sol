...
import {ERC4671} from "./library/ERC4671.sol";
import {IERC4671Pull} from "./library/IERC4671Pull.sol";
import {IERC4671} from "./library/IERC4671.sol";
import "@openzeppelin/contracts/utils/introspection/IERC165.sol";
import "@openzeppelin/contracts/utils/cryptography/ECDSA.sol";
import "@openzeppelin/contracts/token/ERC721/ERC721.sol";

contract TarotCardNTT is ERC4671, IERC4671Pull, ERC721 {
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(IERC165, ERC4671, ERC721)
        returns (bool)
    {
        return
    ...
    function drawCard(address owner) external {
        require(_isCreator(), "You must be the contract creator");
        require(
            balanceOf(owner) == 0,
            "Your fate should only be on card at a time. Return your card for next future"
        );
    ...
    function _baseURI()
        internal
        pure
        override(ERC4671, ERC721)
        returns (string memory)
    {
        return
            "https://gateway.pinata.cloud/ipfs/QmWr1gcBxNpeBJKTsZA5JyDLrz4KhDmuzQ7HKg9pQwLTJS/";
    }
    ...
    function balanceOf(address owner)
        ...
        view
        virtual
        override(ERC4671, ERC721, IERC4671)
        returns (uint256)
    {
    ...
    ERC165
{
        ...
        returns (string memory)
    {
        ...
        if (baseURI.length > 0) {
            return
                string(
                    abi.encodePacked(baseURI, Strings.toString(tokenId), ".png")
                );
        }
        return "";
    }
