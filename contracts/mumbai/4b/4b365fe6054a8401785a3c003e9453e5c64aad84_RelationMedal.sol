...
contract RelationMedal is Ownable, Initializable,SemanticSBCore {
    ...
    function mint(uint256 _pIndex,uint256 _oIndex) external {
        require(whiteList[msg.sender], "Relation Medal: permission denied");
        require(!_ownedSBT[msg.sender][_pIndex][_oIndex], "Relation Medal: already minted");

        SubjectPO[] memory subjectPO = new SubjectPO[](1);
        subjectPO[0] = SubjectPO(_pIndex, _oIndex);

        mint(msg.sender, 0, new IntPO[](0), new StringPO[](0), new AddressPO[](0),
 ...
 */
contract SemanticSBCore is Ownable, Initializable, ERC165, IERC721Enumerable, ISemanticSBT, ISemanticSBTMetadata, ISemanticSBTOperator {
