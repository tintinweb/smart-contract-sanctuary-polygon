 ...
 * @dev FEAR NFT test.
 */
contract FearNftTest is ERC721Enumerable, AccessControl, Withdrawable, OpenSeaCompatible, IMRC721 {
    ...
    */
    ...
    constructor() ERC721("FEAR Nft Test", "FEARTEST") {
    ...
    function initialMint(address initialOwner) external onlyRole(MINTER_ROLE) {
        ...
        items[nextTokenId] = NftParams(true, param1, param2);
        nextTokenId++;
    }

    function transferParams(uint256 tokenId, uint256[] calldata params) external onlyRole(MINTER_ROLE) {
        require(!items[tokenId].set, "Params already set");
        items[tokenId] = NftParams(true, params[0], params[1]);
    }
