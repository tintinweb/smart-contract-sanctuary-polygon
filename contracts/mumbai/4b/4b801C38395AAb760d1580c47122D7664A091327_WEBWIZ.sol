...
contract WEBWIZ is ERC721Enumerable, Ownable, IRamperInterface721 {
    ...
    uint256 public tokenPrice = 42 ether; // Updated to a mutable state variable
    ...
    function price() override external view returns (uint256) {
        return tokenPrice; // Return the mutable token price
    }

    function setPrice(uint256 _newPrice) external onlyOwner {
        tokenPrice = _newPrice; // Set the new token price
    }
