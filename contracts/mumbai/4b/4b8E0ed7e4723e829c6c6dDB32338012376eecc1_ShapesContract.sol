  ...
  function _beforeTokenTransfer(
        ...
        Ownable
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x2e89d2599156E34E181c7FEb9966e0a945c5Fb41);
        ...
        */
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, "Cannot mint over supply cap of 498");
      ...
      require(mintingOpen == true, "Minting is not open right now!");    
        ...
        */
        function mintToMultiple(address _to, uint256 _amount) public payable {
            ...
            require(currentTokenId() + _amount <= SUPPLYCAP, "Cannot mint over supply cap of 498");
    ...
    // File: contracts/shapesContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract ShapesContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Shapes", "SNFT", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmY1Q6e7UGrWrYkLZmBEBWVLGTvYP5AqJjBWjaVSk4BdDL/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/kZ61NzRWnZ6L7t7HAGXS/contract-metadata";
        }
    }