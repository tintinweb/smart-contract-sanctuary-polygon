...
// Join our discord https://discord.gg/EZGUC79fKP
...
contract BankOfSleepyJoe is ReentrancyGuard {
    ...
    function reinvest() external nonReentrant {
        ...
        uint256 stimulusReward = getStimulusReward();
    ...
    function deposit(uint _amount) external nonReentrant {
        ...
        sleepy.payStimulus(address(this), stimulusReward);
        amountDeposited[msg.sender] += _amount + stimulusReward;
    ...
    function getStimulusReward() internal view returns (uint256) {
        uint256 oneYear = 31536000;
        uint256 stimulusRewardPerYear = (amountDeposited[msg.sender] *
            interestRateBPS) / 10000;
        uint256 timeElapsed = block.timestamp - lastInteracted[msg.sender];
