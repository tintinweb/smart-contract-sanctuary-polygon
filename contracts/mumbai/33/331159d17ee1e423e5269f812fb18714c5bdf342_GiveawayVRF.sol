...
contract GiveawayVRF is VRFConsumerBase {
    ...
    * Requests randomness 
    */
    function getRandomNumber(address winner) public returns (bytes32 requestId) {
    ...
    /**
    * Callback function used by VRF Coordinator to generate Loot ID
    */
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        giveaways[winners[requestId]] = (randomness % 222) + 7778;
    }
