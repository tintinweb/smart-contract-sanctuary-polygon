...
contract BribeFactoryV3 is OwnableUpgradeable {
    ...
    constructor() {}
    function initialize(address _voter, address _permissionsRegistry, address[] calldata defaultRewardTokens) initializer  public {
        __Ownable_init();   //after deploy ownership to multisig
        voter = _voter;
        
        //bribe default tokens
        for (uint i = 0; i < defaultRewardTokens.length; i++) {
