...
contract Hub is Ownable {
    ...
    constructor(address participationToken_) {
        participationToken = IParticipationToken(participationToken_);
    }

    // smaller uint can take more gass do more research
    ...
    function placeElement(
        ...
        emit PlacedElement(countOfPlacedElements, x, y, _msgSender(), value);

        countOfPlacedElements++;

        participationToken.mint(_msgSender(), 1);
    }
}
