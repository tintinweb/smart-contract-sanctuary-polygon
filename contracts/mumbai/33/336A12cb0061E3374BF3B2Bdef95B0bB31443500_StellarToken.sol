...
contract StellarToken is IERC20, IERC721Receiver {
    ...
    ISwapRouter private constant swapRouter = ISwapRouter(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff);
    ...
    /// For this example we are providing 1000 address(this) and 1000 MATIC_ADDRESS in liquidity
        ...
        )
    {
        ...
        TransferHelper.safeTransferFrom(address(this), msg.sender, address(this), amountStellarToMint);
        TransferHelper.safeTransferFrom(0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889, msg.sender, address(this), amountMaticToMint);

        // Approve the position manager
        TransferHelper.safeApprove(address(this), address(nonfungiblePositionManager), amountStellarToMint);
        TransferHelper.safeApprove(0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889, address(nonfungiblePositionManager), amountMaticToMint);

        INonfungiblePositionManager.MintParams memory params =
            INonfungiblePositionManager.MintParams({
                token0: address(this),
                token1: 0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889,
                fee: 3000,
                tickLower: -887272,
                tickUpper: 887272,
        ...
        if (amount1 < amountMaticToMint) {
            TransferHelper.safeApprove(0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889, address(nonfungiblePositionManager), 0);
            uint256 refund1 = amountMaticToMint - amount1;
            TransferHelper.safeTransfer(0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889, msg.sender, refund1);
        }
    }
