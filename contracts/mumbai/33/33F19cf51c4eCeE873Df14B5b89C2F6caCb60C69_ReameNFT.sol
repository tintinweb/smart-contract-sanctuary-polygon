...
contract ReameNFT is AccessControlUpgradeable, ERC1155SupplyUpgradeable
{
    ...
    {        
        _tokenId = _reamenftMint(msg.sender, msg.sender, _loyaltyFeePercent, _amount, _collectionId);
    ...
    function mintDelegate(
        ...
        _tokenId = _reamenftMint(_creator, _creator, _loyaltyFeePercent, _amount, _collectionId);
    ...
    {
        _tokenId = _reamenftMint(_creator, _receiver, _loyaltyFeePercent, _amount, _collectionId);
    ...
    function name() external pure returns (string memory) {
        return "ReameNFT Shared Storefront";
    }
