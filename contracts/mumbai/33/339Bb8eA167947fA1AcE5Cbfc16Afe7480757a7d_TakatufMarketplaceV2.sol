 ...
 */
contract TakatufMarketplaceV2 is Initializable, ReentrancyGuardUpgradeable{
    ...
    function _lazyMint(
        ...
        uint256 payment,
        LazyMintSellData calldata lazyMintSellData_
    ) private nonReentrant returns (uint256 offerId_, uint256 tokenId_) {
        (
            ContractType contractType,
            bool isERC1155
     ...
     */
    function _payout(Payout memory payoutData_) internal nonReentrant{
