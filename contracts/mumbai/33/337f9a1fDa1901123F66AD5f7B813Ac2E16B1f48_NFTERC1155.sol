...
// //@author GOLDPIERROT
// //@title Metabay Demo NFT Collection

// /*
//   /$$$$$$   /$$$$$$  /$$       /$$$$$$$  /$$$$$$$  /$$$$$$ /$$$$$$$$ /$$$$$$$  /$$$$$$$   /$$$$$$  /$$$$$$$$
//  /$$__  $$ /$$__  $$| $$      | $$__  $$| $$__  $$|_  $$_/| $$_____/| $$__  $$| $$__  $$ /$$__  $$|__  $$__/
// | $$  \__/| $$  \ $$| $$      | $$  \ $$| $$  \ $$  | $$  | $$      | $$  \ $$| $$  \ $$| $$  \ $$   | $$   
// | $$ /$$$$| $$  | $$| $$      | $$  | $$| $$$$$$$/  | $$  | $$$$$   | $$$$$$$/| $$$$$$$/| $$  | $$   | $$   
// | $$|_  $$| $$  | $$| $$      | $$  | $$| $$____/   | $$  | $$__/   | $$__  $$| $$__  $$| $$  | $$   | $$   
// | $$  \ $$| $$  | $$| $$      | $$  | $$| $$        | $$  | $$      | $$  \ $$| $$  \ $$| $$  | $$   | $$   
// |  $$$$$$/|  $$$$$$/| $$$$$$$$| $$$$$$$/| $$       /$$$$$$| $$$$$$$$| $$  | $$| $$  | $$|  $$$$$$/   | $$   
//  \______/  \______/ |________/|_______/ |__/      |______/|________/|__/  |__/|__/  |__/ \______/    |__/   
// */                                                                                                            
...
// contract NFTERC1155 is ERC1155, PaperVerification, Ownable {

//     using Strings for uint;

//     uint public price = 0 ether;
//     uint private constant MAX_MINT_AMOUNT = 1;
...
//     constructor(address _paperKey) ERC1155("") PaperVerification(_paperKey) {
//         name = "Test Demo";
//         symbol = "TDM";
//         tokenURI[0] = "ipfs://QmehnP6NeYPYApLXiPAjnQsmu6emBMnfPtayUt4a6YuXSa/";
//     }

//     function launchToken(uint256 _tokenId, string memory _uri) external onlyOwner {
//         setURI(_tokenId, _uri);
//     }

//     function getClaimIneligibilityReason(address _recipient, uint256 _quantity, uint256 _tokenId) public view returns (string memory) {
//         // if (amountNFTsperWallet[_userWallet] + _quantity > MAX_MINT_AMOUNT) {
//         //     return "You already minted this NFT!";
//         // }
//         // else 
//         if (_quantity > MAX_MINT_AMOUNT) {
//             return "Invalid mint amount";
//         }
//         else if (_tokenId != 0) {
//             return "Wrong token ID";
//         }
//         return "";
//     }

//     modifier mintCompliance(uint256 _quantity) {
//         // require(amountNFTsperWallet[msg.sender] + _quantity <= MAX_MINT_AMOUNT, "You already minted this NFT!");
//         require(_quantity == MAX_MINT_AMOUNT, "Invalid mint amount!");
//         _;
//     }

//     function paperMint(
//         PaperMintData.MintData calldata _mintData, uint256 _tokenId, bytes memory data) external payable onlyPaper(_mintData) mintCompliance(_mintData.quantity) {
//         // amountNFTsperWallet[msg.sender] += _mintData.quantity;
//         _mint(_mintData.recipient, _tokenId, _mintData.quantity, data);
//     }

//     function claimTo(address _account, uint256 _quantity, uint256 _tokenId) external payable mintCompliance(_quantity) {
...
contract NFTERC1155 is ERC1155, Ownable, PaperVerification {
    string public name;
    string public symbol;
