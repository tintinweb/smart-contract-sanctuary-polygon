    ...
    OwnableUpgradeable
{
    ...
    function createStrategy(
        ...
        require (
            keccak256(abi.encodePacked(strategies[execBundle].execBundle)) == hashedEmptyString, 
        ...
        emit StrategyCreated(strategyCreator, newStrategyTokenId, strategyName);
    }
     ...
     */
    function mint(address recipient, string calldata bundle) private returns (uint256) {
    ...
    function setMaxMaxGasPerAction(uint256 _maxMaxGasPerAction) external onlyOwner {
