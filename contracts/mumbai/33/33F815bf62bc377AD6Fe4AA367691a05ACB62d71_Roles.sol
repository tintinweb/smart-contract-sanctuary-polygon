...
contract Roles{
    ...
    event PrivateDataMinted(string title,string dataHash,string thumbnailURL,string description,int32 imageryDate,string country,string state,string district,address owner,string cordinates);
    ...
    function createPrivateSpatialData(string memory _title,string memory _description,string memory _fileURL,string memory _thumnailURL,string memory _imageURL,int32 _imageryDate,string memory _dataHash,string memory _country,string memory _state,string memory _district,string memory _cordinates) public{
        ...
        emit PrivateDataMinted(_title,_dataHash,_thumnailURL,_description,_imageryDate,_country,_state,_district,msg.sender,_cordinates);
    }
