...
abstract contract MerkleClaimERC721 is ERC721 {
  ...
  mapping(uint => bool) public hasClaimedToken;
  ...
  function claim(address to, uint256 tokenId, bytes32[] calldata proof) external {
    // Throw if token was already claimed
    require(!hasClaimedToken[tokenId], "Token already claimed");
