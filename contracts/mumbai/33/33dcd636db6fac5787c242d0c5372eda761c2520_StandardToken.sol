...
contract StandardToken {
    ...
    modifier onlyAdmin() {
        require(
            adminMap[msg.sender] != address(0) || msg.sender == toolAddress,
            "onlyAdmin"
        );
        _;
    }
    ...
    function addAdminForThisToolToken(
        address addr
    ...
    function deleteAdminForThisToolToken(
        address addr
    ) public onlyOwner returns (bool) {
        require(adminMap[addr] != address(0));
    ...
    function setToolAddress(
        address _toolAddress
...
contract Pepe is StandardToken {
    ...
    function safeTransfer(address token, address to, uint256 value) internal {
        ...
        require(
            ...
            "myTransferHelper: TRANSFER_FAILED"
        );
    }
