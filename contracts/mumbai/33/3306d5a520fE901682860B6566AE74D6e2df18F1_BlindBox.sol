...
contract BlindBox is OwnableUpgradeable, ItemPool, ReentrancyGuardUpgradeable {
    ...
    uint256 constant public all_count_n = 22;
    uint256 constant public all_count_s = 22;
...
abstract contract ItemPool {
    ...
    function _initItemPoolN() internal
    {
        ...
        item_pool_n.push(ITEM_POOL(1, 2, 100, 5000));
        item_pool_n.push(ITEM_POOL(1, 2, 200, 3500));
        item_pool_n.push(ITEM_POOL(1, 2, 500, 1200));
        item_pool_n.push(ITEM_POOL(1, 2, 100, 1000));
        item_pool_n.push(ITEM_POOL(1, 2, 200, 500));
        item_pool_n.push(ITEM_POOL(1, 2, 500, 100));
        item_pool_n.push(ITEM_POOL(10, 2, 1, 5000));
        item_pool_n.push(ITEM_POOL(11, 2, 1, 3500));
        item_pool_n.push(ITEM_POOL(12, 2, 1, 1200));
        item_pool_n.push(ITEM_POOL(13, 2, 1, 250));
        item_pool_n.push(ITEM_POOL(14, 2, 1, 50));
    ...
    function _initItemPoolS() internal
    {
        ...
        item_pool_s.push(ITEM_POOL(2, 2, 100, 250));
        item_pool_s.push(ITEM_POOL(2, 2, 200, 250));
        item_pool_s.push(ITEM_POOL(2, 2, 500, 50));
        item_pool_s.push(ITEM_POOL(2, 2, 100, 1000));
        item_pool_s.push(ITEM_POOL(2, 2, 200, 500));
        item_pool_s.push(ITEM_POOL(2, 2, 500, 100));
        item_pool_s.push(ITEM_POOL(20, 2, 1, 5000));
        item_pool_s.push(ITEM_POOL(21, 2, 1, 3500));
        item_pool_s.push(ITEM_POOL(22, 2, 1, 1200));
        item_pool_s.push(ITEM_POOL(23, 2, 1, 250));
        item_pool_s.push(ITEM_POOL(24, 2, 1, 50));
