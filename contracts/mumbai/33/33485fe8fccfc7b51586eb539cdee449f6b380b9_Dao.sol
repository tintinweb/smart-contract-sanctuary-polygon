...
contract Dao is ERC20{
    ...
    uint256 public totalSupply1 = 500000000000 * 10**18;
    string public name1 = "DAO TOKEN";
    string public symbol1 = "DAO";
    uint256 public decimals1 = 18;
  ...
  constructor() ERC20(name1, symbol1) {
    ...
    event proposalCount(
     ...
     function checkMonkBalance(address _proposalist) public view returns (bool
    ){
    ...
    function getProposal() public view returns (ProposalBrief[] memory){
         ProposalBrief[] memory briefData = new ProposalBrief[](nextProposal);
        for (uint256 i = 0; i < nextProposal; i++) {
