...
contract APIConsumer is ChainlinkClient, ConfirmedOwner {
     ...
     */
    function requestVolumeData(string memory pp, uint256 metal) public returns (bytes32 requestId) {
       ...
       // &base=XAU&currencies=EUR,XAU,XAG,USD'
        ...
        req.add('path', pp); // Chainlink nodes 1.0.0 and later support this format
