...
contract GamespadLand is ERC721Psi, AccessProtected, IERC721Receiver {
    ...
    uint256 private constant TOTAL_PLOTS = 90000;
    ...
    function mintLand(uint256 _quantity) external onlyAdmin {
        require(
            ...
            "GamespadLand: _quantity param of mintLands cannot be greater than the amount of TOTAL_PLOTS"
        );
        _safeMint(address(this), _quantity);
        require(totalSupply() <= TOTAL_PLOTS, "GamespadLand: totalSupply can exceed the amount of TOTAL_PLOTS");
    }
