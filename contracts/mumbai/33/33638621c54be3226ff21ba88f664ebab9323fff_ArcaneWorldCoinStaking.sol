...
contract ArcaneWorldCoinStaking is Ownable {
    ...
    //the percentage that is paid during the period 2.77% every month
    uint constant PERIOD_PERCENT = 277;
    //number of investors     
    ...
    function getWithdrawalBalance(address _target) public view returns(uint) {
        ...
        uint periodAmt = (lockupToken.amount * PERIOD_PERCENT) / 10000;
