...
contract Domains is ERC721URIStorage {
    ...
    // Indicates the upper bound of domain length from which the price doesn't decrease anymore, use one higher than intented, e.g if value is 11, the max is 10
