...
contract A4AMarket is Ownable, IERC721Receiver {
    ...
    address private a4A_NFT_address = 0xf235dCD788cBae22DE7cFc16641C3fC2C1b14670;
    ...
    modifier onlyOwnerOrA4A(uint256 itemID) {
        require( a4A_items.ownerOf(itemID) == _msgSender() || owner() == _msgSender(), "Sender is not authorized." );
        _;
    }
