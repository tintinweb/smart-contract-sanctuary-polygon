...
contract TestOneV4 is Ownable {
    ...
    uint256 private constant BASE = 136;
    ...
    uint256 private totalInvested = 82349 * DECIMALS;
    uint256 private totalInvestors = 348;
    ...
    function CreateLock(address payable _ref, uint256 _period) public payable {
...
// drip
    ...
    function calculate_nt(uint256 amount) public onlyOwner {
         uint256 amount2 = amount.mul(DECIMALS).div(1000);
