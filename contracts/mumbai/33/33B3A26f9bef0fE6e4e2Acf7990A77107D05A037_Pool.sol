...
contract Asset is Initializable, OwnableUpgradeable, ERC20Upgradeable {
     ...
     * @dev Not to be confused with transferring valve Assets.
...
/**
 * @title Core
 * @notice Handles math operations of Valve protocol.
 ...
 * @dev The main entry-point of Valve protocol
 *
 * Note The Pool is ownable and the owner wields power.
 * Note The ownership will be transferred to a governance contract once Valve community can show to govern itself.
 *
 * The unique features of the Valve make it an important subject in the study of evolutionary biology.
 */
contract Pool is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable, Core {
     ...
     * @param asset The address of the valve Asset contract
     */
     ...
     * @param to The user accountable for deposit, receiving the valve assets (lp)
