...
contract CompanyBoardTemplate is BaseTemplate {
    ...
    */
        ...
        external
    {
        ...
        string memory boardTokenName = string(abi.encodePacked("Board of ", _shareTokenName));
        string memory boardTokenSymbol = string(abi.encodePacked("BD_", _shareTokenSymbol));
