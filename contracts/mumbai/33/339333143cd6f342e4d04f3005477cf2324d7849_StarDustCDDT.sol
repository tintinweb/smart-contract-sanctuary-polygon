...
contract StarDustCDDT is ERC721A, Ownable {
    ...
    constructor(uint256 maxNftSupply, string memory _uri) ERC721A("Stardust | Central District | Down Town ", "StarCDDT") {
        baseTokenURI =_uri;
    ...
    function transfer(address to, uint256 tokenId)external payable onlyOwner{
        require(ownerOf(tokenId)== msg.sender,"This tokenId already transferred !");
