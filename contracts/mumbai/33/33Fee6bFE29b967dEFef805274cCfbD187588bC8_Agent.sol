...
library SignatureValidator {
    ...
    bytes4 public constant ERC1271_RETURN_VALID_SIGNATURE = 0x1626ba7e; //0x20c13b0b
    uint256 internal constant ERC1271_ISVALIDSIG_MAX_GAS = 250000;

    string private constant ERROR_INVALID_LENGTH_POP_BYTE =
        "SIGVAL_INVALID_LENGTH_POP_BYTE";
    ...
    function popFirstByte(bytes memory input)
        private
        pure
    ...
    function safeIsValidSignature(
        ...
        bytes memory data = abi.encodeWithSelector(
            ERC1271(validator).isValidSignature.selector,
            hash,
            signature
        );
        bytes4 erc1271Return = safeBytes4StaticCall(
            validator,
            data,
            ERC1271_ISVALIDSIG_MAX_GAS
        );
...
contract ERC1271 {
    ...
    bytes4 constant public ERC1271_RETURN_VALID_SIGNATURE =   0x1626ba7e; // TODO: Likely needs to be updated
