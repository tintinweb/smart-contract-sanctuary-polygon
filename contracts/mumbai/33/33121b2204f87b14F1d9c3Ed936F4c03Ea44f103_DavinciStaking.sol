...
contract DavinciStaking is Ownable, ERC721Holder, ERC1155Receiver, ERC1155Holder {
    ...
    constructor(IERC20Metadata token) {
        ...
        pools[poolType.SILVER] = PoolDetails(3 minutes, 50 * 10 ** decimals);
        pools[poolType.GOLD] = PoolDetails(6 minutes, 120 * 10 ** decimals);
        pools[poolType.VIP] = PoolDetails(12 minutes, 260 * 10 ** decimals);
    }
    ...
    function setPoolDetails(uint256 plan, uint256 duration, uint256 amount) external onlyOwner returns(bool) {
        ...
        pools[poolType(plan)] = PoolDetails(duration * 1 minutes, amount * 10 ** decimals); 
