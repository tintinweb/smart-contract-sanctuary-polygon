...
/** 
* @title istakpaza: USDT contract
* @notice this contract is used to mint and burn USDT 
**/
...
/** 
* @notice used initialize the contract
* @param owner_ address of owner for onlyOwner Role
**/
...
/** 
* @notice used to mint the USDT token
* @param to address of recipient 
* @param amount amount of usdt to mint
**/
...
/** 
* @notice used to burn the USDT token
* @param user address of recipient 
* @param _amount amount of usdt to burn from the  recipient address
**/

function burn(address user, uint256 _amount) public 
{
        _burn(user, _amount);
}
