...
contract SmartContractProva20230601 is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    function register(uint id, string memory hashCode, address portfolio, string memory tokenUri) public onlyOwner {
    ...
    function disableAndBurn(uint id, string memory hashCode) public onlyOwner { 
        require(id > 0 && id <= _TOTAL, "ID Bottiglia non appartenente alla collezione");
        require(_verify(id, hashCode), "Bottiglia non valida");
        require(_collection[id-1].status == _STATUS_OK, "Stato Bottiglia KO");
    ...
    function disable(uint id, string memory hashCode) public onlyOwner { 
        require(id > 0 && id <= _TOTAL, "ID Bottiglia non appartenente alla collezione");
        require(_verify(id, hashCode), "Bottiglia non valida");
        require(_collection[id-1].status == _STATUS_OK, "Stato Bottiglia KO");
        _collection[id-1].service = _SERVICE_DISABLED;
    ...
    function enable(uint id, string memory hashCode) public onlyOwner { 
        require(id > 0 && id <= _TOTAL, "ID Bottiglia non appartenente alla collezione");
        require(_verify(id, hashCode), "Bottiglia non valida");
        require(_collection[id-1].status == _STATUS_OK, "Stato Bottiglia KO");
        _collection[id-1].service = _SERVICE_ENABLED;
    ...
    function destroy(uint id, string memory hashCode) public onlyOwner {
        require(id > 0 && id <= _TOTAL, "ID Bottiglia non appartenente alla collezione");
        require(_verify(id, hashCode), "Bottiglia non valida");
        _collection[id-1].status = _STATUS_KO;
    }

    function reactivate(uint id, string memory hashCode) public onlyOwner {
        require(id > 0 && id <= _TOTAL, "ID Bottiglia non appartenente alla collezione");
        require(_verify(id, hashCode), "Bottiglia non valida");
    ...
    function supportsInterface(bytes4 interfaceId)
        public
        view
        override(ERC721, ERC721Enumerable, ERC721URIStorage) onlyOwner
        returns (bool)
    {
