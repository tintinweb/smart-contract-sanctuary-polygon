...
abstract contract DAOStandart is IDAO, AccessControl {
     ...
     * @return minimumQuorumPercent
     * @return duration of voting
    ...
    // function staticCall(address recipient, bytes calldata callData) external view returns(bool success, bytes memory result) {
    //     return (recipient.staticcall(callData));
    // }
}
