...
contract LevelPrice is ILevelPrice, Ownable {
    ...
    function setupLevels(
        ...
        for (uint256 i = 0; i < _levels.length; i++) {
            ...
            uint256 lower = _lowers[i];
            uint256 upper = _uppers[i];
            require(price > 0, "LevelPrice: price is zero");
            levels[level] = LevelRange(lower, upper);
            levelPrices[level] = price;
            levelKeys.push(level);
        }
        return true;
    }
        ...
        returns (uint256)
    {
        ...
        // }
        // revert("Not found");
        return getLevelandPriceById(_tokenId)[0];
    }
        ...
        returns (uint256)
    {
        ...
        // }
        // revert("Not found");
        return getLevelandPriceById(_tokenId)[1];
    }
