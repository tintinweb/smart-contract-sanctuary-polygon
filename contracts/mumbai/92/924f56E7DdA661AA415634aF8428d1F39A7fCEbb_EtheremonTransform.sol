...
interface EtheremonTradeInterface {
    ...
    function getOnTrade(uint256 _objId)  external view returns (uint8);
    function getOnTradeBool(uint256 _objId)  external view returns (bool);
...
function debugGetOnTrade( uint64 _objId) public view returns (uint8) {

         if (tradeContract != address(0)) {
            EtheremonTradeInterface trade = EtheremonTradeInterface(
                tradeContract
            );
            return trade.getOnTrade(_objId);
        }

    }

function debugGetOnTradeBool( uint64 _objId) public view returns (bool) {

         if (tradeContract != address(0)) {
            EtheremonTradeInterface trade = EtheremonTradeInterface(
                tradeContract
            );
            return trade.getOnTradeBool(_objId);
        }
...
function debugTransformedId( uint64 _objId) public view returns (bool) {
