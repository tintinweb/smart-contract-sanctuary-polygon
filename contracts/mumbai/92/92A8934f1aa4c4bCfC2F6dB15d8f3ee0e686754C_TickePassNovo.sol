...
//File： fs://fcabb4979b4f4ed4879c84ccf6d7bc41/projeto.sol
...
contract TickePassNovo is DefaultOperatorFilterer, ERC721A, Ownable {
  using Address for address;
  using Strings for uint256;
  ...
  constructor() ERC721A("NovoProjeto23", "teste") {    
    setBaseURI("https://ipfs.io/ipfs/QmUMCbap8CmNb4S8hSh7Dx2Xi5vagsByHBPs1Jg7yfZfF8");    
    _contractUri = "https://ipfs.io/ipfs/QmcZvKyHx8U3c7tQchoSYXDhsuPikWLCjhqbKTFjaYkePa";
    ...
    function airDrop(
      ...
      for (uint256 i = 1; i <= _mintAmount; i++) {
        ...
        _addressLastMintedTokenId[endUser] = newIdToken;
      }
      ...
      returns (uint)
    {
     ...
     function split(uint256 _mintAmount ) public payable{
      ...
      uint256 amountM = ownerAmount * royalties / 100;
