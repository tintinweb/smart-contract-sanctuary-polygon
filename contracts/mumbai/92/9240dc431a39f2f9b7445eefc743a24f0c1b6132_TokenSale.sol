...
contract Token is ERC20, ERC20Burnable, AccessControl {
    ...
    constructor() ERC20("JoJoToken", "JJT") {
        ...
        _mint(msg.sender, 66666666666 * (10 ** decimals()));
    }
    ...
    function sale(address to, uint256 amount) public onlyRole(SALE_ROLE) {
        _mint(to, amount);
    }
}
...
contract TokenSale {
    Token public token;
    uint256 public rate = 10000; // 每个 MATIC 可以兑换的 JJT 数量
