...
contract TraceNFTCar is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable, OwnableUpgradeable, ERC721BurnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize() initializer public {
        __ERC721_init("Trace NFT Car", "CAR");
    ...
    function safeMint(address to) external virtual nonReentrant onlyOwner {
    ...
    function safeMintWithTokenId(address to, uint256 tokenId) external virtual nonReentrant onlyOwner {
        _safeMint(to, tokenId);
    }
    ...
    function safeMintBatch(address[] memory recipients, uint256[] memory amounts) external virtual nonReentrant onlyOwner {
