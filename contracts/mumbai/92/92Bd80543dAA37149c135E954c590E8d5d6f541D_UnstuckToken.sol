...
import "./ReleasableLite.sol";

contract UnstuckToken is ERC20, AccessControl, ReleasableLite {
    constructor(
    ...
    ReleasableLite(__disallowed, __mutable)
    {
...
2. Add AccessControl to the contract declations.
