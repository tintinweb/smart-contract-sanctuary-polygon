...
contract MinterFactory is Ownable, Initializable {
    ...
    modifier onlyMinter() {
        require(
            publicMintAllowed || gov.hasRole(AUTHENTICATOR_ROLE, _msgSender()),
    ...
    function mintMultipleTo(address to, uint256[] memory tokenIds) external {
        ififa721.mintBatch(to, tokenIds);
    }

    /**
     * @dev function to allow user mint items
     */
    function allowPublicMint() public onlyManager {
