...
contract  FullOnchainTest5 is ERC721Enumerable, ERC721Permit("FullOnchainTest5NFT:Token"), ERC721Mintable, ReentrancyGuard, Ownable {

    string[] private letters ;
    string[] private fontColors ;
    string[] private backgroundColors ;

    constructor() ERC721("FullOnchainTest5NFT:Token", "FULL TEST") Ownable() {}
