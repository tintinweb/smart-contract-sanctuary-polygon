...
contract PiggyToken is ERC20, Ownable, ERC20Burnable {
    ...
    constructor() ERC20("Piggy Token", "PGGY") {
...
*/
    ...
    event SpecialNFTCashedOut(uint tokenId, address user, uint amount);
...
*/
    ...
    constructor(address _token) ERC721("SpecialNFT", "SpecialNFT") {
...
*/
    function cashOut(uint _tokenId) external {
        ...
        require(
            token.balanceOf(address(this)) >= depo.amount,
            "Insufficient balance"
        );

        token.transfer(msg.sender, depo.amount);

        depo.isCompleted = true;
        _burn(_tokenId);
        emit SpecialNFTCashedOut(_tokenId, msg.sender, depo.amount);
    }
