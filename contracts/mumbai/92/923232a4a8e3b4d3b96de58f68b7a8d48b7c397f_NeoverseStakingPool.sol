...
// File: contracts/NeoverseStakingPool.sol
...
contract NeoverseStakingPool is IRewardDistributionRecipient, ReentrancyGuard {
    ...
    function computeContribution(uint256 amountStaked) public pure returns (uint256) {
        return amountStaked;
    }
    ...
    function updateContribution(address account) internal {
        ...
        uint256 contribution = computeContribution(balanceOf(account));
