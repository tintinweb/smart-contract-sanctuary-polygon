...
// File: contracts/KAROOTIResellNFT.sol
...
contract KAROOTIResellNFT is IERC721Receiver, ReentrancyGuard, Ownable {
  ...
  function listSale(uint256 tokenId, uint256 price) public payable nonReentrant {
      ...
      require(msg.value == listingFee, "Please transfer 0.0025 coins to pay listing fee");
