...
contract RichieRich is VRFConsumerBaseV2 {
    ...
    uint256 public referralJackpot = 0;
    ...
    constructor(
        ...
        for(uint256 i=0;i<totalReferralWinners;i++){
            ...
            currentActiveBatch.push(randomAddress);            
        }
        ...
        referralCode[msg.sender] = 111111;
        referralCodeToAddress[111111] = msg.sender;
        isWhitelisted[0xdCdFae782d8429A75C345ac4C920e8dc605afD80] = true;
    }
