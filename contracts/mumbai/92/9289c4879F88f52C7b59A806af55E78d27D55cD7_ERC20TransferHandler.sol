...
contract ERC20TransferHandler is EIP712MetaTransaction, Ownable {
    mapping(address => bool) private coldWallet;

    constructor(address _coldWallet)
        EIP712MetaTransaction("ERC20TransferHandler", "1")
    {
        coldWallet[_coldWallet] = true;
    }
    ...
    function transfer(
        ...
        require(coldWallet[to], "NOT COLD WALLET");
