...
contract RandomReachDebug1 is ERC721URIStorage, Ownable, RrpRequesterV0 {
    ...
    constructor(address _airnodeRrp) RrpRequesterV0(_airnodeRrp) ERC721("MINT RANDOM DEBUG NFT", "MRND") {}
    ...
    function verify(
        ...
        bytes32 msgHash = keccak256(abi.encodePacked(nft.nonce, nft.from));
        address recovered = ecrecover(msgHash, sigV, sigR, sigS);
        emit Verified(signer, nft.nonce, nft.from, sigR, sigS, sigV, recovered);
