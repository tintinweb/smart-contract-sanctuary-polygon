...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1671541200;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1671372000;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  uint256 public PRICE = 35 ether;
  uint256 public EARLY_MINT_PRICE = 20 ether;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeifxxn6buumh5sk4ldlxebkkd6pwwdhb6awidrtjvhagnfe5fwlr4a/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/IvxYv5eHBRinrmFlK4EV/contract-metadata";
  }
...
// File: contracts/WonderBunnyClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WonderBunnyClubContract is RamppERC721A {
    constructor() RamppERC721A("Wonder Bunny Club", "WBC"){}
}
