...
contract CryptoTattooerzTokenDirectSale is CryptoTattooerzCurrencyHandler, Pausable, AccessControlEnumerable{
     ...
     */
    event TokensPurchased(address indexed beneficiary, uint256 amount, bytes32 indexed currency, uint256 price, uint8 discountRate, uint8 discountDecimals);
    /**
...
//            require(currency != getPriceHandler().TOKEN(), "CryptoTattooerzTokenDirectSale: Cannot change TOKEN address");
    ...
    function buyWithCoins() public payable returns (uint256) {
        ...
        (uint256 tokenAmount, uint8 discountRate, uint8 discountDecimals) =
     ...
     * paused
     */
    function _buy(address buyer, uint256 amount, bytes32 currency, uint256 price, uint8 discountRate, uint8 discountDecimals) private whenNotPaused() {
