...
contract MyNft is ERC721, Ownable, ERC2981 {
    ...
    uint256[] public withdrawPercentages = [85, 15];


    bytes32 public merkleRoot = 0;

    constructor() ERC721("@test", "t") {
        _baseTokenURI = "https://test-api.nftool.io/generator-server/api/contract/v1/hRMwmu5teCxVwHui0/1607265521805254657/metadata/";
