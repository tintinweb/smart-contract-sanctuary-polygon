...
contract ERC20Crowdsale is Crowdsale, WhitelistCrowdsale, Ownable, TimedCrowdsale {
    constructor(
        ...
        uint256 openingTime, 
        uint256 closingTime
    ) Crowdsale(rate, wallet, token) TimedCrowdsale(openingTime, closingTime) public{}
