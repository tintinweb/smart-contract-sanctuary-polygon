...
contract InflowPrivateSale is Ownable, ReentrancyGuard {
     ...
     */
    constructor(address token_,address adminWalletAddress_) {
        require(token_ != address(0x0));
        _token = IERC20(token_);
        adminWalletAddress = adminWalletAddress_;
    }

    mapping(bytes => bool) usedWhitelistSigs;

    address private adminWalletAddress = payable(adminWalletAddress);
    ...
    function buyTokens(
        ...
        int256 _inflowPrice,
        int256 _maticUsd
    ) public payable onlyOrigin returns (uint256 tokenAmount) {
        ...
        int256 inflowPrice = _inflowPrice;
