...
//-------------------------------ADMIN CALLER FUNCTION -----------------------------------
 ...
 // ADD NEW TRANSACTION 
    ...
    function getCurrentRunningTransactionId() external onlyMultiOwner view returns(uint){
    ...
    function _getAprrovalCount(uint _trnxId) public onlyMultiOwner view returns(uint ){
