...
abstract contract ERC2981 is IERC2981, ERC165 {
    ...
    /**
     * @dev to set royality of particular token.
     */
    ...
    /**
     * @dev to reset royality of particular token.
     */
    ...
    Whitelist
{
    ...
    /**
        *@dev Modifier-->Check if the address is not equal to zero address CheckZero
     */
