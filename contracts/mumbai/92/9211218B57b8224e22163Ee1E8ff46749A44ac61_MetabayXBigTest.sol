...
contract MetabayXBigTest is ERC2981, ERC721Enumerable, Ownable, Pausable {
    ...
    uint256 public price; // USDC 6 decimals
    uint256 public SUPPLY = 5; // EVOLUTIVE
    uint256 public immutable MAX_SUPPLY = 10; // MAXIMUM SUPPLY
    ...
    modifier mintCompliant(
        ...
        require(totalSupply() + _quantity <= SUPPLY, "MINT:Current suppply exceeded, wait for the next drop!");
        require(totalSupply() + _quantity <= MAX_SUPPLY, "MINT:Max supply exceeded, sale is over!");
        _;
    }
