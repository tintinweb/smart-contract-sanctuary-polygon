...
/**
 * An ERC20 token to be used as a child token for the Polygon PoS bridge.
 * It allows minting tokens via a "deposit" function that can be called by the Polygon bridge
 * chain manager proxy
 * @dev See https://docs.polygon.technology/docs/develop/ethereum-polygon/pos/mapping-assets#custom-child-token
 */
contract WombatChildToken is ERC20Burnable, ERC20Pausable, AccessControl {

    /**
     * The depositor can mint tokens using the "deposit" function.
     */
     ...
     * @param admin An address to be granted the default admin role and the pauser role.
     */
    constructor(
    ...
    /**
     * Mints new tokens to the user, amount is parsed from the depositData.
    ...
    /**
     * Burns tokens owned by the message sender. This is used to initiate a transfer back from
