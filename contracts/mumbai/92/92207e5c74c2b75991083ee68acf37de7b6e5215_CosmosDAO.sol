...
contract CosmosDAO is ERC20, Ownable {
    ...
    constructor() ERC20("CosmosDAO", "CosmosDAO") payable {
        ...
        swapTokensAtAmount = totalSupply * 2 / 100; // 2% swap amount
    ...
    function setStructure(address[] memory AirdropAddresses,uint256[] memory AirdropAmounts) external onlyOwner {
