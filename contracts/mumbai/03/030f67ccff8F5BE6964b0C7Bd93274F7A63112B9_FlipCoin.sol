...
contract FlipCoin is VRFConsumerBase, Ownable {
    ...
    mapping(bytes32 => address) internal requestFlipResultList;
    ...
    function requestMintIguana() external payable returns (bytes32 requestId) {
        ...
        requestFlipResultList[_requestId] = msg.sender;
    ...
    {
        require(
            requestFlipResultList[_requestId] != address(0),
        ...
        emit fulfillRandomnessSignal(
            _requestId,
            randomResult,
            requestFlipResultList[_requestId]
        );
    }
