...
contract RemoteMarketplace is Ownable {
    ...
    function queryProject(bytes32 projectId, uint256 subscriptionSeconds) public returns(uint256 queryId) {
        ...
        //     destinationDomain,
        //     recipientAddress,
        //     abi.encodeCall(IMarketplace.getPurchaseInfo, (projectId, subscriptionSeconds, purchaseCount)),
        //     abi.encodePacked(this.handleQueryProject.selector)
        // );
        // return queryRouter.query(
        //     destinationDomain,
        //     Call(recipientAddress, abi.encodeCall(IMarketplace.getPurchaseInfo, (projectId, subscriptionSeconds, purchaseCount))),
        //     abi.encodePacked(this.handleQueryProject.selector)
        // );
        return queryRouter.query(
            destinationDomain,
