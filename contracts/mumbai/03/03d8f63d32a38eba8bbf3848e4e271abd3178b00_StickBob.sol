...
/**
 * Hello, I'm Bob. Found on Ethereums interchain solution Polygon,
 * Stick Bob is a collection of NFTs that are based on the idea of creating
 * value opportunity through the advantage of universal utility. 
 * Owning Bob opens access to these opportunities and utilities.
 * All together, there are 58 unique properties that create 5,000 custom varieties of Bob.
 */

contract StickBob is ERC721Enumerable, Ownable {
    using Strings for uint256;
