 ...
 * @notice This contract handles minting Apocalyptic Test Test tokens.
 */
contract ApocalypticTestTest is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x84fe3cd591c458001fCC2DFf8D77f8C73d7ae666;
    ...
    address public royaltyAddress = 0xcdE88AB647E1f2Efe592b7063b1653c94Da0D504;
    address[] public payoutAddresses = [
        0x427da9c48631712Ee2acA06Db7761Dc39d35b4c9,
        0x5D51198BfB782E39dc24Fb00B249F43Cee385dbF,
        0xcdE88AB647E1f2Efe592b7063b1653c94Da0D504
    ];
    ...
    string public name = "Apocalyptic Test Test";
    string public symbol = "APOCTEST";
    ...
    uint256[] public payoutBasisPoints = [2500, 2500, 5000];
    uint96 public royaltyFee = 500;

    constructor(uint256 _heymintFeePerToken, address _crossmintAddress)
        ERC1155(
            "ipfs://bafybeicr5iwq32wfwzzenmrn4vge5cesmyx7oqyxgip7moxhdfvu6pntpi/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[3] = 10000;
        tokenPublicPrice[3] = 0.01 ether;
        tokenPublicMintsPerAddress[3] = 10000;
        tokenPublicSaleStartTime[3] = 1682362800;
        tokenPublicSaleEndTime[3] = 1997714638;
        tokenUsePublicSaleTimes[3] = true;
        tokenPresaleMaxSupply[3] = 100;
        tokenPresalePrice[3] = 0.001 ether;
        tokenPresaleMintsPerAddress[3] = 0;
        tokenPresaleSaleStartTime[3] = 1682359200;
        tokenPresaleSaleEndTime[3] = 1997714638;
        tokenUsePresaleTimes[3] = true;
        require(
