...
import "./generated/deploy/BaseCedarDeployerV1.sol";
import "./CedarERC721PremintV0Factory.sol";
import "./drop/CedarERC721DropV0Factory.sol";
import "./drop/CedarERC1155DropV0Factory.sol";

contract CedarDeployerV1 is Initializable, UUPSUpgradeable, OwnableUpgradeable, BaseCedarDeployerV1 {
    ...
    function cedarERC721PremintFeatures() public view override returns (string[] memory features) {
        return premintV0Factory.implementation().supportedFeatures();
    }
...
// Filename: './BaseCedarDeployerV1.sol'
...
abstract contract BaseCedarDeployerV1 is ICedarDeployerV1 {
    ...
    function supportsInterface(bytes4 interfaceID) virtual override public view returns (bool) {
        return (interfaceID == type(IERC165Upgradeable).interfaceId) || (interfaceID == type(ICedarDeployerV0).interfaceId);
    }
}
