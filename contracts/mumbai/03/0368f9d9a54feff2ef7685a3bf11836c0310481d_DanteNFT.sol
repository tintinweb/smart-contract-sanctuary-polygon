...
contract DanteNFT is ERC721Enumerable, ERC721Burnable, ERC2981, Ownable {
    ...
    uint256 public constant MAX_ELEMENTS = 66;
    uint256 public constant PRICE = 1 wei;
    uint256 public constant MAX_BY_MINT = 5;
    uint256 public constant WHITELIST_CLAIM_WINDOW = 2 days;
    uint256 public constant PUBLIC_WINDOW = 7 days;
    ...
    constructor(address _dao, string memory _provenance) ERC721("Dantes2", "DANTES2") {
        dao = _dao;
