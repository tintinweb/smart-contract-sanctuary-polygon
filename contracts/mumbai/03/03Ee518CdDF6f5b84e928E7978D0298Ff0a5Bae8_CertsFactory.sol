...
contract Accessable {
    ...
    modifier onlyReporter() {
        _require(_roles.isReporter(msg.sender), NO_RIGHTS);
        _;
    }
...
enum ParamKey {
        ...
        StakerDiscountMinPcnt,  // Eg: 1000 vLaunch gets 0.6% discount on Fee. For OTC and NFT only.
        StakerDiscountCapPcnt,  // Eg: 50,000 vLaunch gets 30%% discount on Fee. For OTC and NFT only.
