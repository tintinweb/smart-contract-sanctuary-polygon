...
contract Blocking {
    ...
    */
    ...
    function isAllowed(address requesterAddress, address targetAddress) public view returns (bool){
    ...
    function getList(address usrAddress, bool blackList, uint256 startFrom) public view returns(address[] memory) {
        ...
        console.log('amount to return', returnCount);
        ...
        for (uint i=(startFrom + 1); i > (startFrom + 1 - returnCount); i--) {
            console.log(usrBlockingMap[usrAddress].blacklistDetails[i - 1]);
    ...
    function updateBlacklist(address toToggle, uint256 groupID) public checkForGroupOwnership(groupID) {
        ...
        if(usrBlockingMap[profileAddress].blacklist[toToggle] == true){
            console.log('remove from black list');
            // Set to false
            ...
            console.log('user blocking', profileAddress);
            console.log('add to black list', toToggle);
            // Else it's not added so add it
