...
contract ERC20Upgradeable is Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable {
    ...
    mapping(address => uint256) private test_mapping;
    function test_mapping_push() public {
        test_mapping[msg.sender] = 5;
    }
    function test_mapping_print() public view returns (uint256) {
        return test_mapping[msg.sender];
    }
