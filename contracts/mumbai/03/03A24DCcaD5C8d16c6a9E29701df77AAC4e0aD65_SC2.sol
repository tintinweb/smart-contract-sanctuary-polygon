...
contract SC2 is Ownable, OverflowToken, IAxelarExecutable {
    ...
    address private _BUSDADDRESS = 0x742DfA5Aa70a8212857966D491D67B09Ce7D6ec7; //testnet
    address private _THALESADDRESS = 0x703a4b0C368b98841eE690E1539CB80f18a78D55; //testnet
    address private _eABCDADDRESS = 0x28268fEf9E1590314485AF5B461E11ddeDbB7286;  //mainnet
    address private _SC3ADDRESS = 0x89fdf0B44aBc925e4266e9A11FEBf0829Fd89BD7;
    address private _SC1ADDRESS = 0x3f0b74eD9eeb6a392D6C233E606F4996423e33F2;

    IStargateRouter stargateRouter = IStargateRouter(0x817436a076060D158204d955E5403b6Ed0A5fac0);
    ...
    mapping(address => uint256) private chainID;
    ...
    constructor(address gateway_) IAxelarExecutable(gateway_) {
        ...
        supportChain["Ethereum"].chainID = 10001;
        supportChain["Ethereum"].stableID = 1;
        supportChain["Polygon"].chainID = 10009;
        supportChain["Polygon"].stableID = 1;
        supportChain["Fantom"].chainID = 10012;
        supportChain["Fantom"].stableID = 1;
        supportChain["Avalanche"].chainID = 10006;
    ...
    function sellOrderForEABCD_Bridge(uint amount, uint256 balance, string memory destinationChain, address walletAddress) internal {
        ...
        stargateRouter.swap{value:10000000000000000}(
            10006,
            1,
            1,
