...
contract Phase2 is ERC721, ERC721Burnable,DefaultOperatorFilterer, ERC721Enumerable, Ownable{
    ...
    */
    function claim(uint256 phase1NFTId) external {
        ...
        require(IERC721(phase1Address).ownerOf(phase1NFTId) == msg.sender, "Phase2: You are not the owner of this NFT");
        require(alreadyClaimed[phase1NFTId] == false, "Phase2: NFT already claimed for this token");
