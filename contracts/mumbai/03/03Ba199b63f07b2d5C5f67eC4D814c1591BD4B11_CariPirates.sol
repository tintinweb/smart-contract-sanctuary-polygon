    ...
    Ownable
{
    ...
    constructor() ERC721("CariPirates", "CPS") {
        // Initialize the tokenIdCounter to start 1
        _tokenIdCounter.increment(); //we created our files with 1.png as the first one
    }

    // Override the _baseURI function from ERC721URIStorage to return an empty string
    function _baseURI() internal pure override returns (string memory) {
        return "https://gateway.pinata.cloud/ipfs/QmfNLgLaz1B32LyLfUsLuc9Hjx7UMjcbia44jgVBuPK2u6/";
    }
