...
contract ERC721XpDynamics is ERC721URIStorage, Ownable {
    ...
    function mint(uint256 royalty, uint256 xrRoyalty, string memory tokenURI) public {
    ...
    function safeMint(uint256 royalty, uint256 xrRoyalty, string memory tokenURI) public {
