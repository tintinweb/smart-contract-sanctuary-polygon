    ...
    ReentrancyGuardUpgradeable
{
    ...
    function unlockNft(uint256 _tokenId) public whenNotPaused onlyRole(MARKET_ROLE) {
        sNfts[_tokenId].locked = false;
    }

    function lockNft(uint256 _tokenId) public whenNotPaused onlyRole(MARKET_ROLE) {
