...
*/
    ...
    function Claim(uint8 id,address addr)public
    {
	uint256 amount;
	amount = RewardByAddr(id,addr);
	uint256 amount_to_send;
	amount_to_send = amount - Personal[id][addr].payed;
	Personal[id][addr].payed += amount_to_send;
    ...
    function TokenGetFromVesting()public onlyAdmin
    {
	uint256 balance;
