...
/**
 * @title slabs exchnage RoyaltyFeeRegistry
...
contract RoyaltyFeeRegistry is IRoyaltyFeeRegistry, Ownable {
    ...
    function updateRoyaltyInfoForNFTInitalOwner(
        ...
        _updateRoyaltyInfoForCollection(
            collection,
            tokenId,
            receivers,
            fees
    ...
    function addRoyaltyReceiver(
        ...
        require((feeInfo.tokenIdToRoyaltyInfo[tokenId].totalFee + fee) < royaltyFeeLimit, "Registry: Royalty fee too high");
        require((feeInfo.tokenIdToRoyaltyInfo[tokenId].receiver.length()) < MAX_LIMIT, "Registry: royality reveiver limit full");
        require(feeInfo.tokenIdToRoyaltyInfo[tokenId].receiver.contains(receiver), "Registry: receivers is already in the list");
    ...
    function removeRoyaltyReceiver(
        ...
        require(!feeInfo.tokenIdToRoyaltyInfo[tokenId].receiver.contains(receiver), "Registry: is not in list");
        feeInfo.tokenIdToRoyaltyInfo[tokenId].receiver.remove(receiver);
        feeInfo.tokenIdToRoyaltyInfo[tokenId].totalFee -= feeInfo.tokenIdToRoyaltyInfo[tokenId].fee[receiver];
