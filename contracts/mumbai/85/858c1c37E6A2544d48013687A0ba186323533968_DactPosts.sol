...
contract DactPosts is ERC721, ERC721Enumerable, ERC721URIStorage {
    ...
    mapping(string => uint256) public transactionToTokenId;

    event TokenMinted(address indexed owner, uint256 indexed tokenId, string indexed tokenURI);

    constructor(string memory _name, string memory _symbol) ERC721(_name, _symbol) {}

    function createToken(string memory _tokenURI, string memory _transactionId) public returns (uint256) {
        ...
        transactionToTokenId[_transactionId] = newItemId;
