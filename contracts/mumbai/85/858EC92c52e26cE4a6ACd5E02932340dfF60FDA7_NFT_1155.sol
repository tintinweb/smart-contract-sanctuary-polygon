...
interface IMarketplace{
    function checkListed(address _maker, uint256 _NFTId) external view returns(bool);
}
...
contract NFT_1155 is ERC1155, ERC1155URIStorage, INFT1155 {
    ...
    function getNFTcreator(uint256 NFTId) public virtual view returns(address){
    ...
    function transfer1155NFT(
        ...
        require(!IMarketplace(MKPAddress).checkListed(_from, _Id),"NFT Listed");
    ...
    function transferWithPermission(
        ...
        //address(this) undefined maybe this contract or the caller
        require(IMarketplace(MKPAddress).checkListed(_from, _NFTId),"NFT Listed");
        require(
            permit(_from, address(this), _NFTId, _amount, _nonce, _v, _r, _s),
            "not permitted"
        );
