...
contract urktownNFT is ERC721A, Ownable, ReentrancyGuard{
    ...
    uint256 public MAX_MINT_WALLET = 10;
    ...
    function tokenURI(uint256 tokenId) public view override(ERC721A) returns (string memory) {
        ...
        return string(abi.encodePacked(baseURI, 'unreveled.json'));
        }
    }
    ...
    function makeUrk(uint256 _urks) external nonReentrant onlyOrigin {
        ...
        require(totalSupply() + _urks < TOTAL_SUPPLY +1, "Max supply exceeded!");
        require(_urks < MAX_MINT_TX + 1, "Tx Limit!");
