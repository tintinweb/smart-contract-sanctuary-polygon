...
contract WhiteListMinterV2 is Ownable{
    ...
    //WE CAN'T DELETE THE MAPPING FOR RULES. MAYBE WE JUST SHOULDN'T BURN EVENTS
    // function burnDropEvent(string memory eventId) external onlyOwner {
    //      dropEvents[eventId] = DropEvent(ExistingSDKContract(0), NewSDKContract(0));
    // }
