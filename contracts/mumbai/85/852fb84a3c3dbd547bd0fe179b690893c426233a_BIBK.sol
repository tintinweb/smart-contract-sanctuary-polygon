...
contract BIBK is ERC20, Ownable {
    ...
    //Unlocks 29,519,700 token minted on bibk protocol mainnet launch
    function unlockTokens() external onlyOwner {
        require(unlockMainnetLaunchStatus == false, "already unlocked the tokens");
        require(totalSupply() < (30000000 * 10 ** decimals()), "max token minted");
        ...
        uint128 _mainnetLaunchTokenUnlock = 29519700 * 10 ** 18;
