...
contract User is IUser, EZRContext, YousovRoles {
    ...
    uint8 indexToStoreNextPassword; 
     ...
     **	@param newPII The new pii of the user that contains (firstName, middelName, lastName, birthPlace, uid, birthDateTimeStamp, gender). The previous pii will be replaced by the new pii. 
     *******************************************************************************/
    ...
    /*******************************************************************************
     **	@notice Get the pii a user (firstName, middelName, lastName, birthPlace, uid, birthDateTimeStamp, gender).
     *******************************************************************************/
     ...
     **	@param newPII The new pii of the user (firstName, middelName, lastName, birthPlace, uid, birthDateTimeStamp, gender). The previous pii will be replaced by the new pii.
     *******************************************************************************/
...
contract UserFactory is IUserFactory, YousovRoles, ERC2771Context {
     ...
     **	@param pii The pii of the user (firstName, middelName, lastName, birthPlace, uid, birthDateTimeStamp, gender).
     ...
     **	@param userPII The pii of the user (firstName, middelName, lastName, birthPlace, uid, birthDateTimeStamp, gender).
    ...
    function checkUnicity(
        ...
        for (uint i = 0; i < userList.length; ++i) {
            ...
            if (
                userAccountTpe == AccountType.REGULAR 
            ) {
                if (
                    keccak256(
                        abi.encodePacked(
                    ...
                    keccak256(
                        abi.encodePacked(
                            ...
                            _currentUser.getPII().birthPlace,
                ...
                userAccountTpe == AccountType.PSEUDO
            ) {
                if (
