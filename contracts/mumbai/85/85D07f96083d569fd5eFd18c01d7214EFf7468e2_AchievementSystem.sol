...
contract AchievementSystem is GameRegistryConsumerUpgradeable {
    ...
    Counters.Counter public achievementsIssued;
    ...
    function grantAchievement(
        ...
        address achievementNFTAddress = _getSystem(ACHIEVEMENT_NFT_ID);

        IAchievementNFT achievementNFT = IAchievementNFT(achievementNFTAddress);
        ...
        achievementsIssued.increment();
        uint256 newAchievementTokenId = achievementsIssued.current();
...
interface IAchievementSystem {
     ...
     *
     */
    function grantAchievement(address account, uint256 templateId) external;
}
