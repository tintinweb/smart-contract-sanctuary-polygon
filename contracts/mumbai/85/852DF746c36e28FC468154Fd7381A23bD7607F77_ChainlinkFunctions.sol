...
contract ChainlinkFunctions is AutomationCompatibleInterface, ChainlinkClient {
    ...
    event UpkeepNeeded(
        bool indexed _paymentNeeded,
        bool indexed _updateDefaultNeeded,
    ...
    function checkUpkeep(
        ...
        if (isAnyNewDefault) updateDefaultNeeded = true;
        if (isAnyDueAmountCapableOfBeingRepaid) paymentNeeded = true;
