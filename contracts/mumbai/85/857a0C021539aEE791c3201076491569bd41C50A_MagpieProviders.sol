    ...
    Pausable
{
    ...
    function _increaseLiquidity(uint256 _nftId, uint256 _amount) internal onlyValidLpToken(_nftId, _msgSender()) {
        ...
        require(_amount != 0, "ERR__AMOUNT_IS_0");
        magpieListManager.beforeLiquidityAddition(_msgSender(), token, _amount);
        ...
        whenNotPaused
    {
        ...
        magpieListManager.beforeLiquidityRemoval(_msgSender(), _tokenAddress, _amount);
...
interface IMagpieListManager {
    ...
    function beforeLiquidityAddition(
        ...
        address _token,
        uint256 _amount
    ) external; /* beforeAddingLiquidity */

    function beforeLiquidityRemoval(
        address _lp,
        address _token,
        uint256 _amount
    ) external; /* beforeRemovingLiquidity */
    ...
    function beforeLiquidityTransfer(
        ...
        address _token,
        uint256 _amount
    ) external; /* beforeTransferringLiquidity */
