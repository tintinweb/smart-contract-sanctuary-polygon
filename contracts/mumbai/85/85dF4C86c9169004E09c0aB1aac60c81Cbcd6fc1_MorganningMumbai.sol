...
contract MorganningMumbai is MorganningDeployable {
    ...
    function mint(
        ...
        _mint(reciever, tokenId, 0, 0, layer2, layer3, layer4, layer5, layer6);
    }
}
    ...
    ILayerZeroReceiver
{
    ...
    constructor(bool isTestingContract) {
        //TODO: check this is okay in auto called constructor
    ...
    function initializeVRF(
        ...
        // VRFConsumerBaseV2Upgradeable vrfConsumerBaseV2Upgradeable = new VRFConsumerBaseV2Upgradeable();
        // vrfConsumerBaseV2Upgradeable.initialize(vrfCoordinator);
    ...
    function initialize(
        ...
        greenListing = true;
        callbackGasLimit = 3000000; // TODO: set accurately
        numWords = 2;
        gas = 500000;
    ...
    // Should there be 2 greenlists?
    // 1 greenlist pays no gas
    // Other greenlist pays gas.
    ...
    function mintGreenList(
        ...
        //TODO investigate the implications of running out of link in the subscription
    ...
    function fulfillRandomWords(
        ...
        (uint8 randomLayer0, uint8 randomLayer1) = (
            //TODO add probabilistic randomness to make the 'rare' layers rare
            uint8(randomWords[0] % 4),
            uint8(randomWords[1] % 4)
        ); // returns ([0,3],[0,3])
    ...
    // Adds this contract as a consumer of the random words
    ...
    function swapToLinkForRandomness(
        ...
        }(amountOutMin, path, address(this), block.timestamp + 600);
    }
