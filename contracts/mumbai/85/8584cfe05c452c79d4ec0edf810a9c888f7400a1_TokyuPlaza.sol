...
contract TokyuPlaza is ERC721Enumerable, AccessControl {
    ...
    function safeTransferFrom(
        ...
        if (msg.value > 0){
            ...
            uint256 royalty = calculateRoyalties(msg.value);
            _payRoyalty(royalty);
  ...
  function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
    ...
    function changeRoyaltyAddress(address _royaltyAddress) public {
        require(hasRole(ADMIN_ROLE, msg.sender), "Only admin can use this function");
    ...
    function _payRoyalty(uint256 _royaltyFee) internal {
        (bool success1, ) = payable(royaltyAddress).call{value: _royaltyFee}("");
        require(success1);
    }
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        returns (bool)
    {
        // 0x2a55205a = is ERC2981 interfaceId
