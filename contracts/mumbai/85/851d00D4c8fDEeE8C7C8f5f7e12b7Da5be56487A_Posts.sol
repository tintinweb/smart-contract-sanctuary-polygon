...
contract Posts {
    ...
    * @param whatToGet : [0 = not comments / 1 = get Comments of user / 2 = get comments of post, isCommentOf message ID, repostType[0, 1, 2 (same as comments)]
    */
    function getMsgIDsByAddress(address usrAddress, uint256 startFrom, uint256[] calldata whatToGet) public view returns(uint256[] memory) {
