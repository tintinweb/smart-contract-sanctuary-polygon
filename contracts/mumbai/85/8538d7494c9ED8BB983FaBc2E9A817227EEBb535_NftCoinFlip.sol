...
contract NftCoinFlip is VRFConsumerBaseV2, ERC721Holder, Ownable {
    ...
    event PlayerCreatedGame(address indexed nftContractAddress, uint256 gameId);
    event PlayerJoinedGame(address indexed nftContractAddress, uint256 gameId);
    ...
    event GameCompleted(address indexed nftContractAddress, uint256 gameId);
