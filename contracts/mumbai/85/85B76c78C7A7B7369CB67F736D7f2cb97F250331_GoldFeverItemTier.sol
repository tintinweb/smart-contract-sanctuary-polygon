    ...
    UUPSUpgradeable
{
    ...
    function initialize(address admin,
        ...
        address itemType_) public initializer {
        __GoldFeverItemTier_init(admin, nftContract_, nglContract_, itemType_);
    }

    function __GoldFeverItemTier_init(address admin,
        address nftContract_,
        address nglContract_,
        address itemType_) internal onlyInitializing {
        __ReentrancyGuard_init();
        __GoldFeverItemTier_init_unchained(admin, nftContract_, nglContract_, itemType_);
        __UUPSUpgradeable_init();
    }

    function __GoldFeverItemTier_init_unchained(address admin,
        address nftContract_,
        address nglContract_,
        address itemType_) internal onlyInitializing {
