...
pragma solidity ^0.8.17;
    ...
    contract Crowdsale {
        ...
        function claimVesting() public {
            require(vestingStart == true, "Vesting period has not started");
            require(vestingInfo[msg.sender].claimAmount > 0, "No tokens to claim");

            claimAmount = vestingInfo[msg.sender].claimAmount;
            bool transferSuccess = token.transfer(msg.sender, claimAmount);
            if (transferSuccess) {
