    ...
    ERC2981
{
    ...
    event Mint(address to, uint256 indexed tokenId, uint256 quantity);

    constructor (
        address _currency,
        string memory _baseTokenURI,
        uint96 _royaltyFeesInBips
    ) ERC721r("PUNK", "PUNK", _maxSupplies, 1868) {
    ...
    function mint(uint256 quantity, uint256 totalpay) public nonReentrant whenNotPaused onlyRole(WORKER_ROLE) {
        ...
        currency.safeTransferFrom(msg.sender, address(this), totalpay* 10 ** 18);
