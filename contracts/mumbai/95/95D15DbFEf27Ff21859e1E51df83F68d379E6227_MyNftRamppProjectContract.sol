...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x1F39644A271E745Bc11c7Dc552A2C90BE5e4D135];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "https://api.xxx/token/";
...
contract MyNftRamppProjectContract is RamppERC721A {
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/yXGUYydlyObF8YPFCg8E/contract-metadata";
    }
}
