...
// File: Fractionlesscontracts/Fraction Token.sol
...
contract FractionToken is ERC20 {
    ...
    mapping (address => uint) public mintTime;
    ...
    function Faucetmint(address _to) external {
        require(mintTime[msg.sender] + 8 hours < block.timestamp, "comback next 8hrs to mint more tokens");
