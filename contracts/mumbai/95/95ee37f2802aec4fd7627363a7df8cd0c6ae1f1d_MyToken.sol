...
contract MyToken is ERC721, Pausable, Ownable {
    ...
    uint256 public maxSupply ; // max NFTs that can exist
    ...
    constructor() ERC721("MyToken", "MTK") {
        ...
        baseURI = "dummy.com/";
        maxSupply = 6000;
        preMintPrice = 150000000000000000 ;
...
/**
  ...
  function mint(address _to, uint256 _mintAmount) public payable whenNotPaused() {
    ...
    if ( block.timestamp >= preSaleTime && block.timestamp < publicSaleTime){
  ...
  */
  ...
  /**
    * @dev to mint NFTs for free
    * --Can only be used by contract owner--
    * @param to, address to mint. 
     */
    function giveAway(address to) public whenNotPaused() onlyOwner{
