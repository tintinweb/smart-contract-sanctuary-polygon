...
contract MetadataParcel is ERC721, OnChainMetadata {
    ...
    function claimNftParcel(string memory _size, string memory _type, string memory _map) public payable {
        ...
        _setValue(tokenId, key_token_size, abi.encode(_size));
        _setValue(tokenId, key_token_type, abi.encode(_type));
        _setValue(tokenId, key_token_map, abi.encode(_map));
