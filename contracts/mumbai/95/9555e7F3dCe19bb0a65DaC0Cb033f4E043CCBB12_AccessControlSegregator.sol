 ...
 */
contract AccessControlSegregator is Initializable, UUPSUpgradeable, PausableUpgradeable, AdminProxyManager {
  ...
  /**
        ...
        @param account Address of account.
    */
  function grantAccess(bytes4 sig, address account) public whenNotPaused {
  ...
  /**
        ...
        @notice Set paused to true/false.
    */
...
contract AdminProxyManager is Initializable, Proxied {
  ...
  function transferProxyAdmin(address _newProxyAdmin) external virtual proxied returns (bool success) {
