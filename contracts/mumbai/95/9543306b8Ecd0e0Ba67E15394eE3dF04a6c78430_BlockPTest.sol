...
contract BlockPTest is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("PunkBTest", "PBT") {
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0xA0225fDc7B69C42c3aF7eDaddBdBCf782c4d1b05).call{value: address(this).balance * 50 / 100}("");
    require(hs);
    // =============================================================================
