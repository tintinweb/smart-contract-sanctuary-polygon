...
contract BHeroS is Initializable, AccessControlUpgradeable, UUPSUpgradeable {
  ...
  function updateNumHeroBurn(uint8[] calldata listHeroNum) external onlyRole(DESIGNER_ROLE) {
    numHero = listHeroNum;
  }

  function checkNumHeroBurn(uint256 detailHeroS, uint256[] memory listIdHero) public view returns (bool) {
