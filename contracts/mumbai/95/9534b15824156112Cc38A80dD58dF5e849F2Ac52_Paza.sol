...
**/
function initialize(address _usdt, address _admin)
        public
        initializer
    {
        __ERC20_init("PAZA", "PAZA");
...
/** 
* @notice used to set the minter role of paza token
...
/** 
* @notice used to mint the paza token
* @param to address to mint the paza token
* @param amount amount to be transferred to the receipient 
**/
...
/** 
* @notice used to buy the paza token by depositing the usdt 
* @param _amount amount of usdt token to be deposited
**/
    ...
    function buy(uint256 _amount) public {
        require(
            usdt.balanceOf(_msgSender()) >= _amount * 10**decimals(),
...
* @param _payee address from which the  usdt will be transferred to _beneficiary 
* @param _beneficiary address that will receive the paza token
* @param _amount of paza token usdt
**/
...
/** 
* @notice used to sell the paza token to get back the usdt 
* @param _amount of paza token to sell 
**/
