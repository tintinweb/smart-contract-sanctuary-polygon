...
contract ERC5516 is Context, ERC165, IERC1155, IERC1155MetadataURI, IERC5516 {
     ...
     *
     */
    function tokensFrom(address account) public view virtual override returns (uint256[] memory) {
        require(account != address(0), "EIP5516: Address zero error");
     ...
     *
     */
    function pendingFrom(address account) public view virtual override returns (uint256[] memory) {
        require(account != address(0), "EIP5516: Address zero error");
    ...
    function safeTransferFrom(
        ...
        require(
            _msgSender() == _tokenMinters[id] || isApprovedForAll(_tokenMinters[id], _msgSender()),
     ...
     *
     */
    function claimOrReject(address account, uint256 id, bool action) external virtual override {
     ...
     *
     */
    function _claimOrReject(address account, uint256 id, bool action) internal virtual {
        require(
