...
contract ChainBattles is ERC721URIStorage  {
    ...
    function generateCharacter(uint256 _tokenId) public returns(string memory){
    ...
    Stats memory init;
    init.level=randomNum(10);
    init.speed=5+randomNum(20);
    init.strength=20+randomNum(100);
    ...
    updatedStats.speed=currentStats.speed+randomNum(50);
    updatedStats.strength=currentStats.strength+randomNum(50);
    updatedStats.life=currentStats.life+randomNum(20);
