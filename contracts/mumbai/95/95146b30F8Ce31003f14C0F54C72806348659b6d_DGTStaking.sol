...
contract DGTStaking is Initializable {
	...
	function initialize(address _project, address _leader, address _developer) external initializer {
		project = _project;
		leader = _leader;
	    ...
	    oldContract = OldContract(0xa4f3209ef68493e089c9105dC1841Da4dF2de643);
	    crowdMargin = CrowdMargin(0x38Ed92fD20365393F77Bf49252ecc06Ec476D49C);
		...
		TIME_STEP = 1 days;
		STAKE_LENGTH = 365 * TIME_STEP;
		INVEST_MIN_AMOUNT = 25 ether;
		WITHDRAW_MIN_AMOUNT = 0 ether;
		WITHDRAW_MAX_AMOUNT = 100 ether;
	}
	...
	function withdraw() external {
		...
		additionalMax -= additionalMax % 1000 ether;
