...
contract AllChainMetaDataNFT is ERC721URIStorage  {
    using Strings for uint256;
    using Counters for Counters.Counter;
    Counters.Counter private tokenIds;

    string showText = "AllChainMetaDataNFT";
    string nftname = "AllChainMetaDataNFT";
    string des = "AllChainMetaDataNFT";

    mapping(uint256 => uint256) public tokenIdToLevels;

    constructor() ERC721 (des, nftname){
    }
    ...
    bytes memory svg = abi.encodePacked(
        ...
        '<text x="50%" y="40%" class="base" dominant-baseline="middle" text-anchor="middle">',showText,'</text>',
