...
contract RaffleStake is Ownable {
    ...
    uint256 private _numberOfRaffles = 0;
    ...
    function createRaffle(
        ...
        _raffles[_numberOfRaffles] = new Raffle(
            price,
            minParticipants,
    ...
    function participateInRaffle(uint256 raffleNumber) external {
        _raffles[raffleNumber].participateInRaffle(msg.sender);
    }
...
contract Raffle is Ownable{
    ...
    function participateInRaffle(address participant)
        external
        payable
        validateTicketPrice(){
