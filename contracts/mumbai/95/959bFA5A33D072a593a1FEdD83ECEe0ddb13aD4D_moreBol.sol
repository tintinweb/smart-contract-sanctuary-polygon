...
contract moreBol is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  // uint256 public requested;
  uint256 public currentSupply = 0;
  
  string public baseURI = "https://nftstorage.link/ipfs://bafybeiaenc3i5ddfxtkjeg5djrwa7222nixbrobsbafsimtueszkzk6cci/";
  constructor() 
    ERC721("More BullDust", "BOLLOX")
    RandomlyAssigned(20,1) // bla bla
    {
      mint();
    }
