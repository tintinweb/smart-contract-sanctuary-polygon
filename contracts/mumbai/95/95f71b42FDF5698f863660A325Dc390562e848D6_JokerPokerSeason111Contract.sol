    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 216) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://Qmahv2jcDZaJGErmz26tPhfwALKTA5pWcpRxViwhDWrz4n/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 216");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 216");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 216");
...
// File: contracts/JokerPokerSeason111Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract JokerPokerSeason111Contract is RamppERC721A {
    constructor() RamppERC721A("Joker Poker Season 1 11", "JPS1"){}
}