...
contract Cyber9mumbai is ERC721Enumerable, Ownable, RNG, VRFConsumerBase {
    ...
    // event Withdraw(address indexed _from, uint256[] _tokenIds, uint256 _beiAmount);
    ...
    function withdrawYield() external {
        ...
        // uint256[] memory expArray = new uint256[](_tokens.length);
        ...
        // emit Withdraw(msg.sender, _tokensArray, toTransfer);
    }
