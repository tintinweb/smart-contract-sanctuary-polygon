...
library PriceConverter {
    ...
    function pGetPrice(address t) public view returns(uint){
        uint256 ethPrice = getPrice(AggregatorV3Interface(t));
        uint256 ethAmountInUsd = (ethPrice * 1) / 1000000000000000000;
        return ethAmountInUsd;
    }
}