...
contract AlAd is ERC721A, Ownable {
    using Strings for uint256;

    string public uriPrefix = "ipfs://QmYmpmuHFsY76khZC95SDR26sTwggywc8ueU1BM3qfNmo5/";
    string public uriSuffix = ".json";
    string public hiddenMetadataUri = "ipfs://QmTDCKWMxggSbZLdiw8XAfTgGnKv8sWAB3ezCvEYEGYN65";

    uint256 public costPublic = 0.02 ether;
    uint256 public maxSupply = 5555;
    uint256 public maxMintAmountPerTx = 5;
    uint256 public nftPerAddressLimit = 26;
    uint256 public nftPerAddressLimitPreSale = 52;
    uint256 public maxSupplyForDevs = 0;
