...
contract ChildAkkadiaToken is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, AccessControlEnumerableUpgradeable, UUPSUpgradeable {
    ...
    function initialize(string memory name, string memory symbol, address childChainManagerProxy) initializer public {
        __ERC20_init(name, symbol); // Akkadia, AKKADI
        ...
        _mint(_origin, _initialSupply); // Mint initial supply on Polygon
    }
    ...
    function _mint(address account, uint256 amount) internal virtual override {
        require(totalSupply() + amount <= maxSupply(), "ChildAkkadiaToken: max supply exceeded");
