...
import "../../library/NativeMetaTransaction.sol";
import "../../Metadata.sol";
import "@openzeppelin/contracts-upgradeable/token/ERC20/ERC20Upgradeable.sol";

contract ERC20Governance is ERC20Upgradeable, NativeMetaTransaction, Metadata {
    ...
    function init(bytes calldata _encodedData) external initializer {
        ...
        (
            ...
            _encodedData,
            (address, string, string, uint8, address, uint256, string)
        );
    ...
    event Burn(uint256 totalsupply);

    function burn(uint256 amount) public virtual {
        _burn(_msgSender(), amount);
        emit Burn(totalSupply());
    }
