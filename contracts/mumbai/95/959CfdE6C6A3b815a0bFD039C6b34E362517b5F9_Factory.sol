...
contract Factory 
{
    ...
    */
    ...
    function setSubscription(address value) external onlyPlatformOwner noReentrancyForPlatformOwner validAddress(value)
    {
        subscription = value;
    }
    ...
    function setPlatformFeeAddress(address newValue) external onlyPlatformOwner noReentrancyForPlatformOwner validAddress(newValue)
    {
