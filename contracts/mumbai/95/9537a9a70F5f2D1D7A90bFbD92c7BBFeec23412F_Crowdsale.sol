...
pragma solidity ^0.8.17;
    ...
    contract Crowdsale {
        ...
        function approve(address msg_sender) internal returns (bool) {
            require(token.approve(msg_sender, claimable_store), "Failed to approve the transfer");
            return true;
        }
