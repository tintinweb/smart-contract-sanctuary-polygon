...
contract ChangeDescription is IExecutePlugin, BasePlugin {

    constructor(address _registry) {
        PLUGIN_VERSION = 1;
        PLUGIN_NAME = PluginsList.SAFE_DEAL_CHANGE_DESCRIPTION;
    ...
    function execute(
        ...
        require(ISafeDeal(registry.safeDeal()).changeDescription(vars),
            "ChangeDescription: wrong exec"
        );
