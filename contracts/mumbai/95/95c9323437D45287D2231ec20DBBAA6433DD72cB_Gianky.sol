...
contract Gianky is ERC721, ERC721URIStorage {
    ...
    function incrementReferralCountStarter(uint256 _nftId) public {
        addressToReferralCountsStarter[msg.sender][_nftId]++;
    }

    function incrementReferralCountBasic(uint256 _nftId) public {
        addressToReferralCountsBasic[msg.sender][_nftId]++;
    }

    function incrementReferralCountStandard(uint256 _nftId) public {
        addressToReferralCountsStandard[msg.sender][_nftId]++;
    }

    function incrementReferralCountVip(uint256 _nftId) public {
        addressToReferralCountsVip[msg.sender][_nftId]++;
    }

    function incrementReferralCountPremium(uint256 _nftId) public {
        addressToReferralCountsPremium[msg.sender][_nftId]++;
    }

    function incrementReferralCountDiamond(uint256 _nftId) public {
