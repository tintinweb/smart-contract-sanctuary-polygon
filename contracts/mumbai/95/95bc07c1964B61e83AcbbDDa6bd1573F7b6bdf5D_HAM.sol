...
contract HAM is ERC20, AccessControl, ERC721Holder {
    bytes32 public constant CONTRACT_ADMIN_ROLE = keccak256("CONTRACT_ADMIN_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant BURNER_ROLE = keccak256("BURNER_ROLE");
    address public owner;
    bool public paused = false;
    uint256 public welcomeBonusAmountC1;
    uint256 public welcomeBonusAmountC2;
    uint256 public welcomeBonusAmountC3;
    ...
    mapping (uint256 => bool) public welcomeBonusCollectedC1;
    mapping (uint256 => bool) public welcomeBonusCollectedC2;
    mapping (uint256 => bool) public welcomeBonusCollectedC3;
    ...
    constructor() ERC20("HAM", "HAM")AccessControl(){
        owner = 0xe367A56aFe769172cFBAC6cA2302b53A70687594;
        collectionAddressC1 = 0xfd60698B2cB148bF92a3ABC53DCCBd706ba8F27B;
        ...
        coinAmountPerRewardUnitC1 = 5 * 10 ** 18;
        coinAmountPerRewardUnitC2 = 5 * 10 ** 18;
        coinAmountPerRewardUnitC3 = 5 * 10 ** 18;
        numberOfBlocksPerRewardUnitC1 = 18780;
        numberOfBlocksPerRewardUnitC2 = 18780;
        numberOfBlocksPerRewardUnitC3 = 18780;
        welcomeBonusAmountC1 = 150 * 10 ** 18; 
        welcomeBonusAmountC2 = 150 * 10 ** 18; 
        welcomeBonusAmountC3 = 150 * 10 ** 18; 
    }
    ...
    function stakeC1(uint256 tokenId) public {
        ...
        require(IERC721(collectionAddressC1).ownerOf(tokenId) == address(this),
            "HAM: Error while transferring token");
        ...
        if(!welcomeBonusCollectedC1[tokenId]) {
            _mint(_msgSender(), welcomeBonusAmountC1);
            welcomeBonusCollectedC1[tokenId] = true;
        }
    ...
    function stakeC2(uint256 tokenId) public {
        ...
        if(!welcomeBonusCollectedC1[tokenId]) {
            _mint(_msgSender(), welcomeBonusAmountC2);
            welcomeBonusCollectedC2[tokenId] = true;
        }
    ...
    function stakeC3(uint256 tokenId) public {
        ...
        if(!welcomeBonusCollectedC1[tokenId]) {
            _mint(_msgSender(), welcomeBonusAmountC3);
            welcomeBonusCollectedC3[tokenId] = true;
        }
    ...
    function harvestC1(uint256 tokenId) public {
        require(!paused, "The contract is paused");
        StakeInfoC1 storage infoC1 = stakeLogC1[_msgSender()][tokenId];
        uint256 rewardAmountInHAM = pendingRewardsC1(_msgSender(), tokenId);
        if(rewardAmountInHAM > 0) {
            infoC1.lastHarvestBlock = block.number;
            _mint(_msgSender(), rewardAmountInHAM);
            emit RewardsHarvestedC1(_msgSender(), rewardAmountInHAM);
        }
    }
    function harvestC2(uint256 tokenId) public {
        require(!paused, "The contract is paused");
        StakeInfoC2 storage infoC2 = stakeLogC2[_msgSender()][tokenId];
        uint256 rewardAmountInHAM = pendingRewardsC2(_msgSender(), tokenId);
        if(rewardAmountInHAM > 0) {
            infoC2.lastHarvestBlock = block.number;
            _mint(_msgSender(), rewardAmountInHAM);
            emit RewardsHarvestedC2(_msgSender(), rewardAmountInHAM);
        }
    }
    function harvestC3(uint256 tokenId) public {
        require(!paused, "The contract is paused");
        StakeInfoC3 storage infoC3 = stakeLogC3[_msgSender()][tokenId];
        uint256 rewardAmountInHAM = pendingRewardsC3(_msgSender(), tokenId);
        if(rewardAmountInHAM > 0) {
            infoC3.lastHarvestBlock = block.number;
            _mint(_msgSender(), rewardAmountInHAM);
            emit RewardsHarvestedC3(_msgSender(), rewardAmountInHAM);
        }
    }
    ...
    function setWelcomeBonusAmountC1(uint256 coinAmount) external onlyRole(CONTRACT_ADMIN_ROLE){
        welcomeBonusAmountC1 = coinAmount;
    }
    function setWelcomeBonusAmountC2(uint256 coinAmount) external onlyRole(CONTRACT_ADMIN_ROLE){
        welcomeBonusAmountC2 = coinAmount;
    }
    function setWelcomeBonusAmountC3(uint256 coinAmount) external onlyRole(CONTRACT_ADMIN_ROLE){
        welcomeBonusAmountC3 = coinAmount;
    }
    ...
    function setCollectionAddressC1(address newAddressC1) external onlyRole(CONTRACT_ADMIN_ROLE){
        require (newAddressC1 != address(0), "HAM: update to zero address not possible");
    ...
    function setCollectionAddressC2(address newAddressC2) external onlyRole(CONTRACT_ADMIN_ROLE){
        require (newAddressC2 != address(0), "HAM: update to zero address not possible");
    ...
    function setCollectionAddressC3(address newAddressC3) external onlyRole(CONTRACT_ADMIN_ROLE){
        require (newAddressC3 != address(0), "HAM: update to zero address not possible");
