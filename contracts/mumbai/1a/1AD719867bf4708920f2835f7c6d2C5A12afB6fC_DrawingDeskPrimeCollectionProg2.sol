...
contract DrawingDeskPrimeCollectionProg2 is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, PausableUpgradeable, AccessControlUpgradeable, ERC721BurnableUpgradeable, UUPSUpgradeable,NativeMetaTransactionUpgradeable,ContextMixin {
    ...
    function initialize(string memory name, string memory symbol,string memory baseURI,uint releaseCount) initializer public {
    ...
    function mintAsset(uint256 _mintAmount) public payable {
        ...
        require(msg.value == _mintPrice, "Not Enough Ether");
