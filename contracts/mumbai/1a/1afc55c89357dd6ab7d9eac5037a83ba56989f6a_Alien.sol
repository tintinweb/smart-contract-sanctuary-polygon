...
pragma solidity 0.8.7;
 ...
 contract Alien is  ERC721PresetMinterPauserAutoId, Ownable  {
    ...
    constructor() ERC721PresetMinterPauserAutoId("ALIEN", "ALN","https://link_to_metadata/"){
        _setupRole(ADMIN_ROLE, msg.sender);
    }
    function AlienMint(uint256 _count, address to) payable public {
       require(totalSupply().add(_count) <= MaxSupply, "Max supply");
       require(SaleisActive, "Sale not active");
       require(_count <= MaxPurchase, "Max per tx");
       require(mintPrice * _count <= msg.value, "Value too low");
    ...
    function adminMinting(address to) public {
        require(hasRole(ADMIN_ROLE, _msgSender()), "Not admin");
        require(totalSupply().add(1) <= MaxSupply, "Supply Max");
        super.mint(to);
    }
