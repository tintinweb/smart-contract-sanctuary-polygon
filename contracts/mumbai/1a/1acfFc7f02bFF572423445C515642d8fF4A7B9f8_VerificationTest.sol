...
// File contracts/VerificationTest.sol
...
contract ERC721ContractWrapper is Proxy {
    address internal constant _IMPLEMENTATION_ADDRESS = 0x2327B47bf968BEd6e5cE16a64d94e4A9219039ca;
    bytes32 internal constant _IMPLEMENTATION_SLOT = 0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc;
...
contract VerificationTest is ERC721ContractWrapper {
  constructor(
    string memory _name,
    string memory _symbol,
    uint256 _totalSupply
