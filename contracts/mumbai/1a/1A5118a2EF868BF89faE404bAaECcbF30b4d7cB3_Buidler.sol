...
contract Buidler is ERC721URIStorage, ERC2771Context {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    event Minted(address newMember);

    constructor(address trustedForwarder) 
    ERC721 ("Buidl With Rahat NFT", "BNFT") 
    ...
    function mint () public {
        ...
        require(newItemId <= 100, "NFT Collection is Sold out!");
        _safeMint(_msgSender(), newItemId);
        _setTokenURI(newItemId, "https://bafybeiesmpuib26axywrn2al6jtkzfeiwycy5cn7anspz5e6shzwkut7ni.ipfs.w3s.link/metadata.json");
