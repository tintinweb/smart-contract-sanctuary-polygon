...
contract Dao {
    ...
    constructor(){
        ...
        validTokens = [91088346712699211341523998419508822536166746379380330573348818193720132239361];
    }
    ...
    function createProposal(string memory _description, address[] memory _canVote) public{
        require(checkProposalEligibility(msg.sender), "Only NFT holder can put forth Proposals");
