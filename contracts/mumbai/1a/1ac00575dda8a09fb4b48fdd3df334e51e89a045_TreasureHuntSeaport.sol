    ...
    OwnableUpgradeable
{
    ...
    event LeaveSeaport(address account, uint256 tokenID);
    event KickSeaport(address account, uint256 tokenID);
    event JoinSeaport(address account, uint256 tokenID);
    ...
    function join2Seaport(uint256 tokenID) public {
        ...
        emit JoinSeaport(msg.sender, tokenID);
    }
    ...
    function exitFromSeaport(uint256 tokenID, bool isDirect) public {
        ...
        emit LeaveSeaport(msg.sender, tokenID);
    }
