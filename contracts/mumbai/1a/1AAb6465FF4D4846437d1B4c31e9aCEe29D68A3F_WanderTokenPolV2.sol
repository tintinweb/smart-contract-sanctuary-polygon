 ...
 * contract.
 */
contract WanderTokenPolV2 is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, AccessControlUpgradeable {
    /**
     ...
     * requirements for upgradable smart contract. Initialized
     * token's name, symbol and maximum supply.
     */
    function initialize() initializer public {
        __ERC20_init("Wander Token with Gnosis", "tWDRGv1");
    ...
    /**
     * @dev Function to pause the smart contract.
     */
    ...
    /**
     * @dev Function to mint $WANDER token.
     */
    function mint(address to, uint256 amount) public onlyRole(MINTER_ROLE) {
         ...
         */
        require(
            ((ERC20Upgradeable.totalSupply() + amount) <= MAXSUPPLY), 
    ...
    /**
     * @dev Return the MAXSUPPLY value of the smart
     * contract. 
     *
     * ONLY AVAILABLE FOR TESTING PURPOSES TO SEE WHETHER
    ...
    /**
     * @dev Internal function overriden to accomodate the 
     * pausable nature of the smart contract.
     */
