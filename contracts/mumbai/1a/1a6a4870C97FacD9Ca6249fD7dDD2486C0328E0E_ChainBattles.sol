...
contract ChainBattles is ERC721URIStorage {
    ...
    mapping (uint256 => Powers) public tokenIdToPower;
    ...
    function getLevel(uint256 tokenId) public view returns (string memory) {
        Powers memory data = tokenIdToPower[tokenId];
...
//weisha!!!!!!!.toString
    ...
    function mint() public {
        ...
        Powers memory powers = Powers(0, createRandom(1), createRandom(2), createRandom(3));

//weisha!!!!!!!       Powers memory powers 

        tokenIdToPower[newItemId] = powers;
    ...
    function train(uint256 tokenId) public {
        ...
        Powers memory currentPower = tokenIdToPower[tokenId];
