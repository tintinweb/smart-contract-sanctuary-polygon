...
contract MyNft is ERC721, Ownable, ERC2981 {
    ...
    uint256 public maxPerWallet = 1200;
    uint256 public maxPerTransaction = 1200;

    uint256 public presalePrice = 0.05 ether;
    uint256 public presaleMaxPerWallet = 10;
    uint256 public presaleMaxPerTransaction = 10;
    ...
    address[] public withdrawAddresses = [0x17814275E78965C6C403Ad226AC3E10778C20c3A, 0x5cd819CAa5e1fDd7b9E29dA8aE4036E85330fd21, 0x11eec0923C7c49796482cdEB4F158b348166a783];
    uint256[] public withdrawPercentages = [20, 30, 50];


    bytes32 public merkleRoot = 0;

    constructor() ERC721("NFTOOL DEMO", "NEW") {
        _baseTokenURI = "https://test-nft-tool-gateway-api.tuoluo.net/generator-server/api/contract/v1/1603685302785798146/metadata/";
        _setDefaultRoyalty(0x11eec0923C7c49796482cdEB4F158b348166a783, uint96(500));
    }
