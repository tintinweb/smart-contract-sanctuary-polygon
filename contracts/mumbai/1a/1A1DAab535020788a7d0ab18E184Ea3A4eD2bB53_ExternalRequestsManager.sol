...
contract ExternalRequestsManager is Ownable2StepUpgradeable {
    ...
    event MintRequested(address indexed provider, uint256 value);
    event BurnRequested(address indexed provider, uint256 value);
    event AnotherEvent(address indexed provider, uint256 value);
    ...
    function requestMint() public payable onlyAllowedProviders {
        ...
        emit AnotherEvent(msg.sender, msg.value);
