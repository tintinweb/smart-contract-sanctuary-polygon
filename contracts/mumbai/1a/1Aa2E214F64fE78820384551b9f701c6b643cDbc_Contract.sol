...
contract Contract is ERC1155 {
    ...
    /// @param number The number of tokens that each participant will receive upon claiming
    struct Airdrop {
        uint256 groupId;
        ERC1155 token;
        address manager;
    ...
    uint256 internal immutable wgroupId = 1;
    ...
    constructor(IWorldID _worldId) ERC1155(""){
        worldId = _worldId;
    }
    ...
    function verifyAndExecute(
        ...
        worldId.verifyProof(
            ...
            nullifierHash,
            abi.encodePacked("wid_staging_20e9b4be43785e7045d1969be8a8c5c5", airdropId).hashToField(),
            proof
        );
        ...
        //set URI
        _setURI("ipfs://QmdTfCusY8m1AxqreuKb5zDYuMDseGghNEyoHogem8VPb1");

        // mint the ERC1155 token to the input: user's address
        _mint(input, airdropId, 1, "");

        

        emit AirdropClaimed(airdropId, input);
        //claimed
