    ...
    BufferNFTCore
{
    ...
    function quickCreate(
        ...
        address referrer,
        string memory metadata
    ) public nonReentrant returns (uint256 optionID) {
        ...
        // if the period is lower than 12 hours then assert that the option be an ATM one and deduct a small fee
        if ((period) < 24 hours) {
