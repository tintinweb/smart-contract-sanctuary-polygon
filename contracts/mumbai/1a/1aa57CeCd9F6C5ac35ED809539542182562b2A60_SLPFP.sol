...
import {PFPError} from "../../errors/PFPError.sol";

/// @notice Core storage and event for PFP ERC721 contract
abstract contract PFPBase is
    SLBaseUpgradeable,
...
import {ISLPFP} from "./ISLPFP.sol";
import {PFPBase} from "./PFPBase.sol";
    ...
    UUPSUpgradeable
{
        ...
        returns (bool)
    {
        return
            ...
            interfaceId == type(ISLPFP).interfaceId;
    }
    ...
    function tokenURI(
        ...
        if (!_exists(tokenId)) revert DoesNotExistTokenId();
