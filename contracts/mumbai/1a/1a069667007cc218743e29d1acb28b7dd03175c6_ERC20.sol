...
contract ERC20 {
    ...
    bool    private  rewardCoolTimeEnd;
    ...
    if(_rewardSwitch){require(holders.length >= 2, "Insufficient holders");
    ...
    emit Transfer(from, to, rewardamountper1);
    ...
    function checkrewardcooltime () public view returns (bool){
        return rewardCoolTimeEnd;
    }
