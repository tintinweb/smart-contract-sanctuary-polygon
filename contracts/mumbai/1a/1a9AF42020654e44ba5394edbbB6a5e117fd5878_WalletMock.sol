...
contract WalletMock is ERC2771Context {
    ...
    mapping(address => uint256) withdrawnBalance;
    ...
    function withdraw(address token, uint amount) public {
        ...
        withdrawnBalance[token] += amount;
        IERC20(token).safeTransferFrom(address(this), feeCollector, 0.001 ether);
    }

    function getBalance(address token) public view returns (uint) {
        return withdrawnBalance[token];
    }
