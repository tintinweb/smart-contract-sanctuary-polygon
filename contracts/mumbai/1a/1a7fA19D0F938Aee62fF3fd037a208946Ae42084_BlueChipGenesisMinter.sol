...
contract BlueChipGenesisMinter is AccessControl {
    ...
    uint256 constant MINT_COST = 0.005 ether;
    uint256 private constant MAX_INT = 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff;
    // ★256*24=6144 が取り扱えるALウォレットの数
    uint256[24] arr = [MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT ,MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT];
    /**
     *  @notice ★引き出しアドレス要確認！！
     */
    ...
    function claimTicketOrBlockTransaction(uint256 ticketNumber) private {
        ...
        if (storedBit != 1) revert AlreadyClaimed();
    ...
    function resetArr() external onlyRole(ADMIN) {
        arr = [MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT ,MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT];
    }
