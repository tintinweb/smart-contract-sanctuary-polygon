...
contract ERC1155SBT is ERC1155Base, Drop1155 {
    ...
    //////////// ContractOperator ////////////
    function _setContractOperator(address _contractOperator) external {
    ...
    function _beforeClaim(
        ...
        require(msg.sender == owner() || msg.sender == contractOperator, "Only operator or owner can claim");
    }
...
contract ERC1155SBTFactory is Ownable {
    ...
    event Deployed(address indexed from, address contractAddress);
