...
contract TermPool is ITermPool, Initializable, TermUtils {
  ...
  function allowPartialRepayment(uint256 _termId) external override onlyFactoryOwner {
  ...
  // TODO: give % rate from available reward
...
abstract contract TermUtils {
  ...
  function sliceString(string memory input) public pure returns (string memory, string memory) {
