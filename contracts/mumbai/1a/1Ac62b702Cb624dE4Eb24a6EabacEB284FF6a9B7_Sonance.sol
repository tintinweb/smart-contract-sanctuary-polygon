...
contract Sonance is ReentrancyGuard, Ownable {
   ...
   */
    ...
    */
     ...
     */
    function getTrackOwner(uint256 _songId) external virtual returns (address) {
    ...
    function isTrackExplicit(uint256 _songId) external virtual returns (bool) {
     ...
     */
    function getTrackGenre(uint256 _songId) external virtual returns (Genre) {
