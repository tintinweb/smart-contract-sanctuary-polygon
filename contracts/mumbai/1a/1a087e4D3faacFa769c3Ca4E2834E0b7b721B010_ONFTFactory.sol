...
contract ONFTFactory {
    ...
    function create(string memory _name, string memory _symbol) external {
        ONFT721 onft = new ONFT721(_name, _symbol, msg.sender, minGasToTransfer, lzEndpoint);
...
contract ONFT721 is ONFT721Core, ERC721, IONFT721 {
    ...
    constructor(string memory _name, string memory _symbol, address creator, uint256 _minGasToTransfer, address _lzEndpoint) ERC721(_name, _symbol) ONFT721Core(_minGasToTransfer, _lzEndpoint) {
