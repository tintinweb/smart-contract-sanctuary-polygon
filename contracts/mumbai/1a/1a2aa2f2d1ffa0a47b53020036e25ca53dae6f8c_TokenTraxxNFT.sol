    ...
    IERC721Custom
{
    ...
    function createCollection(
        ...
        // newCollection.title = _collection.title;
        
        // Collection storage newCollection;
        // Collection memory newCollection = Collection({
        //     title: _collection.title,
        //     description: _collection.description,
        //     thumbnail: _collection.thumbnail,
        //     bgImage: _collection.bgImage,
        //     bgColor: _collection.bgColor,
        //     tokenIds: _collection.tokenIds,
        //     owner: _collection.owner,
        //     createdAt: block.timestamp,
        //     updatedAt: 0,
        //     userPurchaseLimit: _collection.userPurchaseLimit,
        //     allowedPurchaseLimit: _collection.allowedPurchaseLimit,
        //     primarySoldCount: 0,
        //     whitelistParams: new WhitelistParams[](0)
        // });
            // newCollection.title = _collection.title;
            // newCollection.description = _collection.description;
            // newCollection.thumbnail = _collection.thumbnail;
            // newCollection.bgImage = _collection.bgImage;
            // newCollection.bgColor = _collection.bgColor;
            // newCollection.tokenIds = _collection.tokenIds;
            // newCollection.owner = _collection.owner;
            // newCollection.createdAt = block.timestamp;
            // newCollection.updatedAt = 0;
            // newCollection.userPurchaseLimit = _collection.userPurchaseLimit;
            // newCollection.allowedPurchaseLimit = _collection.allowedPurchaseLimit;
            // newCollection.primarySoldCount = 0;

        // //Collection memory newCollection = _collection;

        //_collections[id] = newCollection;
        // _collections.push();
    ...
    mapping(address => mapping(uint256 => uint256)) private _primarySaleUserCount;
