...
contract MyNFT is ERC721, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    string public baseURI = "ipfs://QmXW4BQTXmyzuVH6uStD4uVYBmgobv7iZQJ2eF4bHA68Dr";
    bool public revealed = false;

    constructor() ERC721("SuretyToken", "HST") {}

    function _baseURI() internal view override returns (string memory) {
        return baseURI;
    }

    function changeReveal(bool revealed_) public onlyOwner{
        revealed = revealed_;
    }
