...
contract Test is Context, IERC20, Ownable {
    ...
    /* @DEV, sets the router on chain to maintain single contract address deployments. */

    function whichRouterToUse() internal onlyOwner {
        if (chainId == 137) {
            routerAddress = 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff;
        } else if (chainId == 80001) {
            routerAddress = 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff; // There is no testnet swap for MUMBAI
        } else if (chainId == 56) {
            routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // Pancake swap router address for BNB chain mainnet
        }
    }
    ...
    function createSwapPair() external onlyOwner {
        ...
        _maxTxAmount = _tTotal/1000; // 0.01% total max
        tradingOpen = true;
