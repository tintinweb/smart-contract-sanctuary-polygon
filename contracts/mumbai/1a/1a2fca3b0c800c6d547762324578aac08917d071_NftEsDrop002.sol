...
using Address for address;
    ...
    function setStatusMintFeeMaxMintsMaxNFTsDiscountPercentageAndTimer(bool mintStatus, uint8 maxMints, uint16 maxNFTs, uint8 DiscountPercentage, uint32 startTime, uint32 endTime) external onlyOwner {
        //_mintFees = mintFee;
