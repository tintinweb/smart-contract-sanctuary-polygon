...
contract OHtestV6 is ERC721URIStorage, Ownable, ERC721Enumerable {
    ...
    constructor() ERC721("OHTest 6", "OHT") {
        AdminAddresses[owner()] = true;        
    }

    //First layer of Security, using admins to create whitelist entries.
  ...
  require(whitelistedAddresses[_address], "You need to be whitelisted");
    ...
    require(whitelistedAddresses[msg.sender] || isSalePublic, "You need to be whitelisted or wait for the minting to go public");
