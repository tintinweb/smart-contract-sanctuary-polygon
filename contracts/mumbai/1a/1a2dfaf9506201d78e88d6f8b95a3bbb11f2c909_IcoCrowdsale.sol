...
contract Crowdsale is ReentrancyGuard,Pausable {
    ...
    address public _rateSettingOwner;
    ...
    /**
     * @dev To get the tokens mintedsofar
     */
    function _totalTokensMintedSoFar() public view returns (uint256) {
        return _token.totalSupply();
    }
 
    function setRate(uint256 newRate) public
    {
        require(msg.sender == _rateSettingOwner,"This function is restricted to the contract's owner");
        require(newRate > 0 ,"Rate can't be 0");
        _rate = newRate;
    }  
