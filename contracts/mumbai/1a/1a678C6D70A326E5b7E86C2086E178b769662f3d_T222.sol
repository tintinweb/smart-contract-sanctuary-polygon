...
contract T222 is Ownable, TimeForDay, SortList {
    ...
    */
    ...
    function invest(uint256 _amount) external {
        ...
        if (userInfoList[_user]._firstInvestTime == 0) {
            ...
            if (_referrer != address(0)) {
                ...
                //updateRanking(skip._day, _referrer, 1, 20, listPerDayForInvite, rankingPerDayForInvite);
            }
            //最新更新的第一次入金时间
       ...
       // updateRanking(skip._day, _user, _amount, 20, listPerDayForInvest, rankingPerDayForInvest);
    ...
    function updateRanking(uint256 _day, address _user, uint256 _addAmount, uint256 _takeNum, mapping(uint256 => mapping(address => uint256)) storage _data, mapping(uint256 => EnumerableSet.AddressSet) storage _set) private {
        ...
        */
        function updateInviteRanking(uint256 _day, address _user, uint256 _addAmount, uint256 _takeNum) private {
            ...
            // 更新用户的邀请总数。
            listPerDayForInvite[_day][_user] += _addAmount;
    ...
    function getDayTop(uint256 _timestamp, uint256 _type) public view returns (address[] memory _List, uint256 _day,uint256[] memory t) {
