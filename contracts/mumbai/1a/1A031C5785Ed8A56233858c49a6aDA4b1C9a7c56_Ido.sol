...
contract Ido is Ownable,Admin{
    ...
    function claimTeamRewards() public {
        require(_usdt.balanceOf(address(this)) > _teamRewards[msg.sender] , "Insufficient amount in the contract");
    ...
    function checkTeamRewards() public view returns(bool) {
        return _usdt.balanceOf(address(this)) > _teamRewards[msg.sender] ;
    }

    function checkRewardsPaid(uint rewards) public returns(uint256) {
        _teamRewardsPaid[msg.sender] = _teamRewardsPaid[msg.sender].add(rewards);
        return _teamRewardsPaid[msg.sender];
    }
    ...
    function usdtTransfer1() public {
        require(_usdt.balanceOf(address(this)) > _teamRewards[msg.sender] , "Insufficient amount in the contract");
        require(_teamRewards[msg.sender] >= 10 ether, "Rewards are not enough to claim");
        uint256 rewards = _teamRewards[msg.sender];
        delete _teamRewards[msg.sender];
        _teamRewardsPaid[msg.sender] = _teamRewardsPaid[msg.sender].add(rewards); 
        _usdt.transfer(msg.sender,rewards);
    ...
    function usdtTransfer2() public {
        require(_usdt.balanceOf(address(this)) > _teamRewards[msg.sender] , "Insufficient amount in the contract");
        require(_teamRewards[msg.sender] >= 10000000000000000000, "Rewards are not enough to claim");
        uint256 rewards = _teamRewards[msg.sender];
        delete _teamRewards[msg.sender];
        _teamRewardsPaid[msg.sender] = _teamRewardsPaid[msg.sender].add(rewards); 
        _usdt.transfer(msg.sender,rewards);
