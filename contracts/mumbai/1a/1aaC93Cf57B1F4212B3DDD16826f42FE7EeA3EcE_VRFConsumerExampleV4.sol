...
// File contracts/tests/VRFConsumerExampleV4.sol
...
contract VRFConsumerExampleV4 is VRFConsumerBaseV2, ConfirmedOwner {
  ...
  VRFCoordinatorV4Interface COORDINATOR;
  ...
  constructor(address vrfCoordinator) VRFConsumerBaseV2(vrfCoordinator) ConfirmedOwner(msg.sender) {
    COORDINATOR = VRFCoordinatorV4Interface(vrfCoordinator);
  }
