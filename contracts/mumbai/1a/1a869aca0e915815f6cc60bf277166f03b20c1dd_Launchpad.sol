...
contract Launchpad  {
    ...
    function DeployPausableBurn(string calldata name, string calldata symbol,uint256 totalSupply_,uint256 decimals)payable public  returns (address){
     ...
     function DeployPausableMintBurn(string calldata name, string calldata symbol,uint256 totalSupply_,uint256 decimals)payable public  returns (address){
        address newToken=ILaunchPad(UpgradedContract).DeployPausableMintBurn{value:msg.value}( name, symbol, totalSupply_, decimals);
        syncTheData(address(newToken));
        return newToken;
    }
     
    function DeployERC20(string calldata name, string calldata symbol,uint256 totalSupply_,uint256 decimals) payable public  returns (ERC20){
    ...
    function DeployBurnable(string calldata name, string calldata symbol,uint256 totalSupply_,uint256 decimals) payable public  returns (ERC20){
        require(msg.value>=fee);
    ...
    function DeployMintable(string calldata name, string calldata symbol,uint256 totalSupply_,uint256 decimals) payable public  returns (ERC20){
        require(msg.value>=fee);
    ...
    function DeployMintBurn(string calldata name, string calldata symbol,uint256 totalSupply_,uint256 decimals) payable public  returns (ERC20){
        require(msg.value>=fee);
    ...
    function DeployPausable(string calldata name, string calldata symbol,uint256 totalSupply_,uint256 decimals) payable public  returns (ERC20){
        require(msg.value>=fee);
    ...
    function DeployPausableMint(string calldata name, string calldata symbol,uint256 totalSupply_,uint256 decimals) payable public  returns (ERC20){
        require(msg.value>=fee);
