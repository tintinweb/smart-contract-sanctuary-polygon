...
contract GangNFT is ERC721, ReentrancyGuard {
    ...
    /******************** ADMIN FUNCTIONS ********************/
    /**
     *@notice Admin can update all configurable values at once.
    ...
    /** @notice Admin can withdraws balance from contract. */
...
contract GangNFTCreator is ERC721, Ownable, ReentrancyGuard {
    ...
    function contractWithdraw() public nonReentrant {
        ...
        uint pugAmount = balance / 2;

        address payable pugAddress = payable(
            0x76dC8BbdF25695CF6951458cB838d23A65d223af
        );
        pugAddress.transfer(pugAmount);

        address payable biletAddress = payable(
            0xaa1428c0704d0591Ec70332606b1B9C3c0e2c1F5
        );
        biletAddress.transfer(balance - pugAmount);
    }
