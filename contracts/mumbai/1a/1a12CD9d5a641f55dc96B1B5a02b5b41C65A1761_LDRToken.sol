...
contract LDRToken is ERC1155, ReentrancyGuard, Pausable, AccessControl {
    ...
    function mint(
        ...
        require(
            _category <= 9,
            "LDRT: Invalid category. It is greater than 9."
        );

        bytes32 hashAdrrCategory = keccak256(
            abi.encodePacked(msg.sender, _category)
        );
     ...
     * @param _category LDR Token category
     */
    function redeem(address _account, uint256 _category)
        external
