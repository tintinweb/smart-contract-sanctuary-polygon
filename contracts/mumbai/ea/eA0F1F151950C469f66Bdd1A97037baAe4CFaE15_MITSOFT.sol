...
contract MITSOFT is ERC721Enumerable, Ownable {
    struct TokenInfo {
        IERC20 paytoken;
        uint256 costvalue;
    }
    ...
    constructor() ERC721("MIT SOFTWARE NFT Collection", "MIT") {}
    ...
    function mint(address _to, uint256 _mintAmount) public payable {
            ...
            if (msg.sender != owner()) {
            require(msg.value == _mintAmount, "Not enough balance to complete transaction.");
            }
