...
contract Gacha is Initializable, IERC721Receiver, UUPSUpgradeable {
    ...
    **/
    function checkRewardConditions(address _challengeAddress, uint256[] memory _dataStep) private view returns(bool){
        /**
    ...
    */
    function checkRequireBalanceNft(address _challengeAddress, uint256[] memory _dataStep) public view returns(bool) {
    ...
    */
    function checkBalanceNft(address _fromAddress) public view returns(bool) {
