...
contract OlandCard is ERC1155Burnable,ERC1155Supply,Ownable {
    ...
    uint256 [] private cardIds;
    Card[] private cards;
    mapping(uint256 =>Card) private cardIdToCard;

    constructor() ERC1155("https://metadata.oland.info/card/data/{id}.json") {
        _name="Oland Card";
        _symbol="OCard";
    }
    ...
    function symbol() public view returns (string memory) {
     ...
     function mint(
        ...
        require(!exists(cardId),"The token already exists");
        cardIds.push(cardId);
        Card memory card  = Card(cardId,length,cardName,priceOff);
        cards.push(card);
