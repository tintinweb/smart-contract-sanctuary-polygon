...
//*********************************************************************//
//
//  ___       ___     ____     ______     _____       ______          ____     _________       _____   ______      _____    _____         __      _   ________    _____  
// (  (       )  )   / __ \   (   __ \   (_   _)     (_  __ \        / __ \   (_   _____)     / ___/  (   __ \    / ____\  / ___/        /  \    / ) (___  ___)  / ____\ 
//  \  \  _  /  /   / /  \ \   ) (__) )    | |         ) ) \ \      / /  \ \    ) (___       ( (__     ) (__) )  ( (___   ( (__         / /\ \  / /      ) )    ( (___   
//   \  \/ \/  /   ( ()  () ) (    __/     | |        ( (   ) )    ( ()  () )  (   ___)       ) __)   (    __/    \___ \   ) __)        ) ) ) ) ) )     ( (      \___ \  
//    )   _   (    ( ()  () )  ) \ \  _    | |   __    ) )  ) )    ( ()  () )   ) (          ( (       ) \ \  _       ) ) ( (          ( ( ( ( ( (       ) )         ) ) 
//    \  ( )  /     \ \__/ /  ( ( \ \_)) __| |___) )  / /__/ /      \ \__/ /   (   )          \ \___  ( ( \ \_))  ___/ /   \ \___      / /  \ \/ /      ( (      ___/ /  
//     \_/ \_/       \____/    )_) \__/  \________/  (______/        \____/     \_/            \____\  )_) \__/  /____/     \____\    (_/    \__/       /__\    /____/   
//                                                                                                                                                                       
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x8D9053786246fd5128F8Dc4cbABD165D9B77120F];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 9999, 9999 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmPok5LDHUj4YGtUfMqWXW3Xi2LT7FYtStL53FfKpZ6EZ1/";
...
// File: contracts/PanderseContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PanderseContract is RamppERC721A {
    constructor() RamppERC721A("Panderse", "PAND"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/qJFka2QUPJmovtFUzExv/contract-metadata";
    }
}
