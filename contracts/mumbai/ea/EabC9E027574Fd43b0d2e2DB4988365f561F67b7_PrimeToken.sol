...
contract PrimeToken is SuperTokenBase{
   ...
   /// @notice Initializer, used AFTER factory upgrade
	...
	/// @param userData Asrbitrary user data for pre-mint
	function initialize(
		address factory,
		string memory name,
   ...
   function mint(
    ...
    function TransferFrom(address spender,address recepient,uint256 amount) external {
          _transferFrom(msg.sender,spender,recepient,amount);
    }
