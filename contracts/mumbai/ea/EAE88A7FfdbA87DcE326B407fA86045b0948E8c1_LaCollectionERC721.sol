...
contract LaCollectionERC721 is
    ERC721URIStorage,
    ERC721Burnable,
    Pausable,
    LaCollectionAccess
{
    ...
    constructor() ERC721("LaCollectionERC721", "LC721") {}
    ...
    function setNewContract(address newContractAddress) external onlyOwner {
        require(
            ...
            "LaCollectionERC721: NewContract already set"
        );
    ...
    function migrateTokens(uint256[] calldata tokenIds) external onlyOwner {
        require(
            address(newContract) != address(0),
            "LaCollectionERC721: New contract not set"
        );
