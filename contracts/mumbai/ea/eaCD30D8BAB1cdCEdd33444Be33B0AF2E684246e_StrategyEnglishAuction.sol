 ...
 * @notice Strategy to launch an English Auction for a token where the highest bidder is chosen
 */
contract StrategyEnglishAuction is IExecutionStrategy, Ownable {
        ...
        )
    {
        ...
        return (
            (startTime <= block.timestamp) &&
                ...
                (makerBid.price > makerAsk.price) &&
                (makerBid.tokenId == makerAsk.tokenId),
            makerAsk.tokenId,
            makerAsk.amount
        );
    }
