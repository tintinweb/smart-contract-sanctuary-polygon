...
contract ChainBattles is ERC721URIStorage {
    ...
    // randNounce injects a second layer of random to the pesudo random function
    ...
    function train(uint256 tokenId) public {
        ...
        tokenIdToAttributes[tokenId].speed += random(10);
        tokenIdToAttributes[tokenId].strength += random(30);
        tokenIdToAttributes[tokenId].life += random(40);
