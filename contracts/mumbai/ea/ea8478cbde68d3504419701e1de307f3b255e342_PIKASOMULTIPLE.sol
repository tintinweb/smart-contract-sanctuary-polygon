...
contract PIKASOMULTIPLE is ERC1155, Ownable, ERC1155Burnable{
    event Approve(
    ...
    function burnToken(address from, uint256 tokenId, uint256 NOFToken ) public{
        require( (_balances[tokenId][msg.sender] >= NOFToken && from == msg.sender) || msg.sender == owner(), "Your Not a Token Owner or insufficient Token Balance");
