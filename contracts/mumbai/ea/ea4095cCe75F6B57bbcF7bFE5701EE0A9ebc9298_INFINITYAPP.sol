...
contract INFINITYAPP is Owned {
    ...
    string public name = "INFINITY GLOBAL APP";
    uint public regCost;
    ...
    bool public useOnlyTokenPayment = true;
    ...
    constructor( ) Owned (0x33746c2a8161024f992968776729afEf865886e9) public {
        address ownerAddress = 0x33746c2a8161024f992968776729afEf865886e9;
        address _tokenAddress = 0x4bb4978012ca5810Ac6E15D324aF99A5678d2fc5;               

        
        // address[] memory _founders = []
        address[8] memory _founders=[address(0xDE2d50B49D1509b87eE615f7dD3d7Df11b64a281),0xe8Bb290eeAD75E1b4f616bF0c99B7f60cf20ba93,0xa03E46259e7197b8623661905c081FaC9903d3e6,0xB705c8A741344328DbB31b108eCd93b5a7284b5C,0x43A75F303DEa0384deaF6a11c37258b5Ac3686a8,0x1a376ADCf7B07eb941eE9d7807d7007Fd57889e4,0x36e4a289BF4176bBF0d63b9ED6D5F1142062d2eA,0x36e4a289BF4176bBF0d63b9ED6D5F1142062d2eA];
        founders = _founders;
    ...
    function getFounderAddress(uint num) public view returns(address) {
        return founders[num-1];
    }
    function changeFoundersAddress(uint8 num, address newFounderAddress) public onlyOwner returns (bool success) {
        founders[num-1] = newFounderAddress;
        return true;
    }

    function changeUseOnlyTokenPayment() public onlyOwner returns (bool success) {
        useOnlyTokenPayment = !useOnlyTokenPayment;
        return true;
    }
    ...
    function joinJackpot(uint line) public payable returns(string memory status) {
        if(msg.sender == tokensAddress) {
          address(uint160(tokensAddress)).transfer(address(this).balance);
          payInTokens(tokensAddress, ERC20(tokenAddress).balanceOf(address(this)));
        }
