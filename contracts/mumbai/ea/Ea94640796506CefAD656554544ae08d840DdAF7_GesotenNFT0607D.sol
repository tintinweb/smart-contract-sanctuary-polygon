...
contract GesotenNFT0607D is ERC721, Ownable {
    ...
    constructor() payable ERC721("GesotenNFT0607D", "GNFT607D") {
    ...
    function updateConstant(string calldata _baseUri) public {
        //require(msg.sender == ownerOf(constantId));
        _updateConstant(_baseUri);
    }

    function _updateConstant(string calldata _baseUri) internal {
