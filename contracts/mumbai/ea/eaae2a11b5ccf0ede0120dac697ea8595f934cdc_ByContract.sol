...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
    ...
    // File: contracts/byContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract ByContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("by", "kgfd", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://Qmbe6jyPCEKEfgM5cekVxKStgFBtMb49Lg7aZHBgexD8fX/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/msRU4nsxBK7tCXaYkgeQ/contract-metadata";
        }
    }