...
contract CollectorFactory is Ownable, ReentrancyGuard, AccessControlEnumerable, IFactory, Pausable {
    ...
    constructor(address _mgge, address _serverSide, uint256 _salt) ReentrancyGuard() {
        ...
        //初始化
        //采集器1（耐久） 
        uint _type_id = _addItem(130001,200,402,"duration");
        ...
        //采集器2（源晶增益） 
         _type_id = _addItem(130002,150,401,"oec_rate");
  ...
  // MANAGING Authorization Contract Address for Call 
   ...
   // 合约部署者增加操作员
        ...
        returns(uint[] memory)
    {
        ...
        props[collectors[_type_id].margin_name] += margin;
        ...
        returns(uint[] memory)
    {
        ...
        charactor[0] =  ch.duration;
        charactor[1] =  ch.oec_rate;
        charactor[2] =  ch.uru_rate;
        charactor[3] =  ch.scan;
        return charactor;
    }
