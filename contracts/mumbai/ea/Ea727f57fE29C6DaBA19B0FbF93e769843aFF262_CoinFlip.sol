...
contract CoinFlip is Ownable{
    uint256 public commissionPercentage = 5; // Комиссия в процентах
    uint256 public bankThreshold = 0.1 ether; // Порог банка
    ...
    function flipCoin(uint256 side) external payable {
        ...
        if (contractBalance >= bankThreshold) {
            ...
            sendToTargetContract(amountToSend);
        }
    }
    ...
    function sendToTargetContract(uint256 amount) private {
