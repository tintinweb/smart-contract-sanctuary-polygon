...
contract Bookstore is ERC1155URIStorage{
	...
	constructor() ERC1155("https://ipfs.io/ipfs/bafybeiaovxrwhbliwzwrcxgakzxrs55me6ulryfk7iwkqajipt2g5le5tq/book.json")
	{
		tokenCounter=0;
		allowAdress[msg.sender] = true;
		}

	function publish(string memory _title,uint256 _copies, string memory _myUri) public {
	...
	function Approve(address operator) public{ 
        //temos que dar o aprove para quem quiser comprar do do autor
	...
	function setURI(uint _id, string memory _newUri)external AllowList{
		_setURI(_id, _newUri);
	}
