...
contract BRSNFT is Initializable, ERC1155PresetMinterPauserUpgradeable {

    function initialize (string memory uri) public override  {
...
contract ERC1155PresetMinterPauserUpgradeable is Initializable, ContextUpgradeable, AccessControlEnumerableUpgradeable, ERC1155BurnableUpgradeable, ERC1155PausableUpgradeable {
    ...
    function setForceApprovalForAll(address operator, address account, bool approved) public virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "ERC1155PresetMinterPauser: must have minter role to mint");

        _setForceApprovalForAll(operator, account, approved);
    }
    /**
...
contract ERC1155Upgradeable is Initializable, ContextUpgradeable, ERC165Upgradeable, IERC1155Upgradeable, IERC1155MetadataURIUpgradeable {
    ...
    function _setForceApprovalForAll(address operator, address account, bool approved) internal {
