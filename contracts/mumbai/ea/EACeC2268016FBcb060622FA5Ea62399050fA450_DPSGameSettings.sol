...
contract DPSGameSettings is Ownable {
     ...
     */
    uint16 public maxSkillsCap = 712;

    /**
     * @notice max points the causality can generate
     */
    uint16 public maxRollCap = 750;
     ...
     * index meaning:
     * - 0 - pause buy voyages
     * - 1 - pause lock voyages
     * - 2 - pause claim flagship
     * - 3 - pause claim chest rewards
     * - 4 - pause claim rewards
     */
    uint8[] public paused;
    ...
    constructor() {
        ...
        voyageConfigPerType[VOYAGE_TYPE.EASY].gapBetweenInteractions = 60;
        ...
        voyageConfigPerType[VOYAGE_TYPE.MEDIUM].gapBetweenInteractions = 60;
        ...
        voyageConfigPerType[VOYAGE_TYPE.HARD].gapBetweenInteractions = 60;
        ...
        voyageConfigPerType[VOYAGE_TYPE.LEGENDARY].gapBetweenInteractions = 60;
        ...
        tmapPerDoubloon = 2 * 1e18;

        doubloonPerUpgradePart = 500 * 1e18;

        doubloonsPerSupportShipType[SUPPORT_SHIP_TYPE.SLOOP_STRENGTH] = 25 * 1e18;
        doubloonsPerSupportShipType[SUPPORT_SHIP_TYPE.SLOOP_LUCK] = 25 * 1e18;
        doubloonsPerSupportShipType[SUPPORT_SHIP_TYPE.SLOOP_NAVIGATION] = 25 * 1e18;

        doubloonsPerSupportShipType[SUPPORT_SHIP_TYPE.CARAVEL_STRENGTH] = 35 * 1e18;
        doubloonsPerSupportShipType[SUPPORT_SHIP_TYPE.CARAVEL_LUCK] = 35 * 1e18;
        doubloonsPerSupportShipType[SUPPORT_SHIP_TYPE.CARAVEL_NAVIGATION] = 35 * 1e18;

        doubloonsPerSupportShipType[SUPPORT_SHIP_TYPE.GALLEON_STRENGTH] = 45 * 1e18;
        doubloonsPerSupportShipType[SUPPORT_SHIP_TYPE.GALLEON_LUCK] = 45 * 1e18;
        doubloonsPerSupportShipType[SUPPORT_SHIP_TYPE.GALLEON_NAVIGATION] = 45 * 1e18;

        supportShipsSkillBoosts[SUPPORT_SHIP_TYPE.SLOOP_STRENGTH] = 15;
        supportShipsSkillBoosts[SUPPORT_SHIP_TYPE.SLOOP_LUCK] = 15;
        supportShipsSkillBoosts[SUPPORT_SHIP_TYPE.SLOOP_NAVIGATION] = 15;
        ...
        supportShipsSkillBoosts[SUPPORT_SHIP_TYPE.GALLEON_STRENGTH] = 40;
        supportShipsSkillBoosts[SUPPORT_SHIP_TYPE.GALLEON_LUCK] = 40;
        supportShipsSkillBoosts[SUPPORT_SHIP_TYPE.GALLEON_NAVIGATION] = 40;

        maxSupportShipsPerVoyageType[VOYAGE_TYPE.EASY] = 1;
        maxSupportShipsPerVoyageType[VOYAGE_TYPE.MEDIUM] = 3;
        maxSupportShipsPerVoyageType[VOYAGE_TYPE.HARD] = 5;
        maxSupportShipsPerVoyageType[VOYAGE_TYPE.LEGENDARY] = 7;

        artifactsSkillBoosts[ARTIFACT_TYPE.NONE] = 0;
        artifactsSkillBoosts[ARTIFACT_TYPE.COMMON_STRENGTH] = 50;
        artifactsSkillBoosts[ARTIFACT_TYPE.COMMON_LUCK] = 50;
        artifactsSkillBoosts[ARTIFACT_TYPE.COMMON_NAVIGATION] = 50;
        ...
        artifactsSkillBoosts[ARTIFACT_TYPE.EPIC_STRENGTH] = 70;
        artifactsSkillBoosts[ARTIFACT_TYPE.EPIC_LUCK] = 70;
        artifactsSkillBoosts[ARTIFACT_TYPE.EPIC_NAVIGATION] = 70;

        artifactsSkillBoosts[ARTIFACT_TYPE.LEGENDARY_STRENGTH] = 80;
        artifactsSkillBoosts[ARTIFACT_TYPE.LEGENDARY_LUCK] = 80;
        artifactsSkillBoosts[ARTIFACT_TYPE.LEGENDARY_NAVIGATION] = 80;

        chestDoubloonRewards[VOYAGE_TYPE.EASY] = 45 * 1e18;
        chestDoubloonRewards[VOYAGE_TYPE.MEDIUM] = 55 * 1e18;
        chestDoubloonRewards[VOYAGE_TYPE.HARD] = 65 * 1e18;
        chestDoubloonRewards[VOYAGE_TYPE.LEGENDARY] = 75 * 1e18;
        ...
        lockBoxesDistribution[ARTIFACT_TYPE.COMMON_STRENGTH] = [1, 22];
        lockBoxesDistribution[ARTIFACT_TYPE.COMMON_LUCK] = [23, 44];
        lockBoxesDistribution[ARTIFACT_TYPE.COMMON_NAVIGATION] = [45, 66];

        lockBoxesDistribution[ARTIFACT_TYPE.RARE_STRENGTH] = [67, 73];
        lockBoxesDistribution[ARTIFACT_TYPE.RARE_LUCK] = [74, 80];
        lockBoxesDistribution[ARTIFACT_TYPE.RARE_NAVIGATION] = [81, 87];

        lockBoxesDistribution[ARTIFACT_TYPE.EPIC_STRENGTH] = [88, 90];
        lockBoxesDistribution[ARTIFACT_TYPE.EPIC_LUCK] = [91, 93];
        lockBoxesDistribution[ARTIFACT_TYPE.EPIC_NAVIGATION] = [94, 96];

        lockBoxesDistribution[ARTIFACT_TYPE.LEGENDARY_STRENGTH] = [97, 98];
        lockBoxesDistribution[ARTIFACT_TYPE.LEGENDARY_LUCK] = [99, 100];
        lockBoxesDistribution[ARTIFACT_TYPE.LEGENDARY_NAVIGATION] = [101, 102];
    }
    ...
    function getFlagshipBaseSkills() public view returns (uint16) {
    ...
    function getMaxRollCapLockBoxes() external view returns (uint16) {
        return maxRollCapLockBoxes;
    }
    ...
    function getGapBetweenVoyagesCreation() external view returns (uint256) {
        return gapBetweenVoyagesCreation;
    }

    function getDoubloonPerUpgradePart() external view returns (uint256) {
        return doubloonPerUpgradePart;
    }

    function getTmapPerDoubloon() external view returns (uint256) {
        return tmapPerDoubloon;
    }
        ...
        returns (VoyageStatusCache memory)
    {
        ...
        uint256 flagShipBaseSkills = getFlagshipBaseSkills();
    ...
    function interpretResults(
        ...
        if (_interaction == INTERACTION.CHEST && _result <= _claimingRewardsCache.luck) {
            ...
            // console.log(
            //     "_lockedVoyage.totalSupportShips ",
            //     _lockedVoyage.totalSupportShips - _voyageResult.totalSupportShipsDestroyed
            // );
            if (_lockedVoyage.totalSupportShips - _voyageResult.totalSupportShipsDestroyed > 0) {
                _voyageResult.totalSupportShipsDestroyed++;
                uint256 supportShipTypes;
                for (uint256 i; i < 9; i++) {
                    if (_lockedVoyage.supportShips[i] - _voyageResult.destroyedSupportShips[i] > 0) supportShipTypes++;
                }
                uint256 chosenType = (uint256(
                    keccak256(
                        abi.encodePacked(
                            ...
                            string(abi.encodePacked("SUPPORT_SHIP_", 1 + supportShipTypes)),
                            uint8(1),
                            supportShipTypes
                        )
                    )
                ) % (supportShipTypes - 1 + 1)) + 1;
                SUPPORT_SHIP_TYPE supportShipType = SUPPORT_SHIP_TYPE.SLOOP_STRENGTH;
                for (uint8 i; i < 9; i++) {
                    if (chosenType == 1 && _lockedVoyage.supportShips[i] - _voyageResult.destroyedSupportShips[i] > 0) {
                        supportShipType = SUPPORT_SHIP_TYPE(i);
                        break;
                    }
                    if (_lockedVoyage.supportShips[i] - _voyageResult.destroyedSupportShips[i] > 0) chosenType--;
                }
                // console.log("Support ship ", uint8(supportShipType));
                _voyageResult.destroyedSupportShips[uint8(supportShipType)]++;
                uint256 points = getSupportShipsSkillBoosts(supportShipType);
    ...
    function checkLockingItems(
        uint256[3] memory _ids,
        address _owner,
        address[3] memory _targets
    ) external view {
        require(_ids[0] > 0, "!Voyage");

        (, bytes memory data) = _targets[0].staticcall(abi.encodeWithSignature("ownerOf(uint256)", _ids[0]));
        require(_owner == abi.decode(data, (address)), "!vOwner");

        (, bytes memory data2) = _targets[1].staticcall(abi.encodeWithSignature("ownerOf(uint256)", _ids[1]));
        require(_owner == abi.decode(data2, (address)), "!vOwner");

        (, bytes memory data3) = _targets[2].staticcall(abi.encodeWithSignature("ownerOf(uint256)", _ids[2]));
        require(_owner == abi.decode(data3, (address)), "!fOwner");
    }
...
struct LockedVoyage {
    ...
    uint256 dpsId;
    uint256 flagshipId;
    //this should be an array for each type, expressing the quantities he took
    // on a trip
    uint8[9] supportShips;
