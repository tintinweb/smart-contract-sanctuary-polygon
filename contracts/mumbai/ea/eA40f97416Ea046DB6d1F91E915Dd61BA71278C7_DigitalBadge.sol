...
contract DigitalBadge is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function safeMint(address to, string memory uri, bool _isTransferable) public onlyRole(MINTER_ROLE) {
    ...
    {
        require(isTransferable[tokenId],"DigitalBadge: Token No se puede transferir");
