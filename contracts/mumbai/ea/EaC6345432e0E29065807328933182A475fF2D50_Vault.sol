...
contract Vault is Ownable {
    ...
    function pendingReward(address _user) external view returns (uint256) {
        ...
        console.log(1111);
        console.log(pool.accRewardTokenPerShare);
        console.log(user.amount);
        console.log(user.rewardDebt);
        console.log("pool last reward");
        console.log(pool.lastRewardTimestamp);
        console.log("onchain now");
        ...
        if (block.timestamp > pool.lastRewardTimestamp && totalStaked != 0) {
            ...
            console.log(accRewardTokenPerShare);
            console.log(888888);
        }
        console.log(2222);
    ...
    function setStartTime(uint256 _startTime) external onlyOwner {
        poolInfo[0].lastRewardTimestamp = _startTime;
