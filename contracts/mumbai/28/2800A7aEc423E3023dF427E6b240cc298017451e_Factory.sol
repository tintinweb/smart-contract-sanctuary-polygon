...
contract ALP is AlpToken, IAlp, Ownable, MixinResolver {
    ...
    function requestReserve(
        uint256 leverage,
        uint256 amount
    ) external whenNotStopped isD4X returns (uint256 val, uint256 leverageAv) {
        ...
        emit RequestReserve(msg.sender, amount);
    }
...
contract Factory is IFactory, AlpDeployer, Ownable {
    ...
    mapping(uint256 => IExchange) private exchanges;
    ...
    function getExchange(uint256 type_) external view returns (IExchange) {
