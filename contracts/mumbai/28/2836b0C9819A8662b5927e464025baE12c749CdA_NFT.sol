...
contract NFT is ERC721A, Ownable {
    ...
    function mintForAddress(address _user, uint256 _amount) public onlyOwner {
        require(_amount + reservedCount <= nftReserve);
        uint256 supply = totalSupply();
    ...
    function setNftReserve(uint256 _reserve) public onlyOwner {
        nftReserve = _reserve;
    }
