...
*/
contract TestReflections is Context, IERC20, Ownable {
...
contract Test is TestReflections {

    uint256 private _tokenSupply = 1000000000; // 1 Billion

    uint32 private _taxLiquify = 10;
    ...
    uint256 private _minTokensBeforeSwap = (10 ** 6) * (10 ** _decimals);

    constructor () TestReflections("Test Token", "TEST", _decimals, _tokenSupply) {
