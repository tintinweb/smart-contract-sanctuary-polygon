...
contract BuyIUX is Ownable {
    ...
    function exchangeTokens(uint256 _usdAmount) public {
...
contract ExpressPool is Ownable {
    ...
    function processDeposit(address _depositAddress, address _beneficiaryAddress, uint256 _aprIndex) external onlyProcessor {
        require(_depositAddress != address(0), "Cannot find address");
        address quoteTokenAddress = investmentPoolMaster.quoteTokenContractAddressList(quoteTokenIndex);
    ...
    function updateInvestmentBeneficiary(uint256 _investmentIndex, address _beneficiaryAddress) external onlyProcessor {
        Investment storage investment = investments[_investmentIndex];
