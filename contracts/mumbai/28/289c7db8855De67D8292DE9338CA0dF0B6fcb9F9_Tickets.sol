...
// File: @opengsn/[email protected]/src/interfaces/IRelayRecipient.sol
...
// File: @opengsn/[email protected]/src/BaseRelayRecipient.sol
...
// File: contracts/METALAB/Tickets.sol
...
contract Tickets is ERC721URIStorage, BaseRelayRecipient, Ownable {
    ...
    constructor(address _trustedForwarder) ERC721("TICKET", "MetaApp Ticket") {
    ...
    function mint(address buyer, string memory metadataURI)
        public
        onlyOwner
        returns (uint256)
    {
