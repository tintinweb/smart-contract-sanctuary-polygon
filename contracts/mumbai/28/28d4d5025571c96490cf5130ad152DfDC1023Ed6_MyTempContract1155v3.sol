...
// File contracts/temp/MyTempContract1155v3.sol

// 

pragma solidity 0.8.12;
contract MyTempContract1155v3 is ERC1155, Pausable, Ownable {
...
abstract contract MyBeaconedProxy3 is Proxy, ERC1967UpgradeBeaconed {
...
contract MyTransparentUpgradeableProxy3 is ITransparentUpgradeableBeaconedProxy, MyBeaconedProxy3 {
    constructor(
        address _beaconAddress,
        address admin_,
        bytes memory _data
    ) payable MyBeaconedProxy3(_beaconAddress, _data) {
