...
contract PanamaCanal is GameManager, VRFManager, ERC2771Context, AccessControlEnumerable {
    ...
    function assignNextPlayerCard(uint256 _gameNumber, uint256 _handPointer, uint256 _dealtCard) public {
    ...
    function assignNextDealerCard(uint256 _gameNumber, uint256 _dealtCard) public {
