...
import "./interfaces/ISneaker.sol";
import "./interfaces/ISneakerBox.sol";

contract SneakerBox is
    Ownable,
    ReentrancyGuard,
    Pausable,
    ERC721Enumerable,
    ISneakerBox
{
    ...
    uint256 public constant WALKER = 1;
    uint256 public constant JOGGER = 2;
    uint256 public constant RUNNER = 3;
    ...
    modifier onlyMinter() {
        require(
            ...
            "SneakerBox: account not role minter"
        );
        _;
    }
    ...
    modifier verifyBoxType(uint256 _boxType) {
        require(
            _boxType == WALKER || _boxType == JOGGER || _boxType == RUNNER,
            "SneakerBox: Box type invalid value"
        );
        _;
    }
    ...
    modifier verifyCollection() {
        require(
            ...
            "SneakerBox: Invalid collection"
        );
        _;
    }

    constructor(string memory _baseUrl)
        ERC721("Moverse Sneaker Box", "SneakerBox")
    {
        baseUrl = _baseUrl;
    ...
    function setCollectionAddress(address _collectionAddress) public onlyOwner {
        require(
            ...
            "SneakerBox: Invalid collection input"
        );
    ...
    function _openBox(uint256 _boxId) private {
        require(
            ...
            "SneakerBox:Caller is not owner of this box"
        );
        uint256 tokenId = ISneaker(collectionAddress).mint(msg.sender);
...
interface ISneaker is IERC721Enumerable {
...
interface ISneakerBox is IERC721Enumerable {
