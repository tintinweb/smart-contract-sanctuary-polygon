...
contract Cultmaker is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 38,000 Cultmaker
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("Cultmaker", "CULTMAKER") {
        _mint(msg.sender, 1 ether); // mint 1 Cultmaker for initial pools deployment
