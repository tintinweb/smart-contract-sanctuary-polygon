...
contract NFT is ERC721Tradable {
    ...
    constructor(address _proxyRegistryAddress, uint256 settingA)
        ERC721Tradable("HI", "HIII", _proxyRegistryAddress)
    {
        a = settingA;
    }
    ...
    function contractURI() public pure returns (string memory) {
        return "https://creatures-api.opensea.io/api/creature/1";
    }
