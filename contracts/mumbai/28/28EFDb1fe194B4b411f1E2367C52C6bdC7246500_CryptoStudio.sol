...
//    @@@    ::   :::  @@@@@@@   :: ::::  ::: ::::  @@@@@@@   :   : :  ::         ::  @@@@@@@     \\
    ...
    string private constant SPACE_SCHEMA = "spaceName text, space_owner text, groupID text";
    ...
    function SocialSpaceCreation(string memory spaceName , string memory space_group) public  {
        require(spaceMap[spaceName] == msg.sender , "taken space");
