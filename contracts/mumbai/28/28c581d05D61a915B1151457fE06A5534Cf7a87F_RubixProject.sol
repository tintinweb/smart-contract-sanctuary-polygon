...
contract RubixProject is ERC2771Recipient {
    ...
    constructor(
        ...
        currencyContract.permit(_owner, escrowAddress, totalBudget, deadline, v, r, s);
    ...
    function createTask(uint16 taskId, string memory taskName, uint256 pay) external onlyLeader {
