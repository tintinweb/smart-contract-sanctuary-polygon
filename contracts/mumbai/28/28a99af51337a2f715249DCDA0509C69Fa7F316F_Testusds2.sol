...
contract Testusds2 is ERC20 {
    uint8 private _decimal = 6; // cents decimals
    uint256 private _minMintableStablecoin = 10000000; // US$ 10.00 , 10100000 means US$ 10.10
     ...
     */
    function mint(uint256 amount) external admin {
        require(
            amount >= _minMintableStablecoin,
            'Need to mint at leat the minimum'
        );
