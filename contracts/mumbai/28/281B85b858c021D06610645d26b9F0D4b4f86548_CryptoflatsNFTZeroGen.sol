...
contract CryptoflatsNFTZeroGen is ERC721rPass, Ownable, ERC2981 {
    ...
    function mint(
        ...
        if (isMemberFreeList(_proofFreeList, leaf)) {
            _freeList[msg.sender] = true;
        } else if (isMemberSaleList(_proofSaleList, leaf)) {
