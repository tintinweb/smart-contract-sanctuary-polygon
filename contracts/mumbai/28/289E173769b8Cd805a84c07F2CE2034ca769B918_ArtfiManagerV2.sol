    ...
    function verifyFixedPriceLazyMintV2(
        ...
        bytes32 digest = _hashTypedDataV4(
            keccak256(
                abi.encode(
                    keccak256(
                        "LazyMintData(address tokenAddress, string uri,address seller, address buyer, string uid, address[] creators,uint256[] royalties,address[] investors,uint256[] stakeRoyalty,string currency,uint256 minPrice,uint256 quantity)"
                    ),
