...
import "./ShroomAccessControl.sol";


contract WonderGameShroom is ERC20Burnable, ERC20Capped, ShroomAccessControl {

    constructor(string memory name, string memory symbol, uint256 _cap)
    ERC20Capped(_cap)
    ERC20(name, symbol)
    ShroomAccessControl()
    public
...
abstract contract ShroomAccessControl is AccessControl {
