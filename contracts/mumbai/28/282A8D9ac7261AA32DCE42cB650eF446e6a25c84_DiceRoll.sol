...
contract DiceRoll is Ownable, ReentrancyGuard {
    ...
    */
    ...
    function claim(
        ...
        require(games[_gameId][_winnerAddress].start == true && games[_gameId][_loserAddress].start == true, "DiceRoll.claim: Game is not created");
        // require(
        ...
        emit Claim(_gameId, _winnerAddress, claimAmount);
    }
