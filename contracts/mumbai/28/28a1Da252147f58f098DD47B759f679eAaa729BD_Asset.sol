...
contract Asset is Ownable, ERC20, IAsset {
    ...
    /// @notice The underlying usdToken represented by this asset
    ...
    /**
     * @notice Constructor.
     * @param usdToken_ The token represented by the asset
    ...
    constructor(
        ...
        usdToken = usdToken_;
        usdTokenDecimals = ERC20(usdToken_).decimals();
        virtualSupply = 0;
    }
    ...
    /**
     * @notice Changes asset max supply. Can only be set by the contract owner. 0 decimals
    ...
    /**
     * @notice Get USD Token Balance
     * @return Returns the actual balance of ERC20 USD
     */
    ...
    /**
     * @notice Transfers ERC20 usdToken from this contract to another account. Can only be called by Master.
     * @dev Not to be confused with transferring MERCH tokens.
     * @param to address to transfer the token to
     * @param amount amount to transfer
     */
    function transferUsdToken(address to, uint256 amount) external onlyMaster {
