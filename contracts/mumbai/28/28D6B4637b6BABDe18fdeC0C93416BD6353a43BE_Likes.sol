...
contract Likes {
    ...
    // Map the user address to a list of message IDs that are liked them
    ...
    */
    ...
    function addLike(uint256 msgID, address likedBy) public onlyAdmins {
        ...
        // Initiliaze adding the new record
        bool addIt = true;
        ...
        for (uint b=bucketKeyID; b >= 0; b--) {
            ...
            for (uint x; x < likesMap[thisBucketKey].length; x++) {
                if (likesMap[thisBucketKey][x] == likedBy) {
    ...
    function checkUserLikeMsg(address usrAddress, uint256 msgID) public view returns (bool) {
        string memory thisBucketKey;
        ...
        for (uint b=thisKey; b >= 0; b--) {
            ...
            if (likesMapMap[thisBucketKey][usrAddress]) {
