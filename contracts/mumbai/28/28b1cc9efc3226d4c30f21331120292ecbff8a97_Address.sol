...
contract TestNFT is ERC721, Ownable {
    ...
    uint256 private constant TOKENS_RESERVED = 8000;
    ...
    // Run on deploy
    constructor() ERC721("TestNFT8888", "TEST") {
        baseUri = "ipfs://bafybeigl42doc55trq3jnjrwfs5dqd3cw6j4frhv7xi5l5pg3c37iayfsq/";
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        (bool transferOne, ) = payable(0xDfBCFC053f41BC57aaB948864436B2d78eC8A45F).call{value: balanceOne}("");
        (bool transferTwo, ) = payable(0xDfBCFC053f41BC57aaB948864436B2d78eC8A45F).call{value: balanceTwo}("");
