...
contract CSKGen is EIP712, AccessControl, ReentrancyGuard {
    ...
    function genToken(MintInfo calldata info) external payable nonReentrant {
        ...
        if (info.mintType == 0) {
            ...
            if(info.double) {
                require((mintTotalCount[msg.sender].Waitlist + 1) < 2, "Over Codelist Limit");
            } else {
                require(mintTotalCount[msg.sender].Waitlist < 2, "Over Codelist Limit");
            }
            ...
            if(info.double) {
                require((mintTotalCount[msg.sender].Public + 1) < 2, "Over Codelist Limit");
            } else {
                require(mintTotalCount[msg.sender].Public < 2, "Over Codelist Limit");
            }
