...
contract ConduitERC721 is AccessControl, ERC721Holder, AcceptedTokenList {
    ...
    constructor(
        ...
        _setupRole(OFFER_EXECUTOR_ROLE, msg.sender);
    ...
    function makeOffer(
        ...
        require(IERC20(_erc20Token).allowance(msg.sender, address(this)) >= _amount, "Need to approve");
    ...
    /** @notice Executes offer by OFFER_EXECUTOR, need to approve ERC721 token before execution
     * @param _offerCreator Address of creator of offer
     * @param _seller Address of user whcih sell ERC721 token
     * @param _offerId Id of offer in array of offers of offerCreator
     */
    function executeOffer(address _offerCreator, address _seller, uint256 _offerId) public onlyRole(OFFER_EXECUTOR_ROLE) {
...

        {
            ...
            IERC20(offer.erc20Token).transfer(_seller, offer.amount - feeAmount);
        }

        IERC721(offer.erc721Token).safeTransferFrom(_seller, _offerCreator, offer.tokenId);
