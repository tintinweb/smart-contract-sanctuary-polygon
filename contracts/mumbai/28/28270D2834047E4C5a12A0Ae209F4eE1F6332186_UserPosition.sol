...
contract UserPosition {
    ...
    function redeemRent(string calldata symbol) external {
        _isEligibleToClaimRent();
        IRentShare(rentShare).harvestRewards(symbol);
    }
    ...
    function _isEligibleToClaimRent() internal {
        revert("Implement repay logic first");
        // _getTotalRepaidAmount;
    }
}
