...
contract NFTGT_MarketplaceV1 is Ownable, Pausable, ReentrancyGuard {
    ...
    */
    function _validateSellerSignature(SellOrder memory sellOrder, bytes memory signature) internal view returns (bool) {
        ...
        //require( digest == 0x4b4583f7ecc1a7ae81a0a859badfb3da6b40ea7a924fc77308aeb38e51be5c62, "digest is not equal");
        address recoveredAddress = ECDSA.recover(digest, signature);
        //require( recoveredAddress == 0x70997970C51812dc3A010C7d01b50e0d17dc79C8, "address is not equal");
    ...
    function _transferNFT(address contractAddress, uint256 tokenId, address seller, address buyer, uint256 quantity) internal {
        if (contractAddress.supportsInterface(InterfaceId_ERC721)) {
            ...
            if (extraERC1155(contractAddress).minted_records(tokenId) == true){
                ...
                extraERC1155(contractAddress).safe_mint_ext(buyer, tokenId);
            }
