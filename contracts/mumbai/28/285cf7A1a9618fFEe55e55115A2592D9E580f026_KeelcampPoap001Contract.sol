...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [0xF6653dD2E5610861e5662383A5d091AfA6aaA529];
...
// File: contracts/KeelcampPoap001Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract KeelcampPoap001Contract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Keelcamp Poap 001";
    string public symbol = "keel001";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/lLifcE67zNyoILOzrSMx/contract-metadata";
  }
