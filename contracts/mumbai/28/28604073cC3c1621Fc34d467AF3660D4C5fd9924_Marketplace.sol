...
contract Marketplace is ERC721Holder, Ownable {
   ...
   * @param collection collection of card owner wants to buy
   ...
   * @param owner buy order creator
   * @param orderId ID of buy order
   * @param collection collection of card owner wanted to buy
...
function buySellOrder(bytes32 _orderId) external payable onlyIfSenderNotContract sellOrderExists(_orderId) {
   ...
   * @param _collection collection of card owner looks tu buy
   *
   * @return the order ID
   */
  function createBuyOrder(
    uint8 _cardType, uint8 _collection
