...
// File contracts/contract.sol
    ...
    contract MyNewReviewCollection is
        Ownable,
        ERC721A,
        IERC2981,
        ReentrancyGuard,
        DefaultOperatorFilterer
    {
        ...
        modifier checkQuantity(uint256 quantity) {
            ...
            require(
                _publicCounter + quantity <= (MAX_SUPPLY - AIRDROP_SUPPLY),
        ...
        function airDrop(
            ...
            require(
                _airdropCounter + quantity <= AIRDROP_SUPPLY,
            ...
            checkQuantity(quantity)
        {
            ...
            if(_cProof == _publicSaleDiscountCode ) {
                uint256 discountValue = (PUBLIC_PRICE * _publicSaleDiscountValue) / 100;
                uint256 tokenPrice = PUBLIC_PRICE - discountValue;
        ...
        // ERC2981
        function setRoyaltyReceiver(address new_address) public onlyOwner {
            require(royaltyAddress != new_address, "Cannot set address to the same value");
            royaltyAddress = new_address;
        }

        function setRoyaltyPercentage(uint256 new_value) public onlyOwner {
            require(royaltyPercent != new_value, "The new percentage is the same as the current percentage");
            royaltyPercent = new_value;
        }
        ...
        function setPublicSaleActive(bool _state) public onlyOwner {
            require(_state != _publicSaleActive, "New sale activation state is the same as the current state");
        ...
        function setAirdropSupply(uint256 _airdopSupply) public onlyOwner {
            AIRDROP_SUPPLY = _airdopSupply;
        }
        ...
        function getMintInfo() external view 
            ...
            saleInfo = SaleInfo(_publicSaleActive);
            priceInfo = PriceInfo(PUBLIC_PRICE);
            maxMintInfo = MaxMintInfo(maxPublicSaleMintAmount);

            _totalSupply = totalSupply();
            _maxSupply = MAX_SUPPLY;
            _airdropSupply = AIRDROP_SUPPLY;
        }
