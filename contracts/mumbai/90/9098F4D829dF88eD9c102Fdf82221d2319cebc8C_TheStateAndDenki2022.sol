...
import "./interfaces/ITheStateAndDenki2022.sol";
...
contract TheStateAndDenki2022Storage {
    mapping(address => uint256) public whitelistMinted;
    mapping(address => bool) public isAuthorized;
    mapping(address => bool) public isSigner;
    BitMaps.BitMap internal isTokenInvalid;

    uint256 public MAX_TOKENS_AMOUNT;
    uint256 public MAX_TOKENS_TIERAMOUNT;
    uint256 public MAX_TOKENS_PERTX;
...
contract TheStateAndDenki2022 is ITheStateAndDenki2022, TheStateAndDenki2022Storage, ERC721A, Ownable, ERC2981 {
    ...
    constructor()
        ERC721A("TheStateAndDenki2022", "TSD2022") 
    {
        baseURI = "";
        isSigner[owner()] = true;
        MAX_TOKENS_AMOUNT = 10000;
        MAX_TOKENS_TIERAMOUNT = 10000;
        MAX_TOKENS_PERTX = 10000;
        TOKEN_PRICE = 1 ether;
        tokensAuctionSaleTimeStep = 120;
        tokensAuctionSaleStartPrice = 10 ether;
        tokensAuctionSaleEndPrice = 1 ether;
        tokensAuctionSalePriceStep = 1 ether;
        tokensAuctionSaleMaxStepAmount = 9;
    ...
    function mintGiveawayTokens(
        ...
        onlyAuthorized
    {
        if (totalSupply().add(quantities) > MAX_TOKENS_AMOUNT) {
        ...
        whitelistMintActive
    {
        ...
        if (totalSupply() + quantities > MAX_TOKENS_TIERAMOUNT) {
            revert ExceedMaxTierTokens();
        }

        if (totalSupply() + quantities > MAX_TOKENS_AMOUNT) {
            revert ExceedMaxTokens();
        }
        ...
        if (msg.value < quantities.mul(TOKEN_PRICE)) {
            revert NotEnoughETH();
        }
        ...
        callerIsUser
    {
        ...
        if (quantities > MAX_TOKENS_PERTX) {
    ...
    function setMaxTokensAmount(uint256 newMaxTokensAmount)
        ...
        onlyOwner
    {
        MAX_TOKENS_AMOUNT = newMaxTokensAmount;
    }
    ...
    function setMaxTokensTierAmount(uint256 newMaxTokensTierAmount)
        ...
        onlyOwner
    {
        MAX_TOKENS_TIERAMOUNT = newMaxTokensTierAmount;
    }
    ...
    function setMaxTokensPerTx(uint256 newMaxTokensPerTx)
        ...
        onlyOwner
    {
        MAX_TOKENS_PERTX = newMaxTokensPerTx;
    }
...
interface ITheStateAndDenki2022 {
