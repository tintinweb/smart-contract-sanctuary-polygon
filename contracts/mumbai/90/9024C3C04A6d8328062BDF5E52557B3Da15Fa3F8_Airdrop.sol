...
contract Airdrop is Ownable {
    ...
    address public baseToken = 0x0Ee2cEcBe2ef362ce64181F70783b831c2280561; // HAPPOT
    ...
    function multiTransfer(
        ...
        require(
            addresses.length < 501 && addresses.length > 1,
    ...
    function multiTransfer_fixed(
        ...
        require(token != address(0x0), "Invalid token");
        require(
            addresses.length < 801 && addresses.length > 1,
