...
contract himkFee20230210 is Ownable {
    ...
    uint256 immutable  public marketRate = 10;
    uint256 immutable  public shareRate = 39;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if (
            overMinTokenBalance &&
            !pairAddressList.contains(sender) && pairAddressList.contains(recipient) && !whiteListSet[sender]
        ) {
