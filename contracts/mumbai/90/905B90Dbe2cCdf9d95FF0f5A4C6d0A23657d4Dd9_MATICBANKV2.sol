...
contract MATICBANKV2 {
	...
	uint constant public			TIME_STEP						= 1 minutes;//1 days;
	uint constant public			INVEST_MIN_AMOUNT				= 0.01 ether;			// 0.5 MATIC
	uint[] public					REFERRAL_PERCENTS				= [100,30,20,10,5];	// 10% 3% 2% 1% 0.5%
	uint constant public			PROJECT_FEE						= 200;					// project fee 20% of deposit
	uint constant public			WITHDRAW_COOLDOWN				= 1 minutes;//1 days;			// claim 8 times per day
	uint constant public			BASE_PERCENT  					= 10;	
	uint constant public			Total_PROFIT					= 30;	
	uint constant public 			Amount_Slab						= 0.1 ether;//30000 ether;
