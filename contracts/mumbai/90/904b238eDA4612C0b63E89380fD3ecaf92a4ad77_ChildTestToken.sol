    ...
    ERC2771Context
{
    ...
    constructor(
        address manager,
        address childChainManagerProxy // Polygon child chain manager proxy bridge address
    ) ERC20("ThingsTestToken", "TTT") ERC20Permit("TestToken") {
    ...
    function _beforeTokenTransfer(
        ...
        if (hasRole(DEPOSITOR_ROLE, _msgSender())) { // allow always to prevent bridge problems that uses the deposit flow
