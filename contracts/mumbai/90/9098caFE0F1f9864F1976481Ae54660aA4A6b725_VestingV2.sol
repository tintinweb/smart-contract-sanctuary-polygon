...
contract VestingV2 is Ownable, ReentrancyGuard, PaymentSplitter {
    ...
    nonReentrant {
        ...
        if(userExist(who)){
            ...
            uint256 availableRewards = computeClaimableRewards(who);
    ...
    */
    ...
    function setTotalInfoForPrivate(uint256 _totalAllocation, uint256 _price, uint256 _minBuy, uint256 _maxBuy) external onlyOwner {
    ...
    function setTotalAmountForPre(uint256 _totalAllocation, uint256 _price, uint256 _minBuy, uint256 _maxBuy) external onlyOwner {
