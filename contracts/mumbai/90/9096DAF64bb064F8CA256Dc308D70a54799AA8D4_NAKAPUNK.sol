    ...
    ERC2981
{
    ...
    uint256 public _maxSupplies = 120;
    ...
    function setBaseURIs(string memory _baseURI1, string memory _baseURI2, string memory _baseURI3, string memory _baseURI4,
        string memory _baseURI5) external onlyOwner {
        baseURI1 = _baseURI1;
        baseURI2 = _baseURI2;
        baseURI3 = _baseURI3;
        baseURI3 = _baseURI4;
