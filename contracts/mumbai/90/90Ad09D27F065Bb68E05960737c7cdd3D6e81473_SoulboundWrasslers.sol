...
contract SoulboundWrasslers is EssentialERC2771Context {
    /*//////////////////////////////////////////////////////////////
                                 EVENTS
    //////////////////////////////////////////////////////////////*/
    ...
    function encodedAttributes(uint256 tokenId) internal view returns (bytes memory) {
        (
            ...
            uint256 resilience,
            uint256 awareness
        ) = nFight.getFighter(address(this), tokenId, block.chainid);
