...
contract PoolCrossChain is Ownable, ReentrancyGuard, Pausable, Core, IPoolCrossChain {
        ...
        returns (uint256 actualToAmount, uint256 haircut)
    {
        ...
        console.log("params.toAsset.cash before ", params.toAsset.cash);
        console.log("params.toAsset.liability before ", params.toAsset.liability);

        params.toAsset.cash -= actualToAmount;
        params.toAsset.liability -= _dividend(haircut, retentionRatio);

        console.log("params.toAsset.cash ", params.toAsset.cash);
        console.log("params.toAsset.liability ", params.toAsset.liability);
        ...
        // console.log("actualToAmount ", actualToAmount);
        // console.log("minimumToAmount ", minimumToAmount);
    ...
    function receiveSwapCrossChain(
        ...
        console.log("SRC amm ", srcAmount);
        console.log("dst addrs ", dstToken);
