...
contract BloodDonation is ERC721, Ownable {
    ...
    event DonorRegistered(uint256 indexed donorId, string name, string bloodType, int256 latitude, int256 longitude);
    event BloodBankRegistered(uint256 indexed bloodBankId, string name, int256 latitude, int256 longitude);
    event BloodRequest(uint256 indexed requestId, uint256 indexed bloodBankId, string bloodType);
    ...
    function registerDonor(string memory name, string memory bloodType, int256 latitude, int256 longitude) public {
        _tokenIds.increment();
    ...
    function registerBloodBank(string memory name, int256 latitude, int256 longitude) public onlyOwner {
        _tokenIds.increment();
    ...
    //     if (bloodTypeHash % 8 == 0) return "A+";
    //     if (bloodTypeHash % 8 == 1) return "A-";
    //     if (bloodTypeHash % 8 == 2) return "B+";
    //     if (bloodTypeHash % 8 == 3) return "B-";
    //     if (bloodTypeHash % 8 == 4) return "AB+";
    //     if (bloodTypeHash % 8 == 5) return "AB-";
    //     if (bloodTypeHash % 8 == 6) return "O+";
    //     if (bloodTypeHash % 8 == 7) return "O-";
    //     return "";
    // }

//     function _hashToBloodType(bytes32 bloodTypeHash) private pure returns (string memory) {
//     uint8 bloodTypeCode = uint8(bloodTypeHash & 0x7);
//     if (bloodTypeCode == 0) return "A+";
//     if (bloodTypeCode == 1) return "A-";
//     if (bloodTypeCode == 2) return "B+";
//     if (bloodTypeCode == 3) return "B-";
//     if (bloodTypeCode == 4) return "AB+";
//     if (bloodTypeCode == 5) return "AB-";
//     if (bloodTypeCode == 6) return "O+";
//     if (bloodTypeCode == 7) return "O-";
//     return "";
// }
