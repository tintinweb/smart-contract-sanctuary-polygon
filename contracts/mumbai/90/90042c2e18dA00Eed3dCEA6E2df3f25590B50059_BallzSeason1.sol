    ...
    ERC1155PausableUpgradeable
{
    ...
    function initialize() public initializer {
        ...
        minterType = "LXTBallzzzzz";
        pausedCheck = false;
        revealed = true;
        name = "Ballz Season 111";
        symbol = "LXT";
    }
        ...
        virtual
    {
        require(
            hasRole(DEFAULT_ADMIN_ROLE, _msgSender()),
            "LXTBallz: must have admin role to changeee"
        );
        require(_exists(id), "LXTBallz: URI set of nonexistent tokennn");
    ...
    function setMinterType(string memory mintType) public virtual {
        require(
            hasRole(DEFAULT_ADMIN_ROLE, _msgSender()),
            "Must have Admin role to minttt"
        );
        minterType = mintType;
    }
