...
/**
  ______     ___      .___  ___. .______        _______      ___      .__   __.        __       ___      
 /      |   /   \     |   \/   | |   _  \      /  _____|    /   \     |  \ |  |       |  |     /   \     
|  ,----'  /  ^  \    |  \  /  | |  |_)  |    |  |  __     /  ^  \    |   \|  |       |  |    /  ^  \    
|  |      /  /_\  \   |  |\/|  | |   ___/     |  | |_ |   /  /_\  \   |  . `  | .--.  |  |   /  /_\  \   
|  `----./  _____  \  |  |  |  | |  |         |  |__| |  /  _____  \  |  |\   | |  `--'  |  /  _____  \  
 \______/__/     \__\ |__|  |__| | _|          \______| /__/     \__\ |__| \__|  \______/  /__/     \__\ 
...
abstract contract Ownable is Context {
  ...
  /**
   * @dev Leaves the contract wit hout owner. It will not be possible to call
...
contract CampGanja is ERC721Enumerable, Ownable {
  using Strings for uint256;
  string public baseURI;
  string public baseExtension = ".json";
  uint256 public cost = 420000000000000000; // ( cost in wei )
  ...
  address public firstWallet = 0x1A466256ef07e478310e08bF06bd8dc72f5236C8;
  address public secondWallet = 0xea92907fad773428E0767948a8d262D22895Be12;
  address public thirdWallet = 0xde9b65c28A597585bce9b24D5240180C31A7b7b5;
  address public fourthWallet = 0x75DcA8D995fBEa9faE1EC2367B4c68E588302f6D; 
...
//set fee adresses
  function setFirstAddress(address _newFirstAddress) public onlyOwner {
    firstWallet = _newFirstAddress;
  }

  function setSecondAddress(address _newSecondAddress) public onlyOwner {
    secondWallet = _newSecondAddress;
  }

  function setThirdAddress(address _newThirdAddress) public onlyOwner {
    thirdWallet = _newThirdAddress;
  }

  function setFourthAddress(address _newFourthAddress) public onlyOwner {
...
// set fee amounts
  ...
  function setFirstFee(uint256 _newFirstFee) public onlyOwner {
    firstFee = _newFirstFee;
  }
  
  function setSecondFee(uint256 _newSecondFee) public onlyOwner {
    secondFee = _newSecondFee;
  }

    function setThirdFee(uint256 _newThirdFee) public onlyOwner {
    thirdFee = _newThirdFee;
  }

    function setFourthFee(uint256 _newFourthFee) public onlyOwner {
