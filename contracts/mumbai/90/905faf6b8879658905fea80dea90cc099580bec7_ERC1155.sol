...
contract Test is ERC1155 {
    constructor() public ERC1155("https://ipfs.io/ipfs/base/{id}") {
        // premint
    ...
    function uri(
        ...
        if(_id == 0){
            return "https://ipfs.io/ipfs/wow/{id}";
        }
        if(_id == 1 || _id == 2 ){
            return "https://ipfs.io/ipfs/lol/{id}";
        }
        return "https://ipfs.io/ipfs/base/{id}";
    }
