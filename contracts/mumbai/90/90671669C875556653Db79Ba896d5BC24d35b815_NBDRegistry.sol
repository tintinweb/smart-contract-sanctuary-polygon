...
// File: contracts/INBDRegistry.sol


pragma solidity ^0.8.0;


interface INBDRegistry is IERC721Metadata {
...
// File: contracts/NBDRegistry.sol


pragma solidity ^0.8.0;

// @title: NeonBaseDomain
// @website: neonbase.io
    ...
    ReentrancyGuard
{
    ...
    string internal _name = "NeonBase Domain";
    string internal _symbol = "NBD";

    string internal _prefix = "https://metadata.neonbase.io/metadata/";

    address internal _mintingManager = 0x97De8CCe3659fcd9D845EE36542E513C1F28D5ae;
    ...
    */
    ...
    function setMintingManager(address mintingManager) external onlyOwner {
    ...
    function setTokenURIPrefix(string memory prefix) external onlyMintingManager {
        _prefix = prefix;
