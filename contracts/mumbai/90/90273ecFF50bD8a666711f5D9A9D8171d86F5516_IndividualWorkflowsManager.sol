...
contract IndividualWorkflowsManager {
    ...
    mapping(address => string) public metaUrls;
    ...
    function getMetadataURL(address addr) external view returns (string memory) {
        return metaUrls[addr];
    }
    ...
    function createLimitOrderWorkflow(
        ...
        address addr = address(limitOrderWorkflow);
        limitOrderWorkflows.push(addr);
        metaUrls[addr] = metaUrl;
    ...
    function createAddLiquidityWorkflow(
        ...
        address addr = address(addLiquidityWorkflow);
    ...
    function createRemoveLiquidityWorkflow(
        ...
        address addr = address(removeLiquidityWorkflow);
