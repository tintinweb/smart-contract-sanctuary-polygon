...
contract BIOrbit is ERC721, ERC721URIStorage {
	...
	struct Monitoring {
		// Monitoring
		string[2] detectionDate;
		string[2] forestCoverExtension;
	}
	...
	function setTokenURI(
		string[2] memory _detectionDate,
		string[2] memory _forestCoverExtension,
		uint256 _projectId,
		...
		if (project.state == State.Active) {
			...
			Monitoring memory monitoring = Monitoring(
				[_detectionDate[0], _detectionDate[1]],
				[_forestCoverExtension[0], _forestCoverExtension[1]]
			);
