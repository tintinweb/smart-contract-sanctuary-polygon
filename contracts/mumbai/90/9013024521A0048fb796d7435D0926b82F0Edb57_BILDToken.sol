...
abstract contract ERC20PermitUpgradeable is ERC20Upgradeable, IERC20PermitUpgradeable, EIP712Upgradeable {
     ...
     */
    function __ERC20Permit_init(string memory name, string memory symbol) internal onlyInitializing {
...
contract BILDToken is ERC20PermitUpgradeable, AccessControlUpgradeable {
    bytes32 public constant OWNER_ROLE = keccak256("OWNER_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    function initialize(address minter, uint initialSupply) external initializer{
        __ERC20Permit_init("BILD","BIUSD");
