...
//File： https://github.com/ErickQueiroz93/solidity/blob/main/IERC4906.sol
...
//File： fs://7cf264e4cfd14f769628c766bf02584c/main.sol
...
contract mainMobiup is Ownable, ERC721A, ERC2981, IERC4906, DefaultOperatorFilterer {
    using Strings for uint256;
    // ----------------------------- State variables ------------------------------

    uint256 public constant MAX_SUPPLY = 10000;
    uint256 public constant MAX_PER_USER = 50;
    uint256 public PRICE_PER_TOKEN = 0.001 ether;
    bool public revealed = false;
    string public notRevealedUri = "https://ipfs.io/ipfs/QmQVQeR47bRL2cW8rRoU1M9PnFCQVyY5XXsvHpFqJufieU";
    ...
    constructor(address _ERC6551Registry, address _ERC6551AccountImplementation) ERC721A("Main Mobiup", "MBU") {
        contractUri = "https://gateway.pinata.cloud/ipfs/QmWMPcCNpJsvpDrRkydTV66zWbpzwxQReBNaVKjcawqzqS";
        _setDefaultRoyalty(0x2919771f951fd264445d4D4c682EE5D8326B93ec, 500);
    ...
    function mint(uint256 quantity, address destination) external payable {
        ...
        // Check that the MBU creation was success
        require(tokenBoundCreation(quantity, currentMinted), "MBU creation failed");
    }
    ...
    function showMBU(uint256 _tokenId) external view returns (address) {
