 ...
 */
contract GPO is GPOEth {

    address public childChainManagerProxy;
    address deployer;
    
    constructor(ISwapRouter _swapRouter, uint256 _walletsTimelockedUntil, address _childChainManagerProxy) GPOEth(_swapRouter, _walletsTimelockedUntil, true) {
