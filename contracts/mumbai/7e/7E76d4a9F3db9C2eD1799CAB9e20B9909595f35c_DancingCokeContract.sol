...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x410Ce53c75310DDd1B740De09a4505770aC7bDA7];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiaatbehgj5f4asan5fjrd6533lkoxs32oigy24s7wixqvju2crzsm/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/psnaYUOn5djDDNcB2se7/contract-metadata";
  }
...
contract DancingCokeContract is RamppERC721A {
    constructor() RamppERC721A("Dancing Coke", "DCK"){}
}
