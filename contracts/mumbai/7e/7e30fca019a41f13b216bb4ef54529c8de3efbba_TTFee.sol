...
contract TTFee is MulticallUpgradeable, ERC2771ContextUpgradeable, AccessControlEnumerableUpgradeable, IFeeTierPlacementExtension {
    /// @dev The factory for deploying contracts.
    TTFactory public immutable factory;
    ...
    constructor(address _trustedForwarder, address _factory) ERC2771ContextUpgradeable(_trustedForwarder) {
        factory = TTFactory(_factory);
