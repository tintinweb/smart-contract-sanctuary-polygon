...
contract LinearStaking is ILinearStaking, ToInitialize, Ownable, WithFees {
    ...
    function stake(
        uint256 _amount
    ) public override isInitialized isOngoing updateReward(msg.sender) {
        if (_amount == 0) {
            revert AmountZero();
        }
...
import "../dex/core/SpartaDexPair.sol";
import "./LinearStaking.sol";
...
contract SpartaRewardLpLinearStaking is LpLinearStaking {
        ...
        onlyWithFees
    {
        ...
        uint256 toTransfer = (reward * 250000) / 1000000;
        ...
        if (!rewardToken.approve(address(spartaStaking), onStaking)) {
            revert ApproveFailed();
        }

        spartaStaking.stakeAs(msg.sender, onStaking);
