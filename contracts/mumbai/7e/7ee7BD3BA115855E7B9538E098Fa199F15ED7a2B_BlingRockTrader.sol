...
contract BlingRockTrader {
    ...
    function startAuction(
        ...
        emit AuctionStarted(collectionAddress, tokenId, auctionNum, owner);
        return true;
    }
    ...
    function finishAuction(
        ...
        Auctions[collectionAddress][tokenId][auctionNum].state = 2;
        emit AuctionFinished(collectionAddress, tokenId, auctionNum);
...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    function _afterTokenTransfer(
        ...
        // console.log("in after transfer operator:",operator," / to:");
