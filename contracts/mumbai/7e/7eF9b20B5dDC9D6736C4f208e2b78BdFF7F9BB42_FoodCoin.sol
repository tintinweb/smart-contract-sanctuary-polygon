...
contract FoodCoin is ERC20PermitUpgradeable, ERC20PresetMinterPauserUpgradeable, UUPSUpgradeable {
    function initialize(string memory name, string memory symbol) public virtual override initializer {
        revert();
    }

    function initialize() public virtual initializer {
        __ERC20PresetMinterPauser_init("Food Coin", "FOOD");
    }
    ...
    function _beforeTokenTransfer(
        ...
        address to,
        uint256 amount
    ) internal virtual override(ERC20PresetMinterPauserUpgradeable, ERC20Upgradeable) {
        super._beforeTokenTransfer(from, to, amount);
    }
}