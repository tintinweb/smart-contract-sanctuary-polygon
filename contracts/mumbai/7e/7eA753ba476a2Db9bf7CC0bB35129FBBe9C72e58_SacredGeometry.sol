...
contract SacredGeometry is ERC721, Ownable {
    ...
    address private constant CreatorAddress = 0x5593870641f7C691c21ed7eeE3C190596e50bdF5;
    ...
    constructor(string memory _baseURIextended) ERC721("Sacred Geometry", "SGeo"){
