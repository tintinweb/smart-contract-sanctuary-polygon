...
/**
 * @dev Interface of the ERC20 standard as defined in the EIP with minting and burning.
 */
...
contract SporkStaker is AccessControl, ReentrancyGuard {
  bytes32 public constant UNSTAKE_DATE_CHANGER = keccak256("UNSTAKE_DATE_CHANGER");
  ...
  constructor(
    ...
    _setupRole(UNSTAKE_DATE_CHANGER, msg.sender);
  }

  function setUnstakeOnlyAfter(uint256 _unstakeOnlyAfter) public onlyRole(UNSTAKE_DATE_CHANGER) {
    unstakeOnlyAfter = _unstakeOnlyAfter;
  }
