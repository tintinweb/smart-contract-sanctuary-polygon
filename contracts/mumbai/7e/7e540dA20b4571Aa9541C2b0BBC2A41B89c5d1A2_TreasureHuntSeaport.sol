    ...
    OwnableUpgradeable
{
    ...
    function presaleMint() public {
        ...
        presaleCnt++;
        saleCnt += 1;
        ITreasureHunt(rewardPool).transferCost(mintPrice, false);
        mint();
    }
    ...
    function kickFromSeaport(
        ...
        if (tokenID != 1) {
            if (isDirect) {
                ITreasureHunt(rewardPool).transferCost(kickPrice, false);
            } else {
                ITreasureHunt(rewardPool).payUsingReward(msg.sender, kickPrice, false);
            }
        }
    ...
    function upgradeSeaport(uint256 tokenID) public onlySeaportOwner(tokenID) {
        ...
        ITreasureHunt(rewardPool).transferCost(seaportUpdatePrice, false);
