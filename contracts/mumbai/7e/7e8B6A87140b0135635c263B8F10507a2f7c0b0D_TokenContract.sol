...
contract TokenContract is ERC721A, Ownable, PaymentSplitter {
    ...
    constructor(
        ...
        uint96 _royaltyPercentageBasisPoints
    ) ERC721A(_name, _symbol) PaymentSplitter(_payees, _shares) {
        baseURI = _baseURI;
        setRoyalties(payable(address(this)), _royaltyPercentageBasisPoints);
    }
        ...
        returns (address receiver, uint256 royaltyAmount)
    {
        return (
            ...
            (_salePrice * percentageBasisPoints) / 10000
        );
    }
