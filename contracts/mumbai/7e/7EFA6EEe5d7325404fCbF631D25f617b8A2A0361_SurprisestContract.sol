...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0xfbe90f900c1890e232fD7F09295436e0Fc7eCeF8];
  address public erc20Payable = 0xfbe90f900c1890e232fD7F09295436e0Fc7eCeF8;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://bafybeidziqqkqei34axka4gxp5chx22w2iqsk54ghb3tdiimeoxvfqdjzq.ipfs.nftstorage.link/";
...
// File: contracts/SurprisestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SurprisestContract is RamppERC721A {
    constructor() RamppERC721A("SURPRISEST", "SRP"){}
}
