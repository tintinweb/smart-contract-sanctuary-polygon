...
contract LuxyGenesis is ERC721URIStorage, Pauser {
    ...
    uint internal remainingIdsAmount;
    ...
    function generateTokenId() public returns (uint256) {
        uint256 genesisRemainingToAssign = MAX_SUPPLY_PER_CHAIN - remainingIdsAmount -1;
    ...
    function mint(
        ...
        if (remainingIdsAmount > MAX_SUPPLY_PER_CHAIN ) revert MaxSupplyOut();
    ...
    function _random() internal view returns (uint256) {
        uint256 genesisRemainingToAssign = MAX_SUPPLY_PER_CHAIN - remainingIdsAmount;
        return
            uint256(
                keccak256(
                    abi.encodePacked(
