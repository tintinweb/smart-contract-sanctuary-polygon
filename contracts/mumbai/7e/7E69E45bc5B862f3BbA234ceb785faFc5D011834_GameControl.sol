...
contract GameControl is Ownable, ReentrancyGuard {
    ...
    function levelReward(uint levelNo, bool levelStatus) external {
        ...
        require(playerInfo[msg.sender].levelNo == levelNo, "Game level is not correct");
        ...
        if (levelStatus) {
            ...
            token.mint(msg.sender, rewardAmount); // new token mint for winners

            playerInfo[msg.sender].levelNo += 1;
        } else {
