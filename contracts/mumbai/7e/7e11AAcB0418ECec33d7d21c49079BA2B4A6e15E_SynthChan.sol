...
contract SynthChan is ERC721Enumerable, Ownable, FlexAttributes, RoyaltiesV2Impl {
  ...
  // must escape or double-escape all entities, as appropriate.
  // can use a service like https://jsonformatter.curiousconcept.com/ to verify.
    ...
    return string(
      abi.encodePacked("data:application/json;base64,", Base64.encode(
        abi.encodePacked( // TODO: can try attributes(_tokenId, "Last Name").strValue save on space/gas??
          ...
          " \"image_data\":\"data:image/svg+xml;base64,", imageURI(_tokenId), "\",",
          " \"external_url\":\"data:image/svg+xml;base64,", imageURI(_tokenId), "\",",
