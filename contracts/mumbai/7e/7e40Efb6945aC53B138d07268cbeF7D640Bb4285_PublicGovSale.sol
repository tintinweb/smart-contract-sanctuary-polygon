...
contract PublicGovSale is Initializable, UUPSUpgradeable, PausableUpgradeable, OwnableUpgradeable, AdminProxyManager {
    ...
    IPublicGovFactory public immutable factory = IPublicGovFactory(_msgSender());
    ...
    function buyToken(uint128 _amountIn) external whenNotPaused {
        (bool success, bytes memory data) = address(this).call(
            abi.encodeWithSelector(PublicGovSale._buyToken.selector, _amountIn, _msgSender())
        );
        require(success, "fail");
        payment.safeTransferFrom(_msgSender(), address(this), abi.decode(data, (uint128)));
    }
    ...
    function _buyToken(
        ...
        require((_msgSender() == address(this) || _msgSender() == factory.crossChainManager()) && running > 0, "!booster");
