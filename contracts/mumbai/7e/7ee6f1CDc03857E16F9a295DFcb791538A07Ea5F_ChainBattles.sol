...
// Deployed at 0x7ee6f1CDc03857E16F9a295DFcb791538A07Ea5F.
...
contract ChainBattles is ERC721URIStorage {
    ...
    function generateCharacter(uint _tokenId) view public returns (string memory){
        ...
        '<style>.level { fill: rgb(5, 73, 23); font-family: fantasy; font-size: 14px; }</style>',
        '<style>.attack { fill: rgb(202, 25, 25); font-family: fantasy; font-size: 14px; }</style>',
        '<style>.defence { fill: rgb(16, 90, 105); font-family: fantasy; font-size: 14px; }</style>',
        '<style>.speed { fill: rgb(37, 5, 51); font-family: fantasy; font-size: 14px; }</style>',
        '<rect width="100%" height="100%" fill="#dedede" />',
        '<text x="50%" y="25%" class="heading" dominant-baseline="middle" text-anchor="middle"> Chain Battles NFT.</text>',
