...
contract NFTMarket is ReentrancyGuardUpgradeable,AccessControlUpgradeable  {
    ...
    */
    function createMarketItem (
        ...
        require(IERC721Upgradeable(nftContract).ownerOf(tokenId) == msg.sender,"Sender is not the owner of NFT");
    ...
    */
    function offerMarketSale(
        ...
        uint256 offerPrice = _nftPrice - feeCommision;
    ...
    */
    function unlistItem (
        ...
        require(idToMarketItem[_itemId].owner == msg.sender,"Only owner can unlist thier item");
    ...
    */
    function listItem (
        ...
        require(IERC721Upgradeable(nftContract).isApprovedForAll(idToMarketItem[_itemId].owner, address(this)),"Approval is not given");
    ...
    */
    function proceedToTransfer(
        ...
        IERC20Upgradeable wethToken = IERC20Upgradeable(wethAddress);
        uint256 total = price+feeCommision;
        require(wethToken.allowance(sender,address(this)) >= total,"NOT have enough allowance");
        ...
        wethToken.transferFrom(sender,owner,feeCommision*2);
        ...
        if (donationAddress != address(0) && idToMarketItem[itemId].donationPer > 0 ) {
            ...
            wethToken.transferFrom(sender,donationAddress,donation);
        ...
        if (idToMarketItem[itemId].creator != idToMarketItem[itemId].owner && idToMarketItem[itemId].royaltyPer != 0) {
            ...
            wethToken.transferFrom(sender,idToMarketItem[itemId].creator,royaltyAmount);
            totalPrice = totalPrice - royaltyAmount;
        }

        //transfer the price of NFT to owner
        wethToken.transferFrom(sender,idToMarketItem[itemId].owner,totalPrice);
        // payable(idToMarketItem[itemId].owner).transfer(totalPrice);
        // transfer NFT from owner to buyer
        IERC721Upgradeable(nftContract).transferFrom(idToMarketItem[itemId].owner, msg.sender, tokenId);
