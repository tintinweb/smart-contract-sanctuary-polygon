...
contract ERC20MarketFee is ERC20, IERC20MarketFee {
    ...
    function updateFees(
        ...
        require(feeSell_ <= MAX_FEE && feeBuy_ <= MAX_FEE && feeTransfer_ <= MAX_FEE, "ERC20: Maximum fee exceeded");
        feeSell = feeSell_;
        feeBuy = feeBuy_;
...
import "./ERC20MarketFee.sol";

contract ERC20MarketFeeAntibot is ERC20MarketFee, IAntibotUser {
