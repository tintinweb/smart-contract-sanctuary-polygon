...
contract TESTL is ERC2981, ERC721Enumerable, Ownable {
    ...
    uint256 public immutable MAX_SUPPLY = 10; // IMMUTABLE + PAUSABLE AT THE END?
    uint private constant MAX_MINT_AMOUNT = 10;

    mapping(address => uint) public amountPerWallet;

    uint256 private _royaltyFee = 1000; // 10%
    ...
    modifier mintCompliant(
        ...
        require(amountPerWallet[_recipient] + _quantity >= 0, "MINT:You already purchased this pass!"); // TO CHANGE WITH MAX_MINT_AMOUNT
