...
interface IWitnetFeeds {
    ...
    function lastResponse(bytes4 feedId) external view returns (Witnet.Response memory);
    function lastResult(bytes4 feedId) external view returns (Witnet.Result memory);
