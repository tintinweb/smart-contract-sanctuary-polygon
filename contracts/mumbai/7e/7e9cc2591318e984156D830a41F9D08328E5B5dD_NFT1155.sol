...
contract NFT1155 is ERC1155, Ownable, RoleControl {
    ...
    function mint(address account, uint256 amount,string memory tokenURI)public onlyMinter returns (uint)
    {
        _tokenIds.increment();
        uint256 newItemId = _tokenIds.current();
        _mint(account, newItemId, amount, "");
        setTokenUri(newItemId,tokenURI);
          /*emit MintedToken(newItemId,tokenURI);*/
        return newItemId;
    }
