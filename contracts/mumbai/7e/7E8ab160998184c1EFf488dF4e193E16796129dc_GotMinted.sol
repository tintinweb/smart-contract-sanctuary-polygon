// SPDX-License-Identifier: MIT
 ...
 d888b8b   d8888b   ?88'    88bd8b,d88b   88b  88bd88b   ?88'   d8888b d888888  
d8P' ?88  d8P' ?88  88P     88P'`?8P'?8b  88P  88P' ?8b  88P   d8b_,dPd8P' ?88  
88b  ,88b 88b  d88  88b    d88  d88  88P d88  d88   88P  88b   88b    88b  ,88b 
`?88P'`88b`?8888P'  `?8b  d88' d88'  88bd88' d88'   88b  `?8b  `?888P'`?88P'`88b
       888                                                                      
      ,88P                                                                      
  `?8888P                                                                                                                                                               
    ...
    ITokenERC1155
{
    ...
    event AirdropSingleToSingle(address to_, uint256 id_, uint256 amount_);
    event AirdropManyToSingle(address to_, uint256[] ids_, uint256[] amounts_);
    event AirdropSingleToMany(address[] tos_, uint256 id_, uint256 amount_);
    event AirdropManyToMany(address[] tos_, uint256[] ids_, uint256[] amounts_);
    ...
    function airdropSingleToSingle(
        ...
        emit AirdropSingleToSingle(to_, id_, amount_);
    }
    ...
    function airdropManyToSingle(
        ...
        emit AirdropManyToSingle(to_, ids_, amounts_);
    }
    ...
    function airdropSingleToMany(
        ...
        emit AirdropSingleToMany(tos_, id_, amount_);
    }
    ...
    function mint(
        ...
        emit Mint(msg.sender, id_, amount_);
    }
