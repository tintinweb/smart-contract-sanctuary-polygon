...
contract Cryptorun is Pausable, ReentrancyGuard, CryptorunAdministrative  {
	...
	event CreateMatch(uint256 indexed gameId, address player1, address paymentTokenPlayer1, uint256 createMatchTimeStamp);
	event JoinMatch(uint256 indexed gameId, address paymentTokenPlayer1, address paymentTokenPlayer2);
	...
	function startRun(uint256 gameId, uint256[] calldata paymentAmountsUnitPrice) external onlyOperator whenNotPaused nonReentrant {
