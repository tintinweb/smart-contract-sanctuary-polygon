...
contract GNFT is ERC1155, Ownable, Pausable, ERC1155Burnable, ERC1155Supply {
    ...
    string Year;
    string Hectares;
    string CO2captured_Tons;
    string GreenCoins_Qty;
  }
    ...
    function mint(uint256 id, uint256 amount, string memory Country, string memory Location, string memory Year, string memory Hectares, string memory CO2captured_Tons, string memory GreenCoins_Qty)
        public
        onlyOwner
    {
        uint256 newTokenId = _tokenIds.current();        
        _mint(msg.sender, id, amount, "");
        tokenIdtoMetadata[newTokenId] = Metadata(Country, Location, Year, Hectares, CO2captured_Tons, GreenCoins_Qty);
