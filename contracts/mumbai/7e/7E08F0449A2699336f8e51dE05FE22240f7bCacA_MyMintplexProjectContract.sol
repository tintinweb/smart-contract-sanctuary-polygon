    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://ipfs.EHO-721A.com/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/JyWbXtzNdTTGOFYRhm4a/contract-metadata";
  }
...
contract MyMintplexProjectContract is ERC721APlus {
    constructor() ERC721APlus("My Mintplex Project", "EHO721A"){}
}
