...
contract Collection_f029e6b6_4482_4a78_b432_ded21dbd1f8c is ERC721A, Ownable,  ContextMixin, ReentrancyGuard{
  uint256 public constant maxSupply = 10;
  uint public _price = 10 ether;
  uint256 public maxBuyPerTx = 1;
  bool public paused;
  string public _metaURI = "https://ipfs.moralis.io:2053/ipfs/Qmebx4AvJ86HLdszmdGkoDKTRTJWJXab1mXYRtS5nuKFk6/collection/f029e6b6-4482-4a78-b432-ded21dbd1f8c.json";
  // Metadata URI
  string private _baseTokenURI = "https://ipfs.moralis.io:2053/ipfs/QmcY8vvmFgL2Lcc3Z3b25nRDZ42YxcHMiQTW1piixtRDvY/metadata/";


  constructor() ERC721A("dsa", "dsa-84") {
    paused = true;
  }
  // Read the price
