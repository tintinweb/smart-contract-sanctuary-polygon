...
// File: contracts/ShaniTest,sol.sol
...
contract ShaniTest is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Test_OF_GEN", "SHGE") {
    setHiddenMetadataUri("ipfs://QmaiPKuZrzHukwzw7R6T5CiGXGjh6oQqshKwqARbqPtybR.json");
  }
