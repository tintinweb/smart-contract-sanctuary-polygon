...
contract NebulaMarketplaceContract is Ownable, ReentrancyGuard{
    ...
    function listToken(address contractAddress, uint256 tokenId, uint256 amount, uint256 price, address[] memory privateBuyer) 
    ...
    function purchaseToken(uint256 listingId, uint256 amount) public payable nonReentrant {
        ...
        require(msg.value >= (idToListing[listingId].price * amount), Strings.toString(msg.value));
