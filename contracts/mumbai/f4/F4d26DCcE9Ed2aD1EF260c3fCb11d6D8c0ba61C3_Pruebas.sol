...
contract Pruebas is Initializable, AccessControlUpgradeable, UUPSUpgradeable,pruebas1 {
...
import "./EternalStorageUpgradeable.sol";
import "./ICustodia.sol";

contract pruebas1 is ICustodiaImplement {
    mapping(address => bool) public isRegister;
    mapping(address => uint256) public dateRegister;

    function registerERC721(address _ERC721) external {
        ICustodia Icustodia = ICustodia(_ERC721);

        address owner = Icustodia.owner();
        ...
        emit Cadastrar(_ERC721, owner,50);
    }
...
interface ICustodia is IERC721MetadataUpgradeable {
...
interface ICustodiaImplement{

event Cadastrar(address indexed from, address indexed to, uint256 value);
