...
contract MasterChef is Ownable {
    ...
    // function LPbalance(address lpaddress) public view returns(uint256){
    //    CONEWeth = IBEP20(lpaddress);
    //    uint balance = CONEWeth.balanceOf(address(this));
    //    return balance;
    // }

    function LPbalanceK(uint256 _pid)external view returns(uint256){
