...
contract ERC721BaseUpgradeable is Initializable, ERC721Upgradeable, OwnableUpgradeable, UUPSUpgradeable, EIP712Base {
  ...
  function safeMint(address to, string calldata tokenUri) internal returns (uint256){
