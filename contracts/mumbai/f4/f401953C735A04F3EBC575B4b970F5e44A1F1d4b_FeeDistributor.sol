...
contract FeeDistributor is Ownable {
    ...
    address private treasary = 0xc6e82fa11cE0B46395977f1b41076F0D132c2442;
        ...
        returns (bool)
    {
        if (_amount > 0) {
            ...
            // 2 % fees
            // transferring to treasary for buy back token
            IERC20(_token).transfer(treasary, (IERC20(_token).balanceOf(address(this))*2)/100 );
