...
// Decentralized Assets - OnChain
// Decentralized Metadata s - OnChain
// Decentralized Data - OnChain
...
contract NFTExample is ERC721 {
    ...
    function buildImage(uint256 _tokenId) public view returns (string memory) {
        uint256 number = numbers[_tokenId];
        return
            Base64.encode(
                bytes(
                    abi.encodePacked(
                        '<svg width="500" height="500" xmlns="http://www.w3.org/2000/svg">',
                        '<text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-size="41">',
