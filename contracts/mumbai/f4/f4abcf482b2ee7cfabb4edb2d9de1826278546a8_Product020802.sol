...
contract Product020802 {
    ...
    function createPolicy(PolicyParams memory policyParams) external returns(uint){
        ...
        policy.onChainStatus = 1; // 1 = Active
        policy.terminationReason = 1; // 1 = Not applicable
