...
contract ProjectsManagerContract is Initializable, Common {
    ...
    function getProjects(uint _id) external view returns(uint256, address, uint256, uint256, uint256, uint256) {
        ProjectInfo memory project = projects[_id];
        return (project.id, project.addr, project.projectValue, project.nftValue, project.totalNFT, project.totalMintedNFT);
    }
...
// @todo deploy new contract project
    ...
    ////canMintNft(_id, _totalNftToMint) existingProject(_id) 
    {
