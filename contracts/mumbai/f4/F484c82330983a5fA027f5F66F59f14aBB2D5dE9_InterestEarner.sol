...
contract InterestEarner {
    ...
    event stakingInfo(bool initialized, address  beneficiary, uint256  initialStakeTimestamp, uint256 totalExpectedInterest, uint256  balances, bytes32 data);
    ...
    */
        ...
        noReentrant
    {
        ...
        emit stakingInfo(true, msg.sender, block.timestamp, finaltotalExpectedInterest, amount, stakingScheduleId);
