...
contract EthernalElvesLoot is IERC1155 {
...
function mint(address to, uint256 quantity, uint256 tokenId) external {
    onlyOperator();
...
function initialize() public {
    ...
    function getTokenURI(uint256 _id) public view returns (string memory) {
       ...
       string memory tokenURI = 'https://api.ethernalelves.com/api/loot/';
