...
contract ERC20 is IERC20, IERC20Metadata, Admin, ReEntrancyGuard {
    ...
    function _destroyLock(address _owner,
        ...
        while ( (brokenLocks < _unlockedLocks) && (_amountAvailable < _amountToWithdraw) ) {
            ...
            _lock = addressToLock[_owner][addressToValidIndex[_owner]];
            ...
            if (amountLeft < _lock.amount) {
                ...
                _addressToUnlockedAmount[_owner] += _amountAvailable + amountLeft;
                amountLeft = 0;
                break;
            ...
            // we have to break the lock in this iteration and break the loop
                ...
                brokenLocks++;
                _addressToUnlockedAmount[_owner] += _amountAvailable + _lock.amount;
                amountLeft = 0;
                break;
