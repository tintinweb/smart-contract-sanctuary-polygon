...
contract NFTERC1155 is ERC1155, Ownable, PaperVerification {
    ...
    mapping (address => bool) public floatsWallets;
    ...
    constructor(address _paperKey) ERC1155("") PaperVerification(_paperKey) {
        name = "TEST 1";
        symbol = "TELE";
        floatsWallets[0x7754B94345BCE520f8dd4F6a5642567603e90E10] = true;
        // floatsWallets[0xf3DB642663231887E2Ff3501da6E3247D8634A6D] = true;
        // floatsWallets[0x5e01a33C75931aD0A91A12Ee016Be8D61b24ADEB] = true;
        // floatsWallets[0x9E733848061e4966c4a920d5b99a123459670aEe] = true;
    }
    ...
    modifier mintCompliant(uint256 _tokenId, uint256 _quantity) {
        require(_quantity > 0 && _quantity <= maxMintPerTx[_tokenId], "Invalid mint amount, you can only mint 1 token!");
        require(tokenTotalSupply[_tokenId] + _quantity <= maxTokenSupply[_tokenId], "Max supply exceeded, contact support!");
        if (floatsWallets[msg.sender] != true) {
    ...
    {
        amountNFTsperWallet[_to] += _quantity;
