...
contract InspireNFT is ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("Inspire NFT", "INFT") {
        console.log("Deploying a Inspire NFT contract");
    }
    ...
    function mint(
        ...
        console.log("MINT: Add NFT to the contract");
        nfts[tokenId] = Nft(
            tokenId,
            _tokenURI,
            _fileHash,
        ...
        console.log("MINT: Safe mint on wallet:", _wallet);
        _safeMint(_wallet, tokenId);
        console.log("MINT: Set token uri:", _tokenURI);
        _setTokenURI(tokenId, _tokenURI);

        console.log("MINT: Emmit event of minted NFT:", tokenId);
        emit MintedNFT(
            tokenId,
            _tokenURI,
            _fileHash,
