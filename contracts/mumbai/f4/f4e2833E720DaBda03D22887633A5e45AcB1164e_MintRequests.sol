...
contract MintRequests is Initializable, ReentrancyGuardUpgradeable, PausableUpgradeable, EIP712Upgradeable {
    ...
    /*
    /// @dev Quick way to check if an NFT identified by
    /// the tokenUri + recipient address was created from a voucher (Lazy minted)
    mapping(string => bool) public requestCreatedFromVoucher;
    */
    ...
    */
        ...
        returns (uint256 requestID)
    {
        ...
        // requestCreatedFromVoucher[string.concat(voucher.tokenUri, StringsUpgradeable.toHexString(voucher.recipient))] = true;
