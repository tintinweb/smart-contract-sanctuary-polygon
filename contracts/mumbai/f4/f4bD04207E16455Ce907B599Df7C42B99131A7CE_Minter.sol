...
interface IMinter is IPausable {
     ...
     * @dev Mint a new fraction of nft
     */
    function mintFraction(uint256 id, uint256 amount) external;
...
contract Minter is IMinter, MintingAccessControlUpgradeable, FractionCostBadges {
    ...
    function mintFraction(
        ...
        uint256 totalCost = _mintFraction(id, to, amount);
    ...
    function mintFraction(
        ...
        uint256 totalCost = _mintFraction(id, msg.sender, amount);
        sybelToken.safeTransfer(foundationWallet, totalCost);
    }
