...
contract PrintzNft is ERC721A, Ownable {
    ...
    constructor() ERC721A("Fingerprint", "printz") {
        setUriPrefix("https://printz-theta.vercel.app/api/printz/Finger/");
    }
    ...
    function mint() external payable {
        ...
        require(_numberMinted(msg.sender) < 100, "Exceeded the limit");
        require(totalSupply() + 1 <= MAX_SUPPLY, "Not enough tokens left");
    ...
    function resetUriSuffix() public onlyOwner {
        uriSuffix = "";
    }
    ...
    function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
        ...
        return
            bytes(currentUriPrefix).length > 0
