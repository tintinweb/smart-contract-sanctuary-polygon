...
contract KOKODI is ERC721A, ReentrancyGuard, Ownable {
    ...
    uint constant public MAX_SUPPLY = 30;
    ...
    uint public reservedSupply = 10;

    uint public maxPresaleMintsPerWallet = 3;
    uint public maxMintsPerWallet = 10;

    uint public presaleStartTimestamp = 0;
    uint public publicSaleStartTimestamp = 0;
    ...
    function withdraw() external onlyOwner {
        ...
        // alpha mint
        payable(0xBD89fBE194338c9C2fBDf94bc47B2F4837F73e3a).transfer(balance * 7 / 100);
