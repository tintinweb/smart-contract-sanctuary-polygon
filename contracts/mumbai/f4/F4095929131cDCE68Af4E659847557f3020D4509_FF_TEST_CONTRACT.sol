...
contract FF_TEST_CONTRACT is ERC721Enumerable, Ownable, RoyaltiesV2Impl {
    using Strings for uint256;
    ...
    // mint single NFT token with provided token URI and return new token ID
