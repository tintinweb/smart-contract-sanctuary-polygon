...
contract PublicGovSale is
    ...
    uint16 public constant dstChainId = 10002; // bsc_testnet
    ...
    function init(
        ...
        endpoint = ISaleGateway(factory.dstSaleGateway()).lzEndpoint();
    ...
    function estimateFees() public view returns(uint256 fees){
        (fees,) = endpoint.estimateFees(dstChainId, factory.dstSaleGateway(), _getPayload(), false, _getAdapterParams());
    }
    ...
    function buyToken(
        ...
        address sg = factory.dstSaleGateway();
    ...
    function finalizeRemote() external whenPaused {
        ...
        ISaleGateway(factory.dstSaleGateway()).finalizeRemote(address(factory), _getPayload(), _getAdapterParams(), estimateFees());
    }
