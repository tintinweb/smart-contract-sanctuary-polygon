...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xde875218DA60aA68b1A4EAfd211684d0a0d55D67];
  address public erc20Payable = 0xde875218DA60aA68b1A4EAfd211684d0a0d55D67;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 40, 70000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmSHt44792XaFY4kisRmRtBWuRDAdam1VHzXravChmWFye/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 70000");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 70000");
    ...
    function mintToMultipleERC20(address _to, uint256 _amount, address _erc20TokenContract) public payable {
      require(_amount >= 1, "Must mint at least 1 token");
      require(_amount <= maxBatchSize, "Cannot mint more than max mint per transaction");
      require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 70000");
      require(mintingOpen == true, "Minting is not open right now!");
...
// File: contracts/IclighthouseContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract IclighthouseContract is RamppERC721A {
    constructor() RamppERC721A("iclighthouse", "ILH"){}
}
