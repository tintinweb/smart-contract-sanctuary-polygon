...
// File contracts/ERC20HyperionFund.sol
...
contract ERC20HyperionFund is OwnableUpgradeable, ERC20PresetMinterPauserUpgradeable {
  using SafeERC20Upgradeable for ERC20Upgradeable;

  bool public regulated;
   ...
   */
  function initializeHyperionFund(
    string memory name,
    string memory symbol,
    bool isRegulated,
    address whitelistContractInput,
    address transferWalletAddress,
    ...
    require(initialSupplyAmount != 0, "initial supply can't be zero");

    //multiply with 1 ether to mint initial gwei amount
    _mint(transferWalletAddress, initialSupplyAmount * 1 ether);
   ...
   * @param to Address tokens will be minted to.
  ...
  /**
   * @dev Allows owner to set regulated status.
   * @param isRegulated Status regulation should be updated with.
   */
  function setRegulated(bool isRegulated) external onlyOwner {
    regulated = isRegulated;
  }
