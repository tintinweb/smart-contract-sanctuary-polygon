...
// File: contracts/NewMonkee2023.sol
...
contract NewKMonkeez2023 is ERC721, Pausable, Ownable, ERC721URIStorage, ERC721Enumerable {
    ...
    constructor() ERC721("Kannabiz Monkeez 2.5", "KMan") {
        tokenCounter = 0;
    }
    ...
    function originalHolderMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable {
        require(originalSaleActive, "OG Mint not active yet");
        require(whitelistMinted[msg.sender] + _mintAmount < 48, "Max OG monkee mints");
        require(_mintAmount < 48);
        require(msg.value >= originalHolderMonkeePrice * _mintAmount, "$MATIC value sent is not correct");
