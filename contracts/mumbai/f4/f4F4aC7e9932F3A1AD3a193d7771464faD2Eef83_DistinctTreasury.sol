...
import "./utils/role/DistinctRoleManager.sol";

/**
 * @notice The Distinct treasury which collects fees generated by the market.
 * @dev The core responsibility of this contract is collecting fees.
 */

contract DistinctTreasury is
    Initializable,
    ContextUpgradeable,
    DistinctRoleManager,
    UUPSUpgradeable
{
    ...
    function initialize(address _distinctSuperAdmin) public initializer onlyProxy {
        __DistinctRoleManager_init(_distinctSuperAdmin);
    }

    /**
     * @notice Allows an admin to withdraw funds.
     * @dev    this allows access to any ERC-20 funds sent to the contract.
     *
    ...
    AccessControlUpgradeable
{
    ...
    function __DistinctRoleManager_init(address superAdmin)
        internal
        initializer
    {
    ...
    /**
     * @dev onlyRole(ADMIN_ROLE) is enforced by `grantRole`.
     */
    ...
    /**
     * @dev onlyRole(ADMIN_ROLE) is enforced by `revokeRole`.
     */
