...
}// File contracts/templates/MintSnapshotWhiteListTemplate.sol
...
contract MintSnapshotWhiteListTemplate is SnapshotFeature, PausableWithWhitelistFeature, ERC20MintFeature {
    function initialize(
        string memory name_, 
        string memory symbol_, 
        uint8 decimals_, 
