...
contract MessageData {
    ...
    */
    ...
    event logNewMsg(uint256 msgID, uint256 isCommentOf, address[2] postedBy, MsgData newMsg, uint256 indexed asGroup, uint256[] inGroups);
    ...
    */
    ...
    function updateContracts(address _kutils, address _hashtags, address _tagged, address _posts, address _messageFormat, address _followers) public onlyAdmins {
    ...
    */
    ...
    function saveMsg(MsgData memory newMsg) public onlyAdmins {
        ...
        Posts.addPost(newMsg.msgID, newMsg.postedBy[0], newMsg.isCommentOf);

        // Increase the bucket counter
        buckets[1] += 1;

        // Emit to the logs for external reference
        emit logNewMsg(newMsg.msgID, newMsg.isCommentOf, newMsg.postedBy, newMsg, newMsg.asGroup, newMsg.inGroups);
    ...
    function removeMsg(uint256 msgID, address requester) public onlyAdmins {
        ...
        Posts.removePost(msgID, msgData[thisBucketKey][msgID].postedBy[0], thisMsgData.isCommentOf);
