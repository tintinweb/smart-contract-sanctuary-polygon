...
// ref: https://github.com/superfluid-finance/protocol-monorepo/blob/dev/packages/ethereum-contracts/contracts/mocks/CFALibraryMock.sol

contract Moonlight is BaseRelayRecipient {
...
/**
TODO test cases:
1. SF functions revert if called from EOA.
2. SF functions succeed if called via Biconomy meta txs, gas tank
3. only deployer can call setTrustedForwarder
4. isOwner returns true only for deployer
 */
