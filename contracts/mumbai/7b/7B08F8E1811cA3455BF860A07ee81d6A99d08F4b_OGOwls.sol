...
contract OGOwls is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxSupply = 9278;
  uint256 public maxMintAmountPerTx = 5;

  bool public paused = true;
  bool public revealed = false;

  constructor() ERC721("OG Owls", "OGO") {
    setHiddenMetadataUri("ipfs://QmdcLs8N3xaJ131kHJGmEh5jJBBZhwxQhgASUiHr4np3kg.json");
  }
