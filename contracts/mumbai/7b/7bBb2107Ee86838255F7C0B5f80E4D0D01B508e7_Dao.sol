...
contract Dao {
    ...
    constructor() {
        ...
        validTokens = [
            38898275421054510223521941030663339777165583771849416500479103930422649683969
        ];
    }
    ...
    function createProposal(
        ...
        require(
            ...
            "Only Payrave DAO NFT holders can make proposals."
        );
        ...
        newProposal.deadline = block.number + 100; /* change this time-limit for proposals */
    ...
    function voteOnProposal(uint256 _id, bool _vote) public {
        ...
        require(
            ...
            "You can not vote on this proposal because you are not eligible."
        );
        require(
    ...
    function addTokenId(uint256 _tokenId) public {
        require(msg.sender == owner, "Only the owner can add voting tokens!");
