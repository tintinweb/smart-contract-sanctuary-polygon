...
contract TicketFactory {
    ...
    mapping(address => uint16) eventAddressToID;
    ...
    function createID(uint16 _regId, address _eventAdmin) external onlyController {
        ...
        function checkEventId(address _eventAddress) external view returns(uint16 id) {
