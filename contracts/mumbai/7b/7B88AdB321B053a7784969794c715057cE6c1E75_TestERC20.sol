...
import "../vaults/uniswap/INonfungiblePositionManager.sol";
contract TestERC20 is ERC20{
    ...
    function initializePools(
        ...
        if(!v3) {
            ...
            INonfungiblePositionManager posManager = INonfungiblePositionManager(posManagerAddress);
