...
contract SuperMeT2 is ERC721, Ownable {
    using SafeMath for uint256;
 ...
 //   address private newReserveAddress;
    ...
    constructor(address _reserveAddress)
        public
        ERC721("SuperMeT2", "SuperMeT2")
    {
        pricePer = 0.0050 * 10 ** 18;
        maxPerTx = 100;
        maxMotor = 10000;
    ...
    function changePricePer(uint256 newPricePer) public onlyOwner {
        pricePer = newPricePer * 10 ** 18 ;
    }
