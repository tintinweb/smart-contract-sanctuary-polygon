...
/**
 * @title YieldFork
 * @dev Version 1 of the ERC20 token contract for YieldFork
 */
contract YieldFork is ERC20, ERC20Detailed, ERC20Mintable, ERC20Burnable, ERC20SwappableInput, ERC20SwappableOutput {
    using SafeMath for uint256;

    /**
     * @dev After deployment, 1,000,000 tokens will be minted for swap testing.
     */
    constructor () public ERC20Detailed("YieldFork", "YLF", 18) { }
}