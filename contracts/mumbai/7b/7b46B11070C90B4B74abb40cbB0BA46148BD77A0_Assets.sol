...
contract Assets is ERC1155, Pausable, ERC1155Burnable, ERC1155Supply, AccessControlled {

    constructor(address _authority) AccessControlled(IAuthority(_authority)) ERC1155("https://metadata.songchain.ens.re/") {}

    function setURI(string memory newuri) public onlyGovernor {
        _setURI(newuri);
    }
