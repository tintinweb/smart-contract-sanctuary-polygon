...
contract Margin is ReentrancyGuard, MarginStorage, Ownable {
        ...
        returns (uint256)
    {
        ...
        uint256 totalMargin = depositInfo.marginAmount + depositInfo.marginReserve; //95
        uint256 loanAmount = depositInfo.loanAmount + depositInfo.usedLoan; //300
        uint256 maxLeverage = IAdminFunctions(adminContract).getBaseLtm();
        ...
        returns (uint256)
    {
        ...
        uint256 loanAmount;
        if(source == 1) {
            totalMargin = depositInfo.marginAmount + depositInfo.marginReserve;
