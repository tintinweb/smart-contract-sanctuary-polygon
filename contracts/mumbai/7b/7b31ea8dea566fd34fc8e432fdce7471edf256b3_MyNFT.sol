...
contract MyNFT is ERC721URIStorage, Ownable {
        ...
        returns (bool, string memory, uint256[] memory)
    {
        ...
        if (totalSupply == 0) {
            ...
            return (false, "No NFTs found", tokenIds);
        }

        // Iterate over the total supply and store the token IDs in the array.
        for (uint256 i = 0; i < totalSupply; i++) {
            tokenIds[i] = nftData[i].tokenId;
        }

        // Return true to indicate that NFTs were found, a success message, and the array of token IDs.
        return (true, "NFTs found", tokenIds);
    }
