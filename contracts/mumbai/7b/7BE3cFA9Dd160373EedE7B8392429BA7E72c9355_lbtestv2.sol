...
contract lbtestv2 is VRFV2WrapperConsumerBase,ConfirmedOwner,ReentrancyGuard {
        ...
        VRFV2WrapperConsumerBase(linkAddress, wrapperAddress) 
    {
        ...
        lottoWeekly = IluckblocksWeekly(0xC931D328144791DDd2132fFe12e1Cb32599D83dA);
        weeklyContract = 0xC931D328144791DDd2132fFe12e1Cb32599D83dA;
    ...
    function fulfillRandomWords(uint256 requestId, uint256[] memory _randomWords) internal override {
        ...
        if(userWallet == address(this) || userWallet == address(0) || idInPosition < 20){
