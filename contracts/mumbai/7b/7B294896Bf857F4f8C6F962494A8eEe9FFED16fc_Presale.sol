...
contract LCRT is ERC20("Launchor Tokens", "LCRT"), Ownable {
    address PresaleAddress;

    function setPresaleAddress(address _PresaleAddress) external onlyOwner {
        require(address(PresaleAddress) == address(0), "Presale address already set");
...
//Change values
    ...
    function buyLCRT(uint256 amount) public payable  {
        token.mint(msg.sender, amount*1000000000000000000);
