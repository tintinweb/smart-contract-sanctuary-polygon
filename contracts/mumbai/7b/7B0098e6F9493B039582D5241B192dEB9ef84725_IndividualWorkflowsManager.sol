...
import {AutomationRegistryInterface, State, Config} from "./keepers/AutomationRegistryInterface1_2.sol";
import {LinkTokenInterface} from "./keepers/LinkTokenInterface.sol";
...
contract IndividualWorkflowsManager {
    ...
    bytes public encryptEmail = "[email protected]";
    ...
    function registerAndPredictID(
        ...
        if (newNonce == oldNonce + 1) {
            ...
            upkeepIDs[upkeepContract] = upkeepID;
    ...
    function getLimitOrderMeta(address addr) external view returns (LimitOrderKCWorkflow.LimitOrderWorkflowDetail memory) {
        return LimitOrderKCWorkflow(addr).getDetail();
    }
