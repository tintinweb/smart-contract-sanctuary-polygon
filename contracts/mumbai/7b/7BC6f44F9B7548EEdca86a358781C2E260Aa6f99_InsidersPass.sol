        ...
        if (_msgSender() != owner()) {
            if (
             ...
             if (promoCodeDetails[_promoCode].discountIsPercentage) { 
                        if (promoCodeDetails[_promoCode].maxDiscountAmount >= (((ticketTypeDetails[ticketID].ticketFixPrice * noOfCopies) * (promoCodeDetails[_promoCode].discountPercentage ))/ 100) ) {
                        checkPrice((( (ticketTypeDetails[ticketID].ticketFixPrice * noOfCopies) - (((ticketTypeDetails[ticketID].ticketFixPrice * noOfCopies) * (promoCodeDetails[_promoCode].discountPercentage ))/ 100) )));
                                                  promoCodeDetails[_promoCode].claimedUsers++;
                        }
                        else{
                        checkPrice((ticketTypeDetails[ticketID].ticketFixPrice * noOfCopies) - promoCodeDetails[_promoCode].maxDiscountAmount);
                            promoCodeDetails[_promoCode].claimedUsers++;
                        }
             }
                    else if (!promoCodeDetails[_promoCode].discountIsPercentage && !promoCodeDetails[_promoCode].isFree) {
                        require((ticketTypeDetails[ticketID].ticketFixPrice * noOfCopies ) - (promoCodeDetails[_promoCode].fixedDiscount) >= 0,"InvalidDiscountPriceOnFixedDiscount");
                        checkPrice(((ticketTypeDetails[ticketID].ticketFixPrice * noOfCopies ) - (promoCodeDetails[_promoCode].fixedDiscount))); 
                                   promoCodeDetails[_promoCode].claimedUsers++;
                    }
