...
contract wonderLandAuction is IERC721Receiver, Ownable {
    ...
    event End(uint256 auctionid,uint256 nftId, address winner, uint256 amount, uint256 timeStamp);
    ...
    mapping(uint256 => Auction) AuctionbyId;
    uint256 AuctionId = 0;
