    ...
    UUPSUpgradeable
{
    ...
    function burn(uint256 tokenId) public override onlyRole(VERIFIER_ROLE) {

        uint256 valueBadge = metadataToken[tokenId].amountUSDC;
        address owner = super.ownerOf(tokenId);
        require( usdcToken.allowance(msg.sender, owner) >= valueBadge, "Dig Ba: Not enough allw");
        require( usdcToken.balanceOf(msg.sender) >= valueBadge,  "Dig Ba: Not enough balance");
        usdcToken.transferFrom(msg.sender, owner, valueBadge);
