    ...
    AccessControlUpgradeable
{
    ...
    //         "FC: Caller is not a default admin"
    //     );

    //     _;
    // }
    // Modifier to restrict function calls to users with the ADMIN_ROLE.
    // modifier onlyAdmin() {
    //     require(
    ...
    */
     ...
     * @param _tokenAddress The address of the token contract.
     * @param _userAddress The address of the user who wants to burn tokens.
    ...
    function tokenBurn(
        ...
        amountGreaterThanZero(_amount)
        notZeroAddress(_userAddress)
        notPlatformBlacklisted(_userAddress)
        notTokenBlacklisted(_tokenAddress, _userAddress)
    {
        IToken(_tokenAddress).burn(_userAddress, _amount);
        emit BurnToken(_tokenAddress, _userAddress, _amount);
    }
        ...
        notZeroAddress(_userAddress)
    {
        ...
        _tokenBlacklisted[_tokenAddress][_userAddress] = _status;
        emit blackListedToken(_tokenAddress, _userAddress, _status, _uinqueId);
    }
    ...
    function platformBlackList(
        ...
        _platformBlacklisted[_userAddress] = _status;
        emit blackListedPlatform(_userAddress, _status, _uinqueId);
    }
        ...
        notZeroAddress(_userAddress)
    {
        ...
        emit TokensFrozen(_tokenAddress, _userAddress, _amount, _uinqueId);
    }
        ...
        amountGreaterThanZero(_amount)
    {
        ...
        emit TokensUnfrozen(_tokenAddress, _userAddress, _amount, _uinqueId);
    }
