...
import "./NebulaUser1155Token.sol";
...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new NebulaUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        NebulaUser1155Token token = NebulaUser1155Token(address(addr));
...
contract NebulaUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
