...
contract Footearn_Private is ReentrancyGuard, Ownable {
    ...
    function buy(uint256 amount) public nonReentrant {
        ...
        usdToken.safeTransferFrom(msg.sender, address(this), amount * 1 ether);
    ...
    function withdrawFund(address fundAddress) public onlyOwner {
        uint256 totalFund = usdToken.balanceOf(address(this));
        usdToken.safeTransferFrom(address(this), fundAddress, totalFund);
    }
