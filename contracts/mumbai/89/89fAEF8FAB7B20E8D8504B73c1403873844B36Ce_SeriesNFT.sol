 ...
 * @notice This contract handles minting SeriesNFT tokens.
 */
contract SeriesNFT is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x156Aa9eF159e7aff7103aB1Bec18a087f3cE986D;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xD0E9a9186a53bB9c6ab63C889293eed511442352;
    ...
    address[] public payoutAddresses = [
        0xD0E9a9186a53bB9c6ab63C889293eed511442352
    ];
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeiddlhd4te6idpucjibr6tpyaypgzvtmfovfxumh3m4b5ncr7vf6ra/{id}"
        )
        RevokableOperatorFilterer(
