...
contract Diamond {
    constructor(IDiamondCut.FacetCut[] memory _diamondCut, address _owner) {
        ...
        LibAccessControl._setupRole(LibAccessControl.executorRole(), _owner);
...
library LibDiamond {
    bytes32 constant DIAMOND_STORAGE_POSITION =
        keccak256("diamond.standard.factory.diamond.storage");
...
library LibAccessControl {
    bytes32 constant STORAGE_POSITION =
        keccak256("diamond.standard.factory.access.control.storage");
