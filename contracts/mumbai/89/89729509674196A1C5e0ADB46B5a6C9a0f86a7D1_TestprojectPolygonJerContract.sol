...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0xFFC508c1F8C65046Bf3f6aee284255E83264c23D];
  address public erc20Payable = 0xFFC508c1F8C65046Bf3f6aee284255E83264c23D;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeifhcjm263oa5ikzo62etkibbng4vy62surxh54slxpqhn3oiplhiu/";
...
// File: contracts/TestprojectPolygonJerContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TestprojectPolygonJerContract is RamppERC721A {
    constructor() RamppERC721A("Testproject Polygon Jer", "POLYTEST"){}
}
