...
contract Tezeract is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes {
    constructor() ERC20("Tezeract Testnet", "TZN") ERC20Permit("Tezeract Testnet") {}

    // Overrides Decimals to 4
    function decimals() public view virtual override returns (uint8) {
        return 4;
    }
