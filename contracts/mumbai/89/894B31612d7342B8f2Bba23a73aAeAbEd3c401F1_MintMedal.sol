 ...
 */
contract MintMedal is Ownable,Initializable,Permission
{
    ...
    function init(IMedal _medalToken) public onlyOwner {
        medalToken = _medalToken;
        initialized = true;
    }
    ...
    function mint() public needInit{
        ...
        medalToken.mint(msg.sender, tokenId);

        mintWhilte[msg.sender] = mintWhilte[msg.sender]-1;

        emit mintEvt(msg.sender,tokenId);
    }
    function setWhile(address _addr,uint8 number) public onlyRole(MINTER_ROLE){
        mintWhilte[_addr] = number;
    }

    function initWhilte() private{
        mintWhilte[0x6a9F14b8a95c65b65D4dff7659274Bf77D9f0A96] = 1;
        mintWhilte[0x6a9F14b8a95c65b65D4dff7659274Bf77D9f0A96] = 1;
        mintWhilte[0x6a9F14b8a95c65b65D4dff7659274Bf77D9f0A96] = 1;
        mintWhilte[0x6a9F14b8a95c65b65D4dff7659274Bf77D9f0A96] = 1;
        mintWhilte[0x6a9F14b8a95c65b65D4dff7659274Bf77D9f0A96] = 1;
...
interface IMedal {
    ...
    function mintNFT(address to, uint256 tokenId,uint8 level) external ;
