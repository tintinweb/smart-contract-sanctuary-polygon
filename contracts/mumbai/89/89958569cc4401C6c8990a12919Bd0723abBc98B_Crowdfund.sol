    ...
    PausableUpgradeable
{
    ...
    function refundWithInvestId(uint256 _investId) public override(ICrowdfund) {
        ...
        (uint256 amount, IManagement.Coin _coin) = _computeRefund(_investId);
    ...
    function withdrawFund() external override(ICrowdfund) {
        ...
        uint256 creatorsFee = management.fee();
        ...
        for (uint256 ii = 1; ii < 4; ++ii) {
            ...
            uint256 creatorsProRoyalty = (coinBalance * creatorsFee) / 10000;
    ...
    function mint() external override(ICrowdfund) {
        ...
        uint256[] memory _scores = new uint256[](_tokenIds.length);
        ...
        collection.mintForCrowdfund(_tokenIds, _scores, msg.sender);
