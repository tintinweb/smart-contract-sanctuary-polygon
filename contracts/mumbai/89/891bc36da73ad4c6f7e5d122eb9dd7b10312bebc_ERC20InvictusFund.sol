...
contract ERC20InvictusFund is OwnableUpgradeable, ERC20PresetMinterPauserUpgradeable {
  ...
  /**
   * @dev Updates the whitelist contract address.
   * @param newWhitelistAddress The new whitelist address.
   */
  function updateWhitelistContract(address newWhitelistAddress) public onlyOwner {
