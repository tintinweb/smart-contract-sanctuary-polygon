...
abstract contract LayerZeroApp is Initializable, OwnableUpgradeable, ILayerZeroReceiver, ILayerZeroUserApplicationConfig {
  ...
  function getGasLimit(bytes memory _adapterParams) public pure returns (uint256 gasLimit) {
    assembly {
...
abstract contract NonblockingLayerZeroApp is Initializable, LayerZeroApp {
  ...
  function _blockingLzReceive(
    ...
    try this.nonblockingLzReceive(_srcChainId, _srcAddress, _nonce, _payload) {
      ...
      failedMessageReasons[_srcChainId][_srcAddress][_nonce] = reason;
