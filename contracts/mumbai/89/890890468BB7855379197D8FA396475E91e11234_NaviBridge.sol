...
contract NaviBridge is Ownable, ReentrancyGuard, DSMath {
    ...
    mapping(uint32 => uint256) private blockTimestamps; //confirmed block hashes
    ...
    function getLastBlock() external view returns (bytes memory) {
    ...
    function _finalizeBlock() internal {
        ...
        if (currentBlock > 1000) delete pastBlock[currentBlock - 1000];
    ...
    function transferIn(
        ...
        require(nonce > nonces[recepient], "Navi::transferIn: Invalid nonce");
