...
contract AssentBondLpToken is Ownable, ReentrancyGuard, Pausable, ErrorReporter {
    ...
    function payoutFor( uint256 _principalAmount, address _user) public view returns ( uint256 payout, uint tokenPriceDollar, uint principalPriceDollar, uint256 tokenPriceWithDiscount, uint256 tokenPerPrincipal) {
        ...
        tokenPriceWithDiscount*(MULTIPLIER-userFeeReduction)/MULTIPLIER;        
