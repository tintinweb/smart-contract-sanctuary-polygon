...
contract AmazingAEIOU is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("AmazingAEIOU", "AEIOU", maxBatchSize_, collectionSize_) {
  ...
  function withdraw() external nonReentrant {
    require(msg.sender == 0x46A23E0Db8F78408d8BBB4C28278fCB1Fa5B2a26);
