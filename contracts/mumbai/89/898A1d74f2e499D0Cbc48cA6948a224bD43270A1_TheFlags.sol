...
contract TheFlags is ERC721, Ownable {
    ...
    constructor() ERC721("TheFlags", "FLG") public {
        ...
        formNepal[15] = formRange(12, 20);
        formNepal[16] = formRange(13, 20);
        formNepal[17] = formRange(13, 20);
        formNepal[18] = formRange(14, 20);
        formNepal[19] = formRange(15, 20);
        formNepal[20] = formRange(20, 20);
    }
