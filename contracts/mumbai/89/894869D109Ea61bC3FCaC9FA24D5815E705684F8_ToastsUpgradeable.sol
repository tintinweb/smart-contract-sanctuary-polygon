...
//**************************************************************
// MintED Tokens of Appreciation (TOASTs) ERC1155 Contract Upgradeable
//**************************************************************
...
import "@thirdweb-dev/contracts/interfaces/token/ITokenERC1155.sol";
import "@thirdweb-dev/contracts/ThirdwebContract.sol";

contract ToastsUpgradeable is
    Initializable,
    ERC1155Upgradeable,
    UUPSUpgradeable,
    OwnableUpgradeable,
    ...
    ITokenERC1155
{
    ...
    bytes32 private constant TYPEHASH =
        keccak256("MintRequest(address to,string uri,bytes32 uid)");
     ...
     */
    function Pausable_init() internal onlyOwner onlyInitializing {
    ...
    string public constant name = "mintED Toasts";
    string public constant symbol = "TOASTS";
    ...
    uint256 public constant tokenURIOption = 1;
    ...
    event MintSingle(address to_, uint256 id_, uint256 amount_);
    ...
    function mint(
        ...
        emit MintSingle(msg.sender, id_, amount_);
    }
    ...
    function _mintTo(
        ...
        if (bytes(tokenIdToTokenURI[_tokenId]).length == 0) {
            require(bytes(_uri).length > 0, "empty uri.");
            tokenIdToTokenURI[_tokenId] = _uri;
        }

        _mint(_to, _tokenId, _amount, "");

        emit TokensMinted(_to, _tokenId, tokenIdToTokenURI[_tokenId], _amount);
    }
    ...
    {
        return
            abi.encode(TYPEHASH, _req.to, keccak256(bytes(_req.uri)), _req.uid);
    }
    ...
    function supportsInterface(bytes4 interfaceId)
        public
        view
        override(ERC1155Upgradeable, AccessControl, IERC165Upgradeable)
        returns (bool)
    {
