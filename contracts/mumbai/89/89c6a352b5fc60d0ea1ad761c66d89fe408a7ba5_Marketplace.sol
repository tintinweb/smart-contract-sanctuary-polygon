...
contract Marketplace is ERC721, ReentrancyGuard {
    ...
    function listNft(address _nftContract, uint256 _tokenId, uint256 _price) public payable nonReentrant {
        ...
        //IERC721(_nftContract).transferFrom(_owner, address(this), _tokenId);
    ...
    function buyNft(address _nftContract, uint256 _tokenId) public payable nonReentrant {
        ...
        address payable owner = payable(IERC721(_nftContract).ownerOf(_tokenId));
        ...
        nft.owner = buyer;
        //console.log("new owner :", IERC721(_nftContract).ownerOf(_tokenId));        
        nft.price = 0.0;
        nft.listed = false;
        _nftsSold.increment();
        //emit NFTSold(_nftContract, nft.tokenId, buyer, nft.price);
    ...
    function resellNft(address _nftContract, uint256 _tokenId, uint256 _price) public payable nonReentrant {
        ...
        _nftsSold.decrement();
        //emit NFTListed(_nftContract, _tokenId, nft.owner, _price);
        emit NFTListed(_nftContract, _tokenId, msg.sender, address(this), _price);
    }
