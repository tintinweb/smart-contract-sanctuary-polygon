...
// File contracts/payment-gateway/PaymentGatewayV2.sol
...
contract PaymentGatewayV2 is Initializable, OwnableUpgradeable {
  ...
  function pay(
    ...
    ERC20Upgradeable(vndtToken).transferFrom(msg.sender, merchantAddress, amount);
  ...
  function send(
    ...
    ERC20Upgradeable(vndtToken).transferFrom(msg.sender, recipient, amount);
