...
contract RewardTracks is OwnableUpgradeable{
    ...
    function _addTrackToSpecificCard(
      ...
      returns (uint256){
        ...
        TrackMeta memory meta = TrackMeta(_trackIds + 1 , true, _nftContract, _tokenId,_name, _image, _description, _source, _rewards, _trackDuration, isAdvertisement, _advContractAddress, _advCardId);
    ...
    function _addTrackToContract(
      ...
      returns(uint256) {
        ...
        // Create a new struct of type "TrackMeta" 
        TrackMeta memory meta = TrackMeta(newTrackId , false, _nftContract, 0,_name, _image, _description, _source, _rewards, _trackDuration, isAdvertisement, _advContractAddress, _advCardId);
