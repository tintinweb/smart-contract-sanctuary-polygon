...
import "@openzeppelin/contracts/utils/Strings.sol"; // for the toString() method
import "@openzeppelin/contracts/utils/Base64.sol"; // handle base64 data 

contract ChainBattles is ERC721URIStorage {
  using Counters for Counters.Counter;
  Counters.Counter private totalToken;
  using Strings for uint256; // for the toString() method
  ...
  function mint() public {
    ...
    uint256 newTokenID = totalToken.current();
    _safeMint(msg.sender, newTokenID);

    tokenIDtoLv[newTokenID] = 0;
