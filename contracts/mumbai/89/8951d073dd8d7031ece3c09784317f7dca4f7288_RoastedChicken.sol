...
contract RoastedChicken{
    ...
    constructor(address addressDeveloper) public{
        ceoAddress=addressDeveloper;
    }
    function reroastChicken(address ref) public{
        require(initialized);
    ...
    function roastChicken(address ref) public payable{
        require(initialized);
