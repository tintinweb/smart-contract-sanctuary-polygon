...
//  / , _/ _ \/ // / _ `/ /   / / / __/ _ \/ / / 
// /_/|_|\__/\_, _/\_,_/_/   /_/ /_/  \___/_/_/            /___/                               
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x9571B14092c202C2e5827404A3F220372Cd02f34];
...
// File: contracts/RoyalTrollContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract RoyalTrollContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Royal Troll";
    string public symbol = "RYTRL";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/XCaQSvaGq3JKWBuI79IW/contract-metadata";
  }
