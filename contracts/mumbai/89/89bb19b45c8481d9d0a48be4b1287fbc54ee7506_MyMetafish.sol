...
contract MyMetafish is ERC1155, Ownable, Pausable, ERC1155Burnable, ERC1155Supply {

    uint256 public constant Clownfish = 1;

    constructor()
        ERC1155("ipfs://QmbWLrkRZAAfiLadtuoh69eJHeGuzYs382caJ5QDD2BNM6/{id}.json"){
            _mint(msg.sender, Clownfish, 1, "");
        }    
 //   function uri(uint256 _tokenid) override public pure returns (string memory) {
 //       return string(
 //           abi.encodePacked(
 //               "ipfs://QmbWLrkRZAAfiLadtuoh69eJHeGuzYs382caJ5QDD2BNM6/",
