...
contract Roundeds is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
    ...
    uint256 public WHITELIST_SUPPLY = 1000;
    uint256 public PUBLICMINT_SUPPLY = 3750;
    ...
    uint256 public FREEMINT_TX_LIMIT = 3;
    uint256 public WHITELIST_TX_LIMIT = 10;
    uint256 public PUBLICMINT_TX_LIMIT = 10;

    
    uint256 public FREEMINT_WALLET_LIMIT = 3;
    uint256 public WHITELIST_WALLET_LIMIT = 10;
    uint256 public PUBLICMINT_WALLET_LIMIT = 10;

    
    uint256 public FREEMINT_PRICE = 0 ether;
    uint256 public WHITELIST_PRICE = 8 ether;
    uint256 public PUBLICMINT_PRICE = 15 ether;
    ...
    string private preRevealURI = "https://ipfs.w3bmint.xyz/ipfs/QmPMJDaaUE4eJB9W4dMQSeourcii6aVeXD9JVR9fHAEa7P";
    ...
    constructor(
        bytes32 _Freemint,
        bytes32 _Whitelist) ERC721A("Roundeds", "RCHG") {
        
        FREEMINT_ROOT = _Freemint;
        WHITELIST_ROOT = _Whitelist;
        
        _safeMint(0xC037e890FF70Ca38a75a41A637E48D7bcF7F62d8, 50);
    }
    ...
    function PUBLICMINTMint(address to, uint256 numberOfTokens) external isSecured(PUBLICMINT_PRICE * numberOfTokens) payable {
        ...
        addressBlockBought[to] = block.timestamp;
        PUBLICMINT_Minted[to] += numberOfTokens;
