...
contract ResToken is ERC1155, AccessControl, Pausable, ERC1155Burnable, ERC1155Supply {
    ...
    constructor() ERC1155("") {
        name = "PolyGodz:Resurrection Claim Token";
        symbol = "PG:RES";
    ...
    function addMinterRole(address _address) public onlyRole(DEFAULT_ADMIN_ROLE){
