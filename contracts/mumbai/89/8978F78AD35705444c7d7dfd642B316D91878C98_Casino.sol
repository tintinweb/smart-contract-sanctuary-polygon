...
contract Casino is Ownable {
    ...
    // modifier updateCasinoProfitWhenStaked(address _account) {
    ...
    // modifier updateBalanceWhenStaked(address _account) {
    //     casinoBalancesWhenStaked[msg.sender][0] = totalSupply();
    //     casinoBalancesWhenStaked[msg.sender][1] = stakedAmount;
    //     _;
    // }
