...
contract VRDa1Assets is ERC721Tradable{

       constructor() ERC721Tradable("VRDa1 Asset Tokenisation", "VAT",0x1E0049783F008A0085193E00003D00cd54003c71,"https://vrda1-stagging.s3.ap-south-1.amazonaws.com/vrda1-metadata/", 0x1536EF5C6172C8a34c640F527e0cF674aA4DC82D, 500) {
    }
...
contract ERC721PresetMinterPauserAutoId is Context, ERC721Enumerable, ERC721Burnable, ERC721Pausable, ERC2981 {
    ...
    function mintBatch(address[] memory to) public virtual {
        ...
        for (uint256 index = 0; index < to.length; index++) {
            _mint(to[index], _tokenIdTracker.current());
            _tokenIdTracker.increment();
        }
    }
...
contract ERC721Tradable is ContextMixin, ERC721PresetMinterPauserAutoId, DefaultOperatorFilterer {
    ...
    ) ERC721PresetMinterPauserAutoId(_name, _symbol,_baseURI, royaltiesReceiver, royaltiesFeeNumerator) {
