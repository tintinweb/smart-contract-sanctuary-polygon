...
/**
 * XC Swap Goerli -> Mumbai (Uniswap V2 to Uniswap V3)
 */
contract Swap is ZetaInteractor, ZetaReceiver, SwapErrors, Pausable {
    ...
    function swapExactInputSingle(
        ...
        uint256 zetaValueAndGas;
        {
            ...
            uint256[] memory amounts = swapRouterV2.swapExactETHForTokens{value: msg.value}(
        ...
        isValidMessageCall(zetaMessage)
    {
        ...
        if (destinationOutToken == iZetaToken) {
            ...
            TransferHelper.safeApprove(iZetaToken, address(swapRouter), amountIn);

            uint256 amountOut;
            ISwapRouter.ExactInputSingleParams memory params = ISwapRouter.ExactInputSingleParams({
                tokenIn: iZetaToken,
                tokenOut: destinationOutToken,
                fee: poolFee,
            ...
            if (amountOut < outTokenMinAmount) revert InsufficientOutToken();
        }
