...
contract SellContract is Owned {
    
    Tarefa01 tarefa01Token;
    ...
    function buyTokens() public payable returns (uint256 tokenAmount) {
        ...
        uint256 SellerBalance = tarefa01Token.balanceOf(address(this));
        require(SellerBalance >= amountToBuy, "You don't have enough T1 tokens to continue this transaction");
        bool sent = tarefa01Token.transfer(msg.sender, amountToBuy);
...
contract Tarefa01 is ERC20, Owned {
    constructor() ERC20(
        "Tarefa01",
        "T1",
        18
