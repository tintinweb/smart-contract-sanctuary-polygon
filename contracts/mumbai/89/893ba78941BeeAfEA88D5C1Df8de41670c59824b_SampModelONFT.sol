...
contract SampModelONFT is ONFT1155, ERC1155URIStorage, ERC2981, Initializable {
    ...
    constructor() ONFT1155("", 0xf69186dfBa60DdB133E91E9A4B5673624293d8F8) {}
     ...
     * @dev See {IERC165-supportsInterface}.
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(ONFT1155, ERC1155, ERC2981) returns (bool) {
        return interfaceId == type(IONFT1155).interfaceId || super.supportsInterface(interfaceId);
    }
