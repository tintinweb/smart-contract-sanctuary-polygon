...
abstract contract GovenorEnumerationCompatibilityBravo is GovernorCompatibilityBravo {
    ...
    function _storeProposalIndex(uint256 proposalId) private {
        _proposalIndexMap[_proposalCount] = proposalId;
        _proposalCount++;
    }
}
  ...
  GovernorTimelockControl
{
    ...
    IProposalValidator private _proposalValidator;
    event ProposalValidatorSet(address oldProposalValidator, address newProposalValidator);
    ...
    {
        _setProposalValidator(proposalValidator);
    }

    function setProposalValidator(IProposalValidator proposalValidator) public onlyGovernance virtual {
        _setProposalValidator(proposalValidator);
    }

    function _setProposalValidator(IProposalValidator proposalValidator) internal virtual {
        emit ProposalValidatorSet(address(_proposalValidator), address(proposalValidator));
