 ...
 * @notice This contract handles minting Vivid Harmonies: A Kaleidoscope of Sound tokens.
 */
contract VividHarmoniesAKaleidoscopeOfSound is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x1B963737618ea3b42e0e398C0d2E80b4E7394530;
    ...
    address public royaltyAddress = 0x8f91aacaa67686744ae9a1316aBddDb137E66493;
    ...
    string public name = "Vivid Harmonies: A Kaleidoscope of Sound";
    string public symbol = "VivHar";
    ...
    constructor(uint256 _heymintFeePerToken, address _crossmintAddress)
        ERC1155(
            "ipfs://bafybeie4ikuuu75cfclsz7zrbjnly3m7r6wabphla3lmkcnli63breer7i/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenPublicSaleStartTime[1] = 1683021600;
        tokenPublicSaleEndTime[1] = 1685700000;
