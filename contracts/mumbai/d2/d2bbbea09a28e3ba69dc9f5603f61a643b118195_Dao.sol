...
contract Dao is ERC20{
  ...
  constructor() ERC20(name1, symbol1) {
    ...
    function getAllProposal() public view returns (ProposalBrief[] memory){
         if (nextProposal == 1) {
             // means no data
             return new ProposalBrief[](0);
         }
         ProposalBrief[] memory briefData = new ProposalBrief[]((nextProposal-1));
