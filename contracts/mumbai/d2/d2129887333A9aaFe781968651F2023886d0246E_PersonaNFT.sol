...
contract PersonaNFT is ERC721Enumerable, IPersona, Ownable {
    ...
    event SetPersona(uint256 tokenID, string tokenURI);
    ...
    function mint() external payable {
        ...
        emit SetPersona(tokenId, tokenURIs[tokenId]);
    }
    ...
    function updateNFT(
        ...
        uint16[] memory traits = new uint16[](_oldTraits.length + _newTraits.length);
        uint8 index = 0;
        ...
        require(
            IPersonaSign(personaSign).verifyForTraits(
                msg.sender,
