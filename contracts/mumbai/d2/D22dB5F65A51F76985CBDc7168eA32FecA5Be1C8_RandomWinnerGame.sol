...
// Using `VRFConsumerBase.sol` contract to call `requestRandomness()`
import "@chainlink/contracts/src/v0.8/VRFConsumerBase.sol";

contract RandomWinnerGame is VRFConsumerBase, Ownable {
    // ** Why are some variables explicitly `publix` and some are not?
    //Chainlink variables
    ...
    function startGame(uint8 _maxPlayers, uint256 _entryFee) public onlyOwner {
        ...
        // ** How gas-intensive is emptying arrays?
        delete players;
