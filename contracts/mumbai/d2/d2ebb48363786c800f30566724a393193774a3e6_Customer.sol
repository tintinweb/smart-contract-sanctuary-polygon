...
contract Customer is ERC721Holder {
    ...
    function customerBankDetailsTableURI() public view returns (string memory) {
        return string.concat(tableURI(), "SELECT%20*%20FROM%20", _customerBankDetailsTable);
    }

    function customerTableURI() public view returns (string memory) {
        return string.concat(tableURI(), "SELECT%20*%20FROM%20", _customerTable);
    }
}
