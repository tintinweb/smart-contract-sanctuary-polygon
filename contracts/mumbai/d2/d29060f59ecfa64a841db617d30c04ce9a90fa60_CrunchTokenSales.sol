...
contract CrunchTokenSales {
    ...
    function buy(uint256 _tokenAmount, address purchaseWith) public {
        ...
        require(IERC20(purchaseWith).transferFrom(_msgSender(), address(multiSigContractAddress), _tokenAmount * 10 ** IERC20(purchaseWith).decimals() ), "CRUNCH NETWORK: TRANSFERFROM FAILED!");
