...
contract BetMain {
    ...
    uint256 baseBetValue = 0.1 ether;
    bool betOn = false;
    ...
    mapping(uint256 => MatchStruct) public matchIdToMatchStruct;
    ...
    mapping(uint256 => BetStruct) public betIdToStruct;

    //winner address to Clamable amount
    mapping(address => uint256) public betWinnerAmountClaimable;
