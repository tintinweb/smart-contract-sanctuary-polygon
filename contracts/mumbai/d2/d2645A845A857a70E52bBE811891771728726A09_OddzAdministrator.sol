...
contract OddzAdministrator is IOddzAdministrator, AccessControl, ReentrancyGuard {
    ...
    uint256 public claimableTreasuryPercent = 50; //50%
     ...
     */
    function setClaimableTreasuryPercent(uint256 _claimableTreasuryPercent) external onlyAdmin(msg.sender) {
        require(_claimableTreasuryPercent > 0, "Percentage cannot be zero or less");
        require(_claimableTreasuryPercent <= 100, "Percentage cannot be more than 100");
     ...
     * @dev Callable by admin
     */
    function claimTreasury() external override nonReentrant onlyAdmin(msg.sender) notContract(msg.sender) {
