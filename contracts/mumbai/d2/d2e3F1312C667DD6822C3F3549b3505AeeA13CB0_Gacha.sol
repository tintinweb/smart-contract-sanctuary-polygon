    ...
    UUPSUpgradeable
{
    ...
    /**
     * @dev Updates the rate of lost for a specific reward token.
     * @param _indexReward The index of the reward token to update.
     * @param _rateOfLost The new rate of lost for the reward token.
     */
    function updateRateOfLost(
        uint256 _indexReward,
        uint256 _rateOfLost
    ) external onlyRole(UPDATER_ACTIVITIES_ROLE) {
        rewardTokens[_indexReward].unlockRate = _rateOfLost;
    }
    ...
    /**
     * @dev Updates the receive admin wallet and returned NFT wallet addresses.
     * @param _receiveAdminWallet The new receive admin wallet address.
     * @param _returnedNFTWallet The new returned NFT wallet address.
     */
