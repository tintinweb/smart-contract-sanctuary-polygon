    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 20, 15000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmeUu2pZnHFpzpS1d6fxcRJH1snWWuJNdr8NvdtsNEV462/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 15000");
...
// File: contracts/BurntapeContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BurntapeContract is RamppERC721A {
    constructor() RamppERC721A("burntape", "BA"){}
}
