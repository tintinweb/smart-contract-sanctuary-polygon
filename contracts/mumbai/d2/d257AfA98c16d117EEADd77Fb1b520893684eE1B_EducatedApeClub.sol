...
// File: contracts/Apedu.sol
    ...
    contract EducatedApeClub is ERC721, Ownable, ERC721Enumerable {
      using SafeMath for uint256;
      using Strings for uint256;
    
      uint256 public constant tokenPrice = 0.0001 ether; // 0.0019 ETH 
      ...
      uint256 public devReserve = 1000;
        ...
        returns (string memory)
      {
        ...
        if (isRevealed == false) {
          return
            "ipfs://QmS2YpZL2QsU4RkiDWET4GJo2g7HfQadeGSYGYJ3mLK77E/hidden.json";
        }
