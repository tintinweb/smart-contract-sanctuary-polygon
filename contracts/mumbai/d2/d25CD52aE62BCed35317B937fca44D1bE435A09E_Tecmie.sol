...
contract Tecmie {
    ...
    TecmieContract daoContract;

    constructor(){
        owner = msg.sender;
        nextProposal = 1;
        daoContract = TecmieContract(0x2953399124F0cBB46d2CbACD8A89cF0599974963);
    ...
    function voteOnProposal(uint256 _id, bool _vote) public {
        ...
        emit newVote(p.votesWin, p.votesLose, msg.sender, _id, _vote);
    ...
    function countVotes(uint256 _id) public {
        ...
        if(Proposals[_id].votesLose < Proposals[_id].votesWin){
            p.passed = true;            
        }
