...
contract ChainBattles is ERC721URIStorage {
    ...
    function getLevels(uint256 tokenId) public view returns (string memory) {
        Stats storage stat = tokenIdToStats[tokenId];
        return stat.Level.toString();
    }

    function getSpeed(uint256 tokenId) public view returns (string memory) {
        Stats storage stat = tokenIdToStats[tokenId];
        return stat.Speed.toString();
    }

    function getStrength(uint256 tokenId) public view returns (string memory) {
        Stats storage stat = tokenIdToStats[tokenId];
        return stat.Strength.toString();
    }

    function getLife(uint256 tokenId) public view returns (string memory) {
        Stats storage stat = tokenIdToStats[tokenId];
        return stat.Life.toString();
    }
    ...
    function mint() public {
        ...
        tokenIdToStats[newItemId].Speed = 5;
        tokenIdToStats[newItemId].Strength = 5;
        tokenIdToStats[newItemId].Life = 10;
    ...
    function train(uint256 tokenId) public {
        ...
        tokenIdToStats[tokenId].Speed = currentSpeed + 3;
        tokenIdToStats[tokenId].Strength = currentStrength + 4;
        tokenIdToStats[tokenId].Life = currentLife + 5;
