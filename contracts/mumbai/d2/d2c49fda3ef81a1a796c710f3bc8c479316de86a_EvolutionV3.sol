...
// File: contracts/bapevolution/Evolution-v1.sol
...
// File: contracts/bapevolution/Evolution-v2.sol


pragma solidity 0.8.18;


contract EvolutionV2 is EvolutionV1 {
    ...
    function strConcat(
        ...
        return
            string(abi.encodePacked(_str1, _str2));
    }
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return strConcat(tokenURIs[tokenId],"/?new");
    }
}
// File: contracts/bapevolution/Evolution-v3.sol


pragma solidity 0.8.18;


contract EvolutionV3 is EvolutionV2 {
