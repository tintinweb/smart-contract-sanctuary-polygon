...
contract lbtestwv2d is VRFV2WrapperConsumerBase,ConfirmedOwner,ReentrancyGuard {
	using SafeMath for uint256;
    ...
    */
        ...
        VRFV2WrapperConsumerBase(linkAddress, wrapperAddress) 
    {
        ...
        lbNodes = IluckblocksNodes(0xe4Ec44A3243A1Ff145d51fAFced68e6d3E03FA0b);
    ...
    function autoSpin(address _caller, uint256[] calldata _nodes) public nonReentrant {
        ...
        if(lbNodes.getUserActivation(_caller,1) == false){
            ...
            require(block.timestamp > lastAutoSpin + 600, "draw timestamp still not reached");   // 604800 1 week > 605100 1 week+5mins
