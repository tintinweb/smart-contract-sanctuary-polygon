...
contract WowTQuiz is OwnableUpgradeable {
  ...
  function createQuiz(
    ...
    require(
      userPoints > createEligibility || _userAddress == owner(),
    ...
    points.reducePoints(_userAddress, createEligibility);
  }
  ...
  function quizEval(string memory _quizName, bytes32 choice, address _userAddress) external onlyOwner {
