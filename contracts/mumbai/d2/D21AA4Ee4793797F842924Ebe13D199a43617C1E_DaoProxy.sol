...
contract DaoProxy is BaseContract {
    ...
    function getUserData(
        ...
        _OnlyReadItem = OnlyReadItem(
            ...
            totalConfig,
            daoRewardData,
            weekRewardIndex > 0 ? weekRewardPerWeekList["Invest"][weekRewardIndex - 1] : (new weekRewardIitem[](1)[0]),
            weekRewardIndex > 0 ? weekRewardPerWeekList["Invite"][weekRewardIndex - 1] : (new weekRewardIitem[](1)[0])
