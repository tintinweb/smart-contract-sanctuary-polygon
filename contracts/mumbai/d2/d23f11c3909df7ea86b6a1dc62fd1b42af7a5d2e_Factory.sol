...
contract Factory{
    ...
    function deployNft(string memory name, string memory symbol) external returns(address){
      RewardNFT instance = new RewardNFT(msg.sender, msg.sender, name, symbol);
      address contractAddress = address(instance);
      addresses[counter] = contractAddress;
