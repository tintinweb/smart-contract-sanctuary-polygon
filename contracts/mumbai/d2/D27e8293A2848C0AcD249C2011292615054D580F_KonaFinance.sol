...
contract KonaFinance is KonaStorage, IKonaFinance {
    ...
    function updateLoanConditions(uint256 _providerID, uint256 _loanID, uint256 _maturity, uint256 _repayments, uint256 _totalLocked, uint256 _apy) external onlyRole(LOAN_MANAGER_ROLE) {
