...
import "./smart-contracts-dev/IMentaportERC721.sol";
import "./smart-contracts-dev/MentaportVerify.sol";
...
**/
contract MentaportStamps is ERC721URIStorage, MentaportVerify, Ownable, Pausable, ReentrancyGuard, IMentaportERC721  {
 ...
 */
  ...
  */
  ...
  {
    require(isValidAccessMessage(msg.sender, _timestamp, _rule, _signature), "Wrong signature");
    _;
  }
