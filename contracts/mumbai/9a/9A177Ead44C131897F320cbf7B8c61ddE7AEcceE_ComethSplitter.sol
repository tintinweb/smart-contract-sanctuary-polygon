...
contract OriumSplitter is Initializable, AccessControlUpgradeable {
    ...
    mapping(address => uint256) public beneficiaryToShare;
    ...
    function split() public {
        ...
        for (uint256 i = 0; i < tokenAddresses.length; i++) {
            ...
            for (uint256 j = 0; j < beneficiaries.length; j++) {
                uint256 _amount = splitValueByShare(_balance, shares[j]);
                if (_amount == 0) return;
    ...
    /**
     * @notice  Split a value according to a share.
     * @param   _value  value to be split.
     * @param   _share  share to be used.
     * @return  _result  value split according to the share.
     */
    function splitValueByShare(
        uint256 _value,
        uint256 _share
    ) public pure returns (uint256 _result) {
        _result = (_value * _share) / 100 ether;
    }
