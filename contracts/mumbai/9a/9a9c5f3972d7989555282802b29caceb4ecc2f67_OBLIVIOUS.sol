...
contract OBLIVIOUS is ERC20, ERC20Burnable, Pausable, Ownable {
    constructor() ERC20( "OBLIVIOUS", "OBL") {
        _mint(msg.sender, 22000000000000 * 10 ** decimals());
    }
