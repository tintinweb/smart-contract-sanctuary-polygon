...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x6750CdDA7D6Fabb8A2db1D8D1e2D570afa43f22b];
  address public erc20Payable = 0x6750CdDA7D6Fabb8A2db1D8D1e2D570afa43f22b;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeihgb73a66y3elxomeugciod6xhjlqsa6szyspr6tqtq6nymrl2c7m/";
...
// File: contracts/CharVilleContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CharVilleContract is RamppERC721A {
    constructor() RamppERC721A("CharVille", "CV"){}
}
