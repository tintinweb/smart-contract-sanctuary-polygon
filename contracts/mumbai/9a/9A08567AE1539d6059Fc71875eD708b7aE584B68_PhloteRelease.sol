...
contract PhloteRelease is ERC721A, Ownable {
    ...
    uint256 public cosignerPrice = 10;
    ...
    constructor(address payable _artistAddress, address[] memory _cosigners) ERC721A("myContract", "CONT") {
        //Defaults
        totalSupplyLeft = 20; //the public supply
        price = 10000000000000000;
        artist = _artistAddress;
        /***** SET PROPER PHLOTE MAINNET ADDRESS ****/
        phloteToken = IERC20(0x363C97f362e597D0ddcF86A72AF71c9fC80789e2);
    ...
    function cosignerMint() external payable whenSaleIsActive {
        ...
        require(
                phloteToken.allowance(msg.sender, address(this)) >= cosignerPrice,
                "Phlote token allowance is too low"
            );
        require(phloteToken.transferFrom(msg.sender, address(this), cosignerPrice));
    ...
    function setCosignerPrice(uint256 _price) external onlyOwner {
        cosignerPrice = _price;
    }
