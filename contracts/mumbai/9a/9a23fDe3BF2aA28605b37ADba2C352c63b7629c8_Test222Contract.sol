...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmaaQ5WS8X5RjisAsmV7McEy849RqYZeZdSxzBSuyKtdyJ/";
...
// File: contracts/Test222Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Test222Contract is RamppERC721A {
    constructor() RamppERC721A("test222", "t2st2"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/xjISK2G3gb0oHqZE4CTB/contract-metadata";
    }
}
