...
contract UniswapV2ERC20 is IUniswapV2ERC20 {
    string public constant override name = "Logistic AMM";
    string public constant override symbol = "LIAMM";
    ...
    function permit(
        ...
        require(deadline >= block.timestamp, "Logistic AMM: EXPIRED");
        ...
        require(
            ...
            "Logistic AMM: INVALID_SIGNATURE"
        );
...
contract UniswapV2Factory is IUniswapV2Factory {
    ...
    address owner;
    string public name = "LogisticAMM: Factory";
    address treasury;
    ...
    function createPair(
        ...
        require(tokenA != tokenB, "Logistic AMM: IDENTICAL_ADDRESSES");
        (address token0, address token1) = tokenA < tokenB
            ? (tokenA, tokenB)
            : (tokenB, tokenA);
        require(token0 != address(0), "Logistic AMM: ZERO_ADDRESS");
        require(
            getPair[token0][token1] == address(0),
            "Logistic AMM: PAIR_EXISTS"
    ...
    function setTreasuryAddress(address _treasury) external override {
        ...
        {
            require(
                block.timestamp - releaseTime >= lockTime,
...
contract UniswapV2Pair is IUniswapV2Pair, UniswapV2ERC20 {
    ...
    // string public name = 'LogisticAMM: Pair';
    ...
    modifier lock() {
        require(unlocked == 1, "Logistic AMM: LOCKED");
        unlocked = 0;
        _;
        unlocked = 1;
    }
    ...
    function initialize(
        ...
        require(msg.sender == factory, "Logistic AMM: FORBIDDEN"); // sufficient check
        token0 = _token0;
        token1 = _token1;
        // ownerAddress = _owner;
        treasury = _treasury;
    ...
    function mint(
        ...
        require(liquidity > 0, "Logistic AMM: INSUFFICIENT_LIQUIDITY_MINTED");
        _mint(to, liquidity);
    ...
    function burn(
        ...
        require(
            amount0 > 0 && amount1 > 0,
            "Logistic AMM: INSUFFICIENT_LIQUIDITY_BURNED"
        );
    ...
    function swap(
        ...
        require(
            ...
            "Logistic AMM: INSUFFICIENT_OUTPUT_AMOUNT"
        );
        (uint112 _reserve0, uint112 _reserve1, ) = getReserves(); // gas savings
        require(
            amount0Out < _reserve0 && amount1Out < _reserve1,
            "Logistic AMM: INSUFFICIENT_LIQUIDITY"
        );
        ...
        uint256 balance1;
        {
            ...
            require(to != token0 && to != token1, "Logistic AMM: INVALID_TO");
        ...
        require(
            ...
            "Logistic AMM: INSUFFICIENT_INPUT_AMOUNT"
        );
        {
