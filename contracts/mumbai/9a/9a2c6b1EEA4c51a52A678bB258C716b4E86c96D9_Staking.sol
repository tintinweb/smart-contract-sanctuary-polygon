...
contract Staking is AccessControl, ReentrancyGuard {
    ...
    function getReward() external nonReentrant paused {
        uint256 reward = userInfo[msg.sender].rewardDebt + earned(msg.sender);
    ...
    function earned(address _account) public view returns (uint256) {
        return
            userInfo[msg.sender].rewardDebt + ((((block.timestamp - userInfo[_account].since) / rewardsDuration) *
                userInfo[_account].amount) / rewards);
    }
