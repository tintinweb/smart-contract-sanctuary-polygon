...
contract GSCDapp is Contractable {
    ...
    uint256 private constant maxAddFreeze = 20;
    uint256 private constant referDepth = 20;
    uint256 private constant directDepth = 1;
    uint256 private constant uct = 2 minutes;
    ...
    uint256[7] private balDown = [10e21, 30e22, 100e22, 500e22, 1000e22,1500e22,2000e22];
    uint256[7] private balDownRate = [1000, 1500, 2000, 5000, 6000,7000,8000]; 
    uint256[7] private balRecover = [15e21, 50e22, 150e22, 500e22, 1000e22,1500e22, 2000e22];
