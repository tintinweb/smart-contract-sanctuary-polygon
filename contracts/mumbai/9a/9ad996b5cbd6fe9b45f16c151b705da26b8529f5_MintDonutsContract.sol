  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x2a9E9A8b08a4E0c1Ef7A09b2B0da4c72D47cdc0e);
    ...
    // File: contracts/mintDonutsContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract MintDonutsContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("mint donuts", "donut", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmZisTgdbGqtnkPwm9tdiAJxEcKkgZFUg4GZ2QrGNkgFvN/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/BBwldjKER9kQ5WYRt4gE/contract-metadata";
        }
    }