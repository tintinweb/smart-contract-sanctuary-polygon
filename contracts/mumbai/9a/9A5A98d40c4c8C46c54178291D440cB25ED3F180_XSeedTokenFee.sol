...
/**
 * @title XSeedTokenFee
 * @dev Implementation of the XSeedTokenFee
 */
contract XSeedTokenFee is ERC20Capped, ERC20Mintable, ERC20Burnable {
    string constant t_name = "MetaXSeed with Fee";
    string constant t_symbol = "XSEED Fee";
    ...
    uint public marketing_fee = 2000000;
    uint public transaction_fee_decimal = 8;
    address public marketingFeeWallet = address(0);
        ...
        payable
    {
        ...
        marketingFeeWallet = address(this);
    }
    ...
    /**
     * @dev Function to add address to _whiteList
     * @param white_address is valid wallet address
     */
    function addWhiteList(address white_address) public onlyOwner {
        _whiteList[white_address] = true;
    }

    /**
     * @dev Function to remove address from _whiteList
     * @param white_address is valid wallet address
     */
    function removeWhiteList(address white_address) public onlyOwner {
        _whiteList[white_address] = false;
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        if(sender == address(this) && recipient == pairAddress && _whiteList[sender]) {
            super.transferFrom(sender, recipient, amount);
            return true;
        }


        uint256 f_amount = calculateFee(amount, marketing_fee);
        uint256 r_amount = amount - f_amount;

        super.transferFrom(sender, recipient, r_amount);
        super.transferFrom(sender, marketingFeeWallet, r_amount);
        return true;
    }
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        ...
        super.transfer(marketingFeeWallet, r_amount);
        return true;
    }
