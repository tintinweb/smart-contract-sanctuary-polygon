...
/**
 * @title Defed ERC20 AToken
 * @dev Implementation of the interest bearing token for the Defed protocol
 * @author Defed
 */
contract AToken is VersionedInitializable, IncentivizedERC20, IAToken {
  ...
  constructor(
    ...
    address incentivesController,
    uint8 decimal
  ) public IncentivizedERC20(tokenName, tokenSymbol, decimal, incentivesController) {
    POOL = pool;
