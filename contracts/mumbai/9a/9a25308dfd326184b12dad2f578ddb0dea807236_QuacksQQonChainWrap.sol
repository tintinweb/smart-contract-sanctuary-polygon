...
contract QuacksQQonChainWrap is
  ERC721,
  IERC721Receiver,
  Pausable,
  Ownable,
  ...
  ReentrancyGuard
{
  ...
  constructor(address frostiesNFTContractAddress_)
    ERC721("Quacks Dao", "QQDAO")
  {
    frostiesNFT = iQuacksQQ_OG(frostiesNFTContractAddress_);
  }
  ...
  function unwrap(uint256[] calldata tokenIds_) external nonReentrant {
    for (uint256 i = 0; i < tokenIds_.length; i++) {
