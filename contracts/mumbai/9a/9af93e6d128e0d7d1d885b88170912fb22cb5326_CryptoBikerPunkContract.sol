...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xaAeAadD897e9d187A8fF55eD761cC7c398855edd];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmcspFHYTbTE7bnmn5AAEEpgRgHdRdaDFg1iKxStiHrpGX/";
...
// File: contracts/CryptoBikerPunkContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CryptoBikerPunkContract is RamppERC721A {
    constructor() RamppERC721A("Crypto Biker Punk", "CBP"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/jKo3EIz6nLLlNR7nRK8H/contract-metadata";
    }
}
