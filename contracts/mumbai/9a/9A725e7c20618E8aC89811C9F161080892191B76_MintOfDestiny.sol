...
contract MintOfDestiny is Pausable, ReentrancyGuard {
    ...
    */
    ...
    function addRole(string memory roleName, string memory baseURI, uint256 tokenLimit, bool allowPublicMint, uint256 price, uint256 priceERC20, uint256 priceWETH, string memory mandatoryRole, bool hasAttachedMint, string memory attachedMintRole) public onlyAdmins onlyHumans whenNotPaused {
