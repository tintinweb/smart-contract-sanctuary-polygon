...
contract ContractURIUpgradeableV1 is
    Initializable,
...
import "./extensions/ContractURIUpgradeableV1.sol";
import "@openzeppelin/contracts-upgradeable/proxy/utils/Initializable.sol";
...
contract KongregateERC721UpgradeableV1 is
    Initializable,
    PausableUpgradeable,
    ERC721Upgradeable,
    ...
    IKongregateERC721
{
    ...
    function initialize(
        ...
        string memory aBaseUri
    ) public virtual initializer {
        __KongregateERC721_init(
            name,
            symbol,
            contractUri,
            royaltyReceiver,
    ...
    function __KongregateERC721_init(
        string memory name,
        string memory symbol,
        string memory contractUri,
        address royaltyReceiver,
        ...
        __ContractURI_init(contractUri);
        __AccessControlEnumerable_init();

        __KongregateERC721_init_unchained(
            name,
            symbol,
            contractUri,
            royaltyReceiver,
    ...
    function __KongregateERC721_init_unchained(
        string memory,
        string memory,
        string memory,
        address royaltyReceiver,
    ...
    function _setBaseUri(string memory aBaseUri) internal {
        baseUri = aBaseUri;
    }

    /**
     * @dev See {ERC721RoyaltyUpgradeable-__beforeTokenTransfer}.
     */
    function _beforeTokenTransfer(
        address from,
        address to,
    ...
    /**
     * @dev See {ERC721RoyaltyUpgradeable-_burn}.
     */
    function _burn(
        uint256 tokenId
    ...
    /**
     * @dev Base URI for computing {ERC721Upgradeable-tokenURI}.
     */
