...
contract Level3 is ERC1155, Ownable{
    ...
    uint8 public constant LEVEL3 = 10;
    uint256[] IDS = [WHEEL,STEERING,GLASS,CHASIS,BREAK,DOOR,LIGHT,AC,CHAIR,MOTOR,LEVEL3];
            //-----GENERAL------
    ...
    constructor(address lgentry /* address _factoryAdd*/) ERC1155(""){
        /* factoryAdd = _factoryAdd; */
    ...
    function mint() public isAllowed{
        require(verifyMint(msg.sender), "User not able to mint");
        uint8 ID = tRandom();
        require(tokenID[ID] <= 1000);
    ...
    function burn() public isAllowed {
        require(balanceOf(msg.sender, LEVEL3) == 0,"Cannot have more than 1");
    ...
    function verifyMint(address user) public view isAllowed returns(bool){
   ...
   modifier isAllowed() {
    ERC1155 _PreviousLevels = ERC1155(entryAdd);
    require(_PreviousLevels.balanceOf(msg.sender, LEVEL1) > 0 , "Level3: Dont have Level1");
    require(_PreviousLevels.balanceOf(msg.sender, LEVEL2) > 0 , "Level3: Dont have Level2");
    _;
   }
