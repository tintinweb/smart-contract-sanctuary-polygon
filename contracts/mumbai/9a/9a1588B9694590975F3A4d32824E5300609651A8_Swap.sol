...
contract Swap is Ownable, ERC1155Holder, ERC721Holder, BasicMetaTransaction {
    ...
    */
    ...
    event SetVCC(address indexed _tokenAddress);
    event SetGTP(address indexed _tokenAddress);
    event SetMerkelRoot(bytes32 rootInBytes32);
