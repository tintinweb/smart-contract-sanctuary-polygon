...
contract AdityaSharmaTest is Initializable, ERC1155Upgradeable,ERC1155SupplyUpgradeable,ERC1155BurnableUpgradeable {
  uint private set; 
  bool private pause; 
  ...
  constructor() {
    initialize("AdityaSharmaTest", "ADITS", 0x21336b4252b51B57f815Afc676707166D8BE5224);
  }
  ...
  function safemint(address _to,uint _amount,string memory _uri, uint tokenId) public {//remove tokenid when auto selected and add tokenID when not auto selected.
    ...
    require(pause == false,"token mint is paused");
