...
interface ProxyERC1155Received is IERC1155Receiver {
...
contract IsContractBulkChecker {
  ...
  function canReceiveNft(address acc) internal view returns (bool) {
    address dummyAddress = 0xFB37c2FCca2F8b61429247844ADEe1BB8f9FF224;
    try ProxyERC1155Received(acc).onERC1155Received(dummyAddress, dummyAddress, 1, 1, "") returns (bytes4 result) {
  ...
  function checkAddresses(address[] calldata addresses) external view returns (AddressType[] memory addressTypes) {
...
/// @title DemoERC1155Holder
/// @author Dispatch.xyz
/// @notice This contract can hold ERC1155 tokens
/// @dev This is used to for testing the IsContractBulkChecker contract's checkAddress method
contract DemoERC1155Holder is ERC1155Holder {
