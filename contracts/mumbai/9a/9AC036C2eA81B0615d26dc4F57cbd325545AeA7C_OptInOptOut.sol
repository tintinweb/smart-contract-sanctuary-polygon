...
contract OptInOptOut{
    ...
    */
    ...
    function userDataTransferredDays(uint _packageId, string[] memory fields, usersData[] memory _bulkData) external {
        ...
        // packageFieldBasedUsersData[_packageId] = _bulkData;
        emit BulkDataTransfer(_packageId, true);
    }
    ...
    // function fieldBasedUsersData(uint _packageId) external view returns(usersData[] memory userFieldsData){
    //     return packageFieldBasedUsersData[_packageId];
    // }
