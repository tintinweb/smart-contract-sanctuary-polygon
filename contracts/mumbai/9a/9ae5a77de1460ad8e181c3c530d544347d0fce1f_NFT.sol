...
contract NFT is ERC721Enumerable, Ownable {
 ...
 function whitelistUser(address _user) public onlyOwner {
  ...
  function withdraw() public payable onlyOwner {
    // This will pay to followinf wallet 5% of the initial sale
    (bool hs, ) = payable(0xDB686c33dfd5C2846adA91E75A6a8843f8D1D1dA).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
    
    // This will payout the owner rest 95% of the contract balance.
