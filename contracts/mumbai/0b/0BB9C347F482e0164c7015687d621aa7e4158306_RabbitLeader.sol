...
contract RabbitLeader is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("RabbitLeader", "RL") {
        baseURI = "ipfs://bafybeib67o4eo3cqgx7x7zjbck2gbaxphsevqfnr3dxjohuerxg5wyjh6e/";
    }
    ...
    modifier mintPriceCompliance(uint256 mintQuantity) {
        require(mintQuantity > 0);
        require(msg.value > PRICE * mintQuantity, "Need to seed more Eth");
        _;
    }
