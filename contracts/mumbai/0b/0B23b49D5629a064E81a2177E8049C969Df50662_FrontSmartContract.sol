...
contract CollectionERC1155 is ERC1155Supply, Ownable {
    ...
    function mint(address to, uint256 amountOfItems) external payable {
        //require(msg.value >= amountOfItems * MAX_PER_USER);
        //require(msg.value >= amountOfItems * COST_PER_NFT);
        _mint(to, _tokenId, amountOfItems, "");
