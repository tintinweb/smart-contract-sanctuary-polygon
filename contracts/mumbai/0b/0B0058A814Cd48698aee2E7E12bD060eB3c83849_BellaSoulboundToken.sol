...
contract BellaSoulboundToken is ERC721, AccessControl {

    // ERR-1-BST		Cannot set uri twice
    ...
    constructor() ERC721("BELLA Soulbound Token", "BSLBT") {
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _grantRole(MINTER_ROLE, msg.sender);
    }

    function safeMint(address to, string memory uriMetadata) public onlyRole(MINTER_ROLE) {
