...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x0a1AFf9bb04ED51c60ea96cE8aF8e3Db62D2FA60];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmfKtRo1xCSPrJgKagKzavyVePDFzDazmGo41ThB7VasYZ/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 99");
        _safeMint(_to, 1);
    }
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 99");
...
// File: contracts/falseCourageContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract FalseCourageContract is RamppERC721A {
    constructor() RamppERC721A("False Courage ", "FLSC"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/CtPetIdevdmv5OUGisBc/contract-metadata";
    }
}