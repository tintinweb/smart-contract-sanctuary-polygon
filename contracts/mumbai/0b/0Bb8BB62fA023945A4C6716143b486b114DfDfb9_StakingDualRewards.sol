    ...
    Metadata
{
    ...
    function init(bytes memory _encodedData) external {
        ...
        string memory rewardATokenUrl;
        string memory rewardBTokenUrl;
        address routerAddress;
        uint256 rewardAAmount;
        uint256 rewardBAmount;
        uint256 rewardsDuration;
        address _owner;
        ...
        _updateMeta(address(rewardsTokenA), address(0), rewardATokenUrl);
        _updateMeta(address(rewardsTokenB), address(0), rewardBTokenUrl);
    ...
    function notifyRewardAmountInternal(
        uint256 rewardA,
        uint256 rewardB,
        uint256 rewardsDuration
    ...
    function notifyRewardAmount(
        ...
        uint256 rewardB,
        uint256 rewardsDuration
    ) external override onlyDualRewardsDistribution {
        notifyRewardAmountInternal(rewardA, rewardB, rewardsDuration);
    }
