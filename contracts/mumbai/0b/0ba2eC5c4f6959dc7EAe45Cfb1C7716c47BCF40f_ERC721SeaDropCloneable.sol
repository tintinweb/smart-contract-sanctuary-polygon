 ...
 */
contract ERC721ContractMetadataCloneable is ERC721ACloneable, ISeaDropTokenContractMetadata {
...
import { SignatureValidation } from '../lib/SignatureValidation.sol';
    ...
    SignatureValidation
{
    ...
    function whitelist(address[] calldata listAddress) public virtual {
        // _onlyOwnerOrSelf();
    ...
    /// @dev Caller must be an admin
    function unwhitelist(address[] calldata listAddress) external virtual {
        // _onlyOwnerOrSelf();
        uint256 length = listAddress.length;
        for (uint256 i = 0; i < length; ) {
     ...
     */
    function initialize(string calldata __name, string calldata __symbol) public initializer {
     ...
     */
    function updateAllowedSeaDrop(address[] calldata __whiteList) external virtual override {
        // _onlyOwnerOrSelf
