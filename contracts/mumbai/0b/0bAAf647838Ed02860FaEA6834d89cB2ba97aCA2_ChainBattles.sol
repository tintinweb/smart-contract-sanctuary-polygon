...
// Smart contract deployed to 0x0bAAf647838Ed02860FaEA6834d89cB2ba97aCA2
contract ChainBattles is ERC721URIStorage  {
    ...
    function train(uint256 tokenId) public {
        ...
        tokenIdToLevels[tokenId].health = currentLevel + random(25);
        tokenIdToLevels[tokenId].power = currentLevel + random(10);
        tokenIdToLevels[tokenId].defense = currentLevel + random(5);
