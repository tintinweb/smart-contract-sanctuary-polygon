...
contract NftProjectName {
    ...
    event Winner(address indexed winnerAddress, string indexed winnerProposal, uint8 indexed voteCount);
    ...
    function sendProposal(string memory _projectNameProposal, string memory _optionalProposalDescr) public payable {
        ...
        // Not allowed to send proposals when voting time open
        require(votingOpen == false, "The voting period is open, you cannot submit proposals");
    ...
    /**
     * @dev Reopen proposals
     */
    function reopenProposalPeriod() public {
        require(msg.sender == creator, "Only creator can open proposal period");
        votingOpen = false;
    }
    ...
    function voteProjectName(uint8 _proposalId) public {
        ...
        require(votingOpen == true, "The voting period is closed");
    ...
    function winningDecision() public payable {
        ...
        emit Winner(winnerAddress, winnerProposal, proposals[winningProposal].voteCount);
    }
