    ...
    */
    ...
    function _distributeWeekReward(string memory _type) private {
        ...
        if (_canDistribute) {
            ...
            weekRewardPerWeekList[_type][weekRewardIndex]._rewardAmount = _amount;
            weekRewardPerWeekList[_type][weekRewardIndex]._address = firstAddress;
        } else {
            //不分配是不是留到下一次或者截留
        }
        uint256 _gas1 = gasleft();
        ...
        weekRewardPerWeekList[_type][weekRewardIndex]._addressList = weekAddressList[_type];
        weekRewardPerWeekList[_type][weekRewardIndex]._dataList = weekDataList[_type];
        weekRewardPerWeekList[_type][weekRewardIndex]._dayList = weekDayList[_type];
        weekRewardPerWeekList[_type][weekRewardIndex]._remainingRewardAmount = weekReWardList[_type];
        weekRewardIndex += 1;
