...
import "./commons/ERC721Permit.sol";
import "./commons/ERC721Mintable.sol";

contract Genso is ERC721Mintable, ERC721Permit("GensoKishiTest") , Ownable, ERC721URIStorage{
    string public _defaultURI;
    event UpdateDefaultURI(string defaultURI);

    constructor() ERC721("GensoKishiTest", "Genso_NFT") {
