...
contract SOTNFT is Ownable, ERC721AQueryable {
    ...
    event MintNFT(address indexed who, address indexed inviter, uint256 indexed quantity);
    ...
    function freeMint(address _inviter) external {
        ...
        require(totalSupply() + 1 <= MAX_MINT, "Max mint");
    ...
    function mint(address _inviter, uint256 _quantity) external payable {
        ...
        _mint(who, _quantity);
        emit MintNFT(who, _inviter, _quantity);
    }
