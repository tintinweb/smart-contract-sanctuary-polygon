...
contract HotChilli is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("HotChilli", "HC") {
    setHiddenMetadataUri("ipfs://QmS6gyrDsDjVSNStR9nEYZFotTRZYDA3GPAwmKu7ks9qW8");
  }
