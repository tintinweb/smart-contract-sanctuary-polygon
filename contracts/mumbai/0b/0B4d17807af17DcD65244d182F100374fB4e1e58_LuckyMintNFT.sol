...
contract LuckyMintNFT is Initializable, ERC721Upgradeable, PausableUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function initialize() initializer public {
        __ERC721_init("Lucky Mint NFT", "LMNFT");
        __Pausable_init();
        __AccessControl_init();
        __UUPSUpgradeable_init();
        _grantRole(CTO, address(msg.sender));
