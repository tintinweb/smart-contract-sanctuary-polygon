...
contract StellarToken is IERC20 {
    ...
    function _transfer(address from, address to, uint256 value) private {
        ...
        bool isLiquidityTransfer = (from == address(this) && to == router);
    ...
    function createPair() external onlyDev {
        ...
        factoryAddress = uniswapFactory.createPair(address(this), MATIC_TOKEN);
    }
    ...
    function addLiquidity(uint256 amountStellarToken, uint256 amountMaticDesired) external onlyDev {
        ...
        // Check if the contract has sufficient allowance for StellarToken
        require(IERC20(address(this)).allowance(address(this), router) >= amountStellarToken, "Insufficient StellarToken allowance");
        ...
        // Check if the contract has sufficient allowance for MATIC
        require(IERC20(MATIC_TOKEN).allowance(address(this), router) >= amountMaticDesired, "Insufficient MATIC allowance");
