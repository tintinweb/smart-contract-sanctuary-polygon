...
contract MetaMiss is ERC721Enumerable, Ownable, Allowlist, SalesActivation {
    ...
    ERC721("MetamissTest", "MTM") Allowlist("MetamissTest","1",sign_address) 
    ...
    */
    function claimMiss(uint256[] memory tokenId) external {
        require(!claim_paused, "Claim is not started.");
    ...
    */
    function ownerMint(address _to,uint256 missNumber) external onlyOwner() {
        require( miss_index + missNumber < max_miss,      "Exceeds maximum Miss supply" );
    ...
    */
    function setTotalMiss(uint256 _totalMiss) public onlyOwner {
        max_miss = _totalMiss;
    }
    ...
    */
    ...
    /**
    * @dev Set Claim Pause (Callable by owner only)
    */
