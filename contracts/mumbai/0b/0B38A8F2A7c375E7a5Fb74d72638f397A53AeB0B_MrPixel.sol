...
contract MrPixel is ERC721Enumerable, Ownable {

    using Strings for uint256;

    string baseURI;
    string public baseExtension = ".json";
    //uint256 public cost = 2 ether; NOTE for production
    uint256 public cost = 0.1 ether;
    //uint256 public maxSupply = 10000; NOTE for production
    ...
    address t1 = 0xA6851a21ed317a44C49C2d9aaDA18c7d0aB8F592; //cygar
    address t2 = 0x0E124A7c9b378d7276590b6b8b676a75ff923a03; //xanthelasma
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        require(!paused, "Sale must be active to mint tokens");
        ...
        uint256 payAmount = cost * (_mintAmount - totalFree);
        if (msg.sender != owner()) {
    ...
    function setFreeMintList(
		address[] calldata addresses, uint256 numAllowedToFreeMint
	) external onlyOwner {
    ...
    function numAvailableToFreeMint(address addr) 
		external
		view
		returns (uint256) 
	{
