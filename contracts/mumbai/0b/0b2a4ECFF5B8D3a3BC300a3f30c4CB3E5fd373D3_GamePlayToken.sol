...
pragma solidity ^0.8.0;
 ...
 contract GamePlayToken is ERC20{
     ...
     mapping(address=>uint) private publicSaleRemainingAmount;
     ...
     function BuyStrategicSale() public payable{
         price = 23*10**15;
         uint tokenAmount = (msg.value*10**18/price)*10**18;
     ...
     function WithdrawTokens() public{
         tokenBalance[msg.sender] += unlockedBalance[msg.sender];
         this.transfer(msg.sender,tokenBalance[msg.sender]);
         if(publicSaleBalance[msg.sender]>0){
