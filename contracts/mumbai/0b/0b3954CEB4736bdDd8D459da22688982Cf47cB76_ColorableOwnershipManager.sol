    ...
    IColorableOwnershipManager
{
    ...
    bytes32 public constant OWNERSHIP_SETTER_ROLE =
        keccak256("OWNERSHIP_SETTER_ROLE");
    ...
    mapping(address => mapping(address => uint256)) public override balanceOf;
    ...
    ) external onlyRole(OWNERSHIP_SETTER_ROLE) {
    ...
    function resetOwnershipData(address collection, uint256 totalSupply)
        public
        onlyRole(OWNERSHIP_SETTER_ROLE)
    {
        // TODO: restrict only owner of the collection to execute method
