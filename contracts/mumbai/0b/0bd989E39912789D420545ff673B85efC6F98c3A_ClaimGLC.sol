...
contract ClaimGLC is IERC721Receiver  {
  ...
  mapping (uint256 => uint256) maturityTime;
  ...
  function transferNonAcceptedNFTs(address _tokenAddress, uint256 _tokenId, address _receiver) public  {
    require(isAllowed[msg.sender], "Not allowed");
    IERC721(_tokenAddress).safeTransferFrom(address(this), _receiver, _tokenId);
  }

  function setAcceptedTokns(address _acceptedTokenAddress) public {
    require(isAllowed[msg.sender], "Not allowed");
    acceptedTokenAddress = _acceptedTokenAddress;
  }
  ...
  function setMinAgeForClaim(uint256 _minAge) public {
    require(isAllowed[msg.sender], "Not allowed");
    minAgeForClaim = _minAge;
  }

  function whitelistAccount(address _account) public {
    require(isAllowed[msg.sender], "Not allowed");
