...
contract SampleNFT is ERC721URIStorage, Ownable {
    ...
    function mint(string memory _sampleNFT, uint256 _rarity) public {
        ...
        _setTokenURI(newTokenID, getTokenURI(newTokenID, _sampleNFT, _rarity));
    }

    function getTokenURI(
        uint256 tokenID,
        string memory _sampleNFT,
        uint256 _rarity
        ...
        bytes memory dataURI = abi.encodePacked(
            ...
            "\n",
            '"attributes": [\n { "trait_type": "Type", "value": "Avatar" }, \n { "display_type": "number", "trait_type": "Rarity", "value": ',
            _rarity.toString(),
            "} \n],\n",
            '"image": "',
            _sampleNFT,
    ...
    function updateRarity(
        ...
        _setTokenURI(_tokenId, getTokenURI(_tokenId, _imagelink, _newRarity));
    }
}