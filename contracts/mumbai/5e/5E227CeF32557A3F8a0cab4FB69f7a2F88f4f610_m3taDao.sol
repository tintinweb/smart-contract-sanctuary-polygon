    ...
    Ownable
{
    ...
    mapping(address => string) private profileDID;
    mapping(address => string) private profileGroupID;
...
// 0xD504d012D78B81fA27288628f3fC89B0e2f56e24
    ...
    function indexProfile(string memory profiledid , string memory groupID ) public {
        ...
        require(profileExists[msg.sender] == false);
        profileDID[msg.sender] = profiledid;
        profileGroupID[msg.sender] = groupID;        
        ...
        public  
    {
        ...
        accountsGroupID.push(groupID);
        // valistMapping[accountID] = account;
        string memory accountHex = Strings.toHexString(accountID);
        m3tadaoOrganizations.push(accountHex);
        ValistID.increment();
    ...
    function getM3tadaoUserIDs(address user) public view returns (string memory did, string memory groupid){
        return (profileDID[user], profileGroupID[user]);
    }
    ...
    function getM3tadaoOrgIDs() public view returns(string[] memory accountHexs , string[] memory groupids){
        return (m3tadaoOrganizations , accountsGroupID);
    } 
