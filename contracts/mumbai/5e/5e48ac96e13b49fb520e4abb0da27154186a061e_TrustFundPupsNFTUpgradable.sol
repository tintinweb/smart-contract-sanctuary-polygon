...
contract TrustFundPupsNFTUpgradable is
    Initializable,
    ...
    ERC721EnumerableUpgradeable
{
    ...
    // royalty percentage cut of creator
    ...
    function initialize() public initializer {
        __ERC721_init("TrustFundPups", "TFP");
    ...
    {
        royaltyAmount = (creatorRoyalty * _salePrice) / INVERSE_BASIS_POINTS;
