...
contract NFTMarketplace is  Initializable, UUPSUpgradeable, ReentrancyGuardUpgradeable{
    ...
    function createMarketResell(address nftContract, uint256 itemId, uint256 price) public payable nonReentrant {
      require(idToMarketItem[itemId].owner == msg.sender, "NFT not yours");
      require(idToMarketItem[itemId].sold = true, "NFT already listed");
      ...
      idToMarketItem[itemId] =  MarketItem(itemId,nftContract, _tokenID, payable(msg.sender), payable(address(this)), price, false);
    ...
    function cancelSale(address nftContract, uint256 itemId) public nonReentrant {
      require(idToMarketItem[itemId].seller == msg.sender, "NFT not yours");
      uint256 _tokenID = idToMarketItem[itemId].tokenId;
