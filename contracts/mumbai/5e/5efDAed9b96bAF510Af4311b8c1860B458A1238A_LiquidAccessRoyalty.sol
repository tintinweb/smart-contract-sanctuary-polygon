...
contract LiquidAccessRoyalty is
  Context,
  ERC165,
  ERC2981,
  AccessControl,
  ...
  Ownable
{
  ...
  function supportsInterface(bytes4 interfaceId)
    ...
    view
    virtual
    override(ERC165, IERC165, AccessControl, ERC2981)
    returns (bool)
  {
    return
  ...
  function safeMint(
    address to,
    string memory uri,
    string memory date_expiration,
    string memory type_subscription
  ) public onlyOwner {
  ...
  function tokenAuthor(uint256 tokenId) private view returns (address) {
          ...
          Base64.encode(
            bytes(
              abi.encodePacked(
                ...
                '"attributes": [',
                '{"typeSubscription": "',
                typeSubscription(tokenId),
                '", "dateExpiration": "',
                dateExpiration(tokenId),
                '"}',
                ']'
                '}'
              )
  ...
  function _transfer(
    ...
    require(
      LiquidAccessRoyalty.ownerOf(tokenId) == from,
  ...
  function approve(address to, uint256 tokenId) public virtual override {
    address owner = LiquidAccessRoyalty.ownerOf(tokenId);
  ...
  function _approve(address to, uint256 tokenId) internal virtual {
    ...
    emit Approval(LiquidAccessRoyalty.ownerOf(tokenId), to, tokenId);
  }
  ...
  function dateExpiration(uint256 tokenId)
    public
    view
    virtual
    returns (string memory)
  ...
  function typeSubscription(uint256 tokenId)
    public
    view
    virtual
    returns (string memory)
