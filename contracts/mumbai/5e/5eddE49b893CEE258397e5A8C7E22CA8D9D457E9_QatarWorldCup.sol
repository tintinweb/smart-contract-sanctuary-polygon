...
contract QatarWorldCup is ERC721Enumerable, Ownable {
    ...
    uint256 public  mintPrice = 500000000000000000; //0.5 ETH

    // mappings token to metadata URI
    mapping(uint256 => string) private _tokenURIs;

    //mappings tokenId to to rank (tokenId -> _teams -> _rank)Gold: 1, Silver: 2, Bronze: 3
    mapping(uint256 => mapping(uint256 => uint256)) _rank;
    ...
    //mappings teamAmount to tokenId
    mapping(uint256 => uint256) private _amountNFTByTeams;
    ...
    uint256 public rateAirdrop = 7000;

    //rate of transfer fund to operation fund
    uint256 public rateOperation = 3000;
