...
contract PridePixies is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
  ...
  uint256 public  PRICE = 117 ether;

  uint256 private constant TotalCollectionSize_ = 10557; // total number of nfts

  bool public _revelNFT = false;
  string private _baseTokenURI;
  uint private stopat = 1000;
  uint private reserve = 557;

  uint public status = 0; //0-pause 1-whitelist 2-public

  constructor() ERC721A("Pride Pixies","Pride Pixies NFT") {
