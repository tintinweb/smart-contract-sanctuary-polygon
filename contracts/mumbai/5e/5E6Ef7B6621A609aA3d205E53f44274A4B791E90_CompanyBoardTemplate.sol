...
contract CompanyBoardTemplate is BaseTemplate {
    ...
    */
        ...
        external
    {
        ...
        string memory boardTokenName = string(abi.encodePacked(_companyName, " Company Token"));
        string memory boardTokenSymbol = string(abi.encodePacked(_companySymbol, "CT"));
        string memory shareTokenName = string(abi.encodePacked(_companyName, " Executive Token"));
        string memory shareTokenSymbol = string(abi.encodePacked(_companySymbol, "ET"));
