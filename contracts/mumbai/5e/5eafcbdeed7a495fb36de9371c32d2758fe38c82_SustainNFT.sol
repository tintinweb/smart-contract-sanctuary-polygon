...
//    function mintNFT( uint tokenTypes) public  returns (bytes32){
    function mintNFT( uint tokenTypes, bool takeMoney,address _user) internal  returns (bytes32){
        ...
        requestToUserMap[data] = _user;
        return data;
    }

    function setAllocation(uint[] memory _tokenIdToTokenAllocation,uint extendAllocation) public onlyOwner{
        tokenIdToTokenAllocation=_tokenIdToTokenAllocation;
        extendRandom=extendAllocation;
    }
    ...
    function getTokenNumber(uint tokenTier, uint _randomNumber) internal view returns (uint) {
        ...
        randomNumber = (randomNumber % extendRandom) + tokenIdToTokenAllocation[tokenTier];
