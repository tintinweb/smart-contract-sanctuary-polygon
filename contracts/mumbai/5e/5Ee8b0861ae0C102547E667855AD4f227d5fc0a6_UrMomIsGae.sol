 ...
 * @notice This contract handles minting ur mom is gae tokens.
 */
contract UrMomIsGae is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x9E022490914d230A23B214E60f95A736511383f1;
    ...
    string public name = "ur mom is gae";
    string public symbol = "URMOM";
    ...
    constructor()
        ERC1155(
            "ipfs://bafybeiddjjhe5zbentfcthrq4rnw2oql5n4x25xru25koujub5zgqhyr6q/{id}"
        )
        RevokableOperatorFilterer(
