...
abstract contract Ownable is Context {
	 ...
	 */
	constructor() {
		_setOwner(0x9b71b1CC8Cee2ef3efd7D9d620dE598d3e8dD313);
	}
...
contract Jtyrsj is ERC721Enumerable, Ownable, ReentrancyGuard {

	uint256 public TOKEN_MAX_AMOUNT = 4754;
	uint256 public TOKEN_PER_TX = 475;
	uint256 public TOKEN_PER_WALLET = 950;
	uint256 public PRICE = 65 ether;
	uint256 public constant TIME_FOR_GROWN = 1687269962000;
	address public founder = 0x9b71b1CC8Cee2ef3efd7D9d620dE598d3e8dD313;
	...
	string private _name = "jtyrsj";
	string private _symbol = "ZJT";
