...
contract AirdropPool is Ownable {
    ...
    // balance of Airdrop at begin Claim
    uint256 public balanceOfAirdropPool;
    ...
    function getAmountSharePerTeam(uint256 _team) public view returns(uint256){
        unchecked { return(balanceOfAirdropPool * rateShareByTeam[_team])/denominator; }
    }
    ...
    */
    ...
    function setBalanceAirdrop() public onlyOwner {
        balanceOfAirdropPool = address(this).balance;
    }
