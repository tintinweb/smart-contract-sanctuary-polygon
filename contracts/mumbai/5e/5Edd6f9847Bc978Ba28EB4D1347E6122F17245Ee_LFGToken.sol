...
Tranasaction limited to 1 000 000 000 LFG
Thanks to Neo and Angel for the help in preparing and testing the LFG contract
*/
...
contract LFGToken is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "LFG";
  string constant tokenSymbol = "LFG";
