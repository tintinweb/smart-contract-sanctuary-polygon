...
contract Lottery is VRFConsumerBase {
  ...
  struct LotteryHistory {
    uint256 lotteryId;
    uint256 dateCreatedAt;
    address payable winner;
  }

  mapping(uint256 => LotteryHistory) public lotteryHistoryMap;
  ...
  function payWinner() public onlyOwner {
    ...
    lotteryHistoryMap[lotteryId].lotteryId = lotteryId;
    lotteryHistoryMap[lotteryId].dateCreatedAt = block.timestamp;
    lotteryHistoryMap[lotteryId].winner = players[index];
