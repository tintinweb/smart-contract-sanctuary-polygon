...
//Todo condition for removeallErc20 tokens;
...
contract Pool is Initializable, BasicMetaTransaction, Ownable, AccessControl {
    ...
    function transferStakedAmount(
        ...
        console.log("sdfdsdf", stakedAmount[_user][_loanId]);
        token.safeTransfer(_bank, stakedAmount[_user][_loanId]);
    ...
    function unstake(address _borrower, uint256 _loanId) public bankPoolStatus {
        ...
        token.safeTransfer(_borrower, amount + amountStaked);
    ...
    //     IERC20(_tokenAddress).safeTransfer(factory.adminWallet(), balance);
