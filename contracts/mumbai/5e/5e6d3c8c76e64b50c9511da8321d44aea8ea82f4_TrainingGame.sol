...
import "./TrainingGame1155Receiver.sol";
import "./TrainingGameArmor.sol";
import "./TrainingGameRewards.sol";

contract TrainingGame is Initializable, TrainingGame721Receiver, TrainingGame1155Receiver, TrainingGameRewards, TrainingGameArmor {
...
abstract contract TrainingGame1155Receiver is IERC1155Receiver {
...
abstract contract TrainingGameRewards is Initializable, TrainingGameContracts {
    ...
    function getRewardList() public view returns(uint256[] memory) {
        return rewardIds.values();
    }
}
...
interface IWorldReadOnly {
    ...
    // dragon in world of owner
    function dragonToWorldOfOwner(Location _location, address _owner) external view returns(uint256[] memory);

    // wizard in world of owner
    function wizardToWorldOfOwner(Location _location, address _owner) external view returns(uint256[] memory);
}
