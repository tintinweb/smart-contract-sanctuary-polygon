...
contract TWICOIN is ITWICOIN, VERIFY, TIP{
  ...
  // ---------------------------------------------  //
    ...
    function getLinkTokenAllowance() view public returns(uint256){
        return IERC20(linkToken).allowance(_msgSender(),address(this));
    }
    ...
    modifier _verifyApprove(){
        ...
        require(getLinkTokenAllowance() >= defaultFee,"207");
     ...
     * override function
     */
    function fillBackVerifyRes(bytes32 requestId_, bool verifyResult_) override internal {
...
abstract contract VERIFY is Context, ChainlinkClient, ConfirmedOwner {
    ...
    {
        return fillBackVerifyRes(_requestId,verifyResult_);
    }

    /**
     * fillBackVerifyRes
     */
    function fillBackVerifyRes(bytes32 _requestId, bool verifyResult_) virtual internal;
