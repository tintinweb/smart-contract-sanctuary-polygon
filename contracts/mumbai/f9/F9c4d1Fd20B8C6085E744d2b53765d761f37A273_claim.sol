...
contract claim {
    ...
    function payFees(uint256 tokenId) public payable {
        uint256 multiplier = 25;
        value = multiplier.mul(Fees);
    ...
    function transfer(address collectionAddress, uint256 tokenId) public {
        require(payer[msg.sender] == tokenId,"Fees not paid for this token");
