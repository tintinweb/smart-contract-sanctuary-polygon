...
contract NFT is ERC721URIStorage, EIP712, AccessControl {
    ...
    function mint(string memory _tokenURI, address marketplace) external {
        require(hasRole(MINTER_ROLE, msg.sender), "0x0");
        tokenId++;
    ...
    function transferNftBunch(address _to, uint256[] memory _tokenIDs) public {
        require(_tokenIDs.length <= 150, "0x02");
