    ...
    ERC2771Context
{
        ...
        private
    {
        ...
        if(gameData[_gameId].state == GameState.GETTING_VRF_1){
            gameData[_gameId].randomNumbers[0] = requestId;
        }
        else if(gameData[_gameId].state == GameState.GETTING_VRF_2){
            gameData[_gameId].randomNumbers[1] = requestId;
        }
    }
        ...
        for (
            ...
            swapCardPositions(
                ...
                reduceRandomNumberInRange(
                    ...
                    i,
                    gameData[_gameId].deck.length - 1
                )
            );
            unchecked {
                i++;
...
contract TreasuryManager {
    ...
    function playerDeposit(address _player, uint256 _amount) public {
