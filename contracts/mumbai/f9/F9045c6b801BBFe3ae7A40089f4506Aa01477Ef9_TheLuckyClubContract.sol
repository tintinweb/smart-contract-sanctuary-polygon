...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1671799800;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x6b902274df62E78239df34BE5529c0Aa7c558A4c];
  address public erc20Payable = 0x6b902274df62E78239df34BE5529c0Aa7c558A4c;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeihgz7mt37rcotrgjsrb3s3ditx54qyb5lbum4bgqbxsditlms752a/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/3pS2S0MTu7UNYw6EzsHf/contract-metadata";
  }
...
// File: contracts/TheLuckyClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheLuckyClubContract is RamppERC721A {
    constructor() RamppERC721A("The Lucky Club", "TLC"){}
}
