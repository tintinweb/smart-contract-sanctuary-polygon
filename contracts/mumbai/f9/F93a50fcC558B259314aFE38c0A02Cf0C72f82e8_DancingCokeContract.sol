...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x410Ce53c75310DDd1B740De09a4505770aC7bDA7];
  address public erc20Payable = 0x410Ce53c75310DDd1B740De09a4505770aC7bDA7;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2012, 2012) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmR21vyPf747pepMbfdvQq8C7W3BAmAvjukzzFCaBeHS58/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/0rt20A6lJJZt6OLMlfno/contract-metadata";
  }
...
// File: contracts/DancingCokeContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DancingCokeContract is ERC721APlus {
    constructor() ERC721APlus("DancingCoke", "DCK"){}
}
