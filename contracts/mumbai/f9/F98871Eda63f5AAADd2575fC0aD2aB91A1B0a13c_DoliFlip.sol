...
//Deployed and verified at 0xF98871Eda63f5AAADd2575fC0aD2aB91A1B0a13c
...
contract DoliFlip is Ownable{
    ...
    function play() external payable{
        ...
        require(msg.sender.balance > msg.value, "sorry, you don't have enough coins to bet, try to lower it");

        uint8 randomNumber = getRandomNumber(1, 10);

        if (randomNumber < 50000){
            //won
            transferPrize(msg.value, payable(msg.sender));
        } else {
            //lost
    ...
    function transferPrize(uint _amountWon, address payable _address) public payable {
    ...
    function transferLiquidityToContract() external payable {
