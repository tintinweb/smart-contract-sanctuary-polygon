...
pragma solidity ^0.8.0;
contract StreamFi_v1 is ERC1155Supply, Ownable, Pausable {
    string public name;
    ...
    function createToken(uint256 _startTime, uint256 _endTime, uint256 _maxSupply, uint256 _tokenPrice, uint256 _totalGems) external {
        ...
        _createToken(_startTime, _endTime, _maxSupply, _tokenPrice, _totalGems);
    }

    function _createToken(uint256 _startTime, uint256 _endTime, uint256 _maxSupply, uint256 _tokenPrice, uint256 _totalGems) internal whenNotPaused {
        CURRENT_TOKEN++;
        ...
        if(_totalGems > 0){
            ...
            STREAMFI_GEM[CURRENT_TOKEN] = CURRENT_TOKEN++;
        }
    }
