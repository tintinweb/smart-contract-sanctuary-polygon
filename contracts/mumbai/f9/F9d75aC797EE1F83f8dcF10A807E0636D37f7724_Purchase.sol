...
contract Purchase {
    ...
    function buyCourse(uint $USDC, address contentCreator, int96 flowRate,  bool isNewStream) public {
        ...
        if(isNewStream) {
            ...
            cfaV1.updateFlow(contentCreator, ISuperToken(0x42bb40bF79730451B11f6De1CbA222F17b87Afd7), flowRate);
        }
