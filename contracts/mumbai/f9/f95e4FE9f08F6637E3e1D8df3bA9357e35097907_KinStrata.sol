    ...
    DropSinglePhase
{
    ...
    modifier onlyOwner() override(ERC721A, Ownable) {
    ...
    function getTokenBaseURI() public override view returns (string memory) {
    // Function logic
    }
...
contract ERC721A is Context, ERC165, IERC721A {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        string memory baseURI = getTokenBaseURI();
    ...
    function getTokenBaseURI() public view virtual returns (string memory) {
    // Function logic
    }
