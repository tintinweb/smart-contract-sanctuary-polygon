...
contract ERC721LuxyFactory is Ownable {
    ...
    CountersUpgradeable.Counter private _creationIds;
    ...
    function createToken(
        ...
        uint256 creationId = _creationIds.current();
    ...
    function createToken(
        ...
        ERC721LuxyPrivate token = ERC721LuxyPrivate(luxy721Token);
        token.__ERC721LuxyPrivate_init(_name, _symbol, baseURI, _minters);
        token.transferOwnership(_msgSender());
        _creationIds.increment();
        emit Create721LuxyContract(luxy721Token);
    }
    ...
    function deployProxy(bytes memory data, uint256 creationId)
        internal
    ...
    RoyaltiesV1Luxy
{
    ...
    function __ERC721LuxyPrivate_init(
        ...
        __ERC721_init_unchained(name_, symbol_);
        __RoyaltiesV1Luxy_init_unchained();
        __ERC721LuxyPrivate_init_unchained(minters_);
        __ERC721Enumerable_init_unchained();
        __Ownable_init_unchained();
        _setBaseURI(baseURI_);
    }

    function __ERC721LuxyPrivate_init_unchained(address[] memory minters)
        internal
        initializer
    {
    ...
    function mint(
        ...
        require(_isApprovedMinterorOwner(_msgSender()));
        uint256 itemId = _tokenIds.current();
        _safeMint(_recipient, itemId);
        _setTokenURI(itemId, _metadata);
        _setRoyalties(itemId, _royalties);
