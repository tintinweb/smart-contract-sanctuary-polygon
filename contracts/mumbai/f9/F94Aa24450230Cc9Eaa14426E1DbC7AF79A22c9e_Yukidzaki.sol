...
contract Yukidzaki is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize(uint256 _mintPriceValue, uint256 _mintPriceOffset) initializer public {
        ...
        mintPriceValue = _mintPriceValue;
        mintPriceOffset = _mintPriceOffset;
    }

    uint256 private mintPriceOffset;
    uint256 private mintPriceValue;
    ...
    function editePrice(
        uint _mintPriceOffset, 
        uint _mintPriceValue
    ) external onlyOwner{
        mintPriceOffset = _mintPriceOffset;
        mintPriceValue = _mintPriceValue;
    }
    ...
    function editeMintWindows(
     ...
     function mint() public payable {
        require(msg.value == mintPriceValue / 10 ** mintPriceOffset, "Incorrect mint price");
