...
contract StellarTokenNFT is ERC721URIStorage {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        parts[0] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 840 500">';
        ...
        parts[2] = ".base { font-family: 'Press Start 2P', serif; font-size: 10px;} </style></defs>";

        parts[3] = string(abi.encodePacked('<image href="', levelImages[tokenIdToMetadata[tokenId].level-1], '" height="840" width="500" />'));
