...
/**
 * @notice Contract that is needed to connect royalties to our exchange Contracts
 */
    ...
    ReentrancyGuardUpgradeable
{
        ...
        nonReentrant
    {
     ...
     /**
     * @dev setRoyaltiesByToken allow to set royalties to ERC721 
     */
        ...
        nonReentrant
    {
     ...
     /**
     * @dev setRoyaltiesByTokenAndTokenId allow to set royalties to ERC1155
     */
