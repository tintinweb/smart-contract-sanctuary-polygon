...
contract Longlong is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
    uint256 public MAX_SUPPLY = 13;

    
    uint256 public TEST_SUPPLY = 12;
    ...
    uint256 public TEST_WALLET_LIMIT = 2;

    
    uint256 public TEST_PRICE = 0.001 ether;
    ...
    string private preRevealURI = "https://ipfs.w3bmint.xyz/ipfs/QmPZ9MpvLWBXKU597Bd8ojWubxceuxEYYaYtGE7mEJ8pE6";
    ...
    constructor() ERC721A("Longlong", "LLLL") {
    ...
    function TESTMint(address to, uint256 numberOfTokens) external isSecured(TEST_PRICE * numberOfTokens) payable {
