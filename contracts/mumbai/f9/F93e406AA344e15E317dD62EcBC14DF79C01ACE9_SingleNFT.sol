...
contract SingleNFT is Initializable, ERC2771ContextUpgradeable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, ERC721BurnableUpgradeable, AccessControlUpgradeable, RoyaltyUpgradeable, UUPSUpgradeable {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant UPGRADER_ROLE = keccak256("UPGRADER_ROLE");
    bytes32 public constant EXCHANGE_ROLE = keccak256("EXCHANGE_ROLE");

    function initialize(address forwarder, address exchnage) initializer public {
        __ERC721_init("SingleNFT", "NFT");
    ...
    // migration
    function batchTransfer(uint256[] calldata tokenIds, address to) public returns (bool) {
...
abstract contract RoyaltyUpgradeable is Initializable, ERC2981Upgradeable {
    function __RoyaltyUpgradeable_init() internal onlyInitializing {
    }

    function __RoyaltyUpgradeable_init_unchained() internal onlyInitializing {
    }
    /**
...
abstract contract ERC2771ContextUpgradeable is Initializable, ContextUpgradeable {
    ...
    function __ERC2771ContextUpgradeable_init_unchained(address trustedForwarder) internal onlyInitializing {
        _trustedForwarder = trustedForwarder;
    }
