...
contract Trade {
    ...
    function assetTransfer(address to, address nftAddress, BuyingAssetType nftType, uint256 tokenId, uint256 supply) public onlyOwner returns(bool) {
