...
contract limitOrderAndNormalSwapToken_NormalOrder is OpsTaskCreator, Ownable {
    ...
    function createNormalTask(tccItem[] calldata _tccList, uint256 _ethAmount, uint256 _usdtAmount) external payable {
        for (uint256 i = 0; i < _tccList.length; i++) {
            ...
            require(checkTcc(_tcc._swapRouter, _tcc._swapRouter2), "g00");
            require(_tcc._type == orderType.USDTOrder, "g01");
            ...
            if (_tcc._interval <= 20) {
                execData = abi.encodeCall(this.swapToken, (msg.sender, md5));
    ...
    function swapToken(address _user, bytes32 _md5) external {
        ...
        require(y.tcc._type == orderType.USDTOrder, "g14");
        ...
        if (x.swapInAmount == 0) {
            ...
            require(userInfoList[_user].usdtAmount >= x._feeItem.allFee, "g19");
