...
/// @dev Mintable. Burnable. Snapshot. Access control. Taxable. Releasable.
...
contract GaiaTest is ReentrancyGuard, ERC20, ERC20Burnable, ERC20Snapshot, IERC721Receiver, IERC1155Receiver, AccessControl, Pausable, Taxable, Releasable {
    ...
    constructor(
        ...
        Releasable(__disallowed, __mutable)
        payable
    {
