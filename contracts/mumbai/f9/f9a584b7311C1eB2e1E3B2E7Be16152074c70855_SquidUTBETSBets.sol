...
contract SquidUTBETSBets is SquidBetsCore {
    ...
    function withdrawAllFundWhenEmergency() public override onlyAdmin {
        ultibetsToken.transfer(ultibetsTreasury, ultibetsToken.balanceOf(address(this)));
    }
...
contract SquidBetsCore is ISBCNFTType, CustomAdmin {
    ...
    event RoundUpdated(uint256 eventID, uint8 roundLevel, string description, uint256 startTime);
