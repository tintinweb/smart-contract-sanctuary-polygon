...
// File contracts/CollectionList.sol
...
contract CollectionList is ICollectionList, AccessControlEnumerableUpgradeable, PausableUpgradeable {
  ...
  mapping (uint => Collection) private _collectionIdCollection;
  EnumerableSet.UintSet private _collectionIds;

  /// @dev For fast withdraw by depositor. 
  mapping(uint=>mapping(address=>uint)) private _collectionIdDepositorAmount;

  /// @dev For returning deposits when collection is removed.  
  mapping(uint=>DepositRecord[]) private _collectionIdDepositRecords;
  
  modifier withValidCollectionId(uint collectionId) {
  ...
  function addCollection(
    ...
    uint id = _collectionIdCounter.current();
  ...
  function toggleDepositAccepting(uint collectionId) 
  ...
  function getDepositRecordCount(uint collectionId) 
  ...
  function releaseDeposits(uint collectionId, uint count) 
    withValidCollectionId(collectionId) onlyRole(PAUSER_ROLE)
    external override
  {
    require(
  ...
  function removeCollection(uint collectionId) 
    withValidCollectionId(collectionId) onlyRole(PAUSER_ROLE)
    external override  
  {
  ...
  function setLock(uint collectionId) 
    withValidCollectionId(collectionId) onlyRole(PAUSER_ROLE)
    external override  
  {
  ...
  function setName(uint collectionId, string memory name) 
    withValidCollectionId(collectionId) onlyRole(PAUSER_ROLE)
    external override  
  {
  ...
  function setChainId(uint collectionId, uint chainId) 
    withValidCollectionId(collectionId) onlyRole(PAUSER_ROLE)
    external override  
  {
  ...
  function setToken(uint collectionId, address token)
    withValidCollectionId(collectionId) onlyRole(PAUSER_ROLE)
    external override  
  {
  ...
  function setAccessThresholdInCollectionTokens(uint collectionId, uint accessThresholdInCollectionTokens)
    withValidCollectionId(collectionId) onlyRole(PAUSER_ROLE)
    external override  
  {
  ...
  function setActivityThresholdInSNK(uint collectionId, uint activityThresholdInSNK)
    withValidCollectionId(collectionId) onlyRole(PAUSER_ROLE) 
    external override  
  {
  ...
  function setRevshareRecipient(uint collectionId, address payable revshareRecipient) 
    withValidCollectionId(collectionId) onlyRole(PAUSER_ROLE)
    external override  
  {
  ...
  function setRevshareInPercents(uint collectionId, uint revshareInPercents)
    withValidCollectionId(collectionId) onlyRole(PAUSER_ROLE)
    external override 
  {
  ...
  function setLockPeriodInSeconds(uint collectionId, uint lockPeriodInSeconds) 
    withValidCollectionId(collectionId) onlyRole(PAUSER_ROLE)
    external override  
  {
  ...
  function depositSNK(uint collectionId, uint amount) 
  ...
  function withdrawSNK(uint collectionId) 
    withValidCollectionId(collectionId) whenNotPaused() 
    external override  
  {
    Collection storage collection = _collectionIdCollection[collectionId];
  ...
  function isActive(uint collectionId) withValidCollectionId(collectionId)
    external override view returns(bool)   
  {
    return _collectionIdCollection[collectionId].active;
  }

  function getRevshareRecipient(uint collectionId) withValidCollectionId(collectionId) 
    external override view returns(address payable) 
  {
    return _collectionIdCollection[collectionId].revshareRecipient;
  }

  function getRevshareInPercents(uint collectionId) withValidCollectionId(collectionId) 
