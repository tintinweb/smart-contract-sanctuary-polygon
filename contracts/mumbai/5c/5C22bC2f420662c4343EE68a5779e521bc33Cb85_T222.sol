...
contract T222 is Ownable, TimeForDay, SortList {
    ...
    function claimStaticReward() external {
        ...
        updateRewardItem(_user, _pendingReward);
    ...
    function updateRewardItem(address _user, uint256 _pendingReward) private {
