...
/*
        if (_type_id == 0) {
            attack = 145 + randomResult % 5;
            defense = 45 + randomResult % 5;
            hp = 95 + randomResult % 5;
            duration = weapon.prop_sum - attack - defense - hp;
            if (duration>=100) {
                uint diff = duration - 99;
                duration = 99; 
                attack += diff;
            }

        } else if (_type_id == 1) {
            hp = 145 + randomResult % 5;
            duration = 45 + randomResult % 5;
            attack = 95 + randomResult % 5;
            defense = weapon.prop_sum - attack - duration - hp;
            if (defense>=100) {
                uint diff = defense - 99;
                defense = 99; 
                hp += diff;
            }
        } else if (_type_id == 2) {
            hp = 98 + randomResult % 2;
            duration = 98 + randomResult % 2;
            attack = 98 + randomResult % 2;
            defense = weapon.prop_sum - attack - duration - hp;
        } else if (_type_id == 3) {
            attack = 150 + randomResult % 5;
            defense = 50 + randomResult % 5;
            hp = 100 + randomResult % 5;
            duration = weapon.prop_sum - attack - defense - hp;
            if (duration>=100) {
                uint diff = duration - 99;
                duration = 99; 
            ...
            hp = 150 + randomResult % 5;
            duration = 50 + randomResult % 5;
            attack = 100 + randomResult % 5;
            defense = weapon.prop_sum - attack - duration - hp;
            if (defense>=100) {
                uint diff = defense - 99;
                defense = 99; 
            ...
            hp = 105 + randomResult % 2;
            duration = 105 + randomResult % 2;
            defense = 105 + randomResult % 2;
            attack = weapon.prop_sum - defense - duration - hp;
        }
        
         potential = 1 + randomResult % 5; //潜力1-5
