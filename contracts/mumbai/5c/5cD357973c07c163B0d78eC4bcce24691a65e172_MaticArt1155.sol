...
contract MaticArt1155 is ERC1155Royalty  {
    ...
    constructor (string memory name_, string memory symbol_, string memory tokenURIPrefix) ERC1155 (name_){
        tokenCounter = 1;
        _name = name_;
        _symbol = symbol_;
        owner = msg.sender;
    ...
    function mint(string memory uri, uint256 supply, uint96 feeNumerator, Sign memory sign)  public {
        uint256 newItemId = tokenCounter;
        verifySign(uri, msg.sender, sign);
        _mint(msg.sender, newItemId, supply, bytes(uri));
