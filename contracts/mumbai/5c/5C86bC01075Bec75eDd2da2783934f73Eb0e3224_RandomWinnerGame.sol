...
contract RandomWinnerGame is VRFConsumerBase, Ownable {
    ...
    // @param vrfKeyHash - ID of the public key against which randomness is generated
    ...
    // Starts the game by setting appropriate values for all the variables
    function startGame(uint8 _maxPlayers, uint256 _entryFee) public onlyOwner {
        // Check if there is a game already running
        require(!gameStarted, "Game is currently running");
        // Empty the players array
        delete players;
        // Set the maximum players for this game
        maxPlayers = _maxPlayers;
        // Set the entry fee for this game
        entryFee = _entryFee;
    ...
    function joinGame() public payable {
        ...
        // Check if there still is space left in the game to add another player
    ...
    // @param requestId - this ID is unique for the request sent to VRFCoordinator
    // @param randomness - this is a random uint256 generated and returned to us by VRFCoordinator
