...
contract Contract is ERC721Drop {
  ...
  modifier onlyOwners() {
    require(owners[_msgSender()], 'Unauthorised user');
    _;
  }
  ...
  function mint() public {
    // require(!holders[_msgSender()], "Address already holding NFT");
  ...
  function airdropNFT(address _reciever) public payable {
  ...
  function burn(uint256 _tokenId) public override onlyOwners {
    _burn(_tokenId);
  }
}