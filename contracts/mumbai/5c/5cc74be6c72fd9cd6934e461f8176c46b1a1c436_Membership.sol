...
contract Membership is Initializable, Pausable {
    ...
    returns (bool, uint256)
    {
        ...
        uint256 tokenId = aisNft.createMembershipToken(msg.sender, _uri, 1000);
    ...
    function submitMembership(bytes32 _type) external payable returns (bool) {
        ...
        aisNft.membershipTransfer(owner(), msg.sender, tokenId);
    ...
    function upgradeMembership(bytes32 _currentType, bytes32 _toType) external payable returns (bool) {
        ...
        aisNft.membershipTransfer(msg.sender, owner(), tokenIdCurrent);
        aisNft.membershipTransfer(owner(), msg.sender, tokenIdTo);
    ...
    function releaseMembership(bytes32 _type, address _user) external returns (bool)
    {
        ...
        aisNft.membershipTransfer(_user, owner(), _membershipTypeToTokenId[_type]);
    ...
    function withdrawAdmin() onlyOwner external returns (bool) {
