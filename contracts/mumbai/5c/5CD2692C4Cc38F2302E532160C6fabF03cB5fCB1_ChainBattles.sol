...
contract ChainBattles is ERC721URIStorage {   
    using Strings for uint256;  // convert uint256 to strings
    ...
    // function 1/5: Character generation and update Function
    ...
    // function 2/5: NFT Current Level Function
    function getLevels(uint256 tokenId) public view returns (string memory){
        uint256 levels = tokenIdToLevels[tokenId];
        return levels.toString();
    }

    //function 3/5: NFT TokenURI Function
