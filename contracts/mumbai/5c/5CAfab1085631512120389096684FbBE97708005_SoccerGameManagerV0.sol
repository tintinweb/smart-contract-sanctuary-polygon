...
// File: contracts/SC_SoccerGameManagerV0.sol
...
contract SoccerGameManagerV0 is Ownable {
    ...
    function playGame(string memory _key, int256 playerRating, int256 enemyRating) public payable returns(uint256) {
        ...
        if(playerRating - enemyRating >= 10){
            isWinner = 1;
        } else if(playerRating - enemyRating <= -10){
            isWinner = 2;
        } else {
            isWinner = 0;
        }
    ...
    // Setting Functions
    function setPlayPrice (uint256 newPlayPrice) public onlyOwner {
    ...
    function approveContract(address newAddress) public onlyOwner {
        playersContracts[newAddress] = true;
    }


    function disapproveContract(address oldAddress) public onlyOwner {
        playersContracts[oldAddress] = false;
    }
    // ###############################################
