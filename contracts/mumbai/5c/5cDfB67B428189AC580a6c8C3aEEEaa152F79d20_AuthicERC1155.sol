  ...
  ReentrancyGuard
{
  ...
  constructor(
    ...
    // addNewToken(type(uint256).max, message.tokenURI, message.maxSupply);
  }
  ...
  function updateRoot(bytes32 _merkleRoot) public onlyRole(DEFAULT_ADMIN_ROLE) {
  ...
  function mintTo(
    ...
    require(isWhitelistingRequire == false, "Please call whitelisted mint");
    require(
...
interface ICollectionTypes {
  struct TransactionMessage {
    ...
    string name;
    string symbol;
    // string tokenURI; FIXME: This is removed
    // uint128 royaltyBps;
    // address royaltyRecipient;
    // uint256 maxSupply; FIXME: called independently
    //Information about the signature of the transaction message.
    uint256 nonce;
    // bytes32 merkleRoot; FIXME: This is removed due to requirements as backend should update manually
  }
}
