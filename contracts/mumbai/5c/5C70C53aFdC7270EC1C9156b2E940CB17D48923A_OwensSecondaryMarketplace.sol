...
//MODIFIER
    modifier onlyAuthor(address _contract, address _author) {
        require(whitelistedContracts[_contract].author == _author, 'Caller is not the author');
        _;
    }
...
//OWNER FUNCTIONS
    ...
    function changeAuthorDetails(address _contract, address _author, uint256 _authorFees) external onlyAuthor(_contract, _msgSender()) returns(bool){
