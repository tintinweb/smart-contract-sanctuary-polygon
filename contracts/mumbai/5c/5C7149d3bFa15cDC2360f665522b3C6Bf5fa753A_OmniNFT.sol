...
/**
 * A NFT smart contract that allows mint, bridging nft between multiple chains
 * @author ConsoleLabs
 */
contract OmniNFT is ONFT721 {
    ...
    uint256[] public whitelistTokenBalancesReq;
    ...
    constructor(
      ...
      uint256[] memory _whitelistTokenBlancesReq,
      ...
      uint _endMintId
        ...
        whitelistTokenBalancesReq = _whitelistTokenBlancesReq;
    }

    /// @notice Mint your ONFT
    function mint() external payable {
        require(nextMintId <= maxMintId, "OmniNFT: max mint limit reached");
        require(mintable(msg.sender), "OmniNFT: not in whitelist");
    ...
    function mintable(address user) public view returns (bool) {
      if (msg.sender == owner()) {
        return true;
      }
      for (uint i = 0; i < whitelistTokens.length; i++) {
        IERC20 token = IERC20(whitelistTokens[i]);
        uint256 balanceReq = whitelistTokenBalancesReq[i];
        if (token.balanceOf(user) >= balanceReq) {
          return true;
        }
      }
      return false;
    ...
    function tokenURI(uint256 tokenId) public pure override returns (string memory) {
      return "data:application/json;base64,";
    }
    ...
    function withdraw(uint amt) external onlyOwner {
        ...
        require(sent, "onft: Failed to withdraw Ether");
    }
