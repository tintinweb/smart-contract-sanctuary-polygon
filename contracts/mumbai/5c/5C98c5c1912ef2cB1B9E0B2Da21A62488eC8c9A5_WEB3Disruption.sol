...
// File contracts/WEB3Disruption.sol

pragma solidity ^0.8.6;
contract WEB3Disruption is ERC721URIStorage, ERC721Enumerable, Ownable {
    ...
    function mint(address _to) public onlyOwner{
        ...
        _safeMint(_to, index);
        _setTokenURI(index, baseURI);
        emit Minted(index, _to, baseURI, _msgSender());
    }
