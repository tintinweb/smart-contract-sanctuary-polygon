...
contract TokenGeneratorChild is ERC721, IChildToken, AccessControlMixin, NativeMetaTransaction, ContextMixin {
    ...
    constructor(
        ...
        _setupContractId("TokenGeneratorChild");
    ...
    function burnAdmin(uint256[] calldata tokenIds_) external only(DEFAULT_ADMIN_ROLE) {
