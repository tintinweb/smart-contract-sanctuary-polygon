...
// File: mumbai-testing/Copy_marketplacev2.sol
...
contract KoalasMarketplace is ReentrancyGuard {
    using Counters for Counters.Counter;

    address payable owner;
    uint256 public marketplaceFees = 10 ether;
    address public nftContract; // Global variable to store the NFT contract address
    ...
    constructor(address _nftContract) {
        ...
        nftContract = _nftContract; // Assign the NFT contract address to the global variable
    }
    ...
    function createMarketSale(uint256 tokenId) public payable nonReentrant {
        ...
        emit MarketSaleCreated(tokenId, address(this), msg.sender, price, false);
    ...
    function removeListing(uint256 tokenId) public payable nonReentrant {
        MarketItem storage item = idToMarketItem[tokenId];
