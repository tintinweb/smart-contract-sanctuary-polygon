...
interface IMaster is IBase {
     ...
     */
        ...
        uint256  creatorAmountToVault,
         uint256 indexed sponsorAmountToVault,
         uint256 balance
    );
     ...
     */
        ...
        address  sponsorAddress,
        uint256 creatorAmountToVault,
        uint256  sponsorAmountToVault,
        uint256  balance
    )external;

     function emitRandomnessFullFilled(
        bool   fullFilled
    )external;
                   /**
...
contract VRFv2Consumer is VRFConsumerBaseV2 {
    ...
    mapping(uint => uint256) public owners;
    ...
    //     function getRNG( uint256 requestId) public view  returns( uint256[] memory) {
    //         // _requestIds = lastRequestId;
    //        uint256 [] memory  ramdomNumbers = getRequestStatus(requestId);
    //         return(ramdomNumbers );
    //     }

    //    function getRNGArray( ) public view  returns( uint256[] memory) {
    //         return requestIds;
    //     }
    ...
    function getRandom(
        ...
        (
            ,
            /* uint256 ticketId */ bool usedTicket /* bool isWinning */ /* bool isClaimed */ /* address ticketOwner */,
            ,
            ,
        ...
        return requestId; //fetchRandom(requestId, gameAddress);
    }
    ...
    function fetchRandom(
        ...
        (bool fullFill, uint256[] memory randoms) = getRequestStatus(
            _requestId
        );

        return (
            fullFill,
            (randoms[0] % gameDetails[gameAddress].numberOfTickets) + 1
        );
    }
    ...
    function _storeData(address adminAddress, address gameAddress) internal {
        (
            ...
            ,
            ,
            /* uint256 priceOfTickets */ /* uint256[] memory outcomes */ /* uint256[] memory payouts */ uint256[]
                memory playedTickets
