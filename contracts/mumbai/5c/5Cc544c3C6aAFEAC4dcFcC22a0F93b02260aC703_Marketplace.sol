...
//TODO:
// change Price
// wishlist in swapping
// counterOffer in auction
// timespan for the offers
...
contract Marketplace is ReentrancyGuard, IMarketplace, Ownable {
    ...
    */
     ...
     * @dev onlyOwner function
     */
    function whitelisting(address _contractAddress, bool _value) external onlyOwner {
    ...
    // function updateSaleOrder(uint256 saleId) public {
