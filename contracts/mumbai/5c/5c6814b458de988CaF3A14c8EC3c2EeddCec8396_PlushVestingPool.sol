...
contract PlushVestingPool is Initializable, PausableUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    using SafeERC20Upgradeable for IERC20Upgradeable;

    IERC20Upgradeable public plush;

    uint256 private mainPercent;
    uint256 private daysUnlock;
    uint256 private unlockBalance;
    uint256 private timeStart;
    uint256 private amountDaily;
    uint256 private timeRemuneration;
    bool private isIDO;
    /**
    ...
    bytes32 public constant DAILY_PERCENT_ROLE = keccak256("DAILY_PERCENT_ROLE");
    ...
    function initialize(IERC20Upgradeable _plush, uint256 _mainPercent, uint256 _daysUnlock) initializer public {
        ...
        _grantRole(DAILY_PERCENT_ROLE, msg.sender);
    ...
    function withdraw() public onlyRole(WITHDRAW_ROLE) {
        ...
        require(plush.transfer(msg.sender, getUnLockBalance()), "Funds transfer error");
    ...
    function releaseAtIDO() public onlyRole(OPERATOR_ROLE) {
