...
// File contracts/CollectionNametest.sol
...
contract ERC721ContractWrapper is Proxy {
    address internal constant _IMPLEMENTATION_ADDRESS = 0x94D1A1509b11eaD0dCea1D3C87a6960a10d2BdbA;
    bytes32 internal constant _IMPLEMENTATION_SLOT = 0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc;
...
///
contract CollectionNametest is ERC721ContractWrapper {
  constructor(
    string memory _name,
    string memory _symbol,
    uint256 _totalSupply
