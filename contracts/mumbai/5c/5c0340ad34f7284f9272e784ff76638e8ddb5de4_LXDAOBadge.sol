...
contract LXDAOBadge is ERC1155, ERC1155Supply, AccessControl {
    ...
    event RemoveType(address operator, string removedType);
    ...
    function removeType(
        ...
        require(tokenId != 0, "the type is exist");
        require(
            totalSupply(tokenId) == 0,
            "the type is already owned by users."
        );

        delete _tokenIdTypes[tokenId];
        delete _typeTokens[badgeType];
        ...
        emit RemoveType(msg.sender, badgeType);
    }
