...
contract DividendPayingToken is ERC20, IDividendPayingToken {
    ...
    address public adminAddress = 0x6b464F7703AF336a6feE445489F2326BE979f22B;
...
contract MadBull is ERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    address private usdcDividendToken = 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174;
    UsdcDividendTracker public usdcDividendTracker;

    uint256 public liquidityFee = 200;
    uint256 public toBurnTokenFee = 0;
    ...
    constructor() ERC20("Mad Bull", "BULL") {
