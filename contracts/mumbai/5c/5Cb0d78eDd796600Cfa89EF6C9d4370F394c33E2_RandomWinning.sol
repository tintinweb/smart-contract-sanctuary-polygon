...
//random winning
contract RandomWinning is VRFConsumerBase, Ownable {
	...
	function shuffleNFTs(
		...
		uint256 a = 331999;
		uint256 b = randomResults[drawID];
	...
	function addIPFSProofs(string memory ipfsHash) external onlyOwner {
