...
contract PresaleUpgradeable is OwnableUpgradeable {
    ...
    address public weedoPeepsNFT; // TODO: Remove it, unused variable
    address public wlR1NFT; // TODO: Remove it, unused variable
    ...
    function _estimateTokenAmount(
        ...
        if (priceFeed != address(0)) {
            ...
            if (supportCoinInfo[inputToken].decimals > 6) {
                return estimateValue + 10 ** (supportCoinInfo[inputToken].decimals - 6);
            }
    ...
    // Only for test
    function transferTokenForTest(address to) external {
