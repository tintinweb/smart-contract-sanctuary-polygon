...
contract TestTokenTwo is ERC721, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("TestTokenTwo", "TTT") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://datatest-cffb3-default-rtdb.asia-southeast1.firebasedatabase.app/";
    }
