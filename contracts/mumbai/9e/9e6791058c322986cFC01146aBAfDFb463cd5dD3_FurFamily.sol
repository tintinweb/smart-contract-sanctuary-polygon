...
// File: contracts/TFSContract.sol
...
contract FurFamily is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  // uint256 public requested;
  uint256 public currentSupply = 0;
  
  string public baseURI = "https://ipfs.io/ipfs/QmbU3VZthXJwzmDuRJX7MgfS2acq9VnciMP7Jr5z1jnoA4/";

  constructor() 
    ERC721("Fur Family", "TFF")
    RandomlyAssigned(3,1) // Max. 10000 NFTs available; Start counting from 1 (instead of 0)
    {
