...
contract LifesDAOStake is Ownable, ERC1155Holder {
    ...
    constructor(IERC1155 _nft, IRewardToken _rewardsToken) {
        nft = _nft;
    ...
    function _stake(address _user, uint256 _tokenId) internal {
        ...
        nft.safeTransferFrom(_user, address(this), _tokenId, 1, "0x00");
    ...
    function _unstake(address _user, uint256 _tokenId) internal {
        ...
        nft.safeTransferFrom(address(this), _user, _tokenId, 1, "");
