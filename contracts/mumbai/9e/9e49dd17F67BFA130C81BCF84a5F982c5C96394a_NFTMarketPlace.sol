...
contract NFTMarketPlace is ReentrancyGuard, IERC721Receiver {
   ...
   // My Sold item count
    ...
    //Add Multiple User in Whitelisted
    function addUser(address[] memory _addressToWhitelist) public  {
    ...
    //user remove from whitelisted
    function removeFromWhitelist(address _addressToWhitelist) public onlyOwner {
