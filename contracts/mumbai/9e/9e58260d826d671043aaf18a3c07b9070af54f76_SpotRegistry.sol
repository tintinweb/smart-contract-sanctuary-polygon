...
contract VisitedBy is Initializable, UUPSUpgradeable, Ownable {
    ...
    event Visited(address indexed visitor, address indexed spotAddress, address indexed resolver);
    ...
    function _mint(
        ...
        emit Visited(msg.sender, spotAddress, resolverAddress);
     ...
     */
    function _clearExperience(address visitor) internal {
        if (0 == _experienceOf[visitor]) revert("visitor has no experience.");
