...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xE00A5BcadcB520691769A2C00Df3FF987954F6ad];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmUCGNKbLrkvXbiAPaY2R5CCSegknCnF7gXsSSNtCmpoyC/";
...
// File: contracts/CreepyWarContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CreepyWarContract is RamppERC721A {
    constructor() RamppERC721A("Creepy War", "CWA"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/2uXDhXYKYSRcGiNlGy9f/contract-metadata";
    }
}