...
contract Darabase is NFTContract{
    ...
    function buyRental(
        ...
        checkWhitelistedUser(msg.sender);
    ...
    function checkWhitelistedUser(address user) internal view {
        if(!isWhitelisted[user]) revert("User not whitelisted");
    }
    ...
    function setWhitelistUser(address user, bool isUserWhitelisted) external onlyAdminOrOwner{
