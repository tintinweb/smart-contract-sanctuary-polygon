...
contract AuctionV2 is
    ...
    */
    ...
    function verifyOrderMatch(LibLazyBidERC721V2.Bid memory _bid, LibLazyAuctionERC721V2.Auction memory _auction) public virtual returns (IGlipERC721Lazy.DecodedMintData memory, uint96) {
    ...
    function verifyOrderMatchOffChain(LibLazyBidERC721V2.Bid memory _bid, LibLazyAuctionERC721V2.Auction memory _auction) public virtual returns (IGlipERC721Lazy.DecodedMintData memory) {
