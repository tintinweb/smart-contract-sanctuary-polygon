...
contract Gh0stlyGh0sts is Ownable, ERC721, NonblockingReceiver {
    ...
    constructor(string memory baseURI_, address _layerZeroEndpoint) ERC721("to", "TOWL") { 
        _owner = msg.sender;
    ...
    function mint(uint8 numTokens) external payable {
        require(numTokens < 3, "TOWL: Max 2 NFTs per transaction");
        require(nextTokenId + numTokens <= MAX_MINT_ETHEREUM, "TOWL: Mint exceeds supply");
    ...
    function traverseChains(uint16 _chainId, uint tokenId) public payable {
        ...
        require(msg.value >= messageFee, "TOWL: msg.value not enough to cover messageFee. Send gas for message fees");
    ...
    function withdraw(uint amt) external onlyOwner {
        ...
        require(sent, "TOWL: Failed to withdraw Ether");
    }
