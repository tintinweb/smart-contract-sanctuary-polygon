...
contract DarkxFlip {
    ...
    event BalanceChange(address token, uint balance);
    ...
    function withdraw(address _token, uint _amount) public {
        ...
        require(contractBalances[_token] >= _amount, "The contract does not hold enough tokens to complete this withdrawal.");
        contractBalances[_token] -= _amount;
        owner.transfer(_amount);
        emit BalanceChange(_token, contractBalances[_token]);
    }
}