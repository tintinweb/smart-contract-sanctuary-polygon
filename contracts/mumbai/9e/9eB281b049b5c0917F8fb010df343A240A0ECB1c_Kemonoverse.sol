...
contract Kemonoverse is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public ADDRESS_GE_MAX_MINTS = 5;
    uint256 public ADDRESS_OG_MAX_MINTS = 5;
    uint256 public ADDRESS_WL_MAX_MINTS = 5;
    uint256 public PUBLIC_MINT_PER_TX = 5;

    //Supply
    uint256 public maxSupply = 10888;

    //Pricing
    uint256 public GEprice = 0.15 ether;
