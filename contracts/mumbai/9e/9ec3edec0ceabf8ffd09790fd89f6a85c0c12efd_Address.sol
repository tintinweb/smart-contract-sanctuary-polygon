...
// File: contracts/work/nftOpenZeppelin.sol
...
contract NFT is ERC721, ERC721Enumerable, ERC721URIStorage {
    ...
    uint256 private price = 1 * 10**2;

    constructor() ERC721("TESTE", "TST") {}
    ...
    function safeMint(address to) public payable {
        ...
        for (uint256 i = 1; i <= 10; i++) {
            ...
            string memory uri = "https://ipfs.io/ipfs/QmcuPVJ7En75NNdVr6iZcMWBJ59sggZNHrMV8qgXUNQ9j2?filename=MatheusAbreu_girlmedieval_bcb77f8b-66cc-4968-97fc-3bd075e08d91.png";
            string memory format = ".json";
            string memory finalURI = string(abi.encodePacked(uri,tokenId, format));
