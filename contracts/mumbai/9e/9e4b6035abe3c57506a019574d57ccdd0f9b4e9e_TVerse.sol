...
contract TVerse is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("TVerse", "TVS") {
    setHiddenMetadataUri("ipfs://QmX4S36NMNwCSiKgC9u1TjyYBGZsXjssaj18Xyj5a2iog1/hidden.json");
