...
contract TEST19 is ERC721Enumerable, Ownable {
    ...
    constructor(
        ...
        baseURI = "coucou/";
        paperKeyManager = IPaperKeyManager(0x0c93b186B730985628C04DaDA34B681f38143615);
    }
    ...
    modifier mintCompliant(
        ...
        require(amountPerWallet[_recipient] == 0, "You already purchased this pass!");
    ...
    function tokenURI(
        ...
        require(_exists(_tokenId + 1), "URI query for nonexistent token");
    ...
    function withdrawCurrency(IERC20 _currency) external onlyOwner {
        ...
        bool success = _currency.transfer(msg.sender, balance*50/100); // METABAY
        bool creator = _currency.transfer(0x4588069c142A866C564541Dd3a29353cB08A4195, balance*50/100); // ADDRESS WALLET CREATOR
        require(success && creator, "withdraw failed");
    }
