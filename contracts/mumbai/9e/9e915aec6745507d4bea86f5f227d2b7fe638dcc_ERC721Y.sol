...
contract ERC721Y is ERC721MIncreasableOperatorFilterer {
    constructor(
        string memory collectionName,
        string memory collectionSymbol,
        string memory tokenURISuffix,
        ...
        address cosigner,
        uint64 timestampExpirySeconds
    ) ERC721MIncreasableOperatorFilterer(collectionName, collectionSymbol, tokenURISuffix, maxMintableSupply, globalWalletLimit, cosigner, timestampExpirySeconds) {
