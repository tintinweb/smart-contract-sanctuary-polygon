...
contract Web3TalentFairXAgathe is Ownable, ERC1155Supply {
    using Strings for uint256;

    string public name = "Web3TalentFair x agathedavray.eth";

    string public symbol = "WTF-AGATHE";
    ...
    constructor()
    ERC1155("ipfs://QmcUNQJudwvTGLqu2tuKPyhw5j72wTsoSUL2S5MtUn13NU/")
        {
        }
