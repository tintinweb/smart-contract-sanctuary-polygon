...
*/
    ...
    function setPolyDAO(address _DAO) external{
    ...
    function setMinMax(uint256 _minAmount, uint256 _maxAmount) external{
        require(msg.sender == polyWallet, "Not authorized!");
        require(currencyDecimals != 0, "please set decimals for currency");
        minBuy(_minAmount, price, currencyDecimals);
        minC = _minAmount;
        minBuy(_maxAmount, price, currencyDecimals);
        maxC = _maxAmount;
    }
    function setMax(uint256 _max, uint256 _maxM) external{
        require(msg.sender == polyWallet, "Not authorized!");
