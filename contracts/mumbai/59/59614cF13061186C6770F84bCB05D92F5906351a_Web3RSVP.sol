...
contract Web3RSVP {
    ...
    function createNewEvent(
        uint256 eventTimestamp, // Event end time
        uint256 deposit, // Deposit amount
        uint256 maxCapacity, // Max event capacity
        ...
        address[] memory confirmedRSVPs; // tracks RSVPs
        address[] memory claimedRSVPs; // tracks Attendees
