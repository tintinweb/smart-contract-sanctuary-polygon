...
contract RandomToken is Initializable, ERC721Upgradeable, ERC721BurnableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize() initializer public {
        __ERC721_init("RandomToken", "RNDM");
