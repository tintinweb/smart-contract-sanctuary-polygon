...
contract ZyptoGovernance is Governor, GovernorCountingSimple, GovernorVotes, GovernorVotesQuorumFraction {
    ...
    address[] public bussinesses;

    function getBussinessProposal(uint256 _bussinessID) external view returns (BussinessProposal memory){
        return _bussProposals[_bussinessID];
    }
    ...
    function fundBussiness(address _tokenAddress, uint256 _price,uint256 period) external onlyGovernance() {
        ...
        bussinesses.push(address(bussinessProposal.platform));
