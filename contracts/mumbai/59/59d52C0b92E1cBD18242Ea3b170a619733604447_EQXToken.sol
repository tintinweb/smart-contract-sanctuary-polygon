...
contract EQXToken is Initializable{
    string public name;
...
address public owner;
   ...
   function initialize(string memory _name, string memory _symbol, uint8 _decimals, uint256 _taxPercentage, uint256 _initialSupply) public initializer {
        name = _name;
        symbol = _symbol;
        decimals = _decimals;
