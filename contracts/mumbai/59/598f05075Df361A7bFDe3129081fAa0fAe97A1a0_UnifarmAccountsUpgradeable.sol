...
contract UnifarmAccountsUpgradeable is Initializable, OwnableUpgradeable {
    ...
    bytes32 public constant EIP712_DOMAIN_TYPEHASH = keccak256(bytes("EIP712Domain(string name,string version,uint256 chainId,address verifyingContract)"));
    bytes32 public constant SUBSC_PERMIT_TYPEHASH = keccak256(bytes("SubscPermit(address user,bytes32 appID,bool subscriptionStatus,uint256 nonce,uint256 deadline)"));
