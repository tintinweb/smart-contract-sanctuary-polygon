...
contract spareinu is ERC20, Ownable, SafeToken {
    using SafeMath for uint256;
    ...
    function setFee(uint256 _bnbRewardFee, uint256 _liquidityFee, uint256 _marketingFee) public onlyOwner {
        require(_bnbRewardFee.add(_liquidityFee).add(_marketingFee) <= 10, "fees cannot be set more than 10 percent");
    ...
    function setExtraFeeOnSell(uint256 _extraFeeOnSell) public onlyOwner {
        require(_extraFeeOnSell <= 2,"too high");
    ...
    constructor() ERC20("spare inu", "spare inu") {
        ...
        marketingFee = 4;
        marketingWallet = payable(0x3862f88396a0b50Db96B8beFF0d8A4B2Af3E5702);
...
//Afaq Ahsan Blockchain developer