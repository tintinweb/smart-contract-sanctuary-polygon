...
contract Rectangles is ERC721Enumerable, Ownable {
    ...
    //コンストラクタ
    constructor() ERC721("Rectangles By Kitasenju", "RECTS") {
        paused = false;
    }
    ...
    modifier onlyCreator(uint256 _id) {
        require(
            ...
            "Rectangles#creatorOnly: ONLY_CREATOR_ALLOWED"
        );
        _;
    }
    ...
    function html() private view returns (bytes memory) {
        return
            abi.encodePacked(
                ...
                '<style>'
                "body { background:#888;overflow:hidden;font-size:3px;font-family:sans-serif; } "
            ...
            abi.encodePacked(
                ...
                'for(let i=0;i<jsons.length;i++){'
                    ...
                    "let dv2s = dv2.style;"
                        ...
                        'dv1.innerText = ""+i;'
                        'dv1s.left  =dv2s.left   =d[0]+"px";'
                        'dv1s.top   =dv2s.top    =d[1]+"px";'
                        'dv1s.width =dv2s.width  =d[2]+"px";'
                        'dv1s.height=dv2s.height =d[3]+"px";'
