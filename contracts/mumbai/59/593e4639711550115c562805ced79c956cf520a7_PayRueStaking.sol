...
// File: contracts/PayRueStaking.sol
...
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// CHENGES THE 60 SECONDS TO 365 DAYS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
pragma solidity ^0.8.0;
...
contract PayRueStaking is ReentrancyGuard, Ownable {
    ...
    uint256 public constant lockedPeriod = 60 seconds;
    uint256 public constant yieldPeriod = 60 seconds;
