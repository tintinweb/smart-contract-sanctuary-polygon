...
contract GoodTimesPals is Ownable, ERC721A, ReentrancyGuard {
  ...
  function mint(uint256 _mintAmount, uint256 _price, bytes memory _signature) payable public {
    ...
    if (msg.sender != owner()) {
      require(isSignatureValid(msg.sender, _price, nonce[msg.sender], _signature), "Bear: invalid signature");
  ...
  function isSignatureValid(
    ...
    bytes32 hash = keccak256(abi.encodePacked(address(this), _whitelistAddress, _price, _nonce));
