...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0xb54d3aE5cF8d73F7992C820aA64adB19F9542AeF];
  address public erc20Payable = 0xb54d3aE5cF8d73F7992C820aA64adB19F9542AeF;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 301, 300) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmRSGqSq1tjSQVysjnb86QS5bXaCGQpYsyLX2h5tYQGWBf/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/jUUF5223JBMOyN7DvW2z/contract-metadata";
  }
...
// File: contracts/AmvsionContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AmvsionContract is ERC721APlus {
    constructor() ERC721APlus("AMVSION", "AMVS"){}
}
  /*******************************************************/
  /*                                                     */
