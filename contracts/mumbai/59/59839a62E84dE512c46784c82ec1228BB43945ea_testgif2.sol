...
contract testgif2 is ERC721A, Ownable, ERC2981 {
    //Mint Variables to be set by user
    uint256 public maxMintPerBatch = 0;
    uint256 public MAXSUPPLY = 50;
    uint256 public MINTPRICE = 0.018549 ether;
    ...
    //URI
    string public baseURI = "ipfs://bafybeia5nfopc2k3qxoidrnnnninxtnxwvbpcqywbu67nix43itberbgwu/";
    ...
    //
    constructor() ERC721A("testgif2", "GIFF") {
...
// <------------------------------------- Main Functions ------------------------------------->
    ...
    function _baseURI() internal view override returns (string memory) {
        if(reveal == false) {
            return "ipfs://your_pre_reveal_uri/";
        } else {
            return baseURI;
        }
    }
