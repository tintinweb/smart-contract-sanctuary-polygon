...
contract XRDemo is ERC721Enumerable, Ownable {
  
  using Strings for uint256;

  string public baseURI;
  string public baseExtension = ".json";
  uint256 public cost = 0.101 ether;
  ...
  // public
  function tokenMint(uint256 tokenId) public payable {
    require(!paused);
    uint256 supply = totalSupply();
    require(supply + 10 <= maxSupply);
    require(tokenId + 10 <= maxSupply);
