...
contract Staking {
    ...
    function unstakeTokens(uint256 _stakeId) external returns(bool){
        ...
        uint256 reward = amountByStakeId[_stakeId] * rewardMultiplier * (block.timestamp - timeByStakeId[_stakeId])/3600;   //multipler will be divided by 1000 in next step, in 3 decimals
