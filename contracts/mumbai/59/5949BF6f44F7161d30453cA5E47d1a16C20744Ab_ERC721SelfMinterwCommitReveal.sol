...
contract ERC721SelfMinterwCommitReveal is ERC721, ReentrancyGuard, Ownable {
    ...
    string public HIDDEN_URI; // set it in constructor. 
        ...
        onlyMultiSig(msg.sender)
    {
        ...
        require(
            block.timestamp < blockEnd,
            "Exception: Minting period is over"
        );
