...
contract Twitter {
    ...
    // * Helpers
    function _eventSender(
        string memory _message,
        string memory _imageUrl
    ) private {}

    function testStuff() external view OnlyOwner returns (uint8) {
        return 7;
    }

    // ? Contract migration stuff
    // needed since I dont want to lose the data available in https://mumbai.polygonscan.com/address/0x4B0a24db3a6e5F5247a7868C02230f8F1ba0c9D1
