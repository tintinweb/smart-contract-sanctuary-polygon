...
contract elonmusks is ERC721A, OperatorFilterer, Ownable, ReentrancyGuard {
    ...
    constructor(string memory _initBaseURI) ERC721A("elonmusks", "ELNS") {
