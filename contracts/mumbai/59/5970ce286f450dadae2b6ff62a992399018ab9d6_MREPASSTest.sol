...
contract MREPASSTest is ERC721A, Ownable {
  constructor() ERC721A("MRE PASS Test", "MP", 10) {}
    ...
    uint256 public constant MAX_NFT = 5000;
    uint256 public NFTPrice = 0;
    bool public reveal;
    bool public isActive;
    bool public isPresaleActive;
    mapping(address => bool) public giveawayMintClaimed;

    bytes32 public merkleRootGiveAway = 0xbe04e121ea1275259cf02ae30449d7e28f314c1075859346149835f38c47f5f2;

    /*
     * Function to reveal all MRE PASS
    */
    function revealNow() 
        external 
        onlyOwner 
    ...
    */
     ...
     * It is payable. Amount is calculated as per (publicSaleNFTPrice.mul(_numOfTokens))
    */
    function mintNFT(
     ...
     * It is payable. Amount is calculated as per (publicSaleNFTPrice.mul(_numOfTokens))
    */ 
    function mintNFTDuringGiveAway(
        uint256 _numOfTokens,
        ...
        payable
    {
        ...
        require(verify(_proof, merkleRootGiveAway, keccak256(abi.encodePacked(msg.sender))), "Not whitelisted");
    ...
    */
    ...
    function setMerkleRootGiveAway(bytes32 _merkleProof) public onlyOwner {
        merkleRootGiveAway = _merkleProof;
    }
