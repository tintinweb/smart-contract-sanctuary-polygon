...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff);//uniswap, quickswap
        _token = msg.sender;
    }
...
/* Token contract */
contract  ZENITHTOKENS is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0x5F820fDF30e72ba78c1fed7c47d0D33D0A7c582C;//Maticdev testnet
    ...
    // Name and symbol
    string constant _name = "Zenith Token";
    string constant _symbol = "ZTA";
    uint8 constant _decimals = 10;

    // Total supply
    uint256 _totalSupply = 240000000 * (10 ** _decimals); //

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 100 / 1000; // 1% 
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 1000; // 1% 
    uint256 public _maxWalletToken = ( _totalSupply * 100 ) / 1000; // 1% 

    // Mappings
    mapping (address => uint256) _balances;
    mapping (address => mapping (address => uint256)) _allowances;
    mapping (address => bool) public Launching;
    bool public LaunchingEnabled = true;
    ...
    uint256 public marketingFeeSell = 13;
    uint256 public devFeeSell = 2;
    ...
    uint256 public swapThreshold = _totalSupply * 50 / 10000; // 2% of supply
    ...
    constructor () Auth(msg.sender) {
        ...
        router = IDEXRouter(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff);// uniswap, quickswap
        ...
        marketingFeeReceiver = 0x5F820fDF30e72ba78c1fed7c47d0D33D0A7c582C;//matic testnet marketing
    ...
    // Main swapback to sell tokens for WMATIC
