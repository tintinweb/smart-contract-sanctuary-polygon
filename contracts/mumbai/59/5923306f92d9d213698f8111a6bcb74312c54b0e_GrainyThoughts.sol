...
// File: contracts/GrainyThoughts.sol
...
contract GrainyThoughts is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  uint256 public currentSupply = 0;
  
  string public baseURI = "ipfs://QmVYH5F3r2gKKF5XjfJfKdudmA7qSULYZqHqigaNTeejRH/";

  constructor() 
    ERC721("Grainy Thoughts", "GT$")
    RandomlyAssigned(55,1)
    {
