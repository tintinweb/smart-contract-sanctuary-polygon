...
/// @dev This is the facade contract of the diamond portal that delegate-calls into its facets to execute function calls. 
...
contract Diamond is ERC1155Holder, ERC721Holder {
    ...
    constructor(address _contractOwner, address _diamondCutFacet) payable {
        ...
        s.config.defaultMaintenanceTime = 30 days;
        s.config.defaultMigrationTime = 7 days;
        s.config.executeTimeInterval = 40;
        s.config.withdrawGasLimit = 100000;
        s.config.maxNumberOfPendingRequests = 4536000;
        s.domainSeparator = LibMeta._domainSeparator("V1.0.0");
