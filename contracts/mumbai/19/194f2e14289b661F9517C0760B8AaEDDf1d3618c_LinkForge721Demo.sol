...
abstract contract LinkForgeCore is LinkForgeBase, OwnableUpgradeable {
...
contract LinkForge721Demo is LinkForgeCore, ERC721AUpgradeable {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return "ipfs://QmVqtYL4VnQmXvPvGThM58cN7XhT7tvu4g2BkRNv37mKbd";
    }

    function _processClaim(address claimant, bytes calldata) internal override {
        _mint(claimant, 1);
    } 
