    ...
    PausableUpgradeable
{
    ...
    modifier onlyWhitelistNFTContract(address _contractAddress) {
        require(_whitelistNFTContractAddresses[_contractAddress], "Error: NFT contract not allowed");
        _;
    }

    event WhitelistNFTContractAddress(address contractAddress, bool allowance);
    ...
    function setWhitelistNFTContractAddress(address _contractAddress, bool _allowance) public onlyRole(CONFIG_ROLE) {
        require(_whitelistNFTContractAddresses[_contractAddress] != _allowance);

        if (_allowance) _whitelistNFTContractAddresses[_contractAddress] = _allowance;
        else delete _whitelistNFTContractAddresses[_contractAddress];

        emit WhitelistNFTContractAddress(_contractAddress, _allowance);
    }
    ...
    function deposit(address _contractAddress, uint256 _tokenId)
        external
        nonReentrant
        whenNotPaused
        onlyWhitelistNFTContract(_contractAddress)
    {
        require(
    ...
    function withdraw(
        ...
        require(_owners[_contractAddress][_tokenId] == _msgSender(), "Error: You not is owner");
    ...
    function withdrawERC721(
        ...
        require(_owners[_contractAddress][_tokenId] == address(0), "Error: NFT is user deposit");
    ...
    function _addTokenToAllTokensEnumeration(address _contractAddress, uint256 _tokenId) private {
    ...
    function _removeTokenFromAllTokensEnumeration(address _contractAddress, uint256 _tokenId) private {
