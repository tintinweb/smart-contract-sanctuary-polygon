...
//
//                      __  __                 __            __ 
//   ____ _____  ____  / /_/ /_  ___  _____   / /____  _____/ /_
//  / __ `/ __ \/ __ \/ __/ __ \/ _ \/ ___/  / __/ _ \/ ___/ __/
// / /_/ / / / / /_/ / /_/ / / /  __/ /     / /_/  __(__  ) /_  
// \__,_/_/ /_/\____/\__/_/ /_/\___/_/      \__/\___/____/\__/  
//                                                              
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmWdtfUhNk3sziLQhEQp1SFfgEA7X2Ty3HVHKDrrMaFmzJ/";
...
// File: contracts/AnothertestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AnothertestContract is RamppERC721A {
    constructor() RamppERC721A("another test", "CRET"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/CObpn32JuTuHxfwmDE7S/contract-metadata";
    }
}
