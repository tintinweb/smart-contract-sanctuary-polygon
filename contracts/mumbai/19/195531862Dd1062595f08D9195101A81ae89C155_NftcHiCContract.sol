...
//*********************************************************************//
//
//    ______                     _         __  ____          _____ __             __                             
//   / ____/__  ____  ___  _____(_)____   /  |/  (_)___     / ___// /_____ ______/ /______   ____  ____ _      __
//  / / __/ _ \/ __ \/ _ \/ ___/ / ___/  / /|_/ / / __ \    \__ \/ __/ __ `/ ___/ __/ ___/  / __ \/ __ \ | /| / /
// / /_/ /  __/ / / /  __(__  ) (__  )  / /  / / / / / /   ___/ / /_/ /_/ / /  / /_(__  )  / / / / /_/ / |/ |/ / 
// \____/\___/_/ /_/\___/____/_/____/  /_/  /_/_/_/ /_/   /____/\__/\__,_/_/   \__/____/  /_/ /_/\____/|__/|__/  
//                                                                                                               
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1678470300;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1678124700;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x0dffF175E45c12a12Af97259aDB34038634F40c2];
  address public erc20Payable = 0x0dffF175E45c12a12Af97259aDB34038634F40c2;
...
abstract contract EarlyMintIncentive is Teams, ERC721A, ProviderFees {
  ...
  uint256 public earlyMintTokenIdCap = 111;
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 1111) { }
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/ayffwFRWUaU6kAPqPuqu/contract-metadata";
  }
...
// File: contracts/NftcHiCContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NftcHiCContract is ERC721APlus {
    constructor() ERC721APlus("NFT CHiC", "CHiC"){}
}
