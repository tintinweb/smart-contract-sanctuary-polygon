...
contract Workflow is KeeperCompatibleInterface {
    ...
    */
    ...
    function performUpkeep(bytes calldata /* performData */) external override {
        ...
        lastTimeStamp = block.timestamp;
        IERC20(tokenA).transferFrom(creator, address(this), amountTokenA);
        IERC20(tokenB).transferFrom(creator, address(this), amountTokenB);

        IERC20(tokenA).approve(ROUTER, amountTokenA);
