...
// File contracts/1PLC02ImplementationChildV5.sol
...
contract OnePlanetCarbonOffsetChildV5 is ERC20Interface, OwnableUpgradeable, UUPSUpgradeable {
    ...
    //USDC and Tether contract addresses
...
function initialize() public initializer {
		...
		oracleAddress = payable(0x0715A7794a1dc8e42615F059dD6e406A6594651A); //Matic testnet address
		retireAddress = 0x0000000000000000000000000000000000000000;
		daiAddress = payable(0xcB1e72786A6eb3b44C2a2429e317c8a2462CFeb1); // //Matic testnet address
		priceFeed = AggregatorV3Interface(oracleAddress);
        gasCO2factor = 380000000000;
        __Ownable_init();
        
        //Matic Constructor Arguments
        childChainManagerProxy = payable(0xb5505a6d998549090530911180f38aC5130101c6);

        tetherAddress = payable(0xeaBc4b91d9375796AA4F69cC764A4aB509080A58);
        usdcAddress = payable(0xdA5289fCAAF71d52a80A254da614a192b693e977);
    ...
    //-------------------------------------------------------------------------------------------
    function buy1PLwithTether(uint256 tetherAmount) public estGas returns (bool success) {
    ...
    //-------------------------------------------------------------------------------------------
    function buy1PLwithUSDC(uint256 usdcAmount) public estGas returns (bool success) {
    ...
    // Verify transaction details at www.1PLANET.app
    //-------------------------------------------------------------------------------------------
    function offsetDirectWithMatic(string calldata message) external payable estGas returns (bool success) {
