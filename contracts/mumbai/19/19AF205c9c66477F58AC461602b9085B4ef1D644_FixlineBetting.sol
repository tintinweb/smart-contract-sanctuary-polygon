...
contract FixlineBetting is Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        nextRewardTime = block.timestamp + (60 minutes / maxRewardsInDay);
    ...
    /***********************************************************************************************************************
     ...
     (4) If makerAmountPerBet Is Lesser Than 'minMakerAmountPerSlot' Or Greater Than 'maxMakerAmountPerSlot'.
     ...
     Simple Example:-
     Consider A Have Created Bet And They Have Passed Parameters As Given Below,
     slots -> 2
     slotPrice -> 1000
    ...
    ************************************************************************************************************************/
    ...
    /***********************************************************************************************************************
     ...
     (5) If User Have Already Purchased Bet Slot.
     (6) If Sufficient Allowance Is Not Provided To Contract And Sufficient ETH Are Not Passed To Contract.
     (7) If User Is Accidentally Passing ETH.
    ...
    ************************************************************************************************************************/
    ...
    function sendRewardsToStackingContract(
        ...
        if (
            ...
            (block.timestamp >= (nextRewardTime + 60 minutes))
        ) {
            if (
                (totalPendingStableCoinsToSwapForCapsStackingContract +
                    totalPendingStableCoinsToSwapForFixlineStackingContract) >=
...
FixlineBetting:- 0x5497D6a3980e835D335cBFDe9954295C16e4b1fF
*/
