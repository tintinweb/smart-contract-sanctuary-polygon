...
contract BridgeToken is ERC20Bridge, IChildToken, EIP712MetaTransaction {
    ...
    uint256 private immutable _bridgeTransferLimit;
    ...
    constructor(
        ...
        string memory _domainSeparatorVersion,
        uint256 _domainSeparatorChainId,
        uint256 bridgeTransferLimit_
        ...
        _bridgeTransferLimit = bridgeTransferLimit_;
        ...
        domainSeparator = keccak256(
            abi.encode(
                ...
                keccak256(bytes(_domainSeparatorVersion)),
                address(this),
                bytes32(_domainSeparatorChainId)
            )
        );
    ...
    function withdraw(uint256 amount) external {
        require( totalSupply() - amount >= _bridgeTransferLimit, "Bridge transfer limit exceeded");
