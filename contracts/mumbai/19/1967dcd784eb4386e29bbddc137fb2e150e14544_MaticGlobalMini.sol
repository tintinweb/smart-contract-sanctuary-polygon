...
contract MaticGlobalMini {
    ...
    uint256[6] public noWithdrawalIncomeStop= [2 ether,4 ether,6 ether,8 ether,10 ether,12 ether];
  ...
  function withdrawal() external{
    ...
    if(!_CheckIncomeEligibility(msg.sender,0)) {
        uint256 OverFlowAmount=TotalBonus.sub(_userDetails.noWithdrawalIncomeLimits);
