...
contract ApeCoinNFT is ERC721, SismoConnect {
  error ApeCoinNFT__PaymentNotMet();
  ...
  constructor(
    ...
    ERC721("ApeCoinStandsWithCrypto", "ASWC")
  ...
  function claimWithSismo(bytes memory response) public {
    apeToken.transferFrom(msg.sender, address(this), 10 ** 18);
