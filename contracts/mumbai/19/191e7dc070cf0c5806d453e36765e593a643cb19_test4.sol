...
contract gasLesslync is ERC2771Context, ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    string private baseURI;
    uint256 public maxMintAllowedPerUser;
    ...
    constructor(
        ...
        uint256 _maxMintAllowedPerUser,
        uint256 _maxSupply,
        address _trustedForwarder
    ) ERC721A(_name, _symbol) ERC2771Context(_trustedForwarder) {
        setBaseURI(_initBaseUri);
        maxMintAllowedPerUser = _maxMintAllowedPerUser;
    ...
    function mintNewNFT(
        ...
        require(
            balanceOf(_msgSender()) + _mintNum <= maxMintAllowedPerUser,
            "User already minted max amount"
        );
    ...
    function setMaxSupply(uint256 _maxSupply) external onlyOwner {
        require(
            ...
            "Can't set max supply less than total supply"
        );
        maxSupply = _maxSupply;
    }
    ...
    function setMaxMintAllowedPerUser(uint256 _maxMintAllowedPerUser) public onlyOwner{
        maxMintAllowedPerUser = _maxMintAllowedPerUser;
    }
