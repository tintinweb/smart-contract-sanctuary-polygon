...
abstract contract Governor is Context, ERC165, EIP712, IGovernor {
    ...
    function hashProposalSimple(
        bytes32 descriptionHash
    ) public pure virtual returns (uint256) {
        return uint256(keccak256(abi.encode(descriptionHash)));
    }
    ...
    function simplePropose(
        ...
        uint256 proposalId = hashProposalSimple(keccak256(bytes(description)));
