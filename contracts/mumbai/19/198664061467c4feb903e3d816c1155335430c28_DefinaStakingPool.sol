...
contract DefinaStakingPool is Initializable, OwnableUpgradeable, PausableUpgradeable {
    ...
    //**************************************   Only DEV    **************************************************
    function customData(uint256 _pid,address userAddress, UserLPInfo memory customData) onlyOwner external {
        UserLPInfo storage user = userLPInfo[_pid][userAddress];
        user.amount=customData.amount;
        user.averageDepositedTime=customData.averageDepositedTime;
        user.firstDepositedTime=customData.firstDepositedTime;
        user.rewardDebt=customData.rewardDebt;
    }
