...
// File: contracts/PepperPunks.sol
...
contract PepperPunks is ERC721, Ownable {
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        if (msg.sender != owner()) {
            ...
            if (whitelisted[msg.sender] == true) {
                if(freeMintedWallets[msg.sender] < maxFreePerWallet) {
                    require(_mintAmount <= maxFreePerWallet, 'exceeds free mint amount'); 
                    isWhite = true;
                }else{
    ...
    function totalOwnerMint() public view returns (uint256) {
        return mintedWallets[msg.sender];
    }

    function isWhitelistUser() public view returns (bool) {
