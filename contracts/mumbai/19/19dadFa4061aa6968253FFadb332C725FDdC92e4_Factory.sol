...
import "./interfaces/IInitializableNFT.sol";
...
contract Factory is Initializable, Ownable {
    ...
    function deploy(
        ...
        address instance = nft.cloneDeterministic(_getSalt(msg.sender, nonce));
        ...
        emit NewNFTCollection(msg.sender, nonce, instance, totalSupply, name);
    }
