...
// |  _  \                 | | | (_)   | |    | \ | |     |  \/  |
// | | | |_____   _____    | |_| |_  __| | ___|  \| | ___ | .  . | ___  _ __ ___
// | | | / _ \ \ / / _ \   |  _  | |/ _` |/ _ \ . ` |/ _ \| |\/| |/ _ \| '__/ _ \
// | |/ / (_) \ V /  __/   | | | | | (_| |  __/ |\  | (_) | |  | | (_) | | |  __/
// |___/ \___/ \_/ \___|   \_| |_/_|\__,_|\___\_| \_/\___/\_|  |_/\___/|_|  \___|
//
...
contract DoveDigitalCollectibles is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 private immutable maxSupply = 30;
        ...
        onlyPaper(keccak256(abi.encode(_recipient)), _nonce, _signature)
    {
        ...
        if (currentSupply + quantity > maxSupply) {
            revert DoveDigitalCollectibles__MaximumSupplyExceeded();
        }
        _safeMint(_recipient, currentSupply + quantity);
    }

    // Used by Paper before minting.
    function getMintIneligibilityReason()
        external
        view
