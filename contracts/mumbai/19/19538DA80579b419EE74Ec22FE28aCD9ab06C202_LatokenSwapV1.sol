...
// File: contracts/LatokenSwapV1.sol
...
contract LatokenSwapV1 {
  ...
  function convertToken1ToToken2(address token2) payable external  {
  ...
  function convertToken1ToExactToken2(uint256 token2Amount, address token2) payable external {
