...
contract ERC1155Token is ERC1155, Ownable, ReentrancyGuard {
    ...
    */
    ...
    function getItemPrice(uint tokenId) view public returns (uint price){
...
interface IERC1155Token is IERC1155 {
    function mint(uint _id, uint256 amount, uint256 price)  external returns (uint);
    function purchaseItem(uint _tokenId) external payable;
    function getItemPrice(uint tokenId) view external returns (uint price);
}
...
contract FactoryERC1155 is Ownable {
    ...
    */
    function mintERC1155(uint256 id, uint256 amount, uint256 price) public {
        ...
        IERC1155Token(ownerToContract[msg.sender]).mint(id,amount,price);
    }
