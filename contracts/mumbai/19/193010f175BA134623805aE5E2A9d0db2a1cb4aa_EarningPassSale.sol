...
abstract contract Sale is PurchaseLifeCycles, ISale, PayoutWallet, Startable, Pausable {
    ...
    function purchaseFor(
        ...
        _requireNotPaused();
        require(signerKey == address(0), "GBot PackOpener: signer key is set. Use signature");
...
// File contracts/sale/EarningPassSale.sol
...
contract EarningPassSale is FixedPricesSale {
