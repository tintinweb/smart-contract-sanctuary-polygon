...
contract Lottery is
    ...
    mapping(address=>uint) public assignids;
    uint private playersentered;
    ...
    function join() external payable returns(uint)
    {
        ...
        playerIds++;
        assignids[msg.sender]=playerIds;
    ...
    function getrandomwords() public view returns(uint[] memory)
    {
        return randomwords;
    }
