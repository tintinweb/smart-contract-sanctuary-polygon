...
contract PlutoV2forge is Ownable, Implementor {
    ...
    IERC721Enumerable public plutoV2_contract_address; //= IERC721(0x3B8a54213a898ce4f04180155c0631e105368913); Polygon.
    ...
    // Events
    event Forged(
        address indexed _forger,
        uint16 indexed _forgeType,
    ...
    event AddReward(address indexed _claimer, uint8[2] _arrayOfRewards);
    event UserClaimedReward(
        address indexed _claimer,
        uint8 indexed rewardTraits
    );
        ...
        )
    {
        ...
        for (uint256 i = 0; i < sum; i++) {
            uint256 _localID = plutoV2_contract_address.tokenOfOwnerByIndex(
                _user,
                i
            );
            indexes[i] = _localID;
        ...
        internal
    {
        ...
        emit AddReward(_user, _arrayOfRewards);
    }
