...
contract Mintibbl is ERC721URIStorage, Ownable, Algoz {
    bool private s_verifyEnabled = true;
    uint256 private s_proofTtl = 10;
    uint256 private s_tokenCounter;
    mapping(string => bool) private s_usedTokenURIs;

    event NewDrawing(address indexed sender, uint256 indexed tokenId);

    constructor(address tokenVerifier)
        ERC721("Mintibbl", "MNTBL")
        Algoz(tokenVerifier, s_verifyEnabled, s_proofTtl)
    {}
