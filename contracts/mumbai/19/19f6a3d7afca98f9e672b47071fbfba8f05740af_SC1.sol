...
contract SC1 is Ownable, IAxelarExecutable {
    ...
    address public _BUSDADDRESS = 0x742DfA5Aa70a8212857966D491D67B09Ce7D6ec7; //testnet
    address public _THALESADDRESS = 0x703a4b0C368b98841eE690E1539CB80f18a78D55; //testnet
    address public _EABCDADDRESS = 0x28268fEf9E1590314485AF5B461E11ddeDbB7286; //testnet
    ...
    address public _SC3ADDRESS = 0x89fdf0B44aBc925e4266e9A11FEBf0829Fd89BD7  ;
    ...
    function crossChainBuyOrder(uint256 _amount, uint256 balance, string memory destinationChain, string memory destinationAddress, address userWallet) public{
        ...
        callContract("buyOrder", destinationChain,destinationAddress, userWallet, tken_amount * (100 * 1000 - feeForBuyer) * (10 ** eABCD_decimal) / (10 ** 16)/  1000 / 100 / priceFromOracle, 100000000000000);
