...
contract GNFT is ERC721,AccessControl {
    ...
    */
    function mintGNFT(address to,uint256 _numberOfTokens) external onlyOperator{
        require(
            to != address(0),
     ...
     */
    function burnNFT(uint256 id) external onlyOperator {
        _burn(id);
    }
