...
contract VRFD20 is VRFConsumerBaseV2 {
    ...
    event DiceRolled(uint256 indexed requestId, uint256 indexed roller);
     ...
     */
    function rollDice(uint256 roller) public onlyOwner returns (uint256 requestId) {
     ...
     */
    function house(uint256 player) public view returns (string memory) {
