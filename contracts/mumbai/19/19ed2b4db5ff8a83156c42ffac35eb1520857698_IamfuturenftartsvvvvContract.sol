...
// File: contracts/IamfuturenftartsvvvvContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract IamfuturenftartsvvvvContract is RamppERC721A {
    constructor() RamppERC721A("i am future nft arts vvvv", "RAMPP"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/2F33gHEXLOnUEWw0qDC4/contract-metadata";
    }
}
