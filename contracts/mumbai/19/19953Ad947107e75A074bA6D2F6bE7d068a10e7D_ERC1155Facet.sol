    ...
    AllowListInternal
{
    ...
    modifier validTime(uint256 _id, uint256 amount) {
        ...
        if (msg.sender == _owner() || _startTime < block.timestamp) {
    ...
    function batchCreate(
        ...
        success = ERC1155Lib.batchCreate(
            _amount,
            _maxSupply,
            _price,
            _tokenUri,
    ...
    {
        ERC1155Storage.TokenStructure storage s = ERC1155Storage.tokenData(_id);

        _price = s.price;
        _creator = s.creator;
        _tokenUri = s.tokenUri;
        _allowListEnabled = s.allowListEnabled;
    ...
    function setTokenData(
        ...
        s.allowListEnabled = _allowListEnabled;
