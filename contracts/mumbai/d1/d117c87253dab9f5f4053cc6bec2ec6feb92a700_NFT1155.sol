    ...
    ERC1155BurnableUpgradeable
{
    ...
    function saleToken(
        ...
        if (isChange == 1) {
            changePrice(tokenPrice, tokenId,from);
        } else if (isChange == 2) {
    ...
    function changePrice(uint256 value, uint256 tokenId,address from) public {
        require(_balances[tokenId][from] > 0, "Is Not a Owner");
        order_place[from][tokenId].price = value;
        emit ChangePrice(from, tokenId, value);
    }
