...
contract Stakeable {
    ...
    * @notice Staked event is triggered whenever a user stakes tokens, address is indexed to make it filterable
     ...
     */
    uint256 internal rewardPerHour = 10000;//lo cambio para que sea un 0.01% a la hora
    ...
    */
     ...
     function _restake() internal {
        ...
        for (uint256 s = 0; s < summary.stakes.length; s += 1){
           totalreward = totalreward+ calculateStakeReward(summary.stakes[s]);
      ...
      // summary.total_amount = totalStakeAmount;
         ...
         // Grab user_index which is the index to use to grab the Stake[]
        require(totalreward >0, "Staking: Cannot withdraw more than you have staked");
        _stake(totalreward);
     ...
     function _withdrawallStake() internal returns(uint256){
        // totalStakeAmount is used to count total staked amount of the address
   ...
   */
    ...
    * @notice withdrawStake is used to withdraw stakes from the account holder
    ...
    function withdrawallStake()  public {
      ...
      uint256 amount_to_mint = _withdrawallStake();
      // Return staked tokens to user
      _mint(msg.sender, amount_to_mint);
    }
