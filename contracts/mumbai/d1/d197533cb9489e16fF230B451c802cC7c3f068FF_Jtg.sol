...
contract Jtg is ERC721Enumerable, Ownable, ReentrancyGuard {

	uint256 public TOKEN_MAX_AMOUNT = 325;
	uint256 public TOKEN_PER_TX = 5236;
	uint256 public TOKEN_PER_WALLET = 235;
	uint256 public PRICE = 783 ether;
	uint256 public constant TIME_FOR_GROWN = 1685913024596;
