    ...
    PausableUpgradeable
{
    ...
    event VCRevoked(uint256 indexed uuid, address indexed claimer);
    ...
    mapping(uint256 => bool) public isRegisteredVC;
    bytes32 public constant SIGNER_ROLE = keccak256("SIGNER_ROLE");

    IClaimer public ClaimerNFT;
    ...
    function generateUUID(
        ...
        bytes32 uuidBytes = keccak256(abi.encode(to, vcType));
    ...
    function registerVC(
        ...
        require(
            to == vc.credentialSubject.ethereumAddress ||
        ...
        require(!isRegisteredVC[uuid], "This VC has been registered");
    ...
    function revokeVC(address user, uint256 uuid) public whenNotPaused {
        require(
            hasRole(SIGNER_ROLE, msg.sender) || user == msg.sender,
            "No Access to Delete"
        );
        require(
        ...
        isRegisteredVC[uuid] = false;
        _burn(uuid);
        delete VCRegistryTable[user][uuid];

        emit VCRevoked(uuid, user);
    }
