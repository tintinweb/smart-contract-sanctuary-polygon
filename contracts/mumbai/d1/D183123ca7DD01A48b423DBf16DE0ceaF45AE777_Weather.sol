...
contract Weather is ChainlinkClient {
    ...
    constructor(
        ...
        setChainlinkOracle(weatherOracleAddr);
    ...
    /**
     * @notice Gets average temperature from  Chainlink Oracle
     * @param _from fromDate to get tempValue
     * @param _to toDate to get TempValue
     *
     */
    ...
    /**
     * @notice Reverts if sender is not oracle
     * @dev Emits the average temparature result
     * @param _requestId req Id for fulfilment
     * @param _result The temparature unit to emit
     */
    ...
    /**
     * @notice Gets totalRain from  Chainlink Oracle
     * @param _from fromDate to get rain
     * @param _to toDate to get rain
     *
     */
    ...
    /**
     * @notice Reverts if sender is not oracle
     * @dev Emits the total rain as result
     * @param _requestId req Id for fulfilment
     * @param _result The temparature unit to emit
     */
