...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x57A9d1d61eC0A8F62Be1bb258c28878d7Fc3e8e5];
  address public erc20Payable = 0x57A9d1d61eC0A8F62Be1bb258c28878d7Fc3e8e5;
    ...
    
{
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/uN8wCIU3xV5DBfnNSwIv/contract-metadata";
  }
...
// File: contracts/RepublicTestProjectContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract RepublicTestProjectContract is ERC721APlus {
    constructor() ERC721APlus("Republic Test Project", "RTP"){}
}
