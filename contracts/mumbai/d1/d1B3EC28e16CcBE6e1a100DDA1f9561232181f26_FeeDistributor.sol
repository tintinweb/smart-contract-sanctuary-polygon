...
contract FeeDistributor is Ownable, IFeeDistributor {
    ...
    function updateFeeDistribution(uint256[] memory _percentage, address[] memory _to) public onlyOwner {
        delete feeDistribution;
        _updateFeeDistribution(feeDistribution, _percentage, _to);
    ...
    function _updateFeeDistribution(
        ...
        require(_percentage.length == _to.length, "FeeDistributor: mismatched array lengths");
        ...
        require(percentageSum <= 10000, "FeeDistributor: exceeds 100.00%");
    }
}
