...
contract NewContract_6_3 {
    ...
    //0: original, 1:askedToReceive 2: received
    bool paused;
    ...
    function _8_SendThroughAdmin(address user) public 
    {
        ...
        require(balanceOfUser[user] ==1, "the user is not asked to receive or already received doc of this contract");
    ...
    function _29_state(address _owner) public view returns (uint256)
    {
        return balanceOfUser[_owner];   
        //0 means not asked to sign, 1 means asked to sign, 2 means received token
    }
