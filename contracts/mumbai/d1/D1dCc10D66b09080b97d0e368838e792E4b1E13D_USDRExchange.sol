...
contract USDRExchange is AddressAccessor, IExchange, Pausable {
        ...
        onlyRole(CONTROLLER_ROLE)
    {
        ...
        uint256 minted = stats.tngblToUSDR + stats.underlyingToUSDR;
        ...
        if (minted > reduceBy) {
            ...
            if (gains < treasuryValue.total / 1e9) { // todo: ignore USDR in treasury..?
                gains = treasuryValue.total / 1e9 - gains;
                if (gains > minGain) {
