...
contract CPITrackerOracle is Owned, ChainlinkClient {
    ...
    // Data
    uint256 public cpi_last = 27880200000; // Dec 2021 CPI-U, 278.802 * 100000000
    uint256 public cpi_target = 28114800000; // Jan 2022 CPI-U, 281.148 * 100000000
    uint256 public peg_price_last = 1e18; // Use currPegPrice(). Will always be in Dec 2021 dollars
    uint256 public peg_price_target = 1008414573783545311; // Will always be in Dec 2021 dollars
    ...
    uint256 public lastUpdateTime = 1642204800; // Jan 15 2022
    uint256 public ramp_period = 28 * 86400;
    uint256 public future_ramp_period = 28 * 86400;
    CPIObservation[] public cpi_observations;

    // Safety
    uint256 public max_delta_frac = 25000; // 2.5%
    ...
    function fulfill(bytes32 _requestId, uint256 result) public recordChainlinkFulfillment(_requestId)
    {
        ...
        emit CPIUpdated(result_year, result_month, result, cpi_target, peg_price_target, ramp_period);
    }
    ...
    event CPIUpdated(uint256 year, uint256 month, uint256 result, uint256 cpi_target, uint256 peg_price_target, uint256 ramp_period);
}