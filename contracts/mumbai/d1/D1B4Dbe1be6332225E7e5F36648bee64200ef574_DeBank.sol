...
contract DeBank
{
    ...
    //Users should specify how much money they want to lock for a specific time in minute
    function lock(uint lockMinute) public payable 
    {
        ...
        users[msg.sender]=locked(block.timestamp + (lockMinute*60),msg.value);
        emit LOCK (msg.sender,block.timestamp+lockMinute,msg.value);
    }
