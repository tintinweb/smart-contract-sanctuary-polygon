...
// File: contracts/BaseMeTestE.sol


// adapted by LAx for MetaMeShop
...
contract BaseMeTestE is ERC1155, Ownable, ERC1155Supply {
  ...
  string  public mytokenURI= "ipfs://QmVRhJ4tBDpqocpniSqKuNDLqXtC5CbJChpWi6e3956U5S/" ;

    uint256 private constant BaseMe1 = 1;
    uint256 private constant BaseMe2 = 2;
    uint256 private constant BaseMe3 = 3;
    uint256 private constant BaseMe4 = 4;
  ...
  modifier mintCompliance(uint256 amount) {
    require(amount > 0 && amount <= trxMintAmount, "Invalid mint amount!");
   ...
   function mint(uint256 amount)  mintCompliance(amount)
        public{
      _mint(msg.sender, setRandom(), amount, "0x00");        
      NftPerWallet[msg.sender] +=amount ;
} 
...
//for random id based 
  function setRandom() internal view returns (uint256) {
