...
contract Deed_V2 is BasicMetaTransaction, Initializable, OwnableUpgradeable {
    ...
    function transferPlatformFee(uint256 __estateId) public {
        ...
        require(
            IERC20(_erc20Address).allowance(msgSender(), address(this)) >=
                _platformFees,
