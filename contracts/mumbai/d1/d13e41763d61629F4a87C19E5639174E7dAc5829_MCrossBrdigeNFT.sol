...
contract MCrossBridgeNFTController is Ownable {
    ...
    address public desstinationNFT;

    mapping(address => bool) registerBridge;
    ...
    function unlock(uint128 chainId, bytes calldata payload) external {
        ...
        IMockCollection(desstinationNFT).mint(minter, tokenId);
    }
...
interface IMockCollection {
    function mint(address _minter, uint256 _tokenId) external;
}
