...
contract Escrow is ReentrancyGuard, IERC721Receiver {
    ...
    /// @dev allow admin to enable listing cooldown
    function updateCooldownState(bool newState) external onlyAdmin {
        _cooldownEnabled = newState;
    }
    ...
    function recoverNFT(address nftAddress, uint256 tokenId)
        ...
        nonReentrant
    {
        // approve the admin transfer nft
