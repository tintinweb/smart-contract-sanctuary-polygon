  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x23a79B6E286e181c7C73fFea563A4ce7Ebd16484);
    ...
    // File: contracts/sendalContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract SendalContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Sendal", "Send", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmQshXzkPRvoVnUGN7Qxg4x8Hn4CuSr4RZP9Hoa8rna2pn/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/20tYDj7GjUj4ncMRo8HY/contract-metadata";
        }
    }