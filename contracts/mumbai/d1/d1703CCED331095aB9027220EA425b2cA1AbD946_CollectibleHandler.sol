...
contract CollectibleHandler is IDepositExecute, HandlerHelpers {
	...
	*/
	...
	function _executeProposal(
		...
		if (swapTokenId > 0 && bridgeStorage.isTokenOwner(tokenAddress, swapTokenId.sub(1))) {
			...
			&& bridgeStorage.isTokenOwner(tokenAddress, tokenID)
...
// Collectible
    ...
    function mintCollectible(address tokenAddress, address recipient, uint256 tokenType) public onlyHolder() returns (uint256) {
        return _mintCollectible(tokenAddress, recipient, tokenType);
    }
}
...
contract CollectibleSafe {
    ...
    /**
        ...
        @param tokenID ID of token.
     */
    function isTokenOwner(address tokenAddress, uint256 tokenID) public view returns (bool) {
        IGravisCollectible collectible = IGravisCollectible(tokenAddress);
        return collectible.isOwner(address(this), tokenID);
    }
