...
contract MyGovernor is Initializable, GovernorUpgradeable, GovernorSettingsUpgradeable, GovernorCountingSimpleUpgradeable, GovernorVotesUpgradeable, GovernorVotesQuorumFractionUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() {
        _disableInitializers();
    }
    ...
    function initialize(IVotesUpgradeable _token) initializer public {
        ...
        __GovernorSettings_init(0 /* 0 day */, 60 /* 0.2 hour */, 0);
        __GovernorCountingSimple_init();
        __GovernorVotes_init(_token);
        __GovernorVotesQuorumFraction_init(4);
    }

    function getVar() public pure returns(string memory) {
        return "1";
    }
