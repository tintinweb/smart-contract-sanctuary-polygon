...
contract CryptoDadsTraitsInventory is Initializable, OwnableUpgradeable {
    ...
    function redeemCustomization(
        ...
        require(
            customizationsByAddress[_msgSender()][customizationIndex].applied ==
                false,
    ...
    function declineCustomizations(uint256[] memory customizationQueueIDs)
        external
        onlyModerator
    {
        for (uint256 i; i < customizationQueueIDs.length; i++) {
