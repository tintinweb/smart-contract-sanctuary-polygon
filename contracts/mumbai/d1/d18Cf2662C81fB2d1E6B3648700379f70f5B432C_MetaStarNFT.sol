...
contract MetaStarNFT is ERC721URIStorage, Ownable {
    ...
    string[3] internal s_metaStarTokenUris;
    ...
    constructor(string[3] memory metaStarTokenUris, uint256 maxStarsSupply, uint256 mintFee) ERC721("METASTAR NFT", "MST") {
        /**
    ...
    * - Emit event
    */
    function mintMetaStarNFT() public payable {
        ...
        _setTokenURI(newTokenId, s_metaStarTokenUris[newTokenId]);
