...
interface CollectionType3 {
    // Voyage
    function mint(address owner, uint256 tokenId, VoyageConfig calldata config) external;
}

interface CollectionType4 {
    // chest
    function mint(address addr, uint8 assetType, uint256 amount) external;
}
...
contract Airdrop is Ownable {
    ...
    event AirdropCollectionType4(uint256 index, address owner, uint8 assetType, uint256 amount);
