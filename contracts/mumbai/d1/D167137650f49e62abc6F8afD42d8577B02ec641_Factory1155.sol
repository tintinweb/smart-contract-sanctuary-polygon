...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new smartMFGUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        smartMFGUser1155Token token = smartMFGUser1155Token(address(addr));
...
contract smartMFGUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
