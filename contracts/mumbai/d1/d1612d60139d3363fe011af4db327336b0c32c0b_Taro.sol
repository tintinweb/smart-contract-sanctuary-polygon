...
contract Taro is ERC721, ERC721URIStorage, Ownable {
    ...
    /// @dev After we cut over to the permaweb base URI, lock it up so we can't change it back.
    ///      This is a one-time operation! Don't mess it up!
    function lockBaseTokenURI() external onlyOwner {
        baseTokenURILocked = true;
    }

    /// @dev Returns the id that will be used on the next mint request
