...
import "./CyberPunkUser1155Token.sol";
...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new CyberPunkUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        CyberPunkUser1155Token token = CyberPunkUser1155Token(address(addr));
...
contract CyberPunkUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
