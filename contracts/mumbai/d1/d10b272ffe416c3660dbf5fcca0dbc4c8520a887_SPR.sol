...
// File: contracts/SP!/upgradable/SafeMathUpgradeable.sol
...
// File: contracts/SP!/upgradable/IERC20Upgradeable.sol
...
// File: contracts/SP!/upgradable/Initializable.sol
...
// File: contracts/SP!/upgradable/ContextUpgradeable.sol
...
// File: contracts/SP!/ERC20Upgradable.sol
...
contract ERC20Upgradeable is Initializable, ContextUpgradeable, IERC20Upgradeable {
    ...
    //enablement function for token
    function _enable(bool _value) internal virtual {
        enabled = _value;
    }

    //checking enablement function for token
    function isEnable() internal virtual {
        require(enabled == true, "This token is disabled");
    }
...
contract SPR is ERC20Upgradeable{
    ...
    mapping(bytes4 => bool) public isRun;
    mapping(bytes4 => bool) public isColdWalletAddressSet;
    ...
    function initialize(address _owner) external initializer {
        __ERC20_init("Sportiqo-T1", "SPQ-T1");
    ...
    function sendTo(address from, address to, uint256 amount) public returns(bool){
        ...
        require(from != seedWallet, "Cannot send funds from cold wallet");
        require(from != airdropWallet, "Cannot send funds from cold wallet");
        require(from != marketWallet, "Cannot send funds from cold wallet");
        require(from != foundersWallet, "Cannot send funds from cold wallet");
        require(from != treasuryWallet, "Cannot send funds from cold wallet");
        require(from != liquidityWallet, "Cannot send funds from cold wallet");
        require(from != dummyWallet, "Cannot send funds from cold wallet");
        require(from != angelWallet, "Cannot send funds from cold wallet");
        require(from != operationalWallet, "Cannot send funds from cold wallet");
