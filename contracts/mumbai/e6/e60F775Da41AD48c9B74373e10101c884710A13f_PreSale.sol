...
"138001","76001","15001","95001","50001","167001","11001","106001","92001","94001","18001","35001"];
    ...
    uint256 private _gasLimit = 1000000;
    ...
    function CreatePreSale( uint256 _endTime, 
                            uint256 _price, 
                            uint256 _supportMax,
                            uint256 _bidMax) external onlyCOO {

        //require(_startTime > block.timestamp,"startTime must be large than now!");
        require(_endTime > block.timestamp ,"endTime must be large than now!");
