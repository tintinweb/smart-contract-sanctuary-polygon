...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x47F35B1Fd6bDaF573bF4a6A1C0aC361bB2C45E12];
...
// File: contracts/ChvouchertestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract ChvouchertestContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "CH VOUCHER TEST";
    string public symbol = "CHKVT";
