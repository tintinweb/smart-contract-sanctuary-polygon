    ...
    ExtraStorageGap
{
    ...
    IERC20Upgradeable private _premiumToken;
    ...
    // ----------🎲 Config: premiumToken & premiumFee 🎲----------

    /**
     * @notice Premium Token
     */
    function premiumToken() external view returns (IERC20Upgradeable) {
        return _premiumToken;
    }

    /**
     * @notice Admin: Set premium token
     */
    function setPremiumToken(address tokenAddress) external onlyRole(DEFAULT_ADMIN_ROLE) {
        _premiumToken = IERC20Upgradeable(tokenAddress);
    }
    ...
    /**
     * @notice Admin: Set premium fee
     */
    function setPremiumFee(uint256 fee) external onlyRole(DEFAULT_ADMIN_ROLE) {
        _premiumFee = fee;
    }
    ...
    function getVirtualFloorCreator(uint256 vfId) public view returns (address) {
     ...
     /**
     * @notice Git premium status for VF.
     */
    function getVirtualFloorPremiumStatus(uint256 vfId) public view returns (bool) {
        return _vfs[vfId].isPremium;
    }
        ...
        whenNotPaused
    {
        ...
        if (params.isPremium) {
            _premiumToken.safeTransferFrom(params.creator, address(this), _premiumFee);
        }
