...
contract REGPALS is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function mint(uint256 _quantity) external payable {
    ...
    require(!paused);
    require(_quantity > 0);
    require(_quantity <= availableTokens);
  ...
  function setavailableTokens(uint256 _newavailableTokens) public onlyOwner {
    availableTokens = _newavailableTokens;
  }
