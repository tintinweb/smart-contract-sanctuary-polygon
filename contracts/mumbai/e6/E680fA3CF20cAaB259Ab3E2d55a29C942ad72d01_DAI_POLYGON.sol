    ...
    ContextMixin
{
    ...
    function initialize()
        ...
        initializer
    {
      setName("(PoS) Dai Stablecoin");
      setSymbol("DAI");
      setDecimals(18);
      _setupContractId(string(abi.encodePacked("Child", "DAI")));
      _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
      _setupRole(DEPOSITOR_ROLE, address(0xb5505a6d998549090530911180f38aC5130101c6));
      _initializeEIP712("(PoS) Dai Stablecoin", ERC712_VERSION);
    }
...
contract DAI_POLYGON is UChildERC20 {
