...
contract OmniseaONFT721Psi is ONFT721Core, IOmniseaONFT721Psi, ERC721Psi {
    ...
    address private immutable _lzEndpoint = 0x6aB5Ae6822647046626e83ee6dB8187151E1d5ab;
    IOmniseaDropsScheduler private immutable _scheduler = IOmniseaDropsScheduler(0xc3e5a8A1c3B0b4c81F85Ec322554187B3575C478);
    ...
    constructor(
    ...
    ) ERC721Psi(params.name, params.symbol) ONFT721Core(250000, _lzEndpoint) {
        ...
        owner = _owner;
        _royaltyAmount = params.royaltyAmount;
    }
    ...
    function claimRoyalties() external {
        (bool p1,) = payable(revenueManager).call{value: (address(this).balance / 10)}("");
        require(p1, "!p1");
        (bool p2,) = payable(owner).call{value: (address(this).balance)}("");
        require(p2, "!p2");
    }
...
abstract contract ONFT721Core is NonblockingLzApp, ERC165, ReentrancyGuard, IONFT721Core, IERC2981Royalties {
    ...
    uint24 internal _royaltyAmount;
