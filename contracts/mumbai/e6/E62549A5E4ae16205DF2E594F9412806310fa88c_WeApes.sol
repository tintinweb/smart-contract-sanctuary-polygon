...
contract WeApes is ERC721A, Ownable, VRFConsumerBase {
  ...
  function pickAWinner() public onlyOwner {
    ...
    require(tokenContract.ownerOf(currentPrize.tokenId) == address(this), "Must have token");
    require(LINK.balanceOf(address(this)) >= fee, "Not enough LINK");
    requestRandomness(keyHash, fee);
  }

  function returnToken(address tokenAddress, uint256 tokenId) public onlyOwner {
    IERC721 tokenContract = IERC721(tokenAddress);
