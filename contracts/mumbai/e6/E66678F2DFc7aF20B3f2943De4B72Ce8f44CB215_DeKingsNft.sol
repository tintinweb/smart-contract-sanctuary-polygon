...
contract DeKingsNft is ERC721Enumerable, AccessControlEnumerable{
    ...
    constructor (string memory name_, string memory symbol_, string memory baseURI_, string memory contractURI_, address openSeaProxy_)ERC721(name_, symbol_) {
    ...
    /**
     * @dev Mint a multiple tokens till not more than the maxSupply
     */
    function mintMultiple(address to, uint256 amount) public returns (bool) {
        ...
        require((_lastTokenId + amount) <= maxSupply, "mint: max supply reached");
   ...
   */
    function isApprovedForAll(address owner, address operator) public override(IERC721, ERC721) view returns (bool) {
