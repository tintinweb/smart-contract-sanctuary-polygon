...
contract ZodiacHero is ERC721, DefaultOperatorFilterer, Ownable, ERC2981 {
    ...
    address public premintwallet = 0xb3CC4Ef0bDd94e8F8D972FA65f7169EC84Af2775;
    ...
    function bulkPreMintNFTs(uint256[] memory startingIDArray, uint256[] memory endingIDArray) public onlyOwner {
        for (uint256 x = 0; x < 24; x++) {
            preMintNFTs(startingIDArray[x], endingIDArray[x]);
        }        
    }
