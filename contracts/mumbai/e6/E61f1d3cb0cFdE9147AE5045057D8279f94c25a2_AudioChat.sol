...
function _getAddressIndex(bytes32 our_id) view private returns (uint creator_index) {
    bytes32[] storage list_of_addresses = address_to_audio_chat[msg.sender];
...
function deleteAudioChat(bytes32 audio_chat_id) public {
    ...
    address_to_audio_chat[old_audio_chat_state.creator][_getAddressIndex(audio_chat_id)] = 
    address_to_audio_chat[old_audio_chat_state.creator][chats_length - 1];
