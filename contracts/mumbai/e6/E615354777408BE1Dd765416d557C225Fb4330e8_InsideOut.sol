...
contract InsideOut is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
  ...
  function safeMint() external payable {
	if (msg.sender != owner()) {
		require(msg.value >= mintPrice, "ERC721: Insufficient balance!");
	}
	  
    require(!isPaused, "ERC721: Minting is paused");
