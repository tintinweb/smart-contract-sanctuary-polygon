...
contract SquidBets is SquidBetsCore, ReentrancyGuard {
    ...
    function claimBetCanceledRound(uint256 _roundID) external {
        ...
        uint256 roundBetAmount = eventData[roundData[_roundID].eventID]
            .roundBetAmount;
        roundData[_roundID].bettingAmount -= roundBetAmount;
        eventData[roundData[_roundID].eventID].totalAmount -= roundBetAmount;
    ...
    function transferTotalEntryFeesToPrizePool(
        ...
        super.transferTotalEntryFeesToPrizePool(_eventID);
