...
contract NoteChain {
    ...
    function managerRegisterNewAuthor(address _authorAddress, string calldata _authorName, string calldata _newIpfsFileHash) external requireValidOrigin requireContractOperator {
