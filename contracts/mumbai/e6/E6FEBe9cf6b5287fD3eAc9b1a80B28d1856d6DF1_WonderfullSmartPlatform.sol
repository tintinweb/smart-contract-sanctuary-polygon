...
contract WonderfullSmartPlatform {
    ...
    uint256[20] private invitePercents = [600, 200, 300, 400, 300, 100, 100, 100, 50, 50, 50, 50, 30, 30, 30, 30, 30, 30, 30, 30];
    ...
    constructor() {
        usdt = IERC20(0x3aAFeA47Be9D23cCDb516Fa1fC196b3aBcF02cAB);
        defaultRefer = 0xD9c15246107696b2Bc170967022A3B15Cf5F1A82;
        feeReceiver1 = 0xD9c15246107696b2Bc170967022A3B15Cf5F1A82;
        feeReceiver2 = 0xD9c15246107696b2Bc170967022A3B15Cf5F1A82;
    ...
    function withdraw() external {
        ...
        usdt.transfer(feeReceiver1, incomeFee/2);
        usdt.transfer(feeReceiver2, incomeFee/2);
    ...
    function getContractInfos() external view returns(address[4] memory infos0, uint256[10] memory infos1, bool freezing) {
        ...
        infos0[1] = feeReceiver1;
        infos0[2] = feeReceiver2;
        infos0[3] = defaultRefer;
        infos1[0] = startTime;
