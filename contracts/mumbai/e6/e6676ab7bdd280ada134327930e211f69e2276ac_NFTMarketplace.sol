    ...
    PausableUpgradeable
{
    ...
    event MarketItemSold(uint256 indexed tokenId, address seller, address indexed owner, uint256 price, bool indexed sold);
    event MarketItemPriceChanged(uint256 indexed tokenId, address indexed seller, address indexed owner, uint256 price, bool sold);

    function initialize() public initializer {
        listingPrice = 0.025 ether;
        __ERC721_init("TRUEAVATARTEST", "TAVTT");
        __Ownable_init();
        __Pausable_init();
    ...
    function createToken(string memory NftURI, uint256 price) public payable whenNotPaused returns (uint256) {
        _tokenIds.increment();
    ...
    function resellToken(uint256 tokenId, uint256 price) public payable whenNotPaused nonReentrant {
        ...
        emit MarketItemPriceChanged(tokenId, msg.sender, address(this), price, false);
    }

    /* Creates the sale of a marketplace item */
    /* Transfers ownership of the item, as well as funds between parties */
    function createMarketSale(uint256 tokenId) public payable whenNotPaused nonReentrant {
        ...
        emit MarketItemSold(tokenId, idToMarketItem[tokenId].seller, idToMarketItem[tokenId].owner, price, true);
    }
