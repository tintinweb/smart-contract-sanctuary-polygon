...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB40A14BEBa6861a89D877F3cfbb6EcCaE823eB2d;
...
contract WISZR is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xD8a4Df730BbCf0b4f3Bd3ed5F7afA6ec1A90ed44;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 4687000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "WISZR";
    string private _symbol = "WISZR";
