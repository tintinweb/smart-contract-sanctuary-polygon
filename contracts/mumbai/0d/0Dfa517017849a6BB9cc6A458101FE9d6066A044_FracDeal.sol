...
contract FracDeal is ERC1155, Governed{


  constructor() ERC1155("https://emote.one/assets/properties/{id}.json", "FRACDEAL Test Contract", "FRXX1"){
    owner = msg.sender;
  }
  ...
  function mintCustom(uint256 amount, bytes memory data) public isAdmin{
    /**
     * All minted assets will be deposited into _owner
     * _owner will later distribute assets across recipients
     */
     _mint(msg.sender, ++currentTokenIndex, amount, data);
  }
}
