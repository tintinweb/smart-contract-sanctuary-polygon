...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  abstract contract Allowlist is Ownable {
        ...
        , Allowlist
    {
        ...
        string private IPFSTokenURI = "ipfs://QmUBTQMF3aF42NBZUfYr2NsbDVmd2hW3yJFn81NTtGMTxK/";
    ...
    // File: contracts/cryptoSlippersContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract CryptoSlippersContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("CryptoSlippers", "CSL", _proxyRegistryAddress)
        {}

        

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/E3zD6HcGtjXM8Zw8KCNJ/contract-metadata";
        }
    }