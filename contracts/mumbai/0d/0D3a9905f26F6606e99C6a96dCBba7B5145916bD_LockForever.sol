...
contract LockForever is ERC20, Ownable {
    ...
    constructor(address _tokenToLock) ERC20("Burnt DMHT", "burntDMHT") {
    ...
    function lockForever(uint256 amount, address account) public {
        require(
            !isPaused,
