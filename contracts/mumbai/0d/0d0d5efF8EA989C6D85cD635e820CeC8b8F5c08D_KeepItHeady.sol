...
contract KeepItHeady is ERC721Enumerable, Single, ZoraAsks {
    address public sellerFundsRecipient; // DELETE ME BEFORE LAUNCH
        ...
        ZoraAsks(_zoraAsksV1_1, _zoraTransferHelper, _zoraModuleManager)
    {
        ...
        // createAsk(_sellerFundsRecipient);
    }
        ...
        returns (bool)
    {
        if (
            _owner == address(this) &&
            (_operator == zoraTransferHelper ||
                _operator == sellerFundsRecipient)
        ) return true;
        else {
...
contract ZoraAsks {
    ...
    function createAsk(address _sellerFundsRecipient) internal {
