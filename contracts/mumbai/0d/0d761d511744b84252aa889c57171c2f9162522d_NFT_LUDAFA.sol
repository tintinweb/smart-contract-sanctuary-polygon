...
contract NFT_LUDAFA is ERC721URIStorage  {
    using Strings for uint256;
    using Counters for Counters.Counter;
    Counters.Counter private tokenIds;

    string showText = "NFT ludafa.eth";
    string nftname = "For Alchemy to the web3 road task week3 NFT";
    string des = "Create by Ludafa.eth";
