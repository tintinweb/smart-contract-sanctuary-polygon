...
contract NFTArt is ERC721Enumerable, Ownable{
    ...
    address constant public PREMINT_ADDRESS = 0x771557dE135c8Ed3a2B2F4eb23dEff0A4f76cD8f;
    ...
    address public feeAddress = 0x771557dE135c8Ed3a2B2F4eb23dEff0A4f76cD8f;
    ...
    uint256 public fiatRate = 0.81 ether;             // for author royalty, in 10^(-18) fiat units per 1 ether
