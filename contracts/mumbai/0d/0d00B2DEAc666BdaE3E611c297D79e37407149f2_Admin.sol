...
contract Admin is Initializable, AccessControl, BasicMetaTransaction {
    ...
    function tokenCreation(
        ...
        synthFactory.createToken(_name, _symbol,_decimals, _owner, _totalSupply,tokenID);
    }
...
interface ISynthFactory {
    ...
    function createToken(string memory name_,string memory symbol_,uint256 decimals_,address owner_,uint256 totalTokenSupply_,uint256 tokenID) external;
