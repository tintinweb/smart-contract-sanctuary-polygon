...
contract CreatureAccessory is ERC1155Tradable {
    constructor()
        ERC1155Tradable(
            "Go!Bots by Health Hero",
            "GOB",
            "https://ipfs.io/ipfs/QmT2dmawy2pFwsPUpEgMuksEhR2EHmZ9j2dbbVo5Y57jdJ/{id}"
        ) {}

    function contractURI() public pure returns (string memory) {
        return "https://ipfs.io/ipfs/QmT2dmawy2pFwsPUpEgMuksEhR2EHmZ9j2dbbVo5Y57jdJ/testContractMetadata.json";
    }
}
...
contract ERC1155Tradable is ContextMixin, ERC1155, NativeMetaTransaction, Ownable {
  ...
  /**
   * Override isApprovedForAll to whitelist user's OpenSea accounts to enable gas-free listings.
   */
