...
contract ERC1155Virtualness is  
    ...
    */
    function lazyMint(
        ...
        require(_amount > 0, "ERC1155: amount incorrect");
    ...
    /**
    * Override isApprovedForAll to auto-approve Vness protocol contract
    */
    function isApprovedForAll(
        address _owner,
        address _operator
    ) public override view returns (bool isOperator) {
        // if Vness protocol contract is detected, auto-return true
       if (hasRole(MINTER_ROLE, _operator) ) {
            return true;
        }
