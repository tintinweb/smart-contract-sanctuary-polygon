    ...
    PausableUpgradeable
{
    ...
    function setTokenState(uint256 _id, uint256 _state) public onlyOwner {
    ...
    function mint(address owner, uint256 quantity, string[] memory cidArr, string[] memory offChainIds) external onlyOwner {
