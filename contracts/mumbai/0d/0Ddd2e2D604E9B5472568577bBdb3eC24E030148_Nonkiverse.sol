...
contract Nonkiverse is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    uint256 public constant MAX_SUPPLY = 5555;
    uint256 public constant MAX_WHITELIST_MINTS = 2;
    uint256 public constant MAX_ALLOWLIST_MINTS = 2;
    uint256 public constant MAX_PUBLIC_MINTS = 10;
    
    uint256 public constant TICKET_PORTAL_LIMIT = 1111;
    ...
    function ticketMint(uint256 nRegularTickets, uint256 nPlatiumTickets) external {
