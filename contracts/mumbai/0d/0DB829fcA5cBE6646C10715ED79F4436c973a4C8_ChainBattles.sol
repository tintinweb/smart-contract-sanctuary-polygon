...
contract ChainBattles is ERC721URIStorage  {
    ...
    function generateCharacter(uint256 tokenId) public returns(string memory){
        ...
        '<text x="50%" y="60%" class="base" dominant-baseline="middle" text-anchor="middle">', "Speed: ",getStrength(tokenId),'</text>',
        '<text x="50%" y="70%" class="base" dominant-baseline="middle" text-anchor="middle">', "Speed: ",getLife(tokenId),'</text>',
        '</svg>'
    );
    return string(
        abi.encodePacked(
    ...
    function mint() public {
        ...
        tokenIdToSpeed[newItemId] = 0;
        tokenIdToStrength[newItemId] = 0;
        tokenIdToLife[newItemId] = 0;
    ...
    function train(uint256 tokenId) public {
        ...
        tokenIdToSpeed[tokenId] = currentSpeed + 1;
        tokenIdToStrength[tokenId] = currentStrength + 1;
        tokenIdToLife[tokenId] = currentLife + 1;
