...
// File: contracts\AuraToken.sol

pragma solidity 0.6.12;


// AuraToken with Governance.
contract AuraToken is ERC20("AuraSwap Token", "AURA"), Ownable {

    /// @notice Total number of tokens
    uint256 public constant maxSupply = 100_000_000e18; // 100_000_000 Aura
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "AURA::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "AURA::delegateBySig: invalid nonce");
        require(now <= expiry, "AURA::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "AURA::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "AURA::_writeCheckpoint: block number exceeds 32 bits");
