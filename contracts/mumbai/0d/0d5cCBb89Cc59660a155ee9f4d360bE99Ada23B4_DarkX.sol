...
// 21(WEI) with 6 zeros * (10^ 18 display decimals spots) || (21 * 10^6) or 21_000_000 total
    ...
    uint256 public _maxTxAmount = 11 * 10**5 * (10 ** _decimals); // 1,100,000 = 5.2% of supply
    uint256 public _walletMax = 42 * 10**5;
    ...
    constructor() Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x6C77B1284165E20F6feFa55E854d2A9103EFFA9F;
        marketingWallet = 0x13d423e789F614c3d3e06F47895611c2bb6c2e91;
        devWallet = 0x45EEdF40deB75589AaEA65A72CFA1cb36C6EFA02;
