...
contract RajTestt is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Raj Test-1", "RT-1") {
    setHiddenMetadataUri("ipfs://QmTiW3STAxMGWqQifKjUgxBrLLtDomdt4d6NXD7uh2avw4/hidden.json");
  }
