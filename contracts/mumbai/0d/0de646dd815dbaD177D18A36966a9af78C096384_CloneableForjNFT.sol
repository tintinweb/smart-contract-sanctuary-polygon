...
contract CloneableForjNFT is ERC1155, ReentrancyGuard{
    ...
    // mint
    function mint(uint256 tokenId, address mintAddress)
        external
        onlyStarted
        onlyAdminOrOwner(msg.sender)
    {
    ...
    function batchmint(uint256[] memory tokenIds,uint256[] memory amounts, address[] memory mintAddresses)
        external
        onlyAdminOrOwner(msg.sender)
    {
        require(
