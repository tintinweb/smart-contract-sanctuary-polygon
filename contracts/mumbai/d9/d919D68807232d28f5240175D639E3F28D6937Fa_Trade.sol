...
contract Trade {
        ...
        returns (bool)
    {
        require(
            _buyerFee <= 25,
            "Fee: buyerFee should be less than or equal to 2.5%"
        );
        buyerFeePermille = _buyerFee;
        ...
        returns (bool)
    {
        require(
            _sellerFee <= 25,
            "Fee: sellerFee should be less than or equal to 2.5%"
        );
        sellerFeePermille = _sellerFee;
    ...
    function traderAsset(Order calldata order, Fee memory fee)
        external
        returns (bool)
    {
    ...
    function verifySellerSign(
        ...
        bytes32 hash = keccak256(
            abi.encodePacked(assetAddress, tokenId, amount)
        );
        require(
    ...
    function verifyBuyerSign(
        ...
        bytes32 hash = keccak256(
            abi.encodePacked(assetAddress, tokenId, price)
        );
        require(
