...
interface IMemo {
    function rebase( uint256 isaProfit_, uint epoch_) external returns (uint256);
...
contract ISAStaking is Ownable {
    ...
    /**
        @notice stake ISA to enter warmup
        @param _amount uint
        @return bool
     */
    function stake( uint _amount, address _recipient ) external returns ( bool ) {
        ...
        IERC20( ISA ).safeTransferFrom( msg.sender, address(this), _amount );
    ...
    /**
        @notice retrieve sISA from warmup
    ...
    /**
        @notice forfeit sISA in warmup and retrieve ISA
     */
    function forfeit() external {
        ...
        IERC20( ISA ).safeTransfer( msg.sender, info.deposit );
    }
    ...
    function unstake( uint _amount, bool _trigger ) external {
        ...
        IERC20( ISA ).safeTransfer( msg.sender, _amount );
    }

    /**
        @notice returns the sISA index, which tracks rebase growth
        @return uint
     */
    ...
    /**
        @notice returns contract ISA holdings, including bonuses provided
        @return uint
     */
    function contractBalance() public view returns ( uint ) {
        return IERC20( ISA ).balanceOf( address(this) ).add( totalBonus );
    }
