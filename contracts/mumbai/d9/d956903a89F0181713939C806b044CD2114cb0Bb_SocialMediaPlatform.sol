...
contract SocialMediaPlatform {
    ...
    function registerUser(string memory _username, string memory _aboutMe) public {
    ...
    function getInbox(address _userAddress) public view returns (uint256[] memory) {
        return users[_userAddress].inbox;
    }
    
    function getFeed() public view returns (string[] memory, string[] memory) {
        uint256 totalPosts;
