...
contract ChainBattles is ERC721URIStorage {
    ...
    function train(uint256 tokenId) public {
        ...
        tokenIdToStats[tokenId].speed += random(tokenIdToStats[tokenId].speed);
        tokenIdToStats[tokenId].strength += random(
            tokenIdToStats[tokenId].strength
        );
        tokenIdToStats[tokenId].life += random(tokenIdToStats[tokenId].life);
