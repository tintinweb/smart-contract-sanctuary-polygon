...
// File: contracts/FFSmartContract.sol
...
contract FurFam is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  uint256 public currentSupply = 0;
  
  string public baseURI = "QmRqgg5f7S1Gob6Q51pq5czHxALFqyks4rNVnZR9ZM6dFq/";

  constructor() 
    ERC721("Fur Fam", "FF")
    RandomlyAssigned(3,1) 
    {
