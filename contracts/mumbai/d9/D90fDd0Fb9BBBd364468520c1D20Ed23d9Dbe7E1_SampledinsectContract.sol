...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x7d49F95f69a0e12E3dbe831Dccdf3481fc6cdf13];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmNVw6NmhG59x8h9Xsh6m97ckb2V3zKcEEzXXmgHXvqqeE/";
...
// File: contracts/SampledinsectContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SampledinsectContract is RamppERC721A {
    constructor() RamppERC721A("sampledinsect", "SAML"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/heGZW1LAXw99gx9OsKO0/contract-metadata";
    }
}
