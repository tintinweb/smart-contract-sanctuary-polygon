  ...
  IStaking
{
  ...
  modifier onlyFactoryOwner {
    require(_msgSender() == factoryOwner(), "!factoryOwner");
    _;
  }

  modifier isPermitted {
    require(
      _msgSender() == factoryOwner() ||
      _msgSender() == owner(),
      "!permitted"
    );
    _;
  ...
  modifier whenStakePaused {
    require(isStakePaused, "staking active");
    _;
  }
  ...
  function factoryOwner() internal view virtual returns(address) {
  ...
  function _stake(
    ...
    // validate existance of lock index
    require(_lockIndex < lockNumber, "!lockIndex");
  ...
  function _unstake(
    ...
    emit Unstaked(
      ...
      stakeDetail.amount,
      stakeDetail.reward,
      (stakeDetail.amount * lock[stakeDetail.lockIndex].feeInPercent_d2) / 10000,
  ...
  function setLimit(
    ...
    require(
      ...
      lock[_lockIndex].filled < _amount, // validate new amount not below than filled amount
      "bad"
    );
