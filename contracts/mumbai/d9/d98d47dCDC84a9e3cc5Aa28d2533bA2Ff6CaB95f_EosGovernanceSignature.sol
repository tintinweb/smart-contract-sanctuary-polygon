...
contract EosGovernanceSignature is EIP712Upgradeable{
    ...
    function ___eosSigner_init(string memory domain, string memory version) external initializer{
    ...
    function _hash(EOS memory _eos) internal view returns (bytes32) {
        return _hashTypedDataV4(keccak256(abi.encode(
                keccak256("EOS(address contractAddress,address userAddress,uint256 amount,uint256 paymentType,uint256 nonce)"),
