    ...
    AccessProtectedUpgradable
{
    ...
    function setupTokenReceipt(
        ...
        require(
            _tokenType == TOKEN_TYPE_ERC20 ||
                _tokenType == TOKEN_TYPE_ERC721 ||
                _tokenType == TOKEN_TYPE_ERC1155,
            "Token type must be ERC20, ERC721 or ERC1155"
        );

        TokenReceiptable tokenReceiptable = TokenReceiptable(_receiptToken);
        require(
            tokenReceiptable.originalToken() == _originalToken,
            "Receipt token should be came from same original token"
        );
...
import "./TokenReceiptable.sol";

contract ERC20Receipt is
    ERC20,
    ERC20Burnable,
    AccessProtected,
    TokenReceiptable
{
    ...
    ) ERC20(name_, symbol_) TokenReceiptable(originalToken_) {}
    ...
    TokenReceiptable
{
    ...
    constructor(
        ...
        string memory symbol_,
        address originalToken_
    ) ERC721(name_, symbol_) TokenReceiptable(originalToken_) {}
...
contract ERC1155Receipt is
    ERC1155,
    ERC1155Burnable,
    AccessProtected,
    TokenReceiptable
{
    constructor(address originalToken_)
        ERC1155("")
        TokenReceiptable(originalToken_)
    {}
