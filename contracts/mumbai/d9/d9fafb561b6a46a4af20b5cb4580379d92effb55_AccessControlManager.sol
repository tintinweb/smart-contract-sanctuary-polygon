    ...
    UUPSUpgradeable
{
    ...
    function addPauser(address pauser) external override {
        grantRole(PAUSER_ROLE, pauser);
    }

    function removePauser(address pauser) external override {
        revokeRole(PAUSER_ROLE, pauser);
    }

    function isPauser(address pauser) external view override returns (bool) {
