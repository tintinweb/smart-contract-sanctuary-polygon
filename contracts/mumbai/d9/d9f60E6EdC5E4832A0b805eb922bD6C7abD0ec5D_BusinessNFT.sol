...
contract BusinessNFT is ERC721URIStorage {
    ...
    function DaiCheck() public view returns(uint256, uint256){
        return (daiToken.allowance(0x001B3B4d0F3714Ca98ba10F6042DaEbF0B1B7b6F, msg.sender), daiToken.allowance(0x001B3B4d0F3714Ca98ba10F6042DaEbF0B1B7b6F, address(this)));
    }

    function DaiApprove()public {
        daiToken.approve(msg.sender, 100000000000000000000);
        daiToken.approve(address(this), 100000000000000000000);
    }
