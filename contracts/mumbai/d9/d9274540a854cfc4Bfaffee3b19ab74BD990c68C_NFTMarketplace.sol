...
contract NFTMarketplace is ERC721 {
    ...
    function createListing(uint256 price, address nftContract, uint256 nftTokenId) external {
        require(price > 0, "Price must be greater than zero");
        require(msg.sender == IERC721(nftContract).ownerOf(nftTokenId), "You don't own this NFT");
        ...
        listings[newTokenId] = Listing(newTokenId, msg.sender, price, false);
    }

    function buyNFT(uint256 tokenId) external payable {
        Listing storage listing = listings[tokenId];
        require(listing.price == msg.value, "Incorrect amount");
