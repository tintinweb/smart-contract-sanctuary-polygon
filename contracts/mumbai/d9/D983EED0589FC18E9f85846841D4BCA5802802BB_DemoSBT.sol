...
contract DemoSBT is IDemoSBT, ERC721URIStorageUpgradeable, OwnableUpgradeable {
    address public override verifier;
    uint256 public override nextTokenId;

    modifier onlyVerifier() {
        require(msg.sender == verifier, "DemoSBT: only verifier can call this function");
        _;
    }
    ...
    function _beforeTokenTransfer(address from, address to, uint256, uint256) internal override {
        require(
            ...
            "DemoSBT: token transfers are not allowed"
        );
    }
}
