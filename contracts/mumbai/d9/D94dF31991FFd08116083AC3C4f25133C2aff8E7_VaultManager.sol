...
interface IStabilityPool {
    ...
    // function rewards(uint _rewardsToAdd) external;
...
contract VaultManager is OrumBase, Ownable, CheckContract, IVaultManager {
    ...
    */
    function batchLiquidateVaults(address[] memory _vaultArray) public override {
        ...
        if (totals.totalCollSurplus > 0) {
            ...
            collSurplusPool.receive_amatic_CollSurplusPool(totals.totalCollSurplus);
        }
        ...
        returns (LiquidationValues memory singleLiquidation)
    {
        ...
        _movePendingVaultRewardsToActivePool(amatic_Token ,_activePool, _defaultPool, vars.pendingDebtReward, vars.pendingCollReward);
    ...
    */
    ...
    function _movePendingVaultRewardsToActivePool(IaMATICToken amatic_Token, IActivePool _activePool, IDefaultPool _defaultPool, uint _OSD, uint _ROSE) internal {
    ...
    */
    function _redeemCloseVault(ContractsCache memory _contractsCache, address _borrower, uint _OSD, uint _ROSE) internal {
        ...
        collSurplusPool.receive_amatic_CollSurplusPool(_ROSE);
    }
    ...
    */
    ...
    function _applyPendingRewards(IActivePool _activePool, IDefaultPool _defaultPool, address _borrower) internal {
        if (hasPendingRewards(_borrower)) {
            ...
            _movePendingVaultRewardsToActivePool(amatic_Token , _activePool, _defaultPool, pendingOSDDebtReward, pendingROSEReward);
    ...
    function _redistributeDebtAndColl(IActivePool _activePool, IDefaultPool _defaultPool, uint _debt, uint _coll) internal {
        ...
        */
        ...
        _defaultPool.receive_amatic_DP(_coll);
    }
