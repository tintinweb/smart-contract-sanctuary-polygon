    ...
    Pausable
{
    ...
    modifier onlyOwnerOrManager() {
        require(
            (owner() == _msgSender() || managerAddresses[_msgSender()]),
            "AssetContractShared#onlyOwnerOrManager: CALLER_IS_NOT_MANAGER"
        );
        _;
    }
    ...
    modifier onlyOwnerOrMinter() {
        require(
            (owner() == _msgSender() || minterAddresses[_msgSender()]),
            "AssetContractShared#onlyOwnerOrMinter: CALLER_IS_NOT_MINTER"
        );
        _;
    }
    ...
    /**
     * @dev Allows owner to add a manager address
     */
    function addManagerAddress(address _address) public onlyOwnerOrManager {
        managerAddresses[_address] = true;
    }

    /**
     * @dev Allows owner to add a minter address
     */
    function addMinterAddress(address _address) public onlyOwnerOrMinter {
        minterAddresses[_address] = true;
    }

    /**
     * @dev Allows owner to remove a manager address
     */
    function removeManagerAddress(address _address)
        public
        onlyOwnerOrManager
    {
        delete managerAddresses[_address];
    }

    /**
     * @dev Allows owner to remove a minter address
     */
    function removeMinterAddress(address _address)
        public
        onlyOwnerOrMinter
    {
        delete minterAddresses[_address];
    }
