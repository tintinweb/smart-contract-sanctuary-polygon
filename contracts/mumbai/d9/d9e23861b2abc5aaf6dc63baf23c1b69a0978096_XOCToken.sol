...
no team token
no dev token
lp tokens are not locked because 100% of it be burned
...
token taxes are for auto burn and auto liquidity - auto burned lp tokens 
...
contract XOCToken is ERC20, Ownable {
    ...
    constructor(uint256[] memory myvar) ERC20("XOC TOKEN", "XOC") {  
        ...
        // IUniswapV2Router02 _router = IUniswapV2Router02(0x9876A5bc27ff511bF5dA8f58c8F93281E5BD1f21); // bsc mainnet
        ...
        // walletSetter = 0x68Af91fcFF9E1acb3a48808C699675c0efD9DD30; // wallet as setter 
        
        walletListings = 0xD666608538a40Ebed3873260161ac494cfFd08Fd; // test listings
        walletSetter = 0xE0038fB580ECd0340b6E9fbA68D7e2d151Ce1Db9; // wallet as setter 
