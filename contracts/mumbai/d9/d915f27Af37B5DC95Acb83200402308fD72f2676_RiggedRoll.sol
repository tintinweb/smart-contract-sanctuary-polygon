...
contract RiggedRoll is Ownable {
    ...
    event RiggedRollEvent(address indexed player, uint256 roll);
    ...
    function riggedRoll() public {
        require(address(this).balance >= .002 ether, "funds needed to rig and roll");
        bytes32 prevHash = blockhash(block.number - 1);
        ...
        emit RiggedRollEvent(address(this), roll);
