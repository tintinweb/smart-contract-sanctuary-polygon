...
contract ALP is StToken, IAlp {
        ...
        returns (uint256 val, uint256 leverageAv)
    {
        ...
        require(
            IERC20(_token).balanceOf(address(this)) >= val,
    ...
    function returnReserve(uint256 val) external {
        _positionBalances -= val;
    }
    ...
    function _getTotalPooled() internal view override returns (uint256) {
        return IERC20(_token).balanceOf(address(this)) + _positionBalances;
    }
