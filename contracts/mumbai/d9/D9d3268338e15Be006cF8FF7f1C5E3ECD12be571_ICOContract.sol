...
contract ICOContract is Owner, ReentrancyGuard {
    ...
    uint256 public maximumBuy_token1 = 10000;
    uint256 public maximumBuy_token2 = 10000;

    uint256 public salePrice_token1; // set salePrice with token decimals (e.g. USDT TOKEN 6 Decimals) 100000 = 0.1 USDT
    uint256 public salePrice_token2; // set salePrice with token decimals (e.g. LVLX TOKEN 18 Decimals) 10000000000000000000 = 10 LVLX
    ...
    constructor(address _address_token1, address _address_token2, uint256 _salePrice_token1, uint256 _salePrice_token2, address _address_referrals) {
        ...
        uint256 muldec_t1 = 10**18; // this is a muldec for 18 decimals
        uint256 muldec_t2 = 10**6;  // this is a muldec for 6 decimals
        set_mulDec(muldec_t1, muldec_t2);
        set_minimumBuy(1, 1);
        set_maximumBuy(10000, 10000);
    }
