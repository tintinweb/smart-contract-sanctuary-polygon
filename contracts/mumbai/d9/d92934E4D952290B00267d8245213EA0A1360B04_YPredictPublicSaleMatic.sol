...
contract YPredictPublicSaleMatic is Ownable, Pausable, ReentrancyGuard {
  ...
  address internal immutable i_matic_usd_priceFeed =
    0xd0D5e3DB44DE05E9F294BB0a3bEEaF030DE24Ada;
  address internal immutable i_usdt_usd_priceFeed =
  ...
  */
  ...
  constructor(IERC20 usdt_, IVestingHub vesting_) {
    s_usdt = usdt_;
    s_vesting = vesting_;
  }
  ...
  // function _getPriceOfGivenTokenInUSDT(int256 amount)
  //   internal
  //   view
  //   returns (int256)
  // {
  //   return
  //     _getDerivedPrice(i_usdt_usd_priceFeed, i_matic_usd_priceFeed, 18) *
  //     amount;
  // }
    ...
    returns (int256)
  {
    ...
    // return formmatedPriceOfTokensInUsdt;
  }
