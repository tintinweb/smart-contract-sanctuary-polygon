...
contract DroppableNFT is Ownable,ERC721,ERC721Enumerable,DroppableWithQR {
    ...
    constructor(string memory name_,string memory symbol_,string memory metadataURI_, string memory collectionURI_,uint256 maxId_) ERC721(name_,symbol_) {
    ...
    function contractURI() public view returns (string memory) {
        string memory baseURI = _baseURI();
        return string(abi.encodePacked(baseURI,collectionURI));
    }
