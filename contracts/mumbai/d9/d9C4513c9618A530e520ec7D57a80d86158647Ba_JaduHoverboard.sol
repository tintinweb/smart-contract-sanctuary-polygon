...
contract JaduHoverboard is ERC721Enumerable, AccessControl, Ownable {
    ...
    mapping(uint256 => string) public tokenMeta;

    constructor() ERC721("Jadu Hoverboards", "Hoverboard") {
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _setupRole(MINTER_ROLE, _msgSender());

        // tokenMeta[
        //     1
        // ] = "https://cloudflare-ipfs.com/ipfs/QmViYAPWJvM6k6Fvjwss3eMM2S2pE8iRoX6vnxvVziWakD?filename=1.json";
    }
    ...
    function setTokenMeta(string[] memory _tokenUrls) public returns (bool) {
        for (uint256 i = 0; i < _tokenUrls.length; i++) {
            tokenMeta[i + 1] = _tokenUrls[i];
        }
