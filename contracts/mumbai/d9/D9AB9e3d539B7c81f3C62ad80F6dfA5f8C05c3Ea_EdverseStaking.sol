...
using SafeMath for uint256;  
  ...
  IERC20 public ERC20 = IERC20(0x8c578C73aCf52679f2e42cc4fEA4Cf8Aa8ed8498);
  bool public paused = false; 

  uint public duration = 43200;// in Hours ;
...
constructor() { 
      DaysLimitRewardForStake[90] = 1000; // 1% ;
      DaysLimitRewardForStake[180] = 1800; // 1.8%;
     DaysLimitRewardForStake[365] = 3600; // 3.6%;
   }
