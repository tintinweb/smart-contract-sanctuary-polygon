...
contract Venue is VenueMetadata, VenueStorage {
    ...
    function updateVenueVersion(uint256 _eventTokenId, string memory _venueVersion) external {
        ...
        require(startTime >= block.timestamp, "ERR_112:Venue:Event ended");
    ...
    function updateVenueOwner(uint256 venueTokenId, address payable owner) internal {
