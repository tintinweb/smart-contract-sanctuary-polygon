...
contract Write is IExecutePlugin, BasePluginWithRules {
    ...
    constructor(address _registry) {
        PLUGIN_VERSION = 1;
        PLUGIN_NAME = PluginsList.SINGLE_WRITE_POST;
    ...
    function execute(
        ...
        uint256 postId = singlePost.writePost(postVars);
        require(postId > 0, "Write: wrong create single post");

        postVars.data = abi.encode(address(0), postId);
