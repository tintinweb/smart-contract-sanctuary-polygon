...
contract OpenStay is Ownable, ReentrancyGuard, IOpenStay {
    ...
    function addRental(
        ...
        _rentalProvider[id] = sender;

        emit RentalCreated(id, sender, rentalProperties, paymentSettings);
    }
    ...
    function editFeatures(uint256 rentalId, string[] memory features) external {
        require(_rentalIds[rentalId], "[editFeatures]: invalid rental id");
        require(_rentalProvider[rentalId] == msg.sender, "[editFeatures]: unauthorized");
    ...
    function editMaxGuests(uint256 rentalId, uint8 maxGuests) external {
        require(_rentalIds[rentalId], "[editMaxGuests]: invalid rental id");
        require(_rentalProvider[rentalId] == msg.sender, "[editMaxGuests]: unauthorized");
        require(maxGuests > 0, "[editMaxGuests]: max guests cannot ve zero");
    ...
    function editPricePerNight(uint256 rentalId, uint256 price) external {
        require(_rentalIds[rentalId], "[editPricePerNight]: invalid rental id");
        require(_rentalProvider[rentalId] == msg.sender, "[editPricePerNight]: unauthorized");
    ...
    function editVisibility(uint256 rentalId, bool isHidden) external {
        require(_rentalIds[rentalId], "[editVisibility]: invalid rental id");
        require(_rentalProvider[rentalId] == msg.sender, "[editVisibility]: unauthorized");
    ...
    function updatePaymentSettings(uint256 rentalId, PaymentSettings memory paymentSettings) external {
        require(_rentalIds[rentalId], "[updatePaymentSettings]: invalid rental id");
        require(_rentalProvider[rentalId] == msg.sender, "[updatePaymentSettings]: unauthorized");
...
interface IOpenStay {
    ...
    event UpdateRentalProperties(uint256 rentalId, RentalProperties rentalProperties);
    event UpdateRentalPaymentSettings(uint256 rentalId, PaymentSettings paymentSettings);
