...
contract exarMarketPlace is ERC721Holder, Initializable, OwnableUpgradeable, UUPSUpgradeable, ERC165{
    ...
    */
    ...
    external
    {
        ...
        require(msg.sender == IERC721(_nftAddress).ownerOf(_nftTokenid),"You are not the owner of NFT");
