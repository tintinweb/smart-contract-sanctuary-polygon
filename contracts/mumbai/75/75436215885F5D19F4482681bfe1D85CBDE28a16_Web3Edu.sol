...
library Math {
     ...
     * @dev Original c license (https://xn--2-umb.com/21/muldiv)
     * with further edit license.
     */
    function mulDiv(
        uint256 x,
        uint256 y,
...
// File contracts/CourseModule.sol
...
contract Registration is Managed {
    ...
    /**
     * @notice ≡ƒÆ░ WITHDRAWAL FUNCTIONS
     */
