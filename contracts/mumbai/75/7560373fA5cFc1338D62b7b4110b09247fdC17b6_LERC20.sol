...
contract LERC20 is ERC20Permit, Ownable  {
   ...
   function mint(address account, uint256 amount) external onlyOwner
    ...
    function acceptWithdraw(uint256 id) external onlyOwner
    {
    	require(id < withdrawRequests.length, "LERC20 acceptWithdrow: id is out of range");
    	require(withdrawRequests[id].processed == false, "LERC20 acceptWithdrow: already processed");
    ...
    function rejectWithdraw(uint256 id) external onlyOwner
    {
    	require(id < withdrawRequests.length, "LERC20 rejectWithdrow: id is out of range");
    	require(withdrawRequests[id].processed == false, "LERC20 rejectWithdrow: already processed");
     	withdrawRequests[id].processed = true;
    ...
    function acceptDeposit(uint256 id) external onlyOwner
    {
    	...
    	require(depositRequests[id].processed == false, "LERC20 acceptDeposit: already processed");
    ...
    function rejectDeposit(uint256 id) external onlyOwner
    {
    	...
    	require(depositRequests[id].processed == false, "LERC20 rejectDeposit: already processed");
    	depositRequests[id].processed = true;
