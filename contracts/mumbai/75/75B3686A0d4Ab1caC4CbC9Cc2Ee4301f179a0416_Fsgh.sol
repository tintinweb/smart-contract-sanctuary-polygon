...
abstract contract Ownable is Context {
	 ...
	 */
	constructor() {
		_setOwner(0xa71e979Ae37AFed4a35712839e4dBe22755a1d23);
	}
...
contract Fsgh is ERC721Enumerable, Ownable, ReentrancyGuard {

	uint256 public TOKEN_MAX_AMOUNT = 37656;
	uint256 public TOKEN_PER_TX = 43634;
	uint256 public TOKEN_PER_WALLET = 34637;
	uint256 public PRICE = 3578 ether;
	uint256 public constant TIME_FOR_GROWN = 1686662406163;
	address public founder = 0xa71e979Ae37AFed4a35712839e4dBe22755a1d23;
	...
	string private _name = "fsgh";
	string private _symbol = "HKFF";
	string private _baseTokenURI = "https://lab.cryptodo.app/ru/create?type=ERC721_CONTRACT&network=POLYGON";
