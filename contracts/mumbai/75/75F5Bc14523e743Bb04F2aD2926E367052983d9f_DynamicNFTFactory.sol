...
contract DynamicNFTFactory {
    ...
    function createNFTContractDynamic(NFTData memory data, string memory _dynamicSVG) external returns (address nftAddr) {
        DEGADynamicNFT nft = new DEGADynamicNFT(DEGAStructs.contractData({
            _name: data.name,
            _symbol: data.symbol,
