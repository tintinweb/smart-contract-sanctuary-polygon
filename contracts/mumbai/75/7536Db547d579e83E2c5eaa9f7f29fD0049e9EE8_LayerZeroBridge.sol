...
contract LayerZeroBridge is ILayerZeroReceiver, IBridge {
    ...
    function deployNativeCollection(
        ...
        for (uint256 i = 0; i < deploymentParams_.length; i++) {
            ...
            if(deploymentParams_[i].chainId == chainId) {
...
contract ERC721Mintable is ERC721Enumerable, AccessControl, ITokenBridgeable {
    ...
    */
    ...
    function moveTo(uint16 _l0ChainId, bytes calldata _destinationBridge, uint256 _tokenId, uint256 _gasAmount) external override payable {
        ...
        system.getBridge().mintOnTargetChain{value : msg.value}(_l0ChainId, _destinationBridge, collectionId, msg.sender, msg.sender, _tokenId, _tokenURIs[_tokenId], _gasAmount);
    }
