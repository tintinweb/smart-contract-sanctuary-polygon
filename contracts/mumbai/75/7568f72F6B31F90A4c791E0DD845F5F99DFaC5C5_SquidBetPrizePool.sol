...
contract SquidBetPrizePool is CustomAdmin, ReentrancyGuard {
    ...
    function winnerClaimPrizePool(address winner, uint256 amount) external {
        require(msg.sender == squidBet, "You can't call this function.");
        payable(winner).transfer(amount);
    }

    function setSquidBet(address _squid) public onlyAdmin {
        squidBet = _squid;
    }

    function setTreasury(address _ultiBetTreasury) public onlyAdmin {
        ultiBetTreasury = _ultiBetTreasury;
    }
