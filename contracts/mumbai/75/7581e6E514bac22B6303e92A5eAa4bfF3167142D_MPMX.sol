...
{    
    ...
    MintPass MintPassSale = MintPass(
        20 ether,   // _PriceStart
        0.5 ether,  // _PriceEnd
        1,          // _DefaultMaxUserPurchaseableAmount
        750,        // _MaximumAvailableForSale
        27923241,   // _StartingBlockTimestamp
        676446568952790000000,        // _SecondsBetweenPriceDecay
    ...
    MintPack MintPackSale = MintPack(
        ...
        27923241,   // _StartingBlockTimestamp
        676446568952790000000,        // Seconds Between Price Decay
        true,       // _ActivePublic
        true,       // _ActiveBrightList
        true,       // _AllowMultiplePurchases
        0x0         // Merkle Root
