...
// File: flashliquidity-chainlink-labs/libraries/SafeMathCopy.sol
...
// File: flashliquidity-chainlink-labs/libraries/Decimal.sol
...
// File: flashliquidity-chainlink-labs/interfaces/IWETH.sol
...
// File: flashliquidity-chainlink-labs/interfaces/IUniswapV2Pair.sol
...
// File: flashliquidity-chainlink-labs/@chainlink/contracts/src/v0.8/interfaces/AggregatorV3Interface.sol
...
// File: flashliquidity-chainlink-labs/@chainlink/contracts/src/v0.8/interfaces/KeeperCompatibleInterface.sol
...
// File: flashliquidity-chainlink-labs/@openzeppelin/contracts/utils/math/SafeMath.sol
...
// File: flashliquidity-chainlink-labs/@openzeppelin/contracts/utils/Address.sol
...
// File: flashliquidity-chainlink-labs/@openzeppelin/contracts/token/ERC20/IERC20.sol
...
// File: flashliquidity-chainlink-labs/@openzeppelin/contracts/token/ERC20/utils/SafeERC20.sol
...
// File: flashliquidity-chainlink-labs/FlashSwapper.sol
...
contract FlashSwapper is KeeperCompatibleInterface {
    ...
    uint256 minProfitInMATIC; // 9 decimals

    //AggregatorV3Interface internal fastGasFeed; // in wei
        ...
        )
    {
        ...
        int rewardTokenPriceInMATIC = getDerivedPrice(18); // 18 decimals
    ...
    function getDerivedPrice(uint8 _decimals)
        public
        view
        returns (int256)
    {
        ...
        ( , int256 basePrice, , , ) = maticPriceFeed.latestRoundData();
        uint8 baseDecimals = maticPriceFeed.decimals();
        basePrice = scalePrice(basePrice, baseDecimals, _decimals);

        ( , int256 quotePrice, , , ) = rewardTokenPriceFeed.latestRoundData();
        uint8 quoteDecimals = rewardTokenPriceFeed.decimals();
    ...
    function flashArbitrage(address pool0, address pool1) public {
        //require(keepers[msg.sender], "FORBIDDEN: sender is not a registered keeper address")
