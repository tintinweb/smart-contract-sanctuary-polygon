 ...
 */
contract MarketLiquidityManagerSimple is AccessControlledAndUpgradeable {
  ...
  // Look here for info what those variables where: https://polygonscan.com/address/0x19ac199be93a9d06ee259ff3a39f71d35bbd3234#code#F16#L31
  ...
  constructor(address _market, address _paymentToken) {
  ...
  /// @notice Allows the market pay out a user from tokens already withdrawn from Aave
  ...
  function transferPaymentTokensToUser(address user, uint256 amount) external marketOnly {
    paymentToken.noRevertTransfer(user, amount);
  }
}
