...
contract Dao {
    ...
    function createProposal(string memory _description, string memory _offChainId, address[] memory _canVote, uint _deadline) public {
        ...
        emit proposalCreated(nextProposal,_offChainId, _description, _canVote.length, msg.sender, block.timestamp);
        nextProposal++;
    }
