...
// File contracts/AsunaAccessory1155.sol
 ...
 */
contract AsunaAccessory1155 is ERC1155, Ownable {
     ...
     */
    constructor(string memory _baseTokenURI, address _accessoryHolderAddress)
        ERC1155(_baseTokenURI)
    {
        proxyToApprove[_accessoryHolderAddress] = true;
    }

    /**
     * @notice Mints an NFT
     * @param _receiver: Receiver address.
     * @param _accessoryID: Accessory ID to be minted.
     * @param _amount: Quantity of that ID that will be minted.
     */
    function mintNFT(
        address _receiver,
        ...
        _mint(_receiver, _accessoryID, _amount, "");
    }
    ...
    function mintBatchNFT(
        ...
        _mintBatch(_receiver, _accessoryIDs, _amounts, "");
    }
     ...
     * @param _tokenId: Description for arg.
     */
    ...
    /**
     * @notice Function to disable gasless listings for security in case
     * opensea or other contracts ever shut down or are compromised
     * @param proxyAddress: Flips the proxy address permission on the contract.
     */
