 ...
 * @notice This contract handles minting Burn test tokens.
 */
contract BurnTest is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x3a5f6F44EcCC9D0eaE2DE0A4C0A01E8460c56690;
    ...
    constructor()
        ERC1155(
            "ipfs://bafybeig3wne2igatrebbv6laens2yuiizmjbtnmhgc7ywlcsdn4jqjbgca/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenBurnTokens[2].push(
            BurnToken(0xA2cCB0B501a14f319C76b5894C53B66117E71ea0, 2, 1, 1)
        );
        require(
