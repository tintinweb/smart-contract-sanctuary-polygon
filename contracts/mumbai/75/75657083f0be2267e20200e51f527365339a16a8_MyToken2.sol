...
contract MyToken2 is Initializable, ERC721Upgradeable, PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function aaa() pure public returns (string memory){
        return 'new contract v2';
    }
