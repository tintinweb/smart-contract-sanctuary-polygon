...
// File: contracts/SemRoyalties_TTesteT.sol
...
contract MyToken is ERC1155, Ownable, Pausable, ERC1155Burnable, ERC1155Supply {
    ...
    //smart contract show how much money
    function getContractBalance() public view returns(uint) {
        return address(this).balance;
    }
    
    //Let User Withdraw money from the Smart Contract
    function withdrawAll() public onlyOwner {
        address payable to = payable(msg.sender);
        to.transfer(getContractBalance());
    }
    
    //Let User Withdraw money from the Smart Contract to an Specific Address
