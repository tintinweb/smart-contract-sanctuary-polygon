...
contract TournamentState is Base, ITournamentState {
  ...
  function joinTournament(
    ...
    emit TournamentChanged(_serviceID, _tournamentID, '', abi.encode(tournament.configs), abi.encode(tournament.restrictions), abi.encode(battles[_serviceID][_tournamentID].warriors));
  }
