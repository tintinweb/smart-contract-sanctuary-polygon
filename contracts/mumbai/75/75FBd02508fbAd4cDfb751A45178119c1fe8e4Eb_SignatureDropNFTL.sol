...
abstract contract DropSinglePhase is IDropSinglePhase {
    ...
    function claim(
        ...
        _beforeClaim(_receiver, _quantity, _currency, _pricePerToken, _data);
        ...
        verifyClaim(_dropMsgSender(), _quantity, _currency, _pricePerToken);
        ...
        _afterClaim(_receiver, _quantity, _currency, _pricePerToken, _data);
    }
