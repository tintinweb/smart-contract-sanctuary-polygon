...
contract CouponContract is ERC721, Ownable{
    ...
    */
    ...
    // type - Events
    event CouponCreated(uint indexed _tokenId, string indexed _ifpsURL, string indexed _status);
    ...
    function createCoupon(uint _id, string memory _ipfsUrl, uint _start, uint _end) external onlyAdmin{
        ...
        tokenIds.push(_id);
        idCheck[_id] = true;
        emit CouponCreated(_id, _ipfsUrl, "Coupon Created");
    }
     ...
     */
    function viewAllCreatedTokens(uint _values) external view returns(tokenSpecification[] memory tokenspec){
