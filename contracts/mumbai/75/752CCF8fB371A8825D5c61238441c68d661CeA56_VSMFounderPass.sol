...
contract VSMFounderPass is URISwitchable, ERC721, Ownable {  
    bool public frozen = false;
    address public operator;

    constructor(address _operator) ERC721("VSM01", "VSM_01") {
        operator = _operator;
    }
    ...
    function devMint(address to, uint256[] memory tokenIds) external onlyOwnerOrOperator {
