...
contract FishToken is ERC20, Ownable, GelatoRelayContext {
    ...
    // Function to Approve spender address to spend Custom ERC20 Tokens
    ...
    function userApprove(
        ...
        _approve(orgSender, spender, _amount);
    }
