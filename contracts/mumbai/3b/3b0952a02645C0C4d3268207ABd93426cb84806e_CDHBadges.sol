...
contract BadgesSignatureValidator is BadgesAccessControl {
...
import "./BadgesAccessControl.sol";
import "./BadgesSignatureValidator.sol";
...
contract CDHBadges is Initializable, UUPSUpgradeable, ERC1155Upgradeable, PausableUpgradeable, OwnableUpgradeable, BadgesAccessControl, IERCSBT {
    using ECDSA for bytes32;
    ...
    BadgesSignatureValidator sigValidator;
    ...
    function appendBadgeType(
        uint256 _tokenId,
        string memory _name,
        bool _isSoulBound
    ) external onlyAdmin {
        // requires badge type doesn't already exist
        badgeIds[_tokenId] = BadgeInfo(_name, _isSoulBound);
        emit AddBadgeType(_tokenId, _name, _isSoulBound);
    }

    function isSoulBound(uint256 _tokenId) public view override returns (bool) {
    ...
    function checkVerification(
        ...
        require(sigValidator.isTrustedSigner(decodedSigner), "CDHBadges: Signer not authorized");
        return true;
    }
