...
contract RandomTokenERC721 is  ERC721Upgradeable, DefaultOperatorFiltererUpgradeable, AccessControlEnumerableUpgradeable {
    ...
    function buyToken(uint256 _tokenId) public payable whenMintable {
        if(presaleStarted) {
    ...
    // [ … ]
            ...
            emit TokensSold(address(this), _tokenId, price, _msgSender(), block.timestamp);
