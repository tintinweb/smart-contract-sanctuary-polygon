...
contract SwapContract is Ownable {
    ...
    function depositUSDCForLockToken(uint256 amnt) public {
        ...
        uint256 tokenAmount = (getTokensAmount(amnt)*1e18);
    ...
    function depositMATICForLockToken() public payable {
        ...
        uint256 tokenAmount = (getTokensAmount(usdcAmount)*1e18);
    ...
    function getUSDCMATIC() public view returns (uint256) {
    (, int256 price, , , ) = priceFeed.latestRoundData();

    uint256 adjustmentPrice = uint256(price) / 10**18;
    ...
    function getTokensAmount(uint256 usdcAmount) public view returns(uint256) {
        uint256 tokensAmount = (usdcAmount.mul(1e18).div(tokensAmountForUSDC))/1e6;
        return tokensAmount;
    }
