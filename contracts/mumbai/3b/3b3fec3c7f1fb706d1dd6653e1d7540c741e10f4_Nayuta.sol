...
contract Nayuta is ERC721A, IERC4906, ERC721AQueryable, OperatorFilterer, AccessControl, ERC721ABurnable, ERC2981, Ownable, Pausable {
    ...
    constructor(bool _callerIsUserFlg, bool mintERC2309Flg) ERC721A("Nayuta", "NAYUTA") {
        ...
        if (mintERC2309Flg == true) {
            _mintERC2309(0xEe6BF01b42d71885E2a91EF606c151d338072496, 930);
        }
    }
