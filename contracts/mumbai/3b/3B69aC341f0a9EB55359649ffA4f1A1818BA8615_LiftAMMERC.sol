...
// File: contracts/LiftAMMERC.sol


pragma solidity ^0.8.9;


contract LiftAMMERC is ERC20 {
    ...
    constructor (address _tokenA, address _tokenB) ERC20("LiftAMMERC", "LAMME"){
        tokenA = _tokenA;
        tokenB = _tokenB;
    }
    ...
    function addLiquidity(uint256 amountADesired, uint256 amountBDesired) external returns (uint256 liquidity) {
        ...
        require (_totalSupply * amountADesired / balanceA == _totalSupply * amountBDesired / balanceB, "Wrong proportion between assets A and B");
