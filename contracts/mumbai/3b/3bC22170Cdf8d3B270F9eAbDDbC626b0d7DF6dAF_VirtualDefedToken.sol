 ...
 * @author DEFED
 */
contract VirtualDefedToken is ERC20,ERC20Burnable{
    string internal constant NAME = "VirtualDefe Token";
    string internal constant SYMBOL = "VirtualDefe";
    ...
    event BURN_LOG(address indexed operator,address indexed account,uint256 amount);
    
    constructor(address misc) ERC20(NAME, SYMBOL) public{
        owner = msg.sender;
  ...
  function setOperator(address[] calldata _operators,bool[] calldata _isOperators) external onlyOwner {
    ...
    function burnFrom(address account, uint256 amount) public override onlyOperator{
        ...
        emit BURN_LOG(msg.sender,account,amount);
    }

    function burn(uint256 amount) public override {
        _burn(msg.sender,amount);
        emit BURN_LOG(msg.sender,msg.sender,amount);
    }
