...
contract Updates is IUpdates, Messages, MerkleSerialized {
    ...
    /// @inheritdoc IUpdates
    address public immutable _blackholeIdAddr;
    ...
    constructor(
        ...
        address writer,
        address info,
        address blackholeIdAddr
    ) {
        BlackholeId(blackholeIdAddr).assertValidBlackholeId();
        _sto = storageAddress;
        _writer = writer;
        _info = info;
        _blackholeIdAddr = blackholeIdAddr;
...
interface IUpdates {
    ...
    /**
     * @notice Returns the address of the BlackholeId contract that
     * this contract can communicate with
     */
    function _blackholeIdAddr() external view returns (address);
