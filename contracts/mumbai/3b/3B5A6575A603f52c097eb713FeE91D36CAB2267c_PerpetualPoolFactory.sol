    ...
    IPerpetualPoolFactory
{
    ...
    function createLiquidityPool(
        ...
        uint16 _iPricingRatioConvergenceTime,
        ...
        _validatePricingRatioUpdateTime(_iPricingRatioConvergenceTime);
        ...
        pool.iPricingRatioConvergenceTime = _iPricingRatioConvergenceTime;
    ...
    function _validatePricingRatioUpdateTime(uint16 _iPricingRatioConvergenceTime) internal pure {
        require(
            _iPricingRatioConvergenceTime >= 24 && _iPricingRatioConvergenceTime <= 1000,
            "invalid iPricingRatioConvergenceTime"
        );
    }
