...
contract MarketplaceV4 is Initializable, OwnableUpgradeable, UUPSUpgradeable, IMarketplaceV4, IMessageRecipient {
    ...
    function addCrossChainInbox(uint32 domainId, address inboxAddress) external onlyOwner {
        domainIdToCrossChainInbox[domainId] = inboxAddress;
    }
    ...
    */
    ...
    function getPurchaseInfo(
        ...
        uint256 price = subscriptionSeconds * paymentDetails[0].pricePerSecond;
        uint256 fee = (txFee * price) / 1 ether;
