...
contract Metadata is ERC721URIStorage {
    ...
    constructor() ERC721("Metadata", "MTDT") {}
    ...
    function generateCharacter(uint256 tokenId) public returns(string memory){
        ...
        bytes memory svg = abi.encodePacked(
            ...
            '<text x="50%" y="40%" class="base" dominant-baseline="middle" text-anchor="middle">',"Monkey Branch",'</text>',
    ...
    function getTokenURI(uint256 tokenId) public returns (string memory){
        bytes memory dataURI = abi.encodePacked(
            '{',
                '"name": "Monkey Branch #', tokenId.toString(), '",',
                '"description": "Monkey Branch",',
