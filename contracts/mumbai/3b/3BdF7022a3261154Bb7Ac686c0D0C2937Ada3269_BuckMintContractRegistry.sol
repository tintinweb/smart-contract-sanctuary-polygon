...
import './BuckMintContractRegistryStorage.sol';

/// @dev The BuckMintContractRegistry is queried by other contracts for current addresses
contract BuckMintContractRegistry is
    BuckMintContractRegistryStorage,
    OwnableUpgradeable,
    AccessControlUpgradeable,
    IBuckMintContractRegistry,
    UUPSUpgradeable
{
    // ----------------------------------------
    //      Constants
    ...
    function pauseSystem() external onlyPausers {
        ...
        IPausable tcof = IPausable(_buckMintCarbonOffsetsFactoryAddress);
    ...
    //              Setters
    // ----------------------------------------
    function setCarbonOffsetBatchesAddress(address _address) external virtual onlyOwner {
    ...
    function setBuckMintCarbonOffsetsFactoryAddress(address _address) external virtual onlyOwner {
        require(_address != address(0), 'Error: zero address provided');
        _buckMintCarbonOffsetsFactoryAddress = _address;
    }

    function setCarbonOffsetBadgesAddress(address _address) external virtual onlyOwner {
        require(_address != address(0), 'Error: zero address provided');
        _carbonOffsetBadgesAddress = _address;
    }

    /// @dev function to add valid BCO2 contracts
    function addERC20(address _address) external virtual override onlyBy(_buckMintCarbonOffsetsFactoryAddress, owner()) {
    ...
    function carbonOffsetBatchesAddress() external view virtual override returns (address) {
        return _carbonOffsetBatchesAddress;
    }

    function carbonProjectsAddress() external view virtual override returns (address) {
        return _carbonProjectsAddress;
    }

    function carbonProjectVintagesAddress() external view virtual override returns (address) {
        return _carbonProjectVintagesAddress;
    }

    function buckMintCarbonOffsetsFactoryAddress() external view virtual override returns (address) {
        return _buckMintCarbonOffsetsFactoryAddress;
    }

    function carbonOffsetBadgesAddress() external view virtual override returns (address) {
        return _carbonOffsetBadgesAddress;
    }

    function checkERC20(address _address) external view virtual override returns (bool) {
...
/// @dev  BuckMintContractRegistryStorage is used for separation of data and logic
contract BuckMintContractRegistryStorage {
    ...
    address internal _buckMintCarbonOffsetsFactoryAddress;
