...
contract Chat {
  ...
  //--------------------------------------------------------------------------------------   
    ...
    function getMessageIds() public view returns (uint256[] memory) {
    uint256[] memory ids = new uint256[](messages.length);
...
function getMessageId(uint256 index) public view returns (uint256) {
