...
contract DIDRegistry is AbstractBase, IDIDRegistry, IERC165 {
  ...
  // /**
  //  * @notice Broadcasts specified attribute user associate via an on-chain event.
  //  */
  // function setAttribute(
  ...
  // ) external whileActive {
  //   if (!isActive(_method, _id)) {
  //     revert INVALID_REQUEST();
  //   }

  //   if (msg.sender == _id) {
  //     emit AttributeChanged(_method, _id, _name, _value);
  //   } else {
  //     revert INVALID_REQUEST();
  //   }
  // }
