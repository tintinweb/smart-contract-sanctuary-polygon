...
contract Marketplace is Ownable {
    ...
    event CancelSale(uint256 indexed tokenId, address seller);
    ...
    function matchTransaction1155(
        ...
        // emit sale event
        emitEvent1155(addresses, values, fee);
        return true;
    }
    ...
    function cancelSale(
        ...
        usedSignatures[signature] = true;
        emit CancelSale(values[0], _msgSender());
    }
    ...
    function emitEvent1155(
        address[3] calldata addresses,
        uint256[4] calldata values,
        uint256 feeInWei
    ) internal {
        emit MatchTransaction1155(
            values[0],
            addresses[1],
            values[3],
            values[1],
