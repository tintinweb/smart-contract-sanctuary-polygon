...
// File: contracts/Originals/IERC721A.sol
...
// File: contracts/Originals/ERC721A.sol
...
// File: contracts/Originals/Originals.sol
...
contract Originals is Ownable, ERC721A, ContextMixin, NativeMetaTransaction {
    using Strings for uint256;
    string public baseURI;

    constructor (string memory name_, string memory symbol_, string memory _baseURI) ERC721A(name_, symbol_) {
        baseURI = _baseURI;
        _safeMint(msg.sender, 432);
