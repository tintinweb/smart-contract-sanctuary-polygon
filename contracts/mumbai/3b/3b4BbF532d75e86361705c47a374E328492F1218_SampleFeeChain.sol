...
contract SampleFeeChain is OnFeeChain {
    ...
    constructor(address gateway_, address gasReceiver_)
        OnFeeChain(gateway_, gasReceiver_)
    {
        owner = msg.sender;
    }
    ...
    function setFeeTokenForNFT(address _feeToken)
        external
        onlyOwner
    {
    ...
    function setFeeInTokenForNFT(uint256 _price)
        external
        onlyOwner
    {
    ...
    function withdrawFeeTokenForNFT()
        external
        override
        onlyOwner
    {
        address feeToken = this.fetchFeeTokenForNFT();
        uint256 amount = IERC20(feeToken).balanceOf(
            address(this)
        );
...
abstract contract OnFeeChain {
     ...
     */
    function _setFeeTokenForNFT(address _feeToken)
        internal
    {
     ...
     */
    function fetchFeeInTokenForNFT()
        external
        view
        returns (uint256)
    {
    ...
    function _mintCrossChain(
        ...
        require(
            ...
            "FeeChain: Recipient cannot be 0"
        );
        require(
