...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x763aB8057961862Ebbb903F15F0c36752F321ba7];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmctZcLZQMyi4t8haYX8gg8ADEdXdqdBiVS8CWbLD36AGt/";
...
contract MyNftRamppProjectContract is RamppERC721A {
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/scFV9TyStSjzBoUAiMMr/contract-metadata";
    }
}
