    ...
    Ownable
{
    ...
    uint256 public AUCTION_DURATION = 60; //1 mins for test
    ...
    function sendAndRedeemProportion(uint256 id) external nonReentrant override {
        ...
        if (fractionAddr.balanceOf(address(this), tokenId) == TOTAL_FRACTION_AMOUNT) {
            auctionInfos[id].status = ShotgunStatus.REDEEM;
        }
    ...
    function changeAuction_Duration(uint256 newDuration) external virtual override onlyOwner {
