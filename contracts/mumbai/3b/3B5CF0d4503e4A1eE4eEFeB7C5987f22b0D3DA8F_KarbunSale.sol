...
contract KarbunSale is ReentrancyGuard  {
    ...
    address _ETH = 0x8A583aacB750344A4B278D6AE25bC744F8911BA8;
    address _BNB = 0x8A583aacB750344A4B278D6AE25bC744F8911BA8;
    address token = 0x8A583aacB750344A4B278D6AE25bC744F8911BA8;
    address _BTC = 0x8A583aacB750344A4B278D6AE25bC744F8911BA8;
...
// ------------- FUNCTION FOR CHAINLINK -------------- //
   function getETHLatestPrice() public view returns (uint256) {
    ...
    function BuyFromBNB(uint256 _amount) public nonReentrant {
        ...
        IERC20(token).transferFrom(wallet,msg.sender,_amount);
    }
    ...
    function BuyFromMatic(uint256 _amount) public payable nonReentrant{
      ...
      function BuyFromBTC(uint256 _amount) public payable nonReentrant {
