...
contract TraitsCommoners is ITraits {
  ...
  function _getSvgTopTalents(uint8 topTalentNo_) public view returns (string memory data_) {
    string memory s = string(abi.encodePacked("image","()"));
    data_ = call(sourceTopTalents[topTalentNo_-1], abi.encodeWithSignature(s, ""));
  }

  function _getSvg1(uint8 trait1, uint8 id1, string memory sig_) public view returns (string memory data_) {
  ...
  function _getSvg2(uint8 trait1, uint8 id1, uint8 trait2, uint8 id2, string memory sig_) public view returns (string memory data_) {
    string memory s = string(abi.encodePacked(sig_, "()"));
