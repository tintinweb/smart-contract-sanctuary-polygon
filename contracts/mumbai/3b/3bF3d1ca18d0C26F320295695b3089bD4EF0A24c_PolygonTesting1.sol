...
contract PolygonTesting1 is ERC721Royalty, Ownable, ContextMixin {
    ...
    uint256 public price = 0.45 ether; // 0.01 ETH
    ...
    constructor() ERC721("Polygon1","pol1") {
        _setBaseURI("https://boredapeyachtclub.com/api/mutants/");
    }
