...
// Contract Address: 0x77e2777f206B699fdF949CF5030292b2a09c5025
...
contract ChainBattles is ERC721URIStorage {
    ...
    function generateCharacter(uint256 tokenId) public returns(string memory){
        bytes memory svg = abi.encodePacked(
            ...
            '<text x="50%" y="70%" class="base" dominant-baseline="middle" text-anchor="middle">', "Levels: ",getLife(tokenId),'</text>',
            '</svg>'
        );
        return string(
            abi.encodePacked(
    ...
    function mint() public {
        ...
        tokenIdToStats[newItemId] = TokenStats(0, random(100), random(100), 100);
