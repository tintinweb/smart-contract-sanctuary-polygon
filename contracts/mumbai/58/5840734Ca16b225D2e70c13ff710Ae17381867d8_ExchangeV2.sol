...
import "./ORBTransferManager.sol";
import "./IRoyaltiesProvider.sol";
import "./TransferProxy.sol";
import "./ERC20TransferProxy.sol";

contract ExchangeV2 is ExchangeV2Core, ORBTransferManager {
    function __ExchangeV2_init(
        ...
        __ORBTransferManager_init_unchained(
            newBuyerFee,
            newSellerFee,
            newCommunityWallet,
...
contract TransferProxy is Initializable, OperatorRole, INftTransferProxy {
...
abstract contract ORBTransferManager is
    OwnableUpgradeable,
    ...
    ITransferManager
{
    ...
    function __ORBTransferManager_init_unchained(
        uint256 newBuyerFee,
        uint256 newSellerFee,
        address newCommunityWallet,
        IRoyaltiesProvider newRoyaltiesProvider
