...
//  Doc[] public docs;
  ...
  function addDoc(string memory docUid, uint8 docType) external returns (bool) {
...
//  function tipDoc(uint docId, uint256 amount, address tokenAddress) external {
//    bool success = daiInstance.transferFrom(msg.sender, address(this), amount);
