...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x4d3e2c0113C8f16BE0F4Bf6772982Ee01622e78B];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 20, 30 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmWwucARY7LReN6eBcbYYRG3t1ijpoisMH6WRQizmkyxZ3/";
...
// File: contracts/SavageTestCatsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SavageTestCatsContract is RamppERC721A {
    constructor() RamppERC721A("Savage Test Cats", "STCT"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/lp6Bktx2VISdbLv0W9ZU/contract-metadata";
    }
}
