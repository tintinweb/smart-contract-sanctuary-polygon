...
contract TheNFT is Ownable, ERC721A, ReentrancyGuard, ERC2981{
    ...
    uint256 private whitelistMintPrice = 0.01 ether;
    uint256 private privateMintPrice1 = 0.01 ether;
    uint256 private privateMintPrice2 = 0.03 ether;
  ...
  constructor(
  ) ERC721A("TheNFT", "TheNFT",batchSize, _totalSupply) {
     tokenCount = 0;
  }
