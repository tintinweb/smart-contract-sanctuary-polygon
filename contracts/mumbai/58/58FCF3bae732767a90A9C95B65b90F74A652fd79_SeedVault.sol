...
contract SeedVault is Initializable, OwnableUpgradeable, EIP712Upgradeable {
    ...
    function checkHash(bytes memory previousSeed) public pure returns (bytes memory, bytes32, bytes memory, bytes32) {
        return (
            previousSeed, keccak256(previousSeed), "", keccak256("")
        );
    }
