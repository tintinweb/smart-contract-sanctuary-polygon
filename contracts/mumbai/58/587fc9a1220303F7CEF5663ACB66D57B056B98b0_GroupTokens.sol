...
contract GroupTokens is ERC721Upgradeable, ERC721EnumerableUpgradeable, PausableUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable, UUPSUpgradeable {
    ...
    */
    ...
    function mintGroup(string calldata groupName) public payable whenNotPaused nonReentrant {
        ...
        require(msg.value == requiredPayment, "Bad payment amount");
