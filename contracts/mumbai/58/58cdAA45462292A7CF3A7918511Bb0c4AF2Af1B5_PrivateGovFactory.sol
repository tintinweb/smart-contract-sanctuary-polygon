...
import "../interfaces/IPrivateGovSale.sol";

contract PrivateGovFactory is 
    Initializable,
    UUPSUpgradeable,
    PausableUpgradeable,
    OwnableUpgradeable,
...
interface IPrivateGovSale {    
	function init(uint128, uint128, uint128, uint128, uint128, uint128[2] calldata, address, address) external;
}
