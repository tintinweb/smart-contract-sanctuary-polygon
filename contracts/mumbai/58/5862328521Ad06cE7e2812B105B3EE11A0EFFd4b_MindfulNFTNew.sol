...
contract MindfulNFTNew is ERC721, ERC721URIStorage, Pausable, Ownable, ERC721Burnable, ERC2981, DefaultOperatorFilterer {
...
*/
    ...
    // mint Metaverse NFT
    //function mintMindfulNFT(address recipient, string memory uri, address royaltFeeReceiver, uint96 fee, uint256 mintPassId) public payable returns(uint256){
    //function mintMindfulNFT(address recipient, string memory uri, address royaltFeeReceiver, uint96 fee) public payable returns(uint256){
    function mintMindfulNFT(address recipient, string memory uri, address royaltFeeReceiver, uint96 fee, uint256 mintPassId, bytes32 hash, bytes memory signature) public returns(uint256){      
        ...
        //payable(address(0x1f6A403347fd2d335d14Dc3f1AEb21D9192cF166)).transfer(100);

        // check if MintPass is burned
        require(mintPass.ownerOf(mintPassId) == burnAddress, "MintPass not burned");
