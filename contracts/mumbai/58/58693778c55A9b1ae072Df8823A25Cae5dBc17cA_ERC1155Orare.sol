...
contract ERC1155Orare is ERC1155Pausable, Ownable {
    ...
    mapping(uint256 => uint256) private tokenSupply; //mapping for tokenIds to their totalSupply

    uint256 public _currentTokenID = 0; //set the current token id to 0

    mapping(address => bool) isMinterContract; //mapping to check if the address is minter contract or not
    ...
    */
    ...
    /**
     * @param _gameContract The address of the ERC1155Game contract
    ...
    * @param value the quantity of the token to be minted
    * @param data Any extra data to pass while minting
    ...
    * @return Boolean value 
    ...
    /**
    * @notice This function is used to mint a batch of tokens at once
    * @param to the address to mint the token to
    * @param ids the array of IDs of the tokens to be minted
    * @param values the array of quantities of the tokens to be minted
    * @param data Any extra data to pass while minting
    ...
    * @return Boolean value 
    ...
    /**
    * @notice Function to burn a token and decrease its supply from total
    * @param owner the address to burn tokens from
    * @param id the ID of the token to be burned
    * @param value the quantity of token to be burned
    ...
    * @return Boolean value
    ...
    /**
    * @notice Function to burn a batch of tokens and decrease their supply from total
    * @param owner the address to burn tokens from
    * @param ids the ID of the tokens to be burned
    * @param values the quantity of tokens to be burned
