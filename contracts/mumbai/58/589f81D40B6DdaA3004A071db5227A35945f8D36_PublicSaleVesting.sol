...
contract PublicSaleVesting is NWTVestingHub {
  uint256 private START_DATE = block.timestamp;
  uint256 private DURATION = 750 days;
  uint256 private INITIAL_REALEASE_PERCENTAGE = 20;
  uint256 private CLAIM_COOL_DOWN = 60 days;
