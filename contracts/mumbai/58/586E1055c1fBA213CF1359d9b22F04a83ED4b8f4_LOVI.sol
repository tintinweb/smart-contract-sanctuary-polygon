...
contract LOVI is ERC721, ERC721Enumerable,ERC2981, Ownable,ReentrancyGuard {
    ...
    uint256 public mintingFees = 0.05 ether; //@note add setter
    ...
    function changeBaseURI(string calldata _baseURL, bool isFinalReveled) public onlyOwner {
    ...
    function updateMintingFees(uint _fee) public onlyOwner {
        mintingFees = _fee;
    }
    ...
    function updateRoyalty(address _royaltyReceiver, uint96 feeNumerator) public onlyOwner {
    ...
    function safeMint(address to, uint amount, bytes32[] calldata merkleProof) public payable nonReentrant{
        require(amount !=0 && mintedAmount[msg.sender]+amount <= 2,"Invalid Amount");
