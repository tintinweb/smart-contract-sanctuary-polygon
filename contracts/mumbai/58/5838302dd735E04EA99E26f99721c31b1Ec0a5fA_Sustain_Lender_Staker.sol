...
contract Sustain_Lender_Staker_Signer is EIP712Upgradeable{
    ...
    struct WrappedSustain{
        ...
        uint256 nftId;
        uint256 minimumTime;
        uint256 paymentPartition;
        uint256 loanAmount;
        uint256 interestPercent; //should be sent by multiplying with 100. Eg: If want to send 20% should send 20000
        uint256 apr; // value in wei
        bool inStableCoin;
        uint256 nonce;
        bytes signature;
    }
...
contract Sustain_Lender_Staker is OwnableUpgradeable, ReentrancyGuardUpgradeable,Sustain_Lender_Staker_Signer,IERC721Receiver  {
