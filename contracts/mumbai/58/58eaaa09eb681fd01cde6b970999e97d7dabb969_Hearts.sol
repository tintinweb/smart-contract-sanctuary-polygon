...
contract Hearts is ERC721, Ownable {
  ...
  constructor() ERC721("Hearts", "HRT") {
    setHiddenMetadataUri("ipfs://QmPWxh85Buk1jBK2cH146vC9qhTWziWNa5yH9G1g3z88Ps/hidden.json");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0xe25E1169724dF86Df9d830216BD344A1eaA50eab).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
