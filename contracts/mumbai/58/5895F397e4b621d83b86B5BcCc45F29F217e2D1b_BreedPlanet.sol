...
contract BreedPlanet is BreedPlanetBase, ChainlinkRng {
    ...
    struct BreedStruct {
        ...
        uint256 planetAId;
        uint256 planetBId;
        bool isPrimeval; // is Primeval event
        uint256 apeironGodiverseCollectionNumber; // number of GodiverseCollection used
    ...
    constructor(
        ...
        uint256[] memory _apeironGodiverseCollectionNumber,
        ...
        BreedPlanetBase(
            ...
            _aprsPrices,
            _animaPrices,
            _apeironGodiverseCollectionNumber
        )
    ...
    function requestBreed(
        ...
        uint256 planetBId,
        bool isPrimeval,
        uint256 apeironGodiverseCollectionNumber // if 0 = not using ApeironGodiverseCollection token
    ) external {
        ...
        _breed(
            ...
            planetBId,
            isPrimeval,
            apeironGodiverseCollectionNumber,
            true
        );
    ...
    function _rngCallBack(uint256 requestId) internal virtual override {
        ...
        _breed(
            ...
            breedStruct.isPrimeval,
            breedStruct.apeironGodiverseCollectionNumber,
            false
        );
...
contract BreedPlanetBase is ApeironPlanetGenerator, AccessProtected {
    ...
    mapping(uint256 => uint256) public apeironGodiverseCollectionNumbers; // breedcount
    ...
    uint256 public apeironGodiverseCollectionId = 1; // apeironGodiverseCollection id
    ...
    constructor(
        ...
        apeironGodiverseCollection = ERC1155Burnable(_apeironGodiverseCollectionAddress);
    ...
    function checkCanBreed(
        ...
        uint256 planetBId,
        bool isPrimeval,
        uint256 apeironGodiverseCollectionNumber
        ...
        if (isPrimeval) {
            ...
            require(apeironGodiverseCollectionNumber > 0, "Primeval require apeironGodiverseCollection token");
        }
        if (apeironGodiverseCollectionNumber != 0) {
            require(
                userAddress == address(this) ||
                    apeironGodiverseCollection.isApprovedForAll(userAddress, address(this)),
                "Grant apeironGodiverseCollection approval for breeding contract"
            );
            require(
                apeironGodiverseCollection.balanceOf(userAddress, apeironGodiverseCollectionId) >=
                    apeironGodiverseCollectionNumber,
    ...
    function _breed(
        ...
        if (
            ...
            uint256 aprsPrice;
            uint256 animaPrice;
            if (isPrimeval || apeironGodiverseCollectionNumber != 0) {
            ...
            require(
                aprsToken.allowance(userAddress, address(this)) >= aprsPrice,
                "Grant aprsToken approval to Sale Contract"
            );
            require(
                animaToken.allowance(userAddress, address(this)) >= animaPrice,
                "Grant animaToken approval to Sale Contract"
            );
            if (!isDryRun && aprsPrice > 0) {
                aprsToken.transferFrom(userAddress, address(this), aprsPrice);
            }
            if (!isDryRun && animaPrice > 0) {
                animaToken.transferFrom(userAddress, address(this), animaPrice);
            }

            // burn apeironGodiverseCollection
            if (apeironGodiverseCollectionNumber != 0) {
                uint256 targetApeironGodiverseCollectionNumber = apeironGodiverseCollectionNumbers[
                    _getPlanetData(planetAId).breedCount
                ] + apeironGodiverseCollectionNumbers[_getPlanetData(planetBId).breedCount];
                require(
                    apeironGodiverseCollectionNumber >= targetApeironGodiverseCollectionNumber,
                    "ApeironGodiverseCollection is not enough to breed"
                );
                if (!isDryRun) {
                    apeironGodiverseCollection.burn(
                        userAddress,
                        apeironGodiverseCollectionId,
    ...
    function setApeironGodiverseCollectionNumber(uint256[] memory _apeironGodiverseCollectionNumbers)
        public
        onlyOwner
    {
        require(_apeironGodiverseCollectionNumbers.length == 5, "Number length are wrong");
        apeironGodiverseCollectionNumbers[0] = _apeironGodiverseCollectionNumbers[0];
        apeironGodiverseCollectionNumbers[1] = _apeironGodiverseCollectionNumbers[1];
        apeironGodiverseCollectionNumbers[2] = _apeironGodiverseCollectionNumbers[2];
        apeironGodiverseCollectionNumbers[3] = _apeironGodiverseCollectionNumbers[3];
        apeironGodiverseCollectionNumbers[4] = _apeironGodiverseCollectionNumbers[4];
    }
