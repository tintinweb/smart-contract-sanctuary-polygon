 ...
 * @title NiftyzFreePT
 */
contract NiftyzFreePT is ERC1155, Ownable, ReentrancyGuard {
    struct PassToken {
        uint256 id;
        uint256 supply;
        uint256 minted;
    ...
    constructor() ERC1155("https://api.niftyz.io/nfts/free/{id}") {
        metadataURI = "https://api.niftyz.io/nfts/free/{id}";
    }
