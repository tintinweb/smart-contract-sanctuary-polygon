...
*/
    ...
    string calldata _paymentTransferType, S9YData calldata _s9yData) public payable whenNotPaused whenExternalFiatPayNotPaused nonReentrant onlyExternalFiatWhitelistedAddresses {
        _collectExternalFiatPayment(_paymentAddress, _receiver, _assetAddress, _amount, _paymentTransferType, _s9yData.subTxId, _s9yData.txId);
    ...
    S9YData calldata _s9yData) public payable whenNotPaused whenExternalFiatPayNotPaused nonReentrant onlyExternalFiatWhitelistedAddresses {
        _collectExternalFiatPayment(_paymentAddress, address(this), _assetAddress, _amount, _paymentTransferType, _s9yData.subTxId, _s9yData.txId);
