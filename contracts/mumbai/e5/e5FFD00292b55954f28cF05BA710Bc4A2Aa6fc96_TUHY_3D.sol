...
// interface IERC721Metadata is IERC721Upgradeable {
...
contract TUHY_3D is ERC721AUpgradeable, OwnableUpgradeable, PausableUpgradeable {
    string  public baseURI; 
    uint256 public mint1price; 
    uint256 public Supply;
    bool public contarctInitialized;
    address public fundWallet;
    // constructor() ERC721A("The Unstable Horses Yard 3D", "TUHY3D", 100) {
    //     _pause();
    // }
   function initialize() public initializer {
        baseURI = "ipfs://QmWYA1zgmWXt6cmd9EMMC1LaxU2Y3GgnneZjGLc1XwNFLf/";
        mint1price = 0.005 ether;
        Supply = 10000;
        fundWallet = address(0x5B38Da6a701c568545dCfcB03FcB875f56beddC4);
        __ERC721_init("The Unstable Horses Yard 3D", "TUHY3D", 100);
        __Ownable_init();
        _pause();
    ...
    function Mint(uint256 num) public payable whenNotPaused {
        require((mint1price * num) <= msg.value, 'LOW_ETHER');
    ...
    function setFundAddress(address __address) public onlyOwner {
        require(__address != address(0), "Zero address error");
        fundWallet = __address;
    }
