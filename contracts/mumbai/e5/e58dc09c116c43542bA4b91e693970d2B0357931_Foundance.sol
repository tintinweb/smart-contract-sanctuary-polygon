    ...
    AdapterGuard
{
    ...
    /// @notice 
    Modules public _modules;
    /// @notice 
    mapping(string => FoundanceConfig) public _registeredFoundance;
    /// @notice 
    mapping(uint32 => string) public _registeredFoundanceWithId;
     ...
     */
    modifier reentrancyGuard(address daoAddress) {
        if(_lockedAt[daoAddress] != block.number)
            revert ContractLocked(daoAddress);
    ...
    {
        if(_registeredFoundance[foundanceName].creatorAddress != msg.sender)
      ...
      external
    {
        ...
        _registeredFoundanceWithId[projectId] = foundanceName;
        
        FoundanceConfig storage foundance = _registeredFoundance[foundanceName];
      ...
      onlyCreator(foundanceName)
    {
        ...
        //CREATE_CORE
        _modules.daoFactory.createDao(foundanceName, msg.sender);
        address daoAddress = _modules.daoFactory.getDaoAddress(foundanceName);
        DaoRegistry dao = DaoRegistry(daoAddress);

        //CREATE_EXTENSION
        _modules.bankExtensionFactory.create(dao,foundance.tokenConfig.maxExternalTokens);
        _modules.erc20ExtensionFactory.create(dao,foundance.tokenConfig.tokenName,DaoLibrary.UNITS,foundance.tokenConfig.tokenSymbol,foundance.tokenConfig.decimals);
        _modules.memberExtensionFactory.create(dao);
        _modules.dynamicEquityExtensionFactory.create(dao);
        _modules.vestedEquityExtensionFactory.create(dao);
        _modules.communityEquityExtensionFactory.create(dao);

        //GET_ADDRESSES
        address _bankExtensionAddress = _modules.bankExtensionFactory.getExtensionAddress(daoAddress);
        address _erc20ExtensionAddress = _modules.erc20ExtensionFactory.getExtensionAddress(daoAddress);
        address _memberExtensionAddress = _modules.memberExtensionFactory.getExtensionAddress(daoAddress);
        address _dynamicEquityExtensionAddress = _modules.dynamicEquityExtensionFactory.getExtensionAddress(daoAddress);
        address _vestedEquityExtensionAddress = _modules.vestedEquityExtensionFactory.getExtensionAddress(daoAddress);
        address _communityEquityExtensionAddress = _modules.communityEquityExtensionFactory.getExtensionAddress(daoAddress);
...

        {
          ...
          DaoFactory.Adapter[] memory adapterList = new DaoFactory.Adapter[](10);
            adapterList[0] = DaoFactory.Adapter(DaoLibrary.FOUNDANCE_FACTORY, address(this), uint128(255));
            adapterList[1] = DaoFactory.Adapter(DaoLibrary.BANK_EXT, _bankExtensionAddress, uint128(0));
            adapterList[2] = DaoFactory.Adapter(DaoLibrary.ERC20_EXT, _erc20ExtensionAddress, uint128(64));
            adapterList[3] = DaoFactory.Adapter(DaoLibrary.MEMBER_EXT, _memberExtensionAddress, uint128(66));
            adapterList[4] = DaoFactory.Adapter(DaoLibrary.MANAGER_ADPT, moduleAddresses.managerAdapterAddress, uint128(63));
            adapterList[5] = DaoFactory.Adapter(DaoLibrary.VOTING_ADPT, moduleAddresses.votingAdapterAddress, uint128(10));
            adapterList[6] = DaoFactory.Adapter(DaoLibrary.MEMBER_ADPT, moduleAddresses.memberAdapterAddress, uint128(194));
            adapterList[7] = DaoFactory.Adapter(DaoLibrary.DYNAMIC_EQUITY_ADPT, moduleAddresses.dynamicEquityAdapterAddress,uint128(2));
            adapterList[8] = DaoFactory.Adapter(DaoLibrary.VESTED_EQUITY_ADPT, moduleAddresses.vestedEquityAdapterAddress,uint128(2));
            adapterList[9] = DaoFactory.Adapter(DaoLibrary.COMMUNITY_EQUITY_ADPT, moduleAddresses.communityEquityAdapterAddress,uint128(2));
          _modules.daoFactory.addAdapters(dao, adapterList);

          //BANK_EXT_ACL
          adapterList = new DaoFactory.Adapter[](6);
            adapterList[0] = DaoFactory.Adapter(DaoLibrary.ERC20_EXT, _erc20ExtensionAddress, uint128(4));
            adapterList[1] = DaoFactory.Adapter(DaoLibrary.MEMBER_EXT, _memberExtensionAddress, uint128(19));
            adapterList[2] = DaoFactory.Adapter(DaoLibrary.MEMBER_ADPT, moduleAddresses.memberAdapterAddress,uint128(19));
            adapterList[3] = DaoFactory.Adapter(DaoLibrary.DYNAMIC_EQUITY_ADPT, moduleAddresses.dynamicEquityAdapterAddress,uint128(3));
            adapterList[4] = DaoFactory.Adapter(DaoLibrary.VESTED_EQUITY_ADPT, moduleAddresses.dynamicEquityAdapterAddress,uint128(3));
            adapterList[5] = DaoFactory.Adapter(DaoLibrary.COMMUNITY_EQUITY_ADPT, moduleAddresses.communityEquityAdapterAddress,uint128(3));
          _modules.daoFactory.configureExtension(dao, _bankExtensionAddress, adapterList);

          //MEMBER_EXT_ACL
          adapterList = new DaoFactory.Adapter[](3);
            adapterList[0] = DaoFactory.Adapter(DaoLibrary.FOUNDANCE_FACTORY,address(this),uint128(7));
            adapterList[1] = DaoFactory.Adapter(DaoLibrary.MEMBER_ADPT, moduleAddresses.memberAdapterAddress,uint128(7));
            adapterList[2] = DaoFactory.Adapter(DaoLibrary.COMMUNITY_EQUITY_ADPT, moduleAddresses.communityEquityAdapterAddress,uint128(7));
          _modules.daoFactory.configureExtension(dao, _memberExtensionAddress, adapterList);

          //DYNAMIC_EQUITY_EXT_ACL
          adapterList = new DaoFactory.Adapter[](3);
            adapterList[0] = DaoFactory.Adapter(DaoLibrary.DYNAMIC_EQUITY_ADPT, moduleAddresses.dynamicEquityAdapterAddress, uint128(7));
            adapterList[1] = DaoFactory.Adapter(DaoLibrary.MEMBER_EXT, _memberExtensionAddress, uint128(7));
            adapterList[2] = DaoFactory.Adapter(DaoLibrary.MEMBER_ADPT, moduleAddresses.memberAdapterAddress,uint128(7));
          _modules.daoFactory.configureExtension(dao, _dynamicEquityExtensionAddress, adapterList);

          //VESTED_EQUITY_EXT_ACL
          adapterList = new DaoFactory.Adapter[](3);
            adapterList[0] = DaoFactory.Adapter(DaoLibrary.VESTED_EQUITY_ADPT, moduleAddresses.vestedEquityAdapterAddress, uint128(7));
            adapterList[1] = DaoFactory.Adapter(DaoLibrary.MEMBER_EXT, _memberExtensionAddress, uint128(7));
            adapterList[2] = DaoFactory.Adapter(DaoLibrary.MEMBER_ADPT, moduleAddresses.memberAdapterAddress,uint128(7));
          _modules.daoFactory.configureExtension(dao, _vestedEquityExtensionAddress, adapterList);

          //COMMUNITY_EQUITY_EXT_ACL
          adapterList = new DaoFactory.Adapter[](3);
            adapterList[0] = DaoFactory.Adapter(DaoLibrary.COMMUNITY_EQUITY_ADPT, moduleAddresses.communityEquityAdapterAddress,uint128(7));
            adapterList[1] = DaoFactory.Adapter(DaoLibrary.MEMBER_EXT, _memberExtensionAddress, uint128(7));
            adapterList[2] = DaoFactory.Adapter(DaoLibrary.MEMBER_ADPT, moduleAddresses.memberAdapterAddress,uint128(7));
          _modules.daoFactory.configureExtension(dao, _communityEquityExtensionAddress, adapterList);
        }
        ...
        _modules.votingAdapter.configureDao(
          dao, 
        ...
        //REMOVE_ACL_FOUNDANCE_FACTORY
        {
          ...
          _modules.daoFactory.configureExtension(
            dao, 
            _memberExtensionAddress, 
            adapterList
          );
    ...
    function setIdtoDaoName(
      ...
      onlyAdmin
    {
      _registeredFoundanceWithId[projectId] = name;
    }
    ...
    function setConfigurations(
      Configuration[] memory _configurations
    ) 
      external
      onlyAdmin
    {
      ...
      internal 
    {
      ...
      _modules.daoFactory = DaoFactory(_moduleAddresses.daoFactoryAddress);
      _modules.bankExtensionFactory = BankExtensionFactory(_moduleAddresses.bankExtensionFactoryAddress);
      _modules.erc20ExtensionFactory = ERC20ExtensionFactory(_moduleAddresses.erc20ExtensionFactoryAddress);
      _modules.memberExtensionFactory = MemberExtensionFactory(_moduleAddresses.memberExtensionFactoryAddress);
      _modules.dynamicEquityExtensionFactory = DynamicEquityExtensionFactory(_moduleAddresses.dynamicEquityExtensionFactoryAddress);
      _modules.vestedEquityExtensionFactory = VestedEquityExtensionFactory(_moduleAddresses.vestedEquityExtensionFactoryAddress);
      _modules.communityEquityExtensionFactory = CommunityEquityExtensionFactory(_moduleAddresses.communityEquityExtensionFactoryAddress);
      _modules.managerAdapter = ManagerAdapter(_moduleAddresses.managerAdapterAddress);
      _modules.votingAdapter = VotingAdapter(_moduleAddresses.votingAdapterAddress);
      _modules.memberAdapter = MemberAdapter(_moduleAddresses.memberAdapterAddress);
      _modules.dynamicEquityAdapter = DynamicEquityAdapter(_moduleAddresses.dynamicEquityAdapterAddress);
      _modules.vestedEquityAdapter = VestedEquityAdapter(_moduleAddresses.vestedEquityAdapterAddress);
      _modules.communityEquityAdapter = CommunityEquityAdapter(_moduleAddresses.communityEquityAdapterAddress);
    }
    ...
    function isNameUnique(
      ...
      returns(bool)
    {       
       return _modules.daoFactory.getDaoAddress(foundanceName)==address(0x0) && 
              _registeredFoundance[foundanceName].creatorAddress==address(0x0);   
    }
    ...
    function isIdUnique(
      ...
      returns(bool)
    {       
      return bytes(_registeredFoundanceWithId[projectId]).length==0;     
    }
    ...
    {
      return _registeredFoundance[foundanceName].foundanceStatus;       
    }
    ...
    {
      return _registeredFoundanceWithId[projectId];       
    }
    ...
    {
      string memory foundanceName  = _registeredFoundanceWithId[projectId];
      FoundanceConfig storage config = _registeredFoundance[foundanceName];
    ...
    AdapterGuard 
{
    ...
    function getIsProposalUsed(bytes32 proposalId)
        external
        view
        returns (bool)
    {
...
contract ENSRegistrar {
    ...
    constructor(address _ens, bytes32 _tld_node, bytes32 _node_label, address _resolver) {
        admin = msg.sender;
        ens = ENS(_ens);
        TLD_NODE = _tld_node;
    ...
    function registerSubdomain(bytes32 label, address subdomainOwner) public isAdmin not_stopped {
    ...
    function setResolver(string memory name, address _resolver) public isAdmin {
        bytes32 label = keccak256(bytes(name));
        bytes32 node = keccak256(abi.encodePacked(TLD_NODE, label));
        ens.setResolver(node, _resolver);
    }

    function setResolver(ENSResolver _resolver) public isAdmin {
        resolver = _resolver;
    }

    function setTLDNode(bytes32 _TLD_NODE) public isAdmin {
        TLD_NODE = _TLD_NODE;
    }

    function stop() public not_stopped isAdmin {
        stopped = true;
    }
    ...
    ERC165 
{
        ...
        override 
    {
        ...
        if(!dao.isMember(creator))
            revert Bank_NotAMember(creator); 
...
import "../../core/factories/CloneFactory.sol";
...
/// @notice allows members to manage the DAO's configuration
  ...
  AdapterGuard
{
        ...
        reentrancyGuard(address(dao))
    {
        ...
        uint256 tokenAmount = 
            GovernanceLibrary.getVotingWeight(
                dao,
                memberAddr,
                proposalId,
                _voting.blockNumber
        ...
        returns (VotingAdapterLibrary.VotingState state)
    {
        ...
        if(_votingConfig.votingType == VotingAdapterLibrary.VotingType.OPTIMISTIC){
            ...
            if( 
                _votingConfig.passRateMember > _voting.nbMembers || 
                (_votingConfig.passRateToken*totalUnitTokens) / 100  > _voting.nbTokens || 
                (_votingConfig.supportRequired*totalUnitTokens) / 100 > _voting.nbTokens   
            ) 
            {
                return VotingAdapterLibrary.VotingState.NOT_PASS;
            }
            ...
            else if (_voting.nbYes < _voting.nbNo) {
                return VotingAdapterLibrary.VotingState.NOT_PASS;
            } 
            else {
...
interface IFoundanceEvents{
     ...
     * @param  _projectId The Foundance project Id
     * @param  _daoAddress address of DaoRegistry
     * @param  _bankExtensionAdress +
     * @param  _erc20ExtensionAddress +
     * @param  _memberExtensionAddress +
     * @param  _dynamicEquityExtensionAddress +
     * @param  _vestedEquityExtensionAddress +
     * @param  _communityEquityExtensionAddress +
     */
