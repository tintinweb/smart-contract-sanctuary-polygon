...
contract ERC20IssuerV2 is Ownable {
    ...
    mapping(uint256 id => Project project) public _projects;
    mapping(address tokenReceiver => mapping(uint256 projectId => bool claimed))
        public _hasClaimed;
    ...
    function reclaimTokens(uint256 id) external {
        uint256 allocated = _projects[id].allocated;
        uint256 claimed = _projects[id].claimed;
