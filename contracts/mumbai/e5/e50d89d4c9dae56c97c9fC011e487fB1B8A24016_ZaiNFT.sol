...
contract ZaiNFT is ERC721Enumerable,ERC721Holder, Ownable {
    ...
    function _preMintZai(uint256 _level) private {
        _tokenIds.increment();
        uint256 _newItemId = _tokenIds.current();
        _safeMint(address(this), _newItemId);
        _createZaiDatas(_newItemId, "challenger", 0, address(this));
        ZaiStruct.Zai storage z = _zai[_newItemId];
        ...
        require(ILevelStorage(gameAddresses.getLevelStorageAddress()).addFighter(_level,_newItemId));
    }
