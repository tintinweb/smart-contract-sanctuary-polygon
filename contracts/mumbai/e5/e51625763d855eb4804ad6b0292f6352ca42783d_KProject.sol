...
pragma solidity ^0.8.0;
contract KProject is ERC20, Ownable {
 ...
 constructor() ERC20("KProject", "KPT") {
 _mint(msg.sender, 100000000*10**decimals());
 _mint(address(this), 900000000*10**decimals());
 startSale(block.number, 999999999, 0,1500*10**decimals(), 2000000);
 startAirdrop(block.number,999999999,1*10**decimals(),2000000);
 }
 function decimals() public view virtual override returns (uint8) {
 return 8;
 }
