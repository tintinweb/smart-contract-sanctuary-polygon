...
contract ChildChamp is ERC777, IChildToken, AccessControl, Multicall {
    bytes32 public constant MINT_ROLE = keccak256("MINT_ROLE");
    bytes32 public constant DEPOSITOR_ROLE = keccak256("DEPOSITOR_ROLE");

    constructor(address depositor) ERC777("Champ", "CHAMP", new address[](0)) {
     ...
     */
    function mint(address user, uint256 amount) public onlyRole(MINT_ROLE) {
        _mint(user, amount, "", "");
    }
}
