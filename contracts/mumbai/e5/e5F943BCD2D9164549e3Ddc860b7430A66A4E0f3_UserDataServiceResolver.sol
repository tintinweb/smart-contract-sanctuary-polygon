 ...
 */
    ...
    function _createNewAccount(address accountOwner) internal returns (AccountInfo memory) {
        ...
        AccountInfo memory Info = setAccountInfoRecord(tokenId, _ident, msg.sender, metasId);
        emit NewAccountCreated(_ident, msg.sender, tokenId);
...
contract BaseUserRegistry is ERC721, Ownable {
    ...
    function register(uint256 tokenId, address _owner) internal returns (uint256) {
        return _register(tokenId, _owner, true);
    }
