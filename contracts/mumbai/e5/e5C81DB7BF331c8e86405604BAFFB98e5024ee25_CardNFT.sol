...
contract CardNFT is ERC721, ERC721Enumerable, AccessControl, Ownable {
  ...
  uint32[] public cardValue = [
    ...
    80000,     // 4 of Hearts
    80000,     // 4 of Clubs
    160000,    // 5 of Diamonds
    160000,    // 5 of Spades
    160000,    // 5 of Hearts
    160000,    // 5 of Clubs
    320000,    // 6 of Diamonds
    320000,    // 6 of Spades
    320000,    // 6 of Hearts
    320000,    // 6 of Clubs
    640000,    // 7 of Diamonds
    640000,    // 7 of Spades
    640000,    // 7 of Hearts
    640000,    // 7 of Clubs
    1250000,   // 8 of Diamonds
    1250000,   // 8 of Spades
    1250000,   // 8 of Hearts
    1250000,   // 8 of Clubs
    2500000,   // 9 of Diamonds
    2500000,   // 9 of Spades
    2500000,   // 9 of Hearts
    2500000,   // 9 of Clubs
    5000000,   // 10 of Diamonds
    5000000,   // 10 of Spades
    5000000,   // 10 of Hearts
    5000000,   // 10 of Clubs
    15000000,  // Jack of Diamonds
    15000000,  // Jack of Spades
    15000000,  // Jack of Hearts
    15000000,  // Jack of Clubs
    30000000,  // Queen of Diamonds
    30000000,  // Queen of Spades
    30000000,  // Queen of Hearts
    30000000,  // Queen of Clubs
    70000000,  // King of Diamonds
    70000000,  // King of Spades
    70000000,  // King of Hearts
    70000000,  // King of Clubs
    125000000  // Joker
  ];
   ...
   */
   ...
   mapping(uint16 => mapping(uint8 => uint256)) public cardCollectionInfo;

  /**
* @notice Stores the dao address of collection
   */
  mapping(uint16 => address payable) public cardCollectionDaoAddress;
 ...
 * @dev Fired in addCollectionDaoAddress()
  ...
  /**
 * @notice Add new collection dao address to cardCollectionDaoAddress mapping
   *
   *
   * Emits a {DaoAddressAdded} event
   *
   * @param _collection collection id
   * @param _daoAddress dao address of collection
   */
  function addCollectionDaoAddress(uint16 _collection, address payable _daoAddress) external onlyOwner {
    // verify dao address is set
    require(_daoAddress != address(0), "dao address is not set");

    cardCollectionDaoAddress[_collection] = _daoAddress;

    // emit event
    emit DaoAddressAdded(
        _collection,
        _daoAddress
    );
  }
