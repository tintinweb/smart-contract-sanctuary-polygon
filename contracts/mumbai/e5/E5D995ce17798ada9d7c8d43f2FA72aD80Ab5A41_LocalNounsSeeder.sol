  ...
  function generateSeed(
    ...
    return
      Seed({
        background: 0,
        body: 0,
        accessory: uint48(descriptor.accessoryInPrefecture(prefectureId, pseudorandomness >> 96 % accessoryCount)),
        head: uint48(descriptor.headInPrefecture(prefectureId, pseudorandomness >> 144 % headCount)),
        glasses: 0
      });
  }
}