...
contract Soulbounds is ERC1155, ERC1155Burnable, Ownable, ERC5633 {
    constructor() ERC1155("") ERC5633() {
        ...
        _setTokenUri(0, "https://gateway.pinata.cloud/ipfs/QmVjcNEpLHG5eEZTMPeb9hYb2FgjNBrPqAJnzpg4dovT89");
        _setTokenUri(1, "https://gateway.pinata.cloud/ipfs/QmcDyWRTXm3m6Aed51ZRTjpvsecpJ4doVQL6Aj3dAKVVoQ");
    }
    ...
    function burn(address account, uint256 id, uint256 value) public override {
        require(account == _msgSender(), "ERC1155: caller is not token owner or contract owner");
