...
contract Pagamento {
    ...
    function pagar(uint256 montante) external payable {
        ...
        montantePendente[msg.sender] = montantePendente[msg.sender].add(montante);
    ...
    function transferirPagamento() external {
        ...
        // Conversão para Wei
        uint256 montanteWei = montante.mul(1e18); // 1 Matic = 1e18 Wei

        (bool success, ) = vendedor.call{value: montanteWei}("");
