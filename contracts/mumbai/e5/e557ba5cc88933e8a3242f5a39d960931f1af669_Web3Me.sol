...
contract Web3Me is ERC721, ERC721URIStorage, Ownable {
    ...
    constructor(string memory _initBaseURI) ERC721("Web3Me", "W3M") {
    ...
    function numToString(uint256 _i) internal pure returns (string memory _uintAsString) {
        if (_i == 0) {
            return "0";
        }
        uint256 j = _i;
        ...
        returns (string memory)
    {
        ...
        return string(abi.encodePacked(baseURI, numToString(tokenId)));
    }
}