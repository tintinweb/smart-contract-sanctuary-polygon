...
contract Test1206 is ERC721Mintable, ERC721Permit("Test1206 Take Shrine NFT:Token") , Ownable, ERC721URIStorage{
    string public _defaultURI;
    
    event UpdateDefaultURI(string defaultURI);

    constructor() ERC721("Test1206 Take Shrine NFT:Token", "Test1206 TAKE") {
        setDefaultURI("https://metadata.nft-studio.com/tes0222/");
    }
