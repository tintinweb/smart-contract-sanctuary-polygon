...
contract IDOL_Token {
    ...
    mapping(uint256 =>bool) private alreadyTranferred;
        ...
        returns (uint256 _Txid)
    {
     ...
     function PublicBuy(address _buyer, uint256 numOfTokens, bool _NeedStack )
        ...
        returns (uint256 _Txid){
            ...
            emit EForthroundTranfer(_Txid, msg.sender, _buyer, numOfTokens,block.timestamp,0);
        ...
        returns (bool)
    {
        ...
        require(alreadyTranferred[_txIndex]==false,"already Tranferred");
