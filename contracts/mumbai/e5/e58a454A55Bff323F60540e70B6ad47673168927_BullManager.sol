...
contract BullManager {
    ...
    IERC20 private USDC = IERC20(0x3e5570072f96a72703B0276109232eDe994e241E);
    address owner;
    ...
    address private LIQUIDITY = 0x85B89A9C600a35A440a406edEa582b1ebBD75545;
    address private OPERATING_COST = 0x9741De8EbCc09D4e0405Ed2d5581Cc9166c893C9;
    address private constant UNISWAP_V2_ROUTER = 0x8954AfA98594b838bda56FE4C12a09D7739D179b;
    ...
    function createTreeTo(string memory _treeName, address _to) external onlyOwner checkNameConflict(_to, _treeName) {
    ...
    function swap(uint256 _amountIn, address _to) internal {
        IERC20(token).approve(UNISWAP_V2_ROUTER, _amountIn + _amountIn * 10 / 100); // for sell tax
    ...
    function setOperatingCostAddress(address _address) external onlyOwner {
