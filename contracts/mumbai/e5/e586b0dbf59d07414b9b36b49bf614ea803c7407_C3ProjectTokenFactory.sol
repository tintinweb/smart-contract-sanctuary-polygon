    ...
    Common
{
    ...
    mapping(string => address[]) projectsLinkVintageERC20;
    ...
    function newToken(string memory _registry, string memory _project, uint256 _vintage) external virtual onlyOwner whenNotPaused {
        ...
        string memory signature = 'initialize(string,string,string,uint256,string,address)';
        ...
        projectsLinkVintageERC20[projectKey].push(tokenAddress);
    ...
    function checkProject(
        ...
        return infoProjects[_project] == _address;
        ...
        AccessControlUpgradeable
{
    ...
    function setOrchestratorAddresses(address _address) public {
        orchestratorAddress = _address;
    }
