...
contract NebulaDropsCollectible is ERC1155, Ownable {
    ...
    function mint(string memory _name, string memory _newuri, uint256 _id, uint256 _amount) 
        public 
        onlyOwner
     {
    ...
    function mintBatch(string memory _name, string memory _newuri, uint256[] memory _ids, uint256[] memory _amounts)
        public
        onlyOwner
    {
