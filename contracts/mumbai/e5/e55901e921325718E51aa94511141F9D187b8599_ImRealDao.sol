...
contract ImRealDao {
    ...
    RealDaoContract daoContract;

    constructor() {
        owner = msg.sender;
        nextProposal = 1;
        daoContract = RealDaoContract(0x2953399124F0cBB46d2CbACD8A89cF0599974963);
        validTokens = [59845586361153355532212910180820100211355560282750328758318744109287777240040];
    }
