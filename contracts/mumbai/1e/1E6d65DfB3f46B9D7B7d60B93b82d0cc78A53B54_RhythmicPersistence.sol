...
contract RhythmicPersistence is ERC721, PullPayment, Ownable {
    ...
    constructor() ERC721("RhythmicPersistence", "VDL_RP") {
        baseTokenURI = "";
    }
    ...
    function mintMultipleTo(address recipient, uint256 quantity) public payable returns (uint256) {
