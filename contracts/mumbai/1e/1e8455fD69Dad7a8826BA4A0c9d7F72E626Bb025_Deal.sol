...
contract Deal is Initializable, PausableUpgradeable {
    ...
    /// @notice Update rain token address, only Rain user can call this function
    ...
    /// @notice Add new hash to deal hash array, only Rain user can call this function
    ...
    /// @notice Remove hash from deal hash array, only Rain user can call this function
    ...
    /// @notice Update hash in deal hash array,only Rain user can call this function
    ...
    /// @notice Add new milestone to milestone array,only Rain user can call this function
    ...
    /// @notice Remove milestone from milestone array,only Rain user can call this function
    ...
    /// @notice Update milestone in milestone array, only Rain user can call this function
    ...
    /// @notice Add new revenue to revenue array, only Rain user can call this function
    ...
    /// @notice Remove revenue from revenue array, only Rain user can call this function
    ...
    /// @notice Update revenue in revenue array, only Rain user can call this function
    ...
    /// @notice Pause function,  only Rain compliancer can call this function
    function pause() external whenNotPaused onlyRainCompliancer {
        _pause();
    }

    /// @notice Unpause function,  only Rain compliancer can call this function
    function unpause() external whenPaused onlyRainCompliancer {
        _unpause();
    }
}