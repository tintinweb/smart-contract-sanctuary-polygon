...
contract JaPualGold is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    constructor(string memory baseURI) ERC721("JaPaulGold", "JPG") {
        _baseTokenURI = baseURI;
    }

    // mint an NFT
    function mint() public payable onlyWhenNotPaused {
        // check that the number of tokes created
        // remains as we wanted
        require(
            tokenIds < maxTokenIds,
            "Exceeded the max amount of JaPaul Gold NFTs"
        );
