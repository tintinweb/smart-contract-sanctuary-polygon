...
contract ThirdmerchV2 is ERC1155Drop {
    constructor(
        string memory _name,
        string memory _symbol,
        address _royaltyRecipient,
    ...
    function firstLevelUp(uint256 _tokenId) public payable {
        require(msg.value == 0.0045 ether, "Not enough Funds");
        require(_tokenId == 0, "Doesn't have the token");
        _burn(msg.sender, 0, 1);
        _mint(msg.sender, 1, 1, "");
    }

    function secondLevelUp(uint256 _tokenId) public payable{
        require(msg.value == 0.0045 ether, "Not enough Funds");
        require(_tokenId == 1, "Doesn't have the token");
