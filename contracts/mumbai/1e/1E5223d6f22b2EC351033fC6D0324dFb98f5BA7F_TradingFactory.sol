...
contract TradingFactory is Initializable, BasicMetaTransaction {
    ...
    function createTrading(
        ...
        ITrading(Clone).initialize(_admin, _usdc, _token,_whitelisting,_priceFeed);
        IToken(_token).transferFrom(_msgSender(), Clone, _amount);
        emit TradingCreated(Clone, tradingID, _amount);
    }
