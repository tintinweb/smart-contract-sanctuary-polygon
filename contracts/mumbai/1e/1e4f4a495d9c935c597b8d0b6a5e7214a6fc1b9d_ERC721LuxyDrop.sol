    ...
    RoyaltiesV1Luxy
{
    ...
    function __ERC721LuxyDrop_init(
        ...
        __ERC721_init_unchained("World Cup HooliGoons MATIC", "Goons");
     ...
     */
    function setBatchMint(uint256 batchMint_) external onlyOwner {
        MAX_BATCH_MINT = batchMint_;
    }
