...
contract SwapExamples {
    ...
    address public constant ASKJA = 0xE5208819eB69088f31059A97Abf9eB48763b89DA;
        ...
        returns (uint256 amountOut)
    {
        ...
        TransferHelper.safeApprove(ASKJA, address(swapRouter), amountIn);
        ...
        returns (uint256 amountIn)
    {
        ...
        TransferHelper.safeApprove(ASKJA, address(swapRouter), amountInMaximum);
