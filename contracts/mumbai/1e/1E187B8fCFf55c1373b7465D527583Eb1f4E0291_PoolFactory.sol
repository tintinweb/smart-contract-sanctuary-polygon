...
contract PoolFactory is Initializable, AccessControlEnumerableUpgradeable, TimeboundEIP712Upgradeable, UUPSUpgradeable, IPoolFactory, IContractFactory {
    ...
    address private poolDefaultAdmin;
    ...
    function createPack(uint256 poolId, ITokenBundle.Token[] calldata token, uint256[] calldata numOfRewardUnits, uint128 openStartTimestamp, uint128 amountDistributedPerOpen) external onlyRole(DEFAULT_ADMIN_ROLE) {
