...
contract AggregatorProxy is AggregatorProxyInterface, Owned {
    struct Phase {
        uint16 id;
    ...
    constructor(address aggregatorAddress) Owned() {
   ...
   */
    function getAnswer(uint256 roundId) public view virtual override returns (int256 answer) {
        ...
        AggregatorProxyInterface aggregator_ = s_phaseAggregators[_phaseId];
   ...
   */
    ...
    /**
     * @notice return a phase aggregator using the _phaseId
   *
