...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xa8DC963bD71d7095573722ae2A74cD920B207f18];
  address public erc20Payable = 0xa8DC963bD71d7095573722ae2A74cD920B207f18;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 100) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmfXwhMCpkuQDjse7PCwwh9H8FuzHa5CrEyAbwRkdcRRne/";
...
// File: contracts/OptimismLionzContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OptimismLionzContract is RamppERC721A {
    constructor() RamppERC721A("Optimism Lionz", "OLZ"){}
}
