...
* @author DeCommas team
    ...
    */
contract BBFabric is NonBlockingBaseApp, UUPSUpgradeable {
    ...
    function initialize(uint16 nativeChainId,
    ...
    */
    function _initNewProxy(uint256 strategyId,
        address implementation,
        bytes memory dataForConstructor) private returns(bool) {
    ...
    */
    function _upgradeProxyImplementation(uint256 strategyId,
        address proxyAddr,
        address newImplAddr) private returns(bool) {
