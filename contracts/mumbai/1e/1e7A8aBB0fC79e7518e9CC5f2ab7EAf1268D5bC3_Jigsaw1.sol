...
contract Jigsaw1 is ERC721Enumerable, Ownable {
    ...
    /// @notice Total Supply
    uint256 public jigsawTotal = 625;
    ...
    string private _tokenBaseURI = "ipfs://Qma44bSj49V9pAJUHa4mkRsWjrtE9jiQRDDaw7Cd9r9e4R/";
    ...
    */
    ...
    ///--------------------------------------------------------
     ...
     /**
     * @notice Admin can set totalJigsaw count
     * @param _jigsawTotal total jigsaw pieces of puzzle.
     */
    function setJigsawTotal(uint256 _jigsawTotal) external onlyOwner {
        jigsawTotal = _jigsawTotal;
    }
