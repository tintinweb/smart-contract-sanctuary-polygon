...
contract Marketplace is Ownable, ReentrancyGuard {
    ...
    event ItemCanceled(address indexed owner, address indexed nft, uint256 tokenId, bool isMultiToken);
    event OfferCreated(
    ...
    event OfferCanceled(address indexed creator, address indexed nft, uint256 tokenId, bool isMultiToken);
    ...
    function _cancelListing(
        ...
        delete (listings[_nftAddress][_tokenId][_owner]);
        emit ItemCanceled(_owner, _nftAddress, _tokenId, IERC165(_nftAddress).supportsInterface(INTERFACE_ID_ERC1155));
    }
}
