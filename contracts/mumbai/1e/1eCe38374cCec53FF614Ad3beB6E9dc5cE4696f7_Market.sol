...
/** 
 *  SourceUnit: /Users/iggyi/Git/culture-vault/cv-api/contracts/WertMarket_withValidation_withSellerSignature.sol
*/
...
contract Market is EIP712, ReentrancyGuard {
    ...
    address private wertAddress = 0x0000000000000000000000000000000000000000; 
    address private adminAddress = msg.sender;
    ...
    modifier onlyWert() {
        require(msg.sender == wertAddress, "msg call is not from wert's contract.");
        _;
    }

    function updateWertAddress(address _wertAddress) public {
        require(msg.sender == adminAddress, "Only CV Admin can update wert address.");
        wertAddress = _wertAddress;
    }
    ...
    function orderMatch(
        ...
        if (wertAddress != 0x0000000000000000000000000000000000000000) {
            require(wertAddress == msg.sender, "Order is not coming from Wert.");
        }
        ...
        address buyer = buyOrder.maker; // modify 
