...
contract DeveloperInsights is ERC1155, Ownable {
    ...
    //On mainnet:
    //address public currency = "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48";
    //On Goerli
    //address public _currency = 0x07865c6E87B9F70255377e024ace6630C1Eaa37F;
    //On Mumbai (it is WETH but from working perspective does not matter)
    address public _currency = 0xA6FA4fB5f76172d178d61B04b0ecd319C5d1C0aa;
    // Revenue recipient
    address public _recipient = 0x00A3401b6E2D6A977634F5FEf9a5930257a9c77C;

    /// @notice Check that a mint pass with given id exists
    /// @param id - Id of the mint pass
    modifier mpExists(uint256 id) {
        require(_mintPasses[id].passPrice != 0, 'MPF 401 - Mint pass does not exists');
        _;
    }
    ...
    function mint(
        ...
        require(
            ...
            'MPF 106 - Minting is closed currently'
        );
        ...
        if (_currency == CurrencyTransferLib.NATIVE_TOKEN) {
            if (msg.value != totalPrice) {
                revert('MPF 107 - Not proper amount sent');
            }
        }
