...
contract BanListable is OwnableUpgradeable {
  ...
  modifier notBanned(address _account) {
    require(isBanned[_account] == false, "BanListable: Account is banned");
    _;
  }

  function ban(address _account) public onlyOwner {
    isBanned[_account] = true;
    emit AccountBanned(_account);
  }

  function unban(address _account) public onlyOwner {
    // TODO: delete or set to false?
    delete isBanned[_account];
    emit AccountUnbanned(_account);
  }

  // TODO: destroy banned funds
}
