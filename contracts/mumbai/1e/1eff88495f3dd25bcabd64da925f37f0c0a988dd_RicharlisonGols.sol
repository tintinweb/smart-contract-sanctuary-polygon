...
contract RicharlisonGols is ERC1155, Ownable {
    ...
    uint256 private qtdePerGolMinted = 9;
    ...
    mapping(uint256 => uint256) private golsMinted;
    ...
    uint256 private _nftEtherValue = 231 ether;
    ...
    ) ERC1155("https://ipfs.io/ipfs/QmeafDctu8T1swGBW6dymLYWMmVuZruuBMSyXLRgKLUteD/{id}.json") {
        root = _root;
        _contractUri = _contractURI;
        _contractOwner = msg.sender;
        _name = "Richarlison Gols";
        _symbol = "RCHGOLS";
    }
    ...
    function mint(
        ...
        uint256 _numberGol, //Number of Gol
        ...
        require(_mintAmount + balanceOf(endUser, _numberGol) <= maxMintAmount, "Quantidade limite de mint por carteira excedida");
        require(supply + _mintAmount <= maxSupply, "Quantidade limite de NFT excedida");
        require(qtdePerGolMinted >= golsMinted[_numberGol], "Mint para essa quantidade de gols encerrada");
        ...
        addressMintedBalance[endUser] = addressMintedBalance[endUser] + _mintAmount;
        _mint(endUser, _numberGol, 1, "");
        updatedNumAvailableTokens = updatedNumAvailableTokens - _mintAmount;
        totalSupply++;
        golsMinted[_numberGol]++;
    ...
    function split(uint256 _mintAmount, bytes32[] memory proof) public payable {
