...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xBEBcc9514cb4c2B0B0217Ac36a024892ca8Ed64D];
  address public erc20Payable = 0xBEBcc9514cb4c2B0B0217Ac36a024892ca8Ed64D;
    ...
    
{
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/GaGsK3kKQbacBVP4DiE0/contract-metadata";
  }
...
// File: contracts/MyTestdegenProjectContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MyTestdegenProjectContract is ERC721APlus {
    constructor() ERC721APlus("My TEST DEGEN Project ", "MINTPLX"){}
}
