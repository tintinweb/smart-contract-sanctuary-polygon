...
contract SmartContract is ERC721A, Ownable, ReentrancyGuard {
  ...
  *****************************************************************************************************************************/
  modifier mintCompliance(uint256 _mintAmount) {
    ...
    if (_numberMinted(msg.sender) + _mintAmount >= maxMintAmountPerWallet) { revert MaxSupplyExceeded(); }
    _;
  }
  ...
  *****************************************************************************************************************************/
  modifier mintPriceCompliance(uint256 _mintAmount) {
    if (msg.value < mintPrice * _mintAmount) { revert InsufficientFunds(); }
    _;
  }
  ...
  *****************************************************************************************************************************/
  function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
	if (!_exists(_tokenId)) { revert ERC721__URIQueryForNonexistentToken(); }
  ...
  * setUriPrefix
  *****************************************************************************************************************************/
  function setUriPrefix(string memory _uriPrefix) private  onlyOwner {
  ...
  *****************************************************************************************************************************/
  function setHiddenMetadataUri(string memory _hiddenMetadataUri) private onlyOwner {
