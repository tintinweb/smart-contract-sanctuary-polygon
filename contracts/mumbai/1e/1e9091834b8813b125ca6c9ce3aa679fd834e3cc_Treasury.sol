...
contract Sale is Ownable2Step {
    ...
    /**
     * @notice Emit when a sale is sold out
     * @param saleId The id of the sale
     */
    ...
    function createSale(
        ...
        emit SaleStatusUpdated(saleId, SaleStatus.ACTIVE);
    ...
    function cancelSale(
        ...
        emit SaleStatusUpdated(saleId, SaleStatus.CANCELLED);
    ...
    function rejectSale(
        ...
        emit SaleStatusUpdated(saleId, SaleStatus.REJECTED);
