...
// File contracts/trees/StakingTree.sol
...
contract StakingTree is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721BurnableUpgradeable, AccessControlUpgradeable {
    ...
    function initialize(Batch calldata _batch, address admin, address _treesFactory) initializer public {
        ...
        string memory _name  = string(abi.encodePacked("Carbify Foundation Staking Tree B", Strings.toString(batch.no)));
        string memory _symbol = string(abi.encodePacked("STB", Strings.toString(batch.no)));
    ...
    function safeMintBatch(address to, uint256 quantity) public onlyRole(MINTER_ROLE) {
        ...
        require(_currentIndex + quantity <= batch.maxSupply, "Token ID exceeds max supply for Staking NFT");
