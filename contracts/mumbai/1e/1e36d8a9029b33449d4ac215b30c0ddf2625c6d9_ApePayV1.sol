...
contract ApePayV1 is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function verifyRecipient(
        ...
        bytes32 digest = _hashTypedDataV4(keccak256(abi.encode(
            keccak256("Payment(string recipient,bytes32 paymentId,uint128 nonce)"),
    ...
    function receivePayment(
        ...
        _receivePayment(paymentId, recipient, nonce_, signature, msg.sender);
    }
    ...
    function receivePaymentDelegate(
        ...
        _receivePayment(paymentId, recipient, nonce_, senderSignature, recipientAddress);
    }
    ...
    function _receivePayment(
        ...
        PaymentDetail memory paymentDetail = verifyRecipient(paymentId, recipient, nonce_, signature);
        // send fund
