...
} from "seadrop/src-upgradeable/src/ERC721ContractMetadataStorage.sol";
...
contract ExampleToken is ERC721PartnerSeaDropUpgradeable {
    ...
    function initialize(
        ...
        ERC721ContractMetadataStorage.layout()._contractURI = "https://gateway.pinata.cloud/ipfs/QmULRMtPruxNqovcGkCVXTWmhXrhaHfiNmrntzhoHjyeNN";
    }
