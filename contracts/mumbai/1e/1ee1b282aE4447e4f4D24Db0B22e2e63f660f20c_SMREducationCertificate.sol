...
contract SMREducationCertificate is  SMRCertificate {
    constructor() SMRCertificate("TEST - Education Certificate", "SMREDU", "Education") {
...
abstract contract SMRCertificate is ERC165, ERC721, ISMRCertificate {
  ...
  function supportsInterface(bytes4 interfaceId) public view virtual override (ERC165, ERC721) returns (bool) {
    ...
    function certificateDetails(uint256 tokenId) external override view returns (ISMRCertificate.Cert memory) {
