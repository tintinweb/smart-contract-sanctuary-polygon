...
contract MagicalGoatLand is ERC721, ERC721URIStorage, ERC721Burnable, Ownable, EIP712, ERC721Votes {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://gateway.pinata.cloud/ipfs/Qmeee53Ed9h6c7nXwaUvEztx7dH1T1KEVv5GcyK1D1fUc8/+https://ipfs.io/ipfs/QmT54oUziAjA1qruZ2RRTHpsvv4yVCj2TnD6NHYi1geRby/";
    }

    function safeMint(address to, uint256 tokenId, uint256 price) public onlyOwner {
        _safeMint(to, tokenId);
