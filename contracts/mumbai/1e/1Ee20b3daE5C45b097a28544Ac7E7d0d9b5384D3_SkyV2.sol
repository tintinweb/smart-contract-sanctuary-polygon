...
contract SkyV2 is IDollar, ERC20Burnable, Ownable {
    ...
    uint256 public dailyMintingCap = 5000000 ether; // 5 million daily
    ...
    constructor(address _treasury, uint256 _genesis_supply) ERC20("DarkCrypto Share 2.0", "SKY") {
        treasury = _treasury;
    ...
    function mint(address _address, uint256 _amount) external override {
        if (minterCap[_address] >= _amount) {
            minterCap[_address] -= _amount;
