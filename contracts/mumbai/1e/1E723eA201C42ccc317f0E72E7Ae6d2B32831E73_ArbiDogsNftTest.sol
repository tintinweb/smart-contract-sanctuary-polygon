    ...
    AccessControl
{
     ...
     */
    modifier onlyMinter() {
        require(msg.sender == minter, 'ArbiDogsNftTest: caller is not the minter');
        _;
    }

    /*
     * @dev Constructs a new ArbiDogsNftTest
    ...
    constructor(
        address _minter,
        string memory _uri
    ) ERC721('ArbiDogsTest Nft', 'ARBIDOGST') {
        require(_minter != address(0), 'ArbiDogsNftTest: invalid minter address');
    ...
    function _setBaseURI(string memory _uri) internal {
        require(bytes(_uri).length != 0, 'ArbiDogsNftTest: invalid uri');
        baseURI = _uri;
    }
