...
contract MetaOMaticM6PROXYSMCB is  IPOLYCONTRACTM6PROXYB {
    ...
    constructor() {
      ...
      maincontract=IPOLYCONTRACTMAIN(0x8c4a90707aF84d30E4D102f20Cf6071B0adBA8DD);
      m6contract=IPOLYCONTRACTM6(0xB358eADD74113250E4913A076922E49D793771e5);
    ...
    function _PlaceInM660Tree(address user,address referrer) public override returns(bool) {
       ...
       if(NoofIdInFirstLevel==2) {
         ...
         if(leftid1stlevelId==0) {
            ...
            _M660Details[parent].noofidinsecondlevel[leftrecycleno]+=1;
         }
            ...
            if(rightid1stlevelId==0){
               ...
               m6contract.creditM6Income(sponsor,0,1,IsFreshId);
               _M660Details[parent].noofidinsecondlevel[rightrecycleno]+=1;
            }
    ...
    function _PlaceInM6120Tree(address user,address referrer) public override returns(bool) {
       ...
       if(NoofIdInFirstLevel==2) {
         ...
         if(leftid1stlevelId==0) {
            ...
            _M6120Details[parent].noofidinsecondlevel[leftrecycleno]+=1;
         }
         else if(leftid1stlevelId==1) {
            //If Only 1 Id Then Id Will Place In Right Only at 1st Level
            ...
            if(rightid1stlevelId==0){
               ...
               address sponsor=maincontract.getSponsorId(rightid);
               m6contract.creditM6Income(sponsor,1,1,IsFreshId);
               _M6120Details[parent].noofidinsecondlevel[rightrecycleno]+=1;
            }
            else if(rightid1stlevelId==1){
               //If Only 1 Id Then Id Will Place In Right Only at 1st Level
