...
contract TheStripesNFT is ERC721Enumerable, Ownable {
    ...
    uint256 public maxSupply = 1000;                                                                                                    // errors when cahnged 1000
    uint256 public maxMintAmount = 1000;                                                                                                          // errors when changed 20
    ...
    constructor(
        ...
        mint(msg.sender, 100);                                                                                                               // inital mint to adress creator 20
    }
