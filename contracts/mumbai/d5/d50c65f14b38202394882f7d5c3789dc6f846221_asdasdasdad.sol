...
contract asdasdasdad {
	using SafeMath for uint256;
    using SafeMath for uint8;

	uint256 constant public INVEST_MIN_AMOUNT = 0.1 ether; // 10 Lowest Mecha
	uint256[] public REFERRAL_PERCENTS = [70, 50, 10];
	...
	uint256 WITHDRAW_FEE_1 = 1; //1%
	uint256 WITHDRAW_FEE_2 = 1; //1%
