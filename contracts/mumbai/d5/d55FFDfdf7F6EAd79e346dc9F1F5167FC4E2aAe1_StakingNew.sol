...
contract StakingNew{
    ...
    constructor (address tokenAddress_, uint256 stakingCap_){
        ...
        earlyWithdrawTimeStarts = stakingStarts; 
        afterMaturityTimeStarts = earlyWithdrawTimeStarts.add(777600); //9 days
    ...
    */
    function calculateWithdrawEarlyRewards(uint256 amount) public view returns(uint256){
        uint256 denom = getNumberOfDays((afterMaturityTimeStarts).sub(stakingStarts));
        denom = (denom).mul(100);
