...
contract UnityToken is Context, IBEP20, Ownable {
    ...
    string  private _NAME = 'Unity Token';
    ...
    uint256 private _tTotal = 500000000000 * _DECIMALFACTOR;
    ...
    uint256 private _MAX_TX_SIZE = 500000000000 * _DECIMALFACTOR;
