...
contract TeamOgra is ERC721AQueryable, Ownable {
  using Strings for uint256;

  string public uriPrefix = '';
  string public uriSuffix = '.json';

  constructor() ERC721A("Team Ogra NFT", "members") {
        setUriPrefix("ipfs://QmX3MG1U8Lz118rYngNhKc5tveJ559Db6dnkhfjwtyiNPD/");
        _safeMint(owner(), 13);
  }
