...
contract Single_Bid is ERC721{
    ...
    function createNFT(address _creator, string memory uri, uint _royalty) public nftNotCreated(uri){
        tokenId.increment();
...
//----------------------------------Bidding-----------------------------------------
    ...
    function start(uint _nftId) public {
...
function artistOfNFT(uint _token_id) public view returns(address)
{
