...
// File: contracts/final_ufonaut.sol
...
contract UFOnaut is ERC721, ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("UFOnaut Test2 ", "UFO 2") {}
    ...
    function updateTokenId(uint256 tokenId, string memory uri) public onlyOwner {
        _setTokenURI(tokenId, uri);
    }
