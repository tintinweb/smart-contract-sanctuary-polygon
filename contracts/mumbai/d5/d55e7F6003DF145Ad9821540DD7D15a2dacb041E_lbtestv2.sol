...
contract lbtestv2 is VRFV2WrapperConsumerBase,ConfirmedOwner,ReentrancyGuard {
        ...
        VRFV2WrapperConsumerBase(linkAddress, wrapperAddress) 
    {
        ...
        lottoWeekly = IluckblocksWeekly(0x754369D7ce4366434e9EBbbf189d900768EFB586);
        weeklyContract = 0x754369D7ce4366434e9EBbbf189d900768EFB586;
    ...
    function autoSpin(address _caller, uint256[] calldata _nodes) public nonReentrant {
        ...
        if(lbNodes.getUserActivation(_caller,0) == false){
            ...
            require(block.timestamp > lastAutoSpin + 86400,"draw timestamp still not reached.");
