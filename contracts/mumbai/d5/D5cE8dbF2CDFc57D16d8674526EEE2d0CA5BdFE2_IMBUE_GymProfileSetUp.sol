...
contract IMBUE_GymProfileSetUp {
    ...
    function approveTransfer(uint256 daiAmount) public returns(bool){
        bool successApproved = daiInstance.approve(address(0x4dE10a0BaB1b1CB9948f19aF8d8571D6312944B2), daiAmount);
    ...
    function buy(uint256 daiAmount) public {
        ...
        bool success = daiInstance.transferFrom(msg.sender, address(0x4dE10a0BaB1b1CB9948f19aF8d8571D6312944B2), daiAmount);
