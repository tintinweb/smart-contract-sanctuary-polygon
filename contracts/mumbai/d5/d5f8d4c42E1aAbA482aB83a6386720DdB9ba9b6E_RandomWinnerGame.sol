...
contract RandomWinnerGame is VRFConsumerBase, Ownable {
    ...
    uint8 maxPlayers;
    // Variable to indicate the game started
    bool public gameStarted;
    // entry feee of current game
    uint256 entryFee;
    // current game id
    ...
    function startGame(uint8 _maxPlayers, uint256 _entryFee) public onlyOwner{
        ...
        require(_maxPlayers > 0, "You cannot create a game with max players 0");
    ...
    function joinGame() public payable {
        require(gameStarted, "Game has no been started yet");
