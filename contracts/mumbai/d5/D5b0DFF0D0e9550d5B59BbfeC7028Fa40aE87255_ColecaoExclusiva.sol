...
contract ColecaoExclusiva is ERC721A, Ownable {
    using Address for address;
    using Strings for uint256;
    ...
    uint256 private _nftEtherValue = 42000000000000000000;
    ...
    ) ERC721A("B.C. Espaco Literario Exclusiva", "BC-LITx") {
