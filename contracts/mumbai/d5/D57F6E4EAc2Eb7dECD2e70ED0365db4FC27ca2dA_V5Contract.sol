...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1663232400;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1663225200;
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x96840E9c23D71D681c56A627854558a6044C659d];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x96840E9c23D71D681c56A627854558a6044C659d;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmRSzh6Jec7cGZBLK1Ym3iNmNX6Xfvcdh4aWG7rnkSfPCG/";
...
// File: contracts/V5Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract V5Contract is RamppERC721A {
    constructor() RamppERC721A("v5", "TKZC"){}
}
