...
// File contracts/ChainBattles.sol



pragma solidity ^0.8.0;
// deployed on mumbai: 0xB674E69183325e090a33816767e896ec13BB2ef3
// after complete challenge: 0xD58D740D37c2EeA09810C292bF040C1bde4D339D
...
contract ChainBattles is ERC721URIStorage {
  ...
  function generateCharacter(uint256 tokenId) public view returns(string memory){
    ...
    bytes memory svg = abi.encodePacked(
        ...
        '<text x="50%" y="50%" class="base" dominant-baseline="middle" text-anchor="middle">', "Levels: ",info.level,'</text>',
