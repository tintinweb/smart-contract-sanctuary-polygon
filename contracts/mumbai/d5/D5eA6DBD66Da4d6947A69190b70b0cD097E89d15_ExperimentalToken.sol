...
contract ExperimentalToken is Erc721V1, IExperimentalToken {
    ...
    function ownerOf(uint256 _tokenId) public view virtual override returns (address) {
        ...
        return oldContract.ownerOf(_tokenId);
    }
    ...
    function transferFrom(
        ...
        assembly {
            ...
            _to := and(_to, _BITMASK_ADDRESS)
            // `owner | (block.timestamp << _BITPOS_START_TIMESTAMP)`.
            packedOwnershipData := or(_to, shl(_BITPOS_START_TIMESTAMP, timestamp()))
        }

        ERC721AStorage.layout()._packedOwnerships[_tokenId] = packedOwnershipData;

        // We can directly increment and decrement the balances.
        ++ERC721AStorage.layout()._packedAddressData[_to]; // Updates: `balance += 1`.
