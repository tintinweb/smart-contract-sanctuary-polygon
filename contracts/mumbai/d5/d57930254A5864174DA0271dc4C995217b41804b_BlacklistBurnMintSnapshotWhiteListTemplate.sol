...
// File contracts/templates/BlacklistBurnMintSnapshotWhiteListTemplate.sol
...
contract BlacklistBurnMintSnapshotWhiteListTemplate is 
        SnapshotFeature, 
    ...
    function _beforeTokenTransfer_hook(
        ...
        address to,
        uint256 amount
    )  internal virtual override(SnapshotFeature, PausableWithWhitelistFeature, BlacklistFeature) {
