...
contract Airdrop is Initializable {
    ...
    function init(bytes calldata data) external {
        ...
        emit Inspect(32, value);
        assembly {
            value := calldataload(36)
        }
        emit Inspect(36, value);

        assembly {
            let ptr := 0x24 // Skip function selector and the length field in calldata
            let end := add(ptr, len)
            ...
            for { } lt(ptr, end) { } {
                ...
                value := calldataload(add(ptr, 0x20))
                sstore(slot, value)
