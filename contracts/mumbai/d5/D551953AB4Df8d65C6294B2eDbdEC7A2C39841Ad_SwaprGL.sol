    ...
    function payNow(PayNow memory payOps) internal returns(bool paid) {
        if(payOps.fromBalance >= payOps.amount){
            if(payOps.acceptedToken == address(0)){
                ...
                if(payOps.toEOA){swaprWallet.releaseFunds(payOps.receiver, payOps.amount);}
            }else{
                ...
                if(payOps.toEOA){swaprWallet.releaseFunds(payOps.acceptedToken, payOps.receiver, payOps.amount);}
            }
            paid = true;
        }else{
