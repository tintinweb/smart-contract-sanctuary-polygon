...
contract AxelarImpl is IAxelarExecutable {

    IAxelarGasService gasReceiver;

    event MsgReceived(string sourceChain_, string sourceAddress_, bytes payload_);
    ...
    function _execute(
        ...
        emit MsgReceived(sourceChain_, sourceAddress_, payload_);
    }
}
