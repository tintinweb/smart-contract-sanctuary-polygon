...
contract Token_Sample is ERC20, ERC20Burnable {
    constructor() ERC20("ERC20 Token", "MYTT") {
...
contract Vendor is Ownable {
  ...
  constructor(address tokenAddress) {
    yourToken = Token_Sample(tokenAddress);
  }
