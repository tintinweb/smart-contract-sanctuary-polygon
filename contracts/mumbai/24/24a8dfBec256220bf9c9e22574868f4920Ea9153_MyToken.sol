...
contract MyToken is Initializable, ERC721Upgradeable, OwnableUpgradeable, UUPSUpgradeable{
    ...
    // function setTokenName(string memory name, string memory symbol) external {
    //     __ERC721_init(name, symbol);
    // }

    // function setTokenSymbol(string memory symbol) external {
    //     require(msg.sender == owner(), "Only the owner can change the token symbol");
    //     _tokenSymbol = symbol;
    // }
