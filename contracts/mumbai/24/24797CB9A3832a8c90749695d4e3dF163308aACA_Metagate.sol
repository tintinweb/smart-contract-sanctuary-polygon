...
contract Metagate is ERC721 {
  ...
  mapping(uint256 => uint8) public classes;
  ...
  function kesack(
    ...
    return keccak256(abi.encodePacked(tokenId, ',', type_, ',', class));
  }
  ...
  function mint(
    ...
    bytes32 hashed = keccak256(abi.encodePacked(tokenId, ',', type_, ',', class));
    require(owner == hashed.toEthSignedMessageHash().recover(signature), 'Invalid signature, ');
