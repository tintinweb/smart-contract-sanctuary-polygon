...
contract SHEESHA is ISheeshaToken, ERC20Permit, Ownable {
     ...
     * @param _partnershipEcosystemMarketing Address where partnership
     * tokens to send (10% of supply).
     * @param _treasury Address where treasury tokens to send (10% of supply).
     */
    constructor(address _partnershipEcosystemMarketing, address _treasury)
        ERC20("SHEESHA POLYGON", "mSHEESHA")
        ERC20Permit("SHEESHA POLYGON")
    {
        partnershipEcosystemMarketing = _partnershipEcosystemMarketing;
        treasury = _treasury;
        _mint(address(this), INITIAL_SUPPLY);
        _transfer(
            address(this),
            _partnershipEcosystemMarketing,
            (INITIAL_SUPPLY * 10) / 100
        );
        _transfer(address(this), _treasury, (INITIAL_SUPPLY * 10) / 100);
    }
    ...
    function transferVaultRewards(address vaultAddress_) external onlyOwner {
        ...
        _transfer(address(this), vaultAddress_, (INITIAL_SUPPLY * 10) / 100);
        ...
        onlyOwner
    {
        ...
        _transfer(address(this), vaultLPAddress_, (INITIAL_SUPPLY * 20) / 100);
