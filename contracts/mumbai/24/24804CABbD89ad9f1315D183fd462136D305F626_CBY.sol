...
contract CBY is ERC20 {
    ...
    */
    function setPairAddress(address addr, bool status) external onlyOwner addrNotNull(addr) {
        isPair[addr] = status;
    ...
    */
    function setRouterAddress(address addr, bool status) external onlyOwner addrNotNull(addr) {
    ...
    */
    function setWhiteListAddress(address addr, bool status) external onlyOwner addrNotNull(addr) {
