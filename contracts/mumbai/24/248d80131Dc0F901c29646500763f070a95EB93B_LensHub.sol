    ...
    ILensHub
{
    ...
    /// @inheritdoc ILensHub
    function getFollowNFT(uint256 followType, uint256 profileId)
        external
        view
        override
        returns (address)
...
library InteractionLogic {
    ...
    function _followSingle(
        ...
        uint256 tokenId = IFollowNFT(followNFT).mint(follower);
        ...
        // console.log("_followSingle tokenId:",tokenId);
        return tokenId;
    }
...
library PublishingLogic {
    ...
    function createComment(
        ...
        address refModule = _pubByIdByProfile[vars.profileIdPointed][
            vars.pubIdPointed
        ].referenceModule;
    ...
    function createMirror(
        ...
        (uint256 rootProfileIdPointed, uint256 rootPubIdPointed, ) = Helpers
            .getPointedIfMirror(
                vars.profileIdPointed,
                vars.pubIdPointed,
                _pubByIdByProfile
        ...
        _pubByIdByProfile[vars.profileId][pubId]
        ...
        // Reference module validation
        address refModule = _pubByIdByProfile[rootProfileIdPointed][
            rootPubIdPointed
        ].referenceModule;
        if (refModule != address(0)) {
