...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 USDT = IBEP20(0xA02f6adc7926efeBBd59Fd43A84f4E0c0c91e832);
    address WBNB = 0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889;
    IDEXRouter router;
...
contract infinityglobalnftgame is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "INFINITY GLOBAL NFT GAME";
    string constant _symbol = "ING";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 40; // 2,5%
    uint256 public maxWalletTokens =  100000000 * (10**9); // Anti-Whale
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x803c698f680e702609fb09F7782bEA2Ccd3CbdA0 ;
