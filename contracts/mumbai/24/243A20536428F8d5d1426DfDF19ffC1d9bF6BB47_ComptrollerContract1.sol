 ...
 * @author Agile
 */
contract ComptrollerContract1 is ComptrollerV4Storage, ComptrollerInterfaceG2, ComptrollerErrorReporter, ExponentialNoError {
    ...
    function _become(UnitrollerContract1 unitroller) public {
    ...
    uint public testingSupplySpeed = 0;
    uint public testingBlock = 0;
    uint public testdeltaBlocks = 0;
    uint public testIf = 0;
    /**
    ...
    function updateAgileSupplyIndex(address aToken) internal {
        ...
        testingSupplySpeed = supplySpeed;
        uint blockNumber = getBlockNumber();
        testingBlock = blockNumber;
        uint deltaBlocks = sub_(blockNumber, uint(supplyState.block));
        testdeltaBlocks = deltaBlocks;
...
//cont...
    ...
    uint public testmintInternal = 0;
     ...
     * @return (uint, uint) An error code (0=success, otherwise a failure, see ErrorReporter.sol), and the actual mint amount.
     */
    uint public testmintFresh =0;
    uint public testallowed = 0;
 ...
 */
contract UnitrollerContract1 is UnitrollerAdminStorage, ComptrollerErrorReporter {
