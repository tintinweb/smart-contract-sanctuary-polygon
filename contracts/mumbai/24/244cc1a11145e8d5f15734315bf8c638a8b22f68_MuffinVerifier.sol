...
//    function hasBeenVerified(uint256 isVerified) external view returns(uint256);
//}
...
contract MuffinVerifier is ERC20, ZKPVerifier{

    uint64 public constant TRANSFER_REQUEST_ID = 1;
    uint64 public isVerified = 0;
    ...
    function manualVerify() public returns(uint256){
        isVerified = 1;
        return isVerified;
    }
