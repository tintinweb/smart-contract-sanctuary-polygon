...
contract SwarmPriceFeed is Ownable {
    ...
    constructor(
        ...
        setLatestAnswer(_latestAnswer, _latestTimestamp);
    ...
    function setLatestAnswer(uint256 _answer, uint256 _timestamp) public onlyOwner {
        emit LatestAnswerUpdated(_answer, _timestamp);
