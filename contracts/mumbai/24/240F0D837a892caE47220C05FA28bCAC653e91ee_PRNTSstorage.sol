...
contract PRNTSstorage is Ownable {
    ...
    */
    function createPublication(
        ...
        uint256 _pctToDistributePerShare
            ...
            emit PublicationCreated(id, _publicationId, _artistId, _sfIndexId, _pctProfitToDistribute, _pctToDistributePerShare);
    }
        ...
        for (uint256 i = 0; i < revenues.length; i++) {
            if  (
                ...
                keccak256(abi.encode(revenues[i].monthYear))
                    ...
                    revert("Publication ID or MonthYear do not exist, create a new Revenue");
                }
        }
    ...
    */
        ...
        for (uint256 i = 0; i < revenues.length; i++) {
            ...
            if  (
                ...
                keccak256(abi.encode(artists[i].artistAddress))
                    ...
                    revert("Artist ID or Artist Address does not exist or incorrect");
                }
        }
    ...
    function updatePublicationSFIndexID(
        ...
        emit PublicationSFIndexIDUpdated(
            _publicationId,
            _artistId,
            _sfIndexId
        );
