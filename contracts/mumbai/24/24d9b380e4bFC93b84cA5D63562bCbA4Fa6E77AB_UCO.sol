...
contract UCO is ERC721AUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function initialize(string memory _name, string memory _symbol, string memory _projectID) initializerERC721A initializer public {
    ...
    function mint(address owner, uint256 quantity, string[] memory cidArr) external payable onlyOwner nonReentrant {
