...
// File contracts/Liquidity/UniswapV3.sol
...
contract ProvideLiquidity is IERC721Receiver {
    address public immutable _token1; //0x6B175474E89094C44Da98b954EedeAC495271d0F;
    address public immutable _token2; //0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48;
        ...
        )
    {
        ...
        TransferHelper.safeApprove(_token1, address(this), amount0ToMint);
        TransferHelper.safeApprove(_token2, address(this), amount1ToMint);

        // transfer tokens to contract
        TransferHelper.safeTransferFrom(_token1, msg.sender, address(this), amount0ToMint);
        TransferHelper.safeTransferFrom(_token2, msg.sender, address(this), amount1ToMint);

        // TransferHelper.safeTransfer(DAI, address(this), amount0ToMint);
        // TransferHelper.safeTransfer(USDC, address(this), amount1ToMint);

        // Approve the position manager
        TransferHelper.safeApprove(_token1, address(nonfungiblePositionManager), amount0ToMint);
        TransferHelper.safeApprove(_token2, address(nonfungiblePositionManager), amount1ToMint);
        ...
        if (amount1 < amount1ToMint) {
            TransferHelper.safeApprove(_token2, address(nonfungiblePositionManager), 0);
