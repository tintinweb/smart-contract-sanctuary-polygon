...
contract _6262023_pfp is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
    uint256 public MAX_SUPPLY = 5;

    
    uint256 public PHASE_SUPPLY = 4;
    
    bool public IS_PHASE_ACTIVE = false;

    
    uint256 public PHASE_TX_LIMIT = 4;

    
    uint256 public PHASE_WALLET_LIMIT = 4;

    
    uint256 public PHASE_PRICE = 0.01 ether;
    ...
    string private preRevealURI = "https://ipfs.w3bmint.xyz/ipfs/QmWD7ubCja66UaNhcMWqxReUTJLFiXvzbtsJ5CQwVRh9Fu";
    ...
    constructor() ERC721A("_6262023_pfp", "ASFFFF") {
