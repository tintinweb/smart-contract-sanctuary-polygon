...
contract purchase {
    ...
    function buyCourse(uint $USDC, address contentCreator) public {
        ...
        // approving
        USDc.approve(address(0x42bb40bF79730451B11f6De1CbA222F17b87Afd7), contentCreatorAmount);

        // wrapping
        ISuperToken(address(0x42bb40bF79730451B11f6De1CbA222F17b87Afd7)).upgrade(contentCreatorAmount);
