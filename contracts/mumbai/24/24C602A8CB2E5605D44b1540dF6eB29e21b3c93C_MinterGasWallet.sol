...
contract MinterGasWallet is Initializable, UUPSUpgradeable {
    ...
    event Refund(address indexed account, uint256 indexed amount);
    ...
    function refundGas(address account, uint256 gasFeeUtilized) 
        public 
        onlyOperator 
    {
        ...
        uint refundAmount = balanceOf(account) - gasFeeUtilized;
        ...
        (bool transferSuccess, ) = payable(account).call{value:gasFeeUtilized}("");
...
contract GasV2 is MinterGasWallet {
