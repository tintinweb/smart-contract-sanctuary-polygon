...
contract SimpleUpgradeable721_V3 is ERC721Upgradeable, OwnableUpgradeable {
    ////////////////////////////// 以下Storage変数 //////////////////////////////
    // V1で定義したストレージ変数
    mapping(uint256 => string) internal _token2hash;
    uint256 internal _localTokenId;
    // V2で定義したストレージ変数
    string public messageForV2;
    // V3で定義したストレージ変数
    string public messageForV3_1;
    string public messageForV3_2;

    ////////////////////////////// 以下Modifier関数 //////////////////////////////

    modifier initialized() {
        require(version() == 3, "not initialized");
        _;
    }
    ...
    function initialize() public reinitializer(3) {
        messageForV3_1 = "hello";
        messageForV3_2 = "world";
    }
    ...
    function totalTransferred() public view virtual returns (uint256) {
        return totalSupply() - totalOwned();
    }
