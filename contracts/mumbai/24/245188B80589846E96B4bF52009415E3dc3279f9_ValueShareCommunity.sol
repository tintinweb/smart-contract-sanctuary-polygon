...
contract ValueShareCommunity is IERC721Receiver {
    ...
    address public _erc721FactoryAddress = 0x465069D3d6Ec45CDB006ec3E22cC9E8d6f9793eF; // 0x03ABAd83b9f2F182D6C9d3FA70619Abc2edc8ccC
    address public _fixedExchangeAddress = 0x65Ee19cd86dE140fE08Bfd5d51e62Fe53e96358f;
    address public _oceanAddress = 0x8967BCF84170c91B0d24D4302C2376283b0B3a07;
    ...
    constructor(address owner1, address owner2, address erc721FactoryAddress, address fixedExchangeAddress, address oceanAddress) {
        coOwner1 = owner1;
        coOwner2 = owner2;
...
// [['0x65Ee19cd86dE140fE08Bfd5d51e62Fe53e96358f', [0x8967BCF84170c91B0d24D4302C2376283b0B3a07,'0xE5a35520B7F1cB5ff2Fb723AdD9847c509A7e546','0x9984b2453eC7D99a73A5B3a46Da81f197B753C8d','0x0000000000000000000000000000000000000000'], [18,'18','1000000000000000000','0','1']]
    ...
    function createNftWithErc20WithFixedRate(
        ...
        IERC721Factory.NftCreateData memory _NftCreateData = IERC721Factory.NftCreateData(
            name, symbol, 1, "", true, address(this)
        );
        string[] memory strings = new string[](2);
        strings[0] = name;
        strings[1] = symbol;
        ...
        address[] memory addresses = new address[](4);
        addresses[0] = address(this); // minter account who can mint datatokens (can have multiple minters)
        addresses[1] = address(this); // feeManager initial feeManager for this DT
        addresses[2] = address(this); // publishing Market Address
        addresses[3] = 0x0000000000000000000000000000000000000000; // publishing Market Fee Token
        ...
        IERC721Factory.FixedData memory _FixedData = IERC721Factory.FixedData(
            _fixedExchangeAddress, addresses2, uints2
        );
    ...
    function createNftWithErc20WithFixedRate2(
