...
/**
 * @title Factory module for dStorage ERC721 basic
 *
 * @notice this implements a factory module to create a new instance of the
 * dStorage ERC721 basic contract
 */
contract FactoryModuleERC721 is IFactoryModule {
    /**
     * @inheritdoc IFactoryModule
     */
    function createToken(
        ...
        DStorageERC721 token = new DStorageERC721(name, symbol, uri, max);
        token.setReceiver(owner);
