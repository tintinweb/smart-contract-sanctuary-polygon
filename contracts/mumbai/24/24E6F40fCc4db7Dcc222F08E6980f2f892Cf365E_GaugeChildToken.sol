...
contract GaugeChildToken is BlacklistToken {
     ...
     */
    function initialize(string memory name_, string memory symbol_, address _blacklist, address _childChainManagerProxy) public initializer {
    ...
    function deposit(address user, bytes calldata depositData) external {
        ...
        //All this process is already implemented as internal functions
        _mint(user, amount);
