...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x69BE378d6BaB44181FA7885DC68E76BbFC54F089,0x588Fe7E8E2B3EB19e701091332A2f5110AE79CA4,0x225eda4423B9522ade57bb73C9E00d305401BF6f];
  uint256[] public payableFees = [5,55,20,20];
...
abstract contract EarlyMintIncentive is Ownable, ERC721A {
  ...
  uint256 public EARLY_MINT_PRICE = 40 ether;
  uint256 public earlyMintTokenIdCap = 52;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://Qmage4KhUaFtdxy88UNJPgS8su4AgXeNwYvFSPaaSdLNvP/";
...
// File: contracts/JokerPokerSeason1Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract JokerPokerSeason1Contract is RamppERC721A {
    constructor() RamppERC721A("Joker Poker Season 1", "NFTPC"){}
}
