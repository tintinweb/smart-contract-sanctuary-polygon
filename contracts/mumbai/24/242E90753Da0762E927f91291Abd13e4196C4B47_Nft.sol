...
contract Nft is ERC721PresetMinterPauserAutoId, Ownable, ERC2981, IChildToken, AccessControlMixin {
    constructor(
        string memory name,
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC721PresetMinterPauserAutoId, ERC2981, AccessControl)
        returns (bool)
    {
