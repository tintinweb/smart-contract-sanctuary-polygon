...
contract MyToken is ERC721, ERC721Enumerable, Pausable, Ownable, ERC721Burnable {
    ...
    function contractURI() public view returns (string memory) {
        return "https://bafkreieb2quxdl3ba4dlqgljjfayaagrvvutr3sbqsbo5wg22v5hv366p4.ipfs.nftstorage.link/";
    }

   function tokenURI(uint256 tokenId) public view override returns (string memory) {
        require(_exists(tokenId), "ERC721Metadata: URI query for nonexistent token");
        string memory imageToken = "https://www.eldiario.ec/wp-content/uploads/2021/06/hhh-copia.png" ;
