...
contract LotteryChild is VRFConsumerBaseV2, Ownable {
    ...
    */
    ...
    /**
    * @dev Number of purchased project tickets.
    ...
    */
    ...
    /**
    * @dev Get specific ticket from project.
    * @param _projectId: projectId
    * @param _idx: id
    */
    ...
    /**
    * @dev Generate user hash (projectId + userAddress).
    * @param _projectId: projectId
    ...
    */
    ...
    /**
    * @dev Get available tickets to purchase for user & specific project
    * @param _projectId: projectId
    * @param _user: user address
    */
