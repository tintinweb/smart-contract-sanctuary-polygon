    ...
    PaymentSplitter 
{
    ...
    onlyAccounts
    {
        require(msg.sender == account,          "GemmClub: Not allowed");
        require(presaleM,                       "GemmClub: Presale is OFF");
        require(!paused,                        "GemmClub: Contract is paused");
        require(
            _amount <= presaleAmountLimit,      "GemmClub: You maxed and took your presale token limit to the MOON!");
        require(
            _presaleClaimed[msg.sender] + _amount <= presaleAmountLimit,  "GemmClub: You maxed and took your presale token limit to the MOON!");
        ...
        require(
            ...
            "GemmClub: max supply exceeded"
        );
        require(
            _price * _amount <= msg.value,
            "GemmClub: Not enough ethers sent"
        );
    ...
    onlyAccounts
    {
        ...
        require(!paused, "GemmClub: Contract is paused");
        require(_amount > 0, "GemmClub: zero amount");
        ...
        require(
            _price * _amount <= msg.value,
            "GemmClub: Not enough matic sent"
        );
