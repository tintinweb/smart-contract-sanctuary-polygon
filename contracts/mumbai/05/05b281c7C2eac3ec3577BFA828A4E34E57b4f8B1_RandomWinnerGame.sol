...
contract RandomWinnerGame is VRFConsumerBase, Ownable {
    ...
    /**
    * constructor inherits a VRFConsumerBase and initiates the value for keyhash, fee and gameStarted
    * @param vrfCoordinator address of VRFCoordinator contract
    * @param linkToken address of LINK token contract
    * @param vrfFee the amount of LINK token to send with the request
    ...
    * joinGame is called when a player wants to enter the game
     ...
     * This function is overrided to act upon the random number 
    ...
    * getRandomWinner is called to start the process of selecting a random winner
     */
     function getRandomWinner() private returns (bytes32 requestId) {
        ...
        // requestRandomness is a function within the VRFConsumberBase
