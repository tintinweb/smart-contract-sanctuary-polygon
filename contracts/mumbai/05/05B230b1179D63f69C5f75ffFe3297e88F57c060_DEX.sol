...
contract DEX {
    ...
    function Register(address TAddress, address owner,string memory TName) public {
        tokenAddressess[TAddress] = true;
        tokenAdressNamelist.push(TName);
    ...
    function tokenList() public view returns (string[] memory) {
