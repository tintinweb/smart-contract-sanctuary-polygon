...
contract WaruClaimWTC is Ownable{
    ...
    function claimRewards() external callerIsUser {
        require((nft.balanceOf(msg.sender) > 0) || (token.balanceOf(msg.sender) >= 10000000000000000000000), "Need at least 1 NFT or 10k+ tokens.");
