...
contract DataQuest_Hack {
    ...
    function createQuestion(
        ...
        IPUSHCommInterface(0xb3971BCef2D791bc4027BbfedFb47319A4AAaaAa).sendNotification(
            0x7b3Cb0dbCC799262Ed7A17D71A419d962536645A, address(this), // to recipient, put address(this) in case you want Broadcast or Subset.
            bytes(
                string(
                // We are passing identity here: https://docs.epns.io/developers/developer-guides/sending-notifications/advanced/notification-payload-types/identity/payload-identity-implementations
                    abi.encodePacked(
                        questionHash, // this is notification identity: https://docs.epns.io/developers/developer-guides/sending-notifications/advanced/notification-payload-types/identity/payload-identity-implementations
                        "+", // segregator
