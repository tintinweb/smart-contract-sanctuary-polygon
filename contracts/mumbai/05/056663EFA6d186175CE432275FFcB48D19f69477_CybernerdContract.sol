...
abstract contract Feeable is Teams {
  uint256 public PRICE = 322 ether;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 19, 12000) { }
...
// File: contracts/CybernerdContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CybernerdContract is RamppERC721A {
    constructor() RamppERC721A("cybernerd", "cn"){}
}
