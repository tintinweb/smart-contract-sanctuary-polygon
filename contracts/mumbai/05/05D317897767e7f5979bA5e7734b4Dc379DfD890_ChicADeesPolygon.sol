...
/**
* The @uth0rzd contract was deployed by Ownerfy Inc
*
...
contract ChicADeesPolygon is Context, Ownable, ERC1155Burnable {
  ...
  string public constant name = 'Chic-A-Dees Polygon';
  string public constant symbol = 'Chic-A-Dees';
  address public constant creatorAddress = 0x6c474099ad6d9Af49201a38b9842111d4ACd10BC;
  string public baseTokenURI;
  bool public placeHolder = false;
  uint256 public MAX_ELEMENTS = 100000;
  ...
  event UpdateRoyalty(address indexed _address, uint256 _bps);
    ...
    function setMaxElements(uint256 _max) public onlyOwner {
        MAX_ELEMENTS = _max;
    }
