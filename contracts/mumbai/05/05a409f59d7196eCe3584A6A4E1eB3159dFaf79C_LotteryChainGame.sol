...
contract LotteryChainGame is Ownable {
    ...
    address lotteryChainAddress = 0x314177F7B25711E068Bc24c544b14C0Bf39E69d3;
    ...
    function getLotterySettings() public view returns(uint256 [9] memory){
        ...
        uint256 [9] memory settings = [
            priceToEnter, 
            tokensToEnter,
            participantsAddresses.length,
            startAt,
            amount * percentageToWinners / 100,
            tokensToClaim,
            decimalsTokensToClaim,
            numberOfWinners,
            partecipate
            ];
