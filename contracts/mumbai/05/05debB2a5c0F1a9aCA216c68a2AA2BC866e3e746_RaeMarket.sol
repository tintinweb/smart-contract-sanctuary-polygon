...
contract RaeMarket {
    ...
    struct Loan {
        ...
        uint256 requestID;
        // is loan returned or expiry date passed and NFT has been claimed?
        bool status;
    }
    ...
    function createLoan(
        ...
        Loan memory newLoan = Loan(
            ...
            block.timestamp + currentRequest.desiredCompletionTime * 1 days,
            _requestID,
            false
        );
