    ...
    */
    ...
    function joinGame() public payable {
        ...
        require(players.length < maxPlayers, 
            string(abi.encodePacked("The maximum number of players have been reached! | maxPlayers=",maxPlayers)));
        require(msg.value >= entryFee, 
            string(abi.encodePacked("The amount you try to join is smaller then the entry fee! | entryFee=",entryFee)));
