...
contract ChainwhizCore is ReentrancyGuard {
    ...
    event VoterUnstaked(string solutionLink, address voter, string voterGithudId);
    ...
    function initiateEscrow(
        ...
        question.choosenSolution.isTransferred = false;
        ...
        onlyActiveContract
    {
        ...
        require(
            question.questionStatus == QuestionStatus.Escrow &&
                ...
                !question.choosenSolution.isTransferred,
            "TRANSFER_REWARD_B"
        );
        // update the state
        question.choosenSolution.escrowStatus = EscrowStatus.Complete;
        question.choosenSolution.isTransferred = true;
