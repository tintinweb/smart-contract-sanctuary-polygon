...
contract Institution is Initializable, PausableUpgradeable, AccessControlUpgradeable {
    ...
    mapping(uint256 => mapping(uint256 => address)) public studentsIndexToAddress;
    ...
    nonZero(student) {
        ...
        studentsIndexToAddress[courseId][studentCounter.current()] = student;
    ...
    function getCourseCounter() view public returns(uint256) {
        return courseCounter.current();
    }
