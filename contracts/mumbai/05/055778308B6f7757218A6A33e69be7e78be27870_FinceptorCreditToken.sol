...
contract FinceptorCreditToken is ERC20, ERC20Burnable, AccessControl {
    bytes32 public constant PROJECT_SALE_ROLE = keccak256("PROJECT_SALE_ROLE");

    constructor() ERC20("FinceptorCreditToken", "FCT") {
    ...
    function _beforeTokenTransfer(
        ...
        address to,
        uint256 amount
    ) internal override onlyRole(PROJECT_SALE_ROLE) {
