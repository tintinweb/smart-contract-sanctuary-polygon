...
contract MetaFarm721 is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    */
     ...
     */
    function addBlacklistAddresses(address _addess) public onlyManager {
        require(
            blacklistAddresses[_addess] == false,
            "MetaFarm: invalid address"
        );
     ...
     */
    function removeBlacklistAddresses(address _addess) public onlyManager {
        blacklistAddresses[_addess] = false;
    }
