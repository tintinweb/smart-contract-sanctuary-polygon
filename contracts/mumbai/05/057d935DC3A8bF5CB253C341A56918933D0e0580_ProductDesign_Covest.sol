...
contract ProductDesign_Covest is Initializable, UUPSUpgradeable, ReentrancyGuardUpgradeable {
	...
	function withdraw(
		...
		require(isProductDesign(msg.sender) == true, "You aren't a ProductDesign");
		require(_ERC20.balanceOf(address(this)) >= _value, "Balance of Contract Not Enough.");
	 ...
	 */
	function balanceOfProductDesign(address _user, address _asset) public view returns (uint256) {
