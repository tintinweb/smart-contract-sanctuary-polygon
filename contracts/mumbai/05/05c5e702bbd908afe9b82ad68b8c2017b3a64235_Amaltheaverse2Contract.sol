...
//                            _ _   _                                        
//      /\                   | | | | |                                       
//     /  \   _ __ ___   __ _| | |_| |__   ___  __ ___   _____ _ __ ___  ___ 
//    / /\ \ | '_ ` _ \ / _` | | __| '_ \ / _ \/ _` \ \ / / _ \ '__/ __|/ _ \
//   / ____ \| | | | | | (_| | | |_| | | |  __/ (_| |\ V /  __/ |  \__ \  __/
//  /_/    \_\_| |_| |_|\__,_|_|\__|_| |_|\___|\__,_| \_/ \___|_|  |___/\___|
//                                                                           
//                                                                           
//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xeCf8B3F897815EAfA820740C5A08E4Ff212127ec];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "https://ipfs.io/ipfs/QmRAmTacLgDFLQzDDDCkdNxdPZxWaBdKnRk3BcuLVBFYUz/";
...
// File: contracts/Amaltheaverse2Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Amaltheaverse2Contract is RamppERC721A {
    constructor() RamppERC721A("Amaltheaverse2", "AMTV2"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/5gqy7TorouneQtyUoOIh/contract-metadata";
    }
}
