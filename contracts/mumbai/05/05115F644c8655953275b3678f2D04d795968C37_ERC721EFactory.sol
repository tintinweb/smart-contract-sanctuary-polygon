...
interface IERC721AMarketplace {
    ...
    event NewOffer(address buyer, uint256 tokenId, uint256 offerId);
...
interface IERC721E {
    ...
    event NewEntry(uint256 pos, string name, uint256 price, uint256 maxSupply);
    event MintTickets(address buyer, uint256 entryType, uint256 amount);
...
interface IERC721FactoryWide {
    ...
    event EventDeployed(address venue, address _event, uint256 blockNumber);
    event EventRemoved(address venue, address _event);
...
interface IReservForwarder {
    ...
    event NewFactory(uint256 factoriesCount, address factory);
    event DeprecateFactory(address factory, bool deprecate);
    event Deployment(address venue, address factory, address deployed);
    event Removed(address venue, address factory, address _event);
