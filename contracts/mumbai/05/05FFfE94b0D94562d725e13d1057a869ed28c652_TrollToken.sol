...
contract TrollToken is Initializable, ERC721TradeableUpgradeable {
    ...
    function mint(uint256 collectionId, address to) external {
        ...
        require(
            _mintAmount[collectionId][msg.sender] < _mintLimit[collectionId],
     ...
     */
    function setMintLimit(uint256 collectionId, uint256 amount)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        _mintLimit[collectionId] = amount;
    }
     ...
     * @param collectionId id of the collection
     */
    function getMintLimit(uint256 collectionId)
        external
        view
        returns (uint256)
    {
        return _mintLimit[collectionId];
    }
