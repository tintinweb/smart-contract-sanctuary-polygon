...
// File: RestaurantReliefBuilderV03.sol

/**
 * @title Restaurant Relief Builder
 * @dev builds the dynamic content of the Restaurant Relief NFTs
 */
contract RestaurantReliefBuilderV03 is AbstractDynamicURI, BaseViciContract {
    using EnumerableSet for EnumerableSet.AddressSet;
    ...
    function _initDefaults() internal {
        ...
        noNomElement.nomAskLinkText = "https://restaurant-relief.io/nominate";
        noNomElement.nomAskSuffix = "";
        noNomElement.nomAskLine2 = "to nominate a restaurant";
