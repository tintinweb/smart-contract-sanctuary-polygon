...
contract StaxGlpInvestment is StaxInvestment, ReentrancyGuard {
    ...
    /// @notice The ETH (Arbitrum) or AVAX (Avalanche) native token which can be used for buying and selling the stax receipt token
    ...
    ) StaxInvestment(_stxGlpToken, _staxStaking, _staxTokenPrices) {
