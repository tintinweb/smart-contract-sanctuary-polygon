...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x87e382F2b500a44bC21B1685A2D771d68f3cF774];
...
abstract contract Feeable is Ownable {
  uint256 public PRICE = 300 ether;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiehpi432ccy4f3txi7lnlk5d2gavc5wtn47jwaz2hedftlhnfgppq/";
...
// File: contracts/WalrusHavenContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WalrusHavenContract is RamppERC721A {
    constructor() RamppERC721A("Walrus Haven", "WH"){}
}
