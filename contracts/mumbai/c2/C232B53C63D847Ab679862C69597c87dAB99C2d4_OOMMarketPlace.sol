...
abstract contract OOMContractBase is Ownable, ReentrancyGuard, IERC721Receiver {
    ...
    function _placeBid(
        ...
        _depositToken(_fromAddress, price);
     ...
     */
    function _depositToken(address _fromAddress, uint256 _amount) internal virtual;
...
contract OOMMarketPlace is OOMContractBase {
    ...
    function placeBid(address _fromAddress, bytes32 listingId)
        external
        payable
        nonReentrant
        onlyOwner
    ...
    function buyNowGL(address _fromAddress, bytes32 listingId)
        external
        payable
        nonReentrant
        onlyOwner
    ...
    function _depositToken(address _fromAddress, uint256 _amount)
        internal
        override
    {
