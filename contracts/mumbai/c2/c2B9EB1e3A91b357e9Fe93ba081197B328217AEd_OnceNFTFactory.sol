...
contract OnceNFTFactory {
    // owner address => nft list
    mapping(address => address[]) private nfts;

    mapping(address => bool) private _isOnceNFT;
    ...
    function createNFTCollection(
        ...
        OnceNFT nft = new OnceNFT(
            _name,
            _symbol );
        nfts[msg.sender].push(address(nft));
        _isOnceNFT[address(nft)] = true;
    ...
    function isOnceNFT(address _nft) external view returns (bool) {
        return _isOnceNFT[_nft];
    }
}