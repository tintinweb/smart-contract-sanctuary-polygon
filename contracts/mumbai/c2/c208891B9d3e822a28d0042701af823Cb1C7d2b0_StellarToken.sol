...
library TickMath {
    ...
    function convertInt24ToUint256(int24 value) internal pure returns (uint256) {
        int256 convertedValue = int256(value);
        int256 shiftedValue = convertedValue + (1 << 23);
        uint256 result = uint256(shiftedValue);
        return result;
    }
    ...
    function getSqrtRatioAtTick(int24 tick) internal pure returns (uint160 sqrtPriceX96) {
        ...
        require(absTick <= convertInt24ToUint256(MAX_TICK), 'T');
