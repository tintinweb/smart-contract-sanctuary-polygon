...
contract Locker is Ownable {
    ...
    // VARIABLES
    uint256 public maticfee = 100;
    uint256 public maticsubfee = 10;
    ...
    function lockTokens(
        ...
        require( msg.value >= maticfee, 'Matic fee not provided');
    ...
    function lockTokenMultiple(
        ...
        require( msg.value >= requiredFee, 'Matic fee Not provided');
        totalmaticfees = totalmaticfees.add(msg.value);
        remainingmaticfees = remainingmaticfees.add(msg.value);
