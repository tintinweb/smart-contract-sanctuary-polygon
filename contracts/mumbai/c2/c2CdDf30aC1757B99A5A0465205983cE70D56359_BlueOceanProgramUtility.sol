...
contract BlueOceanProgramUtility is IUtilityToken, ERC1155, Ownable, Base {
    ...
    function mint(
        ...
        uint256 id,
        uint256 amount
    ) external checkExpectedCaller(msg.sender, minter) {
        _mint(to, id, amount, "");
    }
    ...
    function setMinter(address acc) external onlyOwner {
