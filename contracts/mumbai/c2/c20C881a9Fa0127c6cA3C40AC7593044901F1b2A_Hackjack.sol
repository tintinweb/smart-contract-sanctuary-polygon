...
contract Hackjack is ERC721URIStorage {
    ...
    mapping(uint8 => uint8) public cardValues; // Card to Card Value
    mapping(uint256 => address) public handOwner; // Hand Owner
    Hand[] public hands;
    ...
    constructor(uint64 subscriptionId) ERC721("Hackjack ", "HJACK") {
    ...
    function executeProposal(uint proposalId) private {
        (bool success, ) = proposals[proposalId].recipient.call{
    ...
    function vote(uint proposalId) public {
        ...
        require(
            proposals[proposalId].sessionId == session,
