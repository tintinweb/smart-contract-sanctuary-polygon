...
import "@wraith-works/contracts/token/ERC721/AirDropERC721.sol";
import "@wraith-works/contracts/token/ERC721/MintableERC721.sol";
import "@wraith-works/contracts/token/ERC721/RevealableERC721.sol";

contract ExampleMintableERC721 is MintableERC721, AirDropERC721, RevealableERC721 {
    constructor()
        BaseERC721("Example", "EXAMPLE", "https://example.com", 3333)
        RevealableERC721("https://prereveal.example.com")
    {
        addMintStage(0, 1, 1, 0x0); // Mint Stage 0 - WL
        addMintStage(15000000000000000000, 1, 1, 0x0); // Mint Stage 1 - AL
        addMintStage(25000000000000000000, 3, 1, 0x0); // Mint Stage 2 - Public
    }
}