...
contract Helper is Ownable2Step, EIP712 {
    ...
    constructor() Ownable2Step() EIP712(_DOMAIN_NAME, _DOMAIN_VERSION) {}

    function _verifySignature(
        FundraiseData memory fundraiseData,
        bytes memory signature
    ) external view onlyOwner returns (address recoveredAddress) {
