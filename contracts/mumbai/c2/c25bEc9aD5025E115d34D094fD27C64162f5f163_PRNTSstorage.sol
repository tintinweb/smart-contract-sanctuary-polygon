...
contract PRNTSstorage {
    ...
    ///@notice Storage Arrays
    Artist[] artists;
    Publication[] publications;
    Fan[] fans;
    Revenue[] revenues;

    ///@notice admin whitelist mapping
    ...
    modifier onlyAdmins{
        require(adminWhitelist[msg.sender] == true, "Address not an admin address!");
        _;
    }
    /**
     ********************************************
    ...
    /**
    * @notice - Add an address to Admin whitelist
    * @param _adminAddress - New address to whitelist
    */
    function addAddressToAdminWhitelist(
        address _adminAddress
    ) public onlyAdmins {
        ///@dev - Add address to the whitelist
        adminWhitelist[_adminAddress] = true;
    }

    /**
    * @notice - Remove an address from Admin whitelist
    * @param _address - Address to remove
    */
    function removeAddressFromAdminWhitelist(
        address _address
    ) external onlyAdmins {
    ...
    function isAdmin(address _address) public view returns (bool) {
        return adminWhitelist[_address];
    }
}
