...
contract DPSDocks is ERC721Holder, ERC1155Holder, ReentrancyGuard, Ownable {
    ...
    function computeVoyageState(
        ...
        unchecked {
            ...
            // console.log("claimingRewardsCache.navigation ", claimingRewardsCache.navigation);
            // console.log("claimingRewardsCache.navigation ", claimingRewardsCache.navigation);
            // console.log("claimingRewardsCache.strength ", claimingRewardsCache.strength);
            ...
            // console.log("after claimingRewardsCache.luck ", claimingRewardsCache.luck);
            // console.log("after claimingRewardsCache.navigation ", claimingRewardsCache.navigation);
            // console.log("after claimingRewardsCache.strength ", claimingRewardsCache.strength);
    ...
    function awardRewards(
        ...
        unchecked {
            ...
            for (uint256 i; i < 9; i++) {
                ...
                } else supportShip.safeTransferFrom(address(this), _owner, i, _lockedVoyage.supportShips[i], "");
            }
