...
contract LostChainGameDataV8 is CustomERC2771ContextUpgradeable, UUPSUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function checkAdventuring(address user) public view returns (bool) {
