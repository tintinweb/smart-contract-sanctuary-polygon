...
contract Lottery is Ownable {
    ...
    function distributeTokens(address _tokenAddress, uint256 _amount, address[] memory _participants, uint256[] memory _prizePercentages) public returns (Winner[] memory) {
        ...
        Winner[] memory winners = new Winner[](_prizePercentages.length);
        ...
        for (uint256 i = 0; i < _prizePercentages.length; i++) {
            ...
            winners[i] = Winner(prizeAmount, winner, i + 1);
