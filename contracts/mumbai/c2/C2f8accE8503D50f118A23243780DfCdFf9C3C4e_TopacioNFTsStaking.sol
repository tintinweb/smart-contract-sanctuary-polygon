 ...
 * Deploy address: 0xc2133D7f29e8E2543ecB5B732b07Fe058C26778E
 */
...
contract TopacioNFTsStaking is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable {
    ...
    // address, tokenId, currentSupply
    event NftBurnned(address, uint, uint);
    ...
    constructor() ERC721("Topacio NFTs Collection", "TOPACIONFT") {
    ...
    function burnNFT(uint256 tokenId) public {
        ...
        supply --;
        tokenContract.register(supply);
        emit NftBurnned(msg.sender, tokenId, supply);
    }
