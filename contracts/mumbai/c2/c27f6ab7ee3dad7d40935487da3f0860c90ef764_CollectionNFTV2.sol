...
contract CollectionNFTV2 is Initializable {
    AuctionStructure.inforCollection public inforCollection;
    ...
    function initialize(address _stanNFT) public initializer {
        owner = msg.sender;
    ...
    function setInforCollection(
        ...
        AuctionStructure.inforCollection
            memory InforCollection = AuctionStructure.inforCollection(
                _ratioCreatorVal,
    ...
    function _processCreatingCollection(
        ...
        _collectionNFT[_collectionId].maxNumber = inforCollection
            .maxColletionNumber;
        _collectionNFT[_collectionId].ratioCreatorVal = inforCollection
            .ratioCreatorVal;
        _collectionNFT[_collectionId].ratioCreatorDenomination = inforCollection
            .ratioCreatorDenomination;
        _collectionNFT[_collectionId].ratioStanVal = inforCollection
            .ratioStanVal;
        _collectionNFT[_collectionId].ratioStanDenomination = inforCollection
