 ...
 * @notice This contract handles minting test drop tokens.
 */
contract TestDrop is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x4afc04FBc7aB5365377EAcDE07adE53448E3B76E;
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeidofcvp76gsaxxtptz7p7hqhxhgggxvmdjshwhsodjxpw4ok5pu54/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenPublicPrice[1] = 0.0002 ether;
        tokenPublicMintsPerAddress[1] = 8;
        require(
