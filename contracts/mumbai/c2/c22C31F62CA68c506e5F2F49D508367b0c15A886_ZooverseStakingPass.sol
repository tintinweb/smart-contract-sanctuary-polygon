...
contract ZooverseStakingPass is
    Initializable,
    OwnableUpgradeable,
    ERC721Upgradeable,
    ERC721HolderUpgradeable
{
    ...
    function stake(uint256[] calldata tokenIds_) external {
        for (uint256 i = 0; i < tokenIds_.length; i++) {
            ...
            _zooverse.safeTransferFrom(msg.sender, address(this), tokenId);
    ...
    function withdraw(uint256[] calldata tokenIds_) external {
        for (uint256 i = 0; i < tokenIds_.length; i++) {
            ...
            _zooverse.safeTransferFrom(address(this), msg.sender, tokenId);
    ...
    function setZooverse(address zooverseAddress_) public {
        _zooverse = ERC721Upgradeable(zooverseAddress_);
    }
