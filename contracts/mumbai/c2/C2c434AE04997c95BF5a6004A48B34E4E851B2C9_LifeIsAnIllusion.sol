...
//      />
//     </
// ERC1155 on-chain NFTs with royalties
...
contract LifeIsAnIllusion is ERC1155, IERC2981, Ownable, ContextMixin {
    ...
    function uri(uint256 tokenId) public view override returns (string memory) {
        ...
        return string(abi.encodePacked(pieces[tokenId].image));
    }
    ...
    function contractURI() public pure returns (string memory) {
        bytes memory dataURI = abi.encodePacked(
            unicode"{",
            unicode'"name": "Life is an illusion"',
            unicode'"symbol": "ILLUSION"',
            unicode'"description": "Жизнь - это илююзия"',
            unicode'"authors": "Ateev Kirill, Anne Leonovich"',
            unicode"}"
        );
