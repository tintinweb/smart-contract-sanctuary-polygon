...
contract BinarySilkLtd is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("BinarySilkLtd", "BLKLTD") {
  ...
  // return abi.encodePacked(msg.value);
  //}
