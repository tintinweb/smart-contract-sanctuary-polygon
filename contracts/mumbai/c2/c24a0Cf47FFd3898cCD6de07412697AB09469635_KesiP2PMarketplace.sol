...
contract KesiP2PMarketplace {
    ...
    function makeOffer(
        ...
        require(_offeredReturnAmount > currentLoan.desiredReturnAmount, "offeredReturnAmount should be more than desiredReturnAmount");
    ...
    function withdrawOffer(
        ...
        require(currentOffer.lender == msg.sender, "Unauthorized");
        require(currentLoan.acceptedOfferID != currentOffer.id, "Offer has been accepted");

        payable(msg.sender).transfer(currentLoan.amount);

        offers[_offerID].isWithdrawn = true;
    }
