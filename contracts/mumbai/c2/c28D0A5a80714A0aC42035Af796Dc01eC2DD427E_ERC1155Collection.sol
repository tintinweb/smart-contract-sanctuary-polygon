...
contract ERC1155Collection is AccessControl, ERC1155, ReentrancyGuard, Ownable {
  string private contractUri;
  bytes32 public immutable OPERATOR_ROLE;

  mapping(uint256 => string) private tokenUris;

  constructor(string memory _uri, string memory _contractUri) ERC1155(_uri) {
  ...
  function burnNFT(
    ...
    require(balanceOf(from, id) >= amount, 'Insufficient tokens');
