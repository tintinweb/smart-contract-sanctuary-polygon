 ...
 * @notice This contract handles minting For the new people tokens.
 */
contract ForTheNewPeople is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x7b7F4d788CCD48AA8C21a105a3BD8e26797d6cbe;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xb3313e8aC37088974A78af20E359676879DA60E4;
    address[] public payoutAddresses = [
        0xb3313e8aC37088974A78af20E359676879DA60E4
    ];
    ...
    string public name = "For the new people";
    string public symbol = "FTNP";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeigtg5i7l3uopck4aymw7ujyh6dex66d35ykkkwb4r4gaixibu3be4/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenPresaleMaxSupply[1] = 3;
        tokenPresalePrice[1] = 0 ether;
        tokenPresaleMintsPerAddress[1] = 3;
        tokenMaxSupply[2] = 10000;
        tokenPublicPrice[2] = 0 ether;
        tokenPublicMintsPerAddress[2] = 10000;
        require(
