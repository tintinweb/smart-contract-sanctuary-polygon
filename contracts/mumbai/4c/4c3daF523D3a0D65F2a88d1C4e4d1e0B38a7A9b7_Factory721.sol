...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new LFMUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        LFMUser721Token token = LFMUser721Token(address(addr));
