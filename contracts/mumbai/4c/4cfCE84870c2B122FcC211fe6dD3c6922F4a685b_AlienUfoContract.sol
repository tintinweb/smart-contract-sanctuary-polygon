...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1687129200;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x6e940C64dDd7cA4065ECBCB8FaC6bB21106C7e46];
  address public erc20Payable = 0x6e940C64dDd7cA4065ECBCB8FaC6bB21106C7e46;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiatulms7uefxmm5a4jguiybcvapmrnw5shacqivl4binho3fobycu/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/ezFWzDRNaYUIeZQ3eV06/contract-metadata";
  }
...
// File: contracts/AlienUfoContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AlienUfoContract is ERC721APlus {
    constructor() ERC721APlus("Alien UFO", "UFO"){}
}
