...
// Cotract deployed to: 0xF44dcD2273436C84b64F084635891F8f54aDaa61
...
contract ChainBattles is ERC721URIStorage {
    ...
    function generateCharacter(uint256 tokenId) public view returns(string memory){
        bytes memory svg = abi.encodePacked(
            ...
            '<text x="50%" y="60%" class="base" dominant-baseline="middle" text-anchor="middle">', "Defense: ",getDefense(tokenId),'</text>',
            '</svg>'
        );
        return string(
            abi.encodePacked(
    ...
    function getDefense(uint256 tokenId) public view returns(string memory){
        uint256 defense = tokenIdtoStats[tokenId].defense;
    ...
    function mint() public {
        ...
        tokenIdtoStats[newItemId].hp = 100;
    ...
    function train(uint256 tokenId) public {
        ...
        tokenIdtoStats[tokenId].hp = tokenIdtoStats[tokenId].hp + random(10);
        tokenIdtoStats[tokenId].strength = tokenIdtoStats[tokenId].strength + random(10);
        tokenIdtoStats[tokenId].defense = tokenIdtoStats[tokenId].defense + random(10);
