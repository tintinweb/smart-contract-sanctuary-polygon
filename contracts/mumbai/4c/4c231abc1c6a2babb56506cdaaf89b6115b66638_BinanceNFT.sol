...
contract BinanceNFT is ERC721Pausable, Ownable {
    ...
    constructor() public ERC721("Rare NFTs", "GOLD") {
    ...
    function mint(address player) external onlyMinter returns (uint256) {
        require(totalSupply() < _maxTotalSupply, "BinanceNFT: total supply is error");
