...
contract AccessPass is ERC1155, Ownable, Pausable {
    ...
    mapping(uint256 => uint256) public expiringTimeStamp;
    ...
    constructor() ERC1155("https://game.example/api/item/{id}.json") {
        ...
        pricesUSD[0] = 499 * 10**16; // 4.99 x 10^18 ($4.99)
    ...
    function withdraw() public onlyOwner {
        ...
        payable(founderOne).transfer(address(this).balance.mul(4).div(10));
        payable(founderTwo).transfer(address(this).balance.mul(4).div(10));
        payable(dev).transfer(address(this).balance.mul(2).div(10));
    }
}
