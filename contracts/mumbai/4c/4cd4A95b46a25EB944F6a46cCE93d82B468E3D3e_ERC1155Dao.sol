...
contract ERC1155Dao is IERC1155Dao, Ownable, Pausable, Auction {
    ...
    mapping(uint256 tokenId => mapping(uint256 serialNo => uint256 auctionTime)) _auctionTime;
    ...
    function listForAuction(
        ...
        _auctionTime[tokenId][serialNo] = block.timestamp;
    ...
    function claimTokenFromAuction(
        ...
        _auctionTime[tokenId][serialNo] = 0;
    ...
    function getAuctionTime(uint256 tokenId, uint256 serialNo) external view returns (uint256) {
        return  _auctionTime[tokenId][serialNo];
    }
}
