...
contract StepsHunter is ChainlinkClient, ConfirmedOwner, AutomationCompatibleInterface {
    ...
    function createGoal(
        ...
        bool isTransferred = i_link.transferFrom(address(msg.sender), address(this), goal.betAmount);
    ...
    function addGoalDayRecord(
        ...
        if (goal.failDaysCount >= goal.maxFailDaysCount) {
            ...
            bool isTransferred = i_link.transfer(address(msg.sender), goal.betAmount);
