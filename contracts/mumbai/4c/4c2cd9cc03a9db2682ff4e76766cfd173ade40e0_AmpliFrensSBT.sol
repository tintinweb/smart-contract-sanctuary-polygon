...
import "./libraries/AmpliFrensStatus.sol";
    ...
    IERC4671Enumerable
{
    ...
    function getStatus(address _address) external view returns (string memory) {
        ...
        return AmpliFrensStatus.getStatus(_tokensForAddress[_address].length);
    }
...
/// @notice Handles the different contributions status and their threshold
library AmpliFrensStatus {
    ...
    function getStatus(uint256 totalTokens)
        external
        pure
        returns (string memory)
    {
