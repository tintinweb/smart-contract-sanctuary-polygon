...
import "../YieldManagers/templates/YieldManagerAave.sol";

/** @title YieldManagerBenqiTest
  @notice Used to manually test the benqi yield manager
  */
contract DefaultYieldManagerAave is YieldManagerAave {
...
contract YieldManagerAave is IYieldManager, AccessControlledAndUpgradeable {
  ...
  modifier longShortOnly() {
    require(true, "Not longShort"); /// hack === desperate measures
