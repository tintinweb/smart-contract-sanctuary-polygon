...
contract ZNSRegistry is ERC721URIStorage, Ownable {
    ...
    constructor() payable ERC721("ZNS Connect Name Service", "ZNS") {}
    ...
    function registerDomain(string calldata name) public payable {
        if (forwardLookUp[name] != address(0)) revert AlreadyRegistered();
        uint256 _price = priceToMint(name);
    ...
    function priceToMint(string calldata name) internal view returns (uint256) {
    ...
    function changePriceToMint(
        uint256 priceForLenght1,
        uint256 priceForLenght2,
        uint256 priceForLenght3,
        uint256 priceForLenght4,
        uint256 priceForLenght5To15
    ) external onlyOwner {
        priceToMintDomain[0] = priceForLenght1; // 13*10**18 = 13 ZETA
        priceToMintDomain[1] = priceForLenght2; // 5*10**18 = 5 ZETA
        priceToMintDomain[2] = priceForLenght3; // 7*10**17 = 0.7 ZETA
        priceToMintDomain[3] = priceForLenght4; // 3*10**17 = 0.3 ZETA
        priceToMintDomain[4] = priceForLenght5To15; // 1*10**17 = 0.1 ZETA
    }
}