...
contract BlackBunny is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxMintAmountPerTx = 27;

  bool public paused = true;
  bool public revealed = false;

  constructor() ERC721("Black Bunny ", " BB") {
    setHiddenMetadataUri("ipfs://QmdEjXpeDqvDscYMaQHT1vW26ifpdhnUr4ASwdu1UXwifi/hidden.json");
  }
