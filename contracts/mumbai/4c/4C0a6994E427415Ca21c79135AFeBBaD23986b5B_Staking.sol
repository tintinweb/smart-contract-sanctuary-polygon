...
contract Staking is ReentrancyGuard{
   ...
   struct StakedNft {
    ...
    IERC721 public immutable claimContractAddress;
    ...
    constructor(IERC20 _token,IERC721  _claim) {
        tokenAddress = _token;
        claimContractAddress = _claim;
    }
    ...
    function stake(uint256 _tokenId) external nonReentrant{
        ...
        require(
            claimContractAddress.ownerOf(_tokenId) == msg.sender,
            "You don't own this token!"
        );
        //transfer nft to this contract

        claimContractAddress.transferFrom(msg.sender,address(this),_tokenId);
    ...
    function withdraw(uint256 _tokenId) external nonReentrant{
        ...
        claimContractAddress.transferFrom(address(this),msg.sender,_tokenId);
