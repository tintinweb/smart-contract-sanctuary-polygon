...
contract BSG {
    ...
    uint256 private constant minDeposit = 50 ether;
    ...
    uint256[4] private level4Percents = [100, 300, 200, 200];
    ...
    uint256 private constant doubleDiamondPoolPercents = 50;
    ...
    function _reOrderTop(uint256 _dayNow) private {
        for(uint256 i = 3; i>1; i--){
            ...
            // address topUser3 = dayTopUsers[_dayNow][i - 3];
            // address topUser4 = dayTopUsers[_dayNow][i - 4];
            // address topUser5 = dayTopUsers[_dayNow][i - 5];
            // address topUser6 = dayTopUsers[_dayNow][i - 6];
            // address topUser7 = dayTopUsers[_dayNow][i - 7];
            // address topUser8 = dayTopUsers[_dayNow][i - 8];
            // address topUser9 = dayTopUsers[_dayNow][i - 9];

            uint256 amount1 = userLayer1DayDeposit[_dayNow][topUser1];
            uint256 amount2 = userLayer1DayDeposit[_dayNow][topUser2];
            // uint256 amount3 = userLayer1DayDeposit[_dayNow][topUser3];
            // uint256 amount4 = userLayer1DayDeposit[_dayNow][topUser4];
            // uint256 amount5 = userLayer1DayDeposit[_dayNow][topUser5];
            // uint256 amount6 = userLayer1DayDeposit[_dayNow][topUser6];
            // uint256 amount7 = userLayer1DayDeposit[_dayNow][topUser7];
            // uint256 amount8 = userLayer1DayDeposit[_dayNow][topUser8];
            // uint256 amount9 = userLayer1DayDeposit[_dayNow][topUser9];
    ...
    function _calLevelNow(address _user) public view returns(uint256) {
        ...
        if(total >= 1000 ether){
            ...
            if(total >= 2000 ether && user.teamNum >= 200 && maxTeam >= 50000 ether && otherTeam >= 50000 ether){
                levelNow = 5;
            }else if(user.teamNum >= 50 && maxTeam >= 10000 ether && otherTeam >= 10000 ether){
                levelNow = 4;
            }else{
                levelNow = 3;
            }
        }else if(total >= 500 ether){
            levelNow = 2;
        }else if(total >= 50 ether){
            levelNow = 1;
        }
    ...
    function _distributeTopPool(uint256 _dayNow) private {
        ...
        // uint32[3] memory maxReward = [2000 ether, 1000 ether, 500 ether];
        uint72[3] memory maxReward = [2000 ether, 1000 ether, 500 ether];
    ...
    function _distributeDeposit(uint256 _amount) private {
        ...
        uint256 star = _amount.mul(diamondPoolPercents).div(baseDivider);
        starPool = starPool.add(star);
        uint256 top = _amount.mul(doubleDiamondPoolPercents).div(baseDivider);
