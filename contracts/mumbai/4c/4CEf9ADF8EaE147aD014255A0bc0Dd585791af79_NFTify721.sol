...
// File: contracts/experiments/collections/ERC721PermitV1.sol
...
abstract contract ERC721Permit is IERC721PermitV1, ERC721Enumerable {
    ...
    {
        return
            interfaceId == type(IERC721PermitV1).interfaceId ||
            super.supportsInterface(interfaceId);
    }
}
...
contract NFTify721 is Ownable, Pausable, ERC721Permit {
