...
contract MyNFT is Ownable, ReentrancyGuard, IERC721, IERC165, IERC721Metadata, IERC721Enumerable {
    using SafeMath for uint256;
    using EnumerableSet for EnumerableSet.UintSet;

    string internal _name = "MyNFT";
    string internal _symbol = "MNFT";
    ...
    // marketer comission
    uint256 private constant _marketerComission = 20;
    address payable private constant _marketer = payable(0x57581eB26540048538188ea673C8dC913623Ef63);
    ...
    function mint(uint256 amount) external payable nonReentrant mintingEnabled {
        ...
        require((totalMinted + amount) <= MINTING_LIMIT, "exceedsMaxSupply");
        ...
        uint256 marketerComission = nftPrice * _marketerComission / 100;
        (bool sent, ) = _marketer.call{ value: marketerComission }("");
        require(sent, "marketerComission");
    ...
    function _mint(address _to) internal notZeroAddress(_to) returns (uint256 _mintedTokenId) {
        require(totalMinted < MINTING_LIMIT, "allMinted");
