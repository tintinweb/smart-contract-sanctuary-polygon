...
contract Metagate is ERC721 {
  ...
  function encode(
    ...
    return abi.encodePacked(tokenId, ',', type_, ',', class);
  }
  ...
  function kesack(
    ...
    return ECDSA.toEthSignedMessageHash(hashed).recover(signature);
  }
  ...
  function mint(
    ...
    bytes memory hashed = abi.encodePacked(tokenId, ',', type_, ',', class);
