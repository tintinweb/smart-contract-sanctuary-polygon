    ...
    Recoverable
{
    ...
    constructor(  ) { 
        uint256 _currentMonth = 1674135025;
        _env = Environment.Development;
        _network = Network.Polygon;

        _transferOwnership(0xE41ec3ffB61C911024d94Aa09600e86FD97461e8);
        ...
        _ayraToken = IERC20(0x0000000000000000000000000000000000000000);
        _ithdToken = IERC20(0x0000000000000000000000000000000000000000);

        _setNFTContracts(0x109DeC8F717dcc85450E6D621EaeedB25Eb2967b, 0x1BAc7c290d685ed1E6bc651e85FFE0476ebFb453);
