...
contract Futur is ERC721URIStorage, PullPayment, Ownable {
    ...
    function getTokenUri(uint256 tokenId) public returns (string memory) {
      bytes memory dataURI = abi.encodePacked(
          '{'
            '"description" : "Web3, NFTs is our future !",',
            '"external_url" : "https://twitter.com/augustin_br",',
            '"image" : "ipfs://QmZC9i7jq1bK3C8vDK58JYeeSnfYaZwDjoaAnH11VYGV66",',
            '"name" : "Futur #', tokenId.toString(), '",',
          '}'
      );
      return string(
          abi.encodePacked(
