...
contract BatchNFT is Ownable, ERC721Enumerable, BatchReveal {
    ...
    function tokenURI(uint256 id) public view override returns (string memory) {
     ...
     require(numberNFT+numberOfTokens<=3,"Maximum amount of Nft-s per account is 3");
...
abstract contract BatchReveal {
    uint constant public TOKEN_LIMIT = 14;
    uint constant public REVEAL_BATCH_SIZE = 2;
    mapping(uint => uint) public batchToSeed;
    uint public lastTokenRevealed = 1;
