    ...
    
{
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/XGwHqCXPOYFCxzILoxvo/contract-metadata";
  }
...
// File: contracts/MpTestDrop02ByGreenChairContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MpTestDrop02ByGreenChairContract is ERC721APlus {
    constructor() ERC721APlus("MP Test Drop 02 By GreenChair ", "GCTDROP2"){}
}
