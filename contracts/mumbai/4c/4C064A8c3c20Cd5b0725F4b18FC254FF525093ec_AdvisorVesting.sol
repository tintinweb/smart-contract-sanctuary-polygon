...
contract NWTVestingHub is Ownable, ReentrancyGuard, Pausable {
    ...
    IERC20 public token = IERC20(0x14D921Fc5163F83C62622b64C64eC56cdBA639A3);
    ...
    function claimTokensForMultipleAccounts(
    ...
    function claim(
        ...
        if (elapsedTime >= duration == false) {
            require(
                block.timestamp >=
                    buyers[benificery].lastClaimTime.add(claimCooldown),
...
contract AdvisorVesting is NWTVestingHub {
    ...
    uint256 private START_DATE = block.timestamp;
    uint256 private DURATION = 15 minutes;
    uint256 private INITIAL_REALEASE_PERCENTAGE = 50;
    uint256 private CLAIM_COOL_DOWN = 1 minutes;
    uint256 private VESTING_CLIFF = 5 minutes;
