...
contract TestFull2 is ERC721A, Ownable, ReentrancyGuard, IERC2981 {
	...
	string private _baseTokenURI = "https://metadata.tokenfy-staging.aegas.it/94/metadata/";
	string private _contractURI = "https://tokenfy-staging-public.s3.us-east-2.amazonaws.com/94/contract-uri";
    ...
    // royalties
    uint256 public royaltyBps = 1300;
	...
	constructor(address _signerAddress) ERC721A("Test Full 2", "TEST") {
