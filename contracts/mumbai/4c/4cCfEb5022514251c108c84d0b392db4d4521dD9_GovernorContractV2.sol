...
contract GovernorContractV2 is Governor, GovernorSettings, GovernorCountingSimple, GovernorVotes, GovernorVotesQuorumFraction {
    ...
    uint256 public balanceLimit = 10000000000000000000;
    constructor(IVotes _token, address _govTokenAddress)
        Governor("GovernorContract")
        GovernorSettings(1 /* 1 block */, 273 /* 1 week */, 0)
        GovernorVotes(_token)
        GovernorVotesQuorumFraction(4)
    {
        _tokenAddress = _govTokenAddress;
    }
    ...
    function castVote(uint256 proposalId, uint8 support) public virtual override returns (uint256) {
        require(IERC20(_tokenAddress).balanceOf(_msgSender())>0,'Must have more than 10 tokens to participate');
    ...
    function updateBalanceLimit(uint256 newLimit) public {
