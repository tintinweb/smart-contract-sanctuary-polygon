...
contract MetaForceBoost {
    ...
    BEP20 public dai = BEP20(0xd982Fc4711eb22dF8274201a822cC34428DfBCBe); 
    struct Player {
        address referrer;
    ...
    function _setb30(uint256 poolNo,address _addr,uint256 _amount) private{
        ...
        //3rd upline
        address up3 = players[b30[poolNo][_parent]].b30_upline[poolNo];
        ...
        //4th upline
        address up4 = players[up2].b30_upline[poolNo];
