...
abstract contract Ownable is Context {
     ...
     */
    constructor() {
        _transferOwnership(0x4d4188686a22fe1593Cc660110fE93EE9EbadDD9);
    }
...
contract Lumos is ERC721A, Ownable {
    uint256 max_mints = 1;
    uint256 max_supply = 1440;
    uint256 public price = 0.09 ether;
    bool public onlyWhitelisted = true;
    bool public paused = true;

    string public baseURI = "ipfs://QmTDZcfZxZEDniuPddCatvyN9UvhfELsA7kkx6NDB9L5su/";
    ...
    constructor(bytes32 _root) ERC721A("Lumos", "L") {
        root = _root;
    }
