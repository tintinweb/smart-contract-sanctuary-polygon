...
contract LZXProviderMock is IXProviderMock, ILayerZeroReceiver {
    ...
    function xSend(
        ...
        // bytes4 selector = bytes4(keccak256("xReceive(uint256)"));    test
        // bytes memory callData = abi.encodeWithSelector(selector, _value);   test
        bytes memory callData = abi.encode(_value); // test 
    ...
    function lzReceive(uint16 _srcChainId, bytes calldata _srcAddress, uint64 _nonce, bytes calldata _payload) external {
        ...
        value = abi.decode(_payload, (uint256)); // test
        // (bool success,) = address(this).call(_payload); test
        // require(success, "LZXProviderMock: lzReceive: No success"); test
    }
