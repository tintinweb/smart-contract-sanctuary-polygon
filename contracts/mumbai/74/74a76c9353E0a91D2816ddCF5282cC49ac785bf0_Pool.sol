...
contract Pool is Initializable, BasicMetaTransaction, Ownable, AccessControl {
    ...
    uint256 public constant TOTAL_TIME = 4 * 31104000; //YEAR IN SECONDS(360 days) 124416000
        ...
        returns (uint256)
    {
        ...
        uint256 amtPerInterval = (reward * temp.disbursementInterval) /
            TOTAL_TIME;
         console.log("stakedTime[_borrower][_loanId]",stakedTime[_borrower][_loanId]);
         console.log("claimabe amount calling time ", block.timestamp);
