...
import './ERC721MintStorage.sol';
import './ERC721Init.sol';

contract ERC721MintImpl is ERC721MintDelegateStorage, ERC721Init, Ownable {
    ...
    function initialize (string memory _name, string memory _symbol, string memory _uri) public onlyOwner {
        uri = _uri;
...
contract ERC721MintDelegatorStorage {
    address public implementation;

    address public pendingImplementation;
}

contract ERC721MintDelegateStorage is ERC721MintDelegatorStorage {
...
contract ERC721Init is Context, ERC165, IERC721, IERC721Metadata {
    using Address for address;
    using Strings for uint256;
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = ERC721Init.ownerOf(tokenId);
        require(to != owner, "ERC721: approval to current owner");
    ...
    function _transfer(
        ...
        require(ERC721Init.ownerOf(tokenId) == from, "ERC721: transfer of token that is not own");
        require(to != address(0), "ERC721: transfer to the zero address");
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        _tokenApprovals[tokenId] = to;
        emit Approval(ERC721Init.ownerOf(tokenId), to, tokenId);
    }
