...
// File: contracts/MNGN.sol

pragma solidity ^0.8.0;


contract MNGN is ERC20PresetMinterPauser, Ownable {
    ...
    function mint(address to, uint256 amount) public virtual onlyOwner override whenNotPaused {
        _mint(to, amount);
    }
