...
//  ________                      __                                                                        __     
// |        \                    |  \                                                                      |  \    
//  \$$$$$$$$______    _______  _| $$_           ______    ______    ______       __   ______    _______  _| $$_   
//    | $$  /      \  /       \|   $$ \         /      \  /      \  /      \     |  \ /      \  /       \|   $$ \  
//    | $$ |  $$$$$$\|  $$$$$$$ \$$$$$$        |  $$$$$$\|  $$$$$$\|  $$$$$$\     \$$|  $$$$$$\|  $$$$$$$ \$$$$$$  
//    | $$ | $$    $$ \$$    \   | $$ __       | $$  | $$| $$   \$$| $$  | $$    |  \| $$    $$| $$        | $$ __ 
//    | $$ | $$$$$$$$ _\$$$$$$\  | $$|  \      | $$__/ $$| $$      | $$__/ $$    | $$| $$$$$$$$| $$_____   | $$|  \
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x8aA0F3F5F519a7A9FeDb79bc8aDe020a8Efed3E6];
  address public erc20Payable = 0x8aA0F3F5F519a7A9FeDb79bc8aDe020a8Efed3E6;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 16384) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeidu4wdlzh36xxkksxpzxj7pngsbjf7houllgwvqcgj5wpwqx2jcna/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 16384");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 16384");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 16384");
...
contract MyTestProjectContract is RamppERC721A {
    constructor() RamppERC721A("My Test Project", "TESTP"){}
}
