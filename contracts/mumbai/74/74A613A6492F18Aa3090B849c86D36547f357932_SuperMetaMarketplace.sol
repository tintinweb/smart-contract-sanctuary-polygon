...
contract SuperMetaMarketplace is OwnableUpgradeable, ERC1155Upgradeable, RevokableDefaultOperatorFiltererUpgradeable {
    ...
    function setProfitRatios (uint256 _artistCut, uint256 _superMetaCut, uint256 _oxytocinCut) external onlyOwner {
        artistProfitPercentage = _artistCut;
        superMetaProfitPercentage = _superMetaCut;
        oxytocinProfitPercentage = _oxytocinCut;
    }

    function setAddresses (address _superMetaAddress, address _oxytocinAddress) external onlyOwner {
        superMetaAddress = _superMetaAddress;
    ...
    function whitelistTokenId (uint256 _tokenId, uint256 _priceOfToken, uint256 _tokenLimit) external onlyOwner {
    ...
    function mint(address _account, address _artistAddress, uint256 _id, uint256 _amount) external payable {
        ...
        distributeETH(msg.value, _artistAddress);
