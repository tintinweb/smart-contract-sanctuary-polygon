  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x52f67902E201E8d64a7431cD86710bA9cc7DcEa3);
    ...
    // File: contracts/punkContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract PunkContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("punk", "punk", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "https://ipfs.io/ipfs/Qma3sC19HbnWHqeLgcsQnR7Kvgus4oPQirXNH7QYBeACaq/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/UWIHqh6BxFCTgagRZteO/contract-metadata";
        }
    }