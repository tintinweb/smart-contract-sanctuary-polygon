...
contract LostWorldValidatorV14 is CustomERC2771ContextUpgradeable, UUPSUpgradeable {
    ...
    event TEST(uint8, uint256, string);
    ...
    function validateRarity(
        ...
        emit TEST(maxRewardWeight, totalRewardWeight, highestRarity);
