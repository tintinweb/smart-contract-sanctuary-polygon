...
import "./dummy Address List.sol";
import "@openzeppelin/contracts/token/ERC1155/extensions/ERC1155Supply.sol";
import "@openzeppelin/contracts/access/Ownable.sol";
import "./ERC2981/ERC2981ContractWideRoyalties.sol";


contract TestSettlersTickets2 is ERC1155Supply, _anotherAddressList, Ownable, ERC2981ContractWideRoyalties {

    //useless variable, just exists to change the bytecode
    uint distinguisher2 = 1;
    uint distinguisher3 = 1;
    ...
    string _contractUri = "https://z5dnhikb7avlimtulum54ogkpsxhtc7m7gbg5dr6zmeuiyseqjza.arweave.net/z0bToUH4KrQydF0Z3jjKfK55i-z5gm6OPssJRGJEgnI";

    constructor() ERC1155(
    // solhint-disable-next-line max-line-length
        "https://7i2he2uedg4k3due5xcfuular3h7vmvgafjuljk2exfhjn6tosja.arweave.net/-jRyaoQZuK2OhO3EWlFgjs_6sqYBU0WlWiXKdLfTdJI"
    ) {
