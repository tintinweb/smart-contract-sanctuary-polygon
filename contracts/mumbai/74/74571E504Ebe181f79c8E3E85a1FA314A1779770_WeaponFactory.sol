  ...
  // MANAGING Authorization Contract Address for Call 
   ...
   // 合约部署者增加操作员
        ...
        // onlyAuthorizationContract // TODO 上线后需要打开 只允许主合约调用
    {
        ...
        uint margin = weapons[_type_id].prop_sum - (props["attack"] +props["duration"] + props["defense"] + props["hp"]);
        props[weapons[_type_id].margin_name] = weapons[_type_id].prop_sum - margin;
