...
contract MBMXToken is ERC20Upgradeable, OwnableUpgradeable, PausableUpgradeable {
    ...
    */
     ...
     * @param from sender address
    */
    function getUserSendedTransfers(address from) public view returns (transactionInfo[] memory) {
        return safeTransfer.getUserSendedTransfers(from);
    }
    ...
    */
    function revertTransfer(address to, uint256 amount, bytes32 msgHash) public {
        safeTransfer.revertTransfer(to, msg.sender, amount, msgHash);
    }
}
