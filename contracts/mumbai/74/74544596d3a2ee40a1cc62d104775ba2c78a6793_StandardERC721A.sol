                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                ...
                                uint2str(tokenId),
                                '", "description": "Fin Del Primer Acto is a digital work composed by Jean Carlos Ayala (jeanayala.eth).',
                                ' As the owner of this NFT, you are an essential part of this tune. To enjoy the final mastered version, please make sure you have the minimum number of tokens and you have redeemed them. Thank you for your support and for appreciating the art, enjoy this unique musical experience we have created together!",',
                                '"attributes": "",',
                                '"image":"',
                                baseVideoURI,
                                '", "animation_url":"',
