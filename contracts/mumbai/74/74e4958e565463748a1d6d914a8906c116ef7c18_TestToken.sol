...
contract TestToken is Ownable, IERC20, IERC20Metadata {
   ...
   receive() external payable { } 
    ...
    modifier onlyOwner () override {
        require(owner() == _msgSender() || isMinter(msg.sender), "Ownable: caller is not the owner or the Minter");
        _;
    }
    
    /*
     @dev function to isMinter token
    ...
    */
    ...
    /*
     @dev function to addMinter token
     @param account address
    */
    ...
    /*
     @dev function to renounceMinter token
    */
    ...
    /*
     @dev function to _addMinter token
     @param account address
    */
    ...
    /*
     @dev function to _removeMinter token
     @param account address
    */
 ...
 */
abstract contract ERC1363 is TestToken, IERC1363, ERC165 {
