...
contract Feb623 is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
  ...
  uint256 public PRESALE_TX_LIMIT = 4;
  uint256 public PUBLIC_TX_LIMIT = 6;

    
  uint256 public PRESALE_WALLET_LIMIT = 4;
  ...
  uint256 public PUBLIC_COUNT = 0;
    ...
    string private preRevealURI = "https://ipfs.w3bmint.xyz/ipfs/Qmc61aksFSWbk44pSR9bm9iqL8Li8aV5cVEfpr4xAvutUf/pre-reveal";

    mapping(address => uint256) addressBlockBought;

    address public constant RL_ADDRESS = 0xc9b5553910bA47719e0202fF9F617B8BE06b3A09; 

    constructor() ERC721A("Feb623", "READINESSTEST") {
