...
//
//    ___              ____      ___           
//   / _ \___  ___ _  / __/___  / _ )___  __ __
//  / // / _ \/ _ `/  > _/_ _/ / _  / _ \/ // /
...
// File: contracts/DogBoyContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract DogBoyContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/ozDIVa7TbyM4Hb1htBix/contract-metadata";
  }
