...
contract PepeTakeover is ERC721A, DefaultOperatorFilterer, Ownable {
    uint256 public MAX_SUPPLY = 10000;
    uint256 public MINT_PRICE = 0.005 ether;
    uint256 public MAX_PER_WALLET = 8;
    uint256 public FREE_MINT = 5000;
    ...
    constructor() ERC721A("Pepe Takeover", "FEPE") {}
    ...
    function mint(uint256 _amount) external payable {
        ...
        uint256 value;
        if (nftMinted[msg.sender] == 0 && FREE_MINT > 0) {
            value = _amount * MINT_PRICE;
            value - MINT_PRICE;
            FREE_MINT--;
        }else{
            value = _amount * MINT_PRICE;
    ...
    function setFreeMintQuantity(uint256 _quantity) external onlyOwner {
        FREE_MINT = _quantity;
    }
