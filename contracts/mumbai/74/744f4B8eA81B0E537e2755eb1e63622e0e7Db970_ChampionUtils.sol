...
contract ChampionUtils is Base, IChampionUtils {
  ...
  function disperseRewards(
    ...
    IZooKeeper(zooKeeper).transferERC20Out(_rewardToken, address(this), _reward);
    IERC20(_rewardToken).approve(rentalAddress, _reward);
    try
    ...
    {} catch {
      IERC20(_rewardToken).transfer(_joiner, _reward);
    }
  }
