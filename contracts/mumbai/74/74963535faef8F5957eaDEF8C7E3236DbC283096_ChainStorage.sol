...
contract ChainStorage is ERC721URIStorage {
...
function getTokenURI(uint256 tokenId) public view returns (string memory){
    bytes memory dataURI = abi.encodePacked(
        '{',
            ...
            '"description": "Battles on polygon chain",',
...
function mint() public {
    ...
    tokenIdToLevels[newItemId].level = random();
    tokenIdToLevels[newItemId].speed = random();
    tokenIdToLevels[newItemId].strength = random();
    tokenIdToLevels[newItemId].life = random();
...
function random() public view returns(uint256){
    ...
    return ((seed - ((seed / 100000) * 100000)) % 100);
}
...
//     }
 ...
 function train(uint256 tokenId) public {
   ...
   tokenIdToLevels[tokenId] = Warrior((currentLevel + 1), 
                (currentLevel + (currentSpeed%4)), 
                (currentLevel + (currentStrength%4)),
                (currentLevel + (currentLife%4)));
    warriors.push(tokenIdToLevels[tokenId]);
