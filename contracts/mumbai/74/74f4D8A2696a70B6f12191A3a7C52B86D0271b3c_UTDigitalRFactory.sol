...
abstract contract UTDigitalRedeemVault is ERC721Holder, BlackHolePreventionForCROwner {
    ...
    function notifyVault(address tokenContractAddress) external {
        ...
        if (communityRegistry.community_admin() != msg.sender && GalaxisRegistry.getRegistryAddress(REGISTRY_KEY_FACTORY) != msg.sender) {
...
contract BlackHolePreventionForCROwner {
    ...
    modifier onlyAllowed() { 
        ...
        if (communityRegistry.community_admin() != msg.sender) {
