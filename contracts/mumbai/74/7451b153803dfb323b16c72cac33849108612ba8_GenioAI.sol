...
contract GenioAI{ 
    ...
    function dischargeDuty(address _upline, address _donor, uint myDNA, uint upline_dna, uint level) internal superGenio {
        ...
        uint lftDNA = traject[upline_dna][0].leftDNA ;
        uint rgtDNA = traject[upline_dna][0].rightDNA;
