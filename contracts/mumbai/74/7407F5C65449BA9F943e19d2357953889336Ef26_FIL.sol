...
contract FIL is Ownable, ERC721A {
    ...
    uint256 public maxPerAddress = 50000;
    // Metadata uris
    ...
    // opensea transfer
    bool canSetApproval = false;
    
    constructor( ) ERC721A("FilmeFilme", "FilmeFilme") { }
    ...
    function setApprovalForAll(address operator, bool approved) public virtual override {
        require(!canSetApproval, "Contract doesn't allow set approval yet");
