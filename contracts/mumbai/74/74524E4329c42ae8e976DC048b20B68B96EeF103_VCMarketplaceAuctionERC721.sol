...
contract VCMarketplaceAuctionERC721 is VCMarketplaceBase {
    ...
    function listAuction(
        ...
        emit ListedAuction(address(artNft), _tokenId, msg.sender, _initialPrice, marketFee, maturity);
    }
    ...
    function bid(uint256 _tokenId, uint256 _amount) public whenNotPaused {
        ...
        emit Bid(msg.sender, address(artNft), _tokenId, _amount);
    }
    ...
    function settle(uint256 _tokenId) public whenNotPaused {
        ...
        if (listing.highestBid != 0) {
            ...
            if (!listing.minted) {
                IArtNftERC721(address(artNft)).mint(_tokenId);
            }
        ...
        emit Settled(listing.highestBidder, listing.seller, address(artNft), _tokenId, listing.highestBid);
    }
