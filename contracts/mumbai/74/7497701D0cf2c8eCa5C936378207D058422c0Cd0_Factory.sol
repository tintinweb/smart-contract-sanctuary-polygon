...
contract NFT is ERC721URIStorage, EIP712, Ownable {
    ...
    // constructor
    constructor(string memory _name, string memory _symbol, address _roleAddress)
        ERC721(_name, _symbol)
        EIP712(SIGNING_DOMAIN, SIGNATURE_VERSION)
    {
        setupRole(DEFAULT_ADMIN_ROLE, _roleAddress);
        grantRole(MINTER_ROLE, _roleAddress);
        grantRole(VALIDATOR_ROLE, _roleAddress);
    }
