...
contract UniswapV2Router02 {
    ...
    {   
        ...
        // console.log("balanceOf pair",pair,token, IERC20(token).balanceOf(pair));
    ...
    function swapExactTokensForTokens(
        ...
        // console.log(IERC20(path[0]).balanceOf(msg.sender), "AAA");
    ...
    function swapExactTokensForETH(
       ...
       // console.log(IERC20(path[0]).balanceOf(msg.sender), IERC20(path[0]).allowance(msg.sender, address(this)), amounts[0]);
        TransferHelper.safeTransferFrom(
            path[0],
            msg.sender,
            UniswapV2Library.pairFor(factory, path[0], path[1]),
