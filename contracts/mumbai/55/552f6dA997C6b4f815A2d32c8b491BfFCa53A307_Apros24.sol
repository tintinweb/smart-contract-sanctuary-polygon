...
pragma solidity 0.8.11;
  ...
  contract Apros24 is ERC20 {
  using SafeMath for uint256;
  uint Royalty = 3;
  address public owner;
  address payable lotteryOne; // = 0xC843B4bB2Ca384899b331694fC43C2a304dAd7DC;
  mapping(address => bool) public offRoyalty;

  constructor() ERC20("Apros24", "APROS24") {
  _mint(msg.sender, 10000* 10 ** 18);
  owner = msg.sender;
  offRoyalty[msg.sender] == true;
}
   function addLottery(address lotteryOne) public {
