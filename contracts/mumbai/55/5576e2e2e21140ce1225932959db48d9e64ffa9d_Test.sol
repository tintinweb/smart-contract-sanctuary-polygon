...
// 0x90a80a33eB2B8770b4f9659F222b6B39A21D2ECa
...
contract Test {
    ...
    function buyLevel(uint8 level) public 
    {
        ...
        emit BuyNewLevel(msg.sender, users[msg.sender].id, level, globalIndex[level][globalCount[level]-1], users[globalIndex[level][globalCount[level]-1]].id);
    }  
