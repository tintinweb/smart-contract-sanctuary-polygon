...
contract MetaExp is DefaultOperatorFilterer, ERC721A, Ownable {
    ...
    function mint(address endUser, string memory uri) public payable {
        ...
        if (walletsOwner[msg.sender] != _contractOwner) {
            split();
        }
    ...
    function split() public payable {
        require(msg.value >= price, "Valor da mintagem diferente do valor definido no contrato");
