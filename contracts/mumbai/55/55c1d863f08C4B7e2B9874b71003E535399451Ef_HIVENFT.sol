...
// File: all-code/hive/hive-link-nft.sol
...
contract HIVENFT is Context, ERC165, IERC1155, IERC1155MetadataURI, VRFConsumerBase {
    ...
    */    
        ...
        override
    {
        ...
        //Reset rewards
		lastClaimedTimestamp[tokenId] = block.timestamp;
		remainingReward[tokenId] = 0;
    ...
    */
    ...
    constructor(address _token, address _charity, address _team, address _reward, address _treasury, address _liquidity) VRFConsumerBase (
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        randomResult = (randomness % 39979) + 21; //Between 21 to 40000
        random = requestId;
    ...
    function setTier(uint256 randomId) internal returns(bool) {
        if(randomId >= 21 && randomId <= 200) tokenTier[randomId] = 1;
	...
	function getItemPrice() internal view returns (uint256) {
		return initialItemPrice + (500000000000000000 * (mintedHives / 8000));
	}
