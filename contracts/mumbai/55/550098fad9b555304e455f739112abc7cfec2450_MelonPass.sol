...
contract MelonPass is BaseERC721AUpgradeable {
    ...
    function initialize() public initializer initializerERC721A {
        __BaseERC721AUpgradeable_init("MelonPass", "MPASS");
    ...
    function ogAllowlistMint(
        ...
        require(msg.value == quantity * settings.ogAllowlistMintPrice, "Wrong price");
    ...
    function generalAllowlistMint(
        ...
        require(msg.value == quantity * settings.generalAllowlistMintPrice, "Wrong price");
    ...
    function publicMint(
        ...
        require(msg.value == quantity * settings.publicMintPrice, "Wrong price");
    ...
    function setEdition(uint256[] calldata ids, Edition edition) external onlyOwner {
        for (uint256 i = 0; i < ids.length; i++) {
            idToEdition[ids[i]] = edition;
        }
    }

    function setSaleSettings(SaleSettings calldata _settings) external onlyOwner {
        ...
        settings.generalAllowlistMintPrice = _settings.generalAllowlistMintPrice;
        ...
        settings.generalAllowlistMaxPerPhase = _settings.generalAllowlistMaxPerPhase;
        settings.ogAllowlistRoot = _settings.ogAllowlistRoot;
    ...
    function validateOgAllowlistMint(
        ...
        require(totalOgMinted + quantity <= settings.ogAllowlistMaxPerPhase, "Max per phase exceeded");
        require(_totalMinted() + quantity <= settings.maxSupply, "Max supply exceeded");
    }
    ...
    function validateGeneralAllowlistMint(
        ...
        require(totalAllowlistMinted + quantity <= settings.generalAllowlistMaxPerPhase, "Max per phase exceeded");
        require(_totalMinted() + quantity <= settings.maxSupply, "Max supply exceeded");
    }
    ...
    function transferFrom(address from, address to, uint256 tokenId)
        public
        payable
        override(BaseERC721AUpgradeable)
    {
