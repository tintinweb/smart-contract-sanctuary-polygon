...
contract OPTGovernor is Governor, GovernorSettings, GovernorCountingSimple, GovernorVotes, GovernorVotesQuorumFraction {
    ...
    modifier onlyRoleOrOpenRole() {
        if(_moderator != address(0)) {
            require(msg.sender == _moderator, "OPTGovernor: caller is not the owner");
        }
    ...
    // The following functions are overrides required by moderator.
        ...
        bytes[] memory calldatas,
        bytes32 descriptionHash
    ) public virtual onlyRoleOrOpenRole returns (uint256) {
    ...
    function renounceModerator() public onlyRoleOrOpenRole {
