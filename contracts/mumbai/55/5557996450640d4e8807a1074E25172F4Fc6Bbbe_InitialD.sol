...
import "@thirdweb-dev/contracts/extension/SignatureMintERC20Upgradeable.sol";

contract InitialD is ERC20, ERC20Burnable, Pausable, Ownable {

    constructor () ERC20("InitialD", "ID"){
