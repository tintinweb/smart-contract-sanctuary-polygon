...
contract MATICFARM {
	...
	constructor(address payable wallet, uint256 startDate)  {
		...
		plans.push(Plan(10, 0)); // 0% per day for 10 days (at the end)
        plans.push(Plan(15, 0)); // 0% per day for 15 days (at the end)
        plans.push(Plan(20, 0)); // 0% per day for 20 days (at the end)
	}
