...
contract FxMintableERC1155ChildTunnel is
    FxBaseChildTunnel,
    Create2,
    ERC1155Holder,
    Ownable
{
    ...
    function deployChildToken(bytes32 _uniqueId, string calldata _uri)
        external
    {
        // deploy new child token using unique id
        address childToken = createClone(
            keccak256(abi.encodePacked(_uniqueId)),
            childTokenTemplate
        ); // child salt, childTokenTemplate
        ...
        require(
            ...
            "FxMintableERC1155ChildTunnel: ALREADY_MAPPED"
        );
        rootToChildToken[rootToken] = childToken;
        emit TokenMapped(rootToken, childToken);

        // initialize child token with all parameters
        FxMintableERC1155(childToken).initialize(
            address(this),
            rootToken,
            _uri,
            msg.sender
    ...
    function _syncDepositBatch(bytes memory syncData) internal {
        ...
        emit FxBatchDepositMintableERC1155(
            rootToken,
            depositor,
            to,
            tokenIds,
    ...
    function _withdraw(
        ...
        emit FxWithdrawMintableERC1155(
            rootToken,
            childToken,
            receiver,
            id,
    ...
    function _withdrawBatch(
        ...
        emit FxBatchWithdrawMintableERC1155(
            rootToken,
            childToken,
            receiver,
            ids,
...
contract FxMintableERC1155 is ERC1155, IFxMintableERC1155 {
    ...
    modifier onlyMinterOrFxManager() {
        require(
            msg.sender == minter || msg.sender == _fxManager,
            "Invalid sender"
        );
        _;
    }
