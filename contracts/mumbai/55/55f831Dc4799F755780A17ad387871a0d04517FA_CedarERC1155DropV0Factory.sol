...
import "./CedarERC1155DropV0.sol";
import "../api/deploy/ICedarDeployer.sol";
import "../SignatureVerifier.sol";

contract CedarERC1155DropV0Factory is Ownable, ICedarDeployerEventsV1, ICedarImplementationVersionedV0 {
    CedarERC1155DropV0 public implementation;
    ...
    constructor() {
        ...
        implementation = new CedarERC1155DropV0();
    ...
    ) external onlyOwner returns (CedarERC1155DropV0 newClone) {
        newClone = CedarERC1155DropV0(Clones.clone(address(implementation)));
...
import "../generated/impl/BaseCedarERC1155DropV0.sol";
...
contract CedarERC1155DropV0 is
    Initializable,
    IThirdwebContract,
    IOwnable,
    IRoyalty,
    ...
    BaseCedarERC1155DropV0
{
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC1155Upgradeable, AccessControlEnumerableUpgradeable, BaseCedarERC1155DropV0)
        returns (bool)
    {
...
interface ICedarDeployerV1 is ICedarDeployerV0 {
...
interface ICedarDeployerV2 is ICedarDeployerV1 {
...
interface ICedarDeployerV3 is ICedarDeployerV2 {
    function deployCedarPaymentSplitterV0(
        address[] memory payees, uint256[] memory shares_
    ) external returns (ICedarPaymentSplitterV0);
...
// Filename: './BaseCedarERC1155DropV0.sol'
...
abstract contract BaseCedarERC1155DropV0 is ICedarERC1155DropV0 {
    function supportedFeatures() override public pure returns (string[] memory features) {
        ...
        features[1] = "IMulticallable.sol:IMulticallableV0";
        features[2] = "ICedarVersioned.sol:ICedarVersionedV0";
        features[3] = "issuance/ICedarSFTIssuance.sol:ICedarSFTIssuanceV0";
    ...
    function supportsInterface(bytes4 interfaceID) virtual override public view returns (bool) {
        return (interfaceID == type(IERC165Upgradeable).interfaceId) || ((interfaceID == type(ICedarFeaturesV0).interfaceId) || ((interfaceID == type(IMulticallableV0).interfaceId) || ((interfaceID == type(ICedarVersionedV0).interfaceId) || ((interfaceID == type(ICedarSFTIssuanceV0).interfaceId) || ((interfaceID == type(ICedarSFTLazyMintV0).interfaceId) || ((interfaceID == type(ICedarUpdateBaseURIV0).interfaceId) || (interfaceID == type(IERC1155V0).interfaceId)))))));
    }
