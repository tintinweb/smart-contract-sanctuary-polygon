...
contract Ssttooppppii is ERC721AntiScamControl, RevokableDefaultOperatorFilterer, ERC2981, AccessControl, Pausable  {
    using Strings for uint256;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x7640248Ea19B09AF3bAf4fd2145dA3cc30e604c2, 1000);
    }
    ...
    /// @dev MINTERによるミント関数
    function minterMint(address _to, uint256 _amount) external whenMintable whenNotPaused onlyRole(MINTER) {
        mintCheck(_amount);
    ...
    function setMintable(bool _state) public onlyRole(ADMIN) {
        mintable = _state;
    }
    ...
    function grantLockerRole(address candidate) external override onlyRole(ADMIN) {
        _grantLockerRole(candidate);
    }

    function revokeLockerRole(address candidate) external override onlyRole(ADMIN) {
    ...
    function supportsInterface(
        bytes4 interfaceId
    ) public view virtual override(AccessControl, ERC721AntiScam, ERC2981) returns (bool) {
