...
contract Rskullz is ERC721Enumerable, Ownable {
    ...
    // Delcaring variable
    uint public constant MAX_SUPPLY = 617; // total amount needs to change as per the requirement
    uint public PRICE = 0.01 ether; //price needs to reset as per the requirement

    string public baseTokenURI;
    
    constructor(string memory baseURI) ERC721("RSkullz", "RSK"){  //Name and Symbol needs to change as per the requirement
        setBaseURI(baseURI);
    }
