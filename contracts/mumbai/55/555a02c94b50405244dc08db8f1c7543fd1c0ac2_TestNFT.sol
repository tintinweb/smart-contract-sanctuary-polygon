...
contract TestNFT is ERC721, ERC721URIStorage, Ownable {
    ...
    constructor(string memory initialContractURI) ERC721("TNFT", "TN"){
        creator = msg.sender;
    ...
    //Edit metadata of a token
    function setTokenURI(string memory newTokenURI, uint256 tokenID) public onlyOwner{
