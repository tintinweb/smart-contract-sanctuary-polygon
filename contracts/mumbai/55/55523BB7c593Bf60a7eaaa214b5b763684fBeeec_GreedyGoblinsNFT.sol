...
contract GreedyGoblinsNFT is ERC721Checkpointable,Ownable,GreedyGoblinsLottery {
...
abstract contract ERC721Enumerable is IERC721Enumerable,ERC721 {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(IERC165,ERC721) returns (bool) {
        return interfaceId == type(IERC721Enumerable).interfaceId || supportsInterface(interfaceId);
    }
