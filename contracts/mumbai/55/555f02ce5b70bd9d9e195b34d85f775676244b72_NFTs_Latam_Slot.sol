    ...
    ITokenERC721
{
        ...
        returns (string memory)
    {
        ...
        //string memory nftcompose = buildNFT(item1, item2, item3);
    ...
    function buildNFT(
        ...
        parts[
            0
        ] = "<svg xmlns='http://www.w3.org/2000/svg' width='250' height='250'> <image x='53' y='88' href= '";
        ...
        string memory svg = string(abi.encode(parts));
    ...
    function getUseState(uint256 _tokenId) public view returns (bool, uint16[] memory) {
        require(_ownerOf(_tokenId) != address(0), "No claimet yet");
        return (useState[_tokenId], prizesRegister[_tokenId]);
    }

    /// @dev
    function claimPrize(uint256 _tokenId)
