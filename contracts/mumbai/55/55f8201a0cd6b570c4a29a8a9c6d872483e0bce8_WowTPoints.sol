...
contract WowTPoints is OwnableUpgradeable, AccessControlUpgradeable {
    ...
    function initialize(
        ...
        require(_pointValues.length == 13, "Invalid number of parameters");
    ...
    function getPointValue(uint256 index) public view returns (uint256) {
        ...
        if (index == 0) {
            return pointValues.levelOnePoints;
        } else if (index == 1) {
            return pointValues.levelTwoPoints;
        } else if (index == 2) {
            return pointValues.activeUserPoints;
        } else if (index == 3) {
            return pointValues.minimumPointsForConvertion;
        } else if (index == 4) {
            return pointValues.postPoints;
        } else if (index == 5) {
            return pointValues.upVotePoints;
        } else if (index == 6) {
            return pointValues.downVotePoints;
        } else if (index == 7) {
            return pointValues.commentPoints;
        } else if (index == 8) {
            return pointValues.adPoints;
        } else if (index == 9) {
            return pointValues.pollPoints;
        } else if (index == 10) {
            return pointValues.sharePoints;
        } else if (index == 11) {
            return pointValues.ratePoints;
        } else if (index == 12) {
            return pointValues.votePoints;
        }
    }
