...
contract DemaLogic {
    ...
    function viewAllShoppersReview() external view returns (string memory hash) {
        return demaStorage.getAllShopperInfo();
    }

    function viewAllProductReview() external view returns (string memory hash) {
        return demaStorage.getAllProductInfo();
    }

    function viewAllSellersReview() external view returns (string memory hash) {
        return demaStorage.getAllSellerInfo();
    }
}