    ...
    Ownable
{
    ...
    uint256 public publicMintAmmount = 5;
    ...
    function mintMany(uint256 ammountMint) public payable {
        require(publicMintAmmount < publicMintCount.current(), "Public Mint Limit Reached");
        uint256 getFreeMint = ammountMint / 2;
        publicMintAmmount.add(ammountMint + getFreeMint);
        _mintLoop(_msgSender(), ammountMint + getFreeMint);
    }
