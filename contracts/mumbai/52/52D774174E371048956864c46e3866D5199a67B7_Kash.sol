...
contract Kash is ERC20, AccessControl, ERC20Burnable, Pausable {
    ...
    constructor(address _operationalAddress, address _marketingAddress, address _lpAddress) ERC20("Kash", "Kash") {
