...
contract Test{
    ...
    function registration(address userAddress, address payable referrerAddress, uint256 id) private{
        ...
        require(msg.value == 1e18, "Minimum 1 Matic!");
        ...
        for(uint8 i=0;i<7;i++)
        {
            ...
            {
                referrerAddress.transfer((msg.value*REFERRAL_PERCENTS[i])/100);
                emit LevelBonus(referrerAddress, msg.sender, (msg.value*REFERRAL_PERCENTS[i])/100, i+1);
