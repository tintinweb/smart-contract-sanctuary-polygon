...
contract ChainBattle is ERC721URIStorage {
    ...
    //-------------------------------------------------------------------------------
    function getRandomNum1() public view returns (uint256) {
    ...
    function getRandomNum() public view returns (uint256) {
        ...
        return randomnum + getRandomNum1();
    }
    ...
    function mint() public {
        ...
        abilities.speed = getRandomNum();
        abilities.strength = getRandomNum();
        abilities.life = life[getRandomNum()];
