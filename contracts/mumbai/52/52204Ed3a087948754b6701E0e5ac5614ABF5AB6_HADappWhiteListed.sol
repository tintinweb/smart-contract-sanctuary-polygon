...
contract HADappWhiteListed is ERC721Enumerable, Ownable {
    ...
    uint public constant MAX_SUPPLY = 1487500;
    uint public constant PRICE = 0.01 ether;
    uint public constant MAX_PER_MINT = 100;

    string public baseTokenURI;

    constructor() ERC721("HADAPP", "HA") {
        //setBaseURI(baseURI);
    }
    ...
    // WhiteListed Presale mints
    function whiteListedpreSale(uint _count) public payable {
        uint totalMinted = _tokenIds.current();
        uint preSalePrice = 0.05 ether;
        uint preSaleMaxMint = 100;
