...
//*********************************************************************//
//
//    ______                        _____            _   ______________   ____        __  __  __         
//   / ____/___ _____  ____  ____ _/ ___/___  ____ _/ | / / ____/_  __/  / __ )____  / /_/ /_/ /__  _____
//  / /   / __ `/ __ \/ __ \/ __ `/\__ \/ _ \/ __ `/  |/ / /_    / /    / __  / __ \/ __/ __/ / _ \/ ___/
// / /___/ /_/ / / / / / / / /_/ /___/ /  __/ /_/ / /|  / __/   / /    / /_/ / /_/ / /_/ /_/ /  __(__  ) 
// \____/\__,_/_/ /_/_/ /_/\__,_//____/\___/\__,_/_/ |_/_/     /_/    /_____/\____/\__/\__/_/\___/____/  
//                                                                                                       
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1687053600;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xAfE5B0813e1725389b5B3e47b44C3E201456cFEc,0x78014Ec7979e6931eD111Ee53589a6f9a60E6715];
  address public erc20Payable = 0xAfE5B0813e1725389b5B3e47b44C3E201456cFEc;
...
abstract contract EarlyMintIncentive is Teams, ERC721A, ProviderFees {
  uint256 public PRICE = 420 ether;
  uint256 public EARLY_MINT_PRICE = 370 ether;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeig54ezj2enwnmirpnhcu6yvagqynj4yfohufktfb7dtiqb75syzu4/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/ekzjGGwJjNh1GKvan7yv/contract-metadata";
  }
...
// File: contracts/CannaSeaNftGreenhousesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CannaSeaNftGreenhousesContract is ERC721APlus {
    constructor() ERC721APlus("CannaSeaNFT Greenhouses", "CSEAG"){}
}
