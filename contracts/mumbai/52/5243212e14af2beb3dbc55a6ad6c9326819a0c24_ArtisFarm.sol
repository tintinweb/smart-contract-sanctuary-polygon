...
contract ArtisFarm is IERC777Recipient {
    ...
    address public artisTokenAddress = 0x8EC776d8Eda7275aa566794D6578eF607C32a02C;
    ...
    */
    function tokensReceived(
        ...
        require(operator == artisTokenAddress, "Caller must be from ARTIS contract... Ya bih.");
        require(from == msg.sender, "Sender must send tokens... Ya bih.");
