...
contract EP {
    ...
    function mint(address dst, uint rawAmount) external {
        ...
        require(amount <= SafeMath.div(SafeMath.mul(totalSupply, mintCap), 100), "ep::mint: exceeded mint cap");
        totalSupply = safe96(SafeMath.add(totalSupply, amount), "ep::mint: totalSupply exceeds 96 bits");
