...
/**
 On Chain Duck Races Brought to you by Quacks QQ quacksqq.io 
*/
...
contract OnChainDuckRace is ERC721A, ReentrancyGuard, Ownable,  DefaultOperatorFilterer , IERC4906 {
    using Strings for uint256;
    ...
    uint256 public maxPurchase = 80;
    uint256 public maxSupply = 52000;
    ...
    constructor() ERC721A("On Chain Duck Race", "QUACKS") {
    }
    ...
    function _buildTokenURI(uint256 id) internal view returns (string memory) {
        ...
        bytes memory image = abi.encodePacked(
            ...
            Base64.encode(
                bytes(
                    abi.encodePacked(
                        '<?xml version="1.0" encoding="UTF-8"?><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 400 400" preserveAspectRatio="xMidYMid meet"><style type="text/css"><![CDATA[text { font-family: monospace; font-size: 9px;} .st0{fill-rule:evenodd;clip-rule:evenodd;} .h1 {font-size: 40px; font-weight: 600;}]]></style><text x="25" y="325"> OnChain Quacks Lvl: ',
