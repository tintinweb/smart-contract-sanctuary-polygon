...
contract KUTHULU is Initializable, PausableUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    */
    ...
    function initialize(IERC20Upgradeable _paymentToken, address _userProfiles, address _kutils, uint256 _costToPost, uint256 _maxMessageLength, uint256 _maxMsgReturnCount, uint256 _cutToPoster, uint256 _maxGroups) initializer public {
    ...
    */
    ...
    function setParams(uint256 _maxMsgReturnCount, uint256 _maxMessageLength, uint256 _maxGroups) public onlyAdmins {
        maxMsgReturnCount = _maxMsgReturnCount;
        maxMessageLength = _maxMessageLength;
        maxGroups = _maxGroups;
    }
