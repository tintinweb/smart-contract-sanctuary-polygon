...
contract mentoraSwap {
    ...
    function MwpToMatic(
        ...
        console.log("amountOut inside contract", amountOut);
        console.log("saldo do contrato antes do withdraw", address(this).balance);
        IWmaticContract(wMaticAddress).withdraw(amountOut);
        console.log("saldo do contrato apos withdraw", address(this).balance);
        msg.sender.transfer(amountOut);
        console.log("saldo do contrato apos transfer p user", address(this).balance);
    }
