...
contract DPSGameSettings is Ownable {
     ...
     */
    uint16 public maxSkillsCap = 900;

    /**
     * @notice max points the causality can generate
     */
    uint16 public maxRollCap = 1000;
    ...
    constructor() {
        ...
        supportShipsSkillBoosts[SUPPORT_SHIP_TYPE.CARAVEL_STRENGTH] = 20;
        supportShipsSkillBoosts[SUPPORT_SHIP_TYPE.CARAVEL_LUCK] = 20;
        supportShipsSkillBoosts[SUPPORT_SHIP_TYPE.CARAVEL_NAVIGATION] = 20;
        ...
        voyageDebuffs[VOYAGE_TYPE.MEDIUM] = 25;
        voyageDebuffs[VOYAGE_TYPE.HARD] = 45;
        voyageDebuffs[VOYAGE_TYPE.LEGENDARY] = 55;
    }
    ...
    function interpretResults(
        ...
        if (_interaction == INTERACTION.CHEST && _result <= _claimingRewardsCache.luck) {
            ...
            if (_lockedVoyage.totalSupportShips - _voyageResult.totalSupportShipsDestroyed > 0) {
                ...
                for (uint8 i; i < supportShipTypesLength; i++) {
                    if (chosenType == i) {
        ...
        uint256 debuffs = voyageDebuffs[_lockedVoyage.voyageType];
