...
import {ERC1400} from "src/consensys_erc1400/ERC1400.sol";

contract SecurityTokenFactory {
    event TokenCreated(address indexed tokenAddr, address indexed creator);
    ...
    function createToken(
        ...
        ERC1400 createdToken = new ERC1400(
            name,
            symbol,
            granularity,
            controllers,
        ...
        createdToken.transferOwnership(msg.sender);
        createdToken.renounceMinter();

        emit TokenCreated(address(createdToken), msg.sender);
    }
}
