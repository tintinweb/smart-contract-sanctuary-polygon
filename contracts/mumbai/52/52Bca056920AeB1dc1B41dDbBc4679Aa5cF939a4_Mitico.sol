...
// File: contracts\Mitico.sol


pragma solidity >=0.8.0 <0.9.0;
pragma experimental ABIEncoderV2;
contract Mitico is ERC721Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
  ...
  function initialize() public initializer {
    ...
    ERC721Upgradeable.__ERC721_init('MITICO', 'MITICO');
    // URL Base to get metadata
    setBaseURI('https://mitico-api.devmitsoftware.com/token?id=');
