  ...
  ReentrancyGuard
{
  ...
  uint256 public constant MAX_SUPPLY = 20; // the total amount of tokens for this NFT
  ...
  function _beforeTokenTransfer(
    ...
    address to,
    uint256 tokenId
  ) internal override(ERC721, ERC721Enumerable, ERC721Pausable, ERC721Freezable, ERC721MintPausable) {
    super._beforeTokenTransfer(from, to, tokenId);
  }
