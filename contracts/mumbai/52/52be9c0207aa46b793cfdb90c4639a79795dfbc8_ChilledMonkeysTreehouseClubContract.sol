...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xA4f79c3cCEf423B98C405a18722B79F65Eb111F5];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmTA3Npsj9pmJKnMqXuXLYxvcakhq6j5Pree6V3AqACP5E/";
...
// File: contracts/ChilledMonkeysTreehouseClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ChilledMonkeysTreehouseClubContract is RamppERC721A {
    constructor() RamppERC721A("Chilled Monkeys Treehouse Club", "CMTC"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/QnRP1coBswyfgEo1LB0s/contract-metadata";
    }
}
