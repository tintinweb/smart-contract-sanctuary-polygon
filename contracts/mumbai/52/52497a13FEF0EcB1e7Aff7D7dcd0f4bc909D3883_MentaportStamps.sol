...
import "./smart-contracts-dev/dynamicStorage/MentaportMint.sol";
...
contract MentaportStamps is MentaportMint {
...
contract MentaportERC721 is ERC721URIStorage, MentaportVerify, Ownable, Pausable, ReentrancyGuard, IMentaportERC721  {
  ...
  */
  modifier mintCompliance(address _receiver) {
    ...
    require(balanceOf(_receiver) + 1 <= maxMintAmount, "Max stamps to mint is three");
