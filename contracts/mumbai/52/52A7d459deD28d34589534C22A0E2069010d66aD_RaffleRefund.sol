...
contract RaffleRefund {
    ...
    /**
     * @dev updates refund MerkleRoot and resets `claimedWord`
     *
     * Requirements:
     *
    ...
    /**
     * @dev User can claim refund for `amount` RaffleTickets 
     * if they provide valid `merkleProof` and `amount` to burn
     *
     * Requirements:
     *
     * - The contract must not be paused.
