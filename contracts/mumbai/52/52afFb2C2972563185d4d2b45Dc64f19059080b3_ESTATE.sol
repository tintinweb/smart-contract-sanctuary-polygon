...
contract ESTATE is ERC721, Ownable, IEstateRegistry {
    ...
    constructor() ERC721("TestEstate", "TSE") {}
     ...
     */
    function mint(address to, string memory metadata) external override onlyOwner returns (uint256) {
