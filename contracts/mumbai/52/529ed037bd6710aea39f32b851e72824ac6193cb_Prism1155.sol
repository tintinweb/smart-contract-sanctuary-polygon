 ...
 */
  ...
  function viewTokenConfig(uint256 _id) public view
    returns (
      string memory name,
      uint256 projectId,
      uint256 collectionId,
      ...
      )
  {
    ...
    projectId = tokens[_id].projectId;
    collectionId = tokens[_id].collectionId;
    tokenPriceInWei = tokens[_id].tokenPriceInWei;
    maxSupply = tokens[_id].maxSupply;
    paused = tokens[_id].paused;
    locked = tokens[_id].locked;
  }
 ...
 */
  ...
  function viewCollectionConfig(uint256 _id)
    public
    view
    returns (
      string memory name,
    ...
    )
  {
    ...
    projectId = collections[_id].projectId;
    maxInvocations = collections[_id].maxInvocations;
    invocations = collections[_id].invocations;
    paused = collections[_id].paused;
    locked = collections[_id].locked;
  }
