...
contract FakeGF is Ownable, ERC721A, ReentrancyGuard {
    using MerkleProof for bytes32[];
    using Strings for uint256;
    using ECDSA for bytes32;

    uint256 public immutable adoptionLimit = 6;
    mapping(uint256=> string) private _tokenURIs;
    bool public saleOpen = false;
    string private baseURI = "https://dabunny.mypinata.cloud/ipfs/QmVS9u92jBPGemUkMPwsoxXKjFeUD9fXhnTe1k1wfRe4ud";
    ...
    function adoptBunny(uint256 _quantity, bytes32[] memory _proof) public payable {
