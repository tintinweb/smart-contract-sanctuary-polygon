...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
   ...
   //string private _tokenURI;
    ...
    function mint(address to,uint256 tokenId,string memory _tokenURI,string memory _mintname,uint256 _timeperiod,string memory _nftowner,uint256 _copies,string memory description
    ) internal 
    {
        _mint(to,tokenId);
...
contract NftMarketplace is ERC721
{
    ...
    {
        tokenId+=1;
        mint(_to,tokenId,_tokenURI,_mintName,_timePeriod,_externalLink,_copies,_description);
        return true;
    }
    ...
    {
        return (salenft,nftprice[tokenid].price);
    }  
