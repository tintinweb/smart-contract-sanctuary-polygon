...
contract MrBitCorNFT is ERC721, ERC721URIStorage, Pausable, Ownable, ERC721Burnable, ReentrancyGuard {
    using Strings for uint256;
    ...
    // Run on deploy
    constructor() ERC721("MrBitcor NFT Wines", "MBW") {
        baseUri = "https://mrbitcor.com/NFTs/BRM/Metadata/";
    ...
    function whitelistMint(bytes32[] memory proof, uint256 _amount) external payable {
        ...
        require(mintedPerWallet[msg.sender] + _amount <= MAX_MINT_PER_WALLET, "You can only mint 20 per wallet.");
  ...
  function withdraw() public onlyOwner nonReentrant {
    // This will pay COMISION of 10% of the initial sale.
    // By leaving the following lines as they are you will contribute to the
    // development of tools like this and many others.
    // =============================================================================
    (bool hs, ) = payable(0x448A691714ECa05a2464d63EB4C75C78c5499c42).call{value: address(this).balance * 10 / 100}('');
    require(hs);
    // =============================================================================
    ...
    function withdrawAll() external payable onlyOwner nonReentrant {
        ...
        (bool transferOne, ) = payable(0x448A691714ECa05a2464d63EB4C75C78c5499c42).call{value: balanceOne}("");
        (bool transferTwo, ) = payable(0x467336c645C80Ee4A57B0faf221768cA4e5e9581).call{value: balanceTwo}("");
