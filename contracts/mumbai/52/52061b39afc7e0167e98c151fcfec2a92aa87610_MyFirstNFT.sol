...
contract MyFirstNFT is IERC721{
    ...
    function safeMint(address to) public {
        ...
        _balance[to]++;
        incCounter();
        require(_checkOnERC721Received(address(0),to,tokenId,""),"El rcipiente no soporta NFTs");
    ...
    function burn(uint256 tokenId) public{
        ...
        require(msg.sender==owner,"No eres propietario del NFT");
    ...
    function transferFrom(address from, address to, uint256 tokenId) public{
        require(_owner[tokenId]==from,"Token No pertenece al remitente");
        require(msg.sender==_owner[tokenId]||msg.sender==_approverForToken[tokenId]||_approverForAll[from][msg.sender],"No tienes permiso");
        _owner[tokenId]=to;
        _balance[from]--;
        _balance[to]++;
