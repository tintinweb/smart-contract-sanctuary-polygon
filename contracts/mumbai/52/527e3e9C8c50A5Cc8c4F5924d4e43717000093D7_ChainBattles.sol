...
contract ChainBattles is ERC721URIStorage {
    ...
    function generateCharacter(uint256 tokenId) public view returns(string memory){
        ...
        bytes memory svg = abi.encodePacked(
            ...
            '<rect width="100%" height="100%" fill="#2C82FF" />',

            '<text x="50%" y="40%" class="character" dominant-baseline="middle" text-anchor="middle">',"Warrior Profile",'</text>',
    ...
    function mint() public {
        ...
        tokenIdToLevels[newItemId].speed = 30 ; 
    ...
    function train(uint256 tokenId) public {
        ...
        tokenIdToLevels[tokenId].life = currentLife + uint(keccak256(abi.encodePacked(block.timestamp,block.difficulty,msg.sender))) % 20;
