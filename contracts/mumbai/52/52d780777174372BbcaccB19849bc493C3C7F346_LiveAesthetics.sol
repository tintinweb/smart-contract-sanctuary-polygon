...
contract LiveAesthetics is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    uint256 MAX_TOKENS = 1000;
    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("Live Aesthetics", "LAES") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://ipfs.io/ipfs/QmTurA78vveXqyrMQaqHiGaGY6aQckCaFf94DRyaCxTUyQ/";
    }
    ...
    function safeMint(uint256 _amount) public onlyOwner {
        // uint256 tokenId = _tokenIdCounter.current();
        require(MAX_TOKENS >= _amount + _tokenIdCounter.current() + 1, "Not enough tokens left to mint.");
