...
contract Contract is ERC721Base {
    ...
    function exchangeForWord(uint256[] memory _tokenIds) public view {
        for(uint256 i=0; i < _tokenIds.length; i++){
            require(keccak256(abi.encodePacked(ownerOf(_tokenIds[i]))) == keccak256(abi.encodePacked(msg.sender)), "You are not the owner.");
