...
contract PaypoolV1ERC20 is NonblockingLzAppUpgradeable, ERC20Upgradeable, PausableUpgradeable, IOFTUpgradeable {
    ...
    */
    function initialize(ILayerZeroEndpoint _lzEndpoint, uint256 _globalSupply, uint256 _localSupply, string memory _tokenName, string memory _ticker) public initializer {
        __PaypoolV1ERC20_init(_lzEndpoint, _globalSupply, _localSupply, _tokenName, _ticker);
    }

    // solhint-disable-next-line func-name-mixedcase
    function __PaypoolV1ERC20_init(ILayerZeroEndpoint _lzEndpoint, uint256 _globalSupply, uint256 _localSupply, string memory _tokenName, string memory _ticker) internal onlyInitializing {
