...
// File: contracts/StandardPool_Polygon/UVPool.sol
...
contract UVStandardPool is ERC20, ERC20Burnable, Ownable, AccessControl {
    ...
    address public stableCoin =
        0xc2132D05D31c914a87C6611C10748AEb04B58e8F; // check

    address public poolReserved;

    uint256 public maxRenewed = 318995000000000000000000; // check
    ...
    uint256 public currentSizePool = 255195931836000000000000; // check
    uint256 public maxSizePool = 357142000000000000000000; // check
    ...
    constructor()
        ERC20(
            string.concat("P - ", Strings.toString(orderNumber)),
            string.concat("P-", Strings.toString(orderNumber))
        )
    {
