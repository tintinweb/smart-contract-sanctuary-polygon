...
contract Spx500 is Context, Ownable {

    using Math for uint256;
    address public OWNER_ADDRESS;
    bool private initialized = false;
    address MATIC = 0xd3C08847815d6B0C3Dd4A7136f08010835b5b42a;
    address public DEV_ADDRESS = 0xa1021B67a359093E72578411309E02b7E8e5E8f7;
    address public MARKETING_ADDRESS = 0xB0eB2AB718e72c395d3CAbD21c239D88897b5d13;
    address public CEO_ADDRESS = 0xc73428E788D325966FE0aF6Ec027b5fc84fa0609;
    address public GIVEAWAY_ADDRESS = 0x032b5DF39aeD1Cc85808a11D0A46928200dF1446;
    ...
    uint256 MIN_DEPOSIT = 10 ether; // 10 MATIC
    uint256 MIN_BAKE = 1 ether; // 1 MATIC
    uint256 MAX_WALLET_TVL_IN_BNB = 100000 ether; // 100000 MATIC
    uint256 MAX_DAILY_REWARDS_IN_BNB = 6500 ether; // 6500 MATIC
    uint256 MIN_REF_DEPOSIT_FOR_BONUS = 150 ether; // 150 MATIC
    ...
    function buyBeans(address ref, uint256 _amount) public {
        ...
        IERC20(MATIC).transferFrom(msg.sender, address(this), _amount);
    ...
    function sendFees(uint256 totalFee, uint256 giveAway) private {
        ...
        IERC20(MATIC).transfer(_dev, dev);
        IERC20(MATIC).transfer(_marketing, marketing);
        IERC20(MATIC).transfer(_ceo, ceo);

        if (giveAway > 0) {
            IERC20(MATIC).transfer(_giveAway, giveAway);
        }
    }
    ...
    function handleBake(bool onlyRebaking) private {
        ...
        if (onlyRebaking == true) {
            require(
                ...
                "Rewards must be equal or higher than 1 MATIC to bake"
            );
        }
    ...
    function eat() public {
        ...
        IERC20(MATIC).transfer(msg.sender, bnbToEat);
    ...
    function contractBalance() public view returns (uint256) {
        return IERC20(MATIC).balanceOf(address(this));
    }
