...
// Cozy Crypto Birds Edition ERC721 

// Calling mint mints a random  CCB until 10,000 have been minted

// cozycryptobirds.com 

contract CozyCryptoBirds is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  // uint256 public requested;
  uint256 public currentSupply = 0;
  
  string public baseURI = "https://ipfs.io/ipfs/QmdQfitWfUdrU6MCcAkb3YoqwUQPdHfc7BTnrh79v1kLGP/";

  constructor() 
    ERC721("Cozy Crypto Birds", "CCB")
