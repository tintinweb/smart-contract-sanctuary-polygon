...
contract EightsGame is Ownable {
    ...
    function joinRoom(string memory _roomId) public payable {
        ...
        require(roomMap[_roomId].roomOwner != msg.sender, "You are already in this game");
        require(roomMap[_roomId].opponent != address(0), "The game is full");
        require(roomMap[_roomId].opponent != msg.sender, "You are already in this game");
