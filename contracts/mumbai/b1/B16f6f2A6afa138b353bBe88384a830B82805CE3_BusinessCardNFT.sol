...
contract BusinessCardNFT is ERC721Enumerable, Ownable {
    ...
    constructor(address _wallet) ERC721("NFT Business Card", "NFBC") {
    ...
    function updateNFTPrice(uint256 _newPrice) public onlyOwner {
        require(msg.sender == wallet, "Only owner can execute this function");
        require(_newPrice > 0, "New Price should be greater than 0");
        mintingFee = _newPrice * contractDecimals;
