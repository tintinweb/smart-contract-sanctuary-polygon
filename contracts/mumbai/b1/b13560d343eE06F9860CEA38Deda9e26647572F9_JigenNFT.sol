...
contract JigenNFT is ERC721Enumerable, Ownable {
    ...
    uint256 public metalockLockPeriod = 5 minutes;
    ...
    function transferFrom(
        ...
        address to,
        uint256 tokenId
    ) public override(ERC721, IERC721) isTransferable(tokenId) {
