...
contract DCTProxy is EternalStorage, ERC1967Proxy {
  /**
  ...
  constructor(
    address owner,
    uint256[] memory ownerIds,
    uint96 _royaltyFeesInBips,
    address _logic,
    bytes memory _data
  ) EternalStorage("DigitalContentsToken", "DCT") ERC1967Proxy(_logic, _data) {
    _setDefaultRoyalty(msg.sender, _royaltyFeesInBips);
    _setOwnerInformation(owner, ownerIds);
    _manager = msg.sender;
  }
