...
contract MLERC721TestToken is Initializable, ERC721Upgradeable, ERC721URIStorageUpgradeable, PausableUpgradeable, AccessControlUpgradeable, ERC721BurnableUpgradeable, EIP712Upgradeable, ERC721VotesUpgradeable {
    ...
    function initialize() initializer public {
        __ERC721_init("ML ERC 721 Test token", "MLNFT1");
        __ERC721URIStorage_init();
        __Pausable_init();
        __AccessControl_init();
        __ERC721Burnable_init();
        __EIP712_init("ML ERC 721 Test token", "1");
        __ERC721Votes_init();
