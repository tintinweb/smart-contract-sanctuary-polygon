...
contract AAPLExchange is AccessControl, ReentrancyGuard {
    ...
    event Buy(address buyer, uint256 ethAmount, uint256 aaplAmount);
    event Sell(address seller, uint256 ethAmount, uint256 aaplAmount);
}
