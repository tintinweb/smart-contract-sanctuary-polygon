 ...
 * @notice This contract handles minting Troll Genesis Adventure tokens.
 */
contract TrollGenesisAdventure is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xb6E8B56c24d50D4ABF99e3699A4d0eFce9E3AaC8;
    ...
    string public name = "Troll Genesis Adventure";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeigkwzyzolbhevhj774ur3loleoo7ihq5sdukip6t2koaxe6asnsm4/{id}"
        )
        RevokableOperatorFilterer(
