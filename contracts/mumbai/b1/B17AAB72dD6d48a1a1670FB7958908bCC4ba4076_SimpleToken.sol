...
/// @title The Simple Token contract.
// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.10;
...
/// @dev `TokenDetailsParams` is for taking the details about the Token.
struct TokenDetailsParams {
...
contract SimpleToken is ERC20Common {
    /**
     * @dev Initializing the ERC20Common contract.
     * @param _feeManagerAddress The address of Fee Manager contract on this network.
     * @param _tokenDetails The struct contains details about the token.
     */
    constructor(
        address _feeManagerAddress,
        TokenDetailsParams memory _tokenDetails
    )
        payable
        ERC20Common(
            ...
            0 /// Token type `0` for SimpleToken.
        )
    {}
}