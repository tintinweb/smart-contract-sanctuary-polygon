...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x6E622048260FC53dfeD463828356bc93a836b6E0,0xE100D53D063AfB290EaA5b7b9b632248d97DcE29,0xB0CC49773388493762aA5eceFbA97916037B9ABF];
  uint256[] public payableFees = [5,31,31,33];
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 500, 12759) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeifqaufaigi7uctifd6twfxzurvfyyhkhjvfae2e54sfmfgaxelcmy/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 12759");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 12759");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 12759");
...
// File: contracts/ColeoPresidenteBolsonaroContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ColeoPresidenteBolsonaroContract is RamppERC721A {
    constructor() RamppERC721A("Coleo Presidente Bolsonaro ", "PB"){}
}
