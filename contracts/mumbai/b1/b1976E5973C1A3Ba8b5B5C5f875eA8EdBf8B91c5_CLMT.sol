...
contract CLMT is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Royalty, AccessControl {
    using Counters for Counters.Counter;
    event minted(uint256 indexed tokenId, string tokenURI, address ownerAddress);
    event uriChange(uint256 indexed tokenId, string tokenURI);
    ...
    constructor() ERC721("Climeta", "CLMT") {
    ...
    function setContractURI(string memory newURI) public onlyRole(MINTER_ROLE)  {
        _contractURI = newURI;
    }
    ...
    function setTreasury (address _treasuryAddress) public onlyRole(MINTER_ROLE)  {
