...
import './Whitelisting.sol';
 ...
 contract TraderTestinggg is ERC721, ERC721Holder, Ownable {
    ...
    function setWhitelistContractAddress(address whitelistContractAddress) public{
    ...
    function mintByUser(uint256 quantity, bytes32[] memory proof) public isPause isHalt payable{
        ...
        if(identifier == 1){
           require (whitelistMethod.VerifyAddressForWhitelisting(msg.sender) == true, "User not whitelisted");
            ...
            require(whitelistMethod.statusOfAddress(msg.sender) == true, 
