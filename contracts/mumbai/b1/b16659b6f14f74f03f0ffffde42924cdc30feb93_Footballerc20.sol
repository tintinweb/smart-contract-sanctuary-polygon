...
contract Footballerc20 is ERC20, Ownable, ERC20Burnable, ERC20Blocklist{
    ...
    constructor() ERC20("Footballerc20", "Footballerc20") {}
    
    modifier checkFrozenBalance(address account, uint256 amount){
        uint256 frozenBalance = frozenBalanceOf(account);
        uint256 balance = balanceOf(account);
        unchecked {
            require( balance - frozenBalance >= amount, "Attention: This wallet balance is frozen");
        }
        _;
    }
