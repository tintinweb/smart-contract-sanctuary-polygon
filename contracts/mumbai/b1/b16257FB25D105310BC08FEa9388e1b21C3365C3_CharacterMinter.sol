...
contract CharacterMinter is Ownable, Pausable{
    ...
    function requestCharacter(uint32 _character_class) public payable whenNotPaused{
    ...
    */
    function requestCharacterExperimental(uint32 _character_class) public payable whenNotPaused{
