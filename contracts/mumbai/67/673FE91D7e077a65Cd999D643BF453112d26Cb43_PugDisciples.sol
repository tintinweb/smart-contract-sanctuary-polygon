...
contract PugDisciples is ERC721Enumerable, PaymentSplitter, Ownable, ReentrancyGuard {
    ...
    uint public pricePresale = 0 ether;
    //Price of one NFT in sale
    uint public priceSale = 5 ether;
    ...
    address[] private _team = [
        0x9005dE63efE5A67c7b09233208Ba4E91D7aBF0b2
    ];
    ...
    constructor(string memory _theBaseURI, string memory _notRevealedURI, bytes32 _merkleRoot) ERC721("PUG DISCIPLES", "PUG") PaymentSplitter(_team, _teamShares) {
