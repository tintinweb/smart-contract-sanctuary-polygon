...
contract VRFv2Consumer is VRFConsumerBaseV2,Ownable {
   ...
   function requestRandomWords(string memory _uri,uint8[2] memory coords) external {
     if(!posOccupied[coords[0]][coords[1]]){
       ...
       requestPosition[s_requestId] = coords;
     }
   }
   ...
   function fulfillRandomWords(
     ...
     emit Result(_uri,randomWords[0],result,coords[0],coords[1]);
   }
