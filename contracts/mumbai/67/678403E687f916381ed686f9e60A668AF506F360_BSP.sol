    ...
    */
    ...
    private onlyOwner
    {
        ...
        {   
            ...
            uint256 _relativePart = relativePart(_fromReleased, _fromBalance, amount);
            // Relative part removed from 'from'
            // sender_dividends_counter = relative part * left amount
            _dividendReleased[from] = _relativePart*_fromBalance;
        }
        ...
        {   
            ...
            // receiver_dividends_counter = relative part * sent amount
            _dividendReleased[to] = _dividendReleased[to]+((_relativePart)*amount); 
        }
    }

    function relativePart (uint256 _fromReleased, uint256 _fromBalance, uint256 _amountTransfered)
    private
    returns(uint256)
    {
        uint256 _relativePart = _fromReleased/(_amountTransfered+_fromBalance);
        return _relativePart;
    }
