...
//        _currentIndex = _startTokenId();
    ...
    /// @dev Returns whether token metadata base URI can be set in the given execution context.
    ...
    /// @dev Returns whether platform fee can be set in the given execution context.
