...
contract TokenAccess is Ownable, AccessControl {
    ...
    modifier onlyGameUser(uint256 worldId, uint256 tokenId) {
        bool isInternal = checkAccess(msg.sender, _gameAccess.getInterfaceAddresses(worldId));
        bool isGameOwner = checkAccess(msg.sender, _gameAccess.getWorldOwnerAddresses(worldId));
        ...
        require(isInternal || isGameOwner || isOwner || isTokenOwner || isGame, "TokenAccess: caller is not GameUser");
        _;
    }
}
