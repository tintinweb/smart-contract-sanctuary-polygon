...
contract NFTSwap is ERC165, ReentrancyGuard, Pausable, AccessControl {
    ...
    /**
     * @notice  checks if the address is an invalid address
     * @param   _address  address to check
     * @return  bool returns if the address is invalid
     */
    function isInvalidAddress(address _address) internal view returns (bool) {
        ...
        /**
     * @notice  checks if the percentage is in BIPS format and valid
     * @param   percentage  percentage to check in BIPS format
     * @return  bool  returns true if the percentage is valid
     */
    function isValidPecentage(uint16 percentage) internal pure returns (bool) {
        ...
        /**
     * @notice  checks if the token is blacklisted
     * @param   _token  token address to check
     * @return  bool  returns true if the token is blacklisted
     */
