...
contract MyNft is ERC721, Ownable, ERC2981 {
    ...
    address[] public withdrawAddresses = [0xb7550c71410F3C692c144509F6C19c256Ad72219];
    uint256[] public withdrawPercentages = [100];


    bytes32 public merkleRoot = 0;

    constructor() ERC721("pol", "pol") {
        _baseTokenURI = "https://test-nft-tool-gateway-api.tuoluo.net/generator-server/api/contract/v1/1602279587438718977/metadata/";
        _setDefaultRoyalty(0xb7550c71410F3C692c144509F6C19c256Ad72219, uint96(0));
    }
