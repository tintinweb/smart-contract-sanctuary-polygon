...
contract NewNairaToken {
    ...
    function transfer(address recipient, uint256 amount) public whenNotPaused returns (bool) {
        ...
        require(block.timestamp > _lastActionTimestamp[msg.sender], "Front-running protection");
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public whenNotPaused returns (bool) {
        ...
        require(block.timestamp > _lastActionTimestamp[sender], "Front-running protection");
        ...
        _lastActionTimestamp[sender] = block.timestamp;
        return true;
    }
    ...
    function mint(address account, uint256 amount) external onlyOwner whenNotPaused {
        ...
        require(block.timestamp > _lastActionTimestamp[account], "Front-running protection");

        _totalSupply += amount;
        _balances[account] += amount;

        emit Transfer(address(0), account, amount);
        _lastActionTimestamp[account] = block.timestamp;
    }
