...
contract SkrtStaking is Ownable {
    ...
    mapping(uint256 => uint256) public stakeTimeline;
    ...
    **/
    ...
    returns (bool) {
        ...
        stakeTimeline[block.timestamp] = totalStakedTokens;
    ...
    /**
     * @dev set wallet address balance
     **/ 
    function setStakingBalance(address _address) 
    whenPaused
    external onlyOwner() 
    returns (bool) {
