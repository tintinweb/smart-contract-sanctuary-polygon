...
contract GoldenStars is ERC20Interface, Owned, SafeMath {
    ...
    function redeemDare() public returns (bool success){
        ...
        require(balances[msg.sender] >= 5, "Insufficient Balance");
    ...
    function redeemPhoto() public returns (bool success){
        ...
        require(balances[msg.sender] >= 10, "Insufficient Balance");
    ...
    function redeemMovie() public returns (bool success){
        ...
        require(balances[msg.sender] >= 15, "Insufficient Balance");
    ...
    function redeemNickname() public returns (bool success){
        ...
        require(balances[msg.sender] >= 20, "Insufficient Balance");
    ...
    function redeemVideo() public returns (bool success){
        ...
        require(balances[msg.sender] >= 40, "Insufficient Balance");
        ...
        require(balances[msg.sender] >= 80, "Insufficient Balance");
    ...
    function SafeMint(uint Tokens) public coulterOnly returns (bool success){
        ...
        emit Transfer(address(0), 0xEf54Ca02be4D7628f11d3638E13CAD6D38f2bD52, Tokens);
        return true;
    }
