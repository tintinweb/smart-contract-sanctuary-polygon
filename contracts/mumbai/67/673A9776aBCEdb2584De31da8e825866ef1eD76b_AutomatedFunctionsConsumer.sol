...
contract AutomatedFunctionsConsumer is FunctionsClient, ConfirmedOwner, AutomationCompatibleInterface {
  ...
  function fulfillRequest(
    ...
    /** @notice returns latest Sportify monthly listeners as uint */
  function latestListeners() public view returns (uint256) {
    uint256 _latestListeners = abi.decode(latestResponse, (uint256));
    return _latestListeners;
}
  /**
