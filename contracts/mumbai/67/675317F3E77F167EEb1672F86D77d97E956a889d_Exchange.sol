 ...
 * ERC20 Transfer : 0x7EFD8beC4A6E928747Fc9bB4c1DEF138F1C4Cfa4, v0
 ...
 * Minimum Exchange Amount : 20000000000000000
 * Exchange Rate : 1000000000000000000
 * The function takes in 0 variables. It can be called by functions both inside and outside of this contract. It does the following :
 * checks that (amount of native currency sent to contract) is greater than or equals to 20000000000000000
 * calls ERC20's transfer function  with variable recipient as the address that called this function, variable amount as amount of native currency sent to contract
 * emits event Exchanged with inputs the address that called this function
*/
	function exchange2To1() public payable {
		require((msg.value >= 20000000000000000), "Too little exchanged");
		ERC20(0x7EFD8beC4A6E928747Fc9bB4c1DEF138F1C4Cfa4).transfer(msg.sender, msg.value);
		emit Exchanged(msg.sender);
	}
