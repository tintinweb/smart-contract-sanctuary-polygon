...
contract Ball is ERC721Tradable {
    ...
    function initialize(
        ...
        _initialize("AFL Ball", "AFB", _proxyRegistryAddress);
...
import {EIPInitializable} from "./Initializable.sol";

contract EIP712Base is EIPInitializable {
    struct EIP712Domain {
        string name;
        string version;
    ...
    function _initializeEIP712(string memory name) internal eipinitializer {
...
contract EIPInitializable {
    bool inited = false;

    modifier eipinitializer() {
