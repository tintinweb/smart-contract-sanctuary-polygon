...
contract polycontract is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("contrato22", "CC") {
    setHiddenMetadataUri("ipfs://QmPRKVGrtMCkHPyvpZGPic4CNNS8DADek6rtRhnqk8aZ1X/hidden.json");
  }
