...
contract YourNftToken is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  string public hiddenMetadataUri;
    ...
    mapping(uint => uint) public availableTokens;
 ...
 function _mintRandom(address to, uint _numToMint) internal virtual {
        ...
        require(numAvailableTokens >= _numToMint, "ERC721r: minting more tokens than available");
    ...
    function _mintAtIndex(address to, uint index) public onlyOwner {
        require(_msgSender() == tx.origin, "Contracts cannot mint");
        require(to != address(0), "ERC721: mint to the zero address");
        require(numAvailableTokens >= 1, "ERC721r: minting more tokens than available");
        
        uint tokenId = getAvailableTokenAtIndex(index, numAvailableTokens);
        --numAvailableTokens;
  ...
  function setNumAvailableTokens(uint256 _numAvailableTokens) public onlyOwner {
    numAvailableTokens =  _numAvailableTokens;
  }
