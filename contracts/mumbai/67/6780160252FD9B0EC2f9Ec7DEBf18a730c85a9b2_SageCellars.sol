...
// File: contracts/sageCellarsMeta.sol
...
contract SageCellars is  Ownable, ERC721A, ReentrancyGuard {
	...
	/// @dev mints tokens during public sale, limited by `MAX_PER_USER`
	/// @param _count number of tokens to mint in transaction
    function mintNFTs(uint _count) external payable callerIsUser {
	...
	/// @dev compare the price and the msg.value
