...
contract FullMain is ERC721A, Ownable, ReentrancyGuard, IERC2981 {
    using ECDSA for bytes32;
	using Strings for uint256;
    using SafeERC20 for IERC20;

	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/832/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/832/contract-uri";
	...
	constructor(address _signerAddress) ERC721A("Full Main", "MAIN") {
