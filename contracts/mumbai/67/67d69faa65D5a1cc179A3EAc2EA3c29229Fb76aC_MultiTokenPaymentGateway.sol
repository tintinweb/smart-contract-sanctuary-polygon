...
library ERC20Utils {
	...
	function tokenTransferFrom(IERC20Upgradeable token, address from, address to, uint256 value) public returns (uint256 finalValue) {
		uint256 balanceBefore = token.balanceOf(to);
		token.safeIncreaseAllowance(to, value);
...
contract MultiTokenPaymentGateway is Initializable {
	...
	mapping(IERC20Upgradeable => uint) public tokens;


	function initialize() public initializer {
		owner = payable(msg.sender);
		tokens[IERC20Upgradeable(0x326C977E6efc84E512bB9C30f76E30c160eD06FB)] = 0;
	}
