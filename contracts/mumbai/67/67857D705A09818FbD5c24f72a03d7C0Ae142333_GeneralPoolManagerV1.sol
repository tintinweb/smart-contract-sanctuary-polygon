...
contract GeneralPairPoolV1 is IGeneralPoolV1, ERC1155Supply {
    ...
    function submitResult(uint8 option) external override onlyPoolManager {
        ...
        resultOpened = true;
        resultOption = option;
        emit SubmitResult(option, totalSupply(option));
    }
    ...
    function buy(
        ...
        collateralReserve = collateralBalance;
        emit Buy(msg.sender, to, option, amount, shares, 0);
    }
    ...
    function sell(
        ...
        TransferHelper.safeTransfer(collateralToken, to, amount);
        collateralReserve = IERC20(collateralToken).balanceOf(address(this));
        emit Sell(msg.sender, to, option, amount, shares, 0);
    }
...
interface IGeneralPoolManagerV1 is IBasePoolManagerV1 {
    ...
    function submitResult(bytes32 poolId, uint8 option) external;
