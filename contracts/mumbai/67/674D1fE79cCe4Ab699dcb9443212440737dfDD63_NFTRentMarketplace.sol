    ...
    IERC721Receiver
{
    ...
    modifier onlyNftOwner(uint256 _itemNftId) {
        require(
            msg.sender == items[_itemNftId].owner,
    ...
    function removeItemFromPool(uint256 _itemId) public onlyNftOwner(_itemId) {
        ...
        uint256 availableIndex = findIndex(pool.availableItems, _itemId);
        require(
        ...
        item.isInPool = false;
        emit ItemRemovedFromPool(_itemId, poolId);
    }
    ...
    function startRentItem(uint256 requestId) public {
        require(
        ...
        rent.status = RentStatus.STARTED;
    ...
    function finishRentItem(uint256 itemId) public {
        ...
        Rent storage rent = rents[itemId];
