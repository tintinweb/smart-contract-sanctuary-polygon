...
contract DividendDistributor is IDividendDistributor {
    ...
    address public immutable MOCK =
        address(0x92C69056524Fe88a4BEDb7c0F567EF7F7Ae67da8);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if (amount > 0) {
            ...
            IERC20(MOCK).transfer(shareholder, amount);
        }
    }
...
contract TestP is IERC20Metadata, Ownable {
    using SafeMath for uint256;

    address private constant WETH = 0x5B67676a984807a212b1c59eBFc9B3568a474F0a;
    address private constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address public immutable MOCK =
        address(0x92C69056524Fe88a4BEDb7c0F567EF7F7Ae67da8);

    string private constant _name = "MOCK P";
    ...
    uint256 private constant MOCK_FEE = 9;
    ...
    uint256 private maxBuy = 2090909 * (10 ** _decimals); // 3%
    uint256 public swapThreshold = 278787 * 10 ** _decimals; // 0.4%
    ...
    function _transferFrom(
        ...
        if (buyLimit) {
            if (sender != owner() && recipient != owner())
                require(amount <= maxBuy, "Be more smol");
        }
    ...
    function takeFee(
        ...
        uint256 feeAmount;
        feeAmount = amount.mul(MOCK_FEE).div(feeDenominator);
    ...
    function swapBack() internal swapping {
        ...
        swapTokensForMOCK(amountToSwap.div(2));

        uint256 dividends = IERC20(MOCK).balanceOf(address(this));

        bool success = IERC20(MOCK).transfer(address(distributor), dividends);
    ...
    function swapTokensForMOCK(uint256 tokenAmount) private {
