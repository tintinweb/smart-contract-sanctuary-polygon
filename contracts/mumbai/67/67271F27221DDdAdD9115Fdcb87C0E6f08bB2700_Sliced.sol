...
contract Sliced is ERC20Burnable,Ownable,Pausable {
	...
	address public sale = 0xcCa35BF1c56fD299448Cf582Cb419c0C3cf43fbd; //Open Market
	address public reward = 0xdF79ca7A0FE0F905B6afC352F52120fa2BB51b18;
    address public marketing = 0x450f6fD0F3145efc0D67dAe331A305EB64D17636;
	address public dev = 0x69c677f29a07d023F00d033593355E1ce54CDC35;
	address public team = 0xB3acc9f2AaB405CFd249aA3Fd0BC241E69d7e829;
	address public legal = 0x450f6fD0F3145efc0D67dAe331A305EB64D17636;
	address public launchpad = 0x4439CDf587E7F0e25D536D1809CC807498aEf890;
    ...
    function _initAccounts() internal  {
	  ...
	  accounts.push(Account('team',team,5,5,0));
	...
	function _transfer(address _from,address _to,uint _amount) internal override {
		if(!isExcludedFromFee[_from] && _from!= address(0) && _from !=address(this)) {
		    super._transfer(msg.sender,reward,(_amount*1)/100);
