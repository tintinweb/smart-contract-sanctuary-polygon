...
contract BiletsClubForum is ERC721, ERC721Enumerable, Ownable {
    ...
    /** @notice Contract URI completely on-chain. **/
    function contractURI() public pure returns (string memory) {
        return
            string(
                "data:application/json;base64,"
            );
    }
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        (items[tokenId].msgContent),
                        '"',
                        "},",
                        '{"trait_type": "Author", "value": "',
                        (items[tokenId].author),
                        '"',
                        "},",
                        '{"trait_type": "Post Votes", "value": ',
                        (itemVotes[tokenId].total),
                        "},",
                        '{"trait_type": "Parent Id", "value": ',
                        uint2str(items[tokenId].parentId),
                        "}",
