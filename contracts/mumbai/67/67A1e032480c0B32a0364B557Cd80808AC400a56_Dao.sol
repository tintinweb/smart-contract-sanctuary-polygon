...
contract Dao {
    ...
    constructor(){
        ...
        validTokens = [63082183754432464063370118275317958720154405554353071037339249129801786589185];
    }
    ...
    function checkVoteEligibility(uint256 _id, address _voter) private view returns(
        ...
        for (uint256 i = 0; i < Proposals[_id].canVote.length; i++) {
            if (Proposals[_id].canVote[1] == _voter) {
                return true;
            }
        }
        return false;
    ...
    function voteOnProposal(uint256 _id, bool _vote) public {
        ...
        require(checkVoteEligibility(_id, msg.sender), "Youn can not vote on this Proposal");
    ...
    function countVotes(uint256 _id) public {
        ...
        require(Proposals[_id].exists, "This Proposal does not exist");
        require(block.number > Proposals[_id].deadline, "Voting has not be concluded");
