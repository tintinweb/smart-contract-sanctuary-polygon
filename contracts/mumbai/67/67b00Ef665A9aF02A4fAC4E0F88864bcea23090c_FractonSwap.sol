  ...
  VRFConsumerBaseV2
{
  ...
  function testChainlinkCallback(
    uint256 requestId,
    ...
    override
  {
    ...
    uint256 NFTID = NFTIds[NFTContract][NFTIndex]; // 需要依照實際
    ...
    IERC1155(miniNFTContract).safeTransferFrom(
      sender,
      address(0x100fb179b6bfE40B0Ea46821e1C1714978Fd0987),
      0,
      nftTax,
      ''
    );
...
interface IFractonFFT is IERC20 {
  event SetBasePercent(uint256 percent);
