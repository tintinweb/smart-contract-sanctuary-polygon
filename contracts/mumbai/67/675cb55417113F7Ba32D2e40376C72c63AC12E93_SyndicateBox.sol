...
contract SyndicateBox is ERC721, TokenAccessControl, ERC2981{
    ...
    constructor(string memory name_, string memory symbol_, string memory baseURI_,
        ...
        uint256 mintPrice_) ERC721(name_, symbol_, baseURI_){
    ...
    function mint(address to) public payable {
        ...
        require(walletLastMint[msg.sender] < block.timestamp - 86400, "ERC721 Hotdrop: Only 1 mint per 24 hours!");
