...
/// @title A rentNFT class.
/// @author A realbits dev team.
/// @notice rentNFT can be used for renting NFT.
    ...
    ERC721Burnable
{
    ...
    // The following functions should be defined because two or more constracts defined this function.
    function _beforeTokenTransfer(
        address from,
        address to,
        uint256 tokenId
