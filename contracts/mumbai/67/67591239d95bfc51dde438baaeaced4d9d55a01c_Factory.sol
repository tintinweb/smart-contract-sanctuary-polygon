...
/** 
 *  SourceUnit: /home/ilad/Dropbox/code/tokenos-web3/contracts/Factory.sol
*/
...
contract Factory {
    function newProject(address _token, address _recovery) external returns (address) {
        Main _main = new Main(_token, _recovery);
