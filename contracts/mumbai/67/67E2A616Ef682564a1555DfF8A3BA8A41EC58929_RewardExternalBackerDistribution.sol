...
contract RewardExternalBackerDistribution is ERC721Holder, ERC1155Holder, ReentrancyGuard, AccessController {
    ...
    mapping(string => uint256) public indexOfTokenIdByCampaignId; 
    ...
    function getIndexOfTokenIdByCampaignId(string calldata _campaignId) public view returns(uint256){
        return indexOfTokenIdByCampaignId[_campaignId];
    }
    ...
    function claimReward(
        ...
        if(existReward.rewardType == RewardStorage.RewardType.ProprieratyNFT){
            ...
            indexOfTokenIdByCampaignId[ _campaignType.campaignId] += _claimInfo.amount;
    ...
    function withdrawRewardExternal(
        ...
        rewardStorage.setOrderExcuted(_orderId, true);
        if(existReward.rewardType == RewardStorage.RewardType.ProprieratyNFT){
            indexOfTokenIdByCampaignId[ _campaignType.campaignId] += _tokenIds.length;
