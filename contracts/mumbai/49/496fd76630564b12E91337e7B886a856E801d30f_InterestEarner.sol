...
contract InterestEarner {
    ...
    mapping(address => uint256) public totalExpectedInterestToAddress;
    mapping(address => mapping(bytes32 => uint256)) public totalAmountStakedToSheduleIdToAddress;
    mapping(address => mapping(bytes32 => uint256)) public totalExpectedInterestToSheduleIdToAddress;
    ...
    event StakingInformations(uint256 weiPerSecond,uint256 holdersStakingCount , bytes32 stakingScheduleId ,uint256 interestEarnedPerAnnum_pre ,uint256  amount,uint256 percentageBasisPoints,uint256 interestEarnedPerAnnum_post,uint256 releaseEpoch,uint256 timePeriod,uint256 initialStakingTimestamp,uint256 secondsRemaining,uint256 interestEarnedForThisStake );
    event totalExpeted(uint256 totalExpectedInterest, uint256 finaltotalExpectedInterest);
    ...
    */
    ...
    function getTotalExpectedInterest() private view returns (uint256) {
        ...
        noReentrant
    {
        ...
        totalExpectedInterestToAddress[msg.sender] = totalExpectedInterestToAddress[msg.sender].add(interestEarnedForThisStake);

        totalAmountStakedToSheduleIdToAddress[msg.sender][stakingScheduleId] = amount;
        totalExpectedInterestToSheduleIdToAddress[msg.sender][stakingScheduleId] = interestEarnedForThisStake;
        ...
        stakingSchedules[stakingScheduleId] = StakingSchedule(
            ...
            msg.sender,
            block.timestamp,
            totalExpectedInterestToSheduleIdToAddress[msg.sender][stakingScheduleId],
            amount,
            false
        );
        ...
        emit StakingInformations(weiPerSecond,holdersStakingCount[msg.sender],stakingScheduleId,interestEarnedPerAnnum_pre, amount, percentageBasisPoints,interestEarnedPerAnnum_post,releaseEpoch, timePeriod, initialStakingTimestamp[msg.sender], secondsRemaining, interestEarnedForThisStake);
        emit totalExpeted(totalExpectedInterest,finaltotalExpectedInterest);
    ...
    returns(uint256){
        ...
        require(
            stakingSchedules[stakeScheduleId].revoked != false,
            "Holder Already Unstaked this scheduled Id"
        );
