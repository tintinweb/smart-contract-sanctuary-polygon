...
contract ProjectInvestImplementer {
    ...
    event newProject(uint32 id, Project project, string uid);
    ...
    function addProject(Project calldata _project, address destWallet, string calldata uid) external onlyAllowed returns (uint32){
        ...
        emit newProject(projectCount, projects[projectCount], uid);
        return projectCount;
    }
