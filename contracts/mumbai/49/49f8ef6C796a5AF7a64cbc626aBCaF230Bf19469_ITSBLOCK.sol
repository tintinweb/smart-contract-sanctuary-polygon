...
contract ITSBLOCK is ERC20, Ownable, Pausable, UserFreeze {
  ...
  function _beforeTokenTransfer(
    ...
    address to,
    uint256 amount
  ) internal virtual override whenNotFrozen(_msgSender()) {
    super._beforeTokenTransfer(from, to, amount);

    require(!paused(), "ERC20Pausable: token transfer while paused");
//    require(!isFrozen(_msgSender()), "UserFreeze: This user is frozen");
  }
}
