...
contract RewardControl is RoleControl {
  ...
  function storeRewards(Reward[] memory rewards) public {
    for (uint256 i = 0; i < rewards.length; i++) {
      ...
      storeReward(r.secret, r.amount, r.tokenContract, r.claimableAt, r.receiver);
    }
  }
...
contract SnackclubTournamentsPayout is RewardControl {
  ...
  function depositToken(uint256 amount, address tokenContract) public onlyAdminOrOperator {
    IERC20 token = IERC20(tokenContract);
