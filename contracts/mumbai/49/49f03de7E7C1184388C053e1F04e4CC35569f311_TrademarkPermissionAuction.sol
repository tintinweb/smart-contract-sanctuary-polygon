...
contract TrademarkPermissionAuction is ClockAuction {
    ...
    function createAuction(
        ...
        require(isOnAuction(_tokenId) == false, "TrademarkPermissionAuction: Already on Auction");
        ...
        whenNotPaused
    {
        ...
        nonFungibleContract.addTrademarkPermission(_tokenId, msg.sender);
    }
}
