...
contract TransferManagerNonCompliantERC721 is ITransferManagerNFT {
    address public immutable ML_EXCHANGE;

    /**
     * @notice Constructor
     * @param _MLExchange address of the ML exchange
     */
    constructor(address _MLExchange) {
        ML_EXCHANGE = _MLExchange;
    }
    ...
    function transferNonFungibleToken(
        ...
        require(msg.sender == ML_EXCHANGE, "Transfer: Only ML Exchange");
