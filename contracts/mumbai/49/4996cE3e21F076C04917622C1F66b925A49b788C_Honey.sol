...
contract Honey is Context, IERC20, Ownable,Pausable{
    ...
    string _name = 'Honey-M';
    string _symbol = 'HNY-M';
    uint8 _decimals = 18;
  ...
  address public immutable uniswapV2Pair;
    ...
    function _approve(address owner, address spender, uint256 amount) private {
       ...
       function SetHoneyTeamTaxPercent(uint256 TeamTax) external onlyOwner() {
        _HoneyTeamTax =TeamTax;
    }
    
    function SetTreasuryTaxPercent(uint256 SetTreasurytax) external onlyOwner() {
        _TreasuryTax = SetTreasurytax;
    }
