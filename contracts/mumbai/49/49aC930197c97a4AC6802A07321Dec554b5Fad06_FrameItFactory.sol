...
contract FrameItFactory is IFrameItFactory, FrameItContext, Ownable {
    ...
    constructor (address _nftTemplate, address _lootBoxTemplate, address _salesSplitterTemplate, address _marketplace, address _auctionMarketplace, address _album, address _forwarder) FrameItContext(_forwarder) {
