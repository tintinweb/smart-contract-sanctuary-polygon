...
contract ConditionalTokens is Roles, ERC1155 {
    ...
    function redeemPositions(IERC20 collateralToken, bytes32 parentCollectionId, bytes32 conditionId, uint[] calldata indexSets) external {
        ...
        uint fullIndexSet = (1 << outcomeSlotCount) - 1;
        uint[] memory payoutStakes = new uint[](indexSets.length);
        ...
        emit PayoutRedemption(msg.sender, collateralToken, parentCollectionId, conditionId, indexSets, totalPayout, payoutStakes);
    }
