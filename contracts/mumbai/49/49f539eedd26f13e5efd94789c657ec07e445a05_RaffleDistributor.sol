...
contract RaffleDistributor is Context, Pausable {
    ...
    event UpdatedRaffleTicketAddress(address oldAddress,address newAddress);
    event UpdatedVaultAddress(address oldAddress,address newAddress);
    ...
    function setRaffleTicketAddress(address raffleaddr) public onlyOwner {
        emit UpdatedRaffleTicketAddress(RAFFLE_TICKET_ADDRESS,raffleaddr);
        RAFFLE_TICKET_ADDRESS = raffleaddr;
    }

    function setVaultAddress(address vaultaddr) public onlyOwner {
        emit UpdatedVaultAddress(VAULT,vaultaddr);
        VAULT = vaultaddr;
    }
