...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x0142B27B469bb2bb1257D8e077EFd6d8b666CF1e,0xe500ba14EEa3fe368f3f33BfEC4D6f06dA982B6f];
  address public erc20Payable = 0x0142B27B469bb2bb1257D8e077EFd6d8b666CF1e;
  uint256[] public payableFees = [30,70];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 999, 8888) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://metadata.mintfoundry.xyz/c/YofdYvfp8L8WdI0yWBHS/token/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/18GkKctGZbu4CoBz2tl8/contract-metadata";
  }
...
// File: contracts/PiDragonKingdomContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PiDragonKingdomContract is ERC721APlus {
    constructor() ERC721APlus("Pi Dragon Kingdom", "PiDK"){}
}
