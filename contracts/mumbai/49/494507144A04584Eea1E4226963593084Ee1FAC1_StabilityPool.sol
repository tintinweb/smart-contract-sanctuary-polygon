...
contract StabilityPool is IStabilityPool, Ownable {
    ...
    function withdrawFromStabilityPool(uint _amount) external override {
        ...
        _sendOMATICGainToDepositor(depositorOMATICGain);
    }
    ...
    */
    ...
    // --- oMATIC staking rewards calculator ---
    function getDepositorOMATICRewards(address _depositor) public view returns (uint) {
        uint initialDeposit = deposits[_depositor];
        ...
        uint MATICRewards = _getOMATICRewardsFromSnapshots(initialDeposit, snapshots);
        return MATICRewards;
    }
    ...
    */
    ...
    function rewardsOffset(uint _rewardsToAdd) external override {
        ...
        _updateOMATICRewardSumAndProduct(oMATICRewardsPerUnitStaked, 0);
    ...
    function _updateOMATICRewardSumAndProduct(uint _oMATICRewardsPerUnitStaked, uint _USDCLossPerUnitStaked) internal {
        uint currentP = P;
        uint newP;
