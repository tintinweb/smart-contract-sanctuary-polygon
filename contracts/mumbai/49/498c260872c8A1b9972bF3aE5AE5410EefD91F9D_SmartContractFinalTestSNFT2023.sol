...
contract SmartContractFinalTestSNFT2023 is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    function registerElement(address to, string memory uri, uint idElement, string memory verificationCode) public onlyContractOwner beforeRegister(idElement, verificationCode) {        
        ...
        _collection[idElement-1].endDate = 0;
        _collection[idElement-1].services = _SERVICES_ENABLED;
        _collection[idElement-1].ownerHistory.push(to);
    }

    function updateTokenUriElement(string memory uri, uint idElement, string memory verificationCode) public onlyContractOwner beforeRegister(idElement, verificationCode) {                
    ...
    function disableServicesElement(uint idElement, string memory verificationCode) public onlyContractOwner before(idElement, verificationCode) {        
        ...
        _collection[idElement-1].endDate = block.timestamp;
    }
    ...
    function _verifyCode(uint idElement, string memory verificationCode) private pure returns (bool) {
        if (idElement >= 1 && idElement<=200)
            return OriginalCollection_0_200.verifyElementCode(idElement-1, verificationCode);
...
library OriginalCollection_0_200 {
/***************************************
**  Validation Code from ID 1 to 200  **
****************************************
- BEGIN -
...
.
******************************************
** Authentication code from ID 1 to 200 **
******************************************
- BEGIN -
...
/***************************************
** Validation Code from ID 201 to 400 **
****************************************
- BEGIN -
...
.
********************************************
** Authentication code from ID 201 to 400 **
********************************************
- BEGIN -
...
/***************************************
** Validation Code from ID 401 to 600 **
****************************************
- BEGIN -
...
.
********************************************
** Authentication code from ID 401 to 600 **
********************************************
- BEGIN -
...
/***************************************
** Validation Code from ID 601 to 800 **
****************************************
- BEGIN -
...
.
********************************************
** Authentication code from ID 601 to 800 **
********************************************
- BEGIN -
...
/****************************************
** Validation Code from ID 801 to 1000 **
*****************************************
- BEGIN -
...
.
*********************************************
** Authentication code from ID 801 to 1000 **
*********************************************
- BEGIN -
...
/*****************************************
** Validation Code from ID 1001 to 1200 **
******************************************
- BEGIN -
...
.
**********************************************
** Authentication code from ID 1001 to 1200 **
**********************************************
- BEGIN -
...
/*****************************************
** Validation Code from ID 1201 to 1400 **
******************************************
- BEGIN -
...
.
**********************************************
** Authentication code from ID 1201 to 1400 **
**********************************************
- BEGIN -
...
/*****************************************
** Validation Code from ID 1401 to 1600 **
******************************************
- BEGIN -
...
.
**********************************************
** Authentication code from ID 1401 to 1600 **
**********************************************
- BEGIN -
...
/*****************************************
** Validation Code from ID 1601 to 1800 **
******************************************
- BEGIN -
...
.
**********************************************
** Authentication code from ID 1601 to 1800 **
**********************************************
- BEGIN -
...
/*****************************************
** Validation Code from ID 1801 to 2000 **
******************************************
- BEGIN -
...
.
**********************************************
** Authentication code from ID 1801 to 2000 **
**********************************************
- BEGIN -
...
/*****************************************
** Validation Code from ID 2001 to 2200 **
******************************************
- BEGIN -
...
.
**********************************************
** Authentication code from ID 2001 to 2200 **
**********************************************
- BEGIN -
...
/*****************************************
** Validation Code from ID 2201 to 2400 **
******************************************
- BEGIN -
...
.
**********************************************
** Authentication code from ID 2201 to 2400 **
**********************************************
- BEGIN -
...
/*****************************************
** Validation Code from ID 2401 to 2436 **
******************************************
- BEGIN -
...
.
**********************************************
** Authentication code from ID 2401 to 2436 **
**********************************************
- BEGIN -
