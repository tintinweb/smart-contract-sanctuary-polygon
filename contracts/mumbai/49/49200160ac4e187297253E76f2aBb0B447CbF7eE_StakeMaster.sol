...
contract StakingPool is Ownable, Whitelist, ReentrancyGuard {
    ...
    uint256 public uniqueParticipants; //Count of unique participants
    uint256 public currentParticipants; //Count of current participants
    ...
    function poolStats() external view returns (uint, uint, uint, uint, uint, uint) {
        return (allStakedAmount, rewardPerSec, uniqueParticipants, startTime, finishTime, currentParticipants);
    }
