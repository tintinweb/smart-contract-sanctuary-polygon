...
contract NFTMinting is ERC721Enumerable, ReentrancyGuard {
    ...
    modifier isPriceEqual(uint256 price, uint256 _mintAmount) {
        require(price >= mintPrice * _mintAmount, "price not enough");
        _;
    }
    ...
    function setCost(uint256 _mintPrice) public onlyOwner {
        mintPrice = _mintPrice;
    }
    ...
    function mint(address _to, uint256 _mintAmount)
        ...
        whenNotPaused
        onlyOwner
        isPriceEqual(msg.value, _mintAmount)
    {
        require(!paused);
