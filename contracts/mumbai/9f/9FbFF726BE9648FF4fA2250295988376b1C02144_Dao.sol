...
// Dao deployed to: 0x9FbFF726BE9648FF4fA2250295988376b1C02144
contract Dao {
    ...
    constructor() {
        ...
        validTokens = [
            14328378809295534319370225206961000861370307333310313602431309575872399278180
        ];
    }
    ...
    function createProposal(
        ...
        require(
            ...
            "Only NFT holders can submit a new proposal"
        );
    ...
    function countVotes(uint256 _id) public {
        require(
            msg.sender == owner,
            "Only the contract owner can call ths function"
        );
        require(Proposals[_id].exists, "This proposal does not exist");
        require(
            block.number > Proposals[_id].deadline,
            "The proposal deadline has not past yet"
        );
        require(
            !Proposals[_id].countConducted,
            "Count for this proposal already took place"
        );
