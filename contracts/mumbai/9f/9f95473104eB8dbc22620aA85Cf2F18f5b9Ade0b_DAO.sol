...
interface IDAO {
     ...
     */
    function addProposal(address recipient, string memory description, bytes memory callData) external;
     ...
     * @param id Proposal ID
     */
    function getVotingStatus(address user, uint256 id) external view returns (bool);
