...
contract Web3RSVP {
    ...
    function createNewRSVP(bytes32 eventId, string calldata _discordId) external {
       ...
       address metsoAddress = 0x4dF8Dd1bE785c0e0b61fB5e3AC35040E8DaAaDD6;
       ...
       // look up event
        ...
        if (myEvent.deposit > 0) {
            uint256 metsoShare = (myEvent.deposit * 2000000000000000000 / 100000000000000000000);
            ...
            token.transferFrom(msg.sender, metsoAddress, metsoShare);
