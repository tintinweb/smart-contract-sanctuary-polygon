...
contract AccessControlFacet is Modifiers, LibValidations {
...
contract ClaimFacet is Modifiers, LibValidations {
...
contract DataFacet is LibFlightsToCheck {
    using LibProduct for Product;
    using LibFlight for Flight;
...
contract PolicyCreationFacet is Modifiers, LibValidations, LibFlightsToCheck {
    using LibPolicy for Policy;
    using LibProduct for Product;
    using LibFlight for Flight;
...
contract LibValidations is InheritedStorage {
    using LibFlight for Flight;
    using LibPolicy for Policy;
...
contract LibFlightsToCheck is InheritedStorage {
    using LibFlight for Flight;
