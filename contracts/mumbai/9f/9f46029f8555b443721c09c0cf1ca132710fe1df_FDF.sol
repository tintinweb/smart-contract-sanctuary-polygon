...
contract FDF {
    ...
    uint256 private constant dayPerCycle = 1 days; //15
    ...
    function _calLevelNow(address _user) private view returns(uint256) {
        ...
        if(total >= 2000e6){
            ...
            if(total >= 4000e6 && user.teamNum >= 20 && maxTeam >= 100000e6 && otherTeam >= 100000e6){//&& user.teamNum >= 200
                levelNow = 5;
            }else if(user.teamNum >= 19 && maxTeam >= 20000e6 && otherTeam >= 20000e6){//&& user.teamNum >= 50
                levelNow = 4;
            }else{
                levelNow = 3;
            }
