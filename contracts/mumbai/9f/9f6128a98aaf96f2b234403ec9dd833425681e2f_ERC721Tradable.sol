...
// File contracts/OnePlanetDrawDownUpgradeable.sol
...
abstract contract OnePlanetConnected is Initializable, AccessControlUpgradeable {
    ...
    function __OnePlanetConnected_init_unchained(address _onePlanetAdmin) internal onlyInitializing {
        ...
        OnePlanetAddress = 0xC7f993B76aEd4531c49f67ca7F9Ad14d613708bf; //Polygon OnePlanet contract address
        offsetSwitch = 1;
   ...
   //OnePlanet Modifiers
    ...
    function setOffsetSwitch(uint8 offsetSwitchState) external onlyRole(ONEPLANET_ADMIN_ROLE) {
        offsetSwitch = offsetSwitchState;
    }

    function updateOffsetMsg(string calldata message) external onlyRole(ONEPLANET_ADMIN_ROLE) {
        offsetMsg = message;
    }
    
    function update1PLANETaddress(address payable new1PLANETaddress) external onlyRole(ONEPLANET_ADMIN_ROLE) {
        OnePlanetAddress = new1PLANETaddress;
	}
    // extra offset value should be in long integer format 1e18
    function updateCO2drawdown(uint256 longInteger) external onlyRole(ONEPLANET_ADMIN_ROLE) {
        CO2drawdown = longInteger;
    }

    // when updating this multiplier value: 100 = 1.00, 155 = 1.55, 200 = 2.00 etc
    function updateDrawdownMultiplier (uint256 threeDigitMultiplier) external onlyRole(ONEPLANET_ADMIN_ROLE) {
...
contract ERC721Tradable is ERC721Upgradeable, OnePlanetConnected, ContextMixin, NativeMetaTransaction {
    ...
    function initialize(
        ...
        _defaultAdmin = 0xacCeB894DbA9632E49C56bC0ED75e515aeA95a12;
        _onePlanetAdmin = 0xacCeB894DbA9632E49C56bC0ED75e515aeA95a12;
        _name = "BadDog";
        _symbol = "BITE";        
    ...
    function baseTokenURI() virtual public returns (string memory) {
        return baseURI;
    }
