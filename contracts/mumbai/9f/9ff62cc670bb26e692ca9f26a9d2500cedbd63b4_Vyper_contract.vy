...
NAME: constant(String[20]) = "GOO"
SYMBOL: constant(String[5]) = "GOO"
...
# @dev the default value for the minRoyaltyAmount is 0.01 ETH = 10**16
    self.minRoyaltyAmount = 100000000
...
@internal
@view
def _royaltiesCalculator(_tokenId: uint256, _salePrice: uint256) -> uint256:
    """
    /// @notice Called with the sale price to determine how much royalty
    //          is owed and to whom. Important; Not all marketplaces respect this, e.g. OpenSea
    /// @param _tokenId - the NFT asset queried for royalty information
