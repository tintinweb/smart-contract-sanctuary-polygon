...
contract AggregatorV2 is ReentrancyGuard, Ownable, EIP712 {
    ...
    bytes32 private constant SWAP_NFT_ORDER_TYPE =
        keccak256(
            "SwapNftOrder(uint256 fee,address fromToken,address toToken,address destination,uint256 fromAmount,uint256 minReturnAmount,address _dex,bytes _data,address _nftDex,bytes _nftData,address nftToken,uint256 tokenId,uint256 nftBaseAmount)"
        );
