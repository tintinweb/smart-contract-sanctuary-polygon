...
contract EditorialV2 is ERC1155, Ownable, Pausable, ReentrancyGuard, AccessControl {
    ...
    function _searchTokenHolder( address _holderAddress ) internal view returns( uint result ) {
        {   uint i;
     ...
     */
    function _removeTokenHolder( uint _tokenHolderIndex ) internal {
    ...
    */
    function transferNFT( address _from, address _to, uint256 _id, uint256 _amount ) external  {
        ...
        uint _tokenHolderIndex = _searchTokenHolder(  _from );

        _removeTokenHolder(  _tokenHolderIndex );
