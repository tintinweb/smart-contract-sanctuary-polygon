...
contract GangLinks is ERC721, Ownable, ReentrancyGuard {
    ...
    GangToken public gangTokenContract =
        GangToken(payable(0x8802bCBF82B12D1d5DF05ED32673Dae9f4304d75));

    GangNFTCreator public gangNFTCreatorContract =
        GangNFTCreator(payable(0x7B2Fce5e6bdebB46B24c8Bd23f06e81830eff1ce));
     ...
     * @param imageUrl The URL of the image associated with the NFT.
     * @param links An array of links associated with the NFT.
     * @return The ID of the created NFT.
     */
    function createGangLinks(
