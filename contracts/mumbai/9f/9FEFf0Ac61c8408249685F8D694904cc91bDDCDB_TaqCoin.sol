...
contract TaqCoin is ERC20, ERC20Burnable, Pausable, TaqAccessControl, ERC20Permit {
    error MismatchedLength();

    constructor(IERC721 _token) ERC20("TaqCoin", "TAQ") TaqAccessControl(_token) ERC20Permit("TaqCoin") {}
    ...
    function batchMint(address[] calldata addrs, uint256[] calldata values) external onlyOwner {
