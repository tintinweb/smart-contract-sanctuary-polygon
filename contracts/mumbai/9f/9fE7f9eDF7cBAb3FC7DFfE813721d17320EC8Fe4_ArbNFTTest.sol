...
contract ArbNFTTest is ERC721, Ownable, Pausable {
    constructor() ERC721("ARBNFT Luffy", "ARBL") Ownable() {}
    ...
    string[] private z;
    string[] private colorBg = ["84D0FA", "8B939E", "7DAEAD", "95C77D", "B1DC8C", "FAE27B", "F9C87C", "ED9685", "E2868A", "C97CAD", "AF87B1", "8186B7", "8E93BD"];
    ...
    string private co1=', ';
    string private rl1='{"name": "ARBNFT Luffy #';
    string private rl3='"}';
    ...
    function genImgSVG(uint256 tokenId) public view returns (string memory) {
        ...
        string memory output = string(abi.encodePacked(z[0], colorBg[(uint8(random(abi.encodePacked(re1,tokenId.toString()))) % colorBg.length)], sp1));
