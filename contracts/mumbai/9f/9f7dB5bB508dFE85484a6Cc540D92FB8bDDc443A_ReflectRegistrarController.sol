...
contract ReflectRegistrarController is Ownable {
    ...
    event SubdomainFee(bytes32 indexed tld, uint indexed SubdomainFee, address indexed payment);
    event TldOwnerFee(bytes32 indexed tld, uint indexed tldOwnerFee, address indexed payment);
