...
contract TftwTest is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    function safeMint(address to) public payable {
        ...
        if (silverSaleStarted) {
            ...
            require(silverWhitelistSale[msg.sender] != true, "You have already mint your silver token.");
            silverWhitelistSale[msg.sender] = true;
        } else if (goldSaleStarted) {
            require(goldWhitelist[msg.sender] == true, "You're not in the whitelist.");
            require(goldWhitelistSale[msg.sender] != true, "You have already mint your gold token.");
            goldWhitelistSale[msg.sender] = true;
        } else if (ogSaleStarted) {
            require(ogWhitelist[msg.sender] == true, "You're not in the whitelist.");
            require(ogWhitelistSale[msg.sender] != true, "You have already mint your og token.");
            ogWhitelistSale[msg.sender] = true;
    ...
    function safeMintBigPackMint(address to) public payable {
        require(bigPackWhitelist[msg.sender] == true, "You're not in the whitelist.");
    ...
    function safeMediumBigPackMint(address to) public payable {
        require(mediumPackWhitelist[msg.sender] == true, "You're not in the whitelist.");
    ...
    function safeSmallBigPackMint(address to) public payable {
        require(smallPackWhitelist[msg.sender] == true, "You're not in the whitelist.");
