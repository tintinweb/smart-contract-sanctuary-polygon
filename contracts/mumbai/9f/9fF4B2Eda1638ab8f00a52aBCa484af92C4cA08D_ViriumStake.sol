...
contract ViriumStake is Initializable, UUPSUpgradeable, AccessControlUpgradeable {
    ...
    function earned() public view returns (uint256) {
        ...
        if (lastUpdateTime == 0 || totalShare == 0) {
            return 0;
        }
        return _userShare[msg.sender] * getRewardRate(block.timestamp, lastUpdateTime) / totalShare + rewards[msg.sender];
    }
    ...
    function earnedPerDay() external view returns (uint256){
        ...
        return _userShare[msg.sender] * getRewardRate(block.timestamp + 1 days, block.timestamp) / totalShare;
    }
