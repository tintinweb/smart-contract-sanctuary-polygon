...
contract SportSevenShop is Pausable, Ownable {
    ...
    uint16 public valueBack = 5;  //to be multiplied by 10 ** 16
    ...
    function buyInETH(
        ...
        uint256 backValue = _amount * valueBack * 10 ** 16;
        (bool sentBack,) = payable(_to).call{value : backValue}("");
        // The value is immediately transferred to the funds recipient
        (bool sent,) = payable(fundsRecipient).call{value : msg.value - backValue}("");
    ...
    /**
     * @dev Set the valueBack
     * @param _value new value in cents of matic
     */
    function setValueBack(uint16 _value) external onlyOwner {
        valueBack = _value;
    }
