...
error MetaStarWL__TransferFailed();
error MetaStarWL__NotEnoughMoneySent();

contract MetaStarWLNFT is ERC721, Ownable {
    ...
    constructor() ERC721("MetaStarWL", "MSW") {
    ...
    function mintNft() onlyActive public payable {
        if (msg.value < s_mintFee) {
            revert MetaStarWL__NotEnoughMoneySent();
        }
    ...
    */
    function withdraw() public onlyAdmin {
        ...
        if(!success) { 
            revert MetaStarWL__TransferFailed();
        }
    }
