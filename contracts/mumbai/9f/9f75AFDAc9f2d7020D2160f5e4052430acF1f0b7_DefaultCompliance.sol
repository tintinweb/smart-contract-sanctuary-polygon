...
contract DefaultCompliance is ICompliance, AgentRole, ComplianceStorage, Initializable {
     ...
     *  @dev See {ICompliance-isTokenAgent}.
     */
    function bindToken(address _token) public override onlyOwner {
     ...
     *  @dev See {ICompliance-isTokenAgent}.
     */
    function unbindToken(address _token) public override onlyOwner {
    ...
    function updateHolderLimit(uint256 _newHolderLimit) public onlyOwner {
