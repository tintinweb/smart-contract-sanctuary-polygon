...
contract Blocking {
    ...
    */
    ...
    function isAllowed(address targetAddress, address requesterAddress) public view returns (bool){
        // Themselves is always allowed
        if (targetAddress != requesterAddress){
    ...
    function toggleWhiteList(uint256 groupID) public checkForGroupOwnership(groupID) {
    ...
    // Can pass in optional groupID if this is a group being managed
    function clearList(bool clearWhitelist, uint256 groupID) public checkForGroupOwnership(groupID) {
    ...
    // Can pass in optional groupID if this is a group being managed
    function updateWhitelist(address toToggle, uint256 groupID) public checkForGroupOwnership(groupID) {
    ...
    // Can pass in optional groupID if this is a group being managed
    function updateBlacklist(address toToggle, uint256 groupID) public checkForGroupOwnership(groupID) {
