...
import {IERC721sbUpgradeable} from "./IERC721sbUpgradeable.sol";
import {IERC721sbReceiverUpgradeable} from "./IERC721sbReceiverUpgradeable.sol";

import {IERC721sbMetadataUpgradeable} from "./IERC721sbMetadataUpgradeable.sol";
 ...
 * {ERC721Enumerable}.
 */
contract ERC721sbUpgradeable is
    Initializable,
    ContextUpgradeable,
    ERC165StorageUpgradeable,
    IERC721sbUpgradeable,
    IERC721sbMetadataUpgradeable
{
     ...
     */
    function __ERC721sb_init(string memory name_, string memory symbol_) internal onlyInitializing {
        __ERC721sb_init_unchained(name_, symbol_);
    }

    function __ERC721sb_init_unchained(string memory name_, string memory symbol_)
        internal
        onlyInitializing
    {
        _name = name_;
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC165StorageUpgradeable, IERC165Upgradeable)
        returns (bool)
    {
        return
            interfaceId == type(IERC721sbUpgradeable).interfaceId ||
            interfaceId == type(IERC721sbMetadataUpgradeable).interfaceId ||
    ...
    function balanceOf(address owner) public view virtual override returns (uint256) {
        require(owner != address(0), "ERC721sb: address zero is not a valid owner");
    ...
    function ownerOf(uint256 tokenId) public view virtual override returns (address) {
        ...
        require(owner != address(0), "ERC721sb: invalid token ID");
        return owner;
    }
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = ERC721sbUpgradeable.ownerOf(tokenId);
        require(to != owner, "ERC721sb: approval to current owner");

        require(
            _msgSender() == owner || isApprovedForAll(owner, _msgSender()),
            "ERC721sb: approve caller is not token owner or approved for all"
        );
    ...
    function transferFrom(
        ...
        revert("One does not simply transfer parts of your soul!");
        //solhint-disable-next-line max-line-length
        //require(
        //    _isApprovedOrOwner(_msgSender(), tokenId),
        //    "ERC721sb: caller is not token owner or approved"
        //);
    ...
    function _safeTransfer(
        ...
        require(
            ...
            "ERC721sb: transfer to non ERC721Receiver implementer"
        );
    }
    ...
    function _mint(address to, uint256 tokenId) internal virtual {
        require(to != address(0), "ERC721sb: mint to the zero address");
        require(!_exists(tokenId), "ERC721sb: token already minted");
    ...
    function _transfer(
        ...
        require(
            ERC721sbUpgradeable.ownerOf(tokenId) == from,
            "ERC721sb: transfer from incorrect owner"
        );
        require(to != address(0), "ERC721sb: transfer to the zero address");
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(ERC721sbUpgradeable.ownerOf(tokenId), to, tokenId);
    }
    ...
    function _setApprovalForAll(
        ...
        require(owner != operator, "ERC721sb: approve to caller");
    ...
    function _requireMinted(uint256 tokenId) internal view virtual {
        require(_exists(tokenId), "ERC721sb: invalid token ID");
    }
    ...
    function _checkOnERC721Received(
        ...
        if (to.isContract()) {
            try
                IERC721sbReceiverUpgradeable(to).onERC721Received(_msgSender(), from, tokenId, data)
            returns (bytes4 retval) {
                return retval == IERC721sbReceiverUpgradeable.onERC721Received.selector;
            } catch (bytes memory reason) {
                if (reason.length == 0) {
                    revert("ERC721sb: transfer to non ERC721Receiver implementer");
                } else {
...
import "./ERC721sbUpgradeable.sol";
import {Initializable} from "@openzeppelin/contracts-upgradeable/proxy/utils/Initializable.sol";

/**
 * @dev ERC721 token with storage based token URI management.
 */
abstract contract ERC721sbURIStorageUpgradeable is Initializable, ERC721sbUpgradeable {
    function __ERC721sbURIStorage_init() internal onlyInitializing {}

    function __ERC721sbURIStorage_init_unchained() internal onlyInitializing {}
    ...
    function _setTokenURI(uint256 tokenId, string memory _tokenURI) internal virtual {
        require(_exists(tokenId), "ERC721sbURIStorage: URI set of nonexistent token");
...
import "./ERC721sbUpgradeable.sol";
import "./IERC721sbEnumerableUpgradeable.sol";
import "@openzeppelin/contracts-upgradeable/proxy/utils/Initializable.sol";
 ...
 * account.
 */
abstract contract ERC721sbEnumerableUpgradeable is
    Initializable,
    ERC721sbUpgradeable,
    IERC721sbEnumerableUpgradeable
{
    function __ERC721sbEnumerable_init() internal onlyInitializing {}

    function __ERC721sbEnumerable_init_unchained() internal onlyInitializing {}
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(IERC165Upgradeable, ERC721sbUpgradeable)
        returns (bool)
    {
        return
            interfaceId == type(IERC721sbEnumerableUpgradeable).interfaceId ||
            super.supportsInterface(interfaceId);
    }
    ...
    {
        require(
            index < ERC721sbUpgradeable.balanceOf(owner),
            "ERC721sbEnumerable: owner index out of bounds"
        );
    ...
    function tokenByIndex(uint256 index) public view virtual override returns (uint256) {
        require(
            index < ERC721sbEnumerableUpgradeable.totalSupply(),
            "ERC721sbEnumerable: global index out of bounds"
        );
    ...
    function _addTokenToOwnerEnumeration(address to, uint256 tokenId) private {
        uint256 length = ERC721sbUpgradeable.balanceOf(to);
    ...
    function _removeTokenFromOwnerEnumeration(address from, uint256 tokenId) private {
        ...
        uint256 lastTokenIndex = ERC721sbUpgradeable.balanceOf(from) - 1;
 ...
 */
abstract contract ERC721sbVotesUpgradeable is Initializable, ERC721sbUpgradeable, VotesUpgradeable {
    function __ERC721sbVotes_init() internal onlyInitializing {}

    function __ERC721sbVotes_init_unchained() internal onlyInitializing {}
 ...
 */
abstract contract ERC721sbBurnableUpgradeable is
    Initializable,
    ContextUpgradeable,
    ERC721sbUpgradeable
{
 ...
 */
interface IERC721sbUpgradeable is IERC165Upgradeable {
    /**
 ...
 */
interface IERC721sbReceiverUpgradeable {
    /**
...
import "./IERC721sbUpgradeable.sol";

/**
 * @title ERC-721 Non-Fungible Token Standard, optional metadata extension
 * @dev See https://eips.ethereum.org/EIPS/eip-721
 */
interface IERC721sbMetadataUpgradeable is IERC721sbUpgradeable {
    /**
 ...
 * @dev See https://eips.ethereum.org/EIPS/eip-721
 */
interface IERC721sbEnumerableUpgradeable is IERC721sbUpgradeable {
    /**
