...
contract BOC is ERC721, ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("BOC", "BOC") {}
    ...
    function safeMint(address to) public payable {
        require(msg.value >= 0.001 ether, "Not enoug money sent");
