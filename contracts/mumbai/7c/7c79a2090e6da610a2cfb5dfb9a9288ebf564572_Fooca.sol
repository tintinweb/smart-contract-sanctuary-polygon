    ...
    UUPSUpgradeable
{
    ...
    function mint(address to_) public returns (uint256) {
        require(hasRole(MINTER_ROLE, _msgSender()), "Fooca: must have minter role to mint");
        uint256 newTokenId_ = _tokenIdTracker.current();
        _safeMint(to_, newTokenId_);
        _tokenIdTracker.increment();
        return newTokenId_;
    }
     ...
     */
    function pause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "Fooca: must have pauser role to pause");
        _pause();
    }
     ...
     */
    function unpause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "Fooca: must have pauser role to unpause");
        _unpause();
    }
