...
// File: contracts/DoodlePalToken.sol


pragma solidity ^0.8.2;


contract DoodlePalToken is ERC20, AccessControl, ERC721Holder {
    ...
    constructor(address owner, address _collectionAddressDoodlePalNFT, address _collectionAddressNFTv2) ERC20("DoodlePalToken", "DPAL") AccessControl(){
    ...
    function stakeDoodlePalNFT(uint256 tokenId) public {
        ...
        require(IERC721(collectionAddressDoodlePalNFT).ownerOf(tokenId) == address(this),
            "DoodlePalToken: Error while transferring token");
