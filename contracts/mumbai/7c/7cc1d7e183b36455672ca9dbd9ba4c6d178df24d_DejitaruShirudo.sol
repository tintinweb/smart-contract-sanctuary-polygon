...
contract DejitaruShirudo is ERC20, Ownable {
    ...
    constructor() ERC20("earth", "help") {
        ...
        uint256 totalSupply = 100000 * 1e18; // 1 billion total supply
        ...
        swapTokensAtAmount = (totalSupply * 300) / 10000; // 3% swap wallet

        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevFee;

        marketingWallet = address(0xA2D26a1E65e4EAd64b4199E0928E496f9aA96C6D); // set as marketing wallet
        devWallet = address(0xA2D26a1E65e4EAd64b4199E0928E496f9aA96C6D); // set as dev wallet
    ...
    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        require(
            newNum >= ((totalSupply() * 200) / 1000) / 1e18,
            "Cannot set maxWallet lower than 20%"
        );
