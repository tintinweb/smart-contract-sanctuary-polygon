...
contract ChainBattles is ERC721URIStorage {
    ...
    function generateCharacter(uint256 tokenId) public view returns (string memory) {
        bytes memory svg = abi.encodePacked( 
            ...
            '<style>.base { fill: #0080ff; font-family: courier; font-size: 15px; }</style>',
            '<style>.title { fill: #0080ff; font-family: courier; font-size: 22px; font-weight: bold; }</style>',
    ...
    function mint() public {
        ...
        tokenIdToStats[newItemId].hp = random();
        tokenIdToStats[newItemId].strength = random();
        tokenIdToStats[newItemId].speed = random();
