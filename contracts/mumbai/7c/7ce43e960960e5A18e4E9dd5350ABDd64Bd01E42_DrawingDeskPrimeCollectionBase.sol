...
contract DrawingDeskPrimeCollectionBase is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, PausableUpgradeable, AccessControlUpgradeable, ERC721BurnableUpgradeable, UUPSUpgradeable,NativeMetaTransactionUpgradeable,ContextMixin {
    ...
    function initialize(string memory name, string memory symbol) initializer public {
     ...
     function _baseURI() internal pure override returns (string memory) {
        return "http://54.174.222.242:8080/api/metadata/CHALLENGE2_TITLE/";
    }
