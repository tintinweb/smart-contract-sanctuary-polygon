...
contract TournamentManager is VRFConsumerBaseV2 {
  ...
  function createTeam(uint256[5] memory gotchis, uint256 gotchiLeader, uint256[5][2] memory gotchiFormation, string memory teamName) public {
  ...
  function wrapToTeam(uint256[5] memory gotchis, uint256 gotchiLeader, uint256[5][2] memory gotchiFormation, address owner, string memory teamName) internal pure returns (Team memory) {
    Team memory newTeam;
  ...
  function modifyTeamBeforeBattle(uint256 teamIndex, uint256[5] memory gotchis, uint256 gotchiLeader, uint256[5][2] memory gotchiFormation, string memory teamName) external {
    require(gotchis.length == 5, "Invalid number of Gotchi IDs provided.");
    require(tournament_state == TOURNAMENT_STATE.INSCRIPTION_OPEN, "Tournament not open");
  ...
  function getTeamFormation(uint256 teamId) public view returns (uint256[5][2] memory){
  ...
  function checkGotchiFormationValidity1(uint256[5][2] memory gotchiFormation) public view returns (bool) {
  ...
  function checkGotchiFormationValidity2(uint256[5][2] memory gotchiFormation) public view returns (bool) {
