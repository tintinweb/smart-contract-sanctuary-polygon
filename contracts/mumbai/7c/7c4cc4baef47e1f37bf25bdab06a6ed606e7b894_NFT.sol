...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
		...
		return "https://ipfs.io/ipfs/QmSJBFTL1LQQZmR9B76GDqhGXU6uTTsQXv5RJMpgPUBtD1";
    }
...
contract NFT is ERC721, ContextMixin, NativeMetaTransaction {

	
   
	
	uint public publicSalePrice = 0.005 ether; //
	uint private constant MAX_SUPPLY = 7000;
	uint256 counter = 1;
	
	mapping(address => uint) public amountNFTsperWalletWhitelistSale;

    constructor() ERC721("MRA Badge", "MRAB") {
        _initializeEIP712("MRA Badge");
    ...
    */
        ...
        returns (uint256)
    {
		...
		require(counter < MAX_SUPPLY, "Max supply exceeded");
		require(amountNFTsperWalletWhitelistSale[msg.sender]<1,"address already minted");
