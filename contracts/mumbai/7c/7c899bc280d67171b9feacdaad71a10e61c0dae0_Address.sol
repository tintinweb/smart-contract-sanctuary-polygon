...
contract CourseCredits is Context, IBEP20, Ownable {
    ...
    string  private _NAME = 'Course Credits';
    string  private _SYMBOL = 'LEARN';
    ...
    uint256 private _tTotal = 5000000 * _DECIMALFACTOR;
    ...
    uint256 private _MAX_TX_SIZE = 5000000 * _DECIMALFACTOR;
