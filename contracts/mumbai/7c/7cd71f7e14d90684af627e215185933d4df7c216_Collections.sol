...
contract ERC1155 is Context, ERC165, IERC1155 {
    ...
    function _burn(address from,
        ...
        _beforeTokenTransfer(operator, from, address(0), collections, tokenIds, "");
        ...
        emit TransferSingle(operator, from, address(0), collection, tokenId);
        _afterTokenTransfer(operator, from, address(0), collections, tokenIds, "");
    }
...
contract Collections is ERC1155, Utilities {
     ...
     */
    event CreatedCollection(address indexed creator_, uint256 collection_);
    ...
    function createCollection(uint256 royalties_,
        ...
        emit CreatedCollection(msg.sender, COLLECTION_ID);
        COLLECTION_ID++;
    }
