...
contract Greeter is BaseRelayRecipient, VRFConsumerBaseV2 {
    ...
    // VRF-V2 Storage parameters
    uint256[] public s_randomWords;
    uint256 public s_requestId;
    uint64 public s_subscriptionId;
    address s_owner;

    //Greeter gasless storage
    string data;
    string[] public emails;

    //address public owner;

    constructor(address _trustedForwarder) VRFConsumerBaseV2(vrfCoordinator) {
    ...
    function generateLicense(string memory _email) public returns (uint256) {
        //call vrf to generate key
        //s_requestId = fulfillRandomWords(null, randomWords);
        ...
        //for now just add entry to array
        emails.push(_email);
        //assume email sent from JS client
