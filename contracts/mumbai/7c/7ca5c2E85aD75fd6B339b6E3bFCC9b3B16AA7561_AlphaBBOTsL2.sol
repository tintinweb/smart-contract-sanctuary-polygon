...
contract AlphaBBOTsL2 is ERC721, Ownable, CantBeEvil {
    ...
    address public CHILD_CHAIN_MANAGER;

    modifier onlyChildChainManager {
      require(_msgSender() == CHILD_CHAIN_MANAGER, "AlphaBBOTsL2: Not the child chain manager");
      _;
    }
    ...
    constructor(
        ...
        CHILD_CHAIN_MANAGER = _childChainManager;
    }
