...
contract HouseHaeds is DefaultOperatorFiltererUpgradeable, ERC721AUpgradeable, Ownable2StepUpgradeable, ReentrancyGuardUpgradeable {
  ...
  * @param _saleDiscount The discount in wei for each token during the elderlist and whitelist sales.
  ...
  * - The _saleDiscount must be less than or equal to the _cost.
  ...
  */
  function initialize(
    ...
    require(_saleDiscount <= _cost, "Invalid sale discount!");
  ...
  */
  function elderListMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) external payable {
    ...
    require(msg.value >= (cost - saleDiscount) * _mintAmount, "Insufficient funds!");
  ...
  */
  ...
  /**
  * @dev Set the whitelist or elderlist sale discount.
  * @param _saleDiscount The new maximum supply value to set.
  * Requirements:
  * - The caller must be the contract owner.
  * - The discount must be lower than the cost.
  */
  function setSaleDiscount(uint256 _saleDiscount) external onlyOwner {
    require(_saleDiscount <= cost, "Discount must be lower than cost!");
    saleDiscount = _saleDiscount;
  }
  ...
  */
  function setCost(uint256 _cost) external onlyOwner {
    require(_cost >= saleDiscount, "Cost must be higher than discount!");
    cost = _cost;
  }
