...
contract TADNFT is ERC721PresetMinterPauserAutoId {
    ...
    /// @dev Checks whether  _msgSender() is admins.
    modifier onlyAdmin() {
        require(
    ...
    function mintNFT(address _to, string calldata _uri) external whenNotPaused {
        ...
        // Update URI
        nftURI[id] = string(abi.encodePacked(_uri, id));
    ...
    function mintNFTBatch(address _to, string[] calldata _uris) external whenNotPaused {
        ...
        for (uint256 i = 0; i < _uris.length; i++) {
            ...
            // Update URI
            nftURI[id] = string(abi.encodePacked(_uris[i], id));
    ...
    /// @dev Lets an admin restrict token transfers.
    function setRestrictedTransfer(bool _restrictedTransfer) external onlyAdmin {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
       return string(abi.encodePacked(nftURI[tokenId],".json"));
    }
