...
contract MultiTaskFactory {
    ...
    function createMultiTask(
        ...
        require(_performanceBondPercent <= 100, "_performanceBondPercent should be less than 100");
        ...
        (
            ...
            _projectBonusRate,
            _projectPenaltyRate,
            _performanceBondPercent,
            _performanceBondDuration,
            MultiTask.User(_ownerName, msg.sender),
            _contractor,
            _referee
        );
        require(
            msg.sender != _contractor.account &&
            msg.sender != _referee.account && 
            _contractor.account != _referee.account,
            "invalid address for users."
        );
