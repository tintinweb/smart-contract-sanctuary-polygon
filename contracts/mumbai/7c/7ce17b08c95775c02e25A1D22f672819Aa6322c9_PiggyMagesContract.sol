...
//
//     ____  _                      __  ___                     
//    / __ \(_)___ _____ ___  __   /  |/  /___ _____ ____  _____
//   / /_/ / / __ `/ __ `/ / / /  / /|_/ / __ `/ __ `/ _ \/ ___/
//  / ____/ / /_/ / /_/ / /_/ /  / /  / / /_/ / /_/ /  __(__  ) 
// /_/   /_/\__, /\__, /\__, /  /_/  /_/\__,_/\__, /\___/____/  
//         /____//____//____/                /____/             
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x96845503957B7cba6702FF08fd0546C5093Dcf79];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmVEAgfURuzWmUk6MRGYVQ8wvsR6NjJrm6jDhcns6WZF8X/";
...
// File: contracts/PiggyMagesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PiggyMagesContract is RamppERC721A {
    constructor() RamppERC721A("Piggy Mages", "PIG"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/B7lCJF6ax2ffXdqan6rV/contract-metadata";
    }
}
