...
contract ERC721LazyMintWith712 is ERC721, EIP712, AccessControl {
    ...
    function redeem2(address account, uint256 tokenId)
    external
    {
        require(_verify2(account), "Invalid signature");
        _safeMint(account, tokenId);
    }
    ...
    function _verify2(address account)
    internal view returns (bool)
    {
        return hasRole(MINTER_ROLE, account);
    }

    function hasRoleToMint(address account) public view returns (bool){
        return hasRole(MINTER_ROLE, account);
    }

    function grantRoleToMint(address account) public {
