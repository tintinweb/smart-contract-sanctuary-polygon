...
contract LandsOfAzollite is ERC721, Ownable {

    // using Strings for uint256;

    string public PROVENANCE_HASH;

    uint256 constant MAX_SUPPLY = 125000;
...
//    uint256 public price = 2.5 ether; //2.5 ether
    // uint256 public price = 250000000000 ; //250.000 trx
