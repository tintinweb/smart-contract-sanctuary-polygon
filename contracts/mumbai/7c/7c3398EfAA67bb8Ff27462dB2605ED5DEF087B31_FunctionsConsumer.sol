...
contract FunctionsConsumer is FunctionsClient, ConfirmedOwner, ERC721, ERC721URIStorage {
  ...
  string[] IpfsIMG = [
    "https://ipfs.io/ipfs/QmZF9C6k5i4rt7xQKHj3tiF3eAsVRjQMcPv9YoQVHLYRQv/bronze.PNG",
    "https://ipfs.io/ipfs/QmZF9C6k5i4rt7xQKHj3tiF3eAsVRjQMcPv9YoQVHLYRQv/silver.PNG",
    "https://ipfs.io/ipfs/QmZF9C6k5i4rt7xQKHj3tiF3eAsVRjQMcPv9YoQVHLYRQv/gold.PNG"
  ];
  ...
  constructor(address oracle) FunctionsClient(oracle) ConfirmedOwner(msg.sender) ERC721("AWSDevDayPOAP", "ADDT") {}
  ...
  function tokenURI(uint256 tokenId) public view override(ERC721, ERC721URIStorage) returns (string memory) {
    ...
    // string for trophy level
    string memory trophyLevel;
    // calculate image based on github count
    string memory imageURI;
    if (githubCount <= 20) {
      imageURI = IpfsIMG[0];
      trophyLevel = "Bronze";
    } else if (githubCount <= 40) {
      imageURI = IpfsIMG[1];
      trophyLevel = "Silver";
    } else {
      imageURI = IpfsIMG[2];
