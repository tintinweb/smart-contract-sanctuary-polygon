...
contract Insurance is FunctionsClient, ConfirmedOwner, VRFConsumerBaseV2 {
  ...
  constructor(
    ...
    uint64 subscriptionId
  ) FunctionsClient(oracle) ConfirmedOwner(msg.sender) VRFConsumerBaseV2(0x8C7382F9D8f56b33781fE506E897a4F1e2d17255) {
