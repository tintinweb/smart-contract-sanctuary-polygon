...
// SPDX-License-Identifier: MIT 
 ...
 /*   Multi - An investment platform based on Matic Staker with innovative features
 
 *
 *   [USAGE INSTRUCTION]
 *
 *   1) Connect browser extension Metamask
 *   2) Choose one of the investment packages, enter the AVAX amount (0.01 AVAX minimum) using our website "Deposit" button
