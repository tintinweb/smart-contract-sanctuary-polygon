...
contract Paintmap is ERC721Base, ENSNameResolver {
    ...
    uint256 public constant DISCOUNT_MINT_PRICE = .032 ether;
...
library BlitmapAnalysis {
    ...
    function tokenRGBColorsOf(bytes memory data)
        public
        pure
        returns (Colors memory)
    {
        Colors memory rgb;
    ...
    function tokenSlabsOf(bytes memory data)
        public
        pure
        returns (string[4] memory)
    {
    ...
    function tokenAffinityOf(bytes memory data)
        public
        pure
        returns (string[3] memory)
    {
        ...
        uint256 r = rgb.r[0] + rgb.r[1] + rgb.r[2];
        uint256 g = rgb.g[0] + rgb.g[1] + rgb.g[2];
        uint256 b = rgb.b[0] + rgb.b[1] + rgb.b[2];
