...
contract SVGNFT is ERC721URIStorage, Ownable, VRFConsumerBaseV2 {
    ...
    {
        string memory initialURI = "data:application/json;base64,";
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        (_tokenId).toString(),
                        "',",
                        "'description': 'Randomly generated stat card for you!',",
                        "'image': '",
        ...
        string memory finalURI = string(
            abi.encodePacked(initialURI, base64json)
        );
        return finalURI;
    }
    ...
    function getImageURI(uint256 _tokenId) public view returns (string memory) {
        ...
        string memory finalURI = string(
            abi.encodePacked(initialURI, base64Svg)
        );
        return finalURI;
    }
}
