...
contract TokenTransaction is AccessControl, Pausable, Utils {
    ...
    event TokenPay(address indexed operatorAddress, address indexed toAddress, uint256 indexed amount, uint256 eventType, uint256 eventId, uint256 divideAmount);
    ...
    function tokenPay(uint256 amount, uint256 eventType, uint256 eventId, address toAddress, bytes32 hash, bytes memory signature, string memory nonce) public whenNotPaused {
        //验证数据参数合法性
    ...
    function tokenCollect(uint256 amount, address fromAddress, bytes32 hash, bytes memory signature, string memory nonce) public whenNotPaused {
        //验证数据参数合法性
        require(amount > 0, "The amount must more than 0!");
        //验证hash
    ...
    function hashTokenPay(uint256 _amount, uint256 _eventType, uint256 _eventId, address _toAddress, string memory _nonce) private pure returns (bytes32) {
