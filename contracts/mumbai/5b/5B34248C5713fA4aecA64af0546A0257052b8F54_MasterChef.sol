...
contract MasterChef is Ownable {
    ...
    // The parameters are:
    // - _allocPoint: The amount of tokens that will be used to allocate the rewards.
    ...
    function pendingCONE(uint256 _pid, address _user)
        external
        view
        returns (uint256)
    {
    ...
    //Set fee Function
    function setFee(uint256 _pid, uint256 _fee)
        public
        virtual
        onlyOwner
        returns (uint256)
    ...
    // function AffinfoFunction(address _user)
    //     external
    //     view
    //     returns (AffInfo memory)
    // {
