...
contract DegenZonePredictionV2 is  ReentrancyGuard {
    ...
    function claim(uint256 epoch) public nonReentrant notContract{
        ...
        if (ledger[epoch][msg.sender].betType == 1){
            ...
            if (rounds[epoch].closePrice > rounds[epoch].lockPrice ){
                ...
                treasuryReward = reward * treasuryFee / 100;
                NFTreward =  reward * NFTfee / 100;
    ...
    function getRewardAmount(uint256 epoch) public view returns (uint256){
        ...
        if (ledger[epoch][msg.sender].betType == 2){
            ...
            if (rounds[epoch].closePrice > rounds[epoch].lockPrice && rounds[epoch].closePrice <= rounds[epoch].lockPrice + borderAmount ){
            ...
            if (rounds[epoch].closePrice > rounds[epoch].lockPrice + borderAmount && rounds[epoch].closePrice <= rounds[epoch].lockPrice + 2 * borderAmount ){
            ...
            //degenZone wins
            if (rounds[epoch].closePrice > rounds[epoch].lockPrice + 2 * borderAmount){
