...
import "../Store/ERC721StoreChildV2.sol";
    ...
    IProduct
{
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(AccessControlEnumerableUpgradeable, ERC721StoreChildV2)
        returns (bool)
    {
        return
...
contract ERC721StoreChildV2 is
    ContextUpgradeable,
    ERC165Upgradeable,
    IERC721Upgradeable,
    IERC721MetadataUpgradeable
{
    ...
    function __ERC721StoreChild_init(string memory id, IStorage store)
        internal
        onlyInitializing
    {
        _childId = id;
