...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, Ownable {
        ...
        returns (bool)
    {
        ...
        //uint256 value_with_royalty = forSale[tokenId] + (forSale[tokenId] / royalty);
        ...
        payable(seller).transfer(price - (price - forSale[tokenId]));

        //if (msg.value > price) { no refunds with buy_and_send
