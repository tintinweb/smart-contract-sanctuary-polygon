...
// File: contracts/FvfvContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract FvfvContract is RamppERC721A {
    constructor() RamppERC721A("fvfv", "fwr"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/Z6BriTKEVCs8VWPHtMCb/contract-metadata";
    }
}
