...
import "./VizvaLazyNFTCollection.sol";

contract VizvaLazyCollectionClone {
    ...
    constructor() {
        collectionImplementation = address(new VizvaLazyNFTCollection());
    }
        ...
        returns (address)
    {
        ...
        VizvaLazyNFTCollection(clone).__VizvaLazyNFTCollection_init(
            name,
            symbol,
            msg.sender
        );
        emit NewCollectionCreated(clone, msg.sender, name, symbol);
        return clone;
    }
}
...
contract VizvaLazyNFTCollection is
    ...
    PausableUpgradeable
{
    ...
    function __VizvaLazyNFTCollection_init(
        string memory name,
        ...
        __VizvaLazyNFTCollection_init_unchained(owner);
    }

    function __VizvaLazyNFTCollection_init_unchained(address owner)
        internal
        onlyInitializing
    {
    ...
    function redeem(
        ...
        require(
            minter == owner(),
            "unauthorized: Only OWNER is allowed to mint token"
        );
