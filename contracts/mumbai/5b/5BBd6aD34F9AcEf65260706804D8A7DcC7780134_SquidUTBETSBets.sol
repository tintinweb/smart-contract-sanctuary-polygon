...
contract SquidUTBETSBets is SquidBetsCore {
    ...
    IUltiBetsToken public ultibetsToken;
    ...
    function registerOnWarriorEvent(
        ...
        require(
            IUltiBetsSign(ultibetsSign).verify(
                msg.sender,
                _eventID,
                _signature
            ),
    ...
    function transferRegisterFeeToTreasuryAndPrizePool(
        ...
        ultibetsToken.transfer(ultibetsTreasury, amount / 2);
    ...
    function withdrawAllFundWhenEmergency() public override onlyAdmin {
        ultibetsToken.transfer(
            ultibetsTreasury,
            ultibetsToken.balanceOf(address(this))
        );
    }
    ...
    function setUltibetsSign(address _ultibetsSign) public onlyAdmin {
...
contract SquidBetsCore is ISBCNFTType, CustomAdmin {
    ...
    function getWinnerIDs(
        ...
        if (result == VotingResult.Indeterminate && winnersLength == 0) {
            return winnerIDs;
        } 
