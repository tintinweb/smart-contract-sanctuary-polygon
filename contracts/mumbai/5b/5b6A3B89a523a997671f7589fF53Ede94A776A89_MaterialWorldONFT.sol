...
// File: contracts/MaterialWorldONFT-eth.sol
...
contract MaterialWorldONFT is Ownable, ERC721, NonblockingReceiver {
    ...
    function traverseChains(uint16 _chainId, uint256 tokenId, string memory newTokenUri) public payable {
        require(
        ...
        require(
            ...
            "Material World: msg.value not enough to cover messageFee. Send gas for message fees"
        );
