...
contract BoleroManager is AccessControl {
    ...
    IBoleroDeployer public boleroDeployer;
    IBoleroArtist public boleroArtist;
    IBoleroArtistToken public boleroArtistToken;
    IBoleroArtistICO public boleroArtistICO;
    IPaymentSplitter public boleroPaymentSplitter;
    IBoleroMultisig public boleroMultiSig;

    address public boleroDeployerAddress;
     ...
     ** @param implementation Address of the contract to be cloned.
     *******************************************************************************/
    function setBoleroMultisigImplementation(address implementation) public {
    ...
    function newPaymentSplitter(
        ...
        boleroPaymentSplitter = IPaymentSplitter(collectionPaymentAddress);
        boleroPaymentSplitter.initialize(
            address(boleroDeployer),
            _payees,
            _roles,
            _shares
        );
        ...
        boleroPaymentSplitter.setMultisigWallet(collectionMultisigAddress);
    ...
    function setMultisigWallet(address paymentSplitter, address multisigWallet) public onlyRole(MANAGER_ROLE) {
        boleroPaymentSplitter = IPaymentSplitter(paymentSplitter);
        boleroPaymentSplitter.setMultisigWallet(multisigWallet);
    }
