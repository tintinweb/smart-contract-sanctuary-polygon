...
contract LostChainEntityData is CustomERC2771ContextUpgradeable, UUPSUpgradeable {
    ...
    function disableWeapon(uint256 weaponId) public onlyRole('MINTER', _msgSender()) {
        require(weaponEntities[weaponId].exists, 'LCED: Weapon does not exist');
    ...
    function enableWeapon(uint256 weaponId) public onlyRole('MINTER', _msgSender()) {
        require(weaponEntities[weaponId].exists, 'LCED: Weapon does not exist');
    ...
    function disableArmor(uint256 armorId) public onlyRole('MINTER', _msgSender()) {
        require(armorEntites[armorId].exists, 'LCED: Armor does not exist');
    ...
    function enableArmor(uint256 armorId) public onlyRole('MINTER', _msgSender()) {
        require(armorEntites[armorId].exists, 'LCED: Armor does not exist');
