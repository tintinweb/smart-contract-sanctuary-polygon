...
// File: contracts/PayRueERC721.sol
...
contract PayRueERC721 is ERC721Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function setComissionReceiverAddress(address _commissionReceiverAddress)
        public
        onlyOwner
    {
        commissionReceiverAddress = _commissionReceiverAddress;
        ...
        canBuy(_tokenId)
    {
        ...
        require(
            ...
            "PayRueERC721: Inorrect funds amount sent"
        );
        ...
        returns (uint256[] memory)
    {
        ...
        require(_mintAmount == _name.length, "Token name amount not equal");
