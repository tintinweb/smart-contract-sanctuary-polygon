...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x821Ea2f21Ee08C4Daf0fE75edb5F7e58305aF04E];
...
// File: contracts/CmcEp10023Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract CmcEp10023Contract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "CMC Ep100 23";
    string public symbol = "CMCNPM12";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/wSBtszg83A63A6q9cyhw/contract-metadata";
  }
