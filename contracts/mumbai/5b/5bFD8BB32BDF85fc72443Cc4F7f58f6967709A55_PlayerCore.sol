    ...
    Settings
{
    ...
    function draftPlayer(
        ...
        //require draft price to be 1 * 10 ** 18
        ...
        assignToRoster(
            IFantasyLeague(fantasyLeague).seasonId(),
            IFantasyLeague(fantasyLeague).UserToDivision(draft.permit.owner),
            draft.permit.owner,
            draft.tokenId
        );
    ...
    function reservePlayer(
        ...
        emit PlayerReserved(
            IFantasyLeague(fantasyLeague).UserToDivision(reservedPlayer.user),
    ...
    function buyPlayers(uint256[] memory _tokenIds) public {
        uint256 seasonId = IFantasyLeague(fantasyLeague).seasonId();
        require(
    ...
    event SuccessPermit(bool success);

    function tryPermit(PermitSig calldata permitSig)
        external
        virtual
        nonReentrant
{
