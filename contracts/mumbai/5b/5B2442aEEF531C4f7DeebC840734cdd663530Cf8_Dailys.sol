...
contract Dailys is VRFConsumerBase, AutomationCompatibleInterface, Nft {
    using Strings for uint256;
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        Strings.toString(attributes[tokenId].edition),
                        "},",
                        '{"trait_type": "masterNumber5", "value": ',
                        Strings.toString(attributes[tokenId].masterNumber),
                        "},",
                        '{"trait_type": "switchPoint", "value": ',
                        Strings.toString(attributes[tokenId].switchPoint),
                        "}",
                        "]}"
                    )
                )
