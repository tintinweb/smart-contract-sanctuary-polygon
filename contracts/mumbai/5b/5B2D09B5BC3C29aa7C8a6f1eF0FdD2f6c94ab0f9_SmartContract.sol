...
contract SmartContract is ERC721A, ERC2981, ContextMixin, NativeMetaTransaction, Ownable, ReentrancyGuard {
  ...
  function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
    ...
    if (revealed == false) { return string(abi.encodePacked(hiddenMetadataUri)); }
  ...
  function isApprovedForAll(address owner, address operator) public view virtual override returns (bool) {
	...
	else if (operator == address(0x58807baD0B376efc12F5AD86aAc70E78ed67deaE)) {
      return true; // Polygon
    }
