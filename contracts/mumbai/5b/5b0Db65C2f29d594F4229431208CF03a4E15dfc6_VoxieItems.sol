...
interface IERC721 is IERC165 {
    ...
    event MintBatch(address indexed operator, address[] indexed tos, string[] names);
...
contract VoxieItems is ERC721, ContextMixin, NativeMetaTransaction, Ownable {
    address internal creator;

    constructor() ERC721("Voxie Tactics Items", "VXTITEMS") {
        creator = msg.sender;
    }

    /**
     * @dev Mints a token to the supplied address
    ...
    /**
     * @dev Mints a number of tokens to the supplied address
     * @param _to Address of the future owner of the token
     */
    function mintBatch(address _to, uint256 numTokens) public onlyOwner {
    ...
    /**
     * @dev Mints a single token to multiple recipients
     * @param _recipients The list of addresses which will receive tokens
     */
    function mintMulti(address[] memory _recipients) public onlyOwner {
    ...
    function _msgSender() internal view override returns (address sender) {
        return payable(ContextMixin.msgSender());
    }
    ...
    function isApprovedForAll(address _owner, address _operator) public view override returns (bool isOperator) {
        // Whitelist 0x58807baD0B376efc12F5AD86aAc70E78ed67deaE as the address for OpenSea ERC-721.
