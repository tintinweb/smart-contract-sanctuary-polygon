...
import "../generated/impl/BaseCedarERC721DropV4.sol";
    ...
    BaseCedarERC721DropV4
{
    ...
    using CedarDropERC721ClaimLogicV0 for DropERC721DataTypes.ClaimData;
    ...
    function supportsInterface(bytes4 interfaceId)
        public
        view
        override(BaseCedarERC721DropV4, ERC721EnumerableUpgradeable, AccessControlEnumerableUpgradeable)
        returns (bool)
    {
        return
            BaseCedarERC721DropV4.supportsInterface(interfaceId) ||
    ...
    function claim(
        ...
        (
            ...
            CedarDropERC721ClaimLogicV0.InternalClaim memory internalClaim
        ) = CedarDropERC721ClaimLogicV0.executeClaim(
                claimData,
                _quantity,
                _currency,
                _pricePerToken,
    ...
    function verifyClaimMerkleProof(
        ...
        return
            CedarDropERC721ClaimLogicV0.verifyClaimMerkleProof(
                claimData,
                _conditionId,
                _claimer,
                _quantity,
    ...
    function verifyClaim(
        ...
        CedarDropERC721ClaimLogicV0.verifyClaim(
            claimData,
            _conditionId,
            _claimer,
            _quantity,
    ...
    function setMaxTotalSupply(uint256 _maxTotalSupply) external onlyRole(DEFAULT_ADMIN_ROLE) {
        if (!(_maxTotalSupply < claimData.nextTokenIdToMint)) revert CrossedLimitMinTokenIdGreaterThanMaxTotalSupply();
    ...
    function setContractURI(string calldata _uri)
        external
        override(ICedarMetadataV0, IThirdwebContract)
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        contractURI = _uri;
    }
...
// Filename: './BaseCedarERC721DropV4.sol'
...
abstract contract BaseCedarERC721DropV4 is ICedarERC721DropV4 {
    ...
    function supportsInterface(bytes4 interfaceID) virtual override public view returns (bool) {
        return (interfaceID == type(IERC165Upgradeable).interfaceId) || ((interfaceID == type(ICedarFeaturesV0).interfaceId) || ((interfaceID == type(ICedarVersionedV0).interfaceId) || ((interfaceID == type(IMulticallableV0).interfaceId) || ((interfaceID == type(ICedarAgreementV0).interfaceId) || ((interfaceID == type(ICedarNFTIssuanceV1).interfaceId) || ((interfaceID == type(ICedarLazyMintV0).interfaceId) || ((interfaceID == type(IERC721V0).interfaceId) || ((interfaceID == type(IRoyaltyV0).interfaceId) || ((interfaceID == type(ICedarUpdateBaseURIV0).interfaceId) || ((interfaceID == type(ICedarNFTMetadataV1).interfaceId) || ((interfaceID == type(ICedarMetadataV0).interfaceId) || (interfaceID == type(IPrimarySaleV0).interfaceId))))))))))));
    }
