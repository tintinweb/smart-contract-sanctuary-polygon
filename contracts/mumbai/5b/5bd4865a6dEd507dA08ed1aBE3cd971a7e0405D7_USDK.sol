...
contract USDK is IUSDK, ERC20, Ownable {   
    ...
    */
    ...
    /**
    * mints $USDK to a recipient
    * @param to the recipient of the $USDK
    * @param amount the amount of $USDK to mint
    */
    ...
    /**
    * burns $USDK from a holder
    * @param from the holder of the $USDK
    * @param amount the amount of $USDK to burn
    */
    ...
    */
    function transferFrom(
        ...
        address recipient,
        uint256 amount
    ) public virtual override(ERC20, IUSDK) disallowIfStateIsChanging returns (bool) {
        ...
        // For instance, someone can't just make a contract and siphon $USDK from every account
