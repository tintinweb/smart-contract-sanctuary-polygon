...
contract NEKOStaking_MOCK {
    ...
    mapping(address => bool) public isAAVEUnderlying;
    mapping(address => bool) public isAAVEToken;
    mapping(address => address) public aaveUnderlyingToAToken;
    mapping(address => address) public aaveATokenToUnderlying;

    address immutable public AAVEPoolAddress;
    mapping(address => mapping(address => uint256)) public userBalances;

    address immutable public foundationAddress;
