...
contract ERC721OpenSea is ERC721, ContextMixin, NativeMetaTransaction {
    ...
    */
    function isApprovedForAll(
        ...
        if (_operator == address(0x58807baD0B376efc12F5AD86aAc70E78ed67deaE) || _operator == address(0xff7Ca10aF37178BdD056628eF42fD7F799fAc77c)) {
            return true;
        }
