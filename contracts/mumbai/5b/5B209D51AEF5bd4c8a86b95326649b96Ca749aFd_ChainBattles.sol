...
contract ChainBattles is ERC721URIStorage {
    ...
    // The mapping will link the NFTId to the level of the NFT.
    ...
    function generateCharacter(uint256 tokenId) public returns (string memory) {
        ...
        // The SVG code takes the return value of a getLevels() function and
        // use it to populate the "Levels:" property.
