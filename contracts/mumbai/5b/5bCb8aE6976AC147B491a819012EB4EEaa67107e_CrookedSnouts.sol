...
contract CrookedSnouts is VRFConsumerBaseV2, ERC721URIStorage {
  ...
  function create() public {
    ...
    randomNumbers memory usersRandomNumbers = requestIdToRandomNumbers[addressToRequestStruct[msg.sender].requestId];
    ...
    string memory svg = string(
      abi.encodePacked(
        ...
        generateBackground.generateBackground(2),
        generateFace.generateFace(8),
        generateEyes.generateEyes(11),
        generateHead.generateHead(1),
        generateMouth.generateMouth(1),
        generateNose.generateNose(7),
        '</svg>'
      )
    );
