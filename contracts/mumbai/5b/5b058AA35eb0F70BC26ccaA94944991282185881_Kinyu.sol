...
contract Kinyu is IERC20, IERC20Metadata {
    ...
    string _name;
    string _symbol;
    uint128 _totalSuppliedShares;
    uint128 _totalBorrowedShares;
    ...
    function totalSupply() external view override returns (uint) {
        return uint(_sharesToBaseTokens(int128(_totalSuppliedShares)));
    }
    ...
    function _supplyBaseToken(
        ...
        int128 existingShares = _userShares[destination];
        int existingBaseTokens = _sharesToBaseTokens(existingShares);
        ...
        _userShares[destination] = updatedShares;
        _totalBorrowedShares -= repayShares;
        _totalSuppliedShares += supplyShares;
