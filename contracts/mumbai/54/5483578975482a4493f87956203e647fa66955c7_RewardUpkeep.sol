...
contract RewardUpkeep is KeeperCompatibleInterface, Ownable {
    ...
    address public immutable liquidityOps;
    ...
    constructor(
        ...
        fxs = _fxs;
        temple = _temple;
        lastTimeStamp[fxs] = block.timestamp;
        lastTimeStamp[temple] = block.timestamp;
    }
