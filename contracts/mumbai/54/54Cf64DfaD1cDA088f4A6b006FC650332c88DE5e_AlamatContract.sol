...
contract AlamatContract is ERC721, EIP712Base, ERC2981, AccessControl, Pausable, Ownable {
  ...
  function verifyMintSig(
    ...
    require(block.timestamp <= deadline, "Alamat: INVALID_DEADLINE");
    ...
    require(hasRole(MINTER_ROLE, signer), "Alamat: INVALID_SIGNATURE");
  }
  ...
  function removeAllowedTokenForTransfer(uint index, address tokenAddress) external onlyRole(DEFAULT_ADMIN_ROLE) {
      require(_allowedTokensList[index] == tokenAddress, 'Alamat: TOKEN_INDEX_ADDRESS_MISMATCH');
  ...
  function _verifyTokenForTransfer(address tokenAddress) internal view {
      require(_allowedTokensForTransfer[tokenAddress], "Alamat: TOKEN_NOT_ALLOWED");
  }
