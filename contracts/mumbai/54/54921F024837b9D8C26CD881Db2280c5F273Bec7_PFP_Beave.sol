...
contract PFP_Beave is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
    uint256 public MAX_SUPPLY = 69;

    
    uint256 public WHITELIST_SUPPLY = 10;
    uint256 public PUBLIC_SUPPLY = 58;
    ...
    uint256 public WHITELIST_PRICE = 0.69 ether;
    uint256 public PUBLIC_PRICE = 0.69 ether;
    ...
    string private preRevealURI = "https://ipfs.w3bmint.xyz/ipfs/QmepnVcJLmbaVgZ7Uo52t7SYYYLB6k12cN8PHaiuaFghdF";
    ...
    constructor(
        bytes32 _Whitelist) ERC721A("PFP_Beave", "BEAVER") {
        
        WHITELIST_ROOT = _Whitelist;
        
        _safeMint(0x97AbCa148Db031A36d445b7C3BbED15dbBc21cCa, 1);
    }
