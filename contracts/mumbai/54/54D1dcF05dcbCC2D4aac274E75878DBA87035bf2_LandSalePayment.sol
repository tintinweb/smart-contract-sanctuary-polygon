...
contract LandSalePayment is Ownable, ReentrancyGuard{
    ...
    struct slotDetails{
        uint256 startTime;
        uint256 endTime;
        mapping (string => uint256) slotSupply;
    }
    ...
    event newSlotAdded(uint256 slot, uint256 startTime, uint256 endTime, string[] category, uint256[] slotSupply);
    ...
    event categoryAvailabilityInSlotUpdated(string category, uint256 slot, uint256 slotSupply);
    ...
    constructor(address _FTaddress, address _NFTaddress, string[] memory _category,bool[] memory _slotDependency, uint256[] memory _priceInUSD, uint256[] memory _maxCategorySupply/*, uint256[] memory _slot, uint256[] memory _startTime, uint256[] memory _endTime, uint256[][] memory _slotSupply*/){
        ...
        //     addNewSlot(_slot[index], _startTime[index], _endTime[index], _categoryArr, _slotSupply[index]);
        // }
    ...
    function set() internal {
        ...
        slot[1].slotSupply["SMALL"] = 0;
        slot[2].slotSupply["SMALL"] = 0;
        slot[3].slotSupply["SMALL"] = 0;
        slot[4].slotSupply["SMALL"] = 0;
        slot[5].slotSupply["SMALL"] = 16;
        slot[6].slotSupply["SMALL"] = 16;
        slot[7].slotSupply["SMALL"] = 16;
        slot[8].slotSupply["SMALL"] = 16;
        slot[9].slotSupply["SMALL"] = 16;
        slot[10].slotSupply["SMALL"] = 16;
        slot[11].slotSupply["SMALL"] = 16;
        slot[12].slotSupply["SMALL"] = 16;
        slot[13].slotSupply["SMALL"] = 16;
        slot[14].slotSupply["SMALL"] = 16;
        slot[15].slotSupply["SMALL"] = 16;
        slot[16].slotSupply["SMALL"] = 16;

       
        slot[1].slotSupply["MEDIUM"] = 0;
        slot[2].slotSupply["MEDIUM"] = 0;
        slot[3].slotSupply["MEDIUM"] = 0;
        slot[4].slotSupply["MEDIUM"] = 0;
        slot[5].slotSupply["MEDIUM"] = 0;
        slot[6].slotSupply["MEDIUM"] = 0;
        slot[7].slotSupply["MEDIUM"] = 0;
        slot[8].slotSupply["MEDIUM"] = 0;
        slot[9].slotSupply["MEDIUM"] = 16;
        slot[10].slotSupply["MEDIUM"] = 16;
        slot[11].slotSupply["MEDIUM"] = 16;
        slot[12].slotSupply["MEDIUM"] = 16;
        slot[13].slotSupply["MEDIUM"] = 16;
        slot[14].slotSupply["MEDIUM"] = 16;
        slot[15].slotSupply["MEDIUM"] = 16;
        slot[16].slotSupply["MEDIUM"] = 16;
        
        
        slot[1].slotSupply["LARGE"] = 16;
        slot[2].slotSupply["LARGE"] = 16;
        slot[3].slotSupply["LARGE"] = 16;
        slot[4].slotSupply["LARGE"] = 16;
        slot[5].slotSupply["LARGE"] = 16;
        slot[6].slotSupply["LARGE"] = 16;
        slot[7].slotSupply["LARGE"] = 16;
        slot[8].slotSupply["LARGE"] = 16;
        slot[9].slotSupply["LARGE"] = 16;
        slot[10].slotSupply["LARGE"] = 16;
        slot[11].slotSupply["LARGE"] = 16;
        slot[12].slotSupply["LARGE"] = 16;
        slot[13].slotSupply["LARGE"] = 16;
        slot[14].slotSupply["LARGE"] = 16;
        slot[15].slotSupply["LARGE"] = 16;
        slot[16].slotSupply["LARGE"] = 16;

        
        slot[1].slotSupply["CONDO"] = 16;
        slot[2].slotSupply["CONDO"] = 16;
        slot[3].slotSupply["CONDO"] = 16;
        slot[4].slotSupply["CONDO"] = 16;
        slot[5].slotSupply["CONDO"] = 16;
        slot[6].slotSupply["CONDO"] = 16;
        slot[7].slotSupply["CONDO"] = 16;
        slot[8].slotSupply["CONDO"] = 16;
        slot[9].slotSupply["CONDO"] = 16;
        slot[10].slotSupply["CONDO"] = 16;
        slot[11].slotSupply["CONDO"] = 16;
        slot[12].slotSupply["CONDO"] = 16;
        slot[13].slotSupply["CONDO"] = 16;
        slot[14].slotSupply["CONDO"] = 16;
        slot[15].slotSupply["CONDO"] = 16;
        slot[16].slotSupply["CONDO"] = 16;

        
        slot[1].slotSupply["GIGA"] = 16;
        slot[2].slotSupply["GIGA"] = 16;
        slot[3].slotSupply["GIGA"] = 16;
        slot[4].slotSupply["GIGA"] = 16;
        slot[5].slotSupply["GIGA"] = 16;
        slot[6].slotSupply["GIGA"] = 16;
        slot[7].slotSupply["GIGA"] = 16;
        slot[8].slotSupply["GIGA"] = 16;
        slot[9].slotSupply["GIGA"] = 16;
        slot[10].slotSupply["GIGA"] = 16;
        slot[11].slotSupply["GIGA"] = 16;
        slot[12].slotSupply["GIGA"] = 16;
        slot[13].slotSupply["GIGA"] = 16;
        slot[14].slotSupply["GIGA"] = 16;
        slot[15].slotSupply["GIGA"] = 16;
        slot[16].slotSupply["GIGA"] = 16;
    }
    ...
    function buyLandWithTVK(uint256 _slot, string memory _category, uint256 _tokenId, bytes32 _hash, bytes memory _signature) public {
        ...
        slotCheck(_slot,_category, _tokenId);
    ...
    function adminMint(uint256 _slot, uint256 _tokenId, string memory _category, bytes32 _hash, bytes memory _signature) public onlyOwner {
        require(block.timestamp >= slot[1].startTime,"LandSale: Sale not started yet.");
        require(landCategory[_category].status,"Invalid caetgory.");
        require(recover(_hash,_signature) == adminAddress,"Invalid signature.");
        require(!signature[_signature],"Signature already used!");
    ...
    function slotCheck(uint256 _slot, string memory _category, uint256 _tokenId) internal {
        ...
        if(landCategory[_category].slotIndependent){
            ...
            require(slot[_slot].slotSupply[_category] > 0,"Landsale: This land category cannot be bought in this slot");
    ...
    function addNewSlot(uint256 _slot, uint256 _startTime, uint256 _endTime, string[] memory _category, uint256[] memory _slotSupply) public onlyOwner{
        ...
        // require(_category.length == _slotSupply.length,"invalid length of category and status");

        slot[_slot].startTime = _startTime;
        slot[_slot].endTime = _endTime;

        for(uint index=0; index<_category.length; index++){
            slot[_slot].slotSupply[_category[index]] = _slotSupply[index];
        }
        slotCount++;
    ...
    function updateCategorySupplyInSlot(string memory _category,uint256 _slot, uint256 _slotSupply) public onlyOwner{
        ...
        slot[_slot].slotSupply[_category] = _slotSupply;
    ...
    function getCategorySupplyBySlot(string memory _category, uint256 _slot) public view returns(uint256 _slotSupply){
        _slotSupply = slot[_slot].slotSupply[_category];
    }
