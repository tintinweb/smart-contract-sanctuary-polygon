 ...
 * @notice This contract handles minting Skeeboo Fragments #1 tokens.
 */
contract SkeebooFragments1 is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address public royaltyAddress = 0x98dE8Db421c0822393DC9197dCA5aBa7EFAE0814;
    ...
    string public baseTokenURI =
        "ipfs://bafybeibm2sf7sdhuza2sqlcqmgipyznwbbp6rp6qlfq6pdzmet6lbjbnta/";
    // Maximum supply of tokens that can be minted
    uint256 public MAX_SUPPLY = 250;
    uint256 public publicMintsAllowedPerAddress = 250;
    uint256 public publicMintsAllowedPerTransaction = 250;
    ...
    constructor(address _blocklistContractAddress)
        ERC721A("Skeeboo Fragments #1", "SKFRG01")
    {
