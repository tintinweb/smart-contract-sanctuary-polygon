    ...
    OwnableUpgradeable
{
    ...
    */
    ...
    {
        counter.add(1);
        currentUserEpoch[msg.sender].add(1);
    ...
    function _startRound(address user, uint256 epoch) internal virtual{
        ...
        emit StartRound(user, epoch, block.timestamp);
    }
    ...
    function _endRound(address user, uint256 epoch, uint8 winningNum) internal virtual{
        ...
        emit EndRound(user, epoch, block.timestamp, winningNum);
    }
        ...
        nonReentrant
    {
        ...
        emit Bets(bets, user, currentUserEpoch[user], round.totalAmountBet);
    }
        ...
        returns (bool, uint256) 
    {
        ...
        return
            ((rounds[user][epoch].oracleCalled && winAmount > 0), winAmount);
    }
