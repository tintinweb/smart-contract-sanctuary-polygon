...
contract SampleContractHook is Initializable, PausableUpgradeable, OwnableUpgradeable, ERC20Upgradeable {
    ...
    // To whitelist the setup of the contract hook
    address public KuthuluUserProfilesContract;
    ...
    function initialize(address _kuthulu, address _kuthuluUP, address _kutils,  address _doom) initializer public {
        __Pausable_init();
        __Ownable_init();
        ...
        // KUTHULU User Profiles for initial setup
        KuthuluUserProfilesContract = _kuthuluUP;
    ...
    */
    ...
    function updateContracts(address _kuthulu, address _kuthuluUP, address _kutils, address _doom) public onlyAdmins {
        ...
        // Update the KUTHULU UserProfile Contract Address
        KuthuluUserProfilesContract = _kuthuluUP;
    }
    ...
    function KuthuluHook(MsgData memory newMsg) public returns (bool) {

        require(msg.sender == KuthuluContract || msg.sender == KuthuluUserProfilesContract, "Only accept calls from KUTHULU");
...
//            console.log("<<<< End Contract Hook");
    ...
    */
    function toggleLike(uint256 msgID) public {
...
//        console.log("> Posting Test Message");
        ...
        // Set URI
        string memory uri = "https://www.KryptoSucks.com";
