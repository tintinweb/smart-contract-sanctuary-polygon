...
// import "@thirdweb-dev/openzeppelin-presets/metatx/ERC2771ContextUpgradeable.sol";

// LIB
import "@thirdweb-dev/contracts/lib/CurrencyTransferLib.sol";

contract SonicaERC721DropBase is
    ERC721Base,
    Drop,
    ...
    LazyMint
{
    /// @dev Wallet from deployer Contract
    ...
    /// @dev Only SONICA_ADMIN_ROLE wallet has specific permissions on contract.
    bytes32 private constant SONICA_ADMIN_ROLE = keccak256("SONICA_ADMIN_ROLE");

    /// @dev Sonica Wallet.
    address public sonicaWallet;
    ...
    constructor(
        ...
        sonicaWallet = _sonicaWallet;
        _setupRole(DEFAULT_ADMIN_ROLE, deployer);
        _setupRole(SONICA_ADMIN_ROLE, sonicaWallet);
    }
    ...
    /// @dev Valid who can change the Claim Conditions.
    ...
    /// @dev Valid who can change the Primary Recipient.
    ...
    /// @dev Valid who can change the Lazy Mint.
    function _canLazyMint() internal view virtual override returns (bool) {
        return hasRole(DEFAULT_ADMIN_ROLE, msg.sender);
    }

    /// @dev Valid who can change the Platform Fee.
    function _canSetPlatformFeeInfo()
        ...
        returns (bool)
    {
        return hasRole(SONICA_ADMIN_ROLE, msg.sender);
    }
}