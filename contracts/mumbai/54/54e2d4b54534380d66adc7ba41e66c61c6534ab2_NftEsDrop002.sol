...
using Address for address;
    ...
    function setStatusMintFeeMaxMintsMaxNFTsDiscountPercentageAndTimer(bool mintStatus, uint8 maxMints, uint16 maxNFTs, uint8 DiscountPercentage,uint32 endTime) external onlyOwner {
        //_mintFees = mintFee;
    ...
    function getStatusMintFeeMaxMintsDiscountPercentageAndTimer()
        external
        view
        onlyOwner
        returns (bool,uint256,uint256, uint8,uint32)
    {
        return (isPaused, _mintFees, _maxMints, _DiscountPercentage, _mintEndTime);
    }
