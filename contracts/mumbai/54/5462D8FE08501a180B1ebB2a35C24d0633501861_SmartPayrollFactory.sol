...
contract SmartPayrollFactory {
    ...
    function createKeeper(address _keeperRegistar,RegistrationParams calldata _params) external returns(uint256 keeperID){
       KeeperRegistrarInterface regustrar = KeeperRegistrarInterface(_keeperRegistar);
       keeperID = regustrar.registerAndPredictID(_params);
