...
contract AllowanceTransfer is IAllowanceTransfer, EIP712 {
    ...
    function permit1(
        ...
        console.logBytes32(permitSingle.hash());
        console.log(
            "this is encodedd in scontracrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr"
        );
        if (block.timestamp > permitSingle.sigDeadline)
            revert SignatureExpired(permitSingle.sigDeadline);
        console.log("1", permitSingle.spender);

        // Verify the signer address from the signature.
        signature.verify(_hashTypedData(permitSingle.hash()), owner);
        console.log("1.5", permitSingle.spender);

        _updateApproval(permitSingle.details, owner, permitSingle.spender);
        console.log("2", permitSingle.spender);
    }
...
library SignatureVerification {
    ...
    function verify(
        ...
        if (claimedSigner.code.length == 0) {
            ...
            console.log(signer, "this is sigmer is verifurer");
...
contract SignatureTransfer is ISignatureTransfer, EIP712 {
    ...
    function permitTransferFrom1(
        ...
        // console.logBytes32(permit.hash());
        // console.log(
        //     "this is encodedd in scontracrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr"
        // );
        _permitTransferFrom(
