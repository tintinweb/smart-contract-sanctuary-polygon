...
contract LifeIsAnIllusion is ERC1155, IERC2981, Ownable, ContextMixin {
    ...
    function mintBatch(
        ...
        string[] memory image,
        string[] memory description,
        string[] memory comressedBase64Image
    ) public onlyOwner {
        ...
        for (uint i = 1; i <= ids.length; i++) {
            ...
            pieces[i].comressedBase64Image = comressedBase64Image[i - 1];
    ...
    function contractURI() public pure returns (string memory) {
        bytes memory dataURI = abi.encodePacked(
            ...
            '"name": "Life is an illusion",',
            '"symbol": "ILLUSION",',
            '"description": "Life is an illusion: this is a unique collection of 42 impressionist photos from different parts of the world dedicated to Anna`s father. \nMetadata and compressed images stored on-chain, original photos stored on IPFS. \n\nLife is an illusion \nA strange game of half-slumber \nIt seems to me that \nEverything is about to collapse \nI love you \nThe sun",',
