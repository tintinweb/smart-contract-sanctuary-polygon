...
contract GelatoPineCore is PineCore {
    ...
    constructor(address _FEE_TOKEN_ADDRESS, address owner, address _WRAPPED_NATIVE, address _GELATO_OPS) PineCore(_FEE_TOKEN_ADDRESS, owner, _WRAPPED_NATIVE, _GELATO_OPS) {}
}
