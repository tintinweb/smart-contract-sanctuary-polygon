...
contract RandomNumberConsumerV2 is VRFConsumerBaseV2 {
    ...
    bytes32 immutable i_keyHash = 0x79d3d8832d904592c0bf9818b621522c988bb8b0c05cdc3b15aea1b6e8db0c15;
    ...
    /**
     * @notice Constructor inherits from VRFConsumerBaseV2
     *
    ...
    function requestRandomWords() public onlyOwner returns (uint256 s_requestId) {
        ...
        lastRequestId = s_requestId;
        emit RequestSent(s_requestId, NUM_WORDS);
        return s_requestId; // requestID is a uint.
    }
    ...
    function fulfillRandomWords(
        ...
        require(s_requests[s_requestId].exists, "request not found");
        s_requests[s_requestId].fulfilled = true;
        s_requests[s_requestId].randomWords = _randomWords;
    ...
    function getRequestStatus(
        ...
        require(s_requests[s_requestId].exists, "request not found");
        RequestStatus memory request = s_requests[s_requestId];
