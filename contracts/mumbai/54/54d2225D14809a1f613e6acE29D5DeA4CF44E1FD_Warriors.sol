...
contract Warriors is ERC1155, IERC2981, Ownable, ContextMixin {
    uint256 public constant CONAN = 0;
    uint256 public constant SNAKE = 1;
    uint256 public constant KRATOS = 2;
    ...
    constructor() ERC1155("ipfs://bafybeibuomg5b7njbztehoimeat4doh3g47htenbqz7mw4q53xfudummo4/{id}.json") {
        _mint(msg.sender, CONAN, 1, "");
        _mint(msg.sender, SNAKE, 1, "");
        _mint(msg.sender, KRATOS, 1, "");
