...
//  /_  __/__  _____/ /_   / __ \(_)________  ____     /   |
//   / / / _ \/ ___/ __/  / /_/ / / ___/ __ \/_  /    / /| |
//  / / /  __(__  ) /_   / ____/ / /__/ /_/ / / /_   / ___ |
// /_/  \___/____/\__/  /_/   /_/\___/\____/ /___/  /_/  |_|
//                                                          
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x82E9cA923191119f08F1c3fDa2F9B0bEb7Cf7B30];
  address public erc20Payable = 0x82E9cA923191119f08F1c3fDa2F9B0bEb7Cf7B30;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeicemnckgm4fchdkryt5jpbh24cnbaazdv4rp7ef234q2devos543a/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/lZ2PGBcuLpiDSpslRNb7/contract-metadata";
  }
...
// File: contracts/TestPicozAContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TestPicozAContract is RamppERC721A {
    constructor() RamppERC721A("Test Picoz A", "TPCOA"){}
}
