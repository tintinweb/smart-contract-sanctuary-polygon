...
contract Factory is IFactory, IOwnable {
    ...
    mapping(ITangibleNFT => bool) public override onlyWhitelistedForUnmintedCategory;
    ...
    function setRequireWhitelistCategory(ITangibleNFT nft, bool required) external onlyOwner {
    ...
    function takeFtnftForReemburse(ITangibleFractionsNFT ftnft, uint256 fractionId) external{
        require(msg.sender == initReSeller, "NA");
        ftnft.safeTransferFrom(ftnft.ownerOf(fractionId), initReSeller, fractionId);
    }
