...
contract Lottery is VRFConsumerBaseV2, ILottery, Roles {
    ...
    struct UserAccount {
        bytes32 code; // recommender code
        uint expend; // accumulated expenses
        uint award; // award
        uint agencyIncome; // agency income
        uint accAward; // accumulated award
        uint accAgencyIncome; // accumulated agency income
        uint accSharesIncome; // accumulated burn shares income
        bool topAgent; // is top agency
        address[] recommenders; // 4th level relationship address
    }
    ...
    uint8 decimals = 6; // usdt decimals
    address public constant OFFICIAL_AGENCY = address(1989); // official recommender address

    uint private ONE_UINTS = 1 * 10 ** decimals; // 1 usdt = 1000000
    uint private ONCE_PRICE = 2 * 10 ** decimals; // single draw price (usdt)
    uint private TEN_PRICE = 10 * ONCE_PRICE; // ten draws price (usdt)

    uint public SHARES_SLOT_ID = 100; // SFT slot ID
    ...
    /**
     * @notice withdraw award
     * @param _value award amount
     */
    ...
    /**
     * @notice withdraw agency income
     * @param _value agency income amount
     */
    ...
    /**
     * @notice Apply to create your own recommender code
     * @param _code recommender code
     */
    ...
    /**
     * @notice owner set Arithmetic contract
     * @param _address contract address
     */
    ...
    /**
     * @notice owner set Agency contract
     * @param _address contract address
     */
    ...
    /**
     * @notice owner instill base pool
    ...
    /**
     * @notice owner withdraw base pool. Withdraw the deposit that was injected into the pool for the first time.
     * Transfer the money in spcialPool and the excess money in totalPool to sharesPool.
     */
    ...
    /**
     * @notice owner withdraw gain pool
     */
    ...
    /**
     * @notice manager send whitelist
     * @param _players player address
     * @param _amounts whitelist quota
     */
    ...
    /**
     * @notice manager set user whitelist(recommender) code
     * @param _agency user address
     * @param _code recommender code
     */
    ...
    /**
     * @notice manager set Official recommender code and whitelist quota
     * OFFICIAL_AGENCY address: address(1989)
     * @param _code recommender code
     * @param _value whitelist quota
     */
    ...
    /**
     * @notice manager receives the whitelist quota for the player through the recommender code
    ...
    /**
     * @notice manager receives the official whitelist quota for the player, 
     * and binds the player to the reocommender code player
     * @param _to player address
     * @param _code recommender code
     */
    ...
    /**
     * @notice manager force players to bind relationships through recommender codes
    ...
    /**
     * @notice manager modify presale status
     * @param _off switch 
     */
    ...
    /**
     * @notice manager modify pause status
     * @param _off switch 
     */
    ...
    /**
     * @notice manager distributes the idlepool income.
     * Requires agency income to reach more than 100 usdt
     * @param _player player address
     * @param _value  allocated amount
     */
