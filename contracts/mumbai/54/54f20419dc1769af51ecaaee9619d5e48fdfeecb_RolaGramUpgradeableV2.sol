...
import "./RolaGramUpgradeable.sol";
import "./IRolaGramUpgradeableV2.sol";
import "@openzeppelin/contracts-upgradeable/token/common/ERC2981Upgradeable.sol";

contract RolaGramUpgradeableV2 is RolaGramUpgradeable, IRolaGramUpgradeableV2, ERC2981Upgradeable {
    ...
    function endMintRolaGram(address account, string memory tokenUri) external payable override(IRolaGramUpgradeableV2) onlyMaintainer whenNotPaused nonReentrant whenNotBlackListedUser(account) {
    ...
    function setRoyaltyRola(uint96 _royaltyFeesInBips) external onlyOwner {
...
contract RolaGramUpgradeable is ERC721Upgradeable, PausableUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable, BlackListUpgradeable, IRolaGramUpgradeable {
    ...
    // Index counter for the next NFT ID's
    CountersUpgradeable.Counter internal nextTokenIndex;
...
interface IRolaGramUpgradeableV2 { 

    /**
     * @dev End the mint ROLAGRAM NFT process by minting ROLAGRAM NFT
     */
    function endMintRolaGram(address account, string memory tokenUri) external payable;
