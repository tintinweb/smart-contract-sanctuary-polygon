...
contract XslapX is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;

  uint256 public currentSupply = 0;
  
  string public baseURI = "https://ipfs.io/ipfs/Qmek3JX1gV2pJfifLMM6tFaaqBbVeMGSyeJZoKQtsCUZ7L/";
      ...
      payable
  {
      ...
      if (msg.sender != owner()) {  
        require( msg.value >= 0.0013 ether);
