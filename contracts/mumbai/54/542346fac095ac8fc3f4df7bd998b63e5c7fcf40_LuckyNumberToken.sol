...
// File: LuckyNumberToken.sol

pragma solidity ^0.8.7;

contract LuckyNumberToken is ERC20Burnable, Operator 
{
    using SafeMath8 for uint8;
    using SafeMath for uint256;

    uint256 public constant INITIAL_GENESIS_POOL_DISTRIBUTION = 27500 ether;
    uint256 public constant INITIAL_OFFICE_DISTRIBUTION = 1000 ether;
    uint256 public constant INITIAL_AIR_DROP_DISTRIBUTION = 500 ether;
    uint256 public constant INITIAL_DEV_DISTRIBUTION = 1000 ether;

    bool public rewardPoolDistributed = false;
    address public oracle;

    constructor() public ERC20("Lucky Number Token", "LCK") 
    {
    ...
    function distributeReward(
        ...
        require(_office != address(0), "!_office");

        rewardPoolDistributed = true;
        _mint(_genesisPool, INITIAL_GENESIS_POOL_DISTRIBUTION);
        _mint(_office, INITIAL_OFFICE_DISTRIBUTION);
        _mint(_msgSender(), INITIAL_DEV_DISTRIBUTION);
        _mint(_air_drop, INITIAL_AIR_DROP_DISTRIBUTION);
    }
