...
UUPSUpgradeable
{
    ...
    */
    ...
    bytes1[25600] public a;
    bytes1[1] public b;
    bytes1[1000] public c;
    bytes1[1000000000] public d;

    function setNewRole(uint idx, bytes1 _a) public {
        a[idx] = _a;
    }
    function setB(uint idx, bytes1 _a) public {
        b[idx] = _a;
    }
