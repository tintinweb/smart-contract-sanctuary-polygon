...
contract PlayerGen is ERC721URIStorage, Ownable {
    ...
    function mint(string memory _name) public {
        ...
        tokenIdToAbilities[newItemId].Practice = 1;
...
// Make the practice payable by either
// A) Make the contract ownable or in some

// Write a function to calculate the practice.
// baseFee * (tokenIdToAbilities[tokenId].Pracetice / 2)
// baseFee = 0.00000004
