...
contract KindeckFluidManager is Ownable, IERC777Recipient {
    ...
    /**
     * @notice add or remove operator capabilities for operator
     * @param _operator - address to add or remove permissions for
     * @param _allowed - bool to set allowed
     */
