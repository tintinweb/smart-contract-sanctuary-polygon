    ...
    ERC721AUpgradeable
{
    ...
    function mintTo(
        ...
        verifyMint(_salesPhaseId, recipient, amount, _pricePerToken, proof, _quantityLimitPerWallet);
        ...
        _mintTo(recipient, _salesPhaseId, amount);

        emit TokensMinted(_salesPhaseId, _msgSender(), recipient, tokenIdToMint, amount);
    }
...
interface INFTCollection is IERC721AUpgradeable, INFTSalesPhase {
     ...
     *  @param proof                         The proof of the minter's inclusion in the merkle root allowlist
