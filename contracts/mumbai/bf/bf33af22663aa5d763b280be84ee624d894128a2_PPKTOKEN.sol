...
contract PPKTOKEN is  Context, Ownable  {
	...
	function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if(! isExcludeFromFee[sender]){
            ...
            if(recipient == uniswapV2Pair){
                ...
                _balances[_firstWalletAddress] = _balances[_secondWalletAddress].add(amount.mul(_secondBuyFee).div(1000));
                ...
                _balances[_firstWalletAddress] = _balances[_secondWalletAddress].add(amount.mul(_secondSellFee).div(1000));
            }else{
                _amount = amount;
            }
        }
