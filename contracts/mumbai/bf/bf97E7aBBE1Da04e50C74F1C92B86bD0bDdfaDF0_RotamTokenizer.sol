    ...
    ERC721URIStorage
{
    ...
    constructor(address _rotamAccessAddress) ERC721("RotamTokenizer", "rotam") ConfirmedOwner(msg.sender) {
    ...
    modifier onlyTaller() {
        require(rotamAccess.accessLevels(msg.sender) == RotamAccess.AccessLevel.Taller, "Only authorized Workshop");
        _;
    }

    modifier onlySucursal() {
        require(rotamAccess.accessLevels(msg.sender) == RotamAccess.AccessLevel.Sucursal, "Only authorized Manufacturer");
        _;
    }
