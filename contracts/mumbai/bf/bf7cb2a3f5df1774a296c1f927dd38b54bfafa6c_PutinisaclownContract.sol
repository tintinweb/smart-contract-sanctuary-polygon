...
//*********************************************************************//
//
// Putin is a clown, spread the word.
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmRUiq3dygnn7Twt4fMCTVQV3LWNqKJFcJ4okj3aAjjZX6/";
...
contract PutinisaclownContract is RamppERC721A {
    constructor() RamppERC721A("Putin is a clown", "PTNCLWN2"){}
