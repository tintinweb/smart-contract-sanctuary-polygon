    ...
    ReentrancyGuardUpgradeable
{
    ...
    function iSend(
        uint256 version,
        Utils.NativeTransferParams memory nativeTransferParams,
        ...
        if (nativeTransferParams.routeAmount > 0) {
            // "empty recipient" => "C04"
            // keccak256("") = 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470
            // TODO: Can we remove
            require(keccak256(nativeTransferParams.routeRecipient) != 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470, 
                "C04"
            );

            vault.deposit(nativeTransferParams.routeAmount, msg.sender);
        }
        ...
        emit ISendEvent(
            version,
            nativeTransferParams.routeAmount, 
            eventNonce, 
            msg.sender, 
            chainId,
            destChainId, 
            nativeTransferParams.routeRecipient,
            requestMetadata,
            requestPacket
        );
