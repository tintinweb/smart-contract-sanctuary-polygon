...
contract DepositFacet is IDeposit {
    ...
    function deposits(address account)
        ...
        returns (uint256)
    {
        return LibDeposit._deposits(account);
    }

    function totalDeposits() external view override returns (uint256) {
        return LibDeposit._totalDeposits();
    }
}
...
interface IDeposit {
    ...
    /// @return the deposit amount made by `account`
    function deposits(address account) external view returns (uint256);

    /// @return the total deposits made to the contract
