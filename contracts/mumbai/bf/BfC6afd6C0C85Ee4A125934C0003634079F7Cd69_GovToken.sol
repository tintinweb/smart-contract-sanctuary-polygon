...
import "../interfaces/tokens/IDistToken.sol";
...
abstract contract DistToken is IDistToken, ERC20, AccessHandler {
    ...
    /**
     * @notice Mint additional tokens. Overrides to restrict access.
 ...
 * @author Michael Larsen
 * @notice Simple ERC20 Token class used to account for governance balances.
 * @notice It is protected from minting except by an assigned role.
 * @notice This is a sub contract for the DaoMain app.
 * @notice GovToken is DistToken, DistToken is Accesshandler and
 * @notice Accesshandler is Initializable.
 */
contract GovToken is DistToken {
