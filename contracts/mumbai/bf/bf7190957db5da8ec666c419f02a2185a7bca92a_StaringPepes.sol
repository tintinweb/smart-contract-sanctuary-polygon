...
contract StaringPepes is ERC721Enumerable, Ownable {
    ...
    function mint(address _to, uint256 _mintAmount) public payable {
        ...
        require(tokensMintedByWallet[msg.sender] + _mintAmount <= maxPerWallet, "Max tokens minted per wallet reached");
        require(_mintAmount <= maxMintAmount, "You can't mint more than 20");
