...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x4Cf3f7C5B4fC7A14cfaFA3eD80D82F643c1DE8A4];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 5, 1424 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmakY3nTn2fTT3pFTMiShzr6fyrw8M8ggsBBBd4jKBD6zb/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 1424");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 1424");
...
// File: contracts/DankmojiMfersContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DankmojiMfersContract is RamppERC721A {
    constructor() RamppERC721A("Dankmoji Mfers", "DNKMFR"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/33GwdzyLllQhoBu24FIM/contract-metadata";
    }
}
