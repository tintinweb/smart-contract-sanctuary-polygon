...
contract FamStarts is ERC721Enumerable, IERC2981, Ownable, ReentrancyGuard {
    ...
    ) ERC721("FAM STARTS", "FAMSTARS") {
        beneficiary = _beneficiary;
        royalties = _royalties;
        baseURI = _initialBaseURI;
        ownerMint(msg.sender, 5);
    }
    ...
    function _internalMint(address to, uint256 amount) private {
        ...
        require(amount + supply <= MAX_SUPPLY, "Will exceed maximum supply");
