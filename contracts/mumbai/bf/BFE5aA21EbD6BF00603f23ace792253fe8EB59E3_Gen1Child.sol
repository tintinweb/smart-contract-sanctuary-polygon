...
contract Gen1Child is ERC721, IChildToken, AccessControlMixin, NativeMetaTransaction, ContextMixin {
    ...
    function claim(uint256[] calldata tokensIds_, bytes32[][] calldata proofs_) external {
    ...
    function setTokenOwnerRoot(bytes32 _newRoot) external only(DEFAULT_ADMIN_ROLE) {
        tokenOwnerRoot = _newRoot;
    }
