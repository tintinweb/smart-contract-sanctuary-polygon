...
contract MutantSumoPolygon is OwnControll, ERC721, NonblockingLzApp {
    ...
    constructor(address _endpoint) ERC721("MutantSumoPolygon", "MSP") NonblockingLzApp(_endpoint) {}
