...
contract FunctionsConsumer is FunctionsClient, ConfirmedOwner, ERC1155, ReentrancyGuard {
  ...
  /**
   * @notice Executes an Functions request
   ...
   * @param id The request ID, returned by sendRequest()
   * @param _response Aggregated response from the user code
   * @param _error Aggregated error from the user code or from the execution pipeline
   * Either _response or _error parameter will be set, but never both
   */
  ...
  /**
   * @notice Updates the Functions oracle address
  ...
  /**
   * @notice Mints a new NFT with the provided prompt and completion
   * @param prompt The prompt associated with the NFT
   * @param completion The completion associated with the NFT
   * @param requester The address to receive the NFT
   */
  ...
  /**
   * @notice Retrieves the NFT data for a given token ID
   * @param tokenId The token ID of the NFT
   * @return NFTData struct containing the prompt and completion
   */
