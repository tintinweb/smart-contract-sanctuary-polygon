...
contract Read is BasePlugin {
    ...
    function read(
        uint256 _postId, uint256 _subscriptionId
        ...
        outData = ISinglePostData(registry.singlePostData()).readPost(vars);
        ...
        if (outData.paymentType != 0) {
            registry.checkPayment(sender, outData.paymentType, _subscriptionId);
        }
    }
}
