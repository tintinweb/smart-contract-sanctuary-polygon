...
contract IkonicERC1155Token is ERC1155Base, Ownable {
    ...
    ERC2981PerTokenRoyalties
{
    ...
    function _mint(
        ...
        require(royaltyValue <= 10000, "ERC1155Base._mint: Royalty value should not exceed 10000");
        require(royaltyRecipient != address(0x0), "ERC1155Base._mint: Royalty recipient should be present");
        require(royaltyValue != 0, "ERC1155Base._mint: Royalty value should be positive");
    ...
    function supportsInterface(bytes4 _interfaceId)
        ...
        view
        virtual
        override(ERC1155, ERC165Storage, ERC2981Base)
        returns (bool)
    {
