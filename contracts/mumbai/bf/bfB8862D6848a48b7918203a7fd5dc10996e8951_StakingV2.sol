...
contract StakingV2 is ReentrancyGuard, Ownable {
    // staking threshold
    uint256 public constant maximumStakeAmount = 300000 * 10 ** 18;
    uint256 public constant minimumStakeAmount = 100 * 10 ** 18;
    ...
    struct Position {
        ...
        uint256 poolId;
        uint256 actualAmount; // real amount staked before getting converted
    }
    ...
    function deposit(
        ...
        uint256 _actualAmount = _amount; // Store the original amount
    ...
    function harvest(
        ...
        console.log("From Harvest function", totalReward);
        return totalReward;
    }
    ...
    function _getClaimableReward(
        ...
        uint256 totalReward = rewardPerPeriodLength * periodPassed;
        ...
        console.log("From _getClaimableReward function: ", totalReward);
        return totalReward;
    }
    ...
    function displayClaimableReward(
        ...
        console.log("from displayClaimableReward function : ", reward);
        return reward;
    }
