    ...
    SerializeBuyNowGet
{
    ...
    uint8 public immutable _blackholeId;
    ...
    constructor(
        ...
        _info = info;
        _writer = writer;
        _blackholeIdAddr = blackholeIdAddress;
        BlackholeId(blackholeIdAddress).assertValidBlackholeId();
        _blackholeId = BlackholeId(blackholeIdAddress).blackholeId();
    }
    ...
    function challVerifiableOnChain(
        ...
        isTXValid =
            isTXValid &&
            BlackholeId(_blackholeIdAddr).hasCorrectBlackholeId(assetId, _blackholeId) &&
