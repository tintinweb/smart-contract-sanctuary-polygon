...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 10888, 10888 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmbRYZQL9XGBBF5x9ZqQPXKVpkTGJs9C1MfcG48omPEpaC/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 10888");
        _safeMint(_to, 1);
    }
...
// File: contracts/DigitalDeersContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DigitalDeersContract is RamppERC721A {
    constructor() RamppERC721A("DigitalDeers", "DDEER"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/i7bgzxSFQMDnerXSlwU9/contract-metadata";
    }
}