...
contract ERC721WithPermit is ERC721, EIP712Base, AccessControl, Pausable {
  ...
  mapping(address => bool) _approvedTokensForTransfer;
  ...
  /**
    ...
    */
  function addAllowedTokenForTransfer(address _addressToApprove) public onlyRole(DEFAULT_ADMIN_ROLE) whenNotPaused {
      _approvedTokensForTransfer[_addressToApprove] = true;
  ...
  /**
    ...
    */
  function removeAllowedTokenForTransfer(address _addressToRevoke) public onlyRole(DEFAULT_ADMIN_ROLE) whenNotPaused {
      _approvedTokensForTransfer[_addressToRevoke] = false;
  }
  ...
  /**
    ...
    *
    */
  function _verifyTokenForTransfer(address _tokenAddress) internal view {
      require(_approvedTokensForTransfer[_tokenAddress], "Artifract: TOKEN_NOT_ALLOWED");
  }
  ...
  /**
    ...
    *
    */
  function isAllowedTokenForTransfer(address _tokenAddress) public view returns (bool) {
    return _approvedTokensForTransfer[_tokenAddress];
  }
}
