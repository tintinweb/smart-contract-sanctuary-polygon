...
// File: contracts/FOMOCToken.sol



pragma solidity ^0.8.0;

interface IFOMOCToken is IERC20 {
...
contract FOMOCToken is ERC20, Ownable, IFOMOCToken {
    ...
    */
    constructor(
        ...
        uint256 _cap
    ) ERC20("FOMO Casino Token", "FOMOC") {
        require(_cap > _premintAmount, "FOMOC: Premint amount is greater than cap");
