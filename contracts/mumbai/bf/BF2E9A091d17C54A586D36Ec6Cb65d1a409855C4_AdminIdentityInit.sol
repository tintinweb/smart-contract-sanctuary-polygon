...
interface IAdminIdentityInit is IIdentity{
    ...
    */
     ...
     */
    event ApprovalAdded(uint256 indexed executionId, bytes32 key);
    event ApprovalCancelled(uint256 indexed executionId, bytes32 key);
    event ExecutionCancelled(uint256 indexed executionId, bytes32 key);
...
contract AdminIdentityInit is AdminIdentityStorage, IAdminIdentityInit, Initializable{
     ...
     */
    function init(address initialManagementKey, uint256 executionTime, uint256 _requiredSignatures) public initializer{
    ...
    function __Identity_init(address initialManagementKey, uint256 executionTime, uint256 requiredSignatures) internal onlyInitializing{
