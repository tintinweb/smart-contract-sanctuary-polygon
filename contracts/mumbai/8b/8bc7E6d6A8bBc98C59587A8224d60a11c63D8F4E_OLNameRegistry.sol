...
contract OLNameRegistry is Ownable, Seriality {
    ...
    event logFoo3(uint256 offset, Registry data);
    ...
    function getRegistry(bytes32 nameHash) public returns (Registry memory) {
        ...
        emit logFoo4(nameHash,buffer);
        Registry memory data = deserializeRegistry(buffer);
        emit logFoo3(1,data);
        return data;
    }
