...
contract Testestes is ERC721A, Ownable, ERC2981 {
    ...
    address[] public withdrawAddresses = [0x06cFE683867e6D8d526B6Ef8cad21edEf011a88C, 0x98B5899328E04d830cC8cC3b71Ff34a1a3dE8cf9];
    uint256[] public withdrawPercentages = [95, 5];

    bytes32 public merkleRoot = 0x3a0f531e1c941775475bb65e69001fc3e79cab60cbfe2c13c53f883a784d54db;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x06cFE683867e6D8d526B6Ef8cad21edEf011a88C, _royaltyAmount);
    }
