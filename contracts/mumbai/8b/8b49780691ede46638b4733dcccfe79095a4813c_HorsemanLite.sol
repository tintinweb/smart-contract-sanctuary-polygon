...
contract HorsemanLite is ReentrancyGuard{
    ...
    uint256 public constant HeroPrice = 0.1 ether; //购买英雄价格
    ...
    uint256[4] private Multiplier = [3500, 800, 300, 182]; //奖励倍率

    uint256 private constant MaxMul = 125; //支持的最大投注倍率
    uint256 private constant MinMul = 36; //资金池支持的最小倍率
    ////////////////////////////////////////////// 相关变量 ////////////////////////////////////////////////////////////
    ...
    address private KeeperConsumer;
    ...
    function Duel(address tokenAddress, uint256 wager)
        ...
        nonReentrant
    {
        if (wager < HeroPrice || msg.value < wager || wager > MaxMul * HeroPrice) {
...
emit Log("random:", r);
    ...
    function setKeeperConsumer(address _KeeperConsumer) external{
        if(Bankroll.getCurrentCorpBank() == msg.sender){
