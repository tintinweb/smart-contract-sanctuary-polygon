...
contract VCMarketplaceFixedPricePoCNft is VCMarketplaceBasePoCNft, ERC721Holder {
    ...
    function unlistFixedPrice(uint256 _tokenId) public {
        ...
        emit UnlistedFixedPrice(address(pocNft), _tokenId, msg.sender);
    }
    ...
    function _newList(uint256 _tokenId, uint256 _listPrice) internal {
        ...
        fixedPriceListings[_tokenId] = FixedPriceListing(msg.sender, _listPrice, marketFee, starterFee, poolFee);

        emit ListedFixedPrice(address(pocNft), _tokenId, msg.sender, _listPrice, marketFee, starterFee, poolFee);
    }
    ...
    function _updateList(uint256 _tokenId, uint256 _listPrice) internal {
        ...
        emit UpdatedFixedPrice(address(pocNft), _tokenId, msg.sender, _listPrice, marketFee, starterFee, poolFee);
    }
}
