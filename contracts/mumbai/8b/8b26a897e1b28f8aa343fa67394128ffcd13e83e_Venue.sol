...
// File contracts/utils/VenueERC721.sol
    ...
    IERC721MetadataUpgradeable
{
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = VenueERC721.ownerOf(tokenId);
    ...
    function _transfer(
        ...
        require(
            VenueERC721.ownerOf(tokenId) == from,
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(VenueERC721.ownerOf(tokenId), to, tokenId);
    }
...
// File contracts/utils/VenueMetadata.sol
