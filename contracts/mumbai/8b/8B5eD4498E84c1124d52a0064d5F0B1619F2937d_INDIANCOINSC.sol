...
contract INDIANCOINSC is Context, IERC20, Ownable,Initializable {   
    ...
    uint256 private _minTransactionLimits;
   ...
   function pauseTransaction() onlyOwner public {
    ...
    function updateBuyFee(uint buyTaxFee,uint LiquidityBuyPer,uint marketingBuyPer,uint RewardBuyPer,uint autoBurnBuyPer) onlyOwner public {
    ...
    function updateSellFee(uint sellTaxFee,uint LiquiditySellPer,uint marketingSellPer,uint RewardSellPer,uint autoBurnSellPer) onlyOwner public {
    ...
    function includeForReward(address account) external onlyOwner() {
      ...
      function _verifyMinxTransactionLimits(uint256 minTransactionLimits) public onlyOwner {
    ...
    function _transfer(address from,address to,uint256 amount) private {
        ...
        require(amount<=_minTransactionLimits,"Maximum Transactio Limit Exceed.");
        if(to == pancakePair){
       ...
       function myReward(address _wallet) public view returns(uint256 _reward){
