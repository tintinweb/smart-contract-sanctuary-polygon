    ...
    UUPSUpgradeable
{
    ...
    bytes32 public constant VRF_REQUESTER = keccak256("VRF_REQUESTER");
    ...
    function requestRandomNumberBouncing(
    ...
    ) external onlyRole(VRF_REQUESTER) {
        // verify that this function is called by an accepted address
        require(
            whiteListSmartContract[_msgSender()],
            "RNG: Request from unauthorized address"
        ...
        _executeCallBack(_msgSender(), _account, idReqBounce, randomWords);
