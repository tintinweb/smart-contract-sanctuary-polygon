...
contract GovernorAlpha {
    ...
    function votingPeriod() public pure returns (uint) {
        //return (60 * 60 * 24 * 3) / 6;
        return (60 * 15) / 2.5;
    } // ~3 days in blocks (assuming 6s blocks)
    ...
    function propose(
        ...
        require(
            agl.getPriorVotes(msg.sender, sub256(block.number, 1)) >
                proposalThreshold(),
    ...
    function cancel(uint proposalId) public {
        ...
        require(
            ...
            "GovernorAlpha::cancel: caglot cancel executed proposal"
        );

        Proposal storage proposal = proposals[proposalId];
        require(
            msg.sender == guardian ||
                agl.getPriorVotes(proposal.proposer, sub256(block.number, 1)) <
                proposalThreshold(),
