...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x0245659D351B8D932D3cA21ab39165A019b2E407];
  address public erc20Payable = 0x0245659D351B8D932D3cA21ab39165A019b2E407;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 5100) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeic466tq46bu3yjtoythrvojobzn5tyubs6u7r46sssstpq7vpmw7a/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/fb1n8jsljjzc1q6xvbdW/contract-metadata";
  }
...
// File: contracts/PizzatokenContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PizzatokenContract is ERC721APlus {
    constructor() ERC721APlus("pizza token", "PT"){}
}
  /*******************************************************/
  /*                                                     */
