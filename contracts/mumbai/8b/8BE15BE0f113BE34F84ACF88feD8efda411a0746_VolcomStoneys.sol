...
contract ERC721WhiteListMint is WTCERC721{
 ...
 *****************************************************************************************/
  ...
  constructor(uint _reservedIDs, uint16 _maxSupply, string memory name, string memory symbol) WTCERC721(_reservedIDs, name, symbol){
