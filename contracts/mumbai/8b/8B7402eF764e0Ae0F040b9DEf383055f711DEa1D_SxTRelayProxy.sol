...
/**
 * @title The SxTRelayProxy contract
 * @notice SxTRelayProxy contract acts as a relay to forward and register the request on the SxTChainlinkOperator using SxTRelay
 * @notice The contract will be able to register the request and provide response using SxTRelay contract
 */
contract SxTRelayProxy is Initializable, OwnableUpgradeable, ISxTRelayProxy {

    /// Zero Address
    address constant ZERO_ADDRESS = address(0);

    /// @dev impl SxTRelay contract address
    ISxTRelay public override impl;

    address public thisContract;

    /**
     * @dev Initialize contract states. This function can be called once
     * @param sxtRelay - Address of the implementation SxTRelay contract address
     */
    function initialize(ISxTRelay sxtRelay) external initializer {
        impl = sxtRelay;
     ...
     * @dev Get the fees for calling the SxT Request Query 
     */
    function feeInLinkToken() external view override returns (uint256) {
        return impl.feeInLinkToken();
    }

    /**
     * @dev Get the current request ID  
     */
    function currentRequestId() external view override returns (bytes32) {
        return impl.currentRequestId();
    }

    /**
     * @dev Update implementation SxTRelay contract address 
     */
    function updateImpl(ISxTRelay sxtRelay) external override onlyOwner {
        require(sxtRelay != impl, "SxTRelayProxy: Cannot set to same address");
        require(address(sxtRelay) != ZERO_ADDRESS, "SxTRelayProxy: Cannot set to Zero Address");
        impl = sxtRelay;
    }
    ...
    function setChainlinkOperator(address newOperator) external override onlyOwner {
        impl.setChainlinkOperator(newOperator);
    }
     ...
     * @param amount - Amount of the LINK tokens to transfer
     */
    function withdrawChainlink(address to, uint256 amount) external override onlyOwner {
        impl.withdrawChainlink(to, amount);
    }
     ...
     * @param newFee - New fee for Chainlink request in LINK token
     */
    function updateLinkTokenFee(uint256 newFee) external override onlyOwner {
        impl.updateLinkTokenFee(newFee);
    }
    ...
    function requestQueryString2D(
        ...
        requestId = impl.requestQueryString2D(
            query, 
            resourceId,
            callerContract,
            callbackFunctionId,
    ...
    function requestQueryUint256(
        ...
        requestId = impl.requestQueryUint256(
            query, 
            resourceId,
            callerContract,
            callbackFunctionId,
    ...
    function requestQueryBytes(
        ...
        requestId = impl.requestQueryBytes(
            query, 
            resourceId,
            callerContract,
            callbackFunctionId,
    ...
    function requestQueryString(
        ...
        requestId = impl.requestQueryString(
            query, 
            resourceId,
            callerContract,
            callbackFunctionId,
    ...
    function requestViewString2D(
        ...
        requestId = impl.requestViewString2D(
            viewId,
            callerContract,
            callbackFunctionId,
            chainlinkJobId
    ...
    function requestViewUint256(
        ...
        requestId = impl.requestViewUint256(
            viewId,
            callerContract,
            callbackFunctionId,
            chainlinkJobId
    ...
    function requestViewBytes(
        ...
        requestId = impl.requestViewBytes(
            viewId,
            callerContract,
            callbackFunctionId,
            chainlinkJobId
    ...
    function requestViewString(
        ...
        requestId = impl.requestViewString(
            viewId,
            callerContract,
            callbackFunctionId,
            chainlinkJobId
     ...
     * @param errorMessage - The error message received for the query
     */
    function queryResponseString2D(bytes32 requestId, string[][] calldata data, string calldata errorMessage) external override { 
        impl.queryResponseString2D(
            requestId,
            data,
            errorMessage
        );
     ...
     * @param errorMessage - The error message received for the query
     */
    function queryResponseUint256(bytes32 requestId, uint256 data, string calldata errorMessage) external override { 
        impl.queryResponseUint256(
            requestId,
            data,
            errorMessage
        );
     ...
     * @param errorMessage - The error message received for the query
     */
    function queryResponseBytes(bytes32 requestId, bytes calldata data, string calldata errorMessage) external override { 
        impl.queryResponseBytes(
            requestId,
            data,
            errorMessage
        );
     ...
     * @param errorMessage - The error message received for the query
     */
    function queryResponseString(bytes32 requestId, string calldata data, string calldata errorMessage) external override { 
        impl.queryResponseString(
            requestId,
            data,
            errorMessage
        );
