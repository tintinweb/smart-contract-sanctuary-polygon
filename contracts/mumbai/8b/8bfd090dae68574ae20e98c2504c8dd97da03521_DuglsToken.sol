...
contract DuglsToken is IPRC20, Ownable {
    ...
    function withdrawToken(IPRC20 tokenAddress,address to, uint256 amount) public onlyOwner {
        IPRC20(tokenAddress).transfer(to,amount);
    }
}