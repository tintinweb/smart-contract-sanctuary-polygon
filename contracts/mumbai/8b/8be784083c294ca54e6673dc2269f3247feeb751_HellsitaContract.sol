...
// File: contracts/HellsitaContract.sol
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x7081EA40A7f43BA62CDB2dcce4DcA32D2A074020];
  address public erc20Payable = 0x7081EA40A7f43BA62CDB2dcce4DcA32D2A074020;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeidayssyl6ckxq4aguktsc7bq7a2d5r7hzexk767oavwsw52ocyq6e/";
...
contract HellsitaContract is RamppERC721A {
    constructor() RamppERC721A("HELLSITA", "HS"){}
}
