...
import "../../3rdparty/biconomy/EIP712MetaTransaction.sol";

contract BiconomyTest is EIP712MetaTransaction, ReentrancyGuard
{
    string public quote;
    ...
    CallStorage[] public callStorage;

    function startQuest(bytes32 questId, uint256[] calldata tokenIds) public nonReentrant
    {
        callStorage.push(CallStorage({
            sender: msgSender(),
            questId: questId,
            tokenIds: tokenIds
        }));
    ...
    function getCallStorageAtIndex(uint256 index) public returns (CallStorage memory)
    {
        return callStorage[index];
    }
