...
contract Pasha is ERC1155 , AccessControl {
    ...
    constructor() ERC1155 ("https://gateway.pinata.cloud/ipfs/QmSqh1v3EdhhkSxzWxKVkGZgULSMNm3y3b58NNt35rBYVb/{id}.json") {
    ...
    function uri(uint256 _id) public pure override returns (string memory) {
        return
            string(
                abi.encodePacked(
                    "https://gateway.pinata.cloud/ipfs/QmSqh1v3EdhhkSxzWxKVkGZgULSMNm3y3b58NNt35rBYVb/",
