...
// File: contracts/IsekaiGenesis-erc721base-UUPS.sol
...
contract IsekaiGenesis is Initializable, ERC721Upgradeable, UUPSUpgradeable, IERC2981Upgradeable, OwnableUpgradeable, DefaultOperatorFiltererUpgradeable {
    ...
    uint256 public ogMintLimit;

    bool public OGpaused;
	...
	function initialize()public initializer{
        ...
        __ERC721_init("ISEKAIGenesis", "IGU");
        __UUPSUpgradeable_init();

        mintCost = 0.03 ether;
        ogMintCost = 0.00 ether;
        wlMintCost = 0.00 ether;
    ...
    function whitelistMint(bytes32[] calldata _merkleProof) public payable {
        ...
        require(MerkleProofUpgradeable.verify(_merkleProof, wlRoot, leaf), 'Invalid proof!');
    ...
    function ogMint(bytes32[] calldata _merkleProof) public payable {
        ...
        bytes32 leaf = keccak256(abi.encodePacked(msg.sender));
        require(MerkleProofUpgradeable.verify(_merkleProof, ogRoot, leaf), 'Invalid proof!');
    ...
    function setDefaultRoyalty(address payable receiver, uint96 feeNumerator) public onlyOwner {
        require(feeNumerator <= 1000 && feeNumerator >= 0, "between 1000 and 0");
        royaltyBPS = feeNumerator;
        fundsRecipient = receiver;
    }
    ...
    function setWlMintLimit(uint256 _wlMintLimit) public onlyOwner {
        wlMintLimit = _wlMintLimit;
    }
    function setOgMintLimit(uint256 _ogMintLimit) public onlyOwner {
