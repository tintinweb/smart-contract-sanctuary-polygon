...
contract PinRIT is ERC721URIStorage {
    ...
    function getCustomTokenURI(uint256 tokenId, string memory base64svg) public pure returns (string memory) {
    ...
    function changePixelSvg(uint256 tokenId, string memory base64svg) public payable {
            ...
            _setTokenURI(tokenId, getCustomTokenURI(tokenId, base64svg));
    }
