...
contract Test {
    ...
    event BuyNewLevel(address  _user, uint8 _level, address referrer, uint256 referrerId);
    ...
    function buyLevel(uint8 level) public 
    {
        ...
        emit BuyNewLevel(msg.sender, level, globalIndex[level][globalId], globalCount[level]-1);
    }  
