...
contract WalletFactory is Managed {
    ...
    */
        ...
        returns (address _wallet)
    {
        ...
        bytes32 newsalt = newSalt(_salt, _modules);
     ...
     * @param _modules The list of modules for wallet.
     */
    function newSalt(bytes20 _salt, address[] calldata _modules) internal pure returns (bytes32) {
        return keccak256(abi.encodePacked(keccak256(abi.encodePacked(_modules.length)), _salt));
    }
