    ...
    function verifySellerSign(
        ...
        bytes32 digest = _hashTypedDataV4(
            keccak256(
                abi.encode(
                    keccak256(
                        "signData(address assetAddress,uint256 tokenId, address paymentAssetAddress, uint256 amount)"
                    ),
                    assetAddress,
                    tokenId,
                    paymentAssetAddress,
        ...
        address signer = ECDSA.recover(digest, sign.v, sign.r, sign.s);
    ...
    function verifyBuyerSign(
        ...
        bytes32 digest = _hashTypedDataV4(
            keccak256(
                abi.encode(
                    keccak256(
                        "signData(address assetAddress,uint256 tokenId, address paymentAssetAddress, uint256 amount, uint256 qty)"
                    ),
                    assetAddress,
                    tokenId,
                    paymentAssetAddress,
        ...
        address signer = ECDSA.recover(digest, sign.v, sign.r, sign.s);
        require(buyer == signer, "buyer sign verification failed");
    }
