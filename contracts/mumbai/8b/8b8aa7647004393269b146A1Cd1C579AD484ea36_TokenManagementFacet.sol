...
contract TokenManagementFacet {
    ...
    /// @notice
    event NewTokenMinLiquidity(uint8 listingId, uint256 minLiquidity);
    ...
    function setTokenLimit(uint8 _listingId, uint256 _minLiquidity) external {
        LibAccessControl._requireGov();
        s.minLiquidity[_listingId] = _minLiquidity;

        emit NewTokenMinLiquidity(_listingId, _minLiquidity);
    }
