...
contract LuniansCollection is ERC1155, Ownable, ERC2981, VRFConsumerBase {
    ...
    */
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        rollState = false;
        // mint
        randomMint(requestId, mintingAmount[rollers[requestId]], mintingSeedpodId[rollers[requestId]]);
    }

    function randomMint(bytes32 requestId, uint256 n, uint256 seedpodId) private {
        uint256 process;
