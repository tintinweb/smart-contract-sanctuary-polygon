...
contract OATH is ERC721Enumerable, ReentrancyGuard, DefaultOperatorFilterer, Ownable {
    using SafeERC20 for IERC20;
    uint256 public price = 50000000; //50 usdt ETH
    uint256 public constant MAX_SUPPLY = 1000; // Max. Oaths
    address public USDT = 0x8807df8159836C600197e4FedE34b91827552d9a;


    constructor() ERC721("OATH", "0ATH") {}
    
    string[] private firstrow = [
        "ALPHA", "BETA", "GAMMA", "DELTA", "EPSILON",
        "ZETA", "ETA", "THETA", "IOTA", "KAPPA",
        "LAMBDA", "MU", "OMICRON", "PI", "RHO",
        "SIGMA", "PHI", "PSI", "TAU", "OMEGA"
    ];

    string[] private secondrow = [
        "ETA", "LAMBDA", "ALPHA", "GAMMA", "PHI",
        "THETA", "OMICRON", "ZETA", "IOTA", "RHO",
        "OMEGA", "BETA", "TAU", "KAPPA", "PI",
        "SIGMA", "EPSILON", "PSI", "DELTA", "MU"
    ];

    string[] private thirdrow = [
        "EPSILON", "TAU", "BETA", "KAPPA", "LAMBDA",
        "OMICRON", "GAMMA", "PHI", "PSI", "ALPHA",
        "THETA", "MU", "ETA", "IOTA", "OMEGA",
        "DELTA", "PI", "ZETA", "SIGMA", "RHO"
    ];

    string[] private fourthrow = [
        "MU", "ZETA", "RHO", "SIGMA", "ETA",
        "GAMMA", "IOTA", "THETA", "OMICRON", "EPSILON",
        "KAPPA", "BETA", "PI", "TAU", "DELTA",
        "LAMBDA", "PSI", "OMEGA", "PHI", "ALPHA"
    ];

    string[] private fifthrow = [
        "ZETA", "PSI", "DELTA", "ETA", "KAPPA",
        "LAMBDA", "EPSILON", "MU", "RHO", "PHI",
        "GAMMA", "SIGMA", "TAU", "ALPHA", "IOTA",
        "OMICRON", "OMEGA", "THETA", "BETA", "PI"
    ];

    string[] private sixthrow = [
        "THETA", "SIGMA", "PI", "TAU", "KAPPA",
        "BETA", "ALPHA", "PHI", "MU", "EPSILON",
        "OMICRON", "OMEGA", "ZETA", "PSI", "ETA",
        "DELTA", "GAMMA", "IOTA", "LAMBDA", "RHO"
    ];
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        parts[
            0
        ] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 700 700"><style>.base { fill: #fff; font-family: Roboto; font-size: 22px; font-weight: bold;}</style><rect width="100%" height="100%" fill="#000" /><text transform="translate(200.000000,400.000000)" fill="#9e9e9e" font-size="400" font-family="Roboto" ><tspan x="0" y="0">&#8486;</tspan></text><text x="50" y="460" class="base">';
    ...
    function mint(uint256 amount) public  nonReentrant {
       ...
       uint256 mintprice = amount * price;
       IERC20 token = IERC20 (USDT);
       token.safeTransferFrom(msg.sender, address(this), mintprice);
    //    abi.encodeWithSelector(token.transferFrom.selector, msg.sender, address(this), mintprice);
    ...
    function mintTokenID(uint256 tokenId) internal  {
