    ...
    IERC721Custom
{
   ...
   function batchMintTraxx(
        ...
        returns (address receiver, uint256 royaltyAmount)
    {
        ...
        receiver = secondarySplitAddress[artistAddress] != address(0) ? secondarySplitAddress[artistAddress] : artistAddress;
    ...
    function setSplitAddress(address _artistAddress, address _secondarySplitAddress) external onlyAdmin {
        require(
