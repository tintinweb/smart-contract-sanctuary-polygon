...
contract Fish_Species_01 is GameBase {
    ...
    function getRandomNumber(uint256 tokenId) private {
        ...
        Fish_Species_01_Extension fish_Species_01_Extension = Fish_Species_01_Extension(_fish_Species_01_ExtensionContractAddress);
        fish_Species_01_Extension.mint(creature_valueType[tokenId], tokenId, contract_points_value_balance_forType[creature_valueType[tokenId]], 53452236467721590622799751259924910047686185017518078278932746526520972949066);
