...
contract Exchange is ERC20 {
    ...
    function addLiquidity(uint256 _amount) public payable returns (uint256) {
        ...
        if (tokenReserve == 0) {
            ...
            require(_amount >= tokenAmount, "Amount of tokens is less than the minimum reqired.");
    ...
    function ethToMyToken(uint _minTokens) public payable {
        ...
        ERC20(tokenAddress).transferFrom(address(this), msg.sender, tokensBought);
    }

    function myTokenToEth(uint _tokensSold, uint _minEth) public payable {
        uint256 tokenReserve = getReserve();
        uint256 ethBought = getAmountOfTokens(_tokensSold, tokenReserve, address(this).balance - msg.value);
...
// 0x7aBdBBAf85D324D13B8D912FAAC86E985a8CFec3