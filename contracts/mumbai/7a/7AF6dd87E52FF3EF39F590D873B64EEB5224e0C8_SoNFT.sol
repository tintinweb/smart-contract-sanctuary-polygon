...
contract SoNFT is ERC721Burnable, Ownable, Pausable, AccessControl {
    ...
    string private _contractUri = "https://d27b24gorg1v04.cloudfront.net/test/static/ff447b0cf9001bc21bafda23b3719ab9/contract.json";
    string private _baseUri = "https://d27b24gorg1v04.cloudfront.net/test/static/ff447b0cf9001bc21bafda23b3719ab9/";

    uint256 private totalCount;
    mapping(uint256 => uint8) private totalSupply;
    ...
    function mint(uint256 tokenId, address to) public {
        ...
        require(tokenId > 0, 'activityID or tokenId cannot be 0');
        require(totalSupply[tokenId] == 0, 'Existing');
        _mint(to, tokenId);
