...
//*********************************************************************//
//
//    __ __ _____ __            _____            __        _             __    __        _____                   __         ________          _     
//   / // // ___// /____  __   / ___/__  _______/ /_____ _(_)___  ____ _/ /_  / /__     / ___/__  ______  ____  / /_  __   / ____/ /_  ____ _(_)___ 
//  / // /_\__ \/ //_/ / / /   \__ \/ / / / ___/ __/ __ `/ / __ \/ __ `/ __ \/ / _ \    \__ \/ / / / __ \/ __ \/ / / / /  / /   / __ \/ __ `/ / __ \
// /__  __/__/ / ,< / /_/ /   ___/ / /_/ (__  ) /_/ /_/ / / / / / /_/ / /_/ / /  __/   ___/ / /_/ / /_/ / /_/ / / /_/ /  / /___/ / / / /_/ / / / / /
//   /_/ /____/_/|_|\__,_/   /____/\__,_/____/\__/\__,_/_/_/ /_/\__,_/_.___/_/\___/   /____/\__,_/ .___/ .___/_/\__, /   \____/_/ /_/\__,_/_/_/ /_/ 
//                                                                                              /_/   /_/      /____/                               
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x6b415d9cA3aE7436D273685913961e2f6a988DCb];
...
// File: contracts/X4SkuSustainableSupplyChainContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract X4SkuSustainableSupplyChainContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "4Sku Sustainable Supply Chain";
    string public symbol = "4sku";
