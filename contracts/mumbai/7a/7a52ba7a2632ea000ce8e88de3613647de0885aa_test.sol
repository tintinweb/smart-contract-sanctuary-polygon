...
contract test is
    ...
    UUPSUpgradeable
{
    string public constant name = "Sample test";
    string public constant symbol = "SAP test";
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() {
        _disableInitializers();
    }
    ...
    function mint(address account, uint256 TOKEN_ID, uint256 SUPPLY) public {
        _mint(account, TOKEN_ID, SUPPLY, "");
        _setURI(TOKEN_ID, "QmYV9HbHD4xGJzUZwFUcKLHVcuiiLRYKv2FWJEdgiVnMgq");
    }
