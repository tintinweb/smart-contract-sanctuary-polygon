    ...
    Ownable
{
    ...
    // keccak256("ServerAuthHash(address buyer,uint256 tokenId,uint256 baseFeeNumerator,uint256 txnExpiry)")
    bytes32 public constant SERVER_AUTH_TYPEHASH = 0x35e9f46134d20dfc704345460d6d6f46b65ce60c7d9b4ca4d9b7688af28d54fb;
    ...
    function matchListing(
        ...
        {   // Scoping for stack too deep error
            ...
            bytes32 serverMessage = generateServerAuthHash(msg.sender, tokenId, baseFeeNumerator, txnExpiry).toEthSignedMessageHash();
