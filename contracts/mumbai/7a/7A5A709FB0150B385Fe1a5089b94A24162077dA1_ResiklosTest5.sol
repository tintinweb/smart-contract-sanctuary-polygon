...
contract ResiklosTest5 is ERC721A, Ownable {
    using Strings for uint256;
    ...
    uint256 public LEGENDARY_PRICE = .001 ether;
    uint256 public RARE_PRICE = .001 ether;
    uint256 public COMMON_PRICE = .001 ether;
    ...
    constructor() ERC721A("ResiklosTest5", "RSK") { }
