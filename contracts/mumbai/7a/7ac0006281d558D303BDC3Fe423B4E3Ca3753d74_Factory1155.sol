...
import "./BookwalaUser1155Token.sol";
...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new BookwalaUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        BookwalaUser1155Token token = BookwalaUser1155Token(address(addr));
...
contract BookwalaUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
