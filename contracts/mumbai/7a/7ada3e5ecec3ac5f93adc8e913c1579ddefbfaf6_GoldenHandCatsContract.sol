...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x37cb85bC1dB76d87928b07B70453a279E1676DE9];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmbknQeGqddsVVRnexDtfHC1zaxtMS8He4gzhENaRaf776/";
...
// File: contracts/GoldenHandCatsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GoldenHandCatsContract is RamppERC721A {
    constructor() RamppERC721A("Golden Hand Cats", "GHC"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/xrJ6KyBNbpRskt5m1bYr/contract-metadata";
    }
}
