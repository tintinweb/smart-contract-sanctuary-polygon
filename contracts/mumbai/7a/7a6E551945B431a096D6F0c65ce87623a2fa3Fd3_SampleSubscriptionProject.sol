...
/// to an IDA index that will split the streams into 2, one for project owner, one for buidlers
contract SampleSubscriptionProject is RedirectAll {
    constructor(
        address ida, // the address of the IDA index to which RedAll will redirect all streams
        ISuperfluid host,
