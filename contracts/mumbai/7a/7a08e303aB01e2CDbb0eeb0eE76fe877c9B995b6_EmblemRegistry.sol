...
contract EmblemRegistry is AccessControl, FxBaseChildTunnel {
    ...
    // private API for looking up badge winners. Tokens are minted to _balances mapping when winners opt in
    ...
    function mint(
        ...
        require(_souls[badgeStruct.badgeDefinitionNumber][badgeStruct.winner] == true, "Badge has not been unfurled");
