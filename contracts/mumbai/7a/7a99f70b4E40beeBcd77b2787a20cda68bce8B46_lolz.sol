...
/********************************************************************************************************************************************/
/********************************************************************************************************************************************/
contract lolz is ERC721AUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
  string private _name                       = 'Laugh Out Loud';
  string private _symbol                     = 'LOL';
  string public uriPrefix                    = '';
  string public uriSuffix                    = '.json';
  string public hiddenMetadataUri            = 'ipfs://bafybeihqsm4xfp5wwjp56k7ltpobxieo5nmuqhfe32d75p63mc55kjdabi';
...
/********************************************************************************************************************************************/
  modifier mintCompliance(uint256 _mintAmount) {
	if (_mintAmount <= 0 || _mintAmount > maxMintAmountPerTx) { revert Errors.InvalidMintAmount(); }
	if (totalSupply() + _mintAmount > maxSupply) { revert Errors.MaxSupplyExceeded(); }
	_;
  }
/********************************************************************************************************************************************/
  modifier mintPriceCompliance(uint256 _mintAmount) {
	if (msg.value < cost * _mintAmount) { revert Errors.InsufficientFunds(); }
	_;
  }
/********************************************************************************************************************************************/
  ...
  {
	if (paused) { revert Errors.TheContractIsPaused(); }
...
/********************************************************************************************************************************************/
  ...
  {
	if (!_exists(_tokenId)) { revert Errors.ERC721__URIQueryForNonexistentToken(); }
	if (revealed == false) { return hiddenMetadataUri; }
	string memory currentBaseURI = _baseURI();
	return bytes(currentBaseURI).length > 0
      ? string(abi.encodePacked(currentBaseURI, "/", StringsUpgradeable.toString(_tokenId), uriSuffix))
      : "";
  }
/********************************************************************************************************************************************/
...
/********************************************************************************************************************************************/
  function supportsInterface(bytes4 _interfaceId)
	...
	returns (bool)
  {
	return ERC721AUpgradeable.supportsInterface(_interfaceId) || super.supportsInterface(_interfaceId);
  }
/********************************************************************************************************************************************/
}
/********************************************************************************************************************************************/
