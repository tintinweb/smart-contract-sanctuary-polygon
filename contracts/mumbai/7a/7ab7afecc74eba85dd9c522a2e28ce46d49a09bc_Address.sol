...
// on chain NFT Certificate
  ...
  function mint(address _address, string memory _name, string memory _locationofBirth, string memory _location) public onlyOwner {
    ...
    tokenIdtoCertificate[newTokenId] = Certificate(_name, _locationofBirth, _location);
