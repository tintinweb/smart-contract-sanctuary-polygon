    ...
    AccessControlEnumerableUpgradeable
{
    ...
    function _baseURI() internal view virtual override returns (string memory) {
        return "https://metadata.darenstar.com/darenJudge/";
    }
    ...
    function executeOrder(uint256 _tokenId) public {
        ...
        require(goods.pk > 0, "Order was not created.");
        require(darenToken != address(0), "Daren Token address is not set.");
    ...
    function setFeeTo(address _feeTo) external onlyRole(ADMIN_ROLE) {
        require(
            _feeTo != address(0),
            "Fee to address should not be zero address."
        );
        feeTo = _feeTo;
    }
