...
contract Onboardbadge is ERC1155, Ownable {
    ...
    // KISS - after completing Blockchan fundamentals quiz, player unlocks NFT xter
    ...
    // string public nft = "nft";
    
    constructor() ERC1155("https://wnwnenergy.com/blockchain/{id}.json") {
        
        _mint(msg.sender, 0, 1, "{'Open': 1}");
        _mint(msg.sender, 1, 1, "{'Badge': 'An InGame Badge'}");
    ...
    // acc addr, 2, 1 // only mints using user address - we don't need to delegate this to contract owner
    function playerMint(address account, uint256 id, uint256 amount) public {
    ...
    function getURI() private pure returns (string memory) {
        string memory uri;
        uri = "https://wnwnenergy.com/blockchain/justOwl825x783.png";
        return uri;
