  ...
  */
  ...
  abstract contract Allowlist is Ownable {
        ...
        Allowlist
    {
        ...
        uint256 public PRICE = 222 ether;
        ...
        constructor(
            ...
            payableAddresses.push(0x70a0534A1b0fAE81246e22C330BA736bE46c1dd1);
      ...
      require(mintingOpen == true && onlyAllowlistMode == false, "Public minting is not open right now!");    
        ...
        */
        function mintToMultiple(address _to, uint256 _amount) public payable {
            ...
            require(currentTokenId() + _amount <= SUPPLYCAP, "Cannot mint over supply cap of 50");
    ...
    // File: contracts/metapolitanClub1StReleaseContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract MetapolitanClub1StReleaseContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Metapolitan Club - 1st Release", "METACLUB", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmVqVv3cx8YVbGegeG7wpXC9CW2r85Ba3yek1mBnwX2PTz/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/bKIpA0qTNeI4ULypIuH5/contract-metadata";
        }
    }