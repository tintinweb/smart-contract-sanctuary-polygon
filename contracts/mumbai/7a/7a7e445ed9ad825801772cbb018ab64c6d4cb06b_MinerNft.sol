...
contract MinerNft is Ownable {
    ...
    uint256 public minBuy = 50 ether;
    uint256 public maxWallet = 1000 ether;
    uint256 public buyLimit = 20000 ether;
