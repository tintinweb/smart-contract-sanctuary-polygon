...
contract Industries is Initializable, OwnableUpgradeable {
    ...
    // @dev helmet_id => Helmet_genome
    mapping( uint256 => uint256 ) private _helmetsGenome;
    ...
    function getHelmetGenome( uint256 helmet_id ) public view returns ( uint256 ) {
        return  _helmetsGenome[ helmet_id ];
    }
    ...
    function createPart( address to, string memory URI ) public onlyOwner {
        NFT_1155 nft_1155 = _Validators._NFT_1155();
        nft_1155.mint( to, NFT_AMOUNT, URI );
    }

    function createLand( address to, string memory URI ) public onlyOwner {
        NFT_1155 nft_1155 = _Validators._NFT_1155();
    ...
    function createLands( address to, uint256 quantity, string[] memory URIs ) public onlyOwner {
        for (uint256 i = 0; i < quantity; i++) createLand( to, URIs[i] );
    }

    function createArena( address to, string memory URI ) public onlyOwner {
        NFT_1155 nft_1155 = _Validators._NFT_1155();
    ...
    function createArenas( address to, uint256 quantity, string[] memory URIs ) public onlyOwner {
        for (uint256 i = 0; i < quantity; i++) createArena( to, URIs[i] );
    }

    function createHelmet( address to, uint256 genome, string memory URI ) public onlyOwner {
        NFT_1155 nft_1155 = _Validators._NFT_1155();

        uint256 helmet_id = nft_1155.tokenID();
        createPart( to, URI );
        _helmetsGenome[ helmet_id ] = genome;
        validateAsHelmet( helmet_id );

        emit CreatePart( "Helmet", to, helmet_id );
    }

    function createHelmets( address to, uint256 quantity, uint256[] memory genomes, string[] memory URIs ) public onlyOwner {
        for (uint256 i = 0; i < quantity; i++) createHelmet( to, genomes[i], URIs[i] );
    }

    function createNexus( address to, string memory URI ) public onlyOwner {
        NFT_1155 nft_1155 = _Validators._NFT_1155();
    ...
    function createNexuses( address to, uint256 quantity, string[] memory URIs ) public onlyOwner {
        for (uint256 i = 0; i < quantity; i++) createNexus( to, URIs[i] );
    }

    function createCore( address to, string memory URI ) public onlyOwner {
        NFT_1155 nft_1155 = _Validators._NFT_1155();
    ...
    function createCores( address to, uint256 quantity, string[] memory URIs ) public onlyOwner {
        for (uint256 i = 0; i < quantity; i++) createCore( to, URIs[i] );
    }

    function createWeapon( address to, string memory URI ) public onlyOwner {
        NFT_1155 nft_1155 = _Validators._NFT_1155();
    ...
    function createWeapons( address to, uint256 quantity, string[] memory URIs ) public onlyOwner {
        for (uint256 i = 0; i < quantity; i++) createWeapon( to, URIs[i] );
    }

    function createAccessory( address to, string memory URI ) public onlyOwner {
        NFT_1155 nft_1155 = _Validators._NFT_1155();
    ...
    function createAccessories( address to, uint256 quantity, string[] memory URIs ) public onlyOwner {
        for (uint256 i = 0; i < quantity; i++) createAccessory( to, URIs[i] );
    }

    function createMotion( address to, string memory URI ) public onlyOwner {
        NFT_1155 nft_1155 = _Validators._NFT_1155();
    ...
    function createMotions( address to, uint256 quantity, string[] memory URIs ) public onlyOwner {
        for (uint256 i = 0; i < quantity; i++) createMotion( to, URIs[i] );
    }
