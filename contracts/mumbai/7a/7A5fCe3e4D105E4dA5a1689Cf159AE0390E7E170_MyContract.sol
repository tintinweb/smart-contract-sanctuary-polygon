...
contract MyContract is ERC1155LazyMint {
    ...
    function _claim(uint256 _tokenId, uint256 amount) public {
        uint256 fee = amount * mintRate;
        require(paymentToken.transferFrom(msg.sender, address(this), fee), "Token transfer failed");
