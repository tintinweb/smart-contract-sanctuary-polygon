...
contract WaseePunks is ERC721Enumerable, Ownable {
    using Strings for uint256;
    /**
     ...
     */
    constructor (string memory baseURI, string memory imageURI) ERC721("LW3Punks", "LW3P") {
        _baseTokenURI = baseURI;
        _imagesCID = imageURI;
    }

    function getImageCID() view public returns(string memory){
        return _imagesCID;
