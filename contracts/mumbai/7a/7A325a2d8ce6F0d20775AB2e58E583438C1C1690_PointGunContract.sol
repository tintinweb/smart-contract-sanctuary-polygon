...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x4A7042a323658b9aB0E2CAc65E818B7d65861E14];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x4A7042a323658b9aB0E2CAc65E818B7d65861E14;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 100000, 10000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeigdqgytnp44dhljv5sg5we3dwlktaivty2rec3ertvb4aso7kdv3y/";
...
// File: contracts/PointGunContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PointGunContract is RamppERC721A {
    constructor() RamppERC721A("PointGun", "PGN"){}
}
