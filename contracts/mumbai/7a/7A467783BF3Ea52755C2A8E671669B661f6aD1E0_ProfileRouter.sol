...
contract ProfileRouter {
    ...
    address private constant _GRATEFUL_PROFILE = 0x12051828B5e529636Fe6F7De5d4DCeE3c210a367;
        ...
        assembly {
            ...
            function findImplementation(sig) -> result {
                if lt(sig,0x6352211e) {
                    ...
                    switch sig
                    case 0x30176e13 { result := _GRATEFUL_PROFILE } // GratefulProfile.setBaseTokenURI()
