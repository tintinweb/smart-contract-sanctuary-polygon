...
//    @@@    ::   :::  @@@@@@@   :: ::::  ::: ::::  @@@@@@@   :   : :  ::         ::  @@@@@@@     \\
    ...
    string private constant ATTRIBUTE_TABLE_PREFIX = "spaces";
    ...
    function mintSpace(string memory spaceName) public {
    ...
    // function to initialize the communication orbis-ceramic layer
    // Each space has an Orbis Group like discord using the Ceramic Network
    ...
    // Function to check if a SpaceName exists
    ...
    // Function to dynamically change the cid of the audio file for a specific tokenID (nft)
    ...
    // function to dynamically add attributes to an NFT only owners of that NFT can make that action
    ...
    // Function to dynamically update attributes to an NFT only owners of that NFT can make that ACTION
    ...
    // Function to check if 2 on memory string are equal
    ...
    // Overriten tokenURI function to fit Tableland based NFTs
	function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
    ...
    // returns the tableland base uri for their gateway
    function tableURI() internal view returns (string memory) {
        return _baseURIString;
    }
    // Setting tableland BaseUri for their future updates
    function setTableURI(string memory baseURI) public  {
        _baseURIString = baseURI;
    }

    // returns the link to fetch all the data inside the main nft table
    ...
    // returns the link to fetch all the data inside the attribute nft table
    ...
    // returns the link to fetch all the data inside the space table
    function space_TableURI() 
    public view returns (string memory) {
        return string.concat(
            tableURI(), 
            "SELECT%20*%20FROM%20",
