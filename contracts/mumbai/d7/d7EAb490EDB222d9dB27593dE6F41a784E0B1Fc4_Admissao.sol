...
//File： fs://1f2a5942eeba4b9a8b0f973a3f29f037/Admissao.sol
...
contract Admissao is DefaultOperatorFilterer, ERC721A, Ownable {
    ...
    uint256 public maxSupplyMonthly = 1;
    uint256 public maxSupplyYearly = 1;
    ...
    uint256 public nftValueMonthly = 10000000000000000;
    uint256 public nftValueYearly = 10000000000000000;
    ...
    function setMaxSupplyMonthly(uint256 value) public onlyOwner {
        maxSupplyMonthly = value;
    }

    function setMaxSupplyYearly(uint256 value) public onlyOwner {
        maxSupplyYearly = value;
    }
    ...
    function mintMonthly(uint256 _mintAmount, address payable _endUser, string memory _cid) public payable {
        ...
        require(contNftsMonthly + _mintAmount <= maxSupplyMonthly, "Quantidade limite de NFT excedida");
        require(_mintAmount + balanceOf(_endUser) <= maxSupplyMonthly + maxSupplyYearly, "Quantidade limite de mint na colecao");
    ...
    function mintYearly(uint256 _mintAmount, address payable _endUser, string memory _cid) public payable {
        require(!paused, "O contrato pausado");
        require(_mintAmount > 0, "Precisa mintar pelo menos 1 NFT");
        require(contNftsYearly + _mintAmount <= maxSupplyYearly, "Quantidade limite de NFT excedida");
        require(_mintAmount + balanceOf(_endUser) <= maxSupplyMonthly + maxSupplyYearly, "Quantidade limite de mint na colecao");
    ...
    function _setTokenURI(uint256 _tokenId, string memory _cid) public {
        require(walletsOwner[msg.sender] == msg.sender, "Apenas wallets permitida");
        cids[_tokenId] = _cid;
    }
