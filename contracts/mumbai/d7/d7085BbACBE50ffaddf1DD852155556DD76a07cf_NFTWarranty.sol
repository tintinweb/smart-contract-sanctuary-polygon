...
contract NFTWarranty is ERC721URIStorage {
    ...
    function createNFT(string memory tokenURI,uint256 sellerId,string memory productId,address customer,uint256 expiry)public{
      ...
      sellerWarrantyDetails[sellerId][Id].tokenURI = tokenURI;
    ...
    function getTokenURI(uint256 sellerId,uint256 tokenId)public view returns (string memory ){
        return tokenURIList[sellerId][tokenId];
    }
