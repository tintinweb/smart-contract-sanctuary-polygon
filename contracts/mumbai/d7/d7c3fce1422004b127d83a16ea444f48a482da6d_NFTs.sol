...
contract NFTs is ERC721, Ownable {
    ...
    uint public constant maxNFTpurchase = 5;

    uint256 public MAX_NFTS = 25;

    bool public saleIsActive = false;
    
    constructor() ERC721("Doodles", "DOO") { }
    ...
    */
    function mint(uint numberOfTokens) public payable {
        ...
        require(numberOfTokens <= maxNFTpurchase, "Can only mint 5 tokens at a time");
