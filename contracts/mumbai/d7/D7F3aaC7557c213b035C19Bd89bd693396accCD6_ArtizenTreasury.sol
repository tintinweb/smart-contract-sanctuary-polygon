...
contract ArtizenTreasury is IArtizenTreasury, Ownable {
    ...
    uint256 public override grantUSDCInTreasury;
    ...
    address public override usdcAddress; // needed for lending pool ops
    ...
    event USDCDeposit(uint256 amountDeposited, uint256 protocolFeeOnDeposit);
        ...
        onlyArtizenCore
    {
        ...
        require(grantUSDCInTreasury >= _amount, "ART_T: GRANT USDC TOO LOW");

        (
            uint256 _usdcInTreasury,
            uint256 _usdcInAave
        ) = getUSDCInTreasuryAndAave();
        ...
        require(
            _usdcInTreasury + _usdcInAave >= grantUSDCInTreasury,
            "ART_T: SANITY CHECK FAILED"
        );

        // Account for withdraw
        grantUSDCInTreasury -= _amount;
    ...
    // Reduce protocol fee by increasing grantUSDCInTreasury
        ...
        onlyOwner
    {
        ...
        require(
            (_usdcInTreasury + _usdcInAave - grantUSDCInTreasury) >= _amount,
        ...
        returns (uint256)
    {
        ...
        return (_usdcInTreasury + _usdcInAave - grantUSDCInTreasury);
    }
