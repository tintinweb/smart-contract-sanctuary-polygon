...
contract NoblyWorld is ERC721, Ownable, ReentrancyGuard {
    ...
    uint public _reservedTokens = 10;
    uint256 _mintPrice = 0.1 * 10 ** 18;        // 0.1 ETH
...
//  constructor() ERC721("Nobly World", "NoblyWorld") {
    ...
    function claimRoyalties() external {
        ...
        _totalClaimable = _totalClaimable.sub(availableToClaim);
    ...
    function mintNFT(uint256 maxNFT) public payable {
        ...
        require(
            ...
            "You must mint a minimum 1 and maximum of 10"
        );
