...
contract Domains is ERC721URIStorage {
 ...
 constructor(string memory _tld) ERC721 ("Crypton Name Service", "CNS") payable {
    ...
    bytes(
      string(
        abi.encodePacked(
          '{"name": "',
          _name,
          '", "description": "A Crypton Name Service (CNS) domain", "image": "data:image/svg+xml;base64,',
