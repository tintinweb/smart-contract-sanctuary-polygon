...
// File contracts/DigigMarketplaceV2.sol
 ...
 */
contract ERC721URIStorage is ERC721Upgradeable {
    using Strings for uint256;
...
contract DigigMarketplace is ERC721URIStorage, OwnableUpgradeable {
    using CountersUpgradeable for CountersUpgradeable.Counter;
    CountersUpgradeable.Counter private _tokenIds;
    uint256 public tokenCounter;

    function initialize() public initializer {
        __ERC721_init("Digig Marketplace", "Digig");
        __Ownable_init();
    }
