...
// goerli: 0x006bdfBdb3C016C6B14DEe750dF093FDBd62Da74
// arbitrum: 0xA660D29F026A6181d049E9B6c5D9a597E21BF284
// matic: 0xD7D46Fb777B0315Fa294BdC1E11CCdD3ffEED880
...
contract ExecutableSample is AxelarExecutable {
    ...
    constructor(address gateway_, address gasReceiver_, bool _r) AxelarExecutable(gateway_) {
    ...
    function setRemoteValue2(
        ...
        gateway.callContract(relayTo, relayAddress, payload);
    }
    ...
    function addNativeGas(
        ...
        gasReceiver.addNativeGas{ value: msg.value }(
        txHash,
        logIndex,
        refundAddress
    );
