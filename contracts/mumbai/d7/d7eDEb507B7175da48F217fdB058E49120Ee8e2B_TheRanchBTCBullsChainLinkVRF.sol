...
contract TheRanchBTCBullsCommunity is 
    ...
    mapping (uint => mintingPricesInfo) public mintingPrices;
    uint public maxSupply;         // 10,000 is the total it will reach
    ...
    */
    ...
    mapping(address => BTCBullOwner) private btcBullOwners;
