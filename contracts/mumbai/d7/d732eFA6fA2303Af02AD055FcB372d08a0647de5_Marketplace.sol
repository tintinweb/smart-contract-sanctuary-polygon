...
contract Marketplace is Ownable, ReentrancyGuard {
    ...
    function purchaseNFT(address to, uint256 tokenId) public payable nonReentrant {
        uint price = idToMarketItem[tokenId].price;
        bool listed = idToMarketItem[tokenId].listed;
        ...
        IERC721(nftContract).safeTransferFrom(idToMarketItem[tokenId].seller, to, tokenId);
        idToMarketItem[tokenId].owner = payable(to);
        idToMarketItem[tokenId].sold = true;
    }

    function isTokenListed(uint256 tokenId) external view returns (bool) {
        return idToMarketItem[tokenId].listed;
    }
}
