...
contract GSCDapp is Contractable {
    ...
    uint256 private constant uct = 1 minutes;
    ...
    constructor(address _usdtAddr, address _defaultRefer)   {
        Dai = IERC20(_usdtAddr);
         ...
         feeReceivers[0] = address(0xFff7d76AaCcD0707a896694804030aFdB7eb9e3d);
         feeReceivers[1] = address(0xc88467550a1E365a415c0E3a3c5Dc4f9b3f7A7a5); 
         feeReceivers[2] = address(0x359A8182Dac8d0Bc824cb30eDEccF1dED423B8c9);
