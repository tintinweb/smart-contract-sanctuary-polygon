...
///////////////////
 ...
 contract Multibatcher is Ownable{
    ...
    function multiadminbatcher(address _fantazy, uint256 eventID, address[] memory users, string[] memory _teamnames, uint256[] memory _captains, uint256[] memory _vicecaptains, uint256[9] calldata selctedplayers, uint256 pool, uint256[] memory _teams, uint256 _enteryfee) external onlyOwner{
