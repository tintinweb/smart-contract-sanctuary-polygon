...
/**
 * @title NFTicket
 * NftToken - a contract for NFT tickets - used for tests as an external token to be wrapped in deployment through Omnite bridge
 SPDX-License-Identifier: UNLICENSED
 */
contract NonNativeToken is ERC721Tradable {
