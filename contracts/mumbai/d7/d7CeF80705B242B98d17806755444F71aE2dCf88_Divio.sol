...
contract Divio is ERC721Base, PermissionsEnumerable {
    ...
    // Add a function to set the power level
    // This function is only callable by the admin role
    function setPowerLevel(uint256 _tokenId, uint256 _powerLevel) public onlyRole(DEFAULT_ADMIN_ROLE) {
        powerLevel[_tokenId] = _powerLevel;
    }

        // Override the mintTo function of the base contract
       // Set the power level of the token to be the token ID
