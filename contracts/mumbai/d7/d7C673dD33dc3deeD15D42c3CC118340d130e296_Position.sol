...
contract Position is ReentrancyGuard, Ownable, PositionStorage {
    ...
    // uint256 ltmRatio = IMargin(IAdminFunctions(adminContract).getMarginContract()).ltmRatio(msg.sender, tokenAddress, 2);
        ...
        uniswapVersion[positionID] = version;
    ...
    function closePosition(uint256 positionId) public {
        string memory version = uniswapVersion[positionId];
    ...
    function getCurrentPrice(uint256 _positionId) public view returns (uint256) {
        string memory version = uniswapVersion[_positionId];
...
contract PositionStorage {
    ...
    mapping (uint256 => string) public uniswapVersion;
