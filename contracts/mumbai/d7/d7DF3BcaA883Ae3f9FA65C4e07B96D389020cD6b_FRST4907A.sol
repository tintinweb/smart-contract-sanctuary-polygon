...
contract FRST4907A is FRST721A, ERC4907A {
  ...
  function tokenURI(uint256 tokenId)
    ...
    view
    virtual
    override(FRST721A, ERC721A, IERC721A)
    returns (string memory)
  {
    return FRST721A.tokenURI(tokenId);
  }
  ...
  function _beforeTokenTransfers(
    ...
    uint256 startTokenId,
    uint256 quantity
  ) internal virtual override(FRST721A, ERC721A) {
    FRST721A._beforeTokenTransfers(from, to, startTokenId, quantity);
  }
  ...
  function setApprovalForAll(
    address operator,
    bool approved
  ) public override(FRST721A, ERC721A, IERC721A) {
    FRST721A.setApprovalForAll(operator, approved);
  }
  ...
  function approve(
    ...
    FRST721A.approve(operator, tokenId);
  }
}
...
import "./storage/FRST721AStorage.sol";
import "./utils/Splits.sol";
import './interfaces/ITokenWithBalance.sol';
import "./utils/OperatorFilterer.sol";

/// @title template NFT contract
contract FRST721A is ERC721A, OperatorFilterer, FRST721AStorage, Initializable, Ownable, Splits {
  ...
  function reserveFRST(uint256 numReserved) external onlyOwner {
