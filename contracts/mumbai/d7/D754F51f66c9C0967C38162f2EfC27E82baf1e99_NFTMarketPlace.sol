...
contract NFTMarketPlace is ERC721, Pausable, Ownable {
	...
	function removeItemFromMarket(uint256 id, address tokenAddress, uint256 tokenId) public ItemExists(id) IsForSale(id)
    {	
		require(activeItems[tokenAddress][tokenId] == true, "item is not on marketplace");
