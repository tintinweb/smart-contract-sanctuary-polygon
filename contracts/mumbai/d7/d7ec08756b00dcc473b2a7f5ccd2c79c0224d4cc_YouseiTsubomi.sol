...
contract YouseiTsubomi is ERC721A, IERC4906, ERC721AQueryable, AccessControl, ERC721ABurnable, ERC2981, Ownable, DefaultOperatorFilterer {
    string private baseURI = "https://arweave.net/qBT4WFhnFFYFsKJJ0HWNe4ekw8uhCADOegrB-7ykvGo/";
    address private constant FUND_ADDRESS = 0x82791D709A6C6E5E73cBa845Eb473200ab49B90C;
    ...
    uint256 private constant PRE_MAX_CAP = 1000;
    ...
    constructor(bool _callerIsUserFlg) ERC721A("YouseiTsubomi", "YouseiTsubomi") {
        _setDefaultRoyalty(FUND_ADDRESS, 1000);
        callerIsUserFlg = _callerIsUserFlg;
        _grantRole(DEFAULT_ADMIN_ROLE, owner());
        if (_callerIsUserFlg) {
            _mintERC2309(FUND_ADDRESS, 250);
        }
    }
