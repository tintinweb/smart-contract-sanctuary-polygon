    ...
    ConditionalTokensStorage
{
    ...
    /// @notice This function creates a new condition.
    ...
    /// @dev The condition result is stored on the payoutNumberators and payoutDenominator
    /// TODO: add batch redeem
    /// @param collateralToken The address of the positions' backing collateral token.
    /// @param conditionId The ID of the condition to split on.
    /// @param indices The indeces of the positions that the sender is willing to get back.
