...
ERC721EnumerableUpgradeable
{
    ...
    function initialize(address admin) public initializer {
        __ERC721_init("Courtyard NFT", "CYT");
    ...
    /**
     * @dev See {IBeaconUpgradeable-implementation}.
     */
     ...
     */
    function transferAdmin(address _to) public onlyRole(DEFAULT_ADMIN_ROLE) {
     ...
     * ================================================= OTHER ROLES =================================================
     * 
     * Roles are defined as functions to avoid issues with upgradeability when new roles are introduced.
     * 
     */
    ...
    function _baseURI() internal view virtual override returns (string memory) {
        // TODO https://github.com/courtyard-nft/courtyard-solidity-dev/issues/70
        return "https://storage.googleapis.com/test-colored-tiles/metadata";
    }
