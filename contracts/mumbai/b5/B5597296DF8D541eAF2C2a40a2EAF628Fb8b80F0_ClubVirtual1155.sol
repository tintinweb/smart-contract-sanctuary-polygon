...
contract ClubVirtual1155 is ERC1155 {
    ...
    constructor(address _auctionContract) ERC1155("http://localhost:8000/") {
    ...
    function contractSafeTransferFrom(
        ...
        super._contractSafeTransferFrom(_from, _to, _tokenId, _numberoftokens, "");
    }
