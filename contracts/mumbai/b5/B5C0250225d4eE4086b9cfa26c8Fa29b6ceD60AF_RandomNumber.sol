...
contract RandomNumber is VRFConsumerBase {
    ...
    function returnLink() public  {
        require(owner == msg.sender, "Only contract owner can withdraw LINK");
        LINK.transfer(msg.sender, LINK.balanceOf(address(this)));
    }

    function fundWithLink() public {
        LINK.transferFrom(msg.sender, address(this), 100000000000000000);
    }
}
