...
contract APIConsumer is ChainlinkClient, ConfirmedOwner{
    using Chainlink for Chainlink.Request;
    KeeperCompatibleInterface myInterface;
    ...
    */
    ...
    function requestVolumeData() public returns (bytes32 requestId) {
        ...
        req.add('get', 'http://api.coinlayer.com/api/live?access_key=8051a9f9f690c7adcd87b8c9525502c2&symbols=BTC,ETH');
        ...
        req.add('path', 'rates,ETH'); // Chainlink nodes 1.0.0 and later support this format
