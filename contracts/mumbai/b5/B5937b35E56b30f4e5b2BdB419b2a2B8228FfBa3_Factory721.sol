...
contract DigitalAssetsUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
...
import "./DigitalAssetsUser721Token.sol";
...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new DigitalAssetsUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        DigitalAssetsUser721Token token = DigitalAssetsUser721Token(address(addr));
