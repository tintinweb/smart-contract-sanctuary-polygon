...
// File: contracts/SpaceThonkSimplified.sol


// Contract: SpaceThonk
// Token ID: "SpaceThonk"
// Token Symbol: "ST"
// Author: HighSeasPiracy - tds
...
contract SpaceThonk is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxMintAmount = 35;
  bool public paused = false;
  uint256 public walletLimit = 35;
  ...
  constructor(
    ...
    mint(msg.sender, 35);
    // payments = payable(_splitterAddress);
  }
