...
contract OnDripNFT is ERC721, ERC2981, ERC721URIStorage, ERC721Enumerable {
    ...
    function mint(
        ...
        emit AccountMinted(msg.sender, tokenId, _description, _rateAmount, _renewalFee, "0x", false);  
    ...
    //onlyowner
    function updateTokenCredentials(bytes32 _credentials, uint256 _tokenId) external {
