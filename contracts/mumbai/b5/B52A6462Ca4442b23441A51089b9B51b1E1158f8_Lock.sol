...
contract Lock is ERC20 {
    ...
    function mint(
        ...
        string
            memory svgPartOne = "<svg xmlns='http://www.w3.org/2000/svg' preserveAspectRatio='xMinYMin meet' viewBox='0 0 750 350'><style>.base { fill: white; font-family: serif; font-size: 30px; }</style><rect width='100%' height='100%' fill='grey'/>";
        string
