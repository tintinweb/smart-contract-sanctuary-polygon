...
contract Phase2 is ERC721, ERC721Burnable,DefaultOperatorFilterer, ERC721Enumerable, Ownable{
    using Counters for Counters.Counter;

    Counters.Counter private _nonce;

    uint16[] private _randomNumbers;
    address public phase0NFTAddress;
    address public phase1NFTAddress;
    string private URI;
    mapping(address => uint256[]) public userNftId;

    constructor(string memory _name, string memory _symbol, address _phase0NFTAddress, address _phase1NFTAddress) ERC721(_name,_symbol) {
        phase0NFTAddress = _phase0NFTAddress;
        phase1NFTAddress = _phase1NFTAddress;
    ...
    */
    ...
    @params phase0TokenId: TokenId for phase0
    @params phase1TokenId: TokenId for phase1
    */
    function merge(uint256 phase0TokenId, uint256 phase1TokenId) public {
        require(IERC721(phase0NFTAddress).ownerOf(phase0TokenId) == msg.sender, "Phase2: You are not the owner of this NFT");
        require(IERC721(phase1NFTAddress).ownerOf(phase1TokenId) == msg.sender, "Phase2: You are not the owner of this NFT");
        require(_randomNumbers.length != 0, "Phase2: All NFT has been already minted");
        IERC721Burn(phase0NFTAddress).burn(phase0TokenId);
        IERC721Burn(phase1NFTAddress).burn(phase1TokenId);
