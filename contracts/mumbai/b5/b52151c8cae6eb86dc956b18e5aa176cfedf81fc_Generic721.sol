...
/**
Demo Contract for bowline.app. If you are a NFT Creator or Developer get in touch with us.
Join our discord - We'd love to discuss your ideas!
*/
...
/**
 * @dev Learn more about this project on bowline.app
 *
 * Generic721 is a ERC721 Contract.
 */
contract Generic721 is ERC721, ERC2981, Ownable {
    ...
    string private _baseTokenURI = "https://demo-api.bowline.app/tokens/";
    ...
    function mint() public {
        require(
            ...
            "BowlineGeneric: Public Minting is not Enabled"
        );
     ...
     *
     */
    function mintMultiple(uint256 qty) public {
        require(
            publicMintEnabled == true,
            "BowlineGeneric: Public Minting is not Enabled"
        );
        ...
        mintQuantityToWallet(qty, msg.sender);
    }
     ...
     *
     * @param tokenReceiver address of receiving wallet
     *
     * Requirements:
     * - `quantity` can't be higher than {publicMintLimitPerWallet}
     */
    function mint(address tokenReceiver, uint256 qty) public onlyOwner {
        mintQuantityToWallet(qty, tokenReceiver);
    }

    /**
     * @dev Function to be called by contract owner to enable / disable minting
     *
    ...
    /**
     * @dev _tokenURIs setter for a tokenId. This can only be done by owner.
     *
    ...
    function setTokenURI(uint256 tokenId, string memory permanentTokenURI)
        ...
        onlyOwner
    {
        require(_exists(tokenId), "BowlineGeneric: URI set of nonexistent token");
        ...
        returns (string memory)
    {
        require(
            _exists(tokenId),
            "BowlineGeneric: URI query for nonexistent token"
        );
