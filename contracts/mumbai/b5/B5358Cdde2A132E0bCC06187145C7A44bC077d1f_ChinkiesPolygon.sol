...
contract ChinkiesPolygon is ERC721, Ownable, ReentrancyGuard, ContextMixin {
    using Strings for uint256;
    ...
    uint256 public _price = 126500000000000000000;
    ...
    function togglePublicSale() public onlyOwner {
        ...
        if (publicMode) {
            adjustMintPriceInWei(126500000000000000000);
            whitelistMode = false;
            freemintMode = false;
        }
    }
    ...
    function toggleWhitelist() public onlyOwner {
        ...
        if (freemintMode) {
            adjustMintPriceInWei(76820000000000000000);
            publicMode = false;
            freemintMode = false;
        }
    }
