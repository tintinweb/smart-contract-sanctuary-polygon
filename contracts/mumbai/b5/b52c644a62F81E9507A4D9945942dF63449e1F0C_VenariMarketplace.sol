    ...
    Ownable
{
    ...
    event CancelListing(uint256 _tokenId, uint256 _nonce);
    ...
    function cancelListing(uint256 tokenId) external {
        ...
        emit CancelListing(tokenId, _sellerNonces[msg.sender][tokenId]);
    ...
    function matchListing(
        ...
        {   // Scoping for stack too deep error
            bytes32 sellerMessage = _generateAddListingHash(seller, tokenId, listingExpiry, baseTokenAddress, basePrice).toEthSignedMessageHash();
    ...
    function generateAddListingHash(
        ...
        return _generateAddListingHash(seller, tokenId, listingExpiry, baseTokenAddress, basePrice);
    }
