...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xA1C9c629691Db3E3FA35823516b233087e270710];
  address public erc20Payable = 0xA1C9c629691Db3E3FA35823516b233087e270710;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 25, 9000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmVU4UZrPYjKfUh2gGaWc8WyF39bAFN4eZQZj9N2ACnumP/";
...
// File: contracts/BoredsourheadsclubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BoredsourheadsclubContract is RamppERC721A {
    constructor() RamppERC721A("boredsourheadsclub", "BSHC"){}
}
