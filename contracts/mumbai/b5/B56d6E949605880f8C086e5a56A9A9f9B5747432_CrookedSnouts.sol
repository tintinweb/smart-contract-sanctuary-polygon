...
contract CrookedSnouts is VRFConsumerBaseV2, ERC721URIStorage {
  ...
  function requestNumbers() public {
    ...
    addressToRequestStruct[msg.sender] = RequestStruct({
      requestId: requestId,
      tokenId: tokenId,
      minted: false
    });
  ...
  function create() public {
    ...
    uint256[] memory userRandomNumbers = requestIdToRandomNumbers[userRequest.requestId];

    uint256 bg = (userRandomNumbers[0] % 7) + 1;
    uint256 face = (userRandomNumbers[1] % 8) + 1;
    uint256 eyes = (userRandomNumbers[2] % 11) + 1;
    uint256 head = (userRandomNumbers[3] % 11) + 1;
    uint256 mouth = (userRandomNumbers[4] % 11) + 1;
    uint256 nose = (userRandomNumbers[5] % 7) + 1;
