...
@notice Terms: The term 'div' is an abbreviation of 'a division of shared revenue'. This term is meant to be short and
    differentiated from many loaded or generic terms (e.g. revenue, dividend, distribution) that confer or imply
    ownership in an underlying asset which a 'div' does not. However, a div is similar to a dividend in that it is
    revenue distributed with a predictable frequency to a group of investors.
