  ...
  // MANAGING Authorization Contract Address for Call 
   ...
   // 合约部署者增加操作员
        ...
        returns(uint[] memory)
    {
        ...
        require(
            auxiliaryDevices[_type_id].margin_name == hash_attack ||  
            auxiliaryDevices[_type_id].margin_name == hash_defense ||  
            auxiliaryDevices[_type_id].margin_name == hash_hp ||
            auxiliaryDevices[_type_id].margin_name == hash_duration, 
            "wrong margin_name"
        );
        ...
        charactor[0] =  props[hash_attack];
        charactor[1] =  props[hash_defense];
        charactor[2] =  props[hash_hp];
        charactor[3] =  props[hash_duration];
