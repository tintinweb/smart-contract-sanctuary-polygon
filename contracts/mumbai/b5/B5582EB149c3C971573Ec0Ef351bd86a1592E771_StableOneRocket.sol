...
contract StableOneRocket is ERC20, ERC20Permit, ERC20Votes,ReentrancyGuard {
    ...
    function changeTransferLimit(uint256 _newLimit) public onlyModerator{
        require(_newLimit!=transferLimit && _newLimit<=1 ether,"New tranfer limit cannot be equal to old limit and cannot be greater than 1 Matic");
        transferLimit = _newLimit;
    }

    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        require(amount>=transferLimit,"Cannot tranfer amount less than minimun transfer limit");
