...
contract xUSDNFT is ERC721, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721("xUSDNFT", "XNFTs") {
        maxSupply = 10000;
   ...
   function getMaticValueForOneUSD() public view returns (uint256) {
        ...
        // Calculate the Matic value equivalent to 1 USD
        maticValue = (1e18 * maticDecimals) / uint256(maticPrice);

        finalMaticValue = maticValue;

        return finalMaticValue;
    }
}