...
// XShark is the coolest bar in town. You come in with some Reward, and leave with more! The longer you stay, the more Reward you get.
//
// This contract handles swapping to and from xReward, AMMSwap's staking token.
contract XShark is ERC20("xShark", "xShark"){
    using SafeMath for uint256;
    ...
    function enter(uint256 _amount) public {
        ...
        // Calculate and mint the amount of xReward the Reward is worth. The ratio will change overtime, as xReward is 
