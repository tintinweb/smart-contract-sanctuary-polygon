...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x10e147f183269E582aBeB30694b30155dE7f7ba9];
...
// File: contracts/TestPodcastContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract TestPodcastContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Test Podcast";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/9CNYz8IIkd0DttxDW3rM/contract-metadata";
  }
