...
//*********************************************************************//
//
//  _       __     __   _____    ____              ______           __             
// | |     / /__  / /_ |__  /   / __/___  _____   /_  __/_  _______/ /_____  __  __
// | | /| / / _ \/ __ \ /_ <   / /_/ __ \/ ___/    / / / / / / ___/ //_/ _ \/ / / /
// | |/ |/ /  __/ /_/ /__/ /  / __/ /_/ / /       / / / /_/ / /  / ,< /  __/ /_/ / 
// |__/|__/\___/_.___/____/  /_/  \____/_/       /_/  \__,_/_/  /_/|_|\___/\__, /  
//                                                                        /____/ 
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x048Af12738eBa4029D044157D67b6F634cf7bdf0];
...
// File: contracts/Web3ForTurkeyContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract Web3ForTurkeyContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Web3 for Turkey";
    string public symbol = "WEBT";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/4ZSBLNogPsDemhJQwB8L/contract-metadata";
  }
