...
contract TMV2 {
    ...
    // Events
    //
    event TournamentCreated(string title);
    ...
    function getSingleTournament(
        ...
        ReadTournament memory readData = ReadTournament({
            owner: tournaments[_tournamentId].owner,
            title: tournaments[_tournamentId].title,
            entryFee: tournaments[_tournamentId].entryFee,
            prizePool: tournaments[_tournamentId].prizePool
        });
