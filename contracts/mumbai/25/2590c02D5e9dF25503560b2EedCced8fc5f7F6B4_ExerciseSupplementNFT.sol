...
contract ExerciseSupplementNFT is ERC721, Ownable, ERC721Burnable{
    ...
    address public requireBalanceNftAddress;
    ...
    function updateRequireBalanceNftAddress(address _tokenAddress) external onlyAdmin {
        require(_tokenAddress != address(0), "INVALID NFT ADDRESS");
        requireBalanceNftAddress = _tokenAddress;
    }
}