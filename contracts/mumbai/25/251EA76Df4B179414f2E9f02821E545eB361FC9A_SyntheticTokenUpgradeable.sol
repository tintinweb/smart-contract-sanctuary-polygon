  ...
  UUPSUpgradeable
{
  ...
  /// @param _minter Address of the core LongShort contract.
  ...
  */
  ...
  function burn(uint256 amount) public override(ERC20BurnableUpgradeable, ISyntheticToken) {
    require(msg.sender == minter, "Only minter contract");
  ...
  */
  function transferFrom(
    ...
    if (recipient == minter && msg.sender == minter) {
  ...
  */
  function _beforeTokenTransfer(
    ...
    if (sender != minter && sender != address(0)) {
      Market(minter).executeOutstandingNextPriceSettlementsUser(sender);
    }
