...
contract MyToken is ERC20, Ownable {
    ...
    event mintTokens(address minterAddress, uint256 amountOfEth, uint256 amountOfTokens);
    ...
    function mint(address minterAddress) public payable onlyOwner {
        require(msg.value > 0, "Send ETH to buy some tokens");

        uint256 amountToMint = msg.value * tokensPerEth;

        //_mint(minterAddress, amountToMint * 10**uint(decimals()));
        _mint(minterAddress, amountToMint);
