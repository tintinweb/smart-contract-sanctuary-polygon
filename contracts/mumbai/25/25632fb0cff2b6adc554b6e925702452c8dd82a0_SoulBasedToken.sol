...
contract SoulBasedToken is ERC721URIStorage {
    ...
    mapping(uint256 => SBT) public sbt_info; //SBT ID => SBT Properties
    mapping(address => uint256[]) public user_info; //User => SBT_ID[]

    event SBT_mint(address minter, address receiver, uint256 SBT_ID);

    constructor() ERC721("Soul Based Token", "SBT") {
        owner = msg.sender;
    }
    ...
    function mint(
        ...
        user_info[_to].push(SBT_ID);
        sbt_info[SBT_ID] = _sbt;
