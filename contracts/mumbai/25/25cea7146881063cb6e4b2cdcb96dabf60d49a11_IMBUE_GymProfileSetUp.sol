...
pragma solidity ^0.8.7;
     ...
     function purchaseMemberShip() public payable{
          ...
          mapping(address=>mapping(address=>uint)) private OneGymVisitCount;
          mapping(address=>uint) private AllGymVisitCount;
          ClassStruct[] arr2;
          ClassStruct[] arr;
     ...
     function BookClass(address _Owner,uint _ClassId) public {
          ...
          arr2.push(_ClassDetails[_ClassId][_Owner]);
           ...
           OneGymVisitCount[msg.sender][_Owner]+=1;
           AllGymVisitCount[msg.sender]+=1;
