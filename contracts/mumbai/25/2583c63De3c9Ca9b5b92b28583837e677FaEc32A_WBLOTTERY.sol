...
contract WBLOTTERY {
    ...
    constructor() {
        ...
        // Admin = msg.sender;
        Marketing_Wallet = 0xfEF4b7f6BC223Bf4fdfF79df032DE347676B9748;
        Liquidity_Wallet = 0x08d413192e2C277AA430f4Cc597Cf8A1DBfdb2f0;
        nonce = 0;
        token = Itoken(0x6Acee9991cc47084102a84a2CcAfe63ce2A8a9A5);
        duration = 1 hours;
