  ...
  FxBaseChildTunnel
{
  ...
  // 2 ^ 8 ^ 11 == Max trait seed
  uint256 m_seedMax = 0x010000000000000000000000;
  ...
  uint256 private m_mintCost = 1000000000000000000;
  ...
  bytes32 public constant ROLE_BRIDGER_ADMIN = keccak256("ROLE_BRIDGER_ADMIN");
  ...
  function mint(address to) public payable returns (uint256) {
    ...
    require(newItemId <= maxTokens(), "Max tokens reached");
    require(
