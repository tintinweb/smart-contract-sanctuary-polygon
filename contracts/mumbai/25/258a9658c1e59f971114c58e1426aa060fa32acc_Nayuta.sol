...
contract Nayuta is ERC721A, IERC4906, ERC721AQueryable, OperatorFilterer, AccessControl, ERC721ABurnable, ERC2981, Ownable, Pausable {
    ...
    function preMint(uint64 _mintAmount, uint256 _presaleMax, BuyerRole _role, bytes32[] calldata _merkleProof, TicketID ticket) external payable whenMintable whenNotPaused {
