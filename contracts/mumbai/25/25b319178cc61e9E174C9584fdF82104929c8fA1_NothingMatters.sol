 ...
 * @notice This contract handles minting Nothing Matters tokens.
 */
contract NothingMatters is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x14705D808d3390888ea6CaF15c9b30Ca004EdDAb;
    ...
    address public royaltyAddress = 0x10de7A90d29DE2a6711Bf97eF8B77702DBad842f;
    address[] public payoutAddresses = [
        0x10de7A90d29DE2a6711Bf97eF8B77702DBad842f
    ];
    ...
    string public name = "Nothing Matters";
    ...
    constructor(uint256 _heymintFeePerToken, address _crossmintAddress)
        ERC1155(
            "ipfs://bafybeiewz3vog3n5uu3st7bwl6bfjvmx7zmfingyssjwvig2pduoronnkm/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenPublicPrice[2] = 0.015 ether;
