...
contract Ownable is Context {
    ...
    contract PQLtoken is Context, IERC20, Ownable {
    ...
    /*===========constructor================-*/
    constructor( address _toOwner,  address _toLiquidityPool  ) {
        toOwner = _toOwner;
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        _transfer(sender, recipient, amount);
         emit transferTokens(sender, recipient, amount);
        return true;
    }
    ...
    function approve(address _spender, uint256 _amount) public returns (bool success) {
        ...
        require(balances[owners] >= _amount ,"BEP20: user balance is insufficient");
        allowed[owners][_spender]=_amount;
        emit Approval(owners, _spender, _amount);
        return true;
    }
    ...
    function sendTexfeeTollAll() private {
        _transferTokenBalances(taxSender,toOwner,calculateTax(taxFee,25));
