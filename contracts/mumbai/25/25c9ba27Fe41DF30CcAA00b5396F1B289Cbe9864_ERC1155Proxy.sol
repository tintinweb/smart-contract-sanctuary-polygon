...
contract ERC1155Proxy is LibAuthorizable, IAssetProxy {
    ...
    address public _erc1155TradeableAddress;
    ...
    function transferFrom(
        ...
        if (
            _erc1155TradeableAddress == address(0) ||
            _erc1155TradeableAddress == erc1155TokenAddress
        ) {
    ...
    function configProxy(
        address erc1155TradeableAddress,
        bool batchTransfer,
        bool offChainSupply
    ) external onlyOwner {
        _erc1155TradeableAddress = erc1155TradeableAddress;
