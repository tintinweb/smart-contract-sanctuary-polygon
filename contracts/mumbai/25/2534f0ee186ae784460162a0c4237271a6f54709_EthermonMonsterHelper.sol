...
contract EthermonMonsterHelper is Ownable {
    ...
    function monsterWorldTokenOfOwnerByIndex(address addr, uint256 index)
        public
        view
        returns(uint64, uint32, address, string memory, uint32, uint256[] memory baseStats, uint256[] memory currentStats)
        {
            uint256 resp = EthermonMonsterContract.tokenOfOwnerByIndex(addr, index);
            (uint64 monId, uint32 classId, address trainer, string memory name, uint32 exp,,,) = EthermonDataContract.monsterWorld(uint64(resp));
    ...
    function getBaseStatsArray(uint64 monId)
        public
        view
        returns (uint256[] memory baseStats)
        {
    ...
    function getcurrentStatsArray(uint64 monId)
        public
        view
        returns (uint256[] memory CurrentStats)
        {
