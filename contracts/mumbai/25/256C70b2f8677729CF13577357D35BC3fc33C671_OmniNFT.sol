...
// File: contracts/Omnibotz/OmniNFTEth.sol
...
contract OmniNFT is ERC721Enumerable, NonblockingReceiver, ILayerZeroUserApplicationConfig {
    using Strings for uint256;
    ...
    function mint(uint256 quantity) external {
        ...
        require(quantity <= maxPerTx && balanceOf(msg.sender) < maxPerTx, "ONLY_3_PER_WALLET");
    ...
    function toggleWhiteSale(bool _state) public onlyOwner {
        whiteListingSale = _state;
    }
