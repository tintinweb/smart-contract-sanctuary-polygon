    ...
    UUPSUpgradeable
{
    ...
    function proposeWithSettings(
        ...
        uint256 _previousVotingDelay = super.votingDelay();
        uint256 _previousVotingPeriod = super.votingPeriod();
        uint256 _previousQuorum = super.proposalThreshold();

        super.setVotingDelay(_votingDelay);
        super.setVotingPeriod(_votingPeriod);
        super.setProposalThreshold(_quorum);

        uint256 _ptx = super.propose(targets, values, calldatas, description);

        super.setVotingDelay(_previousVotingDelay);
        super.setVotingPeriod(_previousVotingPeriod);
        super.setProposalThreshold(_previousQuorum);
