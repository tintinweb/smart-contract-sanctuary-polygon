...
contract POS is POSFactory {
    ...
    constructor( ) ERC1155("")  {
        ...
        GameCollection[Collection.OTHER]= TokenProperies(10058,10058,10058,1 ether,false,"",1000*1000*1000);
    }
          function mint(Collection _collection, uint256 _tokenamount) external payable {
