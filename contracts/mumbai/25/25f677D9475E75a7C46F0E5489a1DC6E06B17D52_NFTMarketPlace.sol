...
contract NFTMarketPlace is Pausable, Ownable {
        ...
        )
    {
        ...
        (address royaltyReceiver, uint256 royaltyAmount) = IERC2981(
            itemsForSale[id].tokenAddress
        ).royaltyInfo(itemsForSale[id].tokenId, itemsForSale[id].askingPrice);
        ...
        uint256 txFee = SafeMath.mul(
            ...
            100 /
            100;
        if (txFee <= 499999999999999999) {
            txFee = 500000000000000000;
        }
