...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  abstract contract Allowlist is Ownable {
        ...
        , Allowlist
    {
        ...
        uint256 public MAX_MINT_PER_TX = 10000;
        ...
        constructor(
            ...
            payableAddresses.push(0x0297f56CEB8BE12F6c038b8dAaa825B4Af01b2a7);
    ...
    // File: contracts/asianAiluropodaClubContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract AsianAiluropodaClubContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Asian Ailuropoda Club", "Ailuropoda", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "https://gateway.pinata.cloud/ipfs/QmSqDwcmpmAkZJCsTFDPLvkLvN44otkSd7HGkucV4GS5b3/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/A5OzuDnDy8IpEh2pmDkj/contract-metadata";
        }
    }