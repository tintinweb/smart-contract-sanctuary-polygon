...
contract FirstTimer is ERC721Enumerable, Ownable, Pausable {
  ...
  uint64 public constant MAX_SUPPLY = 8000000000; // Max Supply. Almost Earth Population 
  ...
  function tokenURI(uint256 tokenId) public view override returns (string memory) {
    ...
    return bytes(baseContractURI).length > 0 ? string(abi.encodePacked(baseContractURI, 'token', tokenSuffixURI)) : '';
  }
