...
contract DCApp {
    ...
    */
    ...
    constructor()
    {
        ...
        exchangeFactoryAddress = 0x5757371414417b8C6CAad45bAeF941aBc7d3Ab32;
    }
    ...
    //-------------REPLACE WETHTESTNET BY WBNB FOR THE MAIN CHAIN-----------
    address private constant WETHTESTNET =
        ...
        public
    {
        ...
        */
        ...
        uint256 estimatedMinimumAmountOut = IUniswapV2Router02(
    ...
    function swap(
        ...
        */
        ...
        if (_tokenIn != address(0) && _tokenOut != address(0)) {
            ...
            IUniswapV2Router02(exchangeRouterAddress)
        ...
        returns (address[] memory)
    {
        ...
        */
        ...
        else if (_tokenIn == WETHTESTNET || _tokenOut == WETHTESTNET) {
            path = new address[](2);
            path[0] = _tokenIn;
            path[1] = _tokenOut;
        } else {
