...
contract NFTFusion is Pausable, Ownable {
    using ECDSA for bytes32;

    event NFTFused(address indexed _sender, uint256 assetQuantity, string _assetsId, uint256[] _tokenIds, uint256[] _tokenAmounts, uint256 rERC20TokenAmount);
    ...
    event ERC20AddressChanged(address _owner, address indexed oldAddress, address indexed newAddress);
    event ERC1155AddressChanged(address _owner, address indexed oldAddress, address indexed newAddress);
    ...
    address private burner = 0x000000000000000000000000000000000000dEaD;

    uint256 public fusionCounter = 0;
   ...
   function setErc20TokenAddress(address _newErc20Token) external onlyOwner {
    ...
    function fuse(
        ...
        require(assetQuantity > 0, "asset quantity should be greater than zero");
