...
contract LotteryChainGame is Ownable {
    ...
    function startLottery () public {
        ...
        for(uint256 i = 0; i<lastWinnersAddresses.length; i++){
            ...
            lastWinnersProfits[lastWinnersAddresses[i]] = profit / numberOfWinners;
    ...
    function getLotterySettings() public view returns(uint256 [8] memory){
