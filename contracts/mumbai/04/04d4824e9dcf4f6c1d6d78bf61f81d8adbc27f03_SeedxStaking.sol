...
contract States {
    ...
    // testnet
    // seedx token
    IERC20 public stakingToken = IERC20(0xC7A4Aa892FB81Dc7F69e2BB78192377403BEF3da);
    // usdt token
    IERC20 public rewardingToken = IERC20(0xC7A4Aa892FB81Dc7F69e2BB78192377403BEF3da);
...
contract SeedxStaking is States, Ownable {
    ...
    function _stakeTokens(uint256 _amount, uint256 _tier)  internal {
        ...
        if(user.stakedAmount>0 && claimcurrentReward > 0){
          _claim(_msgSender(), user.tier);
        }
