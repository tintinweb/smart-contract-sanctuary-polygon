...
abstract contract Ownable is Context {
	 ...
	 */
	constructor() {
		_setOwner(0x56D6e9bB39888b50DFBba837759f4C629Abc61E8);
	}
...
contract Ff is ERC721Enumerable, Ownable, ReentrancyGuard {

	uint256 public TOKEN_MAX_AMOUNT = 333;
	uint256 public TOKEN_PER_TX = 333;
	uint256 public TOKEN_PER_WALLET = 333;
	uint256 public PRICE = 33 ether;
	uint256 public constant TIME_FOR_GROWN = 1687498674613;
