...
function getTokenURI(uint256 tokenId) public view returns (string memory){
    ...
    tokenIdToLevels[tokenId] = currentLevel * 6; //psuedonumber instead of +1
    _setTokenURI(tokenId, getTokenURI(tokenId));

    uint256 currentSpeed = tokenIdToSpeed[tokenId];
    tokenIdToSpeed[tokenId] = currentSpeed * 10; //psuedonumber instead of +1
    _setTokenURI(tokenId, getTokenURI(tokenId));

    uint256 currentStrength = tokenIdToStrength[tokenId];
    tokenIdToStrength[tokenId] = currentStrength * 8; //psuedonumber instead of +1
    _setTokenURI(tokenId, getTokenURI(tokenId));
