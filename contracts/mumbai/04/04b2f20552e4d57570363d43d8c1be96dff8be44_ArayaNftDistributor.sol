...
contract ArayaNftDistributor is ContextMixin, AccessControl, Pausable, Withdrawable, ReentrancyGuard, NativeMetaTransaction {
    ...
    */
    ...
    constructor() {
        string memory _name = "Distributor";
        address arayaNftContractAddress = 0x6FCD7073C66b93434e7f9329F5C9b6F2aAb29B55;
        address fearContractAddress = 0x9006Cf37B092C03f77e2428B1220968E6DA399E9;
        arayaNftContract = IArayaNft(arayaNftContractAddress);
        fearContract = IERC20(fearContractAddress);
        _initializeEIP712(_name);
        setPrice(1, 20 ether, 1000);
        setPrice(2, 10 ether, 1000);
        _unpause();
    }
    ...
    */
    function buyTokens(uint256 id, uint256 amount) public whenNotPaused nonReentrant {
        address caller = ContextMixin.msgSender();
        ...
        require(!limitBuyPerWallet || amount + salesLog[caller][id] <= walletLimit[id], "Total amount exceeds token limit per wallet.");
    ...
    function toggleBuyLimit() public {
        limitBuyPerWallet = !limitBuyPerWallet;
    }
