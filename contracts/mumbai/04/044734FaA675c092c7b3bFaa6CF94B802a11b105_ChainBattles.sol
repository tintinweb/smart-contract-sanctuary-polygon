...
import "@openzeppelin/contracts/token/ERC721/extensions/ERC721URIStorage.sol";      // mint the NFTs
import "@openzeppelin/contracts/utils/Counters.sol";    // handles and stores our tokenIDs
import "@openzeppelin/contracts/utils/Strings.sol";     // implement "toString()" function: convert data into strings
import "@openzeppelin/contracts/utils/Base64.sol";      // handle base64 data like on-chain SVGs
