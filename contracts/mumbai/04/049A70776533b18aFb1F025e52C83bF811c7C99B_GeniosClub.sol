...
contract GeniosClub is IGeniosClub {
  ...
  mapping(uint8 => Rank_Requirement) public RankReq;
  ...
  constructor(
    ...
    RankReq[1] = Rank_Requirement({
      TotalTeam: 10,
      DirectRefs: 3,
      ActiveInMatrix: 1
    });
    RankReq[2] = Rank_Requirement({
      TotalTeam: 40,
      DirectRefs: 3,
      ActiveInMatrix: 1
    });
    RankReq[3] = Rank_Requirement({
      TotalTeam: 40,
      DirectRefs: 3,
      ActiveInMatrix: 1
    });
    RankReq[4] = Rank_Requirement({
      TotalTeam: 640,
      DirectRefs: 3,
      ActiveInMatrix: 1
    });
    RankReq[5] = Rank_Requirement({
      TotalTeam: 2560,
      DirectRefs: 3,
      ActiveInMatrix: 1
    });
    RankReq[6] = Rank_Requirement({
      TotalTeam: 10240,
      DirectRefs: 3,
      ActiveInMatrix: 1
    });
    RankReq[7] = Rank_Requirement({
      TotalTeam: 40960,
      DirectRefs: 3,
      ActiveInMatrix: 1
    });
    RankReq[8] = Rank_Requirement({
      TotalTeam: 163840,
      DirectRefs: 3,
      ActiveInMatrix: 0
    });
  ...
  function updateG3X2(
    ...
    if (x2 == 0) {
      ...
      UsersTeams[Users[refAddr].G3X2Matrix[level].FirstLevelRefs[0]]
        .G3x2FirstTeam++;
      ...
      UsersTeams[Users[refAddr].G3X2Matrix[level].FirstLevelRefs[1]]
        .G3x2FirstTeam++;
      ...
      UsersTeams[Users[refAddr].G3X2Matrix[level].FirstLevelRefs[2]]
        .G3x2FirstTeam++;
  ...
  function updateG3X7Referrer(
    ...
    if (
      ...
      Users[refAddr].Ranks[level].TotalTeam > RankReq[level].TotalTeam &&
      Users[refAddr].Ranks[level].DirectRefs > RankReq[level].DirectRefs &&
      Users[refAddr].ActiveG3X7Levels[level + RankReq[level].ActiveInMatrix]
    ) {
      IPool(PoolAddr).AddUser(level, refAddr);
      Users[refAddr].Ranks[level].IsActive = true;
      emit RankEarners(Users[refAddr].Id, refAddr, level);
    }
  ...
  function updateG3X7(
    ...
    if (x2 == 0) {
      ...
      UsersTeams[Users[refAddr].G3X7Matrix[level].FirstLevelRefs[0]]
        .G3x7FirstTeam++;
      ...
      UsersTeams[Users[refAddr].G3X7Matrix[level].FirstLevelRefs[1]]
        .G3x7FirstTeam++;
      ...
      UsersTeams[Users[refAddr].G3X7Matrix[level].FirstLevelRefs[2]]
        .G3x7FirstTeam++;
  ...
  function sendTokenDividends(
    ...
    if (matrix == 1) {
      ...
      Platform.G3X2TotalEarnings += amount;
      Users[receiver].G3X2Earnings += amount;
      Users[receiver].G3X2Matrix[level].Earnings += amount;
      ...
      for (uint8 i = 1; i <= 7; i++) {
        ...
        uint256 amount = calPerc(LevelPrice[level], LevelPricePercentage[i]);
        TransferHelper.safeTransfer(TOKEN, receiver, amount);

        Platform.G3X7TotalEarnings += amount;
        Users[receiver].G3X7Earnings += amount;
        Users[receiver].G3X7Matrix[level].Earnings += amount;
