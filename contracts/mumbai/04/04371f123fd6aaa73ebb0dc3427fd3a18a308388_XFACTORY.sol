...
// was setup for PAE token, total supply of 1mil, and breakdown of 850k, 100k, 45k, 95k // formatted to 18 decimals already..

    uint256 public constant XFACTORY_REWARD_POOL_ALLOCATION = 7000 ether; // xfactory total supply allocation(8766)
    uint256 public constant INIT_TREASURY_FUND_POOL_ALLOCATION = 877 ether; // 10% for initial marketing and needs
