...
contract MasterChef is Ownable {
    ...
    function set(
        ...
        // The function first checks that the deposit fee basis points are less than or equal to 10000
        ...
        // The function updates the allocation point and deposit fee basis points for the specific pool in the poolInfo mapping
    ...
    function deposit(uint256 _pid, uint256 _amount) public {
        ...
        if (_amount > 0) {
            ...
            // // If there is a deposit fee associated with the pool
            // if (pool.depositFeeBP > 0) {
            //     // The function calculates the deposit fee
            //     uint256 depositFee = _amount.mul(pool.depositFeeBP).div(10000);
            //     // The function performs a safe transfer of the deposit fee to the feeAddress
            //     pool.lpToken.safeTransfer(feeAddress, depositFee);
            //     // The function updates the user's balance in
            //     // the pool by adding the deposit amount minus the deposit fee
            //     user.amount = user.amount.add(_amount).sub(depositFee);
            // } else {
                // If there is no deposit fee, the function updates
