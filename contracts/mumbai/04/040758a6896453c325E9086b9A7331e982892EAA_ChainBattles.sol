...
contract ChainBattles is ERC721URIStorage {
    ...
    function mint() public {
        ...
        uint256[4] memory rns = randomNumbers(20);
        tokenIdToLevels[newItemId].level = 1;
        tokenIdToLevels[newItemId].speed = 30 + rns[0];
        tokenIdToLevels[newItemId].strength = rns[1];
        tokenIdToLevels[newItemId].life = rns[2] * 5;
    ...
    function randomNumbers(uint256 number)
        public
        view
    ...
    function getLevels(uint256 tokenId) public view returns (string[4] memory) {
