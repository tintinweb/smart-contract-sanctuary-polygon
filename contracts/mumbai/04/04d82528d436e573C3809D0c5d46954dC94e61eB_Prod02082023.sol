...
contract Prod02082023 is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
  ...
  uint256 public PRESALE_COUNT = 0;
    ...
    string private preRevealURI = "https://ipfs.w3bmint.xyz/ipfs/QmP7fbh6LRdQELpnocCYyLejMCKHnRrveGUfYT574eB547";

    mapping(address => uint256) addressBlockBought;

    address public constant RL_ADDRESS = 0xc9b5553910bA47719e0202fF9F617B8BE06b3A09; 

    constructor() ERC721A("Prod02082023", "TOKEN") {
