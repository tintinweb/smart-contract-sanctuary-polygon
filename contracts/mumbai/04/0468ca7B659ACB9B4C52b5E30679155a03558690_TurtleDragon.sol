...
/**
 * @title TurtleDragon contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract TurtleDragon is ERC721, ERC721Enumerable, Ownable {
    using SafeMath for uint256;

    uint256 public constant MAX_ALLOW_LIST_MINT = 2;
    uint256 public constant MAX_PUBLIC_MINT = 10;
    uint256 public constant TOKEN_LIMIT = 10000;
    uint256 public constant turtleDragonPrice = 0.095 ether;
    ...
    constructor() ERC721("TurtleDragons", "TRTLDGN") {}
    ...
    function mint(uint256 numTokens) external payable {
        ...
        require(msg.value >= turtleDragonPrice.mul(numTokens), "Purchase value sent is not correct");
