...
import {ISheeshaRetroLPVault, ISheeshaVaultInfo} from "../utils/Interfaces.sol";

contract SheeshaRetroLPVaultProxy is ISheeshaVaultInfo, Ownable {
    ...
    function token() external view override returns (address token_) {
        (token_, , , ) = ISheeshaRetroLPVault(retroVault).poolInfo(0);
    }
    ...
    {
        (stakeOf_, , , ) = ISheeshaRetroLPVault(retroVault).userInfo(0, member);
    }
