...
contract PrintzNft is ERC721A, Ownable, ReentrancyGuard {
    ...
    function ownerMintForAddress(address _receiver) external onlyOwner {
        require(totalSupply() + 1 <= MAX_SUPPLY, "Not enough tokens left");
    ...
    function mintForAddress(
        ...
        // require(_numberMinted(_receiver) < _mintAmount, "Reciever Has Exceeded the limit");
        _safeMint(_receiver, 1);
    }

    function mint(uint256 _mintAmount) external payable {
        // require(_numberMinted(msg.sender) < _mintAmount, "Minter Has Exceeded the limit");
