...
contract SxTRelayProxy is Initializable, OwnableUpgradeable, ISxTRelay {
    ...
    /// @dev Implementation SxTRelay contract address
    ISxTRelay public implementation;

    function initialize(ISxTRelay sxtRelay) public initializer {
        implementation = sxtRelay;
        __Ownable_init();
    }

    function FEE() external view override returns (uint256) {
        uint256 feeAmount = implementation.FEE();
        return feeAmount;
    }

    function currentRequestId() external view override returns (bytes32) {
        bytes32 requestId = implementation.currentRequestId();
        return requestId;
    }

    /// @dev Set Implementation contract address
    function setImplementation(ISxTRelay _sxtRelay) external onlyOwner {
        implementation = _sxtRelay;
    }

    function setChainlinkOperator(address newOperator) external override onlyOwner{
        implementation.setChainlinkOperator(newOperator);
    }

    function withdrawChainlink(address to, uint256 amount) external override onlyOwner{
        implementation.withdrawChainlink(to, amount);
    }
    ...
    function requestQueryString2D(
        ...
        bytes32 requestId = implementation.requestQueryString2D(
            query, 
            resourceId,
            callerContract,
            callbackFunctionId,
    ...
    function requestQueryUint256(
        ...
        bytes32 requestId = implementation.requestQueryUint256(
            query, 
            resourceId,
            callerContract,
            callbackFunctionId,
    ...
    function requestQueryBytes(
        ...
        bytes32 requestId = implementation.requestQueryBytes(
            query, 
            resourceId,
            callerContract,
            callbackFunctionId,
    ...
    function requestQueryString(
        ...
        bytes32 requestId = implementation.requestQueryString(
            query, 
            resourceId,
            callerContract,
            callbackFunctionId,
    ...
    function requestViewString2D(
        ...
        bytes32 requestId = implementation.requestViewString2D(
            viewName,
            callerContract,
            callbackFunctionId,
            chainlinkJobId
    ...
    function requestViewUint256(
        ...
        bytes32 requestId = implementation.requestViewUint256(
            viewName,
            callerContract,
            callbackFunctionId,
            chainlinkJobId
    ...
    function requestViewBytes(
        ...
        bytes32 requestId = implementation.requestViewBytes(
            viewName,
            callerContract,
            callbackFunctionId,
            chainlinkJobId
    ...
    function requestViewString(
        ...
        bytes32 requestId = implementation.requestViewString(
            viewName,
            callerContract,
            callbackFunctionId,
            chainlinkJobId
    ...
    function queryResponseString2D(bytes32 requestId, string[][] calldata data) external override { 
        implementation.queryResponseString2D(
            requestId,
            data
        );
    }
        
    function queryResponseUint256(bytes32 requestId, uint256 data) external override { 
        implementation.queryResponseUint256(
            requestId,
            data
        );
    }

    function queryResponseBytes(bytes32 requestId, bytes calldata data) external override { 
        implementation.queryResponseBytes(
            requestId,
            data
        );
    }

    function queryResponseString(bytes32 requestId, string calldata data) external override { 
        implementation.queryResponseString(
            requestId,
            data
        );
    }
