...
contract DropX1155OpenSea is ERC1155PresetMinterPauser, ERC1155Supply {
    string public name;
    ...
    function setMetadataUri(uint256 id, string memory _metadataUri) private {
    ...
    function mintWithMetadata(
        ...
        setMetadataUri(id, _metadataURI);
