...
{
    // Token name
    string private _name = "masoomeTey";

    // Token symbol
    string private _symbol = "MST";


    string private baseURI_ = "https://bafybeihul2xvp5kftlubxqxndltj6d5chqu5xc53mvw3emy34ikdqkf6du.ipfs.dweb.link/Clock/";


    address internal _owner = 0x0A0167096b6bF3C1743d725834cc8Bb7361E5409;

    uint internal mintCount;

    // Mapping from token ID to owner adderess
