...
contract CryptOcelots_flat is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("CryptOcelots", "COT") {
    setHiddenMetadataUri("ipfs://QmQQcMPobqvV2u7oZEkcQu6vA1MsQh3yZ5e7xbY22bkKCK.json");
  }
