...
import "./LPPrice.sol";
    ...
    */
    ...
    contract BOMICO is Pausable, LPPrice{
        ...
        event LockedAmount(address investor, uint amount, uint locktime);
        ...
        function lockAmount(address investor, uint amount, uint locktime) internal {
            ...
            emit LockedAmount(investor, amount, locktime);
        }
        ...
        function invest(uint amount, uint id) public payable whenNotPaused {
            WhitelistRound storage wlRound = _whiteListRounds[_curRound];
            ...
            if(id==0) amount = msg.value.mul(updatePriceFromLP()).div(10**matic.decimals()) ;
            require(amount > 100, "Amount should be greater than 100");
            ...
            else if (id == 1) busd.safeTransferFrom(msg.sender, masterWallet, amount);
            else if (id == 2) usdt.safeTransferFrom(msg.sender, masterWallet, amount);
            else if (id == 3) usdc.safeTransferFrom(msg.sender, masterWallet, amount);
