...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI,IERC2981 {
     ...
     * @dev See {_setURI}.
     */
    constructor(string memory uri_, string memory _name_, string memory _symbol_) {
        _setURI(uri_);
...
contract OkuGroup is ERC1155, Ownable, ERC1155Burnable {

    uint counter=1;
    address public Operator;
    mapping(uint=>string) private _getURI;


    constructor() ERC1155("","OKU-Collections","OKU") {
    }
    ...
    function mint(uint256 shares, string memory data)
        public
        returns(uint , string memory )
    {
        require(Operator==msg.sender, "!Operator");
        uint tokenId=counter;
        _getURI[tokenId]=data;
        _mint(msg.sender, tokenId, shares, data);
        counter++;
        return(tokenId,data);
    }
