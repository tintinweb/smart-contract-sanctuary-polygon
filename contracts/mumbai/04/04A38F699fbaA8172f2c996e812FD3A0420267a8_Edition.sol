    ...
    URIHandler
{
    ...
    mapping(uint256 => bool) private editionSealed;
    mapping(uint256 => address) private tokenCreators;
    mapping(uint256 => bool) private tokenSignedByCreator;
    ...
    function tokenIsSignedByCreator(
        uint256 _id
    ) external view returns (bool, address) {
        if (_id >= nextEditionId || _id < 1) revert EditionDoesNotExist();
        return (tokenSignedByCreator[_id], tokenCreators[_id]);
    }
    ...
    //  / /   / ___/ _ \/ __ `/ __/ __ \/ ___/
    // / /___/ /  /  __/ /_/ / /_/ /_/ / /
    // \____/_/__ \___/\__,_/\__/\____/_/
    //    / ____/_  ______  _____/ /_(_)___  ____  _____
    //   / /_  / / / / __ \/ ___/ __/ / __ \/ __ \/ ___/
    //  / __/ / /_/ / / / / /__/ /_/ / /_/ / / / (__  )
    // /_/    \__,_/_/ /_/\___/\__/_/\____/_/ /_/____/

    function signToken(uint256 _id) external {
        if (_id >= nextEditionId || _id < 1) revert EditionDoesNotExist();
        if (msg.sender != tokenCreators[_id]) revert OnlyCreator();
        if (tokenSignedByCreator[_id]) revert TokenSigned();

        tokenSignedByCreator[_id] = true;
    }
