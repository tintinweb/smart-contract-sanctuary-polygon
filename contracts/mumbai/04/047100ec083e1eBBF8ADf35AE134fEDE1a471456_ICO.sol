...
contract ICO is ERC20, Ownable {
    // Price of one MUN token or 1*10**18 tokens with decimals
    ...
    constructor (address _NFT) ERC20("Mancherster United Token", "MUN") {
        NFT = INFT(_NFT);
    }
    ...
    function claim() public {
        ...
        require(balance > 0, "You dont own any MUN NFT's");
