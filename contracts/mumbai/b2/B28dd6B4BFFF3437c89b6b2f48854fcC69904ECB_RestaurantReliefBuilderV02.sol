...
// File: RestaurantReliefBuilderV02.sol

/**
 * @title Restaurant Relief Builder
 * @dev builds the dynamic content of the Restaurant Relief NFTs
 */
contract RestaurantReliefBuilderV02 is AbstractDynamicURI, BaseViciContract {
    using EnumerableSet for EnumerableSet.AddressSet;
     ...
     */
    function setOracle(IRestaurantReliefOracle _oracle) public onlyURIManager {
        oracle = _oracle;
    }
    ...
    /**
     * @dev returns the description metadata for the token and the restaurant.
     */
        ...
        return
            svg.svgDocument(
                ...
                string.concat(
                    ...
                    logo(),
                    totalsLabels(tokenId, restaurant)
                )
            );
    }

    function logo() internal view returns (string memory) {
        return
            svg.g(
                ...
                string.concat(
                    svg.g(
                        string.concat(
                            svg.prop("id", "logo"),
                            svg.prop("tranform", logoElement.logoTransform)
                        ),
                        string.concat(
    ...
    function totalsLabels(uint256 tokenId, RestaurantInfo memory restaurant)
        internal
        view
        returns (string memory)
    {
        return
            string.concat(
                ...
                userSummary(tokenId, restaurant),
    ...
    function userSummary(uint256 tokenId, RestaurantInfo memory restaurant)
        internal
        view
        returns (string memory)
    {
        if (restaurant.restaurantId == 0) {
            ...
            if (
                ...
                return _restaurantSmallNomText(nomText, rName);
            }
            return _restaurantNomText(nomText, rName);
        }
    }

    function _restaurantNomText(string memory nomText, string memory rName)
        internal
        view
        returns (string memory)
    {
    ...
    function _restaurantSmallNomText(string memory nomText, string memory rName)
        internal
        view
        returns (string memory)
    {
        ...
        onlyURIManager
    {
        ...
        if (_isUpdate(elem.nomAskText)) {
            noNomElement.nomAskText = elem.nomAskText;
        }
    }
    ...
    function _initDefaults() internal {
        logoElement
            .dPath = "M400.9,244c0,18.1-3,34.8-9.1,50-6,15.2-14.5,28.2-25.5,39.2-11,11-24.1,19.5-39.5,25.5-15.4,6-32.5,9.1-51.3,9.1h-94.3V120.3h94.3c18.8,0,35.9,3.1,51.3,9.2,15.4,6.1,28.6,14.6,39.5,25.5,11,10.9,19.4,23.9,25.5,39.1,6,15.2,9.1,31.8,9.1,50Zm-47.2,0c0-13.6-1.8-25.8-5.4-36.5-3.6-10.8-8.8-19.9-15.6-27.4-6.8-7.5-15-13.2-24.6-17.2-9.6-4-20.5-6-32.6-6h-48.1v174.2h48.1c12.1,0,23-2,32.6-6,9.6-4,17.9-9.7,24.6-17.2,6.8-7.5,12-16.6,15.6-27.4,3.6-10.8,5.4-23,5.4-36.5Z";
        logoElement
            .aPath = "M639,367.7h-35.6c-4,0-7.2-1-9.8-3-2.5-2-4.4-4.5-5.6-7.4l-18.5-50.5h-102.5l-18.5,50.5c-.9,2.6-2.7,5-5.3,7.2-2.6,2.2-5.9,3.3-9.8,3.3h-35.9l97.4-247.4h46.9l97.2,247.4Zm-81.3-93.4l-30.1-82.3c-1.5-3.6-3-8-4.6-13-1.6-5-3.2-10.4-4.8-16.3-1.5,5.8-3,11.3-4.6,16.3-1.6,5.1-3.1,9.5-4.6,13.3l-29.9,82h78.7Z";
        logoElement
            .oPath = "M827.437,209.02s-12.551-.541-23.015,7.483c-10.464,8.023-11.454,8.023-18.404,8.023l-81.609-.662c-1.279,0-2.316-1.037-2.316-2.316s1.037-2.316,2.316-2.316l74.992-1.323c1.644,0,2.978-.671,2.978-2.316s-1.333-2.316-2.978-2.316l-74.992-1.323c-1.279,0-2.316-1.037-2.316-2.316s1.037-2.316,2.316-2.316l74.992-1.323c1.644,0,2.978-.671,2.978-2.316s-1.333-2.316-2.978-2.316l-74.992-1.323c-1.279,0-2.316-1.037-2.316-2.316s1.037-2.316,2.316-2.316l74.992-1.323c1.644,0,2.978-.671,2.978-2.316s-1.333-2.316-2.978-2.316l-74.992-1.323c-1.279,0-2.316-1.037-2.316-2.316s1.037-2.316,2.316-2.316l81.609-.662c6.949,0,7.94,0,18.404,8.023,10.464,8.023,23.015,7.483,23.015,7.483,11.162,.404,28.018,.736,53.433,.777-17.276-49.495-64.361-85.007-119.748-85.007-70.035,0-126.809,56.774-126.809,126.809,0,9.729,1.099,19.201,3.174,28.301h198.881c3.275,0-17.865,29.775-65.506,29.775-6.949,0-29.775,2.068-47.641-5.955-12.028-5.402-17.865-10.332-68.484-10.332-1.958,0-6.731,.21-13.178,.539,17.426,49.219,64.372,84.48,119.562,84.48,70.035,0,126.809-56.774,126.809-126.809,0-11.302-1.487-22.255-4.261-32.684-26.97,.021-44.67,.361-56.233,.779Z";
        logoElement.logoTransform = "translate(180,121.7)";
        logoElement.logoTextY = "439";
        logoElement.logoTextClass = "logo";
        logoElement.logoText = "Restaurant Relief Community";

        fundingElement.fundAmountY = "590";
        fundingElement.fundAmountClass = "amt";
        fundingElement.fundNameY = "660";
        fundingElement.fundNameClass = "norm";
        fundingElement.fundName = "Restaurant Relief Fund";

        noNomElement.nomPendingY = "827";
        noNomElement.nomPendingClass = "norm";
        noNomElement.nomPendingText = "Nomination pending review";
        noNomElement.nomAskY = "827";
        noNomElement.nomAskClass = "norm";
        noNomElement.nomAskText = "Nominate a Restaurant";
