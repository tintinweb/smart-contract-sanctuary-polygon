...
contract Router is Ownable {
    ...
    uint256 constant public POOL_CODE_LENGTH = 2;
    uint256 constant public POOL_SIZE = 100;
    uint256 constant public MIN_NUMBER = 0;
    uint256 constant public MAX_NUMBER = 99;

    uint256 public buyPrice = 1 ether;
    uint256 public subscriptionPrice = 1 ether;
    uint256 public modeChangePrice = 1 ether;
    uint256 public subscriptionDuration = 3600; // 1 hour
    uint256 public numberFreezeDuration = 600; // 10 minutes
    // TODO: Refactory TTL globaly
    uint256 public ttl = 180; // 3 minutes
