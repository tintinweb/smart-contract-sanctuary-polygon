    ...
    UUPSUpgradeable 
{
    ...
    // keccak256("GameMinerOnboard(address owner,address miners,bool bAirDrop,uint256 nonce,uint256 deadline)");
    bytes32 public constant GAME_MINER_TYPEHASH = 0xA534D65148F95D21FFBA54443D2BBCC211CB057E4CF198C41F1A64B7FC37C900;  
    ...
    ) external ensure(permitGameMiner.deadline) isGamingPhase {
        // Miner onboarding must be EOA address 
        require(!miner.isContract(), 'Game Miner: Not EOA Address');

        // Check signature
        bytes32 hashRegister = keccak256(abi.encode(GAME_MINER_TYPEHASH, owner, miner, bAirDrop, permitGameMiner.deadline));
