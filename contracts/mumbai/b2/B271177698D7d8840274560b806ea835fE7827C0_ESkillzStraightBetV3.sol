...
contract ESkillzStraightBetV3 is ESkillzStraightBetV2 {

    // function setSportAddress(SPORT _sport) external onlyOwner {
    //     sport = _sport;
    // }

    function setSportV2Address(SPORTV2 _sport) external onlyOwner {
        sportV2 = _sport;
    }
}
