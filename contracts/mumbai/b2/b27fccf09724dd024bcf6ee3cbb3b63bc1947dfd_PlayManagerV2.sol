...
contract PlayManagerV2 is Initializable, PausableUpgradeable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    string private constant APP_VERSION = "1.0.1";
    ...
    function secret() external pure returns(string memory) {
        return unicode"🐍 hic sunt dracones";
    }
