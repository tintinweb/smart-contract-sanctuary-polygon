...
contract Dao {
    ...
    constructor(){
        owner = msg.sender;
        nextProposal = 1;
        daoContract = IdaoContract(0x9F16B5D4C7150DddF4C6bDf11664525ED7813914);
        validTokens = [33484463451330739659016528953221571211830890358891695593961098534293092696065];
    }
