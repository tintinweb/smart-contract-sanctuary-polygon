...
contract DemotapersNFT is Context, ERC165, Ownable, IERC721Metadata {
    ...
    string private constant SYMBOL = 'DMT NFT';
    ...
    /**
     * @dev Set a new market address
     * @param marketAddress the new market address
    */
    function setMarketAddress(address marketAddress) external onlyOwner {
        require(marketAddress != address(0), "Market contract address is not valid");
