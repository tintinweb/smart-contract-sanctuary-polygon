...
contract ScholarMarket is SMAuth, ReentrancyGuard {
    ...
    function hireScholar(address wallet, 
       ...
       // uint256 matchFee, 
        ...
        uint256 stopLoss 
            ...
            emit Offer(
                keccak256(abi.encodePacked(nftId, block.timestamp)),
                msg.sender,
                wallet,
                nftId,
               // matchFee,
    ...
    function respondOffer(uint256 nftId, uint256 response) external {
        ...
        nftManager[nftId].accepted = response;
         ...
         emit Offer(
                keccak256(abi.encodePacked(nftId, nftManager[nftId].createdAt)),
    ...
    function settleNFT(uint256 nftId) external nonReentrant {
            ...
            emit settle(keccak256(abi.encodePacked(nftId, nftManager[nftId].createdAt)));
