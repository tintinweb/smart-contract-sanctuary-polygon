    ...
    AccessControlUpgradeable
{
    ...
    mapping(uint256 => string) private lottoNo;
    ...
    {
        return (lottoNo[_tokenId], createdAt[_tokenId]);
    }

    function safeMint(address _to, string memory _lottoNo)
        public
        onlyRole(MINTER_ROLE)
    {
        ...
        // token#1 - 256895
        // token#2 - 122667
        lottoNo[tokenIdCounter.current()] = _lottoNo;
