...
contract CompetitionFactory is ICompetitionFactory, Ownable {
    ...
    function createPaidPredictableCompetition(
        ...
        IPaidPredictableCompetition(info.addr).initialize(_competitionName, _numTeams, _startingEpoch, _expirationEpoch, _teamNames, _bannerURI, _totalPointsPerRound, _feeInfo);
        addr_ = info.addr;
    }
...
interface ICompetitionFactory {
    ...
    function createCompetition(
        ...
        uint16 _numTeams,
        uint64 _expirationEpoch,
        CompetitionImpl _competitionImpl,
        string[] memory _teamNames
