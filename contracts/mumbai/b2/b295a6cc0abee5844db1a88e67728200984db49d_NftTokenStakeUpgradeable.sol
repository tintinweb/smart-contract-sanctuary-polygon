...
import "../tokens/ERC20/BondToken.sol";
    ...
    UUPSUpgradeable
{
    ...
    event TokenClaimed(address indexed owner, uint256 indexed tokenId, uint256 bondAmount, string cardCode);
    ...
    function claimToken(
        ...
        BondToken bondToken = BondToken(address(bondAddress));
        ...
        emit TokenClaimed(_msgSender(), _tokenId, _bondAmount, _cardCode);
    }
    ...
    UUPSUpgradeable
{
    ...
    function initialize() public initializer {
        __ERC721_init("NftTokenCard", "CARD");
    ...
    function setBaseURI(string calldata __baseURI)
        public
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        baseURI = __baseURI;
...
contract BondToken is ERC20PresetMinterPauserUpgradeable, OwnableUpgradeable
{
