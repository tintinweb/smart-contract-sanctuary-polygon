...
contract MinerNft is Ownable , ReentrancyGuard {
    ...
    uint256 private creditsToHire1Miner = 2851200; // 3% Per Day
    uint256 private silverToHire1Miner = 1728000; // 5% Per Day
    uint256 private goldToHire1Miner = 1209600;    // 7% Per Day
    uint256 private platinumToHire1Miner = 864000; // 10% Per Day
    uint256 private PSN = 10000;
    uint256 private PSNH = 5000;
    uint256 public constant depositFee = 50;
    uint256 public constant withdrawFee = 50;
    uint256 public constant refPercent = 100;
    uint256 public constant percentDivider = 1000;
    uint256 public constant minBuy = 1;
    uint256 public constant maxWallet = 10;
    uint256 public constant buyLimit = 200;
    address private nullAddress = 0x0000000000000000000000000000000000000000;
    IERC20 private BusdInterface;
    address public tokenAdress;    
    constructor() {
    tokenAdress = 0x0AC9e57F621438633090e41DBD68113b7CC448ea; 
    ...
    function startMining(uint256) public payable onlyOwner {
        require(!initialized && marketValue == 0, "Mining already started.");
        initialized = true;
        marketValue = 259200000000;
    }

    function hireMiners(address ref, uint256) public payable {
