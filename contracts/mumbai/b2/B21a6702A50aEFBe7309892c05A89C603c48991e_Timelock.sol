...
contract Timelock is AccessControl{
    ...
    function finalizeAllIncomingDeposits() public onlyRole(DEFAULT_ADMIN_ROLE) timestampIsSet incomingDepositsStillAllowed {
    ...
    function setTimestamp(uint256 _timePeriodInSeconds) public onlyRole(DEFAULT_ADMIN_ROLE) timestampNotSet  {
        timestampSet = true;
    ...
    function withdrawEth(uint256 amount) public onlyRole(DEFAULT_ADMIN_ROLE) noReentrant{
    ...
    function lockTokens(address recipient, uint256 amount) public onlyRole(DEFAULT_ADMIN_ROLE) timestampIsSet incomingDepositsStillAllowed {
    ...
    function bulkLockTokens(address[] calldata recipients, uint256[] calldata amounts) external onlyRole(DEFAULT_ADMIN_ROLE) timestampIsSet incomingDepositsStillAllowed {
    ...
    function unlockTokens(IERC20 token, address to, uint256 amount) public timestampIsSet noReentrant {
    ...
    function transferAccidentallyLockedTokens(IERC20 token, uint256 amount) public onlyRole(DEFAULT_ADMIN_ROLE) noReentrant {
