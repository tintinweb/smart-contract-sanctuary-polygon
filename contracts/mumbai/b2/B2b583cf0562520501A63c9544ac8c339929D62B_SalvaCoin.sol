...
abstract contract ERC20Snapshot is ERC20 {
    ...
    function balanceOfAt(address account, uint256 snapshotId) public view virtual returns (uint256) {
        ...
        return snapshotted ? value : getPureBalanceOf(account);
    }
    ...
    function getPureBalanceOf(address account) public view virtual returns(uint256){}

    
    function _updateAccountSnapshot(address account) private {
        _updateSnapshot(_accountBalanceSnapshots[account], getPureBalanceOf(account));
    }
...
abstract contract ERC20Dividend is ERC20Snapshot {
    ...
    function calcDividend(
        ...
        uint256 _totalCoinsHeld = totalSupplyAt(_shotId) -
            (_totalDivWithdrawn + _excludedAddressAmount); // total coins held by all holders

        uint256 _divPerToken = (_totalAmountToDistribute * multiplier) /
            _totalCoinsHeld; // deriving the multiplier
