...
contract ERC20Upgradeable is Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable {
    ...
    function _initialLock_Addition(address to, uint32 initialLockedTime, uint128 initialLockedAmount) internal { 
    ...
    function _initialLock_Delete(address account,uint32 initialLockedTime) internal { 
    ...
    function _additionalLock_Addition(address account, uint32 initialLockedTime, uint128[] calldata additionalLockedTime, uint128[] calldata additionalLockedAmount) internal { 
    ...
    function _additionalLock_Delete(address account,uint32 initialLockedTime,uint32 additionalLockedTime) internal { 
    ...
    function _addressFreeze(address account) internal { 
        // require(!_freezingStatus[account], "be already frozen");
        _freezingStatus[account] = true;
        emit freeze(account);
    }
    function _addressUnfreeze(address account) internal { 
...
contract ProjectToken_upgrade is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, OwnableUpgradeable {
    ...
    function initialLock_Additio(address to, uint32 initialLockedTime, uint128 initialLockedAmount) public onlyOwner returns (bool) {
        _initialLock_Addition(to,initialLockedTime,initialLockedAmount);
        return true;
    }
    function initialLock_Delete(address account,uint32 initialLockedTime) public onlyOwner returns (bool) {
        _initialLock_Delete(account,initialLockedTime);
        return true;
    }
    function additionalLock_Addition(address account, uint32 initialLockedTime, uint128[] calldata additionalLockedTime, uint128[] calldata additionalLockedAmount) public onlyOwner returns (bool) {
        _additionalLock_Addition(account,initialLockedTime,additionalLockedTime,additionalLockedAmount);
        return true;
    }
    function additionalLock_Delete(address account,uint32 initialLockedTime,uint32 additionalLockedTime) public onlyOwner returns (bool) {
        _additionalLock_Delete(account,initialLockedTime,additionalLockedTime);
        return true;
    }
    function addressFreeze(address account) public onlyOwner {
        _addressFreeze(account);
    }
    function addressUnfreeze(address account) public onlyOwner {
        _addressUnfreeze(account);
    }
