...
contract GGToken is ERC20("GGToken", "GG"), Ownable {
    ...
    address potContract =  0x2E9C15c2dfe4B04EE4a8115489b20A434A257c52;
    ...
    function recycleBottle() public {
        require(POTIONS(potContract).balanceOf(msg.sender, 500)>0);
        POTIONS(potContract).burnEmptyBottle(msg.sender,500);
        _mint(msg.sender, recycleGGAmount*10**18);
    }

    function batchRecycleBottle(uint256 _number) public {
        require(POTIONS(potContract).balanceOf(msg.sender, 500)>_number);
