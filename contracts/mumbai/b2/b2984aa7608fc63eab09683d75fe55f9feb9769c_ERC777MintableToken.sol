...
contract ERC777MintableToken is
    ERC777,
    IOperatorMint,
    ICirculatingSupply,
    ...
    IERC777OperatorBatchFunctions
{
    ...
    function send(
        ...
        require(_transferEnabled, "ERC777: token transfers are not enabled");
    ...
    function burn(uint256 amount, bytes memory data) public virtual override(ERC777) {
        require(false, "ERC777: token burning is forbidden");
    ...
    function operatorBatchTransfer(
        ...
        require(isOperatorFor(_msgSender(), address(this)), "ERC777: caller is not an operator for sender");
        require(recipients.length == amounts.length, "ERC777: recipients and amounts length mismatch");
