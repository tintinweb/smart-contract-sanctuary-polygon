...
contract NFTicket is INFTicket, ERC721, Ownable {
    ...
    constructor(address _organiserAccessControl) ERC721("NFTicket", "NFTCKT") {
        organiserAccessControl = _organiserAccessControl;
    }

    function changeOrganiserAccessControl(address _organiserAccessControl) external onlyOwner {
        organiserAccessControl = _organiserAccessControl;
    }
    ...
    function changeTokenActiveStatus(address tokenAddress, bool isActive) external onlyOwner {
    ...
    function withdraw(address tokenAddress, uint256 amount) external checkOrganiserApproved {
