...
contract Flower is ERC721, Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        address _treasury
    ) ERC721("Metakicks X Flower Instincts - Mad Hunny", "MTKSXFLOWER") {
    ...
    function _publicSale(uint256 msgValue, uint256 amount, address to) private {
