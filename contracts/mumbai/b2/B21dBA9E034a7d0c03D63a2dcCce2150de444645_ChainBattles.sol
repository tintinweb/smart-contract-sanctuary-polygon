...
contract ChainBattles is ERC721URIStorage {
    ...
    function mint() public {
        ...
        character.levels = 0;
        character.stamina = random(randomLimit);
        character.speed = random(randomLimit);
        character.defence = random(randomLimit);
        character.attack = random(randomLimit);
    ...
    function train(uint256 tokenId) public {
        ...
        character.stamina = character.stamina + random(randomLimit);
        character.speed = character.speed + random(randomLimit);
        character.defence = character.defence + random(randomLimit);
        character.attack = character.attack + random(randomLimit);
