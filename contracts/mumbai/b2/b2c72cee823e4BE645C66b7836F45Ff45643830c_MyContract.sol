...
contract MyContract is
  ...
  event LogFeeData(address indexed router, uint256 fee, uint256 blance, Client.EVM2AnyMessage message);
...
// Selector for the destination chain (in the CCIP protocol)
  ...
  function transferToken(
    ...
    emit LogFeeData(address(router), fee, feeToken.balanceOf(msg.sender), message);
