...
contract YadeckTokens is
    ...
    IYadeckTokens
{
    uint96 public constant DEFAULT_ROYALTY = 1000;
    ...
    event NextContractUpdated(address indexed nextContractAddress);
    event DefaultRoyaltyUpdated(address indexed receiver, uint96 feeNumerator);
    event Evolution(
        address indexed owner,
        uint256 indexed oldCardId,
    ...
    function setBaseURI(string memory _baseURIextended) external onlyOwner {
        ...
        emit BaseURIUpdated(_baseURIextended);
    }
    ...
    function evolution(
        ...
        emit Evolution(signer, cardId, newCardId);

        return newCardId;
    }

    function setNextContract(address nextContractAddress) external onlyOwner {
        nextContract = INextContract(nextContractAddress);
        emit NextContractUpdated(nextContractAddress);
    }
    ...
    function setDefaultRoyalty(address receiver, uint96 feeNumerator)
        ...
        onlyOwner
    {
        require(feeNumerator < 3001, "Royalty must be less than or equal to 30%");
