...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xA61B87B1185a5A58AE1B0f4F341D26efC9fdd887];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 9479) { }
...
// File: contracts/MysdContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MysdContract is RamppERC721A {
    constructor() RamppERC721A("Mysd", "Rs"){}
}
