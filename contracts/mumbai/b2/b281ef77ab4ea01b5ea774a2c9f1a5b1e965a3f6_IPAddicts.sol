...
import "../../extensions/ERC721MaxSupplyExtension.sol";
import "../../extensions/ERC721SoulboundExtension.sol";
import "../../extensions/ERC721FreeMintExtension.sol";

contract IPAddicts is ERC721Base, ERC721MaxSupplyExtension, ERC721SoulboundExtension, ERC721FreeMintExtension {
    ...
    function initialize(string calldata name, string calldata shortName, string calldata domain, address admin) public initializer {
        ...
        __ERC721SoulboundExtension_init();
        __ERC721FreeMintExtension_init(admin);
    }
    ...
    function approve(address operator, uint256 tokenId) public virtual override (IERC721Upgradeable, ERC721Upgradeable) {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override (ERC721Base, ERC721MaxSupplyExtension, ERC721SoulboundExtension, ERC721FreeMintExtension) returns (bool) {
    ...
    function _beforeTokenTransfer(address from, address to, uint256 firstTokenId, uint256 batchSize) internal override (ERC721Base, ERC721BetterHooksUpgradeable, ERC721MaxSupplyExtension, ERC721FreeMintExtension) {
        super._beforeTokenTransfer(from, to, firstTokenId, batchSize);
    }

    function _beforeTokenMint(address to, uint256 firstTokenId, uint256 batchSize) internal virtual override (ERC721BetterHooksUpgradeable, ERC721MaxSupplyExtension, ERC721FreeMintExtension) {
        super._beforeTokenMint(to, firstTokenId, batchSize);
    }

    function _beforeTokenSend(address from, address to, uint256 firstTokenId, uint256 batchSize) internal virtual override (ERC721BetterHooksUpgradeable, ERC721SoulboundExtension) {
        super._beforeTokenSend(from, to, firstTokenId, batchSize);
    }

    function _beforeTokenBurn(address from, uint256 firstTokenId, uint256 batchSize) internal virtual override (ERC721BetterHooksUpgradeable) {
        super._beforeTokenBurn(from, firstTokenId, batchSize);
    }
...
import "../erc721/ERC721BetterHooksUpgradeable.sol";

contract ERC721Base is Initializable, AccessControlEnumerableUpgradeable, ERC721BetterHooksUpgradeable, ERC721EnumerableUpgradeable {
...
import "@openzeppelin/contracts-upgradeable/token/ERC721/extensions/ERC721EnumerableUpgradeable.sol";
import "../../erc721/ERC721BetterHooksUpgradeable.sol";
import "../../extensions/ExtensionUpgradeable.sol";

contract ERC721FreeMintExtension is ExtensionUpgradeable, AccessControlEnumerableUpgradeable, ERC721BetterHooksUpgradeable, ERC721EnumerableUpgradeable {

    bytes32 public constant ERC721_FREE_MINT_EXTENSION = keccak256('ERC721FreeMintExtension');
    bytes32 public constant MINTER_ROLE = keccak256('MINTER_ROLE');

    error ERC721FreeMintExtension_OnlyMinterRole();

    function __ERC721FreeMintExtension_init(address minter) internal onlyInitializing {
        __ERC721FreeMintExtension_init_unchained(minter);
    }

    function __ERC721FreeMintExtension_init_unchained(address minter) internal onlyInitializing {
        initializeExtension(ERC721_FREE_MINT_EXTENSION);
    ...
    function _beforeTokenMint(address to, uint256 firstTokenId, uint256 batchSize) internal virtual override {
        if (!hasRole(MINTER_ROLE, msg.sender)) {
            revert ERC721FreeMintExtension_OnlyMinterRole();
        }
        super._beforeTokenMint(to, firstTokenId, batchSize);
    }
...
contract ERC721SoulboundExtension is ExtensionUpgradeable, AccessControlEnumerableUpgradeable, ERC721BetterHooksUpgradeable {

    bytes32 public constant ERC721_SOULBOUND_EXTENSION = keccak256('ERC721SoulboundExtension');
    // Needed to support ERC721FreeMintExtension
    bytes32 private constant MINTER_ROLE = keccak256('MINTER_ROLE');

    error ERC721SoulboundExtension_Soulbound();

    function __ERC721SoulboundExtension_init() internal onlyInitializing {
        __ERC721SoulboundExtension_init_unchained();
    }

    function __ERC721SoulboundExtension_init_unchained() internal onlyInitializing {
        initializeExtension(ERC721_SOULBOUND_EXTENSION);
    }
    ...
    function _beforeTokenSend(address from, address to, uint256 firstTokenId, uint256 batchSize) internal virtual override {
        // Needed to support ERC721FreeMintExtension
        if (!hasRole(MINTER_ROLE, from)) {
            revert ERC721SoulboundExtension_Soulbound();
        }
        super._beforeTokenSend(from, to, firstTokenId, batchSize);
    }
