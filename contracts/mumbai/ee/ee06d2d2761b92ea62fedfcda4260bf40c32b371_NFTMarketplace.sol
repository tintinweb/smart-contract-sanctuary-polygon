...
contract NFTMarketplace is ReentrancyGuard {
  ...
  function buyItemfromMarketplace(
    ...
    uint256 itemId,
    uint256 price,
    uint256 priceWithRatio // calculate in frontend with price token listing divide price token buy
    ) public nonReentrant {
    ...
    require(priceWithRatio > 0, "No zero ratio !");
    ...
    {
        fee = getFee(priceWithRatio);
        totalPrice = priceWithRatio + fee;
...

    {
        ...
        IBEP20(BEP20Address).transferFrom(buyer, sellerAdd, priceWithRatio);
