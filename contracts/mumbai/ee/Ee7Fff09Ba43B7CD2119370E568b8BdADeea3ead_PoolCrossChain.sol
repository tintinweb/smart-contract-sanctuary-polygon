...
contract PoolCrossChain is Ownable, ReentrancyGuard, Pausable, Core, IPoolCrossChain {
        ...
        returns (uint256 actualToAmount, uint256 haircut)
    {
        ...
        params.estimatedFee = router.estimateFee(params.txType, destinationChain, params.payload);
    ...
    function receiveSwapCrossChain(
        ...
        require(srcAssetAddress != address(0), "ZERO");
        require(dstAssetAddress != address(0), "ZERO");
        require(srcAmount > 0, "ZERO_FROM_AMOUNT");
        require(dstChain == chainId, "WRONG_CHAIN");

        ICSMRouter.CrossChainAsset memory srcAsset = router.getAssetData(srcChain, srcAssetAddress);
