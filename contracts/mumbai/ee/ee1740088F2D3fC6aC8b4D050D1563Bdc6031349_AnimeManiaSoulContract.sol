...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x542258a318c6Ae14a6dE660f0586A87915596574];
...
// File: contracts/AnimeManiaSoulContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract AnimeManiaSoulContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Anime Mania Soul";
    string public symbol = "AMSARC";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/q8KrQhgJ5vBrTYVqmCju/contract-metadata";
  }
