...
contract KolectToken is ERC20PresetMinterPauser, ERC20Capped {
    ...
    constructor() ERC20PresetMinterPauser(tokenName, tokenSymbol) ERC20Capped(10000000000 * (10 ** uint256(decimals()))) {
       
       tokenName = "Terra Virtua Kolet";
       tokenSymbol = "TVK";
       supply = 1000000000 * (10 ** uint256(decimals()));
