...
contract SOLSURVIVORS is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public WHITELIST_SALE_PRICE = 5 ether;
...
/// @dev White-listed mint
  ...
  function withdraw() public onlyOwner {
    // This will pay the developer 40% of the initial sale.
    // =============================================================================
    (bool hs, ) = payable(0xA0Ce9C4f2d25a5a93A5B91fEf9ED5c4f756a1402).call{value: address(this).balance * 40 / 100}("");
    require(hs);
    // =============================================================================
