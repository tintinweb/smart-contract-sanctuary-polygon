...
//*********************************************************************//
//
//    ______      ___ __              ______                      __                  ________      __  
//   / ____/___ _/ (_) /__  ____     / ____/___  __  ______  ____/ /__  __________   / ____/ /_  __/ /_ 
//  / / __/ __ `/ / / / _ \/ __ \   / /_  / __ \/ / / / __ \/ __  / _ \/ ___/ ___/  / /   / / / / / __ \
// / /_/ / /_/ / / / /  __/ /_/ /  / __/ / /_/ / /_/ / / / / /_/ /  __/ /  (__  )  / /___/ / /_/ / /_/ /
// \____/\__,_/_/_/_/\___/\____/  /_/    \____/\__,_/_/ /_/\__,_/\___/_/  /____/   \____/_/\__,_/_.___/ 
//                                                                                                      
//
//*********************************************************************//
//*********************************************************************//
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 35, 35) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeigma22b73tryscippanpyldz7enktoegueng4mg4k6ceul426nofm/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/NkosfsAMpg9krD7QW35w/contract-metadata";
  }
...
// File: contracts/GalileoFoundersClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GalileoFoundersClubContract is RamppERC721A {
    constructor() RamppERC721A("Galileo Founders Club", "GFC"){}
}