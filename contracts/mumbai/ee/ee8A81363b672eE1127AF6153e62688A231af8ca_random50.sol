...
contract random50 is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("random50", "RREE") {
    setHiddenMetadataUri("ipfs://QmWjxoGEZ3o753Bg1nXKGoHqee3zPg98Ljypnc3x3MfJCn/hidden.json");
  }
