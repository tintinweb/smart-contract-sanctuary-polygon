...
contract InterestEarner {
    ...
    event StakingInformations(uint256 finaltotalExpectedInterest ,uint256 holdersStakingCount , bytes32 stakingScheduleId ,uint256 interestEarnedPerAnnum_pre ,uint256  amount,uint256 percentageBasisPoints,uint256 interestEarnedPerAnnum_post,uint256 releaseEpoch,uint256 timePeriod,uint256 initialStakingTimestamp,uint256 secondsRemaining,uint256 interestEarnedForThisStake );
    ...
    */
        ...
        noReentrant
    {
     ...
     emit StakingInformations(finaltotalExpectedInterest,holdersStakingCount[msg.sender],stakingScheduleId,interestEarnedPerAnnum_pre, amount, percentageBasisPoints,interestEarnedPerAnnum_post,releaseEpoch, timePeriod, initialStakingTimestamp[msg.sender], secondsRemaining, interestEarnedForThisStake);
    }
