...
contract Gems is ERC1155 {
    uint256 constant EMERALD = 0;
    uint256 constant RUBY = 1;
    uint256 constant DIAMOND = 2;
    uint256 constant AMETHYST = 3;
    uint256 constant GOLD_RING = 4;
    uint256 constant GOLD_NECKLACE = 5;

    uint256 tokenId = 6;

    constructor() ERC1155("https://cdn.yaytso.art/gems/metadata/{id}.json") {
