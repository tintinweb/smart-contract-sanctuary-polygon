 ...
 */
contract AOCBadge is ERC721Upgradeable, OwnableUpgradeable, ITrustedMintable {
    mapping(address => bool) public s_isTrusted;
    uint256 public s_totalSupply;
    string public s_baseURI;
    uint256 public s_maxSupplyLargePack;
    ...
    function initialize(
        ...
        s_maxSupplyLargePack = 47777;
        s_baseURI = baseURI;
    }

    function _mintAOCLargePack(address _to, uint256 _amount) internal {
        require(s_totalSupply + _amount <= s_maxSupplyLargePack, "AOC: MINTED_OUT");
    ...
    function setTrusted(address _sender, bool _s_isTrusted) external onlyOwner {
        s_isTrusted[_sender] = _s_isTrusted;
    }

    function setMaxSupply(uint256 _supply) external onlyOwner {
        require(_supply != 0, "AOC: ZERO_SUPPLY");
        s_maxSupplyLargePack = _supply;
    }

    function setBaseURI(string memory _aocBaseURI) external onlyOwner {
        s_baseURI = _aocBaseURI;
    }
