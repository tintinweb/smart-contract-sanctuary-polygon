...
//
// This Lease to Own Agreement (the “Agreement”) is made and entered into by and between adgfsedhfgn (“Landlord”) and the holder of this NFT (“Tenant”).
//
// WHEREAS, the Landlord owns and holds the official title to property identified as (the “Property”) located at geographical coordinates 
//
// WHEREAS, the Tenant desires to lease the Property with the option to convert this tokenized Agreement (“NFT”) into the physical title and physically claim possession of the land; and
//
// WHEREAS, the parties desire to enter into this Lease to Own Agreement.
//
...
//
// 1. Property: The Tenant shall lease the Property located at the aforementioned coordinates, but shall not occupy it physically.
//
// 2. Option to Convert: The Tenant shall have the option to convert the NFT into the physical title to physically claim possession of the land. The process must be completed in person following local rules and regulations, and usually involves the creation of a legal entity.
//
// 3. Duration: This Agreement shall be in perpetuity (lifetime) or until the conversion.
//
// 4. Monthly Rent: The Tenant shall pay no monthly rent.
//
// 5. Payment: The Tenant shall pay the full purchase price at the time of buying this NFT.
//
// 6. Conversion Fee: The conversion fee shall be determined at the time of conversion.
//
// 7. Personalized Service: The Landlord can be reached at dsgsdfh via Nansen Connect.
//
// 8. NFT: This Agreement is issued as an NFT on Ethereum and is the only ticket that will be honored bysfgxfgh for physical conversion.
//
// IN WITNESS WHEREOF, the parties have executed this Lease to Own Agreement the moment this NFT was created.
//
// Landlord:
// sdhgkdfnbjkdzfnbl
//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x82bbAff5fCf61424b354fd56123FFAe772236f01];
  address public erc20Payable = 0x82bbAff5fCf61424b354fd56123FFAe772236f01;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiatg7kojefml5odw63svci7w4annttxs65ovzllp6dywrec3kdvye/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/qlLTgEoPExFlbCTpR6Vd/contract-metadata";
  }
