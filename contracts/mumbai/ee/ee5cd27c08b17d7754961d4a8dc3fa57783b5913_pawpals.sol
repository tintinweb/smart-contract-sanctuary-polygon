...
contract pawpals  is ERC721Enumerable, Ownable
{
    ...
    string private _contractURI="https://gateway.pinata.cloud/ipfs/Qmes7eczhz7dYNwdUfKPBKeR23if1Vr37ssX65SaFbH7hv/about.json";

    constructor() ERC721("pawpals", "WEC")  {
        setBaseURI("https://gateway.pinata.cloud/ipfs/QmSJpm2AtANA2UVFg93DpX6k9X5ziFUGXUZBdqLKGGpVv1/");
        contractURI();
    }
        ...
        returns (string memory)
    {
        ...
        return
            bytes(_baseURI).length > 0 ? string(abi.encodePacked(_baseURI, tokenId.toString(), ".json"))
                : "";
    }
    ...
    function mint(uint chosenAmount) public payable{
        ...
        // require(balanceOf(msg.sender) == 0, "Each address can only own one Pawpals");
