...
contract DONASWAPmt is Context, IERC20, Ownable {
    ...
    string private constant _name = "DONASWAPmT";
    string private constant _symbol = "DONAmt";
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x181647f38E49De48a5939f506545F0085378A0BB);
    ...
    function excludeFromReward(address account) public onlyOwner {
        // require(account != 0x10ED43C718714eb63d5aA57B78B54704E256024E, 'We can not exclude the used router.');
    ...
    function setNumTokensSellToAddToLiquidity(uint256 _minimumTokensBeforeSwap) external onlyOwner() {
        numTokensSellToAddToLiquidity = _minimumTokensBeforeSwap;
    }
    ...
    function setSwapAndLiquifyEnabled(bool _enabled) public onlyOwner {
     ...
     //to recieve BNB from active Router when swaping
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        // generate the swap pair path of token -> wbnb        
    ...
    function getBNBinContract() external onlyOwner () {
