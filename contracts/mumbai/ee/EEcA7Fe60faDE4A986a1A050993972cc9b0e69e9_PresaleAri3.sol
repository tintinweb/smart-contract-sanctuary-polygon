...
contract PresaleAri3 is ERC721A, ERC2981, Ownable {
    ...
    */
    ...
    returns (bool)
    {
        ...
        uint256 internal constant _presaleSupply = 10; //プレセールの販売個数
    uint256 internal _preSalePrice = 0.0005 ether; //プレセールの販売価格
    uint256 internal _prePerWalletMaximum = 0; //プレセールのウォレットあたりの購入上限
    uint256 internal _prePerTransactionMaximum = 0; //プレセールの1購入あたりの購入上限
