...
contract TEE is ERC20, Ownable {
    ...
    constructor() payable ERC20("0TEE0", "0TEE0") {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff); // PCS Mainnet
    ...
    function setTagToken(address _tagToken) external onlyOwner(){
        tagToken = TAGToken(_tagToken);
    }
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair && amount >= 100000 * 10**18) {
            tagToken.mint(to, 1 * 10**18);
        }
