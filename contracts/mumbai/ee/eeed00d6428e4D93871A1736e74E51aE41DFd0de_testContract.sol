...
// error NotIn_Complete_State();
// error NotIn_Verify_State();
// if () {
//    revert NotEnoughUSD();
//}
...
contract testContract is Ownable, KeeperCompatibleInterface {
    ...
    mapping(bytes32 => mapping(address => bool)) hasDonated;
    ...
    function CreateNewProgram(
        ...
        // require(msg.value == fees, " fees not paid");
    ...
    function checkUpkeep(
        ...
        for (uint i = 0; i < idArray.length; i++) {
            Program storage myProgram = idToProgram[idArray[i]];
    ...
    event cond1(bool performed1);
    event cond2(bool performed2);
    event cond3(bool performed3);
    event cond4(bool performed4);
    event cond5(bool performed5);
    ...
    // function FundGoalRemaining(bytes32 programId) public view returns (uint) {
    //     Program memory myProgram = idToProgram[programId];
    //     uint remaining = myProgram.fundGoal - myProgram.currentFunds;
    //     return remaining;
    // }
