...
contract NFT is ERC721Enumerable, Ownable {
  ...
  uint256 public maxSupply = 79;
  uint256 public maxMintAmount = 79;
  bool public paused = false;
  mapping(address => bool) public whitelisted;

  constructor() ERC721("CONTRACT DEMO", "CD") {
    setBaseURI("https://cloud.genfty.com/ipfs/Qmbj4oYknyQv9y5Uz53zZaviwuJfrfqv5XH1ENuBVSbFqZ/");
    mint(msg.sender, 79);
  }
