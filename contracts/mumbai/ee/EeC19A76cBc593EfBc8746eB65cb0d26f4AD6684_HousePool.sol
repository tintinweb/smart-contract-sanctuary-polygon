    ...
    ERC20VotesUpgradeable
{
    ...
    function permitAndStake(
        ...
        stake(onBehalfOf, amount *10**precisionDifference);
    }
    ...
    function stake(address onBehalfOf, uint256 amount) public {
        verify(amount*10**precisionDifference);
    ...
    function unStake(address to, uint256 amount) public {
        ...
        require(
            int256(amount*10**precisionDifference) <= ceil(maxUserWithdrawalAmount, 10**0),
    ...
    function verify(uint256 _amount) internal view {
        require(_amount*10**precisionDifference > 1 * 10**18, "HOUSEPOOL: INVALID AMOUNT");
        require(
