...
contract TestPolygonErc71a is ERC721A, Ownable {
    using Strings for uint256;

    string public baseURI = "";
    string public baseExtension = ".json";
    uint256 public cost = 0.000336 ether;
    uint256 public presaleCost = 0.000336 ether;
    uint256 public maxSupply = 1000;
    uint256 public maxMintAmountPerTx = 1;
    //batas wallet pre sale
    uint256 public presaleMintLimit = 1;
    //batas wallet public sale
    ...
    constructor() ERC721A("Test Polygon Erc71a", "POLYGONERC721TEST", 1) {
        ...
        PresaleStarted
    {
        ...
        require(msg.value >= presaleCost * _mintAmount, "MATIC amount is low");
