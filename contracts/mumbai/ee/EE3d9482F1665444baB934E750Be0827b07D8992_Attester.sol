...
contract Attester {
    ...
    modifier onlyForum {
      require(msg.sender == forum, "Caller isn't forum contract");
      _;
    }

    constructor(Unirep _unirep, address _forum) {
        // set unirep address
        unirep = _unirep;
        forum = _forum;
    }

    function attesterSignUp(uint48 epochLength) external onlyForum {
