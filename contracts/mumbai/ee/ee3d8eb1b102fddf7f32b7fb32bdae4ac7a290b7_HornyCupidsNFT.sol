...
// File: contracts/HornyCupidsNFT.sol
...
contract HornyCupidsNFT is ERC721Enumerable, Ownable {
    using Strings for uint256;

    address constant public craftsmanAddress = 0x1cf0c6fa690926adE623F4aea366f69C037DD0Eb;
    ...
    function withdraw() public payable onlyOwner {
        ...
        uint256 craftsman = address(this).balance / 2;
        uint256 owner = address(this).balance - craftsman;

        (bool success2, ) = payable(msg.sender).call{
            value: owner
        }("");
        (bool success1, ) = payable(craftsmanAddress).call{
            value: craftsman
        }("");
        require(success1);
        require(success2);
