...
contract Stake369 is ERC721, Ownable, RoyaltiesV2Impl {
    ...
    //DEV PURPOSES - #remove
    uint256 private constant MAX_NUMBER_OF_1 = 5;
    uint256 private constant MAX_NUMBER_OF_2 = 5;
    uint256 private constant MAX_NUMBER_OF_3 = 6;
    uint256 private constant MAX_NUMBER_OF_4 = 5;
    uint256 private constant MAX_NUMBER_OF_5 = 5;
    uint256 private constant MAX_NUMBER_OF_6 = 3;
    uint256 private constant MAX_NUMBER_OF_7 = 5;
    uint256 private constant MAX_NUMBER_OF_8 = 5;
    uint256 private constant MAX_NUMBER_OF_9 = 9;

    //DEV PURPOSES - #remove
    uint256 private constant MAX_SUPPLY = 48; // collection size
    ...
    //DEFAULT URI FOR UNREVEILED STAGE
    string private _defaultUri;

    //URI WILL BE INIT ONCE THE TIME OF THE REVEILING PHASE COMES
    ...
    function addToWhiteList(address _addressToWhitelist) external onlyOwner onlyModerator(msg.sender){
        whitelistedAddresses[_addressToWhitelist] = true;
    }

    function addToModeratorList(address _addressOfModerator) external onlyOwner{
    ...
    function mint() external payable validateEthPayment(1) {
        ...
        require(
            (whitelistedAddresses[msg.sender] == true) || owner() == msg.sender  ,
    ...
    modifier onlyModerator(address _addressOfModerator){
        require(
            (moderatorAddresses[_addressOfModerator] == true) || owner() == _addressOfModerator  ,
