...
contract AMonkSArt is ERC721OneOfOneCollection, OpenseaNativeMetaTransaction {
    address public _suspiciousForwarder;

  constructor()
    ERC721OneOfOneCollection(
      Config({
         name: "A MonkS Art Mumbai T2",
        symbol: "AMA",
        contractURI: "ipfs://QmfJUFuzbz2ug89wbiengsmRY9nBJbe7mjGB8XFgRLgyp2",
        maxSupply: uint256(0x186A0),
        defaultRoyaltyAddress: address(0xba82BDc515aB64E12d34C5b3233A792182e7439a),
        defaultRoyaltyBps: 200,
        openSeaProxyRegistryAddress: address(0xff7Ca10aF37178BdD056628eF42fD7F799fAc77c),
        openSeaExchangeAddress: address(0x2545943C4d9f6F4A617cEAbA91bd13eD37DeF1aD),
        trustedForwarder: 0x0000000000000000000000000000000000000000
      })
    )
  {
    _initializeEIP712("A MonkS Art Mumbai T2");
  }
 ...
 */
contract OpenseaNativeMetaTransaction is EIP712Base {
