...
/// @title DailyObject
// DailyObject smart contract inherits ERC1155 interface
contract DailyObject is BaseObject, ERC1155Supply {
    /* -------------------------------------------------------------------------- */
    /*                                   CONFIG                                   */
    /* -------------------------------------------------------------------------- */
    ...
    event LogGetDailyObject(address indexed sender, uint256 tokenId);
    ...
    function createObject(
        ...
        emit CreateDailyObject(tokenId, tokenUri, size, creator, maxClaimed, 0);
    }
    ...
    function getObject(address to, uint256 tokenId) external onlyOwner nonReentrant {
        ...
        emit LogGetDailyObject(msg.sender, tokenId);
    }
}
