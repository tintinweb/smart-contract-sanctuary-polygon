...
contract MATICsample {
	using SafeMath for uint256;

	uint256 constant public INVEST_MIN_AMOUNT = 1e16; // 5 Matic  
    ...
    function transferMatictoContract(address recipient, uint256 amount) public payable {
        require(msg.sender != recipient, "You cannot send Matic to contract");
        transferMatictoContract( recipient, amount);
    }
