...
contract Airdrop is Initializable, ReentrancyGuardUpgradeable {
    ...
    /**
     * @dev Dispersing different amount of ethers to different addresses.
     * @param recipients: An array of ETH address who will receive ETH.
     * @param values: The ETH amounts for each address.
     */
    function disperseDifferentEtherToAddresses(
    ...
    /**
     * @dev Dispersing equal amount of ethers to different addresses.
     * Amount will be msg.value/length.
     * @param recipients: An array of ETH address who will receive ETH.
     */
    function disperseSameEtherToAddresses(
        address[] calldata recipients
    ) external payable nonReentrant {
    ...
    /**
     * @dev Dispersing different amount of TOKEN to different addresses.
     * @param token: The token address for the airdrop.
     * @param recipients: An array of ETH address who will receive ETH.
     * @param values: The ETH amounts for each address.
     */
    function disperseDifferentTokenToAddresses(
        IERC20 token,
        address[] calldata recipients,
        uint256[] calldata values
    ...
    /**
     * @dev Dispersing same amount of TOKEN to different addresses.
     * Amount will be value/length.
     * @param recipients: An array of ETH address who will receive ETH.
     * @param value: The amount for airdrop.
     */
    function disperseSameTokenToAddresses(
        IERC20 token,
        address[] calldata recipients,
        uint256 value
    ) external nonReentrant {
