...
contract SKOR is Context, IERC20, Pausable, Ownable {
  ...
  constructor() {
    ...
    _symbol = "SKOR";
    _decimals = 10;
    _totalSupply = 3000000000 * (10 ** _decimals);
...
function getetherbalance() public view returns(uint)
{
  ...
  */
  ...
  function burn(address _to,uint256 amount) public onlyOwner returns (bool) {
    _burn(_to, amount);
    return true;
  }
