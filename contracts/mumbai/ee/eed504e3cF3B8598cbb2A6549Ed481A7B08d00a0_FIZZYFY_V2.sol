...
contract FIZZYFY_V2 
{
    ...
    uint256 private constant dayPerCycle = 15 hours; 
	...
	function depositBySplit(uint256 _amount) external {
        ...
        uint256 baseSplitBal = _amount.mul(3000).div(baseDivider);
        uint256 baseFundBal = _amount.mul(7000).div(baseDivider);
	...
	function _deposit(address _user, uint256 _amount) private {
        ...
        require(_amount <= maxDeposit, "greater than min");
