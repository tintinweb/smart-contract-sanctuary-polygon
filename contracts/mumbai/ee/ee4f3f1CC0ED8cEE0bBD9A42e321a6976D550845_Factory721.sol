...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new BrillianceUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        BrillianceUser721Token token = BrillianceUser721Token(address(addr));
...
contract BrillianceUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
