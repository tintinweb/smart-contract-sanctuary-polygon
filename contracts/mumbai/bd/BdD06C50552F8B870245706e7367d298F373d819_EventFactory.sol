...
contract EventFactory is Initializable, ReentrancyGuardUpgradeable, PausableUpgradeable, OwnableUpgradeable  {
    ...
    function swapExactInputSingle(uint256 amountIn) external payable returns(uint amountOut)
    {

            TransferHelper.safeTransferFrom(address(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2), msg.sender, address(this), amountIn);

        //Approval function to approve the swapRouter contract to spend the Tokens in this contract's balance.
        TransferHelper.safeApprove(address(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2), address(swapRouter), amountIn);

        ISwapRouter.ExactInputSingleParams memory params = 
            ISwapRouter.ExactInputSingleParams ({
                tokenIn: address(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2),                 //The contract address of the inbound token.
                tokenOut: address(0),                  //The contract address of the outbound token.
