...
contract ASonlPatContract is Context, IERC20, Ownable {
    ...
    string private constant _name = "SonlPat";
    string private constant _symbol = "SPT";
    uint256 private _tTotal = 10_000_000 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    
    uint256 public swapTokensAtAmount = 10_000 * 10**_decimals; // Should be between 0.03% to 0.2%  of the total supply
    // Max Transaction Amount
    uint256 public maxTxAmount = 100_000 * 10**_decimals; 
    // Max Wallet Amount
    uint256 public maxWalletBalance = 200_000 * 10**_decimals; 

    address public marketingAddress = 0x1234567891011121314151617181920212223240; // Marketing Fee Receiver
