...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new LFMUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix, _operator)
        );
        LFMUser1155Token token = LFMUser1155Token(address(addr));
    ...
    AccessControl
{
    ...
    function _beforeTokenTransfer(
        ...
        require(operator == msg.sender , "Operator: caller is not operator");
