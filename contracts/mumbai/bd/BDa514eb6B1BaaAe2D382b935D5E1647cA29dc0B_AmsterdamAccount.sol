...
contract AmsterdamAccount is BaseAccount, UUPSUpgradeable, Initializable, TokenCallbackHandler, IWallet {
    ...
    function init(address _owner, address[] calldata _modules, address _guardian) external {
        owner = _owner;
        address _guardianStorageAddress = _modules[0];
        authorised[_guardianStorageAddress] = true;
...
contract SampleStorage {
    ...
    function guardianCount(address _wallet) external view returns (uint256) {
        return guardians[_wallet].length;
    }
}
