...
contract Lock   {
    ...
    function setMasterRewardAddress(address masterRewardAddress_) public onlyOwner {
        _masterRewardAddress = masterRewardAddress_;
    }

    function getMasterRewardAddress() public view virtual returns (address) {
    ...
    function getReceiveTotal(address userAddr) public view virtual returns (uint256){
        return _receiveTotal[userAddr];
    }

    function getReceiveTimes(address userAddr) public view virtual returns (uint256){
        return _receiveTimes[userAddr];
    }
