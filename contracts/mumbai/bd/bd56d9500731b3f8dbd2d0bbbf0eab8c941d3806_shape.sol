...
contract shape is ERC721URIStorage, Ownable {
  ...
  constructor() ERC721("collection", "shapesnft") {
    _customBaseURI = 'https://gateway.pinata.cloud/ipfs/Qme314JcR6FfLsHHrQS6WgbCaygnShjU3ACKYBrPiU9z4Y';
    _price = 0.01 ether; // 0.01 AVAX mint price 
    _maxMintable = 1000; // 2k max supply
