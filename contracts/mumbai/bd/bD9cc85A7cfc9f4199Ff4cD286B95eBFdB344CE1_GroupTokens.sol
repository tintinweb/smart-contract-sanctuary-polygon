...
contract GroupTokens is ERC721, ERC721Enumerable, Pausable, Ownable, ReentrancyGuard {
    ...
    uint256 public lastMintBlock = 0;

    // Cost to mint a new group
    uint256 public costToMintTier1;
    uint256 public costToMintTier2;
    uint256 public costToMintTier3;
    uint256 public costToMintTier4;
    ...
    constructor(address _kutils, uint256 _cost1, uint256 _cost2, uint256 _cost3, uint256 _cost4, string memory _baseURI) ERC721("DOOM", "DOOM"){
        ...
        costToMintTier1 = _cost1;
        costToMintTier2 = _cost2;
        costToMintTier3 = _cost3;
        costToMintTier4 = _cost4;
    ...
    */
    ...
    function mintGroup(string calldata groupName) public payable nonReentrant {
        ...
        // Check that it only has allowed characters
        ...
        string memory _baseURI = KUtils.append(baseURIPrefix, KUtils.addressToString(msg.sender),'/',KUtils.toString(groupID),'.json');

        // Set them to the owner & first member
        Groups.setInitialDetails(groupID, msg.sender, groupName, _baseURI, address(this));
