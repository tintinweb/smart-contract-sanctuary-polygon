...
contract Pandorax is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Pandora X", "$PIX") {
    setHiddenMetadataUri("ipfs://QmUpiqBaWmnke68YaSY6ev2r3TDQMbqprQraBKxyWe56eU/unrevealed.json");
  }
