...
abstract contract ERC721ABurnableUpgradeable is Initializable, ContextUpgradeable, ERC721AUpgradeable {
    ...
    function burn(uint256 tokenId) external virtual {
        ...
        require((sender == owner || isApprovedForAll(owner, sender) || getApproved(tokenId) == sender), "ERC721A: caller is not token owner nor approved");
...
abstract contract ERC721AWithPermitUpgradable is Initializable, ERC721AUpgradeable, IERC4494 {
    ...
    // - `initializer` for OpenZeppelin's `ERC721WithPermitUpgradable`.
    function __ERC721WithPermitUpgradable_init(string memory name_, string memory symbol_) internal initializerERC721A initializer {
    ...
    function permit(
        ...
        require(
            ...
            (recoveredAddress != address(0) && (sender == owner || isApprovedForAll(owner, sender) || getApproved(tokenId) == sender)),
            "permit is invalid"
        );
    ...
    /// @dev transferFrom override to be able to increment the nonce
...
import { ERC721ABurnableUpgradeable } from "./base/token/ERC721/ERC721ABurnableUpgradeable.sol";
import { ERC721AWithPermitUpgradable } from "./base/token/ERC721/ERC721AWithPermitUpgradable.sol";
import { ERC721AURIStorageUpgradeable } from "./base/token/ERC721/ERC721AURIStorageUpgradeable.sol";

contract ERC721AFull is
    Initializable,
    ERC721AWithPermitUpgradable,
    ...
    UUPSUpgradeable
{
    ...
    /// @dev Value is equal to to keccak256("MINTER_ROLE");
    bytes32 public constant MINTER_ROLE = 0x9f2df0fed2c77648de5860a4cc508cd0818c85b8b8a1ab4ceeef8d981c8956a6;
    /// @dev Value is equal to to keccak256("UPGRADER_ROLE");
    ...
    function initialize() public initializer {
        ...
        __ERC721WithPermitUpgradable_init("ERC721AFull", "EA");
    ...
    function transferFrom(
        ...
        address to,
        uint256 tokenId
    ) public override(ERC721AUpgradeable, ERC721AWithPermitUpgradable) {
        super.transferFrom(from, to, tokenId);
    }

    function supportsInterface(
        bytes4 interfaceId
    ) public view override(AccessControlUpgradeable, ERC721AUpgradeable, ERC721AWithPermitUpgradable) returns (bool) {
