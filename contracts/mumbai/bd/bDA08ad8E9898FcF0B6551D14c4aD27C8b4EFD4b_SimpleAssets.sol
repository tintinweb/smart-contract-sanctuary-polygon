...
contract SimpleAssets is ISimpleAssets, AccessControlUpgradeable, ERC721Upgradeable, UUPSUpgradeable {
    ...
    string internal _secretMessage;
    ...
    function setSecret(string memory secret) external onlyRole(DEFAULT_ADMIN_ROLE) {
        _secretMessage = secret;
    }

    function getSecret() external view virtual returns (string memory) {
