...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new smartMFGUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        smartMFGUser721Token token = smartMFGUser721Token(address(addr));
...
contract smartMFGUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
