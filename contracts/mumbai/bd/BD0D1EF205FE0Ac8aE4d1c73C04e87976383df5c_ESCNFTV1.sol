...
// Add ERC2981 to StandardContract + Import
import "@openzeppelin/contracts-upgradeable/token/ERC721/extensions/ERC721RoyaltyUpgradeable.sol";

contract ESCNFTV1 is
    Initializable,
    ERC721Upgradeable,
    ...
    ERC721RoyaltyUpgradeable
{
    ...
    function initialize() public initializer {
        __ERC721_init("ESCNFTV1", "ECIJNFT");
    ...
    {
        uint256 tokenId = _tokenIdCounter.current();
        require((tokenId + recipients.length) <= 20, "Exceed max supply");
    ...
    /// @notice Mint several tokens at once
    /// @param to Is address of the recipient
    function mintAll(address to) external onlyOwner whenNotPaused {
        uint256 tokenId = _tokenIdCounter.current();
    ...
    function withdraw(uint256 amount) external onlyOwner {
        require(
            ...
            "Requested amount is higher than balance"
        );
    ...
    /// @notice Set the royalties on the contract on supported platform
    /// @param feeNumerator Updated royalties (between 0 and 10000)
