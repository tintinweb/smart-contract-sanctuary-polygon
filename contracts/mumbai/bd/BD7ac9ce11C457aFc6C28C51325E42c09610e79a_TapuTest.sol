 ...
 * @notice This contract handles minting tapu test tokens.
 */
contract TapuTest is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xD3152EAA7FF13234c5A10F893Ae1A8879f7bB807;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x69933180D6eBfD26b6F4B1b105795bE6E982b378;
    ...
    address[] public payoutAddresses = [
        0x69933180D6eBfD26b6F4B1b105795bE6E982b378
    ];
    ...
    string public name = "tapu test";
    string public symbol = "tapu";
        ...
        )
    {
        ...
        tokenURI[
            23
        ] = "ipfs://bafybeidnzpe4esg2jpzvqhsepc3uxrkr3do3qk5c47is2ovs2c4gdyovhi";
        tokenPublicPrice[23] = 0.002 ether;
        tokenPublicMintsPerAddress[23] = 2;
        tokenPresaleMaxSupply[23] = 0;
        tokenPresalePrice[23] = 0 ether;
        tokenPresaleMintsPerAddress[23] = 0;
        require(
