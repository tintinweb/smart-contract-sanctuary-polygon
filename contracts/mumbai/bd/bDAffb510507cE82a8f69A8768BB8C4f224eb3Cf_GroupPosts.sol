...
contract GroupPosts {
    ...
    */
    ...
    /**
    * Returns a list of messages are posted in a group
    * @param groupID : group ID to get a list of posts for
    * @param startFrom : the number to start getting records from
    */
    function getMsgIDs(uint256 groupID, uint256 startFrom) public view returns(uint256[] memory) {
    ...
    function addPost(uint256 msgID, uint256[] calldata groupIDs) public onlyAdmins {
    ...
    function removePost(uint256 msgID, uint256[] calldata groupIDs) public onlyAdmins {
