...
// File: contracts/Papuachildrentest.sol
...
contract Papuachildrentest is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Papuachildrentest", "PCT") {
    setHiddenMetadataUri("ipfs://QmYQRKQA5WZkzcXJAPE6fXiK3htj4eqsnzPwmTWv1shR7x/hidden.json");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x3c4Ec871382FfFEBCF442ff1BEBb2990664007Cf).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
