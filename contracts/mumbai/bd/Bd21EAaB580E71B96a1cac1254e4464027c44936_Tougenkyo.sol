    ...
    AccessControl
{
    ...
    string private baseURI =
        'ar://wOdAb4QIL5lRiQgbh5EsCJbCHn2I_Kzu3Zw5IJcf_Ss/';
    ...
    uint256 private constant PRE_MAX_CAP = 136;
     ...
     */
    function setMerkleRoot(bytes32 _merkleRoot, TicketID ticket)
        external
        onlyOwner
    {
    ...
    function ownerMint(address _address, uint256 count)
        external
