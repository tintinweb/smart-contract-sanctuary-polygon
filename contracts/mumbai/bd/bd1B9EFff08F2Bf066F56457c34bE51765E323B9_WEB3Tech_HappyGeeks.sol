...
contract WEB3Tech_HappyGeeks is Ownable, ERC2981 {
    ...
    constructor() ERC1155("ipfs://QmUeLaJmeqJYnQM4bm6NTRdCJ9wr3GMNM9JkqV8H2mSZop/") {
    ...
    function mint(uint256 id) public {   
        require(id >= idStartNum && id <= idEndNum,"Exclusive Id allowed!");
        ...
        idRecord[id] = idRecord[id]+perUser;
    ...
    // @dev set Royalty information of the collection.
     function uri(uint256 tokenId) public view virtual override  returns (string memory tokenuri) {
        require(tokenId >= idStartNum && tokenId <= idEndNum,"Exclusive Id allowed!");
