...
contract LFGPass is ERC721Enumerable, Ownable {
    ...
    function withdraw() public payable onlyOwner {
        (bool dy, ) = payable(0x4eC96EBaDe794CC0c420b9429188d8483f958785).call{value: (address(this).balance * 8) / 10}(
            ""
        );
        require(dy);

        (bool ni, ) = payable(0x94eA70cf4318E26D4b398f062637512387Db76eF).call{value: (address(this).balance * 6) / 10}(
            ""
        );
        require(ni);

        (bool cm, ) = payable(0x58fC319b64C4375052AA84Dd07c5785a5910C7Ce).call{value: address(this).balance}("");
        require(cm);
    }
}
