...
contract ColecaoAmpla is DefaultOperatorFilterer, ERC721A, Ownable {
    using Address for address;
    using Strings for uint256;
    ...
    uint256 private maxSupply = 1050;
    ...
    uint256 private _royaltiesEspacoLiterario = 50;
    uint256 private nftWhitelistDiscount = 0;
    address private wMobiup = 0x2919771f951fd264445d4D4c682EE5D8326B93ec;
    address private wEspacoLiterario = 0x5367A21058f1663eA3Dd2c6B23d00d44c6Ed3467;

    mapping(address => uint256) private _addressLastMintedTokenId;

    bool private _isFreeMint = false;
    uint256 private _nftEtherValue = 20000000000000000000;
    ...
    ) ERC721A("B.C. Espaco Literario Ampla", "BC-LITa") {
    ...
    function split(uint256 _mintAmount, address payable _recommendedBy, uint256 _indicationType, bytes32[] memory proof) public payable {
        ...
        uint256 amountEspacoLiterario = msg.value * _royaltiesEspacoLiterario / 100;
        
        payable(wMobiup).transfer(amountM);
        payable(wEspacoLiterario).transfer(amountEspacoLiterario);
        
        ownerAmount = msg.value - amountM - amountEspacoLiterario;
