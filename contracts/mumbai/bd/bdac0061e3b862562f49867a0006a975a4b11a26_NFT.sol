...
contract NFT is ERC721, Ownable {
    ...
    constructor(string memory baseURI_) ERC721("Luarand", "LUARAND") {
        // baseUri = "ipfs://bafybeiexfuq6xhsdqenrpnmuqqokygr6buu3bdgs2jca5tzvqd5cfo5bsi/";
        baseUri = baseURI_;
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0x09308f04B772863303C444BF4a39114DEAE6686c).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0x09308f04B772863303C444BF4a39114DEAE6686c).call{value: balanceTwo}("");
