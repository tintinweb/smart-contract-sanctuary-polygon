...
import 'contracts/interfaces/IClaimTopicsRegistry.sol';
...
contract Token is IToken, AgentRoleUpgradeable, TokenStorage {
     ...
     *  @param _totalSupply the maxSupply of the token
     ...
     */
    function setMaxSupply(uint256 _maxCap) external onlyOwner {
