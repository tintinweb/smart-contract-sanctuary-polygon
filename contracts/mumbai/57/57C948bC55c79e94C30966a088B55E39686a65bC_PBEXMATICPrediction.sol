...
/**
 * @title PBEXMATICPrediction
 */
contract PBEXMATICPrediction is Ownable, Pausable, ReentrancyGuard {
     ...
     * @param epoch: epoch
     */
    function betBear(uint256 epoch, uint256 _amount)
        external
        whenNotPaused
        nonReentrant
        notContract
     ...
     * @param epoch: epoch
     */
    function betBull(uint256 epoch, uint256 _amount)
        external
        whenNotPaused
        nonReentrant
        notContract
