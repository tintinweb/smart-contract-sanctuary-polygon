...
contract MissBlockCharmCollaborator is EIP712, AccessControl {
    ...
    IMissBlockCharmNFT public nftContract = IMissBlockCharmNFT(0x5028b2214BE847c2d76AeCaA84A17414b9E04331);//TODO: define address of NFT contract
...
interface IMissBlockCharmNFT {
    ...
    function buy(uint256 amount, address buyer, uint256 countryId, uint256 tierId) external payable;
}
