...
contract FluxAggregator is AggregatorV2V3Interface, Owned {
   ...
   */
  uint256 constant private RESERVE_ROUNDS = 1;
   ...
   */
  function submit(uint256 _roundId, string calldata _submission)
    external
  {
    ...
    (bool updated, string memory newAnswer) = updateRoundAnswer(uint32(_roundId));
  ...
  function oracleRoundState(address _oracle, uint32 _queriedRoundId)
    ...
    returns (
      ...
      uint32 _roundId,
      string memory _latestSubmission,
      uint64 _startedAt,
      uint64 _timeout,
    ...
    returns (bool, string memory)
  {
    ...
    string memory newAnswer = Mode.findMostOccurringString(details[_roundId].submissions);
    //string memory newAnswer = details[_roundId].submissions[0];
    ...
    private
  {
    ...
    string memory prevRoundAnswer = rounds[prevRound].answer;
  ...
  function recordSubmission(string memory _submission, uint32 _roundId)
    private
  {
...
interface AggregatorValidatorInterface {
  function validate(
    ...
    string calldata previousAnswer,
    uint256 currentRoundId,
    string calldata currentAnswer
