...
contract RJPunksNFT721 is ERC721, Ownable, ReentrancyGuard {
    ...
    constructor() payable ERC721("RJPunksNFT721","RJP") {
    ...
    function withdraw() external onlyOwner {
        require(withdrawWallet != address(0), "Withdraw wallet is address 0!");
