...
contract Bidtree is Ownable {
    ...
    address private _vrf = 0x85A18d17AC5bEAB7E9Cb1bF0ac16dcdDF39146d4; // Randomizer generator contract address
    ...
    function contribute(uint multi, bool base, address referral) external {
        ...
        uint _rate = _fond/_fromSwap;
        locker = false;
        emit Contributed(msg.sender, referral, _deposit, _referral, _fond, _lottery, _marketing, _toOwner, _refund, _rate);
    }
