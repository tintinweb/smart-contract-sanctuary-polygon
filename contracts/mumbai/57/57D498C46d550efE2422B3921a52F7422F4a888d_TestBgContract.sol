...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1678053120;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1677880800;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x47a7e9592268F07d6F02A419dd5f06E41c290b60];
  address public erc20Payable = 0x47a7e9592268F07d6F02A419dd5f06E41c290b60;
    ...
    , TimedDrop
{
  constructor(
    ...
    uint256 public MAX_WALLET_MINTS = 1200;
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/XKvlaq8PZvLgQRqq9u4M/contract-metadata";
  }
...
// File: contracts/TestBgContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TestBgContract is ERC721APlus {
    constructor() ERC721APlus("TestBG", "TBG"){}
}
