...
contract NFT is ERC721,Ownable,ERC721URIStorage{
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://gateway.pinata.cloud/ipfs/QmRtv46ZeuA4u1WXmAYwMqYMo8pYXE995wRysTYFd8hKuZ/";
    }
    ...
    function mint() public payable returns(uint256){
            if(_tokenId.current() < _totalSupply){
              require(msg.value >= _price && _price != 0,'Please pay equal or more than price');
                return _generate();
            }
            else{
