...
contract Quantumon is ERC721, RrpRequesterV0, Ownable {
    ...
    constructor(address _airnodeRrp) RrpRequesterV0(_airnodeRrp)  ERC721("Testmons", "TMONS") {}
    ...
    function requestQuantumon() public payable returns (bytes32) {
        require(msg.value >= 0.005 ether, 'Need to send atleast 0.005 ether to the sponsorWallet');
        ...
        public
    {
        ...
        _safeMint(requestToSender[requestId], _pickRandomUniqueId(qrngUint256));
    }
}
