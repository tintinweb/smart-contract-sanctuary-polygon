...
abstract contract EventPrice is OwnableUpgradeable {
	  ...
	  uint256 private _price;
		...
		/**
     * @dev Sets the value of the `price`.
     */
    function __EventPrice_set(uint256 price_) public onlyOwner {
    	__EventPrice_set_unchained(price_);
    }

    function __EventPrice_set_unchained(uint256 price_) internal onlyOwner {
    	_price = price_;
    }

    /**
     * @dev Returns the value of the `price`.
     */
...
ERC721BurnableUpgradeable, EventStarts, EventEnds, EventPlace, EventLatitude, EventLongtitude, EventPrice,
 EventCanceled {
