...
import {IDappsSubscription} from './interfaces/IDappsSubscription.sol';
    ...
    ReentrancyGuardUpgradeable
{
    ...
    */
    ...
    /**
     * @param newContractAddress - dapps new subscription contract
     */
    function setNewDappsSubscriptionContract(address newContractAddress) external onlyOwner {
        subscriptionContract = newContractAddress;
    }
     ...
     * @param fid farm id
     * @param dappId - dapp id which needto subscribe
    ...
    function _stakeOnUnifarm(
        ...
        if (dappId != bytes32(0) && subscriptionStatus) {
            IDappsSubscription(subscriptionContract).subscribeToDapp(_msgSender(), dappId, subscriptionStatus, false, x);
        }
    }
    ...
    function stakeOnUnifarm(
        ...
        (tokenId) = _stakeOnUnifarm(cohortId, referralAddress, farmToken, sAmount, farmId, dappId, subscriptionStatus);
    }
    ...
    function setPortionAmount(uint256 tokenId, uint256 stakedAmount) external override {}

    function disableBooster(uint256 tokenId) external override {}

    function safeWithdrawEth(address withdrawableAddress, uint256 amount) external override returns (bool) {}
