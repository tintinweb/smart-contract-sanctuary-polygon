...
contract ERC20MerkleAirdrop is Ownable {
    ...
    bytes32 public immutable merkleRoot = 0x0694d3c6b5a1f96e9f23aa196bff5c485d209559174b780a268831abc78b1519;
    ...
    uint256 public immutable startAt = 1661769560067;
    uint256 public immutable endAt = 1661884200000;

    //id of airdrop created in database
    uint256 public immutable airdropID = 207;

    //comes from template too
    uint256 public immutable totalTokens = 0x4563918244f40000;
    uint256 public claimedTokens  = 0;
    uint256 public availableTokens = 5000000000000000000;
