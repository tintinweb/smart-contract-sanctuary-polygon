...
contract Pool1 is Ownable {
    ...
    // ---------------- Lottery ----------------
    event LotteryLocked365(address indexed account, uint256 val, uint256 P, uint256 amount, uint256 sum);
    event LotteryLocked(address indexed account, uint256 val, uint256 P, uint256 amount, uint256 sum);
