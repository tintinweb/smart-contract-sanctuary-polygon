...
contract ProfitForAllMatic is Ownable {
    ...
    uint256 public constant MINIMUM = 0.01 ether; //5 MATIC minimum investment needed
    uint256 public constant REFERRER_CODE = 6666; //default
    uint256 public constant TIME_STEP = 86400;
    uint256 public constant DAY = 1 days;
    uint256 public constant LAUNCH_TIME = 1627484400000; // Starts on Wednesday, July 28 at 3:00 p.m. UTC
    ...
    constructor(address payable fundAddr,address payable mktAddr, address payable prjAddr) {
        fundAds = fundAddr;
        mktAds = mktAddr;
        prjAds = prjAddr;
        _init();
    ...
    function _init() private {
        ...
        investmentPlans_.push(Objects.Plan(10, 0)); //unlimited
        investmentPlans_.push(Objects.Plan(40, TIME_STEP.mul(45))); //45 days
        investmentPlans_.push(Objects.Plan(70, TIME_STEP.mul(20))); //20 days
        investmentPlans_.push(Objects.Plan(100, TIME_STEP.mul(12))); //12 days
    }
