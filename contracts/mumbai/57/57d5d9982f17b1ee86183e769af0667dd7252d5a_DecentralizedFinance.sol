...
contract DecentralizedFinance  {
    ...
    uint256 private constant timeStep = 10 minutes;          // basically used to divide by 1 day to get actual values
    uint256 private constant dayPerCycle =20 minutes;       /////cycle duration is 10 MINUTES for now (7 days in original)
    uint256 private constant dayRewardPercents = 200;       /////4% weekly
