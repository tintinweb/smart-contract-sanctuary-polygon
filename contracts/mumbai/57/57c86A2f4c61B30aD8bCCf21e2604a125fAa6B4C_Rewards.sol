...
contract Rewards is Ownable {
     ...
     */
    function updateGameItemsAddress(address _gameItems) external onlyOwner {
    ...
    function submitAssetPack(
        ...
        IERC1155(resources).mintBatch(address(assetPool), _resourceIds, _resourceAmounts);

        // Add Items to Asset Pool
        IERC1155(gameItems).mintBatch(address(assetPool), _itemIds, _itemAmounts);
