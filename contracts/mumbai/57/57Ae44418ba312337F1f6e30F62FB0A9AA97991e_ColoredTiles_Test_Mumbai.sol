...
contract ColoredTiles_Test_Mumbai is TokenDropBase {
    ...
    /// A dmin functions to help with testing

    function forceClosed() public onlyOwner {
        _presaleIsOpen = false;
        _publicSaleIsOpen = false;
    }

    function forcePresale() public onlyOwner {
        _presaleIsOpen = true;
        _publicSaleIsOpen = false;
    }

    function forcePublicSale() public onlyOwner {
        _presaleIsOpen = true;
...
abstract contract TokenDropBase is Context, ReentrancyGuard, Ownable, ERC20PaymentProcessor, PresaleList, TokenMintingPool {
    ...
    bool internal _presaleIsOpen = false;            // flag used to control the presale opening
    bool internal _publicSaleIsOpen = false;         // flag used to control the public sale opening
