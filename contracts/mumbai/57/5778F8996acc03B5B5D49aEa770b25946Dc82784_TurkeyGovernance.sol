...
/**
 * @notice implementation of the TurkeyGovernance token contract
 * @author Level
 * Inspired from AAVE v2
 */
contract TurkeyGovernance is Initializable, GovernancePowerDelegationERC20 {
    ...
    function initialize() external initializer {
        __ERC20_init("Turkey Governance Token", "LGO");
