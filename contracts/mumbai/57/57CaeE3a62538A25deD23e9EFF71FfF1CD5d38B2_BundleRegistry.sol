 ...
 *
 * @notice BundleRegistry allows user to register a Open Work Name and Open Work ID in a single
...
contract BundleRegistry is Ownable {
  ...
  /**
   * @notice Register an owId and an owUsername during the final Mainnet phase, where registration is
   *         open to everyone.
   */
  function register(
    address to,
  ...
  /**
   * @notice Register an owId and an owUsername during the first Mainnet phase, where registration of
   *         the owId is available to all, but registration of the owUsername can only be performed by
   *         the Open Work Bootstrap Server (trustedCaller)
   */
  function partialTrustedRegister(
    ...
    // Do not allow anyone except the Open Work Bootstrap Server (trustedCaller) to call this
  ...
  /**
   * @notice Register an owId and an owUsername during the Goerli phase, where registration can only be
   *         performed by the Open Work Bootstrap Server (trustedCaller)
   */
  ...
  /**
   * @notice Register multiple owIds and owUsername during a migration to a new network, where
   *         registration can only be performed by the Open Work Bootstrap Server (trustedCaller).
