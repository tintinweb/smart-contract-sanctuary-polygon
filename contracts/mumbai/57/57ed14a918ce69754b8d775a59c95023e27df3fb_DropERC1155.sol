    ...
    IDropERC1155
{
    ...
    IRSFee private immutable rarescapeFee;
    ...
    constructor(address _rarescapeFee) initializer {
        rarescapeFee = IRSFee(_rarescapeFee);
    }
    ...
    function collectClaimPrice(
        ...
        (address rsFeeRecipient, uint256 rsFeeBps) = rarescapeFee.getFeeInfo(address(this), FeeType.PRIMARY_SALE);
        uint256 rsFee = (totalPrice * rsFeeBps) / MAX_BPS;
        ...
        CurrencyTransferLib.transferCurrency(_currency, _msgSender(), rsFeeRecipient, rsFee);
        CurrencyTransferLib.transferCurrency(_currency, _msgSender(), recipient, totalPrice - platformFees - rsFee);
    }
