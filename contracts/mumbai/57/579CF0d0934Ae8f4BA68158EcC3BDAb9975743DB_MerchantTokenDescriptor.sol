...
contract MerchantTokenDescriptor is IMerchantTokenDescriptor, Initializable, OwnableUpgradeable {
    ...
    function tokenURI(uint256 tokenId, string memory name, address owner) external pure override returns (string memory) {
        ...
        string memory json;
        json = '{"name": "S10N Merchant Token", "description": "This NFT represents a Merchant in S10N protocol.",';
