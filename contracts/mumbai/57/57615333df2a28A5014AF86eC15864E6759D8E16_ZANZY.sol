...
contract ZANZY is ERC721URIStorage, ContextMixin, NativeMetaTransaction, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    string private baseTokenURI;
    string private contractURL;

    constructor() ERC721("Zanzy", "Zan") {
        _initializeEIP712("Zanzy");
        baseTokenURI = "";
        contractURL = "";
    }

    // for opensea baseTokenURI
    ...
    function mintTo(address player) public onlyOwner returns (uint256) {
        _tokenIds.increment();
