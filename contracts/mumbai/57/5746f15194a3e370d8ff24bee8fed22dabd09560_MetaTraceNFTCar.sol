...
contract MetaTraceNFTCar is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, PausableUpgradeable, OwnableUpgradeable, ERC721BurnableUpgradeable, UUPSUpgradeable {
    ...
    function safeMintByUser(bytes memory _signature, uint256 _secretNum) external virtual {
    ...
    function safeMintWithTokenIdByUser(bytes memory _signature, 
    ...
    function _signerCheck(bytes memory _signature, uint256 _secretNum) internal virtual returns (uint256){
        ...
        if (!isApprovedForAll(msg.sender, owner())) {
