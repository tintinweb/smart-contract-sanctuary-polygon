...
contract Polly is Ownable, ERC1155 {
	...
	constructor(string memory _uri, address skaro_addr) ERC1155(_uri) {
		...
		mintToken(skaro_addr, FIRE_POLLY, 1);
		mintToken(skaro_addr, WATER_POLLY, 1);
		mintToken(skaro_addr, HALO, 1);
		mintToken(skaro_addr, HORNS, 1);
		mintToken(skaro_addr, MASK, 1);
		mintToken(skaro_addr, SKATEBOARD, 1);
		mintToken(skaro_addr, SURFBOARD, 1);
		mintToken(skaro_addr, BUSTERSWORD, 1);
		mintToken(skaro_addr, RPG, 1);
		mintToken(skaro_addr, BLUE_BG, 1);
		mintToken(skaro_addr, CYAN_BG, 1);
		mintToken(skaro_addr, GREEN_BG, 1);
		mintToken(skaro_addr, ORANGE_BG, 1);
		mintToken(skaro_addr, PINK_BG, 1);
		mintToken(skaro_addr, WHITE_BG, 1);
