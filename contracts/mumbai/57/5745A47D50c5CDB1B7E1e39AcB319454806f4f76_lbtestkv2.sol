...
contract lbtestkv2 is VRFV2WrapperConsumerBase,ConfirmedOwner,ReentrancyGuard {
   ...
   // Mumbai 0xeeB482F3981D004C6199cA21F331Dc33EE639f0a // Mainnet 0x527a819db1eb0e34426297b03bae11F2f8B3A19E
        ...
        VRFV2WrapperConsumerBase(linkAddress, wrapperAddress) 
    {
        ...
        lottoWeekly = IluckblocksWeekly(0xaD198C773bF9f3BA744562DE6e7dFc761F294F52);
        weeklyContract = 0xaD198C773bF9f3BA744562DE6e7dFc761F294F52;
    ...
    function getRandomNumber() internal returns (uint256 requestId) {
        ...
        if(contractBalance >= minimumPrize*3){
            ...
            swapTokensToUSD((20 * 10**18),address(this),0);
