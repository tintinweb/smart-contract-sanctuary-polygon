...
import {ERC1155GasFreeListing} from "./utils/ERC1155GasFreeListing.sol";
import {NativeMetaTransaction} from "./utils/NativeMetaTransaction.sol";

contract CustomERC1155 is ERC1155GasFreeListing, NativeMetaTransaction {
    ...
    constructor()
        ERC1155GasFreeListing(
            "Test",
            "TEST",
            0x53d791f18155C211FF8b58671d0f7E9b50E596ad, // mumbai 1155 proxy registry
            ""
        )
    {
...
import {AllowsProxyFromRegistry} from "./AllowsProxyFromRegistry.sol";

contract ERC1155GasFreeListing is ERC1155, AllowsProxyFromRegistry {
    string public name;
    ...
    constructor(
        ...
        string memory _uri
    ) ERC1155(_uri) AllowsProxyFromRegistry(_proxyRegistryAddress) {
        name = _name;
        symbol = _symbol;
    }
