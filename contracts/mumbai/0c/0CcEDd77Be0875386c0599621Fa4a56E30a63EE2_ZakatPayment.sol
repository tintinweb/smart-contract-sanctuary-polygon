...
contract ZakatPayment is BasicAccessControl, ZakatBasic {
    ...
    function depositeZKT(
        ...
        bytes32 hashValue = keccak256(
            abi.encodePacked(person, _amount, _nonce1, _nonce2)
        );
        require(
            (getVerifyAddress(person, hashValue, _v, _r, _s) == verifyAddress),
            "Not verified"
        );
        ZakatData zktData = ZakatData(zktDataContract);
    ...
    function depositeZKT_Matic(
        ...
        address person = msgSender();
        bytes32 hashValue = keccak256(
            abi.encodePacked(person, msg.value, _nonce1, _nonce2)
        );
        require(
            (getVerifyAddress(person, hashValue, _v, _r, _s) == verifyAddress),
            "Not verified"
    ...
    function getMessageHash(
        ...
        return keccak256(abi.encodePacked(_sender, _amount, nonce1, nonce2));
    }
