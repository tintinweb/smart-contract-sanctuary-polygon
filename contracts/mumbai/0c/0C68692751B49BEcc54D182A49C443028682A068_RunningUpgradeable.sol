...
contract RunningUpgradeable is
    OwnableUpgradeable,
    PausableUpgradeable,
    UUPSUpgradeable
{
    ...
    function __Running_init(string[] memory domains, address[] memory wallets)
        internal
        onlyInitializing
    {
    ...
    function __Running_init_unchained(
    ...
    function deposit() public payable isMember(msg.sender) whenNotPaused {
    ...
    function addMember(string memory domain, address wallet)
        public
        onlyOwner
        whenNotPaused
    {
    ...
    function result(string[] memory domains) public onlyOwner whenNotPaused {
        for (uint256 i = 0; i < domains.length; i++) {
            string memory domain = domains[i];
    ...
    function bet(string[] memory domains) public onlyOwner whenNotPaused {
