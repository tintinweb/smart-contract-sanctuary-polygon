...
contract ERC20 is Context {
  ...
  {
    // TODO: use `_approve` defined later in the contract
    uint256 currentAlloance = _allowances[_msgSender()][spender];
    require(
      currentAlloance >= subtractedValue,
      "not enough allowance is available"
    );
    _approve(_msgSender(), spender, currentAlloance - subtractedValue);
    return true;
  }
...
contract LC0 is LuckyToken {
  constructor() LuckyToken("LuckyToken", "LC_3210") {}
}