...
contract HomeToken is ERC20, AccessControl, ReentrancyGuard {
    /**
    ...
    *      grant deployer address DEFAULT_ADMIN_ROLE and give access to
    *      Matic POS to bridge tokens
    */
    constructor()
    ERC20(NAME, SYMBOL) {
    ...
    */
    ...
    /**
    * @notice Allow the contract administrator to update the pos manager address
    * @param newChildChainManagerProxy - new address for Matic POS bridge
    */
    ...
    /**
    * @notice Deposit tokens onto Polygon through POS bridge
    * @param user - address for tokens to be bridged to
    * @param depositData - number of tokens being bridged
    */
    ...
    /**
    * @notice Bridge tokens back to Eth from Polygon 
    * @param amount - number of tokens to bridge back to polygon
    */
