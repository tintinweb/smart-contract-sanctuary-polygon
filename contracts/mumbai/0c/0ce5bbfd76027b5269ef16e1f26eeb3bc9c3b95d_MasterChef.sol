...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    T8Ref public T8ReferralContract;
    ...
    function setT8Referral(T8Ref _T8Referral) public onlyOwner {
    ...
    function payReferralCommission(address _user, uint256 _pending) internal {
        if (address(T8ReferralContract) != address(0)) {
             T8Ref.Referral[] memory referrers = T8ReferralContract.getReferrer(_user);
