...
// File: contracts/GloballyUnited.sol
...
contract GloballyUnited is ERC1155, AccessControl {
    string public constant name = "GloballyUnited";
    ...
    function addMintrRole(address _minter)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
