...
contract TokenVesting is Ownable, ReentrancyGuard {
    ...
    event VestingScheduleCreated(
        bytes32 indexed vestingSchedulesId,
    ...
    constructor(address token_) {
        require(token_ != address(0), "TokenVesting: Token address required");
    ...
    function createVestingSchedule(
        ...
        require(
            ...
            "TokenVesting: Beneficiary address required"
        );
        require(
            this.getWithdrawableAmount() >= _amount,
            "TokenVesting: cannot create vesting schedule because not sufficient tokens"
        );
        require(_start > getCurrentTime());
        ...
        onlyIfVestingScheduleNotRevoked(vestingScheduleId)
    {
        ...
        emit Revoked(vestingScheduleId, vestingSchedule.beneficiary);
    }
