...
// File: contracts/nft-test-contract.sol
...
contract TestERC1155Token is ERC1155, Ownable {
  ...
  function mint(address to, string memory tokenUri, uint256 quantity) public onlyOwner {

    _mint(to, supplyCounter.current(), quantity, "");
    tokenURIMap[supplyCounter.current()] = tokenUri;
