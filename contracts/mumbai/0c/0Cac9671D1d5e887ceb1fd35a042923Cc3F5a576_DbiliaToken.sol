  ...
  ReentrancyGuard
{
  ...
  bytes32 private constant PURCHASE_TYPEHASH =
        keccak256('PurchaseInfo(address contractAddress,address buyer,uint256 creatorReceives,uint256 fee,uint256 edition)');
    ...
    bytes32 digest = keccak256(
      abi.encodePacked(
        ...
        keccak256(abi.encode(
          PURCHASE_TYPEHASH, address(this), _msgSender(), _creatorReceives, _fee, _edition
        ))
      )
    );
