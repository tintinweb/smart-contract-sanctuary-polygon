...
// File: contracts/CaesarAugustusOctavianContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CaesarAugustusOctavianContract is RamppERC721A {
    constructor() RamppERC721A("Caesar Augustus Octavian", "CAO"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/RbyH76UqCTvrGBvbkvJW/contract-metadata";
    }
}
