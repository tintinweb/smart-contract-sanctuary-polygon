...
contract NameRegistry_Covest is Initializable, PausableUpgradeable, UUPSUpgradeable {
    ...
    // #1 [Factory => F, policyManager => PM, policyDetail => PDS,Referral => RF, UnderWriter => UW,CA,ProductDesign => PD,CP,PF,Reserve => R,RM,Subsidized => SUB,VerifyAddress => V] //
    // #2 [MIToken => MI,Staking => S] //
