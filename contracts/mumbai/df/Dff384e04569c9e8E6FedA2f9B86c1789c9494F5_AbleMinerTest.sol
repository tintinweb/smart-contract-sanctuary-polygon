...
contract AbleMinerTest {
	using SafeMath for uint256;

    IERC20 public token_ABLET;
	address erctoken = 0x2E4C28E4Cc877512af03543435BFa95D0efFcE0c; /** TestNet ABLET **/

	uint256 constant public INVEST_MIN_AMOUNT = 5 ether; 
	uint256[] public REFERRAL_PERCENTS = [50]; /** Change all setting for testing  **/
	uint256 constant public TOTAL_REF = 50;
	uint256 constant public CEO_FEE = 150;
	uint256 constant public DEV_FEE = 5;
	uint256 constant public REINVEST_BONUS = 100;
	uint256 constant public SEED_BONUS = 50;
	...
	constructor(address payable ceoAddr, address payable devAddr, uint256 start) public {
        ...
        plans.push(Plan(7,  310)); /** Change all setting for testing 31% and 7%  **/
        plans.push(Plan(90, 70));
	}
