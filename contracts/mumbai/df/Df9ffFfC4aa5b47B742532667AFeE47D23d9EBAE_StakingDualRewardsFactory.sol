...
contract StakingDualRewardsFactory is Ownable, CloneBase {
    ...
    event StakingDualRewardsLaunched(uint256 _id, address _stakingPoolsContract);
    ...
    event ImplementationWhitelistStatusUpdated(address _implementation, bool _whitelistStatus);
