...
contract MetaLordz is ERC721Enumerable, Ownable {
    ...
    uint256 public constant metalordzPrice = 0.1 ether;
    uint256 public constant metalordzWLPrice = 0.05 ether;
    uint public maxMetalordzPurchase = 3;
	uint public maxMetalordzPerAddress = 6;
    uint256 public constant MAX_METALORDZ = 8888;
    uint public metalordzReserve = 291;
	...
	event wallet1AddressChanged(address _wallet1, address _wallet2, address _wallet3, address _wallet4);
   ...
   // to set the merkle proof
    ...
    function setWalletAddresses(address _wallet1, address _wallet2, address _wallet3, address _wallet4) external onlyOwner {
        wallet1 = _wallet1;
        wallet2 = _wallet2;
        wallet3 = _wallet3;
        wallet4 = _wallet4;
        emit wallet1AddressChanged(_wallet1, _wallet2, _wallet3, _wallet4);
    }

    function withdrawAll() external onlyOwner {
        require(address(this).balance > 0, "No balance to withdraw.");
        uint256 _amount = address(this).balance;
        (bool wallet1Success, ) = wallet1.call{value: _amount.mul(25).div(100)}("");
        (bool wallet2Success, ) = wallet2.call{value: _amount.mul(25).div(100)}("");
        (bool wallet3Success, ) = wallet3.call{value: _amount.mul(25).div(100)}("");
