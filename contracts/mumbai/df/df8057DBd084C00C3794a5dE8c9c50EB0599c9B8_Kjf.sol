    ...
    ERC20
{
    ...
    address payable public commissionReceiver = payable(msg.sender);
    ...
    function _beforeTokenTransfer(
        ...
        if (from != address(0) && to != address(this) && commission > 0) {
            uint256 commissionValue = (amount * commission) / 100;
            _transfer(from, commissionReceiver, commissionValue);
        }
    }
}