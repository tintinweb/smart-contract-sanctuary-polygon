...
library voucher{
    ...
    event royalty(uint256 tokenId, address reciever, uint256 royaltyAmount);
    ...
    EIP712Upgradeable
{
    ...
    function redeem(uint256 _tokenId) external {
        require(tokenDet[_tokenId].supply > 0, "IT"); //Invalid Token
        require(
            balanceOf(msg.sender, _tokenId) == tokenDet[_tokenId].supply,
            "NE"
        ); //Not Eligible
        _safeTransferFrom(
            msg.sender,
    ...
    function lazyMintNFT(
        ...
        emit voucher.royalty(_tokenId, admin, royaltyAmount);
    }
