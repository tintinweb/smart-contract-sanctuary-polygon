...
contract Minter is IMinter, MintingAccessControlUpgradeable, FractionCostBadges {
    ...
    event TestCost(uint256 cost, address from, address to, address spender, address token);
    ...
    function mintFractionForUserTest(
        ...
        // Emit the event
        emit FractionMinted(id, to, amount, totalCost);
        emit TestCost(totalCost, to, foundationWallet, address(this), address(sybelToken));
    }
