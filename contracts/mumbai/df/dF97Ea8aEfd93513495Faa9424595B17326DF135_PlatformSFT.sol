...
// File contracts/extensions/IERC3525SlotEnumerable.sol
...
// File contracts/ERC3525SlotEnumerable.sol
...
// File contracts/extensions/IERC3525SlotApprovable.sol
...
// File contracts/ERC3525SlotApprovable.sol
...
contract ERC3525SlotApprovable is Context, ERC3525SlotEnumerable, IERC3525SlotApprovable {
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(IERC165, ERC3525SlotEnumerable)
        returns (bool)
    {
        return interfaceId == type(IERC3525SlotApprovable).interfaceId || super.supportsInterface(interfaceId);
    }

    function setApprovalForSlot(address owner_, uint256 slot_, address operator_, bool approved_)
        public
        payable
        virtual
        override
    ...
    function isApprovedForSlot(address owner_, uint256 slot_, address operator_)
        public
        view
        virtual
        override
    ...
    function _isApprovedOrOwner(address operator_, uint256 tokenId_) internal view virtual override returns (bool) {
        ...
        uint256 slot = ERC3525.slotOf(tokenId_);
        return (
            operator_ == owner || getApproved(tokenId_) == operator_ || ERC3525.isApprovedForAll(owner, operator_)
...
contract PlatformSFT is IPlatformSFT, ERC3525, Pool, Ownable {
    ...
    function mint(address mintTo_, uint256 slot_, uint256 value_) external onlyPlatform returns (uint256) {
        // uint256 tokenId_ = ERC3525.totalSupply() + 1;
    ...
    /* to avoid exceed size
    function burn(uint256 tokenId_) external {
        uint256 burnValue_ = ERC3525.balanceOf(tokenId_);
        burnValue(tokenId_, burnValue_); // it will call require(_isApprovedOrOwner(...))
