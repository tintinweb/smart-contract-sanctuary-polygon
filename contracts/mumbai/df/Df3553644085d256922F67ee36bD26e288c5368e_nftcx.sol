...
contract nftcx is Ownable {
    ...
    function getUserInfo(address _user, uint256 _shareId) public view returns (userInfoItem2 memory _userInfo) {
    ...
    function massGetAllUserInfo(address _user) public view returns (userInfoItem2[] memory _userInfoList) {
    ...
    function massGetUserInfo(address _user, uint256[] memory _shareIdList) public view returns (userInfoItem2[] memory _userInfoList) {
