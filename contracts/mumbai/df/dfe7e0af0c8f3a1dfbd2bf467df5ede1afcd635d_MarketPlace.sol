...
contract MarketPlace is ERC165 {
    ...
    mapping(uint256 => uint256) public orderId;
    ...
    event OrderPlaced(uint256 _orderNonce, uint256 timestamp);
    ...
    function placeOrder(
        ...
        emit OrderPlaced(orderNonce, block.timestamp);
        return true;
    }
