...
contract EthermonStakingData is EthermonStakingBasic {
    ...
    function setEmonPerPeriod(uint256 _EmonPerPeriod) external onlyModerators {
    ...
    function getGlobData()
        ...
        returns (
            ...
            uint16 _EmonPeriodMultiplier
        )
    {
        _NewSumTeamPower = NewSumTeamPower;
        _SumTeamPower = SumTeamPower;
        _EmonPerPeriod = EmonPerPeriod;
        _totalStaked = totalStaked;
        _EmonPeriodMultiplier = EmonPeriodMultiplier;
    }
