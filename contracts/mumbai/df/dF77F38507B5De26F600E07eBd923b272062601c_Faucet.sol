...
contract Faucet is Ownable {
    ...
    function claim(
        ...
        require(
            ecr(hashedMessage, v, r, s) == verifiedSigner,
            "Faucet: Invalid caller!"
        );
        require(
            !previousHashedMessages[hashedMessage],
            "Faucet: Wrong message hash!"
        );
        require(
        ...
        previousHashedMessages[hashedMessage] = true;
