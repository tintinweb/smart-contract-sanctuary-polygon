...
contract Comet is Base {
    ...
    function currentBalance(uint256, address account, uint256) public view returns (uint256) {
        return _whitelistMinted[account];
    }

    function remainingBalance(uint256, address account, uint256 maxAmount_) public view returns (uint256) {
