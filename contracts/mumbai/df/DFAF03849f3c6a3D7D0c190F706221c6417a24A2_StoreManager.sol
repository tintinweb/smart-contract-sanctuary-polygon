...
contract StoreManager is ERC1155, Ownable {
    struct Store {
        string name;
    ...
    constructor(Store memory _store) payable ERC1155("") {
        store = _store;
    }
    ...
    // TODO: Change Owner to DAO governance timelock
    function updateStoreInfo(Store memory _store) public onlyOwner {
        store = _store;
    }
