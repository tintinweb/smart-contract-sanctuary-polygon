 ...
 * {ERC721Enumerable}.
 */
contract ERC721 is Context, ERC165, IERC4906, IERC721Metadata {
 ...
 * account.
 */
abstract contract ERC721Enumerable is IERC165, ERC721, IERC721Enumerable {
...
contract AINFT is ERC721Enumerable, AccessControl {
    ...
    constructor() ERC721("OpenNFT", "OPNFT") {
    ...
    function getBase64Data(uint _tokenId) public view returns (string memory) {
        MetaData memory data = tokenData[_tokenId];
    ...
    function mint(
        ...
        require(!ipfsHashes[_ipfsHash], "Image already uploaded");
        ipfsHashes[_ipfsHash] = true;
        
        MetaData storage data = tokenData[_tokenId];
        data.owner = _owner;
