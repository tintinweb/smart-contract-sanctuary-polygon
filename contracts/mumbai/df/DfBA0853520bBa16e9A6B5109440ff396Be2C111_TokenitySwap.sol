    ...
    TransferHistory
{
    ...
    // @dev fee calculation for token
    function setNewFee(uint256 _newFee) external onlyOwner returns (bool) {
        fee = _newFee;
        return true;
    }

    // @dev Active Oracle
    function setActiveOracle(bool _active) external onlyOwner returns (bool) {
        oracleActive = _active;
        return true;
    }

    // @dev Address Oracle
    function setAddressOracle(address _address)
        external
        onlyOwner
        returns (bool)
    {
    ...
    // @dev Amount Token
    function setAmountToken(uint256 _amountToken)
        external
        onlyOwner
        returns (bool)
    {
    ...
    // @dev Price Token
    function setPriceToken(uint256 _priceToken)
        external
        onlyOwner
        returns (bool)
    {
    ...
    // @dev Price Token
    function setTokenityToken(address _token)
        external
        onlyOwner
        returns (bool)
    {
