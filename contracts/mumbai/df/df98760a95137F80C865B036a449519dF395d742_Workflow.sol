...
contract Workflow is KeeperCompatibleInterface {
    ...
    */
    ...
    event TestEvent(uint amountA, uint amountB, uint pair);
    ...
    function removeLiquidity(
        ...
        IERC20(pair).transferFrom(msg.sender, address(this), _liquidityAmount);

        IERC20(pair).approve(ROUTER, _liquidityAmount);
