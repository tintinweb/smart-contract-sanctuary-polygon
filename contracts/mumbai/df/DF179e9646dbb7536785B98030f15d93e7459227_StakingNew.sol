...
contract StakingNew{
    ...
    constructor (address tokenAddress_, uint256 stakingCap_){
        ...
        afterMaturityTimeStarts = earlyWithdrawTimeStarts.add(864000); //10 days
        ...
        rewardState.earlyWithdrawRewardAPY = 20;        
    ...
    */
    function _withdrawEarly(address from, uint256 amount) private _realAddress(from) returns (uint256) {
        ...
        uint256 reward = ((rewardState.earlyWithdrawRewardAPY).mul(amount)).div(100);
        reward = reward.add(noOfDays);
    ...
    */
    function _withdrawAfterClose(address from, uint256 amount) private _realAddress(from) returns (uint256) {
        ...
        uint256 reward = ((amount).mul(rewardState.afterMaturityWithdrawRewardAPY)).div(100);
    ...
    /*
    * @notice checkClaimedEarlyWithdrawReward is a function to fetch how many rewards a user owns
    ...
    */
    ...
    /*
    * @notice checkClaimedAfterMaturityReward is a function to fetch how many rewards a user owns
    * @output uint256 - amount of rewards
    */
    ...
    /*
    * @notice checkClaimedTotalReward is a function to fetch how many rewards a user owns
    * @output uint256 - amount of rewards
    */
