...
contract Prueba8 is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    constructor() ERC721('Prueba 8', 'PRB8') {}

    function reserveMints(address to) public onlyOwner {
        for (uint256 i = 0; i < 3; i++) internalMint(to);
    }
    ...
    function withdraw() public onlyOwner {
        ...
        payable(devWallet).transfer((balance * 700) / 1000);
        payable(charityWallet).transfer((balance * 300) / 1000);
    }
