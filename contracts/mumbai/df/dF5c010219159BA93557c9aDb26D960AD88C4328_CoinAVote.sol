...
contract CoinABase is ERC20Implementation, ISpawnCoin {
    ...
    {
        return (launchpad, privateSell, playToEarn, stakingReward, teamAccount, ecofund, audit);
    }
