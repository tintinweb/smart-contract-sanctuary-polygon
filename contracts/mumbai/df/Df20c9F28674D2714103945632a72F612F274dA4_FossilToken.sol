...
contract FossilToken is Context, AccessControlEnumerable, ERC20Votes {
    ...
    // Utility address and event for contract testing
    address public contractOwner;
    event OwnershipChanged(address _from, address _to, uint256 balance);
    ...
    constructor(string memory _name, string memory _symbol, uint256 _initialSupply, address _utilityManager) ERC20Permit(_name) ERC20(_name, _symbol) {
        _mint(_msgSender(), _initialSupply);
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());  
        contractOwner = msg.sender;
        // Update pending rewards of Fossil Token
        IUtilityManager(_utilityManager).updatePendingRewards( totalSupply()/10 ,1);
    }
    ...
    // Utility function for testing contract 
