...
contract capsStaking is Ownable {
    ...
    function getUserData(
        address userAddress
    ) external view returns (uint, uint, uint, uint, bool, uint, uint) {
    ...
    function calculateRewardPerStack(
        address userAddress
    ...
    function getClaimableRewardAndTokens(
        address userAddress
    ...
    function getUserTotalStackedAmount(
        address userAddress
    ) public view returns (uint) {
    ...
    function getStacksData_Arr(
        address userAddress
    ) external view returns (stackData[] memory) {
        User storage tempUserData = usersData[userAddress];
        int arrSize = int(
