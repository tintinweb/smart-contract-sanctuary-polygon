...
abstract contract RehideBase is Ownable, IRehideBase {
    /**
     * @dev NFT
     */
    ...
    uint256 public _maxReferrerRewardsPercentage = 50; // safety limit, max rewards paid per tx
...
contract RehideNFT is IRehideNFT, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, RehideBase {
            ...
            if (referrer != _msgSender()) {
                ...
                if (primaryReferrer != address(0)) {
                    ...
                    if (whitelistReferrerRewardsPercentage > 0) {
                        ...
                        primaryReferrerReward = whitelistReferrerReward - totalTxReferrerRewards;
                    }
