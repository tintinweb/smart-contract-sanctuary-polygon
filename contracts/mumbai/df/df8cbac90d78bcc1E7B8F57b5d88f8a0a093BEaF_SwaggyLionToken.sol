...
contract SwaggyLionToken is IERC20, Ownable, BaseToken {
    ...
    constructor(
        ...
        console.log("______ 3 ________: %s", _tTotal);
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(router_);
        console.log("_____ 3.1 _______: %s", router_);
        console.log(
            "______ 3.1 ________ factory: %s",
            _uniswapV2Router.factory()
        );
        console.log("______ 3.1 ________ WETH: %s", _uniswapV2Router.WETH());
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), _uniswapV2Router.WETH());
        console.log("______ 3.2 ________");
        uniswapV2Router = _uniswapV2Router;
        console.log("______ 3.3 ________");
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;

        console.log("______ 4 ________");
