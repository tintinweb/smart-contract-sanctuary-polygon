...
import './MCEggDropBase.sol';

/**
 * @title MCED wrapper contract
 */
contract MCED is MCEggDropBase {
    constructor()
        MCEggDropBase(
            'MCED',
            'MCED',
            'https://nftculture.mypinata.cloud/ipfs/QmXJUb2XrSfdYXqW4rS3CmJJnYwZTYFcC4H6QBHYyi4zSc/'
        )
    {
        // Implementation version: 1
        // Alpha Release: Contract Address = 0xE96B2F2429eb1950DBFdaf1d057174eEab4764b3
    }
    ...
    {
        return string(abi.encodePacked(super._tokenFilename(tokenId)));
    }
}
 ...
 */
abstract contract MCEggDropBase is
    ERC721A,
    Ownable,
    ...
    ReentrancyGuard
{
    ...
    uint256 private constant MAX_BATCH_SIZE = 3;
