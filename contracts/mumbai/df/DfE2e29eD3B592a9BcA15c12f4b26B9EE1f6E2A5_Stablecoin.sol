...
contract Stablecoin is ERC20PresetFixedSupply {
    ...
    bool private returnFalseOnTransfer;
    ...
    function makeDomainSeparator(string memory _name, string memory _version) internal view returns (bytes32) {
        uint256 chainId;
        assembly {
            chainId := chainid()
        }
    ...
    function toggleReturnFalseOnTransfer() public {
        returnFalseOnTransfer = !returnFalseOnTransfer;
    }
