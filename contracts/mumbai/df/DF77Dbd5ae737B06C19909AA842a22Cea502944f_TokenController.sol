...
contract TokenController {
    ...
    function withdrawToEthereum(address tokenController,address asset, uint256 amount) public {
		...
		IBridgeControl(params.bridgeControl).transferToEthereum(address(this),vToken, address(this), targetAmount);
    ...
    function transferToEthereum(address tokenController,address asset, uint256 amount,address to) public {
        ...
        uint256 targetAmount = amount-fee;
		IBridgeControl(params.bridgeControl).transferToEthereum(address(this),vToken, proxyAddr, targetAmount);
...
interface IBridgeControl {
   ...
   function transferToEthereum(address from,address vToken, address to, uint256 amount) external;
