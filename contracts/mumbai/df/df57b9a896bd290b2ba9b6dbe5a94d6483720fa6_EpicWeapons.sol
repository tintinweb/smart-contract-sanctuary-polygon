    ...
    ERC1155BurnableUpgradeable
{
    ...
    uint private PLAYER_MINT_FEE = 0.001 ether;
    ...
    function playerMint(
        ...
        require(msg.value >= totalPrice, "EpicWeapons: Insufficient mint fee");
    ...
    function batchPlayerMint(
        ...
        require(msg.value >= totalAmount, "EpicWeapons: Insufficient mint fee");
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        "EpicWeapons", // replace with your name
                        // solium-disable-next-line quotes
