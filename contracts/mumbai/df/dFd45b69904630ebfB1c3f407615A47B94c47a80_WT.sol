...
// File: contracts/contracts/IERC2981Royalties.sol
...
// File: contracts/contracts/ERC2981Base.sol
...
// File: contracts/contracts/ERC2981ContractWideRoyalties.sol
...
// File: contracts/contracts/WebToy.sol
...
contract WT is ERC1155, AccessControl, Ownable, ERC2981ContractWideRoyalties {
    ...
    mapping(address => bool) public playerAddr;
    ...
    */
    ...
    /*
     * @dev
     *      Retreive full list of token owners.
     */
    ...
    * WRITE 
    ░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░
    * ADMIN: Address permissioned funcs
    ░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░
    */
     ...
     *      _ids - Ids of tokens to be minted
     */
    function distribute(address[] memory _to, uint256[] memory _ids)
        external
        onlyRole(DISTRIBUTOR)
    {
        require(!paused, "Contract is currently paused.");

        if (_to.length > 0 && _to.length == _ids.length) {
            for (uint256 i = 0; i < _to.length; ++i) {
                address addr = _to[i];
                // if addr is not already in list
                // check _to player uniqueness
                if (playerAddr[addr] == false) {
                    _mint(addr, _ids[i], 1, "");
                    circulation += 1; // If amount is larger than 1 we need to make sure circulation is correctly incremented
                    playerAddr[addr] = true;
                    owners.push(addr);
                }
            }
        }
    ...
    /*
     * @dev
     *      Allows to set the royalties on the contract.
     * @params
     *      _recipient - Recipient the royalties recipient
     *      _value - Value royalties value (between 0 and 10000) 500 = 5%
     */
