...
contract ChainBattles is ERC721URIStorage {
    ...
    mapping(uint256 => Anim) public tokenIdToStats;
    ...
    function mint() public {
        ...
        tokenIdToStats[newItemId].speed = random(2);
        tokenIdToStats[newItemId].strength = random(2);
        tokenIdToStats[newItemId].health = 3;
    ...
    function train(uint256 tokenId) public {
        ...
        mapping(uint256 => Anim) storage tokenID = tokenIdToStats;
        ...
        tokenID[tokenId].level = currentLevel + 1;
        tokenID[tokenId].speed = currentSpeed + 1;
        tokenID[tokenId].strength = currentStrength + 1;
        //tokenIdToStats[tokenId].health = currentHealth;
        //You could do a buy health for health
