...
contract JuanFourRafCon is VRFConsumerBaseV2, ReentrancyGuard {
    ...
    event TransferReceived(uint room_number,address _from, uint _amount, uint playersLength,address[] s_players, uint playingSlots);
    ...
    function join(uint entryFee, uint room_number) public nonReentrant {
        ...
        // }
        emit TransferReceived(room_number,msg.sender, entryFee, raffle_room[room_number].s_players.length,raffle_room[room_number].s_players,raffle_room[room_number].playingSlot);
