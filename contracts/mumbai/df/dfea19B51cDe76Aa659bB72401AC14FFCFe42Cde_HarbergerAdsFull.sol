...
contract HarbergerAdsFull is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    constructor(uint256 _taxRate, uint256 _cooldownPeriod, IERC20 _currency, address _collector) ERC721("Harberger Ads - EthCC Hack 2022", "HAA") {
        taxRate = _taxRate;
        currency = _currency;
