...
contract ADM {
    ...
    uint256 private constant dayPerCycle = 7 hours; 
    uint256 private constant dayRewardPercents = 150;
    uint256 private constant maxAddFreeze = 30 hours;
    ...
    function _calLevelNow(address _user) private view returns(uint256) {
        ...
        if(total >= 200e6 && user.teamNum >= 10 && maxTeam >= 4000e6 && otherTeam >= 4000e6 && maxTeamC >= 5 && otherTeamC >= 5){
             levelNow = 5;
        }else if(total >= 200e6 && user.teamNum >= 8 && maxTeam >= 2500e6 && otherTeam >= 2500e6 && maxTeamC >= 4 && otherTeamC >= 4){
             levelNow = 4;
        }else if(total >= 150e6 && user.teamNum >= 6 && maxTeam >= 2000e6 && otherTeam >= 2000e6 && maxTeamC >= 3 && otherTeamC >= 3){
             levelNow = 3;
        }
        else if(total >= 100e6 && user.teamNum >= 4 && maxTeam >= 1000e6 && otherTeam >= 1000e6 && maxTeamC >= 2 && otherTeamC >= 2 ){
           levelNow = 2;
        }else if(total >= 50e6){
            levelNow = 1;
        }
