...
contract IterativeVestingFarm is OwnableUpgradeable, ReentrancyGuardUpgradeable{
        ...
        returns(uint256, uint256, uint256)
    {
        if(nVestingPortions != 1){
            ...
            return (0, totalRewards, totalWithdrawn);
        }
    }
    ...
    {
        uint256 amountEarned = calculateEarnings(user);
        ...
        return(
            amountEarned + totalUserPayouts[user],
            totalUserRewards[user].sub(amountEarned + totalUserPayouts[user]),
    ...
    /**
     * @notice function is calculating earnings of user at this moment
     *
     * @param user - address of user
     */
        ...
        returns (uint256)
    {
        ...
        uint256 rewardPerPortion = (totalUserRewards[user] / nVestingPortions);
        uint256 nPortionsVested = (
            (
                (
                    block.timestamp - startTime
        ...
        if(withdrawFirstPortion[user]){
            require(
                userLastWithdrawnPortionNumber[user] < nPortionsVested,
        ...
        amountEarned = (
            (
                (nPortionsVested - userLastWithdrawnPortionNumber[user])
            ) * (totalUserRewards[user] / nVestingPortions)
        );
        ...
        returns (uint256)
    {
        ...
        uint256 rewardPerPortion = (
            totalUserRewards[address(msg.sender)] / nVestingPortions
        );
        uint256 nPortionsVested = (
            (
                (
        ...
        amountEarned = (
            (
                (nPortionsVested - userLastWithdrawnPortionNumber[address(msg.sender)])
            ) * (totalUserRewards[address(msg.sender)] / nVestingPortions)
        );
        ...
        nonReentrant
    {
        ...
        uint256 amountEarned = _withdrawCalculation();

        if (amountEarned > 0){
            uint256 totalLeftLockedForUser = totalUserRewards[address(msg.sender)]
