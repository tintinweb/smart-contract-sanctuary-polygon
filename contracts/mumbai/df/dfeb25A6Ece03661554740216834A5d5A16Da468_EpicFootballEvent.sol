...
contract EpicFootballEvent is ReentrancyGuard, Ownable {
    ...
    modifier roundAvailable(uint8 _roundId) {
        ...
        require(
            purchaseRound.whitelistCount < purchaseRound.supply,
        ...
        roundAvailable(_roundId)
    {
        ...
        require(
            purchaseRound.whitelistCount == 0,
            "Cannot change price of a round after someone be whitelisted"
        );
        ...
        roundAvailable(_roundId)
    {
        ...
        require(
            purchaseRound.supply >= purchaseRound.whitelistCount + 1,
        ...
        if (roundLimitNft[_roundId] > 0) {
            require(
                roundMinted[_roundId][buyer] + 1 <=
                    roundLimitNft[_roundId],
                "You cannot mint more NFT"
            );
        }
        purchaseRound.whitelistCount += 1;
