...
contract D_ERC1155_Generic is ERC1155, Ownable, AccessControl {
    ...
    function mint(
        ...
        emit DynamicERC1155Minted(account_, uris_, backendTokenKey_, tokenId, amount_);
    }
     ...
     */
    function changeToken(string memory backendTokenKey_, uint256 level_) public onlyRole(DEFAULT_ADMIN_ROLE) {
        uint256 tokenId = getTokenId(backendTokenKey_);
     ...
     */
    function getTokenId(string memory backendTokenKey) public view returns (uint256) {
     ...
     */
    function getTokenKeyList() public view returns (string[] memory) {
        return _keyFallback;
    }
