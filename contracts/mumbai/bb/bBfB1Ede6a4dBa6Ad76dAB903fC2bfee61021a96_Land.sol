...
contract Land is ERC721Mintable, ERC721Permit("GensoKishiOnlineLand") , Ownable, ERC721URIStorage{
    string public _defaultURI;
    event UpdateDefaultURI(string defaultURI);

    constructor() ERC721("GensoKishiOnlineLand", "Genso_Land_NFT") {
        setDefaultURI("https://api01test.genso.game/api/land_metadata/");
    }
