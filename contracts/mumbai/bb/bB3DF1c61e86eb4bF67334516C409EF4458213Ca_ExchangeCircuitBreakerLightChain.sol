...
interface IIssuer {
    ...
    function transferMargin(uint256 marginDelta) external returns (uint256);
 ...
 *
 */
contract ExchangeCircuitBreakerLightChain is Owned, MixinSystemSettings, IExchangeCircuitBreaker {
