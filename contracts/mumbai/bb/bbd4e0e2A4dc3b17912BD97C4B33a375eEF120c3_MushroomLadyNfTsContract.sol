...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x06caca57Fe99a445115288c569eF91bF93a45Bdf];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmS4g7sZMkchx2UP4yeQbi6FkapxFeaqsbKZKLcoqZ4jPe/";
...
// File: contracts/MushroomLadyNfTsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MushroomLadyNfTsContract is RamppERC721A {
    constructor() RamppERC721A("Mushroom Lady NFTs", "MLNFT"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/qTKDcFIiXUylzy3WlL46/contract-metadata";
    }
}
