	...
	Ownable
{
	...
	// Contract name
	string public constant name = "Viker Polkapet Pass";
	// Contract symbol
	string public constant symbol = "VKRPPP";
	string private constant _uri = "https://api.ppw.digital/api/viker_pass/";
