...
contract BratkiBeerChallenge is ERC721URIStorage {
    ...
    function generateCharacter(uint256 tokenId, Contestant memory contestant) public returns(string memory){
        bytes memory svg = abi.encodePacked(
            ...
            '<text x="50%" y="40%" class="base" dominant-baseline="middle" text-anchor="middle">',"Beers: ",getBeerCount(tokenId),'</text>',
            '<text x="50%" y="50%" class="base" dominant-baseline="middle" text-anchor="middle">',"Life: ",contestant.life,'</text>',
            '<text x="50%" y="60%" class="base" dominant-baseline="middle" text-anchor="middle">',"Strength: ",contestant.strength,'</text>',
            '<text x="50%" y="70%" class="base" dominant-baseline="middle" text-anchor="middle">',"Speed: ",contestant.speed,'</text>',
            '</svg>'
        );
        return string(
            abi.encodePacked(
    ...
    function getBeerCount(uint256 tokenId) internal view returns (string memory) {
        return tokenIdToContestant[tokenId].beerCount.toString();
    }

    function getTokenURI(uint256 tokenId, Contestant memory contestant) public returns (string memory) {
        ...
        '{',
            ...
            '"image": "', generateCharacter(tokenId, contestant), '"',
