...
contract Sanych is ERC1155, AccessControl {
    ...
    constructor() 
        ERC1155(
            "https://gateway.pinata.cloud/ipfs/Qme6xUbwcjmxWQDaLaE2UtCKSNMvUarvF2m4Bbrr5jJthr/{id}.json"
        ) 
    {
    ...
    function uri(uint256 _id) public pure override returns (string memory) {
        return
            string(
                abi.encodePacked(
                    "https://gateway.pinata.cloud/ipfs/Qme6xUbwcjmxWQDaLaE2UtCKSNMvUarvF2m4Bbrr5jJthr/",
