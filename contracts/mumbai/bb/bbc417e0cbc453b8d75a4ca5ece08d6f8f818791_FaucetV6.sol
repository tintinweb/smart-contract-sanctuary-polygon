...
contract FaucetV6 {
    ...
    uint256 public initialAmountToSend = 0.01 ether;
    bool public paused;
    ...
    function send() external {
        ...
        require(getBalance() >= initialAmountToSend, "Sorry! Insufficient balance");

        uint256 amountToSend = initialAmountToSend;
    ...
    function setAmountToSend(uint256 newAmountToSend) external onlyOwner {
        initialAmountToSend = newAmountToSend;
    }
