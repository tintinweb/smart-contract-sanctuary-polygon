...
import "./AdminIndex.sol";
import "./IIndex.sol";

import "hardhat/console.sol";

contract IndexAdmin is AccessControl, IIndex, AdminIndex {
    ...
    function stake(
        ...
        emit Stake(msg.sender, cost, amountLP);
    }
...
import "contracts/IndexAdmin/IAdminIndex.sol";

abstract contract AdminIndex is IAdminIndex {
    bytes32 public constant DAO_ADMIN_ROLE = keccak256("DAO_ADMIN_ROLE");

    function newIndexComposition(address[] calldata assets) external virtual;
}
