...
contract ArbNFTTest is ERC721, Ownable, Pausable {
    ...
    string private rb1 = 'B';
    string private rc1 = 'C';
    string private rd1 = 'D';
    ...
    string private tr1='", "attributes": [{"trait_type": "hat style","value": "';
    string private tr2='"},{"trait_type": "accessory","value": "';
    string private tr3='"},{"trait_type": "item","value": "';
    string private tr4='"},{"trait_type": "color","value":  [{"trait_type": "hatBackgroundColor", "value": "';
    string private tr5='"},{"trait_type": "hatLineColor","value": "';
    string private tr6='"},{"trait_type": "eyesColor","value": "';
    string private tr7='"},{"trait_type": "clothesColor","value": "';
    string private tr8='"},{"trait_type": "logoClothesColor","value": "';
    string private tr9='"},{"trait_type": "trousersColor","value": "';
    ...
    function randomOne(uint256 tokenId) internal view returns (Arb memory) {
        ...
        arb.hatName = genHat(random(string(abi.encodePacked(ra1,tokenId.toString()))))[2];

        if(random(string(abi.encodePacked(rc1,tokenId.toString()))) % 3 == 0) {
            arb.accessoryName = genAccessory(random(string(abi.encodePacked(ra1,tokenId.toString()))))[1];
            arb.accessory = uint8(seed % color.length);
            seed = uint256(keccak256(abi.encodePacked(seed, arb.accessory)));
        }
        
        if(random(string(abi.encodePacked(rd1,tokenId.toString()))) % 2 == 0) {
            arb.itemName = genItems(random(string(abi.encodePacked(ra1,tokenId.toString()))))[1];
            arb.accessory = uint8(seed % color.length);
            seed = uint256(keccak256(abi.encodePacked(seed, arb.accessory)));
        }

        arb.item = uint8(seed % color.length);
    ...
    function getTraits(Arb memory arb) internal view returns (string memory) {
        ...
        o = string(abi.encodePacked(tr4,uint256(arb.hatBg).toString(),tr5,uint256(arb.hatLine).toString()));
        o = string(abi.encodePacked( o, tr6, uint256(arb.eyes).toString(),tr7,uint256(arb.clothes).toString()));
        return string(abi.encodePacked(o,tr8,uint256(arb.logoClothes).toString(),tr9,uint256(arb.trousers).toString(),tr10));
        //string memory o = string(abi.encodePacked('", "attributes": [{"trait_type": "hat style","value": "hat 1"},{"trait_type": "accessory","value": "hat 2"},{"trait_type": "Color","value": [{"trait_type": "hatBackgroundColor","value": "1"},{"trait_type": "hatLineColor","value": "1"}] ' ,tr7));
        //return o;
    }
    ...
    string private sp1 = '"/>';
    string private attrHat;
    string private attrAccessory;
    string private attrItem;
    ...
    function genImgSVG(uint256 tokenId) public view returns (string memory) {
        ...
        output = string(abi.encodePacked(output, genHat(random(string(abi.encodePacked(ra1,tokenId.toString()))))[0], color[arb.hatBg], sp1));
        output = string(abi.encodePacked(output, genHat(random(string(abi.encodePacked(ra1,tokenId.toString()))))[1], color[arb.hatLine], sp1));
        output = string(abi.encodePacked(output, genEyes(random(string(abi.encodePacked(re1,tokenId.toString())))), color[arb.eyes], sp1));
        if(random(string(abi.encodePacked(rc1,tokenId.toString()))) % 3 == 0) {
            output = string(abi.encodePacked(output, genAccessory(random(string(abi.encodePacked(rc1,tokenId.toString()))))[0], color[arb.accessory], sp1));
        }
        output = string(abi.encodePacked(output, z[13], color[arb.clothes], sp1, z[14], color[arb.logoClothes], sp1));
        if(random(string(abi.encodePacked(rd1,tokenId.toString()))) % 2 == 0) {
            output = string(abi.encodePacked(output, genItems(random(string(abi.encodePacked(rd1,tokenId.toString()))))[0], color[arb.item], sp1));
        }
