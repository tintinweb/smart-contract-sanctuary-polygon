...
contract Stacking is Ownable {
    ...
    IBEP20 public rewardToken=IBEP20(0x2D06f4a2b20469338e1C5C2F43d93029f260C27A);
    struct Plan {
        uint256 time;
        uint256 percent;
    }
    ...
    bool public  hasStartStakcing = false;
    bool public hasStartsale=false;
    ...
    */
    function buyToken(uint256 amount) public {
        ...
        uint256 buyTokens=amount.div(1e18).mul(6);
