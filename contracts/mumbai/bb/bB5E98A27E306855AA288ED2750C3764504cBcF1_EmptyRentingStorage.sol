...
contract EmptyRentingStorage is Context, IRentingContractStorageTypes, MarketplaceAccessControl {

    function getLandStatus(uint256 landId) external pure returns (TokenRentingStatus) {
        return TokenRentingStatus.AVAILABLE;
    }

    function getBotStatus(uint256 botId) external pure returns (TokenRentingStatus) {
        return TokenRentingStatus.AVAILABLE;
    }
