...
contract MorganningMumbai is MorganningDeployable {
    ...
    constructor()
        MorganningDeployable(
            mumbaiVrfCoordinator,
            linkTokenContract,
            keyHashParam
        )
    {}
    ...
    VRFConsumerBaseV2Upgradeable
{
    ...
    function mintGreenList(
        ...
        uint256 s_requestId = VRFCoordinatorV2Interface(vrfCoordinator)
            .requestRandomWords(
                ...
                callbackGasLimit,
                2 // num of random numbers to request
            );
    ...
    function fulfillRandomWords(uint256 requestId, uint256[] memory randomWords)
        ...
        override
    {
        (uint8 randomLayer0, uint8 randomLayer1) = (
            determineRandomLayer(randomWords[0] % 100),
            determineRandomLayer(randomWords[1] % 100)
        );
