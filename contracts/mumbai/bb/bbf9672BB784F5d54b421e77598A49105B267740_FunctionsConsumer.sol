...
contract FunctionsConsumer is FunctionsClient, ConfirmedOwner {
  ...
  function fulfillRequest(
    ...
    nft.updateImage(uint256(bytes32(response)));
...
contract DynamicNFT is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    constructor(address vrfConsumerAddr) ERC721("DynamicNFT", "DNFT") {
        vrfConsumer = VRFv2Consumer(vrfConsumerAddr);
    }
    ...
    function randomMint(uint256 random, uint256 requestId) external {
        uint256 randomness = random % 3;
...
contract VRFv2Consumer is VRFConsumerBaseV2, ConfirmedOwner {
    ...
    function fulfillRandomWords(
        ...
        dynamicNft.randomMint(_randomWords[0], _requestId);
