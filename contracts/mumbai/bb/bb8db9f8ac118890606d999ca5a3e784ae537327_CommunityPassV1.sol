    ...
    IOwnable
{
    ...
    function issuedAt(uint256 tokenId) public view onlyRole(DELEGATE_ISSUER_ROLE) returns (uint256) {
    ...
    /// @return uint256 When the token was issued
    function transferredAt(uint256 tokenId, uint256 index)
        public
        view
        onlyRole(DELEGATE_ISSUER_ROLE)
        returns (uint256)
    ...
    /// @param tokenId The tokenId
    /// @return uint256
    function numTransfers(uint256 tokenId) public view onlyRole(DELEGATE_ISSUER_ROLE) returns (uint256) {
