...
contract TransferProxy {
    ...
    */    
    ...
    function erc721mint(IBase721 token, address from, string memory tokenURI, address[] memory royalty, uint256[] memory royaltyFee) external onlyOperator {
        token.createCollectible(from, tokenURI, royalty, royaltyFee);
    }

    function erc1155mint(IBase1155 token, address from, string memory tokenURI, address[] memory royalty, uint256[] memory royaltyFee, uint256 supply) external onlyOperator {
