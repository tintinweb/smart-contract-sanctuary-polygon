...
// File: contracts/LongNeckOrigin.sol
...
contract LongNeckOrigin is ERC721Enumerable, Ownable {
    using Strings for uint256;

    string public baseURI;
    string public baseExtension = ".json";
    uint256 public cost = 2190 ether;
    uint256 public presaleCost = 2190 ether;
    uint256 public maxSupply = 9997;
    uint256 public maxMintAmount = 9997;
