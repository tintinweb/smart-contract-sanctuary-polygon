    ...
    function decantNewClone(uint _id) public {
        ...
        characters.push(Character(
            ...
            Traits(
                ...
                _smallIntBetweenVals(2, defenseCap, _sliceHashToSmallInt(finalHash, 3, 9)),
                _smallIntBetweenVals(2, hackCap, _sliceHashToSmallInt(finalHash, 3, 12)),
                _smallIntBetweenVals(2, breachCap, _sliceHashToSmallInt(finalHash, 3, 15)),
                _smallIntBetweenVals(2, shootCap, _sliceHashToSmallInt(finalHash, 3, 18)),
                _smallIntBetweenVals(2, meleeCap, _sliceHashToSmallInt(finalHash, 3, 21))
            ),
            0,
