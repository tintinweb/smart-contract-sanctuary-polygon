...
contract Quarters is ERC20Authorization, Ownable {
    ...
    function transferFrom(
        ...
        require(!pauseTransfer, "Quarters: Contract is Paused");
    ...
    function buy(uint256 usdtAmount) public {
        // require(usdt.balanceOf(msg.sender) >= usdtAmount);
    ...
    function buyFor(address buyer, uint256 kusdtAmount) public payable {
        require(usdt.balanceOf(msg.sender) >= kusdtAmount);
        ...
        returns (uint256)
    {
        ...
        uint256 nq = usdtAmount.mul(usdtRate).div(10**6);
    ...
    function withdraw(uint256 value) public onlyActiveDeveloper {
        ...
        uint256 earnings = usdt.balanceOf(address(this)).div(totalSupply());

        _burn(msg.sender, value);

        // earning for developers
        usdt.transfer(msg.sender, earnings);
...
abstract contract ERC20Authorization is ERC20, IEIP3009, EIP712 {
    ...
    function _transferWithAuthorization(
        ...
        require(!_authorizationStates[from][nonce], AUTHORIZATION_USED_ERROR);
