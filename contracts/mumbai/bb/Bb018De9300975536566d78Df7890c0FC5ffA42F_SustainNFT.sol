...
contract SustainNFT is SustainSigner, OwnableUpgradeable, ERC721Upgradeable, VRFConsumerBaseV2{
    ...
    function getCodeSize(address someAddress) external view returns (uint) {
        return someAddress.code.length;
    }
    ...
    function setID(uint64 _ss) external onlyOwner{
        s_subscriptionId=_ss;
    }
}
...
//  }
  ...
  function __Chianlink_init(address _vrfCoordinator) internal {
    vrfCoordinator = _vrfCoordinator;
  }
