    ...
    */
    ...
    function buyer_approveGig(uint256 _id) public payable nonReentrant {
        ...
        if(gigMap[_id].currency == tokens[tokens.length-1]){ 
            ...
            require(gigMap[_id].currency.allowance(msg.sender, address(this)) >= totalFee, "Allowance not given"); 
            gigMap[_id].currency.transferFrom(msg.sender, address(this), totalFee.sub(_platformFee));
            gigMap[_id].currency.transferFrom(  msg.sender, platformFeeAccount,_platformFee);
        }
        // }
...
*/
    ...
    function buyer_makeGig(
        ...
        if (_choose < 3) {
            ...
            gigMap[_id].currency.transferFrom(msg.sender,address(this),totalFee); // Taking money into Escrow
