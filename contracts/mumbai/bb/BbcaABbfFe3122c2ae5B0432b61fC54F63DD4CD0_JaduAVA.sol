...
contract JaduAVA is ERC721AQueryable, AccessControl, Ownable {
    ...
    constructor() ERC721A("MCTAVA", "MCTA") {
    ...
    function upgrade(address _upgradedToAddress) external payable {
        require(
    ...
    function setBaseURI(string calldata baseURI) external payable {
        require(
            hasRole(DEFAULT_ADMIN_ROLE, _msgSender()),
            "unauthorized access"
        );
    ...
    function mint(address to, uint256 size) external payable returns (bool) {
        require(
