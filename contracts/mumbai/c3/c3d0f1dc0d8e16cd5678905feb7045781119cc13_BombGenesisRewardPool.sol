...
contract BombGenesisRewardPool {
    ...
    // MAINNET
     uint256 public BombPerSecond = 13.88888 ether; // 23000 Bomb / (24h * 60min * 60s) 0.2662037
     uint256 public runningTime = 2 days; // 1 days
     uint256 public constant TOTAL_REWARDS = 2400000 ether;
    // END MAINNET
    ...
    // Safe Bomb transfer function, just in case if rounding error causes pool to not have enough Bomb.
