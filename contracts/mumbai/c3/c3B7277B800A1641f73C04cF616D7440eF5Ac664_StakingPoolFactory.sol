...
contract StakingPoolFactory is Ownable, CloneBase {
    ...
    address[] public stakingRewardsList;
     ...
     */
    function _launchRewards(uint256 _id, bytes memory _encodedData)
        internal
        returns (address)
    {
        IERC20 rewardsToken;
        ...
        IMinimalProxy(stakingDualRewards).init(_encodedData);

        stakingRewardsList.push(stakingDualRewards);

        emit StakingRewardsLaunched(_id, stakingDualRewards);
     ...
     * @param _encodedData Encoded data.
     */
    function launchRewards(uint256 _id, bytes memory _encodedData)
        external
        payable
        returns (address)
    {
        address stakingRewardsAddress = _launchRewards(_id, _encodedData);
     ...
     */
    function launchRewardsWithReferral(
        uint256 _id,
        address _referrer,
