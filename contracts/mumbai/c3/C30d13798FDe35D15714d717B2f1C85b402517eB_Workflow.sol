...
contract Workflow is KeeperCompatibleInterface {
    ...
    */
    ...
    uint256 public amountTokenA;
    uint256 public amountTokenB;
    ...
    function _addLiquidityToQuickswap(
        ...
        IERC20(_tokenA).transferFrom(creator, address(this), _amountA);
        IERC20(_tokenB).transferFrom(creator, address(this), _amountB);
