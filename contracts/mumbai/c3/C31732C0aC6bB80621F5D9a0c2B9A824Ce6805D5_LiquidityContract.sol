...
// File contracts/UniswapLiquidityProvider.sol
...
contract LiquidityContract is IERC721Receiver {
    ...
    uint24 public constant poolFee = 3000; // configure this pool fee
    ...
    constructor(
        INonfungiblePositionManager _nonfungiblePositionManger,
        address _tokenA,
        address _tokenB
    ) {
    ...
    function mintNewPosition() external returns (
        ...
        uint256 token0ToMint = 1000;
        uint256 token1ToMint = 1000;

        TransferHelper.safeTransfer(tokenA, address(nonfungiblePositionManager), token0ToMint);
        TransferHelper.safeTransfer(tokenB, address(nonfungiblePositionManager), token1ToMint);
        ...
        INonfungiblePositionManager.MintParams({
            ...
            amount0Desired: token0ToMint,
            amount1Desired: token1ToMint,
            amount0Min: 0,
            amount1Min: 0,
