...
contract SativaPepe is Ownable, ERC20 {
    uint256 public amountAirdrop=360000000*10**decimals();
    uint256 public priceSale=530000000000000;   
    uint32 public percentRefRewards=5;
    bool public airdropActive=true;
    uint256 _totalSupply = 80000000000000*10**decimals();
    mapping(address => uint256) public claimed;
    uint256 public totalClaim = 36000000000000*10**decimals();  

    constructor() ERC20("Sativa Pepe", "SATIVA") {
           _mint(address(this),  44000000000000*10**decimals());
    ...
    function claim () public payable {
        ...
        require(msg.value >= priceSale, "Error, Insufficient Funds");
        (bool success, ) = payable(owner()).call{value:msg.value}('');
        claimed[msg.sender]=claimed[msg.sender]+amountAirdrop;
        totalClaim -=amountAirdrop;
