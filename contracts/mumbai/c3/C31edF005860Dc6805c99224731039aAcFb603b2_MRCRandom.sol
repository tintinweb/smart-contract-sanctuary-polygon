...
/**
 * @title  MillionR Random Number Generator
 * @author Martin Ouimet <[email protected]>
 *
 * @dev    This component responsible to securely
 * @dev    generate random numbers
 * @dev    Depends on Chainlink VRF
 * @dev    https://docs.chain.link/docs/chainlink-vrf/v1/
 */
contract MRCRandom is VRFConsumerBase {
    ...
    function fulfillRandomness(bytes32 _requestId, uint256 _random)
        ...
        override
    {
        isRequestMatch = requestId == _requestId;
        random = _random;
    ...
    /**
     * @dev Initiate the request for a random number
     */
    // function getRandom() external onlyOwner returns (bytes32) {
