...
Following in the success of Grumpy Cat on the Ethereum network. 

Twitter: 
https://twitter.com/grumpycatbnb

Telegram:
https://t.me/GrumpyCatGlobal
...
contract GrumpyCat is Context, IERC20, Ownable {
    ...
    string constant _name = unicode"Grumpy Cat";
    string constant _symbol = unicode"GrumpyCat";
    ...
    feeRatesStruct public buyRates =
        feeRatesStruct({
            rfi: 0, // 0 RFI rate, in %
            dev: 5, // development fee in %
            Marketing: 5, // Marketing fee in %
            lp: 10, // lp rate in %
            toSwap: 20 // Marketing + dev + lp
        });
    ...
    constructor() {
        ...
        // orig router02 bsc 0x10ED43C718714eb63d5aA57B78B54704E256024E
