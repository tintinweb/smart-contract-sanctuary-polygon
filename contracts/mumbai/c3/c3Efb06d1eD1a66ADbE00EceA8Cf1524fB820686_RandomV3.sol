...
contract RandomV3 is VRFConsumerBaseV2, Ownable, IRNG2 { 
  ...
  constructor(uint64 subscriptionId, address _vrfCoordinator)  VRFConsumerBaseV2(_vrfCoordinator)  {
        ...
        if (id == 4) {
            ...
            require(_vrfCoordinator == 0x2Ca8E0C643bDe4C2E08ab1fA0da3401AdAD7734D,"Incorrect VRF Coordinator for MAINNET");
            keys           = [
                bytes32(0x79d3d8832d904592c0bf9818b621522c988bb8b0c05cdc3b15aea1b6e8db0c15) // 30 GWei KeyHash
            ];
        } else if (id == 137) { // polygon
            link           = 0xb0897686c545045aFc77CF20eC7A532E3120E0F1;
            require(_vrfCoordinator == 0xAE975071Be8F8eE67addBC1A82488F1C24858067,"Incorrect VRF Coordinator for POLYGON");
            keys           = [
                bytes32(0x6e099d640cde6de9d40ac749b4b594126b0169747122711109c9985d47751f93), // 200 GWei KeyHash
                bytes32(0xcc294a196eeeb44da2888d17c0625cc88d70d9760a69d58d853ba6581a9ab0cd), // 500 GWei KeyHash
                bytes32(0xd729dc84e21ae57ffb6be0053bf2b0668aa2aaf300a2a7b2ddf7dc0bb6e875a8) // 1000 GWei KeyHash
            ];
        }else if (id == 80001) { // mumbai
            link           = 0x326C977E6efc84E512bB9C30f76E30c160eD06FB;
            require(_vrfCoordinator == 0x7a1BaC17Ccc5b313516C5E16fb24f7659aA5ebed,"Incorrect VRF Coordinator for MUMBAI");
            keys           = [
                bytes32(0x4b09e658ed251bcafeebbc69400383d49f344ace09b9576fe248bb02c003fe9f) // 500 GWei KeyHash
            ];
