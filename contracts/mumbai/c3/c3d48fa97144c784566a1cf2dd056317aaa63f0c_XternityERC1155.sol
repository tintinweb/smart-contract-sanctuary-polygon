    ...
    ERC1155SupplyUpgradeable
{
    ...
    function mint(
        ...
        require(to != address(0), 'XternityERC1155: Zero address not allowed');
    ...
    function mintBatch(
        ...
        require(to != address(0), 'XternityERC1155: Zero address not allowed');
        require(ids.length == amounts.length, 'XternityERC1155: Length mismatch');
        _mintBatch(to, ids, amounts, data);
        for (uint256 i = 0; i < ids.length; i++) {
            emit Mint(to, ids[i], amounts[i]);
    ...
    function treasuryWallet() external view onlyOwner returns (address wallet) {
        wallet = _treasuryWallet;
    }
