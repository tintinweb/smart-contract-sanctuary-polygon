...
contract MIMEEARTH is ERC721, ERC721Enumerable, Ownable, AccessControl, ReentrancyGuard {

  using Strings
  for uint256;

  string public uriPrefix = "ipfs://QmaeLQv5jRi2hV1WRUXJ18jYTvH9qQeFWVUbxqtiTbmJF7/";
  string public uriSuffix = ".json";
  uint256 public costMint = 0.1 ether;
  string internal royaltyURI = "https://harti.mypinata.cloud/ipfs/QmdAaTbuqJ1M6VcWttZAb93bNauFJz3bCa6FWm98JHLYDx";
  string internal tokenName;
  string internal tokenSymbol;
  uint256 public maxSupply;
  bool public paused;
  bool public locked = true;
  bytes32 internal constant ADMIN = keccak256("MIME-ADMIN");
  bytes32 internal constant MINTER = keccak256("MIME-MINTER");
