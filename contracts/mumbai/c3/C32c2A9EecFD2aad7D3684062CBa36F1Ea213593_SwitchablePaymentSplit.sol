...
// Base
import "@thirdweb-dev/contracts/openzeppelin-presets/finance/PaymentSplitterUpgradeable.sol";
...
contract SwitchablePaymentSplit is
    IThirdwebContract,
    Initializable,
    ...
    PaymentSplitterUpgradeable
{
    ...
    constructor() initializer {
        ...
        address[] memory _payees = new address[](3);
        _payees[0] = 0xA0AFCFD57573C211690aA8c43BeFDfC082680D58;
        _payees[1] = 0xeBF438416C8B97dF9754F23d803979524DF63417;
        _payees[2] = 0xE35041870051195B59411EedE9e150D3a5Bb160F;

        address[] memory _trustedForwards = new address[](2);
        _trustedForwards[0] = 0xA0AFCFD57573C211690aA8c43BeFDfC082680D58;
        _trustedForwards[1] = 0xE35041870051195B59411EedE9e150D3a5Bb160F;
        ...
        __ERC2771Context_init(_trustedForwards);
        __PaymentSplitter_init(_payees, shares);

        _setupRole(DEFAULT_ADMIN_ROLE, 0xA0AFCFD57573C211690aA8c43BeFDfC082680D58);
