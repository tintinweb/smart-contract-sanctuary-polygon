...
contract CryptoMusicTorino is ERC721("WZeroWOne", "ZONE"), Ownable {
    string public baseURI =
        "https://bafybeia776izzy4jmlbxu5pqgdisomz56l3be4twcdj2czkbsxi5jcqfwq.ipfs.nftstorage.link/";
    string public baseExtension = ".json";
    address public artist;
    uint256 public royaltyFee;
     uint256 price=1000000000000000; //0.001;
    ...
    function buyToken(uint256 _tokenId) external payable {
        ...
        emit MarketItemBought(_tokenId, seller, msg.sender);
    }
    ...
    function resellToken(uint256 _tokenId) external payable {
        ...
        emit MarketItemRelisted(_tokenId, msg.sender);
    }
