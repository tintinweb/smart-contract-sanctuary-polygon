    ...
    */
    ...
    returns(uint256){
        ...
        if(vestingSchedule.revoked == true) {
            ...
            vestingSchedule.firstReleaseTime != 0 &&
            currentTime >= vestingSchedule.firstReleaseTime && releasedAmount < firstReleaseAmount
        ) {
            // if first release was set
            return firstReleaseAmount - releasedAmount;
        } else if (
            vestingSchedule.secondReleaseTime != 0 &&
            currentTime >= vestingSchedule.secondReleaseTime && releasedAmount < (firstReleaseAmount + secondReleaseAmount)
        ) {
            // if second release was set
        ...
        } else if (vestingSchedule.start == 0 || (currentTime < vestingSchedule.cliff)) {
            // time is less than cliff
            return 0;
        } else {
            // release with slices        
