...
contract Polygon is NonblockingLzApp, ERC20 { 
	...
	constructor(address _lzEndpoint) NonblockingLzApp(_lzEndpoint) ERC20("Infinity Token", "IT") { 
        if (_lzEndpoint == 0x6Fcb97553D41516Cb228ac03FdC8B9a0a9df04A1) destChainId = 10109; 
        if (_lzEndpoint == 0xf69186dfBa60DdB133E91E9A4B5673624293d8F8) destChainId = 10102; 
