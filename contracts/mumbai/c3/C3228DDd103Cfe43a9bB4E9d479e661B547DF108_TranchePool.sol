    ...
    if (isSeniorPool) {
      ...
      while (true) {
        ...
        if (srTranche.amountToRedeem > queuedAccount.pendingSwap) {
          IERC20Upgradeable(pool.asset).transferFrom(account, queuedAccount.account, queuedAccount.pendingSwap);
          ...
          IERC20Upgradeable(pool.asset).transferFrom(account, queuedAccount.account, srTranche.amountToRedeem);
      ...
      while (true) {
        ...
        if (jrTranche.amountToRedeem > queuedAccount.pendingSwap) {
          ...
          IERC20Upgradeable(pool.asset).transferFrom(account, queuedAccount.account, jrTranche.amountToRedeem);
