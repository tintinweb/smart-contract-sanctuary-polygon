    ...
    AchievementError
{
    ...
    struct Collection {
        ...
        uint256[] tokenIds; // tokenId 빈 배열 아닌지까지 체크
        uint256[] amounts; // 721일때 빈 배열 // 1155 일 때 tokenIds랑 amounts랑 갯수 맞는지
    }
    ...
    //// @notice achievementId to hunter to achievement minted
    mapping(uint256 => mapping(address => bool)) internal achievementMinted;
    ...
    UUPSUpgradeable
{
    ...
    function getCollectionAchievementById(
        uint256 _achievementId
    ) external view returns (Achievement memory, CollectionSet memory) {
        if (!isExistAchievementById(_achievementId))
            revert InvalidAchievementId();

        return (
            achievements[_achievementId],
            collectionAchievements[_achievementId]
        );
    }
    ...
    function isMintedAchievement(
        ...
        return achievementMinted[_achievementId][_hunter];
    }
    ...
    function claimAchievement(
        ...
        achievementMinted[_achievementId][hunter] = true;
