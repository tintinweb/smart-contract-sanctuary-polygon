...
interface IRehideNFT {
    ...
    event AddToReadAllowlist(address[] toAddAddresses, uint256 indexed tokenId);
}
...
contract RehideNFT is IRehideNFT, RehideBase {
    ...
    function addToReadAllowlist(address[] calldata toAddAddresses, uint256 tokenId) external {
        ...
        emit AddToReadAllowlist(toAddAddresses, tokenId);
    }
