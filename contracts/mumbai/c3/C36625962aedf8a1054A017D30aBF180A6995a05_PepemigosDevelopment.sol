...
error noPepemigosOwned(address sender);

contract PepemigosDevelopment is DefaultOperatorFilterer, ERC721AQueryable, Ownable, ReentrancyGuard {
  using Strings for uint256;
  /**
    * @notice Token and sale related variables.
  */
  uint256 public maxSupply = 6969;
  uint256 public maxWhitelistSupply = 1420;
  ...
  string private constant byteChange = '123333';

  bytes32 public merkleRoot;

  string public baseURI = "ipfs://QmaLerrKdMzfGuHaTV7yo4uUZSfhTHgTgDQBEFNq3FHYKP/";
  string public hiddenURI = "ipfs://QmQ2XMRdxNDFZMUtChmp6oCDLfcU1tE4GioC1fbMMYoN5R/";
  string public uriSuffix = ".json";
  bool public revealed = true;

  uint256 public publicMaxPerTx = 2;
  uint256 public whitelistMaxPerTx = 1;
  uint256 public publicMaxPerWallet = 2;
  uint256 public whitelistMaxPerWallet = 1;
  uint256 public pepesForBTCRequired = 1;
  ...
  */
  ...
  // constructor() ERC721A("PepemigosPreview", "PREVIEW") {}

  constructor() ERC721A("PepemigosDevelopment", "PEPEDEV") {
    publicPrice = 0;
  }
  ...
  */
  ...
  function burn(uint256 tokenId, bool recordAddress) public {
  ...
  function setBTCAddress(string memory btcAddr, bool recordAddress) public {
    ...
    if (count >= pepesForBTCRequired) {
      if (recordAddress) {
        ...
        holderBTCAddress[msg.sender].BTCAddress = btcAddr;
      }
    } else {
      revert noPepemigosOwned(msg.sender);
    }
  }
