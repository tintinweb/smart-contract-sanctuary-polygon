...
contract TestMaticFarm {
	...
	uint256 constant public WITHDRAW_FEE = 150;
	...
	constructor(address payable wallet, uint256 startDate) {
		...
		/* plans.push(Plan(14, 142));
        plans.push(Plan(21, 119));
        plans.push(Plan(28, 107));
        plans.push(Plan(14, 179));
        plans.push(Plan(21, 142));
        plans.push(Plan(28, 125)); */
        plans.push(Plan(14, 145));
        plans.push(Plan(21, 120));
        plans.push(Plan(28, 110));
        plans.push(Plan(14, 180));
        plans.push(Plan(21, 145));
