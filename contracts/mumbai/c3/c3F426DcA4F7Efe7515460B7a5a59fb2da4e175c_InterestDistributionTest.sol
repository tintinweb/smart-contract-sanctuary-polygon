...
contract InterestDistributionTest is KeeperCompatibleInterface {
    ...
    uint256 public isDurationWorkingfive = 2 * (5 minutes);
    ...
    function register() external payable {
        ...
        recordedStartDay[msg.sender] = todayUTC0 + 5 minutes;
    ...
    function ping() public {
        ...
        pingExpiresAt[msg.sender] = todayUTC0 + 10 minutes;
    }

    // KEEPER check for 24hr
    uint256 interval = 5 minutes; // maybe uint32
