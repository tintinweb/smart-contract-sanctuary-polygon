...
contract MetaHumanGovernor is Governor, GovernorSettings, CrossChainGovernorCountingSimple, GovernorVotes, GovernorVotesQuorumFraction, GovernorTimelockControl {
    ...
    */
    ...
    GovernorSettings(1 /* 1 block */, 5 * 10 /* 10 minutes */, 0) //TODO in production voting period needs to be changed to some reasonable value, right now it's 5 blocks for testing. Also remember about proposal threshold
