...
//File： fs://86ffdf1d30ac483e9ba1f6cb6ea495f8/ArtistasLuqueverso.sol
...
contract ArtistasLuqueverso is DefaultOperatorFilterer, ERC721A, Ownable {
    using Address for address;
    using Strings for uint256;
    ...
    constructor() ERC721A("Artista Luque", "ALV") {
        contractUri = "https://ipfs.io/ipfs/QmRr2hVG4oEeN4YMCRitjeoSRUksuLXsgpMCxCsfzD66cW";
    ...
    function mintPublic(uint256 _mintAmount, address payable _endUser, string memory _cid) public payable {
