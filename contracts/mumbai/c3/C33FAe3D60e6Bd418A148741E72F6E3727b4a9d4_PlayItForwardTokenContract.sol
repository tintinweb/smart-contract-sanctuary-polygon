...
contract PlayItForwardTokenContract is ERC20, Pausable, Ownable {
  /**
   * @dev     To initialize the contract.
   * @param   name_  ERC20 token name.
   * @param   symbol_  ERC20 token symbol.
   * @param   totalSupply_  ERC20 token initial supply.
   * @param   owner_  ERC20 token owner address.
   */
    constructor(
        string memory name_,
   ...
   */
    function burn(uint256 amount) public onlyOwner {
      ...
      /**
   * @dev     External function to burn tokens from an account.
   *          Only owner can mint.
