...
contract NFTTASK is ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("NFTTask", "NFTTaskSYM") {
        _baseTokenURI = "";
    }
    ...
    function SetToken_baseURI(string memory _tokenuri) public {
    ...
    function MintNft(
        ...
        token_id[newPack] = Metadata(name, ipfsimage, ipfsmetadata);
        _safeMint(msg.sender, newPack);
    }
}
