...
contract Gianky is ERC721, ERC721URIStorage {
    ...
    uint256 private constant STARTER_PRICE = 0.01 ether; // 0.01 BNB on BSC
    uint256 private constant BASIC_PRICE = 0.02 ether; // 0.02 BNB on BSC
    uint256 private constant STANDARD_PRICE = 0.03 ether; // 0.03 BNB on BSC
    uint256 private constant VIP_PRICE = 0.04 ether; // 0.04 BNB on BSC
    uint256 private constant PREMIUM_PRICE = 0.05 ether; // 0.05 BNB on BSC
    uint256 private constant DIAMOND_PRICE = 0.06 ether; // 0.06 BNB on BSC
