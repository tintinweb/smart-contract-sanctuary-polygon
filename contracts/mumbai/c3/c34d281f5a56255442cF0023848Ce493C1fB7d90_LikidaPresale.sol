...
contract LikidaPresale is ERC1155, AccessControl, Pausable, ReentrancyGuard, ERC1155Burnable, ERC1155Supply {
  ...
  string public name;
    ...
    uint8 public constant ARMY  = 2;
    uint8 public constant LIKID = 3;
    ...
    constructor() ERC1155("http://test-likida.io/token/{id}.json") {
        ...
        // Token limit
        tokenSupply[BASIC] = 5000;
        tokenSupply[ARMY]  = 3000;
        tokenSupply[LIKID] = 500;

        name = "Likida Founders";
    }
