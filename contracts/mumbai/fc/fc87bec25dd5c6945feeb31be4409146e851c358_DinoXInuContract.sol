...
contract DinoXInuContract is Context, IERC20, Ownable {
    using Address for address;
    address payable public marketingWalletAddress = payable(0x62C0A35caEC07f248d32D209e45420A1D74E1937); // Marketing Wallet Address
    address payable public reserveWalletAddress = payable(0xa8Dd8c38CB0450ED45F8a713C9d82BB8e9E6d849); // Marketing Wallet Address
    address payable public charityWalletAddress = payable(0xfcf1a4bD7deC1106eA5b583fd6daA0CEE730d332); // charity Wallet Address
    address payable public devWalletAddress = payable(0xf3be01C3fCcbDcF9616ec8aD861114dD89286D2F); // dev Wallet Address
    ...
    uint256 private _tTotal = 10**13 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;


    string private constant _name = "DinoX Inu";
    string private constant _symbol = "DOXI";
    ...
    uint256 _saleReserveFee = 2;
    uint256 _saleDevFee = 2;
    uint256 _saleMarketingFee = 3;
    uint256 _saleCharityFee = 1;
    ...
    constructor () {
        address _owner = 0x6FBFd86A549B66091aEb59A893278e410e96e873;
        ...
        if (block.chainid == 56) {
            ...
            currentRouter = 0xDE2Db97D54a3c3B008a097B2260633E6cA7DB1AF; // PCS Testnet
