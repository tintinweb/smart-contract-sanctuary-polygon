...
contract MightyActionHeroChild is ERC721, AccessControl {
		...
		onlyRole(MINTER_ROLE)
	{
		require(
			...
			"MightyActionHeroChild: TOKEN_EXISTS_ON_ROOT_CHAIN"
		);
		_mint(user, tokenId);
	}
	...
	function withdraw(uint256 tokenId) external {
		require(
			...
			"MightyActionHeroChild: INVALID_TOKEN_OWNER"
		);
	...
	function withdrawBatch(uint256[] calldata tokenIds) external {
		...
		require(
			length <= BATCH_LIMIT,
			"MightyActionHeroChild: EXCEEDS_BATCH_LIMIT"
		);
