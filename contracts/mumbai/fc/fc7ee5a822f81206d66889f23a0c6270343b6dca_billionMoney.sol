...
contract billionMoney is owned {
    ...
    uint public  Closing_TimeStep_Pool=86400; // 1 day;
    uint public Closing_TimeStep_Div=86400; // 1 day;
...
//---------------------Passive----------------
    ...
    constructor(address payable ownerAddress, address payable ID1address) public {
        ...
        globalDivDistPart[2] = 2500000;
        globalDivDistPart[3] = 5000000;
        globalDivDistPart[4] = 10000000;
        globalDivDistPart[5] = 20000000;
        globalDivDistPart[6] = 40000000;
        globalDivDistPart[7] = 80000000;
        globalDivDistPart[8] = 150000000;
        globalDivDistPart[9] = 360000000;
        globalDivDistPart[10] =500000000;

        priceOfLevel[1] = 25000000;
        priceOfLevel[2] = 25000000;
        priceOfLevel[3] = 50000000;
        priceOfLevel[4] = 100000000;
        priceOfLevel[5] = 200000000;
        priceOfLevel[6] = 400000000;
        priceOfLevel[7] = 800000000;
        priceOfLevel[8] = 1500000000;
        priceOfLevel[9] = 3000000000;
        priceOfLevel[10]= 5000000000;
//------------------------FOR TESTING----------------------

    
        distForLevel[1] = 10000000;
        distForLevel[2] = 12500000;
        distForLevel[3] = 25000000;
        distForLevel[4] = 500000000;
        distForLevel[5] = 100000000;
        distForLevel[6] = 200000000;
        distForLevel[7] = 400000000;
        distForLevel[8] = 750000000;
        distForLevel[9] = 1500000000;
        distForLevel[10] = 2500000000;

        autoPoolDist[1] = 4000000;
        autoPoolDist[2] = 5000000;
        autoPoolDist[3] = 10000000;
        autoPoolDist[4] = 20000000;
        autoPoolDist[5] = 40000000;
        autoPoolDist[6] = 80000000;
        autoPoolDist[7] = 160000000;
        autoPoolDist[8] = 300000000;
        autoPoolDist[9] = 600000000;
        autoPoolDist[10]= 1000000000;         


        uniLevelDistPart[1] = 500000;
        uniLevelDistPart[2] = 500000;
        uniLevelDistPart[3] = 500000;
        uniLevelDistPart[4] = 500000;
        uniLevelDistPart[5] = 500000;
        uniLevelDistPart[6] = 500000;
        uniLevelDistPart[7] = 500000;
        uniLevelDistPart[8] = 500000;
        uniLevelDistPart[9] = 500000;
        uniLevelDistPart[10] = 500000;
        ...
        updatePool(ownerWallet, autoPoolDist[1]);
    ...
    function regUser(uint _referrerID, uint _parentID) public payable returns(bool) 
    {
        ...
        setUserGain(userAddressByID[_referrerID],1,autoPoolDist[1]);
        ...
        updateROI(msgSender, globalDivDistPart[1]); // only when level buy is not calling inside calling block

        CalculateDailyPool(1);
        updatePool(msgSender, autoPoolDist[1]);
    ...
    function _buyLevel(address msgSender, uint8 _level) internal returns(bool) {
        ...
        setUserGain(reff,_level,autoPoolDist[_level]);
        ...
        updateROI(msgSender, globalDivDistPart[_level]);

        // pool update

        CalculateDailyPool(_level);
        updatePool(msgSender, autoPoolDist[_level]);
    ...
    function payForLevel(uint8 _level, address _user, uint _runtime) internal returns(bool) {
        ...
        if (userGainList.length==0 && _runtime==5){
            ...
            userGainList[0]=(userAddressByID[1]); // default is only eligible after checking recursive five times
        }
    ...
    function CalculateDailyRoi(uint8 _level) internal{
        ...
        uint calcAmount = globalDivDistPart[_level];
    ...
    function CalculateDailyPool(uint8 _level) internal{
        ...
        uint calcAmount = autoPoolDist[_level];
