...
contract SmoolosClub {
    ...
    modifier onlyNFTOnwer {
        require(smoolos.balanceOf(msg.sender) > 0, "You must have a smoolos");
        _;
    }

    function call() onlyNFTOnwer public view returns(bool)  {
        return true;
    }
    ...
    function deposit() onlyNFTOnwer public payable {
        require(address(this).balance.div(1) != 1);
