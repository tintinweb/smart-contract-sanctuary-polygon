...
contract NFT is ERC721, Ownable {
    ...
    constructor() ERC721("WertNFT", "WT") {
        _contractOwner = msg.sender;
    }

    function mint(address _toAddress) public returns (uint) {
    ...
    function buy(uint _id ,  address from) public payable {
        transactionSender = msg.sender;
        _trade(_id , from);
    }

    function _trade(uint _id, address from) internal {
        address payable _buyer = payable(from);
