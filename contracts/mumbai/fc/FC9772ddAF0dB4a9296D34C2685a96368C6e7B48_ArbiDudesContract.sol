...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x0Ca8C0363F8E09A6F0A5F08b48523A8562736ED0];
  address public erc20Payable = 0x0Ca8C0363F8E09A6F0A5F08b48523A8562736ED0;
...
abstract contract Feeable is Teams {
  uint256 public PRICE = 89.2 ether;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 90000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmdAgzsXzkpys3SDEge4Cetfn3orKEZGfX6SJmbgcC4NCK/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 90000");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 90000");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 90000");
...
// File: contracts/ArbiDudesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ArbiDudesContract is RamppERC721A {
    constructor() RamppERC721A("ArbiDudes", "AD"){}
}
