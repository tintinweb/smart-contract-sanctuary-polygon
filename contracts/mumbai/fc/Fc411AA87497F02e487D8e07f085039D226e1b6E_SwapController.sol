...
contract SwapController {
    ...
    function swapTokens(
        ...
        ICustomVault(paths[1]).withdrawAssetForSwapController(
            paths[0],
            amountOut
            // _tokenIn,
            // _amountIn - _fees
        ...
        IERC20(_tokenIn).safeIncreaseAllowance(paths[2], _amountIn - _fees);
        IVaultRouter(paths[2]).stake(_amountIn - _fees, address(0), true);
    }
