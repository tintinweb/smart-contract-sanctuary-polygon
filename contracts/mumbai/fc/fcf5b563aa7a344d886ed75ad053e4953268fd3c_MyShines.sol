...
contract MyShines is ERC721A, ERC721ABurnable, Pausable, Ownable {
    ...
    uint256 public constant FREE_MINT_TOKENS = 2000;
    uint256 public constant MAX_PER_MINT = 100;
    uint256 public constant MINT_PRICE = 0.001 ether;


    constructor() ERC721A("MyShines", "MYS") {}
    ...
    function safeMint(uint256 amount) public payable whenNotPaused{
        ...
        int256 chargable_amount = int256(amount);
