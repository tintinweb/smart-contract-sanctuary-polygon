...
contract Evema is Ownable, ERC721URIStorage{
    ...
    function bookTickets(uint256 _eventId) payable public {
        ...
        tokenIdToURI[tokenId.current()] = tokenURI;
        tokenId.increment();
    }



    function createEvent(uint256 _max_ticket_number, uint256 _startTime,uint256 _endSales, uint256 _amountPerTicket, string memory _metadata) external{
    ...
    function userEvents(address _user) view public returns(EventData[] memory){
