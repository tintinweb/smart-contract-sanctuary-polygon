...
contract StableOneMaticV4 is Ownable {
    ...
    // uint256 private constant WITHDRAW_REINVEST_TIME_STEP = 2 days;
    uint256 private constant WITHDRAW_REINVEST_TIME_STEP = 2 minutes; //fast test mode
    ...
    function reinvest() public {
		require(investors[msg.sender].lastWithdrawDate.add(WITHDRAW_REINVEST_TIME_STEP) <= block.timestamp,"Withdrawal limit is 1 withdrawal in 48 hours");
