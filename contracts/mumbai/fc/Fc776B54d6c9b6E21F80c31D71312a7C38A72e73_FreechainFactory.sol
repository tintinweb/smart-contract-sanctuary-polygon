...
contract FreechainFactory is FreechainArtist {
    ...
    */
    function deployERC1155(
        ...
        ) public onlyArtists() returns (address) {
    ...
    */
    function mintERC1155(uint _index, string memory _name, uint256 amount) 
        public {
        require(indexToOwner[_index] == msg.sender, "You are not the owner of this token");
...
contract FreechainArtist {
    ...
    */
    ...
    /// mapping of artist id to artist address
