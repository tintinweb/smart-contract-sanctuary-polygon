...
import {IERC20Metadata as IERC20} from "@openzeppelin/contracts/token/ERC20/extensions/IERC20Metadata.sol";
import {taskInfoItem, OrderType, TokenInfoItem, TokenInfoItem2, TaskConfig, TokenItem, FeeItem, FeeItem2, BaseItem} from "./StructList.sol";
...
contract OrderShow is OrderBase {
    ...
    function getUserTaskList(
        ...
        bytes32[] memory _taskList
    ) {
        _taskList = userTaskList[_user];
    }

    function getUserAllOrderList(
        address _user,
        OrderType _type
    ) external view returns (
        bytes32[] memory _taskList
    ...
    function getUserAllOrderListByList(
        address _user,
        OrderType _type,
    ...
    function getUserActiveOrderList(
        address _user,
        OrderType _type
    ) external view returns (
        bytes32[] memory _taskList
    ...
    function getUserActiveOrderListByList(
        address _user,
        OrderType _type,
        uint256[] memory _indexList
    ) external view returns (
    ...
    function getUserTaskListByList(
        address _user,
        uint256[] memory _indexList
    ) external view returns (
        bytes32[] memory _taskList
    ...
    function getUserTokenInfo(
        address _user,
        address _token
    ) public view returns (TokenInfoItem2 memory _item) {
    ...
    function getUserTxSetNum(
        address _user
    ) public view returns (uint256 _num) {
        _num = userTxSet[_user].length();
    }

    function getUserTxSet(
        address _user
    ) public view returns (uint256[] memory _list) {
        _list = userTxSet[_user].values();
    }

    function getUserTxSetByList(
        address _user,
        uint256[] memory _indexList
    ) public view returns (
    ...
    function getUserTokenSetByList(
        address _user,
        uint256[] memory _indexList
    ) public view returns (
        address[] memory _list
    ...
    function massGetUserTokenInfo(
        address _user
    ) external view returns (
        TokenInfoItem2[] memory _itemList
    ) {
    ...
    function massGetUserTokenInfoByList(
        address _user,
        uint256[] memory _indexList
    ) external view returns (
        TokenInfoItem2[] memory _itemList
    ...
    function massGetTaskInfo(
        bytes32[] memory _taskIdList,
        uint256 _timestamp
    ) public view returns (
        taskInfoItem[] memory _returnInfoList
    ) {
    ...
    function getActiveManualOrderSet(
        uint256 _timestamp,
        bool _returnList
    ) external view returns (
        uint256 _txAmount,
    ...
    function getActiveManualOrderSetByIndexList(
        uint256[] memory _indexList,
        uint256 _timestamp,
        bool _returnList
    ) external view returns (
    ...
    function getBaseItem() public view returns (
        BaseItem memory BaseItem_
    ) {
        BaseItem_ = BaseItem(
            V2Dex,
            V3Dex,
    ...
    function getTaskInfo(
        ...
        taskInfoItem memory _returnInfo
    ) {
        _timestamp = _timestamp == 0 ? block.timestamp : _timestamp;
