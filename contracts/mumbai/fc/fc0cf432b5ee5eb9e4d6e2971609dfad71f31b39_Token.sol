...
constructor() {
        name = "Suntama Token"; // Sets the name of the token, i.e Ether
        symbol = "SUNTAMA"; // Sets the symbol of the token, i.e ETH
        decimals = 18; // Sets the number of decimal places
        uint256 _initialSupply = 1000000; // Holds an initial supply of coins
