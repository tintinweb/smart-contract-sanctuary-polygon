    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 69) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeigoxu3lltgdy3xwoweyfirprkxcql5mv2uigv2qpwwwowfrxnoaeq/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/A7pT8FjoLEpbH1HC4QJ4/contract-metadata";
  }
...
// File: contracts/AnimArTesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AnimArTesContract is RamppERC721A {
    constructor() RamppERC721A("AnimARTes", "ANM"){}
}
