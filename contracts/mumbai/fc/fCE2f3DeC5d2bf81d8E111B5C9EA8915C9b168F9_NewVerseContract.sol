...
contract NewVerseContract is ERC721URIStorage, ERC2981/*, ERC721Enumerable*/, IMintableERC721, AccessControl, Ownable {
    /**
    ...
    */
    uint256 public constant UID = 0xbd5fd632563a5f931828a4341dc8947653a23474543467fadb6a9bfc21968e5e;
    ...
    uint96 public defaultroyaltyFee = 1000; // In BPS. 1000 = 10%
   ...
   function mintRoyalty(address _to, address _royaltyRecipient, uint96 _royaltyValue, string memory _tokenURI) external onlyRole(MINTER_ROLE) {
...
contract NewVerseStakingContract is IERC721Receiver, ReentrancyGuard {

    NewVerseContract newVerseContractNFT;
    ...
    /**
	    ...
	    * @dev Generated using https://www.random.org/bytes/
    */
    uint256 public constant UID = 0x2ea7574b484461a7aee993592f3951c2735b754e06a72b980639c206efe9c8e6;
    ...
    constructor(NewVerseContract _newVerseContractNFT) {
        newVerseContractNFT = _newVerseContractNFT;
    }

    function stake(uint256 _tokenId) external {
        stakes[msg.sender] = Stake(_tokenId, block.timestamp);
        newVerseContractNFT.safeTransferFrom(msg.sender, address(this), _tokenId);
        emit NFTStaked(msg.sender, address(this), _tokenId);
    }

    function unstake() external {
        newVerseContractNFT.safeTransferFrom(address(this), msg.sender, stakes[msg.sender].tokenId);
        stakingTime[msg.sender] += (block.timestamp - stakes[msg.sender].timestamp);
        emit NFTUnstaked(address(this), msg.sender, stakes[msg.sender].tokenId);
