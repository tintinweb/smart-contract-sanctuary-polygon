...
contract CommemorativeTokens is ERC1155AdminMintable, ERC1155AdminBurnable, ERC1155OperatorApprovable {
    constructor(
    ...
    ) ERC1155Base(_name, _symbol, _baseURI, _contractURI) AdminControlled(_adminAddresses) {
     ...
     * @param _maxSupply Token maximum supply to be set
     * @dev Only admin addresses allowed
     */
    function setTokenMaxSupply(uint256 _tokenId, uint256 _maxSupply) external onlyAdminAddress {
        totalMaxSupply[_tokenId] = _maxSupply;
    }
    ...
    /**
     * @dev See {ERC1155OperatorApprovable-isApprovedForAll}.
     */
    ...
    function _beforeTokenTransfer(
        ...
        require(adminAddresses[operator], "Only admin allowed");
