...
contract DeNewsMedia is ERC721, ERC721URIStorage, Ownable {
    ...
    function safeMint(string memory _cid, address _fakeHunter) public {
        require(
        ...
        _safeMint(address(DeNewsManager), tokenIdCounter);
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        "3",
                        "+",
                        "You have succesfullly opened dispute!", // this is notificaiton title
                        "+",
                        "Your dispute id is ", // notification body
                        uint2str(tokenIdCounter) // notification body
                    )
                )
            )
        );
