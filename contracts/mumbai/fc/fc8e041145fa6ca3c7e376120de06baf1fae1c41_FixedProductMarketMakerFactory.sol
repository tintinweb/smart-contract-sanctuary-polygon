...
contract FixedProductMarketMakerFactory is Errors, IMarketFactoryEvents {
    ...
    function createMarket(
        ...
        // Creation event is emitted before the market is initialized, so that
        // the any events that are emitted by the market itself during
        // initialization come _after_ the creation event. This is crucial for
        // subgraph picking up prices correctly
