...
// File: contracts/KittyOrbit.sol


pragma solidity ^0.8.10;


contract KittyOrbit is ERC721A, Ownable {
    string  public baseURI;
    uint256 public freeMINT = 2;
    uint256 public supplyKittyOrbit = 666;
    uint256 public maxKTYO = 5;
    uint256 public price   = 3 ether;
    mapping(address => bool) private walletCount;


    constructor() ERC721A("Kitty Orbit", "KTYO", 5) {
    }
    ...
    function PublicMINT(uint256 count) public payable {
        require(totalSupply() + count < supplyKittyOrbit, "Excedes maxsupply.");
        require(totalSupply() + 1  > freeMINT, "Public sale isnot live yet.");
        require(count < maxKTYO, "Exceeds max per transaction.");
    ...
    function FREEMINT() public payable {
        require(totalSupply() + 1 <= freeMINT, "not available");
    ...
    function setSupply(uint256 _newSupplyKittyOrbit) public onlyOwner {
        supplyKittyOrbit = _newSupplyKittyOrbit;
    }
