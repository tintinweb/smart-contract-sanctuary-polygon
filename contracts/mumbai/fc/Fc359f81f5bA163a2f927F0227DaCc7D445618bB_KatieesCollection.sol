 ...
 * @notice This contract handles minting Katiee's Collection tokens.
 */
contract KatieesCollection is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x76a8aC613ef8FCd0A1F633b64a614B2dFf903fa5;
    ...
    string public name = "Katiee's Collection";
    string public symbol = "KaCo";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeiflkada5idspnvhcam3f37wi4sndq5qemwa2pqastzpgaxcavpfiy/{id}"
        )
        RevokableOperatorFilterer(
