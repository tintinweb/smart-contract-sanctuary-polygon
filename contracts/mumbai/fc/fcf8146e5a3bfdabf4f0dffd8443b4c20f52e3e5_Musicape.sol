...
contract Musicape  is ERC721A, Ownable {
    ...
    uint256 public tokenPrice = 5000000000000000; //0.0005 ETH
    ...
    constructor(string memory name_,string memory symbol_,uint256 MAX_TOKENS_,uint256 tokenPrice_,string memory baseURI_) ERC721A(name_, symbol_, 100, MAX_TOKENS_) {
