...
// File: contracts/QiDaoLiquidator.sol

// contracts/Qidaoliquidator.sol
...
contract QiDaoLiquidator is ReentrancyGuard {
    using SafeMath for uint256;
    ...
    function checkValid( uint256 _vaultId ) public view returns(bool, uint256, uint256, uint256) {
        ...
        // halfDebt is in dollar value (mimatic tokens assumed to be $1). Convert to Matic amount;
    ...
    function liquidateVault(uint256 _vaultId) public nonReentrant {
        ...
        // remove initial balance. Either dust or user error.
        ...
        // check mimatic balance of contract;
        ...
        // if this worked then we check the difference

        // check mimatic balance (again)

        uint256 newBalance = vaultContract.balanceOf(address(this));

        // amount paid to buy risky vault = newBalance - oldBalance
