    ...
    function createMarketItem(
        ...
        function createMarketSale(
           ...
           idMarketItem[itemId].seller.transfer(msg.value);
            ...
            IERC721(nftContract).transferFrom(idMarketItem[itemId].owner, msg.sender, tokenId);
            ...
            payable(owner).transfer(_getListingPrice(price)); //pay owner of contract the listing price
        }
        ...
        function _getListingPrice( uint256 price) private view returns(uint) {
            return (price / 1000) * (listingPricePercent * 10);
        }
