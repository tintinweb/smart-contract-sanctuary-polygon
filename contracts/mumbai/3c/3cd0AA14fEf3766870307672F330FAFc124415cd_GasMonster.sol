...
contract GasMonster is ERC721A, VRFConsumerBaseV2, ChainlinkClient, Ownable {
	...
	function tokenURI(uint256 tokenId) public view override returns (string memory) {
		...
		return formatTokenURI(tokenId, 'Description', '[{name: "Kek", value: "Keku"}]');
		// NFT memory token = Tokens[tokenId];
					...
					Base64.encode(
						bytes(
							abi.encodePacked(
								...
								', "attributes": ',
								_properties,
								', "image":"https://thumbs.dreamstime.com/b/dynamic-background-abstract-speed-concept-49037206.jpg"}'
							)
						)
					)
				)
