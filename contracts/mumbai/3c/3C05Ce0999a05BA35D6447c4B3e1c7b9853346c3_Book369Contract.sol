...
contract Book369Contract is ERC721, Ownable, RoyaltiesV2Impl {
    ...
    uint256 private mintedTokens = 0; // collection size
    ...
    address payable ownerAddress = payable(0x6CA3A9b9ad46D66847e007829bb8DdEf8665cB9d);
     ...
     * Constructor
     */
    constructor(string memory uri) ERC721("NFT365", "CARD") {
        _defaultUri = uri;
    ...
    function mint(uint256 count) external payable validateEthPayment(count)
 {
        require(
    ...
    function isOwnerOfNFT(uint256 tokenid) public view returns (bool) {
        if (ownerOfNft[tokenid] == msg.sender) {
            return true;
        }
        return false;
    }
    ...
    function _mintRandomId(address to) private {
        ...
        _royalties[0].value = 30000;
        _royalties[0].account = ownerAddress;
