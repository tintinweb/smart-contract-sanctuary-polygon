...
contract TEEMVERSE is ERC721Enumerable,  Ownable, ReentrancyGuard {
    ...
    constructor(string memory _theBaseURI, string memory _notRevealedURI, bytes32 _merkleRoot) ERC721("TEEMVERSE", "TMS") {
    ...
    function privateMint(address _account, bytes32[] calldata _proof, uint _ammount) external payable nonReentrant {
        ...
        require(_ammount <=5,"You can't mint more than 5 NFT at the same time");
        ...
        require((nftsPerWalletWhitelist[_account]+_ammount) <= 5, "You can only get 5 NFT on the Presale");
    ...
    function publicMint(uint256 _ammount) external payable nonReentrant {
        ...
        //Did this account already mint an NFT from the whitelist?
        require((nftsPerWallet[msg.sender]+_ammount) <= 5, "You can only get 5 NFT on Public Sale");
