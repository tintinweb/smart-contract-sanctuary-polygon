...
contract Larrytarium is Ownable,  ERC721Enumerable, RoyaltiesV2Impl{
    
    uint256 public mintPrice;
    uint256 public toSupply;
 ...
 string public baseURI = "ipfs://QmSxw9v6JJRfikwQ7BDpTqAivPHA7WWRLVFHxLEC5Xw6Pk";
...
function mint(uint256 quantity_) public payable {
        ...
        require(toSupply + quantity_ <= maxSupply, 'sold out');
        require(walletMints[msg.sender] + quantity_ <= maxPerWallet, 'exceed max wallet');

        for (uint256 i = 0; i < quantity_; i++) {
            uint256 newTokenId = toSupply + 1;
            toSupply++;
