...
contract PlushVestingSeedInvestorsPool is IPlushVestingPool, Initializable, PausableUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function reserveByUSDT() public {
        require(!isReserve, "Slot reserved");
    ...
    function cancelReserve() public onlyRole(OPERATOR_ROLE) {
        require(!isSold, "Slot sold");
        require(isReserve, "Slot not reserved");
    ...
    function sellManually(address wallet) public onlyRole(OPERATOR_ROLE) {
        require(!isSold, "Slot sold");
    ...
    function reserveManually(address wallet) public onlyRole(OPERATOR_ROLE) {
        require(!isSold, "Slot sold");
        require(!isReserve, "Slot reserved");
