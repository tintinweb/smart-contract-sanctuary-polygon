...
import { ERC721A, ERC721A__IERC721Receiver, IERC721A } from "erc721a/contracts/ERC721A.sol";

import { Types } from "./Types.sol";
import { Venture } from "./Venture.sol";

import { SignatureUtil } from "./utils/SignatureValidation.sol"; 

/**
* @title NftAllocator
* @notice With this contract you can invest and claim a nft
*/
contract NftAllocator is Ownable, Initializable, ERC721A__IERC721Receiver, ReentrancyGuard {
...
contract Venture is Ownable, Initializable, AccessControl {
    ...
    */
    function setVentureToken(IERC20 _ventureToken) external onlyAdmin {
        ...
        // TODO set venture token for all allocators, perhaps with boolean option?
    }
