...
// error Tiditada__NotWinner();
// error TidiTada__NotAdvertsServerAndSubscription();
...
contract Tiditada is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    // modifier onlyAdvertsServerAndSubscription(address payable txAddress) {
    //     // require(txAddress == i_advertsServerAndSubscription);
    //     if (txAddress != i_advertsServerAndSubscription)
    //         revert TidiTada__NotAdvertsServerAndSubscription();
    //     _;
    // }
