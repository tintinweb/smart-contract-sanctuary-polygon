...
import "./CyberPunkUser721Token.sol";
...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new CyberPunkUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        CyberPunkUser721Token token = CyberPunkUser721Token(address(addr));
...
contract CyberPunkUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
