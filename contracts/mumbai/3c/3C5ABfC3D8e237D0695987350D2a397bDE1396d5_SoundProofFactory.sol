...
contract SoundProofFactoryStorage is SoundProofBaseStorage {
    ...
    /// @notice SoundProofUniqueID => NFT Address
    mapping (string => address) public soundProofUniqueIDList;
...
contract SoundProofFactory is Ownable, ISoundProofFactory, ReentrancyGuard {
    ...
    function _createSoundProofNFT(
        ...
        // Check Unique ID
        require(soundProofUniqueIDList[_uniqueId] == address(0), "SoundProofFactory: No Unique ID");
        ...
        // Update Unique ID with New Collection
        soundProofUniqueIDList[_uniqueId] = newNFTAddress;
