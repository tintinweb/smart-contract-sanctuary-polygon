...
contract DeployerX is Initializable, Ownable {
    ...
    function xDeployer(
        ...
        for (uint i = 0; i < destChainId.length; ) {
            ...
            gatewayContract.iSend{value: msg.value / destChainId.length}(
                1,
                0,
                string(""),
                destChainId[i],
    ...
    function iReceive(
        ...
        (
            ...
            bool initializable,
            bytes memory initializeData
        ) = abi.decode(packet, (bytes32, bytes, bool, bytes));
        deployContract(salt, bytecode, initializable, initializeData);
    }
