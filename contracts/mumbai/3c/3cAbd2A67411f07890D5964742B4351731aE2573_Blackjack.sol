...
contract Blackjack is VRFConsumerBaseV2, Ownable, BreakdownUint256 {
    ...
    function playerCards() public view returns (Card[] memory) {
        return gamesStates[msg.sender].playerCards;
    }

    function VRFCards() public view returns (uint8[] memory) {
        return vrfRequests[addressToVRF[msg.sender]].cards;
    }
    ...
    function fulfillRandomWords(
        ...
        vrfRequest.cards = [randomUint8s[0], randomUint8s[1]];
        ...
        if (vrfRequest.vrfRequestType == VRFRequestType.INIT) {
            ...
            gameState.playerCards.push(uint8ToCard(randomUint8s[0]));
        }
