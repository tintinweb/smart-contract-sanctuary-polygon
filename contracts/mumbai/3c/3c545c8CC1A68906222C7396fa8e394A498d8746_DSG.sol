...
contract DSG {
    ...
    function _callLevelNow(address _user) private view returns(uint256) {
        ...
        if(total >= 2000e6 && user.teamNum >= 500 && maxTeam >= 50000e6 && otherTeam >= 450000e6) {
            levelNow = 5; // Diamond
        } else if(total >= 2000e6 && user.teamNum >= 200 && maxTeam >= 50000e6 && otherTeam >= 50000e6) {
            levelNow = 4; // Ruby
        } else if(total >= 1000e6 && user.teamNum >= 50 && maxTeam >= 5000e6 && otherTeam >= 5000e6) {
            levelNow = 3; // Gold
        } else if(total >= 200e6 && user.teamNum >= 5 && maxTeam >= 1500e6 && otherTeam >= 1500e6) {
            levelNow = 2; // Silver
        } else if(total >= 50e6) {
            levelNow = 1; // Newbie
        }
