...
import "../../safedeal/interfaces/ISafeDeal.sol";
import "../../registry/interfaces/IRegistry.sol";
...
contract SetApprove is IExecutePlugin, BasePlugin {

    constructor(address _registry) {
        PLUGIN_VERSION = 1;
        PLUGIN_NAME = PluginsList.SAFE_DEAL_SET_APPROVE;
    ...
    function execute(
        ...
        checkPlugin(_version, address(0));
        ...
        require(ISafeDeal(registry.safeDeal()).setApprove(vars),
            "SetApprove: wrong exec"
        );
...
interface ISafeDeal {
    ...
    function readDeal(
        ...
        DataTypes.SafeDeal memory deal
    );
