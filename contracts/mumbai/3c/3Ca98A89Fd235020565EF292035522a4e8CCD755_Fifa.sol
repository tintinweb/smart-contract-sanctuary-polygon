...
contract Fifa is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    constructor(address _gov, string memory _newbaseURI)
        ERC721("Fifa", "MMF")
    {
    ...
    */
    ...
    function lockTokens(uint256[] memory tokenIds) public onlyManager {
        ...
        require(
            counter > 0,
            "Fifa: number of tokens must be greater then 0"
        );
    ...
    */
    ...
    function mint(address _to, uint256 _tokenId) external onlyMinter {
        require(!_exists(_tokenId), "GameNFT: must have unique tokenId");
        _mint(_to, _tokenId);
    }
    ...
    {
        uint256 counter = tokenIds.length;
        require(counter > 0, "MMF: number of tokens must be greater then 0");
        for (uint256 i = 0; i < counter; i++) {
            require(!_exists(tokenIds[i]), "GameNFT: must have unique tokenId");
    ...
    */
    ...
    function _beforeTokenTransfer(
        ...
        require(
            ...
            "GOV: User in the blacklist"
        );

        require(
            !gov.pausedTransfer() || from == address(0),
            "Fifa: Paused Transfer"
        );
        require(lockedTokens[tokenId] == false, "Fifa: TokenId is locked");
