...
contract Evm721StarterUSDC is ERC721, Ownable {
    ...
    uint256 public maticPrice = 0.001 ether;
    ...
    // PUBLIC
        ...
        function mintMatic(address _to, uint256 _quantity) 
        external  
        isAvailable(_quantity) 
        payable
    {
        require(msg.value == maticPrice * _quantity, "Must send correct amount of ETH");
