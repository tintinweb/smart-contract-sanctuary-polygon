    ...
    */
    ...
    abstract contract IBOM716 is Ownable {
        ...
        function nftBalanceOf(uint _nftID) public view returns (uint) {
            require(bomnft.owner(_nftID) == msg.sender || msg.sender == owner());
    ...
    contract BOMToken is Context, IERC20, Ownable, IBOM716, BlackList, Pausable {
        ...
        */
        ...
        function transferByNFT(uint _nftID, uint _value, uint _key) 
            ...
            _transfer(msg.sender, bomnft.owner(_nftID), _value, txn_fee, _nftID);
        ...
        function distRewardToNFTHolders() public override whenNotPaused {
            ...
            uint pastWeightReward = totalReward.mul(7).div(100);
            uint curWeightReward = totalReward.mul(63).div(100);
