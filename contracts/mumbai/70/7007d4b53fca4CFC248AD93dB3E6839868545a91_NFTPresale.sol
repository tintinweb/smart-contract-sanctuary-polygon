...
contract NFTPresale is Ownable {
    ...
    /**
     * Internal method which mints NFTs.
     */
     ...
     */
    function withdraw(IERC20 _buyToken) external onlyOwner {
        uint256 value = _buyToken.balanceOf(address(this));
        if (value > 0) {
            TransferHelper.safeTransfer(address(_buyToken), msg.sender, value);
        }
    }
