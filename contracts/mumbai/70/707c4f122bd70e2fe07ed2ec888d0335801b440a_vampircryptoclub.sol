...
// File: contracts/vampircryptoclub.sol
...
contract vampircryptoclub is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("vampir crypto club", "VCC") {
    setHiddenMetadataUri("ipfs://QmQmQ65MFLEaM9rXZeR4SaouLPhUSHnqph5MpMUnxrhorR/{id}.json");
  }
