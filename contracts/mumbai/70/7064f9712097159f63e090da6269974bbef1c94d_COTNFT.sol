...
contract COTNFT is ERC721Enumerable, Ownable {
    ...
    uint256 public maxTotalSupply = 5000000;
    ...
    function split(uint256 tokenId, NFTInfo[] memory nftArray) public {
        ...
        NFTInfo memory splitNft = tokenInfoMap[tokenId];
    ...
    function neutralized(uint256 tokenId, string memory imageUrl) public {
        ...
        NFTInfo storage nft = tokenInfoMap[tokenId];
    ...
    function mint(address to, NFTInfo memory nftInfo) public onlyOwner {
        require(maxTotalSupply > totalSupply(), "all nft has been minted");
