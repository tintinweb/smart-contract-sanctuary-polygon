...
library Pricing {
        ...
        )
    {
        ...
        if (taxPercent > 0) {
            taxAmount = (commissionFromBuyer * taxPercent) / (10 ** 4);
        ...
        )
    {
        ...
        if (tax > 0) {
            taxAmount = (commissionFromBuyer * tax) / (10 ** 4);
            amountToBuyer += taxAmount;
        }
    }
    ...
    ReentrancyGuardUpgradeable
{
    ...
    function _getOrderFloatingPrice(
        ...
        if (order.paymentToken == address(0)) {
            ...
            tokenDecimals = IERC20MetadataUpgradeable(order.paymentToken)
                .decimals();
        }
            ...
            if (bid.paymentToken == _paymentToken) {
                ...
                if (buyerPaidAmount > _buyerCommissionOutput.amountToBuyer) {
                    ...
                    if (_paymentToken == address(0)) {
                        ...
                        IERC20MetadataUpgradeable(_paymentToken)
                            .safeTransferFrom(
                                msg.sender,
                                address(this),
                                _buyerCommissionOutput.amountToBuyer -
        ...
        if (bid.bidPrice != _bidPrice) {
            ...
            if (bid.paymentToken != address(0)) {
                if (isExcess) {
                    ...
                    IERC20MetadataUpgradeable(bid.paymentToken)
                        .safeTransferFrom(bid.bidder, address(this), amount);
                }
            } else {
                if (isExcess) {
