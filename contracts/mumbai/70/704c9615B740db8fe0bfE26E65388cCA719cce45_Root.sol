...
contract Sales is Store, TokenUtils {
    ...
    function viewSalesByAsset(
        ...
        uint256[] memory indexes = heapSale.getBestAssets(token, tokenId, amount);
...
function _now() view returns (uint256) {
...
contract Store is Allowed, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    mapping(address => mapping(uint256 => mapping(address => bool))) public accountOffers;
