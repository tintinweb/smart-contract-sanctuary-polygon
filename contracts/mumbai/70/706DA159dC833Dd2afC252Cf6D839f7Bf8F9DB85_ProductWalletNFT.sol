...
contract ProductWalletNFT is ERC721Enumerable, Ownable {

    constructor() ERC721("ProductWalletNFT", "PWNFT") {}

    function mint(address account, uint256 tokenId)
        public
        onlyOwner
    {
      require(!_exists(tokenId), "ProductWalletNFT: token already minted");
