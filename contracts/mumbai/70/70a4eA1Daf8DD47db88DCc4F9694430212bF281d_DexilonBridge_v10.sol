...
contract DexilonBridge_v10 is EIP712, Ownable, Pausable, ReentrancyGuard {
    ...
    function getHashForBatch(address _tokenAddress, address[] memory users, uint256[] memory balances, uint256 batchId) internal pure returns (bytes32) {
        return keccak256(abi.encodePacked(_tokenAddress, users, balances, batchId));
    }
