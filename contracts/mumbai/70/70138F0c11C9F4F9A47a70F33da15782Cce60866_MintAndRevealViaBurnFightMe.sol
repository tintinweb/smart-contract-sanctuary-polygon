...
contract MintAndRevealViaBurnFightMe is ERC721Base {
    event TestEvent(
        uint256 tokenId,
        address burner,
        address sender
      ...
      string public placeholderURIPrefix;
      ...
      constructor(
        ...
        address _royaltyRecipient,
        uint128 _royaltyBps,
        string memory _placeholderURIPrefix
    )
        ERC721Base(
            _name,
            _symbol,
    ...
    {
        placeholderURIPrefix = _placeholderURIPrefix;
    }

    modifier onlyLootboxContract() {
    ...
    function mintViaLootbox(uint256 _tokenId, address _burnerAddress) external onlyLootboxContract {
        //_setTokenURI(nextTokenIdToMint(), string(abi.encodePacked(placeholderURIPrefix, _tokenId)));
        //_safeMint(_burnerAddress, 1, "");
        emit TestEvent(_tokenId, _burnerAddress, msg.sender);
    }
