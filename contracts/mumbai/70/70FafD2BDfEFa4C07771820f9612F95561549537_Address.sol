...
string Others;
    ...
    mapping(uint256 => Character1) public tokenIdToCharacter1;
    mapping(uint256 => Character2) public tokenIdToCharacter2;
function updateChracterSet1(uint256 tokenId, string memory  Name,string memory Description,string memory AwardedBy,string memory AwardedTo,
string memory TypeofAward,
string memory Timestamp,
string memory Occasion,
string memory Message,
string memory Voicememo,
string memory Video
) public returns (bool){
Character1 memory c = Character1(Name, Description, AwardedBy, AwardedTo,TypeofAward,Timestamp,
 Occasion,
 Message,
 Voicememo,
 Video);
tokenIdToCharacter1[tokenId] = c;
return true;
}   
function updateChracterSet2(uint256 tokenId, string memory RewardValue,
string memory Corporateid,
string memory CorporateName,
string memory Tradeable,
string memory Platformfees,
string memory Gasfees,
string memory Transactionfees,
string memory Linkoftheimage,
string memory Others
) public returns (bool){
 Character2 memory c = Character2( RewardValue,
 Corporateid,
 CorporateName,
 Tradeable,
 Platformfees,
