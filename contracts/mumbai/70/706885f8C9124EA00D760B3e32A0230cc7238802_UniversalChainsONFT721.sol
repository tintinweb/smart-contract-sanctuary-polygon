...
contract UniversalChainsONFT721 is ONFT721 {
    /**********/
    /* ERRORS */
    /**********/
    ...
    function mint(address referrer) public payable {
        ...
        if (referrer != address(0)) {
            ...
            referralEarnings[referrer] += referrerEarnings;
        }

        protocolEarnings += ownerEarnings;
    ...
    function claimEarnings() external {
        uint256 earnings = referralEarnings[_msgSender()];
        if (earnings == 0) {
            revert UniversalChainsONFT721_NoEarningsToClaim();
        }

        referralEarnings[_msgSender()] = 0;
