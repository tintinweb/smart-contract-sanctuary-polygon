...
contract MyToken is ERC1155, Ownable, Pausable, ERC1155Burnable {
    ...
    uint256 public constant EYES = 1;
    uint256 public constant BODY = 2;
    ...
    function mintHat() public {
        _mint(msg.sender, HAT, 1, "");
    }

    function mintEyes() public {
        _mint(msg.sender, EYES, 1, "");
    }

    function mintBody() public {
        _mint(msg.sender, BODY, 1, "");
    }

    function mintShoes() public {
        _mint(msg.sender, SHOES, 1, "");
    }

    function mintAccessory() public {
        _mint(msg.sender, ACCESSORY, 1, "");
    }
