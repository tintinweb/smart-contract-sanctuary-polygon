...
contract purchase {
    ...
    function buyCourse(uint $USDC, address contentCreator) public {
        ...
        address superTokenAddress = 0x42bb40bF79730451B11f6De1CbA222F17b87Afd7;
        
        // approving
        USDc.approve(superTokenAddress, contentCreatorAmount);

        // wrapping
        ISuperToken(superTokenAddress).upgrade(contentCreatorAmount);
