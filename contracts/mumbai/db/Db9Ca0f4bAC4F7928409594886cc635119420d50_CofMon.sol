...
contract CofMon is ERC721, Pausable, Ownable, ERC2981 {
    ...
    uint256 public constant PRICE_PUBLIC = 10; // 0.00666 ether;
    uint256 public constant PRICE_FOR_PARTNERS = 5; // 0.00333 ether;
    uint256 public constant PRICE_WITH_MERCH = 20; // 0.0666 ether;
    ...
    function publicMint(
        ...
        if (_withMerch) {
            require(
                msg.value >= (PRICE_WITH_MERCH / 10 * _count),
                "Value below price"
            );
        } else {
            require(msg.value >= (PRICE_PUBLIC / 10 * _count), "Value below price");
        }
    ...
    function mintForPartners(uint256 _count) public payable whenNotPaused {
        ...
        require(
            msg.value >= (PRICE_FOR_PARTNERS / 10 * _count),
            "Value below price"
        );
        require(
