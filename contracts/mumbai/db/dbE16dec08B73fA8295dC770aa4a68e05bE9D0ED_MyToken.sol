...
contract MyToken is ERC20, ERC20Capped, Ownable, ReentrancyGuard {
    ...
    uint256 public MINTING_DAILY_CAP;
    uint256 public constant TAX_PERCENT = 10; // 0.1% tax
    uint256 public constant BURN_PERCENT = 50; // 50% of the tax is burned

    address public treasuryAddress;

    constructor() ERC20("test Token", "MTK") ERC20Capped(10000000 * 10**decimals()) {
        _mint(msg.sender, 1000000 * 10**decimals());
        minters[msg.sender] = true;
        MINTING_DAILY_CAP = 100000 * 10**decimals();
    ...
    function mint(address _to, uint256 _amount) public nonReentrant {
        ...
        require(newMintedToday <= MINTING_DAILY_CAP, "Exceeded daily minting cap");
