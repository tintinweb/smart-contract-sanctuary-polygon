...
import {FxBaseChildTunnel} from "../vendor/fx-portal/tunnel/FxBaseChildTunnel.sol";
...
contract BridgeChildPolygon is
    ...
    Create2
{
    ...
    function deployChildToken(
        ...
        uint8 decimals
    ) public onlyRole(DEFAULT_ADMIN_ROLE) nonReentrant returns (address) {
        ...
        require(
            ...
            "FxMintableERC20ChildTunnel: ALREADY_MAPPED"
        );
    ...
    function withdraw(address childToken, uint256 amount) public nonReentrant {
