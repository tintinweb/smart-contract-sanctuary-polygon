...
contract TradingFactory is Initializable, BasicMetaTransaction {
    ...
    function createTrading(
        ...
        ITrading(Clone).initialize(_admin, _usdc, _token);
        IToken(Clone).transferFrom(_msgSender(), Clone, _amount);
...
interface ITrading {
    ...
    function initialize(address _admin, address _usdc, address _token)  external ;
