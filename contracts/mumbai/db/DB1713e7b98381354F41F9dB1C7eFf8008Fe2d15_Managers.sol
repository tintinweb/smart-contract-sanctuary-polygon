...
contract Managers is Ownable {
    ...
    modifier onlyManager(address _caller) {
        // if (!isManager(msg.sender)) { //hyigit
 ...
 */
	...
	*/
    function changeManager1Address(address _newAddress) external onlyManager(msg.sender) {
        ...
        if (isApproved(_title, _encodedValues)) {
            manager1 = _newAddress;
            emit ChangeManagerAddress(msg.sender, "Manager1", _newAddress, true);
            _deleteTopic(string.concat("Managers: ", _title));
        } else {
            emit ChangeManagerAddress(msg.sender, "Manager1", _newAddress, false);
        }
    }
    ...
    function changeManager2Address(address _newAddress) external onlyManager(msg.sender) {
        ...
        if (isApproved(_title, _encodedValues)) {
            ...
            emit ChangeManagerAddress(msg.sender, "Manager2", _newAddress, true);
            _deleteTopic(string.concat("Managers: ", _title));
        } else {
            emit ChangeManagerAddress(msg.sender, "Manager2", _newAddress, false);
        }
    }
    ...
    function changeManager3Address(address _newAddress) external onlyManager(msg.sender) {
        ...
        if (isApproved(_title, _encodedValues)) {
            ...
            emit ChangeManagerAddress(msg.sender, "Manager3", _newAddress, true);
            _deleteTopic(string.concat("Managers: ", _title));
        } else {
            emit ChangeManagerAddress(msg.sender, "Manager3", _newAddress, false);
        }
    }
    ...
    function changeManager4Address(address _newAddress) external onlyManager(msg.sender) {
        ...
        if (isApproved(_title, _encodedValues)) {
            ...
            emit ChangeManagerAddress(msg.sender, "Manager4", _newAddress, true);
            _deleteTopic(string.concat("Managers: ", _title));
        } else {
            emit ChangeManagerAddress(msg.sender, "Manager4", _newAddress, false);
        }
    }
    ...
    function changeManager5Address(address _newAddress) external onlyManager(msg.sender) {
        ...
        if (isApproved(_title, _encodedValues)) {
            ...
            emit ChangeManagerAddress(msg.sender, "Manager5", _newAddress, true);
            _deleteTopic(string.concat("Managers: ", _title));
        } else {
            emit ChangeManagerAddress(msg.sender, "Manager5", _newAddress, false);
        }
    }
