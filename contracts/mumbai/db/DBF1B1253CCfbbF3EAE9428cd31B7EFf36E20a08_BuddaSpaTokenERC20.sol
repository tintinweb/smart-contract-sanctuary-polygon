...
contract BuddaSpaTokenERC20 is ERC20, ERC20Burnable, ERC20Pausable, ERC20Permit { 
    ...
    constructor ( string memory _name, string memory _symbol, uint8 _decimal, address _owner) ERC20(_name, _symbol) ERC20Permit(_name) {
        decimal = _decimal;
