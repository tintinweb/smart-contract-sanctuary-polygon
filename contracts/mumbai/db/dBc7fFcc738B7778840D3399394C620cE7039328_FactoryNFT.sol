...
contract FactoryNFT {
    ...
    function createToken(uint _indexOfContract,string memory _name, bool _limited, uint128 _limit,bool _allowed, bool _allowedList,string memory _uri) public {
        tokens[_indexOfContract].createToken(_name,_limited,_limit,_allowed,_allowedList,_uri);
    ...
    function mintNFT(uint _indexOfContract,address to) public {
        ...
        // mint function
        uint tokenId = tokens[_indexOfContract].mintTokenItem(to);
    ...
    function mintNFTOther(uint _indexOfContract,address to) public {
        ...
        // mint function
         uint tokenId =  tokens[_indexOfContract].mintTokenItemOther(to);
        emit NFTMinted(tokens[_indexOfContract].owner(), address(tokens[_indexOfContract]),tokenId);
    }
   /*
...
contract NFT is ERC1155, Ownable {
    ...
    function createToken(string memory _name, bool _limited, uint128 _limit,bool _allowed, bool _allowedList,string memory _uri) external  onlyOwner returns(uint256) {
       /*  require(
    ...
    function mintTokenItem(address to) public onlyOwner checkMinting returns(uint256) {       
        _mint(to, tokenId.current(), 1, '');
        tokenIdToToken[tokenId.current()].tokenMinted += 1;
        return tokenId.current();
    }

    function mintTokenItemOther(address to) public checkMinting returns(uint256){
