...
contract Lottery {
    ...
    uint256 public constant maxTickets = 100000000; // maximum tickets per lottery
    uint256 public constant ticketCommission = 0.00032 ether; // commission per ticket
    uint256 public constant duration = 48 hours; // The duration set for the lottery
