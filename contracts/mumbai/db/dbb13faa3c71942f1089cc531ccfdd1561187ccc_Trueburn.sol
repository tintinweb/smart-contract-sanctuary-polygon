...
/**
 *Submitted for verification at Etherscan.io on 3032-11-05
*/
...
contract Trueburn is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function needToUpdateCost(uint256 _supply) public view returns (uint256 _cost) {
      if(_supply < 3) {
          return 0.04 ether;
      }
      if(_supply < 6) {
