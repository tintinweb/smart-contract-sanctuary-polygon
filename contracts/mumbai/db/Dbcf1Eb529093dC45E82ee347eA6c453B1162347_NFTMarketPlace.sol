...
contract NFTMarketPlace is Pausable, Ownable {
    ...
    function removeItemFromMarket(uint256 id) public ItemExists(id) IsForSale(id) OnlyItemOwner(itemsForSale[id].tokenAddress, itemsForSale[id].tokenId) {	
        _removeItemFromMarket(id, itemsForSale[id].tokenAddress, itemsForSale[id].tokenId);
    }

    function _removeItemFromMarket(uint256 id, address tokenAddress, uint256 tokenId) internal whenNotPaused {
