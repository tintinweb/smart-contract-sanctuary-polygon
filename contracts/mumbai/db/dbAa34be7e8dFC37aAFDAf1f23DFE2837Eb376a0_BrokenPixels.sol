...
// File: contracts/BrokenPixels.sol
...
contract BrokenPixels is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("BROKEN PIXELS", "BP") {
    setHiddenMetadataUri("ipfs://QmbYWZtD4qmd2e2GZygrSbiAddrSoKWPnkNArHyLUm8bdE/bp_placeholder.json");
  }
