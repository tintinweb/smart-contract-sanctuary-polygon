...
// File: contracts/MyMintplexProject55Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract MyMintplexProject55Contract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "My Mintplex Project55";
    string public symbol = "MINTPLEX55";
