...
contract univ3tool {
    ...
    UniswapV3Factory factoryV3 = UniswapV3Factory(0x1F98431c8aD98523631AE4a59f267346ea31F984);
    IUniswapV3Pool pool = IUniswapV3Pool(factoryV3.getPool(tokenAddress, maticAddress, defaultFee));
    ...
    function comp(address _a, address _b) public view returns (bool) {
        return _a < _b;
    }
    ...
    function ethbalance(address a) external view returns(uint256){
        return a.balance;
    }
}