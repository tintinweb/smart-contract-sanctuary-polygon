...
[email protected]@[email protected],,,,,,,,,,,,,,;[email protected]@iii,,,,,@[email protected]@0;,,,:;;@LLLG0LGiiiiiiiiiiiiiiiiiiiiiiiiiiii
...
contract BoredUninvitedElephantClubTest is ERC721Enumerable, Ownable, ReentrancyGuard, NonblockingLzApp {
    ...
    constructor(
        ...
        startMintId = _startMintId + _preMintCount;
    ...
    function mint(uint8 _mintAmount) external payable {
        ...
        require(nextMintId + _mintAmount <= maxMintId + 1, "BoredUninvitedElephantClubTest: Max supply exceeded");
