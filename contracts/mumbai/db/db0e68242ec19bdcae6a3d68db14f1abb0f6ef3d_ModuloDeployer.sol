...
// File: Contracts/Modulo_MultiContract/ModuloRaffle721A.sol
...
// File: Contracts/Modulo_MultiContract/ModuloDeployer.sol
...
/// Chainlink - Start
    ...
    function Check_Soldout() public  view returns (bool) {
        bool isSoldout = CurrentRaffle.RaffleAddress.Check_Soldout();
        return isSoldout;
    ...
    function PickWinner()  private  {
        ...
        CurrentRaffle.Winner = CurrentRaffle.RaffleAddress.ownerOf(WinningTokenID);
        require(CurrentRaffle.Winner != address(0), "Error getting Winner");
 
        /// Update Prize Tracker with winner
        PrizeVault memory Prize;

        Prize.GameNo = currentGameNo;
        Prize.PrizeNFTAddress = CurrentRaffle.PrizeNFTAddress;
        Prize.PrizeNFTID = CurrentRaffle.PrizeNFTID;

        /// Add to a list of winning NFT's
        PrizeVaultMapper[CurrentRaffle.Winner].push(Prize);
    ...
    function Withdraw_Prize() public {
...
/// Owner Withdraw functions
    ...
    function withdraw_NFT(address NFTAddress_, uint256 NFTID_) external onlyOwner {
