...
contract testingCoeg is ERC721, Ownable, AccessControl, ReentrancyGuard, ERC721Burnable, ERC721Enumerable {
    ...
    function minter(address _to, uint256 tokenId) public onlyRole(MINTER) {
        require(!paused, "The contract is paused!");
        require(tokenId <= maxSupply, "cannot mint more than maxSupply");
        _safeMint(_to, tokenId);
    }

    function bulkMint(address[] memory _to, uint256[] memory _id) public onlyRole(MINTER){
        require(!paused, "The contract is paused!");
