...
contract MatchMaker is VRFConsumerBaseV2, ReentrancyGuard, Ownable {
    ...
    struct TournamentStruct {
        ...
        // uint256[] playerIds; cant give empty array while struct initiallization
    }
    ...
    mapping(uint256 => address) public playerIdToPlayerAddress;
    mapping(address => uint256) public playerAddressToPlayerId;
    ...
    // constructor() VRFConsumerBaseV2(_vrfCoordinatorV2) {
    constructor(
    ...
    function startTournament(uint256 _tournamentId) external payable nonReentrant {
        ...
        // match making
        requestRandomnessOracle(_tournamentId, tournamentToTournamentInfoMap[_tournamentId].currentGamerCount);
    }
    ...
    function joinTournament(uint256 _tournamentId) external payable nonReentrant {
        ...
        if (playerAddressToPlayerId[msg.sender] == 0) {
            // check fee
            require(
            ...
            playerAddressToPlayerId[msg.sender] = playerId;
            playerIdToPlayerAddress[playerId] = msg.sender;
            ...
            uint256 _playerId = playerAddressToPlayerId[msg.sender];
    ...
    function fulfillRandomWords(uint256 requestId, uint256[] memory randomWords) internal override {
        ...
        uint256[] memory _playersInTournament = tournamentToPlayers[_tournamentId];
        uint256 _totalPlayersInTournament = _playersInTournament.length;
