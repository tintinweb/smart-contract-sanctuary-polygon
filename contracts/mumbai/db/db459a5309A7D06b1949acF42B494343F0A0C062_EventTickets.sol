...
contract EventTickets is ERC721URIStorage {
  ...
  constructor() ERC721 ("Event Tickers", "ETS") {}
  ...
  function createEvent(string memory _name, string memory _dateTime, uint256 _price) public {
    ...
    Event memory newEvent = Event(msg.sender, _price, 0, _name, _dateTime);
  ...
  function generateTicket(string memory _eventName, uint256 _tokenId, address _owner) public pure returns (string memory) {
    bytes memory svg = abi.encodePacked(
        ...
        '<text x="50%" y="50%" class="base" dominant-baseline="middle" text-anchor="middle">', "Ticket: ",_tokenId,'</text>',
        '<text x="50%" y="60%" class="base" dominant-baseline="middle" text-anchor="middle">', "Owner: ",_owner,'</text>',
        '</svg>'
    );
  ...
  function mint() public {
    ...
    _setTokenURI(newItemId, getTokenURI("Solidity Meetup", newItemId, msg.sender));
}
  ...
  function getTokenURI(string memory _eventName, uint256 _tokenId, address _owner) public pure returns (string memory){
    bytes memory dataURI = abi.encodePacked(
        '{',
            ...
            '"image": "', generateTicket(_eventName, _tokenId, _owner), '"',
            '"attributes": [',
              '{',
                '"trait_type": "Token ID"',
