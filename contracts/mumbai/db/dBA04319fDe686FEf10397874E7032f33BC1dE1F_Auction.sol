...
contract Auction is Ownable {
    ...
    function cancelListingFixedPrice(
        ...
        string[] memory arrayString = new string[](0);
        uint160 tokenId = getTokenIdFromListing(_listingId);
        DataStructure.dataStructure memory dataInstance = DataStructure
    ...
    function cancelOfferPvP(
        ...
        uint160 tokenId = Offers[_nftId].tokenId;
        require(
            msg.sender == maker,
    ...
    function cancelOfferAuction(
        ...
        uint160 tokenId = Offers[_auctionId].tokenId;
        require(
            msg.sender == maker,
            "You are not allowed to preoceed this function"
        );
        ...
        checkStateOfAution(_auctionId)
    {
        ...
        uint160 tokenId = processFinishAuction(
            _auctionId,
            winnerSubOfferId,
            _idCollection,
            _requestId
