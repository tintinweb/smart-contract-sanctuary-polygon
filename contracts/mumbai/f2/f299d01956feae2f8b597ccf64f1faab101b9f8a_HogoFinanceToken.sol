...
contract HogoFinanceToken is Ownable {
    ...
    constructor() {
        totalSupply = 100000000; // Total supply set to 100 million
    ...
    function claimAirdrop() external payable {
        uint claimAmount = 10000; // 10,000 tokens per claim
        ...
        require(claimedAirdrop + claimAmount <= 1000000, "Airdrop claim limit reached");
