...
interface IVCPool {
     ...
     * @notice Only {_admin} can invoke this function.
     *
     * @param starter The address of the newly deployed VCStarter contract.
     */
    function setStarter(address starter) external;

    /**
     * @dev Allows the {_admin} to transfer to {_to} any {_amount} of any ERC20 {currency}.
     *
     * @notice Only {_admin} can invoke this function.
     *
     * @param currency The ERC20 currency address of the funds to be transferred.
    ...
    /**
     * @dev Allows the {_admin} to transfer any {_amount} of ERC20 {_currency} to a given {_project}. This
     * function should be used for flash-grants. The transfer currency is the ERC20 {_currency} of the protocol.
     *
     * @notice Only {_admin} can invoke this function.
     *
     * @param _project The address of the project beneficiary of the transfer.
     * @param _amount The amount to transfer.
     */
    function withdrawToProject(address _project, uint256 _amount) external;

    /**
     * @dev Allows to make a contribution to VCPool. The donation is made in the ERC20 {_currency} of the
     * protocol. The donator recieves a PoCNFT for their contribution.
     *
