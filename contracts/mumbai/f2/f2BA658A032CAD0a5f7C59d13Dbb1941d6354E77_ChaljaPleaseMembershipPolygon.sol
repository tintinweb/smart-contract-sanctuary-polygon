 ...
 */
interface IChaljaPleaseMembershipPolygon {
    /**
...
contract ChaljaPleaseMembershipPolygon is
    IChaljaPleaseMembershipPolygon,
    ERC721AQueryable,
    ERC2981,
    Ownable,
    ReentrancyGuard
{
    ...
    constructor(
        ...
        bytes32 _root
    ) ERC721A("ChaljaPlease4 Membership Polygon", "CMP") {
