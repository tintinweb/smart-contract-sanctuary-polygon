...
contract AMonkSArt is ERC721OneOfOneCollection {
  constructor()
    ERC721OneOfOneCollection(
      Config({
        name: "AMonkSArtT4",
        symbol: "AMAT4",
        contractURI: "ipfs://QmRMUhNZ1ZMrmpYTGTo7NFVq92yDGsKs8EyZJiVJg95vDK",
        maxSupply: uint256(0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff),
        defaultRoyaltyAddress: address(0x5e7c7fFF062631Bc18b20AB6EC5565dA4d47F220),
        ...
        trustedForwarder: 0xF695480444a53fE45DA4498DbCc86074731102fd
      })
    )
  {}
}