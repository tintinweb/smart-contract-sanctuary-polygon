...
contract lbtestwv2d is VRFV2WrapperConsumerBase,ConfirmedOwner,ReentrancyGuard {
    ...
    */
        ...
        VRFV2WrapperConsumerBase(linkAddress, wrapperAddress) 
    {
        ...
        lbNodes = IluckblocksNodes(0x2BA07c8E717F0e8C1Cead14a5286479173f0FA11);
    ...
    function autoSpin(address _caller, uint256[] calldata _nodes) public nonReentrant {
        ...
        require(block.timestamp > lastAutoSpin + 25200, "draw timestamp still not reached");   // 604800 1 week > 605100 1 week+5mins
        ...
        botReward = prizeValueJackpot.mul(percentageToNFTs).div(1000); // Default: 9,50% of weekly jackpot goes to NFTNode Golden
         ...
         if(getJackpotinUSD() >= minimumPot){ 
            ...
            if(block.timestamp > lastAutoSpin + 25500 && reset == false){   // if no node activates in 5 minutes period queue resets
