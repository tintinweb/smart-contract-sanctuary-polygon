...
contract Collede{
    ...
    mapping(uint=>StudentDetails) public _students;//_  before to be as not parameter is added as convention to  make it private 

    uint public totalStudents;

    function enroll(string memory name_,uint class_) public {         //_is added after it to identify it as parameter
