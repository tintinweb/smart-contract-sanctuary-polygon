...
contract PrivateSale is ReferralSystem, ISaleRound, Ownable {
    ...
    modifier isWhiteList(address account) {
        require(_whiteList[account], "Only whitelisted users");
        _;
    }
    ...
    function buyMGB(
        ...
        uint256 usdAmount,
        address referrer
    ) external isAvailableCurrency(usdAddr) isWhiteList(msg.sender) isFinish {
        if (
    ...
    /**
     * @dev See {ISaleRound-withdrawETH}.
     */
