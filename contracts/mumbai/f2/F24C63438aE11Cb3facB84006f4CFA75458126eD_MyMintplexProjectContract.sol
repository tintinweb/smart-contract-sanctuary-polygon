...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xC607C8BcF92c7558C013c0c7B4E1CD111367a485];
  address public erc20Payable = 0xC607C8BcF92c7558C013c0c7B4E1CD111367a485;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://ipfs.wewin.net/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/1gYOVO7TFLXxe7KTYMca/contract-metadata";
  }
