...
contract nftsIPFS {
    address payable contractOwner =
        payable(0x38Bd5e068ED4C5F428b2335e872a5acad6eA44dA);
    ...
    function updateListingPrice(uint256 _listingPrice, address owner) public payable {
      require(contractOwner == owner, "Only contract owner can update the listing price.");
    ...
    function withdraw(address _owner) external {
      require(contractOwner == _owner, "Only owner can withdraw");
