    ...
    IDelegator
{
    constructor(
        ...
        uint256 basisPointsTickSizePerYear,
        uint256 basisPointsUpperTickPerYear,
        uint256 pusdLowerTargetPrice,
        uint256 pusdUpperTargetPrice,
        ...
        _delegatecall(abi.encodeWithSelector(
            ...
            borrowInterestRatePerYear,
            basisPointsTickSizePerYear,
            basisPointsUpperTickPerYear,
            pusdLowerTargetPrice,
            pusdUpperTargetPrice,
            blocksPerYear,
            primeOracle
        ));
    }
...
abstract contract IRMDelegatorEvents {
    ...
    event GetPusdLowerTargetPrice(uint256 lowerPrice);
    event GetPusdUpperTargetPrice(uint256 upperPrice);
