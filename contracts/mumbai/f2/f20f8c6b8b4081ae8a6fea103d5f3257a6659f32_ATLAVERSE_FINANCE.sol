...
contract ATLAVERSE_FINANCE is ERC20Burnable, Ownable {
    ...
    constructor(uint256 tTotal_, string memory name_, string memory symbol_, uint8 decimals_, uint256 burnFee_, uint256 AtlaSecure_, uint256 GrowthFund_, uint256 reflectionFee_, address AtlaSecureAccount_, address GrowthFundAccount_, address service_) ERC20(name_, symbol_) payable {
        _decimals = decimals_;
        ...
        _taxFee2 = GrowthFund_;
        _previousTaxFee2 = _taxFee2;

        _feeAccount = AtlaSecureAccount_;
        _feeAccount2 = GrowthFundAccount_;
...
//////////////////////////////Change Function /////////////////////////////////////////////////
    ...
    function changeAtlaSecureAccount(address newFeeAccount) public onlyOwner() returns(bool) {
        require(newFeeAccount != address(0), "zero address can not be the FeeAccount");
        _feeAccount = newFeeAccount;
        return true;
    }

    function changeGrowthFundAccount(address newFeeAccount2) public onlyOwner() returns(bool) {
    ...
    function changeAtlaSecureFee(uint256 AtlaSecure_) public onlyOwner() returns(bool) {
        require(AtlaSecure_ >= 0, "Tax fee must be greater or equal to zero");
        require(AtlaSecure_ <= 10, "Tax fee must be lower or equal to 10");
        _taxFee = AtlaSecure_;
        return true;
    }


    function changeGrowthFundFee(uint256 GrowthFund_) public onlyOwner() returns(bool) {
        require(GrowthFund_ >= 0, "Tax fee must be greater or equal to zero");
        require(GrowthFund_ <= 10, "Tax fee must be lower or equal to 10");
        _taxFee2 = GrowthFund_;
        return true;
    }

//////////////////////////////Atlaverse Finance Function //////////////////////////////////////
