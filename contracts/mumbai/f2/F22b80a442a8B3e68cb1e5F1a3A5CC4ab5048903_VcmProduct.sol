    ...
    AccessControl
{
    ...
    constructor(
        ...
        Product(NAME, token, POLICY_FLOW, riskpoolId, registry) 
    {
    ...
    function setEscrowWallet(address escrowWallet) external {
        ...
        returns (bytes32 processId) 
    {
        ...
        bytes memory applicationData = encodeApplicationParametersToData(msaId, caseSubject, patient);
    ...
    {
        return abi.decode(data, (string, string, address));
    }
    ...
    {
        return abi.encode(msaId, caseSubject, patient);
    }
