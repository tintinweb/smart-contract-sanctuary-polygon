...
contract DayMonth is ERC721, Ownable {
    uint256 public tokenCounter = 0; // Counter for the token IDs
     ...
     */
    event CardPartCreated(uint256 indexed tokenId, string tokenURI);
    ...
    */
    ...
    function createDayMonth(
        ...
        emit CardPartCreated(tokenCounter, _tokenURI);
        tokenCounter++;
