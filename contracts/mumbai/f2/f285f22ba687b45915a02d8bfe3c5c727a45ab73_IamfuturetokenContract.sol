...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmeVDebJQybzdg57jRL6mdQQ9qyJcijP23y3LJfowM5Fh1/";
...
// File: contracts/IamfuturetokenContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract IamfuturetokenContract is RamppERC721A {
    constructor() RamppERC721A("I AM FUTURE TOKEN", "IAF"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/rHJumjUGshKygs9aQPup/contract-metadata";
    }
}
