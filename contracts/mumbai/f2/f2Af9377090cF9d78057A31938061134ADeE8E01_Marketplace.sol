    ...
    IERC1155Receiver
{
    ...
    /// @dev Total number of listingsByListingId ever created in the marketplace.
    ...
    mapping(uint256 => Listing) public listingsByListingId;
    ...
    modifier onlyListingCreator(uint256 _listingId) {
        require(
            listingsByListingId[_listingId].tokenOwner == _msgSender(),
            "Marketplace#onlyListingCreator: msgSender is not owner of the token"
        );
        _;
    }
    ...
    modifier onlyExistingListing(uint256 _listingId) {
        require(
            listingsByListingId[_listingId].assetContract != address(0),
            "Marketplace#onlyExistingListing: listing does not exist"
        );
        _;
    }
    ...
    function createListing(ListingParameters memory _params) external override {
        ...
        require(
            tokenAmountToList > 0,
            "Marketplace#createListing: token amount must be greater than 0"
        );
        ...
        listingsByListingId[listingId] = newListing;
    ...
    {
        Listing memory targetListing = listingsByListingId[_listingId];
        delete listingsByListingId[_listingId];
        transferListingTokens(
            address(this),
    ...
    /*//////////////////////////////////////////////////////////////
                    Direct listingsByListingId sales logic
    //////////////////////////////////////////////////////////////*/
    ...
    function buy(
        ...
        require(
            ...
            "Marketplace#buy: wrong price and/or currency"
        );
    ...
    function executeSale(
        ...
        listingsByListingId[_targetListing.listingId] = _targetListing;
    ...
    /*//////////////////////////////////////////////////////////////
            Shared (direct+auction listingsByListingId) internal functions
    //////////////////////////////////////////////////////////////*/
    ...
    function payout(
        ...
        uint256 remainingAmount = _totalPayoutAmount;
        try
        ...
        safeTransferERC20(_currencyToUse, _payer, _payee, remainingAmount);
    }
    ...
    function validateERC20BalAndAllowance(
        ...
        require(
            ...
            "Marketplace#validateERC20BalAndAllowance: not enough balance"
        );
        require(
            IERC20(_currency).allowance(_addrToCheck, address(this)) >=
                _currencyAmountToCheckAgainst,
            "Marketplace#validateERC20BalAndAllowance: not enough allowance"
        );
    }
    ...
    function validateOwnershipAndApproval(
        ...
        require(
            isValid,
            "Marketplace#validateOwnershipAndApproval: token not owned or approval not set"
        );
    }
    ...
    function validateDirectListingSale(
        ...
        require(
            ...
            "Marketplace#validateDirectListingSale: invalid amount of tokens"
        );
        ...
        returns (TokenType tokenType)
    {
        if (
            ...
            revert("Marketplace#getTokenType: token must be ERC1155 or ERC721");
        }
    }
}
