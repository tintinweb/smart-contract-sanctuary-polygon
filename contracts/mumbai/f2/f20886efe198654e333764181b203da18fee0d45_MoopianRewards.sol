...
contract MoopianRewards is ERC721Enum, Ownable, ReentrancyGuard {
    using Strings for uint256;
    uint256 public maxSupply = 8000;
    string public baseURI = "";

    constructor() ERC721("Moopian", "Moopian") {
        setBaseURI(baseURI);
    }
    ...
    function adminMint(uint256 amount, address recipient) external onlyOwner {
        uint256 s = totalSupply();
        require(s + amount <= maxSupply, "Too many");
