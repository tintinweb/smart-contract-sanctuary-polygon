    ...
    function startTheRecovery() external override {
        ...
        for(uint256 i = 0; i < agentList.length; i++) {
            ...
            if(i < agentList.length / 2) {
                ...
                answerAgentsDetails[agentList[randomIndex]] = AnswerAgentsDetails(affectedChallenge.answer,"",affectedChallenge.id,false, AnswerStatus.NOT_ANSWERED);
...
contract RecoveryFactory is IRecoveryFactory, YousovRoles {
    ...
    function getCurrentUserRecovery(address user) external override returns (address) {
        return currentCreatedRecoveries[user];
    }
}
