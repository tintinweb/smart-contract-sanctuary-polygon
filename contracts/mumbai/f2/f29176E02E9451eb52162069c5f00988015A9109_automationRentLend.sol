...
//import "./lyncrent.sol";
import "./rentLendMarketplaceOrder.sol";
 ...
 */
contract automationRentLend is AutomationCompatibleInterface {
    /**
     * Public counter variable
     */
    uint256 public counter;
    rentLendMarketplaceOrder public rentLendAddress;
    address _owner;
    /**
    ...
    constructor(uint256 updateInterval, address payable addLync) {
        ...
        _owner = msg.sender;
        rentLendAddress = rentLendMarketplaceOrder(addLync);
    }
    ...
    {
        (, uint256 _length) = rentLendAddress.checkRentingDurationExp();
    ...
    function performUpkeep(
        ...
        rentLendAddress.checkAndReturnRentedNfts();
        rentLendAddress.checkAndDelistOrders();
        // We don't use the performData in this example. The performData is generated by the Automation Node's call to your checkUpkeep function
    }

    function setLyncAddress(address payable _rentLendAddress) external {
        require(msg.sender == _owner, "Only owner can call tis function");
        rentLendAddress = rentLendMarketplaceOrder(_rentLendAddress);
    }
}
