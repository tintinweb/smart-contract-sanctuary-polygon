...
contract WrappedBRSToken is ERC20, ERC20Permit, ERC20Votes, ERC20Wrapper {

    constructor(IERC20 wrappedToken, string memory name, string memory symbol) ERC20(name, symbol) ERC20Permit(name) ERC20Wrapper(wrappedToken) {
    }
