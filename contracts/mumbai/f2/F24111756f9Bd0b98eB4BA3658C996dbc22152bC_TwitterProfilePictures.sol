 ...
 * @notice This contract handles minting Twitter Profile Pictures tokens.
 */
contract TwitterProfilePictures is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x6BBaBbc313580C659d9c81406cd05d0F6810401e;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x6dDb27E34179907237F392A8bf04C42E554257A0;
    ...
    address[] public payoutAddresses = [
        0x6dDb27E34179907237F392A8bf04C42E554257A0
    ];
    ...
    string public name = "Twitter Profile Pictures";
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeiauim3ynf43zhi2y45g4m34jmhm6nxjdn6a4bk5tqtlgekdj7dpei/{id}"
        )
        RevokableOperatorFilterer(
