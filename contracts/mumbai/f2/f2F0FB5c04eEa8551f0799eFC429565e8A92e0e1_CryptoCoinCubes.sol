...
contract CryptoCoinCubes is ERC721Enumerable,Ownable {
	...
	{
        myContractURI = "https://gateway.pinata.cloud/ipfs/QmcU29Fwjkd8JJc6CBG3YnP7JkdHU8xKT2qRtbSDgZBmm4";
        _tokenIds.increment();
    ...
    function mintNft(uint256 _quantity) external onlyOwner payable{
		...
		require(msg.value >= NFT_PRICE*_quantity, "Not enough Matic");
