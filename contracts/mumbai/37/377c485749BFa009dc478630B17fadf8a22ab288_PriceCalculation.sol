...
contract PriceCalculation is PriceConsumerV3, IPriceCalculation {
    ...
    view
  {
    ...
    require(_wethAmount >= buyerTotalToWei, "PriceCalculation#validateAmount: not enough of ETH being sent");
  }
  ...
  function setDbiliaToken(address _newDbiliaToken) external {
    require(msg.sender == dbiliaToken.owner(), "PriceCalculation#setDbiliaToken: wrong owner");
