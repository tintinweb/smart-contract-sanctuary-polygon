...
contract Rewards is Initializable, PausableUpgradeable, OwnableUpgradeable, ERC20Upgradeable, ReentrancyGuardUpgradeable {
    ...
    // Maximum level that an address can get by reward ID rewardID]
    ...
    function initialize(address _kutils, address _kuthulu, address _doom, address _raffleTix, uint256 _amnt, uint256 _maxLevel) initializer public {
        __Pausable_init();
        __Ownable_init();
        ...
        // Set the max level someone can have for this reward
        maxRewardLevel.push(_maxLevel);
    }
    ...
    */
    ...
    function updateDetails(address _kutils, address _kuthulu, address _raffleTix, uint256 _amount, address _doom, bool incrementRewardID, uint256 _maxLevel) public onlyAdmins {
        ...
        if (incrementRewardID){
            ...
            // Set the max level someone can have for the new reward id
            maxRewardLevel.push(_maxLevel);
        } else {
            // Set the max level someone can have for this reward
            maxRewardLevel[currentRewardID] = _maxLevel;
        }
