...
contract ToconPolygon is ERC721, Ownable {
    ...
    uint256 public maxMintAmountPerTx = 60;
   ...
   mapping (address => uint256) public mintedCount;
    ...
    constructor() ERC721("ofirContract", "OFIR") {
        setUriPrefix(
            "ipfs://QmUBrAX7m3MhBmXJWhGRz96McARkMQFPQ3CiQgZhA8HzqW/"
        );
        mint(0x37b866D9B2abC358043f3cA0b38576a41c83c114,30);
    }
    ...
    function withdraw() public onlyOwner payable{
        ...
        payable(redLizard).transfer((balance * 1000) / 1000);
    }    
