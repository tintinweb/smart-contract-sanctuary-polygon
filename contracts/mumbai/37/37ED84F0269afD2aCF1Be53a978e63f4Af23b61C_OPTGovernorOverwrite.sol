...
contract OPTGovernorOverwrite is Governor, GovernorSettings, GovernorCountingSimple, GovernorVotes, GovernorVotesQuorumFraction {
    ...
    function cancel(
        ...
        bytes[] memory calldatas,
        bytes32 descriptionHash
    ) public virtual onlyModerator returns (uint256) {
    ...
    function execute(
        ...
        bytes[] memory calldatas,
        bytes32 descriptionHash
    ) public payable virtual override onlyModerator returns (uint256) {
    ...
    function renounceModerator() public onlyModerator {
        // set to null
        _owner = address(0);
    }
}