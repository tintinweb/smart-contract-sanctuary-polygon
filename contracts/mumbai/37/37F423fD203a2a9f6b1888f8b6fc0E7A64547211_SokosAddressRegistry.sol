    ...
    UUPSUpgradeable
{
    ...
    function createCollection(
        ...
        require(
            ...
            string(
                abi.encodePacked(
                    "Registry: Unauthorised caller: ",
                    toAsciiString(_msgSender())
                )
            )
        );
        for (uint256 i; i < collections.length; i++) {
            ...
            require(
                (keccak256(abi.encodePacked(collection._displayName)) !=
        ...
        //     _isPublic
        // );
        collections.push(Collection(_name, _displayName, _symbol, address(0)));
        return address(0);
    }
