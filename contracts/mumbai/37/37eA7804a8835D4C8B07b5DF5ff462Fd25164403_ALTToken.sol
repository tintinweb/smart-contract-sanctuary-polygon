...
abstract contract ADFPausable is Pausable{
    ...
    modifier whenNotAddressPaused(address _pauseaddress) {
        require(!addresspaused(_pauseaddress) , "ADFPausable: address paused");
        _;
    }

    modifier whenAddressPaused (address _pauseaddress) {
        require(addresspaused(_pauseaddress) , "ADFPausable: address not paused");
        _;
    }
...
contract ALTToken is ERC20, ERC20Snapshot, ERC20Burnable,  Ownable , ADFPausable , ERC20Permit {

    constructor() ERC20 ( "Alisong" , "ALT" ) ERC20Permit("Alisong") {
