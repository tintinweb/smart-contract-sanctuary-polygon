...
contract UmiverseMarket is Ownable, ERC2771Context {
    ...
    IERC20 public usdt = IERC20(0xE0bcb04DE395BD5d688F25848e047427C3399af9);
    ...
    function buy(
        ...
        // buy with usdt
        if (_amount > 0) {
            usdt.transferFrom(_buyer, address(this), _amount);

            uint256 _fee = (_amount * feerate) / 1e4;
            if (_fee > 0) usdt.transfer(feeAddress, _fee);
            usdt.transfer(_seller, _amount - _fee);
        }
