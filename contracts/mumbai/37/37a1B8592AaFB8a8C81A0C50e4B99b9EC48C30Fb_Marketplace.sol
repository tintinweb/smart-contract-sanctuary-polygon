...
contract Marketplace {
    ...
    function listNFTforSale(uint256 tokenId, uint256 price) external {
        ...
        require(nft.getApproved(tokenId) == address(this), "Please approve the NFT to Marketplace contract");
    ...
    function buyNFT(uint256 tokenId) external {
        ...
        require(tokenPrices[tokenId] <= cby.balanceOf(msg.sender), "Offered price $CBY is not sufficient"); 
