...
contract ChainBattles is ERC721URIStorage {
    ...
    function mint() public {
        ...
        tokenIdToLevels[newItemId].speed = random(10);
        tokenIdToLevels[newItemId].strength = random(20);
        tokenIdToLevels[newItemId].life = random(30);
    ...
    function train(uint256 tokenId) public {
        ...
        tokenIdToLevels[tokenId].speed = tokenIdToLevels[tokenId].speed + 2;
        tokenIdToLevels[tokenId].strength = tokenIdToLevels[tokenId].strength + 3;
        tokenIdToLevels[tokenId].life = tokenIdToLevels[tokenId].life + 4;
