    ...
    ITradeCoinCompositionContract
{
    ...
    // modifier onlyProductInComposition(uint256 tokenId, uint256 productTokenId) {
    //     require(
    ...
    function createComposition(
        ...
        require(
            documents.docHash.length == documents.docType.length,
    ...
    function appendProductToComposition(
        ...
        require(ownerOf(tokenIdComposition) != address(0));
    ...
    function addTransformation(
        ...
        require(
            amountLoss <= tradeCoinComposition[tokenId].amount,
            "Invalid amount loss"
        );
        ...
        uint256 newAmount = tradeCoinComposition[tokenId].amount - amountLoss;
        tradeCoinComposition[tokenId].amount = newAmount;
        ...
        onlyReversible(tokenId)
    {
        ...
        tradeCoinComposition[tokenId].amount - amountLoss;
    }
    ...
    // function rtnInterfaceId() public pure returns (bytes4) {
    //     return type(ITradeCoinCompositionContract).interfaceId;
    // }
