...
contract PublicGovFactory is
    ...
    address public override dstSaleGateway; // dst sale gateway
    ...
    function init(
        ...
        address _dstSaleGateway, // sale gateway at another chain
     ...
     * @param _dstSaleGateway Sale gateway address
...
// interface IGovSaleRemoteFactory{
interface IGovFactory{
    ...
    // function saleGatewayRemote() external view returns (address);
    function dstSaleGateway() external view returns (address);
    ...
    // function createProject(uint128, uint128, uint128, uint128, uint128[4] calldata, address, address) external returns (address);
    ...
    // function setPercentage_d2(uint128, uint128, uint128, uint128) external;
}
...
interface IPublicGovSale {    
	...
	function buyToken(uint128, address) external;
}
