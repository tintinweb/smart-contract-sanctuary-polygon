...
import "./TokenTransferProxyV1.sol";
import "@openzeppelin/contracts/utils/Strings.sol";

/**
 * @title Token Transfer Proxy (V2)
 * @author Michael Larsen
 * @notice This contract is used to transfer tokens on the owners behalf.
 * @notice This is a util contract for the BookieMain app.
 * @notice Accesshandler is Initializable.
 */
contract TokenTransferProxyV2 is TokenTransferProxyV1 {
    uint8 public version;

    function reInitialize(uint8 newVersion) public virtual reinitializer(newVersion) {
        version = newVersion;
    }
