...
contract MarketPlace is Signer {
    ...
    function fixedOrderExecution( OrderStruct memory makerOrder, OrderStruct memory takerOrder, LazyMintStruct memory lazyMint, RoyaltyStruct memory royaltyInfo) public {
        require(((royaltyInfo.royaltyAddress == address(0)) && (royaltyInfo.royaltyFee == 0)) || ((royaltyInfo.royaltyAddress != address(0)) && (royaltyInfo.royaltyFee > 0  && royaltyInfo.royaltyFee < 5000)),"Invalid Royaltyfee and address");
    ...
    function setBeneficiaryFee( uint newBeneficiaryFee) public onlyOwner {
        require((newBeneficiaryFee > 0) && (newBeneficiaryFee < 5000), "setBeneficiaryFee : newBeneficiaryFee should > 0% and < 50%");
