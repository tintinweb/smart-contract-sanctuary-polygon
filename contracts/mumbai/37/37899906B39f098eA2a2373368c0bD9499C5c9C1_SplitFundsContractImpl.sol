...
contract SplitFundsContractImpl is ISplitFundsContract, Ownable, StringToAddress {
    ...
    string public titleWallet;
     ...
     enum TransactionType { Deposit, Spend, Withdraw }
    ...
    function deposit() external payable override {
        ...
        transactionInfo[transactionCount] = Transaction(block.timestamp, TransactionType.Deposit, msg.sender, address(this), msg.value, string.concat("Deposit: ", Strings.toString(msg.value), "Matic"));
    }
    ...
    function depositERC(uint256 amount) external payable  {
        ...
        transactionInfo[transactionCount] = Transaction(block.timestamp, TransactionType.Deposit, msg.sender, address(this), amount, string.concat("Deposit: ", Strings.toString(amount),"DERC"));
    }
    ...
    function spend(uint256 amount, address payable recipient, string calldata information) external  onlyAuthorized {
        ...
        transactionInfo[transactionCount] = Transaction(block.timestamp, TransactionType.Spend, address(this), recipient, amount, string.concat("Spend of : ", Strings.toString(amount), "Matic"));
    ...
    transactionInfo[transactionCount] = Transaction(block.timestamp, TransactionType.Spend, address(this), recipient, amount, string.concat("Spend of : ", Strings.toString(amount), "DERC"));
    ...
    function withdraw() external override onlyAuthorized {
        ...
        transactionInfo[transactionCount] = Transaction(block.timestamp, TransactionType.Withdraw, address(this), msg.sender, amount, string.concat("Withdraw of : ", Strings.toString(amount), "Matic"));
    ...
    function withdrawERC() external onlyAuthorized {
        ...
        transactionInfo[transactionCount] = Transaction(block.timestamp, TransactionType.Withdraw, address(this), msg.sender, amount, string.concat("Spend of : ", Strings.toString(amount), "DERC"));
