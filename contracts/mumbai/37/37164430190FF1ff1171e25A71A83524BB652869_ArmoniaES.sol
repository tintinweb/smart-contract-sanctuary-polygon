...
contract ArmoniaES is AccessControl {
    address _coin = 0xd9145CCE52D386f254917e481eB44e9943F39138;
    AmbrosiaCoin moneda = AmbrosiaCoin(_coin);
  ...
  function isUser(string memory _nomalias) public virtual view returns (bool){
    _nomalias = string(abi.encodePacked('arm.per.', _nomalias ));
  ...
  function Gremio_Add( string memory _nomalias, string memory _mecenasalias  ) public onlyAdmins {
    _nomalias = string(abi.encodePacked('arm.sec.', _nomalias ));
    _mecenasalias = string(abi.encodePacked('arm.per.', _mecenasalias ));
  ...
  function GremioMaestro_Add( string memory _nomalias, string memory _master  ) public onlyAdmins {
    _nomalias = string(abi.encodePacked('arm.sec.', _nomalias ));
    _master   = string(abi.encodePacked('arm.per.', _master ));
  ...
  function ComunidadOficial_Add( string memory _nomalias, string memory _oficial  ) public onlyAdmins {
    _nomalias = string(abi.encodePacked('arm.com.', _nomalias ));
    _oficial = string(abi.encodePacked('arm.per.', _nomalias ));
...
*/
  ...
  function register(string memory _nomalias ) public {
    ...
    Gente memory oGente = Gente( msg.sender , '' , _nomalias , ''   );  
  ...
  function registerByAdmin(string memory _nomalias , address payable _addr , string memory _ipfs , string memory _prv ) public onlyAdmins {
    _nomalias = string(abi.encodePacked('arm.per.', _nomalias ));
    require( genteByAlias[_nomalias].addr == address(0) , 'Alias Duplicado');
    require( genteByAddr[_addr].addr == address(0) , 'Pasaporte ya creado');
    Gente memory oGente = Gente( _addr , _ipfs , _nomalias , _prv );  
  ...
  function indexOf(string[] memory arr, string memory searchFor) private pure returns (int256) {
   ...
   function SaldoArmonia() public view returns(uint256) {
      
   return moneda.balanceOf(address(this));
  }

  function SaldoMio() public view returns(uint256) {
   return moneda.balanceOf(msg.sender);
  }
