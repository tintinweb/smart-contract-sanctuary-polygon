...
// This contract is used to manage the the Revellers Patron NFT`
// Enforces a final limit on the number of Revellers that can be minted.
// Tokens minted and distributed by metcalf.inc
    ...
    EIP2981RoyaltyOverrideCore
{
    ...
    // @dev limit of how many Patrons can be minted
    uint256 public maxSupply = 10;

    constructor() ERC721('Patrons', 'PAT') EIP712('PAT', "1") {}
    ...
    // @notice  Owner can mint new Patrons. Checks if the limit has been reached.
    // @dev     If the limit has been reached, throw an error.
    // @param   _to The address to send the token to.
    // @param   _tokenId The id of the token to be sent.
    // @param   _uri The uri of the token to be sent.
    function mint(
        address to,
        uint256 tokenId,
        string memory uri
