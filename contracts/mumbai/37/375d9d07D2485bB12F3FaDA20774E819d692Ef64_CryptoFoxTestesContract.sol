  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x9eA610212222509E21DC025CaF9CFcCD29dDA2C5);
        ...
        */
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, "Cannot mint over supply cap of 4");
    ...
    // File: contracts/cryptoFoxTestesContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract CryptoFoxTestesContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Crypto Fox TESTES", "CFTT", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmQ8PwLx5br6PM6tTEu9y2jSSUuvq6Jm2PyXzKxG2QS9og/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/veIRDFOL67RuBuRcVjRa/contract-metadata";
        }
    }