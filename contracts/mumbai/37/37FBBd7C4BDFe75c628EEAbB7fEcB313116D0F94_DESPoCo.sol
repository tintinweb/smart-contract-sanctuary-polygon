 ...
 * @notice This contract handles minting DESPoCo tokens.
 */
contract DESPoCo is
    ERC1155Supply,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x432CF93ba95d111FDDfa98336B189A4495ee7ee7;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x84E7ec5634aFF8C47fdf539Ea8e3Fdef744755EA;
    address[] public payoutAddresses = [
        0x84E7ec5634aFF8C47fdf539Ea8e3Fdef744755EA
    ];
    ...
    string public name = "DESPoCo";
    string public symbol = "DPOCO";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeibnhaduq6hg4ujk5o737ojexqbidrizp57tou6jpiq5lqp6imxd2q/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[100523] = 50;
        tokenPresaleMaxSupply[100523] = 50;
        tokenPresalePrice[100523] = 0 ether;
        tokenPresaleMintsPerAddress[100523] = 0;
        require(
