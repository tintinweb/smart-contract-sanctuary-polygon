...
contract StakingV4Upgrade is Initializable,OwnableUpgradeable,ERC721HolderUpgradeable, ReentrancyGuardUpgradeable {
        ...
        canUseThisSlot(_slot)
    {
        ...
        userPlots[tx.origin] = userPlots[tx.origin].add(facility.size(_tokenId));
        ...
        ownedSlot(_slot)
    {
        ...
        for (uint256 i = 0; i < _tokenIds.length; i++) {
            ...
            user.stables.pop();
            userPlots[ tx.origin] = userPlots[ tx.origin].sub(facility.size(_tokenId));
