...
contract Pet is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    uint256 public rate = 100 * 10 ** 18; // FRG tokens required per mint
    ...
    function safeMintWithBurnFrg(
        ...
        // console.log(
        //     "In PET.sol _msgSender():",
        //     _msgSender(),
        //     frgTokenAddress.balanceOf(_msgSender()),
        //     rate
        // );

        // console.log("In PET.sol frgTokenAddress:");
        // console.logAddress(address(frgTokenAddress));

        if (frgTokenAddress.balanceOf(_msgSender()) < rate)
            revert InsufficientFrgBalance();

        // EIP2612: extension of EIP-20 approvals enabling approvals using a signed message
        // console.log(
        //     "Pet.sol - owner, spender, value: ",
        //     _msgSender(),
        //     address(this),
        //     rate
        // );
