  ...
  Ownable
{
  ...
  event Unwrapped(uint256 indexed tokenId);
    //Variables
  address public ruggedproject = 0x8fe31Dad3E2ab1175eb9c7572766604d172E16AC; //address of Rugged NFT
  address public dbcontract = 0xbBed9425169FCdfBaafe1344e3C25E4B10134bd0; //address if the DB contract
  ...
  /////////////////////////////////
  constructor()
    ERC721("WrappedCompanionPolyGon", "wWM")
  {
