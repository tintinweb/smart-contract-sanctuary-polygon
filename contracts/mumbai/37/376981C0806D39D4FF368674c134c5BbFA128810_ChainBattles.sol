...
contract ChainBattles is ERC721URIStorage {
    ...
    mapping (uint256 => CharacterStats) public tokenIdtoCharacterStats;
    ...
    function getLevel(uint256 tokenId) public view returns (string memory) {
      CharacterStats memory Stats = tokenIdtoCharacterStats[tokenId];
    ...
    function mint() public {
        ...
        CharacterStats memory CharacterStats = CharacterStats(0, createRandom(2),  createRandom(3), createRandom(4)); // level, speed, strength, life)
        tokenIdtoCharacterStats[newItemId] = CharacterStats;
    ...
    function train(uint256 tokenId) public {
        ...
        CharacterStats memory currentCharacterStats = tokenIdtoCharacterStats[tokenId];
        uint256 currentLevel = currentCharacterStats.Level;
        currentCharacterStats.Level = currentLevel +1;
        tokenIdtoCharacterStats[tokenId] = currentCharacterStats;
