...
contract SimpleAssets is ISimpleAssets, AccessControlUpgradeable, ERC721Upgradeable, UUPSUpgradeable {
    ...
    mapping(address => bool) internal _bridgeOperatorApprovalRevoked;
    ...
    returns (bool) {
        ...
        (hasRole(BRIDGE, operator) && !_bridgeOperatorApprovalRevoked[owner]);
    }
    ...
    override
    virtual {
        if (!approved && hasRole(BRIDGE, operator) && !_bridgeOperatorApprovalRevoked[owner]) {
            _bridgeOperatorApprovalRevoked[owner] = true;
