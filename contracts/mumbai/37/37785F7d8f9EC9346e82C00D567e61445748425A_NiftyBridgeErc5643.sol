...
contract NiftyBridgeErc5643 is ERC5643, ERC2981, Ownable {
    using Counters for Counters.Counter;
    using Strings for uint256;

    string private _contractUri;
    string private _metadataSrc;
    ...
    function supportsInterface(bytes4 _interfaceId)
        ...
        view
        virtual
        override(ERC5643, ERC2981)
        returns (bool)
    {
        return super.supportsInterface(_interfaceId);
    }

    function create(address to, uint64 duration)
        external
        ownerOrManager
        returns (uint256 _id)
    {
