...
import "./ERC5643.sol";
import "./../BaseUri/Erc721BaseUri.sol";

contract NiftyBridgeErc5643 is Erc721BaseUri, ERC5643 {
    constructor(
    ...
    function supportsInterface(bytes4 _interfaceId)
        public
        view
        override(Erc721BaseUri, ERC5643)
        returns (bool)
    {
...
contract Erc721BaseUri is ERC721, ERC2981, Ownable {
    ...
    constructor(
        ...
        uint96 royaltyValue,
        string memory metadataSrcIn
    ) ERC721("NiftyBridgeErc721BaseUri", "NB") {
    ...
    modifier ownerOrManager() {
        require(
            isOwner() || (msg.sender == _manager && _manager != address(0))
        );
        _;
    }
    ...
    function create() external ownerOrManager returns (uint256 _id) {
        _tokenIds.increment();
