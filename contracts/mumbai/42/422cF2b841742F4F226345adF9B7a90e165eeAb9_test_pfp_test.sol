...
contract test_pfp_test is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
    uint256 public MAX_SUPPLY = 15;

    
    uint256 public PHASE_SUPPLY = 14;
    
    bool public IS_PHASE_ACTIVE = false;

    
    uint256 public PHASE_TX_LIMIT = 14;

    
    uint256 public PHASE_WALLET_LIMIT = 14;
    ...
    constructor() ERC721A("test_pfp_test", "TESTPFPTEST") {
