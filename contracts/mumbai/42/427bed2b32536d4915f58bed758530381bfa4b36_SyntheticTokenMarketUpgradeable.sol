  ...
  ERC20PermitUpgradeable
{
  ...
  bool public marketIsDeprecated;
  ...
  */
  ...
  /// @notice Burns user's tokens when market is deprecated.
  /// @param account The user who's tokens will get burned.
  /// @param amount The amount to burn.
  function burnWhenDeprecated(address account, uint256 amount) external override {
    require(msg.sender == market, "Only minter contract");
    require(marketIsDeprecated, "Only callable when market is deprecated");
  ...
  */
  function _beforeTokenTransfer(
    ...
    if (marketIsDeprecated) {
      ...
      IMarketTieredLeverage(market).executeOutstandingEpochSettlementsUser(sender);
    }
  ...
  */
  function balanceOf(address account) public view virtual override returns (uint256) {
    return
      ...
      IMarketTieredLeverage(market).getUsersConfirmedButNotSettledSynthBalance(
        account,
        poolType,
        poolTier
      );
  ...
  /// @notice When the market is deprecated the transfer function will fail because it will try call executeOutstandingEpochSettlementsUser, so we add an extra bool to _beforeTokenTransfer to check if the market is deprecated. This function sets that bool to true.
