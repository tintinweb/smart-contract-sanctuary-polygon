...
contract CertificateFactoryFacetUgrade {
    CertificateAddress internal cc;

    /// @dev function to return all cerificate address
    function returnCertificateAddress() external view returns(address[] memory){
        return cc.certficates;
    }
}
