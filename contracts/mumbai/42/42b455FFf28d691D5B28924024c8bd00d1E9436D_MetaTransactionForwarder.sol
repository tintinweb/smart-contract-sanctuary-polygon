...
contract MetaTransactionForwarder is
    Initializable,
    OwnableUpgradeable,
    EIP712Upgradeable
{
    ...
    function initialize() public initializer {
        __Ownable_init();
        __EIP712_init_unchained("MetaTransactionForwarder", "0.0.1");
    }

    function execute(
        ForwardRequest calldata req,
        bytes calldata signature
    ) public onlyOwner returns (bool success, bytes memory returndata) {
