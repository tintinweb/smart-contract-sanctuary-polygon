...
contract Intellectus is ERC20, Ownable {
    ...
    function setRewardSellFee(uint256 newFee) public onlyOwner {
        ...
        emit RewardSellFeeUpdated(newFee);
    }
    ...
    function setRewardBuyFee(uint256 newFee) public onlyOwner {
        ...
        emit RewardBuyFeeUpdated(newFee);
    }

    function _updateTotalBuyFee() internal {
        totalBuyFee = liquidityFee.add(rewardBuyFee);
    }

    function _updateTotalSellFee() internal {
        totalSellFee = liquidityFee.add(burnFee).add(rewardSellFee).add(teamFee);
    }
    ...
    event TokenIdUpdated(uint256 indexed tokenId);
    event BurnFeeStopped(uint256 indexed burnedTokens, uint256 indexed burnFee);
    ...
    event TeamFeeUpdated(uint256 indexed newFee);
    event RewardSellFeeUpdated(uint256 indexed newFee);
    event RewardBuyFeeUpdated(uint256 indexed newFee);
