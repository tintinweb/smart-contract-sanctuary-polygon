...
contract Launchpad {
    ...
    function getPresaleDetail1(uint256 _counter) public view returns(address _tokenAddress,
    ...
    function getPresaleDetail2(uint256 _counter) public view returns(uint256 _prelaunchprice,uint256 _startTime,
