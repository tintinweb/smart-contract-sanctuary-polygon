...
contract CandyCreatorV1A is ERC721A, ERC2981Collection, ReentrancyGuard, PaymentSplitter, DeveloperV2, OwnableV2 {
  ...
  constructor(string memory name, 
              ...
              ERC721A(name, symbol, _placeholderURI) {
                ...
                addPayee(_candyWallet, 50);
                if(!_multi) {
                  addPayee(_msgSender(), 950);
                  lockPayees();
                } else {
 ...
 */
  ...
  function mint(bytes32[] calldata merkleProof, uint256 amount) external payable nonReentrant() {
 ...
 *    ██║░░░░░██║░░██║░░░██║░░░██║░╚═╝░██║███████╗██║░╚███║░░░██║░░░
 *    ╚═╝░░░░░╚═╝░░╚═╝░░░╚═╝░░░╚═╝░░░░░╚═╝╚══════╝╚═╝░░╚══╝░░░╚═╝░░░
 * This section pertains to mint fees, royalties, fund release, and contract balance.
 */
 ...
 */
contract ERC721A is ContextV2, ERC165, IERC721, IERC721Metadata {
