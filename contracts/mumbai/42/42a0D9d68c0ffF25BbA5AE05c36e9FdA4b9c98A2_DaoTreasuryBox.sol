...
import "./interfaces/IDaoTreasuryBox.sol";
 ...
 */
contract DaoTreasuryBox is IDaoTreasuryBox, LockBox {
     ...
     * @param inGovToken The Token handled by this lockBox.
     * @param inTokenTransferProxy The TokenTransferProxy contract  address.
     */
    function init(
        IGovToken inGovToken,
        ...
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        ...
        grantRole(AccessHandler.TOKEN_ROLE, address(inGovToken));
...
contract LockBox is ILockBox, TokenValidator {
     ...
     */
    function initBox() external notInitialized {
        _init();
    }
