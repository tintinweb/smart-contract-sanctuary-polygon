...
contract NoteChain {
    ...
    function registerNewAuthor(string memory _authorName) external payable {
    ...
    function setAuthorName(string memory _newAuthorName) external payable requireRegisteredAuthor {
    ...
    function addNote(string memory _newNoteName, string memory _newNoteContent) external payable requireRegisteredAuthor {
    ...
    function editNote(uint256 _noteId, string memory _noteName, string memory _noteContent) external payable requireRegisteredAuthor {
