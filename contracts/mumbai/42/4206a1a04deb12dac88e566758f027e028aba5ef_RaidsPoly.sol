...
contract RaidsPoly {
    ...
    function setRaids() external {
        ...
        Raid memory hiddenCatacombOneDay = Raid({ minLevel:  180, maxLevel: 200,  duration:  24, cost: 110, grtAtMin: 0, grtAtMax: 500, supAtMin: 0, supAtMax: 500, regReward: 400, grtReward: 1200, supReward: 1600, minPotions: 2, maxPotions: 2});
        Raid memory hiddenCatacombInsta = Raid({ minLevel:  180, maxLevel: 200,  duration:  0, cost: 110, grtAtMin: 0, grtAtMax: 500, supAtMin: 0, supAtMax: 500, regReward: 400, grtReward: 1200, supReward: 1600, minPotions: 2, maxPotions: 2});
