...
contract SmartPayrollFactory {
  ...
  event UpkeepContractCreateAddress(address,uint256);
  ...
  // }
   ...
   uint256 _updateInterval
    ...
    SmartPayrollByTime smartPayrollByTime = new SmartPayrollByTime(_updateInterval);
    emit UpkeepContractCreateAddress(address(smartPayrollByTime),_updateInterval);
  }
