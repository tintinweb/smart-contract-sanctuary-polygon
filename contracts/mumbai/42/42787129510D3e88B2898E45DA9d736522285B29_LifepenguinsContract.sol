...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xc06cD0302dF646D6F09D07aE4b45B73598c4F975];
  address public erc20Payable = 0xc06cD0302dF646D6F09D07aE4b45B73598c4F975;
...
abstract contract Feeable is Teams, ProviderFees {
  uint256 public PRICE = 0.269 ether;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 8888) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmeYv62jHme2nqRDBVo8fDGcpn3BZ8GK8Y4ZjjWEhWyzaG/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/MwHh7GHvSMQECL1leQAD/contract-metadata";
  }
...
contract LifepenguinsContract is ERC721APlus {
    constructor() ERC721APlus("LIFE PENGUINS", "LFPenguins"){}
}
