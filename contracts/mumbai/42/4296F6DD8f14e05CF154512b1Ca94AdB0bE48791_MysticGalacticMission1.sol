...
contract MysticGalacticMission1 is ERC721, Ownable, Pausable, AccessControlEnumerable, ReentrancyGuard {
    ...
    /**
   * Returns the latest price in USD for 1 MATIC
   */
...
//
//        require(maticPrice > 0, "Invalid rate");
//
//        // uint256 rateWhole = uint256(rate) / 10 ** 8; // Convert to whole number
//
//        uint256 usdPriceDecimal = usdPrice / 1e10; // Convert to 8 decimal places
//        uint256 maticPriceDecimal = uint256(maticPrice) * 1e10; // Convert to 18 decimal places
//        //return usdPriceDecimal * 1e18 / maticPriceDecimal;
//        return usdPriceDecimal / maticPriceDecimal;
//
//        // Calculate the price in Wei, assuming the rate is given with 8 decimal places
//        // uint256 price = (usdPrice * rateUint) / 1e18;
//        // return usdPrice / uint256(rateWhole);
//    }
//
//
//    /**
