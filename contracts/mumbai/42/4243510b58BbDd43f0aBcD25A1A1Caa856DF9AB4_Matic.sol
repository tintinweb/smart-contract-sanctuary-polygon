...
contract Matic is Initializable{
 ...
 emit UserIncome(userAddress,referrerAddress,UserAllDetailByAddress[referrerAddress].holdAmount[level],level,"GlobalPool");
 ...
 emit UserIncome(userAddress,referrerAddress,UserAllDetailByAddress[referrerAddress].holdAmount[level],level,"Global Pool");
 UserAllDetailByAddress[referrerAddress].holdAmount[level]=0;
 }
 }
