...
contract FlashBot is Ownable {
    ...
    function flashArbitrage(
        ...
        Adjustments memory _adjustments = Adjustments({
            adjustmentPool: pairAddress,
            adjustmentToken0: tokenAddress0,
            adjustment0: token0Amount,
            adjustment1: token1Amount
        });
