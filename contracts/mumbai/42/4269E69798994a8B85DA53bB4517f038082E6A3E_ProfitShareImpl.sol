...
import { ERC4907ProfitShareUpgradeable } from "./test/ERC4907ProfitShareUpgradeable.sol";
...
contract ProfitShareImpl is ERC4907ProfitShareUpgradeable, AccessControlUpgradeable {
    ...
    function setUserProfitShare(
        ...
        require(lastExpires < block.timestamp, "ERC4907ProfitShare: cannot update user while active");
        super.setUserProfitShare(tokenId, user, expires, beneficiaries, split);
    }
