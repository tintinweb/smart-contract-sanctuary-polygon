...
contract VitaliVNFT is ERC721A, Ownable {
    ...
    constructor(
        string memory _uri,
        address payable _withdrawWallet) ERC721A("VitaliV NFT", "VVN") {
            baseURI = _uri;
    ...
    // mint by owner
    function Mint(address _receiver,uint256 quantity) external onlyOwner virtual {
    ...
    function DEV_TEAM() public pure returns (string memory web_url) {
        web_url = "https://theartcode.space";
    }
