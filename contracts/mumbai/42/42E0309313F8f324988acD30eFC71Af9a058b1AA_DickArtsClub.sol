// SPDX-License-Identifier: MIT
    ...
    contract DickArtsClub is ERC721, Ownable, ERC721Enumerable {
      ...
      constructor() ERC721("Dick Arts Club", "DAC") {}
      ...
      function mintDick(uint256 numberOfTokens) external payable {
      ...
      function presaleDick(uint256 numberOfTokens) external payable {
        ...
        returns (string memory)
      {
        ...
        if (isRevealed == false) {
          return
            "ipfs://QmXhBq5EXyushg9XPf9FgeHLWzo5vMzmNGdEGUcdAtZ4pq/hidden.json";
        }
