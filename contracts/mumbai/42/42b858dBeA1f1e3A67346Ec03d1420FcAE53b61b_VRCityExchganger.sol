...
contract VRCityExchganger is Ownable, ReentrancyGuard {
    ...
    function swapToken(address tokenIn, uint256 amountIn)
        external
        nonReentrant
        returns (uint256 amountOut)
    {
        require(
            IUniswapV3Factory(IPeripheryImmutableState(swapRouter).factory())
        ...
        uint256 amountUSDC = ISwapRouter(swapRouter).exactInput(
