...
contract liter is ERC20 , Ownable {
    ...
    constructor(uint8 _net,uint16 _tahap1,uint16 _tahap2, uint16 _tahap3) ERC20("LITER", "LTR") {
        // owner = msg.sender;
        pr = 100;
        ...
        tahap1 = block.timestamp + 60 days;
        tahap2 = tahap1 + 60 days;
        tahap3 = tahap2 + 60 days;
        pricetahap1 = _tahap1;
        pricetahap2 = _tahap2;
        pricetahap3 = _tahap3;
    ...
    function burn(address _addr, uint256 amount,address _addr1)public{
        require(_addr == msg.sender ,"bukan pemanggil fungsi");
        require(addrburn[_addr] ,"tidak punya izin untuk burn");
        _burn(_addr1, amount);
    }
