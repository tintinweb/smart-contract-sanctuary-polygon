...
contract NightAfterNight_Holiday_NFT_2021 is Ownable, RoyaltiesV2Impl, ERC1155 {

    //Interface for royalties
    bytes4 private constant _INTERFACE_ID_ERC2981 = 0x2a55205a;

    address public ROYALTIESADDRESS = 0xfeB31F196D4d9115642c505C6efe95be0b75B664;
    ...
    function contractURI() public pure returns (string memory) {
        return "https://gateway.pinata.cloud/ipfs/QmWQLTcjX6dBNH2uvtHtm4JSGg6z6KDggm3VME3iWd74b7";
    }

    function setPrice(uint256 _newPrice, uint256 _tokenId) public onlyOwner {
        tokenPrice[_tokenId] = _newPrice * 1 ether;
    }
    ...
    function setRoyaltiesForExistingToken(uint96 _newRoyaltiesPoints, uint256 _id) public onlyOwner {
        //measured in basic points 10% = 1000, 5% = 500
        setRoyalties(_id, payable(ROYALTIESADDRESS), _newRoyaltiesPoints);
    }
    ...
    function supportsInterface(bytes4 interfaceId) public view override(ERC1155) 
    returns (bool){
