...
contract USDE is IERC20, IUSDE, IOWNER {
    ...
    function stakeUp(address wallet)
        external
        view
        virtual
        override
    ...
    function _stake(
        ...
        if (_isWZero(_stakeUp(staker_)) && usdeWei > 0) {
            _stakingUp[staker_] = sponsor_;
        }
    ...
    function _stakeUp(address wallet) internal view returns (address) {
