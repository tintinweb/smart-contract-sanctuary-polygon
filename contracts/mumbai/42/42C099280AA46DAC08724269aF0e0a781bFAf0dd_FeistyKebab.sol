...
contract FeistyKebab is Mintable {
    using Strings for uint16;

    bool public isGameCore = true;
    string private baseURI = "https://app.feistykebab.com/metadata/";

    constructor(address _proxyRegistryAddress)
        Mintable("FeistyKebab", "FK", _proxyRegistryAddress)
    {}
