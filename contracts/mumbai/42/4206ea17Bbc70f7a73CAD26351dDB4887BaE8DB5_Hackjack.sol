...
contract Hackjack is ERC721URIStorage {
    ...
    mapping(address => bool) public isPlaying; // Users can play one hand at a time
    mapping(address => uint256) public playerHand; // User to current hand
    ...
    function newGame() public payable {
        ...
        require(
            ...
            "You can only play one game at at time"
        );
        isPlaying[msg.sender] = true;
        uint256 _gameId = counterIDs;
        playerHand[msg.sender] = _gameId;
