...
contract UserProfiles {
    ...
    */
    ...
    // Set an NFT as your profile photo (only for users / not groups)
    function setAvatar(string calldata imageURI, address _nftContract, uint256 tokenId, string calldata metadata, uint256 _networkID) public onlyApproved {
        // Save the token metadata
        ...
        usrProfileMap[msg.sender].userAvatar.networkID = _networkID;
    }
