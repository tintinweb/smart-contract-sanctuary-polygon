...
contract ArrcV1 is ERC20, Ownable { 
    ...
    constructor(address rewards_address, address safe_address) ERC20("ARRC", "Arrland coin-V1") {
        _mint(safe_address, 249000 * 10 ** decimals());
        _mint(rewards_address, 1000 * 10 ** decimals());        
    }
