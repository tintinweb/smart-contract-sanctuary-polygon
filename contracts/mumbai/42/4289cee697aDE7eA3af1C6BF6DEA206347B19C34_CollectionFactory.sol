...
contract CollectionFactory is Initializable, OwnableUpgradeable, PausableUpgradeable {
    ...
    function createCollection(
        ...
        Niftyco721 collection = new Niftyco721();
        collection.initialize(name, symbol, contractUri, baseUri, royalty, msg.sender);
    ...
    Role
{
    ...
    function setBaseURI(string memory baseUri) external whenNotPaused onlyRole(DEFAULT_ADMIN_ROLE) {
        _baseUri = baseUri;
    }
