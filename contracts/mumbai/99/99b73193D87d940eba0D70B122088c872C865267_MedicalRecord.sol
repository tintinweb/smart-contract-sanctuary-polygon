...
contract MedicalRecord is ERC721URIStorage, Pausable, Ownable {
    ...
    function getTokenURI(uint256 tokenId, string memory base64SVGString)
        public
        pure
    ...
    function mint(address _toAddr, string memory base64SVGString, string memory _email)
        public
        onlyOwner
    {
        require(
        ...
        require(
            bytes(base64SVGString).length != 0 && bytes(_email).length != 0,
