    ...
    ERC1155Holder
{
    ...
    */
    ...
    function transferBoxOwnerShip(uint256 boxId, address transferAddress) public isOpenForSwap {
        ...
        require(offeredList[boxId].length == 0, "You must withdraw all offers");
    ...
    */
    ...
    function createBox(
        ...
        if(state == 1){
            require(
                msg.value == createFees + _gasTokenDetails + swapConstantFees[1] + prePaid_nft_gas_Fees + boxroyaltyFees + _gasTokenDetails, "Insufficient Creating Fee"
            );
        } else {
            require(
                msg.value == createFees + _gasTokenDetails + swapConstantFees[2] + prePaid_nft_gas_Fees + boxroyaltyFees + _gasTokenDetails, "Insufficient Offering Fee"
            );
        }
