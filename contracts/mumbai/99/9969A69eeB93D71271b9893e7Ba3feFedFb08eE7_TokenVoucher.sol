...
contract TokenVoucher is Context, AccessControl {
  //used in redeem()
  ...
  function create(
    ...
    //make a voucher
    vouchers[++lastId] = Voucher(contractId, contractAddress, owner, amount);
    //emit an event
    emit Created(lastId, contractId, contractAddress, owner, amount);
  }
  ...
  function redeem(
    ...
    if (redeemed[voucherId] || !hasRole(SIGNER_ROLE, ECDSA.recover(
