                ...
                Base64.encode(
                    bytes(
                        abi.encodePacked(
                            ...
                            '", "attributes": [',
                            '{"trait_type": "character_class", "value": "', uri_details.name,'"}, {"trait_type": "strength", "value": "', abi.encodePacked(character_props.str),'"}, {"trait_type": "vitality", "value": "', abi.encodePacked(character_props.vit),'"}, {"trait_type": "dexterity", "value": "', abi.encodePacked(character_props.dex),'"}, ',
                            '{"trait_type": "experience", "value": "', abi.encodePacked(character_props.exp),'"}, {"trait_type": "element", "value": "', CharacterLibrary.getElement(character_props.element),'"}, {"display_type": "boost_percentage", "trait_type": "',CharacterLibrary.getTalent(character_props.talent),'", "value": 10}, {"trait_type": "mood", "value": "',uri_details.mood,'"}',
                            ']}'
                        )
                    )
                )
...
library CharacterLibrary {
    function getCharacter(uint32 character_class, uint32 mood) internal pure returns (character_uri_details memory character){
        string memory image_url = "ipfs://bafybeig2zoemwtcpybdaluyaxdw4jiifqfyiqwdxwbt3xonnabxkvlypde/";
    ...
    function getMood(uint32 mood) internal pure returns (string memory mood_tag){
        ...
        if(mood == 3){mood_tag = "Furious";}
        if(mood == 4){mood_tag = "Irritated";}
        if(mood == 5){mood_tag = "Mocking";}
        if(mood == 6){mood_tag = "Sad";}
        if(mood == 7){mood_tag = "Scared";}
        if(mood == 8){mood_tag = "Stunning";}
        if(mood == 9){mood_tag = "Talking";}
        if(mood == 10){mood_tag = "Thoughtful";}
        if(mood == 11){mood_tag = "Upset";}
    }
