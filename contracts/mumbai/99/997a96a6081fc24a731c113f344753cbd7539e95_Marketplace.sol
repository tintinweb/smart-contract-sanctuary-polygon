...
contract Marketplace {
    ...
    function mint(address _user, uint256 _mintAmount) public {
        require(nft.balanceOf(msg.sender) + _mintAmount <= 3, "Cannot mint more that 3 NFTs with 30% rarities");
    ...
    function mintDiamond(address _user) public {   
        require(nft.balanceOf(msg.sender) < 4, "You've already minted all rarities");
