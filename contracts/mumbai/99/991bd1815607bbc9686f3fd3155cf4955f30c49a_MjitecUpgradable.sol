...
contract MjitecUpgradable is UUPSUpgradeable, ERC721EnumerableUpgradeable, ERC2981, OwnableUpgradeable, ContextMixin, ReentrancyGuardUpgradeable {
...
//   uint256 public currentPhaseMintMaxAmount = 110;
  ...
  function initialize(
    ...
    __MJITEC_init(_initBaseURI, _initNotRevealedUri, _contractURI);
  }
  ...
  function supportsInterface(bytes4 interfaceId) public view virtual override(ERC2981, ERC721EnumerableUpgradeable) returns (bool) {
