...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x52dA6E5AEa0Ca3dFBD938938d5f83eD561920059];
  address public erc20Payable = 0x52dA6E5AEa0Ca3dFBD938938d5f83eD561920059;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 11, 5000) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://maxwelladen.xyz/montecarlo/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/CmHLdOZmIBF0YFTOZjq1/contract-metadata";
  }
...
contract MyMintplexProjectContract is ERC721APlus {
    constructor() ERC721APlus("My Mintplex Project", "TEST"){}
}
