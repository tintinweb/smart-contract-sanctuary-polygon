...
contract PolygonLPBank is ReentrancyGuardUpgradeable, PausableUpgradeable, OwnableUpgradeable {
    ...
    /**
     * @notice Owner can set the LP token contract(IERC20Upgradeable)
     * @param _token Address of the new LP token
     */
    function setLPTokenTokenContract(IERC20Upgradeable _token) external onlyOwner {
        lpToken = _token;
    }
