...
/**
 * @title MockERC20PermitDai
 * @author Hysland Finance
 * @notice A mock ERC20 token used to test other contracts. Also has an old version of the `ERC2612` permit extension.
 */
contract MockERC20PermitDai is IERC20PermitDai, ERC20 {
