...
// File: contracts/LeagueX/LeagueXBallzTest.sol
    ...
    ERC1155PausableUpgradeable
{
    ...
    function initialize() public initializer {
        ...
        ownerAddress = 0x4D00C0759d677DDe7ec37b530e947Ce96dB9b96d;
        baseExtension = ".json";
        cost = 0.00 ether;
    ...
    event Mint(uint256 tokenId, string uri, address tokenOwner, LXTBallz newNFT);
...
// Compliance
    ...
    modifier mintCompliance(uint256 _mintAmount, uint256 Royalty) {
        ...
        require(
            ...
            "LXTBallz: Percentage not sufficient, min is 0.01, max is 100"
        );
        _;
    }
...
// All Write Functions
    ...
    function mint(
    ...
    ) public payable virtual mintCompliance(mintAmount,1)  {
        ...
        for (uint256 i = 0; i < mintAmount; i++) {
            ...
            creator[nextTokenId] = ownerAddress;
            nftOwner[nextTokenId] = msg.sender;
            royalty[nextTokenId][msg.sender] = 1;
            emit Mint(nextTokenId, tokenURI, nftOwner[nextTokenId], newNft);
            nextTokenId++;
            tokensInCirculation++;
        }
    }
    ...
    function mintBatch(
        ...
        for (uint256 i = 0; i < ids.length; i++) {
            ...
            nftOwner[ids[i]] = msg.sender;
            royalty[ids[i]][msg.sender] = 1;
            emit Mint(ids[i], tokenURI, nftOwner[ids[i]], newNft);
        }
    }
