...
abstract contract MasterMessageHandler is IMaster, MasterModifiers, MasterEvents {
    ...
    function redeemAllowed(
        ...
        (, uint256 shortfall) = _getHypotheticalAccountLiquidity(
            ...
            params.pToken,
            params.amount,
            (FLAG_CURRENT_MAX + FLAG_WITHDRAW)
        );
        //if approved, update the balance and fire off a return message
        // slither-disable-next-line incorrect-equality
        if (shortfall == 0) {
...
abstract contract MasterStorage {
    ...
    */
    ...
    // flags = FLAG_COLLATERAL_FACTOR + FLAG_OPERATION
    uint256 internal constant FLAG_TOTAL = 0x01;
    uint256 internal constant FLAG_CURRENT_MAX = 0x02;
    uint256 internal constant FLAG_LIQUIDATE = 0x04;
    uint256 internal constant FLAG_DEPOSIT = 0x08;
    uint256 internal constant FLAG_WITHDRAW = 0x10;
    uint256 internal constant FLAG_BORROW = 0x20;
    uint256 internal constant FLAG_REPAY = 0x40;
}
