...
contract PanamaCanal is GameManager, TreasuryManager, VRFManager, ERC2771Context, AccessControlEnumerable {
    ...
    function removePlayerFromGame(address _player) public override onlyRole(GAME_MANAGER) {
        ...
        require(gameId != 0, "resetPlayerInGame: player not in game");
