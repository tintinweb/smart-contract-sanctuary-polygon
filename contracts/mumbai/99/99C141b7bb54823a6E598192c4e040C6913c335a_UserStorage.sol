...
contract UserStorage {
    ...
    // function getActiveUsers() external onlyOwner returns (int256) {
    //     return activeUsers;
    // }

    // function getDeletedUsers() external onlyOwner returns (int256) {
    //     return deletedUsers;
    // }
    ...
    // function getSomething(address userAddress)
    //     external
    //     onlyOwner
    //     returns (address)
    // {
