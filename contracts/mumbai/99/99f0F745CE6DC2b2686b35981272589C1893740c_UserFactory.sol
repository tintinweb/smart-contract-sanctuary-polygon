...
interface IUser is IYousovStructs {
    ...
    function checkWalletPassword(string memory walletPassword) pure external  returns (bool validPassword , Wallet memory wallet);
    event SecretUpdated();
...
contract User is IUser {
    ...
    function checkWalletPassword(string memory walletPassword) pure external override returns (bool validPassword , Wallet memory wallet) {

        if (keccak256(abi.encodePacked(walletPassword )) == keccak256(abi.encodePacked(wallet.walletPassword )) ) {
            return (true, wallet);
        }
        else{
