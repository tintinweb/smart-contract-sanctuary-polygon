...
contract BountyPayment is FunctionsClient {
    ...
    function createBounty(
        ...
        require(msg.value >= bountyAmount, "Insufficient ETH to create the bounty");
    ...
    function applyToBounty(uint256 bountyId, string calldata githubUsername, address walletAddress) external payable {
        ...
        BountyContributor memory contributor;
        contributor.username = githubUsername;
        contributor.walletAddress = walletAddress;
    }
