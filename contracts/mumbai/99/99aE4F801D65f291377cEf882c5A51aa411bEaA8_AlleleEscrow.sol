...
interface IAlleleEscrow {
    ...
    event OrderCreated(uint256 indexed orderID, uint256 indexed tokenID, uint256 indexed generation, uint256 marketID, address buyer, address seller, uint256 amount, uint256 price, string marketURI);
