    ...
    IERC2981
{
    ...
    function _validatePublicMint(
        ...
        require(phaseStates[phaseIndex].totalMinted + quantity <= phases[phaseIndex].maxPerPhase, "Exceeds phase supply");
    ...
    function validatePublicMint(
        ...
        if (phaseStates[phaseIndex].totalMinted + quantity > phases[phaseIndex].maxPerPhase)
            return "Exceeds phase supply";
