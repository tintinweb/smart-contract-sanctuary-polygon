...
contract SC2 is Ownable, OverflowToken, IAxelarExecutable {
    ...
    address private _BUSDADDRESS = 0x4A0D1092E9df255cf95D72834Ea9255132782318; //testnet
    ...
    address private stargateRouter = 0x13093E05Eb890dfA6DacecBdE51d24DabAb2Faa1;
    ...
    uint256 public gasfee = 100000000000000;
    ...
    function _execute (
        ...
        sellOrderForEABCD_Bridge(10012, amount, balance, sourceChain_, walletAddress );
    }


    function sellOrderForEABCD_Bridge(uint16 destinationId, uint amount, uint256 balance, string memory destinationChain, address walletAddress) public {
        // uint256 balanceForBUSD = IBEP20(_BUSDADDRESS).balanceOf(address(this));
        // uint256 tokenPriceWithOracle = ISC3(_SC3ADDRESS).getAssetPrice();
        ...
        // require(balanceForBUSD > BUSD_For_eABCD, "Insufficient Fund");
        IBEP20(_BUSDADDRESS).approve(stargateRouter, amount);
