...
contract PolyDropsFaucet {
	...
	uint256 constant public CONTRIBUTE_MIN_AMOUNT = 1e17; // 0.1 Matic  
	...
	uint256 constant public PROJECT_FEE = 1;
	...
	function Contribute(address referrer, uint8 plan) public payable {
		...
		require(msg.value >= CONTRIBUTE_MIN_AMOUNT);
		...
		totalContribute = totalContribute.add(msg.value);
	...
	function getSiteInfo() public view returns(uint256 _totalInvested, uint256 _totalBonus) {
		return(totalContribute, totalRefBonus);
	}
