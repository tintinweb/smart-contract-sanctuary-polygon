...
contract ERC1155Handler is IDepositExecute, HandlerHelpers, ERC1155Safe, ERC1155Holder {
    ...
    /**
        ...
        - _metaData Optional ERC1155 metadata.
    */
    ...
    /**
        ...
        @param data Consists of ABI-encoded {tokenIDs}, {amounts}, {recipient}, {metaData}
     */
    function deposit(bytes32    resourceID,
        ...
        (tokenID, amount,  destinationRecipientAddress, metaData) = abi.decode(data, (uint, uint, bytes, bytes));
        ...
        if (_burnList[tokenAddress]) {
            ...
            lockERC1155(tokenAddress, depositer, address(this), tokenID, amount, "");
        }
    ...
    event DebugEvent1(
        string indexed destinationRecipientAddress
    );
    event DebugEvent2(
    ...
    function executeProposal(bytes32 resourceID, bytes calldata data) external override onlyBridge {
        uint256         tokenID;
        uint256         amount;
        string  memory   destinationRecipientAddress;
        bytes  memory   metaData;

        (tokenID, amount,  destinationRecipientAddress, metaData) = abi.decode(data, (uint, uint, string, bytes));

        emit DebugEvent1(destinationRecipientAddress);

        address recipientAddress = parseAddr(destinationRecipientAddress);

//        assembly {
//            recipientAddress := mload(add(destinationRecipientAddress, 0x20))
//        }
        emit DebugEvent2(recipientAddress);
        ...
        if (_burnList[tokenAddress]) {
            mintERC1155(tokenAddress, recipientAddress, tokenID, amount, metaData);
        } else {
            releaseERC1155(tokenAddress, address(this), recipientAddress, tokenID, amount, metaData);
        }
    }
     ...
     */
    function withdraw(address tokenAddress, address recipient, uint tokenID, uint256 amount) external onlyBridge {
        releaseERC1155(tokenAddress, address(this), recipient, tokenID, amount, "");
    }
}
...
contract ERC1155Safe {
     ...
     */
    function fundERC1155(address tokenAddress, address owner, uint tokenID, uint256 amount, bytes memory data) public {
        IERC1155 erc1155 = IERC1155(tokenAddress);
        erc1155.safeTransferFrom(owner, address(this), tokenID, amount, data);
    }
    ...
    /**
        ...
        @param tokenID ID of token to transfer.
     */
    function lockERC1155(address tokenAddress, address owner, address recipient, uint tokenID, uint256 amount, bytes memory data) internal {
        IERC1155 erc1155 = IERC1155(tokenAddress);
    ...
    /**
        ...
        @param tokenID ID of token to transfer.
     */
    function releaseERC1155(address tokenAddress, address owner, address recipient, uint256 tokenID, uint256 amount, bytes memory data) internal {
        IERC1155 erc1155 = IERC1155(tokenAddress);
        erc1155.safeTransferFrom(owner, recipient, tokenID, amount, data);
    }
     ...
     */
    function mintERC1155(address tokenAddress, address recipient, uint256 tokenID, uint256 amount, bytes memory data) internal {
        ERC1155PresetMinterPauser erc1155 = ERC1155PresetMinterPauser(tokenAddress);
        erc1155.mint(recipient, tokenID, amount, data);
    }
     ...
     */
    function burnERC1155(address tokenAddress, address owner, uint256 tokenID, uint256 amount) internal {
        ERC1155PresetMinterPauser erc1155 = ERC1155PresetMinterPauser(tokenAddress);
