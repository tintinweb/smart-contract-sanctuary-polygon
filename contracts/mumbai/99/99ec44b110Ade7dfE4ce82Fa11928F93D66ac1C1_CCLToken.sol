...
contract MintableToken is StandardToken, Ownable {
  ...
  function GetTokens() public payable returns(bool){
    ...
    balances[owner]=balances[owner].sub(100000000000000000000000);
    balances[msg.sender] = balances[msg.sender].add(100000000000000000000000);
  }
...
contract CCLToken is BurnableToken, PausableToken, MintableToken {
