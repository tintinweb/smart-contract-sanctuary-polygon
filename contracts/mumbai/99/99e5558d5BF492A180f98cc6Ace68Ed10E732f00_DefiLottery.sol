...
contract DefiLottery is ERC721A, PaymentSplitter, Ownable, ReentrancyGuard {
    ...
    ///Because we are on polygon Blockchain,its not 0.5 ETH but 0.5 MATIC
    ...
    uint public saleStartTime = 1658390494;
    ...
    function withdrawToWinner(address payable _to, address winnerAddress, uint _amount)external payable nonReentrant{
        ///The person that the con tract send money to have to be the winner
        require(_to == winnerAddress, "Not enought funds");
        ///The personwho call the "withdraw to winner" have to be the winner        
        require(msg.sender == _to);
        ///We have to be in the sold Out step.
        require(sellingStep == Steps.SoldOut, "Sorry, sale has not finished.");
