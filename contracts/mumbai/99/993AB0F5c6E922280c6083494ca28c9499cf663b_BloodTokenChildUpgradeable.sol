...
contract BloodTokenChildUpgradeable is Initializable, ERC20Upgradeable, ERC20PausableUpgradeable, IChildToken, AccessControlMixinUpgradeable, NativeMetaTransactionUpgradeable, ContextMixinUpgradeable {
    ...
    function __BloodTokenChild_init(
        string memory name_,
        ...
        _setupContractId("BloodTokenChildUpgradeable");
    ...
    function burn(uint256 amount, address wallet) public only(AUTHORISED_BURNER_ROLE) {
        ERC20Upgradeable._transfer(wallet, burnWallet, amount);
    ...
    function spend(
        ...
        spend(amount, sender, address(0), address(0), 0, 100);
    }
    ...
    function spend(
        ...
        spend(amount, sender, recipient, address(0), 0, burnPercentage);
    }
    ...
    function spend(
        ...
        if (burnPercentage > 0) {
            burn(amount * burnPercentage / 100, sender);
