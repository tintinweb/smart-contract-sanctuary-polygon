...
contract Pigs is ERC721A, Ownable, ERC721Holder {
  uint256 constant _maxSupply = 10000;
  bool public isSaleActive;

  constructor() ERC721A("Pigs", "PIG") {}
  ...
  function onERC721Received(address, address to, uint256 tokenId, bytes memory) public virtual override returns (bytes4) {
