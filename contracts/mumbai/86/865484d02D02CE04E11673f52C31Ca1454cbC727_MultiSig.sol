...
contract MultiSig is Ownable {
    ...
    function requestChangeSigners(address _signer1, address _signer2) public onlyOwners {
        ...
        prevSignerForSigners = msg.sender;
    ...
    function approveChangeSigners() public onlyOwners {
        require(prevSignerForSigners != msg.sender, "You are first signer for this transaction");
        require(
            change_admin_status == 1,
    ...
    function getCurrentChangeAdminStatus()
        public
        view
        returns (address _new_signer1, address _new_signer2, uint8 _change_admin_status, address _prevSigner)
    {
        return (new_signer1, new_signer2, change_admin_status, prevSignerForSigners);
    }
}