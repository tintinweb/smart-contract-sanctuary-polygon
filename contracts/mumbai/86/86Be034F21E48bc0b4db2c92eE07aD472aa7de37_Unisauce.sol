...
contract Unisauce {
    ...
    bool optionActivated;

    // Hardcoded ether price in terms of dai
    uint256 etherPrice = 1000 * 1e18;
    ...
    {
        owner = msg.sender;
        // contract creater will be the initial covered call option sellers
        optionSeller = seller;
        nonfungiblePositionManager = _nonfungiblePositionManager;
        // hardcoded the option premium to 50 DAI
        optionPremium = 50 * 10e18;
    ...
    function sellCoveredCall(
        ...
        require(msg.sender == optionSeller, "Invalid option seller");
    ...
    function buyCoveredCall() external {
        require(optionActivated == false, "Option already purchased");
    ...
    // TODO: Fetch ether price in terms of dai from oracle
    function getEtherPriceFromOracle() public view returns(uint256) {
        return etherPrice;
    }
    ...
    //     require(block.timestamp > Expiry, "Please wait till the option expires");
    // }
