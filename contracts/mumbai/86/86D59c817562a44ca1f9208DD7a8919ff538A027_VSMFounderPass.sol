...
contract VSMFounderPass is URISwitchable, ERC721, AccessControl, Ownable {  
    ...
    constructor(address[] memory operators, bool approveProxy, address[] memory proxies) ERC721("VSM01", "VSM_01") {
