...
contract VoidLife is ReentrancyGuard, ERC721Enumerable, Ownable {
    ...
    uint256 public constant maxMintAmount = 100;
    bool public paused = false;
    mapping(address => bool) public whitelisted;


    constructor() ERC721("Void Life", "VL") {}
    ...
    function teamMint(address _to, uint256 _mintAmount) external onlyOwner {
