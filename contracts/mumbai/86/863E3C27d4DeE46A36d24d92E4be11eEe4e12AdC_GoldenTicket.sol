...
contract GoldenTicket is ERC721, Ownable, ReentrancyGuard {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(currentBaseURI).length > 0
            ? string(abi.encodePacked(
                '{"name": "Golden Ticket #',
                tokenId.toString(),
                '", "description": "A Ticket To Your Future.", "image": "ipfs://QmRH3jr44m1qsGcTU4mPmc2Ahyn1Li5weBWazNJRMMjSwe/1.png", "attributes": []}'
            ))
            : "";
    }
    ...
    function toggleSaleEnabled() external onlyOwner {
    ...
    function mint() external payable nonReentrant {
        ...
        (bool success, ) = payable(owner()).call{value: royaltyAmount, gas: gasLimit_}("");
