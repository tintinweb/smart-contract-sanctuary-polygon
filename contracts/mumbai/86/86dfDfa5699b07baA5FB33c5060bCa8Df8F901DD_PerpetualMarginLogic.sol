    ...
    IPerpetualMarginLogic
{
    ...
    function _depositMarginForOpeningTrade(
        ...
        if (_order.traderAddr != address(this)) {
            activeAccounts[_order.iPerpetualId].add(_order.traderAddr);
        }
        ...
        emit TokensDeposited(_order.iPerpetualId, _order.traderAddr, _fDepositRequired);
        return true;
    }
    ...
    function _isDepositAllowed(
        ...
        require(balance >= ufAmountD18, "balance not enough");
        uint256 allowance = marginToken.allowance(_userAddr, address(this));
        require(allowance >= ufAmountD18, "allowance not enough");
    }
