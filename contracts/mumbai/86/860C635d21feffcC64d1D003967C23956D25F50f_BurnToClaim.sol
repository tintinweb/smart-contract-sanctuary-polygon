...
contract BurnToClaim is ERC721LazyMint {
    ...
    function verifyClaim(address _claimer, uint256 _quantity)
        ...
        override
        {
            require(mainNFT.balanceOf(_claimer) >= _quantity, "You don't own enoungh of the main NFT");
            require(burnNFT.balanceOf(_claimer, 0) >= _quantity, "You don't own enoungh of the burn NFT");
        }
