    ...
    IERC721ReceiverUpgradeable
{
    ...
    function rentingOrbitalTrack(
        ...
        (bool isInvited, ) = starOrbitalTrackLogicContract
        ...
        starOrbitalTrackLogicContract.checkSlotCanBeRent(
            msg.sender,
    ...
    function _detachingPlanet(
        ...
        if (
            ...
            planetCooldown = block.timestamp + detachCooldown;
        ...
        if (
            ...
            obCooldown = block.timestamp + detachCooldown;
        }
