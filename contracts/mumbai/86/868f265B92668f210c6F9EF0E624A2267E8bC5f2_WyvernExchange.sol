...
contract ExchangeCore is ReentrancyGuarded, StaticCaller, EIP712 {
    ...
    event OrdersMatched     (bytes32 firstHash, bytes32 secondHash, address indexed firstMaker, address indexed secondMaker, bytes staticExtradata);
    // event OrdersMatched     (bytes32 firstHash, bytes32 secondHash, address indexed firstMaker, address indexed secondMaker, uint newFirstFill, uint newSecondFill, bytes32 indexed metadata, address x);
        ...
        reentrancyGuard
    {
        ...
        /* Log match event. */
        emit OrdersMatched(firstHash, secondHash, firstOrder.maker, secondOrder.maker, secondOrder.staticExtradata);
    }
