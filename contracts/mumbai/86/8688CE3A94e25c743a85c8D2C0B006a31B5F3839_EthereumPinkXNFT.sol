...
contract EthereumPinkXNFT is ERC721, Ownable {
    ...
    function convertEthereumToMatic() public view returns (uint256) {
        ...
        uint256 ethValue;
        uint256 ethereumPinkValue;
        uint256 ethereumPinkValueInMATIC;
        uint256 maticValue;
        ...
        ethereumPinkValue = ethValue / 100; // 1 ETH Pink value in USD
        maticValue = ((10**18) * uint256(maticPrice)) / maticDecimals; // ETH value in USD
        finalMaticValue = (((10**18) * ethValue) / maticValue) * (1 ether);
        ethereumPinkValueInMATIC = (finalMaticValue / 10**18) / 100; // 1 ETH Pink value in MATIC
        return ethereumPinkValueInMATIC;
    }
}