    ...
    AssetClassRegistryStorage
{
     ...
     */
    bytes4 private constant _SELF_KEY = bytes4(keccak256("AssetClassRegistry"));
    ...
    function supportsInterface(bytes4 interfaceId) public view override(IERC165, ERC165) returns (bool) {
        return
            interfaceId == type(IAssetClassRegistry).interfaceId ||
            interfaceId == type(IContractEntity).interfaceId ||
