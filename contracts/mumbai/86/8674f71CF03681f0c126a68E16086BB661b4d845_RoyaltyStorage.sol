...
contract RoyaltyStorage is Ownable{
    ...
    constructor(address _marketplace, address _platformLazyNFT){
    ...
    function setAddresses(address _marketplace, address _platformNFT) external onlyOwner{
        platformLazyNFT= _platformNFT;
        marketplace = _marketplace;
    }
