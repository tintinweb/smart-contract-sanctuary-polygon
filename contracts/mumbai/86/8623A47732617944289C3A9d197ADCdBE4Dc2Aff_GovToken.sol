 ...
 */
contract GovToken is IGovToken, ERC20Burnable, AccessHandler {
     ...
     */
    constructor(address inToken, string memory inName, string memory inSymbol) Initializable() ERC20(inName, inSymbol) {
        tokenAdd = inToken;
     ...
     * @param tokenHandler is the address that gets the Minter/Burnet role.
     */
