...
contract CoolXClonesGiveawayTool is VRFConsumerBaseV2, Ownable {
    ...
    uint public listLength = 56;

    address[56] public addressList = [
        ...
        address(0xD06c350939e90795C63e5BeC3C981D7A2c9ed6E7),
    ...
    function rollDice(string memory meta) public onlyOwner returns (uint256 requestId) {
