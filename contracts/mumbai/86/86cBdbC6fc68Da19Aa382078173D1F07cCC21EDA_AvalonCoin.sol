...
// File: contracts/Najim.sol

pragma solidity ^0.6.2;

  
  contract AvalonCoin is ERC20 {
   
      constructor () public ERC20("AvalonCoin", "AVC") {
             _mint(msg.sender, 100000000000000000000000 * (10 ** uint256(decimals())));
                }
