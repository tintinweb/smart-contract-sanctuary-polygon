...
contract DynamicVaults is IDynamicVaults, OwnableUpgradeable, PausableUpgradeable {
  ...
  */
   ...
   * @param tokens The tokens to be transferred
   */
  function repossessAccount(address owner, address[] memory tokens) external onlyBackup(dynamicVaults[owner]) {
    Types.DynamicVault storage dynamicVault = dynamicVaults[owner];
    for (uint256 i = 0; i < tokens.length; i++) {
      ERC20 token = ERC20(tokens[i]);
   ...
   * @return beneficiariesNames The names of the beneficiaries
   * @return beneficiariesAddresses The addresses of the beneficiaries
   * @return beneficiariesInheritancePercentages The inheritance percentages of the beneficiaries
   */
 ...
 */
   ...
   * @notice Transfers the tokens to the beneficiaries
   * @param owner The owner of the dynamic vault
   * @param tokens The tokens to transfered
   * @dev The function can only be called after the inactivity period is over
   */
  function succeed(address owner, address[] memory tokens) external;
   ...
   * @param tokens The tokens to transfered
   */
  function repossessAccount(address owner, address[] memory tokens) external;
