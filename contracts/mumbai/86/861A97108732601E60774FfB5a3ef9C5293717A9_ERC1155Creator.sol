...
contract ERC1155Creator is ERC1155, Ownable {
    ...
    mapping (uint256 => uint256) NFTmintedForId;
    ...
    function generateNFT(uint256 _expiringTimeInDays) external onlyOwner returns (uint256 _idGenerated) {
        _idGenerated = id;
        id++;
