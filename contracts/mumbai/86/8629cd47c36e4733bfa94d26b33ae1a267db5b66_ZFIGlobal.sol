...
contract ZFIGlobal {
    ...
    address payable feeReceiver = 0xbF27627c16c20c1d3806EB650edAf10ECEd96CBC;
    address payable feeReceiver2 = 0x27F906e7512A7b798f3443c5cbfF688729b4de75;
    address payable feeReceiver3 = 0xe2D7cAA88b391932Cb3397886015e8567795974f;
    ...
    function deposit(uint256 _amount) external payable {
        ...
        require(msg.value>=minDeposit, "Invalid Package.");
    ...
    function _deposit(address _user, uint256 _amount) private {
        ...
        if(userInfo[_user].myLastDeposit==0){
            userInfo[_user].incomeArray[7]=10000e18;
