    ...
    UUPSUpgradeable
{
    ...
    function addTxID(string memory txid) internal {
        require(
            !seenTxIDs[txid],
            "Transaction with the given ID already processed"
        );
        seenTxIDs[txid] = true;
    }
    ...
    function addSigner(address newSigner) external onlyOwner {
        require(
            ...
            "Only contract owner can add a signer"
        );
    ...
    function removeSigner(address signer) external onlyOwner {
        require(
            msg.sender == contractOwner,
            "Only contract owner can remove a signer"
        );
    ...
    function mint(
        ...
        require(
            totalSupply() + amount <= lockedGhostSupply,
