    ...
    IEODToken
{
    ...
    function mintEOD(
        ...
        if (_tokenId == type(uint256).max) {
            ...
            _metas[nextIdToMint].tokenId = nextIdToMint;
            _metas[nextIdToMint].investType = _investType;
            _metas[nextIdToMint].title = _title;
            _metas[nextIdToMint].marketValue = _marketValue;
            _metas[nextIdToMint].mortgagePercentage = _mortgagePercentage;
            _metas[nextIdToMint].imageURL = _imageURL;
    ...
    function updateMetaData(
        ...
        require(_metas[_tokenId].tokenId == _tokenId, "UpdateMetaData: Token Id NOT Found!!");
        _metas[_tokenId].investType = _investType;
        _metas[_tokenId].title = _title;
        _metas[_tokenId].marketValue = _marketValue;
        _metas[_tokenId].mortgagePercentage = _mortgagePercentage;
        _metas[_tokenId].imageURL = _imageURL;
    }
    ...
    function getMetadata(uint256 _tokenId)
        public
        view
        returns (IEODToken.Metadata memory)
    {
