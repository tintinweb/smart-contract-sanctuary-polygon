    ...
    ERC2981ContractWideRoyalties
{
    ...
    mapping(address => MetaVisor) public proxies;
    ...
    constructor(address newOwner, address _proxyRegistryAddress)
        ERC721("GameState", "GS")
    {
        // set proxyRegistryAddress of OpenSea
        ...
        returns (bool isOperator)
    {
        ...
        MetaVisor metaVisor = MetaVisor(proxyRegistryAddress);
        if (address(metaVisor.proxies(_owner)) == _operator) {
            return true;
        }
