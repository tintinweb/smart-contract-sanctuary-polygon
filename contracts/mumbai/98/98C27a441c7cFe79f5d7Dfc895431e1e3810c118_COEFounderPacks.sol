...
contract COEFounderPacks is ERC1155, ReentrancyGuard {
    ...
    ERC1155("COE Founder Packs")
  {
    ...
    // _createToken(1, 0.01 ether, _tier1Uri, 1000);
    // _createToken(2, 0.02 ether, _tier2Uri, 1000);
    // _createToken(3, 0.03 ether, _tier3Uri, 1000);
    _createToken(1, 50000, _tier1Uri, 1000);
    // _createToken(2, 100000, _tier2Uri, 1000);
    // _createToken(3, 150000, _tier3Uri, 1000);
  }
