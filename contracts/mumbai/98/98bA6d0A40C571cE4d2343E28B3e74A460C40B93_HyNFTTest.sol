...
contract EIP712Whitelist is EIP712{
    ...
    constructor()  EIP712("HyNFTTest","1"){}
...
contract HyNFTTest is ERC721Enumerable, Ownable, ERC721Burnable, EIP712Whitelist {
    using Strings for uint256;
    ...
    string public notRevealedUri = "ipfs.io/ipfs/QmYpMQBKu23QCBzUMq2tnZ3F7Uim8aZArJrZ1ebgUD5RQ7123";
    ...
    constructor() ERC721("HyNFTTest", "HyNFT") {}

    function mint(address _to, uint256 _mintAmount) public onlyOwner payable {
        uint256 tokenId = currentTokenId.current();
        require(_mintAmount > 0, "need to mint at least 1 NFT");
        require(tokenId + _mintAmount <= maxSupply, "max NFT limit exceeded");
    ...
    // airdrop
    function airdrop(address _to, bytes calldata signature) public payable {
        uint256 currentClaimTokenId = currentTokenId.current();
        require(isWhitelisted(_to) == false, "Address already claimed airdrop");
        require(simpleVerify(signature), "Invalid Signature");
        require(currentClaimTokenId + 1 <= maxSupply, "No remained NFT to claim");        
