...
contract Marketplace is AdminAccess, ITangibleMarketplace, IERC721Receiver {
        ...
        returns (ITangibleFractionsNFT ftnft, uint256 tokenToSell)
    {
        ...
        //update tracker
        updateTracker(ftnft, tokenToKeep, false);
        ...
        //update tracker
        updateTracker(tnft, tokenId, false);
    ...
    function buyFraction(
        ...
        if (share == remainingShare) {
            ...
            //update tracker
            updateTracker(ftnft, fractTokenId, false);
        } else {
            ...
            //update tracker
            updateTracker(ftnft, splitedTokens[1], false);
            //to send usdc that marketplace received after fractionalizing
        ...
        external
    {
        ...
        //update tracker
        updateTracker(ftnft, tokenId, false);
    }
    ...
    function _stopSale(ITangibleNFT nft, uint256 tokenId) internal {
        ...
        //update tracker
        updateTracker(nft, tokenId, false);
    }
    ...
    function _onERC721Received(
        ...
        if (!fraction) {
            ...
            updateTracker(ITangibleNFT(nft), tokenId, true);
        } else {
            ...
            updateTracker(ITangibleFractionsNFT(nft), tokenId, true);
        }
