...
contract RewardsPayer is ReentrancyGuard, AccessControl, HelperRewardsContract, IMortgageInterest {
    // Contratos de los tokens Busd y Usdc en BSC Mainnet
    IERC20 Busd; // tesnet address: 0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee  Mainet: 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56
    IERC20 Usdc;
    ...
    constructor(address _Mortgagecontrol, address _Busd, address _Usdc,address _controlContract,address _VaultRewardsContract,
    address _walletPanoram, address _vaultLender, address _poolRewards) {
        ...
        VaultRewardsContract = IVaultRewards(_VaultRewardsContract);
...
interface IControl {
   ...
   function getNFTInfo(address _collection, uint256 _id)
    ...
    function getNFTQuantity(address _wallet) external view returns (uint256 _quantity);
    ...
    function addQuantity(address _wallet,uint256 _amount) external;

    function removeQuantity(address _wallet,uint256 _amount) external;
