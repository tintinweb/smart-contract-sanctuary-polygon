    ...
    ReentrancyGuard
{
    ...
    function setTokenFactory(ITokenFactory factory) public onlyOwner {
        ...
        returns (bool)
    {
        ...
        if (_optionId > (maxSupply - token.current())) {
            return false;
        }
        return true;
    }
    ...
    */
        ...
        returns (bool)
    {
        return
            ...
            interfaceId == type(IFactoryMintable).interfaceId;
    }
    ...
    function ownerOf(uint256 _optionId) public view override returns (address) {
        return factoryCanMint(_optionId) ? owner() : address(0);
    }
