    ...
    ERC721Holder
{
    ...
    bytes4 constant INTERFACE_ID = 0x80ac58cd;
    bytes4 private constant _INTERFACE_ID_ERC2981 = 0x2a55205a;
    ...
    function createSaleOrder(
        ...
        address tokenContract,
        uint256 reservePrice
    ) external nonReentrant whenNotPaused() isWhitelisted(tokenContract) returns (uint256) {
        require(
        ...
        nonReentrant
    {
        ...
        if (treasury != address(0)) {
            platformFee =
                (tokenOwnerProfit * platformFeePercentage) /
                (10000);
        ...
        if (checkRoyalties(order.tokenContract)) {
            ...
            if (receiver != address(0)) {
                ...
                emit RoyaltyTransafer(order.tokenId,order.tokenContract,receiver,royaltyAmount);
        ...
        nonReentrant
    {
        ...
        if (checkRoyalties(auction.tokenContract)) {
            ...
            if (receiver != address(0)) {
                _handleOutgoingBid(receiver, royaltyAmount, LNQTokenAddress);
                emit RoyaltyTransafer(auction.tokenId,auction.tokenContract,receiver,royaltyAmount);
        ...
        onlyOwner
    {
        require(
            ...
            "platformFeePercentage is already same"
        );
