    ...
    ERC20_ML_AnyswapV6
{
    ...
    string public constant name = "Zara";
    string public constant symbol = "ZA";
    uint8 public constant decimals = 18;

    uint32 public constant percentFactor = 10000; //100 = 1%
    ...
    function _setTax(uint256 _tier, int8 _type, uint32 _tax, bool _checkMax) internal onlyOwner
    {
        ...
        require(_tax <= percentFactor, "Invalid Tax");
        if (_checkMax)
        {            
    ...
    function takeTax(address _from, address _to, uint256 _amount) internal returns (uint256)
    {
        ...
        uint256 taxAmount = (_amount * uint256(tax)) / uint256(percentFactor);
