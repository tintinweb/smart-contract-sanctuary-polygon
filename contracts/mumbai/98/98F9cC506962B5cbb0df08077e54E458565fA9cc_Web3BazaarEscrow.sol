...
contract Web3BazaarEscrow is Context, ERC1155Holder, ERC721Holder, MultiAccessControl
{
    ...
    function createTradeAdmin( address creator, address[] memory creatorTokenAddress, uint256[] memory creatorTokenId, uint256[] memory creatorAmount, uint8[]  memory creatorTokenType,
                         address  executerAddress , address[] memory executorTokenAddress, uint256[] memory executorTokenId, uint256[] memory executorAmount, uint8[] memory executorTokenType  )  public isOwner returns(uint256) 
    {
        return initTrade(creator, creatorTokenAddress, creatorTokenId, creatorAmount, creatorTokenType, 
                  executerAddress, executorTokenAddress, executorTokenId, executorAmount, executorTokenType );
    }

    
    function initTrade( address creatorAddress, address[] memory creatorTokenAddress, uint256[] memory creatorTokenId, uint256[] memory creatorAmount, uint8[]  memory creatorTokenType,
                        address  executerAddress , address[] memory executorTokenAddress, uint256[] memory executorTokenId, uint256[] memory executorAmount, uint8[] memory executorTokenType  )  internal returns(uint256)
    {
    ...
    {
       return initTrade(msg.sender, creatorTokenAddress, creatorTokenId, creatorAmount, creatorTokenType, 
                  executerAddress, executorTokenAddress, executorTokenId, executorAmount, executorTokenType );
    }
