...
contract AstroGatorActivityTicket is ERC721Enumerable, IERC2981 {
    // attributes
    ...
    // modifiers
    modifier onlyOwner() {
        require(owner() == _msgSender(), "Permission: caller is not the owner");
        _;
    }
    ...
    function transferOwner(address newOwner) external virtual onlyOwner {
        require(
            newOwner != address(0),
            "Ownership: new owner is the zero address"
        );
