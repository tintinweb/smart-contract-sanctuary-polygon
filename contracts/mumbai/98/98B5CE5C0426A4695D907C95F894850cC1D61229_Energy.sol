...
contract Energy is ERC20, ERC20Burnable, TrustedForwarderRecipient {
    ...
    function bulkMint(address[] memory addresses, uint[] memory amounts)
    ...
    function setAdmin(address _newAdmin, bool _isAdmin)
    external onlyOwner {
