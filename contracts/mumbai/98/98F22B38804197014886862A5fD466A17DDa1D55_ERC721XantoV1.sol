...
/// @title ERC721XantoV1
contract ERC721XantoV1 is ERC721Enumerable, Ownable {
  ...
  // Treasury wallet
  address public treasury = 0x8709A7a13c63b26a060705E27504F535EbAc7363;

  // Supply limits
  uint256 public constant SUPPLY_STRICT_UPPER_BOUND = 101;
  ...
  // Constructor
  constructor() ERC721('Xanto NFT v1', 'XNFTV1') {}
  ...
  modifier correctCost(
    ...
    require(
      ...
      'Xanto: Incorrect ether amount provided.'
    );
    _;
  }
  ...
  modifier meetsExistence(uint256 tokenId) {
    require(_exists(tokenId), 'Xanto: Nonexistent token.');
    _;
  }
   ...
   */
  modifier mintActive() {
    require(mintIsActive, 'Xanto: Mint is not active.');
    _;
  }
  ...
  function setTreasuryWallet(address newTreasury) external onlyOwner {
    require(newTreasury != address(0), 'Xanto: Invalid treasury address.');
   ...
   * @dev Wrapped internal function for minting.
   */
    ...
    onlyOwner
  {
    require(
      ...
      'Xanto: Amount array length does not match recipient array or option length.'
    );
    ...
    require(
      ...
      'Xanto: Cannot mint more than supply limit.'
    );
