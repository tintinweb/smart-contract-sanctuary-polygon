    ...
    ContractVersion
{
    ...
    function initialize(
        ...
        // Init contracts
        __ERC721A_init("Sample POAP", "SPOAP");
        __Context_init();
    ...
    /// Returns token IDs owned by `tokenOwner`
    ...
    /// See {ERC721AUpgradeable-_startTokenId}
    function _startTokenId() internal view virtual override returns (uint256) {
        // Token ID starts from 1 (one)
        return 1;
    }

    /// See {ERC721AUpgradeable-_beforeTokenTransfer}
