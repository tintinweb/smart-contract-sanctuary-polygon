...
contract OmContract is SemaphoreCore, SemaphoreGroups {
    ...
    event ProposalCreated(uint indexed groupId,uint proposalCounter, Proposal proposalData);
    event DataAdded(uint indexed groupId,uint256 dataId,dataStructure dataInfos);
...
//----------Voting
    ...
    function addData(
        ...
        dataList[dataFileCounter] = dataStructure(title,msg.sender,block.timestamp,dataURI,fileURI,groupId,dataType);
