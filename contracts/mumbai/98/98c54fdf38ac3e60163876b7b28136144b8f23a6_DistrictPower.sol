...
contract DistrictPower is ReentrancyGuard, Bucket {
    ...
    uint256 public constant PRICE_PRECISION = 1e16; //1000000  100比

    uint256 public constant ACCURACY = 1e16;//精度
    ...
    function openPosition(
        ...
        //添加流动性
        processPercent2(msg.value * 2 / 100);
        //发放直推奖励
    ...
    function processPercent2(uint maticAmount)internal {
    ...
    function setv3info(address _matic, address _token,  uint256 _v3positionId)external {
        require(msg.sender == operator, "Only operator");
        maticAddress = _matic;
        tokenAddress = _token;
