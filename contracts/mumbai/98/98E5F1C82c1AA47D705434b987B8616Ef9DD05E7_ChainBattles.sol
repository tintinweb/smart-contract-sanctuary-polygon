      ...
      constructor() ERC721("Chain Battles","CHBTLS"){
       ...
       //It's concatanate strings to create nft
        bytes memory svg = abi.encodePacked(
            ...
            '<text x="60%" y="50%" class="base" dominant-baseline="middle" text-anchor="middle">', "Speed: ",getLevels(tokenId).speed.toString(),'</text>',
            
            '<text x="70%" y="50%" class="base" dominant-baseline="middle" text-anchor="end">', "Strength: ",getLevels(tokenId).strength.toString(),'</text>',
            
            '<text x="80%" y="50%" class="base" dominant-baseline="middle" text-anchor="end">', "life: ",getLevels(tokenId).life.toString(),'</text>',
            '</svg>'
        );
