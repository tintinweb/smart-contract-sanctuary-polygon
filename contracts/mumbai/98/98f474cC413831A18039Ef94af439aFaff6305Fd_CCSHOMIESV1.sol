    ...
    ERC2771ContextUpgradeable
{
    ...
    function initialize(
        ...
        MAX_SUPPLY = 212;
        MINT_PRICE = 25000000000000000000;
        MAX_MULTIMINT = 100;
    }
    ...
    function safeMint(uint256[] calldata ids) public payable whenNotPaused {
        uint256 count = ids.length;

        require(totalSupply() + count - 1 < MAX_SUPPLY, "Exceeds max supply");

        require(count <= MAX_MULTIMINT, "Max multimint reached");
    ...
    function ownerMint(uint256[] calldata ids) public onlyOwner {
        uint256 count = ids.length;
        ...
        returns (bool isOperator)
    {
        ...
        // for Polygon´s Prod, use 0x58807baD0B376efc12F5AD86aAc70E78ed67deaE
