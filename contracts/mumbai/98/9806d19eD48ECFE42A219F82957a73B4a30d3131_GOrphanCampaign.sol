...
contract GOrphanCampaign is ReentrancyGuard, Pausable, TierSystem, Blacklist {
    ...
    function loadCampaign(
        ...
        _setTiers(_tier0,_tier1, _tier2, _tier3, _tier4);
...
contract TierSystem is Ownable {
    ...
    uint256 public tier2Time = 600;
    uint256 public tier3Time = 1200;
    uint256 public tier4Time = 1800;
    uint256 public tier0Time = 2100;    
