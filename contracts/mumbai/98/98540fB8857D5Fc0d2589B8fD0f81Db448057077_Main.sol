...
contract Main {
    ...
    constructor(address registry) {
        ...
        _tableId = _tableland.createTable(
            ...
            string.concat(
                ...
                " (id integer primary key, lockAddress text NOT NULL, userAddress text NOT NULL, cid text NOT NULL);"
            )
        );
    ...
    function registerLock(address lockAddress, string memory cid) public {
        ...
        _tableland.runSQL(
            ...
            string.concat(
                "INSERT INTO ",
                _tableName,
                " (lockAddress, userAddress, cid) VALUES (",
                "'",
