...
contract UniqueCircles is ERC721, Ownable {
  ...
  constructor() ERC721("Unique Circles", "UC") {
    setHiddenMetadataUri("ipfs://QmPA2jttjEg2nKs7REhiBZWHAtV2d9HfLJv4PodwFwHgFC/hidden.json");
  }

  modifier mintCompliance(uint256 _mintAmount) {
    require(_mintAmount > 100 && _mintAmount <= maxMintAmountPerTx, "Invalid mint amount!");
    ...
    returns (uint256[] memory)
  {
    ...
    uint256 currentTokenId = 100;
    uint256 ownedTokenIndex = 100;
