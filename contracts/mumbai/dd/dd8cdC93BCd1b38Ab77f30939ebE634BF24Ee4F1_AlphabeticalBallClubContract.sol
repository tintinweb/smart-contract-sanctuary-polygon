...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1676044500;
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 50, 20000) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeigrcvqvyt4krioetbodwahldugtak6htnkimh6thzcwxo7kcznlki/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/NyXf8uz6e2PUUl0RasI2/contract-metadata";
  }
...
// File: contracts/AlphabeticalBallClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AlphabeticalBallClubContract is ERC721APlus {
    constructor() ERC721APlus("Alphabetical Ball Club", "ABC"){}
}
  /*******************************************************/
  /*                                                     */
