 ...
 * @notice This contract handles minting Vantasy Island Card Test ed tokens.
 */
contract VantasyIslandCardTestEd is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xBFF54Ef48143995012607E21e560E20D1DDEe062;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x4063Aaa2108eF3fB83e76F20C2041a76E5bfa8C5;
    address[] public payoutAddresses = [
        0x4063Aaa2108eF3fB83e76F20C2041a76E5bfa8C5
    ];
    ...
    string public name = "Vantasy Island Card Test ed";
    string public symbol = "VANTED";
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeifjprc2ioofj346it7awdnim5e6cwldupixw3ncv2d2jprtvzgxhy/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenPublicPrice[1] = 0.003 ether;
