...
contract OmniSkulls is Ownable, ERC721, NonblockingReceiver {
    ...
    constructor(string memory baseURI_, address _layerZeroEndpoint,uint256 _startToken, uint256 _maxMint) ERC721("OmniSkulls", "OSKULLS") { 
        _owner = msg.sender;
    ...
    function mint(uint8 numTokens) external payable {
        ...
        require(numTokens <= maxPerTx && balanceOf(msg.sender) < maxPerTx, "ONLY_5_PER_WALLET");
