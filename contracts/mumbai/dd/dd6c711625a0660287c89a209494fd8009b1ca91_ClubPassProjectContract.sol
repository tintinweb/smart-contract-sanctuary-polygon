...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  */
  ...
  abstract contract Allowlist is Ownable {
    ...
    // File: contracts/clubPassProjectContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract ClubPassProjectContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Club Pass Project", "CLUB", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmSirGtmUXFGBGNL9gvAj7M6omw97XdgihHTbNDXM8MLZr/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/7crgMadqxZXkHEj2znol/contract-metadata";
        }
    }