...
contract NFT is ERC721Enumerable, Ownable {
    ...
    function mint(string calldata _color) public {
    ...
    function buildMetadata(uint256 _tokenId) private view returns (string memory) {
        ...
        string memory image = buildImage(_item.color);
        return string(
            abi.encodePacked(
    ...
    function buildImage(string memory _color) private view returns (string memory) {
