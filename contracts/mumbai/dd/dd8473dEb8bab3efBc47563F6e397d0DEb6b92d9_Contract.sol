...
contract Contract is ERC721LazyMint {
    ...
    function claim(bool _isSBT)public payable{
        if(_isSBT){
            require(msg.value == pricePerSBT, "msg value must be same as mint price");
        }else{
            require(msg.value == pricePerNFT, "msg value must be same as mint price");
        }
