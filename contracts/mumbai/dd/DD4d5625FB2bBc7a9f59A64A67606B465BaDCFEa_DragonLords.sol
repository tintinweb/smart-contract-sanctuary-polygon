...
pragma solidity >=0.7.0 <0.9.0;
 ...
 contract DragonLords is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "0x5f14840FB8ed3819Cc07D70FA35303C34DCbB5CD";
  ...
  constructor() ERC721("DragonLords", "DL") {
    setHiddenMetadataUri("ipfs://VQmaZn1nUWKNMEjifoufY56VdXJ6qWY2tL9Zd28pLeHX1SD/hidden.json");
  }

  modifier mintCompliance(uint256 _mintAmount) {
    require(_mintAmount > 1 && _mintAmount <= maxMintAmountPerTx, "Invalid mint amount!");
