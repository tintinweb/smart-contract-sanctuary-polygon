    ...
    RoyaltiesV1Luxy
{
    ...
    uint256 public constant DROP_START_TIME = 1666041623;
    ...
    function __Absu_init(
        ...
        __ERC721_init_unchained("Absu", "LuxyDrop");
        __ERC721Enumerable_init_unchained();
        __Ownable_init_unchained();
        __Absu_init_unchained(
            baseURI_,
            artist_,
            // luxy_,
    ...
    function __Absu_init_unchained(
        string memory baseURI_,
        address artist_,
        // IERC20Upgradeable luxy_,
        address luxyLaunchpadFeeManagerProxy_
