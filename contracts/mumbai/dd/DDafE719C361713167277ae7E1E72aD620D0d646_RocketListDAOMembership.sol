...
contract RocketListDAOMembership is ERC721, Ownable, EIP712, ERC721Votes {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor()
        ERC721("RocketListDAO Membership", "RLDM")
        EIP712("RocketListDAO Membership", "1")
    {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://www.rocketlistdao.xyz/";
    }
