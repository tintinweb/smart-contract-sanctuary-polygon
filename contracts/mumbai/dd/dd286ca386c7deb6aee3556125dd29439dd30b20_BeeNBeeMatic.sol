...
contract BeeNBeeMatic {
    ...
    uint256 public MIN_DEPOSIT = 30 ether; /** 30 MATIC  **/
    uint256 public MAX_DEPOSIT = 10000 ether; /** 10 000 MATIC  **/
...
/**
    MATIC Bee'n'Bee
    Build Hives, Gather Honey, Harvest Honey and Sell for MATIC.
    8% daily Rate
    ...
    30 MATIC minimum investment.
    10 000 MATIC max deposits per wallet.
