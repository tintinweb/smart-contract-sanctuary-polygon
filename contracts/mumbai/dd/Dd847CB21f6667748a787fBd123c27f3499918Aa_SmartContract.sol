...
/// @title SmartContract
/// @notice ERC721A smart contract template.
contract SmartContract is ERC721A, ERC2981, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
  ...
  uint public maxMintAmountPerWallet;
  ...
  /// @notice Set hiddenMetadataUri
  /// @dev setHiddenMetadataUri
  function setHiddenMetadataUri(string memory _hiddenMetadataUri) public onlyOwner {
    hiddenMetadataUri = _hiddenMetadataUri;
  }

  /// @notice Set uriPrefix
  /// @dev setUriPrefix
  function setUriPrefix(string memory _uriPrefix) public onlyOwner {
    uriPrefix = _uriPrefix;
  }

  /// @notice Set uriSuffix
  /// @dev setUriSuffix
  ...
  /// @notice Set maxMintAmountPerTx
  /// @dev setMaxMintAmountPerTx
  function setMaxMintAmountPerTx(uint _maxMintAmountPerTx) public onlyOwner {
    maxMintAmountPerTx = _maxMintAmountPerTx;
  }

  /// @notice Set maxMintAmountPerWallet
  /// @dev setMaxMintAmountPerWallet
  ...
  /// @notice Starts TokenId at 1 instead of 0
  /// @dev _startTokenId
  function _startTokenId() internal view virtual override returns (uint) {
    return 1;
  }

  /// @notice _baseURI returns uriPrefix
  /// @dev _baseURI
