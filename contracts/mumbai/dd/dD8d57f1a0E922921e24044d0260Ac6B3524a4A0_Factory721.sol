...
import "./CarrotFactoryNft721.sol";
...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new CarrotFactoryUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        CarrotFactoryUser721Token token = CarrotFactoryUser721Token(address(addr));
...
contract CarrotFactoryUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
