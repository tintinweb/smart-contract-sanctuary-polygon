...
contract RandomToken is Initializable, ERC721Upgradeable, PausableUpgradeable, OwnableUpgradeable, ERC721BurnableUpgradeable, DefaultOperatorFiltererUpgradeable {
    ...
    function initialize(
        ...
        __ERC721_init("Random-Token", "MTK");
        __Pausable_init();
        __Ownable_init();
