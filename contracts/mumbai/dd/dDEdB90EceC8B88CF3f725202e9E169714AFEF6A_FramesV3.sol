...
contract FramesV3 is IFraming {
    ...
    function _randomWeightedFrameId(
        ...
        revert("no valid frameId selected");
    }
        ...
        returns (string memory, string memory)
    {
        ...
        string memory stops;
        string memory frame;
        string memory tagId = string(
            abi.encodePacked("supercool__pixly_gradient_", tokenId.toString())
        );
        ...
        if (gradient == 0) {
            ...
            frame = string(
                abi.encodePacked(
                    ...
                    tagId,
                    "' gradientUnits='userSpaceOnUse' gradientTransform='rotate(12)' x1='100%' y1='0%' x2='0%' y2='100%'>",
                    stops,
                    "</linearGradient></defs>",
                    "<rect height='320' width='260' style='fill:#000; stroke-width:20; stroke:url(#",
                    tagId,
                    ")'/>"
                )
            );
            ...
            frame = string(
                abi.encodePacked(
                    ...
                    tagId,
                    "' gradientUnits='userSpaceOnUse' r='100%'>",
                    stops,
                    "</radialGradient></defs>",
                    "<rect height='320' width='260' style='fill:#000; stroke-width:20; stroke:url(#",
                    tagId,
