...
contract VRFv2Consumer is VRFConsumerBaseV2, CooperatableBase,IRandomnessConsumer,ERC165 {
    ...
    function random(uint32 range) external onlyOwnerOrOperator returns (uint256){
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
        return
            interfaceId == type(IRandomnessConsumer).interfaceId ||
