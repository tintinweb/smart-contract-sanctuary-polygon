    ...
    Whitelist
{
    ...
    modifier timeLimitExceeds(uint256 saleId) {
        ...
        uint256 deadline = block.timestamp + sixHours;
        require( deadline < reserveSale[saleId].startTime, 'DistinctMarket: 6 Hours left for the sale');
        _;
    }
    ...
    function joinWhitelist(uint256 saleId) external  validateSaleId(saleId){
