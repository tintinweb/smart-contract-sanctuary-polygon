...
contract OHtest3 is ERC721URIStorage, Ownable, ERC721Enumerable {
    ...
    constructor() ERC721("Oh-test-3", "OHT") {
    ...
    function safeMint(address to, string memory uri) payable public isWhitelisted(msg.sender) returns (uint256){
