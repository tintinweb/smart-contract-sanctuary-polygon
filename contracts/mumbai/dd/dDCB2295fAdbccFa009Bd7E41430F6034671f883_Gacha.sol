...
contract Gacha is Initializable, IERC721Receiver, UUPSUpgradeable {
    ...
    */
    ...
    // Data
    address public VRFConsumerBase;
    ...
    */
    function initialize(
        ...
        require(_VRFConsumerBase != address(0), "INVALID VRF CONSUMER ADDRESS.");
        VRFConsumerBase = _VRFConsumerBase;
    }
    ...
    */
    function checkAbilityReward() private returns(uint256){
        ...
        if(typeRandomReward == TypeRandomReward.NORMAL_RANDOM_NUMBER) {
            ...
            ramdomNumber = checkRamdomNumber(totalUnlockReward);
        } else {
            // Call the getRandomNumber function on the VRFConsumerBase contract
            IVRFConsumerBase(VRFConsumerBase).getRandomNumber();
            
            // If not, generate a random number using VRFConsumerBase and the total unlock reward
            ramdomNumber = IVRFConsumerBase(VRFConsumerBase).randomResult() % totalUnlockReward;
        }
    ...
    */
    ...
    /**
    * Set the address of VRFConsumerBase contract
    * @param _VRFConsumerBase The address of the VRFConsumerBase contract
    */
    function setVRFConsumerBase(address _VRFConsumerBase) external onlyAdmin {
        require(_VRFConsumerBase != address(0), "VRF CONSUMER BASE IS INVALID.");
        VRFConsumerBase = _VRFConsumerBase;
    }
