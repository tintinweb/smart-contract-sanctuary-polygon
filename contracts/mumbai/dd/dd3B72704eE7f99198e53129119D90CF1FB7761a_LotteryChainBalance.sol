...
contract LotteryChainBalance is Ownable{
    ...
    // ##### Variables #####
    address public evolveCoinTokenAddress = 0xBD6f168B36dEA56E4aB58287EAC38C81eeb558d7;
    EvolveCoinTokenInterface evolveCoinTokenInstance = EvolveCoinTokenInterface(evolveCoinTokenAddress);

    address public evolveCoinLiquidityAddress = 0x8CfE14E2C4060C4C560ba3A07dA110b71EB7Ef01;
