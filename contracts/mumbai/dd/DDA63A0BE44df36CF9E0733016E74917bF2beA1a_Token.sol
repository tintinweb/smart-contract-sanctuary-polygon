...
function burn(uint256 amount) onlyOwner public virtual {
    _burn(_msgSender(), amount);
}


function burnFrom(address account, uint256 amount) onlyOwner public virtual {
