...
library OracleLibrary {
        ...
        returns (int24 arithmeticMeanTick, uint128 harmonicMeanLiquidity)
    {
        ...
        if (tickCumulativesDelta < 0 && (tickCumulativesDelta % int56(int256(uint256(secondsAgo))) != 0)) arithmeticMeanTick--;
    ...
    function getBlockStartingTickAndLiquidity(address pool) internal view returns (int24, uint128) {
        ...
        tick = int24(int256(uint256(int256(tickCumulative - prevTickCumulative)) / uint256(delta)));
        uint128 liquidity =
        uint128(
