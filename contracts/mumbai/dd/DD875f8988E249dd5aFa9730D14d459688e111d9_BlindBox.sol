...
contract BlindBox is OwnableUpgradeable, ItemPool {
...
abstract contract ItemPool {
    ...
    function _initItemPool() internal
    {
    ...
    function _updateItemPool(ITEM_POOL[] memory _itemPool) internal
    {
