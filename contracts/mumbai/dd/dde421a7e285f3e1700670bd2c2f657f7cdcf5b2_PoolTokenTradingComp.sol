...
*/
contract PoolTokenTradingComp is AccessControlledAndUpgradeable, ERC20Upgradeable, ERC20BurnableUpgradeable, ERC20PermitUpgradeable, IPoolToken {
  ...
  address public immutable shifterTRADING_COMPETITION_ONLY;
  ...
  constructor(
    ...
    shifterTRADING_COMPETITION_ONLY = tradingCompShifter;
  }
  ...
  */
  function _beforeTokenTransfer(
    ...
    require(
      sender == market || to == market || sender == shifterTRADING_COMPETITION_ONLY || to == shifterTRADING_COMPETITION_ONLY,
      "disallowed transfer"
    );
