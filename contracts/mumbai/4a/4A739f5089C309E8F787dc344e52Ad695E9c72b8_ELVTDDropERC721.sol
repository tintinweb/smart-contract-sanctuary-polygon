...
import { IDropERC721 } from "@thirdweb-dev/contracts/interfaces/drop/IDropERC721.sol";
...
abstract contract MulticallUpgradeable is Initializable, OnlyDelegateCallUpgradeable {
     ...
     */
    function _functionDelegateCall(address target, bytes memory data) private onlyDelegateCall returns (bytes memory) {
