...
contract DogeCollectables is ERC721URIStorage, ERC2981 {
    string private basicDogeTokenURI = 'ipfs://bafkreic2h4tjs3b6fx4ckpgvvmolpa4wb5kuu2mflvfjilbdv3viqyumva';
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    address[] private _allowedMintMessageSenders;

    constructor(address[] memory allowedMintMessageSenders, uint96 defaultRoyaltyFeeNumerator) ERC721("Doge collectables", "DOC") {
    ...
    returns (uint256)
    {
        ...
        _setTokenURI(newItemId, basicDogeTokenURI);
