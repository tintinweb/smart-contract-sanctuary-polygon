...
contract Airdrop is ERC20, SismoConnect {
  ...
  bytes16 public constant MERGOOOR_CONTRIBUTOR_GROUP_ID = 0x42c768bb8ae79e4c5c05d3b51a4ec74a;
  ...
  constructor(
    ...
    ERC20(name, symbol)
    SismoConnect(buildConfig(appId, true)) // <--- Sismo Connect constructor
  {}
  ...
  function claimWithSismo(bytes memory response) public {
    ...
    claims[0] = buildClaim({
      groupId: MERGOOOR_CONTRIBUTOR_GROUP_ID
