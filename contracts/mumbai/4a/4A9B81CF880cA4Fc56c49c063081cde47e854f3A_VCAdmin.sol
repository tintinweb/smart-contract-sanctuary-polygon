...
contract VCAdmin is IVCAdmin {
    ...
    function setupProtocol(ParamsSetup calldata params) external {
        ...
        IFeeBeneficiary(params._marketplaceFixedPrice1155).setAdmin(params._marketManager);
        IFeeBeneficiary(params._marketplaceFixedPrice721).setAdmin(params._marketManager);
        IFeeBeneficiary(params._marketplaceAuction721).setAdmin(params._marketManager);
        IFeeBeneficiary(params._marketplaceFixedPricePocNft).setAdmin(params._marketManager);
        IFeeBeneficiary(params._marketplaceAuctionPocNft).setAdmin(params._marketManager);
