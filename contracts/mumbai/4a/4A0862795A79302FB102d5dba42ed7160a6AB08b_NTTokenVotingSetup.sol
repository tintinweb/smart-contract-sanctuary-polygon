...
import "OpenZeppelin/[email protected]/contracts/token/ERC20/extensions/ERC20BurnableUpgradeable.sol";
import "OpenZeppelin/[email protected]/contracts/access/OwnableUpgradeable.sol";
import "OpenZeppelin/[email protected]/contracts/token/ERC20/extensions/draft-ERC20PermitUpgradeable.sol";
import "OpenZeppelin/[email protected]/contracts/token/ERC20/extensions/ERC20VotesUpgradeable.sol";
...
/// @dev This contract inherits from `MajorityVotingBase` and implements the `IMembership` interface.
contract NTTokenVoting is IMembership, MajorityVotingBase {
    using SafeCastUpgradeable for uint256;
...
/// @author Aragon Association - 2022-2023 - modified/adapted for non transferable mintable/burnable token by [email protected]
