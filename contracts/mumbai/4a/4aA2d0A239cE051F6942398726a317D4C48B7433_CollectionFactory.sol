...
contract CollectionFactory is Initializable, OwnableUpgradeable, PausableUpgradeable {
    ...
    function createCollection(
        ...
        collection.__NiftyCollection_init(name, symbol, _contractURI, tokenURIPrefix, _royalty, msg.sender);
...
contract NiftyCollection is PausableUpgradeable, OwnableUpgradeable, Niftyco721 {
    function __NiftyCollection_init(
        string memory name,
        string memory symbol,
        string memory _contractURI,
        string memory tokenURIPrefix,
        ...
        __NiftyCollection_init_unchained(name, symbol, _contractURI, tokenURIPrefix, _royalty, _admin);
    }

    function __NiftyCollection_init_unchained(
        string memory name,
        string memory symbol,
        string memory _contractURI,
        string memory tokenURIPrefix,
        ...
        __Niftyco721_init(name, symbol, _contractURI, tokenURIPrefix, _royalty, _admin);
        transferOwnership(_admin);
    }

    function safeMint(address to, string memory tokenURI) public override whenNotPaused returns (uint256) {
        return Niftyco721.safeMint(to, tokenURI);
    }
}
    ...
    Role
{
    ...
    function initialize(
        ...
        _init("Victor721", "VIC", _contractURI, tokenURIPrefix, _royalty, _admin);
    }
    ...
    function safeMint(address to, string memory uri) public virtual whenNotPaused returns (uint256) {
