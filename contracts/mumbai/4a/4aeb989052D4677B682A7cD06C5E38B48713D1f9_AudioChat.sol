...
function _removeFromStateArrays(stateOptions old_state, uint256 index) private {
...
function deleteTheAudioChat(bytes32 audio_event_id) public {
    ...
    _removeFromStateArrays(id_to_audio_chat[audio_event_id].state, id_to_audio_chat[audio_event_id].state_index);
