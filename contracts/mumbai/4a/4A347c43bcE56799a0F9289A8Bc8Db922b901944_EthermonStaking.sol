...
contract EthermonStaking is EthermonStakingBasic, EthermonEnum {
    ...
    function updateTokens(uint256 _lockId) external {
        ...
        if (timeElapsed > 0 && currentTime > data.endTime) {
            ...
            data.emons /= 1*10**18;
            emon.transferFrom(address(0xe675d762199E0F7BD907B67E76f04403088ff5aC), data.owner, data.emons);

            //ethermonTadeData.removeBorrowingItem(data.monId);
            //stakingData.removeTokenData(_lockId);

            emit Withdraw(address(0xe675d762199E0F7BD907B67E76f04403088ff5aC), data.owner, data.emons);
