...
contract NFT1155 is ERC1155 {
    ...
    /**
     * Override isApprovedForAll to auto-approve Whitelisted MarketPlace's proxy contract
     */
        ...
        whenNotPaused
    {
        ...
        revert("NFT1155#setApprovalForAll: NOT ALLOWED ( DEFAULTED TO MARKETPLACE )");
    }

    function setRoyaltyFee(uint256 royaltyFee) external onlyOwner{
    ...
    /**
     * @dev enable owner to withdraw royalty received 
     */
    function OwnerWithdrawRoyalty(uint256 amountInWei) external onlyOwner returns (bool) {
        require(amountInWei <= address(this).balance,"NFT1155#OwnerWithdrawRoyalty: amount exceeds available Royalty Balance");
        (bool success, ) = payable(_msgSender()).call{value: amountInWei}("");
        require(success, "NFT1155#OwnerWithdrawRoyalty: Failed");
        emit RoyaltyWithdrawn(msg.sender, amountInWei);
        return success;
    } 
