...
contract OntecoPayMaster is BasePaymaster {

  address public target;

  string public override versionPaymaster = '2.2.6';
  ...
  /**
  * Function to set new version of gas station network
  */
  function setVersionPaymaster(string memory _newVersion) public onlyOwner {
      versionPaymaster = _newVersion;
  }
}
