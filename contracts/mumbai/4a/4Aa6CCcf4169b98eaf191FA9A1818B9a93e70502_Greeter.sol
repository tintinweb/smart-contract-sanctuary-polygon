...
contract Greeter {
    ...
    function setStokCabe(uint256 _stok) public {
        stokCabe = _stok;
    }

    function setStokBawang(uint256 _stok) public {
        stokBawang = _stok;
    }

    function setStokBayam(uint256 _stok) public {
        stokBayam = _stok;
    }

    function setStokPadi(uint256 _stok) public {
        stokPadi = _stok;
    }

    function setStokJagung(uint256 _stok) public {
        stokJagung = _stok;
    }

    function getStokCabe() public view returns (uint256) {
        return stokCabe;
    }

    function getStokBawang() public view returns (uint256) {
        return stokBawang;
    }

    function getStokJagung() public view returns (uint256) {
        return stokJagung;
    }

    function getStokBayam() public view returns (uint256) {
        return stokBayam;
    }

    function getStokPadi() public view returns (uint256) {
        return stokPadi;
    }
