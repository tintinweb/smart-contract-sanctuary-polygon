...
contract A1 is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    constructor() ERC721("A1 collection by ArtX", "A1") {}
    ...
    function _baseURI() internal override(ERC721) view virtual returns (string memory) {
        return "ipfs://QmNUeyiQYGRtGT6zBrkBDtdcuhv4UsbvChqMT3SKKuQgEt/";
    }
