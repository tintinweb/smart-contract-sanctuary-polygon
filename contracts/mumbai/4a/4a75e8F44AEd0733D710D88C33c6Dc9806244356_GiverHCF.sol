...
contract GiverHCF is Ownable {
    ...
    uint256 private constant _MAXIMUM_TARGET = 2 ** 250;
    ...
    /// @notice Mapping of the submitted solutions for mining challenge numbers
    mapping(bytes32 => bytes32) private _solutions;
    ...
    function claim(
        ...
        _solutions[_challengeNumber] = digest;
