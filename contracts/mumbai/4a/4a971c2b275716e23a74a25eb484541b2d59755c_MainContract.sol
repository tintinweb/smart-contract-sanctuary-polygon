...
contract MainContract {
    ...
    */
    ...
    /**
    * @dev Throws if Bet Taker Will Be Bet Creator Address
    * @param _betContractId Address Of Contract Which Has Been Deployed On Bet Creation Time
    */
    ...
    */
    ...
    /**
    * @dev Throws If Bet Ending Date Will Be Less Then Current Timestamp
    * @param _betEndingDate Bet Ending Time
    */
    modifier isBetLegitimate(uint _betEndingDate) {
        require(_betEndingDate >= block.timestamp, "Ending time can't be before current time");
        _;
    }
    ...
    */
    ...
    public
    payable
    isBetLegitimate(_betEndingDate)
    returns(P2PBet)
    {
        p = new P2PBet();
