...
contract DAOAdmin is DAOStandart, ExtensionWhiteList, ExtensionSelector {
    ...
    function addAdmins(address[] memory accounts) external onlyRole(DAO_ADMIN_ROLE) {
    ...
    function finishPoll(uint256 proposalId) external {
