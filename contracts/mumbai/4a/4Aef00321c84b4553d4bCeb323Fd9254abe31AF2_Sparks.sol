...
library EnergyConstants {
    uint8 public constant CWATT = 1;
    uint8 public constant XWATT = 2;
    uint8 public constant LWATT = 3;
    uint8 public constant NWATT = 4;
    uint8 public constant PWATT = 5;
    uint8 public constant SWATT = 6;
    uint8 public constant VWATT = 7;
}
...
contract Sparks is Initializable, NTERC1155Upgradeable, OwnableUpgradeable {
    ...
    function initialize(
        ...
        tokenPriceInCurrency = 0.000000000000000001 ether;
        currency = IERC20Upgradeable(_currency);
        energyPerSpark = 10e18;
    ...
    function buyAndRewardSparks(
        ...
        if (account == recipient || recipient == address(0)) {
    ...
    function _awardSparks(uint256 amount, address recipient) internal {
        ...
        // Emit event
        emit SparksAwarded(_msgSender(), amount, recipient, energyAmount);
    }
}