...
contract Coin_Test5723 is ERC20 {

	address owner;
	event Mint (address indexed mintBy);
	uint256 public mintAmtInBank = uint256(0);

	constructor() ERC20("PolyCoinTest5723", "Test5723") {
		owner = msg.sender;
		super._mint(msg.sender, uint256(10000000000000000000000));
	}
