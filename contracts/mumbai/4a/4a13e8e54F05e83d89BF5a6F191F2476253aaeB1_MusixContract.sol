...
contract MusixContract is ERC721Enumerable,Ownable {
    ...
    uint256 public startDate = 1650403911;
    ...
    function getCurrentPrice() public view returns (uint currPrice){
        uint daysAfterLaunch = (block.timestamp - startDate) / (1* 1 minutes);
