...
contract TokenUpgradableV4 is Initializable, ERC20Upgradeable, OwnableUpgradeable {
    mapping(address => uint256) public balances;
    // mapping(address => mapping(address => uint256)) public allowance;

    // uint256 public totalSupply1 = 500000000000 * 10**18;
    // string public name1 = "MONK TEST TOKEN";
    // string public symbol1 = "MONKTEST";
    ...
    // This is only to be used first time while deploying contract
    // function initialize() public initializer {
    //     __ERC20_init("Monk Upgradable", "MONKU");
    //     __Ownable_init();
    ...
    function metaTransfer(
        ...
        // console.logBytes32(metaHash);
        address signer = getSigner(metaHash, signature);

        // console.log("ssigner %s", signer);
        // console.log("nonce %s", nonce);
        // console.log("replayNonce %s", replayNonce[signer]);
