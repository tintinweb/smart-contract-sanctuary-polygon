...
contract StanNFT is ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    mapping(uint256 => bytes32) private TokenIdToListing;
    ...
    function updateTokenToListing(bytes32 _listing, uint256 _tokenId)
        external
...
contract CollectionNFT is Ownable {
    ...
    mapping(bytes32 => bool) public collectionId;
    mapping(uint256 => bytes32) public tokenIdToCollectionId;
    mapping(bytes32 => DataStructure.stateCollection) internal _collectionNFT;
