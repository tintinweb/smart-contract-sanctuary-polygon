...
contract CerealClub is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 private constant AUCTION_STEP_SECONDS = 0.5 minutes;
  uint256 private constant AUCTION_MIN_PRICE = 0.1 ether;
  uint256 private constant FAR_FUTURE = 0xFFFFFFFFF;
  uint256 private constant MAX_MINTS_PER_TX = 3;
  ...
  uint256 private _auctionMaxSupply = 3;
  uint256 private _marketingSupply = 3;
