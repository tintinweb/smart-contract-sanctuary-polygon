...
contract GameRegistry is OwnableUpgradeable {
  ...
  function createTournamentByUser(
  ...
  ) external payable onlyActiveGame(_gid) returns (uint256 tid) {
    // require(msg.value == tournamentCreationFeeAmount, "Incorrect tournament fee paid");
    ...
    emit DebugEvent(tournamentCreationFeeAmount, msg.value);
