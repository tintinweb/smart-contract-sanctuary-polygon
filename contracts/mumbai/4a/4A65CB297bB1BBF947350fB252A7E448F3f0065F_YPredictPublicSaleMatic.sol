...
contract YPredictPublicSaleMatic is Ownable, Pausable, ReentrancyGuard {
  ...
  */
  ...
  function _getPriceOfGivenMaticInUSDT(int256 amount)
    public
    view
    returns (int256)
  {
    return
      _getDerivedPrice(i_matic_usd_priceFeed, i_usdt_usd_priceFeed, 6) * amount;
  }

  function buyTokens(uint256 amount) external whenNotPaused nonReentrant {
    require(
