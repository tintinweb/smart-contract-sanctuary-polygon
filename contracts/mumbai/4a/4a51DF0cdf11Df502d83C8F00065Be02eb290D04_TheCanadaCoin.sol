...
contract TheCanadaCoin is BaseErc20, Taxable, Dividends {
    ...
    constructor () {
        ...
        // Quickswap
        //address Quickswap = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; // TESTNET
        address Quickswap = 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff; // MAINNET
        IDEXRouter router = IDEXRouter(Quickswap);
        address WMATIC = router.WETH();
        address pair = IDEXFactory(router.factory()).createPair(WMATIC, address(this));
        exchanges[pair] = true;
        taxDistributor = new TaxDistributor(Quickswap, pair, WMATIC);
        ...
        _allowed[address(taxDistributor)][Quickswap] = 2**256 - 1;
