...
/*
https://docs.openzeppelin.com/contracts/4.x/api/proxy#ProxyAdmin
-----------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------
Context ) 현재 실행 컨텍스트에 대한 정보를 제공합니다
https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.7.0/contracts/utils/Context.sol
-----------------------------------------------------------------------------------------
Ownable ) 특정 기능에 대한 독점 액세스 권한을 부여할 수 있는 계정(소유자)이 있는 기본 액세스 제어 메커니즘을 제공하는 계약 모듈
https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.7.0/contracts/access/Ownable.sol
-----------------------------------------------------------------------------------------
ProxyAdmin ) 이 계약은 {TransparentUpgradeableProxy}의 관리자로 할당되어야 하는 보조 계약입니다. 이 옵션을 사용하는 이유에 대한 설명은 {TransparentUpgradeableProxy} 설명서를 참조하십시오.
https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.7.0/contracts/proxy/transparent/ProxyAdmin.sol
-----------------------------------------------------------------------------------------
*/
