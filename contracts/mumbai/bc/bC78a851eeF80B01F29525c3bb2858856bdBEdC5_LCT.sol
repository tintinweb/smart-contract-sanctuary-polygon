...
// File: contracts/LuxOn/ERC721LUXON.sol
...
contract ERC721LUXON is ERC721A, SuperOperators {
    string private baseURI = "";
    
    constructor(string memory name_, string memory symbol_) ERC721A(name_, symbol_) {}

    function mintLuxOn(address mintUser, uint32 quantity) external onlySuperOperator {
