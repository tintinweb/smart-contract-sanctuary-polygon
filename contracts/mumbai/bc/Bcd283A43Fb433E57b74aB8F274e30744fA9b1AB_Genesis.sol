...
contract Genesis is ERC721Enumerable, AccessControl {
    ...
    function getRandom(
        ...
        require(
            signerAddress ==
                keccak256(abi.encodePacked(_seed))
    ...
    function verifyMessage(string memory message, bytes calldata signature) public view  returns(address, bool) {
