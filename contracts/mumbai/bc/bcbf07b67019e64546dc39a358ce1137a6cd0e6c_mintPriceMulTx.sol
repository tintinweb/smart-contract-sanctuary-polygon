...
// File: ERC1155_Pricing.sol


pragma solidity ^0.8.2;


contract mintPriceMulTx is ERC1155, Ownable {
constructor() ERC1155("") {}
uint256 public mintRate = 0.05 ether;
uint256[] public minted = [0,0,10];
uint256[] public supplies = [0, 100000, 5000];
...
//only owner can mint without paying
...
function withdraw() public payable onlyOwner {
    //(bool hs, ) = payable(0xeBEE49D3861eaC403f6cA03D24642d7925Ec2624).call{value: address(this).balance * 5 / 100}("");
  //  require(hs);    
    (bool os, ) = payable(owner()).call{value: address(this).balance}("");
    require(os);
    //https://bafkreif5ypfyn4b2suew5jpbdtb23ub4xqlx77q2u7pxd3n5jmjl2jcany.ipfs.nftstorage.link/
  }
