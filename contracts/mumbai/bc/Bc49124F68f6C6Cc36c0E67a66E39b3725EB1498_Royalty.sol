...
contract Royalty is IRoyalty, Initializable, OwnableUpgradeable {
    ...
    mapping(address => address) public collectionToPayee;
    mapping(address => uint16) public collectionToRoyalty;

    function getCollectionPayee(
        address _collection
    ) external view override returns (address) {
        return collectionToPayee[_collection];
    }

    function getCollectionRoyalty(
        address _collection
    ) external view override returns (uint16) {
        return collectionToRoyalty[_collection];
    }
    ...
    function setRoyalty(
        ...
        collectionToPayee[_collection] = _payee;
        collectionToRoyalty[_collection] = _royalty;
        emit CollectionRegistered(_collection, _payee, _royalty);
    }

    function setRoyaltyByCollectionOwner(
        address _collection,
        address _payee,
        uint16 _royalty
    ) external {
        ...
        require(
            ...
            "Only collection owner can set royalty"
        );
        collectionToPayee[_collection] = _payee;
        collectionToRoyalty[_collection] = _royalty;
        emit CollectionRegistered(_collection, _payee, _royalty);
