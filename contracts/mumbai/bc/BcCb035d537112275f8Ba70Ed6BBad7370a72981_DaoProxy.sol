...
contract DaoProxy is BaseContract {
    ...
    function getUserData(
        ...
        _returnItem.BaseItem4_ = BaseItem4(weekRewardForInvest, weekRewardForInvite, weekDataList["Invest"], weekDataList["Invite"], weekAddressList["Invest"], weekAddressList["Invite"], weekDayList["Invest"], weekDayList["Invite"]);
    }
    ...
    function getBigNetAmountList(address[] memory _addressList) external view returns (DaoInfoItem[] memory DaoInfoItem_) {
        ...
        for (uint256 i = 0; i < _num; i++) {
            ...
            _user : _user,
            _daoType:userDaoList[_user]._daoType, //DAO等级
