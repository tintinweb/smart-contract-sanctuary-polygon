...
contract StreakCreator is Ownable {
...
contract DropMintingCreator is Ownable, IDropMintingCreator {
    function createContract(
        ...
        ERC721Streak erc721Contract = ERC721Streak(erc721Address);
        erc721Contract.grantRole(erc721Contract.MINTER_ROLE(), address(dropMintingContract));
