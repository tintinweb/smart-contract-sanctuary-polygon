...
contract CKNFT is ERC1155, Ownable, Pausable {
    ...
    constructor()
        ERC1155(
            "https://gateway.pinata.cloud/ipfs/QmRSTdSQCR5Bm3aexoVvvvjkVQv5GWwjR2ZQEMpVGNPRf5/{id}.json"
        )
    {
        contractUri = "https://gateway.pinata.cloud/ipfs/QmVSsZd12eLC1YuJTDcHi76RNB9MdHRhd4fHySG7W8TUtU"; // json contract metadata file for OpenSea
