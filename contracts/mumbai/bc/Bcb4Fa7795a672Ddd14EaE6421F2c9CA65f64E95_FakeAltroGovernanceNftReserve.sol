...
/**
 * @title FakeAltroGovernanceNftReserve
 * @author FakeAltro Developer
 * @dev Contract that acts as the FakeAltro reserve for ERC721 and ERC1155 tokens. It verifies that the operator has the approval for the token
 * before allowing the transfer to proceed.
 */

contract FakeAltroGovernanceNftReserve is ERC721Holder, ERC1155Holder, Ownable, INftReserve {
	/**
	...
	receive() external payable {
		revert("FakeAltroGovernanceNftReserve: cannot receive Eth");
	}
