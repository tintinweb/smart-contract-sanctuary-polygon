...
contract Forge_Metadata is Ownable {
    ...
    // token description
    string public defaultDescription = "Welcome to the future of gaming. Forge is a social platform where you can earn rewards by playing games and participating in the community. This NFT unlocks special utility, find out more XXXX TKTKTKT";
    string public specialVariantDescription = "Welcome to the future of gaming. Forge is a social platform where you can earn rewards by playing games and participating in the community. This NFT unlocks special utility, find out more XXXX TKTKTKT";
    // display types
    ...
    function generateImgUrl(bool isSpecialVariant) internal view returns (string memory) {
        return string(abi.encodePacked(baseURI, isSpecialVariant ? specialVariantURI : defaultURI));
    }
