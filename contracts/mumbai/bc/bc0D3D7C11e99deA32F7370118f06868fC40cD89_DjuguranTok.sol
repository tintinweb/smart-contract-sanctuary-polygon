...
/*
    HIBURAN MCIN. WALLET MARKETING KANGGO MARKETING TENANAN.
    PROFITE INYONG KARO TIM MUNG SEKANG LP TOK.
    INTINE NEK DIRUG UTAWA HONEYPOT TK KIRIM BALIK DUITE!

    https://t.me/djugurantoken
...
contract DjuguranTok is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Djuguran Tok";
    string private _symbol = "Djuguran";
    uint8 private _decimals = 8;

    address payable public marketingWalletAddress = payable(0xFba4a88058f75731d5246E08B15286d8e13fd657); 
    address payable public teamWalletAddress = payable(0x0A47B67E527694A3Ac97C4276548da553Cfd448f); 
    ...
    uint256 private _totalSupply = 6900000 *  10**4 * 10**_decimals;
