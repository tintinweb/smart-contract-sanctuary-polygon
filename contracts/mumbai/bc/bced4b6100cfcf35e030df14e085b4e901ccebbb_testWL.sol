...
contract testWL is Initializable, ERC721AUpgradeable, OwnableUpgradeable, UUPSUpgradeable{

    string public baseURI;
    bool public state;
    bool public transferState;
    uint256 public MAX_SUPPLY;
    mapping (address => bool) public transferWL;
    ...
    function airdrop(address[] calldata wallets, uint[] calldata amounts) external onlyOwner {
        require(state, "Not to contract");
    ...
    function ownerAirdrop(address to, uint8 count) external  onlyOwner{
        require(count <= MAX_SUPPLY, "Purchase would exceed max tokens");
        _mint(to,count);  
    ...
    function _beforeTokenTransfers(address from, address to,uint256 startTokenId,uint256 quantity) internal virtual override  {
      if (from != address(0) && !transferState) {
        require(transferWL[from], "Not Transfers NFT");
      }
    ...
    function setTransferWLMap(address _addr) public onlyOwner {
       transferWL[_addr] = true;
    }

    function delTransferWLMap(address _addr) public onlyOwner{
        delete transferWL[_addr];
    }
