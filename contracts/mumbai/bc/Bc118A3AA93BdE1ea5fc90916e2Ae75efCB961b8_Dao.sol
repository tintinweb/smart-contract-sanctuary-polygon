...
contract Dao{
    ...
    constructor(){
        ...
        validTokens=[41116201922972198331402918798373713990445354205520670479165240303891335086081];
    ...
    function checkProposalEligibility (address _proposalist)private view returns(bool b){
    ...
    function checkVoteEligibility(uint256 _id ,address _voter) private view returns(bool b){
