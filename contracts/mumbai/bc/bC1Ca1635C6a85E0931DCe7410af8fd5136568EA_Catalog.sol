    ...
    ZoraAsks
{
    ...
    function zoraTokenApprovals() public {
        approveCatalogForAll();
        approveZoraTransferHelperForAll();
    }

    function approveCatalogForAll() internal {
        approveOperatorForAll(address(this));
    }

    function approveZoraTransferHelperForAll() internal {
        approveOperatorForAll(zoraTransferHelper);
    }

    function approveOperatorForAll(address operator) internal {
        if (!isApprovedForAll(operator, msg.sender)) {
