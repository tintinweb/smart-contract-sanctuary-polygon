...
import "./GradisERC1155Token.sol";

contract GradisFactoryERC1155 {

    GradisERC1155Token[] public tokens; //an array that contains different ERC1155 tokens deployed
    ...
    */
    function deployERC1155(string memory _contractName, string memory _uri, uint[] memory _ids, string[] memory _names) public returns (address) {
        GradisERC1155Token t = new GradisERC1155Token(_contractName, _uri, _names, _ids);
        tokens.push(t);
    ...
    */
    ...
    {
        GradisERC1155Token token = tokens[_index];
...
contract GradisERC1155Token is ERC1155, Ownable {
