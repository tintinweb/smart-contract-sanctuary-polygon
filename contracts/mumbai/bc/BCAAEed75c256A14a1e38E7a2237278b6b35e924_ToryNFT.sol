...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    function _mint(address to, uint256 quantity) internal virtual {
        ...
        require(quantity > 0, "ERC721A: quantity can not be zero");
...
abstract contract ERC721Permit is ERC721A {
    ...
    bytes32 private constant NAME_HASH = keccak256("ToryNFT");
    ...
    function permit(
        ...
        require(deadline >= block.timestamp, "ERC721permit: expired deadline");
...
contract ToryNFT is ERC721Permit, ERC721URI, ERC721Mintable {
    constructor(
        string memory name,
    ...
    function _mint(address to, uint256 quantity) internal override(ERC721A) {
        super._mint(to, quantity);
    }

    function _multiMint(address[] memory to) internal override( ERC721A) {
        super._multiMint(to);
    }
}