...
contract MultiNFT is ERC1155URIStorage, ERC1155Supply, Ownable  {
    ...
    function createNft(string memory tokenURI, uint256 quantity) public returns (uint256 index) {
        index = _itemIds.current();
        _itemIds.increment();

        _mint(msg.sender, index, quantity, "");
