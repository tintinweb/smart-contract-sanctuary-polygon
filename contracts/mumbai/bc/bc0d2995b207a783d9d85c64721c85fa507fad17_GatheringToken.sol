...
//    ERC20Token tipTokenInstance = ERC20Token(tipTokenAddress);
...
//    tipTokenInstance.allowance(sender, address(tipTokenInstance));
//    tipTokenInstance.approve(sender, amount);
    require(tipTokenInstance.balanceOf(msg.sender) >= amount , "Your balance is too low" );
    tipTokenInstance.transferFrom(msg.sender, address(this), amount);
