...
contract SellFeeDistributor is ISellFeeDistributor, Ownable, Exchange {
    ...
    constructor(address _revenueShare, address _usdc, address _tngbl, address _WETH9, address _router)
        Exchange(_router, _WETH9){
        USDC = IERC20(_usdc);
        TNGBL = IERC20(_tngbl);
    ...
    function setPercentages(uint256 _revenuePercent, uint256 _burnPercent) external onlyOwner{
        require((_revenuePercent + _burnPercent) == 99999999999, "Wrong percentages");
