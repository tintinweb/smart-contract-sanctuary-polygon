...
contract R3v3nge is ERC721A, Pausable, Ownable {
    ...
    string private metadataBaseURI = "https://polyland-api-dot-tools-303211.nw.r.appspot.com/lootbox/metadata/";
    string private collectionBaseURI = "https://polyland-api-dot-tools-303211.nw.r.appspot.com/lootbox/collection/";
    ...
    constructor() ERC721A("r3v3nge", "r3v3nge") {
    }
    ...
    verifyCoupon(coupon, couponType)
    {
        ...
        require(couponType == CouponType.FreeMint, "Only FreeMint is available");
