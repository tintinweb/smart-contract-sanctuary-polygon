...
contract CryptoPriceFeed is ChainlinkClient {
    ...
    string public latestSymbol;
    bytes32 public latestRequestId;
    bytes32 public latestRequestedId;
        ...
        recordChainlinkFulfillment(_requestId)
    {
        ...
        latestSymbol = _symbol;
        latestPrice = _returnedPrice;
        latestRequestId = _requestId;
        // console.log("Latest price is :", latestPrice);
        // console.log("Latest symbol is :", latestSymbol);
