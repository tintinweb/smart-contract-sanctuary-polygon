...
contract EQ8token is BasicMetaTransaction, MinterRole {
     ...
     */
    function _mint(address account, uint256 amount) external onlyMinter(_msgSender()) virtual {
     ...
     */
    function _burn(address account, uint256 amount) external onlyMinter(_msgSender()) virtual {
...
import "contracts/libraries/Roles.sol";
