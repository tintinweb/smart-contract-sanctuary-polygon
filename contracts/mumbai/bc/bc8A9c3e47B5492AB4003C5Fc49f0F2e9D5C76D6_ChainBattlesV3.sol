...
// data:image/svg+xml;base64,

contract ChainBattlesV3 is ERC721URIStorage {
    using Strings for uint256;
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    //mapping(uint256 => uint256) public tokenIdToStr;
    ...
    mapping(uint256 => Characters) public tokenIdToStats;
    ...
    function generateCharacter(uint256 tokenId) public returns (string memory) {
        bytes memory svg = abi.encodePacked(
            ...
            "<g>",
            '<svg x="30%" y="32%" fill="#000000" width="60px" height="60px" viewBox="0 0 128 128" enable-background="new 0 0 128 128" version="1.1" xml:space="preserve" xmlns="http://www.w3.org/2000/svg">',
            ...
            "</svg>",
            "</g>",
            '<text x="56%" y="41%" class="base" dominant-baseline="middle" text-anchor="middle">',
            "Warrior",
            "</text>",
            '<text x="50%" y="54%" class="base" dominant-baseline="middle" text-anchor="middle">',
            "Level: ",
            getLevels(tokenId),
            "</text>",
            '<text x="50%" y="64%" class="base" dominant-baseline="middle" text-anchor="middle">',
            "Strength: ",
            getStr(tokenId),
            "</text>",
            "</svg>"
    ...
    function getStr(uint256 tokenId) public view returns (string memory) {
        uint256 str = tokenIdToStats[tokenId].str;
        return str.toString();
    }
    ...
    function mint() public {
        ...
        Characters storage character = tokenIdToStats[newItemId];
    ...
    function train(uint256 tokenId) public {
        ...
        require(
            ...
            "You must own this token to be able to train it"
        );
        uint256 currentLevel = tokenIdToStats[tokenId].level;
        tokenIdToStats[tokenId].level = currentLevel + 1;
        uint256 currentStr = tokenIdToStats[tokenId].str;
        tokenIdToStats[tokenId].str = currentStr + 3;
