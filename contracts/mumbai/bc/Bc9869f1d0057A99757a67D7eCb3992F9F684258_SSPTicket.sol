...
contract SSPTicket is ERC1155PresetMinterPauser {
    ...
    TicketID public mintPhase = TicketID.PublicSale;
    ...
    string constant public name = "SSPTicket";
    string constant public symbol = "SSPTT";
    ...
    function pushMultiWL(address[] memory list, uint256[] memory maxMintList) public virtual onlyRole(MINTER_ROLE) {
        for (uint256 i = 0; i < list.length; i++) {
            whiteLists[list[i]] = maxMintList[i];
        }
    }

    function setPresale(bool _state) public onlyRole(MINTER_ROLE) {
        presale = _state;
    }
