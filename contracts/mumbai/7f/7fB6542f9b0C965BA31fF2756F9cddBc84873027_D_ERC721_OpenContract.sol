...
contract D_ERC721_OpenContract is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function getTokenStorage(
        ...
        return getERC721Storage().tokens[tokenId];
    }
    ...
    function getTokenKeyId(
        ...
        return getERC721Storage().backendTokenKeyToId[tokenKey_];
    }
    ...
    function getTokenURI(
        ...
        return getTokenStorage(tokenId).uri;
    }
    ...
    function mint(
        ...
        LibDiamond.ERC721Storage storage ds = getERC721Storage();
        require(
    ...
    function getTokenData(
        ...
        return LibDiamond.Token({uri: getTokenURI(tokenId_)});
    }
    ...
    function getTokenKeyList() external view returns (string[] memory) {
        return getERC721Storage().keyFallback;
    }
    ...
    function contractURI() external view returns (string memory) {
        return getERC721Storage().contractUri;
    }
    ...
    function balanceOf(
        ...
        return getERC721Storage().balances[owner];
    }
    ...
    function symbol() public view virtual override returns (string memory) {
        return getERC721Storage().symbol;
    }
    ...
    function getApproved(
        ...
        return getERC721Storage().tokenApprovals[tokenId];
    }
    ...
    function isApprovedForAll(
        ...
        return getERC721Storage().operatorApprovals[owner][operator];
    }
    ...
    function _ownerOf(uint256 tokenId) internal view virtual returns (address) {
        return getERC721Storage().owners[tokenId];
    }
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        getERC721Storage().tokenApprovals[tokenId] = to;
    ...
    function _setApprovalForAll(
        ...
        getERC721Storage().operatorApprovals[owner][operator] = approved;
    ...
    function __unsafe_increaseBalance(
        ...
        getERC721Storage().balances[account] += amount;
    }
}
