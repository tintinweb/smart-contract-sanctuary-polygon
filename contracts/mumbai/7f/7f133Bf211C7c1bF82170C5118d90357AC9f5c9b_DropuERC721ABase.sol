...
import {BaseConfig, DropuStorage} from "../libraries/DropuStorage.sol";
...
contract DropuERC721ABase is DropuERC721AUpgradeable, IERC2981Upgradeable {
    ...
    function initialize(
        ...
        DropuStorage.state().cfg = _config;
        ...
        if (_config.publicSaleStartTime > 0 && _config.publicSaleEndTime == 0) {
            DropuStorage.state().cfg.publicSaleEndTime =
        ...
        if (_config.publicSaleEndTime > 0 && _config.publicSaleStartTime == 0) {
            DropuStorage.state().cfg.publicSaleStartTime = uint32(
                block.timestamp
            );
        }
        ...
        if (_config.presaleStartTime > 0 && _config.presaleEndTime == 0) {
            DropuStorage.state().cfg.presaleEndTime =
        ...
        if (_config.presaleEndTime > 0 && _config.presaleStartTime == 0) {
            DropuStorage.state().cfg.presaleStartTime = uint32(
                block.timestamp
            );
        }
    }
    ...
    view
    virtual
    override(DropuERC721AUpgradeable, IERC165Upgradeable)
    returns (bool)
    {
        return DropuERC721AUpgradeable.supportsInterface(interfaceId);
    }
    ...
    function setBaseURI(string calldata _newBaseURI) external onlyOwner {
        ...
        DropuStorage.state().cfg.uriBase = _newBaseURI;
    }
    ...
    function freezeMetadata() external onlyOwner {
        DropuStorage.state().advCfg.metadataFrozen = true;
    }
    ...
    function setPublicSaleState(bool _saleActiveState) external onlyOwner {
        DropuStorage.state().cfg.publicSaleActive = _saleActiveState;
    }
    ...
    function setPublicPrice(uint32 _publicPrice) external onlyOwner {
        DropuStorage.state().cfg.publicPrice = _publicPrice;
    }
    ...
    function setPublicMintsAllowedPerAddress(
        ...
        DropuStorage.state().cfg.publicMintsAllowedPerAddress = _mintsAllowed;
    }
    ...
    function setPublicSaleStartTime(
        ...
        DropuStorage.state().cfg.publicSaleStartTime = _publicSaleStartTime;
    }
    ...
    function setPublicSaleEndTime(
        ...
        DropuStorage.state().cfg.publicSaleEndTime = _publicSaleEndTime;
    }
    ...
    function setUsePublicSaleTimes(
        ...
        DropuStorage.state().cfg.usePublicSaleTimes = _usePublicSaleTimes;
    }
