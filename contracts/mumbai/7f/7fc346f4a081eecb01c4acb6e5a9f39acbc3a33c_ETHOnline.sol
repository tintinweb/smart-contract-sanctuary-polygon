...
contract ETHOnline is ERC721Holder {
    ...
    function createTable() external payable {
        ...
        tableName = string.concat(
            _tablePrefix,
            "_",
            StringsUpgradeable.toString(block.chainid), // 80001
            "_",
    ...
    function writeToTable(string memory message) external payable {
        // INSERT INTO prefix_chainId_tableId (id, message) VALUES (_counter, message)
        _tableland.runSQL(
            address(this),
            _tableId,
            string.concat(
