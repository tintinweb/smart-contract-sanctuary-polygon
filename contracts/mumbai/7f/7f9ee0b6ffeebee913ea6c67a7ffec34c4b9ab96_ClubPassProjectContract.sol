  ...
  abstract contract Allowlist is Ownable {
        ...
        Allowlist
    {
        ...
        */
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, "Cannot mint over supply cap of 49");
      ...
      require(mintingOpen == true && onlyAllowlistMode == false, "Public minting is not open right now!");    
        ...
        */
        function mintToMultiple(address _to, uint256 _amount) public payable {
            ...
            require(currentTokenId() + _amount <= SUPPLYCAP, "Cannot mint over supply cap of 49");
    ...
    contract ClubPassProjectContract is ERC721Tradable {
        ...
        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmY4N5iVws3z8RgXk7mSCkVpio2Sq69vh4Zb9QYmSUGYme/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/pMZa7oXF4E4AQDM73hC6/contract-metadata";
        }
    }