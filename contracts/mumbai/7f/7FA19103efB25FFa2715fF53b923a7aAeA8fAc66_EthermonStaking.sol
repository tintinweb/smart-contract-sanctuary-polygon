...
contract EthermonStaking is EthermonStakingBasic, EthermonEnum {
    ...
    bytes32 public appHash =
        0xf3ea384cf308a185038d61230ee5ebefee0523ab3a50323645b91d3527e9bdac;
    ...
    function CheckHash(bytes32 _appSecret) external {
    ...
    function depositeTokens(
        ...
        //require(keccak256(abi.encodePacked(_appSecret)) == appHash);
