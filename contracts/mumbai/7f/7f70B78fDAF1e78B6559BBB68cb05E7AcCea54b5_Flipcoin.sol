...
contract Flipcoin {
    ...
    uint256 private _playersPerLobby = 2; // Количество игроков в каждой ставке
    ...
    function placeBet(uint256 betAmount) external {
        ...
        if (_betAddresses.length == _playersPerLobby) {
            ...
            delete _betLobbies[winner];
            delete _betLobbies[lobby[1 - winnerIndex]];
