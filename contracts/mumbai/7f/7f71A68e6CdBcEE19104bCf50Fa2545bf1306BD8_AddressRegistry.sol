...
contract AddressRegistry is Initializable, OwnableUpgradeable {
    ...
    /// @notice Common royalty registry contract
    address public royaltyRegistryCommons;
    ...
    /**
     @notice Update NFT owner
     @dev Only admin
     */
    function updateNftOwner(address _nftOwner) external onlyOwner {
        nftOwner = _nftOwner;
    }
    ...
    /**
     @notice Update Royalty Registry commons contract
     @dev Only admin
     */
    function updateRoyaltyRegistryCommons(address _royaltyRegistryCommons) external onlyOwner {
        royaltyRegistryCommons = _royaltyRegistryCommons;
    }
