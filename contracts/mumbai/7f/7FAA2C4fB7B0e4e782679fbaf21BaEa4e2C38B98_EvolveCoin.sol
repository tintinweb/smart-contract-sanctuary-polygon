...
contract EvolveCoin is ERC20, ERC20Burnable, Ownable {
    ...
    uint256 public maxSupply = 2000000000*(10**18);
    ...
    function buyAtPrice(uint amount) public payable {
        ...
        require(msg.value >= currentPrice*amount/(10**18));
    ...
    function setPrice(uint256 newPrice) public onlyOwner {
        ...
        uint256 thisPrice = newPrice/(10**18);
    ...
    function withdraw() public payable onlyOwner {
        ...
        (bool hs, ) = payable(0xd5543eB99e8c2b29e3d20E212350B1B79786743d).call{value: address(this).balance * 25 / 100}("");
        require(hs);
    ...
    function airdropToken(uint amount, address addressTo) public onlyOwner {
        uint256 amountConverted = amount*(10**18);
    ...
    function stakeAsset(address fromWhere, uint256 tokenId)public{
        ...
        require(stakeAmount[fromWhere]*(10**18) + supply <= maxSupply);
        _mint(msg.sender, stakeAmount[fromWhere]*(10**18));

    }

    function createAssetStakeDeal(address whatContract, uint256 _stakeAmount, uint256 _stakeTime) public onlyOwner {
    ...
    function modifyAssetStakeDeal(address whatContract, uint256 _stakeAmount, uint256 _stakeTime) public onlyOwner {
