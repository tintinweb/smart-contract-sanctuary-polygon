...
contract Prueba is ERC721URIStorage, AccessControl {
    ...
    constructor(
        ...
        _setupRole(DEFAULT_ADMIN_ROLE, royaltyAddresses[0]);
        _setupRole(DEFAULT_ADMIN_ROLE, royaltyAddresses[1]);
    }
    ...
    function giveawayMint(uint256 quantity, address to) external {
    ...
    function setIsPresaleOpen(bool _isPresaleOpen) external {
        require(hasRole(ADMIN_ROLE, msg.sender), "Caller is not a Admin");
        if(_isPresaleOpen){
            isPaused = false;
    ...
    function setIsPublicSaleOpen(bool _isPublicSaleOpen) external {
        require(hasRole(ADMIN_ROLE, msg.sender), "Caller is not a Admin");
    ...
    function setIsTokenURIRevealed(bool _isTokenURIRevealed, string memory _tokenURIPrefix) external {
        require(hasRole(ADMIN_ROLE, msg.sender), "Caller is not a Admin");
    ...
    function setGiveawaySupply(uint256 _giveawaySupply) external {
        require(hasRole(ADMIN_ROLE, msg.sender), "Caller is not a Admin");
        giveawaySupply = _giveawaySupply;
    }

    function setPresaleSupply(uint256 _presaleSupply) external {
        require(hasRole(ADMIN_ROLE, msg.sender), "Caller is not a Admin");
        presaleSupply = _presaleSupply;
    }

    function setPresalePrice(uint256 _presalePrice) external {
        require(hasRole(ADMIN_ROLE, msg.sender), "Caller is not a Admin");
        presalePrice = _presalePrice;
    }

    function setMaxPerPresaleTx(uint256 _maxPerPresaleTx) external {
        require(hasRole(ADMIN_ROLE, msg.sender), "Caller is not a Admin");
    ...
    function setMaxPerPublicSaleTx(uint256 _maxPerPublicSaleTx) external {
        require(hasRole(ADMIN_ROLE, msg.sender), "Caller is not a Admin");
    ...
    function setTokenURISuffix(string memory _tokenURISuffix) external {
        require(hasRole(ADMIN_ROLE, msg.sender), "Caller is not a Admin");
        tokenURISuffix = _tokenURISuffix;
    }   

    function setHiddenTokenURI(string memory _hiddenTokenURI) external {
        require(hasRole(ADMIN_ROLE, msg.sender), "Caller is not a Admin");
        hiddenTokenURI = _hiddenTokenURI;
    }
