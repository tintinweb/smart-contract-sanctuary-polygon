...
contract BCChars is ERC721URIStorage, Ownable, BCUtils {
    ...
    function setContractAddresses(address _lobbyContractAddress, address _gameContract) public onlyOwner {
    ...
    constructor() ERC721("Black Comet Characters", "BCC") {
        // TODO: Mint special launch characters?
    }
    ...
    function enlistChar(uint _charId) public payable {
        ...
        safeTransferFrom(msg.sender, address(gamesContract), _charId);
