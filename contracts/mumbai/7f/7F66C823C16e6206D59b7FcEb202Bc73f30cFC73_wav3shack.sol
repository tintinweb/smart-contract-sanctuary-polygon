...
contract wav3shack {
    ...
    mapping(uint256 => PostData) _dataByProfile;
    ...
    constructor(uint256 fee, address modulens) {
        i_modulens = modulens;
        i_fee = fee;
    }
     ...
     * @param profileIdWallet The ID of the profile that initiated the mirror.
     * @param profileIdPointed The ID of the profile that was mirrored.
     */
    function processMirror(
        address profileIdWallet,
        uint256 profileId,
        uint256 profileIdPointed /* uint256 pubIdPointed,
        bytes calldata data*/
    ) external {
        ...
        address __currency = _dataByProfile[profileIdPointed].currency;
        // Get the reward for the post pointed to
        uint256 __reward = _dataByProfile[profileIdPointed].reward;
...
*/
        ...
        s_followerHasMirrored[profileIdPointed][profileId] = true;
    }
    ...
    function fundMyGlobalBudget(
        ...
        _dataByProfile[profileId].reward = _reward;
        _dataByProfile[profileId].currency = _currency;
        ...
        IERC20(_currency).safeTransferFrom(profileIdWallet, address(this), globalBudget);
