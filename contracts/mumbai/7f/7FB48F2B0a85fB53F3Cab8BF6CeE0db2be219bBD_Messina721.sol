    ...
    IMessina721
{
    ...
    function mintNFT(address recipient, string memory tokenURI) external returns (uint256) {
        ...
        string memory baseURI = "https://mirrorpass.mypinata.cloud/ipfs/Qmem34kVeCAzqeqT3pmnfs8sBFqqAWJ7J79RvvWPPcTnJy/";

        _mint(recipient, newTokenId, string(abi.encodePacked(baseURI, idStr)), '');
        return newTokenId;
    }
