    ...
    
{
    ...
    mapping(address => uint256) internal nullifierHashes2;
     ...
     */
    // function initialize( Im3taQuery initqueryContract, ILensHub hub)
    function initialize( Im3taQuery initqueryContract) public initializer {
    // function initialize( Im3taQuery2 initqueryContract) public initializer {

        worldId = IWorldID(0xABB70f7F39035586Da57B3c8136035f87AC0d2Aa);

        groupId = 1;

        // Initializing the Statements and Queries for Tableland!
         _queryContract = initqueryContract;
        __Ownable_init();
        __UUPSUpgradeable_init();
        // Initializing the Lens Protocol Profile Creator to interact 
    ...
    function verifyAndExecute(
        ...
        nullifierHashes2[msg.sender] = nullifierHash;
