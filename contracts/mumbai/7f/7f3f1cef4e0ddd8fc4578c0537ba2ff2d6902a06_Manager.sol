...
contract Manager is VRFConsumerBaseV2 
{
 ...
 // Your subscription ID.
  ...
  bytes32 constant private KEY_HASH = 0xcc294a196eeeb44da2888d17c0625cc88d70d9760a69d58d853ba6581a9ab0cd;
  ...
  */
  constructor(uint64 subId) VRFConsumerBaseV2(0xAE975071Be8F8eE67addBC1A82488F1C24858067) 
  {
    ...
    _aggregator["WETH"] = 	0xF9680D99D6C9589e2a93a78A04A279e509205945;
    _aggregator["WMATIC"]  = 0xAB594600376Ec9fD91F8e885dADF0CE036862dE0;
...
/// @notice creation init raffle contract 
  ...
  {
       int p = 0;
       if(_aggregator[symbol]==address(0))
       {
          p = 1e18;
       }
       else
