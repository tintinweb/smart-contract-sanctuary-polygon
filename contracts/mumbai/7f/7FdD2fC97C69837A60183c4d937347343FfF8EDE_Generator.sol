...
contract Generator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    uint256[] public winningTicketsPosn;
        ...
        override
    {
        ...
        winningTicketsPosn = expand(randomness);
    }
    ...
    function expand(
        ...
        for (uint256 i = 0; i < noOfWinners; i++) {
            winningTicketsIDs[i] =
                (uint256(keccak256(abi.encode(randomValue, i))) % 100) +
                1;
        }
