    ...
    AccessControlUpgradeable
{
    ...
    function initialize() public initializer {
        ...
        _grantRole(AmberfiLib.AMBERFI_OWNER, _msgSender());

        emit AmberfiLib.MarketOwnerRoleGranted(_msgSender());
    }

    function pauseAmberfi() external onlyRole(AmberfiLib.AMBERFI_OWNER) {
        _pause();

        emit AmberfiLib.AmberfiPaused();
    }

    function unpauseAmberfi() external onlyRole(AmberfiLib.AMBERFI_OWNER) {
        _unpause();
    ...
    {
        _grantRole(AmberfiLib.AMBERFI_OWNER, account_);
    ...
    function revokeAmberfiOwner(address account_)
        ...
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        _revokeRole(AmberfiLib.AMBERFI_OWNER, account_);
    ...
    function grantMarketOwner(address account_)
        external
        onlyRole(AmberfiLib.AMBERFI_OWNER)
    {
        _grantRole(AmberfiLib.MARKET_OWNER, account_);
    ...
    function revokeMarketOwner(address account_)
        ...
        onlyRole(AmberfiLib.AMBERFI_OWNER)
    {
        _revokeRole(AmberfiLib.MARKET_OWNER, account_);
    ...
    function grantKycVerifier(address account_)
        ...
        onlyRole(AmberfiLib.AMBERFI_OWNER)
    {
        _grantRole(AmberfiLib.KYC_VERIFIER, account_);
    ...
    function revokeKycVerifier(address account_)
        ...
        onlyRole(AmberfiLib.AMBERFI_OWNER)
    {
        _revokeRole(AmberfiLib.KYC_VERIFIER, account_);
        ...
        onlyRole(AmberfiLib.AMBERFI_OWNER)
    {
        ...
        if (!hasRole(AmberfiLib.MARKET_OWNER, marketOwner_)) {
    ...
    function pauseMarket(uint256 marketId_) public {
        if (!hasRole(AmberfiLib.MARKET_OWNER, _msgSender())) {
