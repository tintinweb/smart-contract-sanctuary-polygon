...
// File contracts/RealLionsDNA.sol



pragma solidity ^0.8.0;

contract RealLionsDNA {
...
contract RealLions is ERC721, ERC721Enumerable, RealLionsDNA {
    ...
    constructor(uint256 _maxSupply) ERC721("The Real Lions", "TRL") {
        maxSupply = _maxSupply;
    }

    function mint() public {
        uint256 current = _idCounter.current();
        require(current < maxSupply, "No RealLions left :(");
