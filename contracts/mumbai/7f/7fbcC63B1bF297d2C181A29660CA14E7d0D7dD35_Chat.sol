...
contract Chat {
    ...
    string public GroupID = "1";


    function incrementGrpID(string memory number) public returns (string memory){
        string memory OldGroupID = GroupID;
        GroupID = number;
        return OldGroupID;
    }
  ...
  //--------------------------------------------------------------------------------------   
   ...
   require(walletAddress != address(0), "User with given address does not exist.");
    ...
    function sendMessage(address receiver, string calldata subject, string memory message, string memory fileHash, string memory GroupID) external {
        require(
        ...
        Message memory message = Message(msg.sender, receivers, subject, message, block.timestamp, false, fileHash, GroupID);
