...
interface ICedarDeployerAddedV8 {
    function deployCedarERC1155DropV2(
        address _defaultAdmin,
        string memory _name,
        string memory _symbol,
        string memory _contractURI,
        ...
        uint128 _platformFeeBps,
        address _platformFeeRecipient
    ) external returns (ICedarERC1155DropV2);

    function deployCedarERC721DropV4(
        address _defaultAdmin,
        string memory _name,
        string memory _symbol,
        string memory _contractURI,
        ...
        uint128 _platformFeeBps,
        address _platformFeeRecipient
    ) external returns (ICedarERC721DropV4);
}
...
interface ICedarDeployerV7 is
    ICedarDeployerEventsV5,
    ICedarDeployerAddedV8,
    ICedarDeployerAddedV3,
    ICedarDeployerAddedV2,
    ICedarDeployerIntrospectionV0
{}
...
interface ICedarERC721DropV4 is
    ICedarFeaturesV0,
    ICedarVersionedV0,
    IMulticallableV0,
    ICedarAgreementV0,
...
interface ICedarERC1155DropV2 is
    ICedarFeaturesV0,
    ICedarVersionedV0,
    IMulticallableV0,
    ICedarSFTIssuanceV1,
