...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    uint256 internal _totalSupply = 1;
    ...
    */
    ...
    function mint(address to, string memory uri, uint256 supply) external override {
        ...
        require(tokenCounter <= _totalSupply,"Embers: Mint limit exceeds");
        _mint(to, tokenCounter, supply, uri, rFee);
...
contract ELITES1155 is ERC1155 {
