    ...
    AccessControl
{
    ...
    function mintLoanNft(
        ...
        uint totalAmount = _details.borrowerShare+ _details.foundationShare;
    ...
    function _prepaidPostpaid(LoanLib.Loan memory _details) internal {
        ...
        if (_details.isPrepaid) {
            Paza.transferFrom(_details.bank, defiWallet, (totalPaza * defiSharePercent) / PCT_BASE);
            ...
            Paza.transferFrom(
                _details.bank,
                pools[_details.bank],
                (_details.borrowerShare * borrowerSharePercent) / PCT_BASE
            );
        } else {
            ...
            Paza.safeTransfer(defiWallet, (totalPaza * defiSharePercent) / PCT_BASE);
            Paza.safeTransfer(
                pools[_details.bank],
               (_details.borrowerShare * borrowerSharePercent) / PCT_BASE
            );
