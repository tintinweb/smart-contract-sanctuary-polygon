...
contract InitDiamond {
    ...
    function init(Args memory _args) external {
        ...
        s.domainSeparator = LibMeta.domainSeparator("BadgesDiamond", "V1");

        s.collectibleName = _args.collectibleName;
        s.collectibleSymbol = _args.collectibleSymbol;
        s.collectibleMaxSupply = _args.collectibleMaxSupply;
        s.collectibleContractURI = _args.collectibleContractURI;
        s.collectibleTokenURI = _args.collectibleTokenURI;
