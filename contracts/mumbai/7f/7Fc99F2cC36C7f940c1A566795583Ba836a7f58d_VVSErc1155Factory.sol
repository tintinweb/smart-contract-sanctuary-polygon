...
/// @title Interface for VVSErc1155


pragma solidity ^0.8.9;


interface IVVSErc1155 { 
    /**
    ...
    */
    ...
    function preSale(uint256 _tokenId, uint256 _amount, bytes memory _data) external;
...
import { IVVSErc1155 } from "./interfaces/IVVSErc1155.sol";
...
contract VVSErc1155Factory is IVVSErc1155Factory, IVVSErc1155FactoryInitializer, OwnableUpgradeable {
    ...
    */
    ...
    function createCollection(
        ...
        IVVSErc1155(collectionAddress).transferOwner(_msgSender());
