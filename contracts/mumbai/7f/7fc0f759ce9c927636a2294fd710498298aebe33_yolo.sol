...
contract yolo is ERC721, ERC721Enumerable, Ownable {
    using SafeMath for uint256;

    uint256 public constant MAX_ALLOW_LIST_MINT = 2;
    uint256 public constant MAX_TO_MINT=2;
    uint256 public constant MAX_SUPPLY=4;
    uint256 public constant MINT_PRICE=0.013 ether;
