...
contract MetaHumanGovernor is Governor, GovernorSettings, CrossChainGovernorCountingSimple, GovernorVotes, GovernorVotesQuorumFraction, GovernorTimelockControl {
    ...
    */
    ...
    GovernorSettings(1 /* 1 block */, 5 * 60 * 10 /* 10 hours */, 0) //TODO in production voting period needs to be changed to some reasonable value, right now it's 5 blocks for testing
