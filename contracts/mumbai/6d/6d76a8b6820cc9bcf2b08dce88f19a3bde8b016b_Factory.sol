...
contract Factory is AccessControlUpgradeable {
  ...
  function __KwikTrustFactory_init() external initializer {
    ...
    grantRole(DEPLOYER_ROLE, _msgSender());
  }

  /**
   * @dev Deploy the KwikTrust ERC721 contract
   * @param _name Token name
   * @param _symbol Token symbol
   * @param _minterAddress address that can mint the NFTs
   * @param _validatorAddress address that can validate the Lazy minting
   */
  ...
  function deployMintingContract(
    ...
    KwikTrustNFT nftContract = new KwikTrustNFT(_name, _symbol, _minterAddress, _validatorAddress);
...
contract KwikTrustNFT is ERC721URIStorage, EIP712, AccessControl {
    ...
    constructor(
        ...
        grantAccessRole(MINTER_ROLE, _roleAddress, _roleAddress);
        grantAccessRole(VALIDATOR_ROLE, _roleAddress, _validator);
    }
