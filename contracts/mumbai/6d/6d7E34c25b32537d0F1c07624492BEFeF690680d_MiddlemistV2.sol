...
interface ListingFeeInfo {
    ...
    // function getListingRecipientAddressInfo(uint256 _tokenId) external view returns(address[] memory receipient );
    // function getListingPercentageInfo(uint256 _tokenId) external view returns(uint96[] memory lisitngPercentage );
}
...
contract MiddlemistV2 is ERC721,Ownable,ERC721URIStorage,ERC721Enumerable,ERC721Burnable,Pausable, RoyaltiesV2Impl,RoyaltiesInfo, ListingFeeInfo {
    ...
    //collection based Royalty Fee in percentage
    ...
    // struct ListingReceipientInfo {
    //      uint256 tokenId;
    //      address[] listingReceipient;
    //      uint96[] percentageBasisPoints;
    // }

    mapping(uint256 => RoyaltyReceipientInfo) private royaltyReceipientInfo;
    //mapping(uint256 => ListingReceipientInfo) private listingReceipientInfo;
    ...
    constructor() ERC721("Krishna", "MIN") {
    ...
    // function setListingReceipientInfo(uint256 tokenId, address[] memory Recipients, uint96[] memory listingPercentage)  public onlyOwner{
    //     require(_exists(tokenId), "ERC721: operator query for nonexistent token");
    //     for (uint j = 0; j < Recipients.length; j++) {
    //         require(Recipients[j] != address(0x0), "Recipient should be present");
    //     }
    //     listingReceipientInfo[tokenId] =  ListingReceipientInfo(
    //         tokenId,
    //         Recipients,
    //         listingPercentage
    //     );
    ...
    // function getListingRecipientAddressInfo(uint256 _tokenId) public override view returns(address[] memory receipient ){
    //     require(_exists(_tokenId), "ERC721: operator query for nonexistent token");
    //     ListingReceipientInfo storage listing = listingReceipientInfo[_tokenId];
    //     return listing.listingReceipient;
    // }
    
    // function getListingPercentageInfo(uint256 _tokenId) public override view returns(uint96[] memory lisitngPercentage ){
    //     require(_exists(_tokenId), "ERC721: operator query for nonexistent token");
    //     ListingReceipientInfo storage listing = listingReceipientInfo[_tokenId];
    //     return listing.percentageBasisPoints;
    // }
