...
contract CloudCitizens is ERC721A, ERC721AQueryable, Ownable, AccessControl {
    ...
    // Airdrop constants
    bytes32 public constant PRIVATE_SALE_MERKLE_ROOT = 0xfa9fb5ec6c4f880a88887ca5e6488317c469c48bdc64fd703d51f1aa38359521;
    ...
    constructor(string memory tokenURI) ERC721A("CloudCitizens", "CLOUDCITIZENS") {
    ...
    function validClaim(
        ...
        return MerkleProof.verify(merkleProof, PRIVATE_SALE_MERKLE_ROOT, node);
    }
    ...
    // TODO: Check if address already claimed? Now only limits per proof
    ...
    function _claim(address to, uint256 amount, string calldata code, bytes32[] calldata merkleProof) private {
        ...
        require(PRIVATE_SALE_MERKLE_ROOT != 0x0, "CloudCitizens: merkle root must be set");
