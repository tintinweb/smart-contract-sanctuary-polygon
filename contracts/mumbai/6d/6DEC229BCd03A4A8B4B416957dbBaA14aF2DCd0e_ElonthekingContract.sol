...
//*********************************************************************//
//
//    ________    ____  _   __   ________  ________   __ __ _____   ________
//    / ____/ /   / __ \/ | / /  /_  __/ / / / ____/  / //_//  _/ | / / ____/
//   / __/ / /   / / / /  |/ /    / / / /_/ / __/    / ,<   / //  |/ / / __  
//  / /___/ /___/ /_/ / /|  /    / / / __  / /___   / /| |_/ // /|  / /_/ /  
// /_____/_____/\____/_/ |_/    /_/ /_/ /_/_____/  /_/ |_/___/_/ |_/\____/   
//                                                                           
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x42189954a23e4A3d1d1A2dd6316244956bf8b5cE];
  address public erc20Payable = 0x42189954a23e4A3d1d1A2dd6316244956bf8b5cE;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://https://nftstorage.link/ipfs/bafybeihmt5mdnvej7b42y65u2mmnlplejv65mlapl3ys5kpliyu2pvpbni/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/Ox4W3NZ8cjdGXoYwDAYd/contract-metadata";
  }
...
// File: contracts/ElonthekingContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ElonthekingContract is RamppERC721A {
    constructor() RamppERC721A("ELON THE KING", "ELON"){}
}
