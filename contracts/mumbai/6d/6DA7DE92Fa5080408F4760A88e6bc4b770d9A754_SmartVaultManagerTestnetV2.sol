...
contract SmartVaultManagerTestnetV2 is ISmartVaultManager, Initializable, ERC721Upgradeable, OwnableUpgradeable {
    ...
    function completeUpgrade(address _nftMetadataGenerator) external {
    ...
    function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
        return INFTMetadataGenerator(nftMetadataGenerator).generateNFTMetadata(
            _tokenId, ISmartVault(smartVaultIndex.getVaultAddress(_tokenId)).status());
    }
