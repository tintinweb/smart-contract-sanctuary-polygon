...
contract VenusMe is ERC721, ERC721Royalty, ERC721Enumerable, Ownable {
    ...
    // everyone can see that this is the only function to withdraw the funds.
    ...
    // Unfortunately this concept does not work yet for Polygon blockchain,
    // because The Giving Block only supports MATIC on Ethereum blockchain.
    // We are working on creating a solution.
    // Follow @VenusMe14 on twitter or visit https://venusme.love for updates
