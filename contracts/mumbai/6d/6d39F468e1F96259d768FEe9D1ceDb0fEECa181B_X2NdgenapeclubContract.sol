...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x79D94572edCbdaeC1B96Efe2762cd0e8E9b5A9C5];
  address public erc20Payable = 0x79D94572edCbdaeC1B96Efe2762cd0e8E9b5A9C5;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 100, 20000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiadwuxvfx5rtrmm26itib7tzobluc2czdgxwp7bt6usyxnicxqemy/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 20000");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 20000");
...
// File: contracts/X2NdgenapeclubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract X2NdgenapeclubContract is RamppERC721A {
    constructor() RamppERC721A("2ndgenapeclub", "2GENAPE"){}
}
