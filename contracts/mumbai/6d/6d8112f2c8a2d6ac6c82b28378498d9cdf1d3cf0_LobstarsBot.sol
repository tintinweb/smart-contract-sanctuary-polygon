...
// File: LobstarsBot.sol


pragma solidity ^0.8.8;

/*
      __       _____      _____    _____    _______   ______  
     /\_\     ) ___ (   /\  __/\  ) ___ ( /\_______)\/ ____/\ 
    ( ( (    / /\_/\ \  ) )(_ ) )/ /\_/\ \\(___  __\/) ) __\/ 
     \ \_\  / /_/ (_\ \/ / __/ // /_/ (_\ \ / / /     \ \ \   
     / / /__\ \ )_/ / /\ \  _\ \\ \ )_/ / /( ( (      _\ \ \  
    ( (_____(\ \/_\/ /  ) )(__) )\ \/_\/ /  \ \ \    )____) ) 
    ...
    Lobstars Bot All Rights Reserved 2022
...
contract LobstarsBot is ERC721A, Manageable, DefaultOperatorFilterer, ReentrancyGuard {
    ...
    constructor() ERC721A("LobstarsBot", "LOBOTS") {}
        ...
        nonReentrant
    {
        ...
        if (msg.sender != _crossmintAddress && msg.sender != to) revert CallerIsNotCrossmintNorWalletOwner();
        ...
        if (!_stageAllowlist[currentStage.id][to]) revert NotInAllowlist();
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        uint64 bookingSlotId = tokenBookingSlotId(tokenId);
        return super.tokenURI(bookingSlotId);
    }
