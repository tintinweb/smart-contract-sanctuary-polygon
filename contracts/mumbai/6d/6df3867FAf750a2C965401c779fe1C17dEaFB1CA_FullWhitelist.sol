...
//| |_   | | | || || |  \ \ /\ / / | '_ \ | || __| / _ \| || |/ __|| __|
//|  _|  | |_| || || |   \ V  V /  | | | || || |_ |  __/| || |\__ \| |_ 
//|_|     \__,_||_||_|    \_/\_/   |_| |_||_| \__| \___||_||_||___/ \__|
//
...
contract FullWhitelist is ERC721A, Ownable, ReentrancyGuard, IERC2981 {
    using ECDSA for bytes32;
	using Strings for uint256;
    using SafeERC20 for IERC20;

	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/834/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/834/contract-uri";
    ...
    uint256 public tokenfyPresalePrice = 10000000000000000;
	...
	constructor(address _signerAddress) ERC721A("Full Whitelist", "LIST") {
