...
contract GoldHunter is ERC721, Ownable {
    ...
    function mint(uint _amount, bool _stake) public payable whenNotPaused {
        ...
        for (uint i = 0; i < _amount; i++) 
        {
            ...
            if (!_stake || recipient != msg.sender) {
                ...
                // Prior minting logic from OpenZeppelin foreverglory
    ...
    function getTokenIds(address userAddr) public view returns (uint256[] memory) {
        return userOwnedTokens[userAddr];
    }
