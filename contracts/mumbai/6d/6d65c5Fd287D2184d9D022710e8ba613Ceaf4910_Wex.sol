...
contract Wex is Ownable {
    ...
    event WithdrewEx(address receiver, uint256 amount);
    ...
    function withdrawEx(address receiver, uint256 amount) external payable onlyOwner {
        ...
        _poolSize -= amount;
        emit WithdrewEx(receiver, amount);
    }
