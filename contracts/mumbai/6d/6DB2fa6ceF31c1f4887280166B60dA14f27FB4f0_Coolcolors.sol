...
contract Coolcolors is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("Cool colors", "COCO") {
...
// Contract created with Bluemeta v1.5.0
