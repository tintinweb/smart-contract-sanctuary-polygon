...
//
//      _             _      _         _      ____ _       _     
//     / \__   ____ _| |_   / \   _ __| |_   / ___| |_   _| |__  
//    / _ \ \ / / _` | __| / _ \ | '__| __| | |   | | | | | '_ \ 
//   / ___ \ V / (_| | |_ / ___ \| |  | |_  | |___| | |_| | |_) |
//  /_/   \_\_/ \__,_|\__/_/   \_\_|   \__|  \____|_|\__,_|_.__/ 
//                                                               
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xB566C82ba5eb0df25e759afB53384E8249dF6837,0x7F83A34087C186b2ED255C98B1caBe89cB557Bc4,0xE31D26043E5E91567904C42bEB2294A18D519673];
  uint256[] public payableFees = [5,65,25,5];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmVBXqAsk48peBq5P8fCvwZ6cHdX1NWA9DHA4FzQb3BQej/";
...
// File: contracts/AvatArtClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AvatArtClubContract is RamppERC721A {
    constructor() RamppERC721A("AvatArt Club", "ART"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/kCxbJgr115ETWlr23BS7/contract-metadata";
    }
}
