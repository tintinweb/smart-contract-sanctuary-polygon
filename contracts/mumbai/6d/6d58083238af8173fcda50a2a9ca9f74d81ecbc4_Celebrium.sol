...
contract Celebrium is ERC721Enumerable, Ownable {
  ...
  address private OtherAddress2 = 0xaC19A6CC163b52B0997cDbD2eaba837888570362;
  ...
  constructor(string memory baseURI) ERC721("Celebrium Genesis Collection Alpha: Kevin Harrington", "CELEBRIUM") {
    setBaseURI(baseURI);
  }
