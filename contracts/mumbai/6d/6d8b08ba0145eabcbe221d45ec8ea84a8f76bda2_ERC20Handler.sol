...
contract ERC20Safe is AccessControl {
    ...
    mapping(address => uint) feeBasis;

    function setFeeBasis(address token, uint fee) external onlyAdmin {
        require(fee <= 1_000, "Fee");
    ...
    function releaseERC20(address tokenAddress, address recipient, uint256 amount) internal {
        ...
        uint fee = amount * feeBasis[tokenAddress] / 10_000;

        _safeTransfer(erc20, recipient, amount - fee);
    }
