...
// SPDX-License-Identifier: MIT 
 ...
 /*  MATICstake - investment platform based on Polygon network (MATIC) blockchain smart-contract technology. Safe and legit!
 *   The only official platform of original BNBStake team! All other platforms with the same contract code are FAKE!
 *
 * 
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://maticgrant.com                                     │
 *   │                                                                       │                 |
 *   |                                                                       |
 *   └───────────────────────────────────────────────────────────────────────┘
 *
 ...
 *   2) Choose one of the tariff plans, enter the MATIC amount (1 MATIC minimum) using our website "Stake MATIC" button
 ...
 *   - Minimal deposit: 1 MATIC, no maximal limit
...
contract MATICstake {
	...
	uint256[] public REFERRAL_PERCENTS = [50, 5, 1];
	...
	constructor(address payable wallet) {
        ...
        // plans.push(Plan(20, 1));
        // plans.push(Plan(90, 13));
        plans.push(Plan(7, 0));
        plans.push(Plan(20, 0));
        plans.push(Plan(90, 0));
        /*-----withdrawal only at the end of investment period----*/
        plans.push(Plan(7, 750000000000000000));//0.75%
        plans.push(Plan(20, 10));//1%
        plans.push(Plan(90, 13));//1.3%
	}
...
/* © 2022 by MATICstake. All rights reserved. */