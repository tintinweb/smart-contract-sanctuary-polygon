...
contract MintpadErc721LazyMint is 
    ERC721DelayedReveal,
    PrimarySale,
    PlatformFee,
    ...
    Drop
{
    ...
    /// @dev Transfers the NFTs being claimed.
    function _transferTokensOnClaim(address _to, uint256 _quantityBeingClaimed) internal override(Drop, ERC721LazyMint) returns (uint256 startTokenId){
        startTokenId = _currentIndex;
