...
contract SxTRelay is ConfirmedOwner, String, Initializable, ReentrancyGuard, ChainlinkClient, ISxTRelay {
     ...
     * @param data - The response data received for the query
     */
    function queryResponseString2D(bytes32 requestId, string[][] calldata data) external override nonReentrant recordChainlinkFulfillment(requestId) {
        ...
        (bool success, ) = callerAddress.call(abi.encodeWithSelector(callbackFunctionSignature, requestId, data));
     ...
     * @param data - The response data received for the query
     */
    function queryResponseUint256(bytes32 requestId, uint256 data) external override nonReentrant recordChainlinkFulfillment(requestId) {
        currentRequestId = requestId;
        address callerAddress = requestDetails[requestId].responseContract;
        bytes4 callbackFunctionSignature = requestDetails[requestId].responseFunctionId;
        (bool success, ) = callerAddress.call(abi.encodeWithSelector(callbackFunctionSignature, requestId, data));
     ...
     * @param data - The response data received for the query
     */
    function queryResponseBytes(bytes32 requestId, bytes calldata data) external override nonReentrant recordChainlinkFulfillment(requestId) {
        currentRequestId = requestId;
        address callerAddress = requestDetails[requestId].responseContract;
        bytes4 callbackFunctionSignature = requestDetails[requestId].responseFunctionId;
        (bool success, ) = callerAddress.call(abi.encodeWithSelector(callbackFunctionSignature, requestId, data));
     ...
     * @param data - The response data received for the query
     */
    function queryResponseString(bytes32 requestId, string calldata data) external override nonReentrant recordChainlinkFulfillment(requestId) {
        currentRequestId = requestId;
        address callerAddress = requestDetails[requestId].responseContract;
        bytes4 callbackFunctionSignature = requestDetails[requestId].responseFunctionId;
        (bool success, ) = callerAddress.call(abi.encodeWithSelector(callbackFunctionSignature, requestId, data));
