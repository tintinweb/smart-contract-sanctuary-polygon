...
contract MyoriCrypto is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, OwnableUpgradeable, ERC20PermitUpgradeable, UUPSUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() {
        _disableInitializers();
    }
    ...
    function initialize() initializer public {
        __ERC20_init("MyoriCrypto", "MYC");
        __ERC20Burnable_init();
        __Ownable_init();
        __ERC20Permit_init("MyoriCrypto");
