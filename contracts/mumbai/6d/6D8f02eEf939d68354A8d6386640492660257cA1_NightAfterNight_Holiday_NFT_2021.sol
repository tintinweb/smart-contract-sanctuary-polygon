...
contract NightAfterNight_Holiday_NFT_2021 is Ownable, RoyaltiesV2Impl, ERC1155 {
    ...
    address ROYALTIESADDRESS = 0xfeB31F196D4d9115642c505C6efe95be0b75B664;
        ...
        public payable onlyOwner returns (uint256)
    {
        ...
        //royalties set at 50% for the test. always go to the same address, that we set up above
        setRoyalties(id, payable(ROYALTIESADDRESS), 5000);
