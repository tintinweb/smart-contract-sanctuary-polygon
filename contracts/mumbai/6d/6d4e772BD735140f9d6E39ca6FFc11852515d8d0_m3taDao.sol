...
//     :       :   : :  : :: : :  :::  :: : :       :      @@        @@     @@@    ::   :::  @@@@@@@   :: ::::  ::: ::::  @@@@@@@   :   : :  ::         ::  @@@@@@@     \\
    ...
    string private constant M3TADAO_ORGANIZATION_PREFIX = "M3taOrganization";
    ...
    string private constant M3TADAO_PROFILE_PREFIX = "M3taProfile";
    string private constant PROFILE_SCHEMA = " (userName text, userAddress text, identifier text, userDID text, userName text, imageURI text, description text);" ;

    string  private _ProposalTable;
    uint256 private _proposalTableID;
    string private constant PROPOSAL_PREFIX = "M3taProposal";
    ...
    string private constant VOTES_PREFIX = "M3taVote";
    string private constant VOTES_SCHEMA = " (proposalid text, accountid text, respondent text, vote text, unique(proposalid, respondent));";
        // Tableland Hiring table variables

    string  private _hireTable;
    uint256 private _hiringTableId;
    string private constant HIRE_PREFIX = "M3taHire";
