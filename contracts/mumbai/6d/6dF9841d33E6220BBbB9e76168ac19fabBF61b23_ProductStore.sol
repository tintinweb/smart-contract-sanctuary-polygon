...
contract ProductStore is Ownable, Pausable {
    ...
    constructor(address _tools) {
        require(_tools != address(0), "ProductStore: zero address");
    ...
    function createProduct(
        ...
        require(nftTypeId <= tools.lastTypeId(), "ProductStore: nft tpyeId not found");
    ...
    function setTools(address newTools) external onlyOwner {
        ...
        address oldTools = address(newTools);
