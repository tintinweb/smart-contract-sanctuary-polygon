...
contract AuctionNFT {
    ...
    uint256 public constant PERCENTAGE_FEE = 1000;
    ...
    function finish(uint256 _tokenId) public {
        ...
        uint256 receipientAmount =
            (awarder.amount * PLATFORM_FEE) / PERCENTAGE_FEE;
        uint256 sellerAmount = awarder.amount - PLATFORM_FEE;
        recipientAddr.transfer(receipientAmount);
        auction.seller.transfer(sellerAmount);
        nftContract.transferFrom(address(this), awarder.addr, _tokenId);
