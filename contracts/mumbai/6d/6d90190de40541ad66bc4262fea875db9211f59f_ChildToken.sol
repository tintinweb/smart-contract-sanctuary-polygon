...
// File: examples/state-transfer/FxStateChildTunnel.sol
...
contract ChildToken is ERC20,FxStateChildTunnel {
    constructor(address _fxChild) ERC20("ChildToken", "CT")FxStateChildTunnel(_fxChild) {
