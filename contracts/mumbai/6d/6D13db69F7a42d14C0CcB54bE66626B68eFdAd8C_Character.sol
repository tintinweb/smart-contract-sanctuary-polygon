...
contract Character is ERC721Base, ERC721Sig {
    ...
    function mintWithSignature(
        ...
        emit TokensMintedWithSignature(signer, receiver, nextTokenIdToMint(), _req);
    }
    ...
    function _collectPriceOnClaim(address _currency, uint256 _pricePerToken)
        internal
        virtual
    {
        if (_pricePerToken == 0) {
    ...
    Royalty
{
    ...
    function changeRentCurrency(address asset) external onlyOwner {
        ...
        require(asset != address(0), "Unseen: cannot be address 0");
        runToken = asset;
    }
    ...
    function _grantMinterRole(address _signer) external onlyOwner {
        ...
        require(_signer != address(0), "Unseen: Cannot be address 0");
        _minterRole[_signer] = true;
...
abstract contract ERC4907A is ERC721A, IERC4907A {
    ...
    function setRentFee(uint256 tokenId, uint128 ratePerMinute)
        public
        virtual
        override
