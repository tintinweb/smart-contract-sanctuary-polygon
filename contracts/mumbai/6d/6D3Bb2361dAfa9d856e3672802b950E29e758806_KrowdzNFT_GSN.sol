...
contract KrowdzNFT_GSN is ERC721, ERC721URIStorage, ERC2771Context, Ownable {
    ...
    ) ERC721(tokenName, symbol) ERC2771Context(address(forwarder)) {}
    ...
    function safeMintBulk(
        ...
        uint256 tokenId = _tokenIdCounter.current();
        for (uint i = tokenId; i < tokenId + count; i++) {
            _tokenIdCounter.increment();
