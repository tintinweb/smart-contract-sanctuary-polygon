...
contract TrellissoftMarketplace is Context, AccessControlEnumerable, ReentrancyGuard {
    ...
    modifier onlyItemOwner(address nftContract, uint256 tokenId) {
        require(
            ...
            "TrellissoftMarketplace: Sender does not own the item"
        );
        _;
    }
    ...
    modifier onlyWhenItemExist(uint256 itemId) {
        require(
            ...
            "TrellissoftMarketplace: Market item doesn't exist"
        );
        _;
    }
    ...
    modifier onlySeller(uint256 itemId) {
        require(
            ...
            "TrellissoftMarketplace: Sender is not seller of this item"
        );
        _;
    }
    ...
    */
    function createMarketItem(
        ...
        require(price > 0, "TrellissoftMarketplace: Price must be at least 1 wei");
    ...
    */
        ...
        onlyWhenItemExist(itemId)
    {
        ...
        require(
            msg.value == price,
            "TrellissoftMarketplace: Pay Market Price to buy the NFT"
        );
