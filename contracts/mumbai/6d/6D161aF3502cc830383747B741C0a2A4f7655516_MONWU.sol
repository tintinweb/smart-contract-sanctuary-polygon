...
contract MONWU is ERC20, Ownable {
  ...
  /// Custom burn fucntion to help track burning easier
  /// Also setting maximum amount that can be burned
  ...
  /// Allowing owner to mint hardcoded amount to certain allocation
  /// @param foundersVestingContract - contract address to mint the allocation to
  ...
  /// Allowing owner to mint hardcoded amount to certain allocation
  /// @param marketingVestingContract - contract address to mint the allocation to
  ...
  /// Allowing owner to mint hardcoded amount to certain allocation
  /// @param developmentVestingContract - contract address to mint the allocation to
  ...
  /// Allowing owner to mint hardcoded amount to certain allocation
  /// @param privateSaleVestingContract - contract address to mint the allocation to
  ...
  /// Allowing owner to mint hardcoded amount to certain allocation
  /// @param publicSaleAddress - contract address or EOA (to be determined) to mint the allocation to
  ...
  /// Allowing owner to mint hardcoded amount to certain allocation
  /// @param poolInitializer - EOA address that will be initializing pool on DEX
  ...
  /// Allowing owner to mint hardcoded amount to certain allocation
  /// @param stakingContract - contract address to mint the allocation to
  ...
  /// Allowing owner to mint hardcoded amount to certain allocation
  /// @param rewardsContract - contract address to mint the allocation to
