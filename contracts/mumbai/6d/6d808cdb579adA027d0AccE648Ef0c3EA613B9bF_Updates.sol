...
contract Updates is IUpdates, Messages, MerkleSerialized {
    ...
    /// @inheritdoc IUpdates
    address public immutable _blackholeId;
    ...
    constructor(
        ...
        address writer,
        address info,
        address blackholeIdAddress
    ) {
        BlackholeId(blackholeIdAddress).assertValidBlackholeId();
        _sto = storageAddress;
        _writer = writer;
        _info = info;
        _blackholeId = blackholeIdAddress;
...
interface IUpdates {
     ...
     * this contract can communicate with
     */
    function _blackholeId() external view returns (address);
