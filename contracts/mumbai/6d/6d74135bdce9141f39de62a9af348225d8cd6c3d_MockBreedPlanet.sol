...
contract BreedPlanet is BreedPlanetBase, ChainlinkRng {
    ...
    function _breed(
        ...
        //     if (planetAId <= 4585) {
        //         targetApeironGodiverseCollectionNumber += primevalApeironGodiverseCollectionNumbers[
        //             planetABloodline
        //         ][_getPlanetData(planetAId).breedCount];
        //     } else {
        //         targetApeironGodiverseCollectionNumber += apeironGodiverseCollectionNumbers[
        //             planetABloodline
        //         ][_getPlanetData(planetAId).breedCount];
        //     }
