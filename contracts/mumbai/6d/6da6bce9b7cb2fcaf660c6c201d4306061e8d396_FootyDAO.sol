...
contract FootyDAO is Ownable {
    event Stake(bytes32 indexed userId, bytes32 indexed gameId, uint256 amount);
    event GameAdded(bytes32 indexed gameId, uint256 minStake);
    ...
    function stake(
        ...
        emit Stake(userId, gameId, amount);
    }
    ...
    function addGame(bytes32 gameId, uint256 minStake) external onlyOwner {
        ...
        emit GameAdded(gameId, minStake);
    }
