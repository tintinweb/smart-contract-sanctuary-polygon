    ...
    IPlatform
{
    ...
    function approve(address token_, uint256 amount_) external override {
        require(token_ != address(0x0), "eth doesn't need approve");
...
interface IPlatform {
    ...
    function approve(address token_, uint256 amount_) external;
