...
contract MockCurveWrapper {
    ...
    IERC20 public immutable USDR =
        IERC20(0xb1eeE3b068B183C5A5C3c507036e89A9024a7514);
    IERC20 public immutable DAI =
        IERC20(0xB9B232d67b6F6E0660c96445A8B62530e07a2364);
    ...
    function swapExactTokensForTokens(
        ...
        if (path[1] == address(DAI)) {
            DAIMint(address(DAI)).mint(amountIn);
        } else {
            USDMint(address(path[1])).mint(address(this), amountIn);
        }
