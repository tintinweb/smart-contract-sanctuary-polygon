...
contract ArtFluenceNFTFactory {
    ...
    ArtFluenceNFT721 public artFluenceNFT721;
    ArtFluenceNFT1155 public artFluenceNFT1155;
    ...
    constructor(address _signer,ArtFluenceNFT721 _artFluenceNFT721,ArtFluenceNFT1155 _artFluenceNFT1155){
        signer = _signer;
        owner = msg.sender;
