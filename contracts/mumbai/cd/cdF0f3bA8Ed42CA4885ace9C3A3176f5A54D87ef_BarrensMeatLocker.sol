...
// The MeatLocker is full of rewards and noms.
// The longer you stay, the more NOMS you end up with when you leave.
// This contract handles swapping to and from xNoms <> Noms
contract BarrensMeatLocker is ERC20 {
    ...
    // Enter the MeatLocker. Deposit some Noms. Earn some shares.
    ...
    // Leave the bar. Claim back your Noms.
