...
// File: contracts/IamfrutureContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract IamfrutureContract is RamppERC721A {
    constructor() RamppERC721A("I AM FRUTURE", "IAF"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/IZJc8UBnySkcVqefSxvQ/contract-metadata";
    }
}
