...
contract DiamondHands is ERC721Enumerable, Ownable{
  ...
  mapping (address => Staker) public stakers;
   ...
   function stakingBatch(uint256[] memory tokenIds) public payable{
      for (uint i = 0; i < tokenIds.length; i++) {
  ...
  function _stake(address _user,uint256 _tokenId) internal{
       ...
       staker.balance = staker.balance.add(amount);
        ...
        // safeTransferFrom(_user,ownerAddress,_tokenId);
        // safeTransferFrom(_user,ownerAddress, _tokenId);
        // delete _tokenId;
   ...
   function unstakeBatch(uint256[] memory tokenIds) public payable{
