...
// File contracts/GuardianERC721Burnable.sol
...
pragma solidity ^0.8.0;
contract GuardianERC721Burnable is ERC721Burnable {
    using Address for address;
    ...
    function _safeMint(
        ...
        _mint(to, tokenId);
        require(
            _checkOnERC721ReceivedImpl(address(0), to, tokenId, data),
            "ERC721: transfer to non ERC721Receiver implementer"
        );
    }

    function _checkOnERC721ReceivedImpl(
        address from,
        address to,
        uint256 tokenId,
        bytes memory data
