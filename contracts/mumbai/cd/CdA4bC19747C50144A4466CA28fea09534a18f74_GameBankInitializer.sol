...
contract GameBankInitializer {

    function setGameBankAddress(address _gameBankAddress) public {
        LibDiamond.enforceIsContractOwner();
        LibDiamond.setGameBankAddress(_gameBankAddress);
    }

    function getGameBankAddress() external view returns (address) {
        return LibDiamond.diamondStorage().gameBankAddress;
    }
}
