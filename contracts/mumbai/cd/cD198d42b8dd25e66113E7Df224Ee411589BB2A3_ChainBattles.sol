...
contract ChainBattles is ERC721URIStorage {
    ...
    function getStats(uint256 tokenID) public view returns(string memory){
        string memory res = string(
            abi.encodePacked(
                ...
                '<text x="20%" y="60%" class="base" dominant-baseline="left" text-anchor="left">Strength: ', tokenIdToChars[tokenID].str.toString(),'</text>',
                '<text x="20%" y="70%" class="base" dominant-baseline="left" text-anchor="left">Speed: ', tokenIdToChars[tokenID].speed.toString(),'</text>'                      
        ));
        return res;
    }
    ...
    function mint() public {
        ...
        tokenIdToChars[tokenid].str = random(10);
        tokenIdToChars[tokenid].speed = random(10);
