...
//*********************************************************************//
//
//        .,                                ,.,   '                 ,.         ,Â·Â´'; '      ;'*Â¨'`Â·- .,  â€˜                           _,.,  Â°         ,. -  .,                           ,. -,                   _,.,  Â°                                  ,.         ,Â·Â´'; '           ,.-Â·~ ^~, â€˜           ,  . .,  Â°                 ,. -,    
//    ,Â·Â´    '` Â·.'                        ;Â´   'Â· .,           ;'Â´*Â´ ,'\       ,'  ';'\Â°     \`:Â·-,. ,   '` Â·.  '              ,.Â·'Â´  ,. ,  `;\ '     ,' ,. -  .,  `' Â·,              ,.Â·'Â´,    ,'\           ,.Â·'Â´  ,. ,  `;\ '                           ;'Â´*Â´ ,'\       ,'  ';'\Â°       .'Â´  ,.-Â·~-.,':\     ;'Â´    ,   ., _';\'         ,.Â·'Â´,    ,'\   
//     \`; `Â·;Â·.   `Â·,                  .Â´  .-,    ';\         ;    ';::\      ;  ;::'\      '\:/   ;\:'`:Â·,  '`Â·, '         .Â´   ;Â´:::::\`'Â´ \'\     '; 'Â·~;:::::'`,   ';\       ,Â·'Â´ .Â·Â´'Â´-Â·'Â´::::\'       .Â´   ;Â´:::::\`'Â´ \'\                           ;    ';::\      ;  ;::'\      ;   ,':\::::::'\::\    \:Â´Â¨Â¯:;'   `;::'\:'\    ,Â·'Â´ .Â·Â´'Â´-Â·'Â´::::\' 
//      ;   ,'\::`Â·,   \'               /   /:\:';   ;:'\'      ;      '\;'      ;  ;:::;       ;   ;'::\;::::';   ;\        /   ,'::\::::::\:::\:'     ;   ,':\::;:Â´  .Â·Â´::\'    ;    ';:::\::\::;:'       /   ,'::\::::::\:::\:'                         ;      '\;'      ;  ;:::;     ;'   ;:::'_-Â·~-\;' â€˜     \::::;   ,'::_'\;'   ;    ';:::\::\::;:'  
//     ;   ,'::'\:::';   ';            ,'  ,'::::'\';  ;::';     ,'  ,'`\   \      ;  ;:::;       ;  ,':::;  `Â·:;;  ,':'\'     ;   ;:;:-Â·'~^Âª*';\'Â´       ;  Â·'-Â·'Â´,.-Â·'Â´:::::::';   \Â·.    `Â·;:'-Â·'Â´         ;   ;:;:-Â·'~^Âª*';\'Â´                          ,'  ,'`\   \      ;  ;:::;   ,.'    'Âª*'Â´ __'`;\ Â°          ,'  ,'::;'  â€˜     \Â·.    `Â·;:'-Â·'Â´     
//     ;   ;:::;'Â·:.'  ,Â·'\'       ,.-Â·'  'Â·~^*'Â´Â¨,  ';::;     ;  ;::;'\  '\    ;  ;:::;       ;   ;:::;    ,Â·' ,Â·':::;     ;  ,.-Â·:*'Â´Â¨'`*Â´\::\ '    ;Â´    ':,Â´:::::::::::Â·Â´'     \:`Â·.   '`Â·,  '         ;  ,.-Â·:*'Â´Â¨'`*Â´\::\ '                         ;  ;::;'\  '\    ;  ;:::;    `',   ;\Â¯::::::::\:\â€˜          ;  ;:::;  Â°      \:`Â·.   '`Â·,  '     
//    ';  ';: -Â· 'Â´. Â·'Â´:::'\'      ':,  ,Â·:Â²*Â´Â¨Â¯'`;  ;::';    ;  ;:::;  '\  '\ ,'  ;:::;'       ;  ;:::;'  ,.'Â´,Â·Â´:::::;    ;   ;\::::::::::::'\;'      ';  ,    `Â·:;:-Â·'Â´            `Â·:'`Â·,   \'         ;   ;\::::::::::::'\;'                         ;  ;:::;  '\  '\ ,'  ;:::;'     ;   ;::\;::_:_::\;'          ;  ;::;'  â€˜         `Â·:'`Â·,   \'      
//    ;  ,-Â·:'Â´:\:::::::;Â·'       ,'  / \::::::::';  ;::';   ,' ,'::;'     '\   Â¨ ,'\::;'       ':,Â·:;::-Â·Â´,.Â·Â´\:::::;Â´'     ;  ;'_\_:;:: -Â·^*';\      ; ,':\'`:Â·.,  ` Â·.,            ,.'-:;'  ,Â·\        ;  ;'_\_:;:: -Â·^*';\                        ,' ,'::;'     '\   Â¨ ,'\::;'      ;  ';:::;        '             ;  ;::;'â€š            ,.'-:;'  ,Â·\     
//   ,'  ';::::::'\;:Â·'Â´          ,' ,'::::\Â·Â²*'Â´Â¨Â¯':,'\:;    ;.'\::;        \`*Â´\::\; Â°       \::;. -Â·Â´:::::;\;Â·Â´        ';    ,  ,. -Â·:*'Â´:\:'\Â°    \Â·-;::\:::::'`:Â·-.,';     ,Â·'Â´     ,.Â·Â´:::'\       ';    ,  ,. -Â·:*'Â´:\:'\Â°                      ;.'\::;        \`*Â´\::\; Â°     ';  ;::';                      ',.'\::;'â€š       ,Â·'Â´     ,.Â·Â´:::'\    
//   \Â·.,Â·\;-Â· 'Â´  '             \`Â¨\:::/          \::\'    \:::\'          '\:::\:' '          \;'\::::::::;Â·Â´'            \`*Â´ Â¯\:::::::::::\;' '    \::\:;'` Â·:;:::::\::\'    \`*'Â´\::::::::;Â·'â€˜       \`*Â´ Â¯\:::::::::::\;' '                     \:::\'          '\:::\:' '        \*Â´\:';        'â€š              \::\:;'â€š        \`*'Â´\::::::::;Â·'â€˜   
//    \::\:\                     '\::\;'            '\;'  '    \:'             `*Â´'â€š               `\;::-Â·Â´                  \:::::\;::-Â·^*'Â´          'Â·-Â·'       `' Â· -':::''    \::::\:;:Â·Â´              \:::::\;::-Â·^*'Â´                            \:'             `*Â´'â€š           '\::\;     '                   \;:'      â€˜     \::::\:;:Â·Â´        
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmX8pgqZ5dfecFPaMYzZQJrQEnUfapcoUZRQ5ciKFtZj3a/";
...
contract PanderseContract is RamppERC721A {
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/9ojRhuNiUN0QK1LcyEcM/contract-metadata";
    }
}
