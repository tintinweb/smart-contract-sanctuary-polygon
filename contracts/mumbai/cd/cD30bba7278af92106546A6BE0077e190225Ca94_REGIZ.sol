...
/*
    Website: https://regiz.io/
    Contract Name: regiz
    Discord: https://discord.gg/gyYTgKuc
    Twitter: @sifu_Inu @laurapoker
    YT: https://youtube.com/CWOOBDZ3T3k
    Telegram: https://t.me/regizofficial
    FB: https://www.facebook.com/regizOfficial
    Contract Version: 1.0
    Contract Supply: 100,000,000,000 /100 Billion
    Contract Tokenomics:
    ...
    Deployed on Polygon Mainnet Chain: 
...
contract REGIZ is Context, IERC20, LockToken {
    using SafeMath for uint256;
    using Address for address;
    address payable public marketingWalletAddress = payable(0x6a705DD24522230A428E186F946065101CE833AE); // Marketing Wallet Address
    address payable public charityWalletAddress = payable(0x2feBE718A9456ba1569BC7Bd04c7D299502E47dB); // charity Wallet Address
    address payable public devWalletAddress = payable(0x6a705DD24522230A428E186F946065101CE833AE); // dev Wallet Address
    ...
    uint256 investmentPlan = 7;  //calculated In Date
    ...
    function setInvestmentPlan(uint256 _investmentPlan, uint256 _interestRate) public onlyOwner{
    ...
    function claimInvestment() public {
        ...
        emit inventReleased(address(this), invests.owner, totalEarned, ctime);
    }
    ...
    string private _name = "REGIZ COIN";
    ...
    uint256 public _maxTxAmount = 100_000_000_000 * 10**18; //1 %
