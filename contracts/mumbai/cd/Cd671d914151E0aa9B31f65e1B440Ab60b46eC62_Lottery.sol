...
contract Lottery {
    ...
    address public usdcContractAddress = 0xe6b8a5CF854791412c1f6EFC7CAf629f5Df1c747;
    ...
    constructor() {
        ...
        usdcToken = IERC20(usdcContractAddress);
    }
    ...
    // Asegurar que el contrato USDC tenga permiso para transferir USDC desde la cuenta del usuario
    require(
        usdcToken.allowance(msg.sender, address(this)) >= totalPrice,
        "Insufficient USDC allowance."
    );

    // Transferir USDC desde la cuenta del usuario al contrato
    require(
