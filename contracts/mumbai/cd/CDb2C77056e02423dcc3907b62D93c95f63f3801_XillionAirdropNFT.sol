...
contract XillionAirdropNFT is ERC721A, Ownable{
    ...
    constructor (address _signer) ERC721A("XillionNFT", "XFT") {
        require(_signer != address(0), "Signer can't be zero address");
        s_signerAddress = _signer;
    }

    function airdrop(bytes calldata signature)external {
    ...
    function giveAway(address user, uint256 count) public onlyOwner {
        _mint(user, count);
    }
