    ...
    constructor(address registry) ERC721("AstroFT", "AFT") {
        ...
        _metadataTableId = _tableland.createTable(
            ...
            string.concat(
                ...
                " (id int, image text, event_date text, event_description text ,attributes text);"
            )
        );
    ...
    function safeMint(address to) public returns (uint256) {
        ...
        _tableland.runSQL(
            ...
            string.concat(
                "INSERT INTO ",
                _metadataTable,
                " (id int, image text, event_date text, event_description text ,attributes text) VALUES (",
