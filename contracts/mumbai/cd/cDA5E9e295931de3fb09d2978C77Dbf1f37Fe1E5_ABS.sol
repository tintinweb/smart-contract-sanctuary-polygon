...
// ABI FINANCE
contract ABS is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 100,000 ABS
    ...
    ) public ERC20("ABI Share", "ABS") {
        _mint(msg.sender, 500 ether); // mint 500 ABS for initial liquidity deployment
