...
interface IGenericBurn {
    ...
    */
     ...
     *
     */
    function burnPack(uint256 _tokenId, uint32 _amount, bool _optIn) external;
     ...
     */
    function setContentEligibility(uint256 _tokenId, uint256 _categoryId, address _conditionalProvider) external;
     ...
     */
    function getContentCategories(uint256 _tokenId) external view returns (ContentCategory[] calldata _categories);
