...
contract IcoGeneric is ReentrancyGuard, Ownable {
    ...
    function buyATM(address customerAddress, uint256 amountInUsd, address usdAddress)
        external
        icoActive
        nonReentrant
        hasTokenBalance
        ...
        isAllowedToTrade(msg.sender)
    {
        ...
        uint256 allowanceInWei = usd.allowance(customerAddress, address(this));
        ...
        usd.transferFrom(customerAddress, walletTo, amountInUsdSafe);
