...
contract RehideNFT is IRehideNFT, RehideBase {
    ...
    function readSharedNote(uint256 tokenId) public payable returns (string memory noteSmd) {
        ...
        require(note.isShareable > 100, "RehideNFT: Note not shareable");
        // _noteReadAllowlist
        ...
        emit ReadSharedNote(note.tokenId, _msgSender(), block.timestamp);

        if (note.isExpirable > 0) {
