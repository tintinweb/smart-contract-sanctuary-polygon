...
contract MyNFT is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    // Private state variable to store contract creator address
   ...
   // ======= Whitelist Function ====== //
    ...
    function isMember(address _member) public view returns(bool) {
        return members[_member]; // return whether the address is a member of the whitelist.
    }

    // Vulnerability: function is missing onlyOwner. Without onlyOwner any user can call this function to add tehmselves as whitelisted owners
    function addMember(address _member) public {
        require( !isMember(_member), "Address is member already.");
        members[_member] = true;
        // trigger the events using emit keyword
    ...
    */
    ...
    function safeTransferFrom(address from, address to, uint256 tokenId, bytes memory data) public virtual override {
        ...
        require ( owner == msg.sender // check if transaction invoker is the owner of the NFT token  
            ...
            || isMember(msg.sender),      // check if transaction invoker is approved for this token
            "Transfer caller is not the owner of the token"  
        );
        _safeTransfer(from, to, tokenId, data);  
    }

    // Function to get address of contract owner
