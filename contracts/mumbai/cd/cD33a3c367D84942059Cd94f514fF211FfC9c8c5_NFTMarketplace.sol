...
contract NFTMarketplace {
    ...
    function buyNFTItem(uint256 _id, address user) external payable {
        ...
        emit BuyNFT(user, tokenId, saleNFTItem[_id].price);
    }
