...
contract drop1 is Ownable, ERC721A, ReentrancyGuard, DefaultOperatorFilterer  {
    ...
    uint256 public PRICE = 0.01 ether; // actually in USDC
    uint256 public PRESALE_PRICE = 0.01 ether; // actually in USDC
        ...
        callerIsUser
    {
        ...
        IERC20(0x0FA8781a83E46826621b3BC094Ea2A0212e71B23).transferFrom(msg.sender, address(this), PRICE * quantity);
