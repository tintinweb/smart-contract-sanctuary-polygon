...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x11e1F53cd9fe3DDAf05b4B6d7fF09C6DAd3dA15f];
...
// File: contracts/ArtifactsbyTimeToContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract ArtifactsbyTimeToContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Artifacts by Time To";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/vBg6flPd7Hk55cV94OYt/contract-metadata";
  }
