...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x35aeBeD3493aB3BBaf38a656f0F5BF989c8B099C];
  address public erc20Payable = 0x35aeBeD3493aB3BBaf38a656f0F5BF989c8B099C;
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 22000) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiff2yt5otegigjquuhkrykjqwtjemgcq7mfqpafaeoq77kizzehly/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/3OCJ5GetaY0ln4KjY4Sc/contract-metadata";
  }
...
// File: contracts/Chictest028Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Chictest028Contract is ERC721APlus {
    constructor() ERC721APlus("CHICTEST028", "CHIC"){}
}
