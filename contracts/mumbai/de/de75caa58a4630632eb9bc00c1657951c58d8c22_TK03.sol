...
contract TK03 is ERC20 {

    uint256 public TIME_BLOCK = 1691639999; //Date and time (GMT): 2023-08-10 00:59:59

    address public contractOwner;



    constructor() ERC20("CelebrationDay", "CBTD") {
    ...
    modifier checkBlock() {
        ...
        require(msg.sender == contractOwner || block.timestamp > TIME_BLOCK, 'Wait from the promised land babe');
