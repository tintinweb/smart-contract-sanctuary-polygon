...
/**
* @notice Stash is a development token that we use to learn how to code solidity 
* and what BEP-20 interface requires
*/
contract Stash is Ownable, Stakeable{
  ...
  */
  constructor(){
      ...
      _symbol = "STH";
      _decimals = 18;
      _totalSupply = 438125000;
      staking_process = false;
      _totalstakes = 0;
  ...
  */
  function _mint(address account, uint256 amount) internal {
    require(account != address(0), "Stash: cannot mint to zero address");
  ...
  */
  function _burn(address account, uint256 amount) internal {
    require(account != address(0), "Stash: cannot burn from zero address");
    require(_balances[account] >= amount, "Stash: Cannot burn more than the account owns");
  ...
  *  - sender balance most be = or bigger than amount
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    require(sender != address(0), "Stash: transfer from zero address");
    require(recipient != address(0), "Stash: transfer to zero address");
    require(_balances[sender] >= amount, "Stash: cant transfer more than your account holds");
   ...
   *   - owner and spender cannot be zero address
    */
    function _approve(address owner, address spender, uint256 amount) internal {
      require(owner != address(0), "Stash: approve cannot be done from zero address");
      require(spender != address(0), "Stash: approve cannot be to zero address");
    ...
    *   - The caller must have a allowance = or bigger than the amount spending
    ...
    function transferFrom(address spender, address recipient, uint256 amount) external returns(bool){
      ...
      require(_allowances[spender][msg.sender] >= amount, "Stash: You cannot spend that much on this account");
      // Transfer first
   ...
   */
    ...
    *
    ...
    function stake(uint256 _amount) public {
      require(staking_process == true, "Staking has been closed!");
      // Make sure staker actually is good for it
      uint256 stakesleft = stakeable_supply();
      require(stakesleft!=0, "Staking has been closed! Cannot stake any more tokens");
      require(_amount < _balances[msg.sender], "Stash: Cannot stake more than you own");
      require(_amount <= stakesleft, "Cannot stake more than stakable supply");
        _stake(_amount);
                // Burn the amount of tokens on the sender
        _burn(msg.sender, _amount);
        _totalstakes = _totalstakes + _amount;
    }
    ...
    * @notice withdrawStake is used to withdraw stakes from the account holder
    ...
    function withdrawRewards(uint256 stake_index) public {
      uint256 rewardtodistrib = _withdrawRewards(stake_index);
      _mint(msg.sender, rewardtodistrib);
    }
    ...
    function stakeable_supply() public view returns(uint256){
      return 103125000-_totalstakes;
    }

    function startstaking() public onlyOwner{
      staking_process = true;
    }
