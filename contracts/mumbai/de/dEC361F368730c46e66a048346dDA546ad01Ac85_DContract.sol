...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0xa82473266dC4BE674Ee1d76c90Ed0760f16C0860];
  address public erc20Payable = 0xa82473266dC4BE674Ee1d76c90Ed0760f16C0860;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 5) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiecihv6bo4komzx5tv2l4unkxkri5nroiehapbuaczxryepfgjvq4/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/32Gcp1zOuOkcbjBkKFF3/contract-metadata";
  }
...
// File: contracts/DContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DContract is RamppERC721A {
    constructor() RamppERC721A("d", "g"){}
}
