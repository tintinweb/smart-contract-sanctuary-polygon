    ...
    ERC721AUpgradeable
{
    ...
    function claimWithCondition(
        ...
        /// uint256 _conditionId = getActiveClaimConditionId();

        verifyClaim(_conditionId, _dropMsgSender(), _quantity, _currency, _pricePerToken, _allowlistProof);

        // Update contract state.
        claimCondition.conditions[_conditionId].supplyClaimed += _quantity;
        claimCondition.supplyClaimedByWallet[_conditionId][_dropMsgSender()] += _quantity;
        ...
        emit TokensClaimed(_conditionId, _dropMsgSender(), _receiver, startTokenId, _quantity);
