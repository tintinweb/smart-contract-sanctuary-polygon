...
contract AME_GOVERNER is Governor, GovernorSettings, GovernorCountingSimple, GovernorVotes, GovernorVotesQuorumFraction, GovernorTimelockControl {
    constructor(IVotes _token, TimelockController _timelock)
        Governor("AME_GOVERNER")
        GovernorSettings(1 /* 1 block */, 25 /* 5 minutes */, 10e18)
