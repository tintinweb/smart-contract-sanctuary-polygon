...
abstract contract TermsableBase is Ownable, TermReader {
    ...
    string urlProvider = "https://ipfs.io/ipfs/";
    ...
    function setUrlProvider(string memory _newUrlProvider) external onlyOwner {
        urlProvider = _newUrlProvider;
    }
...
abstract contract TermsableNoToken is TermsableBase {
    ...
    function termsUrlWithProvider() public view returns (string memory) {
        return
            string(
                abi.encodePacked(
                    urlProvider,
...
abstract contract TokenTermsable is TermsableBase, TokenTermReader {
    ...
    function termsUrlWithProvider(uint256 _tokenId)
        public
        view
