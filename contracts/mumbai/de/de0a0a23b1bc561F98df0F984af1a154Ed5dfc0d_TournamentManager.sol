...
contract TournamentManager is VRFConsumerBaseV2 {
  ...
  function createTeam(uint256[5] memory gotchis, uint256 gotchiLeader, uint256[5][2] memory gotchiFormation, string memory teamName) public {
    ...
    require(checkGotchiFormationValidity(gotchiFormation) == true, "Gotchi formation contains duplicate entries");
  ...
  function checkGotchiFormationValidity(uint256[5][2] memory gotchiFormation) internal pure returns (bool) {
