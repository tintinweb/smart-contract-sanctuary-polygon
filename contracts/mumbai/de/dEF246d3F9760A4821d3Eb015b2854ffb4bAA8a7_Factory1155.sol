...
import "./MetaMorphisUserToken1155.sol";
...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new MetaMorphisUserToken1155{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        MetaMorphisUserToken1155 token = MetaMorphisUserToken1155(address(addr));
...
contract MetaMorphisUserToken1155 is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
