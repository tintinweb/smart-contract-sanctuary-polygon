...
contract protoKol is iProtoKol {
  ...
  function createCampaign(
      ...
      //Add signature
        ...
        _newCampaign.requiredInvestment = _newCampaignInput.requiredInvestment * 10 ** IERC20(_USDT).decimals();
        ...
        _newCampaign.remainingInvestment = _newCampaignInput.requiredInvestment * 10 ** IERC20(_USDT).decimals();
  ...
  function generateTGE(uint256 _campaignId, address token) external
  {
    ...
    IERC20(campaigns[_campaignId].campaignData.preSaleToken).transferFrom(msg.sender ,_vault,campaigns[_campaignId].campaignData.stakingAmount 
