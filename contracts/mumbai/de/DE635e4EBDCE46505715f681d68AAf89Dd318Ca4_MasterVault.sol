...
ReentrancyGuardUpgradeable
{
    ...
    /// @dev only owner can set new deposit fee
    /// @param newMaxDepositFee new deposit fee percentage
    function setMaxDepositFee(uint256 newMaxDepositFee) external onlyOwner {
        require(newMaxDepositFee > 0 && newMaxDepositFee <= 1e6, "invalid maxDepositFee");
    ...
    /// @dev only owner can set new deposit fee
    /// @param newMaxWithdrawalFees new deposit fee percentage
    function setMaxWithdrawalFee(uint256 newMaxWithdrawalFees) external onlyOwner {
        require(newMaxWithdrawalFees > 0 && newMaxWithdrawalFees <= 1e6, "invalid maxWithdrawalFees");
        maxWithdrawalFee = newMaxWithdrawalFees;
    }
