...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new BuyrareUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        BuyrareUser1155Token token = BuyrareUser1155Token(address(addr));
...
contract BuyrareUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
