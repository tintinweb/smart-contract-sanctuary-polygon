...
contract Cyber9 is ERC721Enumerable, Ownable, RNG, VRFConsumerBase {
    ...
    //Events
    event Attack(address indexed _from, uint256 _tokenId, uint256 _dmg, bool isCrit, uint256 _enemyDmg, uint256 _experience);
    ...
    function levelUp(uint256 _tokenId) external status(_tokenId) {
        require(characters[_tokenId].level < MAX_LEVEL+1);
