...
contract RoomTiles is Ownable {
    ...
    function extGetRoomTile(uint256 _id) external view returns(RoomTile memory) {
        return roomTiles[_id];
    }

    // function extGetStarterTile(uint256 _id) external view returns (RoomTile memory) {
    ...
    function _initDefaultRooms() internal {
        ...
        roomTiles.push(RoomTile(
            ...
            // 3,
            // 3, // TODO: Make doors stronger or deal with room in a room or make event???
            // 0,
    ...
    function returnAllRoomTiles() public returns (RoomTile[] memory) {
        // TODO::  There has to be a better way
        // TODO: Why did I abandon this in favor of the one in BCGames??
        uint256 count = roomTiles.length;
        RoomTile[] memory returnList = new RoomTile[](count);
...
contract BCChars is ERC721URIStorage, Ownable {
    ...
    // TODO:  Move to utils and add seed from Oracle
