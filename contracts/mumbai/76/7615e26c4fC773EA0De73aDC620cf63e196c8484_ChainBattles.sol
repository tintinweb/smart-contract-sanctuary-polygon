...
contract ChainBattles is ERC721URIStorage {
    ...
    function getAttack(uint256 tokenId) public view returns (string memory){
        uint256 attack = tokenIdtoLevels[tokenId].attack;
...
function mint() public {
    ...
    tokenIdtoLevels[newItemId] = attributes(1,random(100),random(10),random(10));
    _setTokenURI(newItemId, getTokenURI(newItemId));
}

function train(uint256 tokenId,uint256 _hp, uint256 _attack, uint256 _speed) public {
    ...
    tokenIdtoLevels[tokenId].attack = attack + _attack;
