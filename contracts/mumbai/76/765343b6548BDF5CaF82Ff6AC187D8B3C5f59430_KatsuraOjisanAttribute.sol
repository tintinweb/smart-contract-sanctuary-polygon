...
// File: contracts/KatsuraOjisanAttribute.sol
...
contract KatsuraOjisanAttribute is Ownable
{
    ...
    function changeAttributes(uint256 _token, string[] calldata _attribute) external onlyOwner 
    {
        //clear old values
        for (uint256 i = 0; i < attributes[_token].length; i++)
        {
            attributes[_token].pop();
        }
