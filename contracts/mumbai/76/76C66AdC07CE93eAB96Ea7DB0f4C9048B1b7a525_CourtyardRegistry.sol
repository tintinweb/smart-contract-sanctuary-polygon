...
abstract contract OperatorFiltererUpgradeable is Initializable {
    ...
    function __OperatorFilterer_init(address subscriptionOrRegistrantToCopy, bool subscribe)
        ...
        onlyInitializing
    {
        _setupOperatorFilterer(subscriptionOrRegistrantToCopy, subscribe);
    }

    /// @dev Helper to setup the operator filterer that should be called upon an upgrade.
    function _setupOperatorFilterer(address subscriptionOrRegistrantToCopy, bool subscribe) internal {
