...
contract Mixer is Ownable {
    ...
    mapping(address => uint256) private mixedFromStaking;
    ...
    function mix(uint256 count) external {
        ...
        if (mixedFromStaking[msg.sender] > 0) {
            tudStakedCount = tudStakedCount > mixedFromStaking[msg.sender]
                ? tudStakedCount - mixedFromStaking[msg.sender]
                : 0;
        }
    ...
    function _mix(
        ...
        mixedFromStaking[msg.sender] += tudFromStaking;
