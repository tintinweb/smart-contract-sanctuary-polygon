...
contract TestERC20mint is ERC721A, Ownable { // PaperVerification
    ...
    modifier mintCompliance(uint256 _quantity, address _account) {
        require(amountNFTsperWallet[_account] + _quantity <= MAX_MINT_AMOUNT, "You already claimed this NFT");
    ...
    function claimTo(address _account, uint256 _quantity) external payable mintCompliance(_quantity, _account) {
