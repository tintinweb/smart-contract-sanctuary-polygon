 ...
 * @notice This contract handles minting lkz tokens.
 */
contract Lkz is
    ERC1155Supply,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x5118010a63AA35837c60A5B6D46E0eB9939DE0d0;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x9670D5589016C37E1B2918ACa330C18A2106F95c;
    ...
    address[] public payoutAddresses = [
        0x9670D5589016C37E1B2918ACa330C18A2106F95c
    ];
    ...
    string public name = "lkz";
    string public symbol = "1";
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeibympt7mr3aha6wbsldiji54sgn2wwifd45o3fez3pdjrh54ik6va/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[123] = 100;
        tokenPublicPrice[123] = 0.1 ether;
        tokenPublicMintsPerAddress[123] = 100;
        require(
