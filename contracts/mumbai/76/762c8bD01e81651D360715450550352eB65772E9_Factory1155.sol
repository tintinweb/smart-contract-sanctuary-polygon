...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new YoloUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        YoloUser1155Token token = YoloUser1155Token(address(addr));
