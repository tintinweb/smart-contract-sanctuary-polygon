...
contract TokenContract is ERC721A, Ownable {
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseURI, address payable _royaltiesRecipientAddr, uint96 _royaltyBps) ERC721A(_name, _symbol) {
        setBaseURI(_baseURI);
        setRoyalties(_royaltiesRecipientAddr, _royaltyBps);
    }
