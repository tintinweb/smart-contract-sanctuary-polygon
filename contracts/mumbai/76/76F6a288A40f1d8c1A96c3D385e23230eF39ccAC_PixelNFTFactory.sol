...
contract PixelNFTMinter is AccessControl {
    ...
    function privateMint(
        ...
        require(status == Status.PreSale, "WL mint is not active");
        _mint(_to, _count);
    }
    ...
    function activePublicMint() public onlyRole(ADMIN_ROLE) {
        status = Status.Public;
        emit StatusUpdated(status);
    }

    function activePrivateMint() public onlyRole(ADMIN_ROLE) {
        status = Status.PreSale;
        emit StatusUpdated(status);
    }

    function convert() public onlyRole(ADMIN_ROLE) {
...
contract PixelNFT is ERC721, ERC721Enumerable, ERC721URIStorage, AccessControl, Ownable, ERC721Royalty {
    ...
    constructor(
        ...
        _setDefaultRoyalty(royaltyReciever, royaltyFee);
    }
