...
contract WildcardLogos is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    string public BKEVersion = "BKEmbedded.0.1.16";
...
contract BKEmbedded is Ownable {
    ...
    string public constant BKContractName = "BKEmbedded.0.1.16";
...
*/
    ...
    function createDocument(string memory jsonString)
        ...
        {
        bool ok = checkCreateDocument(jsonString); //this will revert if there's a problem that would cause reversion.
...
by a taker, and can also be used to produce the hash proof to be signed by the client. */
    ...
    */
        ...
        returns (uint32)
    {
        ...
        sigIndexByTokenId[params.docId].push(sig.sigId);
    ...
    {
        require(pageNumber < pageStore.length, "{P3KKJ9}"); //page out of range
...
contract BKBindingCollection {
    ...
    string constant public BKVersion = "0.1.16";
...
contract BKBinding {
    ...
    */
    ...
    string public constant BKVersion="0.1.16";
...
contract BKRenderer {
    ...
    function renderTemplate( address collAddress, string memory templateName) public  view returns (string memory) {
        ...
        console.log("carrots", rootTemplateText, rootTemplateText.length());
    ...
    function getFromJSON(string memory key,  TagRefMapData memory data) public view returns(string memory) {
