...
contract TinyVillage is ERC1155 {
 ...
 function mintVillage() public {
    require(balanceOf(msg.sender, VILLAGE) == 0, "you already have a vilage");
    _mint(msg.sender, VILLAGE, 1, "0x00");
 }
 ...
 function mintCastle() public {
    ...
    require(balanceOf(msg.sender, MILL) > 0, "you need to hahve a mill");
    require(balanceOf(msg.sender, CASTLE) == 0, "you already have a castle");
    _mint(msg.sender, CASTLE, 1, "0x00");
 }
