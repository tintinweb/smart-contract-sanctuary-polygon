...
// File: contracts/GFCBlackSmith.sol
...
contract GFCBlackSmith is Ownable, Whitelist, VRFConsumerBase {
        ...
        ) 
    {
        ...
        genesisWeapon = GFCGenesisWeapon(address(0xF352a0A78402a95241D80CaEee4C9513D869bf8E));
        mysteryItem = GFCMysteryItem(address(0xd0AaB92f2915d8824e21A549016C76b4e6b2fFc2));
