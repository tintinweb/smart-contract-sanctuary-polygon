    ...
    PausableUpgradeable
{
    ...
    function initialize(
        ...
        setUpgrader(upgraderWallet, true);
    ...
    function addScheme(
        ...
        scheme.vestingPeriod = period * secondsOfDay;
    ...
    function claim(uint256 subscriptionId) external whenNotPaused {
        ...
        require(subscription.depositAmount > 0, "depositAmount is zero");
        require(
    ...
    function isUpgrader(address upgrader) public view returns (bool) {
        ...
        )
    {
        ...
        period = scheme.vestingPeriod / secondsOfDay;
    ...
    function setUpgrader(address upgrader, bool _isUpgrader) public onlyOwner {
        _upgrader[upgrader] = _isUpgrader;
    }
        ...
        returns (uint256 completedSub)
    {
        ...
        if (blockTime >= subscription.vestingEndTime) {
            ...
            subscription.nextClaimTime =
                ((block.timestamp + scheme.vestingPeriod) / secondsOfDay) *
                secondsOfDay;
    ...
    function _onlyUpgrader() private view {
        require(_upgrader[msg.sender], "Vesting : Sender is not upgrader");
    }
