...
import "./interface/IMultiSigWallet.sol";
...
contract CreatorDAOUpgradeable is GranularRolesUpgradeable {
    ...
    string public _name;
    WalletContract public _treasuryAddress;
    ...
    function initialize(
        ...
        // FIXME: Must create owners list here
        address[] memory owners = new address[](1);
        owners[0] = daoConfig.owner;

        _treasuryAddress = new WalletContract(owners, 1); // TODO: This value is hardcoded for now

        _initRoles(daoConfig.owner, _roleAddresses);

        emit CreatedDAO(_name, address(_treasuryAddress));
    }
    ...
    function getTreasury() public view returns (address treasury) {
        return address(_treasuryAddress);
    }
    ...
    function withdraw(
        ...
        _treasuryAddress.withdraw(to_, amount_, data_);
    }
}
