...
contract EventTicketSystemFactory {
    EventTicketSystem[] public ticketSystems;
    ...
    function create (
        ...
        EventTicketSystem eventTicketSystem = new EventTicketSystem(
            msg.sender,
            _eventName, 
            _eventSymbol, 
            _eventStartDate,
        ...
        ticketSystems.push(eventTicketSystem);
    }
    ...
    function createAndSendEther (
        ...
        EventTicketSystem eventTicketSystem = (new EventTicketSystem){value: msg.value}(
            msg.sender,
            _eventName, 
            _eventSymbol, 
            _eventStartDate,
    ...
    function getEventTicketSystem (uint256 id) public view returns (address eventTicketSystemAddress) {
        return address(ticketSystems[id]);
    }
}
