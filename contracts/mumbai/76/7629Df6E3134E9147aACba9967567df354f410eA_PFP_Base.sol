...
contract PFP_Base is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
    uint256 public MAX_SUPPLY = 50;

    
    uint256 public PHASE_SUPPLY = 1;
    
    bool public IS_PHASE_ACTIVE = false;

    
    uint256 public PHASE_TX_LIMIT = 1;

    
    uint256 public PHASE_WALLET_LIMIT = 1;
    ...
    string private preRevealURI = "https://ipfs.w3bmint.xyz/ipfs/QmdLkqStfRCskTtL3vPsXujDVq1fq82h9xzfAMeE3Mbi2u";
    ...
    constructor() ERC721A("PFP_Base", "PFPPBASE") {
        
        
        _safeMint(0xc9A076d59109d55779104DA8750A496C9386751B, 49);
    }
