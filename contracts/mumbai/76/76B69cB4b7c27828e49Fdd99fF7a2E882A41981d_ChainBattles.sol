...
function generateCharacter(uint256 tokenId) public returns(string memory){
    ...
    bytes memory svg = abi.encodePacked(
        ...
        '<text x="42" y="65" class="base level" dominant-baseline="middle" text-anchor="middle">', "Speed: ",getProps(tokenId).speed.toString(),'</text>',
        '<text x="42" y="65" class="base level" dominant-baseline="middle" text-anchor="middle">', "Strength: ",getProps(tokenId).strength.toString(),'</text>',
        '<text x="42" y="65" class="base level" dominant-baseline="middle" text-anchor="middle">', "Life: ",getProps(tokenId).life.toString(),'</text>',
        '</svg>'
    );
    return string(
        abi.encodePacked(
