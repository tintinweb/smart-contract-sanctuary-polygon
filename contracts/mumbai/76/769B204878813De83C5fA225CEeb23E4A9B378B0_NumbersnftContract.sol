...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x85A6458EF76F02A9FCD024615f25Cd8347f5D89f];
  address public erc20Payable = 0x85A6458EF76F02A9FCD024615f25Cd8347f5D89f;
    ...
    
{
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/iJkWjHLnoIKU2tifzN0d/contract-metadata";
  }
...
// File: contracts/NumbersnftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NumbersnftContract is ERC721APlus {
    constructor() ERC721APlus("numbers nft", "nn"){}
}
