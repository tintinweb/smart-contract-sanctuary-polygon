...
contract ClubVirtual is NFTokenMetadata {
 ...
 uint256 _tokenId;
  constructor() {
   ...
   function mint (address _to,uint256 no_of_tokens_to_create, string calldata _uri) external {
  ...
  function batchmint (address to,uint256 no_of_tokens_to_create, string[] memory uri) external {
