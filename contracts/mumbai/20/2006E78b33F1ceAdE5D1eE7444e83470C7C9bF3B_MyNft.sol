...
contract MyNft is ERC721, Ownable, ERC2981 {
    ...
    uint256 public immutable presaleSupply = 4;
    ...
    address[] public withdrawAddresses = [0x329b743D7372b6Ec12FD6B8bb2b45Fc9EA948BaE, 0xb4082f8469795D49BD62DB1232561B4621BE127B];
    uint256[] public withdrawPercentages = [10, 90];


    bytes32 public merkleRoot = 0xe0d83b0386cb62aeaf8ae7f1a6900fb56962640d992568ee0a5c5e44e6b6f9c6;

    constructor() ERC721("testa", "a") {
        _baseTokenURI = "https://test-nft-tool-gateway-api.tuoluo.net/generator-server/api/contract/v1/1603725683882999809/metadata/";
        _setDefaultRoyalty(0xb4082f8469795D49BD62DB1232561B4621BE127B, uint96(0));
    }
