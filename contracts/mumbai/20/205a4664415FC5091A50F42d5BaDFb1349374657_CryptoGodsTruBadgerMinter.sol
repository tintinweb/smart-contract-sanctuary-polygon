...
contract CryptoGodsTruBadgerMinter is AccessControl {
  ...
  uint256 public unitPrice = .01 ether; //TODO unit price for whitelist?
  uint256 public startTime = 1690095800;
  ...
  function updateWhitelistStartDate(uint256 time) public onlyRole(ADMIN_ROLE) {
