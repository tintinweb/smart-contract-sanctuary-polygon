...
contract colmod is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    ...
    //setBaseURI("https://ipfs.io/ipfs/bafybeiaw6iz5bbbd54svpffknnfbvkxycjt5ynbkccimnumrja6cyru77m");
  ...
  // public
  function PMint(uint256 quantity)  external payable callerIsUser {
...
*/
   require(quantity<=10, "reached max supply");
    ...
    uint256 totalCost = saleConfig.cost * quantity;
