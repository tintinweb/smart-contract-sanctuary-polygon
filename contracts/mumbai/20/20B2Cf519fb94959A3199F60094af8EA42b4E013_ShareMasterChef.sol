...
contract ShareMasterChef is IRewardPool, OwnableUpgradeable, IERC721Receiver, ReentrancyGuard {
    ...
    struct PoolInfo {
        ...
        uint256 allocPoint;        // How many allocation points assigned to this pool. SKY to distribute per block.
        uint256 lastRewardTime;    // Last block number that SKY distribution occurs.
        uint256 accSharePerShare;  // Accumulated SKY per share, times 1e18. See below.
