...
contract DrippsEventFactory is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    event NewEvent(address instance);
		...
		event NewQuotes(address quotesAddress);

		/**
     * @dev Sets the value of the `_eventImplementation`.
   	 */
    function eventImplementation_set(
		...
		/**
    	* @dev Returns the value of the `_eventImplementation`.
    	*/
    function eventImplementation() external view virtual returns (address) {
		...
		/**
     * @dev Sets the value of the `_quotesAdress`.
   	 */
    function quotes_set(
			address quotesAdress
		) external onlyOwner {
    		quotes_set_unchained(quotesAdress);
    }

		function quotes_set_unchained(
			address quotesAdress
		) internal onlyOwner {
				_quotesAdress = quotesAdress;
				emit NewQuotes(quotesAdress);
		}

			/**
		* @dev Returns the value of the `_quotesAdress`.
		*/
    function quotes() external view virtual returns (address) {
        return _quotesAdress;
    }
    ...
    function eventCreate(
        ...
        _initAndEmit(
					...
					abi.encodeWithSignature(
						"initialize(address,string,uint256,uint256,uint256,string,int256,int256,address,uint256)",
						msg.sender,
