...
//    }
    ...
    */
    function detach(
        ...
        for (uint256 i=0; i<tailAddresses.length; i++) {
            if (!airdropReceived[parentIds[i]] && tailAddresses[i] == crateContract && tailIds[i] == parentIds[i]) {
    ...
    */
    function getParentOf(address tailAddress, uint256 tailId) external view returns (uint256) {
    ...
    */
    function popToken(address tailAddress, uint256 parentTokenId, uint256 tailTokenId) internal {
    ...
    /**
        ...
        * @param tailAddress The address of the tail contract
    */
    function popTailAddress(uint256 parentTokenId, address tailAddress) internal {
