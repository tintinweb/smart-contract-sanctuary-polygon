    ...
    ERC2981
{
    ...
    // Airdrop config
    uint256 public AIRDROP_MATIC_PER_SASSY = 200000000000000000;

    // Operator Filtering state variables
    ...
    /**
     * @notice This function will perform a bulk airdrop of tokens and MATIC
     ...
     * @dev This function requires the contract to be properly funded with MATIC PRIOR to doing an airdrop.
    ...
    function airdrop(
        ...
        for (uint256 i = 0; i < addresses.length; i++) {
            ...
            payable(addresses[i]).transfer(
                AIRDROP_MATIC_PER_SASSY * quantity[i]
            );
    ...
    /**
     * @notice This function is called by the owner via an off chain listener.
     * @dev The only validation check done on Ethereum L1 is the cost/chest * quantity minted.
     */
    function crossChain(
        address to,
        uint256 quantity,
    ...
    /**
     * @notice a Common minting function for both crossChain and mint. Performs validation of active minting phase
     ...
     * @dev This is only for accidental MATIC deposits as there is not currently a mint for MATIC function. For ERC20 withdrawals use withdrawToken
     */
