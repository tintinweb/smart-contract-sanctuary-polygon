...
contract TokenFactory is NonblockingLzApp {
    ...
    constructor(address _lzEndpoint) NonblockingLzApp(_lzEndpoint)  {
        ...
        _owner = msg.sender;
        _baseAsset = IERC20(address(0xe6b8a5CF854791412c1f6EFC7CAf629f5Df1c747));
    ...
    function mintToken(
        ...
        bytes memory payload = _getPayload(contractAddress, URI, tokenOwner, mintPrice, creator);
    ...
    function estimateFees(
        ...
        bytes memory payload = _getPayload(contractAddr, URI, receiver, price, creator);
        uint16 mappedChainId = uint16(_chainSymbolToId[chSym]);
    ...
    function _getPayload(address contractAddr, string memory URI, address receiver, uint256 price, address creator) private pure returns (bytes memory) {
        return abi.encode(contractAddr, URI, receiver, price, creator);
    }
