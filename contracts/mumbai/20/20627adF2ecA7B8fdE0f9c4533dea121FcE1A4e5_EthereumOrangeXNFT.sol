...
contract EthereumOrangeXNFT is ERC721, Ownable {
    ...
    function convertEthereumToMatic() public view returns (uint256) {
        ...
        uint256 ethValue;
        uint256 ethereumOrangeValue;
        uint256 ethereumOrangeValueInMATIC;
        uint256 maticValue;
        ...
        ethereumOrangeValue = ethValue / 1000; // 1 ETH Orange value in USD
        maticValue = ((10**18) * uint256(maticPrice)) / maticDecimals; // ETH value in USD
        finalMaticValue = (((10**18) * ethValue) / maticValue) * (1 ether);
        ethereumOrangeValueInMATIC = (finalMaticValue / 10**18) / 1000; // 1 ETH Orange value in MATIC
        return ethereumOrangeValueInMATIC;
    }
}