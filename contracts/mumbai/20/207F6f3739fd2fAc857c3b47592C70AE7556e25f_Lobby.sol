...
contract Lobby is Ownable {
    ...
    function setGameContract(address _gameContractAddress) public onlyOwner {
    ...
    uint public enlistCost = .0001*10**18; // TODO: Move this and things like it to a central place
    ...
    function enlistForMission(address _charContractAddress, uint _charId) public payable {
        ...
        uint playerIndex = games.addPlayer(_charContractAddress, _charId, msg.sender);
    ...
    function debugStartGame() public onlyOwner {
        // TODO: We don't have the character contract address here currently
        enlistForMission(address(this), 3);
        enlistForMission(address(this), 2);
        enlistForMission(address(this), 1);
        enlistForMission(address(this), 0);
    }
}
