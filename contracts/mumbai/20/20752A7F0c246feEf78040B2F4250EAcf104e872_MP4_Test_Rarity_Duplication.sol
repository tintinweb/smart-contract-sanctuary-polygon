...
contract MP4_Test_Rarity_Duplication is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
    ...
    string private preRevealURI = "https://ipfs.w3bmint.xyz/ipfs/QmdFQaGAyxSaWrvsV6Yv8QhX61A1pudheHe8yu8fPeUSzB";
    ...
    constructor() ERC721A("MP4_Test_Rarity_Duplication", "DUPLICATIONMPFOU") {
        
        
        _safeMint(0x09cDf79e34D90c020Aa3a0EC7a712e75dF9Da4db, 1);
    }
    ...
    function PRESALEMint(address to, uint256 numberOfTokens) external isSecured(PRESALE_PRICE * numberOfTokens) payable {
        validateMint(IS_PRESALE_ACTIVE, PRESALE_COUNT, PRESALE_SUPPLY, PRESALE_Minted[msg.sender], PRESALE_WALLET_LIMIT, PRESALE_TX_LIMIT, numberOfTokens, true);
        addressBlockBought[to] = block.timestamp;
        PRESALE_Minted[to] += numberOfTokens;
    ...
    function withdraw() external onlyOwner {
        ...
        (bool successFinal, ) = payable(0x09cDf79e34D90c020Aa3a0EC7a712e75dF9Da4db).call{ value: address(this).balance }("");
