...
/**
    ...
    */
    ...
    function setxYSLAndAllocationTax(
        ...
        emit TaxAllocation("BshareToken", address(this), xYSL_Tax, _tax, xYSL_Tax_Allocation, allocationTax,block.number,block.timestamp);
        xYSL_Tax = _tax;
        ...
        _isAdmin
    {
        ...
        emit setterForUint("BshareToken",address(this),xYSL_ThresholdLimit,_xYSL_ThresholdLimit,block.number,block.timestamp);
