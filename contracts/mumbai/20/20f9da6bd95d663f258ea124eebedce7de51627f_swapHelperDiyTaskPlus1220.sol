...
interface swapHelperDiyTaskPlus {
    function setDefaultSwapInfo(uint256 _approveAmount) external;
    function setUSDTPoolAddress(address _USDTPoolAddress) external;
     function createTask(
...
contract swapHelperDiyTaskPlus1220 is OpsTaskCreator, Ownable {
    ...
    function setDefaultSwapInfo(uint256 _approveAmount) public onlyOwner {
         ...
         XD.delegatecall(abi.encodeWithSelector(swapHelperDiyTaskPlus.setDefaultSwapInfo.selector,_approveAmount));
    }
    ...
    function setUSDTPoolAddress(address _USDTPoolAddress) public onlyOwner {
        ...
        XD.delegatecall(abi.encodeWithSelector(swapHelperDiyTaskPlus.setUSDTPoolAddress.selector,_USDTPoolAddress));
    }
    ...
    function createTask(
        tccItem calldata _tcc
         ...
         XD.delegatecall(abi.encodeWithSelector(swapHelperDiyTaskPlus.setUSDTPoolAddress.selector,_tcc));
