...
contract LimitOrderBookFactory is Ownable {
    ...
    mapping(uint24 => address) private orderBooks;
    // Instance of beacon
     ...
     * */
    function deployLimitOrderBookProxy(address _perpetualManagerAddr, uint24 _perpetualId)
        external
        onlyOwner
    {
        ...
        BeaconProxy limitOrderBookProxy = new BeaconProxy(
            ...
            abi.encodeWithSelector(
                LimitOrderBook(address(0)).initialize.selector,
...
contract LimitOrderBook is IPerpetualOrder, Initializable, PerpetualHashFunctions {
     ...
     * @param _perpetualId The id of perpetual.
     * */
    function initialize(address _perpetualManagerAddr, uint24 _perpetualId) external initializer {
