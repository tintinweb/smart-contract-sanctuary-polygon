 ...
 * @author mario
 */
contract Hivemind is HivemindV1Storage, HivemindI, ErrorReporter, Ownable {
  ...
  function getHypotheticalAccountLiquidityBorrowInternal(
    ...
    uint256 sumCollateral = oracle.getUnderlyingNFTPrice(_collection, _hToken.decimals());
    ...
    // console.log("sumCollateral ", sumCollateral);
