...
contract RBL20 is Context, IERC20, Ownable {
  ...
  uint256 public INCREASE_CAP = 20;
  ...
  function tryBuyToken(uint256 _amountUSD) public view returns (uint256[] memory) {
    ...
    uint256 afterbalance = usdToken.balanceOf(address(this)).add(_amountUSD);
    uint256 sold_price = afterbalance.mul(10**usdToken.decimals()).div(_totalSupply);
