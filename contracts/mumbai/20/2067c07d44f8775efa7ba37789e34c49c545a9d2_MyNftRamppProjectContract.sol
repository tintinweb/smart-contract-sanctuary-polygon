  ...
  function _beforeTokenTransfer(
    ...
    contract MyNftRamppProjectContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("My NFT Rampp Project", "MSTEST", _proxyRegistryAddress)
        {}
        ...
        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/TqNvM8txM9Lc3NaCVbsH/contract-metadata";
        }
    }