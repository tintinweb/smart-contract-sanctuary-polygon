...
contract HexagonMarketplace is Ownable, ReentrancyGuard, ERC1155Holder {
    ...
    */
    function setFeeAllocations(FeeAllocation[] memory _feeAllocations) external onlyOwner {
    ...
    */
    function updateWhitelist(address _nftAddress, address _royaltyRecipient, uint _royaltyFee) external onlyWhitelisted(_nftAddress) {
