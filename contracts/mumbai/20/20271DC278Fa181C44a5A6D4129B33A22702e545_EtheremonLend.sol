...
// File: contracts/EtheremonLend.sol
...
contract EtheremonLend is EthermonEnum, BasicAccessControl, SafeMathEthermon {
    ...
    */
    ...
    function borrowItem(uint64 _objId) external isActive {
        EtheremonTradeData monTradeData = EtheremonTradeData(
            tradingMonDataContract
        );
        ...
        emon.safeTransferFrom(
            msgSender(),
            obj.trainer,
            safeSubtract(borrowItem.price, fee)
        );
