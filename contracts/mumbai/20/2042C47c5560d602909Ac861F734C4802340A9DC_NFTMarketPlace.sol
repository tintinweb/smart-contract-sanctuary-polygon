...
contract NFTMarketPlace is ReentrancyGuard {
    // uint256   marketFees = 0.0001 ether;
    ...
    Counters.Counter private mainId;
    Counters.Counter private ownerList;
    ...
    event Paused(address from , address to , uint256 tokenId);
    ...
    function createItemForSale(
       ...
       // IERC721(nftContract).transferFrom(address(0), address(this), tokenId);
    ...
    function createMarketForSale(address nftContract, uint256 nftItemId)
        ...
        nonReentrant     
    {
        require(canPause==true,"Can't be transacted");
        ...
        itemsSold.increment();
        // payable(owner).transfer();  //removed becuase we need to remove the fees from frontend
    }
