...
contract Factory {
    ...
    function deploy(
        ...
        addr = address(
            new QuantumUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        QuantumUser721Token token = QuantumUser721Token(address(addr));
...
contract QuantumUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
