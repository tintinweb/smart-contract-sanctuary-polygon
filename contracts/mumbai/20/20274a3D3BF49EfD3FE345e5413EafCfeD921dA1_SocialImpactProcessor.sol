...
contract SocialImpactProcessor is Ownable {
    ...
    //Tracking indices
    uint256 highestCharityIndex = 0;
    uint256 highestTransactionIndex = 0;

    //Fees
    uint256 charityFee = 60;
    uint256 kindlyFee = 35;
    uint256 rebuyFee = 5;

    //Tokens
    IERC20 Kindly; //not used on TESTNET
    IERC20 USDC = IERC20(0xAECD12599ACC3318e640B0Ea1800B39b45085418);

    //Addresses
    address kindlyWallet = 0x1556646B375346C55Bd86f4d39Ab43f743432Da1;
    address rebuyWallet = 0x1556646B375346C55Bd86f4d39Ab43f743432Da1;
