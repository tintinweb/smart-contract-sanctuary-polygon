...
contract Bulma100ERC20Token is ERC20Permit, IOHM, OlympusAccessControlled {
    using SafeMath for uint256;

    constructor(address _authority) 
    ERC20("Bulma100", "BLM100", 18) 
    ERC20Permit("Bulma100") 
    OlympusAccessControlled(IOlympusAuthority(_authority)) {       
        
        _mint(_authority, 15000000000000000000000000000); 
