 ...
 *         ERC1155, and batch ERC1155 transfers, used by both PIX Marketplace as
 *         well as by conduits deployed by the ConduitController. Use great 
 *         caution when considering these functions for use in other codebases,
 *         as there are significant side effects and edge cases that need to be
 *         thoroughly understood and carefully addressed.
 */
