...
contract PolEye is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://Qme1bjKDT5EsLy1i4Fu98EpRgBKZuPsmFNWVmUjndbsFVg/";
  ...
  constructor() ERC721("PolEye", "PEY") {
    setHiddenMetadataUri("ipfs://QmQLP4YgERymqosbRDZ5wfwNqJDurvtxMFstmMxyUJNjJS/hidden.json");
  }
