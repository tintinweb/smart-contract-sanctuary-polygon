...
contract ChessWager is MoveHelper {
    ...
    function acceptWager(address wagerAddress) public {
    ...
    function payoutWager(address wagerAddress) public returns (bool) {
        require(
    ...
    function cancelWager(address wagerAddress) public returns (bool) {
        require(
            gameWagers[wagerAddress].player0 == msg.sender ||
                gameWagers[wagerAddress].player1 == msg.sender,
            "not listed"
