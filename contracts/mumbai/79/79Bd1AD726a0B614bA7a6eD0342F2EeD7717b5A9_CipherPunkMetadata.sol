...
/// @title Cipher Punk domain metadata contract
/// @author Cipher Labs
/// @notice Contract that generates metadata for the Cipher Punk domain.
contract CipherPunkMetadata is Ownable {
  ...
  function getMetadata(
    ...
    return string(
      abi.encodePacked("data:application/json;base64,",Base64.encode(bytes(abi.encodePacked(
        ...
        '"description": "A collection of Cipher Punk NFTs created by Cipher Domain Service: https://cipher.domains/#/nft/punk", ',
