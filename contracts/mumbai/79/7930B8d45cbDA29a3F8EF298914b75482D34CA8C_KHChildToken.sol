...
// File: @maticnetwork/pos-portal/contracts/common/ContextMixin.sol
...
// File: @maticnetwork/pos-portal/contracts/child/ChildToken/ChildERC20.sol
...
// File: contracts/khchildtoken/KHChildToken.sol

pragma solidity >=0.6.0 <0.8.0;


contract KHChildToken is ChildERC20 {
    constructor(
        string memory name_,
        string memory symbol_,
        uint8 decimals_,
        ...
        // can't mint here (Mumbai/Polygon), because minting in child chain smart contract's constructor not allowed 
        // (it is done on root contract, on Goerli/Ethereum)
    }
}