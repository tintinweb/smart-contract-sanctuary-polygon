...
abstract contract WorldStorage is Initializable, WorldContracts {
    ...
    function dragonToWorldOfOwner(Location _location, address _owner) external view override returns(uint256[] memory){
    ...
    function wizardToWorldOfOwner(Location _location, address _owner) external view override returns(uint256[] memory){
