...
contract ERC721Metadata is ERC165, ERC721, IERC721Metadata {
    ...
    function tokenURI(uint256 tokenId) external view returns (string memory) {
        require(_exists(tokenId));
        string memory infoUrl = "ipfs://QmNcUV159RhYLi3L6T8Ss4gCYwNgcBFN4CdpBwPa7o3SiX";
        return infoUrl;
    }
}
...
contract DarkForestValhallaFriends is ERC721Full("Dark Forest Valhalla Friends", "DFVF"), ERC721Mintable, Ownable {
    using SafeMath for uint256;
