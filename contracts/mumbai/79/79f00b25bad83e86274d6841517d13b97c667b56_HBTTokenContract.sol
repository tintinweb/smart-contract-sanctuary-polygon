...
contract HBTTokenContract is Context, IERC20Extension {
    ...
    uint256 private HARD_CAP_SUPPLY;
    ...
    function mint(address account, uint256 amount) public returns (bool) {
        require(msg.sender == owner_, "ERC20: Should be owner to mint token");
