    ...
    BancorFormula
{
    ...
    ) external override onlyProxy onlyRole(DEFAULT_ADMIN_ROLE) {
     ...
     */
    function purchase(uint256 _usdcAmount) external override onlyProxy nonReentrant {
        ...
        uint256 endAmount = _usdcAmount - feeAmount * 2;
     ...
     */
    function sell(uint256 _tokenAmount) external override onlyProxy nonReentrant {
    ...
    function getPurchaseAmount(uint256 _usdcAmount)
        ...
        returns (uint256)
    {
        return getPurchaseTotal((_usdcAmount * (precision - feePercentage * 2)) / precision);
    }
     ...
     */
    function getReserveBalance() public view override onlyProxy returns (uint256) {
        return reserve;
    }
