    ...
    IDapp
{
    ...
    mapping(string => bytes) public remoteContracts;
    ...
    function setContractOnChain(
        ...
        remoteContracts[chainId] = toBytes(contractAddress);
    }
    ...
    function sendRPTokenCrossChain(
        ...
        gateway.iSend(
            ...
            _dstChainId,
            _requestMetadata,
            abi.encode(remoteContracts[_dstChainId], payload)
        );
    }
    ...
    function iReceive(
        ...
        require(
            keccak256(srcContractAddress) ==
                keccak256(remoteContracts[srcChainId]),
            "Invalid src chain"
        );
    ...
    function iAck(
        ...
        if (execFlags) {
            bytes memory _execData = abi.decode(execData, (bytes));
