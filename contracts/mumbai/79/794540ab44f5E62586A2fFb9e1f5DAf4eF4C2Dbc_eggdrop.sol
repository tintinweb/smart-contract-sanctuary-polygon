...
contract eggdrop is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor()
        ERC721("Asprey Bugatti La Voiture Noire Collection", "AB:C1")
    {
    ...
    function mint(address to) external onlyOwner {
        require(totalSupply() <= MAX_Count, "Mint supply exceeded");
