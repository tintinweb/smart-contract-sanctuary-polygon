...
contract NFTPMysteryBox is ERC1155, ReentrancyGuard, AccessControl {
    ...
    */
    function setBnbBuying(uint256 id, bool state) external onlyRole(DEFAULT_ADMIN_ROLE) {
        MysteryBox.Collection storage c = collections[id];
    ...
    */
    ...
    //     uint256 priceBNB = twapGetter.getPrice(path); // again path
    ...
    */
    function mintWithToken(uint256 id, uint256 amount) external {
        ...
        uint32 twapInterval = 0; // how to set this correctly?
