    ...
    ReentrancyGuard
{
    ...
    modifier throttleLimit() {
        ...
        if(throttling[key] > maxFusionsPerDay + bonuses_fusion[msg.sender]) revert("too many fusions for today");
        _;
    }
    ...
    function whitelistsalesmint(
        ...
        if (index + quantityToMint > maxSupplyToMint)
        ...
        throttleLimit
    {
        ...
        if (datas1.evolution != datas2.evolution) revert("fusion impossible car pas la meme evolution");
        if (datas1.types == datas2.types) revert("fusion impossible car de la meme couleur");
    ...
    function transferFrom(
        ...
        address to,
        uint256 tokenId
    ) public virtual payable override(ERC721A, IERC721A) {
