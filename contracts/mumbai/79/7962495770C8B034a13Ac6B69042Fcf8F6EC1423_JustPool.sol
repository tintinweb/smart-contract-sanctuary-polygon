...
contract JustPool is ERC20Upgradeable, OwnableUpgradeable, AccessControlUpgradeable {
    ...
    mapping(address => bool) public roll;

    modifier onlyRoll(address poolAddr) {
        require(roll[poolAddr]);
        _;
    }

    function setRoll(address newRoll, bool state) public onlyOwner {
        roll[newRoll] = state;
    }
    ...
    function getReward(uint256 amount, address winner) public onlyRoll(msg.sender) {
