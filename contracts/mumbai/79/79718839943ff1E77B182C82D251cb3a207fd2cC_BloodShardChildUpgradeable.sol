...
contract BloodShardChildUpgradeable is Initializable, ERC1155SupplyUpgradeable, ERC1155PausableUpgradeable, IChildToken, AccessControlMixinUpgradeable, NativeMetaTransactionUpgradeable, ContextMixinUpgradeable {
    ...
    function __BloodShardChild_init(
        ...
        _name = name_;
        _symbol = symbol_;
        _setupContractId("BloodShardChild");
    ...
    function mint(
        ...
        uint256 amount,
        bytes calldata data
    ) external only(AUTHORISED_MINTER_ROLE) {
        _mint(account, BLOOD_SHARD_ID, amount, data);
        emit Mint(account, BLOOD_SHARD_ID, amount);
    }
