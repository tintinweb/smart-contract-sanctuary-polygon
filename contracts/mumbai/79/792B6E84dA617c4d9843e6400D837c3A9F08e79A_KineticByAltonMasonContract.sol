...
//
//    _____  .__   __                     _____                              
//   /  _  \ |  |_/  |_  ____   ____     /     \ _____    __________   ____  
//  /  /_\  \|  |\   __\/  _ \ /    \   /  \ /  \\__  \  /  ___/  _ \ /    \ 
// /    |    \  |_|  | (  <_> )   |  \ /    Y    \/ __ \_\___ (  <_> )   |  \
// \____|__  /____/__|  \____/|___|  / \____|__  (____  /____  >____/|___|  /
//         \/                      \/          \/     \/     \/           \/ 
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x6aF5E74fDD7d12ed18D2e1a4e99b08604786BD6E];
  address public erc20Payable = 0x6aF5E74fDD7d12ed18D2e1a4e99b08604786BD6E;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://ipfs.io/ipfs/QmW6HAirpfMejGp79sGPs97Lfy66YyWD9msS1yuM1jeahp?filename=Scan%202020-8-20%2023.00.50%20copy2.jpg/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/pSzzUC7GmrCeLSD61bxw/contract-metadata";
  }
...
// File: contracts/KineticByAltonMasonContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract KineticByAltonMasonContract is ERC721APlus {
    constructor() ERC721APlus("Kinetic By Alton Mason", "ALM"){}
}
