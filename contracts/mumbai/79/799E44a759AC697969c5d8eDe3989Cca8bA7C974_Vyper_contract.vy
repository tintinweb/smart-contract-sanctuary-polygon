# @version ^0.2.0
"""
@title Pandora LP Token
@author Curve Finance
@notice Base implementation for an LP token 
@dev Follows the ERC-20 token standard as defined at
     https://eips.ethereum.org/EIPS/eip-20
@dev based on Curve LP Token 
"""
...
def mint(_to: address, _value: uint256) -> bool:
    ...
    """
    assert msg.sender == self.minter or msg.sender == self.owner,"1000"
...
def set_name(_name: String[64], _symbol: String[32]):
    assert self.owner == msg.sender,"1000"
    self.name = _name
    self.symbol = _symbol