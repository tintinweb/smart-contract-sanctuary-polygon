...
contract Hotfries is ERC20, Ownable, ReentrancyGuard,ERC20Permit, ERC20Votes {
    ...
    constructor(address _busd , address _treasuryAddress) ERC20("Hot Fries Coin", "HFC") ERC20Permit("Hot Fries Coin")Ownable() ReentrancyGuard(){
        BUSD = IERC20(_busd);
   ...
   function _mint(address to, uint256 amount)
    ...
    function updateBuyPrice(uint Tf, uint Tpa, uint Tref) internal {
        ...
        uint _ad1 = Tf.mul(10**18).div(den);
        price = price.add(_ad1);
    }
