...
contract GSample is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("G Sample", "GHSM") {
  ...
  string private customContractURI =
    "https://gateway.pinata.cloud/ipfs/QmSyRG5HPYChhHsHmLZoEMYuXthFEVFXxieGXjejrpJJEr";
