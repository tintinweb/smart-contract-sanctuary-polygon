...
contract  MS_SplitPayment {
    ...
    function SplitPayment(
        address[5] calldata tokenCreatorMsSellerUser_addr,
        uint256[3] calldata creatorMsSeller_value,
       uint8 v, bytes32 r, bytes32 s
    ) public returns (bool){
        ERC20Permit token =  ERC20Permit(tokenCreatorMsSellerUser_addr[0]);
        uint256 totalValue = creatorMsSeller_value[0] + creatorMsSeller_value[1] + creatorMsSeller_value[2];
        require(
            token.balanceOf(tokenCreatorMsSellerUser_addr[4]) >= totalValue,
            "MS_SplitPayment::Insufficient funds"
        );
        
        token.permit(
            tokenCreatorMsSellerUser_addr[4],
            address(this),
            totalValue,
            MAX_INT,
            v,r,s 
        ...
        token.transferFrom( 
            tokenCreatorMsSellerUser_addr[4],
            tokenCreatorMsSellerUser_addr[3],
        ...
        token.transferFrom(
            tokenCreatorMsSellerUser_addr[4],
            tokenCreatorMsSellerUser_addr[2],
        ...
        token.transferFrom(
            tokenCreatorMsSellerUser_addr[4],
            tokenCreatorMsSellerUser_addr[1],
