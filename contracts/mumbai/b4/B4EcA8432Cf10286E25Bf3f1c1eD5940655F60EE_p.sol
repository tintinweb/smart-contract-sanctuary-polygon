...
contract p is IERC721L, ERC721AQueryable, Ownable, ReentrancyGuard {
    ...
    // Current base URI.
    string private _currentBaseURI = "ipfs://bafybeifv3oclhtjccwc34osn6l3wgspgeakv4gfdbgeu7biswjomxo7zo4/";
    ...
    constructor() ERC721A("p", "p") {
        _mintStages.push(MintStageInfo({cost: 0, walletLimit: 5, merkleRoot: 0x0, maxStageSupply: 0, startTimeUnixSeconds: 1687264944, endTimeUnixSeconds: 1692448944}));
    }
