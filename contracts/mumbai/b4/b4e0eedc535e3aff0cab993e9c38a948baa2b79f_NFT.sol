...
// File: EthIndia/IERC721Metadata.sol
...
// File: EthIndia/NFT.sol


pragma solidity ^0.8.7;


contract NFT is ERC4973 {
    ...
    function mint(string calldata _tokeURI) external onlyOwner {
        require(!_userExist[msg.sender],"User already exist's");
        _mint(msg.sender, count, _tokeURI);
