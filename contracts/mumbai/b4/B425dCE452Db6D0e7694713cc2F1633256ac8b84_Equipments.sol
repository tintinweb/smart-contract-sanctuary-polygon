...
contract Equipments is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    function encodeStats(equipment_stats memory _stats) internal pure returns (string memory stats_uri){
        stats_uri = string(abi.encodePacked(
                            '"}, {"display_type": "number", "trait_type": "Attack", "value": ', Strings.toString(_stats.atk),
                            '}, {"display_type": "number", "trait_type": "Defense", "value": ', Strings.toString(_stats.def),
                            '}, {"display_type": "number", "trait_type": "Evade Chance", "value": ', Strings.toString(_stats.eva),
                            '}, {"display_type": "number", "trait_type": "HP", "value": ', Strings.toString(_stats.hp),
                            '}, {"display_type": "number", "trait_type": "Penetration Chance", "value": ', Strings.toString(_stats.pen),
                            '}, {"display_type": "number", "trait_type": "Critical Chance", "value": ', Strings.toString(_stats.crit),
                            '}, {"display_type": "number", "trait_type": "Luck", "value": ', Strings.toString(_stats.luck),
                            '}, {"display_type": "number", "trait_type": "Energy Restoration", "value": ', Strings.toString(_stats.energy_regen)
        ));
    }
