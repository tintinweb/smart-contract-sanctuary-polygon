...
//*********************************************************************//
//
//     __  _____  ____  _________   ____             __        __   _____ __   _     
//    /  |/  / / / /  |/  / ____/  / __ \____  _____/ /_____ _/ /  / ___// /__(_)___ 
//   / /|_/ / / / / /|_/ / __/    / /_/ / __ \/ ___/ __/ __ `/ /   \__ \/ //_/ / __ \
//  / /  / / /_/ / /  / / /___   / ____/ /_/ / /  / /_/ /_/ / /   ___/ / ,< / / / / /
// /_/  /_/\____/_/  /_/_____/  /_/    \____/_/   \__/\__,_/_/   /____/_/|_/_/_/ /_/ 
//                                                                                   
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract ProviderFees is Context {
  ...
  uint256 public PROVIDER_FEE = 1 ether;  
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1683154800;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x565D3CCFaf83d460637eB304fBaec25B7bEF5D1F];
  address public erc20Payable = 0x565D3CCFaf83d460637eB304fBaec25B7bEF5D1F;
...
abstract contract EarlyMintIncentive is Teams, ERC721A, ProviderFees {
  ...
  uint256 public EARLY_MINT_PRICE = 25 ether;
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 100, 1000) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeieun4ypakc7eootwuzlovgrcnve2wsoynh5r5r3gpx7cvzdm76tna/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/BhdMTrYKnLo1h8hjifFt/contract-metadata";
  }
...
// File: contracts/MumePortalSkinContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MumePortalSkinContract is ERC721APlus {
    constructor() ERC721APlus("MUME Portal Skin", "MPS"){}
}
