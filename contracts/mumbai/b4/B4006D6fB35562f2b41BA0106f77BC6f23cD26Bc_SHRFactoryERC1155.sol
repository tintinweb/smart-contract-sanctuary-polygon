...
import "./SHR_NFT_1155_V1.sol";

contract SHRFactoryERC1155 is Initializable, OwnableUpgradeable, UUPSUpgradeable {

    SHRNFT_1155_Collection_v1[] public collections; //an array that contains different ERC1155 tokens deployed
    ...
    function deployERC1155(string memory _contractName, string memory _uri, string memory _symbol, address _royaltyRecipient, uint256 _royaltyValue) public returns (address) {
        SHRNFT_1155_Collection_v1 t = new SHRNFT_1155_Collection_v1(_contractName, _uri, _symbol, _royaltyRecipient, _royaltyValue);
        collections.push(t);
    ...
    */
    ...
    {
        SHRNFT_1155_Collection_v1 token = collections[_index];
...
contract SHRNFT_1155_Collection_v1 is
    ERC1155,
    Ownable,
    Pausable,
    ERC1155Burnable,
