...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x1BA5FC1F4d950EEDDf7EF1815AD36Af41507B5cD,0xd757F456C2E98cbE72c65Bcc932Ed41C9470dcd8];
  address public erc20Payable = 0x1BA5FC1F4d950EEDDf7EF1815AD36Af41507B5cD;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 300) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeifdnlldsq5kllxgjqxeaubr63ovwfxtqtwzparh2w2tlq2b7lpbli/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/hxZzGEq6X7eB9IkkB3u5/contract-metadata";
  }
...
// File: contracts/XmasBiMsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract XmasBiMsContract is RamppERC721A {
    constructor() RamppERC721A("Xmas BiMs", "XmasBiMs"){}
}
