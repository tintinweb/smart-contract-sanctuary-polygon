...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    function _mint(
        ...
        require(to != address(0), "ERC1155: mint uuu to the zero address");
...
// File: 1155FractionSimple/Fraction.sol
...
contract Fraction is ERC1155, Ownable, ERC721Holder, ERC1155Burnable {
    ...
    uint256 public auctionLength = 15 days;
    ...
    // "https://ipfs.io/ipfs/QmSU8Ao3rFCQYrFFFVYeXri7TXFzvorSpRRqzN1axFrEBZ?filename=1.json"
    ...
    function initialize(
        ...
        forSale = true;
        maxSupply=supply;
        _mint(msg.sender,1,maxSupply,"0");

    }

    function start() external payable {
        require(auctionState == State.inactive, "start:no auction starts");
        require(msg.value >= salePrice, "start:too low bid");
    ...
    function bid() external payable {
        ...
        _sendETHOrWETH(winner, livePrice);
    ...
    function cash() external {
        ...
        uint256 share = bal * address(this).balance / maxSupply;
        super.burn(msg.sender, 1, bal);
    ...
    //         require(_amount>= balanceOf(from) , "Not enough token");
    //         uint256 totalBalance = address(this).balance;
    //         uint256 toRedeem = _amount * totalBalance / maxSupply;
    //         super.burn(from, 1, _amount);
    //         payable(from).transfer(toRedeem);
    //     }
