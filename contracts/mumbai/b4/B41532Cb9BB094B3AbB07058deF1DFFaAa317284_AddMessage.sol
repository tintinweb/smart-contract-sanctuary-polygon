...
contract AddMessage is IExecutePlugin, BasePlugin {

    constructor(address _registry) {
        PLUGIN_VERSION = 1;
        PLUGIN_NAME = PluginsList.SAFE_DEAL_ADD_MESSAGE;
    ...
    function execute(
        ...
        require(ISafeDeal(registry.safeDeal()).addMessage(vars),
            "AddMessage: wrong exec"
        );
