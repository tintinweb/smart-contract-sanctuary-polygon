...
contract Auction is IERC721Receiver {
    ...
    event CREATETOKENAUCTION(address nft,uint256 tokenId,uint128 price,uint256 duration);
    event BID(address nft,uint256 tokenId);
    event EXCUTESALE(address nft,uint256 tokenId);
    event CENCELAUCTION(address nft,uint256 tokenId);
    ...
    function createTokenAuction(
        ...
        emit CREATETOKENAUCTION(_nft,_tokenId,_price,_duration);
    }
    ...
    function cancelAuction(address _nft, uint256 _tokenId) external {
        ...
        emit CENCELAUCTION(_nft,_tokenId);
    }
