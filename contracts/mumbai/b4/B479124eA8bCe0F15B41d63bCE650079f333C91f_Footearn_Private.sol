...
contract Footearn_Private is ReentrancyGuard, Ownable {
    ...
    function buy(uint256 amount) public nonReentrant {
        ...
        if (whitelistWiner[msg.sender] == true) {
            require(
                amount <= maxBuyWiner + maxBuyRandom && nextBuy <= maxBuyWiner + maxBuyRandom,
        ...
        require(
            usdToken.balanceOf(msg.sender) >= amount,
        ...
        usdToken.safeTransferFrom(msg.sender, fundAddress, amount);
