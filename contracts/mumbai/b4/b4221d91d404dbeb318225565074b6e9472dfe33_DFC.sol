...
/// @notice This contract is upgradeable
/**
@dev
    ...
    ERC721EnumerableUpgradeable
{
    ...
    uint256 public cost; // This is the initial price set by the owner to mint each NFT.
    uint256 public maxSupply; // Total number of NFT that are available to mint.
    uint256 public maxMintAmount; // The max amount of NFTs that can be mint at a time.
    bool public paused; // circuit breaker. The owner can pause the contract from executing important functions during emergency.
    bool public revealed; // if the NFT project has been revealed.
    ...
    function initialize(
        ...
        /// @dev Since we don't use a constructor for UUPS contracts, we need to explicitly initialize OwnableUpgradeable
        __Ownable_init();
    ...
    ///@dev required by the OZ UUPS
    function _authorizeUpgrade(address) internal override onlyOwner {}

    /// @dev allows contract to receive ether sent to it
