...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x2F6D68A819FBA8A5dbeCf653B75F9b5c5E758321];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 10, 100 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmVzUmLViJpap5pZjpSqBeAHgfWa9XSyHwkaRYzkYErwb3/";
...
// File: contracts/CoolSnakes30Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CoolSnakes30Contract is RamppERC721A {
    constructor() RamppERC721A("Cool Snakes 30", "CS"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/urfN4PAE9GJthOpXm86s/contract-metadata";
    }
}
