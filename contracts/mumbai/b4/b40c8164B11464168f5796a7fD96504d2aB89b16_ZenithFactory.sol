 ...
 */
contract ERC20Std is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function setVersion(string memory version_) external onlyOwner { VERSION = version_; }
...
contract ZenithInitializable is Ownable, ReentrancyGuard {
    using SafeERC20 for IERC20Metadata;

    // The address of the zenith stake factory
    address public immutable ZENITH_STAKE_FACTORY;
    ...
    constructor()
    {
        ZENITH_STAKE_FACTORY = msg.sender;
    }
        ...
        external
    {
        ...
        require(msg.sender == ZENITH_STAKE_FACTORY, "Not factory");
...
contract ZenithFactory is Ownable {
    ...
    function getStakeAddressByIndex(
        uint256 index
    )
    ...
    function getStakeAddressByPair(
        address staked,
        address rewarded
    )
    ...
    function getStakeAddressByRangeIndex(
        uint256 fromIndex,
        uint256 toIndex
    )
        public view returns(address[] memory)
...
interface IZenithInitializable {
    ...
    function initialize ( address _stakedToken, address _rewardToken, uint256 _rewardPerBlock, uint256 _startBlock, uint256 _bonusEndBlock, uint256 _poolLimitPerUser, uint256 _numberBlocksForUserLimit, address _admin ) external;
