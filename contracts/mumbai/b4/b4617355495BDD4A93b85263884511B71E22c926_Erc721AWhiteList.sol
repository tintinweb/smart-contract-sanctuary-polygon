...
// File: contracts/ERC721AWhitelist.sol



// Edited by Cindy Horn - Added whitelist and Extended ERC721A
...
contract Erc721AWhiteList is ERC721A, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://QmT4uvU9dTTRkY8m84FDtxLVTemCn9yW6aVCkwdg5d52E7/";
  ...
  constructor() ERC721A("CozySpaceNFT", "CSNFT") {
  ...
  modifier mintCompliance(uint256 _mintAmount) {
    ...
    if (isOwner()) {
        ...
        require(whitelistTokenCount[msg.sender] + _mintAmount <= whitelist[msg.sender], "Max limit reached.");
        require(whitelist[msg.sender] > 0, "You are not authorized");
    }
    _;
  }
  ...
  function setWhitelist(address _address, uint256 _numberOfTokens) public onlyOwner {
      whitelist[_address] = _numberOfTokens;
  }
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) callerIsUser {
    ...
    if (whitelistOnly) {
      whitelistTokenCount[msg.sender] = whitelistTokenCount[msg.sender] + _mintAmount;
    }
