...
contract EntityPolicyBank {
    ...
    function getPolicy(bytes32 policyId) public canView view returns(address, address, bool) {
        return (policyMapping[policyId].owner, policyMapping[policyId].routeTo, policyMapping[policyId].isActive);
    }
    ...
    function isPolicyAdminWallet(bytes32 policyId) public view returns (bool) {
        return policyMapping[policyId].owner == msg.sender;
    }
