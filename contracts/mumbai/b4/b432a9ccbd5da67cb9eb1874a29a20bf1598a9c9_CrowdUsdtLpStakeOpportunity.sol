...
//        _transferFrom(pair, _removeLiqDescriptor.amountLP);

        uint256[] memory _fees = new uint256[](2);
        _fees[0] = unstakeFee;
        _fees[1] = removeLiquidityFee;
        uint256 _totalFee = _deductFee(_fees, pair, _removeLiqDescriptor.amountLP);
        _removeLiqDescriptor.amountLP -= _totalFee;
