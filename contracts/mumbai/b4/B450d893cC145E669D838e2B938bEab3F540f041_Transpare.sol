...
contract Transpare is Ownable, SlotMachine {
    ...
    event PlaySlotMachine(address indexed user, uint[][] matrix, uint256 multiplier, uint256 payoutAmount, uint256 betAmount);
    ...
    function playSlotMachine(uint256 amountToPlay) public {
        ...
        // Emit the new event
        emit PlaySlotMachine(msg.sender, matrix, totalMultiplier, payoutAmount, amountToPlay);
    }
