  ...
  // MANAGING Authorization Contract Address for Call 
   ...
   // 合约部署者增加操作员
        ...
        returns(uint[] memory)
    {
        ...
        uint margin =auxiliaryDevice.prop_sum - (props[hash_attack] + props[hash_defense] + props[hash_hp] + props[hash_duration]);
        props[keccak256(abi.encode(auxiliaryDevice.margin_name))] +=  margin;
