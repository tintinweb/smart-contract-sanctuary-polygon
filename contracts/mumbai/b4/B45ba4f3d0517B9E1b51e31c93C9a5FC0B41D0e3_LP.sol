...
contract LP is ERC721AQueryable, Ownable, ReentrancyGuard, Pausable, IERC2981 {
    ...
    */
    bytes32 public phase1Root =
        0x2cc14f074759afa2a353be9188e86320e3701afaefaec123c69ab73603f6ed73;

    bytes32 public phase2Root =
        0x197684aaa6fc7f47960a18de200016a4603990eac793a4e8fbe75414f1033f3a;
    ...
    uint256 public phase1Start = 1666417216;
    uint256 public phase2Start = 1666431616;
    uint256 public phase3Start = 1666435216;
    ...
    */
    ...
    address private royaltyReceiver = 0x1b7fea990984bdD27c12d227CD2D3c4EaE3E6fDD;
    ...
    */
    function phase1Mint(
        ...
        require(msg.sender == to, "Can't mint to other address");
    ...
    function phase1MintPlatform(
        ...
        require(!usedHashes[paymentHash], "Already minted for hash");
    ...
    */
    ...
    function validatePhase1Mint(
        ...
        require(userMinted[to] + quantity <= PHASE_1_MAX, "Phase 1 limit exceeded");
