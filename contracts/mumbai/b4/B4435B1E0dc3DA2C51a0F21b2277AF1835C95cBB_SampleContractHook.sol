...
contract SampleContractHook is Initializable, PausableUpgradeable, OwnableUpgradeable, ERC20Upgradeable {
    ...
    function initialize(address _kuthulu, address _kutils,  address _doom) initializer public {
        __Pausable_init();
        __Ownable_init();
    ...
    */
    ...
    function KuthuluHook(MsgData memory newMsg) public returns (bool) {
        ...
        require(msg.sender == KuthuluContract, "Only accept calls from KUTHULU");
