...
//import "https://github.com/QuickSwap/megapool/blob/main/contracts/interfaces/IERC20Permit.sol";
//import "https://github.com/QuickSwap/megapool/blob/main/contracts/libraries/SafeERC20.sol";
...
struct AppStorage {
    ...
    uint256 totalSupply; //totalSupply of the Pool at a specific time
...
contract MegaPool {
    ...
    function rewardPerToken(address _rewardToken) internal view returns (uint256 rewardPerToken_, uint256 lastTimeRewardApplicable_) {
        ...
        if (lastUpdateTime == 0 || l_totalSupply == 0) {
            ...
            rewardPerToken_ =
                ...
                ((lastTimeRewardApplicable_ - lastUpdateTime) * rewardToken.rewardRate * 1e18) /
                l_totalSupply;
        }
    }
    ...
    function internalEarned(
        ...
        RewardToken storage rewardToken = s.rewardTokens[_rewardToken];
        return
            (s.balances[_account] * (_rewardPerToken - rewardToken.rewards[_account].userRewardPerTokenPaid)) /
            1e18 +
    ...
    function getAPY(address _rewardToken) external view returns (uint256 apy_) {
        require(s.totalSupply > 0, 'No stake inside the pool, apy is not calculatable');
        RewardToken storage rewardToken = s.rewardTokens[_rewardToken];
        uint256 anoTime = 31557600;
        apy_ = rewardToken.rewardPerTokenStored + (anoTime * rewardToken.rewardRate * 1e18) / s.totalSupply;
    }
