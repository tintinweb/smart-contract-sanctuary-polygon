...
contract MumbaiTest is ERC721, Ownable {
    ...
    constructor() ERC721("MumbaiTest", "MT") {}

    function setBase_URI(string calldata baseURI) external onlyOwner {
        base_URI = baseURI;
    }
    ...
    function mintNFT(address recipient) public payable returns (uint256) {
        ...
        require(msg.value >= MINT_PRICE, "Transaction value does meet the mint price");
