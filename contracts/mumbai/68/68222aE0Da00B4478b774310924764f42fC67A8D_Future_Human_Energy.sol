...
contract Future_Human_Energy is ERC1155, Ownable, Pausable, ERC1155Supply {

    constructor() ERC1155("ipfs://QmQWfhCjDwroxPqGZ26wje1AmQeQhrUovhQgc1tv2TcXB6/") {}
    ...
    function mint(uint256 amount) virtual payable public {

        uint256 suplied = (vari + amount);

        require(msg.value >= (amount * mintRate), "Insuficient Matic sending.");

        require(suplied + amount <= maxSupply, "Stock out.");
    ...
    function mintCompany(uint256 amount) public onlyOwner {
