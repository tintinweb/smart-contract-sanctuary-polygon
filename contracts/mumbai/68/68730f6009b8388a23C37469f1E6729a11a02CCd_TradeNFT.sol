...
contract TradeNFT is Ownable, ReentrancyGuard{
    ...
    function buyNFT(uint256 _tokenId, address _from, address _to, uint256 _numOfEditions, uint256 _perEditionPrice)
