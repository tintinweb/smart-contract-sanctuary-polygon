...
// File: interfaces/ITritonOwnable.sol


pragma solidity ^0.8.15;

interface ITritonOwnable {
...
// File: interfaces/ITritonPrimarySale.sol


pragma solidity ^0.8.15;

interface ITritonPrimarySale {
...
// File: interfaces/ITritonPlatformFee.sol


pragma solidity ^0.8.15;

interface ITritonPlatformFee {
...
// File: interfaces/ITritonRoyalty.sol


pragma solidity ^0.8.15;


interface ITritonRoyalty is IERC2981Upgradeable {
    struct RoyaltyInfo {
        address recipient;
        uint256 bps;
    }
...
// File: interfaces/token/ITritonERC721.sol
    ...
    ITritonERC721
{
    ...
    bytes32 private constant MODULE_TYPE = bytes32("TritonERC721");
    ...
    /// @dev Max bps in the triton system
    uint256 private constant MAX_BPS = 10_000;

    /// @dev The address interpreted as native token of the chain.
    address private constant NATIVE_TOKEN = 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE;

    /// @dev The triton contract with fee related information.
    ITTFee public immutable tritonFee;
    ...
    constructor(address _tritonFee) initializer {
        tritonFee = ITTFee(_tritonFee);
    }
    ...
    function collectPrice(MintRequest memory _req) internal {
        ...
        (address ttFeeRecipient, uint256 ttFeeBps) = tritonFee.getFeeInfo(address(this), FeeType.PRIMARY_SALE);
        uint256 ttFee = (totalPrice * ttFeeBps) / MAX_BPS;
        ...
        CurrencyTransferLib.transferCurrency(_req.currency, _msgSender(), ttFeeRecipient, ttFee);
        CurrencyTransferLib.transferCurrency(
            _req.currency,
            _msgSender(),
            saleRecipient,
            totalPrice - platformFees - ttFee
        );
    }
