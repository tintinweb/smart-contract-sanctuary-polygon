    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafkreichkr5k3p7xqviqnvlkeb3bflrshbzeve24ayniekrqn75nq3cjla/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/Dar0QOf0UVib7vgOw4Hd/contract-metadata";
  }
...
// File: contracts/AnaglyphAmunContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AnaglyphAmunContract is RamppERC721A {
    constructor() RamppERC721A("Anaglyph Amun", "ANAA"){}
}
