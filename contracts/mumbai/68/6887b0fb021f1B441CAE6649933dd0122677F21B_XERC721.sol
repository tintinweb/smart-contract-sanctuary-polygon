...
contract XERC721 is ERC721,ERC721URIStorage,IDapp {
 ...
 // name of the chain
  ...
  constructor() ERC721("MyNFT", "NFT") {
    ...
    owner = msg.sender; 
    ourContractOnChains[name["routerTest"]] = "router1g8yjhsthsmyflefs7wv2zw2dr5z2t5lexke85vln2wd9g9h9ckmq6vvc99";
...
function safeMint(address to, uint256 tokenId, string memory uri) public 
 ...
 function _burn(uint256 tokenId) internal override(ERC721, ERC721URIStorage) {
  ...
  function iReceive(
    ...
    safeMint(toAddress(transferParams.recipient), transferParams.nftId, "");
