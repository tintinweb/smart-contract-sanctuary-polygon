...
contract Kingdom is Ownable, IERC721Receiver, Pausable {  
    ...
    mapping(uint256 => uint80) public tokenToLevelTime;
    ...
    uint256 public totalAddPercent = 0;
    ...
    constructor(
        ...
        MAXIMUM_GLOBAL_GROAT = 10000000 ether;
        ...
        brutRelated.brutToEarnPerDay[0] = 40 ether;
        brutRelated.brutToEarnPerDay[1] = 44  ether;
        brutRelated.brutToEarnPerDay[2] = 52 ether;
        brutRelated.brutToEarnPerDay[3] = 64 ether;
        brutRelated.brutToEarnPerDay[4] = 80 ether;
        brutRelated.brutToEarnPerDay[5] = 100 ether;
        brutRelated.brutToEarnPerDay[6] = 124 ether;
        brutRelated.brutToEarnPerDay[7] = 152 ether;
        brutRelated.brutToEarnPerDay[8] = 184 ether;
        brutRelated.brutToEarnPerDay[9] = 220 ether;
        brutRelated.brutToEarnPerDay[10] = 260 ether;  

        brutRelated.brutToUnstakingFee[0] = 40 ether;
        brutRelated.brutToUnstakingFee[1] = 44 ether;
        brutRelated.brutToUnstakingFee[2] = 52 ether;
        brutRelated.brutToUnstakingFee[3] = 64 ether;
        brutRelated.brutToUnstakingFee[4] = 80 ether;
        brutRelated.brutToUnstakingFee[5] = 100 ether;
        brutRelated.brutToUnstakingFee[6] = 124 ether;
        brutRelated.brutToUnstakingFee[7] = 152 ether;
        brutRelated.brutToUnstakingFee[8] = 184 ether;
        brutRelated.brutToUnstakingFee[9] = 220 ether;
        brutRelated.brutToUnstakingFee[10] = 260 ether;

        brutRelated.brutToRequiredBling[0] = 0 ether;
        brutRelated.brutToRequiredBling[1] = 10 ether;
        brutRelated.brutToRequiredBling[2] = 20 ether;
        brutRelated.brutToRequiredBling[3] = 30 ether;
        brutRelated.brutToRequiredBling[4] = 35 ether;
        brutRelated.brutToRequiredBling[5] = 40 ether;
        brutRelated.brutToRequiredBling[6] = 45 ether;
        brutRelated.brutToRequiredBling[7] = 50 ether;
        brutRelated.brutToRequiredBling[8] = 65 ether;
        brutRelated.brutToRequiredBling[9] = 75 ether;
        brutRelated.brutToRequiredBling[10] = 90 ether; 
    ...
    function buyBling(uint256 _amount) external {
        ...
        contracts.bling.mint(_msgSender(), _amount);
    ...
    function levelupBrutality(uint256 tokenId) external {
        ...
        contracts.bling.transferFrom(_msgSender(),address(this), required_bling);
        require(
            block.timestamp - tokenToLevelTime[tokenId] >
        ...
        tokenToLevelTime[tokenId] = uint80(block.timestamp);
        emit BrutalityLevelupSuccess(_msgSender(), tokenId);
    }

    function levelupMultipleBrutality(uint256[] memory tokenIds) external {
        for (uint256 i = 0; i < tokenIds.length; i++) {
            require(
            ...
            uint256 required_bling = brutRelated.brutToRequiredBling[
                _brutalityLevelForHenchman(tokenIds[i])
            ];
            require(
                contracts.bling.balanceOf(_msgSender()) > required_bling,
                "NOT ENOUGH BLING"
            ...
            contracts.bling.transferFrom(_msgSender(),address(this), required_bling);
            require(
                block.timestamp - tokenToLevelTime[tokenIds[i]] >
                    brutRelated.brutToTimeLimit[_brutalityLevelForHenchman(tokenIds[i])] * 1 days,
                "There is time limit before each brutality level"
            );
            contracts.warrior.levelupBrutality(tokenIds[i]);
            tokenToLevelTime[tokenIds[i]] = uint80(block.timestamp);
            emit BrutalityLevelupSuccess(_msgSender(), tokenIds[i]);
        }        
    }
    /** STAKING */
        ...
        returns (uint256 score)
    {
        ...
        totalAddPercent += scoreToAddReward[diceScore];        
        score = diceScore;
        ...
        returns (uint256 owed)
    {
        if (contracts.warrior.getTokenTraits(tokenId).isMerry) {
            ...
            if (totalGroatEarned < MAXIMUM_GLOBAL_GROAT) {
                owed =
                    ((block.timestamp - stake.value) * brutRelated.brutToEarnPerDay[_brutalityLevelForHenchman(tokenId)])*(100 + stake.addReward)/100 /
                    1 days;
    ...
    function _updateEarnings() internal {
        if (totalGroatEarned < MAXIMUM_GLOBAL_GROAT) {
            totalGroatEarned = contracts.groat.totalSupply();
