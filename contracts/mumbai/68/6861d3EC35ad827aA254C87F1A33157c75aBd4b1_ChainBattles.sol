...
//                  ~P57!?YJ?77777YB5.                 
//                 5&!:YY!~!?J?!JP7.P#:                
//                [email protected]!!&J.JJJ7?55.:#? G#.               
//                [email protected] P5 ?!  J# Y& ^@Y               
//               .#P #5 5B^?? :GP Y&.:@P               
//                [email protected]^#7 ?5YYY5! ^#Y [email protected]               
//                 [email protected]!^GP7^^^^^7PG7.J#?                
//                  !BP7!7JY55Y7^^?GY:                 
//        .~7JYYYJ?!:.!5P5J???JY55?.  ^~!!!!!^.        
//     .!5G5J????77?Y5Y~.^B&[email protected]  .!5P5Y5YYYG##5^      
//    !#G!~!?Y555Y?!. ^J5Y&P :@Y~YP?~!?JJ??J7:^Y&P^    
//   [email protected]:PB?^^!7!~~?PY.  7J^  7#P! :PBY7!!!75#J.^&@~   
//  .&G.##. ~G?77?5! J&7          ^&Y.!P5J55.^&&^[email protected]   
//  :@G^@#  B#. P?.#! [email protected]^        .B5 ^@G [email protected]! [email protected]? #&.  
//   [email protected]~#G^^Y5JPJ!&~ [email protected] [email protected] :&G [email protected]#[email protected]   
//    ?&?:?GPYJYY5P! [email protected]@!       ^@5B5.:5PJ?YGG?^[email protected]   
//     ^GBJ~~!~~^^[email protected]^       Y&. YBJ~~~!~^~Y#B7     
//       ~J5PPPP55Y7: 5&.       [email protected]:  ^?5PGGGGPJ^       
//           ...     :&P        [email protected]      ...           
...
//               :#&:   [email protected]&^  [email protected]~ [email protected]                  
//               [email protected] [email protected]@J   :@G .&#                  
//               B&:  :#@5     B&: [email protected]:                 
//              [email protected] [email protected]#:     [email protected]^ ^@P                 
//              B&:  [email protected]@!      ^@J  [email protected]:                
//             ^@J  [email protected]@?       .#B  [email protected]^                
//            :B&:  [email protected]         B#. ^@Y                
//        .~?PGY.   #B.         [email protected]?  ?#?7!^::          
//     .7PGPJ!~~7??PG:          ^##7^:~7JYYP##Y        
//     J&B5YYYYYJ?!^             .!Y55YY5SV3NSEI        
//      ....                              ..          
...
contract ChainBattles is ERC721URIStorage{
    ...
    function generateCharacter(uint256 tokenId) public view returns (string memory) {
        ...
        bytes memory svg = abi.encodePacked(
            ...
            '<style>.basedna { fill: red; font-family: serif; font-size: 12px; }</style>',
            '<rect width="100%" height="100%" fill="black" />',
            "<text x='10%' y='20%' class='base' dominant-baseline='middle' text-anchor='start'>Wizzard</text>",
            "<text x='13%' y='40%' class='basedna' dominant-baseline='middle' text-anchor='start'>Id:",getId(tokenId),"</text>",
            "<text x='13%' y='50%' class='basedna' dominant-baseline='middle' text-anchor='start'>Level:",getLevel(tokenId),"</text>",
            "<text x='13%' y='60%' class='basedna' dominant-baseline='middle' text-anchor='start'>Speed:",getSpeed(tokenId),"</text>",
            "<text x='13%' y='70%' class='basedna' dominant-baseline='middle' text-anchor='start'>Strength:",getStrength(tokenId),"</text>",
            "<text x='13%' y='80%' class='basedna' dominant-baseline='middle' text-anchor='start'>Life:",getLife(tokenId),"</text>",
            "</svg>"
        );
