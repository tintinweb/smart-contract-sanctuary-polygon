...
abstract contract BaseWallet {
    ...
    // The security window
    uint256 internal constant SECURITY_WINDOW = 10 minutes;
...
abstract contract GuardianManager is BaseWallet {
    ...
    uint256 internal constant SECURITY_PERIOD = 10 minutes;
...
abstract contract SecurityManager is BaseWallet {
    uint256 internal constant LOCK_PERIOD = 10 minutes;
    uint256 internal constant RECOVERY_PERIOD = 10 minutes;
...
abstract contract TransactionManager is BaseWallet {
    ...
    /* solhint-enable */
    uint256 internal constant WHITELIST_PERIOD = 10 minutes;
