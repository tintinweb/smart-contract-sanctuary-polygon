...
interface ISXTValidator {
    ...
    event SXTResponse(bytes32 indexed requestId, bytes data);
...
contract SXTValidator is Admin, Initializer, ISXTValidator {
    using ECDSA for bytes32;

    uint256 private constant SXT_REQUEST_EXPIRE_TIME = 5 minutes;

    // Maximum number of oracles the offchain reporting protocol is designed for
    uint64 private constant maxNumOracles = 31;
     ...
     */
    // function initialize(address api)
    function initialize(address api)
        external
        initializer
        onlyAdmin
    ...
    /**
     * Set Oracle signers/transmitters configuration
     */
    function setConfig(
        ...
        // Add new signers/transmitters addresses
        ...
        returns (SXTRequest memory request, bytes memory paramHash)
    {
        ...
        request = SXTRequest({
            ...
            expiredAt: uint128(block.timestamp + SXT_REQUEST_EXPIRE_TIME),
    ...
    function fulfill(
        ...
        require(
            sxt_signersList.length <= maxNumOracles,
            "SXTValidator: too many oracles"
        );
        ...
        returns (bool)
    {
        ...
        emit SXTResponse(requestId, response);
