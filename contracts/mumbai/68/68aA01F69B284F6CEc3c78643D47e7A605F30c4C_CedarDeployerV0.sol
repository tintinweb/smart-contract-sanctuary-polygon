...
contract CedarDeployerV0 is Initializable, UUPSUpgradeable, OwnableUpgradeable, BaseCedarDeployerV0 {
    ...
    function deployCedarERC721DropV0(
        ...
        newContract = dropV0Factory.deploy(_defaultAdmin, _name, _symbol, _contractURI, _trustedForwarders, _saleRecipient, _royaltyRecipient, _royaltyBps, _userAgreement, _signatureVerifier, _greenlistManagerAddress);
