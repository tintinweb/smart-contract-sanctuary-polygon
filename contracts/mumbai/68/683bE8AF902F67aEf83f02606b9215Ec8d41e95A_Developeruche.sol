...
contract Developeruche is ERC721URIStorage {
    ...
    constructor() ERC721("Developeruche Collection", "DUC") {
        admin = msg.sender;
    }

    function safeMint(address to, string memory uri) public{
        require(isPaused == false, "Cannot mint now");
    ...
    function pauseOrContinue(bool _state) external {
        require(msg.sender == admin, "cannot perform this oeration");
        isPaused = _state;
    } 
