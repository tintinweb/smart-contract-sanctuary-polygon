    ...
    BasicMetaTransaction
{
    ...
    */
     ...
     */
    function grantManagerRoleForBatch(address _batchId, address _address) external {
    ...
    function _checkBeforeMintNewBatch(
        ...
        require(
            ...
            "_checkBeforeMintNewBatch: pccManagerContract cannot be zero"
        );
        require(
        ...
        require(
            ...
            "_checkBeforeMintNewBatch: Receiver address cannot be ZERO_ADDRESS"
        );
        require(
            (_batchSupply != 0) &&
                (_deliveryYear != 0) &&
                (_uniqueIdentifier != 0),
            "_checkBeforeMintNewBatch: Batch supply / Delivery Year / UniqueIndentifier cannot be zero"
        );
        require(
            bytes(_batchURI).length != 0,
            "_checkBeforeMintNewBatch: Batch URI cannot be empty"
        );
    }
...
contract PCCBatch is ERC20, AccessControl, BasicMetaTransaction {
    ...
    /**
        ...
        @param _managerAddress Manager contract address
    ...
    constructor(
        ...
        _setupRole(EVX_MANAGER_ROLE, _managerAddress);
    }
