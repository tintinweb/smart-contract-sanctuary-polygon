...
contract NFT is ERC721, PullPayment, Ownable, ContextMixin {
  ...
  constructor() ERC721("antother-one-collection-xxx", "NFT") {
    baseTokenURI = "";
  }
  ...
  function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
      require(_exists(tokenId), "ERC721Metadata: URI query for nonexistent token @tokenURI");
      return baseTokenURI;
  }

  /// Sets the base token URI prefix.
   function _setTokenURI(uint256 tokenId, string memory _tokenURI) public onlyOwner {
        require(_exists(tokenId), "ERC721Metadata: URI set of nonexistent token @_setTokenURI");
