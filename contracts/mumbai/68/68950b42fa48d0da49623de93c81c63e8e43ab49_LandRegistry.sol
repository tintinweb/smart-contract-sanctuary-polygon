...
contract LandRegistry is ERC721Enumerable, Ownable {
    ...
    uint256 public maxSupply = 46226;
    bool public paused = false;

    constructor() ERC721("Marstack LAND", "LAND") {}
    ...
    // function mintLand(uint256 _mintAmount, uint256[] memory NFTId, uint256 cryptoTokenId) public payable {
    ...
    //             _safeMint(msg.sender, NFTId[i-1]);
    ...
    function mintLand(
        ...
        for (uint256 i = 1; i <= _mintAmount; i++) {
            ...
            _safeMint(msg.sender, landId[i - 1]);
            emit Mint(msg.sender, msg.value);
        }
    }
