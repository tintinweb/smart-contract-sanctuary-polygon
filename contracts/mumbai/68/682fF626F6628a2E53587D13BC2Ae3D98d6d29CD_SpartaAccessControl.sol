...
/// @dev This contract is used for managing access across different roles in the Sparta smart contract system.
contract SpartaAccessControl is AccessControl, ZeroAddressGuard {
    ...
    /// @dev Initializes the contract setting the admin as the initial default admin role.
    /// @param _admin Address of the admin to be granted the DEFAULT_ADMIN_ROLE.
