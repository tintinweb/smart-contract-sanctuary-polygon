...
contract USDRExchange is AddressAccessor, IExchange, Pausable {
    ...
    function avgTNGBLMintPrice() external view returns (uint) {
        ...
        if (stats.usdrMinted == 0) return 0;
        return stats.tngblValue / stats.usdrMinted;
    }
        ...
        )
    {
        ...
        _updateTNGBLMintingStats(amountIn, tngblPrice, amountOut);
    }
    ...
    function _updateTNGBLMintingStats(
        ...
        _tngblMintingStats.tngblValue += tngblIn * tngblPrice;
        _tngblMintingStats.usdrMinted += usdrOut;
    }
}
