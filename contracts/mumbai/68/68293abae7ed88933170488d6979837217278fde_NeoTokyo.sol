...
contract NeoTokyo is ERC721Enum, Ownable, ReentrancyGuard {
    ...
    address private genesisToken = 0xc2367BDbb409E160cB17326da8b81e4e7258E940;
    ...
    function mintPreSaleERC20(uint256 _mintAmount, bytes32[] calldata proof)
        external
        nonReentrant
    {
        require(status == 1, "Sale inactive");
    ...
    function setpreSaleERC20cost(uint256 _cost) external onlyOwner {
        discountERC20cost = _cost;
    }

    function setpreSaleETHCost(uint256 _cost) external onlyOwner {
        preSaleCost = _cost;
    }
