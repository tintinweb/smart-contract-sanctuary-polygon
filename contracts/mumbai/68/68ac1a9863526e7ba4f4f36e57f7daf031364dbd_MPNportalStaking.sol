...
// File: https://github.com/minplusnft/Launch/blob/main/MPNportalToken.sol
...
contract MPNportalToken is ERC20, ERC20Burnable, Ownable {
  ...
  constructor() ERC20("MPNportalToken", "MPNT") { 
...
// File: contract/MPNportalSTAKING.sol
...
contract MPNportalStaking is Ownable, IERC721Receiver {
  ...
  MPNportalToken token;

  // maps tokenId to stake
  mapping(uint256 => Stake) public vault; 

   constructor(ERC721Enumerable _nft, MPNportalToken _token) { 
    nft = _nft;
    token = _token;
  }
