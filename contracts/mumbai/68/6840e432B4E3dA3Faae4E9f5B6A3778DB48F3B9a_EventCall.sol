...
contract EventCall is Ownable, EventCallStorage {
    ...
    function completeInternal(uint256 eventTokenId) public view isEventOrganiser(eventTokenId) {
    ...
    function endInternal(
        ...
        ) public view isEventOrganiser(eventTokenId) {
        require(
            IAdminFunctions(adminContract).isEventStarted(eventTokenId) == true,
            "ERR_139:ManageEvent:Event is not started"
        );
    ...
    ///@param eventTokenId event Token Id
    function startEventInternal(uint256 eventTokenId) public view isEventOrganiser(eventTokenId) {
        require(IEvents(IAdminFunctions(adminContract).getEventContract())._exists(eventTokenId), "ERR_132:ManageEvent:TokenId does not exist");
        (
            uint256 startTime,
            uint256 endTime,
    ...
    ///@param eventTokenId event Token Id
    function cancelEventInternal(uint256 eventTokenId) public view isEventOrganiser(eventTokenId) {
        require(IEvents(IAdminFunctions(adminContract).getEventContract())._exists(eventTokenId), "ERR_132:ManageEvent:TokenId does not exist");
