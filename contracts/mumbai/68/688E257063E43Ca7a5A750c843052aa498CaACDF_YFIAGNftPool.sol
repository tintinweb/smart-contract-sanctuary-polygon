...
contract YFIAGNftPool is IYFIAGNftPool, Ownable, ReentrancyGuard{
    ...
    function getAmountEearn(address _user, address _tokenAddress) public view override returns(uint256){
...
interface IYFIAGNftPool {
    ...
    function getAmountEearn(address _user, address _tokenAddress) external view returns(uint256);
