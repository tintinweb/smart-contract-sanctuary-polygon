...
contract NebulaDropsCollectible is ERC1155, Ownable {
    ...
    function mint( uint256 _amount, address _nebulaMarketplace, bool _cardpay) 
        public  payable  
     {
    ...
    function mintBatch(
       // uint256 _initialId,
     uint256 _amount, uint256  _totalNoOfTokens, address _nebulaMarketplace, bool _cardpay) 
        public payable
    {
