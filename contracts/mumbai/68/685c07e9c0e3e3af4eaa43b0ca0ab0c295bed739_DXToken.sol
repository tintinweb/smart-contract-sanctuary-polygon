...
/* File: @openzeppelin\contracts-upgradeable\token\ERC20\presets\ERC20PresetFixedSupplyUpgradeable.sol */
...
contract DXToken is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, OwnableUpgradeable, UUPSUpgradeable, ERC20PresetFixedSupplyUpgradeable {
    /*/ @custom:oz-upgrades-unsafe-allow constructor */
    constructor() {
        _disableInitializers();
    }
    ...
    function initialize(
        ...
        /* __ERC20PresetFixedSupply_init("DXToken", "DXT", (10 ** 9) * (10 ** 18), _msgSender() ); */
        __ERC20PresetFixedSupply_init(name, symbol, initialSupply, owner );
