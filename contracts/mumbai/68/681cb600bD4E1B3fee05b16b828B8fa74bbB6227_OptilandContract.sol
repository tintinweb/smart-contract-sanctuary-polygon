...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5CB1EFf47A563B079690A7efA9351faf1c144845];
  address public erc20Payable = 0x5CB1EFf47A563B079690A7efA9351faf1c144845;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 27, 39300) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://Qmadxi2SMtVEi9e8baTLMqERtLa9vpzGoD4oka5rvbrGz4/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 39300");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 39300");
    ...
    function mintToMultipleERC20(address _to, uint256 _amount, address _erc20TokenContract) public payable {
      require(_amount >= 1, "Must mint at least 1 token");
      require(_amount <= maxBatchSize, "Cannot mint more than max mint per transaction");
      require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 39300");
      require(mintingOpen == true, "Minting is not open right now!");
...
// File: contracts/OptilandContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OptilandContract is RamppERC721A {
    constructor() RamppERC721A("optiland", "OL"){}
}
