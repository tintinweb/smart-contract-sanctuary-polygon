...
contract ArmES is AccessControl {
...
*/
  ...
  function register(string memory _nomalias ) public {
    ...
    Gente memory oGente = Gente( msg.sender , '' , _nomalias , 0 , 0  );  
  ...
  function registerByAdmin(string memory _nomalias , address payable _addr , string memory ipfs ) public onlyAdmins {
    ...
    Gente memory oGente = Gente( _addr , ipfs , _nomalias , 0 ,0  );  
    ...
    emit RegisterEvent( _nomalias, _addr , ipfs );
