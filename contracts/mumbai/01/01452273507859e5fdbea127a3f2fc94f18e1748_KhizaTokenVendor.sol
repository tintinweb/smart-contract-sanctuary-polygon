...
contract KhizaTokenVendor is Ownable, ReentrancyGuard {
    ...
    function buyTokens(uint amountToBuy) public nonReentrant notPaused whitelistCompliance(amountToBuy) timeCompliance {
        ...
        // TODO: verificar se saldo a pagar é maior do que algum valor mínimo (0 USDC). 
        // Hoje está aceitando a compra de valores pequenos (0,00003) sem pagar nada, pela diferença de decimals entre KHIZA e USDC
