...
contract SxTRelay is ConfirmedOwner, String, Initializable, ReentrancyGuard, ChainlinkClient, ISxTRelay {
     ...
     * @param chainlinkJobId - Chainlink Job ID that SxT team has created on the Chainlink Oracle Node
     */
    function requestViewString2D(string memory viewName, address callerContract, bytes4 callbackFunctionId, string memory chainlinkJobId) external override nonReentrant checkAllowanceAndTransfer(callerContract, feeInLinkToken) returns (bytes32) {
        ...
        return addRequestParamsAndSendView(viewName, request, callerContract, callbackFunctionId);
    }
     ...
     * @param chainlinkJobId - Chainlink Job ID that SxT team has created on the Chainlink Oracle Node
     */
    function requestViewUint256(string memory viewName, address callerContract, bytes4 callbackFunctionId, string memory chainlinkJobId) external override nonReentrant checkAllowanceAndTransfer(callerContract, feeInLinkToken) returns (bytes32) { 
        Chainlink.Request memory request = buildChainlinkRequest(
            stringToBytes32(chainlinkJobId),
            callerContract,
            this.queryResponseUint256.selector
     ...
     * @param chainlinkJobId - Chainlink Job ID that SxT team has created on the Chainlink Oracle Node
     */
    function requestViewBytes(string memory viewName, address callerContract, bytes4 callbackFunctionId, string memory chainlinkJobId) external override nonReentrant checkAllowanceAndTransfer(callerContract, feeInLinkToken) returns (bytes32) {
        Chainlink.Request memory request = buildChainlinkRequest(
            stringToBytes32(chainlinkJobId),
            callerContract,
            this.queryResponseBytes.selector
     ...
     * @param chainlinkJobId - Chainlink Job ID that SxT team has created on the Chainlink Oracle Node
     */
    function requestViewString(string memory viewName, address callerContract, bytes4 callbackFunctionId, string memory chainlinkJobId) external override nonReentrant checkAllowanceAndTransfer(callerContract, feeInLinkToken) returns (bytes32) { 
        Chainlink.Request memory request = buildChainlinkRequest(
            stringToBytes32(chainlinkJobId),
            callerContract,
            this.queryResponseString.selector
     ...
     * @param callbackFunctionId - User contract callback function selector id
     */
    function addRequestParamsAndSendView(string memory viewName, Chainlink.Request memory request, address callerContract, bytes4 callbackFunctionId) internal returns (bytes32){
        request.add("viewName", viewName);
