...
contract CrowdMargin {
    ...
    function getUserInfo(address addr) external view returns (uint128, uint32, uint32, uint32, uint96) {
    	return (totalIncome[addr], lastDownlineCount[addr], minimumDownline, repeatMinimum, joinFee);
    }
