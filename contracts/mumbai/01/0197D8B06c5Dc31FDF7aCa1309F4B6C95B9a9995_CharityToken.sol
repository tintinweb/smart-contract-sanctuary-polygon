...
contract CharityToken is Context, IERC20, Ownable {
    ...
    address payable public _charityFactory; // Donations Pool
    ...
    constructor() {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xbdd4e5660839a088573191A9889A262c0Efc0983); // UniswapV2 for Ethereum network
    ...
    function excludeAccount(address account) external onlyOwner {
        require(account != 0xbdd4e5660839a088573191A9889A262c0Efc0983, "We can not exclude Uniswap router.");
    ...
    function sendETHToCharity(uint256 amount) private {
        _charityFactory.transfer(amount);
    }
    ...
    function _setCharityWallet(address payable charityWalletAddress) external onlyOwner {
        _charityFactory = charityWalletAddress;
    }
