...
contract StableOneV5 is Ownable {
    using SafeMath for uint256;

    uint256 private constant PRIMARY_BENIFICIARY_INVESTMENT_PERC = 60;
    uint256 private constant PRIMARY_BENIFICIARY_REINVESTMENT_PERC = 30;
    ...
    uint256 private constant REINVEST_TIME_STEP = 1 minutes;
    
    uint256 private constant WITHDRAW_TIME_STEP = 5 minutes;
    
    uint256 private constant DAILY_INTEREST_RATE = 40;
    uint256 private constant DAILY_AUTO_REINTEREST_RATE = 210;
    uint256 private constant ON_WITHDRAW_AUTO_REINTEREST_RATE = 150;
    ...
    function withdraw() public {
		require(investors[msg.sender].lastWithdrawDate.add(WITHDRAW_TIME_STEP) <= block.timestamp,"Withdrawal limit is 1 withdrawal in 5 minutes");
