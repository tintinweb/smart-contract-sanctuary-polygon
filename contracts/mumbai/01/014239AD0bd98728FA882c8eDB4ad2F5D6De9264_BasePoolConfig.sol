...
abstract contract BasePool is Initializable, BasePoolStorage, ILiquidityProvider, IPool {
    ...
    function initialize(address poolConfigAddr) public initializer {
        _baseInitialize(poolConfigAddr);
    }

    function _baseInitialize(address poolConfigAddr) internal onlyInitializing {
...
contract BaseFeeManager is IFeeManager, Ownable {
    ...
    uint256 internal constant SECONDS_IN_A_DAY = 1 days;
    uint256 internal constant MAX_PERIODS = 360; // 30 years monthly loan
