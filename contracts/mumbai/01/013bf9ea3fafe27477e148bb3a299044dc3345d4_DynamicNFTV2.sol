...
contract DynamicNFTV2 is Initializable, ERC1155URIStorageUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    using CountersUpgradeable for CountersUpgradeable.Counter;
    CountersUpgradeable.Counter private _tokenIdTracker;

    string public name;

    function initialize(string memory name_, string memory uri_) external initializer {
        name = name_;
        __ERC1155_init(uri_);
        __Ownable_init();
