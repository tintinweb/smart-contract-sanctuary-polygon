...
contract MagicMondrian is Ownable, Pausable, ReentrancyGuard, ERC721A, EIP712 {
    ...
    mapping(address => mapping(uint256 => bool)) public hasPrintedOnce;
    ...
    modifier canPrint(uint256 _tokenId) {
        require(hasPrintedOnce[msg.sender][_tokenId] == false, "Already printed");
        _;
    }
     ...
     *
     * @param _tokenId if of the token
     */
    function print(uint256 _tokenId) external payable callerIsUser canPrint(_tokenId) nonReentrant {
        ...
        hasPrintedOnce[msg.sender][_tokenId] = true;
    }
