...
contract Safemoon is ISafemoon, Initializable, ContextUpgradeable, OwnableUpgradeable, PausableUpgradeable {
    ...
    modifier whenNotPausedOrWhitelisted() {
        require(!paused() || whitelistMint[_msgSender()], "Token transfer is paused, and caller is not whitelisted");
        _;
    }
    ...
    function transfer(address recipient, uint256 amount) public override whenNotPausedOrWhitelisted returns (bool) {
    ...
    function approve(address spender, uint256 amount) public override whenNotPausedOrWhitelisted returns (bool) {
