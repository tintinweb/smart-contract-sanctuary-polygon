...
abstract contract Crowdsale {
     ...
     * @param tokenAmout number of tokens purchased
     * @param tokenId
     */
    ...
    -The purchase is processed and deliverd to the user after performing mint.
...
contract CCOFInventory is ERC721A, InventoryAccessControl, ERC721AQueryable {
    ...
    /**
     * @dev Safely mints `quantity` tokens and transfers them to `_benificary`.
     *
     * Requirements:
     ...
     */
    function mint(address _benificary, uint256 quantity) public onlyMinter {
        _safeMint(_benificary, quantity);
    }
