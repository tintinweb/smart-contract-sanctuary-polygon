...
// File: flexibleibatstaking.sol


// Creator: telegram - @jagjeetjena
...
contract flexiblestaking is Ownable, Initializable, ReentrancyGuard {
    ...
    uint256 public rewardsPerHour = 342; // 0.00155%/h or 12% APY

    // Minimum amount to stake
    uint256 public minStake = 10 * 10**18;
    uint256 public maxStake = 10000000 * 10**18;
    ...
    uint256 public compoundFreq = 86400; //4 hours
    ...
    function claimRewards() public nonReentrant {
      ...
      function exit() external {
        withdraw(stakers[msg.sender].deposited);
         claimRewards();
    }
