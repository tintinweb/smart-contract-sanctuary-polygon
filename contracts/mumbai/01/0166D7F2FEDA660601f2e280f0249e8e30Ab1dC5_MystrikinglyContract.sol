...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x20E98c7A30eedc465e753737c36991679073789E];
  address public erc20Payable = 0x20E98c7A30eedc465e753737c36991679073789E;
...
abstract contract Feeable is Teams {
  uint256 public PRICE = 131 ether;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 50, 57293) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmSqSGgvP9hm4aqE2CTeZhCZqdCsCTX8moZ2cJ9vCbLu25/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 57293");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 57293");
    ...
    function mintToMultipleERC20(address _to, uint256 _amount, address _erc20TokenContract) public payable {
      require(_amount >= 1, "Must mint at least 1 token");
      require(_amount <= maxBatchSize, "Cannot mint more than max mint per transaction");
      require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 57293");
      require(mintingOpen == true, "Minting is not open right now!");
...
// File: contracts/MystrikinglyContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MystrikinglyContract is RamppERC721A {
    constructor() RamppERC721A("mystrikingly", "mk"){}
}
