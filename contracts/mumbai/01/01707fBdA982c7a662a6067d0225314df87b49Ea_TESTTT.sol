...
contract TESTTT is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("TESTTT", "TTT") {
    customBaseURI = customBaseURI_;

    allowedMintCountMap[owner()] = 5;

    allowedMintCountMap[0x7625593faf19319C1A034AbB017361FE5F9F109B] = 2;
  }
