...
contract Badges is Initializable, PausableUpgradeable, OwnableUpgradeable {
    ...
    */
    ...
    event addBadgeToApp(string indexed badgeName, string badgeURL, address indexed allowedAddress);
    ...
    */
    function addBadge(string calldata badgeName, string calldata badgeURI, address allowedAddress, uint256 minimumReq, uint256 badgeTypeID) public whenNotPaused onlyAdmins {
        ...
        emit addBadgeToApp(badgeName, badgeURI, allowedAddress);
    }
    ...
    */
    function getBadgeDetails(uint256 badgeID) public view whenNotPaused returns(string[] memory) {
        ...
        string[] memory thisBadge = new string[](5);
