...
contract Lottery is Ownable, VRFConsumerBase, KeeperCompatible {
    ...
    uint256[] registered;
    uint256[] tokenIds = IEGVC(0xF8A236c5247dc27A5218B96140f9D03CACD291f1).walletOfOwner(msg.sender);
...
constructor()
    ...
    function register(uint256 _tokenID) public returns (string memory) {
        ...
        tokenIds = IEGVC(0xF8A236c5247dc27A5218B96140f9D03CACD291f1).walletOfOwner(msg.sender);
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        uint256 index = randomResult % registered.length;
        winnerNFT = registered[index];
        lotteryWinner = payable(IEGVC(0xF8A236c5247dc27A5218B96140f9D03CACD291f1).ownerOf(winnerNFT));
        payable(lotteryWinner).transfer( (getBalance() * 90) / 100);
    ...
    return IEGVC(0xF8A236c5247dc27A5218B96140f9D03CACD291f1).walletOfOwner(msg.sender);
    }
