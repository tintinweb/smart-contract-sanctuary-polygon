...
contract Mid is Royalty, AccessControl, BaseRegistrarImplementation, Pausable, TokenURISetting {
    ...
    function init(address micAddress_, address landAddress_, address payable micBank_, address payable midLandBank_, address payable alchemistBank_, address payable fundBank_) external {
        ...
        _fundBank = fundBank_;
        ROYALTY = 1*(10**18);
        super.init(micBank_, midLandBank_, alchemistBank_, micAddress_);
    }
...
abstract contract Royalty is ReentrancyGuard, Context, IncomingTransferSupport{
     ...
     * @dev Initializes the contract with the given parameters.
     */
    function init(address payable micBank_, address payable midLandBank_, address payable alchemistBank_, address micAddress_) internal virtual{
