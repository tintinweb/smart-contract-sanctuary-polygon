...
contract RequestManager is IRequestManager {
    ...
    function ForwardGetJuryStatistics(address user_) external view returns (uint usersStake_,uint lastWithdrawal_,uint userInitialStake_,bool isActiveStaker_) {
