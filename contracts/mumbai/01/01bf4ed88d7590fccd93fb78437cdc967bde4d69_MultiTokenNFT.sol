...
contract MultiTokenNFT  is ERC1155Supply {
    ...
    constructor(string memory name_, string memory _uri) ERC1155(_uri){
        _name = name_;
        _mint(msg.sender, 0, 5, '0x00');
        _mint(msg.sender, 1, 5, '0x00');
        _mint(msg.sender, 2, 5, '0x00');
        _mint(msg.sender, 3, 5, '0x00');
        _mint(msg.sender, 4, 5, '0x00');
        _mint(msg.sender, 5, 5, '0x00');
