...
interface ICedarDeployerV10 is ICedarDeployerOwnEventsV1, ICedarVersionedV2 {
    ...
    function cedarERC721DropDelegateLogicVersion()
        external
        view
        returns (
            uint256 major,
    ...
    function cedarERC1155DropDelegateLogicVersion()
        external
        view
        returns (
            uint256 major,
    ...
    function cedarERC721DropDelegateLogicFeatures() external view returns (string[] memory features);

    function cedarERC1155DropDelegateLogicFeatures() external view returns (string[] memory features);
}
...
interface ICedarERC1155DropDelegateLogicFactoryEventsV0 is ICedarFactoryEventsV0 {
    event CedarERC1155DropDelegateLogicDeployment(
        address indexed contractAddress,
        uint256 indexed majorVersion,
        uint256 indexed minorVersion,
        uint256 patchVersion
...
interface ICedarERC721DropDelegateLogicFactoryEventsV0 is ICedarFactoryEventsV0 {
    event CedarERC721DropDelegateLogicDeployment(
        address indexed contractAddress,
        uint256 indexed majorVersion,
        uint256 indexed minorVersion,
        uint256 patchVersion
