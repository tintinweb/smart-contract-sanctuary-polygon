...
//**************************************************************
// Mint-ED Cornish ERC1155 Contract 
//**************************************************************

contract mintEDstorefront is ERC1155, ERC1155Supply, Ownable {
    constructor() ERC1155("") {}
    ...
    //set cost (potential future use.  won't be used for primary sales)
...
//***************************************************************
    ...
    string public name = "Cornish College of the Arts: 2022";
    string public symbol = "CORNISH";
    ...
    // Airdrop Functions
    function mintSingleToSingle(address to_, uint256 id_, uint256 amount_, bytes memory data_) external onlyOwner {
    ...
    function mintManyToSingle(address to_, uint256[] memory ids_, uint256[] memory amounts_, bytes memory data_) external onlyOwner {
        require(!paused, "the contract is paused");
    ...
    function mintSingleToMany(address[] memory tos_, uint256 id_, uint256 amount_, bytes memory data_) external onlyOwner {
        require(!paused, "the contract is paused");
        require(amount_ > 0, "need to mint at least 1 NFT");
    ...
    function mintManyToMany(address[] memory tos_, uint256[] memory ids_, uint256[] memory amounts_, bytes memory data_) external onlyOwner {
        require(!paused, "the contract is paused");
