...
// contract ERC1155TokenMetaVentStorage {
//     EscrowUpgradeable private _escrow;
//     uint256[50] private __gap;
// }

contract ERC1155TokenMetaVent is ERC1155Upgradeable, OwnableUpgradeable {
    string public baseMetadataURI; // the token metadata URI
    uint256 public mintFee; //mintfee, only used in mint function, not batch.
    string public name; // Contract name
    string public symbol; // Contract symbol
    uint256 private _currentTokenID; //the current token id
    ...
    function contractURI() public view returns (string memory) {
        return string(abi.encodePacked(baseMetadataURI, "metadata.json"));
    }
    ...
    */
    function mint(
        ...
        _mint(account, _id, amount, _data);
