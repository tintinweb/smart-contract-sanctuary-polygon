...
contract Testament{
    ...
    constructor(){
        // token = MyToken(0xe2899bddFD890e320e643044c6b95B9B0b84157A);
        token = MyToken(0xa5060f4A60f0f5977a45B61F29132474C5675e16);
        _manager = msg.sender;
    }

    function create(address heir, uint amount) public payable{
    ...
    function transferTo(address to, uint amount) public{
        ...
        require(amount > 0, "You need to sell at least some tokens");
        uint256 allowance = token.allowance(msg.sender, to);
        require(allowance >= amount, concatenate("Check the token allowance : ", Strings.toString(allowance)));
        // token.approve(msg.sender, amount);
        // token.transfer(to, amount);
