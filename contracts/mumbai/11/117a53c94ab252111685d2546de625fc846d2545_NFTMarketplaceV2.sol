...
contract NFTMarketplaceV2 is UserHolder, CollectionHolder, MarketItemHolder {
    ...
    function cancelMarketSale(uint256 marketTokenId) public payable {
        MarketItem storage mi = idToMarketItem[marketTokenId];
        require(mi.seller == msg.sender);
        Collection(mi.collection_address).transfer(address(this), msg.sender, mi.tokenId);
        mi.owner = mi.seller;
        mi.sold = true;
    }
