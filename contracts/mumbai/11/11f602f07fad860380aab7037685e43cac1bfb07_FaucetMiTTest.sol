...
contract FaucetMiTTest is Ownable{
    address private _token; 
    uint8 private decimals;
    uint private MaxQuantity = 1 * 10 ** 18;
    event retrieve(address user, uint quantity);
    event addedWhiteListUsers(address[] usersAdded);
    ...
    function widthdrawMatic() public onlyWhiteList{
