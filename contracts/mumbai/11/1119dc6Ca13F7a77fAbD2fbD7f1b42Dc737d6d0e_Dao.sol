...
// ne asiguram ca cel care face un proposal contine un nft(validTokens) in smart contract  (daoContract)
    constructor(){
        owner = msg.sender; // who deploy the smart contract is th owner of it
        nextProposal = 1; // id of first proposal
        daoContract = IdaoContract(0x2953399124F0cBB46d2CbACD8A89cF0599974963);
        validTokens = [53771286755685511049304056916226098522711474101858316070775171846184858812417]; // [34885103611559094078416375598166902696017567311370712658413208238551126245396];
    }
