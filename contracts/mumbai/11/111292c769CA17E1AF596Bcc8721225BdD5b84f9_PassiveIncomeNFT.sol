...
contract PassiveIncomeNFT is ERC721Enumerable, AccessControl {
    ...
    RevenueShare private _revenueShare;
    ...
    function setRevenueShareContract(address revenueShare)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        _revenueShare = RevenueShare(revenueShare);
    }
    ...
    function _beforeTokenTransfer(
        ...
        _revenueShare.setClaimerForTokenId(tokenId, to);
    }
}
