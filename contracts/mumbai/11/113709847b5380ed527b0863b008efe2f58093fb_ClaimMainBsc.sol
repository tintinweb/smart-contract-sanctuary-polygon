...
// File: contracts\ClaimMainBsc.sol
...
contract ClaimMainBsc is Ownable, ReentrancyGuard, Authorizer {
    using SafeMath for uint256;
    ...
    constructor(address _authorizer, address _cl) public {
        cl = _cl;
    ...
    function claim(address receiver, uint256 amount, uint256 nonce,
        uint256 underBlock, uint256 _type, bytes memory signature) nonReentrant external {
        ...
        require(IERC20(cl).balanceOf(address(this)) > amount, "Insufficient balance");
        ...
        IERC20(cl).safeTransfer(receiver, amount);
        claimed[receiver] = claimed[receiver].add(amount);
