...
contract fixlineBetting is Ownable, ReentrancyGuard {
    ...
    function setFixlineStackingContractAddress(address newAddress)
        external
        onlyOwner
    {
        fixlineStackingContractAddress = newAddress;
    }
