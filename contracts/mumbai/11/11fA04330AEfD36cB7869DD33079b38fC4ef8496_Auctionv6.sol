...
contract Auctionv6 is Initializable, OwnableUpgradeable {
    ...
    */
    ...
    function findUserBidIndex(Bid[] memory bids, address user)
        internal
        pure
        returns (int256)
    {
        ...
        checkForBidAuction(auctionId, tokenId)
    {
        ...
        require(_auc.auctionType == AuctionType.BID, "Can't place bid.");
    ...
    function endMultipleAuctions(uint256[] memory auctionIds)
        external
        onlyOwner
    {
    ...
    function getTokenIds(uint256 auctionId)
        external
        view
    ...
    function getTokenLastBid(uint256 auctionId, uint256 tokenId)
        external
        view
        returns (Bid memory bid, uint256 numOfOffer)
    {
    ...
    function checkTokenIdExist(Auctions storage _auc, uint256 tokenId)
        internal
        view
        returns (bool)
    {
    ...
    function withdrawAnonymousToken(IERC20Upgradeable token, uint256 amount)
        external
        onlyOwner
    {
