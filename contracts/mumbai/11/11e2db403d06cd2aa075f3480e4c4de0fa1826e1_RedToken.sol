...
contract RedToken {
    ...
    uint public transactionFeeRate; // Transaction fee rate in basis points (1 basis point = 0.01%)
    address public transactionFeeReceiver; // Address that receives the transaction fee
