...
contract IseedWhitelist is Ownable, ERC1155 {
    ...
    function mint(string memory _community, uint256 _amount) public payable {
        ...
        bool sentToLiquidity = liquidityPoolInstance.transferBalance{value: (address(this).balance * (percentageToLiquidityPool / 100))}();
        require(sentToLiquidity, "Transfer to liquidity pool failed");
    }
