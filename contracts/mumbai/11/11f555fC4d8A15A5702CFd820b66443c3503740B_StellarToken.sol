...
contract StellarToken is IERC20, IERC721Receiver {
        ...
        )
    {
        ...
        emit Debug("Before deposit");
        // Create a deposit
        _createDeposit(msg.sender, tokenId);
        emit Debug("After deposit");

        emit Debug("Before amount0 < amountStellarToMint");        
        ...
        emit Debug("Before amount1 < amountStellarToMint");        
