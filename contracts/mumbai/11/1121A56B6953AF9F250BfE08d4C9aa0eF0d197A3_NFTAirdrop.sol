...
contract NFTAirdrop is Pausable, EIP712 {
  ...
  bytes32 public constant PRESALE_TYPEHASH1 = 0x78fc2e87fc1b10c4daf166d3682ff22523a8de84480d2d2d24ce86930e7159f9;
  ...
  {
    hash = _hashTypedDataV4(keccak256(abi.encode(PRESALE_TYPEHASH1, _buyer, keccak256(abi.encodePacked(_maxSales)), keccak256(abi.encodePacked(_types)), _nonce)));
  }
