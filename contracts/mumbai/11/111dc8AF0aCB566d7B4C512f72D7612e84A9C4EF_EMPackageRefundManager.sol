...
// File interfaces/IEMPackageSaleManager.sol

pragma solidity >=0.7.0 <0.9.0;

interface IEMPackageSaleManager {
...
contract EMPackageRefundManager is Ownable, Pausable, ReentrancyGuard {
    ...
    IEMPackageSaleManager EMPackageSaleManager;
    ...
    constructor(
        ...
        IEMERC721A dao_,
        IEMPackage package_,
        IEMPackageSaleManager packageSaleManager_
        ){
        EMAstronaut = astronaut_;
        EMPFP = pfp_;
        EMDAO = dao_;
        EMPackage = IEMPackage(package_);
        EMPackageSaleManager = IEMPackageSaleManager(packageSaleManager_);
    }
    ...
    function refund(PackageType _packageType, uint256 _packageId) external nonReentrant whenNotPaused {
        ...
        EMPackageSaleManager.payBack(msg.sender, price);
    ...
    function setEMPackageSaleManager(IEMPackageSaleManager _packageSaleManager) external onlyOwner {
