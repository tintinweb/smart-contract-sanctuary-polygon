...
abstract contract ERC20 is IERC20 {
    ...
    uint256 public maxTransferAmountRate = 1000000000000000000;
...
contract ZorroERC20Token is ERC20Permit, IOHM, OlympusAccessControlled {
    using SafeMath for uint256;

    constructor(address _authority) 
    ERC20("ZORROCOIN", "ZOR", 18) 
    ERC20Permit("ZORROCOIN") 
    OlympusAccessControlled(IOlympusAuthority(_authority)) {       
        
        _mint(_authority, 1000000000000000000000000); 
        
    }

    function mint(address account_, uint256 amount_) onlyVault external override {
