...
contract CampaignFactory is Ownable {
    ...
    function createCampaign(
        ...
        (uint256 actualCreationFee, uint256 actualCampaignFee) = _manager
            .calculateFees(_settings[2], _settings[3], _addresses[0]);
...
contract CampaignManager is Ownable {
    ...
    constructor(address owner) {
        ...
        fees[2] = 10;
        fees[3] = 5;
        createFee = 1000000000000000000; // testnet 1
        campaignFee = 5000000000000000000; // 5
        feeCollector = payable(0xbC31e237494844Ce74Be95eD1768B4eE7107AF52);

        campaignCreationTokenArray.push(0xfCeBe3A758352FF904C96cC84eA214A93ec95d57);
