...
contract Contract is ERC721Base {
    ...
    // 3 string arrays - blockchains, dapps, tokens
    string[] public blockchains = ["Ethereum", "Solana", "Arbitrum", "Optimisim", "Polygon"];
    string[] public dapps = ["Aave", "Compound", "Uniswap", "MakerDAO", "ENS"];
    string[] public tokens = ["ETH", "DAI", "USDC", "USDT", "WBTC"];
    ...
    // function tokenURI - build an SVG image with random words
    function tokenURI(uint256 _tokenId) public view override returns(string memory) {
        ...
        parts[1] = getBlockchain(_tokenId);

        parts[2] = '</text><text x="10" y="40" class="base">';

        parts[3] = getDapp(_tokenId);

        parts[4] = '</text><text x="10" y="60" class="base">';

        parts[6] = getToken(_tokenId);
    ...
    function getBlockchain(uint256 _tokenId) public view returns(string memory) {
        return pluck(_tokenId, "BLOCKCHAIN", blockchains);
    }

    function getDapp(uint256 _tokenId) public view returns(string memory) {
        return pluck(_tokenId, "DAPP", dapps);
    }

    function getToken(uint256 _tokenId) public view returns (string memory) {
        return pluck(_tokenId, "TOKEN", tokens);
    }

    // claim function - to actually claim and mint the NFT
