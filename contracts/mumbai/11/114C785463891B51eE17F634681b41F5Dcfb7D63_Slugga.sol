...
contract Slugga is ERC721AUpgradeable, AccessControl {
  ...
  /// @param _baseTokenURIUnrevealed uri for un minted tokens
  /// @param _max supply
  function initialize(
    string memory _name,
    ...
    string memory _baseTokenURIUnrevealed,
    uint256 _max
  ) public initializerERC721A {
    __ERC721A_init(_name, _symbol);
    contractURI = _contractURI;
    baseTokenURI = _baseTokenURI;
    baseTokenURIUnrevealed = _baseTokenURIUnrevealed;
    max = _max;
  ...
  function setBaseURIUnrevealed(string memory _baseTokenURIUnrevealed)
    public
    onlyOwner
  {
    baseTokenURIUnrevealed = _baseTokenURIUnrevealed;
