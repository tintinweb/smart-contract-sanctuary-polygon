...
/// @title Inkling Origins Generation 1 Inklings
...
contract Inklings is ERC721A, Ownable, ERC2981, ReentrancyGuard {
    using Strings for uint256;

    //NOTE Token values incremented for gas efficiency
    uint256 public maxSalePlusOne = 5001;
    uint256 public tokenPricePresale = 0.0855 ether;
    uint256 public tokenPricePublicSale = 0.095 ether;

    uint256 public presaleAllowancePlusOne = 4;
    uint256 public publicSaleTXAllowancePlusOne = 11;
    ...
    constructor() ERC721A("Inkling Origins Generation 1 Inklings", "IOG1I") {
        placeholderURI = "ipfs://...";

        // 7.5% royalties
        recipient = 0x032f92C9f6A183Aa93C97709b9dbC92588C642cA;
        _setRoyalties(recipient, 750);
    }
    ...
    */
    ...
    function mintPublic(uint256 quantity)
        ...
        correctValue(tokenPricePublicSale * quantity)
    {
        require(quantity < publicSaleTXAllowancePlusOne, "Exceeds allowance!");
    ...
    {
        require(mintsPerAddress[msg.sender] + quantity < presaleAllowancePlusOne, "Exceeds allowance!");
        _safeMint(msg.sender, quantity);
        mintsPerAddress[msg.sender] += quantity;
        nonce++;
    }
     ...
     */
    function mintReserved(address[] memory to) external onlyOwner withinMintLimit(to.length) {
     ...
     */
    function setTokenPricePublicSale(uint256 newPrice) external onlyOwner {
        tokenPricePublicSale = newPrice;
    }
     ...
     * @param publicAllowance The new publicsale allowance.
     */
    function setPublicSaleTXAllowance(uint256 publicAllowance) external onlyOwner {
        publicSaleTXAllowancePlusOne = publicAllowance + 1;
    }
