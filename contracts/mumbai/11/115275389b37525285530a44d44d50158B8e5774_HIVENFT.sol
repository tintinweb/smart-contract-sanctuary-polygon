...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    */
    ...
    function _mint(address from, uint256 tokenId, uint256 _uri) internal {
        ...
        emit TransferSingle(from, address(0x0), from, tokenId, 1);
    }
...
contract HIVENFT is ERC1155, VRFConsumerBase {
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        _mint(requesters[requestId],randomResult, randomResult);
        setTier(randomResult);
        _setTokenURI(randomResult, (Strings.toString(randomResult)));
        assignedNFTs += 1;
