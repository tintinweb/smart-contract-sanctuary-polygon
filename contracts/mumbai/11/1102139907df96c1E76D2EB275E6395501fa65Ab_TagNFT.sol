...
interface ITagEscrow {
    ...
    function determineOutcome(uint256 escrowId, bool partyAWon) external payable;
    ...
    Ownable
{
    ...
    */
    ...
    function _beforeTokenTransfer(address from, address to, uint256 tokenId, uint256 batchSize) internal override {
        ...
        nftEscrowDetails[tokenId].owner = to;
    }
    ...
    function burn(uint256 tokenId) public override {
        ...
        ( , , , , , , , uint256 determineTime, , bool closed, ) = EscrowContract.escrows(
            nftEscrowDetails[tokenId].escrowId
        );
        require(determineTime < block.timestamp, "You can only burn your NFT after the release time has passed");
        require(closed, "You can only burn your NFT after Escrow has been closed");
        _burn(tokenId);
    }
