    ...
    PausableUpgradeable
{
     ...
     */
    function upWhitelistBatch() public onlyAdmin whenNotPaused {
        whitelistBatch += 1;
    }
        ...
        whitelistMiddleware
    {
        ...
        require(
            IERC20Upgradeable(usdtAddress).balanceOf(_msgSender()) >= mintFee,
            "Not enough fee token"
        );
        require(
            IERC20Upgradeable(usdtAddress).allowance(
                _msgSender(),
                melxNftAddress
            ) >= mintFee,
