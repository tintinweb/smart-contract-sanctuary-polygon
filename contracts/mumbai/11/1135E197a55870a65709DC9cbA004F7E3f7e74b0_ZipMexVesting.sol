...
contract ZipMexVesting is Initializable, OwnableUpgradeable {
        ...
        tokenAmountNotZero(_totalPoolTokenAmount)
    {
        ...
        p.releaseAmountPercentage = _releaseAmountPercentage;
        ...
        returns (uint)
    {
        ...
        if (block.timestamp < p.releaseTimes[currentVestingIndex]) { // Next release time not reached yet.
        ...
        { 
            ...
            uint divisor = hundred.div(percentage);

            unlockedTokens = b.totalTokens.div(divisor);
