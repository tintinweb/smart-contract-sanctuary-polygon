...
abstract contract WorldRandomDragon is WorldStorage {
    ...
    // function testRandomDragOwner() external view returns (address){
    //     uint256 totalRankStaked = 33;
    //     uint256 _randomSeed = 30651181323863600757805402065249228182939696318774945618241995789939011552006;
    ...
    //     for (uint i = 5; i <= 8; i++) {
    //         if(i == 5) {
    //             cumulative += 1 * rankToPoints[i];
    //         }
    //         if(i == 6) {
    //             cumulative += 1 * rankToPoints[i];
    //         }
    //         if(i == 7) {
    //             cumulative += 2 * rankToPoints[i];
    //         }
    //         if(i == 8) {
    //             cumulative += 0 * rankToPoints[i];
    //         }
    ...
    //     console.log('Rank picked: ', rankPicked);
    //     uint256 _dragonsAtTG = 1;
    //     uint256 _dragonsAtRift = 1;
    //     Location _locationOfEvent = Location.TRAINING_GROUNDS;
    ...
    //     console.log('numberInRange', _numberInRange);
    //     console.log('_rangePerTGDragon', _rangePerTGDragon);
    //     console.log('_rangePerRiftDragon', _rangePerRiftDragon);
    //     console.log('_dragonsAtTGRange', _dragonsAtTGRange);
    //     console.log('_dragonsAtRiftRange', _dragonsAtRiftRange);
    ...
    //         console.log('_indexOfChosenDragon', _indexOfChosenDragon);
