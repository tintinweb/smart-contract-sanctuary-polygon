...
contract ChainBattles is ERC721URIStorage {
    ...
    function generateCharacter(uint256 tokenId) public view returns (string memory){
        bytes memory svg = abi.encodePacked(
            ...
            '<text x="50%" y="70%" class="base" dominant-baseline="middle" text-anchor="middle">', "Strenght: ",getStrength(tokenId),'</text>',
    ...
    function getLevel(uint256 tokenId) public view returns (string memory) {
      Stats memory data = tokenIdtoStats[tokenId];
    ...
    function mint() public {
        ...
        Stats memory stats = Stats(0, randNumb(100), randNumb(50), 3);
    ...
    function train(uint256 tokenId) public {
        ...
        uint currentLevel = currentStats.level;
        uint currentLife = currentStats.life;
        currentStats.level = currentLevel +1;
        currentStats.life = currentLife -1;
        tokenIdtoStats[tokenId] = currentStats;
        _setTokenURI(tokenId, getTokenURI(tokenId));
    }

    function randNumb(uint256 number) internal view returns(uint256) {
