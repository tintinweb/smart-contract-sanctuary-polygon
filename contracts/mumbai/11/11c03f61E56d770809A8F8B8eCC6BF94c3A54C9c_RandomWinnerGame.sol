...
contract RandomWinnerGame is Ownable, VRFConsumerBase {
    // chainlink need an amount of fee to send a request
    uint256 public fee;
    //id plublic key against with randomness is generated
    ...
    function withdrawLink () public onlyOwner{
        require (LINK.balanceOf(address(this)) > 0, "no link here bud");
