...
import "./interfaces/IFRSTRegistry.sol";
...
contract FRSTSDK is Ownable {
  ...
  event DeployFRST721A(address FRST721A);
  event DeployFRST4907A(address FRST4907A);
  event DeployFRSTCrescendo(address FRSTCrescendo);
  event DeployFRSTVault(address FRSTVault);
  event DeployFRSTStaking(address FRSTStaking);
  event DeployZKEdition(address ZKEdition);

  /// ============ Constructor ============

  /// @notice Creates a new FrostySDK instance
  constructor(
    address _FRST721AImplementation,
    address _FRST4907AImplementation,
    address _FRSTCrescendoImplementation,
    address _FRSTVaultImplementation,
    address _FRSTStakingImplementation,
    address _metadataRenderer,
    address _contractRegistry,
    address _SplitMain,
    address _ZKEditionImplementation
  ) {
    FRST721AImplementation = _FRST721AImplementation;
    FRST4907AImplementation = _FRST4907AImplementation;
    FRSTCrescendoImplementation = _FRSTCrescendoImplementation;
    FRSTVaultImplementation = _FRSTVaultImplementation;
    FRSTStakingImplementation = _FRSTStakingImplementation;
  ...
  function deployFRST721A(
    ...
    clone = Clones.clone(FRST721AImplementation);
    ...
    require(success);
    IFRSTRegistry(contractRegistry).register(msg.sender, clone, "FRST721A");
    emit DeployFRST721A(clone);
  }
  ...
  function deployZKEdition(
    ...
    require(success);
    IFRSTRegistry(contractRegistry).register(msg.sender, clone, "ZKEdition");
  ...
  function deployFRST4907A(
    ...
    clone = Clones.clone(FRST4907AImplementation);
    (bool success, ) = clone.call(
      abi.encodeWithSignature(
        "initialize("
          "address,"
    ...
    require(success);
    IFRSTRegistry(contractRegistry).register(msg.sender, clone, "FRST4907A");
    emit DeployFRST4907A(clone);
  }
  ...
  function deployFRSTCrescendo(
    ...
    clone = Clones.clone(FRSTCrescendoImplementation);
    (bool success, ) = clone.call(
      abi.encodeWithSignature(
        "initialize("
          "address,"
    ...
    require(success);
    IFRSTRegistry(contractRegistry).register(
      msg.sender,
      clone,
      "FRSTCrescendo"
    );
    emit DeployFRSTCrescendo(clone);
  }
  ...
  function deployFRSTVault(
    ...
    clone = Clones.clone(FRSTVaultImplementation);
    (bool success, ) = clone.call(
      abi.encodeWithSignature(
    ...
    require(success);
    IFRSTRegistry(contractRegistry).register(msg.sender, clone, "FRSTVault");
    emit DeployFRSTVault(clone);
  }
  ...
  function deployFRSTStaking(
    ...
    clone = Clones.clone(FRSTStakingImplementation);
    (bool success, ) = clone.call(
      abi.encodeWithSignature(
        "initialize(address,address,address,uint256,uint256)",
        msg.sender,
    ...
    require(success);
    IFRSTRegistry(contractRegistry).register(msg.sender, clone, "FRSTStaking");
    emit DeployFRSTStaking(clone);
  }
}
