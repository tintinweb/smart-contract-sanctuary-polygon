...
contract ChubbyApeLogic is Ownable {
    ...
    // TODO: 上線要移除
    function verifySignData_public(
        ...
        return
            verifySignData(
                keccak256(
                    abi.encodePacked(senderAddress, _amount, _value, _requestID)
                ),
                signature
            );
    }
    ...
    ///#region WETH
    //Pre-sale Whitelist Mint By WETH
    function WhitelistMintByWETH_test(
        uint256 _amount,
        uint256 _value,
        uint256 _requestID,
        bytes memory _signature
