    ...
    NativeMetaTransaction
{
    ...
    constructor(address trustedForwarder) initializer ERC2771ContextUpgradeable(trustedForwarder) {}
    ...
    function mint(uint256 amount) public onlyRole(PREDICATE_ROLE) {
        _mint(_msgSender(), amount);
    }

    function _msgSender() internal view virtual override(ContextUpgradeable, ERC2771ContextUpgradeable) returns(address) {
        return msg.sender == address(this) ? ContextMixin.msgSender() : ERC2771ContextUpgradeable._msgSender();
    } 
