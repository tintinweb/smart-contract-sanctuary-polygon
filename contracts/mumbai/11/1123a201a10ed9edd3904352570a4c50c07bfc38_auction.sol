...
contract auction {
    ...
    constructor(address payable  _owner){
        ...
        //初始化商品信息，拍卖时间，起拍价
        auctionItems[0] = auctionItem("Name0","There is auction0's info",100,block.timestamp + 600,0,0x35a1A713C87335286a89A808588029cc4B154d78,0,0x0000000000000000000000000000000000000000);//
        auctionItems[1] = auctionItem("Name1","There is auction1's info",100,block.timestamp + 600,0,0x35a1A713C87335286a89A808588029cc4B154d78,0,0x0000000000000000000000000000000000000000);//
        auctionItems[2] = auctionItem("Name2","There is auction2's info",100,block.timestamp + 600,0,0x35a1A713C87335286a89A808588029cc4B154d78,0,0x0000000000000000000000000000000000000000);//
    }
    ...
    function putOnShelves(uint256 pid) public returns(bool){
        ...
        //最低价验证
        require(auctionItems[pid].Price >= 100,"auction error: the price is too cheap");//
        //状态更新
    ...
    function setPrice(uint256 pid, uint256 price) public returns(bool){
        ...
        require(auctionItems[pid].StateIdx == 0,"auction error: this item cannot be listd");
        //最低价验证
        require(price >= 100,"auction error: the price is too cheap");//
