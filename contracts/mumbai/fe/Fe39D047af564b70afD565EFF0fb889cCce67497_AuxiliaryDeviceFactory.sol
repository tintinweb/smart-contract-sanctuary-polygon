...
contract AuxiliaryDeviceFactory is Ownable, ReentrancyGuard, AccessControlEnumerable, IFactory, Pausable {
  ...
  // MANAGING Authorization Contract Address for Call 
   ...
   // 合约部署者增加操作员
        ...
        returns(uint[] memory)
    {
        ...
        // props["attack"] = settings[_type_id]["attack"].base + 1;
        ...
        props["defense"] = settings[_type_id]["defense"].base;
        ...
        props["hp"]      = settings[_type_id]["hp"].base;
        ...
        // }
        props["duration"]= settings[_type_id]["duration"].base;
 ...
 //msg.sender是erc1155合约
        ...
        uint new_rand= (randomResult.sub(randomResult%10)).div(10);
