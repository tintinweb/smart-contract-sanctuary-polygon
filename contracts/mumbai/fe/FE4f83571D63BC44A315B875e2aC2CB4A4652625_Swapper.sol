...
contract Swapper is Context,ERC20,Pausable,ERC2771Context, MinimalForwarder,AdminRole{
  
    constructor(address owner) ERC20("Swapper", "SWP") ERC2771Context(address(this)) AdminRole(owner) {
    }
