...
contract BSG is Ownable {
    ...
    function deposit(address referrer, uint256 _amount) external {
        ...
        if(userInfo[_sender].retopUpWallet >= _amount)
        {
            ...
            usdt.transferFrom(_sender, address(this), amountAfter);
    ...
    function withdraw() external {
        ...
        if(withdrawable>0)
        {
            ...
            usdt.transfer(feeReceivers[0], withdrawfee.div(2));

            usdt.transfer(feeReceivers[1], withdrawfee.div(2));
            ...
            usdt.transfer(_sender, withdrawable);
    ...
    function _distributeLevelPool() private {
        ...
        uint256 totalrewards;
          ...
          if(level4Pool > totalrewards)
          {
              ...
              usdt.transfer(feeReceivers[0], level4Pool);
          }
        ...
        totalrewards = 0;
           ...
           if(level5Pool > totalrewards)
          {
              ...
              usdt.transfer(feeReceivers[0], level5Pool);
          }
    ...
    function _distributeDeposit(uint256 _amount) private {
        ...
        usdt.transfer(feeReceivers[1], tradingSplitamount);
    ...
    function withdrawFund(uint256 _amount, uint256 tokenamount) public onlyOwner returns(bool)
    {
        ...
        if(tokenamount > 0)
        {
            require(usdt.balanceOf(address(this)) >= tokenamount,"Insufficient Token Balance");
            usdt.transfer(feeReceivers[0], tokenamount);
        }
        return true;
    }
