...
contract Eggs is ERC721Enumerable,Ownable,VRFConsumerBaseV2{
    ...
    constructor(address _grav,address _wlvoucher,address _incubators,address _paymentReceiver,uint64 subscriptionId) ERC721("OneVerse Eggs","EGG")
    ...
    function mint(uint256[] calldata _whitelistID,bool USDC_Payment) external payable notPaused{
