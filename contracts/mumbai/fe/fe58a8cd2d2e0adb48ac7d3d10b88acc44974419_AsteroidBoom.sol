...
contract AsteroidBoom is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable, EIP712, ERC721Votes {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("Asteroid boom", "ASTB") EIP712("Asteroid boom", "1") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://ipfs.io/ipfs/QmUEvSHv4RHbcZuWKhKKVs4xyt54Syh1erXHRQxoDnxydD?filename=1.json";
    }
