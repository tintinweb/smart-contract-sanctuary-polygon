...
contract NFTMint is ERC1155URIStorage {
    ...
    function retreiveName() public view returns (string memory) {
        return name;
    }

    function retreiveSymbol() public view returns (string memory) {
        return symbol;
    }
    ...
    function transferTokenToSmartContract(
        uint256 tokenId,
        uint256 supply,
        address NFTMarketplaceAddress
    ) external {
