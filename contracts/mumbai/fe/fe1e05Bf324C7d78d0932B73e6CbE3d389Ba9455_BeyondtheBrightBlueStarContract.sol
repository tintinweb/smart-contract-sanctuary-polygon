...
//*********************************************************************//
//
//     ____                             __   __  __            ____       _       __    __     ____  __              _____ __            
//    / __ )___  __  ______  ____  ____/ /  / /_/ /_  ___     / __ )_____(_)___ _/ /_  / /_   / __ )/ /_  _____     / ___// /_____ ______
//   / __  / _ \/ / / / __ \/ __ \/ __  /  / __/ __ \/ _ \   / __  / ___/ / __ `/ __ \/ __/  / __  / / / / / _ \    \__ \/ __/ __ `/ ___/
//  / /_/ /  __/ /_/ / /_/ / / / / /_/ /  / /_/ / / /  __/  / /_/ / /  / / /_/ / / / / /_   / /_/ / / /_/ /  __/   ___/ / /_/ /_/ / /    
// /_____/\___/\__, /\____/_/ /_/\__,_/   \__/_/ /_/\___/  /_____/_/  /_/\__, /_/ /_/\__/  /_____/_/\__,_/\___/   /____/\__/\__,_/_/     
//            /____/                                                    /____/                                                           
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x98794Ec6Ba91e003854a5b2ad21E1CBa65A438E0];
  address public erc20Payable = 0x98794Ec6Ba91e003854a5b2ad21E1CBa65A438E0;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiermhpr6p5xfyk5daftxcknt4q6fdrls4a6wevk4fye7vt4zz7qia/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 3");
...
// File: contracts/BeyondtheBrightBlueStarContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BeyondtheBrightBlueStarContract is RamppERC721A {
    constructor() RamppERC721A("Beyond the Bright Blue Star", "BTBBS"){}
}