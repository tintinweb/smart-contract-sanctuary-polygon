...
//*********************************************************************//
//
// ,  ,  _, ,_  ,   ,_       _,  __,     _,   _,  _, ,  ,,__,    ,_ ,_   _,  ___,_, _,___, 
// | ,| / \,|_) |   | \,    / \,'|_,    / _  / \,/ \,|\ |  /     |_)|_) / \,',| /_,/ ' |   
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x01d70Be9066d014884c8aDd3A8c1328F37460aF5];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmVXKQcSWAM78m7kM5Rph5GFCmW9HCv13de23KQQoWFdYh/";
...
// File: contracts/NftGangstaGoonzProjectContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NftGangstaGoonzProjectContract is RamppERC721A {
    constructor() RamppERC721A("NFT Gangsta Goonz Project", "LOOT"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/V7ACQiycpNlHwUE0XizQ/contract-metadata";
    }
}
