...
contract NFTYDashPremium is ERC1155, Ownable {
    ...
    function mintPublic(uint256 amount_) external payable onlyPublic {
        require(totalSupply + amount_ <= MAX_SUPPLY, "MAXED_COL");
        require(msg.value == amount_ * pricePublic, "!PRICE");
    ...
    function whitelist(uint256 amount_, bytes32[] calldata merkleProof_) external payable onlyWhitelist {
        require(totalSupply + amount_ <= MAX_SUPPLY, "MAXED_COL");
        require(msg.value == amount_ * priceWhitelist, "!PRICE");
