    ...
    ERC2981
{
    ...
    event Mint(address to, uint256 quantity, uint256 totalpay);
    ...
    function mint(uint256 quantity, uint256 totalpay) public nonReentrant whenNotPaused onlyRole(WORKER_ROLE) {
        ...
        currency.safeTransferFrom(msg.sender, address(this), totalpay);
        _mintRandom(msg.sender, quantity );

        emit Mint(msg.sender, quantity, totalpay);
    }
