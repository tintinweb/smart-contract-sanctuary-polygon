...
contract swap_v2 is Ownable {
    ISwapRouter public ROUTER;
    IERC20 public LinkToken;
    IWETH public WETHcontract;
    IUniswapV3Pool public customPool;

    event SwapPerformed(uint256 amountIn, uint256 amountOut, address sender);
    event LogEstimatedAmountOutMin(uint256 estimatedAmount);
    ...
    function swapMaticForLink() external payable {
        ...
        emit SwapPerformed(amountIn, amountOut, msg.sender);
    }
        ...
        returns (uint256 amountOut)
    {
        ...
        emit LogEstimatedAmountOutMin(estimatedAmountOut);
        // perform the swap
        ISwapRouter.ExactInputSingleParams memory params = ISwapRouter
            .ExactInputSingleParams({
                tokenIn: address(WETHcontract),
