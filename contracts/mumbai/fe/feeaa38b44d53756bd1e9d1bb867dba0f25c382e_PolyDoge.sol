...
contract DogewoodPoly is PolyERC721 {
    /*///////////////////////////////////////////////////////////////
                    Global STATE
    //////////////////////////////////////////////////////////////*/
    ...
    uint256 public constant mintCooldown = 0 hours;
    ...
    address public nameChangeAddress;
    ...
    function setNameChange(address t_) external {
        require(msg.sender == admin);
        nameChangeAddress = t_;
    }
    ...
    */
    ...
    /**
     * @dev Changes the name of Gratia of given tokenId
     */
    function changeName(uint256 id, string memory newName) public virtual ownerOfDoge(id, msg.sender) {
        INameChange(nameChangeAddress).changeName(msg.sender, id, newName);
    }
}

contract PolyDoge is DogewoodPoly {
    function takeDoge(address from, uint256 id) public {
    ...
    function updateDoge(uint256 id, uint8 head, uint8 breed, uint8 color, uint8 class, uint8 armor, uint8 offhand, uint8 mainhand, uint16 level, 
    uint16 breedRerollCount, uint16 classRerollCount) external {
        doges[id].head = head;
        doges[id].breed = breed;
        doges[id].color = color;
        doges[id].class = class;
