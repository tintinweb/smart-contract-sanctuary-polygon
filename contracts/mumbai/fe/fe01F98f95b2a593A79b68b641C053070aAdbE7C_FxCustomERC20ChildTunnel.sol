...
contract FxCustomERC20ChildTunnel is FxBaseChildTunnel, Create2 {
    ...
    function _processMessageFromRoot(
        ...
        if (syncType == DEPOSIT) {
            ...
            _mapToken(syncData);
        } else if (syncType == MAP_TOKEN_WITHOUT_DEPLOY) {
            _mapTokenWithoutDeploy(syncData);
        } else {
    ...
    function _mapTokenWithoutDeploy(bytes memory syncData) internal returns (address) {
