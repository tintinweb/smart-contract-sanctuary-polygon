...
contract VennityCollection is Context, ERC165, IERC1155, IERC1155MetadataURI, Ownable {
    ...
    function mint(address account, string memory _name, string memory _uri, uint256 amount, string memory uuid)
        public onlyOwner
    {
        _mint(account, _name, _uri, amount, uuid);
    }
