...
// File: contracts/CocoaStrawberryAirdrop.sol


pragma solidity ^0.8.4;

contract CocoaStrawberryAirdrop is ERC721, ERC721Enumerable, ERC721Burnable, Ownable, BaseRelayRecipient {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    bytes32 public merkleRoot = 0x3aaaf62feaeb17dd1e11347810bfca0e10294c15d629c718305c3b46b4748441;

    mapping(address => bool) public whitelistClaimed;

    string public baseURI;

    constructor(address _trustedForwarder) ERC721("CocoaStrawberryClub", "COCOA") {
    ...
    function getAirdrop(bytes32[] calldata _merkleProof) public {
        require(!whitelistClaimed[_msgSender()], "address has already been claimed");
