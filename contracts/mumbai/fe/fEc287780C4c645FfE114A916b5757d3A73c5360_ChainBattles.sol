...
//Inital address -0x5380448950729c0A67092FB7ce9C6D57d9FD7120
//Challenge Address - 
contract ChainBattles is ERC721URIStorage {
    ...
    mapping(uint256 => Trait) public tokenIdToLevels;
    ...
    function mint() public {
        ...
        tokenIdToLevels[newItemId].speed = random(80);
        tokenIdToLevels[newItemId].strength = random(100);
        tokenIdToLevels[newItemId].life = random(5);
    ...
    function train(uint256 _tokenId) public {
        ...
        uint256 newLevel = tokenIdToLevels[_tokenId].level + 1;
        uint256 newSpeed = tokenIdToLevels[_tokenId].speed + 10;
        uint256 newStrength = tokenIdToLevels[_tokenId].strength + 25;
        uint256 newLife = tokenIdToLevels[_tokenId].life + 3;
        
        Trait memory trait = Trait(newLevel, newSpeed, newStrength, newLife);
        tokenIdToLevels[_tokenId] = trait;
