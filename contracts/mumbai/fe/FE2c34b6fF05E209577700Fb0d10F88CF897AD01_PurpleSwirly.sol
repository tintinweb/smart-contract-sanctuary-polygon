 ...
 * @notice This contract handles minting Purple Swirly tokens.
 */
contract PurpleSwirly is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x779260af2DAA5F304e98EfcC84AacA7DD5fb9F63;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x6Ddd07cbB98aE4280539050F09Afec6D4ABE9654;
    ...
    address[] public payoutAddresses = [
        0x6Ddd07cbB98aE4280539050F09Afec6D4ABE9654
    ];
    ...
    string public name = "Purple Swirly";
    string public symbol = "PPSWRLY";
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeiebz2yf2wxeuj74xptrcyqxqp7izztbygxhkj6aw72pt7ly3enmiy/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[1] = 333;
        tokenPublicPrice[1] = 0.05 ether;
        tokenPublicMintsPerAddress[1] = 333;
        tokenPresaleMaxSupply[1] = 111;
        tokenPresalePrice[1] = 0.03 ether;
