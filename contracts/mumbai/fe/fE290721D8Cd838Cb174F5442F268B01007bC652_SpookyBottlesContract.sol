...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x3b708244c43Ee3207AA5B7638194a1e3238FfdA8];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 111) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiaxvpe3ybk5b2uick2cgn2y7nj3flsqqhtjt3r3z2tvxiqegarrhu/";
...
// File: contracts/SpookyBottlesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SpookyBottlesContract is RamppERC721A {
    constructor() RamppERC721A("Spooky Bottles", "SPBS"){}
}
