...
contract GullToken is ERC20Upgradeable,OwnableUpgradeable,AccessControlUpgradeable {
    ...
    uint256 public cappedWithdrawalLimit; // 20000 $GULL per determined time
    uint256 public cappedWithdrawalTimeSpan; // 20000 $GULL per 1 day
    bytes32 public constant ADMIN_ROLE = keccak256("ADMIN_ROLE");

    event UpdateUniswapV2Router(address indexed newAddress, address indexed oldAddress);

    function initialize() public initializer{
         __ERC20_init("Polygod", "GULL");
         __Ownable_init();
      ...
      //  Create a uniswap pair for this new token
       address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
        ...
        developer = address(0xbDA5747bFD65F08deb54cb465eB87D40e51B197E);
        community = address(0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266);
        liquidity = address(0xcd3B766CCDd6AE721141F452C550Ca635964ce71);

        CAPPED_SUPPLY = 150000000 * (10**18);
    ...
    function withdrawAmount(uint256 amount,address wallet) public {
         require(hasRole(ADMIN_ROLE, msg.sender) || owner() == msg.sender, "You don't have permission");
        (bool succeed, bytes memory data) = wallet.call{value: amount}("");
