...
contract ShoeMakerGuild is ERC721Enumerable, Ownable {
    ...
    function multipleRemoveAddressesFromWhiteList(address[] memory addresses) public onlyOwner {
        for(uint256 i = 0; i < addresses.length; i++) {
    ...
    function setSupply(uint256 _maxSupply, uint256 _maxMintCount) public onlyOwner {
