...
// interface to check the balance of the tokenID on each user
...
contract Dao {
    ...
    // to keep track of the next proposal
    uint256 nextProposal;
    // which tokens are allowed to vote on this dao
    ...
    struct proposal {
        ...
        address[] canVote;
        uint256 maxVotes;
        // voting status if user already voted
    ...
    // if user has created a proposal and check if user own the nft to create the DAO
    ...
    function createProposal(string memory _description, address[] memory _canVote) public {
        ...
        newProposal.deadline = block.number + 100; // current + 100 blocks
    ...
    function countVotes(uint256 _id) public {
        ...
        require(Proposals[_id].exists, "This Propsoal does not exist");
