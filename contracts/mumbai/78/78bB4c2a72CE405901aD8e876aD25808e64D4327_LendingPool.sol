...
contract LendingPool is AccessControlEnumerable, Pausable {
    ...
    mapping(address => mapping(address => bool)) public collateralTokens;
    mapping(address => bool) public collateralPools;
    mapping(address => uint256) public lenderSupply;
    ...
    function _withdraw(
        ...
        lenderSupply[msg.sender]-= Math.min(lenderSupply[msg.sender], assetAmount_);
    ...
    function getLTokenPrice(
        ...
        ReserveInfo memory reserveInfo_ = reserveInfos[asset_];
        price_ = reserveInfo_.tokenInfo.lTokenPrice;
    }
}