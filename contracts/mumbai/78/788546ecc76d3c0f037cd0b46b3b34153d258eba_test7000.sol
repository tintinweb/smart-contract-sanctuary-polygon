...
contract test7000 is ERC20, Pausable, Ownable, ERC20Burnable, ERC20Blocklist{
    ...
    constructor() ERC20("test7000", "t7000") {}
    ...
    function MinersDetails(uint256 _NumberOfMiner, string memory _Location, string memory _HotSpot, string memory _HotSpotFreq, string memory _P2P, string memory _P2PFreq, string memory _IoTSupport, string memory _StorageSupport, string memory _StorageCapacity) public onlyOwner {
       NumberOfMiner = _NumberOfMiner;
       Location = _Location;
       HotSpot = _HotSpot;
            HotSpotFreq  = _HotSpotFreq;
       P2P = _P2P;
           P2PFreq = _P2PFreq;
       IoTSupport = _IoTSupport;
       StorageSupport = _StorageSupport;
