...
contract AdminManagedSBT is Initializable, OwnableUpgradeable, AdminManaged, SoulBound, ContractMetadata {
    ...
    function initialize(
        ...
        __AdminManaged_init(owner, transfer, burner, minter, approver);
        __Ownable_init();
    ...
    function tokenURI(uint256) public view virtual override returns (string memory) {
        return 'https://ipfs.io/ipfs/QmfBsUkJJ5db3vvLZJFBKR5xfLZD5oYeaxYuvH9sEPvh6c?filename=token-metadata.json';
    }
}
