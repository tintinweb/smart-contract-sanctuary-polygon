...
/**
    ...
    **/
    ...
    function backedPrice() public view returns(uint){
        uint _backedPrice = ((((IERC20(Admin.BUSD()).balanceOf(Admin.Treasury()) + IERC20(Admin.BUSD()).balanceOf(Admin.POL()))/2) * 10 **18)/totalSupply());
        return _backedPrice;
    }
