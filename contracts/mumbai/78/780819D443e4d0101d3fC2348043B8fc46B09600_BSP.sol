...
contract BSP is Initializable, ERC1155Upgradeable, OwnableUpgradeable, PausableUpgradeable, ERC1155SupplyUpgradeable, UUPSUpgradeable {
    ...
    */
    ...
    uint public debugAmount;
    uint public debugFromBalance;
    uint public debugReleasedPerToken;
    ...
    */
    ...
    private onlyOwner
    {
        ...
        {   
            ...
            debugAmount = amount;
            debugFromBalance = _fromBalance;
            debugReleasedPerToken = _releasedPerToken;
        }
    }
    ...
    returns (uint256)
    {
        ...
        // all splittable dividends * precent of the account own shares out of the total shares - amount already released
        uint256 pendingPayment = ((totalReceived * _accountShares) / _totalShares) - alreadyReleased;
