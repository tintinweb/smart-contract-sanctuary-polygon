...
contract Hackjack is HackjackVRF {
...
contract HackjackVRF is VRFConsumerBaseV2, BreakdownUint256, Destructible, RequestQueue { 
    using Counters for Counters.Counter;
    ...
    function sendRandomRequest() public {
        ...
        requestInfo memory newRequest = requestInfo(false, true,false,0,0,requestIndex);
    ...
    function fulfillRandomRequest(
        ...
        uint8 randomWord
            ...
            requestIndexToRequestInfo[requestIndex].randomNumber = randomWord;
    }
