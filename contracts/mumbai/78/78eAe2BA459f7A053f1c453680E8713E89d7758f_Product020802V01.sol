...
contract Product020802V01 is OwnableV01 {
    ...
    function endorsePolicy(
        ...
        checkPolicyExists(endorsementParams.onChainPolicyId);
        Product020802Lib.Policy storage endorsedPolicy = allPolicies[endorsementParams.onChainPolicyId];
        Product020802Lib.endorsePolicy(endorsementParams, endorsedPolicy, TIME_ZONE_OFFSET);
        emit PolicyEndorsed(
            endorsementParams.onChainPolicyId,
            endorsedPolicy.operationType,
            endorsedPolicy.operationEffectiveDate
        );
    }
    ...
    function cancelPolicy(
        ...
        checkPolicyExists(onChainPolicyId);
    ...
    function checkPolicyExists(string calldata onChainPolicyId) private view {
...
library Product020802Lib {
    ...
    function endorsePolicy(
        ...
        policy.operationEffectiveDate = endorsementParams.operationEffectiveDate;
    }
