...
contract PresaleSRX is Ownable {
    ...
    function buySRXWithToken(
        ...
        if (_tokenAddress == btcAddress) {
            userToBtcTokenAmount[msg.sender] += tokenAmount;
            btcAmount += _amount;
        } else if (_tokenAddress == bnbAddress) {
            userToBnbTokenAmount[msg.sender] += tokenAmount;
            bnbAmount += _amount;
        } else if (_tokenAddress == usdcAddress) {
            userToUsdcTokenAmount[msg.sender] += tokenAmount;
            usdcAmount += _amount;
        } else if (_tokenAddress == busdAddress) {
            userToBusdTokenAmount[msg.sender] += tokenAmount;
            busdAmount += _amount;
        }
