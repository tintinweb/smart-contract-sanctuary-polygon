...
import {IOneAuth} from "../auth/interfaces/IOneAuth.sol";

contract UnderlyingAsset is ERC20, Owned {
    address public oneAuth; // address of the OneLendAuth contract
    ...
    modifier onlyOwnerOrAdmin() {
        bool isAdmin = IOneAuth(oneAuth).isAdmin(msg.sender);
    ...
    /*//////////////////////////////-////////////////////////////////
                                CONSTRUCTOR
    //////////////////////////////-////////////////////////////////*/
    constructor(string memory _name, string memory _symbol, address _oneAuth)
        Owned(msg.sender)
    ...
    function resetBalances() external onlyOwnerOrAdmin {
        // get all kyc users from the oneAuth contract
        address[] memory kycAccounts = IOneAuth(oneAuth).getKycAccounts();
    ...
    // set oneAuth address
    function setOneAuth(address _oneAuth) public onlyOwner {
        oneAuth = _oneAuth;
    }
}
