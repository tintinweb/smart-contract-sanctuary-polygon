...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xEc3d9cA927E1EFd0e15F64249A8948825954C3DB];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xEc3d9cA927E1EFd0e15F64249A8948825954C3DB;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://Qmdi5RCw629Rp7hrw6kYvn3aq4ZsedSmUc9uKuFVs82nK4/";
...
// File: contracts/PaludariumContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PaludariumContract is RamppERC721A {
    constructor() RamppERC721A("Paludarium", "PLD"){}
}
