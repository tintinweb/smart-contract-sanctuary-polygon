  ...
  ERC721Burnable
{
    ...
    returns (uint256)
  {
    return
      TicketTracker(raffleConfig.ticketTracker).totalMinted() *
      (raffleConfig.fullSellPrice / raffleConfig.maxTickets);
  }
  ...
  function redeemPriceNft(uint256 raffleNftId) external {
    ...
    uint256 raffleAmount = TicketTracker(raffleConfig.ticketTracker)
      .totalSupply() * (raffleConfig.fullSellPrice / raffleConfig.maxTickets);
