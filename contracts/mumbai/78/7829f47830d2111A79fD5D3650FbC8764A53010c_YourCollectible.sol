...
contract YourCollectible is ERC721, Ownable, AccessControl, IMintableERC721, ERC721Enumerable, MerkleClaimERC721 {
...
abstract contract MerkleClaimERC721 is ERC721 {
  ...
  /// @param proofs merkle proof to prove address and tokenId are in tree
  function claim(address to, uint256[] calldata tokenIds, bytes32[][] calldata proofs) external {
