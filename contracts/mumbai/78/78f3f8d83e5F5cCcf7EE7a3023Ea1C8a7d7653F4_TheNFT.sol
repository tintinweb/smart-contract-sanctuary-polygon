...
contract TheNFT is Ownable, ERC721A, ReentrancyGuard, ERC2981{
  ...
  function firstSaleMint(uint256 quantity, address to, bytes32[] calldata _merkleProof) public payable nonReentrant {
    ...
    require(firstSaleLimit >= quantity, "limit over");
    require(firstSaleMintLimit >= totalMinted[msg.sender] + quantity, "You have no Mint left");
    require(msg.value == firstSaleMintPrice * quantity, "Value sent is not correct");
  ...
  function secondSaleMint(uint256 quantity, address to, bytes32[] calldata _merkleProof) public payable nonReentrant {
    ...
    require(secondSaleLimit >= quantity, "limit over");
  ...
  function thirdSaleMint(uint256 quantity, address to, bytes32[] calldata _merkleProof) public payable nonReentrant {
    ...
    require(thirdSaleLimit >= quantity, "limit over");
  ...
  function switchThirdSale(bool _state) external onlyOwner {
    thirdSaleStart = _state;
  }
  //
  function setFirstSaleMintLimit(uint256 newLimit) external onlyOwner {
    firstSaleMintLimit = newLimit;
  }
  function setSecondSaleMintLimit(uint256 newLimit) external onlyOwner {
    secondSaleMintLimit = newLimit;
  }
  function setThirdMintLimit(uint256 newLimit) external onlyOwner {
  ...
  // 
  function setFirstSaleMintPrice(uint256 _price) external onlyOwner {
    firstSaleMintPrice = _price;
  }
  function setSecondSaleMintPrice(uint256 _price) external onlyOwner {
    secondSaleMintPrice = _price;
  }

  function setSecondSaleMintPriceWL(uint256 _price) external onlyOwner {
    secondSaleMintPriceWL = _price;
  }

  function setSecondSaleMintPriceSP(uint256 _price) external onlyOwner {
    secondSaleMintPriceSP = _price;
  }

  function setThirdMintPrice(uint256 _price) external onlyOwner {
    thirdSaleMintPrice = _price;
  }
  function setThirdMintPriceWL(uint256 _price) external onlyOwner {
    thirdSaleMintPriceWL = _price;
  }
  function setThirdMintPriceSP(uint256 _price) external onlyOwner {
  ...
  function setMerkleRootSP(bytes32 _merkleRootSP) external onlyOwner {
    merkleRootSP = _merkleRootSP;
  }

  function setMerkleRootSPWP(bytes32 _merkleRootSP, bytes32 _merkleRootWL) external onlyOwner {
    merkleRootSP = _merkleRootSP;
    merkleRootWL = _merkleRootWL;
  }
