...
library Address{
 ...
 contract Etionera is Context, IERC20, Ownable {
    ...
    uint256 public maxSellLimit = 5_000_000 * 10**9; //0.5%
    ...
    string private constant _name = "Etionera";
    string private constant _symbol = "ETA";
