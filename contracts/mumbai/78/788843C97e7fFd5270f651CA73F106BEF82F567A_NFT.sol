...
contract NFT is ERC721PresetMinterPauserAutoId, IERC2981, Ownable {

    address DONATIONS = 0x000000000000000000000000000000000000dEaD;

    constructor() ERC721PresetMinterPauserAutoId(
      "Bart", "BT",
      "https://ipfs.io/ipfs/QmdFGgwbPxze7GSXZv42Rx5jL5wK6FPzoy37hLzE9sRAUE"
    ) {}
    ...
    function mintBatch(address[] memory to) external onlyOwner {
        ...
        for (uint256 i = 0; i < length; i++) { mint(to[i]); }
    }
    ...
    function royaltyInfo(uint256 _tokenId, uint256 _salePrice) external view virtual override returns (address, uint256) {
        uint256 royaltyAmount = (_salePrice * 10) / 100;
        return (DONATIONS, royaltyAmount);
    }
}
