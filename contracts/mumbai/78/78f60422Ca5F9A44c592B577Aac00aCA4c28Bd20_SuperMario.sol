...
contract SuperMario is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x6Bd7CB6209E167Fa8a2Bd4b7458aB1dcaeBb48Fe);
    ...
    function setFeePercent(uint256 liquidityFee, uint256 marketingFee) external onlyOwner() {
        require(liquidityFee.add(marketingFee) <= 10, "tax too high");
