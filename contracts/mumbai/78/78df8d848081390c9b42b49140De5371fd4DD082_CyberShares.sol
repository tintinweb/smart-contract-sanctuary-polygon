...
// File: contracts/cyberShare_optimized.sol
...
contract CyberShares is ERC721A {
    address payable target1 = payable(0x488A8CA56f29BFbe28e6f4cf898D5c3C1455deDa);
    address payable target2 = payable(0x488A8CA56f29BFbe28e6f4cf898D5c3C1455deDa);
    address owner;
...
string privateRevealURI="https://gateway.pinata.cloud/ipfs/Qmch5v4XuNu6BpKuchYGiL2iVmAZw7gCSWpo7DV47PeGcZ";
    constructor() ERC721A("CyberShares", "CS") {
      owner=msg.sender;
      count=0;
 setBaseURI("https://gateway.pinata.cloud/ipfs/QmQ6mbwcak5hsy7WwukbfFyUgZdjx38DFRhHXGquXgve8D/");
...
function toggleReveal() public {
    ...
    if(ownerOf(_id[i])==owner)
    {
     ...
     {
          count++;
          safeTransferFrom(msg.sender, _to[i], _id[i]+1);
          count++;
        }
    }}
    ...
    require(_mintAmount > 0);
        ...
        if(whitelisted[msg.sender] != true) {
          ...
          uint per=(msg.value).mul(5).div(100);
