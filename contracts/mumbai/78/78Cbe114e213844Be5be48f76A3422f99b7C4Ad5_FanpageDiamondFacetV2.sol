...
contract FanpageDiamondFacetV2 is ERC1155Base, FanpageAccessControl {
    ...
    constructor() {
        ...
        LibERC1155.setName('FanpageTest123');
    }

    function uri(uint256 _tokenId) public view returns (string memory) {
        string memory _tokenURI = LibERC1155.getURI(_tokenId);
        return _tokenURI;
    }
    ...
    function mintAndDeposit(
        ...
        LibERC1155.setTokenURL(_tokenId, _tokenURI );
        LibERC1155.setSerialNumber(_tokenId, _serial );
        if (_royaltyPercentage != 0) {
            LibERC1155.setRoyaltyInfo(_tokenId, _recipient, _royaltyPercentage);
        }
    ...
    function checkSerial(uint256 _tokenId, bytes32 _serial) public view virtual returns (bool) {
        ...
        if (LibERC1155.getSerialNumber(_tokenId) == _serial) {
            return true;
        }
        return false;
    }
    ...
    function royaltyInfo(
        ...
        uint256 percentage = LibERC1155.getRoyaltyPercentage(_tokenId);
        address recipient = LibERC1155.getRoyaltyRecipient(_tokenId);
