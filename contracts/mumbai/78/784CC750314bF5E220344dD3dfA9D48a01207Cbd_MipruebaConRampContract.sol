...
//*********************************************************************//
//
//    __________  _________   ___       ____  ____  ____  ____
//   / ____/ __ \/  _/__  /  /   |     / __ \/ __ \/ __ \/  _/
//  / /   / /_/ // /   / /  / /| |    / /_/ / / / / / / // /  
// / /___/ _, _// /   / /__/ ___ |   / _, _/ /_/ / /_/ // /   
// \____/_/ |_/___/  /____/_/  |_|  /_/ |_|\____/_____/___/   
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x4526F15D089f071718c88553808F14A6C3d4d425];
...
// File: contracts/MipruebaConRampContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract MipruebaConRampContract is 
    ERC1155,
    Ownable, 
    Pausable, 
    ERC1155Supply, 
    ...
    Allowlist
{
    ...
    string public name = "mipruebaconramp";
    string public symbol = "MPRU";
    ...
    */
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/gkyKnWjhJ1HOEXZelLOG/contract-metadata";
    }
