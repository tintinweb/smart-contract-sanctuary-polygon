    ...
    ERC721Burnable
{
    ...
    constructor() ERC721Permit("BeeMeeClub", "BMC") {
    ...
    /// @notice Allows to set a token URI with a signed permit
    ...
    function setTokenURIWithPermit(
        uint256 tokenId,
    ...
    /// @dev burn token by tokenId
    /// @notice tokenId must exist
    /// @notice emits a Transfer event.
    /// @dev override of _burn required by ERC721WithPermit.sol
    /// @param tokenId the token id
    ...
    /// @dev override of tokenURI required by ERC721URIStorage.sol
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC721, ERC721Permit, AccessControl)
        returns (bool)
    {
