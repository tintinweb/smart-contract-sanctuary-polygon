...
contract Dao {
    ...
    constructor(){
        ...
        validTokens = [1];
        votee = [daoContract.ownerOf(validTokens[0])];
    }
    ...
    function createProposal(string memory _description) public {
        ...
        newProposal.canVote  = votee;
        newProposal.maxVotes = votee.length;

        emit proposalCreated(nextProposal, _description, votee.length, msg.sender);
        nextProposal++;
    }
  ...
  //      votee.push(daoContract.ownerOf(_tokenId));
    }
