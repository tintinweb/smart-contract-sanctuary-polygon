...
contract AZL is ERC721Enum, Ownable, ReentrancyGuard {
    using Strings for uint256;
	
	uint256 public SALE_NFT = 100;
	uint256 public MAX_BY_MINT_IN_TRANSACTION = 3;
	uint256 public MAX_MINT_SALE = 100;
	
	uint256 public SALE_PRICE = 45 * 10**18;
    ...
    constructor() ERC721P("Azoll Generation 1", "AZL") {}
