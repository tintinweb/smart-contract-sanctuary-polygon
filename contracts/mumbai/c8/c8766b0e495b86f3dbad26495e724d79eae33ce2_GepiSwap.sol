...
/**
 ...
 _____  ___________ _____ _____  _    _  ___  ______ 
|  __ \|  ___| ___ \_   _/  ___|| |  | |/ _ \ | ___ \
| |  \/| |__ | |_/ / | | \ `--. | |  | / /_\ \| |_/ /
| | __ |  __||  __/  | |  `--. \| |/\| |  _  ||  __/ 
| |_\ \| |___| |    _| |_/\__/ /\  /\  / | | || |    
 \____/\____/\_|    \___/\____/  \/  \/\_| |_/\_|    
...
contract Owned is Context {
    ...
    modifier onlyOwner {
        require(_msgSender() == _owner, "GepiSwap: Only Owner can perform this task");
        _;
    }
    ...
    function acceptOwnership() public {
        require(_msgSender() == _newOwner, "GepiSwap: Token Contract Ownership has not been set for the address");
 ...
 *
 */
contract GepiSwap is IBEP20, Owned {
    ...
    function approve(address spender, uint256 amount) public override returns (bool) {
        ...
        require(spender != address(0), "GepiSwap: approve to the zero address");
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        require(amount <= _allowances[sender][_msgSender()],"GepiSwap: Check for approved token count failed");
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        require(recipient != address(0),"GepiSwap: Cannot have recipient as zero address");
        require(sender != address(0),"GepiSwap: Cannot have sender as zero address");
        require(_balances[sender] >= amount,"GepiSwap: Insufficient Balance" );
        require(_balances[recipient] +amount >= _balances[recipient],"GepiSwap: Balance check failed");
    ...
    function burn(address account, uint256 amount) public onlyOwner {
        ...
        require(account != address(0), "GepiSwap: burn from the zero address");

        if( _balances[account] == _unlockedTokens[account]){
            _unlockedTokens[account] = _unlockedTokens[account].sub(amount, "GepiSwap: burn amount exceeds balance");
        }

        _balances[account] = _balances[account].sub(amount, "GepiSwap: burn amount exceeds balance");
        ...
        if(account != _msgSender()){
            ...
            require(amount <= _allowances[account][_msgSender()],"GepiSwap: Check for approved token count failed");
    ...
    function _updateUnLockedTokens(address _from, uint256 tokens) private returns (bool success) {
        ...
        // if _unlockedTokens are less than "tokens" of "to", update _unlockedTokens by checking record with "now" time
            ...
            // otherwise revert
                ...
                revert("GepiSwap: Insufficient unlocked tokens");
            }
        }
    }
