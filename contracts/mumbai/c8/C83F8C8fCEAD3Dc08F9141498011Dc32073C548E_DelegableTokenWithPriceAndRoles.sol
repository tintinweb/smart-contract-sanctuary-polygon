...
import "@wakeuplabs/delegable-token/contracts/extensions/DelegableTokenExtensionURIStorage.sol";

contract DelegableTokenWithPriceAndRoles is
    DelegableTokenExtensionURIStorage,
    AccessControl,
    Pausable
{
    ...
    function supportsInterface(bytes4 interfaceId)
        public
        view
        override(AccessControl, ERC4907ExtensionURIStorage)
        returns (bool)
    {
    ...
    function mint(address customer, string memory metadataUri)
        external
        payable
        onlyMinter
        whenNotPaused
    ...
    function changeMetadataUri(uint256 tokenId, string memory metadataUri)
        external
        onlyOwner
    {
...
abstract contract ERC4907ExtensionURIStorage is
    Ownable,
    ERC721URIStorage,
    IERC4907
{
