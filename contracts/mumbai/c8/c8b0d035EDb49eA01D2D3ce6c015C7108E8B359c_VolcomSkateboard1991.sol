...
contract VolcomSkateboard1991 is PunchableERC721{
    ...
    uint16 constant maxSkateboards = 10;
    ...
    function mint() external payable {
        require(supply < maxSkateboards, "Max supply reached");
    ...
    *****************************************************************************************/
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        require(_exists(tokenId), "Nonexisten NFT");
        if (!_globalUriEmpty()){
            ...
            //console.log("startingIndex: ", startingIndex);
            uint16 i = uint16((tokenId + startingIndex - 1) % maxSkateboards);
            //console.log("uri: ", uri);
