...
contract RCUBEv2 is ERC20Detailed, Ownable {
    ...
    address public usdtToken = 0x3a93603cEe693674826DF627E1f3fe37b9F8B0c4;
    ...
    constructor() ERC20Detailed("RCUBE2.0", "RCUBE2.0", uint8(DECIMALS)) {
        router = IDEXRouter(0x3eFe4806E5725EB3B48c57D13F845d6e701ACf75);
    ...
    function _swapTokensForusdt(uint256 tokenAmount, address receiver) private {
    ...
    function swapBack() internal swapping {
        ...
        if(amountToRFV > 0){
            _swapTokensForusdt(amountToRFV, riskFreeValueReceiver);
        }
    ...
    event SwapAndLiquifyusdt(uint256 tokensSwapped, uint256 usdtReceived, uint256 tokensIntoLiqudity);
