...
import "../interfaces/IChainlinkUpkeepRegistrar.sol";
import "../interfaces/IChainlinkUpkeepRegistry.sol";
...
contract LoanContract {
    ...
    address public addressChainlinkUpkeepRegistrar;
    ...
    constructor(
        ...
        address _addressChainlinkUpkeepRegistrar
    ) {
        if (
        ...
        addressChainlinkUpkeepRegistrar = _addressChainlinkUpkeepRegistrar;
        uint i;
    ...
    function confirmLoan(
        ...
        chainlinkUpkeepId = IChainlinkUpkeepRegistrar(
            addressChainlinkUpkeepRegistrar
    ...
    function repayPrincipal() internal {
        ...
        if (allowance > (loanAmount / MINIMUM_REPAYMENTAMOUNT_DIVISOR)) {
            ...
            if (newOutstandingAmount == 0) {
                ...
                address addressUpkeepRegistry = getChainlinkUpkeepRegistryAddress();
                IChainlinkUpkeepRegistry(addressUpkeepRegistry).cancelUpkeep(
                    chainlinkUpkeepId
                );
            }
        }
    ...
    function getChainlinkUpkeepRegistryAddress() public view returns (address) {
        if (block.chainid == 80001) {
            return (ADDRESS_UPKEEP_REGISTRY_MUMBAI);
        } else if (block.chainid == 11155111) {
            return (ADDRESS_UPKEEP_REGISTRY_SEPOLIA);
        } else {
            return (address(0));
        }
    }
...
interface IChainlinkUpkeepRegistrar {
...
interface IChainlinkUpkeepRegistry {
