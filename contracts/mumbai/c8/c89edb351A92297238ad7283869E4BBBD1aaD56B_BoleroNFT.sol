...
contract BoleroNFT is ERC721Enumerable, LockRegistry, RoyaltiesWrapper {
    ...
    function getRoyalties(uint256 _tokenID) external view returns (uint256) {
        ...
        return collections[collectionForToken].artistRoyalty;
        ...
        returns (address receiver, uint256 royaltyAmount)
    {
        return (
            rewards2981,
            (value * (royaltiesForBolero + this.getRoyalties(tokenId))) /
                MAXIMUM_PERCENT
        );
    }
