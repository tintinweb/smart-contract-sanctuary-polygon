...
contract theboard { 
    ...
    constructor () { 
        ...
        initPrice  = 10000000000000000; 
        incrIndex  = 125;
        masterFee  = 1;
    } 

    //==========================================================================================================================
    //function getPosition(uint _x, uint _y) private pure returns (uint) { return (uint(_x) * 10000 + uint(_y)); }
    ...
    function getPix(uint _x, uint _y) public view returns(Pixel memory) {
        //if (pixels[_x][_y].price > 0) { return Pixel(pixels[_x][_y].colorurl, pixels[_x][_y].owner, pixels[_x][_y].price); }
        //else { return Pixel("", address(0), 0); }
