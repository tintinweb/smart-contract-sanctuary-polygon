...
contract LALALA is ERC721Enumerable, Ownable, ReentrancyGuard, IERC2981 {
    // attributes
    uint256 immutable public collectionSize = 880;
    uint256 constant public publicPrice = 0.01 ether;
    ...
    function _internalMint(address to, uint256 quantity) private {
        require(
            currentId + quantity <= collectionSize,
            "reached max supply"
        );
