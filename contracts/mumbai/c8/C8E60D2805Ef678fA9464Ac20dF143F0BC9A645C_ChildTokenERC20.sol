...
contract ChildTokenERC20 is TokenERC20 {

    bytes32 public constant DEPOSITOR_ROLE = keccak256("DEPOSITOR_ROLE");

    constructor(string memory name, string memory symbol, address childChainManager) TokenERC20(name, symbol) {
...
contract TokenERC20 is ERC20, Pausable, AccessControl {
