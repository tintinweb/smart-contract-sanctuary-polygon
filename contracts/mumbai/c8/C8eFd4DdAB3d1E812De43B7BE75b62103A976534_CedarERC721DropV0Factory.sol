...
contract CedarERC721DropV0Factory is Ownable, ICedarDeployerEventsV0 {
    ...
    function deploy(
        ...
        newClone.initialize(_defaultAdmin, _name, _symbol, _contractURI, _trustedForwarders, _saleRecipient, _royaltyRecipient, _royaltyBps, _userAgreement, _signatureVerifier, _greenlistManagerAddress);
        ...
        params.greenlistManagerAddress = _greenlistManagerAddress;
