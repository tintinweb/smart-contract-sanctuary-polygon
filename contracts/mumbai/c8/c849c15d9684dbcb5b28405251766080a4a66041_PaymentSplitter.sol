...
contract PaymentSplitter is Context {
    ...
    ///////////////// START modified for large group of payees ///////////////////////
    ...
    function dropTempAdmin() external {
        require(msg.sender == tempAdmin, "PaymentSplitter: only temp admin");
        tempAdmin = address(0);
    }
     ...
     */
    function addPayees(address[] calldata payees, uint256[] calldata shares_) external {
        require(msg.sender == tempAdmin, "PaymentSplitter: only temp admin");
    ...
    ///////////////// END modified for large group of payees ///////////////////////
