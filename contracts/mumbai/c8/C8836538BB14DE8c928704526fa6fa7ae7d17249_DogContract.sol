...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0xeBDe41007712138F3BeD12F889031Cf1D23E282E];
  address public erc20Payable = 0xeBDe41007712138F3BeD12F889031Cf1D23E282E;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 4, 4) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiaddbxwesheqeofzoutmnewltnbqx44neodfmnk44m6bddxd2clbi/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/B7QRieWt1n3JAloL8iZq/contract-metadata";
  }
...
// File: contracts/DogContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DogContract is RamppERC721A {
    constructor() RamppERC721A("DOG", "DOG"){}
}
