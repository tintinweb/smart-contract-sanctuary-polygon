...
interface PollingInterface {
     ...
     * @dev Only owner can call this function.
     * @param pollingId The unique identifier of the poll to be ended.
    ...
    ReentrancyGuardUpgradeable
{
    ...
    function endPoll(
        ...
        require(
            pollingDetails[pollingId].startDate != 0,
        ...
        require(
            block.timestamp >= pollingDetails[pollingId].endDate,
            "Polling: End date of poll is later"
        );

        PollingDetail storage updatePoll = pollingDetails[pollingId];
