    ...
    MinterRole
{
     ...
     */
    function bundleMint(uint256[] memory cardIds, string[] memory _tokenURI, Attributes[] memory traits)
        public
        onlyMinter
        nonReentrant
    {
        ...
        require(
            ...
            "Cards: TokenURIs and Traits amount won't match"
        );

        _batchMint(owner(), cardIds, _tokenURI, traits);
    }
