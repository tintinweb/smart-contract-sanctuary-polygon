...
contract SmartChefFactory is Ownable {
    ...
    function deployPool(
        ...
        require(address(_stakedToken) != address(0), "SmartChefFactory: StakedToken must not be zero");
        require(address(_rewardToken) != address(0), "SmartChefFactory: RewardToken must not be zero");
        require(_stakedToken.totalSupply() >= 0);
        require(_rewardToken.totalSupply() >= 0);
        require(_stakedToken != _rewardToken, "SmartChefFactory: Tokens must be be different");
