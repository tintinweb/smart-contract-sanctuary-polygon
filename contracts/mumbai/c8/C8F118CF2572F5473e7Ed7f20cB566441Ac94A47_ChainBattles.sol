...
contract ChainBattles is ERC721URIStorage {
    ...
    function generateCharacter(uint256 tokenId) public returns(string memory){
        ...
        bytes memory svg = abi.encodePacked(
            ...
            '<text x="50%" y="50%" class="base" dominant-baseline="middle" text-anchor="middle">', "Levels: ",_attributes.levels.toString(),'</text>',
            ...
            '<text x="50%" y="50%" class="base" dominant-baseline="middle" text-anchor="middle">', "Speed: ",_attributes.speed.toString(),'</text>',
            '</svg>'
        );
        return string(
            abi.encodePacked(
