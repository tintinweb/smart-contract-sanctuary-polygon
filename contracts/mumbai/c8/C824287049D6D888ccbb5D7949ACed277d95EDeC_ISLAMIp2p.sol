...
*/  
    ...
    IERC20 ISLAMI = IERC20(0x4Cd922196d3b7f253152a1Ba3eD582F0c3c8b260); //(0x9c891326Fd8b1a713974f73bb604677E1E63396D);
    IERC20 USDT = IERC20(0xFc72D3C5b895601a717d78dAe2Be257e716A1573); //(0xc2132D05D31c914a87C6611C10748AEb04B58e8F);
    IERC20 USDC = IERC20(0x254Eb2Eb0544D250aBA210A838a62FEd548C9723); //(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174);
    ...
    event orderCancelled(address OrderOwner);
...
*/
    ...
    function createOrder(
        ...
        monopoly[msg.sender] = block.timestamp.add(4 days);
    ...
    function takeOrder(address _orderOwner, uint256 _amount) external nonReentrant{
        ...
        _currency.transfer(burn, _p2pFee);
