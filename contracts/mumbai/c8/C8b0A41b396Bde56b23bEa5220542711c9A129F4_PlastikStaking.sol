...
contract PlastikStaking is Ownable, ReentrancyGuard {
    ...
    event UpdatePool(uint256 _pid, uint256 _minDeposit ,uint256 _currentStaking, uint256 _limitStaking);
    ...
    function depositLongTerm(uint256 _pid, uint256 _amount) external nonReentrant {
        ...
        emit UpdatePool(_pid, pool.minDeposit, pool.currentStaking, pool.limitStaking);
