...
//get user total withdrawal amount
    function getUserTotalWithdrawalAmount(address _userAddress) public view returns(uint256){
        return getUserPendingBonusWithdrawalAmount(_userAddress).add(getUserPendingWithdrawalAmount(_userAddress));
    }
    ...
    function withdraw(address _userAddress, uint256 _amount) public {
        ...
        require(getUserTotalWithdrawalAmount(_userAddress) >= _amount,"Withdrawal amount is greater than total withdrawal ");
        require(getUserTotalWithdrawalAmount(_userAddress) >= 10000000,"Withdrawal amount is greater than 10 USDT ");
