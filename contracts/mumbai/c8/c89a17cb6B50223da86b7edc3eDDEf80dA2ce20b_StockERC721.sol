...
contract StockERC721 is ERC721 {
    uint256 private _index;
    uint256 private _usdtValue;
    address private _factoryAddress;
    IERC721TransferProxy private _transferProxy;

    constructor(address factoryAddress, uint256 index_, uint256 usdtValue_) ERC721("NFT-Stock", "NFT-Stock"){
...
contract StockNftFactory is OwnablePausable {
    ...
    mapping(uint256 => StockERC721) public stockTokens;
    ...
    function createERC721(uint256 index, uint256 value) public {
        stockToken = new StockERC721(address(this), index, value);
        stockTokens[index] = stockToken;
    }
