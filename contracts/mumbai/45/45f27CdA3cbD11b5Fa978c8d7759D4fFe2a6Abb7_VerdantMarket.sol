...
library Payment {
    ...
    function calBuyerCommission(
        ...
        if (serviceTaxPercentForBuyer > 0) {
            serviceTaxAmount = (amount * serviceTaxPercentForBuyer) / (10 ** 4);
    ...
    function matchOrder(
        ...
        uint256 _serviceTaxAmountForSeller = (_price *
            _serviceTaxPercentForSeller) / 10000;

        _order.serviceTaxToSeller = _serviceTaxAmountForSeller;
        _order.serviceTaxFromBuyer = _serviceTaxAmountForBuyer;
...
library StructLib {
    struct Order {
        ...
        uint256 serviceTaxFromBuyer;
        uint256 serviceTaxToSeller;
        uint256 expTime;
