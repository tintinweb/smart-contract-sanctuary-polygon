...
contract NatashatiniNFT is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor() ERC721A("Natashatini NFT BP Test","Natashanatini_BPT", MaxMintPerBatch_, TotalCollectionSize_) {
    setURIbeforeReveal("https://gateway.pinata.cloud/ipfs/QmNmqvCbbcA6rTQkxzkEgPQWoXSReCZdqs13S5338bifJg");
