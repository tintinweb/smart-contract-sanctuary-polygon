...
for (uint256 ii=0; ii < 8; ii++) {
    ...
    if ((workingByte >> (7 - ii)) & 1 == 1) {
          rects.appendSafe(abi.encodePacked('<use xlink:href="#tri2" x="',toString((x*25) + (ii*25)),'" y="',
...
if ((workingByte >> (7 - ii)) & 1 == 1) {
          rects.appendSafe(abi.encodePacked('<use xlink:href="#tri" x="' ,toString((x*25) + (ii*25)),'" y="',
              toString(y*50),'" fill="',svgBackgroundColor2[color1]));//'" fill="', svgBackgroundColor2[colorByte]));
  } else {
        if ((colorByte >> (7 - ii)) & 1 == 1) {
          rects.appendSafe(abi.encodePacked('<use xlink:href="#tri" x="' ,toString((x*25) + (ii*25)),'" y="',
