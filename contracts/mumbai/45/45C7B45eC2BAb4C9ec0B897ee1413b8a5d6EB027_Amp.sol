...
contract Amp is ERC1155, ERC2981, Ownable {
    ...
    function createCourseItem(
        ...
        emit CourseItemCreated(_id, msg.sender, address(this), _price, _amount);
        ...
        onlyStudent
    {
        ...
        uint256 tokenId = idToCourses[_id].id;
        require(idToCourses[_id].amount > 0, "Course Sold Out");
