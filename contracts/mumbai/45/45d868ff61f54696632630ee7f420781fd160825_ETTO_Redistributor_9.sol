...
contract ETTO_Redistributor_9 is IERC777Recipient, ReentrancyGuard { 
    ...
    function getRandomNumber4() private view returns (uint256) {
        ...
        bytes32 hash = keccak256(abi.encodePacked(random));
        uint256 randomNumber = uint256(hash) % 910 + 2;
        return randomNumber;
    }
    ...
    function getRandomNumber5() private view returns (uint256) {
        ...
        bytes32 hash = keccak256(abi.encodePacked(random));
        uint256 randomNumber = uint256(hash) % 920 + 2;
        return randomNumber;
    }
    ...
    function getRandomNumber6() private view returns (uint256) {
        ...
        bytes32 hash = keccak256(abi.encodePacked(random));
        uint256 randomNumber = uint256(hash) % 930 + 2;
        return randomNumber;
    }
