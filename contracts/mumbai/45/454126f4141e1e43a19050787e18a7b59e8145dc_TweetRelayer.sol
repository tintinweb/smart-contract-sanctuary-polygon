...
*/
contract TweetRelayer is ITweetRelayer, ChainlinkClient, Ownable {
    ...
    constructor(address linkAddress_, address operatorAddress_, bytes32 readTweetJobId_, bytes32 writeTweetJobId_) Ownable() {
    ...
    */
     ...
     *  Only Owner setters
     */
    function setReadJobId(bytes32 value) public onlyOwner {
        readTweetJobId = value;
    }

    function setWriteJobId(bytes32 value) public onlyOwner {
        writeTweetJobId = value;
    }
}
