...
contract lbtestmv2 is VRFV2WrapperConsumerBase,ConfirmedOwner,ReentrancyGuard {
        ...
        VRFV2WrapperConsumerBase(linkAddress, wrapperAddress) 
    {
        ...
        lottoWeekly = IluckblocksWeekly(0xe4cEC43f385D4a8936944B4D46f0a7C6609Bacea);
        weeklyContract = 0xe4cEC43f385D4a8936944B4D46f0a7C6609Bacea;
    ...
    function swapTokensToUSD(uint256 tokenAmount, address user, uint typeSwap) private {
        ...
        uint256 prevBalance = wmatic.balanceOf(address(this));
        ...
        uint256 nowBalance = wmatic.balanceOf(address(this));
    ...
    function autoSpin(address _caller, uint256[] calldata _nodes) public nonReentrant {
        ...
        require(block.timestamp > lastAutoSpin + 86400,"draw timestamp still not reached.");
         ...
         uint256 botReward = nftnodeBalance;
            ...
            if(getJackpotinUSD() >= minimumPot && registeredsAccts.length >= 15){ 
    ...
    function fulfillRandomWords(uint256 requestId, uint256[] memory _randomWords) internal override {
        ...
        if(userWallet == address(this) || userWallet == address(0) || idInPosition < 5){
