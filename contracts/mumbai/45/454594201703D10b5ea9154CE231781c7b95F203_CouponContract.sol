...
contract CouponContract is ERC721, Ownable{
    ...
    */
    ...
    event Redeemed(address indexed _ad, uint indexed _couponId, uint indexed _tokenId, uint tokenId);
    ...
    // type - String
    string public status_1 = "Coupon is Live";
    string public status_2 = "Coupon Expired";
    string public status_3 = "Coupon not created";
    ...
    function redeemCoupon(address _driverAddress, uint _id) external onlyAdmin{
        ...
        emit Redeemed(_driverAddress, _id, CouponAccepted_Code, idCreate);
    }
