...
contract CryptoTattooerzTokenDirectSale is BaseCryptoTattooerzTokenDirectSale {
    ...
    BaseCryptoTattooerzTokenDirectSale(proxyHubAddress_, priceHandlerAddress_, tokenAddress_,
...
import "cryptotattooerz-utils/contracts/WhitelistUtils.sol";
 ...
 * @author tazous
 */
abstract contract BaseCryptoTattooerzTokenDirectSale is CurrencyHandler, PriceHandlerProxy,
     ...
     */
    function getPriceHandler() internal view override returns(CryptoTattooerzPriceHandler) {
        CryptoTattooerzPriceHandler priceHandler = super.getPriceHandler();
