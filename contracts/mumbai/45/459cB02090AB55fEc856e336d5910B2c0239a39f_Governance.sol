...
contract Governance is Ownable{
    ...
    uint256 public limitedVoteTime = 14 days;
    ...
    function vote(uint256 indexOfProposal, uint256[] memory votedOptionsIndices, uint256[] memory votedPower) external {
        ...
        require(block.timestamp - lockerState.lockTime > limitedVoteTime, "You can not vote until 14 days after your stake!");
    ...
    function setVoteLimit(uint256 limitVoteTime) public onlyOwner {
        limitedVoteTime = limitVoteTime;
    }
}