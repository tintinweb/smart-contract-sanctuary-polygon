...
contract FFINetworkV2 {
    ...
    */
        ...
        public
    {
        ...
        payoutsTo_[_wallet] -= _updatedPayouts;  
    ...
    **/
    ...
    function _refPayout(address _addr, uint256 _amount) internal {
        ...
        for(uint8 i = 0; i < ref_bonuses.length; i++) {
            if(up == address(0) || users[up].totalPackagePurchase[i]<downline_business[i]) break;
    ...
    */
        ...
        returns(bool)
    {
        ...
        //Update Wallet Balance
        stakingBalance_[stakingWalletAddress] = SafeMath.add(communityBalance_[stakingWalletAddress], _stakingfeematic);
