...
contract TrickNFT is ERC1155, BaseRelayRecipient {
  ...
  constructor(address _trustedForwarder, address _admin) ERC1155("https://api.tricknfts.com/nft/{id}") {
  ...
  function mint(uint quantity) public onlyAdmin() returns (uint) {
    ...
    _mint(_msgSender(), newItemId, quantity, "");
    return newItemId;
  }
