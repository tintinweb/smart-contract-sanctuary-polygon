...
/// @custom:security-contact hashkoffee.eth
contract BlockyHopsV1 is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable, EIP712, ERC721Votes {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    uint public maxSupply = 100;
    mapping(address => bool) public userClaimed;
    string public baseUri = "ipfs://QmZEdd7eCbP12xhgknBHnKtS72GPdWvEZ4AuMhpVx4on9A/";

    constructor() ERC721("Blocky Hops V1", "BH1") EIP712("Blocky Hops V1", "1") {
    ...
    function safeMint(address to, string memory uri) public onlyOwner {
     ...
     function publicMint() public {
        uint256 tokenId = _tokenIdCounter.current();
        require(tokenId<maxSupply,"Maximum reached");
        require(!userClaimed[msg.sender],"You already claimed your nft");
