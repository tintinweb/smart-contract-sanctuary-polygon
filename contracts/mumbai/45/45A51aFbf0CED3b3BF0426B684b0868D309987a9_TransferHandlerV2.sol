...
contract TransferHandlerV2 is ERC2771Context, Ownable, Pausable, ReentrancyGuard {
    ...
    function transfer(
        ...
        require(token != address(0), "TransferHandlerV2: E00");
        if (token == nativeToken) {
            require(msg.value == amount && to != address(0), "TransferHandlerV2: E01");
    ...
    function permitEIP2612AndTransfer(
        ...
        require(token != address(0), "TransferHandlerV2: E00");
        require(token != nativeToken, "TransferHandlerV2: E02");
