	...
	function tokenURI(uint256 id) public view override returns (string memory) {
        ...
        bytes memory dataURI = abi.encodePacked(
            '{',
                ...
                '"attributes": [',
                    '"tribe": ', contributors[id].tribeId,
                    '"contributions": ', contributors[id].nrOfContributions,
                    '"projects": ', contributors[id].nrOfProjects,
                ']'
            '}'
        );
    ...
    function generateSvg(uint256 id) internal view returns(string memory) {
        ...
        if (contributors[id].tribeId == 1) {
            svg = abi.encodePacked(
                ...
                '<text fill="#000000" stroke="#000" x="117.39999" y="375" id="svg_5" stroke-width="0" font-size="24" font-family="monospace" text-anchor="start" xml:space="preserve">Contributions: ', contributors[id].nrOfContributions, '</text>'
                '<text fill="#000000" stroke="#000" x="164.2" y="421" id="svg_6" stroke-width="0" font-size="24" font-family="monospace" text-anchor="start" xml:space="preserve">Projects: ', contributors[id].nrOfProjects,'</text>'
                '</g>'
                '<defs>'
        ...
        // Lunarpunk
            ...
            svg = abi.encodePacked(
                ...
                '<text transform="matrix(1, 0, 0, 1, 0, 0)" style="cursor: move;" xml:space="preserve" text-anchor="start" font-family="monospace" font-size="24" stroke-width="0" id="svg_5" y="375" x="117.39999" stroke="#000" fill="#000000">Contributions: ', contributors[id].nrOfContributions, '</text>'
                '<text transform="matrix(1, 0, 0, 1, 0, 0)" xml:space="preserve" text-anchor="start" font-family="monospace" font-size="24" stroke-width="0" id="svg_6" y="421" x="164.2" stroke="#000" fill="#000000">Projects: ', contributors[id].nrOfProjects,'</text>'
                '</g>'
                '<defs>'
