...
import "../../utils/ERC721Claimable/ERC721ClaimableV3.sol";
import "@openzeppelin/contracts/token/ERC20/IERC20.sol";
import "../../utils/interfaces/IERC20Fixed.sol";

contract UniqERC721 is ERC721ClaimableV3 {
    modifier adminOrUPP() {
        require(
            msg.sender == administrator || msg.sender == paymentProxy,
            "Only admin or proxy allowed"
        );
        _;
    }
    ...
    event MintTokens(
        address indexed resquester,
        bytes indexed transactionHash,
    ...
    constructor(
        ...
        address _owner
    ) ERC721ClaimableV3(_name, _symbol, _ttokenUri) {
    ...
    function editTokenUri(string memory _ttokenUri) external adminOrUPP{
        _editTokenUri(_ttokenUri);
    }
    ...
    function mintNFTTokens(
        ...
        require(
            !_isHashUsed[_chainId][_transactionHash],
            "Cant be minted twice"
        );
...
abstract contract ERC721ClaimableV3 is
    ContextMixin,
    ERC721Enumerable,
    ...
    Ownable
{
    ...
    function _editTokenUri(string memory _ttokenUri) internal {
