...
contract Marketplace is ReentrancyGuard, AccessControl {
    ...
    function makeItem(
        ...
        items[_tokenId] = Item(_tokenId, _nft, _price, payable(msg.sender));
        // emit Offered event
        emit offeredSingle(
            itemCount,
            address(_nft),
        ...
        accessRole
    {
        ...
        for (uint256 i = 0; i < _tokenIDs.length; i++) {
            ...
            item.nft.safeTransferFrom(msg.sender, _to, _tokenIDs[i]);
        }
    ...
    function transferNft(address _to, uint256 _tokenID) public accessRole {
        ...
        item.nft.safeTransferFrom(msg.sender, _to, _tokenID);
