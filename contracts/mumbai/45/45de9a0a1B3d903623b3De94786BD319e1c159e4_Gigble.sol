...
contract Gigble {
    ...
    event TransferToLockinBlockChain(address client,  address platformAddress, uint256 budget, string email, string title, string description,  uint256 deadline, string keyword );
    ...
    function createProject(
        ...
        emit TransferToLockinBlockChain(project.client, platformAddress, project.budget, project.email, project.title, project.description, project.deadline, project.keyword);
