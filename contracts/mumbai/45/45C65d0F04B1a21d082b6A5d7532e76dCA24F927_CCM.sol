...
contract CCM is Initializable, UUPSUpgradeable, ReentrancyGuardUpgradeable, NonblockingLzApp, PausableUpgradeable, AdminProxyManager {
    address public targetSale;
    uint256 public srcInvoiceIndex;
    uint128 public amountIn;
	...
	function _nonblockingLzReceive(
        ...
        (targetSale, srcInvoiceIndex, amountIn, buyer) = abi.decode(_payload, (address, uint256, uint128, address));
