...
contract CatAttackNFT is ERC1155LazyMint {
    ...
    function attack(address victim) external gameNotPaused {
        ...
        if(balanceOf[victim][0] > 0) {
            ...
            tokenToBurn = 19;
        } else if(balanceOf[victim][20] > 0) {
            tokenToBurn = 20;
        } else {
            revert("Victim has no Betta!");
        }
        // burn it
        ...
        emit Miaowed(msg.sender, victim, tokenToBurn + 1);
            ...
            _mint(attacker, 6, 1, "");
            emit Miaowed(msg.sender, victim, tokenToBurn + 1);
        } else if(balanceOf[attacker][6] > 0 && balanceOf[attacker][6] < 10) {
            _mint(attacker, 7, 1, "");
             emit Miaowed(msg.sender, victim, tokenToBurn + 1);
            } else if(balanceOf[attacker][6] > 9) {
            _mint(attacker, 7, 2, "");
            emit Miaowed(msg.sender, victim, tokenToBurn + 1);
        } else if(balanceOf[attacker][7] > 0 && balanceOf[attacker][7] < 10) {
            _mint(attacker, 8, 1, "");
            emit Miaowed(msg.sender, victim, tokenToBurn + 1);
            } else if(balanceOf[attacker][7] > 9) {
            _mint(attacker, 8, 2, "");
            emit Miaowed(msg.sender, victim, tokenToBurn + 1);
        } else if(balanceOf[attacker][8] > 0 && balanceOf[attacker][8] < 10) {
            _mint(attacker, 9, 1, "");
            emit Miaowed(msg.sender, victim, tokenToBurn + 1);
            } else if(balanceOf[attacker][8] > 9) {
            _mint(attacker, 9, 2, "");
            emit Miaowed(msg.sender, victim, tokenToBurn + 1);
        } else if(balanceOf[attacker][9] > 0 && balanceOf[attacker][9] < 10) {
            _mint(attacker, 10, 1, "");
            emit Miaowed(msg.sender, victim, tokenToBurn + 1);
            } else if(balanceOf[attacker][9] > 9) {
            _mint(attacker, 10, 2, "");
            emit Miaowed(msg.sender, victim, tokenToBurn + 1);
        } else if(balanceOf[attacker][10] > 0 && balanceOf[attacker][10] < 10) {
            _mint(attacker, 11, 1, "");
            emit Miaowed(msg.sender, victim, tokenToBurn + 1);
            } else if(balanceOf[attacker][10] > 9) {
            _mint(attacker, 11, 2, "");
            emit Miaowed(msg.sender, victim, tokenToBurn + 1);
        } else if(balanceOf[attacker][11] > 0 && balanceOf[attacker][11] < 10) {
            _mint(attacker, 12, 1, "");
            emit Miaowed(msg.sender, victim, tokenToBurn + 1);
             } else if(balanceOf[attacker][11] > 9) {
            _mint(attacker, 12, 3, "");
            emit Miaowed(msg.sender, victim, tokenToBurn + 1);
        } else if(balanceOf[attacker][12] > 0 && balanceOf[attacker][12] < 10) {
            _mint(attacker, 13, 1, "");
            emit Miaowed(msg.sender, victim, tokenToBurn + 1);
            } else if(balanceOf[attacker][12] > 9) {
            _mint(attacker, 13, 3, "");
            emit Miaowed(msg.sender, victim, tokenToBurn + 1);
        } else if(balanceOf[attacker][13] > 0 && balanceOf[attacker][13] < 10) {
            _mint(attacker, 14, 1, "");
            emit Miaowed(msg.sender, victim, tokenToBurn + 1);
             } else if(balanceOf[attacker][13] > 9) {
            _mint(attacker, 14, 3, "");
            emit Miaowed(msg.sender, victim, tokenToBurn + 1);
        } else if(balanceOf[attacker][14] > 0 && balanceOf[attacker][14] < 10) {
            _mint(attacker, 15, 1, "");
            emit Miaowed(msg.sender, victim, tokenToBurn + 1);
             } else if(balanceOf[attacker][14] > 9) {
            _mint(attacker, 15, 3, "");
            emit Miaowed(msg.sender, victim, tokenToBurn + 1);
        } else if(balanceOf[attacker][15] > 0 && balanceOf[attacker][15] < 10) {
            _mint(attacker, 16, 1, "");
            emit Miaowed(msg.sender, victim, tokenToBurn + 1);
             } else if(balanceOf[attacker][15] > 9) {
            _mint(attacker, 16, 3, "");
            emit Miaowed(msg.sender, victim, tokenToBurn + 1);
        } else if(balanceOf[attacker][16] > 0 && balanceOf[attacker][16] < 10) {
            _mint(attacker, 17, 1, "");
            emit Miaowed(msg.sender, victim, tokenToBurn + 1);
            } else if(balanceOf[attacker][16] > 9) {
            _mint(attacker, 17, 3, "");
            emit Miaowed(msg.sender, victim, tokenToBurn + 1);
        } else if(balanceOf[attacker][17] > 0 && balanceOf[attacker][17] < 10) {
            _mint(attacker, 18, 1, "");
            emit Miaowed(msg.sender, victim, tokenToBurn + 1);
            } else if(balanceOf[attacker][17] > 9) {
            _mint(attacker, 18, 3, "");
            emit Miaowed(msg.sender, victim, tokenToBurn + 1);
        } else if(balanceOf[attacker][18] > 0 && balanceOf[attacker][18] < 10) {
            _mint(attacker, 19, 1, "");
            emit Miaowed(msg.sender, victim, tokenToBurn + 1);
             } else if(balanceOf[attacker][18] > 9) {
            _mint(attacker, 19, 4, "");
            emit Miaowed(msg.sender, victim, tokenToBurn + 1);
            if(balanceOf[victim][18] > 0) {
            tokenToBurn = 18;
        }
        } else if(balanceOf[attacker][19] > 0 && balanceOf[attacker][19] < 10) {
            _mint(attacker, 20, 1, "");
            emit Miaowed(msg.sender, victim, tokenToBurn + 1);
            } else if(balanceOf[attacker][19] > 9) {
            _mint(attacker, 20, 4, "");
            emit Miaowed(msg.sender, victim, tokenToBurn + 1);
            if(balanceOf[victim][19] > 0) {
            tokenToBurn = 19;
        }
        } else if(balanceOf[attacker][20] > 0 && balanceOf[attacker][20] < 10) {
            _mint(attacker, 20, 1, "");
            emit Miaowed(msg.sender, victim, tokenToBurn + 1);
            } else if(balanceOf[attacker][20] > 9) {
            _mint(attacker, 20, 4, "");
             _mint(attacker, 1, 1, "");
            emit Miaowed(msg.sender, victim, tokenToBurn + 1);
            if(balanceOf[victim][20] > 0) {
            tokenToBurn = 20;
        }
        }
