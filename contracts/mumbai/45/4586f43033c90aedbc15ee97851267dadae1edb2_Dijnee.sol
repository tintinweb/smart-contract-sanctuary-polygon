...
contract Dijnee is ERC721Enumerable, Ownable {
 ...
 mapping(uint256 => _bidDetail) public bidDetail;
  ...
  function walletOfOwner(address _owner) public view returns (uint256[] memory){
    ...
    function Mint(address user, uint256 tokenId,uint256 salePrice, uint256 royalty,SellType sellType) external returns(uint256){       
        require(!paused, "the contract is paused");
        require(
        ...
        tokenDetails[tokenId] = _tokenDetails(msg.sender,user,royalty,salePrice,sellType,true,true);
        return tokenId;
    }
