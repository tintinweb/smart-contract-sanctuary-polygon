...
contract ChainBattles is ERC721URIStorage, RandomNumber {
    ...
    function mint() public {
        ...
        tokenIdToLevels[newItemId].speed = createRandom(10);
        tokenIdToLevels[newItemId].strength = createRandom(20);
        tokenIdToLevels[newItemId].life = createRandom(10);
    ...
    function train(uint256 tokenId) public {
        ...
        require(ownerOf(tokenId) == _msgSender(), "You must own this token to train it");
