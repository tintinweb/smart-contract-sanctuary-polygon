...
contract Credentials is Ownable {
    ...
    event CredentialIssued(uint256 _credentialId, address _issuer, string _cert_material);
    ...
    function issueCredential(string memory _cert_material)
        public
        onlyListedIssuer
    {
        ...
        emit CredentialIssued(_credentialId, msg.sender, _cert_material);
    }
    ...
    function getNextCredentialId() public view returns(uint256) {
        return credentialId;
    }
}
