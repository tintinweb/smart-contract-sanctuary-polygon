...
contract MyCollection2 is ERC721A, Ownable {
    ...
    constructor(
    ...
    ) ERC721A("NAME of Token", "SPDM symbol of token", 10, 3000) {
        ...
        maxNFTs = 3000;
        publicSalePrice = 5000000000000000; // 0.005
