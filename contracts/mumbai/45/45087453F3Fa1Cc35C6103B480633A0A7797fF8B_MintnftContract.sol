...
//*********************************************************************//
//
//    __  ________  _________  ____________
//   /  |/  /  _/ |/ /_  __/ |/ / __/_  __/
//  / /|_/ // //    / / / /    / _/  / /   
...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x5182571500Bf61B57Ac43faB3B54E0B3Ac084628];
...
// File: contracts/MintnftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract MintnftContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/2y1tOYAN5s35zltBH4AW/contract-metadata";
  }
