...
contract ARAB is ERC20 {
    ...
    constructor() ERC20("Arab Coin", "ARAB") {
        _mintprice =(10**16);
        setmaxSupply(100000000 * (10**18));
    ...
    function setMintPrice (uint price) external virtual onlyOwner {
        _mintprice = price;
    }

    function getMintEarnings()external virtual view onlyOwner returns(uint256) {
        return mintEarnings;
    }
    ...
    function paybackburn(uint256 amount_) external payable noRentrancy {
        ...
        _burn(msg.sender,amount_ * (10**18));
