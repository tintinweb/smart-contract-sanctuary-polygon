...
contract ChainBattles is ERC721URIStorage {
    ...
    // // TODO: create a struct and use on mappings
    struct Stats {
        uint256 level;
        uint256 speed;
        uint256 strength;
    ...
    // TODO: Generate a pseudo random number for different stats on _mint
    function randomNbr(uint256 number) public view returns (uint256) {
        return
            uint256(
                keccak256(
                    abi.encodePacked(
    ...
    // TODO: Increment stats using a pseudo random number
