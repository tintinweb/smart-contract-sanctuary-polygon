...
contract AirDrop1 is ERC721A {
    // address payable public target1 = payable(0x488A8CA56f29BFbe28e6f4cf898D5c3C1455deDa);
    // address payable public target2 = payable(0x488A8CA56f29BFbe28e6f4cf898D5c3C1455deDa);
...
using SafeMath for uint;
 modifier onlyOwner {
    ...
    // uint256 public preSaleCost = 0.001 ether;
     string public baseURI="https://gateway.pinata.cloud/ipfs/QmQ6mbwcak5hsy7WwukbfFyUgZdjx38DFRhHXGquXgve8D/";
  string public baseExtension = ".json";
//   mapping(address => bool) public whitelisted;
// bool public reveal= false;
string public revealURI="https://gateway.pinata.cloud/ipfs/Qmch5v4XuNu6BpKuchYGiL2iVmAZw7gCSWpo7DV47PeGcZ";
...
//   function updateAddress (address payable addr1,address payable addr2)public{
//       target1= addr1;
//       target2=addr2;
//   }
...
// }
    ...
    // }
    // AirDrop
    function airDrop(address[] calldata _to, uint256[] calldata _id) public payable{
...
//           }
          ...
          count.increment();
// airDrop(_to[i], uint256[] calldata _id)
        //  for(uint256 i=0;i<totalSupply()-count.current();i++){
        //      if(ownerOf(_id[count.current()])!=owner)
        //      {count.increment();}
        //  }
        // //  uint temp=i;
       
        // safeTransferFrom(owner, _to[i], _id[count.current()]);
        //   count.increment();
...
// cost=_cost;
// }
// function setPreSaleCost(uint _preSaleCost) public{
