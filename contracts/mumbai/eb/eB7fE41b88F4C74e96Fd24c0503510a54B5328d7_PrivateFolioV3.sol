...
interface IFolioFactory {
    ...
    function checkValidFolio(address folio) external view returns(bool);

    function checkApprovedModule(address module) external view returns(bool);
...
import "./interfaces/IFolioFactory.sol";
import "./utils/ERC6551Account.sol";

contract PrivateFolioV3 is Initializable, ERC6551Account {
    ...
    function delegateCall(
        ...
        require(IFolioFactory(_factory).checkApprovedModule(_target), "ERR: NON AUTHORIZED MODULE");
