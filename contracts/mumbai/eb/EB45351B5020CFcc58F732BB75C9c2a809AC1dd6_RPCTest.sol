...
contract RPCTest is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public MAX_MINT = 20; // This actually means 1 mints but we say 2 for minor gas saving
    ...
    constructor(string memory _cURI, string memory _metaBURI, address _developer, address _treasury) public ERC721A ("RPC", "RPCTest") {
        _contractURI = _cURI;
