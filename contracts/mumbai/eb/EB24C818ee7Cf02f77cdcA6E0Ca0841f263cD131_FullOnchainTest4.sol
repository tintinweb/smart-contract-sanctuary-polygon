...
contract  FullOnchainTest4 is ERC721Enumerable, ERC721Permit("FullOnchainTest4NFT:Token"), ERC721Mintable, ReentrancyGuard, Ownable {
    ...
    uint[maxNumber] private tokenIds ;
    uint16 counter = 1;

    constructor() ERC721("FullOnchainTest4NFT:Token", "FULL TEST") Ownable() {}


    function setInfo(string memory _letter, uint256 _tokenId) public onlyOwner {
        require(counter < maxNumber, "the aray is full");
        require(vacantLetter(_letter), "the letter is used");
        letters[counter] = _letter;
        fontColors[counter] = "pink";
        backgroundColors[counter] = "blue";
