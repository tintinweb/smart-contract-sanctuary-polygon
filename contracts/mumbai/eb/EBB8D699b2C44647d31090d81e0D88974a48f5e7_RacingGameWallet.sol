...
contract RacingGameWallet is ERC721Drop {
    ...
    function createRaceLobby(
        ...
        require(_entryFee == msg.value, "You must also pay the entry fee!");
        ...
        RaceLobby memory newRaceLobby = RaceLobby({
            creator: msg.sender,
            entryFee: _entryFee,
            readyPlayers: new address[](0),
            joinedPlayers: new address[](1),
            isStarted: false,
        ...
        newRaceLobby.joinedPlayers[0] = msg.sender;
