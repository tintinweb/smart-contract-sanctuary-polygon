...
//*********************************************************************//
//
// Cryptocanna - The first cannabis database on the blockchain.
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x96f9Ff5fccFC09637C9405EB286d1b4f26A3E973];
  address public erc20Payable = 0x96f9Ff5fccFC09637C9405EB286d1b4f26A3E973;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeihfisgbc47jgrvixzhdbj5fvs7v76rbfqg5thgrcpty6hjesk5wwq/";
...
// File: contracts/CryptocannaTeste1Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CryptocannaTeste1Contract is RamppERC721A {
    constructor() RamppERC721A("Cryptocanna Teste 1", "CCanna"){}
}
