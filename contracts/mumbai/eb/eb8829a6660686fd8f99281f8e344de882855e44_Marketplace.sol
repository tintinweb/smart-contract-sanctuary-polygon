    ...
    IERC1155ReceiverUpgradeable
{
    ...
    IRSFee public immutable rarescapeFee;
    ...
    constructor(address _nativeTokenWrapper, address _rarescapeFee) initializer {
    ...
    function payout(
        ...
        (address rsFeeRecipient, uint256 rsFeeBps) = rarescapeFee.getFeeInfo(address(this), FeeType.MARKET_SALE);
        uint256 rsFeeCut = (_totalPayoutAmount * rsFeeBps) / MAX_BPS;
        ...
        try IERC2981Upgradeable(_listing.assetContract).royaltyInfo(_listing.tokenId, _totalPayoutAmount) returns (
            ...
            if (royaltyFeeRecipient != address(0) && royaltyFeeAmount > 0) {
                require(royaltyFeeAmount + platformFeeCut + rsFeeCut <= _totalPayoutAmount, "fees exceed the price");
        ...
        CurrencyTransferLib.transferCurrencyWithWrapper(
            ...
            _payer,
            _payee,
            _totalPayoutAmount - (platformFeeCut + royaltyCut + rsFeeCut),
            _nativeTokenWrapper
        );
    }
