 ...
 */
 ...
 // TODO change thelock period in initialize function;
...
contract Staking is IStaking, Initializable {
    ...
    uint256 public MaticFeeLockLevel = 1;
    bool public noLock;
    ...
    */
    ...
    emit UserStakeDetails(msg.sender, _level, _amount,_duration);
    }
    ...
    function unstake() external override {
        ...
        emit UserUnstakeDetails(msg.sender, amount);
    }
    ...
    */
    ...
    function _takeMaticFee(uint256 _amount, uint256 _maticValue) internal {
        ...
        console.log("value in Matic from staking",valueInMatic );
