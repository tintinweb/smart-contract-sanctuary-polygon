...
contract USDCToken is CheckContract, IUSDCToken {
    using SafeMath for uint256;
    
    uint256 private _totalSupply;
    string constant internal _NAME = "USDC Stablecoin";
    string constant internal _SYMBOL = "USDC";
    ...
    function transferFrom(address sender, address recipient, uint256 amount) external override returns (bool) {
        ...
        _approve(sender, msg.sender, _allowances[sender][msg.sender].sub(amount, "USDCToken: transfer amount exceeds allowance"));
        return true;
    }
