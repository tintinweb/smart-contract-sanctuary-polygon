...
contract _0xBitcoinToken is ERC20Interface, Owned {
    ...
    function testDouble() public {
        ...
        function mintFree(uint nonce, bool challenge_digest) public returns (bool success) {
    ...
    function _startNewMiningEpoch() internal {
      ...
      bytes32 solution = solutionForChallenge[challengeNumber];
      if(solution != 0x0) revert();  //prevent double challenges
    ...
    function getChallengeNumber2() public view returns (bytes32) {
