...
contract YieldFarmMusk {
    ...
    uint public constant NR_OF_EPOCHS = 1000;
    ...
    // constructor
    constructor(address muskTokenAddress, address stakeContract, address communityVault) public {
        _musk = IERC20(muskTokenAddress);
        _poolTokenAddress = muskTokenAddress;
    ...
    function harvest (uint128 epochId) external returns (uint){
        ...
        require(epochId <= NR_OF_EPOCHS, "Maximum number of epochs is 1000");
