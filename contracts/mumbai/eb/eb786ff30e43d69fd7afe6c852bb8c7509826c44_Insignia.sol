...
contract Insignia is ERC20, ERC20Burnable, Pausable, AccessControl, ERC20FlashMint {
    ...
    function mint(address to, uint256 amount) public onlyRole(MINTER_ROLE) {
        require((_totalSupply+amount)<=MAXSUPPLY,"The maximum supply has been reached");
