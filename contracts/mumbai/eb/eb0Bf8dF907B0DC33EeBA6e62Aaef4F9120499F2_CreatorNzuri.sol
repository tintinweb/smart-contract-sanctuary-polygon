...
contract CreatorNzuri is Ownable {
    ...
    function createContracts(
        ...
        ERC721Nzuri erc721Contract = ERC721Nzuri(erc721ContractAddress);
        ERC1155Nzuri erc1155Contract = ERC1155Nzuri(erc1155ContractAddress);
        ExchangeNzuri exchangeContract = ExchangeNzuri(exchangeContractAddress);
        AuctionFactoryNzuri auctionFactoryContract = AuctionFactoryNzuri(auctionFactoryContractAddress);
...
contract ExchangeNzuri is Ownable {
	struct ERC1155Offer {
		uint tokenId;
		uint quantity;
		uint price;
...
contract AuctionFactoryNzuri is Ownable {
