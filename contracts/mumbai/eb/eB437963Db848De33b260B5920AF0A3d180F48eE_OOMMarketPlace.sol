...
//** Author ishanshahzad :  Marketplace) Contract 2022.5 */
...
contract OOMMarketPlace is OOMContractBase {
    constructor(
        ...
        IMRConfig _mrConfig
    ) OOMContractBase(_owner, _nftWhiteList, _mrConfig) {}
...
abstract contract OOMContractBase is Ownable, ReentrancyGuard, IERC721Receiver {
    ...
    constructor(address _owner, INftWhiteList _nftWhiteList, IMRConfig _mrConfig) {
