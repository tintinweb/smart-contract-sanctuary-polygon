...
import "./OwnEnterosportsNFT721.sol";
...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new EnterosportsNFTUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        EnterosportsNFTUser721Token token = EnterosportsNFTUser721Token(address(addr));
...
contract EnterosportsNFTUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
