...
contract ListingTransactionContract is Ownable, ReentrancyGuard, ERC2771ContextLocal{
    ...
    function createListing (
        string memory _listingCID, 
        string memory _creativeCID, 
        ...
        uint256 tokenId = artListingNFT.safeMint(newID, _msgSender(),_listingCID); // Use the new unique ID as the token ID
    ...
    function updateListing(
        ...
        require(_msgSender() == listing.owner,"You have to be listing's owner to be able to update listing !");
        ListingDetails memory _listingInfo = ListingDetails(
                                                _listingId, 
                                                _listingCID, 
                                                _creativeCID, 
