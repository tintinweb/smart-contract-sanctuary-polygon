	...
	WithSaleStart
{
	...
	// Constant
	uint256 private constant SALE_START_TIMESTAMP = 1659689400;
    ...
    uint256 private ALLOWED_TOKEN_COUNT = 10;

	// maximum mint count per transaction
	uint256 public constant MAX_MINT_COUNT = 5;

	// merkle root generated by MerkleTree
	bytes32 private constant WHITELIST_MERKLE_ROOT = 0xecf96566abbdff297e7d40d7d0e7d48ac529c01e5ec2e4efee7bc4a089ea0c0d;

	/// @dev Base token URI used as a prefix by tokenURI().
	string public baseTokenURI;

	/// take note which wallet address already claim.
	mapping(address => bool) claimAddress;


	constructor(string memory _baseTokenURI)
		ERC721("SwampVerse NFT", "CREATURE")
		RandomlyAssigned(MAX_SUPPLY, 1)
		WithSaleStart(SALE_START_TIMESTAMP)
	{
		...
		afterSaleStart
	{
		...
		require(
			MerkleProof.verify(_proof, WHITELIST_MERKLE_ROOT, leaf),
			"Not on whitelist."
		);
		require(
			numberOfTokens <= MAX_MINT_COUNT,
			"Exceeding maximum mint limit."
		);
		require(
