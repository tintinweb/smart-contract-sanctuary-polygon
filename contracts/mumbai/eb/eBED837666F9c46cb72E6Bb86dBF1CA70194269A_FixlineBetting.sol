    ...
    function sendRewardsToStackingContract(
        ...
        if (
            ...
            if (
                ...
                uint amountForCapsStacking=((((amountOut * 1e18) /(totalRewardToSendInFixlineStackingContract + totalPendingStableCoinsToSwapForFixlineStackingContract)) * totalPendingStableCoinsToSwapForCapsStackingContract) /
                    1e18);
