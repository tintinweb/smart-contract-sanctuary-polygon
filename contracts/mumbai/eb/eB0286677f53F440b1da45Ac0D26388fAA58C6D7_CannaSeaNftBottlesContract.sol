...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1686761940;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x78014Ec7979e6931eD111Ee53589a6f9a60E6715,0xAfE5B0813e1725389b5B3e47b44C3E201456cFEc];
  address public erc20Payable = 0x78014Ec7979e6931eD111Ee53589a6f9a60E6715;
...
abstract contract EarlyMintIncentive is Teams, ERC721A, ProviderFees {
  ...
  uint256 public EARLY_MINT_PRICE = 170 ether;
    ...
    , TimedDrop
{
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/AwYUymShzAHe1BzoUYvH/contract-metadata";
  }
...
// File: contracts/CannaSeaNftBottlesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CannaSeaNftBottlesContract is ERC721APlus {
    constructor() ERC721APlus("CannaSeaNFT Bottles", "CSEA"){}
}
