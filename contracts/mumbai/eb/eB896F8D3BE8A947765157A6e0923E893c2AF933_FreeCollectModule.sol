...
contract FreeCollectModule is FollowValidationModuleBase, ICollectModule {
    ...
    mapping(uint256 => mapping(uint256 => bool))
        internal _followerOnlyByPublicationByProfile;
    ...
    function initializePublicationCollectModule(
        ...
        if (followerOnly)
            _followerOnlyByPublicationByProfile[profileId][pubId] = true;
        return data;
    }
...
abstract contract FollowValidationModuleBase is ModuleBase {
     ...
     */
    function _checkFollowValidity(uint256 profileId, address user)
        internal
        view
    {
        ...
        if (followModule != address(0)) {
            ...
            address followNFT = ILensHub(HUB).getFollowNFT(
