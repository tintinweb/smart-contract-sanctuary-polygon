...
contract UltiBetsLeaderBoard is CustomAdmin, ReentrancyGuard {
    ...
    function isInfluencer(address _bettor) external view returns (bool) {
        return isOnLeaderboard[_bettor];
    }
