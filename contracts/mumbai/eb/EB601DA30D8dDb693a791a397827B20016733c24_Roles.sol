...
contract Roles {
     ...
     */
    function addVerifiedUser(address newVerifiedUser) public virtual onlyModerators {
     ...
     * @dev Only moderators and admins can execute this function
     */
    function removeVerifiedUser(address oldVerifiedUser) public virtual onlyModerators {
