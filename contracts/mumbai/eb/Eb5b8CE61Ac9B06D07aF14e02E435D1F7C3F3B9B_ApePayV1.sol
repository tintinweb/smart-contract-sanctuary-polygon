...
contract ApePayV1 is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function verifyRecipient(
        ...
        bytes32 digest = _hashTypedDataV4(keccak256(abi.encode(
            keccak256("Payment(bytes32 paymentId,string recipient,address tokenAddress,uint256 amount,uint128 nonce)"),
            paymentId,
    ...
    function receivePayment(
        ...
        _receivePayment(paymentId, recipient, tokenAddress, amount, nonce_, signature, msg.sender);
    }
    ...
    function receivePaymentDelegate(
        ...
        _receivePayment(paymentId, recipient, tokenAddress, amount, nonce_, senderSignature, recipientAddress);
    }
    ...
    function _receivePayment(
        ...
        PaymentDetail memory paymentDetail = verifyRecipient(paymentId, recipient, tokenAddress, amount, nonce_, signature);
        // send fund
