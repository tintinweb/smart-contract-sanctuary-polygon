...
contract SOLTIES4 is ERC721, ERC721URIStorage, Ownable, ERC2981, ContextMixin {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdCounter;
    string public contractURI;

    constructor() ERC721("SOLTIES4", "SOL4") {}
    ...
    /**
    * Set contractURI for OS (collection info, royalties, ...)
    */
    ...
    /**
    * Override isApprovedForAll to auto-approve OS's proxy contract. Gass-less listing
    */
