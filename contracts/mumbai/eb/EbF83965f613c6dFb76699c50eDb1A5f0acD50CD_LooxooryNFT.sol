...
contract LooxooryNFT is ERC721URIStorage, EIP712, AccessControl, Ownable {
    ...
    mapping(bytes=>uint256) public usedVouchers;
        ...
        returns (uint256)
    {
        ...
        require( usedVouchers[voucher.signature]!=1,"Voucher already used");
        usedVouchers[voucher.signature] = 1;
        ...
        _transfer(signer, redeemer, currentTokenId);
