...
contract ComplianceProvider_Covest is Initializable, UUPSUpgradeable, ReentrancyGuardUpgradeable {
	 ...
	 *  - `msg.sender` Must be a ComplianceProvider.
	...
	/**
	 * @notice Get balanceOfComplianceProvider.
	 * @param _user The user address.
     * @param _asset The asset address.
	 * @return The uint256 value of balanceOfComplianceProvider of the user with asset.
	 */
	function balanceOfComplianceProvider(address _user, address _asset) public view returns (uint256) {
		return valueOfCP[_asset][_user];
	}

    /**
	 * @notice Get whoIsComplianceProvider.
	 * @return The address of the ComplianceProvider.
     * @return The signature of the ComplianceProvider.
	 */
