    ...
    ReentrancyGuard
{
    ...
    constructor(address manager_) ERC721("GoldNumber", "luckynumber.gg")
    {
    ...
    function setResult(uint256 randomWords) external onlyManager
    {
    ...
    function init(
        ...
        uint finishTime_, 
        uint256 price_, 
        address token_) external onlyManager
    {
    ...
    function claimReward() external onlyOneBlock nonReentrant
    {
        ...
        */
        ...
        require(IERC20(token).transfer(winner, IERC20(token).balanceOf(address(this))), "error transfer"); 
    }
    /// @notice close raffle
    ...
    function _mint(uint itemId, string memory _tokenURI) private
    {
