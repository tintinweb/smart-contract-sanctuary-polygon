...
contract ConditionalTokens is IConditionalTokens, ERC1155 {
    ...
    // The constructor argument here should be a URI for a json describing the metadata of these tokens
    ...
    function redeemPositions(
        ...
        if (totalPayout == 0) revert PositionsAlreadyRedeemOrNonexistent();

        bool success = collateralToken.transfer(msg.sender, totalPayout);
        if (!success) revert TransferFailed();
