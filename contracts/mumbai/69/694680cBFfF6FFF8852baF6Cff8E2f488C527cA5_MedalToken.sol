...
mapping(uint256 => uint8) tokenLevels;
...
/**
   ...
   */ 
  constructor(
        ) ERC721("medalToken","NFTMedal") public 
  {
  ...
  /**
    ...
    function mint(address to, uint256 tokenId) public override {
        ...
        _mintToken(to, tokenId,1);
    } 

    function mintNFT(address to, uint256 tokenId,uint8 level) public  override{
        require(hasRole(MINTER_ROLE, _msgSender()), "ERC721PresetMinterPauserAutoId: must have minter role to mint");
        //_safeMint(to, tokenId);
        //tokenLevels[tokenId] = level;
        _mintToken(to, tokenId,level);
    }

    function _mintToken(address to, uint256 tokenId,uint8 level) internal{
        _safeMint(to, tokenId);
        tokenLevels[tokenId] = level;
    }

    function getLevel(uint256 tokenId)  public view override returns (uint8){
