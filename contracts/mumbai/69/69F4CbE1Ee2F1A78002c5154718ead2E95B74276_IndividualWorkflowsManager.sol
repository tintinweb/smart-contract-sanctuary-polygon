...
contract IndividualWorkflowsManager {
    ...
    function getLimitOrderMeta(address addr) external view returns (LimitOrderWorkflow) {
        return limitOrderMeta[addr];
    }

    function getAddLiquidityMeta(address addr) external view returns (AddLiquidityWorkflow) {
        return addLiquidityMeta[addr];
    }

    function getRemoveLiquidityMeta(address addr) external view returns (RemoveLiquidityWorkflow) {
        return removeLiquidityMeta[addr];
    }
