    ...
    ERC721Pausable
{
    ...
    constructor(
        ...
        string memory base_TokenURI
    ) ERC721(name, symbol) {
        _baseTokenURI = base_TokenURI;
    ...
    function baseTokenURI() internal view virtual override returns (string memory) {
