...
contract BatchMintMetadata {
    ...
    function _getBaseURI(uint256 _tokenId) internal view virtual returns (string memory) {
        uint256 numOfTokenBatches = getBaseURICount();
        uint256[] memory indices = batchIds;
    ...
    function _setBaseURI(uint256 _batchId, string memory _baseURI) internal virtual {
...
contract DynamicPass is ERC1155Drop {
    ...
    function _getBaseURI(uint256 _batchId) internal view virtual override returns (string memory) {
        return baseURI[_batchId];
    }
