...
contract SoulboundNFTKey is ERC721, ERC721URIStorage, EIP712, Ownable, ReentrancyGuard, ERC721Votes {
    ...
    constructor(string memory tokenName, string memory symbol, address[] memory minterAddresses) ERC721(tokenName, symbol) EIP712(SIGNING_DOMAIN, SIGNING_VERSION)
    {
    ...
    function _afterTokenTransfer(address from, address to, uint256 tokenId, uint256 batchSize) internal virtual override(ERC721, ERC721Votes) {
