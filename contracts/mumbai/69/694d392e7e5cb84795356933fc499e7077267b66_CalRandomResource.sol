...
contract CalRandomResource is OwnableUpgradeable {
    ...
    function firstResource(uint256 number, uint8 num, uint8 level, uint16 ratio, uint8 option) internal view returns(
    ...
    function loop0(uint256[4] calldata number, uint8 num, uint8 level, uint16 ratio, uint8 option) internal view returns(
        LoopResult memory res
    ) {
        res = firstResource(
            number[0],
    ...
    function loop1(uint256[4] calldata number, uint8 num, uint8 level, uint16 ratio, uint8 option) internal view returns(
        LoopResult memory res
    )  {
    ...
    function loop2(uint256[4] calldata number, uint8 num, uint8 level, uint16 ratio, uint8 option) internal view returns(uint8[] memory) {
