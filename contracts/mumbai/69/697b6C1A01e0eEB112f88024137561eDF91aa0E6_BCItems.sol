...
contract BCItems is ERC721URIStorage, Ownable {
    ...
    enum BCItemType { COMPANY, ALIEN, SCAVENGER }
    ...
    function _initInitialBaseItems() private {
        ...
        baseItems.push(BaseItem(
            ...
            BCChars.Traits(0, 0, 0, 0, 0, 0, 1),
            BCChars.Traits(0, 0, 0, 0, 0, 0, 0),
            0,
            1,
            false,
            false
