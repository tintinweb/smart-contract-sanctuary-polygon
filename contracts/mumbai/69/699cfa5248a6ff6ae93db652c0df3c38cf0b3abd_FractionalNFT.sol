    ...
    OwnableUpgradeable
{
    ...
    mapping(uint256 => fractionalERC20Tokens) private tokenIdToERC20Address;

    // Mapping Jewellery Data against NFT's tokenId.
    mapping(uint256 => Jewellery) private tokenIdToJewelleryData;

    // Mapping Valuations Data against NFT's tokenId.
    mapping(uint256 => Valuations) private tokenIdToValuationsData;
    ...
    function transferNftAfterSale(
        ...
        require(
            ERC20(tokenAddress).balanceOf(to) ==
    ...
    function giftNFT(
        ...
        address tokenAddress = getTokenAddress(tokenId);
        require(
            ERC20(tokenAddress).balanceOf(from) ==
                ERC20(tokenAddress).totalSupply(),
    ...
    function mintFNFT(
        ...
        if (_totalFractionalTokens > 0) {
            ...
            tokenIdToERC20Address[_tokenId] = tokenAddress;
        }
    }

    function getTokenAddress(uint256 _tokenId) public view returns (address) {
        return tokenIdToERC20Address[_tokenId].erc20TokenAddress;
    }
    ...
    {
        return tokenIdToJewelleryData[_tokenId].jewelleryData;
    }
    ...
    function getValuationsData(uint256 _tokenId)
        ...
        returns (string memory)
    {
        return tokenIdToValuationsData[_tokenId].valuationsData;
    }
...
contract FNFToken is ERC20, Ownable {
    constructor() ERC20("RuptokNFTShare", "RNFTS") {}
