...
contract ERC20Staking is ReentrancyGuard {
    ...
    function showBlockTime() public view returns (uint256){
        return block.timestamp;
    }

    function showFunctionTime() public view returns (uint256){
        return staked[0].stakingStartDate + staked[0].duration;
    }
}
