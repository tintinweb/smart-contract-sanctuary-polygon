	...
	Withdrawable
{
	...
	uint256 public constant PUBLIC_SALES_START_PRICE = 2 ether;
	...
	uint public constant PRESALE_MAX_PURCHASE_ALLOWED = 20;
		...
		isPreSalesActive
	{
		...
		require(currentId.add(numberOfTokens) <= PRE_SALES_MAX_SUPPLY, "Purchase would exceed pre-sale limit.");
