...
contract CZBSEC is Context, Ownable, IERC20, ERC20Detailed {
    ...
    address payable public walletJackpot =
        payable(0xaCABC0af233D3E36CB5dA9bD0CEf7405930230F9);
    ...
    constructor() ERC20Detailed("CZ Battle SEC", "CZBSEC", 18) {
        _owner = msg.sender;
        _totalSupply = 20_000_000 * (10 ** 18);
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            uint256 taxAmount = amount.mul(swapFee).div(100);
