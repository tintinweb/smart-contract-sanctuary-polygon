...
contract HKFINFT2022 is ERC721A, Ownable, ReentrancyGuard{
    ...
    uint256 immutable public MAX_SUPPLY = 300;

    /// @notice counter for how much nft minted
    ...
    /// @notice Event for to notify that there is a change on the BaseURI
    event BaseURIChanged(string newBaseURI);

    constructor() ERC721A("The Hong Kong Insurance Awards 2022", "HKFIAWARD2022"){
    }
    ...
    modifier callerIsUser() {
        require(tx.origin == msg.sender, "CBK :: Cannot be called by a contract");
        _;
    }

    /**
     * @notice set metadata url
     * @param newbaseURI new url of metadata
     */
    ...
    /**
     * @notice mint one nft for each owner
     * @param owners a list of who will receive nft
     */
    function mint(
        address[] calldata owners
    ) payable public nonReentrant onlyOwner {
    ...
    /**
     * @notice Return list of NFT that belong to a buyer
     * @return List of the NFTs of the buyer
     */
    ...
    /**
     * @notice For contract ownership transfer
     */
...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
     ...
     */
    function tokenOfOwnerByIndex(address owner, uint256 index) public view override returns (uint256 _i) {
