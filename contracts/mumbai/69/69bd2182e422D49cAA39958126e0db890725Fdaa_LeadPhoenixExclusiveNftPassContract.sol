    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmWfqmUuTwMQauk1GxmPWnkWS9BNEnh9nPFYWLpmgyjdwK/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/zyvPqufyqKcVyPQCYsnK/contract-metadata";
  }
...
// File: contracts/LeadPhoenixExclusiveNftPassContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract LeadPhoenixExclusiveNftPassContract is ERC721APlus {
    constructor() ERC721APlus("LeadPhoenix Exclusive NFT Pass", "LPIO"){}
}
