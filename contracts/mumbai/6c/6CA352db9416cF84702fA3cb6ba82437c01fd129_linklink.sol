 ...
 */
contract linklink is ChainlinkClient, ConfirmedOwner {
     ...
     */
    function requestVolumeData(uint256 _nftId) public returns (bytes32 requestId) {
        ...
        string memory oracleURL = string.concat("https://ne-contact-metadata.herokuapp.com/nft/get/",Strings.toString(_nftId));
