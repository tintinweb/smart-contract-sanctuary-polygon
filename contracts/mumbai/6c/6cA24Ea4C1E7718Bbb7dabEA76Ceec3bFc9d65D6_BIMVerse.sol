...
contract BIMVerse is ERC721, Ownable {
  using Strings for uint256;
...
Building[] public buildings;
  ...
  constructor() ERC721("NAME", "BVS") {
    //setHiddenMetadataUri("ipfs://__CID__/hidden.json");
    buildings.push(Building("ZERO", 0,0,0,0,0,0));
      buildings.push(Building("1", 1,3,2,2,0,3));
      buildings.push(Building("2", 2,5,4,10,0,6));
      buildings.push(Building("3", 1,1,2,7,0,-7));
      buildings.push(Building("4", 2,3,1,9,0,-9));
      buildings.push(Building("5", 2,5,2,-2,0,5));
