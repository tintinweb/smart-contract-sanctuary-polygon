...
contract CantTransfer3 is ERC721Mintable, ERC721Permit("CantTransferNFT:Token") , Ownable, ERC721URIStorage{
    string public _defaultURI;
    
    event UpdateDefaultURI(string defaultURI);

    constructor() ERC721("CantTransferNFT:Token", "CT") {
        setDefaultURI("https://nft-studio.com/api/metadata/maruzen_art/");
    }
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal virtual override(ERC721, ERC721Enumerable) {
        ...
        require(from == address(0), "only mint can execute");
    }
