 ...
 * Cannot exist without another contract using it as fuel to mint new tokens.
 */
contract TICKETS is ERC721, Ownable {
     ...
     * Store this address in callerAddr to make sure calls come from the other ERC721 contract.
     */
    ...
    * Mints Tokens
    */
    function mintTicket(address to, uint256 numberOfTokens) public onlyCaller {
