...
// NOTE: discount on other currencies
contract CyptoPunks3dTest is ERC721, Pausable, ERC721Burnable {
   ...
   {                       
    ...
    function updateWhitelistTimeBound(uint _whitelistTimeBound) public onlyValidator {
        whitelistTimeBound= _whitelistTimeBound;
    }

    function updateCryptoCurrencyAddress(uint index, address _contractAddress) public onlyValidator {
        CryptoCurrencies[index]= _contractAddress;
    }
