...
contract AnOnchainGame is EssentialERC2771Context {
    ...
    // Events
    event Registered(address indexed player, address nftContract, uint256 nftTokenId, uint256 spaceId);
    ...
    function register() external onlyForwarder {
        ...
        emit Registered(_msgSender(), nft.contractAddress, nft.tokenId, playerLocation[_msgSender()]);
    }
