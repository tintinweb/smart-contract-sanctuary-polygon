...
contract POLY20Token is IPOLY20 {
	
	uint256 private _totalSupply;
    uint8 private _decimals = 18;
    string private _symbol = "DKC";
    string private _name= "DUKE COIN";
...
contract POLY20TokenSale {
    address payable admin;
    POLY20Token public tokenContract;
    ...
    constructor(POLY20Token _tokenContract, uint256 _tokensSold) public {
        admin = msg.sender;
