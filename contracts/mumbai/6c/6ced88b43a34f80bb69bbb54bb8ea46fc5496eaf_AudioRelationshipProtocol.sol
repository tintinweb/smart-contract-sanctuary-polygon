...
/// @author Alec Papierniak <[email protected]>, Kyle Dhillon <[email protected]>
...
contract AudioRelationshipProtocol is Initializable, AccessControlUpgradeable, PausableUpgradeable, UUPSUpgradeable, IAudioRelationshipProtocol {
    ...
    /// @inheritdoc IAudioRelationshipProtocol
    ...
    /// @inheritdoc IAudioRelationshipProtocol
    function getMedia(uint256 index) external view override returns (Media memory) {
    ...
    function getMediaByOrigin(
        ...
        uint256 tokenId
    ) external view override returns (Media memory) {
...
interface IAudioRelationshipProtocol {
    ...
    /// @param mediaId ID of the media registered within ARP
    /// @param version ARP version
    ...
    /// @param originToken Origin token, if any, for the media
    struct Media {
        uint256 mediaId;
        uint256 version;
        address artistAddress;
