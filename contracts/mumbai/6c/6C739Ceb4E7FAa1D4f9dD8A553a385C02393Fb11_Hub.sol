...
contract Hub is Initializable {
    ...
    /// @notice This function is used to add mappings (su -> coin) and (coin->su) to the hub contract
    /// @param _su The startup address
    /// @param _coin The coin token address
    ...
    /// @notice This function is used to add statement hash in mapping (su->hash[]) to the hub contract
    /// @param _su The startup address
    /// @param _new_hash The hash statement
    ...
    /// @notice This function is used to update the su address in the mappings (su->coin), (coin->su)
    ...
    /// @notice This function is used to update rain token address in the hub contract, only admin can do
    /// @param newRainTokenAddress The new rain token address
    ...
    /// @notice This function is used to get the coin address from the startup address (su -> coin)
    /// @param _su The startup address
    function getCoinFromSu(address _su) external view returns (address) {
        return suToCoinMapping[_su];
    }

    /// @notice This function is used to get the startup address from the coin address (coin -> su)
    /// @param _coin The coin token address
    function getSuFromCoin(address _coin) external view returns (address) {
        return coinToSuMapping[_coin];
    }

    /// @notice This function is used to get the startup statement hash from the su,address and index (su -> hash)
    /// @param _su The startup address
    /// @param _index The index of the hash statement
