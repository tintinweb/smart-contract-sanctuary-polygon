...
contract NftCoinFlip is VRFConsumerBaseV2, ERC721Holder, Ownable {
    ...
    event GameCompleted(address indexed nftContractAddress, uint256 gameId, address winnerAddress, uint256 winnerNft);
    ...
    function fulfillRandomWords(uint256 _requestId, uint256[] memory _randomWords) internal override {
        ...
        Player memory winner = _randomWords[0] % 2 == 0
        ...
        emit GameCompleted(nftContractAddress, gameId, winner.playerAddress, winner.nftId);
    }
