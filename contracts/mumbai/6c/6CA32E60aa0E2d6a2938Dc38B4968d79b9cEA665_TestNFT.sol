...
contract TestNFT is ERC721Enumerable, ERC2981, Ownable {
    ...
    constructor() ERC721("TestContract", "TC") {
        baseURI = "https://test-kpop-earth.s3.ap-northeast-2.amazonaws.com/test/";
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        if (msg.sender != owner()) {
            if (onlyWhitelisted == true) {
                ...
                require(
                    ownerMintedCount + _mintAmount <= maxNftPerAddress,
    ...
    function delWhitelistUsers() public onlyOwner {
        delete whitelistedAddresses;
    }
