...
// File: contracts/Eho1155TestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract Eho1155TestContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "EHO1155 TEST ";
    string public symbol = "EHO1155";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/2R2NhlyVYNk951PSqg2f/contract-metadata";
  }
