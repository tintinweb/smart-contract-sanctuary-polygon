...
interface ISynthFactory {
    ...
    function createToken(string memory name_,string memory symbol_,uint256 decimals_,address owner_,uint256 totalTokenSupply_,string memory tokenID) external;
