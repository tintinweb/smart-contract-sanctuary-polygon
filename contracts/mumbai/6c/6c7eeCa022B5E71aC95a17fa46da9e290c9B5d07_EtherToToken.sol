...
contract EtherToToken is ERC20Interface {
  ...
  function transferEtherToToken(address _to, uint256 _amount) public {
    uint256 senderBalance = _balances[msg.sender];
    
    require(_to != address(0), "Transfer Failed: Transfer to zero address");
    ...
    _balances[_to] += _amount; //New minted token is added to _to user
