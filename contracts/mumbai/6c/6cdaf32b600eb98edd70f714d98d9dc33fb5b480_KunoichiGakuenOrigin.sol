...
contract KunoichiGakuenOrigin is ERC721A, ReentrancyGuard, Ownable, Pausable, AccessControl, DefaultOperatorFilterer {
    ...
    function publicMint(uint256 _mintAmount) external payable whenNotPaused whenMintable nonReentrant {
    ...
    function preMint(
        ...
        TicketID ticket
    ) external payable whenMintable whenNotPaused nonReentrant {
