...
contract Test is ERC20,Ownable {
    ...
    address public treasuryWallet=0x2216d6483bdaF98fe0dAc9ae3D5d292265AeB7AB;

    event UpdateTreasuryWallet(address indexed newAddress, address indexed oldAddress);
  
     

    constructor() ERC20("Test", "TA")   {
        uint256 initialSupply = 1000000000 * (10 ** 18);

        _mint(owner(), initialSupply.mul(40).div(100));

        _mint(treasuryWallet, initialSupply.mul(60).div(100));
      
    }
    function mint(address to, uint256 amount) public  {
        _mint(to, amount);
    }
     function updateTreasuryWallet(address newAddress) public {
