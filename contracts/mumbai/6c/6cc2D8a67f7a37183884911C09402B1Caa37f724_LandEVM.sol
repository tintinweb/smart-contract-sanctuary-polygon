...
contract LandEVM is LandBase {
    ...
    /**
    * @dev Throws if weth address is zero
    *
    */
    ...
    */
    ...
    /**
    * @dev Send contract wETH balance to withdrawal recipient requires ROLE_MULTISIG_WALLET
    ...
    */
    function _withdraw(uint256 _amount)
        private
    {
        IERC20(wETHAddress).transfer(withdrawalRecipient, _amount);
