...
contract ApeironPlanetPresaleFactory is MultiWhitelist {
    ...
    constructor(
        ...
        typeMax[NFTType.Primal] = typeCounter[NFTType.Primal] + _mintCountPerType[4] - 1;

        typeCounter[NFTType.Divine] = typeMax[NFTType.Primal] + 1;
        typeMax[NFTType.Divine] = typeCounter[NFTType.Divine] + _mintCountPerType[3] - 1;

        typeCounter[NFTType.Arcane] = typeMax[NFTType.Divine] + 1;
        typeMax[NFTType.Arcane] = typeCounter[NFTType.Arcane] + _mintCountPerType[2] - 1;

        typeCounter[NFTType.Mythic] = typeMax[NFTType.Arcane] + 1;
        typeMax[NFTType.Mythic] = typeCounter[NFTType.Mythic] + _mintCountPerType[1] - 1;

        typeCounter[NFTType.Elemental] = typeMax[NFTType.Mythic] + 1;
        typeMax[NFTType.Elemental] = typeCounter[NFTType.Elemental] + _mintCountPerType[0] - 1;
    }
