...
contract Voting {
    ...
    // state variables
    address public AME_VOTING_TOKEN = 0x167678e8e8eCE47df4b89Fb42029f19D00fF3E48;
    ...
    function castVote(bool _decision, uint _proposalId) external {
        ...
        if (
            ...
            if (_decision) {
                ...
                onlyForVotes[_proposalId]._add = msg.sender;
                onlyForVotes[_proposalId]._timeStamp = block.timestamp;
                ...
                onlyAgainstVotes[_proposalId]._add = msg.sender;
                onlyAgainstVotes[_proposalId]._timeStamp = block.timestamp; 
