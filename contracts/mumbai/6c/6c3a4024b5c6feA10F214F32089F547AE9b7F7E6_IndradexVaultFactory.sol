...
// File: verified-sources/0x6c3a4024b5c6feA10F214F32089F547AE9b7F7E6/sources/contracts/libs/PreciseUnitMath.sol
...
// File: verified-sources/0x6c3a4024b5c6feA10F214F32089F547AE9b7F7E6/sources/contracts/IndradexBaseVault.sol
...
// File: verified-sources/0x6c3a4024b5c6feA10F214F32089F547AE9b7F7E6/sources/contracts/IndradexMultiExternalVault.sol
...
// File: verified-sources/0x6c3a4024b5c6feA10F214F32089F547AE9b7F7E6/sources/contracts/IndradexLibraryMultiVaultFactory.sol
...
// File: verified-sources/0x6c3a4024b5c6feA10F214F32089F547AE9b7F7E6/sources/contracts/IndradexSingleExternalVault.sol
...
// File: verified-sources/0x6c3a4024b5c6feA10F214F32089F547AE9b7F7E6/sources/contracts/IndradexLibrarySingleVaultFactory.sol
...
// File: verified-sources/0x6c3a4024b5c6feA10F214F32089F547AE9b7F7E6/sources/contracts/IndradexVaultFactory.sol
...
contract IndradexVaultFactory is Ownable{
    ...
    */
    function createVault(address newOwner, string memory name_, string memory symbol_, address payable inputToken_,
                address[] memory outputTokens_, address[] memory aggregators_, uint256 maxCapDeposit, bool isSingleExternalVault) external onlyOwner
                returns(address newVault)    {
        if(isSingleExternalVault){
            newVault = address(IndradexLibrarySingleVaultFactory.createVault(newOwner, name_, symbol_, inputToken_, outputTokens_, aggregators_, maxCapDeposit));
            _indradexSingleExternalVaults.push(newVault);
        }
        else{
            newVault = address(IndradexLibraryMultiVaultFactory.createVault(newOwner, name_, symbol_, inputToken_, outputTokens_, aggregators_, maxCapDeposit));
    ...
    */
    function setDeprecated(address vaultAddress, bool deprecated) external onlyOwner{
        require(_vaultStatus[vaultAddress] != VaultStatus.NOT_EXISTING, "Factory: vault not existing");
        if(deprecated){
    ...
    */
    function vaultStatus(address vaultAddress) external view returns(VaultStatus){
    ...
    */
    function getIndradexSingleExternalVaults() external view returns(address[] memory) {
