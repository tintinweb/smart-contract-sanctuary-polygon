    ...
    UUPSUpgradeable
{
    ...
    function __FuelDistributor_init_unchained(
        ...
        setDestinationsProtocol(_destinationsProtocol);
        setDestinationsCredit(_destinationsCredit);
        setDestinationsRemainder(_destinationsRemainder);
    }
     ...
     */
    function setDestinationsProtocol(Destination[] calldata _destinationsProtocol) public onlyOwner {
     ...
     */
    function setDestinationsRemainder(Destination[] calldata _destinationsRemainder) public onlyOwner {
     ...
     */
    function setDestinationsCredit(Destination[] calldata _destinationsCredit) public onlyOwner {
