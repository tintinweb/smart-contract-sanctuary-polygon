...
contract UpgradableProxy is ERC1967Proxy {
    ...
    function transferProxyOwnership(address _newOwner) public onlyProxyOwner {
     ...
     function updateImplementation(address _newProxyTo, bytes memory _data, bool _forceCall) public onlyProxyOwner {
        require(_newProxyTo != address(0x0), "INVALID_PROXY_ADDRESS");
        require(Address.isContract(_newProxyTo), "DESTINATION_ADDRESS_IS_NOT_A_CONTRACT");

        _upgradeToAndCall(_newProxyTo, _data, _forceCall);
    }
    // ##################
