...
contract Dao {
    ...
    constructor(){
        owner = msg.sender;
        nextProposal = 1;
        daoContract = IdaoContract(0x91Bc2AEC72aDD1fb8e41D93fd9f92001521811bd);
        validTokens = [65917826540723047970735311029428931714846892655520240547175603111634038424252];
    }
    ...
    function voteOnProposal(uint256 _id, bool _vote) public {
        ...
        require(checkVoteEligibility(_id, msg.sender), "You can note vote on this Proposal");
        require(!Proposals[_id].voteStatus[msg.sender], "You hace already voted on this Proposal");
