...
// File: contracts\ERC1155\IERC1155MetadataURI.sol
...
// File: contracts\ERC1155\ERC1155Supply.sol
...
// File: contracts\ERC1155\ERC1155Extensions.sol
...
// File: contracts\Lib\IERC1155Mint.sol
...
// File: contracts\Lib\IGetTokenId.sol
...
// File: contracts\ERC1155\ERC1155Token.sol

pragma solidity ^0.8.0;
contract ERC1155Token is IERC1155Mint,ERC1155, ERC1155Extensions, ERC1155Burnable, ERC1155Supply,IGetTokenId {
    ...
    function mint(address account, uint256 amount, bytes memory data, string memory uri)
        ...
        returns(uint256)
    {
        uint256 tokenId = getTokenId(account);
        _nonce[account]++;
    ...
    function getTokenId(address owner) public override view returns(uint256 tokenId){
