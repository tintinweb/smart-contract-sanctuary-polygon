...
contract MoonLightBond is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("MoonLight Bond", "MOON") {
  ...
  function mint() public payable nonReentrant {
    ...
    require(msg.value >= PRICE, "Insufficient payment, 2 ETH per item");
