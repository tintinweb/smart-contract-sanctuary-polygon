 ...
 * @notice This contract handles minting FOR SMATY tokens.
 */
contract FORSMATY is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xF9bd8d01e0889DB60461b37A81C52Aa0231Dd605;
    address public royaltyAddress = 0x3816F8d2389065c14e6b797Be451272F2E498dA0;
    address[] public payoutAddresses = [
        0x3816F8d2389065c14e6b797Be451272F2E498dA0
    ];
    ...
    string public name = "FOR SMATY";
    string public symbol = "4SMATY";
    ...
    constructor()
        ERC1155(
            "ipfs://bafybeie5nb6brcwm67djfuvpybfjlof7o3rexm7oupzmuagbqdisdt2x44/{id}"
        )
        RevokableOperatorFilterer(
