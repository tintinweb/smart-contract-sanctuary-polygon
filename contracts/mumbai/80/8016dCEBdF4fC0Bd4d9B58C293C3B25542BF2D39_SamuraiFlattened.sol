...
contract SamuraiFlattened is ERC721Enumerable, ERC2981, Ownable, Pausable {
    using Strings for uint256;
    ...
    function freeMint(address _address, uint256 count) public onlyOwner {
        uint256 supply = totalSupply();
        require(
            supply + count <= maxSupply,
            "Total supply cannot exceed maxSupply"
