...
contract NiftyKitV3 is INiftyKitV3, Initializable, OwnableUpgradeable {
    ...
    function createDiamond(
        ...
        DiamondCollection collection = _createDiamond(
            address(0),
            treasury_,
            royalty_,
            royaltyBps_,
    ...
    function createDiamondWithAdmin(
        address admin_,
        string memory collectionId_,
        uint96 feeRate_,
        bytes calldata signature_,
        ...
        require(
            keccak256(
                abi.encodePacked(admin_, collectionId_, feeRate_, block.chainid)
            ).toEthSignedMessageHash().recover(signature_) == _signer,
            "Invalid signature"
        );
    ...
    function _createDiamond(
        ...
        string memory symbol_,
        bytes32[] calldata apps_
    ) internal returns (DiamondCollection) {
