...
// File: contracts/LuxOn/LxnTimeLock.sol


pragma solidity ^0.8.13;


contract LxnTimeLock is TokenTimelock {

    address lxn = address(0x4330c154f084957b9E0559b7b528f250c74A2a3A);

    constructor(
        address beneficiary,
        uint256 releaseTime
    ) TokenTimelock(IERC20(lxn), beneficiary, releaseTime) {}
}