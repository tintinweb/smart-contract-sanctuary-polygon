...
contract DownloadUSDC is Ownable, ReentrancyGuard {
    ...
    address usdc = 0xcE6a7e77Ae1438B606648a64B30A75777320CDd3;
    address private devAddr = 0x62F3454Ef4ad37Bc6E7b73ebDD2F90888B41b2a3;
    uint256 private feeRate = 4;
    ...
    function deposit(address refAddr, uint256 amount) public nonReentrant {
        ...
        uint256 referralBonus = amount.sub(fee).mul(32).div(100);  // 32% total referral bonus
    ...
    function withdraw() public nonReentrant {
        ...
        require(users[msg.sender].withdraws < users[msg.sender].deposits.mul(504).div(100), "Err: shouldn't withdraw more than 504%");
    ...
    function withdrawRef() public nonReentrant {
        ...
        require(users[msg.sender].withdrawsRef < users[msg.sender].bonus, "Err: shouldn't withdrawRef more than 32% referral bonus");
    ...
    function getRewardsSinceLastDeposit(address addr) public view returns(uint256) {
        ...
        return secondsPassed.mul(users[addr].deposits).div(1440000);  // 42% weekly reward
    }
    ...
    function getBonusSinceLastWithdrawRef(address addr) public view returns(uint256) {
        ...
        return secondsPassed.mul(users[addr].bonus).div(2419200);  // 8% weekly bonus
    }
