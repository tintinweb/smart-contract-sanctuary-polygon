...
// V9: Remove time window concept. Add i lockBalance to indicator total amount lock for one round bid, which including bidder and owner. 

pragma solidity ^0.8.0;

contract AutratecBinaryOptionV9 {
    ...
    constructor() {
        owner = msg.sender;
        rewardPercentage = 95;
        // speicla program for VM test only
        acctBalance[owner] = 100000;  
        acctBalance[0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2] = 1000;
        acctBalance[0x4B20993Bc481177ec7E8f571ceCaE8A9e22C02db] = 500;
    }
