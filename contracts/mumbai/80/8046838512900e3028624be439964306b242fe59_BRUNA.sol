    ...
    RoyaltiesV1Luxy
{
    ...
    uint256 public constant DROP_START_TIME = 1665316800;
    uint256 public constant PRICE_PER_TOKEN = 1.5 ether;
    uint256 public constant MINIMUM_LUXY_AMOUNT = 1000 ether;

    //Uncomment this section to enable whitelist
    uint256 public constant WHITELIST_EXPIRE_TIME = 10 minutes;
    uint256 public constant LUXY_SALE_EXPIRE_TIME = 20 minutes;

    /**
     * @dev Initializes the contract by setting a `name` and a `symbol` to the token collection.
     */
    function __BRUNA_init(
        ...
        __ERC721_init_unchained("BRUNA", "LuxyDrop");
        __ERC721Enumerable_init_unchained();
        __Ownable_init_unchained();
        __BRUNA_init_unchained(
            baseURI_,
            artist_,
            // luxy_,
    ...
    function __BRUNA_init_unchained(
        string memory baseURI_,
        address artist_,
        // IERC20Upgradeable luxy_,
        address luxyLaunchpadFeeManagerProxy_
