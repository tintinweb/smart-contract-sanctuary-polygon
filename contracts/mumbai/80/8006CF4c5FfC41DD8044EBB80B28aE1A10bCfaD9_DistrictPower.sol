...
contract DistrictPower is ReentrancyGuard, Bucket {
    ...
    uint256[6] public DEFAULT_TARGET_AMOUNTS = [13e4 * ACCURACY, 25e4* ACCURACY, 35e4 * ACCURACY, 50e4 * ACCURACY, 75e4 * ACCURACY, 125e4 * ACCURACY];
    ...
    function openPosition(
        ...
        if(userGlobalInfo.supernodeAddress != address(0)){
            if(userGlobalInfos[_referrer].supernode){
