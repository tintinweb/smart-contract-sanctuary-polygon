 ...
 */
contract TestFxERC20 is ERC20 {
    address internal _fxManager;
    address internal _connectedToken;

    constructor(address fxManager_, address connectedToken_, string memory name_, string memory symbol_) {
        require(fxManager_ != address(0x0) && connectedToken_ != address(0x0));
        _fxManager = fxManager_;
        _connectedToken = connectedToken_;

        // setup meta data
        _setupMetaData(name_, symbol_, 18);
    }
