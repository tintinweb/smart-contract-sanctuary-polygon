...
function initialize() public initializer {
    ...
    function isApprovedAndOffset(address spender, uint tokens, string calldata message) public returns (bool success) {
        checkApproved = ERC721Interface(msg.sender);
        require(checkApproved.isApprovedForAll(spender, tx.origin) == true, "Operator is NOT Approved to Transfer Tokens");
