...
contract MiniWolf is Ownable, ERC721, NonblockingReceiver {
    ...
    function mint(uint8 numTokens) external payable {
        require(numTokens < 3, "Mini Wolf: Max 2 NFTs per transaction");
        require(
    ...
    function getEstimatedGas(uint16 _chainId, uint256 tokenId) public returns (uint256) {
        ...
        revert("This chain is currently unavailable for travel");
    }
