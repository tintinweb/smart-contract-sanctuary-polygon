...
contract Racino is ERC721A, ReentrancyGuard {
    using Strings for uint256;

    //NOTE Token values incremented for gas efficiency
    uint256 private maxSalePlusOne = 1001;
    uint256 public tokenPrice = 0.003 ether; //450$ at time of mint

    bytes32 public merkleRoot;

    uint public mintAllowancePlusOne = 6;
    ...
    address public recipient = 0xbFc7dE7E9381F7e36205C27e7b0945c5E13e3d00;

    constructor() ERC721A("Racino", "R") {
        placeholderURI = "ipfs://...";

        merkleRoot = 0x935323dfdc2225bd42c05cdcbeb7d4502e6a24cf363845ee8538427fca3329db; //0x should be prepended
    ...
    /**
     * Update price of tokens for sale.
     * @param newTokenPrice The new price of the tokens for sale.
     */
