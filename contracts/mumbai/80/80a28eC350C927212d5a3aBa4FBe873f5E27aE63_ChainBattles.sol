...
contract ChainBattles is ERC721URIStorage {
    ...
    function train(uint256 tokenId) public {
        ...
        currentCharacter.hp = currentCharacter.hp + rand(100);
        currentCharacter.strength = currentCharacter.strength + rand(100);
        currentCharacter.speed = currentCharacter.speed + rand(100);
