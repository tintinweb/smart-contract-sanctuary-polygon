...
// Contract deployed to 0x801EFB6F607CaC2C8213824620b632fd49ae1A97
...
contract ChainBattles is ERC721URIStorage  {
    ...
    function train(uint256 tokenId) public {
        ...
        tokenIdToVariables[tokenId].hp = currentHp + 1;
        uint256 currentStrength = tokenIdToVariables[tokenId].strength;
        tokenIdToVariables[tokenId].strength = currentStrength + 1;
        uint256 currentSpeed = tokenIdToVariables[tokenId].speed;
        tokenIdToVariables[tokenId].speed = currentSpeed + 1;
