...
contract DigicapMarket is Manager, ERC721Holder, ReentrancyGuard {
    ...
    function createOrder(
        ...
        require(_expTime > block.timestamp || _expTime == 0, "Invalid-expired-time");
    ...
    function buy(
        ...
        require(order.expTime > block.timestamp || order.expTime == 0, "Order-expired");
    ...
    function acceptBid(uint256 _bidId) external whenNotPaused returns (bool) {
        ...
        require(bid.expTime > block.timestamp || bid.expTime == 0, "Bid-expired");
