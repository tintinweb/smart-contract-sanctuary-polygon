...
contract CampaignPayment {
    ...
    function approveTransfer(uint256 amount) external onlyOwner {
        require(amount > 0, "Amount must be greater than 0");
        _usdcToken.safeApprove(address(this), amount);
    }
    ...
    function transferUSDC(
        ...
        uint256 allowance = _usdcToken.allowance(msg.sender, address(this));
        require(allowance >= amount, "transfer amount exceeds allowance");

        _usdcToken.safeTransferFrom(msg.sender, recipient, amount);
    }
