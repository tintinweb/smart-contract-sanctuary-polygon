...
interface IProfileTokenURI {
    function getProfileTokenURI(uint256 id,address owner,string memory username,string memory imageURI, string memory description) external pure returns (string memory);
}
