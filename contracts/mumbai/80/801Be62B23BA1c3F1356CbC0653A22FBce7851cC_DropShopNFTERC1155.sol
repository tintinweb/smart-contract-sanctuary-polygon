    ...
    RoyaltiesV2Impl
{
 ...
 /**
    ...
    */
     ...
     * but can be changed as per requirement
     */
    function bulkMint(address to, string calldata metadaIpfsHash_,uint256[] calldata amounts,bytes calldata data) external only(MINTER_ROLE) {
        ...
        for(uint i = 0; i < amounts.length; i++){
            ...
            metadaIpfsHash[i]=metadaIpfsHash_;
        }
     ...
     function bulkMintWithCustomIds(address to, string calldata metadaIpfsHash_,uint256[] calldata ids,uint256[] calldata amounts,bytes calldata data) external only(MINTER_ROLE) {
