    ...
    PausableUpgradeable
{
    ...
    function initialize(string memory _baseTokenURI, string memory _projectID, address _admin) public initializer {
    ...
    function mint(address user, uint256 quantity, string[] memory cidArr, string[] memory offChainIds) external onlyAdmin {
    ...
    function buy(address user, string memory offChainId) external {
        ...
        _safeTransferFrom(admin, user, tokenId, 1, '');
