...
contract TestVesting is ReentrancyGuard, Ownable {
    ...
    function TestVestingSchedule(
        ...
        uint256 _duration = _start.add(1 days);
    ...
    function Test2VestingSchedule(
        ...
        uint256 _duration = _start.add(2000);
     ...
     function Test3VestingSchedule(
        ...
        uint256 _start = testStartTime;
        uint256 _cliff = _start.add(200);
        uint256 _duration = _start.add(1000);
        uint256 _slicePeriod = 120;
        uint256 _releasedPercent = 1000;
        uint256 _tgePercent = 0;
    ...
    function getClaimableAmount(address _beneficiary) external view returns(uint256) {
        ...
        return _getClaimableAmount(_beneficiary);
    }
    ...
    function _getClaimableAmount(
        ...
        require(vestingSchedule.amountTotal == vestingSchedule.released,"no more token to release");
    ...
    function _computeReleasableAmount(
        ...
        if(currentTime < vestingSchedule.cliff) {
            ...
            currentTime >=vestingSchedule.duration
        ) {
    ...
    uint256 totalAmount = vestingSchedule.amountTotal;
    uint256 tgePercent = uint256(vestingSchedule.tgePercent);
    return totalAmount .mul(tgePercent.div(10000));
   }
