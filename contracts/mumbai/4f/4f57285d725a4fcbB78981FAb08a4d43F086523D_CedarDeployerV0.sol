...
contract CedarDeployerV0 is Initializable, UUPSUpgradeable, OwnableUpgradeable, BaseCedarDeployerV0 {
    ...
    function deployCedarERC721DropV0(
        ...
        newContract = dropV0Factory.deploy(_defaultAdmin, _name, _symbol, _contractURI, _trustedForwarders, _saleRecipient, _royaltyRecipient, _royaltyBps, _userAgreement, _signatureVerifier);
...
contract CedarERC721PremintV0Factory is Ownable, ICedarDeployerEventsV0 {
    ...
    constructor(address _greenlistManagerAddress) {
        ...
        emit CedarImplementationDeployed(address(this), major, minor, patch, "CedarERC721PremintV0");
    }
...
contract CedarERC721DropV0Factory is Ownable, ICedarDeployerEventsV0 {
    address public implementationAddress;
    ...
    constructor() {
        // Deploy the implementation contract and set implementationAddress
        CedarERC721DropV0 implementation = new CedarERC721DropV0();
        implementation.initialize(_msgSender(), "default", "default", "", new address[](0), address(0), address(0), 0, "", address(0));
        implementationAddress = address(implementation);
        (uint256 major, uint256 minor, uint256 patch) = implementation.implementationVersion();
        emit CedarImplementationDeployed(address(this), major, minor, patch, "DropERC721V0");
    }
    ...
    function deploy(
        ...
        newClone = CedarERC721DropV0(Clones.clone(implementationAddress));
        newClone.initialize(_defaultAdmin, _name, _symbol, _contractURI, _trustedForwarders, _saleRecipient, _royaltyRecipient, _royaltyBps, _userAgreement, _signatureVerifier);
        ...
        params.signatureVerifier = _signatureVerifier;
