...
contract NFTMarketplace is ReentrancyGuard, Ownable {
    ...
    uint256 public listingPrice = 0.0 ether;
    ...
    function createMarketSale(address nftContract, uint256 itemId) public payable nonReentrant {
        ...
        payable(feeAccount).transfer(listingPrice);
    ...
    function getTotalPrice(uint itemId) view public returns(uint) {
        return _items[itemId].price*(100 + feePercent/100);
    }

       //only owner
    function setListingPrice(uint256 _listingPrice) public onlyOwner {
        listingPrice = _listingPrice / 1 ether;
    }
