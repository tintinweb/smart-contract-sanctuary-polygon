...
interface INFT {
  ...
  function mint ( address _to, string memory _tokenUri, address _ERC20Token, address _sender, address royaltyRecipient, uint256 royaltyBps ) external returns ( uint256 );
