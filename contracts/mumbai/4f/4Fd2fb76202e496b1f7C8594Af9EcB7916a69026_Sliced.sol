...
contract Sliced is ERC20Burnable,Ownable,Pausable {
    ...
    function _initAccounts() internal  {
      accounts.push(Account('sale',0x90F79bf6EB2c4f870365E785982E1f101E93b906,40,0,0));
	  isExcludedFromFee[0x90F79bf6EB2c4f870365E785982E1f101E93b906]=true;
	  accounts.push(Account('reward',0x15d34AAf54267DB7D7c367839AAf71A00a2C6A65,20,10,0));
	  isExcludedFromFee[0x15d34AAf54267DB7D7c367839AAf71A00a2C6A65]=true;
	  accounts.push(Account('marketing',0x9965507D1a55bcC2695C58ba16FB37d819B0A4dc,15,5,0));
	  isExcludedFromFee[0x9965507D1a55bcC2695C58ba16FB37d819B0A4dc]=true;
	  accounts.push(Account('dev',0x976EA74026E726554dB657fA54763abd0C3a0aa9,10,5,0));
	  isExcludedFromFee[0x976EA74026E726554dB657fA54763abd0C3a0aa9]=true;
	  accounts.push(Account('team',0x14dC79964da2C08b23698B3D3cc7Ca32193d9955,5,5,0));
	  isExcludedFromFee[0x14dC79964da2C08b23698B3D3cc7Ca32193d9955]=true;
	  accounts.push(Account('legal',0x23618e81E3f5cdF7f54C3d65f7FBc0aBf5B21E8f,5,5,0));
	  isExcludedFromFee[0x23618e81E3f5cdF7f54C3d65f7FBc0aBf5B21E8f]=true;
	  accounts.push(Account('launchpad',0xa0Ee7A142d267C1f36714E4a8F75612F20a79720,5,0,0));
	  isExcludedFromFee[0xa0Ee7A142d267C1f36714E4a8F75612F20a79720]=true;
	...
	function _transfer(address _from,address _to,uint _amount) internal override {
		if(!isExcludedFromFee[_from] && _from!= address(0) && _from !=address(this)) {
		    super._transfer(msg.sender,accounts[1].wallet,(_amount*1)/100);
