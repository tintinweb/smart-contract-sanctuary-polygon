...
contract BLUESKYERS_NFT_HACKATHON is ERC721, Ownable {
    ...
    constructor() ERC721("BLUESKYERS NFT HACKATHON", "BLUE") {}
    ...
    function _baseURI() internal view override returns (string memory) {
        require(!frozen, "Cannot change the base URI because it was frozen");
