...
import "./HeftyverseUser1155Token.sol";
...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new HeftyverseUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        HeftyverseUser1155Token token = HeftyverseUser1155Token(address(addr));
...
contract HeftyverseUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
