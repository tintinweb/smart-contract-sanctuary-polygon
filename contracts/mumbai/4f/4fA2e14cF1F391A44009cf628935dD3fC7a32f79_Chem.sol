...
contract Chem is ERC1155 {
    ...
    string public Elements = 'ipfs://QmTvUtD92cWT2EM5Jz9yAUfmE9HftcgwV27qHPfv5Ym32J/'  ;  //'ipfs://QmfLahwBhRCuMP29EqH5X1iNjgAXcwLgn3yGfQkqCL9aMi/';  
 ...
 /*   //Elemental Merging
    function createWater()public {
        uint256 one = 1;
        uint256 two = 2;
        _burnBatch(msg.sender, [Hydrogen, Helium], [two, one]) ; //from, ids [], amounts []
    }  */
