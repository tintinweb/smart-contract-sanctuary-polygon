    ...
    ERC1155Supply
{
    ...
    /**
     * @dev Mints a new token and assigns it to an account.
     * @param account The account to receive the token.
    ...
    /**
     * @dev Mints multiple tokens and assigns them to an account.
     ...
     * It checks if the token transfers are paused.
     * @param operator The address that triggered the token transfer.
     ...
     * @param data Additional data passed during the token transfer.
     */
    function _beforeTokenTransfer(
        address operator,
        address from,
