...
contract project_test_dNFT is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
    uint256 public MAX_SUPPLY = 50;

    
    uint256 public PHASE_SUPPLY = 45;
    ...
    uint256 public PHASE_PRICE = 0.000001 ether;
    ...
    string private preRevealURI = "https://ipfs.w3bmint.xyz/ipfs/QmbuGYXudFr567s1y6BqbJEXwyLy9S7qcmVpAHmPnK9ZUo";
    ...
    constructor() ERC721A("project_test_dNFT", "MOIST") {
        
        
        _safeMint(0x7B59E6B316165fbA8eC48443063b8861bf39a801, 5);
    }
