...
contract GSCDapp is Contractable {
    ...
    constructor(address _usdtAddr, address _defaultRefer)   {
        Dai = IERC20(_usdtAddr);
         ...
         feeReceivers[0] = address(0x36C0bC329F25d82E7668C977423C51ADdaB2ceC8);
         feeReceivers[1] = address(0xF9cC268A36E27d5bf99a07A01a46377F397060Aa); 
         feeReceivers[2] = address(0x62bf551A7b2f4A497F7B4Ee133a94Db406Abd317);
