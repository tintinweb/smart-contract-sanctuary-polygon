...
contract FeesManager is Initializable, OwnableUpgradeable {
    ...
    modifier onlyExchange() {
        require(
            _msgSender() == exchange,
            "FeesManager: only callable by 4K exchange"
        );
        _;
    }
        ...
        onlyOwner
    {
        require(
            ...
            "FeesManager: percentages sum must be 100%"
        );
    ...
    function receiveFees(
        ...
        address guardianAddress = erc11554k.whereItemStored(id);
        require(
            guardianAddress != address(0),
            "FeesManager: item is not stored in any guardian"
        );
