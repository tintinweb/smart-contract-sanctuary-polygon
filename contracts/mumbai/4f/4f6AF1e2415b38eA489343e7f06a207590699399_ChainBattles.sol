...
contract ChainBattles is ERC721URIStorage {
    ...
    function mint() public {
        ...
        tokenIdToLevels[newItemId].speed = 85;
        tokenIdToLevels[newItemId].strength = 80;
    ...
    function train(uint256 tokenId) public {
        ...
        tokenIdToLevels[tokenId].level = tokenIdToLevels[tokenId].level + 1;
        tokenIdToLevels[tokenId].speed = tokenIdToLevels[tokenId].speed + 10;
        tokenIdToLevels[tokenId].strength = tokenIdToLevels[tokenId].strength + 25;
        tokenIdToLevels[tokenId].life = tokenIdToLevels[tokenId].life + 3;
