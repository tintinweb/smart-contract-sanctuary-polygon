...
//	event StakeLog(string name,address addr,uint256 time,uint256 amount, uint256 frozen,uint256 unlock);
	event TxLog(uint256 sale,address addr,uint256 amount,address vault,uint256 blk,uint256 utime);
...
*/
	...
	emit TxLog(sale,addr,amount,Sale[sale].vault,block.number,block.timestamp);
        }
