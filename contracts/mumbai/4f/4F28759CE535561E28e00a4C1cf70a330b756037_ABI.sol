...
// AbiDollar FINANCE
contract ABI is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // Supply used to launch in LP
    uint256 public constant INITIAL_LAUNCH_DISTRIBUTION = 500000 ether; // 0.5 million of ABI
    ...
    /**
     * @notice Constructs the ABI ERC-20 contract.
     */
    constructor() public ERC20("AbiDollar", "ABI") {
        _mint(msg.sender, 10000 ether); // for initial liquidity deployment
    }

    /**
     * @notice Operator mints ABI to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of ABI to mint to
