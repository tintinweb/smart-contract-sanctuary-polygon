...
contract TGAI is ERC721A, Ownable {
    ...
    function setRevenueRecipient(address revenueRecipient) external onlyOwner {
    ...
    // burn token 0 after collection is initialized 
    function burnToken0() external onlyManagers {
        require(_exists(0), "ALREADY_BURNED");
        _burn(0);
    }
