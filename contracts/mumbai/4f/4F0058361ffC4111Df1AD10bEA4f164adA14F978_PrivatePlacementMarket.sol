...
contract PrivatePlacementMarket is OwnerPausable {
    ...
    function setBag(uint256[] memory bag0, uint256[] memory bag1, 
    uint256[] memory bag2, uint256[] memory bag3) external onlyOwnerOrOperator {
...
contract StockERC1155 is ERC1155Supply, OwnerPausable {
    ...
    constructor(address owner) OwnerPausable(owner) ERC1155("https://game.example/api/item/{id}.json") {
        _whitelistOpen = true;
    }
