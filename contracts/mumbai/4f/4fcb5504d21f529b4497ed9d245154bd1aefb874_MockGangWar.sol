...
contract Deploy is Script {
    ...
    function run() external {
        ...
        console.log(string.concat('gmc: "', vm.toString(address(gmc)), '",'));
        console.log(string.concat('mice: "', vm.toString(address(mice)), '",'));
        console.log(string.concat('tokenYakuza: "', vm.toString(address(tokens[0])), '",'));
        console.log(string.concat('tokenCartel: "', vm.toString(address(tokens[1])), '",'));
        console.log(string.concat('tokenCyberpunk: "', vm.toString(address(tokens[2])), '",'));
        console.log(string.concat('badges: "', vm.toString(address(badges)), '",'));
        console.log(string.concat('game: "', vm.toString(address(game)), '",'));
        console.log(string.concat('mockVRF: "', vm.toString(address(coordinator)), '",'));
    }
