...
contract ERC721Bid is Ownable, Pausable, ERC721BidStorage, NativeMetaTransaction {
    ...
    */
    ...
    function acceptBid(address _from,uint256 _tokenId,bytes32 _data) public  whenNotPaused() {
        // bytes32 bidId = _bytesToBytes32(_data);
        uint256 bidIndex = bidIndexByBidId[_data];
        ...
        // ERC721Interface(msg.sender).transferFrom(msg.sender, bidder, _tokenId);
