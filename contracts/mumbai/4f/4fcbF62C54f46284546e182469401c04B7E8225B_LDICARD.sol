...
contract LDICARD is ERC721, Ownable, EIP712, ERC721Votes {
    using Counters
    for Counters.Counter;
    Counters.Counter private _tokenIdCounter;
    constructor() ERC721("LDICARD", "MTK") EIP712("LDICARD", "1") {}

    function _baseURI() internal pure override returns(string memory) {
        return "<https://digitalindonesia.net/idcard/json/{id}.json>";
    }
