...
contract Celebrium is ERC721Enumerable, Ownable {
  ...
  uint256 public preSaleMintPrice = 0.0001 ether;
  ...
  address private OtherAddress = 0xE4a5510402E17AD8bEd1D5f891f9c4D8F104E11c;
  ...
  constructor(string memory baseURI) ERC721("Celebrium", "C") {
    setBaseURI(baseURI);
  }
