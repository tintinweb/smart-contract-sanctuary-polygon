...
contract MarketCore is AccessControlledAndUpgradeableModifiers, IMarketCommon, IMarketCore, MarketStorage, ProxyNonPayable {
  ...
  mapping(address => bool) public canCallMintFor;

  function setCanCallMintFor(address mintFor, bool hasPermission) public onlyRole(MINOR_ADMIN_ROLE) {
    canCallMintFor[mintFor] = hasPermission;
  }
  ...
  function mintLongFor(
    ...
    require(canCallMintFor[msg.sender], "only permissioned addresses can call");
