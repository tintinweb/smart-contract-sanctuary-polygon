...
contract Campaign {
    ...
    Reward.RewardNFT[] public rewards;
    ...
    function createRewardNFT(
        ...
        _createRewardNFT(_contribution, _maxNumber, _imageLink);
    }
    ...
    function _createRewardNFT(
        uint256 _contribution,
        uint256 _maxNumberNFTs,
        string memory _URI
    ) public restricted {
        Reward.RewardNFT memory newReward = Reward.RewardNFT({
            contribution: _contribution,
            maxNumberNFTs: _maxNumberNFTs,
            URI: _URI
        });
...
contract CampaignFactory {
    ...
    function createCampaign(
        ...
        string memory _pdfUrl,
        string memory _videoUrl,
        Reward.RewardNFT[] memory _rewards
    ) public {
