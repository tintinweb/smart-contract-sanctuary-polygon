...
contract iTicketing is ERC721, ERC721URIStorage {
    ...
    ///////     EVENTS      ///////    
    event EventCreated(uint16 NftId, address creator);
    event RegistrationStarted(string info);
    event Registered(address attendee, uint256 event_id, uint256 reg_time);
       ...
       function supportsInterface(bytes4 interfaceId) public view virtual override( ERC721) returns (bool) {
        ...
        function register() external payable {
            ...
            if(eventDetails.eventFee == 0 && msg.value == 0) {
                ...
                _setTokenURI(eventId, _tokenURI);
                emit Registered(msg.sender, eventId, block.timestamp);
