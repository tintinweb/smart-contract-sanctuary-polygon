...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x4d0fADF272dE1E7d29545962C156C8848244B590];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmdB7ie1WeptDvNPeP5fAEcqDQwL47nJGxpiqfHjU5FpEy/";
...
// File: contracts/MajesticMaskPreviewContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MajesticMaskPreviewContract is RamppERC721A {
    constructor() RamppERC721A("Majestic Mask Preview", "MMP"){}
}
