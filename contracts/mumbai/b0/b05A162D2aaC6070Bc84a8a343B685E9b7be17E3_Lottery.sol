...
contract Lottery {
    ...
    address[] public interactedAddresses;
    ...
    interactedAddresses.push(msg.sender);
  }
  function getInteractedAddresses() public view returns (address[] memory) {
    return interactedAddresses;
  }
