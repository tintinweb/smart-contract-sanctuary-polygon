...
contract MSM is ERC20, Ownable {
    uint256 public buyTax = 40; // 0.4%
    uint256 public sellTax = 20; // 0.2%
    uint256 public immutable MAX_TAX = 100; // 1%
    ...
    /**
     * @dev Creates a MSM token contract
     * - MUST mint the total supply (100 mil) of tokens
     */
    constructor(address uniV2Router) ERC20("Matic Milestone", "MSM") {
    ...
    /**
     * @dev Hooks buy/sell transfer to get the fee amount of MSM token
     *
