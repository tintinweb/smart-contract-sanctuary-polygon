...
contract NgageNFactory is AccessControl, ERC2771Context {
  ...
  function createFactory(
    ...
    require(!factoryCreated[_factoryName], 'NF: Factory name already used');
    require(
      _owner != _msgSender(),
      'NF: Contract owner cannot be the proxy admin'
    );
   ...
   * Reverts if the caller is not an admin
   * @param _forwarder The address that will be set as new minimal forwarder contract
   */
  function setNewMinimalForwarder(address _forwarder) public onlyAdmin {
