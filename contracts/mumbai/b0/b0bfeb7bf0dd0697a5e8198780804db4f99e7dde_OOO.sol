...
contract OOO is Initializable, ERC721Upgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize() initializer public {
        __ERC721_init("000", "000");
        __Ownable_init();
        __UUPSUpgradeable_init();
    }

    function _baseURI() internal pure override returns (string memory) {
        return "https://omnishape.io/nfts/trophee/";
    }
