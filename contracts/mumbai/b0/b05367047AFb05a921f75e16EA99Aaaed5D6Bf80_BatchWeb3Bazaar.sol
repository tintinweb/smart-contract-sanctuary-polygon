...
contract BatchWeb3Bazaar is Context, ERC1155Holder, ERC721Holder, MultiAccessControl
{
    ...
    /*
    function getTrade(uint256 tradeId, address userWallet, address tokenAddress ) public view returns (uint256 memory tokenId, uint256 memory amount, uint traderType)
    {
        Trade storage store = _transactions[tradeId];
    ...
    */
    ...
    function verifyERC721 (address from, address tokenAddress, uint256 tokenId) public view returns (bool){
    ...
    function verifyERC20 (address from, address tokenAddress, uint256 amount) public view returns (bool){
    ...
    function verifyERC1155 (address from, address tokenAddress, uint256 amount, uint256 tokenId) public view returns (bool){
    ...
    // TESTED
    function swapERC721 (address from, address to, address tokenAddress, uint256 tokenId) public returns (bool){
    ...
    function swapERC1155 (address from, address to, address tokenAddress, uint256 tokenId, uint256 amount) public returns (bool)
    {
    ...
    function swapERC20 (address from, address to, address tokenAddress, uint256 amount) public returns (bool){
    ...
    function executeTrade(uint256 tradeId )  public returns(uint256)
    {
        ...
        //if the caller isnt the executer throw an error
