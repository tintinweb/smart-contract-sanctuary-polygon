...
contract DCCSwapFactory is IDCCSwapFactory {

  address public override feeTo;
  address public override lpFeeTo;
  address public override feeToSetter;

  uint256 public override lpFee = 20000;
  address public override lpFeeToSetter;
  uint256 public override lpFeeRateMax = 10000000;
  uint256 public override lpFeeToLpSupplierRate = 1 ;

  address public override lpFeeCallBackAddress;
  address public override swapFeeCallBackAddress;

  bool public override sameFeeAddLiquidity =true;
  // bool public override sameFeeRemoveLiquidity =true;
  ...
  constructor(address _feeToSetter, address _lpFeeToSetter) public {
    feeToSetter = _feeToSetter;
    lpFeeToSetter = _lpFeeToSetter;
  }
  ...
  function pairCodeHash() external pure returns (bytes32) {
    return keccak256(type(DCCSwapPair).creationCode);
  }

  function createPair(address tokenA, address tokenB) external override returns (address pair) {
    require(tokenA != tokenB, "DCCSwapFactory::createPair::IDENTICAL_ADDRESSES");
    (address token0, address token1) = tokenA < tokenB ? (tokenA, tokenB) : (tokenB, tokenA);
    require(token0 != address(0), "DCCSwapFactory::createPair::ZERO_ADDRESS");
    require(getPair[token0][token1] == address(0), "DCCSwapFactory::createPair::PAIR_EXISTS"); // single check is sufficient
    bytes memory bytecode = type(DCCSwapPair).creationCode;
    bytes32 salt = keccak256(abi.encodePacked(token0, token1));
    assembly {
      pair := create2(0, add(bytecode, 32), mload(bytecode), salt)
    }
    DCCSwapPair(pair).initialize(token0, token1);
  ...
  function setFeeTo(address _feeTo) external override {
    require(msg.sender == feeToSetter, "DCCSwapFactory::setFeeTo::FORBIDDEN");
    feeTo = _feeTo;
  }

  function setLpFeeTo(address _lpFeeTo) external override {
    require(msg.sender == feeToSetter, "DCCSwapFactory::setLpFeeTo::FORBIDDEN");
    lpFeeTo = _lpFeeTo;
  }

  function setFeeToSetter(address _feeToSetter) external override {
    require(msg.sender == feeToSetter, "DCCSwapFactory::setFeeToSetter::FORBIDDEN");
    feeToSetter = _feeToSetter;
  }

  function setLpFee(uint256 _lpFee) external override {
    require(msg.sender == lpFeeToSetter, "DCCSwapFactory::setLpFeeTo::FORBIDDEN");
    lpFee = _lpFee;
  }

  function setLpFeeToSetter(address _lpFeeToSetter) external override {
    require(msg.sender == lpFeeToSetter, "DCCSwapFactory::setLpFeeToSetter::FORBIDDEN");
    lpFeeToSetter = _lpFeeToSetter;
  }

  function setLpFeeRateMax(uint256 _lpFeeRateMax) external override {
    require(msg.sender == lpFeeToSetter, "DCCSwapFactory::setLpFeeRateMax::FORBIDDEN");
    lpFeeRateMax = _lpFeeRateMax;
  }

  function setLpFeeToLpSupplierRate(uint256 _lpFeeToLpSupplierRate) external override {
    require(msg.sender == lpFeeToSetter, "DCCSwapFactory::setLpFeeToLpSupplierRate::FORBIDDEN");
    lpFeeToLpSupplierRate = _lpFeeToLpSupplierRate;
  }

  function setLpFeeCallBackAddress(address _lpFeeCallBackAddress) external override {
    require(msg.sender == feeToSetter, "DCCSwapFactory::setLpFeeCallBackAddress::FORBIDDEN");
    lpFeeCallBackAddress = _lpFeeCallBackAddress;
  }

  function setSwapFeeCallBackAddress(address _swapFeeCallBackAddress) external override {
    require(msg.sender == feeToSetter, "DCCSwapFactory::setSwapFeeCallBackAddress::FORBIDDEN");
    swapFeeCallBackAddress = _swapFeeCallBackAddress;
  }

  function setSameFeeAddLiquidity(bool _sameFeeAddLiquidity) external override {
    require(msg.sender == feeToSetter, "DCCSwapFactory::setSameFeeAddLiquidity::FORBIDDEN");
    sameFeeAddLiquidity = _sameFeeAddLiquidity;
  }

  // function setSameFeeRemoveLiquidity(bool _sameFeeRemoveLiquidity) external override {
  //   require(msg.sender == feeToSetter, "DCCSwapFactory::setSameFeeRemoveLiquidity::FORBIDDEN");
  //   sameFeeRemoveLiquidity = _sameFeeRemoveLiquidity;
  // }
