...
contract PlastikStaking is Ownable, ReentrancyGuard {
    ...
    struct PoolInfo {
        ...
        uint256 rewardPool; // amount reward for pool
    ...
    event AddPool(uint256 _rewardPool, uint256 _minDeposit, uint256 _maxDeposit, uint256 _limitStaking, uint64 _APR, uint128 _period);
    ...
    function addPool(uint256 _rewardPool, uint256 _minDeposit, uint256 _maxDeposit, uint256 _limitStaking, uint64 _APR, uint128 _period) external onlySystemAdmin {        
        ...
        emit AddPool(_rewardPool, _minDeposit, _maxDeposit, _limitStaking, _APR, _period);
    }
