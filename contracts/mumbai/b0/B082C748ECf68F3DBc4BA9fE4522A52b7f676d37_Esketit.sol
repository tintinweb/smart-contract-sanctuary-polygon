...
contract Esketit is ERC721, IERC721Receiver, Pausable, Ownable {
    ...
    event UpdateCurrentPrice(uint256 indexed nftId, uint256 updatedCurrentPrice);
    ...
    function updateCurrentPrice(uint256 _nftId, uint256 _newPrice) external {
        require(_msgSender() == esketitMarketplace, "caller is not esketit marketplace");
