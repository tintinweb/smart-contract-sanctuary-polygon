...
contract CraftObject is BaseObject, ERC1155Supply {
    ...
    event LogGetCraftObject(address indexed sender, uint256 tokenId);
    ...
    function createObject(
        ...
        emit CreateCraftObject(tokenId, tokenUri, size, creator, maxClaimed, 0);
    }
    ...
    function getObject(address to, uint256 tokenId) external onlyOwner nonReentrant {
        ...
        emit LogGetCraftObject(msg.sender, tokenId);
    }
}
