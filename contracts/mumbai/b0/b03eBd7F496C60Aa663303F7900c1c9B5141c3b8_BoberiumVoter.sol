...
contract BoberiumVoter is Initializable, GovernorUpgradeable, GovernorSettingsUpgradeable, GovernorCountingSimpleUpgradeable, GovernorVotesUpgradeable, GovernorVotesQuorumFractionUpgradeable, GovernorTimelockControlUpgradeable {
...
contract BoberiumVotingNFT is Initializable, ERC721Upgradeable, ERC721URIStorageUpgradeable, OwnableUpgradeable, EIP712Upgradeable, ERC721VotesUpgradeable {
    using CountersUpgradeable for CountersUpgradeable.Counter;
    ...
    function initialize() initializer public {
        __ERC721_init("BoberiumNFT", "Boberium");
        __ERC721URIStorage_init();
        __Ownable_init();
        __EIP712_init("BoberiumNFT", "1");
        __ERC721Votes_init();
    }
