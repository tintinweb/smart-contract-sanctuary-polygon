...
contract WagmiApes_Contract is ERC721A, ERC2981, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
    ...
    string public baseURI = "ipfs://bafkreigmtdbw2eoo4wio47fdnur6q3su4tgvnrrwca3qmu3sc4wfqq5yce/";
    ...
    bytes32 public root = 0x6546e05a9c4cbd99b2fab58a3cd2f1af628d439a6481916ca811f8b4af2760ff;
    ...
    function mint(uint256 quantity, bytes32[] calldata proofs) external payable nonReentrant {
        ...
        if(isWhiteListed) {
            ...
            if (additional && publicClaimed[msg.sender] == 0)
