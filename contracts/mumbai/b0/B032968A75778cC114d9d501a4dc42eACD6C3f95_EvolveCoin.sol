...
contract EvolveCoin is ERC20, ERC20Burnable, Ownable {
    ...
    function burnForAction(uint amount, address whoBurn) public {
        ...
        uint howMuch = ((amount*(10**18)*stakePercentageToCreators[msg.sender])/100)/dividendi;
        ...
        _burn(whoBurn, amount*(10**18)-(howMuch*dividendi));
        maxSupply -= amount*(10**18)-(howMuch*dividendi);
