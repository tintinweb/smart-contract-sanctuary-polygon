  ...
  abstract contract Allowlist is Ownable {
        ...
        Allowlist
    {
        ...
        constructor(
            ...
            payableAddresses.push(0xA10f5637c82653278F1d90269908bF9B215713ef);
    ...
    // File: contracts/clubPassProject2Contract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract ClubPassProject2Contract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Club Pass Project 2", "CLUB", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmdrojUNzJFJpHkWfL51L9CvuQsSufuByPWSyFUJbp32f9/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/6aculKihCRn1W9k8v8mt/contract-metadata";
        }
    }