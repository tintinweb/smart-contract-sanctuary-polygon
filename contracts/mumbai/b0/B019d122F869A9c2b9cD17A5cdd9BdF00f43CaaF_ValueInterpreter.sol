...
contract ValueInterpreter {
     ...
     */
    function addPrimitives1(
        address[] calldata _primitives,
        address[] calldata _aggregators,
        RateAsset[] calldata _rateAssets
    ) external onlyOwner {
        __addPrimitives1(_primitives, _aggregators, _rateAssets);
    }
    function addPrimitives2(
        address[] calldata _primitives,
        address[] calldata _aggregators,
        RateAsset[] calldata _rateAssets
    ) external onlyOwner {
        __addPrimitives2(_primitives, _aggregators, _rateAssets);
    }
    ...
    function __addPrimitives6(
        ...
        for (uint256 i; i < _primitives.length; i++) {
            ...
            __validateAggregator2(_aggregators[i]);
        }
    }
    function __addPrimitives7(
        address[] calldata _primitives,
        address[] calldata _aggregators,
        RateAsset[] calldata _rateAssets
    ) internal {
        ...
        for (uint256 i; i < _primitives.length; i++) {
            ...
            __validateAggregator3(_aggregators[i]);
        }
    }
    function __addPrimitives8(
        address[] calldata _primitives,
        address[] calldata _aggregators,
        RateAsset[] calldata _rateAssets
    ) internal {
    ...
    function __validateAggregator2(address _aggregator) private view {
        (, int256 answer, , uint256 updatedAt, ) = IChainlinkAggregator(_aggregator).latestRoundData();
    }
    function __validateAggregator3(address _aggregator) private view {
        (, int256 answer, , uint256 updatedAt, ) = IChainlinkAggregator(_aggregator).latestRoundData();
        require(answer > 0, "__validateAggregator: No rate detected");
    }
