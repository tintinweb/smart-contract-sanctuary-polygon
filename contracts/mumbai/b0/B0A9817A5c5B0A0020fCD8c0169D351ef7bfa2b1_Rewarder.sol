...
contract Rewarder is    Initializable,
    ...
    function rewardERC721(
        ...
        uint256 tokenId = IERC721(tokenAddress).issueToken(recipient);
    ...
    function rewardERC1155(
        ...
        IERC1155(tokenAddress).issueToken(recipient, tokenId, amount);
    ...
    function rewardERC1155Batch(
        ...
        IERC1155(tokenAddress).issueTokenBatch(recipient, tokenIds, amounts);
