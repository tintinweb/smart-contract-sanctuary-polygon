...
contract CLEGSale is ReentrancyGuard, Ownable {
    ...
    constructor(uint256 totalLimit_, IERC20 BUSD_){
        totalLimit = totalLimit_;
        BUSD = BUSD_;
    }
    ...
    function buy(uint256 amount) external nonReentrant {
        require(getTotalSale().add(amount)<=getTotalLimit());
        BUSD.transferFrom(msg.sender, address(this), amount);
        updateUser(msg.sender, amount);
    }
