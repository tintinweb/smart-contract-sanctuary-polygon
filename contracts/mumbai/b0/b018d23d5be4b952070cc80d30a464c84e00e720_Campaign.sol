...
/* 
    ...
    campaign entity,
    shuttle is part of the campaign,
    claims entity - user deposits.
 */
...
contract CampaignSecurityModule is AccessControlUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable {
