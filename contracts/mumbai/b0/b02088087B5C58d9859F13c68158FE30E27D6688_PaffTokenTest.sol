...
/// @custom:security-contact tokenmaster.paffstudios.com
contract PaffTokenTest is ERC20, ERC20Capped, ERC20Burnable, Pausable, AccessControl, ERC20Permit, ERC20Votes{
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    constructor(uint256 cap) ERC20("PaffTokenTest", "PFTT") ERC20Permit("PaffTokenTest") ERC20Capped(cap) {
