...
contract LIBERTY is ERC721A , Ownable  {
    ...
    uint public maxPurchase = 1;

    uint256 public MAX = 2000;
    ...
    function changeMaxMint(uint256 maxMint) public onlyOwner {
     ...
     constructor() ERC721A("Libert Networks Launch", "LIBERTY") {}

        function withdraw() public onlyOwner {
        uint balance = address(this).balance;
        
        address payable one = payable(0xABC338aC3E8fabbc5201798320150FA091971aDd);
        
        one.transfer(balance.mul(100).div(100));
