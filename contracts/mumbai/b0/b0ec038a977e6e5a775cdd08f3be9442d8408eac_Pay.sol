...
contract Pay is BasePay {
    ...
    function pay(
        ...
        if (address(0) != settleToken) {
            ...
            if (merchantInfo.autoSettle) {
                _autoWithdraw(_merchant, merchantInfo.settleAccount, settleToken, _orderAmount - fee);
            } else {
            ...
            emit Order(_orderId, _paiAmount, _currency, _orderAmount, settleToken, fee, merchantInfo.account, msg.sender, merchantInfo.rate);
            ...
            if (merchantInfo.autoSettle) {
                _autoWithdraw(_merchant, merchantInfo.settleAccount, _currency, _paiAmount - fee);
            } else {
            ...
            emit Order(_orderId, _paiAmount, _currency, _orderAmount, _currency, fee, merchantInfo.account, msg.sender, merchantInfo.rate);
    ...
    function payWithETH(
        ...
        if (address(0) != settleToken) {
            ...
            emit Order(_orderId, _paiAmount, WETH9, _orderAmount, settleToken, fee, merchantInfo.account, msg.sender, merchantInfo.rate);
            ...
            if (merchantInfo.autoSettle) {
                _autoWithdraw(_merchant, merchantInfo.settleAccount, WETH9, _paiAmount - fee);
            } else {
            ...
            emit Order(_orderId, _paiAmount, WETH9, _orderAmount, WETH9, fee, merchantInfo.account, msg.sender, merchantInfo.rate);
...
interface IMerchant {
    ...
    function setMerchantRate(address _merchant, uint256 rate) external;
