...
contract BSBFactoryUpgradeable is Initializable, OwnableUpgradeable, IBSBTypes, BSBBaseUpgradeable, VRFConsumerBaseUpgradeable {
    ...
    uint public cappedLevelForBloodTokenSpending;
    ...
    function setCappedLevelForBloodTokenSpending(uint amount_) external onlyOwner {
        cappedLevelForBloodTokenSpending = amount_;
    }
    ...
    function _runReRoll(
        ...
        if (isReRollSuccessful) {
            ...
            delete gen1BonusPercentages[toBeUpgradedTokenId_];
        } else {
    ...
    function _calculateReRollStats(
        ...
        uint totalPrice_ = _calculatePrice(toBeUpgradedTokenId_, currentAdditionalTax_);
    ...
    function _calculatePrice(uint tokenId_, uint additionalTax_) internal view returns(uint) {
        return gen1ReRollStartingPrice + gen1ReRollAdditionalTax[tokenId_] + additionalTax_;
    }
