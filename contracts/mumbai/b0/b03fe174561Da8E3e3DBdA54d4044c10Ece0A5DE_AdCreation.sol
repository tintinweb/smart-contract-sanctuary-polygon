...
contract AdCreation is NFT721Metadata {
    ...
    mapping(address => AdInfo[]) public adInfos;

    uint256 uniqueID = 1;

    mapping(address => uint[]) public userAds;

    event AdCreated(address advertiser, uint tokenID, string ipfsPath, string[6] adDetails);
    ...
    function _initializeAdvertiserRegistration(address _registry) internal {
        ...
        require(
            ...
            "Amigo Ad creation: Address is not a contract"
        );
        registry = _registry;
    }
        ...
        external
    {
        ...
        adInfos[msg.sender].push(AdInfo({
            title:adDetails[0],
            targetLink : adDetails[1],
            category : adDetails[2],
            content : adDetails[3],
            layout : adDetails[4],
            targetPlatform : adDetails[5],
