...
contract ScosNft is ERC721, AccessControlEnumerable, ERC721Pausable {
    // Create a new role identifier for the minter role
    // role hash: a49807205ce4d355092ef5a8a18f56e8913cf4a201fbe287825b095693c21775
    bytes32 public constant ADMIN_ROLE = keccak256("ADMIN_ROLE");

    // role hash: 154c00819833dac601ee5ddded6fda79d9d8b506b911b3dbd54cdb95fe6c3686
    ...
    constructor() ERC721("SCOS_NFT", "SCOS_NFT") {
    ...
    function mint(
        ...
        _tokenIds.increment();
        _safeMint(to, newId);
        _tokens.push(Info(newId, tokenType, tokenCode));
        return newId;
    }
    ...
    function tokenOf(address owner) external view returns (uint256[] memory) {
        require(_msgSender() == owner,"only inquire about yourself!");
        require(_ownedTokens[owner].length > 0, "no data!");
    ...
    function _removeTokenFrom(address _from, uint256 _tokenId) private {
        if (_from != address(0)) {
            ...
            uint256 _lastTokenIndex = _ownedTokens[_from].length - 1;
    ...
    function getInfo(uint256 _tokenId) external view returns (Info memory) {
