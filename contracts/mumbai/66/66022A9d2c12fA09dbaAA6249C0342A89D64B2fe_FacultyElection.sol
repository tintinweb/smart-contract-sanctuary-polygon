...
contract FacultyElection {
    ...
    function getCandidateData(uint256 _index)
        public
        view
        returns (
            uint256,
    ...
    function giveVoterRight(uint256 _matriculationNumber) external {
        require(
            msg.sender == votingOrganizer,
        ...
        // Check department and matriculation number eligibility
        require(
            (1404144001 <= _matriculationNumber && _matriculationNumber <= 1404144150) ||
            (1404244001 <= _matriculationNumber && _matriculationNumber <= 1404244150),
            "Invalid department or matriculation number"
        );
