...
// File: contracts/EthermonAdventureSite.sol
...
contract EtheremonAdventureSite is
    NFTStandard("EtheremonAdventure", "EMOND"),
    BasicAccessControl
{
    uint256 public MAX_OWNER_PERS_SITE = 10;
    ...
    function SetMaxSiteID(
        ...
        uint256 _MAX_OWNER_PERS_SITE
    ) external onlyModerators {
        MAX_SITE_ID = _MAX_SITE_ID;
        MAX_OWNER_PERS_SITE = _MAX_OWNER_PERS_SITE;
        MAX_SITE_TOKEN_ID = MAX_SITE_ID * MAX_OWNER_PERS_SITE;
    }
