...
/////////////////////////// Functions for Staking, Unstaking and Jackpot of LMS ///////////////////////////
    ...
    */
    function stakeTokens(IERC20 token, uint256 amount) external noReentrant {
        ...
        jackpotTime = block.timestamp.add(300);
        minimumStakingTime[msg.sender] = block.timestamp.add(300);
...
/////////////////////////// Functions for Rewards from Staking APR ///////////////////////////
    ...
    */
    function calculateRewards() external noReentrant {
        ...
        require(block.timestamp > initialRewardTimeStamp.add(300),"24hrs not passed yet since the last reward calculation");
        initialRewardTimeStamp = block.timestamp;
