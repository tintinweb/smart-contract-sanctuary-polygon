...
contract DcRouter is ERC1155Upgradeable, SmartLZBase, UUPSUpgradeable {
    ...
    *       (https://layerzero.gitbook.io/docs/technical-reference/testnet/testnet-addresses)
    ...
    function initialize(uint16 nativeChain,
        ...
        remotes[actionPoolNativeId] = abi.encode(actionPool);
   ...
   * @notice Set address of native stable token for this router
    ...
    * @dev only deCommas ActionPool Address
    */
    function _startStrategyList(bytes memory actionData) private {
    ...
    * @dev only deCommas ActionPool Address
    */
    function _stopStrategyList(bytes memory actionData) private {
        (uint256 strategyId) = abi.decode(actionData, (uint256));
