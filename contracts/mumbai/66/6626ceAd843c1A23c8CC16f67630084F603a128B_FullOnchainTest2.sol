...
contract  FullOnchainTest2 is ERC721Enumerable, ERC721Permit("FullOnchainTest2NFT:Token"), ERC721Mintable, ReentrancyGuard, Ownable {

    string[] private letters ;
    string[] private fontColors ;
    string[] private backgroundColors ;

    constructor() ERC721("FullOnchainTest2NFT:Token", "FULL TEST") Ownable() {}
