...
contract KashiPair is ERC20, BoringOwnable, IMasterContract {
    ...
    uint256 private LIQUIDATION_MULTIPLIER; // add 12%
    uint256 private constant LIQUIDATION_MULTIPLIER_PRECISION = 1e5;

    // Fees
    uint256 private PROTOCOL_FEE; // 10%
    uint256 private constant PROTOCOL_FEE_DIVISOR = 1e5;
    uint256 private BORROW_OPENING_FEE; // 0.05%
    ...
    function init(bytes calldata data) public payable override {
        ...
        (
            ...
            PROTOCOL_FEE,
            BORROW_OPENING_FEE
        ) = abi.decode(data, (IERC20, IERC20, IOracle, bytes, uint256, uint256, uint256));
