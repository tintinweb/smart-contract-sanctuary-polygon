...
/// @title CraftObject
// CraftObject smart contract inherits ERC1155 interface
contract CraftObject is BaseObject, ERC1155Supply {
    /* -------------------------------------------------------------------------- */
    /*                                   CONFIG                                   */
    /* -------------------------------------------------------------------------- */
    ...
    /*                                   EVENTS                                   */
    /* -------------------------------------------------------------------------- */
    event CreateCraftObject(uint256 tokenId, string uri, Size size, address payable creator);
    event LogCraftObject(address indexed sender, uint256 tokenId);
    event SetCraftLogic(address indexed craftLogic);
    ...
    /*                               INITIALIZATION                               */
    /* -------------------------------------------------------------------------- */
    constructor(address payable _treasuryAddress, address _phiMapAddress, address _craftLogic) ERC1155("") {
    ...
    function createObject(
        ...
        emit CreateCraftObject(tokenId, tokenUri, size, creator);
    }
    ...
    function burnObject(address from, uint256 id, uint256 amount) external nonReentrant {
        // burn the token
        super._burn(from, id, amount);
    }

    function burnBatchObject(address from, uint256[] memory tokenids, uint256[] memory amounts) external nonReentrant {
        // burn the token
