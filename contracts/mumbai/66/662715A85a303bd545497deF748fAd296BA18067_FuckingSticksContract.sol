...
//    / ____/_  _______/ /__(_)___  ____ _   / ___// /_(_)____/ /_______
//   / /_  / / / / ___/ //_/ / __ \/ __ `/   \__ \/ __/ / ___/ //_/ ___/
//  / __/ / /_/ / /__/ ,< / / / / / /_/ /   ___/ / /_/ / /__/ ,< (__  ) 
// /_/    \__,_/\___/_/|_/_/_/ /_/\__, /   /____/\__/_/\___/_/|_/____/  
//                               /____/                                 
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x1bf5CcF30d520624b57d01196C250a5Abaac55Bf];
...
abstract contract EarlyMintIncentive is Ownable, ERC721A {
  ...
  uint256 public EARLY_MINT_PRICE = 2 ether;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 15, 2000) { }
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeidkfhd7yvwc2xx7qs2uehw42ivsax3rb7ztff4ubgaeyzlapwbxuq/";
...
// File: contracts/FuckingSticksContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract FuckingSticksContract is RamppERC721A {
    constructor() RamppERC721A("Fucking Sticks", "FCKS"){}
}
