...
contract BurnToclain is ERC721LazyMint {
        ...
        override
    {
        ...
        require(mainNFT.balanceOf(_claimer) >= _quantity, "Voce nao tem o NFT 01 na sua wallet!");
        require(burnNFT.balanceOf(_claimer, 0) >= _quantity, "Voce nao tem o NFT 02 na sua wallet!");
    }
