...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x792e51da39C39BbDb231C411cBE1ABc1deD187bD];
...
// File: contracts/TheJemCardV1Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract TheJemCardV1Contract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "The JEM Card V1";
