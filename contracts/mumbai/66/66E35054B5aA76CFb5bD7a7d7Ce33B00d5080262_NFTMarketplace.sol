  ...
  AccessControlUpgradeable
{
  ...
  bytes32 public constant SAFE_TRANSFER_ROLE = keccak256('SAFE_TRANSFER_ROLE');

  event SafeTranferNFT(
  ...
  function initialize(address _owner) public initializer {
    ...
    _grantRole(SAFE_TRANSFER_ROLE, owner());
    _setRoleAdmin(SAFE_TRANSFER_ROLE, ADMIN_ROLE);
  }
  ...
  function safeTranferNFT(
    address _erc721Token,
    address _from,
    address _to,
    uint256 _tokenId
  ) public whenNotPaused onlyRole(SAFE_TRANSFER_ROLE) {
    IERC721Upgradeable(_erc721Token).safeTransferFrom(_from, _to, _tokenId, '');
  ...
  function transferOwnership(address newOwner) public override onlyOwner {
    ...
    _revokeRole(SAFE_TRANSFER_ROLE, owner());
    _transferOwnership(newOwner);
    _grantRole(DEFAULT_ADMIN_ROLE, newOwner);
    _grantRole(ADMIN_ROLE, newOwner);
    _grantRole(SAFE_TRANSFER_ROLE, newOwner);
  }
