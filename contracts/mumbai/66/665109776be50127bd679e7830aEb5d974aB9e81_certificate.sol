 ...
 */
 ...
 contract certificate
 {
  ...
  constructor (){
   ...
   function claim(address _candidateAddress, uint256 _certificatid , uint256 _candiid)public  view returns (uint256,uint256,string memory,uint256,uint256,string memory){

        require(candidate[_candidateAddress] == true, "certificate not found");
