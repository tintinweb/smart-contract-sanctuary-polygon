...
contract T222 is Ownable, TimeForDay, SortList {
    ...
    function getDaoReward2(address _user, uint256 _type) public view returns (uint256 _totalReward, bool isDao, UserDaoItem memory x, uint256 _investId, uint256 _daoType, bool _ok, xx memory y) {
        ...
        y = xx(tatalInvestNumber == 0, _type > 3, !isDao, _type != _daoType);
        if (_ok) {
            _totalReward = 0;
        }
        if (_type == 0) {
