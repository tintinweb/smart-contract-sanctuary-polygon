...
contract RandomSVG is ERC721URIStorage, VRFConsumerBase {
    ...
    constructor(address _VRFCoordinator, address _LinkToken, bytes32 _keyHash, uint256 _fee) ERC721 ("RandomSVG", "rsNFT") VRFConsumerBase(_VRFCoordinator, _LinkToken) {
    ...
    function finishMint(uint256 _tokenId) public {
        ...
        require(tokenIdToRandomNumber[_tokenId] > 0, "Need to wait for Chainlink!");
    ...
    function generatePathCommand(uint256 _randomNumber, uint _i) public view returns (string memory pathCommand) {
        if(_i == 0) {
            pathCommand = pathCommands[0];
        } else {
    ...
    function formatTokenURI(string memory imageURI) public pure returns (string memory) {
        ...
        return string(abi.encodePacked( baseURL,
            Base64.encode(
                bytes(abi.encodePacked('{"name": "SVG NFT", "decsription":"An NFT based on SVG!", "attributes":"", "image":"', imageURI, '"}'))
        )));
    }
