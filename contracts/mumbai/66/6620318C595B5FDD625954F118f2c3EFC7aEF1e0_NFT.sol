...
interface IERC721Receiver {
     ...
     * by operator fromfrom, this function is called.
     *
 ...
 * {ERC721Enumerable}.
 */
contract NFT is Context, ERC165, IERC721, IERC721Metadata, Ownable {
     ...
     */
    constructor(string memory name_, string memory symbol_, uint256 supply_, uint256 rate, string memory uri) {
        _name = name_;
        _symbol = symbol_;
        _supply = supply_;
         mintingRate = rate;
