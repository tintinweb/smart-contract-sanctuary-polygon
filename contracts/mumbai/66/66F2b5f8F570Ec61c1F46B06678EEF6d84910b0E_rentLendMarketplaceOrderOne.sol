...
contract rentLendMarketplaceOrderOne is
    Ownable,
    ReentrancyGuard,
    IRentLendMarketplace
{
    ...
    address public squidRouter = 0xC3468a191Fe51815b26535ED1F82C1f79e6Ec37D;
    modifier onlySquidRouter() {
        if (msg.sender != squidRouter) {
            revert InvalidCaller(squidRouter, msg.sender);
        }
        _;
    }

    function listItemCrossChain(
        NFTStandard _nftStandard,
        address _nftAddress,
        uint256 _tokenId,
        uint256 _tokenQuantity,
        ...
        if (_nftStandard == NFTStandard.E721) {
            ...
            require(ownerOf == _tokenHolder, "You Do not own the NFT");
        ...
        tokenSellerStorage.sellerAddress = payable(_tokenHolder);
        ...
        addressToTokenIdToListedQty[_nftAddress][_tokenId][_tokenHolder] = true;
