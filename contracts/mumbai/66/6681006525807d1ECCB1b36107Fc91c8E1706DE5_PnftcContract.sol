...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x55d6827618D153f7c362E5f112b060204B7c1737];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://https://gateway.pinata.cloud/ipfs/QmeSBmYhczV7jRUbAJYzWGq5tP79GMkiZjL1uPycrEooXX//";
...
// File: contracts/PnftcContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PnftcContract is RamppERC721A {
    constructor() RamppERC721A("PNFTC", "PNFTC"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/FEhRjdxuNuKGNtDvLCxv/contract-metadata";
    }
}
