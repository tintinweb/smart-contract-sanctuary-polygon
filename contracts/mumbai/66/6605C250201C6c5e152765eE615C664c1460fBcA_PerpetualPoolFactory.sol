    ...
    IPerpetualPoolFactory
{
     ...
     * @param   _iFundTransferConvergenceHours virtual pool
    ...
    function setPoolParam(
        ...
        } else if (_isStringEqual(_name, "iFundTransferConvergenceHours")) {
            //uint16
            uint16 iFundTransferConvergenceHours = uint16(uint128(_value));
            _validateFundTransferConvergenceHours(iFundTransferConvergenceHours);
            pool.iFundTransferConvergenceHours = iFundTransferConvergenceHours;
    ...
    {
        require(
            _iFundTransferConvergenceHours >= 5 && _iFundTransferConvergenceHours <= 200,
