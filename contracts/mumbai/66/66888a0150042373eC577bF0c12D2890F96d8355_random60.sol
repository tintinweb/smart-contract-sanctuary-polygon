...
contract random60 is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("random60", "RREE") {
    setHiddenMetadataUri("ipfs://QmU7ycaY8dzwW3a2jX92fZMaEFZKRL2MDhF6SD2zA6d1gY/hidden.json");
  }
