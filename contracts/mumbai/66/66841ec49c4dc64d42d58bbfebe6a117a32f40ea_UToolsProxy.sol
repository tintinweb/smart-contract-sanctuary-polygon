...
/**
 * @title UTools, support ETH and ERC20 Tokens
...
contract UpgradeabilityProxy is Proxy {
    ...
    bytes32 private constant implementationPosition =
        keccak256("utools.me.proxy.implementation");
     ...
     */
    function _upgradeTo(address _newImplementation, string _newVersion)
        internal
    {
 ...
 */
contract UToolsProxy is UpgradeabilityProxy {
    /**
    ...
    bytes32 private constant proxyOwnerPosition =
        keccak256("utools.me.proxy.owner");
     ...
     */
    function upgradeTo(address _implementation, string _newVersion)
        public
        onlyProxyOwner
    {
