...
contract MyERC2981 is ERC721URIStorage, Ownable, ERC2981 {
    ...
    constructor() ERC721("Sample ERC2981", "TKN") {
        console.log("This is my ERC2981 contract.");
        // 受取先のアドレスとロイヤリティを設定
        // ロイヤリティは万分率で指定する ex） 10%　の場合、1000）
