...
contract Certifi is ERC721, ERC721URIStorage {
    ...
    constructor() ERC721("Certifi", "CER") {
        owner = msg.sender;
    }
    ...
    // function safeMint(address to,string memory uri,uint _price) public {
    ...
    function BuyNFT(address from,address to,uint256 _tokenId) payable public {
        ...
        // require(gettokenidByaddress[from] == _tokenId,"Caller is not owner of the NFT");
        require(msg.value >= pricefortokenid[_tokenId], "Not Enough funds to buy");
        payable(owner).transfer(msg.value);
        _transfer(from, to, _tokenId);
    }

    function getCountOfNfts() public view returns(uint) {
