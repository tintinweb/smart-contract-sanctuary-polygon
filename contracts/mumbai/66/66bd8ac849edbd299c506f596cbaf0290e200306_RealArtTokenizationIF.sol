...
// File: Codes/Remix/Real/RealArtworkTokenizationIF.sol
...
//
contract RealArtTokenizationIF{
//contract RealArtTokenizationIF is Ownable{
    ...
    // 
    function readArtCredential()
      public view returns (string memory, string memory, string memory){

      string memory realText0 = "Art Token Credential : [1] DID Credential , [2] Token Name";
    ...
    function readArtToken()
      public view returns (string memory, uint256, uint256){

      string memory realText0 = "Art Token Information : [1] Edition number , [2] Total supply";
      uint256 realNumber1 = realContract.readAssetIdNext() - 1;
    ...
    //
    // transfer ART Tokens from msg.sender
    // back to the Real Contract owner only
    //
    function claimArtTokenBack(
        //address from,
        address toContract,
        uint256 tokenId,
        uint256 amount,
    ...
    // mint additional Art Edition on top of the first NFT
    // auto tokenId
    function mintArtEdition(
        ...
        string memory realText0 = "New Art Edition minted [Token ID , Supply]";
