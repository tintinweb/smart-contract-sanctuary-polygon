...
abstract contract CrosschainDistributor is AdvancedDistributor, ICrosschain {
  ...
  */
  ...
  function _settleClaim(
    ...
    console.log("CrosschainDistributor: emitting CrosschainClaim");
...
contract FairQueue {
  ...
  /**
		...
		@dev The delay is determined by calculating a distance between the user's address and a blockhash using the XOR distance metric (c.f. Kademlia)
