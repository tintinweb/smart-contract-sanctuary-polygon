...
contract BridgeControl is Ownable{
    ...
    event TransferToEthereum(address indexed fromEthAdr,address indexed toEthAdr, address indexed toProxyAdr, address token, address vToken, uint256 value);
	...
	function transferToEthereum(address from,address vToken, address to, uint256 amount) external {
        ...
        emit TransferToEthereum(fromEthAddr,toEthAddr, to, token, vToken, targetAmount);
	}
