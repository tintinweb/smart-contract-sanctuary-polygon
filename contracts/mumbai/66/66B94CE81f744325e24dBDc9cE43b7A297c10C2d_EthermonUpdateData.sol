...
interface EtheremonDataBase {
    ...
    function getElementToArrayType(EthermonEnum.ArrayType _type, uint64 _id) external view returns(uint8[] memory);
    function updatElementToArrayType(EthermonEnum.ArrayType _type, uint _index, uint64 _id, uint8 _value) external returns(uint);
    ...
    NativeMetaTransaction
{
        ...
        )
    {
        ...
        uint8[] memory _stats = data.getElementToArrayType(
            ArrayType.STAT_START,
            uint64(_classId)
        );
        // uint8[] memory _types = data.getElementToArrayType(
        //     ArrayType.CLASS_TYPE,
        //     uint64(_classId)
        // );
        _price = class.price;
        _catchable = class.catchable;
        //_type = _types[0];
        _type = 0;
        _ss1 = _stats[0];
        _ss2 = _stats[1];
    ...
    function updateMonsterClassExtend(
        uint32 _classId,
        uint8 _type2,
        uint8 _type3,
        uint8 _st1,
    ...
    function getMonsterClassExtend(uint32 _classId)
        public
        view
        returns (
            uint8 _type2,
        ...
        )
    {
        ...
        uint8[] memory _steps = data.getElementToArrayType(
            ArrayType.STAT_STEP,
            uint64(_classId)
        );
        _type2 = _types[0];
