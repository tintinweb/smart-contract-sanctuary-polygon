...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x8a011Ad0f0aE30fCE52766D8ec2Cd3Fa2021307a];
...
// File: contracts/VariousArtistHaikuremixesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract VariousArtistHaikuremixesContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Various Artist  HAIKU REMIXES";
    string public symbol = "HAIKURMX";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/e7xlBxv0Q4dvwd4WxvXb/contract-metadata";
  }
