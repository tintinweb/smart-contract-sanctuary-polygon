...
contract BatchWeb3Bazaar is Context, ERC1155Holder, ERC721Holder, MultiAccessControl
{
    ...
    //string private _name;
    string private _symbol;
    mapping(uint256 => Trade) public _transactions;
    ...
    function getTrade(uint256 tradeId, address userWallet) public view returns (address[] memory)
    {
        Trade storage store = _transactions[tradeId];
        return store._traders[userWallet].tokenAddress ;
    }
    ...
    /*
    function getTradeInfoCreator(uint256 tradeId) public view returns(address[] memory , address, uint256, uint256, uint8, uint8, uint8 )  {
        Trade storage store = _transactions[tradeId];
