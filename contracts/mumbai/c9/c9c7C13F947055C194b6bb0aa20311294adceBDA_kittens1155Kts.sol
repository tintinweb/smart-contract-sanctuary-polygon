...
contract kittens1155Kts is ERC1155 {
    uint256 public constant White = 1;
    uint256 public constant Red = 2;
    uint256 public constant Grey = 3;
    uint256 public constant Black = 4;

    constructor() ERC1155("https://ipfs.io/ipfs/bafybeib5dzhx3npf73xox7743rsxcxnzxgk6hna6fvfnk2t6xafk6weyry/{id}.json") {
        _mint(msg.sender, White, 1, "");
        _mint(msg.sender, Red, 1, "");
        _mint(msg.sender, Grey, 20, "");
