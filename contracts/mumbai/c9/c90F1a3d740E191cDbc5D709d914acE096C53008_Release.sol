    ...
    */
    function getNumberOfTimesToHalve() public view virtual returns (uint256) {
        if(_firstReleaseTime>0){
            ...
            // console.log("the numberOfTimesToHalve is ",numberOfTimesToHalve);
    ...
    function release() public virtual {
        ...
        // console.log(amount);
        // console.log(_firstReleaseTime);
        // console.log(address(_receivingAddress));
        // console.log(address(_token));
        // console.log(block.timestamp,releaseTime);
