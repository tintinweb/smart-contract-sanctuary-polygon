...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x740d66377c8CEAB046749eC61dE3e856d66598dB];
...
// File: contracts/MintieroContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract MintieroContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "mintiero";
    string public symbol = "mintiero";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/Y7BQEyupdIWphmMtDOyW/contract-metadata";
  }
