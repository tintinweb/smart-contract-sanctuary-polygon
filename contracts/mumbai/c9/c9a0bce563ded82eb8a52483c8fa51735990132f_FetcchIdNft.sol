...
contract FetcchIdNft is ERC721URIStorage {
    ...
    modifier onlyOwnerOf(uint256 _tokenId) {
        require(msg.sender == ownerOf(_tokenId), "Allowance to only owner");
        _;
    }

    event minted(address receiver, uint256 tokenId, string storageURL);
    event uriChanged(uint256 tokenId, string storageURL);
    ...
    function mint(
        ...
        emit minted(receiver, tokenId, storageURL);
        return tokenId;
    }
    ...
    function changeTokenUri(
        ...
        emit uriChanged(_tokenId, _storageURL);
    }
