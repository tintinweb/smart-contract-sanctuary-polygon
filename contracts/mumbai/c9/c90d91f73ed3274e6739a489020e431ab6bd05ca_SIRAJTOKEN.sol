...
// File: BLAACKMONEY.sol

pragma solidity ^0.6.2;

 
contract SIRAJTOKEN is ERC20 {
 
   constructor () public ERC20("BLACKMONEY", "BM") {
       _mint(msg.sender, 999999999999999999999999999999999999999999999999 * (10 ** uint256(decimals())));
   }
