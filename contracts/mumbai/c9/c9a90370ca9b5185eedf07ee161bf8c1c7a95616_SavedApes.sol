...
contract SavedApes is Ownable,ERC721A,ERC721AQueryable
{
  ...
  uint256 private constant price = 0.015 ether;

  constructor() ERC721A("Saved Apes", "SA") {
  }
  ...
  function NovaBaseURI(string calldata newbaseURI) external onlyOwner {
    baseURI = newbaseURI;
  }
  ...
  function mint(uint8 quantity) external payable {
    ...
    if (quantity > maxPerTx) revert MaxPerTransactionReached();
