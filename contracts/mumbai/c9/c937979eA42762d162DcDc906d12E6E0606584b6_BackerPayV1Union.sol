...
contract BackerPayV1Union is IBackerPayV1Union {
        ...
        ensure(deadline)
    {
        ...
        p.balanceOf[address(0)] = p.balanceOf[address(0)] + msg.value - commission;
        emit Ledger(
            paymentId,
            commission,
            msg.value,
    ...
    function paymentToken(
        ...
        p.balanceOf[tokenAddr] = p.balanceOf[tokenAddr] + amount - commission;
        emit Ledger(
            paymentId,
            commission,
            amount,
    ...
    function refund(
        ...
        p.balanceOf[tokenAddr] = p.balanceOf[tokenAddr] - amount;
