...
contract  FullOnchainTest6 is ERC721Enumerable, ERC721Permit("FullOnchainTest6NFT:Token"), ERC721Mintable, ReentrancyGuard, Ownable {
    ...
    constructor() ERC721("FullOnchainTest6NFT:Token", "FULL TEST") Ownable() {}


    function setInfo(string memory _letter, string memory _fontColor, string memory _backgroundColor, uint256 _tokenId) public onlyOwner {
        require(vacantLetter(_letter), "the letter is used");
        letters[counter] = _letter;
        fontColors[counter] = _fontColor;
        backgroundColors[counter] = _backgroundColor;
        tokenIdNumber[_tokenId] = counter;
        counter++;
    }
