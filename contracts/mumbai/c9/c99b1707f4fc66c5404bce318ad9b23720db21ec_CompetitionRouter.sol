...
contract CompetitionRouter is ICompetitionRouter, Ownable {
     ...
     */
    function createBracketPrediction(bytes32 _competitionId, uint8[] calldata _matchPredictions) payable public {
        CompetitionImpl impl = _factory.getCompetitionImplType(_competitionId);
        if(impl == CompetitionImpl.PAID_PREDICTABLE) {
            IPaidPredictableCompetition comp = IPaidPredictableCompetition(_factory.getCompetitionAddress(_competitionId));
            ...
            if(info.isNetworkToken) {
                ...
                comp.createBracketPredictionGasToken(msg.sender, _matchPredictions);
            } else {
...
interface ICompetitionRouter {
     ...
     */
    function createBracketPrediction(bytes32 _competitionId, uint8[] calldata _matchPredictions) payable external;
    /**
