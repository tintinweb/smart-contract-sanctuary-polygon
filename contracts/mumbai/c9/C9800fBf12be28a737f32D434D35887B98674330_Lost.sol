...
contract Lost is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("Lost", "LMC") {
  ...
  uint256 public constant MAX_TOKEN_ID = 499;
