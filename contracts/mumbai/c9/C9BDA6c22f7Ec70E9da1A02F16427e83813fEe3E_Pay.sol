...
abstract contract BasePay is Initializable, OwnableUpgradeable{
    ...
    event Order(string orderId, uint256 paidAmount,address paidToken,uint256 orderAmount,address settleToken,uint256 fee,address merchant, address payer, uint256 rate);
...
contract Pay is BasePay {
    ...
    function pay(
        ...
        if (address(0) != settleToken) {
            ...
            emit Order(_orderId, _paiAmount, _currency, _orderAmount, settleToken, totalFee, merchantInfo.account, msg.sender, merchantInfo.rate);
            ...
            emit Order(_orderId, _paiAmount, _currency, _orderAmount, _currency, totalFee, merchantInfo.account, msg.sender, merchantInfo.rate);
