...
contract Contest {
    ...
    function vote (
        ...
        _tokenKVT.transferFrom(msg.sender, to, 1000);
        ...
        IERC20(_rewardAddress).transferFrom(msg.sender, address(this), balanceProposal + balanceAll);
    }
    ...
    function withdraw(
        ...
        tmpBalance = _tokenKVT.balanceOfAt(address(this), _currentSnapshotId);
