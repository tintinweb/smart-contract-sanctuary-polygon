...
contract KOLSelling is Pausable {
    ...
    modifier basicCheck(uint256 _amount) {
        require(
            ...
            "This Contract don't have enough token"
        );
    ...
    function setDetails(
        ...
        require(
            token.balanceOf(address(this)) >= _max_Release,
            "Contract have not enough token"
        );
        swapRate = _swapRate;
        ...
        whenNotPaused
    {
        ...
        require(
            msg.value > 0 && msg.value >= paymentTobuy,
    ...
    function buyWithWETH(uint256 _buyamount, uint256 _payamount)
        external
        basicCheck(_buyamount)
        whenNotPaused
    {
        ...
        require(
            WETH.allowance(msg.sender, address(this)) >= _payamount,
            "Not enough WETH allowance"
        );
        ...
        whenNotPaused
    {
        ...
        require(
            USDT.allowance(msg.sender, address(this)) >= _payamount,
