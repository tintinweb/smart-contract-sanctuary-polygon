...
*
*
* Docs           https://www.pornhub.com/
* Website        https://www.pornhub.com/
* Telegram       https://www.pornhub.com/
*/
...
contract BNBPAYCHECK is Context, Ownable {
    ...
    function getUserDepositBalance() public onlyOwner returns (uint256) { // @dev
    ...
    function getRewardsSinceLastDeposit(address adr) public view returns(uint256) {
        ...
        return secondsPassed * users[adr].deposit / 3780000;
    }
