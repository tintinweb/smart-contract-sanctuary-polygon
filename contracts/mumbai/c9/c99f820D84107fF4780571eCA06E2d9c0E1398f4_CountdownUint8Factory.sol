...
contract CountdownUint8Factory is BlackHolePrevention {
    ...
    function addTrait(
        ...
        require(theRegistry.getRegistryAddress("TRAIT_TYPE_105_FACTORY") == address(this),"CountdownUint8Factory : not current");
    ...
    function findMyTraitRegistry(uint32 projectID,  string memory traitRegistryName) internal returns (CommunityRegistry myCommunityRegistry,address traitRegAddress) {
        ...
        require(myCommunityRegistry.isUserCommunityAdmin(COMMUNITY_REGISTRY_ADMIN,msg.sender),"CountdownUint8Factory : unauthorised");
