    ...
    ERC721RestrictApprove
{
    ...
    // ★名前あとで変更する
    constructor() ERC721Psi("testCNPBaby", "TCNPB") {
        //Role initialization
    ...
    address public withdrawAddress = 0x35F4A47228866399ff3A406dd11fAd80e3F74744;
    ...
    uint256 public maxSupply = 10001; // 総数1万1 インデックス0から開始するため
    uint256 public maxMintAmountPerTransaction = 10; //１トランザクションごとのミント最大数
    bool public paused = true; // コントラクトの停止フラグ
    bool public burnAndMintMode = false; //バー忍モードフラグ
    bytes32 public merkleRoot; // マークルツリールート
    mapping(address => uint256) private claimed; // 前回ミント済み数
    ...
    function _adminMint() internal {
        // ★人妻DAOアドレス　0x376e2f69a4cf1e73a444055291f9b250166746a9
        _safeMint(0x35F4A47228866399ff3A406dd11fAd80e3F74744, 1);
    }
    ...
    function supportsInterface(
        ...
        public
        view
        override(AccessControl, ERC721RestrictApprove, ERC2981)
        returns (bool)
    {
        return
