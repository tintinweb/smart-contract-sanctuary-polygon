     ...
     */
      ...
      */
      function startGame(uint8 _maxPlayers, uint256 _entryFee) public onlyOwner {
        // Check if there is a game started already
       ...
       */
       ...
       /**
        * fullfillRandomness is called by VRFCoordinator when it receives a valid VRF proof
        * This function is overrided to act upon the random number generated by Chainlink VRF
        * @param requestId this ID is unique for the request we sent to the VRFCoordinator
        * @param randomness this a random uint256 generated and returned by the VRF Coordinator
        */
        function fulfillRandomness(bytes32 requestId, uint256 randomness) internal virtual override {
            // We want out winnerIndex to be in the length from 0 0 to players.length-1
         ...
         */
         function getRandomeWinner() private returns (bytes32 requestId) {
            // LINK is an internal interface for the Link token found within the VRFConsumerBase
