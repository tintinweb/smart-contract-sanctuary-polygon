...
contract TangibleRentShare is AccessControl {
    ...
    IForwarder public constant forwarder =
        IForwarder(0x4055cb250Ec8d539C5222EAa71fa7e30Fe94f8e9);
        ...
        returns (RevenueShare)
    {
        ...
        if (_contractForToken[token].revenueShare == address(0)) {
            ...
            RentDistributor distributor = new RentDistributor(
                revenueToken,
                ops
            );
            ...
            distributor.grantRole(DISTRIBUTOR_ROLE, ops); // todo: ops or gelato?
            //distributor.grantRole(DISTRIBUTOR_ROLE, IOps(ops).gelato()); // todo: ops or gelato?
...
contract RentDistributor is AccessControl, OpsReady {
    bytes32 public constant DEPOSITOR_ROLE = keccak256("DEPOSITOR");
    bytes32 public constant DISTRIBUTOR_ROLE = keccak256("DISTRIBUTOR");
    ...
    constructor(address tokenContractAddress, address ops) OpsReady(ops) {
