 ...
 */
contract ColleCollection is IColleCollection, ERC721URIStorage, SignatureValidator, MarketAccess {
    /**
     ...
     * @dev This function re-introduces manual transfers, as we intentionally broke transferFrom to avoid accidental un-mirroring of assets
     * @param _from The current owner of the token.
     * @param _to The address to receive the token.
     * @param _tokenId The ID of the token to transfer.
     */
    ...
    /**
     * @notice Reverts ERC721 transfers to break 3rd party marketplace integration.
     * @dev Items should only be transferred in tandem with their mirrored physical goods.
     */
    ...
    /**
     * @notice Reverts ERC721 safe transfers to break 3rd party marketplace integration.
     * @dev Items should only be transferred in tandem with their mirrored physical goods.
     */
    ...
    /**
     * @notice Reverts ERC721 safe transfers (with data) to break 3rd party marketplace integration.
     * @dev Items should only be transferred in tandem with their mirrored physical goods.
     */
    function safeTransferFrom(
        address /*from*/,
