...
contract BornPlanet is BreedPlanetBase, ChainlinkRng {
    ...
    function requestBreed(uint256 planetId) external {
        uint256 requestId = requestRandomWords();

        BornStruct memory bornStruct = BornStruct(msg.sender, planetId);
    ...
    function _rngCallBack(uint256 requestId) internal virtual override {
        ...
        _born(bornStruct.userAddress, bornStruct.planetId);
    }
}
...
abstract contract ChainlinkRng is VRFConsumerBaseV2, Random, Ownable {
    // abstract contract ChainlinkRng is VRFConsumerBaseV2, Random {
