...
contract sISA is ERC20Permit, VaultOwned {
    ...
    event LogSupply(uint256 indexed epoch, uint256 timestamp, uint256 _totalSupply );
    ...
    constructor() ERC20("Staked ISA", "sISA") ERC20Permit("Staked ISA") {
    ...
    /**
        @notice increases sISA supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sISA
