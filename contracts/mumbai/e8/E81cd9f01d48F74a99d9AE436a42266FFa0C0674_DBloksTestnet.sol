...
contract DBloksTestnet is ERC721, ERC721Enumerable, ERC721Burnable, ERC721Royalty, Ownable {
    ...
    bytes32 internal DOMAIN_SEPARATOR = keccak256(abi.encode(
        ...
        keccak256(bytes("DBloksTestnet")),
        keccak256(bytes("1")),
        80001, // Polygon
        address(this)
    ));

    constructor(address trustedForwarder) ERC721("DBloksTestnet", "DBTN") {
        _tokenIds.increment();
    ...
    function mint(uint ammount, bytes32 r, bytes32 s, uint8 v) public payable {
        ...
        require(_msgSender() == ecrecover(digest, v, r, s), "invalid-signatures");
        ...
        require(_msgSender()==_trustedForwarder, "Is not trusted forwarder");
