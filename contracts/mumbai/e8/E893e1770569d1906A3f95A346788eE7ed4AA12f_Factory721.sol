...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new OwnHarvestUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        OwnHarvestUser721Token token = OwnHarvestUser721Token(address(addr));
...
contract OwnHarvestUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
