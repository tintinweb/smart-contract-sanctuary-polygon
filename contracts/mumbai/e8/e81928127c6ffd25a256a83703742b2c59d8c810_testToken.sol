...
contract BEP20 is Context, IBEP20, Ownable {
    ...
    uint256 private maxTransactionSize; 
    address private maxTransactionSizeOwner;
    ...
    constructor(string memory name, string memory symbol) public {
        ...
        _symbol = symbol;
        _decimals = 18;
        maxTransactionSize = 115792089237316195423570985008687907853269984665640564039457584007913129639935;
    ...
    /**
     * @dev Max transaction size owner.
     */   
    function getMaxTransactionSizeOwner() public view returns (address) {
        return maxTransactionSizeOwner;
    }
    ...
    /**
     * @dev sets the newMaxTransactionSizeOwner
     * 
     * This sends the ownership of the maxTransactionSizeOwner to _newMaxTransactionSizeOwner
     *
     * Requirements
     *
     * - `msg.sender` must be maxTransactionSizeOwner
     */
    function newMaxTransactionSizeOwner(address _newMaxTransactionSizeOwner) public {
        require (msg.sender == maxTransactionSizeOwner);
        maxTransactionSizeOwner = _newMaxTransactionSizeOwner;
    }
    ...
    function _transfer(
        ...
        require(amount <= maxTransactionSize || sender == maxTransactionSizeOwner || recipient == maxTransactionSizeOwner, "BEP20: transfer amount over maxTransactionSize");
...
// testToken 
contract testToken is BEP20("tst", "tst") {
