...
contract DivineNft is ERC721URIStorage, ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties, EIP712, AccessControl {

    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    string private constant SIGNING_DOMAIN = "DivineNft-Voucher";
    string private constant SIGNATURE_VERSION = "1";

    mapping (address => uint256) pendingWithdrawals;

    constructor() 
        ERC721("Divine Cards", "DVIN")
    ...
    struct NFTVoucher {
        ...
        string uri;
        /// @notice the percentage to payout for royalty payments
        uint256 royaltyAmount;
        /// @notice the address to receive the royalty payments
  ...
  function _hash(NFTVoucher calldata voucher) internal view returns (bytes32) {
    return _hashTypedDataV4(keccak256(abi.encode(
      keccak256("NFTVoucher(uint256 tokenId,uint256 minPrice,string uri,uint256 royaltyAmount,address royaltyRecipient)"),
      voucher.tokenId,
      voucher.minPrice,
