...
contract ChainBattles is ERC721URIStorage {
    ...
    function generateCharacter(uint256 tokenId) public view returns(string memory){
        ...
        bytes memory svg = abi.encodePacked(
            '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 1440 350">',
            '<style>.base { fill: white; font-family: serif; font-size: 14px; }</style>',
            '<rect width="100%" height="100%" fill="white" />',
            '<path fill="#e7008a" fill-opacity="1" d="M0,288L40,272C80,256,160,224,240,197.3C320,171,400,149,480,149.3C560,149,640,171,720,160C800,149,880,107,960,117.3C1040,128,1120,192,1200,218.7C1280,245,1360,235,1400,229.3L1440,224L1440,0L1400,0C1360,0,1280,0,1200,0C1120,0,1040,0,960,0C880,0,800,0,720,0C640,0,560,0,480,0C400,0,320,0,240,0C160,0,80,0,40,0L0,0Z"></path>'
            ...
            '<text x="50%" y="90%" class="base" dominant-baseline="middle" text-anchor="middle">', "Life: ",life,'</text>',
            '</svg>'
        );
        return string(
            abi.encodePacked(
