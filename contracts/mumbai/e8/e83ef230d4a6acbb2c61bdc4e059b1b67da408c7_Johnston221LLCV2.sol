...
contract Johnston221LLC is Initializable, ContextUpgradeable, IERC20MetadataUpgradeable, UUPSUpgradeable, OwnableUpgradeable, PausableUpgradeable {
    ...
    function airdropNewToken(address[] calldata account, uint256[] calldata amount) external virtual onlyOwner {
    ...
    function _transfer(address from, address to, uint256 amount) internal whenNotPaused virtual {
...
// File contracts/HouseBetaV2.sol



pragma solidity ^0.8.16;

contract Johnston221LLCV2 is Johnston221LLC {
    function mint(address to, uint256 amount) external virtual override onlyOwner {
        require(totalSupply() + amount <= 2000, "Can not mint above 1000");
         _mint(to, amount);
    }
}