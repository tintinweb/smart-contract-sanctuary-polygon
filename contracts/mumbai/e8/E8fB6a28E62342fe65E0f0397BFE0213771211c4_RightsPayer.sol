...
contract RightsPayer {
    ...
    function setMaticPerPlay(uint256 tokens) public onlyAdmin {
        payPerPlay = tokens;
    }
     ...
     */
    function setUsdtPerPlay(uint256 tokens) public onlyAdmin {
        usdtPerPlay = tokens;
    }
    ...
    function payRightsInMatic(uint256 plays) public onlyAdmin {
        ...
        emit RightsPayed("MATIC", total, payPerPlay, plays, receiver, msg.sender);
    }
    ...
    function payRightsInUSDT(uint256 plays) public onlyAdmin {
        ...
        if (!success) revert PayRightsFailed();
        emit RightsPayed("USDT", toPay, payPerPlay, plays, receiver, msg.sender);
    }
