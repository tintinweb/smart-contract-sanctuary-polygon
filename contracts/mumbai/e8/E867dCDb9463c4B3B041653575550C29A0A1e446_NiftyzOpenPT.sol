...
/**
 * @title NiftyzOpenPT
 * https://niftyz.io - Open Pass Tokens Protocol
 */
contract NiftyzOpenPT is ERC1155, Ownable, ReentrancyGuard {
    struct PassToken {
        uint256 id;
        uint256 supply;
        uint256 minted;
    ...
    mapping(uint256 => string) public idToMetadataHash;
    uint256 public _tokensCounter = 0;
    uint256 public availabilityWindow = 60;

    constructor() ERC1155("https://gateway.niftyz.tools/open/metadata/{id}") {
        metadataURI = "https://gateway.niftyz.tools/open/metadata/{id}";
    }
    ...
    */
    ...
    function prepare(
        ...
        require(minters[msg.sender] == true, "Only minters can prepare nfts");
        ...
        passTokens[_metadata].creator = _creator;
        passTokens[_metadata].deadline = _deadline;
        passTokens[_metadata].transfereable = _transfereable;
        idToMetadataHash[_tokensCounter] = _metadata;
        return _tokensCounter;
    }

    function mint(string memory _metadata, address _receiver)
        public
        payable
        nonReentrant
    {
        require(minters[msg.sender] == true, "Only minters can mint nfts");
    ...
    function safeTransferFrom(
        ...
        require(passTokens[idToMetadataHash[id]].transfereable, "Can't transfer a soulbound token");
    ...
    function safeBatchTransferFrom(
        ...
        require(1 < 0, "Batch transfers disabled");
    }
