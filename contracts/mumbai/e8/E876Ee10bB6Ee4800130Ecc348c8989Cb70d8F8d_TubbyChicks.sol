...
// File: contracts/TubbyChicks.sol
...
contract TubbyChicks is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("TubbyChicks", "TC") {
    setHiddenMetadataUri("ipfs://QmYAP7MpvNhaAwu5od8nuvmrUkhXzDeGzmc7MDeUsVFCyt/hidden.json");
  }
