...
contract IDOPool is Ownable, Pausable, KLAYDAOWhitelist {
    ...
    function initialize(
        ...
        // ITicket(_ticketAddress).createTierBatch(ids, amounts, uris, "");

        ITicket(_ticketAddress).createTier(0, "", "");
        ITicket(_ticketAddress).createTier(0, "", "");
        ITicket(_ticketAddress).createTier(0, "", "");
...
contract Ticket1155 is ERC1155, Ownable {
    ...
    //     require(ids.length == 3, "Only onwer can create new nft ticket");
    ...
    function createTier(
        ...
        emit CreateTier(_id, _quantity, _uri, _data);
    ...
    function _setTokenID(uint256 _id) private returns (uint256) {
        currentTokenId = _id;
