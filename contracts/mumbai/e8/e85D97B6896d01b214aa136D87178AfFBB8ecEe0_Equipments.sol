                ...
                Base64.encode(
                    bytes(
                        abi.encodePacked(
                            ...
                            '{"trait_type": "equipment_type", "value": "',_details.type_tag,'"}, {"trait_type": "rarity", "value": "',_details.rarity_tag,'"}, {"trait_type": "dominant_stat", "value": "',_details.dominant_stat_tag,'"}, {"trait_type": "extremity", "value": "',_details.extremity_tag,
                            '"}]}'
                        )
                    )
                )
...
library EquipmentLibrary {
    function getEquipment(equipment_properties memory equipment) internal pure returns (equipment_details memory details){
        ...
        details = equipment_details({
            name: abi.encodePacked(rarity_tag, type_tag, extremity_tag, dominant_stat_tag),
