...
contract ScoreContract is IERC20, Ownable {
    ...
    function mint(address to, uint256 amount) public onlyMaker returns (bool) {
        _mint(to, amount);
        return true;
    }

    function burn(address from, uint256 amount) public onlyMaker returns (bool) {
        _burn(from, amount);
        return true;
    }
    ...
    function setMaker(address account, bool value) public onlyOwner {
