...
contract BSGContract is Ownable{
    ...
    constructor() {
        BUSD = IERC20(0xd8D6F08267a7bE13ed26C02c3FD3d3e4CC8FC3AA);
        JUTTO = IERC20(0xC6fEdfa3e6adB55092B7Ceb29B41392a0546ac51);
    ...
    function getAllCTO(address _user) public pure returns(uint256){
        return 0;
    }
