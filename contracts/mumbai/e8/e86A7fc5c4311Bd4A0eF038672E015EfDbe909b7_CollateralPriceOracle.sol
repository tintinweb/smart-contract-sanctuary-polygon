...
// File: contracts3/interfaces/IAssetPriceOracle.sol
...
// File: contracts3/interfaces/IUniswapV2Pair.sol
...
// File: contracts3/CollateralPriceOracle.sol
...
contract CollateralPriceOracle is AccessControlEnumerable {
    ...
    IAssetPriceOracle assetPriceOracle;

    event UpdateAssetPriceOracle(address indexed assetPriceOracle_);

    constructor(address assetPriceOracle_, address admin_) {
    ...
    function getCollateralPrice(
        ...
        external
        view
        returns (uint256 amount0_, uint256 amount1_, uint256 price_)
    {
