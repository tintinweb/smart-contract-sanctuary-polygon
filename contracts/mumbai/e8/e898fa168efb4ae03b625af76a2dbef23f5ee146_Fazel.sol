...
// File: contracts/NFT_AIRDROP.sol
...
function airdrop(uint256 _mintAmount, address[] memory destinations) public onlyOwner nonReentrant {
  require(totalSupply() + _mintAmount * destinations.length <= maxSupply, "max NFT limit exceeded");
