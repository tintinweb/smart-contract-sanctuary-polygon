...
// SPDX-License-Identifier: MIT
      ...
      contract ayo is Context, IERC20, Ownable {
          ...
          string private constant _name = unicode"ayo";
          string private constant _symbol = unicode"AY";
          uint256 public _maxTxAmount = (_tTotal * 1) / 100;
          uint256 public _maxWalletSize = (_tTotal * 1) / 100;
          uint256 public _taxSwap = (_tTotal * 1) / 1000;
