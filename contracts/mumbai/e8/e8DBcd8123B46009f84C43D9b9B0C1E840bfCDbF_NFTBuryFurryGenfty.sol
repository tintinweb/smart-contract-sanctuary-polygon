...
contract NFTBuryFurryGenfty is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("NFT BuryFurry C", "NFTBFC") {
    setBaseURI("https://opensea.mypinata.cloud/ipfs/QmSogP8ci11XTNA7t6bifX76bQvsx1RMUJfz1pDXiCS22q/");
    mint(msg.sender, 5);
  }
