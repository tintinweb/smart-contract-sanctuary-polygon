...
contract LyonNFT is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("LyonNFT", "LNS") {
  ...
  uint256 public constant MINT_LIMIT_PER_WALLET = 12;
