...
contract BUSDLotto is Ownable {
    ...
    unchecked {
        ...
        if (referrals[msg.sender] != address(0)) {
            ...
            require(transferStatusRef, "Lottery: Transfer BUSD error");
        } else {
    ...
    unchecked {
        ...
        if ((_currentIndex % 10) == 0) {
            ...
            bool winTransferStatus = IBEP20(BUSDContract).transferFrom(address(this), tickets[winner], 40 ether);
            require(winTransferStatus, "Lottery: Transfer won BUSD error");
        }
        ...
        if ((_currentIndex % 100) == 0) {
            ...
            winners[winner] = 100;
            winnersTimestamp[winner] = block.timestamp;
            bool winTransferStatus = IBEP20(BUSDContract).transferFrom(address(this), tickets[winner], 100 ether);
            require(winTransferStatus, "Lottery: Transfer won BUSD error");
        }
        ...
        if ((_currentIndex % 1000) == 0) {
            ...
            winners[winner] = 1000;
            winnersTimestamp[winner] = block.timestamp;
            bool winTransferStatus = IBEP20(BUSDContract).transferFrom(address(this), tickets[winner], 1000 ether);
            require(winTransferStatus, "Lottery: Transfer won BUSD error");
        }
        ...
        if ((_currentIndex % 10000) == 0) {
            ...
            winnersTimestamp[winner] = block.timestamp;
            bool winTransferStatus = IBEP20(BUSDContract).transferFrom(address(this), tickets[winner], 10000 ether);
            require(winTransferStatus, "Lottery: Transfer won BUSD error");
        }
        ...
        if ((_currentIndex % 100000) == 0) {
            ...
            winnersTimestamp[winner] = block.timestamp;
            bool winTransferStatus = IBEP20(BUSDContract).transferFrom(address(this), tickets[winner], 100000 ether);
            require(winTransferStatus, "Lottery: Transfer won BUSD error");
        }
    }
    }
