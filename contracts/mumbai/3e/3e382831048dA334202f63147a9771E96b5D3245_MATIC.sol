...
*
*                                                                                     
* MATIC FARMER - MATIC MINER
*
* Website  : https://www.maticfarmer.app
...
contract MATIC is Ownable {
    ...
    uint256 public MIN_INVEST_LIMIT = 1* 1e16; /* 0.01 MATIC  */  //change
    uint256 public WALLET_DEPOSIT_LIMIT = 15000 * 1e18; /* 15000 MATIC  */
    ...
    constructor() {
        // owner = msg.sender;
        dev1 = payable(0x9DB8caBD27354F0e8ca0Cd82f4F531f003760ccb);//change
        dev2 = payable(0x9DB8caBD27354F0e8ca0Cd82f4F531f003760ccb);//change
    ...
    function BuyFarms(address ref) public payable{
        require(contractStarted, "Contract not yet Started.");
        User storage user = users[msg.sender];
    ...
    /* How many Farms per day user will receive based on MATIC deposit */
