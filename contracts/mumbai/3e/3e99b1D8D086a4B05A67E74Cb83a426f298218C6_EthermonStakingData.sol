...
contract EthermonStakingData is EthermonStakingBasic {
    ...
    //Con: Can take only one data data so for each token backend have to call it over and over again
    //What can we do: Create a mapping of address pointing to array of TokenData 
