...
contract VaultRewards is ReentrancyGuard, AccessControl {
    ...
    constructor(address _tokenInfo, address _token, uint256 _percentage, address _rewards) {
    ...
    { 
            ...
            avaibleRewards -= tempTotalRewards; //update avaible rewards
            emit AvaibleRewards(lastCall, avaibleRewards, tempTotalRewards);
