...
contract HyphenProvider is ReentrancyGuard {
	...
	function transferNative(address receiver, uint256 toChainId, string calldata tag) external payable nonReentrant {
			require(msg.value != 0, "WagPay: Please send amount greater than 0");
			hyphenLiquidityPool.depositNative{value: msg.value}(receiver, toChainId, tag);
	...
	function transferERC20(uint256 toChainId,
        ...
        address receiver,
        uint256 amount,
        string calldata tag ) external payable {
