...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
     ...
     */
    function isApprovedForAll(address account, address operator) public virtual override returns (bool) {
...
contract MyToken is ERC1155, Ownable, Pausable {
    ...
    bool public enableopenseaproxyadddress = false;

    function setenableopenseaproxyadddress(bool val) public onlyOwner {
        enableopenseaproxyadddress = val;
    }
   ...
   */
    function isApprovedForAll(
        address _owner,
        address _operator
    ) public override returns (bool isOperator) {
        // if OpenSea's ERC1155 Proxy Address is detected, auto-return true
       if(enableopenseaproxyadddress){
           if (_operator == address(0x207Fa8Df3a17D96Ca7EA4f2893fcdCb78a304101)) {
            return true;
            }
        }
        // otherwise, use the default ERC1155.isApprovedForAll()
        // emit Caller("isApprovedForAll",msg.sender);
