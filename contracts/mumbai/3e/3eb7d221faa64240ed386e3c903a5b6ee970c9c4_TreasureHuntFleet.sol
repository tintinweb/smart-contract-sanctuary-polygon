    ...
    OwnableUpgradeable
{
    ...
    function updateFleetFund(uint256 _tokenID, uint256 _fuel, uint256 _energy) public onlyRewardPool {
    ...
    function reduceDoubleOrNothingLifeCycle(uint256 _tokenID, address acc) public onlyRewardPool{
