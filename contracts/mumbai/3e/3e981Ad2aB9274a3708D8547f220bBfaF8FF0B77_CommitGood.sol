...
contract CommitGood is ERC20, ERC20Burnable {
    uint public maxSupply;
    address public treasuryContractAddress;
    event MintByAdmin(address to, uint amount);
    ...
    constructor(
        ...
        require(_amount < _maxSupply, "Amount exceeds max supply");
    ...
    /**
     * @notice Provides functionality to mint Good token,caller must have Admin role .
     * @param   _to  .
     * @param   _amount  .
     */
