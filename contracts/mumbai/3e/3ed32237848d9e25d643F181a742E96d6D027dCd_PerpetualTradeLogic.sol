...
contract PerpetualTradeLogic is PerpetualUpdateFunctions, IFunctionList, IPerpetualTradeLogic {
        ...
        internal
    {
        // (neg) AMM exposure (aggregated trader exposure)
        {
            ...
            int128 tmp = _ema(_perpetual.fCurrentAMMExposureEMA[iIndex], fCurrentObs, fLambda);
        ...
        // trader exposure
        {
            ...
            int128 fLambda = fCurrentObs > _perpetual.fCurrentTraderExposureEMA
                ? _perpetual.fDFLambda[1]
                : _perpetual.fDFLambda[0];
            if (fCurrentObs < _perpetual.fMinimalTraderExposureEMA) {
                fCurrentObs = _perpetual.fMinimalTraderExposureEMA;
            }
            _perpetual.fCurrentTraderExposureEMA = _ema(
...
contract PerpetualUpdateFunctions is PerpetualBaseFunctions {
    ...
    int128 private constant FIVE_64x64 = 0x50000000000000000;
        ...
        returns (int128)
    {
        ...
        if (fCoverN < FIVE_64x64) {
            fCoverN = FIVE_64x64; // =5
        }
        ...
        returns (bool isMarketClosed)
    {
        ...
        if (fPrice > 0) {
            ...
            if (fPrice != _perpetual.fSettlementS2PriceData) {
                ...
                if (_perpetual.iLastSettlementPriceUpdateTimestamp + 6 > block.timestamp) {
                    int128 fJump = fPrice
                    ...
                    if (fJump > fCurrSpread.add(fCurrSpread)) {
                        ...
                        _perpetual.iLastPriceJumpTimestamp = uint64(block.timestamp);
                    }
                }
                _perpetual.fSettlementS2PriceData = fPrice;
            }
            _perpetual.iLastSettlementPriceUpdateTimestamp = uint64(block.timestamp);
        } else {
            isMarketClosed = true;
        }
