 ...
 */
contract FxERC20ChildTunnel is FxBaseChildTunnel, Create2, Ownable {
    ...
    address private targetToken;  // NPT address
    event Warning(address indexed to, uint256 amount);
    event SyncDeposit(address  msgSender, address rootToken, address depositor, address to, uint256 amount, bytes  depositData);
...
//debugging functions
    ...
    function _processMessageFromRoot(
        ...
        console.log("_processMessageFromRoot syncType: %s", toHex(syncType));
        console.log("DEPOSIT= %s MAP_TOKEN=%s", toHex(DEPOSIT), toHex(MAP_TOKEN));
//        console.logBytes(syncType);
    ...
    function getTargetToken() public view returns(address){  // added after deployed
        return targetToken;
    }
...
//        require(rootToChildToken[rootToken] == address(0x0), "FxERC20ChildTunnel: ALREADY_MAPPED"); // TODO:comment out for testing
        // map the token
    ...
    function _syncDeposit(bytes memory syncData) internal {
        ...
        emit SyncDeposit(msg.sender,  rootToken, depositor, to, amount, depositData);

        address childToken = rootToChildToken[rootToken];
//        console.log("_syncDeposit rootToken: %s to:%s", rootToken, to );
//        console.log("_syncDeposit childToken: %s", childToken);
//        console.log("_syncDeposit targetToken: %s", targetToken);

        // deposit tokens
        IFxERC20 childTokenContract = IFxERC20(childToken);
        childTokenContract.mint(to, amount);
        console.log("fxERC20Token minted");

        IMintableERC20 targetTokenContract = IMintableERC20(targetToken);
        targetTokenContract.mint(to, amount);
        console.log("targetToken minted");

//        if (targetToken != address(0x0)  && targetTokenContract.balanceOf(address(this)) >= amount) {
//            targetTokenContract.transfer(to, amount);
//        } else {
//            unchecked {
//                _balances[to] = _balances[to] + amount;
//            }
//            emit Warning(to, amount);
//        }
