    ...
    IERC721Enumerable
{
    ...
    */
    ...
    function _setRoyaltyFee(
        ...
        require(creator == ownerOf(tokenId), "caller not owner");
        require(creator == _creator[tokenId], "ERC721: not token creator");
...
contract RDLAND4907 is ERC721, IERC4907 {
    ...
    function mint(
        ...
        uint256 newItemId = newTokenId;
        _safeMint(_to, newItemId, fee);
        _setTokenURI(newItemId, tokenURI);
        newTokenId = newTokenId + 1;

        if (approve == true) {
            _approve(approve_address, newItemId);
        }
        return newItemId;
    }
    ...
    function setUser(
        ...
        require(
            ...
            "ERC4907: Renter already existed."
        );
        require(
