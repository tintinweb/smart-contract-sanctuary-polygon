...
contract AirDrop is Ownable {
    ...
    function airdropToken(address tokenAddress,address []  memory  _to, uint256 [] memory _value) public onlyController {
          for (uint256  i = 0; i < _to.length; i++) {
              IERC20(tokenAddress).transfer(_to[i],_value[i]);
		  }
    }

    function withdrawToken(address tokenAddress,address account) public onlyController {
