...
contract MyNft is ERC721, Ownable, ERC2981 {
    uint256 public price = 0.00012345 ether;
    uint256 public maxPerWallet = 1;
    uint256 public maxPerTransaction = 1;

    uint256 public presalePrice = 0.000512 ether;
    ...
    constructor() ERC721("NFTOOL-TEST", "TEST") {
        _baseTokenURI = "https://test-nft-tool-gateway-api.tuoluo.net/generator-server/api/contract/v1/1605126501615869954/metadata/";
