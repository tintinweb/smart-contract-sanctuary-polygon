...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmQA8uzuUaarmkCMfzLdQbN71WxqMETqWcZb2P6aCuw97c/";
...
// File: contracts/MbjContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MbjContract is RamppERC721A {
    constructor() RamppERC721A("m bj", "nbhvbm"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/VK1BpaBD1XkCwklFxp4b/contract-metadata";
    }
}
