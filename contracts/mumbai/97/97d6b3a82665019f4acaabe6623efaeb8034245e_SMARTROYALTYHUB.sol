...
interface IERC2981Royalties {
   ...
   function royaltyInfo(uint256 tokenId, uint256 value)
        external
        view
        returns (address recipient1, uint256 value1,address recipient2,uint256 value2,address recipient3, uint256 value3);
}
...
abstract contract ERC2981PerTokenRoyalties is ERC165, IERC2981Royalties {
    ...
    /// @param recipient1 recipient of the royalties
    /// @param value1 percentage (using 2 decimals - 10000 = 100, 0 = 0)
    function _setTokenRoyalty(
        ...
        require(value1 <= 10000, 'ERC2981Royalties: Too high');

        _royalties[id] = Royalty(recipient1,recipient2,recipient3, value1,value2,value3);
    }
        ...
        returns (address recipient1, uint256 value1,address recipient2,uint256 value2,address recipient3, uint256 value3)
    {
        ...
        recipient1 = royalty.recipient1;
        value1 =  (value * royalty.value1) / 10000;
        recipient2 = royalty.recipient2;
        value2 =  (value * royalty.value2) / 10000;
        recipient3 = royalty.recipient3;
        value3 =  (value * royalty.value3) / 10000;
        return (recipient1,value1,recipient2,value2,recipient3,value3);
    }
}
  ...
  ERC2981PerTokenRoyalties
{
  ...
  function mint(
    ...
    uint256 royaltyValue1,
    address royaltyRecipient2,
    uint256 royaltyValue2,
    address royaltyRecipient3,
    uint256 royaltyValue3
  )
    external
  {
    super._mint(_to, _tokenId);
    ...
    if (royaltyValue1 > 0) {
        _setTokenRoyalty(_tokenId, royaltyRecipient1,royaltyRecipient2,royaltyRecipient3,royaltyValue1,royaltyValue2,royaltyValue3);
    }
