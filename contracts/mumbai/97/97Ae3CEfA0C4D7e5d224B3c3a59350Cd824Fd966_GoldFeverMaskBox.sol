    ...
    ERC721RoyaltyUpgradeable
{
    ...
    function __GoldFeverMaskBox_init(
        address admin,
        address gfiContract_,
        address vrfCoordinator_,
        uint64 subscriptionId_,
        ...
        __ERC721_init("GFMaskBox", "GFMB");
        __VRFConsumerBaseV2_init(vrfCoordinator_);
        __GoldFeverMaskBox_init_unchained(
            admin,
            gfiContract_,
            vrfCoordinator_,
            subscriptionId_,
    ...
    function __GoldFeverMaskBox_init_unchained(
        address admin,
        address gfiContract_,
        address vrfCoordinator_,
        uint64 subscriptionId_,
