...
contract MaykNFT is ERC721, ERC721Royalty, ContextMixin, Ownable {
    string private _tokenURI;
    string private _contractURI;

    constructor(
        string memory collectionName,
        string memory pTokenURI,
        string memory pContractURI,
        address artistAddress,
        address royaltyAddress
    ) ERC721(collectionName, "MAYK") {
        _tokenURI = pTokenURI;
        _contractURI = pContractURI;
        _safeMint(artistAddress, 1);
        _setTokenRoyalty(1, royaltyAddress, 1000);
    }
    ...
    function tokenURI(uint256 tokenId) public view override (ERC721) returns (string memory) {
        require(tokenId == 1, "Only 1 to mint!");
        return _tokenURI;
    }
