 ...
 */
contract OpenScienceNFT is ERC721, Ownable, Pausable {
    ...
    function transferOwnership(
        ...
        require(
            ...
            "OSNFT: new owner cannot be current contract"
        );
