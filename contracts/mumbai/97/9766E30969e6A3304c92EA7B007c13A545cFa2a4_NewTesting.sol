...
contract NewTesting is ERC721Royalty, Ownable, ContextMixin {
    ...
    constructor() ERC721("NewTesting","Test") {}
    ...
    function VIPSaleAction2() external onlyOwner {
        _saleStatus = !_saleStatus;
    }
    ...
    function VIPList(uint256 numberOfTokens) public saleFlip payable {
        ...
        require(mintedNumber.add(numberOfTokens) <= MAX_VIP_Allow_List, "Max limit of NFTs");
        ...
        for(uint i = 0; i < numberOfTokens; i++) {
            _safeMint(msg.sender, mintedNumber+1);
            _setTokenRoyalty(mintedNumber+1, msg.sender, royaltyPer);
        }
    ...
    // function deleteVIPList(address _userAddr) public onlyOwner {
    //      isVIPlist[_userAddr] += 2;
    // }
