...
contract PublicGovSale is Initializable, UUPSUpgradeable, PausableUpgradeable, OwnableUpgradeable, AdminProxyManager {
    ...
    function _buyToken(
        ...
        address factoryAddr = factory.crossChainManager();
        if(sender != factoryAddr && sender != owner()) _buyer = sender;
    ...
    function __buyToken(uint128 amountIn, address buyer) external onlyOwner {
        _buyToken(amountIn, buyer);
    }
