...
contract ToyMoriesRewards is ReentrancyGuard, Ownable  {
    ...
    // Internal//
    /////////////
    function calculateRewards(address _holder)
        internal
        view
        returns (uint256 _rewards)
    {
        return (users[_holder].unclaimedRewards + airDrop);
    }
