    ...
    EIP712Upgradeable
{
    ...
    // ROLES
    bytes32 public constant OWNER_ROLE = keccak256("O");
    bytes32 public constant SIGNER_ROLE = keccak256("S");
    bytes32 public constant WITHDRAW_ROLE = keccak256("W");
    // DATA
    address payable public treasury;
    string public baseURI;
    mapping(uint256 => uint256) public drop_max; // [drop_id => max]
    mapping(uint256 => uint256) public token_drop; // [drop_id => max]
    mapping(uint256 => uint256[]) public drop_tokens; // [drop_id => max]
    ...
    function initialize() public initializer {
        ...
        _setRoleAdmin(WITHDRAW_ROLE, OWNER_ROLE);
