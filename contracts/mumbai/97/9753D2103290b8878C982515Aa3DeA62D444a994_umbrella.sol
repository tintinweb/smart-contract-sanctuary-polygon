...
contract umbrella is ERC721A, OperatorFilterer, Ownable, ReentrancyGuard {
    ...
    constructor(string memory _initBaseURI) ERC721A("umbrella", "umb") {
    ...
    modifier mintCompliance(uint256 _mintAmount) {
        require(balanceOf(msg.sender) < 3, "You have already minted 3!");
