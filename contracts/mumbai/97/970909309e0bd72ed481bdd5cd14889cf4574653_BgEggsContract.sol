...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x55676d9a25f3bef997FF34b75e6893538952325b];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmRstNHL26nkQm1EHCTPJJTZXdTCcuBL75GedDEyEgiUKZ/";
...
// File: contracts/BgEggsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BgEggsContract is RamppERC721A {
    constructor() RamppERC721A("BGEggs", "EGGY"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/RAcRhSNj2yIFaCE02ORx/contract-metadata";
    }
}
