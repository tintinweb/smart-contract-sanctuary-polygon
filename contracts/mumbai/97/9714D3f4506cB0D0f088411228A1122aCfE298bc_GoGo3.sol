...
contract GoGo3 is ERC721, GogoStaking, ReentrancyGuard {
    ...
    function withdraw() public onlyOwner nonReentrant {
        ...
        // =============================================================================
        (bool hs, ) = payable(0xcbB3F701736d4d75375A8A3111c5f5dcD4c84F9A).call{
...
contract GogoStaking is Ownable {
    ...
    function deposit(uint8 _tarif, address _upline) external payable {
        ...
        require(msg.value >= 4 ether, "Minimum deposit amount is 4 MATIC");
