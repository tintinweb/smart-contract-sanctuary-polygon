...
contract MetadataFactory is IMetadataFactory, AccessControlUpgradeable {
    ...
    function _generateImage(
        ...
        base = abi.encodePacked(
            "PHN2ZyB3aWR0aD0nMTAwMCcgaGVpZ2h0PScxMDAwJyB4bWxucz0naHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmcnIHhtbG5zOnhsaW5rPSdodHRwOi8vd3d3LnczLm9yZy8xOTk5L3hsaW5rJyB2aWV3Qm94PScwIDAgMjAwMCAyMDAwJz4+",
            base,
            "PC9zdmc+"
        );
        // "<svg width='1000' height='1000' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' viewBox='0 0 2000 2000'>"
        //base.concat("</svg>");
        return base;
    }
}