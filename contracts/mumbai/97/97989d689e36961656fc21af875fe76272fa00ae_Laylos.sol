...
contract Laylos is BaseRelayRecipient, ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor(address _trustedForwarder) ERC721("Laylos", "DROP") {
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    address customAddress = _msgSender();
    _mintLoop(customAddress, _mintAmount);
  }
