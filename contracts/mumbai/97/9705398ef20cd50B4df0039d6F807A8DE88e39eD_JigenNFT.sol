...
contract JigenNFT is ERC721Enumerable, Ownable {
    ...
    modifier onlyUnpaused() {
        require(!isPaused, "Contract us paused");
        _;
    }
    ...
    //public functions
    function mint() public isValidMint onlyUnpaused {
        if (!isPublicMint) {
            require(
    ...
    modifier isRedeemable(uint256 tokenId) {
    ...
    function transferFrom(
        ...
        address to,
        uint256 tokenId
    ) public override(ERC721,IERC721) isRedeemable(tokenId) {
    ...
    function getTokensOfAddress(address account) public view returns(uint256[] memory) {
