...
contract LionsofPrideNFT1155 is
  Context,
  ERC1155Burnable,
  ERC1155Supply,
  ERC2981
{
    ...
    uint96 public maximumSupply = 100;
    ...
    function mint(address creator, string memory _uri, uint256 supply) external onlyOperator returns(uint256 _tokenId){
        require(msg.sender == operator, "ERC1155: caller doesn't have operator Role");
        require(_tokenIdTracker.current() <= maximumSupply, "ERC1155: maximum supply minted");
