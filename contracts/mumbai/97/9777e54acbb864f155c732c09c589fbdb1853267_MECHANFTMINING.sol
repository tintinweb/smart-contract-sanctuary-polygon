...
contract MECHANFTMINING {
	...
	constructor(address payable wallet, address payable _developer) public {
        ...
        plans.push(Plan(20, 90)); // SL Mecha 
        plans.push(Plan(20, 80)); // L Mecha
        plans.push(Plan(20, 75)); // SR Mecha
		plans.push(Plan(20, 70)); // R Mecha (Compounding)
        plans.push(Plan(20, 70)); // COMM Mecha (Compounding)
        plans.push(Plan(20, 70)); // UNC Mecha (Compounding)
	}
