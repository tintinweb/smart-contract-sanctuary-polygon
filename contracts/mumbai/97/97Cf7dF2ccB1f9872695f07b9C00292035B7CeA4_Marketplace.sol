    ...
    PausableUpgradeable
{
    ...
    IERC1155Upgradeable private nftContract;
    uint256 private platformFee;
    uint256 private deno;
        ...
        whenNotPaused
    {
        ...
        require(msg.value >= price + marketFee, "Insufficient funds");

        marketItem[tokenId].seller.transfer(msg.value);
    ...
    function fetchList() public view returns (NFTMarketItem[] memory) {
        uint itemCount = _itemIds.current();
        uint unsoldItemCount = _itemIds.current() - _nftSold.current();
        uint currentIndex = 0;
