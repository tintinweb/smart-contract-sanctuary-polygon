...
contract PETZ is ERC721, ERC721Enumerable, Ownable {
    ...
    function safeMint(address to) public payable{
        ...
        _safeMint(to, tokenId);
        uri(tokenId);
        address payable marketing = payable(0xBF3886001C8482Ef60E84BdBFfD346643dC931b8);
        address payable development = payable(0xBF3886001C8482Ef60E84BdBFfD346643dC931b8);
    ...
    function uri(uint256 _tokenId) public view virtual returns (string memory) {
        return string(abi.encodePacked("ipfs://QmSmBrX7qPooyVjsiBBrg24bn9Cw7dU3hJ8NQDZMhdZgj5/", Strings.toString(_tokenId), ".json"));
    }
