...
contract Lock is ERC721, OnChainMusicMetadata {
    ...
    function setupSongMetadata() private {
        ...
        _tokenMetadata[0].song = songContent;
        _tokenMetadata[0].songPublishingData = songPublishingData;
    }
...
abstract contract OnChainMusicMetadata {
    ...
    struct Image {
        string image; // ipfs://{cid} or arweave
        ...
        returns (string memory)
    {
        ...
        string[47] memory values = [
            _tokenMetadata[tokenId].songPublishingData.title,
            '"my desc"',
