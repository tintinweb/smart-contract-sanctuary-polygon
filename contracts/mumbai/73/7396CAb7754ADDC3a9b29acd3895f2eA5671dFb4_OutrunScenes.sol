...
contract OutrunScenes is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("Outrun Scenes by Sal Paradise", "OTSC") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://gateway.ipfs.io/ipfs/QmRHy9hAeKNL5aEGc3LNqfmNmoE9pHzVrcedLFe216d4Ua";
    }
    ...
    function safeMint(uint256 _amount) public onlyOwner {
        require(1000 >= _amount + _tokenIdCounter.current(), "Not enough tokens left to mint.");
