...
library LootBoxRandomness {
  ...
  function setOptionSettings(
    ...
    OptionSettings memory settings = OptionSettings({
      ...
      // bool value to specify if there is any guarantee
      hasGuaranteedClasses: hasGuaranteedClasses,
      /* 
      ** guarantees displays amount of tokenIDs to be choose randomly in specific class determined by classID(index of gaurantee)
      */
