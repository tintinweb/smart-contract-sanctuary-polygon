...
contract OGateway is IOmniApp, Ownable, ReentrancyGuard {
    ...
    function sendTo(SendParams calldata params) public payable nonReentrant {
        ...
        if (isCopy[tokenAddress]) {
            ...
            _send(_getPayload(params.token, copyToOriginal[tokenAddress], params.amount), params.dstChainName, params.gas, params.redirectFee);
        ...
        _send(_getPayload(params.token, tokenAddress, params.amount), params.dstChainName, params.gas, params.redirectFee);
    }
    ...
    */
    ...
    function forceUnlock(address _token, address _account, uint256 _amount) external onlyOwner nonReentrant {
