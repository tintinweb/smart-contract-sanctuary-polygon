...
contract IseedWhitelist is Ownable, ERC1155 {
    ...
    uint256 public publicMaxSupply = 4500;
    uint256 public publicTotalSupply = 0;

    uint256 public privateMaxSupply = 500;
    uint256 public privateTotalSupply = 0;
    ...
    function mint(string memory _community, uint256 _amount) public payable {
        ...
        require(_amount > 0);
        require(publicTotalSupply + _amount <= publicMaxSupply);
        
        uint256 totalPrice = getCurrentPrice(msg.sender, _amount);
        ...
        publicTotalSupply += _amount;
    }

    function airdrop(address _to, uint256 _amount) public onlyOwner {
        require(privateTotalSupply + _amount <= privateMaxSupply);
        _mint(_to, 1, _amount, "");
    ...
    // VIEW FUNCTIONS
    function getCurrentPrice(address _user, uint256 _amount) public view returns(uint256) {
    ...
    function remainingTokens() public view returns(uint256) {
        return publicMaxSupply - publicTotalSupply;
    }
