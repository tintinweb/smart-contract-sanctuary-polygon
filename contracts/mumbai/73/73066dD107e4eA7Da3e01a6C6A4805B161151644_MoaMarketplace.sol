...
contract MoaMarketplace is Context, IMoaMarketplace, ReentrancyGuard {
    ...
    function createMarketSale(
        ...
        bool revoke = idToMarketItem[itemId].revoke;
        ...
        idToMarketItem[itemId].owner = payable(_msgSender());  // Record the (new) owner
        idToMarketItem[itemId].sold = true; // set the MarketItem to sold = true
...
interface IMoaMarketplace {
    ...
    function revokeMarketItem(uint256 itemId) external;
