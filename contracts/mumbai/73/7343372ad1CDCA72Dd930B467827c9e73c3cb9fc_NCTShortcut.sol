...
contract NCTShortcut is IShortcut{
    ...
    uint public constant ONE_HUNDRED_PERCENT = 3;
    ...
    returns(uint){
        if(_checkTokenTCO2(_toToken)){
            ...
            require(_checkBuyShortcutValid(_fromToken, _toToken, forTrade, _amOut), "Shortcut must pass valid check to be executed");
            // buy NCT
