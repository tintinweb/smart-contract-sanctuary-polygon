...
contract ERC721LuxyPrivateFactory is Ownable {
    ...
    function createToken(
        ...
        address luxy721PrivateToken = deployProxy(
            getData(_name, _symbol, _baseURI, _minters, _ischangeable),
            _salt
        );
        ERC721LuxyPrivate token = ERC721LuxyPrivate(luxy721PrivateToken);
        token.__ERC721LuxyPrivate_init(_name, _symbol, _baseURI, _minters,_ischangeable);
    ...
    RoyaltiesV1Luxy
{
    ...
    function __ERC721LuxyPrivate_init_unchained(address[] memory minters_)
        internal
        initializer
    {
        _setInitialMinters(minters_);
