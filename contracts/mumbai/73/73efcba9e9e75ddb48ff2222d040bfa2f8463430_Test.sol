...
contract Test is ERC20, AccessControl, ERC721Holder {
    ...
    constructor(address owner, address _collectionAddress) ERC20("TeStV1", "TST") AccessControl(){
        _mint(owner, 400000 * 10 ** 18);
        ...
        coinAmountPerRewardUnit = 10 * 10 ** 18;
        numberOfBlocksPerRewardUnit = 20571; // Roughly 40000 to 41000 blocks in 24 hours
        welcomeBonusAmount = 100 * 10 ** 18;
    }
