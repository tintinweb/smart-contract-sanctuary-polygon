...
contract ArtNftERC721 is ERC2981, AccessControl, ERC721 {
    ...
    function lazyMintBatch(
        ...
        Batch memory batch = Batch(_currentBatchId, _cid, _name, creator, _currentTokenId, _batchSize);
    ...
    function mint(uint256 _tokenId) public onlyRole(MINTER_ROLE) {
