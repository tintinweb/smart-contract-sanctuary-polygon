...
contract InvestmentPool is Ownable {
    ...
    function changeInvestmentPoolStatus(bool _poolOpen) external onlyPoolManager {
        poolOpen = _poolOpen;
    }
     ...
     */    
     ...
     /*
      * Create investment. User enters amount of USDC, and we calculate amount of IUX
      * For example, 1000 USDC => 1000 * 20000 / 10000 = 2000 (1:1)
      */
    function createInvestment(
        ...
        investmentIndex++;
        currentValue = currentValue.add(_investmentValue);
    } 
