...
contract AaveV2WrapV2Adapter {
    ...
    // Address of the Aave LendingPool, maybe changed in the event of an upgrade
    address internal immutable _lendingPool;

    // ==================== Constructor function ====================

    constructor(ILendingPoolAddressesProvider lendingPoolAddressesProvider) {
        _lendingPool = lendingPoolAddressesProvider.getLendingPool();
    }
