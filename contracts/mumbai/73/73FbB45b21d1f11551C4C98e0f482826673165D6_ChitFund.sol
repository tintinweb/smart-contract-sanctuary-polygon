...
contract ChitFund {
    ...
    function payInstallment(uint256 _id) external {
        ...
        // require(msg.value == chit.installmentAmount, "Incorrect installment amount"); wallet.transfer(msg.value);

        require(payable(msg.sender).send(chit.installmentAmount), "Failed to send payment to contract wallet");
