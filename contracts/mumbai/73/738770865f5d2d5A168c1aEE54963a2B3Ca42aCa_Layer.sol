...
contract Layer is AccessControl, DateUtil,ReentrancyGuard{
    ...
    constructor(address _token, address _recipient, address _NFTAddress)  {
        tokenAddress = _token;
    ...
    function getRequestAmount() public view returns (uint amountByDay){
        ...
        amountByDay = 180000 + 10000*daysNum;
    }
    ...
    //    return cards[tokenId - 100001].uri;
    //}    
