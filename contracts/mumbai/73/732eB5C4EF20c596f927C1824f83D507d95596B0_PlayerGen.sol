...
contract PlayerGen is ERC721URIStorage, Ownable {
    ...
    function practiceAll(uint256 tokenId) public payable {
        ...
        practiceInc(tokenId, AllPrac);
        _setTokenURI(tokenId, getTokenURI(tokenId));
    }

    // Practice Shooting
    function _practiceShooting(uint256 tokenId) internal {
    ...
    // Practice Passing
    function _practicePassing(uint256 tokenId) internal {
    ...
    // Practice Tackling
    function _practiceTackling(uint256 tokenId) internal {
        uint256 currentTackling = tokenIdToAbilities[tokenId].Tackling;
        tokenIdToAbilities[tokenId].Tackling = currentTackling + 1;
    }
    ...
    // Practice Saves
    function _practiceSaves(uint256 tokenId) internal {
        uint256 currentSaves = tokenIdToAbilities[tokenId].Saves;
        tokenIdToAbilities[tokenId].Saves = currentSaves + 1;
    }
    ...
    function practiceInc(uint256 tokenId, uint256 pracType) internal {
