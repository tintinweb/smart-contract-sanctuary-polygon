 ...
 *
 */
abstract contract OnChainMusicMetadata is MusicStructs {
        ...
        returns (string[47] memory)
    {
        ...
        values[2] = _getString(_tokenMetadata[_tokenId].song.artwork.imageUri);
        values[3] = _getString(
            _tokenMetadata[_tokenId].songPublishingData.title
        );
        values[4] = _getString(
        ...
        values[5] = "2846.69";
        values[6] = '"audio/wav"';
        values[7] = '"ipfs://QmdXNSkWHKM8zTeLAwztyvok9c7AU3KCgQAGoeJyeGX6tj"';
        values[8] = "1";
        values[9] = "null";
        values[10] = "[]";
        values[11] = "null";
        ...
        values[13] = "null";
        values[14] = "null";
        values[15] = '"https://www.npmjs.com/package/onchain-music-metadata"';
        values[16] = '"ipfs://QmdXNSkWHKM8zTeLAwztyvok9c7AU3KCgQAGoeJyeGX6tj"';
        values[17] = '"Meet the Mint Songs Team"';
        values[18] = '"ipfs://QmejE2hSTSkDEEfyg4vDfVMd28AyLEQRdhPd4LcacbR4QW"';
        values[19] = '"image/png"';
        values[20] = "null";
        ...
        values[26] = "null";
        values[27] = "null";
        values[28] = '"ipfs://QmejE2hSTSkDEEfyg4vDfVMd28AyLEQRdhPd4LcacbR4QW"';
        values[29] = '"image/png"';
        values[30] = "null";
        values[31] = "null";
        values[32] = "null";
