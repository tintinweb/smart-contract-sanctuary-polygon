...
contract CryptosaursPrologue is ERC1155, ReentrancyGuard, Ownable {
    ...
    // mint
    function mint(uint256 tokenId, address mintAddress) external onlyAdminOrOwner(msg.sender) {
    ...
    function batchmint(uint256 tokenId, address[] memory mintAddresses) external onlyAdminOrOwner(msg.sender) {
