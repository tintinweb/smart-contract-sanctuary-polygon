...
contract StickyNFT1155 is ERC1155, Ownable {
  ...
  constructor(string memory _name, string memory _symbol) ERC1155("") {
    name = _name; // custom Name(could be collection name)
    symbol = _symbol; // Collection Symbol
  }
  ...
  function setURI(uint _id, string memory _uri) public onlyOwner {
    ...
    function setURIsInBatch(uint[] memory _ids, string[] memory _uris) public onlyOwner {
