...
contract PunchableERC721 is ERC721WhiteListMint{
    ...
    function punchACard(string memory eventId, uint256 _tID, uint8 increment) external {
        require( _msgSender() == punchBook[eventId].puncherAddress, "Not allowed to punch");
        require(nftPunchBook[_tID][eventId] + increment <= punchBook[eventId].maxPunches, "Not punches left");
 ...
 *****************************************************************************************/
 function mint(address _to, uint256 _tID, uint256 _eID) external override allowedMinter {
   require(_tID <= nextTID, "Token ID out of range");
 ...
 *****************************************************************************************/
 ...
 /*****************************************************************************************
     ...
     @param _eID: the Token's expereince ID of the NFT
 *****************************************************************************************/
 function mint(address _to, uint256 _eID) external override allowedMinter {
   nextTID += 1;
 ...
 /*****************************************************************************************
     ...
     @param _Uri: the Token's URI
 *****************************************************************************************/
 function mint(address _to, uint256 _eID, string memory _Uri) external override allowedMinter {
   nextTID += 1;
   super._mint(_to, nextTID);
   EID[nextTID] = _eID;
...
contract SDKERC721 is ERC721, Ownable{
 ...
 constructor(uint _reservedIDs) ERC721("SDK", "SDK") {
