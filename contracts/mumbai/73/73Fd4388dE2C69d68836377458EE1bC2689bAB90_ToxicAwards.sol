...
contract ToxicAwards is ERC1155, Ownable {
    ...
    constructor() ERC1155("https://storage.googleapis.com/toxicawards/meta/{id}") {
        ...
        configureAwardToken(1, 300, 0.01 ether, true);
        configureAwardToken(2, 100, 0.02 ether, true);
        configureAwardToken(3, 50, 0.05 ether, true);
        configureAwardToken(4, 10, 0.2 ether, true);
    }
