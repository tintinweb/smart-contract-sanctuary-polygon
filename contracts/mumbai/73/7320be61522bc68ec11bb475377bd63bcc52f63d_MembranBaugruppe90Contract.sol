...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x4e7DF5CDfD50d78ACeDed36e99acbb1e5B4ce8bA];
...
// File: contracts/MembranBaugruppe90Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract MembranBaugruppe90Contract is 
    ERC1155,
    Ownable, 
    Pausable, 
    ERC1155Supply, 
    ...
    Allowlist
{
    ...
    string public name = "Membran  BAUGRUPPE90";
    string public symbol = "B90";
    ...
    */
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/UdypYRjEMzHNNDRaj1ke/contract-metadata";
    }
