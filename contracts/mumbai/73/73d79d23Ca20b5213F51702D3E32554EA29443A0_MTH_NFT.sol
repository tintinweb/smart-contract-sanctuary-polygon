...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {return true;}  
    function allowance(address owner, address spender) public view virtual override returns (uint256) {return _allowances[owner][spender];}   
    function approve(address spender, uint256 amount) public virtual override returns (bool) {return true;}   
    function transferFrom(address sender, address recipient, uint256 amount) public virtual override returns (bool) {return true;}   
    function increaseAllowance(address spender, uint256 addedValue) public virtual returns (bool) {return true;}   
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {return true;}  
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {}       
    function _approve(address owner, address spender, uint256 amount) internal virtual {}   
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal virtual {}
}

contract MTH is Ownable, ERC20 {
    constructor() ERC20("MTH", "MTH") {}    
}
/////// ERC-20 Token Info! End!
...
,ERC721Fees
{
   ...
   //경매취소
    ...
    function _bid_token(uint256 _tokenId, uint256 _amount) internal virtual {
        ...
        require(_PayToken.balanceOf(msg.sender) >= _amount , "Not enough MTH quantity.");
   ...
   function _set_PayTokenAddress(MTH _token) internal {
       _PayToken = _token;
   }
 ...
 ERC721Burnable
{
    ...
    function _validate_token(uint256 _id) internal {
        ...
        require(_PayToken.balanceOf(msg.sender) >= price[_id] , "Not enough MTH quantity.");        
    ...
    function _trade_token(uint256 _id, bool _present, address _to) internal {             
        ...
        if(_present)
        {
         ...
         _PayToken.transferFrom(msg.sender, _owner_NFT, _sellerValue);
         if(_commissionValue > 0)
         {
...
contract MTH_NFT is Market {
   ...
   function Set_PayTokenAddress(MTH _token) public onlyOwner {
