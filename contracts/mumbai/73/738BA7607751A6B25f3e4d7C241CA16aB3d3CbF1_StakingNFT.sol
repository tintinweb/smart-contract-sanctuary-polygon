 ...
 */
contract StakingNFT is Ownable, ReentrancyGuard, Pausable {
    ...
    function setNFTAndToken(address _nftContract, address _erc20Contract) external {
        nftCollection = IERC721(address(_nftContract));
        rewardsToken = IERC20(address(_erc20Contract));
    }
