    ...
    Initializable
{
    ...
    function adjustMintFee(uint _newFee) external onlyOwner {
        mintFee = _newFee;
    }

    function adjustRedemptionFee(uint _newFee) external onlyOwner {
        redemptionFee = _newFee;
    }

    function adjustMgmtFee(uint _newFee) external onlyOwner {
        mgmtFee = _newFee;
    }

    function setSafeManager(address _safeManager) external onlyOwner {
        safeManager = _safeManager;
        safeManagerContract = ISafeManager(safeManager);
    }
