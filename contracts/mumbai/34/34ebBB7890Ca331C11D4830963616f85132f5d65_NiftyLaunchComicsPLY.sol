...
/**
 * @dev {ERC1155} token for PoS bridge
 */
contract NiftyLaunchComicsPLY is Ownable, ERC1155 {
    string public name = "Nifty Launch Comics";
    string public symbol = "NLC";

    // @dev ChildChainManager
    address public constant MINT_ADDRESS = 0xb5505a6d998549090530911180f38aC5130101c6;
