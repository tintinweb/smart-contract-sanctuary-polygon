...
contract RemoteMarketplace is Ownable {
    ...
    function queryProjectFromMarketplace(bytes32 projectId, uint256 subscriptionSeconds) public view returns(address, address, uint256, uint256, uint256) {
        return IMarketplace(recipientAddress).getPurchaseInfo(projectId, subscriptionSeconds, purchaseCount);
    }
