...
contract Polygonpay is  Ownable {
  ...
  uint256 public totalDays;
   ...
   constructor(
        ...
        adminFee = 10 * 1e15; // 10Matic
        minwithdraw = 5 * 1e15; // 5 Matic

        LEVEL_PRICE[1] = 10 * 1e15; // 10Matic
        LEVEL_PRICE[2] = 30 * 1e15;
        LEVEL_PRICE[3] = 90 * 1e15;
        LEVEL_PRICE[4] = 1000 * 1e15;
        LEVEL_PRICE[5] = 3000 * 1e15;
        LEVEL_PRICE[6] = 9000 * 1e15;
        LEVEL_PRICE[7] = 25000 * 1e15;
        LEVEL_PRICE[8] = 75000 * 1e15;
        ...
        oldPolygonPay = Polygonpay(0x5C8fd967820fc39360da73B34a1b69296e24A426);
