...
contract bootsForLife is ERC721URIStorage {
    ...
    mapping(uint256 => Boot) private _tokenIdsToBoot;
    ...
    function generateBootURI(uint256 tokenId) public view returns(string memory){
        ...
        '<text x="50%" y="50%" class="base" dominant-baseline="middle" text-anchor="middle">', "Efficiency: ",efficiency.toString(),'</text>',
        '<text x="50%" y="50%" class="base" dominant-baseline="middle" text-anchor="middle">', "Luck: ",luck.toString(),'</text>',
        '<text x="50%" y="50%" class="base" dominant-baseline="middle" text-anchor="middle">', "Comfort: ",comfort.toString(),'</text>',
        '<text x="50%" y="50%" class="base" dominant-baseline="middle" text-anchor="middle">', "Resilience: ",resilience.toString(),'</text>',
        '</svg>'
        );
        return string(
            abi.encodePacked(
