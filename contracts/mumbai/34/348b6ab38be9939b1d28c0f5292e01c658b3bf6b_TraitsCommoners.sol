...
contract TraitsCommoners is ITraits {
  ...
  function drawSVGTest1(uint256 tokenId) public view returns (string memory) {
    ICommoner.Commoner memory s = commoner.getTokenTraits(tokenId);
  ...
  function drawSVGTest1_1(uint8 breed, uint8 palette, bool flag_) public view returns (string memory) {
    return flag_ ? _getSvg2(
          0,
          breed,
          2,
          palette,
          string(abi.encodePacked("breed", toString(breed), "color", palette))
        ) : _getSvg2(
          0,
          breed,
          2,
          palette,
          string(abi.encodePacked("breed", "1", "color", "1"))
        );
  }

  function drawSVGTest2(uint256 tokenId) public view returns (string memory) {
    ICommoner.Commoner memory s = commoner.getTokenTraits(tokenId);
  ...
  function drawSVGTest3(uint256 tokenId) public view returns (string memory) {
    ICommoner.Commoner memory s = commoner.getTokenTraits(tokenId);
  ...
  function drawSVGTest4(uint256 tokenId) public view returns (string memory) {
    ICommoner.Commoner memory s = commoner.getTokenTraits(tokenId);
  ...
  function drawSVGTest5(uint256 tokenId) public view returns (string memory) {
    ICommoner.Commoner memory s = commoner.getTokenTraits(tokenId);
  ...
  function drawSVGTest6(uint256 tokenId) public view returns (string memory) {
    ICommoner.Commoner memory s = commoner.getTokenTraits(tokenId);
