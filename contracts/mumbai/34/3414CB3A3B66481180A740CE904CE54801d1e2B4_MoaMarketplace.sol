...
contract MoaMarketplace is IMoaMarketplace, ReentrancyGuard {
      ...
      nonReentrant
    {
        ...
        // Event
        emit MarketItemUpdate(_itemId, _price, tokenId, msg.sender);
    }
...
interface IMoaMarketplace {
    ...
    event MarketItemUpdate(uint indexed itemId, uint256 updated, uint256 indexed tokenId, address seller);
