...
contract LayerZeroImpl is ILayerZeroReceiver, Ownable {
    ...
    constructor(address _endpointPoly, address _endpointAvax) {
    ...
    function changeEndpoint(address _endpoint) external onlyOwner {
        endpointAvax = ILayerZeroEndpoint(_endpoint);
    }
    ...
    function sendMsg(
        ...
        endpointAvax.send{value: msg.value}(
            _dstChainId,
            _destination,
            _payload,
