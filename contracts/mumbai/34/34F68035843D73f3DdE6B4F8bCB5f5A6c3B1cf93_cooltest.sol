...
contract cooltest is ERC1155, Ownable {
  ...
  function mint(uint256 _id, uint256 _amount) payable public {
      require(_id <= supplies.length, "Token doesn't exist.");
      require(_id > 0, "Token doesn't exist." );
      require(msg.value >= (_amount * mintRate), "Not rnough ether sent.");
      require(minted[_id - 1] + _amount <= supplies[_id - 1], "Not enough supply left.");
