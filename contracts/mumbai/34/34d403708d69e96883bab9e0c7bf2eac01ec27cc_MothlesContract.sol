  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        */
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, "Cannot mint over supply cap of 992");
    ...
    contract MothlesContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Mothles", "RAMPP", _proxyRegistryAddress)
        {}

        

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/pW9msk3lp9O9aotf5O8l/contract-metadata";
        }
    }