...
import "../implementers/UTAutographStorage.sol";
import "../implementers/UTAutographController.sol";
import "../extras/recovery/BlackHolePrevention.sol";
...
contract UTAutographFactory is Ownable, BlackHolePrevention {
     ...
     *      This contract must have admin right in RANDOMV2_SSP_TRAIT_DROPPER - so it can setAuth to any
     *      controller (vault)
     */
    function addTrait(
        ...
        require(
            ...
            "UTAutographFactory: Unauthorized"
        );
