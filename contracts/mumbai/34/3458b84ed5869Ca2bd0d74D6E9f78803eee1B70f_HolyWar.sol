...
contract GameManager {
    ...
    function getDeckByGame(uint256 _gameId) public view returns (uint256[] memory) {
        return gameData[_gameId].deck;
    }

    function getRandomNumbersByGame(uint256 _gameId) public view returns (uint256[] memory) {
        return gameData[_gameId].randomNumbers;
    }

    function getRequestIdByGame(uint256 _gameId) public view returns (uint256[] memory) {
