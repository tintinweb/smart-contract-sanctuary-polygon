...
function mint(uint256 _mintAmount) public payable {
  ...
  // only owner
//   Now for the last chunk of code to add to our smart contract - the functions that only the owner can access. Copy the code below and paste it under // only owner.
