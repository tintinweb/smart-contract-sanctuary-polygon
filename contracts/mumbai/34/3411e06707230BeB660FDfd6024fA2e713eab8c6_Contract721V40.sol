...
// File: contracts/721_Base/721_Base_40.sol
/*
...
contract Contract721V40 is ERC721, Ownable, ERC2981, DefaultOperatorFilterer, ContextMixin, RoyaltiesV2Impl { 
    ...
    function burnSingleForMint(uint256 _burnTokenId, uint256 _mintTokenId) public onlyOwner {
        require(!paused, "The contract is paused!");
