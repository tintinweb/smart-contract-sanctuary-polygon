...
contract BetVerseTokenICO is ERC20, ReentrancyGuard {
    ...
    constructor(
        ...
        dai = IERC20(_daiAddress); // Kovan address => must change to mumbai (Matic) 0x6B175474E89094C44Da98b954EedeAC495271d0F
        ...
        )
    {
        ...
        dai.transferFrom(msg.sender, admin, daiAmount);
