...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x27DD2a02fD84405DdAde86434A9A99D8467592ef];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmbVmuGPFeMN5MK6enhECqvJPJqB5je6PgECUMLJ3xNf5S/";
...
// File: contracts/MyNftRamppProjectPolygonContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MyNftRamppProjectPolygonContract is RamppERC721A {
    constructor() RamppERC721A("My NFT Rampp Project  Polygon", "TESTPOL"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/uFWgkcOIaX1CQ552hSdt/contract-metadata";
    }
}
