...
contract NFTMarketplace {
    ...
    address constant WBNB_ADDRESS = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; //0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    function buyNFTItem(uint256 _id) external payable {
        ...
        emit BuyNFT(
            msg.sender,
            saleNFTItem[_id].sellerAddr,
            tokenId,
            saleNFTItem[_id].price
        );
    }
