...
// File contracts/ProxyImplementation.sol
...
// File contracts/GovernableImplementation.sol
...
// File contracts/interfaces/IDystopiaLens.sol
...
// File contracts/interfaces/IPenPool.sol
...
// File contracts/interfaces/IPenPoolFactory.sol
...
// File contracts/interfaces/IPen.sol
...
// File contracts/interfaces/IVlPen.sol
...
// File contracts/interfaces/IPenDyst.sol
...
// File contracts/interfaces/IDyst.sol
...
// File contracts/interfaces/IUserProxy.sol
...
// File contracts/interfaces/IVotingSnapshot.sol
...
// File contracts/interfaces/IMultiRewards.sol
...
// File contracts/interfaces/IPenV1Rewards.sol
...
// File contracts/interfaces/ITokensAllowlist.sol
...
// File contracts/interfaces/IPenLens.sol
...
// File contracts/interfaces/ICvlPen.sol
...
contract RewardsDistributor is GovernableImplementation, ProxyImplementation {
    ...
    // For OXD/FTM & penDYST/DYST LPs
    uint256 public ecosystemLPRate = 0;

    uint256 public penroseTeamRate = 0;

    uint256 public sphereTreasuryRate = 0;
    ...
    function setPenroseTeamAddress(address _penroseTeamAddress) external onlyGovernance {
    ...
    function notifyRewardAmount(
        ...
        // If it's DYST, distribute DYST at 10% to penDYST stakers (and partners), 5% to OXD stakers, 
        // x% to treasury, x% to OXD/FTM & penDYST/DYST LPs, and rest to LP (84%)
        ...
        // penDYST lockers get OXD = minted * (oxDyst.totalSupply()/DYST.totalSupply())
        // this ensures penDYST lockers are not diluted against other DYST stakers
        // and prevents the %OXD emission penDYST stakers get isn't diluted below penDYST/DYST.totalSupply()
        ...
        amount = amount.sub(rewardStreams.treasuryAmount);
        {
            ...
            if (partnersRatioOfDYST.mul(basis).div(1e18) > 2500) {
                ...
                // penDYST stakers always get at least 5% of OXD emissions
    ...
    function treasuryAddress() internal view returns (address) {
        return penLens().treasuryAddress();
    }
