...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x99d659E6E9E7806e6A4daDb38CFE0a91e7237983];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 2, 230 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmNZTB4sEmYn7PrddXep1a3gMPBx1PuGi7f7HRoVx7ScxG/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 230");
        _safeMint(_to, 1);
    }
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 230");
...
// File: contracts/BoredCatsNftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BoredCatsNftContract is RamppERC721A {
    constructor() RamppERC721A("Bored Cats NFT", "BCN"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/GrlsypYElbTHH89iPiMr/contract-metadata";
    }
}
