...
// Root file: contracts/tokens/ERC1155m_Brand_Tokens.sol
...
contract ERC1155m is ERC1155, Ownable, AccessControl {
    enum MoleculeType {
        Approve,
        Burn,
        Mint,
    ...
    constructor(string memory baseURI, address minter) ERC1155("") {
        setBaseURI(baseURI);
