...
contract FutToken is ERC20, ERC20Burnable, Pausable, ERC20Permit, AccessControlled {
    ...
    function getCurrentWeek() public view returns (uint256) {
        ...
        console.log("block.timestamp - startingDate", block.timestamp - startingDate);
        console.log("block.timestamp - startingDate / 604800", (block.timestamp - startingDate) / 604800);
