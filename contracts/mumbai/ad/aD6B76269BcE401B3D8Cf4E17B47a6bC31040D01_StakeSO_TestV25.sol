...
contract StakeSO_TestV25 is Ownable {
    ...
    // mapping of rarity to remaining slots
    mapping(uint256 => uint256) remainingSlots;
...
/*------------- Calculation & Logics -------------*/
    ...
    */
    ...
    function getCurrentRate(uint256 _rarity) public view returns(uint256) {
    ...
    */
    ...
    // get number of slots remianing free
