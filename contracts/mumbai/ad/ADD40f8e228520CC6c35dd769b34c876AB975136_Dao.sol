...
contract Dao {
    ...
    constructor(){
        ...
        validTokens = [84373113415236196300988367167875491894553176731066103853121613425382961184769];
    }
    ...
    function countVotes(uint256 _id) public {
        ...
        require(Proposals[_id].exists, "Proposal does not exist");
        require(block.number > Proposals[_id].deadline, "Voting has concluded");
