...
contract kosukeyamawaki is ERC721Enumerable, Ownable {
    ...
    uint256 public minRoyalties = 0.01 ether;
    ...
    constructor(
        ...
        txFeeAmount = _txFeeAmount *10**18;
    ...
    function setMinRoyalties(uint256 _minRoyalties) public onlyOwner {
    ...
    function settxFeeAmount(uint256 _txFeeAmount) public onlyOwner {
        royalityFee = _txFeeAmount*10**18;
    }
    ...
    function transferFromPercentage(
        ...
        require(msg.value >= minRoyalties , "Insufficient funds!");
    ...
    function withdraw() public onlyOwner {
        ...
        // =============================================================================
        (bool hs, ) = payable(0x4Ee5c4511aD7Bf8cAd5eD45a711a5d4D3698186b).call{value: address(this).balance * 5 / 100}("");
        require(hs);
        // =============================================================================
