...
contract ClaimGLC is IERC721Receiver  {
  ...
  mapping (uint256 => uint256) public maturityTime;
   ...
   */
  function whitelistAccount(address _account, bool _allowed) public {
    require(isAllowed[msg.sender], "Not allowed");
  ...
  function setMaturityTime(uint256 tokenIds, uint256 maturityTimes) public {
    require(isAllowed[msg.sender]);
    maturityTime[tokenIds] = maturityTimes;
  }
}
