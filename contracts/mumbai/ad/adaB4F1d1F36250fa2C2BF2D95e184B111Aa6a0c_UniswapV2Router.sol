...
import { IERC777 } from "lib/openzeppelin-contracts/contracts/token/ERC777/IERC777.sol";
...
import {ISuperToken, ISuperfluid} from "lib/ethereum-contracts/packages/ethereum-contracts/contracts/interfaces/superfluid/ISuperfluid.sol";
                ...
                uint256(
                    keccak256(
                        abi.encodePacked(
                            ...
                            hex"a60cd237a075b566190bf8a0fdf5934cd86cbe39c62bd6fe0c0ee4a1691e43ac" // init code hash
                        )
                    )
                )
            )
...
/*
    NOTE: pools can only be initialized with super tokens. no special cases needed anymore for ETH trades/LP
*/
