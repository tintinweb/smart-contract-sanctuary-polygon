...
contract LevelPrice is ILevelPrice, Ownable {
    ...
    event SetupId(uint256 id, uint256 level, uint256 price);

    event SetupLevels(uint256 levels);
    ...
    function setLevelPriceById(
        ...
        emit SetupId(_tokenId, _level, _price);
    }
    ...
    function setupLevels(
        ...
        emit SetupLevels(_levels.length);
        return true;
    }
