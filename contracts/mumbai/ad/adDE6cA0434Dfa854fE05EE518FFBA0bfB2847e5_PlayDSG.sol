...
contract PlayDSG {
    ...
    uint256 private level4And5Bonus = 34000e6;
    uint256 private constant level2And3Bonus = 5000e6;
    ...
    uint256 private constant balDown = 210000e6;
    ...
    function _calLevelNow(address _user) private view returns (uint256) {
        ...
        if (total >= 2000e6 && directTeam >= 15 && user.teamNum >= 300 && user.maxDirectDeposit >= 10000e6 && maxTeam >= 100000e6 && otherTeam >= 100000e6) {
            levelNow = 5; // Diamond
        } else if (total >= 2000e6 && directTeam >= 10 && user.teamNum >= 150 && user.maxDirectDeposit >= 5000e6 && maxTeam >= 50000e6 && otherTeam >= 50000e6) {
            levelNow = 4; // Ruby
        } else if (total >= 500e6 && directTeam >= 5 && user.teamNum >= 40 && user.maxDirectDeposit >= 2000e6 && maxTeam >= 10000e6 && otherTeam >= 10000e6) {
            levelNow = 3; // Gold
        } else if (total >= 200e6 && directTeam >= 3 && user.teamNum >= 10 && user.maxDirectDeposit >= 1000e6 && maxTeam >= 500e6 && otherTeam >= 1500e6) {
            levelNow = 2; // Silver
        } else if (total >= 50e6) {
            levelNow = 1; // Newbie
        }
        ...
        if (level5Count > 0 && !isStopLoss2) {
            ...
            for (uint256 i = 0; i < diamondPlayers.length; i++) {
                ...
                if (userInfo[_user].level == 5) {
                    ...
                    if(rubyCount > 1) {
                        givenReward = givenReward + (20e6*(rubyCount - 1));
                    } 
