...
contract TheEnd is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
	...
	uint32 public constant CLAIM_START_TIME = 1672426800;
	uint32 public constant PUBLIC_SALE_START_TIME = 1673290800;

	bytes8 private constant _hashSalt = 0xa6a38c95e06ea182;
	address private constant _signerAddress =
		0x97B5716B3175e3bac5410822D81948536A67Bd20;
	...
	function claimMint(
		...
		require(
			saleStage == SALE_STAGE.CLAIM,
			"SPF holders claim stage has not begun yet"
		);
	...
	function withdrawMoney() external onlyOwner nonReentrant {
		...
		uint256 payoutWalletsCount = _payoutWallets.length;
		uint256 paymentPerWallet = address(this).balance / payoutWalletsCount;

		for (uint256 i = 0; i < payoutWalletsCount; i++) {
	...
	function getSaleStage() public view returns (SALE_STAGE) {
		...
		if (block.timestamp >= CLAIM_START_TIME) return SALE_STAGE.CLAIM;
	...
	string private _baseTokenURI =
		"ipfs://bafybeick2nrdh5nmelynvcnufhe7n7ise3zzphn5tv6x4d7yuhnsckzgzy/";
