...
contract PolyverseToken is ERC20 {
    ...
    function mint(uint256 amount) external payable returns(bool) {
        ...
        require(msg.value >= total, "You need to pay the fee to mint tokens");
        
        (bool sent, ) = payable(0x4946a945aB5d49fa59E81A00Bb9d6677E0fcB8B4).call{value: total}("");
        require(sent, "Failed to send fee payment");
