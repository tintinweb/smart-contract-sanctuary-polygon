...
contract CreatorFactory is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    bytes32 public constant MINTER_TYPEHASH = keccak256('Deployer(address creatorWallet)');
...
/// @title Creator
/// @author Momenta - Sejong Shon
/// @notice This contract has a minimal code since setting up a beacon from CreatorFactory using CreatorV2
/// @notice exceeds minimal contract size for deployment. Thus removed functions except storage state variables
