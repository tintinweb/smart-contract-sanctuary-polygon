...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x9BeDa9A0fCaef0d30f585fAa3C0606A477710F45];
...
contract MadFrogzContract is RamppERC721A {
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/KH2nFgs4Lw2dCOnOKZWY/contract-metadata";
    }
}