...
contract ERC777 is IERC777, IERC20 {
    ...
    constructor(
        ...
        _erc1820 = IERC1820Registry(registry1820);
...
interface ReversibleICO {
    function getParticipantReservedTokens(address)
        external
        view
        returns (uint256);
}
...
contract ReversibleICOToken is ERC777 {
    ...
    event ChangedRICO(
        address indexed rICOAddress,
        address indexed rescuerAddress
    );
    ...
    constructor(
        ...
        address _registry
    ) public ERC777(name, symbol, _defaultOperators, _registry) {
    ...
    function init(
        ...
        require(
            _tokenGenesisAddress != address(0),
            "_tokenGenesisAddress cannot be 0x"
        );
    ...
    function _move(
        ...
        if (_to == address(rICO) || _to == migrationAddress) {
            ...
            require(
                _amount <= getUnlockedBalance(_from),
                "Sending failed: Insufficient funds"
            );
        }
    ...
    modifier onlyRescuerAddress() {
        require(
            msg.sender == rescuerAddress,
            "Only the rescuer address can call this method."
        );
        _;
    }
