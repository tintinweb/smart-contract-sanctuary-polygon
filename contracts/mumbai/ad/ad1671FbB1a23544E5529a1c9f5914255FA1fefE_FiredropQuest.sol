...
// File: .deps/remix-tests/firequest.sol
    ...
    ReentrancyGuard
{
    ...
    string private constant baseTokenURI = "https://gateway.pinata.cloud/ipfs/";
    string private _name = "Firedrop Quest Test";
    string private _symbol = "FQTTEST";
    ...
    constructor(address _owner) ERC1155(baseTokenURI) {
    ...
    function mint(address creator, string memory _uri)
        external
        nonReentrant
        onlyOwner
        returns (uint256 _tokenId)
    {
        ...
        require(_tokenId <= 10, "Limit exceeds");
        _mint(creator, _tokenId, 10000, "");
