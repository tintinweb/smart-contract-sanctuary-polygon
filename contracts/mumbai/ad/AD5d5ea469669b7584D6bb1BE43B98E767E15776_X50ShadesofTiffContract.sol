...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xA5880F4Ccb8eCB3DE32737C17824122C8Cc32d5D];
  address public erc20Payable = 0xA5880F4Ccb8eCB3DE32737C17824122C8Cc32d5D;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeictqvdg7ft37ljvj27vkm6qqexo63qomnrncyufxdt7s3tzbj7mri/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/Sxqi3K8Aaf3U8aNz3fd0/contract-metadata";
  }
...
// File: contracts/X50ShadesofTiffContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract X50ShadesofTiffContract is RamppERC721A {
    constructor() RamppERC721A("50 Shades of Tiff", "50TIFFS"){}
}
