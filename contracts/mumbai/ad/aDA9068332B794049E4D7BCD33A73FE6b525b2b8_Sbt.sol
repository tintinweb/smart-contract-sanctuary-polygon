...
contract ERC1155 is ERC165, IERC1155, IERC1155MetadataURI {
    ...
    function setApprovalForAll(address _operator, bool _approved) external pure {
        revert ERC1155NoSetApprovalForAll(_operator, _approved);
    }

    function isApprovedForAll(address _account, address _operator) external pure returns (bool) {
        revert ERC1155NoIsApprovedForAll(_account, _operator);
    }
    ...
    function safeTransferFrom(
        ...
        revert ERC1155NoSafeTransferFrom(_from, _to, _id, _amount, _data);
    }
    ...
    function safeBatchTransferFrom(
        ...
        revert ERC1155NoSafeBatchTransferFrom(_from, _to, _ids, _amounts, _data);
    }
    ...
    //  ==========  Additional logic    ==========
    function _mint(address[] memory _tos, uint256 _tokenId) internal {
        for (uint256 i = 0; i < _tos.length; i++) {
            require(_tos[i] != address(0), "Mint to the zero address.");
            require(_balances[_tokenId][_tos[i]] == 0, "Already minted to this user.");

            _balances[_tokenId][_tos[i]]++;
        }
    }
    ...
    function _burn(address _from, uint256 _tokenId) internal {
        ...
        require(
            _from == msg.sender || _tokenMetadata[_tokenId].createdBy == msg.sender,
        ...
        unchecked {
            _balances[_tokenId][_from] = fromBalance - 1;
        }
    }
...
contract Sbt is ERC1155 {
    ...
    function mint(
        ...
        console.log("SBT #%s has been minted", _tokenId);
    }

    function burn(address _from, uint256 _tokenId) external {
        _burn(_from, _tokenId);
        console.log("SBT #%s has been burnt from %s", _tokenId, _from);
    }
}
