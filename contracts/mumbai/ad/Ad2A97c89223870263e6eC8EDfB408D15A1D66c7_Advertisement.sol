...
contract Advertisement is NFT721Metadata {
    using AddressUpgradeable for address;
        ...
        external
    {
        ...
        // adInfo.title = adDetails_[0];
        // adInfo.targetLink = adDetails_[1];
        // adInfo.category = adDetails_[2];
        // adInfo.content = adDetails_[3];
        // adInfo.layout = adDetails_[4];
        // adInfo.targetPlatform = adDetails_[5];
