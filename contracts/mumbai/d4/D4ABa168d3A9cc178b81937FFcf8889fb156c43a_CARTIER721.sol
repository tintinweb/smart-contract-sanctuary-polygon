    ...
    OwnableOperatorRole
{
    ...
    function initialize(
        ...
        __CARTIER721_init_unchained();

    }

    function __CARTIER721_init_unchained() internal initializer virtual {
    ...
    function mint(address creator, string memory _tokenURI) 
        public 
        virtual 
        payable
        returns (uint256) 
    {
        require(hasRole(MINTER_ROLE, _msgSender()), "CARTIER721: must have minter role to mint");
    ...
    function mintBatch(address creator, string[] memory tokenURIs) 
        public 
        virtual
        returns (bool)
    {
    ...
    function pause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "CARTIER721: must have pauser role to pause");
        _pause();
    }

    function unpause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "CARTIER721: must have pauser role to unpause");
        _unpause();
    }
