...
contract EvoxSale is Ownable, IEvoxSale {
    ...
    constructor(
        ...
        allocationPerNFT = _allocationPerNFT * (10**18);
    }

    /**
     * @notice Transfers the deposited tokens to the owner.
     * @dev This function can only be called by the owner.
     */
    function transferTokens() external onlyOwner {
        peggedToken.safeTransfer(msg.sender, peggedToken.balanceOf(address(this)));
    }
    ...
    function deposit(uint256 _amount) external override {
        ...
        peggedToken.safeTransferFrom(msg.sender, address(this), _amount);
