...
contract StanFundV2 is OwnableUpgradeable {
    ...
    function setAbilityToWithdraw(uint256 _val, uint256 _valDenomination)
        external
        onlyOwner
    {
        ability.val = _val;
    ...
    function deposit(
        ...
        totalSupply += _amount;
        userSupply += _amount;
        tokenStan.transferFrom(msg.sender, address(this), _amount);
    ...
    function withdraw(
        ...
        totalSupply -= _amount;
        userSupply -= _amount;
        tokenStan.transfer(msg.sender, _amount);
    ...
    function withdrawByStan(
        ...
        totalSupply -= _amount;
        tokenStan.transfer(owner(), _amount);
