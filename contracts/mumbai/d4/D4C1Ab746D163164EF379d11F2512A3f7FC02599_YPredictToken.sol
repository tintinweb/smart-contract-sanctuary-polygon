...
contract YPredictToken is ERC20, Ownable {
    ...
    function setDevFee(uint256 _onBuy, uint256 _onSell) external onlyOwner {
        require(_onBuy <= 7 && _onSell <= 7, "Invalid devFee");
        require(
            totalFeesOnBuy.sub(devFeeOnBuy).add(_onBuy) <= 7,
            "Invalid Total Fee"
        );
        require(
            totalFeesOnSell.sub(devFeeOnSell).add(_onSell) <= 7,
            "Invalid Total Fee"
        );
        devFeeOnBuy = _onBuy;
    ...
    function setMarketingFee(
        ...
        require(_onBuy <= 7 && _onSell <= 7, "Invalid Fee");
        require(
            totalFeesOnBuy.sub(marketingFeeOnBuy).add(_onBuy) <= 7,
            "Invalid Total Fee"
        );
        require(
            totalFeesOnSell.sub(marketingFeeOnSell).add(_onSell) <= 7,
            "Invalid Total Fee"
        );
    ...
    function setLiquidityFee(
        ...
        require(_onBuy <= 7 && _onSell <= 7, "Invalid Fee");
        require(
            totalFeesOnBuy.sub(liquidityFeeOnBuy).add(_onBuy) <= 7,
            "Invalid Total Fee"
        );
        require(
            totalFeesOnSell.sub(liquidityFeeOnSell).add(_onSell) <= 7,
            "Invalid Total Fee"
        );
    ...
    function setCtoFee(uint256 _onBuy, uint256 _onSell) external onlyOwner {
        require(_onBuy <= 7 && _onSell <= 7, "Invalid Fee");
        require(
            totalFeesOnBuy.sub(ctoFeeOnBuy).add(_onBuy) <= 7,
            "Invalid Total Fee"
        );
        require(
            totalFeesOnSell.sub(ctoFeeOnSell).add(_onSell) <= 7,
            "Invalid Total Fee"
        );
        ctoFeeOnBuy = _onBuy;
    ...
    function setResearchFee(
        uint256 _onBuy,
        uint256 _onSell
    ) external onlyOwner {
        require(_onBuy <= 7 && _onSell <= 7, "Invalid Fee");
        require(
            totalFeesOnBuy.sub(researchFeeOnBuy).add(_onBuy) <= 7,
            "Invalid Total Fee"
        );
        require(
            totalFeesOnSell.sub(researchFeeOnSell).add(_onSell) <= 7,
            "Invalid Total Fee"
        );
