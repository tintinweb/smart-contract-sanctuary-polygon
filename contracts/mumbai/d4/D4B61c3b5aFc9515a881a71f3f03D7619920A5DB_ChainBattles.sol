...
contract ChainBattles is ERC721URIStorage {
    ...
    uint constant lvl = 1;
    uint constant hp = 1;
    uint constant strength = 2;
    uint constant speed = 5;
    ...
    function getHealthPoints(uint256 tokenId) public view returns (string memory) {
    ...
    function train(uint256 tokenId) public {
        require(_exists(tokenId), "This token dosen't exist.");
        require(ownerOf(tokenId) == msg.sender, "You dont own this token.");
        require((tokenIdToLevels[tokenId].level) < 10, "Max level reached.");
        ...
        tokenIdToLevels[tokenId].strength = currentStrength + 2;
