...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _mint(address to, uint256 tokenId) internal virtual {
        ...
        require((_limited == false) || (balanceOf(to) < 1),"onlyOneNFT: Only One Nft for Owner");
...
contract EBLive is ERC721 {
    ...
    constructor() ERC721("TestEBL2023","TestEBL","http://www.google.es", 100) {
        _Admin = _msgSender();
        _Creator = _msgSender();
    }
    ...
    function SetUnpause() public onlyAdmin {
        require(_paused == true, "Pausable: Already Unpaused");
        _paused = false;
    }
    ...
    function SetUnLimited() public onlyAdmin {
        require(_getLimited() == true, "Limite: Already Unlimited");
        _setUnLimited();
    }
    ...
    //Funciones Minteo
    function SafeMint(address to) public onlyCreator whenNotPaused {
    ...
    modifier whenNotPaused() {
        require(_paused == false,"Pausable: Mint paused");
        _;
    }
}