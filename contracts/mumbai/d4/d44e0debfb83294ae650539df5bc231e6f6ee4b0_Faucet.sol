...
/// @title A recipient for the DAO to store tokens and spend them automatically without the need for a voting.
/// @dev This is contract is intended to store a small number of tokens  The tokens are used to pay for delegation, tally counting, execution of approved transactions and referral rewards. The DAO periodically refills this contract with more tokens as needed through a voting.
