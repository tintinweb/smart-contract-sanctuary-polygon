...
// modified from Velodrome, minimal ERC20
contract KZA is ERC20("KINZA", "KZA"), ERC20Permit("Kinza") {
    ...
    // governance can use this to propose/cancel newGovernance.
    ...
    // newGovernance need to accept the governance role
    ...
    // total 100M
    // Initial mint: 40M for reserve, team vesting, investor, initial LP etc
