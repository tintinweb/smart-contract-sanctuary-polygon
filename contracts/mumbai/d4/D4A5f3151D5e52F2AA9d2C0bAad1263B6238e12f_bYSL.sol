...
/**
    ...
    **/
    ...
    function backedPrice() public returns(uint){
        uint _backedPrice = ((((IERC20(Admin.BUSD()).balanceOf(Admin.Treasury()) + IERC20(Admin.BUSD()).balanceOf(Admin.POL()))) * 10 **18)/totalSupply());
