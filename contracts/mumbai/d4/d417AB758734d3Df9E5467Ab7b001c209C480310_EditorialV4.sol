...
contract EditorialV4 is ERC1155, Ownable, Pausable, ReentrancyGuard, AccessControl {
    // string baseUri = "https://www.realestatechain.es/api/item/";
    string baseUri = "ipfs://bafybeid6cefjbybv4vp64kbebeku62txv6qtqxg3xewc7mscxjbi4totzy/";
    
    // update baseUri

    // Token type 1
    // ipfs://bafybeid6cefjbybv4vp64kbebeku62txv6qtqxg3xewc7mscxjbi4totzy/
    // MmCaT-premium-001
    // 700 tokens
    ...
    function addBook(
        ...
        // _bookAutoId and bookdata[ ] might not be needed anymore
        // test and delete in the future
        _bookAutoId.increment();
        uint256 newBookId = _bookAutoId.current();
        // _mint(msg.sender, newBookId, 1, "");

        // params: address acct, uint256 id, uint256 amount, bytes internal data
        ...
        _addTokenHolder( msg.sender, _tokenType );
