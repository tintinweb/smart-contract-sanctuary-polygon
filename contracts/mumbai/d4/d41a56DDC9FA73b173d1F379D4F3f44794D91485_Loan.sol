...
contract Loan is ERC721, LoanAdmin, SignatureLoan {
    ...
    function beginLoan(
        ...
        require(uint256(loan.loanDuration) <= maximumLoanDuration, "Not exceed maximum loan duration");
        ...
        // loan completion.
        IERC721(loan.nftCollateralContract).transferFrom(_lender, address(this), loan.nftCollateralId);

        // Transfer principal from borrower to lender.
