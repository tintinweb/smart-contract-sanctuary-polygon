...
contract NFTMarket is ERC721Holder, ERC1155Holder, Ownable, ReentrancyGuard {
    ...
    function createERC721Listing(address tokenAddress, uint256 tokenId, address ownerAddress, uint256 price) external nonReentrant returns(uint256 listingId){
        ...
        return _listingIdERC721Counter.current();
    }

    function createERC1155Listing(address tokenAddress, uint256 tokenId, address ownerAddress, uint256 price, uint256 quantity) external nonReentrant returns(uint256 listingId){
        ...
        return _listingIdERC1155Counter.current();
    }
