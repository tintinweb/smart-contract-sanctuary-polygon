...
contract Ifo20230503 is Ownable {
    ...
    function getUserData(address _user, uint256 _preAmount) external view returns (returnItem memory returnItem_) {
        ...
        returnItem_._preTotalAmount = _preAmount * IfoConfig.price;
    }
