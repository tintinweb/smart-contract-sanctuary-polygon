...
contract testUpdateMetadata is ERC1155, Ownable, AccessControl, ReentrancyGuard{
    ...
    ImageHandlerManager ImageHandler;

    function setAddresses(address meta) external onlyOwner {
        //migrator      = mig;
        ImageHandler = ImageHandlerManager(meta);
    }
...
/*
    function getImage(uint256 tokenId) external view returns(string memory){
        ...
        //linkImage = ImageHandler.getImageURI(attributes[tokenId].numberCard);

        return ImageHandler.getImageURI(attributes[tokenId].numberCard);
...
*/
    ...
    function uri(uint256 tokenId) public view override returns (string memory) {
        ...
        //string memory img_dinamica = getImage(attributes[tokenId].numberCard);
        string memory img = 'ipfs://QmPrEcMp8J9utBMswLzK3iCxnxo9DFPh3L3jHrkzkwWELb';
