...
contract EAZYELEPHANTS is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("EAZY-ELEPHANTS", "EAZY-EEEE'S") {
    setHiddenMetadataUri("ipfs://QmeQmzX7G8LBnpwTemP2zqYcT8N82zKyPUv6RtXXCcEoKe/hidden.json");
  }
