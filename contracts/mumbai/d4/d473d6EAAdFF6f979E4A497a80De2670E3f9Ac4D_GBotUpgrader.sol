...
// File contracts_v2/utils/access/TokenTimeLock.sol
...
// File contracts_v2/game/GBotUpgrader/UpgraderProperties.sol
...
// File contracts_v2/game/GBotUpgrader/GBotUpgrader.sol
...
contract GBotUpgrader is ERC721Receiver, Ownable, Pausable, TokenTimelock, UpgraderProperties {
  ...
  event GBotEvolutionStarted(address indexed owner, uint256 tokenId, uint256 gmeeCost, uint256 ompCost, uint256 newMetadata, uint256 lockTimestamp);
    ...
    function upgradeGBot(
        ...
        uint256 copDifference = calculateCop(newMetadata) - (calculateCop(metadata));
    ...
    function claimGBot(uint256 tokenId) public {
