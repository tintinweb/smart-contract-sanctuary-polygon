// 0xa761B63438AbcC87D8cc8931d1D2b105741F42e4
...
contract ChainBattles is ERC721URIStorage  {
    ...
    string[] colors = ["Red", "Orange", "Yellow", "Green", "Blue", "Indigo", "Violet", "Silver", "Gold"];
    ...
    bytes memory svg = abi.encodePacked(
        ...
        "<text x='50%' y='30%' class='base' dominant-baseline='middle' text-anchor='middle'>Class: Rogue</text>",
    ...
    function train(uint256 tokenId) public {
      ...
      track = Track(current.id, current.level+1, current.hp+50, current.strength+15, current.speed+25);
