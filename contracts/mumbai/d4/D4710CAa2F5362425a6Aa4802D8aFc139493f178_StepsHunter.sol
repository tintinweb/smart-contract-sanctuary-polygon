...
contract StepsHunter is ChainlinkClient, ConfirmedOwner, AutomationCompatibleInterface {
    ...
    constructor(ENV _env) ConfirmedOwner(msg.sender) {
        ...
        i_link = LinkTokenInterface(0x326C977E6efc84E512bB9C30f76E30c160eD06FB); // Polygon Mumbai Link from https://docs.chain.link/docs/link-token-contracts/#mumbai-testnet

        registrar = 0x57A4a13b35d25EE78e084168aBaC5ad360252467; // Polygon Mumbai from https://docs.chain.link/chainlink-automation/supported-networks/#configurations
        i_registry = AutomationRegistryInterface(0xE16Df59B887e3Caa439E0b29B42bA2e7976FD8b2); // Polygon Mumbai from https://docs.chain.link/chainlink-automation/supported-networks/#configurations
