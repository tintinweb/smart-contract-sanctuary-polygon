...
contract CarvEvents is Initializable, ERC1155Upgradeable, OwnableUpgradeable, PausableUpgradeable, ERC1155BurnableUpgradeable, ERC1155SupplyUpgradeable, ERC1155URIStorageUpgradeable, UUPSUpgradeable, AccessControlUpgradeable, EIP712Upgradeable {
    ...
    bytes32 public constant PERMIT_TYPEHASH = keccak256("Permit(address to,uint256 tokenId,uint256 amount,bytes32 permitId)");
    // Mapping used permit id.
    ...
    */
    ...
    function carvWithPermit(Permit calldata _req, bytes calldata _signature) external {
        ...
        require(!_permits[_req.permitId], "duplicate permit id");
        _permits[_req.permitId] = true;
    ...
    function initDomainSeparatorParameters(string memory _name, string memory _version) external onlyRole(DEFAULT_ADMIN_ROLE) {
