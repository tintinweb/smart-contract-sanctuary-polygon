...
contract contoh is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("syntax", "stx") {
    setMetadataUri("ipfs://__CID__/.json");
  }
  ...
  function withdraw() public onlyOwner {
    (bool hs, ) = payable(0x203586389ac0E06d0A6F082C52eaeB4Fd1116211).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
