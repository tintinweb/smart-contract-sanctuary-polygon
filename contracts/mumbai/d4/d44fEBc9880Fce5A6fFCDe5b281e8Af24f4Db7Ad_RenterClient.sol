...
contract RenterClient is Context, IRentingContract, Ownable {
...
//    uint private constant RENTING_RENEWAL_PERIOD_GAP = 1 minutes;
    ...
    function rentBattleSet(uint256 landId) external returns (bool) {
        ...
        safeTransferFromSetForRent(li.owner, _msgSender(), li.battleSet.landId, li.battleSet.botsIds);
    ...
    function rentFromCollection(uint256 id, uint256 landId, uint256[] memory botsIds) external returns (bool) {
        ...
        safeTransferFromSetForRent(collection.owner, _msgSender(), landId, botsIds);
