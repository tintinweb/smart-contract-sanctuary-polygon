...
contract MDMA is ERC20Upgradeable, IMintable, IAdmin, Ownable {
    constructor() {
        initialize();
    }

    function initialize() public initializer {
        __ERC20_init("MAD Metafuel", "MDMA");
        super.transferOwnership(msg.sender);
        super._addAdmin(msg.sender);
        // mint 10 billions of tokens to owner
    ...
    function mint(address to, uint256 amount) public override isAdmin {
        super._mint(to, amount * (10**uint256(decimals())));
    }
}
