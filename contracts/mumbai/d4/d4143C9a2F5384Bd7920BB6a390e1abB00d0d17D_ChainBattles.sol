...
mapping(uint256 => uint256) public tokenIdToLevels; // uint256 mapped to uint256. keep track of the NFT level.
...
function mint() public {
    ...
    tokenIdToLevels[newItemId] = 0;     // create new item in tokenIdToLevels mapping, assign value to 0. nft levels start at zero.
...
function train(uint256 tokenId) public {
    ...
    uint256 currentLevel = tokenIdToLevels[tokenId];    // above checks pass, get the current level of the nft...
    tokenIdToLevels[tokenId] = currentLevel + 1;       // then increment by 1
