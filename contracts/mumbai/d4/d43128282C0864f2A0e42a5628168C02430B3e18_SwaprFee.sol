...
contract SwaprFee is BaseGovernanceWithUserUpgradable {
    ...
    function getDiscountAmount(address _discountToken)
        external
        view
    ...
    function _exists(
        ...
        if((_paymentToken == address(0) && address(_cryptoPriceFeed) != address(0)) || (_paymentToken == address(lkrToken) && address(lkrOracle) != address(0))) {
            return (true, 0);
        }
