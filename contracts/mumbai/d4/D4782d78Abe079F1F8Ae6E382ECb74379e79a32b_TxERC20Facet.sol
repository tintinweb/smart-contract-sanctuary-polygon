...
/******************************************************************************\
/// @title Sipher Portal - TxERC20 Facet
/// @author Ather Labs
/// @dev This contract provides functions for user to deposit listed ERC20 token into the portal.
/******************************************************************************/
...
contract TxERC20Facet is IOperations {
    /* ------ TYPE & VARIABLES ------ */
    ...
    /* ------ EXTERNAL FUNTIONS ------ */
    /// @notice Deposit a listed ERC20 token to the portal.
    ...
    function depositERC20(IERC20 _tokenAddress, uint88 _amount) external {
        LibStatusControl._requireDepositEnabled();
        uint8 listingId = LibTokenManagement._validateTokenAddress(address(_tokenAddress));
        LibTokenManagement._requireUnpaused(listingId);

        // Start transfer token from user to contract
        ...
        require(depositAmount > s.config.minDeposit[listingId], "TE20F: Deposit amount is invalid");
...
/******************************************************************************\
/// @title Sipher Portal - Library Bytes
/// @author Ather Labs
...
/******************************************************************************\
/// @title Sipher Portal - Library Operations
/// @author Ather Labs
