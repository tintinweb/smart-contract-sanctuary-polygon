...
contract Hera is Context, IERC20, Ownable {
    ...
    string private _name = "Hera";
    string private _symbol = "HRA";
    uint8 private _decimals = 8;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0x4476Fad5886B69965a4dB4160579142b82061a25);
    address payable public teamWalletAddress = payable(0x5A516136dC05f9395D541B1fD86B31BAa66C5B9a);
