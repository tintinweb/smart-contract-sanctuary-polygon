...
contract Omni is OFTV2 {
    ...
    constructor(address _layerZeroEndpoint, uint8 _sharedDecimals) OFTV2("OMNI", "OMME", _sharedDecimals, _layerZeroEndpoint) {
    ...
    function _beforeTokenTransfer(
      ...
      if(!blackList[from] && !blackList[to])
        require(amount < super.totalSupply() / 1000, "Can't transfer tokens more than 0.1% of totalSupply.");
    }
