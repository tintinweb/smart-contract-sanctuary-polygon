...
contract testomi {
	...
	uint256 constant public INVEST_MIN_AMOUNT = 1e16;
	uint256 constant public PERCENTS_DIVIDER = 1000;
	uint256 constant public CONTRACT_BALANCE_STEP = 1000000 ether;
	uint256 constant public TIME_STEP = 1 days;
	uint256 constant public BASE_PERCENT = 10;  // 1%
	uint256 constant public MARKETING_FEE = 55; // 5.5%
	uint256 constant public PROJECT_FEE = 55;   // 5.5%
  ...
  // -----------------------------------------
	...
	function invest(address referrer) external payable {
			if (!started) {
			if (msg.sender == marketingAddress) {
				started = true;
