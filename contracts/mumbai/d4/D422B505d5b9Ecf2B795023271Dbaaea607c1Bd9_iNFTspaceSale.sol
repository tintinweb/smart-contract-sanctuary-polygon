...
contract iNFTspaceSale is Ownable {
    ...
    function getSellingNFTs(uint256 _index) public view returns (Selling memory) {
        return _sellingNFTs[_sellingNFTsId[_index].saleTokenId][_sellingNFTsId[_index].assetId];
    }

    function getSellingNFTsId(uint256 _index) public view returns (SellingId memory) {
    ...
    function getSupportSaleTokensLength() public view returns (uint256) {
        return _supportSaleTokens.length;
    }

    function getSupportSaleTokens(uint256 _index) public view returns (SaleToken memory) {
    ...
    function getPayCurrenciesLength() public view returns (uint256) {
        return _supportCurrencies.length;
    }

    function getPayCurrencies(uint256 _index) public view returns (PayCurrency memory) {
