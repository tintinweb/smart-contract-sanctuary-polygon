...
import "./zetachain/interfaces/ZetaInterfaces.sol";
import "./zetachain/tools/ZetaInteractor.sol";
    ...
    ZetaReceiver
{
    ...
    mapping(address => uint) public balances; // extra zeta balances

    IERC20 internal immutable _zetaToken;
    ZetaTokenConsumer private immutable _zetaConsumer;

    modifier supportCrossChain() {
        if (address(connector) == address(1)) {
    ...
    function crossChainTransfer(
        ...
        bytes memory destinationAddress = interactorsByChainId[
            destinationChain
        ];
    ...
    function onZetaMessage(
        ...
        balances[sender] += zetaMessage.zetaValue;
    ...
    function withdraw() public {
        ...
        _zetaToken.transfer(_msgSender(), balance);
    }
    ...
    function onZetaRevert(
        ...
        balances[sender] += zetaRevert.remainingZetaValue;
        _mint(sender, tokenId, amount, "");
    }
}
