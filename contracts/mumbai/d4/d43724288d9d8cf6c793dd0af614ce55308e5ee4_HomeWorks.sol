...
abstract contract PriceOFETHTOUSD{
...
contract HomeWorks is ERC721Enumerable, PriceOFETHTOUSD, Ownable {
  using Strings for uint256;
...
string  public _name = "Open works";
string public  _symbol = "op1";
  constructor (
