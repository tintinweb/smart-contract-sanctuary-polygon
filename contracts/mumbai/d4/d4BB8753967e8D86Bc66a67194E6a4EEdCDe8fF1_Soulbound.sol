...
contract Soulbound is ERC721, ERC721Enumerable, Ownable {

  // we only allow some users and also control how many nfts they can mint
  // a kind of whitelist
  mapping(address => uint256) public allowlist;

  constructor() ERC721("Soulbound", "SoulboundNFT") {}
  ...
  // Non-transferability
  // this soulbound nft principal that they cant be transferred
  // lets deploy on testnet now
