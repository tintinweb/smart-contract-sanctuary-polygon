...
contract AskjaCoin is ERC20PresetFixedSupplyUpgradeable, OwnableUpgradeable {
    //////////////////////////////////////////////////////////////////////
    //DEV
    address public constant rusticityWallet =
        0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266;
    address public constant marketingAdress =
        0x90F79bf6EB2c4f870365E785982E1f101E93b906;
    address public constant devAdress =
        0x15d34AAf54267DB7D7c367839AAf71A00a2C6A65;
    address public constant charityAdress =
        0x9965507D1a55bcC2695C58ba16FB37d819B0A4dc;

    // PROD
    // address public constant rusticityWallet =
    //     0xAec3F27c1612dF71075417007341040b2c6Dd561;
    // address public constant marketingAdress =
    //     0x79910e35c0d0D4758840F7Dbb4487C58506F5767;
    // address public constant devAdress =
    //     0x36615cBaB9Def10fEe9a992a45595517ee33243B;
    // address public constant charityAdress =
    //     0xe2b9Fe279E07316dC235e64Eb4D255e710D5375a;
        ...
        returns (bool)
    {
        if (_msgSender() != rusticityWallet) {
            ...
            // calculate the share for your target address 3%
            uint256 shareForMarketing = (amount / 100) * 3;
            uint256 shareForDev = (amount / 100) * 2;
            uint256 shareForCharity = (amount / 100) * 1;

            _transfer(
                _msgSender(),
                recipient,
                amount - shareForMarketing - shareForDev - shareForCharity
            );

            _transfer(_msgSender(), marketingAdress, shareForMarketing);

            _transfer(_msgSender(), devAdress, shareForDev);
            _transfer(_msgSender(), charityAdress, shareForCharity);
        } else {
