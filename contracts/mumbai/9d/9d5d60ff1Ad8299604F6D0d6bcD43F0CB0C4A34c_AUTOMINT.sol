...
contract AUTOMINT {
    Implementation impl = Implementation(0xeE37936ac616443CabCA3a90D5e334277076c392);

    //address nftreceiver = 0xeF904Ea6E04239d817e7D216E2A94dbC9Dd5E66b;

    function mintNFTs (uint256 NFTnumber, string memory uri) public{
        for (uint i=1; i<=NFTnumber;i++){
            impl.mint(0xeF904Ea6E04239d817e7D216E2A94dbC9Dd5E66b,uri);
        }
    }
}