...
abstract contract MerfiHarvester is Manageable, IMerfiHarvester, OpsReady {
    using SafeERC20 for IERC20;
    ...
    function setDelay(uint256 _delay) external onlyManager { 
        delay = _delay;
...
contract MerfiVaultRegistry is Manageable, IMerfiVaultRegistry {
    using SafeERC20 for IERC20;
    using EnumerableSet for EnumerableSet.AddressSet;
    ...
    mapping(address => EnumerableSet.AddressSet) private _tokenToVaultsMap;
