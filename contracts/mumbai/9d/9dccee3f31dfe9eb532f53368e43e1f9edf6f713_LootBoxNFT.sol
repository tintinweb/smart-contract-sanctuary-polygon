...
import "./openzeppelin_for_proxied/ERC1155Supply.sol";
import "./openzeppelin_for_proxied/ERC1155URIStorage.sol";
import "@openzeppelin/contracts/access/AccessControl.sol";
import "@openzeppelin/contracts-upgradeable/proxy/utils/Initializable.sol";
import "forge-deploy-proxy/ForgeDeploy_Proxied.sol";

contract LootBoxNFT is ILootBoxNFT, Initializable, Proxied, ERC1155Supply, ERC1155URIStorage, AccessControl {
    ...
    function changeCollectionURI(uint256 collectionId, string memory newURI) external override onlyRole(MINTER_ROLE) {
        _setURI(collectionId, newURI);
        emit CollectionURIChanged(collectionId, newURI);
    }

    function mint(address to, uint256 collectionId, uint256 amount) external override onlyRole(MINTER_ROLE) {
        _mint(to, collectionId, amount, "");
    }

    function burn(address from, uint256 collectionId) external override onlyRole(BURNER_ROLE) {
        _burn(from, collectionId, 1);
    }
    ...
    function supportsInterface(
        ...
        return
            interfaceId == type(ILootBoxNFT).interfaceId ||
...
interface ILootBoxNFT is IERC1155 {
    ...
    function mint(address to, uint256 collectionId, uint256 amount) external;

    function burn(address from, uint256 collectionId) external;
}
