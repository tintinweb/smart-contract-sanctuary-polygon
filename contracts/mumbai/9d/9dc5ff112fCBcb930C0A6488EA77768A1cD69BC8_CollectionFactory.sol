...
contract CollectionFactory is Initializable, OwnableUpgradeable, PausableUpgradeable {
    ...
    function createCollection(
        ...
        //Proxy collection = new Proxy(implementationContract,data);
        ...
        bytes memory data =abi.encodeWithSelector(Niftyco721(address(0)).initialize.selector,
        name, symbol, contractUri, baseUri, royalty, msg.sender);
        BProxy collection = new BProxy(implementationContract,data);
...
contract BProxy is ERC1967Proxy {
    constructor(address beacon, bytes memory data) ERC1967Proxy(beacon,data){
