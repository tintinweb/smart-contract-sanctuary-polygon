...
contract FiftyFiftyV3 is Initializable, ERC721EnumerableUpgradeable, VRFConsumerBaseUpgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
...
*/
    ...
    function newAdminMintv3(uint8 _amount, address _mintTo) external adminOnly{
        // transfer WETH to contract
        uint256 ffsplit = cost * _amount * 1/2;
        weth.transferFrom(msg.sender, address(this), ffsplit);
        weth.transferFrom(msg.sender, ownerAddress, ffsplit);
