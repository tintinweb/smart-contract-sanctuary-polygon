...
contract Marketplace is ReentrancyGuard, RoleControl {
    ...
    */
    ...
    function addGallery(address _galleryWallet, uint256 _royalty) public onlyOperator returns (uint) {
    ...
    */
    function createMarketSale(
        ...
        uint galleryRoyalty = calculateRoialty(msg.value, gallery.royalty);
        uint marketRoyalty = calculateRoialty(msg.value, royalty);
    ...
    */
    ...
    function calculateRoialty(uint amount, uint percentage) private pure returns(uint){
