...
contract StarDustCDDT is ERC721A, Ownable {
    using Strings for uint256;

    //declares the maximum amount of tokens that can be minted
    uint256 private max_nft_supply = 15000;
    ...
    constructor(string memory _uri) ERC721A("Stardust | Central District | Down Town ", "StarCDDT") {
        baseTokenURI =_uri;
    }
