        ...
        */
        _metadataTableId = _tableland.createTable(
            ...
            SQLHelpers.toCreateFromSchema(
                "id int, customer text, points int, category text, perks int, pfp_image_url text, favorite_product int",
                _tablePrefix
            )
        );
    }
    ...
    function _insertSQLToken(uint256 tokenId, address buyer) private {
        _tableland.runSQL(
            ...
            SQLHelpers.toInsert(
                ...
                // column names
                "id, customer, points, category, perks, pfp_image_url, favorite_product",
                 // values
                string.concat(
