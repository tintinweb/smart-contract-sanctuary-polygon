...
contract BlacklistBurnSnapshotTxFeeTemplate is 
    ...
    function _beforeTokenTransfer_hook(
        ...
        address to,
        uint256 amount
    )  internal virtual override(SnapshotFeature, BlacklistFeature, TxFeeFeatureV3) {
...
abstract contract TxFeeFeatureV3 is ERC20Base, ITxFeeFeatureAlt {
    ...
    bytes32 public constant TX_FEE_WHITELISTED_MANAGER = keccak256("polkalokr.features.txFeeFeature._txFeeBeneficiaryRole");
