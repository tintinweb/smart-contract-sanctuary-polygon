...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x073b4d5f08aFa6d36A8eEB8590aB2BbC78cF9ed1];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 2, 500 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmNwVe5aU9D6ZXk767Hmch8LRb8UDRBLepWQL25pGpHrXp/";
...
// File: contracts/ArtgalleriesdaodocumentsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ArtgalleriesdaodocumentsContract is RamppERC721A {
    constructor() RamppERC721A("ART GALLERIES DAO DOCUMENTS", "ARTGAL"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/rSjnMGPh6KqxyfSa6gZa/contract-metadata";
    }
}
