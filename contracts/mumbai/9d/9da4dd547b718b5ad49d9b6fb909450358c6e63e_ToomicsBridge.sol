...
contract Validator is EIP712Upgradeable {
    ...
    // keccak256("RefundkToken(address _recipient,uint256 _amount,uint256 _nonce,uint256 _timeEnd)");
    bytes32 public constant REFUND_TOKEN_TYPEHASH =
        0xa8b37f71b7c6a8403b59ee3519fe6518b7bc9e0feed0d6389cd70e90b2e958bd;
    // keccak256("UnlockNft(address _recipient,uint256[] _arrTokenIdDest,uint256[] _arrTokenIdSource,bytes32 _interchainTX,uint256 _chainIdDest,uint256 _chainIdSource,uint256 timeEnd)");
    bytes32 public constant UNLOCK_NFT_TYPEHASH =
        0x3e685be0de391f64d2e4ffd27756736d058a33e99ec0d3658b9c245933b9c031;
    // keccak256("MintNft(address _recipient,uint256[] _tokenId,bytes32 _interchainTX,uint256 _chainIdDest,uint256 _chainIdSource,string[] _tokenURI,uint256 timeEnd)");
    bytes32 public constant MINT_NFT_TYPEHASH =
        0x26a588736b7d54b8b1a21fa9d5d43d2c36f9bbfa80f24e3c2b42674f21df7239;
    // keccak256("RefundNft(address _recipient,uint256[] memory _tokenId,uint256 _nonce,uint256 timeEnd)");
    bytes32 public constant REFUND_NFT_TYPEHASH =
        0x3102c54a0549f00e49f2b8ea550edfb4eb52d6cedd34ae6be8034214e3859ae1;
