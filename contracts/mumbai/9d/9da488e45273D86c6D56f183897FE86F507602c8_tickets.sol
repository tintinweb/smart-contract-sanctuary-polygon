...
contract tickets is AccessControl
{
    ...
    **/
    ...
    mapping(string => uint256)public hisByHash;
...
//	emit eLog(nn++,"balance_ramp",IToken(tokenAddress).balanceOf(msg.sender));
//	emit eLog(nn++,"amount", tokenAmount);
	...
	emit eLog(nn++,"hash",uint256(bytes32(b)));
