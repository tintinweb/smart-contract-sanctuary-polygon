...
contract EscrowTrade is Initializable, OwnableUpgradeable {
    ...
    function startTrade (address _seller) public payable {
        ...
        emit StartTrade(msg.sender, _seller, msg.value, "MATIC");
    }
    ...
    function handleDispute (address _buyer, address _seller, address winner, uint256 _tradeId) public onlyOwner() {
        ...
        require(keccak256(abi.encodePacked(trades[_tradeId].coin)) == keccak256(abi.encodePacked("MATIC")),  "invalid request");
