...
// File: contracts/ERC20_Token_Sale_Rabochiy.sol
...
contract TokenSale {
    ...
    constructor(IERC20 _saleToken, IERC20 _purchaseToken, uint256 _price) {
        owner = msg.sender;
    ...
    function buyTokens(uint256 _numTokens) public {
        uint256 cost = _numTokens * price / 100;
        ...
        require(_numTokens <= saleTokenBalance, "Not enough sale tokens available");

        purchaseToken.transferFrom(msg.sender, owner, cost);
        saleToken.transfer(msg.sender, _numTokens);
    }
