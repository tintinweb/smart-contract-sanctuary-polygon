    ...
    AccessControlUpgradeable
{
    ...
    */
    ...
    function transferToken(
        ...
        notBlacklisted(_tokenAddress, _to)
    {
        IToken(_tokenAddress)._transferToken(_msgSender(), _to, _amount);
     ...
     *  @param _freeze blackList status of the address
    ...
    function addBlackList(
        ...
        notBlacklisted(_tokenAddress, _userAddress)
    {
        _blacklisted[_tokenAddress][_userAddress] = _freeze;
        emit AddressBlackListed(_tokenAddress, _userAddress, _freeze);
    }
