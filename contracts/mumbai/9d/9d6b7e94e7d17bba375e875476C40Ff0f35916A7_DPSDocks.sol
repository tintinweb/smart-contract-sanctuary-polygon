...
contract DPSDocks is ERC721Holder, ReentrancyGuard, Ownable {
    ...
    function computeVoyageState(
        ...
        // console.log("base pirate skills");
        ...
        // console.log("getMaxSkillsCap ", gameSettings.getMaxSkillsCap());
        // console.log("maxRollCap ", maxRollCap);
        // console.log("user address  ", causalityParams.userAddress);
        ...
        //     claimingRewardsCache.strength
        // );
        voyageResult.interactionResults = new uint16[](_voyageConfig.sequence.length);
        for (uint256 i; i < _voyageConfig.sequence.length; i++) {
            ...
            //  console.log("index ", claimingRewardsCache.randomCheckIndex);
            // console.log("maxRollCap ", maxRollCap);
            // console.log("maxSkillsCap ", gameSettings.getMaxSkillsCap());
            // console.log("user ", _causalityParams.userAddress);
            ...
            if (_causalityParams.signature.length > 0) {
                ...
                // console.log("params ", _causalityParams.userAddress,
                //     _causalityParams.blockNumber[claimingRewardsCache.randomCheckIndex],
                //     _causalityParams.timestamp[claimingRewardsCache.randomCheckIndex]
                //     );
            ...
            //     claimingRewardsCache.strength
            // );
            // if (interaction == INTERACTION.STORM) {
            //     console.log("random for interaction STORM = ", result);
            // } else if (interaction == INTERACTION.CHEST) {
            //     console.log("random for interaction CHEST = ", result);
            // } else {
            //     console.log("random for interaction ENEMY = ", result);
            // }
            ...
            voyageResult.interactionResults[i] = uint16(result);
        }
        // console.log("Generated randoms ", claimingRewardsCache.randomCheckIndex - (voyageConfig.noOfInteractions + 1));
        return voyageResult;
    }
