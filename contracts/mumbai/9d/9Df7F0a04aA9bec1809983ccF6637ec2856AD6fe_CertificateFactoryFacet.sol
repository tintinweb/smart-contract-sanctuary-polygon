...
import {CertificateAddress} from "../libraries/LibAppStorage.sol";
...
contract CertificateFactoryFacet {
    CertificateAddress internal cc;
    // ===============================================
    // ERROR
    // ===============================================
    ...
    function depolyCertificate(string memory name, string memory symbol) external {
        ...
        cc.certficates.push(address(new_certificate));
