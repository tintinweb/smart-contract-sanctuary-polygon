...
contract SimpleMarket is EventfulMarket, DSMath {
    ...
    function getOffer(uint id) public view returns (uint, ERC20, uint, ERC20) {
      ...
      return (offers[id].pay_amt, offers[id].pay_gem,
              offers[id].buy_amt, offers[id].buy_gem);
    }
    ...
    {
        //getOffer(id);
        uint spend = mul(quantity, offers[id].buy_amt) / offers[id].pay_amt;
        ...
        if (quantity == 0 || spend == 0 ||
            quantity > offers[id].pay_amt || spend > offers[id].buy_amt)
        {
            return false;
        }

        offers[id].pay_amt = sub(offers[id].pay_amt, quantity);
        offers[id].buy_amt = sub(offers[id].buy_amt, spend);
        safeTransferFrom(offers[id].buy_gem, msg.sender, offers[id].owner, spend);
        safeTransfer(offers[id].pay_gem, msg.sender, quantity);
        ...
        emit LogTrade(quantity, address(offers[id].pay_gem), spend, address(offers[id].buy_gem));
        ...
        returns (bool success)
    {
        ...
        safeTransfer(offers[id].pay_gem, offers[id].owner, offers[id].pay_amt);
        ...
        returns (uint id)
    {
        ...
        require(pay_amt > 0);
        require(pay_gem != ERC20(address(0x0)));
        require(buy_amt > 0);
        require(buy_gem != ERC20(address(0x0)));
