...
contract Voltage is ERC721URIStorage {
    ...
    event SalePriceSet(uint256 tokenId, uint256 salePrice);
    event VoltCreated(uint256 tokenId);

    constructor() ERC721("Voltage", "VOLT") {}
    ...
    function createVolt(
        ...
        newTokenId = _createVolt(creator, receiver, tokenMetaUri, salePrice);
    }
