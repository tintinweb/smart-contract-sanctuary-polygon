...
contract FandomToken is ERC1155URIStorage {
    ...
    //mapping user address to user token count
    ...
    function safeTransferFrom(
        ...
        // Add custom logic or additional checks here before calling the parent function
        ...
        // Add additional logic to handle events or other actions after the transfer
 ...
 */
contract Market is ReentrancyGuard, Ownable, ERC1155Receiver {
    using Counters for Counters.Counter;
    ...
    mapping(address=>MarketItem[]) public userNFTs;
     ...
     * @param itemId itemId 
     */
     function removeNFT(address userAddr, uint256 itemId) private {
    MarketItem[] storage userNFT = userNFTs[userAddr];
    uint256 userNFTLen = userNFT.length;

    MarketItem memory lastNFT = userNFT[userNFTLen - 1];
    MarketItem memory currNFT;
     ...
     */
    function buy(uint256 itemId) external payable nonReentrant {
