...
contract MetawhaleNFT is IERC721Receiver, ERC721, ReentrancyGuard, Ownable {
    ...
    event Minted(uint256 _NftId, address minter, string msg);
    ...
    function buyItem(
        ...
        emit ItemBought(
            ...
            msg.sender,
            msg.value,
            idToMarketItem[itemId].currency,
            true,
            false
        );
