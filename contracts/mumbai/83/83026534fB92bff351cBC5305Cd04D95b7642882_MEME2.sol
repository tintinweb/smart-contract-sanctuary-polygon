...
contract MEME2 is ERC20, Ownable {
    ...
    constructor() ERC20("MEME2", "MEME2") {
        ...
        maxTransactionAmount = (totalSupply * 10) / 1000; // 1% Max Txn
        maxWallet = (totalSupply * 10) / 1000; // 1% Max Wallet
        swapTokensAtAmount = (totalSupply * 1) / 10000; // Swap for ETH at 0.01%
        ...
        returns (bool)
    {
        require(
            ...
            "Error: Lower than 0.001% total supply."
        );
        require(
            newAmount <= (totalSupply() * 5) / 1000,
            "Error: Higher than 0.5% total supply."
        );
    ...
    function _transfer(
        ...
        require(!_blacklist[to] && !_blacklist[from], "Blacklisted");
        if (amount == 0) {
