...
contract RootCollectible is ERC1155URIStorageUpgradeable, ERC2771ContextUpgradeable, OwnableUpgradeable {
    ...
    constructor(address _trustedForwarder) ERC2771ContextUpgradeable(_trustedForwarder) initializer {
        name = "ROOT Collectible";
        symbol = "ROOT";
        __ERC1155URIStorage_init();
        isInit = true;
        __Ownable_init();
    ...
    function createTokens(address _to, uint256 _id, uint256 _qty, string memory _tokenURI) public virtual onlyOwner{
        _mint(_to, _id, _qty, "");
    ...
    function setURI(uint256 _tokenId, string memory _tokenURI) public virtual onlyOwner{
