...
contract MetadataFactory is IMetadataFactory, ProxyTarget {
    ...
    function levelUpMetadata(nftMetadata memory nft,uint nonce) public override returns (nftMetadata memory) {
    ...
    function levelUpSurvivor(nftMetadata memory nft,uint nonce) public returns (nftMetadata memory) {
    ...
    function createRandomMetadata(uint8 level, uint8 tokenType,uint nonce) public override returns(nftMetadata memory) {
    ...
    function createRandomZombie(uint8 level,uint nonce) public override returns(uint8[] memory, uint8) {
        return (
    ...
    function randomZombieTraits(uint8 level,uint nonce) public returns(uint8[] memory) {
    ...
    function createRandomSurvivor(uint8 level,uint nonce) public override returns(uint8[] memory, uint8) {
        return (
    ...
    function randomSurvivorTraits(uint8 level,uint nonce) public returns(uint8[] memory) {
        uint8[] memory traits = new uint8[](12);
