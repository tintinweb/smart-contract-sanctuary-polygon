...
contract ChainBattles is ERC721URIStorage {
    ...
    function train(uint256 tokenId) public {
        ...
        stats.strength = stats.strength + randomNum(4);
        stats.speed = stats.speed + randomNum(4);
        stats.life = stats.life + randomNum(4);
        _setTokenURI(tokenId, getTokenURI(tokenId));
    }

    function randomNum(uint256 limit) public view returns (uint256) {
        return uint256(blockhash(block.number - 1)) % limit;
    }
}
