...
contract GC is ERC20, Ownable {
    ...
    constructor(address _treasury, uint256 _p2pFee, uint256 _totalSupply) ERC20("GC TOken", "GC") {
    ...
    function mint(address recipient_) internal onlyOwner {
    ...
    function setFees(uint256 _p2pFee) public onlyOwner {
        require(
            _p2pFee <= 25,
            "All Fees must be below than 25"
        );
        p2pFee = _p2pFee;
    }
