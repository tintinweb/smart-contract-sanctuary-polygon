...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 4, 30 ) {}
...
contract MyNftRamppProjectContract is RamppERC721A {
    constructor() RamppERC721A("My NFT Rampp Project ", "RAMPCT"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/UzPybrPTCUA2CoiV4So6/contract-metadata";
    }
}
