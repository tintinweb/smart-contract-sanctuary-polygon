...
contract ERC721OnChainMetadata is ERC721, OnChainMetadata {
    ...
    function setTeamTraits() private {
        ...
        trait_display[0] = abi.encode("collector");
        trait_display[1] = abi.encode("host");
        trait_display[2] = abi.encode("ceo");
        trait_display[3] = abi.encode("cto");
        trait_display[4] = abi.encode("artist success manager");
        trait_display[5] = abi.encode("community manager");
        trait_display[6] = abi.encode("director of growth");
        trait_display[7] = abi.encode("product manager");
        trait_display[8] = abi.encode("product designer");
        trait_display[9] = abi.encode("software engineer");
        trait_display[10] = abi.encode("software engineer");
        trait_display[11] = abi.encode("sofware engineer");
        trait_display[12] = abi.encode("software engineer");
