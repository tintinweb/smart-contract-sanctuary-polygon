...
library NameServiceLogic {
    ...
    returns (string memory)
    {
        ...
        Base64.encode(
            abi.encodePacked(
                '<svg  class="icon" viewBox="0 0 512 512" version="1.1" xmlns="http://www.w3.org/2000/svg" width="512" height="512" fill="white" > <rect xmlns="http://www.w3.org/2000/svg" id="default-picture-background" x="0" width="512" height="512" fill="white"/> <text x="40" y="450" fill="#FF4F99" font-size="28" >',
                name,
                '</text></svg>'
            )
        );
...
import "./ContentWithSign.sol";
import "./DaoWithSign.sol";
import "./FollowWithSign.sol";
import "./PrivacyContentWithSign.sol";

contract RelationPayable is ContentWithSign,DaoWithSign,FollowWithSign,PrivacyContentWithSign {
