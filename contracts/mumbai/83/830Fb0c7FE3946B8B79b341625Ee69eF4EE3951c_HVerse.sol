...
Building[] public buildings;
  ...
  constructor() ERC721("HVerse", "HVS") {
    setHiddenMetadataUri("https://gateway.pinata.cloud/ipfs/Qmafb6H7U9FreNipw3yruSNtNw1TiKKf3cv1TgVqxrkxDT");
    ...
    buildings.push(Building('Ray House',1,3,3,-4,0,2));
    ...
    buildings.push(Building('Shop',2,5,2,-2,0,5));
    buildings.push(Building('House',2,6,4,-2,0,-3));
