...
contract MyToken is ERC20, FxBaseChildTunnel, Ownable {
    ...
    //Daily reward
     uint256 public dailyToken = 5*10**18;

     //Testing only
    bytes public testing1;
    address public testing2;
    bool public testing3;
    address public testing4;
    uint256 public testing5;
    ...
    function _processMessageFromRoot(uint256 stateId, address sender, bytes memory data) internal override validateSender(sender){ 
        ...
        //Check data got pass through here.
        testing1 = data;
        testing2 = from;
        testing3 = action;
        testing4 = sender;
    ...
    function earned(address _address) public view returns(uint256){
        //86400seconds -> 24hrs
        return ((dailyToken/86400) * (block.timestamp - lastUpdated[_address]));
    }
    ...
    function drawDailyTokens() public onlyOwner {
        _mint(msg.sender, dailyToken);
    }
