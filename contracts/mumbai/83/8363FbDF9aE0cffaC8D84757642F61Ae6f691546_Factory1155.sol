...
import "./DreamsterInternationalUser1155Token.sol";
...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new DreamsterInternationalUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        DreamsterInternationalUser1155Token token = DreamsterInternationalUser1155Token(address(addr));
...
contract DreamsterInternationalUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
