...
contract ContractName is ERC721, Ownable {
    ...
    address public constant BENEFICIARY_ADDRESS = 0x087d19CA4dE548B68d213B6c008f503aA6864080;
    
    constructor() ERC721("NFTName", "NM") {}
    ...
    */
    function mintNFT(uint256 numberOfTokens) public payable {
        ...
        // limit per wallet
        require(totalIssued.add(numberOfTokens) <= maxTokens, "Minting would exceed max. supply");
    ...
    function setContractSettings(bool _saleStart) public onlyOwner {
