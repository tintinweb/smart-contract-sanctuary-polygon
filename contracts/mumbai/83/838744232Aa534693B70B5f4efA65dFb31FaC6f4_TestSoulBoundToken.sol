...
contract ERC5192 is ERC721, IERC721Core, IERC5192, CoreRoles {
    using Strings for uint256;
...
interface IERC721Core {
    ...
    function supplies() external view returns (uint256, uint256, uint256);
}
...
import { ERC5192 } from "../core/ERC5192.sol";

// NOTE: Testnet での動作確認を目的とするコントラクト
contract TestSoulBoundToken is ERC5192 {
    constructor() ERC5192("+TestSoulBoundToken", "TSBT", 100, "", "") {}
}