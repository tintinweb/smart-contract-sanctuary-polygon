...
contract PoFInternalValidator is Ownable {
    ...
    */
    ...
    function evaluateFeedback(address feedbackID, uint256 evaluation)
        public
        onlyJuror
    {
        require(
        ...
        feedbacks[feedbackID].evaluations[_msgSender()] = evaluation;
    ...
    */
    function finalEvaluation(address feedbackID) private {
        uint256 evaluation = (feedbacks[feedbackID].evaluations[
            feedbacks[feedbackID].juror1
        ] +
        ...
        )
    {
        ...
        if (i2 == i1) ++i2 % totalJurors;
        uint256 i3 = ((index / totalJurors) / totalJurors) % totalJurors;
        if (i3 == i1) {
            ++i3 % totalJurors;
            if (i3 == i2) ++i3 % totalJurors;
        }
