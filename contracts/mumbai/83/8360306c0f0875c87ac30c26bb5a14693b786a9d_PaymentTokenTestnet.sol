...
contract PaymentTokenTestnet is AccessControlledAndUpgradeable, ERC20PresetMinterPauserUpgradeable {
  ...
  UUPSUpgradeable
{
  ...
  /// @notice Serves purely as a convenience function for reading the implementation which is useful for development and debugging.
  ///         Can be removed if contract size ever becomes an issue.
