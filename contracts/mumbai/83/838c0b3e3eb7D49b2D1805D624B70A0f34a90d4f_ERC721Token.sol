    ...
    ERC2981Upgradeable
{
    ...
    mapping(uint256 => string[]) public tokenIdAttributes;
    mapping(uint256 => mapping(string => string)) public tokenIdAttributeValues;
     ...
     * - `tokenId` must exist.
     */
    function updateTokenUri(uint256 tokenId, string memory _tokenURI, string[] memory attributes, string[] memory attributeValues)
        external
        whenNotPaused
    {
        require(NFTCollection(factory).isAccountWhitelisted(msg.sender) , "Account is not whitelisted.");
        require(
    ...
    function setPlatformFee(uint256 _newPlatformFee)
        ...
        whenNotPaused
    {
        require(_newPlatformFee >= 0, "Invalid fee value");
     ...
     * @param uri - token uri
     */
    function safeMint(address to, string memory uri, string[] memory attributes, string[] memory attributeValues)
        external
        onlyOwner
        whenNotPaused
        nonReentrant
    ...
    ReentrancyGuardUpgradeable
{
    ...
    */
    ...
    function updateAdminRoyaltyPercentage(uint256 newPercentage)
        ...
        onlyOwner
    {
        require(newPercentage >= 0, "Factory: Invalid value");
