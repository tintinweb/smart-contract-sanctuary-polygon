...
contract TheHordeContract is Ownable, ERC721A {
    ...
    constructor(/*uint256 _startTime, bool _paused*/) ERC721A("TheHordeContract", "HORDE") {
        START_TIME = block.timestamp;//_startTime;
        mintPaused = false;//_paused;
    }
