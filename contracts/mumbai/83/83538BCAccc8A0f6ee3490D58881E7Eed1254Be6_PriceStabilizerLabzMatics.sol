...
int256 constant ONEMATIC = 10000000000000000000;
...
contract PriceStabilizerLabzMatics is PriceStabilizer {
    ...
    function MaticToLabz(int256 _targetMatics) public view returns(int256) {
        int256 priceUSDMatic = _currentPrice;
        int256 priceMaticLabz = int256(priceUSDMatic / (_targetMatics * ONEMATIC));
        return priceMaticLabz;
    }

    function PriceInLabzForOneMatic(int256 _labzValueUSD) public view returns(int256) {
       return getDerivedPrice(8, _labzValueUSD);
    }
