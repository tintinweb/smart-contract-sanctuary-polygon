...
contract EhsanNFTnize is ERC721, ERC721URIStorage, ERC721Burnable, RoyaltiesV2Impl, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdCounter;
    bytes4 private constant _INTERFACE_ID_ERC2981 = 0x2a55205a;

    constructor() ERC721("Visions of Unity and Peace", "VUP") {}
    ...
    function mintNFT(address recipient, string memory uri, address payable _royaltiesReceipientAddress, uint96 _percentageBasisPoints)
        public onlyOwner
        returns (uint256)
    {
        _tokenIdCounter.increment();
        ...
        _mint(recipient, newItemId);
        _setTokenURI(newItemId, uri);
        setRoyalties(newItemId, _royaltiesReceipientAddress, _percentageBasisPoints);
        return newItemId;
    }
