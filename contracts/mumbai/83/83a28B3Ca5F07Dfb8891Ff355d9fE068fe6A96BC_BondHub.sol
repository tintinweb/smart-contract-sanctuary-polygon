...
library InteractionLogic {
    ...
    function _followSingle(
        ...
        emit Events.OutputLogString('followNFT:',followNFT,0,false);
        emit Events.OutputLogString('followModule:',followModule,0,false);
...
contract FollowNFTProxy is Proxy {
    ...
    constructor(bytes memory data) {
        ...
        HUB = msg.sender;
        address impl = IBondHub(msg.sender).getFollowNFTImpl();
        emit Events.OutputLogString('getFollowNFTImpl ',impl,0,false);
        impl.functionDelegateCall(data);
    }
