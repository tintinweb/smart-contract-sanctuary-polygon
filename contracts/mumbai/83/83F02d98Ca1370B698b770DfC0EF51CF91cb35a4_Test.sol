...
contract Test is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
    uint256 public MAX_SUPPLY = 3;

    
    uint256 public PUBLIC_SUPPLY = 2;
    ...
    uint256 public PUBLIC_PRICE = 0.0001 ether;

    
    uint256 public PUBLIC_COUNT = 0;

    
    bytes32 public PUBLIC_ROOT;
    ...
    string private preRevealURI = "https://ipfs.w3bmint.xyz/ipfs/QmZdduh36uMTCzqqXTUk8LNNZTBMqboFqCR4eG9nzhhBdv";
    ...
    constructor(
        bytes32 _Public) ERC721A("Test", "NUKI") {
        
        PUBLIC_ROOT = _Public;
        
        _safeMint(0x1BAD87f6954caB91ecC44fE78b0E19DB0F5B2AB0, 1);
    }
    ...
    function PUBLICMint(address to, uint256 numberOfTokens, bytes32[] memory proof) external isSecured(PUBLIC_PRICE * numberOfTokens) payable {
        validateMint(IS_PUBLIC_ACTIVE, PUBLIC_COUNT, PUBLIC_SUPPLY, PUBLIC_Minted[msg.sender], PUBLIC_WALLET_LIMIT, PUBLIC_TX_LIMIT, numberOfTokens, MerkleProof.verify(proof, PUBLIC_ROOT, keccak256(abi.encodePacked(msg.sender))));
    ...
    function withdraw() external onlyOwner {
        ...
        (bool successFinal, ) = payable(0x1BAD87f6954caB91ecC44fE78b0E19DB0F5B2AB0).call{ value: address(this).balance }("");
