...
contract NFTSC is ERC721, ERC721URIStorage, ERC721Burnable, AccessControl, Pausable {
    using Counters for Counters.Counter;
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    Counters.Counter private _tokenIdCounter;

    address minter = 0x14140d91aE8aC60E2672B23599f6a523a8e6401b;
    ...
    function safeMintBatch(address to, string[] calldata _tokenURI) public onlyRole(MINTER_ROLE) whenNotPaused{
