...
contract MockCurveWrapper {
    ...
    IERC20 public immutable USDC =
        IERC20(0xA0fB0349526B7213b6be0F1D9A62f952A9179D96);
    IERC20 public immutable USDR =
        IERC20(0x74B2A1Af182Ff14fB5251cf980aFA911AD4c4120);
    IERC20 public immutable DAI =
        IERC20(0xe08e7009C2c4ae13C45852876f45913c47eF07Cc);
        ...
        returns (uint256[] memory amountsIn)
    {
        ...
        uint256 amountInMax = convertToDecimal(IERC20Metadata(path[0]),amountOut, IERC20Metadata(path[1]).decimals() );
    ...
    {
        require(path.length == 2, "invalid path length");
        uint256 amountOutMin = convertToDecimal(IERC20Metadata(path[1]),amountIn, IERC20Metadata(path[0]).decimals() );
