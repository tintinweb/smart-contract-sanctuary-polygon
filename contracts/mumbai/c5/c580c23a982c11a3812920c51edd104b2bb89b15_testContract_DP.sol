...
/**
 * @title testContract_DP contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract testContract_DP is ERC721, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC721("The Doge Pound", "DOGGY") {
        //  Tracker name, short version
        MAX_SUPPLY=10;
        REVEAL_TIMESTAMP = block.timestamp + (86400 * 7);
        MINT_PRICE=50000000000000000; // 0.069 ETH
        MAX_TO_MINT=5;
        saleIsActive = false;
    ...
    function setMaxToMint(uint256 _maxValue) external onlyOwner {
        MAX_TO_MINT = _maxValue;
    }

    /**
     * Reserve Mint for the owner
     */
    function reserveMint(address _to, uint256 _numberOfTokens)
        external
        onlyOwner
    {
