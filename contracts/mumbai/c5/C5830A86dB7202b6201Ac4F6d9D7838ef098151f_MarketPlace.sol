    ...
    ERC721Holder
{
    ...
    // to check auction created by eveny on
        ...
        nonReentrant
    {
        ...
        if (checkRoyalties(saleOrder[orderId].tokenContract)) {
            (address reciver, uint256 royaltyAmount) = IERC2981(
                saleOrder[orderId].tokenContract
            ).royaltyInfo(saleOrder[orderId].tokenId, tokenOwnerProfit);
        ...
        nonReentrant
    {
        ...
        if (
            ...
            auction.duration =
                oldDuration +
                (timeBuffer -
                    ((auction.firstBidTime + (oldDuration)) -
                        (block.timestamp)));
            extended = true;
        }
        ...
        nonReentrant
    {
        ...
        if (auctions[auctionId].tokenOwner != _msgSender()) {
            require(
                block.timestamp >=
    ...
    */
    ...
    {
        require(
            isAuctionRestricted != isAuctionRestricted,
