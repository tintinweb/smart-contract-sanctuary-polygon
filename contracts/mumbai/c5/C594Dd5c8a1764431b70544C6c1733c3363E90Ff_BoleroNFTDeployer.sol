...
contract BoleroNFT is ERC721Enumerable, LockRegistry, NFTController  {
    ...
    event ThresholdUpdated(uint256 collectionID, uint256 threshold);
     ...
     *******************************************************************************/
    function setThresholdPrivate(uint256 _collectionId, uint256 _threshold)
        public 
        onlyBolero
    {
         collections[_collectionId].privateSaleThreshold = _threshold;
         emit ThresholdUpdated(_collectionId, _threshold);
    }
...
contract BoleroNFTDeployer is WithManagement {
    ...
    constructor(address _management, address _rewards) {
        ...
        nft = address(new BoleroNFT("Bolero Song Shares", "BSS", swap, msg.sender));
    }
