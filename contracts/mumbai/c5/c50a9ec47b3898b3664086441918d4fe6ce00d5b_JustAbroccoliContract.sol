...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x6e16d42F951c3500b7f21209eB04bE3F205762f3];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmfXe9U4uCnCDyBttW8bJBzdxkdt1QozERqsQmz85XmZDp/";
...
// File: contracts/JustAbroccoliContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract JustAbroccoliContract is RamppERC721A {
    constructor() RamppERC721A("justAbroccoli", "BROCCOLI"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/mViPuos7Rhyc19Fqguls/contract-metadata";
    }
}
