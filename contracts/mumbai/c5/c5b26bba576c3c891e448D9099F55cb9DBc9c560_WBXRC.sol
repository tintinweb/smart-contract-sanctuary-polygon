...
contract WBXRC is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    string private _baseURIextended = "https://gateway.pinata.cloud/ipfs/QmPV4KxCmiBMnRaQMWboPvixuMD5j56jnpDVDGUiy8Su9v";
    ...
    constructor() ERC721("Wild Bears X Club", "$WBXRC") {
    }

    function crossmint(address _to) public payable {
    require(_priceextended == msg.value, "Incorrect ETH value sent");
    require(_tokenIdentifiers.current() + 1 <= MAX_NFT_SUPPLY, "No more left");
    ...
    uint256 newTokenId = _tokenIdentifiers.current();
