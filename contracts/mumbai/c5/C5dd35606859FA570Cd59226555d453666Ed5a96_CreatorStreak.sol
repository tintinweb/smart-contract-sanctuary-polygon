...
import "../streak/ERC721Streak.sol";
import "../streak/ERC1155Streak.sol";
import "../streak/ExchangeStreak.sol";
import "../streak/AuctionFactoryStreak.sol";
import "../streak/DropMinting.sol";
import "./ICreators.sol";

contract CreatorStreak is Ownable {
    ...
    event ContractsCreated(
        ...
        address indexed dropMintingAddress
    );

    IERC721StreakCreator private erc721Creator;
    IERC1155StreakCreator private erc1155Creator;
    IExchangeStreakCreator private exchangeCreator;
    IAuctionFactoryStreakCreator private auctionFactoryCreator;
    ...
    constructor(
        ...
        erc721Creator = IERC721StreakCreator(erc721CreatorAddress);
        erc1155Creator = IERC1155StreakCreator(erc1155CreatorAddress);
        exchangeCreator = IExchangeStreakCreator(exchangeCreatorAddress);
        auctionFactoryCreator = IAuctionFactoryStreakCreator(auctionFactoryCreatorAddress);
    ...
    function createContracts(
        ...
        uint256 dropEnd,
        uint256 dropPrice,
        uint16 dropMintLimitTotal
    ) external onlyOwner {
        address erc721ContractAddress = erc721Creator.createContract(erc721Name, erc721Symbol, erc721BaseURI);
        address erc1155ContractAddress = erc1155Creator.createContract(erc721Name, erc721BaseURI);
        address exchangeContractAddress = exchangeCreator.createContract(
            msg.sender,
            erc20Address,
            erc721ContractAddress,
            erc1155ContractAddress
        );
        address auctionFactoryContractAddress = auctionFactoryCreator.createContract(
            msg.sender,
            erc20Address,
            erc721ContractAddress,
            erc1155ContractAddress
        );
        address dropMintingContractAddress = dropMintingCreator.createContract(
            erc20Address,
            erc721ContractAddress,
            dropStart,
            dropEnd,
        ...
        ERC721Streak erc721Contract = ERC721Streak(erc721ContractAddress);
        ERC1155Streak erc1155Contract = ERC1155Streak(erc1155ContractAddress);
        ExchangeStreak exchangeContract = ExchangeStreak(exchangeContractAddress);
        AuctionFactoryStreak auctionFactoryContract = AuctionFactoryStreak(auctionFactoryContractAddress);
        DropMinting dropMintingContract = DropMinting(dropMintingContractAddress);
        ...
        erc1155Contract.grantRole(erc1155Contract.DEFAULT_ADMIN_ROLE(), address(this));
...
contract ERC721StreakCreator is Ownable, IERC721StreakCreator {
    function createContract(
        string memory name,
        string memory symbol,
        string memory baseURI
    ) external override onlyOwner returns(address contractAddress) {
        ERC721Streak erc721Contract = new ERC721Streak(name, symbol, baseURI);
        erc721Contract.grantRole(erc721Contract.DEFAULT_ADMIN_ROLE(), msg.sender);
        contractAddress = address(erc721Contract);
    }
}

contract ERC1155StreakCreator is Ownable, IERC1155StreakCreator {
    function createContract(
        string memory name,
        string memory baseURI
    ) external override onlyOwner returns(address contractAddress) {
        ERC1155Streak erc1155Contract = new ERC1155Streak(name, baseURI);
        erc1155Contract.grantRole(erc1155Contract.DEFAULT_ADMIN_ROLE(), msg.sender);
        contractAddress = address(erc1155Contract);
    }
}

contract ExchangeStreakCreator is Ownable, IExchangeStreakCreator {
    function createContract(
        address owner,
        address erc20Address,
        ...
        ExchangeStreak exchangeContract = new ExchangeStreak(
            owner,
            erc721Address,
            erc1155Address,
            erc20Address
...
contract AuctionFactoryStreakCreator is Ownable, IAuctionFactoryStreakCreator {
    function createContract(
        address owner,
        address erc20Address,
        address erc721Address,
        ...
        AuctionFactoryStreak auctionFactoryContract = new AuctionFactoryStreak(
            erc20Address,
            erc721Address,
            erc1155Address,
            owner
...
contract ExchangeStreak is Ownable {
	struct ERC1155Offer {
		uint tokenId;
		uint quantity;
		uint price;
...
contract DropMinting is ReentrancyGuard, Ownable {
    ...
    modifier onlyMintAdmin() {
      require(mintAdmin == _msgSender(), "DropMinting: caller is not the mintAdmin");
      _;
    }
    ...
    */
    ...
    function dropMint(uint256 mintQuantity) external nonReentrant returns(uint256[] memory) {
        ...
        for (uint256 i = 0; i < mintQuantity; i++) {
            uint256 tokenId = token.mintItem(msg.sender);
     ...
     */
    function withdrawToken() external onlyMintAdmin {
...
interface IERC721StreakCreator {
    function createContract(
        string memory name,
        string memory symbol,
        string memory baseURI
...
interface IERC1155StreakCreator {
    function createContract(
        string memory name,
        string memory baseURI
    ) external returns(address contractAddress);
...
interface IExchangeStreakCreator {
    function createContract(
        address owner,
        address erc20Address,
        address erc721Address,
...
interface IAuctionFactoryStreakCreator {
    function createContract(
        address owner,
        address erc20Address,
        address erc721Address,
