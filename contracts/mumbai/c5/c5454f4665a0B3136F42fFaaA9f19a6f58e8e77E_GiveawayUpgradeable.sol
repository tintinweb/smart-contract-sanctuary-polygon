    ...
    UniqueCheckingUpgradeable
{
    ...
    function initialize(
        ...
        __Treasury_init_unchained(tokens_, treasuries_);
    }

    function withdraw(Proof calldata proof_, WithdrawInput calldata withdrawInput_) external override nonReentrant {
...
abstract contract TreasuryUpgradeable is BaseUpgradeable {
    ...
    function __Treasury_init(address[] calldata tokens_, address[] calldata vaults_) internal onlyInitializing {
        __Treasury_init_unchained(tokens_, vaults_);
    }
    ...
    function _setVaults(address[] calldata tokens_, address[] calldata vaults_) private {
