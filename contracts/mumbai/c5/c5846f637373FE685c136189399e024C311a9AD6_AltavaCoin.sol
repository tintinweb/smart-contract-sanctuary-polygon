...
contract AltavaCoin is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, OwnableUpgradeable, ERC20PermitUpgradeable, UUPSUpgradeable {
    // 10억개
    ...
    function initialize() initializer public {
        __ERC20_init("AltavaCoin", "TAVA");
        __ERC20Burnable_init();
        __Pausable_init();
        __Ownable_init();
        __ERC20Permit_init("AltavaCoin");
