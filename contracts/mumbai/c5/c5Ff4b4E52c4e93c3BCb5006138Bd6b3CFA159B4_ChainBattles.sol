...
contract ChainBattles is ERC721URIStorage{
      ...
      constructor() ERC721("Mythical Battles","MYTHB"){
       ...
       function generateCharacter(uint256 tokenId) public view returns(string memory){
        ...
        bytes memory svg = abi.encodePacked(
            ...
            '<text x="13%" y="20%" class="base" dominant-baseline="middle" text-anchor="start">',"Mythical Creature",'</text>',
            '<text x="13%" y="40%" class="base" dominant-baseline="middle" text-anchor="start">', "Level: ",getLevels(tokenId).level.toString(),'</text>',
            '<text x="13%" y="50%" class="base" dominant-baseline="middle" text-anchor="start">', "Speed: ",getLevels(tokenId).speed.toString(),'</text>',
            '<text x="13%" y="60%" class="base" dominant-baseline="middle" text-anchor="start">', "Strength: ",getLevels(tokenId).strength.toString(),'</text>',
            '<text x="13%" y="70%" class="base" dominant-baseline="middle" text-anchor="start">', "life: ",getLevels(tokenId).life.toString(),'</text>',
            '</svg>'
        );
        ...
        bytes memory dataURI = abi.encodePacked(
            '{',
                '"name": "Mythic Battles #', tokenId.toString(), '",',
                '"description": "There was once a...",',
    ...
    function train(uint256 tokenId) public {
        ...
        require(ownerOf(tokenId) == msg.sender, "You must own this Mythical Creature to train it!");
