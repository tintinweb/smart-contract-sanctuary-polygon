 ...
 * @notice This contract handles minting Oska test collection stake tokens.
 */
contract OskaTestCollectionStake is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    string public baseTokenURI =
        "ipfs://bafybeiecwwlkk64zs2xtpgsrg7ol2htxiilfro5ulc4qv5ugwtv56gojpq/";
    ...
    uint256 public publicPrice = 30 ether;
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC721A("Oska test collection stake", "OTCS")
        RevokableOperatorFilterer(
