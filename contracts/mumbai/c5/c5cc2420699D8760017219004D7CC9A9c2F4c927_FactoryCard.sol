...
contract FactoryCard {
  address public adminAddress;
  CardToken[] public tokens; //an array that contains different ERC1155 tokens deployed
  ...
  */
  function deployERC1155(string memory _contractName, string memory _uri,  string[] memory _names, uint[] memory _ids) 
  external onlyAdmin
  returns (address)
  {
    CardToken t = new CardToken(_contractName, _uri, _names, _ids);
    tokens.push(t);
