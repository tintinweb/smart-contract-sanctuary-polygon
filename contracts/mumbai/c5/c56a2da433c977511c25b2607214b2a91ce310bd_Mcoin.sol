...
//Pussycoin Token 1.5B supply fixed supply 0.05 price per token 0.5
...
contract Mcoin is Context,IERC20, Ownable{
    ...
    string private _name = "Pussy-coin";
    string private _symbol = "Pussy-coin";
    ...
    */
    function sendtoYearLockAddresses(address newAddress,uint256 tokenAmount,uint256 unlockDate) public onlyOwner{
        require(_balances[_msgSender()] > tokenAmount,"Not enough Pussytoken to send to this address");
