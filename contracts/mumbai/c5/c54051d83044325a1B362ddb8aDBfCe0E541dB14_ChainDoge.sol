...
contract ChainDoge is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("ChainDoge", "CNDG") {
    setHiddenMetadataUri("ipfs://QmZezdaBCCvYEBAyf2kEFg3NiSwkYjJKyuBKfKJV4qst5e/hidden.json");
  }
