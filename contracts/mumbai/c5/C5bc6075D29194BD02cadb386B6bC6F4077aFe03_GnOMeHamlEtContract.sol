...
// $$ |  $$ |$$ |  $$ |$$ |  $$ |$$ |\$  /$$ |$$   ____|      $$ |  $$ |$$  __$$ |$$ | $$ | $$ |$$ |$$ |      $$ |$$\ 
// \$$$$$$  |$$ |  $$ | $$$$$$  |$$ | \_/ $$ |\$$$$$$$\       $$ |  $$ |\$$$$$$$ |$$ | $$ | $$ |$$ |$$$$$$$$\ \$$$$  |
//  \______/ \__|  \__| \______/ \__|     \__| \_______|      \__|  \__| \_______|\__| \__| \__|\__|\________| \____/ 
//                                                                                                                    
//                                                                                                                    
//                                                                                                                    
//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xFd5701Fdf97398fea466eC93C66FED9bbc0D0bda];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xFd5701Fdf97398fea466eC93C66FED9bbc0D0bda;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 9999) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeifhlussdk6leda6i4bbpoc2bqtxclraivds3wdnnsnjgnbveedfwu/";
...
// File: contracts/GnOMeHamlEtContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GnOMeHamlEtContract is RamppERC721A {
    constructor() RamppERC721A("GnOMe HamlEt", "GnOMe"){}
}
