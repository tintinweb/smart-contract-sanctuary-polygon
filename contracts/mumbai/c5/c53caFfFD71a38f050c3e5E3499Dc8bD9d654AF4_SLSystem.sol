...
abstract contract Arise is ISLSystem, SystemBase {
    ...
    function upgradeEssenceStone(
        ...
        hunterUpgradeCount[hunter][_stoneRank] += _requestAmount;
        upgradeCount[_stoneRank] += _requestAmount;
    ...
    function ariseEssenceStone(
        ...
        hunterAriseCount[hunter][_stoneRank] += _requestAmount;
        ariseCount[_stoneRank] += _requestAmount;
    ...
    function smeltingBrokenStone(
        ...
        hunterSmeltingCount[hunter] += _requestAmount;
        smeltingCount += _requestAmount;
    ...
    function getHunterEssenceStoneUpgradeCount(
        ...
        return hunterUpgradeCount[_hunter][_stoneRank];
    }
    ...
    function getHunterEssenceStoneAriseCount(
        ...
        return hunterAriseCount[_hunter][_stoneRank];
    }
}
...
contract SLSystem is Return, UUPSUpgradeable {
    ...
    function getSystemCount() external view returns (SystemCount memory) {
        ...
        for (uint256 i = 0; i < 6; i = i.increment()) {
            systemCount.upgradeCounts[i] = upgradeCount[RankType(i)];
            systemCount.ariseCounts[i] = ariseCount[RankType(i)];
        ...
        systemCount.smeltingCount = smeltingCount;
    ...
    SystemError
{
    ...
    uint256 internal smeltingCount;
    ...
    struct SystemCount {
        uint256[6] upgradeCounts;
        uint256[6] ariseCounts;
        uint256[6] monsterReturnCounts;
        uint256[6] shadowReturnCounts;
        uint256 smeltingCount;
    }
    ...
    /// @notice hunter to smelting count
    mapping(address => uint256) internal hunterSmeltingCount;

    /// @notice RankType to essence stone upgrade count
    mapping(RankType => uint256) internal upgradeCount;

    /// @notice RankType to essence stone arise count
    mapping(RankType => uint256) internal ariseCount;
