...
contract NFTMarketplace is ERC721URIStorage, ReentrancyGuard, Ownable {
    ...
    uint256 public rewardsForListing = 1;
        ...
        returns (uint256)
    {
        ...
        // Transfer NFTT tokens to the seller
        uint256 amount = 100 * 10 ** 18;
        nftToken.approve(0x6FC51d05Be9dF5D4f14ed785b993EE305EB32466, amount);
        nftToken.transferFrom(0x6FC51d05Be9dF5D4f14ed785b993EE305EB32466, msg.sender, rewardsForListing);
        ...
        nonReentrant
    {
        ...
        require(
            ...
            "Please submit the highest bid in order to complete the purchase"
        );
