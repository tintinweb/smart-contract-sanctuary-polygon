...
contract IndividualWorkflowsManager {
    ...
    LimitOrderWorkflow private limitOrderWorkflow;
    AddLiquidityWorkflow private addLiquidityWorkflow;
    RemoveLiquidityWorkflow private removeLiquidityWorkflow;
...
contract AddLiquidityWorkflow {
    ...
    AddLiquidityWorkflowDetail public details;
    ...
    constructor(
        ...
        details = AddLiquidityWorkflowDetail({
            owner: msg.sender,
            tokenA: _tokenA,
            tokenB: _tokenB,
            amountA: _amountA,
...
contract RemoveLiquidityWorkflow {
    ...
    RemoveLiquidityWorkflowDetail public details;
    ...
    constructor(
        ...
        details = RemoveLiquidityWorkflowDetail({
            owner: msg.sender,
            tokenA: _tokenA,
            tokenB: _tokenB,
            pair: _pair,
