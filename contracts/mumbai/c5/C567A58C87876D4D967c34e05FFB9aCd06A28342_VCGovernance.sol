...
contract VCGovernance {
    ...
    function setupProtocol(
        ...
        _setMarketplace(_marketplaceFixedPrice);
        _setMarketplace(_marketplaceAuction);
    ...
    function setMinterRoleArtNft(address _minter) external {
        _onlyAdmin();
        _setMarketplace(_minter);
    }

    function _setMarketplace(address _marketplace) private {
        artNft.setMarketplace(_marketplace);
    }
