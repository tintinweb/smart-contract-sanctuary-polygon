...
contract MonoMoods is ERC721Enumerable, Ownable, ReentrancyGuard {

    using Strings for uint256;

    // Constants
    uint256 public constant TOTAL_SUPPLY = 1212;
    ...
    constructor(
        ...
        string memory initHiddenTokenURI_
    ) ERC721( name_, symbol_) {
        setBaseTokenURI(initBaseURI_);
        setHiddenTokenURI(initHiddenTokenURI_);
    }
