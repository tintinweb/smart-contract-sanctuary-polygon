...
contract voting{
    ...
    function vote(address _candidate, string memory _electionId) public {
        ...
        require(elections[_electionId].hasVoted[msg.sender]==0, "Voter has already voted");
        elections[_electionId].hasVoted[msg.sender] = 1;
        elections[_electionId].candidates[_candidate].totalVotesReceived++;
        elections[_electionId].totalVotes++;
    }

    //Check isVoted
    function isVoted(string memory _electionId) public view returns(uint256){
