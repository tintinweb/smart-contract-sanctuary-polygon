...
contract SSSS5 is Context, IERC20, Ownable, ReentrancyGuard {
	...
	uint256 private _tTotal = 1 * 10**6 * 10**2;
	uint256 private _rTotal = (MAX - (MAX % _tTotal));
	uint256 private _tHODLrRewardsTotal;

	string private _name = "SSSS5";
	string private _symbol = "SS5";
	uint8 private _decimals = 2;

	uint256 public _rewardFee = 11;
	...
	uint256 public _maxTxAmount = 1 * 10**6 * 10**2;
