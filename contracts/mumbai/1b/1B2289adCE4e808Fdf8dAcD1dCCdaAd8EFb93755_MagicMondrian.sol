...
contract MagicMondrian is Ownable, Pausable, ERC721A, PaymentSplitter, EIP712 {
    ...
    uint256 public constant MAX_RESERVED = 5;
    ...
    constructor(address[] memory _payeesAdresses, uint[] memory _payeesShares, address _signerAddress, string memory _hiddenURI) ERC721A("Magic Mondrian", "MAMO") PaymentSplitter(_payeesAdresses, _payeesShares) EIP712(_signerAddress, "Magic Mondrian") {
