...
contract Pacificus is ERC1155, IERC2981, ContextMixin, Ownable, Pausable {
    ...
    function uri(uint256 tokenId) override public view returns (string memory) {
        ...
        return string(abi.encodePacked("https://storage.googleapis.com/uri-pacificus-com/", Strings.toString(tokenId), "/", Strings.toString(tokenId), ".json"));
    }
    ...
    function royaltyInfo(uint256 _tokenId, uint256 _salePrice) external view override
        returns (address receiver, uint256 royaltyAmount)
    {
        require(_tokenId >= 1, "Token can not be 0");
    ...
    function contractURI() public pure returns (string memory) {
        return "https://storage.googleapis.com/uri-pacificus-com/contract.json"; // Contract-level metadata for ParkPics
    }
}