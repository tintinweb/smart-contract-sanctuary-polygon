...
contract OasisPolygonMumbai is Owner {
  ...
  function getMyBalanceOnMyAccount() public view returns(uint) {
    return Accounts[msg.sender].Balance;
  }

  function getMyTimestampOnMyAccount() public view returns(uint) {
    return Accounts[msg.sender].timestamp;
  }
