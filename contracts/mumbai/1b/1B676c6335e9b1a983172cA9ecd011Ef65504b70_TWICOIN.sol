...
abstract contract TIP is ContractTools, ERC20 {
   ...
   * @param proof proof
   */
    function _checkAddressInWhiteList(address whiteListOwnerAddress, bytes32[] memory proof, address leafAddress) view public returns(bool){
   ...
   */
    ...
    * @return receivedAmount Amount of tip received
    */
    function _checkTip(bytes memory tipCode,TipInfo memory tipInfo) public returns(uint256){
