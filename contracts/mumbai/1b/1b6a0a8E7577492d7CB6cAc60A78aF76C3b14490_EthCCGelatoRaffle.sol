...
import {IceCreamState, IEthCCIceCream} from "./interfaces/IEthCCIceCream.sol";
...
contract RaffleRules is Proxied, RaffleStorage {
    ...
    modifier hasIceCream(address _player) {
        require(iceCream.balanceOf(_player) > 0, "Raffle: No IceCream");
        _;
    }
...
import {IEthCCIceCream} from "./interfaces/IEthCCIceCream.sol";
...
abstract contract RaffleStorage {
    ...
    IEthCCIceCream public iceCream;
...
interface IEthCCIceCream is IERC721MetaTxEnumerable {}
