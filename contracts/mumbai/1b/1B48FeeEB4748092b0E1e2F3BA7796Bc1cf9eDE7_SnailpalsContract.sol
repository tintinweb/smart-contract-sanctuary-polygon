...
// File: contracts/SnailpalsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract SnailpalsContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/WbuFBSx9wahEyiZGNYbe/contract-metadata";
  }
