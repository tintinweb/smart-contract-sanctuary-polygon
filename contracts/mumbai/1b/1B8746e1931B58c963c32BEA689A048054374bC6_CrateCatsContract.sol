...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x6857c14148b6Cf1bD8286D5c94Cf02671A07657f];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 15009, 15009 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmYFLTuzKsZEeZ2SvhGD8L4Ysib8XEiEYvw8fPTUQCMQy4/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 15009");
        _safeMint(_to, 1);
    }
...
// File: contracts/CrateCatsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CrateCatsContract is RamppERC721A {
    constructor() RamppERC721A("CrateCats", "CRATE"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/L6lFs41xfrSCkDrZz4lt/contract-metadata";
    }
}