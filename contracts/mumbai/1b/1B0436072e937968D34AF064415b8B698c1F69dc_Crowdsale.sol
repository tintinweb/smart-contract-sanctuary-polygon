...
pragma solidity ^0.8.17;
    ...
    contract Crowdsale {
        ...
        function claimVesting() public {
            ...
            if (vestingInfo[msg.sender].user == msg.sender) {
                token.transfer(user, vestingInfo[user].claimAmount);
                vestingInfo[msg.sender].To_be_Claimable = 0;
        ...
        function claimable() internal {
            ...
            currentTime = block.timestamp;
            timePassed = currentTime - timeStart2;
            //volver a poner en 86400
            daysPassed = timePassed / 1;
            calculateDailyVestingToken();
            accumulatedTokens = daysPassed * vestingdaily;
            vestingInfo[msg.sender].To_be_Claimable = accumulatedTokens;
        }
