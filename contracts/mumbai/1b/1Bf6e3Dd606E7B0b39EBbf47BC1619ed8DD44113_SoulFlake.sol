...
contract SoulFlake is ERC721, ERC721Enumerable, AccessControl, Ownable {
  ...
  function getSvg(uint256 tokenId) public view returns (string memory) {
    ...
    parts[2] = "'; var test = atob(input); document.querySelector('.bodyText').innerText = test;</script></foreignObject></svg>"; //<foreignObject x='50' y='50' width='412' height='30'><div xmlns= 'http://www.w3.org/1999/xhtml' > <p id='themetext' class='themeText'> soulflake </p></div><script>var input = '";
