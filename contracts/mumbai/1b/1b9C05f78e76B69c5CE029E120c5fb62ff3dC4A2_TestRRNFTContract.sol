...
// File: TestRRNFTContract.sol

/**
 * @title My Contract
 * @dev TODO: Rename this contract
 * @dev TODO: set the collection name, symbol, and max supply
 * @dev TODO: set the correct contract uri
 * @dev TODO: replace this comment with something fun and interesting.
 * @dev TODO: if you don't want to support the recall feature, override maxRecallPeriod() to return 0.
 */
contract TestRRNFTContract is ViciERC721, INominator {
    mapping(uint256 => string) nftNames;
    mapping(uint256 => bool) needsNomination;

    constructor() ViciERC721("My NFT Contract", "MyNFT", 100000) {
        setContractURI(
            "https://storage.googleapis.com/arrival-shadow-motion-newman/vici/restaurant-relief/TestMetadata.json"
        );
    }
