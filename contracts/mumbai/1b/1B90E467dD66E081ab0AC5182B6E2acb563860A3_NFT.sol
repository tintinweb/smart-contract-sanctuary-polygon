...
contract NFT is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, INFT, Multicall {
	// string baseURI;
	...
	function mint(string calldata _tokenURI, address _to) public override onlyMinters returns (uint256) {
	...
	function burn(uint256 _tokenId) public override onlyMinters {
		_burn(_tokenId);
	}
