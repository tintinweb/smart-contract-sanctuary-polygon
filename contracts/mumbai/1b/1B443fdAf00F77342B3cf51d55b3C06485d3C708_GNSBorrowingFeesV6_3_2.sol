...
contract GNSBorrowingFeesV6_3_2 is Initializable, GNSBorrowingFeesInterfaceV6_3_2 {
    ...
    function _setPairPendingAccFees(
        ...
        pair.lastAccBlockPerVaultMarketCap = getPendingAccBlockWeightedMarketCap(currentBlock);
    ...
    function _setGroupPendingAccFees(
        ...
        group.lastAccBlockPerVaultMarketCap = getPendingAccBlockWeightedMarketCap(currentBlock);
    ...
    function getGroupWeightedVaultMarketCapSinceLastUpdate(
        ...
        return
            getWeightedVaultMarketCap(
                ...
                g.lastAccBlockPerVaultMarketCap,
    ...
    function getPairWeightedVaultMarketCapSinceLastUpdate(
        ...
        return
            getWeightedVaultMarketCap(
                getPendingAccBlockWeightedMarketCap(currentBlock),
                p.lastAccBlockPerVaultMarketCap,
    ...
    function getWeightedVaultMarketCap(
        uint accBlockPerVaultMarketCap,
        uint lastAccBlockPerVaultMarketCap,
        uint blockDelta
    ) public pure returns (uint) {
        // return 1 in case blockDelta is 0 since acc borrowing fees delta will be 0 anyway, and 0 / 1 = 0
        return blockDelta > 0 ? (blockDelta * P_2) / (accBlockPerVaultMarketCap - lastAccBlockPerVaultMarketCap) : 1; // 1e18
    }
