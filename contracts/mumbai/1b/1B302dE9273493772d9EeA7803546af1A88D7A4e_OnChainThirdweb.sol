...
contract OnChainThirdweb is ERC721Base {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory){
        ...
        parts[2] = '<path fill="#ff8f8f" d="M12,8h3v1h-2v1h-1v1h-1v3h-1v1h-1v-1h1v-3h1v-1h1zM20,8h3v1h-2v1h-1v-2z" />';

        parts[3] = getDapp(tokenId);

        parts[4] = '<path fill="#ef7373" d="M15,8h1v2h5v1h2v-3h1v2h1v1h1v3h1v2h1v5h-1v-5h-1v-1h-1v-1h-1v2h-1v5h-1v1h-1v1h-6v-1h-1v-1h-1v-5h-1v-2h-1v1h-1v1h-1v5h-1v-5h1v-1h1v-1h1v-3h1v-1h1v1h2zM17,11h-1v1h1zM20,11h-1v1h1zM17,13h-1v1h1v1h1v2h1v-3h1v-1zM20,17h-1v1h1zM14,27h1v1h1v1h-1v-1h-1v1h-1v-1h1zM21,27h1v1h1v1h-1v-1h-1v1h-1v-1h1v-1z" />';
