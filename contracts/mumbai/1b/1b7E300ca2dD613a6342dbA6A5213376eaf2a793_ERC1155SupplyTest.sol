 ...
 * @notice This contract handles minting ERC1155 Supply Test tokens.
 */
contract ERC1155SupplyTest is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x3E5A582510CF7CAb3a59444fcD36A409F428b821;
    ...
    string public name = "ERC1155 Supply Test";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeibth44xxgd2yylupl2hbhemclkfsq2dosy7ngosuonf4tkokn453a/{id}"
        )
        RevokableOperatorFilterer(
