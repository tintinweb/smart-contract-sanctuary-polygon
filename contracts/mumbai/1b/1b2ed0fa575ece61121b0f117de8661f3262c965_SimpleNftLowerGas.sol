...
// File: contracts/StampMarket_test.sol
...
contract SimpleNftLowerGas is ERC721, Ownable {
  ...
  uint256 public finalMaxSupply = 1000000000000000000; //
  uint256 public currentMaxSupply = 1000000000; //
 ...
 function resetFinalMaxSupply() public onlyOwner {
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x54413C1Ab17392b3dC27aa62E2AaeA9D778b146e).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
