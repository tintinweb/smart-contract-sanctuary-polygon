...
contract Kp is ERC721Psi, Ownable {
    ...
    address public constant PUBLIC_MINT = 0xB670AaD712564afDbCb293c1dB17E35881D56eBc;

    address public constant PRIVATE_MINT = 0x0C9c3D710834A883083d3fCEF38DC8ca369086D2;
    ...
    constructor(
        ...
        setBlindURI(__blindURI);
        setBaseURI(__baseTokenURI);
        _mint(PRIVATE_MINT, 300);
        _mint(PUBLIC_MINT, 2700);
    }
