...
contract faucet is Ownable{
    ...
    ERC20 public tokenInstance0;
    ERC20 public tokenInstance1;
    
    mapping(address => uint256) lastAccessTime;

    constructor(address _tokenInstance0, address _tokenInstance1) {
        require(_tokenInstance0 != address(0));
        require(_tokenInstance1 != address(0));
        tokenInstance0 = ERC20(_tokenInstance0);
    ...
    function requestTokens0() public {
        require(allowedToWithdraw(msg.sender));
        address _owner = owner();
        tokenInstance0.transferFrom(_owner, msg.sender, tokenAmount);
    ...
    function requestTokens1() public {
        require(allowedToWithdraw(msg.sender));
        address _owner = owner();
        tokenInstance1.transferFrom(_owner, msg.sender, tokenAmount);
        lastAccessTime[msg.sender] = block.timestamp + waitTime;
    }
