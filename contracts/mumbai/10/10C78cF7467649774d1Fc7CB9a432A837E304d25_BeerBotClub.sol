...
contract BeerBotClub is ERC721, ERC721Enumerable, ERC721Royalty, Ownable, Pausable, BotSelector, PaymentSplitter  {
    ...
    constructor(uint16 _maxSupply, 
                ...
                payable
                {
                    ...
                    _customBaseUri = "https://beermoneybot.io/bmclub/";
    ...
    function tokenURI(uint256 tokenId) 
        ...
        returns (string memory) 
        {
            ...
            string memory baseURI = _baseURI();
            string memory jsonURI = Base64.encode(abi.encodePacked(baseURI, tokenId.toString(), ".json"));
        //  return string(abi.encodePacked(_baseURI(), "/",uint2str(_tokenId),".json"));
