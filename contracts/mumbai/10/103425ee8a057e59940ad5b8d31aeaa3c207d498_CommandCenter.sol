...
contract CommandCenter is IERC721ReceiverUpgradeable, Initializable, AccessControlUpgradeable, ERC721Upgradeable {
    ...
    function conquer(uint256 operatorId, uint256 weaponId) external {
        ...
        require(operators.ownerOf(operatorId) == msg.sender);
        require(operators.ownerOf(weaponId) == msg.sender);
        // TODO: only elites
    ...
    function setBaseReward(uint256 _baseReward) public onlyGameController {
        baseReward = _baseReward;
    }
    function setBaseXpGain(uint8 _baseXpGain) public onlyGameController {
        baseXpGain = _baseXpGain;
    }
    function setBaseStaminaCost(uint8 _baseStaminaCost) public onlyGameController {
        baseStaminaCost = _baseStaminaCost;
    }
    function setBaseDurabilityCost(uint8 _baseDurabilityCost) public onlyGameController {
        baseDurabilityCost = _baseDurabilityCost;
    }
    function setCombatDuration(uint16 _combatDuration) public onlyGameController {
    ...
    modifier onlyGameController() {
        // TODO: require(hasRole(GAME_CONTROLLER, msg.sender), 'Game controller role needed');
        _;
    }
}