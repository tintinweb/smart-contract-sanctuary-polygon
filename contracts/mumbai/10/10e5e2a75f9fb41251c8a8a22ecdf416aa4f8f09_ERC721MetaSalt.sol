...
abstract contract ERC721Lazy is IERC721LazyMint, ERC721Upgradeable, Mint721Validator, OwnableUpgradeable {
    ...
    function getRoyaltyFee(uint256 _id) external override view returns (uint) {
...
abstract contract ERC721Base is ERC721DefaultApproval, ERC721BurnableUpgradeable, ERC721Lazy {
