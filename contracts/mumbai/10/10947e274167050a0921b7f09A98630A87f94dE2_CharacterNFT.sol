...
contract CharacterNFT is ERC1155Supply, Ownable{
    address potionContract= 0xb82374295d5AaDD97d21Ba477Db5c5d2F91809ef;
    address genContract= 0x0467881893383965D1fFAFeb3B79b355908f6AEd;
    address GGContract= 0x57EB9846BE4Adfe583b81cB564C3DDF96619Ff8d;
    address WETHContract= 0xA6FA4fB5f76172d178d61B04b0ecd319C5d1C0aa;
    address distributeContract= 0x4B8B6807B0407f4Ab3d2B535f8A4A0a34F24239d;
    ...
    function mintGenesisGG(uint256 _id , uint8 _amount) public {
        if (!characterToPublicEnabled[_id]) {
            require(characterToWhitelist[_id][msg.sender]);
        }
        for(uint8 i = 0 ; i < _amount; i++){
            ERC20(GGContract).transferFrom(msg.sender, address(this), characterToGenPriceGG[_id] * _amount);
