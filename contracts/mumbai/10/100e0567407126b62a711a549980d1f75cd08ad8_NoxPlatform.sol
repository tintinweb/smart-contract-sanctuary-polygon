...
contract NOXSBT is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    function mint(
        ...
        if (_isPrivate) {
            documentsURI[tokenId] = "Private";
        } else {
            documentsURI[tokenId] = _url;
        }
...
// File: contracts/NoxPlatform.sol
...
contract NoxPlatform is Ownable, ReentrancyGuard {
    ...
    address public noxTokenAddress = 0x71411f2bbDAb65DfEC57BeC13C0E35A73E51d896;
    ...
    function issue(
        ...
        if (_isPrivate) {
            ...
            encryptedUrls[docCount][_to] = _url;
        } else {
            Documents[docCount] = Document(
                docCount,
                _details,
        ...
        NFTInterface.mint(_to, _url, _isPrivate);
    }
