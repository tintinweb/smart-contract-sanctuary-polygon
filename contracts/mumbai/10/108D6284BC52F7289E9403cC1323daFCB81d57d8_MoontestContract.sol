...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x72a416Ef94b87f1208BcFbaa8000Ba4CaC215a85];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeibmp3lcx2eugguepme4pxd6lh465dwqdgv2udd36re7ujwczuhuzy/";
...
// File: contracts/MoontestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MoontestContract is RamppERC721A {
    constructor() RamppERC721A("Moon test", "MOON"){}
}
