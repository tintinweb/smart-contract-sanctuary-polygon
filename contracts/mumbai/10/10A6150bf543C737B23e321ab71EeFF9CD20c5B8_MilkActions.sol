...
contract MilkActions is HSystemChecker, Multicall {
    ...
    modifier actionExists(bytes32 key) {
        require(_actionPrices[key] > 0, 'MA 400: Action doesnt exist');
        _;
    }
    ...
    function buy(
        ...
        require(_treasury.balanceOf(buyer) >= price, 'MA 101: Insufficient funds');
    ...
    /// @param actionKey - Key identifier for new action
    /// @param price - Price of new
    function editAction(bytes32 actionKey, uint256 price)
        external
