 ...
 * D4X service takes advantage of Aave and increases the number of tokens
 * through staking.
 **/
contract AaveProtocol is IAaveProtocol, MixinResolver, Ownable {
        ...
        returns (bytes32[] memory addresses)
    {
        ...
        addresses[0] = EXTRA_PROTOCOL_CONTRACT;
    }
    ...
    function _resolveAddressesFinish() internal override {
        _extraProtocol = requireAndGetAddress(EXTRA_PROTOCOL_CONTRACT);
    }
