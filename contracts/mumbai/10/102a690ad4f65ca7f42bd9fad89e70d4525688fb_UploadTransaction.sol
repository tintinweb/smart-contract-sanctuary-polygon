...
contract UploadTransaction is Ownable {
    ...
    event Upload(address account,Data[] data);
    ...
    function getAccountRecords(address account) public view returns (Data [] memory){
        return accountRecords[account];
    }
}