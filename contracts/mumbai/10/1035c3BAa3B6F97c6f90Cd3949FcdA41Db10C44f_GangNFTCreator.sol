...
contract GangNFT is ERC721, ReentrancyGuard {
    string public contractURI =
        "https://gangclub.vercel.app/api/opensea_meta/contractChild/";
    string public baseURI = "https://gangclub.vercel.app/api/opensea_meta/";

    GangNFTCreator gangNFTCreatorContract =
        GangNFTCreator(0x1035c3BAa3B6F97c6f90Cd3949FcdA41Db10C44f);
    ...
    /******************** ADMIN FUNCTIONS ********************/
    /**
     *@notice Admin can set the NFT cost.
     *@param newCost New cost for mint a new NFT.
     */
    function adminSetNFTCost(uint256 newCost) public onlyAdmin {
        nftCost = newCost;
    }

    /**
     *@notice Admin can set the subscription cost for different time periods.
     ...
     */
    function adminSetSubscriptionCost(
        uint8 timeInMonths,
    ...
    /** @notice Admin can toggle the pause state of Mint and Subscription. */
    function adminFlipPause() public onlyAdmin {
        paused = !paused;
    }
...
contract GangNFTCreator is ERC721, Ownable, ReentrancyGuard, IERC2981 {
    ...
    string public baseURI =
        "https://gangclub.vercel.app/api/opensea_meta/contract/token/";
