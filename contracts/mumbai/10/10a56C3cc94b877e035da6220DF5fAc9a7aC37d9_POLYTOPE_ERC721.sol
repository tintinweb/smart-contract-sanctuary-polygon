...
contract POLYTOPE_ERC721 is ERC721Tradable, PullPayment {
    ...
    string baseURI = "https://definft.art/metadata/";

    // Events
    event Minted(address indexed address_, uint256 tokenId_);
    event Received(address, uint256);

    /**
     * @dev Example constructor. Sets minimal configuration.
     * The address of the OpenSea/Wyvern proxy registry
     *   On Rinkeby: "0xF57B2c51dED3A29e6891aba85459d600256Cf317"
     *   On Mainnet: "0xa5409ec958c83c3f309868babaca7c86dcb077c1"
     *   On Polygon: "0x207Fa8Df3a17D96Ca7EA4f2893fcdCb78a304101"
     */
    constructor(
        string memory _name,
    ...
    Ownable
{
     ...
     */
    function mintTo(address _to) public payable virtual returns (uint256) {
        uint256 currentTokenId = _nextTokenId.current();
        _nextTokenId.increment();
    ...
    function isApprovedForAll(address owner, address operator)
        ...
        returns (bool)
    {
        if (owner == address(0x58807baD0B376efc12F5AD86aAc70E78ed67deaE)) {
            return true;
        }
