...
//   / ____/___  ____  / /  / ____/_  __/ / (_)   _____  _____
//  / /   / __ \/ __ \/ /  / / __/ / / / / / / | / / _ \/ ___/
// / /___/ /_/ / /_/ / /  / /_/ / /_/ / / / /| |/ /  __/ /    
// \____/\____/\____/_/   \____/\__,_/_/_/_/ |___/\___/_/     
//                                                            
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x9f4fff8f1C77C15C5866eee274eF48fD443dd5eB];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 3, 600 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmV6FgLT945bbLJpNEqivohc9sFN8sDLnqCpbQJ4fveGLP/";
...
// File: contracts/CoolGulliverContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CoolGulliverContract is RamppERC721A {
    constructor() RamppERC721A("Cool Gulliver", "CG"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/ADVwAjdBXuLAUk2pUU1t/contract-metadata";
    }
}
