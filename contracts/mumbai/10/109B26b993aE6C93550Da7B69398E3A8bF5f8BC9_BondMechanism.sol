    ...
    ERC1155SupplyUpgradeable
{
    ...
    /**
        @notice Mint
        @dev emits when a Mech token is minted
     */
    event Mint(
    ...
    /**
        @notice Burn
        @dev emits when a Mech token is burned
     */
    ...
    */
    ...
    // get base price of bond
    function getBasePriceOfBond(
        uint256 _tokenId
    ) external view returns (uint256) {
        return basePriceOfBonds[_tokenId];
    }
    ...
    */
    function mintBonds(
        ...
        basePriceOfBonds[_tokenId] = _basePriceOfArt / 100;
        _setURI(_tokenId, _uri);
        _mint(address(this), _tokenId, _amount, "");
        safeTransferFrom(
            address(this),
            _receiver,
            _tokenId,
        ...
        emit Mint(_tokenId, _receiver, _amount, _uri);
    }
