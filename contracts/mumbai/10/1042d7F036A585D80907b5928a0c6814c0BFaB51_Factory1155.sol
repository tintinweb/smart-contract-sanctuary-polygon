...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new NexityNFTUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        NexityNFTUser1155Token token = NexityNFTUser1155Token(address(addr));
...
contract NexityNFTUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
