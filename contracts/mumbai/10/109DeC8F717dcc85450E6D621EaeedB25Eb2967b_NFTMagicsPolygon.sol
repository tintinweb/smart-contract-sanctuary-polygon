...
contract NFTMagicsPolygon is ERC1155Base {
    constructor()
     ERC1155('NFTS MAGICS') {
        _transferOwnership(0x1Fb0C631dF78c4Bb723e293D04d687bc0cEfc869);

        _env = Environment.Development;
        _network = Network.Polygon;

        _profit = 0x1ad9f0Ad2f37519041f86594e8834fc2cC849984;
        _marketplace = 0xE41ec3ffB61C911024d94Aa09600e86FD97461e8;
        distributed = 0xE41ec3ffB61C911024d94Aa09600e86FD97461e8;
    ...
    function _setInitialPrices() private {
        if (_env == Environment.Development) {
            _prices[TokenType.Native][_ONE] = 3_600_000 gwei;
            _prices[TokenType.Native][_FIVE] = 5_000_000 gwei;
            _prices[TokenType.Native][_TEN] = 6_600_000 gwei;
            _prices[TokenType.Native][_TWENTY] = 8_700_000 gwei;
        } else {
            _prices[TokenType.Native][_ONE] = 360_000_000 gwei;
            _prices[TokenType.Native][_FIVE] = 500_000_000 gwei;
            _prices[TokenType.Native][_TEN] = 660_000_000 gwei;
            _prices[TokenType.Native][_TWENTY] = 870_000_000 gwei;
        }
    }
}
