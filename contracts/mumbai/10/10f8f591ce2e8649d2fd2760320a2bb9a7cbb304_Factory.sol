...
contract MyERC721 is ERC721, ERC721URIStorage, Ownable, AccessControl {
    ...
    constructor(string memory _name) ERC721(_name, "RLP") {
    ...
    function checkApprovalForAll(address _owner, address _operator) public view returns (bool) {
        return ERC721.isApprovedForAll(_owner, _operator);
    }

    function setPaymentWallet(address paymentAddress) external onlyAdmin {
        _paymentAddress = paymentAddress;
    }

    function getPaymentWallet() public view returns (address) {
...
contract Factory {
   MyERC721[] public MyERC721Array;

   function deploy721Contract(
        string memory _newMyERC721
    ) external returns (MyERC721 cardAddress) {

        MyERC721 newCards = new MyERC721(_newMyERC721);

        MyERC721Array.push(newCards);
        return newCards;
    }
}