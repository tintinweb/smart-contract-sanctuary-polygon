...
contract FitmintGuideActivities is Initializable, PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    event CalculateAllowed(address userAddress, uint256 calculationAttempts);
    ...
    function topUp(uint256 amount) external {
        ...
        fitmintGuideToken.transferFrom(msg.sender, address(this), amount);
        uint256 calculationAttempts = amount / 10 ** 18;
        emit CalculateAllowed(msg.sender, calculationAttempts);
    }
    ...
    function withdraw() external onlyOwner {
        uint256 balance = fitmintGuideToken.balanceOf(address(this));
        require(balance > 0, "Insufficient FTG balance");
        fitmintGuideToken.transfer(msg.sender, balance);
    }
