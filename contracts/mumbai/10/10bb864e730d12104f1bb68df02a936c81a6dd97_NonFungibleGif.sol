...
// File: interfaces/INonFungibleGifOwnable.sol


pragma solidity ^0.8.15;

interface INonFungibleGifOwnable {
...
// File: interfaces/INonFungibleGifPrimarySale.sol


pragma solidity ^0.8.15;

interface INonFungibleGifPrimarySale {
...
// File: interfaces/INonFungibleGifPlatformFee.sol


pragma solidity ^0.8.15;

interface INonFungibleGifPlatformFee {
...
// File: interfaces/INonFungibleGifContract.sol


pragma solidity ^0.8.15;

interface INonFungibleGifContract {
...
// File: interfaces/INonFungibleGifRoyalty.sol


pragma solidity ^0.8.15;


interface INonFungibleGifRoyalty is IERC2981Upgradeable {
    struct RoyaltyInfo {
        address recipient;
        uint256 bps;
    }
...
// File: interfaces/token/INonFungibleGif.sol
 ...
 */
interface INonFungibleGif is
    INonFungibleGifContract,
    INonFungibleGifOwnable,
    INonFungibleGifRoyalty,
    INonFungibleGifPrimarySale,
    INonFungibleGifPlatformFee,
    IERC721Upgradeable
{
    /**
...
// NonFungibleGif top-level


contract NonFungibleGif is
    Initializable,
    ...
    INonFungibleGif
{
    ...
    bytes32 private constant MODULE_TYPE = bytes32("NonFungibleGif");
    ...
    /// @dev Max bps in the nonfungiblegif system
    uint256 private constant MAX_BPS = 10_000;

    /// @dev The address interpreted as native token of the chain.
    address private constant NATIVE_TOKEN = 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE;

    /// @dev The nonfungiblegif contract with fee related information.
    INFGFee public immutable nonfungiblegifFee;
    ...
    constructor(address _nonfungiblegifFee) initializer {
        nonfungiblegifFee = INFGFee(_nonfungiblegifFee);
    }
    ...
    function initialize(
        ...
        __EIP712_init("NonFungibleGif", "1");
    ...
    function collectPrice(MintRequest memory _req) internal {
        ...
        (address nfgFeeRecipient, uint256 nfgFeeBps) = nonfungiblegifFee.getFeeInfo(address(this), FeeType.PRIMARY_SALE);
        uint256 nfgFee = (totalPrice * nfgFeeBps) / MAX_BPS;
        ...
        CurrencyTransferLib.transferCurrency(_req.currency, _msgSender(), nfgFeeRecipient, nfgFee);
        CurrencyTransferLib.transferCurrency(
            _req.currency,
            _msgSender(),
            saleRecipient,
            totalPrice - platformFees - nfgFee
        );
    }
