...
contract CowriseTest4 is Initializable, ERC1155Upgradeable, OwnableUpgradeable, ERC1155BurnableUpgradeable, UUPSUpgradeable {
    ...
    function contractURI() public pure returns (string memory) {
        return
            "ipfs://bafkreihzkqu4m7xlrspa2hdh7nucu4azkdkczqfuwzuybtip76nfrzr4mq";
    }

    function mint(string memory tokenURI_, uint256 _amount) public {
        id.increment();
        uint256 Id = id.current();
        setURI(tokenURI_);
    ...
    function update_TokenURI(uint256 tokenID, string memory _newTokenURI) public onlyOwner {
