...
contract WarrentyNFT is ERC721, ERC721URIStorage, Ownable{
    ...
    function getTokenUri(uint tokenURI) private view returns(string memory){
        return string(abi.encodePacked('{"name": "',attribute[tokenURI]._name,'","description": "This is Your Warranty Card.","image": "',generateCharacter(),'","attributes": [{"trait_type": "Serial", "value": "',attribute[tokenURI]._serial,'"}, {"trait_type": "Repairs", "value": "',attribute[tokenURI]._repairs,'"},{"trait_type": "Product", "value": "',attribute[tokenURI]._product,'"},]'));
    }
