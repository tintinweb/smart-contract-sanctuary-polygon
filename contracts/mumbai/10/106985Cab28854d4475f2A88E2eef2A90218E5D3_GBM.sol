...
contract GBM is IGBM, IERC1155TokenReceiver, IERC721TokenReceiver {
    ...
    function bid(uint256 _auctionID, uint256 _bidAmount, uint256 _highestBid) external override {
        require(
    ...
    function registerAnAuctionToken(address _contract, uint256 _tokenId, bytes4 _tokenKind, address _initiator) public {
...
interface IGBM {
    ...
    function bid(uint256 _auctionID, uint256 _bidAmount, uint256 _highestBid) external;
