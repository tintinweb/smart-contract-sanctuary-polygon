...
contract BankOnatorStaking is Ownable, ReentrancyGuard, Pausable {
    ...
    function setLastRewardTime(uint256 _newLastRewardTime) external onlyOwner {
    ...
    function calculateReward(
        ...
        uint256 rewardPerSecond = (tokens * APY) / (DIVIDER * APYBASE);

        // Total reward is per second reward multiplied by elapsed time
