...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmQg9RHwdmbxCZoFTzqBasnfVBkDLuGUfuqoKgTVRLPKks/";
...
// File: contracts/WotsTest25Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WotsTest25Contract is RamppERC721A {
    constructor() RamppERC721A("WotsTest 25", "WTT"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/RJzPAgB9cB5TGbhtzX7h/contract-metadata";
    }
}
