    ...
    IERC2981Upgradeable
{
    ...
    struct RoyaltyInfo {
        ...
        uint rate; // The rate of the payment
    }
    ...
    mapping(address => bool) whiteListAddresses; // whiteListAddress to bool value mapping
    mapping(address => bool) adminAddresses;
    mapping(uint256 => address) airdropOwners;
    mapping(address => uint256) tokenIds; // address to token Id mapping
    ...
    function addToWhiteList(address[] calldata entries) external onlyOwner {
        for (uint256 i = 0; i < entries.length; i++) {
            ...
            require(!whiteListAddresses[entry], "Cannot add duplicate address");
    ...
    function removeWhiteListAddresses(address entry) external onlyOwner {
        ...
        require(
            tokenIds[entry] == 0,
            "Airdrop NFT Holder: Not Allowed To Remove"
        );
    ...
    function createAirdropNFT(
        ...
        require(
            ...
            "AirdropNFT: Not Allowed to Mint The NFT"
        );
        ...
        // emit NftCreated(to, _uri, 0, _nftTypeStatus);
    }
    ...
    function createSpecialNFT(
        ...
        require(
            ...
            "Mint Special NFT: Only Admin Allowed"
        );
    ...
    function setAdminWallet(
        ...
        for (uint256 i = 0; i < adminWallets.length; i++) {
            ...
            require(admin != address(0), "Cannot add zero address");
            require(!adminAddresses[admin], "Cannot add duplicate address");
            adminAddresses[admin] = true;
        }
    }

    function removeAdminAddresses(address _adminWallet) external onlyOwner {
        require(_adminWallet != address(0), "Zero address");
    ...
    function _createNFT(
        ...
        uint256 feeInEth = getMaticPriceFromUsd(MINTING_FEE_IN_USD);
        require(msg.value == feeInEth, "WayGateERC721: Invalid Amount");
        require(
    ...
    // function getWhitelistAddressStatus(
