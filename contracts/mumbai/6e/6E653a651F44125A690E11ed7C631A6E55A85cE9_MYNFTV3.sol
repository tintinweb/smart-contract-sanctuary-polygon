    ...
    UUPSUpgradeable
{
    ...
    event TestSetter(
        string indexed _contractName,
        uint256 indexed _contractVersion
    );
    ...
    function initialize() public initializer {
        __ERC721_init("MYNFTV3", "MNTV3");
        __ERC721Enumerable_init();
        __ERC721URIStorage_init();
        __Pausable_init();
        __AccessControl_init();
        __ERC721Burnable_init();
        __EIP712_init("MYNFTV3", "1");
        __ERC721Votes_init();
    ...
    function testSetter(string memory _contractName, uint256 _contractVersion)
        public
    {
        contractName = _contractName;
        contractVersion = _contractVersion;

        emit TestSetter(_contractName, _contractVersion);
    }

    function testGetter() public returns (string memory, uint256) {
        emit TestGetter();
