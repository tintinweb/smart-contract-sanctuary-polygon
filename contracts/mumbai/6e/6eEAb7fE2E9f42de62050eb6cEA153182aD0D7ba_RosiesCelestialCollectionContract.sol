...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x0694A71862E0E8DbA57c6667788274A75235CD35];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x0694A71862E0E8DbA57c6667788274A75235CD35;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 4422) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmPuo1rwtnqQy3RiPcF1NnmrQYzZK1F1w72A6v2KWDfbdD/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 4422");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 4422");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 4422");
...
// File: contracts/RosiesCelestialCollectionContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract RosiesCelestialCollectionContract is RamppERC721A {
    constructor() RamppERC721A("Rosies Celestial Collection", "RCC"){}
}
