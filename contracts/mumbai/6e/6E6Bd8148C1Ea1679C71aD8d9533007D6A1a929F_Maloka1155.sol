...
contract Maloka1155 is ERC1155, Ownable {
    uint256 TOKEN_ID = 1;
    bytes32 public merkleRootHash=0x209467e9668dc8958ad4b3699e86f930138f72ed835e656861b5630d30f373ce;
    string public BASE_URI = "https://baseuri/";
    string public name = "MALOKA DAO TEST";
    string public symbol = "MDAO_test";
    ...
    function airdrop(address _to, uint amount) external onlyOwner {
        require(amount > 0, "amount must be greater than 0");
        _mint(_to, TOKEN_ID, amount, "");
    }

    function uri(uint256 _tokenID) public override view returns (string memory){
        require(_tokenID == TOKEN_ID, "Token id doesn't exist");
        return string(abi.encodePacked(BASE_URI, Strings.toString(TOKEN_ID), ".json"));
    }
}