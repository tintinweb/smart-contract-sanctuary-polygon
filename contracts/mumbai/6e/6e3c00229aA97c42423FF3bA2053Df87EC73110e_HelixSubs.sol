...
//PUBLIC FUNCTIONS -----------------------------------------------------------------------------------
    ...
    function Subscribe (
        ...
        if(subscription.exists) {
            ...
            else
            {
                ...
                subscription.merchantAddress = tokenMerchantHelixCreatorUserSpender_addr[1];
                subscription.hellixValue = merchantHelixCreatorApprovedDeadlineTime_value[1];
                subscription.helixAddress = tokenMerchantHelixCreatorUserSpender_addr[2];
                subscription.creatorValue = merchantHelixCreatorApprovedDeadlineTime_value[2];
                subscription.creatorAddress = tokenMerchantHelixCreatorUserSpender_addr[3];
    ...
    function TryBillSubscription(SubscriptionStruct memory subscription) public returns(bool){
        ...
        //merchant value
        if(subscription.merchantValue > 0)
        {
        ...
        //creator value
        if(subscription.creatorValue > 0)
        {
            paymentToken.transferFrom(
                subscription.userAddrress,
