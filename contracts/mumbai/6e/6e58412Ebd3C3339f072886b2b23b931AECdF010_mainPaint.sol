...
contract NFT is ERC721URIStorage, Ownable {//删ERC721URIStorage里的supportsInterface
    ...
    function exchangeMint (uint256 tokenId, string memory uri) public onlyOwner returns(uint256){
        _setTokenURI(tokenId, uri);
        return tokenId;
    }
