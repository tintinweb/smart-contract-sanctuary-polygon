...
contract DPSSupportShip is ERC721Enumerable, AccessControlEnumerable {
    ...
    mapping(uint256 => SUPPORT_SHIP_TYPE) typePerTokenId;
    ...
    constructor() ERC721("DPS Support Ship", "DPSSupportShip") {
    ...
    function getSkillBoostPerTokenId(uint256 _tokenId) external view returns (uint256, SUPPORT_SHIP_TYPE) {
        return (skillBoostPerTokenId[_tokenId], typePerTokenId[_tokenId]);
    }
    ...
    function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
        ...
        SUPPORT_SHIP_TYPE typeOfToken = typePerTokenId[_tokenId];
        string memory mainType = "SLOOP";
        string memory secondaryType = "STRENGTH";
        if (typeOfToken == SUPPORT_SHIP_TYPE.SLOOP_LUCK) {
            secondaryType = "LUCK";
        } else if (typeOfToken == SUPPORT_SHIP_TYPE.SLOOP_NAVIGATION) {
            secondaryType = "NAVIGATION";
        } else if (typeOfToken == SUPPORT_SHIP_TYPE.CARAVEL_STRENGTH) {
            mainType = "CARAVEL";
            secondaryType = "STRENGTH";
        } else if (typeOfToken == SUPPORT_SHIP_TYPE.CARAVEL_LUCK) {
            mainType = "CARAVEL";
            secondaryType = "LUCK";
        } else if (typeOfToken == SUPPORT_SHIP_TYPE.CARAVEL_NAVIGATION) {
            mainType = "CARAVEL";
            secondaryType = "NAVIGATION";
        } else if (typeOfToken == SUPPORT_SHIP_TYPE.GALLEON_STRENGTH) {
            mainType = "GALLEON";
            secondaryType = "STRENGTH";
        } else if (typeOfToken == SUPPORT_SHIP_TYPE.GALLEON_LUCK) {
            mainType = "GALLEON";
            secondaryType = "LUCK";
        } else if (typeOfToken == SUPPORT_SHIP_TYPE.GALLEON_NAVIGATION) {
            mainType = "GALLEON";
            secondaryType = "NAVIGATION";
        }
