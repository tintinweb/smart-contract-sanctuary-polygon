...
contract MVerse is ERC721, Ownable {
  ...
  constructor() ERC721("MVerse", "MVS") {
    setHiddenMetadataUri("ipfs://__CID__/hidden.json");
    buildings.push(Building("ZERO",0,0,0,0,0,0));
    buildings.push(Building("House",1,3,2,2,0,3));
    buildings.push(Building("Maskondi House",2,5,4,10,0,6));
    buildings.push(Building("Shrayes House",1,6,2,10,0,0));
    buildings.push(Building("Dinesh House",1,1,2,7,0,-7));
    buildings.push(Building("Suman House",2,3,1,-9,0,-9));
    buildings.push(Building("Madhu House",1,3,3,-4,0,2));
    buildings.push(Building("Krishna House",2,5,2,-2,0,5));
    buildings.push(Building("Dharmen House",2,6,1,-10,0,4));
    buildings.push(Building("Library",4,1,4,5,0,0));
    buildings.push(Building("Beach House",3,1,3,-4,0,-5));
    buildings.push(Building("Ghost House",2,2,3,-10,0,0));
