...
contract ClaimNeuromod is Ownable, ReentrancyGuard {
    ...
    uint256 public constant MAX_PER_ACCOUNT_WL = 1000;
    uint256 public constant MAX_PER_ACCOUNT_OG = 30;
    uint256 public constant MAX_PER_ACCOUNT_PUBLIC = 30;

    /**
     * @notice this is 8 because the first 8 are reserved for the Vault
     */
    uint256 public currentId = 8;
