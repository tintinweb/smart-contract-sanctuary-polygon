        ...
        if (_msgSender() != owner()) {
            if (
             ...
             if (promoCodeDetails[_promoCode].discountIsPercentage) {
                        uint256 newDiscountedAmount =  ((promoCodeDetails[_promoCode].discountPercentage / 100) * (ticketTypeDetails[ticketID].ticketFixPrice * noOfCopies));
                        ...
                        if (
                            newDiscountedAmount < ticketTypeDetails[ticketID]
                            .ticketFixPrice * noOfCopies 
                        ) {
                            checkPrice(((newDiscountedAmount)));
                            promoCodeDetails[_promoCode].claimedUsers++;
