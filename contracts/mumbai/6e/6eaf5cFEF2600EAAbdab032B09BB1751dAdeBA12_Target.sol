...
contract Target is IXReceiver, Ownable {
    ...
    address public Esource =
        address(0x21B55B1A71030bDBf48c61dA5097B6365313f8D7);
    address public Dsource =
        address(0x4751a706945452CE38De176456365c019F76D9C2);
    ...
    function _borrowFor(uint256 _amount) internal {
        ...
        sendPong(curr_balance - dBalance, uint8(2));
