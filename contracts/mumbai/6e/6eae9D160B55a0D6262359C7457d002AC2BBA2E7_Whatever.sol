...
/**
  ...
  */
contract Whatever is IBridge, AccessControlUpgradeable, ERC721HolderUpgradeable, UUPSUpgradeable {
...
//        simpleAssets.transferFrom(address(this), user, importsPending[referenceId].tokenId);
//        delete importsPending[referenceId];
    }
