...
contract PIXTerritoryStaking is OwnableUpgradeable, ReentrancyGuardUpgradeable, ERC721HolderUpgradeable, IPIXTerritoryStaking {
    ...
    function _rewardPerTokenFromLastUpdate(RewardPool storage rewardPool) internal view returns(uint256) {
        ...
        uint256 rewardPerToken = (rewardPool.tokensStaked == 0) ? 0 : reward / rewardPool.tokensStaked;
    ...
    function _calcRewardsToPush(uint256 _tokensStaked, uint256 totalReward) internal view returns (uint256) {
        ...
        return (totalReward * rewardPercentagePaidPerTokensStaked[_tokensStaked]) / rewardPercentagesDenominator;
    }
