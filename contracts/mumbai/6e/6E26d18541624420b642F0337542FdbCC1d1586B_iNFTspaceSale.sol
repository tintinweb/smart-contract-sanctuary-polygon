...
contract iNFTspaceSale is Ownable {
    ...
    PayCurrency [] private _supportCurrencies;
    ...
    function payCurrenciesLength() public view returns (uint256) {
        return _supportCurrencies.length;
    }

    function payCurrencies(uint256 _index) public view returns (PayCurrency memory) {
        return _supportCurrencies[_index];
    }
