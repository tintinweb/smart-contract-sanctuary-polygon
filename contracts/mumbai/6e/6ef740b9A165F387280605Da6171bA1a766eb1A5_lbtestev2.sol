...
contract lbtestev2 is VRFV2WrapperConsumerBase,ConfirmedOwner,ReentrancyGuard {
    ...
    address ethTrading = 0x210e3410db1EDfD7025e95b244357C5849e30844;
    ...
    uint256 public houseTickets = 10;
   ...
   // Mumbai 0xeeB482F3981D004C6199cA21F331Dc33EE639f0a // Mainnet 0x527a819db1eb0e34426297b03bae11F2f8B3A19E
        ...
        VRFV2WrapperConsumerBase(linkAddress, wrapperAddress) 
    {
        ...
        lottoWeekly = IluckblocksWeekly(0xF30408b857Ba3D66edD227c466E1351c0dB5Ac78);
        weeklyContract = 0xF30408b857Ba3D66edD227c466E1351c0dB5Ac78;
    ...
    function swapTokensToUSD(uint256 tokenAmount, address user, uint typeSwap) private {
        ...
        if(typeSwap == 1){
         ...
         prizeValueJackpot = (eth.balanceOf(address(this)) - contractBalance);

        } else if (typeSwap == 0){

         contractBalance = (eth.balanceOf(address(this)) - prizeValueJackpot);
    ...
    function getRandomNumber() internal returns (uint256 requestId) {
        ...
        uint256 amountInToken = (minimumPot * 10**18) / tprice;  // 100 usd in token
        minimumPrize = amountInToken;
