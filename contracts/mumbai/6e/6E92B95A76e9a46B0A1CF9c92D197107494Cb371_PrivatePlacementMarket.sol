...
contract PrivatePlacementMarket is OwnablePausable, ReentrancyGuardUpgradeable{
    ...
    function getTTPrice() external view returns(uint256, uint256, uint256, uint256, uint256, uint256) {
        (uint256 usdtUsdPrice, uint256 usdtUsdDecimals) = _tdex.getUsdtUsdPrice();
        return (
