...
contract RootForwarder is EIP712, Ownable {
    ...
    constructor() EIP712("RootForwarder", "0.0.2") { }
    ...
    modifier isRelayer() {
        require(_msgSender() == relayer, "Unauthorized");
        _;
    }
    ...
    {
        require(verify(req, signature), "RootForwarder: signature does not match request");
