...
contract Marketplace is Exchange, IMarketplace, IERC721Receiver {
    ...
    ) Exchange(_uniswapV2Router, _WETH9) {
    ...
    function buy(
        ...
        if (nft.tnftToPassiveNft(tokenId) == 0) {
            ...
            factory.lockTNGBLOnTNFT(nft, tokenId, _years, lockedTNGBL);
        }
        //buy the token
    ...
    function buyUnminted(
        ...
        if (nft.tnftToPassiveNft(tokenIds[0]) == 0) {
            ...
            factory.lockTNGBLOnTNFT(nft, tokenIds[0], _years, lockedTNGBL);
        }
...
abstract contract Exchange is AdminAndTangibleAccess {
    ...
    constructor(address _routerV2, address _WETH9) {
        router = _routerV2;
        WETH9 = IWETH9(_WETH9);
    }
    ...
    function setWETH9(address _WETH9) external onlyAdmin {
        ...
        emit NewWETH9(address(WETH9), _WETH9);
        WETH9 = IWETH9(_WETH9);
    }
