...
pragma solidity >=0.7.0 <0.9.0;
 ...
 contract Lumst{
    ...
    address public liquidityWallet = 0xe09821cD82536ea439394eb9eCaC92a20445c6aB ;  // Liquidity pool wallet address
    ...
    function setBurnPercentage(uint burn_percentage) public {
       require(msg.sender==owner,"Unauthorized access, only owner is allowed");
       require(burn_percentage>=1);
       require(burn_percentage<=100);
       burningTax = burn_percentage;
    }

    function setNewliquidityWalletAddress(address _address) public returns(bool) {
       require(msg.sender==owner,"Unauthorized access, only owner is allowed");
