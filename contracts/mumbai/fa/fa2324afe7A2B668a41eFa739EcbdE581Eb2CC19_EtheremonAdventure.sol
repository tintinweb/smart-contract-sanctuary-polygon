...
// File: contracts/EtheremonAdventure.sol
...
abstract contract EtheremonAdventureData {
    ...
    function getLandRevenue(uint256 _classId)
        ...
        view
        virtual
        returns (uint256 _emontAmount, uint256 _etherAmount);
...
contract EtheremonAdventure is EtheremonEnum, BasicAccessControl {
    ...
    uint256 public exploreEMONTFee = 1500000000;
    uint256 public exploreFastenETHFee = 0.005 ether;
    uint256 public exploreFastenEMONTFee = 750000000;
    ...
    function setFeeConfig(
        ...
        uint256 _exploreEMONTFee,
        uint256 _exploreFastenETHFee,
        uint256 _exploreFastenEMONTFee
    ) public onlyOwner {
    ...
    function adventureByToken(
        ...
        uint64 _param3,
        uint64 _param4
    ) external isActive onlyModerators {
    ...
    function _claimExploreItemUsingEMont(uint256 _exploreId, uint256 _token)
        internal
    {
    ...
    function claimExploreItem(uint256 _exploreId) public payable isActive {
        EtheremonAdventureData adventureData = EtheremonAdventureData(
            adventureDataContract
        );
        ExploreData memory exploreData;
        ...
        )
    {
        ...
        if (exploreData.itemSeed != 0) {
            ...
            if (block.number < exploreData.startAt + 2) return (0, 0, 0, 0);
            itemSeed =
                getRandom(
                    exploreData.sender,
                    exploreData.startAt + 1,
