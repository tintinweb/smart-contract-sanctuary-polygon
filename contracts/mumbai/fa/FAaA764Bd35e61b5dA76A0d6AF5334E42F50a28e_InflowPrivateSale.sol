...
contract InflowPrivateSale is Ownable, ReentrancyGuard {
    ...
    * @param _maticUsd for tokenPerMatic
    */
    function buyTokens(bytes32 messageHash,bytes calldata signature, int256 _maticUsd)
        public
        payable
        onlyOrigin
        nonReentrant
        returns (uint256 tokenAmount)
    {
        ...
        int256 inflowPrice = 2500000;
        int256 maticUsd = _maticUsd;
        int256 _tokensPerMatic = maticUsd / inflowPrice;
        // getLatestPrice() / inflowPrice;
        uint256 tokensPerMatic = uint256(_tokensPerMatic);
