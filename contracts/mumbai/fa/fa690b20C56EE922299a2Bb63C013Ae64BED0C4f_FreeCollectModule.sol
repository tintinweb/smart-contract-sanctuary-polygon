 ...
 *
 * @notice This is a simple  Oxtrip CollectModule implementation, inheriting from the ICollectModule interface.
 *
...
abstract contract FollowValidationModuleBase is ModuleBase {
    ...
    function _checkFollowValidity(uint256 profileId, address user) internal view {
        address followModule = IOxtripHub(HUB).getFollowModule(profileId);
        bool isFollowing;
