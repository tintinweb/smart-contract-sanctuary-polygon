...
contract Voting {
    ...
    function forVotePercentagePerProposal(uint _proposalId) external returns (uint forTotes){
        ...
        return calculateWeightedAvg[_proposalId].weightedAvgOfForVotes;
    }

    function agasintVotePercentagePerProposal(uint _proposalId) external returns (uint againstVotes){
        ...
        return calculateWeightedAvg[_proposalId].weightedAvgOfAgainstVotes;
    }
