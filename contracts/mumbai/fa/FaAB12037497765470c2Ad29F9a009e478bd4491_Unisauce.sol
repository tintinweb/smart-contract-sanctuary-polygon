...
contract Unisauce {
    ...
    function exerciseCoveredCall() external {
        ...
        if (currentPrice > coveredCallOption.strikePrice) {
            ...
            // unwrap v3 position
            // uint128 liquidity = getPoolLiquidity();
            // ( , , , , , , ,uint128 liquidity, , , ,) = INonfungiblePositionManager(nonfungiblePositionManager).positions(coveredCallOption.tokenId);
            ...
            IERC20(DAI).transferFrom(address(this), coveredCallOption.seller, coveredCallOption.premium + sellerAmountOwed);
            IERC20(DAI).transferFrom(address(this), coveredCallOption.buyer, buyerAmountOwed);
            ...
            IERC20(DAI).approve(coveredCallOption.seller, coveredCallOption.premium);
            IERC20(DAI).transferFrom(address(this), coveredCallOption.seller, coveredCallOption.premium);
        }
    }
