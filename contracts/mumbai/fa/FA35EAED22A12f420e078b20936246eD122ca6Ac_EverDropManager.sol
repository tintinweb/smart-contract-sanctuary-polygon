...
contract EverDropManager is Initializable, UUPSUpgradeable, AccessControlUpgradeable, ERC165StorageUpgradeable, EverErrors {
    ...
    function create(
        ...
        drops.push(Drop(dropId, 0, _saleOpenTime, _saleCloseTime, dropTokenInfo, _externalId, _owner, _nft));
