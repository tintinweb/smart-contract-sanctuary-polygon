...
contract MARCOPOLO is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor(uint96 _royalityFeeInBips, string memory _contractUri) ERC721("MARCO POLO", "MAPO") {
