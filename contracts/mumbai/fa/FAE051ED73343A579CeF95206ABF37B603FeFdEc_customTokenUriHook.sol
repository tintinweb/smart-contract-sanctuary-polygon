    ...
    ILockKeyPurchaseHook
{
    ...
    string public url="https://impact-api-bepw.vercel.app/";
    address public target;
    string public cid2="bafybeiglojwa6at5xwyswrkth3tviufd2h2g6zzto2nbtmdimxlwxqw3py";
    string public cid1="bafybeid4nmidjfhgpgorznvc35beajwpeelpcchg25mrme2i5ps6twkily";
    ...
    modifier tokenOwner() {
        ...
        require(Lock.balanceOf(msg.sender)!=0);
        _;
    }
    ...
    function seturl() public onlyOwner returns(string memory) {
        return url;
    }
        ...
        if(privacyList[owner]==true)
        {
            bytes memory json = 
                    abi.encodePacked(
                        ...
                        '"name": "Impact NFT",',
                        ' "description": "Impact",',
                        ' "image_data": "https://',cid1,'.ipfs.nftstorage.link",',
                        '"attributes" :',
                        '[{',
                        ' "score": "Private"',
                        '}]',
            ...
            cid=cid1;
             bytes memory json = 
                    abi.encodePacked(
                        ...
                        '"name": "Impact NFT",',
                        ' "description": "Impact",',
                        ' "image_data": "https://',cid,'.ipfs.nftstorage.link",',
                        '"attributes" :',
                        '[{',
                         ' "score": "',score,'"',
                        '}]',
    ...
    */
    function requestImpactScore(address owner) internal returns (bytes32 requestId) {
        ...
        string memory apiurl=string(abi.encodePacked(url,ownerstring));
        req.add("get", url);
