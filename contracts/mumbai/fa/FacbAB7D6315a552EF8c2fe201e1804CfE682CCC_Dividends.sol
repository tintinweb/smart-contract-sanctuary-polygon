...
contract Dividends is IDIVIDENDS, Pausable, Ownable {
    ...
    function amountSnapshotsAccount(address p_contractHoldings, address p_account, uint256 p_snapshotId) public view override returns(uint256, uint256, uint256, bool) { 
        ...
        if (balanceAccount == 0) { return (0, 0, 0, true); }
        ...
        return (balanceAccount, totalSupply, amountDividendsAccount, ITOKENHOLDINGS(p_contractHoldings).snapshotUsed(p_account, p_snapshotId));
    }
