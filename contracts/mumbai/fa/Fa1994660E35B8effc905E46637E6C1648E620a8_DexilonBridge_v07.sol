...
contract DexilonBridge_v07 is Ownable, Pausable, ReentrancyGuard {
     ...
     */
    function deposit(address _tokenAddress, uint256 amount) public whenNotPaused nonReentrant {
        ...
        if (usersAvailableBalances[_tokenAddress][msg.sender] == 0) {
            usersAvailableBalances[_tokenAddress][msg.sender] = 0;
        }
     ...
     */
    function batchUpdateAvailableBalances(address _tokenAddress, address[] memory users, uint256[] memory balanceUpdates, uint256 batchId, bytes[] memory signatures) public nonReentrant {
     ...
     * @param amount Amount of token in smallest units
     */
    function withdraw(address _tokenAddress, uint256 amount) public whenNotPaused nonReentrant {
