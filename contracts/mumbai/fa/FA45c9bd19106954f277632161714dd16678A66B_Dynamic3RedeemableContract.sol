...
// File: contracts/Dynamic3RedeemableContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract Dynamic3RedeemableContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Dynamic3 Redeemable";
    string public symbol = "D3Redeem";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/3hFR3aKnlErOq4vYnh9x/contract-metadata";
  }
