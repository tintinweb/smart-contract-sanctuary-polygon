...
contract LockingModule is veNFT {
    ...
    modifier notLocked(uint _tokenID) {
    ...
    function getVotingPower (uint256 _tokenID) public view notLocked(_tokenID) returns (uint256 votingPower) {
    ...
    function timeToDeadline (uint256 _tokenID) public notLocked(_tokenID) view returns (uint256 _deadline) {
    ...
    function lock(uint _amount, uint256 _duration) public 
    ...
    function unlock(uint256 _tokenID) public notLocked(_tokenID) {
