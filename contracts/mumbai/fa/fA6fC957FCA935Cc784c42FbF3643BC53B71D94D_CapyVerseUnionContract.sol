...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x2663b02e8b38865F8D21FAF36a4F402fb41Dae64];
...
abstract contract EarlyMintIncentive is Ownable, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 750;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 7500) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeibumr5eipjj7qazfbr7habiyf5er3jxocgeie77ppv6e4wsun7aym/";
...
// File: contracts/CapyVerseUnionContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CapyVerseUnionContract is RamppERC721A {
    constructor() RamppERC721A("CapyVerse Union", "CAPY"){}
}
