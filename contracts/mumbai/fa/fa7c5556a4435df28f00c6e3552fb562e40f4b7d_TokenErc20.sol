...
contract ERC20 is Context, IERC20, IERC20Metadata, Authorized {
    ...
    function setWalletADM(address account) public isAuthorized(0) { walletADM = account; }
    function setWalletMAIN(address account) public isAuthorized(0) { walletMAIN = account; }
    function setWalletBURN(address account) public isAuthorized(0) { walletBURN = account; }
