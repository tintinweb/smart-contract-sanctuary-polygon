...
contract HidalgoNFT is ERC721, IERC2981, ReentrancyGuard, Ownable {
  ...
  constructor(string memory customBaseURI_) ERC721("HidalgoNFT", "HGNFT") {
  ...
  address private constant payoutAddress1 =
    0xC2841E753e6e89E27fACd0a9Bc31D4D01691f238;
  ...
  function withdraw() public nonReentrant {
    ...
    Address.sendValue(payable(payoutAddress1), balance * 19 / 100);
    ...
    Address.sendValue(payable(payoutAddress5), balance * 24 / 100);
  }
