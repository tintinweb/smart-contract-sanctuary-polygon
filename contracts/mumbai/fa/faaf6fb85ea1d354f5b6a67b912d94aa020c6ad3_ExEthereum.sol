...
contract ExEthereum is ERC20, ERC20Burnable, Pausable, Ownable {
    constructor() ERC20("ExEthereum", "ExEth") {
        _mint(msg.sender, 900000000000000000 * 18 ** decimals());
    }
