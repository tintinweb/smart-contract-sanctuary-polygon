...
contract EtheremonLend is EthermonEnum, BasicAccessControl, SafeMathEthermon {
    ...
    function offerBorrowingItem(
        ...
        emit EventOfferBorrowingItem(msg.sender, _objId, _price, _releaseTime);
    }
    ...
    function removeBorrowingOfferItem(uint256 _objId) external isActive {
        ...
        emit EventRemoveOfferBorrowingItem(msg.sender, _objId);
    }
    ...
    function borrowItem(uint256 _objId) external payable isActive {
        ...
        //if (borrowItem.price != weth.balanceOf(msgSender())) revert();
        ...
        //_triggerNFTEvent(obj.trainer, msgSender(), _objId);
    ...
    function getBackLendingItem(uint64 _objId) external isActive {
        ...
        emit EventGetBackItem(msg.sender, borrowItem.borrower, _objId);
    }
