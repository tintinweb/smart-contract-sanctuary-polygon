...
/// @title NFT Mint, whitelist, Payment Splitter, merkle tree for NFT Marketplace
/// @author Bleuplatine
...
contract MocheERC721A is Ownable, ERC721A, PaymentSplitter {
    ...
    uint256 public MAX_GIFT = 10;
    uint256 public MAX_WHITELIST = 30;
    uint256 public MAX_PUBLIC = 20;
    uint256 public MAX_SUPPLY_MINUS_GIFT = MAX_SUPPLY - MAX_GIFT;

    uint256 public wlSalePrice = 5 ether;
    uint256 public publicSalePrice = 7 ether;
    ...
    uint256 public maxPerAddressDuringWhitelistMint = 5;
    uint256 public maxPerAddressDuringPublicMint = 5;
    ...
    uint256[] private _teamShares = [70, 30];
    ...
    **/
    function whitelistMint(address _account, uint _quantity, bytes32[] calldata _proof) external payable callerIsUser{
        ...
        require(amountNFTperWalletWhitelistSale[msg.sender] + _quantity <= maxPerAddressDuringWhitelistMint, "Max NFT per Address exceeded during Whitelist Sale");
    ...
    **/
    function publicMint(address _account, uint _quantity) external payable callerIsUser {
        ...
        require(amountNFTperWalletPublicSale[msg.sender] + _quantity <= maxPerAddressDuringPublicMint, "Max NFT per Address exceeded during the Public Sale");
    ...
    */
    ...
    /**
    * @notice Allows to set the max supply
    *
    * @param _MAX_SUPPLY The new max supply
    */
    ...
    /**
    * @notice Allows to set the max gift
    *
    * @param _MAX_GIFT The new max gift
    */
    function setMAX_GIFT(uint _MAX_GIFT) external onlyOwner {
        MAX_GIFT = _MAX_GIFT;
    }

    /**
    * @notice Allows to set the max whitelist
    *
    * @param _MAX_WHITELIST The new max whitelist
    */
    function setMAX_WHITELIST(uint _MAX_WHITELIST) external onlyOwner {
        MAX_WHITELIST = _MAX_WHITELIST;
    }

    /**
    * @notice Allows to set the max public
    *
    * @param _MAX_PUBLIC The new max public
    */
    function setMAX_PUBLIC(uint _MAX_PUBLIC) external onlyOwner {
        MAX_PUBLIC = _MAX_PUBLIC;
    }
    ...
    */
    ...
    /**
    * @notice Allows to set the max mint per address during the Whitelist sale
    *
    * @param _maxPerAddressDuringWhitelistMint The new max mint per address during the Whitelist sale
    */
    function setMaxPerAddressDuringWhitelistMint(uint _maxPerAddressDuringWhitelistMint) external onlyOwner {
        maxPerAddressDuringWhitelistMint = _maxPerAddressDuringWhitelistMint;
    }

    /**
    * @notice Allows to set the max mint per address during the public sale
    *
    * @param _maxPerAddressDuringPublicMint The new max mint per address during the the public sale
    */
    function setMaxPerAddressDuringPublicMint(uint _maxPerAddressDuringPublicMint) external onlyOwner {
