...
contract Trust_Global is Ownable {
    ...
    event Upgrade(address indexed user, address indexed referrer, uint8 matrix, uint8 level,uint8 mtype);
    ...
    function _buyNewLevel(address _userAddress, uint8 matrix, uint8 level) internal {
        ...
        if (matrix == 1) {
            ...
            emit Upgrade(_userAddress, freeX3Referrer, 1, level,1);
            ...
            emit Upgrade(_userAddress, freeX6Referrer, 2, level,2);
        }
    }
