...
contract SmartContract is ERC721A, Ownable, ReentrancyGuard {
  ...
  *****************************************************************************************************************************/
  modifier mintCompliance(uint256 _mintAmount) {
    ...
    if (_mintAmount + _numberMinted(msg.sender) >= maxMintAmountPerWallet) { revert MaxSupplyExceeded(); }
    _;
  }
...
//  function setUriContract(string memory _uriContract) public onlyOwner {
//    uriContract = _uriContract;
//    uriContract = string(abi.encodePacked(_uriContract));
//    uriContract = string(abi.encodePacked("data:application/json;base64,", Base64.encode(bytes(_uriContract))));
//  }
