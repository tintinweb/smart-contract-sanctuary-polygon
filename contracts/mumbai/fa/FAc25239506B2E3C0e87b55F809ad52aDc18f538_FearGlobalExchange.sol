...
contract FearGlobalExchange is AccessControl, Pausable, Withdrawable, ContextMixin, NativeMetaTransaction {
    ...
    function exchange(string memory contractName, string memory positionName, uint256 amount) payable external whenNotPaused {
        ...
        exchangeContract.exchange{value:msg.value}(_msgSender(), positionName, amount);
    }
