...
contract CapsuleHD is ERC721A, Ownable, Pausable, PaymentSplitter {
    ...
    function mint(
        ...
        capsulesMintedPerAddress[to].Onyx += _amountOnyx;
        capsulesMintedPerAddress[to].Gold += _amountGold;
        capsulesMintedPerAddress[to].Diamond += _amountDiamond;
        ...
        _safeMint(to, _amountOnyx + _amountGold + _amountDiamond);
        emit Mint(to, _amountOnyx, _amountGold, _amountDiamond, _totalSupply + 1);
    }
