    ...
    OwnableUpgradeable
{
    ...
    function initialize() public initializer {
        __ERC721_init("JYS NFTs", "JYS");
        __ERC721Enumerable_init();
        __ERC721URIStorage_init();
        __Ownable_init();
        __EIP712_init("JYS NFTs", "1");
        __ERC721Votes_init();
    }
...
abstract contract OwnableUpgradeable is Initializable, ContextUpgradeable {
    ...
    event OwnershipRevoked(uint256 indexed owner);
    ...
    //  */
    // function owners() public view virtual returns() {
    //     return _owners;
    // }
    ...
    function revokeOwnership(uint256 index) public virtual onlyOwner {
        delete _owners[index];
        emit OwnershipRevoked(index);
    }
