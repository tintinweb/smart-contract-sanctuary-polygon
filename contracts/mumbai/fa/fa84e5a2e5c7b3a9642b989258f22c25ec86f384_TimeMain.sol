...
contract TimeMain is ERC721Enumerable, Ownable, Pausable {
    using Strings for uint256;
    ...
    uint256 public preCost = 0.003 ether;
    ...
    function setBaseURI1(string memory _newBaseURI1) public onlyOwner {
        baseURI1 = _newBaseURI1;
    }

    function setBaseURI2(string memory _newBaseURI2) public onlyOwner {
        baseURI2 = _newBaseURI2;
    }
