...
// balance of NFT tokens for the address
...
contract Dao {
    ...
    constructor() {
        ...
        validTokens = [
            25713041121946968301422062672570858736701408956056232875891260699931366653967
        ];
    }
    ...
    function voteOnProposal(uint256 _id, bool _vote) public {
        require(Proposals[_id].exists, "Proposal doesn't exists");
        require(
