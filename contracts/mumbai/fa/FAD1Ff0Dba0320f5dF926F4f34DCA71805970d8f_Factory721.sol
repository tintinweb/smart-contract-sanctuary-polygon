...
import "./OwnGoMVBUser721Token.sol";
...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new GoMVBUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        GoMVBUser721Token token = GoMVBUser721Token(address(addr));
