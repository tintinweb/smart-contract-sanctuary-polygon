...
// File contracts/ToketV2With2771.sol

pragma solidity ^0.8.9;

contract ToketV2With2771 is
    ERC721,
    ERC721Enumerable,
    ERC721URIStorage,
    ERC721Royalty,
    ...
    ERC2771Context
{
    ...
    event ToketV2Mint(address indexed _to, uint256 indexed _tokenId);
    ...
    // Override functions to use ERC2771Context
    function _msgData()
        internal
        view
...
// File contracts/ToketV2With2771Proxy.sol

pragma solidity ^0.8.9;

contract ToketV2With2771Proxy is AccessControl, ERC2771Context {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    ...
    function safeMint(
        address _toketV2With2771,
        address to,
        string memory uri
    ) public onlyRole(MINTER_ROLE) returns (uint256) {
        require(
            _toketV2With2771 != address(0),
            "Invalid ToketV2With2771 address"
        );
        return ToketV2With2771(_toketV2With2771).safeMint(to, uri);
    }
    ...
    function safeMintWithRoyalties(
        ...
        ToketV2With2771(_toketV2With2771).safeMintWithRoyalties(
            to,
            uri,
            royaltiesReceiver,
            royalties
