...
contract TokenfyDemo is ERC721A, Ownable, ReentrancyGuard, IERC2981 {
    using ECDSA for bytes32;
	using Strings for uint256;
    using SafeERC20 for IERC20;

	string private _baseTokenURI = "https://metadata.api.tokenfy.com/55/metadata/";
	string private _contractURI = "https://tokenfy-production-public.s3.us-east-2.amazonaws.com/55/contract-uri";
	...
	constructor(address _signerAddress) ERC721A("Tokenfy Demonstration", "DEMO") {
