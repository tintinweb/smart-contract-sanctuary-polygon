...
contract RandomBananaNFT is ERC721URIStorage, VRFConsumerBaseV2 {
    ...
    function createOnChainSvg(string[2] memory color) internal pure returns (string memory svg) {
        ...
        string
            memory baseSvg3 = "'/><path d='M46.875 168H18.75v-18.668H0v-18.664h18.75V112h37.5V93.332H75V74.668h18.75V37.332h18.75V0h18.75v37.332H150v56h-18.75v37.336H112.5v18.664H75V168zm0-18.668H75v-18.664h37.5V93.332h18.75v-56H112.5v37.336H93.75v18.664H75V112H56.25v18.668h-37.5v18.664zm0 0' fill='#000'/></svg>";
