...
contract MiniMiao is ERC721Enumerable, NonblockingReceiver {
    ...
    constructor(
        ...
        // traitGen = new MiniMiaoTraitGen("POLY", 1);
...
*/
    ...
    // function hashToImageData(string memory _hash)
    //     internal
    //     view
    //     returns (string memory)
    // {
    //     return AnonymiceLibrary.encode(descriptor.hashToSVG(_hash));
    // }
