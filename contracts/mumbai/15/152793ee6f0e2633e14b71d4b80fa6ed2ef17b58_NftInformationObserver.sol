...
contract NftInformationObserver {
        ...
        )
    {
        ...
        gameNftInfo = new OwnerNftData[](2);
        boxNftInfo = new OwnerNftData[](3);
        ...
        )
    {
        ...
        StakeNftData memory newStakeNftData3 = StakeNftData({
           collectionId: 8,
           tokenId: 9,
           duration: block.timestamp - 40000
        });
        stakeInfo[0] = newStakeNftData0;
        stakeInfo[1] = newStakeNftData1;
        stakeInfo[2] = newStakeNftData2;
        stakeInfo[3] = newStakeNftData3;
    }
}