...
contract ProofOfXFactory is AccessControl {
    ...
    function createContracts(
        ...
        require(!factoryCreated[_factoryName], "PoXF: Factory already created for this factory name");
        require(
        ...
        factories[_factoryName] = addresses(_creator, _factoryName, address(proxy), address(proofOfX), address(forwarder));
