...
contract Comments is Ownable {
  ...
  uint256 private _registryTableId;
  string private _registryTable;
  uint256 private _commentsTableId;
  string private _commentsTable;
  string private _tablePrefix = "nfc";

  string private _baseURIString = "https://testnet.tableland.network/query?s=";

  function createTables(address tablelandRegistry) public onlyOwner {
  ...
  function getCommentsForToken(string memory contractAddress, uint256 tokenId) public view returns (string memory) {
