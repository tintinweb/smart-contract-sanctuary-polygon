...
contract Domains is ERC721URIStorage {
    ...
    // tdl: top level domain (.eth, .anything)
    string public tld = "banana";
    ...
    function register(string calldata name) public payable {
        ...
        require(domains[name] == address(0), "Domain has already been registered!");
