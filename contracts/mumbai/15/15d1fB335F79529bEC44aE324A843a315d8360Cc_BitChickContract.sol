...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1655845200;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1656018000;
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x6AF96bA8F3199e01971edD7cA194Ee9F7736dDBE];
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeifryjki373eyxbsycmw4ijhewpfvbq5wdwp7lfnm4w4owb6yfzwoy/";
...
// File: contracts/BitChickContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BitChickContract is RamppERC721A {
    constructor() RamppERC721A("BitChick", "BCC"){}
}
