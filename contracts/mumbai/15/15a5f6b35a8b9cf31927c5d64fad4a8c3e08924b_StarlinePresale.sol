...
contract StarlinePresale is Ownable {
    ...
    constructor() {
        presaleToken = IERC20(0x73EdFfE71764522B6B51cAd43F8c6d0Ff3056981);
        WBTC = IERC20(0xbDAD50fF669b3C11b6Abc8ffa16549404C24391f);
        USDT = IERC20(0x65c157b91148A4256cBe67b6e20E3D8a911cd260);
    ...
    function getTokenOutAmount(
        ...
        if (_exhangeToken == USDT) {
                return (
                    ((amount * getLatestPriceUSDT() * 1e30
                    ) /
