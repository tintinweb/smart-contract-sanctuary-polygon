...
// Certik: Only Owners will use multisig;
...
contract Token is ERC20, Ownable, Interest, ReentrancyGuard {
    ...
    // Certik: All parameters are required and are initialized by truffe
    // The min amount to stake is used to avoid DDOS and to have min 
    constructor(
        string memory name_,
