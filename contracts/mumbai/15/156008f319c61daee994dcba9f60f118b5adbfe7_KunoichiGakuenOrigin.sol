...
contract KunoichiGakuenOrigin is ERC721A, ReentrancyGuard, Ownable, Pausable, AccessControl, DefaultOperatorFilterer {
    using Strings for uint256;
    ...
    function publicMint(uint256 _mintAmount) external payable whenNotPaused whenMintable callerIsUser nonReentrant {
    ...
    function preMint(
        ...
        TicketID ticket
    ) external payable whenMintable callerIsUser whenNotPaused nonReentrant {
