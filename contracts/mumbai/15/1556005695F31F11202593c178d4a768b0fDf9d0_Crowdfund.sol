    ...
    PausableUpgradeable
{
    ...
    function initialize(
        ...
        quotaInfos[QuotaClass.LOW].value = _valueLowQuota;
        quotaInfos[QuotaClass.REGULAR].value = _valueRegQuota;
        quotaInfos[QuotaClass.HIGH].value = _valueHighQuota;
        ...
        checkIfCrowdfundOngoing
    {
        ...
        uint256 totalPayment = _amountOfLowQuota *
            quotaInfos[QuotaClass.LOW].value +
            _amountOfRegularQuota *
            quotaInfos[QuotaClass.REGULAR].value +
            _amountOfHighQuota *
            quotaInfos[QuotaClass.HIGH].value;
...
interface ICrowdfund {
    ...
    /** @notice initializes this contract.
        @param _valueLowQuota: parameters to initiate a collection
        @param _valueRegQuota: parameters to initiate the crowdfunding */
    function initialize(
        uint256 _valueLowQuota,
        uint256 _valueRegQuota,
        uint256 _valueHighQuota,
