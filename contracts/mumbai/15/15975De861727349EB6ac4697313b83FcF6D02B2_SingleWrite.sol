...
contract SingleWrite is IExecutePlugin, BasePluginWithRules {
    ...
    function execute(
        ...
        ) = abi.decode(_data,(uint256, address, string, bool, bool, bool, bool));
        ...
        require(registry.hasAnyPayment(_sender, postInfo.paymentType),
            "SingleWrite: the user did not pay"
        );
