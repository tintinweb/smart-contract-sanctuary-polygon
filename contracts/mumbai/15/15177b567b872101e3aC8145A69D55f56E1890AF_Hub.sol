...
contract Hub is IHub, Ownable {
    ...
    uint256 public placeReward; // How many tokens to receive for placing one element
    uint256 public expansionCost; // How many tokens it cost to expand by one element
    uint256 public cooldownDuration;

    uint256 public tokensNeededPerOneSnapshotCell;
    ...
    // function setSnapshotsURI(string memory newuri) external onlyOwner {
    //     snapshots.setURI(newuri);
    // }

    // function mintPersmissions(
    //     address to,
    //     uint256 id,
    //     uint256 tokensToDonate
    // ) external onlyOwner {
    //     permissions.mint(to, id, tokensToDonate);
    // }

    // function mintBatchPersmissions(
    //     address to,
    //     uint256[] memory ids,
    //     uint256[] memory amounts
    // ) external onlyOwner {
    //     permissions.mintBatch(to, ids, amounts);
    // }
}
