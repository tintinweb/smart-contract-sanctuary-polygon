...
// SPDX-License-Identifier: MIT
    ...
    contract FacesNFT is ERC721, Ownable, ERC721Enumerable {
        ...
        returns (string memory)
      {
        ...
        if (isRevealed == false) {
          return
            "ipfs://bafybeievzxb6vpx2w57l7uc6kccurrxtfzvsudcy6vv2zuuczjijbhfg34/hidden.json";
        }
