...
contract FakeAltroNftCollectionFactory is Initializable, OwnableUpgradeable {
	...
	function initialize(address _licenseManager,
						address _nftReserveAddress) public initializer {
	...
	function createCollection(
		...
		FakeAltroNftCollection collection = new FakeAltroNftCollection(_name, _symbol, _oracle, msg.sender, nftReserveAddress, _minGracePeriod, _insolvencyGracePeriod);
