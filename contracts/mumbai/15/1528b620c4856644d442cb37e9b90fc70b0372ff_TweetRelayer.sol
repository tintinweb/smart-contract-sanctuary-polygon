...
contract TweetRelayer is ITweetRelayer, ChainlinkClient {
    ...
    bytes32 immutable private readTweetJobId;
    bytes32 immutable private writeTweetJobId;
    ...
    function requestTweetPublication(bytes20 postId_) public returns (bytes32 requestId) {
        Chainlink.Request memory req = buildOperatorRequest(readTweetJobId, this.fulfillPublication.selector);
