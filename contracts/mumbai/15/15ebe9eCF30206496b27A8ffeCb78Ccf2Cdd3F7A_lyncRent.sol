...
error DurationMustBeLessThanOrEqualToAllowedDuration();
...
contract lyncRent is ReentrancyGuard {
        ...
        isOwner(tokenId, msg.sender, nftAddress)
    {
        ...
        emit ItemListedForRent(msg.sender, nftAddress, tokenId, price);
    }
        ...
        notAlreadyRented(tokenId, nftContractAddress)
    {
        ...
        if (duration > listing.allowedDuration) {
            revert DurationMustBeLessThanOrEqualToAllowedDuration();
        }
