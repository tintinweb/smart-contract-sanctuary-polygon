...
abstract contract Crowdsale is Initializable {
  ...
  function _forwardFunds(address _beneficiary, uint256 _BUSDTokenAmount) internal {
    _BUSDToken.safeTransferFrom(_beneficiary, wallet, _BUSDTokenAmount);
  }
...
contract FarmSent is Crowdsale, FinalizableCrowdsale, UUPSUpgradeable{
    ...
    function initialize(
      ...
      public initializer
    {      
        _BUSDToken = IERC20Upgradeable(0x5c3e6f59efdE1AFc9F4A4Bd89aC6eB17ed751d2D); // BUSD Token
    ...
    */
    function setReceiveTokens(address busdToken) external onlyOwner {
    ...
    function buyToken(address _beneficiary, uint256 _BUSDTokenAmount) external onlyWhileOpen whenNotPaused{
      ...
      token.safeTransfer(_beneficiary, token_amount);
