...
import "./Registry.sol";
import "./interfaces/IFantasySportContract.sol";
...
contract Factory is Multicall, ERC2771Context, AccessControlEnumerable {
    ...
    function addImplementation(address _implementation) external {
        ...
        IFantasySportContract module = IFantasySportContract(_implementation);
    ...
    function approveImplementation(address _implementation, bool _toApprove)
        external
    {
        require(hasRole(FACTORY_ROLE, _msgSender()), "not admin.");
