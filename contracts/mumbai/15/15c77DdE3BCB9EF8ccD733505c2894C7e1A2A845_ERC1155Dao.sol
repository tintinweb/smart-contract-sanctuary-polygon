...
contract Ownable is IOwnable {
     ...
     */
    modifier onlyOwner() {
        if (_owner != msg.sender) revert NotAvailableForOperationLib.NotAvailableForOperation(20);
        _;
    }
    ...
    modifier checkForInvalidAddress(address newOwner) {
        if (newOwner == address(0)) revert NotAvailableForOperationLib.NotAvailableForOperation(21);
        _;
    }
