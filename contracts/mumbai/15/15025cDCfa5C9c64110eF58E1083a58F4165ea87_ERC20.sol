...
contract Blacklistable is OwnableUpgradeable {
    ...
    modifier notBlacklisted(address _account) {
        require(
            ...
            "ERC20 EURM: sender account is blacklisted"
        );
        _;
    }
    ...
    modifier validAddress(address _to) {
        require(_to != address(0), "ERC20 EURM: Not Add Zero Address");
        /* solcov ignore next */
        _;
    }
    ...
    function dropBlacklist(address _account) public validAddress(_account) onlyOwner() {
		require(isBlacklisted(_account), "ERC20 EURM: Wallet don't exist");
