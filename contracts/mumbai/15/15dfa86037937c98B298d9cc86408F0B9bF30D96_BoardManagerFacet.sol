                        ...
                        for (uint r = 0; r < down.length; r++){
                            if(down[r] != game.score_away_by_period[q] % 10){
                                ...
                                if( squareBuyerz[c][r].purchaser != address(0x0) ){
                                    ...
                                    winners[squareBuyerz[c][r].purchaser].totalWinnings = winners[squareBuyerz[c][r].purchaser].totalWinnings + backwardPrize;
                                    winners[squareBuyerz[c][r].purchaser].winningBackwardSquarez.push(squareBuyerz[c][r]);
                                }
                            }
                        }
