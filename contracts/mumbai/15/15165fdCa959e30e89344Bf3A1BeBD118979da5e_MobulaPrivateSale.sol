...
contract MobulaPrivateSale is Ownable {
    ...
    IERC20 public MOBULA;
    IERC20 public USDC;

    uint public MAX_USDC_FOR_PRIVATESALE_PERUSER = 10 ** 18;
    ...
    function approveUSDCTransfer() public callerIsUser {    
        ...
        USDC.approve(address(this), 10 ** 18);
    }
    ...
    function deposit() public callerIsUser {
        require(privateSaleended == false, "Private Sale ended");
        USDC.approve(address(this), 10);
        USDC.transferFrom(msg.sender, address(this), 1 ** 18);
    }
