...
contract Dao {
    ...
    constructor() {
        ...
        validTokens = [31157856944392261834479670957073950563596401360920146543096296036575632949249];
    }
    ...
    function checkProposalEligibilty(address _proposalList)
        private
        view
        returns (bool)
    {
    ...
    function createProposal(
        ...
        require(
            checkProposalEligibilty(msg.sender),
