...
// File contracts/templates/BurnTxFeeWhiteListTemplate.sol
...
contract BurnTxFeeWhiteListTemplate is 
    ERC20Base, 
    ERC20BurnFeature, 
    TxFeeFeature, 
    PausableWithWhitelistFeature 
{
    ...
    function _beforeTokenTransfer_hook(
        ...
        address to,
        uint256 amount
    )  internal virtual override(TxFeeFeature, PausableWithWhitelistFeature) {
