...
import {Skyteller_RouterOpenSweepDisabled} from "./SkytellerErrors.sol";
...
contract SkytellerRouterV1 is Initializable, Ownable2StepUpgradeable, UUPSUpgradeable {
     ...
     * @param newSweeperDelegate The new sweeper contract
     */
    function setSweeperDelegate(ISkytellerSweepDelegate newSweeperDelegate) external onlyOwner {
        sweeperDelegate = newSweeperDelegate;
        emit SkytellerRouterSetSweeperDelegate(newSweeperDelegate);
    }
