...
contract Vesting {
    ...
    uint256 public UNLOCK_UNIT = 30; // 30% of the total allocation will be unlocked
    ...
    constructor(
        ...
        UNLOCK_UNIT = (100 - TGE_UNLOCK_) / VESTING_PERIOD_;
    ...
    returns (uint256 _amountVested)
    {
        ...
        vestedPercent = ((block.timestamp - firstVestingPoint) / MEASURE).mul(
            UNLOCK_UNIT
        );
