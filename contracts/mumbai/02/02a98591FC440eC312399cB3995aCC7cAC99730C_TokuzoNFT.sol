...
// File: contracts/tokuzo-poly.sol

pragma solidity ^0.8.13;

contract TokuzoNFT is Ownable, ERC721, NonblockingReceiver {
    address public _owner;
    string private baseURI;
    uint256 public cost;
    uint256 public maxMintperWallet = 3;
    uint256 nextTokenId = 333;
    uint256 MAX_MINT_POLYGON = 444;
    ...
    function mint(uint8 quantity) external payable {
        require(!paused, "Tokuzo: The contract is paused.");
        require(
        ...
        require(
            nextTokenId + quantity <= MAX_MINT_POLYGON,
    ...
    function setMaxMintperWallet(uint256 maxMint) external onlyOwner {
    ...
    function traverseChains(uint16 _chainId, uint256 tokenId) public payable {
        ...
        require(
            ...
            "Tokuzo: msg.value not enough to cover messageFee. Send gas for message fees"
        );
