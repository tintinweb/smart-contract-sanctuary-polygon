...
contract RoyaltyNonFungibleToken is ERC2981, NonFungibleToken {
    constructor(
        string memory name_,
        string memory symbol_,
        address minter_,
        ...
        _setDefaultRoyalty(minter_, feeNumerator_);
    }

    function setDefaultRoyalty(uint96 _newFeeNumerator) public virtual onlyOwner {
        _setDefaultRoyalty(_msgSender(), _newFeeNumerator); // _msgSender() == owner()
    }
