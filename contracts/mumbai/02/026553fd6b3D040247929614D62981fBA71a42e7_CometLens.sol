...
contract CometLens {
    ...
    function getUserData(
        ...
        IComet.UserCollateral memory userCollateral = IComet(comet).userCollateral(user);
...
interface IComet {
    ...
    function userCollateral(address user) external view returns (UserCollateral memory);
