...
contract ShibaClassic is ERC721A, Ownable {

    uint256 _currentIndex = 1; //Make first tokenId = first json file.
    string baseExtension = ".json";
    uint256 _mintamount = 5000; //It will be equal to quantity.
    ...
    constructor(
        string memory _MalikSaqib,
        string memory _MS,
        string memory _baseUri
    ) ERC721A(_MalikSaqib, _MS) {
