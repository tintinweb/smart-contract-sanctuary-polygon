...
contract NFT is ERC721A, Ownable, ReentrancyGuard {
    ...
    // ===== Constructor =====
    constructor() payable ERC721A("Contract", "Token") {}

    // ===== Modifiers =====
    modifier whenPrivateMint() {
        if (!privateMintStarted || publicMintStarted)
            revert PrivateMintNotStarted();
        _;
    }
        ...
        whenPrivateMint
    {
        ...
        if (_numberMinted(msg.sender) + quantity > presaleMaxItemsPerWallet)
