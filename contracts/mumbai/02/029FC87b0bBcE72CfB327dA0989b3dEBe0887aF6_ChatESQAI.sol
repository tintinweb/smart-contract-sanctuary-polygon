...
contract ChatESQAI is ERC20, Ownable {
    uint256 public marketingFee = 300; // 3%
    uint256 public rewardsFee = 300; // 3%
    address public marketingWallet = 0x40eC408Ff743f486a53f2a00a209A0eF1bf0Bb52;
    address public rewardsWallet = 0x6c66F80E90b9E03516a5d0D648C20A407b21894E;
    ...
    constructor() ERC20("ChatESQ", "$ChatESQ") {
