 ...
 * @dev Fired in addCollection()
  ...
  * @dev Fired in addCollection()
  ...
  function mint(address _to, uint256 _tokenId, uint8 _cardType, uint8 _cardCollection) public  validCardType(_cardType) onlyRole(MINTER_ROLE){
   ...
   * @param _cardCollection the collection of the card to mint
	 */
  function mintBatch(address _to, uint256 _tokenId, uint128 _n, uint8 _cardType, uint8 _cardCollection) public onlyRole(MINTER_ROLE) validCardType(_cardType) {
   ...
   * @param _data additional data with no specified format, sent in call to `_to`
	 */
  function safeMint(address _to, uint256 _tokenId, uint8 _cardType, uint8 _cardCollection, bytes memory _data) public {
   ...
   * @param _cardCollection the collection of the card to mint
	 */
  function safeMint(address _to, uint256 _tokenId, uint8 _cardType, uint8 _cardCollection) public {
   ...
   * @param _data additional data with no specified format, sent in call to `_to`
	 */
  function safeMintBatch(address _to, uint256 _tokenId, uint128 _n, uint8 _cardType, uint8 _cardCollection, bytes memory _data) public {
   ...
   * @param _cardCollection the collection of the card to mint
	 */
  function safeMintBatch(address _to, uint256 _tokenId, uint128 _n, uint8 _cardType, uint8 _cardCollection) external {
