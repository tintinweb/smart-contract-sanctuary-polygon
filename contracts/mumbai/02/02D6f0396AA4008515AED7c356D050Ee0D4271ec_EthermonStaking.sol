...
contract EthermonStaking is EthermonStakingBasic, EthermonEnum {
    ...
    function CheckHash(string calldata _appSecret) external {
        bytes32 _log = keccak256(abi.encodePacked(_appSecret));
        emit LOG(_log);
    }
