...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 3, 8884 ) {}
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 8884");
        _safeMint(_to, 1);
    }
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 8884");
...
// File: contracts/MoEvContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MoEvContract is RamppERC721A {
    constructor() RamppERC721A("MoEv", "MoEv"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/Mz2tb0nXcXfmXqSk3o4M/contract-metadata";
    }
}