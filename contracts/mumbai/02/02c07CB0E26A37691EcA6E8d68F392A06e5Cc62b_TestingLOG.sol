...
contract TestingLOG is ERC721r, Ownable {
    ...
    bool private _tokenLockedTesting = true;
    ...
    //                          OWNER FUNCTION
    // ===================================================================
    function setDurationTokenLock_JwA(bool _duration) public onlyOwner {
        //_timeTokenLock = block.timestamp + _duration;
        _tokenLockedTesting = _duration;
    }
    ...
    function withdraw_wdp() external onlyOwner {
        ...
        Address.sendValue(
            payable(0xfa1656f6785718BaE8A8790DBd91433Cd566dF8f),
            balance
        );
    }
    ...
    function _beforeTokenTransfer(
        ...
        if (from != address(0)) {
            if (_tokenLocked[tokenId] && _tokenLockedTesting) {
                revert TokenLocked();
            }
        }
...
contract ERC721r is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function getRandomIndex(address to) internal view returns (uint256) {
        ...
        return randomNum % updatedNumAvailableTokens;
    }
