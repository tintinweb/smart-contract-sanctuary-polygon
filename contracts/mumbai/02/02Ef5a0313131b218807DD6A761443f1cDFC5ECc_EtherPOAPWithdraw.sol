...
contract EtherPOAPWithdraw is OwnableUpgradeable {
    bool public active;

    address public signer;
    mapping(bytes32 => bool) public evidenceUsed;
    uint256 public maxValuePerReward;

    function __EtherPOAPWithdraw_init(address _signer) public initializer {
    ...
    function claimRewards(
        ...
        if (maxValuePerReward > 0) {
            require(
                value <= maxValuePerReward,
                "exceed the maximum value per reward"
            );
        }
        require(
    ...
    function setMaxPrice(uint256 _maxValuePerReward) public onlyOwner {
