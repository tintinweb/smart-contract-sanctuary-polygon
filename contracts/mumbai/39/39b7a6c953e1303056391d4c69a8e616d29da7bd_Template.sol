...
contract Template is ERC721URIStorageUpgradeable, ERC2981Upgradeable, EIP712Upgradeable, BasicMetaTransaction{
    ...
    function _hash(Voucher.NFTvoucher calldata voucher) internal view returns (bytes32) {
        return _hashTypedDataV4(keccak256(abi.encode(
            keccak256(
                "NFTvoucher(uint160 nftAddress,uint256 tokenId,uint256 price,string tokenUri,uint160 royaltyKeeper,uint96 royaltyFees)"
            ),
            voucher.nftAddress,
            voucher.tokenId,
            voucher.price,
    ...
    function redeem(Voucher.NFTvoucher calldata _voucher, address redeemer) public onlyOperator {
