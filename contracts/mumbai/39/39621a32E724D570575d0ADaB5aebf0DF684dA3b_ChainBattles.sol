...
contract ChainBattles is ERC721URIStorage {
    ...
    function train(uint256 tokenId) public {
        ...
        Character storage characterStats = tokenIdToCharacter[tokenId];

        characterStats.level = characterStats.level + 1;
        characterStats.speed = characterStats.speed + random(4);
        characterStats.strength = characterStats.strength + random(4);
        characterStats.life = characterStats.life + random(4);
