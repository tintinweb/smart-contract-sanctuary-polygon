...
contract CollectionFactory is Initializable, OwnableUpgradeable, PausableUpgradeable {
    ...
    function createCollection(
        ...
        Collection collection = new Collection(name, symbol, _contractURI, tokenURIPrefix, msg.sender);
...
contract Collection is Pausable, Ownable, NFTDefault {
    ...
    constructor(
        ...
        string memory tokenURIPrefix,
        address _admin
    ) NFTDefault(name, symbol, _contractURI, tokenURIPrefix, _admin) {
    ...
    function safeMint(
        ...
        _tokenIdCounter.increment();
        NFTDefault.safeMint(to, _tokenId, tokenURI, creator, value);
        return _tokenId;
    }
}
