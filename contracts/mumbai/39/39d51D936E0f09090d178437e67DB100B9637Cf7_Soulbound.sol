...
contract Soulbound is ERC721, ERC721URIStorage, Ownable {
    ...
    event Revoke(address indexed from, address indexed to, uint256 indexed tokenId);
    ...
    function _afterTokenTransfer(
        ...
        if (to == address(0)) {
            emit Revoke(from, to, firstTokenId);
        }
    }
...
// 0x39d51D936E0f09090d178437e67DB100B9637Cf7