...
contract NFT1155 is ERC1155, Ownable {
  ...
  function mintAndConnect(address _to, uint _id, uint _amount, string memory _uri) public{
    _mint(_to,_id,_amount, "");
    tokenURI[_id] = _uri;
    emit URI(_uri, _id);
  ...
  function burnForMint(address _from, uint[] memory _burnIds, uint[] memory _burnAmounts, uint[] memory _mintIds, uint[] memory _mintAmounts) public{
