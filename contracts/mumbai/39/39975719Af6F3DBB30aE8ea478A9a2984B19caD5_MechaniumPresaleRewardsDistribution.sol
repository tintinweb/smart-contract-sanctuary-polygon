...
/**
 * @title MechaniumPresaleRewardsDistribution - Pre-sale distribution smart contract
 * @author EthernalHorizons - <https://ethernalhorizons.com/>
 * @custom:project-website  https://mechachain.io/
 * @custom:security-contact [email protected]
 */
contract MechaniumPresaleRewardsDistribution is MechaniumVesting {
    ...
    constructor(IERC20 token_)
        MechaniumVesting(
            token_,
            10, // once the schedule has started, unlock 10%
