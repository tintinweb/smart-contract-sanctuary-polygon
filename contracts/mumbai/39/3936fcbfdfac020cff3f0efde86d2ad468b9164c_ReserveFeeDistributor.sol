...
// claim reserve from the aave core protocol
// send the reserve fee generated from each pool to the corresponding bribe(s) contract on each epoch
contract ReserveFeeDistributor is Ownable {
    using SafeERC20 for ERC20;

    uint256 private constant PRECISION = 1000;
    uint256 public bribeRatio = 500;
    ...
    function _split(address _asset) internal {
        address _aToken = getReserveData(_asset).aTokenAddress;
