    ...
    IRandomizerCallback
{
     ...
     */
    function paused() public view virtual override(Pausable) returns (bool) {
        return Pausable.paused() || _gameRegistry.paused();
    }
...
interface ITraitsProvider is ISystem, IERC165 {
...
interface ILockingSystem is ISystem, IERC165 {
    /**
...
interface ILootSystem is ISystem, IERC165 {
    // Type of loot
    enum LootType {
        UNDEFINED,
        ERC20,
...
interface IRandomizer is ISystem, IERC165 {
    /**
...
contract GameNFT is IERC165, TraitsConsumer, IGameNFT, ERC721BridgableChild {
    ...
    ) ERC721(name, symbol) TraitsConsumer(gameRegistryAddress) {
...
contract PirateNFT is GameNFT {
    ...
    constructor(address gameRegistryAddress)
        GameNFT(MAX_SUPPLY, "Pirate", "PIRATE", gameRegistryAddress)
    {
    ...
    function _initializeTraits(uint256 tokenId) internal override {
        // Gen 0
        _setTraitInt256(tokenId, GENERATION_TRAIT_ID, 0);
        _setTraitInt256(tokenId, XP_TRAIT_ID, 0);
        _setTraitInt256(tokenId, LEVEL_TRAIT_ID, 1);
        _setTraitInt256(tokenId, IS_PIRATE_TRAIT_ID, 1);
    }
