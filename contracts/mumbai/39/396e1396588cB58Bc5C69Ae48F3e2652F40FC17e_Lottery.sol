...
contract Lottery is VRFConsumerBase{
    ...
    uint256 public ticketPrice =100000000000000  ;
    bytes32 public keyHash;
    uint256 public fee;
    uint256 public randomNumber;
    uint256 public constant MAX = ~uint256(0); 
    uint256 public constant SCALE = 9;
    uint256 public constant SCALIFIER = MAX / SCALE;
    uint256 public constant OFFSET = 1; 
    string[] public id;

    mapping(address => string[]) public CheckPair;
    ...
    function getRandomNumber() public returns(bytes32 requestId){
       require(LINK.balanceOf(address(this)) >= fee,"check Link supply");
    ...
    function buy(uint256 ticket) public payable {

      require(msg.value >= ticketPrice,"low price not accepted!");
      uint256 a;
      uint256 b;
      uint256 c;
      uint256 d;
      string memory z;
      uint256 _ticket = msg.value.div(ticketPrice) * ticket; 
    //   uint256 _ticket = msg.value.div(ticketPrice);
        ...
        for(uint256 i =0 ;i< _ticket;i++){
            ...
            z =string(abi.encodePacked(_toString(a),_toString(b),_toString(c),_toString(d)));
            id.push(z);
            CheckPair[msg.sender].push(z);
        }        
    ...
    function randomish() internal  returns(uint256) {
        uint256 seed = uint256(getRandomNumber());
    ...
    function withdrawEther(address payable _addr) public {
