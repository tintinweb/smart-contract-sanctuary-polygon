...
contract InflottoTickets is ERC721URIStorage  {
    ...
    string private constant COLLECTION_NAME = "Inflotto Ticketss3";
    string private constant COLLECTION_ID = "IFLTK3";
    ...
    function getTraits(uint256 tokenId) private view returns (string memory, string memory, string memory) {
        return (
            ...
            tokenIdToTraits[tokenId].index.toString(),
    ...
    function mint(uint256 newItemId, uint256 draw, uint256 index) public {
