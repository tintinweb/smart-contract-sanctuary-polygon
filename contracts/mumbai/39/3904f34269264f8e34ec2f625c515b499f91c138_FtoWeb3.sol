...
contract FtoWeb3
{
    ...
    function FileExist(string memory id) private view returns (bool)
    {
    ...
    function CreateFile(string memory id,string memory fileName,uint fileSize) public payable
    {
        address owner = payable(msg.sender);
  


        FileObj memory newFileObj = FileObj(owner,"",fileName,fileSize,false,id);
    ...
    function AddFile(string memory id,string memory base64Data) public payable
    {
