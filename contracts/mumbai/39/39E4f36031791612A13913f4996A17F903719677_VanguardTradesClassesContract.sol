...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1682926200;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xe0240970F00D7c8Eac526dB12F138B3905DF8521];
  address public erc20Payable = 0xe0240970F00D7c8Eac526dB12F138B3905DF8521;
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 101) { }
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/7gqoOYAXSRjmykah8fBp/contract-metadata";
  }
...
// File: contracts/VanguardTradesClassesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract VanguardTradesClassesContract is ERC721APlus {
    constructor() ERC721APlus("Vanguard Trades Classes", "VTC"){}
}
