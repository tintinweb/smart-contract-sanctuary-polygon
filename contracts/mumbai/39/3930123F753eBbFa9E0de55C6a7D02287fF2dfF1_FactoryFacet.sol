...
contract Modifiers {
    ...
    modifier onlyHost {
        require(BigBoardManagerLib.getFactory().hostToken.balanceOf(msg.sender) > 0);
        _;
    }
    ...
    modifier founderOrHostOnly{
        require(BigBoardManagerLib.getFactory().founderz[msg.sender] || BigBoardManagerLib.getFactory().hostToken.balanceOf(msg.sender) > 0);
        _;
    }
