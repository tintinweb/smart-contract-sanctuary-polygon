    ...
    */
    ...
    returns(uint256){
        ...
        if(vestingSchedule.revoked == true) {
            ...
            currentTime >= vestingSchedule.firstReleaseTime && currentTime <= vestingSchedule.secondReleaseTime
        ) {
            // if first release was set
            return firstReleaseAmount - releasedAmount;
        } else if (
            vestingSchedule.secondReleaseTime != 0 &&
            currentTime >= vestingSchedule.secondReleaseTime && currentTime <= vestingSchedule.cliff
        ) {
