...
contract ChainBattles is ERC721URIStorage {
    ...
    mapping(uint => PlayerStats) public tokenIdStats;
    ...
    function getStats(uint tokenId)
        public
        view
        returns (PlayerStats memory)
    {
        PlayerStats memory playerStats = tokenIdStats[tokenId];
        return playerStats;
    }
    ...
    {
        PlayerStats memory playerStats = getStats(tokenId);
    ...
    function mint() public {
        ...
        tokenIdStats[newItemId] = PlayerStats(
            0,
            random(500),
            random(1000),
            random(100)
    ...
    function train(uint tokenId) public {
        ...
        tokenIdStats[tokenId].level++;
        tokenIdStats[tokenId].speed += 50;
        tokenIdStats[tokenId].strength += 10;
        tokenIdStats[tokenId].health += 5;
