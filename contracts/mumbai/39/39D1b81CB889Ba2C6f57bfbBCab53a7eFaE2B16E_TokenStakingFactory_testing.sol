...
contract TokenStakingFactory_testing is Ownable {
    ...
    *         - 3: Ended
    *         Other variables:
    *         - registerTime: The registration time of the pool.
    *         - endRegisterTime: The end registration time of the pool.
    *         - endPoolTime: The end time of the pool.
    *         - deployTime: The deployment time of the pool contract.
    *         - totalReward: The total reward of the pool.
    *         - highestAPR: The highest APR from all pool.
    *         - stakeToken: The token used for staking in the pool.
    */
