...
contract Coinz is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Coinz", "CNZ") {
        ...
        swapTokensAtAmount = (totalSupply * 5) / 1000000000000; // 0.050% swap wallet
        ...
        marketingWallet = address(0x0C71632231D3a955Dc36C23ac8E8510228fC2cea); // set as marketing wallet
        devWallet = address(0x0C71632231D3a955Dc36C23ac8E8510228fC2cea); // set as dev wallet
