    ...
    ERC20Upgradeable
{
    ...
    event Withdraw(address addr, uint256 amount, uint256 fee);
    ...
    function initialize(
        ...
        multiplierWithdrawEnabled = true;
     ...
     */
    function stakeMultiplier(address nft, uint256 tokenId)
        external
        isEligibleSender
    {
        ...
        // update existing CLAM amount
        Otter memory info = otterInfo[msg.sender];
        uint256 newMultipliedAmount = _getMultipliedAmount(
            info.amount,
            msg.sender
        );
        ...
        otterInfo[msg.sender] = Otter({
            amount: info.amount,
            multipliedAmount: newMultipliedAmount,
    ...
    /**
     * @notice stake CLAM
     * @param amount the amount of clam to stake
     */
    function stake(uint256 amount) external isEligibleSender {
        ...
        IERC20(CLAM).transferFrom(msg.sender, address(this), amount);
     ...
     */
    function addApprovedMultiplierToken(address token, uint256 multiplier)
        external
        onlyAdmin
    {
    ...
    function onERC721Received(
        ...
        return OtterStakingV2.onERC721Received.selector;
    }
