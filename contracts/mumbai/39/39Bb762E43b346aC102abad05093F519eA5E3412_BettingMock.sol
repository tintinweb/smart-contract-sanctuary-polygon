...
contract BettingMock is Ownable, IBettable, IBetResolvable, INicknameStorage {

    uint256 public currentBetNumber = 0;
    uint256 public withdrawCount = 0;
    uint256 public refundCount = 0;
    uint256 public matchSettledCount = 0;
    bool public isRefundNeededFlag = false;
    uint256 public nicknameSetCount = 0;
    ...
    function refundNeeded() onlyOwner public view returns (bool) {
        return isRefundNeededFlag;
    }

    function setRefundNeeded() onlyOwner public {
        isRefundNeededFlag = true;
    }

    function refundAll() onlyOwner public {
        emit RefundCalled();
        refundCount++;
        isRefundNeededFlag = false;
    }
