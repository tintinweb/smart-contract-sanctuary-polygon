...
//
//     ______                                    
//    / ____/___ ___  ____  ___  _________  _____
//   / __/ / __ `__ \/ __ \/ _ \/ ___/ __ \/ ___/    
// /_____/_/ /_/ /_/ .___/\___/_/   \____/_/     
//                /_/                            
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x6CcF4F2A470A4e979a80fD11D906F278c984E43b];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmXpYnVPd4RS6hcPw7LL8xwtBtDsyvFBrZc9Z41kemXthK/";
...
// File: contracts/EmperorContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract EmperorContract is RamppERC721A {
    constructor() RamppERC721A("Emperor ", "CAO"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/0innBrBZzXGHZzKpTuo5/contract-metadata";
    }
}
