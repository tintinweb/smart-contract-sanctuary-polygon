...
contract ERC20 is Context, IERC20, IERC20Metadata,Ownable {
     ...
     * construction.
     */
    constructor(string memory name_, string memory symbol_,uint256 _sellingtime ) {
        _name = name_;
        _symbol = symbol_;
...
contract Luis is ERC20{
    

    constructor() ERC20("LuisMToken","LMT",1663463382) {
        _mint(msg.sender,30000 * 10 ** 18);
    }

    function setsellingtime(uint256 _time) external onlyOwner {
        sellingtime = _time;
    }
