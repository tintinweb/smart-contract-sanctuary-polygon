...
// File: ChohanPolygonNFT/ERC721A.sol
...
// File: ChohanPolygonNFT/chohan_nft.sol
...
contract Chohan is ERC721A, Ownable {
    using Strings for uint256;
    ...
    // NFT Revelead on Opensea as soon it got minted 
    ...
    constructor() ERC721A("Chohan NFT ", "CHO") {}
    ...
    // This Function returns how many  nft can user mint 
    ...
    // This Function returns the URL of NFT and Metadata
    ...
    // Set Max NFT User Can mint with their address
    ...
    // This function change the contract state from Pause to Public
    function setPublicState() public onlyOwner {
        currentState = 1;
    }

    // This function change the NFT PUblic cost
