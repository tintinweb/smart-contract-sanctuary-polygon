...
contract mentoraSwap is AccessControl, PriceConsumerMaticDollar, ReentrancyGuard{
    ...
    function MaticToMwp(
        ...
        emit MaticToMwpTransaction(msg.sender,bipsFeeAmount, msg.value, amountSwap, amountOut);
    }
    ...
    function MwpToMatic (
        ...
        emit MwpToMaticTransaction(msg.sender, bipsFeeAmount, _amountSwap, amountOut, netAmountOut);
    }
    function swap(
        address _tokenIn,
        address _tokenOut,
