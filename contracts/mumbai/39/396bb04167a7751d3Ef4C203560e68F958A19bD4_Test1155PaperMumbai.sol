 ...
 * @notice This contract handles minting test 1155 paper mumbai tokens.
 */
contract Test1155PaperMumbai is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xF674364571027C5De96309a58457DfE310E6d112;
    ...
    string public name = "test 1155 paper mumbai";
