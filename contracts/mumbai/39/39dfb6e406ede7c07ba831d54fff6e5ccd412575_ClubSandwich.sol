...
import "./WenSandwich.sol";

// import "hardhat/console.sol";

contract ClubSandwich is ERC721A, ERC721ABurnable, Ownable, ReentrancyGuard {
    bool public isOpen;
    WenSandwich public wenSandwich;
    ...
    string private _baseTokenURI =
        "https://www.wensandwich.xyz/api/clubsandwich/";

    constructor(address _wenSandwichAddress) ERC721A("Club Sandwich", "CS") {
        wenSandwich = WenSandwich(_wenSandwichAddress);
    }
    ...
    function mint(
        ...
        ingredientData[_nextTokenId()] = ingredients;
        uint256 i = 0;

        unchecked {
            do {
                wenSandwich.burn(tokenIds[i]);
