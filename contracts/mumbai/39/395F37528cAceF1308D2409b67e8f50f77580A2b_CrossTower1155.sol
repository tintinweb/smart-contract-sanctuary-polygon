...
contract CrossTower1155 is ERC1155Supply, Ownable, ERC2981 {
    using Strings for uint256;
    uint96 immutable public royaltyFeeNumerator;

    constructor() ERC1155("https://api.coolcatsnft.com/cat/") {
        royaltyFeeNumerator = 500;          // 5% Royalty (Denominator = 10000)
        ...
        onlyOwner
    {
        for(uint i=0; i<ids.length; i++){
            require(totalSupply(ids[i])==0 , "Token Already Minted");
