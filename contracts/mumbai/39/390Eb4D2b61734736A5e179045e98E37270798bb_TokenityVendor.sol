    ...
    Oracle
{
    ...
    function transferReserved(
        ...
        external onlyUser noReentrant returns (bool success)  
    {
        /// @dev get the pair
    ...
    function BuyWithCustomToken(
        ...
        external noReentrant returns (bool success)
    {
...
contract WhiteListTokens is Administered {
    ...
    /// @param _tokenAddress                            Address of the token contract
    /// @return ERC20List                               Documents of the token
