...
contract GuildID is Modifiers, Initializable, ERC721Upgradeable {
...
contract Guild is Modifiers, Initializable {
    /*///////////////////////////////////////////////////////////////
                               ERRORS
    //////////////////////////////////////////////////////////////*/
    ...
    function initialize(Parameters calldata params) public initializer {
        // Guild
        gs.admin = params.admin;
        gs.name = params.name;
        gs.symbol = params.symbol;
        gs.guildTreasury = params.guildTreasury;
        gs.guildToken = params.guildToken;
        gs.rankUpBasePriceXP = params.rankUpBasePriceXP;
        gs.rankMultiplierPercent = params.rankMultiplierPercent;

        // Guild XP
        gs.signer = params.signer;

        // Guild ID
        gs.imageUrl = params.imageUrl;
        gs.minRankForTransfers = params.minRankForTransfers;
        gs.maxRank = params.maxRank;
        gs.mintETH = params.mintETH;
        gs.nameETH = params.nameETH;
        gs.rankETH = params.rankETH;
        gs.avatarETH = params.avatarETH;
        gs.mintGuildToken = params.mintGuildToken;
        gs.nameGuildToken = params.nameGuildToken;
        gs.rankGuildToken = params.rankGuildToken;
        gs.avatarGuildToken = params.avatarGuildToken;

        gs.managers[gs.admin] = true;
        gs.members[gs.admin] = true;
    }
    ...
    //     if (actionID == 0) {
    //         // Mint
    //         ethFee = gs.fees.mintETH;
    //         tokenFixedFee = gs.fees.mintGuildToken;
    //     } else if (actionID == 1) {
    //         // Name
    //         ethFee = gs.fees.nameETH;
    //         tokenFixedFee = gs.fees.nameGuildToken;
    //     } else if (actionID == 2) {
    //         // Rank
    //         ethFee = gs.fees.rankETH;
    //         tokenFixedFee = gs.fees.rankGuildToken;
    //     } else if (actionID == 3) {
    //         // Avatar
    //         ethFee = gs.fees.avatarETH;
    //         tokenFixedFee = gs.fees.avatarGuildToken;
    //     }

    //     if (msg.value != ethFee) revert InvalidETHValue();

    //     if (guildToken != address(0)) {
    //         IERC20(guildToken).transferFrom(user, gs.guildTreasury, tokenFixedFee);
    //     }
    // }
}
