...
contract UpVsDownGameV1 is Ownable {
  ...
  function makeBet(
    ...
    require(msg.value >= etherToWei(pools[poolId].minBetAmount), "Bet amount should be higher than the minimum");
    require(msg.value <= etherToWei(pools[poolId].maxBetAmount), "Bet amount should be lower than the maximum");
    uint256 newTotal;
