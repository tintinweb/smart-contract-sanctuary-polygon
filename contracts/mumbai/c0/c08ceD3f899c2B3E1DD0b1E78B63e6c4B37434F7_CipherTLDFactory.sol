...
import "./CipherTLD.sol";
import "../../interfaces/ICipherForbiddenTlds.sol";

/// @title Cipher Domain Service TLD Factory contract (v2)
/// @author Cipher Labs
/// @notice Factory contract dynamically generates new TLD contracts.
contract CipherTLDFactory is Ownable, ReentrancyGuard {
  using strings for string;

  string public projectName = "Cipher Domain Service";
  ...
  uint256 public royalty = 0; // royalty for Cipher Domain Service when new domain is minted 
  ...
  function _validTldName(string memory _name) view internal {
    ...
    ICipherForbiddenTlds forbidden = ICipherForbiddenTlds(forbiddenTlds);
...
interface ICipherForbiddenTlds {
