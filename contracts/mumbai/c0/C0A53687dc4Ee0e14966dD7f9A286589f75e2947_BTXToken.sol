...
contract BTXToken is ERC20, ERC20Burnable, Pausable, AccessControl, ERC20Permit {
    ...
    function burnUsingRewards(uint256 amount) public {
        _internalBurn(_msgSender(), amount, true);
    }

    function burnUsingRewardsFrom(address account, uint256 amount) public {
        _spendAllowance(account, _msgSender(), amount);
        _internalBurn(account, amount, true);
    }
