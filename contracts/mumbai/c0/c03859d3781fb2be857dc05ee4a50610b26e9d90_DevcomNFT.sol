...
contract DevcomNFT is ERC721, ERC721URIStorage, PullPayment, Ownable {
    using Counters for Counters.Counter;

    uint256 private constant _totalSupply = 1000;
    string private constant _baseTokenURI = "https://devcom-web3-nft.s3.amazonaws.com/json/";
    string private constant _contractURI = "https://devcom-web3-nft.s3.amazonaws.com/contract-metadata.json";
    ...
    function ownerTokens(address _owner) public view returns (uint256[] memory) {
        ...
        while (ownedTokenIndex < ownerTokenCount && currentTokenId <= _totalSupply) {
