    ...
    TunnelEnabled
{
    ...
    address private baseDataFeed;
    address private quoteDataFeed;
    uint8 private priceDataDecimals;
    ...
    constructor(
        ...
        address _baseDataFeed,
        address _quoteDataFeed,
        ...
        )
    {
        ...
        baseDataFeed = _baseDataFeed;
        quoteDataFeed = _quoteDataFeed;
        ...
        returns (int256)
    {
        ...
        ( , int256 basePrice, , , ) = AggregatorV3Interface(baseDataFeed).latestRoundData();
        uint8 baseDecimals = AggregatorV3Interface(baseDataFeed).decimals();
        basePrice = scalePrice(basePrice, baseDecimals, priceDataDecimals);

        ( , int256 quotePrice, , , ) = AggregatorV3Interface(quoteDataFeed).latestRoundData();
        uint8 quoteDecimals = AggregatorV3Interface(quoteDataFeed).decimals();
