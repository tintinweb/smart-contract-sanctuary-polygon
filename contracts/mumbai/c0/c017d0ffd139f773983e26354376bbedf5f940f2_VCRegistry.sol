...
// File: AUth30620/vcUpgraded0622.sol
    ...
    PausableUpgradeable
{
    ...
    function canDecrypt(address user, address /*requestor*/, uint[] memory uuids, bytes memory /*signature*/, bytes[] memory /*args1*/, bytes[] memory /*args2*/) public view returns(bool) {
        
        for (uint i = 0; i < uuids.length; i++) {
                require(
                    ownerOf(uuids[i]) == user,
