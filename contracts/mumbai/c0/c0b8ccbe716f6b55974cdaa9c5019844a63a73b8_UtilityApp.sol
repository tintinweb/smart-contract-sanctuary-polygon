...
contract UtilityApp{
     ...
     */
    function userRegistration(address userAddress,string calldata userName, string memory _RSA_Public_Key) public {
        require(bytes(userName).length>0, "Username cannot be empty!");
        require(msg.sender == userAddress,"Signer is not account owner");
