...
contract Darabase is NFTContract{
    ...
    function buyRentalPrimarySale(
        ...
        doPaymentTransfer(msg.sender, remaining, sellOrder.maker, sellOrder.payment, true, currency);
    ...
    function renewRental(
        ...
        uint remaining = doPlatformPayment(msg.sender, totalPayment, sellOrder.payment, buyerFee + sellerFee);
        doPaymentTransfer(msg.sender, remaining, sellOrder.maker, sellOrder.payment, true, currency);
    ...
    function distributeRevenue(
        ...
        doPaymentTransfer(msg.sender, totalPayment - remainingPayment , ownerPdr, payment, false, currency);
    }
