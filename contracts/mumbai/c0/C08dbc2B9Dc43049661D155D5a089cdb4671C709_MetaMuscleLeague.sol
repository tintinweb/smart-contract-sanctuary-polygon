...
contract MetaMuscleLeague is ERC721Enumerable, Ownable, ReentrancyGuard, PaymentSplitter{
  ...
  uint256 private mintPrice = 1 ether; // TODO: Revert to 130 ether for deploying to mainnet
  ...
  constructor(
    ...
    ) ERC721("MetaMuscle League", "MML") PaymentSplitter(_payees, _shares) payable {
    ...
    returns (uint256, uint256)
  {
    ...
    require(
      _tokenIds.current() + _count <= MAX_PUBLIC_MM,
      "All tokens minted"
    );
    require(
