...
contract Marketplace is Ownable, Pausable, AccessControlEnumerable {
        ...
        internal
    {
        ...
        require(nftRegistry.getApproved(assetId) == address(this) || nftRegistry.isApprovedForAll(assetOwner, address(this)), "UNAUTHORIZED_ASSET");
        ...
        emit OrderCreated(orderId, assetId, assetOwner, nftAddress, price, expiresAt);
    }
    ...
    function _executeOrder(address nftAddress, uint256 assetId, uint256 price) internal returns (Order memory) {
        ...
        require(order.seller == nftRegistry.ownerOf(assetId), "SELLER_NOT_OWNER");
        ...
        emit OrderSuccessful(order.id, assetId, order.seller, sender, nftAddress, price);
    ...
    function _requireERC721(address nftAddress) internal view {
        ...
        IERC721 nftRegistry = IERC721(nftAddress);
        require(nftRegistry.supportsInterface(ERC721_Interface), "INVALID_ERC721_IMPLEMENTATION");
    }
}
