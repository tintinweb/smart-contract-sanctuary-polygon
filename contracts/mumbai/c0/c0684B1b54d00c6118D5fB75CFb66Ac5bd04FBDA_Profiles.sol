    ...
    ERC721EnumerableUpgradeable
{
    ...
    function changeAvatar(string memory _newAvatar) external {
        ...
        emit AvatarChanged(_profile.tokenId, _newAvatar);
    }
    ...
    function setDescription(string memory _newDescription) external {
        ...
        emit DescriptionChanged(_profile.tokenId, _newDescription);
    }
    ...
    function setBio(DataTypes.ProfileBioStruct memory _newBio) external {
        ...
        emit BioChanged(
            _profileIdByUsernameHash[usernameHash],
            _newBio.key,
            _newBio.value
        );
    }
    ...
    function testUpdate(address owner) public pure returns (address) {
        return owner;
    }
