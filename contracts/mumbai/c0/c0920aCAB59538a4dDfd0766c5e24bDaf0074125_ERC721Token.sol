...
contract ERC721Token is ERC721URIStorage, Ownable {
    ...
    function generateImage(uint256 _id) public {
        ...
        require(freeImageGen[msg.sender].count < freeLimit && freeImageGen[msg.sender].nextImgGenTime < block.timestamp,"Free Limit Exceeded");
        require(IERC721(NFT).ownerOf(_id) == msg.sender, "You are not the owner of this NFT");
        require(!isNFTExist[_id], "You can't use this NFT for free chance");
        isNFTExist[_id] = true;
