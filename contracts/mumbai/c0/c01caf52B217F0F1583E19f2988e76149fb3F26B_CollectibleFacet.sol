...
import {Modifiers, ItemBalancesIO} from "../libraries/LibAppStorage.sol";
...
contract CollectibleFacet is Modifiers {
     ...
     */
    function setName(string memory _name) external onlyPlatform {
     ...
     * Only platform can make updates
     */
    function setSymbol(string memory _name) external onlyPlatform {
     ...
     * Only platform can make updates
     */
    function setTokenURI(string memory _name) external onlyPlatform {
     ...
     * Only platform can make updates
     */
    function setMaxSupply(uint256 _supply) external onlyPlatform {
