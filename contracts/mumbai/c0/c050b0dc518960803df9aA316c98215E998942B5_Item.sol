    ...
    ReentrancyGuardUpgradeable
{
    ...
    function mint(
        ...
        metadata[id][msg.sender] = ItemMetadata(price, userId);
    }
    ...
    function mintBatch(
        ...
        for (uint256 index = 0; index < ids.length; index++) {
            metadata[ids[index]][msg.sender] = ItemMetadata(
                prices[index],
                userIds[index]
            );
        }
    ...
    function burn(
        ...
        delete metadata[id][msg.sender].owner;
    }
    ...
    function burnBatch(
        ...
        for (uint256 index = 0; index < ids.length; index++) {
            ...
            delete metadata[ids[index]][msg.sender].owner;
        }
    }
