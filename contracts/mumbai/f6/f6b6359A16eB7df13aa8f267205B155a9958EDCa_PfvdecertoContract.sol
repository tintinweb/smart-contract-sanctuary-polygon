...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0xCC5adAe6cE5B920FE9005eDFFa7BA29935cf2bdA];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://reagffgdg/";
...
// File: contracts/PfvdecertoContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PfvdecertoContract is RamppERC721A {
    constructor() RamppERC721A("pfv de certo", "certu"){}
}
