...
contract ChampionUtils is Base, IChampionUtils {
  ...
  address public rentalKeeperAddress;
  ...
  function setRentalKeeperAddress(address _contract) external onlyRoler("setRentalKeeperAddress") {
    rentalKeeperAddress = _contract;
  }
  ...
  function checkExtRestrictions(
    ...
    if (originalOwner == rentalKeeperAddress) {
