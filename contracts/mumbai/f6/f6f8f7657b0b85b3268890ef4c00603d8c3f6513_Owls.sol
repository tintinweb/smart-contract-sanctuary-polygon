...
contract Owls is ERC721Enumerable, Ownable {
    ...
    mapping(uint256 => string) internal seeds;
    ...
    string lineTwo =
        "\\xDB\\xDB\\xDB\\xDB\\xDB\\xDB __ \\xDB\\xDB\\xDB\\xDB\\xDB\\xDB\\xDB";
    string lineThree = "\\xDB\\xDB\\xDB\\xDB.-'  `.-.\\xDB\\xDB\\xDB\\xDB";
    string lineFour = "\\xDB\\xDB\\xDB(         )\\xDB\\xDB\\xDB";
    string lineFive = "\\xDB\\xDB/      /    \\\\xDB\\xDB";
    string lineSix = "\\xDB\\xDB\\    \\/     /\\xDB\\xDB";
    string lineSeven = "\\xDB\\xDB\\xDB\\(         )\\xDB\\xDB\\xDB";
    string lineEight = "\\xDB\\xDB\\xDB\\xDB\\'-\\___/-'\\xDB\\xDB\\xDB\\xDB";
    string lineNine =
        "\\xDB\\xDB\\xDB\\xDB\\xDB\\xDB\\xDB\\xDB\\xDB\\xDB\\xDB\\xDB\\xDB\\xDB\\xDB\\xDB\\xDB";

    constructor() ERC721("Owls", "HOOT") {
    }
    ...
    function mint(uint32 count) external payable {
        ...
        for (uint32 i; i < count; ) {
            seeds[nextTokenId] = generateSeeds();
    ...
    function generateSeed(
        ...
        uint256[] memory myColors = new uint256[](10);
        if (tokenId % 100 == 0) {
            for (uint256 i = 0; i < 10; i++) {
                uint256 color;
                while (color > 100000) {
                    color = random(tokenId);
                }
                myColors[i] = color;
            }
        } else {
            uint256 color = random(tokenId);
            for (uint256 i = 0; i < 10; i++) {
                myColors[i] = color;
            }
        }
        string memory randomSVG = "";

        return randomSVG;
    }

    function generateSeeds() internal view returns (string memory) {
