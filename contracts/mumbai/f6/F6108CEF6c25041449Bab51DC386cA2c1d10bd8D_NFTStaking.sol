...
contract AmanIsERC20 is ERC20, Ownable {

    mapping(address=>bool) admins;

    constructor() ERC20("Aman Token","AT"){}
    /**
    * @notice The mint function of Aman Token
    **
    * @param _to The account who mint the Token
    * @param _amount The amount is allowed to mint
    */
    ...
    /**
    * @notice Function to add account as admin
    * @param _admin Account who will be admin
    **/
    function addAdmin(address _admin) external onlyOwner {
        admins[_admin] = true;
    }
    /**
    * @notice Function to remove account as admin
    * @param _admin Account be deleted as admin
    **/
...
/// @author Aman-Abbas Dissingar for Alyra
...
contract AmanIsERC721A is ERC721A, ERC721AQueryable,
Ownable, PaymentSplitter {
    ...
    uint public saleStartTime = 1681561023;
    ...
    address[] private _team = [0x9984EEda8713e5733120620028AD6b1967015Bf2];
    uint[] private _teamShare= [100];
    ...
    ERC721A("NFT Aman","NFTa")PaymentSplitter(_team, _teamShare){
    ...
    **/
    function publicMint(address _account, uint _quantity) external payable whenNotPaused {
        ...
        "You can only mint 3 NFT during the public sale");
...
import "./AmanIsERC721A.sol";
import "./AmanIsERC20.sol";
...
contract NFTStaking {
  ...
  constructor(AmanIsERC20 _token, AmanIsERC721A _nft) {
      token = _token;
      nft = _nft;
  }
...
/**
* @notice The Unstake function
* @param owner The account who will unstake
* @param tokenIds Array of tokenId
**/
...
/**
* @notice The internal claim function
* @param owner The account who will claim the rewards
* @param tokenIds Array of the tokenId
* @param _unstake True or False if he wants to unstake
**/
...
/**
* @notice The external claim function
* @param tokenIds Array of tokenId
**/
...
/**
* @notice The unstake function
* @param tokenIds Array of the token Id
**/
...
/**
* @notice The rewards function
* @param owner The account who will get the rewards
* @param tokenIds Array of the token Id
**/
  function getRewardsAmount(address owner, uint[] calldata tokenIds) external view
  returns(uint) {
      uint tokenId;
      uint earned;
      uint totalEarned;
...
/**
* @notice Get the token stake by the token
* @param owner The account to know how he owned
**/
