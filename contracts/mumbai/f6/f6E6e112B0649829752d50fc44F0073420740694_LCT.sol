...
// File: contracts/LuxOn/NewERC721LUXON.sol
...
contract NewERC721LUXON is ERC721A, SuperOperators {
    string private baseURI = "";
    
    constructor(string memory name_, string memory symbol_) ERC721A(name_, symbol_) {}

    mapping(uint256 => uint32) characterInfo;

    function mintLuxOn(address mintUser, uint32 quantity, uint32[] memory characterId) external onlySuperOperator returns (uint256 tokenId) {
    ...
    function getCharacterInfo(uint256 tokenId) public view returns (uint32) {
...
// File: contracts/LuxOn/NewLCT.sol


pragma solidity ^0.8.13;


contract LCT is NewERC721LUXON {
    constructor() NewERC721LUXON("Lux-On Character NFT", "LCT") {}
}