...
contract Dao {
    ...
    constructor(){
        owner = msg.sender;
        nextProposal = 1;
        daoContract = IdaoContract(0x6Bd3259cB608bbBA1EaaD68F3871E162F3407A94);
        validTokens = [15406834649152238974285857835103261578672874772538900556315664249312342179844];
    }
