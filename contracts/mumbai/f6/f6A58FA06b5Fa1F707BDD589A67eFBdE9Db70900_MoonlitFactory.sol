...
contract MoonlitFactory is IMoonlitFactory, Ownable {
  ...
  function createDao(
    ...
    string calldata _blurbIpfsHash,
...
interface IMoonlitFactory {
  function createDao ( string calldata _title, string calldata _blurbIpfsHash, string calldata _textIpfsHash, uint256 _initialMintPrice, uint256 _firstEditionAmount ) external;
