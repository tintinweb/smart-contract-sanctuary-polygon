...
contract BallsContract is ERC20, ReentrancyGuard {
...
contract BallsRewards is ReentrancyGuard, BallsContract {
...
// Transfer the amount of coins to our connected wallet
    function claimRewards(address _wallet, uint _amount) external nonReentrant() returns (bool) { 
