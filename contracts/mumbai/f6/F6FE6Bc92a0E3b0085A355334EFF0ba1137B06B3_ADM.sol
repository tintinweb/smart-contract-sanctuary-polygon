...
contract ADM {
    ...
    function _calLevelNow(address _user) private view returns(uint256) {
        ...
        if(total >= 200e6 && user.teamNum >= 20 && maxTeam >= 4000e6 && otherTeam >= 4000e6){
             levelNow = 5;
        }else if(total >= 200e6 && user.teamNum >= 15 && maxTeam >= 2500e6 && otherTeam >= 2500e6){
             levelNow = 4;
        }else if(total >= 150e6 && user.teamNum >= 0 && maxTeam >= 2000e6 && otherTeam >= 2000e6){
             levelNow = 3;
        }
        else if(total >= 100e6 && user.teamNum >= 5 && maxTeam >= 1000e6 && otherTeam >= 1000e6){
           levelNow = 2;
        }else if(total >= 50e6){
            levelNow = 1;
        }
