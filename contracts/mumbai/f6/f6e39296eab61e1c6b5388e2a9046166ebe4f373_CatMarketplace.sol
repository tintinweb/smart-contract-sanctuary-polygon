...
contract Catcontract is ERC721Enumerable, Ownable {
    ...
    uint256 public breedFee = 100 ether; // Breed
    ...
    constructor(uint256 _maxCatsSupply, uint8 _CREATION_LIMIT_GEN0) ERC721("CuteCat", "CC") {
    ...
    require(msg.value >= breedFee, "Catcontract: in the propagation");
    ...
    //
    function setBreedFee(uint256 _fee) external onlyOwner { 
    breedFee = _fee;
    }
    ...
    function withdrawBreed() external onlyOwner {
...
contract CatMarketplace is ICatMarketplace, Ownable, ReentrancyGuard {
    ...
    _removeOffer(_tokenId);
    //
    uint256 fee = offer.price * feePercentage / 100;
    ...
    require(_feePercentage <= 100, "Market: Invalid percentage");
