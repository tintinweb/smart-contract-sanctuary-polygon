...
contract TimeLockPool is BasePool, ITimeLockPool {
    ...
    function withdraw(uint256 _depositId, address _receiver) external {
        ...
        IUtilityManager(utilityManager).updateClaimedAmount(userDeposit.amount);
        // update unclaimed rewards
        IUtilityManager(utilityManager).updateUnclaimedAmount(userDeposit.amount,0);
...
contract EscrowPool is TimeLockPool {
    ...
    constructor(
        ...
        uint256 _maxLockDuration,
        address _utilityManager
    ) TimeLockPool(_name, _symbol, _depositToken, _rewardToken, _escrowPool, _escrowPortion, _escrowDuration, _maxBonus, _maxLockDuration, _utilityManager) {
