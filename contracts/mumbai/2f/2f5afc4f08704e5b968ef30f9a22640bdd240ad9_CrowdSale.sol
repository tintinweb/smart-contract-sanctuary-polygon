...
abstract contract TimedCrowdsale is Crowdsale {
   ...
   * @param round round has been increase based on the creating a new round
   */
  function _createNewRound(uint256 roundOpeningTime,uint256 roundClosingTime, uint256 roundRate, uint256 round) internal {
...
contract CrowdSale is Crowdsale, FinalizableCrowdsale, UUPSUpgradeable{
    ...
    function newCrowdSaleRound(uint256 roundOpeningTime,uint256 roundClosingTime, uint256 roundRate) virtual external onlyOwner whenNotPaused {
      ...
      _createNewRound(roundOpeningTime, roundClosingTime, roundRate, round);
      _updateFinalization();
    }
