...
contract ContractMaker is Ownable {
    ...
    function getMct(address account) public view returns (bool) {
        return isMaker[account];
    }

    function getSct(address account) public view returns (bool) {
        return isMaker[account];
    }

    function getUct(address account) public view returns (bool) {
        return isMaker[account];
    }

    function getRat(address account) public view returns (bool) {
        return isMaker[account];
    }
    ...
    function setMct(address value) external onlyOwner {
        _mct = value;
    }

    function setSct(address value) external onlyOwner{
        _sct = value;
    }

    function setUct(address value) external onlyOwner{
        _uct = value;
    }

    function setRat(uint256 value) external onlyOwner{
        _rat = value;
    }

    function inContract() public payable {}

    function deContract(address account, uint256 value) external onlyMaker {
