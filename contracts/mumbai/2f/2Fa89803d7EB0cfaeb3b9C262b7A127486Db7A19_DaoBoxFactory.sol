...
contract DaoBoxFactory is APMNamehash, IsContract {
    ...
    function newInstance(
        ...
        VotesForwarder forwarder = VotesForwarder(
            _installApp(dao, VOTES_FORWARDER_APP_ID, initializeVotesForwarderData, false)
        );
...
contract VotesForwarder is IForwarder, AragonApp {
    ...
    // Note that we COMPLETELY trust this Token to not be malicious for proper operation of this contract
    IVotes public token;
