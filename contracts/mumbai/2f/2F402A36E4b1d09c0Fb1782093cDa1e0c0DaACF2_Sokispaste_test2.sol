...
// File: contracts/Sokispaste_test1.sol
...
contract Sokispaste_test2 is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Sokispaste", "SOKIS") {
    setHiddenMetadataUri("ipfs://bafybeid3bbl5lhkfrrqscweyf5b3qu7bzd4nwu433mlhv67pgwzymx4pli/hidden.json");
  }
