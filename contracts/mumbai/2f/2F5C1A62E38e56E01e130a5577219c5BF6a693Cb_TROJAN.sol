...
interface POLYGONTRJMetadata is POLYGONTRJ {
...
contract TaxPool is Ownable {
  ...
  uint256 public rndPercentage = 2000; address public rndWallet = 0xc91b2D8776625DF4ac80B6667213c64fea8DbDcB;
  function setRND (uint256 percent_, address wallet_) public onlyOwner { rndPercentage = percent_; rndWallet = wallet_; }
  
  uint256 public marketingPercentage = 6000; address public marketingWallet = 0x9E5b7B8E007627599F9951aB5f23E1a1B4Fe91bb;
  ...
  uint256 public buybackandburnPercentage = 2000; address public buybackandburnWallet = 0x04f65b709C2a8B6F81b59371BE7aA11B9Cce7360;
  ...
  , POLYGONTRJMetadata
{
  ...
  string private _name = "TROJAN Volera";
  string private _symbol = "TRJ";
  ...
  address ROUTER = 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff; //Polygon Mainnnet
  address FACTORY = 0x5757371414417b8C6CAad45bAeF941aBc7d3Ab32; //Polygon Mainnet
  address WMATIC = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270; //Polygon Mainnet
  ...
  constructor() {
    ...
    _pair = IFactory(_router.factory()).createPair(WMATIC, address(this));
  ...
  function distributeFee () private swapping {
    ...
    if (_balances[address(this)] > 0) {
      ...
      uint256 currentMATICBalance = address(this).balance;
      try _router.swapExactTokensForETHSupportingFeeOnTransferTokens(
        ...
        uint256 amountMATIC = address(this).balance.sub(currentMATICBalance);
        (bool sent, ) = payable(_taxPool).call{value: amountMATIC, gas: 30000}(""); require(sent, "Transfer error.");
