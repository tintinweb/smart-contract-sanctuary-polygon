...
contract eliteStake is Pausable, Ownable {
    ...
    constructor(address _elite, uint256 _APYpercent) {
        eliteToken = _elite;
    ...
    function deposit(uint256 _tokenAmount) external whenNotPaused {
        ...
        IBEP20(eliteToken).transferFrom(_msgSender(), address(this), _tokenAmount);
    ...
    function withdraw(uint256 _stakeID) external whenNotPaused {
        ...
        IBEP20(eliteToken).transfer(_msgSender(),user.amount);
    ...
    function claimReward(uint256 _stakeID) public whenNotPaused {
        ...
        IBEP20(eliteToken).transfer(user.userAddress, reward);
    ...
    function setEliteToken(address _elite) external onlyOwner{
        eliteToken = _elite;
    }
