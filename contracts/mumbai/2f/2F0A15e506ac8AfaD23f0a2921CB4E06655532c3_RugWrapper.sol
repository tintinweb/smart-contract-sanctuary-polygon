...
| $$  | $$|  $$$$$$/|  $$$$$$$      | $$  | $$|  $$$$$$$ /$$$$$$$/|  $$$$$$$|  $$$$$$/|  $$$$$$$ /$$$$$$$/
|__/  |__/ \______/  \____  $$      |__/  |__/ \_______/|_______/  \_______/ \______/  \_______/|_______/ 
                     /$$  \ $$                                                                            
                    |  $$$$$$/                                                                            
                     \______/                                                                                  
**/
...
///////Start of contract/////
contract RugWrapper is ERC721, IERC721Receiver, Pausable, Ownable {
    event Wrapped(uint256 indexed tokenId);
    event Unwrapped(uint256 indexed tokenId);
    address public originalcompanion;
    address public dbcontract;
    address public currentowner; //of rugged contract used to open methods and restrict via address
    address public upgradecontract; //External smart contract to upgrade artwork
    IERC721 immutable companions;
    uint private fee1 = 80000000000000000; // 0.08ETH
    uint private fee2 = 100000000000000000; // 0.10ETH
    uint public numwraps; //total wraps
    bool public feesenabled = true; //On by default
    bool public wrapenabled = true; //On by default
    ...
    constructor(
        ...
        originalcompanion = _originalcompanion;
        companions = IERC721(_originalcompanion);
