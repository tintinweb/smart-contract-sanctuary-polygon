...
/// @custom:security-contact [email protected], from openzepplein wizard
contract OrganizationGovernor is Initializable, 
    GovernorUpgradeable, 
    ...
    function initialize(IVotesUpgradeable _token, 
        ...
        uint256 _quorumPercentage, /* 10 for 10 percent */
        uint256 _votingPeriod, /*50 for 50 block */
        uint256 _votingDelay /*1 for 1 block */ ) initializer public
    {
        __Governor_init("MyGovernor");
        __GovernorSettings_init(_votingDelay /* 1 block */, _votingPeriod /* 50 block */, 0);
