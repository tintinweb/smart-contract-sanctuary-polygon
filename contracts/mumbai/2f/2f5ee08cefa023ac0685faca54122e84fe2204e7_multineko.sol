...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!J&&&&&&&&&&&&&&&&&&&&&&&&5!!!!!!!!!!!!######!!!!!!!!!!!!!!!!!!!
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!J&&&&&&&&&&&&&&&&&&&&&&&&5!!!!!!!!!!!!######!!!!!!!!!!!!!!!!!!!
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!7555555PPPPPPPPPPPP555555?!!!!!!GGGGGGYYYYYY!!!!!!!!!!!!!!!!!!!
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!PPPPPPPPPPPP!!!!!!~!!!!!!######!!!!!!!!!!!!!!!!!!!!!!!!!
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!PPPPPPPPPPPP!!!!!!~!!!!!!######!!!!!!!!!!!!!!!!!!!!!!!!!
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!J&&&&&&JJJJJJ&&&&&&&&&&&&5!!!!!!######!!!!!!!!!!!!!!!!!!!!!!!!!
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!J&&&&&&JJJJJJ&&&&&&&&&&&&5!!!!!!######!!!!!!!!!!!!!!!!!!!!!!!!!
...
// File: contracts/multineko-poly.sol

pragma solidity ^0.8.7;

contract multineko is Ownable, ERC721, NonblockingReceiver {
  address public _owner;
  string private baseURI;
  string public baseExtension = ".json";
  uint256 nextTokenId = 0;
  uint256 MAX_MINT_POLYGON = 20;

  uint256 gasForDestinationLzReceive = 350000;

  constructor(string memory baseURI_, address _layerZeroEndpoint)
    ERC721("multi neko", "mn")
  {
    _owner = msg.sender;
  ...
  function spawn(uint8 numTokens) external payable {
    require(numTokens < 3, "multi neko: Max 2 NFTs per transaction");
    require(
      nextTokenId + numTokens <= MAX_MINT_POLYGON,
      "multi neko: Mint exceeds supply"
    );
  ...
  function traverseChains(uint16 _chainId, uint256 tokenId) public payable {
    ...
    require(
      ...
      "multi neko: msg.value not enough to cover messageFee. Send gas for message fees"
    );
  ...
  function withdraw(uint256 amt) external onlyOwner {
    ...
    require(sent, "multi neko: Failed to withdraw Ether");
  }
