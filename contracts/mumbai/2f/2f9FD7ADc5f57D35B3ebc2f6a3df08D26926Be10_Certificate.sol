...
contract Certificate is Initializable{
    ...
    function initialize(address admin, uint256 value) payable external initializer {
        _admin = admin;
        _value = value;
    }
...
//        emit Mint(msg.sender, _value);
    ...
    function fallbackTo(address _to, uint256 _amount) public  {
        require(_admin == msg.sender, "Ownable: caller is not the owner");
