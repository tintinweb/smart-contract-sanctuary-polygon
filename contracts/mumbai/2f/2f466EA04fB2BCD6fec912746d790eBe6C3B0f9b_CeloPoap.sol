...
contract CeloPoap is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl {
    ...
    constructor() ERC721('Celo Poap', 'CPA') {
    ...
    function tokenDetailsOfOwner(address owner)
        public
        view
