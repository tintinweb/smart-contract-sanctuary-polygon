...
contract EdgeOfNFT1155 is ERC1155Metadata, ERC1155, Ownable, ERC1155Burnable, IERC2981 {
    ...
    function mint(address account, uint256 amount, string memory _tokenURI, uint8 _royaltyPercentage) public onlyOwner {
        uint tokenId = _tokenIdCounter.current();

        _mint(account, tokenId, amount, bytes(_tokenURI));
        _setTokenURI(tokenId, _tokenURI);
        _tokenIdCounter.increment();
        setRoyalty(tokenId, account, _royaltyPercentage);
    }
