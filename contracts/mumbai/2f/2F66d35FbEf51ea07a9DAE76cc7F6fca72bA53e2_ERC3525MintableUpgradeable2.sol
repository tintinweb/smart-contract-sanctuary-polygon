...
contract ERC3525MintableUpgradeable2 is Initializable, ContextUpgradeable, ERC3525Upgradeable {
    ...
    function changefromNormalToSpecial(
        ...
        require(slot_ == 1, "slot ID is different");
        require(ownerOf(tokenId_) == msg.sender, "this is not yours");
        _burn(tokenId_);
        mint(mintTo_, mintTokenNum, 3, value_/10);
        mintTokenNum++;
    }
