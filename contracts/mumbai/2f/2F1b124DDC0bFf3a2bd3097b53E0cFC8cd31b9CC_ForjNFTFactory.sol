...
contract ForjNFTFactory{
    ERC1155Minter private template;

    event Created(address addr);

    constructor(){
        template = new ERC1155Minter();
    }
    ...
    function cloneNewNFT(
        ...
        ERC1155Minter(clone).initialise(_multisig,_owner, _baseURI, _name, _symbol);
        emit Created(clone);
    }
...
contract ERC1155Minter is ERC1155, ReentrancyGuard{
