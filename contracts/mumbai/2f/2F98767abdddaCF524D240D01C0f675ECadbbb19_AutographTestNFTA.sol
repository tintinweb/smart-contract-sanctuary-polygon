...

{
    ...
    */
        ...
        payable
    {
        ...
        _mint(address(this), recipients.length);
    ...
    (
        ...
        virtual
    {
        // require(hasRole(MINTER_ROLE, _msgSender()), "Autograph NFT: must have minter role to set token uri");
        ...
        returns (string memory)
    {
        require(
            _exists(tokenId),
            "AutographNFT: URI query for nonexistent token"
        );
    ...
    */
    ...
    (
        ...
        view
        virtual
        override(ERC721AUpgradeable) returns (bool)
