...
contract BlkaPool is Ownable, Pausable {
    ...
    /**
     * @notice Harvest pending BLKA tokens from MasterChef
     */
    function harvest() internal {
        uint256 pendingBlka = masterchef.pendingBlka(cakePoolPID, address(this));
        if (pendingBlka > 0) {
    ...
    function calculateTotalPendingCakeRewards() public view returns (uint256) {
        uint256 amount = masterchef.pendingBlka(cakePoolPID, address(this));
        return amount;
    }
