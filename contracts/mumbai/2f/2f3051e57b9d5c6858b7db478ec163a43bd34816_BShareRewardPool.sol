...
// File: github/BasedFinance/based-finance-contracts/contracts/distribution/BShareRewardPool.sol
...
contract BShareRewardPool is ReentrancyGuard {
    ...
    uint256 public bSharePerSecond = 0.001585 ether; // 50000 bshare / (365 days * 24h * 60min * 60s)
