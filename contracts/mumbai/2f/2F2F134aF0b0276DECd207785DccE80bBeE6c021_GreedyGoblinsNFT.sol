...
contract GreedyGoblinsNFT is Ownable,ERC721Checkpointable,GreedyGoblinsLottery {
    ...
    function LotteryWinner(uint lottery) public returns (address payable) {
       require(lotteryHistory[lottery]!=0x0000000000000000000000000000000000000000,"Winner have invalid address");
    ...
    uint256 brNft=balanceOf(msg.sender);
     require(brNft+numberOfTokens<=10,"Maximum amount of Nft-s per account is 10");
     if(winner==msg.sender ){
         require(numberOfTokens==1,"You can mint 1 NFT for free");
     ...
     else if((_allowList[msg.sender]!=0)){
