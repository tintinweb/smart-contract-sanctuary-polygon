...
/********************************************************************************************
Smart contract generated on NFTOOL: https://www.nftool.io

NFTOOL is a one-stop platform for generating, deploying and minting NFT collections, with multi-chain support, easy deployment and management of custom contracts, and 100% revenue retention

NFTOOL is not associated or affiliated with this oroiect.
NFTOOL isnotliable for any bugs or minting issues associated with this contract.
/*********************************************************************************************/
...
contract NFTOOL is ERC721, Ownable, ERC2981 {
    ...
    address[] public withdrawAddresses = [0xcFD876425cc13285b461eB1581DDFbc4f96D5C46];
    uint256[] public withdrawPercentages = [100];


    bytes32 public merkleRoot = 0;

    constructor() ERC721("cccccccccccc", "cccccccc") {
        _baseTokenURI = "https://test-api.nftool.io/generator-server/api/contract/v1/4blCmyHsp1bqA8wE1/1613005987157106689/metadata/";
        _setDefaultRoyalty(0xcFD876425cc13285b461eB1581DDFbc4f96D5C46, uint96(0));
    }
