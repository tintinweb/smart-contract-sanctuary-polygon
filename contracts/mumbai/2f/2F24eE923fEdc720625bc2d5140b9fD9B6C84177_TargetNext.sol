...
contract TargetNext is IXReceiver, Ownable {
    ...
    event Borrow(address _token, address _user, uint256 _amount, uint8 chainID);
    event Repay(address _token, address _user, uint256 _amount, uint8 chainID);
