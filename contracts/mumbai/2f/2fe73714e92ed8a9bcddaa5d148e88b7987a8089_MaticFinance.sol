...
contract MaticFinance {
	...
	function getContractInfo() public view returns(uint256 tStake, uint256 tReinvest, uint256 tReferral, uint256 cBalance) {
		return( totalStaked, totalReinvest, totalRefBonus, getContractBalance() );
	}
