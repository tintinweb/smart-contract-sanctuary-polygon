...
import "./OwnConstructArtNFT721.sol";
...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new ConstructArtUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        ConstructArtUser721Token token = ConstructArtUser721Token(address(addr));
...
contract ConstructArtUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
