...
contract RandomNumber is VRFConsumerBaseV2, ConfirmedOwner {
    ...
    // The ID of the VRF subscription.
    ...
    // Corresponds to a particular oracle job which uses that key for generating the VRF proof.
    ...
    constructor(uint64 subscriptionId) VRFConsumerBaseV2(0x7a1BaC17Ccc5b313516C5E16fb24f7659aA5ebed) ConfirmedOwner(msg.sender){
