...
contract RandomWinnerGame is Ownable, VRFConsumerBase {
    ...
    // ID of public key against which randomess is generated
    ...
    event GameStarted(uint256 gameId, uint256 maxPlayer, uint256 entryFee);
     ...
     */
    function startGame(uint256 _maxPlayer, uint256 _entryFee) public onlyOwner {
        require(!gameStarted, "Game already started");
        delete players; // empty player array
        maxPlayer = _maxPlayer;
        entryFee = _entryFee;
        gameStarted = true;
        gameId += 1;
        emit GameStarted(gameId, _maxPlayer, _entryFee);
    }
    ...
    function joinGame() public payable {
        require(gameStarted, "Game not start yet!");
        require(msg.value == entryFee, "Not match entry fee");
        require(players.length < maxPlayer, "Maximum number of players");
