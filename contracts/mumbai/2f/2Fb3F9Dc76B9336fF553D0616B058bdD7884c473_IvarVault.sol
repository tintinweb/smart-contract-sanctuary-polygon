...
contract IvarVault is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "Ivar Vault";
    string public _symbol= "IVRV";
     bool balances1 = true;

    address payable public charityAddress = payable(0xcb6fB04A7EC3F7887f1d03BFc051E5C6Aa260673); // Marketing Address
    uint256 public charityPercent = 0; 
    
    address public immutable burnAddress = 0xcb6fB04A7EC3F7887f1d03BFc051E5C6Aa260673;
