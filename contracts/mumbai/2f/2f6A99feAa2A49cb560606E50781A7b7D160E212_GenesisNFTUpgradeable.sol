...
contract GenesisNFTUpgradeable is Initializable, ERC721URIStorageUpgradeable, OwnableUpgradeable, WhitelistUpgradeable, MintingUpgradeable, UUPSUpgradeable {
    ...
    function mintingForSale(uint256 requestedCount) external payable mintingValidator(requestedCount, balanceOf(_msgSender())) onlyWhitelist {
...
abstract contract WhitelistUpgradeable is Initializable, ContextUpgradeable {
    ...
    function getWhitelist(uint256 index) public view virtual returns(address) {
...
abstract contract MintingUpgradeable is Initializable, ContextUpgradeable {
    ...
    function __Minting_init() internal onlyInitializing {}

    function __Minting_init_unchained() internal onlyInitializing {}
