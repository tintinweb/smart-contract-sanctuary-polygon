...
contract NovelCollection is Ownable, IERC721, ERC721Enumerable, ERC2981, BaseRelayRecipient, ContextMixin, NativeMetaTransaction {
    ...
    constructor(
        ...
        // URI for collection metadata (ex: https://novel.com/metadata/x102129)
    ...
    function whitelistedClaimIdForAddress(
        ...
        returns (bool)
    {
        return whitelistedAddressToClaimIdUsed[customerAddress][claimId];
    }
