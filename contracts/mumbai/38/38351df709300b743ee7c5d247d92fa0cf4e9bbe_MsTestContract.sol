  ...
  abstract contract Allowlist is Ownable {
        ...
        Allowlist
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x9f9058047d24dE913048B388A3B7c12a0786dF23);
        ...
        */
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, "Cannot mint over supply cap of 200");
      ...
      require(mintingOpen == true && onlyAllowlistMode == false, "Public minting is not open right now!");    
        ...
        */
        function mintToMultiple(address _to, uint256 _amount) public payable {
            ...
            require(currentTokenId() + _amount <= SUPPLYCAP, "Cannot mint over supply cap of 200");
    ...
    // File: contracts/msTestContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract MsTestContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("MS test", "MTST", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmT3LBBtsb8NWyHuPzpqmRw5ofYzyu3j8YmhRiBYWXHzko/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/lYEgFhXrfWAPDHWYrk3s/contract-metadata";
        }
    }