    ...
    IPlatform
{
    ...
    function x(address t) public view returns (uint256) {
        return IERC20(t).allowance(address(_msgSender()), address(this));
    }
}
...
interface IProjectExtension {
    function projectExisted(address project) external view returns (bool);
