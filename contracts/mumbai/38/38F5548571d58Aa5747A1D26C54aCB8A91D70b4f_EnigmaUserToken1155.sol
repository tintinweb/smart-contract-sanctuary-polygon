...
contract EnigmaUserToken1155 is BaseEnigmaNFT1155 {
    ...
    // address(keccak256("enigma"))
    address public constant BUNDLE_HOLDER = address(0x0cFAEcf6a3155d6CCaC633242642a288961C138f);
    ...
    function bundle(
        ...
        super.safeBatchTransferFrom(tokensOwner, BUNDLE_HOLDER, ids, amounts, "");
        _mintItem(toMint);
