...
contract CapsuleFactory {
    ...
    function createStorage(string memory _name, string memory _symbol) public {
        address clone = Clones.clone(implementation);
        UMC(clone).initialize(_name, _symbol);
...
contract UMC is Initializable, ERC721Upgradeable, ERC721URIStorageUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
