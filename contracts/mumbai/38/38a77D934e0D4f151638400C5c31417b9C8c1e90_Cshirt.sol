...
contract Cshirt is ERC721A, ERC721AQueryable, ReentrancyGuard, Ownable {
    ...
    mapping(address => uint) public userWhitelistCount;
    ...
    address payable public _safe =
        payable(0xBA94eCd0BfBdC22D11Ec10405f5b66fe6Ec93F47);
     ...
     * @param – _newPrice: count of max nft per  wallet in whitelist
     */
     ...
     * @param _signature: signed signature to validate
     */
    function mintWaitlist(bytes calldata _signature, uint256 _amount)
        ...
        nonReentrant
    {
        require(_max_nft >= _amount, "exceed amount");
        require(MintStage.ALLOWLIST != _stage, "waitlist not active");
        ...
        require(userWhitelistCount[msg.sender] + _amount <= _max_nft, "max purchase reached");
        userWhitelistCount[msg.sender] += _amount;
    ...
    function mint(uint256 _amount)
        ...
        nonReentrant
    {
        require(MintStage.WAITLIST != _stage, "sale not active");
        _mint(msg.sender, _amount);
    }
