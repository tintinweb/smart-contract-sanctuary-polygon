 ...
 */
contract WETHTokenPaymasterrrr is BasePaymaster {
    event feesPayed(uint256 _value, address _smartWallet);
    ...
    function _postOp(
        ...
        uint256 fees = actualGasCost + (COST_OF_POST * gasPrice);
        emit feesPayed(fees, sender);
    }
}