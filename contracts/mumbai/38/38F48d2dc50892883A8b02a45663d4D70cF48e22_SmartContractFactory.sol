...
contract SmartContractFactory {
    ...
    ERC721WhitelistCommitReveal private erc721WhitelistCommitRevealTemplate;

    event Created(address addr);

    constructor(){
        collectionNFTTemplate = new CollectionNFT();
        erc721WhitelistCommitRevealTemplate = new ERC721WhitelistCommitReveal();
    }
    ...
    function createERC721WhitelistCommitRevealNFT(
        address _multisig,
        address _owner,
        string memory _baseURI,
        string memory _name,
        ...
        address payable clone = createClone(address(erc721WhitelistCommitRevealTemplate));
        ERC721WhitelistCommitReveal(clone).initialise(_multisig,_owner, _baseURI, _name, _symbol, _fees, _maxSupply, _limitPerAddress, starts, ends, merkleRoots);
        emit Created(clone);
    }
