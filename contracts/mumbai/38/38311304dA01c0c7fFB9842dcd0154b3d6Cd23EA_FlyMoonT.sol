...
contract FlyMoonT is ERC721, Ownable {
    using SafeMath for uint256;
 
    uint256 public immutable pricePer;
    uint256 public immutable maxPerTx;
    uint256 public immutable maxFlyMoon;
    ...
    function reserveMotor() public onlyOwner {   
     ...
     function mintFlyMoon(uint256 numberOfTokens) public payable {
        require(isSaleActive, "Sale is not active");
        require(numberOfTokens <= maxPerTx, "No more than 100 tokens per transaction");
        require(totalSupply().add(numberOfTokens) <= maxFlyMoon, "Purchase would exceed max supply of FlyMoon");
