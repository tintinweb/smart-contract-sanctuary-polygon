...
contract GeniosClub is IGeniosClub {
  ...
  mapping(uint8 => uint256) public RankReqTotalTeam;
  ...
  constructor(
    ...
    RankReqTotalTeam[1] = 10;
    RankReqTotalTeam[2] = 40;
    RankReqTotalTeam[3] = 40;
    RankReqTotalTeam[4] = 640;
    RankReqTotalTeam[5] = 2560;
    RankReqTotalTeam[6] = 10240;
    RankReqTotalTeam[7] = 40960;
    RankReqTotalTeam[8] = 163840;
  ...
  function updateG3X7Referrer(
    ...
    if (
      ...
      Users[refAddr].G3X7Matrix[level].FirstLevelRefs.length < 3
    ) {
