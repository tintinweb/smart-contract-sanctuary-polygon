...
contract ChainBattles is ERC721URIStorage  {
    ...
    function randMod(uint number) private view returns (uint) {
    ...
    function mint() public {
        ...
        //uint level = randMod(newItemId);
        //uint speed = randMod(level);
        //uint strength = randMod(speed);
        //uint life = randMod(strength);
