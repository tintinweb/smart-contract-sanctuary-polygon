...
contract ChainBattles is ERC721URIStorage  {
    ...
    constructor() ERC721 ("Space Battle", "SPBT"){
    }
    ...
    function generateCharacter(uint256 tokenId) public view returns (string memory) {
        bytes memory svg = abi.encodePacked(
            ...
            "<text x='50%' y='30%' class='base' dominant-baseline='middle' text-anchor='middle'>Alien X</text>",
    ...
    function getName(uint256 tokenId) public view returns(string memory) {
        string memory names = tokenIdToTrack[tokenId].name;
        return names;
    }
    ...
    function mint(string memory _name) public {
        ...
        tokenIdToTrack[newItemId] = Track(_name, 0, 0, 0, 0);
    ...
    function train(uint256 tokenId) public {
        ...
        tokenIdToTrack[tokenId].level = currentLevel + random(5);

        uint256 currentSpeed = tokenIdToTrack[tokenId].speed;
        tokenIdToTrack[tokenId].speed = currentSpeed + random(5);

        uint256 currentStrength = tokenIdToTrack[tokenId].strength;
        tokenIdToTrack[tokenId].strength = currentStrength + random(10);

        uint256 currentLife = tokenIdToTrack[tokenId].life;
        tokenIdToTrack[tokenId].life = currentLife + random(20);
