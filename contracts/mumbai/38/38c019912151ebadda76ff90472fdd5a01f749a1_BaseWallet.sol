...
contract BaseWallet is IBaseWallet {
    ...
    */
    ...
    function setOwner(address sender, address new_owner) public onlyOwner(sender) {
        owner = new_owner;
    }

    function _transfer(address sender, address _receiver, uint _value) public onlyOwner(sender) {
