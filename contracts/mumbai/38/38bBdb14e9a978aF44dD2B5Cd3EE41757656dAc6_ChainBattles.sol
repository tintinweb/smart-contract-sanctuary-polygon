...
contract ChainBattles is ERC721URIStorage {
    ...
    mapping (uint256 => Nummbbeer) public tokenIdToPower;
    ...
    function getLevel(uint256 tokenId) public view returns (string memory) {
        Nummbbeer memory data = tokenIdToPower[tokenId];
    ...
    function mint() public {
        ...
        Nummbbeer memory nummbbeer = Nummbbeer(0, createRandom(1), createRandom(2), createRandom(3));

        tokenIdToPower[newItemId] = nummbbeer;
    ...
    function train(uint256 tokenId) public {
        ...
        Nummbbeer memory currentPower = tokenIdToPower[tokenId];
        uint256 currentLevel = currentPower.Level;
        currentPower.Level = currentLevel + 1;
        tokenIdToPower[tokenId] = currentPower;
