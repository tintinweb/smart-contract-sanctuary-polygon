...
contract Portrait is ERC1155, IERC2981, Ownable, Pausable, ContextMixin {
    ...
    function contractURI() public pure returns (string memory) {
        return "ipfs://bafkreiai6dwnsboznvstdz57nmbom2rncompud5r5lgmmvdjfuoimigyjq"; // Contract-level metadata for PORTRAIT
    }
}
...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    constructor(string memory uri_) {
        ...
        _uriBase = "ipfs://bafybeibmaiwf3bgr6ncayzsla4d2noiyv3nn2mkbobxt4cumzfjmpwi7xi"; // IPFS base for Portrait collection
