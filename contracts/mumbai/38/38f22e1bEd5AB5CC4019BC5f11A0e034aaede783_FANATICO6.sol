...
contract FANATICO6 is ERC20, ERC20Burnable, ERC20FlashMint, AccessControl, ReentrancyGuard {
    constructor(
        string memory _name,
    ...
    uint public constant DAILY_REWARDS = 1 * 10 ** 18; // 1 token max per day (same as signup bonus)
    ...
    function signupBonus(address account) public onlyRole(REWARDS_MANAGER_ROLE) nonReentrant {
        ...
        emit SignupBonusClaimed(account, DAILY_REWARDS);
    }
