...
contract myNft is ERC721Upgradeable,OwnableUpgradeable {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        return "htts://baidu.com";
    }

    function getStr() public view onlyOwner returns (string memory) {
        return "onlyOwner";
    }

    function getStr1() public view onlyOwner returns (string memory) {
        return unicode"新 合约的 onlyOwnekkk";
    }
