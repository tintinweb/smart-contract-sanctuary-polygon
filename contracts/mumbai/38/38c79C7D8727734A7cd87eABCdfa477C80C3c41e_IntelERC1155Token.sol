...
contract IntelERC1155Token is IERC2981, ERC165Storage, Ownable, IERC1155MetadataURI, ERC1155, MinterRole {
    ...
    */
    ...
    /**
     * @dev external function to set the Merkle Proof Mode.
     * @param _flag merkle proof flag
     */
    function setMerkleProofMode(bool _flag) external {
        isMerkleProof = _flag;
    }
