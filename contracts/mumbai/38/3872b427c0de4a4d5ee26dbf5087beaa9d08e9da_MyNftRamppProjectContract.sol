...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xE2612978Ddc3F3ffdCAFcD462d8A435b7BaE3e65];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 2001, 5000 ) {}
...
contract MyNftRamppProjectContract is RamppERC721A {
    constructor() RamppERC721A("My NFT Rampp Project", "TEST"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/IgCjp0fqNGsNRgVCqO3E/contract-metadata";
    }
}