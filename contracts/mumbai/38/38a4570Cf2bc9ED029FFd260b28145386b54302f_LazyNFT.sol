...
contract LazyNFT is AccessControl, ERC721 {
    ...
    address public admin = 0x30268390218B20226FC101cD5651A51b12C07470;//0x30268390218B20226FC101cD5651A51b12C07470
    address public mortgagecontroller;

    constructor(
        address _market,
        address _mortgagecontroller,
        uint256 _maxsupply,
    ...
    function nftValuation() public view returns (uint256 _nftValuation){
        return valuation / maxsupply;
    }

    function getValuation() public view returns (uint256 _valuation){
        return valuation;
    }
