    ...
    DefaultOperatorFiltererUpgradeable
{
    ...
    function setPrimaryMintPrice(uint256 _primaryMintPrice) public onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    */
    function mintToCaller(
        ...
        //     setRoyalties(tokenId, payable(royaltiesAddress), uint96(royaltiesBasisPoints));
