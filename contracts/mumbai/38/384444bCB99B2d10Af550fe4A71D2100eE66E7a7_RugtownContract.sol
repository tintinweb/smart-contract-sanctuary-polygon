...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1681491600;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x8FC9a65aDf1998DC17a8509377D26E0BaF9f45C6];
  address public erc20Payable = 0x8FC9a65aDf1998DC17a8509377D26E0BaF9f45C6;
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 444) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeig7uzgpun2snasrfeln4idpjaulznsvk4h3mtl2di77u75dua37vq/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/ukR8mm1ThxlKzkDKqsOh/contract-metadata";
  }
...
// File: contracts/RugtownContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract RugtownContract is ERC721APlus {
    constructor() ERC721APlus("RUGTOWN", "RUGTOWN"){}
}
