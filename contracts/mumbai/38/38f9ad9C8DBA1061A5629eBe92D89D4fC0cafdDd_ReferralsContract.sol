...
contract ReferralsContract is Owner, ReentrancyGuard {
    ...
    constructor(address _rewardToken) {
        ...
        setPercentageTreeForReward2(0, 900);  // 900 = 9%
        setPercentageTreeForReward2(1, 600);  // 600 = 6%
        setPercentageTreeForReward2(2, 500);  // 500 = 5%
        setPercentageTreeForReward2(3, 400);  // 400 = 4%
        setPercentageTreeForReward2(4, 300);  // 300 = 3%
        setPercentageTreeForReward2(5, 200);  // 200 = 2%
        setPercentageTreeForReward2(6, 100);  // 100 = 1%
    }
