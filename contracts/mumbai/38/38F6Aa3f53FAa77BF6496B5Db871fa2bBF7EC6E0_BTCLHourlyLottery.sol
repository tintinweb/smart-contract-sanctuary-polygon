...
contract BTCLHourlyLottery is AutomationCompatible, AutomatedRandomness, ReentrancyGuard {
    ...
    // uint256 private ticketPrice = 5 ether;   // 5 MATIC x 1 ticket price
    // uint256 private ticketFee   = 0.5 ether; // 0.5 MATIC ticket fee
    ...
    uint256 public minutesUntilDraw  = 10;     // 10 in minutes
    ...
    AutomatedRandomness(
        ...
        // Set the end date of the first round to 1 hour
        rounds[round].status.endDate =  BTCLCore.addMinutes(block.timestamp, minutesUntilDraw);
    }

    /* ============ External Functions ============ */
    /**
     * @dev Function that allows players to purchase 1 ticket in a 500$ Prize Game
     * Max 100 players or 1h has passed and there are atleast 10 unique tickets
