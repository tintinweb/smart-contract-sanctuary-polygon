...
contract CustomTimeLockUpgradeable is
    Initializable,
    OwnableUpgradeable,
    UUPSUpgradeable,
    TimelockControllerUpgradeable
{
    address public membershipToken; // NFT Contract address
    ...
    function initialize(
        ...
        uint8 _membershipBalance
    ) public initializer {
        require(
            _membershipToken != address(0) && _membershipToken != address(this),
            "Invaild Membership Token Address"
        );
        __TimelockController_init(minDelay, new address[](0), executors, admin);
        __Ownable_init();
        __UUPSUpgradeable_init();
        membershipToken = _membershipToken;
        membershipBalance = _membershipBalance;
    }
    ...
    function schedule(
        ...
        bytes32 salt,
        uint256 delay
    ) public virtual override onlyMember {
    ...
    function _isMember(address _user) internal virtual returns (bool) {
        return IERC721(membershipToken).balanceOf(_user) > membershipBalance;
    }
