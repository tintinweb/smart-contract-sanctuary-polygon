...
contract ChainBattles is ERC721URIStorage  {
    ...
    function mint() public {
        ...
        tokenIdToAttributes[newItemId].level = random(100, "level");
        tokenIdToAttributes[newItemId].speed = random(100, "speed");
        tokenIdToAttributes[newItemId].strength = random(100, "strength");
        tokenIdToAttributes[newItemId].life = random(100, "life");
    ...
    function random(uint cappedNumber, string memory attribute) public view returns(uint){
        return uint(keccak256(abi.encodePacked(block.timestamp, block.difficulty, attribute))) % cappedNumber;
    }
