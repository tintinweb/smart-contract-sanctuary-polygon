...
contract Exar721 is Initializable, ERC721Upgradeable, ERC721BurnableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    */
    ...
    function initialize(string memory _metadata, uint256 _maxTokenLimit) initializer public {
        metadataUri = _metadata;
        cap = _maxTokenLimit;
        totalLimit = 0;
        contracturi = "https://ipfs.io/ipfs/QmUekmQdD9stUSswQ3Y8H14YXkQUtvBU5BKXHGVG7FJcB3";
        __ERC721_init("Exar Ice Age", "EXAR_ICE");
    ...
    */
    function mint(address _to, uint256 _tokenId, string memory _tokenUri) public onlyAdmin {
        if (totalLimit > cap) { revert CapExceeded(); }
    ...
    */
    ...
    function tokenURI (uint256 _id) public view virtual override returns (string memory) {
        ...
        return  string(abi.encodePacked(metadataUri, holdUri[_id]));
    }
