...
contract RewardProtocol is OwnableUpgradeable {
    ...
    function createVestingSchedule(
        ...
        if(vestingCountByBeneficiary == 0){
            ...
            bytes32 VestingScheduleID = _createVestingSchedule(_beneficiary, vestingDuration, _tokenId, _nftContract, _trackId, _trackRewardsRate, vestingAmount);
            ...
            if(getCurrentTime() > vestingSchedule.start + vestingSchedule.duration){
                ...
                bytes32 newVestingScheduleID = _createVestingSchedule(_beneficiary, vestingDuration, _tokenId, _nftContract, _trackId, _trackRewardsRate, vestingAmount);
