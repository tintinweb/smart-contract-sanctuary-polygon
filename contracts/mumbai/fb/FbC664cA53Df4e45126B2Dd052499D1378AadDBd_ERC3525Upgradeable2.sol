...
contract ERC3525Upgradeable2 is Initializable, ContextUpgradeable, IERC3525Metadata, IERC721Enumerable {
    ...
    function approve(uint256 tokenId_, address to_, uint256 value_) public payable virtual override {
        address owner = ERC3525Upgradeable2.ownerOf(tokenId_);
        require(to_ != owner, "ERC3525: approval to current owner");

        require(
            _msgSender() == owner || ERC3525Upgradeable2.isApprovedForAll(owner, _msgSender()),
    ...
    function transferFrom(
        ...
        _mint(to_, newTokenId, ERC3525Upgradeable2.slotOf(fromTokenId_), 0);
    ...
    function tokenByIndex(uint256 index_) public view virtual override returns (uint256) {
        require(index_ < ERC3525Upgradeable2.totalSupply(), "ERC3525: global index out of bounds");
    ...
    function tokenOfOwnerByIndex(address owner_, uint256 index_) public view virtual override returns (uint256) {
        require(index_ < ERC3525Upgradeable2.balanceOf(owner_), "ERC3525: owner index out of bounds");
    ...
    function _isApprovedOrOwner(address operator_, uint256 tokenId_) internal view virtual returns (bool) {
        ...
        return (
            operator_ == owner ||
            ERC3525Upgradeable2.isApprovedForAll(owner, operator_) ||
            ERC3525Upgradeable2.getApproved(tokenId_) == operator_
        );
    }

    function _spendAllowance(address operator_, uint256 tokenId_, uint256 value_) internal virtual {
        uint256 currentAllowance = ERC3525Upgradeable2.allowance(tokenId_, operator_);
    ...
    function _mintValue(uint256 tokenId_, uint256 value_) internal virtual {
        ...
        address owner = ERC3525Upgradeable2.ownerOf(tokenId_);
        uint256 slot = ERC3525Upgradeable2.slotOf(tokenId_);
    ...
    function _approve(address to_, uint256 tokenId_) internal virtual {
        ...
        emit Approval(ERC3525Upgradeable2.ownerOf(tokenId_), to_, tokenId_);
    }
    ...
    function _transferTokenId(
        ...
        require(ERC3525Upgradeable2.ownerOf(tokenId_) == from_, "ERC3525: transfer from invalid owner");
        require(to_ != address(0), "ERC3525: transfer to the zero address");

        uint256 slot = ERC3525Upgradeable2.slotOf(tokenId_);
        uint256 value = ERC3525Upgradeable2.balanceOf(tokenId_);
    ...
    function _checkOnERC3525Received( 
        ...
        address to = ERC3525Upgradeable2.ownerOf(toTokenId_);
    ...
    function _createDefaultTokenId() private view returns (uint256) {
        return ERC3525Upgradeable2.totalSupply() + 1;
    }
