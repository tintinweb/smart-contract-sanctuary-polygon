...
contract ValueInterpreter {
    ...
    function addPrimitives3(
        address[] calldata _primitives,
        address[] calldata _aggregators,
        RateAsset[] calldata _rateAssets
    ) external onlyOwner {
        __addPrimitives3(_primitives, _aggregators, _rateAssets);
    }
    function addPrimitives4(
        address[] calldata _primitives,
        address[] calldata _aggregators,
        RateAsset[] calldata _rateAssets
    ) external onlyOwner {
        __addPrimitives4(_primitives, _aggregators, _rateAssets);
    }
    function addPrimitives5(
        address[] calldata _primitives,
        address[] calldata _aggregators,
        RateAsset[] calldata _rateAssets
    ) external onlyOwner {
        __addPrimitives5(_primitives, _aggregators, _rateAssets);
    }
    function addPrimitives6(
        address[] calldata _primitives,
        address[] calldata _aggregators,
        RateAsset[] calldata _rateAssets
    ) external onlyOwner {
        __addPrimitives6(_primitives, _aggregators, _rateAssets);
    }
    function addPrimitives7(
        address[] calldata _primitives,
        address[] calldata _aggregators,
        RateAsset[] calldata _rateAssets
    ) external onlyOwner {
        __addPrimitives7(_primitives, _aggregators, _rateAssets);
    }
    function addPrimitives8(
        address[] calldata _primitives,
        address[] calldata _aggregators,
        RateAsset[] calldata _rateAssets
    ) external onlyOwner {
        __addPrimitives8(_primitives, _aggregators, _rateAssets);
    }
    function addPrimitives9(
        address[] calldata _primitives,
        address[] calldata _aggregators,
        RateAsset[] calldata _rateAssets
    ) external onlyOwner {
        __addPrimitives9(_primitives, _aggregators, _rateAssets);
    }
    function addPrimitives10(
        address[] calldata _primitives,
        address[] calldata _aggregators,
        RateAsset[] calldata _rateAssets
    ) external onlyOwner {
        __addPrimitives10(_primitives, _aggregators, _rateAssets);
    }
