...
contract LinearVesting is ReentrancyGuard {
     ...
     */
    constructor(IERC20 _token, uint256 _start, uint256 _end, uint256 _cliffDurationInSecs, uint256 _tgedistributionPercentage, address _ownerAddress)  {
...
contract IVOVestingFactory {
    ...
    function createVestingContract(IERC20 _tokenAddress, uint256 _start, uint256 _end, uint256 _cliffTime, uint256 _tgedistributionPercentage, address _ownerAddress) public returns(address) {
        LinearVesting vesting = new LinearVesting(_tokenAddress, _start, _end, _cliffTime, _tgedistributionPercentage, _ownerAddress);
