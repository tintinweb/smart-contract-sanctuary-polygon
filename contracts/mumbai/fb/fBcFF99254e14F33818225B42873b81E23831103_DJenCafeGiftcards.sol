 ...
 * @notice This contract handles minting dJen Cafe giftcards tokens.
 */
contract DJenCafeGiftcards is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xA3Be3E3102C86020e594EE0dDFB30b7c49f191AE;
    address public royaltyAddress = 0x94e8FFF2A92Ed17ecAa10C8E2DA7DdfA3bc0461D;
    address[] public payoutAddresses = [
        0x94e8FFF2A92Ed17ecAa10C8E2DA7DdfA3bc0461D
    ];
    ...
    string public name = "dJen Cafe giftcards";
    string public symbol = "DJEN";
    ...
    constructor()
        ERC1155(
            "ipfs://bafybeiaurxqpl3mwsnbejapd3fygbc4zydupecx5tdur37gtloonaovcsy/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenPublicMintsPerAddress[1] = 50;
