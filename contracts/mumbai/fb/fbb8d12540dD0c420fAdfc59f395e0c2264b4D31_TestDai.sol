...
contract TestDai is ERC20("Dai stablecoin","Dai"){
    ...
    constructor(){
        ...
        _mint(0x70997970C51812dc3A010C7d01b50e0d17dc79C8,10 ether);
    ...
    function permitUsingVRS(
        ...
        bytes32 hash = keccak256(abi.encodePacked("\x19\x01", DOMAIN_SEPARATOR, structHash));
        // console.logBytes32(hash);
        address signer = tryRecover(hash, v, r, s);
        // console.logAddress(owner);
        require(signer == owner, "ERC20Permit: invalid signature");
    ...
    function recover(
        ...
        if (signature.length == 65) {
            ...
            console.log("1 here");
            return address(0);//"tryRecover(hash, v, r, s)";
    ...
    // function Domain_Seperator() external view override returns (bytes32) {
