...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x4DE23f3f0Fb3318287378AdbdE030cf61714b2f3];
...
// File: contracts/AmlbotContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract AmlbotContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/rkr2dlOEiEiLfWWDi6vn/contract-metadata";
  }
