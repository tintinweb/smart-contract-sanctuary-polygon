...
contract YoloswapGovernor is Governor, GovernorSettings, GovernorCountingSimple, GovernorVotesComp, GovernorTimelockControl {
    constructor(ERC20VotesComp _token, TimelockController _timelock)
    Governor("YoloswapGovernor")
//    GovernorSettings(1 /* 1 block */, 201600 /* 1 week */, 2500000e18)
    GovernorSettings(1 /* 1 block */, 100 /* 1 week */, 2500000e18)
