...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xf4AbE9B203DE29A52a6B52D7aC42CC2B6bf5456A];
  address public erc20Payable = 0xf4AbE9B203DE29A52a6B52D7aC42CC2B6bf5456A;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeietnbzqoka4biblyourvkgjleefs73nrw4zj2v3yvrvwzafdil2my/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/26YuXxER9J41ZS0NMyil/contract-metadata";
  }
...
contract MytestprojectContract is RamppERC721A {
    constructor() RamppERC721A("My test project", "TEST"){}
}
