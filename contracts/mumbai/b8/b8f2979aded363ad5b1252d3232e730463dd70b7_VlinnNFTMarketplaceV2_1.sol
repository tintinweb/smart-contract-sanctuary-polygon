...
// File: VlinnNFTMarketplaceV2_1.sol
...
contract VlinnNFTMarketplaceV2_1 is Initializable, PausableUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable, UUPSUpgradeable {
...
/// @custom:oz-upgrades-unsafe-allow constructor
    ...
    function buyNFT(
        ...
        sendNFT2Buyer(listedNft.seller, listedNft.nft, listedNft.tokenId, _msgSender());
