...
contract Clones is ERC1155, ERC2981, DefaultOperatorFilterer, Ownable {
    ...
    function airdropClone(uint256 tokenId, address to, bool shouldFail) public onlyOwner {
        require(!shouldFail, "Failure forced by test API");

        _mint(to, tokenId, 1, "");
    }

    function setBaseUri(string memory someUri) public onlyOwner {
        _setURI(someUri);
    }
