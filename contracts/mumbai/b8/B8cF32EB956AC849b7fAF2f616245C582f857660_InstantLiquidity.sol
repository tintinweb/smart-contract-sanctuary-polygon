...
interface PassiveIncomeNFT {
    ...
    function locks(uint256 piTokenId) external returns (Lock memory lock);
...
interface IFactory is IVoucher {
    ...
    function whitelistForBuyUnminted(address buyer) external view returns(bool);
}
