...
contract MintableToken is StandardToken, Whitelist {
     ...
     */
    function finishMinting() public onlyWhitelisted canMint returns (bool) {
...
contract RainToken is MintableToken {
    struct Stats {
        uint256 txs;
        uint256 minted;
    }

    string public constant name = "Rain Token";
    ...
    uint8 internal constant taxDefault = 10; // 10% tax on transfers
     ...
     */
    constructor(uint256 _initialMint) public Ownable() {
    ...
    function transferFrom(
        ...
        (uint256 adjustedValue, uint256 taxAmount) = calculateTransferTaxes(
            _from,
            _value
        );
