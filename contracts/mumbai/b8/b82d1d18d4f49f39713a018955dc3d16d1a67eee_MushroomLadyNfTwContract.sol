...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 50, 9996 ) {}
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 9996");
        _safeMint(_to, 1);
    }
...
// File: contracts/MushroomLadyNfTwContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MushroomLadyNfTwContract is RamppERC721A {
    constructor() RamppERC721A("Mushroom Lady NFTw", "MLNFT"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/90QJgl9WBxNdZgH5Vluw/contract-metadata";
    }
}
