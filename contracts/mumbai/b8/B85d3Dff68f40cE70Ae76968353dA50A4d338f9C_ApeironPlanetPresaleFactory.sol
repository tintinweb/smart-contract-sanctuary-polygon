...
//Do safe-math still need? https://blog.soliditylang.org/2020/12/16/solidity-v0.8.0-release-announcement/
...
contract ApeironPlanetPresaleFactory is MultiWhitelist {
    ...
    constructor(
        ...
        // PRICES
        prices[NFTType.Elemental] = _prices[0];
        prices[NFTType.Mythic] = _prices[1];
        prices[NFTType.Arcane] = _prices[2];
        prices[NFTType.Divine] = _prices[3];
        prices[NFTType.Primal] = _prices[4];

        //3188-4585
        typeCounter[NFTType.Elemental] = 3188;
        typeMax[NFTType.Elemental] = 4585;

        //1133-3187
        typeCounter[NFTType.Mythic] = 1133;
        typeMax[NFTType.Mythic] = 3187;

        //387-1132
        typeCounter[NFTType.Arcane] = 387;
        typeMax[NFTType.Arcane] = 1132;

        //14-386
        typeCounter[NFTType.Divine] = 14;
        typeMax[NFTType.Divine] = 386;

        //0-13
        typeCounter[NFTType.Primal] = 0;
        typeMax[NFTType.Primal] = 13;
    }
        ...
        onlyWhitelisted
    {
        ...
        planetContract.safeMint(0, msg.sender, nftId);
