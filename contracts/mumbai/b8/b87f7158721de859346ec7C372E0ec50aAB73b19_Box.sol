...
*/
contract Box is ERC721A, Ownable, ERC721ABurnable, ERC721AQueryable {
    ...
    function crossChain(address to, uint256 quantity) external onlyOwner {
        _mintToQuantity(to, quantity);
    }

    function _mintToQuantity(address to, uint256 quantity) internal {
