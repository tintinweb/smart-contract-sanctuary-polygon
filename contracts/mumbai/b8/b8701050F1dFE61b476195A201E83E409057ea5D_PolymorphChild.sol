...
contract PolymorphChild is IPolymorphChild, PolymorphWithGeneChanger {
    ...
    function setMaticAddress(address _maticAddress) public onlyDAO {
        addressMaticWETH = _maticAddress;
    }
        ...
        nonReentrant
    {
        ...
        IERC20 maticWETH = IERC20(addressMaticWETH);
