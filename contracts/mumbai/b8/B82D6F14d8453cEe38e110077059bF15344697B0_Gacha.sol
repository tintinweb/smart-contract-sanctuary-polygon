...
contract Demo {
    ...
    function getData(address _address) public {
        IVRFConsumerBase(_address).getRandomNumber();
    }

    function getData1(address _address) external view returns(uint256) {
        return IVRFConsumerBase(_address).randomResult();
    }
}
