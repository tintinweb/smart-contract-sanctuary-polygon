...
/**
 * @title AtomicPrediction
 */
contract AtomicPrediction is Ownable, Pausable, ReentrancyGuard {
    ...
    IERC20 public token; // IERC20 token address
     ...
     * @param _token: Input token required to participate
     */
    constructor(
     ...
     */
    function betBear(uint256 epoch, uint256 amount, address referrer)
        external
        whenNotPaused
        nonReentrant
        notContract
     ...
     * @param referrer: referrer address
     */
    function betBull(uint256 epoch, uint256 amount, address referrer)
        external
        whenNotPaused
        nonReentrant
        notContract
