...
contract ChainBattles is ERC721URIStorage {
    ...
    // One example can be, value.toString(). An uint256 can be easily converted into a string. How convenient.
    // 类似于JavaScript中的包装类，字符串按理说是没有length的，你要获取时会创建一个包装类，获取到以后该包装类消失
