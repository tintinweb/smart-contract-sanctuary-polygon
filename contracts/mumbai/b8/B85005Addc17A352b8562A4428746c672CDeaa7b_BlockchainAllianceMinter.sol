...
import "./IMRC721.sol";
import "./IBlockchainAlliance.sol";
import "@openzeppelin/contracts/access/Ownable.sol";
import "@openzeppelin/contracts/token/ERC20/IERC20.sol";
import "@openzeppelin/contracts/utils/cryptography/ECDSA.sol";

contract BlockchainAllianceMinter is Ownable {
    using ECDSA for bytes32;

    uint256 public unitPrice = 0.35 ether;
    uint256 public startTime = 1662760800;

    address public signer = 0x9077624D6C5B78163b069799D03eeA053f788501;

    mapping(address => bool) wl;

    mapping(address => uint256) public usersMinted;
    IBlockchainAlliance public nftContract =
        IBlockchainAlliance(0x0850fC4aACf91A31048BAE43d10240Dd7ffDF4B8);

    constructor() // address nftContractAddress,
    // address _signer
    {
        // nftContract = IBlockchainAlliance(nftContractAddress);
        // signer = _signer;
        wl[0x541C2F5607d194266e587CC48bde58ffdDF897Ba] = true;
        wl[msg.sender] = true;
        wl[0x7E9e166eEC3AFFe3BD2b1175849f73D6Eb53bAfE] = true;
    }
    ...
    function mint(
        ...
        require(block.timestamp >= startTime || wl[_to], "not started");
    ...
    function updateNftContrcat(
        IBlockchainAlliance _newAddress
    ) public onlyOwner {
        nftContract = IBlockchainAlliance(_newAddress);
    }
