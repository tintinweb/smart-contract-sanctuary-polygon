...
contract NgageNFactory is AccessControl, ERC2771Context {
  ...
  CustomForwarder public factoryForwarder;
  ...
  function createFactory(
    ...
    admn.grantRole(CREATOR, _assetCreator);
   ...
   */
  function setNewForwarder(address _forwarder) public onlyAdmin {
    factoryForwarder = CustomForwarder(_forwarder);
  }
}
