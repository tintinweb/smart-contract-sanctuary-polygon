...
// File: tests/ERC721_WhiteListMint.sol
 ...
 *****************************************************************************************/
 function mint(address _to, uint256 _tID, uint256 _eID) external override allowedMinter {
   require(_tID <= nextTID, "ERC721TokenID: Token ID is above the maxiumum allowed for specified mints");
   super._mint(_to, _tID);
   EID[_tID] = _eID;
 }
