 ...
 */
contract ERC20SwappableInput is ERC20, ERC20Detailed, Ownable {
    using SafeMath for uint256;
    ...
    function swap(address outputToken, address payee, uint256 inputAmount) external returns (bool) {
        ...
        uint256 outputAmount = inputAmount.mul(10 ** uint256(ERC20Detailed(address(outputContract)).decimals())).div(10 ** uint256(decimals())).mul(999900).div(1000000);
...
/**
 * @title TestSwapMain
 * @dev Version 1 of the ERC20 token contract for TestSwapMain.
 */
contract TestSwapMain is ERC20, ERC20Detailed, ERC20Upgradable, ERC20Mintable, ERC20Burnable, ERC20SwappableInput, ERC20SwappableOutput {
    using SafeMath for uint256;

    /**
     * @dev After the token is constructed, test balances will be initialized for swap testing.
     */
    constructor () public ERC20Detailed("TestSwapMain", "TSMA", 0) { }
}