    ...
    OwnableUpgradeable
{
    ...
    mapping(uint256 => NftType) public nftTypeStatus;
    ...
    function safeMint(
        ...
        nftTypeStatus[tokenId] = _nftTypeStatus;
    ...
    function getNftTypeStatus(uint256 _tokenId) public view returns (NftType) {
