...
contract MyToken is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    ...
    constructor() ERC20("MyToken", "MTK") ERC20Permit("MyToken") {
        feeEnabled = false;
        feeWallet = address(0); // Endereço inicial para receber a taxa (desativada)
        feePercentage = 10; // Taxa de 10% por padrão
    }
    ...
    // As funções a seguir são overrides necessários pelo Solidity.
