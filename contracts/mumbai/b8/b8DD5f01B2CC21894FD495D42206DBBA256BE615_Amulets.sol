...
contract Amulets is ERC721Upgradeable, ERC721EnumerableUpgradeable, PausableUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    */
    ...
    // 2 = White List
    // 3 = Open Mint
    function updateDetails(uint256 amuletCost, uint256 max, uint256 _openMint, string calldata _amuletsBaseURI) public onlyAdmins {
    ...
    * @dev 3 = Open Mint
    */
    function mintAmulet() internal whenNotPaused nonReentrant {
