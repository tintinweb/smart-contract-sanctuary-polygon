...
contract TangibleRentShare is AccessControl {
        ...
        returns (RevenueShare)
    {
        ...
        if (address(_contractForToken[token].revenueShare) == address(0)) {
            ...
            revenueShare.grantRole(CLAIMER_ROLE, address(this));
            revenueShare.grantRole(DEPOSITOR_ROLE, address(this));
            revenueShare.grantRole(SHARE_MANAGER_ROLE, address(this));
