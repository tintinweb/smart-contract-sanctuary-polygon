...
contract GentleDoggiesSerum is Ownable, ERC721, NonblockingReceiver {
    ...
    constructor(string memory baseURI_, address _layerZeroEndpoint) ERC721("GentleDoggiesSerum", "GDS") { 
        _owner = msg.sender;
    ...
    //     require(numTokens < 5, "GDS: Max 2 NFTs per transaction");
    //     require(nextTokenId + numTokens <= MAX_MINT_ARBITRUM, "GDS: Mint exceeds supply");
    ...
    function crossChain(uint16 _chainId, uint tokenId, uint _destination) public payable {
        ...
        require(msg.value >= messageFee, "GDS: msg.value not enough to cover messageFee. Send gas for message fees");
    ...
    function withdraw(uint amt) external onlyOwner {
        ...
        require(sent, "GDS: Failed to withdraw Ether");
    }
