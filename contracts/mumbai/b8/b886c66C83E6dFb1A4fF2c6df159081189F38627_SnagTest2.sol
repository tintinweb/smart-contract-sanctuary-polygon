 ...
 * @notice This contract handles minting snag test 2 tokens.
 */
contract SnagTest2 is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xA99cde2B085f9BfB253ee2609DC77134fbB760FE;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x7d70c37FeA96103419e2A5f82548086b50bA3726;
    address[] public payoutAddresses = [
        0x7d70c37FeA96103419e2A5f82548086b50bA3726
    ];
    ...
    string public name = "snag test 2";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeifgzaidr7jturr5aga6tadfemazrnymdeuonigkdwx6y3b6m7efse/{id}"
        )
        RevokableOperatorFilterer(
