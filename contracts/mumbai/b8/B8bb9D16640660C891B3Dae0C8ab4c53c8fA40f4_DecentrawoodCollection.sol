...
contract DecentrawoodCollection is Ownable,ERC721URIStorage{
  ...
  constructor() ERC721("Decentrawood Collection", "DEOD_STORE") {}



    function createNFT(uint256 tokenID,string memory tokenURI) public returns(uint256){
        
        require(!nftExists[tokenID],"Decentrawood Store #mintNFT : TokenId already exists");
