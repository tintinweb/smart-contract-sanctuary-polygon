...
// File: contracts/Rush1155RoyaltyChildToken.sol
...
contract Rush1155RoyaltyChildToken is Rush1155RoyaltyToken {
    ...
    constructor(string memory uri_, address childChainManager) Rush1155RoyaltyToken(uri_) {
        _setupRole(DEPOSITOR_ROLE, childChainManager);
    }

    // Polygon mint-able related functions
    function deposit(address user, bytes calldata depositData) external onlyRole(DEPOSITOR_ROLE) {
        ...
        require(
            user != address(0),
            "Rush1155ChildToken: INVALID_DEPOSIT_USER"
        );
