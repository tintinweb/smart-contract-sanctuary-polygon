...
contract ArtGrailAuction is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    event BidPlaced(address indexed nftAddress, uint256 indexed tokenId, address indexed bidder, uint256 bid, address owner);

    event BidWithdrawn(address indexed nftAddress, uint256 indexed tokenId, address indexed bidder, uint256 bid, address owner);

    event BidRefunded(address indexed bidder, uint256 bid);

    event AuctionResulted(address indexed nftAddress, uint256 indexed tokenId, address indexed winner, uint256 winningBid, address owner);

    event AuctionCancelled(address indexed nftAddress, uint256 indexed tokenId, address indexed owner);
    ...
    function placeBid(address _nftAddress, uint256 _tokenId) external payable nonReentrant whenNotPaused {
        ...
        emit BidPlaced(_nftAddress, _tokenId, _msgSender(), bidAmount, auction.owner);
    }
    ...
    function withdrawBid(address _nftAddress, uint256 _tokenId) external nonReentrant whenNotPaused {
        ...
        emit BidWithdrawn(_nftAddress, _tokenId, _msgSender(), previousBid, auction.owner);
    }
    ...
    function resultAuction(address _nftAddress, uint256 _tokenId) external nonReentrant {
        ...
        emit AuctionResulted(_nftAddress, _tokenId, winner, winningBid, auction.owner);
    }
    ...
    function cancelAuction(address _nftAddress, uint256 _tokenId) external nonReentrant {
        ...
        emit AuctionCancelled(_nftAddress, _tokenId, auction.owner);
