...
contract AgoraCollection is ERC721, Ownable {
    ...
    function drop(address targetAddress,uint256 quantity) external {
        require(msg.sender == owner() || msg.sender == _dropperAddress, "not allowed");
        require(totalSupply + quantity <= MAX_SUPPLY, "supply limit reached");
