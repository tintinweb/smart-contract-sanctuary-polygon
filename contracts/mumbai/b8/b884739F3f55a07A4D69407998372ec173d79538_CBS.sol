...
contract CBS is ERC1400 {
     ...
     */
    function upgradeFeeAddr(address _feeAddr1,  address _feeAddr2) public onlyOwner {
        feeAddr1 = _feeAddr1;
        feeAddr2 = _feeAddr2;
    }
    ...
    function _transferByPartition(
        ...
        uint256 feeAmount1 = value.mul(100).div(10000); // 1%
        uint256 feeAmount2 = value.mul(25).div(10000); // 0.25%
