...
contract Activity is AccessControl{
    ...
    AtomNFT public nft;
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    address private _feeAddress = 0xA38f69a8177BF32c65234BA340101e9441A5BEFa;
    ...
    constructor() {
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _grantRole(MINTER_ROLE, msg.sender);
        soltDetail = SoltDetail("Fragment","Mining machine fragment",1,1*10**6,100*10**6,10,10);
    }
