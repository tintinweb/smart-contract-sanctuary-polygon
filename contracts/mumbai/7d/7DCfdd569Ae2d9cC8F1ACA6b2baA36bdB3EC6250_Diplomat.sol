...
contract Diplomat is ERC1155, ERC1155Supply, Ownable {
    ...
    mapping(uint256 => address) public _itemAllowedMinter;
    mapping(address => uint256[]) public _diplomatsPerMinter;
    ...
    function createDiplomat(string memory _uri, address _minter) external onlyOwner {
        ++_idCounter;
        uint256 _id = _idCounter;
        _itemAllowedMinter[_id] = _minter;
        _urls[_id] = _uri;
        ...
        external
    {
        ...
        require(_itemAllowedMinter[id] == msg.sender, "You are not allow");
