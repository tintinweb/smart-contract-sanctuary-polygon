...
contract Flamemonk is ERC721, Ownable {
    ...
    address private constant CreatorAddress = 0x55b6B99f5388C6bFaA1089f2698A46A54d98d0e9;
    ...
    constructor(string memory _baseURIextended) ERC721("FlameMonk", "FLM"){
