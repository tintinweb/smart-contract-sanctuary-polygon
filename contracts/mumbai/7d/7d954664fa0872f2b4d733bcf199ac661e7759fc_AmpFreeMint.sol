...
//SPDX-License-Identifier: MIT V32
 ...
 * the owner.
 */
abstract contract Ownable is Context,ReentrancyGuard {
     ...
     */
    function _transferOwnership(address newOwner) internal nonReentrant virtual {
...
// File: contracts/AmpFreeMint.sol
...
contract AmpFreeMint is ERC1155, ERC2981, ReentrancyGuard {
    ...
    address  private royalityOwner;

    //uint256 public lillupPrice = 1 ether; //Define the Visibility of lillup Price 
    uint256 public lillupRoyality;
    ...
    constructor() ERC1155("Apm Token") {
        // set royalty of all NFTs to 2,5%
        // owner = payable(msg.sender);
        owner = payable(msg.sender);
        royalityOwner = 0x6ABc0b7386618B3A450e1A3f740F33e98220ab88;
    ...
    _tokenIds.increment();
    //id increment 
    require(totalAmp <= 999, "Over 1000 AMP minted");
    //require (msg.value == _amount * lillupPrice, "Please Enter Correct Price");
    uint256 newTokenId = _tokenIds.current();
    
    idToAmp[newTokenId].id = _tokenIds.current();
    ...
    idToAmp[newTokenId].graphUri = _graphUri;
    ...
    */
        ...
        onlyLearner
    {
        ...
        //Calculation of Royality 
        uint256 calRoyality = price / lillupRoyality;
        uint256 afterRoyality = price - calRoyality;
        ...
        if (whitelist[_msgSender()] == true) {
            ...
            payable(creator).transfer(afterRoyality);
            payable(royalityOwner).transfer(calRoyality);
 
            getBalance[creator] += afterRoyality;
            getBalance[royalityOwner] += calRoyality;
