...
contract AccountsEscrow is Initializable, OwnableUpgradeable {
    ...
    function addToBalance(uint256 _amount, address _account) public {
        ...
        // require(et.approve(address(this), _amount), "token transfer not approved");
...
contract EngageToken is ERC20, AccessControlEnumerable {
    ...
    // Multichain V7ERC20 _mint override compat
    function _mint(address to, uint256 amount) internal virtual override(ERC20) {
        require(((this.totalSupply() + amount) <= MAX_SUPPLY), "can not exceed max supply");
    ...
    // Multichain V7ERC20 _burn override compat
    function _burn(address from, uint256 amount) internal virtual override {
        require(((this.totalSupply() - amount) >= MIN_SUPPLY), "can not exceed max supply");
