...
contract Collection_70f56ddc_cf9c_40a2_a1ff_0ce0293a6665 is ERC721A, Ownable,  ContextMixin, ReentrancyGuard{
  uint256 public constant maxSupply = 20;
  uint public _price = 10 ether;
  uint256 public maxBuyPerTx = 1;
  bool public paused;
  string public _metaURI = "https://ipfs.moralis.io:2053/ipfs/Qmdu2bHPythyhUySHHUNmK7EKW73deJzA1GV8Da6vTGu7V/collection/70f56ddc-cf9c-40a2-a1ff-0ce0293a6665.json";
  // Metadata URI
  string private _baseTokenURI = "https://ipfs.moralis.io:2053/ipfs/QmW5G18q1SWDkhr4YvQJXvUWxY6t9aGNLDaCpq5fxppnVS/metadata/";


  constructor() ERC721A("Test new Collection", "test-new-collection-95") {
    paused = true;
  }
  // Read the price
