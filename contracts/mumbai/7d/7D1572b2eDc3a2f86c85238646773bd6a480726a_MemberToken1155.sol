...
contract MemberToken1155 is Ownable, ERC1155Pausable, ERC1155Burnable {

    string public name = "MetaverSyndicate Member Tokens";
    string public symbol = "MSMT";

    string public contractUri = "https://jsonkeeper.com/b/TL3Y";
