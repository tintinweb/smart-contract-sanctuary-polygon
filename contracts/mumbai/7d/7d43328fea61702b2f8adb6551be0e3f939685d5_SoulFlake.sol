...
contract SoulFlake is ERC721, ERC721Enumerable, AccessControl, Ownable {
  ...
  string public style ="<style>.bodyText{font-size: 20px;font-weight: 400;font-family: 'Fredoka';line-height: 30px;text-align: left; color:#FFFFFF}</style>";
  ...
  function mint(
    ...
    require(price <= msg.value); // base price to cover for receiver burn + optional gift
    ...
    returns (string memory)
  {
    ...
    string memory json = Base64.encode(
      abi.encodePacked(
        ...
        '"},{"trait_type": "Type","value":"SBT"}],"image":"data:image/svg+xml;base64,',
        svgData,
        '"}'
      )
    );
