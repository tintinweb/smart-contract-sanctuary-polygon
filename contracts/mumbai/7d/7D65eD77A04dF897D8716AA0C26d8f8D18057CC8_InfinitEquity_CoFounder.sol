...
contract InfinitEquity_CoFounder is ERC721, ERC721Enumerable, ReentrancyGuard, Ownable, AccessControl {
	...
	/*
	// Not needed - getter value available by default
	...
	*/
	...
	function _lockedBurn(uint _tokenID) internal {
  	...
  	// Withdraw Ether
	// Those are safe-functions if any ether or tokens accidentally gets stuck in this contract, which should not happen in the first place
	/*
    function withdrawEther() public onlyRole(ALLOWED_ROLE) {
