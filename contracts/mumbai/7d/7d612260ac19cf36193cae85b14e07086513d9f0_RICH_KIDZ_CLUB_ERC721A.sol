...
contract RICH_KIDZ_CLUB_ERC721A is ERC721AUpgradeableOwnable, I_RICH_KIDZ_CLUB {
    ...
    function initialize() external initializer {
        ...
        _unrevealedBaseURI = "ipfs://bafybeieno4eu4avapi2ugbxgvjzpfhgph4f2ove4cjpwltseckilsluxmq/unrevealed/";
    }
    ...
    function mint(
        ...
        if (phase != Phase.PUBLIC)
            _addMintedToAux(msg.sender, phase, uint64(amount));
