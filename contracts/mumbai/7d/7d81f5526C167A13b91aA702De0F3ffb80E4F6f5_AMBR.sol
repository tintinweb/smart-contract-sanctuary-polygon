...
import "./metafab/System.sol";
import "./metafab/ERC2771Context_Upgradeable.sol";

contract AMBR is ERC20, ERC20Burnable, Pausable, AccessControl, System,  ERC2771Context_Upgradeable{
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    constructor(address _forwarder, bytes32 _systemId) ERC20("AMBR", "AMBR") ERC2771Context_Upgradeable(_forwarder) System(_systemId){
    ...
    function upgradeTrustedForwarder(address _newTrustedForwarder) external onlyRole(AccessControl.DEFAULT_ADMIN_ROLE) {
