...
contract PlatformFee_Covest is Initializable, UUPSUpgradeable, ReentrancyGuardUpgradeable {
	...
	function withdraw(
		...
		require(PDS.isBlacklistUser(_to) != true, "Policy: The destination is Blacklist.");
		require(PDS.isBlacklistAssetsUser(_to, _asset) != true, "Policy: The Assets of destination is Blacklist.");
		valueOfPF[_asset] -= _value;
	 ...
	 */
	function balanceOfPlatformFee(address _asset) public view returns (uint256) {
