...
function onERC721Received(
  ...
  // Require NFT from correct contract and correct NFT ID
  require(from == nftContract && tokenId == nftID, "Waffle: Invalid NFT received.");

  // Toggle contract NFT ownership
  nftOwned = true;

  // Return the required ERC721 interface function signature
