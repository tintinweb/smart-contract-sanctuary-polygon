...
contract OneJungleStaking is Ownable {
      ...
      event Stake(address staker, uint256 tokenId, uint256 lockTime);
    ...
    constructor(){
      stakingNft = IERC721(0x36620E3e85b5c02618d212D96d9F4EE378BB21A7);
    ...
    function _stake(uint256 tokenId) internal isApproved(tokenId) {
      ...
      emit Stake(_msgSender() , tokenId, lockTime);
    }
