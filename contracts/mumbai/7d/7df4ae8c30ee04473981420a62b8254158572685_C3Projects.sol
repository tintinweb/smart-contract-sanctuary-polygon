    ...
    Common
{
    ...
    function getProjectsId() public view virtual returns (string[] memory) {
        return projectsId;
    }
    ...
    **/
    function addProject(
        ...
        bool isUpdating = projectData[projectKey].period_start != 0;
        ...
        projectData[projectKey].uri = uri;
    ...
    function setBannedVintageProject(string memory _projectKey, uint256 _vintage , bool _enable) external onlySupervisor {
        ...
        string memory vintageKey = string(abi.encodePacked(_projectKey, "-", Strings.toString(_vintage)));
