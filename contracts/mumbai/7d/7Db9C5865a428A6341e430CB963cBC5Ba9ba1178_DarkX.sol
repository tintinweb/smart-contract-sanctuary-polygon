...
contract DividendDistributor is IDividendDistributor {
    ...
    address routerAddress = 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff; //Quickswap router
    IERC20 RewardToken = IERC20(0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889); //WETH testnet
...
contract DarkX is IERC20, Auth {
    using SafeMath for uint256;

    string constant _name = "DarkX";
    string constant _symbol = "DarkX";
    ...
    address RewardToken = 0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889; //WETH

    uint256 _totalSupply = 21 * 10**6 * (9**_decimals);
    uint256 public _maxTxAmount = 1 * 10**6 * (9**_decimals);
    uint256 public _walletMax = 2 * 10**6 * (9**_decimals);
    ...
    uint256 public swapThreshold = 1 * 10**3 * (9**_decimals);
    ...
    constructor() Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x1bf94AcE856a08c4d011F5Fdcd8E3951d51C63B9;
        marketingWallet = 0x1bf94AcE856a08c4d011F5Fdcd8E3951d51C63B9;
        devWallet = 0x1bf94AcE856a08c4d011F5Fdcd8E3951d51C63B9;
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 marketingShare = amountETHMarketing.mul(3).div(4);
        ...
        (bool tmpSuccess1, ) = payable(devWallet).call{
            value: devShare,
            gas: 30000
        }("");
