...
contract CarbonStandardValidator is ERC721, ERC721Enumerable, ERC721Burnable, Ownable, EIP712, ERC721Votes {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor()
        ERC721("Carbon Standard Validator", "CSV")
        EIP712("Carbon Standard Validator", "1")
    {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://carbonstandard-nft.vercel.app/nft?id=";
    }
