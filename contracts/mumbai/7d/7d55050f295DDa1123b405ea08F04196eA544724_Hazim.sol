...
contract Hazim is ERC4973, IERC4907, Ownable {
    ...
    uint256 public _nftEtherValueQuarterly = 1000000000000000;
    uint256 public _nftEtherValueSemester  = 2000000000000000;
    uint256 public _nftEtherValueYearly    = 3000000000000000;

    uint256 public _nftEtherValueQuarterlyDiscount = 100000000000000;
    uint256 public _nftEtherValueSemesterDiscount  = 200000000000000;
    uint256 public _nftEtherValueYearlyDiscount    = 300000000000000;
    ...
    function mintPublic(
        ...
        for (uint256 i = 1; i <= _mintAmount; i++) {
            ...
            UserInfo storage info = _users[id.current()];
            info.user = _endUser;
            info.expires = expires;
            
            _addressLastMintedTokenId[_endUser] = i;
