...
contract DecentralizedGreenEnery is Context, IERC20, Ownable {  
    ...
    */
    ...
    function sell(uint256 amount) public { 
        ...
        // uint256 _getmatic = Price*amount;
        ...
        transfer (address(this),(_marketing+_reward));
        // _wallet.transfer(_getmatic);
        //Fire event
        emit onTokenSell(_wallet, netAmount);
        AutoUpdateSellPrice(amount);   
    }
    ...
    function GetBuyTokenPrice(uint _amount) public view returns (uint){
        uint256 Getmatic =Price*_amount;
        return Getmatic;
    }
