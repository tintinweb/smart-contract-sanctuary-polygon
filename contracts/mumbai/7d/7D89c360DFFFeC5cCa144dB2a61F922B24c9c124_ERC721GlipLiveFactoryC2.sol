...
contract ERC721GlipLiveFactoryC2 is Ownable {
    ...
    // constructor(address implementation_, address _exchangeProxy, address _defaultMinter) {
    ...
    function createToken(address to, string memory _name, string memory _symbol, bool _global, string memory baseURI, string memory contractURI, uint salt) external {
