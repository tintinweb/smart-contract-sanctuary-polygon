...
contract ClearIssue is IExecutePlugin, BasePlugin {

    constructor(address _registry) {
        PLUGIN_VERSION = 1;
        PLUGIN_NAME = PluginsList.SAFE_DEAL_CLEAR_ISSUE;
    ...
    function execute(
        ...
        require(ISafeDeal(registry.safeDeal()).clearIssue(vars),
            "ClearIssue: wrong exec"
        );
