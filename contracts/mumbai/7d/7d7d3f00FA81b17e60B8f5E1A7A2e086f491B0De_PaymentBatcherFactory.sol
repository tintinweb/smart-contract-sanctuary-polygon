...
contract PaymentBatcherFactory is
    ...
    OwnableUpgradeable
{
    event PaymentBatcherCreated(
        address _paymentBatcherAddress,
        string _tenantName
    );
        ...
        returns (address paymentBatcherAddress)
    {
        ...
        emit PaymentBatcherCreated(paymentBatcherAddress, _tenantName);
    }
    ...
    function updateTenantName(
        ...
        emit PaymentBatcherCreated(_paymentBatcherAddress, _tenantName);
    }
}