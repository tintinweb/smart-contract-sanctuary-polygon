...
contract TestWhitelist is ERC721Enumerable, Ownable {
// contract TestWhitelist is ERC721A, Ownable {

    using SafeMath for uint256;

    bytes32 public presaleMerkleRoot =
        0xb09b992ad1ae59f767eaa82b80755eeee9aff6e98f9eeb20abd991c74c750582;
    ...
    constructor() ERC721("TestWhitelist", "Test") {
   ...
   function setBaseURI(string calldata baseURI) external onlyOwner {
    ...
    {   
        ...
        require(allowList[msg.sender] + quantity <= 2, "Up to 2 mints allowed");
        require(msg.value >= MINT_PRICE * quantity, "Insufficient funds");
        require(ts + quantity <= MAX_SUPPLY , "Purchase would exceed max tokens");
