...
// File: contracts/doodlesdino2.sol


pragma solidity ^0.8.12;

//@author Krillmeed_NFT
//@title Doodles Dino 2.0
...
contract NFTERC721A is Ownable, ERC721A, PaymentSplitter {
    ...
    uint private constant maxsupply = 5555;
    uint private constant MAX_WHITELIST = 300;
    uint private constant MAX_PUBLIC = 5050;
    uint private constant MAX_GIFT = 205;

    uint public wlSalePrice = 0.003 ether;
    uint public public_sale_price = 0.005 ether;

    bytes32 public merkleRoot;

    uint public saleStartTime = 1664463765;

    mapping(address => uint) public amountNFTsperWalletWhitelistSale;

    uint private teamLength;

    constructor(address[] memory _team, uint[] memory _teamShares, bytes32 _merkleRoot, string memory _baseURI) ERC721A("Doodles Dino 2", "DDINO")
