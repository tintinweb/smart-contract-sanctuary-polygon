...
contract GangNFT is ERC721, ReentrancyGuard, IERC2981 {
    string public baseURI = "https://gangclub.vercel.app/api/opensea_meta/";
        ...
        )
    {
        clubId = tokenId;
        _safeMint(creator, 1);
        gangNFTCreatorContract = GangNFTCreator(_gangNFTCreator);
    }
    ...
    /**
     * @notice Get owner of this Gang Club.
    ...
    function contractURI() public view returns (string memory) {
        return
            string(
                abi.encodePacked(
                    "https://gangclub.vercel.app/api/opensea_meta/",
    ...
    /**
     * @notice Transfers ownership of the Gang Club to a new address.
...
contract GangNFTCreator is ERC721, Ownable, ReentrancyGuard, IERC2981 {
    string public contractURI =
        "https://gangclub.vercel.app/api/opensea_meta/contractCreator/";
    string public baseURI =
        "https://gangclub.vercel.app/api/opensea_meta/token/";
