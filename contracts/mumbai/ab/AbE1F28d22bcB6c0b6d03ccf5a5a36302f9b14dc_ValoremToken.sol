...
contract ValoremToken is AccessControl, ERC20Burnable, IMintableToken {
    ...
    constructor() ERC20("AdValorem Token", "VLR") {
    ...
    function mint(address to, uint256 amount) external override {
        require(hasRole(MINTER_ROLE, msg.sender), "AdValorem Token: not authorized");
        _mint(to, amount);
    }
}
