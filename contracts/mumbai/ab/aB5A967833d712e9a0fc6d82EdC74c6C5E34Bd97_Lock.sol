...
contract Lock is ERC20 {
    ...
    function mint(
        ...
        require(CertifierID < certificates.length, "Invalid CertifierID");
        uint256 lotId = CertifierID;
    ...
    function balanceOfCertificate(
        ...
        return walletTokenBalances[account][CertificateID];
    }
