...
contract PlushOperationsDAO is Governor, GovernorSettings, GovernorCountingSimple, GovernorVotes, GovernorVotesQuorumFraction, GovernorTimelockControl {
    constructor(IVotes _token, TimelockController _timelock)
    Governor("PlushOperationsDAO")
    GovernorSettings(1 /* 1 block */, 19636 /* 3 days */, 1e18)
