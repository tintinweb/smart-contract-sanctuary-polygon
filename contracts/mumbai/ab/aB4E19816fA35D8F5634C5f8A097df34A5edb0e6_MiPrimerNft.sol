...
// Contador para identificar cada NFT.
contract Counters {
...
contract MiPrimerNft is ERC721, Pausable, AccessControl, ERC721Burnable {
    ...
    constructor() ERC721("Mi Primer Token", "MPT") {
    // constructor(
    ...
    function _baseURI() internal pure override returns (string memory) {
        ...
        return "ipfs://QmPEEBZpkV5m5NTQoPfo8rtAmLRDA2aRyDn76kEcgpoKK1/";
    } 
    ...
    // minamos(compramos) la NFT
    // to: direccion destino
    function safeMint(address to) public {
        // @TODO: 
        // minamos(compramos) la NFT
        _safeMint(to, _tokenId);
        // Proteger que no se pase de 30
        require(_tokenId <= 30);
        // aumentamos el contador cada vez que se crea un NFT
        _tokenId++;
    }
