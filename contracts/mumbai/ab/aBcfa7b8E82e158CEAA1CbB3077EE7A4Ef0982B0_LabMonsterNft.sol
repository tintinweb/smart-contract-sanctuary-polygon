...
contract LabMonsterNft is ERC721URIStorage, Ownable {
    ...
    function randomMint() external returns (uint256) {
        ...
        uint256 monsterId = (randomNumbers[0] % 8) + 1;
        ...
        string memory _tokenURI = string(
            abi.encodePacked(
                ...
                '","description":"Lab Monster NFT","image":"https://ipfs.io/ipfs/QmZWzAUMs8G7Bp9a1w8Kawu8UR71d5mipkyD9f49hsgHm3/monster-',
                Strings.toString(monsterId),
    ...
    function withdrawTokens() external onlyOwner {
        uint256 balance = slabsToken.balanceOf(address(this));
        slabsToken.transfer(msg.sender, balance);
    }
}
