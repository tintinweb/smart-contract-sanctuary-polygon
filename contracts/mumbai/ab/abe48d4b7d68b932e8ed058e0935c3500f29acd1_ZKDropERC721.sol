...
// import "sismo-connect-solidity/libs/utils/Structs.sol";
import {AuthType, AuthRequest, IAuthRequestBuilder} from "sismo-connect-solidity/libs/utils/AuthRequestBuilder.sol";
import {IAddressesProvider} from "sismo-connect-solidity/periphery/interfaces/IAddressesProvider.sol";
 ...
 */
contract ZKDropERC721 is ERC721 {
    ...
    // // external libraries
    IAuthRequestBuilder internal _authRequestBuilder;
    ...
    constructor(
        ...
        // // external libraries
        _authRequestBuilder = IAuthRequestBuilder(ADDRESSES_PROVIDER.get(string("authRequestBuilder-v1")));
        // _claimRequestBuilder = ClaimRequestBuilder(ADDRESSES_PROVIDER.get(string("claimRequestBuilder-v1")));
    ...
    //     return _requestBuilder.build(auth, claim, signature, _appId);
    // }
}
...
import {AuthRequest, AuthType} from "./Structs.sol";
...
contract AuthRequestBuilder is IAuthRequestBuilder {
