...
import "@chainlink/contracts/src/v0.8/functions/dev/0_0_0/FunctionsClient.sol";
import {ConfirmedOwner} from "@chainlink/contracts/src/v0.8/ConfirmedOwner.sol";
import {AutomationCompatibleInterface} from "@chainlink/contracts/src/v0.8/automation/AutomationCompatible.sol";
import "@openzeppelin/contracts/token/ERC20/ERC20.sol";
import "@openzeppelin/contracts-upgradeable/proxy/utils/Initializable.sol";
import "@uniswap/lib/contracts/libraries/TransferHelper.sol";
import "./VarVaultImmutables.sol";
    ...
    VarVaultImmutables
{
   ...
   */
    ...
    function withdraw(address account, uint256 amount) external {
        ...
        TransferHelper.safeTransfer(assetToken(), account, assetTokenAmount);
    }
}
...
contract VarVaultImmutables is Clone {
    /**
     * @notice The address of the token to be deposited into the vault
     * @dev using ClonesWithImmutableArgs pattern here to save gas
     * @dev https://github.com/wighawag/clones-with-immutable-args
     * @return The address of the token to be deposited
     */

    function depositToken() public pure returns (address) {
        return _getArgAddress(0);
    }

    /**
     * @notice The address of the asset token of the vault
     * @dev using ClonesWithImmutableArgs pattern here to save gas
     * @dev https://github.com/wighawag/clones-with-immutable-args
    ...
    /**
     * @notice The address of the price-feed oracle for the assetToken
     * @dev using ClonesWithImmutableArgs pattern here to save gas
     * @dev https://github.com/wighawag/clones-with-immutable-args
     * @return The address of the oracle
     */

    function assetOracle() public pure returns (address) {
