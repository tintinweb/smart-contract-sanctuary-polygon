...
interface IWithdraw {
    ...
    function claimNFTback(address tokenOwner, address tokenContract, uint256 tokenId, bool ercStandard) external returns(bool);
    function storeNFT(address tokenOwner, address tokenContract, uint256 tokenId, bool ercStandard) external returns(bool);
...
contract Marketplace is ReentrancyGuard, IMarketplace, Ownable {
    ...
    */
    ...
    function createSaleOrder(
        ...
        IWithdraw(escrow).storeNFT(tokenOwner, tokenContract, tokenId, standard721);
    ...
    */ 
    ...
    function _deleteAuction(uint256 auctionId, address _to, address _contract, uint256 _tokenId) internal {
        ...
        bool ercStandard = (auctionOrderDetails[auctionId].erc == ErcStandard.ERC721) ? true : false;
    ...
    */
    ...
    function finishAuction(uint256 auctionId, uint256 biddingId) external auctionExist(auctionId) {
        ...
        IWithdraw(escrow).claimNFTback(bid.bidder, auc.tokenContract, auc.tokenId, ercStandard);
    ...
    */
    function cancelSell(uint256 orderId) external tradeExists(orderId) {
        ...
        IWithdraw(escrow).claimNFTback(owner, sell.tokenContract, sell.tokenId, ercStandard);
    ...
    function buyOrder(uint256 orderId) external payable tradeExists(orderId) nonReentrant {
        ...
        IWithdraw(escrow).claimNFTback(msg.sender, sell.tokenContract, sell.tokenId, ercStandard);
