 ...
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 Developed By SD-MALINGA
 */

pragma solidity ^0.7.0;

contract whoosh is ERC721, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC721("whoosh", "wh")  {
      
    }


  
  function mintToken(string memory baseURI)public  returns(uint256 )
  { 
      uint256 mintindex = totalSupply().add(1);
   _safeMint(msg.sender,mintindex);
   _setTokenURI(mintindex,baseURI);
   return mintindex;
  }
