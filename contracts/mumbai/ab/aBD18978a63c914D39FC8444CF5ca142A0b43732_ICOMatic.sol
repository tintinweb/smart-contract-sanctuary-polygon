...
contract ICOMatic {
    ...
    function withdraw() public payable onlyOwner {
        ...
        uint _novaBalance = tokenNova.balanceOf(address(this));
        tokenNova.transfer(owner, _novaBalance);
    }
    ...
    function getBalanceNGG() public view returns (uint) {
    ...
    function getUSDBalance() public view returns (uint) {
        uint _balance = getMaticBalance();
        uint _usd = getConversionRate(_balance);
        return _usd;
    }
}