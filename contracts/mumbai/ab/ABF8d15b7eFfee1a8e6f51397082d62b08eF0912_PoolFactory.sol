...
contract PoolFactory is OwnableUpgradeable {
    ...
    event PresaleCreated(
        address _presale,
        address[4] _addrs,
        uint256[16] _saleInfo,
        string _poolDetails,
        uint256[3] _vestingInit,
        string[3] _otherInfo,
        address _creator
    );    
    event PrivateCreated(
        address _private,
        address[4] _addrs,
        uint256[13] _saleInfo,
        string _poolDetails,
        uint256[3] _vestingInit,
        string[3] _otherInfo,
        address _creator
    ...
    function initalizeClone(
        ...
        require(poolForToken[_addrs[0]] == address(0), "Pool Already Exist!!");
    }
    ...
    function createFairSale(
        ...
        _transferFromEnsureExactAmount(_addrs[0], pair, totalToken);     
        uint256[11] memory _saleInfo;
        _saleInfo[0] = _capSettings[0];
        _saleInfo[1] = _capSettings[1];
        _saleInfo[2] = _timeSettings[0];
        _saleInfo[3] = _timeSettings[1];
        _saleInfo[4] = _timeSettings[2];
        _saleInfo[5] = _feeSettings[0];
        _saleInfo[6] = _feeSettings[1];
        _saleInfo[7] = _audit;
        _saleInfo[8] = _kyc;
        _saleInfo[9] = _liquidityPercent[0];
        _saleInfo[10] = _liquidityPercent[1];
        emit FairCreated(
            pair,         
            _addrs, 
            _saleInfo,
    ...
    function updateKycAuditStatus(
        ...
        require(
            poolForToken[_poolAddress] != address(0),
            "Pool Not exist !!"
        );
