...
contract AutomatedFunctionsConsumer is AutomationCompatibleInterface {
    /**
...
contract FuntionsFactory {
  ...
  event autoFunctionEvent(address,uint256);
  ...
  // }
   ...
   function createAutomatedFunctions(
    ...
    emit autoFunctionEvent(address(autoFunction),_updateInterval);
  }
