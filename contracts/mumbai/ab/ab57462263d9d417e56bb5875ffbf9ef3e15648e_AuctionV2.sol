...
contract AuctionV2 is Initializable {
    ...
    function setFeeStanSystem(
        uint128 _val,
        uint128 _valDenomination,
        uint128 _stanFee
    ) external onlyOwner {
        AuctionStructure.feeStanSystem
            memory feeStanSystemInstance = AuctionStructure.feeStanSystem(
                _val,
                _valDenomination,
                _stanFee
            );
        feeStanSystem = feeStanSystemInstance;
    }
