...
contract Kichee is IERC20 {
    ...
    */
    ...
    function buyTokensByUSDC(uint256 valueUSDC, string) checkHardCaps(valueUSDC.mul(priceUsdc), msg.sender) public{
    ...
    //Buy new tokens functions 
    function buyTokensByMatic(string) payable checkHardCaps(priceMatic.mul(msg.value), msg.sender) external {
