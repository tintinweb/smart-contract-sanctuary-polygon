    ...
    ERC20Upgradeable
{
    ...
    function dynamicAdjustment() public onlyRift {
        ...
        if (isIncrease) {
            uint256 maxIncreaseAmount = balanceOf(address(pair)) * (10000 + maxBuyPercent) / 10000;
            _balanceAdjustment(true, adjustedPozAmount >= maxIncreaseAmount ? 
                adjustedPozAmount - maxIncreaseAmount :
