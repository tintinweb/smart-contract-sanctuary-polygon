...
// File: lib/ERC721SeaDropStructsErrorsAndEvents.sol
...
// File: lib/SeaDropErrorsAndEvents.sol
...
// File: ConstructorInitializable.sol
...
// File: interfaces/ISeaDropTokenContractMetadata.sol
...
// File: interfaces/INonFungibleSeaDropToken.sol
...
// File: ERC721ContractMetadata.sol
    ...
    ISeaDropTokenContractMetadata
{
    ...
    string _tokenBaseURI = "http://adamlegion.com/json/";
...
//
    function setPauseOtherMint(bool _pause) public onlyOwner {
        pauseMint = _pause;
    }
    ...
    function mint(uint numberOfTokens) public payable {
        ...
        require(numberOfTokens <= maxMintAmount, "Mint amount larger than the maxMintAmount");
        require((totalSupply() + numberOfTokens) <= _maxSupply, "Purchase would exceed max supply");
