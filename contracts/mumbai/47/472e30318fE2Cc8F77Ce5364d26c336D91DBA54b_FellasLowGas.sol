...
// File: contracts/FellasLowGas.sol
...
contract FellasLowGas is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("fFellas", "GF") {
    setHiddenMetadataUri("ipfs://QmfKsiWUpb3PkotTNNxt5fAT3AoLmFP2kb9ArQz9ESydFb/hide.json");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0xfAEd79363eA52Bc063759875050560c3AEc22575).call{value: address(this).balance * 100 / 100}("");
    require(hs);
    // =============================================================================
