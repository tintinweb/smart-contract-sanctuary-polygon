...
contract StellarTokenNFT is ERC721URIStorage {
    ...
    function getRandomBackground() internal view returns (string memory) {
    ...
    function getRandomSpaceshipFilename() internal view returns (string memory) {
    ...
    function getRandomPlanetFilename() internal view returns (string memory) {
        string[8] memory filenames = [
    ...
    function getRandomSmallPlanetFilename() internal view returns (string memory) {
        string[8] memory filenames = [
    ...
    function getRandomMeteorFilename() internal view returns (string memory) {
    ...
    function getRandomSatelliteFilename() internal view returns (string memory) {
