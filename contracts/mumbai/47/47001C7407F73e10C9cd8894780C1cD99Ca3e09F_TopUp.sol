...
contract TopUp is ITopUp, OwnableUpgradeable, PausableUpgradeable, AuthModifiers, UUPSUpgradeable {
    ...
    function topUpCustodial(
        ...
        emit ToppedUp(_integratorIndex, msg.sender, _availableFuel, _amountFuel, _swapPrice);
    }
    ...
    function topUpNonCustodial(uint32 _integratorIndex, uint256 _amountFuel) external whenNotPaused {
        ...
        emit ToppedUp(_integratorIndex, msg.sender, _availableFuel, _amountFuel, _price);
    }
...
interface IEconomics {
    ...
    function viewIntegratorAveragePrice(address _relayerAddress) external view returns (uint256);

    function viewIntegratorAvailableFuel(address _relayerAddress) external view returns (uint256);

    function viewIntegratorUSDBalance(address _relayerAddress) external view returns (uint256);
}
