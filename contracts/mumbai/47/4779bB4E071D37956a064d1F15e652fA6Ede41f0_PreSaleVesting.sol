...
contract VestingHub is Ownable, ReentrancyGuard {
  ...
  constructor(
    ...
    _transferOwnership(0x360795778E0bE0E2AF054A164e87f7D63660Be46);
  }
...
contract PreSaleVesting is VestingHub {
  ...
  function allocateTokensManager(address benificiaries, uint256 amount)
    ...
    onlyManager
  {
    _allocatedTokens[benificiaries] = _allocatedTokens[benificiaries] + amount;
  }
