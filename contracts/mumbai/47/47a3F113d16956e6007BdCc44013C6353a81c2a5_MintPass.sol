...
contract ERC721Base is ERC721Pausable, Ownable, ReentrancyGuard {
...
contract MintPass is ERC721Base {
        ...
        ERC721Base(_name, _symbol)
    {
        ...
        MAX_RESERVED_SUPPLY = _reservedSupply;
        MAX_PUBLIC_SUPPLY = MAX_SUPPLY - MAX_RESERVED_SUPPLY;
        MAX_PER_ADDRESS = _mintLimitPerAddress;
        MAX_MULTIMINT = _multiMintLimit;
    ...
    function mint(uint256 count) public payable nonReentrant publicSaleIsAvailable {
        ...
        for (uint256 i = 0; i < count; i++) {
            ...
            _safeMint(msg.sender, totalPublicSupply() + MAX_RESERVED_SUPPLY);
        }
    ...
    function ownerMint(uint256 count, address recipient) external onlyOwner() {
        ...
        for (uint256 i = 0; i < count; i++) {
            ...
            _safeMint(recipient, totalReservedSupply());
        }
    }
