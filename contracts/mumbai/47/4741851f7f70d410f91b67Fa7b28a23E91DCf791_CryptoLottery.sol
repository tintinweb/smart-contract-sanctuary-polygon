...
//не работает
    function getUserTickets (address user) external view returns(Ticket[] memory tickets) {
    ...
    function getUserFreeTicketsCount (address user) external view returns(uint) {
