...
contract MyToken is ERC20Authorization, Ownable {
    ...
    ERC20 public usdt = ERC20(0xb514C45fb2861ad6591C85C93641711D5821Ea40);
    ...
    constructor(address _q2, address _swapAddress)
        ...
        returns (uint256)
    {
        ...
        if (swapFromDex) {
            ...
            // exchangeKctPos(address(usdt), Q2BurnAmount, q2, path);
        } else {
            /**
             * Approving PoolAddress to Spend Token
             */
            usdt.approve(poolAddress, Q2BurnAmount);
            /**
             * Exchanging q2 with usdt
             */
            // IPool(poolAddress).exchangeQ2withusdt(Q2BurnAmount);
        }
        ERC20(q2)._burn(address(this), ERC20(q2).balanceOf(address(this)));
        // return nq
        return nq;
    }
