...
contract HolaMetaversoTeam is ERC721A, Ownable{
    ...
    constructor(address _wallet, string memory _teamURI) ERC721A("Hola Metaverso Los Angeles 2022 Team", "HOLATEAM"){
       baseTokenUri = _teamURI;
       _safeMint(_wallet, 10);
    }
