...
contract MyNft is ERC721, Ownable, ERC2981 {
    ...
    constructor() ERC721("NFTOOL", "COOL") {
        _baseTokenURI = "https://test-nft-tool-gateway-api.tuoluo.net/generator-server/api/contract/v1/1601053553668653057/metadata/";
    ...
    onlyOwner
    {
        ...
        for (uint256 i = 0; i < numRecipients; ) {
            if (_currentIndex + qtys[i] - 1 > supply) revert SoldOut();
