...
contract Treasury is Ownable {
    ...
    constructor(address payable multisigWallet)
    {
    ...
    function depositToken(address token) public {
       ...
       tokenContract.safeTransfer(_multisigWallet, tokenContract.balanceOf(address(this))); 
    ...
    function withdrawEthers(uint256 amount) external onlyOwner{
        ...
        _multisigWallet.transfer(amount);
    }
    ...
    function withdrawTokens(address tokenAddress, uint256 amount) external onlyOwner{
        ...
        tokenContract.safeTransfer(_multisigWallet, amount);
    }
}