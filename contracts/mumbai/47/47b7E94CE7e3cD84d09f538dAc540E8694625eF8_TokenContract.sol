    ...
    AccessControlUpgradeable
{
    ...
    event FactoryContractAdded(address indexed _factoryAddresss);
    ...
    function _transferToken(
        ...
        uint256 availableBalance = balanceOf(_from) - frozenTokens[_from];
    ...
    function freezeTokens(address _userAddress, uint256 _amount) external {
        ...
        require(
            balanceOf(_userAddress) >= frozenTokens[_userAddress] + _amount,
