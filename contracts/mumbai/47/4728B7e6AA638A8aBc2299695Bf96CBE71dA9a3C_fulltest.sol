...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract fulltest is Context , IERC20, Ownable {
    ...
    uint256 private _tTotal = 500000 * 10**9 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "full test";
    string private _symbol = "fulltest";
    ...
    address public devWallet = 0x21f9E395ABf408392E06f2b7FA45386768d94b0B; //2% for marketing ,1% for giveaways
    ...
    uint256 public _maxWalletToken = 270 * 10**9 * 10**9; 
    ...
    function excludeFromReward(address account) public onlyOwner() {
       require(account != 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff, 'We can not exclude Pancake router.'); //v2
