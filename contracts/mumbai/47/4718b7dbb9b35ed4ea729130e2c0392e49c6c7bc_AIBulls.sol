...
contract AIBulls is ERC721A, Ownable, ERC2981, DefaultOperatorFilterer {
    using Strings for uint256;
   ...
   // Team addresses for withdrawals
    address public a1=0x7a92a9cD2f78aBe6E3716eb5cc2eD762aE90c88A;
    address public a2=0x36E0FaD0CFb54ACB3268Fa64ec64deB3B266e067;

    constructor(string memory _initBaseURI, string memory _initNotRevealedUri, string memory _contractURI) ERC721A("AI Bulls", "$STOMP") {
     
    setBaseURI(_initBaseURI);
    setNotRevealedURI(_initNotRevealedUri);   
    setRoyaltyInfo(owner(),230);
