...
contract StakingReward is OwnerPausable {
    ...
    function pauseStake() external onlyOwnerOrOperator { //access auth handled by parent
        lastPausedTimestamp = block.timestamp;
        super.pause();
    }

    function unpauseStake() external onlyOwnerOrOperator { //access auth handled by parent
        super.unpause();
    }
