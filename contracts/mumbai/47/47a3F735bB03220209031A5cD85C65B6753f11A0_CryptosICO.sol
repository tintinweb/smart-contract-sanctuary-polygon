...
contract CryptosICO is Cryptos{
    ...
    function invest(address payable sponsor) payable public returns(bool){ 
        ...
        sponsor.transfer(sponsorCommission);
    ...
    function transferFrom(address from, address to, uint tokens) public onlyAdmin override returns (bool success){
        require(block.timestamp > tokenTradeStart); // the token will be transferable only after tokenTradeStart
