...
contract LostChainPaymaster is LostChainBasePaymaster, UUPSUpgradeable {
    ...
    function testRBALinker1(string memory testValue) public view returns (bytes32) {
        return LCRBALinker.getRole(testValue);
    }

    function testRBALinker2(bytes32 testValue1, address testValue2) public view returns (bool) {
        return LCRBALinker.checkAccountRole(testValue1, testValue2);
    }
