...
contract cngn2 is Initializable, OwnableUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable, PausableUpgradeable,ReentrancyGuardUpgradeable {
    ...
    function enablew () public virtual returns(bool){
        www = true;
        return true;
    }

    function denablew () public virtual returns(bool){
        www = false;
        return true;
    }
