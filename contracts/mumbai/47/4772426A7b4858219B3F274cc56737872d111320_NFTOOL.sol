...
contract NFTOOL is ERC721, Ownable, ERC2981 {
    ...
    address[] public withdrawAddresses = [0x5cd819CAa5e1fDd7b9E29dA8aE4036E85330fd21];
    uint256[] public withdrawPercentages = [100];


    bytes32 public merkleRoot = 0;

    constructor() ERC721("NFTOOL", "NFT") {
        _baseTokenURI = "https://api.nftool.io/generator-server/api/contract/v1/mU9DrhKcwPhkjalH1/1613354081759477762/metadata/";
        _setDefaultRoyalty(0x5cd819CAa5e1fDd7b9E29dA8aE4036E85330fd21, uint96(500));
    }
