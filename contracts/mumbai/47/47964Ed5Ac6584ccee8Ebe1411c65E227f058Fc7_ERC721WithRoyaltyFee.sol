    ...
    ERC2981PerTokenRoyalties
{
    ...
    string public constant CollectionBaseURI =
        "https://cryber8.mypinata.cloud/ipfs/";

    mapping(address => bool) private _operators;
    mapping(uint256 => address) private _royaltyAddress;
    ...
    function safeMint(
        ...
        if (royaltyRate > 0) {
            ...
            _royaltyAddress[tokenId] = to;
        }
        emit Minted(to, tokenId, royaltyRate, block.timestamp, tokenCID);
    }
