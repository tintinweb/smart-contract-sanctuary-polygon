...
{    
    ...
    function initialize(
        ...
        __ERC20_init("P2P", "P2P");
        __ERC20Burnable_init();
        __Pausable_init();
        __AccessControl_init();
        __ERC20Permit_init("P2P");

        _grantRole(DEFAULT_ADMIN_ROLE, _admin);
        _grantRole(PAUSER_ROLE, _pauser);
        _grantRole(MINTER_ROLE, _minter);
        _grantRole(BRIDGER_ROLE, _bridger);
    ...
    function bridge(address _user, uint256 amount)
        external
        ...
        notBlacklisted(_user)
    {
        ...
        emit TokensBridged(_user, amount, block.timestamp);
    }
    ...
    function _beforeTokenTransfer(
        ...
        address to,
        uint256 amount
    ) internal override whenNotPaused notBlacklisted(msg.sender) {
