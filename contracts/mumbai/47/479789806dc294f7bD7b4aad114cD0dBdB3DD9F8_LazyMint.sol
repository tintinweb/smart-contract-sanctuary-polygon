...
contract EIP712Base is Initializable {
    ...
    function _initializeEIP712(string memory _name, string memory _version) internal initializer {
...
contract LazyMint is Initializable, ERC721Upgradeable, ERC721URIStorageUpgradeable, PausableUpgradeable, OwnableUpgradeable, ERC721BurnableUpgradeable, UUPSUpgradeable,EIP712Base {
    /// @custom:oz-upgrades-unsafe-allow constructor
    string private constant SIGNING_DOMAIN = "Legends-Domain";
    string private constant SIGNATURE_VERSION = "1";
    address public minter;
    address public contractOwner;


    function initialize(address _minter)initializer  public   {
        __ERC721_init("LegendNft", "LN");
        __ERC721URIStorage_init();
        __Pausable_init();
        __Ownable_init();
        __ERC721Burnable_init();
        __UUPSUpgradeable_init();
        _initializeEIP712(SIGNING_DOMAIN,SIGNATURE_VERSION);
        minter = _minter;
