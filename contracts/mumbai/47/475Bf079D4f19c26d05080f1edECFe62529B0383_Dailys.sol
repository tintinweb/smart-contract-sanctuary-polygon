...
contract Utils is Ownable {
    ...
    function stopOpacityPicker(
        ...
        return stopOpacity[index % stopOpacity.length];
    }
    ...
    function backgroundTimer(
        ...
        return bgTimes[index % bgTimes.length];
    }
    ...
    function buildGradient(
        ...
        string memory gradientStop1 = buildGradientStop(_stopColor1, "0");
        string memory gradientStop2 = buildGradientStop(_stopColor2, ".5");
        string memory gradientStop3 = buildGradientStop(_stopColor3, "1");
