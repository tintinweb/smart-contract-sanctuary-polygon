...
contract NFTClaim is Ownable, ReentrancyGuard, ERC1155Holder {
    ...
    function setWhitelistRoot(uint256 campaignId, bytes32 whitelistRoot)
        external
        onlyOwner
    {
    ...
    function verifyWhitelist(
        ...
        bytes32 leaf = keccak256(abi.encodePacked(campaignId, user, quantity));
        return
            whitelistProof.verify(campaignInfo[campaignId].whitelistRoot, leaf);
    }
