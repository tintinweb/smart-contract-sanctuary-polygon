    ...
    UUPSUpgradeable
{
    ...
    function editLand(
        ...
        uint256[] memory maxRewardAmount
        ...
        for (uint256 i = 0; i < rewardAmount.length; i++) {
            ...
            require(rewardAmount[i] <= maxRewardAmount[i], 'LWNFT: Max reward is more than the reward amount');
        }
    ...
    function clearLand(uint256 landId) public onlyRole('TRUSTED_FORWARDER', msg.sender) {
        ...
        landData[landId].maxRewardAmount = new uint256[](0);
