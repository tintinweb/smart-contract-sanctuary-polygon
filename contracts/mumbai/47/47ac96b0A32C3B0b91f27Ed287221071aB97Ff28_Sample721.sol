...
contract Sample721 is ERC721Enumerable, AccessControl {
    string public baseTokenURI = "https://test.s3.amazonaws.com/tokens/metadata/";
    bytes32 public constant MINTER = keccak256("MINTER");

    constructor(address root) ERC721("Sample Token 721", "SAMP") {
    ...
    function tokenURI(uint256 _tokenId) public pure virtual override returns (string memory) {
        return "https://gateway.pinata.cloud/ipfs/QmPxCL84j57RS8XxrAggpbtdKoR8Mew8VYgx4EAywkgASY?_gl=1*psuf50*_ga*NTI2MjU5OGYtZGVhNi00YTg0LTliYWYtYjAxYzljMzAyNWVj*_ga_5RMPXG14TE*MTY3OTk0NDI5NC4xLjEuMTY3OTk0NTMwMS43LjAuMA..";
    }
}