...
contract BaseRegistrarImpl is ERC721Enumerable, IBaseRegistrar, Ownable {
    ...
    constructor(ENS _ens, bytes32 _baseNode, string memory _name, string memory _symbol) ERC721(_name, _symbol) {
        ens = _ens;
        baseNode = _baseNode;
    }
...
//        require(_index < tokens.length, "ERC721: invalid _index");
//        return tokens[_index];
//    }
//
//    function tokenOfOwnerByIndex(address _owner, uint256 _index) external view override returns (uint256) {
//        require(_index < ownerToIds[_owner].length, "ERC721: invalid _index");
 ...
 */
contract RealRegistrarController is
    Ownable,
    IERC165,
    ReverseClaimer
{

    bytes32 private constant ETH_NODE = 0x0a7c5b3259ba40a0e55d9fced5e02b9dd15e56f224e59b1b3d106650ca45e3cd;
    ...
    function register (
        ...
        uint expires = base.register(tokenId, address(this), MAX_EXPIRY);
