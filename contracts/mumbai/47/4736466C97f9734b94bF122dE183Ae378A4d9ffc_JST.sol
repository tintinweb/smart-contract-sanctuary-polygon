...
contract JST {
  ...
  function transfer(address _to, uint256 _value) external returns (bool) {
    require(_to != address(0), "JST: can't mit to zero address");
    require(_value <= balances[msg.sender], "JST: insufficient fund");
  ...
  function transferFrom(address _from, address _to, uint256 _value) external returns (bool) {
    require(_to != address(0), "JST: can't mit to zero address");
    require(_value <= balances[_from], "JST: insufficient fund");
    require(_value <= allowed[_from][msg.sender], "JST: insufficient allowance");
