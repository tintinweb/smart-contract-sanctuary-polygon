...
contract MyToken is Initializable, ERC721Upgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function safeMint(address to, address _contractadrmark, uint256 tokenId) public {
        _safeMint(to, tokenId);
        setApprovalForAll(_contractadrmark, true); 
        //setApprovalForAll(_contractadrauction, true); 
    }
