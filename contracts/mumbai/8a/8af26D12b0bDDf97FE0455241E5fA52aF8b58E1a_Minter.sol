...
contract Minter is IMinter, MintingAccessControlUpgradeable, FractionCostBadges {
    ...
    event TestCost(uint256 cost, address from, address to, address spender);

    /**
     * @dev Mint a new s nft
     */
    function mintFractionForUserTest(
        uint256 id,
        address to,
        uint256 amount
        ...
        // Emit the event
        emit FractionMinted(id, to, amount, totalCost);
        emit TestCost(totalCost, to, foundationWallet, address(this));
    }
