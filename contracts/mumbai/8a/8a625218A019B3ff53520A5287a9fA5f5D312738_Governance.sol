...
contract Governance is Dcarb{
    ...
    // executed only once
    function initialize(address dcarbAddr, address escrowAddr) public {
        require(isInitialized == false, "Contract already initialized.");
        require(dcarbAddr != address(0), "carb must not be 0x0");
        require(escrowAddr != address(0), "Escrow must not be 0x0");
    ...
    function activate() public {
        ...
        console.log('staked vs threshold :', carb.DCO2Staked(), ACTIVATION_THRESHOLD);
        require(
    ...
    function propose(
        ...
        //Calling openCarbonEscrow function once the proposal is created successfully

        escrow.openCarbonEscrow(_projectID,_vintage,_tCO2,_nonce);
    ...
    function execute(uint256 proposalId,bytes32 _escrowID) public payable {
        ...
        escrow.approveEscrow(_escrowID);
    }

    function cancelProposal(uint256 proposalId,bytes32 _escrowID) public {
        require(
    ...
    function abrogateProposal(uint256 proposalId,bytes32 _escrowID) public {
        require(
...
abstract contract Parameters {
    ...
    uint256 constant ACTIVATION_THRESHOLD = 0;
