...
contract myContract is Ownable{
    ...
    // Comprobar si tu wallet esta en el array (solo para Remix)
    function isYourWalletInArray () public view returns (bool) {
    ...
    function setMessage (string memory _description) public {
        bool result = checkByWallet(msg.sender);
        if (result == false) {
    ...
    function updateList (string memory _description) public {
        bool result = checkByWallet(msg.sender);
        if (result == true) {
