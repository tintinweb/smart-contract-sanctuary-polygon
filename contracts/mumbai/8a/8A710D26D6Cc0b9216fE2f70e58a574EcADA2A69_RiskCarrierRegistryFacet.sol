    ...
    IRiskCarrierRegistryInternal
{
    ...
    function _registerRiskCarrierController(
        ...
        IRiskCarrierBaseStorage.RiskCarrierController
            memory riskCarrierurerController = IRiskCarrierBaseStorage
                .RiskCarrierController(_addr_, _name_, _riskTransferRatio_);
        ...
        emit RegisterRiskCarrierController(
            _poolId_,
            _name_,
            _addr_,
            _riskTransferRatio_
    ...
    function _setRiskTransferRatio(
        string memory _poolId_,
        address _addr_,
        uint8 _riskTransferRatio_
    ) internal {
        ...
        .riskCarrierControllerListByPool[_poolId_][
            _rbs_.riskCarrierControllerListIndexByPool[_poolId_][_addr_]
        ].riskTransferRatio = _riskTransferRatio_;

        emit SetRiskTransferRatio(_poolId_, _addr_, _riskTransferRatio_);
    }
        ...
        )
    {
        ...
        riskCarrierControllerList = new IRiskCarrierBaseStorage.RiskCarrierController[](
            length
        );

        for (uint256 i = 0; i < length; i++) {
            riskCarrierControllerList[i] = _rbs_
    ...
    IRiskCarrierRegistry
{
    ...
    function registerRiskCarrierController(
        ...
        _registerRiskCarrierController(
            _poolId_,
            _name_,
            _addr_,
            _riskTransferRatio_
    ...
    function setRiskTransferRatio(
        ...
        _setRiskTransferRatio(_poolId_, _addr_, _riskTransferRatio_);
    }
