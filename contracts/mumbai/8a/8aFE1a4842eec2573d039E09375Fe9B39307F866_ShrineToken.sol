...
contract ShrineToken is ERC20, FxBaseChildTunnel, Ownable {
    ...
    constructor(
        ...
        multipleStakedBoost[2] = 2;
        multipleStakedBoost[3] = 4;
        multipleStakedThreshold.push(2);
        multipleStakedThreshold.push(3);

        //---init lockup boost---//
        lockupBoost[1 days] = 2;
        lockupBoost[2 days] = 4;
        lockupThreshold.push(1 days);
        lockupThreshold.push(2 days);

        //---init ecosystem boost---//
        EcosystemBoost memory _boost1 = EcosystemBoost(1, 1, 5);
        EcosystemBoost memory _boost2 = EcosystemBoost(2, 3, 10);
        ecosystemThreshold.push(_boost1);
        ecosystemThreshold.push(_boost2);

        //---init rarity rate---//
        rarityRate[haki][0] = 1000 ether;
        rarityRate[haki][1] = 2000 ether;
        rarityRate[sekira][0] = 1000 ether;
        rarityRate[sekira][1] = 2000 ether;
    }
