...
contract LeafSBTContract is ERC721URIStorage, Ownable2Step, ReentrancyGuard {
    ...
    function mintSBT(uint256 _tokenId, string memory _tokenUrl, address _address) external payable  nonReentrant onlyOwner{
