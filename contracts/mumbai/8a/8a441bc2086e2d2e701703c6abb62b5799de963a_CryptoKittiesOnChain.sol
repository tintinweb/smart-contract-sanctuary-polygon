...
// File: contracts/IDescriptor.sol
...
// File: contracts/CryptoKittiesOnChain.sol
...
contract CryptoKittiesOnChain is ERC721Enumerable, Ownable {
    ...
    uint256 token_price = 0.003 ether; 
    uint256 free_per_txn = 2;

    constructor(IDescriptor newDescriptor) ERC721("CryptoKittiesOnChain", "KittiesOnChain") {
        descriptor = newDescriptor;
        teamClaim(1);
    }


    function teamClaim(uint32 count) public {
    ...
    function mint(uint32 count) external payable {
        ...
        require(msg.value >= token_price * (count - free_per_txn), "Two Freemint. Need to send more ETH.");
    ...
    function getSeed(uint256 tokenId) public view returns (uint256) {
        require(_exists(tokenId), "Kitties does not exist.");
    ...
    function generateSeed(uint256 tokenId) private view returns (uint256) {
        ...
        return 10000 * (10000 * (10000 * headSeed + faceSeed)) + legsSeed;
    }
