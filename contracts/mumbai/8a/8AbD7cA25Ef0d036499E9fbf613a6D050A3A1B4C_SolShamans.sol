...
contract SolShamans is ERC721, Ownable, Pausable {
    using Strings for uint256;
    uint256 public constant MAX_SUPPLY = 777;
    uint256 public  MINT_PRICE = 0.05 ether;
    uint256 constant public init_supply = 77;
    uint256 public totalInitialMinted;
    uint256 public mintingLimit=7;
   ...
   struct mintedData{
    ...
    constructor(address payable _collectionWallet) ERC721("Souls", "SOL") { 
    ...
    function InitMinting() internal  {
        require(totalInitialMinted<init_supply,"Legendary Total Minted Reached");
        ...
        minteddata.push(mintedData(msg.sender,init_supply));
    }
   ...
   function mintWhitelist(
    ...
    function mint(uint256 _count) public payable {
        ...
        require(totalSupply + _count <= MAX_SUPPLY, "MAX_SUPPLY_REACHED");
        require(msg.value >=(_count * MINT_PRICE), "INVALID_Matic_SENT");
        require(totalPublicMinted[msg.sender]+_count<=mintingLimit,"Maximum NFT Limit reached");
    ...
    function changeCollectionWallet(address payable _wallet) external onlyOwner{
