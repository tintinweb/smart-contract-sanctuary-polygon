...
interface IMarketplace {
    ...
    function getAllHistoryTypes()
        external
        view
        returns (HistoryType[] memory);

    function getHistoryTypeById(uint256 _typeId)
        external
        view
        returns (HistoryType memory);
    ...
    function royaltyCreator() external view returns (uint256);

    function royaltyMarket() external view returns (uint256);

    function setLabelPercents(LabelValue memory newLabelPercent)
        external;

    function setLabelValue(LabelValue memory newLabelValue)
        external;

    function setRoyaltyCreator(uint256 _royalty) external;

    function setRoyaltyMarket(uint256 _royalty) external;
