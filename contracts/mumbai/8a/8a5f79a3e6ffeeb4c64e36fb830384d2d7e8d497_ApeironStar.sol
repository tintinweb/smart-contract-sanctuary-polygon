    ...
    UUPSUpgradeable
{
    ...
    // Mapping from token ID to StarGenId
    ...
    function updateStarGen(uint256 _tokenId, uint256 _genId)
        ...
        onlyAdmin
    {
        starGenMap[_tokenId] = _genId;
        emit UpdateStar(_tokenId, _genId);
    }

    function getStarGen(uint256 _tokenId)
        external
        view
        returns (
            uint256, //starGen
    ...
    {
        return (starGenMap[_tokenId], _exists(_tokenId));
    }
