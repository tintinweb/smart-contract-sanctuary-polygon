 ...
 */
contract PioneerCertificate is ERC721URIStorage, Ownable {
    event Minted(address to, uint256 tokenId, string uri);
    event MintedBatch(address to, uint256 tokenId, string[] uris);
    ...
    function mintBatch(address _to, string[] memory _uris) external {
        require(_to != address(0), "Invalid address");
