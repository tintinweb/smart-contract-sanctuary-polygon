...
import "IVoiceDepositNotifier.sol";

/**
    @title Voice Deposit Notifier
    @notice forwards native currency received to the Voice API and logs received amounts
    @author John Dodson [email protected]
  */
contract VoiceDepositNotifier is IVoiceDepositNotifier, AccessControlUpgradeable, UUPSUpgradeable {
...
interface IVoiceDepositNotifier is IAccessControlUpgradeable {
