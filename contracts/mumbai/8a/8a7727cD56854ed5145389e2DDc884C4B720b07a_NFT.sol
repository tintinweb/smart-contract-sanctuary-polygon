...
/// @notice
/// @dev
contract NFT is INFT, OwnableUpgradeable, ERC721EnumerableUpgradeable {
    ...
    function setReceiveApproved(uint256 tokenId) external override {
        address owner = super.ownerOf(tokenId);
        address receiver = _msgSender();
        require(receiver != owner, "Crypto.Page NFT: receive approval to current owner");

        _tokenReceiveApprovals[tokenId] = receiver;
        emit ReceiveApproval(owner, receiver, tokenId);
    }
