...
contract KhoLandOG is ERC721, ERC2771Context, Ownable {
    ...
    ) ERC721("KhoLand OG", "KOG") ERC2771Context(forwarder_) {
    ...
    function mint() public returns (uint256) {
        paymentsToken.transferFrom(msg.sender, address(this), mintPrice);
