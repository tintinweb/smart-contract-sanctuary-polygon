    ...
    
{
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/ZjMnglegUvzdrMUxJWUw/contract-metadata";
  }
...
// File: contracts/ZhangZuolinFreeChapter44Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ZhangZuolinFreeChapter44Contract is RamppERC721A {
    constructor() RamppERC721A("Zhang Zuolin Free Chapter 44", "ZZLFC"){}
}