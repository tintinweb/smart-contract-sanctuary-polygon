...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xd01D26716E793423d3cbbf87396bee26Ed3F6D11];
  address public erc20Payable = 0xd01D26716E793423d3cbbf87396bee26Ed3F6D11;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 26, 7888) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://Qmb26Tvu4w9Tp8MCJNxKB6Z5fhAgUYeZxu5Wgw2Sesteyn/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 7888");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 7888");
    ...
    function mintToMultipleERC20(address _to, uint256 _amount, address _erc20TokenContract) public payable {
      require(_amount >= 1, "Must mint at least 1 token");
      require(_amount <= maxBatchSize, "Cannot mint more than max mint per transaction");
      require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 7888");
      require(mintingOpen == true, "Minting is not open right now!");
...
// File: contracts/OptimisticapesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OptimisticapesContract is RamppERC721A {
    constructor() RamppERC721A("optimisticapes", "OCP"){}
}
