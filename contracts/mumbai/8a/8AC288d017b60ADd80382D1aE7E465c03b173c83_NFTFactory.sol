...
contract NFTFactory is Ownable {
    ...
    mapping(address => bool) public whitelistSetFee;

    NFTWithPresaleWithRandomDelayed.randomConfig internal rConfig;

    modifier onlyWhitelistSetFee() {
        require(whitelistSetFee[msg.sender], "Invalid");
        _;
    }
    ...
    */
    ...
    function whiteListForSetFee(address _wl, bool value) external onlyOwner {
        whitelistSetFee[_wl] = value;
    }
