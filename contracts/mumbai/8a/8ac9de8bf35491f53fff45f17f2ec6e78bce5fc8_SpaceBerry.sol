...
| |    \ |  / ( ` )   '| ( ' )  |   | ( ' )  |       \  _. /  ' | ,_/  \__) /   '  \  \| (`' ) /     / ( ` )   ' 
| |____/ / . (_ o _)  ||(_ o _) /   |(_ o _) /        _( )_ .',-./  )       |___|  /  ||(_ ()_)     . (_ o _)  | 
|   _ _ '. |  (_,_)___|| (_,_).' __ | (_,_).' __  ___(_ o _)' \  '_ '`)        _.-`   || (_,_)   __ |  (_,_)___| 
|  ( ' )  \'  \   .---.|  |\ \  |  ||  |\ \  |  ||   |(_,_)'   > (_)  )  __ .'   _    ||  |\ \  |  |'  \   .---. 
| (_{;}_) | \  `-'    /|  | \ `'   /|  | \ `'   /|   `-'  /   (  .  .-'_/  )|  _( )_  ||  | \ `'   / \  `-'    / 
|  (_,_)  /  \       / |  |  \    / |  |  \    /  \      /     `-'`-'     / \ (_ o _) /|  |  \    /   \       /  
/_______.'    `'-..-'  ''-'   `'-'  ''-'   `'-'    `-..-'        `._____.'   '.(_,_).' `--'   `'-'     `'-..-'   
...
contract SpaceBerry is ERC1155, Ownable, ERC1155Supply {
    constructor() ERC1155("") {}
    uint256[] supplies = [500, 500, 500, 500];
        ...
        public
    {
        ...
        require(amount == 1, "Maximum of 1 mint per transaction");
        require(minted[id + 1] + amount <= supplies[id - 1], "Not enough supplies left");
