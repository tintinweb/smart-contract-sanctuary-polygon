...
// / / /_       __\ \_\/ / /_______\/ / /____\/ // / /    / / /      
// \_\___\     /____/_/\/__________/\/_________/ \/_/     \/_/   
...
contract Aeon is ERC1155, Ownable {
  string public name;
  ...
  function ownerMint(uint _amount) external onlyOwner {
    // We cannot mint more than the max Supply (like bored apes ;))
    require(totalSupply + _amount <= maxSupply, "Sold out, change quantity");
  ...
  function mint() public payable {
    ...
    // Increment total supply and wallet mints
    totalSupply++;
