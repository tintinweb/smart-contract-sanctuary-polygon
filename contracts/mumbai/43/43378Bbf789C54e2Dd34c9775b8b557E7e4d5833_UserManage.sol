...
interface IERC725Y is IERC165 {
     ...
     */
    function getData(bytes32 dataKey) external view returns (string memory dataValue);
     ...
     */
    function getData(bytes32[] memory dataKeys) external view returns (string[] memory dataValues);
     ...
     * Emits a {DataChanged} event.
     */
    function setData(bytes32[] memory dataKeys, string[] memory dataValues) external;
}
...
abstract contract ERC725YCore is OwnableUnset, ERC165, IERC725Y {
     ...
     * @inheritdoc IERC725Y
     */
    function setData(bytes32 dataKey, string memory dataValue) public virtual override onlyOwner {
...
contract UserManage {
        ...
        external
    {
        ...
        OazizCitizenship identity = new OazizCitizenship(msg.sender);
