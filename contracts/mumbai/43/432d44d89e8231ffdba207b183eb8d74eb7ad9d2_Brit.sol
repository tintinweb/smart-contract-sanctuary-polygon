...
contract Brit is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 48000000 * 10**12;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Britcoin";
    string private _symbol = "Brit";
    ...
    uint256 private numTokensSellToAddToLiquidity = 8000 * 10**12;
    ...
    constructor () public {
        ...
        // PancakeSwap V2 Router BSC mainnet address: 0x10ED43C718714eb63d5aA57B78B54704E256024E
    ...
    function removeAllFee() private {
        if(_RewardFee == 0 && _liquidityFee == 0 && _burnFee==0) return;
