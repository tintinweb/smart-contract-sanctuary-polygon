    ...
    function fulfillRandomWords(
        ...
        for (uint i=0; i< numWords; i++) {
            ...
            for (uint j=0; j<32; j++) {
                ...
                requestInfo storage requestBeingFulfilled = requestIndexToRequestInfo[requestIndex];
                requestBeingFulfilled.isFulfilled = true;
                requestBeingFulfilled.randomNumber = randomUint8s[j];
            }
        }
