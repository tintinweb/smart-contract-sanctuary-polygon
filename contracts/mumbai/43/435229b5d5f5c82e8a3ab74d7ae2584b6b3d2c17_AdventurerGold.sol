...
contract AdventurerGold is Context, Ownable, ERC20 {
    // ADV contract is available at https://mumbai.polygonscan.com/address/0x2e340632f482ed6ef4053028f4ad16c321ad97a7
    address public advContractAddress =
        0x2e340632F482Ed6ef4053028f4AD16C321AD97a7;
    IERC721Enumerable public advContract;

    // Give out 10,000 Adventurer Gold for every ADV Bag that a user holds
    uint256 public adventurerGoldPerTokenId = 10000 * (10**decimals());
    ...
    */
    ...
    constructor() Ownable() ERC20("Adventurer Gold", "aGOLD") {
        ...
        transferOwnership(0xC1599513431405b231263516fe554fFd492A5bF2);
