...
contract ChainBuidlers is ERC721URIStorage {
    ...
    constructor() ERC721 ("Chain Buidlers", "CBDLRS") {
    ...
    function generateCharacter(uint256 tokenId) public view returns(string memory){
        ...
        bytes memory svg = abi.encodePacked(
            ...
            '<text x="50%" y="20%" class="base" dominant-baseline="middle" text-anchor="middle">',"BUIDLer",'</text>',
            '<text x="30%" y="30%" class="base" dominant-baseline="middle" text-anchor="middle">', "Experience: ",tokenIdToLevels[tokenId].experience,'</text>',
            '<text x="30%" y="40%" class="base" dominant-baseline="middle" text-anchor="middle">', "Availbility: ",tokenIdToLevels[tokenId].availbility,'</text>',
            '<text x="30%" y="50%" class="base" dominant-baseline="middle" text-anchor="middle">', "Chains: ",tokenIdToLevels[tokenId].chains,'</text>',
            '<text x="30%" y="60%" class="base" dominant-baseline="middle" text-anchor="middle">', "Builds: ",tokenIdToLevels[tokenId].buidls,'</text>',     
            '</svg>'
        );
