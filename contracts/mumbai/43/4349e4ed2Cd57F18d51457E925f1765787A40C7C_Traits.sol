...
/**  
    * @title ForeverPudgyPenguin traits contract
...
contract Traits is Ownable {
    ...
    /**
        ...
        * @param _overwrite will overwrite old data if true, will push on top of other data if false
    */
    function uploadTraitTypes(string[] calldata _namesOfTraitTypes, bool _overwrite) external onlyOwner {
        if (_overwrite) delete traitTypes;
    ...
    */
     ...
     */
    function attributeForTypeAndValue(string memory _traitType, string memory _value) private pure returns (string memory) {
        return string(abi.encodePacked(
            '{"trait_type":"',
                _traitType,
                   '","value":"',
