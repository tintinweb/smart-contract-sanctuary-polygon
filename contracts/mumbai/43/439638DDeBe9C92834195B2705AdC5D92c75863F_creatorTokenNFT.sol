...
contract Erc721ProStoURIburnalblePausable is ERC721, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

   constructor(string memory _name, string memory _ticker,address _user) ERC721(_name,_ticker) {
...
contract Erc721ProStoURIburnalble is ERC721, ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;
