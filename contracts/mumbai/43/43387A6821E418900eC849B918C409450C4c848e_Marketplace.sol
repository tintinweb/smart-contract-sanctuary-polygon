...
contract Marketplace is Ownable, ReentrancyGuard, ERC1155Holder {
    ...
    constructor(uint256 _minIncrementForBids, uint256 _sellFeePercentage, address _walletReceivingSellFee, address _payTokenContract, address _NftsContract, address _ticketsContract) {
