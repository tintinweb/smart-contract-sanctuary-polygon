...
contract JustTestToken is ERC721Burnable, ERC721Enumerable, Ownable2Step {
    using Strings for uint256;
    ...
    /// @notice Safely mints a new NFT and assigns ownership to the specified address.
    ...
    /// @notice Provdes the token URI using URI prefix, suffix and token ID
    /// @param _tokenId Token identifier, it's assigned to a minted token
