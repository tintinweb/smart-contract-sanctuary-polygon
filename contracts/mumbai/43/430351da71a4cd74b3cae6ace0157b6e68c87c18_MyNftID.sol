...
contract MyNftID is ERC721 {
   ...
   // Mapping from token ID to Metadata Struct
    ...
    Metadata private _EmptyMetadata = Metadata("MyNftID","","https://MyNftID.vercel.app/logo512.png","https://MyNftID.vercel.app",attribute("DiscordID",""),attribute("DiscordAccount",""),attribute("TwitterAccount",""),attribute("eMailAccount",""));

    constructor() ERC721("MyNftID","MyID","https://MyNftID.vercel.app/metadata/80001/") {
        _admin = _msgSender();
        _writer = _msgSender();
    ...
    function GetWriter() public view onlyAdmin returns (address){
        return _writer;
    }
