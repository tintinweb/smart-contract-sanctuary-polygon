...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x4d6BFEab9252C92Db7c48779a13697a3eF6c0Bfc];
...
// File: contracts/MyTestProjectContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract MyTestProjectContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "My Test Project";
    string public symbol = "TESTP";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/GSd5aPsq2clcZ9UYH6ay/contract-metadata";
  }
