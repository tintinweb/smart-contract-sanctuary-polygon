...
contract NFTCollateral is AutomationCompatibleInterface, IERC721Receiver, FunctionsClient, ConfirmedOwner {
  ...
  // deprecated function (OPENSEA API does not support MATIC)
  ...
  // STEPS TO REPRODUCE VIDEO DEMO
  // 1. Comment 'require(nft.getApproved(tokenId) == address(this), "No approval for NFT");'
  // 2. Comment 'nft.safeTransferFrom(msg.sender, address(this), tokenId);'
