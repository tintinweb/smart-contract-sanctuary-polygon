    ...
    PausableUpgradeable
{
    ...
    mapping(address => uint256[]) public subscriptionByWallet;
    ...
    function addSubscription(
        ...
        subscriptionByWallet[subscription.wallet].push(subscriptionId);

        erc20Token.safeTransferFrom(msg.sender, address(this), depositAmount);
    ...
    function getAllSubscriptionByWallet(address _wallet)
        public
        view
        returns (uint256[] memory)
    {
        return subscriptionByWallet[_wallet];
    }
