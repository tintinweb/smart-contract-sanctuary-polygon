...
*/
contract LandRenting is OwnableUpgradeable {

    IBalanceVault public balanceVault;
    ILandNANFT public landNFT;
    ...
    function getLandDetails(address _landAddress, uint256 _landId) public view returns(uint256) {
    ...
    */
    function listLand(address _landAddress, uint256 _landId, uint256 _rentalPrice) public onlyLandOwner(_landId, _landAddress) {
        require(getUnclaimedFee(_landAddress, _landId) == 0, "[LandRenting.listLand] Need to claim remaining rental fee first");
        require(lands[_landAddress][_landId].owner == 0x0000000000000000000000000000000000000000, "[LandRenting.listLand] Land already listed");
    ...
    * @param _landId -  ID of prefered land.
    */
    function cancelListedOrder(address _landAddress, uint256 _landId) public onlyLandOwner(_landId, _landAddress) {
    ...
    * @param _rentalPrice -  prefered rental price per day.
    */
    function editListedOrder(address _landAddress, uint256 _landId, uint256 _rentalPrice) public onlyLandOwner(_landId, _landAddress) {
        lands[_landAddress][_landId].rentalPrice = _rentalPrice;
    }
    ...
    */
    function executeRent(address _landAddress, uint256 _landId, uint256 _rentalPeriod) public {
        require(lands[_landAddress][_landId].renter == 0x0000000000000000000000000000000000000000, "[LandRenting.executeRent] Land already rented");
        //pay rental price
    ...
    * @param _landId -  ID of prefered land.
    */
    function claimFee(address _landAddress, uint256 _landId) public onlyLandOwner(_landId, _landAddress) {
