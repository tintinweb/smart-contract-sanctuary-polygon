    ...
    BaseRelayRecipient
{
    ...
    string public name = "Mintlab NFT";
    ...
    constructor() ERC1155("https://metadata.mintlab.co/v1/{id}.json") {
    ...
    function _msgSender() internal override(Context) view returns (address ret) {
