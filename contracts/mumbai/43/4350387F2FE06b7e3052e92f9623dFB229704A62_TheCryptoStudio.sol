...
contract TheCryptoStudio is ERC1155
{
    ...
    function deleteSpaceArtist(string memory spaceName, address artist) public {
        ...
        string memory filters = string.concat("spaceName=",SQLHelpers.quote(spaceName)," and ","space_artist=",SQLHelpers.quote(Strings.toHexString(artist)));
        string memory delete_statement = SQLHelpers.toDelete(SPACE_ARTISTS_TABLE_PREFIX, space_artists_tableID, filters);
        runSQL(space_artists_tableID,delete_statement);
    }
