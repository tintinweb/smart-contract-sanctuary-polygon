...
contract RpgWarriors is ERC721Enumerable,ERC721URIStorage  {
  ...
  constructor() ERC721 ("RpgWarriorsTest1", "RPGWT1") {}

  function createWarrior(WarriorsLibrary.Warrior memory warrior) public {
...
library WarriorsLibrary {
  ...
  function _warriorToBase64Metadata(Warrior memory warrior) internal pure returns (string memory) {
    bytes memory dataUri = abi.encodePacked(
      ...
      '","image":"', warrior.image,
      '","attributes": [{ "trait_type":"',warrior.attributes[0].trait_type, '", "value":"', _raceToString(warrior.attributes[0].value),'"}]'
      ' }');
