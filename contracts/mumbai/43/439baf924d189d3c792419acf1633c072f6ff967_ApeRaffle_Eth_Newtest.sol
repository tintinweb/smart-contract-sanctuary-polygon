...
contract ApeRaffle_Eth_Newtest is ERC721A, Ownable {
    ...
    function mintApeRaffle(uint numberOfTokens) public payable {
        ...
        require(msg.value >= apePrice * numberOfTokens, "ETH value sent is too little for this many APERFL's");
        require(((addressesThatMinted[msg.sender] + numberOfTokens) * 100) <= ApeSup , "You have already minted in this 100 set");
