 ...
 */
abstract contract AntsAbstract is 
  Ownable,
  AccessControl, 
  ERC721BAbstract, 
  IERC721Metadata 
...
/**
 * @dev Specifics of the Ants collection
 */
contract PAnts is ReentrancyGuard, AntsAbstract {
  // ============ Constants ============
  ...
  uint256 public constant MINT_PRICE = 10 ether; // 10 MATIC
