...
contract Swap is Ownable {
  XOTIK swapToken;
  uint256 public maticPerTokenBuy  = 1.060400 * 10**18/10;
  uint256 public maticPerTokenSell = 1.060400 * 10**18/10;
  event BuyTokens(address buyer, uint256 amountOfMATIC, uint256 amountOfTokens);
  constructor(address tokenAddress) {
    swapToken = XOTIK(tokenAddress);
  }

  function buyTokens() public payable returns (uint256 tokenAmount) {
    require(msg.value > 0, "You need to send some MATIC to proceed");
    uint256 amountToBuy = msg.value * maticPerTokenBuy;
  ...
  function sellTokens(uint256 tokenAmountToSell) public {
    ...
    uint256 amountOfMATICToTransfer = tokenAmountToSell / maticPerTokenSell;
    ...
    (bool sent) = swapToken.transferFrom(msg.sender, address(this), tokenAmountToSell);
    require(sent, "Failed to transfer tokens from user to Swap");
...
contract XOTIK is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, ERC20SnapshotUpgradeable, OwnableUpgradeable, PausableUpgradeable, UUPSUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() {
        _disableInitializers();
    }
