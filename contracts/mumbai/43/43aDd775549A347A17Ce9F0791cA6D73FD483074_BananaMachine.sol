...
contract BananaMachine is VRFConsumer {
    ...
    /* solhint-disable var-name-mixedcase */
    IERC20Burnable private immutable _BANANA;
    /* solhint-enable var-name-mixedcase */
    ...
    constructor(
        ...
        _BANANA = IERC20Burnable(bananaAddress);
    ...
    // TODO: fix possible reentrancy vulnerability.
    function spin() external {
        uint256 _costPerSpin = costPerSpin;
        _BANANA.transferFrom(msg.sender, address(this), _costPerSpin);
        uint256 burnAmount = _calculatePercentage(_costPerSpin, burnPercentagePoints);
        _BANANA.burn(burnAmount);
    ...
    function fulfillRandomWords(uint256 requestId, uint256[] memory randomWords) internal override {
        ...
        if (number1 == number2 && number2 == number3 && number3 == number4) {
            ...
            _BANANA.transfer(players[requestId], winnings);
