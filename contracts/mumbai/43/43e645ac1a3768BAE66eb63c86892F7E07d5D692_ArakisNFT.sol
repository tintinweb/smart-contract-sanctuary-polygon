    ...
    OwnableUpgradeable
{
    ...
    function buyNft(
        ...
        require(redeemer != address(0), "RACZ"); //NOACZ : Redeemer address can't be zero address
        require(_voucher.nftAmount > 0, "ACZ"); //ACZ : Amount should be greater than zero
