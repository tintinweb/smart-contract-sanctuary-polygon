...
import "./generated/deploy/BaseCedarDeployerV2.sol";
import "./CedarERC721PremintV0Factory.sol";
import "./CedarERC721PremintV1Factory.sol";
import "./drop/CedarERC721DropV0Factory.sol";
import "./drop/CedarERC1155DropV0Factory.sol";

contract CedarDeployerV2 is Initializable, UUPSUpgradeable, OwnableUpgradeable, BaseCedarDeployerV2 {
    CedarERC721PremintV0Factory premintV0Factory;
    CedarERC721PremintV1Factory premintV1Factory;
    CedarERC721DropV0Factory drop721V0Factory;
    CedarERC1155DropV0Factory drop1155V0Factory;

    function initialize(
        CedarERC721PremintV0Factory _premintV0Factory,
        CedarERC721PremintV1Factory _premintV1Factory,
        CedarERC721DropV0Factory _drop721V0Factory,
        CedarERC1155DropV0Factory _drop1155V0Factory
    ) public virtual initializer {
        premintV0Factory = _premintV0Factory;
        premintV1Factory = _premintV1Factory;
        drop721V0Factory = _drop721V0Factory;
        drop1155V0Factory = _drop1155V0Factory;
    ...
    function deployCedarERC721DropV0(
        ...
        newContract = drop721V0Factory.deploy(_defaultAdmin, _name, _symbol, _contractURI, _trustedForwarders, _saleRecipient, _royaltyRecipient, _royaltyBps, _userAgreement);
    ...
    ) external override returns (ICedarERC1155DropV0 newContract) {
        newContract = drop1155V0Factory.deploy(_defaultAdmin, _name, _symbol, _contractURI, _trustedForwarders, _saleRecipient, _royaltyRecipient, _royaltyBps, _platformFeeBps, _platformFeeRecipient);

        (uint256 major, uint256 minor, uint256 patch) = newContract.implementationVersion();
        emit CedarInterfaceDeployed(address(newContract), major, minor, patch, "ICedarERC1155DropV0");
    }
    ...
    returns (
        ...
        return drop721V0Factory.implementationVersion();
    }
    ...
    returns (
        ...
        return drop1155V0Factory.implementationVersion();
    }
    ...
    function cedarERC721DropFeatures() public view override returns (string[] memory features) {
        return drop721V0Factory.implementation().supportedFeatures();
    }

    function cedarERC1155DropFeatures() public view override returns (string[] memory features) {
        return drop1155V0Factory.implementation().supportedFeatures();
    }

    // Concrete implementation semantic version - provided for completeness but not designed to be the point of dispatch
    function minorVersion() public virtual pure override returns (uint256 minor, uint256 patch) {
        minor = 0;
        patch = 0;
    }
}
...
// Filename: './BaseCedarDeployerV2.sol'
...
abstract contract BaseCedarDeployerV2 is ICedarDeployerV2 {
    ...
    function supportsInterface(bytes4 interfaceID) virtual override public view returns (bool) {
        return (interfaceID == type(IERC165Upgradeable).interfaceId) || (interfaceID == type(ICedarDeployerV1).interfaceId);
    }
}
