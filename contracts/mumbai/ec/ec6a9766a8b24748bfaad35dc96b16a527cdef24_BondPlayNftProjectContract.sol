...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x05DB2dBdADBBA9fcA240Ca6f5D75D5117EF8D66B];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmXxC4jZxbVhzty9FGTi5xBq7sBv7jkHa1x73gjhtauQnU/";
...
// File: contracts/BondPlayNftProjectContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BondPlayNftProjectContract is RamppERC721A {
    constructor() RamppERC721A("Bond  Play NFT Project", "BNP"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/skaIx7zbANawjsJft7EK/contract-metadata";
    }
}
