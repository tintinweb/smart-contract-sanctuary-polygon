...
contract CPOOL {
    ...
    function _transferTokens(
        ...
        require(
            src != address(0),
            "Cpool::_transferTokens: cannot transfer from the zero address"
        );
        require(
            dst != address(0),
            "Cpool::_transferTokens: cannot transfer to the zero address"
        );
        ...
        if (srcRep != dstRep && amount > 0) {
            if (srcRep != address(0)) {
                ...
                uint96 srcRepNew = sub96(
                    srcRepOld,
                    amount,
                    "Cpool::_moveVotes: vote amount underflows"
                );
            ...
            if (dstRep != address(0)) {
                ...
                uint96 dstRepNew = add96(
                    dstRepOld,
                    amount,
                    "Cpool::_moveVotes: vote amount overflows"
                );
