...
contract Web3RSVP {
    ...
    function createNewRSVP(bytes32 eventId) external payable {
        // look up envent from our mapping
        CreateEvent storage myEvent = idToEvent[eventId];

        // transfer deposit to our contract / require that they send in enough ETH
        // to cover deposit requirement of this specific event
        ...
        // require ths msg.sendr isn't already in myEvent.confirmedRSVPs AKA
    ...
    function confirmAttendee(bytes32 eventId, address attendee) public {
        // look up event from our strcut using the eventId
        CreateEvent storage myEvent = idToEvent[eventId];

        // require msg.sender is the owner of the event
        ...
        // AKA make sure they haven't already check in
    ...
    function withdrawUnclaimedDeposits(bytes32 eventId) external {
        ...
        // calculate how many people didn't claim by camparing
