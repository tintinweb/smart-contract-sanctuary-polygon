...
contract RxNftMinter is ERC721, Ownable {
    ...
    function _createScript(
        ...
        mintRx(_rx.patient_wallet, rx_tokenCounter);
    ...
    function mintRx(
        address _to,
        uint256 _rx_tokenCounter // string memory _uri // string memory _patient, // string memory _description, // string memory _medication,
    ) public // string memory _dob,
    // string memory _quantity
    {
