...
contract Factory is AccessControl {
    ...
    function deployMintingContract(address _roleAddress, address _validatorAddress) public  {
        require(hasRole(DEPLOYER_ROLE, msg.sender), "0x001");
        NFT nftContract = new NFT(_roleAddress, _validatorAddress);
...
contract NFT is ERC721URIStorage, EIP712, AccessControl {
    ...
    ) ERC721("KwikTrust", "KTX") EIP712(SIGNING_DOMAIN, SIGNATURE_VERSION) {
