...
contract myVault {
  ...
  /* goerli Addresses */
  /*
  address public daiAddress = 0x11fE4B6AE13d2a6055C8D9cF65c55bac32B5d844;
  ...
  */
  ...
  address public daiAddress = 0x326C977E6efc84E512bB9C30f76E30c160eD06FB;//link
  address public wethAddress = 0xA6FA4fB5f76172d178d61B04b0ecd319C5d1C0aa;
  address public uinswapV3QuoterAddress = 0xb27308f9F90D607463bb33eA1BeBb41C27CE5AB6;
  address public uinswapV3RouterAddress = 0xE592427A0AEce92De3Edee1F18E0157C05861564;
  address public chainLinkETHUSDAddress = 0x0715A7794a1dc8e42615F059dD6e406A6594651A;
  ...
  function getDaiBalance() public view returns(uint) {
    uint x = daiToken.balanceOf(address(this));
    console.log("dai", x);
    return x;
  }

  function getWethBalance() public view returns(uint) {
    uint x =  wethToken.balanceOf(address(this));
    console.log("weth", x);
    return x;
  }
  ...
  function rebalance() public {
    ...
    console.log("q", usdBalancePercentage);
  ...
  function wrapETH() public {
    ...
    console.log("v", address(this).balance);
    wethToken.deposit{ value: ethBalance }();
    console.log("y", address(this).balance);
  }
