...
contract CollectionProxyOLD is Initializable, ERC721Upgradeable {
    ...
    function initialize(address _marketplaceScAdr, address payable _collectionCreator) public initializer {
