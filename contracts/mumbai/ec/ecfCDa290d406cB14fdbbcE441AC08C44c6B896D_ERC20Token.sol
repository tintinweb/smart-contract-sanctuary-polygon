...
/**
 * @dev ERC20Token implementation with Burn, Pause, Recover capabilities
 */
contract ERC20Token is ERC20Base, ERC20Burnable, ERC20Pausable, Ownable, Recoverable, FeeProcessor {
    constructor(
        string memory name_,
        ...
        FeeProcessor(feeReceiver_, 0xf7089acb979c3245f62146e3c1428acf138aa1ad2231cc28446c9924e5c01026)
    {
