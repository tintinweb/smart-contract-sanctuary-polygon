...
contract Factory {
    ...
    function createToken_721(
        ...
        NFT721 token = new NFT721(_name, _symbol, _uri);
    ...
    function createToken_1155(
        ...
        NFT1155 token = new NFT1155(_name, _symbol, _uri);
...
contract NFT721 is ERC721Enumerable, AccessControl {
    ...
    function mintBatch(address[] calldata tos, string[] memory tokenURIs)
        external
        onlyRole(MINTER_ROLE)
        returns (uint256)
    {
...
contract NFT1155 is ERC1155, AccessControl {
    ...
    function mintBatch(
        ...
        require(_tokenURIs_batch.length == quantities.length, "Mismatched array lengths");
