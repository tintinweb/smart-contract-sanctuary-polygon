...
contract CommonNFT is ERC721URIStorageUpgradeable, OwnableUpgradeable {
    ...
    function mint() external {
        ...
        require(mintedCount < totalSupply, "Overflow count of Common NFT");

        uint256 price = 100 + 10 * mintedCount;
