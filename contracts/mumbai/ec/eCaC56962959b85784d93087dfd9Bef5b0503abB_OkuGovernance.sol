...
contract OkuSignature is EIP712Upgradeable{
    ...
    function _hash(OkuGroup memory okuGroup) internal view returns (bytes32) {
        return _hashTypedDataV4(keccak256(abi.encode(
                keccak256("OkuGroup(address _userAddress,address _nftAddress,uint256 amount,uint96 fee,bool isMatic,uint256 nonce)"),
                    okuGroup._userAddress,
...
interface IERC1155upgradeable is IERC165Upgradeable{
    ...
    */
    ...
    contract OkuGovernance is OwnableUpgradeable,OkuSignature{
        ...
        function initialize(address _stableCoin , address _Signer, string memory __domain, string memory __version ) external initializer{
        ...
        function buyNFT(string memory Collection, string memory uri, OkuGroup memory oku ) external payable returns(uint){
            ...
            if(oku.isMatic){
             ...
             getUsersTotalMaticInvestment[msg.sender][oku._nftAddress]+=msg.value;
                ...
                stableCoin.transferFrom(msg.sender, address(this),oku.amount);
                price=oku.amount;
        ...
        function setStableCoin(address _tokenAddress) external onlyOwner{
            stableCoin=IERC20Upgradeable(_tokenAddress);
        }
