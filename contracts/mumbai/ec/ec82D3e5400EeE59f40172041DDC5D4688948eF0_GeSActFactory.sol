...
import "@openzeppelin/contracts/utils/Context.sol";
import "../permissions/PermissionsOverwriter.sol";
import "./GeSAct20v1.sol";

contract GeSActFactory is Context, PermissionsOverwriter {
    ...
    constructor(IPermissions55 permissions_) PermissionsOverwriter(permissions_, 0) {
        _owner = _msgSender();
    }
    ...
    function create(
        ...
        GeSAct20v1.ContractParameters calldata params
    ) external {
        _checkRole(TOKEN_ROLE_DEPLOYER);

        GeSAct20v1 token = new GeSAct20v1(_permissions, permissionSetId, name, symbol, denomination, params);
