...
contract DaoAdmin is BaseContract {
    ...
    function setDaoAmount(uint256 _dao1Amount, uint256 _dao2Amount, uint256 _dao3Amount, uint256 _dao4Amount) external onlyOwner {
        dao1Amount = _dao1Amount;
        dao2Amount = _dao2Amount;
        dao3Amount = _dao3Amount;
        dao4Amount = _dao4Amount;
    }
