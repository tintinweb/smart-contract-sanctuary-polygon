...
//----------Voting
    ...
    function createProposal(
        ...
        ProposalList[proposalCounter] = Proposal(msg.sender,title,description,0,0,startDate,endDate,proposalURI);
    ...
    function addData(
        ...
        dataList[dataFileCounter] = dataStructure(dataFileCounter,title,msg.sender,block.timestamp,dataURI,fileURI,groupId,dataType,assymetricKey);
