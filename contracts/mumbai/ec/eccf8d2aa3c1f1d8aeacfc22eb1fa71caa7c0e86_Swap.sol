...
contract Swap is IUniswapV2CustomRouter {
    ...
    */
    ...
    /**
     *
     * @notice converts the fees in decimals in terms of numerator and denominator for easy 
       calculation and avoiding overflows
       @return numerator nummerator of fees 
       @return denominator denominator of fees
       @param fees gie app fees
    */
    ...
    */
    function calculateFeesForTransaction(
        ...
        uint gieNum; 
        uint gieDen;
        (gieNum, gieDen) = convertToFraction(gieAppFees);
        gieAppFee = (amount * gieNum) / (gieDen * 100);
    }
