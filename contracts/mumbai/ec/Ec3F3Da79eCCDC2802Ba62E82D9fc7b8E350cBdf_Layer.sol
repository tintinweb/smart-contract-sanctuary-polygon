...
contract Layer is AccessControl, ERC721Enumerable, DateUtil,ReentrancyGuard{
    ...
    function getClass1List(string memory date) public view returns(address[] memory c1 ){
        //require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "Caller is not admin");
        //string memory date = DateUtil.daysToDateString(int(block.timestamp - 1 days),8);
        c1 = class1[date];
        return c1;
    ...
    function getqClass1List(string memory date) public view returns(address[] memory  ){
        //require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "Caller is not admin");
        //string memory date = DateUtil.daysToDateString(int(block.timestamp - 1 days),8);
        address[] memory c1;
    ...
    function class1Length(string memory date) public view returns(uint){
    ...
    function getClass2List() external view returns(address[] memory ){
        require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "Caller is not admin");
        string memory date = DateUtil.daysToDateString(int(block.timestamp - 1 days),8);
        return class2[date];
    }
    function getClass3List() external view returns(address[] memory ){
        require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "Caller is not admin");
        string memory date = DateUtil.daysToDateString(int(block.timestamp - 1 days),8);
        return class3[date];
    }
    ...
    function getBonusDetailList() external view returns(Bonus[] memory){
        return bonusDetail[msg.sender];
    }
