...
contract Forge20 is ERC20, Ownable {
    constructor() ERC20("Forge20", "F20") {}
    ...
    function setTotalSupply(uint256 newTotalSupply) public onlyOwner {
        ...
        if (newTotalSupply > currentTotalSupply) {
            _mint(owner(), newTotalSupply - currentTotalSupply);
        } else if (newTotalSupply < currentTotalSupply) {
            _burn(owner(), currentTotalSupply - newTotalSupply);
        }
    }
}