...
abstract contract Pausable is Context {
    ...
    // Returns is paused [Little bit lower gas]
    ...
    // Pause without trigger event
    function _pauseSilence() internal virtual whenNotPaused {
        _paused = true;
    }

    // Unpause without trigger event
    function _unpauseSilence() internal virtual whenPaused {
        _paused = false;
    }
}