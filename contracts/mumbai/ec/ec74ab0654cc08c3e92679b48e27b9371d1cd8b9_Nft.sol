...
contract Nft is ERC721, Ownable {
    mapping(uint => string) s_tokenIdToTokenURI;
    uint256 public s_tokenId;
    event TokenMinted(address to, uint256 tokenId);

    constructor() ERC721("Neoverse Land", "LAND"){}
    
    function setTokenURI(uint _tokenId, string memory _tokenURI) internal {
        s_tokenIdToTokenURI[_tokenId] = _tokenURI;
    }

    function _mintLand(address _to, string memory _tokenURI) external onlyOwner {
