    ...
    PausableUpgradeable
{
    ...
    function stakeInLocked(uint256 _amount) external nonReentrant {
        ...
        emit UpdateLockedStake(lockedPool.totalLockedTokens);
    }
    ...
    function stakeInFlexible(uint256 _amount) external nonReentrant {
        ...
        emit UpdateFlexibleStake(flexiblePool.totalLockedTokens);
    }
    ...
    event UpdateLockedStake(uint256 totalStake);
    event StakedInFlexible(address indexed user, uint256 amount);
    event UpdateFlexibleStake(uint256 totalStake);
