...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     * construction.
     */
    function setup(string memory name_, string memory symbol_) internal {
        _name = name_;
        _symbol = symbol_;
    }
...
contract EquityToken is ERC20, Ownable {
    ...
    function setupToken(string memory name_, string memory symbol_) public {
        super.setup(name_, symbol_);
    }
}
    ...
    GuardManager
{
    ...
    uint256 private constant INTIAL_TOTAL_EQUITY = 100_000_00;
    ...
    /// @param _equities List of equities.
    ...
    function setup(
        ...
        setupEquityStructure(_owners, _equities, INTIAL_TOTAL_EQUITY);
        ...
        emit SafeSetup(msg.sender, _owners, 0, to, fallbackHandler);
    }
    ...
    function checkNSignatures(
        ...
        for (i = 0; i < ownerCount; i++) {
            ...
            // equity += 1;
            equity += getStake(currentOwner);
            if (equity > 50) break;
        }
        require(equity > 50, "PUTER02");
    }
