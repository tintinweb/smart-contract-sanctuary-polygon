 ...
 * @dev Represents a collection
  ...
  * @dev Fired in addCollection()
  ...
  function mint(address _to, uint256 _tokenId, uint8 _cardType, uint16 _cardCollection) public  validCardType(_cardType) onlyRole(MINTER_ROLE){
 ...
 * @notice Add new collection to cardCollectionInfo mapping
   ...
   */
  function addCollection(uint16 _collection, address _collectionAddress, uint256 _collectionPrize) external onlyOwner {
