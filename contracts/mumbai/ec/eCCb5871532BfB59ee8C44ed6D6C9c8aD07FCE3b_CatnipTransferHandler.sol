...
contract CatnipTransferHandler is ICatnipTransferHandler, Ownable {
    ...
    function setBlacklistTo(address _address, bool permission)
        public
        onlyOwner
    {
        blacklistTo[_address] = permission;
    }

    //prevent someone from sending tokens
    function setBlacklistFrom(address _address, bool permission)
        public
        onlyOwner
    {
        blacklistFrom[_address] = permission;
    }

    //prevent someone from sending and receiving tokens
    function setBlacklist(address _address, bool permission) public onlyOwner {
        setBlacklistFrom(_address, permission);
        setBlacklistTo(_address, permission);
    }
