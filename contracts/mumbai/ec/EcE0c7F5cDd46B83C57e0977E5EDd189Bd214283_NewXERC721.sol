...
// 0xaEe78b8306bB31057bE720819B5E8E3063C8a917
// 0xCD7925309A21740BA3C115877b857088A8740433
/// @title XERC721
...
contract NewXERC721 is ERC721, ERC721URIStorage, IDapp {
        ...
        ERC721("ERC721", "ERC721")
    {
        ...
        gatewayContract.setDappMetadata(
            "0xAb771C0e0C33b8794BdE3a79568D829De399C094"
        );
    }
    ...
    function transferCrossChain(
        ...
        TransferParams calldata transferParams // bytes calldata requestMetadata
    ) public payable {
        require(
