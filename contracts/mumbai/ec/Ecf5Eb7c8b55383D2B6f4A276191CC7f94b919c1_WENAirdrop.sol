...
contract WENAirdrop is Ownable, ReentrancyGuard {
     ...
     */
    constructor(address token_, uint256 duration_) {
    ...
    function claim(uint256 _amount, bytes32[] memory _proof) external nonReentrant {
        ...
        createVestingSchedule(msg.sender, _amount, _released);
    ...
    function _computeReleasableAmount(VestingSchedule memory vestingSchedule) 
        ...
        if (currentTime >= vestingSchedule.start + _duration) {
            ...
            // Compute the proportion of time that has passed, in relation to the vesting duration
