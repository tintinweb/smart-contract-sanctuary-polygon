...
contract Pledge is IERC721ReceiverUpgradeable, OwnableUpgradeable {
    ...
    function setUserStore(uint256 _store) public 
    {
        userStore[_msgSender()] += _store;
    }
    ...
    function setEventsInfo(uint256 _period, uint256 _start, uint256 _end, uint256 _done, uint256 _max, uint256 _win, uint256 _loss, uint256 _store) public 
    {
    ...
    function firstAdd() internal 
    {
        EventInfo memory o = EventInfo({
            period: 1,
            startTime: 1667232000, //22.11.1
            endTime: 1669824000, //22.12.1
            done: 0, 
            max: 5, 
            win: 1, 
            loss: 2, 
        ...
        periodEventInfos[1] = o;
        eventArray.push(o);
    }

    function secAdd() internal 
    {
        EventInfo memory o = EventInfo({
            period: 2,
            startTime: 1669824000, //22.12.1
            endTime: 1672502400, //23.1.1
            done: 0, 
            max: 5, 
            win: 300, 
            loss: 300, 
        ...
        periodEventInfos[2] = o;
        eventArray.push(o);
    }

    function thAdd() internal 
    {
        EventInfo memory o = EventInfo({
            period: 3,
            startTime: 1672502400, //23.1.1
            endTime: 1675180800, //23.2.1
            done: 0, 
            max: 5, 
            win: 300, 
            loss: 300, 
