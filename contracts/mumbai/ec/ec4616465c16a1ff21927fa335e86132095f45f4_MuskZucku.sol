...
contract MuskZucku is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 420_696_024 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    
    uint256 public swapTokensAtAmount = 500_000 * 10**_decimals;
    
    uint256 public maxSellAmount = 4_206_024 * 10**_decimals; // 1%
    uint256 public maxBuyAmount = 4_206_024 * 10**_decimals; // 1%
    uint256 public maxWalletBalance = 12_620_880 * 10**_decimals; // 3%

    address public marketingAddress = 0xAa0fd0e93C76A4A0342972fBd94544BAC8c83Ef3;

    string private constant _name = "MuskZucku";
    string private constant _symbol = "MuskZ";
    ...
    Taxes public Buytaxes = Taxes(1,2,1);
