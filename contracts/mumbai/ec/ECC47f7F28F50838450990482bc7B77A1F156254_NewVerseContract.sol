...
contract NewVerseContract is ERC721, ERC2981, ERC721Enumerable, IMintableERC721, AccessControl, Ownable {
    ...
    */
    ...
    // function setRoyaltyInfo(address receiver, uint96 fee) external onlyRole(DEFAULT_ADMIN_ROLE) {
...
contract NewVerseStakingContract is IERC721Receiver, ReentrancyGuard {
    ...
    */
    ...
    constructor(NewVerseContract _newVerseContract) {
    ...
    function unstake(uint256 _tokenId) external {
        ...
        stakingTime[msg.sender][_tokenId] += (block.timestamp -  stakes[msg.sender][_tokenId]);
