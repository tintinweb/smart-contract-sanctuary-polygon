...
contract StepsHunter is ChainlinkClient, ConfirmedOwner, AutomationCompatibleInterface {
    ...
    uint constant chainlinkRequestCostAmount = 200000000000000000; // 0.2 Ether
    ...
    function createGoal(
       ...
       uint newGoalId = _goalIds.current();
        ...
        uint totalGoalPayment = stepsHunterGoalFee + totalGoalChainlinkRequestsCostAmount + goal.betAmount + minChainlinkAutomationUpkeepFundBalance;
