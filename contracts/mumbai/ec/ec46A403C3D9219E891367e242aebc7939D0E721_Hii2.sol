...
contract Hii2 is ERC1155, Ownable, ERC1155Supply, ReentrancyGuard {
    ...
    function hi (address[] calldata recipients, uint256 _tokenId) public onlyOwner {
        require(!paused, "Contract is paused");
        require(recipients.length > 0, "Need some addresses to airdrop");
