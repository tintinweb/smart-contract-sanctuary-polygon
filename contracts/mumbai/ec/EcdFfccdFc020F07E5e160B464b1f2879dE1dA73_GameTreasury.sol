...
contract GameTreasury is AccessControl, Ownable{
  ...
  function upgradeCommission (address _to, uint256 value) public onlyRole(TREASURER_ROLE){
    payable(_to).send(value);
  }

  function mintFee (address _to, uint256 value) public onlyRole(TREASURER_ROLE){
    payable(_to).send(value);
  }
  ...
  function refundCommit (address _to, uint256 value) public onlyRole(TREASURER_ROLE){
