...
contract FaketownTown is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize(uint256 maxSupply_) public initializer {
        __ERC721_init("Faketown Town", "FTWN");
    ...
    /**
     * @notice Sets the base uri for the token. Can only be editable by owner.
     */
