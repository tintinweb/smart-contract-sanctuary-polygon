...
/**
 * Random number generator based off of Kenshi VRF
 *
 * This class is based off of Kenshi's reference implementation
 */
contract KenshiRandomizer is
    IRandomizer,
    ERC165,
    KenshiVRFConsumer,
    GameRegistryConsumer
{
    ...
    constructor(
        ...
        // Don't verify and don't emit events
        setVRFConfig(_vrfCoordinator, false, true);
    }
    ...
    function setVRFConfig(
        ...
        setupVRF(vrfCoordinator, shouldVerify, silent);
    }
     ...
     * @param randomWord  Word generated by VRF
     */
...
abstract contract KenshiVRFConsumer {
    /* Contracts */
    ...
    /** Returns config for the randomizer */
    function getVRFConfig()
        external
        view
        returns (ICoordinator vrfCoordinator, bool shouldVerify, bool silent)
    {
