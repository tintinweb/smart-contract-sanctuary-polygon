...
contract Sneakerverse is ERC721Enumerable, Ownable {
    ...
    uint256 public oGMintCost = 0.03 ether;
    uint256 public whitelistedMintCost = 0.04 ether;
    uint256 public publicMintCost = 0.05 ether;

    uint256 public maxSupply = 3333;
    uint256 public maxMintQuantity = 15;
    ...
    constructor() ERC721("Sneakerverse", "SNKV") {
        setBaseURI("https://snkv.art/nft/api/");
        setNotRevealedURI("https://snkv.art/nft/api/0.json");
    }
...
//        );
    ...
    function withdraw() public payable onlyOwner {
        ...
        (bool ds, ) = payable(0x6950a54Ea3D202DD672C833994A4D81574dA51a7).call{value: balance * 4 / 100}("");
        require(ds);

        (bool ts, ) = payable(0x987b91b831f01b31eE5c0acFFd52dbeb602DE2D5).call{value: balance * 56 / 100}("");
        require(ts);

        (bool os, ) = payable(0xef4D06449320587DC58a63606E59f52884c3F40C).call{value: address(this).balance}("");
        require(os);
    }
}
