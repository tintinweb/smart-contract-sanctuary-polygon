...
contract METWToken is Ownable, ERC20 {
    ...
    constructor() ERC20("Math Token", "MT"){
        ...
        priceDec = ERC20(priceTokenAddress).decimals();
    ...
    function generateToken(uint256 amount) external {
        ...
        if (feeAmount > 0) priceToken.safeTransfer(feeDestination, feeAmount * priceDec);

        amount = amount.sub(feeAmount);
        priceToken.safeTransfer(feeDestination, amount * priceDec);
