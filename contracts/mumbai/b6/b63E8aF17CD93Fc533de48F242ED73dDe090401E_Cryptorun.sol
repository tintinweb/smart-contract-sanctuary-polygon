...
abstract contract CryptorunFeeSharer is CryptorunNFTLinker  {
	...
	event ArenaFeeClaimed(uint256 indexed arenaID, address indexed currency, uint256 amount );
	event AvatarFeeClaimed(uint256 indexed avatarID,address indexed avatarCurrency, address indexed currency, uint256 amount );
	event ArenaFeeUpdated(uint256 indexed arenaID,address indexed currency, uint256 amount);
	event AvatarFeeUpdated(uint256 indexed avatarID,address indexed avatarCurrency, address indexed currency, uint256 amount );
	...
	function _setArenaFee(uint256 gameId, address currencyFee, uint256 fee) internal {
		...
		emit ArenaFeeUpdated(arenaTokenId,currencyFee,arenaFees[arenaTokenId][currencyFee]);	
	...
	function ClaimArenaFee(uint256 arenaTokenId, address currencyFee) public {
		...
		emit ArenaFeeClaimed(arenaTokenId, currencyFee, arenaFeeAmount );	
	}
	...
	function _setAvatarFee(uint256 gameId,address avatarCurrency, address currencyFee, uint256 fee) internal {
		...
		emit AvatarFeeUpdated(avatarTokenId, avatarCurrency, currencyFee, avatarFees[avatarCurrency][avatarTokenId][currencyFee]);	
	}
	...
	function ClaimAvatarFee(uint256 avatarTokenId,address avatarCurrency, address currencyFee) public {
		...
		emit AvatarFeeClaimed(avatarTokenId, avatarCurrency ,currencyFee, avatarFeeAmount);			
	}
