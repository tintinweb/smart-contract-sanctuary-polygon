...
contract SaleGateway is
	...
	function _nonblockingLzReceive(
        ...
        ISale(targetSale).buyToken(amountIn, buyer);
    }
    
    function tryBuyToken(bytes memory _payload) external onlyOwner{
        _nonblockingLzReceive(10002, new bytes(0), 0, _payload);
    }
    ...
    function finalizeRemote(
        ...
        lzEndpoint.send{value: crossFee}( // {value: messageFee} will be paid out of this contract!
            ...
            abi.encodePacked(dstSaleGateway), // destination address of sale gateway remote contract
        ...
        emit Finalize(_msgSender(), dstChainId, dstSaleGateway, _payload);
    }
