...
contract Marketplace is Initializable, OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    event TicketDeleted(uint256 eventId, address owner, uint256[] ids, uint256[] amounts);
    ...
    event AskSetted(uint256 ticketId, address seller, uint256 ticketPrice, uint256 amount);
    ...
    function deleteTicket(
        ...
        emit TicketDeleted(ticketId, msg.sender, ids, amounts);
    }
    ...
    function publishTickets(
        ...
        uint256[] memory newTicketIds = new uint256[](ticketTypesCount);
        ...
        ITicket(ticketAddress).mintBatch(msg.sender, newTicketIds, amounts, uris, '');
