...
contract TestNft is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, OwnableUpgradeable {
    function initialize() public initializer {
        __ERC721_init("TEST NFT", "TEST");
        __Ownable_init_unchained();
    }
    ...
    function burn(uint256 _tokenId) external onlyOwner {
        require(_msgSender() == ownerOf(_tokenId), "no permission");
        _burn(_tokenId);
    }
