    ...
    DefaultOperatorFiltererUpgradeable // Opensea onchain royalty handler
{
    ...
    */
    ...
    // ! Add new token here - only owner can update the token here
    function updateToken(uint256 _tokenId, uint256 _totalSupply, uint256 _salePrice) public onlyOwner {
        updateToken(_tokenId, _totalSupply, _salePrice);
    }
    ...
    function _canUpdateToken() internal view returns (bool) {
