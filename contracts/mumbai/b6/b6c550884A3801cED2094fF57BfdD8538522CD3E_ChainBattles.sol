...
// Contract deployed to 0xb6c550884A3801cED2094fF57BfdD8538522CD3E
...
contract ChainBattles is ERC721URIStorage  {
    ...
    function train(uint256 tokenId) public {
        ...
        uint256 hpIncrease = 1 + random(1);
        tokenIdToVariables[tokenId].hp = currentHp + hpIncrease;
        uint256 currentStrength = tokenIdToVariables[tokenId].strength;
        uint256 strengthIncrease = 1 + random(1);
        tokenIdToVariables[tokenId].strength = currentStrength + strengthIncrease;
        uint256 currentSpeed = tokenIdToVariables[tokenId].speed;
        uint256 speedIncrease = 1 + random(1);
        tokenIdToVariables[tokenId].speed = currentSpeed + speedIncrease;
