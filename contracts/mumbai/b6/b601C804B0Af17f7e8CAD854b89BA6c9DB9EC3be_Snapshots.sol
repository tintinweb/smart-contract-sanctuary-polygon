...
contract Snapshots is ISnapshots, ERC1155Supply, Ownable {
    ...
    mapping(uint256 => SnapshotData) public snapshotData;
    ...
    function createSnapshot(
        ...
        require(world.inWorldBounds(x, y), "Snapshots: out of world bounds");

        (int256 cellX, int256 cellY) = world.belongsToCell(x, y);

        uint256 diameter_CU = (2 * radiusInCells + 1);
        ...
        snapshotData[snapShotID] = SnapshotData(
            x,
            y,
            radiusInCells,
...
struct SnapshotData {
    ...
    uint256 placedElementsCount; // v momente vytvorenie snapshotu
