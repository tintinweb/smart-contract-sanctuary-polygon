...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0xE4bdAe5037c8f7a3DfD87568cE8f81eD015cd56a];
  address public erc20Payable = 0xE4bdAe5037c8f7a3DfD87568cE8f81eD015cd56a;
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 10) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeicvipwzduiz72ldmm4tlxct6u5buyzhf77qhi3mdgtjnqqsezwxyy/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/UvbYsd8CAtRyNnivf6QP/contract-metadata";
  }
...
// File: contracts/PruebanftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PruebanftContract is ERC721APlus {
    constructor() ERC721APlus("prueba nft", "prb"){}
}
  /*******************************************************/
  /*                                                     */
