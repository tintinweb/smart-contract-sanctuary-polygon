...
interface IAutomate {
    ...
    function depositGelatoFunds(uint256 _amount) external;
}
...
library LibAutomate {
    ...
    function _depositGelatoFunds(uint256 _amount) internal {
        _storageAutomate().taskTreasury.depositFunds{value: _amount}(
            address(this), // TODO: CHECK if this is the diamond proxy's address (main address), if not change this line of code !!
            _storageAutomate().eth,
            _amount
        );
    }

    function _testGetThisAddr() internal view returns (address) {
        return address(this);
    } // TODO: remove after test

    // TODO: implement _storageAutomate().taskTreasury.userTokenBalance
    // TODO: implement _storageAutomate().taskTreasury.totalUserTokenBalance
    // TODO: whats the diff? userTokenBalance vs totalUserTokenBalance ?
}
...
library LibDiamond {
    ...
    function _addFacet(StorageDiamond storage s, address _facetAddress)
        internal
    {
...
contract DiamondInit {
    function init() external // address _gelatoOps,
