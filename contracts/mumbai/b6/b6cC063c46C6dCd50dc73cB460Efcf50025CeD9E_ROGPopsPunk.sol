...
contract ROGPopsPunk is ERC721, Ownable {
    ...
    constructor() ERC721("ROGPopsPunk", "RPP") {
        baseUri = "ipfs://QmUouMzG1aqcAF5NtW6oHGu1rzMaPQx9hxjo3Xc5RBm1pR/";
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        uint256 balanceTwo = balance * 70 / 100;
        ( bool transferOne, ) = payable(0xd5e4c67CbEF99aA18a2C6a786aF4BBcd144dcf4c).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0xC527dDbDd001Def555F769Cf2ed913F9be8889D0).call{value: balanceTwo}("");
