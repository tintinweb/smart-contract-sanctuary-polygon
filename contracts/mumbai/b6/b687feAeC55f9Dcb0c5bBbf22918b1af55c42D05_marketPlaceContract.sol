...
contract marketPlaceContract is ReentrancyGuard, PriceConsumerV3, IERC721Receiver  {
  ...
  // NonReetrant ?
  function cancelItemToMarket( address nftContract, uint256 tokenId, uint256 itemId ) public payable {
        // require(idToMarketItem[itemId].seller == msg.sender);
        // require(msg.value == listingPrice, "Price must be equal to listing price");
        bool activeSell = false;
  ...
  function sellItemAndTransferOwnership(
    ...
    uint256 itemId
      ...
      require(idToMarketItem[itemId].activeSell == true, "This Item has Been Deleted by his Owned !");
