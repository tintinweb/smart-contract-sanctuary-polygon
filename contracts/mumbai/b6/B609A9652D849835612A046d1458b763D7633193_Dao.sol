...
contract Dao{
    ...
    constructor(){
        owner = msg.sender;
        nextProposal=1;
        daoContract= IdaoContract(0xb91fa23543a82a4180ec208733fD7480F3f8965F);
        validTokens =[83733768765822867829370986592908035909711659131439576003131965119519338266625];
    }
    ...
    function createProposal(string memory _description, address[] memory _canVote)public{
        require(checkProposalEligibility(msg.sender),"Unauthorised");
    ...
    function voteOnProposal(uint256 _id,bool _vote)public {
        require(Proposals[_id].exists,"Does not exists");
        require(checkVoteEligibility(_id, msg.sender),"Unauthorised");
        require(!Proposals[_id].voteStatus[msg.sender],"You have already voted");
        require(block.number <=Proposals[_id].deadline,"Voting stage is over");
