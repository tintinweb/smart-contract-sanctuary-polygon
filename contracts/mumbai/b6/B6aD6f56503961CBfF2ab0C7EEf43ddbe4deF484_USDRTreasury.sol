...
contract USDRTreasury is AddressAccessor, ITreasury, IERC721Receiver {
        ...
        returns (ITreasury.TreasuryValue memory value)
    {
            ...
            );
        {
            ...
            ITreasury.CalcValue memory cValue;
            (
                cValue.treasuryUsdValue,
                cValue.vaultsUsdValue,
                cValue.valueNotLatest
            ) = IRWACalculator(calculator).calculate(IERC20(underlying));
            value.rwa = cValue.treasuryUsdValue * underlyingMultiplier;
            value.rwaVaults = cValue.vaultsUsdValue;
            value.rwaValueNotLatest = cValue.valueNotLatest;
        }
