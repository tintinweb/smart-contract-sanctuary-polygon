...
contract lolz is ERC721AUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
  string public _name                        = 'Laugh Out Loud';
  string public _symbol                      = 'LOL';
  string public uriPrefix                    = '';
  string public uriSuffix                    = '.json';
  string public hiddenMetadataUri            = 'ipfs://bafybeigvrvoe6dcwshmeawbfnvhtlgjj7faz2j4uph6fcglx4hc2udq2vm';
