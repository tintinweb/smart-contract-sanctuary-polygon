...
contract Alligators is
    ...
    */
    ...
    function merge(uint256 _1st, uint256 _2nd, uint256 _3rd, address _owner, bytes calldata skeletonParams, bytes calldata levelParams) external {
        ...
        if (ownerOf(_1st) == _owner && ownerOf(_2nd) == _owner && ownerOf(_3rd) == _owner ) {
            ...
            {
                (uint8 anatomy1,uint8 anatomy2,uint8 anatomy3,uint8 anatomy4,uint8 anatomy5,uint8 anatomy6 ,uint8 anatomy7) = abi.decode(skeletonParams,(
                    uint8, uint8, uint8, uint8, uint8, uint8, uint8));
                (uint8 lvl1,uint8 lvl2,uint8 lvl3,uint8 lvl4,uint8 lvl5,uint8 lvl6 ,uint8 lvl7) = abi.decode(levelParams,(
                    uint8, uint8, uint8, uint8, uint8, uint8, uint8));
                _createSkeleton(anatomy1, anatomy2, anatomy3, anatomy4, anatomy5, anatomy6, anatomy7);
                _createLevels(lvl1, lvl2, lvl3, lvl4, lvl5, lvl6, lvl7);
            }
    ...
    function _createSkeleton(uint8 _trait1, uint8 _trait2, uint8 _trait3, uint8 _trait4, uint8 _trait5, uint8 _trait6, uint8 _trait7) internal {
    ...
    function _createLevels(uint8 _trait1, uint8 _trait2, uint8 _trait3, uint8 _trait4, uint8 _trait5, uint8 _trait6, uint8 _trait7) internal {
