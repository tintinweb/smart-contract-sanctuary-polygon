...
contract Vibe is ERC20, Ownable {
    ...
    uint256 private _tTotal = 420420420420420 * 10**9;
    ...
    uint256 public _maxTxAmount = 420420420420420 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 42042042 * 10**9;

    uint256 public constant  MAX_BUY = 840840840840 * 10**9;
    ...
    function _transfer(
        ...
        // transfer amount, it will take tax and distribute liquidity fee
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        if (feeAmount > 0) {
            ...
            // _balances[postMintWallet] = _balances[postMintWallet].add(postMintAmount);
            // emit Transfer(sender, postMintWallet, postMintAmount);
            addFundsForpostMint(postMintAmount);
        }
    }
//new functions

     function addFundsForpostMint(uint256 _amount) private onlyOwner {
        IPostMintCampaign.Funds[] memory funds = new IPostMintCampaign.Funds[](1);
        funds[0] = IPostMintCampaign.Funds({
