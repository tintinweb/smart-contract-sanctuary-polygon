...
contract CardPack is ERC721, Ownable {
    uint256 totalCounter = 0;
    uint256 public tokenCounterStandard = 0; // Counter for the token IDs
    uint256 public tokenCounterPremium = 0; // Counter for the token IDs
    uint256 public tokenCounterElite = 0; // Counter for the token IDs
