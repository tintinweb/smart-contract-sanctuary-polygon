    ...
    
{
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/KzQ7mjgHB4JwECxC3p3s/contract-metadata";
  }
...
// File: contracts/Test3Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Test3Contract is RamppERC721A {
    constructor() RamppERC721A("test 3", "test"){}
}