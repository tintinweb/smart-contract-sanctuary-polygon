...
contract Token is ERC20, ERC20Burnable, ERC165, ReentrancyGuard, Taxable, AccessControl {
  /* @dev Variables */
  ...
  /* @dev: Prevent ERC721 and ERC1155 from ending up in the contract */
  function supportsInterface(bytes4 interfaceId) public view virtual override(AccessControl, ERC165) returns (bool) {
    return interfaceId != ERC1155_INTERFACE_ID || interfaceId != ERC721_INTERFACE_ID;
  }
