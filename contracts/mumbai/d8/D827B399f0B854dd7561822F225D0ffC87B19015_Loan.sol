...
contract Loan {
    ...
    constructor() {
        ...
        token = ERC20(0x46EA7aE4a1edd342ce7a97E65a17634f7f705521);
    ...
    function approveContract(uint256 amount) internal {
    ...
    function payLoan(uint256 loanId) public payable {
        ...
        approveContract(userToAddress[loanId].amountGotten);
        token.transferFrom(
            msg.sender,
            address(this),
