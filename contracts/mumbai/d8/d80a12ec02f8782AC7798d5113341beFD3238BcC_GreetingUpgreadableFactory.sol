...
import "../GreetingUpgradeable.sol";

contract GreetingUpgreadableFactory is ERC2771Context {
    ...
    function cloneContract() external returns(address instance) {
        ...
        GreetingUpgradeable(instance).initialize();
...
contract GreetingUpgradeable is ERC2771ContextUpgradeable {
