...
import "./BookwalaUser721Token.sol";
...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new BookwalaUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        BookwalaUser721Token token = BookwalaUser721Token(address(addr));
...
contract BookwalaUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
