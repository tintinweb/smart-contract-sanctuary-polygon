...
contract Workflow is KeeperCompatibleInterface {
    ...
    */
    ...
    constructor() {
        ...
        maticPriceFeed = AggregatorV3Interface(0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889);
        daiPriceFeed = AggregatorV3Interface(0xcB1e72786A6eb3b44C2a2429e317c8a2462CFeb1);
    }
    ...
    function _swap(
        ...
        emit TokensSwapped(_tokenIn, _tokenOut, from);
    }
    ...
    function performUpkeep(bytes calldata /* performData */) external override {
        ...
        if ((block.timestamp - lastTimeStamp) > interval && newWorkflowCreated) {
            ...
            _swap(creator, tokenA, tokenB, amountTokenA, 1);
            // if ((prevTokenBPrice - lastTokenBPrice) > prevTokenBPrice / 100)
            _addLiquidityToQuickswap(creator, tokenA, tokenB, amountTokenA, amountTokenB);
            lastTimeStamp = block.timestamp;
        }
    }
}
