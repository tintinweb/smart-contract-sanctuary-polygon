...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1668000660;
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x104fAef38591b74ba47660C628776dE75FF2bc4d];
  address public erc20Payable = 0x104fAef38591b74ba47660C628776dE75FF2bc4d;
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 50, 50) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeif27rq3uvta7sfhmc4a2m4sxpv356234gx3qeuxctld2ms6vmg7q4/";
...
// File: contracts/CryptonymityContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CryptonymityContract is RamppERC721A {
    constructor() RamppERC721A("CRYPTONYMITY", "CTY"){}
}