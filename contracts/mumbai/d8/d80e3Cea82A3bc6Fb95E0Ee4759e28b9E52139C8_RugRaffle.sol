...
contract RugRaffle is EssentialERC2771Context {
    ...
    /*
    Generally a raffle? We'll be able to trust that the nft at _msgNFT() is owned
    by _msgSender(). One ticket per NFT, no double entry.

    VRF would be good for generating a seed to pick winners. Probably multiple?

    See stuff like https://github.com/Anish-Agnihotri/MultiRaffle
    for prior art
