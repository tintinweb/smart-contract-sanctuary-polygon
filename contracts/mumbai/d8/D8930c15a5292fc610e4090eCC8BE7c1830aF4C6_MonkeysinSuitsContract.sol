...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x32671dE188a887C973ddE1a2C4Bbe45EAf71a170];
  address public erc20Payable = 0x32671dE188a887C973ddE1a2C4Bbe45EAf71a170;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 82) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiekb6qthq2cwtjkk64yzyzgc3y4e3rieiewj3qfdrjtbjyuwtuxiq/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/mk7f6s1Uc2lUjG1VSGd5/contract-metadata";
  }
...
// File: contracts/MonkeysinSuitsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MonkeysinSuitsContract is RamppERC721A {
    constructor() RamppERC721A("Monkeys inSuits", "Monkey"){}
}
