...
contract CapTable {
	...
	constructor() {
		...
		shares[0] = 33_000_000 * (10 ** 18);
		shares[1] = 23_999_987 * (10 ** 18);
		shares[2] = 9_000_000 * (10 ** 18);
		shares[3] = 7_250_000 * (10 ** 18);
		shares[4] = 7_250_000 * (10 ** 18);
		shares[5] = 6_500_000 * (10 ** 18);
		shares[6] = 6_500_000 * (10 ** 18);
		shares[7] = 5_000_000 * (10 ** 18);
	}
