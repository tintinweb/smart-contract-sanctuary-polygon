...
contract AccountsEscrow is Initializable, OwnableUpgradeable {
     ...
     */
    function initialize(address _engage_token) public initializer {
        et = EngageToken(_engage_token);
    }

    /*
     * @dev update user balance
     * @params _amount to update
    ...
    function addToBalance(uint256 _amount, address _account) public {
        ...
        require(et.approve(msg.sender, _amount), "token transfer not approved");
        // et.allowance(msg.sender, address(this));
        ...
        emit transferEvent(msg.sender, address(this), _amount);
    }
    ...
    function setEngageTokenAddress(address _token) public onlyOwner {
        et = EngageToken(_token);
    }

    /*
    function setAdManagerAddress(address _am) public onlyOwner {
        AD_MANAGER = _am;
    }
    */
