...
contract PairFactory is IPairFactory, OwnableUpgradeable {
    ...
    function updatePrivilegedAccount(address _account, bool _addToPrivileged) external onlyManager {
...
contract Pair is IPair {
    ...
    function claimFees() external returns (uint256 claimed0, uint256 claimed1) {
        ...
        if (claimed0 > 0 || claimed1 > 0) {
            ...
            (uint256 excess0, uint256 excess1) = PairFees(fees).excessTokenAmounts();

            claimed0 = claimed0 + excess0;
            claimed1 = claimed1 + excess1;
...
contract PairFees {
    ...
    function excessTokenAmounts() external view returns (uint256 amount0, uint256 amount1) {
