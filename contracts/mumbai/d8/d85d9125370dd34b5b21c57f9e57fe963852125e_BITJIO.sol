...
contract BITJIO  {
    ...
    constructor() {
        admin=msg.sender;
        platform_fee=0x6137d3e622920543Cf36923496Cb9738E959D3dC;
        ...
        users[id1] = user;
        idToAddress[1] = id1;
        royaltybusinessCond[1]=1e18;
        royaltybusinessCond[2]=2e18;
    }
    ...
    function updateCoinRate(uint256 _token,uint Isbuy) public {
        if(Isbuy==1)
        _initialCoinRate+=_initialCoinRate*1*_token/10000e18;
        else 
        _initialCoinRate-=_initialCoinRate*1*_token/10000e18;
    }
    ...
    function _distributelevelIncome(address _user, uint256 _amount) private {
        ...
        users[_referrer].directincome += _amount*directPercents/1000;
        users[_referrer].totalincome += _amount*directPercents/1000;
        emit Transaction(users[_user].referrer,_user,_amount*directPercents/1000,1,1);
