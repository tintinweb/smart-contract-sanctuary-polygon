...
contract TestNFT is ERC721, IERC721Receiver {
    ...
    constructor() ERC721("Project", "X") {
        owner = msg.sender;
        mintFee = 20.00 ether; // default is 20 Matic.
        royaltyFee = 5; //default 5%.
        recipients.push(payable(0x22AbA4c94E703e280A96713c26a1c1872AB45D9e)); //Rewards contract address
        percentages.push(20);
        recipients.push(payable(0xCAeaA9D2DffF37c240bafC215608752c9C125B42)); //Charity fund address
        percentages.push(5);
        recipients.push(payable(0xe1C87F43c12a7B43Bee853e66F0BCB3dd75d9E95)); // Management fund address
        percentages.push(55);
        recipients.push(payable(0x38d5a7EF9DB64D05A47c82C5E42bB45A7C82B457)); // Liquidity fund address
        percentages.push(20);
    }
    ...
    function royaltyInfo(
        ...
        royaltyAmount = salePrice.mul(royaltyFee).div(100); // 5% default.
    ...
    function burn(uint256 tokenId) public {
        ...
        emit NftWithburnt(msg.sender, tokenId);
    }
