...
contract LiquidityExamples is IERC721Receiver {
    ...
    //definingInonfungiblePositionManager
    address public constant nonfungiblePositionManageraddress = 0xC36442b4a4522E871399CD717aBDD847Ab11FE88; 
    INonfungiblePositionManager public immutable nonfungiblePositionManager = INonfungiblePositionManager(nonfungiblePositionManageraddress);
    ...
    function swap_AtoB(uint256 amountIn, address _tokenA, address _tokenB, uint24 _fee) external returns (uint256 amountOut) {
        ...
        TransferHelper.safeApprove(_tokenA, swapRouteraddress, amountIn);
    ...
    /// For this example we are providing 1000 _tokenA and 1000 _tokenB in liquidity
        ...
        )
    {
        ...
        TransferHelper.safeTransferFrom(_tokenA, msg.sender, address(this), amount0ToMint);
        TransferHelper.safeTransferFrom(_tokenB, msg.sender, address(this), amount1ToMint);

        // Approve the position manager
        TransferHelper.safeApprove(_tokenA, address(nonfungiblePositionManager), amount0ToMint);
        TransferHelper.safeApprove(_tokenB, address(nonfungiblePositionManager), amount1ToMint);
        ...
        // Note that the pool defined by _tokenA/_tokenB and fee tier 0.3% must already be created and initialized in order to mint
