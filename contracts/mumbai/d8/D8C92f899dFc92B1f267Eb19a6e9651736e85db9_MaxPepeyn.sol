  ...
  DefaultOperatorFiltererUpgradeable 
{
  ...
  modifier validMint(Phases _phase, bytes32[] memory _proof, uint256 _points) {
  ...
  function mint(Phases _phase, string memory _metadata, bytes32[] memory _proof, uint256 _points) external payable validMint(_phase, _proof, _points){
    YRewardsV2 yrewards = YRewardsV2(mp.rewards);
