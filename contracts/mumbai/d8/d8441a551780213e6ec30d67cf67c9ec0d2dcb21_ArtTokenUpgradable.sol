...
contract ArtTokenUpgradable is ERC721AUpgradeable, OwnableUpgradeable {
    ...
    function setRoyaltiesPercentage(uint256 _percentage)
        public
        onlyOwner
    {
    ...
    function setRoyaltiesReceiver(address _receiver)
        public
        onlyOwner
    {
    ...
    function addDenylist(address _account, bool _isDenied)
        public
        onlyOwner
    {
    ...
    function mint(uint256 _quantity) external payable {
        ...
        allowList.totalMinted += _quantity;
    }
