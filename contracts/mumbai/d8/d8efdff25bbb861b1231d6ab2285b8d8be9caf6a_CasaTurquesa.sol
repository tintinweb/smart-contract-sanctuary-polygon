...
contract CasaTurquesa is ERC721, Ownable {
  ...
  modifier mintCompliance(uint256 _mintAmount) {
    ...
    require(totalMinted.current() + _mintAmount <= maxSupply, "Max supply exceeded!");
    _;
  }
  ...
  function mint(uint256 _id) public payable mintCompliance(1) {
    require(!_blacklist[msg.sender], "Blacklisted address");
    require(!paused, "The contract is paused!");
    require(msg.value >= price, "Insufficient funds!");

    _mintLoop(msg.sender, 1, _id);
  }
  
  function _mintLoop(address _receiver, uint256 _mintAmount, uint256 _id) internal {
  ...
  function mintForAddress(uint256 _mintAmount, address _receiver, uint256 _id) public mintCompliance(_mintAmount) onlyOwner {
    _mintLoop(_receiver, _mintAmount, _id);
  }
