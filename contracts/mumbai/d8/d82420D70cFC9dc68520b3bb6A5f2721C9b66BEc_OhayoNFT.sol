...
contract ERC4907Upgradeable is ERC721Upgradeable, IERC4907 {
    ...
    function __ERC4907Upgradeable_init() internal onlyInitializing {}
    ...
    function setUser(
        ...
        require(
            ...
            "ERC721: expires should be equal or greater than block timestamp"
        );
    ...
    OwnableUpgradeable
{
    ...
    event Mint(uint256 indexed tokenId, address indexed account);

    function initialize(
        address payable _accountImpl,
        address _registry
    ) public initializer {
        __Ownable_init();
        ...
        __ERC4907Upgradeable_init();
        __ERC721_init("OhyaoNFT", "ONFT");

        implementation = _accountImpl;
    ...
    function mint(address to, string memory _tokenURI) public onlyOwner returns (address) {
    ...
    function setBaseURI(string memory uri) external onlyOwner {
        baseURI = uri;
        emit BaseURIUpdated(baseURI, uri);
    }
