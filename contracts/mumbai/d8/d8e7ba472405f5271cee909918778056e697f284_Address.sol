...
contract Revealed is Ownable, DefaultOperatorFilterer, ERC721A {
    ...
    string public hiddenURI = "ipfs://hiddenURI/";
    uint256 public price = 0 ether;
    uint256 public maxSupply = 1234;

    constructor() ERC721A("Revealed", "REVE"){}
   ...
   function sendGiftsToWallet(address _wallet, uint256 _num) external onlyOwner{
    ...
    function setmaxSupply(uint256 _supply) public onlyOwner() {
        require(_supply <= 1234, "Error: New max supply cant be higher than original max.");
        maxSupply = _supply;
    }
    ...
    function toggleHidden() public onlyOwner() {
        revealed = !revealed;
    }
