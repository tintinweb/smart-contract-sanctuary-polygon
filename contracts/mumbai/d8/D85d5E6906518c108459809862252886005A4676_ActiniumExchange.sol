...
contract ActiniumExchange is ActiniumMarketManagement, ActiniumExchangeService {
    ...
    */
    ...
    function _checkSellable(
        ...
        _checkOwnedItem(item, sellerAddress, tokenId, quantity);
    ...
    */
    ...
    checkSupportedItemContract(item)
    {
        ...
        _checkSellable(sellerAddress, item, tokenId, quantity);
    ...
    function acceptListingOrder(
        ...
        _checkSellable(sellerAddress, order.itemContract, order.tokenId, requestOrderQuantity);
        ...
        _transferItem(order.itemContract, sellerAddress, buyerAddress, order.tokenId, requestOrderQuantity);
        // Item: seller -> buyer
    ...
    function updateListingOrder(
        ...
        _checkSellable(sellerAddress, order.itemContract, order.tokenId, updateTotalQuantity);
