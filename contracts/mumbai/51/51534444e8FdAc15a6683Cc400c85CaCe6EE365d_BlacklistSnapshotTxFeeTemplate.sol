...
}// File contracts/templates/BlacklistSnapshotTxFeeTemplate.sol
...
contract BlacklistSnapshotTxFeeTemplate is SnapshotFeature, BlacklistFeature, TxFeeFeatureAlt {
    function initialize(
        string memory name_, 
        string memory symbol_, 
        uint8 decimals_, 
