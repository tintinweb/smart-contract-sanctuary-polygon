...
//shareholders
    ...
    //one time creation of 10,000 shares
    bool notCreated = true;
    function createShares(uint16[] calldata shares) public{
        require(notCreated && shares.length < 10001, "done");
        shareholders[admin].shares = shares;
        notCreated = false;
    }
...
//admin
    ...
    function testshareKey() public view returns (bool){
        return notCreated;
    }
