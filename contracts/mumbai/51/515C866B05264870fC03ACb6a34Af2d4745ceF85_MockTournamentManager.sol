...
import { IChainlinkRandomInterval } from "./interfaces/IChainlinkRandomInterval.sol";
 ...
 * 
 **/
contract ChainlinkRandomInterval is VRFConsumerBaseV2, IChainlinkRandomInterval {
...
interface IChainlinkRandomInterval {
...
contract MockTournamentManager is TournamentManager {
	...
	function mockStartTournament() public {
		require(!isTournamentActive, "startTournament: Tournament already active");
		isTournamentActive = true;
		tournaments[id].bracket = INITIAL_BRACKET;
