...
contract VLFIV7 is ERC20Upgradeable, ERC20PermitUpgradeable, AccessControlUpgradeable, ERC20VotesUpgradeable {
...
/// @notice initialize function called by Openzeppelin Hardhat upgradeable plugin
 ...
 /*** Functions to call after upgradation */
    ...
    function unstakeMax() public {
        ...
        bool success = ILFIToken(STAKED_TOKEN).transfer(msg.sender, uint256(unstakeValue));
