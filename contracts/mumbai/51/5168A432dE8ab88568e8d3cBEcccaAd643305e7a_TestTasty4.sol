...
contract TestTasty4 is ERC721A, Ownable {

    constructor() ERC721A("TestTasty4", "TT4") {}
    ...
    function setPrice(uint _price) external onlyOwner {
     ...
     function set_MAX_PER_WALLET(uint _MAX_PER_WALLET) external onlyOwner {
        MAX_PER_WALLET = _MAX_PER_WALLET;
    }

     function set_MAX_PER_TX(uint _MAX_PER_TX) external onlyOwner {
        MAX_PER_TX = _MAX_PER_TX;
    }

    function set_MaxSupply(uint _maxSupply) external onlyOwner {
