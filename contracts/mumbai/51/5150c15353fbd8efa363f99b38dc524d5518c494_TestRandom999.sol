...
contract TestRandom999 is ERC721, Ownable, RandomlyAssigned { // change NFT on your contract name
  ...
  constructor() 
    ...
    {
       for (uint256 a = 1; a <= 2; a++) { // it mints selected amount of 50 to the owner after deploy. CHANGE THE NUMBERS ACCORDING TO YOUR PLAN! or delete the stroke
      ...
      payable
  {
      ...
      if (msg.sender != owner()) {  
       ...
       // require( balanceOf(_to) <= 1); // i dunno really
      }
