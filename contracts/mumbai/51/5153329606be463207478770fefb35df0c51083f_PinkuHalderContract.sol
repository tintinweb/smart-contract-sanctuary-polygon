...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xAe361DA29c1Ec7Ad1B2b81C34025f3c22d1b31D3];
...
// File: contracts/pinkuHalderContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PinkuHalderContract is RamppERC721A {
    constructor() RamppERC721A("PinkuHalder", "PH"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/Dhv8yQqQKKy3Jf6BkLHW/contract-metadata";
    }
}