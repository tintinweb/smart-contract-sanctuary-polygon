 ...
 * @notice This contract handles minting Mythical Maidens tokens.
 */
contract MythicalMaidens is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x849b8BBBECbFB0f07FF41568829097dcdf093b7e;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x3D83481DAe802D3683cEb82e315d9edf7c45E961;
    address[] public payoutAddresses = [
        0x3D83481DAe802D3683cEb82e315d9edf7c45E961
    ];
    ...
    string public name = "Mythical Maidens";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeihpfidlzffqhue2mctpzl3uumoutvqhf2zzfqbs6tdks5af3swdzq/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenPresaleMaxSupply[1] = 10;
        tokenPresalePrice[1] = 0.02 ether;
        tokenPresaleMintsPerAddress[1] = 2;
        tokenMaxSupply[2] = 20;
        tokenPublicPrice[2] = 0.05 ether;
        tokenPublicMintsPerAddress[2] = 20;
        tokenPresaleMaxSupply[2] = 10;
        tokenPresalePrice[2] = 0.02 ether;
        tokenPresaleMintsPerAddress[2] = 2;
        tokenMaxSupply[3] = 20;
        tokenPublicPrice[3] = 0.05 ether;
        tokenPublicMintsPerAddress[3] = 20;
        tokenPresaleMaxSupply[3] = 10;
        tokenPresalePrice[3] = 0.02 ether;
        tokenPresaleMintsPerAddress[3] = 2;
        tokenMaxSupply[4] = 20;
        tokenPublicPrice[4] = 0.05 ether;
        tokenPublicMintsPerAddress[4] = 20;
        tokenPresaleMaxSupply[4] = 10;
        tokenPresalePrice[4] = 0.02 ether;
        tokenPresaleMintsPerAddress[4] = 2;
        tokenMaxSupply[5] = 20;
        tokenPublicPrice[5] = 0.05 ether;
        tokenPublicMintsPerAddress[5] = 20;
        tokenPresaleMaxSupply[5] = 10;
        tokenPresalePrice[5] = 0.02 ether;
        tokenPresaleMintsPerAddress[5] = 2;
        tokenMaxSupply[6] = 20;
        tokenPublicPrice[6] = 0.05 ether;
        tokenPublicMintsPerAddress[6] = 20;
        tokenPresaleMaxSupply[6] = 10;
        tokenPresalePrice[6] = 0.02 ether;
        tokenPresaleMintsPerAddress[6] = 2;
        tokenMaxSupply[7] = 10;
        tokenPublicPrice[7] = 0.05 ether;
        tokenPublicMintsPerAddress[7] = 10;
        tokenPresaleMaxSupply[7] = 5;
        tokenPresalePrice[7] = 0.02 ether;
        tokenPresaleMintsPerAddress[7] = 1;
        tokenMaxSupply[8] = 20;
        tokenPublicPrice[8] = 0.05 ether;
        tokenPublicMintsPerAddress[8] = 20;
        tokenPresaleMaxSupply[8] = 10;
        tokenPresalePrice[8] = 0.02 ether;
        tokenPresaleMintsPerAddress[8] = 2;
        require(
