...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x55e478e18bca7a3A6C2a1Fbf6542f2E43B64feC6];
...
// File: contracts/ByGianFerrerContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract ByGianFerrerContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "by Gian Ferrer";
    string public symbol = "byGIAN";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/5MssnMDcRi5Q4amfQIV5/contract-metadata";
  }
