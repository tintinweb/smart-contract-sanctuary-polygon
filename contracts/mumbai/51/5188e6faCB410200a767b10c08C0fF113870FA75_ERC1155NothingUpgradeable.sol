...
contract ERC1155NothingUpgradeable is Initializable, ERC1155BurnableUpgradeable, OwnableUpgradeable {
    ...
    uint256 public constant BLACK_DOT_ID = 1;
    uint256 public constant RED_DOT_ID = 2;
    uint256 public constant EAR_VOUCHER_ID = 3;
    uint256 public constant YELLOW_DOT_ID = 4;
    ...
    function mergeBlackToRed(address owner) public {
    ...
    function mergeBlackToRed(address owner, uint256 redAmount) public {
    ...
    function mergeRedToYellow(address owner) public {
    ...
    function mergeRedToYellow(address owner, uint256 yellowAmount) public {
