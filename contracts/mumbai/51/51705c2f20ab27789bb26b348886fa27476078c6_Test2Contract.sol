  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0xdAe7212C83Db619F861a7e95d937Ad3cbd12dfd6);
        ...
        */
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, "Cannot mint over supply cap of 1000");
    ...
    contract Test2Contract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("test2", "test2", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmXdERmwM3SNMZkMG1u6AMDPAqb2CSDeFVy6Ho8FrjCxVJ/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/KztSgS9WiqSqzfZpAHaU/contract-metadata";
        }
    }