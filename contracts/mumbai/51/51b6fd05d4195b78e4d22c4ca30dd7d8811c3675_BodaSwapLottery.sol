...
// File: interfaces/IBodaSwapLottery.sol


pragma solidity >=0.6.0;

interface IBodaSwapLottery {
    /**
...
/** @title BodaSwap Lottery.
 * @notice It is a contract for a lottery system using
 * randomness provided externally.
 */
contract BodaSwapLottery is ReentrancyGuard, IBodaSwapLottery, Ownable {
    ...
    uint256 public constant MAX_LENGTH_LOTTERY = 7 days + 8 minutes; // 4 days
    uint256 public constant MAX_TREASURY_FEE = 2500; // 30%
    ...
    struct Lottery {
        ...
        uint256[3] rewardsBreakdown; // 0: 4 matching number // 2: 6 matching numbers
        uint256 treasuryFee; // 500: 5% // 200: 2% // 50: 0.5%
        uint256[3] busdPerBracket;
    ...
    constructor(address _busdTokenAddress, address _randomGeneratorAddress) {
        ...
        _bracketCalculator[0] = 1111;
        _bracketCalculator[1] = 11111;
    ...
    function claimTickets(
        ...
        for (uint256 i = 0; i < _ticketIds.length; i++) {
            require(_brackets[i] < 3, "Bracket out of range"); // Must be between 0 and 3
    ...
    function startLottery(
        ...
        _lotteries[currentLotteryId] = Lottery({
            ...
            busdPerBracket: [uint256(0), uint256(0), uint256(0)],
