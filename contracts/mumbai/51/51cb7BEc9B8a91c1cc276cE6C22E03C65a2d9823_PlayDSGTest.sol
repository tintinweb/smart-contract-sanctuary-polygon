...
contract PlayDSGTest {
    ...
    uint256 private constant level2And3Bonus = 200e6;
    ...
    function _deposit(address _user, uint256 _amount) private {
        ...
        orderInfos[_user].push(
            OrderInfo(_amount, block.timestamp, unfreezeTime, false, user.aon)
        );
    ...
    function _updateReward(address _user, uint256 _amount, uint256 _prevMax) private {
        ...
        if (_amount > _prevMax || user.depositDistributed < 3) {
