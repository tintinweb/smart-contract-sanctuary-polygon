...
contract faucet is Ownable{
    //Current Address0x514B4D53413795723F7e485489796315a1Cd3E1D
    ...
    function getTokens(address _destinationWallet) public {
        require(testToken.balanceOf(address(this)) > 1000, "Faucet Empty");
        testToken.safeTransfer(_destinationWallet, 1000);
    }

    function checkFaucetBalance() public onlyOwner view returns(uint256 _balance){
        _balance = testToken.balanceOf(address(this));
    }
