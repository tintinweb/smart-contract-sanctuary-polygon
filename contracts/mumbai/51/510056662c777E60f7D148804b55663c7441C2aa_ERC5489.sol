...
interface IERC5489 {
     ...
     */
    event SlotAuthorizationCreated(
        uint256 indexed tokenId,
        address indexed slotManagerAddr
    );
     ...
     */
    event SlotAuthorizationRevoked(
        uint256 indexed tokenId,
        address indexed slotManagerAddr
    );
...
contract ERC5489 is IERC5489, ERC721Enumerable, Ownable {
    ...
    ) external override onlySlotManager(tokenId) {
    ...
    function authorizeSlotTo(
        ...
        require(
            !tokenId2AuthroizedAddresses[tokenId].contains(slotManagerAddr),
    ...
    function revokeAllAuthorizations(
        ...
        for (
            uint256 i = tokenId2AuthroizedAddresses[tokenId].length() - 1;
            i > 0;
            i--
        ) {
