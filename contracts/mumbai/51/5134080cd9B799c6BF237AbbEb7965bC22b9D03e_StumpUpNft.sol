    ...
    OwnableUpgradeable
{
    ...
    mapping(address => bool) public operators; // for Operator Mapping
    ...
    function safeMint(
        ...
        require(to != address(0), "Can't mint on zero address");
    ...
    function addOperator(address _newOperator, bool status) external onlyOwner {
        require(
            ...
            "Can't add zero address as operator"
        ); //Zero Address
