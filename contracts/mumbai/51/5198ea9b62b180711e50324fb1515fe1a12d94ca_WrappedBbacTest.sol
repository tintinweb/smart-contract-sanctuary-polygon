  ...
  ERC721Burnable
{
  ...
  constructor(address frostiesNFTContractAddress_)
    ERC721("TEST Wrapped Basic Bored Ape Yatch Club", "WBBAC")
  {
    frostiesNFT = IERC721(frostiesNFTContractAddress_);
  }

  function _baseURI() internal pure override returns (string memory) {
    return "ipfs://QmTZCpuEWQRv5kiGWxp9B6WinHiZshC97yADwLpLruD8zs/";
  }
  ...
  function wrap(uint256[] calldata tokenIds_) external payable {
      require(msg.value >= 100000000000000000, "ETH value sent is too little for this many wraps");
  ...
  function onERC721Received(
    ...
    require(
      ...
      "must be BBAC_NFT or WrappedBBAC"
    );
  ...
  function emergencyMintWrapped(uint256 tokenId_) external onlyOwner {
    if (frostiesNFT.ownerOf(tokenId_) == address(this)) {
      ...
      revert("BBAC is not locked in contract");
    }
  }
}