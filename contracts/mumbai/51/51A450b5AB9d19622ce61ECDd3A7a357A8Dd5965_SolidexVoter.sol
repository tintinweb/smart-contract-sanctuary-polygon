...
contract SolidexVoter is Ownable {
    ...
    // SOLIDsex/SOLID and SEX/WFTM pool addresses
    ...
    function setPoolProtection(address[2] calldata _pools) external {
        require(sexPartners.isEarlyPartner(msg.sender), "Only early partners");
