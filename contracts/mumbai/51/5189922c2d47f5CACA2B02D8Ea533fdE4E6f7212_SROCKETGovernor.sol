...
contract SROCKETGovernor is Governor, GovernorSettings, GovernorCountingSimple, GovernorVotes, GovernorVotesQuorumFraction {

    address public _tokenAddress;
    uint256 public balanceLimit = 1000000000000000000;
    address public _owner;
    constructor(IVotes _token, address _govTokenAddress, address owner)
        Governor("GovernorContract")
        GovernorSettings(1 /* 1 block */, 273 /* 1 week */, 50e18)
    ...
    function castVote(uint256 proposalId, uint8 support) public virtual override returns (uint256) {
        require(IERC20(_tokenAddress).balanceOf(_msgSender())>=balanceLimit,'Must have more than 1 tokens to participate');
    ...
    function updateBalanceLimit(uint256 newLimit) public onlyOwner {
