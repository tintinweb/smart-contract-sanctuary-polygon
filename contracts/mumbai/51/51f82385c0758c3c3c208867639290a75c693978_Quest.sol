...
contract Quest is RandomNumberGenerationQuest, UUPSUpgradeable, OwnableUpgradeable, IERC721ReceiverUpgradeable {
  ...
  function complete() external {
    ...
    if (result) {
      ...
      rewards.as_chests += 0; // necessary to balance gas usage
  ...
  function getQuestRewards(uint256 index) public view returns (uint256, uint256) {
    ...
    //rewards_ether[0] = 0; // MATIC
    rewards_ether[0] = 0; // FIXME: testnet value
    //rewards_ether[1] = 0; // MATIC
    rewards_ether[1] = 0.05 ether; // FIXME: testnet value
    //rewards_ether[2] = 14 ether; // MATIC
    rewards_ether[2] = 0.012 ether; // FIXME: testnet value
    //rewards_ether[3] = 0; // MATIC
    rewards_ether[3] = 0; // FIXME: testnet value
    //rewards_ether[4] = 20 ether; // MATIC
    rewards_ether[4] = 0.030 ether; // FIXME: testnet value
    //rewards_ether[5] = 13 ether; // MATIC
    rewards_ether[5] = 0.030 ether; // FIXME: testnet value
    //rewards_ether[6] = 27 ether; // MATIC
    rewards_ether[6] = 0.030 ether; // FIXME: testnet value
    //rewards_ether[7] = 25 ether; // MATIC
    rewards_ether[7] = 0.030 ether; // FIXME: testnet value
  ...
  function getQuestCost(uint256 index) public pure returns (uint256) {
    ...
    //cost[0] = 0;
    cost[0] = 0; // FIXME: testnet value
    //cost[1] = 2 ether; // MATIC
    cost[1] = 0.0011 ether; // FIXME: testnet value
    //cost[2] = 5 ether; // MATIC
    cost[2] = 0.0027 ether; // FIXME: testnet value
    //cost[3] = 9 ether; // MATIC
    cost[3] = 0.005 ether; // FIXME: testnet value
    //cost[4] = 15 ether; // MATIC
    cost[4] = 0.0081 ether; // FIXME: testnet value
    //cost[5] = 17 ether; // MATIC
    cost[5] = 0.0095 ether; // FIXME: testnet value
    //cost[6] = 18 ether; // MATIC
    cost[6] = 0.01 ether; // FIXME: testnet value
    //cost[7] = 19 ether; // MATIC
    cost[7] = 0.01 ether; // FIXME: testnet value
  ...
  function getQuestDuration(uint256 index) public pure returns (uint256) {
    ...
    //duration[0] = 1 days;
    duration[0] = 0.01 days; // FIXME: testnet value
    //duration[1] = 2 days;
    duration[1] = 0.02 days; // FIXME: testnet value
    //duration[2] = 4 days;
    duration[2] = 0.03 days; // FIXME: testnet value
    //duration[3] = 6 days;
    duration[3] = 0.04 days; // FIXME: testnet value
    //duration[4] = 8 days;
    duration[4] = 0.05 days; // FIXME: testnet value
    //duration[5] = 12 days;
    duration[5] = 0.06 days; // FIXME: testnet value
    //duration[6] = 14 days;
    duration[6] = 0.07 days; // FIXME: testnet value
    //duration[7] = 16 days;
    duration[7] = 0.08 days; // FIXME: testnet value
