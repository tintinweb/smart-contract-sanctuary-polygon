 ...
 * @notice This contract handles minting Vantasy-Project-test tokens.
 */
contract VantasyProjectTest is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x6034265e160aA8961eBCc97924FcEEAe4cBdaa1a;
    ...
    address[] public payoutAddresses = [
        ...
        0xD492B32f4d752914d124426EDEc4CBDD2b154aF0
    ];
    ...
    string public name = "Vantasy-Project-test";
    string public symbol = "VANTASY";
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeiaymqmffs7kqmc5trqflfprf4k6tgnhkxmljijmhqgobq3g34nzl4/{id}"
        )
        RevokableOperatorFilterer(
