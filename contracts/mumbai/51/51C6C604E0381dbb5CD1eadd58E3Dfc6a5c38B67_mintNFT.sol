...
contract mintNFT is
    ERC721URIStorage,
    Ownable,
    EIP712MetaTransaction("mintNFT", "1")
{
    ...
    constructor() ERC721("mintQrNft ", "QrNft") {
        ownerOne = msg.sender;
        console.log("This is mintQrNft smart contract");
    }

    modifier ownerCheck() {
        require(ownerOne == msgSender(), "Only Owners modifier");
        _;
    }
    ...
    function mintUserNFT(string memory _tokenURI) public {
        ...
        emit NewShitNFTMinted(msgSender(), itemId);
    }
...
import "./interfaces/EIP712Base.sol";
