...
contract MorganningMumbai is MorganningTestNet {
    address constant mumbaiVrfCoordinator =
    ...
    constructor()
        MorganningTestNet(mumbaiVrfCoordinator, linkTokenContract, keyHashParam)
    {}

    function setVrfCallBackgasLimit(uint32 newLimit) public {
    ...
    function mint(
        ...
        require(
            layer2 < _layerCounts.numImagesLayer2 &&
                ...
                layer6 < _layerCounts.numImagesLayer6,
...
contract MorganningDeployable is Morganning {
    constructor(
        ...
        bytes32 _keyHash
    ) Morganning(false, vrfCoordinator, linkTokenContract, _keyHash) {}
}

contract MorganningTestNet is MorganningDeployable {
    ...
    constructor(
        ...
        address linkTokenContract,
        bytes32 _keyHash
    ) MorganningDeployable(vrfCoordinator, linkTokenContract, _keyHash) {}

    /// @notice Helper function for mocks (testing)
    function incrementCounter() internal returns (uint256 tokenId) {
        // Member "current" not found or not visible after argument-dependent lookup in struct SettableCountersUpgradeable.Counter storage ref.
    ...
    function unsetClaimed() external {
    ...
    VRFConsumerBaseV2Upgradeable
{
    ...
    /// LayerZero trusted recipients chain addresses
    ...
    function initialize(
        ...
        __ERC721_init("A.P. Morgan Sailing Club", "MOR");
    ...
    function mintGreenList(
        ...
        uint256 s_requestId = VRFCoordinatorV2Interface(vrfCoordinator)
            .requestRandomWords(
                keyHash,
                s_subscriptionId,
    ...
    /// @param reciever - the address to mint to
    ...
    function transferCrossChain(
        ...
        uint256 tokenId,
        address receiver
    ) public payable isTokenOwnerOrApproved(tokenId) {
    ...
    /// @notice Helper function for getting latest tokenId
