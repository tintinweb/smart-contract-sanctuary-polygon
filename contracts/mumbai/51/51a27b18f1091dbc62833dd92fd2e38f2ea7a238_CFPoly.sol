...
ReentrancyGuard
{
    ...
    {
        return (campaignId2Publisher[cid], campaignDonationCount[cid], campaign2Balance[cid] - campaign2Balance[cid] / serviceFee, campaign2Target[cid], campaignDissolved[cid], campaign2Start[cid], campaign2End[cid]);
    }
    ...
    */
    ...
    function closeCampaign(uint256 cid, uint256 supporterTokenId) public
    {
        ...
        uint256 supporterTokenBalance = checkUserSupporterTokenBalance(msg.sender, supporterTokenId);

        uint256 campaignServiceFee = campaign2Balance[cid] / serviceFee;
    ...
    function createCampaign(uint startDate, uint endDate, uint256 target) public whenNotPaused
    {
        ...
        require(target > serviceFee, CFPS.STR_TARGET_TOO_LOW);
    ...
    function withdrawServiceFee() public onlyOwner
    {
        ...
        payable(_royaltiesRecipient).transfer(serviceFeeBalance);
        serviceFeeBalance = 0;
    }
