...
contract AddressRegistry is Ownable {
    ...
    /**
     ...
     @dev Only admin
     */
    function updateMultiTokenFactory(address _MultiTokenFactory)
        external
        onlyOwner
    {
    ...
    /**
     ...
     @dev Only admin
     */
    function updateTreasuryManagement(address _treasuryManagement)
        external
        onlyOwner
    {
    ...
    /**
     ...
     @dev Only admin
     */
    function updateWhitelistContract(address _whitelist)
        external
        onlyOwner
    {
