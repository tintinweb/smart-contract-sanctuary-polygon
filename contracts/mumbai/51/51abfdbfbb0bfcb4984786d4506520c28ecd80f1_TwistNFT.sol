...
contract TwistNFT is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    constructor(string memory metadataUri) ERC721("TWIST NFT", "TWISTNFT") {
    ...
    function mintFor(uint256 qty, address addr) external onlyOwner {
        require(totalSupply() + qty <= MAX_SUPPLY, "Sold out!");
