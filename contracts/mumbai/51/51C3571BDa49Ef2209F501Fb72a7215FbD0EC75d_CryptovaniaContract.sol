...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x0dDCf5aA06b2D851eD97bdcfE8a2Fedf85Ae1437];
  address public erc20Payable = 0x0dDCf5aA06b2D851eD97bdcfE8a2Fedf85Ae1437;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 42, 60000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmNRgknCzh6cf4iU3EqWn7E1mTRFE3Xi3WYrfrLTBKAjsC/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 60000");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 60000");
    ...
    function mintToMultipleERC20(address _to, uint256 _amount, address _erc20TokenContract) public payable {
      require(_amount >= 1, "Must mint at least 1 token");
      require(_amount <= maxBatchSize, "Cannot mint more than max mint per transaction");
      require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 60000");
      require(mintingOpen == true, "Minting is not open right now!");
...
// File: contracts/CryptovaniaContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CryptovaniaContract is RamppERC721A {
    constructor() RamppERC721A("cryptovania", "CV"){}
}
