...
contract AltcoinNFT is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256[] public LEVEL_PRICE = [0.5 ether, 2 ether, 4 ether, 8 ether, 16 ether];
    ...
    function mint(uint256[] memory numberOfTokens) external payable nonReentrant {
        ...
        require(totalSupply() <= LEVEL_MAX[4], "All tokens have been minted");
        ...
        require(totalSupply() + numOt < LEVEL_MAX[4], "Purchase would exceed max supply");
