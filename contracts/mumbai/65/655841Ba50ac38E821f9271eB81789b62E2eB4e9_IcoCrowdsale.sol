...
contract Crowdsale is ReentrancyGuard,Pausable {
    ...
    function setRate(uint256 newRate,uint256 divisor) public
    {
        ...
        require(divisor > 0 ,"decimal can't be 0"); 
        _divisor=divisor;
        _rate = newRate;
    }  
    ...
    function _getTokenAmount(uint256 weiAmount) internal view returns (uint256) {
        ...
        tokenAmount = tokenAmount.div(_divisor);
        return tokenAmount;
    }
