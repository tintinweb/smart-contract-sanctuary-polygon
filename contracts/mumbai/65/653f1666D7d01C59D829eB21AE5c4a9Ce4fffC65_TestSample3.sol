    ...
    ContextMixin
{
    ...
    constructor(
        ...
        name = _name;
        symbol = _symbol;
        dropManager.initMaxSupply(_maxSupply);
    }
    ...
    {
        owners.enforceItemExists(_tokenId);
        return dropManager.getTokenURI(_tokenId);
    }
    ...
    function setBaseURI(string memory _baseURI)
        ...
        onlyOwnerOrRole(CREATOR_ROLE_NAME)
    {
        dropManager.setBaseURI(_baseURI);
    }
    ...
    function setBaseURI(string memory _dropName, string memory _baseURI)
        ...
        onlyOwnerOrRole(CREATOR_ROLE_NAME)
    {
        dropManager.setBaseURI(_dropName, _baseURI);
    }
    ...
    function getBaseURIForDrop(string memory _dropName)
        ...
        returns (string memory)
    {
        return dropManager.getBaseURI(_dropName);
    }
    ...
    function setCustomURI(uint256 _tokenId, string memory _newURI)
        ...
        onlyOwnerOrRole(CREATOR_ROLE_NAME)
    {
        dropManager.setCustomURI(_tokenId, _newURI);
    }
    ...
    function tokenOfOwnerByIndex(address _owner, uint256 _index)
        ...
        returns (uint256)
    {
        return owners.itemOfOwnerByIndex(_owner, _index);
    }
    ...
    function tokenByIndex(uint256 _index) public view returns (uint256) {
        return owners.itemAtIndex(_index);
    }
    ...
    function balanceOf(address _owner) public view returns (uint256 balance) {
        return owners.ownerItemCount(_owner);
    }
    ...
    function userWallet(address _user) public view returns (uint256[] memory) {
        return owners.userWallet(_user);
    }
     ...
     * - Calling user MUST be owner or have the creator role.
     * - Calling user MUST NOT be banned.
     * - `_category` MAY be an empty string, in which case the token will
     *      be minted in the default category.
     * - There MUST be available supply within `_category`.
     ...
     * - Plus any additional requirements imposed by the token manager.
     */
    function mint(
        string memory _category,
        address _toAddress,
        ...
        ERC721Invariants.roleInvariants(ams, _msgSender(), CREATOR_ROLE_NAME);
        dropManager.onMint(_category, _tokenId, "");
    ...
    function mintCustom(
        ...
        ERC721Invariants.roleInvariants(ams, _msgSender(), CREATOR_ROLE_NAME);
        dropManager.onMint(_category, _tokenId, _customURI);
        _safeMint(_toAddress, _tokenId, "");
    }
    ...
    function safeMint(
        ...
        ERC721Invariants.roleInvariants(ams, _msgSender(), CREATOR_ROLE_NAME);
        dropManager.onMint(_category, _tokenId, _customURI);
        _safeMint(_toAddress, _tokenId, _data);
    }
     ...
     * - `_toAddresses` MUST NOT contain any banned addresses.4
    ...
    function batchMint(
        ...
        ERC721Invariants.roleInvariants(ams, _msgSender(), CREATOR_ROLE_NAME);
        ERC721Invariants.batchMintInvariants(
            _category,
            _toAddresses,
            _tokenIds
        );
        dropManager.onBatchMint(_category, _tokenIds);

        for (uint256 i = 0; i < _toAddresses.length; i++) {
            _safeMint(_toAddresses[i], _tokenIds[i], "");
        }
    }
    ...
    function getApproved(uint256 _tokenId)
        ...
        returns (address)
    {
        return owners.getApprovedForItem(ownerOf(_tokenId), _tokenId);
    }
    ...
    function setApprovalForAll(address _operator, bool _approved)
        ...
        whenNotPaused
    {
        ERC721Invariants.approveForAll(
            owners,
            ams,
            _msgSender(),
            _operator,
    ...
    function isApprovedForAll(address _owner, address _operator)
        ...
        returns (bool)
    {
        return owners.isApprovedForAll(_owner, _operator);
    }
    ...
    function amountRemainingInDrop(string memory _dropName)
        ...
        returns (uint256)
    {
        return dropManager.amountRemainingInDrop(_dropName);
    }
    ...
    function dropMintCount(string memory _dropName)
        ...
        returns (uint256)
    {
        return dropManager.dropMintCount(_dropName);
    }
    ...
    function dropNameForIndex(uint256 _index)
        ...
        returns (string memory)
    {
        return dropManager.dropNameForIndex(_index);
    }
    ...
    function dropForName(string memory _dropName)
        ...
        returns (Drop memory)
    {
        return dropManager.dropForName(_dropName);
    }
    ...
    function isDropActive(string memory _dropName) public view returns (bool) {
        return dropManager.isDropActive(_dropName);
    }
    ...
    function deactivateDrop(string memory _dropName)
        ...
        onlyOwnerOrRole(CREATOR_ROLE_NAME)
    {
        dropManager.deactivateDrop(_dropName);
    }
    ...
    {
        ERC721Invariants.recallInvariants(
            owners,
            ams,
            tracker,
            _toAddress,
    ...
    function recoverSanctionedAsset(address _destination, uint256 _tokenId)
        ...
        onlyOwner
    {
        ERC721Invariants.recoverInvariants(owners, ams, _destination, _tokenId);
        _doRecall(_destination, _tokenId);
    }
    ...
    function makeUnrecallable(uint256 _tokenId) public {
        ERC721Invariants.makeUnrecallableInvariants(
            owners,
            ams,
            _msgSender(),
            CUSTOMER_SERVICE,
    ...
    {
        owners.enforceItemExists(_tokenId);
        return owners.isApproved(_spender, ownerOf(_tokenId), _tokenId, 1);
    }
    ...
    function _safeMint(
        ...
        ERC721Invariants.checkOnERC721Received(
            address(0),
            _toAddress,
            _tokenId,
            _data
    ...
    function _mint(address _toAddress, uint256 _tokenId) internal virtual {
        ERC721Invariants.internalMintInvariants(
            owners,
            ams,
            _toAddress,
            _tokenId
        ...
        owners.doTransfer(_msgSender(), address(0), _toAddress, _tokenId, 1);
    ...
    function _burn(uint256 _tokenId) internal virtual {
        ...
        owners.doTransfer(_msgSender(), token_owner, address(0), _tokenId, 1);
        tracker.clearBornOnDate(_tokenId);
        dropManager.onBurn(_tokenId);
        emit Transfer(token_owner, address(0), _tokenId);
        _post_burn_hook(token_owner, _tokenId);
    }

    function _doRecall(address _destination, uint256 _tokenId) internal {
        address currentOwner = owners.ownerOfItemAtIndex(_tokenId, 0);
        owners.approveForItem(currentOwner, _msgSender(), _tokenId);

        if (_destination == address(0)) {
            _burn(_tokenId);
        } else {
            ERC721Invariants.internalDoSafeTransfer(
                owners,
                _msgSender(),
                currentOwner,
                _destination,
        ...
        emit TokenRecalled(_tokenId, _destination);
    }
...
// File: MutableViciERC721.sol

/**
 * @title MutableViciERC721
 * @dev This contract exposes the calls to the state machine library as
 *      internal contract functions so that subclasses have easy access to them
 *      and can wrap them in the appropriate business logic.
 */
contract MutableViciERC721 is ViciERC721 {
    using OwnerOperatorApproval for OwnerOperatorApproval.OwnerOperator;
    using DropManagement for DropManagement.DropManager;
    ...
    constructor(
        ...
        string memory _symbol,
        uint256 _maxSupply
    ) ViciERC721(_name, _symbol, _maxSupply) {}
    ...
    function _setBaseURIForState(
        ...
        dropManager.setBaseURIForState(_dropName, _stateName, _baseURI);
    }
    ...
    function getBaseURIForState(
        ...
        return dropManager.getBaseURIForState(_dropName, _stateName);
    }
     ...
     * @param _fromState the "from" side of the transition
     * @param _toState the "to" side of the transition
     * @param _baseURI the base URI for the "to" state
     *
     * Requirements:
     * - `_dropName` MUST refer to a valid drop
     * - `_fromState` MUST refer to a valid state for `_dropName`
    ...
    function _deleteStateTransition(
        ...
        dropManager.deleteStateTransition(_dropName, _fromState, _toState);
    }
     ...
     * @param _stateName the new state
     *
     * Requirements:
     * - `_tokenId` MUST exist
     * - The token MUST have been minted as part of a drop.
     * - The transition from the token's current state to `_stateName` MUST be
     *      valid.
     */
    function _changeState(uint256 _tokenId, string memory _stateName) internal {
        owners.enforceItemExists(_tokenId);
        dropManager.changeState(_tokenId, _stateName);
    }
     ...
     * - `_tokenId` MUST exist
     * - The token MUST have been minted as part of a drop.
     * - `_stateName` MUST exist in the state machine for this token's drop.
     * - The transition from the token's current state to `_stateName` MAY be
     *      invalid.
     */
    function _setState(uint256 _tokenId, string memory _stateName) internal {
        owners.enforceItemExists(_tokenId);
        dropManager.setState(_tokenId, _stateName);
    }
    ...
    function getState(uint256 _tokenId) public view returns (string memory) {
        owners.enforceItemExists(_tokenId);
        return dropManager.getState(_tokenId);
    }
}

// File: TestSample3.sol

/**
 * @title TestSample3
 */
contract TestSample3 is MutableViciERC721 {
    bytes32 public GAME_ROLE = "game role";
    ...
    {
        setContractURI("https://storage.googleapis.com/arrival-shadow-motion-newman/sample-project/CollectionMetadata.json");
    }
    ...
    function setBaseURIForState(
        ...
        _setBaseURIForState(_dropName, _stateName, _baseURI);
    }
    ...
    function addStateTransition(
        ...
        _addStateTransition(_dropName, _fromState, _toState, _baseURI);
    }
    ...
    function deleteStateTransition(
        ...
        _deleteStateTransition(_dropName, _fromState, _toState);
    }

    function changeState(uint256 _tokenId, string memory _stateName)
        public
        onlyOwnerOrRole(GAME_ROLE)
    {
        _changeState(_tokenId, _stateName);
    }

    function setState(uint256 _tokenId, string memory _stateName)
        public
        onlyOwnerOrRole(GAME_ROLE)
    {
        _setState(_tokenId, _stateName);
    }
}