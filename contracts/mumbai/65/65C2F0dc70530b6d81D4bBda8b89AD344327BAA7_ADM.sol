    ...
    */
    ...
    function _calLevelNow(address _user) private view returns(uint256) {
        ...
        if(total >= 2000e6 && user.teamNum >= 200 && maxTeam >= 70000e6 && otherTeam >= 70000e6){
             levelNow = 5;
        }else if(total >= 2000e6 && user.teamNum >= 50 && maxTeam >= 22000e6 && otherTeam >= 22000e6){
             levelNow = 4;
        }else if(total >= 1500e6 && user.teamNum >= 30 && maxTeam >= 18000e6 && otherTeam >= 18000e6){
             levelNow = 3;
        }
        else if(total >= 1000e6 && user.teamNum >= 20 && maxTeam >= 15000e6 && otherTeam >= 15000e6){
           levelNow = 2;
        }else if(total >= 50e6){
            levelNow = 1;
        }
