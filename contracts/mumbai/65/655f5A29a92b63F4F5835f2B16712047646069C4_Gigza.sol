...
struct Job {
        ...
        string message;
        string url;
        //mapping(uint256 => Bid[]) jobIdtoBids;
    }
struct Bid {
        uint256 jobId;
        string description;
...
contract Gigza is Ownable {
    ...
    function createJobPost(
        ...
        //Emit the event for a successful job post. The frontend parses this message and updates the end user
        emit JobPosted(
            newJobId,
            title,
            description,
    ...
    **/
    ...
    public onlyOwner
    {
        ...
        //the event emitted when a job is successfully posted
    event JobPosted (
