...
contract FantationMarket {
    ...
    function ListMarketItem(
        ...
        require(msg.value == listingPrice, "Must pay the creating price");
    ...
    function buyMarketItem(uint256 itemId, uint amount) public payable {
        ...
        IERC1155(marketItems[itemId].nftContractAddress).safeTransferFrom(
            address(this),
            msg.sender,
