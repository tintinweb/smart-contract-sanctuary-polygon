...
contract Factory {
    ...
    function deploy(
        ...
        addr = address(
            new BuyrareUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        BuyrareUser721Token token = BuyrareUser721Token(address(addr));
...
contract BuyrareUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
