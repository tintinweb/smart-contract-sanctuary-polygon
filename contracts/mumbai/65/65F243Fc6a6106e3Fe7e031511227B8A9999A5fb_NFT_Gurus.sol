...
contract NFT_Gurus is ERC721EnumerableUpgradeable, OwnableUpgradeable {
    ...
    function initialize(string memory baseURI, address _fundWallet) public initializer {
