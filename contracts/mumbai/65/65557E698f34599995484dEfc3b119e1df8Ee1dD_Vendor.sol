...
contract Vendor is Ownable {
    ...
    function buyTokens() external payable {
        require(msg.value > 0, "You must send more than 0 wei");
    ...
    function sellTokens(uint256 amount) external {
        ...
        require(success, "Failed to send Ether");
        // is it possible that between these two calls something goes wrong?
        // should we send eth first or transfer token first?
        // like no more eth in balance?
