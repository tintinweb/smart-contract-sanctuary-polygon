    ...
    Role
{
    ...
    function initialize(
        ...
        _init(_name, _symbol, _contractURI, tokenURIPrefix, _royalty, _admin);
    }
    ...
    function __Niftyco721_init(
        ...
        __Niftyco721_init_unchained(name, symbol, _contractURI, tokenURIPrefix, _royalty, _admin);
    }

    function __Niftyco721_init_unchained(
        string memory name,
        string memory symbol,
        string memory _contractURI,
        string memory tokenURIPrefix,
        ...
        _init(name, symbol, _contractURI, tokenURIPrefix, _royalty, _admin);
    }
