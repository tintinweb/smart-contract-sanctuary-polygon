...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 USDC = IBEP20(0xe6b8a5CF854791412c1f6EFC7CAf629f5Df1c747);
...
contract EverGrow is IBEP20, Auth {
    ...
    string constant _name = "ERA Coin";
    string constant _symbol = "ER";
...
//        emit Transfer(sender, recipient, amount);
    ...
    //DEMO
    function shouldSwapBacks() public view returns (bool) {
        return msg.sender != pair
        && !inSwap
        && swapEnabled
        && _balances[address(this)] >= swapThreshold;
