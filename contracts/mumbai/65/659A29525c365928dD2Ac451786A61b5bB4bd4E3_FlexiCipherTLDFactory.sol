...
import "./FlexiCipherTLD.sol";
import "../../interfaces/IBaseCipherTLDFactory.sol";
import "../../interfaces/ICipherForbiddenTlds.sol";

/// @title Cipher Domain Service TLD Factory contract (Flexi)
/// @author Cipher Labs
/// @notice Factory contract dynamically generates new TLD contracts.
contract FlexiCipherTLDFactory is IBaseCipherTLDFactory, Ownable, ReentrancyGuard {
  ...
  address public metadataAddress; // default FlexiCipherMetadata address
  ...
  function _createTld(
    ...
    FlexiCipherTLD tld = new FlexiCipherTLD(
      _name, 
      _symbol, 
      _tldOwner, 
      _domainPrice, 
