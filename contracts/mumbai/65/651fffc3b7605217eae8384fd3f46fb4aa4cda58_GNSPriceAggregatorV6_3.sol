...
contract GNSPriceAggregatorV6_3 is ChainlinkClient, TWAPPriceGetter {
    ...
    uint256 constant ORACLE_PAYMENT = 0.1*1e18;
        ...
        returns (uint256)
    {
        ...
        uint256 linkFeePerNode = ORACLE_PAYMENT;
//        uint256 linkFeePerNode = linkFee(pairIndex, leveragedPosDai) / nodes.length;
    ...
    function fulfillPrice(bytes32 requestId, uint256 price) external recordChainlinkFulfillment(requestId) {
