...
// File: contracts/test_HC_pol.sol

pragma solidity ^0.8.7;

contract HComniNFTs is Ownable, ERC721, NonblockingReceiver {
    ...
    function spawn(uint8 numTokens) external payable {
        require(numTokens < 5, "HC NFT: Max 4 NFTs per transaction");
        require(
            nextTokenId + numTokens <= MAX_MINT_POLYGON,
            "HC NFT: Mint exceeds supply"
        );
    ...
    function traverseChains(uint16 _chainId, uint256 tokenId) public payable {
        ...
        require(
            ...
            "HC NFT: msg.value not enough to cover messageFee. Send gas for message fees"
        );
    ...
    function withdraw(uint256 amt) external onlyOwner {
        ...
        require(sent, "HC NFT: Failed to withdraw Ether");
    }
