...
// File: czm/newsale.sol


pragma solidity ^0.8.9;


contract TiFiMarket is ERC20 {
    address payable public contractOwner;
    bool public isSaleActive;

    uint256 public constant TOKEN_RATE = 1000; // 1 ETH = 1000 tokens
    ...
    function buyTokens(uint256 ethAmount) external payable {
        ...
        contractOwner.transfer(msg.value); // Transfer received ETH to the contract owner
    }
    ...
    function transferTokens(address recipient, uint256 amount) external onlyOwner {
        require(balanceOf(address(this)) >= amount, "Insufficient tokens in contract balance");
