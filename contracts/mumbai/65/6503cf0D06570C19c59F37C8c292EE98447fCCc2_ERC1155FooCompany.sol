    ...
    UUPSUpgradeable
{
    ...
    function __ERC1155FooCompany_init(
        string memory name_,
        ...
        for (uint8 i = 0; i < _addresses.length; i++) {
            ...
            require(
                ...
                "ERC1155FooCompany: delegate call to non-contract"
            );
    ...
    function transferToRecipients(
        ...
        require(
            ...
            "ERC1155FooCompany: not enough tokens are owned."
        );
    ...
    function toHexDigit(uint8 d) internal pure returns (bytes1) {
        ...
        revert("ERC1155FooCompany: invalid value for hexadecimal.");
    }
