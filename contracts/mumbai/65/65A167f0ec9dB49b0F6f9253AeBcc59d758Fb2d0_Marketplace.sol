...
contract Marketplace is ReentrancyGuard, Ownable{
    ...
    function sellNFTItem(
        ...
        require(tokenId > 0, "valid tokenId from 1");
    ...
    function editNFTItem(uint256 marketItemId, uint256 _inBnbprice, uint256 _inTokenprice) public nonReentrant {
        ...
        require(marketItemId > 0, "valid marketId from 1");
        ...
        require(marketItemIdToMarketItem[marketItemId].canceled == false, "NFT item is canceled");
    ...
    function cancelNFTItem(uint256 marketItemId) public nonReentrant {
        require(marketItemId > 0, "valid Market item must be more than 0");
