 ...
 * if (((((claimCoinPrice0) * (nosCreditsPerToken with element _tokenId)) / (10**18)) * (claimCoinPrice0SourceSplit0)) / (100)) is strictly greater than 0 then (calls ERC20(Address 0xd875313ba1F7c7261FB2d2d4C2459fF69bfF12A7)'s at transfer function  with variable recipient as Address 0x0000000000000000000000000000000000000000, variable amount as (((((claimCoinPrice0) * (nosCreditsPerToken with element _tokenId)) / (10**18)) * (claimCoinPrice0SourceSplit0)) / (100)))
...
*/
	function claim(uint256 _tokenId) public {
		...
		if ((((((claimCoinPrice0 * nosCreditsPerToken[_tokenId]) / uint256(10**18)) * claimCoinPrice0SourceSplit0) / uint256(100)) > uint256(0))){
			ERC20(address(0xd875313ba1F7c7261FB2d2d4C2459fF69bfF12A7)).transfer(address(0x0000000000000000000000000000000000000000), ((((claimCoinPrice0 * nosCreditsPerToken[_tokenId]) / uint256(10**18)) * claimCoinPrice0SourceSplit0) / uint256(100)));
		}
