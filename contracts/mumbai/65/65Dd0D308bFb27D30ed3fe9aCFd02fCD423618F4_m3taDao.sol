    ...
    Ownable
{
    ...
    string private constant _OrganizationSchema = "userAddress text, identifier text, userDID text, groupID text, userName text, imageURI text, description text";

    string  private _UserTable;
    string  private _UserTablePrefix;
    uint256 private _UserTableId;

    string private constant _UserSchema = "founderAddress text, identifier text, OrganizationID text, groupID text, OrganizationHex text, OrganizationName text, imageURI text, description text";
        ...
        public  
    {
        ...
        SQLHelpers.toInsert(
                ...
                string.concat(
                    ...
                    ",",
                    Strings.toString(OrganizationID),
                    ",",
                    groupID,
                    ",",
                    OrganizationHex,
