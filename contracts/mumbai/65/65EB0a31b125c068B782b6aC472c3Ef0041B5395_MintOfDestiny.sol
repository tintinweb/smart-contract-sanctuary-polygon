...
contract MintOfDestiny is Pausable, ReentrancyGuard, IERC721Receiver {
    ...
    */
    ...
    constructor(IERC20 _paymentToken, address _gameWallet){
    ...
    */
    ...
    function addRole(string memory roleName, uint256 tokenLimit, bool allowPublicMint, uint256 price, uint256 priceERC20, string memory mandatoryRole, bool hasAttachedMint, string memory attachedMintRole) public onlyAdmins whenNotPaused {
    ...
    function updateRoleDetails(string memory roleName, bool allowPublicMint, uint256 price, uint256 priceERC20, string calldata mandatoryRole, bool hasAttachedMint, string calldata attachedMintRole) public onlyAdmins {
    ...
    function updateGameWallet(address _gameWallet) public onlyAdmins {
        gameWallet = _gameWallet;
    }

    function changePaymentToken(IERC20 paymentTokenContractAddress) public onlyAdmins {
    ...
    */
    ...
    function publicMint(string calldata roleName, bool useERC20) public onlyHumans payable whenNotPaused nonReentrant {
    ...
    */
    ...
    function getCostOfTokenByRole(string memory roleName) public view returns(uint256[] memory){
        // Initialize the return array of prices (MATIC / ERC20 in Eth)
