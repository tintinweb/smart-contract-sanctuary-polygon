...
contract DTBSTS is Context, AccessControlEnumerable, ERC20Burnable, ERC20Pausable, ReentrancyGuard, BlackList {
    ...
    constructor() ERC20("DividendTokenBotSuperTrendSwap", "DTBSTS") {
        locked_withdraw = false;
        _grantRole(ROLE_ADMIN, _msgSender());
        setDecimals(6);
        tokenDividend = ERC20(0x8c4f2D40b70271488A8ca4934C4850287Ca519D0);
        tokenSwap = ERC20(0x9daDC583280b12dF9029bb72Ea4EaD730CFDf926);
    }
