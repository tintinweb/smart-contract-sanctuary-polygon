...
contract ERC20Token is IERC20, MyInterceptor{
    ...
    function allowance(address _ownerAddress, address _spenderAddress) override public view returns (uint256)
    {
        return allowanceMaps[_ownerAddress][_spenderAddress];
    }
...
contract BasicToken is ERC20Token, Pausable{
    ...
    function decreIssue(uint256 _amount) public onlyOwner whenNotPaused
    {
        ...
        require(balanceMaps[owner] >= _amount, "Insufficient balance!");
...
{
    constructor() public BasicToken(1000000000, "USDT", "USDT", 6)
    {
        platfomType = PlatformType.ETH;
    }
}

contract MyUT is BasicToken
{
    constructor() public BasicToken(1000000000, "MyUT", "MyUT", 6)
    {
