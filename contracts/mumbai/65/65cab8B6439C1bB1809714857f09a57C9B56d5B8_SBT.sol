...
contract SBT is ERC721URIStorage, MinterRole {
    ...
    /*SBT Type - Commitment
    (All properties that were in Affiliation SBT -based on which this credential SBT has been issued).
        Start Date and Time
        End Date and Time
        Status - Completed / Quotaful / ScreenOut/ Data Quality Check Failed
        Data NFT ID
        XP Points - <Number of XP points earned>
        Token Name: 
        Token Smart Contract Address: 
        Amount - <Number of ERC 20 tokens/EQ8 Tokens)
        Status - (Claimed/Un-Claimed)
        SBT Hash (By clicking on this, use should be able open this SBT in the chain-explorer)
    */
