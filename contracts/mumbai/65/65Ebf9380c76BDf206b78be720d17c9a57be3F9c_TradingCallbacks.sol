...
contract TradingCallbacks{
    ...
    constructor(address _tradingStorageAddress) {
    ...
    function openTradeMarketCallback(AggregatorAnswer memory a) external onlyPriceAggregator notDone{
        ...
        StorageInterface.PendingMarketOrder memory o = storageT.reqID_pendingMarketOrder(a.orderId);
        if(o.block == 0){ return; }
        ...
        || !withinExposureLimits(t.pairIndex, t.buy, t.positionSizeDai, t.leverage)){
            ...
            (StorageInterface.Trade memory finalTrade, uint tokenPriceDai) = registerTrade(t, 1500, 0);
    ...
    function closeTradeMarketCallback(AggregatorAnswer memory a) external onlyPriceAggregator notDone{
        ...
        StorageInterface.Trade memory t = storageT.openTrades(o.trade.trader, o.trade.pairIndex, o.trade.index);

        if(t.leverage > 0){

            StorageInterface.TradeInfo memory i = storageT.openTradesInfo(t.trader, t.pairIndex, t.index);
            AggregatorInterface aggregator = storageT.priceAggregator();
    ...
    function executeNftOpenOrderCallback(AggregatorAnswer memory a) external onlyPriceAggregator notDone{
        ...
        StorageInterface.PendingNftOrder memory n = storageT.reqID_pendingNftOrder(a.orderId);
        NftRewardsInterface nftIncentives = storageT.priceAggregator().nftRewards();
        ...
        && block.number >= storageT.nftLastSuccess(n.nftId) + storageT.nftSuccessTimelock()){
            ...
            StorageInterface.OpenLimitOrder memory o = storageT.getOpenLimitOrder(n.trader, n.pairIndex, n.index);
            NftRewardsInterface.OpenLimitOrderType t = nftIncentives.openLimitOrderTypes(n.trader, n.pairIndex, n.index);

            a.price = marketExecutionPrice(a.price, a.spreadP, o.spreadReductionP, o.buy);

            if((t == NftRewardsInterface.OpenLimitOrderType.LEGACY ? (a.price >= o.minPrice && a.price <= o.maxPrice) :
                t == NftRewardsInterface.OpenLimitOrderType.REVERSAL ? (o.buy ? a.price <= o.maxPrice : a.price >= o.minPrice) :
                (o.buy ? a.price >= o.minPrice : a.price <= o.maxPrice))
            && withinExposureLimits(o.pairIndex, o.buy, o.positionSize, o.leverage)){

                (StorageInterface.Trade memory finalTrade, uint tokenPriceDai) = registerTrade(
                    StorageInterface.Trade(
                        o.trader,
                        o.pairIndex,
                        0, 0,
                        o.positionSize,
                        t == NftRewardsInterface.OpenLimitOrderType.REVERSAL ? o.buy ? o.maxPrice : o.minPrice : a.price,
                        o.buy,
                        o.leverage,
                        o.tp,
                        o.sl
        ...
        nftIncentives.unregisterTrigger(NftRewardsInterface.TriggeredLimitId(n.trader, n.pairIndex, n.index, n.orderType));
    ...
    function executeNftCloseOrderCallback(AggregatorAnswer memory a) external onlyPriceAggregator notDone{
        ...
        StorageInterface.PendingNftOrder memory o = storageT.reqID_pendingNftOrder(a.orderId);
        StorageInterface.Trade memory t = storageT.openTrades(o.trader, o.pairIndex, o.index);

        AggregatorInterface aggregator = storageT.priceAggregator();
        NftRewardsInterface nftIncentives = aggregator.nftRewards();
        ...
        && t.leverage > 0 && block.number >= storageT.nftLastSuccess(o.nftId) + storageT.nftSuccessTimelock()){
            ...
            v.price = pairsStored.guaranteedSlEnabled(t.pairIndex) ?
                        o.orderType == StorageInterface.LimitOrder.TP ? t.tp : 
                        o.orderType == StorageInterface.LimitOrder.SL ? t.sl : a.price : a.price;
            ...
            v.nftReward = 
                (o.orderType == StorageInterface.LimitOrder.TP && t.tp > 0 && (t.buy ? a.price >= t.tp : a.price <= t.tp))
             || (o.orderType == StorageInterface.LimitOrder.SL && t.sl > 0 && (t.buy ? a.price <= t.sl : a.price >= t.sl)) ? 
                    v.posToken * t.leverage * pairsStored.pairNftLimitOrderFeeP(t.pairIndex) / 100 / PRECISION : 
                o.orderType == StorageInterface.LimitOrder.LIQ && v.profitP <= int(LIQ_THRESHOLD_P*PRECISION) * (-1) ? 
                    v.posToken / 20 : 0;
            ...
            if(v.nftReward > 0){
                ...
                nftIncentives.distributeNftReward(
                    NftRewardsInterface.TriggeredLimitId(o.trader, o.pairIndex, o.index, o.orderType),
                    v.nftReward
                );
        ...
        nftIncentives.unregisterTrigger(NftRewardsInterface.TriggeredLimitId(o.trader, o.pairIndex, o.index, o.orderType));
        storageT.unregisterPendingNftOrder(a.orderId);
    }
    function updateSlCallback(AggregatorAnswer memory a) external onlyPriceAggregator notDone{
        
        AggregatorInterface aggregator = storageT.priceAggregator();
        AggregatorInterface.PendingSl memory o = aggregator.pendingSlOrders(a.orderId);
    ...
    function registerTrade(
        StorageInterface.Trade memory _trade, 
        uint _nftId, 
        uint _limitIndex
        ...
        if(_nftId < 1500){
            ...
            aggregator.nftRewards().distributeNftReward(
                NftRewardsInterface.TriggeredLimitId(
                    _trade.trader, _trade.pairIndex, _limitIndex, StorageInterface.LimitOrder.OPEN
                ), nTokens
            );
    ...
    function unregisterTrade(
        ...
        VaultInterface vault = storageT.vault();
    ...
    function withinExposureLimits(uint _pairIndex, bool _buy, uint _positionSizeDai, uint _leverage) private view returns(bool){
        PairsStorageInterface pairsStored = storageT.priceAggregator().pairsStorage();
