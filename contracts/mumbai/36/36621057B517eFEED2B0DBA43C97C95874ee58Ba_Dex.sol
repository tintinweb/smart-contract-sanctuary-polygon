...
// File: FLASHLOANTOOLS/Context.sol
...
// File: FLASHLOANTOOLS/IERC20.sol
...
// File: FLASHLOANTOOLS/IERC20Metadata.sol
...
// File: FLASHLOANTOOLS/MintableERC20.sol
...
contract Dex {
    ...
    function depositUSDC(uint256 _amount) external {
        ...
        MintableERC20 token = MintableERC20(address(0));
    ...
    function depositDAI(uint256 _amount) external {
        ...
        require(allowance >= _amount, "Check the token allowance");
        MintableERC20 token = MintableERC20(daiAddress);
