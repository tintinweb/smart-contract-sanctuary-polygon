...
contract BadMagic is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxMintAmount = 666;
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    require(_mintAmount <= maxMintAmount, "Mint amount above maximum allowable");
    require(supply + _mintAmount <= maxSupply, "All NFTs are minted.");
    ...
    if (msg.sender != owner()) {
     require(!paused, "Minting is paused");
         if (onlyWhitelisted == true) {
           ...
           require(ownerTokenCount < nftPerAddressLimit, "This address may not Mint any more");
        }
