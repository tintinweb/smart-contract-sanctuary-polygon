...
contract MetaFin is ChainlinkClient, Ownable {
    ...
    address RewardTokenAddress = 0xF743201D84dA2bCe7C67de31c981D2dcE01f558c; // Reward
    address StakeTokenAddress = 0x4351E3d86aDD4FeB510c439E95989C4DdA103c4E; // Stake
    ...
    function getUserTotalValue(address user) public view returns (uint256) {
        ...
        if (uniqueTokensStaked[user] > 0) {
            totalValue =
                totalValue +
                getUserTokenStakingBalanceEthValue(user, StakeTokenAddress);
        }
        return totalValue;
    }
