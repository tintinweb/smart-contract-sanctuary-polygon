...
contract PolygonNetworkNFT is ERC721Enumerable, Ownable {
    ...
    event WithdrawResponse(bool success, bytes data);
    ...
    constructor(address _signer) ERC721("PolygonNFT", "PNFT") {
        serverAddress = _signer;
    }
    ...
    function mintWithSignature(
        ...
        payable
        isCorrectPayment
        validServerSignature(_tokenId, _deadline, v, r, s)
    {
        currentTokenId.increment();
        uint256 newItemId = currentTokenId.current();
        _safeMint(msg.sender, newItemId);
        emit LogTokenMinted(msg.sender, _tokenId);
    }
        ...
        returns (string memory)
    {
        ...
        return
            "https://gitlab.com/amimaro/nft-test-images/-/raw/main/off-chain-contract-authorization/metadata/polygon";
    }
    ...
    function withdraw() public onlyOwner {
        ...
        emit WithdrawResponse(success, data);
    }
