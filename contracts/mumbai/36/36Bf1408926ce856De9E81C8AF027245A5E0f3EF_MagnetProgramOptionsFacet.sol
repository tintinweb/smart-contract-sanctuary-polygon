...
library MagnetProgramOptionsLib {
    ...
    function getLeaderPercernt(int8 prgm) external view returns (uint) {
    ...
    function getOptions(int8 prgm) external view returns (Options memory) {
        return getStorage().options[prgm];
    }
...
contract MagnetProgramOptionsFacet {
    function getLeaderPercernt(int8 prgm) external view returns (uint) {
        return MagnetProgramOptionsLib.getLeaderPercernt(prgm);
    }
    ...
    function getStructurePartnerUpPercernts(
        ...
        return MagnetProgramOptionsLib.getStructurePartnerUpPercernts(prgm);
    }

    function getStructurePartnerDownPercernts(
        int8 prgm
    ) external view returns (uint[] memory) {
        return MagnetProgramOptionsLib.getStructurePartnerDownPercernts(prgm);
    }

    function getReferralPercernts(
        int8 prgm
    ) external view returns (uint[] memory) {
        return MagnetProgramOptionsLib.getReferralPercernts(prgm);
    }
}