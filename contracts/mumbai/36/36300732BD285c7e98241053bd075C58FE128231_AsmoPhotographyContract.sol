...
//*********************************************************************//
//
//     ___                         ____  __          __                               __             _____ _____ _____
//    /   |  _________ ___  ____  / __ \/ /_  ____  / /_____  ____ __________ _____  / /_  __  __   / ___// ___// ___/
//   / /| | / ___/ __ `__ \/ __ \/ /_/ / __ \/ __ \/ __/ __ \/ __ `/ ___/ __ `/ __ \/ __ \/ / / /  / __ \/ __ \/ __ \ 
//  / ___ |(__  ) / / / / / /_/ / ____/ / / / /_/ / /_/ /_/ / /_/ / /  / /_/ / /_/ / / / / /_/ /  / /_/ / /_/ / /_/ / 
// /_/  |_/____/_/ /_/ /_/\____/_/   /_/ /_/\____/\__/\____/\__, /_/   \__,_/ .___/_/ /_/\__, /   \____/\____/\____/  
//                                                         /____/          /_/          /____/                        
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x073Ec40559855d83fB140a18253861aB6b83D0Be];
  address public erc20Payable = 0x073Ec40559855d83fB140a18253861aB6b83D0Be;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 666) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeid4epcxdwennr42mse53fnvxjtl5szio7dzkzqibzfqzsnvreg73q/";
...
// File: contracts/AsmoPhotographyContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AsmoPhotographyContract is RamppERC721A {
    constructor() RamppERC721A("AsmoPhotography", "AsmoPho666"){}
}
