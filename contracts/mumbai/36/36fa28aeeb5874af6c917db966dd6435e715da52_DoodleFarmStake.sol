...
/* STAKING MECHANICS */
    ...
    function setFudFarmTokenAddress(address erc721Addr) public onlyOwner() {
    ...
    //deposit function. 
    function deposit(uint256[] calldata tokenIds) external whenNotPaused requireFudFarmToken requireERC20Token {
    ...
    //withdrawal function.
    function withdraw(uint256[] calldata tokenIds) external whenNotPaused requireFudFarmToken requireERC20Token nonReentrant() {
        claimRewards(tokenIds);
