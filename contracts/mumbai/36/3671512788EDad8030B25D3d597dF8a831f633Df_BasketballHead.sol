...
contract BasketballHead is IERC2981, ERC165Storage, Ownable, IERC1155MetadataURI, ERC1155, MinterRole {
    ...
    */
    constructor(string memory _name, string memory _symbol, string memory _tokenURIPrefix, address _royalty) ERC1155(_tokenURIPrefix) {
        name = _name;
        symbol = _symbol;
    ...
    */
    ...
    /**
     * @dev free mint function.
     */
    function freeMint() external {
        require(freeMintSupply > 0, "no available free mint");
        safeMint(msg.sender, 1, 1);
        totalsupply+=1;
        freeMintSupply--;
    }
    ...
    /**
     * @dev set free mint supply function
     */
    function updateFreeMintSupply(uint256 _count) external onlyAdmin {
        freeMintSupply += _count;
        maxsupply += _count;
    }
    ...
    function getReservedCount() public view returns(uint) {
        return reserveCount[msg.sender];
    }
