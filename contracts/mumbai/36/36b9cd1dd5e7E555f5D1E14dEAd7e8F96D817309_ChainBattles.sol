...
contract ChainBattles is ERC721URIStorage {
    ...
    function getLevels(uint256 tokenId) public view returns (string memory) {
        ...
        return string(
            abi.encodePacked(
            '<tspan x="50%" y="30%">Level: ', attributes.level.toString(), "</tspan>",
            '<tspan x="50%" y="50%">Speed: ', attributes.speed.toString(), "</tspan>",
            '<tspan x="50%" y="70%">Strength: ', attributes.strength.toString(), "</tspan>",
            '<tspan x="50%" y="90%">Life: ', attributes.life.toString(), "</tspan>"
        ));
    }
