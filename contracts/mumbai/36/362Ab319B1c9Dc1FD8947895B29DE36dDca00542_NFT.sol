...
import "./utils/ERC4610.sol";
import "@openzeppelin/contracts/security/Pausable.sol";
import "@openzeppelin/contracts/utils/Counters.sol";

// Digital Monster Game Asset
contract NFT is ERC4610, Pausable {
    using Address for address;
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIds;

    uint public constant CREATION_LIMIT = 10000;
    string private URI = "https://ipfs.moralis.io:2053/ipfs/QmWECfepH5i5JuhKhMJK6HWpEe1NxpTkHskd3x9uHrHb8k/MageClass_637928177036052461.json"; 
    uint internal price = (1 ether)/10;
    address payable private _owner;

    
    constructor(string memory name_, string memory symbol_) ERC4610(name_, symbol_) payable {
   ...
   function mintNFT() public payable returns(uint){
     require(_tokenIds.current() < CREATION_LIMIT," creation limit exceeds");
 ...
 */
contract ERC4610 is  ERC165, ERC721URIStorage, Ownable {
    using Address for address;
     ...
     */
    function setDelegator(address delegator, uint256 tokenId) public virtual {
        address owner = ownerOf(tokenId);
     ...
     */
    function delegatorOf(uint256 tokenId) public view virtual returns (address) {
    ...
    function _safeTransfer(
        ...
        _transfer(from, to, tokenId);
        require(_checkOnERC721Received4610(from, to, tokenId, _data), "ERC721: transfer to non ERC721Receiver implementer");
    }
    ...
    function _safeMint(
        ...
        _mint(to, tokenId);
        require(
            _checkOnERC721Received4610(address(0), to, tokenId, _data),
     ...
     */
    function _checkOnERC721Received4610(
        address from,
        address to,
        uint256 tokenId,
        bytes memory _data
