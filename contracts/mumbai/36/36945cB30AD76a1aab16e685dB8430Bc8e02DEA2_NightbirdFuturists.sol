...
contract NightbirdFuturists is ERC721A, BaseRoyalties, Ownable {

    ///@dev Interface for royalties
    ...
    function supportsInterface(bytes4 interfaceId) public view override (ERC721A, BaseRoyalties)
        returns(bool){
    ...
    function withdraERC20(IERC20 _erc20Token) external onlyOwner {
