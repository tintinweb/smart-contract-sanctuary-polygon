...
contract MergeGators is Ownable, VRFConsumerBaseV2, IMergeGators {
    ...
    function merge3NFTs(uint256 _1st, uint256 _2nd, uint256 _3rd) public payable {
        ...
        payable(address(this)).transfer(_taxAmount);
        ...
        (bool success, ) = address(alligators).call{gas: 2_000_000}(mergeParams);
...
contract MergeGatorsMock is MergeGators {
    ...
    address payable collection_ = payable(0x42672d606908602f9df76825D4693425eFa0a9D6);
