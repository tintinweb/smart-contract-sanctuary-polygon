...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x11B4E83BC3e9605F03E2A4C34BD09567be5aeBBE];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 25, 1000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeigeyomfuk72syf6bqbxgg63kjgmom7lp67stdo5ao5s5bdlyxpcoa/";

    bool public mintingOpen = false;
    bool public isRevealed = false;
    
    uint256 public MAX_WALLET_MINTS = 25;
...
// File: contracts/GhDryRunPreRevealContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GhDryRunPreRevealContract is RamppERC721A {
    constructor() RamppERC721A("GH Dry Run PreReveal", "GHPR"){}
}