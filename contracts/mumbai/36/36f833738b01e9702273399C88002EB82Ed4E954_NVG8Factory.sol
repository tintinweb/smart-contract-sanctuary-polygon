...
contract NVG8Factory is Ownable {
    ...
    function setNvg8Marketplace(address _marketplace) public onlyOwner {
...
interface INVG8Marketplace {
        function enlistDataToken( address _erc721Token, address _erc20Token, address _owner, string memory _name, string memory _symbol, uint256 _usagePrice) external returns (bool);
}
