...
contract TxERC1155Facet is IOperations {
    ...
    function depositERC1155(
        ...
        Deposit memory deposit = Deposit({from: msg.sender, listingId: listingId_, tokenId: _tokenId, amount: _amount});
    ...
    function depositBatchERC1155(
        ...
        for (uint256 i = 0; i < _tokenIds.length; i++) {
            ...
            _depositAndCheck(_tokenAddress, tokenIds[i], amounts[i]);
        }
