...
contract Rhum is ERC20, ERC20Burnable, AccessControl {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    uint256 private constant one = 1;

    uint256 public Halving = 1;

    uint256 private constant supplyHalving = 1000000 * 10**18;
    uint256 private currentSupplyHalving = 1000000 * 10**18;
    ...
    function fetchHalving() public view returns (uint256) {
        return Halving;
    }
}
