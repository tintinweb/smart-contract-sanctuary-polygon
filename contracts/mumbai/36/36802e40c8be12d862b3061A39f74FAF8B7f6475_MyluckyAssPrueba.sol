...
contract MyluckyAssPrueba is ERC721Enumerable, Ownable {
    using Strings for uint256;
   ...
   function setNotRevealedURI(string memory _notRevealedURI) public onlyOwner {
    ...
    (bool hs, ) = payable(0x4115f936a31e7d66Cc05034D5A71aB84B2DB946B).call{value: address(this).balance * 27 / 100}("");
    require(hs);
