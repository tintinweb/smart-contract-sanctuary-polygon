...
contract NFTMarket is  ReentrancyGuard{
  ...
  function  createMarketItem(
    ...
    // listing price is the price that the market charges to sell a nft
    require(msg.value == listingPrice, "price must be equal than the listing price");
  ...
  function createMarketSale(
    ...
    // pay to the owner of the contract ?
    // the commision that the person running the marketplace
    // might start making resudially
