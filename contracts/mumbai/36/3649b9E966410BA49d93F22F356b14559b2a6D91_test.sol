...
contract test is ERC721, Ownable {
    ...
    /**
     * @dev This emits when Metadata of token is Update
     */
    ...
    */
    ...
    function mint(string memory uri) external {
        require(!_minted[msg.sender], "SBT already minted");
     ...
     *  @param tokenIds uint
     *  @param tokenURIs string
     */
    function setBatchTokenURI(uint256[] memory tokenIds, string[] memory tokenURIs) public onlyOwner {
        uint256 tokenIdLength = tokenIds.length;
        require(tokenIdLength <= 100, "Max length of token ids is 100");
     ...
     *
     * This is an internal function that sets _tokenURI
     */
    ...
    /**
     *  @notice Returns the account has Soulbound token or not
     */
    function hasSoul(address to) public view returns(bool) {
        return _minted[to];
    }
}
