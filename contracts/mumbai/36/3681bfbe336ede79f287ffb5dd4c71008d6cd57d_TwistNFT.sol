...
contract TwistNFT is ERC721EnumerableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function mintWithFee(address to) external payable {
        require(msg.value == _mintingFee, "Incorrect fee amount");
        require(totalSupply() < _maxSupply, "Max supply reached");
        require(to != address(0), "Invalid address");
    ...
    function _baseURI() internal view override returns (string memory) {
        // Implement your baseURI logic here
    }
}