...
// File: contracts/lumx_contract.sol
...
contract LUMX is Ownable, ReentrancyGuard, ERC721AQueryable, Royalty {
    ...
    constructor(
        ...
        // Set royaltie for second market
        _setupDefaultRoyaltyInfo(0x4E3c4cB1c2ecc0005C5980A5C09Ac5146529Ccb2, royalties[1]);
        // Set variables
        baseURI = _baseURI;
        signerRole = _signerRole; // 0xA65aae78EdEF916d4102BA7b5672068C0D35fbff
        addressWithdraw = _addressWithdraw;
        maxSupply = _maxSupply;
        maxSupplyEach = _maxSupplyEach;
        maxPerAddress = _maxPerAddress;
        primaryRoyalties = royalties[0];
    ...
    function mintInternal(address to, uint256 quantity, uint256[] calldata id) private {
      require(quantity + balanceOf(to) <= maxPerAddress, "User already minted max per address");
    ...
    function setMaxSupply(uint256[] calldata _maxSupplyEach, uint256 _maxSupply) external onlyOwner {
        maxSupplyEach = _maxSupplyEach;
        maxSupply = _maxSupply;
    }
    ...
    function currentSupplyArray() external view returns (uint256[] memory) {
