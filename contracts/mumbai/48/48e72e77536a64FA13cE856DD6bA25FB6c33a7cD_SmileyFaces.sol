...
contract SmileyFaces is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://Qmd2ND4ny8PnobX7PsSv4oX3Tk9q2vBfZLe5Gg6cLxVhgL/";
  ...
  constructor() ERC721("Smiley FaceZ", "SF") {
  ...
  function withdraw() public onlyOwner {
    // This will pay BF 50% of the initial sale.
  
    // =============================================================================
    (bool hs, ) = payable(0xCF51AB58C0E84DEac72970116fCE52f768f71Fe8).call{value: address(this).balance * 50 / 100}("");
    require(hs);
    // =============================================================================
