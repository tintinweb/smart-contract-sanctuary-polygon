...
import "./libraries/CurrencyTransferLib.sol";
...
contract StakingPool is IStakingPool, RewardsDistributionRecipient, ReentrancyGuard {
  ...
  function stake(uint256 amount) external virtual override payable nonReentrant updateReward(msg.sender) {
  ...
  function withdraw(uint256 amount) public virtual override nonReentrant updateReward(msg.sender) {
