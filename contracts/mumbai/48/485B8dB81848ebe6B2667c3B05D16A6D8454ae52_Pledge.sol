...
contract Pledge is IERC721ReceiverUpgradeable, OwnableUpgradeable {
    ...
    uint256 DAY_FREE_REWARD;  //每日积分奖励 FREE
    uint256 DAY_TOLL_REWARD;  //每日积分奖励 TOLL
    ...
    // 获取地址所有质押历史记录
    function getAddressStakeRecords() public view returns (StakeInfo[] memory) 
    {
        return addressStakeRecords[_msgSender()];
    }
