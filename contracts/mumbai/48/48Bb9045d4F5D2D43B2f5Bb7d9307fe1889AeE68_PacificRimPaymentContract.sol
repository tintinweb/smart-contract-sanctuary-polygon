...
contract PacificRimPaymentContract is Ownable, AccessControl, ReentrancyGuard {
    ...
    uint256 public whitelistSaleMintLimit; 
    uint256 public publicSaleTime; 
    uint256 public publicSaleDuration; 
    uint256 public preSalePerTransactionMintLimit;
    uint256 public whitelistSalePerTransactionMintLimit;
    uint256 public publicSalePerTransactionMintLimit;
