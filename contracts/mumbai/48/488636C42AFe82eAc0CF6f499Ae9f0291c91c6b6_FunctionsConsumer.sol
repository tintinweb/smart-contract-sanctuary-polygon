...
// import "FunctionsClient.sol"; // Once published
...
contract FunctionsConsumer is FunctionsClient, ConfirmedOwner {
     ...
     */
    constructor(
        address oracle, address owner
    ) FunctionsClient(oracle) ConfirmedOwner(owner) {}
    ...
    // Extra function
    // implemented to fetch data for LensGoal
    function getLatestReponseAndError() public view returns(bytes memory response, bytes memory err) {
        return (latestResponse, latestError);
    }
