...
abstract contract BernoulliGameBase is RandomnessConsumer, Ownable {
    ...
    /**
     * @return The current number of active bets waiting to be settled.
    ...
    /**
     * @return An array of all bets placed throughout this contracts history.
     */
    ...
    /**
     * @return The index of the oldest bet that hasn't been settled.
     */
    ...
    /**
     * @return The house edge for each bet.
     */
    ...
    /**
     * @return The max loss allowed, as a percentage of the contract's current balance.
     */
    ...
    /**
     * @return The total amount current at risk, from unsettled bets.
     */
    ...
    /**
     * @return The total contract profit since inception (negative for loss).
     */
    ...
    /**
     * @return The current randomness provider.  This is the only contract/address allowed to provided randomness to the game.
     */
