...
contract Dao {
	...
	function createProposal (string memory _description, address[] memory _canVote) public {
		...
		//To set the validity period of this proposal, 10000 is the time for 10000 blocks to be created onto the blockchain
		newProposal.deadline = block.number + 10000;
