...
contract TokenFactory is AccessControl {
 ...
 event whiteListed(address _userAddress,address _token);
    ...
    function _initProxy(
        ...
        success = false;
        (success, ) = proxy.call(
            abi.encodeWithSelector(0xf2fde38b, adminContract)
        );
