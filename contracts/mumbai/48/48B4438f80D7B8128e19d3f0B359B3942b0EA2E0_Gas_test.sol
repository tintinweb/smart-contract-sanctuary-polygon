...
contract Gas_test is ERC721, EIP712, ERC721Votes,Ownable{
 using Counters for Counters.Counter;
...
mapping(address => uint256) public minted;
 ...
 string baseURI;
  ...
  bool public revealed = false;
    ...
    constructor(string memory _initBaseURI, string memory _initNotRevealedUri) ERC721("MyToken", "MTK") EIP712("MyToken", "1") {
...
for (uint256 i=0;i<index;i++){
   ...
   require(preSaleIsActive,"Presale not started");
