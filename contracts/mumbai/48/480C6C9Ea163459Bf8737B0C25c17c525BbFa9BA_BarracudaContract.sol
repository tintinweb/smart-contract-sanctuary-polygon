...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x4466f0aC14A2F204441e6EDb8d6C97B18326B90E];
  address public erc20Payable = 0x4466f0aC14A2F204441e6EDb8d6C97B18326B90E;
...
abstract contract Feeable is Teams {
  uint256 public PRICE = 213 ether;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 40, 9000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmcNsQoR3Capm87YtHagHCdTRnA2fmo9rnQkmnpcZypBJm/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 9000");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 9000");
    ...
    function mintToMultipleERC20(address _to, uint256 _amount, address _erc20TokenContract) public payable {
      require(_amount >= 1, "Must mint at least 1 token");
      require(_amount <= maxBatchSize, "Cannot mint more than max mint per transaction");
      require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 9000");
      require(mintingOpen == true, "Minting is not open right now!");
...
// File: contracts/BarracudaContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BarracudaContract is RamppERC721A {
    constructor() RamppERC721A("barracuda", "BC"){}
}
