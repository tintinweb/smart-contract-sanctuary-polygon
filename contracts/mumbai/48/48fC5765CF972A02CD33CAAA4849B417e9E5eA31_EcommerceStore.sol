...
contract EcommerceStore is ERC1155SignatureMint {
    struct Product {
        uint id;
        string name;
        string description;
    ...
    function updateProduct(
        ...
        products[_id] = Product(_id, _name, _description, _price, _quantity);
        emit ProductUpdated(_id, _name, _description, _price, _quantity);
    }
