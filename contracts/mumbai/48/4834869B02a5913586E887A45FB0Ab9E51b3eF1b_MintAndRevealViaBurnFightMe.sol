...
contract MintAndRevealViaBurnFightMe is ERC721Base {
    ...
    function mintViaLootbox(uint256 _tokenId, address _burnerAddress, uint256 random) external onlyLootboxContract {
        _setTokenURI(nextTokenIdToMint(), string(abi.encodePacked(
