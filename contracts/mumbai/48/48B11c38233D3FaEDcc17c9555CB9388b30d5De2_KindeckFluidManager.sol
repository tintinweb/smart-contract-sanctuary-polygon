...
contract KindeckFluidManager is Ownable, IERC777Recipient {
    ...
    /**
     * @dev Can addresses be hardcoded with addresses here or how does that work?
     */
    function initialize(
        ISuperfluid _host,
    ...
    /**
     * @dev should be called by user through sdk instead?
     */
    ...
    /**
     * @notice needs to be called in order to trigger approve subscription from this contract to child contract's index
     *
     */
