...
contract BILD is Initializable, ERC20Upgradeable, AccessControlUpgradeable, ERC20PermitUpgradeable {
  
    bytes32 public constant ADMIN_ROLE = keccak256("ADMIN_ROLE");
   
   
    function initialize() initializer public {
        __ERC20_init("BILD", "USDBI");
        __AccessControl_init();
        __ERC20Permit_init("BILD");
         _mint(msg.sender, 84000000000 * 10 ** decimals());
