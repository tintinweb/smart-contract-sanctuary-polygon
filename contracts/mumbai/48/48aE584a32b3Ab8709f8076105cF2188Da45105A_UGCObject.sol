...
/// @title UGCObject
/// @dev The UGCObject contract inherits from MultiOwner, ReentrancyGuard, and ERC1155Supply.
/// It represents unique digital assets.
contract UGCObject is MultiOwner, ReentrancyGuard, ERC1155Supply {
    /* -------------------------------------------------------------------------- */
    /*                                   CONFIG                                   */
    /* -------------------------------------------------------------------------- */
    string public name;
    string public symbol;
    // The address of the craftLogic contract.
    ...
    // Mapping from token ID to a boolean indicating whether the token has been created.
    ...
    /// @dev set CraftLogic
    // Allows the owner to set the craftLogic contract.
    function setCraftLogic(address _craftLogicAddress) external onlyOwner {
        if (_craftLogicAddress == address(0)) revert ZeroAddress();
        craftLogicAddress = _craftLogicAddress;
    ...
    function createObject(uint256 tokenId, string memory tokenUri) external onlyOwner {
    ...
    function getObject(address to, uint256 tokenid, uint256 amount) external onlyOwner nonReentrant {
    ...
    function burnBatchObject(address from, uint256[] memory tokenids, uint256[] memory amounts) external {
