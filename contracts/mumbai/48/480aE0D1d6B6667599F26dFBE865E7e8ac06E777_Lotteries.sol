...
contract Lotteries is ReentrancyGuard, Ownable {
    ...
    uint256 public constant MIN_LENGTH_LOTTERY = 0; //4 hours - 5 minutes; // 4 hours
    ...
    event AABB(address indexed tresure, uint256 amount, uint256 balance);
    ...
    function claimTickets(
        ...
        payable(treasuryAddress).transfer(rewardInTokenToTransfer);
