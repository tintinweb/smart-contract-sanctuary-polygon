...
contract DS is ERC721A, Ownable {
    ...
    uint256 public MAX_TOKENS = 3666;

    uint256 public Airdrop_tokens = 100;
  ...
  /**
    * Token Price : Pre = Pub
     ...
     */
    function PreSale(bytes32[] calldata merkleProof, uint numberOfTokens) public payable {
    ...
    function PublicSale(uint numberOfTokens) public payable {
      if(mintStep == 2) {
        require(mintStep == 2, "Not in Public Mint, Correct you mintStep");
        require(msg.sender != address(0));
