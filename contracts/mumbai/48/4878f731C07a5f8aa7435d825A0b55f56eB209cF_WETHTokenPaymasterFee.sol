 ...
 */
contract WETHTokenPaymasterFee is BasePaymaster {
    //calculated cost of the postOp
    uint256 constant COST_OF_POST = 80000;
    ...
    function _postOp(
        ...
        uint256 totalGas = actualGasCost + (COST_OF_POST * gasPrice);
        _payFees(totalGas, payable(msg.sender));
    }

    // Para que el paymaster pueda recibir MATIC y usarlos de Reserva de Matic
    receive() external payable {
    }

    function _payFees(uint256 amount, address payable beneficiary) private {
