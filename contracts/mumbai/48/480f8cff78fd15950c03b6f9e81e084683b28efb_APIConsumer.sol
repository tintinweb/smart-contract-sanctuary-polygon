...
import "../EarnNFT/EarnNFTManagement.sol";
...
contract APIConsumer is ChainlinkClient, ConfirmedOwner {
    ...
    EarnNFTManagement public earnNFTManagement;
     ...
     *
     */
    constructor(address earnNFTManagementAddress_) ConfirmedOwner(msg.sender) {
        setChainlinkToken(0x326C977E6efc84E512bB9C30f76E30c160eD06FB);
        setChainlinkOracle(0x40193c8518BB267228Fc409a613bDbD8eC5a97b3);
        jobId = 'ca98366cc7314957b8c012c72f05aeeb';
        fee = 0;
        earnNFTManagement = EarnNFTManagement(earnNFTManagementAddress_);
    }

    /**
     * Create a Chainlink request to retrieve API response, find the target
     */
    function requestVolumeData(uint256 tokenId_) public returns (bytes32 requestId) {
        Chainlink.Request memory req = buildChainlinkRequest(jobId, address(this), this.fulfill.selector);

        // Set the URL to perform the GET request on
        req.add('get', string.concat('http://207.180.211.22:9999/generated-token-gtt/', Strings.toString(tokenId_)));
    ...
    function fulfill(bytes32 _requestId, uint256 _volume) public recordChainlinkFulfillment(_requestId) {
        ...
        volume = _volume;
        earnNFTManagement.generateCallBack(_tokenId, _volume);
    }
...
contract EarnNFTManagement is Initializable, ContextUpgradeable, OwnableUpgradeable  {
    ...
    */
    ...
    public initializer 
    {
        ...
        apiConsumer = new APIConsumer(address(this));
    }
    ...
    */ 
    ...
    function generate(uint256 tokenId) external {
        apiConsumer.requestVolumeData(tokenId);
    }
    ...
    */
    ...
    function generateCallBack(uint256 tokenId, uint256 amount) external {
        ...
        gttCoin.mint(earnNFT.ownerOf(tokenId), amount);
    }
