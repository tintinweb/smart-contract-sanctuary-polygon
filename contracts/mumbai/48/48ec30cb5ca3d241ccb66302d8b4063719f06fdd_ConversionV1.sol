...
contract ConversionV1 is Initializable, Ownable {
    ...
    function getToken(address _tokenAddress) public view returns(string memory , string memory, uint256) {
        bool is721 = IERC165Upgradeable(_tokenAddress).supportsInterface(0x80ac58cd);
        if(is721){
