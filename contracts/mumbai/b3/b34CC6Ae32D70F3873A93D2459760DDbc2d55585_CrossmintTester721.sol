...
contract CrossmintTester721 is ERC721, AccessControl {
    ...
    event NewCrossmintAddress(string oldAddress, string newAddress);
    ...
    function setPriceNative(uint256 _newPrice) external onlyRole(ADMIN_ROLE) {
    ...
    function setUsdcAddress(IERC20 _usdc) public onlyRole(ADMIN_ROLE) {
        usdc = _usdc;
    }
