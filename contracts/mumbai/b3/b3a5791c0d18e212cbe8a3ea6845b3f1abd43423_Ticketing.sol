...
contract Ticketing is ERC721URIStorage, EIP712, AccessControl{
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
  string private constant SIGNING_DOMAIN = "Ticketing";
  string private constant SIGNATURE_VERSION = "1";
 
  mapping (address => uint256) pendingWithdrawals;
 
  constructor(address payable minter)
    ERC721("Ticketing", "Ticketing") 
  ...
  function redeem(address redeemer, address owner, NFTVoucher calldata voucher) public payable returns (uint256) {
