...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0xC6941845C9DA0350C898735Cd9242ad87A693609];
...
// File: contracts/PasSbyZuhairXContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract PasSbyZuhairXContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "PASS by ZuhairX";
    string public symbol = "PASSZX";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/B9MzE7jpfSFcG8fqokrm/contract-metadata";
  }
