...
contract RareNFT is ERC721URIStorageUpgradeable, OwnableUpgradeable {
    ...
    function initialize(
        ...
        __Ownable_init();
        __ERC721_init("KakiRareNFT", "KKRNFT");
        baseURI = _baseURI;
    ...
    function mint() external {
        ...
        require(mintedCount < totalSupply, "Overflow count of Rare NFT");

        uint256 price = 5000 + 100 * mintedCount;
