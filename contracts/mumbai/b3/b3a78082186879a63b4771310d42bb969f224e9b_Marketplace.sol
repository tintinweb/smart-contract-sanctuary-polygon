...
contract Marketplace is ERC721Holder {
    ...
    function buy(address nftContract, uint256 itemId) external payable {
        ...
        // Calculate commission fee (1% of the price)
        uint256 commissionFee = price / 100;
        ...
        // Transfer commission fee to the marketplace owner
        marketplaceOwner.transfer(commissionFee);
