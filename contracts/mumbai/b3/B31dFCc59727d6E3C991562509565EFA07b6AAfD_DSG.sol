...
contract DSG {
    ...
    constructor(address _usdcAddr, address _defaultRefer, address[2] memory _feeReceivers) public {
    ...
    function _distributeDeposit(uint256 _amount) private {
        ...
        usdc.transfer(feeReceivers[0], fee.div(2));
        usdc.transfer(feeReceivers[1], fee.div(2));
