...
// Borrowed from: https://github.com/ethereum/EIPs/blob/master/assets/eip-5216/ERC1155ApprovalByAmount.sol but modified to override ERC1155Delta (no other changes were made)

/**
 * @title ERC-1155 Approval By Amount Extension
 * Note: the ERC-165 identifier for this interface is 0x1be07d74
 */
interface IERC1155ApprovalByAmount is IERC1155Delta {
 ...
 */
abstract contract ERC1155ApprovalByAmount is ERC1155Delta, IERC1155ApprovalByAmount {
    ...
    function safeBatchTransferFrom(
        ...
        uint256[] memory amounts,
        bytes memory data
    ) public virtual override(ERC1155Delta) {
        require(
...
contract OrigosMarketplace is Initializable, OwnableUpgradeable, UUPSUpgradeable, ReentrancyGuardUpgradeable, ERC2771Context(address(0x8239d7c443F3bAcF17946fc0Dd2295696138a4B6)), ERC1155Holder {
  ...
  function publish(address _nftAddress, uint256 _tokenId, uint256 _price) external {
    IERC1155ApprovalByAmount(_nftAddress).approve(address(this), _tokenId, 1);
