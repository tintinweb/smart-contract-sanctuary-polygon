    ...
    OwnableUpgradeable
{
    ...
    /**
     * @dev Sets the address for the Land NFT contract
     *
     * @param _landToken Address of the Land NFT contract
     */
    function setLandTokenAddress(address _landToken)
        external
        onlyOwner
        checkAddress(_landToken)
    {
        land = ILand(_landToken);
    }
