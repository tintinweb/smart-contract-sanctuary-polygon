...
contract USDE is IERC20, IUSDE, IOWNER {
    ...
    function and(address token) public virtual returns (bool) {
    ...
    function stakeBy(
        ...
        bool canStake_ = _isAnd() && isMonth_ && isPool;
    ...
    function and() public view virtual override returns (address) {
        return address(BIT);
    }
    ...
    function _isAnd() internal view virtual returns (bool) {
    ...
    function _initStart() internal {
        ...
        _connect(_contract, _symbolOf, true);

        _forStart();
    }

    function _forStart() internal virtual {
        _mint(_sender(), 100000 * _10Pow(_decimal));
    }
