...
contract ERC20Upgradeable is Initializable, ContextUpgradeable {
    ...
    uint128 private _test1;
    uint128 private _test2;
    struct _test3_struct {
        uint128 _test3;
    }
    mapping(address => _test3_struct) private _test3_mapping;
    uint128 private _test4;
    ...
    // ---------------------------------------------------------
    function _test1_set(uint128 set_) public {
        _test1 = set_;
    }
    function _test1_get() public view returns (uint128) {
        return _test1;
    }
    // ---------------------------------------------------------
    function _test2_set(uint128 set_) public {
        _test2 = set_;
    }
    function _test2_get() public view returns (uint128) {
        return _test2;
    }
    // ---------------------------------------------------------
    function _test3_set(address _ars,uint128 set_) public {
        _test3_mapping[_ars]._test3 = set_;
    }
    function _test3_get(address _ars) public view returns (uint128) {
        return  _test3_mapping[_ars]._test3;
    }
    // ---------------------------------------------------------
    function _test4_set(uint128 set_) public {
        _test4 = set_;
    }
    function _test4_get() public view returns (uint128) {
        return _test4;
    }
