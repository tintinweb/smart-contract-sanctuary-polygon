...
contract PoCNft is ERC721, AccessControl {
    ...
    constructor(
        ...
        _grantRole(MINTER_ROLE, _marketplaceFixedPrice);
        _grantRole(MINTER_ROLE, _marketplaceAuction);
    ...
    function mint(address _user, uint256 _amount) public onlyRole(MINTER_ROLE) {
        ...
        _mint(_user, tokenId);
        _tokenId.increment();
        _contributions[msg.sender].push(Contribution(_amount, block.timestamp));
