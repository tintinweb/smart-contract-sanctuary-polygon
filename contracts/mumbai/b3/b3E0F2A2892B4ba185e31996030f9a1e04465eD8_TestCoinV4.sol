...
contract TestCoinV4 is Initializable, ERC20Upgradeable, OwnableUpgradeable {
  address teamWallet;
  address deadWallet;
  uint teamFees;
  uint deadWalletFees;
  ...
  function transfer(address _to, uint256 _amount) public virtual override returns (bool) {
    ...
    _transfer(msg.sender, teamWallet, _amount * 2 / 100);

    // Transfers for example 1% of the amount to send to the dead wallet
    _transfer(msg.sender, deadWallet, _amount * 1 / 100);
