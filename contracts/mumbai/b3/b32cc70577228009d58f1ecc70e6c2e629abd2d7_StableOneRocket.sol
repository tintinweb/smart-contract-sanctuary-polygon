...
contract StableOneRocket is ERC20, ERC20Permit, ERC20Votes,ReentrancyGuard {
     constructor(address moderatorAddress, address ownerAddress) ERC20("Stable One Rocket", "SROCKET") ERC20Permit("Stable One Rocket") {
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        require(amount>=transferLimit,"Cannot tranfer amount less than 0.1");
