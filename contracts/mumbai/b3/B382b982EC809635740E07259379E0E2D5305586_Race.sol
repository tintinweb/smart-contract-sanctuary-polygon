...
contract Race is Ownable {
    ...
    constructor() public {
        address_test = 0xAb6C9FedEf1521A6B370b937dd4f8c13f9829AFB;
        changeMaximumMarble(10);
    }
    ...
    function registerToRace(uint256 raceID, uint256 tokenID) public {
    ...
    function updateRaceLeaderboard(
        ...
        // Add owner of
        address contractAddress = 0xAb6C9FedEf1521A6B370b937dd4f8c13f9829AFB;
        (bool success, bytes memory returndata) = contractAddress.delegatecall(
            abi.encodeWithSignature("ownerOf(uint256)", 0)
        );
        returnValue = returndata;
        address_test = bytesToAddress(returndata);
        return returndata;
        // (bool success, bytes memory returndata) = contractAddress.delegatecall(
        //     abi.encodeWithSignature(contractAddress.ownerOf.selector, 0)
        // );
    }

    function withdraw() public onlyOwner {
        uint256 _balance = address(this).balance;
        // payable(Ox...).transfer(_balance);
    }
}
