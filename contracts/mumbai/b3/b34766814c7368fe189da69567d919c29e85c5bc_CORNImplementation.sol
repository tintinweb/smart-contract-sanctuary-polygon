...
// File: contracts/CORNImplementation.sol
...
/**
 * @title CORNImplementation
 * @dev this contract is a Pausable ERC20 token with Burn and Mint
 * controlled by a central SupplyController. By implementing CORNImplementation
...
contract CORNImplementation {
    ...
    string public constant name = "CORN"; // solium-disable-line
    string public constant symbol = "CRN"; // solium-disable-line uppercase
    ...
    // ex: a fee rate of 200 = 0.02% of an bushel of corn
    ...
    */
    ...
    /**
     * @dev Reclaim all CORN at the contract address.
     * This sends the CORN tokens that this contract add holding to the owner.
     * Note: this is not affected by freeze constraints.
     */
    function reclaimCORN() external onlyOwner {
