...
contract newIMPACT is ERC20 {
    ...
    function transferIMPACT(address to, uint256 amount)
        ...
        returns (bool)
    {
        bool isTransferred = transfer(to, amount*10**18);
        return isTransferred;
    }
    function getImpact(uint amount) external {
        require(impactHold[msg.sender]+amount*10**18<=1000*10**18,"Cannot transfer more than 1000 tokens");
        impactHold[msg.sender]+=amount*10**18;
