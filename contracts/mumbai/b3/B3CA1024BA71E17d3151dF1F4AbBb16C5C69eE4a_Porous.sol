...
//      .........             .'``'.          ...'''''.                .```'.         ........      .....      .``.        
//     '^l$$x''`,1*}'     .!|~"'..'^i(_`     '`>$$j'''^<*|"        ^}{;`...`,](:.    .`"u$$1^`     .^>Bn,`   +[`..':!~~    
//        8$/     ;$$,  .1$1.         l$c`      $$\     `$$1     ,M8`         .xB-.     I$$`          }'    [email protected]       /~    
//        M$/     '$${ .&$j            ~$$"     $$\     .$$v    >$$"           .%$v     :$$`          _.    x$)'      '    
//        M$/     \$M' }$$:            .$$8     $$\     ]$x'   [email protected]$B             {$$:    :$$`          _.    .j$$#],.       
//        M$u"",;}-,   x$$^             $$$.    $$x^l\n)^.     `$$v             _$$_    :$$`          _.      'I(&$$M{^    
//        M$/          ]$$:            .$$8     $$\  ^M$f'     [email protected]$B             }$$:    ;$$`          -.          .,\$$-   
//        M$/          .W$j            >$$"     $$\    [[email protected]     l$$"           .8$u     ,$$^          |.   .*        'B$   
//        8$j           .{${.         ;$c`      $$\     "W$n`    ,#&`         .jB-.     .*$|         ,<    .$1        &t   
//     '`i$$B:`'          .!|+"'...`!|?`     '`~$$8,`'    ~B$u!^.  ^{{;`...'"]/I.         Ir*+"```,li`     .W`!,`..';j>    
//      .......               .'```.         .........      ....       '```'.                .'``'.             .``'.      
//
//                                  
//      poro.us                         
...
contract Porous is ERC721, ERC721Enumerable, ERC721Burnable, Ownable, ContextMixin, NativeMetaTransaction {
    ...
    constructor() ERC721(title, "POROUS") {
        _initializeEIP712(title);
    }
