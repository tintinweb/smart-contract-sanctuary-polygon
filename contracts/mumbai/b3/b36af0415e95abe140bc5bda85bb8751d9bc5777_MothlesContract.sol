...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        string private IPFSTokenURI = "ipfs://QmVTo6mqjPVjrYkuU4z17pLoPCEnPvHFK4GbVHn1ZSFYCw/";
    ...
    // File: contracts/mothlesContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract MothlesContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Mothles", "MOTH", _proxyRegistryAddress)
        {}

        

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/9ejNKS8bQIBwWKWNSNyO/contract-metadata";
        }
    }