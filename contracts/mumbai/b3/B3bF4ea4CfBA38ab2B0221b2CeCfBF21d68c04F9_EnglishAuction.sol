...
contract EnglishAuction is AccessControl {
    event AddAuction(uint256 auctionId, address collection, uint256 tokenId, uint256 duration, uint256 startingBid);
    ...
    function setupAuction(
        ...
        emit AddAuction(_auctionId, _nftAddress, _tokenId, _duration, _startingBid);
    }
