...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x20600b55Cb7A44807ca32498437A2412bc6B6048];
  address public erc20Payable = 0x20600b55Cb7A44807ca32498437A2412bc6B6048;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmQZbwzFLGZQDApzJR7XZ6UtQXxkzdsar1f6fSqAPLsZaQ/";
...
// File: contracts/MonkeyContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MonkeyContract is RamppERC721A {
    constructor() RamppERC721A("Monkey", "MON"){}
}
