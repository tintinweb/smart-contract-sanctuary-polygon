...
contract ERC721MetadataMintable is ERC721 {
...
contract FisherYatesRangeValueGeneratorInitializableERC721Revealer is
    FisherYatesRangeValueGeneratorInitializable
{
    error MaxLimitRevealExceeded();
    error OnlyApprovalOrOwnerAccess();
    uint256 public constant MAX_PER_TRANSACTION = 42;
    address public constant DEAD_ADDRESS =
        0x000000000000000000000000000000000000dEaD;

    IERC721 public immutable collectionToReveal;
    ERC721MetadataMintable public immutable collection;
    ...
    constructor(
        ...
        collection = new ERC721MetadataMintable(
            name_,
            symbol_,
            address(this),
            baseTokenURI_
