...
contract GutterArt is ERC1155Burnable, Ownable, ReentrancyGuard {
	...
	string private _baseTokenURI = "ipfs://xxx/"; //must end with /
	...
	//mint 1 NFT with quantity x to the receiver
	function mint(
		address receiver,
		uint256 nftID,
		uint256 quantity,
	...
	//requires allowance: await erc20.increaseAllowance(gutterart.address, "999999999999999999999999999999")
	function airdropERC20Token(
		address[] memory receivers,
	...
	function customAction(
		...
		require(balanceOf(msg.sender, nftID) > 0, "NFT ownership required");
