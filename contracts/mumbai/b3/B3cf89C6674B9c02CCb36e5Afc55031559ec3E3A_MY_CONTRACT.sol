...
contract MY_CONTRACT is ERC721Enumerable, Ownable, RoyaltiesV2Impl {
    using Strings for uint256;
    ...
    // set token URI for single token
    ...
    // mint single token with provided token URI and return new token ID
    function mintSingleTokenWithURI(
        address recipient,
        string memory uri
    ...
    // function allows you to mint several NFT tokens
