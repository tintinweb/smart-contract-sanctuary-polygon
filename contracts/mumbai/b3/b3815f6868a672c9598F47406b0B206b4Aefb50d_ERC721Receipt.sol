...
/// @title Receipt Contract for ERC1155
/// @notice This contract is used to mint or burn receipt for corresponding token
contract ERC721Receipt is ERC721, AccessProtected, ITokenReceiptable {
    using Address for address;

    address internal _originalToken;

    string internal uri;

    /// @dev constructor for token receipt
    /// @param name_ The name of the token
    /// @param symbol_ The symbol of the token
    /// @param originalToken_ The address of the original token
    constructor(
        string memory name_,
        ...
        require(
            originalToken_.isContract(),
            "originalToken should be a contract"
        );

        _originalToken = originalToken_;
    }

    /// @dev Assign URI to the token
    ...
    /// @dev force any transfer calls whose are onlyAdmin
    ...
    /// @dev override function for TokenReceiptable
    ...
    /// @dev override function for TokenReceiptable
    /// @param receiptTo Burn receipt for this address
