...
import "./LockBox.sol";
import "./interfaces/IDaoMain.sol";
 ...
 * @notice This is the DAO main, that offers stake func.
...
contract DaoMain is LockBox, IDaoMain {
    ...
    /**
     * @notice Event fires when unstake of 0 gov Tokens is attempted.
     * @param owner is the owner of the distTokens.
     * @param govToken is the distToken contract address.
     */
    event UnstakedZero(address indexed owner, address govToken);
    ...
    function returnAllStakedTokensAsAdmin(
        ...
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        // TODO: Should ADMIN approve the unstake on behalf of user?
        uint256 sdtBalance = IERC20(inStakedTokenAdd).balanceOf(owner);
        unstakeTokens(owner, sdtBalance);
    }
...
import "./tokens/ILPToken.sol"; // Staked DAO Tokens are LPToken
...
interface ILPToken is IDistToken {
}
