...
// File: IERC721PermitUpgradeable.sol
...
// File: ERC721PermitUpgradeable.sol
...
contract PlanetPersibLandNFT is
    Initializable,
    ERC721Upgradeable,
    ...
    UUPSUpgradeable
{
    ...
    function initialize() public initializer {
        __ERC721_init("Planet Persib - Land NFT", "PPLNFT");
        __ERC721Enumerable_init();
        __ERC721URIStorage_init();
        __Pausable_init();
        __Ownable_init();
        __ERC721PermitUpgradeable_init("Planet Persib - Land NFT", "1");
    ...
    function _afterTokenTransfer(
        ...
        ERC721PermitUpgradeable._updateNonce(from);
