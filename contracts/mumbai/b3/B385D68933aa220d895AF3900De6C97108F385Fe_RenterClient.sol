...
contract RenterClient is Context, IRentingContract, TokensManager, Ownable {
...
//    uint private constant RENTING_RENEWAL_PERIOD_GAP = 1 minutes;
    ...
    constructor(address storageContractAddress, address landsContractAddress, address botsContractAddress,
        address xoilAddress, address rblsAddress, address wethAddress) TokensManager(landsContractAddress, botsContractAddress) {
