...
//*********************************************************************//
//
//    ______           _____    __  ___      ____  _       ____                 
//   / ____/___ _____ |__  /   /  |/  /_  __/ / /_(_)     / __ \____ ___________
//  / /   / __ `/ __ \ /_ <   / /|_/ / / / / / __/ /_____/ /_/ / __ `/ ___/ ___/
// / /___/ /_/ / /_/ /__/ /  / /  / / /_/ / / /_/ /_____/ ____/ /_/ (__  |__  ) 
// \____/\__,_/ .___/____/  /_/  /_/\__,_/_/\__/_/     /_/    \__,_/____/____/  
//           /_/                                                                
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [0x168FE4EBf3ba698d60b5B5f9189Fc2d3beCE2217];
...
// File: contracts/Cap3MultiPassContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract Cap3MultiPassContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Cap3 MultiPass";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/l8z1EXd8URsLro4Q7ahM/contract-metadata";
  }
