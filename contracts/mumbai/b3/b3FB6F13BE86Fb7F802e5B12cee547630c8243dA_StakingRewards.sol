...
contract StakingRewards {
    ...
    function earned(address account) public view returns (uint) {
        ...
        if (_enableLock == false){
            ...
            uint256 reward = _balances[account] + (2 * 1e17 * _balances[account] *  (block.timestamp - lastUpdateTime)) / 365 days; 
            return reward;
        }
    }
    ...
    modifier updateReward(address account) {
        ...
        emit RewardUpdated(account, rewards[account], lastUpdateTime);
        _;
    }
