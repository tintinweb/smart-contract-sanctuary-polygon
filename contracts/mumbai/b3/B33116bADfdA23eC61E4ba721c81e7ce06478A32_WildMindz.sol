...
contract WildMindz is ERC721, Ownable {
    ...
    string private constant metadataFileExtension = ".json";

    constructor() ERC721("Wild Mindz", "WMZ") {
        currentBaseTokenURI = "https://s3.amazonaws.com/nft.jbltx.com/wild-mindz/metadata/";
    }
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(baseURI).length > 0 ? string(abi.encodePacked(baseURI, tokenId.toString(), metadataFileExtension)) : "";
    }
