...
abstract contract Card is Initializable, AccessControlUpgradeable, ERC721EnumerableUpgradeable, ERC721BurnableUpgradeable, PausableUpgradeable, UUPSUpgradeable {
    ...
    // function setTokenType(uint256 tokenId, uint16 tokType) public whenNotPaused onlyRole(DEFAULT_ADMIN_ROLE) {
    //     require(tokType > 0, "Error");
    //     _tokenIdToType[tokenId] = tokType;
    // }
    ...
    function burnMultipleTokens(uint256[] calldata tokenIds) public virtual {
