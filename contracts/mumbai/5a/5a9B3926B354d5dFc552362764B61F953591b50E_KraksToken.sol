...
contract KraksToken is ERC20, ERC20Capped, Ownable, ReentrancyGuard {
  ...
  constructor()
  ERC20("Krak$ Token Test", "KRKS")
  ERC20Capped(5000000000 ether) {}

  function mint(address to) public {
    require(balanceOf(to) <= 500000000000000000000, "Cannot claim kraks if you have more than 500 in your account.");
    _mint(to, 500000000000000000000);
  }
