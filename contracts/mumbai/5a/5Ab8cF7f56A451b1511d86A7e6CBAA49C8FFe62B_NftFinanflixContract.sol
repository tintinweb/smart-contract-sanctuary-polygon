...
// | \ | |/ _| |   |  ___(_)                  / _| (_)     
// |  \| | |_| |_  | |_   _ _ __   __ _ _ __ | |_| |___  __
// | . ` |  _| __| |  _| | | '_ \ / _` | '_ \|  _| | \ \/ /
// | |\  | | | |_  | |   | | | | | (_| | | | | | | | |>  < 
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x343c318fd8510EC9E0B2C359534A6f2fa5B72754];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmXjCp9b5GruWWqBE58m1vC4iPvEjTgo3vgUxH6tb6G6Bq/";
...
// File: contracts/NftFinanflixContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NftFinanflixContract is RamppERC721A {
    constructor() RamppERC721A("Nft Finanflix ", "FFF"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/MLIQPF756adEyAfc8N5s/contract-metadata";
    }
}
