...
contract AmateurBlockchainDevelopersToken is ERC20, ERC20Burnable, Pausable, AccessControl, ERC20Permit,Ownable {
    ...
    constructor() ERC20("Amateur Blockchain Developers Token", "MNK") ERC20Permit("Amateur Blockchain Developers Token") {
