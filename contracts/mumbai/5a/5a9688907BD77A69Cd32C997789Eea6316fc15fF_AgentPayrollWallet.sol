...
contract AgentPayrollWallet is AccessControl,  IAgentPayrollWallet {
    address ezr;
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    constructor (address _ezr) {
        ezr = _ezr;
    }

    // Mint 0.05 free EZR
    function claimFreeEZR() external override onlyRole(MINTER_ROLE) {
        IEZR(ezr).mint(msg.sender, 5 * 10**16);
    }
}
