...
contract Staking is IERC721Receiver, Context {
    ...
    *@dev emitted when '_user' unstakes '_tokenId' token.
    ...
    // Address of the owner of this contract. It is the whiteListedContract address
    ...
    *@dev lastClaim is in epoch time.
    ...
    struct StakingInfo {
        ...
        uint multiplier; // Modifies ERC20 token generations peed
     ...
     */
    constructor(address _whiteListedContract) {
     ...
     * Emits a {Stake} event
     */
    function _stakeNft(uint _tokenId, address _from) internal {
    ...
    function _toClaim(address _user) internal view returns(uint){
        ...
        uint toClaim = (block.timestamp - SI.lastClaim) * SI.multiplier;
        return toClaim;
    }
    ...
    *@notice Returns the amount of ERC20 tokens generated that a user can claim
    ...
    /**
    *@notice Returns the whiteListed address that is owner of contract. Only this address can call setERC20 to set the ERC20 contract address to use.
     */
    function showWhiteListedContract() external view returns(address){
        return whiteListedContract;
    }

    /**
    *@notice Returns the address of '$AMMO' ERC20 token contract.
     */
    function showAmmoAddress() external view returns (address) {
        return address(ammo);
    }
}
...
contract AMMO is ERC20("AMMO", "$AMMO"){
    ...
    function logStakingAddress() external view returns (address) {
