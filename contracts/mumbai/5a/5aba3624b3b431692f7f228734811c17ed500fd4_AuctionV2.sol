...
contract AuctionV2 is Initializable {
    ...
    AuctionStructure.feeSystem public feeSystem;
    ...
    function setFeeSystem(uint128 _stanFee, uint128 _serviceFee)
        ...
        onlyOwner
    {
        AuctionStructure.feeSystem memory FeeSystem = AuctionStructure
            .feeSystem(_stanFee, _serviceFee);
        feeSystem = FeeSystem;
    }
    ...
    function cancelListingAuction(
        ...
        (uint256 tokenId, AuctionStructure.Currency currency) = auctionPure
            .cancelListingAuction(_listingId, whiteList[msg.sender], feeSystem);
    ...
    function acceptOfferAuction(
        ...
        (
            uint256 tokenId,
            AuctionStructure.Currency currencyListing
        ) = auctionPure.acceptOfferAuction(_auctionId, _subOfferId, _nftId);
    ...
    function transferNFTPvP(
        ...
        AuctionStructure.Currency currency = auctionFixedPrice.transferNFTPvP(
            _receiver,
            _tokenId,
            maker,
            whiteList[msg.sender],
    ...
    function deposit(
        ...
        stanFund.deposit(_amount, stanWalletAddress, msg.sender);
    ...
    function withdraw(
        ...
        stanFund.withdraw(_amount, stanWalletAddress, msg.sender);
    ...
    function finishAuction(
        ...
        (
            AuctionStructure.Currency currencyListing,
            uint256 tokenId
        ) = auctionPure.finishAuction(_auctionId, _nftId, feeSystem);
...
interface IAuctionFixedPrice {
    ...
    ) external returns (AuctionStructure.Currency);
}
...
interface IAuctionPure {
    ...
    function finishAuction(
        ...
        bytes memory _nftId,
        AuctionStructure.feeSystem calldata feeSystem
    ) external returns (AuctionStructure.Currency, uint256);
}
