...
contract NFT is ERC721EnumerableUpgradeable, OwnableUpgradeable {
    ...
    function doMint(address _to) internal returns (uint256)
    {
    ...
    function multiMint(address _to, uint256[] memory _nftIds) external checkAdmin
    {
