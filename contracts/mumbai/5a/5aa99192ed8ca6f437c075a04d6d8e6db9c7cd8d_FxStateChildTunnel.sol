...
contract FxStateChildTunnel is FxBaseChildTunnel {
    ...
    string public Record_name;
    bytes public Record_byte;
    ...
    function winnerNameRecord() public {
        Record_name = winnerName();
        Record_byte = bytes(Record_name);
        _sendMessageToRoot(Record_byte);
    }
}