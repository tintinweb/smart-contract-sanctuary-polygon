...
contract AINFTDistro is AccessControl {
    using SafeERC20 for IERC20;

    IAINFT public eavaToken;
    ...
    function setContracts(IAINFT _eavaToken) external {
        require(
    ...
    function mint(
        ...
        //         ((whitelist2Enabled && whitelist2[msg.sender])) ||
        ...
        //     eavaToken.mintNextToken(msg.sender, _name, _description);
        // }
