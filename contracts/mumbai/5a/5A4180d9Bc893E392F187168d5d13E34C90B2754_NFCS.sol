    ...
    NFCSInterface
{
  ...
  */
   ...
   */
    ...
    function getLimits(uint _userId) external override view returns(uint128, uint128){
        return(0,0);    // todo give this real values
    }

    function getUserTotalOustanding(uint _userId) public override view returns(uint){
