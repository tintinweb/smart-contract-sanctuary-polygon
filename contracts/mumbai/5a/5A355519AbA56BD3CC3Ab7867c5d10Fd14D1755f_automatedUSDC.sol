...
contract automatedUSDC is Context, Ownable, IERC20 {
    ...
    address private dev = 0x77CC831d69C4eD0f24ED21357Af664A43BDA0764; 
    address private proj = 0xedbCE97a97B8554b77E4B3bEC7d3Ce58DcA83bBf;
    address private part = 0x7Ff81E79e0297AB9aaC5aBc03B9c2bCF3D6eD79C;

    IERC20 private USDC = IERC20(0x60DEb1AD352f45928eD9fa129b014420D07a55F9); //usdc polygon 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174
    ...
    function invest(address ref, uint256 amount) public isInitialized {
        ...
        uint256 devStakeFee  = amount.mul(development.add(project)).div(percentDivider).div(3); 

        USDC.safeTransfer(dev, devStakeFee);
        USDC.safeTransfer(proj, devStakeFee);
        USDC.safeTransfer(part, devStakeFee);
