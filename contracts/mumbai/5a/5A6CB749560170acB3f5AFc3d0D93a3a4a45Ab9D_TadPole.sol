...
contract TadPole is ERC1155, Ownable, ContextMixin, NativeMetaTransaction {
   ...
   */
    ...
    */
    ...
    function create(
        ...
        require(_validate(msg.sender, _timestamp, v, r, s), "TadPoleERC1155#create: signature not valid" );        
        uint256 _id = _getNextTokenID();
        _incrementTokenTypeId();
        creators[_id] = msg.sender;
