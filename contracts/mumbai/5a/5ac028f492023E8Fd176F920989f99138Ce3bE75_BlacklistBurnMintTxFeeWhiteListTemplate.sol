...
// File contracts/templates/BlacklistBurnMintTxFeeWhiteListTemplate.sol
...
contract BlacklistBurnMintTxFeeWhiteListTemplate is 
    ERC20Base, 
    BlacklistFeature, 
    ERC20BurnFeature, 
    ERC20MintFeature, 
    ...
    PausableWithWhitelistFeature
{
    ...
    function _beforeTokenTransfer_hook(
        ...
        address to,
        uint256 amount
    )  internal virtual override(BlacklistFeature, PausableWithWhitelistFeature, TxFeeFeature) {
