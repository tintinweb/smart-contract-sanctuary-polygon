...
contract MaticMaker is Context, Ownable {
    ...
    function buyEggs(address ref) public payable {
        require(initialized,"Cannot invest at the moment");
    ...
    function seedMarket(bool _newValue) public onlyOwner{
        require(marketEggs == 0);
        require(_newValue!=initialized,"New value cannot be same with previous value");
        initialized = _newValue;
        //initialized = true;
