    ...
    AccessControlUpgradeable
{
    ...
    function buy(uint256 _amount) public {
        ...
        usdc.safeTransferFrom(_msgSender(), address(this), requiredUsdc);
        paza.safeTransfer(
            _msgSender(),
    ...
    function sell(uint256 _amount) public {
        require(
            paza.balanceOf(_msgSender()) >= (_amount * 10 ** paza.decimals()) / PCT_BASE,
            "Insufficient balance"
        );
        paza.safeTransferFrom(_msgSender(), address(this), (_amount * 10 ** paza.decimals()) / PCT_BASE);
        usdc.safeTransfer(_msgSender(), (_amount * 10 ** 4) / PCT_BASE);
        emit Pazasell(_msgSender(), (_amount * 10 ** paza.decimals()) / PCT_BASE);
    }
     ...
     * @param _amount of paza token with decimals
     **/
    ...
    function buyWithApproval(
        ...
        require((_amount / 10 ** 14) > 0, "can't transfer 0 USDC");
