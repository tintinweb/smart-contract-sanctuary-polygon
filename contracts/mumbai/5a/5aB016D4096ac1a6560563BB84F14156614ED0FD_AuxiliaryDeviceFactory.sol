  ...
  // MANAGING Authorization Contract Address for Call 
   ...
   // 合约部署者增加操作员
        ...
        returns(uint[] memory)
    {
        ...
        uint new_rand;
        bytes32 hash_prop_name = keccak256(abi.encodePacked("attack"));
        if (settings[_type_id][hash_prop_name].section > 0) {
            new_rand = (randomResult.sub(randomResult%10)).div(10);
            props["attack"] = settings[_type_id][hash_prop_name].base + new_rand % settings[_type_id][hash_prop_name].section;
        }
        ...
        // }
        hash_prop_name = keccak256(abi.encodePacked("defense"));
        props["defense"] = settings[_type_id][hash_prop_name].base;
        ...
        // }
        hash_prop_name = keccak256(abi.encodePacked("hp"));
        props["hp"]      = settings[_type_id][hash_prop_name].base;
        ...
        // }
        hash_prop_name = keccak256(abi.encodePacked("duration"));
        props["duration"]= settings[_type_id][hash_prop_name].base;
    ...
    //     }
        ...
        hash_prop_name = keccak256(abi.encodePacked("move"));
        move = settings[_type_id][hash_prop_name].base +1; //new_rand % settings[_type_id]["move"].section; 
        hash_prop_name = keccak256(abi.encodePacked("potential"));
        potential = settings[_type_id][hash_prop_name].base +1; //new_rand % settings[_type_id]["potential"].section;
        ...
        returns(uint[] memory)
    {
        ...
        if (settings[_type_id][hash_prop_name].section > 0 ) {
             new_rand = (randomResult.sub(randomResult%100)).div(100);
             props["defense"] = settings[_type_id][hash_prop_name].base + new_rand % settings[_type_id][hash_prop_name].section;
        }
        ...
        if (settings[_type_id]["hp"].section > 0) {
            new_rand = (randomResult.sub(randomResult%1000)).div(1000);
            props["hp"]      = settings[_type_id][hash_prop_name].base + new_rand % settings[_type_id][hash_prop_name].section;
        }

        hash_prop_name = keccak256(abi.encodePacked("duration"));
        if (settings[_type_id][hash_prop_name].section > 0) {
            new_rand = (randomResult.sub(randomResult%10000)).div(10000);
            props["duration"]= settings[_type_id][hash_prop_name].base + new_rand % settings[_type_id][hash_prop_name].section;
        }
        ...
        if (settings[_type_id][hash_prop_name].section > 0) {
            new_rand = (randomResult.sub(randomResult%100000)).div(100000);
            move = settings[_type_id][hash_prop_name].base +new_rand % settings[_type_id][hash_prop_name].section; 
        }

        hash_prop_name = keccak256(abi.encodePacked("potential"));
           if (settings[_type_id][hash_prop_name].section > 0) {
            new_rand = (randomResult.sub(randomResult%1000000)).div(1000000);
            potential = settings[_type_id][hash_prop_name].base +new_rand % settings[_type_id][hash_prop_name].section;
        }
    ...
    {
         bytes32 hash_prop_name = keccak256(abi.encodePacked(prop_name));
        return settings[_type_id][hash_prop_name];
    }    
