...
contract Nectarverse is ERC1155, AccessControl, Pausable, ERC1155Burnable, ERC1155Supply, ERC1155URIStorage {
    ...
    function setOwner(address _newOwner) external onlyRole(DEFAULT_ADMIN_ROLE) {
        require(hasRole(DEFAULT_ADMIN_ROLE, _newOwner), "New owner needs DEFAULT_ADMIN_ROLE.");
        _owner = _newOwner;
    }
