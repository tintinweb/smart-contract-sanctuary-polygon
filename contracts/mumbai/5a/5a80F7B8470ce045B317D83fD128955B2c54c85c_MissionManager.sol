    ...
    AccessControlUpgradeable
{
    ...
    function initialize(address _rentalPoolAddress) external initializer {
    ...
    {
        string[] memory tenantReadyMissionsUuid = tenantReadyMissionUuid[
            _tenant
        ];
        NFTRental.Mission[]
            memory tenantReadyMissions = new NFTRental.Mission[](
