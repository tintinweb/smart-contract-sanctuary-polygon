...
contract NFTMarketplace is ERC721Holder {
    ...
    uint256 public feePercent; // percentage fee charged on sales
    ...
    function createSale(
        ...
        require(
            ...
            "This NFT is already for sale"
        );
        require(_price > 0, "Price must be greater than zero");

        sales[_tokenId] = Sale(buyer, msg.sender, _price, _tokenId, true);
        emit SaleCreated(msg.sender, _tokenId, _price);
    }

    function cancelSale(uint256 _tokenId) public {
        require(
            msg.sender == sales[_tokenId].seller,
            "You are not the seller of this NFT"
        );
        require(
            sales[_tokenId].active == true,
    ...
    function addToSales(
        ...
        sales[id] = Sale(buyer, seller, price, id, true);
    }
}