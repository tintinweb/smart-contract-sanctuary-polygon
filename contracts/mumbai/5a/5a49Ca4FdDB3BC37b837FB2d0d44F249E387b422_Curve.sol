...
contract Curve is VRFConsumerBase {
    ...
    event Lottery(uint256 indexed tokenId, uint256 indexed lotteryId, bool isWinner, uint256 indexed prizeAmount);
    ...
    */
    constructor (address payable _creator, address payable _charity, address _coordinator, address _link, bytes32 _keyHash)              
        VRFConsumerBase(
    ...
    */
    ...
    function getCurrentPriceToBurn() public virtual view returns (uint256) {
        ...
        burnPrice -= (burnPrice.mul(CREATOR_PERCENT.add(CHARITY_PERCENT))).div(DENOMINATOR);
        return burnPrice;
    }
}
...
contract ERC721 is ERC165, IERC721, IERC721Metadata, IERC721Enumerable, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) public {
        ...
        palette.push("#fac901"); //yellow: 1/5 chance
    ...
    function generateSVGFromHash(bytes32 _hash) public virtual view returns (string memory) {
        ...
        */
        string memory svg = string(abi.encodePacked(
            ...
            string(abi.encodePacked("<rect x='100' y='0' width='100' height='100' style='fill:",palette[toUint8(bhash,2)/51],";stroke-width:3;stroke:black'/>")), // tile 3
            string(abi.encodePacked("<rect x='100' y='100' width='100' height='100' style='fill:",palette[toUint8(bhash,3)/51],";stroke-width:3;stroke:black'/>")), // tile 4
            string(abi.encodePacked("<rect x='200' y='0' width='100' height='100' style='fill:",palette[toUint8(bhash,4)/51],";stroke-width:3;stroke:black'/>")), // tile 5
            string(abi.encodePacked("<rect x='200' y='100' width='100' height='100' style='fill:",palette[toUint8(bhash,5)/51],";stroke-width:3;stroke:black'/>")), // tile 6
            "</svg>"
        ));
