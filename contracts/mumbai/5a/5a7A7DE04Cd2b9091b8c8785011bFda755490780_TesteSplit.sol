...
contract TesteSplit is DefaultOperatorFilterer, ERC721A, Ownable {
  using Address for address;
  using Strings for uint256;
  ...
  uint256 private _royaltyArtist = 10;  
  uint256 private _royaltyCreator = 75;  
  ...
  address private wArtist = 0x336B6fcFb5563c53D7F99D807087f80Efb7E3C46;
  address private wCreator = 0x9fD17B94d6AF41FBAd13cd04fF1309433A63249e;
  uint256 royaltiesSpender;

  uint256 private _royaltyFundMarket = 1;  
  uint256 private _royaltyArtistSecondMarket = 2;
  ...
  uint256 private _nftEtherValue = 0.02 ether;
  uint256 private _nftEtherValueWaitList = 0.02 ether;  

  mapping(uint256 => string) private cids;

  uint256 private initSaleWaitList = 1685557956;
  uint256 private endSaleWaitList = 1685557956;
  uint256 private startSalePublic = 1685557956;

  event _transferSend(address _from, address _to, uint _amount);

  constructor(    
    bytes32 _root    
  ) ERC721A("TesteSplit", "split") {    
    root = _root;
    _contractUri = "";
