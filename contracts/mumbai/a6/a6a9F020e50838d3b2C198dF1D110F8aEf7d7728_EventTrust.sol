...
contract EventTrust is Context, IERC20, IERC20Metadata, IERC20Errors {
    ...
    constructor() {
        ...
        _mint(owner, halfSupply); // Mint half of the total supply to the owner
        _mint(address(this), halfSupply); // Mint the other half to the contract itself
    }
    ...
    */
    ...
    function calculateReward(uint256 eventId, address user) public view returns (uint256) {
        ...
        uint256 reward = (4 * normalizedLikes + 4 * normalizedRating + 2 * normalizedFeedback) * reputation / (10**20);
    ...
    */
    function claimAirdrop() public {
        ...
        uint256 amountToTransfer = 1000 * 10**18; // Transfer 10 tokens
    ...
    */
    function claimVestedTokens() public {
        ...
        require(block.timestamp > _airdropClaimTimestamps[msg.sender] + 7 days, "Must wait for monthly vesting");
