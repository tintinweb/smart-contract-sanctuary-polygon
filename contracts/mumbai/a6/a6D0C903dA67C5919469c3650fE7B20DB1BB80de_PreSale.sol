...
contract PreSale is Ownable {
    ...
    constructor() {
        ...
        BuyRequests[specialAddress] = buyRequests(specialAddress, 0, address(0), 0);
    ...
    function buyTokenUSDT(uint256 quantity, address _refferalAddress) external {
        ...
        BuyRequests[msg.sender] = buyRequests(specialAddress, quantity, _refferalAddress, payment);
        ...
        SOLIDA.transfer(msg.sender, quantity * 10**9);
    ...
    function buyTokenETH(address _refferalAddress) external payable {
        ...
        _totalETHInvestment += msg.value;
            ...
            BuyRequests[msg.sender] = buyRequests(specialAddress, solidaAmt, _refferalAddress, usdAmount);
