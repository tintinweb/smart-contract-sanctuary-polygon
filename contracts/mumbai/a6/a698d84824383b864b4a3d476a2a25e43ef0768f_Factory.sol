...
contract Factory  {
     ...
     */
    function createNFT(string memory name, string memory symbol, uint8 decimals, uint256 cap, address owner) external returns (address) {
     ...
     * @dev Create FT Token
     */
    function createFT(string memory name, string memory symbol, uint256 startTokenId, address owner) external returns (address) {
