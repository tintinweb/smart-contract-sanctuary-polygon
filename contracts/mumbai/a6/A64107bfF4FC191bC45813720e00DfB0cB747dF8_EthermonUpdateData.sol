...
contract EthermonUpdateData is EthermonEnum, BasicAccessControl {
    ...
    */
        ...
        isActive
    {
        ...
        EtheremonTradeData tradeData = EtheremonTradeData(tradeDataContract);
        if (
            tradeData.isOnTrade(obj.monsterId) ||
            tradeData.isOnTrade(obj1.monsterId)
        ) revert();
    ...
    */
    function reRollMonsterStatsEMON(uint32 _tokenId) external isActive {
        ...
        EtheremonTradeData tradeData = EtheremonTradeData(tradeDataContract);
        if (tradeData.isOnTrade(obj.monsterId)) revert();
