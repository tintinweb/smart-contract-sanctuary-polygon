...
contract Web3NFTContract is ERC1155, Ownable, Pausable, ERC1155Supply {
    ...
    uint256 ReservedMintPrice = 0.05 ether;
    ...
    function publicMint(uint256 id, uint256 amount)
        ...
        payable
    {
        require(msg.value >= publicMintPrice, "Not enough ETH sent; check price!");
    ...
    {
        require(msg.value >= ReservedMintPrice, "Not enough ETH sent; check price!");
