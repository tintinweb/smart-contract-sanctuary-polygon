...
contract Ownable is Context {
    ...
    mapping(address => bool) public addressConfirmation;
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        ...
        addressConfirmation[newOwner] = true;
        // _owner = newOwner;
    }

    function confirmOwnership() public {
        require(addressConfirmation[msg.sender], "Address not confirmed for ownership.");
        _owner = msg.sender;
        addressConfirmation[msg.sender] = false;
    }
...
contract DLICOM is Context, IERC20, Ownable {  
    ...
    IPancakeRouter02 public immutable uniswapRouter;
    address public immutable uinswapPair;
    bool inSwapAndLiquify;
    bool private paused = false;
    bool public constant swapAndLiquifyEnabled = true;
    ...
    function _transfer(
        ...
        if(from == uinswapPair && to!=address(this)) {
            require(amount <= _maxBuycap, "BEP20: Buy Qty Exceed !");
            require(amount >= _minBuycap, "BEP20: Buy Qty Does Not Match !"); 
            require(checkSellEligibility(from), "BEP20: Try After Buy Time Interval !"); 
        }
        if(to == uinswapPair && from!=address(this)) {
            require(amount <= _maxSellcap, "BEP20: Sell Qty Exceed !");
            require(amount >= _minSellcap, "BEP20: Sell Qty Does Not Match !"); 
