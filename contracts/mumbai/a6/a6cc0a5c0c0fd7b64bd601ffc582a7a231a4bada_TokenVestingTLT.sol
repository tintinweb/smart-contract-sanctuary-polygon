...
contract TokenVestingTLT is IERC20, Context, ReentrancyGuard {
    ...
    modifier onlyIfBeneficiaryExists(address beneficiary) {
        require(
            ...
            "TokenVestingTLT: INVALID Beneficiary Address! no vesting schedule exists for that beneficiary"
        );
        _;
    }
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(
            owner != address(0),
            "TokenVestingTLT: approve from the zero address"
        );
        require(
            spender != address(0),
            "TokenVestingTLT: approve to the zero address"
        );
    ...
    function transferFrom(
        ...
        require(
            ...
            "TokenVestingTLT: insufficient allowance"
        );
    ...
    function _transfer(address from, address to, uint256 amount) private {
        require(
            from != address(0),
            "TokenVestingTLT: transfer from the zero address"
        );
        require(
            to != address(0),
            "TokenVestingTLT: transfer to the zero address"
        );
        require(
            _balances[from] >= amount,
            "TokenVestingTLT: transfer amount exceeds balance"
        );
    ...
    function getVestingIdAtIndex(
        ...
        require(
            ...
            "TokenVestingTLT: index out of bounds"
        );
        ...
        returns (VestingSchedule memory)
    {
        require(
            ...
            "TokenVestingTLT: INVALID Vesting Schedule Index! no vesting schedule exists at this index for that beneficiary"
        );
    ...
    function getVestingSchedule(
        ...
        require(
            ...
            "TokenVestingTLT: INVALID Vesting Schedule ID! no vesting schedule exists for that id"
        );
    ...
    function createVestingSchedule(
        ...
        require(
            ...
            "TokenVestingTLT: token TLT transferFrom not succeeded"
        );
        _createVestingSchedule(
            _beneficiary,
            _start,
    ...
    function _createVestingSchedule(
        ...
        require(_duration > 0, "TokenVestingTLT: duration must be > 0");
        require(_amount > 0, "TokenVestingTLT: amount must be > 0");
        require(
            _slicePeriodSeconds >= 1,
            "TokenVestingTLT: slicePeriodSeconds must be >= 1"
        );
        ...
        returns (bool)
    {
        ...
        require(
            ...
            "TokenVestingTLT: token TLT rewards transfer to beneficiary not succeeded"
        );
    ...
    function computeAllReleasableAmountForBeneficiary(
        address beneficiary
    ) external view onlyIfBeneficiaryExists(beneficiary) returns (uint256) {
        uint256 vestingSchedulesCountByBeneficiary = getVestingSchedulesCountByBeneficiary(
                beneficiary
            );
