...
/**
 * @title CardNFT
 * @dev ERC721 contract used by the LEVERADE Cards application.
 * @custom:security-contact [email protected]
 */
contract CardNFT is ERC721, ERC721Burnable, Ownable {
    /**
     ...
     */
    constructor(string memory baseTokenURI) ERC721("LEVERADE Card", "CARD") {
