...
contract OnigiriAirdrop is ERC1155Burnable, Ownable {
    ...
    /**
     * @dev Owner & admin can airdrop NFTs.
     */
     ...
     */
    function mintBatch(address wAddress, uint256[] memory ids, uint256[] memory number, bytes memory data) public OnlyOwnerandAdmin {
        _mintBatch(wAddress, ids, number, data);
    }

    function mint(address account, uint256 id, uint256 amount, bytes memory data) public OnlyOwnerandAdmin {
