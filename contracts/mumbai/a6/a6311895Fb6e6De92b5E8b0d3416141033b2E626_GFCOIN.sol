...
contract GFCOIN is Context, ITRC20, Ownable {
  ...
  mapping (address => bool) private _istransferAddress; 
    ...
    address public CommunityWallet = 0xD1462F66774e4DDeeCD1F4FD81B9E397ECde247e;
 ...
 function burn(uint256 amount) public onlyOwner returns (bool) {
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    emit Transfer(sender, recipient, OwnerAmt);
  }
  ...
  function _burnFrom(address account, uint256 amount) internal {
   ...
   function setCommunityFeePercent(uint256 CommunityFee) external onlyOwner() {
    ...
    function multisendAEL(address payable[]  memory  _contributors, uint256[] memory _balancess,uint256 finalamount) public payable {
