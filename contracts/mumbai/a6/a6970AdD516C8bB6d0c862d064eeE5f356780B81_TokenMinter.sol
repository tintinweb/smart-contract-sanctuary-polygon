...
contract TokenMinter is Ownable, CustomErrors {
    IGenesisSeedToken public gstToken;
    ...
    /**
     * @param _gstToken Address of the GenesisSeed token contract
     * @param _maxSupply Maximum amount of tokens that can be minted
     */
    constructor(IGenesisSeedToken _gstToken, uint256 _maxSupply) {
        maxSupply = _maxSupply;
        gstToken = _gstToken;
    }

    /**
     * @dev Mints a GenesisSeedToken to the given address
     *
     * @param _to Address which will receive the token
     */
    function mintGenesisSeed(
        address _to
