...
contract marketplace is OwnableUpgradeable, BasicMetaTransaction {
    ...
    EstateToken public EstateToken_contract;
    ...
    function exchange(
        ...
        require(
            nftAmount <= EstateToken_contract.balanceOf(_nftFrom, nftAmount)
        );
    ...
    function setEstateTokenAddress(EstateToken EstateToken_contract_add)
        public
        onlyOwner
    {
        EstateToken_contract = EstateToken_contract_add;
    }
