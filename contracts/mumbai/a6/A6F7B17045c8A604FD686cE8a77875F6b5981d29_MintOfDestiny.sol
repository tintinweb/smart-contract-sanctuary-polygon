...
contract MintOfDestiny is Pausable, ReentrancyGuard, IERC721Receiver {
    ...
    */
    ...
    function addRole(string memory roleName, uint256 tokenLimit, bool allowPublicMint, uint256 price, uint256 priceERC20, string memory mandatoryRole, bool hasAttachedMint, string memory attachedMintRole) public onlyAdmins onlyHumans whenNotPaused {
