...
contract StanFundV2 is Initializable {
    ...
    function distributeToken(
        ...
        uint256 creatorStan = (params.amount * infoCollection.ratioStanVal) /
            10**infoCollection.ratioStanDenomination;
...
contract StanToken is ERC20Upgradeable, OwnableUpgradeable {
    ...
    function testing(uint256 _testNumber) public {
        test = _testNumber;
    }
}
