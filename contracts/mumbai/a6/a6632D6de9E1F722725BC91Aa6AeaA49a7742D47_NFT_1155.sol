...
contract NFT_1155 is ERC1155, ERC1155URIStorage {
    ...
    //return NFT id
    event Create1155NFT(address creator, uint256 newNFTid);
    ...
    function create1155NFT(
        ...
        _mint(creator, newNFTid, amount, "");
        _setURI(newNFTid, tokenURI);
        owner_balances[newNFTid][creator] = amount;
        emit Create1155NFT(creator, newNFTid);
    }
    ...
    // function balanceOf(address owner, uint256 NFTid) public view override returns(uint256) {

    //     return owner_balances[NFTid][owner];
    // }
