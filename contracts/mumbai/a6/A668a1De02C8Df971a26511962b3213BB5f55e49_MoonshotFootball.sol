...
contract MoonshotFootball is ERC721URIStorage, Ownable {
    using SafeMath for uint256;
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    uint public constant maxPurchase = 10;
    uint256 public constant purchasePrice = 5000000000000000000; //5 MATIC

    constructor() ERC721("MoonshotFootball", "MOONFOOTBALL") {}
        ...
        returns (uint256)
    {
        ...
        _setTokenURI(newItemId, string(abi.encodePacked(
                "https://moondiamonds.s3.us-east-2.amazonaws.com/f",
