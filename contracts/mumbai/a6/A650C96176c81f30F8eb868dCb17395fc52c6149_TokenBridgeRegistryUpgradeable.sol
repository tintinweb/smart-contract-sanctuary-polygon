...
contract BridgeUpgradeable is Initializable, OwnableUpgradeable, RouterCrossTalkUpgradeable {
    ...
    function crossChainTransferOut(
        ...
        (bool success, ) = routerSend(_toChainId, _interface, data, crossChainGas, _gasPrice);
    ...
    function createCrossChainTransferMapping(
        ...
        emit BridgeTransactionEnd(_transferIndex, chainId, _userAddress, _tokenTicker, 2);
    }
    ...
    function crossChainTransferIn(
        ...
        emit BridgeTransactionEnd(_index, chainId, _msgSender(), _tokenTicker, 3);
    }
