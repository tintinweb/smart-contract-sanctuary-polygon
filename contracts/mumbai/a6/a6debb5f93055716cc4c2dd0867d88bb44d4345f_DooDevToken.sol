...
contract DooDevToken is IMATIC20, Ownable {
    ...
    //Returns MATIC20-totalSupply
    function totalSupply() external view virtual override returns (uint256) {
        return _totalSupply;
    }

    //Returns MATIC20-balanceOf
    ...
    function transferFrom(
        ...
        require(
            ...
            "MATIC20: transfer amount exceeds allowance"
        );
        unchecked {
            _approve(
                sender,
        ...
        returns (bool)
    {
        ...
        require(
            ...
            "MATIC20: decreased allowance below current allowance"
        );
        unchecked {
    ...
    function _transfer(
        ...
        require(from != address(0), "MATIC20: transfer from the zero address");
        require(to != address(0), "MATIC20: transfer to the zero address");
        require(
            _balances[from] >= amount,
            "MATIC20: transfer amount exceeds balance"
        );
        unchecked {
    ...
    function _mint(address account, uint256 amount) internal {
        require(account != address(0), "MATIC20: mint to the zero address");
        _totalSupply += amount;
    ...
    function _burn(address account, uint256 amount) internal {
        require(account != address(0), "MATIC20: burn from the zero address");
        require(
            _balances[account] >= amount,
            "MATIC20: burn amount exceeds balance"
        );
        unchecked {
    ...
    function _approve(
        ...
        require(owner != address(0), "MATIC20: approve from the zero address");
        require(spender != address(0), "MATIC20: approve to the zero address");
    ...
    function burnFrom(address account, uint256 amount) public onlyOwner {
        require(
            ...
            "MATIC20: burn amount exceeds allowance"
        );
