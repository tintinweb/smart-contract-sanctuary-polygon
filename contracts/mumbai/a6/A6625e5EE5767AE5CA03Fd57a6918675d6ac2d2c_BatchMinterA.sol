...
contract BatchMinterA is ERC721A {
    constructor() ERC721A("Batch", "BATCH") {}
...
import '@openzeppelin/contracts-0.8/token/ERC721/extensions/IERC721Metadata.sol';
...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _baseURI() internal view virtual returns (string memory) {
        return 'http://coddleranchinternaltesting.azurewebsites.net/api/tokendetails?tokenid=';
    }
