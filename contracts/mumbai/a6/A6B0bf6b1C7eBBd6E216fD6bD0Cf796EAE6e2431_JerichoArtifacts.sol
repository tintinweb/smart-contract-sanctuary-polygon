 ...
 * @dev Provides counters that can be incremented, set, decremented or reset. This can be used e.g. to track the number
...
library Counters {
    ...
    function setCounterValue(Counter storage counter, uint256 value) internal {
        unchecked {
