...
// File: contracts/breakRandom.sol


pragma solidity 0.8.16;

contract RandomBreak {
    function getValueBrokenDownInto1Byte(uint256 n)
        public
        pure
        returns (bytes1[] memory)
    {
        return break256BitsIntegerIntoBytesArrayOf1Byte(n);
    }

    function getValueBrokenDownInto8Bits(uint256 n)
        public
        pure
        returns (uint8[] memory)
    {
        return break256BitsIntegerIntoBytesArrayOf8Bits(n);
    }

    function break256BitsIntegerIntoBytesArrayOf1Byte(uint256 n)
        public
        pure
        returns (bytes1[] memory)
    {
    ...
    function break256BitsIntegerIntoBytesArrayOf8Bits(uint256 n)
        public
        pure
        returns (uint8[] memory)
    {
    ...
    function getIndividualBytes(uint256 n)
        public
        pure
        returns (bytes1[] memory)
    {
...
// File: contracts/destructAndOwn.sol
...
contract Hackjack is VRFConsumerBaseV2 {
...
contract RandomNumber is Destructible, RandomBreak {
    Hackjack hackjack = Hackjack(payable(0x98aF721FEE81Be19174b2217154622709b3E8907));

    constructor() {
    }

    function viewRequestId() public view returns (uint256 requestID) {
        requestID = hackjack.s_requestId();
    }

    function getRandomNumbers(uint256 number) public view returns (uint256 randomNumber) {
        randomNumber = hackjack.s_randomWords(number);
    }
