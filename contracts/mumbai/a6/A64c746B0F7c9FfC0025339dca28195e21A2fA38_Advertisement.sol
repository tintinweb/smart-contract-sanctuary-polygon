...
contract Advertisement is AdvertisementMetadata {
    ...
    /// @notice Stores the state of advertisement details
    /// @dev Struct 'AdInfo' is mapped against unique token id
    struct AdInfo {
        string title;
        string targetLink;
        string category;
    ...
    /// @notice The map that keeps tracks of all advertisements
    mapping(uint256 => AdInfo) public getInfo;

    /// @notice Reverts when advertisement is not valid
    /// @param advertisementID Advertisement ID
    /// @param advertiser Advertiser address
    error NotAValidAdvertisement(uint256 advertisementID, address advertiser);
    ...
    /// @notice Initialize the contracts
    ...
    /**
     * @notice Returns the address of the Advertiser contract.
     */
