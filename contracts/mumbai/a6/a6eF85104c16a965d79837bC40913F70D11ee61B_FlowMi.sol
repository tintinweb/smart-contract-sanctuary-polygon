...
contract FlowMi is VRFConsumerBaseV2 {
    ...
    address private wmaticTokenAddress =
        ...
        // // wrapped testnet
        0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889; // wrapped testnet
    ...
    function flowmiFollow(address _profileid) public payable {
        ...
        //iWmatic.transferFrom(payable(msg.sender), address(this), fraction);

        // iWmatic.approve(address(this), fraction);
        // iWmatic.approve(address(POOL), fraction);
        iWmatic.transferFrom(msg.sender, address(this), fraction);
