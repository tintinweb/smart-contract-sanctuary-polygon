...
contract web3domain is Ownable, ERC721, ERC721URIStorage, ERC721Enumerable {
    ...
    function mint(uint256 _id, string memory title, string memory _tokenUri) internal {
    ...
    function claim(uint256 tokenId, string calldata title, string memory _tokenUri) external payable {
    ...
    constructor() ERC721("web3domain", "Web3 Domain") {
        // mint(0, "");
    }
