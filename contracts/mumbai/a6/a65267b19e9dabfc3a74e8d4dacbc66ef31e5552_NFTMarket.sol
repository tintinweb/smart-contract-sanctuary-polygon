...
contract NFTMarket is Ownable {
    ...
    function listNftFixPrice(
        ...
        require(
            IERC721(nfts[_nftId].erc721).isApprovedForAll(msg.sender, address(this)) == true,
        ...
        emit tokenListedFixPrice(_nftId, nfts[_nftId].erc721, _price);
    }
    ...
    function unlistNftFixPrice(uint256 _nftId) public {
        ...
        emit tokenUnlistedFixPrice(_nftId, nfts[_nftId].erc721);
    }
    ...
    function buyNftFixedPrice(uint256 _nftId) public payable {
        ...
        emit nftBoughtFixPrice(_nftId, nfts[_nftId].erc721, msg.sender);
    }
