...
contract  newNFT is ERC721, ERC721URIStorage, Ownable {
    ...
    address public feeReceiver = 0x7863d1C6f74Ebb0d4C7c0bdBE40EEB963dE005A0;
    mapping(address => uint256[]) public ownedTokens;
    mapping(address => uint256) public mintCount; 
    uint256 public totalSupply = 70;
    uint256 public sold;
    uint256 public gasFee = 0.002 ether;
    uint256 public amountRaised; 

    constructor() ERC721("Decent Database", "NFT") {}
    ...
    function mintNFT(
        ...
        require(
            msg.value == gasFee,
            "Should have gas fee in BNB"
        );
        require(sold <= totalSupply, "All Nfts  Sold");
        uint256 newTokenId; {
            _tokenIdCounter.increment();
            newTokenId = _tokenIdCounter.current();
            _safeMint(msg.sender, newTokenId);
            _setTokenURI(newTokenId, _nft);
    ...
    function getProgress() public view returns (uint256 _percent) {
        uint256 remaining = totalSupply.sub(sold);
    ...
    function transferFunds(uint256 _amount) public onlyOwner {
