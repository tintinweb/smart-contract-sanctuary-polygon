    ...
    MigrateToken
{
    ...
    string private _name = "NOMAD Token";
    string private _symbol = "NOMAD";
    ...
    constructor(
        ...
        if (_initialSupply > 0) {
            ...
            _mint(InsiderWallet, _initialSupply.mul(45).div(100));

            _mint(PublicWallet, _initialSupply.mul(55).div(100));
        }
    }
