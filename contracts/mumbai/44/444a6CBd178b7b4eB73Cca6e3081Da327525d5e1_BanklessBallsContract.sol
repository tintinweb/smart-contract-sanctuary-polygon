...
//   ____                 _     _                   ____          _  _      
//  |  _ \               | |   | |                 |  _ \        | || |     
//  | |_) |  __ _  _ __  | | __| |  ___  ___  ___  | |_) |  __ _ | || | ___ 
//  |  _ <  / _` || '_ \ | |/ /| | / _ \/ __|/ __| |  _ <  / _` || || |/ __|
//  | |_) || (_| || | | ||   < | ||  __/\__ \\__ \ | |_) || (_| || || |\__ \
//  |____/  \__,_||_| |_||_|\_\|_| \___||___/|___/ |____/  \__,_||_||_||___/
//                                                                          
//                                                                          
//
//*********************************************************************//
...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1658311260;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1657447200;
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xe786AD005BffBaaBF6D0c19474d524db7f682f1a];
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeibhu7vrqwv7wuy2tx4rjs3jl47oaxyxlhnqtjyb6tzwb3pn4hl73e/";
...
// File: contracts/BanklessBallsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BanklessBallsContract is RamppERC721A {
    constructor() RamppERC721A("Bankless Balls", "BLB"){}
}
