...
contract BondTeller is ITeller, OlympusAccessControlled {
    ...
    struct Bond {
        ...
        uint256 payout; // sSOLID remaining to be paid. agnostic balance
    ...
    IsSOLID internal immutable sSOLID; // payment token
    ...
    function newBond(
        ...
        SOLID.approve(address(staking), _payout);
    ...
    function getReward() external override {
        ...
        FERs[msg.sender] = 0;
        SOLID.safeTransfer(msg.sender, reward);
    }
    ...
    function pay(address _bonder, uint256 _amount) internal {
        sSOLID.safeTransfer(_bonder, _amount);
    }
    ...
    function pendingForIndexes(address _bonder, uint256[] memory _indexes) public view override returns (uint256 pending_) {
        ...
        pending_ = sSOLID.fromG(pending_);
    }
