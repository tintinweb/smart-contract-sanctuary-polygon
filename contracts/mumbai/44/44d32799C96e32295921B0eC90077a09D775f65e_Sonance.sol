...
contract Sonance is ReentrancyGuard, Ownable {
    ...
    @param coverIPFS: the IPFS url for the cover art
    @param explicit: default is false aka not explicit
    @param inspired: the address of the artist who inspired the AI track
