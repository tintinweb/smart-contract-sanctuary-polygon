...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xCDdb2F85f2881103302eA44223D0049B66C239c3];
...
// File: contracts/OregenContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OregenContract is RamppERC721A {
    constructor() RamppERC721A("Oregen", "ORE"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/kDnRrfCipKh8uqC0Y7At/contract-metadata";
    }
}
