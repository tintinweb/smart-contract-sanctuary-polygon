...
contract PledgeStakeV2 {
    ...
    function _updateRewards(address _user) private {
        ...
        uint256 userLastProcessedStakeIndex = lastProcessedStakeIndex[_user];
        uint256 stakesLength = stakes[_user].length;
        for (uint256 i = userLastProcessedStakeIndex; i < stakesLength; i++) {
            ...
            // Update the last processed stake index
            lastProcessedStakeIndex[_user] = i + 1;
        }
    }
