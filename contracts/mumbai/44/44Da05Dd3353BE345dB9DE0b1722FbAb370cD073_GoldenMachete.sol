...

{
    ...
    */
        ...
        external
    {
        ...
        require(hasRole(MINTER_ROLE, _msgSenderERC721A()), "GoldenMachete: must have minter role to mint");
    ...
    */
    ...
    {
        require(hasRole(UPGRADER_ROLE, _msgSender()), "GoldenMachete: must have admin role");
    ...
    */
    ...
    (
        ...
        returns (string memory)
    {
        require(_exists(tokenId), "GoldenMachete: URI query for nonexistent token");
    ...
    */
        ...
        virtual
    {
        require(
            ...
            "GoldenMachete: must have pauser role to pause"
        );
        ...
        virtual
    {
        require
            (hasRole(PAUSER_ROLE, _msgSenderERC721A()),
            "GoldenMachete: must have pauser role to unpause"
        );
