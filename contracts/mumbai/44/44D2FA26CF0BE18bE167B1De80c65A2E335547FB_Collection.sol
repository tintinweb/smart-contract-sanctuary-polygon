    ...
    AccessControl
{
    ...
    bytes32 public constant NFT_URI_EDITOR_ROLE =
        keccak256("NFT_URI_EDITOR_ROLE");
    ...
    function addURIEditor(address _editor) public onlyRole(DEFAULT_ADMIN_ROLE) {
        grantRole(NFT_URI_EDITOR_ROLE, _editor);
    }
    ...
    {
        revokeRole(NFT_URI_EDITOR_ROLE, _editor);
    }
    ...
    function addAdminRole(address _admin) public onlyRole(DEFAULT_ADMIN_ROLE) {
        ...
        grantRole(NFT_URI_EDITOR_ROLE, _admin);
    }
        ...
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        ...
        revokeRole(NFT_URI_EDITOR_ROLE, _admin);
    }
    ...
    /**
     * @dev Function to set the nft IPFS uri.
     * @param _tokenId uint256 ID of the nft
     * @param _uri string of the nft IPFS uri
     */
    function setURI(uint256 _tokenId, string memory _uri)
        public
        onlyRole(NFT_URI_EDITOR_ROLE)
    {
     ...
     */
    function batchMint(address[] memory _to, uint256[] memory _tokenId)
        public
        onlyRole(MINTER_ROLE)
        returns (uint256[] memory ids, address[] memory receivers)
    {
    ...
    /**
     * @dev Function to set the Nft URI in batch.
     * @param _tokenId tokenId array
     * @param _uri uri array
     */
    function batchSetURI(uint256[] memory _tokenId, string[] memory _uri)
        public
        onlyRole(NFT_URI_EDITOR_ROLE)
    {
