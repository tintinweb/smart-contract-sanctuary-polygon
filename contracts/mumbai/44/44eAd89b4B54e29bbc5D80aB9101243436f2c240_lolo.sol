...
contract lolo is ERC721A, Ownable, ERC2981 {
    ...
    //URI
    string public baseURI = "ipfs://bafybeiao3y3wzru6tgfxbr55bglmdkhn2eh4ejuxn7uilbibtfkbgxb2m4/";
...
// <------------------------------------- Main Functions ------------------------------------->
    ...
    function _baseURI() internal view override returns (string memory) {
        if(reveal == false) {
            return "ipfs://bafybeiao3y3wzru6tgfxbr55bglmdkhn2eh4ejuxn7uilbibtfkbgxb2m4/";
        } else {
            return baseURI;
        }
    }
