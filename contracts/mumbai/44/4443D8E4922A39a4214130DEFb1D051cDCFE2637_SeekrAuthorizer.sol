...
import "./interfaces/ISeekrAuthorizer.sol";
import "@openzeppelin/contracts-upgradeable/access/AccessControlEnumerableUpgradeable.sol";

contract SeekrAuthorizer is ISeekrAuthorizer, AccessControlEnumerableUpgradeable {
    bytes32 public constant SUPER_ADMIN_ROLE = keccak256("SUPER_ADMIN");
    bytes32 public constant SUPPORT_LEVEL_1_ROLE = keccak256("SUPPORT_LEVEL_1");
    bytes32 public constant SUPPORT_LEVEL_2_ROLE = keccak256("SUPPORT_LEVEL_2");
    bytes32 public constant SUPPORT_LEVEL_3_ROLE = keccak256("SUPPORT_LEVEL_3");
    ...
    function initialize(address _superAdmin) public initializer {
        ...
        // initialize admin relationships
        _setRoleAdmin(SUPER_ADMIN_ROLE, SUPER_ADMIN_ROLE);
        _setRoleAdmin(SUPPORT_LEVEL_1_ROLE, SUPER_ADMIN_ROLE);
        _setRoleAdmin(SUPPORT_LEVEL_2_ROLE, SUPER_ADMIN_ROLE);
        _setRoleAdmin(SUPPORT_LEVEL_3_ROLE, SUPER_ADMIN_ROLE);

        // grant initial superadmin role
        _grantRole(SUPER_ADMIN_ROLE, _superAdmin);
    }

    /// @inheritdoc ISeekrAuthorizer
    function isValidSigner(address signer) public override view returns (bool) {
        return _signers[signer];
    }

    /// @inheritdoc ISeekrAuthorizer
    function setValidSigner(address signer, bool isValid) public override onlyRole(SUPER_ADMIN_ROLE) {
