...
pragma solidity 0.8.1;
contract PremiumPackTest is ERC1155, Ownable, AccessControl, ReentrancyGuard {
    ...
    string public constant symbol = "CTAPRMT";

    mapping(address => address) private signatures;

    bool public saleOpen = false;

    uint256 public constant maxSupply = 18008;

    uint256 private constant AIRDROP_NUMBER = 8;
    ...
    function uri(uint256 tokenId) public view override returns (string memory) {
        ...
        return (
            string(
                abi.encodePacked(
                    "https://ipfs.io/ipfs/QmV1FLwx3Qmw1TCUJoV9qWBkM1koFASL6ypRzzC3J8xcH9/",
                    id,
                    ".json"
                )
            )
