...
contract DrippsEventFactory is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    event NewEvent(address instance);
		...
		event NewAssetsAddress(address assetsAdress);
    ...
    function eventImplementation() external view virtual returns (address) {
		...
		/**
     * @dev Sets the value of the `_assetsAdress`.
   	 */
    function assets_set(
			address assetsAdress
		) external onlyOwner {
    		assets_set_unchained(assetsAdress);
    }

		function assets_set_unchained(
			address assetsAdress
		) internal onlyOwner {
				_assetsAdress = assetsAdress;
				emit NewAssetsAddress(assetsAdress);
		}

			/**
		* @dev Returns the value of the `_assetsAdress`.
		*/
    function assets() external view virtual returns (address) {
        return _assetsAdress;
    }
