...
import {IChildToken} from "./utils/IChildToken.sol";

contract AnimaChild is
    ERC20,
    ERC20Burnable,
    Pausable,
    AccessProtected,
    ...
    IChildToken
{
    bytes32 public constant AUTHORISED_MINTER_ROLE =
        keccak256("AUTHORISED_MINTER_ROLE");
    bytes32 public constant DEPOSITOR_ROLE = keccak256("DEPOSITOR_ROLE");

    constructor(address childChainManager)
        ERC20("Anima617", "ANIMA617")
    {
    ...
    // The following functions are required by token map.
