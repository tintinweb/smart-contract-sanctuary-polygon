...
contract CyberSyndicate is ERC721A("CyberSyndicate", "CSE"), Ownable, ERC2981, DefaultOperatorFilterer, ONFT721ACore {
    ...
    uint256 _minGasToTransferAndStore = 64000;
    address _lzEndpoint= 0x551f387C994EF93d0D88d1ac8bD009Fd4f6e4Cf1;
    address[]  adds = [0x551f387C994EF93d0D88d1ac8bD009Fd4f6e4Cf1];

    constructor() ONFT721ACore(_minGasToTransferAndStore, _lzEndpoint) {
        _setDefaultRoyalty(msg.sender, 500); // 5.00 %
        sendPreMintedNFT();
    }

    function sendPreMintedNFT() private {
