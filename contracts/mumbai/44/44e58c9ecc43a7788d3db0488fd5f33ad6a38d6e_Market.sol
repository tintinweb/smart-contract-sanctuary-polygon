    ...
    ReentrancyGuardUpgradeable
{
    ...
    function createAuction(
        ...
        _listCountPerTokenId[nftContract_][tokenId_]++;
        ...
        isValidAuction(auctionId_)
    {
        ...
        uint256 listCount = _listCountPerTokenId[auction.nftContract][
            auction.tokenId
        ] > 1
            ? 1
            : 0;
        ...
        if (
            ...
            payoutCount = INFTPayoutsUpgradeable(auction.nftContract)
                .payoutCount(auction.tokenId, listCount);
        }
        ...
        if (_paymentTokens[highestBid.paymentTokenIndex].native) {
            if (payoutCount == 0) {
                ...
                (payoutReceivers, payoutShares) = INFTPayoutsUpgradeable(
                    auction.nftContract
                ).payoutInfo(auction.tokenId, bidAmountWithoutFee, listCount);
