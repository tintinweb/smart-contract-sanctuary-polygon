...
contract Dema {
    ...
    function viewAllProducts() public view returns (string memory){
        return allProducts;
    }

    function viewAllShoppers() public view returns (string memory){
        return allShoppers;
    }

    function viewAllSellers() public view returns (string memory){
        return allSellers;
    }
