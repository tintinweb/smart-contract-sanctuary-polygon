...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x6D8C1445b62a8018A48f743e157732b0Db8ab579];
...
// File: contracts/SaveWorldNfTsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract SaveWorldNfTsContract is 
    ERC1155,
    Ownable, 
    Pausable, 
    ERC1155Supply, 
    ...
    Allowlist
{
    ...
    string public name = "SaveWorldNFTs";
    ...
    */
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/ZEwHkphVUk8Yf5z7PeGJ/contract-metadata";
    }
