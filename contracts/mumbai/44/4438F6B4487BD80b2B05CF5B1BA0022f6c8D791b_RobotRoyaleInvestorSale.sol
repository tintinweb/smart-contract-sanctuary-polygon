...
//   _____       _           _   _____                   _      
//  |  __ \     | |         | | |  __ \                 | |     
//  | |__) |___ | |__   ___ | |_| |__) |___  _   _  __ _| | ___ 
//  |  _  // _ \| '_ \ / _ \| __|  _  // _ \| | | |/ _` | |/ _ \
//  | | \ \ (_) | |_) | (_) | |_| | \ \ (_) | |_| | (_| | |  __/
//  |_|  \_\___/|_.__/ \___/ \__|_|  \_\___/ \__, |\__,_|_|\___|
//                                            __/ |             
//                                           |___/              
//     by CryptoWinter                                          
...
contract RobotRoyaleInvestorSale is ERC721Holder, Ownable {
    ...
    event Purchase(address indexed, uint);
    ...
    function purchase(uint _amount) public payable {
        ...
        require(valueReceived >= costofPurchase, "Insufficient funds");
