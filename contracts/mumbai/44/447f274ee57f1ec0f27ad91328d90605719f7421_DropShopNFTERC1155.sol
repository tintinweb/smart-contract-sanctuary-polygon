    ...
    RoyaltiesV2Impl
{
    ...
    mapping(uint => string) public metadaIpfsHash;
 ...
 /**
    ...
    function uri(uint256 tokenId) public view override returns (string memory) {  
        ...
        return _stringReplace(uri_, "?", metadaIpfsHash[tokenId]);
        //return metadaIpfsHash[tokenId];
    }
    ...
    */
    ...
    function mint(
        address account,
        string calldata metadaIpfsHash_,
        uint256 amount,
        bytes calldata data
        ...
        require(((amount > uint(0)) && (amount == restTotalSupply(tokenId, amount))) , "INVALID_TOKEN_AMOUNT");
         metadaIpfsHash[tokenId]=metadaIpfsHash_;
     ...
     * but can be changed as per requirement
     */
     function bulkMint(address to, string calldata metadaIpfsHash_,uint256[] calldata ids,uint256[] calldata amounts,bytes calldata data) external only(MINTER_ROLE) {
        ...
        for(uint i = 0; i < ids.length; i++){ 
            ...
            metadaIpfsHash[ids[i]]=metadaIpfsHash_;
        }
