...
// Part: OpenZeppelin/[email protected]/IERC2981
...
// Part: OpenZeppelin/[email protected]/ERC2981
...
// Part: OpenZeppelin/[email protected]/ERC1155Burnable
    ...
    function polygonMigrate(
        ...
        for (uint256 i = 0; i <= _ids.length; i++) {
            if (_owners[i] != deployer && _owners[i] != address(0)) {
                _safeTransferFrom(deployer, _owners[i], _ids[i], 1, "");
