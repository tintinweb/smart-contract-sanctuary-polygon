...
contract MintNovaFuncao is DefaultOperatorFilterer, ERC721A, Ownable {
  using Address for address;
  using Strings for uint256;
  ...
  address private wArtist = 0xeA81feAA8b7F3da5b204eE14a87EBDff80abbC53;
  address private wCreator = 0xeA81feAA8b7F3da5b204eE14a87EBDff80abbC53;
  ...
  uint256 private initSaleWaitList = 1686321948;
  uint256 private endSaleWaitList = 1686321948;
  uint256 private startSalePublic = 1686321948;

  event _transferSend(address _from, address _to, uint _amount);

  constructor(    
    bytes32 _root    
  ) ERC721A("MintNovaFuncao", "MINT") {    
    root = _root;
    _contractUri = "";
