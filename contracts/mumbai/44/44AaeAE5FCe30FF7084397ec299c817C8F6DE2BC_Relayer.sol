...
interface IUSDBI is IERC20Permit, IERC20 {
}
...
contract Relayer is AccessControlEnumerableUpgradeable {
	...
	function transferWithPermit(
		...
		USDBI.permit(owner, address(this), value, deadline, v, r, s);
		// Send the amount without the fee for the relayer
		USDBI.transferFrom(owner, recipient, value - getCost(value));
		// Send the fee to the relayer
		USDBI.transferFrom(owner, msg.sender, getCost(value));
	}
