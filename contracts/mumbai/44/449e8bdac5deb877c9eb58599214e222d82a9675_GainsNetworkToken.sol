...
contract AccessControlMixin is AccessControl {
    ...
    // set the revert msg based on the contract name
...
contract GainsNetworkToken is ERC20Capped, IChildToken, AccessControlMixin, NativeMetaTransaction, ContextMixin {
    ...
    event GrantRequestInitiated(bytes32[] indexed roles, address indexed account, uint256 indexed block);
    event GrantRequestCanceled(address indexed account, uint256 indexed canceled);

    constructor() public ERC20Capped(100 * (10 ** 9) * (10 ** 18)) ERC20("Gains Network", "GNS") {
        // Token init
