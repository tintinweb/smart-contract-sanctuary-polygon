...
contract Cirip is Ownable{
    ...
    function buyProduct(address _sellerAddress, string memory _id ) payable public returns(string memory id) {
        require(
        ...
        address payable sellerAddress = payable(_sellerAddress);
