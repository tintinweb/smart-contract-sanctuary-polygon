...
contract KaiGani is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;

    string public constant ContractName = "KaiGani.0.0.2";
    mapping(address=>bool) private authorizedApprovers; 
    Counters.Counter private _tokenIdCounter;
    address[] public authorizedApproverList;
    address private _creator;

    constructor() ERC721("KaiGani", "KAI") {
        _creator = msg.sender;
    }
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    /**
     * @dev Approve `to` to operate on `tokenId`msgSenderasdfasdfasdfasdfasdf
     *
