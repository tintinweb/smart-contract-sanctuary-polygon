...
//    uint private constant RENTING_RENEWAL_PERIOD_GAP = 4 hours;
    ...
    function rentFromCollection(uint256 id, uint256 landId, uint256[] memory botsIds) external returns (bool) {
        ...
        uint256[] memory availableLands = Array256Lib.remove(collection.landIds, landId);
//        uint256[] memory availableBotsIds = Array256Lib.removeAll(collection.botsIds, botsIds);
//        uint256[] memory rentedLandIds = Array256Lib.add(collection.rentedLandIds, landId);
//        uint256[] memory rentedBotsIds = Array256Lib.addAll(collection.rentedBotsIds, botsIds);

//
//        storageContract.updateCollectionRentedAssets(id, availableLands,
//    availableBotsIds, rentedLandIds, rentedBotsIds);
////
////
