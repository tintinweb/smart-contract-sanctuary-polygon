...
contract RethestateMember is ERC1155, Ownable, ERC1155Burnable, ERC1155Supply {
    using Strings for uint256;
    using SafeMath for uint256;
    

    string public constant name = "Rethestate";
    string public constant symbol = "RMEM";
    string baseURI = "";
    ...
    function mint(uint256 tokenId, uint256 amount) public payable {
        ...
        require(msg.value >= totalPrice, "insufficient value sent");
