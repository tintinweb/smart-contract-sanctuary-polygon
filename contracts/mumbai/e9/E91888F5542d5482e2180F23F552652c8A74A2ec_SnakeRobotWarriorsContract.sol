...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xA5c4B43Dfde7DB9b2ad6ef20502dDA9065cAD5fD];
  address public erc20Payable = 0xA5c4B43Dfde7DB9b2ad6ef20502dDA9065cAD5fD;
...
abstract contract EarlyMintIncentive is Teams, ERC721A, ProviderFees {
  uint256 public PRICE = 65 ether;
  uint256 public EARLY_MINT_PRICE = 50 ether;
  uint256 public earlyMintTokenIdCap = 145;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 290) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeieqdznnblmfhf533to3avhbh4p6m6lfdrsgesrzcgzx6iedh6jbfq/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/3h1lo0U0USmg60ULoc0m/contract-metadata";
  }
...
// File: contracts/SnakeRobotWarriorsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SnakeRobotWarriorsContract is ERC721APlus {
    constructor() ERC721APlus("Snake Robot Warriors", "SnakeRobot"){}
}
