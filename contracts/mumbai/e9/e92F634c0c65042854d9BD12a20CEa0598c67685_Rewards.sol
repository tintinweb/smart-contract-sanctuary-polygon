    ...
    */
    ...
    function checkRewards(uint256 msgID, uint256 postCount) public onlyAdmins {
        ...
        if (userRewardID[tx.origin] != currentRewardID){
            ...
            console.log("Not in right rewards, switching");
        ...
        console.log("from", tx.origin);
        console.log("level", level);
        console.log("amount", amountPerLevel[currentRewardID].length);
        console.log("posts needed", amountPerLevel[currentRewardID][level]);
        if (level < amountPerLevel[currentRewardID].length) {

            console.log("level < number of levels");

            // If hey have reached the reward tier for their current level
            console.log(postCount, "=", amountPerLevel[currentRewardID][level]);
