...
contract ALPHABET is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("ALPHABET", "ALPHA") {
  ...
  uint256 public constant MINT_LIMIT_PER_WALLET = 27;
  ...
  uint256 public constant MAX_MULTIMINT = 27;
  ...
  function mint(uint256 count) public nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 27 at a time");
