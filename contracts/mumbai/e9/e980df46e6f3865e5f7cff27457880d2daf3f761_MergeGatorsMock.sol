...
contract MergeGators is Ownable, VRFConsumerBaseV2, IMergeGators {
    ...
    function merge3NFTs(uint256 _1st, uint256 _2nd, uint256 _3rd) public payable {
        ...
        (bool sent1, ) = payable(address(this)).call{gas: 600_000, value: _calculatePortionToRewardPool()}("");
        (bool sent2, ) = taxTreasury.call{gas: 600_000, value: _taxAmount - _calculatePortionToRewardPool()}("");
        (bool success, ) = address(alligators).call{gas: 10_000_000}(mergeParams);
        _mergePrize(msg.sender);
        require(success == true && sent1 == true && sent2 == true, "LowCallFailed");
    ...
    function merge3Wjoker(uint256 _1st, uint256 _2nd, uint256 _3rd) public payable {
        ...
        (bool sent1, ) = payable(address(this)).call{value: _calculatePortionToRewardPool()}("");
        (bool sent2, ) = taxTreasury.call{value: _taxAmount - _calculatePortionToRewardPool()}("");
...
contract MergeGatorsMock is MergeGators {
    ...
    address payable collection_ = payable(0x8F17c65051C3bfA42acba6D5b729Df960BB768d4);
