...
contract LazyBoys is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public presaleMintPrice = 10 ether;
    uint256 public publicMintPrice = 10 ether;
    uint256 public maxMintPerWallet = 10000;
    ...
    // ===== Constructor =====
    constructor() ERC721A("Lazy Boys", "lazyboys", maxMintPerWallet, 10000) {
    ...
    {      
        require(msg.value >= presaleMintPrice, "Minting a LazyBoy costs 10 matic each!");
    ...
    {      
        require(msg.value >= publicMintPrice, "Minting a LazyBoy Costs 10 matic Each!");
