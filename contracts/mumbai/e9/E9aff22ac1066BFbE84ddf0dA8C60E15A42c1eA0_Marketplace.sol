...
contract Marketplace is Ownable{
    ...
    bytes32 private constant SELL_ORDER_TYPEHASH =
        keccak256("SellOrder(address maker,uint256 rentalId,uint256 numberOfTokens,Payment payment,uint256 salt)Payment(bytes4 paymentClass,uint256 amount,bytes data)");
