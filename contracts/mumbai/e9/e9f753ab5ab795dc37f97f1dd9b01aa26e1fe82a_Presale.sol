...
contract Presale{
  ...
  function unpause() onlyowner whenPaused public {
    ...
    function calculateRWDforWT(uint256 amount) public view returns(uint256) 
    {
    ...
    {   
        ...
        uint256 amount = calculateRWDforWT(_amount);
    ...
    {     require(checkContractBalance()>=amount,"contract have not enough balance");  
          owner.transfer(amount);
            ...
            function WithdrawRWD(uint256 amount) public onlyowner
    {
