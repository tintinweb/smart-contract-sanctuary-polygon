...
// poder retirar todo el dinero quedando siempre un remanente de 0.02 ether, solo el owner, Con la funcion (sCToOwner).
...
contract Mypersonalwallet {
    ...
    function sCToOwner(uint amount) external onlyOwner {     
        ...
        require (amount <= miniFound, "Saldo insuficiente");
