...
contract WATT is ERC20, Ownable, ERC20Burnable, AccessControl {
    ...
    address private gaming;
    modifier onlyStaking {
        require(staking == msg.sender, "Only staking can call this function");
        _;
    }
    modifier onlyGaming {
        require(gaming == msg.sender, "Only staking can call this function");
        _;
    }
    ...
    function updateGaming (address newAddress) external onlyOwner {
        require(gaming != newAddress, "Already set");
        gaming = newAddress;
    }
