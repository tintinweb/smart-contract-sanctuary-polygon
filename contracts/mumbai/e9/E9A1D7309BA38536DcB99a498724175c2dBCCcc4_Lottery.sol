...
contract Lottery is VRFConsumerBaseV2, ILottery, Roles {
    ...
    uint64 private subscriptionId = 2738;
    ...
    constructor()
        ...
        Roles(_msgSender())
    {
        USDT = IERC20(0xCD4BE01824eD1e87396Beee404e3aD5F23D31B9B);
    ...
    function withdrawBasePool() external override onlyOwner {
        require(totalPool >= basePool, "Insufficient pool balance");
    ...
    function transferWhitelist(address _to, uint _value) external override {
        ...
        require(_value % 20 == 0, "Invalid whitelist quota");
