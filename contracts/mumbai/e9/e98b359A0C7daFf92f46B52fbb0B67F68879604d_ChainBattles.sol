...
contract ChainBattles is ERC721URIStorage {
    ...
    function generateCharacter(uint256 tokenId) public view returns (string memory){
        bytes memory svg = abi.encodePacked(
            ...
            '<text x="50%" y="60%" class="base" dominant-baseline="middle" text-anchor="middle">', "Speed: ",stats.speed.toString(),'</text>',
            '<text x="50%" y="70%" class="base" dominant-baseline="middle" text-anchor="middle">', "Strenght: ",getStrength(),'</text>',
    ...
    function setStats(uint256 tokenId) public {
        ...
        uint256 speed = tokenIdtoLevels[tokenId] + 100;
        uint256 strength = tokenIdtoLevels[tokenId] + 80;
        uint256 life = tokenIdtoLevels[tokenId] + 3;
        stats = Stats(level, speed, strength, life);
    }
