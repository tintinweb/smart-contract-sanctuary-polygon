...
contract SteerPeriphery is ISteerPeriphery, Initializable, OwnableUpgradeable, UUPSUpgradeable   {
    ...
    function deposit(
        ...
        if (amount0Desired > amount0) token0.transfer(msg.sender, amount0Desired - amount0);
        if (amount1Desired > amount1) token1.transfer(msg.sender, amount1Desired - amount1); 
    }
