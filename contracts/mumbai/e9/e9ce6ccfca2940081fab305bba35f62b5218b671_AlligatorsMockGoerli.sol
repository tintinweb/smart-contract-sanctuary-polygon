...
contract Alligators is
   ...
   /**
    ...
    function publicMint(uint256 _quantity) public payable {
        ...
        if (_numberMinted(msg.sender) + _quantity > perPublic) revert callErr();
    ...
    function whitelistMint(uint256 _quantity) public {  
        ...
        if (_whitelistMintedCount[msg.sender] + _quantity > perWhitelisted) revert callErr();
    ...
    */
    ...
    function merge3alligators(uint256 _1st, uint256 _2nd, uint256 _3rd, address merger) external {
        require(msg.sender == mergeGator, "OnlyHubs");
        require(tokenIdType[_1st] == 1 && tokenIdType[_2nd] == 1 && tokenIdType[_3rd] == 1, "Fail");
        if (ownerOf(_1st) == merger && ownerOf(_2nd) == merger && ownerOf(_3rd) == merger) {
            _mergeAlligators(_1st, _2nd, _3rd, merger);
        }
    }

    function mergeWjoker(uint256 _1st, uint256 _2nd, uint256 _3rd, address merger) external {
        require(msg.sender == mergeGator, "OnlyHubs");
        require(tokenIdType[_1st] == 3 && tokenIdType[_2nd] == 1 && tokenIdType[_3rd] == 1, "Fail");
        if (ownerOf(_1st) == merger && ownerOf(_2nd) == merger && ownerOf(_3rd) == merger) {
            _mergeWjoker(_1st, _2nd, _3rd, merger);
        }
    }
    ...
    */
    ...
    function traitTypes(uint256 _tokenId) public returns (uint8[7] memory _traits) {
        return anatomy(_tokenId);
    }

    function jokerLevel(uint256 _tokenId) public returns (uint8 lvl_) {
        return joker_level(_tokenId);
    }
    function traitLevels(uint256 _tokenId) public returns (uint8[7] memory _traits) {
        return alligator_level(_tokenId);
    }

    function nftType(uint256 _tokenId) public returns (uint8 type_) {
    ...
    */
    ...
    function _compareTraitJoker(uint256 _2nd, uint256 _3rd, uint8 _index) internal returns (uint8[2] memory) {
        if (alligator_level(_2nd)[_index] >= alligator_level(_3rd)[_index]) {

            uint8[2] memory value_ = [anatomy(_2nd)[_index], alligator_level(_2nd)[_index]];
            return value_;

        } else {

            uint8[2] memory value_ = [anatomy(_3rd)[_index], alligator_level(_3rd)[_index]];
            return value_;
    ...
    function _compareTrait(uint256 _1st, uint256 _2nd, uint256 _3rd, uint8 _index) internal returns (uint8[2] memory) {
        if (alligator_level(_1st)[_index] >= alligator_level(_2nd)[_index]) {
            if (alligator_level(_1st)[_index] >= alligator_level(_3rd)[_index]) {
                // first value is Type index, second one is Level Index
                uint8[2] memory value_ = [anatomy(_1st)[_index], alligator_level(_1st)[_index]];
                return value_;
            } else {
                uint8[2] memory value_ = [anatomy(_3rd)[_index], alligator_level(_3rd)[_index]];
                return value_;
    ...
    function _mergeAlligators(uint256 _1st, uint256 _2nd, uint256 _3rd, address merger) internal {
        ...
        // Generate Merged NFT
        if (anatomy(_1st)[0] == anatomy(_2nd)[0] 
        && anatomy(_1st)[0] == anatomy(_3rd)[0]) {
            if (alligator_level(_1st)[0] == alligator_level(_2nd)[0] 
            && alligator_level(_1st)[0] == alligator_level(_3rd)[0]) {
                if (alligator_level(_1st)[0] < 5) {
                    _1stType[1]++;
                    levelUp = lvlUp.TRUE;
                }
            }
        }
        if (anatomy(_1st)[1] == anatomy(_2nd)[1] 
        && anatomy(_1st)[1] == anatomy(_3rd)[1]) {
            if (alligator_level(_1st)[1] == alligator_level(_2nd)[1] 
            && alligator_level(_1st)[1] == alligator_level(_3rd)[1]) {
                if (alligator_level(_1st)[1] < 5) {
                    _1stType[1]++;
                    levelUp = lvlUp.TRUE;
                }
            }
        }
        if (anatomy(_1st)[2] == anatomy(_2nd)[2] 
        && anatomy(_1st)[2] == anatomy(_3rd)[2]) {
            if (alligator_level(_1st)[2] == alligator_level(_2nd)[2] 
            && alligator_level(_1st)[2] == alligator_level(_3rd)[2]) {
                if (alligator_level(_1st)[2] < 5) {
                    _1stType[1]++;
                    levelUp = lvlUp.TRUE;
                }
            }
        }
        if (anatomy(_1st)[3] == anatomy(_2nd)[3] 
        && anatomy(_1st)[3] == anatomy(_3rd)[3]) {
            if (alligator_level(_1st)[3] == alligator_level(_2nd)[3] 
            && alligator_level(_1st)[3] == alligator_level(_3rd)[3]) {
                if (alligator_level(_1st)[3] < 5) {
                    _1stType[1]++;
                    levelUp = lvlUp.TRUE;
                }
            }
        }
        if (anatomy(_1st)[4] == anatomy(_2nd)[4] 
        && anatomy(_1st)[4] == anatomy(_3rd)[4]) {
            if (alligator_level(_1st)[4] == alligator_level(_2nd)[4] 
            && alligator_level(_1st)[4] == alligator_level(_3rd)[4]) {
                if (alligator_level(_1st)[4] < 5) {
                    _1stType[1]++;
                    levelUp = lvlUp.TRUE;
                }
            }
        }
        if (anatomy(_1st)[5] == anatomy(_2nd)[5] 
        && anatomy(_1st)[5] == anatomy(_3rd)[5]) {
            if (alligator_level(_1st)[5] == alligator_level(_2nd)[5] 
            && alligator_level(_1st)[5] == alligator_level(_3rd)[5]) {
                if (alligator_level(_1st)[5] < 5) {
                    _1stType[1]++;
                    levelUp = lvlUp.TRUE;
                }
            }
        }
        if (anatomy(_1st)[6] == anatomy(_2nd)[6] 
        && anatomy(_1st)[6] == anatomy(_3rd)[6]) {
            if (alligator_level(_1st)[6] == alligator_level(_2nd)[0] 
            && alligator_level(_1st)[6] == alligator_level(_3rd)[6]) {
                if (alligator_level(_1st)[6] < 5) {
                    _1stType[1]++;
                    levelUp = lvlUp.TRUE;
                }
            }
        }
        require(levelUp == lvlUp.TRUE, "FAILED!");
        _anatomy[_currentIndex] = NFT_Anatomy(
            {
                trait1: Trait1(_1stType[0]), 
                trait2: Trait2(_2ndType[0]),
                trait3: Trait3(_3rdType[0]),
                trait4: Trait4(_4thType[0]),
                trait5: Trait5(_5thType[0]),
                trait6: Trait6(_6thType[0]),
                trait7: Trait7(_7thType[0])
            });
        _lvl[_currentIndex] = NFT_Level(
            {
                trait1Lvl: _1stType[1],
                trait2Lvl: _2ndType[1],
                trait3Lvl: _3rdType[1],
                trait4Lvl: _4thType[1],
                trait5Lvl: _5thType[1],
                trait6Lvl: _6thType[1],
                trait7Lvl: _7thType[1]
            });
    ...
    function _mergeWjoker(uint256 _1st, uint256 _2nd, uint256 _3rd, address merger) internal {
        ...
        uint8 JokerLvl = joker_level(_1st);

        if (JokerLvl == alligator_level(_2nd)[0] && JokerLvl == alligator_level(_3rd)[0]) {
            if (alligator_level(_2nd)[0] < 5) {
            _1stType[1]++;
            levelUp = lvlUp.TRUE;
            }
        }
        
        if (JokerLvl == alligator_level(_2nd)[1] && JokerLvl == alligator_level(_3rd)[1]) {
            if (alligator_level(_2nd)[1] < 5) {
                _2ndType[1]++;
                levelUp = lvlUp.TRUE;
            }
        }
        
        if (JokerLvl == alligator_level(_2nd)[2] && JokerLvl == alligator_level(_3rd)[2]) {
            if (alligator_level(_2nd)[2] < 5) {
                _3rdType[1]++;
                levelUp = lvlUp.TRUE;
            }
        }
        
        if (JokerLvl == alligator_level(_2nd)[3] && JokerLvl == alligator_level(_3rd)[3]) {
            if (alligator_level(_2nd)[3] < 5) {
                _4thType[1]++;
                levelUp = lvlUp.TRUE;
            }
        }
        
        if (JokerLvl == alligator_level(_2nd)[4] && JokerLvl == alligator_level(_3rd)[4]) {
            if (alligator_level(_2nd)[4] < 5) {
                _5thType[1]++;
                levelUp = lvlUp.TRUE;
            }
        }
        
        if (JokerLvl == alligator_level(_2nd)[5] && JokerLvl == alligator_level(_3rd)[5]) {
            if (Alligators.alligator_level(_2nd)[5] < 5) {
                _6thType[1]++;
                levelUp = lvlUp.TRUE;
            }
        }
        
        if (JokerLvl == alligator_level(_2nd)[6] && JokerLvl == alligator_level(_3rd)[6]) {
            if (alligator_level(_2nd)[6] < 5) {
                _7thType[1]++;
                levelUp = lvlUp.TRUE;
            }
        }

        if (levelUp != lvlUp.TRUE) revert callErr();
        _anatomy[_currentIndex] = NFT_Anatomy(
            {
                trait1: Trait1(_1stType[0]), 
                trait2: Trait2(_2ndType[0]),
    ...
    function anatomy(
        uint256 _tokenId
    ) internal returns (uint8[7] memory _traits) {
