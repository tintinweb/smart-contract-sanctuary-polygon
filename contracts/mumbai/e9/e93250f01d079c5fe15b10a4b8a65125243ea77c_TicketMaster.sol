...
// File contracts/utils/TicketERC721.sol
...
// File contracts/utils/TicketMetadata.sol
...
// File contracts/utils/TicketMasterStorage.sol
...
// File contracts/TicketMaster.sol
...
contract TicketMaster is Ticket, TicketMasterStorage {
    ...
    function buyTicket(
        ...
        emit Bought(buyTicketId, msg.sender, mintedToken);
    }
        ...
        for(uint256 i=0; i < ticketIds.length; i++) {
            if(refundTicketFeesStatus[eventTokenId][ticketIds[i]] == false) {
                if(ownerAddress == Ticket(ticketNFTAddress[eventTokenId]).ownerOf(ticketIds[i])) {
                    ...
                    emit RefundClaimed(eventTokenId, ticketIds[i]);
                }
            }
        }
