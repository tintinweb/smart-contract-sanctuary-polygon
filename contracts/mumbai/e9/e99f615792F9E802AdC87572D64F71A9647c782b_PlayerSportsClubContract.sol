...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address public erc20Payable = 0xF03B6901737cCa8A7f521CC602EaeF87b720F8C3;
...
abstract contract Feeable is Teams {
  uint256 public PRICE = 1750 ether;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 9519) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmWha1PCpwDjTjoK57Cqg3tuGy4T2ck1d237Z39Psvk7Nz/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 9519");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 9519");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 9519");
...
// File: contracts/PlayerSportsClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PlayerSportsClubContract is RamppERC721A {
    constructor() RamppERC721A("Player Sports Club", "PSC"){}
}
