...
contract Launchpad is Ownable { 
    ...
    event BatchLaunch(uint256[] eventId);
    ...
    mapping(uint256 => uint256[]) private nftCollectionsPerProject;
    ...
    function batchLaunchEvent(
        ...
        uint[] memory eventIds = new uint[](stock.length);
    ...
    function deleteEvent(
        ...
        require(
            eventDescription[eventId].sold == 0,
            "Already the NFTs are sold"
        );
    ...
    function buyTokens(uint256 eventId, uint256 amountBought) external {
        ...
        require(project.projectOwner != address(0), "Invalid Id");
    ...
    */
    ...
    function eventsPerProject(uint256 projectId) external view returns(uint256[] memory) {
        return nftCollectionsPerProject[projectId];
    }
}
