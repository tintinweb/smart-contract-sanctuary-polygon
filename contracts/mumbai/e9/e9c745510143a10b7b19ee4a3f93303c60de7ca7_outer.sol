...
contract outer is AccessControl, DateUtil, ReentrancyGuard {
    ...
    function mintX(MetaData memory data) external {
        ...
        IRunbitCard.MetaData memory m =  IRunbitCard.MetaData(80,20,300,150,2);
        string memory uri = "https://xxx.com/pict/100004-mintX.png";

        emit NFTCardMint(msg.sender, 100004, 2, uri, m);
    }

    function mintY(IRunbitCard.MetaData memory meta) external {
        IRunbitCard.MetaData memory m =  meta;
