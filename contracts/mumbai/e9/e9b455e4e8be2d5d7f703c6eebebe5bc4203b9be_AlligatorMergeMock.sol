...
contract AlligatorMerge is Ownable, VRFConsumerBaseV2, IMergeGators {
    ...
    function merge(uint256 _1st, uint256 _2nd, uint256 _3rd) public payable {
        ...
        if (IAlligators(alligatorsAddress).tokenType(_1st) == 3 
            || IAlligators(alligatorsAddress).tokenType(_2nd) == 3 
            || IAlligators(alligatorsAddress).tokenType(_3rd) == 3) revert Mergefailed();
        ...
        address(alligatorsAddress).call(abi.encodeWithSignature("createSkeleton(uint8, uint8, uint8, uint8, uint8, uint8, uint8)",
            _1stType[0],
            _2ndType[0],
            _3rdType[0],
            _4thType[0],
        ...
        address(alligatorsAddress).call(abi.encodeWithSignature("createLevels(uint8, uint8, uint8, uint8, uint8, uint8, uint8)",
            _1stType[1],
            _2ndType[1],
            _3rdType[1],
            _4thType[1],
        ...
        address(alligatorsAddress).call(abi.encodeWithSignature("merge(uint256, uint256, uint256, address)", _1st, _2nd, _3rd, msg.sender));
...
contract AlligatorMergeMock is AlligatorMerge {
    ...
    //11
    address constant collection = 0xd8280211558a4Af8c1063c552aA81D0Bd7E60716;
