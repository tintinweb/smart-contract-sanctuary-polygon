...
contract AvatarsNFTFactory is AccessControl {
    ...
    function createNFT(
        ...
        nftContract = new AvatarsNFT(_name, _symbol,
            __baseURI, tokensAmount, _to, _trustedForwarder);
    ...
    function revokeRole(bytes32 role, address account) public virtual override onlyRole(getRoleAdmin(role)) {
        require(account != _msgSender(), "AccessControl: can only revoke not self");
        super.revokeRole(role, account);
    }

    function renounceRole(bytes32 /* role */, address /* account */) public virtual override {
        require(0 == 1, "AccessControl: role renouncing is disabled");
    }
