...
interface ISaleRound {
    ...
    */
     ...
     */
    function swap(uint256 usdAmount, uint256 factor) external view returns (uint256 MGBamount);
 ...
 */
contract ReferralSystem is Whitelist, ReentrancyGuard {
    using SafeERC20 for IERC20;
     ...
     */
    function sendMATIC(address account, uint256 value) internal nonReentrant {
...
contract Whitelist {
     ...
     */
    function _setWhiteList(address[] memory account, bool[] memory status)
        internal
    {
