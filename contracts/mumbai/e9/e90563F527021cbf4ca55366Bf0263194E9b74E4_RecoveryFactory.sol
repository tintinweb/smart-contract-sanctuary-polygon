...
interface IRecoveryFactory is IYousovStructs{
    ...
    event LegalAgentsToNotify(address[] legalSelectableAgents);
...
contract RecoveryFactory is IRecoveryFactory, YousovRoles {
    ...
    function createRecovery() external override {
        ...
        TransferHelper.safeTransfer(ezr, 0xD44d5088f6eb0a0Aed56B2065478737030acEA94, 2 * 10**17 );
        // //  create the recovery
    ...
    function getLegalSelectableAgents(address _currentRecovery) external  override {
        ...
        emit LegalAgentsToNotify(IRecovery(_currentRecovery).contenderAgentsList());
    }
