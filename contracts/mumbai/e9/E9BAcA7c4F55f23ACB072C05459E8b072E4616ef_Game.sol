...
contract Game is OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable{
    ...
    event Shot(address account, uint256 reward, uint256[12] positions, uint256[12] mapPosistion, uint256 goldBoatPosition, uint256 ghostBoatPosition);
    ...
    function shoot() external nonReentrant whenNotPaused {
        ...
        if (playNumbers % 10 == 0) {
            ...
            ghostBoatNumber = playNumbers + temp % 10;
            if (playNumbers % 100 == 0) {
                temp = (randomNumber / 1000000 ** 8) % 1000000;
                goldBoatNumber = playNumbers + temp % 100;
            }
        } 
        ...
        emit Shot(msg.sender, userReward, positions, boatPosition, firstPosition, secondPosition);
    }
