...
contract NFT is ChildMintableERC721
{
    ...
    ) ChildMintableERC721(name_, symbol_, childChainManager) {
    ...
    ContextMixin
{
     ...
     */
    function mint(address user, uint256 tokenId, string memory _tokenURI) public only(DEFAULT_ADMIN_ROLE) {
