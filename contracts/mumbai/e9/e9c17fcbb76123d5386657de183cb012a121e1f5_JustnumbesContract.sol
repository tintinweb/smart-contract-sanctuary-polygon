...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xa0165b48e35c707cf2eA60e7f5307fd5Ee4CbF35];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 2, 9 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmXfTWUHXSLwDhVMvjUdSgCuiD7gX4o1o29X8kZpgZp1MD/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 9");
        _safeMint(_to, 1);
    }
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 9");
...
// File: contracts/JustnumbesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract JustnumbesContract is RamppERC721A {
    constructor() RamppERC721A("Just numbes", "jsnt"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/KNYAF0pUshYccd4GYIGb/contract-metadata";
    }
}
