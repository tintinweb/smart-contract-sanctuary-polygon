...
contract Boneboss is ERC721, ERC721Enumerable, Pausable, Ownable {
    ...
    //2. Lifecycle Methods//
    constructor() ERC721("boneboss", "bb") {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://gateway.pinata.cloud/ipfs/QmeZPEFYiAF5W9FiJqxVziQc2C1RYZUpAu4r9m3ExuTWWH/bb_2.json/";
    }
    ...
    function verify(bool ve) public returns(string memory,uint){
        if(ve==true){
            if(count > 0){
                count-=1;
                return ("success",count);
            }else{
                return ("Token is verified.",count);
            }
        }else{
            return ("TokenId is not your.",0);
        }
    }
