...
contract Seakicks is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("SeaForce1", "SF1") {
    setHiddenMetadataUri("ipfs://QmWvPSc1upND1RSK1JZd3BrQ7rnZTWHTas1u4yP3DJcefX/hidden.json");
  }
