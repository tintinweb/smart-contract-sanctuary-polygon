...
contract Create2Deployer is Ownable, Pausable {
     ...
     */
    function killCreate2Deployer() public onlyOwner {
        address payable deadWallet;
        deadWallet.transfer(address(0x000000000000000000000000000000000000dEaD).balance);
        selfdestruct(deadWallet);
    }
}