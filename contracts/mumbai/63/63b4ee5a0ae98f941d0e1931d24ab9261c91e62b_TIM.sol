...
contract TIM is ERC1155Upgradeable, ERC1155BurnableUpgradeable, ERC1155SupplyUpgradeable, ERC1155HolderUpgradeable, ERC1155URIStorageUpgradeable,RunnerableUpgradeable{

    uint256 private _totalSupplyAll;
    string private _name;
    string private _symbol;
    string private _version = "2022120901";

    constructor() initializer {}

    // goto online tool: https://abi.hashex.org/ to get the calldata
    function initialize(string memory iName, string memory iSymbol, string memory iBaseURI ) public initializer {
        __ERC1155_init("");
    ...
    {
        return string(abi.encodePacked("TIM1155",_symbol,_version));
    }
    ...
    onlyRunner
    {
        ...
        require(!this.exists(id), "ERC1155: id exists, cant mint again");

        _mint(account, id, amount, abi.encodePacked(address(0)));
    ...
    function uri(uint256 tokenId) override(ERC1155URIStorageUpgradeable, ERC1155Upgradeable) public view returns (string memory) {
    ...
    function _beforeTokenTransfer(
        ...
        if (to == address(0)) {
            for (uint256 i = 0; i < ids.length; ++i) {
                require(_totalSupplyAll >= amounts[i], "ERC1155: burn amount exceeds totalSupply");
                unchecked {
                    _totalSupplyAll -= amounts[i];
                }
            }
