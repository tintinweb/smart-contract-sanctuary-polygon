...
contract P00lsTokenCreator_Polygon is P00lsTokenBase, RegistryOwnable
{
    ...
    address public immutable fxManager;
    address public connectedToken;

    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor(address registry, address _fxManager)
    ...
    function initialize(string calldata name, string calldata symbol, address parent, address child)
        external
        initializer()
    {
        ...
        connectedToken = parent;
    }

    function mint(address user, uint256 amount) external {
        require(msg.sender == fxManager);
        _mint(user, amount);
    }
