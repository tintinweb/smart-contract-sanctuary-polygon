...
contract LaunchPad is ERC1155Holder {
    ...
    function listing() external verifyTimeClaim(){
        ...
        TransferHelper.safeTransferFrom(LaunchPadInfo.tokenPayment, msg.sender, router, tokenAddLiquidity);
        TransferHelper.safeTransferFromNFT(NFT, msg.sender, router, LaunchPadInfo.id, totalNFTAddLiquidity, bytes(''));
