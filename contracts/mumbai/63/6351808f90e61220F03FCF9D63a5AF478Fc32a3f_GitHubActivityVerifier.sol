...
contract GitHubActivityVerifier is Verifier, ChainlinkClient {
    ...
    event UpdatedVerifyResult(bytes32 indexed requestId, bool verifyResult);
    ...
    function verify(uint256 goalTokenId) public override {
        ...
        req.add(
            "get",
            "https://web3goals.space/api/checker/github/activity/kiv1n/10"
        );
    ...
    function fulfill(
        ...
        emit UpdatedVerifyResult(_requestId, _verifyResult);
