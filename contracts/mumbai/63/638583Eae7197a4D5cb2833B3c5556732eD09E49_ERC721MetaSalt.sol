...
contract ERC721MetaSalt is ERC721Base {
    ...
    function __ERC721MetaSalt_init(string memory _name, string memory _symbol, string memory baseURI) external initializer {
        __ERC721MetaSalt_init_unchained(_name, _symbol, baseURI);
        emit CreateERC721MetaSalt(_msgSender(), _name, _symbol);
    }

    function __ERC721MetaSalt_init_unchained(string memory _name, string memory _symbol, string memory baseURI) internal {
        _setBaseURI(baseURI);
...
library LibERC721LazyMint {
    ...
    bytes32 public constant MINT_AND_TRANSFER_TYPEHASH = keccak256("Mint721(uint256 tokenId,string tokenURI,address creator)");
...
abstract contract ERC721Lazy is IERC721LazyMint, ERC721Upgradeable, Mint721Validator {
...
abstract contract ERC721Base is OwnableUpgradeable, ERC721DefaultApproval, ERC721BurnableUpgradeable, ERC721Lazy {
