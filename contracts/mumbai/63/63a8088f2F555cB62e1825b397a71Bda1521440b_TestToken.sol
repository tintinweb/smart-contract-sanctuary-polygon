...
contract TestToken is ITestToken, IERC2981, Ownable {
    // ======== Supply =========
    ...
    // ======== Constructor =========
    constructor(address metadataAddress) ERC721A("TOKEN", "TK") {
        metadata = ITestMetadata(metadataAddress);
        royaltyAddress = owner();
        royaltyPercent = 5;
    }

    // ======== Minting =========
    function mint(address _recipient, uint256 _count)
        public
        override
        onlyMinter
    {
    ...
    function updateMetadata(address _metadata) external onlyOwner {
        ...
        metadata = ITestMetadata(_metadata);
    }
