...
// File: ReliefDAONFT.sol

/**
 * @title Relief DAO NFT
 * Contains common implementations for interface functions.
 */
abstract contract ReliefDAONFT is ViciERC721v4, Named, INominator {
    ...
    /**
     * @dev returns whether this token has nominated a coffee shop.
    ...
    /**
     * @dev sets whether this token has nominated a coffee shop.
     */
...
// File: TestReliefNFT.sol

/**
 * @title Test Relief NFT
 */
contract TestReliefNFT is ReliefDAONFT {
    constructor() ViciERC721v4("Test Relief DAO", "tRD", 1000000) {}
}