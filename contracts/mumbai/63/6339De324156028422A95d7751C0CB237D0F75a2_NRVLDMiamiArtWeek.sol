...
contract NRVLDMiamiArtWeek is NRVLDTokenFactory, ReentrancyGuard{
    ...
    constructor(address _admin, string memory _firstTokenURI, uint256 _firstTokenMaxSupply) ERC1155("https://gateway.pinata.cloud/ipfs/QmT3keXbZuwLNUhiXhLGk4UL2mQrFQXF5vXDTJrTsShQbo/"){
        name_="NRVLD Miami Art Week";
        symbol_ = "UMAW";
        mtCounter.increment();
...
abstract contract NRVLDTokenFactory is ERC1155Supply, ERC1155Burnable, AdminPermissionable {
