...
contract Octopuses is IERC20, Auth {
    ...
    uint256 private constant _totalSupply = 300 * (10**_decimals);
    ...
    address payable private _walletMarketing = payable(0x6D996edc7C23f814f5f469d60bAfddeAc7b5973C); 
    address payable private _walletDevelopment = payable(0x6D996edc7C23f814f5f469d60bAfddeAc7b5973C); 
