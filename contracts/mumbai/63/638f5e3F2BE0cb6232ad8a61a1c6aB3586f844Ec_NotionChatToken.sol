...
* 
* Smart contract to grant access to notion chat with the condition that they have to pay a minimum of $0.01 to mint the NFT. 
* Used thirdweb contractKit and deploy tool. Real time price conversion provided by Chainlink Data Feeds.
*/
pragma solidity ^0.8.0;
...
contract NotionChatToken is ERC721Base {
    ...
    // Minimum price for NFT access in MATIC
    ...
    *  _royaltyRecipient (address) who will get a royalty on secondary sale, _royaltyBps (royalty percentage)
    * we don't need to set Royalty for the purpose of our smart contract. setting _royaltyBps to Zero
    ...
    */
    function createToken() public payable {
        ...
        string memory tokenURI = "https://gateway.pinata.cloud/ipfs/QmZda6FPLNdDz8UCdpvF986m1MoNHCpjEczPZfKMdJsjno";
...
/**
 * @author Andrae Aldrete  Github:Onn_drE   Twitter:Onn_drE
 * Contract to get the current price of MATIC / USD using Chainlink Data feeds.
 */
