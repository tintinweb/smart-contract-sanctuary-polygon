...
contract MysticGalacticMission1 is ERC721, Ownable, Pausable, AccessControl, ReentrancyGuard {
    ...
    struct Handlers {
        address priceHandlerAddr;
        address refundHandlerAddr;
        address missionEventsHandlerAddr;
    }
     ...
     * @param _missionEventsHandlerAddr The mission events handler
     */
     ...
     * @return mintResult An array of newly minted tokens.
     *
     ...
     */
    function mintNFT(uint16 bottles) public payable nonReentrant whenNotPaused returns (TokenMintResult[] memory) {
        ...
        TokenMintResult[] memory mintResults = new TokenMintResult[](bottles);
        ...
        for (uint256 i = 0; i < bottles; i++) {
            ...
            mintResults[i] = TokenMintResult(tokenId, tokenURI(tokenId));
        }
...
//    event TokensMinted(address indexed to, uint256 paymentReceived, uint256 tokenId, TokenMintResult[] tokensMinited);
