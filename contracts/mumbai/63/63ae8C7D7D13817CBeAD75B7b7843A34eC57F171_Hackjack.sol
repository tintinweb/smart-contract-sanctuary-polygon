...
contract Hackjack is VRFConsumerBaseV2, BreakdownUint256, Destructible, RequestQueue {
    ...
    function requestNewDeal(uint256 _handId) internal {
        ...
        sendRandomRequest(true,false,_handId);
        sendRandomRequest(true,false,_handId);
        
        // Deal 1 card to dealer
        sendRandomRequest(false,true,_handId);
    }


    function sendRandomRequest(bool isPlayer,bool isDealer,uint _handId) public {
        ...
        requestInfo memory newRequest = requestInfo(false, isPlayer,isDealer,0,_handId,requestIndex);
    ...
    function fulfillRandomRequest(
        ...
        uint8 randomWord
            ...
            // Dispatch Request to the right game and player
            if (requestIndexToRequestInfo[requestIndex].isPlayer) {
    ...
    uint256 public minBet = 0.00000000000001  ether;
