...
contract Stampit_v0 {
    ...
    event NewStampCreated(
        uint256 indexed stampIndex,
        string fileHash,
        string metaHash
    );
    ...
    function newStamp(string memory file_hash, string memory meta_hash) public {
        require(
            owner == msg.sender,
            "Only the contract owner can create stamps"
        );
