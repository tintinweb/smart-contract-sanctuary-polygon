...
contract VVSErc1155Factory is IVVSErc1155Factory, IVVSErc1155FactoryInitializer, OwnableUpgradeable {
  ...
  function createCollection(
    ...
    uint256 nonce,
    address newOwner
  ) public onlyOwner returns (address collectionAddress) {
    ...
    // transfer Ownership
    IVVSErc1155Update(collectionAddress).transferOwner(newOwner);

    emit CollectionCreated(collectionAddress, newOwner, version, name, symbol, nonce);
  }
