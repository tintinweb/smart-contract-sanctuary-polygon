...
/** 
 *  SourceUnit: /home/talha/Navigate Contracts/contracts/pools/FixPrice.sol
*/
...
contract FixPrice is OwnableUpgradeable {
    ...
    function setNVG8Factory(address _nvg8_factory) public onlyOwner {
        nvg8_factory = _nvg8_factory;
    }

    function setNVG8Token(address _nvg8_token) public onlyOwner {
