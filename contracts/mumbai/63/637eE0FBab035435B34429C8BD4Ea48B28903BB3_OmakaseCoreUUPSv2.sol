...
contract DataFacetv2 is InheritedStorage {
    using LibProduct for Product;
    using LibFlight for Flight;
    ...
    /**
     * @notice testing AppStorage admin contents
     */

    function getAdminFromDataFacetAppStorage() external view returns (address) {
        return s.admin;
    }

    /**
     * @notice testing storage persistence by changing claimExpireTime
     */

    function getClaimExpireTime() external view returns (uint64) {
