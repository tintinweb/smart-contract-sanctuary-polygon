...
// File: contracts/presets/ERC20Preset.sol
    ...
    ERC20PausableUpgradeable
{
    ...
    /**
     * @dev Grants `DEFAULT_ADMIN_ROLE`, `MINTER_ROLE`, `PAUSER_ROLE`, and `BLACKLIST_ROLE` to the
