...
contract DPSShipyard is Ownable, ReentrancyGuard {
    ...
    mapping(DPSFlagshipI => bool) public flagshipsAllowedForUpgrade;
    ...
    function upgradeFlagship(
        ...
        if (!flagshipsAllowedForUpgrade[_flagship]) revert Unauthorized();
    ...
    function setContract(
        ...
        else if (_target == 8) flagshipsAllowedForUpgrade[DPSFlagshipI(_contract)] = _enabled;
