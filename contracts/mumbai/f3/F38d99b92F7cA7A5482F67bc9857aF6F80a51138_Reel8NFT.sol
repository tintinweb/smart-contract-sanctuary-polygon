...
contract Reel8NFT is Ownable, ERC721 {
    ...
    constructor(string memory _publicBaseURI) ERC721("Reel8NFT", "R8NFT") {
     ...
     */
    function mint(address walletAddress, uint256 tokenQuantity)
        external
        onlyOwner
    {
        for (uint256 i = 0; i < tokenQuantity; i++) {
            ...
            lastTokenId++;
            emit PublicSale(tokenId, walletAddress);
        }
    }
