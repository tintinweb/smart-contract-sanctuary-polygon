...
contract ChainBattles is ERC721URIStorage {
    ...
    function getLevels(uint256 tokenId) public view returns (string memory) {
        ...
        return string(
            abi.encodePacked(
            '<tspan x="0" y="20%">Level: ', attributes.level.toString(), "</tspan>",
            '<tspan x="0" y="40%">Speed: ', attributes.speed.toString(), "</tspan>",
            '<tspan x="0" y="60%">Strength: ', attributes.strength.toString(), "</tspan>",
            '<tspan x="0" y="80%">Life: ', attributes.life.toString(), "</tspan>"
        ));
    }
