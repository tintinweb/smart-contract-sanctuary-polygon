...
import "../Interface/IImplementationSpecificReferralManager.sol";
...
contract ERC20Factory is OwnableUpgradeable, CloneBase {
    ...
    function _launchERC20(uint256 _id, bytes memory _implementationData)
        internal
        returns (address)
    {
    ...
    function launchERC20(
        ...
        address erc20Adddress = _launchERC20(_id, _implementationData);
        _handleFeeManager(_id, _feeManagerEncodedData);
        return erc20Adddress;
    }

    function launchERC20WithReferral(
        uint256 _id,
        address referrer,
        bytes memory _implementationData,
        bytes memory _feeManagerEncodedData,
        ...
        _handleReferral(referrer, feeAmount, _id, _referralEncodedData);
        return erc20Adddress;
    }
