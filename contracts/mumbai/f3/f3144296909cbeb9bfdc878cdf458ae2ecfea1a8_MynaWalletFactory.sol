...
// File contracts/RSAVerifier.sol
...
// File contracts/EIP712RSA.sol

pragma solidity ^0.8.0;

abstract contract EIP712RSA {
     ...
     * @dev Inspired from
     */
    function getTypedData(bytes32 structHash)
        internal
        view
        virtual
        returns (bytes memory)
    {
        return abi.encodePacked("\x19\x01", _domainSeparatorV4(), structHash);
    }
}
...
// File contracts/MynaWalletFactory.sol
