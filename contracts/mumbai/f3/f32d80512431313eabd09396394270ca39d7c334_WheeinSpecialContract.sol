...
// File: contract/9_WheeinSpecialContract.sol
...
contract WheeinSpecialContract is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, ERC2981, Pausable, Ownable {
    ...
    constructor() ERC721("WHEE IN Special NFT", "WISN") {
    ...
    function mintForAddress(address _receiver, uint256 _mintAmount) public mintCompliance(_mintAmount) onlyOwner {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721, ERC2981, ERC721Enumerable)
        returns (bool) {
