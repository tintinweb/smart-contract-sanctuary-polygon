...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0xc3e273eA4eE84db3B7286Df7ed6e8e2e2Ee5CFD1];
  address public erc20Payable = 0xc3e273eA4eE84db3B7286Df7ed6e8e2e2Ee5CFD1;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeignaq6kgawyqsedvfc7vkbnbvmytxyupse3c5h2nt3dbmceko7gsy/";
...
// File: contracts/PandaXContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PandaXContract is RamppERC721A {
    constructor() RamppERC721A("Panda X", "PNDX"){}
}
