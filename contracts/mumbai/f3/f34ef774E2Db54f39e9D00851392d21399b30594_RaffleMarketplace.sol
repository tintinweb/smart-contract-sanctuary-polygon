...
contract RaffleMarketplace is Ownable, VRFV2SubscriptionManager,RaffleRegisterUpkeep {
    ...
    struct Raffle {
        ...
        uint256 raffleEndTime; // how long will the raffle go on once starts
...
contract RaffleContract is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    */
        ...
        )
    {
        ...
        //TODO: threshold is in percent so this doesnt work now!
...
//     function _shuffle() public returns(Players[] memory) {
//     for (uint256 i = 0; i < totalTickets(); i++) {
//         uint256 n = uint256(keccak256(abi.encodePacked(block.timestamp))) % (totalTickets() - i) + i;
