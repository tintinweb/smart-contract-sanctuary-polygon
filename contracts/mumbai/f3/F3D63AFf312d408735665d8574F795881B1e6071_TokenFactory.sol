...
contract TokenFactory {
    ...
    constructor(address _codeAddress1) {
        codeAddress = _codeAddress1;
    }
...
contract TokenERC20 is ERC20Upgradeable {
    ...
    function initialize(string memory name, string memory symbol1) public initializer {
        __ERC20_init(name, symbol1);
    }
