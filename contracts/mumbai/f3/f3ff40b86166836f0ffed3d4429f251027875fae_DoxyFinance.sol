...
contract DoxyFinance is  ERC20 , Ownable { 
    ...
    address constant USDC = 0xc2132D05D31c914a87C6611C10748AEb04B58e8F; 

    address public strategicSalesWallet = payable(0xEed053faa4Ca68080214C39dD865f061778b2DA8);
    ...
    constructor() ERC20("Doxy Finance ", "DOXY") { 
        ...
        kinjaBUSDPair = IFactory(kinjaRouter.factory()).createPair(address(this),USDC);          
    }   
