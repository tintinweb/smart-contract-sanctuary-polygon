...
contract VrfMint is ERC721URIStorage, VRFConsumerBaseV2, Ownable,ChainlinkClient {
    ...
    event RequestAmount(bytes32 indexed requestId, uint256 volume);
    event RequestUrl(string url);
    ...
    function _mint(uint32 _amount) private returns (uint256 requestId) {
