...
contract Dessay is DessayToken {
    ...
    function Init() public {
        ...
        enterWriting("Dessay", "QmQshMAM7cLabiXYNga6jjFELiUQACw6kstTfL4jJVjbb3",TopicInput ,15, 50, "Yeni Nesil", "Nitelikli Bilgi icin", "Sosyal Medya");
        enterWriting("Dessay", "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam neque ex, scelerisque nec elit id, tempor malesuada lectus. Nam sed porttitor lectus. Aenean lobortis neque eget ex aliquet consectetur. Sed tincidunt erat libero, vitae hendrerit diam ultrices et. Curabitur posuere quam eros, sed dignissim mi condimentum a. Fusce ac dui erat.",TopicInput ,15, 50, "Yeni Nesil", "Nitelikli Bilgi icin", "Sosyal Medya");
        enterWriting("Dessay", "QmQshMAM7cLabiXYNga6jjFELiUQACw6kstTfL4jJVjbb3",TopicInput ,15, 50, "Yeni Nesil", "Nitelikli Bilgi icin", "Sosyal Medya");
        enterWriting("Dessay", "QmQshMAM7cLabiXYNga6jjFELiUQACw6kstTfL4jJVjbb3",TopicInput ,15, 50, "Yeni Nesil", "Nitelikli Bilgi icin", "Sosyal Medya");
