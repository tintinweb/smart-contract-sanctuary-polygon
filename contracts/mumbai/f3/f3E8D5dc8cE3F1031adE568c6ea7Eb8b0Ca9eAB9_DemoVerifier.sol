...
import "./interfaces/IDemoVerifier.sol";
import "./interfaces/IDemoSBT.sol";

contract DemoVerifier is IDemoVerifier, ZKPVerifier {
    uint256 public constant AGE_VERIFY_REQUEST_ID = 1;

    IDemoSBT public override sbtContract;
    ...
    function setSBTContract(address sbtContract_) external override onlyOwner {
        sbtContract = IDemoSBT(sbtContract_);
    }
...
interface IDemoVerifier {
    ...
    function sbtContract() external view returns (IDemoSBT);
