...
interface IERC1155ManagedSupply {
  ...
  function mint(address account, uint256 id, uint256 value, string memory hash) external;
  function mintBatch(address account, uint256[] memory ids, uint256[] memory values, string[] memory hashes) external;
