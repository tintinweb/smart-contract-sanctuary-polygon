...
contract SeeDAO is ERC1155, Ownable{
    ...
    mapping (uint256 => string) public tokenIDSymbol;
    ...
    //铸造新 ID NFT
    function ownerMint(string memory _name,string memory  _symbol,uint256 _tokenID,uint256 _amount,uint256 _totalSupply) public onlyOwner { 
        require( _totalSupply >= _amount,"Sorry,the number of totalAmount should higher than the amount!");
        
        _mint(msg.sender, _tokenID, _amount, "");
        tokenIDName[_tokenID] = _name;
        tokenIDSymbol[_tokenID] = _symbol;
