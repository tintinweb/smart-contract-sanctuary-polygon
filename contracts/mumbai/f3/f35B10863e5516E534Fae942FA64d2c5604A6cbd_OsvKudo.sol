...
contract OsvKudo is Initializable, ERC20Upgradeable, AccessControlUpgradeable, DateTime {
    ...
    mapping(address => uint256) public lastClaimed; // TODO: this is not used, remove
    ...
    function setFixClaimAmount(uint256 newFixClaimAmount) public onlyRole(TREASURY_ROLE) {
        fixClaimAmount = newFixClaimAmount;
    }

    function setInstantGratificationAmount(uint256 newInstantGratificationAmount) public onlyRole(TREASURY_ROLE) {
        instantGratificationAmount = newInstantGratificationAmount;
    }

    function setMonthlyIntantGratificationCapAmount(uint256 newMonthlyIntantGratificationCapAmount)
        public
...
contract OsvKudoExchange is Initializable, AccessControlUpgradeable {
    using SafeERC20 for IERC20;

    bytes32 public constant ACCOUNTANT_ROLE = keccak256("ACCOUNTANT_ROLE");

    IERC20 public osvKudo;
    bool public isEnabled;

    mapping(address => uint256) public exchangeForCSARequested;
    mapping(address => uint256) public exchangedForCSAApproved;

    // TODO: add something to track totals for requested and approved
    ...
    function initialize(address osvKudoTokenAddress) public initializer {
        ...
        osvKudo = IERC20(osvKudoTokenAddress);
        isEnabled = false;
    }

    function setIsEnabled(bool enabledStatus) public onlyRole(ACCOUNTANT_ROLE) {
    ...
    function approveExchangeForCSA(address userToBeApproved, uint256 amount) public onlyRole(ACCOUNTANT_ROLE) {
        require(
