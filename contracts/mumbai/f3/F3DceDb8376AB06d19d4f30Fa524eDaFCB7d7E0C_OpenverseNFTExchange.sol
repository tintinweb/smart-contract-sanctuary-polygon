...
contract OpenverseNFTExchange is IOpenverseNFTExchange, ReentrancyGuard, Ownable {
    ...
    event CancelAllOrders(address indexed user, uint256 oldMinNonce, uint256 newMinNonce);
    ...
    function cancelAllOrdersForSender(uint256 minNonce) external {
        ...
        uint256 oldMinNonce = userMinOrderNonce[msg.sender];
        userMinOrderNonce[msg.sender] = minNonce;

        emit CancelAllOrders(msg.sender, oldMinNonce, minNonce);
    }
