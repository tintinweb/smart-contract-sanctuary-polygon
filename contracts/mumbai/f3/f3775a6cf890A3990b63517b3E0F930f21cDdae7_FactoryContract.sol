    ...
    AccessControlUpgradeable
{
    ...
    modifier notBlacklisted(address _tokenAddress, address _userAddress) {
        require(
            !_blacklisted[_tokenAddress][_userAddress],
            "FC: Account blacklisted"
        );
        _;
    }
    ...
    */
    ...
    function addAdminRole(address _address) public onlyDefaultAdmin {
    ...
    */
    ...
    function addCFORole(address _address) public onlyDefaultAdmin {
     ...
     * @notice This function can only be called by the owner of the contract.
     */
    function revokeAdminRole(address _address) external onlyDefaultAdmin {
     ...
     * @notice This function can only be called by the owner of the contract.
     */
    function revokeCFORole(address _address) external onlyDefaultAdmin {
        require(isCFO(_address), "FC:Admin Role Doesn't Exist ");
        revokeRole(CFO_ROLE, _address);
    }
    ...
    function tokenMint(
        ...
        notBlacklisted(_tokenAddress, _to)
    {
    ...
    function tokenBurn(
        ...
        amountGreaterThanZero(_amount)
        notZeroAddress(_userAddress)
        notBlacklisted(_tokenAddress, _userAddress)
    {
    ...
    function addBlackList(
        ...
        notZeroAddress(_userAddress)
    {
        _blacklisted[_tokenAddress][_userAddress] = _status;
        emit AddressBlackListed(_tokenAddress, _userAddress, _status);
    }
     ...
     *  a freezeTokens
     *  @param _tokenAddress The address of the token contract.
     *  @param _userAddress the address of the wallet on which isBlacklisted is called
     */
    ...
    function isBlacklisted(
        ...
        returns (bool)
    {
        return _blacklisted[_tokenAddress][_userAddress];
    }
        ...
        notZeroAddress(_userAddress)
    {
        ...
        emit TokensFrozen(_tokenAddress, _userAddress, _amount);
    }
        ...
        notBlacklisted(_tokenAddress, _userAddress)
    {
        ...
        emit TokensUnfrozen(_tokenAddress, _userAddress, _amount);
    }
