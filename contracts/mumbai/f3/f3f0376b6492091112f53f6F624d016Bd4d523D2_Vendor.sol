...
// MWP per MATIC dependendo do bacth
    ...
    //Value in Dolar for 1 Matic
        int256 dolWei = getPriceMaticperDolar();
       // int256 dolWei = dol *10**18;
        if(batch == WL){
           return (PriceWL*10**18)/dolWei;
            //return dolWei;
        }
        else if(batch == BATCH2){
        return (PriceBatch2*10**18)/dolWei;
        //return dolWei;
        }
        else if(batch == BATCH3){
            return (PriceBatch3*10**18)/dolWei;
           //return dolWei;
        }
        else{
            return (PricePO*10**18)/dolWei;
            //return dolWei;
        }
    }
