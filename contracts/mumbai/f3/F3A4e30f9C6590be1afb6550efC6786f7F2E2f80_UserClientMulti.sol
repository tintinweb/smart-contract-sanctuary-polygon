...
contract UserClientMulti is SxTClient {
    ...
    function executeViewUint(string memory viewName, string memory biscuitId)
        external
    {
    ...
    function executeViewBytes(string memory viewName, string memory biscuitId)
        external
    {
        currentRequestId = _executeView(
            viewName,
            biscuitId,
            this.saveBytesResponse.selector
        );
    }
