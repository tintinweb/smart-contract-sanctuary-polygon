...
contract FmBtcNft is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  // Paper.xyz 
  // function mintTo(address _receiver, uint256 _mintAmount) public payable returns (uint256) {
  //     uint256 tokenId = currentTokenId.current();
  //     require(tokenId + quantity <= maxSupply, "Max supply reached");
  ...
  function mintTo(uint256 _mintAmount, address _receiver) public mintCompliance(_mintAmount) {
    _safeMint(_receiver, _mintAmount);
  }
