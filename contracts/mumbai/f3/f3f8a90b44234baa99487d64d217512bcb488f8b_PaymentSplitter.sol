...
// File: contracts/BoleroPaymentSplitter.sol
...
contract PaymentSplitter {
    ...
    event PayeeShareUpdated(address account, uint256 newShares, uint256 oldShares);
	...
	/*******************************************************************************
	**	@notice Init a new PaymentSplitter contract with the needed information.
	...
	*******************************************************************************/
    constructor(address _bolero, address[] memory payees, uint256[] memory shares) {
    ...
    *******************************************************************************/
    function _releaseToken(address _want, address _account) internal {
        ...
        uint256 payment = (totalReceived * _shares[_account]) / _totalShares - _released[_want][_account];
    ...
    *******************************************************************************/
    function migratePayee(address oldPayee, address newPayee) external onlyManagement() {
        require(oldPayee != address(0), "PaymentSplitter: account is the zero address");
        require(newPayee != address(0), "PaymentSplitter: account is the zero address");
    ...
    *******************************************************************************/
    ...
    function addPayee(address account, uint256 shares) public onlyManagement() {
    ...
    *******************************************************************************/
    function updatePayeeShares(address account, uint256 newShares) public onlyManagement() {
        require(account != address(0), "PaymentSplitter: account is the zero address");
