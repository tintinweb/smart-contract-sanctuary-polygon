...
contract project_dNFT is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
    uint256 public MAX_SUPPLY = 30;

    
    uint256 public PHASE1_SUPPLY = 29;
    
    bool public IS_PHASE1_ACTIVE = false;

    
    uint256 public PHASE1_TX_LIMIT = 10;

    
    uint256 public PHASE1_WALLET_LIMIT = 10;

    
    uint256 public PHASE1_PRICE = 0.000001 ether;
    ...
    string private preRevealURI = "https://ipfs.w3bmint.xyz/ipfs/QmNrn3nno1PrjMmewsxHZN5H1VLSJYZeW2AVKiEaqDSTXz";
    ...
    constructor() ERC721A("project_dNFT", "MOIST") {
