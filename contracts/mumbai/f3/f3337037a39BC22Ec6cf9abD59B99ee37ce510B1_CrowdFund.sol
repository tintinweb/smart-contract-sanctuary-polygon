...
contract CrowdFund is ERC20, Ownable {
    ...
    constructor(string memory _name, string memory _symbol, uint _goal, uint _pledged, uint _startAt, uint _endAt ) ERC20 (_name,_symbol) {
        
         campaignData.creator= msg.sender;
         campaignData.goal=_goal;
         campaignData.pledged=_pledged ;
    ...
    function launch() public onlyOwner {
        ...
        require(today>campaignData.startAt && today<campaignData.endAt, "Project will launch within stablished time");
        launched = true;
