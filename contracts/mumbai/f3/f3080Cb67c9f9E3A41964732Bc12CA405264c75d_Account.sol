...
contract Account is Ownable {
    ...
    constructor(address _utilityTokenAddress, address _governanceTokenAddress) {
        require(
    ...
    function getBalance(address _address, address _tokenAddress)
        external
        view
        returns (uint256)
    {
        ...
        require(
            balances[_address][_tokenAddress] != 0,
            "Account: balance is zero"
        );
        return balances[_address][_tokenAddress];
    }
