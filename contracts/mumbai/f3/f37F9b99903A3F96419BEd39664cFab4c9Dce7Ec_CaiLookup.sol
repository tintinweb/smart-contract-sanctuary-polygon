...
import "./libraries/CaiLibEnumerateString.sol";

import "hardhat/console.sol";

contract CaiLookup is Ownable {
    mapping ( string  => string ) private valueByCode;
    mapping ( string  => string ) public  valueByIndex1;
    mapping ( string  => string ) private auxIndex1;
    
    EnumerableSetString.StringSet private set;
    
    function add( string memory _code ,  string memory _value , string memory _index1  ) public  onlyOwner returns(bool) {
        valueByCode[_code] = _value;
        valueByIndex1[_index1] = _code ;
        auxIndex1[_code] = _index1;
    ...
    function remove( string memory _code ) public  onlyOwner returns(bool) {
        ...
        delete valueByIndex1[ auxIndex1[_code] ] ;
    ...
    function values( string[] memory _values ) public  view returns ( string[] memory  ) {
        string[] memory aRet = new string[](_values.length);
        for( uint i = 0 ; i < _values.length ; i++){
            aRet[i] =valueByCode[_values[i]];
        }
        return aRet;
    }
