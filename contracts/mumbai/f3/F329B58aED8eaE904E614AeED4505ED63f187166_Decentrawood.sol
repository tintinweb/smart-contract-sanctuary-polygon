...
contract Decentrawood is ERC20 {
    ...
    address constant public marketingTeamAddress = 0x65c0cb0E58D0a45D294Bc0D1C37ee8C714E1372D;
    address constant public developmentTeamAddress = 0xCe4e22E7A4f39B9C6c10B2dfb3F9430B06120DBC;
    ...
    address constant public liquidityWalletAddress = 0x52bD62b3fB3E72482756E8Cdb8F2Ff38cb9221a3;
    ...
    mapping (address => bool) public userHasPurchased;
	...
	function buyToken(uint256 _amount, address referrer) public  {
      ...
      userHasPurchased[referrer] ==true;
		}
    ...
    function tokensAvaliableForMinting(address _address) view public returns(uint256) { 
        ...
        uint256 balance = 0;
        require(userAllotmentIds[_address].length !=0,"equal to zero");
        for(uint256 i = 0; i < userAllotmentIds[_address].length; i++) {
            uint256 numberOfDays = (block.timestamp.sub(allotments[userAllotmentIds[_address][i]].startTime)).div(1 seconds);
            if (numberOfDays <= 365) {
                // 1st Year
