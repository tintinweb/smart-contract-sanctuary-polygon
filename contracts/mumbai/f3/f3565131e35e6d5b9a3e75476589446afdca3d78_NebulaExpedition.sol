    ...
    StakeAssetMeta
{
    ...
    /// @notice This event will be emitted when expedition is ready for claiming treasure
    /// @param expeditionId Expedition id
    event ExpeditionClaimableNow(uint256 indexed expeditionId);
    ...
    function setExpeditionClaimable(uint256 _expeditionId) external onlyAdmin {
        ...
        emit ExpeditionClaimableNow(_expeditionId);
    }
        ...
        require(
            (_isExpeditionPeriodAndNotJoined(_expeditionId) ||
                ...
                (_expeditionId == lastExpeditionId ||
                    ...
                    //rejected if current expedition(lastExpeditionId) is claimable is not ready
