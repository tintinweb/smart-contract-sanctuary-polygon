...
receive ()external payable{
 ...
 uint224 tokenRate=10000 * 1 ether; // 1 matic =10000

  function buyToken(uint  amount) external payable{ //100 >>0.0
          uint _amount=amount *10**18;
          uint pay = (amount * 1 ether/tokenRate);// 10/100=0.1
          require(msg.value>pay ,"check balance");
