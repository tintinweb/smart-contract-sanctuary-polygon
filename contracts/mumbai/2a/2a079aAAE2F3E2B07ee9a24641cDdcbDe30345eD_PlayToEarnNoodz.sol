...
contract PlayToEarnNoodz is Ownable {
  ...
  // real token address:
  address constant noodzToken = 0x0A58ADAd4f9E9211ceeFd92Cf354e0C5dD65076D;
  // address noodzToken;
  ...
  // event PaymentsTokenChanged(address noodzToken);
  ...
  // function setPaymentsToken(address _noodzToken) external onlyAdmin {
