...
contract PolyDraw is VerifyHash, ZKPVerifier, VRFConsumerBaseV2, ReentrancyGuard {
    ...
    function listPhysicalPrizeGame(
        ...
        emit ListPhysicalPrizeGame(
            msg.sender, 
            physicalPrizeGames.length-1, 
            _gameTitle, 
            _gameIntro, 
            _prizeCount, 
            _prizeInfo, 
        ...
        returns (uint requestId_)
    {
        ...
        physicalPrizeGame.pendingPrizeCount -= playRounds;

        payable(physicalPrizeGame.gameOwner).transfer(totalCost);
    ...
    function claimPhysicalPrize(
        ...
        require(prizeExist, "prize is not exist");
