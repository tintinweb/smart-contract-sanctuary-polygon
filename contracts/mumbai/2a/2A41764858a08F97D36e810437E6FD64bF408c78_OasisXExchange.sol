...
contract OasisXExchange is Exchange {
    ...
    */
    constructor(address[] memory registryAddrs) Exchange(name, version) {
...
contract ExchangeCore is ReentrancyGuard, StaticCaller, EIP712 , Ownable{
    ...
    /* Minimum required protocol fees . Paid to owner (who can change it). */
    uint public protocolFee = 2;

    /* Recipient of protocol fees. */
    address public protocolFeeRecipient = payable(0x8b9E9f6259C5b11e59e7F246883AFC9e868B399F); 
    ...
    **/
    constructor(string memory name, string memory version) ReentrancyGuard() EIP712(name, version) { }
     ...
     returns (uint)
    {
        ...
        uint pfee = (amount).mul(protocolFee) / 100;
        uint cfee = (amount).mul(tokenIdPriceRoyalties[2]) / 100;
        ...
        (bool creatorFeeSuccess,) = creatorAndCollection[0].call{value: cfee}("");
    ...
    function changeProtocolFeeRecipient(address newProtocolFeeRecipient)
        ...
        onlyOwner
    {
        require(newProtocolFeeRecipient != address(0),"OasisX: protocolFeeRecipient cannot be address zero");
        require(newProtocolFeeRecipient != protocolFeeRecipient,"OasisX: protocolFeeRecipient cannot be same as previous");
    ...
    function changeProtocolFee(uint newProtocolFee)
        ...
        onlyOwner
    {
        require(newProtocolFee != protocolFee,"OasisX: protocolFee cannot be same as previous");
