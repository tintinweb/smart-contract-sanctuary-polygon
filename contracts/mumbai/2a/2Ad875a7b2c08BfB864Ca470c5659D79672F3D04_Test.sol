...
contract Test is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress =
        payable(0x213dff73dF51D219FF244D3440f0376208361181);
    ...
    bool private tradingOpen = true; // other owners had it to true
    ...
    function setDisableWhitelist(bool _disableWhitelist) public onlyOwner {
        whitelistDisabled = _disableWhitelist;
    }
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            ...
            require(
                isWhitelisted[to],
                "Invalid token transfer, needs to b wlisted"
            );
            if (!tradingOpen) {
                require(
                    from == owner(),
