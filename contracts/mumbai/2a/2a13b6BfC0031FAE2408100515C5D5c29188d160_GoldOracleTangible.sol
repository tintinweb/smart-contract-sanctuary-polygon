...
contract GoldOracleTangible is AdminAccess, IPriceOracle, PriceConverter {
    ...
    function _latestAnswer(uint256 fingerprint, bool initialSale)
        internal
        view
        returns (
            uint256,
        ...
        )
    {
        ...
        //NOTE: add logic for initial sale here mandatory before launch!!!!
        ...
        return (priceForGrams + premium + lockAmount, premium, lockAmount);
    }
        ...
        )
    {
        ...
        ) = _latestAnswer(localFingerprint, initialSale);
        uint8 decimalsLocal = _decimals();
        weSellAt = convertPriceToUSDC(_priceOracle, decimalsLocal); //plus premium to add
        ...
        return (weSellAt, weBuyAt, lockedAmount);
    }
