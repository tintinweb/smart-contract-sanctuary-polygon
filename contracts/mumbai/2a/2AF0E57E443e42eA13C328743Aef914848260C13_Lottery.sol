...
contract Lottery is ILottery, Ownable, Pausable, ReentrancyGuard, PullPayment, NoDelegateCall {
    ...
    /// @inheritdoc ILotteryState
    address public override vrfCoordinator;
    // @inheritdoc ILotteryState
    ...
    function setVRFSettings(
        ...
        vrfCoordinator = vrfCoordinatorAddress_;
        vrfCoordinatorV2Interface = VRFCoordinatorV2Interface(vrfCoordinatorAddress_);
    ...
    function fulfillRandomWords(uint256 requestId, uint256[] memory randomWords) private nonReentrant {
