...
contract Year is ERC721, Ownable {
    ...
    mapping(uint256 => string) private _tokenURIs;  // Mapping to store the token URIs for each year
     ...
     */
    function createYear(string memory _tokenURI) public onlyMinter returns (uint256) {
