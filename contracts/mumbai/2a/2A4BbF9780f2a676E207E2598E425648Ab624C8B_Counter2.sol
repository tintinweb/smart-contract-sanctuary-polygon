 ...
 */
 contract Counter2 is 
 Initializable,
 OwnableUpgradeable,
 UUPSUpgradeable,
 Counter2Storage
 {
    event newCounter(uint256 _counter);
     event newCounter2(uint256 _counter);

    
    function initialize(address _address) public initializer {
        // __Ownable_init();
        __UUPSUpgradeable_init();
          _changeAdmin(_address);
          __Ownable_init();
    ...
    function getCounterValue() public view returns(uint256 counterValue){
     ...
     /**
        ...
        @param _increment Amount to increment 
     */
    function increment2In(uint256 _increment) external {
        counter2 += _increment; //Overflow validation not needed in solidity version >= 0.8.0
        emit newCounter2(counter2);
    }
    ...
    /**
        ...
        @return counterValue Current counter value 
     */
    function getCounter2Value() public view returns(uint256 counterValue){
        return counter2;
    }
...
/**
    ...
    It shows how to develop, test and deply contracts
 */
 contract Counter2Storage{
 
    uint256 public counter; // use 'uint256' instead of 'uint'
    uint256 public counter2; // use 'uint256' instead of 'uint'
 }
