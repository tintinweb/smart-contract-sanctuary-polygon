...
library PoolLogic {
    ...
    )
  {
    ...
    totalCollateralBase = _getUserBalanceInBaseCurrency(reserve.supplyingAsset, collateralAmount, params.oracle);
    totalDebtBase = _getUserBalanceInBaseCurrency(reserve.borrowingAsset, debtAmount, params.oracle);
