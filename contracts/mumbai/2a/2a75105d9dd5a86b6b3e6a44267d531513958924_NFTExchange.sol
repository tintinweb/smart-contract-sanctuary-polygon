...
// File: src/openzeppelin/contracts/NFTExchange.sol
...
contract NFTExchange is EIP712Upgradeable, ReentrancyGuardUpgradeable{
    uint256 public constant INVERSE_BASIS_POINT = 10000;

    function initialize() initializer public {
        __EIP712_init("NFT Pangolin Exchange", "1.0");
    ...
    function verify(Order memory order, bytes memory signature, address expectAddress) public pure returns (bool) {
        ...
        address recoverAddress = ECDSAUpgradeable.recover(dataHash, signature);
