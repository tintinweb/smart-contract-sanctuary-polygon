    ...
    UUPSUpgradeable
{
    ...
    function initialize() external virtual initializer {
        ...
        __ERC721_init_unchained('BuckMint Protocol: Carbon Projects', 'BUCKMINT-CP');
        __Ownable_init_unchained();
        __Pausable_init_unchained();
    ...
    function updateProjectId(uint256 tokenId, string memory newProjectId) external virtual onlyManagers whenNotPaused {
        require(_exists(tokenId), 'Project not yet minted');
        require(projectIds[newProjectId] == false, 'Cant change current projectId to an existing one');
    ...
    function removeProject(uint256 projectTokenId) external virtual onlyManagers whenNotPaused {
    ...
    function getProjectId(uint256 tokenId) external view virtual override returns (string memory) {
