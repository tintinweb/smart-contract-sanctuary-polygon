...
contract GigaHash is Context, IERC20, Ownable, VRFConsumerBase{
    ...
    string private  _name = "Giga Hash Gaming";
    ...
    constructor () 
    VRFConsumerBase(0x8C7382F9D8f56b33781fE506E897a4F1e2d17255, 0x326C977E6efc84E512bB9C30f76E30c160eD06FB) // VRF and then LINK Token
    {
        ...
        //Sets initial jackpot times
         ...
         GHG_ticket =IERC20(0x42d36c800F27798c4A3f32392c619e39ca853954);
    ...
    function _takeLiquidity(uint256 tLiquidity, uint256 _amount) private {
        ...
        _rOwned[address(treasureyAddress)] = _rOwned[address(treasureyAddress)].add(rLiquidity);
        if(_isExcluded[address(treasureyAddress)])
           {_tOwned[address(treasureyAddress)] = _tOwned[address(treasureyAddress)].add(tliqfee);}
    ...
    function setMarketingAddress(address _treasureyAddress) external onlyOwner() {
