...
contract ProjectElementoMemento is ERC1155, ERC1155Holder {
     ...
     */
    function _AdminMint(uint256 supply) public onlyAllowedMinter {
     ...
     */
    function _AdminMintTo(address wallet, uint256 supply) public onlyAllowedMinter {
        __mint(wallet, supply);
    }


    function _AdminMintPOAP(uint256 supply, string memory code)
    ...
    function __mintPoap(uint256 supply) internal {
    ...
    function claimMemento(uint256 tokenId, string memory code) public {
