    ...
    AccessControl
{
     ...
     * @param _USDCWallet address of USDC wallet
    ...
    function _prepaidPostpaid(LoanLib.Loan memory _details) internal {
        if (_details.isPrepaid) {
            ...
            // Paza.mint(postpaidUsdcWallet, _details.foundationShare);
    ...
    function prepaidPazaBuy(
        ...
        if (usdc.balanceOf(prepaidUsdcWallet) >= _amount) {
            ...
            emit PazaBuyFromCoinbase(_serialNo, _lender, coinbaseBalance);
        }
    }
