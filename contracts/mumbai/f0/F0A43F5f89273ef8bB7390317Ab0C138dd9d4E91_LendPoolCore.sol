...
contract GovToken is ERC20, ERC20Burnable, Ownable, ERC20Permit, ERC20Votes {
    constructor() ERC20("LendGovToken", "LGT") ERC20Permit("LendGovToken") {}
...
contract LendPoolCore is Ownable {
    ...
    function validateBorrow(
        ...
        uint256 amountInUsd = IPriceOracleGetter(priceOracle)
            ...
            .mul(_amount)
            .div(10 ** 8)
            .div(10 ** 18); //TODO confirm this makes for non 18 decimals

        (, , uint256 availableToBorrow, , ) = this.getCurrentLiquidity();

        require(
            amountInUsd < availableToBorrow,
            "requreted borrow amount more than available to borrow"
        );
    }
