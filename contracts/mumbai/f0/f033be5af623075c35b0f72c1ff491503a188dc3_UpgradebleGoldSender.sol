...
/**
 ** Gold Digger Multi Sender.app - support ETH and ERC20 Tokens
*
///// Made by https://golddigger.pro/gms-token
...
contract UpgradebleGoldSender is OwnedUpgradeabilityStorage, Claimable {
    ...
    function initialize(address _owner) public {
        ...
        setOwner(_owner);
        setArrayLimit(200);
        setDiscountStep(0.0145 ether);
        setFee(14.51 ether);
        boolStorage[keccak256("Gold_multisender_initialized")] = true;
    }

    function initialized() public view returns (bool) {
        return boolStorage[keccak256("Gold_multisender_initialized")];
    }
