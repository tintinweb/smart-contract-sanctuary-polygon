...
// File: contracts/WhyteRabbitHoleUncommon.sol
...
contract WhyteRabbitHoleUncommon is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721("WhyteRabbitHoleUncommon", "WHYU") {}
    ...
    return "ipfs://Qme5o1s9HQQNnHYYrsjrHWjhdEyBLiQiRfLbUfdrryWoEp/";
    ...
    function mintpid(address _to, uint256 _mintAmount, uint256 _pid) public payable {
        ...
        function withdrawcustom(uint256 _pid) public payable nonReentrant onlyOwner() {
            TokenInfo storage tokens = AllowedCrypto[_pid];
            IERC20 paytoken;
            paytoken = tokens.paytoken;
