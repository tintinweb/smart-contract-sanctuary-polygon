...
contract InfinityAssetV2 is ERC1155, Ownable, Pausable, BaseRelayRecipient {
    ...
    constructor(address _forwarder) ERC1155("") {

        name = "InfinityAssetV2";
        symbol = "INV2";
