...
contract MetaGenixNFT is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseUR) ERC721("MetaGenix", "MGT") {
        setBaseURI(baseUR);
    }
    ...
    function setMaxSupply(uint256 _maxSupply,uint256 _maxMint) public onlyOwner {
    ...
    function mintNFTs(uint256 _count) public payable {
        ...
        require(Minted[msg.sender] <= MAX_MINT, "Address can't mint more NFTs in pre-sale.");
