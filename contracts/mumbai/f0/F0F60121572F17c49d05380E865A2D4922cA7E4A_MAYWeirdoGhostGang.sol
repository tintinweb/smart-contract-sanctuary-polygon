...
contract MAYWeirdoGhostGang is ERC721, AccessControl {
...
//    uint256 public constant PRICE = 0.04 ether;
    string public baseTokenURI = "https://nft.may.social/nft-room-template/";
    ...
    constructor(address weirdoGhostGangAddress) ERC721("MAYWeirdoGhostGang", "MAYWGG") {
...
//        require(PRICE <= msg.value, "mint: Ether value sent is not correct");
        ...
        require(ecrecover(digest, v, r, s) == SIGNER, "mint: Invalid signer");
