    ...
    IPerpetualPoolFactory
{
     ...
     * @param   _fMaxTransferPerConvergencePeriod virtual pool
    ...
    function runLiquidityPool(uint8 _liqPoolID) external override onlyMaintainer {
        ...
        for (uint256 i = 0; i < length; i++) {
            ...
            if (perpetual.state == PerpetualState.INITIALIZING) {
                ...
                _getUpdateLogic().setInitialFundAllocationWeight(perpetual.id);
            }
        }
    ...
    function setAMMPerpLogic(address _AMMPerpLogic) external override onlyMaintainer {
    ...
    function setPoolParam(
        ...
        } else if (_isStringEqual(_name, "fMaxTransferPerConvergencePeriod")) {
            //int128
            int128 fMaxTransferPerConvergencePeriod = _value;
            require(
                fMaxTransferPerConvergencePeriod > 0,
                "invalid fMaxTransferPerConvergencePeriod"
            );
            pool.fMaxTransferPerConvergencePeriod = fMaxTransferPerConvergencePeriod;
