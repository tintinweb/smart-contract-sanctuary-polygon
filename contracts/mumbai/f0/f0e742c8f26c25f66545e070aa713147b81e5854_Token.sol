...
contract Token is Context, IERC20, IERC20Metadata {
    ...
    function _initialize(string memory name_,
        string memory symbol_,
        uint256 totalSupply_,
        address owner) public  {
            require(!initialize, "Contract already initialised");
    ...
    function _transfer(
        ...
        address recipient,
        uint256 amount
    ) internal virtual afterInitialise {
    ...
    modifier afterInitialise {
        require(initialize, "Contract not initialised");
        _;
    }
}