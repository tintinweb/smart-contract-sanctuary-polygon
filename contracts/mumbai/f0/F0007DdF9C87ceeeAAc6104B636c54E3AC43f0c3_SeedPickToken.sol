...
/**
 * @notice This smart contract implements the mintable and burnable ERC20 token used a reward in the staking contract
 */
contract SeedPickToken is ERC20, AccessControl {
    
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    
    /**
     * @notice Initiaises the ERC20 token
     */
    constructor() ERC20("Seed Pick Token", "PICK") {
     ...
     * @param to The address that will burn the tokens
