...
contract CrossChainManager is Initializable, UUPSUpgradeable, ReentrancyGuardUpgradeable, NonblockingLzApp, PausableUpgradeable, AdminProxyManager {
	...
	function _nonblockingLzReceive(
        ...
        {
            (address fromSale, address targetSale, uint256 srcInvoiceIndex, uint128 amountIn, address buyer) = abi.decode(_payload, (address, address, uint256, uint128, address));
            ...
            payload = abi.encode(fromSale, buyer, boosterId, srcInvoiceIndex, received, bought, isOutOfSale);
        }
