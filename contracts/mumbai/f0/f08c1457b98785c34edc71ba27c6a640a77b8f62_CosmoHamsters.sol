...
// File: contracts/CosmoHamsters.sol
...
contract CosmoHamsters is ERC721A, Ownable {
    ...
    constructor(
        ...
        _mintTokens(deploymentConfig.owner, deploymentConfig.initCollectionLenght);
    }
        ...
        pure
    {
        ...
        require(config.initCollectionLenght > 0, "Collection should contain at least one token");
    }
