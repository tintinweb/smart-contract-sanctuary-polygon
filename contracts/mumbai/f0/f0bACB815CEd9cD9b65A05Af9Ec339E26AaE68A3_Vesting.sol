...
contract Vesting is VestingAbstract, ExtensionWhiteList, AccessControl {
     ...
     */
    function includeAccountInWL(address account) external onlyRole(ADMIN_ROLE) {
     ...
     */
    function excludeAccountInWL(address account) external onlyRole(ADMIN_ROLE) {
