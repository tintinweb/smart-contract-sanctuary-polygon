...
//                                                                                                                           
//                                                                                dddddddd                                   
//          tttt         hhhhhhh                                                  d::::::d  iiii                             
//       ttt:::t         h:::::h                                                  d::::::d i::::i                            
//       t:::::t         h:::::h                                                  d::::::d  iiii                             
//       t:::::t         h:::::h                                                  d:::::d                                    
// ttttttt:::::ttttttt    h::::h hhhhh           eeeeeeeeeeee             ddddddddd:::::d iiiiiiippppp   ppppppppp           
// t:::::::::::::::::t    h::::hh:::::hhh      ee::::::::::::ee         dd::::::::::::::d i:::::ip::::ppp:::::::::p          
// t:::::::::::::::::t    h::::::::::::::hh   e::::::eeeee:::::ee      d::::::::::::::::d  i::::ip:::::::::::::::::p         
// tttttt:::::::tttttt    h:::::::hhh::::::h e::::::e     e:::::e     d:::::::ddddd:::::d  i::::ipp::::::ppppp::::::p        
//       t:::::t          h::::::h   h::::::he:::::::eeeee::::::e     d::::::d    d:::::d  i::::i p:::::p     p:::::p        
//       t:::::t          h:::::h     h:::::he:::::::::::::::::e      d:::::d     d:::::d  i::::i p:::::p     p:::::p        
//       t:::::t          h:::::h     h:::::he::::::eeeeeeeeeee       d:::::d     d:::::d  i::::i p:::::p     p:::::p        
//       t:::::t    tttttth:::::h     h:::::he:::::::e                d:::::d     d:::::d  i::::i p:::::p    p::::::p        
//       t::::::tttt:::::th:::::h     h:::::he::::::::e               d::::::ddddd::::::ddi::::::ip:::::ppppp:::::::p        
//       tt::::::::::::::th:::::h     h:::::h e::::::::eeeeeeee        d:::::::::::::::::di::::::ip::::::::::::::::p  ...... 
//         tt:::::::::::tth:::::h     h:::::h  ee:::::::::::::e         d:::::::::ddd::::di::::::ip::::::::::::::pp   .::::. 
//           ttttttttttt  hhhhhhh     hhhhhhh    eeeeeeeeeeeeee          ddddddddd   dddddiiiiiiiip::::::pppppppp     ...... 
//                                                                                                p:::::p                    
//                                                                                                p:::::p                    
//                                                                                               p:::::::p                   
//                                                                                               p:::::::p                   
...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1659409860;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1658805060;
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xa271b48345249d1F2bb6831d41eAbc94354318a1,0xbb9e1Be44d7c67453C84d1BeeBF3F38AC4274230];
  uint256[] public payableFees = [5,65,30];
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  uint256 public PRICE = 49.99 ether;
  uint256 public EARLY_MINT_PRICE = 11.11 ether;
    ...
    , TimedDrop
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 1100) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeihoqrf7eijd2uoju4j4dt7fhwjhgovwohay3ivs4i6pamp3grjsxa/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 1100");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 1100");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 1100");
...
contract ThedipContract is RamppERC721A {
    constructor() RamppERC721A("the dip", "DIPPD"){}
}
