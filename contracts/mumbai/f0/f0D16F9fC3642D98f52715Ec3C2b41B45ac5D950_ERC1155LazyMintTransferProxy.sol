...
library LibERC1155LazyMint {
    ...
    bytes32 public constant MINT_AND_TRANSFER_TYPEHASH = keccak256("Mint1155(uint256 tokenId,string movieId,uint256 supply,uint256 nftRevealTime,address producer,string tokenURI,Part[] creators,Part[] royalties)Part(address account,uint96 value)");
