...
contract Manager {
    ...
    mapping (address => MysteryEdition) editions;

    constructor(){
    } 


    function createEdition(string memory editionName, uint quantity) public{
        new MysteryBox(editionName, quantity, address(this));
    }


/*
    function deleteEdition(address addressEdition) public onlyOwner{
