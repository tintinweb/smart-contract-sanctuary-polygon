...
contract KMCSelect is ERC1155PresetMinterPauser {
    ...
    string private _baseURI =
        'https://arweave.net/wZsTr1d1C7oYSfHRYKNBc-9bytjXtUZRBTQaWPpT820/';

    string public constant name = 'KMCSelect';
    string public constant symbol = 'KMCS';
    string private constant BASE_URI_SUFFIX = '.json';
    ...
    function preMint(
    ...
    ) public whenNotPaused whenMintable {
        ...
        _mint(msg.sender, uint256(mintPhase), _mintAmount, '');
