...
import "../OwnPauseRecover.sol";

contract RenEmpire is ERC4907A, ERC721AQueryable, OwnPauseRecover {
    string private baseURI = "";
    string private baseExt = "";

    constructor(string memory baseURI_, string memory baseExt_)
        ERC721A("Soulbond Ren Empire", "SBREN")
    {
        baseURI = baseURI_;
        baseExt = baseExt_;
    }
    ...
    function mint(address[] calldata addresses) external onlyOwner {
        require(addresses.length + totalSupply() - 1 < 10_000, "mint overflow");
    ...
    function setBaseExt(string calldata baseExt_) external onlyOwner {
        baseExt = baseExt_;
    }
    ...
    {
        return string(abi.encodePacked(super.tokenURI(tokenId), baseExt));
    }
...
contract OwnPauseRecover is Ownable, Pausable {
    ...
    function withdrawERC20(address erc20Address) external onlyOwner {
        require(erc20Address != address(0), "erc20: NO 0 ADDRESS");
