...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x866Aedff69F7Cb13F29EA6fbf841D5E1d5492Fd7];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://Qmf51roVUxp8mezbq88Fuqc6TdKCjWQeU2Jn9GavVAs8Lm/";
...
// File: contracts/ItsDaveContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ItsDaveContract is RamppERC721A {
    constructor() RamppERC721A("Its Dave", "ID"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/7mhRBpU1t06PgA3ktlOa/contract-metadata";
    }
}