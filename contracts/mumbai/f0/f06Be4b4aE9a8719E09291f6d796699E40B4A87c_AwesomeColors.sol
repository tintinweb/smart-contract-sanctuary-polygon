...
// File contracts/AwesomeColors.sol



pragma solidity >=0.7.0 <0.9.0;
contract AwesomeColors is ERC1155, Ownable, AccessControl {
    ...
    string public name = "AwesomeColors";
    string public symbol = "AWSCOLORS";
    ...
    function create(uint256 packType, bytes memory signature) public payable {
        ...
        require(saleEnabled == true, "sale is not open yet!");
    ...
    function uri(uint256 tokenId) public view override returns (string memory) {
        ...
        return (
            string(
                abi.encodePacked(
                    "https://ipfs.io/ipfs/QmU4BTrbJNk6GtRUDHDyMA5ovc2grdYkj8Sea4H9cCZUJz/",
                    id,
                    ".json"
                )
            )
    ...
    function changePrice(uint256[] memory packType, uint256[] memory newPrice)
        ...
        onlyOwner
    {
        require(saleEnabled == false, "sale is not open now!");
    ...
    function withDraw() public payable onlyOwner {
        require(withdrawalAddress.balance > 0, "No balance on contract!");
