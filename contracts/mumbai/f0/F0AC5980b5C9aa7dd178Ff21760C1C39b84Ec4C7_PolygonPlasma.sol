...
contract PolygonPlasma is ERC20, IChildToken, AccessControlMixin, NativeMetaTransaction, ContextMixin {
     ...
     */
    function mint(address user, uint256 amount) public only(DEPOSITOR_ROLE) {
        _mint(user, amount);
    }
