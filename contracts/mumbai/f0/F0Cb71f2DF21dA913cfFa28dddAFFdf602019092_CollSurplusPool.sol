...
contract CollSurplusPool is Ownable, CheckContract, ICollSurplusPool {
        ...
        onlyOwner
    {
        ...
        // emit Amatic_TokenAddressChanged(_amatic_TokenAddress); TODO
    }
    ...
    function claimColl(address _account) external override {
        ...
        if (claimableColl>0){
            bool success = amatic_Token.transfer(_account, claimableColl);
            require ( success, "CollSurplusPool: sending ROSE failed");
        }
    }
    ...
    function _requireCallerIsVM() internal view {
        require(msg.sender == vaultManagerAddress, "DefaultPool: Caller is neither BO nor Default Pool or VM");
    }
    function receive_amatic_CollSurplusPool(uint new_coll) external override {
        _requireCallerIsVM();
        ROSE += new_coll;
        emit CollSurplusROSEBalanceUpdated(ROSE);
    }
}