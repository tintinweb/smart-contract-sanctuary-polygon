...
// 
contract ETCT is ERC721, Ownable {
    ...
    address private author = 0xD3F58e3c3640C0604fCd8E110AB24E3636C59b7f;
...
abstract contract Presaleable is ETCT {
...
contract ETCTPresale is ETCT, Presaleable {
    constructor(
        string memory _uri,
        string memory _name,
        string memory _symbol,
        ...
        uint256 _cost,
        bool _open
    ) ETCT(_uri, _name, _symbol, _totalSupply, _cost, _open) {}
