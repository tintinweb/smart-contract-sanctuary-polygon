...
/**
 * @title Omega Particle token - OMP
 */
contract OMPOL is Recoverable, UsingUniversalForwarding, IERC20Mintable, MinterRole, PolygonChildERC20Burnable {
    constructor(IForwarderRegistry forwarderRegistry, address childChainManager)
        PolygonChildERC20Burnable("Omega Particle Token", "OMP", 18, childChainManager)
