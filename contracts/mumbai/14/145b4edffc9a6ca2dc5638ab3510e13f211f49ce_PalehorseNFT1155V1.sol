...
contract PalehorseNFT1155V1 is ERC1155 {
    ...
    */
    ...
    function LazyMint(address payable creator, NFTVoucher calldata voucher, uint supply)
        public
        payable
        returns (uint256)
    {
       ...
       if(nonceToTokenId[voucher.vNonce] == 0) 
        {
            ...
            _mint(msg.sender, tokenCounter, supply, voucher.tokenUri, voucher.royality);
        ...
        {
            _mint(msg.sender, nonceToTokenId[voucher.vNonce], supply, voucher.tokenUri, voucher.royality);
            creator.transfer(msg.value);
