...
contract LuckBuyLogic is ReentrancyGuardUpgradeable {
  ...
  function getItemTemplates() public pure returns (LuckBuyItemTemplate[] memory) {
    ...
    items[10] = LuckBuyItemTemplate(11, address(0x0), 0.05 ether, 0.01 ether, true, 1 days, true);
    items[11] = LuckBuyItemTemplate(12, address(0x0), 0.005 ether, 0.001 ether, true, 1 days, true);
