...
contract MyInfaq {
    ...
    function createInfaq(address _owner, string memory _title, string memory _description, uint256 _target, uint256 _duedate, string memory _image) public returns (uint256) {
    ...
    function kirimInfaq(uint256 _id) public payable {
        ...
        Infaq storage campaign = infaqs[_id];
