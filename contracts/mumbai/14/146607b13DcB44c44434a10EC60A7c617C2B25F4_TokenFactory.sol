...
contract TokenFactory {
    ...
    constructor(address _codeAddress2) {
        codeAddress = _codeAddress2;
    }
    ...
    function createToken(string memory name, string memory symbol) public returns(address) {
        ...
        TokenERC20 token = TokenERC20(currentToken);
...
contract TokenERC20 is ERC20Upgradeable {
    ...
    function initialize(string memory name, string memory symbol2) public initializer {
        __ERC20_init(name, symbol2);
    }
