...
contract NFTKey is ERC721URIStorage, EIP712, Ownable, ReentrancyGuard {
    ...
    constructor(string memory tokenName, string memory symbol, address recipientAddress, address[] memory minterAddresses) ERC721(tokenName, symbol) EIP712(SIGNING_DOMAIN, SIGNING_VERSION)
    {
