...
contract TokenSale is Initializable, ITokenSale {
    ...
    function initialize(
        ...
        usdc = IERC20D(0xa36EF00CCC73f43dd83E38AEba806C6EFB2BcD6F);         //change for mainnet
        marketingWallet = 0x0B4d9ba9634D5782a4682ec5c8919A490A863E79;       //change for mainnet
    ...
    function userWhitelistAllocation(address[] calldata users, uint256[] calldata allocations)
        public
    {
    ...
    function _processPrivate(address _sender, uint256 _amount) internal {
        ...
        uint256 taxFreeAllcOfUser = (_maxTierAllc(_sender)) *
            PCT_BASE;
    ...
    function userTaxRate(uint256 _amount, address _sender)
        ...
        returns (uint256)
    {
        uint256 userTaxFreeAllc = _maxTierAllc(_sender);
    ...
    function claim() external {
        ...
        if (s.taxAmount > 0) {
            ...
            uint256 taxFreeAllc = _maxTierAllc(msg.sender) *
                PCT_BASE;
