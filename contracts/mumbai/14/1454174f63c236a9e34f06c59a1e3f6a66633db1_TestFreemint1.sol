...
contract TestFreemint1 is ERC721A, Ownable, ReentrancyGuard {
  ...
  bool public revealed = true; // Open

  constructor(
    string memory _initBaseURI,
    string memory _notRevealedUri
  ) ERC721A("TestFreemint1", "TestFreemint1") {  // change the name and symbol for your collection
