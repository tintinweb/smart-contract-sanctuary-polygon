...
contract MainBridge is Ownable, ERC1155Receiver {
    ...
    event NftsLocked(address indexed requester, bytes32 indexed mainDepositHash, uint256 _id, uint256 amount, uint256 timestamp);
    event NftsUnlocked(address indexed requester, bytes32 indexed sideDepositHash, uint256 _id, uint256 amount, uint256 timestamp);
    ...
    constructor (IERC20Minter _tokenContract, ERC1155 _nftContract, address _gateway) {
    ...
    function lockNfts (address _requester, uint256 _id, uint256 _bridgedAmount, bytes32 _mainDepositHash) onlyGateway external {
        emit NftsLocked(_requester, _mainDepositHash, _id, _bridgedAmount, block.timestamp);
    }

    function unlockNfts (address _requester, uint256 _id, uint256 _bridgedAmount, bytes32 _sideDepositHash) onlyGateway external {
        nftContract.safeTransferFrom(address(this),_requester, _id, _bridgedAmount,"0x0");
        emit NftsUnlocked(_requester, _sideDepositHash, _id, _bridgedAmount, block.timestamp);
    }

    
    // Token Bridge

    function migrateTokens (address _requester, uint256 _bridgedAmount, bytes32 _sideDepositHash) onlyGateway external {
    ...
    function lockTokens (address _requester, uint256 _bridgedAmount, bytes32 _mainDepositHash) onlyGateway external {
        emit TokensLocked(_requester, _mainDepositHash, _bridgedAmount, block.timestamp);
    }

    function unlockTokens (address _requester, uint256 _bridgedAmount, bytes32 _sideDepositHash) onlyGateway external {
