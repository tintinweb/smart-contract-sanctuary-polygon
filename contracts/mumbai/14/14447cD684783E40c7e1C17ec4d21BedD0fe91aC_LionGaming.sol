...
contract LionGaming is AccessControlUpgradeable, ReentrancyGuardUpgradeable, EIP712Upgradeable {
        ...
        onlyRole(ADMIN_ROLE)
    {
        ...
        require(coinIndex < 101, "Can't assign reserved coinIndex"); // >= 100 is for internal use
        ...
        onlyRole(AGENT_ROLE)
    {
        ...
        for (uint256 i = 0; i < numRecipients; i++) {
            ...
            string memory typeString =
                (rewards[i].rewardType == RewardType.CREDIT)
                ? "LFICredit"
                : "LFIAirdrop";
        ...
        private
    {
        ...
        withdrawalRequestNonces[user] = request.nonce;
    }
