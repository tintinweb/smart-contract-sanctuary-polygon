...
contract ERC721NESStakingController {
    ...
    // Array of multipliers for different staking options
    ...
    // For each token, this map stores the staking option index
    mapping(uint256 => uint256) public tokenToStakingOption;
    ...
    function getStakingRewards(uint256 tokenId) public view returns (uint256) {
        uint256 stakingOption = tokenToStakingOption[tokenId];
        uint256 multiplier = multipliers[stakingOption];
     ...
     */
    function stake(uint256 tokenId, uint256 stakingOption) public {
        require(stakingOption < multipliers.length, "Invalid staking option");
        require(
        ...
        tokenToStakingOption[tokenId] = stakingOption;
    ...
    function unstake(uint256 tokenId) public {
        ...
        tokenToStakingOption[tokenId] = 0;
