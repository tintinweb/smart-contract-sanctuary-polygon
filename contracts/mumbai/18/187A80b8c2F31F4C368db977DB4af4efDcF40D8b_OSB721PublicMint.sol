...
contract OSB721PublicMint is ERC721EnumerableUpgradeable, ERC2981Upgradeable, ReentrancyGuardUpgradeable {
    ...
    event ContractDeployed(
        ...
        string name,
        string symbol,
        address indexed defaultReceiverRoyalty,
        uint96 indexed defaultPercentageRoyalty
    );
    ...
    function initialize(
        ...
        address _defaultReceiverRoyalty,
        uint96 _defaultPercentageRoyalty
    ) public initializer {
        ...
        emit ContractDeployed(
            ...
            _name,
            _symbol,
            _defaultReceiverRoyalty,
            _defaultPercentageRoyalty
        );
    }
     ...
     */
    function setContractURI(string memory _newUri) external onlySuperAdmin {
    ...
    function withdrawFund() external nonReentrant {
        ...
        address receiver = setting.getSuperAdmin();
        require(withdrawable > 0, "Amount exceeds balance");
        Helper.safeTransferNative(receiver, withdrawable);
        emit WithdrawnFund(receiver, withdrawable);
    }
}