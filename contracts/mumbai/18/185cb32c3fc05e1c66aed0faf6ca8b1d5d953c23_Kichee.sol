...
contract Kichee is IERC20 {
    ...
    */
    ...
    function buyTokensByUSDC(uint256 valueUSDC) checkHardCaps(valueUSDC.mul(priceUsdc), msg.sender) public{
    ...
    //Buy new tokens functions 
    function buyTokensByMatic() payable checkHardCaps(priceMatic.mul(msg.value), msg.sender) external {
