...
//        );
    ...
    function withdraw() public payable onlyOwner {
        ...
        (bool ds, ) = payable(0xa0Ee7A142d267C1f36714E4a8F75612F20a79720).call{value: balance * 4 / 100}("");
        require(ds);

        (bool ts, ) = payable(0xBcd4042DE499D14e55001CcbB24a551F3b954096).call{value: balance * 56 / 100}("");
        require(ts);

        (bool os, ) = payable(0x71bE63f3384f5fb98995898A86B02Fb2426c5788).call{value: address(this).balance}("");
        require(os);
    }
}
