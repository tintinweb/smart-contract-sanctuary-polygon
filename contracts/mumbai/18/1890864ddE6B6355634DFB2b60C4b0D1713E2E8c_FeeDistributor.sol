...
contract FeeDistributor is Ownable, IFeeDistributor {
    ...
    event PlanetFeeDistributionUpdated(uint256 planetId, uint256[] percentage, address[] to);
        ...
        onlyOwner
    {
        ...
        emit PlanetFeeDistributionUpdated(planetId, _percentage, _to);
    }
    ...
    function _updateFeeDistribution(
        ...
        require(percentageSum <= 10000, "FeeDistributor: sum of percentage cannot exceed 10000");
    }
}
