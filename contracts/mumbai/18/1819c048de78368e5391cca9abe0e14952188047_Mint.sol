...
contract Mint is IExecutionStrategy{
    ...
    {
        return (makerAsk.price == takerBid.price && makerAsk.startTime <= block.timestamp && makerAsk.endTime >= block.timestamp && makerAsk.id == takerBid.id, makerAsk.id, 667);
    }
