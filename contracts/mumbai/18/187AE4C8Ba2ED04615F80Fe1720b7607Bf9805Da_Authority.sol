...
contract Authority is IAuthority, AccessControlled {
    ...
    constructor(
        ...
        require(isContract(_governor), "GOV_NOT_CONTRACT");
        governor = _governor;
    ...
    function pushGovernor(address _newGovernor, bool _effectiveImmediately) external onlyGovernor notAddressZero(_newGovernor) _isContract(_newGovernor) {
