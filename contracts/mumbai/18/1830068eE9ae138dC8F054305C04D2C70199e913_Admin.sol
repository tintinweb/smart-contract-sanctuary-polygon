...
import "./Core/interfaces/ISynthFactory.sol";
...
contract Admin is Initializable, AccessControl, BasicMetaTransaction {
    ...
    function setSynthFactory(address _address)
        external
        validation(_address)
        onlyAdmin
    {
        synthFactory = ISynthFactory(_address);
    }
    ...
    function tokenCreation(
        ...
        synthFactory.createToken(_name, _symbol, _owner, _totalSupply,tokenID);
    }
...
interface ISynthFactory {
    ...
    function createToken(string memory name_,string memory symbol_,address owner_,uint256 totalTokenSupply_,uint256 tokenID) external;
