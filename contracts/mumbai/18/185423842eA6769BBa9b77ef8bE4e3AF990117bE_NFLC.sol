...
contract NFLC is KeeperCompatibleInterface, VRFConsumerBase {
    ...
    function expand() public view returns (uint256[] memory expandedValues) {
        expandedValues = new uint256[](6);
        for (uint256 i = 0; i < 6; i++) {
            expandedValues[i] = uint256(keccak256(abi.encode(randomResult, i))) % 45 + 1;
    }
