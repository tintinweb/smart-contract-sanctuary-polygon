 ...
 * calls ERC20(Address 0x01b1556601a9862dFAC900Ba7EcBd0AFD218E8AA)'s at transferFrom function  with variable sender as (the address that called this function), variable recipient as (the address of this contract), variable amount as (((claimCoinPrice0) * (nosCreditsPerToken with element _tokenId)) / (10**18))
 * checks that (ERC20(Address 0x01b1556601a9862dFAC900Ba7EcBd0AFD218E8AA)'s at balanceOf function  with variable recipient as (the address of this contract)) is greater than or equals to (((((claimCoinPrice0) * (nosCreditsPerToken with element _tokenId)) / (10**18)) * (claimCoinPrice0SourceSplit0)) / (100))
 * if (((((claimCoinPrice0) * (nosCreditsPerToken with element _tokenId)) / (10**18)) * (claimCoinPrice0SourceSplit0)) / (100)) is strictly greater than 0 then (calls ERC20(Address 0x01b1556601a9862dFAC900Ba7EcBd0AFD218E8AA)'s at burn function  with variable amount as (((((claimCoinPrice0) * (nosCreditsPerToken with element _tokenId)) / (10**18)) * (claimCoinPrice0SourceSplit0)) / (100)))
...
*/
	function claim(uint256 _tokenId) public {
		...
		ERC20(address(0x01b1556601a9862dFAC900Ba7EcBd0AFD218E8AA)).transferFrom(msg.sender, address(this), ((claimCoinPrice0 * nosCreditsPerToken[_tokenId]) / uint256(10**18)));
		require((ERC20(address(0x01b1556601a9862dFAC900Ba7EcBd0AFD218E8AA)).balanceOf(address(this)) >= ((((claimCoinPrice0 * nosCreditsPerToken[_tokenId]) / uint256(10**18)) * claimCoinPrice0SourceSplit0) / uint256(100))), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		if ((((((claimCoinPrice0 * nosCreditsPerToken[_tokenId]) / uint256(10**18)) * claimCoinPrice0SourceSplit0) / uint256(100)) > uint256(0))){
			ERC20(address(0x01b1556601a9862dFAC900Ba7EcBd0AFD218E8AA)).burn(((((claimCoinPrice0 * nosCreditsPerToken[_tokenId]) / uint256(10**18)) * claimCoinPrice0SourceSplit0) / uint256(100)));
		}
 ...
 * The function takes in 0 variables. It can be called by functions both inside and outside of this contract. It does the following :
 * checks that the function is called by the owner of the contract
 * checks that (ERC20(Address 0x01b1556601a9862dFAC900Ba7EcBd0AFD218E8AA)'s at balanceOf function  with variable recipient as (the address of this contract)) is greater than or equals to claimCoinPrice0SourceAmtInBank
 * if claimCoinPrice0SourceAmtInBank is strictly greater than 0 then (calls ERC20(Address 0x01b1556601a9862dFAC900Ba7EcBd0AFD218E8AA)'s at transfer function  with variable recipient as (the address that called this function), variable amount as claimCoinPrice0SourceAmtInBank)
 * updates claimCoinPrice0SourceAmtInBank as 0
*/
	function claimCoinPrice0SourceTaxWithdrawAmt() public onlyOwner {
		require((ERC20(address(0x01b1556601a9862dFAC900Ba7EcBd0AFD218E8AA)).balanceOf(address(this)) >= claimCoinPrice0SourceAmtInBank), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		if ((claimCoinPrice0SourceAmtInBank > uint256(0))){
			ERC20(address(0x01b1556601a9862dFAC900Ba7EcBd0AFD218E8AA)).transfer(msg.sender, claimCoinPrice0SourceAmtInBank);
		}
