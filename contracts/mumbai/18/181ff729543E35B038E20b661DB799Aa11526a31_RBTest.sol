...
contract RBTest is ERC721Enumerable, Ownable, GenCounter {
    ...
    uint256 private constant MAX_PRESALE_MINT = 1000; //1;
    uint256 private constant MAX_MISSION_COMPONENTS = 3;
    uint256 private constant MISSION_TIME  = 300; //43200;
    uint256 private constant RECOVERY_TIME = 300; //43200;
    ...
    uint256 public presalePrice = 0.006 ether; //60 ether;
    uint256 public salePrice = 0.012 ether; //120 ether

    uint256 public breedPlaPrice = 10 ether; //666 ether;
    uint256 public inkTime = 300; //86400;
    ...
    function startMission(uint256[] calldata _rawb0tsId) external missionIsActive {
     ...
     function endMission(uint256[] calldata _rawb0tsId) external missionIsActive {
...
abstract contract GenSupply {
    ...
    uint256 internal constant MAX_GEN0_ID    = 666; //6666;
    uint256 internal constant START_GEN01_ID = 1;
    uint256 internal constant MAX_GEN01_ID   = 222; //2222;
    uint256 internal constant START_GEN02_ID = 223; //2223;
    uint256 internal constant MAX_GEN02_ID   = 444; //4444;
    uint256 internal constant START_GEN03_ID = 445; //4445;
    uint256 internal constant MAX_GEN03_ID   = 666; //6666;

    uint256 internal constant START_GEN1_ID  = 667; //6667;
    uint256 internal constant MAX_GEN1_ID    = 1332; //13332;
    uint256 internal constant START_GEN11_ID = 667; //6667;
    uint256 internal constant MAX_GEN11_ID   = 888; //8888;
    uint256 internal constant START_GEN12_ID = 889; //8889;
    uint256 internal constant MAX_GEN12_ID   = 1110; //11110;
    uint256 internal constant START_GEN13_ID = 1111; //11111;
    uint256 internal constant MAX_GEN13_ID   = 1332; //13332;

    uint256 internal constant START_GEN2_ID  = 1333; //13333;
    uint256 internal constant MAX_GEN2_ID    = 1998; //19998;
    uint256 internal constant START_GEN21_ID = 1333; //13333;
    uint256 internal constant MAX_GEN21_ID   = 1554; //15554;
    uint256 internal constant START_GEN22_ID = 1555; //15555;
    uint256 internal constant MAX_GEN22_ID   = 1776; //17776;
    uint256 internal constant START_GEN23_ID = 1777; //17777;
    uint256 internal constant MAX_GEN23_ID   = 1998; //19998;

    uint256 private constant SUP_GEN0_ID  = 666; //6666;
    uint256 private constant SUP_GEN11_ID = 222; //2222;
    uint256 private constant SUP_GEN12_ID = 222; //2222;
    uint256 private constant SUP_GEN13_ID = 222; //2222;
    uint256 private constant SUP_GEN21_ID = 222; //2222;
    uint256 private constant SUP_GEN22_ID = 222; //2222;
    uint256 private constant SUP_GEN23_ID = 222; //2222;
