...
contract DoSomething is VRFConsumerBaseV2 {
    ...
    uint256 public wasteGasVariable;
    ...
    bytes32 public WASTE_GAS_ID = keccak256("WasteGas");
    ...
    function wasteGas() public {
        ...
        requestIdToFunctionId[requestId] = WASTE_GAS_ID;
    }
        ...
        override
    {
        ...
        if (requestIdToFunctionId[requestId] == WASTE_GAS_ID) {
