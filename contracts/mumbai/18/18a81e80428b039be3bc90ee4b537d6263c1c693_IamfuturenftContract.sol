...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 7, 5000 ) {}
...
// File: contracts/IamfuturenftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract IamfuturenftContract is RamppERC721A {
    constructor() RamppERC721A("I AM FUTURE NFT", "IAFN"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/ovHgki8uZr1RlyQbKh7W/contract-metadata";
    }
}
