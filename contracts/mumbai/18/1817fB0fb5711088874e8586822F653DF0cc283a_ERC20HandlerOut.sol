...
contract ERC20HandlerOut is
	...
	IAddressBook public _addressBook;
    
    /**
        @param bridgeAddress Contract address of previously deployed Bridge.
     */
    function init(address bridgeAddress, address addressBook) external initializer proxied {
    ...
    function executeProposal(bytes32 resourceID, bytes calldata data) external override {
        ...
        // get recipient / toAddress from addressBook
        (, address recipient) = _addressBook.ownersMapping(sender);
...
interface IAddressBook {
  function ownersMapping(address) external returns(bytes memory, address);
}
