...
contract Vault {
    ...
    constructor(MarketTradingControl _tradingControl, ApedToken _apedToken, MockDAI _daiAddress, AccessControl _accessControl)  {
    ...
    function checkAccountBalance(address _trader) public view returns(uint) {
        return tradersAccountBalance[_trader];
    }
    ...
    function openMarketPriceOrder(
                ...
                uint _collateral, 
                uint _takeProfit, 
                uint _stopLoss) public returns(uint){
