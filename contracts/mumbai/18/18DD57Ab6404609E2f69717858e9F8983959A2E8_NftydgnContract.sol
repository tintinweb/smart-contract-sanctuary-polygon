...
abstract contract EarlyMintIncentive is Teams, ERC721A, ProviderFees {
  uint256 public PRICE = 1.23 ether;
    ...
    
{
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/CjSQtNLSdA5U3oU9zwR3/contract-metadata";
  }
...
// File: contracts/NftydgnContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NftydgnContract is ERC721APlus {
    constructor() ERC721APlus("NFTY DGN", "NFTYD"){}
}
