...
abstract contract MerkleClaimERC721 is ERC721 {
  ...
  /// @notice Thrown "AlreadyClaimed" when claiming a token already claimed before
  ...
  function claim(address to, uint256 tokenId, bytes32[] memory proof) public {
