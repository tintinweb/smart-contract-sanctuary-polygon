...
// File contracts/interfaces/VRFCoordinatorV3Interface.sol




interface VRFCoordinatorV3Interface {
  /**
...
// File contracts/tests/VRFConsumerExampleV3.sol
...
contract VRFConsumerExampleV3 is VRFConsumerBaseV2, ConfirmedOwner {
  ...
  VRFCoordinatorV3Interface COORDINATOR;
  ...
  constructor(address vrfCoordinator) VRFConsumerBaseV2(vrfCoordinator) ConfirmedOwner(msg.sender) {
    COORDINATOR = VRFCoordinatorV3Interface(vrfCoordinator);
  }
