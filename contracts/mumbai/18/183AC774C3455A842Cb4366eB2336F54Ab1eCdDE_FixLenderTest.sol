 ...
 */
contract FixLenderTest is IFixLender, AccessControl {
    ...
    uint256 private _depositEndDate;
    uint256 private immutable _poolPeriod;
    uint256 private _poolEndDate;
    ...
    function changeDeadline(uint256 timestamp) external {
        _poolEndDate = timestamp;
        _depositEndDate = timestamp - 10;
    }
    ...
    function getLockingDuration() external view returns (uint256) {
        return (_poolEndDate - _poolStartDate) / 1 days;
    }
