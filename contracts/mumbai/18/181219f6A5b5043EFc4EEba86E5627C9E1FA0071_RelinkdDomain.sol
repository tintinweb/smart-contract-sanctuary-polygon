...
contract RelinkdDomain is ERC721 {
    ...
    function _getSVGImageBase64Encoded(
        ...
        return
            Base64.encode(
                abi.encodePacked(
                    '<svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 113.33 113.33"><defs><style>.cls-1{fill:#',
                    _design.backgroundColor,
                    ';}@font-face{font-family:"Space Grotesk";src:url(data:application/font-woff;charset=utf-8;base64,',
                    _design.font,
                    ') format("woff");} </style></defs><defs><style>.cls-2{fill:#000;}</style></defs><title>Artboard 1</title><rect class="cls-2" width="113.33" height="113.33"/><rect width="113.33" height="113.33"/>',
                    _design.logo,
