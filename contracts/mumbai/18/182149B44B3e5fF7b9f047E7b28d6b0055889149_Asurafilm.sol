...
contract Asurafilm is
  ERC721Mintable,
  ERC721Permit("Asurafilm"),
  Ownable,
  ERC721URIStorage
{
  ...
  constructor() ERC721("Asurafilm", "Asurafilm") {
    setDefaultURI(
      "https://anime-bank.com/api/metadata/?name=asurafilm&token_id="
    );
  }
  ...
  function supportsInterface(bytes4 interfaceId)
    ...
    view
    virtual
    override(ERC721, ERC721Mintable)
    returns (bool)
  {
  ...
  AccessControl
{
  ...
  function bulkMint(address[] memory _tos, uint256[] memory _tokenIds) public {
    require(
      hasRole(MINTER_ROLE, _msgSender()),
      "must have minter role to mint"
    );
