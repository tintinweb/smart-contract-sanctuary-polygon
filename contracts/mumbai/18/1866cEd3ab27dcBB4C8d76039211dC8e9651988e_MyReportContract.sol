...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xA3A32E428D682bae981e0a5BCA8c7075Ff6061Ee];
  address public erc20Payable = 0xA3A32E428D682bae981e0a5BCA8c7075Ff6061Ee;
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, type(uint256).max) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmW9RChcAyPWTWMLJsGkoCGVLCT2Pg3ZiSQnssh4aEvPGV/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/iNcEBthnZbq88whRDjpX/contract-metadata";
  }
...
// File: contracts/MyReportContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MyReportContract is ERC721APlus {
    constructor() ERC721APlus("MyReport", "MYREPORT"){}
}
