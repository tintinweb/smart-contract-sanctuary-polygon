...
contract i1WPNFT is ERC721URIStorage, Ownable {
	using Counters for Counters.Counter;
	Counters.Counter private _tokenIds;

	// the name and symbol for the NFT
	constructor() public ERC721("i1 Waste PowerTech Non-Fungible Token", "i1WPNFT") {
	}
	...
	function createWPNFT (address receiver, string memory tokenURI, uint256 newItemId) public onlyOwner returns (uint256) {
		_mint(receiver, newItemId);
		_setTokenURI(newItemId, tokenURI);
...
contract i1WPFT is ERC20, Ownable {
	constructor() ERC20("i1 Waste PowerTech Fungible Token", "i1WPFT") {}
}