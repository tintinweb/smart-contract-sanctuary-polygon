...
// Represents unique digital assets.
...
contract CraftObject is BaseObject, ERC1155Supply {
    ...
    // PhiMap address, craftLogic, and secondaryRoyalty of the CraftObject contract
    ...
    /*                                  MODIFIERS                                 */
    /* -------------------------------------------------------------------------- */
    // Modifier to ensure function can only be called by craftLogic contract
...
abstract contract BaseObject is MultiOwner, IERC2981, ReentrancyGuard {
    ...
    {
        return (address(this), (salePrice * secondaryRoyalty) / 10_000);
    }
