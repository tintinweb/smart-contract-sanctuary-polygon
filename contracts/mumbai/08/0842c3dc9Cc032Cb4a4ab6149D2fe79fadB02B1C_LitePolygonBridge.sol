...
abstract contract AdminModule is FxBaseChildTunnel {
    ...
    function toggleChildToRootVaultMap(
        ...
        if (add) {
            require(childToRootVault[childVault] == address(0), "LBP:[toggleChildToRootVaultMap]:: child to root Mapping already added");
            childToRootVault[childVault] = rootVault;
        } else {
            require(childToRootVault[childVault] != address(0), "LBP:[toggleChildToRootVaultMap]:: child to root Mapping not added");
            delete childToRootVault[childVault];
        }
...
contract LitePolygonBridge is AdminModule {
    ...
    function processBatchFromMainnet(
