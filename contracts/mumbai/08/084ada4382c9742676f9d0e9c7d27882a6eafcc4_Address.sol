...
// File: Titanic/ERC721REnumerable.sol
...
contract Titanic is ERC721rEnumerable, Ownable, ReentrancyGuard {
    ...
    constructor() 
    ERC721r("Titanic", "TTNIC", MAX_SUPPLY) {
    }
