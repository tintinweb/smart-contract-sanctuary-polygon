  ...
  ERC20Permit
{
  ...
  */
  function _beforeTokenTransfer(
    ...
    if (sender != longShort) {
      ILongShortOriginal(longShort).executeOutstandingNextPriceSettlementsUser(sender, marketIndex);
    }
  ...
  */
  function balanceOf(address account) public view virtual override returns (uint256) {
    return
      ...
      ILongShortOriginal(longShort).getUsersConfirmedButNotSettledSynthBalance(
        account,
        marketIndex,
        isLong
      );
...
import "./MIA/SyntheticTokenOriginal.sol";
