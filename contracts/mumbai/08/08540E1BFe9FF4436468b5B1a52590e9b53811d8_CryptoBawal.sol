...
contract CryptoBawal is ERC721Enumerable, ReentrancyGuard, Ownable {
  ...
  uint256 public constant MAX_MULTIMINT = 7000;
  ...
  function mint(uint256 count) public nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 7000 at a time");
