    ...
    ReentrancyGuardUpgradeable
{
    ...
    uint32 public executionAllowedPeriod;
    uint256 public liquidateDifference;
    uint256 public treasuryRate; //divided by 1000 -> 15 means 1.5%
    ...
    function initialize(
        ...
        require(_treasuryRate <= 100, "<100"); //max 10%
        require(_admin != address(0), "cant be address 0");
        require(_operator != address(0), "cant be address 0");

        adminAddress = _admin;
        operatorAddress = _operator;

        intervalSeconds = _intervalSeconds;
        executionAllowedPeriod = _intervalSeconds;
        minBetAmount = _minBetAmount;

        treasuryRate = _treasuryRate;
        currentEpoch = 1;
        liquidateDifference = 500;
    }
