...
contract BlockchainAlliance is MRC1155, Ownable {
    ...
    constructor()
        MRC1155(
            "Blockchain Alliance",
            "BA",
            "https://blockchain-alliance.communitynftproject.io/"
        )
    {
    ...
    function publicMint(
        ...
        require(
            amount + totalSupply(MALE) + totalSupply(FEMALE) <= maxCap,
            "> maxcap"
        );
    ...
    */
    ...
    function _beforeMint(
        ...
        require(
            totalSupply(MALE) + totalSupply(FEMALE) + amount <= MAX_SUPPLY,
            "> maxSupply"
        );
    }
