...
contract FitRizer is ERC20, Ownable, ERC20Burnable {
    ...
    mapping(address => investorStakInfo) public investorStakData;
    mapping(address => whiteListStakInfo) public whiteListStakData;
    mapping(uint256 => LockStaking) public staking;
    ...
    mapping(uint256 => saleData) public saleDataInfo;
    mapping(address => bool) public blackList;
    mapping(address => bool) public whiteList;
    address[] public allWhiteListUser;
    mapping(address => uint256) public signUp;
    mapping(address => bool) public signUpInfo;
    mapping(address => uint256) public purchaseTime;
    mapping(uint256 => softStaking) public softStakinginfo;
    mapping(address => uint256[]) public userIdsByAddress;
    mapping(address => uint256) public userTokenData;
    mapping(address => uint256) public investorTokenData;
    mapping(address => uint256) public whiteListedTokenData;
    address[] public investorAddressList;
    mapping(address => bool) public partialAddress;
    address[] public partialAddressList;
    mapping(address => userPresaleInfo) public presaleData;
    address[] public presaleDataList;
    ...
    function addUserToken(uint256 _amount) public {
        userTokenData[msg.sender] = userTokenData[msg.sender] + _amount;
    }
    ...
    function stakeTokens(uint256 stakingPeriod, uint256 amt) external {
        ...
        staking[currentStackId] = LockStaking(
            ...
            msg.sender,
            block.timestamp,
            block.timestamp + (stakingPeriod * 1 seconds),
            tiers[stakingPeriod],
            tokenAmount,
