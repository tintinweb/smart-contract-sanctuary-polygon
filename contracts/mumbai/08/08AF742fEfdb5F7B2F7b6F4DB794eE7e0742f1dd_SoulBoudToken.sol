...
// File: https://github.com/auroraug/ERC721-alter/contracts/ERC721.sol
...
// }
// Verifier public Ver;
function setVerifier(address _verifier,bool _permission) public onlyOwner{
IsVerifier[_verifier] = _permission;
}

modifier onlyVerifier(address _verifier){
    require(IsVerifier[msg.sender] != false);
    _;
}
}
...
// File: https://github.com/auroraug/ERC721-alter/contracts/ERC721URIStorage.sol
...
mapping (address => bool) mintStatus;
    ...
    function safeMint() public {
        ...
        _setTokenURI(tokenId, "ipfs://QmeDBYHYLJJGhcDzYRuKvwXEa3KtrgC4CiWXYMsn5cjTMw");
        max_supply -= 1;
    }
}