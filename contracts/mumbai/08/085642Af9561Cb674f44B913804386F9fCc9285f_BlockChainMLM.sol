...
contract BlockChainMLM is Ownable{
  ...
  function reg(ERC20 token, address uplineAddress, uint256 amount) public {
    ...
    _updateGroupSales(uplineAddress, amount, 0);
  }
  ...
  function reTopup(ERC20 token, uint256 amount) public{
    ...
    require(_uplineAddress != address(0), "This address not yet register!");
  ...
  function payout(ERC20 token, address to, uint256 amount) public onlyOwner{
    require(_members[to].totalDownlines > 0, "No such this upline!");
