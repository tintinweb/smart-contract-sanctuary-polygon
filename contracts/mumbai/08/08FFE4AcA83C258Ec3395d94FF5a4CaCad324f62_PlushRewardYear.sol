    ...
    UUPSUpgradeable
{
    ...
    returns (uint256)
    {
        uint256 birthdayDate = getYear(lifeSpan.getBirthdayDate(lifeSpanId));
        uint256 mintDate = getYear(lifeSpan.getDateOfMint(lifeSpanId));
        uint256 dateNow = getYear(block.timestamp);
