...
library MSNFTCounters {
    ...
    function set(Counter storage counter, uint256 _num) internal {
        counter._value = _num;
    }
}
...
import "./IMS721.sol";
import "../lib/MSNFTCounters.sol";

contract Item721Consecutive is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721Pausable,
    ...
    IMS721
{
    ...
    MSNFTCounters.Counter internal tokenIdTracker;
    ...
    function burn(uint256 tokenId) public override(ERC721Burnable, IMS721) {
        super.burn(tokenId);
    }

    function mint(uint256 tokenId, address to) public onlyMinter {
        _safeMint(to, tokenId);
        emit NFTTransfer(address(0), to, tokenId, block.timestamp);
    }
}