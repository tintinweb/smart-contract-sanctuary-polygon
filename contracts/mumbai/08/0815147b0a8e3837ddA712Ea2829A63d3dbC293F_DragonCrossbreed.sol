...
contract DragonCrossbreed is BaseAuctionReceiver, ReentrancyGuard, RandomConsumerBase {
    ...
    function breed(uint myDragonId, uint anotherDragonId) external payable nonReentrant {
    ...
    function claimReward(address payable to, uint amount) external nonReentrant {
        require(!Address.isContract(to), "DragonCrossbreed: address cannot be contract");
