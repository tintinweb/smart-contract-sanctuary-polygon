...
interface ITWICOIN {
     ...
     * @dev paidBind
     */
    function paidBind(string memory twi_string_,uint256 fee) external;
...
contract TWICOIN is ITWICOIN, VERIFY, TIP{
  ...
  // ---------------------------------------------  //
    ...
    modifier _verifyApprove(uint256 fee){
        ...
        require(getLinkTokenAllowance() >= fee,"208");
    ...
    //paidBind    
    function paidBind(string calldata twi_string_,uint256 fee) override public
        _isStrValid(twi_string_, USERNAME_MIN_LENGTH, USERNAME_MAX_LENGTH, NOT_ALL_NUM) 
        _verifyApprove(fee){
        ...
        require(IERC20(linkToken).transferFrom(_msgSender(),address(this),fee),"208");
        ...
        bindRec[requestVerify(fee,twi_string_, addressToString(_msgSender()), bindTagName)] = verifyObj;
