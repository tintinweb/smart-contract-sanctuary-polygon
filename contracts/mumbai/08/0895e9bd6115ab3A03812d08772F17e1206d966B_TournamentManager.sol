...
contract TournamentManager is VRFConsumerBaseV2 {
  ...
  function checkGotchiFormationValidity1(uint32[5][2] memory gotchiFormation) public returns (bool) {
  ...
  function checkGotchiFormationValidity2(uint32[5][2] memory gotchiFormation) public returns (bool) {
