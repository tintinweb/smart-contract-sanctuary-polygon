...
contract UniswapV3ExchangeAdapter {
        ...
        )
    {
        ...
        require(sourceToken == sourceFromPath, "U3EA0a"); // "UniswapV3ExchangeAdapter: source token path mismatch"

        address destinationFromPath = data.toAddress(data.length - 20);
        require(destinationToken == destinationFromPath, "U3EA0b"); // "UniswapV3ExchangeAdapter: destination token path mismatch"
