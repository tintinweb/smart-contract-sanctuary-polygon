...
contract TheSanctuary is ERC1155, Ownable, DefaultOperatorFilterer {
    ...
    */
    ...
    @param _tier A boolean that indicates whether the function is setting the URI for the tierURI.
    ...
    */
    function setURI(bool _hidden, bool _tier, bool _isBatch, uint _id, string memory _uri, bool _isIpfsCID) external onlyAdmins {
        if(_hidden){
            hiddenURI = _uri;
        }
        if(_tier){
