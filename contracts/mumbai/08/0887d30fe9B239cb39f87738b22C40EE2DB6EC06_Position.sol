...
contract Position is ReentrancyGuard, Ownable, PositionStorage {
    ...
    function addMargin(uint256 positionId, uint256 marginAmount, uint256 source) external payable {
        ...
        if(source == 1) {
            ...
            uint256 maxAddMargin = getMaxAddMargin(positionId, source) ;
    ...
    function getMaxAddMargin(uint256 positionId, uint256 source) public view returns(uint256) {
        Position storage positionInfo = positionIDs[positionId];
        ...
        if(source == 1) {
            ...
            , uint256 usedLoan) = IMargin(IAdminFunctions(adminContract).getMarginContract()).getDepositAmounts(msg.sender, positionInfo.asset);
