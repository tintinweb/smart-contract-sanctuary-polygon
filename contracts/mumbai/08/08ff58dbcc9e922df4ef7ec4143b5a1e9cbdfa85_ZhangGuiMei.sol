...
contract ZhangGuiMei is ERC20, Ownable {
    uint256 private constant MINT_PRICE = 0.001 ether;
    uint256 private constant MAX_SUPPLY = 600_000; // fund target is 600 ETH
    ...
    function mintTo(address recipient) external payable {
        ...
        require(msg.value >= MINT_PRICE, "Insufficient payment to mint");
