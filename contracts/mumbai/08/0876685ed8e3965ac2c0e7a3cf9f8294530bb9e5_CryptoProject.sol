...
// File: contracts/CryptoProject.sol


pragma solidity ^0.8.0;

 /// @author Groot#6879 (Discord) / @Grootz_Web3 (Twitter)
...
contract CryptoProject is ERC721A, Ownable,ReentrancyGuard{
    ...
    uint256 public constant SALE_PRICE = 10**16; 
    ...
    constructor(address payable _withdrawalAddress) ERC721A("Crypto Web3 Genesis", "Crypto",MAX_PER_ADRESS_PUBLIC_MINT,MAX_SUPPLY) {
    ...
    function ucase(address to, uint256 _quantity) external onlyOwner{ 
