...
contract IDOPool is Ownable, Pausable, KLAYDAOWhitelist, IERC1155Receiver, VRFConsumerBase {
     ...
     */
    function updateFundingWallet(uint256 _price) external onlyOwner {
        ticketPrice = _price;
    }
     ...
     * @param _minQuantity max quantity of ticket want to buy
    ...
    function buyTicket(
        ...
        require(_verifyMintTicket(msg.sender, _id, _maxQuantity, proof), "POOL:INVALID_MERKLE");
    ...
    function _verifyMintTicket(
        ...
        return (verifyMintTicket(_candidate, _id, _maxquantity, proof));
    }
...
contract KLAYDAOWhitelist {
    ...
    function verifyMintTicket(
        ...
        bytes32 leaf = keccak256(abi.encodePacked(_candidate, _id, _maxquantity));
