...
contract TDCNFTS is Ownable {

    address contractAddr = 0xA1C83a9947f1daBeF37EEBeAb0f1DB113c266E83;
    ...
    function addListing(uint256 tokenId) public onlyOwner
    {
        listings[contractAddr][tokenId]= Listing(cost,msg.sender);
    }

    function purchase(uint256 tokenId) public payable
    {
        Listing memory item = listings[contractAddr][tokenId];
        require(msg.value >= item.price * 1,"insufficient funds sent");
    ...
    function withdraw(address payable destAddr) public onlyOwner{
        ...
        destAddr.transfer(balances[msg.sender]);
    }
}