...
contract Octopuses is IERC20, Auth {
    uint8 private constant _decimals      = 18;
    uint256 private constant _totalSupply = 3000000000 * (10**_decimals);
    string private constant _name         = "Octopuses";
    string private  constant _symbol       = "$OCTPS";
    ...
    address payable private _walletMarketing = payable(0x7ffAe38748412dAB5D6e55C15B65670Cb0f33cB7); 
    address payable private _walletDevelopment = payable(0x7ffAe38748412dAB5D6e55C15B65670Cb0f33cB7); 

    uint256 private _launchBlock;
    uint256 private _maxTxAmount     = _totalSupply; 
    uint256 private _maxWalletAmount = _totalSupply;
    uint256 private _taxSwapMin = _totalSupply * 10 / 100000;
    uint256 private _taxSwapMax = _totalSupply * 889 / 100000;
    ...
    modifier notBlacklisted(address addr) {
        require(!blacklists[addr], "Address is blacklisted");
        _;
    }
    ...
    constructor() Auth(msg.sender) {
        ...
        uint256 airdropAmount = _totalSupply * 70 / 100;
