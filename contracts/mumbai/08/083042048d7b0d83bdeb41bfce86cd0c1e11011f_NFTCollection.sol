 ...
 */
contract NFTCollection is NFTBase, Ownable, Pausable, AccessControl {
    ...
    function mint(Voucher calldata voucher) external payable {
    ...
    function supportsInterface(bytes4 interfaceId)
      ...
      view
      virtual
      override(NFTBase, AccessControl)
      returns (bool)
    {
