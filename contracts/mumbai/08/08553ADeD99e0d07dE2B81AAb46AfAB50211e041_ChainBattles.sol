...
// Contract deployed to 0x08553ADeD99e0d07dE2B81AAb46AfAB50211e041
...
contract ChainBattles is ERC721URIStorage  {
    ...
    function train(uint256 tokenId) public {
        ...
        tokenIdToVariables[tokenId].hp = currentHp + (createRandom(currentHp)/100);
        uint256 currentStrength = tokenIdToVariables[tokenId].strength;
        tokenIdToVariables[tokenId].strength =  currentStrength + (createRandom(currentStrength)/100);
        uint256 currentSpeed = tokenIdToVariables[tokenId].speed;
        tokenIdToVariables[tokenId].speed =  currentSpeed + (createRandom(currentSpeed)/100);
