  ...
  // MANAGING Authorization Contract Address for Call 
   ...
   // 合约部署者增加操作员
        ...
        returns(uint[] memory)
    {
        ...
        // }
        uint margin = auxiliaryDevices[_type_id].prop_sum.sub(props[hash_attack] + props[hash_defense] + props[hash_hp] + props[hash_duration]);
        props[hash_prop_name] =  props[hash_prop_name].add(margin);
