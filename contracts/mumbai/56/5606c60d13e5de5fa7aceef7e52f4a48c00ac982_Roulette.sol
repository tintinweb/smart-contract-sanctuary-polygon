    ...
    OwnableUpgradeable
{
    ...
    */
    ...
    //User and Epoch to counter
    mapping(address => mapping(uint256 => uint256)) public counterForUserEpoch;
        ...
        whenNotPaused 
    {
        ...
        counterForUserEpoch[msg.sender][currentUserEpoch[msg.sender]] = counter;
        
        uint256 prevRoundIdForUser = 0;
        if(currentUserEpoch[msg.sender] > 1){
            prevRoundIdForUser = counterForUserEpoch[msg.sender][currentUserEpoch[msg.sender] - 1];
        }
