...
contract NFTYMarketplace is AccessControlEnumerable, ReentrancyGuard {
    ...
    */
    ...
    function _payOut(
        ...
        if (_currency == address(NATIVE_TOKEN_ADDRESS)) {
            ...
            if (_royaltyReciver != address(0) && royaltyProfit > 0) {
                (bool isRoyaltyFeeTransferSuccess, ) = payable(_royaltyReciver)
    ...
    function _NftAuctionInstantBuy(
        ...
        _NftAuction(_tokenId, _nftAddress, _auctioner, buyer, NftOnAuction, false);
    }
    ...
    function _NftAuction(
        ...
        if (NftOnAuction.isResell && !_isFiatPurchase) {
            _settleTransfers(
                _buyer,
                _nftAddress,
                _auctioner,
