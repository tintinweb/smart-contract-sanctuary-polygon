...
//*********************************************************************//
//
//    ______      __          ____                  __         _   ______________    
//   / ____/_  __/ /____     / __ \____ _____  ____/ /___ _   / | / / ____/_  __/____
//  / /   / / / / __/ _ \   / /_/ / __ `/ __ \/ __  / __ `/  /  |/ / /_    / / / ___/
// / /___/ /_/ / /_/  __/  / ____/ /_/ / / / / /_/ / /_/ /  / /|  / __/   / / (__  ) 
// \____/\__,_/\__/\___/  /_/    \__,_/_/ /_/\__,_/\__,_/  /_/ |_/_/     /_/ /____/  
//                                                                                   
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xEF651fAFaebeA3428D89fEB11A79fEC5aECB181F];
  address public erc20Payable = 0xEF651fAFaebeA3428D89fEB11A79fEC5aECB181F;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public EARLY_MINT_PRICE = 0.15 ether;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmQqsdegpg6dk1mdUqg8yCqtAJ21WKjvctA5cwjPZVHKcJ/";
...
// File: contracts/CutePandaContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CutePandaContract is RamppERC721A {
    constructor() RamppERC721A("Cute Panda ", "CPanda"){}
}
