...
contract MATICEatPizza is Context, Ownable {
    ...
    mapping (address => uint256) private pizzaMiners;
    ...
    function eatPizzas(address ref) public {
        ...
        //send referral pizza
        claimedPizzas[referrals[msg.sender]] = SafeMath.add(claimedPizzas[referrals[msg.sender]],SafeMath.div(pizzasUsed,8));
    ...
    function sellPizzas(address ref) public payable {
        require(initialized);
