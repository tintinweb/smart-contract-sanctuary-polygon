...
contract HELLSITA is Ownable, ERC721A {
using Strings for uint256;
  ...
  constructor() ERC721A("Luck or Death", "LoD") {
    ...
    whitelist[0xaf8221d68E93AE0E279dB5Bd19eB30200C6240ff] = true;
    whitelist[0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2] = true;
    whitelist[0x4B20993Bc481177ec7E8f571ceCaE8A9e22C02db] = true;
  ...
  function whitelistMint(uint256 quantity)  public payable callerIsUser
    ...
    require(numberMinted(msg.sender) + quantity <= saleConfig.AmountForWhitelist,
