...
//    \ \/  \/ / _ \| __/ __| | | | | '__| __| |/ _ \/ __|
//     \  /\  / (_) | |_\__ \ | |_| | |  | |_| |  __/\__ \
//      \/  \/ \___/ \__|___/_|\__,_|_|   \__|_|\___||___/
//                                                        
//                                                        
//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xC936AD4DB5E2d7dcE1fC12deCd9cd071D9fb9A51];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmWtV3GoNG51toJyotpcFdE4KoxzuLdUBuxvZJk2CubTMg/";

    bool public mintingOpen = false;
    
    uint256 public PRICE = 15.2 ether;
...
// File: contracts/WotsTurtlesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WotsTurtlesContract is RamppERC721A {
    constructor() RamppERC721A("WotsTurtles", "WOTS"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/sApUbwd8s7kdoxZhu7RO/contract-metadata";
    }
}
