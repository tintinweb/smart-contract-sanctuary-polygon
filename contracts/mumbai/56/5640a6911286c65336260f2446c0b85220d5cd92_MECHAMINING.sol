...
contract MECHAMINING {
	...
	constructor(address payable wallet, address payable _developer) public {
        ...
        plans.push(Plan(30, 45)); // SL Mecha 
        plans.push(Plan(30, 45)); // L Mecha
        plans.push(Plan(30, 40)); // SR Mecha
		plans.push(Plan(30, 35)); // R Mecha (Compounding)
        plans.push(Plan(30, 35)); // COMM Mecha (Compounding)
        plans.push(Plan(30, 35)); // UNC Mecha (Compounding)
	}
