...
contract NFTContract is ERC721A, Ownable {
    ...
    string constant baseURI =
        "ipfs://bafybeidhguesgqcd2hx3fqup7lctpbt4d2bccmuggxa5tfteifmesvpauq/personal/";
    // string constant companyURI =
    //     "ipfs://bafybeidhguesgqcd2hx3fqup7lctpbt4d2bccmuggxa5tfteifmesvpauq/company/";
    bool public mutex = false;

    error SaleHasentStarted();
    error AlreadyMinted();

    mapping(address => bool) public limitedMintPerWalttet;
    ...
    function mint(uint256 quantity) external payable {
        ...
        // }
        // if (limitedMintPerWalttet[msg.sender]) {
    ...
    function _baseURI() internal view virtual override returns (string memory) {
        return 'ipfs://bafybeidhguesgqcd2hx3fqup7lctpbt4d2bccmuggxa5tfteifmesvpauq/personal/';
    }
