...
contract SimpleNFTCollection3 is Ownable, ERC721URIStorage, ERC721Enumerable, ERC721Royalty, ContextMixin {
    ...
    constructor() ERC721("SimpleNFTCollection3", "SNC3") {
        console.log("DEPLOY: Msg sender > ", _msgSender());
    }
    ...
    function mint(string memory _tokenURI) public onlyOwner returns(uint256) {
        ...
        console.log("MINT: Msg sender > ", _msgSender());
