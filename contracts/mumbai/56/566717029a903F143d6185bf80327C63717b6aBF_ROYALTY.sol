...
contract ROYALTY is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public  maxSupply = 1200; //total supply
  uint256 public  MAX_PUBLIC_MINT = 10;
  uint256 public  MAX_WHITELIST_MINT = 10;
  uint256 public  PUBLIC_SALE_PRICE = 1 ether; //public sale price
  uint256 public  WHITELIST_SALE_PRICE = 0.00001 ether; //whitelist sale  price
  address public artist;
  uint256 royaltyFee = 10; //royalty percent %
  ...
  constructor(
    address _artist
  ) ERC721A("Name of the collection", "the symol") {
    artist = _artist;
  }
