...
contract Tickets is Ownable, ERC1155, Handlers {
  mapping(uint256=>string) metadata;
  mapping(uint256=>bool) public valid;
  mapping(uint256=>uint256) public ticketsCount;

  string public name = "PolyFarmTickets";
  ...
  function mint(address account, uint256 tokenId, uint16 amount) public isHandler {
    require(valid[tokenId], "Invalid tokenId");
