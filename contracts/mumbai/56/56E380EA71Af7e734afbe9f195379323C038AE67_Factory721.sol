...
contract Factory721 {
    ...
    event EscrowChanged(address previousEscrow, address newEscrow);
    ...
    function changeEscrow(address _escrow) external onlyOwner {
    ...
    function deploy(
        ...
        addr = address(
            new UmiverseUser721Token{salt: _salt}(name, symbol, tokenURIPrefix, escrow, proxy)
        );
    ...
    AccessControl
{
    ...
    function _beforeTokenTransfer(
        ...
        require(!IEscrow(escrow).isRented(address(this), from, tokenId, 1), "ERC721Rental: NFT is on Rental");
