...
contract GlobalPass is ERC1155, Ownable, Pausable, ERC1155Burnable, GlobalPassAuction,GlobalPassRoyalties, ReentrancyGuard {
    ...
    struct TicketType
    {
        ...
        string ticketName;
        uint ticketFixPrice;
        uint32 validityStartDate;
        uint32 validityEndDate;
        uint totalCopies;
        string ticketURI;
        uint32 copiesSold;
    ...
    //[[1,"Ticket1",9738178 ,7886858 ,100000,100,"http://URI",0,"",2,5,0, 2], [1,"T2", 9738178 ,7886858,200000,20,"http://URI2",0, 2]]
   ...
   mapping(address=> mapping(uint => uint)) public CopiesOnBidOrSale;
    ...
    // tickets will be created on time of event registration
     function registerEvent(
        ...
        //The Arguments of addTicketType() will be given in following format:
        // for 2 types of tickets
        /*
        ...
        */
        ...
        addTicketType( ticketTypesCount, _TicketTypes /*_auctionStartTimes, _auctionEndTimes */) ;
        ...
        for(uint8 i=0; i < ticketTypesCount ; i++)
         {
            ...
            ticketTypeDetails[ticketsCount].eventIDforTicket = eventsCount;
            ...
            ticketTypeDetails[ticketsCount].validityStartDate = _ticketTypes[i].validityStartDate;
            ticketTypeDetails[ticketsCount].validityEndDate = _ticketTypes[i].validityEndDate;
    ...
    function mintTicketsWithFixPrice(address account, uint ticketID, uint32 noOfCopies) public payable {
    ...
    function placeTicketForFixedPrice(address owner, uint ticketID,  uint _ticketFixPrice) internal  {
