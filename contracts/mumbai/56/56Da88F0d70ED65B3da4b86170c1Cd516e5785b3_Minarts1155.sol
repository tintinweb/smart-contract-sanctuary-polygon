...
contract Minarts1155 is ERC1155, IERC2981, Ownable, Pausable, ContextMixin {
    using Strings for uint256;
    string public name;
    ...
    constructor()
        ERC1155(
            ...
            address(0x2AA7aca898216a5bFA3e7424a0f9b968d835C4e5),
            10
        )
    {
        name = "minarts";
    ...
    function contractURI() public pure returns (string memory) {
        return "https://minarts-store.s3.amazonaws.com/nft_test/metadata/"; // Contract-level metadata for ParkPics
    }
}