...
contract WWWWWWWW is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("WWWWWWWW", "WWW") {
    customBaseURI = customBaseURI_;

    allowedMintCountMap[0x7625593faf19319C1A034AbB017361FE5F9F109B] = 1;
  }
