...
contract POS is POSFactory {
    ...
    constructor( ) ERC1155("")  {
        ...
        GameCollection[Collection.OXYGEN]= TokenProperies(0,0,0,1 ether,false,"",100000000000000);
        GameCollection[Collection.RARE_WOLFS]= TokenProperies(1,1,6000,1 ether,false,"",1);
        GameCollection[Collection.EPIC_WOLFS]= TokenProperies(6001,6001,9000,1 ether,false,"",1);
        GameCollection[Collection.LEGENDARY_WOLFS]= TokenProperies(9001,9001,10000,1 ether,false,"",1);
        ...
        GameCollection[Collection.WOOD]= TokenProperies(10053,10053,10053,1 ether,false,"",1);
        GameCollection[Collection.ROCK]= TokenProperies(10054,10054,10054,1 ether,false,"",1);
        GameCollection[Collection.IRON]= TokenProperies(10055,10055,10055,1 ether,false,"",1);
        GameCollection[Collection.GOLD]= TokenProperies(10056,10056,10056,1 ether,false,"",1);
        GameCollection[Collection.OTHER]= TokenProperies(10048,10048,10052,1 ether,false,"",1);
    }
