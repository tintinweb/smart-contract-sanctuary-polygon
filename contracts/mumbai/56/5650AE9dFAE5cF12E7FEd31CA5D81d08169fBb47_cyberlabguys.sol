...
// File: contracts/cyberlabguys.sol
...
contract cyberlabguys is ERC721, IERC2981, Ownable, ReentrancyGuard {
	using Strings for uint256;
	...
	uint256 public price = 0.1 ether;//50matic
	...
	) ERC721("cyberlabguys", "aguymember") {
	...
	function mintListed(
		...
		require(isActive, "sale is over , don't be late for next drop");
