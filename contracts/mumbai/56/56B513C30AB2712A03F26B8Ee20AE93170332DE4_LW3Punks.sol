...
contract LW3Punks is ERC721Enumerable, Ownable{
    ...
    */
    function mint() public payable onlyWhenNotPaused{
        require(tokenIds < maxTokensIds, "mint - EXCEED_MAXIMUM_SUPPLY");
        require(msg.value >= _price, "mint - UNSUFFICIENT FUNDS");
        tokenIds += 1;
    ...
    */
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory){
        require(_exists(tokenId), "tokenURI - ERC721METADATA: NONEXISTENT_TOKEN");
    ...
    */
    function withdraw() public onlyOwner{
        ...
        require(sent, "withdraw - FAILED_TO_WITHDRAW");
    }
