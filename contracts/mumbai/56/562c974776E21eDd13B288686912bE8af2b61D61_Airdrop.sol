...
contract Airdrop is IAccessControlHolder, IAirdrop, WithFees {
    ...
    mapping(address => uint256) public onLockdropPhase2;
    ...
    function claimTokens() external payable override onlyWithFees {
        ...
        uint256 senderOnLockdropPhase2 = onLockdropPhase2[msg.sender];
        uint256 onVesting = amount / 2;
        uint256 toSend = amount - senderOnLockdropPhase2 - onVesting;
    ...
    function lockOnLockdropPhase2(uint256 _amount) external override {
        ...
        uint256 totalToLock = claimableAmounts[msg.sender] / 2;
        uint256 alreadyLocked = onLockdropPhase2[msg.sender];
        if (_amount + alreadyLocked > totalToLock) {
            revert AmountOfTokensExceeded();
        }
