...
contract USDRouter {
    ...
    address private constant _USDTOKEN_MODULE = 0xdF9289ba12d1eAF594a911Fd2Cfe8428C2090523;
        ...
        assembly {
            ...
            function findImplementation(sig) -> result {
                ...
                if lt(sig,0xaaa15fd1) {
                    ...
                    case 0xa14d707c { result := _USDTOKEN_MODULE } // USDTokenModule.transferCrossChain()
