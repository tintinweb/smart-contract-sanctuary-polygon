...
contract SPUDSIEINU is Context, IBEP20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    uint8 private _decimals = 9;

    string private _name = "SPUDSIE INU";                  
    string private _symbol = "SPUDS";                                 
    ...
    uint256 public _taxFee4Buyers = 4;
    ...
    uint256 public defaultLiquidityFee = 10;
    uint256 public _liquidityFee = defaultLiquidityFee;
    uint256 private _previousLiquidityFee = _liquidityFee;

    uint256 public _liquidityFee4Buyers = 6;
    ...
    uint256 private _previousMaxWallet = _maxWallet;
    ...
    uint256 public numTokensSellToAddToLiquidity = _tTotal * 5 / 1000;
    address public pancakeRouterAddress = 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff; // Pancake  Version 2 address                                                                  // contract balance to trigger swap & liquify + wallet transfer.
    //address public pancakeRouterAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;   // Pancake TEST Router Version 2 address
    uint[] public _percentages = [80,10,10,0,0];                                         // % of liquidity fee split to wallet(s)
    address payable[] public _wallets = [                                                // wallet(s) to receive liquidity fee split
        payable(0x63Ab8ad49251DB10DCd0900BF8F9b6831d9e0E0d),                             // Dev wallet
        payable(0xe0Faccd617b82eC7Ce0431CB4E7cCd13F7394de6),                             // Marketing wallet
        payable(0xc93735F49A684964F9234F5e0D6B691b68b3ee8a),                             // Team Dev wallet
        payable(0x80c6953fECC6d31135D11cAC8c923bb05F3f3dEd),                             // Charity wallet
        payable(0x73Ec19746CD4f714Fa627A14197f65DDfC87AE19)                              // SPARE1
 ];
    ...
    constructor () {
        ...
        uniswapV2Router = _uniswapV2Router;
         ...
         maxTransactionAmount = _tTotal * 1 / 100;// 1.0% maxTransactionAmount

        // exclude pancake from max wallet
        
        


        //exclude owner and this contract from fee and Max wallet and Tx
     ...
     // _isExcludedMaxTransactionAmount[address(0) ] = true;
      _isExcludedFromMaxWallet[address(uniswapV2Router) ] = true;
   ...
   function excludeFromMaxWallet(address account) public onlyOwner {
    ...
    function updateMaxTxAmount(uint256 newNum) external onlyOwner {
     require(newNum >= (_tTotal * 5 /  1000), "Cannot set maxTransactionAmount lower than 0.5%");
   ...
   function isExcludedFromMaxWallet(address account) public view returns(bool) {
    ...
    //to recieve MATIC when swapping
   ...
   // }
    ...
    function _goLive() external onlyOwner() {
        require(!isTokenLive, "SPUDS is already live");
        isTokenLive = true;
    }
    ...
    function _transfer(
        ...
        require(_isExcludedFromFees[from] || _isExcludedFromFees[to] || isTokenLive, "SPUDS is not live yet");
     ...
     if (automatedMarketMakerPairs[from] && !_isExcludedMaxTransactionAmount[to]) {
       ...
       require((heldTokens + amount) <= _maxWallet,"Over wallet limit.");
     }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // swap tokens for BNB
        swapTokensForBNB(liquifyHalves[0]); // <- this breaks the MATIC -> SPUDS swap when swap+liquify is triggered
    ...
    function bulksendToken(address[] calldata _to, uint256[] calldata _amounts) external {
        ...
        for (uint256 i = 0; i < _to.length; i++) {
            _transfer(_msgSender(), _to[i], _amounts[i]);
        }
    }
}