...
contract TestNET_NFT is ERC721Enumerable, Ownable {
  ...
  uint256 public cost = 0.00001 ether; //цена за минт 1 нфт
  ...
  constructor() ERC721("TestNET", "TN") {
    setBaseURI("ipfs://Qmbzm1TyXvcCFC9TdpMrqnxkY9XLoUZ4Kxda1YucdqBGi2");
    setNotRevealedURI("ipfs://QmZdgwjNzGwMcXSUi47gADQ6wRwfXfcePpRov9n6ghPzNS/hidden.json");
  }
  ...
  function withdraw() public payable onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x88D1282122a3c3a38F4fC6Cf70bE9799172149cD).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
