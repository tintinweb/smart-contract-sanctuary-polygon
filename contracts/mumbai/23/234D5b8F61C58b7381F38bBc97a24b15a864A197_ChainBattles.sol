...
contract ChainBattles is ERC721URIStorage  {
    ...
    function getLevel(uint256 tokenId) public view returns (string memory) {
        Attributes memory attributes = tokenIdToAttributes[tokenId];
        return attributes.level.toString();
    }

    function getSpeed(uint256 tokenId) public view returns (string memory) {
        Attributes memory attributes = tokenIdToAttributes[tokenId];
        return attributes.speed.toString();
    }
    ...
    function getLife(uint256 tokenId) public view returns (string memory) {
        Attributes memory attributes = tokenIdToAttributes[tokenId];
        return attributes.life.toString();
    }
    ...
    function mint() public {
        ...
        tokenIdToAttributes[newItemId].level = random(100);
        tokenIdToAttributes[newItemId].speed = random(100);
        tokenIdToAttributes[newItemId].strength = random(100);
        tokenIdToAttributes[newItemId].life = random(100);
    ...
    function train(uint256 tokenId) public {
        ...
        // uint256 currentLevel = tokenIdToAttributes[tokenId];
