...
contract Box is Ownable {
    ...
    function requestAccessForBox() public {
        require(isRequested[msg.sender].isRequested == false, "User Already Requested");
...
contract Subscription is Ownable {
    ...
    constructor() {
        packages.push(subscriptionPlans(1000, 10 * 1024));
        packages.push(subscriptionPlans(2000, 25 * 1024));
        packages.push(subscriptionPlans(3000, 50 * 1024));
    }
