...
contract TheCryptoStudio is ERC1155
{
    ...
    string private constant MAIN_SCHEMA = "tokenID text, description text, image text, name text, animation_url text, maxSupply text, currentSupply text, mintPrice text";
...
library SQLHelpers {
    ...
    toInsert(
            MAIN_TABLE_PREFIX,
            mainTableID,
            "tokenID, description, image, name, animation_url, maxSupply, currentSupply, mintPrice",
            string.concat(
