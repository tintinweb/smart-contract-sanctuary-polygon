...
----------------------------------------------------
   ______                               _       __ 
  / ____/________  ______________ ___  (_)___  / /_
 / /   / ___/ __ \/ ___/ ___/ __ `__ \/ / __ \/ __/
/ /___/ /  / /_/ (__  |__  ) / / / / / / / / / /_  
\____/_/   \____/____/____/_/ /_/ /_/_/_/ /_/\__/  

----------------------------------------------------
*/

contract Crossmint1155 is ERC1155, Ownable {
    uint256 public salePrice = 0.001 ether;
    uint256 public maxTokensPerTxn = 6;

    string public simpleURI =
    ...
    function mint(uint256 quantity, uint256 id)
        external
        payable
        maxTokens(quantity)
    ...
    function crossmint(address to, uint256 quantity, uint256 id)
        external
        payable
        isCrossmint
        maxTokens(quantity)
