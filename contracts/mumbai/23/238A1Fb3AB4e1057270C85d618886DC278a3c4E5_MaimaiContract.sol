...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x028954B8890996cb25020Dce4c3f3704af5808cF];
  address public erc20Payable = 0x028954B8890996cb25020Dce4c3f3704af5808cF;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 149) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeie6s74y5rzgnmqpgu32vny6oumf7oymxd6dvcb5cvkunsq6b7liya/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/UZKKnE9I0AOelag4eZOG/contract-metadata";
  }
...
// File: contracts/MaimaiContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MaimaiContract is RamppERC721A {
    constructor() RamppERC721A("maimai ", "MAI"){}
}
