...
abstract contract AccessControl is Context, IAccessControl, ERC165 {
    ...
    contract ERC1155PresetMinterPauser is Context, AccessControl, ERC1155Burnable, ERC1155Pausable {
        ...
        function _beforeTokenTransfer(
      	...
      	uint256 public constant asas = 0;
uint256 public constant asd = 1;
      	
			constructor() ERC1155PresetMinterPauser("adsadsad") {
		
    		_mint(msg.sender, asas, 11203, "");
_mint(msg.sender, asd, 11505, "");
        }
