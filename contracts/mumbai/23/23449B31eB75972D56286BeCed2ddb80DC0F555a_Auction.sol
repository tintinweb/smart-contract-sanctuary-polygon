...
contract Auction {
    ...
    mapping(bytes32 => DataStructure.autionStruct) public auctionIdToAuction;
    mapping(bytes32 => address[]) public autionIdToParticipants;
    mapping(bytes32 => DataStructure.Listing) public Listings;
    mapping(bytes32 => DataStructure.Offer) public Offers;
    ...
    modifier checkStateOfAution(bytes32 _auctionId) {
        require(
    ...
    function getTokenIdFromListing(bytes32 _listingId)
        internal
        view
        returns (uint256)
    {
    ...
    function getInforOffer(bytes32 _indexId, bytes32 _subOfferId)
        public
        view
        returns (
            uint256,
        ...
        )
    {
        ...
        bytes32 _idcollection = collectionNFT.getTokenIdToCollectionId(
    ...
    function getInforListing(bytes32 _indexId)
        public
        view
        returns (
            bytes32,
    ...
    function processCancelListing(bytes32 _listingId, bytes32 _requestId)
        internal
    {
        require(
    ...
    function listingNFTFixedPrice(
        ...
        bytes32[] memory arrayString = new bytes32[](0);
    ...
    function buyFixPrice(
        ...
        bytes32 _listingId = stanNFT.getTokenToListing(_tokenId);
        require(
    ...
    function cancelListingFixedPrice(bytes32 _listingId, bytes32 _requestId)
        external
    {
    ...
    function cancelListingAuction(bytes32 _listingId, bytes32 _requestId)
        external
    {
        require(
    ...
    function cancelOfferPvPAuto(
        bytes32 _nftId,
        bytes32[] memory subOffersIdParam,
        bytes32 _requestId
    ) external onlyOwner {
    ...
    function deposit(uint256 _amount, bytes32 _requestId)
        external
    ...
    function withdraw(uint256 _amount, bytes32 _requestId) external {
        require(
    ...
    function findTheBestFitWinner(bytes32 _auctionId)
        internal
        view
        returns (uint256)
    {
    ...
    function finishAution(bytes32 _auctionId, bytes32 _requestId)
        external
        onlyOwner
        ...
        checkStateOfAution(_auctionId)
    {
        ...
        bytes32 winnerSubOfferId = auctionIdToAuction[_auctionId]
...
interface IStanNFT {
    ...
    function updateTokenToListing(bytes32 _listing, uint256 _tokenId) external;
...
library DataStructure {
    ...
    struct autionStruct {
        ...
        bytes32[] offerIds;
        Type _type;
        mapping(bytes32 => uint256) offerIdToIndex;
    ...
    struct Offer {
        uint256 tokenId;
        mapping(bytes32 => subOffer) subOffers;
        bytes32 nftID;
        bytes32 auctionID;
    }
