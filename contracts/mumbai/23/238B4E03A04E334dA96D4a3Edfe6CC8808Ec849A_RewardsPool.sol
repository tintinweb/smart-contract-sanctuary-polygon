...
contract RewardsPool is IRewardsPool, Ownable{
    ...
    address public WMATIC_address = 0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889;
    address public USDC;
    ...
    function _swapMaticToUSDC(uint amount) internal returns (uint) {
        address[] memory path = new address[](2);
        path[0] = uniswapV2Router02.WETH();
        path[1] = address(usdc_token);

        uniswapV2Router02.swapExactETHForTokens{value: amount } (0, path, address(this), block.timestamp+300);
