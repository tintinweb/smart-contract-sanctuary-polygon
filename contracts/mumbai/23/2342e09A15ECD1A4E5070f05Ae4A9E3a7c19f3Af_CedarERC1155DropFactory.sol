...
import "../generated/impl/BaseCedarERC1155DropV3.sol";
    ...
    BaseCedarERC1155DropV3
{
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(BaseCedarERC1155DropV3, ERC1155Upgradeable, AccessControlEnumerableUpgradeable)
        returns (bool)
    {
        return
            BaseCedarERC1155DropV3.supportsInterface(interfaceId) ||
    ...
    function claim(
        ...
        CedarERC1155DropLogic.InternalClaim memory internalClaim = CedarERC1155DropLogic.claim(
            claimData,
            _tokenId,
            _quantity,
            _currency,
    ...
    function verifyClaimMerkleProof(
        ...
        return
            CedarERC1155DropLogic.verifyClaimMerkleProof(
                claimData,
                _conditionId,
                _claimer,
                _tokenId,
        ...
        )
    {
        ...
        } else if (claimData.maxTotalSupply[_tokenId] > 0) {
...
library CedarERC1155DropLogic {
    ...
    function claim(
        ...
        if (!(isTrustedForwarder || msgSender == tx.origin)) revert Bot();
        ...
        if (internalData.validMerkleProof && _proofMaxQuantityPerTransaction > 0) {
             ...
             */
            claimData.claimCondition[_tokenId].limitMerkleProofClaim[internalData.activeConditionId].set(
    ...
    function recordTransferClaimedTokens(
        ...
        claimData.claimCondition[_tokenId].limitLastClaimTimestamp[_conditionId][msgSender] = block.timestamp;
    ...
    function verifyClaimMerkleProof(
        ...
        if (currentClaimPhase.merkleRoot != bytes32(0)) {
            ...
            if (!(!claimData.claimCondition[_tokenId].limitMerkleProofClaim[_conditionId].get(merkleProofIndex)))
                revert InvalidProof();
    ...
    function getClaimTimestamp(
        ...
        lastClaimTimestamp = claimData.claimCondition[_tokenId].limitLastClaimTimestamp[_conditionId][_claimer];
...
// Filename: './BaseCedarERC1155DropV3.sol'
...
abstract contract BaseCedarERC1155DropV3 is ICedarERC1155DropV3 {
    function supportedFeatures() override public pure returns (string[] memory features) {
        ...
        features[6] = "standard/IERC1155.sol:IERC1155SupplyV0";
    ...
    function supportsInterface(bytes4 interfaceID) virtual override public view returns (bool) {
        return (interfaceID == type(IERC165Upgradeable).interfaceId) || ((interfaceID == type(ICedarFeaturesV0).interfaceId) || ((interfaceID == type(ICedarVersionedV0).interfaceId) || ((interfaceID == type(IMulticallableV0).interfaceId) || ((interfaceID == type(ICedarSFTIssuanceV1).interfaceId) || ((interfaceID == type(ICedarLazyMintV0).interfaceId) || ((interfaceID == type(ICedarUpdateBaseURIV0).interfaceId) || ((interfaceID == type(IERC1155SupplyV0).interfaceId) || ((interfaceID == type(IRoyaltyV0).interfaceId) || ((interfaceID == type(ICedarMetadataV1).interfaceId) || ((interfaceID == type(ICedarAgreementV0).interfaceId) || (interfaceID == type(IPrimarySaleV0).interfaceId)))))))))));
    }
