    ...
    ERC2981
{
    ...
    function setBaseURIs(string memory _baseURI1, string memory _baseURI2, string memory _baseURI3, string memory _baseURI4, string memory _baseURI5) external onlyOwner {
        baseURI1 = _baseURI1;
        baseURI2 = _baseURI2;
        baseURI3 = _baseURI3;
        baseURI3 = _baseURI4;
    ...
    function _baseURI4() internal view virtual override returns (string memory) {
        return baseURI4;
    }
    function _baseURI5() internal view virtual override returns (string memory) {
        return baseURI5;
    }
...
contract ERC721r is Context, ERC165, IERC721, IERC721Metadata, VRFConsumerBaseV2 {
    ...
    require(_exists(tokenId), 'ERC721Metadata: URI query for nonexistent token');
       ...
       if (tokenId <= 2000) {
        ...
        } else if (tokenId > 4000 && tokenId <= 6000 ) {
        ...
        } else if (tokenId > 6000 && tokenId <= 8000 ) {
            string memory baseURI4 = _baseURI4();
            return bytes(baseURI4).length > 0 ? string(abi.encodePacked(baseURI4, tokenId.toString(), baseExtension)) : "";
        }
        else {
            string memory baseURI5 = _baseURI5();
        return bytes(baseURI5).length > 0 ? string(abi.encodePacked(baseURI5, tokenId.toString(), baseExtension)) : "";
        }
