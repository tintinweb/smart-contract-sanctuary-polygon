...
contract Parcel is ERC721, ReentrancyGuard, Ownable {
    ...
    constructor(
        string memory _name, string memory _symbol, string memory _metadata) 
    ...
    function tokenURI(uint256 tokenId) public override view returns (string memory) {
        string[13] memory i;
        i[0] = '{\n\t\"name\": \"Metaverse Parcel Testing\",\n';
        i[1] = '\t\"description\": \"Only demo for minting tokens\",\n';
        i[2] = string.concat('\t\"image\": \"', getPic(), '\",\n');
        i[3] = '\t\"dna\": \"7c1dd1dbd3671217f387cc2df3c2aa6c6118b16d\",\n'; // ! need improvate again
        i[4] = '\t\"edition\": 1,\n';
        i[5] = string.concat('\t\"date\": ', toString(block.timestamp), ',\n');
        i[6] = '\t\"attributes\": [\n';
        ...
        output = string.concat(output, i[9], i[10], i[11], i[12]);

        return bytes(output).length > 0 ? string.concat(output, toString(tokenId)): "";
    }
    ...
    function claimParcel(
        ...
        public nonReentrant {
            ...
            _mint(_to, tokenNow); // trying to minting
