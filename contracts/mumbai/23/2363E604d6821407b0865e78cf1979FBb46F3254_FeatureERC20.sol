...
// File: feature-v2/FeatureERC20.sol
...
contract ChainConstants {
    ...
    uint256 public constant CHILD_CHAIN_ID = 80001;
    bytes public constant CHILD_CHAIN_ID_BYTES = hex"013881";
}
...
contract FeatureERC20 is Initializable, NativeMetaTransaction, ChainConstants, ContextMixin, IArbitrable {
     ...
     *  @param _arbitrator The arbitrator of the contract.
     *  @param _arbitratorExtraData Extra data for the arbitrator.
     *  @param _token // Token address of the token.
    ...
    function createTransaction(
        ...
        require(
            _token.transferFrom(msgSender(), address(this), _amount),
