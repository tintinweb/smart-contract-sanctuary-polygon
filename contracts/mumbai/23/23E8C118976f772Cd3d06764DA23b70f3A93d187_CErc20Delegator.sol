...
contract CErc20Delegator is CTokenInterface, CErc20Interface, CDelegatorInterface {
    ...
    function mint(address minter, uint mintAmount) external returns (uint) {
        bytes memory data = delegateToImplementation(abi.encodeWithSignature("mint(address,uint256)", minter,mintAmount));
    ...
    function redeem(address payable redeemer,uint redeemTokens) external returns (uint) {
        bytes memory data = delegateToImplementation(abi.encodeWithSignature("redeem(address,uint256)", redeemer,redeemTokens));
        return abi.decode(data, (uint));
    }
    ...
    function redeemUnderlying(address payable redeemer, uint redeemAmount) external returns (uint) {
        bytes memory data = delegateToImplementation(abi.encodeWithSignature("redeemUnderlying(address,uint256)", redeemer,redeemAmount));
        return abi.decode(data, (uint));
    }
    ...
    function borrow(address borrower, address payable holder, uint borrowAmount) external returns (uint) {
        bytes memory data = delegateToImplementation(abi.encodeWithSignature("borrow(address,address,uint256)",borrower, holder, borrowAmount));
        return abi.decode(data, (uint));
    }
