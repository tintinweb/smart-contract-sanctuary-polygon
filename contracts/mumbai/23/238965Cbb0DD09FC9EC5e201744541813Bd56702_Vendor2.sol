...
contract Vendor2 is Ownable, PriceConsumerMaticDollar, ReentrancyGuard, AccessControl, Pausable {
...
//TOTAL SOLD PER BACTH
    ...
    constructor(address mwpAddress, address aggregator) PriceConsumerMaticDollar(aggregator) {
...
//Checks conform supply or Flag
    function witchBatchIs() public view returns(Batch batch){
        if(totalTokensSold <= MAX_SUPPLY_BATCH_1){
            return Batch.BATCH_1;
        }
        else if(totalTokensSold < MAX_SUPPLY_BATCH_2){
