...
contract RandomWinner is VRFConsumerBase, Ownable {
    ...
    uint public fee;
    // ID of public key for randomness generation
    ...
    // emit when game starts/player joins/ game ends
    ...
    constructor(address vrfCoordinator, address linkToken, bytes32 vrfKeyHash, uint vrfFee) VRFConsumerBase(vrfCoordinator, linkToken) {
        keyHash = vrfKeyHash;
        fee = vrfFee;
    }
