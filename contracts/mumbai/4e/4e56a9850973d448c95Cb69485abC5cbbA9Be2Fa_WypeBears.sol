...
contract WypeBears is ERC721("WypeBears", "WB"), ERC721Enumerable, Ownable {
    ...
    string private baseURI = "https://carolinanft.com/metadata/";
    ...
    uint256 public mintPrice = 0.4 ether; //todo
    bool public reveal = true;
    bool public mintActive;
    mapping (address => bool) public whitelist;
    mapping (address => bool) public addressMinted;
    address public whitelistSigner;//todo test
    ...
    function multiMintOwner(address account, uint256 amount) public onlyOwner {
