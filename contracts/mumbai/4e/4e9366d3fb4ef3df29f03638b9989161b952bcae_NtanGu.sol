...
- Symbol: TAG
- Decimals: 9
- Total Supply: 12 billion 12,000,000,000
- Owners Address
- Mint option: No
...
Markting : 2% in Matic
Liquidity: 2%
Reflection: 2% in Matic (Whoever holds the token will get it according to their holdings)

*/

contract NtanGu is Context, IERC20, Ownable {
    ...
    uint256 public _tTotal = 12000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string public _name = "NtanGu";
    string public _symbol = "TAG";
