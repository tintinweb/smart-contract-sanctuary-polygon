...
contract RegistrationInRace is
    Initializable,
    ...
    OwnableUpgradeable
{
    ...
    mapping(address => RegisteredUser[]) public registeredUser;
    ...
    function chetkInscriptions(
        address user
    ) external view returns (RegisteredUser[] memory) {
    ...
    function update(
        ...
        registeredUser[_user].push(
            RegisteredUser(raceId, amount, horseId, block.timestamp)
        );
    }
