...
abstract contract AbstractSale is ReferralSystem, Pausable, ISaleRound, AccessControl {
    using SafeERC20 for IERC20;
 ...
 */
contract ReferralSystem is Whitelist {
    using SafeERC20 for IERC20;
    ...
    /**
     * @dev Checks if sender or account is whitelisted
     */
