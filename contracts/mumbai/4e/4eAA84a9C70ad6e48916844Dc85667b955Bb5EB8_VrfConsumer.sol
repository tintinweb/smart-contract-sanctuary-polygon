...
contract VrfConsumer is VRFConsumerBaseV2 {
  ...
  function getRandomNumber() external onlyAdmin returns (uint256) {
  ...
  function fulfillRandomWords(
    ...
    s_requestIdToRandomWords[requestId] = randomWords[0];
  }
  ...
  modifier onlyAdmin() {
    require(admins[msg.sender] == true || msg.sender == s_owner, "Only admins can use this function");
    _;
  }
