...
// File: LuckyNumberShare.sol


pragma solidity ^0.8.7;


contract LuckyNumberShare is ERC20Burnable, Operator 
{
     using SafeMath for uint256;
    ...
    uint256 public constant OFFICE_FUND_POOL_ALLOCATION = 5000 ether;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("LuckyNumberShare", "LCS") {
        ...
        devFundRewardRate = OFFICE_FUND_POOL_ALLOCATION.div(VESTING_DURATION);
    ...
    function distributeReward(address _farmingIncentiveFund) external onlyOperator {
        ...
        _mint(communityFund, COMMUNITY_FUND_POOL_ALLOCATION);
        _mint(devFund, OFFICE_FUND_POOL_ALLOCATION);
    }
