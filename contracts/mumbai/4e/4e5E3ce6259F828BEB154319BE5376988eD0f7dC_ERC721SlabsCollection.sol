 ...
 */
contract ERC721SlabsCollection is
    ERC2771Context,
    ERC721URIStorage,
    ERC2981,
    Authorizable,
    Whitelist
{
    ...
    constructor(
        ...
        require(
            ...
            "ERC721-Collection: address must be valid"
        );
        maxRoyalty = 2000;
    ...
    function batchMint(
        ...
        for (uint8 i = 0; i < _amount; i++) {
            mint(_to, _tokenURIs[i], _feeNumerator, _receivers, _fees);
        }
    }
