...
contract Category is ERC721, Ownable {
    ...
    */
    constructor() ERC721("Category", "CAT") {}
    ...
    */
    function changeCrafter(address _newCrafter) public onlyOwner {
        require(_newCrafter != address(0), "CraftingCard: No zero address");
...
*/
     ...
     */
    function isCrafted(uint256 tokenId) public tokenExists(tokenId) view returns (bool) {
