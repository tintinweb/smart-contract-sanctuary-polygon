...
contract PrivateSale is AbstractSale, Pausable, Whitelist {
        ...
        whenNotPaused   
    {
        ...
        uint256 amountMGB = _buyMGB(amountUSD);
        ...
        whenNotPaused
    {
        ...
        uint256 amountMGB = _buyMGB(usdAmount);
...
abstract contract AbstractSale is ReferralSystem, ISaleRound, AccessControl {
    ...
    constructor(
        ...
        _periodDuration = periodDuration * 60; // minutes
...
contract Whitelist {
    ...
    /**
     * @dev Check if account is whitelisted
     ...
     * @param account array with users addresses
     * @param status array with users statuses
     */
...
interface ISaleRound {
    ...
    /**
     * @dev emits when new TGE is set
     */
    event TGE(uint256 newTGE);
    ...
    */
    ...
    /**
     * @dev Set the token generation event after which rewards will be calculating
     * @param newTGE Timestamp to set TGE
     */
    function setTGE(uint256 newTGE) external;
