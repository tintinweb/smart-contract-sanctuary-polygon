...
// File: TODO/GovernorBravoInterfaces.sol
...
contract GovernorBravoDelegateStorageV1 is GovernorBravoDelegatorStorage {
    ...
    /// @notice The address of the Libertum Protocol Timelock
    TimelockInterface public timelock;

    /// @notice The address of the Libertum governance token
    LbmVaultInterface public lbmVault;
...
// File: TODO/GovernorBravoDelegate.sol
...
contract GovernorBravoDelegate is GovernorBravoDelegateStorageV1, GovernorBravoEvents {
    ...
    string public constant name = "LIBERTUM Governor Bravo";

    /// @notice The minimum setable proposal threshold
    uint public constant MIN_PROPOSAL_THRESHOLD = 150000e18; // 150,000 lbm

    /// @notice The maximum setable proposal threshold
    uint public constant MAX_PROPOSAL_THRESHOLD = 300000e18; //300,000 lbm
    ...
    uint public constant quorumVotes = 600000e18; // 600,000 = 2% of lbm
    ...
    /**
      ...
      * @param lbmVault_ The address of the LbmVault
        ...
        public
    {
        ...
        require(lbmVault_ != address(0), "GovernorBravo::initialize: invalid lbm address");
        ...
        lbmVault = LbmVaultInterface(lbmVault_);
    ...
    function propose(address[] memory targets, uint[] memory values, string[] memory signatures, bytes[] memory calldatas, string memory description) public returns (uint) {
        ...
        require(lbmVault.getPriorVotes(msg.sender, sub256(block.number, 1)) > proposalThreshold, "GovernorBravo::propose: proposer votes below proposal threshold");
    ...
    function cancel(uint proposalId) external {
        ...
        require(
            ...
            || lbmVault.getPriorVotes(proposal.proposer, sub256(block.number, 1)) < proposalThreshold,
    ...
    function castVoteInternal(address voter, uint proposalId, uint8 support) internal returns (uint96) {
        ...
        uint96 votes = lbmVault.getPriorVotes(voter, proposal.startBlock);
