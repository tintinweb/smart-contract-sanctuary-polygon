...
contract TariNFT is ERC1155Upgradeable, ERC1155BurnableUpgradeable, ERC1155SupplyUpgradeable{
    ...
    function mint(address creator, string memory __uri, uint256 supply, uint96 fee)  public returns(uint256, bool){
