...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
	...
	function _baseURI() internal view virtual returns (string memory) {
		return "https://ipfs.io/ipfs/QmNNYUZfTSFwT3wfo3qiJzaPdtA3CJtWV9hKCv5jh1BQvg/";
	}
...
contract Nft_ALotNFT is ERC721A {

	address owner;
	event Mint (address indexed mintBy);
	uint256 public mintAmtInBank = uint256(0);

	constructor() ERC721A("ALotNFT", "ALotNFT") {
		owner = msg.sender;
		super._safeMint(msg.sender, uint256(15));
	}
 ...
 * checks that ((totalSupply) + (_amt)) is less than or equals to 72
 * checks that (amount of native currency sent to contract) is equals to ((_amt) * (50000000000000000))
 * calls super._safeMint with variable account as (the address that called this function), variable amount as _amt
 * updates mintAmtInBank as (mintAmtInBank) + ((_amt) * (50000000000000000))
 * emits event Mint with inputs the address that called this function
*/
	function mint(uint256 _amt) public payable {
		require(((totalSupply() + _amt) <= uint256(72)), "Exceeded Total Supply");
		require((msg.value == (_amt * uint256(50000000000000000))), "Wrong Fee");
		super._safeMint(msg.sender, _amt);
		mintAmtInBank  = (mintAmtInBank + (_amt * uint256(50000000000000000)));
 ...
 * calls super._safeMint with variable account as (the address that called this function), variable amount as _amount
*/
