...
abstract contract WithdrawableV2 is Teams {
  ...
  address public erc20Payable = 0xa4312A13e1F53Df0B2c2cbA40D1F700f8b118220;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "https://testing.com/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/JvXsP1MbkGuWXpYIAWt1/contract-metadata";
  }
...
// File: contracts/Erc721TestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Erc721TestContract is ERC721APlus {
    constructor() ERC721APlus("erc721test", "MINTPLEX"){}
}
