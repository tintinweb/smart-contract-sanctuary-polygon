...
contract MyNft is ERC721, Ownable, ERC2981 {
    ...
    address[] public withdrawAddresses = [0x5cd819CAa5e1fDd7b9E29dA8aE4036E85330fd21, 0x17814275E78965C6C403Ad226AC3E10778C20c3A];
    uint256[] public withdrawPercentages = [40, 60];


    bytes32 public merkleRoot = 0;

    constructor() ERC721("NFTOOL", "DEMO") {
        _baseTokenURI = "https://api.nftool.io/generator-server/api/contract/v1/QHb8ngFABWwRsPnh0/1611196989912739841/metadata/";
        _setDefaultRoyalty(0x17814275E78965C6C403Ad226AC3E10778C20c3A, uint96(500));
    }
