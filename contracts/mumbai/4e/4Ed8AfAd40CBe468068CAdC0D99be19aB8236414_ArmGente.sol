...
contract ArmGente is AccessControl {
  ...
  constructor () {
    mio = payable(msg.sender);
     address _coin = 0x2680Eb80872064Ab395fCc76db8c567C68E981F3;
    // _token = IERC20(_coin);
    GenesisPlata moneda = GenesisPlata(_coin);
    
        // return c.getValue(100);


   // address addr = 0x2E1af14F00461830050c31DdAcc180c4E0340427;
     address addr = 0xEb61708bf62C0A448f9eE1059EC45fbFdE39ff30;
...
contract GenesisPlata is ERC20, ERC20Snapshot, AccessControl, Pausable, ERC20Permit, ERC20Votes {
    bytes32 public constant SNAPSHOT_ROLE = keccak256("SNAPSHOT_ROLE");
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");

    constructor() ERC20("Genesis Plata", "GAG") ERC20Permit("Genesis Plata") {
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _grantRole(SNAPSHOT_ROLE, msg.sender);
        _grantRole(PAUSER_ROLE, msg.sender);
        _mint(msg.sender, 20000000 * 10 ** decimals());
        address testeo1 = 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4;
        transfer(testeo1,15);
