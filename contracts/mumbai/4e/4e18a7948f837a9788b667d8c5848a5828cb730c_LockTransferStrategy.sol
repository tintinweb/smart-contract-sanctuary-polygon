 ...
 * The external account could be a smart contract or EOA that must approve to the LockTransferStrategy contract address.
 * @author Aave
 **/
contract LockTransferStrategy is TransferStrategyBase {
  ...
  function updateLockRatio(uint256 newLockRatio) external onlyRewardsAdmin {
    require(newLockRatio <= 1000, "new lock ratio above 100%");
 ...
 * @author Aave
 **/
abstract contract TransferStrategyBase {
  using SafeERC20 for IERC20;
