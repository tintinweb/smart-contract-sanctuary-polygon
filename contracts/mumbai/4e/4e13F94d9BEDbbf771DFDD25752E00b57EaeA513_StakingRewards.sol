...
contract StakingRewards {
    ...
    function setToken(A0TheStupidestKidsNFTs _stakingToken, IERC20 _rewardsToken, uint _rate) public onlyOwner {
    ...
    function stake(uint _amount) external updateReward(msg.sender) {
        ...
        require(userAllNFTs > _balances[msg.sender], "You dont have nfts for staking");
        require(userAllNFTs <= _balances[msg.sender] + _amount, "You have all your NFTs in staking");
