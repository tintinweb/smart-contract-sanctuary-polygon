...
contract Alligators is
    ...
    */
    function burn(uint256 _id) external override {
        require(msg.sender == alligatorMerge || msg.sender == jokerMerge, "onlyByHubs");
        _burn(_id);
    }

    function merge(address merger) external override {
        require(msg.sender == alligatorMerge || msg.sender == jokerMerge, "onlyByHubs");
    ...
    function createSkeleton(uint8 _trait1, uint8 _trait2, uint8 _trait3, uint8 _trait4, uint8 _trait5, uint8 _trait6, uint8 _trait7) external override {
        require(msg.sender == alligatorMerge || msg.sender == jokerMerge, "onlyByHubs");
    ...
    function createLevels(uint8 _trait1, uint8 _trait2, uint8 _trait3, uint8 _trait4, uint8 _trait5, uint8 _trait6, uint8 _trait7) external override {
        require(msg.sender == alligatorMerge || msg.sender == jokerMerge, "onlyByHubs");
...
interface IAlligators is IERC721, IERC721Metadata {
    ...
    function merge(address _owner) external;
