...
/// @title The B01 NFT descriptor

pragma solidity ^0.8.6;

import { Ownable } from '@openzeppelin/contracts/access/Ownable.sol';
import { IB01Descriptor } from './interfaces/IB01Descriptor.sol';
import { IB01Seeder } from './interfaces/IB01Seeder.sol';

contract B01Descriptor is IB01Descriptor, Ownable {
    // prettier-ignore
    // https://creativecommons.org/publicdomain/zero/1.0/legalcode.txt
    bytes32 constant COPYRIGHT_CC0_1_0_UNIVERSAL_LICENSE = 0xa2010f343487d3f7618affe54f789f5487602331c0a8d03f49e9a7c547cf0499;

    // Whether or not new B01 parts can be added
    bool public override arePartsLocked;

    IB01Descriptor.AttributeRanges private attributeRanges =
        IB01Descriptor.AttributeRanges({
     ...
     */
    function getAttributeRanges() external view override returns (IB01Descriptor.AttributeRanges memory) {
...
/// @title Interface for B01Descriptor

pragma solidity ^0.8.6;

interface IB01Descriptor {
...
/// @title Interface for B01Seeder

pragma solidity ^0.8.6;

import { IB01Descriptor } from './IB01Descriptor.sol';

interface IB01Seeder {
    struct Seed {
        uint8 volumeCount;
    ...
    function generateSeed(uint256 b01Id, IB01Descriptor descriptor) external view returns (Seed memory);
}
