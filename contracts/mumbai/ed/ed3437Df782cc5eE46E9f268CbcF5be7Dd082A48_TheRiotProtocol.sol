...
contract TheRiotProtocol is ERC721, ERC721URIStorage {
    ...
    mapping(bytes32 => uint256) private groupRegistered;
    mapping(uint256 => Device) private deviceIdToDevice;
     ...
     */
    modifier checkIfDeviceIsMinted(uint256 _deviceId) {
     ...
     */
    function setSubscriberAddress(uint256 _deviceId, address _subscriber) public {
        ...
        safeTransferFrom(msg.sender, _subscriber, uint256(uint160(_deviceId)), "");
    }
     ...
     */
    function updateFirmware(bytes32 _firmwareHash, uint256 _deviceId) public {
        require(msg.sender == deviceIdToDevice[_deviceId].subscriber, "Unauthorized User");
     ...
     */
    function generateRiotKeyForSubscriber(uint256 _deviceId)
        public
        view
     ...
     */
    function getGroupContract(bytes32 _deviceGroupIdHash) public view returns (uint256) {
     ...
     */
    function isDeviceMinted(uint256 _deviceId) public view returns (bool) {
