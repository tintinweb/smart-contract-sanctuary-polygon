...
contract StakingContractV3 {
    ...
    function stake(uint256 amount) external {
        ...
        if (staker.stakedAmount > 0) {
            uint256 pendingReward = (staker.stakedAmount * rewardPerToken - staker.rewardDebt) /
            MULTIPLIER;
            rewardToken.transfer(msg.sender, pendingReward);
        }

        staker.stakedAmount += amount;
        staker.rewardDebt = (staker.stakedAmount * rewardPerToken) / MULTIPLIER;
        totalStaked += amount;
    }
    ...
    function updateRewardPerToken() internal {
        ...
        rewardPerToken = (rewardBalance * MULTIPLIER) / totalStaked;
    }
}
