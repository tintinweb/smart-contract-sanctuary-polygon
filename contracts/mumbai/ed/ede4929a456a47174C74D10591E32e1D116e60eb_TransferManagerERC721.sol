...
contract TransferManagerERC721 is ITransferManagerNFT {
    address public immutable NUWTON_EXCHANGE;

    /**
     * @notice Constructor
     * @param _rivenNFT address of the LooksRare exchange
     */
    constructor(address _rivenNFT) {
        NUWTON_EXCHANGE = _rivenNFT;
    }
    ...
    function transferNonFungibleToken(
        ...
        require(msg.sender == NUWTON_EXCHANGE, "Transfer: Only Nuwton Exchange");
