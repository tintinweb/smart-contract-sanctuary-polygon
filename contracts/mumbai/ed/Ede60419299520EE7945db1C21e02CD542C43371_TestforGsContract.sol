...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x906430207A2e29fAe4334599Ab7e7cac05aB373D];
...
// File: contracts/TestforGsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract TestforGsContract is 
    ERC1155,
    Ownable, 
    Pausable, 
    ERC1155Supply, 
    ...
    Allowlist
{
    ...
    string public name = "Test for GS";
    string public symbol = "GStest";
    ...
    */
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/q87owozzvzPl4WvmuxMG/contract-metadata";
    }
