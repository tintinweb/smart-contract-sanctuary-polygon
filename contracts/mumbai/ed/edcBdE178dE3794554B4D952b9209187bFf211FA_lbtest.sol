...
contract lbtest is VRFConsumerBase,ReentrancyGuard,Ownable {
        ...
        )
    {
        ...
        lottoWeekly = IluckblocksWeekly(0x8bB493861CD272F8fdf209Ed86013B1068ca7791);
        weeklyContract = 0x8bB493861CD272F8fdf209Ed86013B1068ca7791;
    ...
    function accumulateJackpot(uint256 amount) internal {
        ...
        if(amount > minimumPrize){
         ...
         contractBalance += amount.mul(20).div(100);
