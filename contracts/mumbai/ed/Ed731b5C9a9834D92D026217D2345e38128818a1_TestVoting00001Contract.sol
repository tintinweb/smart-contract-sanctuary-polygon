...
interface ISubNFTContract {
    function getAddressBalance(address _address, uint256 tokenId) external view returns (uint);
}
...
contract TestVoting00001Contract is Ownable {
    ...
    function vote(uint256 optionId) public payable {
        ...
        uint256 addressBalanceNFTName2 = ISubNFTContract(nftAdresses[1]).getAddressBalance(msg.sender, 1);
