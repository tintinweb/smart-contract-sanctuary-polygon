    ...
    IOperatorTransferAnyERC20Token
{
    ...
    //returns (uint256 remaining)
    {
        ...
        require(IERC20(rewardToken()).balanceOf(rewardAccount()) >= remaining, "RedemptionController: insufficient balance in reward account");
    ...
    function _redeemAt(
        ...
        if (amount > 0) {
            ...
            if (rewardAccount() == address(this)) {
                ...
                IERC20(rewardToken()).transferFrom(rewardAccount(), account, amount);
            }
