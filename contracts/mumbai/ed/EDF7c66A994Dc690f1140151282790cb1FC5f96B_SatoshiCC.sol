...
contract SatoshiCC is ERC721WithEIP2981 {
    constructor() ERC721WithEIP2981("Satoshi CC", "SATOSHI_CC") {}

    string public baseURI = "";
    uint16 mintIndex = 1;

    uint16 royaltyPercent = 500;
    ...
    function mintItem(address to) public onlyOperator nonReentrant {
        uint256 tokenId = mintIndex;
        mintIndex++;

        _safeMint(to, tokenId);

        TokenRoyaltyConfig[] memory royaltyConfigs;
        royaltyConfigs[0] = TokenRoyaltyConfig(tokenId, to, royaltyPercent);
    ...
    function supportsInterface(
        bytes4 _interfaceId
    ) public view virtual override(ERC721WithEIP2981) returns (bool) {
...
import "../custom/Operatorable.sol";

/**
 * Reference implementation of ERC721 with EIP2981 support
 */
contract ERC721WithEIP2981 is
    ERC721Enumerable,
    ...
    ReentrancyGuard
{
    ...
    function supportsInterface(
        ...
        view
        virtual
        override(ERC721Enumerable, EIP2981RoyaltyOverrideCore, AccessControl)
        returns (bool)
    {
        return
