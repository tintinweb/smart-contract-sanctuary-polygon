...
contract SnackclubTournamentsPayout {
  ...
  function claimPayment(
    ...
    bytes32 hash = prefixed(
      keccak256(abi.encodePacked(msg.sender, amount, nonce, this, tokenContract, claimableAt, secret))
    );
    require(
      recover(hash, signature) == owner_ && recover(hash, signature) != 0x0000000000000000000000000000000000000000,
