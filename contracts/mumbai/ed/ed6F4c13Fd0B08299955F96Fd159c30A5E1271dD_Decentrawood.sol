...
contract Decentrawood is ERC20 {
    ...
    uint256 public maxAllotmentByMarketingTeam =
        maxTotalSupply.mul(15).div(100);
    uint256 public totalAllotmentByMarketingTeam;
    uint256 public maxAllotmentByDevelopmentTeam =
        maxTotalSupply.mul(10).div(100);
    uint256 public totalAllotmentByDevelopmentTeam;
    uint256 public maxAllotmentByStrategicAllianceTeam =
        maxTotalSupply.mul(10).div(100);
    ...
    uint256 public airdropTokenAmount = maxTotalSupply.mul(1).div(100); //appear changes here
    uint256 public liquidityTokenAmount = maxTotalSupply.mul(4).div(100); //appear changes here

    uint256 public totalTokensAllotedTillDate;
    uint256 public currentMillion;
    uint256 public rate;

    address public constant admin = 0x3e2E7E6c8802821147c00742b2aA64167BE757b0;
    address public constant marketingTeamAddress =
        0x65c0cb0E58D0a45D294Bc0D1C37ee8C714E1372D;
    address public constant developmentTeamAddress =
        0xCe4e22E7A4f39B9C6c10B2dfb3F9430B06120DBC;
    address public constant strategicAllianceTeamAddress =
        0x1025Fe18F1eaFB52E09D74f65323026f774a8a4d;
    address public constant airdropWalletAddress =
        0x0ade893921c9f963869E1D6C501E5d3E1004Cb96;
    address public constant liquidityWalletAddress =
        0x52bD62b3fB3E72482756E8Cdb8F2Ff38cb9221a3;
    address public constant deadAddress =
        0x000000000000000000000000000000000000dEaD;

    uint256[] public REFERRAL_PERCENTS = [100, 20, 20, 20, 20, 20];
    uint256 public constant PERCENTS_DIVIDER = 1000; //appear changes here
    ...
    constructor() ERC20("Decentrawood", "Deod", maxTotalSupply) {
        ...
        rate = 500; // 1000 tokens per USDT////appear changes here
    }
        ...
        onlyAdmin
    {
        ...
        require(
            totalAllotmentByAdmin <= maxAllotmentByAdmin,
            "MAX_ADMIN_ALLOTMENT_REACHED"
        );
    ...
    function allotmentByMarketingTeam(address _address, uint256 _amount)
        ...
        onlyMarketingTeam
    {
        totalAllotmentByMarketingTeam = totalAllotmentByMarketingTeam.add(
            _amount
        );
        require(
            totalAllotmentByMarketingTeam <= maxAllotmentByMarketingTeam,
            "MAX_MARKETING_TEAM_ALLOTMENT_REACHED"
        );
        allotmentCount = allotmentCount + 1;
        Allotment memory alt = Allotment(
            allotmentCount,
    ...
    function allotmentByDevelopmentTeam(address _address, uint256 _amount)
        ...
        onlyDevelopmentTeam
    {
        totalAllotmentByDevelopmentTeam = totalAllotmentByDevelopmentTeam.add(
            _amount
        );
        require(
            totalAllotmentByDevelopmentTeam <= maxAllotmentByDevelopmentTeam,
            "MAX_DEVELOPMENT_TEAM_ALLOTMENT_REACHED"
        );
        allotmentCount = allotmentCount + 1;
        Allotment memory alt = Allotment(
            allotmentCount,
    ...
    {
        totalAllotmentByStrategicAllianceTeam = totalAllotmentByStrategicAllianceTeam
            .add(_amount);
        require(
            totalAllotmentByStrategicAllianceTeam <=
                maxAllotmentByStrategicAllianceTeam,
