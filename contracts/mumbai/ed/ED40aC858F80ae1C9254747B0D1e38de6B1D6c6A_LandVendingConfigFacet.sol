...
library LibLandVendingEnvironmentConfig {
    ...
    function initialLandVendingLoad() private {
        ...
        //owedRBW
        LibLandVending.setOwedRBW(50);

        //owedUNIM
        LibLandVending.setOwedUNIM(1000);
        ...
        LibLandVending.setDefaultTokenURIByLandType(1, "https://arweave.net/zJC5DFeJF__etw3WF7N4TncSiX8FWSoqzPuRbozwSGQ");
        LibLandVending.setDefaultTokenURIByLandType(2, "https://arweave.net/kfhl3qR16NrYpqm8Q2i8YGA4zYifhRQLQ_LcM0Olk70");
        LibLandVending.setDefaultTokenURIByLandType(3, "https://arweave.net/mtpPMtfRpL-JMZmWbfBJrf4-bQMTJ08t7ExlOtJlSOE");
        LibLandVending.setDefaultTokenURIByLandType(4, "https://arweave.net/qn1yzXs25jLxGcwRz6OgArKk5i2VFuIkA8LULZ4RyJQ");
        LibLandVending.setDefaultTokenURIByLandType(5, "https://arweave.net/FBga4yIYcCgy-Orc21d4e4aoqNdh70xMMgEX6S0dQ34");
        LibLandVending.setDefaultTokenURIByLandType(6, "https://arweave.net/gIJerj5d6voZPEXVzef3b9O9glWai55ToQPsxzYFiK8");
        LibLandVending.setDefaultTokenURIByLandType(7, "https://arweave.net/N8d42KC6nZGbxOvwGs4y5sKMFwygmvZSrF2e4McyQB8");
        LibLandVending.setDefaultTokenURIByLandType(8, "https://arweave.net/xSOneG-wa4f424zZXrga3bAAQVnLRXIqZW2JbXX0Emg");
        LibLandVending.setDefaultTokenURIByLandType(9, "https://arweave.net/rjRuYO72qNtlD6E6DdBpebVJxp99JySICxytWB3BbEw");
        LibLandVending.setDefaultTokenURIByLandType(10, "https://arweave.net/mvgtUfF2B-LX7ZpAEr8pgOs0c2WMtDs6uksmTQdv79A");
        LibLandVending.setDefaultTokenURIByLandType(11, "https://arweave.net/iPWgb7C_ubZBalIfzAw1mYw1o7fj067capp_Ol15-wY");
        LibLandVending.setDefaultTokenURIByLandType(12, "https://arweave.net/6G8vKH4mb72NERtg7DQWmQ_ZVpocMh3s-W_whL-f7dY");
        LibLandVending.setDefaultTokenURIByLandType(13, "https://arweave.net/0iFFLqfH_Vu5iWUkVfOa6Hr4HH1UiMoabCcJFK3G_EQ");
...
library LibLandVending {
    ...
    function beginKeystoneToLand(uint256 desiredPrice, uint8 landType, uint256 slippage) internal returns(uint256 tokenId, string memory fullName) {
        ...
        fullName = LibLandNames._getFullName(tokenId);
    ...
    function mintNextLandVendingToken(uint8 landType, address to) internal returns(uint256) {
        ...
        dna = LibLandDNA._setOrigin(dna, LibLandDNA.DNA_LAND_VENDING_ORIGIN);
