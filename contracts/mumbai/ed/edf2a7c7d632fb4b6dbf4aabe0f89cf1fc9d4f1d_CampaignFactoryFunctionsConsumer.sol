...
contract CampaignFactoryFunctionsConsumer is FunctionsClient, ConfirmedOwner {
    ...
    uint256 public latestLiquidityScore;
    ...
    ) external onlyOwner whenInitilized(false) {
    ...
    function getDeployedCampaigns()
        public
        view
        returns (address[] memory campaigns_)
    {
    ...
    // function getCampaignLiquidityScore(
    //     uint256 _id
    ...
    function fulfillRequest(
        ...
        uint256 liquityScore = abi.decode(response, (uint256));
        latestLiquidityScore = liquityScore;
...
contract Campaign is Ownable {
    ...
    function getCampaignInfo()
        public
        view
        returns (string memory, address, address, uint, uint)
    {
    ...
    function updatePendingWithdrawal(
        address _beneficiary,
        uint256 _amount
    ) external onlyOwner {
