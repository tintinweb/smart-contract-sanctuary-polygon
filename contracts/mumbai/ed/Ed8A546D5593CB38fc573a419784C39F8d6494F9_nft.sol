...
contract nft is ERC721, Ownable {
    ...
    address payable public shareholder2 = payable(0x74958115bCE003E512becB19f430B9f3Bb7fa72B);
    address payable public shareholder3 = payable(0x74958115bCE003E512becB19f430B9f3Bb7fa72B);
    address payable public shareholder4 = payable(0x74958115bCE003E512becB19f430B9f3Bb7fa72B);
    address payable public shareholder5 = payable(0x74958115bCE003E512becB19f430B9f3Bb7fa72B);
    ...
    */
    ...
    function presaleMint(uint256 number, uint8 _v, bytes32 _r, bytes32 _s) onlyValidAccess(_v,  _r, _s) public payable {
        ...
        require(saleState_ != State.PublicSale, "Presale has closed, Check back out during the Public Sale.");
    ...
    function publicSaleMint(uint256 number) public payable {
        State saleState_ = saleState();
        require(saleState_ == State.PublicSale, "Public Sale is not open yet!");
    ...
    function reservedMintTeam(uint number, address recipient) public onlyOwner {
        require(_reservedMintsTeam + number <= maxReservedMintsTeam, "Not enough NFTs left to mint.");
    ...
    function reservedMintGiveaways(uint number, address recipient) public onlyOwner {
        require(_reservedMintsGiveaways < maxReservedMintsGiveaways, "Not enough NFTs left to mint.");
