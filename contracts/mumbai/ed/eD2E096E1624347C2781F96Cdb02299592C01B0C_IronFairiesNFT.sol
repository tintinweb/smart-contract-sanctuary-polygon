...
contract IronFairiesNFT is ERC721, ERC721URIStorage, ERC721Enumerable, ERC721Burnable, Ownable , ReentrancyGuard{
    ...
    constructor(uint96 _royaltyFeesInBips, string memory _contractURI, string memory _baseTokenURI) ERC721("IronFairiesNFT", "IFN") {
    ...
    function safeMint(address to, uint256 tokenId) public nonReentrant onlyOwner {
        tokenIds.increment();
