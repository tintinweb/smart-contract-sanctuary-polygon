...
contract VoteEscrow is ERC1155, Ownable {
    ...
    //bytes32 immutable state;  <<< change back to immutable
    bytes32 state;
    uint256 locked;
    uint256 gameOver;
    ...
    function withdraw() external onlyOwner {
        require(block.timestamp >= gameEndTime + 10 minutes, "Cannot withdraw until one week after game end");
