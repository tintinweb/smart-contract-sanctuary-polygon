...
contract certIssuer{
    ...
    function getCertInfobyHash(string memory _hash) public view returns (Dado[] memory) {
	    ...
	    function getCertInfobyCpf(string memory _cpf) public view returns (Dado[] memory) {
        Dado[] memory indice = new Dado[](1);
