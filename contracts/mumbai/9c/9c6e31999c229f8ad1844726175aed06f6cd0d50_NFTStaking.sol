...
// File: https://github.com/minplusnft/Test/blob/main/MinerPlusToken.sol
...
contract MINERPLUS is ERC20, ERC20Burnable, Ownable {
  ...
  constructor() ERC20("MINERPLUS", "MNRP") { 
...
contract NFTStaking is Ownable, IERC721Receiver {
  ...
  mapping(uint256 => Stake) public vault; 
   ...
   constructor(ERC721Enumerable _nft, MINERPLUS _token) { 
    nft = _nft;
    token = _token;
  }
