...
contract ChainBattles is ERC721URIStorage  {
    ...
    function generateCharacter(uint256 tokenId) public view returns(string memory){
        bytes memory svg = abi.encodePacked(
            ...
            '<text x="50%" y="20%" class="base" dominant-baseline="middle" text-anchor="middle">',getJob(tokenId),'</text>',
    ...
    function getJob(uint256 tokenId) public view returns (string memory) {
        string memory job = tokenIdToCharacter[tokenId].Job;
        return job;
    }
    ...
    function mint(string memory _job) public {
        ...
        tokenIdToCharacter[tokenId] = Character(_job, 1, random(10), random(50), random(100));
    ...
    function train(uint256 tokenId) public {
        ...
        tokenIdToCharacter[tokenId].Level += 1;
        tokenIdToCharacter[tokenId].Speed += 1;
        tokenIdToCharacter[tokenId].Strength += random(10);
        tokenIdToCharacter[tokenId].Health += random(20);
