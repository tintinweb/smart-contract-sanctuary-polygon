...
contract RaffleMarketplace is Ownable, VRFConsumerBaseV2 {
    ...
    function createUpkeep(
        ...
        LINKTOKEN.transferAndCall(registarAddress, minFundingAmount, data);
    }
    ...
    function verifyRaffle(uint256 id) external invalidTickerId(id) doesRaffleExists(id) onlyOwner {
        ...
        createUpkeep(_raffles[id].raffleAddress,_raffles[id].title,gasLimit,MINIMUM_FUNDING_AMOUNT);
