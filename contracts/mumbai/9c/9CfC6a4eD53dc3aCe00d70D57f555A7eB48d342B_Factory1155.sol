...
import "./OwnEnterosportsNFT1155.sol";
...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new EnterosportsNFTUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        EnterosportsNFTUser1155Token token = EnterosportsNFTUser1155Token(address(addr));
...
contract EnterosportsNFTUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
