...
contract Game is IGame, OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable{
    ...
    modifier nonZero(uint256[12] memory positions) {
        ...
        require(valuePosition > 0, "need missiles");
        _;
    }
    ...
    function clickAffiliate(address endUser, address publisher) external onlyOwner {
    ...
    function addToWhitelistFree(address account_, uint256 freeEventId_) external onlyOwner {
