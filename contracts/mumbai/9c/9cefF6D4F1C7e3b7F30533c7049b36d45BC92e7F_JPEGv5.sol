...
contract JPEGv5 is ERC20Upgradeable, OwnableUpgradeable {
    ...
    function initialize(
        ...
        console.log("JP3G::initialize");
        console.log("_growthAddress  ",_growthAddress);
        console.log("_treasuryAddress",_treasuryAddress);
    ...
    function applyTaxes(address sender, uint amount, uint8 tax, uint64 taxDiscount) internal returns (uint newAmountTransfer) {
        ...
        uint amountAutoLiquidity = (amount * autoLiquidityFees * (MAXDISCOUNT - taxDiscount));
