...
contract GirlsLovePeace is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Girls Love Peace", "GLP") {
    setHiddenMetadataUri("ipfs://QmXZh2WqvFFK3nH7wp8FJrRyBe7A7NofUckSKSj21dcRmZ/hiddenimage.json");
  }
