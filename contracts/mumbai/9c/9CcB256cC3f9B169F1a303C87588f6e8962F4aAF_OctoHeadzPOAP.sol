...
contract OctoHeadzPOAP is ERC1155, Ownable, Whitelistable {
    ...
    constructor(address _whitelistAdmin) 
        ...
        Whitelistable(_whitelistAdmin) {
            ...
            events.push(POAP_EVENT("Summer Event", "20220705", "The best Event of the summer"));
    }
    ...
    function addTokenURI(uint256 _tokenID, string memory _tokenURI) public onlyOwner {
    ...
    function addEvent(string memory _name, string memory _date, string memory _description) public onlyOwner {
...
///////////////////////////////////////////////// Minting /////////////////////////////////////////////////
    ...
    function checkEvent(uint256 _eventID) internal {
    ...
    function mintWLNFT(uint _eventID, uint256 _numNFTz, bytes memory _proof) public isWhitelisted(keccak256(
            abi.encodePacked(
                msg.sender,
                _numNFTz
            )
