...
abstract contract Ownable is Context {
	 ...
	 */
	constructor() {
		_setOwner(0x50F92c0959cfb8a91f7c31F2C8455B1A8e48a166);
	}
...
contract Df is ERC721Enumerable, Ownable, ReentrancyGuard {

	uint256 public TOKEN_MAX_AMOUNT = 32;
	uint256 public TOKEN_PER_TX = 4343;
	uint256 public TOKEN_PER_WALLET = 4343;
	uint256 public PRICE = 4343 ether;
	uint256 public constant TIME_FOR_GROWN = 1687393996260;
	address public founder = 0x50F92c0959cfb8a91f7c31F2C8455B1A8e48a166;
	...
	string private _name = "df";
	string private _symbol = "SDFSD";
