...
contract SatoshiWeapons is ERC721Enumerable, Operatorable, ReentrancyGuard {
    constructor() ERC721("Satoshi Weapons", "SATOSHI_WEAPONS") {}

    string public baseURI = "";
    uint16 mintIndex = 1;

    function supportsInterface(bytes4 _interfaceId) public view virtual override(AccessControl, ERC721Enumerable)
    returns (bool)
  {
