...
contract NFTYDashPremium is ERC1155, Pausable, Ownable {
    ...
    uint256 public allowedPerWalletFreeClaim = 1;
    ...
    mapping(address => uint256) public mintedFreePerWallet;
    ...
    function mintFreePublic(uint256 amount_, bytes32[] calldata merkleProof_) external whenNotPaused {
        ...
        unchecked {
            mintedFreePerWallet[msg.sender] += amount_;
            minted += amount_;
        }

        require(mintedFreePerWallet[msg.sender] <= allowedPerWalletFreeClaim, "MAXED");
