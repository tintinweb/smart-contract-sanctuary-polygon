...
/* error codes */
    ...
    error GravityGrade__RebateTooLarge(uint _saleId, uint _price, uint _bulkDsc, uint _ownershipDsc);

/**@title Gravity Grade
 * @author @Haltoshi
 * @notice This contract is for managing cargo and pack drops
 */
contract GravityGrade is IGravityGrade, IGravityGrade_Transak, OwnableUpgradeable, ERC1155Upgradeable {
    /* Type Declarations */
    struct Sale {
        uint256 saleId;
        uint256 tokenId;
    ...
    */
    ...
    function _validateRebates(uint _saleId) internal {
        ...
        */
        ...
        uint postRebatePrice = (((info.salePrice * (MAXIMUM_BASIS_POINTS - sum)) / MAXIMUM_BASIS_POINTS) * (MAXIMUM_BASIS_POINTS - best)) / MAXIMUM_BASIS_POINTS;
    ...
    function _buyPacks(
        ...
        uint balance = info.salePrice * _numPurchases;
