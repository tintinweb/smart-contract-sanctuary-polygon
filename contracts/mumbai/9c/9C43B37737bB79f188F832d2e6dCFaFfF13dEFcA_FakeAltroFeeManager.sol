...
contract FakeAltroFeeManager is Initializable, OwnableUpgradeable, IFeeManager {
	...
	function initialize(
		...
		__FakeAltroFeeManager_init(_governanceTreasury, _licenseManager, _redemptionFee);
	}
	...
	function __FakeAltroFeeManager_init(
		...
		__FakeAltroFeeManager_init_unchained(_governanceTreasury, _licenseManager, _redemptionFee);
	}
