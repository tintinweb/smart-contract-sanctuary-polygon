...
contract DigitalAudioTracks is ERC1155 {
    ...
    constructor(
        ...
        //standardMintingPercentage = _standardMintingPercentage;
        //Set up Roles
    ...
    function issuerOf(bytes32 tokenId) public view returns (address) {
    ...
    function issueToken(
        ...
        emit ParadimeTokens.TokenIssued(
    ...
    function withdraw() public {
        ...
        (bool paymentSuccess,) = payable(address(this)).call{value: nativeBalance}("");
