...
contract Favour is ERC20, ERC20Burnable, Pausable, Ownable, ERC20Permit, AccessControl {

    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant BURNER_ROLE = keccak256("BURNER_ROLE");

    constructor() ERC20("Fortunes Favour", "FFAV") ERC20Permit("Favour") {
    ...
    function makeMinter(address to) public onlyOwner {
        grantRole(MINTER_ROLE, to);
    }

    function makeBurner(address to) public onlyOwner {
