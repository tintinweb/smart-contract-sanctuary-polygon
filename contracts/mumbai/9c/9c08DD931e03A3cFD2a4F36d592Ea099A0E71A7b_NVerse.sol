...
contract NVerse is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("NVerse", "NVS") {
    setHiddenMetadataUri("ipfs://QmbaikauqUq9KGRhLqnhvBCuERWSMXMNDH3dzzwCTc5o2w/hidden.json");
    ...
    buildings.push(Building("Ray House", 2,3,1,-9,0,-9));
    buildings.push(Building("Ghost House", 1,3,3,-4,0,2));
    buildings.push(Building("Beach House", 2,5,2,-2,0,5));
    buildings.push(Building("Summer House", 4,1,4,5,0,0));
    buildings.push(Building("Library", 2,2,3,-10,0,0));
    buildings.push(Building("Shed", 3,2,2,-3,0,-2));
    buildings.push(Building("Shop", 2,6,1,-10,0,0));
  }
