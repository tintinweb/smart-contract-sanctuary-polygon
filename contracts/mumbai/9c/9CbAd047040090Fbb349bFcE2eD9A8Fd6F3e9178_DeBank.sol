...
contract DeBank
{
    ...
    // At certain time users can withdraw their money and pay 0.01 ether as gas.
    function withdraw(address payable user) public 
    {
        ...
        uint value = users[msg.sender].amount - 0.01 ether;
        emit WITHDRAW (msg.sender,user,users[msg.sender].amount-0.01 ether);
    ...
    //Only owner can track the balance of the contract 
    function BalanceOfBank () public view OnlyOwner returns (uint)
    {
