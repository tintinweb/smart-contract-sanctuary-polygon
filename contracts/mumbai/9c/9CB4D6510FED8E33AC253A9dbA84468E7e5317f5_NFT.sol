...
constructor() ERC721 ("Collection Name", "SYMBL") { // construct your token, needs name and symbol
  console.log("An NFT has been minted to %s", msg.sender);
}

function mint() public { //function to create nfts

  uint256 newItemId = _tokenIds.current(); // get the tokenId

  require(newItemId < MAX_SUPPLY); // check if the total supply has been reached 
