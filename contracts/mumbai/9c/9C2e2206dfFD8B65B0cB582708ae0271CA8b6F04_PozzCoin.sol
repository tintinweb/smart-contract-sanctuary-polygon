    ...
    ERC20Upgradeable
{
    ...
    function dynamicAdjustment() public onlyRift {
        ...
        if (isIncrease) {
            uint256 maxIncreaseAmount = adjustedPozAmount * 10000 / (10000 + maxBuyPercent);
            _balanceAdjustment(true, maxIncreaseAmount >= balanceOf(address(pair)) ? 
                maxIncreaseAmount - balanceOf(address(pair)) :
                adjustedPozAmount - balanceOf(address(pair)));
        } else {
