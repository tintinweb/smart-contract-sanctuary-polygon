...
contract NFTSwap2 is ReentrancyGuard, Ownable, ERC1155Holder {
    ...
    function swap(uint256 pairId, uint256[] memory _ids,address recipient,uint256 targetId,uint256 total) public {
        ...
        uint256[] memory ids = _asSingletonArray(_ids[0]);
        uint256[] memory amounts = _asSingletonArray(total);             
   ...
   //     swap(pairno,_id,_amount,_from,1);
	...
	function onERC1155BatchReceived(
     ...
     //   mock1155.burn(address(this), _id, _amount);
        ...
        swap(pairno,_ids,_from,_ids.length,amt);
