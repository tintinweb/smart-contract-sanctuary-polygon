 ...
 * @notice This contract handles minting [TEST] ERC-1155 BTM tokens.
 */
contract TESTERC1155BTM is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xD7047d14bB6c2f77cAc6068632fA156edAcCA4eA;
    ...
    string public name = "[TEST] ERC-1155 BTM";
    string public symbol = "1155BURN";
    ...
    constructor()
        ERC1155(
            "ipfs://bafybeida3rnustvhg2ztdhrjwrfppzgndvo2ot5xu3fuo7hx3j2osnsmaa/{id}"
        )
        RevokableOperatorFilterer(
