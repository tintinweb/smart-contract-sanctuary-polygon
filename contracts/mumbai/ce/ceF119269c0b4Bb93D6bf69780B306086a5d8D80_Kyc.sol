...
contract Kyc is AccessControl {
  ...
  function changeCountryCode(
    ...
    require(countryCode[customer] != BLACKLIST, "BlackListed");
  ...
  function revokeKycs(address[] calldata toUnKyc) external onlyRole(SIGNER) {
  ...
  function canBuy(address toCheck) public view returns (bool) {
    return !cannotBuy[countryCode[toCheck]];
  }
