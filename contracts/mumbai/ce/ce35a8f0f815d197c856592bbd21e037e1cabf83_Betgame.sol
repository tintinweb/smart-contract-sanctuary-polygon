...
contract Betgame is Ownable {
    ...
    function hasBet() public view returns (bool){
        return userData[msg.sender].numTickets>0;
    }
    ...
    function hasWalletWithdrawn() public view returns (bool){
        return userData[msg.sender].withdrawn;
    }
    //check if wallet has withdrawn
