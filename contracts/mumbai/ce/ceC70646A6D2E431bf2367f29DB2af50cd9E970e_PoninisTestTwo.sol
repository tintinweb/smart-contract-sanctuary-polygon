...
/**
 *Submitted for verification at Etherscan.io on 2022-21-04
*/
...
/*
Ponini's, is an NFT collection made up of 10 Traits in 8Bit art released on the Polygon Network.
Each NFT is different, there are many combinations and 8 rarities, making your piece unique.
From horses, unicorns and pegasus, to a mixture of all of them with elemental powers.
You can find them by doing Mint.
**/

contract PoninisTestTwo is ERC721Enumerable, Ownable {  
    using Address for address;
    ...
    // Price of each token
    uint256 public initial_cost = 0.01 ether;
    uint256 public cost;

    // Maximum limit of tokens that can ever exist
    uint256 public constant MAX_SUPPLY = 20;
    uint256 public constant MAX_PRESALE_SUPPLY = 15; //Si quiero 5 NFT para Whitelist debo poner 5 mas osea 10 para PreSale y 5 para Whitelist un total de 15
    uint256 public constant MAX_MINT_PER_TX = 10;

    // Unrevealed NFT
    string public notRevealedUri = "https://storage.googleapis.com/unrevealed/PoninisNFT.gif";

    // The base link that leads to the image / video of the token
    string public baseTokenURI = "http://159.223.183.186/";

    // List of addresses that have a number of reserved tokens for whitelist
    mapping (address => uint256) public whitelistReserved;

    constructor () ERC721 ("PoninisTestTwo", "PNNTT") {
        cost = initial_cost;
    }
    ...
    function mintWhitelist(uint256 _amount) public payable {
        ...
        require(!paused,                                               "Mint is in paused" );
        ...
        require( msg.value >= needToUpdateCost(supply) * _amount,      "Wrong amount of MATIC sent" );
    ...
    function mintPresale(uint256 _amount) public payable {
        ...
        require( _amount > 0 && _amount <= MAX_MINT_PER_TX,           "Can only mint between 1 and 5 tokens at once" );
    ...
    // Set NFT Revealed true or false
    ...
    // Set a different price in case MATIC changes drastically
