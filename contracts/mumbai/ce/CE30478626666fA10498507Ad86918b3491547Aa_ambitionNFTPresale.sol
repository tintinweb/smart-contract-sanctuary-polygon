...
//    string internal baseUri;
    ...
    string public notRevealedUri = "ipfs://QmNLfUibis3JZPishAR7YZ5nZYebGXjTtxWKLCndXkyjGj/secreto.json";
    ...
    uint96 public royaltiesBps = 1000; //1000 = 10%
    ...
    constructor(
        ...
        royaltiesAddress = address(0x04F5D83627955C6bAC867e9b49261cd03fC08C9D);
        royaltiesBps = 1000;
    }
...
contract ambitionNFTPresale is ambitionNFT, Presaleable {
    constructor(
        ...
        bytes32 _mkroot,
        bool _open
    ) ambitionNFT(_uri, _name, _symbol, _totalSupply, 0.001 ether, _open) {
