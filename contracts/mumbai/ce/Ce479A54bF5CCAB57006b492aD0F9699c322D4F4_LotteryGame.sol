...
uint256[] public s_randomWords;
   ...
   /**
   * constructor inherits a VRFConsumerBaseV2 and initiates the values for keyHash, fee and gameStarted
   ...
   */
    constructor(address vrfCoordinator,uint64 subscriptionId,bytes32 vrfKeyHash) VRFConsumerBaseV2(vrfCoordinator) {
    ...
    * @param requestId  this ID is unique for the request we sent to the VRF Coordinator
    ...
    s_randomWords = randomWords;
        uint256 winnerVrf = s_randomWords[0];
        // For this we mod it with the player.length value
        uint256 winnerIndex = winnerVrf % players.length;
