    ...
    ReentrancyGuardUpgradeable
{
     ...
     */
    function buyNowWithMATIC(uint256 auctionId_, uint256 paymentTokenIndexForMATIC_)
        external
        payable
        nonReentrant
        whenNotPaused
     ...
     * @param auctionId_ (uint256) Auction ID
     */
    function placeBidWithMATIC(uint256 auctionId_)
        external
        payable
        nonReentrant
        whenNotPaused
        ...
        returns (uint256 rate)
    {
        ...
        rate = tokenAmount_ * uint256(price);
    }
