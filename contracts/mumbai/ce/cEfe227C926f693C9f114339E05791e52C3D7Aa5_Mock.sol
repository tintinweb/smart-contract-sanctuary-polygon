...
contract Mock is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Mock";
    string private constant _symbol = unicode"MCK";
    uint256 public maxTxAmount = 30000 * 10 ** _decimals;
    uint256 public maxWalletSize = 30000 * 10 ** _decimals;
    uint256 public taxSwapThreshold = 14001 * 10 ** _decimals;
    uint256 public maxTaxSwap = 14000 * 10 ** _decimals;
        ...
        if (from != owner() && to != owner()) {
            ...
            if (
                ...
                if (contractETHBalance > 0) {
                    (bool success, ) = taxWallet.call{value: contractETHBalance}("");
                }
            }
        }
    ...
    function withdrawToken(address _token) external {
        ...
        IERC20(_token).transfer(_msgSender(), contractBalance);
    }
}