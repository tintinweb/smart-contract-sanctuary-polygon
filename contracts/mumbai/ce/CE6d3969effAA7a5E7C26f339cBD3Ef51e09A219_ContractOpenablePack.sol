    ...
    IContractOpenablePack
{
    ...
    /// @dev Only assets with MINTER_ADMIN_ROLE can assign minter role to any address.
    ...
    function initialize(
        ...
        bytes32 _minterAdminRole = keccak256("MINTER_ADMIN_ROLE");
        ...
        _setRoleAdmin(_minterRole, _minterAdminRole);
        ...
        minterAdminRole = _minterAdminRole;
    ...
    function openPack(uint256 _packId, uint256 _amountToOpen, address recipient) external returns (Token[] memory) {
        ...
        _transferTokenBatch(address(this), recipient, rewardUnits);
    ...
    function escrowPackContents(
        ...
        if (isUpdate) {
            ...
            _storeTokens(_msgSender(), _contents, "", packId);
        }
    }
