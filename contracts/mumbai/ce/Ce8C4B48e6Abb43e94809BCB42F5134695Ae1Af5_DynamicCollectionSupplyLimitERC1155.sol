...
abstract contract EIP712Upgradeable is Initializable {
    ...
    function _domainSeparatorV4() internal view returns (bytes32) {
        console.logBytes32(_buildDomainSeparator(_TYPE_HASH, _EIP712NameHash(), _EIP712VersionHash()));
...
contract DynamicCollectionSupplyLimitERC1155 is SignatureMintWithParamsERC1155 {
    ...
    function verifyRequest(MintRequestWithParams calldata _req, bytes calldata _signature) internal override returns (address) {
        ...
        require(_collectionSupply < p.maxCollectionSupply, "max supply reached");
...
import "./SignatureMintWithParamsUpgradeable.sol";
...
contract SignatureMintWithParamsERC1155 is
    ...
    ERC1155Upgradeable,
    SignatureMintWithParamsUpgradeable,
    ISignatureMintERC1155
{
    using ECDSAUpgradeable for bytes32;
    using StringsUpgradeable for uint256;
    bytes internal constant TYPE = abi.encodePacked(
    ...
    bytes32 internal constant TYPEHASH = keccak256(TYPE);
    ...
    function initialize(
        ...
        __SignatureMintWithParams_init("earnalliance.com", "1", _signerAddress);
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(IERC165Upgradeable, IERC165, AccessControlEnumerableUpgradeable, ERC1155Upgradeable, SignatureMintWithParamsUpgradeable)
        returns (bool)
    {
        return
            super.supportsInterface(interfaceId) ||
    ...
    function _buildHashStruct(bytes memory _req) internal view override returns(bytes memory) {
...
import "../interfaces/ISignatureMintWithParams.sol";

import "@openzeppelin/contracts-upgradeable/utils/cryptography/ECDSAUpgradeable.sol";
import "@openzeppelin/contracts-upgradeable/utils/cryptography/draft-EIP712Upgradeable.sol";

abstract contract SignatureMintWithParamsUpgradeable is Initializable, EIP712Upgradeable, ISignatureMintWithParams {
    using ECDSAUpgradeable for bytes32;
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual returns(bool) {
        return interfaceId == type(ISignatureMintWithParams).interfaceId;
    }

    function __SignatureMintWithParams_init(string memory name, string memory version, address _signer) internal onlyInitializing {
        __EIP712_init(name, version);
        _authrorizeSigner(_signer);
    }

    function __SignatureMintWithParams_init_unchained() internal onlyInitializing {}
    ...
    function _buildHashStruct(bytes memory _req) internal view virtual returns (bytes memory);
...
import "./ISignatureMintWithParams.sol";
/**
 ...
 */
interface ISignatureMintWithParams {
    /**
