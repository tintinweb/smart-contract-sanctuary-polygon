...
// File contracts/royalties/ERC2981PerTokenRoyalties.sol
...
// File contracts/meta-transactions/ContentMixin.sol
...
// File contracts/meta-transactions/NativeMetaTransaction.sol
...
// File contracts/IllustAirdrops.sol
    ...
    ERC2981PerTokenRoyalties
{
    ...
    /**
     * Mint a new set of tokens. Cannot increase supply after minting.
     * @param to - the address to mint to
     * @param tokenId - the ID of the token
     * @param amount - the amount of tokens to mint
     * @param royaltyRecipient - the address to receive royalties
     * @param royaltyBasisPoints - basis points (0.01%) to give to the recipient.
     */
    function mint(
        address to,
        uint256 tokenId,
        ...
        // Stop minter from increasing supply.
        require(totalSupply(tokenId) == 0, "IllustAirdrops: cannot mint more");

        // Record the royalties.
        _setTokenRoyalty(tokenId, royaltyRecipient, royaltyBasisPoints);
        // Mint the tokens.
