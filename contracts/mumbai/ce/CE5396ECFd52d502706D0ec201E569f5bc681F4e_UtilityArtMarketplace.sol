...
contract UtilityArtMarketplace is Ownable, ERC721Holder, Pausable {
    ...
    function createAuction(
        ...
        uint256 _startTime,
        uint256 _endTime
    ) external whenNotPaused isNotAuction(_nft, _tokenId) {
        IERC721 nft = IERC721(_nft);
     ...
     * @param _tokenId NFT id
     */
    function completeBid(address _nft, uint256 _tokenId)
        external
        whenNotPaused
        returns (address)
    {
