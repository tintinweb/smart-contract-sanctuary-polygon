...
contract ObiDatti is ERC721Enumerable, Ownable {
    ...
    * to the owner of the contract
    ...
    // // This will pay me and the NFT artist 30% (15% each) of initial sale.
    // // =============================================================================
    // (bool artistShare, ) = payable(0xc8Bb661fd13c568F79a84ec939fFDB982ff22C80).call{value: address(this).balance * 30 / 100}("");
    // require(artistShare, "Failed to pay artist");
    // // =============================================================================
...
//  function withdraw(address payable _input_Artist_Address) public onlyOwner  {
//     // This will pay me and the NFT artist 30% (15% each) of initial sale.
//     // test with 'test account 1'
//     // =============================================================================

//     (bool artistShare, ) = payable(_input_Artist_Address).call{value: (address(this).balance * 30/100)}("");
//     require(artistShare, "Failed to pay artist");
//     // =============================================================================
//     // 'main account' is owner account
//         address _owner = owner();
