...
contract Ownable {
    ...
    function accept_ownership() public returns (bool){
...
contract TDV is Context, IERC20, IERC20Metadata,Ownable {
    ...
    uint256 private _maxSupply = 5000000*10**18;
    string private _name = "TribeDigitalVentures";
    string private _symbol = "TDV";
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        require(newAccountBalance <= maxSupply(), "ERC20: mint amount exceeds Maximum supply");
        unchecked {
    ...
    function mint(uint256 amount) public onlyOwner virtual {
