...
contract PettoStaking  is Ownable, ReentrancyGuard {
    ...
    */
    ...
    /**
    * @notice Check if the provided amount is available in the pot
    * @return bool if provided amount is available update the pot value and return true otherwise return false
    */
