...
contract LiquidityGeneratorToken is Context, IERC20, Ownable {
    ...
    address public router = 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff; // Quickswap mainnet //FIXME hardcoded address
    ...
    function burn(uint256 tAmount) public {
        (uint256 rAmount,,,,,) = _getValues(tAmount);
        _rOwned[_msgSender()] = _rOwned[_msgSender()].sub(rAmount, "ERC20: burn amount exceeds balance");
        _rTotal = _rTotal.sub(rAmount);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap { //FIXME Left over Matic from swapping
