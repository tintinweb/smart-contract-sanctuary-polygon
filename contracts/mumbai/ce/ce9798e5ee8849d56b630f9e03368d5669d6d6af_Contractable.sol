...
contract POLYTest is Contractable {
    ...
    constructor(address _usdtAddr, address _defaultRefer)   {
        Dai = IERC20(_usdtAddr);
         ...
         feeReceivers[1] = address(0xE888BB784336fCCf704C63dB944DF5E78Dc501AB); 
         feeReceivers[2] = address(0x1102f4aF63825B58feE4D4D282cAD4C4BE978Ed9);
