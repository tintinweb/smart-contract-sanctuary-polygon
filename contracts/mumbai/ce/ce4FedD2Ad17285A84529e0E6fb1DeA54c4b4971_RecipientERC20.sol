...
contract RecipientERC20 is Context, IRecipientERC20{   
    ...
    function transfer(address to, uint256 amount) public virtual override returns (bool) {
        address __owner = _msgSender();
        _transfer(__owner, to, amount);
        return true;
    }
     ...
     */
    function allowance(address __owner, address spender) public view virtual override returns (uint256) {
    ...
    function approve(address spender, uint256 amount) public virtual override returns (bool) {
        address __owner = _msgSender();
        _approve(__owner, spender, amount);
        return true;
    }
