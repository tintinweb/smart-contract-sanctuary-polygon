 ...
 */
contract TestWisdomNFT is ViciERC721v4, Named {
    constructor()
        ViciERC721v4(
            "Wisdom NFT", // collection name
            "WIS", // collection symbol
            0xFFFFFFFFFFFFFFFF // max supply (collection can be no larger than this)
        )
    {}
