...
contract bridgeCustody is IERC721Receiver, ReentrancyGuard, Ownable {
  ...
  uint256 public costNative;
  
 ERC721Enumerable nft;
   
   constructor(ERC721Enumerable _nft, uint _costNative)  {
    nft = _nft;
    costNative = _costNative;
  } 
...
function updateNativeCost(uint _newNativeCost) public onlyOwner{
    costNative = _newNativeCost;
}
