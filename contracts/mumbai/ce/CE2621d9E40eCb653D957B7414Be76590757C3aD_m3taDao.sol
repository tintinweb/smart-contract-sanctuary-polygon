...
//     :       :   : :  : :: : :  :::  :: : :       :      @@        @@     @@@    ::   :::  @@@@@@@   :: ::::  ::: ::::  @@@@@@@   :   : :  ::         ::  @@@@@@@     \\
    ...
    string private constant ORGANIZATION_SCHEMA = "founderAddress text, identifier int, OrganizationID text, groupID text, OrganizationHex text, OrganizationName text, imageURI text, description text";

    string  private _UserTable;
    uint256 private _UserTableId;
    string private constant M3TADAO_PROFILE_PREFIX = "m3taProfile";
    string private constant USER_SCHEMA = "userName text,userAddress text, identifier int, userDID text, userName text, imageURI text, description text" ;

    string  private _ProposalTable;
    uint256 private _proposalTableID;
    string private constant QUESTIONS_PREFIX = "m3taProposal";
    string private constant QUESTIONS_SCHEMA = "proposalid int, accountid text, proposer text, body text";

    string  private _VotingTable;
    uint256 private _votingTableID;
    string private constant VOTES_PREFIX = "m3taVotes";
    string private constant ANSWERS_SCHEMA = "proposalid int, accountid text, respondent text, vote int, unique(proposalid, respondent)";
        // Tableland Hiring table variables

    string  private _hireTable;
    uint256 private _hiringTableId;
    string private constant HIRE_PREFIX = "m3taHireRequest";
    string private constant HIRE_SCHEMA ="hireID int, profAddress text, accountid text, hireTitle text, hireDescription text, unique(profAddress, accountid)";
...
// 0xD504d012D78B81fA27288628f3fC89B0e2f56e24
    constructor(IValist ValistRegistryContract )
    {
        ...
        tableNames.push(_OrganizationTable);
        tableNames.push(_UserTable);
        tableNames.push(_ProposalTable);
        tableNames.push(_VotingTable);
        tableNames.push(_hireTable);
    ...
    function Proposal(
            ...
            string memory statement =
                SQLHelpers.toInsert(
                    ...
                    string.concat(
                        Strings.toString(proposalID.current()),
                        ",",
     ...
     function createHiringRequest(uint accountID , string memory hireTitle , string memory hireDescription) public  {
        ...
        string memory statement =
            SQLHelpers.toInsert(
                ...
                string.concat(
                    Strings.toString(hireID.current()),
                    ",",
                    SQLHelpers.quote(Strings.toHexString(msg.sender)),
                    ",",
                    SQLHelpers.quote(Strings.toString(accountID)),
