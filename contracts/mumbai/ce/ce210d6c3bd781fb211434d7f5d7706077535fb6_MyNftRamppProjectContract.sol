  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0xFb3808F85BAb21cbbE9827Dc5227D41336929B1b);
        ...
        */
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, "Cannot mint over supply cap of 50");
    ...
    contract MyNftRamppProjectContract is ERC721Tradable {
        ...
        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmevXhK3xT58uYANhyR45Vjif9vsaBnYA2ruwyUZbLngwX/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/haR7GrPOMo7n2PdsEuhg/contract-metadata";
        }
    }