...
//File： fs://008c665287a04b6c8560f70880dfde3f/Build.sol
...
contract Builder is DefaultOperatorFilterer, ERC721A, Ownable {
    using Address for address;
    using Strings for uint256;
    ...
    mapping(uint256 => uint256) public dayMint;

    constructor() ERC721A("SVWC 2023", "SVWC23") {
        contractUri = "https://gateway.pinata.cloud/ipfs/QmbK99BVNQUeBFsSbmczgLMcgDNAyFAttCPq5JqQotmuxL";
    ...
    function mint(uint256 _mintAmount, address payable _endUser, string memory _cid, uint256 day) public onlyOwner {
    ...
    function dayCountDay(uint256 _day) external view returns (uint256) {
        return dayMint[_day];
    }
