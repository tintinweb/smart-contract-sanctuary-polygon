...
interface IERC20{
    ...
    //Devuelve el número de token que el spender podrá gastar en nombre del owner
...
contract ERC20 is Context, IERC20 {
    ...
    function tokenTransfer(address to, uint256 amount) public virtual override returns (bool) {
...
contract PerpetualToken is ERC20, Pausable, Ownable {

    // Price in WEI. 1 ETH = 1000000000000000000 WEI

    constructor () ERC20("Perpetual Token", "PPT", 100000000, 800000000000000){}
    ...
    function buyTokens(uint256 amount) public payable {
        ...
        require(amount <= balanceOf(address(this)), "Buy less PPT");
