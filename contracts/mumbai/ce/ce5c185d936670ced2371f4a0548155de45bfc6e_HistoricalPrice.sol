...
contract HistoricalPrice is KeeperCompatibleInterface, Ownable {
    AggregatorV3Interface internal priceFeed;
    uint256 public historicalPrice;
    uint256 public targetDatetime;
    bool public requestCompleted;
    string public pricePairName;
    ...
    function _fetchHistoricalPrice() private view returns (uint256) {
        ...
        uint80 startRound = 0;
        uint80 endRound = currentRound;
        uint256 targetTimestamp = targetDatetime;
    ...
    function _customCallbackLogic() private {
        // Add custom logic here, e.g. updating the protocol's internal oracle for option contract settlement.
    }
}