...
contract DxCollTest is ERC721A, Ownable, ReentrancyGuard {
  ...
  IERC721AQueryable private bxCol1NFT;
  ...
  constructor(
    ...
    bxCol1NFT = IERC721AQueryable(bxCol1Contract);
  }
  ...
  function whitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    if (bxCol1NftCount >= 50) {
      ...
      revert('Insufficient BxCol1 NFT holdings!');
    }
