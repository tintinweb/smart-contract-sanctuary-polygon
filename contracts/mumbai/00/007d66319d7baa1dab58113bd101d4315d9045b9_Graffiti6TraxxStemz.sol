...
abstract contract ErrorCodes {
    ...
    int32 internal constant INVALID_PAYABLE_AMOUNT = 58;
    int32 internal constant INVALID_WITHDRAWABLE_AMOUNT = 59;
    int32 internal constant EXCEEDED_TOKEN_LIMIT = 60;
    int32 internal constant EXCEEDED_MINT_LIMIT = 61;
    int32 internal constant EXCEEDED_INDIVIDUAL_TOKEN_LIMIT = 62;
...
contract Graffiti6TraxxStemz is ERC721AUpgradeable, IERC2981, AccessControlEnumerableUpgradeable, ErrorCodes {
    ...
    uint256 public constant MINT_PRICE = 0.0000303 ether; // CHANGE THIS AFTER TESTING
    ...
    function mint(uint256 quantity, string[] calldata uris,  bytes32[] memory proof) external payable {
        ...
        require(quantity == uris.length, throwError(INVALID_FUNCTION_PARAMS));
    ...
    function internalMint(address to, uint256 quantity, string[] calldata uris) external onlyAdmin{
        require(quantity == uris.length, throwError(INVALID_FUNCTION_PARAMS));
