...
contract DT_Token is IDT_Token, ContextMixin, ERC721Enumerable, IERC2981, NativeMetaTransaction, AccessControl {
    using Strings for uint256;

    bytes32 public constant MINTER_ROLE    = keccak256(   "MINTER_ROLE");
    bytes32 public constant CONTRACT_ADMIN = keccak256("CONTRACT_ADMIN");
 
    uint256                     internal    collectionRoyaltyAmount;
    ...
    constructor(
        ...
        uint256 _collectionRoyaltyAmount
    ) ERC721(_name, _symbol)
    {
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _setupRole(CONTRACT_ADMIN, _msgSender());
        tokenBaseURI = _tokenBaseURI;
        collectionRoyaltyAmount = _collectionRoyaltyAmount;
    }
  ...
  /**
   * Override isApprovedForAll to auto-approve OS's proxy contract as shown here
