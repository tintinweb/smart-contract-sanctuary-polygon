...
contract ZAMNFT is ERC721Enumerable, Ownable {
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    require(level1+_mintAmount <= 1400,"NFT is left or mint amount is too big");
    ...
    require(level2+_mintAmount <= 500, "NFT is left or mint amount is too big");
    ...
    if(thirdLevel[msg.sender] == true ){
      ...
      require(level3+_mintAmount<= 100, "NFT is left or mint amount is too big");
     ...
     if(secondLevel[msg.sender]!=true && thirdLevel[msg.sender]!=true){
      ...
      require(level1+_mintAmount <= 7000, "NFT is left or mint amount is too big");
    for (uint256 i = 0; i < _mintAmount; i++) {
      _safeMint(msg.sender, level1 + i);
    }
    level1 = level1+_mintAmount; 
    ...
    if(secondLevel[msg.sender] == true){
      ...
      require(level2+_mintAmount <= 8500, "NFT is left or mint amount is too big");
     for (uint256 i = 0; i <_mintAmount;i++){ 
     _safeMint(msg.sender, level2 + i);
    }
    level2 = level2+_mintAmount;
