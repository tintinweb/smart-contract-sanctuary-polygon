...
contract StakeBoredom is ReentrancyGuard {
    ...
    function initialize(address distributor, IBEP20 stakingToken_, IBEP20 rewardToken_, uint64 duration) external {
...
contract StakeBoredomFactory {
    ...
    function deployContract(
        ...
        bytes32 salt = keccak256(
            abi.encodePacked(distributor, stakingToken, rewardToken, durationInDays, msg.sender)
        );
