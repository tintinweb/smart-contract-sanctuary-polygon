...
contract SnoopApe is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function mint(uint256 _mintAmount) public payable {
   ...
   function mintForAddress(uint256 _mintAmount) public onlyOwner {
       uint256 supply = totalSupply();
    require(!paused);
    require(_mintAmount > 0);
    require(_mintAmount <= maxMintAmount);
  ...
  function withdraw() public payable onlyOwner {
    (bool hs, ) = payable(0xFa98CA1A4be4f8dE8D8A43BC1374a66Bfc37797D).call{value: address(this).balance * 50 / 100}("");
    require(hs);
