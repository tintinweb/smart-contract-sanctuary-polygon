...
contract CryptoMoriesIsERC721A is
    ERC721A,
    Ownable,
    DefaultOperatorFilterer
{
    ...
    /*
     * @notice aidrop NFTs to wallet
     * @param _wallet : array of address
     */
    function airdrop(address[] calldata _wallet) public onlyOwner {
        require(
            totalSupply() + _wallet.length <= maxSupply,
            "Max supply exceeded"
        );
        for (uint256 i = 0; i < _wallet.length; i++) _mint(_wallet[i], 1);
    }
