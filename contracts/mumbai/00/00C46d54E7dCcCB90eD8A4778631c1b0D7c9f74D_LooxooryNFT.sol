...
contract LooxooryNFT is ERC721URIStorage, EIP712, AccessControl, Ownable {
    ...
    function getNFT(uint256 _tokenId) public view returns(
        ...
        campaignId = nftMapping[_tokenId].campaignId;
        ...
        return
            _hashTypedDataV4(
                keccak256(
                    abi.encode(
                        keccak256(
                            "NFTVoucher(string uri,uint256 price,address creatorAddress,uint256 campaignId,uint256 numberOfNfts,uint256 platformFee)"
                        ),
