...
contract HyphenProvider is Ownable, ReentrancyGuard {
	...
	function transferNative(address _from, address _receiver, uint256 toChainId, address tokenAddress, uint _amount) public payable nonReentrant {
		...
		emit FundsTransferred(_receiver, toChainId, msg.value, tokenAddress);
	}
}
