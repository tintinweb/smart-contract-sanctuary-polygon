...
interface NftInterface {
    ...
    function mint(address _to, uint16 _avatarType, uint64[] calldata _attributes) external;
    ...
    function updateAvatar(uint256 _targetId, uint16 _mintType, uint64[] calldata _attributes) external;
...
contract CustomContract is Pausable, AccessControl, ReentrancyGuard {
    ...
    constructor(NftInterface _nft, uint128 _nrOfRecycledNfts) {
    ...
    function recycle(
        ...
        for (i = 0; i < _tokenIds.length; i++) {
            ...
            uint64[] memory currentTokenParts;
            ...
            if (currentToken.partPosition.length > 0) {
                ...
                currentTokenParts = currentAvatar.attributes;
    ...
    function getAvatarDetails(uint256 _tokenId) external view returns (uint8, uint16, uint16, uint64[] memory) {
