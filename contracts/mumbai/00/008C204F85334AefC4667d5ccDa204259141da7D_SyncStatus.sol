...
contract SyncStatus {
    ...
    function updateStatus(address _receiver, uint64 _dstChainId, uint8 _status) external payable {
        ...
        MessageSenderLib.sendMessage(_receiver, _dstChainId, message, messageBus, msg.value);
    ...
    function calcFee(uint8 _status) external view returns (uint256) {
        ...
        IMessageBus(messageBus).calcFee(message);
    }
}
