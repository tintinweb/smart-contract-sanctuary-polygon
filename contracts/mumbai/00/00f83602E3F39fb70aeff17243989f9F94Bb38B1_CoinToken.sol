...
event subEvent(uint256 a, uint256 b) ;
    ...
    function sub(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        //return sub(a, b, Strings.toString(a));
    }
...
contract CoinToken is IBEP20 {
    ...
    constructor ()  {
        ...
        string memory _name = "TESTSHI";
        string memory _symbol = "TESTSHI";
        uint256 _decimals = 18;
        uint256 _supply = 1000000000000;
        uint256 _txFee = 0;
        uint256 _burnFee = 0;
        uint256 _charityFee = 0;
        address _FeeAddress = 0x74Cc651166d5775E6ddB46b5382C8d33F13d3A0a;
        address tokenOwner = 0x74Cc651166d5775E6ddB46b5382C8d33F13d3A0a;
