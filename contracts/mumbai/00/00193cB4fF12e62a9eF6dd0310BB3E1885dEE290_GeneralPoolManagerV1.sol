...
contract GeneralPairPoolV1 is IGeneralPoolV1, ERC1155Supply, Pausable {
    ...
    function addLiquidity() external override onlyPoolManager whenNotPaused {
...
contract GeneralPoolManagerV1 is IGeneralPoolManagerV1, BasePoolManagerV1 {
    ...
    function createGeneralPairPool(
        ...
        GeneralPairPoolV1(pool).addLiquidity();
    }
...
interface IGeneralPoolManagerV1 {
