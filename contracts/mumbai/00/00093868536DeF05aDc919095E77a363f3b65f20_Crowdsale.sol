    ...
    contract Crowdsale {
        ...
        function buyTokens() public payable {
            ...
            require (supply >= 0, "The token cap has been reached.");
                if (vestingInfo[msg.sender].user == msg.sender) {
                ...
                tokens = 0;
                vestingInfo[msg.sender].dailyVestedTokens = (vestingInfo[msg.sender].totalVestedTokens); //MODIFICAR A (vestingInfo[msg.sender].totalVestedTokens/365);
            }
        ...
        function claimVesting() public {
            ...
            accumulateVesting();
            require(vestingInfo[msg.sender].claimAmount > 0, "No tokens available for claim");
            //if (vestingInfo[msg.sender].user == msg.sender) {
                token.transfer(msg.sender, vestingInfo[msg.sender].claimAmount);
        ...
        function accumulateVesting() internal {
            timeStart2 = block.timestamp;
            currentTime = block.timestamp;
            timePassed = currentTime - timeStart2;
            daysPassed = 1; //MODIFICAR A timePassed / 86400;
            //calculateDailyVestingToken();
            vestingdaily = vestingInfo[msg.sender].dailyVestedTokens;
            accumulatedTokens = daysPassed * vestingdaily;
            vestingInfo[msg.sender].claimAmount = accumulatedTokens;
            accumulatedTokens = 0;
            timeStart2 = block.timestamp;
        }
        
        function calculateDailyVestingToken() internal returns (uint256) {
            vestingdaily = Crowdsale.vestingInfo[msg.sender].dailyVestedTokens;
            return vestingdaily;
        }
