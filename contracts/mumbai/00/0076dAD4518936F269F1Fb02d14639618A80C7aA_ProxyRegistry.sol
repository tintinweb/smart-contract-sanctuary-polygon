...
contract ProxyRegistry is IProxyRegistry, AccessManager {
    ...
    constructor(IRoleRegistry roleRegistry) AccessManager(roleRegistry) {}
...
contract AccessManager {
    IRoleRegistry internal immutable roleRegistry;
...
library Roles {
    ...
    bytes32 internal constant COLLECTION_APPROVER = "collection_approver";
