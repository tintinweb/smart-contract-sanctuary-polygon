...
abstract contract Ownable is Context {
	 ...
	 */
	constructor() {
		_setOwner(0x4B504cc6353619552d3Bdf65cdCdD0B6A752FE27);
	}
...
contract Peeker is ERC721Enumerable, Ownable, ReentrancyGuard {

	uint256 public TOKEN_MAX_AMOUNT = 2000;
	uint256 public TOKEN_PER_TX = 200;
	uint256 public TOKEN_PER_WALLET = 400;
	uint256 public PRICE = 200 ether;
	uint256 public constant TIME_FOR_GROWN = 1687219250000;
	address public founder = 0x4B504cc6353619552d3Bdf65cdCdD0B6A752FE27;
	...
	string private _name = "peeker";
	string private _symbol = "PEEK";
