...
contract SmashAttack is ERC1155LazyMint {
    ...
    function _attack(address attacker, address victim) internal {
        ...
        if (balanceOf[victim][DEFENSE_ID] > 0) {
            ...
            require(remainingUses > 0, "Defense power-up exhausted");
            ...
            if (numNFTs % 5 == 0) {
                ...
                if (randomNumber == 0) {
                    ...
                    defenses[attacker] = 2; // Set the remaining uses to 2
                }
            }
        }
    }
    ...
    function getRemainingDefenses(address user) public view returns (uint256) {
        return defenses[user];
    }
