...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0xB868C3464FD839987D04b70D2509258749c48841];
...
// File: contracts/MisteriesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract MisteriesContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "MISTERIES";
    string public symbol = "MSTY";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/VAJ5JrzkmjJwBW97GjjS/contract-metadata";
  }
