...
contract BetLiquidityPool is LiquidityPool, IBetLiquidityPool {
    ...
    uint8 internal constant MAX_LP_BET_PERCENT = 90;
    ...
    {
        uint256 betLimit = getFullBalance(tokenAdd).mul(MAX_LP_BET_PERCENT).div(100);
...
abstract contract LiquidityBox is ILiquidityBox, TokenValidator {
    ...
    function deposit(
        ...
        if (feePermille > 0) {
            ...
            // Update the pools rewards, before minting lpTokens
