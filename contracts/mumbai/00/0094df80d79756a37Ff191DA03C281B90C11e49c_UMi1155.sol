...
/**
 * @title UMi1155
 * UMi1155 - ERC1155 contract with IPFS support
 */
contract UMi1155 is ERC1155, Ownable {
    ...
    function prepare(
        ...
        require(
            ...
            "UMi1155: Only the proxy address can prepare nfts"
        );
        require(
            _metadataToId[metadata] == 0,
            "UMi1155: Trying to push same metadata to another id"
        );
        uint256 id = uint256(
            keccak256(
    ...
    function mint(
        ...
        require(canMint, "UMi1155: Max supply reached");
