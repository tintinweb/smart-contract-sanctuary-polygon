...
contract HeyMintERC1155Reference {
  ...
  function presalePriceInWei(uint16 _tokenId) external view returns (uint256) {}
  ...
  function getSettings()
    external
    view
    returns (BaseConfig memory, AdvancedConfig memory, bool, uint16[] memory)
  {}
  ...
  function setTokenUri(uint16 _tokenId, string memory _newTokenURI) external {}
  ...
  function burnPaymentInWei(uint16 _tokenId) external view returns (uint256) {}
  ...
  function refundPriceInWei(uint16 _tokenId) external view returns (uint256) {}

  function setBurnClaimState(uint16 _tokenId, bool _burnClaimActive) external {}
  ...
  function updateMintsPerBurn(uint16 _tokenId, uint8 _mintsPerBurn) external {}
  ...
  function setFreeClaimState(uint16 _tokenId, bool _freeClaimActive) external {}
