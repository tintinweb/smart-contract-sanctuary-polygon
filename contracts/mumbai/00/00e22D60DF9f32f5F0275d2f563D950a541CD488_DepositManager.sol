...
contract DepositManager is OwnableUpgradeable, UUPSUpgradeable {
    ...
    function addDeposit(address _tokenAddress, uint256 _amount) external {
        ...
        uint256 storagePurchased = _amount.mul(stableTokenRate[_tokenAddress]).mul(costOfStorage()).div(10**decimals).div(
            10**6
        );
        ...
        emit AddDepositEvent(msg.sender, _tokenAddress, _amount, _costOfStorage, storagePurchased);
    }
