...
contract PlushNFTCashbackPool is Initializable, PausableUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    {
        idsBalances[_wallet].push(idsBalances[_wallet].length - 1);
        balanceInfo[idsBalances[_wallet].length - 1].balance = _amount;
        balanceInfo[idsBalances[_wallet].length - 1].timeIsActive = block.timestamp + _timeUnlock;
    }
