    ...
    ICollectionPoolFactory
{
    ...
    function validatePoolParamsLte(
        ...
        LPTokenParams721 memory poolParams = viewPoolParams(tokenId);
        return (
            poolParams.nftAddress == nftAddress && poolParams.bondingCurveAddress == bondingCurveAddress
                && poolParams.fee <= fee && poolParams.delta <= delta && poolParams.royaltyNumerator <= royaltyNumerator
        );
    }
