...
/**
    ...
    */
    ...
    contract Pruebaangel {
        using SafeMath for uint256;
        using SafeMath for uint8;

        uint256 constant public INVEST_MIN_AMOUNT = 0.01 ether; // 0.01 MATIC
        ...
        constructor(address payable wallet, address payable _developer) public {
            ...
            startUNIX = block.timestamp.add(100 minutes);

            plans.push(Plan(5, 80)); // 8% per day for 14 days
