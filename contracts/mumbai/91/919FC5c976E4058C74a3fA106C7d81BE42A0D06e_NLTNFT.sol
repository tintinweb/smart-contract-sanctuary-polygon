...
contract NLTNFT is ERC1155, Ownable {
    ...
    uint256 public constant TIER0 = 0;
    ...
    uint256 public maxSupply0;
    uint256 public maxSupply1;
    ...
    constructor() ERC1155('https://nlt.rocks/metadata/'){
        mintPrice0 = 1 ether;
        mintPrice1 = 2 ether;
        mintPrice2 = 4 ether;
        totalSupply0 = 1;
    ...
    function  mint(uint256 id) payable public{
        ...
        if(id == 0){
            require(totalSupply0 <= maxSupply0,'Max supply reached');
            require(msg.value == mintPrice0,'wrong mint price should be id 0');
            totalSupply0 ++;
        }
        if(id == 1){
            require(totalSupply1 <= maxSupply1,'Max supply reached');
            require(msg.value == mintPrice1,'wrong mint price should be id 1');
            totalSupply1 ++;
        }
        if(id == 2){
            require(totalSupply2 <= maxSupply2,'Max supply reached');
            require(msg.value == mintPrice2,'wrong mint price should be id 2');
            totalSupply2 ++;
        }
