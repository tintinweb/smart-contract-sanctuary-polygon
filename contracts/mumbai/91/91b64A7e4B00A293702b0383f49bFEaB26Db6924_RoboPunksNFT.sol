...
contract RoboPunksNFT is ERC721, Ownable {
    ...
    string constant baseTokenUri =
        "https://gateway.pinata.cloud/ipfs/QmdB7t21FQyn2AEiYDu4pnbn6Sb2ArMcojuMRE3N649ddo/";
    address payable public withdrawWallet;
    mapping(address => uint256) public walletMints;

    event mintActivated(uint256 time, address owner);
