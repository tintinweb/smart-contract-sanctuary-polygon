...
contract DisputeResolvers is Mappings, IDisputeResolution {
    ...
    function stake() external override returns (bool) {
        ...
        require(usersStake[tx.origin] == 0, "Already Staked");
    ...
    function createDispute(
     ...
     function processVerdict(
        ...
        address verdictProvider = ProcessData.rsvExtracotr(hash_, signature_);
        ...
        require(
            verdictProvider == tx.origin,   
            "Signature Not Verified"
        );

        require( verdictProvider != disputeRooms[betAddress_].betCreator && verdictProvider != disputeRooms[betAddress_].betTaker,
                 "Verdict Provider can not be Bet Initiater or Bet Taker");
        ...
        returns (bool status_)
    {
        ...
        uint256 temp = userInitialStake[user_] - amount_;
