...
contract MetaStarNFTV2 is ERC721URIStorage, Ownable {
    ...
    */
    ...
    function changeMintFee_0(uint256 newFee) public onlyAdmin {
        s_mintFee_type0 = newFee;
    }

    function changeMintFee_1(uint256 newFee) public onlyAdmin {
        s_mintFee_type1 = newFee;
    }

    function changeMintFee_2(uint256 newFee) public onlyAdmin {
        s_mintFee_type2 = newFee;
    }

    function changeMintFee_3(uint256 newFee) public onlyAdmin {
