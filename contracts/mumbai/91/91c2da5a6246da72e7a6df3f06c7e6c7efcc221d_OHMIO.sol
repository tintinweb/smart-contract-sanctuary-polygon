...
contract OHMIO is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20FlashMint {
    constructor() ERC20("OHMIO", "OHMIO") {
        ...
        override(ERC20, ERC20Snapshot)
    {
      ...
      // Método para emitir tokens de acuerdo a la potencia
    function mintTokensWithPower(address to, uint256 amount) public onlyOwner {
        _mint(to, amount);
    }

    // Método para liberar tokens de acuerdo a la potencia
    function freeTokensWithPower(address to, uint256 amount) public onlyOwner {
        _mint(to, amount);
    }
}