...
contract Ratings is Ownable, IRatings{
    ...
    struct RatingBoundDto{
        uint256 Min;
        uint256 Max;
    }

    struct RatingDefinitionDto{
       RatingBoundDto Field1Bound;
       RatingBoundDto Field2Bound;
       RatingBoundDto Field3Bound;
       RatingBoundDto Field4Bound;
       RatingBoundDto Field5Bound;
    }
    ...
    // Rating settings
    RatingDefinitionDto _definition = RatingDefinitionDto(
        RatingBoundDto(0,5),
        RatingBoundDto(0,5),
        RatingBoundDto(0,5),
        RatingBoundDto(0,5)
    ...
    */
    function setRatingDefinition(RatingDefinitionDto memory definition) public onlyOwner{
    ...
    function validateUrl(string memory url) public pure returns(bool){
        ...
        string memory firstSection = substring(url, 0, 8);
        require(compareStrings(firstSection, "https://"), "Url must start with 'https://'");
