...
contract ArtistMoonBoxNft is Context, Ownable {
    ...
    event SetMoonshootLimit(
        address indexed account,
        uint256 moonBoxId,
        uint256 moonshootTokens
    );
    address public authAddress;
    address payable private constant feeAddress =
    ...
    function setMoonshootLimit(uint256 moonBoxId, uint256 moonshootTokens)
        external
        onlyOwner
    {
        moonshootLimit[moonBoxId] = moonshootTokens;
        emit SetMoonshootLimit(_msgSender(), moonBoxId, moonshootTokens);
    }
