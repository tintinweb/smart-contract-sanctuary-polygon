...
//counter for the nested mapping
  mapping (address => uint) public cntToMint;
...
// mint several tokenIds
  ...
  function checkbalanceErc1155 (uint tokenId) public view  returns(uint){
 ...
 function removeRegularWhitelistUser(address _user) public onlyOwner {
  ...
  // function deleteBurnerList(address _receiver) public onlyOwner {
  //   delete cntToMint[_receiver];
  //   delete openseaCollection[_receiver][1];
  // }
