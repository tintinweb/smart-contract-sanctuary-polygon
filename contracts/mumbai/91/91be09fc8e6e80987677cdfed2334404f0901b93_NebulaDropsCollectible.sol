...
contract NebulaDropsCollectible is ERC1155, Ownable {
    ...
    address public defaultNebulaMarketplace;
    ...
    constructor(string memory _name, string memory _uri, address _nebulaMarketplace) ERC1155(_uri) 
    {
        setURI(_uri);
        setName(_name);
        defaultNebulaMarketplace = _nebulaMarketplace;
    }
    ...
    function mint(uint256 _amount, bool _cardpay) 
        public  payable  
     {
       ...
       // if(mintedTokensByArtists[_dropid].tokensMinted > 0){
        ...
        _setApprovalForAll(_msgSender(), defaultNebulaMarketplace, true);
    ...
    function mintBatch(
       // uint256 _initialId,
     //address _nebulaMarketplace, 
     uint256 _amount, uint256  _totalNoOfTokens, bool _cardpay) 
        public payable
    {
        // string memory _name, string memory _newuri, 
        ApprovedArtists4Minting memory _approvedArtist =   allowArtistToMintTokens[msg.sender];
        ...
        _totalMintedTokens += _totalNoOfTokens;// _ids.length;
        ...
        uint256[] memory _ids= new uint256[](_totalNoOfTokens);
        uint256[] memory _amounts = new uint256[](_totalNoOfTokens); 
        uint index = 0;
        for(uint256 i = (lastMintedTokenId+1); i<= (lastMintedTokenId + _totalNoOfTokens); i++ ){
            _ids[index] = i;
        ...
        /* Set last minted Token Id..*/
        lastMintedTokenId = _ids[_totalNoOfTokens-1];
