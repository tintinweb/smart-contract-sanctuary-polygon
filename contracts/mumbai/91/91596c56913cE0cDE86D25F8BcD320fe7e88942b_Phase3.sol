...
contract Phase3 is ERC721, ERC721Burnable,DefaultOperatorFilterer, ERC721Enumerable, Ownable{
    ...
    /* 
    @dev This function will burn the ticket, and mint a new NFT dor phase 2 with same tokenID as Phase1, before calling this function
        make sure you have taken the allowance of tokenId from the phase1 and vial claim contract
    ...
    */
    function merge(uint256 phase1TokenId, uint256 artVialTokenId) public {
        ...
        require(IERC721(phase1NFTAddress).ownerOf(phase1TokenId) == msg.sender, "Phase3: You are not the owner of Phase1 NFT");
        require(IERC721(artVialNFTAddress).ownerOf(artVialTokenId) == msg.sender, "Phase3: You are not the owner of Phase2 NFT");
    ...
    function updatePhaseAddresses(address phase1Address_, address artVialAddress_) external onlyOwner{
        require(phase1Address_ != address(0), "Phase3: Phase1 address cannot be zero address");
        require(artVialAddress_ != address(0), "Phase3: Art Vial address cannot be zero address");
