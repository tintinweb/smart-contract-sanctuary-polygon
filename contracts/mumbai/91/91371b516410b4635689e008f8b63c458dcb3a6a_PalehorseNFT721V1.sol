...
contract PalehorseNFT721V1 is ERC721 {
    ...
    function mint(string memory tokenUri ,uint256 fee) public {
        ...
        _mint(msg.sender, tokenCounter, fee);
        _setTokenURI(tokenCounter, tokenUri);
         

    }

    function LazyMint(address payable creator, NFTVoucher calldata voucher)
        public
        payable
        returns (uint256)
    {
        ...
        _safeMint(signer, tokenCounter, voucher.royality);
        _setTokenURI(tokenCounter, voucher.tokenUri);
        // transfer the token to the redeemer
        _transfer(signer, msg.sender, tokenCounter);
