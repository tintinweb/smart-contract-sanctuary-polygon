  ...
  OnlyDelegateCall
{
  ...
  // We want to block direct initialization to prevent implementation takeover
  function initialize(
    bool canTransfer_,
    bool canTransferFromContracts_,
    string memory collectionName_,
  ...
  /*
   * Set the origin hash to authenticate the original ordering of the tickets
   */
