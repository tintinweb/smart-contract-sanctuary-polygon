...
contract GTokenLockedDepositNftDesign is IGTokenLockedDepositNftDesign {
            ...
            abi.encodePacked(
                ...
                Base64.encode(
                    abi.encodePacked(
                        ...
                        generateBase64Image(
                            tokenId, lockedDeposit, gTokenSymbol, assetSymbol, numberInputDecimals, numberOutputDecimals
                        ),
    ...
    function numberToRoundedString(uint256 number, uint8 inputDecimals, uint8 outputDecimals)
        public
        pure
