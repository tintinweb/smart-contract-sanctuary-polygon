...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmdJxW1dTxubb28aawpKYQVMvL6C15RmdiezYt1vejBLHo/";
...
// File: contracts/ApeartContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ApeartContract is RamppERC721A {
    constructor() RamppERC721A("APE ART", "AA"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/G0i6kO3ZquR6G7frGvk7/contract-metadata";
    }
}
