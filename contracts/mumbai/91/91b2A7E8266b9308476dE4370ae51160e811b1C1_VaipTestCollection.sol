 ...
 * @notice This contract handles minting Vaip Test Collection tokens.
 */
contract VaipTestCollection is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x3953bf23E42e6238b74fcC7ce01cbd64c503a98b;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x599D3F7D2690335b49d3bf37a0c57c572F27e3C7;
    address[] public payoutAddresses = [
        0x599D3F7D2690335b49d3bf37a0c57c572F27e3C7
    ];
    ...
    string public name = "Vaip Test Collection";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeihuk5twxtlcww4qor227g4uu7z62ti2dks4u5kriwzalnw2yxtbhu/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenPublicMintsPerAddress[2] = 25;
        require(
