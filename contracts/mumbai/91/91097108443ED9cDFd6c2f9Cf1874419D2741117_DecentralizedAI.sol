...
contract DecentralizedAI {
    ...
    event ApiKeyGenerated(uint256 model_id, address indexed user, address indexed owner, uint256 api_key, string request_source);
    ...
    function requestApiKey(uint256 model_id, address payable owner, uint256 max_tokens, string calldata request_source) public payable returns (uint256) {
        ...
        emit ApiKeyGenerated(model_id, msg.sender, owner, api_key, request_source);
        return api_key;
    }
