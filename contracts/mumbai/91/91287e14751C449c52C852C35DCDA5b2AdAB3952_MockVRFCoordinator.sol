 ...
 */
contract MockVRFCoordinator is VRF, VRFRequestIDBase {
    ...
    sufficientLINK(_feePaid, _keyHash)
  {
    ...
    fulfillRandomnessRequest(_keyHash, requestId);
  }
  ...
  /**
   * @notice Called right after randomnessRequest
   *
   ...
   * @dev block.
   */
  function fulfillRandomnessRequest(bytes32 currentKeyHash, bytes32 requestId) public {
