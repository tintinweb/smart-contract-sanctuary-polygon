...
contract Mid is Royalty, AccessControl, BaseRegistrarImplementation, Pausable, TokenURISetting, Initializable {
    ...
    constructor(NNS nns_, address timelockController, address erc20TransferHelper_, address payable micTreasury_, address payable midLandTreasury_, address payable alchemistTreasury_, address payable fundTreasury_, address usdt_) BaseRegistrarImplementation("MetaID", "MID", nns_) Royalty(erc20TransferHelper_) {
