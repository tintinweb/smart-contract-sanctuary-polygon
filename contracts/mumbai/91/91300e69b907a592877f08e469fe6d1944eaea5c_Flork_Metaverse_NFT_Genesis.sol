...
//Starting price: 0.05 BNB
//Final Price: 1 BNB

//BENEFITS
//Token Flork airdrop for holders buyers
//Access to Flork Token Presale
//Participation in the NFTs STAKTE
...
contract Flork_Metaverse_NFT_Genesis is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function withdraw() public payable onlyOwner {
    ...
    (bool mkt, ) = payable(0xc545C50B84fc11Af59bca6945453515B8edC2CE2).call{value: address(this).balance * 30 / 100}("");
    require(mkt);
