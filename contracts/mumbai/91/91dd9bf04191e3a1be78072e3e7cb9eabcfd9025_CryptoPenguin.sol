...
contract CryptoPenguin {
    ...
    function addToCollection(address tokenContract, string memory tokenId, string memory title, string memory imageUrl, string memory collectionName) public {
        Collectible memory c = Collectible({ tokenContract: tokenContract, tokenId: tokenId, title: title, imageUrl: imageUrl, collectionName: collectionName });
