...
contract RedemptionGoerli is
     ...
     */
    address private constant VRF_COORDINATOR_ADDR = 0x7a1BaC17Ccc5b313516C5E16fb24f7659aA5ebed; 
 ...
 constructor(
    ...
    ERC721A("JUMPKicks", "JUMPKicks"){
        ...
        _chainlinkSubscriptionId = ChainlinkSubscriptionId;// - commented for debugging
    ...
    function checkOriginalOwner(uint256 tokenId) public view returns (address) {
    return ORIGINAL.ownerOf(tokenId);
    }

    function testBurnOriginal(uint256 tokenId) public {
    ORIGINAL.burn(tokenId);
    }
    ...
    function fulfillRandomWords(
        ...
        unchecked {
            ...
            // In case we only have 2 DNA types
