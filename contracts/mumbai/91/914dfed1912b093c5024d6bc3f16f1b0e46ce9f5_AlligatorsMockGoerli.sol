...
contract Alligators is
    ...
    */
    ...
    function _compareTraitJoker(uint256 _2nd, uint256 _3rd) internal returns (uint8[7] memory) {
        uint8[7] memory data;
    ...
    function _compareLvlJoker(uint256 _2nd, uint256 _3rd) internal returns (uint8[7] memory) {
        uint8[7] memory data;
        for (uint256 i = 0; i < 7; i++ ) {
            if (alligator_level(_2nd)[i] >= alligator_level(_3rd)[i]) {
    ...
    function _compareTrait(uint256 _1st, uint256 _2nd, uint256 _3rd) internal returns (uint8[7] memory) {
        uint8[7] memory data;
        for (uint256 i = 0; i < 7; i++ ) {
    ...
    function _compareLvl(uint256 _1st, uint256 _2nd, uint256 _3rd) internal returns (uint8[7] memory) {
        uint8[7] memory data;
        for (uint256 i = 0; i < 7; i++ ) {
            if (alligator_level(_1st)[i] >= alligator_level(_2nd)[i]) {
                if (alligator_level(_1st)[i] >= alligator_level(_3rd)[i]) {
    ...
    function _mergeAlligators(uint256 _1st, uint256 _2nd, uint256 _3rd, address merger) internal {
        uint8[7] memory pullData = _compareLvl(_1st, _2nd, _3rd);
        uint8[7] memory pullDataTraits = _compareTrait(_1st, _2nd, _3rd);
        {
    ...
    function _mergeWjoker(uint256 _1st, uint256 _2nd, uint256 _3rd, address merger) internal {
        uint8[7] memory pullData = _compareLvlJoker(_2nd, _3rd);
        uint8[7] memory pullDataTraits = _compareTraitJoker(_2nd, _3rd);
