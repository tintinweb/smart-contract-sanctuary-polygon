...
contract CUBEClaim is Ownable, ReentrancyGuard {
    ...
    function claimCUBE(
        ...
        // emit ClaimedCUBE(_nonce, _to, _amount);
    }
    ...
    function claimUSDT(
        ...
        usdt.transfer(_to, _amount * 1 ether);
        // isClaimed[_to][_nonce] = true;
        // emit ClaimedUSDT(_nonce, _to, _amount);
    }
    ...
    function claimNFTFragment(
        ...
        // isClaimed[_to][_nonce] = true;
        // emit ClaimedNFTFragment(_nonce, _to, _attributes);
    }
    ...
    function claimNFTBox(
        ...
        // isClaimed[_to][_nonce] = true;
        // emit ClaimedNFTBox(_nonce, _to, _amount);
    }
