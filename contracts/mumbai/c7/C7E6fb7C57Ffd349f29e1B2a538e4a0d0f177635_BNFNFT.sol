...
// File: ../www/contracts/BlobbyNFrens.sol
...
contract BNFNFT is ERC721Enumerable, Ownable, ReentrancyGuard {

    using Strings for uint;

    using SafeMath for uint256;
    
    uint public constant TOKEN_PRICE = 0; // 0.06 ETH

    uint public constant PRE_SALE_TOKEN_PRICE = 0; // 0.06 ETH
    ...
    address private VAULT_ADDRESS = 0x000000000000000000000000000000000000dEaD;
