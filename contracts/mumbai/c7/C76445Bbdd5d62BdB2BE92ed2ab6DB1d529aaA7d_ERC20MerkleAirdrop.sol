...
contract ERC20MerkleAirdrop is Ownable {
    ...
    bytes32 public immutable merkleRoot = 0x0123da5c6fe26753ad3e1034202f2fcfc58eae342fe7ac7c1d9dc821335faea7;

    //this value should be set by template; ERC20 token address that will be used for airdrop
    address public immutable tokenAddress = 0xb87BCf5e59961d20D78dFD837d7AA78B62FFf4DC;

    //comes from template, timestamp of start and end data of compaign
    uint256 public immutable startAt = 1661770679410;
    uint256 public immutable endAt = 1661884200000;

    //id of airdrop created in database
    uint256 public immutable airdropID = 210;

    //comes from template too
    uint256 public immutable totalTokens = 0xde0b6b3a7640000;
    uint256 public claimedTokens  = 0;
    uint256 public availableTokens = 1000000000000000000;
