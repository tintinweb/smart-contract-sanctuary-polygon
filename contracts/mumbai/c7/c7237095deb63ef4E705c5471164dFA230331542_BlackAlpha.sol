...
abstract contract DataStorage {
    ...
    function userDashboard(address userAddr) public view returns(
        ...
        upgradeTime = upgradeRemainingTime(userAddr);
    }
    ...
    function upgradeRemainingTime(address userAddr) internal view returns(string memory ans) {
        User storage user = users[userAddr];
