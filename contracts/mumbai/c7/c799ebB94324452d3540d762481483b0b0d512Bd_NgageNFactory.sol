...
contract NgageNFactory is AccessControl, ERC2771Context {
  ...
  function createFactory(
    ...
    NgageN(address(_proxy)).grantRole(ADMINISTRATOR_ROLE, address(_admn));
    NgageN(address(_proxy)).grantRole(ADMINISTRATOR_ROLE, address(_mintNFT));
    ...
    factoryOwner[_collectionId] = _owner;
