...
contract StellarTokenNFT is ERC721URIStorage {
    ...
    function getRandomSmallPlanetFilename() public view returns (string memory) {
        string[8] memory filenames = [
            '<image href="https://stellartokennft.s3.amazonaws.com/planets/planet_01.png" x="280" y="30" width="45" height="45" />',
            '<image href="https://stellartokennft.s3.amazonaws.com/planets/planet_02.png" x="280" y="30" width="45" height="45" />',
            '<image href="https://stellartokennft.s3.amazonaws.com/planets/planet_03.png" x="280" y="30" width="45" height="45" />',
            '<image href="https://stellartokennft.s3.amazonaws.com/planets/planet_04.png" x="280" y="30" width="45" height="45" />',
            '<image href="https://stellartokennft.s3.amazonaws.com/planets/planet_05.png" x="280" y="30" width="45" height="45" />',
            '<image href="https://stellartokennft.s3.amazonaws.com/planets/planet_06.png" x="280" y="30" width="45" height="45" />',
            '<image href="https://stellartokennft.s3.amazonaws.com/planets/planet_07.png" x="280" y="30" width="45" height="45" />',
            '<image href="https://stellartokennft.s3.amazonaws.com/planets/planet_08.png" x="280" y="30" width="45" height="45" />'
        ];
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        parts[2] = getRandomBackground();
        parts[3] = getRandomSpaceshipFilename();

        parts[4] = '';
        if(level >= 2) {
            parts[4] = getRandomPlanetFilename();
        }
        parts[5] = '';
        if(level >= 3) {
            parts[5] = getRandomSmallPlanetFilename();
        }
        parts[6] = '';
        if(level >= 4) {
            parts[6] = getRandomMeteorFilename();
        }
        parts[7] = '';
        if(level >= 5) {
            parts[7] = getRandomSatelliteFilename();
        }
        parts[8] = '';
        if(level == 6) {
