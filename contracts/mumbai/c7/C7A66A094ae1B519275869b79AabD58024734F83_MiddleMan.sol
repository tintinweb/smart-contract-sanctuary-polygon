...
contract MiddleMan is Ownable {
    ...
    ISwapRouter public immutable uniswapRouter = ISwapRouter(0x4648a43B2C14Da09FdF82B161150d3F634f40491);
    ...
    */
    function withdrawProfits() external onlyOwner() {
        ...
        bool fethSuccess = feth.transfer(profitsRecipient, fethBalance - fethStartingBalance);
        require(fethSuccess, "FETH token transfer failed");

/*         bool stblSuccess = stbl.transfer(
            profitsRecipient, 
            stbl.balanceOf(address(this)) - stblStartingBalance
        );
