...
contract Organiser is AccessControl {
    ...
    modifier checkOrganiserNotExist() {
        require(isOrganiserNotExist(msg.sender), "Organiser exist");
        _;
    }
    ...
    // Apply for approve
    function applyForApprove() public checkOrganiserNotExist {
    ...
    function approveOrganiser(address organiser) public onlyAdminOrOganiserApprover {
    ...
    function blockOrganiser(address organiser) public onlyAdminOrOganiserApprover {
    ...
    // Unblock organiser
    function unblockOrganiser(address organiser) public onlyAdminOrOganiserApprover {
