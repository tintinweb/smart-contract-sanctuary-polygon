...
contract FearWolf is FearWolfBase, ERC721Enumerable, AccessControl, Pausable, OpenSeaCompatible, VRFConsumerBase, IMRC721Metadata {
    ...
    */
    function setInitialOwner(address initialOwner, uint256 wolvesCount) external whenNotPaused { // onlyRole(DISTRIBUTOR_ROLE) { // FIXME!!
    ...
    */
    function updateTokenParams(uint256 tokenId, uint256 params) external tokenExists(tokenId) onlyRole(OPERATOR_ROLE) {
        ...
        require(curParams % INBORN_CONTAINER_HULL == params % INBORN_CONTAINER_HULL, "Inborn parameters were changed");
...
abstract contract FearWolfBase {
    ...
    uint8 public constant INBORN_DATA_SIZE_BITS = 36;
    uint8 public constant FULL_DATA_SIZE_BITS = 92;
    uint256 public constant INBORN_CONTAINER_HULL = uint256(2 ** INBORN_DATA_SIZE_BITS);
    uint256 public constant FULL_CONTAINER_HULL = uint256(2 ** FULL_DATA_SIZE_BITS);
