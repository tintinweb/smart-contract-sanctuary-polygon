...
import "@knobs/contracts/contracts/shuffledIds/ShuffledIds.sol";


contract NFT2048 is Ownable,ERC721,ERC721Enumerable,ShuffledIds {
    ...
    constructor(string memory name_,string memory symbol_,string memory metadataURI_, string memory collectionURI_,address arrayToGoAddress_,string memory arrayName_) ERC721(name_,symbol_) ShuffledIds(arrayToGoAddress_,arrayName_){
    ...
    function mint() public payable {
        require(getRemaining() > 0, "cap reached");
        require(msg.value >= price,"not enough funds supplied");
        uint256 newId = popRandomId();
