...
Tranasaction limited to 1 000 000 000 Sky
Thanks to Neo and Angel for the help in preparing and testing the Sky contract
*/
...
contract SkyToken is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "Sky";
  string constant tokenSymbol = "Sky";
  uint8  constant tokenDecimals = 0;
  uint256 _totalSupply = 100000000;
  uint256 public basePercent = 100;
  uint256 public _maxTxAmount = 10 * 10**3;
