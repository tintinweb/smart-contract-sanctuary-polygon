    ...
    function contractURI() public view returns (string memory) {
        ...
        Base64.encode(
            ...
            abi.encodePacked(
                '{"name":"',
                "AttackOnFactory",
                '", "description":"The Factory is under attack! The high levels of fun produced in this place have attracted fun-eating monsters from another dimension; they are going to steal all the entertainment from the world, leaving only sadness and boredom. Will you be able to stop the invasion?", "external_link": "https://www.nft-factory.club", "image":"ipfs://QmYVREj1TuY92a68LX1SBDyDHHUy4d22wr7bKbnhQZAZmg/2225.png"}'
            )
            )
        )
        )
