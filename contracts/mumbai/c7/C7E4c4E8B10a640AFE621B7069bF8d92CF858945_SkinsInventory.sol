...
contract SkinsInventory is ERC1155, Ownable {
    using ECDSA for bytes32;

    address public signer;
    mapping(address => uint256) public seedNonce;

    event SetSigner(address _signer, uint256 _blockTimestamp);

    constructor() ERC1155("https://public.nftstatic.com/static/nft/BSC/BMBTOWER/") {
        signer = msg.sender;
    }
    ...
    function getVerificatonSignature(
