...
contract COIN20 is Ownable, IERC20, IERC20Metadata {
    ...
    constructor(string memory tokenName,string memory tokenSymbol,uint8 tokenDecimal,uint256 tokenSupply,address tokenOwner,address service,uint256 burnFee,uint256 txFee,address feeAddress) payable Ownable(tokenOwner) {
        _name = tokenName;
        _symbol = tokenSymbol;
