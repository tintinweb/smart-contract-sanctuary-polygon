...
contract NewContract_6_5 {
    ...
    function _6_set_askedToReceive(address[] memory input) public returns (uint)
    {
        ...
        //(9-30-2022)
        require(addressLength    +   currentUserNum <= userLimit, "number of users required to receive exceed limit of number of users of this contract");
        ...
        currentUserNum = currentUserNum + successNum;//(9-30-2022)
        return successNum;
    }
...
*/
    ...
    function _27_checkUserListNum() public view returns (uint)
    {
        ...
        // return userList.length; //(9-30-2022)
