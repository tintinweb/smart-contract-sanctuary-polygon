...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x43b6380aD7A351e877d0F317504184743a017568];
  address public erc20Payable = 0x43b6380aD7A351e877d0F317504184743a017568;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmThapSosRKMGM2tc4165Xzuo1Bedd8Bq8w9prTNMWe3Nr/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/LTD4oj3BdJlAIY2CZgZO/contract-metadata";
  }
...
// File: contracts/MyNftsalsaTestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MyNftsalsaTestContract is ERC721APlus {
    constructor() ERC721APlus("My NFTSALSA Test", "SALSA Test"){}
}
