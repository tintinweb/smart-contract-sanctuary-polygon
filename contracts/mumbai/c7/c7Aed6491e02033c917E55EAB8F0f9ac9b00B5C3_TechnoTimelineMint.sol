    ...
    ERC721URIStorage
{
    ...
    function mint(address to, string memory _tokenURI) public virtual {
        require(
            ...
            "TechnoTimelineMint: must have minter role to mint"
        );
    ...
    function mintBunch(address[] memory to, string memory _tokenURI)
        public
        virtual
    {
        require(
        ...
        for (uint256 i = 0; i <= to.length; i++) {
            ...
            _setTokenURI(_tokenIdTracker.current(), _tokenURI);
            _updateTokenCreator(_tokenIdTracker.current(), payable(to[i]));
            _tokenIdTracker.increment();
        }
    }
