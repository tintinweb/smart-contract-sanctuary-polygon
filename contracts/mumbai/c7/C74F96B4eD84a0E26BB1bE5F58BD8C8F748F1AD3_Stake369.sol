...
contract Stake369 is ERC721, Ownable, RoyaltiesV2Impl {
     ...
     * Private Variables
     */
    uint256 private constant MAX_NUMBER_OF_1 = 502;
    uint256 private constant MAX_NUMBER_OF_2 = 502;
    uint256 private constant MAX_NUMBER_OF_3 = 198;
    uint256 private constant MAX_NUMBER_OF_4 = 502;
    uint256 private constant MAX_NUMBER_OF_5 = 501;
    uint256 private constant MAX_NUMBER_OF_6 = 99;
    uint256 private constant MAX_NUMBER_OF_7 = 501;
    uint256 private constant MAX_NUMBER_OF_8 = 501;
    uint256 private constant MAX_NUMBER_OF_9 = 27;

    uint256 private constant MAX_SUPPLY = 3333; // collection size
    ...
    uint256 private constant MAX_MINTS_PER_ADDRESS = 27; // this is the max total mints per account
    ...
    function premint(uint random) private onlyOwner {
        require(mintable == true, "Mint phase is closed");
        require(mintedTokens < MAX_SUPPLY, "Exceeds maximum allowable mints");
        _mintRandomId(msg.sender);
        mintedAddressesArray.push(msg.sender);
