...
contract ExampleUSDC is ERC721, Ownable {
    ...
    uint256 public priceUSDC = 1; // 1 USDC
    uint256 public priceMATIC = 1000000000000000; //.01  // 100000000; // .001 MATIC
    ...
    function setPriceMATIC(uint256 _newPrice) external onlyOwner {
  ...
  function getCostInMATIC() public view returns (uint256) {
    ...
    uint256 costOfToken = priceUSDC * 1 ether / uint256(costOfMATIC);
    return costOfToken;
  }
}