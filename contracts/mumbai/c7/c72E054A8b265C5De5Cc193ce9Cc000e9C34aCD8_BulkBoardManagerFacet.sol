...
contract BulkBoardManagerFacet is Modifiers {
    function shuffleAllBoardz() external onlyFounder {
        BigBoardManagerLib.shuffleAll();
    }

    function distributeScores() external onlyFounder {
        BigBoardManagerLib.distributeScores();
    }

    function clearApprovedBoardz() external onlyFounder {
        BigBoardManagerLib.clearApprovedBoardContracts();
    }

    function selectAllWinners() external founderOrHostOnly {
