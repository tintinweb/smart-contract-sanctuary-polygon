...
/// @title A smart contract for base token
/// @dev Supports base URI string setting.
contract BaseToken is IBaseToken, AccessControl, ERC1155 {
    /**
     * Minter has the right to mint resources. It supposed to be the game
     * admin and the address that is part of the bridging solution.
     */
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    // Burner has the right to burn resources on behalf of another address.
