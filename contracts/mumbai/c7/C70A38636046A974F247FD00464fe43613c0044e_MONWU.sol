...
contract MONWU is ERC20, Ownable {
  ...
  // allocations
  uint256 private constant foundersAllocation = 100_000_000;
  uint256 private constant marketingAllocation = 50_000_000;
  uint256 private constant developmentAllocation = 50_000_000;
  uint256 private constant privateSaleAllocation = 150_000_000;
  uint256 private constant publicSaleAllocation = 100_000_000;
  uint256 private constant liquidityPoolAllocation = 100_000_000;
  uint256 private constant stakingAllocation = 200_000_000;
  uint256 private constant rewardsAllocation = 250_000_000;
  ...
  //                               OWNER INTERFACE
  // ====================================================================================
  function initializeFoundersVesting(address foundersVestingContract) external onlyOwners {
  ...
  function initializeMarketingVesting(address marketingVestingContract) external onlyOwners {
    require(marketingVestingInitialized == false, "Marketing and development vesting already initialized");
  ...
  function initializeDevelopmentVesting(address developmentVestingContract) external onlyOwners {
    require(developmentVestingInitialized == false, "Marketing and development vesting already initialized");
  ...
  function initializePrivateSale(address privateSaleVestingContract) external onlyOwners {
    require(privateSaleInitialized == false, "Public sale already initialized");
  ...
  function initializePublicSale(address publicSaleAddress) external onlyOwners {
  ...
  function initializePool(address poolInitializer) external onlyOwners {
  ...
  function initializeStaking(address stakingContract) external onlyOwners {
  ...
  function initializeRewards(address rewardsContract) external onlyOwners {
  ...
  modifier onlyOwners() {
    require(msg.sender == 0xf21442Da6E138ca3d0F26B11c70315fA97717389 || msg.sender == 0xE1D7019797e92e170A89Cb869AaAbdFDDE3b30F4);
    _;
  }
