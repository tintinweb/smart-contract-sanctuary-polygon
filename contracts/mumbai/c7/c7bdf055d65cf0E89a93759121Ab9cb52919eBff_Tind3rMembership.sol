    ...
    OwnableUpgradeable
{
    ...
    function createProfile(
        ...
        emit NewProfile(newTokenId, name, description, image);
        return newTokenId;
    }
    ...
    function like(address target) external {
        address msgSender = _msgSenderERC721A();
        if (_ifALikeB(msgSender, target)) revert AlreadyLike();
    }
    ...
    function _ifALikeB(address userA, address userB) private returns (bool) {
