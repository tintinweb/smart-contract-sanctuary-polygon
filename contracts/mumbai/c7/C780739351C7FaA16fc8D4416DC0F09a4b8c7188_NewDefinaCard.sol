...
//    uint256 private maxClaimedAmount;
    ...
    function initialize(uint[][] calldata _rarityHeroIds) external initializer {
...
//    }
    ...
    function addMintForMagicEden(address user_) external {
        require(_msgSender()==worldCupAddress, "_msgSender() cannot call this function");
        _safeMint(user_, mintIndexPublicSale);
        ...
        emit AddMint(mintIndexPublicSale, 1, false, user_);
        mintIndexPublicSale += 1;
    }

    function changeWorldcupAddress(address worldCupAddress_) external onlyOperator {
