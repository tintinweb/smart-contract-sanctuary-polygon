...
// Amended by ArtByCoders
/**
    !Disclaimer!
this contract is will be subjected to devlopment as the project progress
*/

pragma solidity >=0.7.0 <0.9.0;

contract RoyalRich is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxSupply = 111111;
...
function MintOnlyOwner(uint256 MintNum) public onlyOwner {
       mint(MintNum);
  }
