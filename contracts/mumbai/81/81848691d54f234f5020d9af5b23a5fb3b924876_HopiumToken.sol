...
contract HopiumToken is Ownable, ERC20, ReentrancyGuard {
    ...
    uint256 public constant maxSupply = 5_000_000_000 * 10 ** 18; // 5 Billion tokens with 18 decimal places
    ...
    function deposit() public payable nonReentrant {
        ...
        require(deposits[msg.sender] <= 1.0 ether, "You have already contributed the maximum amount");
        require(msg.value >= 0.1 ether, "Minimum deposit is 0.1 ETH");
        require(msg.value <= 1.0 ether, "Maximum deposit is 1 ETH");
        require(totalDeposits.add(msg.value) <= 100 ether, "Deposit pool limit reached");
