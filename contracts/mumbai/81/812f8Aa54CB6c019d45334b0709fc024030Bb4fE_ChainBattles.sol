...
contract ChainBattles is ERC721URIStorage {
    ...
    function getLevels(uint256 tokenId) public view returns (string memory) {
        Attributes storage attributes = tokenIdToAttributes[tokenId];
        return string(
            abi.encodePacked(
            '<tspan x="0">Level: ', attributes.level.toString(), "</tspan>",
            '<tspan x="0">Speed: ', attributes.speed.toString(), "</tspan>",
            '<tspan x="0">Strength: ', attributes.strength.toString(), "</tspan>",
            '<tspan x="0">Life: ', attributes.life.toString(), "</tspan>"
        ));
    }
    ...
    function mint() public {
        ...
        tokenIdToAttributes[newItemId] = Attributes(
            0, createRandom(100), createRandom(100), createRandom(100)
        );
