...
/// @dev An admin must wait SAFETY_PERIOD after pausing
/// @dev to emergency resolve a condition
...
/// @notice   [0,1] if the benchmark price is strictly less than the strike price
...
contract Adapter is Admin, IAdapter {
    ...
    /// @notice Question benchmark IDs and strike prices
