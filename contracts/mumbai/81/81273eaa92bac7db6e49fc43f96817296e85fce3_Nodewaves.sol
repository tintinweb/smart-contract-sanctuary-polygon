...
contract Nodewaves is ERC20, ERC20Burnable, Ownable {
    ...
    function nodeWithdraw() public {
        ...
        uint _amount = ((tokenForNode / payoutTime) * (365-(block.timestamp - daysPassed)/payoutTime)) / numberOfNodes;
    ...
    function pob() public view returns (uint) {
        ...
        uint _amount = (tokenForPoB.div(365-(block.timestamp - daysPassed)/payoutTime)).mul(_days);
        return _amount;
    }

    function pos() public view returns (uint) {
        uint _days = (block.timestamp.sub(distributedatePoS)).div(payoutTime);
        uint _amount = (tokenForPoS.div(365-(block.timestamp - daysPassed)/payoutTime)).mul(_days);
        return _amount;
    }

    function team() public view returns (uint) {
        uint _days = (block.timestamp.sub(distributedateTeam)).div(payoutTime);
        uint _amount = (tokenForTeam.div(365-(block.timestamp - daysPassed)/payoutTime)).mul(_days);
        return _amount;
    }
    ...
    function advisors() public view returns (uint) {
        ...
        uint _amount = (tokenForAdvisors.div(365-(block.timestamp - daysPassed)/payoutTime)).mul(_days);
        return _amount;
    }
    ...
    function treasure() public view returns (uint) {
        ...
        uint _amount = (tokenForTreasure.div(365-(block.timestamp - daysPassed)/payoutTime)).mul(_days);
        return _amount;
    }

    function P2E() public view returns (uint) {
        uint _days = (block.timestamp.sub(distributedateP2E)).div(payoutTime);
        uint _amount = (tokenForP2E.div(365-(block.timestamp - daysPassed)/payoutTime)).mul(_days);
        return _amount;
    }

    function M2E() public view returns (uint) {
        uint _days = (block.timestamp.sub(distributedateM2E)).div(payoutTime);
        uint _amount = (tokenForM2E.div(365-(block.timestamp - daysPassed)/payoutTime)).mul(_days);
        return _amount;
    }
    ...
    function liquidity() public view returns (uint) {
        ...
        uint _amount = (tokenForLiquidity.div(365-(block.timestamp - daysPassed)/payoutTime)).mul(_days);
        return _amount;
    }
    ...
    function devAndEco() public view returns (uint) {
        ...
        uint _amount = (tokenForDevAndEco.div(365-(block.timestamp - daysPassed)/payoutTime)).mul(_days);
        return _amount;
    }

    function sp() public view returns (uint) {
        uint _days = (block.timestamp.sub(distributedateSP)).div(payoutTime);
        uint _amount = (tokenForSP.div(365-(block.timestamp - daysPassed)/payoutTime)).mul(_days);
        return _amount;
    }
