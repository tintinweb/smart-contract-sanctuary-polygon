...
contract TugStorage is TugStorageInterface {
    ...
    function getPricingEngineAddress() external view returns (address) {
        return
            getAddress(
                0x4279e58726c8dc65e1099f4a24c63b11b47fb7cf57c2edb27a45e21c29443740
            ); // keccak256(abi.encodePacked("price-engine")
    }

    function getTreasuryAddress() external view returns (address) {
        return
            getAddress(
                0xcbd818ad4dd6f1ff9338c2bb62480241424dd9a65f9f3284101a01cd099ad8ac
    ...
    function getTokenRegistryAddress() external view returns (address) {
        return
            getAddress(
                0xf85a77f31b2608129c9116531d0ac1863090a8eb96c02b3e44e7aa26114186de
            ); // keccak256(abi.encodePacked("token-registry")
    }
}