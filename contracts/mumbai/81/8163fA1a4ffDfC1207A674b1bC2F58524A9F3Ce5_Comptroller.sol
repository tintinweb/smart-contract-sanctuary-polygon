...
contract Comptroller is ComptrollerV4Storage, ComptrollerInterfaceG2, ComptrollerErrorReporter, ExponentialNoError {
    ...
    function getAGLAddress() public view returns (address) {
        return 0xA647571F688dab7121957BB477a03dc057125e99;
    }
}
...
//cont...
     ...
     */
    function getCashPrior() internal view returns (uint); //function has no logic written inside. This makes this contract as abstract contract
