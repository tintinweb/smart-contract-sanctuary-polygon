...
import '../governance/N00unsDAOLogicV2.sol';

contract N00unsDAOLogicV2Harness is N00unsDAOLogicV2 {
    function initialize(
        address timelock_,
        address n00uns_,
        address vetoer_,
...
/// @title The N00uns DAO logic version 2
...
// LICENSE
// N00unsDAOLogicV2.sol is a modified version of Compound Lab's GovernorBravoDelegate.sol:
...
//
// MODIFICATIONS
// See N00unsDAOLogicV1 for initial GovernorBravoDelegate modifications.

// N00unsDAOLogicV2 adds:
...
// max quorum votes using the current N00un supply.
...
contract N00unsDAOLogicV2 is N00unsDAOStorageV2, N00unsDAOEventsV2 {
    ...
    function initialize(
        ...
        require(
            ...
            'N00unsDAO::initialize: invalid proposal threshold bps'
        );
    ...
    function castVoteInternal(
        ...
        uint96 votes = n00uns.getPriorVotes(voter, proposalCreationBlock(proposal));
    ...
    function _setProposalThresholdBPS(uint256 newProposalThresholdBPS) external {
        ...
        require(
            ...
            'N00unsDAO::_setProposalThreshold: invalid proposal threshold bps'
        );
    ...
    function _setMinQuorumVotesBPS(uint16 newMinQuorumVotesBPS) external {
        ...
        require(
            ...
            'N00unsDAO::_setMinQuorumVotesBPS: invalid min quorum votes bps'
        );
        require(
            newMinQuorumVotesBPS <= params.maxQuorumVotesBPS,
            'N00unsDAO::_setMinQuorumVotesBPS: min quorum votes bps greater than max'
        );
    ...
    function _setMaxQuorumVotesBPS(uint16 newMaxQuorumVotesBPS) external {
        ...
        require(
            ...
            'N00unsDAO::_setMaxQuorumVotesBPS: invalid max quorum votes bps'
        );
        require(
            params.minQuorumVotesBPS <= newMaxQuorumVotesBPS,
            'N00unsDAO::_setMaxQuorumVotesBPS: min quorum votes bps greater than max'
        );
     ...
     * @param totalSupply The total supply of N00uns at the time of proposal creation
    ...
    function getDynamicQuorumParamsAt(uint256 blockNumber_) public view returns (DynamicQuorumParams memory) {
        uint32 blockNumber = safe32(blockNumber_, 'N00unsDAO::getDynamicQuorumParamsAt: block number exceeds 32 bits');
    ...
    /**
     * @notice Current min quorum votes using N00un total supply
     */
    function minQuorumVotes() public view returns (uint256) {
        return bps2Uint(getDynamicQuorumParamsAt(block.number).minQuorumVotesBPS, n00uns.totalSupply());
    }

    /**
     * @notice Current max quorum votes using N00un total supply
     */
    function maxQuorumVotes() public view returns (uint256) {
        return bps2Uint(getDynamicQuorumParamsAt(block.number).maxQuorumVotesBPS, n00uns.totalSupply());
    }
