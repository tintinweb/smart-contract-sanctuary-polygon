...

{
    ...
    function adminUpdateConfig(
        ...
        Functionalities functionality, bool value) external onlyAdmin{
        
         _updateDistinctNft(_distinctNft);
         _updateDistinctTreasury(_distinctTreasury);
         _updateMarketFees(_primaryDistinctFeeBasisPoints,_secondaryDistinctFeeBasisPoints);
         _updateProperties(functionality,value);
    }

    function adminUpdateDistinctNft( address _distinctNft) external onlyAdmin{
         _updateDistinctNft(_distinctNft);
    }

    function adminUpdateDistinctTreasury(address _distinctTreasury) external onlyAdmin{
         _updateDistinctTreasury(_distinctTreasury);
    }

     function adminUpdateDistinctMarketFees(
         uint256 _primaryDistinctFeeBasisPoints,
        uint256 _secondaryDistinctFeeBasisPoints)  external onlyAdmin{
        _updateMarketFees(_primaryDistinctFeeBasisPoints,_secondaryDistinctFeeBasisPoints);
    }
    ...
    // function adminupdateMarketFees(
    ...
    // function updateDistinctNode(address _distinctNft) external {
    //     _updateDistinctNft(_distinctNft);
    // }
...
abstract contract AdminAuth {
    ...
    modifier allowedByAdmin(Functionalities functionality) {
        require(isAllowed[functionality], 'Distinct: not allowed by admin');
        _;
    }
