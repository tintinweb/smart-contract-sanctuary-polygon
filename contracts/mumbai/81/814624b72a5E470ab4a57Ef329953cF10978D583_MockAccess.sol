...
contract MockAccess is ViciAccess {
    ...
    uint256 internal _public_counter = 0;
    uint256 internal _owner_counter = 0;
    uint256 internal _unit_tester_counter = 0;
    ...
    function increment_unit_tester_counter() public noBannedAccounts onlyOwnerOrRole(UNIT_TESTER) {
