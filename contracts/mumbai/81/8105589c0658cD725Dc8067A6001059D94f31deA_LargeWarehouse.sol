...
contract LargeWarehouse {
    ...
    //uint256 public nextId;
        ...
        require(
            ...
            "You are not registered manufacturer of this smart contract"
        );
        _;
    }

    modifier onlyRetailer() {
    require(retailers[msg.sender].id > 0, "Only registered retailers can call this function.");
    _;
}
    ...
    event sneakerFiled(
        ...
        function setManifactureAddress(address _manufacturer) public onlyOwner {
        manufacturer = _manufacturer;
    }

        function fileSneaker(uint256 _id, string memory _color, string memory _size ) public onlyManufacturer
    {
        ...
        newSneaker.blockNumber = block.number;
...
function getRandomString() internal view returns (string memory) {
    ...
    require(msg.sender == manufacturer, "Only admin can call this function.");
    hasShown = true;
}
    ...
    function addRetailer(uint256 _id, string memory _name, address _addr) public onlyManufacturer {
