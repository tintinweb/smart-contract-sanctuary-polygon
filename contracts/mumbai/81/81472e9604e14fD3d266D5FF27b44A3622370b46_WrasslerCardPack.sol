...
contract SignedAllowance {
    ...
    function createMessage(address account, uint256 nonce, address _for) public pure returns (bytes32) {
    ...
    function validateSignature(address account, uint256 nonce, bytes memory signature) external view returns (bool) {
    ...
    function _useAllowance(address account, uint256 nonce, bytes memory signature) internal {
