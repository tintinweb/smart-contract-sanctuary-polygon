...
uint256 constant public INVEST_MIN_AMOUNT = 0.1 ether; 
	uint256[] public REFERRAL_PERCENTS = [10,10,50];
	uint256 constant public PROJECT_FEE = 20;
	uint256 constant public LANDPERMIT_FEE = 20;
	uint256 constant public LANDALLOCATION_FEE = 20;
	uint256 constant public LANDTITLE_FEE = 10;
	uint256 constant public LANDTAX_FEE = 10;
	uint256 constant public LANDREGISTRATION_FEE = 20;
	...
	uint256 WITHDRAW_FEE_1 = 0; 
	uint256 WITHDRAW_FEE_2 = 0; 
	...
	constructor(address payable wallet, address payable _permit, address payable _allocation, address payable _title,  address payable _tax, address payable _registration) public {
        ...
        plans.push(Plan(75, 80)); // 8% per day for 14 days
        plans.push(Plan(75, 75)); // 7.5% per day for 21 days
        plans.push(Plan(75, 70)); // 7% per day for 28 days
		plans.push(Plan(75, 80)); // 8% per day for 14 days (at the end, compounding)
        plans.push(Plan(75, 75)); // 7.5% per day for 21 days (at the end, compounding)
        plans.push(Plan(75, 70)); // 7% per day for 28 days (at the end, compounding)
	}
