...
contract Airdrop is Pausable {
    ...
    constructor(address _tokenAddress, address _admin, uint256 _tokensPerUSD, uint256 _airdropAmount, uint256 _referralLevelOneBonusPercentage, uint256 _referralLevelTwoBonusPercentage) {
    ...
    function updateTokensPerUSD(uint256 _tokensPerUSD) public onlyAdmin {
        tokensPerUSD = _tokensPerUSD;
    }
    ...
    function buyTokens() public payable whenNotPaused {
        ...
        uint256 maticPerUSD = uint256(getLatestMaticPrice());
        uint256 tokensPerMatic = tokensPerUSD.div(maticPerUSD.div(100000000));
    ...
    // To withdraw acccidentally sent Matic to contract address
    function adminMaticWithdrawal() public onlyAdmin {
