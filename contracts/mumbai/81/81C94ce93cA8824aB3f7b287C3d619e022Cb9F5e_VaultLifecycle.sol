...
library VaultLifecycle {
        ...
        )
    {
        ...
        uint256 premiumBeforeFee = _getPremium(gnosisEasyAuction, auctionID);
    ...
    function getVTokenPrice(address easyAuction, uint256 auctionID)
        ...
        returns (uint256)
    {
        AuctionType.AuctionData memory auctionData = IGnosisAuction(easyAuction)
    ...
    function _getPremium(address _easyAuction, uint256 _auctionID)
        ...
        returns (uint256)
    {
        AuctionType.AuctionData memory auctionData = IGnosisAuction(
            _easyAuction
...
library Vault {
    ...
    struct AuctionSellOrder {
        ...
        uint96 buyAmount;
        // User Id of realized vault in latest gnosis auction
        uint64 userId;
    }
}
...
library GnosisAuction {
        ...
        returns (uint256 auctionID)
    {
        ...
        require(
            ...
            "GnosisLib: vTokenSellAmount > type(uint96) max value!"
        );
