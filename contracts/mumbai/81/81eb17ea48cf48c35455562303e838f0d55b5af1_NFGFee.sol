...
contract NFGRegistry is Multicall, ERC2771Context, AccessControlEnumerable {
...
contract NFGFactory is Multicall, ERC2771Context, AccessControlEnumerable {
    /// @dev Only FACTORY_ROLE holders can approve/unapprove implementations for proxies to point to.
    bytes32 public constant FACTORY_ROLE = keccak256("FACTORY_ROLE");

    NFGRegistry public immutable registry;
    ...
    constructor(address _trustedForwarder, address _registry) ERC2771Context(_trustedForwarder) {
        ...
        registry = NFGRegistry(_registry);
    }
    ...
    function addImplementation(address _implementation) external {
        ...
        INonFungibleGifContract module = INonFungibleGifContract(_implementation);
...
contract NFGFee is Multicall, ERC2771Context, AccessControlEnumerable, IFeeTierPlacementExtension {
    /// @dev The factory for deploying contracts.
    NFGFactory public immutable factory;
