...
import "./IStar/IERC721.sol";
import "./IStar/IERC721Receiver.sol";
import "./IStar/IERC721Metadata.sol";
import "./IStar/Address.sol";
import "./IStar/Strings.sol";
import "./IStar/Context.sol";

import "./IStar/Ownable.sol";
import "./IStar/ERC165.sol";
import "./IStarNFT.sol";

/**dre
 * @dev Fork https://github.com/generalgalactic/ERC721S and implement IStarNFT interface
 */
contract StarNFTV4 is Ownable, ERC165, IERC721, IERC721Metadata, IStarNFT, Context {
    ...
    /* ============ External Functions ============ */
    function mint(address account, uint256 _cid)
    external
    override
    onlyMinter
    returns (uint256)
    {
        ...
        Star memory star = Star(uint160(account), uint96(_cid));
