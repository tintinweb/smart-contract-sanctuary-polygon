...
import "./Tatum/contracts/token/ERC721/extensions/ERC721Enumerable.sol";
import "./Tatum/contracts/token/ERC721/extensions/ERC721URIStorage.sol";
import "./Tatum/contracts/access/AccessControlEnumerable.sol";
import "./Tatum/contracts/token/ERC20/IERC20.sol";
import "./Tatum/contracts/utils/introspection/ERC2981.sol";
...
contract ERC721 is Ownable, ERC165, IERC721, IERC721Metadata {
     ...
     * @dev See {IERC721-safeTransferFrom}.
     */
    function safeTransferFrom(address from, address to, uint256 tokenId, bytes calldata _data) public virtual payable override {
        require(_isApprovedOrOwner(_msgSender(), tokenId), "ERC721: transfer caller is not owner nor approved");
