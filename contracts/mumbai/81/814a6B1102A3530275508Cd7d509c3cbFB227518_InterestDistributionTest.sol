...
contract InterestDistributionTest is KeeperCompatibleInterface {
    ...
    uint256 public studyPeriodDuration = 1 days; // day by default for payout require statement
    ...
    // TESTING
    uint256 public isDurationWorking = 2 * studyPeriodDuration;
    ...
    function register() external payable {
        ...
        recordedStartDay[msg.sender] = todayUTC0 + studyPeriodDuration;
    ...
    function ping() public {
        ...
        pingExpiresAt[msg.sender] = todayUTC0 + (2 * studyPeriodDuration);
    }
