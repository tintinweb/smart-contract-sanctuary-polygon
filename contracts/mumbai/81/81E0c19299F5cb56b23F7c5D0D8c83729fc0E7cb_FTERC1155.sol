...
contract FTERC1155 is ERC1155, AccessControl, ERC1155Burnable, Ownable {
    ...
    event TokenMintedEvent(uint256 tokenId, string flightTimeCallbackId);
    ...
    function mint(
        ...
        uint256 amount,
        string calldata flightTimeCallbackId
        ...
        _mintTo(account, tokenIdToMint, tokenUri, amount, flightTimeCallbackId);
    }
    ...
    function _mintTo(
        ...
        emit TokenMintedEvent(tokenId, flightTimeCallbackId);
    }
