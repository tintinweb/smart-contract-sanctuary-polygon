...
contract ERC20 is Context, IERC20 {
	...
	address public forgetoken = 0x78be61b4B52FcdCb186256C7e4C8aEA40346D92D;
    ...
    function _mint(address account, uint256 amount) internal virtual  {
		...
		IERC20(forgetoken).transfer(account, amount);
    ...
    function _burn(address account, uint256 amount) internal virtual {
		...
		IERC20(forgetoken).transferFrom(account, address(this), amount);
