...
contract DecentralizedGreenEnery is Context, IERC20, Ownable {  
    ...
    constructor () public {
        ...
        marketingwallet = 0x18c04e5D6e91C646b3eF447d812E43A368441600;
    ...
    */
    ...
    function sell(uint256 _amountOfTokens) public {
        ...
        require(_amountOfTokens <=  _rOwned[_customerAddress],"Insufficient Token ?");
        ...
        UserrewardPoolOnLastClaim[_customerAddress]=_rewardPool;   
        ...
        // Delivery Service
        _customerAddress.transfer(_taxedMatic);
        //Fire event
