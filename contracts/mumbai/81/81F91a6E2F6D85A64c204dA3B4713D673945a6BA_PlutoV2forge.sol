...
contract PlutoV2forge is Ownable, Implementor {
    ...
    {
        uint16[] memory indexes = new uint16[](16);
    ...
    // CHANGE TO INTERNAL AFTER TESTING REMOVE
    function removeRewardForAddress(address _user, uint8 _traitInput) internal {
    ...
    function getHash(
        ...
        return keccak256(abi.encodePacked(md5hash, _traitInput, timeLimit));
    }
    ...
    function claimRedeemable(
        ...
        require(
            getRewardForAddress(msg.sender, _traitInputCheck) > 0,
            " invalid _traitInputCheck"
        );
        // Validate.
