...
contract SampleNFT is ERC721URIStorage, Ownable, ReentrancyGuard {
    ...
    uint256 public immutable maxGiftMintId = 199;
    uint256 public giftMintId = 0;

    uint256 public immutable maxWhitelistId = 399;
    uint256 public whitelistId = 200;
    uint256 public constant WHITELIST_SALE_PRICE = 0.01 ether;

    uint256 public immutable maxPublicMint = 499;
    uint256 public publicMintId = 400;
