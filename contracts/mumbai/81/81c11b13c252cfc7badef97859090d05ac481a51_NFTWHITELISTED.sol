...
// File: contracts/NFT_WHITESYSTEM6_PRLIST_EVENT.sol
...
contract NFTWHITELISTED is ERC721Enumerable, Ownable {
  ...
  event PRiniti(address payable [] _PR);
  event whitelistevent(address whitelisted);
  event welcomePRevent(address welcome1);
  event welcomeUserevent(address welcome2);
