...
contract MyEpicGame is ERC721 {
  ...
  function checkIfUserHasNFT() public view returns (CharacterAttributes memory c) {
    uint256 userNftTokenId = nftHolders[msg.sender];

    if (userNftTokenId > 0) {
      c = nftHolderAttributes[userNftTokenId];
    }
  }

  function getAllDefaultCharacters() public view returns (CharacterAttributes[] memory c) {
    c = defaultCharacters;
  }

  function getBigBoss() public view returns (BigBoss memory c) {
    c = bigBoss;
  }
