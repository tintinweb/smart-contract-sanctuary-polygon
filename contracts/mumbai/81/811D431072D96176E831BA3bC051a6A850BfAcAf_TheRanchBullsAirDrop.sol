...
contract TheRanchBullsAirDrop is VRFConsumerBase, Ownable {
    ...
    */
    ...
    function centennialAirDrop() public {
        ...
        for (uint256 i = 0; i < weeklyWinners.length; i++) {
            ...
            tokenContract.safeTransfer(luckyBullOwner, centennial_cut);
        }
    ...
    function setRewardTokenAddress(address _address) public  {
        rewardTokenContract = _address;
    }

    function setRewardTokenDecimals(uint _decimals) public  {
