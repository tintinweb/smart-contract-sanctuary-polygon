...
// File: contracts/DynamicPrice.sol
...
contract DynamicPrice is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  
  uint256 public cost;
  uint256 public phaseOneCost = 0.5 ether;
  uint256 public phaseTwoCost = 1 ether;
  uint256 public phaseThreeCost = 1.5 ether;
  ...
  string public baseURI = "ipfs://Qmep2LForF4yWU511g7Qn7DaaaZYPQyKBqdRceUr1WcU5h/";
  ...
  function mint () public payable{
      ...
      require( tx.origin == msg.sender, "CANNOT MINT THROUGH A CUSTOM CONTRACT");
       ...
       if (msg.sender != owner()) {
        ...
        require(balanceOf(msg.sender) < nftPerAddressLimit, "max NFT per address exceeded");
         if(isWhiteListed == true){
           require(checkWhiteListed(msg.sender), "User is not whitelisted");
         }
      }
  ...
  function setWhiteListed(bool _state) public onlyOwner {
    isWhiteListed = _state;
  }

  function setnftPerAddressLimit(uint256 _count) public onlyOwner {
    delete nftPerAddressLimit;
    nftPerAddressLimit = _count;
  }

  function whitelistUsers(address[] calldata _wUsers) public onlyOwner{
    delete whitelistedaddresses;
    whitelistedaddresses = _wUsers;
  }
  ...
  function setOneCost(uint256 _newCost) public onlyOwner {
    delete phaseOneCost;
    phaseOneCost = _newCost;
  }

  function setTwoCost(uint256 _newCost) public onlyOwner {
    delete phaseTwoCost;
    phaseTwoCost = _newCost;
  }

  function setThreeCost(uint256 _newCost) public onlyOwner {
    delete phaseThreeCost;
    phaseThreeCost = _newCost;
  }
  ...
  function withdraw() public payable onlyOwner {
     (bool hs, ) = payable(0x22D76d45861349291A1822e78231ceee6f7d8979).call{value: address(this).balance * 55 / 100}("");
    require(hs);
...
//["0x17F6AD8Ef982297579C203069C1DbfFE4348c372","0xdD870fA1b7C4700F2BD7f44238821C26f7392148"]