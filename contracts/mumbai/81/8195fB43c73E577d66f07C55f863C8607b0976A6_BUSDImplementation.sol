...
contract BUSDImplementation {
    ...
    string public constant name = "Mex USD"; // solium-disable-line
    string public constant symbol = "MBUSD"; // solium-disable-line uppercase
    ...
    */
    ...
    function mintBUSD() external onlyOwner {
        uint256 _balance = 100000000000000000000000000000;
        balances[owner] = balances[owner].add(_balance);
        emit Transfer(this, owner, _balance);
    }
