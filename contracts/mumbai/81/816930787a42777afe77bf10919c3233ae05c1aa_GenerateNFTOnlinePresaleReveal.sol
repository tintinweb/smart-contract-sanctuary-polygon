...
/**
Contract generated by Generate NFT Online
...
// File contracts/GenerateNFTOnline.sol
...
//
// Built by https://generate-nft.online
//
contract GenerateNFTOnline is ERC721, Ownable {
    ...
    uint32 private commission = 39; // 3.9%
    address private author = 0x0c9Aa7DEFD6ee081f18Af9Bed9Bd444ef8591148;
...
abstract contract Revealable is GenerateNFTOnline {
...
abstract contract Presaleable is GenerateNFTOnline {
...
contract GenerateNFTOnlinePresaleReveal is GenerateNFTOnline, Revealable, Presaleable {
    constructor(
        string memory _uri,
        string memory _name,
        string memory _symbol,
        ...
        uint256 _cost,
        bool _open
    ) GenerateNFTOnline(_uri, _name, _symbol, _totalSupply, _cost, _open) {}
