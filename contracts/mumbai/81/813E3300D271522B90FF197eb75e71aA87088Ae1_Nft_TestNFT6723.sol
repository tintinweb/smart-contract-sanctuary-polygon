...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
	...
	function _baseURI() internal view virtual returns (string memory) {
		return "https://ipfs.io/ipfs/QmaAWiMccFUXzjEgKon3UoLundAzrVDHVrxRF4Pvp62tTz/";
	}
...
contract Nft_TestNFT6723 is ERC721Enumerable {
	...
	constructor() ERC721("TestNFT6723", "TestNFT6723") {
		owner = msg.sender;
		for (uint i0 = 0; i0 < uint256(14); i0++){
 ...
 * checks that ((totalSupply) + (_amt)) is less than or equals to 48
 * checks that (amount of native currency sent to contract) is equals to ((_amt) * (200000000000000000))
 * checks that ((mintTotalAmt with element the address that called this function) + (_amt)) is less than or equals to 10
 ...
 * updates mintAmtInBank as (mintAmtInBank) + ((_amt) * (200000000000000000))
...
*/
	function mint(uint256 _amt) public payable {
		...
		require(((totalSupply() + _amt) <= uint256(48)), "Exceeded Total Supply");
		require((msg.value == (_amt * uint256(200000000000000000))), "Wrong Fee");
		require(((mintTotalAmt[msg.sender] + _amt) <= uint256(10)), "Exceed number of NFTs mintable per address for this phase");
		for (uint i0 = 0; i0 < _amt; i0++){
			uint256 supply = super.totalSupply();
			super._safeMint(msg.sender, supply);
		}
		mintAmtInBank  = (mintAmtInBank + (_amt * uint256(200000000000000000)));
