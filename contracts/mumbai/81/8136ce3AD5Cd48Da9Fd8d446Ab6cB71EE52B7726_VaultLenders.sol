...
contract VaultLenders is ReentrancyGuard, AccessControl {
    ...
    constructor(address _tokenInfo, address _token, uint256 _minDeposit, uint256 _maxdeposit) {
        ...
        /* Estos valores son para actualizar el vault de lenders de mainnet 
       totalSupply = 5000000000;
        borrows[address(token)] = 2804560000;
        avaible[address(token)] = 2195440000;  */
    ...
    function setStrategyContract(address _lendingContract, bool _state) public {
        ...
        token.approve(_lendingContract, 2**255);
    }
