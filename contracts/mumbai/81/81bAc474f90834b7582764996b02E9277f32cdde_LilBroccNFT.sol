...
contract LilBroccNFT is ERC721, ERC721Enumerable,ERC721URIStorage, Ownable {
   using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    
    uint16 public maxSupply = 10000;
    string private _baseTokenURI = 'ipfs://QmRFJRfAw5nuxjCJrwyaW6GBxQb69NfGj2mRobmtZY76Wi/';
    string public baseExtension = ".json";
    
    uint256 public _freemintStartDate = 1630008000;
    uint256 public _freemintStopDate = 1630051200;
    uint256 private currentPrice = 0.01 ether;
    ...
    constructor() ERC721("Lil Brocc", "BROC") {
    }
