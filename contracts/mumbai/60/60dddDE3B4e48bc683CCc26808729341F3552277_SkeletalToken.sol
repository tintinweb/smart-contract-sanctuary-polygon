    ...
    ContextMixin
{
    ...
    constructor(
        ...
        address vault,
        address pool
    ) public ERC20Capped(100*(10**6)*(10**18)) ERC20("Skeletal Token", "SKEL") {

        // Token init
        _setupContractId("ChildMintableERC20");
        _setupDecimals(18);
        _setupRole(DEFAULT_ADMIN_ROLE, 0x1989d0CCCCA5530f48c3abB36A95841A21BacD95);
        _setupRole(DEPOSITOR_ROLE, 0xA6FA4fB5f76172d178d61B04b0ecd319C5d1C0aa);
        _initializeEIP712("Skeletal");
    ...
    function grantPoolMinterRole(address _pool) external only(DEFAULT_ADMIN_ROLE) {
