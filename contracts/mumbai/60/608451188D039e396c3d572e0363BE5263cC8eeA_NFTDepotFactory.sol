...
contract NFTDepotFactory is Ownable {
    // create methods to deploy nft contracts
    // function deployNFT(address _owner, string memory _name, string memory _symbol) public {
        // use create to clone ERC721Template contract
        // https://solidity.readthedocs.io/en/latest/contracts.html#create2
    ...
    address public minter = address(0x5B38Da6a701c568545dCfcB03FcB875f56beddC4);
...
contract ERC721Template is Initializable, ERC721Upgradeable, EIP712Upgradeable, ERC721URIStorageUpgradeable, ERC721BurnableUpgradeable, OwnableUpgradeable {
