 ...
 * for the additional interface id that will be supported.
 */
...
/**
 * @dev ERC1155 Multi Token Standard, Tokens Receiver.
 */
    ...
    Pausable
{
    ...
    function _beforeTokenTransfer(
        ...
        internal
        override(ERC1155, ERC1155URIStorage, ERC1155Supply)
        whenNotPaused
    {
        super._beforeTokenTransfer(operator, from, to, ids, amounts, data);
    }
