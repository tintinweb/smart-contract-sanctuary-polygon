...
contract Solisium is Ownable {
    ...
    uint256 private constant MIN_WITHDRAW = 0.5 ether;
    uint256 private constant MIN_INVESTMENT = 0.5 ether;
	...
	uint256 private constant TOTAL_REF = 15;
	uint256[] private REFERRAL_PERCENTS = [5, 4, 3, 2, 1];
    ...
    function _invest(address _addr, address _ref, uint256 _amount ) private returns (bool){
        require(msg.value >= MIN_INVESTMENT, "Minimum investment is 0.5 Matic");
    ...
    function reinvest() public {
		require(investors[msg.sender].lastWithdrawDate.add(TIME_STEP) <= block.timestamp,"Withdrawal limit is 1 time every 24 hours");
    ...
    function withdraw() public {
        ...
        require(dividendAmount >= MIN_WITHDRAW, "min withdraw amount is 0.5 matic");
