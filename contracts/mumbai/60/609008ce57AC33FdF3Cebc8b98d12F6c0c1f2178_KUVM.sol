...
contract BaseSBT is ERC721Enumerable, IERC4906, Ownable, Pausable {
    ...
    mapping(uint256 tokenID => uint256 metaType) internal _tokenMetaTypes;
    ...
    function metaType(uint256 tokenID_) external view returns (uint256) {
        _requireMinted(tokenID_);

        return _tokenMetaTypes[tokenID_];
    }
    ...
    function _burn(uint256 tokenID_) internal override {
        ...
        delete _tokenMetaTypes[tokenID_];
        _typeSupplies[tokenType_]--;
...
contract KUVM is BaseSBT {
    ...
    function airdropByType(
        ...
        if (
            ...
            _tokenMetaTypes[_tokenID] = _metaType;
