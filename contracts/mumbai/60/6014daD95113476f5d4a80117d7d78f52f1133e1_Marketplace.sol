...
contract Marketplace is ERC721Holder {
    ...
    function buy(address nftContract, uint256 itemId) external payable {
        ...
        uint256 commission = (price * COMMISSION_PERCENTAGE) / (10**DECIMALS);

        paymentToken.transferFrom(msg.sender, item.seller, price - commission);
        ...
        if (remainingBalance > 0) {
            paymentToken.transfer(msg.sender, remainingBalance);
        }
    }
