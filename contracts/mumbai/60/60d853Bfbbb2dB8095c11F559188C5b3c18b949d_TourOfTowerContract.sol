...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xDa4AA0D9C1067caD9B8cdd38e593E0DC39eeD611];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmVjfYAARTz8TXB8y6sa7yhKqYVGH3uwUSa6rK25ZhBrNy/";
...
// File: contracts/tourOfTowerContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TourOfTowerContract is RamppERC721A {
    constructor() RamppERC721A("TOUR OF TOWER", "TOT"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/uJRP8HzXq3amQZvO2hm9/contract-metadata";
    }
}