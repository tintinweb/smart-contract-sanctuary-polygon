...
contract EggAuction is BaseAuctionReceiver, ReentrancyGuard {
    ...
    constructor(address accessControl, address eggToken, uint fees100) 
    BaseAuctionReceiver(accessControl, eggToken, fees100) {
    }
    ...
    function buy(uint tokenId) external payable nonReentrant whenLocked(tokenId) {
