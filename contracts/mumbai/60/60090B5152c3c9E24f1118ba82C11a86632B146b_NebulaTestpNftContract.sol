...
//*********************************************************************//
//
//   ________  ________   _____________   _____________ _________
//  /_  __/ / / / ____/  / ____/ ____/ | / / ____/ ___//  _/ ___/
//   / / / /_/ / __/    / / __/ __/ /  |/ / __/  \__ \ / / \__ \ 
//  / / / __  / /___   / /_/ / /___/ /|  / /___ ___/ // / ___/ / 
// /_/ /_/ /_/_____/   \____/_____/_/ |_/_____//____/___//____/  
//                                                             
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1670842800;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmUMDZRmsbB3fWBXtiYAQW7e6Sv1Aip4BEdmqnBxhtmbtr/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/AOAgpJmUcdDe84RYaSZZ/contract-metadata";
  }
...
// File: contracts/NebulaTestpNftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NebulaTestpNftContract is RamppERC721A {
    constructor() RamppERC721A("Nebula Test pNFT", "NEBULAT"){}
}