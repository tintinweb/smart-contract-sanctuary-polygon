...
contract SCONTRACT is ERC721, Ownable {
  ...
  string public uriPrefix = "ipfs://QmYqNn1gMYKAFTc2wYVUAxxsjpY3DHpG1dwpC8tgkkEfYx/";
  string public uriSuffix = ".json";
  string public hiddenMetadataUri;
  
  uint256 public cost = 58 ether;
  uint256 public maxSupply = 1721;
  uint256 public maxMintAmountPerTx = 500;

  bool public paused = false;
  bool public revealed = true;

  constructor() ERC721("THE BABY GOATS COLLECTION", "BGC") {
    setHiddenMetadataUri("ipfs://QmYqNn1gMYKAFTc2wYVUAxxsjpY3DHpG1dwpC8tgkkEfYx/1.json");
  }
