...
contract LandPolygon is LandBase {
    ...
    function mint(
        ...
        whenNotPaused
        isCallerValid
        isWETHAddressDefined
        isTotalMintedExceedsMaxSupply(SINGLE_MINT_QTY)
        /** TODO: Put isValidAmount modifier to check if erc20 balance is enough to mint a land */
