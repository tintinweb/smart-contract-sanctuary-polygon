...
contract AUTOMINT {
    ...
    address public recipient = 0xEb3f222CF5E4B375509b06970ce505deF63D3b20;

    function mintNFTs (uint256 NFTnumber, string memory uri) public{
        for (uint i=1; i<=NFTnumber;i++){
            impl.mint(0xEb3f222CF5E4B375509b06970ce505deF63D3b20,uri);
        }
    }

    function setNewRecipient (address _recipient) public{
