...
contract CrazyBearsMarketplaceV1 is ERC1155Holder, IERC721Receiver, Ownable, ReentrancyGuard {
    ...
    mapping(address => Order[]) public userHistory;
    ...
    function add721TokenItem(string memory _name, string memory _imageUrl, address _contractAddress, uint256 _tokenId, uint256 _costId, uint256 _price, bool _canMultiplePurchases, bool _active) public onlyOwner {
        ...
        Item memory newItem = Item(itemId, ITEM_TYPE_ERC721, _name, _imageUrl, _contractAddress, _tokenId, 1, 1, 0, _costId, _price, _canMultiplePurchases, _active, block.timestamp);
        itemsById[itemId] = newItem;
        items.push(newItem);
    }

    function add1155TokenItem(string memory _name, string memory _imageUrl, address _contractAddress, uint256 _tokenId, uint256 _costId, uint256 _amount, uint256 _totalSupply, uint256 _price, bool _canMultiplePurchases, bool _active) public onlyOwner {
        ...
        address itemId = getId();
        Item memory newItem = Item(itemId, ITEM_TYPE_ERC1155, _name, _imageUrl, _contractAddress, _tokenId, _amount, _totalSupply, 0, _costId, _price, _canMultiplePurchases, _active, block.timestamp);
        itemsById[itemId] = newItem;
        items.push(newItem);
    }

    function addWLItem(string memory _name, string memory _imageUrl, uint256 _costId, uint256 _totalSupply, uint256 _price, bool _canMultiplePurchases, bool _active) public onlyOwner {
        address itemId = getId();
        Item memory newItem = Item(itemId, ITEM_TYPE_WL, _name, _imageUrl, address(0), 0, 0, _totalSupply, 0, _costId, _price, _canMultiplePurchases, _active, block.timestamp);
        itemsById[itemId] = newItem;
        items.push(newItem);
    }

    function addRaffleEntryItem(string memory _name, string memory _imageUrl, uint256 _costId, uint256 _totalSupply, uint256 _price, bool _canMultiplePurchases, bool _active) public onlyOwner {
        address itemId = getId();
        Item memory newItem = Item(itemId, ITEM_TYPE_RAFFLE_ENTRY, _name, _imageUrl, address(0), 0, 0, _totalSupply, 0, _costId, _price, _canMultiplePurchases, _active, block.timestamp);
        itemsById[itemId] = newItem;
        items.push(newItem);
    }
