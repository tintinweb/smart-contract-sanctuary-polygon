 ...
 * @title Items
 * @author TEAM201
 * @dev Library for managing items
 */
...
contract Items {
    ...
    // Sell item i.e transfer the ownership to another user
    function sell(
        address partyId,
        ...
        transferOwnership(msg.sender, partyId, barcodeId); // To transfer ownership from seller to buyer
