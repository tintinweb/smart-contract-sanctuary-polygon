...
import "./IVCArtNftERC721.sol";

contract VCArtNftERC721 is IVCArtNftERC721, ERC2981, AccessControl, ERC721 {
    using Strings for uint256;
    ...
    constructor(uint256 _maxRoyaltyBps, uint256 _maxBatchSize, address _admin) ERC721("VC-ArtNFT", "VCART") {
    ...
    function tokenURI(uint256 _tokenId) public view virtual override(IVCArtNftERC721, ERC721) returns (string memory) {
    ...
    function supportsInterface(
        bytes4 interfaceId
    ) public view virtual override(IVCArtNftERC721, ERC2981, AccessControl, ERC721) returns (bool) {
        return
