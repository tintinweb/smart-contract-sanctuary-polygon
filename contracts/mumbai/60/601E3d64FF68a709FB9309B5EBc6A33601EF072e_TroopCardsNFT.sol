    ...
    ContextMixin
{
    ...
    string public name = "Troop Cards NFT";

    constructor(address proxyRegistryAddress_)
        ERC1155(
            "https://gateway.pinata.cloud/ipfs/QmZBvghtHbHURg62exg5kXzyV1csKvZoUTr3aZn7j2gYUd/" // TODO: Change this before deployment
        )
    {
    ...
    function contractURI() external pure returns (string memory) {
        return
            "https://gateway.pinata.cloud/ipfs/QmcGF8So76oo9wNMyCKB8rmXiJVZC49U7HjNXqhxkFCWe5"; // TODO: Change this before deployment
    }
    ...
    {
        require(exists(id), "NONEXISTENT_TOKEN");
        return
            string(
    ...
    function _stakeNFT(address account, uint256 id) internal {
        require(balanceOf(account, id) > 0, "user doesn't own the nft");
    ...
    /**
     * @dev Overrides safeBatchTransferFrom function of ERC1155 to introduce nftStakeStatus check
     */
    function safeBatchTransferFrom(
        ...
        for (uint256 i = 0; i < nTransfer; i++) {
            require(!nftStakeStatus[_ids[i]], "NFT is staked");
        }
