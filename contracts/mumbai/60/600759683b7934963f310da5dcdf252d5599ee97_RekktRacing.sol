...
contract RekktRacing is ERC721Tradable {
    // constructor(
    //     address _proxyRegistryAddress
    // ) ERC721Tradable("Racing", "RE", _proxyRegistryAddress) {}
}
 ...
 * ERC721Tradable - ERC721Upgradeable contract that whitelists a trading address, and has minting functionality.
 */
    ...
    UUPSUpgradeable
{
    ...
    //     address _proxyRegistryAddress
    // ) ERC721Upgradeable(_name, _symbol) {
    //     proxyRegistryAddress = _proxyRegistryAddress;
    //     _initializeEIP712(_name);
    // }

    function initialize() public initializer {
        __ERC721_init("MetaRaptor", "MTRT");
        _initializeEIP712("MetaRaptor");
    ...
    function claimItem(string memory tokenURI, address from)
        public
        onlyOwner
        returns (uint256)
    {
