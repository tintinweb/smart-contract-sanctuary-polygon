...
contract ArtisFarm is IERC777Recipient {
    ...
    address public artisTokenAddress =
        0x8EC776d8Eda7275aa566794D6578eF607C32a02C;
    ...
    constructor() {
        artisToken = IERC777(artisTokenAddress);
    ...
    */
    function tokensReceived(
        ...
        require(
            to > address(this),
            "Must send tokens to this address... Ya bih."
        );
        require(
            artisToken.balanceOf(address(this)) ==
                totalARTISRewards + totalARTISLocked + amount,
    ...
    function addRewards(uint256 amount) public {
        ...
        artisToken.operatorSend(msg.sender, address(this), amount, "", "");
