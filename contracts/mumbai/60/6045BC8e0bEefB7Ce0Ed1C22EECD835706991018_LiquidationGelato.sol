 ...
 *
 **/
abstract contract AutomateLiquidation is GasEstimate, MixinResolver {
    ID4X _d4x;
    ...
    function check() public view returns (uint256[] memory positions) {
        return _d4x.getLiquidationPositions();
    }

    function perform(uint256[] memory positions) public {
...
import "./../../resolver/MixinResolver.sol";
import "hardhat/console.sol";
import "./../../automation/AutomateLiquidation.sol";
 ...
 *
 **/
contract LiquidationGelato is AutomateLiquidation {
    constructor(address resolver) AutomateLiquidation(resolver) {}
    ...
    {
        uint256[] memory positions = super.check();

        return (
            positions.length > 0,
            abi.encodeWithSelector(
                AutomateLiquidation.perform.selector,
                positions
            )
        );
    }
