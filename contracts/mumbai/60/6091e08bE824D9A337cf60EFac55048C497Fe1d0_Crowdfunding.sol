...
interface INFTCrowdfunding {
    ...
    function targetAmount() external view returns (uint256 targetAmount);
    function allowlist(address account) external view returns (bool status);
    function publicReceipt(address account) external view returns (uint256 publicReceipt);
    function allowlistReceipt(address account) external view returns (uint256 allowlistReceipt);
    function publicRefundReceipt(address account) external view returns (uint256 refundAmount);
    function allowlistRefundReceipt(address account) external view returns (uint256 refundAmount);

    function getPublicData() external view returns (uint256 startAt, uint256 endAt, uint256 price, uint256 AcctQty);
    function getAllowlistData() external view returns (uint256 startAt, uint256 endAt, uint256 price, uint256 AcctQty);

    function getPublicReceiptAccounts() external view returns (address[] memory accounts);
    function getAllowlistReceiptAccounts() external view returns (address[] memory accounts);

    function publicBuy(address account, uint256 buyQty) external returns (uint256 payableAmount);
    function allowlistBuy(address account, uint256 buyQty) external returns (uint256 payableAmount);
    function publicRefund(address account) external returns (uint256 refundAmount);
    function allowlistRefund(address account) external returns (uint256 refundAmount);
    function withdraw() external returns (uint256 withdrawAmount);
}
