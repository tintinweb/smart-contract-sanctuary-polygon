...
// File: AccessControlWithRoles.sol
...
contract AccessControlWithRoles is ERC1155, AccessControl, Pausable {
    ...
    function incDefAdminCount(address sender) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, sender), "Unauthorized: You do not have the DEFAULT_ADMIN_ROLE");
        defAdminCount++;
    }

    // Increments secAdminCount's count
    function incSecAdminCount(address sender) public {
        require(hasRole(SECOND_ADMIN_ROLE, sender), "Unauthorized: You do not have the SECOND_ADMIN_ROLE");
        secAdminCount++;
    }
