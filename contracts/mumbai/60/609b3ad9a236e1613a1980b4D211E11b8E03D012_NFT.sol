...
contract NFT is ERC1155URIStorage, ERC1155Burnable, ERC1155Pausable, ERC1155Supply {
    ...
    function setMintAuthority(address account) public {
    ...
    function mint(string memory _uri) public {
        require(mintable[msg.sender] == true, "You cannot mint");
        _mint(owner, _tokenAmount + 1, 1, "");
