 ...
 * @notice This contract handles minting sonnets of new york city tokens.
 */
contract SonnetsOfNewYorkCity is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xAD8625FDE4926C33A403C2D768C809ab9de39749;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xf6be92f9B65cb571Af03119BC6a0A7918cE4D606;
    address[] public payoutAddresses = [
        0xf6be92f9B65cb571Af03119BC6a0A7918cE4D606
    ];
    ...
    string public name = "sonnets of new york city";
    string public symbol = "SONYC";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeifcp3jcf762lpyqbgoo223kbgx6d23mrqefbmrwxtwlghbjgyglzi/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[3] = 3;
        tokenPublicPrice[3] = 0.011 ether;
        tokenPublicMintsPerAddress[3] = 3;
        tokenMaxSupply[33] = 3;
        tokenPublicPrice[33] = 0.011 ether;
        tokenPublicMintsPerAddress[33] = 3;
        tokenMaxSupply[333] = 3;
        tokenPublicPrice[333] = 0.011 ether;
        tokenPublicMintsPerAddress[333] = 3;
        require(
