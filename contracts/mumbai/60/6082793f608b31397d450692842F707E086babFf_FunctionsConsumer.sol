 ...
 */
contract FunctionsConsumer is FunctionsClient, ConfirmedOwner, IOracle {
  ...
  function fulfillRequest(
    ...
    latestError = err;
    // ILightClientMock.OracleResponse[] memory responses = abi.decode(response, (ILightClientMock.OracleResponse[]));
    // require(address(lightClient) != address(0x0), "Futaba: invalid ligth client");
...
interface ILightClientMock {
  ...
  function updateHeader(OracleResponse[] memory responses) external;
}
