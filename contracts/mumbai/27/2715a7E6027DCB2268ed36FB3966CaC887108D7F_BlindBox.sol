...
contract BlindBox is ERC721Upgradeable, OwnableUpgradeable, IERC721ReceiverUpgradeable {
    ...
    function setEventInfo(uint256 _period, uint256 _startTokenId, uint256 _nowTokenId, uint256 _total, uint256 _bought, uint256 _price, uint256 _purchase) public 
    {
