...
import "./mason/utils/ToggleableUpgradable.sol";
import "./mason/utils/EIP712CommonUpgradable.sol";
...
contract FloorAppPass is
    ERC721AUpgradeable,
    OwnableUpgradable,
    AdministrableUpgradable,
    ToggleableUpgradable,
    EIP712CommonUpgradable
{
    ...
    function initialize(
        ...
        maxPerWallet = 3;
        tokenPrice = 200000000;

        imageExtension = ".jpg";
        externalUrl = "https://www.floornfts.io";
        tokenDescription = "The Floor App Pass unlocks the Floor app for iOS & Android (in beta) and grants access to Floor App Pass channels in the Floor Discord.\\n\\nLearn more, and get started at https://floor.link/app-pass-nft";
        tokenName = "Floor App Pass";
    ...
    function mint(uint256 _count)
        ...
        requireActiveSale
    {
        if (_numberMinted(msg.sender) + _count > maxPerWallet)
    ...
    function airdrop(uint256 _count, address _recipient)
        external
...
contract EIP712CommonUpgradable is OwnableUpgradable {
    ...
    function __EIP712Common_init() internal {
...
abstract contract ToggleableUpgradable is OwnableUpgradable {
    bool public saleIsActive;
    bool public whitelistIsActive;

    function __Toggleable_init() internal {
        saleIsActive = false;
