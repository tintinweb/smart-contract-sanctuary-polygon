...
contract NFTCreatorApp is ERC721Tradable, PullPayment {
    string public baseContractURI;


    constructor()
        ERC721Tradable("NFTCreatorApp", "NCA", address(0xff7Ca10aF37178BdD056628eF42fD7F799fAc77c))
    {
        baseContractURI = "https://megacy.io/nfts/metadata?token=";
    }
    ...
    function isApprovedForAll(
      ...
      // for Polygon's Mumbai testnet, use 0xff7Ca10aF37178BdD056628eF42fD7F799fAc77c 0x58807baD0B376efc12F5AD86aAc70E78ed67deaE
       ...
       if (_operator == address(0x53d791f18155C211FF8b58671d0f7E9b50E596ad)) {
        ...
        return ERC721Tradable.isApprovedForAll(_owner, _operator);
    }
...
abstract contract ERC721Tradable is ERC721, ContextMixin, NativeMetaTransaction, Ownable {
    ...
    constructor(
        ...
        baseTokenURI = "https://nftcreatorapps.com/nft/metadata?token=";
    ...
    function _baseURI() internal view virtual override returns (string memory) {
        string memory _baseTokenURI = string(abi.encodePacked(baseTokenURI, Strings.toHexString(address(this)), "/"));
    ...
    function mintToWithURI(address _to, string memory _uri) public onlyOwner returns (uint256) {
    ...
    function mintTo(address _to) public onlyOwner returns (uint256) {
        uint256 currentTokenId = _nextTokenId.current();
        _safeMint(_to, currentTokenId);
        _setTokenURI(currentTokenId, string(abi.encodePacked(_baseURI(), Strings.toString(currentTokenId))));
        _nextTokenId.increment();
        return currentTokenId;
    }
