...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x6D89EcA05E25A6acCE9A47B5622195C407113E65];
  address public erc20Payable = 0x6D89EcA05E25A6acCE9A47B5622195C407113E65;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://https://nftstorage.link/ipfs/bafybeihr4fmn4zffajghgarhrpiocuo4i52xyfew62xg7qrsfw3jcqtqde/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/wCZ8dgAEW0gGSAZpuhUM/contract-metadata";
  }
...
// File: contracts/DmyContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DmyContract is RamppERC721A {
    constructor() RamppERC721A("DMY", "MATIC"){}
}
