...
contract Product020802V01 is OwnableV01 {
    ...
    function createPolicy(
        ...
        for (uint index = 0; index < policyParams.selectedCoverages.length; index++) {
    ...
    function endorsePolicy(
        ...
        Product020802Lib.Policy storage _policy = allPolicies[endorsementParams.onChainPolicyId];
