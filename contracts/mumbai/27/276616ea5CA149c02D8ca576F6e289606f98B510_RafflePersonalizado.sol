...
/**@title Contrato Rifa
 * @author Yoel Torres
 * @notice Contrato sin verificar para ver si se puede decodificar desde la web
 * @dev  implementando chainlink VRF
 */
contract RafflePersonalizado is VRFConsumerBaseV2, AutomationCompatibleInterface {
    /* Type declarations */
    enum RaffleState {
        OPEN,
        CALCULATING
    ...
    function enterRaffle(uint256 numTicket) public payable {
    ...
    function fulfillRandomWords(
        ...
        uint256 winnerNum = randomWords[0] % numMaxPlay;
