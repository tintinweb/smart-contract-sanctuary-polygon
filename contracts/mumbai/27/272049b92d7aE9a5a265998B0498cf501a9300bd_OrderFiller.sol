...
contract OrderFiller is Initializable {
    ...
    function fillBuyOrder(
        ...
        IERC20(takerOrder.takerToken).approve(exchangeProxyAddress, _orderData.totalMakerTokensToFill);
        // For every order submitted
        for (uint256 i = 0; i < info.makerOrdersToFill; i++) {
            ...
            require((info._takerFill != 0) && (info._makerFill != 0));
        ...
        require((info.takerFill != 0) && (info.makerFill != 0));
        ...
        return (info.MakerTokenAmountFilled, info.takerFill);
    }
