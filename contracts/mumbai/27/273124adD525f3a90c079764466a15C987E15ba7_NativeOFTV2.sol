...
import "../token/oft/v2/OFTCoreV2.sol";
...
contract NativeOFTV2 is OFTV2, ReentrancyGuard {
    ...
    constructor(string memory name, string memory symbol, uint8 _sharedDecimals, address _layerZeroEndpoint) OFTV2(name, symbol, _sharedDecimals, _layerZeroEndpoint) {}
