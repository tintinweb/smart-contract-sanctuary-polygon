...
contract ChainBattles is ERC721URIStorage  {
    ...
    function mint() public {
        ...
        tokenIdToTrack[newItemId].level = 3;
        tokenIdToTrack[newItemId].speed = 5;
        tokenIdToTrack[newItemId].strength = 2;
        tokenIdToTrack[newItemId].life = 7;
    ...
    function train(uint256 tokenId) public {
        ...
        tokenIdToTrack[tokenId].strength = currentStrength + random(currentStrength);
