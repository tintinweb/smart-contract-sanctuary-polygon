...
// File: contracts/WHYteRabbitHoleTrip.sol
...
contract WHYteRabbitHoleTrip is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721("WHYteRabbitHoleTrip", "WHYT") {}
    ...
    return "ipfs://QmQMaPLvRhtvUsDh5x7eqP27Vm9x8wwPv7qs3sDjBL9ysv/";
    ...
    function mintpid(address _to, uint256 _mintAmount, uint256 _pid) public payable nonReentrant {
        ...
        function setmaxMintAmount(uint256 _newmaxMintAmount) public nonReentrant onlyOwner() {
        ...
        function setBaseExtension(string memory _newBaseExtension) public nonReentrant onlyOwner() {
            baseExtension = _newBaseExtension;
        }
        
        function pause(bool _state) public nonReentrant onlyOwner() {
            paused = _state;
        }
