...
import "contracts/ERC721ABurnable.sol";
import "@openzeppelin/contracts/access/Ownable.sol";
import "@openzeppelin/contracts/utils/Address.sol";
import "@openzeppelin/contracts/utils/Strings.sol";
import "@openzeppelin/contracts/security/ReentrancyGuard.sol";

contract BraveSunset is ERC721A, Ownable, ReentrancyGuard, ERC721ABurnable {
    ...
    function devMint(uint8 quantity) external onlyOwner {
        ...
        _mint(theOwner, quantity);        
    }
    
    // Safe mint functon for burn and mint
    function safeMint(address to, uint256 tokenId) public onlyOwner {
        _safeMint(to, tokenId);
    }

    // Burn token
    function _burnAndMint(uint256 tokenId) internal onlyOwner {
        burn(tokenId);

        safeMint(theOwner, tokenId);    
    }
...
import 'contracts/IERC721ABurnable.sol';
