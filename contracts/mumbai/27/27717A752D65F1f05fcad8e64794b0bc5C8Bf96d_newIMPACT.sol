...
contract newIMPACT is ERC20 {
    ...
    mapping(address=>uint) impactHold;
    modifier onlyOwner() {
    ...
    function getImpact(uint amount) external {
        require(impactHold[msg.sender]+amount<=1000,"Cannot transfer more than 1000 tokens");
        impactHold[msg.sender]+=amount;
