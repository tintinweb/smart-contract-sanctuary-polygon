...
// File: contracts/ICrazyCrowsAssets.sol



pragma solidity ^0.8.0;

interface ICrazyCrowsAssets {
...
contract AssetShop is OwnableWithAdmin {
    ...
    ICrazyCrowsAssets public immutable crazyCrowsAssets;
    address public centralTreasuryControl = 0xd340c737ad9675F0c9E625BBf02245adE2c3f72c;

    constructor(address _crazyCrowsAssetsAddress) {
        crazyCrowsAssets = ICrazyCrowsAssets(_crazyCrowsAssetsAddress);
    }
    ...
    function purchaseAsset(uint256 _tokenId, uint256 _amount, address _currency) external {
        ICrazyCrowsAssets _crazyCrowsAssets = crazyCrowsAssets;
        uint256 _price = _crazyCrowsAssets.getPrice(_tokenId, _currency) * _amount;
        ...
        _crazyCrowsAssets.mint(_msgSender(), _tokenId, _amount);
    }
