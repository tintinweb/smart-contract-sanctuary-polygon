...
contract Marketplace is Initializable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    function _buyItem(
        ...
        IERC20Upgradeable(_payToken).safeTransferFrom(_msgSender(), _owner, price);
    ...
    function registerRoyalty(
        ...
        require(INFTFactory(addressRegistry.factory()).exists(_nftAddress), "NFT not minted on Veritone Marketplace");
