...
contract CrazyBearsMarketplaceV1 is ERC1155Holder, IERC721Receiver, Ownable, ReentrancyGuard {
    ...
    struct Item {
        address id;
        uint itemType; // 0: ERC721, 1: ERC1155, 2: WL spots, 3: Raffle Entry, 999: Other
        string name;
        string imageUrl;
    ...
    function add721TokenItem(string memory _name, string memory _imageUrl, address _contractAddress, uint256 _tokenId, bool _active) public onlyOwner {
        ...
        Item memory newItem = Item(itemId, 0, _name, _imageUrl, _contractAddress, _tokenId, 1, 0, _active);
