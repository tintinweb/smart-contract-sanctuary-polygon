...
contract ProjectDao is ERC1155, AccessControlEnumerable, ERC1155Supply, Pausable {
  ...
  Project public project = Project("", "", "", address(0), "", "", "", address(0));
  ...
  function distributeShares() private {
    ...
    withdraw(project.factory, foundationShareInMatic);
  ...
  // added for testing
  function setFactoryAddress(address _factory) external onlyRole(AUTHOR_ROLE) whenNotPaused {
    project.factory = _factory;
  }
