...
abstract contract OnChainMusicMetadata {
        ...
        returns (string memory)
    {
        ...
        string[47] memory values = [
            _getString(_tokenMetadata[tokenId].songPublishingData.title),
            _getString(_tokenMetadata[tokenId].songPublishingData.description),
            _getString(_tokenMetadata[tokenId].song.artwork.imageUri),
            _getString(_tokenMetadata[tokenId].songPublishingData.title),
            '"sweetman eth"',
            "2846.69",
            '"audio/wav"',
