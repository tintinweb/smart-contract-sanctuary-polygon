...
contract FishToken is ERC20, Ownable, GelatoRelayContext {
    ...
    // Function Matic Balance
    function contractFund() private view returns (uint256) {
        return payable(address(this)).balance;
    }

    // Function to Withdraw MATIC from the Smart Contract
    function withdrawFund(address payable _to) external onlyOwner {
        (bool success, ) = _to.call{value: contractFund()}("");
