...
// File: contracts/VioleContract.sol
...
contract Viole is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("David On Chain", "DAVOC") {
    setHiddenMetadataUri("ipfs://QmVYFWZWkZdpn9dyDPtWSRsTujGskuv3FRZGGZ4cR6hDso/hidden.json");
  }
