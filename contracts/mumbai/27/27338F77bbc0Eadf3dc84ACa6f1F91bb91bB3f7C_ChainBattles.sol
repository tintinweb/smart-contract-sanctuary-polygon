...
contract ChainBattles is ERC721URIStorage{
    ...
    mapping(uint256 => tokenLevel) public tokenIdToLevels;
    ...
    function mint() public {
        ...
        tokenIdToLevels[newTokenId].level = 0;
        tokenIdToLevels[newTokenId].strength = 0;
        tokenIdToLevels[newTokenId].speed = 0;
        tokenIdToLevels[newTokenId].life = 0;
