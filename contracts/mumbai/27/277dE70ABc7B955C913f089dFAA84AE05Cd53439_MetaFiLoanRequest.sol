...
contract MetaFiLoanRequest {
        ...
        returns (bool)
    {
        return  
            ...
            loanRequests[_nftContractAddress][_tokenId].lenderDeposit * (10000 + loanRequests[_nftContractAddress][_tokenId].loanInterestPercentage * (loanRequests[_nftContractAddress][_tokenId].loanPeriod / 86400)) / 10000; //should be considered
    }
    ...
    function _getFeeByDailyPercentage(uint256 _amount, uint32 _percentage, uint64 _passTimeInSec)
        internal
        pure
        returns (uint256)
    {
        return (_amount * (_percentage * (_passTimeInSec / 86400))) / 10000;
    }
    ...
    function lenderDepositAndFullfilBuy(
        address _nftContractAddress,
        uint256 _tokenId,
        address _erc20Token,
        uint128 _amount
        ...
        ERC20TokenWhitelisted(_erc20Token)
    {
        ...
        fullfillBuyRequest(_nftContractAddress, _tokenId);
