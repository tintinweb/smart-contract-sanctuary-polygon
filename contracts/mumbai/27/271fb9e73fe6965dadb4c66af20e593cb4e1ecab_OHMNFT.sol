...
contract OHMNFT is ERC721A, Ownable, ReentrancyGuard {  
...
// ================== Constructor Start =======================
  ...
  ) ERC721A("OHM NFT", "OHM")  { //change this line to your full and short NFT name
...
//============================ Mint for address ================
  ...
  function MintForAddress(uint256 _mintAmount, address _Reciver) public onlyOwner {

     _safeMint(_Reciver, _mintAmount);
...
//=========================withdraw ======================
                  ...
                  // Don't Remove This its Keep safe withdraw "Creater"
