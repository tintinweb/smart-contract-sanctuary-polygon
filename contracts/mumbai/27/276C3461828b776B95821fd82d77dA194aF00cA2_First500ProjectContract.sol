...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x372c789aa46503182B839568609bd13Cfc1daAAD];
...
// File: contracts/First500ProjectContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract First500ProjectContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "First 500 Project";
    string public symbol = "F5P";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/4U4cEXZByQny54pMg70r/contract-metadata";
  }
