...
contract TestNTF is ERC721Enumerable, Ownable {
	...
	constructor() ERC721("TEST NFT", "TNT1") {
		_reserved = 100;
		_price = 25 * 10 ** 18;
		_saleStarted = false;
		setBaseURI("https://cyberbrokers.io/api/cyberbroker/");
	}
    ...
    // Allows for the early reservation of 100 NFT from the creators for promotional usage
    ...
    function transferERC20(IERC20 token, address to, uint256 amount) public payable onlyOwner {
