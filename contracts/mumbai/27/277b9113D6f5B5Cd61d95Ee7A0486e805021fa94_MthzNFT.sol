...
import "../Common/ERC721/ERC721URIStorage.sol";

import "../Common/ownership/Ownable.sol";
import "../Common/ToString.sol";
import "../Common/Counters.sol";

contract MthzNFT is ERC721URIStorage, Ownable, ToString {
    address private proxyContract;

    Counters.Counter private tokenIds;

    string private prefixURI = "https://apiweb.z5.xyz/heroezNft/live/metadata/";
    string private constant SUFIXURI = ".json";

    constructor() ERC721("MTHZ", "MTZ") {}
