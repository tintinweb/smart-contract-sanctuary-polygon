...
contract TSL is ItsukiUpgradable {
    constructor() ItsukiUpgradable("generate", "GNR", 20) {}
}
    ...
    ReentrancyGuardUpgradeable
{
    ...
    constructor(
        ...
        initialize(_name, _symbol, _maxSupply);
    }
