...
// @author Mark Ibanez - [email protected] (github)
contract GoingUpAccountsV1 is Initializable, AccessControlUpgradeable {
    function initialize() public initializer {
        _setupRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _setupRole(DEFAULT_ADMIN_ROLE, 0x68D99e952cF3D4faAa6411C1953979F54552A8F7);
    }
    ...
    mapping (string => EnumerableSetUpgradeable.AddressSet) private userAddresses;
