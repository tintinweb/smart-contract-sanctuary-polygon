...
contract RandomWorker is AccessControl {
    ...
    mapping(address => mapping(uint256 => uint256)) public mintedMetadata;
    ...
    function batchGetRanomNum(
        ...
        for (uint i = 0; i < 50; i++) {
            ...
            metads[i] = result;
            mintedMetadata[_msgSender][tokenId[i]] = result;
        }
    ...
    function getUserTokenAndInfos(
        ...
        require(userAddress != address(0), "resultsPerPage cannot be 0");
        require(tokenId > 0, "Invalid TokenId");
        return mintedMetadata[userAddress][tokenId];
    }
    ...
    function getRandomNumber(
        ...
        mintedMetadata[_msgSender][tokenId] = result;
