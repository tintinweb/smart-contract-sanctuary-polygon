...
contract DaoCommittee is  OwnableUpgradeable {
    ...
    function initialize (IERC20 _XENO , address _fundsWallet) public initializer { 
        XENO = _XENO;
    ...
    function addNfts ( string  calldata uri_ ) external {
        require(XENO.balanceOf(msg.sender) >99 ether, "Must hold 100 XEN Tokens");
        XENO.transferFrom(msg.sender, fundsWallet, 30e18);
