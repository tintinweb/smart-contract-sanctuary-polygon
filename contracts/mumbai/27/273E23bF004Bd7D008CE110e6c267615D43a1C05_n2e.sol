...
/** 
 *  SourceUnit: /home/himanshu/EthOnline/n2e/smart-contract/contracts/n2e.sol
*/
...
contract n2e is ERC721URIStorage {
    ...
    */
    ...
    function registerEvent(
        ...
        proposal.deadline = block.number + 150;
    ...
    //this function return true if user has not book a slot in an evnt already
     function verify(uint256 eventId,uint256 nullifierHash) external view returns(bool){
