...
contract ROGPopsPunk is ERC721Enumerable, Ownable {
    ...
    ) payable ERC721("ROGPopsPunk", "RPP") {
        baseURI = "ipfs://QmcrLFkpTKZt6n9ZpyozqViy1eet7VczsEhzLbVLjdSMT3/";
        cost = 0.010 ether;
        maxSupply = 99;
        maxPerWallet = 3;
    ...
    function payToMint(uint256 quantity_) public payable {
        uint256 supply = totalSupply();
        require(!paused, "The sale is paused");
        require(supply + quantity_ <= maxSupply, "Sorry, all NFTs have been minted!");
        ...
        if (msg.sender != owner()) {
            require(msg.value >= cost, "Please top up values");
        }
