...
contract GaiaLand is ERC721, Ownable {
  ...
  function mintGaiaLandToken(
    ...
    // uint gaiaUSDC = getTokenPrice();
    uint gaiaUSDC = 400 * (10**18);
    uint _price = (gaiaGoodLandPrice * numberOfGoodLands + gaiaRegularLandPrice * numberOfRegularLands) * (10**18) / gaiaUSDC;
    require(
