...
contract DemoERC721 is ERC721, Ownable {
    ...
    constructor() ERC721("DemoERC721", "DEMONFT") {
    ...
    function airdrop(address _receiver) external  {
        // anyone can airdrop anyone else
        _mint(_receiver, totalSupply);
        totalSupply += 1;
    }

    function mint() external  {
        // no limit single mints
        _mint(msg.sender, totalSupply);
        totalSupply += 1;
    }

    // ERC721 transferFrom override without ownership
    ...
    // ERC721 safeTransferFrom override without ownership
