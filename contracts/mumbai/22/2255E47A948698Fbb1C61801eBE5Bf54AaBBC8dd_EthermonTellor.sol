...
// File: contracts/EthermonTellor.sol

pragma solidity 0.8.0;

contract EthermonTellor is UsingTellor {
    ...
    function setEmonPrice() public {
        bytes memory _b = abi.encode("SpotPrice", abi.encode("emon", "usd"));
