...
contract  FullOnchainTest7 is ERC721Enumerable, ERC721Permit("FullOnchainTest7NFT:Token"), ERC721Mintable, ReentrancyGuard, Ownable {
    ...
    constructor() ERC721("FullOnchainTest7NFT:Token", "FULL TEST") Ownable() {}


    function setInfos(string[] calldata _letters, string[] calldata _fontColors, string[] calldata _backgroundColors, uint256[] calldata _tokenIds) public onlyOwner {
    ...
    function tokenURI(uint256 _tokenId) public override view returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Sample test #', toString(tokenIdNumber[_tokenId]), '", "description": "This is test.", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
