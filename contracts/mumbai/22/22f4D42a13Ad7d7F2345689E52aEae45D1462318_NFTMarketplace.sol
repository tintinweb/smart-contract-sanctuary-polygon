...
contract NFTMarketplace is ReentrancyGuard, ERC721URIStorage, ERC2981, Ownable{
    ...
    function mintNFT(string memory uri, uint256 nftRoyaltyPercent) public payable nonReentrant{
        ...
        MarketItemDatabase[newTokenId] = MarketItem(newTokenId, _scAddress, uri, payable(msg.sender), payable(address(0)), 0, nftRoyaltyPercent, nft_Id, false);
        emit MarketItemCreated(newTokenId, _scAddress, uri, msg.sender, address(0), 0, nftRoyaltyPercent, nft_Id, false);
    }
    function listNFT(uint256 tokenId, uint256 price) public {
        ...
        _setTokenRoyalty(MarketItemDatabase[tokenId].nftId, MarketItemDatabase[tokenId].nftCreator, uint96(MarketItemDatabase[tokenId].nftRoyaltyPercent));
