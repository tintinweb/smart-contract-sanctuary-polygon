...
contract Metacard is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public giftPercentage = 2;
 ...
 function setGiftPercentage(uint256 _newPercentage) public onlyOwner(){
  ...
  function withdraw() public payable onlyOwner {
    ...
    (bool d, ) = payable(0xbCC5C3ece3c2cb58A16DDB64e6926105fcD63F51).call{value: address(this).balance * 10 / 100}("");
    require(d);
