...
contract BetVerseTokenICOUSDT is ERC20, ReentrancyGuard, Ownable {
        ...
        )
    {
        ...
        // We must keep 6 decimal places :: USDT
        usdt.transferFrom(msg.sender, walletTo, usdtAmount);

        // It must have 18 decimal places :: WEI
    ...
    function getTokenAmountToSell(uint256 usdtAmount) public view returns (uint256) {
        // USDT already have 6 decimal places we need to convert it to WEI so the TOKEN can send it correctly.
        // 6 decimal places + 12 decimal = 18 
        return usdtAmount.div(price) * 10**18;
    }
