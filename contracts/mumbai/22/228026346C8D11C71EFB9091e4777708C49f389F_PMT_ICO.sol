...
contract PMT_ICO{
	...
	{
     	require(tokenQty>=MINIMUM_BUY*1e18,"Invalid minimum quatity");
      require(tokenQty<=MAXIMUM_BUY*1e18,"Invalid maximum quatity");
      uint256 bnb_amt=tokenQty*((token_price/1000)*1e18);
