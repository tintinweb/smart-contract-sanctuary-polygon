    ...
    ReentrancyGuard
{
    ...
    mapping(bytes32 => OrderBook) public salesList;
        ...
        marketplaceCompliance(_amount, _tokenid)
    {
        ...
        bytes32 listingId = keccak256(
            abi.encodePacked(listingNonce, address(this), _tokenid)
        );
        require(
    ...
    function delistFromMarketplace(uint256 _tokenid, bytes32 _listingId)
        public
        virtual
        nonReentrant
    {
    ...
    function purchaseItem(bytes32 _listingId) external payable nonReentrant {
        bytes memory data = "";
    ...
    // Read Functions
    function getItemPrice(bytes32 _itemId) public view returns (uint256) {
    ...
    function getNFTOrderBookDetails(bytes32 id)
        external
        view
