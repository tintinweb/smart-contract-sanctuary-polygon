...
import "./HashUpSingleToken.sol";

contract HashUpSingleTokenFactory is Ownable {
    ...
    function deployCollection(
        ...
        HashUpSingleToken collection = new HashUpSingleToken(
            _name,
            _symbol,
            _initBaseURI,
            address(config)
    ...
    PreAuthorization
{
    ...
    constructor(
        ...
        config = IHashUpConfig(_nftingConfig);
