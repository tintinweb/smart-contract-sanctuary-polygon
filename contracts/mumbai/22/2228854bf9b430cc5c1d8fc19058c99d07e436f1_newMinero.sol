...
contract newMinero is Context, Ownable , ReentrancyGuard {
    ...
    require(totalWithdraw[msg.sender].amount <= SafeMath.mul(investments[msg.sender].invested,3), "You cant withdraw you have collected three times ROI already"); // hh new
...
investments[msg.sender].invested = 0;
    ...
    function unStake() external noReentrant {
        ...
        require(I_investment > t_withdraw, "You have already withdrawn more than your investment");
