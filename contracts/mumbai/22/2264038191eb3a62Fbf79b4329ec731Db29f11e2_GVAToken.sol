...
// import "@thirdweb-dev/contracts/openzeppelin-presets/token/ERC20/extensions/ERC20Permit.sol";
...
contract GVAToken is ContractMetadata, Multicall, Ownable, ERC20Permit {
    /*//////////////////////////////////////////////////////////////
                            Constructor
    //////////////////////////////////////////////////////////////*/
    ...
    constructor(string memory _name, string memory _symbol) ERC20Permit(_name) ERC20(_name, _symbol) {
        ...
        // 4 billion with 18 decimals
        _mint(msg.sender, 40000000000000000000000000000);
    }
