 ...
 * @notice This contract handles minting Metaverse Academy PoP - TEST tokens.
 */
contract MetaverseAcademyPoPTEST is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x57803414c49d6628C5282c1B903C69dc111b91C3;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x6CA58804B0aa4d451F58D1DD262170fE711Ece76;
    ...
    string public name = "Metaverse Academy PoP - TEST";
    string public symbol = "MAPOP";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeictxj2omjbcxbwhcnn54jirlh4aji4l22jwsvtbd7ybuidjvnuwoi/{id}"
        )
        RevokableOperatorFilterer(
