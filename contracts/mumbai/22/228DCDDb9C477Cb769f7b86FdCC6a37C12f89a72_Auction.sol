...
contract Auction is Ownable {
    ...
    function purchaseProcessing(
        ...
        require(
            stanFund[_buyer] - creatorAmount - creatorStan - fee > 0,
    ...
    function getInforListingAuction(string memory _auctionId)
        public
        view
        returns (
            string memory,
    ...
    {
        DataStructure.Listing memory listing = Listings[_auctionId];
    ...
    function placeBidAuction(
        ...
        (
            ...
            ,
            uint256 _tokenId
        ) = getInforListingAuction(_auctionId);
    ...
    function acceptOfferPvP(
        ...
        require(msg.sender == ownerNFT, "You are not the owner of this NFT");
    ...
    function acceptOfferAuction(
        ...
        (, , address ownerOfNFT, , , , ) = getInforListingAuction(_auctionId);
        ...
        purchaseProcessing(_collectionId, owner, maker, amount, 0, tokenId);
