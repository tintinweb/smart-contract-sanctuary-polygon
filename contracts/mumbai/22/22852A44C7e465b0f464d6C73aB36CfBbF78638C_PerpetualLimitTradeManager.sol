    ...
    IPerpetualLimitTradeManager
{
     ...
     * @param _isApprovedExecutor Flag indicating whether the executor is excempt from delay constraints.
     */
    ...
    /**
     * Charges a rebatable relative fee: to earn a rebate, the order needs to be executed.
     * @dev The fee is charged in collateral currency, and stored in the liquidity pool until it is rebated.
     * @param _order Perpetual order
     * @param _feeTbps Relative fee in tenths of a basis point
     */
    ...
    /**
     * Rebates the fee charged via chargePostingFee. It is called by the order book where the order was posted.
     * @param _order Perpetual order
     * @param _feeTbps Relative fee in tenths of a basis point
     */
