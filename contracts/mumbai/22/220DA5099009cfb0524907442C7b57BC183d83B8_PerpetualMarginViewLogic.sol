...
contract PerpetualMarginViewLogic is
    ...
    PerpetualRebalanceFunctions
{
    ...
    function calcMarginForTargetLeverage(
        ...
        PerpStorage.PerpetualData storage perpetual = _getPerpetual(_iPerpetualId);
        ...
        if (_fTargetLeverage == 0) {
            ...
            int128 fMaxLvg = ONE_64x64.div(int128(perpetual.fInitialMarginRate) << 35);
        ...
        return
            _getAMMPerpLogic().getDepositAmountForLvgPosition(
                _fTraderPos,
                b0,
                _fTradeAmountBC,
                _fTargetLeverage,
    ...
    function _getMarginBalance(PerpStorage.PerpetualData storage _perpetual, address _traderAddr)
        internal
        view
        returns (int128)
    {
        ...
        int128 fLockedInValueCC = marginAccounts[_perpetual.id][_traderAddr].fLockedInValueQC.div(
            fConversionC2Q
        );
        int128 fCashCC = _getAvailableCash(_perpetual, _traderAddr);
        int128 fMargin = marginAccounts[_perpetual.id][_traderAddr]
            .fPositionBC
            .mul(fConversionB2C)
            .add(fCashCC);
    ...
    function _getAvailableMargin(
        PerpStorage.PerpetualData storage _perpetual,
        address _traderAddr,
        bool _isInitialMargin
    ...
    function _getInitialMargin(PerpStorage.PerpetualData storage _perpetual, address _traderAddr)
        internal
        view
        returns (int128)
    {
    ...
    function _getMaintenanceMargin(
        ...
        int128 fConversionB2C = _getBaseToCollateralConversionMultiplier(_perpetual, atMark);
        int128 pos = marginAccounts[_perpetual.id][_traderAddr].fPositionBC;
        int128 m = int128(_perpetual.fMaintenanceMarginRate) << 35;
        return pos.mul(fConversionB2C).mul(m).abs();
    }
     ...
     */
    function isMarginSafe(uint24 _iPerpetualId, address _traderAddr)
        external
        view
        override
        returns (bool)
     ...
     */
    function _getTraderPosition(PerpStorage.PerpetualData memory _perpetual, address _traderAddr)
        internal
        view
        returns (int128)
    {
