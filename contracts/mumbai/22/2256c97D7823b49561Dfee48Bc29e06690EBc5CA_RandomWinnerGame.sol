...
contract RandomWinnerGame is VRFConsumerBase, Ownable {
    ...
    // Chainlink
    // Theamount of LINK to send with the request
    uint256 public fee;
    ...
    // Max numbers of players in one game;
    uint8 maxPlayers;
    ...
    function startGame(uint8 _maxPlayers, uint256 _entryFee) public onlyOwner {
        // Check if the there is a game already running
     ...
     * This function is overried to act upon the random number generated by Chainlink VRF.
    ...
    function getRandomWinner() private returns (bytes32 requestId) {
        ...
        // Here we use the balanceOf methos from that interface to make sure that our
