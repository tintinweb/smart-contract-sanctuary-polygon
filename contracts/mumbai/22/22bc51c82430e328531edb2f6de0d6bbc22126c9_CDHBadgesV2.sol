...
// File: BadgesSignatureValidator.sol
...
contract CDHBadgesV2 is Initializable, UUPSUpgradeable,ERC1155Upgradeable, PausableUpgradeable, OwnableUpgradeable, BadgesAccessControl, IERCSBT {
    using ECDSA for bytes32;
   ...
   function _authorizeUpgrade(address) internal override onlyOwner {}
    ...
    function aboutthisVersion2() public pure returns (string memory ){
