...
contract Gsuperinoes is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Gsuperinoes", "GS") {
    setHiddenMetadataUri("ipfs:QmWehjyynJGYFZXD2pvz2SXMAEmtPw9RzxfNHM1jp4eH8e.json");
  }
