...
contract Game is IGame, OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable{
    ...
    function shoot() external override nonReentrant whenNotPaused {
        ...
        (uint256[12] memory boatPosition, uint256 firstPosition, uint256 secondPosition, uint256 finalReward, uint256 boatShot) = calPosition(randomNumber);
        playNumbers += 1;
    ...
    function calPosition(uint256 randomNumber) public override view returns (
        ...
        (finalReward,) = rewardMul(userReward, msg.sender);
    }
...
pragma solidity ^0.8.0; 
 ...
 interface IGame {
    ...
    function calPosition(uint256 randomNumber) external view returns (uint256[12] memory map, uint256 firstPosition, uint256 secondPosition, uint256 finalReward, uint256 boatShot);
 }
