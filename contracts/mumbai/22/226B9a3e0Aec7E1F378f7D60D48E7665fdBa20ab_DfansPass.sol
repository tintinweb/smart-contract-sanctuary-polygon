...
contract DfansPass is ERC721, ERC721Royalty, ERC721Pausable, Ownable, Initializable, DefaultOperatorFilterer {
    ...
    // function withdrawForBeneficiary() public onlyOwner{
    //     //require(false, Strings.toHexString(address(this)));
    //     uint withdrawableForBeneficiary = address(this).balance - totalReceived;
    //     //require(withdrawableForBeneficiary > 0, "Nothing to withdraw");
    //     //_transfer(beneficiary, address(this).balance);
    // }
