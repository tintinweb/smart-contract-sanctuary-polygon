...
contract Dao {
    ...
    constructor() {
        contractDao = interfaceDao(0x2953399124F0cBB46d2CbACD8A89cF0599974963);
        daoToken = [82973708039240629251272792125261330690652406198626706840055742852139281547364];
        creator = msg.sender;
        indexProposal = 1;
    }
