...
contract CrossChainDepositor is LogicUpgradeable {
    ...
    function __CrossChainDepositor_init(
     ...
     */
    function setAccumulatedDepositor(
        address _accumulatedDepositor
    ) external onlyOwner {
     ...
     * @param stargateDstGasForCall_ Amount of DstGasForCall
     */
    function setStargateDstGasForCall(
        uint256 stargateDstGasForCall_
    ) external onlyOwner {
        stargateDstGasForCall = stargateDstGasForCall_;
    }
