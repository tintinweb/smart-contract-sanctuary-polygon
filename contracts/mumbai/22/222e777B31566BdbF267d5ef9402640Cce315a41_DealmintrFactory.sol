...
contract DealmintrFactory is Ownable {
    ...
    constructor(string memory _baseURI){
     ...
     address controller
        ...
        Dealmintr _dealmintr = new Dealmintr(name,symbol,baseURI,maxBatchSize,controller);
        dealmintrs.push(address(_dealmintr));
        index ++;
        DealmintrNFT memory _dealmintrNft = DealmintrNFT(c_name,name,symbol,address(_dealmintr),controller);
    ...
    Ownable
{
    ...
    function mint(
        ...
        uint256 royaltyValue
         ...
         require(totalSupply() == maxBatchSize,"The token can't mint anymore.");
