...
// File: ShootToContentNFT.sol

contract ShootToContentNFT is ERC721Enumerable, AccessControl, ERC165Storage {
    using Strings for uint256;
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721Enumerable, AccessControl, ERC165Storage) returns (bool) {
