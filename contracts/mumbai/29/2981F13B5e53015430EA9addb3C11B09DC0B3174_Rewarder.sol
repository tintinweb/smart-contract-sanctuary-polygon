...
contract Rewarder is IRewarder, SybelAccessControlUpgradeable, ContentBadges, ListenerBadges, PushPullReward {
    ...
    function computeTestTest(
        address listener,
        uint256 contentId,
        uint16 listenCount) external {
        computeRewardForContent(contentId, listenCount, 1 ether, listener, SybelMath.payableTokenTypes(), TotalRewards(0, 0, 0, 0));
    }
...
/// @custom:security-contact [email protected]bel.co
