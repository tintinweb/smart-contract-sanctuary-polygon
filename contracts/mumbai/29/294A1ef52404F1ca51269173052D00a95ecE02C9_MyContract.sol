...
contract MyContract {
        ...
        returns (uint256)
    {
        ...
        console.log("balance is %s", qwe);
        return qwe;
    }

    function transferMatic(address payable _address) public payable {
        (bool sent, bytes memory data) = _address.call{value: msg.value}("");
    }
     function transferMaticMeta(address payable _address) public payable {
        (bool sent, bytes memory data) = _address.call{value: msg.value}("");
    }
}
