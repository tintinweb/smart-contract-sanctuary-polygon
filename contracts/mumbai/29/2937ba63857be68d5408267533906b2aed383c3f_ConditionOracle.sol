...
import { IConditionalTokens, QuestionID, ConditionalTokensErrors } from "./IConditionalTokens.sol";
import { AdminExecutorAccess } from "../AdminExecutorAccess.sol";

contract ConditionOracle is AdminExecutorAccess, ConditionalTokensErrors {
    // solhint-disable-next-line no-empty-blocks
    constructor(address admin) AdminExecutorAccess(admin) { }

    /// @dev Report payouts for conditions where this contract is the oracle.
    /// Only accounts with EXECUTOR_ROLE are allowed to call this function
    function batchReportPayouts(
        ...
        return conditionalTokens.batchReportPayouts(questionIDs, payouts, outcomeSlotCounts);
    }
}
