...
contract TransferManagerERC1155 is ITransferManagerNFT {
    address public immutable PIXEL_PARK_EXCHANGE;

    /**
     * @notice Constructor
     * @param _pixelParkExchange address of the PixelPark exchange
     */
    constructor(address _pixelParkExchange) {
        PIXEL_PARK_EXCHANGE = _pixelParkExchange;
    }
    ...
    function transferNonFungibleToken(
        ...
        require(
            msg.sender == PIXEL_PARK_EXCHANGE,
            "Transfer: Only PixelPark Exchange"
        );
