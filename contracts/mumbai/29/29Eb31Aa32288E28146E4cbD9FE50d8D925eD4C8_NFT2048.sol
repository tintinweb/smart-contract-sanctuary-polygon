...
import "@knobs/contracts/contracts/shuffledIds/ShuffledIdsV2.sol";


contract NFT2048 is Ownable,ERC721,ERC721Enumerable,ShuffledIdsV2 {
    ...
    constructor(string memory name_,string memory symbol_,string memory metadataURI_, string memory collectionURI_,uint256 maxId_) ERC721(name_,symbol_) ShuffledIdsV2(maxId_){
