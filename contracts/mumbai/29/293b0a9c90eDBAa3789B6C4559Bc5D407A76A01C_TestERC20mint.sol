...
contract TestERC20mint is ERC721A, PaperVerification, Ownable {
    ...
    constructor(address _paperKey, string memory _baseURI) ERC721A("Demo", "DEMO") PaperVerification(_paperKey) {
        baseURI = _baseURI;
    }
