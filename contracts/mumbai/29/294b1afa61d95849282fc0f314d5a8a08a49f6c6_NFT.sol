...
contract NFT is ERC721A, Ownable {
    uint32 public maxSupply = 5000; 
    uint64 public publicPrice = 0.04 ether;
    uint16 public maxNFTPerAddress = 3;
    ...
    constructor(string memory _notRevealedURI__) ERC721A("Pit Bulls Club", "PBC") {
        notRevealedURI_ = _notRevealedURI__;
