...
// File: 108_EveryFinance/HoldTime.sol
...
contract HoldTime is Ownable {
    ...
    function updateToken(address token_) external onlyOwner {
        require(token_ != address(0), "Transformative.Fi: zero address");
        require(token_ != token, "Transformative.Fi: no change");
        token = token_;
    ...
    function updateHoldTime(address account_, uint256 amount_) external {
        require(msg.sender == token, "Transformative.Fi: caller is not token");
...
// File: 108_EveryFinance/Token.sol
...
contract Token is ERC20, AccessControlEnumerable {
    ...
    constructor(
        ...
        require(holdTime_ != address(0), "Transformative.Fi: zero address");
        require(admin_ != address(0), "Transformative.Fi: zero address");
    ...
    function updateHoldTime(
        ...
        require(holdTime_ != address(0), "Transformative.Fi: zero address");
        require(holdTime_ != address(holdTime), "Transformative.Fi: no change");
        holdTime = HoldTime(holdTime_);
    ...
    function addToWhiteList(
        ...
        require(account_ != address(0), "Transformative.Fi: zero address");
        require(!whitelist[account_], "Transformative.Fi: address exists");
    ...
    function removeFromWhiteList(
        ...
        require(
            whitelist[account_],
            "Transformative.Fi: address doesn't exist"
        );
