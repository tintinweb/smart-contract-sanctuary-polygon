...
// File: contractImplementation/contracts/Signer.sol
...
contract YetiSigner is EIP712{
    ...
    function _hash(Rarity memory rarity) internal view returns (bytes32) {
        return _hashTypedDataV4(keccak256(abi.encode(
                keccak256("Rarity(address userAddress,uint256 UID,uint256 tokenId,uint256 amount)"),
                rarity.userAddress,
                rarity.UID,
                rarity.tokenId,
                rarity.amount
...
// File: contractImplementation/contracts/YetiMarketplace.sol
...
contract yetiMarketplace is ERC1155, Ownable, YetiSigner{
    ...
    mapping(uint => bool) public checkUID;
    ...
    function buyNFTs(Rarity memory rarity) external {
        ...
        require(!hasPurchased[rarity.userAddress][rarity.UID], "Item already Purchased");
        require(!checkUID[rarity.UID], "Item with particular UID already Purchased");
        frxst.burn(rarity.userAddress, rarity.amount);
        hasPurchased[rarity.userAddress][rarity.UID] = true;
        checkUID[rarity.UID] = true;
