...
// File: contracts/TheWorldToken.sol


pragma solidity ^0.8.0;


contract TheWorldToken is ERC20 {
    address private admin;
    mapping(address=>bool) private minters;
    uint256 maxSupply = 300000000;

    constructor () ERC20 ("TheWorldToken", "WORLD") {
       admin = msg.sender;
    }
    ...
    function burn(address msgSender,uint amount) external {
