...
// |  _  \               |  _  (_)     (_) |      | | /  __ \     | | |         | | (_) |   | |
// | | | |_____   _____  | | | |_  __ _ _| |_ __ _| | | /  \/ ___ | | | ___  ___| |_ _| |__ | | ___  ___
// | | | / _ \ \ / / _ \ | | | | |/ _` | | __/ _` | | | |    / _ \| | |/ _ \/ __| __| | '_ \| |/ _ \/ __|
// | |/ / (_) \ V /  __/ | |/ /| | (_| | | || (_| | | | \__/\ (_) | | |  __/ (__| |_| | |_) | |  __/\__ \
// |___/ \___/ \_/ \___| |___/ |_|\__, |_|\__\__,_|_|  \____/\___/|_|_|\___|\___|\__|_|_.__/|_|\___||___/
//                                 __/ |
//                                |___/
...
error DoveDigitalCollectibles__MaximumSupplyExceeded();

contract DoveDigitalCollectibles is ERC721Enumerable, Ownable, ReentrancyGuard {
    using Strings for uint256;

    IPaperKeyManager paperKeyManager;

    string public uriPrefix = "";
    uint256 private immutable quantity = 1;
    ...
    function mint(
        ...
        external
        payable
        onlyPaper(keccak256(abi.encode(_recipient)), _nonce, _signature)
    {
        uint256 currentSupply = totalSupply();
        _safeMint(_recipient, currentSupply + quantity);
    }
    ...
    // Overrides @openzeppelin/contracts/token/ERC721.sol.
    function _baseURI() internal view virtual override returns (string memory) {
        return uriPrefix;
    }

    // Location for collection metadata, used by leading marketplaces.
    function contractURI() public view returns (string memory) {
        return string.concat(uriPrefix, "metadata");
    }

    // In case anyone sends money to this contract, and we want to withdraw it.
