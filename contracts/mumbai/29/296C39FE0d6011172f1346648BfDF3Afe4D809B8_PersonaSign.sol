...
contract PersonaSign is Ownable, IPersona {
    mapping(address => uint256) public nonces;
    address public signer;
    address public personaNFT;
    address public personaNFTStake;
    ...
    function setPersonaNFT(address _personaNFT) public onlyOwner {
        personaNFT = _personaNFT;
    }

    function setPersonaNFTStake(address _personaNFTStake) public onlyOwner {
    ...
    function increaseNonce(address _minter) external {
        require(
            ...
            "Only NFT contract call this function."
        );
        nonces[_minter]++;
    }
}