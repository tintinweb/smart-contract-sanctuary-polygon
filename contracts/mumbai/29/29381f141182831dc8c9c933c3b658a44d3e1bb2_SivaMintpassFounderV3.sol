...
contract SivaMintpassFounderV3 is
    Initializable,
    ERC721Upgradeable,
    ...
    PullPaymentUpgradeable
{
    ...
    function initialize() public initializer {
        __ERC721_init("SivaMintpassFounder", "SMP1");
        ...
        _grantRole(PAYEE_ROLE, msg.sender);
    ...
    function tmpInitPullPayments() public onlyRole(DEFAULT_ADMIN_ROLE) {
        __PullPayment_init();
    }
    ...
    /// Free mint function for MINTER_ROLE users
    /// @param to address to mint to
    ...
    /// @dev Overridden in order to make it accessible for payees with PAYEE_ROLE only
