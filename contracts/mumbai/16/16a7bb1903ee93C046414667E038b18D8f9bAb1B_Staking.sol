...
contract Staking {
    ...
    function unstake(uint256 _amount) external {
        ...
        // может ли тут обмануть систему типо апдейт сначала а не после обновления тоатал амаунт стейк
        // то что мы засовываем в мисст ревард
