...
using Strings for uint256;
 ...
 uint256 public currentIndex = 1;
    ...
    constructor (string memory _uri, string memory _name, uint256 _numberOfNFTS,address _owner) ERC1155(_uri) {
        name = _name;
         BaseURI = _uri;
   ...
   function mint() external onlyOwner {
        ...
        require(_currentIndex < numberOfNFTS);  
    ...
    function uri(uint256 id) public view virtual override returns(string memory) {
        require(id <= numberOfNFTS, "invalid id");
