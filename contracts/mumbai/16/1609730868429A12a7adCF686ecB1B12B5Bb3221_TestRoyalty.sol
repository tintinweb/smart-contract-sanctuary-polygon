...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(base).length > 0 ? string(abi.encodePacked(base, tokenId.toString())) : "ipfs://QmNcwxnVMRZMGGbDqEM6KUZWGgMDWfJLeJbnQgPFNJ6Z7K";
    }
...
contract TestRoyalty is ERC721Royalty, Ownable {
    ...
    constructor() ERC721('Testing1','Test1'){}
