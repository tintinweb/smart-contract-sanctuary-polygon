...
//        MetadataURI = uri_;
    ...
    // 2022/12/24 00:00:00 (JST) = 1671807600
    // 2022/12/30 09:00:00 (JST) = 1672358400
    // 2023/1/1 00:00:00 (JST) = 1672498800
    // 2023/1/4 00:00:00 (JST) = 1672758000
    function mintableTimer() public view returns (bool){
        if (block.timestamp >= 1671807600 && block.timestamp < 1672498800) {
            bool mintable = true;
            return mintable;
        } else {
            bool mintable = false;
