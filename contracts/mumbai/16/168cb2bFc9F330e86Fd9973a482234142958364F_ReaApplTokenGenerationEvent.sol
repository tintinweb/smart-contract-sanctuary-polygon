...
/*
 ...
 ( c | r | y | p | t | o | R | E | I | T | $ )
  ...
  ############################################
    ...
    Real Matter Technology Limited (c) 2023
...
// File: IRealCREDVerifiable721.sol
...
// File: RealAPPTokenGenerationEvent.sol
...
contract ReaApplTokenGenerationEvent is ERC721Holder{
    ...
    // 
    function refresh_TGE_Information() 
        public {
...
//      tgeToken.credential = realContract.readCredentialURI();
    ...
    // transfer TGE token from msg.sender @Interface Contract owner
    ...
    function claim_Redemption(
        ...
        realContract.transferFrom (fromHolder, toContract, amount_decimal18);    // ERC20.transferFrom
        
        //require(ok, "Transferrable: failed");
    } 

    function transfer_TGE_Token_To(
        //address from,
        address toOtherHolder,
        uint256 amount_decimal18) 
        public {
        ...
        //   approval (this.address, amount)
        // for this interface contract on the real contract
        realContract.transfer (toOtherHolder, amount_decimal18);    // ERC20.transfer
        
        //require(ok, "Transferrable: failed");
    } 
    function transfer_Credential(
        address fromContractOwner,
        address toOtherOwner,
        uint256 tokenId,
        ...
        // for this interface contract on the real contract
        realCredential.safeTransferFrom (fromContractOwner, toOtherOwner, tokenId, remarkData);   // ERC721.safeTransferFrom
