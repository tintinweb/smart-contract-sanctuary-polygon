...
contract PermissionsRegistry is 
    Initializable,
    ERC165Upgradeable,
    ...
    IPermissionsRegistry
{
     ...
     * @dev Platform vault
     */
    address override public platformVault;
     ...
     */
    function initialize(address _platformVault) initializer override public {
        __ERC165_init();
     ...
     */
    function isPlatformExecutor(address _executor) override external view returns (bool) {
     ...
     */
    function platformExecutors() override external view returns (address[] memory) {
     ...
     */
    function isCurrencyWhitelisted(address _currency) override external view returns (bool) {
     ...
     */
    function whitelistedCurrencies() override external view returns (address[] memory) {
