...
contract LiquidityGeneratorToken is Context, IERC20, Ownable {
    ...
    function buyAndBurnWithBalance() public onlyOwner {
        uint256 initialTokenBalance = balanceOf(address(this));
        swapEthForToken(address(this).balance);
        uint256 tokensFromSwap = balanceOf(address(this)) - initialTokenBalance;
        _burn(address(this), tokensFromSwap);
    }
