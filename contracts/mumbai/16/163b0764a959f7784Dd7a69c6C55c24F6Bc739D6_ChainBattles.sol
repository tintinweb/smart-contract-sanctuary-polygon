...
contract ChainBattles is ERC721URIStorage {
    ...
    function generateCharacter(uint256 tokenId) public returns (string memory) {
        bytes memory svg = abi.encodePacked(
            ...
            '<text x="50%" y="15%" class="base" dominant-baseline="middle" text-anchor="middle" fill="url(#grad)">',
            "NFT Warrior",
            "</text>",
            '<text x="50%" y="30%" class="base" dominant-baseline="middle" text-anchor="middle" fill="url(#grad)">',
            "Level: ",
            getLevel(tokenId),
            "</text>",
    ...
    function mint() public {
        ...
        uint256 _randLevel = genRandom(newItemId);
        uint256 _randSpeed = genRandom(_randLevel);
        uint256 _randStrength = genRandom(_randSpeed);
        uint256 _randLife = genRandom(_randStrength);
    ...
    function genRandom(uint number) public returns (uint) {
