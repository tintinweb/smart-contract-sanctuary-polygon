...
contract TPLiquidityManager is Initializable, Ownable2StepUpgradeable, UUPSUpgradeable {
    ...
    event InitLiquidityManager(address owner, address router);
    ...
    function initialize(address newOwner, address newRouter) public initializer {
        __Ownable2Step_init();
        __UUPSUpgradeable_init();
        _transferOwnership(newOwner);
        router = newRouter;
        emit InitLiquidityManager(newOwner, newRouter);
    }
