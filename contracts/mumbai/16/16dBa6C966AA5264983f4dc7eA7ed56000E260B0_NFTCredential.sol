...
contract NFTCredential is ERC721A, Ownable {
    ...
    mapping(uint256 => string[]) private _showNameList;
        ...
        returns (string[] memory)
    {
        ...
        string[] memory retNameList = new string[](list_length);
        retNameList = _showNameList[tokenId];

        return retNameList;
    }

    function _setShowNameList(uint256 tokenId, string[] memory namelist) internal {
        require(_exists(tokenId), "URI set of nonexistent token");
