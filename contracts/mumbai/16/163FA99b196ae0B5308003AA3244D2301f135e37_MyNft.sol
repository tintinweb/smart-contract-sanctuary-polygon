...
contract MyNft is ERC721, Ownable, ERC2981 {
    ...
    address[] public withdrawAddresses = [0x2EE981911362cc9Ade1a6f48a42678051d18c96e];
    uint256[] public withdrawPercentages = [100];


    bytes32 public merkleRoot = 0;

    constructor() ERC721("XT", "PP") {
        _baseTokenURI = "https://test-nft-tool-gateway-api.tuoluo.net/generator-server/api/contract/v1/1602913891877449729/metadata/";
        _setDefaultRoyalty(0x2EE981911362cc9Ade1a6f48a42678051d18c96e, uint96(0));
    }
