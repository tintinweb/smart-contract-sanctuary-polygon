...
interface ICollectionFactory {
    ...
    function getCollectionCreatorAddresses() external view returns (address[] memory);
}
...
contract CollectionFactory is ICollectionFactory {
    ...
    function getCollectionCreatorAddresses() public view override returns (address[] memory) {
        return collectionRoles.getCollectionCreatorAddresses();
    }
}
