...
using Counters for Counters.Counter;
   ...
   */
  function deleteMarketItem(uint256 itemId, address senderAddress) public nonReentrant {
    ...
    require(IERC721(item.nftContract).ownerOf(item.tokenId) == senderAddress, "must be the owner");
