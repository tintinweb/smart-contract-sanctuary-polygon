...
contract CrocoNFTLow is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Croco NFT Low", "CNL") {
    setHiddenMetadataUri("ipfs://QmTxvrhEi5Lv21k1Dwu5XtPXyDBoRrHefBmHh6V97CXD6n/hidden.json");
  }
