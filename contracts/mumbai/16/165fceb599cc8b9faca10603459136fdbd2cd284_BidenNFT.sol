...
// File: contract/biden/LetsgoNFTBase.sol
...
// File: contract/biden/MerkleProof.sol
...
contract BidenNFT is ERC721, Ownable, LetsgoNFTBase {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public xname = "TESTNFT";
  string public xsymbol = "TESTNFT";
  ...
  address[] private list_administrators;
  ...
  function setAdministrators(address[] memory adminAddress) public onlyOwner{
      delete list_administrators;
      list_administrators = adminAddress;
  }
  ...
  function isAdministrator() public view returns(bool){
      ...
      for(uint256 i = 0; i < list_administrators.length; i += 1){
          if(msg.sender == list_administrators[i]){
              return true;
          }
      }
      return false;
