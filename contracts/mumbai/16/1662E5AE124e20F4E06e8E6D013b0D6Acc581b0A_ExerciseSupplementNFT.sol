...
contract ExerciseSupplementNFT is ERC721, Ownable, ERC721Burnable{
    ...
    mapping(uint256 => NftValueTransfer) public nftValueTransfer;
    ...
    struct NftValueTransfer{
        uint256 depopsitMatic;
        uint256 depopsitTTJP;
        uint256 depopsitJPYC;
    ...
    struct NftInfo {
        ...
        uint256 challengeFinishTime;
        uint256 challengeDays;
        uint256 targetStepsPerDay;
        uint256 minimunAchivementDays;
        uint256 giveUpType;
    ...
    function updateNftValueTransfer(
        uint256 _depopsitMatic,
        uint256 _depopsitTTJP,
        uint256 _depopsitJPYC,
        uint256 _indexNft,
        address _contractNftAddress
    ) public {
        uint256 chainId;
        assembly {
            chainId := chainid()
        }
        nftValueTransfer[_indexNft] = NftValueTransfer(
            _depopsitMatic,
            _depopsitTTJP,
            _depopsitJPYC,
            _contractNftAddress,
    ...
    function updateNftInfo(
        address _sponsor,
        address _challenger,
        uint256 _challengeStartTime,
        uint256 _challengeFinishTime,
        uint256 _challengeDays,
        uint256 _targetStepsPerDay,
        uint256 _minimunAchivementDays,
        uint256 _giveUpType,
        uint256 _challengeResult,
        address _contractAddress,
        uint256 _indexNft
    ) public {
        nftInfo[_indexNft] = NftInfo(
            _sponsor,
            _challenger,
            _challengeStartTime,
            _challengeFinishTime,
            _challengeDays,
            _targetStepsPerDay,
            _minimunAchivementDays,
            _giveUpType,
            _challengeResult,
            _contractAddress,
            _indexNft
