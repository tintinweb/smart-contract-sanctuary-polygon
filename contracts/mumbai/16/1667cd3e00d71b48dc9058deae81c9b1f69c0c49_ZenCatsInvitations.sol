...
contract ZenCatsInvitations is ERC1155,Ownable {
    using Strings for string;

	string public name = "ZenCats Invitations";
	string public symbol = "INVIT";
    constructor()  ERC1155("https://api.zencats.io/invitations/{id}.json") {
