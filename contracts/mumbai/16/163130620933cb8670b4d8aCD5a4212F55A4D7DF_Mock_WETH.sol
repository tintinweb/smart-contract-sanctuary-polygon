/**
* @dev This contract is a copy of WETH, deployed on Polygon at address 0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619
* It also includes an added `mint(uint256)` function in order for users to be able to get some coins in order 
* to test integration of WETH on polygon with their own contract
* 
* To match actual behavior of contract on Polygon, it must be compiled with:
* ~ solc version v0.6.6+commit.6c089d02
* ~ No optimization
* ~ Default EVM version
*/
...
contract Mock_WETH is ChildERC20 {
