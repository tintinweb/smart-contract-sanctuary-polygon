...
/**
 * @title DAMLA Token (DAMLA)
 * @author softtech
 * @notice The native governance token of the Suna Protocol.
 */
contract DAMLA is IDAMLA, ERC20Permit, Governable {
    ...
    /**
     * @notice Constructs the DAMLA Token contract.
     * @param governance The address of the governance.
     */
    constructor(address governance) ERC20("DAMLA", "DML") ERC20Permit("DAMLA") Governable(governance) { }
     ...
     */
    function isManager(address account) external view override returns (bool status) {
     ...
     */
    function addManager(address manager) external onlyGovernance override {
        require(manager != address(0x0), "zero address");
     ...
     */
    function removeManager(address manager) external onlyGovernance override {
