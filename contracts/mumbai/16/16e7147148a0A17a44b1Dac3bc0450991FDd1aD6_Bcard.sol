...
contract TempTest  {
    address public BcardContractAddr = 0x16e7147148a0A17a44b1Dac3bc0450991FDd1aD6;
    address public oldCardAddr = 0xE5405e0017B81bC6d7E42dA60647d64bc4a49C7D;

    using Strings for uint256;
    
    function initial(uint _totalSupply, string memory _ethName, string memory _nickName, address cardholder) public payable{
...
contract MAKECard is Ownable{
    address public BcardMetaDataStorageAddr = 0xc446370FcA8b793981813Cd12Ff3D87114b390Ed;
    address public designContractAddr = 0x4fB6a5f467968d4e3a3A6765540738dAaD49CC0D;
...
contract Bcard is ERC1155, Ownable {
  ...
  address public CheckQuaAddr=0x601906cfc5a2b8e9367f028941c577a0200A92D6;
  address public MAKECardAddr=0x6C12d215DEf4cB2e92D5fB73f8c39Ca639976173;
  address public RecStorageAddr=0x6F113BA6767EFf9c6e5D4C00F364C96AfE7fB91B;
...
contract BcardRecSto is Ownable  {
    ...
    address public BcardRecAddr = 0x1fD3C870e20Aefc08041C5a70391aC9BD628d3f4;
...
contract BcardRec is Ownable  {
    ...
    address payable public timelockadd = payable(0x3E65890c05597EAf7CCBCE1D85140d8aCF2100b5);
    uint structMax=0;
