...
contract MagnetProgramOptionsFacet {
    function setOptions(
        ...
        MagnetProgramOptionsLib.setOptions(
            prgm,
            leaderBonus,
            partner,
            referral,
    ...
    function getLeaderPercent() external view returns (uint) {
        return MagnetProgramOptionsLib.getLeaderPercent();
    }

    function setLeaderPercent(uint leaderBonus) external {
        MagnetProgramOptionsLib.setLeader(leaderBonus);
    }
}