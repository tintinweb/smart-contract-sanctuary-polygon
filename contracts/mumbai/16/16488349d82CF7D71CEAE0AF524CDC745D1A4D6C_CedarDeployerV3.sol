...
import "./generated/deploy/BaseCedarDeployerV3.sol";
...
contract CedarDeployerV3 is Initializable, UUPSUpgradeable, OwnableUpgradeable, BaseCedarDeployerV3 {
    ...
    ) external override returns (ICedarPaymentSplitterV0 newContract) {
...
// Filename: './BaseCedarDeployerV3.sol'
...
abstract contract BaseCedarDeployerV3 is ICedarDeployerV3 {
    ...
    function supportsInterface(bytes4 interfaceID) virtual override public view returns (bool) {
        return (interfaceID == type(IERC165Upgradeable).interfaceId) || (interfaceID == type(ICedarDeployerV2).interfaceId);
    }
}
