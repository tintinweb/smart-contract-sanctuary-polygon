    ...
    VRFConsumerBaseV2
{
    ...
    function addSubCollection(
        ...
        require(bytes(params.symbol).length != 0, "Missing symbol");
     ...
     * @param subCollectionName The name of the sub-collection.
    ...
    function upgradeToken(
        ...
        require(isCollectionRevealed(subCollectionName), "SubCollection must be revealed");
    ...
    /**
     * @dev A function used to finish a lottery of a sub-collection with the specified name.
     * @param subCollectionName The name of the sub-collection to finish its lottery.
     */
    ...
    /**
     * @dev Check if the lottery of a sub-collection with the specified name is over or not.
     * @param subCollectionName The name of the sub-collection to check if its lottery is over.
     * @return bool value indicating if the lottery of the specified sub-collection is over or not.
     */
     ...
     * @param subCollectionIdx The ID of the sub-collection to mint the token for.
     * @param mainSupply The maximum number of tokens in the sub-collection.
     ...
     * @param subCollectionName The name of the sub-collection to verify its Merkle tree.
...
interface ICollectionToken  {
    ...
    function isCollectionRevealed(string memory subCollectionName) external view returns (bool);
