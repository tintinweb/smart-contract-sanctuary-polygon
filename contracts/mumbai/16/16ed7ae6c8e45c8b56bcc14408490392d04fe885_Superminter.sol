...
contract Superminter is ERC721, ERC721Enumerable, ERC2981, Ownable {
    using Strings for uint256;
    ...
    uint256 public cost = 0.00001 ether; //change this price on production to 30USD
    ...
    ) ERC721("SUPERMINTER", "PROSA#1") {
        setRoyaltyInfo(address(this), _royaltyFeesInBips);
    ...
    function withdraw() public onlyOwner {
        (bool ar, ) = payable(artist).call{
            value: (address(this).balance * 13) / 100
        }("");
        require(ar);
        // =============================================================================
        (bool ow, ) = payable(creator).call{
            value: (address(this).balance * 50) / 100
        }("");
        require(ow);

        // =============================================================================
        (bool cl, ) = payable(client).call{value: (address(this).balance)}("");
        require(cl);
        // =============================================================================
        // =============================================================================
    }
