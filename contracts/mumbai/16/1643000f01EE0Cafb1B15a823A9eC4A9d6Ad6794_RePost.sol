...
contract RePost is IExecutePlugin, BasePluginWithRules{
    ...
    function execute(
        ...
        (address _userCommunityId , uint256 _postId, uint256 _subscriptionId) = abi.decode(_data,(address, uint256, uint256));
        ...
        checkRuleWithNftId(RulesList.POST_TRANSFERRING_RULES, _userCommunityId, _sender, _postId);
        checkBaseRule(RulesList.USER_VERIFICATION_RULES, _userCommunityId, _sender);
        checkRuleWithNftId(RulesList.POST_PLACING_RULES, _userCommunityId, _sender, _subscriptionId);
