...
contract CustomAttributes is ERC1155, ERC1155Burnable, AccessControl {
    ...
    function setFirstBeliever(address believer)
        public
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
    ...
    function removeFirstBeliever(address addr)
        public
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
    ...
    function isBeliever(address add)
        public
        view
        onlyRole(DEFAULT_ADMIN_ROLE)
        returns (bool)
    ...
    function mint(
        ...
        if (artifact == GATE_PASS) {
            ...
            require(
                necklacesOwners[msgSender].length > 0 || isBeliever(msgSender),
    ...
    function safeTransferFrom(
        ...
        uint256,
        bytes memory
    ) public view override onlyRole(BURNER_ROLE) {
        require(false, "Jericho Artifacts are non-transferable.");
    }
    ...
    function _beforeTokenTransfer(
        ...
        bytes memory data
    ) internal override(ERC1155) onlyRole(BURNER_ROLE) {}
