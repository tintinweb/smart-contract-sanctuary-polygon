...
contract Manager is Initializable, OwnableUpgradeable, PausableUpgradeable {
    ...
    mapping(bytes32 => uint256) private commissionSellers;
    mapping(bytes32 => bool) public isCommissionSellerSets;

    mapping(bytes32 => uint256) private commissionBuyers;
    mapping(bytes32 => bool) public isCommissionBuyerSets;
    ...
    ReentrancyGuardUpgradeable
{
    ...
    function getCommissionSellerByTokenId(
        ...
        _commission = getCommissionSeller(
            _categoryId,
            _branchId,
            _collectionId,
            _buyer
    ...
    function calBuyerCommission(
        ...
        require(_serviceTaxPercentForBuyer <= ZOOM_FEE, "Invalid tax");
        (
            uint256 _categoryId,
            uint256 _branchId,
            uint256 _collectionId
        ...
        StructLib.BuyerCommissionOutput memory _buyerCommissionOutput;
    ...
    function buy(
        ...
        bytes32 _id = keccak256(
            abi.encodePacked(nFTAddress, _orderId, msg.sender)
        );
    ...
    function acceptBid(
        ...
        isBid[
            keccak256(abi.encodePacked(nFTAddress, bid.orderId, bid.bidder))
        ] = false;
