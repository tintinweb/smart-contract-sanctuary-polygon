    ...
    BasicMetaTransaction
{
    ...
    */
    ...
    function setDoc1(uint256 _tokenID, string calldata doc1) external onlyOwner {
        docs[_tokenID].doc1 = doc1;
    }

    //ANCHOR : Setter for doc 2
    function setDoc2(uint256 _tokenID, string calldata doc2) external onlyOwner {
        docs[_tokenID].doc2 = doc2;
    }

    //ANCHOR : Setter for doc 3
    function setDoc3(uint256 _tokenID, string calldata doc3) external onlyOwner {
        docs[_tokenID].doc3 = doc3;
    }

    //ANCHOR : Setter for doc 4
    function setDoc4(uint256 _tokenID, string calldata doc4) external onlyOwner {
        docs[_tokenID].doc4 = doc4;
    }
