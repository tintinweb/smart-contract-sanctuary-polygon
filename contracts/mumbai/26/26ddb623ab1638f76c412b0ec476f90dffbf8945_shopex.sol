...
/**
 *Submitted for verification at elitepoin.com on 2022-01-21
*/
...
// ----------------------------------------------------------------------------
contract shopex is ERC20Interface {
    ...
    //     require(
    //         msg.sender == owner || msg.sender == deputyOwner,
    ...
    /**
     * @dev update Deputy Owner 
     * Can only be called by the current owner only.
     */
    function updateDeputyOwner(address _newDeputyOwner) public virtual onlyOwner onlyNonZeroAddress(_newDeputyOwner) {
        owner = _newDeputyOwner;
    }
