...
// import "@openzeppelin/[email protected]/utils/math/SafeCast.sol";
    ...
    TimeLock
{
    ...
    function setCoinContract(address _contract) public onlyOwner {
        require(_contract != address(0), "setCoinContract: invalid address");
        coinContract = _contract;
    }

    function setCoinWallet(address _wallet) public onlyOwner {
        require(_wallet != address(0), "setCoinWallet: invalid address");
        coinWallet = _wallet;
    }
    ...
    function _createCard(
        ...
        _setRoyaltyInfo(_tokenId, coinWallet, _royalty);
