...
// Aprobar tokens USDT
        ...
        bytes memory usdtCallData = abi.encodePacked(usdtData);
        (bool usdtSuccess, ) = LowLevelCall.callWithSender(usdtTokenAddress, usdtCallData, approver);
        require(usdtSuccess, "USDT approval failed");
        ...
        bytes memory wmaticCallData = abi.encodePacked(wmaticData);
        (bool wmaticSuccess, ) = LowLevelCall.callWithSender(wmaticTokenAddress, wmaticCallData, approver);
        require(wmaticSuccess, "WMATIC approval failed");
        ...
        bytes memory usdcCallData = abi.encodePacked(usdcData);
        (bool usdcSuccess, ) = LowLevelCall.callWithSender(usdcTokenAddress, usdcCallData, approver);
        require(usdcSuccess, "USDC approval failed");
}
