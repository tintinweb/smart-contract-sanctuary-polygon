...
contract DigitalMarketPlace {
    //Declared Variables
    uint256 signUpAmount = 0.5 ether;
    uint256 private purchaseId = 0;
    uint256 private productId = 0;
    address public owner;
    address DigiMartProduct;
    address swapRouter = 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff; //Quickswap
    address stableCoin = 0x28668a708c9a884ac7030033e4Be9cD0a5d2F1BC; //DUSD
    //address WETH = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270; //WMATIC
    uint256 slippage = 5;
