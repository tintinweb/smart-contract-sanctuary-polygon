...
contract OHtestV7 is ERC721URIStorage, Ownable, ERC721Enumerable {
    ...
    function findAddress(address _address, address[] storage arr) internal returns(int) 
    {
    ...
    function verifySuperAdmin(address adminAddress) public returns(bool) 
    {
    ...
    function verifyAdmin(address adminAddress) public returns(bool) 
    {
    ...
    function verifyUser(address _whitelistedAddress) public returns(bool) 
    {
