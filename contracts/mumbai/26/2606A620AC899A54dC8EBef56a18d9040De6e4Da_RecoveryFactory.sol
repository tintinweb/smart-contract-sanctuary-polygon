...
interface IRecovery is IYousovStructs{
    ...
    event AgentRoleForRecovery(address agent, address recovery, RecoveryRole recoveryRole);
    ...
    function startTheRecovery() external override {
        ...
        for(uint256 i = 0; i < agentList.length; i++) {
            ...
            if(i < agentList.length / 2) {
                ...
                answerAgentsDetails[agentList[randomIndex]] = AnswerAgentsDetails("","",false);
                emit AgentRoleForRecovery(agentList[randomIndex], address(this), RecoveryRole.ANSWER_AGENT);
            } else {
