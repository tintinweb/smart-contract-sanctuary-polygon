...
contract megaFarming {
    
    // call it megaFI
    string public name = "megaFarming";
    
    // create 2 state variables
    address public usdc;
    address public megaFi;
    ...
    constructor()  {
        ...
        megaFi = 0xf91DAEd1865276F51512d414a1048218c8748C42;
    ...
    // if there is a balance transfer the SAME amount of bank tokens to the account that is staking as a reward
            ...
            if(balance >0 ) {
                IERC20(megaFi).transfer(recipient, balance);
