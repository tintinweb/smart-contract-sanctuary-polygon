...
contract Account is Ownable {
    ...
    event CreateUserInformation(address indexed _user, string _userID, string _displayName, string _bio, string _IPFS);
    event UpdateUserInformation(address indexed _user, string _userID, string _displayName, string _bio, string _IPFS);
    ...
    function addUserInformation(
        ...
        require(userInfo[_user].userID.isEmpty(), "USER:ALREADY_EXISTS");
        ...
        emit CreateUserInformation(info.userAddress, info.userID, info.displayName, info.bio, info.IPFS);
    }
    ...
    function editUserInformation(
        ...
        emit UpdateUserInformation(info.userAddress, info.userID, info.displayName, info.bio, info.IPFS);
    }
    ...
    modifier canChange() {
        ...
        require(admin[_sender] == true || _sender == info.userAddress, "WALLET::NOT_ADMIN");
        _;
    }
