...
//*********************************************************************//
//
//   ____                ____  _          ____    __                       ______                     _     
//   / __ \____  ___     / __ )(_)___ _   /  _/___/ /__  ____ _            / ____/__  ____  ___  _____(_)____
//  / / / / __ \/ _ \   / __  / / __ `/   / // __  / _ \/ __ `/  ______   / / __/ _ \/ __ \/ _ \/ ___/ / ___/
// / /_/ / / / /  __/  / /_/ / / /_/ /  _/ // /_/ /  __/ /_/ /  /_____/  / /_/ /  __/ / / /  __(__  ) (__  ) 
// \____/_/ /_/\___/  /_____/_/\__, /  /___/\__,_/\___/\__,_/            \____/\___/_/ /_/\___/____/_/____/  
//                            /____/                                                                         
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [0xFAEa523cDF00E9be0A82FA201fBB111330CC7c0C];
...
// File: contracts/OneBigIdeaGenesisContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract OneBigIdeaGenesisContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "One Big Idea  Genesis";
