...
contract AdminFunctions is  Ownable, AdminStorage {
    ...
    //example - 4
    function updateBaseLTM(uint256 _baseLtm) external onlyOwner() {
        baseLtm = _baseLtm;
    }
    ...
    //example - 70%
    function updateMarginCallRatio(uint256 _marginCallRatio) external onlyOwner {
        marginCallRatio = _marginCallRatio;
    }

    //example - (if 0.2% pass 20)
    function updateProtocolFees(uint256 _protocolFees) external onlyOwner {
        protocolFees = _protocolFees;
    }

    //example - (if 0.02% pass 2)
    ...
    function updateMargin(address _marginContract) external onlyOwner {
        require(
    ...
    function updateLiquidationReserves(address payable _liquidationReserves) external onlyOwner {
        require(
            _liquidationReserves.isContract(),
            "AdminFunctions: Address is not a contract"
        );
        liquidationReserves = _liquidationReserves;
    }

    function updateProtocolReserves(address payable _protocolReserves) external onlyOwner {
        require(
            _protocolReserves.isContract(),
            "AdminFunctions: Address is not a contract"
        );
    ...
    function updateMaximillionContract(address _maximillionContract) external onlyOwner {
        require(
            _maximillionContract.isContract(),
            "AdminFunctions: Address is not a contract"
        );
        maximillionContract = _maximillionContract;
    ...
    function getBaseLtm() public view returns(uint256) {
        return baseLtm;
    }
    ...
    function getMarginCallRatio() public view returns(uint256) {
    ...
    function getMarginContract() public view returns(address) {
        return marginContract;
    }

    function getMarginFundsContract() public view returns(address) {
        return marginFundsContract;
    }

    function getPositionContract() public view returns(address) {
        return positionContract;
    }

    function getLiquidationReserves() public view returns(address payable){
        return liquidationReserves;     
    }

    function getProtocolReserves() public view returns(address payable){
        return protocolReserves;   
    }

    function getDelegatorAddress(address assetAddress) public view returns(address) {
        return delegatorAddresses[assetAddress];
    }

    function getMaximillionContract() public view returns(address){
        return maximillionContract;
...
contract AdminStorage {
    ...
    address internal maximillionContract;

    address internal positionContract;

    address payable protocolReserves;
     
    address payable liquidationReserves;

    address payable internal treasuryContract;

    mapping (address => address) internal delegatorAddresses;
