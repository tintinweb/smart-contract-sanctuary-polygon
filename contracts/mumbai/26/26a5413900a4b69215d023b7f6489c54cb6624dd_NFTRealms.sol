...
contract NFTRealms is ERC721, Ownable, PullPayment {
    ...
    */
    ...
    function getGeography(uint _tokenId) tokenExists(_tokenId) external view returns (uint24[3] memory) {
    ...
    */
    ...
    function mintWorld(MintData calldata _mintData, bytes calldata _signature) public payable returns (uint256) {
        ...
        tokenWorldData[tokenId] = _mintData._worldData;
        tokenSeeds[tokenId] = _mintData._seed;
        _safeMint(_msgSender(), tokenId);
        return tokenId;
    }

    function reservedMint(MintData calldata _mintData) public onlyOwner returns (uint256) {
        totalMinted += 1;
