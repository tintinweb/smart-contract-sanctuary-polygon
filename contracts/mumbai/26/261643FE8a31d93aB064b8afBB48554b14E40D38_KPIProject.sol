...
contract KPIProject is IKPIProject {
    ...
    /// @inheritdoc IKPIProjectImmutables
    address public override token2;
    /// @inheritdoc IKPIProjectImmutables
    ...
    constructor() {
        ...
        projectInfo.depositChecking = depositChecking;
    ...
    function setOwner(address _owner) external override onlyOwner {
        ...
        IKPIProjectFactory(factory).userAddedToProject(_owner, address(this));
    }
