...
import "@pythia-oracle/pythia-periphery/contracts/oracles/proto/uniswap/ManagedUniswapV2Oracle.sol";

contract PythiaQuickswapOracle is ManagedUniswapV2Oracle {
    constructor(
        ...
        address quoteToken_,
        uint256 period_
    ) ManagedUniswapV2Oracle(liquidityAccumulator_, uniswapFactory_, initCodeHash_, quoteToken_, period_) {}
}
