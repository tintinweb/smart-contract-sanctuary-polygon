...
contract Factory is AccessControl {
     ...
     */
    function deployNewCollectionContract(string memory _name, string memory _symbol,address trustedForwarder) onlyRole(SUPER_ADMIN)
        external
        returns (address)
    {
        ...
        collection.grantRole(SUPER_ADMIN,msg.sender);
        collection.grantRole(MINTER,msg.sender);
        collection.grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
