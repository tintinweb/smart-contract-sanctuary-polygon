    ...
    function getOrCreateSplitterUsingSplit(LibPart.Part[] memory payees) internal virtual returns (bytes32){
        ...
        if (payees.length == 1) {
            ...
            if (splitterAddress == address(0x0)){
                ...
                SplitPayments(splitterAddress).setMinterContract();
...
contract SplitPayments {
    ...
    address constant minterAddress = 0x13b7d85782B68fB171a0FB9650b5567E17906f2f;
    IMinterUpgradeableFPaymentSplitter minter;

    constructor() public {
    }

    function setMinterContract() public {
