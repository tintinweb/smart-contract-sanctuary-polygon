...
contract CollectionFactory is Initializable, OwnableUpgradeable, PausableUpgradeable {
    ...
    function removeCollection(uint256 id) public whenNotPaused {
        ...
        (uint index, bool exits )=findElementInArray(collection,_userCollections[msg.sender]);
    ...
    function findElementInArray(address collection, uint[] memory arr) public pure returns(uint,bool) {
