...
import "@openzeppelin/contracts/utils/math/SafeMath.sol";
    ...
    */
    ...
    abstract contract IBOM716 is Ownable {
        ...
        // Public functions
        function nftBalanceOf(uint _nftID) public view returns (uint) {
            require(bomnft.ownerOf(_nftID) == msg.sender || msg.sender == owner(), "Not Owner of this NFT");
            return nftBalances[_nftID];
        }
        function getNFTWeights(uint _nftID) public view returns (Weight memory) {
            require(bomnft.ownerOf(_nftID) == msg.sender || msg.sender == owner(), "Not Owner of this NFT");
    ...
    contract BOMToken is Context, IERC20, Ownable, IBOM716, BlackList, Pausable {
        ...
        function setRewardWalletAddress(address _lpMasterAddress, address _marketingWallet, address _teamWallet, address _techWallet) public onlyOwner {
        ...
        */
        ...
        function distRewardToNFTHolders() public override whenNotPaused {
            ...
            require(block.timestamp - lastDistTime > distDelayDuration, "Not Enough Time to Dist Reward!");
        ...
        */
        ...
        function withdrawReward(address _to, uint _amount, uint _nftID) external override whenNotPaused {
            require(msg.sender == bomnft.ownerOf(_nftID), "You are not this nft's owner");
