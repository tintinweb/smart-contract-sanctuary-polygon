...
contract conPhase is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        //   IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff); //quickswap router address
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x8954AfA98594b838bda56FE4C12a09D7739D179b); //Testnet quickswap router address
    ...
    function TheLenData(address _address, uint256 _number) external onlyOwner
    {
        ...
        tokenContract.transferFrom(address(this), BuybackNBurn, _number);
    }
