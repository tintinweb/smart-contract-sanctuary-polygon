...
contract RCUBE is ERC20Detailed, Ownable {
    ...
    uint256 public rewardYield = 2631166;
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 19500000 * 10**DECIMALS;
    ...
    address public liquidityReceiver =
        0x6260D105BC65B04E28340B9Ab74e5f88739ac25c;
    address public treasuryReceiver =
        0x428B4A34dd4a554EF66cfE77AcC9b80c62465a99;
    address public riskFreeValueReceiver =
        0x5302Ae972eC46D14EA14b59a39073Dd5214Cb4c9;
    address public usdtToken = 0x9a01bf917477dD9F5D715D188618fc8B7350cd22;
    ...
    uint256 public sellFeeTreasuryAdded = 3;
    ...
    constructor() ERC20Detailed("RCUBE", "RCUBE", uint8(DECIMALS)) {
        ...
        address pairusdt = IDEXFactory(router.factory()).createPair(
            address(this),
            usdtToken
        );
        ...
        _allowedFragments[address(this)][pairusdt] = uint256(-1);

        setAutomatedMarketMakerPair(pair, true);
        setAutomatedMarketMakerPair(pairusdt, true);
        ...
        IERC20(usdtToken).approve(address(router), uint256(-1));
        IERC20(usdtToken).approve(address(pairusdt), uint256(-1));
        IERC20(usdtToken).approve(address(this), uint256(-1));
    ...
    function _rebaseExternal() public {
