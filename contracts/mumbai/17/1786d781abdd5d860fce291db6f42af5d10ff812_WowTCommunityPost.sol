...
contract WowTCommunityPost is OwnableUpgradeable, AccessControlUpgradeable {
    struct Post {
        uint256 id;
        string content;
        string imageUrl;
    ...
    function createPost(
        ...
        // posts[_communityName][postCount] = Post(postCount, _content, 0, 0, 0, creator);
    ...
    function tipPost(
        ...
        points.reducePoints(_msgSender(), _points);
    }
    ...
    function getPostCount() public view returns (uint256) {
     ...
     function setPostName(string calldata _communityName, uint256 _postId, string memory _userName) external onlyOwner {
        require(
            community.checkCommunityExists(_communityName),
            "Community doesn't exist"
        );
    ...
    // function getCommunityPosts(string memory _communityName, uint256 _postId) public view returns (uint256, string memory, uint256, uint256, uint256) {
    //     require(_postId > 0 && _postId <= postCount, "Invalid post ID");
