...
contract Factory is AccessControl {
    ...
    /**
     * @dev Deploy the ERC721
     * @dev Error Details
     * - 0x0f1: User has not DEPLOYER_ROLE
     */
...
contract KwikTrustNFT is ERC721URIStorage, EIP712, AccessControl {
  ...
  event HandleLazyMint(address signer, address minter, string uri, uint256 tokenId);
  ...
  function mint(string memory _tokenURI, address marketplace) external minterRole returns (uint256) {
    tokenId++;
  ...
  function bulkMint(string[] memory _tokenURI, address marketplace) external minterRole returns (uint256) {
  ...
  function lazyMint(
    ...
    NFTVoucher memory voucher = NFTVoucher(_uri, _price, _signature, _token, _marketplace, _signer);
