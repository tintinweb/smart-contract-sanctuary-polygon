...
contract RandomTokenERC721 is VRFConsumerBaseV2, ERC721Upgradeable, DefaultOperatorFiltererUpgradeable {
    ...
    // [ … ]
    _safeMint(_msgSender(), resultNumber);

    tokenMinted[resultNumber] = true;
    ...
    function mintedToken(uint256 _tokenId) external view returns (bool) {
