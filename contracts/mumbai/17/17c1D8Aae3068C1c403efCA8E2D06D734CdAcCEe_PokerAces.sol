    ...
    UUPSUpgradeable
{
    ...
    uint256 public _ITEM_PRICE_IN_MUMBAI_MATIC;
    uint256 public _ITEM_PRICE_IN_RINKEBY;

    IERC20 public TOKEN_USDC;
    IERC20 public TOKEN_USDT;
    IERC20 public TOKEN_WETH;

    IERC20 public TOKEN_MUMBAI_MATIC;
    IERC20 public TOKEN_RINKEBY;
    ...
    function initialize() public initializer {
        ...
        _ITEM_PRICE_IN_MUMBAI_MATIC = 777E14;
        _ITEM_PRICE_IN_RINKEBY      = 777E14;

        // TOKEN_MUMBAI_MATIC = IERC20(0x4DBCdF9B62e891a7cec5A2568C3F4FAF9E8Abe2b);
        TOKEN_RINKEBY = IERC20(0xf5DDc67CeC0De541aFBc1457366F3C6bbD44a699);
    }
    ...
    function publicMintNFT(IERC20 _toAddress, uint256 amount) external saleConditions {
        ...
        require(amount >= _NFT_PRICE, "Incorrect amount");
        require(_toAddress == TOKEN_MUMBAI_MATIC || _toAddress == TOKEN_RINKEBY, "Token not supported");

        bool success = IERC20(_toAddress).transferFrom(msg.sender, _NFT_PAYMENT_WALLET, amount);
        require(success, "Transfer failed.");

        // for (uint256 i = 0; i < _count; i++) {
        //     _mint(_toAddress, _tokenIdTracker.current(), 1, "");
        //     emit PokerAceMinted(
        //         _tokenIdTracker.current(),
        //         _toAddress,
        //         msg.sender
