...
interface ICryptoPunk {
    ...
    function punkOfferedForSale(uint256 punkIndex)
        external
        returns (
            bool,
            uint256,
...
import "../libraries/Ownable.sol";
import "../interface/ICryptoPunk.sol";
...
contract WrappedPunk is Ownable, ERC721Enumerable, Pausable {
    ...
    function mint(uint256 punkIndex) public whenNotPaused {
        ...
        require(
            _punkContract.punkIndexToAddress(punkIndex) == msg.sender,
            "not owner"
        );
        _punkContract.buyPunk(punkIndex);
