...
contract Finixx {
    ...
    uint256[10] private communityPackages = [50e18, 1000e18, 1100e18, 2500e18, 2600e18, 5000e18, 550018, 10000e18, 11000e18, 25000e18];
    ...
    address public recoveryFund = 0x35AdFF8D0abF7357e0Eff3a14c3D3357CEB3CaB3; 
    address public registerationFee = 0xfCc5B4E4fD1fA3A453D692B8F5f06773C64f59d1; 
    ...
    function claimReward() public {
        ...
        uint256 interestInMultiple = (block.timestamp.sub(rewardInfo[msg.sender].acheived)).div(2 minutes);
