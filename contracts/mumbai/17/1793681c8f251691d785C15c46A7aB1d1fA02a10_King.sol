...
contract King is Context, IERC20, Ownable {
    ...
    uint256 public _developmentFee = 7;
    uint256 private _previousDevelopmentFee = _developmentFee;
    address payable public developmentWallet = payable(0x3E9a5036baC8054A7387c2a20572b60b21040Ad3);
    ...
    function _transfer(
        ...
        if (
            ...
            //add liquidity and send bnb to development wallet
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 liquidityTokens = contractTokenBalance.mul(_liquidityFee).div(_liquidityFee.add(_developmentFee));
    ...
    function setFeePercent(uint256 liquidityFee, uint256 developmentFee) external onlyOwner() {
        require(liquidityFee.add(developmentFee)<= 20, "tax too high");
