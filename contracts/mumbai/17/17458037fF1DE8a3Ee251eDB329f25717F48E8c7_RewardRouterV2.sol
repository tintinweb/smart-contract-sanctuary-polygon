...
contract RewardRouterV2 is ReentrancyGuard, Governable {
    ...
    function mintAndStakeAlp(address _token, uint256 _amount, uint256 _minUsda, uint256 _minAlp) external nonReentrant returns (uint256) {
    ...
    function mintAndStakeAlpETH(uint256 _minUsda, uint256 _minAlp) external payable nonReentrant returns (uint256) {
