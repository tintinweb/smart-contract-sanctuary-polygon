    ...
    IERC1155ById
{
     ...
     * @dev See {IERC165-supportsInterface}.
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC1155, BaseURIStorage, NFTSupplyStorage, NFTLifeCycle, IERC165) returns (bool) {
        return
    ...
    function uri(uint256 id) public view virtual override returns (string memory) {
        ...
        if (!ERC1155Supply.exists(id)) revert IdDoesNotExist();
    ...
    function _validateMintInput(uint256 id, uint256 amount) internal virtual {
        ...
        if (_isMaxSupplyByIndexDefined[id]) {
            if (amount + ERC1155Supply.totalSupply(id) > _maxSupplyByIndex[id]) revert ExceedMaxSupplyById();
        }
    }
...
contract ERC1155ByIdMock_NonProxy is 
    ERC1155ById,
    ERC2771Recipient,
    AccessControl,
    Ownable,
    ...
    constructor(
        ...
        _setupRole(BURNER_ROLE, _initBurner);
