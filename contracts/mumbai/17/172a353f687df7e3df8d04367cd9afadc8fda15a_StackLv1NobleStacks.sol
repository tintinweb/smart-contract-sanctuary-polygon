...
contract StackLv1NobleStacks is Context, Ownable {
    ...
    uint8 public constant nblTokenMultiplier = 1;
    ...
    function getTokenAmounts(
        uint256 _total
    ) internal pure returns (uint256 _amountScty, uint256 _amountNoble) {
        _amountNoble =
            nblTokenMultiplier *
