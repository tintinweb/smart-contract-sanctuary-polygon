...
contract Nayuta is ERC721A, IERC4906, ERC721AQueryable, OperatorFilterer, AccessControl, ERC2981, Ownable, Pausable {
    ...
    string private baseURI = "ar://DtYXJSS3d2iOhY1QH7aBg5SrSOp3DTL_gIm9nIc1IRo/";
    ...
    constructor(bool _callerIsUserFlg) ERC721A("TESTREVEAL", "NAYUTA") {
        ...
        if (_callerIsUserFlg == true) {
            _mintERC2309(owner(), 5000);
        }
    }
