...
import "./QvinoNFTTransfer.sol";

contract QvinoCustodian is
Ownable,
ERC721Holder,
ERC1155Holder,
ReentrancyGuard,
QvinoNFTTransfer
{
    ...
    function onERC721Received(
        ...
        emit Received(msg.sender, from, tokenId, 1, data);
        return this.onERC721Received.selector;
    }
    ...
    function onERC1155Received(
        ...
        emit Received(msg.sender, from, id, value, data);
        return this.onERC1155Received.selector;
    }
    ...
    function onERC1155BatchReceived(
        ...
        for (uint16 i = 0; i < ids.length; i++) {
            emit Received(msg.sender, from, ids[i], values[i], data);
        }
        return this.onERC1155BatchReceived.selector;
    }
