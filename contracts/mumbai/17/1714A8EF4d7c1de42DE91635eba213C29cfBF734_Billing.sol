...
contract Billing is IBilling, OwnableUpgradeable, UUPSUpgradeable {
    ...
    ///  @param details  this is a text description of plan preferable as a markdown text file
    function createSystemSubscriptionWithDescription(SystemDefinedSubscription calldata _sub, string calldata details)
        external
        virtual
        override
        onlyOwner
...
interface IBilling {
    ...
    function createSystemSubscriptionWithDescription(SystemDefinedSubscription calldata _sub, string calldata details) external returns (uint64);
