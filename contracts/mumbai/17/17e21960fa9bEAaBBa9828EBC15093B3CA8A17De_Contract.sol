...
contract Contract is ERC2771Recipient, ERC721URIStorage  {
    ...
    event HorseyVerified(address indexed verifiedAddress, uint256 tokens);
    ...
    constructor(IWorldID _worldId, string memory _actionId, address _trustedForwarder, address _tokenAddr) ERC721("HorseyTestNFT", "NFT") {
        worldId = _worldId;
    ...
    function verifyAndClaimReward(address recipient, uint256 root, uint256 nullifierHash, uint256[8] calldata proof) public
        returns (bool)
    {
        ...
        require(Token(tokenAddr).transfer(recipient, 1000));


        emit HorseyVerified(recipient, 1000);
