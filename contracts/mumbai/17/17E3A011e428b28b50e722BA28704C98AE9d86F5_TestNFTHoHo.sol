...
contract TestNFTHoHo is Ownable, ERC721A, PaymentSplitter {
    ...
    uint public wlSalePrice = 3 ether; // Matic
    uint public publicSalePrice = 5 ether; // Matic
    ...
    uint private constant maxPerAddressDuringPublicMint = 15;
