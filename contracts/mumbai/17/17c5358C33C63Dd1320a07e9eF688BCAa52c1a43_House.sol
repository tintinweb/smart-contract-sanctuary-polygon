...
// File: contracts/interfaces/IHouse.sol
...
contract House is ReentrancyGuard, Ownable, IHouse {
    ...
    function placeBet(address player, uint amount, bool isBonus, uint nftHolderRewardsAmount, uint winnableAmount) payable external isHouseLive admin nonReentrant {
        ...
        lockedInRewards += nftHolderRewardsAmount;
