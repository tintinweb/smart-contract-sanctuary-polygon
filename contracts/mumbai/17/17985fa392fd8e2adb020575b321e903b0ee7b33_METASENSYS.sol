...
//    uint256 public DiamindCounter=0;    
    ...
    constructor() ERC721("METASENSYS", "MSS")  {
     _baseURI= "https://sloopyseals.mypinata.cloud/ipfs/QmQTpj6zUYsKU2dFpkzPezJ9mNoPegMsSyUpNrD6dq4gQD/";
    // contractURI();
    }
    ...
    function mint(uint chosenAmount) public payable isSaleOpen
    {
            ...
            require(SilverPrice.mul(chosenAmount) == msg.value, "Sent ether value is incorrect");
    ...
    function Change_SilverPrice(uint slPrice) public onlyOwner{
        SilverPrice=slPrice;
    } 
