...
contract StMaticOracle is CrossRateLstOracle {
    ...
    function initialize(AggregatorV3Interface _aggregatorAddress, address _stMatic, IMasterVault _masterVault, IRatioAdapter _ratioAdapter) external initializer {
