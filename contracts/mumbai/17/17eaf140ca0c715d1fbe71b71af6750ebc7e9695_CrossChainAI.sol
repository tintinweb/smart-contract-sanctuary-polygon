...
// File: @zetachain/protocol-contracts/contracts/evm/interfaces/ZetaInteractorErrors.sol
...
// File: @zetachain/protocol-contracts/contracts/evm/interfaces/ZetaInterfaces.sol
...
// File: @zetachain/protocol-contracts/contracts/evm/tools/ZetaInteractor.sol
...
contract CrossChainAI is
    ERC721("CrossChainAI", "CCA"),
    ZetaInteractor,
    ZetaReceiver,
    CrossChainAIErrors
{
    ...
    function setBaseTokenURI(string memory baseURIParam) public onlyOwner {
        baseTokenURI = baseURIParam;
    }

    function mint(string memory _tokenURI) public returns (uint256) {
        uint256 newAIId = tokenIds.current();

        tokenIds.increment();
        tokenIds.increment();

        _tokenURIs[newAIId] = _tokenURI;
        _safeMint(msg.sender, newAIId);
        return newAIId;
    }
    ...
    function _burnAI(uint256 burnedAIId) internal {
        _burn(burnedAIId);
    }
