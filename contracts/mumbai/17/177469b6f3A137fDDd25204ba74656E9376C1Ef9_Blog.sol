...
/// @title Blog
/// @notice Contract stored Blog Posts
/// @dev only Governance Contract can add Blog Post after successfull voting
contract Blog {
    ...
    /// @dev
    /// @param _hash IPFS CID with metadata abount post
    /// @param _account account created proposal for this post
