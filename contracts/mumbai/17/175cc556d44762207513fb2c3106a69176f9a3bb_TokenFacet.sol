        ...
        return string(
                abi.encodePacked(
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                '{"attributes":[{"trait_type":"Expired","value":"', (isExpired) ? "true" : "false", '"},{"trait_type":"Expiry Timestamp","value":"', uint2str((getState().subscriptionDeadline[tokenId] - block.timestamp) / (60 * 60 * 24)), '"}],',
