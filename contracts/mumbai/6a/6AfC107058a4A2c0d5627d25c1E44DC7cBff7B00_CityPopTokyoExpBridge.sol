...
contract CityPopTokyoExpBridge is
    OwnableUpgradeable,
    ReentrancyGuardUpgradeable,
    UUPSUpgradeable
{
    uint256 public expDecimal;
    uint256 public maxExpLimit;
    uint256 public equalTokenPerExp;
    address public nft;
    address public token;
    address public holderOfSpended;
    ...
    function initialize(
        uint256 tokenExp,
        address tokenForBridge,
        address nftForUpgrade
        ...
        expDecimal = 2;
        holderOfSpended = _msgSender();

        equalTokenPerExp = tokenExp;
    ...
    function changeHolderExpSpend(
        address _holder
    ) external onlyOwner nonReentrant {
        holderOfSpended = _holder;
    }
