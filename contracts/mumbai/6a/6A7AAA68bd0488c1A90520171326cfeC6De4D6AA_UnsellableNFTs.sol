...
contract UnsellableNFTs is ReentrancyGuard, Pausable, Ownable {
    ...
    constructor(address _wallet, address _tokenContract) {
        require(_wallet != address(0), "Invalid wallet address");

        ourWallet = payable(_wallet);
    ...
    function setOurTokenAddress(address _tokenAddress) public onlyOwner {
    ...
    function setNftPaymentAmount(
        uint256 _nftPaymentAmount
    ...
    function setServiceFeeCapAmount(
        uint256 _serviceFeeCap
    ) public onlyOwner nonReentrant {
        require(
    ...
    function sellNfts(
        ...
        require(
            IERC20(tokenContract).balanceOf(msg.sender) > 0,
            "You must hold our token to use this dapp"
        );
        require(
