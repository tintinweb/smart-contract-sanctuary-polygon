...
contract BaseFixedPriceAuctionERC1155 is ERC1155, ReentrancyGuard, Ownable {
    ...
    string public prefix = "LOA Whitelist Verification:";
    ...
    function airdropMint(address[] calldata recipients, uint256[] calldata tokenIds, uint256[] calldata amounts) external onlyOwner {
