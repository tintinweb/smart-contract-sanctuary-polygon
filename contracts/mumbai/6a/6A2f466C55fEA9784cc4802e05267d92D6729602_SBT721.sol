...
contract SBT721 is IERC5192, ERC721, ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("Soulbounds721", "SBT") {}
    ...
    function lockMint(address to, string memory uri) public onlyOwner returns (uint256) {
