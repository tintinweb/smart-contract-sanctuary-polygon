...
interface IERCHandler {
    ...
    /**
        ...
        @param spender Spender address.
        @param amountOrTokenID Amount to approve.
     */
    function approveTo(address tokenAddress, address spender, uint256 amountOrTokenID) external;
}
...
contract HandlerHelpers is IERCHandler {
    ...
    /**
        ...
        @param amountOrTokenID Amount to approve.
     */
    function approveTo(address tokenAddress, address spender, uint256 amountOrTokenID) external virtual override {}
...
// File: contracts\utils\UpgradableOwnable.sol
...
abstract contract UpgradableOwnable is Context {
    ...
    bool public _isInitialised = false;
