...
contract Stake369 is ERC721, Ownable, RoyaltiesV2Impl {
    ...
    //DEV PURPOSES - #remove
    uint256 private constant MAX_NUMBER_OF_1 = 2;
    uint256 private constant MAX_NUMBER_OF_2 = 2;
    uint256 private constant MAX_NUMBER_OF_3 = 6;
    uint256 private constant MAX_NUMBER_OF_4 = 2;
    uint256 private constant MAX_NUMBER_OF_5 = 2;
    uint256 private constant MAX_NUMBER_OF_6 = 3;
    uint256 private constant MAX_NUMBER_OF_7 = 2;
    uint256 private constant MAX_NUMBER_OF_8 = 2;
    uint256 private constant MAX_NUMBER_OF_9 = 1;

    //DEV PURPOSES - #remove
    uint256 private constant MAX_SUPPLY = 22; // collection size
    ...
    uint256 private constant MAX_MINTS_PER_ADDRESS = 4; // this is the max total mints per account
    ...
    function mint() external payable validateEthPayment(1) {
        ...
        if (whitelist) addressToMints[msg.sender]._numberOfMintsByAddress += 1;
        _mintRandomId(msg.sender);
    }

    function getRemainingTokenNumber() view public onlyOwner returns (uint256){
