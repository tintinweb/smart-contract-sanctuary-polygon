...
// File: contracts/NFts_refactor.sol
    ...
    ERC721Burnable
{
    ...
    uint256 public maxWalletAmount = 8;
    address public pair;
    ...
    function safeMint(address to, string memory uri) public payable onlyAdministrator {
        uint256 tokenId = _tokenIdCounter.current();
        _tokenIdCounter.increment();
        _safeMint(payable(to), tokenId);
        _setTokenURI(tokenId, uri);
        tokenContract.register(uint(tokenId));
        totalSupply_++;
    }
    ...
    function _beforeTokenTransfer(
        ...
        require(
            isMaxTxExempt[to] || balanceOf(to) + 1 <= maxWalletAmount,
    ...
    function updateIpfsURI(string memory _uri_ ) public onlyOwner {
        baseIPFSURI = _uri_;
    }
    ...
    function _burn(uint256 tokenId) internal virtual override(ERC721,ERC721URIStorage) {
        ...
        super._burn(tokenId);
        totalSupply_--;
        // super._approve(address(0x0000000000000000000000000000000000000000), tokenId);
    }

    // function burnNFT(uint256 tokenId) public {
    //     super._approve(address(0x000000000000000000000000000000000000dEaD), tokenId);
    //     super._burn(tokenId);
    //     totalSupply_--;
    // }
        ...
        onlyAdministrator
    {
        ...
        require( totalSupply_> 0 ,"required mint Nfts");
        maxWalletAmount = (totalSupply_ * percentage) / 10000;
    }

    function setMaxTxExempt(address account, bool value)
        external
        onlyAdministrator
    {
