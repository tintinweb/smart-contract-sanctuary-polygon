...
contract DIME is Pausable, ReentrancyGuard {
    ...
    */
    ...
    function postMsg(string calldata message, string[] memory _hashtags, address[] calldata taggedAccounts, uint256 totalTips, string calldata uri, uint256[4] calldata attribs, uint256[] calldata inGroups) public payable nonReentrant whenNotPaused {
        ...
        require(paymentToken.approve(msg.sender, totalCostToPost), "Must approve payment tokens to be transferred");
...
//            Tagged.addTags(msgCounter, taggedAccounts);
    ...
    function followUser(address userToFollow) public whenNotPaused nonReentrant {
        // require the approval of the sending of the token to the contract
        require(paymentToken.approve(msg.sender, costToFollow), "Must approve payment tokens to be transferred.");
    ...
    function unfollowUser(address userToUnfollow) public whenNotPaused nonReentrant {
        // require the approval of the sending of the token to the contract
        require(paymentToken.approve(msg.sender, costToUnfollow), "Must approve payment tokens to be transferred.");
