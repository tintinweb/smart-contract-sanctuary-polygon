...
contract BoredExpressionsYachtClub is ERC721, IERC2981, ReentrancyGuard, Ownable
{
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_)
    ERC721("Bored Expressions Yacht Club", "BEYC")
  {
  ...
  uint256 public constant PRICE = 10000000000000000000;
  ...
  function mint(uint256 count) public payable nonReentrant {
    ...
    require(
      msg.value >= PRICE * count, "Insufficient payment, 10 ETH per item"
    );
