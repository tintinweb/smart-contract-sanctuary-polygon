...
contract Staking is Ownable, Pausable {
    ...
    // Constructor
    constructor(address _stakeToken, uint256 _rewardTokensPerBlock, uint256 _depositLock, uint256 _rewardPool, IBlacklist blacklist_) {
     ...
     * @dev Deposit tokens
     */
    function stake(uint256 _amount) external isNotBlackListed {
     ...
     */
    function unstake() external isNotBlackListed {
     ...
     */
    function harvestRewards() public isNotBlackListed {
        updatePoolRewards();
        PoolStaker storage staker = poolStakers[msg.sender];
    ...
    function setRewardPerBlock (uint256 _rewardPerBlock) external onlyOwner {
        rewardTokensPerBlock = _rewardPerBlock;
    }
