...
contract UserProxyTemplate is UserProxyStorageLayout, CascadingFallbackProxy {
    ...
    function initialize(
        ...
        require(penLensAddress == address(0), "Already initialized");
        ownerAddress = _ownerAddress;
        penLensAddress = _penLensAddress;
        penLens = IPenLens(_penLensAddress);
        penDystAddress = penLens.penDystAddress();
        penDystRewardsPoolAddress = penLens.penDystRewardsPoolAddress();
        userProxyInterfaceAddress = _userProxyInterfaceAddress;
        vlPenAddress = penLens.vlPenAddress();
