...
contract ERC1155Proxy is MixinAuthorizable, IAssetProxy {
    ...
    // Id of this proxy.
    bytes4 internal constant PROXY_ID = bytes4(keccak256("ERC1155Assets(address,uint256[],uint256[],bytes)"));
    ...
    function transferFrom(
        ...
        IERC1155(erc1155TokenAddress).safeBatchTransferFrom(from, to, ids, scaledValues, data);
    }
