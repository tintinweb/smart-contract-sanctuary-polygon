...
contract FootEarnMarketPlace is ReentrancyGuard, Ownable {
        ...
        nonReentrant
    {
        ...
        FootEarn(FACTORY_NFT).safeTransferFrom(
            msg.sender,
            address(this),
            tokenId
        );
        ...
        emit MarketItemCreated(itemIds, tokenId, msg.sender, priceItem, false);
        itemIds++;
    }
    ...
    function buyNFT(uint256 tokenId) public nonReentrant {
        require(idToMarketItem[tokenId].sold == false, "Buy NFT : Unavailable");

        uint256 fee = (idToMarketItem[tokenId].price * paid_percent) / 1000;
