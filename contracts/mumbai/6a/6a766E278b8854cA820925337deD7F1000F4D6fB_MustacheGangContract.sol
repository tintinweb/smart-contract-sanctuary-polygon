...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x9269ba8cceAAb1Fe5439C5A4C2A6E95c51945aB9];
  address public erc20Payable = 0x9269ba8cceAAb1Fe5439C5A4C2A6E95c51945aB9;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeihyusv7ddd2bj7rajiolorc23inpwitc4utsnswlczsytbeqobeui/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/OJruNprBCnxM6wx8JPSh/contract-metadata";
  }
...
// File: contracts/MustacheGangContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MustacheGangContract is RamppERC721A {
    constructor() RamppERC721A("Mustache Gang", "MG"){}
}
