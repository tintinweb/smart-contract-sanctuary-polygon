...
contract Smarti is ERC721, Ownable {
    using Strings for uint256;

    
    uint public constant MAX_TOKENS = 3670;
    ...
    constructor() ERC721("Smarti", "SRT") {
        baseUri = "ipfs://QmWx162JYC8Y8hmbcqsvgUcM9eyYhnTr4VvmkGbsqtkDeg";
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0x338e92a140d04c22A7AE0B2D44C3A676Ac4fE967).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0x338e92a140d04c22A7AE0B2D44C3A676Ac4fE967).call{value: balanceTwo}("");
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
     ...
     function _baseURI() internal view virtual override returns (string memory) {
        return "https://ipfs.io/ipfs/QmWx162JYC8Y8hmbcqsvgUcM9eyYhnTr4VvmkGbsqtkDeg/";
    }
