...
import "./interfaces/IBoleroNFT.sol";
import "./storage/BoleroNFTStorage.sol";

contract BoleroNFT is
    ERC721AUpgradeable,
    OwnableSkeleton,
    IBoleroNFT,
    BoleroNFTStorage
{
    ...
    function owner()
        public
        view
        override(IBoleroNFT, OwnableSkeleton)
        returns (address)
    {}
    ...
    function mintedPerAddress(
        address minter
    ) external view override returns (AddressMintDetails memory) {}
...
import {IBoleroNFT} from "../interfaces/IBoleroNFT.sol";

contract BoleroNFTStorage {
    /// @notice Configuration for NFT minting contract storage
    IBoleroNFT.Configuration public config;

    /// @notice Sales configuration
    IBoleroNFT.SalesConfiguration public salesConfig;
