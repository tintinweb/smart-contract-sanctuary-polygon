...
contract Alchemist is Royalty, AccessControl, ERC721Enumerable, Pausable, TokenURISetting, Ownable, Initializable {
    ...
    constructor(address timelockController, address erc20TransferHelper_) ERC721("Alchemist", "ALC") Royalty(erc20TransferHelper_) {
     ...
     */
    function init(address micAddress_, address payable micBank_, address payable midLandBank_, address payable alchemistBank_) external initializer {
        ROYALTY = 100 ether;
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "', Strings.toString(tokenId),'.alchemist", "description": "Alchemist is a MID community co-builder.", ', render, '}'))));
     ...
     */
    function mintByContract(address owner_) public nonReentrant {
    ...
    function setAlchemist(address owner_, uint8 allow_) public {
    ...
    function ownerOfMinted(address owner_) public view returns(uint8) {
