...
contract ERC721WhitelistCommitRevealFactory is ForjFactoryEvents {
    function createTemplate(
        ...
        ERC721WhitelistCommitReveal clone = new ERC721WhitelistCommitReveal();
        clone.initialise(_multisig, _owner, _baseURI, _name, _symbol, _fees, _maxSupply, _limitPerAddress, starts, ends, merkleRoots);
        emit TemplateCreated(address(clone), "ERC721WhitelistCommitReveal");
    }
}
