...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x1d52412498A4d23012a9D22a9Fa8DB7c156E5B74];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmRbfHnRgvXQzhETyWGffBRDrKTVVnuJ1jG1buLZhUQaKp/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 2");
        _safeMint(_to, 1);
    }
...
// File: contracts/helloWorldBy11DAnomalyContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract HelloWorldBy11DAnomalyContract is RamppERC721A {
    constructor() RamppERC721A("Hello World by 11dAnomaly", "11d"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/pLgbEIo0FnQLPwpChSlC/contract-metadata";
    }
}