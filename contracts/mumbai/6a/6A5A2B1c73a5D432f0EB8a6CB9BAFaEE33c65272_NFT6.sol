...
contract NFT6 is ERC721URIStorage, EIP712, AccessControl {
        ...
        returns (uint256)
    {
        ...
        _transferBuy(msg.value, marketItemId);
    ...
    function _transferBuy(uint256 _amount, uint256 _marketItemId) internal {
    ...
    function secondaryBuyToken(
        ...
        _transferSecondaryBuy(msg.value, _marketItemId);
    ...
    function _transferSecondaryBuy(uint256 _amount, uint256 _marketItemId)
        internal
    {
