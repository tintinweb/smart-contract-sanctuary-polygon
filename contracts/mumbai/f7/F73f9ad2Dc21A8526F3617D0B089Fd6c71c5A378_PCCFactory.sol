...
/// @title EnverX: PCC smart contract
/// @author EnverX Blockchain Engineering Team
/// @notice This contract is used for managing PCC fundamentals
    ...
    BasicMetaTransaction
{
    ...
    */
     ...
     */
    mapping(address => uint256) public batchIndexList;
    ...
    */
    ...
    function getBytecode(
        ...
        return
            abi.encodePacked(_bytecode, abi.encode(_tokenName, _tokenSymbol));
    }
    ...
    function createNewBatch(
        ...
        PCCBatch(_batchAddress).grantRole(DEFAULT_ADMIN_ROLE, address(this));
        PCCBatch(_batchAddress).grantRole(ADMIN_ROLE, address(this));
    ...
    function mintMoreInABatch(
        ...
        PCCBatch(_batchId).mint(_batchOwner, _amountToMint);
    ...
    function burnFromABatch(
        ...
        PCCBatch(_batchId).burn(_batchOwner, _amountToBurn);
    ...
    /**
        @notice _beforeTokenMint: Update delivery year of batch
    ...
    function _createNewBatch(
        ...
        string memory _tokenName,
        string memory _tokenSymbol
    ) internal onlyRole(ADMIN_ROLE) returns (address) {
...
contract PCCBatch is ERC20, AccessControl {
    /**
     * @notice Declaring access based roles
     */
    bytes32 public constant ADMIN_ROLE = keccak256("ADMIN_ROLE");
    ...
    /**
        @notice Basic ERC20 constructor call
     */
    constructor(
        string memory _name,
