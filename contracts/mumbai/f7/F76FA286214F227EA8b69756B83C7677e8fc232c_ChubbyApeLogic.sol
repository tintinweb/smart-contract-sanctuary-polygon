...
contract ChubbyApeLogic is Ownable {
    ...
    function GetMATICPrice() public view returns (uint256) {
        ...
        AggregatorV3Interface priceFeed_ETHUSD = AggregatorV3Interface(
            0x0715A7794a1dc8e42615F059dD6e406A6594651A
        );
        (
        ...
        // 1 MATIC to  1.57 USD
        //  3337 / 1.57 = MATIC to 1 ETH

        // ETH / USD    331790000000
        // MATIC / USD  153302882
        return uint256(uint256(price_ETHUSD).div(uint256(price)));
        // return uint256(price_ETHUSD / price) / uint256(10**8);
    }
