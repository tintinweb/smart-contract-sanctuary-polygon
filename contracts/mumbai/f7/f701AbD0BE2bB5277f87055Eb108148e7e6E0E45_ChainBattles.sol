...
contract ChainBattles is ERC721URIStorage{
    ...
    function generateCharacter(uint256 tokenId) public view returns (string memory) {
        ...
        bytes memory svg = abi.encodePacked(
            ...
            '<style>.basetrack { fill: white; font-family: serif; font-size: 12px; }</style>',
            '<rect width="100%" height="100%" fill="black" />',
            "<text x='10%' y='20%' class='base' dominant-baseline='middle' text-anchor='start'>Wizzard</text>",
            "<text x='13%' y='40%' class='basetrack' dominant-baseline='middle' text-anchor='start'>Level:",getLevel(tokenId),"</text>",
            "<text x='13%' y='50%' class='basetrack' dominant-baseline='middle' text-anchor='start'>Speed:",getSpeed(tokenId),"</text>",
            "<text x='13%' y='60%' class='basetrack' dominant-baseline='middle' text-anchor='start'>Strength:",getStrength(tokenId),"</text>",
            "<text x='13%' y='70%' class='basetrack' dominant-baseline='middle' text-anchor='start'>Life:",getLife(tokenId),"</text>",
            "</svg>"
        );
