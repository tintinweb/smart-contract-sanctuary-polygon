...
contract Airdrop is Ownable{
    ...
    address tokenAddress = 0x1f1168fBB87EA3F02523A9eCfB19a94ef830318d;



    function airdrop(address[] memory _users, uint256 amountPerPerson) public onlyOwner{
        uint256 len = _users.length;
        for (uint256 i = 0; i < len; i++) {
            IERC20(tokenAddress).transferFrom(msg.sender,_users[i], amountPerPerson * 10**18);
        }
    }
