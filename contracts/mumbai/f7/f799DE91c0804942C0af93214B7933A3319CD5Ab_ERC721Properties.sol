...
contract ERC721Properties is ERC721Upgradeable, OwnableUpgradeable, App {
    ...
    bytes32 constant TIER_CLASSIC = bytes32("CLASSIC");
    bytes32 constant TIER_EPIC = bytes32("EPIC");
    ...
    function initialize(
        ...
        uint32 transferUnlocksAtHours_,
        address owner_,
        ...
        if (isTransferable) {
            transferUnlocksAtHours = transferUnlocksAtHours_;
        }
    ...
    function setAttribute(string memory propKey, bytes32 propValue, string memory attrKey, bytes32 attrValue) external requirePermission(APP_UPDATER) {
    ...
    function getAttribute(string memory propKey, bytes32 propValue, string memory attrKey) external view returns (bytes32) {
