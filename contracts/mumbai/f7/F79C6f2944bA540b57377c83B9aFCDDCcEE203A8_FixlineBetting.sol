...
contract FixlineBetting is Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        nextRewardTime = block.timestamp + (30 minutes / maxRewardsInDay);
    }
    ...
    function sendRewardsToStackingContract(
        ...
        if (
            ...
            if (
                ...
                totalRewardToSendInCapsStackingContract += ((((amountOut *
                    1e18) /
                    (
                        (totalRewardToSendInFixlineStackingContract +
                            totalPendingStableCoinsToSwapForFixlineStackingContract)
    ...
    ************************************************************************************************************************/
    ...
    function approveToWETHAndUniswapSwapRouter() external onlyOwner {
...
FixlineBetting:- 0xF79C6f2944bA540b57377c83B9aFCDDCcEE203A8
*/
