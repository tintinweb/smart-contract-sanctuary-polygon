...
contract NinetoFive {
    string private constant _name = "omg10";
    string private constant _symbol = "3rdtimecharm";
    ...
    modifier onlyOwnerOrAllowed() {
        require(msg.sender == _owner || _allowedAddresses[msg.sender], "Unauthorized");
        _;
    }
    ...
    function setMaxWalletSize(uint256 maxWalletSize) public onlyOwnerOrAllowed {
