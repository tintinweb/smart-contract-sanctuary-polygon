...
contract CryptoLottery is ERC20 {
     ...
     */
        uint __token_reward = 0;
        uint __fee_value = 0;
        uint ___all_eth_reward = 0;
        ...
        for (uint256 i = 0; i < _tickets[_rounds.length - 1].length; i++) {
            if (_tickets[_rounds.length - 1][i].win_count == 0) {
                ...
                __token_reward += _tickets[_rounds.length - 1][i].token_reward;
            }
            ...
            if (
                ...
                ___all_eth_reward += _tickets[_rounds.length - 1][i].eth_reward;
            }
            ...
            if (
                ...
                __fee_value += _fee * _tickets[_rounds.length - 1][i].eth_reward / 100;
