...
contract IslandReplica is ERC721URIStorage, EIP712, AccessControl{
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
  string private constant SIGNING_DOMAIN = "IslandReplica";
  string private constant SIGNATURE_VERSION = "1";
 
  mapping (address => uint256) pendingWithdrawals;
 
  constructor(address payable minter)
    ERC721("IslandReplica", "IslandReplica") 
...
//   function transferamount(address creator,address admin,uint256 amount,uint256 adminpersent) public 
