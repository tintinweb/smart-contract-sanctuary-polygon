...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new QuantumUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        QuantumUser1155Token token = QuantumUser1155Token(address(addr));
...
contract QuantumUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
