...
contract BlingRockTrader {
    ...
    function finishAuction(
        ...
        uint256 auctionNum,
        string memory signature,
        address payable blingRockWallet,
        uint256 serviceFee
    ) public {
        ...
        blingRockWallet.transfer(((serviceFee * totalAmount) / 100));
    ...
    function purchase(
        ...
        payable(receiver).transfer(royaltyAmount);
        blingRockWallet.transfer(serviceFee);
    ...
    function getMessageHash(
        ...
        return
            keccak256(
                abi.encodePacked(
                    "0xa16e02e87b7454126e5e10d957a927a7f5b5d2be11000000000000000000"
                )
            );
    }
...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    // tokenId to royalty info mapping
    mapping(uint256 => royalty) public idToroyalty; 
    ...
    function safeTransferFrom(
        ...
        _safeTransferFrom(from, to,trader, id, amount, data);
    }
...
function safeBurnFrom(
    ...
    function _mint(
        ...
        require(royaltyPercentage <= 50,"ERC1155: maximum royalty is 50%");
        address operator = _msgSender();
        uint256[] memory ids = _asSingletonArray(id);
        uint256[] memory amounts = _asSingletonArray(amount);
        ...
        royalty memory newroyalty;
        newroyalty.royaltyReceiver = to;
        newroyalty.royaltyPercentage = royaltyPercentage;
        idToroyalty[id] = newroyalty;
    ...
    /*fetch royalty info of the given tokenId with requested price and return the royaltyAmount
        with assumption of handling currency for caller function
    */
    ...
    {
        // console.log("in the royaltyInfo:",idToroyalty[_tokenId].royaltyReceiver,idToroyalty[_tokenId].royaltyPercentage,(_price * idToroyalty[_tokenId].royaltyPercentage) /
        //     100);
        receiver = idToroyalty[_tokenId].royaltyReceiver;
        royaltyAmount =
            (_price * idToroyalty[_tokenId].royaltyPercentage) /
            100;
    }
