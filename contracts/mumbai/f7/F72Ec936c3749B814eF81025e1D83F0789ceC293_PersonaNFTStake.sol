...
interface IPersonaSign is IPersona  {
...
contract PersonaNFTStake is IPersona, Ownable {
    ...
    mapping(uint256 => PersonaNFTRarity) public stakedNFTsRarity;
    ...
    function stake(
        ...
        require(
            IPersonaSign(personaSign).verifyForStake(
                msg.sender,
                _tokenIds,
                _rarities,
                _signature
