...
We are international charity crypto-community, and we invite you to join us!
We want to build a global community based on cryptocurrency and spend part of the money earned on charity - this is the highest goal for us. 
We invite you to become a member of the community and help people, as well as invest in our project so that we can develop the ecosystem. 
We will not fail your expectations, because we have good goals and we are moving towards them!

Our smart contract description:
...
Links:
Website: https://osex.space/ (may be changed)
...
//Below is a regular contract, nothing interesting.
...
contract OSEXAdvertiseToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10 * 10**17 * 10**2;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Orbital Station Excelsior (OSEX) Advertisment Token (look into code tab)";
    string private _symbol = "OSEXcode";
    ...
    uint256 public _maxTxAmount = 5 * 10**17 * 10**2;
    uint256 private numTokensSellToAddToLiquidity = 5 * 10**17 * 10**2;
