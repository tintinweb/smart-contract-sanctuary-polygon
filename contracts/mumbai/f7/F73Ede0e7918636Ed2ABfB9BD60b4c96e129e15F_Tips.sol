...
contract Tips is Initializable, PausableUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    */
    ...
    function addTaggedTips(address[] memory taggedAccounts, uint256 erc20Tips, address tipContract) public onlyAdmins whenNotPaused payable {
        ...
        require(taggedAccounts.length > 0, "Need Tagged Accounts");
        ...
        if (erc20Tips > 0){
            ...
            uint256 tipPerTag = erc20Tips / (taggedAccounts.length - 1);
            ...
            for (uint t=0; t < taggedAccounts.length - 1; t++) {
                ...
                // Send the tips
                tipsToken.transferFrom(tx.origin,taggedAccounts[t], tipPerTag);
