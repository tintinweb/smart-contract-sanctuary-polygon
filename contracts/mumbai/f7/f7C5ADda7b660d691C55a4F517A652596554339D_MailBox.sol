...
//
// Email sends a LayerZero message to destination chain
// destinationChain (receiving chain) stores the message by messageId as Key
...
contract MailBox is NonblockingLzApp, Pausable {
    // event emitted every sendMail() to keep track of message sent
    event EmailSent(bytes32 messageId, string message);
    ...
    function _nonblockingLzReceive(
        ...
        (bytes32 messageId, string memory message) = abi.decode(_payload, (bytes32, string));
