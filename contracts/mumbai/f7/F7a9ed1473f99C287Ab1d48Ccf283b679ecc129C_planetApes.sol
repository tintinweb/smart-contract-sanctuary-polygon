...
contract planetApes is Ownable, ReentrancyGuard, IERC721, IERC165, IERC721Metadata, IERC721Enumerable {
    using SafeMath for uint256;
    using EnumerableSet for EnumerableSet.UintSet;
    EnumerableSet.UintSet internal tokensOnSale;
    // using EnumerableSetMarket for EnumerableSetMarket.MarketLotSet;

    string internal _name = "Apes";
    string internal _symbol = "APES";
    string private _baseURI;

    uint256 internal totalMinted = 0;

    uint256 public constant MINTING_LIMIT = 50;
