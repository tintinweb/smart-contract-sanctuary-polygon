...
contract NFTFactory is Ownable, INFTFactory {
    ...
    constructor(address _proxyImplementation, IRoyaltyDistributorFactory _royaltyDistributorFactory, address _mutagenImplementation, address _metadataRevealer, address _mutagenise) {
