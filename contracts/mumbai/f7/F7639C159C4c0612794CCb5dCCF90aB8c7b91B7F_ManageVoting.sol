...
contract ManageVoting {
    ...
    //EVENTS
    event CreateVoting(address sender, string _votingName, Opt[] options);
    event Voted(address sender, string _votingName, uint256 _optionID);
    ...
    function createVoting(
        ...
        emit CreateVoting(msg.sender, _votingName, options);
        return true;
    }
        ...
        returns (bool)
    {
        ...
        emit Voted(msg.sender, _votingName, _optionID);
        return true;
    }
