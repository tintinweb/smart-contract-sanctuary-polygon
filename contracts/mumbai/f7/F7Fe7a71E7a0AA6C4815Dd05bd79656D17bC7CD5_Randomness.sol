...
contract Randomness is VRFConsumerBaseV2 {
    ...
    uint64 subscriptionId = 2504;
    bytes32 gasLane = 0x4b09e658ed251bcafeebbc69400383d49f344ace09b9576fe248bb02c003fe9f;
   ...
   //uint256[] public _randomWords;
    ...
    function fulfillRandomWords(uint256 _requestId, uint256[] memory _randomWords) internal override{
        ...
        // uint256 i = 0;
        // for (i; i < 80;) {
        //     s_requests[_requestId].randomWords[i] = _randomWords[i] % 17;
        //     unchecked { i++; }    
        // }
    ...
    function getRandomWords_16(uint256 requestId) external view returns(uint256[] memory) {
        uint256[] memory _numbers = new uint256[](s_requests[requestId].randomWords.length);
        for (uint256 i = 0; i < _numbers.length;) {
            _numbers[i] = s_requests[requestId].randomWords[i] % 17;
            unchecked { i++; }    
        }
        return _numbers;
    }
    ...
    function withdrawTokens(IERC20 _tokenAddress, uint256 _amount) external {
