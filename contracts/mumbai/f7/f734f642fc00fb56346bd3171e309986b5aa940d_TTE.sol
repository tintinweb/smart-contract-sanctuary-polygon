...
contract TTE is ERC721, ERC721URIStorage, Ownable {
  ...
  constructor() ERC721("Barn NFT", "BarnNFT") {}
  ...
  function setSupply(uint256 _supply) external onlyOwner contractUnlocked {
    supply = _supply;
  }

  function lockContract() public virtual onlyOwner contractUnlocked {
  ...
  function burn(uint256 tokenId) public virtual onlyOwner contractUnlocked {
    _burn(tokenId);
  }
