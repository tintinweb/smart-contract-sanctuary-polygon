...
contract MobLNER is ERC1155, Ownable {
    using Strings for uint256;

    string public constant INITIAL_BASEURI =
    "https://nftstorage.link/ipfs/bafybeie7yu25tvfadawda2xfovkpvsuyqkrn6q7pkh2hl7htvzkoeundei/";

    string public name = "Internet of Mobility Mobsters - LNER";
    string public symbol = "MOBLNER";
