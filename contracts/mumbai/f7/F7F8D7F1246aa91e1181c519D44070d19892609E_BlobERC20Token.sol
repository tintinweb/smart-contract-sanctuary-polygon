...
// File: interfaces/IBLOB.sol

interface IBLOB is IERC20 {
...
contract BlobERC20Token is ERC20Permit, IBLOB, BlobAccessControlled {
    using SafeMath for uint256;

    constructor(address _authority)
        ERC20("Blob", "BLOB", 18)
        ERC20Permit("Blob")
        BlobAccessControlled(IBlobAuthority(_authority))
    {}
