...
// File: contracts/child/ChildToken/ChildBodyNFT.sol
    ...
    Pausable
{
    ...
    constructor(address childChainManager) ERC1155("") {
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _grantRole(URI_SETTER_ROLE, msg.sender);
        _grantRole(PAUSER_ROLE, msg.sender);
        _grantRole(DEPOSITOR_ROLE, childChainManager);

        _initializeEIP712("ChildBodyNFT");
    }
        ...
        onlyRole(DEPOSITOR_ROLE)
    {
        ...
        require(user != address(0x0), "ChildBodyNFT: INVALID_DEPOSIT_USER");
