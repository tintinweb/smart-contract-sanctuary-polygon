...
contract COTNFT is ERC721, Ownable {
    ...
    //["Briquettes", "Sichuan Biogas Stove Development Programme", "Sichuan, China", "Gold Standard", "COM PoA 2898,GS 1239", 800000]
    struct ProjectInfo{
        string projectName;
        string projectTitle;
        string location;
    ...
    function childNFTs() public view returns(NFTInfo[] memory) {
        ...
        for (uint256 i=initChildId; i < maxChildId; i++) {
            NFTInfo storage info = _tokenInfo[i];
            nftInfos[i] = info;
        }
        return nftInfos;
    }
                        ...
                        bytes(
                            string(
                                abi.encodePacked(
                                    '{"name":"',tokenId,'","image":"',
                                    nft.imageUrl,
                                    '"},{"trait_type":"Project title","value":"',
                                    projectInfo.projectTitle,
                                    '"},{"trait_type":"Total COT","value":"',
                                    projectInfo.totalCOT,
