...
import {KoshaNFTBase} from "src/KoshaNFTBase.sol";
import {ERC2981, IERC2981, PrincipalRoyaltyInfo} from "src/royalties/ERC2981/ERC2981.sol";
import {IKoshaAddressRegistry} from "src/interfaces/IKoshaAddressRegistry.sol";
import {IKoshaTokenRegistry} from "src/interfaces/IKoshaTokenRegistry.sol";
import {KoshaNFTErrors} from "src/common/Errors.sol";
import {ERC1155} from "src/libs/ERC1155.sol";

/// @title An implementation contract of EndKoshaNFT contract.
contract MockEndKoshaNFT is KoshaNFTBase, ERC2981, KoshaNFTErrors {
    /// @notice Token name
    ...
    /// @dev Mints tokens
    function mint(address _to, uint256 _amount, string calldata _tokenURI) external {
        _mintTo(_to, _amount, _tokenURI);
    }
