...
/*
  ...
  .zf"` `"tu                                                    dF                                    ..         
 x88      '8N.                                      u.    u.   '88bu.                     .u    .    @L          
 888k     d88&      .u         uL          .u     [email protected] [email protected] '*88888bu         u      .d88B :@8c  9888i   .dL  
 8888N.  @888F   ud8888.   .ue888Nc..   ud8888.  ^"8888""8888"   ^"*8888N     us888u.  ="8888f8888r `Y888k:*888. 
 `88888 9888%  :888'8888. d88E`"888E` :888'8888.   8888  888R   beWE "888L [email protected] "8888"   4888>'88"    888E  888I 
...
contract SoulTwo is ERC721AQueryable, ERC2981, Ownable, ReentrancyGuard {
  ...
  constructor(
    ...
    _setDefaultRoyalty(address(this), 900);
  }
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    // This will pay to DHARMA 33% of the initial sale.
    // =============================================================================
    (bool td, ) = payable(0xF0db0413044631822B0ad2b355aD724226ABC5B9).call{value: address(this).balance * 33 / 100}('');
    require(td);
    // =============================================================================

    // This will pay to DONATION 33% of the initial sale.
    // =============================================================================
    (bool dd, ) = payable(0xC992578BEc92fa9f04740Cc43D07F76262a846Ad).call{value: address(this).balance * 33 / 100}('');
    require(dd);
    // =============================================================================

    // This will pay to NFT ACCOUNT 32% of the initial sale.
    // =============================================================================
    (bool na, ) = payable(0x9116286B96Ac10596910A4a4F6B5b5471295D4FF).call{value: address(this).balance * 32 / 100}('');
    require(na);
    // =============================================================================
