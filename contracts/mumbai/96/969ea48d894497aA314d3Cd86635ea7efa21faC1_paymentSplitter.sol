...
contract paymentSplitter is Initializable, UUPSUpgradeable, OwnableUpgradeable{
    ...
    */
    ...
    /**
        * setRoyaltyInfo
        * There is a maximum restriction for royalty receiver array size.
    */
    function setRoyaltyInfo(royaltyInfo[] memory _royalty, address _nftAddress, uint _nftTokenId) external{
        ...
        Exar721 ad = Exar721(_nftAddress);
        require(msg.sender == ad.owner(),"you are not owner of the contract");
