...
contract Chat {
    ...
    constructor() {
        ...
        users[0x603C4Ae498fd4147B4dF6378A5f16B150336f5Ef] = User("Admin", "[email protected]", true,0x603C4Ae498fd4147B4dF6378A5f16B150336f5Ef,true);
  ...
  //--------------------------------------------------------------------------------------   
   ...
   require(walletAddress != address(0), "User with given address does not exist.");
    ...
    // Send message function
     function sendMessage(address[] memory receivers, string calldata message,string calldata subject, bool isShareable) external {
        require(
