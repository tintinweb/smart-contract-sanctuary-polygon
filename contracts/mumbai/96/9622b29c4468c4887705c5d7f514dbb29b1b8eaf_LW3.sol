...
contract LW3 is ERC721Enumerable, Ownable {
    using Strings for uint256;
    /**
    ...
    uint256 public _paused = 1;

    // max number of LW3Punks
    uint256 private constant _MAX_TOKEN_IDS = 10;

    // total number of tokenIds minted
    uint256 public tokenIds;

    modifier onlyWhenNotPaused() {
        require(_paused == 1, "Contract currently paused");
        _;
    }
     ...
     */
    constructor(string memory baseURI) ERC721("LW3NFT", "LW3") {
    ...
    function mint() public payable onlyWhenNotPaused {
        require(tokenIds < _MAX_TOKEN_IDS, "Exceed maximum LW3Punks supply");
    ...
    function maxTokenIds() external view returns (uint256 maxTokenIds_) {
        maxTokenIds_ = _MAX_TOKEN_IDS;
    }
     ...
     */
    function setPaused(uint256 val) public onlyOwner {
        _paused = val;
    }
