...
contract EtheremonAdventureData is BasicAccessControl {
    ...
    event AddedRevenue(uint _amount, uint fee);
    ...
    function initialize(address _emon) external onlyModerators {
        emon = IERC20(_emon);
    }
        ...
        )
    {
        ...
        _perecentAmount = (_emonAmount * 10) / 100;
        _subAmount = _emonAmount.sub(_perecentAmount);
        _currentRevenue = _subAmount / tokenIds.length;
    }
