...
contract NmareFuelos is ERC721, ERC721Enumerable, ERC721URIStorage, ERC2981, Pausable, Ownable {
...
uint256 public constant MAX_PER_TXN =3;
    ...
    constructor(uint96 _royaltyFeesInBips) ERC721("Nmare Fuelos", "NMARE") {
    ...
    function unpause() public onlyOwner {
     ...
     function mint(uint256 numberOfTokens) public payable {
        ...
        require(numberOfTokens <= MAX_PER_WALLET, "No more 4 u, sry");
        require(ts + numberOfTokens <= MAX_SUPPLY, "Sold out!");
        require(balanceOf(msg.sender)<= MAX_PER_WALLET, "Sry no moar 4 u");
        require(MINT_PRICE * numberOfTokens <= msg.value, "Pls pay moar, sry");
