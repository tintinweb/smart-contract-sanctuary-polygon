...
contract CrossmintTester721 is ERC721, AccessControl {
    ...
    uint256 public priceNative = 1 ether; // 1 MATIC
    ...
    modifier isCrossmint(address _sender) {
        require(_sender == crossmintAddress, "Only Crossmint can call this function");
        _;
    }
    ...
    function setCrossmintAddress(address _crossmintAddress) public onlyRole(ADMIN_ROLE) {
        crossmintAddress = _crossmintAddress;
    }
