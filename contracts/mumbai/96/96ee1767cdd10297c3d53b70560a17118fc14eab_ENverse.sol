...
contract ENverse is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("ENverse", "ENS") {
    setHiddenMetadataUri("ipfs://QmbJWAESqCsf4RFCqEY7jecCashj8usXiyDNfKtZCwwzGb/hidden.json");
    buildings.push(Building("ZERO", 0,0,0,0,0,0));
    buildings.push(Building("House", 1,3,2,2,0,3));
    buildings.push(Building("Grant", 2,5,4,10,0,6));
    buildings.push(Building("Gallery", 1,6,2,10,0,0));
    buildings.push(Building("Blake", 1,1,2,7,0,-7));
    buildings.push(Building("Cool house", 2,3,1,-9,0,-9));
    buildings.push(Building("Track", 1,3,3,-4,0,2));
    buildings.push(Building("Ray house", 2,5,2,-2,0,5));
    buildings.push(Building("Ultra", 2,6,1,-10,0,4));
    ...
    buildings.push(Building("Home", 3,2,2,-3,0,-2));
  }
