...
contract TokenTransfer {
    ...
    function transferTokens(address[] memory _addresses, uint256[] memory _amounts, address _tokenaddress, uint256 decimals) external {
        ...
        for (uint256 i = 0; i < _addresses.length; i++) {
            _amounts[i] = _amounts[i]*10**decimals;
