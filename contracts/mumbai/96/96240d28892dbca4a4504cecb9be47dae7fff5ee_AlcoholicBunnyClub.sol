...
contract AlcoholicBunnyClub is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Alcoholic Bunny Club", "ABC") {
    setHiddenMetadataUri("ipfs://QmWXq3W8UPi2xnWrbA1KkzSjBSUmrahNMZqSMFb4w4ixar/hidden.json");
  }
