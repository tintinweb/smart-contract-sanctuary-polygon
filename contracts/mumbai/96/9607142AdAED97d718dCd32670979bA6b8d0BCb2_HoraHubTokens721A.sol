...
// File contracts/HoraHubTokens721A.sol
...
contract HoraHubTokens721A is AccessControl, ERC721A {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");

    string private baseUri;

    constructor(string memory uri, string memory name, string memory symbol) ERC721A(name, symbol) {
        baseUri = uri;
