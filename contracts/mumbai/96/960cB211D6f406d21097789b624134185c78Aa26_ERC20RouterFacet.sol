 ...
 *
 * Tokens can be transferred to another address via [`erc20Transfer()`](#erc20transfer) or transferred from another address via [`erc20TransferFrom()`](#erc20transferfrom). Tokens can be approved to another address via [`erc20Approve()`](#erc20approve) or [`erc20ApproveAtLeast()`](#erc20approveatleast). Tokens with the `ERC2612` extension can be permitted from `msg.sender` via [`erc2612Permit()`](#erc2612permit) or [`erc2612PermitDai()`](#erc2612permitdai).
 */
