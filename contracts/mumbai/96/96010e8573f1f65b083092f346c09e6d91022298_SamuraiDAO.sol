...
contract SamuraiDAO is ReentrancyGuard {
    ...
    address public metaverseMarketing;
    ...
    function setDefaultCollection(address _collection) public onlyOwner {
     ...
     function setDefaultAds(address _metaverseMarketing) public onlyOwner {
        metaverseMarketing = _metaverseMarketing;
    }
    ...
    function submitProposal(string memory _title, string memory _proposal) public {
        ...
        proposals[proposalCount] = Proposal(proposalCount, _title, _proposal, msg.sender, 0, 0, new address[](0), new address[](0), true);
    ...
    //Connecting Metaverse Marketing
    function submitAdsProposal(string memory _title, string memory _proposal) public {
        //Require
        require(msg.sender == metaverseMarketing, "You must be AdsContract");
         ++proposalCount;
        require(proposals[proposalCount].status == false);
