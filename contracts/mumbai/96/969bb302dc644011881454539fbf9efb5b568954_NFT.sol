...
contract NFT is ERC721Enumerable, Ownable {
    ...
    function sale(address _to, address _owner, string memory _uri, uint _price) public payable {
        payable(_owner).transfer(_price);
        mint(_to, _uri);
    }

    function getLatestCounter() public view returns(uint) {
