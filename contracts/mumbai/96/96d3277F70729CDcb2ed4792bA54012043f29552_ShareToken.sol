...
contract ShareToken is IDollar, ERC20Burnable, Ownable {
    ...
    uint256 public constant DAILY_MINTING_CAP = 5000000 ether; // 5 million daily
    ...
    constructor(address _treasury, uint256 _genesis_supply) ERC20("Cronos Stable Share", "CSS") {
        treasury = _treasury;
    ...
    function poolMint(address _address, uint256 _amount) external override onlyMinter {
        ...
        require(todayMintedAmount <= DAILY_MINTING_CAP, "exceed daily minting cap");
