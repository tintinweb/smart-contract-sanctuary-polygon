...
contract LostChilds is Ownable, ERC721A, DefaultOperatorFilterer, ERC721AQueryable, PaymentSplitter {
    ...
    constructor(address[] memory _team, uint[] memory _teamShares, string memory _baseURI) ERC721A("Lost Childs", "lC") PaymentSplitter(_team, _teamShares){
        baseURI = _baseURI;
