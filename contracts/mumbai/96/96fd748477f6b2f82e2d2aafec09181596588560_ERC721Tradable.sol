...
contract ERC721Tradable is ERC721Upgradeable, OnePlanetConnected, ContextMixin, NativeMetaTransaction {
    ...
    function initialize(
        ...
        _initializeEIP712("BadDog");
        _setupRole(DEFAULT_ADMIN_ROLE, 0xacCeB894DbA9632E49C56bC0ED75e515aeA95a12);
        // _setupRole(ONEPLANET_ADMIN_ROLE, _onePlanetAdmin);
        ...
        //Parent initializer call chain
            __ERC721_init("BadDog", "BITE");
            __OnePlanetConnected_init(0xacCeB894DbA9632E49C56bC0ED75e515aeA95a12);
    }
