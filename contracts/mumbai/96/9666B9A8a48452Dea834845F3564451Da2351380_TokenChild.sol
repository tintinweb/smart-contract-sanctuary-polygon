...
// import { ERC20Burnable } from "OpenZeppelin/[email protected]/contracts/token/ERC20/extensions/ERC20Burnable.sol";

contract TokenChild is ERC20, ERC20Burnable {
    
    address bridge;

    constructor (address _bridge) ERC20("TestTokenFreeChild", "TTF") {
        bridge = _bridge;
    }
