...
contract MyContract is ERC1155LazyMint {
    ...
    function mintHero(address owner,uint256 _tokenId, uint256 amount) public payable {
        require(msg.sender.balance >= mintRate * amount, "you don't have enough ether to perform this transaction");
        _mint(owner, _tokenId, amount, "");
    }
}