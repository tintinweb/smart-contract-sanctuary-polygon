...
interface IRentalPool {
    ...
    function approveMultipleCollections(address[] calldata collections)
        external;
    ...
    function unapproveMultipleCollections(address[] calldata collections)
        external;
    ...
    function isCollectionApproved(address collection)
        external
        view
