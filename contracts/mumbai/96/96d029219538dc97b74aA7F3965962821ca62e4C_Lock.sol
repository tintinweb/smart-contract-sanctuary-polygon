...
contract Lock is ERC721, OnChainMusicMetadata {
    uint256 songId;
 ...
 *
 */
abstract contract OnChainMusicMetadata {
    ...
    mapping(uint256 => MusicMetadata) public _tokenMetadata; // metadata for each token
        ...
        returns (string memory)
    {
        ...
        string[46] memory values = [
            '"my title"',
            '"my desc"',
            '"ipfs://QmejE2hSTSkDEEfyg4vDfVMd28AyLEQRdhPd4LcacbR4QW"',
            '"my song title"',
            '"sweetman eth"',
            "2846.69",
            "audio/wav",
            '"ipfs://QmdXNSkWHKM8zTeLAwztyvok9c7AU3KCgQAGoeJyeGX6tj"',
            "1",
            "null",
            "[]",
            "null",
            ...
            "null",
            "null",
            '"https://www.npmjs.com/package/onchain-music-metadata"',
            '"ipfs://QmdXNSkWHKM8zTeLAwztyvok9c7AU3KCgQAGoeJyeGX6tj"'
            '"Meet the Mint Songs Team"',
            '"ipfs://QmejE2hSTSkDEEfyg4vDfVMd28AyLEQRdhPd4LcacbR4QW"',
            '"image/png"',
            "null",
            '"my desc"',
            ...
            "null",
            "null",
            '[{"name":"sweetman eth","collaboratorType":"creator"}]',
            '"sweetman eth"',
            "null",
            "null",
            "null",
