    ...
    AccessControlEnumerable
{
    ...
    constructor(address token)
        ERC20Permit("SR_FID")
        ERC20("Fidira Staking Receipt", "SR_FID")
    {
        _fidira = token;
        ...
        returns (uint256 amount)
    {
        ...
        emit Unstaked(liquidity, amount);
    }
    ...
    event Staked(uint256 amountStaked, uint256 stakingReceipts);

    event Unstaked(uint256 stakingReceipts, uint256 amountUnstaked);
...
contract FIDRewardsReserve is Ownable, KeeperCompatibleInterface, Pausable {
    ...
    uint256 public _keeperTimestamp;
    ...
    constructor(
        ...
        _interval = 24 * 60 * 60;
        _keeperTimestamp = block.timestamp;
        _rate = rate;
        _pool = pool;
        _fidira = fidira;
    }
    ...
    {
        upkeepNeeded = (block.timestamp - _keeperTimestamp) >= _interval;
    }
