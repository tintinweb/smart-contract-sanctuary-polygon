...
contract Layer is AccessControl {
    ...
    event ReferrerAdded(address to,address from);
    ...
    //0x3d0B04bB8E8950e7aBFd586a9DB0CC17c97994B3  
    //0xf2f39E886DDf06251dC80BA16E20Fa1657886aaF
    ...
    function transfer(uint amount) external returns (bool result) {
       ...
       emit TranfsferToken(msg.sender,recipient,amount);
        ...
        if(!Details[msg.sender].isUsed){
            //FunderDetail memory f = FunderDetail( 0, 0, true);
