...
contract SVGTicket is ISVGTicket {
  ...
  function _getStaticBody(
    ...
    return
      string(
        abi.encodePacked(
          _getText('300.702', _totalPrice),
          _getText('418.62', _ticketPrice),
  ...
  function _getDynamicBody(
    ...
    return
      string(
        abi.encodePacked(
          _getText('640.601', string(abi.encode(' #', _ticketId))),
          _getText(
            '528.605',
  ...
  function _getBody(
    ...
    return
      string(
        abi.encodePacked(
          _getStaticBody(_raffleId, _ticketPrice, _totalPrice),
          _getDynamicBody(_ticketId, _numberTickets, _maxTickets)
        )
      );
  }
}
