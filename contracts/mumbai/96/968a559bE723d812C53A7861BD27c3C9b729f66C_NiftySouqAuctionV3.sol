...
contract NiftySouqAuctionV3 is Initializable {
    ...
    function _endAuctionWithHighestBid(uint256 offerId_, address creator_)
        internal
        returns (
            uint256 bidIdx_,
            uint256 bidAmount_,
    ...
    function endAuction(uint256 offerId_, uint256 bidIdx_) public {
        ...
        ) = _endAuction(offerId_, msg.sender, bidIdx_);
