...
// import "../ONFT/IONFT721.sol";
import "../ONFT//ONFT721Core.sol";
// import "@openzeppelin/contracts/proxy/transparent/ProxyAdmin.sol";
// import "@openzeppelin/contracts/proxy/transparent/TransparentUpgradeableProxy.sol";

contract ERC721TokenUpgradeable is ONFT721Core,IERC721Mint,ERC721Upgradeable, ERC721EnumerableUpgradeable,ERC721URIStorageUpgradeable,ERC721BurnableUpgradeable {
    ...
    function initialize(string memory name_, string memory symbol_,address owner,address _lzEndpoint) public initializer{
        __ERC721_init(name_, symbol_);
        _transferOwnership(owner);
        __ERC721Enumerable_init();
        __ERC721Burnable_init();
        __ERC721URIStorage_init();
        __ONFT721Core_init( _lzEndpoint);
    ...
    function supportsInterface(bytes4 interfaceId)
        public
        view
        override(ERC721Upgradeable, ERC721EnumerableUpgradeable,ONFT721Core)
        returns (bool)
    {
    ...
    function setMintId(uint256 _nextmintid, uint256 _maxmintid) public onlyOwner{
    ...
    function _send(address _from, uint16 _dstChainId, bytes memory _toAddress, uint _tokenId, address payable _refundAddress, address _zroPaymentAddress, bytes memory _adapterParams) internal virtual override {
        ...
        bytes memory payload = abi.encode(_toAddress, _tokenId, tokenuri);
    ...
    function _creditTo(uint16, address _toAddress, uint _tokenId,string memory _tokenUri) internal virtual  {
        _safeMint(_toAddress, _tokenId);
...
abstract contract ONFT721Core is Initializable, NonblockingLzApp, ERC165, IONFT721Core {

    // constructor(address _lzEndpoint) NonblockingLzApp(_lzEndpoint) {}
      function __ONFT721Core_init(address _lzEndpoint) internal onlyInitializing {
...
abstract contract NonblockingLzApp  is Initializable, LzApp {
    // constructor(address _endpoint) LzApp(_endpoint) {}
      function __NonblockingLzApp_init(address _lzEndpoint) internal onlyInitializing {
...
interface IERC721Mint {
    function initialize(string memory name_, string memory symbol_,address owner,address _lzEndpoint)  external;
