...
// File: contracts/wonderStake/WonderStakeAccessControl.sol
...
// File: contracts/helpers/dataStructures/StakeData.sol
...
// File: contracts/wonderStake/WonderStake.sol
...
contract WonderStake is IERC721Receiver, WonderStakeAccessControl, StakeData {
    ...
    uint256 public stakeLimitInSecs = 0;
    ...
    constructor(
        ...
        raffle = _raffle;
        rewardPeriod = 1 weeks;
    }

    function setRewardPeriod(uint256 _period)
    public
    onlyRole(OWNER_ROLE)
    {
    ...
    function setStakePeriod(uint256 _timeInSeconds) public onlyRole(OWNER_ROLE) {
        stakeLimitInSecs = _timeInSeconds;
    }
    ...
    function onERC721Received(
        ...
        require(
            address(wonderland) == msg.sender,
            "Only accepts Wonder game nfts"
        );
