...
contract DummyVision is ERC20PresetMinterPauser {
    using SafeMath for uint256;

    string private constant NAME = "DVision";
    string private constant SYMBOL = "DVision";
    uint8 private constant DECIMALS = 18;

    // Token amount must be multiplied by this const to reflect decimals
    uint256 private constant E18 = 10 ** DECIMALS;

    uint256 private constant MAX_SUPPLY = 5000000 * E18;
