...
//_____________________________________________________________________________________________________________________________________________________________________________________________
    ...
    function setWinners(uint32 ID_) private {
        ...
        uint length = BlockID[ID_].valuePercantage.length;
        unchecked{
            for (uint i=0;i<length;i++){
                if (ticketsBought>=100)
                    winnersAmount=ticketsBought/100*BlockID[ID_].winnersPercentage[i];
                else                   
                    winnersAmount=(ticketsBought*100*BlockID[ID_].winnersPercentage[i])/10000;    
