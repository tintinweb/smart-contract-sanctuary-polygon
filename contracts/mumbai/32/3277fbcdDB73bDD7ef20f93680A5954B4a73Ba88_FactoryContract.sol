...
contract FactoryContract {
    ...
    event ContractCreated(string campaignId, address indexed campaignOwner, address newContract);
    ...
    function createContract(
        ...
        require(_validateSignature(_signature, _campaignId, _orderId, msg.sender, _backerNftConstructor.transferable), "Invalid signature");
        ...
        emit ContractCreated(_campaignId, msg.sender, address(newContract));
    ...
    function _validateSignature(
        ...
        bytes32 hashValue = keccak256(
            abi.encodePacked(_orderId, _campaignId, _campaignOwner, _transferable)
        );
