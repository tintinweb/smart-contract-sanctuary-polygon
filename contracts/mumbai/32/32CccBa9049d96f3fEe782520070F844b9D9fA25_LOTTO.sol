...
contract LOTTO is VRFConsumerBaseV2, ConfirmedOwner {
    ...
    uint256 betId = 1;
    uint256 public count3Match=0;
    uint256 public count4Match=0;
    uint256 public count5Match=0;
    uint256 public count6Match=0;
    ...
    event ReferralEarningEvent(uint256 referralAmount,address walletAddress,address referral,uint256 time);
    ...
    function _refPayout(address _addr, uint256 _amount) private {
        ...
        for (uint256 i = 0; i < BonusLinesCount; i++) {
            ...
            emit ReferralEarningEvent(sendAmount,_addr,up,block.timestamp);
        }
    }
