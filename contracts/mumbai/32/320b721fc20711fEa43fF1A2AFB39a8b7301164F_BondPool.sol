...
library GovernanceUtilV1 {
  ...
  function getReporter(
    ...
    bytes32 prefix = status == CoverUtilV1.CoverStatus.IncidentHappened ? ProtoUtilV1.NS_GOVERNANCE_REPORTING_WITNESS_YES : ProtoUtilV1.NS_GOVERNANCE_REPORTING_WITNESS_NO;
    ...
    )
  {
    ...
    totalStakeInWinningCamp = status == CoverUtilV1.CoverStatus.IncidentHappened ? yes : no;
    totalStakeInLosingCamp = status == CoverUtilV1.CoverStatus.IncidentHappened ? no : yes;
    myStakeInWinningCamp = status == CoverUtilV1.CoverStatus.IncidentHappened ? myYes : myNo;
  }
