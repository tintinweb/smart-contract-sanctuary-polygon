...
contract GenericTransferProxy is IERC20TransferProxy, INftTransferProxy, Initializable, OperatorRole {

    function __GenericTransferProxy_init() external initializer {
        __Ownable_init();
    }
    ...
    // function erc1155safeBatchTransferFrom(IERC1155Upgradeable token, address from, address to, uint256[] calldata ids, uint256[] calldata values, bytes calldata data) override external onlyOperator {
    //     token.safeBatchTransferFrom(from, to, ids, values, data);
    // }
...
interface INftTransferProxy {
    ...
    // function erc1155safeBatchTransferFrom(IERC1155Upgradeable token, address from, address to, uint256[] calldata ids, uint256[] calldata values, bytes calldata data) external;
}
