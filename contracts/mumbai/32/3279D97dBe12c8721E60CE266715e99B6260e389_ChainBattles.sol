...
contract ChainBattles is ERC721URIStorage {
    ...
    function mint() public {
        ...
        //v1
        tokenIdtoStats[newItemId].levels = randMod(1);
        tokenIdtoStats[newItemId].hp = randMod(20);
        tokenIdtoStats[newItemId].strength = randMod(30);
        tokenIdtoStats[newItemId].speed = randMod(500);
