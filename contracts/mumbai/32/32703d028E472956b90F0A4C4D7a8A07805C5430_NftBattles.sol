    ...
    constructor() ERC721("nft-battles","NFTB" ){
        ...
        function generateCharacter(uint256 tokenId) public returns (string memory){
            ...
            bytes memory svg = abi.encodePacked(
                ...
                '<text x="50%" y="50%" class="base" dominant-baseline="middle" text-anchor="middle">', "Levels: ", getStats(tokenId).level, '</text>',
                '<text x="50%" y="40%" class="base" dominant-baseline="middle" text-anchor="middle">', "Health: ", getStats(tokenId).health, '</text>',
                '<text x="50%" y="50%" class="base" dominant-baseline="middle" text-anchor="middle">', "Strenght: ", getStats(tokenId).strenght, '</text>',
                '<text x="50%" y="50%" class="base" dominant-baseline="middle" text-anchor="middle">', "Defense: ", getStats(tokenId).defense, '</text>',
                '</svg>'
            );
