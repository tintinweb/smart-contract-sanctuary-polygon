...
contract ShavoNFTSaleContract is ERC721Enumerable, Ownable{
    using Strings for uint256;
    ...
    constructor(IERC20 _tokenAddress, uint256 _tokenPrice, uint256 _hardcap, uint256 _cliffTime)
        ERC721("Shavo Music", "SHAVO")
    {
    ...
    function buyNFT() external {
        ...
        require(totalSupply() <= hardcap, "buyNFT: Hardcap reached for NFTs");
    ...
    function claimNFT() external {
        ...
        require(isPurchased[msg.sender] == true, "claimNFT: No NFT purchased");
        ...
        require(block.timestamp > cliffTime, "claimNFT: Can not claim before cliff duration");
            ...
            _safeMint(msg.sender, tokenIdPurchasedByUser[msg.sender]);
    }
    ...
    function withdrawFund(address _owner) external onlyOwner {
        tokenAddress.transferFrom(address(this), _owner, getContractBalance());
    }
