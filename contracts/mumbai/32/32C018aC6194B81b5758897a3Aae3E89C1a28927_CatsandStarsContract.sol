...
abstract contract WithdrawableV2 is Teams {
  ...
  address public erc20Payable = 0x1D2fb75930F37B58673545D27Af1379F66d7074f;
    ...
    , TimedDrop
{
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/DGBnfxmT1pldRfT2vLCD/contract-metadata";
  }
...
// File: contracts/CatsandStarsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CatsandStarsContract is ERC721APlus {
    constructor() ERC721APlus("Cats and Stars", "CAS"){}
}
