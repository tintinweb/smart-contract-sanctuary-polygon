...
//! This should be tested to core
contract ERC1155Base is ERC1155, Ownable, Royalty, BatchMintMetadata {
    using TWStrings for uint256;

    // @dev Token Id => total supply in circulation
