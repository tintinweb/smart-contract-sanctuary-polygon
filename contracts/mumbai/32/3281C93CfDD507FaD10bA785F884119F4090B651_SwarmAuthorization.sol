...
contract SwarmAuthorization is Initializable, AccessControlUpgradeable {
    /// @dev permissionManagerAddress of Swarm Ecosystem
    address public permissionManagerAddress;

    event PermissionAddressChanged(
    ...
    function initialize(address _permissionManagerAddress) public initializer {
    ...
    /// @return true if `account` is authorized
    function isAccountAuthorized(address _account) external view returns (bool) {
        require(permissionManagerAddress != address(0), "Invalid permission address");
    ...
    /**
     * @dev Sets `permissionManagerAddress` as the permission manager from swarm ecosystem
    ...
    function _setPermissionManagerAddress(address _permissionManagerAddress) internal {
        require(_permissionManagerAddress != address(0), "_permissionManagerAddress is zero address");
        emit PermissionAddressChanged(_msgSender(), permissionManagerAddress, _permissionManagerAddress);
