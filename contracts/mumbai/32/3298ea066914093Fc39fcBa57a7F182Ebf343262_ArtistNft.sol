...
contract ArtistNft is ERC721 {
  ...
  //Mapping for excluded list
  mapping(address => bool) public excludedList;

  //When contract will deployed to main or test network by giving artist address, transaction fee address, transaction fee amount in parameters
  constructor() ERC721("HPA" , "HopeAccelerated"){}
  

  //Function for set excluded of nft (only artist can call this function)
  ...
  //Function for safeTransferFrom with data
  function safeTransferFrom(
    address from,
    address to,
    uint256 tokenId,
  ...
  //Function for payTransactionFee
