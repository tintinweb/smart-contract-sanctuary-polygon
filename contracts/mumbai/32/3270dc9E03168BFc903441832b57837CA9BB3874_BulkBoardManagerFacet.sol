...
contract BulkBoardManagerFacet is Modifiers {
    function shuffleEveryBoard() external onlyFounder {
        BigBoardManagerLib.shuffleAll();
    }

    function distributeScoresToEveryBoard() external onlyFounder {
        BigBoardManagerLib.distributeScores();
    }

    function clearAllApprovedBoardz() external onlyFounder {
        BigBoardManagerLib.clearApprovedBoardContracts();
    }

    function selectAllWinnersForEveryBoard() external founderOrHostOnly {
