...
contract TestHounds is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("Test Hounds", "WATH") {
  ...
  {
    return (
      string(abi.encodePacked(super.tokenURI(tokenId), ".token.json\n\n\n\n"))
    );
  }
