    ...
    ERC2981
{
    ...
    constructor() ERC721("MomentsNFT", "MOMENTS") {
    ...
    function toggleTrading() public onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function removeAdmin(address account) public onlyRole(DEFAULT_ADMIN_ROLE) {
        require(_adminCounter.current() > 1, "Must have at least one admin");
        _revokeRole(DEFAULT_ADMIN_ROLE, account);
    }

    function setRoyalty(uint96 bps) public onlyRole(DEFAULT_ADMIN_ROLE) {
        // maintains the original owner, just changes the royalty percentage
        for (
            uint256 tokenId = 0;
    ...
    // Overrides to modify functionality
    ...
    function _transfer(
        ...
        require(
            tradingEnabled || hasRole(DEFAULT_ADMIN_ROLE, msg.sender),
            "Trading disabled"
        );
