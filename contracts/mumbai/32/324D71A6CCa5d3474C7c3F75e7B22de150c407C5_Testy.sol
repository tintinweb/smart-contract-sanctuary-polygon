 ...
 * @notice This contract handles minting testy tokens.
 */
contract Testy is
    ERC1155Supply,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xfbCbAAF6de5aA214B3f4A83C2F84EB6845d5B0f1;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x0a3a8be22356659ac2a222EC57966fbe1dd7d46D;
    address[] public payoutAddresses = [
        0x0a3a8be22356659ac2a222EC57966fbe1dd7d46D
    ];
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeicopiw2qf7rrgly3uooliu7cvnvspkpju4wgv2brjxm23hq3r32g4/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[1] = 300;
        tokenPublicPrice[1] = 0.1 ether;
        tokenPublicMintsPerAddress[1] = 300;
        require(
