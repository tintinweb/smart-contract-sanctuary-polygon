...
contract StatesOfMind is ERC721URIStorage {
    ...
    function generateCharacter(uint256 tokenId) public returns (string memory) {
        ...
        bytes memory svg = abi.encodePacked(
            ...
            "Happy: ", 
            stats.happy.toString(),
            "</text>",
            '<text x="50%" y="50%" class="base" dominant-baseline="middle" text-anchor="middle">',
            "Excited: ",
            stats.excited.toString(),
            "</text>",
            '<text x="50%" y="50%" class="base" dominant-baseline="middle" text-anchor="middle">',
            "Surprised: ",
            stats.surprised.toString(),
            "</text>",
            '<text x="50%" y="50%" class="base" dominant-baseline="middle" text-anchor="middle">',
            "Silly: ",
            stats.silly.toString(),
            "</text>",
            "</svg>"
        );
        return
    ...
    function randomNumGenerator(uint256 randNum) private view returns (uint256) {
        return
            uint256(
                keccak256(
