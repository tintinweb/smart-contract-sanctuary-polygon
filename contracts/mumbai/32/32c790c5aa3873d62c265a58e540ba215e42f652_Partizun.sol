...
contract Partizun is Ownable, ReentrancyGuard, IERC721, IERC721Metadata, IERC721Enumerable {
    using SafeMath for uint256;
    using Strings for uint256;
    using EnumerableSet for EnumerableSet.UintSet;

    string private constant _name = "Partizun";
    string private constant _symbol = "Partizun";
    ...
    uint256[2] private mintingLevelPrices = [2 ether, 3 ether];
    ...
    uint public priceToken = 0.1 ether;
    ...
    function getMintPrice(uint256 amount) public view returns (uint256 price) {
    ...
    function mint(uint256 amount) external payable nonReentrant mintingEnabled {
        require(amount >= 1 && amount <= 20, "amountLimit");
        require((totalMinted + amount) <= MAX_SUPPLY, "exceedsMaxSupply");

        uint256 nftPrice = getMintPrice(amount);
