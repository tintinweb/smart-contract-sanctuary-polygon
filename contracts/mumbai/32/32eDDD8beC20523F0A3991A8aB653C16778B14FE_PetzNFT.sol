...
contract PetzNFT is ERC721, Ownable, Pausable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdCounter;

    uint256 private totalSupplyLimit = 2000;
    ...
    event BurnNFT(address indexed owner, uint256 indexed tokenId);
    event MintNFT(address indexed buyer, uint256 indexed tokenId);

    constructor() ERC721("Petz", "PTZ") {}
    ...
    function mintNFT() external payable {
        require(totalSupplyCount < totalSupplyLimit, "Total supply limit reached.");
    ...
    function burnNFT(uint256 tokenId) external onlyOwner {
        ...
        totalSupplyCount--;
        emit BurnNFT(ownerOf(tokenId), tokenId);
    }
