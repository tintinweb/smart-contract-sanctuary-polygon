...
contract NFTCredential is ERC721URIStorage, Ownable, ConsensusAdminable {
    ...
    function getTokenURI(
        ...
        string memory _name = "Foobar NFT name"; // TODO
        string memory _description = "Foobar NFT description"; // TODO

        bytes memory _attributes = abi.encodePacked(
            '"attributes": [',
            '{"trait_type": "Issuer name", "value": "',
            _issuerName,
            '"},',
            '{"trait_type": "Certificate name", "value": "',
            _certificateName,
            '"}',
            "]"
        );
...
contract ConsensusAdminable is AccessControl {
    ...
    bytes32 public constant UPVOTE_FOR_WITHDRAW =
        keccak256("UPVOTE_FOR_WITHDRAW");
    ...
    function _hasConsensus(address _candidate, bytes32 _role)
        public
        view
        returns (bool)
    {
        return
            votes[_role][_candidate].votes >=
            _numberOfAdmins / PERCENTAGE_OF_CONSENSUS;
    }
    ...
    function addInitialAdmins(
        address[] memory _admins,
        bool givenHighestAuthority
    ) internal {
