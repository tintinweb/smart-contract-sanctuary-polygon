...
import "./polygon/ERC721PolygonChild.sol";

contract ERC721Mumbai is ERC721PolygonChild {
  constructor(string memory name, string memory symbol, address childChainManager) ERC721(name, symbol) ERC721PolygonChild(childChainManager) {
...
abstract contract ERC721PolygonChild is ERC721, ERC721Burnable, AccessControl {
  ...
  function safeMint(address user, uint256 tokenId) public onlyRole(DEFAULT_ADMIN_ROLE) {
    require(!withdrawnTokens[tokenId], "ChildMintableERC721: TOKEN_EXISTS_ON_ROOT_CHAIN");
