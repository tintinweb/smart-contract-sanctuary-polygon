...
contract PolygonCryptoNijigenGirlsExchange is Initializable, OwnableUpgradeable {
    ...
    address public _erc721TokenAddress;

    function initialize() initializer public {
        __Ownable_init();
        _baseMintPrice = 10000000000;
        _erc20TokenAddress = 0x36eE32E83c00266319928e5e355C17501e4AaE12;
        _erc721TokenAddress = 0x290fF7Eb0a22AD8e05Aa367C54E10185A41953aD;
    }
    ...
    function sellCNG(uint256 _tokenId, uint256 _price, uint256 _days) external {
        IERC721Upgradeable NFTContract = IERC721Upgradeable(_erc721TokenAddress);
        require(msg.sender == NFTContract.ownerOf(_tokenId), 'CNGE001');
    ...
    function banCNG(uint256 _tokenId) external {
        IERC721Upgradeable NFTContract = IERC721Upgradeable(_erc721TokenAddress);
        require(msg.sender == NFTContract.ownerOf(_tokenId), 'CNGE001');
        delete sellTokenPrice[_tokenId];
...
//
    function buyCNG(uint256 _tokenId) external {
        ...
        delete sellTokenPrice[_tokenId]; // not for sale anymore
    ...
    function setErc721TokenAddress(address newErc721TokenAddress) public virtual onlyOwner{
        _erc721TokenAddress = newErc721TokenAddress;
    }
