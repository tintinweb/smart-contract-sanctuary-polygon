...
contract RugbabyAPE is ERC721A, Ownable {
    ...
    bytes32 public whitelistMerkleRoot =
        0x63b0c097903292e528b4c781df3887422524e79bda260ce85e6181f80ce6799b;
    ...
    function whitelistMint(
        ...
        require(
            _txPerAddress + _mintAmount <= maxWLMintAmountPerWallet,
    ...
    function withdraw() external onlyOwner {
        ...
        payable(0x741d19947544f8C3A021f5eaBc5E23Bf147cD2b3).transfer(
            (_balance * 50) / 100
        );
        payable(0xEe82CC182663e6D1F839dD967610A571909f4853).transfer(
            (_balance * 50) / 100
        );
    }
