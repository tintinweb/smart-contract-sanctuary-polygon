    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeianlwboekypzfqum44jhmcp6js6lldjw72njf3dd2fdyqj3rb3gxy/";
    string public _baseTokenExtension = ".json";

    bool public mintingOpen = false;
    
    
    uint256 public MAX_WALLET_MINTS = 35;
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/3QRoBpgN8k52SnKyOdco/contract-metadata";
  }
...
// File: contracts/GalileosFoundersContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GalileosFoundersContract is RamppERC721A {
    constructor() RamppERC721A("Galileos Founders", "GALILEO"){}
}
