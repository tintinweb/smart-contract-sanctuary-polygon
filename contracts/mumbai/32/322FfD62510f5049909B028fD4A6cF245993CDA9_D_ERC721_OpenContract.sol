...
contract D_ERC721_OpenContract is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function mint(
        ...
        // Validate input
        require(account_ != address(0), "ERC721: mint to the zero address");
        require(
            bytes(uri_).length != 0,
            "D_ERC721_OpenContract: Uri cannot be empty"
        );

        LibDiamond.ERC721Storage storage ds = LibDiamond
            .diamondStorage()
            .erc721Storage;
    ...
    function changeNFT(
        ...
        require(
            LibDiamond.diamondStorage().erc721Storage.backendTokenKeyToId[
                backendTokenKey_
            ] != 0,
            "D_ERC721_OpenContract: No token exist with this name"
        );
        require(bytes(uri_).length != 0, "D_ERC721_OpenContract: URI is empty");
        uint256 tokenId = LibDiamond
            .diamondStorage()
            .erc721Storage
            .backendTokenKeyToId[backendTokenKey_];
        require(_exists(tokenId), "D_ERC721_OpenContract: Token nonexistent");
        LibDiamond.diamondStorage().erc721Storage.tokens[tokenId].uri = uri_;
    ...
    function tokenURI(
        ...
        return LibDiamond.diamondStorage().erc721Storage.tokens[tokenId_].uri;
    }
    ...
    function getTokenData(
        ...
        LibDiamond.Token storage tokenStorage = LibDiamond
            .diamondStorage()
            .erc721Storage
            .tokens[tokenId_];
        LibDiamond.Token memory tokenMemory = LibDiamond.Token({
            uri: tokenStorage.uri
        });
        return tokenMemory;
    }
    ...
    function getTokenKeyList() external view returns (string[] memory) {
        return LibDiamond.diamondStorage().erc721Storage.keyFallback;
    }
    ...
    function contractURI() external view returns (string memory) {
        return LibDiamond.diamondStorage().erc721Storage.contractUri;
    }
    ...
    function balanceOf(
        ...
        return LibDiamond.diamondStorage().erc721Storage.balances[owner];
    }
    ...
    function name() public view virtual override returns (string memory) {
        return LibDiamond.diamondStorage().erc721Storage.name;
    }
    ...
    function symbol() public view virtual override returns (string memory) {
        return LibDiamond.diamondStorage().erc721Storage.symbol;
    }
    ...
    function getApproved(
        ...
        return
            LibDiamond.diamondStorage().erc721Storage.tokenApprovals[tokenId];
    }
    ...
    function isApprovedForAll(
        ...
        return
            LibDiamond.diamondStorage().erc721Storage.operatorApprovals[owner][
                operator
            ];
    }
    ...
    function _ownerOf(uint256 tokenId) internal view virtual returns (address) {
        return LibDiamond.diamondStorage().erc721Storage.owners[tokenId];
    }
    ...
    function _mint(address to, uint256 tokenId) internal virtual {
        ...
        unchecked {
            ...
            LibDiamond.diamondStorage().erc721Storage.balances[to] += 1;
        }

        LibDiamond.diamondStorage().erc721Storage.owners[tokenId] = to;
    ...
    function _burn(uint256 tokenId) internal virtual {
        ...
        // Clear approvals
        delete LibDiamond.diamondStorage().erc721Storage.tokenApprovals[
            tokenId
        ];
        ...
        unchecked {
            ...
            LibDiamond.diamondStorage().erc721Storage.balances[owner] -= 1;
        }
        delete LibDiamond.diamondStorage().erc721Storage.owners[tokenId];
    ...
    function _transfer(
        ...
        unchecked {
            ...
            LibDiamond.diamondStorage().erc721Storage.balances[from] -= 1;
            LibDiamond.diamondStorage().erc721Storage.balances[to] += 1;
        }
        LibDiamond.diamondStorage().erc721Storage.owners[tokenId] = to;
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        LibDiamond.diamondStorage().erc721Storage.tokenApprovals[tokenId] = to;
    ...
    function __unsafe_increaseBalance(
        ...
        LibDiamond.diamondStorage().erc721Storage.balances[account] += amount;
    }
}
