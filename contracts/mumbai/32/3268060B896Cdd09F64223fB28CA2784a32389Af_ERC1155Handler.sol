...
contract ERC1155Handler is IDepositExecute, HandlerHelpers, ERC1155Safe, ERC1155Holder {
    ...
    */
    ...
    function executeProposal(bytes32 resourceID, bytes calldata data) external override onlyBridge {
        emit DebugEvent1(resourceID, data);
        uint256         tokenID;
        uint256         amount;
        bytes  memory   destinationRecipientAddress;
        bytes  memory   metaData;
        ...
        emit DebugEvent2(tokenAddress, tokenID, amount, metaData);
        emit DebugEvent3(_burnList[tokenAddress], address(this), address(recipientAddress), destinationRecipientAddress);
