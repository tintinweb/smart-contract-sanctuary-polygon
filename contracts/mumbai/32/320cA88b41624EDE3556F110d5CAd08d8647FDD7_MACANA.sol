...
// File: contract-bf5e889e9d_flat.sol
...
contract MACANA is ERC20, ERC20Burnable, Pausable, Ownable {
    constructor() ERC20("MACANA", "MCN") {
        _mint(msg.sender, 5500 * 10 ** decimals());
    }
