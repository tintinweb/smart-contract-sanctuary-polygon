...
contract NebulaDropsCollectible is ERC1155, Ownable {
    ...
    function mint(uint256 _id, uint256 _amount, address _nebulaMarketplace, bool _cardpay) 
        public  payable  
     {
    ...
    function mintBatch(uint256[] memory _ids, uint256[] memory _amounts, address _nebulaMarketplace, bool _cardpay) 
        public payable
    {
        // string memory _name, string memory _newuri, 
        ApprovedArtists4Minting memory _approvedArtist =   allowArtistToMintTokens[msg.sender];
