...
contract PlatformFee_Covest is Initializable, UUPSUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function withdraw(address _asset, uint256 _value) public nonReentrant isSuperManager checkAsset(_asset) {
        IERC20 _ERC20 = IERC20(_asset);
        require(_ERC20.balanceOf(address(this)) >= _value,"Balance of Contract Not Enough.");
        ...
        emit Withdraw(_asset,msg.sender,_value,valueOfPF[_asset]);
    }
