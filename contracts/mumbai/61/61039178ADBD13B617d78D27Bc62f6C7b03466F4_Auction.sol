...
contract Auction is Initializable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    event AuctionFromVoucherCreated(address nftAddress, uint256 tokenId, string internalRef);
    ...
    function createAuctionAndBidWithVoucher(
        ...
        if(_voucher.deployAndMint){    
            ...
            emit AuctionFromVoucherCreated(_nftAddress, _tokenId, _internalRef);
            _createAuction(_nftAddress, _tokenId, _payToken, _reservePrice, _startTimestamp, _minBidReserve, _endTimestamp);
            ...
            if (_voucher.isMultiToken) {
                require(
                    ...
                    "Auction: Contract should have been deployed by this application"
                );
            ...
            emit AuctionFromVoucherCreated(_voucher.existingAddress, _tokenId, _internalRef);
            _createAuction(_voucher.existingAddress, _tokenId, _payToken, _reservePrice, _startTimestamp, _minBidReserve, _endTimestamp);

            _placeBid(_voucher.existingAddress, _tokenId, _bidAmount);
        }
    }
