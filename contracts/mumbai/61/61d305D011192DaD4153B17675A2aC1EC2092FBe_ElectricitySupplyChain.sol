...
contract ElectricitySupplyChain {
  ...
  event UpdateUnitsConsumedRan(uint256 timeestamp);
    ...
    mapping(uint256 => mapping(uint256 => uint256)) public powerPlantsDailyEnergyProducedById;
    mapping(uint256 => mapping(uint256 => uint256)) public powerPlantsDailyEnergySoldById;
    ...
    mapping(uint256 => mapping(uint256 => uint256)) public distributorsDailyEnergyBoughtById;
    mapping(uint256 => mapping(uint256 => uint256)) public distributorsDailyEnergySoldById;

    mapping(uint256 => Substation) public substations;
    mapping(address => uint256) public substationsAddressToIds;

    mapping(uint256 => mapping(uint256 => uint256)) public substationsDailyEnergyBoughtById;
    mapping(uint256 => mapping(uint256 => uint256)) public substationsDailyEnergySoldById;

    mapping(uint256 => Consumer) public consumers;
    mapping(address => uint256) public consumersAddressToIds;

     mapping(uint256 => mapping(uint256 => uint256)) public consumersDailyEnergyBoughtById;
    ...
    function calculateEnergyConsumptionOfEachConsumer() public {
        ...
        for (uint i = 0; i < distributorArray.length; i++) {
            ...
            for (uint j = 0; j < distributor.consumerIds.length; j++) {
                ...
                consumersDailyEnergyBoughtById[distributor.consumerIds[j]][today]++;
            ...
            distributorsDailyEnergySoldById[distributorArray[i]][today]+=totalEnergyConsumedByConsumersOfADistributor;
            // if (
            //     totalEnergyConsumedByConsumersOfADistributor >
            //     distributor.energyAvailable
            // ) {
        ...
        emit UpdateUnitsConsumedRan(block.timestamp);
    }
    ...
    function connectConsumerToDistributor(
        ...
        // require(consumer.isEnergyPaid,"Please pay the energy used first");
    ...
    function getUnitsConsumedByConsumer() public view returns (uint256) {
        return (block.timestamp -
            consumers[consumersAddressToIds[msg.sender]].startCycleTime);
    }
