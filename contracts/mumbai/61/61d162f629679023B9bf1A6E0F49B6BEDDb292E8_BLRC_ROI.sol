...
contract BLRC_ROI {
    ...
    uint256 public nextResultIn = block.timestamp.add(10 minutes);
    uint256 public TIME_STEP_FOR_TOP_REFERRER = 10 minutes;
                ...
                if (upline != address(0)) {
                    ...
                    if(i>0){
                        ...
                        users[upline].refEarningsLevel[i] = users[upline]
                            .refEarningsLevel[i]
                            .add(amount);
                        users[upline].refEarning = users[upline].refEarning.add(amount);
