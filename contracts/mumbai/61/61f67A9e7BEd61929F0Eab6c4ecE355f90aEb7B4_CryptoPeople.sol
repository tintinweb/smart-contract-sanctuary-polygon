    ...
    AccessControlUpgradeable
{
    ...
    function buyNFT(uint256 tokenId) public payable {
        ...
        (bool sent, bytes memory data) = payable(_listings[tokenId].seller).call{value: price - royaltyAmount}("");
        require(sent, "Failed to send Ether to seller");

        (sent, data) = payable(_royaltiesCollector).call{value: royaltyAmount}("");
        require(sent, "Failed to send Ether to royalties collector");
