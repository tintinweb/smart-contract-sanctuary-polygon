...
contract ChainBattles is ERC721, ERC721URIStorage {
    ...
    function tokenURI(uint256 tokenId) public view override(ERC721, ERC721URIStorage) returns(string memory) {
        bytes memory dataURI = abi.encodePacked(
            '{"name":"aligator","description":"","image":"ipfs://QmZzs9VDnSyxS1QXCpcbdf2w5jfh58C5X3LdrnkbJPAufX/PFP.png","external_url":"","background_color":""}'
            /*"{",
                '"name": "Chain Battles #', tokenId.toString(), '",',
                '"description": "Battles on chain",',
                //'"image": "', generateCharacter(tokenId), '"',
                '"image": "ipfs://QmZzs9VDnSyxS1QXCpcbdf2w5jfh58C5X3LdrnkbJPAufX/PFP.png"',
            "}"*/
        );
        return string(
            abi.encodePacked(
