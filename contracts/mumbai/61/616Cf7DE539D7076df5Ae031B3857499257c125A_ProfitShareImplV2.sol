...
contract ProfitShareImplV2 is ERC4907ProfitShareUpgradeable, AccessControlUpgradeable {
    ...
    function mintV2(address to_, uint256 id_) public onlyRole(DEFAULT_ADMIN_ROLE) returns (uint256) {
        _mint(to_, id_);
        return id_;
    }

    function burnV2(uint256 id_) public onlyRole(DEFAULT_ADMIN_ROLE) {
        _burn(id_);
    }
