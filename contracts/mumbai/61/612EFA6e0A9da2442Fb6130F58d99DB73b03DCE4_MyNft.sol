...
contract MyNft is ERC721, Ownable, ERC2981 {
    ...
    address[] public withdrawAddresses = [0xD08Fcabb23FB46464d05C3c84805F1293702f36D, 0x60f141c4fE03505E6c29e7eAA8603815Cd008271];
    uint256[] public withdrawPercentages = [30, 70];


    bytes32 public merkleRoot = 0;

    constructor() ERC721("Enid-a", "ee") {
        _baseTokenURI = "https://test-nft-tool-gateway-api.tuoluo.net/generator-server/api/contract/v1/1602505766900920322/metadata/";
        _setDefaultRoyalty(0x60f141c4fE03505E6c29e7eAA8603815Cd008271, uint96(900));
    }
