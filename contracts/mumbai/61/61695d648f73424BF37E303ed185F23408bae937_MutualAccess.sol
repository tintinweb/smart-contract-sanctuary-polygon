    ...
    IERC2981
{
    ...
    uint256 private _anticDefaultPrimaryFeesPercent; // Global fee that Multeez collects from primary sale
    uint256 private _anticDefaultSecondaryFeesPercent; // Global fee that Multeez collects from secondary sale
    address private _antic; // Supervise the contract
    ...
    function addNewContent(
        ...
        content[newContentId].contentOwnerAddress = contentCreator;
