...
// File: contracts/key1.sol

pragma solidity ^0.7.0;


contract XStake {
    function isStaked(address) public view returns (bool) {}
}

contract Key is ERC721, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    XStake staker;

    constructor() ERC721("meka_key_001", "mkey001") {}

    function setStaker(address _staker) public onlyOwner {
        staker = XStake(_staker);
    }

    function mint(address receiver) external onlyOwner returns (uint256) {
        require(balanceOf(receiver) == 0, "You already have a key!");
        require(!staker.isStaked(receiver), "You already have a key!");
    ...
    function _baseURI() internal view virtual returns (string memory) {
        return "https://ipfs.io/ipfs/QmTBH9W3vExugMUSXL4JzFjUnLWYVykq2E5z8hgXzxZGcP";
    }
