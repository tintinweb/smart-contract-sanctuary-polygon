...
contract Token1 is ERC721Enumerable, Ownable {
    ...
    function checkLevelForAddress(address _userAddress)
        public
        view
        returns (uint256)
    {
        return (addressTolevelMapping[_userAddress]);
    }

    function upgradeLevelforAddress(address _userAddress) public {
        addressTolevelMapping[_userAddress] += 100;
    }
    ...
    function checktoUpgrade() public view returns (bool) {
        return true;
    }
