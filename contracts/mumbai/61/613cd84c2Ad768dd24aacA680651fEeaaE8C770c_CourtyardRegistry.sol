...
/**
 * @title The registry contract for the Courtyard NFTs.
 * 
 * Minting Courtyard NFT cannot be achieved by interacting with this contract. Instead, minter contracts are granted a
 * {MINTER_ROLE} role, which allows them to mint new tokens on behalf of collectors when new assets are released.
 * 
 * @dev This system acts as a gate keeper to ensure the security around minting operations, as well as gives Courtyard
...
ERC721EnumerableUpgradeable
{
    ...
    function initialize(address admin) public initializer {
        ERC721Upgradeable.__ERC721_init("Courtyard NFT", "COURTYARD");
    ...
    function _baseURI() internal view virtual override returns (string memory) {
        return "https://staging.pndo.xyz/v0/api/content/crt";
    }
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        require(_exists(tokenId), "CourtyardRegistry: Nonexistent token.");
        return string(abi.encodePacked(_baseURI(), "/", _tokenIdToProofOfIntegrityAsHexString(tokenId)));
    }
