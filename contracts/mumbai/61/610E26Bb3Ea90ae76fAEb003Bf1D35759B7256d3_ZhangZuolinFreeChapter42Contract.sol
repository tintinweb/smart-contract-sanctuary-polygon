    ...
    
{
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/GLAbgdmFrLDMscJicwmU/contract-metadata";
  }
...
// File: contracts/ZhangZuolinFreeChapter42Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ZhangZuolinFreeChapter42Contract is RamppERC721A {
    constructor() RamppERC721A("Zhang Zuolin Free Chapter 42", "zzlfc"){}
}