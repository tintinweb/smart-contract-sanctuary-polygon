...
contract KRWN is ERC721r, Ownable, ReentrancyGuard {
  ...
  function upgradePlatinumBundle() public payable nonReentrant{
    uint256 supply = totalSupply();
    require(supply+10 <= maxSupply, "All tokens are minted");
    ...
    _mint(msg.sender, reservedTokensPlatinum[platinumUpgradeCounter]);
    _withdraw();
  ...
  function upgradeDiamondBundle() public payable nonReentrant{
    ...
    _mint(msg.sender, reservedTokensDiamond[diamondUpgradeCounter]);
    _withdraw();
