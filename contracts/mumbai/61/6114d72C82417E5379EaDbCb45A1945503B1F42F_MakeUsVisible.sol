...
Visit https://events.pollinate.co/ for project details.
...
contract MakeUsVisible is ERC1155, Ownable, ERC1155Burnable {
    ...
    "https://gateway.pinata.cloud/ipfs/QmTKcND4oodap7jDxAJmUszALzsL5EX835wkhAHubvcknv";
...
//enough eth sent && public sale active &&  mint per transaction 
        ...
        payable
    {
        ...
        require(msg.value >= salePrice.mul(amount), "Not enough ETH sent");
