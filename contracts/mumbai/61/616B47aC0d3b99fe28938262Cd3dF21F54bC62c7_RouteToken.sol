...
/**
 * @title Route Token
 * @dev Route ERC20 Token
 */
contract RouteToken is ERC20Permit, Ownable {
    uint256 public constant MAX_CAP = 20 * (10**6) * (10**18); // 20 million
    ...
    constructor() ERC20("RouteToken", "Route") {
     ...
     * Owner is assumed to be governance or Route trusted party for helping users
