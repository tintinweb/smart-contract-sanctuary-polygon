...
contract Webston {
    ...
    function deposit(address _refferel, uint256 _dai) public  {
        ...
        require(players[_refferel].b3Entry[0] > 0, "Sponsor Address not registered");
    ...
    function _setb14self(uint256 poolNo,address _referral,address _addr,uint256 _amount) private{
        ...
        if(players[_referral].b14_level[poolNo][0]<2){
            ...
            address _ref1=players[_referral].b14_lr[poolNo][0];
            address _ref2=players[_referral].b14_lr[poolNo][1];
            // 1st ref
            if(players[_ref1].b14_level[poolNo][0]<2){
                if(players[_ref1].b14_level[poolNo][0]==0){
                    players[_ref1].b14_lr[poolNo][0]=_addr;
                }else if(players[_ref1].b14_level[poolNo][0]==1){
                    players[_ref1].b14_lr[poolNo][1]=_addr;
                }
                _parent = _ref1;
            }else if(players[_ref2].b14_level[poolNo][0]<2){
                // 2nd ref
                if(players[_ref2].b14_level[poolNo][0]==0){
                    players[_ref2].b14_lr[poolNo][0]=_addr;
                }else if(players[_ref2].b14_level[poolNo][0]==1){
                    players[_ref2].b14_lr[poolNo][1]=_addr;
                }
                _parent = _ref2;
            }else if(players[_ref1].b14_level[poolNo][0]>=2 && players[_ref2].b14_level[poolNo][0]>=2){
                _ref21=players[_ref1].b14_lr[poolNo][0];
                _ref22=players[_ref1].b14_lr[poolNo][1];
                _ref23=players[_ref2].b14_lr[poolNo][0];
                _ref24=players[_ref2].b14_lr[poolNo][1];

                if(players[_ref21].b14_level[poolNo][0]<2){
                    if(players[_ref21].b14_level[poolNo][0]==0){
                        players[_ref21].b14_lr[poolNo][0]=_addr;
                    }else if(players[_ref21].b14_level[poolNo][0]==1){
                        players[_ref21].b14_lr[poolNo][1]=_addr;
                    }
                    _parent = _ref21;
                }else if(players[_ref22].b14_level[poolNo][0]<2){
                    // 2nd ref
                    if(players[_ref22].b14_level[poolNo][0]==0){
                        players[_ref22].b14_lr[poolNo][0]=_addr;
                    }else if(players[_ref22].b14_level[poolNo][0]==1){
                        players[_ref22].b14_lr[poolNo][1]=_addr;
                    }
                    _parent = _ref22;
                }else if(players[_ref23].b14_level[poolNo][0]<2){
                        if(players[_ref23].b14_level[poolNo][0]==0){
                            players[_ref23].b14_lr[poolNo][0]=_addr;
                        }else if(players[_ref23].b14_level[poolNo][0]==1){
                            players[_ref23].b14_lr[poolNo][1]=_addr;
                        }
                        _parent = _ref23;
                }else if(players[_ref24].b14_level[poolNo][0]<2){
                    // 2nd ref
                    if(players[_ref24].b14_level[poolNo][0]==0){
                        players[_ref24].b14_lr[poolNo][0]=_addr;
                    }else if(players[_ref24].b14_level[poolNo][0]==1){
                        players[_ref24].b14_lr[poolNo][1]=_addr;
                    }
                    _parent = _ref24;
                }else{ 
                    _ref1=players[_ref1].b14_lr[poolNo][0];
                    while(players[_ref1].b14_lr[poolNo][0] != address(0)){
                        if(players[_ref1].b14_level[poolNo][0]<2){
                            _parent=players[_ref1].b14_lr[poolNo][0];
                            break;
                        }else{
                            _ref1=players[_ref1].b14_lr[poolNo][0];
                        }
    ...
    function b14TeamAddress(address _addr,uint8 pool) view external returns(address[2] memory p) {
        for(uint8 i=0;i<2;i++){
