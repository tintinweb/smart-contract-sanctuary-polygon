...
contract COEOpenPacks is ReentrancyGuard {
  ...
  function openPack(uint256 _packId) public nonReentrant {
    require(packs[_packId].exists, "Pack does not exist");

    IPack(packAddress).burn(msg.sender, _packId, 1);
    console.log("burned pack");
