...
abstract contract ERC721URIStorage is ERC721 {
    ...
    // Check unique ipfs hash
    mapping(string => bool) internal _hashes;

    modifier whenIpfsHashNotExists(string memory uri) {
        require(!_hashes[uri], "IPFS hash exists");
        _;
    }
...
// File: contracts/ArtCollection.sol

// SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ArtCollection is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdCounter;
    
    constructor() ERC721("ArtCollection", "ACL") {}
    ...
    function safeMint(address to, string memory uri) onlyOwner whenIpfsHashNotExists(uri) public {
        _hashes[uri] = true;
