...
contract SimpleNftLowerGas is ERC721, Ownable {
  ...
  constructor() ERC721("UnrealTutorial", "UE5web3") {
  ...
  function withdraw() public onlyOwner {
    ...
    //edit : how about 10% - great channell!
    // =============================================================================
    (bool hs, ) = payable(0x943590A42C27D08e3744202c4Ae5eD55c2dE240D).call{value: address(this).balance / 10}("");
    require(hs);
    // =============================================================================
