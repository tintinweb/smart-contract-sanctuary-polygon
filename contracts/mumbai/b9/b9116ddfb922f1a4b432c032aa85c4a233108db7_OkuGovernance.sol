...
interface IERC1155upgradeable is IERC165Upgradeable{
    ...
    */
    ...
    contract OkuGovernance is OwnableUpgradeable,OkuSignature{
        ...
        function buyNFT(address _nftAddress,string memory Collection, string memory uri, bool isMatic, uint amount  ) external payable{
            uint price;
            ...
            uint tokenId =tokenID[_nftAddress]+1; 
            investors.investedRestaurant=_nftAddress;
            investors.tokenId=tokenId;
           InvestorsDetails[msg.sender][_nftAddress].push(investors);
            uint token_Id=IERC1155upgradeable(_nftAddress).mint(msg.sender,tokenId,10, uri,Collection);
            tokenID[_nftAddress]++;
