    ...
    IN3XClone 
{
    ...
    function initialize(string memory name_, string memory symbol_, address owner_, string memory baseTokenURI_) initializer public {
    ...
    */
        ...
        whenNotPaused
    {
        ...
        unchecked {
            ...
            require(newTokenId < _maxTotalSupply || _maxTotalSupply == 0, "Maximum supply reached");
