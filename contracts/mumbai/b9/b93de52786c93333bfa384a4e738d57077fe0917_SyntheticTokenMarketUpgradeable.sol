...
contract SyntheticTokenMarketUpgradeable is
  ISyntheticTokenMarketUpgradeable,
  ERC20Upgradeable,
  ...
  */
  function _beforeTokenTransfer(
    ...
    if (sender != market && sender != address(0)) {
      // TODO: this currently settles all the markets tokens, could work out a way to optimize it.
      //       ie call _executePoolOutstandingUserMints and _executePoolOutstandingUserRedeems on the specific pools rather than all pools.
      IMarketTieredLeverage(market).executeOutstandingNextPriceSettlementsUser(sender);
    }
