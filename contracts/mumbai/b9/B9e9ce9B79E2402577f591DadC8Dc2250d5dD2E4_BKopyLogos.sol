...
contract BKopyLogos is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    string public projectName  = "BKopy Logos";
    string public BKContractName = "BKopyLogos V0.0.1";
    ...
    constructor(uint32 editionLimit_) ERC721("BKopyLogos", "BKL") {
    ...
    string private constant uri = "https://us-central1-bkopy-63ecf.cloudfunctions.net/getBKopyLogosMeta?id=";
