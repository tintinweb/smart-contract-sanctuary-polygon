...
contract NFT is IIdleKey, ERC721Enumerable, ChildMintableERC721
{
    ...
    constructor(address deployedMarketplaceAddress) ChildMintableERC721("Vina", "VN") {
    ...
    function createToken(address to, string memory _tokenURI) public onlyMinter override returns (uint256) {
...
interface IIdleKey {
    ...
    function createToken(address to, string memory tokenURI) external returns (uint256);
