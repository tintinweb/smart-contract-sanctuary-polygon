...
contract Arbitrager {
    ...
    IUniswapV2Router02 immutable qRouter;

    constructor(address _sFactory, address _qRouter) public {
        sFactory = _sFactory;
    ...
    function uniswapV2Call(
        ...
        if (_amount0 == 0) {
            ...
            entryToken.approve(address(qRouter), amountEntryToken);
            path[0] = token1;
            path[1] = token0;
            uint256 amountReceived = qRouter.swapExactTokensForTokens(
                amountEntryToken,
                0,
                path,
                address(this),
