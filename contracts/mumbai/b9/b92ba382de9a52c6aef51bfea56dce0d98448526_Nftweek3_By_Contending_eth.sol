...
contract Nftweek3_By_Contending_eth is ERC721URIStorage  {
    using Strings for uint256;
    using Counters for Counters.Counter;
    Counters.Counter private tokenIds;

    string showText = "Nftweek3 By Contending.eth";
    string nftname = "Nftweek3 By Contending.eth";
    string des = "Nftweek3 By Contending.eth";
