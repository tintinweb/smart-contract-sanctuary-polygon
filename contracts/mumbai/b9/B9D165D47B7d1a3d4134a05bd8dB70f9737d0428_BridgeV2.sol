...
contract BridgeV2 is Initializable, AdminableUpgradeable {
    ...
    function receiveMessage(
        ...
        _octopool.safeTransferFrom(_from, address(this), _tokenID, _amount, "");
        _octopool.withdraw(_tokenID, _amount, 0, address(this), type(uint256).max);
        (bool success, bytes memory data) = _metarouter.call(_metaRouteCalldata);
