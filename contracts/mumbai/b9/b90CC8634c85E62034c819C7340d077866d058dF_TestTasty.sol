...
contract TestTasty is ERC721A, Ownable {
    ...
    uint256 public preMintPrice = 0.01 ether;
    ...
    address public teamWallet = 0x7AB2eb7D4e86512E04FD54135EFE39E496D28dC8;

    constructor() ERC721A ("TestTasty", "TT") {
    ...
    function teamMint() onlyOwner external {
        ...
        require(totalSupply() + teamSupply <= supply, "You can't mint more than the total supply");
    ...
    function getMintNFTPerAddressMax() public view returns (uint256) {
        ...
        if(!revealed) {
            ...
            return presaleMaxNFTPerWallet;
        }

        return publicSaleMaxNFTPerWallet;
    }
