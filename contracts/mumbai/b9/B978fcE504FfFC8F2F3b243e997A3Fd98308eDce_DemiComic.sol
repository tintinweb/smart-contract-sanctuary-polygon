...
╰━━━┻━━┻┻┻┻┻━━━┻━━┻┻┻┻┻━━╯
    ...
    DemiVerse Studio - DemiHumanNFTs / 2022 
*/
...
contract DemiComic is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor( uint256 maxAmountPerMint, uint256 maxCollection ) 
        ERC721A("DemiComic", "DEMI", maxAmountPerMint, maxCollection) 
            { }

    function withdraw() external onlyOwner {
        uint256 _balance = address(this).balance;
        require(payable(s1).send(_balance), "Send Failed");
    }
    ...
    function mintDemiComic(uint256 _amount, address to) private {
