...
contract EtheremonWorldNFT is BasicAccessControl, NativeMetaTransaction {
    ...
    uint32 public maxClassDiff = 1299;
    uint8 public constant STAT_MAX = 42;
    IERC20 public weth;
    IERC20 public emon;
    ...
    function setMaxClassDiff(uint32 _maxClassDiff) external onlyModerators {
        maxClassDiff = _maxClassDiff;
    }
    ...
    function setStatMaxClass(uint32 _classId, uint256 _statMax)
        external
        onlyModerators
    {
    ...
    function mintMonster(
        ...
        uint256 maxStat = (_classId > maxClassDiff)
