...
contract ArmorySale is Initializable, AccessControlUpgradeable, PausableUpgradeable {
        ...
        oncePerBlock(msg.sender)
    {
        ...
        uint256 sellPrice = (bundle.price.mul(10**18)).div(tagPriceInUSD);
