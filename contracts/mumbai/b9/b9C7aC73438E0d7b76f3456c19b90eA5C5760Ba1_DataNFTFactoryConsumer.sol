    ...
    Ownable
{
    ...
    string public ipfsGateway = "https://data.mcs.lagrangedao.org/";
    ...
    function requestDataNFT(string memory datasetName) public returns (bytes32 requestId) {
        ...
        string memory requestUrl = concat('{\"url\":\"', concat(urlWithDataset, 'generate_metadata\", \"method\":\"POST\"'));

        req.add("requestData", requestUrl);
    ...
    function setGateway(string memory url) public onlyOwner {
        ipfsGateway = url;
    }
