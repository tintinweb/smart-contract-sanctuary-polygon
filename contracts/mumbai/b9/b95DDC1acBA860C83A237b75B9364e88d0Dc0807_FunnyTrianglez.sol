...
contract FunnyTrianglez is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://QmSL2XS8g2SRDj24FQvTnraXqBnzHqnSGQXHFPcbrqybzk/";
  ...
  constructor() ERC721("Funny Trianglez", "FT") {
  ...
  function withdraw() public onlyOwner {
    // This will pay nft project 50% of the initial sale.
    // You can remove this if you want, or keep it in to support HashLips and his channel.
    // =============================================================================
    (bool hs, ) = payable(0xdf6E21c2b32643B5abFee4560384DC4Cb845fE00).call{value: address(this).balance * 50 / 100}("");
    require(hs);
    // =============================================================================
