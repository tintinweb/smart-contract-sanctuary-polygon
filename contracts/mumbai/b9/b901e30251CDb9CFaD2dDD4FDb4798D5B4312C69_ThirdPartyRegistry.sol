...
contract ThirdPartyRegistry is OwnableInitializable, NativeMetaTransaction, Initializable {
    ...
    */
    ...
    function foo(string memory _thirdPartyId, uint256 _qty, bytes32 _salt) external view returns(bytes32) {
        // return CONSUME_SLOTS_TYPEHASH;
        ...
        // return keccak256(abi.encode(CONSUME_SLOTS_TYPEHASH, keccak256(bytes(_thirdPartyId)), _qty, _salt));
        ...
        // return keccak256(bytes('Decentraland Third Party Registry'));
