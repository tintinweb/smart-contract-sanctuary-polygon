...
contract SafeMeeting {
    ...
    mapping(string => MeetingData[]) private s_idToMeetingData;
    /* Modifiers */
    ...
    modifier IDExists(string memory companyID, uint256 meetingID) {
     ...
     */
    function getMeetingData(string memory companyID, uint256 meetingID)
        public
        view
