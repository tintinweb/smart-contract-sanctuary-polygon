...
contract Gorpe is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Gorpe", "GP") {
    setHiddenMetadataUri("ipfs://QmPusCXJeCiz3M4gqFwmuSAPemFd2fUp8XfcJedXi8NsRp/hidden.json");
  }
