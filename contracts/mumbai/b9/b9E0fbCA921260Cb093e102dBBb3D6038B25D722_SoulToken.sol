...
contract SoulToken is ERC721, ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("LN Token", "LTK") {}

    function give(address to, string memory uri) public onlyOwner {
    ...
    function _setApprovalForAll(
        ...
        require(owner == address(0), "Err:  Token Approval is blocked!");
