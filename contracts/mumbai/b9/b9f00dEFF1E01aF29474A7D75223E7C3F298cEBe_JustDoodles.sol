...
contract JustDoodles is Ownable, ERC721, NonblockingReceiver {
    ...
    constructor(uint256 price, string memory baseURI_, address _layerZeroEndpoint) ERC721("JustDoodles", "JDoodles") { 
        PRICE = price;
        _owner = msg.sender;
