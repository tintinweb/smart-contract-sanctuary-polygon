...
contract DemoWorkflow {
    ...
    AddLiquidityWorkflow[] public addLiquidityWorkflows;
    RemoveLiquidityWorkflow[] public removeLiquidityWorkflows;
    ...
    function _lookupLimitOrder() private {
    ...
    function _lookupAddLiquidity() private {
    ...
    function _lookupRemoveLiquidity() private {
        for(uint256 i = 0; i < limitOrderWorkflows.length;) {
    ...
    function approveRemoveLiquidityToProtocol(address _pair) external {
        uint liquidity = IERC20(_pair).balanceOf(msg.sender);
    ...
    function _removeLiquidity(
        ...
        uint256 amount = IERC20(_pair).balanceOf(_owner);
        require(amount != 0, "Workflow: has no balance");
        IERC20(_pair).transferFrom(_owner, address(this), amount);
