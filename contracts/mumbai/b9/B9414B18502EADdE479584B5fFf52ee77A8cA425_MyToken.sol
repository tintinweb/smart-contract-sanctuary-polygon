...
contract MyToken is ERC721, Pausable, Ownable {
    ...
    constructor() ERC721("TreeTest5", "TTF") {}

    string _contractURI = "https://ipfs.io/ipfs/QmQuKv5HgcEQaRhmGSWVS1nZrKivjL4PToBXCEgfGMLMLX?filename=first-test-collection.json";
