...
contract Contests {
   ...
   address constant fund_Address = 0xf3Cb9bc8485fB4EB65be613C3f3F5c96BB4EAcd2;
   address constant mellody_address= 0x28Ede5215f49c6043a9DEf1aE9840D7C6dC2626D;
   address constant locked_wallet= 0x3BE2E934f9854cB90BB4e9065920e3a840429d1C;
   ...
   constructor() {
       owner =  msg.sender;
       MLDY = IERC20(0x94Fd3FDF5D33D643855E9f09C015FD9EF673539d);
   }

   event OnContestCreated(string title, address[] artists_addresses, uint256  id_contest); 
 
   function createContest(string memory title, uint endTime, address[] memory artists_addresses) public returns(uint256 id) {
