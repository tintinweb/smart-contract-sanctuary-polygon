...
contract MyNft is ERC721, Ownable, ERC2981 {
    ...
    uint256 public immutable supply = 10;
    ...
    address[] public withdrawAddresses = [0xb4082f8469795D49BD62DB1232561B4621BE127B, 0xC7e86186C6709949e165ADDA9fE049E7A001B6B5];
    uint256[] public withdrawPercentages = [80, 20];


    bytes32 public merkleRoot = 0;

    constructor() ERC721("ONE", "O-10") {
        _baseTokenURI = "https://test-nft-tool-gateway-api.tuoluo.net/generator-server/api/contract/v1/1603712839644889090/metadata/";
        _setDefaultRoyalty(0xb4082f8469795D49BD62DB1232561B4621BE127B, uint96(500));
    }
