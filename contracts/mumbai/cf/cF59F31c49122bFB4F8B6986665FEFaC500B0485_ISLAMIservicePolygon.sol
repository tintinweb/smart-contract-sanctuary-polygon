...
*/
    ...
    function hasLockedTokens(address _token) public view returns(bool){
        if(lT[_token][msg.sender].tokenAddress == ERC20(_token)){
            return true;
        }
        else{
            return false;
...
*/
    function selfLock2(address _token, uint256 _amount, uint256 _lockTime, address _recoveryWallet) external nonReentrant{
        ERC20 token = ERC20(_token);
        ...
        emit SelfLockInvestor2(msg.sender, _vaultID, token, amount);
