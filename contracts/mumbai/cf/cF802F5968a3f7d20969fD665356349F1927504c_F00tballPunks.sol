...
// File: contracts/F00tballPunks.sol
...
contract F00tballPunks is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  string private hiddenMetadataUri;
    ...
    constructor() ERC721A("F00tballPunks", "FP") {
        setHiddenMetadataUri("ipfs://QmSidELRhd2DK7s9f5Km7WYpfEnyKqJQZAKMLUj3Sd9rrT/hidden.json");
    }

    uint256 public price = 0.60 ether;
