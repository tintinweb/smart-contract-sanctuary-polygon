...
contract NERC721 is ERC2981, ERC721, Ownable {
    mapping(address => bool) public minter;
    uint private _tokenIndex;
    ...
    function mintAlone(
        ...
        require(amount > 0, "NERC721::amount > 0");
        uint tokenId = _mintBatch(recipient, tokenUri);
        return tokenId;
    }
    ...
    function burn(
        ...
        require(msg.sender == ownerOf(id),"NERC721:: caller is not the nft owner");
        require(amount == 1,"NERC721:: amount == 1");
        _burn(id);
    }
