  ...
  PausableUpgradeable
{
    ...
    returns (uint256)
  {
    ...
    (, , , uint256 liquidity) = NFTPositionInfo.getPositionInfo(factory, want, _tokenId);

    sharesTotal += liquidity;
  ...
  {
    (, , , uint256 liquidity) = NFTPositionInfo.getPositionInfo(factory, want, _tokenId);
    uint256 sharesRemoved = liquidity;
    sharesTotal -= sharesRemoved;

    want.safeTransferFrom(address(this), msg.sender, _tokenId);
