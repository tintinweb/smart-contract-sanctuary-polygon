...
contract SrpPocCollection is ERC721, Ownable {
 ...
 using Counters for Counters.Counter;
    ...
    string public constant BASE_TOKEN_URI = 'ipfs://Qmbevg6DvqJvzgHyJ1Xyq8stSVUELCQHBduTio25bJ52Z6';

    bool public metadataFrozen = false;

    event newMint(address indexed sender, uint256 amount);

    constructor() ERC721("SRP POC Collection", "SPP") { }
    ...
    function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
        ...
        return string(abi.encodePacked(BASE_TOKEN_URI, _tokenId.toString()));
    }
