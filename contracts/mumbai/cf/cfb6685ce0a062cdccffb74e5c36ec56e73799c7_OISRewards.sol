    ...
    ERC1155Supply
{
    ...
    event log_address(string name, address addr);

    event UriChanged(string newUri);

    constructor() ERC1155("OISRewards") {
        emit log_address("Deployer ois rewards", msg.sender);
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _setupRole(PAUSER, _msgSender());
    }

    function setURI(string memory newuri) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "Not FACTORY_HANDLER");

        _setURI(newuri);
    }

    function pause() public {
        require(hasRole(PAUSER, msg.sender), "Not FACTORY_HANDLER");
        _pause();
    }
    ...
    function mint(
        ...
        require(hasRole(PAIR, msg.sender), "Not FACTORY_HANDLER");
