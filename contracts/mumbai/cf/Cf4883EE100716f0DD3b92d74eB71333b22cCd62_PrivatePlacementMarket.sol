...
contract PrivatePlacementMarket is OwnablePausable, ReentrancyGuardUpgradeable{
    ...
    function initStockNftFactory() external onlyDeployer {
        _stockNftFactory.createERC721(0, _bags[0].stockValue, "StockERC721-for-Package-Try");
        _stockNftFactory.createERC721(1, _bags[1].stockValue, "StockERC721-for-Package-Junior");
        _stockNftFactory.createERC721(2, _bags[2].stockValue, "StockERC721-for-Package-Senior");
        _stockNftFactory.createERC721(3, _bags[3].stockValue, "StockERC721-for-Package-Advanced");
        _stockNftFactory.createERC721(4, _bags[4].stockValue, "StockERC721-for-Package-Super");
    }
    ...
    function getAddresses() external view returns (
        ...
        return (address(_stockNftFactory), _ttAddress, address(_stockMargin), _stockMargin.marginDepositAddress());
    }
