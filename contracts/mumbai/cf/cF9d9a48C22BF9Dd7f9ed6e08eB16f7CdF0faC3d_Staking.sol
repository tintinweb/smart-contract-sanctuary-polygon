...
import "../Tokens/MyDummyDKToken.sol";
    ...
    PausableUpgradeable
{
    ...
    function claimReward(address _user, uint256 _tokenId) external {
        ...
        // transfer
        DKToken(rewardToken).mint(msg.sender, installment);
...
contract DKToken is IERC20 {
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    address public _owner;

    string private _name = "DKToken";
    string private _symbol = "DKT";
    uint256 private _totalSupply = 300000000000000000000000000; //300,000,000 DKT tokens
