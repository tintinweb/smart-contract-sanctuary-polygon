...
contract Avatar is ReentrancyGuard, Bucket {
    ...
    uint256 public DEFAULT_TARGET_AMOUNTS = 13e22;
        ...
        while (search.depth < MAX_SEARCH_DEPTH) {
            ...
            if (!search.levelSearchDone) {
                ...
                if (search.numLevelSearchCandidate + 1 <= search.levelSearchStep) {
                    ...
                    console.log(search.currentReferrer, search.levelSearchAmountPerReferrer);
                    // update referrer's referrer amount
...
//                    emit ReferrerRewardAdded(search.currentReferrer, search.levelSearchAmountPerReferrer, 1);
    ...
    function _getSalesToLevel(uint256 amount) internal pure virtual returns (uint8) {
        ...
        if (amount < 100 ether / 100000) {
            return 0;
        } else if (amount < 200 ether / 100000) {
            return 1;
        } else if (amount < 300 ether / 100000) {
            return 2;
        } else if (amount < 400 ether / 100000) {
            return 3;
        } else if (amount < 500 ether / 100000) {
            return 4;
        } else if (amount < 600 ether / 100000) {
            return 5;
        }
        return 6;
...
contract Bucket {
    ...
    struct BucketStock {
        ...
        // epoch => [1-45] eg [1 -> 100] [2 -> 200] [3-50]
    ...
    constructor(){
        ...
        // 10000
        // TODO
        bucketStock.dailyTradeVolume[yesterdayTimestamp] = 12e16;
