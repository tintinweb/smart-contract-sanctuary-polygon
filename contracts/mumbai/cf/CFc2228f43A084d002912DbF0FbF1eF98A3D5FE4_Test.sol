...
contract Test {
    ...
    function makePairs(string memory _name, ERC20 _token, uint256 _buyPrice, uint256 _sellPrice, uint256 _buyFee, uint256 _sellFee, uint256 _incPricePer, uint256 _decPricePer) public{
    ...
    // function callFunction(uint256 tokenQty) public payable
	// {
