...
import "./CrocoKingLegendary.sol";
import "./CrocoCoin.sol";

contract CrocoStakeSystem is Ownable {
    using SafeMath for uint256;

    bytes4 private constant _ERC721_RECEIVED = 0x150b7a02;
    CrocoKingLegendary public crocoKingLegendary;
    CrocoCoin public crocoCoin;

    uint256 private constant lockTime30 = 3 minutes;
    uint256 private constant lockTime60 = 6 minutes;
    uint256 private constant lockTime120 = 12 minutes;
    uint256 public constant lockTimeRewards30Days = 20000 ether; // 20 000 crocoCoin
    uint256 public constant lockTimeRewards60Days = 50000 ether; // 50 000 crocoCoin
    uint256 public constant lockTimeRewards120Days = 120000 ether; // 120 000 CrocoCoin
    ...
    mapping(address => StakerInformation) public NFTStakers;
    ...
    constructor(CrocoKingLegendary _crocoKingLegendary, CrocoCoin _crocoCoin)
        public
    {
        transferOwnership(msg.sender);
        crocoKingLegendary = _crocoKingLegendary;
        crocoCoin = _crocoCoin;
    }
    ...
    function stake(uint256 tokenId, uint256 _lockPeriod) external {
        _stake(msg.sender, tokenId, _lockPeriod);
    }
    ...
    function _stake(
        ...
        require(
            crocoKingLegendary.isApprovedForAll(_user, address(this)) == true,
            "PleaseApproveThisContract"
        );
        require(_lockPeriodUINT >= lockTime30, "LockPeriodMustBeMoreThan30");
        ...
        crocoKingLegendary.safeTransferFrom(_user, address(this), _tokenId);
    }
    ...
    function _unstake(address _user, uint256 _tokenId) internal {
        NFTInformation storage _nftInfos = NFTInfos[_tokenId];
        StakerInformation storage staker = NFTStakers[_user];
        require(block.timestamp > _nftInfos.lockPeriod, "YourNftIsStillLocked");
        require(tokenOwner[_tokenId] == _user, "YouAreNotOwnerOfThisNft ");
        updateReward(_user);
        ...
        crocoKingLegendary.safeTransferFrom(address(this), _user, _tokenId);
    }
    ...
    function claimReward() public {
        ...
        require(_rewards > 0, "RewardsBalacneToLow");
        _staker.balance = 0;
        crocoCoin.payRewards(msg.sender, _rewards);
    }
