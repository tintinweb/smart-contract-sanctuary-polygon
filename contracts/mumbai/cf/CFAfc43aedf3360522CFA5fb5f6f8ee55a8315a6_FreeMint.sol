...
contract FreeMint is DefaultOperatorFilterer, ERC721, Ownable {
    ...
    function safeMint(bytes32[] calldata proof) public {
        ...
        require(MerkleProof.verify(proof, root, leaf), "FreeMint: Invalid proof");

        require(minted[_msgSender()] == false, "FreeMint: User already minted");

        require(_tokenIdCounter.current() < maxSupply, "FreeMint: Max supply minted"); 
