...
contract Moneu is IBEP20, Auth {
    ...
    string constant _name = "Moneu";
    string constant _symbol = "MONEU";
...
//        emit Transfer(sender, recipient, amount);
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _buybackFeeReceiver, address _liquidityFeeReceiver) external authorized {
