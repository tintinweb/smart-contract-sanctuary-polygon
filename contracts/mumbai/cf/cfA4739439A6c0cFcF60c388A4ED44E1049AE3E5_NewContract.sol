...
contract NewContract is Ownable, VRFConsumerBaseV2 {
  ...
  function getWinnerByLottery(uint16 lottery) public view returns (address payable) {
  ...
  function payWinner() public payable onlyOwner {
    ...
    uint256 balance = address(this).balance;
        ...
        lotteryHistory[lotteryId] = winners[0];
        lotteryHistory[lotteryId] = winners[1];
        lotteryHistory[lotteryId] = winners[2];
        lotteryHistory[lotteryId] = winners[3];
        lotteryHistory[lotteryId] = winners[4];
