...
contract y is IERC721L, ERC721AQueryable, Ownable, ReentrancyGuard {
    ...
    // Current base URI.
    string private _currentBaseURI = "ipfs://bafybeifvyhaaayntt5buwitb4242xzwaqvwbgqoiozmoauvx52644co63u/";
    ...
    constructor() ERC721A("y", "y") {
        _mintStages.push(MintStageInfo({cost: 0, walletLimit: 5, merkleRoot: 0x0, maxStageSupply: 0, startTimeUnixSeconds: 1687267395, endTimeUnixSeconds: 1692451395}));
    }
