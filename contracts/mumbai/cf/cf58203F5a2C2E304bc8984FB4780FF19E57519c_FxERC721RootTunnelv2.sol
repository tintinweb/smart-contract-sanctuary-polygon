 ...
 */
abstract contract FxBaseRootTunnel is IFxMessageProcessor {
    ...
    function processMessageFromRoot(
        ...
        require(msg.sender == fxRoot, "FxBaseRootTunnel: INVALID_SENDER");
        _processMessageFromChild(stateId, rootMessageSender, data);
    }
...
import {IERC721Receiver} from "@maticnetwork/fx-portal/contracts/lib/IERC721Receiver.sol";
import {FxBaseRootTunnel} from "./BaseTunnel_Contracts/FxBaseRootTunnel.sol";
 ...
 */
contract FxERC721RootTunnelv2 is IERC721Receiver, FxBaseRootTunnel, Create2 {
    // constructor
    // map Token
