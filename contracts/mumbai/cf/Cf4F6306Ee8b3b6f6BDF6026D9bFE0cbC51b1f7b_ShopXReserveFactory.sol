...
contract ShopXReserveFactory is Ownable {
  ...
  event ContractCreated(address indexed ShopXReserveNFT);
  ...
  */
  ...
  function createReserveNFT(
    ...
    ShopXReserveNFT _shopXReserveNFT = new ShopXReserveNFT (
    _name,
    _symbol,
    _baseURI,
    _uintArgs,
    ...
    emit ContractCreated(address(_shopXReserveNFT));
  }
}
...
contract ShopXReserveNFT is ERC721Enumerable, ERC2981ContractWideRoyalties, AccessControl, Pausable {
  ...
  // ERC721
  string private baseURI;// TokenURI: baseURI/{tokenId}
  ...
  constructor (
    ...
    */
    ...
    //_pause(); // initializes in paused state
  }
  ...
  modifier onlyAllow(address _address, bytes32[] calldata _merkleProof) {
    ...
    require (merkleRoot == bytes32(0) || valid, "ReserveNFT: Valid proof required.");
    _;
  }
 ...
 * @dev Sets the merkle root.
     ...
     */
  //addToAllowList
  function setMerkleRoot(bytes32 _merkleRoot) public onlyRole(SALE_ADMIN) {
...
* @dev Mints a token to the msg.sender. It consumes whitelisted supplies.
    */
  function mint(bytes32[] calldata merkleProof) payable public whenNotPaused onlyAllow(msg.sender, merkleProof) {
    require(totalSupply() < maxSupply, "NotEnoughNFT: NFT supply not available");
    require(msg.value == mintPrice, "NotEnoughETH: Not enough ETH sent.");
