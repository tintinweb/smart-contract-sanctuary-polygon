    ...
    ResourceImplementationPointer
{
    ...
    function initialize() external initializer {
        ...
        // Initialize contract
        changeNodeMinPrice(42_000 * (10**18)); // 42,000 Resources
        ...
        resourceSet
    {
        ...
        string memory previousName = nft.name;
        nft.name = nftName;
        emit Rename(account, previousName, nftName);
    }

    function createNFTWithTokens(
        string memory nftName,
        uint256 nftValue
    ) external nonReentrant whenNotPaused resourceSet returns (uint256) {
        address sender = _msgSender();
        ...
        // Assign the NFT to this account
        _mint(sender, newNFTId);

        emit Create(sender, newNFTId, nftValue);
    ...
    function stakeTokensOnNFT(
        ...
        emit Stake(sender, _nftId, nftValue);
    }
        ...
        resourceSet
    {
        ...
        emit Cashout(account, _nftId, amountToReward);
    }
        ...
        resourceSet
    {
        ...
        emit CashoutAll(account, nftsOwned, rewardsTotal);
    }
        ...
        resourceSet
    {
        ...
        emit Compound(account, _nftId, amountToCompound);
    }
        ...
        resourceSet
    {
        ...
        emit CompoundAll(account, nftsAffected, amountsToCompound);
    }
