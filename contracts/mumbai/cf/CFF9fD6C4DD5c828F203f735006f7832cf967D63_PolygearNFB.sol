...
import '@polychainmonsters/nfbs/contracts/NFB.sol';
/// @dev - importing this because we're deploying it
import '@polychainmonsters/nfbs/contracts/token-uri-getters/NFBImageTokenURIGetter.sol';

contract PolygearNFB is NFB {
    constructor() NFB('PolygearNFB', 'PG-NFB') {}
}
