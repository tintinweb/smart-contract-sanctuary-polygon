...
interface ISettlement {
    function settlement(
        ...
        uint256 _count,
        uint256 _requestId,
        uint64 _mainType, uint64 _subType
    ) external;
}
...
contract Lottery is VRFConsumerBaseV2, Roles {
    ...
    constructor(address _gamePool, uint64 _mainType, uint64 _subType) VRFConsumerBaseV2(coordinator) Roles(_msgSender()) {
    ...
    function startGame(
        ...
        tokenId; gameArgs; // to avoid warnings of compiler
    ...
    function fulfillRandomWords(uint256 requestId, uint256[] memory randomWords) internal override {
        ...
        gamePool.settlement(random, player, gameCount, requestId, mainType, subType);
        delete vrfReq[requestId];
    }

}

// https://mumbai.polygonscan.com/address/0x56f32017b1d47c10e29291aa26810ec43079ec01#code