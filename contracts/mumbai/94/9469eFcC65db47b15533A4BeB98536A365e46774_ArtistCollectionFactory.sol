...
contract ArtistCollectionFactory {
    ...
    function createArtistCollection(
        ...
        ArtistCollection(clone).initialize(
            baseURI,
            contractName,
            tokenSymbol,
            artist
    ...
    Royalties
{
     ...
     */
    bool private _allowSignedMinting = false;
    ...
    function mintSigned(
        ...
        _checkSigned(args, tokenNonce, v, r, s);
        _mintNoPermission(to, _tokenURI, receiver, basisPoints);
    }
    ...
    function _checkSigned(
        ...
        // Recover signature
        address authorizer = Signatures.recoverPersonal(args, v, r, s);
