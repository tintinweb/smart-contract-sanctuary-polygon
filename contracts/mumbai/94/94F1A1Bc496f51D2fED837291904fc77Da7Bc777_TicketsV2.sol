    ...
    ERC721BurnableUpgradeable
{
    ...
    function mintManyTicketsToUser(uint256[] memory ticketIds, address to)
        public
        whenNotPaused
        onlyRole(DEFAULT_ADMIN_ROLE)
        returns (bool)
    ...
    function contractURI() public pure returns (string memory) {
        return
            "https://us-central1-welook-siwe.cloudfunctions.net/ipfs/v2/t/contract";
    }
