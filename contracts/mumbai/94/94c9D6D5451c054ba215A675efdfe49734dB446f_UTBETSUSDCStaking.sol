...
contract UTBETSUSDCStaking is Ownable {
    ...
    uint256 public constant StakeThreshold = 1 ether;
    ...
    function stake(uint256 _amount) public {
        ...
        stakeOfAddress[msg.sender].depositAmount += _amount / StakeThreshold;
        ...
        pool.totalStakedAmount += _amount / StakeThreshold;
