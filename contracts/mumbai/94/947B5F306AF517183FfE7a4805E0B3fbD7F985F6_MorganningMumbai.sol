...
contract MorganningMumbai is MorganningDeployable {
    ...
    constructor()
        MorganningDeployable(vrfCoordinator, linkTokenContract, keyHashParam)
    {}
...
contract MorganningDeployable is Morganning {
    constructor(
        ...
        bytes32 keyHash
    ) Morganning(false, vrfCoordinator, linkTokenContract, keyHash) {}
}
    ...
    VRFConsumerBaseV2
{
    ...
    function initialize(
        ...
        require(
            numl2 < 16 && numl3 < 16 && numl4 < 16 && numl5 < 16 && numl6 < 16,
            "Layers out of bounds!"
        );
