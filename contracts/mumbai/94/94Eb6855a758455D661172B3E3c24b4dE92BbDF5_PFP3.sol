...
contract PFP3 is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
    uint256 public MAX_SUPPLY = 25;

    
    uint256 public PHASE_SUPPLY = 10;
    uint256 public PUBLIC_SUPPLY = 10;
    
    bool public IS_PHASE_ACTIVE = false;
    bool public IS_PUBLIC_ACTIVE = false;

    
    uint256 public PHASE_TX_LIMIT = 5;
    uint256 public PUBLIC_TX_LIMIT = 5;

    
    uint256 public PHASE_WALLET_LIMIT = 5;
    uint256 public PUBLIC_WALLET_LIMIT = 5;

    
    uint256 public PHASE_PRICE = 0.001 ether;
    ...
    string private preRevealURI = "https://ipfs.w3bmint.xyz/ipfs/QmRV6uUju6Sqp878koDNbDiEtMFqN6JtVfoQva5z9xMLPz";
    ...
    constructor() ERC721A("PFP3", "PFPTHREE") {
        
        
        _safeMint(0xe9f71B435048B595E15a5fc9a031B4B80C10E639, 5);
    }
    ...
    function withdraw() external onlyOwner {
        ...
        (bool successFinal, ) = payable(0xe9f71B435048B595E15a5fc9a031B4B80C10E639).call{ value: address(this).balance }("");
