...
contract BigtimeWarriorsDeployer is ERC721Enumerable, Ownable 
{
    using Strings for string;

    uint public constant MAX_TOKENS = 5000; //5k tokens
    uint public PRESALE_LIMIT = 4000; //4k presale
    uint public presaleTokensSold = 0;
    uint public constant NUMBER_RESERVED_TOKENS = 1000; //deployer reserve tokens
    uint256 public PRICE = 10000000000000000; //0.01 eth
    uint public perAddressLimit = 1; //limit per address
    ...
    address payable private devguy = payable(0xC0FD0D8604b64680752d40d3E58A253A728C52B5); //send  contract payables to this address

    constructor() ERC721("BigtimeWarriors", "BTW") {}
    ...
    function mintToken(uint256 amount, bytes32[] memory proof) external payable
    {
        ...
        require(amount > 0 && amount <= 10, "Max 1 NFTs per transaction");
