...
contract Collection is Initializable, ERC1155Upgradeable, OwnableUpgradeable, ERC1155BurnableUpgradeable, ERC1155URIStorageUpgradeable, UUPSUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() {
        _disableInitializers();
    }
    ...
    function initialize() initializer public {
        __ERC1155_init("https://woozy-distinct-anger.glitch.me/items/{id}.json");
        __Ownable_init();
