    ...
    ERC2771Context
{
    ...
    mapping(uint256 => uint256) public supplyPerToken;
    ...
    function setSupply(uint256 max_supply, uint256 tokenId) public onlyOwner {
        supplyPerToken[tokenId] = max_supply;
    }
    ...
    function mint(
        ...
        require(
            totalSupply(id) + amount <= supplyPerToken[id],
