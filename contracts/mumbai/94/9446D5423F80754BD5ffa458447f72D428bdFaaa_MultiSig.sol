...
contract MultiSig {
    ...
    function addTokens(IERC20 _token) external {
        ...
        require(tokens.length != tokenAmount, "You have added the maximum amount of tokens");
        tokens.push(_token);
        isToken[_token] = true;
    }
    ...
    //remove the token from the list
     function removeToken(IERC20 _token) external {
        require(msg.sender == admin, "Only the admin can remove Tokens");
...
contract MultiSigFactory is Factory, Ownable {
    uint256 public s1 = 100;
    uint256 public s2 = 200;
    uint256 public s3 = 300;
    uint256 public s1Token = 50;
    uint256 public s2Token = 100;
    uint256 public s3Token = 150;
    ...
    function createMultiSig(
        ...
        require(
           ...
           if(_subscription == 1){
               require(_owners.length <= _sub1Owners, "Reached maximum owners for subscription 1");
           }
           else if (_subscription == 2){
                require(_owners.length <= _sub2Owners, "Reached maximum owners for subscription 2");
           }
           else{
                require(_owners.length <= _sub3Owners, "Reached maximum owners for subscription 3");
           }
    ...
    function changeSub1Owners(uint256 _newSub1Owners)external onlyOwner{
        _sub1Owners = _newSub1Owners;
    }
    function changeSub2Owners(uint256 _newSub2Owners)external onlyOwner{
        _sub1Owners = _newSub2Owners;
    }
    function changeSub3Owners(uint256 _newSub3Owners)external onlyOwner{
        _sub1Owners = _newSub3Owners;
    }
