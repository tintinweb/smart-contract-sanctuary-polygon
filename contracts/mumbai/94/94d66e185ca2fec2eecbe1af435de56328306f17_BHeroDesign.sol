...
contract BHeroDesign is AccessControlUpgradeable, UUPSUpgradeable, IBHeroDesign {
  ...
  function createTokens(
    ...
    for (uint256 i = 0; i < count; ++i) {
      ...
      uint256 category = (details >> 30) & 31;
      bool isHeroS = ((details >> 35) & 1) == 1;
      ...
      uint256 tokenSeed = uint256(keccak256(abi.encode(seed, tokenId)));

      (, details) = createRandomToken(tokenSeed, tokenId, rarity, isSuperBox, isHeroS, dropRateOption);

      tokenId += 1;
      tokenDetails[i] = details;
    }
  }
