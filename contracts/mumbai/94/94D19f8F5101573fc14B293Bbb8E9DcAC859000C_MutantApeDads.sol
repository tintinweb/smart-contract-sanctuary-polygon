...
contract MutantApeDads is ERC721Enumerable, Ownable {
    ...
    ERC721("MUTANTApeDads", "MutantAPEDADS")
    {
        baseURI = _baseURI;
    ...
    function publicMint(uint256[] memory tokenIdsToCheck) public {
        ...
        uint256 serumBalance = ApeDadsSerum(apeDadsSerumContract).balanceOf(_msgSender(), 0);
        ...
        ApeDadsSerum(apeDadsSerumContract).burn(countToMint);
    }
...
contract ApeDadsSerum is ERC1155, Ownable {
