...
// File: contracts/smnft_1_0_0.sol
...
contract SMNFT_1_0_0 is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public finalMaxSupply = 10;
  ...
  constructor() ERC721("SMNFT", "NFT") {
    setHiddenMetadataUri("//ipfs://QmRKHdRdAQFedyE8QL4sNQ7ZVaRqvypQMp9PYuRGs64yxp/_metadata.json"); //ipfs://__CID__/hidden.json
  }
