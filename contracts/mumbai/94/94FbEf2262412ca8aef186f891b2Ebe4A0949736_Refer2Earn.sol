...
contract Refer2Earn is Ownable, ReentrancyGuard {
    ...
    /**
     * @dev Sets the treasury address to receive fees and commissions.
    ...
    /**
     * @dev Sets the commission percentage for a specific contract.
     * @param _contract The address of the contract.
     * @param _percent The commission percentage.
     */
    ...
    /**
     * @dev Sets the bonus percentage for a specific contract and referrer.
     * @param _contract The address of the contract.
     * @param _percent The bonus percentage.
    ...
    /**
     * @dev Calculates the commission and fee for a referral.
     * @param _contract The address of the contract.
     * @param _recipient The address of the recipient.
     * @param _referrer The address of the referrer.
     * @param _value The value of the referral.
     * @return The commission and fee amounts.
     */
    function getCommission(address _contract, address _recipient, address _referrer, uint256 _value)
        public
        view
    ...
    /**
     * @dev Retrieves the bonuses of a contract.
     * @param _contract The address of the contract.
     * @return The referrers and their corresponding bonuses.
     */
    ...
    /**
     * @dev Processes a referral payment.
     * @param _recipient The address of the recipient.
     * @param _referrer The address of the referrer.
     * @param _quantity The quantity of the referral.
     * @param _value The value of the referral.
     */
    function payReferral(address _recipient, address payable _referrer, uint256 _quantity, uint256 _value)
        external
        payable
        nonReentrant
        onlyContract
