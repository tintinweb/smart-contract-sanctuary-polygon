...
contract NFTSwap2 is ReentrancyGuard, Ownable, ERC1155Holder {
    ...
    function createSwapPair(
        ...
        swapPair memory pair = swapPair(source, _count, _tokenId, 0, 0, srcIds,true,_minterContract);
        count++;
        pairs[count] = pair;
        emit swapPairCreated(source, _count, _tokenId, count);
    }
    ...
    function swapMultiple(
        ...
        uint256[] memory acceptedIds = pair.sourceIds;
        ...
        mockerc = ERC1155(pair.source);
        mock1155.burnBatch(address(this), _ids, _amts);
        mockerc = ERC1155(pair.minterContract);
