...
contract TestContract is ERC20, Ownable {
    ...
    constructor() ERC20("TestContract", "TESTC") {
        ...
        if (block.chainid == 56) {
            ...
            currentRouter = 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff; //Polygon Testnet
        } else {
            revert();
        }
    ...
    function setNegativaRewardShare(
        uint256 _negativaRewardShare
    ) external onlyOwner {
        negativaRewardShare = _negativaRewardShare;
        require(
            negativaRewardShare <= sellTotalFees,
