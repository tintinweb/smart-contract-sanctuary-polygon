...
contract MergeGators is Ownable, VRFConsumerBaseV2, IMergeGators, ReentrancyGuard {
    ...
    constructor(
        ...
        uint256 poolPortionBps_
            ...
            //alligators = erc721_;
            alligatorsInstance = Alligators(erc721_);
    ...
    function merge3NFTs(uint256 _1st, uint256 _2nd, uint256 _3rd) public payable nonReentrant() {
        ...
        alligatorsInstance.merge3alligators(_1st, _2nd, _3rd, msg.sender);
    ...
    function merge3Wjoker(uint256 _1st, uint256 _2nd, uint256 _3rd) public payable nonReentrant() {
        ...
        payable(address(this)).transfer(_calculatePortionToRewardPool());
        taxTreasury.transfer(_calculatePortionToRewardPool());
        alligatorsInstance.mergeWjoker(_1st, _2nd, _3rd, msg.sender);
        // bytes memory mergeParams = abi.encodeWithSignature("mergeWjoker(uint256, uint256, uint256, address)",_1st, _2nd, _3rd, msg.sender);
        // (bool success, bytes memory value ) = address(alligators).call{gas: 30_000_000, value: msg.value}(mergeParams);
        // require(success, "LowCallFailed");
        _mergePrize(msg.sender);
    }
...
contract MergeGatorsMock is MergeGators {
    ...
    address payable collection_ = payable(0xD6eE64174040406D483231bEB5BCF317552209aA);
