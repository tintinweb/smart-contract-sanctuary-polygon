...
abstract contract Ownable is Context {
	 ...
	 */
	constructor() {
		_setOwner(0x5f7e7827FEe1cceF50b4b64022f94c744763EC4d);
	}
...
contract Htd is ERC721Enumerable, Ownable, ReentrancyGuard {

	uint256 public TOKEN_MAX_AMOUNT = 6;
	uint256 public TOKEN_PER_TX = 6;
	uint256 public TOKEN_PER_WALLET = 79;
	uint256 public PRICE = 12 ether;
	uint256 public constant TIME_FOR_GROWN = 1687095044984;
	address public founder = 0x5f7e7827FEe1cceF50b4b64022f94c744763EC4d;
	...
	string private _name = "htd";
	string private _symbol = "DSV";
	string private _baseTokenURI = "https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.maximonline.ru%2Fentertainment%2Fkak-sozdavat-svoi-kartinki-v-midjourney-prostoi-gid-id872428%2F&psig=AOvVaw3HfK9soeGnQFpFoLJ8EGEP&ust=1687180799530000&source=images&cd=vfe&ved=0CA4QjRxqFwoTCIipk7P0zP8CFQAAAAAdAAAAABAS";
