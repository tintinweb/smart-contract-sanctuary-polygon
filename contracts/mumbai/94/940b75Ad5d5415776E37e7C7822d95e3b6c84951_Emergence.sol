 ...
 * @notice This contract handles minting Emergence tokens.
 */
contract Emergence is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x2ef02c0dD0F50a3A174037e0B6752e939cf7927f;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xA6Bf8b6B4ae92f36Cc938b62c6770431aaDfB0B3;
    address[] public payoutAddresses = [
        0xA6Bf8b6B4ae92f36Cc938b62c6770431aaDfB0B3
    ];
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeie65wthdmzhjoc6gflkteyrou4ubbr73zwy23eau55rwhkepg65lq/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[1] = 11;
        tokenPublicPrice[1] = 0.033 ether;
        tokenPublicMintsPerAddress[1] = 11;
        tokenMaxSupply[2] = 11;
        tokenPublicPrice[2] = 0.033 ether;
        tokenPublicMintsPerAddress[2] = 11;
        tokenMaxSupply[3] = 11;
        tokenPublicPrice[3] = 0.033 ether;
        tokenPublicMintsPerAddress[3] = 11;
        require(
