...
contract testbunny is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://QmRQHYNXYP492LcNigSfFGUxHXxxdQK4mTqwGETKgcvH63/";
  ...
  constructor() ERC721("Test Bunny NFT", "TBN") {
