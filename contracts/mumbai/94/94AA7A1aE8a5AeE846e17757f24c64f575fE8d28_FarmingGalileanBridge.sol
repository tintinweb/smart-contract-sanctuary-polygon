...
// This contract is not upgradeable due to Polygon's mapping restrictions
contract FarmingGalileanBridge is Ownable, AccessControl {
    ...
    function withdrawWithMetadata(uint256 tokenId) external {
        require(
            _msgSender() == address(galilean),
            "Only farming galilean contract can withdraw"
        );
