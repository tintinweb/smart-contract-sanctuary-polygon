...
contract ArbNFTTest is ERC721, Ownable, Pausable {
    constructor() ERC721("ARBNFT SPACE", "ARBL") Ownable() {}
    using Strings for uint256;
    ...
    string[2][] public bgAttributes;
    function setBgAttribute(bytes memory encodec) public onlyOwner {
        string[2] memory bground = abi.decode(encodec, (string[2]));
        bgAttributes.push(bground);
    }

    function genBg(uint256 h) public view returns(string[2] memory) {
        string[2] memory bg;
        uint8 seed = uint8(h % (bgAttributes.length));
        bg = bgAttributes[seed];
        return bg;
    }

    string bg1 = '<image width="150" height="150" xlink:href="data:image/jpg;base64,';
    string bg2 = '"></image>';
    ...
    function genImgSVG(uint256 tokenId) public view returns (string memory) {
        ...
        string memory output = string(abi.encodePacked(z[0], bg1, genBg(tokenId)[0], bg2));
        output = string(abi.encodePacked(output, z[1], z[2], z[3], z[4], z[5]));
