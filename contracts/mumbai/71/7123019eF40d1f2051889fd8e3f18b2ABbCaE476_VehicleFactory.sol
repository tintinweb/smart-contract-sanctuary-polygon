...
// ContraPropBasic: {"hp": 10, "scan": 100, "defense": 10, "duration": 1, "oec_rate": 10, "uru_rate": 10, "potential": 5}
  ...
  // MANAGING Authorization Contract Address for Call 
   ...
   // 合约部署者增加操作员
        ...
        returns(uint[] memory)
    {
        ...
        require(
            vehicles[_type_id].margin_name == hash_defense ||  
            vehicles[_type_id].margin_name == hash_hp ||  
            vehicles[_type_id].margin_name == hash_duration,
            "wrong margin_name"
        );
