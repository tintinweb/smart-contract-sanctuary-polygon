...
contract OverrideMatrix is AccessControl {
    ...
    constructor(address _usdt, address _noReferPlatform, address _feePlatform, address _initAcc) {
        ...
        _grantRole(DEFAULT_ADMIN_ROLE, 0x5D330e32933DFF0f0d90eF9D9132FA823f91F2B5);
        // 0x68368Ce26663B461A5dAf301E05f4119Da222E76
        _grantRole(SETENV_ROLE, 0x68368Ce26663B461A5dAf301E05f4119Da222E76);
        // 0x67BCfc3828a451c8BbBD5c075Ec5beEDAA03C635
        _grantRole(REMOVE_ROLE, 0x67BCfc3828a451c8BbBD5c075Ec5beEDAA03C635);
        // 0x68368Ce26663B461A5dAf301E05f4119Da222E76
        _grantRole(INIT_ROLE, 0x68368Ce26663B461A5dAf301E05f4119Da222E76);
