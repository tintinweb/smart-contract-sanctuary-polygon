...
// File: myNftContract/ERC721R.sol
...
// File: myNftContract/ERC721REnumerable.sol
...
contract NFT is ERC721rEnumerable, Ownable {

    // Project dependent parameters
    uint256 public maximumSupply = 8;
    ...
    constructor(string memory _name, string memory _symbol, string memory _initBaseURI) 
        ERC721r(_name, _symbol, maximumSupply) {
    ...
    function mint() public callerIsUser {
        ...
        require(supply + 1 <= maximumSupply, "Collecton Sold.");
        require(WalletMintedBalance[msg.sender] == 0, "You can mint only 1 NFT per wallet.");
