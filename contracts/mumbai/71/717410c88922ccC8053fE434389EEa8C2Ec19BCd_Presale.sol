...
contract Presale is Ownable {
    ...
    address public wallet = payable(0xF41E6d44Ce05C5C80871d52b70f145bB621F8a25);

    // How many token units a buyer gets per ETH
    uint256 private rate = 2217900;
    ...
    //Presale status
    bool private hasPresaleEnded = false;
    bool private hasPresaleLaunched = false;
    ...
    function LaunchPresale() public onlyOwner{
        hasPresaleLaunched = true;
    }

    function buyTokens() public payable {
        require(hasPresaleLaunched,"Presale not yet started");
        require(!hasPresaleEnded, "Presale has ended");
        require(msg.value >= 0.01 ether, "cant buy less with than 0.01 ETH");
    ...
    function PresaleStageTwo() public onlyOwner{
        presaleStage = 2;
        rate = 855114; 
    }

    function PresaleStageThree() public onlyOwner{
        presaleStage = 3;
        rate = 466160; 
    }
    ...
    require(block.timestamp >= startTime, "Claiming Period not yet started");
