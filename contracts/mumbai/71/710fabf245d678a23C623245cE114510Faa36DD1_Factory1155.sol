...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new BrillianceUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        BrillianceUser1155Token token = BrillianceUser1155Token(address(addr));
...
contract BrillianceUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
