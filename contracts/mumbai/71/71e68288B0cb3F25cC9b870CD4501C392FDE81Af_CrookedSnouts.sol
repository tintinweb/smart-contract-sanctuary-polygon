...
contract CrookedSnouts is VRFConsumerBaseV2, ERC721URIStorage {
  ...
  mapping(address => RequestStruct) public addressToRequestStruct;
  mapping(uint256 => uint256[]) public requestIdToRandomNumbers;
  mapping(uint128 => uint256) public tokenIdToRequestId;
  ...
  function readRandomNumbersArray() public view returns(uint256[] memory) {
    RequestStruct storage reqData = addressToRequestStruct[msg.sender];
    return reqData.randomNumbers;
  }
  ...
  function requestNumbers() public {
    ...
    addressToRequestStruct[msg.sender].requestId = requestId;
    addressToRequestStruct[msg.sender].tokenId = tokenId;
  ...
  function fulfillRandomWords(uint256 _requestId, uint256[] memory randomNumbers) internal override {
    ...
    addressToRequestStruct[msg.sender].randomNumbers = [
      (randomNumbers[0] % 7) + 1,
      (randomNumbers[1] % 8) + 1,
      (randomNumbers[2] % 11) + 1,
      (randomNumbers[3] % 11) + 1,
      (randomNumbers[4] % 11) + 1,
      (randomNumbers[5] % 7) + 1
    ];
  ...
  function create() public {
    ...
    uint256[] memory usersRandomNumbers = readRandomNumbersArray();


    uint256 bg = usersRandomNumbers[0];
    uint256 face = usersRandomNumbers[1];
    uint256 eyes = usersRandomNumbers[2];
    uint256 head = usersRandomNumbers[3];
    uint256 mouth = usersRandomNumbers[4];
    uint256 nose = usersRandomNumbers[5];
    ...
    addressToRequestStruct[msg.sender].minted = true;
