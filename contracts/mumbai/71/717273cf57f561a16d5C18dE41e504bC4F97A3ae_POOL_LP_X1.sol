...
//     uint256 fee = rewards / 10; // หาค่าฟี 10% จาก rewards
//     uint256 finalRewards = rewards - fee; // rewards ที่จะมอบให้กับผู้เรียกเคลม
...
function _claimRewards() internal virtual {
    ...
    // ส่ง 5% ไปที่ที่อยู่ 0x000000000000000000000000000000000000dEaD
...
contract POOL_LP_X1 is Staking20Base {
    constructor(
        uint256 _timeUnit,
        uint256 _rewardRatioNumerator,
        uint256 _rewardRatioDenominator,
