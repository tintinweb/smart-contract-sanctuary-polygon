...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x87B23553aFfAFe941715C2387f221f660d84B394];
...
// File: contracts/BsPassContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract BsPassContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "BSPass";
    string public symbol = "BSPASS";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/OYNJuls7mrSV5btmiLGc/contract-metadata";
  }
