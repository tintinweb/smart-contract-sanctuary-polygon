...
contract KOC is Initializable, ERC721Upgradeable, ERC721URIStorageUpgradeable, PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable{
    ...
    function airdrop(address to, uint8 count) public {

    require(airdropMap[msg.sender] == true, "No airdrop permission");
