...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x594F6eC9BE8da93541B892B1D926827bEB3eF074];
  address public erc20Payable = 0x594F6eC9BE8da93541B892B1D926827bEB3eF074;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 25, 50000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmdFJRgfZft4YmQ3eD4VpuUmKKfnym2FwS8YSrRp35kqE2/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 50000");
...
// File: contracts/UsagiduckContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract UsagiduckContract is RamppERC721A {
    constructor() RamppERC721A("usagiduck", "UD"){}
}
