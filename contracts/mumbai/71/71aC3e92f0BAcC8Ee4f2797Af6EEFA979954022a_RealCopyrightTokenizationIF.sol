...
// File: Codes/Remix/Real/RealCopyrightTokenizationIF.sol
...
//
contract RealCopyrightTokenizationIF{
    ...
    // 
    function readCopyrightCredential()
      public view returns (string memory, string memory, string memory){

      string memory realText0 = "Copyright Token Credential : [1] DID Credential , [2] Token Name";
    ...
    function readCopyrightToken()
      public view returns (string memory, uint256, uint256, uint256){

      string memory realText0 = "Copyright Token Information : [1] TokenID , [2] Edition number , [3] Total supply";
    ...
    //
    // transfer Copyright Tokens from msg.sender
    // back to the Real Contract owner only
    //
    function claimCopyrightTokenBack(
        //address from,
        address toContract,
        uint256 tokenId,
        uint256 amount,
    ...
    // mint & transfer Copyright NFT token as Utility to msg.sender 
    // from the Real Contract owner
    // only NFT asset at assetId.ID_ASSET1
    function mintTransferCopyright(
    ...
    // mint additional Copyright Edition on top of the first NFT
    // auto tokenId
    function mintCopyrightEdition(
        ...
        string memory realText0 = "New Copyright Edition minted [Token ID , Supply]";
