...
contract Breezy is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
    ...
    uint256 public TotalCollectionSize_ = 101; // total number of nfts
    uint256 public MaxMintPerBatch_ = 101; //max mint per transaction
