...
// Contract deployed to 0x71a8385f0c25eF8Ed1fdC5aA5000A597bFD129dc
...
contract ChainBattles is ERC721URIStorage  {
    ...
    function createRandom(uint _number) view public returns(uint){
        return uint(keccak256(abi.encodePacked(_number++))) % 100;
    }
    ...
    function train(uint256 tokenId) public {
        ...
        tokenIdToVariables[tokenId].hp = createRandom(currentHp);
        uint256 currentStrength = tokenIdToVariables[tokenId].strength;
        tokenIdToVariables[tokenId].strength =  createRandom(currentStrength);
        uint256 currentSpeed = tokenIdToVariables[tokenId].speed;
        tokenIdToVariables[tokenId].speed =  createRandom(currentSpeed);
