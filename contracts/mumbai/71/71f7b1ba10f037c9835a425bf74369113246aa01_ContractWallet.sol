...
contract MockERC1155 is ERC1155 {
  constructor() ERC1155("TEST-URI") {
    ...
    _mint(_msgSender(), 3, 100, "");
    _mint(_msgSender(), 4, 100, "");
    _mint(_msgSender(), 5, 100, "");
  }
}
...
contract MockERC721 is ERC721 {
  ...
  constructor(address owner, uint256 count) ERC721("MockERC721", "MERC721") {
    mintToken(owner, count);
  }

  function mintToken(address owner, uint256 count) public {
