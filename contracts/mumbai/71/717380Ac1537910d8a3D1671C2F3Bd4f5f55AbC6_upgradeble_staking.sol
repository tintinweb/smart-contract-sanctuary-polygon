...
contract upgradeble_staking is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    */
    function batchStaking(uint256[] calldata _tokenIds) public nonReentrant {
    ...
    */
    ...
    function withdrawAdmin(uint256 _amount) public onlyOwner lockContract {
