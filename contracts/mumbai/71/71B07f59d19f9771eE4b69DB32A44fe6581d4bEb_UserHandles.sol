...
contract UserHandles is Initializable, PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize(IERC20Upgradeable _paymentToken, address _kutils, uint256 _costForNameChange) initializer public {
        __Pausable_init();
        __Ownable_init();
    ...
    */
    ...
    function updateUserHandle(string calldata handle) public whenNotPaused {
        ...
        require(paymentToken.transferFrom(msg.sender, owner(), costForNameChange), "Didn't receive the Payment Token");
