...
contract f is IERC721L, ERC721AQueryable, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("f", "f") {
        _mintStages.push(MintStageInfo({cost: 50000000000000000, walletLimit: 5, merkleRoot: 0x0, maxStageSupply: 0, startTimeUnixSeconds: 1687263939, endTimeUnixSeconds: 1692447939}));
    }
