...
//public to check correct mapping
    ...
    function mintTicketsWithFixPrice(
        ...
        require( eventDetails[ticketTypeDetails[ticketID].eventIDforTicket].eventEndDate + 24 hours  > block.timestamp,"Event Passed"  );
        require(
        ...
        if (_msgSender() != owner()) {
            if (
             ...
             if (promoCodeDetails[_promoCode].discountIsPercentage) {
                        ...
                        require(newDiscountedAmount>=0,"InvalidPromoCodePriceOnFixedDiscount");
                               checkPrice(((newDiscountedAmount)));
                            promoCodeDetails[_promoCode].claimedUsers++;
