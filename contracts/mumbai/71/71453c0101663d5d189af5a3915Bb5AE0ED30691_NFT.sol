...
contract NFT is ERC721, Ownable {
    ...
    uint public constant MAX_TOKENS = 8;
    ...
    constructor() ERC721("The Mad Pigz", "TMPIG") {
        baseUri = "ipfs://QmY2X1RViubniRB691xBNyohTSDvZ5X4TMYBbWWMCsaL7D/";
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0xD43ebd1135E47dB300794790DF9078661a873D1f).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0xD43ebd1135E47dB300794790DF9078661a873D1f).call{value: balanceTwo}("");
