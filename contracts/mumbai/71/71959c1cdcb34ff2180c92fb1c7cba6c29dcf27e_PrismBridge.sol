...
// event emmited by the contract
    ...
    function checkOutSentinel(uint256[] calldata ids, uint256[] calldata sentinel, bytes[] memory signatures, bytes[] memory authCodes, uint256 chain) public returns (bool) {
