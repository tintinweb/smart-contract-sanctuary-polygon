...
contract Land is Royalty, AccessControl, BaseRegistrarImplementation, Pausable, TokenURISetting {
     ...
     */
    function init(address micAddress_, address payable midAddress_, address payable midBank_, address payable midLandBank_, address payable alchemistBank_) external {
