...
contract VEI is ERC20 {
    ...
    constructor() public ERC20("VEI", "VEI Token") {
...
// File contracts/core/MasterChef.sol
...
contract MasterChef is Ownable {
   ...
   //Our token
    ...
    uint256 public constant RESERVE_FUND_PERCENTAGE = 50;

    // 10% to Dev Wallet

    uint256 public constant DEV_WALLET_PERCENTAGE = 200;

    // 10% Ecosystem Fund

    uint256 public constant ECOSYSTEM_FUND_PERCENTAGE = 200;

    // 60% percentage of rewards that goes to farming rewards.
    uint256 public constant FARMING_REWARDER_PERCENTAGE = 550;
   ...
   function harvest() public {
        ...
        uint256 rewardsForDev = (tokenRewards * DEV_WALLET_PERCENTAGE) / 1000;
        uint256 rewardsForEco = (tokenRewards * ECOSYSTEM_FUND_PERCENTAGE) / 1000;

        token.mint(reserveFundsAddress,rewardsForReserves);
        token.mint(farmingRewarderAddress,rewardsForFarming);
        token.mint(devWalletAddress,rewardsForDev);
        token.mint(ecosystemFundAddress,rewardsForEco);
