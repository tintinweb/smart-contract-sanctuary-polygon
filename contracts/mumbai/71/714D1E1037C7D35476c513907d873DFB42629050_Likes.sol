...
contract Likes {
    ...
    */
    ...
    event logAddLike(uint256 indexed msgID, address indexed requester, uint256 tips);
    ...
    */
    ...
    function addLike(uint256 msgID, address likedBy, uint256 tips) public onlyAdmins {
        // Stringify the ID
        string memory msgIDStr = KUtils.toString(msgID);
        ...
        messageData.addStat(1, msgID, 1, tips);

        // Emit to the logs for external reference
        emit logAddLike(msgID, likedBy, tips);
