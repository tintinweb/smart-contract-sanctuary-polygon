...
library GnosisAuction {
    ...
    function getOTokenPremium(
        ...
        console.log( newOToken.strikePrice(),
...
console.log("optionPremium",optionPremium);
...
library VaultLifecycle {
        ...
        )
    {
        ...
        console.log(expiry, closeParams.currentOption, closeParams.period);
        ...
        console.log(closeParams.lastStrikeOverrideRound,vaultState.round);
