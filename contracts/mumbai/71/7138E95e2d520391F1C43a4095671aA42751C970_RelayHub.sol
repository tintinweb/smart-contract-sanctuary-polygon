...
// File: https://github.com/blockrockettech/PleaseRelayMe/blob/master/smart-contracts/contracts/relay/ECDSA.sol
...
// File: https://github.com/blockrockettech/PleaseRelayMe/blob/master/smart-contracts/contracts/SafeMath.sol
...
// File: https://github.com/blockrockettech/PleaseRelayMe/blob/master/smart-contracts/contracts/relay/RLPReader.sol
...
// File: https://github.com/blockrockettech/PleaseRelayMe/blob/master/smart-contracts/contracts/relay/LibBytes.sol
...
// File: https://github.com/blockrockettech/PleaseRelayMe/blob/master/smart-contracts/contracts/relay/GsnUtils.sol
...
// File: https://github.com/blockrockettech/PleaseRelayMe/blob/master/smart-contracts/contracts/relay/IRelayRecipient.sol
...
// File: https://github.com/blockrockettech/PleaseRelayMe/blob/master/smart-contracts/contracts/relay/IRelayHub.sol
...
contract RelayHub is IRelayHub {
    ...
    function stake(address relay, uint256 unstakeDelay) external payable override {
        if (relays[relay].state == RelayState.Unknown) {
            ...
            relays[relay].owner = payable(msg.sender);
    ...
    function removeRelayByOwner(address relay) public override {
        ...
        relays[relay].unstakeTime = relays[relay].unstakeDelay + block.timestamp;
    ...
    function canUnstake(address relay) public view returns (bool) {
        return relays[relay].unstakeTime > 0 && relays[relay].unstakeTime <= block.timestamp;
    ...
    function penalize(address relay) private {
        ...
        if (relays[relay].state == RelayState.Registered) {
            emit RelayRemoved(relay, block.timestamp);
        }
