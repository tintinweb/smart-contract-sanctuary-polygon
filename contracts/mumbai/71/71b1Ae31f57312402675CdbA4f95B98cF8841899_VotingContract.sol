...
contract VotingContract is Context, Ownable {
    ...
    event QuestionAdded(bytes32 indexed questionHash, address indexed proposer);
    ...
    modifier canAddQuestion() {
        require(_canVote(_msgSender()) || _msgSender() == owner(), "Low Balance");
        _;
    }
    ...
    function addQuestion(
        ...
        emit QuestionAdded(_questionHash, _msgSender());
    }
