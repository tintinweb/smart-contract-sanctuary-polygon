...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0xd8606C51492695AacCa8B52b9b0541Db3eEa73b3];
...
// File: contracts/TruthAidogeAidoContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract TruthAidogeAidoContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Truth Aidoge AIDO";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/14N6j6obn7BiSRTHQQ9E/contract-metadata";
  }
