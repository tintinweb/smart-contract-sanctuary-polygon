...
contract BoleroNFTManager is AccessControl {
    ...
    /**
     *@notice BoleroNFTSwap functions
     * */
    ...
    function getRewards() public returns (address) {
        rewards = BoleroNFTSwap.rewards();
        return rewards;
    }
    ...
    /**
     *@notice BoleroPaymentSplitter functions
     *@dev You'll need the address of the payment splitter to perform action on it
     * */
    function migratePayee(
