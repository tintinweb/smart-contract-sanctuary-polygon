...
// File: contracts/AlterBody/AlterBody.sol
  ...
  BaseRelayRecipient
{
  ...
  mapping(uint256 => AlterBodyDetails) public NFTLogs;
  ...
  event MintBatch(uint256 tokenId, address tokenOwner, AlterBodyDetails newNFT);
  ...
  function minter(
    ...
    noOfFreeMintsPerWallet[_creator] -= 1;
