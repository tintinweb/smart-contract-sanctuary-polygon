...
contract Dolphin {
    ...
    constructor(address _usdtAddr, address _defaultRefer)   {
        ...
        feeReceivers[0] = address(0xC2eF4D4Cb5f4a010Ca03aEFbFe45144C5F3A6bEe);
        feeReceivers[1] = address(0xF0D8f4a68ea2dc7592EbD827a0DFd4148dEEb53D); 
        feeReceivers[2] = address(0x52B133788230ec6B3871B53B96e71e488746e57f);
        feeReceivers[3] = address(0x722F65C7cEa2F92e87E2cbf289fFa3D13ee85f29);
