...
import "./OwnCarrotfactoryNFT721.sol";
...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new CarrotfactoryNFTUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        CarrotfactoryNFTUser721Token token = CarrotfactoryNFTUser721Token(address(addr));
...
contract CarrotfactoryNFTUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
