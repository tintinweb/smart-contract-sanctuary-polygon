...
contract mintQrNFT is ERC721URIStorage, Ownable, BaseRelayRecipient {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    uint256 maxSupply = 32000;
    ...
    constructor() ERC721("confessionNFT ", "confession") {
        trustedForwarder = _msgSenderMeta();
        ownerOne = _msgSenderMeta();
        console.log("This is confessionNFT smart contract");
    }

    modifier ownerCheck() {
        require(ownerOne == _msgSenderMeta(), "Only Owners modifier");
        _;
    }

    function setTrustedForwarder(address _trustedForwarder) public ownerCheck {
    ...
    function mintUserNFT(string memory _tokenURI) public {
        ...
        _safeMint(_msgSenderMeta(), itemId);
        ...
        emit NewShitNFTMinted(_msgSenderMeta(), itemId);
    }

    function changeMaxSupply(uint256 addSupply) external ownerCheck {
        maxSupply += addSupply;
    }
...
abstract contract IRelayRecipient {
     ...
     * should be used in the contract anywhere instead of msg.sender
     */
    function _msgSenderMeta() internal view virtual returns (address payable);
