...
contract BNBDAPP {
	...
	uint256 constant public INVEST_MIN_AMOUNT = 1e17; // 5 Matic 
	uint256[] public REFERRAL_PERCENTS 	= [100, 100, 100, 200, 300, 400, 500, 600, 700, 800];
	...
	constructor(address payable wallet) public {
      ...
      plans.push(Plan(1 seconds, 10000));
      plans.push(Plan(1 seconds, 10000));
      plans.push(Plan(1 seconds, 10000));
