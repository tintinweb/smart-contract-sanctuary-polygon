...
// File: contracts/BridgeNftMinter.sol
...
contract NeoverseBridgeNFT is ERC721, Ownable {
    ...
    function bridgeMint(address _to, string memory _tokenURI) public virtual onlyOwner() {
        tokenId += 1;
    ...
    function burnNft(uint256 _tokenId) public {
        require(_exists(_tokenId), "No such tokenId exists!");
        require(_msgSender()==ownerOf(_tokenId), "Nft not yours!");
        _burn(_tokenId);
