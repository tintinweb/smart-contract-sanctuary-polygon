...
contract HADappPreIDOSale is ERC721Enumerable, Ownable {
    ...
    uint public constant MAX_SUPPLY = 4987500;
    ...
    // PreIDOSale Presale mints
    function preIDOSale(uint _count) public payable {
        uint totalMinted = _tokenIds.current();
        uint preSalePrice = 0.05 ether;
        uint preSaleMaxMint = 1000;
