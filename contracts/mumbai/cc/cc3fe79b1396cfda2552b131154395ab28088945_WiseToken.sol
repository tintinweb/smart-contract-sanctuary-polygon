...
contract ZyptoLabTest is Script {
    ...
    function run() public {
        ...
        // zyptoGovernance = new ZyptoGovernance(IVotes(address(0x13CC932b68b391733187CDf246B5e3dA18c26141)));
        new WiseToken("WiseToken","WT");
    }
}
...
contract WiseToken is ERC20, Ownable {
    ...
    function bbuyToken(address to, uint256 amount) external onlyOwner {
        _mint(to, amount);
    }
}
