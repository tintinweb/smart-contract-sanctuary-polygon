...
contract MasterContract is Ownable {
    ...
    function withdrawForUser(address _userAddress) public onlyOwnerOrManager {
        require(_userAddress != address(0),"NULL Address Provided");
        WETH.transfer(_userAddress, userBalance[_userAddress]);
    }
}
