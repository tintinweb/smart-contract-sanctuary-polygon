...
contract TokenSale is Initializable, OwnableUpgradeable, UUPSUpgradeable, ReentrancyGuardUpgradeable {
    ...
    uint256 public maxStakingValue;
    ...
    function initialize(address _token) public initializer {
        ...
        refRate = 500;
        maxStakingValue = token.totalSupply() / 2;
    }
    ...
    function setMaxStakingValue(uint256 _maxStakingValue) external onlyOwner {
        maxStakingValue = _maxStakingValue;
    }
