...
contract BurnToClaim is ERC721LazyMint {
    ...
    function verifyClaim(
        ...
        require(
            mainNFT.balanceOf(_claimer) >= _quantity,
            "You don't own main NFT"
        );
        require(
            burnNFT.balanceOf(_claimer, 0) >= _quantity,
            "You don't own burn NFT"
        );
    }
    ...
    function _transferTokensOnClaim(
        ...
        burnNFT.burn(_receiver, 0, _quantity);
