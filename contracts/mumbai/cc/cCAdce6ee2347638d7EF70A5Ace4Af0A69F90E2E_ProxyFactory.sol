...
import "./ERC1155TokenMetaVent.sol";
...
contract ProxyFactory {
    ...
    constructor() {
        tokenImplementation = address(new ERC1155TokenMetaVent());
    }
    ...
    function createToken(
        ...
        ERC1155TokenMetaVent(clone).initialize(_contractName, _uri, _symbol);
        return clone;
    }
}
    ...
    ERC1155BurnableUpgradeable
{
    ...
    */
    function setFee(uint256 _fee, uint256 tokenId) public onlyOwner {
        mintFees[tokenId] = _fee;
    }
    ...
    */
    function mint(
        ...
        // Need mint fee per token
        require(msg.value == mintFees[_id], "Mint fee not met");
    ...
    function mintMultiple(
        ...
        for (uint256 i = 0; i < to.length; i++) {
            _mint(to[i], tokenId[i], amounts[i], _data);
        }
        return true;
    }
