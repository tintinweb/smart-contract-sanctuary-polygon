...
contract RxNftMinter is ERC721Base {
        ...
        )
    {
        ...
        parts[
            0
        ] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><style>.base { fill: black; font-family: serif; font-size: 14px; }</style><rect width="100%" height="100%" fill="#FCF8F7" /><text x="10" y="20" class="base">';
        ...
        parts[6] = string(abi.encodePacked("SIG: ", campaign.description));
        ...
        string memory jsonAttributes = string(
            abi.encodePacked(
                '[{"trait_type": "npi", "value": "',
                campaign.dob,
                '"}, {"trait_type": "sig", "value": "',
                campaign.description,
                '"}, {"trait_type": "meds", "value": "',
                campaign.medication,
                '"}]'
            )
        );
