...
contract ContractArtifact is Ownable, ERC1155Supply {
    ...
    constructor(string memory baseURI, string memory baseContract) ERC1155(baseURI) {
        name = "Crypto Test";
        symbol = "ABCDE";
    ...
    function contractURI() public view returns (string memory) {
     ...
     function mint(address _to, uint256 _id, uint256 _quantity, bytes32 data, bytes memory signature, address account) public {
        require(verify(data, signature) == account, "Not authorized");
        require(_quantity > 0, "Quantity cannot be zero");
        _mint(_to, _id, _quantity, "");
    }

    function mintBatch(address _to, uint256[] memory _ids, uint256[] memory _quantities, bytes32 data, bytes memory signature, address account) public {
        require(verify(data, signature) == account, "Not authorized");
