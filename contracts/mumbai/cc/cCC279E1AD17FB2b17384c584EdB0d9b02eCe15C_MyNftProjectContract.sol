...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x9CDA463B4a47a407Ef548fb6c41bD73536f68dEd];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmWtqgbdkhuHhh4ZFQXjfri6K7V2v5VmJ24fvvkfVSAyHr/";
...
contract MyNftProjectContract is RamppERC721A {
    constructor() RamppERC721A("My NFT  Project", "TEST"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/jzL38safyUWQSd8V7X9h/contract-metadata";
    }
}