...
contract AdminManagedSBT is Initializable, OwnableUpgradeable, AccessControlUpgradeable, SoulBound {
    ...
    function adminTransferFrom(address from, address to, uint256 tokenId) external onlyRole(ADMIN_ROLE) {
    ...
    function allowToBurn(uint256 tokenId) external onlyRole(ADMIN_ROLE) {
        _isAllowedToBurn[tokenId] = true;
    }

    function denyToBurn(uint256 tokenId) external onlyRole(ADMIN_ROLE) {
...
contract SoulBound is Initializable, IERC5192, ERC721AUpgradeable {
