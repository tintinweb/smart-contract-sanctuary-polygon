...
contract EthermonStaking is EthermonStakingBasic, EthermonEnum {
    ...
    //Ethermon.IO 0x45746865726d6f6e2e494f0000000000000000000000000000000000000000
    ...
    function updateTokens(
        ...
        TokenData memory data = stakingData.getTokenData(_lockId);
        require(data.monId < 1 || _level < 1, "Data is not valid");
        ...
        //emonsOnly = 1 || 0 * emons * data.level * rarity * data.lastCalled * data.badgeAdvantage
    ...
    // mapping address => TokenData [monId, pfpId]  //1010 / isValid = 1;
    // mapping address => TokenData [monId, pfpId]  //1010 / isValid = 0;

    // MonId => [600]

    // TODO: Setter for max and min limiting for EMONS
    ...
    //TODO: Update mon in staking data...
