...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x651462E08dF9bD06e40b31Db0C3735fAdeFC8ab4];
  address public erc20Payable = 0x651462E08dF9bD06e40b31Db0C3735fAdeFC8ab4;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 200;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 200, 200) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmfVXu9fsBqeqjS5Z4dQZJzANHPSYGvzMbwFkzqcyokaAd/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/B4kGnqyLX12hXTI99rA7/contract-metadata";
  }
...
// File: contracts/ModContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ModContract is RamppERC721A {
    constructor() RamppERC721A("MOD", "MOD"){}
}
