...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xc74CdA6b9f4851ce90d9560572035fCFfed2D537];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmSYyVxsrKtr1Vkka4ANg72kxxdGK2dAaPR2YRVERqs2Fb/";
...
// File: contracts/HrcluBbyMakiPeopleContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract HrcluBbyMakiPeopleContract is RamppERC721A {
    constructor() RamppERC721A("HR CLUB by Maki People", "HRCLUB"){}
}
