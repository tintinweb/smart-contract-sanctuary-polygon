...
contract Phase0 is ERC721, ERC721Burnable, ERC721Enumerable, Ownable{
    ...
    string private URI = "https://metacultrstorage.blob.core.windows.net/meta-test2/";
    ...
    */
    ...
    function burnNFT(uint256 tokenId, address user) external{
        require(msg.sender == ticketAddress, "Ticket: Can be called only by ticket contract");
