...
/**
    ...
    SPECS:
    - 3-6% daily
    - 200 MATIC Max Wallet TVL
    - 5 MATIC Max Reward Accumulation 
...
contract PurplebeansTest {
    ...
    uint8 private WITHDRAWAL_FEE = 3;
    ...
    uint256 private MIN_DEPOSIT = 1000000000000000000; // 0.01 MATIC
    uint256 private MIN_BAKE = 1000000000000000000; // 0.01 MATIC
    uint256 private MAX_WALLET_TVL_IN_MATIC = 200000000000000000000; // 200 MATIC
    uint256 private MAX_DAILY_REWARDS_IN_MATIC = 5000000000000000000; // 5 MATIC
    uint256 private MIN_REF_DEPOSIT_FOR_BONUS = 500000000000000000; // 0.5 MATIC
     ...
     function handleBake(bool onlyRebaking) private {
        ...
        if (onlyRebaking == true) {
            require(
                ...
                "Rewards must be equal or higher than 0.01 MATIC to bake"
            );
        }
