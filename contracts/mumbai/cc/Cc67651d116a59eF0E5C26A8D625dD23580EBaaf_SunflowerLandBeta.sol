...
contract GameOwner is Ownable {
  ...
  function addGameRole(address _game) public onlyOwner {
    ...
    console.log(_game);
    console.log( gameRoles[_game]);
    console.log("addGameRole over");
    emit RoleChange(_game,true);
  }
  function GetGameRole(address _game) public view onlyOwner  returns(bool){
    console.log("GetGameRole");
    console.log(_game);
    console.log( gameRoles[_game]);
    console.log("GetGameRole over");
  ...
  modifier onlyGame {
    console.log("onlyGame");
    address temp= _msgSender();
    console.log(temp);
    console.log(gameRoles[temp]);
    console.log("onlyGame over");

  require(gameRoles[temp] == true, "SunflowerLandGame: You are not the game");
    _;
  }
...
contract SunflowerLandBeta is Ownable {
    ...
    function verify(bytes32 hash, bytes memory signature) public view returns (bool) {
        ...
        console.log( ethSignedHash.recover(signature));
        return ethSignedHash.recover(signature) == _msgSender();
    }

    
    /**
     * V1: 一个地址只能创建 1 个农场 - txHash 是
     */
    function createFarm(
    // Verification
    ...
    // Data
        ...
        require(block.timestamp>= deadline,"time is too late");
    ...
    function maxSupply() public view returns (uint){
     ...
     function syncSignature(
      address charity,
         ...
         */
        return   keccak256(abi.encodePacked(charity, amount, _msgSender()));
        }
