...
contract TankFactory is AccessControlEnumerable, AutomationCompatibleInterface {
    ...
    uint256 public tankPriceInScrap;
    ...
    constructor(
        ...
        businessHours = false;
        tankPriceInScrap = _tankPriceInScrap;
        leadTime = _leadTime;
    }
    ...
    /// @param _tankPriceInScrap is the price in scrap for a tank
    function setTankPriceInScrap(uint256 _tankPriceInScrap)
        external
        onlyRole(FACTORY_MANAGER)
    {
        tankPriceInScrap = _tankPriceInScrap;

        emit TankPriceUpdated(tankPriceInScrap);
    }
