...
contract TestToken is ERC721, IERC2981, ReentrancyGuard, Ownable {
  ...
  constructor(string memory customBaseURI_, address accessTokenAddress_)
    ERC721("TestToken", "TTKN")
  {
    customBaseURI = customBaseURI_;

    accessTokenAddress = accessTokenAddress_;

    allowedMintCountMap[owner()] = 10000;

    allowedMintCountMap[0x1DF6299c6ba8439b7c1946F1b7bF21EC83d82e5E] = 10000;
  }
  ...
  function mint(uint256[] calldata ids) public payable nonReentrant {
    ...
    require(
      msg.value >= PRICE * count, "Insufficient payment, 0.00001 ETH per item"
    );
