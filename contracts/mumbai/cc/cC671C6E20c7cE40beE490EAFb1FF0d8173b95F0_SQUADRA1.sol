...
contract SQUADRA1 {
    ...
    // Funzione per trasferire un giocatore da un altro contratto 
    function transferPlayer(SQUADRA1 _from, uint _index) public {
        (string memory name, uint age, string memory position, uint price, bool forSale) = _from.getPlayer(_index);
