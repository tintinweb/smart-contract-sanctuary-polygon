    ...
    UUPSUpgradeable
{
    ...
    CountersUpgradeable.Counter private _maskIds;
    ...
    function initialize(
        ...
        __GoldFeverMask_init(admin, gfiContract_, nglContract_, itemTypeContract_);
    }

    function __GoldFeverMask_init(
        address admin,
        address gfiContract_,
        address nglContract_,
        address itemTypeContract_
        ...
        __ERC721_init("GFMask", "GFM");
        __GoldFeverMask_init_unchained(admin, gfiContract_, nglContract_, itemTypeContract_);
        __UUPSUpgradeable_init();
    }

    function __GoldFeverMask_init_unchained(
        address admin,
        address gfiContract_,
        address nglContract_,
        address itemTypeContract_
    ...
    function unforgeMask(uint256 maskId) external nonReentrant {
        ...
        require(msgSender == owner, "GoldFeverMask: Only owner can unforge");
    ...
    function updateForgeMaskFee(uint256 _fee)
        external
        nonReentrant
        only(DEFAULT_ADMIN_ROLE)
    {
    ...
    function updateUnforgeMaskFee(uint256 _fee)
        external
        nonReentrant
        only(DEFAULT_ADMIN_ROLE)
    {
    ...
    function withdrawCollectedFee() external nonReentrant only(COMPANY_ROLE) {
    ...
    function purchaseMask(uint256 maskId) external nonReentrant {
        ...
        require(
            _msgSender() == owner,
            "GoldFeverMask: Only owner can purchase"
        );
        require(
            idToMask[maskId].status == FORGED,
