...
interface IVCMarketplaceAuctionPoCNft {
    ...
    /**
     * @dev Allows a token owner, i.e. msg.sender, to auction an ERC721 pocNft with a given initial price and duration.
     *
...
import "./IVCMarketplaceAuctionPoCNft.sol";

contract VCMarketplaceAuctionPoCNft is IVCMarketplaceAuctionPoCNft, VCMarketplaceBasePoCNft, ERC721Holder {
    ...
    /**
     * @dev See {IVCMarketplaceAuctionPoCNft-listAuction}.
     */
    function listAuction(
        uint256 _tokenId,
        uint256 _initialPrice,
        ...
        _newList(ListingData(_tokenId, _initialPrice, _projectIds, _projectFeesBps), maturity);
    }

    /**
     * @dev See {IVCMarketplaceAuctionPoCNft-unlistAuction}.
     */
    function unlistAuction(uint256 _tokenId) public {
        ...
        emit MktUnlistedAuction(msg.sender, address(pocNft), _tokenId);
    }

    /**
     * @dev See {IVCMarketplaceAuctionPoCNft-bid}.
     */
    function bid(uint256 _tokenId, uint256 _amount) public whenNotPaused {
        ...
        emit MktBid(msg.sender, listing.seller, _tokenId, address(pocNft), _amount, marketFee, starterFee, poolFee);
    }

    /**
     * @dev See {IVCMarketplaceAuctionPoCNft-settle}.
     */
