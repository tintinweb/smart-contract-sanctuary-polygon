...
pragma solidity ^0.8.17;
    ...
    contract Crowdsale {
        ...
        uint256 public roundAmountSupply;
        uint256 public tokensold;
        uint public percentage;

        uint256 public round0_Rate;
        ...
        constructor() {
            ...
            round0_Rate = 0 ether;
            round1_Rate = 0.45 ether;
            round2_Rate = 0.55 ether;
            round3_Rate = 0.65 ether;
            rate = round1_Rate;
            round = 1;
        ...
        round = _round;
            ...
            if (round == 1) {
                supply = round1_Supply;
                rate = round1_Rate;
                roundAmountSupply = round1_Supply;
            } else if (round == 2) {
                supply = round2_Supply;
                rate = round2_Rate;
                roundAmountSupply = round2_Supply;
            } else if (round == 3) {
                supply = round3_Supply;
                rate = round3_Rate;
                roundAmountSupply = round3_Supply;
            } else if (round == 0) {
                supply = round0_Supply;
                rate = round0_Rate;
                roundAmountSupply = round0_Supply;
            }
        }
        ...
        function buyTokens() public payable {
            ...
            tokensold = roundAmountSupply - supply;
            percentage = (tokensold * 100 / roundAmountSupply);
            tokens = 0;
