 ...
 * OasisX protocol shared asset contract - A contract for easily creating custom assets on OasisX
 */
...
/**
 * @title AssetContract
 * AssetContract - A contract for easily creating non-fungible assets on OasisX protocol.
 */
