...
contract PolyFlipNFTMint is Ownable, ERC721Enumerable {
     ...
     */
    function MintPolyFlipNft(uint16 _mintNum) external payable {
        ...
        for (uint16 inx = 0; inx < _mintNum; inx++) {
     ...
     * @param _mintNum the amount which mint per once
     */
    function mintTest1(uint16 _mintNum) external payable {
        require(_mintNum <= 5 && _mintNum >= 1, "mintNum err");
        require(mintedCountMap[msg.sender] + _mintNum <= 20, "too many minted");
     ...
     * @param _mintNum the amount which mint per once
     */
    function mintTest2(uint16 _mintNum) external payable {
        require(_mintNum <= 5 && _mintNum >= 1, "mintNum err");
        require(mintedCountMap[msg.sender] + _mintNum <= 20, "too many minted");
