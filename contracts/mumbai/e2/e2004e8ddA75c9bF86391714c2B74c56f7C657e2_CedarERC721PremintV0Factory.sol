...
import "./CedarERC721PremintV0.sol";
import "./api/deploy/ICedarDeployer.sol";

contract CedarERC721PremintV0Factory is Ownable, ICedarDeployerEventsV0, ICedarImplementationVersionedV0 {
    CedarERC721PremintV0 public implementation;
    ...
    constructor(address _greenlistManagerAddress) {
        ...
        implementation = new CedarERC721PremintV0();
        ...
        emit CedarImplementationDeployed(address(implementation), major, minor, patch, "CedarERC721PremintV0");
    }
    ...
    function deploy(
    ...
    ) external onlyOwner returns (CedarERC721PremintV0 newClone) {
        newClone = CedarERC721PremintV0(Clones.clone(address(implementation)));
        ...
        emit CedarERC721PremintV0Deployment(
            address(newClone),
            major,
            minor,
            patch,
...
import "./generated/impl/BaseCedarERC721PremintV0.sol";
 ...
 * @author Monax Labs
 */
contract CedarERC721PremintV0 is
    OwnableUpgradeable,
    ERC721AUpgradeable,
    ERC2981,
    Greenlist,
    ...
    BaseCedarERC721PremintV0
{
    ...
    function mintBatch(uint256 _quantity, address _to) external override onlyOwner {
        require(
            ...
            "CedarERC721PremintV0: max limit exceeded, reverting batch call"
        );
        _mint(_to, _quantity);
        tokenId += _quantity;
    }
    ...
    */
        ...
        if (_to != owner()) {
            ...
            if (termsActivated) {
                require(
                    ...
                    string(
                        abi.encodePacked(
                            "CedarERC721PremintV0: Receiver address has not accepted the collection's terms of use at ",
                            ownerDomain
                        )
                    )
                );
    ...
    function supportsInterface(bytes4 interfaceId)
        public
        view
        override(BaseCedarERC721PremintV0, ERC721AUpgradeable, ERC2981)
        returns (bool)
    {
...
// Filename: './BaseCedarERC721PremintV0.sol'
...
abstract contract BaseCedarERC721PremintV0 is ICedarERC721PremintV0 {
    ...
    function supportsInterface(bytes4 interfaceID) virtual override public view returns (bool) {
        return (interfaceID == type(IERC165Upgradeable).interfaceId) || ((interfaceID == type(ICedarFeaturesV0).interfaceId) || ((interfaceID == type(ICedarVersionedV0).interfaceId) || ((interfaceID == type(ICedarPremintV0).interfaceId) || ((interfaceID == type(ICedarAgreementV0).interfaceId) || (interfaceID == type(IMulticallableV0).interfaceId)))));
    }
