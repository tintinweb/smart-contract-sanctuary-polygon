...
contract Darabase is NFTContract{
    ...
    function renewRental(
        ...
        uint remaining = doPlatformPayment(msg.sender, totalPayment, sellOrder.payment, platformPayment);
        doPaymentTransfer(msg.sender, remaining, sellOrder.maker, sellOrder.payment, true);
        updateRental(sellOrder.pdrId, sellOrder.rentalId, startTime, endTime);
...
contract NFTContract is ERC1155, Ownable, Pausable{
    ...
    function transferRWO(
        ...
        address from = getRwoOwner(rwoId);
        require(msg.sender == admin || msg.sender == owner() || msg.sender == from, "Only admin/owner/RWOOwner");
        ...
        for(uint256 i=0; i< rwoToPdr[rwoId].length; i++){
            ...
            _safeTransferFrom(from, to, pdrId, pdrAmount, "");
        ...
        _safeTransferFrom(from, to, rwoId, balanceOf(from, rwoId), "");
    ...
    function burnNFTId(
        ...
        // RWO token id
        require(tokenType[nftID] == TokenType.RWO, "Only RWO");
