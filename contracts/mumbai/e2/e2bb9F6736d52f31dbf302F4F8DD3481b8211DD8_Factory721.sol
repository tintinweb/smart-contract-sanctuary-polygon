...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new TopProspectUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        TopProspectUser721Token token = TopProspectUser721Token(address(addr));
...
contract TopProspectUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
