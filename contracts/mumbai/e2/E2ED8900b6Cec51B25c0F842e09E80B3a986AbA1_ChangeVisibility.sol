...
contract ChangeVisibility is IExecutePlugin, BasePluginWithRules {
    ...
    constructor(address _registry) {
        PLUGIN_VERSION = 1;
        PLUGIN_NAME = PluginsList.SINGLE_CHANGE_VISIBILITY_POST;
    ...
    function execute(
        ...
        require(currentOwner == _sender, "ChangeVisibility: wrong owner");
        ...
        ISinglePostData singlePost = ISinglePostData(registry.singlePostData());
        require(singlePost.setVisibility(vars),
