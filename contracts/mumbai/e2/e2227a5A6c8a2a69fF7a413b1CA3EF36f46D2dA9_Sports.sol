...
import {ERC20, IERC20, ERC1363} from "./erc1363/ERC1363.sol";
import {AccessControl} from "@openzeppelin/contracts/access/AccessControl.sol";

contract Sports is ERC1363, ERC20Capped, ERC20Permit, AccessControl {
    using SafeERC20 for IERC20;

    /// @notice The maximum amount of tokens that can be minted.
    uint256 internal CAP = 68_000_000e18;

    /// @notice The role that can mint new tokens.
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    /// @dev Emitted when any ERC20 tokens are swept from this contract
     ...
     * Only callable by the minter role.
    ...
    /**
     * @notice Sweeps any ERC20 tokens from this contract
