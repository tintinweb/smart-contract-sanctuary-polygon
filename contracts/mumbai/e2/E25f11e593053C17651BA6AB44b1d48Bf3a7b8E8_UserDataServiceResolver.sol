 ...
 */
   ...
   Counters.Counter internal _tokenIndex;
    ...
    function createNewAccount(address _accountWalletAddress, string memory accountName) external {
    ...
    function createNewAccount(address _accountWalletAddress) external {
