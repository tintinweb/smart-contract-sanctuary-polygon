...
contract MyNft is ERC721, Ownable, ERC2981 {
    ...
    uint256 public immutable supply = 8;
    ...
    address[] public withdrawAddresses = [0x11eec0923C7c49796482cdEB4F158b348166a783];
    uint256[] public withdrawPercentages = [100];


    bytes32 public merkleRoot = 0;

    constructor() ERC721("test3", "test") {
        _baseTokenURI = "https://test-api.nftool.io/generator-server/api/contract/v1/qqEfLYrJ5bgVO06N1/1610473407195471874/metadata/";
        _setDefaultRoyalty(0x11eec0923C7c49796482cdEB4F158b348166a783, uint96(0));
    }
