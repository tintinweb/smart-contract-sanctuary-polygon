...
contract Economics is IEconomics, AuthModifiers, OwnableUpgradeable, ReentrancyGuardUpgradeable, UUPSUpgradeable {
    ...
    */
    function spendBasicAction(address _relayerAddress, uint32 _ticketCount) external onlyEvent returns (uint256) {
        ...
        uint256 _fuelToSpend = (basicTaxRate * _reservedFuelPerTicket(_relayerAddress) * _ticketCount) / 1e6;
    ...
    */
    function spendTicketReserved(address _relayerAddress, uint32 _ticketCount) external onlyEvent returns (uint256) {
        ...
        uint256 _fuelToSpend = _reservedFuelPerTicket(_relayerAddress) * _ticketCount;
    ...
    */
    ...
    function _reservedFuelPerTicket(address _relayerAddress) internal view returns (uint256) {
        IntegratorData storage integrator = integratorData[relayerData[_relayerAddress].integratorIndex];
    ...
    function viewIntegratorAveragePrice(address _relayerAddress) external view returns (uint256) {
        return integratorData[relayerData[_relayerAddress].integratorIndex].price;
    }

    function viewIntegratorAvailableFuel(address _relayerAddress) external view returns (uint256) {
        return integratorData[relayerData[_relayerAddress].integratorIndex].availableFuel;
    }
