...
contract DeCarbEscrow is Ownable {
    ...
    function openCarbonEscrow(
        ...
        escrowID = keccak256(abi.encode(_projectID, _vintage, _tCO2, _nonce));
        ...
        // emit EscrowCreated(escrowID, _escrowValue, (_escrowPeriod / 3600));
    ...
    function cancelEscrow(bytes32 _escrowID) public {
        require(isValidEscrowId[_escrowID], "Not a valid ID");
        Escrow storage escrow = escrowIdToEscrow[_escrowID];
        require(msg.sender == escrow.creator, "Not Authorised");
        require(
        ...
        // Deposit fee is with treasury. it may be returned after deducting fee.
    }
