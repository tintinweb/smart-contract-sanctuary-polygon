...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmNnZ9gXgL6YXR61rHZeHncfDk4kd9o7g3Kb5Sb39EHVbz/";
...
// File: contracts/KnightV11ArtualistContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract KnightV11ArtualistContract is RamppERC721A {
    constructor() RamppERC721A("Knight V 11  Artualist", "KNTV1"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/PkkXL80kIuSVbYULnqto/contract-metadata";
    }
}