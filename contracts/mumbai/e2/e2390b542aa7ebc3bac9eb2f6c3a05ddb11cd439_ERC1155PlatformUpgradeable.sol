...
contract ERC1155PlatformUpgradeable is Initializable,ERC1155PausableUpgradeable,ReentrancyGuardUpgradeable,OwnableUpgradeable,AccessControlEnumerableUpgradeable,UUPSUpgradeable
{
    ...
    function initialize(string memory contract_uri, address admin) public initializer {
        //Dependencies initialization: (NEVER FORGET: If inheritating from other contracts, please initialize them!)
        ...
        if(admin != address(0)) { _grantRole(DEFAULT_ADMIN_ROLE,admin); } //allows a centralized admin control, if wanted.
    }
     ...
     *
     */
    function mint(address to, uint256 tokenId, uint256 amount, string memory contract_uri, bool burnable) public nonReentrant onlyRole(MINTER_ROLE)
    {
     ...
     *
     */
    function burnToken(address contract_address, uint256 tokenId, uint256 amount) public nonReentrant onlyRole(BURNER_ROLE)
    {
     ...
     *
     */
    function pause() public onlyRole(PAUSER_ROLE) whenNotPaused { _pause(); }
     ...
     *
     */
    function unpause() public onlyRole(PAUSER_ROLE) whenPaused { _unpause(); } 

    function supportsInterface(bytes4 interfaceId) public view override(ERC1155Upgradeable, AccessControlEnumerableUpgradeable) returns (bool) { return super.supportsInterface(interfaceId); }
