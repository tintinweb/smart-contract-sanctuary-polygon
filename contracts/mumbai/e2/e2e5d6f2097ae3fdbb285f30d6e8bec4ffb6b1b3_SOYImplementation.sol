...
// File: contracts/SOYImplementation.sol
...
contract SOYImplementation {
    ...
    string public constant name = "SOYBEAN"; // solium-disable-line
    string public constant symbol = "SOY"; // solium-disable-line uppercase
    ...
    // ex: a fee rate of 200 = 0.02% of an bushel of soybeans
