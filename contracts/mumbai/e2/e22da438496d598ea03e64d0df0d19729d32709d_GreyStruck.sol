...
contract GreyStruck is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    constructor() ERC721("GreyStruck", "GREY") {}
    ...
    function _baseURI() internal override(ERC721) view virtual returns (string memory) {
        return "ipfs://QmdCG2cv4yz4EWMPmtskKuKpWiSeQBZbSgQYy7YT8zReja/";
    }
