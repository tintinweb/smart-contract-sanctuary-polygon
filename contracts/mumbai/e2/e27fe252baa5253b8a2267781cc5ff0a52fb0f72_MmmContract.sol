...
contract MmmContract is Ownable {
    ...
    function getOuter() public view returns (address) {
        return ones;
        return twos;
        return thrs;
        return fous;
    ...
    function setOuter(address oneAddress, address twoAddress, address thrAddress, address fouAddress) public onlyOwner {
        ones = oneAddress;
        twos = twoAddress;
        thrs = thrAddress;
        fous = fouAddress;
