...
contract Dao {
    ...
    constructor(){
        ...
        validTokens = [109500032739700313117846014794234681497094515046728247747779338779192442486884];
    }
    ...
    function voteOnProposal(uint256 _id, bool _vote) public {
        ...
        require(block.number <= Proposals[_id].deadline, "Deadline has passed!");
    ...
    function countVotes(uint256 _id) public {
        ...
        require(Proposals[_id].exists, "No proposal existing");
        require(block.number > Proposals[_id].deadline, "Deadline has passed!");
