...
contract Counter is AutomationCompatibleInterface {
    ...
    lyncrentTime public lyncAddress;
    address _owner;
    /**
    ...
    constructor(uint256 updateInterval, address payable addLync) {
        ...
        _owner = msg.sender;
        lyncAddress = lyncrentTime(addLync);
    }
    ...
    function setLyncAddress(address payable _lyncAddress) external {
        ...
        lyncAddress = lyncrentTime(_lyncAddress);
    }
}
...
contract lyncrentTime is ReentrancyGuard {
        ...
        )
    {
        ...
        autoWithdrawProceeds(_sellerAddress);
    ...
    function autoWithdrawProceeds(address _sellerAddress) internal {
        uint256 proceeds = s_proceeds[_sellerAddress];
        if (s_proceeds[_sellerAddress] <= 0) {
            revert NoProceeds();
        }
    ...
    function checkAndReturnRentedNfts() external {
        ...
        (RentersArrayStruct[] memory getExpired, uint toupdate ) = checkTokenDurationExp();
        if(toupdate > 0){
