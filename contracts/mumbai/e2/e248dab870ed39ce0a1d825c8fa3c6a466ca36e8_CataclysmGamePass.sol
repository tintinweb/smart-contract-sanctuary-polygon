...
contract CataclysmGamePass is Ownable,ERC721,ERC721Enumerable {

    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    string _base64Description = '';
    string _metadataURI;
    uint256 public price;

    constructor(string memory name,string memory symbol,string memory metadataURI) ERC721(name,symbol) {
                ...
                Base64.encode(
                    bytes(
                        abi.encodePacked(
                            ...
                            '","description":"Play with Cataclysm: Space Travel!",', 
                            '"external_link": "https://www.cataclysm-game.com",', 
                            '"image":"',
                            _baseURI(),
                            _metadataURI,
                            '"}'
