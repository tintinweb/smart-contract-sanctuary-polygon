...
contract MyNft is ERC721, Ownable, ERC2981 {
    ...
    uint256 public immutable supply = 2;
    ...
    address[] public withdrawAddresses = [0x54D8Bd1f2fB8705D8A7643b8FEe510cd74086724];
    uint256[] public withdrawPercentages = [100];


    bytes32 public merkleRoot = 0;

    constructor() ERC721("demo5", "55") {
        _baseTokenURI = "https://test-nft-tool-gateway-api.tuoluo.net/generator-server/api/contract/v1/xAeD63AP3hmekob10/1605113352566972418/metadata/";
        _setDefaultRoyalty(0x54D8Bd1f2fB8705D8A7643b8FEe510cd74086724, uint96(0));
    }
