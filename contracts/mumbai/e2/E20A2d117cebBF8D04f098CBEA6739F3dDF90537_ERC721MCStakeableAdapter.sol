...
contract ERC721MCStakeableAdapter is IMissionControlStakeable, OwnableUpgradeable, ERC721HolderUpgradeable {
    ...
    */
    ...
    function _getT(
        ...
        T = (_max_div(int256(DAY_IN_SEC) * MAX_SCALE, int256(resourceEV) * MAX_SCALE) * _exponential_2(tokenId, seed)) / (MAX_SCALE * MAX_SCALE);
    }
    ...
    function _exponential_2(uint256 tokenId, int256 seed) internal pure returns (int256 exponential_sample) {
        exponential_sample = -_max_ln(MAX_SCALE - _max_div(MAX_SCALE * int256(_uniform(tokenId, seed)), MAX_SCALE * int256(PROBA_RES)));
    }
