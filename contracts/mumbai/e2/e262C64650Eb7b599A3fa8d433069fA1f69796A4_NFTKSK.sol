...
contract NFTKSK is ERC721, AxelarExecutable, ERC721URIStorage, ERC721Burnable, Ownable  {
    ...
    constructor(address gateway_, address gasReceiver_) ERC721("KhmerSlKhmer", "KSK") AxelarExecutable(gateway_){
