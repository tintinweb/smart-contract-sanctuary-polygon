...
contract WowTCommunityPoll is OwnableUpgradeable, AccessControlUpgradeable {
  ...
  emit pollVoted(_communityName, "poll", _pollId);
    ...
    function getPoll(string calldata _communityName, uint256 _pollId) public view returns (string memory, string[] memory, uint256[] memory, uint256, address, string memory) {
        ...
        return (poll.question, poll.options, voteCounts, poll.timestamp, poll.creator, poll.userName);
    }
}
