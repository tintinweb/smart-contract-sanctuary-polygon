...
import "@thirdweb-dev/contracts/openzeppelin-presets/token/ERC20/extensions/ERC20Votes.sol";
...
contract cDAOToken is ERC20DropVote, PermissionsEnumerable {
    constructor(string memory _name, string memory _symbol, address _primarySaleRecipient)
        ERC20DropVote(_name, _symbol, _primarySaleRecipient)
    {
