...
contract TokenLocker is Ownable {
    ...
    function setAddresses(IERC20 _topia) external onlyOwner {
        TOPIA = _topia;
    ...
    /**
        ...
        @param _amount Amount of TOPIA to lock. This balance transfered from the caller.
    ...
    function lock(
        ...
        TOPIA.safeTransferFrom(msg.sender, address(this), _amount);
    ...
    /**
        ...
        @param _amount Amount of TOPIA to extend the lock for. When the value given equals
    ...
    function withdrawExitStream() external returns (bool) {
        ...
        if (stream.start > 0) {
            ...
            TOPIA.safeTransfer(msg.sender, amount);
        }
    ...
    /**
        @notice Get the amount of TOPIA in expired locks that is
    ...
    /**
        @notice Get the amount of TOPIA available to withdraw
