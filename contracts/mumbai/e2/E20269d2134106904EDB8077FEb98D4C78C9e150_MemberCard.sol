...
interface IMemberCard {
    ...
    //function approveMint(address _minter) external;
...
contract MemberCard is IMemberCard, ERC721, ERC2981, AccessControlEnumerable {
    ...
    function setPaused(bool _paused) external onlyRole(PLATFORM) {
        paused = _paused;
    }
    ...
    function setPayoutFee (uint  _fee) public onlyRole(OWNER) {
        s_payoutFee = _fee;
    }
