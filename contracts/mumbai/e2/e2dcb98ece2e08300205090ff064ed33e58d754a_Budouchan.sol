...
contract Budouchan is ERC1155, ERC2981, Ownable, ReentrancyGuard {
    string public name = "Budou Test"; //本番デプロイ時変更
    string public symbol = "bt"; //本番デプロイ時変更
    ...
    constructor() ERC1155("") {
        setOptions(
            0,
            "https://arweave.net/0D06yyJkqOqlgm_AcT3_D0yM5Pr0_ljj_Ft4TcQcN5k/a.json",
            100,
            2,
            false,
            100000000000000000,//例：0.1matic
            true
        );
    }
