...
contract Marketplace {
    ...
    function listEstate(uint256 _estateID, uint256 _cost, address _owner) external {
        require(estates[_estateID].listed == false,"ESTATE_ALREADY_LISTED");
        require(estateCollection.ownerOf(_estateID)== _owner,"YOU_ARE_NOT_OWNER_OF_THE_ESTATE");
    ...
    function releasePayment(uint256 _estateID) public payable {
        ...
        estateCollection.safeTransferFrom(estates[_estateID].seller, msg.sender, _estateID);
