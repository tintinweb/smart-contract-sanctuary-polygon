...
contract LandSalePayment is Ownable, ReentrancyGuard{
    ...
    constructor(address _FTaddress, address _NFTaddress, string[5] memory _category, uint256[] memory _priceInUSD, uint256[] memory _maxCategorySupply/*, uint256[] memory _slot, uint256[] memory _startTime, uint256[] memory _endTime, bool[][] memory _status*/){
