...
contract TokenTimelock is Ownable, ReentrancyGuard{   
    ...
    mapping(address => bool) private co_founders_wallets;

    uint public monthlyAmount = 0.1 ether;
