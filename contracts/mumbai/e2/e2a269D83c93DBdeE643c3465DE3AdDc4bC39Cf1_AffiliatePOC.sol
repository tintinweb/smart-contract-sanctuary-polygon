...
contract AffiliatePOC is ERC721, ReentrancyGuard, Signable, AccessControl {
  ...
  // index the rId and add it as data
  // this allows us to search for the string AND read the value in our logs
  event SaleEvent(string indexed rId, string _rId, uint256 amount);
