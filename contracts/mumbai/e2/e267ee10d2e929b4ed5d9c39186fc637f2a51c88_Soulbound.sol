...
contract Soulbound is ERC721, ERC721URIStorage, Ownable {
    ...
    function safeMint(address to, string memory uri) public {
        require(whitelist[to] == false, "already minted");
    ...
    function isWhitelisted(address _isWhitelist) public view returns(bool){
        return whitelist[_isWhitelist];
    }
