...
contract ChainBattles is ERC721URIStorage {
    ...
    function generateCharacter(uint256 tokenId) public returns(string memory){
        ...
        bytes memory svg = abi.encodePacked(
            ...
            '<text x="50%" y="30%" class="base" dominant-baseline="middle" text-anchor="middle">',"Degen Hero",'</text>',
    ...
    function mint() public {
        ...
        tokenIdToLevels[newItemId] = Stats(0,random(100),random(100),random(100));
    ...
    function train(uint256 tokenId) public {
        ...
        tokenIdToLevels[tokenId] = Stats(currentLevel + 1, currentSpeed + random(2), currentStrength +random(2), currentLife+random(2) );
