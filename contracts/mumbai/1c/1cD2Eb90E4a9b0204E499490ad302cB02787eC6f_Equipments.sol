...
contract Equipments is ERC721, ERC721Enumerable, Ownable {
    ...
    function encodeStats(equipment_stats memory _stats) internal pure returns (string memory stats_uri){
        stats_uri = string(abi.encodePacked(
                            ...
                            '}, {"display_type": "number", "trait_type": "Evade Chance %", "max_value": 100, "value": ', Strings.toString(_stats.eva / 10),
                            '}, {"display_type": "number", "trait_type": "HP", "max_value": 100, "value": ', Strings.toString(_stats.hp),
                            '}, {"display_type": "number", "trait_type": "Penetration Chance %", "max_value": 100, "value": ', Strings.toString(_stats.pen / 10),
                            '}, {"display_type": "number", "trait_type": "Critical Chance %", "max_value": 100, "value": ', Strings.toString(_stats.crit / 10),
                            '}, {"display_type": "number", "trait_type": "Luck %", "max_value": 100, "value": ', Strings.toString(_stats.luck / 10),
                            '}, {"display_type": "number", "trait_type": "Energy Restoration %", "max_value": 100, "value": ', Strings.toString(_stats.energy_regen / 10)
        ));
    }
