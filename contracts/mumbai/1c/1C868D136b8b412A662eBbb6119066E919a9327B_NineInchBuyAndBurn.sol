...
// File: contracts/BBCBuyAndBurnV3.sol

// P1 - P3: OK
pragma solidity 0.6.6;

// BBCBuyAndBurn is a contract that converts received LP tokens from platform fees for BBC and then burns it.
// The caller of convertMultiple, the function responsible for converting fees to BBC earns a 0.1% reward for calling.
contract NineInchBuyAndBurn is Ownable, ReentrancyGuard {
    ...
    modifier onlyAuth() {
        require(isAuth[_msgSender()], "BBCBuyAndBurn: FORBIDDEN");
        _;
    }
    ...
    modifier onlyEOA() {
        ...
        require(msg.sender == tx.origin, "BBCBuyAndBurn: must use EOA");
        _;
    }
    ...
    function convertMultiple(
        ...
        require(anyAuth || isAuth[_msgSender()], "BBCBuyAndBurn: FORBIDDEN");
        ...
        for (i = 0; i < len; i++) {
            ...
            require(address(pair) != address(0), "BBCBuyAndBurn: Invalid pair");
        ...
        // final step is to swap all WETH to BBC and burn it
    ...
    function _burnTokens(address token) internal returns (uint amount) {
        ...
        //BBC.burn(amount);
        //BBC.transfer(address(0xdead), amount);
    ...
    function _swap(
        ...
        require(address(pair) != address(0), "BBCBuyAndBurn: Cannot convert");
        ...
        require(
            ...
            "BBCBuyAndBurn: slippage too high"
        );
    ...
    function _getAmountOut(
        ...
        require(amountIn > 0, "BBCBuyAndBurn: INSUFFICIENT_INPUT_AMOUNT");
        require(
            reserveIn > 0 && reserveOut > 0,
            "BBCBuyAndBurn: INSUFFICIENT_LIQUIDITY"
        );
