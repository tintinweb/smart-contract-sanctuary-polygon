...
contract Chat {
    ...
    constructor() {
        ...
        users[0x7B60eD2A82267aB814256d3aB977ae5434d01d8b] = User("Admin", "[email protected]", true,0x603C4Ae498fd4147B4dF6378A5f16B150336f5Ef,true);
        userAddresses.push(0x7B60eD2A82267aB814256d3aB977ae5434d01d8b);
        users[0x8455022A4Ef3044A3B0949517D8aA0006054403d] = User("H'nifa", "[email protected]", true,0x7fD3E2234101c7a3A97E6839E2828Ff72112a107,false);
