...
contract Tax is CollateralWrapper {
   ...
   function setTaxStakingPercent(uint256 newTaxStakingPercent) external onlyOwner {
        require(newTaxStakingPercent <= 100 && newTaxStakingPercent > 0, "Tax must be greater than 0 and smaller than 100%");
         require(_totalTaxPercentage() <= 100, "Total tax percentage cannot exceed 100");
        taxStakingPercent = newTaxStakingPercent;
    }
    
   function setTaxDGPercent(uint256 newTaxDGPercent) external onlyOwner {
        require(newTaxDGPercent > 0 && newTaxDGPercent <=100 , "Tax must be greater than 0 and smaller than 100%");
         require(_totalTaxPercentage() <= 100, "Total tax percentage cannot exceed 100");
        taxDGPercent = newTaxDGPercent;
    }
    
   function setTaxJSPercent(uint256 newTaxJSPercent) external onlyOwner {
        require(newTaxJSPercent > 0 && newTaxJSPercent <=100 , "Tax must be greater than 0 and smaller than 100%");
        require(_totalTaxPercentage() <= 100, "Total tax percentage cannot exceed 100");
        taxJSPercent = newTaxJSPercent;
    }
    
   function setTaxAggPercent(uint256 newTaxAggPercent) external onlyOwner {
        require(newTaxAggPercent > 0 && newTaxAggPercent <=100 , "Tax must be greater than 0 and smaller than 100%");
         require(_totalTaxPercentage() <= 100, "Total tax percentage cannot exceed 100");
        taxAggPercent = newTaxAggPercent;
    }
    
   function setTaxOpPercent(uint256 newTaxOpPercent) external onlyOwner {
        require(newTaxOpPercent > 0 && newTaxOpPercent <=100 , "Tax must be greater than 0 and smaller than 100%");
         require(_totalTaxPercentage() <= 100, "Total tax percentage cannot exceed 100");
        taxOpPercent = newTaxOpPercent;
    }
    
   function setTaxSlPercent(uint256 newTaxSlPercent) external onlyOwner {
        require(newTaxSlPercent > 0 && newTaxSlPercent <=100 , "Tax must be greater than 0 and smaller than 100%");
         require(_totalTaxPercentage() <= 100, "Total tax percentage cannot exceed 100");
    ...
    return taxStakingPercent + taxDGPercent + taxJSPercent + taxAggPercent + taxOpPercent + taxSlPercent;
    }
...
contract WosPackages is ReentrancyGuard, Ownable, Tax {
    ...
    function buyArtifact(uint256 id) external {
