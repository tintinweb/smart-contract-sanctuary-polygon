...
contract GameItem is ERC721URIStorage {  // Definisce il contratto GameItem e lo eredita da ERC721URIStorage
    ...
    constructor() ERC721("Financial", "FC") {}  // Costruttore del contratto che chiama il costruttore del contratto ERC721 e gli assegna il nome "GameItem" e il simbolo "ITM"
