...
contract Brillion is ERC721, Ownable{
...
//Public Functions
    ...
    function mint(address _reciver, uint _amountForMint) public checkMint() {
        require(
            _amountForMint > 0, 
        ...
        for( uint i = 0; i < _amountForMint; i++){
            ...
            tokenSupply++;
            _mint(_reciver, tokenSupply);

            emit Mint(_reciver, tokenSupply);
        }
    }
