...
contract CryptoPenguin {
    ...
    function addToCollection(address tokenContract, string memory tokenId, string memory title, string memory imageUrl, string memory name) public {
        Collectible memory c = Collectible(tokenContract, tokenId, title, imageUrl, name);
