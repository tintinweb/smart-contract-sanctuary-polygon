...
contract AuctionWithAdmin is Ownable {
    ...
    function getAuctionServiceFeeEnable() public view returns (bool){
        return auction_service_fee;
    }

    function getAuctionTokenFee() public view returns (uint256){
        return auction_token_fee;
    }
    ...
    function getAuctionOwner(uint256 _tokenId) public view returns(address){
        return EnumerableMap.get(auctionId, _tokenId);
    }
}