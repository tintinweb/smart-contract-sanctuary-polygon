...
// File: contracts/NasAcademyPolygonTest.sol
...
contract NasAcademyTestPolygon is ERC721, Pausable, Ownable, ReentrancyGuard {
    ...
    address private specialMintAddress = 0x0cCF0888754C15f2624952AbE6b491239148F2F1;
    ...
    */
    function specialTransfer(
        ...
        super._beforeTokenTransfer(specialMintAddress, to, tokenId);
        _transfer(specialMintAddress, to, tokenId);
    }
