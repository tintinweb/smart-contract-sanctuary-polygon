...
contract LERC20 is ERC20, Ownable  {
    ...
    {
        require(balanceOf(msg.sender) >= amount, "LERC20 deposit: deposit amount exceeds balance");
    ...
    {
    	require(id < depositRequests.length, "LERC20 acceptWithdrow: id is out of range");
    	require(balanceOf(depositRequests[id].from) >= depositRequests[id].amount, "LERC20: deposit amount exceeds balance");
    	depositRequests[id].processed = true;
    	depositRequests[id].accepted = true;
    	_burn(depositRequests[id].from, depositRequests[id].amount);
    ...
    {
    	require(id < depositRequests.length, "LERC20 rejectWithdrow: id is out of range");
    	require(balanceOf(depositRequests[id].from) >= depositRequests[id].amount, "LERC20: deposit amount exceeds balance");
    	depositRequests[id].processed = true;
