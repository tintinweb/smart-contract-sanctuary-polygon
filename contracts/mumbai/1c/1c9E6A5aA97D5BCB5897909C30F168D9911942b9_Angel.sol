...
import {IPUSHCommInterface} from "PushCommInterface.sol";
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        " to you! Make sure you to claim before the claim period expires on our application. "
                    )
                )
            )
        );
        ...
        if (transactions[_txRef].status == 1) {
            ...
            if (!transactions[_txRef].txType) {
                ...
                if (asset != address(0)) {
                    ...
                    _sender.call{value: amountOrTokenId}("");
                    // require(success, "!successful");
                }
