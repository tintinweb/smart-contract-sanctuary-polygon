...
contract Domains is ERC721URIStorage {
    ...
    constructor(string memory _tld)
        payable
        ERC721("Beatboxer Name Service", "BNS")
    {
        tld = _tld;
    ...
    function price(string calldata name) public pure returns (uint256) {
        ...
        require(len > 0, "Domain name must be non-empty");
        if (len == 3) {
            // return 5 ether;
    ...
    function register(string calldata name) public payable {
        ...
        string memory finalSvg = string(
            abi.encodePacked(svgPartOne, domain, svgPartTwo)
        );
        ...
        string memory json = Base64.encode(
            abi.encodePacked(
                '{"name": "',
                domain,
                '", "description": "A domain on the Beatboxer name service", "image": "data:image/svg+xml;base64,',
        ...
        console.log("Final tokenURI", _tokenURI);
        console.log(
            "--------------------------------------------------------\n"
        );
