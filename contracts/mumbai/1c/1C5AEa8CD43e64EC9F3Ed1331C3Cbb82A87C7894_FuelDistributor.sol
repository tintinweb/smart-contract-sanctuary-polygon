    ...
    UUPSUpgradeable
{
    ...
    function __FuelDistributor_init(
        ...
        __FuelDistributor_init_unchained(_registry, _destinationsProtocol, _destinationsRemainder);
    }
    ...
    function collect() public nonReentrant {
        (uint256 _amountTotal, uint256 _amountProtocol) = registry.economics().collectSpentFuel();
        require(_amountTotal > 0, "FuelDistributor: nothing to collect");
        uint256 _amountRemainder = _amountTotal - _amountProtocol;
