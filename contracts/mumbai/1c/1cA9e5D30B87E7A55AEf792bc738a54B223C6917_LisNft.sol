...
contract LisNft is ERC721, AccessControl, Ownable {
    ...
    function mint(address receiver) external onlyRole(MINTER_ROLE) returns (uint256) {
        require(_tokenIds.current() < _maxSupply, "Collection limit has been exceeded.");
