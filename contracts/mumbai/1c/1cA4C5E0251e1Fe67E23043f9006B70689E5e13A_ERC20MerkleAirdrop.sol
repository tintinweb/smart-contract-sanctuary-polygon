...
contract ERC20MerkleAirdrop is Ownable {
    ...
    bytes32 public immutable merkleRoot = 0x3dbbdbd2a561fb2d17556a2a7f7ad816d8f81b0f5216855d9faf18f3d30fcf5c;
    ...
    uint256 public immutable startAt = 1671128511384;
    uint256 public immutable endAt = 1671561000000;

    //id of airdrop created in database
    uint256 public immutable airdropID = 6;

    //comes from template too
    uint256 public immutable totalTokens = 0x1043561a8829300000;
    uint256 public claimedTokens  = 0;
    uint256 public availableTokens = 300000000000000000000;
