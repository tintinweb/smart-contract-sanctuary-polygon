...
contract TestLand is ERC721, Ownable {
    ...
    function mintToken(address to, int256 x, int256 y, string memory metadata) public onlyOwner {
        _safeMint(to, getTokenId(x, y));
        _setTokenURI(getTokenId(x, y) + 1, metadata);
    }
