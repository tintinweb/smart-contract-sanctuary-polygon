...
contract NFTMarketplaceMain is IERC721Receiver, Ownable, ILayerZeroReceiver {
    ...
    * @param _wallets 0: Seller wallet, 1: Buyer wallet, 2: Creator wallet
    * @param _tokenId Token Id
    * @param _collection Collection address
    * @param _tokenAddress ERC20 Address Token (Payment currency)
    * @param _creatorPercentageFirstSell Percentage value for the creator on first sale
    * @param _creatorPercentageRoyalties Percentage value for the royalties for creator in each transaction
    * @param _marketplacePercentageRoyalties Percentage value for the royalties for marketplace in each transaction
    */
    function collect(
        address[] memory _wallets, // 0: seller wallet, 1: buyer wallet, 2: creator wallet
        uint256 _tokenId,
        uint256 _amount,
        address _collection,
        ...
        require(collection.ownerOf(_tokenId) == address(this), "This contract is not the owner of the NFT");
        ...
        if (_wallets[0] == marketWallet) {
            ...
            tokenERC20.transferFrom(_wallets[1], _wallets[2], creatorShare);
            ...
            tokenERC20.transferFrom(_wallets[1], _wallets[2], creatorRoyaltiesShare);
    ...
    /**
    * @notice Transfers the NFT to the respective owner
    * @param _collection Collection address
    * @param _tokenId Token Id
    */
    ...
    /**
    * @notice Transfers the NFT to the contract owner (in case we change the contract and need to)
    * @param _collection Collection address
    * @param _tokenId Token Id
    */
    ...
    */
    function list(address _collection, uint256 _tokenId) public {
        ...
        //ToDo REQUIRE SENDER NEED TO BE THE OWNER OF THE NFT BECAUSE OTHER PEOPLE CAN CALL THIS TO LIST OTHERS NFTS IF WE USE SETAPPROVALFORALL
        // TODO: require that the token is in this chain
    ...
    */
    ...
    /**
    * @notice Change the state of Claiming
    */
    ...
    /**
    * @notice Change the state of Listing
    */
