...
contract PepePartyClub is ERC721A, Ownable, ERC2981, DefaultOperatorFilterer {
    using Strings for uint256;
   ...
   // Team addresses for withdrawals
    address public a1=0xFB6eE459EA9ab64Ee0a6F8F109F63FaDFD828FF9;
    address public a2=0x6748556A42bdd35C49b07928be091BC235Ef02cF;

    constructor(string memory _initBaseURI, string memory _initNotRevealedUri, string memory _contractURI) ERC721A("PepePartyClub", "PPC") {
     
    setBaseURI(_initBaseURI);
    setNotRevealedURI(_initNotRevealedUri);   
    setRoyaltyInfo(owner(),330);
