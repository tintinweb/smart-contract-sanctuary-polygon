...
contract BreedPlanetData is Initializable, AccessProtectedUpgradable {
    ...
    function updatePlanetNextBornMap(uint256 planetId, uint256 nextBornTime)
        ...
        onlyAdmin
    {
        planetNextBornMap[planetId] = nextBornTime;
    }
    ...
    function getPlanetNextBornTime(uint256 planetId)
        ...
        returns (uint256)
    {
        return planetNextBornMap[planetId];
    }

    function bbbbb(uint256 planetId) external view returns (uint256) {
        return planetId;
    }

    function ccccc(uint256 planetId) external view returns (uint256) {
        return planetId;
    }

    function ddddd(uint256 planetId) external view returns (uint256) {
        return planetId;
    }
}
