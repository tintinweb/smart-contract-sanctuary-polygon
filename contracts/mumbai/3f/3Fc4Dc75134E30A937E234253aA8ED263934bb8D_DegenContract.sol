...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x0dffF175E45c12a12Af97259aDB34038634F40c2];
...
abstract contract EarlyMintIncentive is Teams, ERC721A, ProviderFees {
  ...
  uint256 public earlyMintTokenIdCap = 21;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeibstkttlj6leaqfooedqdeja6hwdzrhadedfuid3mddtbhhtsteea/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/BgmLiN5IJG73VcYlvNtK/contract-metadata";
  }
...
// File: contracts/DegenContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DegenContract is ERC721APlus {
    constructor() ERC721APlus("degen", "dgn"){}
}
  /*******************************************************/
  /*                                                     */
