...
/**
 * @title Token contract for the MeebitsDAO Drops
 * @author maikir
 *
 */
contract MeebitsDAODrops is ERC1155Supply, Ownable {
  event PermanentURI(string _value, uint256 indexed _id);
  string public constant name = "MeebitsDAO Drops";
  string public constant symbol = "MDAODR";
  ...
  /**
   * @dev Batch minting function with ETH
   */
  ...
  function freezeTokenData(uint256 id) public onlyAdmin tokenExists(id) {
