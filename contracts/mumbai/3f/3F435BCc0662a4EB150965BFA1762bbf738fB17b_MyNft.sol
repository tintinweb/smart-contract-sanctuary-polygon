...
contract MyNft is ERC721, Ownable, ERC2981 {
    ...
    address[] public withdrawAddresses = [0xa5693946e3B46f83A61B8Ab8868A04fE4150fE04, 0xd5F75aBe2F0F2a1104fE219830216f85204c1d26];
    uint256[] public withdrawPercentages = [90, 10];


    bytes32 public merkleRoot = 0xbc1631720762fd06782c38a949f85dc1aa469c9158caa012f916a351365ae29b;

    constructor() ERC721("DOCK", "PO") {
        _baseTokenURI = "https://api.nftool.io/generator-server/api/contract/v1/kYloXbyuGtdoLAGX1/1612726375406653442/metadata/";
        _setDefaultRoyalty(0xa5693946e3B46f83A61B8Ab8868A04fE4150fE04, uint96(1000));
    }
