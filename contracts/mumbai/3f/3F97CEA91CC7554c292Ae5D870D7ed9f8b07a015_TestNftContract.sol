...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xAB022D2349FEd8FC9b33538E068382B8fffD823D];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xAB022D2349FEd8FC9b33538E068382B8fffD823D;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://bafybeihyk7zhvumandcrpd6v6pm6mbnx47tvlffcxelywkfwjx5owagmvu.ipfs.nftstorage.link/";
...
contract TestNftContract is RamppERC721A {
    constructor() RamppERC721A("Test NFT", "TNFT"){}
}
