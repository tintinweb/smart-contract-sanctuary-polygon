...
contract LiquidityManager is IERC721Receiver {
    ...
    function decreaseLiquidity(uint128 _liquidity, uint256 _tokenId) external returns (uint amount0, uint amount1) {
    ...
    function collectAllFees( uint256 _tokenId) external returns (uint256 amount0, uint256 amount1) {
        ...
        INonfungiblePositionManager.CollectParams memory params =
            INonfungiblePositionManager.CollectParams({
                tokenId: _tokenId,
                recipient: nonfungiblePositionManager.ownerOf(_tokenId),
