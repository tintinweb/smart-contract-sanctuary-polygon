...
contract MM5_testing_Interog is ERC20, AccessControl, ERC721Holder {
    ...
    constructor(address owner, address _collectionAddress) ERC20("TestCOIN", "TESTC") AccessControl(){
