...
contract TestSport4 is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("TestSport4", "TS4") {
         _baseTokenURI = "ipfs://";
    }
    ...
    function safeMint(address to, string memory tokenIPFSURI) public virtual onlyOwner {
