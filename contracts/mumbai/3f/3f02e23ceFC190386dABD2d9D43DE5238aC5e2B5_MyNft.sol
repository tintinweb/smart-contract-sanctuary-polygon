...
contract MyNft is ERC721, Ownable, ERC2981 {
    ...
    address[] public withdrawAddresses = [0xcc0756D7586Ec64B44F7fdf2f023829e03dAaa4f, 0xD08Fcabb23FB46464d05C3c84805F1293702f36D];
    uint256[] public withdrawPercentages = [90, 10];


    bytes32 public merkleRoot = 0x43a836dce42e98982cea8034da9e24cb045f4b022ce609f37e338808874e7781;

    constructor() ERC721("t1", "tt") {
        _baseTokenURI = "https://test-nft-tool-gateway-api.tuoluo.net/generator-server/api/contract/v1/1602275743459766273/metadata/";
        _setDefaultRoyalty(0xcc0756D7586Ec64B44F7fdf2f023829e03dAaa4f, uint96(300));
    }
