...
contract GeneralMinter is AccessControl {
    ...
    constructor() {
        ...
        eggCrackedContract = ERC721Preset(address(0xfeCf94925e98d707642bb6769A78A62F23Af9e6e)); // Mumbai
        generalContract = General(address(0x4C171F709f03720C3FE2299a740533884Ab8384f)); // Mumbai

        metaDiceRoller = GeneralMetaDiceRoller(payable(address(0xc7Fef7Dd94F142Cc20dc22bBA7b371a756270548))); // Mumbai
        metaCalculator = GeneralMetaCalculator(address(0x22165591d9B3666E76637E7F6dc75CdFd6f36F56)); // Mumbai
    }
