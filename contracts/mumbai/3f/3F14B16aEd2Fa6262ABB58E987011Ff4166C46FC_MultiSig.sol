...
contract MultiSig {
    ...
    uint256 public nonce; // mutable state
    uint256 public threshold; // mutable state
    ...
    function setOwners_(uint256 threshold_, address[] memory owners_) private {
        require(
            owners_.length <= 20 &&
    ...
    function setOwners(uint256 threshold_, address[] memory owners_) external {
