...
contract RevewzRewardSystem is RevewzToken(100000), ReentrancyGuard {
    /*
///@dev a mapping of review ids to the Reward Account that wrote it. it is used to keep track of 
reviews that have been verified and have their awarded amounts paid out
...
///@dev this method is used to send rewards of rvz erc20 token to users who sumbit reviews that have been approve 
    function sendReward(string memory _reviewCID)
        ...
        nonReentrant
    {
        require(userReward[_reviewCID].exists == true, "Not a valid review");
        require(
            userReward[_reviewCID].verified == true,
            "Review not verified & approved"
        );
        require(
        ...
        transfer(receipient, userReward[_reviewCID].rewardBalance);
    }
    ...
    function validateReview(
        ...
        bool approved
    ) public onlyRole(APPROVER_ROLE) nonReentrant {
        ...
        nonReentrant
    {
        ...
        require(
            ...
            " epoch start-time is less than now"
        );
    ...
    function addApprover(address approver) public onlyRole(DEFAULT_ADMIN_ROLE) nonReentrant{
 ...
 function add(address rewarder) public onlyRole(DEFAULT_ADMIN_ROLE) nonReentrant{
...
contract RevewzToken is ERC20, Ownable, ERC20Burnable, AccessControl, Pausable {
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant REWARDER_ROLE = keccak256("REWARDER_ROLE");
    bytes32 public constant APPROVER_ROLE = keccak256("APPROVER_ROLE");

    constructor(uint256 initialSupply) ERC20("Revewz", "RVZ") {
