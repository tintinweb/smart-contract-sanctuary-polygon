...
contract AnOnchainGame is EssentialERC2771Context {
    ...
    function setMap(Space[] calldata spaces, StartSpaces[] calldata startSpaces) external onlyOwner {
        ...
        for (uint8 teamIndex = 0; teamIndex < teamCount; teamIndex++) {
            StartSpaces memory _spaces = startSpaces[teamIndex];

            teamStartingSpaces[_spaces.teamId] = _spaces.spaces;
        }
    }
