...
contract DaoProxy is BaseContract {
    ...
    function getUserData2(address _user) external view returns (
        uint256 _day,
        ...
        baseItem2_ = BaseItem2(weekTop1AddressList, rewardRateList, rewardRateListForInviteRanking, rewardRateListForInvestRanking, addressConfig, Dao1Set.length(), Dao2Set.length(), Dao3Set.length(), Dao4Set.length(), IERC20(daoToken).balanceOf(_user), _user.balance, DayRewardForInvestRankings[_day], DayRewardForInviteRankings[_day]);
    }
