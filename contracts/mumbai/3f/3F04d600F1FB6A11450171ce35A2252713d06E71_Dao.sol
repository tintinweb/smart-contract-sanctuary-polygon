...
//interface of the external contract
...
contract Dao {
    ...
    constructor(){
        owner = msg.sender;
        nextProposal = 1;
        daoContract = IdaoContract(0x2953399124F0cBB46d2CbACD8A89cF0599974963); //OpenSea contract
        validTokens = [ 
            5314724687970862991509558690724165110534397231306832994262106035243364384769,
            16300100164096370621845451875738325936267288317616745724986671888855277240321
            ]; //IDs of tokens needed for voting
    }
    ...
    //check if address making proposal holds a valid token
    ...
    function countVotes(uint256 _id) public {
        ...
        if(Proposals[_id].votesAgainst < Proposals[_id].votesFor){
            p.passed = true;            
        }
