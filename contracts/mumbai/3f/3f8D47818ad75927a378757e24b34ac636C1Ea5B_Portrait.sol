...
contract Portrait is ERC1155, IERC2981, Ownable, Pausable, ContextMixin {
    ...
    {
        //token royalty set at 5% standard is 1000=10% 
    ...
    /** @dev Contract-level metadata for OpenSea. **Review**Contract-level metadata for PORTRAIT */

    // Update for collection-specific metadata.
   // function contractURI() public pure returns (string memory) {
  //      return "ipfs://bafkreiai6dwnsboznvstdz57nmbom2rncompud5r5lgmmvdjfuoimigyjq"; // 
  //  }
}
...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    constructor(string memory uri_) {
        ...
        _uriBase = "ipfs://bafybeigceecxlggqjuunmyi5u25owg74bk774s4bidp3bkajygxpjbifye/"; // IPFS base for Portrait collection
