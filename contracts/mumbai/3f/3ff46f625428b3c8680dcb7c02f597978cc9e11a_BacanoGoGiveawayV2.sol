...
contract BacanoGoGiveawayV2 is BacanoGoCollection {
    ...
    function configureCharacters(
        ...
        require(
            cardSpec.characters.length == 0 ||
                cardSpec.characters.length == _characters.length,
    ...
    function getCharacters(
        CardType _cardType
    ) external view returns (CharacterSpec[] memory) {
