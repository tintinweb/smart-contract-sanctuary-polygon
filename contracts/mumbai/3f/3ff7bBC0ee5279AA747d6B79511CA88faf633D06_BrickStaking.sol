...
contract BrickStaking{
    ...
    event test(uint256 rewardLevel, uint256 percent);
    ...
    function getRewardLevel(address staker, uint256 stakingTime) public returns (uint256){
        ...
        emit test(rewardLevel, REWARD_PERCENT[rewardLevel]);
        return rewardLevel;
    }   
