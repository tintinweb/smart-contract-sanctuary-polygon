...
contract VoidCoin is ERC20, ERC20Burnable, Ownable {
    ...
    constructor() ERC20("Void Coin", "VC") {}
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        if (sender != address(0) && (_isExcludedFromFee[sender] || _isExcludedFromFee[recipient])) {
            ...
            _transfer(sender, MarketingWallet, splitFee);
            _transfer(sender, ResearchWallet, splitFee);
            _transfer(sender, DevelopmentWallet, splitFee);
