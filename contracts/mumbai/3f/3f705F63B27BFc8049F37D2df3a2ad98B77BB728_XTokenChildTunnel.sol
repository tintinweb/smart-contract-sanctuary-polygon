...
import {Ownable} from "@maticnetwork/fx-portal/contracts/lib/Ownable.sol";
import {FxERC20} from "@maticnetwork/fx-portal/contracts/tokens/FxERC20.sol";
 ...
 */
contract XTokenChildTunnel is Ownable, FxBaseChildTunnel, Create2 {
    ...
    ) FxBaseChildTunnel(MUMBAI_FX_CHILD) {
