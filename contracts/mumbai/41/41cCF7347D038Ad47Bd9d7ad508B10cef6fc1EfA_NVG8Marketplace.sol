...
contract NVG8Marketplace is Ownable, DataPool {
    ...
    function buyDataTokenForUse(uint256 _dataTokenId) public {
        ...
        if (poolType == PoolTypes.FIX_PRICE) {
            //TODO: Intract with Pricing Pool !
            IFixPrice(dataTokens[_dataTokenId].erc20Token).buyToken(
                _dataTokenId,
                dataTokens[_dataTokenId].usagePrice,
            ...
            //TODO: Intract with Pricing Pool !
            // TODO: handle amount in and amount out based on price and deadline
            IUniswapV2(dataTokens[_dataTokenId].erc20Token).swapTokens(
                _dataTokenId,
                1,
                1,
                msg.sender,
