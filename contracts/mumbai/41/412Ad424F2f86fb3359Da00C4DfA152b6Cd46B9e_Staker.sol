...
contract Staker {
	...
	constructor(address payable mWallet,address payable dWallet, uint256 startDate) {

		require(!isContract(mWallet));
	...
	function setUserBoostState(address userAddress, bool state) public {
		...
		require(msg.sender == marketingWallet || msg.sender == devWallet, "Not allowed to perform the operation");
