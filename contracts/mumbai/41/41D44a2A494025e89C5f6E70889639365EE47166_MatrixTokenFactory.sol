 ...
 * @title MatrixToken
 *
 * @dev ERC20 Token contract that allows privileged modules to modify positions and invoke from the MatrixToken.
 */
contract MatrixToken is ERC20, IMatrixToken {
    ...
    uint8 internal constant EXTERNAL = 1; // held on other smart contract(module or external source)

    // ==================== Variables ====================

    IController internal _controller;

    address internal _manager; // add modules, remove, and set a new manager

    address internal _locker;
    bool internal _isLocked;

    address[] internal _modules; // initialized modules

    // module address => ModuleState: NONE -> PENDING -> INITIALIZED
    ...
    /**
     * @dev Initialize Positions in default state, add modules into pending state.
     *
    ...
    /**
     * @dev Each component with a non-zero virtual unit is considered a Default Position, and each
     * externalPositionModule will generate a unique position. Virtual units are converted to real units.
     */
    ...
    /**
     * @dev return total real units for a given component, summing the default and external position units.
     */
    ...
    /**
     * @dev Edit a component's virtual unit, take a real unit and converts it to virtual before committing.
     */
    ...
    /**
     * @dev Add a module to a component's externalPositionModules
     */
    ...
    /**
     * @dev Remove a module from a component's externalPositionModules, delete the associated externalPosition.
     */
    ...
    /**
     * @dev Edit a component's external position virtual unit, take a real unit and converts it to virtual before committing.
     */
    ...
    /**
     * @dev Edit a component's external position data
     */
    ...
    /**
     * @dev Modify the position multiplier, such as update all the Positions' units when inflation is awarded (e.g. subscription fees).
     */
    ...
    /**
     * @dev Add a module into a PENDING state.
     * @notice Module must be initialized via module's initialize function later.
     */
    ...
    /**
     * @dev Remove a module from the MatrixToken. MatrixToken calls removeModule on module
    ...
    /**
     * @dev Changes manager, allow null addresses.
     */
     ...
     * the product of the positionMultiplier and the lowest absolute virtualUnit value must > 0.
     */
    ...
    /**
     * @dev Get the total number of positions:
