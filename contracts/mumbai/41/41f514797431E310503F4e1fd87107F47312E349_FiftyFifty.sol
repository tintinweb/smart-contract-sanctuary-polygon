...
*/
    ...
    mapping(bytes32 => uint256) private responseIdToToken;
...
*/
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        if(responseIdToAction[requestId] == 1){
            uint256 token = responseIdToToken[requestId];
            uint8 rare = getRarity(randomness);

            tokenToRarity[token] = rare;
            quarterlyToTokenID[currentQuarter][rare].push(token);
...
*/
    ...
    function mint(uint8 qty) public nonReentrant{
        ...
        for(uint8 i=0; i<qty; i++){
            ...
            responseIdToToken[_requestId] = _tokenIds;
            responseIdToAction[_requestId] = 1;

            tokenToRarity[_tokenIds] = 99;
...
*/
    ...
    function tokenURI(uint256 _tokenId) public view override returns (string memory){
        ...
        if(tokenToRarity[_tokenId] != 99){
            ...
            return "https://checkmates.eggheads.io/api/alpha/checkmate/1";
        }
    }
