...
contract Metaverse_Global is Ownable {
    ...
    uint256[6] private levelPercents = [20,5,2,1,1,2];
    ...
    function registration(address userAddress, address referrerAddress,uint8 level) private {
        ...
        users[userAddress].totalDeposit += levelPrice[level];
    ...
    {
        if(royaltyInfo[msg.sender].totalincome>users[msg.sender].totalDeposit*3)
        {
