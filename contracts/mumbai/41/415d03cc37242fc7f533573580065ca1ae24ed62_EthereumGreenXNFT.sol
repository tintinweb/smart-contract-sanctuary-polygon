...
contract EthereumGreenXNFT is ERC721, Ownable {
    ...
    function convertEthereumToMatic() public view returns (uint256) {
        ...
        uint256 ethValue;
        uint256 ethereumGreenValue;
        uint256 ethereumGreenValueInMATIC;
        uint256 maticValue;
        ...
        ethereumGreenValue = ethValue / 10; // 1 ETH Green value in USD
        maticValue = ((10**18) * uint256(maticPrice)) / maticDecimals; // ETH value in USD
        finalMaticValue = (((10**18) * ethValue) / maticValue) * (1 ether);
        ethereumGreenValueInMATIC = (finalMaticValue / 10**18) / 10; // 1 ETH Green value in MATIC
        return ethereumGreenValueInMATIC;
    }
}