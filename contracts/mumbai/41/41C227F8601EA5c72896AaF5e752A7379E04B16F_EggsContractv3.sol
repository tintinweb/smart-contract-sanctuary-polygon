...
contract EggsContractv3 is ERC1155LazyMint {
    ...
    require(_tokenId >= 1 && _tokenId <= 3, "Invalid tokenId");
    ...
    {
        require(this.balanceOf(msg.sender, 1) == 1, "You have not minted NFT id=1 yet");
        _burn(msg.sender, 1, 1);
        _mint(msg.sender, 0, 1, "evolved");
    }
