...
contract NevittToken is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "Nevitt Token";
    ...
    //address public marketingWallet = 0xDa74924C17600B03aEe57338313B73b93e332FD8; //testnet
    address public marketingWallet = 0xDa74924C17600B03aEe57338313B73b93e332FD8;
    ...
    function excludeFromReward(address account) public onlyOwner() {
        require(account != 0xbdd4e5660839a088573191A9889A262c0Efc0983, 'We can not exclude Quickswap router.');
