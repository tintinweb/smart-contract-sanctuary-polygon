...
contract DolphinContract is ERC721Enumerable, Ownable {
    ...
    function createDemoDolphin(uint256 _genes, address _owner)
        public
        payable
        returns (uint256)
    {
        require(!paused, "Transaction paused");
        require(msg.value >= genCost, "not enough eth");
        uint256 newDolphin = _createDolphin(99, 99, 99, _genes, _owner);
        return newDolphin;
    }
