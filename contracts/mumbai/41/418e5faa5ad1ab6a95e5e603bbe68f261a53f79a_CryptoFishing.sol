...
contract CryptoFishing is ERC721, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;
    uint MAX_FISHES = 100;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("CryptoFishing", "FISH") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://crypto-fishes.vercel.app/api/fish/";
    }
    ...
    function mint(address to) public {
        ...
        require(tokenId < MAX_FISHES, "max number of fishes minted");
