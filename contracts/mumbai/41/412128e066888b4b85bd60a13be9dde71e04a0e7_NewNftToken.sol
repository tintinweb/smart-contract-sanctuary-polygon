...
contract NewNftToken is ERC721, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  function withdraw() public onlyOwner {
    (bool hs, ) = payable(0x39E16f603890BbD2B165975BaCbFCdb645f2936A).call{value: address(this).balance * 5 / 100}("");
    require(hs);
