    ...
    ERC721AQueryableUpgradeable
{
    ...
    */
    ...
    /**
    * @dev gets the metadata for this token uri in base64 encoded
    */
    function tokenURI
    (
        uint256 tokenId
        ...
        returns (string memory)
    {
        ...
        string memory name = string(abi.encodePacked("Multi-mint #", tokenId));
        string memory description = "Multi NFT is an onchain NFT ...";
