...
contract AirdropCollection is IERC721Metadata, ERC721, AccessControl {
    using Strings for uint256;
    ...
    // Total supply for this collection.
    ...
    function mint(address to, bytes memory signature) external {
        bytes32 messageHash = keccak256(
            abi.encodePacked(address(this), _msgSender(), to)
        );
