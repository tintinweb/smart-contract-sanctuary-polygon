...
contract Logistic is AccessControl {
  /* ===================================================== CONSTANTS ==================================================== */
  ...
  mapping(string => OrderStatusType) private s_currentOrderStatus;
  ...
  function createOrders(
    ...
    for (uint256 i = 0; i < _ordersIds.length; i++) {
      ...
      s_currentOrderStatus[_ordersIds[i]] = OrderStatusType.IN_TRANSIT;
    }
    Event memory _event;
    _event.orderStatus = OrderStatusType.IN_TRANSIT;
  ...
  function deliverOrder(
    ...
    s_currentOrderStatus[_orderId] = OrderStatusType.DELIVERED;
  }
  ...
  function getOrder(
    string memory _orderId
  ) external view returns (OrderStatusType, Event[] memory) {
    ...
    return (s_currentOrderStatus[_orderId], _eventsOfOrder);
  }

  function getManifestId(string memory _orderId) public view returns (uint256) {
    return s_orderIdToManifestId[_orderId];
  }

  function getEvents(uint256 _manifestId) public view returns (Event[] memory) {
    return s_manifestEvents[_manifestId];
  }

  function getCurrentStatus(
    string memory _orderId
  ) public view returns (OrderStatusType) {
    return s_currentOrderStatus[_orderId];
  }
}