    ...
    ERC721HolderUpgradeable
{
        ...
        whenNotPaused
    {
        ...
        if (commission > 0 && walletAffiliate != address(0)) {
            // Transfer commission to affiliate wallet
            CommonLib.safeTransfer(token, address(this), walletAffiliate, commission);
        }

        // Transfer saleprice to fee collecting wallet after deducting discount and commission
        CommonLib.safeTransfer(token, address(this), feeCollector, amountToCollect);
...
// File contracts/vesting/Vesting_Old.sol

// 
pragma solidity ^0.8.0;
contract Vesting_Old is
    UUPSUpgradeable,
    OwnableUpgradeable,
    PausableUpgradeable,
    ReentrancyGuardUpgradeable
