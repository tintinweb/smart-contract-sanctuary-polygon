...
contract StakingAlgo1_nonusd is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    struct UserInfo {
    ...
    function initialize(
        ...
        address _priceFeed, // Chainlink Aggregator : _depositToken/USD
    ...
    function changeAggregator(address _aggregator) external onlyOwner {
        require(_aggregator != address(0), "can't be zero address");
        priceFeed = IAggregatorV3(_aggregator);
    }
