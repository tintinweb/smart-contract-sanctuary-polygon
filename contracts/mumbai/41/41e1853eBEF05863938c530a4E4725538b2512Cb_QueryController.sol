...
contract QueryController is 
    ...
    CoreController
{
    // TODO remove after successful debugging
    event LogProductCallback(
        ...
        onlyResponsibleOracle(_requestId, _responder) 
    {
        ...
        // TODO remove after successful debugging
        emit LogProductCallback(
            req.callbackContractAddress,
            functionSignature, 
            _requestId, 
            req.bpKey, 
            _data);
        ...
        emit LogOracleResponded(req.bpKey, _requestId, _responder, success);
    }
