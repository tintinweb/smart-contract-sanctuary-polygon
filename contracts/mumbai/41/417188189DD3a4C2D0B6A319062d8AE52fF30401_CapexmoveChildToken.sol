...
contract CapexmoveChildToken is ERC20Custom, Pausable {
    ...
    constructor(string memory name_,string memory symbol_,address childChainManagerProxy_) ERC20Custom(name_, symbol_,childChainManagerProxy_) {
        _owner = _msgSender();
        _setupDecimals(0);
    }
