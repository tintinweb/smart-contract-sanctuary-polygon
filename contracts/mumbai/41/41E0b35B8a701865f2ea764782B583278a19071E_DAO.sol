...
//Blacklisting and Whitelisting
    ...
    string memory _postaddress, string memory _number, address _sponsor1, address _sponsor2) public {
        ...
        candidacyAllData[msg.sender].timeEnd = block.timestamp + 48 hours;
...
uint256 public totalVotes;
    ...
    function VoteForCandidacyProposal(address _candidacy, bool _vote) public onlyMember{
        ...
        require(block.timestamp <= candidacyAllData[_candidacy].timeEnd, "This Vote has been closed");
        score[msg.sender] +=1;
        totalVotes +=1;
        if(_vote){
    ...
    function calculateResults(address candid, uint256 forVotes, uint256 againstVotes) internal{
