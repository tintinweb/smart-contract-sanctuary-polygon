...
library LibERC1155LazyMint {
    ...
    bytes32 public constant MINT_AND_TRANSFER_TYPEHASH =
        keccak256(
            "Mint1155(uint256 tokenId,Asset reserve,uint256 supply,address creator,address minter,Part[] creators,Part royalty)Part(address account,uint96 value)Asset(AssetType assetType,uint256 value)AssetType(bytes4 assetClass,bytes data)"
        );
