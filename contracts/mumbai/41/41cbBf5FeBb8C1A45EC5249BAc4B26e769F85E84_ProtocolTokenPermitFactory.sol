...
import {BaseControlledMintableBurnableERC20} from '../../interfaces/BaseControlledMintableBurnableERC20.sol';
import {MintableBurnableTokenPermit} from '../MintableBurnableTokenPermit.sol';

contract ProtocolTokenPermitFactory is ReentrancyGuard, MintableBurnableTokenFactory {
    /* -------------------------------------------------------------------------- */
    /*                                  Constants                                 */
    /* -------------------------------------------------------------------------- */
     ...
     * @param _protocolFinder Synthereum finder contract
     */
    constructor(address _protocolFinder) MintableBurnableTokenFactory(_protocolFinder) {}
    ...
    {
        MintableBurnableTokenPermit mintableToken = new MintableBurnableTokenPermit(
        tokenName,
        tokenSymbol,
        tokenDecimals
      );
...
import {BaseControlledMintableBurnableERC20} from '../../interfaces/BaseControlledMintableBurnableERC20.sol';
import {IProtocolFactoryVersioning} from '../../../core/interfaces/IFactoryVersioning.sol';
...
abstract contract MintableBurnableTokenFactory {
    ...
    /*                                   Storage                                  */
    /* -------------------------------------------------------------------------- */
    IProtocolFinder public protocolFinder;
    /* -------------------------------------------------------------------------- */
    /*                                   Events                                   */
    /* -------------------------------------------------------------------------- */
    ...
    modifier onlyTokenFactory() {
        ...
        uint8 numberOfFixedRateFactories = factoryVersioning.numberOfFactoryVersions(FactoryInterfaces.FixedRateFactory);
        bool isFixedRateFactory =
            _checkSenderIsFactory(factoryVersioning, numberOfFixedRateFactories, FactoryInterfaces.FixedRateFactory);
        if (isFixedRateFactory) {
            _;
            return;
        }
        revert('Sender must be a Token factory');
    }
    /* -------------------------------------------------------------------------- */
    /*                                 Constructor                                */
    /* -------------------------------------------------------------------------- */
     ...
     * @param _protocolFinder Synthereum finder contract
     */
    constructor(address _protocolFinder) {
        protocolFinder = IProtocolFinder(_protocolFinder);
    }
    /* -------------------------------------------------------------------------- */
    /*                                External View                               */
    /* -------------------------------------------------------------------------- */
    ...
    function _checkSenderIsFactory(
        ...
        internal
        view
        returns (bool isFactory)
    {
        uint8 counterFactory;
        for (uint8 i = 0; counterFactory < numberOfFactories; i++) {
            try factoryVersioning.getFactoryVersion(factoryKind, i) returns (address factory) {
