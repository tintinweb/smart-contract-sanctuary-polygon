...
contract TransferSafeRouter is Ownable {
    ...
    function getNativeFeeBalance(string memory test) public view onlyOwner returns (uint256) {
        return nativeFeeBalance;
    }
    
    function getTokenFeeBalance(address tokenType) public view onlyOwner returns (uint256) {
