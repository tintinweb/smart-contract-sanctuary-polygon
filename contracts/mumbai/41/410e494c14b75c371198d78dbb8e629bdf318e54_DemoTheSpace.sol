...
contract Property is ERC721Enumerable {
    ...
    function mint(address to, uint256 tokenId) public onlyMarket {
        if (tokenId >= _totalSupply) revert InvalidTokenId(tokenId, _totalSupply);
...
uint256 constant tokensAmount = 1000000;

contract DemoTheSpace is TheSpace {
    constructor(address currencyAddress_) TheSpace(currencyAddress_)
    {}
