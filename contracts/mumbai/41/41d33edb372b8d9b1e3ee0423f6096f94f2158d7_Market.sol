    ...
    ReentrancyGuardUpgradeable
{
    ...
    function createAuction(
...

        {
            ...
            uint256 weightedMinListingPriceUSD = _minAuctionListingPriceUSD *
                10**aggregatorDecimals;
            if (weightedStartPriceUSD < weightedMinListingPriceUSD) {
                revert AmberfiLib.Market_AuctionCreateFailed(
    ...
    function buyNow(
...

        {
            ...
            uint256 weightedPriceUSD = auction.priceUSD *
                10**aggregatorDecimals;
            if (weightedPaymentAmountUSD < weightedPriceUSD) {
                revert AmberfiLib.Market_AuctionBuyNowFailed(
                    uint8(
                        AmberfiLib.AuctionBuyNowErrorType.INVALID_PAYMENT_AMOUNT
                    )
                );
            }
        }
        ...
        returns (uint256 priceUSD)
    {
        ...
        (, int256 price, , , ) = priceFeed.latestRoundData();
        priceUSD = paymentTokenAmount_ * (uint256)(price);
    }
