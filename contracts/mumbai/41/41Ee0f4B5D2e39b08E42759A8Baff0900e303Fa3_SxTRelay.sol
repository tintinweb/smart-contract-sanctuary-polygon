...
contract SxTRelay is ISxTRelay, AdminUpgradeable, PausableUpgradeable {
    ...
    /// @dev Instance of sxtPaymentManager to interact with
    ISxTPaymentManager public sxtPaymentManager;
    ...
    * @param  payment Address of payment contract to be set in the contract
    */
    function setSxTPaymentManager(address payment) public onlyAdmin {
        sxtPaymentManager = ISxTPaymentManager(payment);
        emit SxTPaymentManagerRegistered(payment);
    }
    ...
    */
    function executeQueryERC20(
        ...
        sxtPaymentManager.acceptERC20Payment(requestId, paymentCurrency);
    ...
    */
    function executeQueryNative(
        ...
        sxtPaymentManager.acceptNativePayment{value: msg.value}(requestId);
        emit SxTRequestQueryV1(requestId, msg.sender, paramHash, sqlTextData, resourceIdData, biscuitIdData, true);
        return requestId;
    }
