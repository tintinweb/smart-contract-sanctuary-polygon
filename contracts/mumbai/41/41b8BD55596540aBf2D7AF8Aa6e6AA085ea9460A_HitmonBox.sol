...
contract HitmonBox is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  IERC20 usdcToken = IERC20(0xE097d6B3100777DC31B34dC2c58fB524C2e76921);
  IERC20 usdtToken = IERC20(0x466DD1e48570FAA2E7f69B75139813e4F8EF75c2);
  ...
  function mint(uint256 _mintAmount) public mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    if(!timerExpired()){
        require(IERC721(0x1AdfEd2866468D0173Aa8613E748d9108fcD5795).balanceOf(msg.sender) >= 1,"Not a Holder :( wait for Public Mint");
    }
     _safeMint(_msgSender(), _mintAmount);
