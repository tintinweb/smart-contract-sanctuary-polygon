...
contract MintRequests {
    ...
    */
    function updateRequest(
        ...
        require(request.owner == msg.sender || IWhitelist(addressRegistry.whitelistContract()).hasRoleAdmin(msg.sender),"Neither the Owner, nor an Admin");
        require(block.timestamp <= request.expirationDate, "Request has expired");
        //Update struct
        request.existingAddress = _existingAddress;
