    ...
    ReentrancyGuardUpgradeable
{
        ...
        )
    {
        ...
        for (uint256 i = 0; i < poolFen[user].historyPack.length; i++) {
            if (!poolFen[user].historyPack[i].isEnd) {
                if (
                    toTimeStamp >
                    ...
                    totalMonthPassed = totalMonthPassed > (vestingDays) / 30
                        ...
                        : totalMonthPassed;
                    totalReward +=
                        (poolFen[user].historyPack[i].amount *
                            mothlyUnlockRate *
                            totalMonthPassed) /
                        10000 +
                    ...
                    toTimeStamp > poolFen[user].historyPack[i].startTime
                ) {
                    rewards[index] = Reward(
                        i,
                        (poolFen[user].historyPack[i].amount * tge) / 10000
                    );
                    totalReward +=
                        (poolFen[user].historyPack[i].amount * tge) /
                        10000;
        ...
        return (index, b, totalReward - poolFen[user].receivedAmount);
        // return rewards;
    }
}
