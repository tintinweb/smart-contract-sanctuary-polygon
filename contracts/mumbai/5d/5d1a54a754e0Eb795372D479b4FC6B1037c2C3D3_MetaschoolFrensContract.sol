...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x9ecC65a7Af1ad065b6D5636180eC1934E3B142b7];
  address public erc20Payable = 0x9ecC65a7Af1ad065b6D5636180eC1934E3B142b7;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmRKjYNG8FEHxcs2oCDmriKH3fXKCL6qA9pc84gx6SKaQs/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/0T7IY3zaEZ3bShuHkr3i/contract-metadata";
  }
...
// File: contracts/MetaschoolFrensContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MetaschoolFrensContract is RamppERC721A {
    constructor() RamppERC721A("Metaschool Frens", "META"){}
}
