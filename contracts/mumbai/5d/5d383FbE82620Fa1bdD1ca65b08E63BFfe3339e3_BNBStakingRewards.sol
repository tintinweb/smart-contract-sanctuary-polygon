...
contract BNBStakingRewards {
    ...
    function rewardPerToken() public view returns (uint) {
        ...
        return
            ...
            (((block.timestamp - lastUpdateTime) * rewardRate * 1e18) / _totalSupply / 3600 / 24);
    }
    ...
    function withdraw(uint _amount) external updateReward(msg.sender) {
        ...
        require(succeed, "Failed to withdraw BNB");
    }
    ...
    function getReward() external updateReward(msg.sender) {
        ...
        (bool succeed, ) = payable(msg.sender).call{value: reward}("");
        require(succeed, "Failed to get Reward");
    }
}
