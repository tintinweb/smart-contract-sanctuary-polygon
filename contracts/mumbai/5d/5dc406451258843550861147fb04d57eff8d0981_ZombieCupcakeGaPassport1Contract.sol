...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x6B8FDe60b76E47103Fe9f2008d78035a2baeb9F1];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 5, 1200 ) {}
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 1200");
        _safeMint(_to, 1);
    }
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 1200");
...
// File: contracts/ZombieCupcakeGaPassport1Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ZombieCupcakeGaPassport1Contract is RamppERC721A {
    constructor() RamppERC721A("Zombie Cupcake GA Passport 1", "zcuporacle"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/1sROGcRQ2TX2MyPLWYRx/contract-metadata";
    }
}
