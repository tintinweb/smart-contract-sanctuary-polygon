...
// File: contracts/BlatformRoyaltyRegistry.sol
 ...
 * @title IERC1155 Non-Fungible Token Creator basic interface
 */
contract BlatformRoyaltyRegistry is Ownable, IBlatformRoyaltyRegistry {
    ...
    function setPercentageForTokenRoyalty(
        ...
        require(
            ...
            msg.sender == owner() ||
            msg.sender == blatform,
            "setPercentageForTokenRoyalty::Must be contract owner or creator or blatform"
        );
        require(
            _percentage <= 100,
    ...
    function restore(address _oldAddress, address _oldBlatformAddress, uint256 _startIndex, uint256 _endIndex) external onlyOwner {
        BlatformRoyaltyRegistry oldContract = BlatformRoyaltyRegistry(_oldBlatformAddress);
