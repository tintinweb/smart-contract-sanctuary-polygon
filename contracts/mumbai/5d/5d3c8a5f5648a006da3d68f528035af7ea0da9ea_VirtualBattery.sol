...
contract VirtualBattery {
    ...
    function setPricePerKWH(uint256 _priceInEuros) external isAdmin {
        // Here we're simulating the division by 0.70 by multiplying by 100 (to get cents) and then dividing by 64.
        uint256 priceInMatic = (_priceInEuros * 100) / 70;  // Convert Euro to Matic
        uint256 priceInWei = priceInMatic * 1e18;  // Convert Matic to Wei
        currentRateKWH = priceInWei;
    }
