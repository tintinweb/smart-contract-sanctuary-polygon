...
contract Pool is ReentrancyGuard {
    ...
    function _matchOrder(Order memory _order, bool _isBuy) internal {
        ...
        if (_isBuy) {
            ...
            fAsset = fAfter;
            fractions.transferFrom(address(this), sender, received);
            ...
            erc20.transferFrom(address(this), sender, received);
        }
...
//    }
    ...
    function _mintFractions(address _to, uint256 _forBase) private {
        fractions.mint(_to, _forBase * f);
    }

    function _burnFractions(address _from, uint256 _forBase) private {
        fractions.burn(_from, _forBase * f);
    }
}
