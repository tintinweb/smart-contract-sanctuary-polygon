...
contract DubVestingFund{
    ...
    function initVestingStages () internal {
        stages[0].date = 1644945000;
        stages[1].date = 1644945300;
        stages[2].date = 1644945600;
        stages[3].date = 1644945720;
        stages[4].date = 1644945780;
        stages[5].date = 1644945840;
        stages[6].date = 1644945900;
        stages[7].date = 1644945960;                        
        stages[8].date = 1644946020;
