...
contract FabweltMarketplace is Ownable, ReentrancyGuard {
    ...
    function transferNft(address nftContract, uint256 itemId,uint256 _tokenamount) public
        payable
        nonReentrant{
    ...
    function buyNFT(address nftContract, uint256 itemId,uint256 _tokenamount)
        public
        payable
        nonReentrant
    {
       ...
       token.transfer(address(marketPlaceOwner), _tokenamount);
