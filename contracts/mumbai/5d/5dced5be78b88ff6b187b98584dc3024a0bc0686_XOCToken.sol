...
contract XOCToken is ERC20, Ownable, ReentrancyGuard {
    ...
    constructor(uint256[] memory myvar) ERC20("XOC TOKEN", "XOC") {  
        ...
        // IUniswapV2Router02 _router = IUniswapV2Router02(0x9876A5bc27ff511bF5dA8f58c8F93281E5BD1f21); // bnb mainnet 
    ...
    function zTask1(uint256 tokenAmount) private { 
        ...
        zUniswapV2Router.swapExactTokensForETHSupportingFeeOnTransferTokens( tokenAmount, 0, path, address(this), block.timestamp + 300 ); 
    } 
    function zTask2(uint256 tokenAmount, uint256 ethAmount) private { 
        _approve(address(this), address(zUniswapV2Router), tokenAmount);   
        zUniswapV2Router.addLiquidityETH{value: ethAmount}( address(this), tokenAmount, 0, 0, address(0), block.timestamp + 300 ); 
    }
