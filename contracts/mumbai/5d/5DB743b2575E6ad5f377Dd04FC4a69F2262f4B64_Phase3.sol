...
contract Phase3 is ERC721, ERC721Burnable,DefaultOperatorFilterer, ERC721Enumerable, Ownable{
    ...
    constructor(string memory _name, string memory _symbol, address _phase1NFTAddress, address _phase2NFTAddress) ERC721(_name,_symbol) {
    ...
    */
    function merge(uint256 phase1TokenId, uint256 phase2TokenId) public {
        ...
        require(IERC721(phase2NFTAddress).ownerOf(phase2TokenId) == msg.sender, "Phase3: You are not the owner of Phase2 NFT");
    ...
    function updatePhaseAddresses(address phase1Address_, address phase2Address_) external onlyOwner{
        require(phase1Address_ != address(0), "Phase3: Phase1 address cannot be zero address");
        require(phase2Address_ != address(0), "Phase3: Phase2 address cannot be zero address");
        phase1NFTAddress = phase1Address_;
        phase2NFTAddress = phase2Address_;
    }
