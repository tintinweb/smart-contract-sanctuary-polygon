...
contract CryptodialsGenesis is ERC721A, Ownable {
    ...
    uint256 public publicSalePrice = 101000000000; // 000000
    uint256 public allowlistSalePrice = 90900000000; // 000000
    uint256 public ogSalePrice = 80800000000; // 000000
    ...
    function safeMint(address to, uint256 quantity) internal {
        if (_numberMinted(to) + quantity > maxPerWallet)
