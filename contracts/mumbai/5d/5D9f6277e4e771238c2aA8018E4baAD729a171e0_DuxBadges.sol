...
contract DuxBadges is ERC721A, Ownable {
    ...
    string private baseURI = "https://dux-content.s3.amazonaws.com/badges/metadata/";
    
    constructor() ERC721A("DUX BADGES", "DUX BADGES")
    {
    }
    ...
    function setURI(string calldata _base) external onlySender {
        baseURI = _base;
    }
    /*
