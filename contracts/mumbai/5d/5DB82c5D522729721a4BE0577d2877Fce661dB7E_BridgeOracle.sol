...
Ownable
{
    ...
    mapping(bytes32 => uint256) public chainFees;
    ...
    function getFee(
        ...
        uint256 chainFee = chainFees[chain];
        if (chainFee == 0) revert InvalidChain();
        return 1e8 * chainFee / _getLatestPrice();
    }

    function getLatestPrice(
    ) public view returns (uint256) {
        return _getLatestPrice() * 1e10;
    }
