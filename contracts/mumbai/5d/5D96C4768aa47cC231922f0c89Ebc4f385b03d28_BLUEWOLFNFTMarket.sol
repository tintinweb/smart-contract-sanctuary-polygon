    ...
    AccessControl
{
    ...
    constructor(address _wallet, uint256 _fee, uint256 _offerDuration) {
    ...
    function cancelOrder(uint256 tokenId, uint256 orderId)
        public
        whenNotPaused
        nonReentrant
    {
    ...
    function Buy(uint256 tokenId, uint256 orderId)
        public
        whenNotPaused
        nonReentrant
    {
    ...
    function cancelOffer(uint256 tokenId, uint256 offerId)
        public
        whenNotPaused
        nonReentrant
    {
