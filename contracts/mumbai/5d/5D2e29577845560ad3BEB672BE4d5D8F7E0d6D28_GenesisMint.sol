...
abstract contract GenesisStorage is AccessControl, ERC721A, ERC2981 {
    ...
    string internal _goldenTicketURI;
    ...
    mapping(uint => bool) internal isRevealedEarly;
...
/* ------------------------------------------------------------  ADMIN FUNCTIONS  ----------------------------------------------------------- */
        ...
        onlyRole(OPERATOR_ROLE)
    {
        merkleRoot = _merkleRoot;
        startTimestamp = _startTimestamp;
        endTimestamp = startTimestamp + 2 hours;
    ...
    {
        startTimestamp = _startTimestamp;
        endTimestamp = startTimestamp + 2 hours; // 2 weeks;
        merkleRoot = "";
