...
contract MerchadiseDelorean is ERC721, AccessControl {
    // Last ID of tokens minted
    uint256 private s_token_id = 0;
    ...
    constructor() ERC721("MerchadiseDelorean", "MD") {
    ...
    {
        _safeMint(address(_to), s_token_id);
