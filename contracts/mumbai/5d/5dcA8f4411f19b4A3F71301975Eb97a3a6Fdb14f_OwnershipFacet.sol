...
/**
 * @title Ownership Facet Contract
 * @notice Implements the functions to manage ownership of the contract.
 * @dev This facet is part of a diamond contract architecture.
 * Ownership is managed through the {LibDiamond} library.
 */
contract OwnershipFacet is IERC173 {
    /**
     * @notice Transfers ownership of the contract to a new account (`newOwner_`).
