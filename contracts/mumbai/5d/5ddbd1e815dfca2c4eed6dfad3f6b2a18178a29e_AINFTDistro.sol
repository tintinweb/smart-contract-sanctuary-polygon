...
interface IAINFT {
    /**
        _name: is what each art would be called
        _description: is brief explaination of what are is
        _hash: is IPFS hash
     */
...
contract AINFTDistro is AccessControl {
    ...
    function mint(
        ...
        require(
            (getVerifyAddress(msg.sender, hashValue, _v, _r, _s) ==
                verifyAddress),
            "Not verified"
        );
        // require(
        ...
        eavaToken.mintNextToken(msg.sender, _name, _description, _wish, _hash);
