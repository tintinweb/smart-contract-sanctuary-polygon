...
import "./interfaces/ITheGlenrothesTaiwanImpressionismSingleCaskOfConnoisseurs.sol";
...
contract TheGlenrothesTaiwanImpressionismSingleCaskOfConnoisseursStorage {
...
contract TheGlenrothesTaiwanImpressionismSingleCaskOfConnoisseurs is 
    ITheGlenrothesTaiwanImpressionismSingleCaskOfConnoisseurs, 
    TheGlenrothesTaiwanImpressionismSingleCaskOfConnoisseursStorage, 
    ERC721A, 
    Ownable, 
    ERC2981 {
    ...
    constructor()
        ERC721A("TheGlenrothesTaiwanImpressionismSingleCaskOfConnoisseursStorage", "TGTISCC") 
    {
        baseURI = "";
        isSigner[owner()] = true;
        MAX_TOKENS_AMOUNT = 1828;
        MAX_TOKENS_TIERAMOUNT = 1828;
        MAX_TOKENS_PERTX = 1828;
        TOKEN_PRICE = 1 ether;
...
interface ITheGlenrothesTaiwanImpressionismSingleCaskOfConnoisseurs {
