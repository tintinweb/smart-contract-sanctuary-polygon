...
contract EkuusNftHorsest is ERC721Enumerable, Ownable {
    ...
    uint256 public price = 1 * 10 **18; //0.01 ether;
    ...
    function mintToken(uint256 _amount) public payable {
        require(
            _amount > 0 && _amount <= MAX_PER_MINT,
        ...
        if (!saleActive) {
            ...
            require(
                reservedAmt > 0 && _amount <= reservedAmt,
                "Sale isn't active and you are not whitelisted"
            );
