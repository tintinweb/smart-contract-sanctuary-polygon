...
contract RewardControl is RoleControl {
  ...
  function storeReward(
    ...
    require(isAdmin(msg.sender) || isOperator(msg.sender), 'Only admin or operator can execute this function');

    reward[secret] = Reward(secret, amount, tokenContract, claimableAt);
  }
...
contract SnackclubTournamentsPayout is RewardControl {
  ...
  event RewardClaimed(address indexed to, uint256 amount, address tokenContract);
