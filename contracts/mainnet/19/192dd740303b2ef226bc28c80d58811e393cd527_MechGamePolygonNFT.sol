...
contract MechGamePolygonNFT is
    ...
    Ownable(), ERC2981, DefaultOperatorFilterer
{
    ...
    function claim(
        ...
        uint256 path) external {
            require(mintStatus != MintStatus.CLOSED, "claim closed.");
    ...
    */
    ...
    constructor() {
        _setDefaultRoyalty(0x02dF807d510ce365D4bB454851Af2d159c3f9D1c, 500);
    }
}