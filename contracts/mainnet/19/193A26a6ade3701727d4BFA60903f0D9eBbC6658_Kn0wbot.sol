...
contract Kn0wbot is ERC721, ERC721Enumerable, Ownable, ContextMixin, NativeMetaTransaction {
  using Counters for Counters.Counter;
  uint256 public maxSupply = 10000;
  uint256 public cost = 5 ether;
  string public baseURI = "ipfs://QmYyiYyvA5k7RCWPny6LE2zaFNLa9dYMh1hse3CQT6pS7Y/";
  ...
  function safeMint(address to) public payable {
    ...
    if (msg.sender != owner()) {
      require(msg.value >= cost, "Wrong amount of ETH sent. Cost is 5 MATIC");
    }
