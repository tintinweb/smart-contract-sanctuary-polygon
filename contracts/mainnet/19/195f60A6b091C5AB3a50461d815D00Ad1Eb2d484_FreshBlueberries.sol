...
// File: contracts/FreshBlueberries.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract FreshBlueberries is
    ERC1155,
    Ownable,
    Pausable,
    ERC1155Supply,
    ...
    Allowlist
{
    ...
    string public name = "Fresh Blueberries";
    string public symbol = "FreshBlueberries";
    string public contractURI = "ipfs://bafyreicgoqmq5ggxzaw4ja36q6q2rffwe5r3jh74kk6s7s3p2jziaedvrq/metadata.json";
