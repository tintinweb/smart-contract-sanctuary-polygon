...
//Vertu Bank
// contract: 0x19b6948a51dc481f564a57B1AF5BBeD380EA64D6
library Address {
...
contract VertuBank is ERC20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Vertu Bank";
    string constant _symbol = "V";
    uint8 constant _decimals = 9;
    uint256 public constant MASK = type(uint128).max;
    uint256 _totalSupply = 9_999_999_999 * (10 ** _decimals);
