...
contract PAI is OFT {
    function initialize(address _layerZeroEndpoint) public initializer {
        OFT.__OFT_init("Parrot USD", "PAI", _layerZeroEndpoint);
    }
...
contract OFT is OFTCore, ERC20Upgradeable, IOFT, UUPSUpgradeable {
    // constructor(string memory _name, string memory _symbol, address _lzEndpoint) ERC20(_name, _symbol) OFTCore(_lzEndpoint) {}

    function __OFT_init(string memory _name, string memory _symbol, address _lzEndpoint) public initializer {
        __UUPSUpgradeable_init();
        ERC20Upgradeable.__ERC20_init(_name, _symbol);
        OFTCore.__OFTCore_init(_lzEndpoint);
    }
...
abstract contract OFTCore is NonblockingLzApp, ERC165Upgradeable, IOFTCore {
    ...
    function __OFTCore_init(address _endpoint) public initializer {
        NonblockingLzApp.__NonblockingLzApp_init(_endpoint);
    }
...
abstract contract NonblockingLzApp is LzApp {
    ...
    function __NonblockingLzApp_init(address _endpoint) public initializer {
...
abstract contract LzApp is OwnableUpgradeable, ILayerZeroReceiver, ILayerZeroUserApplicationConfig {
    ...
    function __LzApp_init(address _endpoint) public initializer {
        __Ownable_init();
        lzEndpoint = ILayerZeroEndpoint(_endpoint);
    }
