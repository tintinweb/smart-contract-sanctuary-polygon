...
contract dBloksCollisionRaffle is ERC721, ERC721Enumerable, ERC721Burnable, ERC721Royalty, Ownable {
    ...
    constructor(address trustedForwarder) ERC721("dBloksCollisionRaffle", "DBCR_E10") {
        _tokenIds.increment();
