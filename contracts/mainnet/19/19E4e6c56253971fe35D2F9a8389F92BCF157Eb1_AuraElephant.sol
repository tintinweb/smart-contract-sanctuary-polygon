...
contract AuraElephant is ERC721Enumerable, Ownable {
  using Strings for uint256;
  string public baseURI;
  string public baseExtension = ".json";
  uint256 public cost = 88.5 ether;
  uint256 public maxSupply = 10000;
  uint256 public maxLimitWhitelist = 10;
  uint256 public maxLimitNonWhitelist = 50;
  ...
  constructor(
    ...
    string memory _nonRevewaledUri
  ) ERC721(_name, _symbol) {
      setNotRevealedURI(_nonRevewaledUri);
  }
