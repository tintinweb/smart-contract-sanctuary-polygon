    ...
    Ownable
{
    ...
    uint256 public reveal_time = 1638338409;
  

    constructor(
    ) ERC721("Test Doang x", "TDX") {

        notRevealedURI = "https://gateway.pinata.cloud/ipfs/QmToMrFFGWcvQR9b7pAXJgso9y6xMT7Eg6yrayF7WrrP7G/";
        baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmXaojKP4YH5JZ8ycrXfwqA6BEbhWEY3xJntj6a1qdrcmR/hidden.json";
