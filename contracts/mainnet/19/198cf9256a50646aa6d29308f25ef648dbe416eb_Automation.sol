...
contract AutomationStorage is AutomationType {
    ...
    uint256 public constant GAS_USED_PER_BATCH_MINT = 18000000;
    uint256 public constant GAS_USED_PER_BATCH_CLAIM = 5000000;
     ...
     */
    function getBatchInfo(uint256 mintId, uint256 batchId)
        external
        view
        returns (IFactory.BatchInfo memory info)
    {
...
contract AutomationRobot is AutomationStorage, transferHelper {
    ...
    function mint(uint256 mintId) external {
        ...
        uint256 returnValue = result.valueLeft;
