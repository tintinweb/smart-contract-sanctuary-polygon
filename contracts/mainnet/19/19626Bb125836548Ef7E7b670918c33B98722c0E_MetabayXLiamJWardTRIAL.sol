...
contract MetabayXLiamJWardTRIAL is ERC721Enumerable, Ownable {
    ...
    ) ERC721("Metabay x Liam J. Ward TRIAL", "MLJWT") {
    ...
    modifier mintCompliant(
        ...
        require(totalSupply() + _quantity <= MAX_SUPPLY, "MINT:Max supply exceeded!");
    ...
    function getClaimIneligibilityReason(
        ...
        } else if (amountNFTsperWallet[_recipient] + 1 > MAX_MINT_AMOUNT) {
