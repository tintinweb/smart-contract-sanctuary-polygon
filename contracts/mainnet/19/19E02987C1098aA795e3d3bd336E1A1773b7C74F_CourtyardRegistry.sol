...
ERC721EnumerableUpgradeable
{
    ...
    /* ==================================== POLYGON TO ETHEREUM EXTERNAL MIGRATION LOCKS ==================================== */

    function approve(address to, uint256 tokenId) public virtual override {
        revert("CourtyardRegistry: This token has been locked. The contract has moved to Ethereum at 0xd4ac3CE8e1E14CD60666D49AC34Ff2d2937cF6FA and all tokens are being re-minted there to their respective last owners.");
    }
