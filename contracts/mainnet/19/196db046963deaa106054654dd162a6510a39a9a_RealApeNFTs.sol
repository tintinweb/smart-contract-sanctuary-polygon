...
contract RealApeNFTs is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    string private _baseURIextended = "https://apeart.mypinata.cloud/ipfs/QmUYGFoCXfzotW4U1NThNnpz53eQsscZ2DyHhYkxUnqu9X/";
    uint256 private _priceextended = 0;
    ...
    uint256 public MAX_MINT_LIMIT = 100;

    constructor() ERC721("Real Ape NFTs", "RANFT") {
    }
    ...
    function mintNFT(uint256 _cnt) public payable {
        ...
        if(publicSale) {
            require(_cnt <= MAX_MINT_LIMIT, "Exceded the Minting Count");
        }
