...
contract BoredHuskyKennelClub is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Bored Husky Kennel Club", "BHKC") {
    setHiddenMetadataUri("ipfs://QmW7bGwXZMaWLD52AEUz1xWki3bUt52zhk1SQNVVEXqPHS/hidden.json");
  }
