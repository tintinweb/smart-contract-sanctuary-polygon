	...
	ERC1155SupplyUpgradeable
{
		...
		initializer
	{
		...
		// Mint prices
		mintPricePotatoByPriceType[MintPriceTypes.NONE] = 1200 * 10**18;
	...
	function mintPigsWithChickenAndFamerOrFarmGirl(
		uint256[] memory _chickenIds,
		uint256 _farmerId,
		uint256 _farmGirlId,
		uint256 _numberOfPigs
