...
contract GameplayToken is UUPSUpgradeable,AccessControlEnumerableUpgradeable,ERC20Upgradeable{
    ...
    function renounceRole(bytes32 role, address account) public view override{
        revert("can't renounceOwnership here");
    }

}

// File: GameplayChildToken.sol
...
contract GameplayChildToken is GameplayToken {
    ...
    function initialize(string memory name, string memory symbol, address childChainManagerProxy) external {
        ...
        require(childChainManagerProxy!=address(0),"The childChainManagerProxy should be a valid address");
