...
contract MysteryBox is ERC721A, AccessControl, Pausable, ReentrancyGuard {
    // ================== //
    //  Variable section  //
    // ================== //

    AggregatorV3Interface MATICUSDfeed =
        AggregatorV3Interface(0xAB594600376Ec9fD91F8e885dADF0CE036862dE0); // MATICUSD Mainnet
    ...
    uint256 public mysteryBoxPrice = 1;
    ...
    modifier checkMintCond(uint256 quantity) {
        require(_totalMinted() < MAX_SUPPLY, "MysteryBox already sold out!");
    ...
    constructor() ERC721A("MysteryBox", "MBX") {
    ...
    function usdMint(uint256 quantity)
        ...
        nonReentrant
    {
        uint256 price = quantity * mysteryBoxPrice * (10**6); // amount * item price * wei => n * 20 * 1000000
        require(
    ...
    function nativeMint(uint256 quantity)
        ...
        nonReentrant
    {
        uint256 price = getMysteryBoxNativePrice(quantity); // mock up matic price
    ...
    function setUSDTAddress(address _addr) public onlyRole(DEFAULT_ADMIN_ROLE) {
        USDT_ADDRESS = _addr;
    }
    ...
    function setMysteryBoxPrice(uint256 _mysteryBoxPrice)
        public
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
    ...
    function getMysteryBoxNativePrice(uint256 quantity)
        public
        view
        returns (uint256 price)
    {
        price = (quantity * mysteryBoxPrice * 10**36) / getMATICPrice(); // Real price
    }
