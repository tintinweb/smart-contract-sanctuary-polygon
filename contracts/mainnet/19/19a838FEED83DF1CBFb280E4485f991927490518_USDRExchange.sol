...
contract USDRExchange is AddressAccessor, IExchange, Pausable {
        ...
        onlyRole(CONTROLLER_ROLE)
    {
        ...
        uint256 minted = stats.tngblToUSDR + stats.underlyingToUSDR + stats.usdrFromGains;
        ...
        if (minted >= reduceBy) {
            ...
            ITreasury.TreasuryValue memory treasuryValue = ITreasury(treasury).getTreasuryValue();
            uint256 total = (treasuryValue.total - treasuryValue.rwaVaults) / 1e9 - stats.usdrFromGains;
        ...
        )
    {
        ...
        ITreasury.TreasuryValue memory tv = ITreasury(treasury).getTreasuryValue();
        require(
