...
// File: contracts/operator-filter-registry/lib/Constants.sol
    ...
    contract BigBangPunks is IERC721L, ERC721AQueryable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
        ...
        // Current base URI.
        string private _currentBaseURI = "ipfs://bafybeiesbis7pihbotpu43qihwoe7xug34wrwu24rm2f6tdauvkrfkrv4q/";
        ...
        constructor() ERC721A("Big Bang Punks", "BBP") {
            _mintStages.push(MintStageInfo({cost: 1000000000000000000, walletLimit: 1111, merkleRoot: 0x0, maxStageSupply: 0, startTimeUnixSeconds: 1687622632, endTimeUnixSeconds: 1692806632}));
        }
