...
contract CoCreateERC721A is OwnableUpgradeable, ERC2981Upgradeable, IERC4494, EIP712Upgradeable, ERC721AUpgradeable {
  ...
  function validateTokenOperation(address from, address to) internal view virtual {
    ...
    bool isEitherAddressZero = from == address(0) || to == address(0);
    bool isEitherAddressOnAllowlist = transferAllowList[from] || transferAllowList[to];
    if (isTransferAllowlistRestricted && !isEitherAddressZero && !isEitherAddressOnAllowlist && !isEitherAddressOwner) {
