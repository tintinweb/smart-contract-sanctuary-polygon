...
contract LazyPetter {
  ...
  constructor(address _authorizedExecutor, address gotchiDiamond, address _gotchiOwner) {
    ...
    gotchiIds = [
      ...
      // next top kin gotchis
      20601,21141,18013,13102,21048,12797,17495,15079,24941,24935,24936,23309,23098,24564,23861,24004,22929,23918,24004,24564,22934,10055,23085,23591,23810,24561,24561,17443,18812,22530,24559,13608,19943,21586,10566

      // i also need to reset the commented out part below
      // 12771,
      // 22518,
      // 22710,
      // 18365,
      ...
      // sold
      // 22921, 10755, 22561, 2987, 14999, 22392, 12220, 24806, 11345, 16876, 14160, 11408, 18594, 22580, 15672, 13785, 14055, 20469, 16206, 14357, 23689, 15296, 10273
    ];
  }
