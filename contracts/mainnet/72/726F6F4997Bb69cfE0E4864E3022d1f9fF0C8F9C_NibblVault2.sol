...
contract NibblVault2 is INibblVault2, BancorFormula, ERC20Upgradeable, Twav2 {
    ...
    function createERC1155Link(string memory _n, string memory _ns) external onlyCurator {
...
contract Twav2 {
    ...
    uint256 constant period = 2 seconds; // Interval in which Observation should updated into twavObservations
