 ...
 * @notice Investment strategy for investing assets via Aave V3 Strategy
 */
import { IERC20, InitializableAbstractSingleStrategy } from "../../utils/InitializableAbstractSingleStrategy.sol";
...
import {ISingleVault} from "../../interfaces/ISingleVault.sol";
...
contract AaveV3SingleStrategy is InitializableAbstractSingleStrategy {
     ...
     * InitializableAbstractStrategy initializer as Aave V3 strategies don't fit
     * well within that abstraction.
     ...
     @param _aave_contracts AAVE related contracts
    ...
    function initialize(
        ...
        address[] calldata _aave_contracts, 
        ...
        pool = ILendingPool(_aave_contracts[0]);
        lp = IERC20(_aave_contracts[1]);
    ...
    function _deposit(
        ...
        pool.supply(address(token0), _amount, address(this), uint16(0));
    }
    ...
    function _withdraw(uint256 _amount) internal {
        pool.withdraw(address(token0), _amount, address(this));
    }
    ...
    function _collectRewards() internal pure returns (uint256) {
        return 0;
    }
