...
contract Oxo is ERC721Enumerable, Ownable {
    using ECDSA for bytes32;
    using Strings for uint256;

    uint256 public totalTokenSupply; //Total token supply
    ...
    constructor() ERC721("0x0.Art", "OAN") {
        ...
        reserve = 100;
        preSalePrice = 250000000000000000000;
        publicPrice = 300000000000000000000;
        tokenId = 0;
    ...
    function publicMint(uint256 number) external payable returns(bool){
        ...
        require(
            number + tokenId + reserve <= totalTokenSupply,
    ...
    function mintToAddress(address _to) external onlyOwner{
        require(1 + tokenId + reserve <= totalTokenSupply, "Total tokens supply reached");
        tokenId += 1;
