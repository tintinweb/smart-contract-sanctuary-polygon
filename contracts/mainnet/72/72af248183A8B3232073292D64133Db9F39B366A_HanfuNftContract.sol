    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 100, 5200) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmWNmhvM4hUMKEfgn1wqkdCR7JSxvWfF1nYPXYzXGCUE1G/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/PjF558cac4QmptHHE4K6/contract-metadata";
  }
...
// File: contracts/HanfuNftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract HanfuNftContract is RamppERC721A {
    constructor() RamppERC721A("HanfuNFT", "HanfuNFT"){}
}
