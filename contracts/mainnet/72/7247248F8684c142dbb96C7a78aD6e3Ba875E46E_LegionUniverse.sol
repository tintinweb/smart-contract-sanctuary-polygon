...
// File: contracts/LegionUniverse.sol
...
contract LegionUniverse is Ownable, ERC721A, PaymentSplitter {
    ...
    uint public MAX_PER_WALLET_PUBLIC = 150;
    uint public MAX_PER_WALLET_WL = 150;


    uint public wlSalePrice = 80 ether;
    uint public publicSalePrice = 80 ether;
    ...
    constructor(uint96 _royaltyFeesInBips, address[] memory _team, uint[] memory _teamShares, bytes32 _merkleRootWL, string memory _baseURI) ERC721A("LegionUniverse", "LegionUniverse")
