...
contract SatishiLovelansPendant is ERC721 {
    ...
    constructor()
        ERC721("Satishi Lovelans' Pendant", "SLP")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeidvaosvc6jytzbd2iudmczyk7ceiiz5uchooxa23vxg5efkxkyxg4/", Strings.toString(tokenId), ".json")
            );
    }
