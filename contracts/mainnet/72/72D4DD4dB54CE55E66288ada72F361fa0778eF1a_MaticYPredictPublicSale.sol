...
contract MaticYPredictPublicSale is Ownable, Pausable, ReentrancyGuard {
    ...
    constructor() {
        ...
        if (block.chainid == 137) {
            ...
            s_vesting = IVestingHub(0x39A503b4Af2724912F6cd2a2763cdCBa484203Ea);
    ...
    function _getPriceOfGivenTokenInMatic(
        int256 amount
    ...
    function buyTokens(
        ...
        require(
            s_investemetByAddress[benificery] + payableAmountUSDT <=
                s_maxAmountToInvest,
            "YPredictPrivateSale: Exceeding maximum limit"
        );

        s_investemetByAddress[benificery] =
            s_investemetByAddress[benificery] +
            payableAmountUSDT;

        s_vesting.allocateTokensManager(benificery, tokenAmount);
