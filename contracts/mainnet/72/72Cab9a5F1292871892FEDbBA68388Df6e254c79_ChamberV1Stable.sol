...
interface IChamberV1Stable {
    ...
    function calculateCurrentPoolReserves() external view returns (uint256, uint256);
    ...
    function setLTV(uint256 _targetLTV, uint256 _minLTV, uint256 _maxLTV, uint256 _hedgeDev) external;
}
