...
// File: contracts/KikxNfts.sol


pragma solidity ^0.8.9;

/*
Contract: KIKX NFT Contract
Version: v0.0.1
Date: 31st of July, 2023
...
contract MyNFT is Initializable, ERC721Upgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    // Creating a mapping to set admins and another one for tokenUris.
    ...
    // Creating a transfer management boolean.
    ...
    function initialize() public initializer {
        ...
        // Setting the contract owner to be the initial admin.
    ...
    // Ability to toggle transferability of tokens.
    function setTransfersAllowed(bool status) public onlyOwner {
        _transfersAllowed = status;
    }

    // Ability to mint tokens by admins.
    function mint(address to, string memory uri) public {
        require(_admins[msg.sender], "Only admins can mint");
    ...
    // Ability to burn tokens by approved contracts and owner.
    function burn(uint256 tokenId) public {
        require(_isApprovedOrOwner(_msgSender(), tokenId), "ERC721: burn caller is not owner nor approved");
        _burn(tokenId);
    }

    // Ability to set metadata of a tokenId.
    function setTokenURI(uint256 tokenId, string memory _tokenURI) public {
        require(_exists(tokenId), "ERC721Metadata: URI set of nonexistent token");
        require(_admins[msg.sender], "Only admins can set URI");
        _tokenURIs[tokenId] = _tokenURI;
    }

    // Ability to get the tokenUri for a known tokenId.
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
    ...
    // Overriding the transferFrom function to enforce transfer rules.
    function transferFrom(address from, address to, uint256 tokenId) public virtual override {
        require(_transfersAllowed, "Transfers are currently not allowed");
        super.transferFrom(from, to, tokenId);
    }

    // Overriding the safeTransferFrom function to enforce transfer rules.
