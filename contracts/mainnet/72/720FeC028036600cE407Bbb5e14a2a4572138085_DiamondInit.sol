...
contract DiamondInit {
    ...
    function init() external {
        ...
        s.swap[C.ubo()][C.usdc()].ammRouters = [C.sushiGreenRouter(), C.sushiTridentRouter()];
        ...
        s.swap[C.nbo()][C.usdc()].ammRouters = [C.sushiGreenRouter(), C.sushiTridentRouter()];
        ...
        // Approve BentoBox
        IBentoBoxMinimal(C.sushiBento()).setMasterContractApproval(
            address(this),
            C.sushiTridentRouter(),
            true,
            0,
            0,
            0
