...
contract StopViolaceAgaistWomen is ERC721A, Ownable, ReentrancyGuard {

  string public        baseURI;
  uint public          price             = 0.009 ether;
  uint public          maxPerTx          = 30;
  uint public          maxPerWallet      = 1000;
  uint public          totalFree         = 1000;
  uint public          maxSupply         = 10000;
  uint public          nextOwnerToExplicitlySet;
  bool public          mintEnabled;

  constructor() ERC721A("Stop violance agaist women", "SVAW"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more SVAW nft");
    require(mintEnabled, "Minting is not live yet, hold on Stop violance agaist women.");
