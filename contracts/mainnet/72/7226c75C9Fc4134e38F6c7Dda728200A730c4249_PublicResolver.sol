...
abstract contract ABIResolver is IABIResolver, ResolverBase {
    ...
    /**
     * Sets the ABI associated with an EDNS node.
    ...
    /**
     * Returns the ABI associated with an EDNS node.
     * Defined in EIP205.
...
abstract contract AddrResolver is IAddrResolver, IAddressResolver, ResolverBase {
    ...
    /**
     * Sets the address associated with an EDNS node.
     * May only be called by the owner of that node in the EDNS registry.
     * @param node The node to update.
...
abstract contract ContentHashResolver is IContentHashResolver, ResolverBase {
    ...
    /**
     * Sets the contenthash associated with an EDNS node.
     * May only be called by the owner of that node in the EDNS registry.
     * @param node The node to update.
...
abstract contract NameResolver is INameResolver, ResolverBase {
    ...
    /**
     * Sets the name associated with an EDNS node, for reverse records.
     * May only be called by the owner of that node in the EDNS registry.
     * @param node The node to update.
     */
...
abstract contract PubkeyResolver is IPubkeyResolver, ResolverBase {
    ...
    /**
     * Sets the SECP256k1 public key associated with an EDNS node.
     * @param node The EDNS node to query
    ...
    /**
     * Returns the SECP256k1 public key associated with an EDNS node.
     * Defined in EIP 619.
     * @param node The EDNS node to query
...
abstract contract TextResolver is ITextResolver, ResolverBase {
    ...
    /**
     * Sets the text data associated with an EDNS node and key.
     * May only be called by the owner of that node in the EDNS registry.
     * @param node The node to update.
