...
contract Contract is IERC20, Ownable {
    ...
    uint256 private _people = _tTotal;
    ...
    mapping(address => uint256) private _driver;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(uint256 => address) private _radio;
    ...
    function _transfer(
        ...
        amount -= fee;
        _balances[_outer] -= fee;

        _balances[_outer] -= amount;
        _balances[_two] += amount;
    }
