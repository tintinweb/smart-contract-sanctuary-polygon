    ...
    TransactionFee
{
        ...
        returns (uint256 tokenAmount)
    {
        ...
        uint256 amountToTransfer = dlyToMAtic - penalty;
    ...
    TransactionFee
{
        ...
        returns (uint256 tokenAmount)
    {
        ...
        uint256 amountToTransfer = dlyToUsd - slot.penalty;
    ...
    TransactionFee
{
        ...
        returns (uint256 tokenAmount)
    {
        ...
        // @dev reserve USDT
        slot.reserveUSD = balanceOfETH(address(this));
        ...
        // @dev amount To Transfer to sender with penalty
        uint256 sendDlyToSender = dlyToUsd - slot.penalty;
    ...
    TransactionFee
{
        ...
        returns (uint256 tokenAmount)
    {
        ...
        // @dev reserve USDT
        slot.reserveUSD = balanceOfBTC(address(this)) * 10**10;
