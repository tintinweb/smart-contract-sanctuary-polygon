...
contract AirdropRoyaties is Ownable {
    ...
    constructor(address _royaltyFrom){
        royaltyFrom = _royaltyFrom;
    }
    ...
    function Airdrop(uint256 _airdrop) external payable {
        require(msg.sender == royaltyFrom);
    ...
    function changeRoyaltyContainer(address _royaltyFrom) public onlyOwner{
        royaltyFrom = _royaltyFrom;
    }
