    ...
    ReentrancyGuardUpgradeable
{
    ...
    */
    ...
    function adminSetTokenDecimals(
        ...
        require(!_unsupportedChains[destinationChainID], "Bridge: unsupported chain");
 ...
 */
    ...
    */
    ...
    function getBridgeFee(
        ...
        require(!_unsupportedChains[destChainID], "Bridge: unsupported chain");
        address handlerAddress = _resourceIDToHandlerAddress[resourceID];
        IERCHandler handler = IERCHandler(handlerAddress);
    ...
    */
    function genericDeposit(uint8 _destChainID, bytes32 _resourceID) external whenNotPaused returns (uint64) {
        require(!_unsupportedChains[_destChainID], "Bridge: unsupported chain");
    ...
    */
    function replayGenericDeposit(
        ...
        emit Deposit(_destChainID, _resourceID, _depositNonce, 0);
    }
...
interface ISequencerHandler {
    ...
    /// @param _erc20Data data regarding the swapDetails for erc20 transaction.
    /// @param _generic data for generic cross-chain call.
    /// @param hash hash for the generic call.
    /// @param _gas gas limit for the call.
    /// @param _feeToken fee token for payment of fees.
    /// @param _isErcFirst sequence for erc20 and generic call. True for prioritizing erc20 over generic call.
