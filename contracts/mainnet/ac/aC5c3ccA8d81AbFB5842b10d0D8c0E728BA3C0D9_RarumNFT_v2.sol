...
contract RarumNFT_v2 is RarumNFT_Permit {
    ...
    ***************************************/
    ...
    function updateTokenURI(
        ...
        onlyAdmin
    {
        require(bytes(_tokenURIs[id]).length != 0, "RarumNFT: token not registered");
    ...
    function setOwner(address _newOwner)
      ...
      onlyAdmin
    {
        require(_newOwner != address(0), "RarumNFT: invalid owner address");
...
contract RarumNFT_Roles is ERC1155PresetMinterPauserUpgradeable {
    ...
    modifier onlyAdmin() {
        require(hasRole(ADMIN_ROLE, _msgSender()), "RarumNFT: caller is not an ADMIN");
        _;
    }
}
