...
// File: node_modules/@openzeppelin/contracts/token/ERC721/extensions/ERC721Royalty.sol
...
// File: node_modules/@openzeppelin/contracts/token/ERC721/extensions/ERC721Pausable.sol
...
contract MosaicAlphaNFT2022 is ERC721, ERC721Enumerable, ERC721Royalty, Ownable, ReentrancyGuard {

    uint16 public constant MAX_TOKENS = 600;

    string public BASE_URI;

    // royalty fee in basis points
    uint96 public ROYALTY_FEE = 500;
    ...
    function mint(uint256 _amount) external onlyOwner {
        require(minted < MAX_TOKENS, "All tokens have been minted");
        require(minted + _amount <= MAX_TOKENS, "Cant mint that many NFTs, try with less");
