...
contract PolyDice is VRFConsumerBaseV2 {
    ...
    */
    ...
    modifier onlyAdmin() {
        require(msg.sender == _admin, "PolyDice: invalid msg.sender");
        _;
    }
   ...
   /**
    */
    function setRewardToken(address p_) external onlyAdmin {
        _p = p_;
    }
  
   /** 
    */
    function setRewardRate(uint256 baslineReward_) external onlyAdmin {
