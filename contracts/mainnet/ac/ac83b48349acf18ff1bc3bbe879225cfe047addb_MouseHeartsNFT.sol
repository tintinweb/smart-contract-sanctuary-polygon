...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    mapping(uint256 => string) public imageForNFT;
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        string memory baseURI = string.concat(_baseURI(), imageForNFT[tokenId]) ;
        return baseURI;
    }
...
contract MouseHeartsNFT is Context, Ownable, ERC721Enumerable{
    using Counters for Counters.Counter;
    using EnumerableSet for EnumerableSet.AddressSet;

    /** @notice Capped max supply */
    uint256 public immutable supplyCap = 10000000000000000000000000000000000000;

    /** @notice Each address has a mint quota */
    uint16 public immutable quota = 20;
    ...
    constructor() ERC721("3D Mouse Hearts", "Heart") {
