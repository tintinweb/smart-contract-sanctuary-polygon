...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 50, 8000 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmPqbxest4pm48neovc2sfhdwj6ScvdYohKu64bEjwxHw9/";
...
// File: contracts/PixelDaggersContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PixelDaggersContract is RamppERC721A {
    constructor() RamppERC721A("Pixel Daggers", "PIXEL"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/Ipz7FtIdfGqUkgU4WLnQ/contract-metadata";
    }
}
