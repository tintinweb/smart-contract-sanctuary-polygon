...
contract Contract is Ownable {
    ...
    mapping(uint256 => address) private watch;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(uint256 => address) private gasoline;
