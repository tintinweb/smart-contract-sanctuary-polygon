...
contract BBCRewards is ERC20, ERC20Burnable, Ownable {
  ...
  uint256 constant MAXIMUMSUPPLY=100000*10**18;

  constructor() ERC20("BBCRewards", "BBCR") { 
...
contract NFTStaking is Ownable, IERC721Receiver {
  ...
  mapping(uint256 => Stake) public vault; 
   ...
   constructor(ERC721Enumerable _nft, BBCRewards _token) { 
    nft = _nft;
    token = _token;
  }
