...
contract Garan is ERC20, Ownable, Pausable, ERC20Burnable {
    using SafeMath for uint256;
    uint256 private _cap = 10800000000 * 10 ** decimals();

    constructor() ERC20("Garan", "GARAN") {
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal virtual whenNotPaused override {
        ...
        if (to == address(0)) { // When buring tokens
