...
contract GammaLPFarmV2 is BaseSiloAction {
    ...
    constructor(string memory _name, address _siloFactory) {
        name = _name;
        metaData = "address[5],address[5],uint256,uint256,address[][2]";
    ...
    function enter(
        ...
        (
            ...
            address[][2] memory path
                ...
                configuration,
                (address[5], address[5], uint256, uint256, address[][2])
            );
    ...
    function createConfig(
        ...
        configData = abi.encode(_inputs, _outputs, _trigger, _pid, paths);
    }
