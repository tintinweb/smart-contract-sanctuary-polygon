...
contract FalineArena24 is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public cost = 9.40 ether;
  uint256 public maxSupply = 376;
  uint256 public maxMintAmountPerTx = 20;

  bool public paused = true;
  bool public revealed = false;

  constructor() ERC721("Faline Arena 24", "FA24") {
    setHiddenMetadataUri("ipfs://bafybeiaaddvxhtr3xiaeqr5w4hkixdypsjs635ggg5xx75xqt4wsqz2hfq");
  }
