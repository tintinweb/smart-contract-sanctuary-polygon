...
/** 
 *  SourceUnit: /Users/antonstesluks/Desktop/ZeitlsERC721a/contracts/ZeitsNFT.sol
*/
 ...
 * Assumes that the maximum token id cannot exceed 2**256 - 1 (max value of uint256).
 */
contract ZeitsNFT is ERC721A, Ownable {
    using Strings for uint256;
    ...
    constructor(string memory name_, string memory symbol_, string memory baseUri_, string memory contractUri_) ERC721A(name_, symbol_) {
