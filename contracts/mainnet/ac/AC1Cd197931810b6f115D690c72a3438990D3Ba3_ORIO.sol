...
contract ORIO is ERC20, Ownable {
    uint256 public buyTax = 400; // 4%
    uint256 public sellTax = 200; // 2%
    uint256 public immutable MAX_TAX = 3000; // 10%
    ...
    /**
     * @dev Creates a ORIO token contract
     * - MUST mint the total supply (100 mil) of tokens
     */
    constructor(address uniV2Router) ERC20("ORIO", "ORIO") {
    ...
    /**
     * @dev Hooks buy/sell transfer to get the fee amount of ORIO token
     *
