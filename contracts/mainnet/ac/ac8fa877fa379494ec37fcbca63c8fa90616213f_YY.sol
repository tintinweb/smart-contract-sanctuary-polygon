...
// File: @openzeppelin/[email protected]3/utils/Arrays.sol
...
contract YY is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    constructor() ERC20("YY", "YY") ERC20Permit("YY") {
        _mint(msg.sender, 20230520 * 10 ** decimals());
    }
