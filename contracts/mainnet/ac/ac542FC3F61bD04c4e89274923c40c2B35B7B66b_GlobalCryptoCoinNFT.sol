...
// File: contracts/GlobalCrypto.sol
...
contract GlobalCryptoCoinNFT is Ownable, ERC721A, PaymentSplitter, DefaultOperatorFilterer {
    ...
    uint public MAX_PER_WALLET_PUBLIC = 500;
    uint public MAX_PER_WALLET_WL = 500;


    uint public wlSalePrice = 37 ether;
    uint public publicSalePrice = 46 ether;
    ...
    constructor(uint96 _royaltyFeesInBips, address[] memory _team, uint[] memory _teamShares, bytes32 _merkleRootWL, string memory _baseURI) ERC721A("GlobalCryptoCoinNFT", "GlobalCryptoCoinNFT")
