...
contract TerminusTokenInitializer {
    function setTerminusTokenAddress(address terminusTokenAddress) external {
        LibDiamond.enforceIsContractOwner();
        LibTerminusToken.setTerminusTokenAddress(terminusTokenAddress);
    }

    function getTerminusTokenAddress() external view returns(address) {
        return LibTerminusToken.getTerminusTokenAddress();
    }
}
