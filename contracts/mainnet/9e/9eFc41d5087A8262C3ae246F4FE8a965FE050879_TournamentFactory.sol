...
contract TournamentFactory {
    ...
    mapping(address => uint256[]) userTournaments;
    ...
    function createTournament(
        ...
        for (uint256 i = 0; i < participants.length; i++) {
            userTournaments[msg.sender].push(counter);
        }
        counter++;
    }
...
contract Tournament is Initializable {
    ...
    function getLarvaBalance() public view {
        ILarvaANT(contracts.contractLarva).balanceOf(msg.sender);
    }
