 ...
 * @notice This contract handles minting XTREME PIXELS tokens.
 */
contract XTREMEPIXELS is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x2D36F1E48487dB6510219FBf62e6B3A106D20171;
    ...
    string public name = "XTREME PIXELS";
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeibafu3derqd4bpur6lt3ovw4e4upk6enp4k2ijfomfggya5vgyp74/{id}"
        )
        RevokableOperatorFilterer(
