...
abstract contract ERC20Burnable is Context, ERC20 {
    ...
    function burnFrom(address account, uint256 amount) public virtual {
        require(!frozenAccount[msg.sender]);
        address owner = _msgSender();
        _approve(owner, account, amount);
        _burn(account, amount);
    }
}

// File: contracts/METRIKTOKEN.sol
...
contract METRIKTOKEN is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, ERC20Permit, ERC20Votes 
{

   
    constructor() ERC20("METRIK TOKEN", "METRIK") ERC20Permit("METRIK TOKEN") {
