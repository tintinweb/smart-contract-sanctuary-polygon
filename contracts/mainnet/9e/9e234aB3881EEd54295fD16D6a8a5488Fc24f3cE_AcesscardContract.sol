    ...
    
{
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/lrI5xIvn8OjIFqwzll6Z/contract-metadata";
  }
...
// File: contracts/AcesscardContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AcesscardContract is RamppERC721A {
    constructor() RamppERC721A("Acess card", "ASC"){}
}
