...
contract Gplayv5 {
    ...
    //    event RequestPayment(bytes32 indexed requestId, uint256 Payment);
   constructor ()  {
    owner = msg.sender;
   }
  ...
  function ChangeGameMasterLocation(address newAddy) onlyOwner public {
   ...
   function GameEndWithdrawal(address sendPaymentAddress, uint256 value_Stake, uint256 ServerCode ) public payable {
            ...
            uint256 PlayerReward = (value_Stake * 85)/ 100;
            ...
            TotalBreadWCollected[sendPaymentAddress] += PlayerReward;
