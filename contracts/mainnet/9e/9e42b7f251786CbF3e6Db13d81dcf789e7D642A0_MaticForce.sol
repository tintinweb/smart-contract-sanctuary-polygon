...
contract MaticForce {
	...
	uint256 constant public minInvestmentAmount = 35 ether;
    ...
    uint256[5] public defaultPackages = [35 ether,70 ether,140 ether,280 ether,700 ether];
    ...
    constructor() public {
		primaryAdmin = 0xb9D2D29113228fC26cEBdE524CA0017c8A592DD2;
