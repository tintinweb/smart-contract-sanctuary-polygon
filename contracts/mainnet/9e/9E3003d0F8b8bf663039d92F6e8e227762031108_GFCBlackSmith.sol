...
contract GFCBlackSmith is OwnableUpgradeable, WhitelistUpgradeable, VRFConsumerBaseV2 {
    ...
    function getForgeCost() public view returns (uint256[] memory) {
        return forgeCost;
    }
    ...
    function chargeGCOIN(uint256 tier) internal {
        ...
        require(forgeCost[tier-1] != 0, "invalid forge price or tier");
        require(IERC20Upgradeable(TOKEN).allowance(msg.sender, address(this)) >= forgeCost[tier-1], "insufficient allowance");
        IERC20Upgradeable(TOKEN).safeTransferFrom(msg.sender, address(this), forgeCost[tier-1]);
    }
    ...
    function setCallbackGas(uint32 _gasLimit) public onlyOwner{
...
contract WeaponMock is ERC1155Upgradeable, WhitelistUpgradeable {
    constructor(string memory url) ERC1155Upgradeable () {}
