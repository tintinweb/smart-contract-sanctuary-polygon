...
contract HOMGOLDToken is BEP20, MinterRole {
     ...
     */
    constructor(address _treasury, address _HOM, address _lpcontract) public BEP20("HOM-GOLDToken", "HOM-GOLD") {
        operator = _msgSender();
    ...
    function getReserves1() public view returns (uint112 reserve0, uint112 reserve1, uint32 blockTimestampLast) {
        return IUniswapV2Pair( lpcontract ).getReserves();
    }

    function reserves1() public view returns (uint256 reserves)
    {
        reserves=reserve0*100/reserve1;
