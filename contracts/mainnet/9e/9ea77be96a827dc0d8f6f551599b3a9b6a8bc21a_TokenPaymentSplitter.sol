...
// File: contracts/Erc20PaymentSplitter.sol
...
contract TokenPaymentSplitter is AccessControl{
    ...
    // Returns the total allocated shares
    function totalShares() public view returns (uint256) {
    return _totalShares;
    }

    // Returns the shares for a given account
    function shares(address account) public view returns (uint256) {
        return _shares[account];
    }

    // Returns the payee address given index
    function payee(uint256 index) public view returns (address) {
        return _payees[index];
    }

    // Returns total tokens released
    function totalTokenReleased() public view returns(uint256){
        return _totalTokenReleased;
    }

    // Update the shares for a given payee
    function _updateShares(address account, uint256 shares_) public{
    ...
    // Add a payee to the payment splitter
    ...
    // Release funds to specific payee
