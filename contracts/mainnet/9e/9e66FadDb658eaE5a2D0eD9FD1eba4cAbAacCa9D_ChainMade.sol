...
contract ChainMade is ERC721Enumerable, Ownable {
    event SeedUpdated(uint256 indexed tokenId, uint256 seed);

    mapping(uint256 => uint256) internal seeds;
    ArtDescriptor public descriptor;
    uint256 public maxSupply = 10000;
    bool public minting = false;
    bool public canUpdateSeed = true;

    constructor(ArtDescriptor newDescriptor) ERC721("ChainMade", "ART") {
    ...
    function setDescriptor(ArtDescriptor newDescriptor) external onlyOwner {
        descriptor = newDescriptor;
    }
