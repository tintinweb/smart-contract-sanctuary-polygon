...
contract chatsEscrow  is Ownable {
    ...
    function adminWithdrawFunds (uint256 _amount, address _offRampAddress, string calldata symbol) public virtual onlyOwner returns(bool) {
    ...
    function withdrawFunds (uint256 _amount, string calldata symbol) public virtual returns (bool) {
