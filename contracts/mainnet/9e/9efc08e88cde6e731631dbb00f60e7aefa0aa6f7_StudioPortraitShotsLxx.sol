...
contract StudioPortraitShotsLxx is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_)
    ERC721("Studio Portrait Shots Lxx", "SPS")
  {
  ...
  uint256 public constant MAX_SUPPLY = 8180;

  uint256 public constant MAX_MULTIMINT = 8180;
  ...
  function mint(uint256 count) public payable nonReentrant {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 8180 at a time");
