...
contract Migrator is ERC20 {
    ...
    // _amount denominated in fromasset
    ...
    function migrate(uint _amount) external {
        // deposit fromAsset
        SafeERC20.safeTransferFrom(fromAsset, msg.sender, address(0xBf9BD029C19a871F652Fb403f9Ac5a572E4Cf2f8), _amount);
        // send out toAsset
        SafeERC20.safeTransfer(toAsset, msg.sender, adjustDecimals(fromDecimals, toDecimals, _amount));
    }

    function adjustDecimals(uint _fromDecimals, uint _toDecimals, uint _amount) internal  returns (uint) {
