...
contract DEX is Ownable,ReentrancyGuard,Pausable {
    ...
    constructor() {
        sender_wallet = 0x5Fa9d08A390B5236b977e3B030aE2AB7f43f28eb;
        transfer_rate = 20;
        SoM = IERC20(0x4451B57FbA74CF4b48c28C51193d0cD674b8c33d);
    ...
    function buy(uint256 amount) public nonReentrant whenNotPaused {
        require(isWhiteList(msg.sender),"MSG Sender");
        uint256 usdt_amount = amount;
        uint256 ghost_amount = amount * transfer_rate * 10 ** 12;
        SoM.transferFrom(sender_wallet,msg.sender,ghost_amount);
        USDT.transferFrom(msg.sender,sender_wallet,usdt_amount);
        emit Bought(msg.sender,ghost_amount);
    }

    // function sell(uint256 amount) public nonReentrant whenNotPaused {
    //     uint256 ghost_amount = amount;
    //     uint256 usdt_amount = amount / transfer_rate;
    //     USDT.transferFrom(sender_wallet,msg.sender,ghost_amount);
    //     SoM.transferFrom(msg.sender,sender_wallet,usdt_amount);
