...
contract CryptoMondayAnthonyOrtiz is ERC721, ERC721Enumerable, ERC721Burnable, ERC721Royalty, Ownable {
    ...
    constructor(address trustedForwarder) ERC721("CryptoMondayAnthonyOrtiz", "CMAO_E10") {
        _tokenIds.increment();
