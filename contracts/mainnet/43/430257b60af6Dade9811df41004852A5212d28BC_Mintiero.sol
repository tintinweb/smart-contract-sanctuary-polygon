...
contract Mintiero is ERC1155, Ownable, IRamperInterface1155 {
    ...
    string public _baseURI = "https://bafybeibl7pqccvog4ogr4ohjww4xnpkrqw33onnhasnewpnrzudymdv5zm.ipfs.nftstorage.link/";
    uint256 constant public MAX_TOKENS_PER_TXN = 1;

    constructor(string memory _name) ERC1155(_baseURI) {
        name = _name;
    }
    ...
    function setTokenPrice(uint256 tokenId, uint256 price) public onlyOwner {
        tokenPrices[tokenId] = price * 10**14;
    }

    function mint(address _userWallet, uint256 _quantity, uint256 _tokenId) override external payable {
        require(msg.value >= tokenPrices[_tokenId] * _quantity, "Insufficient funds for requested tokens");
