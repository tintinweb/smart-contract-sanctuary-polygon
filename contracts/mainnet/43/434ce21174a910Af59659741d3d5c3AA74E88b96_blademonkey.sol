...
// File: contracts/operator-filter-registry/lib/Constants.sol
    ...
    contract blademonkey is IERC721L, ERC721AQueryable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
    
        // Whether base URI is permanent. Once set, base URI is immutable.
        bool private _baseURIPermanent;
    
        // The total mintable supply.
        uint256 internal _maxMintableSupply = 3010;
        ...
        // Current base URI.
        string private _currentBaseURI = "ipfs://bafybeic6varwwlqua4w2z4rjyt7b3zmjp3sbjxrvvfpq2beamzq6ocly7a/";
        ...
        constructor() ERC721A("Blade Monkey 2023", "BMON") {
            _mintStages.push(MintStageInfo({cost: 0, walletLimit: 3, merkleRoot: 0x0, maxStageSupply: 0, startTimeUnixSeconds: 1690642839, endTimeUnixSeconds: 1695820599}));
        }
