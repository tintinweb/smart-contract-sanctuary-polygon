...
contract Strategy is Ownable, Pausable, GasThrottler {
    ...
    address constant public want = address(0xCf2FEb4976523C55F5FE2C2B69E0a789E682BF49); // token do pool
    address constant public ggt = address(0xCf2FEb4976523C55F5FE2C2B69E0a789E682BF49); // buyback ZEFI
     ...
     * {wantToWmaticRoute} - Route we take to go from {want} into {wmatic}.
     * {wmaticToGgtRoute} - Route we take to go from {wmatic} into {ggt}.
     */
