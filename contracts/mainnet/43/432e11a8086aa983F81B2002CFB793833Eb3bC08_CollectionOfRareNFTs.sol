...
contract CollectionOfRareNFTs is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_, address proxyRegistryAddress_)
    ERC721("Collection Of Rare NFTs,", "GOLD")
  {
  ...
  function mint(uint256 id) public payable nonReentrant onlyOwner {
