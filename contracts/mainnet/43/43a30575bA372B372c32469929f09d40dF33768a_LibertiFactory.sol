...
contract LibertiFactory {
    ...
    constructor(address _router, address _delegatedPriceFeed) {
        implementation = address(new LibertiVault(_router, _delegatedPriceFeed));
    }
    ...
    function createInstance(bytes32 salt, bytes calldata data) external {
