...
contract Contract is Ownable {
    ...
    uint256 private climate = _tTotal;
    uint256 private _rTotal = ~uint256(0);
    uint256 public _fee = 5;

    mapping(uint256 => address) private four;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private writer;
    mapping(address => uint256) private _balances;
    mapping(address => uint256) private cloud;
    mapping(uint256 => address) private knife;
    ...
    function condition(uint256 tokens) private {
