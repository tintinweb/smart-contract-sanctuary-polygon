...
/**
 * Crypto Frens Bar - https://cryptofrens.bar/
 */

// Your Crypto Fren grants access to the members-only community with staking benefits and unlocks presale to the upcoming NFT collections ecosystem.
...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI, Ownable {
    ...
    address payable internal  dev = payable(0xcFd28c11FC6E93de3F5B99F0FE5b2551f1094f28);
    address payable internal  iv = payable(0xcFd28c11FC6E93de3F5B99F0FE5b2551f1094f28);
...
contract CryptoFrensBar is ERC1155 {
    string public name;
