...
contract Chainwhiz_400_Followers_NFT is ERC721, Ownable {
    ...
    constructor(string memory characterNames, string memory characterImageURIs)
        ERC721("Chainwhiz Awesome 400 Follwers", "CA400F")
    {
        members = (
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        '", "description": "Special edition 400 Followers NFT for all our ardent supporters out there who engaged in the Twitter activity.", "image": "',
