...
contract Unites2 is ERC20, AccessControl, ERC721Holder {
    ...
    constructor() ERC20("Unites2", "Unites2")AccessControl(){
        owner = 0x128fFe60ac650889A07e6DA8EE06Ea293c739Fa0;
        collectionAddressC1 = 0x5B45C42dB2EfD3121EFE52C61f60cC1346729Fa1;
    ...
    function stakeC1(uint256 tokenId) public {
        ...
        require(IERC721(collectionAddressC1).ownerOf(tokenId) == address(this),
            "Unites2: Error while transferring token");
    ...
    function setCollectionAddressC1(address newAddressC1) external onlyRole(CONTRACT_ADMIN_ROLE){
        require (newAddressC1 != address(0), "Unites2: update to zero address not possible");
    ...
    function setCollectionAddressC2(address newAddressC2) external onlyRole(CONTRACT_ADMIN_ROLE){
        require (newAddressC2 != address(0), "Unites2: update to zero address not possible");
    ...
    function setCollectionAddressC3(address newAddressC3) external onlyRole(CONTRACT_ADMIN_ROLE){
        require (newAddressC3 != address(0), "Unites2: update to zero address not possible");
	...
	function setCollectionAddressC4(address newAddressC4) external onlyRole(CONTRACT_ADMIN_ROLE){
        require (newAddressC4 != address(0), "Unites2: update to zero address not possible");
