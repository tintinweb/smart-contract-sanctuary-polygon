...
contract EventManager is Ownable {
    ...
    function testFunction() external {
        uint256 weightClassesCount = 15;
        uint256 attributeCount = 6;
        uint256 roundCount = 7;
        uint256 dudesCount = 2;

        uint256 total = weightClassesCount * attributeCount * roundCount * dudesCount;
    ...
    function executeFightNight(uint256 eventId) external {
    ...
    function cancelFightNight(uint256 eventId) external {
        require(isFightCoordinator(eventId, msg.sender), "Sender not the fight coordinator");
