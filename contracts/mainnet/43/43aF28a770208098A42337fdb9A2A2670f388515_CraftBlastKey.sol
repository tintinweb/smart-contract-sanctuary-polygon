 ...
 * @notice This contract handles minting Craft Blast Key tokens.
 */
contract CraftBlastKey is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x32aA4F16ae4AC2360EB26CCde3E8a3C70Df889aF;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x69999C2Dcf117d3768cf84c7b5Bc56007FBC70Df;
    address[] public payoutAddresses = [
        0x69999C2Dcf117d3768cf84c7b5Bc56007FBC70Df
    ];
    ...
    string public name = "Craft Blast Key";
    string public symbol = "CBKEY";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeifztu7onocmetkrl3yshgjc2cfjyggf54accjph6qp2bnhrvaina4/{id}"
        )
        RevokableOperatorFilterer(
