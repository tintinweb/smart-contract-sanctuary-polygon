...
/*[ PRESET VARIABLES ]------------------------------------------------------------------------------------------------------------------*/
    address public TOKENaddy = address(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270);     /* TOKEN address                                */
    address public cTOKENaddy = address(0x3FaE5e5722C51cdb5B0afD8c7082e8a6AF336Ee8);    /* cTOKEN address                               */
    uint256 public decimals = 1000000000000000000;                  /* The Tokens Decimal format                                        */
    uint256 public minimumBet = 1000000000000000000;                /* The Minimum Amount of Tokens a User can Bet                      */
    bytes32 public tokenName = "WMATIC";                            /* TOKEN name                                                       */
    ...
    uint256 public swapAmt = 1000000000000000000;                   /* The amount of Tokens to be swapped into wLINK                    */
/*[ CHAINLINK VARIABLES ]---------------------------------------------------------------------------------------------------------------*/
