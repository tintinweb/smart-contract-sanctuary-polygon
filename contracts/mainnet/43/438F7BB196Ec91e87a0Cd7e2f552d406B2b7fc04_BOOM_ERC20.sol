...
abstract contract BOOM_ERC20_Base is AppModuleUpgradeable {
	...
	return AppConsts.BOOM_ERC20_CONTRACT_ID;
    }

    function getName() override view public returns(string memory) {
	return AppConsts.BOOM_ERC20_CONTRACT_NAME;
    }
...
import "./BOOM_ERC20_Base.sol";

contract BOOM_ERC20 is ERC20Upgradeable, BOOM_ERC20_Base {

    uint256[256] __gap;

    function initialize() public virtual initializer {
	ERC20Upgradeable.__ERC20_init("BOOM City utility ERC20 token","B00M");
	__Base_init();
    }

    function mint(address to, uint256 value) public onlyERC20Minter {
	_mint(to, value);
    }
