...
contract RESTOToken is ERC20Pausable {
    string public constant name = "Little Flower";
    string public constant symbol = "LTF";
    uint32 public constant decimals = 18;
    uint256 public INITIAL_SUPPLY = 10000 * 1 ether; // 1 100 000 000
    address public CrowdsaleAddress;


    constructor(address myAddress) public {
    
        CrowdsaleAddress = myAddress;
        _mint(myAddress, INITIAL_SUPPLY);
    }
...
contract Crowdsale is Ownable {
    ...
    */
    ...
    // !!!     убрать нижние функции перед развертыванием в реальной сети   !!!
