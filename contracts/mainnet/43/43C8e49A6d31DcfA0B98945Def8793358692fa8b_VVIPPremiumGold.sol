...
contract VVIPPremiumGold is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_, address proxyRegistryAddress_)
    ERC721("VVIP Premium Gold", "VPCG")
  {
  ...
  uint256 public constant PRICE = 210000000000000000000;
  ...
  function mint(uint256 count) public payable nonReentrant {
    ...
    require(
      msg.value >= PRICE * count, "Insufficient payment, 210 ETH per item"
    );
