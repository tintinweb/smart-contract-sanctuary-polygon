...
contract Usdtify is Ownable, Pausable, ReentrancyGuard {
    ...
    uint256 amount = validHashes[secretHash] * 1e12; // Adjust amount based on token decimal places
    ...
    uint256 amount = pendingWithdrawals[_beneficiary] / 1e12; // Adjust amount based on token decimal places
