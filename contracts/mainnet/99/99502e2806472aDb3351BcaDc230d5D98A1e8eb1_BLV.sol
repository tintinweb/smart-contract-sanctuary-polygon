...
contract BLV is Context, IBEP20, Ownable {
  ...
  uint256 private _unlockTime = 1669766400;
  uint256 private _unlockPeriod = 0;

  address private _project = 0x6433ffe55562cc03da2C0Bfa144Fb1158959D505;
  address private _recoverpool = 0x803619fBCe03fA5D34F875C29dEb3aA78D9BbC27;
  address private _technology = 0x82A426BE13cbFe17714ea7A11CB1693257C5af37;
  address private _investor = 0x8cd631bec0232a138f728E7540f35883d91D7461;
  address private _community = 0x792cc18e1bed22Df4A5c5C158260EA8240562aB1;
  ...
  constructor() public {
    ...
    _transfer(address(this), _project, 1000000 * 10 ** 18);
  ...
  function unlock(uint256 amount) public returns (bool) {
    ...
    uint256 period = (block.timestamp.sub(_unlockTime)).div(86400);
