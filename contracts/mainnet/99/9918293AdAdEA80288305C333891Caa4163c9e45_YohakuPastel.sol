...
contract YohakuPastel is ERC721A("YohakuPastel", "YHK"), Ownable {
    ...
    address public constant withdrawAddress = 0xDb40277dd6B3d4f0971A982f9fE9Fd5D96905E0e;
    ...
    string public baseURI = "ipfs://QmRJmwpNnDmdMxki9hbGrR8UzKEDRXYhr4tEdfmGuHWuRp/";
    ...
    function whiteListMint(uint256 _mintAmount) external payable {
        ...
        if (totalSupply() + _mintAmount > maxSupply) revert MintReachedMaxSupply();
        if (whiteListMintedAmount[_msgSender()] + _mintAmount > whiteList[_msgSender()]) revert MintReachedWhiteListMaxMintAmount();
    ...
    function getWhiteListCountOfOwner(address owner) public view returns (uint256) {
