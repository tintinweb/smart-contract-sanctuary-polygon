...
contract METAVIA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "METAVIA";
    string private constant _symbol = "METAVIA";
    ...
    uint256 private _marketingFee = 25;
