...
contract GothPupJnr is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("GothPupJnr", "GPJ") {
    setHiddenMetadataUri("ipfs://QmWaQqBvdPHEonxkp4UBFTV3zJuPWqhZ8F9BpUPnF9TgLV/hidden.json");
  }
