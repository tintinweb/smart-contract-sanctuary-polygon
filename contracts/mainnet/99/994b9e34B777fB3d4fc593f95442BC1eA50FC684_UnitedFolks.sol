...
contract UnitedFolks is ERC721, Ownable, ContextMixin {
    ...
    uint public constant COLLECTION_SIZE = 8216;
    
    uint public constant TOKENS_PER_TRAN_LIMIT = 1;
    
    uint public constant TOKENS_PER_PERSON_WL_LIMIT = 1;
    uint public constant PRESALE_MINT_PRICE = 600 ether;
    uint public MINT_PRICE = 750 ether;
    SaleStatus public saleStatus = SaleStatus.PAUSED;
    bytes32 public merkleRoot;
    string private _baseURL;
    string public preRevealURL = "null";
    mapping(address => uint) private _mintedCount;
    mapping(address => uint) private _whitelistMintedCount;

    constructor() ERC721("UnitedFolks", "UFG"){}
    ...
    function contractURI() public pure returns (string memory) {
        return "https://zerocodenft.azurewebsites.net/api/marketplacecollections/f7bfcd1d-25ad-45cd-a678-08da6a02c7ae";
    }
    ...
    function redeem(bytes32[] calldata merkleProof, uint count) external payable {
        ...
        require(count <= TOKENS_PER_TRAN_LIMIT, "ZeroCodeNFT: Number of requested tokens exceeds allowance (1)");
