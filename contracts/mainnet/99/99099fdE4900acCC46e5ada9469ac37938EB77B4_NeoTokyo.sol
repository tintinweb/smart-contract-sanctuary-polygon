 ...
 * @notice This contract handles minting Neo Tokyo tokens.
 */
contract NeoTokyo is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xCD7a7b818C93726022159606B7515b3b61a4DfF0;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x319aC1AEF9ff7FBF817fe3b3299C5D6478334E3B;
    address[] public payoutAddresses = [
        0x319aC1AEF9ff7FBF817fe3b3299C5D6478334E3B
    ];
    ...
    string public name = "Neo Tokyo";
    string public symbol = "NeoTokyo";
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeicfxavrckwiq5ji4hf4ni63npf73vzcowyhuuvpdklgvyooqz4zci/{id}"
        )
        RevokableOperatorFilterer(
