...
contract OplanCityQ1 is ERC721AQueryable, Ownable {
  using Strings for uint256;

  string public uriPrefix = '';
  string public uriSuffix = '.json';

  constructor() ERC721A("Oplan City Q1", "immobili") {
        setUriPrefix("ipfs://QmPy9pWESiTufrUPgFTtrYB9zBb2KF4L7cQYn9r3oGTD5d/");
        _safeMint(owner(), 1505);
  }
