...
import "./PFPDAO.sol";
import {PFPDAORoleVariantManager} from "./PFPDAORoleVariantManager.sol";
import {PFPDAOStyleVariantManager} from "./PFPDAOStyleVariantManager.sol";

error InvalidSlot();
error NotAllowed();
error NotOwner();

contract PFPDAORole is PFPDAO, PFPDAORoleVariantManager, PFPDAOStyleVariantManager {
...
abstract contract PFPDAOStyleVariantManager is Initializable {
    mapping(address => mapping(uint16 => mapping(uint8 => uint32))) public addressToStyleVariant;
    mapping(uint16 => mapping(uint8 => uint32)) public lastStyleVariant;

    function __PFPDAOStyleVariantManager_init() internal onlyInitializing {
        __PFPDAOStyleVariantManager_init_unchained();
    }

    function __PFPDAOStyleVariantManager_init_unchained() internal onlyInitializing {}
