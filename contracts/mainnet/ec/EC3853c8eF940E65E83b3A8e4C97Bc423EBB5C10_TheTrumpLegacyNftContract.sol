...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xC5A22362Eab6B0810e58E9bC74bba3d9ff3c72ad];
  address public erc20Payable = 0xC5A22362Eab6B0810e58E9bC74bba3d9ff3c72ad;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 4547) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmXCvnQDr9nrBP1zT11PLCsJSsXyVDdSvM22XP4UzcsXUn/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/87go9IuzUSQWUOMxu20x/contract-metadata";
  }
...
// File: contracts/TheTrumpLegacyNftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheTrumpLegacyNftContract is RamppERC721A {
    constructor() RamppERC721A("The Trump Legacy NFT ", "TLPNFT"){}
}
