...
// File: contracts/PlanetCamoraNFTToken.sol
...
contract PlanetCamoraNFTToken is ERC721Enumerable, Ownable, Royalties, MinterRole {
    using Strings for uint256;
    using SafeMath for uint256;

    string public baseExtension = ".json";
    string public baseURI = "https://planet-camora-reveal.s3.us-east-2.amazonaws.com/";
    ...
    function mint(
        ...
        require(_mintAmount > 0, "PlanetCamoraNFTToken: mintAmount should be > 0");
        ...
        returns (string memory)
    {
        require(
            _exists(tokenId),
            "PlanetCamoraNFTToken: URI query for nonexistent token"
        );
