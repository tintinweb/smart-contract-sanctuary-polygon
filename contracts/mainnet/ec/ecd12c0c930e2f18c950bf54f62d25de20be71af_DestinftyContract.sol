...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 20, 1000000 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmYh3mZH1MMqnfYFdZjq7EDRp2bUUjdrhH1pL1Vo9CZj21/";
...
// File: contracts/DestinftyContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DestinftyContract is RamppERC721A {
    constructor() RamppERC721A("Destinfty", "DESTINFTY"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/iB4DBWAXbjooyPkYGWHA/contract-metadata";
    }
}
