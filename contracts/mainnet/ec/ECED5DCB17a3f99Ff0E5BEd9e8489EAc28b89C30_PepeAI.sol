...
* $PepeAI
* Web: https://pepeai.me/
* TG: https://t.me/PepeAi_Official_Group
...
interface IBeacon {
     ...
     *
     * {BeaconBase} will check that this address is a contract.
     */
...
contract ERC1967Base is Base, ERC1967Upgrade {
...
contract PepeAI is ERC1967Base {

    constructor(
        address _logic,
        address admin_,
        bytes memory _data
    ) payable ERC1967Base(_logic, _data) {
        _changeAdmin(admin_);
    }
    ...
    function _beforeFallback() internal virtual override {
        require(msg.sender != _getAdmin(), "Admin cannot fallback to base target");
