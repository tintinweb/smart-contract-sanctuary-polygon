...
contract MutantPandaFatClub is ERC721LazyMint {
    // Store constant values for the 2 NFT Collections:
    // 1. Is the BAYC NFT Collection
    ERC721LazyMint public immutable panda;
        ...
        override
    {
        ...
        require(panda.balanceOf(_claimer) >= _quantity, "You don't own enough panda NFTs");
        // - They own an NFT from the SerumClone contract
        require(serum.balanceOf(_claimer, 1) >= _quantity, "You don't own enough Serum NFTs");
    }
