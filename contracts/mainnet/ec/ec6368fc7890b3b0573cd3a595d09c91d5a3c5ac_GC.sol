...
contract GC is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://QmR21YK3QM9JNHHPXbcesryoj8PciJQyxFXL4CcYhSNPTL/";
  string public uriSuffix = ".json";
  string public hiddenMetadataUri;
  
  uint256 public cost = 875 ether;
  ...
  constructor() ERC721("Geographic Coordinates", "GC") {
    setHiddenMetadataUri("ipfs://QmfPs1LbBtvrWWi3eiVhQNRDt7sag8UU5dHmn6h3wMcM49/hidden.json");
  }
