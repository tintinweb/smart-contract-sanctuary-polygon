...
library TransferHelper {
    ...
    function safeSync(address pair) internal {
        // bytes4(keccak256(bytes('sync()')));
        (bool success, bytes memory data) = pair.call(abi.encodeWithSelector(0xfff6cae9));
        require(success && (data.length == 0 || abi.decode(data, (bool))), 'TransferHelper: SYNC_FAILED');
    }
}
// File: contracts/IUniswapV2Callee.sol
