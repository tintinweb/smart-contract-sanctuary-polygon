...
// Invest in cryptocurrency is never easy
// Your fantasy dream is here
// Buy hold Fortune and be Millionaire
// Good Luck !!!!
...
contract FORTUNE is Context, IERC20, Ownable {
    ...
    uint256 public  _whaleSellTaxFee  = 24;  
    uint256 private _previousTaxFee;
    uint256 public  _goldPortionMultiply = 3;     
    uint256 public vSwap = 88;
    uint256 public vGold = 88;
    uint256 public vWhale = 888;
    ...
    uint256 public _buybackMaticThreshold  = 8 * 10**9 * 10**9;      
    uint256 public _buybackUpperLimit    = 88 * 10**9 * 10**9; 
    ...
    uint    public  _goldChance       = 100;               
    uint256 public  _goldThreshold    = 888 * 10**18;
