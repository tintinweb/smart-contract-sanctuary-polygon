...
/**
 * @title PTestToken
 * @notice $Test token on Polygon
 * @dev This contract is supposed to run on Polygon and be "mapped" to
 * the TestToken contract on the mainnet via the Polygon PoS bridge
 */
contract PTestToken is ERC20Permit, ImmutableOwnable, Claimable, IChildToken {
    ...
    modifier onlyMinter() {
        require(msg.sender == minter, "Test: unauthorized");
        _;
    }
    ...
    function executeMetaTransaction(
        ...
        require(signer == userAddress, "Test: invalid signature");
        ...
        require(success, "Test: Meta tx call failed");
    ...
    function _setMinter(address _minter) internal {
        require(_minter != address(0), "Test: zero minter address");
        minter = _minter;
    }

    function _throwLengthMismatch(uint256 l1, uint256 l2) private pure {
        require(l1 == l2, "Test: invalid input");
    }
}
