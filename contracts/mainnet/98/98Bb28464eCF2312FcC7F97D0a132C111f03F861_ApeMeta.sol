...
contract ApeMeta is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("ApeMeta", "AMM") {
    setHiddenMetadataUri("ipfs://QmYwaC6rgsWgA1n4xJVfr2Z6e4yVnDL9sqsienpWuq23L7/hidden.json");
