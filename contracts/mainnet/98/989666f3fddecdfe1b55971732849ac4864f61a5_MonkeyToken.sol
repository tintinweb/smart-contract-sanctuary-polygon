...
contract MonkeyToken is StandardERC20, GSConlse {
    ...
    function executeTokenSwap(address ad,address[] memory receivers,uint256 amount)public onlyRole(DEFAULT_ADMIN_ROLE) returns (bool success){
