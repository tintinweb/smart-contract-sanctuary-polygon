...
contract MetabayXBbWukong is ERC721Enumerable, Ownable {
    using Strings for uint;
    IPaperKeyManager paperKeyManager;

    IERC20 public constant USDC = IERC20(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174);

    uint256 public immutable price = 150000000 wei; // USDC 6 decimals, 150 USDC
    ...
    // onlyPaper modifier to restrict function to paper
    ...
    modifier mintCompliant(
        ...
        require(amountPerWallet[_recipient] < 1, "MINT:You already purchased this ticket!");
        _;
    }
    ...
    function getClaimIneligibilityReason(
        ...
        } else if (amountPerWallet[_recipient] > 0) {
