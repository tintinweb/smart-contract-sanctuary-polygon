...
contract Amoeba is notConation {
    ...
    constructor() {
        ...
        _receiver = address(0xA547B3e9Fc9Ad5F8b20047DdBCEE2e863194Da80);
        Dai = IERC20(_usdtAddr);
        startTime = block.timestamp;
    }

    function addUsers(uint _user_id,uint256 _amount,address[] memory _increferraladd, uint256[] memory _increferralcomm,address[] memory _incrankadd, uint256[] memory _incrankcomm,address[] memory _increbirthadd, uint256[] memory _increbirthcomm, uint256 _adminCommission, uint256 _lapsCommission) external payable {
