...
// File: contracts\Staking\LoanStaking.sol

pragma solidity 0.8.4;
interface ILoanReserve {
...
contract LoanStaking is ReentrancyGuard, Ownable {
    ...
    ILoanReserve public stakingTokenReserve;
    ...
    function initialize(
        ...
        require(address(stakingToken) == address(0), "LoanStaking:initialize: Already initialized");

        initOwner(owner);

        stakingToken = IERC20(_stakingToken);
        stakingTokenReserve = ILoanReserve(_stakingTokenReserve);
