...
contract FantasyBestiary is ERC721 , DefaultOperatorFilterer {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeiepycchveixbtedaffc27ghyhibwrjsmqfqvtw7jjrrwelad2mfmi/", Strings.toString(tokenId), ".json")
            );
    }
