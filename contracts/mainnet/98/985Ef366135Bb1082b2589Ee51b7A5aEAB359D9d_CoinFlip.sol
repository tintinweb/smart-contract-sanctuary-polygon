...
contract CoinFlip is AccessControl, VRFConsumerBase {
    ...
    function setCommissionWallet(address payable walletAddress) public onlyAdmin { commissionWallet = walletAddress; }
    ...
    function flip(uint side) public payable {
        ...
        require(commissionWallet != address(0), "Commission wallet cannot be address zero");
    ...
    function finalizeFlip(bytes32 requestId) public onlyAdminOrBackend {
        ...
        if (playerWon) {
            ...
            // compute commission from basis points
            uint commission = (f.betAmount * _commissionBasisPoints) / 10000;
            commissionWallet.transfer(commission);
