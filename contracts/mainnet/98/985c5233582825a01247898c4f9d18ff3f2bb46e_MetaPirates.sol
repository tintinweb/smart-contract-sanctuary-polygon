...
contract MetaPirates is MetaPiratesDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private MetaPiratesTeam;
    address private CharityMetaPirates;
    ...
    string public override name = "Meta Pirates";
    string public override symbol = "Meta Pirates";
    ...
    constructor(uint totalSupplyValue, address MetaPiratesTeamAddress, address CharityMetaPiratesAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        MetaPiratesTeam = MetaPiratesTeamAddress;
        CharityMetaPirates = CharityMetaPiratesAddress;
        
        // split the tokens according to agreed upon percentages
        balances[MetaPiratesTeam] =  totalSupply * 45 / 100;
        balances[CharityMetaPirates] = totalSupply * 45 / 100;
