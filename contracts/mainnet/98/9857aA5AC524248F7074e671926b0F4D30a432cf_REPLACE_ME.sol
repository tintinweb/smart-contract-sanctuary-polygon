...
contract MintBurn is Core {
    ...
    mapping(uint256 => int256) public _baseline; //TODO: make public?

    bool public active; //TODO: make private
    bool public assigned; //TODO: make private
    bool public reserved; //TODO: make private
    ...
    function setReserve() external onlyAdmin {
        require(!reserved, "Polygods: allocation already reserved");
        /* * */
        uint reserve = 202; 
