...
import {LibAppStorageCard, CardAppStorage} from "../libraries/AppStorageCard.sol";

contract FakeGotchisCardDiamond {
    constructor(
        ...
        LibDiamond.addSupportForERC165(0xd9b67a26); // ERC1155
