...
contract ThirtySixBearDoodles is ERC721, ERC721Enumerable, Ownable {

    bool public isActiveSale = false;
    string private _customBaseUri;
    uint256 constant MAX_SUPPLY = 50000;

    constructor() ERC721("Thirty Six Bear Doodles", "THIRTYSIXBEARDOODLES") {}
    ...
    function safeMintBulk(address to, uint _num) public onlyOwner {
        require(isActiveSale, "Sale must be active to mint tokens");
    ...
    function setIsActiveSale(bool state) public onlyOwner {
        isActiveSale = state;
    }
