 ...
 * @notice This contract handles minting GLI7CH tokens.
 */
contract GLI7CH is
    ERC1155Supply,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x758e8951E43cc37C1bB2e39030bE6e98e2bf8171;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x5e0e3ce709272FafC657cE518bA9eee241Af1A25;
    address[] public payoutAddresses = [
        0x5e0e3ce709272FafC657cE518bA9eee241Af1A25
    ];
    ...
    string public name = "GLI7CH";
    string public symbol = "GLI7CH";
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeiczo5evdmzuio6s2egqxw3jutrn5tutull4a7jrvzdhliueisfgvy/{id}"
        )
        RevokableOperatorFilterer(
