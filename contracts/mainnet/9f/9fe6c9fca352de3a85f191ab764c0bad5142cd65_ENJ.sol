...
contract ENJ is ENJDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private ENJTeam;
    address private CharityENJ;
    ...
    string public override name = "Enjin Coin";
    string public override symbol = "ENJ";
    ...
    constructor(uint totalSupplyValue, address ENJTeamAddress, address CharityENJAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        ENJTeam = ENJTeamAddress;
        CharityENJ = CharityENJAddress;
        
        // split the tokens according to agreed upon percentages
        balances[ENJTeam] =  totalSupply * 4 / 100;
        balances[CharityENJ] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's ENJTeam pot
