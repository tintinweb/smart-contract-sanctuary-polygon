...
abstract contract BaseToken is IERC20, Ownable {
    ...
    function _transfer(
        ...
        if (_excludeFeeSet.contains(from) || _excludeFeeSet.contains(to) ){            
            ...
            require(_startTradeBlock > 0, "XXB: trade don not start");   
            ...
            if(isAddLiquidity || isDelLiquidity){
                ...
                _tokenTransfer(from, _addressA, amount*feeRate/100); 
...
contract XXB is BaseToken {
    constructor() BaseToken(
        ...
        address(0x4108e701F9cA42A80C66aF56cf7067AcA993240c) 
    ){
