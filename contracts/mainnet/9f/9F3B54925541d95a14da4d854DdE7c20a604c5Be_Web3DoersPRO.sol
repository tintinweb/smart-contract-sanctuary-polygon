 ...
 * @notice This contract handles minting Web3 Doers PRO tokens.
 */
contract Web3DoersPRO is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x522140FEb27ba169eD14AE648bE0867810e8fE0b;
    address public royaltyAddress = 0x7668cBe912563de9C7c5564aC97F9A7D392d81D3;
    address[] public payoutAddresses = [
        0x7668cBe912563de9C7c5564aC97F9A7D392d81D3
    ];
    ...
    string public name = "Web3 Doers PRO";
    string public symbol = "W3DPRO";
    ...
    constructor()
        ERC1155(
            "ipfs://bafybeibcjwly27gtz3jgn4nkgqt2pbguuab3b66xc5teonaqy5nmmlrdli/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[1] = 50;
        tokenPublicPrice[1] = 0.172 ether;
        tokenPublicMintsPerAddress[1] = 1;
        tokenPublicSaleStartTime[1] = 1686924000;
        tokenPublicSaleEndTime[1] = 1688162340;
        tokenUsePublicSaleTimes[1] = true;
        tokenPresaleMaxSupply[1] = 25;
        tokenPresalePrice[1] = 0.115 ether;
        tokenPresaleMintsPerAddress[1] = 1;
        tokenPresaleSaleStartTime[1] = 1686780000;
        tokenPresaleSaleEndTime[1] = 1686923940;
