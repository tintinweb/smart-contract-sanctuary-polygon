...
import "./CNPRwanshouYondaiAdmin.sol";

contract CNPRwanshouYondai is CNPRwanshouYondaiAdmin, ERC721A("CNP Rookies Wanshou Yondai", "CNPRWY") {
    constructor() {
...
import "./CNPRwanshouYondaiConfig.sol";
import "@openzeppelin/contracts/access/AccessControl.sol";

abstract contract CNPRwanshouYondaiAdmin is CNPRwanshouYondaiConfig, AccessControl {
    /**
     ...
     */
    function setDescriptor(ICNPRwanshouYondaiDescriptor _descriptor) external onlyAdmin {
...
abstract contract CNPRwanshouYondaiConfig is Ownable {
    // The Project token URI descriptor
    ICNPRwanshouYondaiDescriptor public descriptor;
