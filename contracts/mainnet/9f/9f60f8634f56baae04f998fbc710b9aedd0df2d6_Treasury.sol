...
library Consts {
    ...
    uint public constant BOARDROOM_WITHDRAWING_TIMES = 10;
    uint public constant BOARDROOM_WITHDRAWING_PEROID = 1 hours;

    

    // STCLP
    uint public constant STCLPPOOL_DURATION = 1 hours;
    uint public constant STCLPPOOL_WITHDRAWING_TIME = 1 hours;
    uint public constant STCLPPOOL_HALF_TIMES = 5;
    uint public constant STCLPPOOL_INITIAL_REEAWD = 855e18;
