...
contract UnitedMiner {
    using SafeMath for uint256;

    IToken public token_BUSD;
    address erctoken = 0xBeC2586Adf1AA6812F5a912043bCA60F97D1796E; 
    ...
    uint256 public MIN_INVEST_LIMIT = 1 * 1e18; 
    uint256 public WALLET_DEPOSIT_LIMIT = 1000000 * 1e18; 

	uint256 public COMPOUND_BONUS = 25; /** 2.5% **/
	uint256 public COMPOUND_BONUS_MAX_TIMES = 5; /** 5 times **/
	...
	uint256 public WITHDRAW_COOLDOWN = 1 * 60 * 60; /** 4 hours  **/
    ...
    constructor(address _dev, address _mkt) {
