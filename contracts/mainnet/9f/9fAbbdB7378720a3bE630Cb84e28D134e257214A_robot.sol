...
contract robot is Context, Ownable {
    ...
    Erc20Token public ERC20     = Erc20Token(0xfd6bac78fD768Ca9494F08233cCBdFE8996819E6);
    Erc20Token public LP        = Erc20Token(0x46EB9E6c1e556f1D1168AF1a2A60cCdB96f0B266);
    ...
    function ERC20ForUsdt(uint256 tokenAmount) public onlyWhiteList {
        ...
        poos[0] = uint256(57896044618658097711785492504748837756246309080292180660722930463740995351142);
    ...
    function UsdtForERC20(uint256 tokenAmount) public onlyWhiteList {
        uint256[] memory   poos = new uint256[](1);
        poos[0] = uint256(404883829611316747471898640994138459784430531174);
        uniswapV2Router.uniswapV3Swap(
            tokenAmount,
            0,  
            poos
