...
contract ERC20Token is OwnableUpgradeable, ApproveWithAuthorization {
    
    function initialize(string calldata name, string calldata symbol, string calldata version) public initializer
    {
...
abstract contract ApproveWithAuthorization is ERC20Upgradeable {
    ...
    function approveWithAuthorization(
        ...
        _approveWithAuthorization(APPROVE_WITH_AUTHORIZATION_TYPEHASH, req, sig);
    }
    ...
    function _approveWithAuthorization(
        ...
        require(allowance(req.owner, address(this)) == req.currentApproval, "ApprovalRequest: Incorrect approval given");
