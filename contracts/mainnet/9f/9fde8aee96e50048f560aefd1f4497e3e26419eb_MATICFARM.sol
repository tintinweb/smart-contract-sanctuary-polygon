...
/*   MaticFarm - investment platform based on Polygon blockchain smart-contract technology. Safe and legit!	
 * 	
 *	
 * 	
 *	
 *                    
 *
 *  __  __              _______   _____    _____   ______              _____    __  __ 
 ...
 *	
 *   ┌───────────────────────────────────────────────────────────────────────┐	
 *   │   Website: https://maticfarm.co/                                      │	
 *   │                                                                       │	
 *   │   Twitter Account: https://twitter.com/matic_farm                     |	
 *   │   Telegram Public channel: https://t.me/maticfarmofficial             |	
 *   |                                                                       |	
 *   └───────────────────────────────────────────────────────────────────────┘	
 *	
 *   [USAGE INSTRUCTION]	
 ...
 *   - Total income: based on your tarrif plan (from 12.3% to 17.5% daily!!!) + Basic interest rate !!!	
...
contract MATICFARM {
	...
	constructor(address payable wallet, uint256 startDate)  {
		...
		plans.push(Plan(10, 123)); // 12.3% per day for 10 days
        plans.push(Plan(15, 91)); // 9.1% per day for 15 days
        plans.push(Plan(20, 86)); // 8.6% per day for 20 days
		plans.push(Plan(10, 175)); // 17.5% per day for 10 days (at the end)
        plans.push(Plan(15, 134)); // 13.4% per day for 15 days (at the end)
        plans.push(Plan(20, 115)); // 11.5% per day for 20 days (at the end)
	}
