...
// File: contracts/COTTONImplementation.sol
...
/**
 * @title COTTONImplementation
 * @dev this COTTONcontract is a Pausable ERC20 token with Burn and Mint
 * controlled by a central SupplyController. By implementing COTTONImplementation
...
contract COTTONImplementation {
    ...
    string public constant name = "COTTON"; // solium-disable-line
    string public constant symbol = "CTN"; // solium-disable-line uppercase
    ...
    // ex: a fee rate of 200 = 0.02% of an pound of cotton
