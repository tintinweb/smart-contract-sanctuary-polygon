...
contract LMTerminal is Initializable, OwnableUpgradeable {
    ...
    function deployIncentivizedPool(
        ...
        console.log('amount0: %s amount1: %s', pool.amount0, pool.amount1);

        console.log('t0 balance: %s t1 balance: %s', IERC20(pool.token0).balanceOf(msg.sender), IERC20(pool.token1).balanceOf(msg.sender));
