...
//*******************************************************************//
contract Meta_Rider_EcoSystems
{
...
contract Meta_Rider_Eco_Systems is Meta_Rider_EcoSystems {
    ...
    function initialize1() public onlyOwner returns (bool) {
        ...
        mentorROI[0] = 1000; // for level 1
        mentorROI[1] = 500; // for level 2
