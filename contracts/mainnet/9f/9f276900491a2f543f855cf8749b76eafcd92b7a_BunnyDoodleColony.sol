...
// File: contracts/bunnydoodlecolony.sol
...
contract BunnyDoodleColony is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("BUNNY DOODLE COLONY", "BDC") {
    setHiddenMetadataUri("QmacvSh1cedwdw891g5AQqkH7bYshYvFdaJjS1oWuoPRpr");
  }
