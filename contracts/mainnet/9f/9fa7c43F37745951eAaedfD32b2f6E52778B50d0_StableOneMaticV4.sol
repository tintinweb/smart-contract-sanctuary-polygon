...
contract StableOneMaticV4 is Ownable {
    using SafeMath for uint256;

    uint256 private constant PRIMARY_BENIFICIARY_INVESTMENT_PERC = 120;
    ...
    uint256 private constant REINVEST_TIME_STEP = 1 days;
    // uint256 private constant REINVEST_TIME_STEP = 1 minutes; //fast test mode
    uint256 private constant WITHDRAW_TIME_STEP = 2 days;
    // uint256 private constant WITHDRAW_TIME_STEP = 2 minutes; //fast test mode
    ...
    function reinvest() public {
		require(investors[msg.sender].lastWithdrawDate.add(REINVEST_TIME_STEP) <= block.timestamp,"Withdrawal limit is 1 withdrawal in 24 hours");
    ...
    function withdraw() public {
		require(investors[msg.sender].lastWithdrawDate.add(WITHDRAW_TIME_STEP) <= block.timestamp,"Withdrawal limit is 1 withdrawal in 48 hours");
