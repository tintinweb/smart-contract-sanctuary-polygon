...
contract OnOWeeklyDrop is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    function setMaxSupply(uint256 _newMaxSupply)
        ...
        onlyOwner
    {
        require(_newMaxSupply > totalSupply(), "cannot set maxSupply to equal or less than current supply");
