...
// File: contracts/BDTC2_Token.sol
...
contract BDTC2_Token is Ownable, ERC721A, PaymentSplitter, DefaultOperatorFilterer {
    ...
    constructor(uint96 _royaltyFeesInBips, address[] memory _team, uint[] memory _teamShares, string memory _baseURI) ERC721A("Brandon Digital Trading Cards Series 2", "BDTC2")
    ...
    function batchReward(address[] memory _to, uint256[] memory _amounts)
        external
        onlyOwner
    {
    ...
    function reward(address _to, uint _quantity) external onlyOwner {
    ...
    function tokenURI(uint _tokenId) public view virtual override returns (string memory) {
        ...
        string memory folder = (_tokenId / 1000).toString(); 
