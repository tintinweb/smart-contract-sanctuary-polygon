...
contract IronPawGangBattleRoyal is ERC721A, ERC2981, Ownable, OperatorFilterer, ReentrancyGuard {
    ...
    constructor(string memory initialBaseURI, address payable royaltiesReceiver)
        ERC721A("IPG Champion 03: Battle Royale", "IPGC3-BR")
    {
    ...
    function setProvenance(string calldata value) external onlyOwner {
        PROVENANCE = value;
    }
