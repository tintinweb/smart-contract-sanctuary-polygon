...
contract DestCrossSwapFacet {
        ...
        internal
    {
        ...
        address oracle = messageHash.recover(signature);
        require(IOracleProvider(s.oracleProvider).isPublicWhitelisted(oracle), "Oracle is not whitelisted");
    }
...
interface IOracleProvider {
    function isPublicWhitelisted(address oracle) external returns (bool);

    function isPrivateWhitelisted(address oracleAdmin, address oracle) external returns (bool);
}
