    ...
    InstaFlashReceiverInterface
{
    ...
    function cast(
        ...
        (success_, result_) = _avoWalletImpl.delegatecall(abi.encodeCall(AvoWallet._callTargets, (actions_, id_)));
    ...
    /// to build for chain id 63400 and block.chainid in salt
    ...
    /// @notice builds domain separator for EIP712 but with fixed chain id set to 63400 instead of current chain
    /// @dev can not override EIP712 _buildDomainSeparatorOverride directly because it is not marked as virtual
    /// sets defaultChainId (63400) instead of block.chainid for the hash, uses block.chainid in salt
