...
contract ORL_Engine is Ownable, Concatenate {
    ...
    uint[] memory _flow3){
        ...
        address[] memory _contracts = new address[](_len);
        address[] memory _owners = new address[](_len);
        ...
        for(uint i = 0; i < _len; i++){
            ...
            _contracts[i] = perfByRacer[0][_slot].nftContract;
            _owners[i] = perfByRacer[0][_slot].owner;
            _flow1[i] = perfByRacer[0][_slot].leg1;
            _flow2[i] = perfByRacer[0][_slot].leg2;
            _flow3[i] = perfByRacer[0][_slot].leg3;
        }
        return (_racersReal, _contracts, _owners, _flow1, _flow2, _flow3);
    }
