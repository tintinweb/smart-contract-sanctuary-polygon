...
/*
Tidal
(C) Tidal Gobal, A.A. J. Frankland 2022

Version A.92.1 - Codename Irixius

Changes:
I. Completed Test and Port to Cronos Blockchain
II. Swap is now set to CroDex
III. Ensured Security testing for Solidity 0.8.12
IV. Tax now set to 0 on default. Do not need to cal beforePresale.
...
contract Tidal is Context, IERC20, Ownable {
    ...
    string private _name = "Tidal";
    string private _symbol = "MTDL";
    ...
    //this is kept for lgeacy purposes
