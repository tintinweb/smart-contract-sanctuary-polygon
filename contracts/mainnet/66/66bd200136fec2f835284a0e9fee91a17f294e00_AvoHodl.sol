...
contract AvoHodl is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  {
      uint256 supply = totalSupply(); 
      require(_reserveAmount > 0 && _reserveAmount <= tokenReserve, "Reserving over max of 3 or not enough total supply.");
