...
// File: TheNorikumiC1.sol

/**
 _____ _            _   _            _ _                    _ 
|_   _| |__   ___  | \ | | ___  _ __(_) | ___   _ _ __ ___ (_)
  | | | '_ \ / _ \ |  \| |/ _ \| '__| | |/ / | | | '_ ` _ \| |
  | | | | | |  __/ | |\  | (_) | |  | |   <| |_| | | | | | | |
  |_| |_| |_|\___| |_| \_|\___/|_|  |_|_|\_\\__,_|_| |_| |_|_|
 Created & Expressed By 0xCryptavi.                                                             
...
contract TheNorikumiC1 is ERC721Enumerable, Ownable, ContextMixin, RoyaltiesV2Impl {
    using Strings for uint256;

    string public baseURI;
    string public baseExtension = ".json";
    uint256 public cost = 0.014 ether;
    uint256 public norilistCost = 0.007 ether;
        ...
        if (msg.sender != owner()) {
            if (whitelisted[msg.sender] != true) {
                if (presaleWallets[msg.sender] != true) {
                    ...
                    //presale
                    require(msg.value >= norilistCost * _mintAmount);
                }
            }
        }
    ...
    function setnorilistCost(uint256 _newCost) public onlyOwner {
        norilistCost = _newCost;
    }
