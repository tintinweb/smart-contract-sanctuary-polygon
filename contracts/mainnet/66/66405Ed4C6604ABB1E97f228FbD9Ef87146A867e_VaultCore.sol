...
contract VaultCore is VaultStorage, MiniCurveExchange {
    ...
    function _mint(
        ...
        uint256 _toMintBasedOnPrice = _change.scaleBy(18, 8).mul(10**18).div(price());
...
import { IMiniVault } from "../interfaces/IMiniVault.sol";
import "hardhat/console.sol";
abstract contract MiniCurveExchange {
    ...
    function _checkPoolBalances(address _curvePool) internal view {
        ...
        uint256 _poolBalanceCheckExponent = IMiniVault(address(this)).poolBalanceCheckExponent();
...
contract VaultStorage is Initializable, Governable {
    ...
    event SupplyUpdated(uint256 _newSupply);
