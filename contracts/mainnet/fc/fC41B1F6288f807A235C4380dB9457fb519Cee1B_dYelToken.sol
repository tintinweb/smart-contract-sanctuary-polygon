...
contract dYelToken is ERC20 {
    ...
    constructor(address _BANG, string memory _name, string memory _s) ERC20(_name, _s) {
    ...
    function dYelToBANG(uint256 _amount) public view returns (uint256) {
        ...
        return _amount.mul(IBANG(BANG).index()).div(10 ** decimals());
    }
    ...
    function BANGTodYel(uint256 _amount) public view returns (uint256) {
        // 1 BANG
        return _amount.mul(10 ** decimals()).div(IBANG(BANG).index());
    }
