 ...
 * @notice This contract handles minting CAMPFIRE SEASON (TRINARY) tokens.
 */
contract CAMPFIRESEASONTRINARY is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x98131234E0212Eddba01B8077AB7a5D542889a59;
    ...
    string public name = "CAMPFIRE SEASON (TRINARY)";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeidw3c6tadq5neroxapswou3jqccln2mpgfro62qehh7niypfljomm/{id}"
        )
        RevokableOperatorFilterer(
