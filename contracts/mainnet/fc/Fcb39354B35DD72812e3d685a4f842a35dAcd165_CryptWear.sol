...
contract CryptWear is ERC721, Ownable, ReentrancyGuard {
    ...
    ERC721("DeadNull404", "DADNL4")
    {
        ...
        preMerkleRoot = 0x1ed81f797662b4eda551b8b8c3f3981570a6befdbee9cc9da1b6cb0e599693ae;
        //TODO !!!!!!!
    ...
    modifier canMint(uint256 numberOfTokens, MintType mintType) {
        if (mintType == MintType.PREMINT)
            require(
                mintSettings.preMintId + numberOfTokens <= mintSettings.maxPreMintId,
    ...
    canMint(amount, MintType.PREMINT) nonReentrant
    {
        ...
        for (uint256 i = 0; i < amount; i++) {
            _mint(to, mintSettings.preMintId++);
        }
    }
