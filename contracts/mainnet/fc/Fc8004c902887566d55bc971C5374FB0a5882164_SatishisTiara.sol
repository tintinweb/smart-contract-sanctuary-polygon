...
contract SatishisTiara is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeihqhcppgosp2ofnfu6xszl6jc36eqt5hcu5awpbtmk2kcpw5gbucm/", Strings.toString(tokenId), ".json")
            );
    }
