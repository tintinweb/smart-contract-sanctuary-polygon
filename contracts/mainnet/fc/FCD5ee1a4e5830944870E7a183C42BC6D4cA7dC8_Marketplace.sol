...
//    bytes4 private constant _ERC721_RECEIVED = 0x150b7a02;
    ...
    function acceptOffer(
        ...
        ITokenPaymentSplitter(treasuryAddress).split(address(offer.payToken), _creator, feeAmount);
    ...
    function _buyItem(Listing memory _listing) private {
        ...
        ITokenPaymentSplitter(treasuryAddress).split(_listing.payToken, msg.sender, feeAmount);
