...
contract bWalletPolygon {
    ...
    event SplitFee(address sender, address token, uint256 finalAmount, uint256 fee);
    ...
    function SplitItERC20(address _token) public {
    ...
    function stakeMeshToken(address _token, address _iToken) public {
    ...
    function unStakeMeshToken(address _token, address _iToken) public {
        uint256 maxUint = 115792089237316195423570985008687907853269984665640564039457584007913129639935;
        meshContract = MeshGateway(_iToken);
