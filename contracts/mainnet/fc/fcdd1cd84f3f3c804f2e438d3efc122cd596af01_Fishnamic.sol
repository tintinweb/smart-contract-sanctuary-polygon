...
import {ERC5058} from "./ERC5058/ERC5058.sol";
import "@openzeppelin/contracts/access/Ownable.sol";
import "@openzeppelin/contracts/token/common/ERC2981.sol";

contract Fishnamic is ERC5058, ERC2981, Ownable {
    uint256 public immutable COLLECTION_SIZE;

    constructor(
        uint256 _collectionSize,
        uint96 _royaltyFeeNumerator
    ) ERC5058("F*shnamic", "F*shnamic") {
        require(_collectionSize > 0, "Fishnamic: invalid collection size");
    ...
    function mint(address to, uint256 quantity) external onlyOwner {
        require(
            _totalMinted() + quantity <= COLLECTION_SIZE,
    ...
    function supportsInterface(
        bytes4 interfaceId
    ) public view virtual override(ERC5058, ERC2981) returns (bool) {
        return
            ERC5058.supportsInterface(interfaceId) ||
