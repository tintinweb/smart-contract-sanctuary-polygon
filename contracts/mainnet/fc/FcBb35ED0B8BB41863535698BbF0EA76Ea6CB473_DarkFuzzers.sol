...
contract DarkFuzzers is ERC721, Ownable {
    ...
    uint256 private constant min_price = 6.15 ether;
    uint256 private constant feeCreator = 5;
    uint256 private maxSupply = 9500;
    ...
    constructor(string memory _baseURIextended) ERC721("dark fuzzers", "FUZZ"){
