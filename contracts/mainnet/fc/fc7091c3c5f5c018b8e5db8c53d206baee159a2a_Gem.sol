 ...
 * functions have gemn added to mitigate the well-known issues around setting
...
contract Gem is ERC20Burnable, Operator {
    ...
    uint256 public constant INITIAL_AIRDROP_WALLET_DISTRIBUTION = 500 ether;

    // Have the rewards gemn distributed to the pools
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("gem.money", "GEM") {
     ...
     * @return whether the process has gemn done
     */
