...
// File: contracts/GenKSpecial.sol
...
contract GenKSpecial is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    uint256 public tokenCounter;
    string public baseURI;

    constructor() ERC721("Gen K Special", "GENKSP") {
    ...
    function updateTokenURI(uint256 _tokenId, string memory _uri) public onlyOwner {
