...
contract DTT is Initializable, ERC20Upgradeable, ERC20BasicApproveExtension, WithAdminUpgradeable, WithSuperOperators, ERC2771HandlerUpgradeable {
    ...
    function initialize(address beneficiary,uint256 amount,address admin,address trustedForwarder) external initializer {
        __ERC20_init("Dummy Test Token", "DTT");
