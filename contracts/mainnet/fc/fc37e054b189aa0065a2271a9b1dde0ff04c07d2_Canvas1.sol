...
contract Canvas1 is ArtToken {
    uint256 private _count;
    mapping(uint256 => Image1) private _images;
    ...
    function getImage(uint256 id) external view returns (Image1 memory) {
        return _images[id];
    }
    ...
    function _print(
        ...
        require(
            image.traits.length == image.values.length,
            "Canvas: traits and values length mismatch"
        );
    ...
    constructor() ArtToken("Canvas", "CANVAS") {}
}
