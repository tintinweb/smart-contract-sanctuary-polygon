...
contract M_coin is Context, AccessControlEnumerable, IERC20, IERC20Metadata {
    ...
    uint256 private constant maxSupply = 1000000000 ether;
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        _totalSupply += amount;
        require((_totalSupply + _burned) <= maxSupply);
