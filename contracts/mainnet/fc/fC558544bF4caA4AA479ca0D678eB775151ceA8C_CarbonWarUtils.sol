...
contract CarbonWarUtils is Pausable, AccessControl {
    string public name;
    ...
    function changeCWARfractionalNftAddress(
        address newAddress
    ) public onlyRole(CONFIGURATION_UPDATE_ROLE) {
        _fractionalTokenAddress = newAddress;
    }
