...
contract YieldHunter {
	...
	uint256[] public REFERRAL_PERCENTS = [80, 40, 20]; // 5%, 3%, 2%
	uint256 constant public PROJECT_FEE = 200; // 20% -- Development 3% -- Marketing 5% -- 12% Liquadity to add in Yavax
	uint256 constant public PERCENT_STEP = 5;
	uint256 constant public WITHDRAW_FEE = 1000; //In base point 10% withdraw fees
