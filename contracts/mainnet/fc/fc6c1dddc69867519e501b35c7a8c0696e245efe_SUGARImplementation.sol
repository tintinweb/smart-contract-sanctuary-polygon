...
// File: contracts/SUGARImplementation.sol
...
/**
 * @title SUGARImplementation
 * @dev this SUGARcontract is a Pausable ERC20 token with Burn and Mint
 * controlled by a central SupplyController. By implementing SUGARImplementation
...
contract SUGARImplementation {
    ...
    string public constant name = "SUGAR"; // solium-disable-line
    string public constant symbol = "SGR"; // solium-disable-line uppercase
    ...
    */
    ...
    /**
     * @dev Reclaim all SUGAR at the contract address.
     * This sends the SUGAR tokens that this contract add holding to the owner.
