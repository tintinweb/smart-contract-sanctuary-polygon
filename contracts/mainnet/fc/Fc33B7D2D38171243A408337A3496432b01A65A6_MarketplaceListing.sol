...
contract MarketplaceListing is Ownable,  MarketplaceListingHelper {
    ...
    function cancelOffer(uint256 offerId) public { 
        ...
        if(offerIdToOffer[offerId].buyer != msg.sender || owner() != msg.sender || offerIdToOffer[offerId].seller != msg.sender){
            revert("You are not allowed to cancel this offer!");
        }
    ...
    */
    ...
    function buyFromListing(uint256 listingId) public {
        ...
        uint256 fee = (listing.price * royalty) / 10000000;
    ...
    */
    function cancelListing(uint256 listingId) external{
        require(listingIdToListing[listingId].state == State.OPEN,"Listing already ended.");

         if(listingIdToListing[listingId].seller != msg.sender || owner() != msg.sender){
            revert("You are not allowed to cancel this listing!");
        }
