...
contract MCLeagueGG is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0xd365773e60DE92F43e484e1A8eBb9e09Ab83135B));
    address payable public _devwallet =
        payable(address(0x5E984b6edAEcE90F7bd8c05Cb5f81b5E74F8d547));
    address public _exchangewallet =
        payable(address(0x9EC3f7BF52F3d6Dc8b3211f137E5C6b65244cA2b));
    address _partnershipswallet =
        payable(address(0xf206Aaf1A5B311B599206f82A2a268EBF686c840));
    address private _donationAddress =
        0x000000000000000000000000000000000000dEaD;

    string private _name = "Match Point";
