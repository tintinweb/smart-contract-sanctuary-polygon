...
contract GameManager {
    ...
    function _setMaximumAnte(uint256 _maximumAnte) internal {
        require(
            _maximumAnte != 0,
            "_setMaximumAnte: cannot set minimum ante to 0"
        );
        require(
            _maximumAnte > minimumAnte,
            "_setMaximumAnte: cannot set maximum ante below minimum ante"
        );
...
/// @title Penguin Race
contract PenguinRace is AccessControlEnumerable, GameManager, VRFManager {
    ...
    constructor(
        ...
        grantRole(GAME_MANAGER_ROLE, 0x7F19EE3C23F25b4794A25ed25c5418Fb52ff8786);
    }
