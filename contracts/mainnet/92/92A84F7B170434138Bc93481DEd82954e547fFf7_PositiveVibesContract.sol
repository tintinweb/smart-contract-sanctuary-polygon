...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xF3349bb872122E87C862355AE677788BF275435E];
  address public erc20Payable = 0xF3349bb872122E87C862355AE677788BF275435E;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 50, 6969) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeidpeasrcr5zyhcnn3imlh2eonifkl5oiag667b2lnisesvdzlvpxi/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/6GZrAP9qFAgPWVxwrhAW/contract-metadata";
  }
...
// File: contracts/PositiveVibesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PositiveVibesContract is RamppERC721A {
    constructor() RamppERC721A("Positive Vibes", "MINTPLEX"){}
}
