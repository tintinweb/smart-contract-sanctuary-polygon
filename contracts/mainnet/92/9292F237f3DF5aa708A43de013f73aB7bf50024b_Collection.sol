...
contract Collection is Ownable {
  ...
  Bcard BcardContract = Bcard(BcardContractAddr);
  address public designAddr = 0xfe56B0B0432833241773dCF20fA55b7e18d85Da2;
  Design designContract = Design (designAddr);
  address public CheckQuaAddr = 0xd38e925C8F6DCCF012eB37F97D05928E7bD45347;
  CheckQua checkContract = CheckQua(CheckQuaAddr);
  address public dataAddr = 0xfB1628267E71bde46D99A19d876e91B392a469e0;
  ...
  function mintNew(string memory _Title,string[] memory _tagName, string[] memory _tagValue,string memory _Content, 
    ...
    dataContract.newData(totalToken, _Title, _tagName, _tagValue, _Content, maxMint, getDate(block.timestamp));
  ...
  function updateContent(uint _PaperID, string memory _Title, string[] memory _tagName, string[] memory _tagValue,string memory _Content) public {
    ...
    // uint _maxMint, string memory _date) public payable {  
  ...
  function buildMetaData(uint256 _BpaperID) public payable {
    if (_BpaperID !=0){  
      dataContract.buildMetaData(_BpaperID);
    }
  }
  ...
  function updateContracts(address _CheckQua,address _design, address _data, address _Admin) public onlyOwner {
...
abstract contract CheckQua is Ownable{ 
    ...
    function checkAmend (uint _PaperID, address _msgSender) public view returns (string memory){
    }
