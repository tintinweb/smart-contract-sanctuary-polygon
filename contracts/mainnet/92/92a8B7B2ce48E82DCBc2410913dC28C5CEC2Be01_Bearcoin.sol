...
contract Bearcoin is ERC20, Ownable, KeeperCompatibleInterface, VRFConsumerBase {
  ...
  uint256 private constant _genesisBitcoinPrice = 200000e7;
  ...
  //Randomness
  uint32 private constant _randomSeedUpdateSeconds = 2592000;
  ...
  function genesisBitcoinPrice() external pure returns (uint256) {
