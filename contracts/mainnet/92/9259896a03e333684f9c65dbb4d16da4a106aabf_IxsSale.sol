...
// File: contracts/interfaces/IERC20DistributionController.sol
...
// File: contracts/interfaces/IIxsTreasury.sol
...
// File: contracts/interfaces/IIxsSale.sol
...
contract IxsSale is Context, AccessControl, IIxsSale {
    ...
    uint256 private constant IXS_AMOUNT_OUT_PRECISION = 1000;
        ...
        onlyRootUser(_saleId, _msgSender())
    {
        ...
        for (uint256 i; i < _receiver.length; i++) {
            ...
            if (isSuccessSale) {
                ...
                // payDecimal = 1e18 (USDC) (100e18 * 500 / 1000 => 50e18) 
                // secDecimal = 1e6 (KUMBALUMBA)
                // rate = 500 (1:2)

                // payDecimal = 1e6 (USDT) (100e6 * 500 / 1000 => 50e6
                // secDecimal = 1e18 (KUMBALUMBA)
                // rate = 500 (1:2)

                // payDecimal > secDecimal; 12 / 50e18/1e12 = 50e6 (1:2);
                // secDecimal < secDecimal; 12 / 50e6*1e12 = 50e18(1:2);
                // secDecimal == secDecimal; (nothing);
    ...
    function getAmountOut(
        ...
        _amountOut = (_amount * onSales[_saleId].rate * IXS_AMOUNT_OUT_PRECISION) / 1000; // calculate how much claim secTokens
        ...
        if (decimalsOfSec >= decimalsOfPay){
            _amountOut = (_amountOut * 10 ** (decimalsOfSec - decimalsOfPay)) / IXS_AMOUNT_OUT_PRECISION;
        } else if(decimalsOfSec < decimalsOfPay){
            _amountOut = (_amountOut / 10 ** (decimalsOfPay - decimalsOfSec)) / IXS_AMOUNT_OUT_PRECISION;
        }
    }
