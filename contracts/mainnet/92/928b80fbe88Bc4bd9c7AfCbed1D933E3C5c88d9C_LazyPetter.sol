...
contract LazyPetter {
  ...
  constructor(address _authorizedExecutor, address gotchiDiamond, address _gotchiOwner) {
    ...
    gotchiIds = [
      ...
      // tier 2 (redeploy)
      // 13974, 20952, 16980, 12628, 14046, 13676, 19784, 12593, 14437, 12532, 10221, 15427, 18989, 17957,15328,16925,16368,11093,12555,14817,15351,19263,18465,15603
      
      // tier 3 (redeploy)
      24941,24935,23098,24564,23861,24004,24004,24564,13608,19943,21586
