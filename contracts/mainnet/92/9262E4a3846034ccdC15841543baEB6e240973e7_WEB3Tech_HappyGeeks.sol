 ...
 * _Available since v4.5._
 */
abstract contract ERC2981 is IERC2981, ERC165, ERC1155Supply {
    struct RoyaltyInfo {
        address receiver;
     ...
     * @dev See {IERC165-supportsInterface}.
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(IERC165, ERC165, ERC1155) returns (bool) {
...
/// @title Happy Geeks Exlusive NFT Collection
/// @author Ankit Agarwal
/// @notice You can use this contract for miniting any sets of unique NFTs in batches
...
contract WEB3Tech_HappyGeeks is Ownable, ERC2981 {
    ...
    event NewRoyaltyInfo(address indexed _royaltyReceiver, uint256 feePer);
    event NewURI(address indexed ownerAddr, string newuri);
    event NewMint(address indexed _idOwner, uint256 tokenId);
    
    constructor() ERC1155("ipfs://QmTrHhpbL764Qh4udhoPaAyKF1KSJBTd7pX2vfUTKBHZ1d/") {
    ...
    function mint(uint256 id) public {   
      ...
      require(STOP_MINTING == false ,'Public Minting Has Been Paused By Admin') ;
    ...
    function tokenRoyaltyInfo(address receiver, uint96 feeNumerator) public onlyOwner {
        _setDefaultRoyalty(receiver, feeNumerator);
        emit NewRoyaltyInfo(receiver, feeNumerator);
    }

    // @dev set Royalty information of the collection.
     function uri(uint256 tokenId) public view virtual override  returns (string memory tokenuri) {
        
        require(tokenId >= idStartNum,"Exclusive Id allowed!");
        require(tokenId <= idEndNum,"Exclusive Id allowed!");      
 ...
 // @dev returns total no of NFTs minted for each batch of 20 unique NFTs
  ...
  function getSupplyBalance() public view returns (uint256[] memory tokentotalSupply){
       ...
       /**
         * 'stopMinting()' function 
         *  Function implmented in case Admin wants to pause/stop the public minting of NFTs
         *  Activation of this 'STOP_MINTING' == true ,will result in probhition to Mint Further.
        */


        function stopMinting() public onlyOwner {
        require(STOP_MINTING == false , 'Public Minting has already been Paused By Admin') ;
        STOP_MINTING = true ;
         ...
         *  Function implmented  in case Admin wants to restart the public minting of NFTs
        */
