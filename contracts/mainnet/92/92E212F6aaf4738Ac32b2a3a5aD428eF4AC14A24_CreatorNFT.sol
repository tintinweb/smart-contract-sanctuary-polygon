...
contract CreatorNFT is ERC721, IERC2981, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721("Creator of 0xCreator", "0xCr") {
    }
    ...
    {
        require(!claimed[msg.sender], "0xCr already claimed by this wallet");
