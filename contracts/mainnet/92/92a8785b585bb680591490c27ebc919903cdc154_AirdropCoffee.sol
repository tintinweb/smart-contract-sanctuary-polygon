...
contract AirdropCoffee is ERC721A, Ownable {
    ...
    uint8 public maxMintPerTxn = 100;
    ...
    =                Transfer               =
    =======================================*/
    function safeBatchTransfer(address[] calldata receivers, uint256[] calldata tokenIds) external {
        uint256 length = tokenIds.length;
        require(receivers.length == length, "the length of receivers and tokenIds must be equal");
