...
// File: contracts/CoolMonkesNFT.sol
...
contract CoolMonkesNFT is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Cool Monkes NFT", "CMNFT") {
    setHiddenMetadataUri("ipfs://QmU73qy3roFSMhUkJo8kWkf6B6U8695njFEisNYz5MKUWw/hidden.json");
  }
