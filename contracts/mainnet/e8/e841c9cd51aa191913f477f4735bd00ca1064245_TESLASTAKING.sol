...
contract TESLASTAKING{
    //uint256 EGGS_PER_MINERS_PER_SECOND=1;
    uint256 public EGGS_TO_HATCH_1MINERS=345600;// 25 percent daily
    uint256 PSN=10000;
    uint256 PSNH=5000;
    ...
    function sellEggs() public{
        ...
        uint256 autoCompound = SafeMath.div(SafeMath.mul(50, amount),100); //auto reinvest 50 percent
    ...
    function devFee(uint256 amount) public pure returns(uint256){
        return SafeMath.div(SafeMath.mul(amount,2),100); //dev 2
    }
    function seedMarket() public payable{
        require(msg.sender == ceoAddress, 'invalid call');
        require(marketEggs==0);
        initialized=true;
        marketEggs=34560000000;
        buyEggs(msg.sender);
  }
