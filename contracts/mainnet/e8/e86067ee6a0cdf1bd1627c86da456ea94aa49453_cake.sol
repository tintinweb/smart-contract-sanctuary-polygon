...
contract cake is ERC721URIStorage, Ownable {
  ...
  constructor() ERC721("My cake Collection", "cake") {
    _customBaseURI = 'https://gateway.pinata.cloud/ipfs/QmWvvXhRpMvTagXrRU7TEVtHB8kXbeMrC3WMF8NGNARzcZ/';
    _price = 0.1 ether; // 0.1 MATIC mint price 
