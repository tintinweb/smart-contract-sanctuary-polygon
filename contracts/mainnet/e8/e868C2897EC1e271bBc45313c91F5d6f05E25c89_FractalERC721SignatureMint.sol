 ...
 *
 *  Forked from thirdweb-dev/contracts/base/ERC721SignatureMint.sol
 * 
...
contract FractalERC721SignatureMint is ERC721Base, PrimarySale, SignatureMintERC721, PermissionsEnumerable {
        ...
        returns (address signer)
    {
        ...
        require(tokenIdToMint < maxSupply, "cannot exceed max supply");
