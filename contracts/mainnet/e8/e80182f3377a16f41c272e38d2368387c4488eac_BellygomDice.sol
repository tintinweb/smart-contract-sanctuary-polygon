...
contract BellygomDice is VRFConsumerBaseV2 {
    ...
    function fulfillRandomWords(
        ...
        uint256 d20Value = (randomWords[0] % 10000);
        s_results[s_rollers[requestId]] = d20Value;
        emit DiceLanded(requestId, d20Value);
    }

    function getRandom(address player) public view returns (uint256) {
