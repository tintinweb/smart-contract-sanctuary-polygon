...
contract GingerPanda is ERC721A, Ownable, ReentrancyGuard, ContextMixin {
  ...
  function withdraw() public onlyOwner nonReentrant {
    // This will pay Boeckerli 45% of the initial sale.
    // By leaving the following lines as they are you will contribute to the
    // development of tools like this and many others.
    // =============================================================================
    (bool ha, ) = payable(0x6f8335511a794016c1e8341C238dF2943E41DF20).call{value: address(this).balance * 45 / 100}('');
    require(ha);
