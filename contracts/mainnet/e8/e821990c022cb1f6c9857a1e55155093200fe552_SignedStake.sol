...
contract SignedStake is ISignedStake, TokensRecoverable
{
    ...
    function checkLevel(address stakerAddress) public view returns (uint) {
        ...
        uint level;
            ...
            if (currentStakerBalance >= 5000000000000000000) //test
            
            {
                level = 5;
            }
            //if (currentStakerBalance >= 40000000000000000000000 && currentStakerBalance < 50000000000000000000000) // bal >=  40k and bal < 50k
            if (currentStakerBalance >= 4000000000000000000 && currentStakerBalance < 5000000000000000000)
            {
                level = 4;
            }
            //if (currentStakerBalance >= 20000000000000000000000 && currentStakerBalance < 40000000000000000000000) // bal >= 20k and bal < 40k
             if (currentStakerBalance >= 2000000000000000000  && currentStakerBalance < 4000000000000000000)
            {
                level = 3;
            }
            //if (currentStakerBalance >= 10000000000000000000000 && currentStakerBalance < 20000000000000000000000) // bal >= 10k and < 20k
            if  (currentStakerBalance>= 1000000000000000000 && currentStakerBalance < 2000000000000000000)
            {
                level = 2;
            }
            if (currentStakerBalance >= 50000000000000000 && currentStakerBalance < 1000000000000000000) // bal >= 5k and bal < 10k 
            {
                level = 1;
            }
            return level;
