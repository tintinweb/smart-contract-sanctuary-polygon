...
contract PixelApesOnFire is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  address payable commissions = payable(0xeF6416dF2C765BB155Cd26df79383Eef67b0eB19);
  address[] public whitelistedAddresses;
  mapping(address => uint256) public addressMintedBalance;

  constructor()
  ERC721("Pixel Apes on Fire", "PAF") 
  {
    setBaseURI("https://pixel-ape.vercel.app/metadata/");
  }
