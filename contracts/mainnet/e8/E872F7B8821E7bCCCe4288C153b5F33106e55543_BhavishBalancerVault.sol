...
contract BhavishBalancerVault is AccessControl, BaseVault {
    ...
    function withdrawAll() external nonReentrant whenPaused onlyAdmin(msg.sender) {
...
abstract contract BaseVault is Pausable, AccessControl, ReentrancyGuard {
    ...
    function performPrediction(bool nextPredictionUp) external whenNotPaused onlyOperator(msg.sender) {
        ...
        IBhavishPrediction.Round memory currentRound = IBhavishPredictionImpl(getPredictionMarketAddr()).getCurrentRoundDetails();
