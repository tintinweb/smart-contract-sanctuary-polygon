...
/// @title ERC-20 Token for GMFTT
contract GreenMetaFitTokenTest is ERC20, ERC20Burnable, Ownable, ReentrancyGuard {
    address public gameContractAddress;
    
    /// maximum token allowed to be 1 Billion GMFTT * decimals()
    ...
    constructor() ERC20("Green Meta Fit Token Test", "GMFTT") {
    }
    ...
    function mintTokens(uint256 tokenAmount) private onlyOwner{
        require(msg.sender == gameContractAddress, "Only Game Contract can mint the tokens");
        require(tokenAmount <= maxTokenSupply - totalSupply(), "Total supply can be a maximum of 1 Billion GMFTT tokens");
