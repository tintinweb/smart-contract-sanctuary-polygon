...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x43cEB5538eAB402127503784d7e3d258cc32C03C];
  address public erc20Payable = 0x43cEB5538eAB402127503784d7e3d258cc32C03C;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://bafkreibqhuqkawt7qlqnbsu4exusaaq4lzmiyvwzzraj3cljewgymy2nqu.ipfs.dweb.link/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/V5hfLSJ6epI34t6Hhtgn/contract-metadata";
  }
...
// File: contracts/X55Bb55FfContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract X55Bb55FfContract is ERC721APlus {
    constructor() ERC721APlus("55BB55FF", "55BB55FF"){}
}
