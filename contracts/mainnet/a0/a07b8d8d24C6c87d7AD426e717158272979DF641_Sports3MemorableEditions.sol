...
contract ERC5192 is ERC721, IERC721SoulBound, IERC5192, SoulBoundRoles {
    using Strings for uint256;
    ...
    modifier nonLocked(uint256 tokenId) {
    ...
    function mint(address to, uint256 tokenId) external override onlyOperator {
    ...
    function transferFrom(
        ...
        address to,
        uint256 tokenId
    ) public virtual override nonLocked(tokenId) {
    ...
    function safeTransferFrom(
        ...
        address to,
        uint256 tokenId
    ) public override nonLocked(tokenId) {
    ...
    function setApprovalForAll(address, bool) public pure override {
        revert("set approval for all is not allowed");
    }
...
contract Sports3MemorableEditions is ERC5192 {
    constructor() ERC5192("Sports3 Memorable Editions", "SME", "", "") {}
}