...
contract CryptosaursHolidays is
	ERC1155,
	AccessControlMixin,
	...
	Ownable
{
	...
	// Contract name
	string public constant name = "Cryptosaurs Holidays";
	// Contract symbol
	string public constant symbol = "CSH";
	string private constant _uri =
		"https://api.cryptosaurs.ai/api/metadata/holidays/";

	constructor() ERC1155(_uri) {
		_setupContractId(symbol);
	...
	function supportsInterface(bytes4 interfaceId)
		...
		view
		virtual
		override(AccessControl, IERC165, ERC1155)
		returns (bool)
	{
		return
