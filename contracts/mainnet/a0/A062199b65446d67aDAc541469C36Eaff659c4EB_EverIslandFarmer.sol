...
// File: contracts\EverIslandFarmer.sol
...
contract EverIslandFarmer is ERC721, Ownable {
    ...
    uint256 public farmerPrice = 1000000000000000; //0.001 ETH

    uint public constant maxFarmerPurchase = 10;

    uint public MAX_Farmers = 200;
    ...
    constructor() ERC721("EverIslandFarmer-Test", "EverIslandFarmer-Test") public{
    ...
    function reserveFarmer(uint num) public onlyOwner {        
        uint supply = totalSupply()+100000;
        uint i;
        for (i = 0; i < num; i++) {
    ...
    */
    ...
    function mintNumberOfTokens(uint numberOfTokens) private{
        for(uint i = 0; i < numberOfTokens; i++) {
            uint mintIndex = totalSupply()+10000;
