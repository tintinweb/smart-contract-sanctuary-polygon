    ...
    ERC721Burnable
{
    ...
    address  public router = 0x887230c6bfeECD0D94c467fb05e852DefCbDD1Bb;
    ...
    function mint(uint256 amount) public payable {
        ...
        require(amount > 0 && amount <= maxPerTx,"Error: limit per transaction");
        require(balanceOf(msg.sender) + 1 <= maxPerPerson,"Error: limit per address");
