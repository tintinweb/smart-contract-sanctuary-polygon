...
contract dark0X is ERC20("DarkX Steak", "dark0X"), Auth {
    ...
    uint256 public _denomToken = 100; // DarkX held in reserve 
    uint256 public _numerRate = 80; // fractional amount of dark0x
    ...
    address defaultRouter = 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff; // uniswap address for all networks.
...
*/
    constructor(IERC20 _DarkX, address _router) Auth(msg.sender) payable {
    ...
    function stake(uint256 amount) public payable {
      //get the user's balance
        ...
        uint256 totalDarkX = DarkX.balanceOf(address(this));
        uint256 totalShared0X = this.totalSupply();
        uint256 amt = amount.mul(toScale); /*  numer/denom = (80/100) * 1e18;  */
        ...
        require(uint256 (amount) > 10 * 10**18, "Minimum of 10 tokens at creation"); // this should be 10-100+ token
...
event injection (address indexed _caller , uint256 _amount, uint256 _timestamp);

 function deposit() public payable {
     emit injection (msg.sender, msg.value, block.timestamp);
 }
    ...
    function unstake(uint256 shared0X) public {
        ...
        require(_userBalance >= shared0X, "Buy some dark0X first, and try again");
