...
contract TokenERC721 is ERC721A, ContractMetadata, Multicall, Ownable, Royalty, BatchMintMetadata {
    using TWStrings for uint256;
     ...
     */
    function mintTo(address _to, string memory _tokenURI) public virtual returns (uint256 tokenIdToMint) {
        require(_canMint(), "Not authorized to mint.");
        tokenIdToMint = nextTokenIdToMint();
        _setTokenURI(tokenIdToMint, _tokenURI);
        _safeMint(_to, 1, "");
        
        emit TokensMinted(_to, tokenIdToMint, _tokenURI);
    }
