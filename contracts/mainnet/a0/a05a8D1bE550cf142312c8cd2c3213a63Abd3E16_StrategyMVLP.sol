    ...
    PausableUpgradeable
{
    ...
    function __StratFeeManager_init(address _vault) internal onlyInitializing {
        __Ownable_init();
        __Pausable_init();        
        vault = _vault;
    }
    ...
    function getWithdrawalFee(address caller) external view returns (uint256) {
        return withdrawalFeePerTier[tierChecker.checkTier(caller)];
    }
...
contract StrategyMVLP is StratFeeManagerInitializable, UUPSUpgradeable {
    ...
    event ChargedFees(uint256 managerFee, uint256 partnerFee);
    ...
    function chargeFees() internal {
        ...
        emit ChargedFees(managerFee, partnerFee);
    }
