...
contract CyberpunkDystopianTradingCards is ERC721 , DefaultOperatorFilterer {
    ...
    constructor()
        ERC721("Cyberpunk Dystopian Trading Cards", "CDTC")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeibwobx3ddk7b6zv7qxva6n4mlyqdfxonrh4wyjbhk3xd6axupaooy/", Strings.toString(tokenId), ".json")
            );
    }
