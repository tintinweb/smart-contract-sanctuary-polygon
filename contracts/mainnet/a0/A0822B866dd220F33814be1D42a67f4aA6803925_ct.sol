...
contract ct is ERC721Enumerable, Ownable {
    ...
    uint256 public presaleCost = 0.001 ether; // PREÇO EM ETHER NA PRE SALE.
    uint256 public maxSupply = 500; // QUANTIDADE DE NFT DA SUA GALERIA
    uint256 public maxMintAmount = 500; // QUANTIDADE MÁXIMA DE NFT PARA MINTAR POR CONTA
