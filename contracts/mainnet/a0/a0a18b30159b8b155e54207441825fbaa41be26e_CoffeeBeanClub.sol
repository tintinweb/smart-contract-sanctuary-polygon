...
// File: contracts/CoffeeBeansClubMainnet.sol
...
contract CoffeeBeanClub is Ownable, ERC721Enumerable{
    uint256 public MAX_AMOUNT = 888;
    bool public _saleIsActive = false;
    string private _nftBaseURI = "ipfs://QmTd1y7WbgJdwy5pDEXFpfZVJWU9pj29mJkJtdaAMX69MZ/";
    uint256 public _listing_price = 5;

  event Mint(address indexed sender, uint totalSupply);

    constructor()
    ERC721("CoffeeBeanClub", "CBC")
    {}
