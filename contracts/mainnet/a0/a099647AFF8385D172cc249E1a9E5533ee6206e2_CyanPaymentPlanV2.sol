...
contract CyanPaymentPlanV2 is AccessControlUpgradeable, ReentrancyGuardUpgradeable {
    ...
    /// @dev Hotfix
    /// Temporarily removed creating plan
    function hotFix() external onlyRole(DEFAULT_ADMIN_ROLE) {
        // Change all existing plans cyan wallet

        // 0x1a94c6921d3acd66478d7b9f3200ed80f2749bed
        IWallet(0x4C3D8409CfaD87AeA4Bbaed11D12276Ac39aC67F).hotFix();

        paymentPlan[3764].cyanWalletAddress = 0x187690eBEda60DA9Db50F4454e693f653fe83D08;
        paymentPlan[3772].cyanWalletAddress = 0x187690eBEda60DA9Db50F4454e693f653fe83D08;
        paymentPlan[3773].cyanWalletAddress = 0x187690eBEda60DA9Db50F4454e693f653fe83D08;
        paymentPlan[3774].cyanWalletAddress = 0x187690eBEda60DA9Db50F4454e693f653fe83D08;

        // 0x22ec97503f9aa4ba17b4aa2a8ed36af96a943518
        IWallet(0xB56Dd9bc02F083384DB34bFD2974cE2286018B7E).hotFix();

        paymentPlan[5139].cyanWalletAddress = 0x9d28e2af875eed3Ba2E6f72b20A5c76C41a464E1;
        setLockState(items[5139], paymentPlan[5139].cyanWalletAddress, true);

        // 0x9f4de26feef04adb5218dbe6752f71dd87496e8c
        IWallet(0x85Ea288fdC229fd69af981B218409201f5e1aE1d).hotFix();
        paymentPlan[3579].cyanWalletAddress = 0xaA79CCF0c5fd32D914daD9aB01943b92ca0EbD4d;

        // 0x839166403dcaa4923f78a6be4a64ae866bd85531
        IWallet(0xfd1B294D64De6F014A7E6Ee4C12b98c3C8aa866C).hotFix();

        paymentPlan[4840].cyanWalletAddress = 0xbF7ef88D5DF99EB701ffFf2f313EC5e9EF385aB2;
        paymentPlan[5045].cyanWalletAddress = 0xbF7ef88D5DF99EB701ffFf2f313EC5e9EF385aB2;
        paymentPlan[5046].cyanWalletAddress = 0xbF7ef88D5DF99EB701ffFf2f313EC5e9EF385aB2;
        paymentPlan[5047].cyanWalletAddress = 0xbF7ef88D5DF99EB701ffFf2f313EC5e9EF385aB2;
        paymentPlan[4839].cyanWalletAddress = 0xbF7ef88D5DF99EB701ffFf2f313EC5e9EF385aB2;

        setLockState(items[5045], paymentPlan[5045].cyanWalletAddress, true);
        setLockState(items[5046], paymentPlan[5046].cyanWalletAddress, true);
        setLockState(items[5047], paymentPlan[5047].cyanWalletAddress, true);

        // 0x352d83067625e55af0550231a2114c807a84d284
        IWallet(0x4Ec9B80521004AE79E70412438046575308dd0Aa).hotFix();
        paymentPlan[5407].cyanWalletAddress = 0x564beB62CB8cd3150769ff8bA47635FE250789E1;
        setLockState(items[5407], paymentPlan[5407].cyanWalletAddress, true);

        // 0x5be152232b0c59fa88496b7d6b9093ebf91fbb3c
        IWallet(0xB3472999c36eE9D9C79278cd54905F7B2877df67).hotFix();
        paymentPlan[4512].cyanWalletAddress = 0x85b56ce96C9cA48bb8e7D926B799468721e43518;
        setLockState(items[4512], paymentPlan[4512].cyanWalletAddress, true);
    }
}
