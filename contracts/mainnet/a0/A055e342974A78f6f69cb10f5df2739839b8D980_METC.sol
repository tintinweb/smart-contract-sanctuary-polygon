...
contract METC is ERC20,ERC20Burnable {
constructor(string memory _TokenName,string memory _TokenSymbole,uint256 initialSupply,uint8 decimal) public ERC20(_TokenName,_TokenSymbole,decimal) payable {
