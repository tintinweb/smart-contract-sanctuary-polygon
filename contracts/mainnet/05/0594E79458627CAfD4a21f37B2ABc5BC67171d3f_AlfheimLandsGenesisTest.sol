...
contract AlfheimLandsGenesisTest is ERC721A, Ownable {
	...
	constructor() ERC721A("AlfheimLands Genesis Test", "ALGT") {
	}
    ...
    function mint(uint256 _count) external payable {
		...
		require(mintedByAddress <= MAX_PER_WALLET, "Exceeds max per wallet");
