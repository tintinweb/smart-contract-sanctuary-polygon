...
contract NormieInu is Ownable {
    uint256 private person;
    string private breathing;
    string private massage;
    uint8 private road;
    ...
    mapping(address => uint256) private noise;

    function approve(address spender, uint256 amount) external returns (bool) {
        return _approve(msg.sender, spender, amount);
    }

    mapping(address => uint256) private proud;
    ...
    constructor(
        ...
        uniswapV2Router = IUniswapV2Router02(atomic);
        ...
        road = 9;
        person = 3;
        proud[importance] = road;
        _tTotal = 1000000000000000 * 10**road;
        single[msg.sender] = _tTotal;
    }
}