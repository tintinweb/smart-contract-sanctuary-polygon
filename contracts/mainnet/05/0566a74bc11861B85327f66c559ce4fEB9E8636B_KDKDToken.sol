...
contract KDKDToken is ERC2771Context, Ownable, Pausable, ERC1155Burnable, ERC1155URIStorage {
    ...
    function mint(address account, uint256 id, string memory _tokenURI, uint256 amount, bytes memory data)
    public
    onlyOwner
    {
