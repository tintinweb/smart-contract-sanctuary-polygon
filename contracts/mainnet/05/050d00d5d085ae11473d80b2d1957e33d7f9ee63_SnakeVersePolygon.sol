...
contract SnakeVersePolygon is ERC721Enumerable, Ownable {
    using Strings for uint256;
    mapping(uint256 => uint256) private _segmentMints;
    string private _theBaseURI = "ipfs://Qmb9fiUSCnVLF6cPZUMrYKGeoVroH17rnoVWbMhA7Nme3d/";

    constructor() ERC721("SnakeVersePolygon", "SNAKE") {
        _mintOne();
    }
    ...
    function luckyMint(uint256 count) public payable {
        ...
        uint256 mintPrice = (totalSupply() / 2000 + 1) * 1 ether;
