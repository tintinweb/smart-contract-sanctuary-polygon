...
event Swap(
 ...
 function getBalance(address _tokenAddress) external view returns (uint256) {
    ...
    function receiveFlashLoan(
        ...
        // revert("made it past instantiations");
        ...
        // revert("made it past preparation");
        ...
        // revert("transferred back to protocol");

        // IERC20(asset).approve(address(POOL), amounts[0]); 
