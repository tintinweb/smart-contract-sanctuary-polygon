...
// File: Main_AirTnt/Utils/airdropTNT.sol
...
contract airDrop is Initializable{
    ...
    event AirDrop(address indexed erc20Contract, address indexed from, address indexed to, uint256 amount);
    ...
    function bulkSend(address paymentContract, Investor[] memory arrInvestor) external {
        for (uint256 i = 0; i < arrInvestor.length; i++) {
            ...
            emit AirDrop(paymentContract, from, to, amount);
        }
    }
}