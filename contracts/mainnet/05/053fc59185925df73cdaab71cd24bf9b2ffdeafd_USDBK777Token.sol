    ...
    IERC777OperatorBatchFunctions
{
     ...
     */
    function authorizeGlobalOperator(address operator) public virtual {
        require(isOperatorFor(_msgSender(), address(this)), "USDBK777: caller is not an operator for this contract");
     ...
     */
    function revokeGlobalOperator(address operator) public virtual {
        require(isOperatorFor(_msgSender(), address(this)), "USDBK777: caller is not an operator for this contract");
     ...
     */
    function globalOperators() public view virtual returns (address[] memory) {
     ...
     */
    function getTransferEnabled() public view virtual returns (bool) {
    ...
    function burn(uint256 amount, bytes memory data) public virtual override(ERC777) {
        require(false, "USDBK777: token burning is forbidden");
    ...
    function operatorBatchMint(
        ...
        for (uint256 i = 0; i < recipients.length; i++) {
            ...
            require(isOperatorFor(operator, recipient), "USDBK777: caller is not an operator for recipient");
    ...
    function operatorBatchBurn(
        ...
        for (uint256 i = 0; i < holders.length; i++) {
            ...
            require(isOperatorFor(operator, holder), "USDBK777: caller is not an operator for holder");
    ...
    function operatorMint(
        ...
        require(isOperatorFor(_msgSender(), account), "USDBK777: caller is not an operator for holder");
