...
contract VULX is ERC20Detailed, Ownable, MinterRole {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 77 * 10**7 * 10**DECIMALS; // 7 million
    ...
    address public RiskFreeValueReceiver = 0xA8B396a069f8f6eeEB9EF3C32dE3773722396a63;
    address public autoLiquidityReceiver = 0xA8B396a069f8f6eeEB9EF3C32dE3773722396a63;
    address public TreasuryReceiver = 0xA8B396a069f8f6eeEB9EF3C32dE3773722396a63;
    ...
    constructor() ERC20Detailed("VULX", "$VULX", uint8(DECIMALS)) {
        //sushi swap router address
