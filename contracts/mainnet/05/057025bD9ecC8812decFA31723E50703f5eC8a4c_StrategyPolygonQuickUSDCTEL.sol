...
contract StrategyPolygonQuickUSDCTEL is StratManager, FeeManager {
    ...
    constructor(
        address _want, //0xa5cabfc725dfa129f618d527e93702d10412f039
        address _rewardPool, //0x84b3c86d660d680847258fd20aaa1274cc35eacd 
        address _vault, //0xAFf7b21d6DeDa24B02A492F4c365BB3111FD5D29
        address _unirouter, //0xa5e0829caced8ffdd4de3c43696c57f7d7a678ff
        ...
        address[] memory _outputToNativeRoute, // ["0x831753dd7087cac61ab5644b308642cc1c33dc13", "0x0d500b1d8e8ef31e21c99d1db9a6444d3adf1270"]
        address[] memory _rewardToNativeRoute, // ["0xdf7837de1f2fa4631d716cf2502f8b230f1dcc32", "0x0d500b1d8e8ef31e21c99d1db9a6444d3adf1270"]
        address[] memory _nativeToLp0Route, // ["0x0d500b1d8e8ef31e21c99d1db9a6444d3adf1270", "0x2791bca1f2de4661ed88a30c99a7a9449aa84174"]
        address[] memory _nativeToLp1Route // ["0x0d500b1d8e8ef31e21c99d1db9a6444d3adf1270", "0x2791bca1f2de4661ed88a30c99a7a9449aa84174", "0xdf7837de1f2fa4631d716cf2502f8b230f1dcc32"]
    ...
    function _giveAllowances() internal {
        IERC20(want).approve(rewardPool, uint256(type(uint256).max));
        IERC20(output).approve(unirouter, uint256(type(uint256).max));
        IERC20(native).approve(unirouter, uint256(type(uint256).max));

        IERC20(reward).approve(unirouter, 0);
        IERC20(reward).approve(unirouter, uint256(type(uint256).max));
