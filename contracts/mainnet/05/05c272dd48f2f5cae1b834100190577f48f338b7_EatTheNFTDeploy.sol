...
// Use 0.8.4 Compiler and Use 200 Optimizations
//Learn more about the contract:
//https://github.com/EatTheNFT/NFT-Contract/blob/main/NFTSmartContract.sol
//Deploy EatTheNFTDeploy.sol Contract
    ...
    OwnableUpgradeable
{
    ...
    function updateReferral(uint256 _val) public onlyOwner {
       ...
       function updateRoyalties(address _address, uint256 _recipientFee)
        public
        onlyOwner
    {
        recipient = _address;
        recipientFee = _recipientFee; // Input 100 : Adds 10% fee to each sale
    }
