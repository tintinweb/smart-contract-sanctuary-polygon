...
// File: Chaos.sol - Private Minters
...
contract Chaos is Ownable {
  mapping(address=>bool) public chaos;

  function addChaos(address h) public onlyOwner {
    chaos[h] = true;
  }

  function removeOG(address h) public onlyOwner {
    chaos[h] = false;
  }

  modifier isChaos() {
    address sender = _msgSender();
    require(owner() == sender || chaos[sender], "Chaos: Unauthorized");
    _;
  }
}
// File: CHAOTICS
...
contract ZCollabs is Ownable, ERC1155, Chaos {
  ...
  function withdraw() public payable onlyOwner {
    // This will payout the owner the remainder (10%) of the contract balance.
