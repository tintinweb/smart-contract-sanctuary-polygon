...
/****************************************************************
 **                                                             **
 **                  2022 The Faith For Crypto                  **
 **                                                             **
 ****************************************************************/
pragma solidity ^0.8.0;

// @title: The Faith For Crypto
// @author: ntnu.CCLAB

import "./ERC1155Creator.sol";

contract TheFaithForCrypto is ERC1155Creator {
...
contract ERC1155Creator is AdminControl, ERC1155, ReentrancyGuard {
    string public constant name = "The Faith For Crypto";
    ...
    function mintBatch(
        ...
        for (uint256 i = 0; i < tokenId.length; i++) {
            require(
                bytes(s_uris[tokenId[i]]).length != 0,
                "Please set token uri before mint."
            );
        }
        // 鑄造
