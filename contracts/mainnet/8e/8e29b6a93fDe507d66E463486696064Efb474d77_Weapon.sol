...
contract Weapon is Ownable, ERC2981, ERC721A, ReentrancyGuard {
    //using
  ...
  address payable public withdrawAddress;
    ...
    function burn(uint256 tokenId) external {
        require(
            ...
            "WeaponNft: must be valid burn whitelist"
        );
        _burn(tokenId, false);
    }
    ...
    function mint(address to, uint256 quantity) external {
        require(
            ...
            "WeaponNft: must be valid mint whitelist"
        );
    ...
    function lock(uint256 tokenId) external {
        require(
            ...
            "WeaponNft: must be valid lock whitelist"
        );
        require(_exists(tokenId), "WeaponNft: must be valid tokenId");
        require(!lockedTokens[tokenId], "WeaponNft: token has already locked");
    ...
    function unlock(uint256 tokenId) external {
        ...
        require(_exists(tokenId), "WeaponNft: must be valid tokenId");
        require(lockedTokens[tokenId], "WeaponNft: token has already unlocked");
    ...
    function _beforeTokenTransfers(
        ...
        uint256 quantity
            ...
            require(!lockedTokens[startTokenId], "WeaponNft: can not transfer locked token");
