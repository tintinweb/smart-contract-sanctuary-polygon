...
contract ElegantBeans2 is Ownable, AccessControl {
    ...
    function getSpeedBoost(uint _id, bool _ext) public view returns(uint) {
        ...
        //Advantange check
        bool isBoosted = _rules.tokenCheck(_tokenID,9002,_con);
        if (isBoosted == true){
            _boost = _boost + 1;
        }
        return _boost;
    ...
    function getAccelBoost(uint _id, bool _ext) public view returns(uint) {
        ...
        _boost = 2;
        //special
        //isBoosted = _rules.tokenCheck(_tokenID,10001,_con);
        //if (isBoosted == true){
        //    _boost = _boost + 1;
        //}
    ...
    function buildRace(uint[] calldata _racers,uint[] calldata _legs) public onlyOwner{
        ...
        for(i; i < racing; i++ ){ //go through every racer
            ...
            _temp.newN = randomNumber(_nonce, 4, 11);  
            ...
            _temp.newN = randomNumber(_nonce, 7, 13);
