...
contract Registrar is ERC721, Ownable, ReentrancyGuard {
    ...
    mapping(address => uint256) public addressToPrimaryDomain; 
    mapping(address => uint256[]) public ownerDomains;

    event DomainRegistered(address indexed owner, string domain, uint256 indexed tokenId, uint256 registeredAt);
