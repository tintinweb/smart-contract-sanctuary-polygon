...
contract ElegantBeans is Ownable, AccessControl {
    ...
    function buildRace(uint[] calldata _racers) public {
        require(hasRole(TEAM_ROLE, msg.sender), "Caller is not a member of the team.");
        ...
        for(i; i<racing; i++){ //go through every racer
            ...
            uint _nonce = block.timestamp.sub(deployT)+i*2;
            perfByRacer[_racer].id = _racer;
