...
contract Trader is Ownable {
    ...
    function fillAsk(
        ...
        require(
            o.totalAmt >= o.exchange.paymentAmt + o.prePayment.paymentAmt + o.refererrAmt + (o.totalAmt * 0) / 10000,
            'amt not matching'
        );
        ...
        if (o.refererrAmt > 0 && referrer != address(0)) {
            ...
            payEther(
                (o.totalAmt - (o.totalAmt * 0) / 10000 - o.exchange.paymentAmt - o.prePayment.paymentAmt) * amount,
                o.signer
            );
        }
