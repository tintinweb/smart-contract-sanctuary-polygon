...
*/
  ...
  
  {
       ...
       uint256 public ServiceFee = 0.9107 ether  ;
        ...
        constructor(uint256 _price, uint256 __maxSupply, string memory _initBaseURI, uint256 _maxMintAmountPerTx, uint256 _maxMintAmountPerWallet) ERC721("test", "test") {
