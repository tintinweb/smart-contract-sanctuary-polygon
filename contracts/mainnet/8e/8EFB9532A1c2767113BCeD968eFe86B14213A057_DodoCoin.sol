...
contract DodoCoin is Ownable, ERC20 {
  ...
  modifier onlyGameContract() {
    require(
      ...
      "DodoCoin: caller is not the game contract"
    );
    _;
  }

  function updateGameContract(address _gameContract) public onlyOwner {
  ...
  function deductTokens(address from, address to, uint256 amount) onlyGameContract public {
    _transfer(from, to, amount);
  }
