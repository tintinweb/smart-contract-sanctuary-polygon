...
/**
*Floofs are an adorable metaverse companion. Whether it lives on your couch, bed or bookshelf, this lovable pair of glowing eyes is always a darling that inspires.
*Minting Tutorial @ https://scalenenetwork.medium.com
*/
...
contract Floofs is ERC1155, Ownable {
    ...
    constructor() ERC1155("ipfs://QmPCY2jfPTSTd9D2NEBQdgsfdpN9FRRTN8WjoXpVTcmJNC/{id}.json") {}
        ...
        whenPublicSaleActive
    {
        ...
        require(numNfts > 0 && numNfts <= 25, "Must mint at least one Floof and less than or equal to 25 Floofs per transaction");
