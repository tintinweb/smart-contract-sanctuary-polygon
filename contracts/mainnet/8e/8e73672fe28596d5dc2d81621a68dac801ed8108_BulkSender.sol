...
/*
    ...
    HOW THIS BULK SENDER SMART CONTRACT WORKS:
...
/* 
    ...
    This smart contract is open source, code is minimal to save gas fees & you don't need to pay anything to use it except gas fees.
...
contract BulkSender is Ownable {
    ...
    uint16 public maxAddressAllowed;

    constructor() {
        donationReceiver = payable(owner);
        maxAddressAllowed = 255;
    }

//Making this smart contract ETH receivable
    receive() external payable {}

//Set max receiver address limit
    function setMaxAddressLimit(uint16 _number)public onlyOwner{
        maxAddressAllowed = _number;
    }

//Set donation receiving address
    function setDonationReceivingAddress(address payable _address) public onlyOwner{
        donationReceiver = _address;
    }

//Get ETH balance of this smart contract
...
//Withdraw ETH from this smart contract
     function withdrawETH()public onlyOwner {
        payable(donationReceiver).transfer(address(this).balance);
    }

//Get Tokens balance of this smart contract
    function getTokenBalance(IERC20 _tokenAddress)public view returns(uint256 tokenBalance){
