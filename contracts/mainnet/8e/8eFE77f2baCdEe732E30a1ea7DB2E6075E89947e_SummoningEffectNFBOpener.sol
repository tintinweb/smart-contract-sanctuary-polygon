    ...
    AccessControl
{
    ...
    function openViaNfb(
        ...
        uint256 amount,
        address to
    ) external override onlyRole(OPENER_ROLE) {
    ...
    function setChainlinkParams(
        address _vrfCoordinator, bytes32 _keyHash,
        uint64 _subscriptionId,
        uint16 _requestConfirmations,
        uint32 _callbackGasLimit
    ...
    function setPolygear(address _polygear) external onlyRole(DEFAULT_ADMIN_ROLE) {
        polygear = IPolygear(_polygear);
    }
}