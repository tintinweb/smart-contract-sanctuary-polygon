...
contract DineroHeroAlphaStandard is ERC721A, Ownable {
    uint256 max_mints = 5;
    uint256 max_mints_user = 5;
    uint256 max_supply = 10000;
    uint256 public price = 120 ether;
    uint256 public preSalePrice = 240 ether;
    bool public preSale = true;
    bool public paused = true;
    address[] public whitelistedAddresses;

    string public baseURI = "ipfs://bafybeidiebu36vqr7bagfzanawl2kx3nxx6oot6zh5xezotcnxcwrgt7uy/";

    constructor() ERC721A("DineroHero: Alpha Standard", "DHAS") {}
