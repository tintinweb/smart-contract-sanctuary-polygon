...
contract CSGladiators is ERC721ABurnable, Managerial, DefaultOperatorFilterer {
  string public apiBase = "https://api.cyberstadium.gg/gladiators/";

  constructor() ERC721A("Cyber Stadium Gladiator", "GLADIATOR") {
  ...
  function setNewApiBase(string calldata newBase) external onlyManagers {
    apiBase = newBase;
  }

  function mint(address target, uint256 quantity) external onlyManagers returns (uint256) {
  ...
  // solhint-disable custom/internal-or-protected
  ...
  //https://forum.openzeppelin.com/t/derived-contract-must-override-function-supportsinterface/6315/12
  ...
  function supportsInterface(bytes4 interfaceId) public view override(IERC721A, ERC721A, AccessControl) returns (bool) {
