    ...
    nonReentrant
  {
    ...
    if (!listing.isPriceBound) {
      ...
      if (
        ...
        // paymentTokensPerTBNToken =  tbnPrice / paymentPrice;
        fullCost =
          (tbnPrice * TBNAmount * listing.priceBandBasisPoint) /
          (1000000000000 * paymentPrice); // 10**8 to remove decimals
      } else {
        // Get token price from oracle - is ration
        ...
        fullCost =
          ...
          (10000 * (10**18)); // 10**18 to remove decimals
      }
      ...
      // TODO: ask if we should protect the seller
      require(
        expectedPaymentAmount >
          ((fullCost * (10000 - errorMarginBasisPoint)) / 10000),
