...
contract poly5 is ERC721, ERC721URIStorage, ERC721Burnable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    uint public currentSketchID = _tokenIdCounter.current();
    uint public maxSketchSupply = 7;

    constructor() ERC721("poly5", "POLY5") {}

    function mint(address to, string memory uri) public onlyOwner {
        require(_tokenIdCounter.current() < maxSketchSupply,"It's full fren, full of NFTs!!!");
        _tokenIdCounter.increment();
        currentSketchID = _tokenIdCounter.current();
