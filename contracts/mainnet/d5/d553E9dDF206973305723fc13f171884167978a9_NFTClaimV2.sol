...
contract NFTClaimV2 is Initializable, AccessProtectedUpgradeable, BaseRelayRecipient, ReentrancyGuardUpgradeable {
    ...
    function __NFTClaim_init_unchained(IERC1155Tradeable _token) internal initializer {
        require(address(_token) != address(0), "NFTClaim: ERC1155Tradeable cannot be 0 address");
    ...
    function setTrustedForwarder(address _trustedForwarder) external onlyAdmin {
        require(_trustedForwarder != address(0), "NFTClaim: Biconomy trusted forwarder cannot be 0 address");
    ...
    function initializeV2(IERC1155Tradeable _token) external onlyAdmin {
        ...
        require(address(_token) != address(0), "NFTClaimV2: ERC1155Tradeable address can not be zero");
