...
contract ThreePMMultiToken is ContextMixin, ERC1155Supply, Ownable, Pausable {
    ...
    **/ 
    ...
    /**
    * @dev set allow token id for mint
    **/ 
    function setTokenIdforMint(
        uint256 _tokenId
    ) public onlyOwner {
    ...
    **/ 
    ...
    /**
    * @dev return the address of minter
    **/ 
    ...
    **/ 
    function mintMultiToken(
        ...
        if (minter == address(0)) {
            require(_amount == 1, "Only allow mint 1 token!");
            require(_tokenId == mintTokenId, "Only allow token id can be minted!");
        } else {
            require( (_msgSender() == owner()) || (_msgSender() == minter) , "Only owner or minter can mint!");
        }
