...
contract SavageStock is ISavageStock, Operator {
  ...
  constructor(
    ...
    _primarySaleSystemFee = 15;
    _secondarySaleSystemFee = 15;
  }
  ...
  function _distributeSavage(
    ...
    savageDistribution.creatorAmount = _swap(
      _getInPath(_savageToken, _intermediateStablecoin),
      savageDistribution.creatorAmount,
      address(this),
      false
    );
    _transferTokens(token, savageDistribution.systemFeeRecipient, savageDistribution.systemFeeAmount);
    _transferTokens(_intermediateStablecoin, savageDistribution.creator, savageDistribution.creatorAmount);
