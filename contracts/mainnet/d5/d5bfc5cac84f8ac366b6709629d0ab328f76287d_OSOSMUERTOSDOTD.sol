...
// File: contracts/OSOSMUERTOSDOTD.sol
...
/**
 * @title OSOS MUERTOS DOTD
 */
contract OSOSMUERTOSDOTD is ERC721AQueryable, ERC2981, Ownable, Pausable {
    ...
    uint256 public presalePrice = 8 ether;
    uint256 public presaleSupply = 0;
    uint256 public publicPrice = 15 ether;

    uint256 private _tokenIdCounter = 1; // Starting token ID
