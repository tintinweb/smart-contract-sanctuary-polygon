...
contract TokenURI {
        ...
        returns (string memory)
    {
        ...
        parts[
            0
        ] = '<svg id="svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 600 450" width="400px" height="400px" preserveAspectRatio="none"><rect height="450" width="600" fill="#FAFAFA" />';
