...
contract CryptoPunkBunnies is ERC721A
{
    using Strings for uint256;
    ...
    constructor(string memory defaultBaseURI) ERC721A("Crypto Punk Bunnies", "CPB", maxMintAmount) {
        owner = msg.sender;
