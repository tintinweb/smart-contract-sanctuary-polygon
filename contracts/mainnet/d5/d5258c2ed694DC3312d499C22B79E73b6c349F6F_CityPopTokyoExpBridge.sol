    ...
    UUPSUpgradeable
{
    ...
    function changeOnlyHolder(bool _status) external onlyOwner nonReentrant {
        limitOnlyHolder = _status;
    }
    ...
    function convertTokenToExp(
        ...
        require(
            INFT(nft).ownerOf(nftId) != address(0) && (limitOnlyHolder == true)
