...
contract ICO is Ownable, ReentrancyGuard {
    ...
    uint256 private constant maxRoundICO = 200;

    AggregatorV3Interface private priceFeed;
    uint256 public usdPrice;
    uint256 private constant startPriceInUSD = 5; // since this value is 0.0005 . Multiplying it by 10000
    ...
    */
    ...
    function buyFor(uint256 value, address buyer) external payable onlyAdmin whenIcoStart {
        ...
        for (uint i = 0; i < usersIndexes[msg.sender]; i++) {
            ...
            <= COUNT_OF_MONTH
                ...
                if (
                    ...
                    if (month > 18) {
                        month = 18 - getDiffMonth(
                            usersVestings[msg.sender][i].startDate, usersVestings[msg.sender][i].lastReleaseDate
                        );
                    }
