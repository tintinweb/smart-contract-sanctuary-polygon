...
contract Gianky is ERC721, ERC721URIStorage {
    ...
    uint256 private STARTER_PRICE = 20 ether; // 0.01 MATIC on POLYGON
    ...
    constructor(IERC20 _giankyToken, address payable _splitter)
    ...
    function mintStandard(uint256 _referralId)
        public
        payable
        returns (uint256)
    {
    ...
    function distributeRewardsroY(uint256 _id, address payable _to)
        public
        payable
    {
        // Get the NFT
