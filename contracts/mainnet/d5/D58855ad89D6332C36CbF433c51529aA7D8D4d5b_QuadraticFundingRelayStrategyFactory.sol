...
import "./QuadraticFundingRelayStrategyImplementation.sol";

contract QuadraticFundingRelayStrategyFactory is OwnableUpgradeable {
    ...
    function create() external returns (address) {
        ...
        QuadraticFundingRelayStrategyImplementation(clone).initialize();
