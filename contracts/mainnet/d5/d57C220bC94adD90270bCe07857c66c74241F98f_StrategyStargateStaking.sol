...
import "../../../../interfaces/IBentoPool.sol";
import "../../../../libs/StringUtils.sol";
import "../../CompoundStrat.sol";
import "../../CompoundFeeManager.sol";

contract StrategyStargateStaking is CompoundFeeManager, CompoundStrat {
    ...
    constructor(
        ...
        CompoundStratManager(
            _commonAddresses.keeper,
            _commonAddresses.strategist,
            _commonAddresses.unirouter,
            _commonAddresses.ethaFeeRecipient
        )
    {
        want = _want;
        poolId = _poolId;
    ...
    function rewardsAvailable() public view returns (uint256) {
        ...
        bytes memory result = Address.functionStaticCall(chef, abi.encodeWithSignature(signature, poolId, address(this)));
