...
contract ERC20 {
  ...
  function transferFrom(address _from, address _to, uint256 _value) external returns (bool) {
    require(allowances[_from][msg.sender] >= _value, "Transfer amout exceeds allowance");
  ...
  function approve(address _spender, uint256 _value) public returns (bool) {
    allowances[msg.sender][_spender] = _value; // msg.senderさんのトークンをspenderさんがどれだけ扱って良いか？を指定
