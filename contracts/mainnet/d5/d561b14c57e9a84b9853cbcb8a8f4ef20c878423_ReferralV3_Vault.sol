...
contract ReferralV3_Vault is ReferralEvents, ReferralFamily, Ownable {
    ...
    function deposit(
        ...
        if ((ChildToParent[nftId] != 0) && (epochStart < block.timestamp)) {
            ...
            uint256 childBoost = TiersById[
                childMetadata.TierIdPerEpoch[e]
            ].TierShare;

            uint256 parentBoost = TiersById[
                parentMetadata.TierIdPerEpoch[e]
            ].TierShare;
