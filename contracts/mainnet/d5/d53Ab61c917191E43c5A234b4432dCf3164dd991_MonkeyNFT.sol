...
/**
 * OS: Gas abstraction END
 */

contract MonkeyNFT is
    ERC721URIStorage,
    ERC721Enumerable,
    Governance,
    ContextMixin
{
    ...
    address public immutable marketProxy;

    constructor(string memory name_, string memory symbol_, address marketProxy_)
    ...
    function _baseURI() internal pure override returns (string memory) {
        return
            "https://raw.githubusercontent.com/ullerbusiness/MONKEY_NFT/main/json_files/";
    }
     ...
     */
    function tokensOfOwner(address owner, uint256 from)
        external
        view
        returns (uint256[] memory)
    {
        ...
        for (uint256 i = from; i < balance; i++) {
