...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xCDf30b6b189Bcf40237a38f53e6b0aBFAAedBeB8];
  address public erc20Payable = 0xCDf30b6b189Bcf40237a38f53e6b0aBFAAedBeB8;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2000, 20000) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeibxfhxh5ymankze33rd4r65waik4k7vxub7a5pjghi7n72dt34e3q/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/aLP6nzz1h1aomeRd3C1q/contract-metadata";
  }
...
// File: contracts/XpunkContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract XpunkContract is ERC721APlus {
    constructor() ERC721APlus("Xpunk", "xp"){}
}
