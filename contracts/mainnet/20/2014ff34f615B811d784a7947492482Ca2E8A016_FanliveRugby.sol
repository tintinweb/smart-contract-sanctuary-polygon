...
/*
Fanlive Rugby (FLR) - The first NFT Play and Own platform dedicated to Rugby
*/
pragma solidity ^0.8.0;
...
contract FanliveRugby is ERC721A, ERC721AQueryable, AccessControl, IERC173 {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(AccessControl, ERC721A, IERC165, IERC721A) returns (bool) {
