...
contract ERC721BaseClaim is App {
    ...
    // @dev In cases of non-active sends error: NOT_ACTIVE_ERROR
 ...
 * {ERC721Enumerable}.
 */
contract ERC721LinkClaim is ERC721BaseClaim, __with_semver(uint8(1), uint8(0), uint8(0)) {
    ...
    function claim(
        ...
        bytes32 element = keccak256(abi.encodePacked(secret, _bytes32ToString(tierValue)));
