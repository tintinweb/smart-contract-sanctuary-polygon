...
//*********************************************************************//
//
// Chilled Monkeys Treehouse Club   
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmP5YcsXKKbBwJHrEmBrJiLWrwzAu6aLuxXThRTCBk66zx/";
...
contract ChilledMonkeysTreehouseClubContract is RamppERC721A {
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/EaVxHwyLIObihknjj9hs/contract-metadata";
    }
}
