...
// License identifier above applies to MintKitERC721CloneFactory and MintKitERC721
// Other files have their own license - see relevant GitHub repos or reach out to 0xDarni ([email protected] - https://twitter.com/0xDarni - https://0xdarni.com)
...
contract MintKitERC721 is Initializable, OwnableUpgradeable, ERC721Upgradeable, ERC721URIStorageUpgradeable, ERC721RoyaltyUpgradeable, IRoyalties, ReentrancyGuardUpgradeable, BaseOpenSea, ContextMixin {
  ...
  function initialize(
    ...
    uint256 _maxMintPerAccount) initializer public {
      ...
      _setOpenSeaRegistry(_proxyRegistry);
...
contract MintKitERC721CloneFactory is Ownable {
    ...
    */
    // Currently on Polygon
    address openSeaProxyRegistry = 0x58807baD0B376efc12F5AD86aAc70E78ed67deaE;
    ...
    function newContract(
        ...
        MintKitERC721(clone).initialize(_name, _symbol, _owner, vaultAddress, openSeaProxyRegistry, _maxSupply, _costInWei, feePercentage, _maxMintAmountPerTx, _maxMintPerAccount);
        isValid[clone] = true;
