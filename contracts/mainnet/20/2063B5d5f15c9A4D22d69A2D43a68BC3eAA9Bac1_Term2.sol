...
contract Term2 is TermBase, ExpressTerms {
    ...
    function term(
        ...
        return
            'The Company has selected Pudgy Penguin NFT number **${TOKEN_ID}** for use in a product development, promotion and/or sales Project relating to or concerning **${USE_CASE}** (the Project). Penguin Holder has personal rights and certain commercial rights to their Pudgy Penguin NFT, which the Company desires to license. Specifically, the Company has requested, and Penguin Holder has agreed to make Pudgy Penguin NFT number **${TOKEN_ID}** available for use in the Project. CUSTOM INJECT: **${CUSTOM_FIELD}**';
    }
}