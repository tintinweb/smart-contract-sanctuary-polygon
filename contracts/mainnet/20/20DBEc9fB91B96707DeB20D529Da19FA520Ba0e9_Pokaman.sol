...
contract Pokaman is ERC721Optimized, Ownable, ReentrancyGuard {
    ...
    uint256 public fMsupply = 1;
    uint256 public maxMPerx = 2;
    uint256 public maxFMPerx = 1;
    uint256 public maxFMPerW = 1;
    ...
    constructor() ERC721Optimized("Pokaman", "pk") {
    ...
    function getTotalMintPrice(uint256 numberOfTokens) public view returns (uint256) {
        ...
        require(end <= maxsupply, "Exceeded max supply");
        if (end <= fMsupply) {
            return 0;
        } else {
