...
contract MechaniumPublicDistribution is MechaniumVesting {
    ...
    /**
     * @notice Process multiple allocation by matching the input arrays one-on-one
     * @param addresses Addresses of the beneficiaries
     * @param amounts Total tokens to be allocated to each beneficiary
     */
