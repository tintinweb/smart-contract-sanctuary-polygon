 ...
 * @notice This contract handles minting Shiba Odyssey tokens.
 */
contract ShibaOdyssey is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x988912512245a8bC984914e782599bB74738F839;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x75251ccBb74E9a6877F16fe647EeAd405a119c4d;
    address[] public payoutAddresses = [
        0x75251ccBb74E9a6877F16fe647EeAd405a119c4d
    ];
    ...
    string public name = "Shiba Odyssey";
    string public symbol = "SBO";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeicjxd4ycjidlr4u5t27zqoyobodjxcgppz33ytfzmu7qumm3bwpqy/{id}"
        )
        RevokableOperatorFilterer(
