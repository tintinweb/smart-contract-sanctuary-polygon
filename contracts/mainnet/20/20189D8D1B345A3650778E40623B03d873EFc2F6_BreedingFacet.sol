...
contract BreedingFacet is ERC721WithDiamondStorage {
    ...
    function beginBreedingWithSignature(
        ...
        LibBreeding.beginBreeding(roundTripId, possibleClasses, classProbabilities, blockDeadline, createEggWithBasicDNA(), firstParentId, secondParentId);
    ...
    function finishBreedingWithSignature(
        ...
        LibBreeding.beginFinishBreeding(eggId, firstParentId, secondParentId, tokenURI);
        ...
        LibBreeding.completeFinishBreeding(eggId, roundTripId);
    }
    ...
    function createEggWithBasicDNA() private returns(uint256) {
        uint256 eggId = _mintNextToken(address(this));
        uint256 dna = 0;
