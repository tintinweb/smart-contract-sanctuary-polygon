...
contract MultiFeeDistribution is ReentrancyGuard, Ownable {
        ...
        return
            rewardData[rewardsToken].rewardPerTokenStored.add(
                lastTimeRewardApplicable(rewardsToken)
                    ...
                    .mul(rewardData[rewardsToken].rewardRate)
                    .mul(1e18)
                    .div(supply)
            );
    }
    ...
    function _earned(
        ...
        return
            balance
                .mul(_rewardPerToken(rewardsToken, supply).sub(userRewardPerTokenPaid[user][rewardsToken]))
                .div(1e18)
                .add(rewards[user][rewardsToken]);
    }
