...
contract TheFarmHouse is Context, Ownable {
    ...
    function replantSeeds(address ref) public {
        ...
        if(refferalsAmountData[referrals[msg.sender]]==0){
        ...
        referralsData[totalRefferalCount] =ReferralData({
            refAddress:referrals[msg.sender],
            amount:referralsData[totalRefferalCount].amount.add(claimedSeeds[referrals[msg.sender]]),
            refCount:referralsData[totalRefferalCount].refCount.add(1)
        });
