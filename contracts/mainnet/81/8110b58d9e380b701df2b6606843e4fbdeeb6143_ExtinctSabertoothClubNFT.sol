...
contract ExtinctSabertoothClubNFT is ERC721Enumerable, DataLayout, Proxiable, Ownable {
    using SafeMath for uint256;
    
    constructor() ERC721("Extinct Sabertooth Club", "SABERTOOTH") {
    ...
    function NFTConstructor(address _manager) public payable {
        ...
        gateWay = "https://sabertooths.mypinata.cloud/ipfs/";
        proxyConstructor("Extinct Sabertooth Club", "Sabertooth");
        mintCost = 0.03 ether;
        mintLimit = 3000;
