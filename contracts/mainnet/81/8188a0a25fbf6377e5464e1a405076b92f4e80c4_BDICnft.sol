...
contract BDICnft is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Backyard Duckling`s Ishab Club", "BDIC") {
    setHiddenMetadataUri("ipfs://Qmdod3r9oBd79wpnfzHT3hDKT6BzCTaDitJ2nghxcQC5GS/hiddenjson.json");
  }
