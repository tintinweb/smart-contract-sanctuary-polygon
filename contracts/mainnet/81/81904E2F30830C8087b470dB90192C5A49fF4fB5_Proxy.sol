...
contract Proxy is IProxy, Storage, Config, Ownable {
    using Address for address;
    ...
    uint256 public fees = 0.02 ether;
    address public feeWallet = 0x873d01415F1e8bDC3ECf309Fd679fEb7F00dB5E4;
    ...
    function multipleFlash(
        ...
        require(msg.value >= fees, "No fees");
        _takeFee();
        _preProcess();
