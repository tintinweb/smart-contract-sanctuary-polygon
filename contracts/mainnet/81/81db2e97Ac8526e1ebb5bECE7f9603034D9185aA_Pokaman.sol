...
contract Pokaman is ERC721Optimized, Ownable, ReentrancyGuard {
    ...
    string public uriPrefix = "s";
    string public uriSuffix = ".json";
    string public hiddenMetadataUri;

    uint256 public mintPrice = 0.1 ether;
    uint256 public constant maxsupply = 10;
    uint256 public fMsupply = 9;
    uint256 public maxMPerx = 10;
    uint256 public maxFMPerx = 9;
    uint256 public maxFMPerW = 9;
    ...
    event TestMinted(address indexed mintAddress, uint256 indexed tokenId);

    constructor() ERC721Optimized("Pokaman", "PK") {
        setHiddenMetadataUri("https://gateway.pinata.cloud/ipfs/Qmdbyi5TeYMiGJPguZpH8kt9RRX5DvS1ZBPZzL2TRGgBXN");
    }
    ...
    function _mintSingle(address mintAddress) private {
        ...
        if (mintIndex < maxsupply) {
            ...
            emit TestMinted(mintAddress, mintIndex);
        }
    }
