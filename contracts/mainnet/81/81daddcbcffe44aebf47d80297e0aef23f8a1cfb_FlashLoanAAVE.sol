...
contract FlashLoanAAVE is Ownable {
    ...
    function _sellAsset(address asset_) internal {
        ...
        sellAsset.approve(address(sellDexRouter), sellAsset.balanceOf(address(this)));


        if(sellV3){
            sellAsset.approve(address(uniswapRouter), sellAsset.balanceOf(address(this)));
            uniswapRouter.exactInputSingle{value: 0}(
                ISwapRouter.ExactInputSingleParams({
                    ...
                    amountIn: sellAsset.balanceOf(address(this)),
                    amountOutMinimum: 0,
                    sqrtPriceLimitX96: 0
                })
            );
            ...
            sellDexRouter.swapExactTokensForTokensSupportingFeeOnTransferTokens(
                sellAsset.balanceOf(address(this)), 
                0, 
                path, 
                address(this), 
                block.timestamp
