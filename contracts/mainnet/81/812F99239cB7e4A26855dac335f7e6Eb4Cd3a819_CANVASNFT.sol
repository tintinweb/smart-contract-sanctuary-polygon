...
/**
   ...
   BRUSH token will deflate itself in supply with every transaction, 50% Supply is burned at start.
...
contract CANVASNFT is Context, IERC20, Ownable {
    ...
    string private _name = "CANVASNFT";
    ...
    uint256 public _maxTxAmount = 500000000 * 10**10;
