...
import {console} from "../../../lib/ds-test/src/console.sol";
...
contract LpPosition is AdminTwoStep, ILpPosition, ERC721Solmate {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        console.log(address(_metadataGenerator));
...
contract MetadataGenerator is AdminTwoStep {
     ...
     */
    function generateImage(MetadataInfo memory info) view private returns (string memory) {
