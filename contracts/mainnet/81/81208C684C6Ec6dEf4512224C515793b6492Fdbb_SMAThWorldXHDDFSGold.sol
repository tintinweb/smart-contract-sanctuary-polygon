 ...
 * @notice This contract handles minting SMATh World x HDDFS Gold tokens.
 */
contract SMAThWorldXHDDFSGold is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x7e5e7dE6D5892634F0645194B35C6a49877F56D1;
    address public royaltyAddress = 0xE7E01E536865A965f1335A5615419f847fc0B7AA;
    ...
    string public name = "SMATh World x HDDFS Gold";
    string public symbol = "SMAThXHDDFS GOLD";
    ...
    constructor()
        ERC1155(
            "ipfs://bafybeihlp7yikyxefaqdrrvuisfcmizwajtsgxqajclieeset6ju2bhiru/{id}"
        )
        RevokableOperatorFilterer(
