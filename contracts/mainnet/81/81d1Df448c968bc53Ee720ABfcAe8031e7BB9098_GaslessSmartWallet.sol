...
contract GaslessSmartWallet is EIP712Upgradeable, IGaslessSmartWallet {
    ...
    // keccak256 of "Cast(address[] targets,bytes[] datas,uint256[] values,uint256 nonce,uint256 validUntil,uint256 gas)";
    bytes32 public constant castTypeHash =
        0x1c05d3e826f997f0d05435116ca93f54aa5ed5428c651c99078b1e5579918aaa;
...
interface IGaslessSmartWallet {
    ...
    ///                     Reverts if any validation has failed. For instance, if params or either signature or nonce are incorrect.
    ...
    /// @param signature    the EIP712 signature, should match keccak256(abi.encode(targets, datas, nonce, domainSeparatorV4()))
