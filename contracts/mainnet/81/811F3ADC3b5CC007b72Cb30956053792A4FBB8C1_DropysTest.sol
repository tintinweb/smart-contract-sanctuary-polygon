...
// File: contracts/DropysTest.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract DropysTest is
    ERC1155,
    Ownable,
    Pausable,
    ERC1155Supply,
    ...
    Allowlist
{
    ...
    string public name = "Dropys Test ";
    string public symbol = "DropysTest";
    string public contractURI = "ipfs://bafyreictsyh4pbgjemzpdas6akaxzvf5kdqchrs4qgzg2daxugmhoclqve/metadata.json";
