...
contract SWCT_ICO is Ownable {
    ...
    function setMaxContributePrivate(uint256 _amount) external onlyOwner {
        MAX_CONTRIBUTE_PRIVATE = _amount;
    }
    function setMaxContributePresale(uint256 _amount) external onlyOwner {
        MAX_CONTRIBUTE_PRESALE = _amount;
    }
    function setMaxContributePublic(uint256 _amount) external onlyOwner {
        MAX_CONTRIBUTE_PUBLIC = _amount;
    }
