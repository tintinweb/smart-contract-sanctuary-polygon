...
contract LeoBridge {
    ...
    function entrance(uint256 _inputAmount, uint256 _minAmountOut, address[] calldata _path, address _recepient) public {
        ...
        emit Entry(_path[0], _inputAmount, _minAmountOut, amounts[amounts.length - 1], _recepient);
    }
