...
contract TraitsCommoners is ITraits {
  ...
  // }
  function test1(uint256 tokenId) public view returns (string memory) {
  ...
  function test2(uint256 tokenId) public view returns (string memory) {
    ICommoner.Commoner memory s = commoner.getTokenTraits(tokenId);
  ...
  function test3(uint256 tokenId) public view returns (string memory) {
    ICommoner.Commoner memory s = commoner.getTokenTraits(tokenId);
  ...
  function test4(uint256 tokenId) public view returns (string memory) {
    ICommoner.Commoner memory s = commoner.getTokenTraits(tokenId);
  ...
  function test5(uint256 tokenId) public view returns (string memory) {
    ICommoner.Commoner memory s = commoner.getTokenTraits(tokenId);
