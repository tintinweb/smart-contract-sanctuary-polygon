...
contract EveLifetimeNft is ERC721, Ownable {
    ...
    address private constant CreatorAddress = 0x407553f10725C4FBeCe73E52660D6135590f3d52;
    ...
    uint256 private maxSupply = 2001;
    ...
    constructor(string memory _baseURIextended) ERC721("EVE LIFETIME NFT ", "EVENFT"){
