...
contract MeekMittis is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("Meek Mittis", "MKMTS") {
    customBaseURI = customBaseURI_;

    allowedMintCountMap[owner()] = 777;
  }
  ...
  uint256 public constant MINT_LIMIT_PER_WALLET = 777;
  ...
  uint256 public constant MAX_MULTIMINT = 777;
  ...
  function mint(uint256 count) public nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 777 at a time");
  ...
  {
    return (address(this), (salePrice * 777) / 10000);
  }
