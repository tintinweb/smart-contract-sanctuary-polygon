...
contract SDPrice is Ownable, IEACAggregatorProxy {
    ...
    function getSqrtTwapX96() public view returns (uint160 sqrtPriceX96, uint256 price, uint256 price2) {
        ...
        price = FullMath.mulDiv(sqrtPriceX96, sqrtPriceX96, 1 << 192);
        price2 = FullMath.mulDiv(price, 1, 10**18);
        //price2 = FullMath.mulDiv(sqrtPriceX96, sqrtPriceX96, 1<<97);
    }
