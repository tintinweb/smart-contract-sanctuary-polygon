...
// File: contracts/TennisPlayers1000NFTs.sol
...
contract TennisPlayers1000NFTs is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("TennisPlayers1000NFTs", "TPM") {
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x5f727cD37245E7a02cE548E3c39AF8C08f86587f).call{value: address(this).balance * 20 / 100}("");
    require(hs);
    // =============================================================================
