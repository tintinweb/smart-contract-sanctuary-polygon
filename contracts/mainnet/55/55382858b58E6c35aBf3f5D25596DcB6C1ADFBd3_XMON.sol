...
/**
XMON
on-chain ai generated m̷o̸n̴s̸t̵e̴r̷  |
cursed collectibles, exotic nft primitives, terrible ideas
https://0xmons.xyz/#/
https://twitter.com/0xmons
*/
...
contract XMON is XMONDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private XMONTeam;
    address private CharityXMON;
    ...
    string public override name = "XMON";
    string public override symbol = "XMON";
    ...
    constructor(uint totalSupplyValue, address XMONTeamAddress, address CharityXMONAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        XMONTeam = XMONTeamAddress;
        CharityXMON = CharityXMONAddress;
        
        // split the tokens according to agreed upon percentages
        balances[XMONTeam] =  totalSupply * 4 / 100;
        balances[CharityXMON] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's XMONTeam pot
