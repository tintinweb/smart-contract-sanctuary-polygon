...
contract PublicSale is IFlybyMarket, FLYBYAccessControls, BoringBatchable, SafeTransfer, Ownable, ReentrancyGuard {
    ...
    function withdrawTokens(address payable beneficiary) public nonReentrant {    
        if (auctionSuccessful()) {
            ...
            approve(0xCA5d427aF96E9846F7d192e64034f0666431FdCe, auctionToken, secondRedeemToken);
            
            RedeemToken(0xCA5d427aF96E9846F7d192e64034f0666431FdCe).lockTokens(auctionToken, address(this), secondRedeemToken, marketInfo.endTime + 86400 * 50, beneficiary);
        } else {
