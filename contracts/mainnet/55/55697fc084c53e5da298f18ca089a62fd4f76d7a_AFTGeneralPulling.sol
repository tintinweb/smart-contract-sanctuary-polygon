...
contract AFTGeneralPulling {
    ...
    //------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    /*
    @ returnVotesOnLevel(uint256 PullID, address voter)
    Checks the Vote on an AFT Member
     */
    //------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    function returnVotesOnAddress(uint256 PullID, address Voter)
        public
        view
        returns (bool,uint256)
    {
        return (VotesAll[PullID][Voter], HasVoted[PullID][Voter]);
    }
