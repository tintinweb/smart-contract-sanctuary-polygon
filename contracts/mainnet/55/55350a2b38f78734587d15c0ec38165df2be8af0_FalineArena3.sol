...
contract FalineArena3 is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxSupply = 1272;
  uint256 public maxMintAmountPerTx = 100;

  bool public paused = true;
  bool public revealed = false;

  constructor() ERC721("Faline Arena 3", "FA3") {
    setHiddenMetadataUri("ipfs://bafybeihouh6vubejrgxfgvtay2l7etpdw7gkypxgq75hnqwef3rxwpavia");
  }
