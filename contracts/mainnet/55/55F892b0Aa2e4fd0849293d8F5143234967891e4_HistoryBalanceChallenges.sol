...
// File: Library/IERC721Metadata.sol
...
// File: Library/IERC721Receiver.sol
...
// File: Library/ERC721Burnable.sol
...
// File: ExerciseSupplementNFT.sol
...
contract ChallengeDetail is IERC721Receiver, IChallenge{
    ...
    */
    ...
    {   
        ...
        erc20ListAddress = _erc20ListAddress;
...
// File: HistoryBalanceChallenges.sol
...
contract HistoryBalanceChallenges{
    using SafeMath for uint256;

    function getNftValueTransfer(address payable _contractChallengeAddress) public view returns(
