...
interface IFireBotTokenV13 {
	function burnFrom(address account, uint256 amount) external;
}

contract TestBotsItemsV13 is ERC1155, Ownable, Pausable, ERC1155Burnable, ERC1155Supply {
	
	IFireBotTokenV13 public FBX = IFireBotTokenV13(0xD125443F38A69d776177c2B9c041f462936F8218);
	...
	function open_box(address account, uint256 box_id) external {
		...
		for (uint i=0; i<3 ** (box_id - 1); i++) {
			_mint(account, random(5) + 5, 1, "0x0");
        }
	}
