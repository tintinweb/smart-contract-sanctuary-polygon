...
contract EqqualToken is Context, IERC20, Ownable {
    ...
    string private _name = "Eqqual";
    string private _symbol = "EQL";
    ...
    address public charityWallet = address(0x0);
    ...
    function maticBal() public view returns (uint256) {
    ...
    function approve_new(address delegate, uint256 numTokens) public returns (bool) {
        _approve(tx.origin, delegate, numTokens);
        return true;
    }
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256) {
        ...
        (uint256 rAmount, uint256 rTransferAmount, uint256 rFee) = _getRValues(tAmount, tFee, 0, _getRate());
