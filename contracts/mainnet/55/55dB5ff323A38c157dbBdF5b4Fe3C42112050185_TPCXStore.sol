...
contract TPCXStore is ERC1155Holder, Ownable, Pausable {
    ...
    function viewUserCanPurchase() public view returns(bool){
        return block.timestamp >=  nextPurchaseDate[msg.sender];
    }
    
    function viewUserOwnsExclusive() public view returns(bool){
        uint256 _holdings;
