    ...
    ReentrancyGuard
{
    ...
    // @dev number of tokens minted for account
    ...
    modifier accountInLimit() {
        require(
            tokenMap[msg.sender].length + 1 <= maxMintLimit,
    ...
    function isAccountInLimit() public view returns (bool) {
        return tokenMap[msg.sender].length + 1 <= maxMintLimit;
    }
    ...
    function safeMint(address _to) private supplyAvailable {
        ...
        tokenMap[msg.sender].push(tokenId);
    }
        ...
        returns (bool isOperator)
    {
        ...
        // matic net : 0x58807baD0B376efc12F5AD86aAc70E78ed67deaE
