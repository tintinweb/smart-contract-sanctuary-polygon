...
// File: contracts/PixelRomans.sol
...
contract PixelRomans is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://QmcowA1CQk64jqjZMJUTDn17jks6hLLULfMTTgRsg9hxSr/";
  string public uriSuffix = ".json";
  string public hiddenMetadataUri;
  
  uint256 public cost = 0.00 ether;
  uint256 public maxSupply = 7999;
  uint256 public maxMintAmountPerTx = 7999;

  bool public paused = true;
  bool public revealed = false;

  constructor() ERC721("PixelRomans", "PR") {
    setHiddenMetadataUri("ipfs://QmTcmSnDtbX7xGbFFoQVjc46eJaQYeLeCUMWrT4h2nY5sb/hidden.json");
  }
