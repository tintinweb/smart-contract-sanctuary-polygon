 ...
 * @notice This contract handles minting Kiss the Stars tokens.
 */
contract KissTheStars is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xF09ab3Ea7a1B9B85FbFb922f24402E6FD8e4A75e;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x616Bb71645371F6c32D9cfAFc3DDb480a19A249a;
    address[] public payoutAddresses = [
        0x616Bb71645371F6c32D9cfAFc3DDb480a19A249a
    ];
    ...
    string public name = "Kiss the Stars";
    string public symbol = "KTSTARS";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeiau2jvvjddaw6s26rfqwc74seyougoxsqhr3qc2d5uorz2bckvswy/{id}"
        )
        RevokableOperatorFilterer(
