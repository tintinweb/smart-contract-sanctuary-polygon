...
contract Winenwin is ERC1155, Ownable, ERC1155Burnable, ERC1155Supply, ERC1155URIStorage {
    ...
    */
    function mintMembershipNFTs(address holder,uint256[] memory tokenIds,uint256[] memory amounts,string memory baseURI,string memory _tokenURI) external onlyOwner {
    ...
    */
     ...
     * @param amount: 발급하려는 NFT의 숫자
    */
    function mintMembershipBatchNFTs(address[] memory holders,uint256 tokenId,uint256 amount,string memory baseURI,string memory _tokenURI) external onlyOwner {
