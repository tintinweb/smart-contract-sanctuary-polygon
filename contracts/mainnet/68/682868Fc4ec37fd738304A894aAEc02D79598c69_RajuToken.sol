...
contract RajuToken is Initializable {
    ...
    function setStartTime1(uint256 phase1starttime) external limited {
        require(phase1starttime >= block.timestamp && _phase1starttime >= block.timestamp, "Phase1time error");
        _phase1starttime = phase1starttime;
    }

    function setPeriod1(uint256 phase1period) external limited {
        require(_phase1starttime >= block.timestamp && _phase1starttime >= block.timestamp, "Phase1period error");
        _phase1period = phase1period;
    }

    function setStartTime2(uint256 phase2starttime) external limited {
        require(phase2starttime >= block.timestamp && _phase2starttime >= block.timestamp, "Phase2time error");
        _phase2starttime = phase2starttime;
    }

    function setPeriod2(uint256 phase2period) external limited {
        require(_phase2starttime >= block.timestamp && _phase2starttime >= block.timestamp, "Phase2period error");
        _phase2period = phase2period;
    }

    function setStartTime3(uint256 phase3starttime) external limited {
        require(phase3starttime >= _phase2starttime && _phase3starttime >= block.timestamp, "Phase3time error");
        _phase3starttime = phase3starttime;
    }

    function setPeriod3(uint256 phase3period) external limited {
        require(_phase3starttime >= block.timestamp && _phase3starttime >= block.timestamp, "Phase3period error");
