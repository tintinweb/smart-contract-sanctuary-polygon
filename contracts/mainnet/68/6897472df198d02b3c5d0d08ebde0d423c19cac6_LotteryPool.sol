...
contract LotteryPool {
    ...
    onlyAdmin(_appId, msg.sender) {
        ...
        lotteries[_lotteryId] = Lottery(_rewardToken, _amounts, _fixedNum, _proportionNum, false, false, true);
    ...
    onlyAdmin(_appId, msg.sender) {
        ...
        lotteries[_lotteryId] = Lottery(IERC20(address(0)), _amounts, _fixedNum, _proportionNum, true, false, true);
