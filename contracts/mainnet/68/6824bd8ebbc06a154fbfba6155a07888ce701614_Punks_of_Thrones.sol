...
// File: contracts/PunksofThrones.sol
...
contract Punks_of_Thrones is ERC721A, Ownable {
    ...
    constructor(string memory baseURI, address _founderAddress, bytes32 root) ERC721A("Punks of Thrones", "POT") {
