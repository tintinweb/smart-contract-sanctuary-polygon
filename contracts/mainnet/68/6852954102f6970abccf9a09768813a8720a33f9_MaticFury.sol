...
contract MaticFury {
	...
	uint constant public			PROJECT_FEE						= 30;					// project fee 3% of deposit
	...
	uint constant public			WITHDRAW_COOLDOWN				= 1 days / 1;			// claim 1 times per day
	address payable public			INSURANCE_CONTRACT;
	mapping (uint => uint) public	INSURANCE_MAXBALANCE;
	uint constant public			INSURANCE_PERCENT				= 190;					// insurance fee 19% of claim
	uint constant public			INSURANCE_LOWBALANCE_PERCENT	= 250;					// protection kicks in at 25% or lower
	uint constant public			REINVEST_PERCENT				= 10;					// auto reinvest 1% of claim
