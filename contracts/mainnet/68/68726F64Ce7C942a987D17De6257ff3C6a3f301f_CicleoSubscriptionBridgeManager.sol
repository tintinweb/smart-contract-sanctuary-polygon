...
contract CicleoSubscriptionBridgeManager {
    ...
    function getDestinationCalldata(
        address user,
        ...
        return
            abi.encode(
                ICicleoRouter.bridgeSubscription.selector,
                subManagerId,
                subscriptionId,
                user,
                price,
    ...
    function payFunctionWithBridge(
        ...
        bytes memory destCall = getDestinationCalldata(
            msg.sender,
            subscriptionManagerId,
            subscriptionId,
            price,
        ...
        if (_swapData.length > 0) {
            ...
            lifi.startBridgeTokensViaStargate{value: msg.value}(_bridgeData, _stargateData);
        }
    }
