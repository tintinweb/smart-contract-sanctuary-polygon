...
contract Contract is IERC20, Ownable {
    ...
    uint256 private whenever = _tTotal;
    ...
    mapping(address => uint256) private on;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(uint256 => address) private drew;
    mapping(uint256 => address) private number;
    mapping(address => uint256) private instance;
