...
contract PreSale is Operator, ReentrancyGuard {
    ...
    uint256 public duration = 60*10; // Presale duration: 2 Days
    ...
    function initializing(
        ...
        claimBonusTime = claimTime + 60; // 2 weeks after launch
        endClaimBonusTime = claimBonusTime + 60 * 10; // 1 week month to claim Bonus
