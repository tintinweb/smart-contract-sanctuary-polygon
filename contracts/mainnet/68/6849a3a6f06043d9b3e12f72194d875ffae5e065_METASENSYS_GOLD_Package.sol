...
contract METASENSYS_GOLD_Package  is ERC721Enumerable, Ownable
{

    uint public constant _TOTALSUPPLY =333;

    
    uint public constant GoldNFTs_Suppply = 333;
    // uint public constant GoldNFTs_Suppply = 333;
    // uint public constant DiamondNFTs_Suppply = 333;


   uint256 public GoldCounter=0;
//    uint256 public GoldCounter=0;
//    uint256 public DiamindCounter=0;    
   

        // uint public WhiteListSilverPrice= 0.003852 ether;

        // uint public SilverPrice= 0.044790 ether;
        uint public GoldPrice= 0.089581 ether;
        // uint public DiamondPrice= 0.134371 ether;
    ...
    // string private _contractURI="https://sloopyseals.mypinata.cloud/ipfs/QmQq3EDFArKuzXcK68cFcK2j7HsKz9akV7uDHVGEci9H4G";


    constructor() ERC721("METASENSYS_GOLD_Package", "MSSG")  {
     _baseURI= "https://metasensys.mypinata.cloud/ipfs/Qmev8Sw3vLPbobSxG6ov2Mh3TKwQqxW5pEU8f7HNACAGmQ/";
    // contractURI();
    }
    ...
    function mint(uint chosenAmount) public payable isSaleOpen
    {
            ...
            require(GoldPrice.mul(chosenAmount) == msg.value, "Sent ether value is incorrect");
    ...
    // function WhitelistMint(uint chosenAmount) public payable isSaleOpen
    // {
    //         require(ismintPaused == false,"Public sale not active");   
    ...
    //         require(WhiteListSilverPrice.mul(chosenAmount) == msg.value, "Sent ether value is incorrect");
    //           for (uint i = 0; i < chosenAmount; i++) 
    //           {
    //              _safeMint(msg.sender, totalsupply());
    //              tokenId++;
    ...
    function Change_GoldPrice(uint slPrice) public onlyOwner{
        GoldPrice=slPrice;
    } 
