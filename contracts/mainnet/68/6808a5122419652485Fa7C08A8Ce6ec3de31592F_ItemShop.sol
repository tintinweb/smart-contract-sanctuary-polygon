...
contract ItemShop is OwnableUpgradeable {
    ...
    function initialize() public initializer {
        ...
        setShopInfo(4, true, 1000000, 2, 10 ether);
        ...
        setShopInfo(10, true, 1000000, 1, 100 ether);
        setShopInfo(11, true, 1000000, 1, 200 ether);
        setShopInfo(12, true, 1000000, 1, 300 ether);
        setShopInfo(13, true, 1000000, 1, 30 ether);
