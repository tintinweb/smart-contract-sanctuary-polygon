...
contract AOPFrenchy is ERC721Tradable {
    string _baseTokenURI;

    constructor() ERC721Tradable("AOP Frenchy", "AOP") {}

    function mintTo(address _to) public onlyOwner {
        super._mintTo(_to);
    }

    function mintMany(address _toAddress, uint256 _amount) public onlyOwner {
    ...
    function transferMany(address _toAddress, uint256 _amount) public {
        ...
        for (uint256 index = 0; index < _amount; index++) {
            ...
            transferFrom(msg.sender, _toAddress, tokenId);
        }
    }
