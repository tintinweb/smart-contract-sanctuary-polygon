...
contract CryptosaursSpecialEvents is
	ERC1155,
	AccessControlMixin,
	...
	Ownable
{
	...
	// Contract name
	string public constant name = "Cryptosaurs Special Events";
	// Contract symbol
	string public constant symbol = "CSSE";
	string private constant _uri =
		"https://api.cryptosaurs.ai/api/metadata/special_events/";
