 ...
 */
contract WOO3OfficialSBT is ERC721, ERC721URIStorage, Ownable {
     ...
     */
    constructor() ERC721("WOO3OfficialSBT", "SBT") {
    ...
    function setTokenMintMap(address[] calldata addresses,string[] calldata uris) public onlyOwner {
        require(addresses.length==uris.length,"Woo3SBT: addresses does not uris length");
