...
// File: contracts/Bpaper 2.0 Verified.sol
...
contract Collection is Ownable {
  ...
  address public designAddr = 0x005fC62d456fD17CaAc3542Cf40feD55eAe46d60;
  address public CheckQuaAddr = 0xAEe6BF13E0DEe34DB12e2295883870B6A02c11d2;
  ...
  function PreviewTokenURI(uint _BcardID, string memory _title, string[] memory _tagName, string[] memory _tagValue,
    string memory _content) public payable returns (string memory){
        ...
        Design designContract = Design (designAddr);
        return designContract.buildMetadata(uint256(collectionID).toString(),_title, _tagName,
          _tagValue, getDate(block.timestamp), _content, 
...
contract Data is Ownable {
  uint public collectionID = 1;
  using Strings for uint256;
  address public CollectionContractAddr = 0x6AEB66A0c65DF5dfdd04DE5Ba5185D0908d9427a;
  ...
  function newData(uint _BpaperID, string memory _Title,string[] memory _tagName, string[] memory _tagValue,string memory _Content, 
    ...
    string memory tempUri = DesignContract.buildMetadata(uint256(collectionID).toString(),
        _Title, _tagName, _tagValue, _date, _Content, _BpaperMinterID, 
...
abstract contract Design is Ownable{
    function buildMetadata(string memory _collectionID, string memory _title, string[] memory _tagName, string[] memory _tagValue, string memory _editTime, string memory _content, uint _tkId, string memory _ethName) 
...
contract Bpaper is ERC1155, Ownable {
  ...
  address public MAKEPaperAddr = 0x82f531f8B004B66B306e0cC8e8Fc19b3C4015BE2;
  address public AdAddr;
