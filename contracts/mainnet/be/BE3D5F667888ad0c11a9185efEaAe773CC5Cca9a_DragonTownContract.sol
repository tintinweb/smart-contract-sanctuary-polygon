...
//
//     ____                                  ______                  
//    / __ \_________ _____ _____  ____     /_  __/___ _      ______ 
//   / / / / ___/ __ `/ __ `/ __ \/ __ \     / / / __ \ | /| / / __ \
//  / /_/ / /  / /_/ / /_/ / /_/ / / / /    / / / /_/ / |/ |/ / / / /
// /_____/_/   \__,_/\__, /\____/_/ /_/    /_/  \____/|__/|__/_/ /_/ 
//                  /____/                                           
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x352CaC108Dd71574B68A9e75524908ab706a9Af0];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmSGgshqfQDU1qJziGTno4ZV1XVtuAvfTJo3bnNqUuqgC7/";
...
// File: contracts/DragonTownContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DragonTownContract is RamppERC721A {
    constructor() RamppERC721A("Dragon Town", "DRT"){}
}
