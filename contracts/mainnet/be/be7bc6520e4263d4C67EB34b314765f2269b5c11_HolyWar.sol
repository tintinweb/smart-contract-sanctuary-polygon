    ...
    ERC2771Context
{
    ...
    event PlayerSurrenders(uint256 indexed _gameId, address indexed _player);
    ...
    function startHolyWar(uint256 _ante, address _tokenContract) public {
        ...
        require(
            _ante >= minimumAnte[_tokenContract] &&
                _ante <= maximumAnte[_tokenContract],
    ...
    function surrender() public {
        ...
        emit PlayerSurrenders(gameId, sender);
    }
    ...
    function goToWar(uint256 _sideBet) public {
        ...
        emit GoToWar(gameId, sender, _sideBet);
    ...
    function capture(uint256 _gameId) public {
        ...
        emit PlayerSurrenders(_gameId, gameData[_gameId].player);
    }
