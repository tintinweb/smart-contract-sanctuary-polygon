...
// File: contracts/token/Memoria.sol
...
contract Memoria is Ownable, ERC20 {
  uint256 constant NUMBER = 1_000_0 * 10**uint256(18);

  constructor() ERC20('Memoria', 'ORIA') {
    _mint(msg.sender, 1000000 * NUMBER);
  }
