...
contract BEP20M025 is IBEP20, Ownable, LineReward, InviteReward {
    using SafeMath for uint256;
    struct info{
    ...
    string private _name = "M-025";
    string private _symbol = "M-025";
    ...
    address public fundAddress=0x2D4C407BBe49438ED859fe965b140dcF1aaB71a9;
    address public fundAddress1=0x2D4C407BBe49438ED859fe965b140dcF1aaB71a9;
    address public fundAddress2=0x2D4C407BBe49438ED859fe965b140dcF1aaB71a9;
    address public fundAddress3=0x2D4C407BBe49438ED859fe965b140dcF1aaB71a9;
    address public bonusAddress=0x2D4C407BBe49438ED859fe965b140dcF1aaB71a9;
    address public lineAddress=0x2D4C407BBe49438ED859fe965b140dcF1aaB71a9;
    uint256 Inviter_season_number = 3;
    ...
    function setpush_contract_address(address _push_contract_address,uint256 _value) public  {
    ...
    function basic_set(uint32 _bonusIntervalTime,uint256 _bonusUsdtAmount,uint256 _bonusLineUsdtAmount,uint256 _buyLineUsdtAmount,uint256 _Inviter_season_number) public  {
        require(msg.sender == _owner || msg.sender == arbitration);
        ...
        Inviter_season_number = _Inviter_season_number;
    }
   ...
   function getNumberOforderListings(uint256 status,address _address)
    ...
    function vbbc(address shop_address,uint256 recommand_radio,uint256 straight,uint256 straight_radio,uint256 pay_type,uint256 _number,address contract_address,uint256 order_id)public{
             ...
             uint256 oldBalance = ERC20(contract_address).balanceOf(address(this));
            ERC20(contract_address).transferFrom(msg.sender,address(this),_number);     
            uint256 newBalance = ERC20(contract_address).balanceOf(address(this));
            _number = newBalance-oldBalance;
             }
             if(order_id <= 0){
        ...
        for(uint8 i = 0; i < rates.length; i++) {
            cur = _refers[cur];
              ...
              uint256 curAmount = amount.div(1000).mul(rate);
               removeAllFee();
            if (cur == address(0) || is_vid[cur] == 0 ||  (season_buy[get_season()-1][cur] < Inviter_season_number && i != 0)) {
