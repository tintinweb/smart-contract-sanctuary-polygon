...
contract OnChEternalStorage is OnChOwnableWithWhitelist {
    ...
    // *** Setter Methods ***
    function setUint(bytes32 _key, uint _value) whitelistedOnly external {
        uIntStorage[_key] = _value;
    }

    function setString(bytes32 _key, string memory _value) whitelistedOnly external {
        stringStorage[_key] = _value;
    }

    function setAddress(bytes32 _key, address _value) whitelistedOnly external {
        addressStorage[_key] = _value;
    }

    function setBytes(bytes32 _key, bytes memory _value) whitelistedOnly external {
        bytesStorage[_key] = _value;
    }

    function setBool(bytes32 _key, bool _value) whitelistedOnly external {
        boolStorage[_key] = _value;
    }

    function setInt(bytes32 _key, int _value) whitelistedOnly external {
        intStorage[_key] = _value;
    }

    // *** Delete Methods ***
    function deleteUint(bytes32 _key) whitelistedOnly external {
        delete uIntStorage[_key];
    }

    function deleteString(bytes32 _key) whitelistedOnly external {
        delete stringStorage[_key];
    }

    function deleteAddress(bytes32 _key) whitelistedOnly external {
        delete addressStorage[_key];
    }

    function deleteBytes(bytes32 _key) whitelistedOnly external {
        delete bytesStorage[_key];
    }

    function deleteBool(bytes32 _key) whitelistedOnly external {
        delete boolStorage[_key];
    }

    function deleteInt(bytes32 _key) whitelistedOnly external {
