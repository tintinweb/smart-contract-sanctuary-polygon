...
contract Auction888BazarStorage {
    ...
    address public auction888Marketplace;

    address public auction888House;
    ...
    Auction888BazarStorage
{
    ...
    function initialize(
        ...
        address _auction888Marketplace,
        ...
        require(_auction888Marketplace != address(0));
        require(_auctionHouse != address(0));
        ...
        auction888Marketplace = _auction888Marketplace;
        auction888House = _auctionHouse;
    ...
    function setAuction888Marketplace(address _auction888Marketplace)
        external
        onlyOwner
    {
        require(_auction888Marketplace != address(0));
    ...
    function setAuction888House(address _auctionHouse)
        external
        onlyOwner
    {
        require(_auctionHouse != address(0));
    ...
    function offer(
        ...
        (bool success, bytes memory data) = auction888Marketplace.delegatecall(
    ...
    function configureAuction(
        ...
        (bool success, bytes memory data) = auction888House.delegatecall(
            abi.encodeWithSelector(
