...
// File: contracts/PaladdinReferral.sol
 ...
 * `SafeMath` restores this intuition reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it as always.
 */
library SafeMath {
    /**
...
contract PaladdinReferral is IReferral, Ownable {
