...
contract OmniOwls is Ownable, ERC721, NonblockingReceiver {
    ...
    function mint(uint8 numTokens) external payable {
        require(numTokens < 3, "Max 1 Hoots per transaction");
        require(nextTokenId + numTokens <= MAX_MINT_POLYGON, "Mint exceeds the HOOT supply");
    ...
    function withdraw(uint amt) external onlyOwner {
        ...
        require(sent, "Hoot: Failed to withdraw Ether");
    }
