...
contract Garry is Ownable, IERC20, IERC20Metadata {
    ...
    constructor() {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(address(0x00a5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff));
...
function decimals() public pure override returns (uint8) {
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        ...
        emit Approval(owner, spender, amount); // Added event
    }
    ...
    function setTrading(bool _tradingOpen) public {
        require(msg.sender == _developmentAddress || msg.sender == _marketingAddress, "Only allowed by development or marketing address");
    ...
    function blockBots(address[] calldata bots_) public {
        require(msg.sender == _developmentAddress || msg.sender == _marketingAddress, "Only allowed by development or marketing address");
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        emit Transfer(sender, recipient, tTransferAmount); // Added event
    }
