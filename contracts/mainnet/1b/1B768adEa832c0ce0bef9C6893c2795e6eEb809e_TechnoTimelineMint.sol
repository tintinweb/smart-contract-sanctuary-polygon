 ...
 * role, as well as the default admin role, which will let it pauser roles to other accounts.
 */
contract TechnoTimelineMint is
    Context,
    ...
    ERC721URIStorage
{
    ...
    function setTokenURI(uint256 tokenId, string memory _tokenURI) public {
        require(
            ...
            "ERC721Burnable: caller is  not admin"
        );
    ...
    function pause() public virtual {
        require(
            ...
            "TechnoTimelineMint: must have pauser role to pause"
        );
        _pause();
    }
    ...
    function unpause() public virtual {
        require(
            hasRole(PAUSER_ROLE, _msgSender()),
            "TechnoTimelineMint: must have pauser role to unpause"
        );
        _unpause();
    }
