...
contract HonigdachsVIPCLUB is ERC721A {
...
using SafeMath for uint;
 modifier onlyOwner {
    ...
    Counters.Counter public count;
     string public baseURI="https://gateway.pinata.cloud/ipfs/Qmazhb9aGRugBqKSTtLKg5Ncbai1bMfNzib7BuLnbTUQXu/";
  string public baseExtension = ".json";
    constructor() ERC721A("Honigdachs VIP CLUB", "HVC") {
      owner=msg.sender;
