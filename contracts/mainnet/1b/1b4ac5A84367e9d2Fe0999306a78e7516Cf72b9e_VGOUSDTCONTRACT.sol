...
contract VGOUSDTCONTRACT is ReentrancyGuard{
...
/** sender is the registered user check **/
require(_amountDeposited[msg.sender] > 0, "User has no deposits.");

/** sender is whitelisted user check **/
