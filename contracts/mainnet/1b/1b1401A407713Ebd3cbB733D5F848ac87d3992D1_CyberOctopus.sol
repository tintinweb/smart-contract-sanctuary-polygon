...
contract CyberOctopus is ERC721A, MerkleDistributor, ReentrancyGuard, AccessControl{
    ...
    constructor(address payable shareholderAddress_) ERC721A("CyberOctopus Oracle", "OCTOPUS") {
    ...
    * set price per token 
    */
    function setPrice(uint256 _cost) external onlyRole(SUPPORT_ROLE) {
        pricePerToken = _cost;
    }
    /**
