...
contract BoredApePunkClub is ERC721, ERC721Enumerable, Pausable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;


    uint256 public initial_price = 6 ether;
    uint256 public price;
    uint256 public MAX_SUPPLY = 10213;
    uint256 public reserved = 1000;
    uint256 public constant MAX_MINT_PER_TX = 100000;



    constructor() ERC721("Bored Ape Punk Club", "BAPC") {
        price = initial_price;
    }

    function _baseURI() internal pure override returns (string memory) {
        return "https://ipfs.io/ipfs/QmeN4iYMF2KRCYAWyPex6K6fB4morhbs2isQP3JdMVrqdH/";
    }
    ...
    function mintToken(uint256 _amount) public payable {
        uint256 supply = totalSupply();
        require( _amount > 0 && _amount <= MAX_MINT_PER_TX, "Can only mint 100000 tokens at once" );
