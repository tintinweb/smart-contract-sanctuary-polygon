...
contract ManoFish is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Mano Fish", "MF") {
    setHiddenMetadataUri("ipfs://QmSg6A6FV5Y5R6jzC49H64sX3GfFbwBSTA7aUjpCztfWKY/hidden.json");
  }
