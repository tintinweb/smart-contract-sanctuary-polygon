...
contract MaticPro {
	...
	uint constant public			INVEST_MIN_AMOUNT				= 0.005 ether;				// 0.005 MATIC
	uint[] public					REFERRAL_PERCENTS				= [80, 30, 20, 10, 10];	// 8% 3% 2% 1% 1%
	uint constant public			DEV_FEE							= 50;					// dev fee 5% of deposit
	uint constant public			MAX_WITHDRAW_AMOUNT				= 5000 ether;			// claim 5000 MATIC max wdraw daily
	...
	constructor(address payable _walletDev) {
		...
		PLANS.push( TPlan(30,50) ); //30days 5percent
	}
