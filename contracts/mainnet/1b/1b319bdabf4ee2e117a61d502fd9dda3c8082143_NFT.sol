...
contract NFT is ERC721Enumerable, Ownable {
  ...
  uint256 public maxSupply = 2222; //тут пишите общее количество нфт в вашей коллекции
  uint256 public maxMintAmount = 2222;  // количество нфт которое можно сминтить при 1 транзакции
 ...
 function whitelistUser(address _user) public onlyOwner {
  ...
  function withdraw() public payable onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x03BFccd7e890F145C3aBc97cddc8502Bc7f2A59D).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
