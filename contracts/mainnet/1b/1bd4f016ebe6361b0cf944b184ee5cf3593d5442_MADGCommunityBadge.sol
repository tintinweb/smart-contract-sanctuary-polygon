...
// File: contracts/MADGCB.sol


// https://www.madgoblins.com
...
contract MADGCommunityBadge is ERC721, ERC721Enumerable, Ownable {
    string private _baseURIextended;
    bool public saleIsActive = false;
    bool public isAllowListActive = false;
    uint256 public constant MAX_SUPPLY = 999;
    uint256 public constant MAX_PUBLIC_MINT = 1;
    uint256 private PRICE_PER_TOKEN = 0.00 ether;

    mapping(address => uint8) private _allowList;

    constructor() ERC721("MADG Community Badge", "MADGCB") {
    }
