...
contract BlockChair is ERC721, ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdCounter;

    string private baseTokenURI;
    address public minter = 0x07afd940cD80508e6154F00020e46FDBe3c0405a;

    constructor() ERC721("BlockChair", "BlockChair") {}
    ...
    function safeMintTo(address _to, string memory tokenURI_)
        public
        payable
        onlyMinter
    {
