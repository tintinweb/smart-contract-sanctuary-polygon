...
contract YPredictSaleMatic is Ownable, Pausable, ReentrancyGuard {
    ...
    ////new
    function _getMaticPriceInUSDT() public view returns (int256) {
        return _getDerivedPrice(i_matic_usd_priceFeed, i_usdt_usd_priceFeed, 6);
    }
