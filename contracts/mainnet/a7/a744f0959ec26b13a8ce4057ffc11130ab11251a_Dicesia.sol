...
contract Dicesia is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;
 
  constructor(string memory customBaseURI_) ERC721("Dicesia", "DCSIA") {
  ...
  function mint(uint256 count) public payable nonReentrant onlyOwner {
    ...
    require(totalSupply() <= (MAX_SUPPLY - count), "Exceeds max supply");
  ...
  address private constant payoutAddress1 =
    0xA7c8EF131344639F8C4aC295fb6F08695721198b;
