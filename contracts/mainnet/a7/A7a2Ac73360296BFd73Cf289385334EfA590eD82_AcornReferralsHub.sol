...
import "./interfaces/IAcornReferralsVault.sol";

/**
 * @title AcornReferralsHub
 * @notice Contract to manage the referrals of Acorn Casino.
 */
contract AcornReferralsHub is ReentrancyGuard, Pausable, Ownable {
    //---------- Libraries ----------//
    using SafeMath for uint256;
    using EnumerableSet for EnumerableSet.AddressSet;

    //---------- Contracts ----------//
    IAcornReferralsVault private VAULT;
    ...
    constructor(address _acornBank, address _referralVault) {
        ...
        VAULT = IAcornReferralsVault(_referralVault);
    }
    ...
    //----------- External Functions -----------//
    function isReferral(address _wallet) public view returns (bool) {
    ...
    function addPoints(address _referral, uint256 _amount) external onlyBank {
...
interface IAcornReferralsVault {
