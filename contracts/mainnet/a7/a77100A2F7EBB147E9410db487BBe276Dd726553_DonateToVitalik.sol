...
import {Address} from "@openzeppelin/contracts/utils/Address.sol";
import {VITALIK} from "./constants/Addresses.sol";
...
contract DonateToVitalik is GelatoRelayContext {
    using Address for address payable;

    function sendToVitalik() external onlyGelatoRelay {
        // Payment to Gelato
        _transferRelayFee();

        // transfer of tokens
        payable(VITALIK).sendValue(10000000000000000);
    }
}
...
address constant _MSG_SENDER = 0xDA9644C2c2B6F50426EaBa9ce1B853e99f2D4fCa;