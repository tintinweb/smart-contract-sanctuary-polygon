...
contract SkinShop is OwnableUpgradeable {
    ...
    function initialize() public initializer {
        ...
        newSkinInfo(10005, 30 ether, true, 1000);
        newSkinInfo(10006, 30 ether, true, 1000);
        newSkinInfo(10007, 45 ether, true, 1000);
        newSkinInfo(10008, 45 ether, true, 1000);
        newSkinInfo(10009, 60 ether, true, 1000);
    }
    ...
    function compoundSuperSkin(uint[] memory skins) external {
        ...
        require(skins[0] == skins[1] && skins[1] == skins[2], 'wrong skin ID');
        require(skins[0] >= 10010 && skins[0] < 10013, 'wrong skin');
        for (uint i = 0; i < skins[i]; i++){
            skin.burn(skins[i]);
        }
        skin.mint(msg.sender,skins[0] + 1);
    }
