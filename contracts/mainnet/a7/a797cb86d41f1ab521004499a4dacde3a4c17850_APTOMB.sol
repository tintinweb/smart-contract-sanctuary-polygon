...
// APTOMB is the coolest bar in town. You come in with some Reward, and leave with more! The longer you stay, the more Reward you get.
//
// This contract handles swapping to and from xReward, AMMSwap's staking token.
contract APTOMB is ERC20("aPTOMB", "aPTOMB"){
    using SafeMath for uint256;
