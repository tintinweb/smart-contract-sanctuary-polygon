...
contract zombieNft is ERC721Enumerable,BridgeNFT {
    string public baseUri;
    constructor (string memory name_, string memory symbol_, string memory baseURI_) ERC721 (name_, symbol_){
        baseUri=baseURI_;
    }
    function mint(address to, uint256 id,bytes calldata mintArgs) public override {
        _safeMint(to, id);
    }
    function burnFor(address from, uint256 id) external override {
