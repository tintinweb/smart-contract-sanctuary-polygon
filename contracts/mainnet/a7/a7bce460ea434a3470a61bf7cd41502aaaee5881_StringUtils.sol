...
contract PropertyMogul  {
    ...
    uint256 private WITHDRAW_PENALTY = 10;
    ...
    function withdrawRentalIncomeForSuburb(uint256 suburb) private {
        ...
        if(hasSeeds > 0)
        {
            ...
            _users[msg.sender].seedProperties[suburb] = SafeMath.sub(_users[msg.sender].seedProperties[suburb], SafeMath.div(_users[msg.sender].seedProperties[suburb], WITHDRAW_PENALTY));
    ...
    function getBackMyMoney() public  {
