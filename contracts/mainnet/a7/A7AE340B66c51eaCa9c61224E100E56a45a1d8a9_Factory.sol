...
contract Factory is Ownable, ReentrancyGuard {
    VRFCoordinatorV2Interface public constant VRF_COORDINATOR =
        VRFCoordinatorV2Interface(0xAE975071Be8F8eE67addBC1A82488F1C24858067); // polygon mainnet
...
contract WeightedRaffle is VRFConsumerBaseV2Upgradeable, NativeMetaTransaction, OwnableUpgradeable, ContextMixin {
    ...
    VRFCoordinatorV2Interface public constant VRF_COORDINATOR =
        VRFCoordinatorV2Interface(0xAE975071Be8F8eE67addBC1A82488F1C24858067);
    bytes32 public constant KEY_HASH = 0x6e099d640cde6de9d40ac749b4b594126b0169747122711109c9985d47751f93; //polygon mainnet
    ...
    event UpdateReservior(address indexed lowestWinner, uint256 lowestWinnerIndex, uint256 maxWeightedRandomKey);
    ...
    function fulfillRandomWords(uint256 requestId, uint256[] memory randomWords) internal override {
        ...
        else _weightedRandomKey = uint256(-randomSeed.log2()) / _addressToWeight[_newAddress];
        ...
        if (winners.length < winnersNumber) _fillReservior(_newAddress);
    ...
    function exitRaffle() external {
        ...
        if (winners[addressToIndex[_msgSender()]] == _msgSender()) {
            ...
            if (addressToIndex[_msgSender()] == lowestWinnerIndex) _updateReservior(); // update reservior if lowestWinnerIndex exited
