...
abstract contract LoanUpdateJobResolver is TimedResolver {
  ...
  constructor(
    ...
    uint256 _initialStartUpdateHour
  ) TimedResolver(_initialStartUpdateHour) {
...
contract LoanValueUpdateResolver is LoanUpdateJobResolver {
  ...
  ) LoanUpdateJobResolver(_addressRegistry, _maxLoansToUpdate, _initialUpdateHour) {}
