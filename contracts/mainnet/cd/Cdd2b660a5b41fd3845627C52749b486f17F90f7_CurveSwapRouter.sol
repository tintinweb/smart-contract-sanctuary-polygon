...
contract CurveSwapRouter is ICurveSwapRouter {
  ...
  function _sellARTHUSDForExact(
    ...
    if (amountBUSDOutMin > 0) {
      ...
      zap.exchange_underlying(0, 1, amountARTHUSDInForBUSD, amountBUSDOutExpected, me);
    }
    ...
    if (amountUSDCOutMin > 0) {
      ...
      zap.exchange_underlying(0, 2, amountARTHUSDInForUSDC, amountUSDCOutExpected, me);
    }
    ...
    if (amountUSDTOutMin > 0) {
      ...
      zap.exchange_underlying(0, 3, amountARTHUSDInForUSDT, amountUSDTOutExpected, me);
    }
  ...
  function _buyARTHUSDForExact(
    ...
    if (amountBUSDIn > 0) {
      ...
      zap.exchange_underlying(1, 0, amountBUSDIn, arthUsdAmountExpected, me);
    }
    ...
    if (amountUSDCIn > 0) {
      ...
      zap.exchange_underlying(2, 0, amountUSDCIn, arthUsdAmountExpected, me);
    }
    ...
    if (amountUSDTIn > 0) {
      ...
      zap.exchange_underlying(3, 0, amountUSDTIn, arthUsdAmountExpected, me);
    }
