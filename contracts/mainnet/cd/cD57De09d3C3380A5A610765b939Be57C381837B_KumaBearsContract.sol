...
//
//     __ __                      ____                      
//    / //_/_  ______ ___  ____ _/ __ )___  ____ ___________
//   / ,< / / / / __ `__ \/ __ `/ __  / _ \/ __ `/ ___/ ___/
//  / /| / /_/ / / / / / / /_/ / /_/ /  __/ /_/ / /  (__  ) 
// /_/ |_\__,_/_/ /_/ /_/\__,_/_____/\___/\__,_/_/  /____/  
//                                                         
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1653933600;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1653915600;
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://Qmc165SEWFZRcrkKcdgx89iE1C6winDTcn7NN9V1p2VVoR/";
...
// File: contracts/KumaBearsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract KumaBearsContract is RamppERC721A {
    constructor() RamppERC721A("KumaBears", "KUMA"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/ABfyZIYEGl84BZG8mpLz/contract-metadata";
    }
}
