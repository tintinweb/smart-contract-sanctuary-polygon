...
contract PlatonicPrinters is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    string public unrevealURI = "https://platonicprinters.mypinata.cloud/ipfs/QmemNY1Ywyyvf8qymgvTxJCmdq4tcHH4AjTcWLU9zsoT8K/unrevealed.json";
    bool public reveal = false;

    bool private endSale = false;

    string private _baseURIextended = "https://ipfs.io/ipfs/";
    uint256 private _priceextended = 300000000000000000000;
    ...
    constructor() ERC721("PlatonicPrinters", "PP") {
    }
