...
contract LeChristmas is ERC721 , DefaultOperatorFilterer {
    uint256 public totalSupply;
    uint256 public cost = 0 ether;
    uint256 public maxMints = 260;
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeihu2ygmepgmj7qijbv7qqywe6o3dntym7d4xn4ogzyss6bll43dmy/", Strings.toString(tokenId), ".json")
            );
    }
