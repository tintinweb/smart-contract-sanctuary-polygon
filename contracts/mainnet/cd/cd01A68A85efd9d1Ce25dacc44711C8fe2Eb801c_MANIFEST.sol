...
contract MANIFEST is ERC721  {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeie6evvky4focqqznmlfikhp22fqs6ovbjmdqvwm23ipp2bksw727u/", Strings.toString(tokenId), ".json")
            );
    }
