...
/// @title Contract for VSFG CNY NFT 2023
...
contract VSFGCNYContract is ERC721A, Ownable {
    uint256 constant public MAX_SUPPLY = 150;
    string private baseTokenURI;

    mapping(bytes32 => bool) public tidMinted;

    constructor() ERC721A("VSFG - Year of the Rabbit NFT", "VSFGCNY2") {
        baseTokenURI = "https://dot.dttd.group/VSFGCNY2/";
        _mint(msg.sender, 1);
    }
