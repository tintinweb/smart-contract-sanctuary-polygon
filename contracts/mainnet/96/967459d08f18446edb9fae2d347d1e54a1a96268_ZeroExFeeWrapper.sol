...
// File: contracts/lib/LibOrder.sol
...
// File: contracts/ZeroExFeeWrapper.sol
...
contract ZeroExFeeWrapper is ReentrancyGuard {
  ...
  mapping(address => bool) _executors;
  ...
  {
    require(_executors[msg.sender],"Executor Addresses only");
    _;
  }

  

  function setOwner(address owner,bool enabled)
    external
    ownerOnly
  {
    _owners[owner] = enabled;
  }
