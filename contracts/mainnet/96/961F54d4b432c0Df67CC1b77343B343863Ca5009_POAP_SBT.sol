...
contract POAP_SBT is ERC721, MinterRole {
        ...
        onlyMinter(_msgSender())
    {
        ...
        _sbt.Title = "Proof Of Community By Shardeum";
        _sbt.SbtType = "Character";
        _sbt.Issuer = "EQ8 DeSoc";
        _sbt.Location = "EQ8 Estate, New Delhi";
        _sbt.DateOfIssue = "26/11/2022";
        _sbt.MembershipStatus = "Inactive";
