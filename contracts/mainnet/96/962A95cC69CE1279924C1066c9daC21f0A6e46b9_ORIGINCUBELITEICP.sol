 ...
 * @notice This contract handles minting ORIGIN CUBE (LITE-ICP) tokens.
 */
contract ORIGINCUBELITEICP is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    string public baseTokenURI =
        "ipfs://bafybeiamiruvdawu6ubqkehldl2i3f6gqvuuewjn5f4u6le2ecm2nle2tq/";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC721A("ORIGIN CUBE (LITE-ICP)", "ORGN")
        RevokableOperatorFilterer(
