...
contract Biden is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  string private hiddenMetadataUri;
    ...
    constructor() ERC721A("Biden Digital Trading Cards on Polygon", "BidenDTCP") {
        setHiddenMetadataUri("https://gateway.pinata.cloud/ipfs/QmXJRcqRGY1cjmZ83K6zgkRbq8P1QLdFVoLB1LkLkGZRuB/hidden.json");
    }
