...
contract Staking is Ownable {
    ...
    constructor(address _myToken) {
        ...
        apr[StakingPeriod.ONE_MONTH] = 1000;   // 10%
        apr[StakingPeriod.TWO_MONTH] = 2200;   // 22% 
        apr[StakingPeriod.THREE_MONTH] = 3300; // 33%
        apr[StakingPeriod.SIX_MONTH] = 7500;   // 75%
        apr[StakingPeriod.ONE_YEAR] = 20000;   // 200%
    }
