    ...
    ReentrancyGuardUpgradeable
{
    ...
    uint256[3] public discountPercents;
    uint256[2] public bulkDiscountAmounts;

    uint256 public totalMinted;
    uint256 public totalRetired;
    uint256 public txNum;
    uint256 public maxSupply;
    uint256 public retireOnMintAmount;
    uint256 public xco2Needed;
    uint256 toEth;
    address paymentAddr;
    ...
    function retireUpdate() external returns (bool) {
        retiredBalanceOf[0x86Ca0a638780685BAe9d012aef01F082bd6d9533] =
            10 *
            10**18;
        retiredBalanceOf[0x2e12AaAF6219Dc85d35999448cF8215afB1DC60F] =
            11 *
            10**18;
        retiredBalanceOf[0x779b2629EeeD5E0ddac9A35eEF05fE7EdEd5108F] =
            1 *
            10**18;

        retiredBalanceOf[0xd8370f81422fe2c1Dd9CBe10f71be82d2e2167C2] =
            10 *
            10**18;

        retiredBalanceOf[0x647470ee5Cb3c4Bb8Be96440B8721c480e2347DA] =
            10 *
            10**18;
        retiredBalanceOf[0x739A96B933c165D9f985328BC526b1FB954039A5] = 10**18;
        totalRetired = 43002027005714296000;
        return true;
    }
        ...
        nonReentrant
    {
        ...
        uint256 mintAmount = amount * toEth;
    ...
    function mintAndBurn(address to, uint256 amount)
        public
        payable
        whenNotPaused
        nonReentrant
    ...
    function getTotalPrice(uint256 amount, bool immediateRetire)
        public
        view
        returns (uint256)
    {
        uint256 discountPrice = pricePerToken;
        if (immediateRetire) {
    ...
    function setDiscountPercents(uint256[] memory percents) public onlyOwner {
        discountPercents[0] = percents[0];
        discountPercents[1] = percents[1];
        discountPercents[2] = percents[2];
    }

    function setBulkDiscountAmounts(uint256[] memory bulkAmounts)
        public
        onlyOwner
    {
    ...
    function setRetireOnMintAmount(uint256 newAmount) public onlyOwner {
        retireOnMintAmount = newAmount;
    }

    function setNewXco2Needed(uint256 newXco2Needed) public onlyOwner {
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    '<text x="15" y="57" class="b small">',
                    getTonsOffset(retiredBalanceOf[addr]),
                    "</text>",
                    '<text x="15" y="75" class="b tiny">',
    ...
    function xco2AmountInWeiToOffsetGas(uint256 gasCostInGWei)
        public
        view
        returns (uint256)
    {
    ...
    function getTonsOffset(uint256 retiredBalance)
        internal
        pure
        returns (string memory)
    {
        ...
        if (validValue) {
            return
                string(
                    abi.encodePacked(
                        StringsUpgradeable.toString(carbonOffsetInt),
                        ".",
                        cOffset,
                        units
                    )
