...
contract PaladinToken is BEP20, MinterRole {
    ...
    // In swap and liquify
    bool private _inSwapForDAI;

    // Automatic swap and liquify enabled
    bool public swapForDAIEnabled = true; // INMUTABLE
    ...
    function enableSwapTokenForDAI(bool _enabled) public onlyOperator {
        swapForDAIEnabled = _enabled;
    }
