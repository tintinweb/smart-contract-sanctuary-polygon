...
contract ERC20 is IERC20 {
    ...
    address busd = 0xa70cA4FE0B54B6F00625687fDE85F181Db055766; // live busd
    //address busd = 0xa70cA4FE0B54B6F00625687fDE85F181Db055766; // testnet busd
    IERC20 token;
...
contract OurNewToken is Token {
    
    uint private startTime = 1646326800; // March 4, 2022 1:00:00 AM
    ...
    uint8[] private REF_BONUSES             = [100, 50, 30, 10, 10, 10, 10, 10, 10, 10];
    uint private constant ADV_FEE           = 70;                   // Base 7% multipled * 7 = 49% total
    uint private constant ADV_FEESM         = 60; 
    ...
    uint public SELL_LIMIT        = 1000 ether; 
    ...
    constructor() public {
        ...
        ADMIN = msg.sender;
        DEV_1 = msg.sender;                                  // e
        DEV_2 = 0x9086446fea5b06F5365Ba720F9E7DB4196eED6Fa;  // N
        ADV_1 = 0x9086446fea5b06F5365Ba720F9E7DB4196eED6Fa;  // 0         
        ADV_2 = 0x9086446fea5b06F5365Ba720F9E7DB4196eED6Fa;  // E        
        ADV_3 = 0x9086446fea5b06F5365Ba720F9E7DB4196eED6Fa;  // o 
        ADV_4 = 0x9086446fea5b06F5365Ba720F9E7DB4196eED6Fa;  // au    
        FIN_1 = 0x9086446fea5b06F5365Ba720F9E7DB4196eED6Fa;  // S   -1
        FIND_1 = 0x9086446fea5b06F5365Ba720F9E7DB4196eED6Fa; // ll 6%
        MAR_1 = 0x9086446fea5b06F5365Ba720F9E7DB4196eED6Fa;  // DESB   6%   
    ...
    function stakeBUSD(address referrer,  uint256 _amount) public payable {
        require (block.timestamp > startTime);                // March 4, 2022 1:00:00 AM
        ...
        token.transfer(FIND_1, feesm);    // new - 6%
        token.transfer(MAR_1, feesm);     // changed 6%
