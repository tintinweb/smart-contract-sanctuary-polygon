...
contract PTZToken is ERC20 {
    string public constant name = "PETOZ Token";
    string public constant symbol = "PTZ";
    uint8 public constant decimals = 18;
    uint256 public constant initialSupply = 1930000000 * (10 ** uint256(decimals));
