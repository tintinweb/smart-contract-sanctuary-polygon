...
contract QuickSwapRestrictedStrategyWithdrawMinimizeTrading is
  OwnableUpgradeSafe,
  ...
  IStrategy
{
  ...
  modifier onlyWhitelistedWorkers() {
    require(
      ...
      "QuickSwapRestrictedStrategyWithdrawMinimizeTrading::onlyWhitelistedWorkers:: bad worker"
    );
    _;
  }
  ...
  /// @param _wftm The wrapped BNB token.
  ...
  function execute(
    ...
    IQuickPair lpToken = IQuickPair(factory.getPair(farmingToken, baseToken));
    // 2. Approve router to do their stuffs
    require(
      lpToken.approve(address(router), uint256(-1)),
      "QuickSwapRestrictedStrategyWithdrawMinimizeTrading::execute:: failed to approve LP token"
    );
    ...
    require(
      ...
      "QuickSwapRestrictedStrategyWithdrawMinimizeTrading::execute:: insufficient farming tokens received"
    );
    ...
    require(
      ...
      "QuickSwapRestrictedStrategyWithdrawMinimizeTrading::execute:: unable to reset lp token approval"
    );
