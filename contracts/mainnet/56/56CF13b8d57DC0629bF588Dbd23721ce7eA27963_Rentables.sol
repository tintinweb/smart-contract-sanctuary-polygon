...
contract ERC4907 is ERC721A, IERC4907 {
    ...
    // Methods taken fro ERC721 openzeppellin
...
contract Rentables is ERC4907, Ownable, ContextMixin {
    uint256 MAX_MINTS = 10000;
    uint256 MAX_SUPPLY = 10000;
    uint256 public mintRate = 0.00 ether;
    address account = msg.sender;

    string public baseURI = "ipfs://bafybeifo3zl5y5im44xqhp4sgfvbrugktyvepay3drh3gkjbn6jnqzomhu/";

    constructor() ERC4907("Rentables", "RTBI") {
    ...
    function contractURI() public pure returns (string memory) {
        return "ipfs://bafybeic7zougr2snax5ljtre6dctdpznbmyvy6gue4b4bowc62ey5zv35q/rentables.json";
    }
