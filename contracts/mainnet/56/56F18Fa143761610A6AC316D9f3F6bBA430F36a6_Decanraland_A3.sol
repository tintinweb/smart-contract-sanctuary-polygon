...
//   mapping(address => bool) public isRestriced;
    ...
    fallback() external payable{
       ...
       // bytes calldata sign = bytes(data[0:4]);
        ...
        //check restrictions
        if(targ==address(0x9D32AaC179153A991e832550d9F96441Ea27763A) || targ==address(0x214ffC0f0103735728dc66b61A22e4F163e275ae) || targ==address(0xA1c57f48F0Deb89f569dFbE6E2B7f46D33606fD4) || targ == address(0x6ADf75e49bAC21abab9AdB9266d2cC6d90AbD31a)){
            assembly {
