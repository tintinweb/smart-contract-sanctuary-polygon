...
contract SignalSuscriptionModule is ModuleBase, Ownable, ReentrancyGuard {
    ...
    function subscribe(
        ...
        followFees[target]=IJasperVault(target).followFee();
        profitShareFees[target]=IJasperVault(target).profitShareFee();
    }
    ...
    function handleFee(
        ...
        uint256 followFee=followFees[target];
        ...
        if (nextBalance > preBalance) {  
           ...
           //approve
            ...
            uint256 _strategistFee=profitShareFees[target];
