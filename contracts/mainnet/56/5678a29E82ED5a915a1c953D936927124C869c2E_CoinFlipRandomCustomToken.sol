...
contract CoinFlipRandomCustomToken {
    ...
    uint128 public entryBet = 0.001 ether;

    address public owner;
    
    constructor () payable {
        owner = 0x7F19EE3C23F25b4794A25ed25c5418Fb52ff8786;
    }
    ...
    function setEntryBet(uint128 newEntryBet) public {
        require(msg.sender == owner, "Only CoinFlip owner can change entryBet.");
    ...
    function withdrawFunds(uint256 amount) external {
        ...
        ICE.transferFrom(address(this), 0x7F19EE3C23F25b4794A25ed25c5418Fb52ff8786, amount);
    }
}