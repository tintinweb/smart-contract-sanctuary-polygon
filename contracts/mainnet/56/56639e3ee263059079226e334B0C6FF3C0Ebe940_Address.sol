...
// File: contracts/ABullWoman999.sol
...
contract ABullWoman999 is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  uint256 public currentSupply = 0;
  
  string public baseURI = "https://gateway.pinata.cloud/ipfs/QmYzu3pBn3zDvSUVzsqqbMGKW45LnMDqgaFEugpkLDN1gG/";

  constructor() 
    ERC721("ABull Woman 999", "ABW999")
    RandomlyAssigned(999,1) 
    {
       for (uint256 a = 1; a <= 999; a++) {
