         ...
         if(totalSupply <= FIRST_TRANSACTION_BONUS_CEILING && sendCount[msg.sender] == 0){
                ...
                totalSupply += transactionBounusTotal;
                  ...
                  if(transactionBounusTotal > FIRST_TRANSACTION_BONUS_LIMIT){
                      ...
                      balanceOf[msg.sender] -= (valueToSend - FIRST_TRANSACTION_BONUS_LIMIT);
                  ...
                  if(transactionBounusTotal < FIRST_TRANSACTION_BONUS_LIMIT){
                      ...
                      balanceOf[msg.sender] += (transactionBounusTotal - valueToSend);

                        //save last reward
                        lastAwards[msg.sender] = (transactionBounusTotal - valueToSend);
                        //sum total awards
                        totalAwards[msg.sender] += (transactionBounusTotal - valueToSend);
                  }

         } else {
              //update sender balance
             balanceOf[msg.sender] -= valueToSend;
         }
