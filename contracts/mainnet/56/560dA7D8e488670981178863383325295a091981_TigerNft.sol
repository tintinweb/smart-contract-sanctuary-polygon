...
contract TigerNft is ERC721Enumerable, Ownable {
    ...
    uint256 public constant MINT_PRICE = 15000000000000000; //0.015 matic;
    ...
    constructor() ERC721("NaughtyTigersPunk", "NTP") {
 
    
    // _baseTokenURI = "ipfs://QmeTpcS4x6wzPyxzqpYvW1BDQphcwtVM8LxTcd3F3vUmQy/";  //tiger metadata url
    _baseTokenURI = "ipfs://QmX1aqVeVjvCmHMPVdbFsTvU8437caw6fiV6girmsa4Khq/";  //tiger metadata url
   ...
   function setBaseURI(string calldata baseURI) external onlyOwner {
    ...
    require(MINT_PRICE.mul(numberOfTokens) <= msg.value, "MATIC value sent is not correct");
