...
contract CreateNFT is ERC721URIStorage {
  ...
  function mint(uint256 _unity, address _address, string memory metadataURI) public payable {
    uint256 supply = totalSupply;

    require(supply <= maxSupply);

    invites.push(
      Invite(_unity, _address, metadataURI)
    );
    ...
    _setTokenURI(_unity, metadataURI);
  }
