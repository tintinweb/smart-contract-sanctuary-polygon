...
/**
 * @title DfynLiquidityBridge
 * @author DeFi Basket
 *
 * @notice Adds/removes liquidity using the DfynLiquidityBridge contract in Polygon.
 *
 * @dev This contract adds or removes liquidity from DfynLiquidityBridge through 2 functions:
 *
 * 1. addLiquidity works with 2 ERC20 tokens
 * 2. removeLiquidity works with 2 ERC20 tokens
 *
 */
contract DfynLiquidityBridge is IUniswapV2Liquidity {

    address constant public routerAddress = 0xA102072A4C07F06EC3B4900FDC4C7B80b6c57429;
    address constant public factoryAddress = 0xE7Fb3e833eFE5F9c441105EB65Ef8b261266423B;
