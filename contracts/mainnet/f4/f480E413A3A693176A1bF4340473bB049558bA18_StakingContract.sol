...
// High Yield Addy Farming on Polygon Chain
...
contract StakingContract is ReEntrancyGuard{
    ...
    address public _link = 0xc3FdbadC7c795EF1D6Ba111e06fF8F16A20Ea539;
    IERC20 token = IERC20(_link);
    address public owner;

    address payable public devwalletAddress = payable(0x73aaDA92809A2E79D876930F2136407fCB78C3f5);
