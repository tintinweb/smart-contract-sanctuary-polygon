...
contract TGCERC721A is Ownable, ERC721A, PaymentSplitter {
    ...
    uint256 public ogSalePrice = 7 ether;
    uint256 public wlSalePrice = 10 ether;
    uint256 public publicSalePrice = 13 ether;
    ...
    ) ERC721A("TGCERC721A", "TGC") PaymentSplitter(_team, _teamShares) {
    ...
    function setMaxAmountMint(uint256 _maxAmountMint) external onlyOwner {
        maxAmountMint = _maxAmountMint;
    }
