...
// File: contracts/Ranghmar`s Deadman Warrior.sol
...
contract NFT is ERC721Enumerable, Ownable {
  ...
  uint256 public maxSupply = 9000; //тут пишите общее количество нфт в вашей коллекции
  uint256 public maxMintAmount = 9000;  // то количество нфт которое будет сминчено вместе с деплоем смарт контракта 
