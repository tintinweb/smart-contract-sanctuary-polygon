...
// File: contracts/RulersOfTheSky.sol

pragma solidity >= 0.8.0 < 0.9.0;

contract RulersOfTheSky is ERC721A, Ownable, ReentrancyGuard {
  ...
  address public parentAddress = 0x52a8811591EB6bb6380e9F349b27b7dF1d33fFB8;
  Moondust MoondustContract = Moondust(parentAddress);

  constructor() ERC721A ( "Rulers of the Sky", "RTS" ) {
    setUriPrefix( "ipfs://CID/" );
  }
