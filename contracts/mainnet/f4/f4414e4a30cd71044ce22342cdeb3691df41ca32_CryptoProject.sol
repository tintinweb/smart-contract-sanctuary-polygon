...
contract CryptoProject is ERC721A, Ownable,ReentrancyGuard{
    ...
    constructor(address payable _withdrawalAddress) ERC721A("Crypto Web3 Genesis", "CW",MAX_PER_ADRESS_PUBLIC_MINT,MAX_SUPPLY) {
    ...
    function mint() external payable nonReentrant callerIsUser{
        ...
        require(msg.value >= (SALE_PRICE), "CryptoProject :: Payment is below the price");
