...
import "./interfaces/INewNODERewardManagement.sol";
...
contract NodeHelper is Ownable {
    ...
    address public PENT = 0x283366bb42ef49a994913BAF22263c6562e588a4;

    address public vault = payable(0xE339CF3C5034bc4A07A70467460295c3a0638aAA);
    address public rewardsPool = payable(0x095b511Cdc59bd14361050730BC3ff693709beb1);
    address public treasury = payable(0x064a4fB29a53b8B0ffEC43C1dFD38F18B29a286a);
    ...
    uint256 public swapTokensAmount = 3000000000000000000;
    ...
    constructor(
        ...
        nodeRewardManagement = INewNODERewardManagement(0x54d9f7964de09EEdbFE2d16B8337aCa050A129e4);

        require(uniV2Router != address(0), "ROUTER CANNOT BE ZERO");
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(uniV2Router);

        uniswapV2Pair = 0x01b758b406FB0F4e36C95DFBc909763D7080e5B4;
	...
	function withdrawStakingPosition(uint256 index) public {
        ...
        uint256 amount = nodeRewardManagement.withdrawAmount(account, index);
	...
	function createNodeWithStakePosition(string memory name, uint256 stakeDays, uint256 _type) public {
        ...
        IERC20(PENT).transferFrom(sender, address(this), nodePrice + nodeFee);
    ...
    function _createNodeWithTokens(string memory name, uint256 _type, bool isFusion) private {
        ...
        uint256 paidAmount = nodeRewardManagement._compoundForNode(sender, nodePrice, _type, isFusion);
...
interface INewNODERewardManagement {
    ...
    function withdrawAmount(address account, uint256 index) external view returns(uint256);
