...
// File: contracts/NFTsLatam_contract.sol
...
contract NFT_Latam_test is 
    ...
    bytes32 private constant MODULE_TYPE = bytes32("NFT_Latam_Carla");
    ...
    constructor(        
       ...
       // Initialize inherited contracts, most base-like -> most derived.
        ...
        __EIP712_init("NFT_Latam_Carla", "2");
    ...
    function collectPrice(MintRequest memory _req) internal {
        ...
        (address nlFeeRecipient, uint256 nlFeeBps) = nftslatamFee.getFeeInfo(address(this), FeeType.PRIMARY_SALE);
        ...
        CurrencyTransferLib.transferCurrency(_req.currency, _msgSender(), nlFeeRecipient, nlFee);
