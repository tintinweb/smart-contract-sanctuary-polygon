...
contract NameAndPublicKeyDirectory is INameAndPublicKeyDirectory{
    ...
    function deleteMyAvatar () public {
        delete userAvatarNFTContractToAddress[msg.sender];
        delete userAvatarTokenIdToAddress[msg.sender];
    }
    
    function deleteMyUserName () public {
