...
contract MhkGk is ERC721 {
    ...
    uint256 public wlMaxMints = 1000;
    uint256 public whitelistCost = 10 ether;
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeihbwtupfcnvxu7madspoxvxklijxx2jjspra7hpnyruo52kl6qllm/", Strings.toString(tokenId), ".json")
            );
    }
