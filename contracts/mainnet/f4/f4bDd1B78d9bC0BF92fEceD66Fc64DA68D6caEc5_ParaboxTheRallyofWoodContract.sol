...
//*********************************************************************//
//
//   _____                _                   _______ _            _____       _ _                __  __          __             _ 
//  |  __ \              | |              _  |__   __| |          |  __ \     | | |              / _| \ \        / /            | |
//  | |__) |_ _ _ __ __ _| |__   _____  _(_)    | |  | |__   ___  | |__) |__ _| | |_   _    ___ | |_   \ \  /\  / /__   ___   __| |
//  |  ___/ _` | '__/ _` | '_ \ / _ \ \/ /      | |  | '_ \ / _ \ |  _  // _` | | | | | |  / _ \|  _|   \ \/  \/ / _ \ / _ \ / _` |
//  | |  | (_| | | | (_| | |_) | (_) >  < _     | |  | | | |  __/ | | \ \ (_| | | | |_| | | (_) | |      \  /\  / (_) | (_) | (_| |
//  |_|   \__,_|_|  \__,_|_.__/ \___/_/\_(_)    |_|  |_| |_|\___| |_|  \_\__,_|_|_|\__, |  \___/|_|       \/  \/ \___/ \___/ \__,_|
//                                                                                  __/ |                                          
//                                                                                 |___/                                           
//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x77c47e801a82De4f5E1D9d20976d48425c68B890];
  address public erc20Payable = 0x77c47e801a82De4f5E1D9d20976d48425c68B890;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  uint256 public PRICE = 1.69 ether;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 69, 3333) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeigjvhcvbnf73rsuotcdylhqd7zptrkcgfvnbd5hjdddo4tweydwvq/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/yoCSABWRHeiW8GmKdLjM/contract-metadata";
  }
...
// File: contracts/ParaboxTheRallyofWoodContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ParaboxTheRallyofWoodContract is ERC721APlus {
    constructor() ERC721APlus("Parabox The Rally of Wood", "BOX"){}
}
