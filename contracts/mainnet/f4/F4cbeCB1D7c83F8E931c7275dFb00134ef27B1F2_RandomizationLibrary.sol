...
contract RandomizationLibrary {
  ...
  function easySimulateBinomial(uint256 seed) external view returns (uint256 value) {
  ...
  function getRandomNumber(uint256 seed) public view returns (uint256 value) {
    value = uint256(keccak256(abi.encode(msg.sender, seed, "RANDOM_ASS_STRING")));
  }
}
