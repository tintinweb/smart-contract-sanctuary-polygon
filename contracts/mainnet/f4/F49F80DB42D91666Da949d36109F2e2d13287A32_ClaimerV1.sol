...
contract ClaimerV1 is Context, Ownable, Pausable, AccessControlEnumerable, ERC1155Receiver {
    ...
    function claimTo(
        ...
        _useAllowance(beneficiary, code, signature);
    ...
    function withdraw(uint256 tokenId, uint256 amount) external whenNotPaused {
    ...
    function validateSignature(
        ...
        require(usedAllowances[message] == false, "ClaimerV1: Signature already used");
        require(claimedCode[keccak256(abi.encodePacked(code))] == false, "ClaimerV1: Code has already claimed");
        require(claimedAddresses[account] == false, "ClaimerV1: Address has already claimed");
   ...
   * @dev Pauses contract
    ...
    function pause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "ClaimerV1: must have pauser role to pause");
        _pause();
    }
    ...
    function unpause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "ClaimerV1: must have pauser role to unpause");
        _unpause();
    }
