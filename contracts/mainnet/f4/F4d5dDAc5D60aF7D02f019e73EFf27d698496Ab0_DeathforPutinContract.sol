    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 96) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeicmvxksfxeo546tr7acsx5k5a7enh7nnhmtmsodjfatqhqusy75hm/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/S6J4opazu7y8WLlAZui5/contract-metadata";
  }
...
// File: contracts/DeathforPutinContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DeathforPutinContract is RamppERC721A {
    constructor() RamppERC721A("Death for Putin", "DFP"){}
}
