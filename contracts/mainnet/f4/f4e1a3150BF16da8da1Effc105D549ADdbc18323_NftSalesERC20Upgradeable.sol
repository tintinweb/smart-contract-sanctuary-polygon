    ...
    ERC721BaseUpgradeable
{
    ...
    event SetNftType(uint32 indexed nftId, uint32 indexed nftType, address indexed user);
    ...
    function _assignNftTypeFiltered(
        ...
        for (uint256 x; x < nftIDs.length; x++) {
            ...
            emit SetNftType(nftIDs[x], nftTypes[x], ownerOf(nftIDs[x]));
        }
    }
...
/*     function _incrementNftTypeCountForAddress(
    ...
    function _mintAndAssignNftType(
        ...
        emit SetNftType(id, nftType, ownerOf(id));
        return id;
    }
