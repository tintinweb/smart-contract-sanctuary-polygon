...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [0x7bbC6f19f0d06300d98742813f2d73729Dc170fC];
...
// File: contracts/DontGetOutTheDoorContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract DontGetOutTheDoorContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Dont GET Out The Door";
    string public symbol = "GETIN";
