...
contract Gaia is ERC721Enumerable, Ownable {
  using Strings for uint256;
  
  string[] public wordsValues = ["MINERVA","HEPHAESTUS","AETHER","POSEIDON","DEMETER","ARTEMIS","ELEUTHIA","APOLLO","HADES","HADES (CORRUPTED)","ELEUTHIA (CORRUPTED)"];
  ...
  constructor() ERC721("GAIA MOTHER EARTH AI", "GAIA") {}
  ...
  function mint() public payable {
    ...
    Word memory newWord = Word(
        string(abi.encodePacked('AI #', uint256(supply + 1).toString())), 
        "GAIA was tasked with ending the Faro Plague and starting life anew on planet earth",
