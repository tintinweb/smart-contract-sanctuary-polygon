...
contract MagicalGoatLand is ERC721, ERC721URIStorage, ERC721Burnable, Ownable, EIP712, ERC721Votes {
    ...
    function setSecondaryImageURI(uint256 tokenId, string memory uri) public onlyOwner {
    require(_exists(tokenId), "ERC721: token does not exist");
    _setTokenURI(tokenId, uri);
    }

    function _baseURI() internal pure override returns (string memory) {
        return "https://ipfs.io/ipfs/QmT54oUziAjA1qruZ2RRTHpsvv4yVCj2TnD6NHYi1geRby";
    }
