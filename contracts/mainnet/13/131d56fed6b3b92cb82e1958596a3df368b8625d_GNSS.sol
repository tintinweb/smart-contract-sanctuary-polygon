...
contract GNSS is GNSSDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private GNSSTeam;
    address private CharityGNSS;
    ...
    string public override name = "GNSS";
    string public override symbol = "GNSS";
    ...
    constructor(uint totalSupplyValue, address GNSSTeamAddress, address CharityGNSSAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        GNSSTeam = GNSSTeamAddress;
        CharityGNSS = CharityGNSSAddress;
        
        // split the tokens according to agreed upon percentages
        balances[GNSSTeam] =  totalSupply * 4 / 100;
        balances[CharityGNSS] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's GNSSTeam pot
