...
contract DistrictPower is ReentrancyGuard, Bucket {
    ...
    address public tokenAddress = 0xa9347B437966a2dd53EF72745B2F627eEbf08a4F;
    address public maticAddress = 0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889;
    uint256 public positionId = 891049;
    uint256 public lpMaticAmount;
    uint256 public lpMaticLimit = 500000 * ACCURACY;
    ...
    uint256 public startUseTokenNum = 25000000 * ACCURACY;
    ...
    function setPosition (
...

        {
            ...
            }else if(expiryTime >= (openTime + 40 * TIME_UNIT)){
                nowInvestReturnRate = 9500;
    ...
    function useRewardsEligibility(
        ...
        require(positionInfo.lossAmountExist == true, "absent lossAmount");
        require(positionInfo.stopLossTime + TIME_UNIT > block.timestamp, "Eligibility timeout");
        UserGlobalInfo storage userGlobalInfo = userGlobalInfos[msg.sender];
