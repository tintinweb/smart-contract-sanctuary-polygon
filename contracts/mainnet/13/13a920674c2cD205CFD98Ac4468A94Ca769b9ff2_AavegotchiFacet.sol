...
// File: contracts/interfaces/IAavegotchi.sol
...
// File: contracts/facet/AavegotchiFacet.sol
...
contract AavegotchiFacet is Modifiers {
    ...
    function spendSkillPoints(uint256 _tokenId, int16[4] calldata _values) public whenNotPaused{
        ...
        require(s.deposits[im_diamondAddress][_tokenId] == msg.sender, "spendSkillPoints: not gotchi depositor");
