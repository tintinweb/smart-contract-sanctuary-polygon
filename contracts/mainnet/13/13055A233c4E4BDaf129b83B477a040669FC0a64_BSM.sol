...
contract BSM is IERC20, Ownable {
    ...
    // swap and send fees ( initially matic can change later)
    address public SWAPTOKEN = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270;
    address public REWARD = 0xdAb529f40E671A1D4bF91361c21bf9f0C9712ab7;
    ...
    uint256 public buyShillerFee = 0;
    ...
    uint256 public sellShillerFee = 0;
    uint256 public sellDevFee = 1;
    uint256 public sellBurnFee = 0;
    uint256 public sellTotalFees = 9;

    address public marketingFeeReceiver = 0x1F18155C8bE75a765f4c5F4935e8B69b08167516;
    address public shillerFeeReceiver = 0xb371097bc7AAAa92614E75209e8e0eECB7D560c7;
    address public devFeeReceiver = 0x60AC5cf786B745aa2Af5c108c4d3f72C76991316;
    address public liquidFeeReceiver = 0x60AC5cf786B745aa2Af5c108c4d3f72C76991316;
    ...
    function switchToken(address rewardToken, bool isIncludeHolders)
        ...
        onlyOwner
    {
        require(rewardToken != WMATIC, "Can not reward MATIC in this tracker");
        REWARD = rewardToken;
    ...
    function swapBackInMatic() internal swapping {
        ...
        // get swapped matic amount
        uint256 swappedMaticAmount = address(this).balance;

        uint256 totalSwapFee = buyMarketingFee.add(buyShillerFee).add(buyDevFee);
        uint256 marketingFeeMatic = swappedMaticAmount.mul(buyMarketingFee).div(totalSwapFee);
        uint256 shillerFeeMatic = swappedMaticAmount.mul(buyShillerFee).div(totalSwapFee);
        uint256 devFeeMatic = swappedMaticAmount.mul(buyDevFee).div(totalSwapFee);
        // calculate reward matic amount
        if (tokensToReward > 0) {
