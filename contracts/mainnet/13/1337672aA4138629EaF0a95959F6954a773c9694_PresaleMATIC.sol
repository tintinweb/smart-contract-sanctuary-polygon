...
contract PresaleMATIC is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable, PausableUpgradeable {
  ...
  function initialize(address _usdt, address _usdc, address _oracle) external initializer {
