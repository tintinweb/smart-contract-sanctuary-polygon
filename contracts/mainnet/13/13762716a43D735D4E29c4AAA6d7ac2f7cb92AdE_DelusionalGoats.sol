// SPDX-License-Identifier: MIT
    ...
    contract DelusionalGoats is ERC721, Ownable, ERC721Enumerable {
      using SafeMath for uint256;
      using Strings for uint256;
    
      uint256 public  tokenPrice = 40000000000000000000; 
      uint256 public  maxTokenPurchase = 100;
      ...
      constructor() ERC721("DelusionalGoats", "DGN") {}
        ...
        returns (string memory)
      {
        ...
        if (isRevealed == false) {
          return
            "ipfs://QmdsXTWHrofBjZnqVTXVw6Xw2tyiGPKxzM6p4ZTV9ttJgc/gizli.json";
        }
