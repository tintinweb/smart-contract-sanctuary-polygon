...
contract PreSale is Operator, ReentrancyGuard {
    ...
    mapping(address => uint256) userCommittedAmount;
    ...
    uint256 public constant MIN_DISTRIBUTION = 1 ** 6; // Min buy 1 usdc
    uint256 public constant MAX_DISTRIBUTION = 5000 * 10 ** 6; // Max buy 5000 usdc
    ...
    function initializing(
        ...
        require(startTime > block.timestamp, "Invalid time");
        require(xShare != address(0), "Invalid address");
    ...
    function claimToken() public nonReentrant presaleEnded nonContract{
        ...
        uint256 xShare_claimable = committed_amount * xSharePerUsdc;
