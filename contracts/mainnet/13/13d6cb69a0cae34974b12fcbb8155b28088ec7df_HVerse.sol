...
contract HVerse is ERC721, Ownable {
  ...
  constructor() ERC721("HVerse", "HVS") {
    setHiddenMetadataUri("ipfs://QmfACrh456LsCCE5ZUcW9WJoFtecTJQMhC93VhtykQcXTa/hidden.json");
    buildings.push(Building("ZERO", 0,0,0,0,0,0));
    buildings.push(Building("House", 1,3,3,2,0,3));
    ...
    buildings.push(Building("House", 1,3,3,-4,0,4));
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x7bA99c44296897874c3b332cf563EE3c7DB57C90).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
