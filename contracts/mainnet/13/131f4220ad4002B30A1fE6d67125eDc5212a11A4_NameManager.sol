...
// File: contracts/nameManager/NameManagerAccessControl.sol

pragma solidity ^0.8.0;


abstract contract NameManagerAccessControl is AccessControl {
    ...
    address internal handler = 0xfEf4A089fd701f74bdEd986d0C43504e0EF6cF68;

    bool public isPaused;

    modifier whenNotPaused {
        require(!isPaused, "Wonder Game Character Name Manager is paused");
        _;
    }
...
// File: contracts/nameManager/NameManager.sol

pragma solidity ^0.8.0;


contract NameManager is  NameManagerAccessControl{

    mapping(uint256 => string) public tokenName;
    mapping(string => bool) public  isNameUsed;
    mapping (string => string) public uniqueName;
    ...
    function setNameStatus(string memory _name,bool _status) external  onlyRole(HANDLER_ROLE){
        isNameUsed[_name] = _status;
    }
    ...
    function setTokenName(uint256 _tokenId, string memory _name, string memory _uniqueName) public whenNotPaused onlyRole(HANDLER_ROLE) {
        require(!isNameUsed[_uniqueName], "Name already used");
        isNameUsed[_uniqueName] = true;
        isNameUsed[uniqueName[tokenName[_tokenId]]] =false;
        uniqueName[_name] = _uniqueName;
