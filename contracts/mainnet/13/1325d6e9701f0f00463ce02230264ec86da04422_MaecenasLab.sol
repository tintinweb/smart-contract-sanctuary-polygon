...
/**
 *Submitted for verification at Etherscan.io on 02-2022
*/
...
contract MaecenasLab  is ERC721Enumerable, Ownable
{
    ...
    uint256 [] public winIds;

    constructor() ERC721("MaecenasLab", "MAL")  {
        setBaseURI("https://gateway.pinata.cloud/ipfs/QmTERXbVRaJ9wLiHUxe6LkghQkPLQZKTj2GMAiRmXHaWHf/");
    }

    function SetWinIds(uint256[] memory arrofaddress) public onlyOwner{
        winIds=arrofaddress;
    }
    function GetWinIds() public view returns(uint256[] memory){
        return winIds;
    }
