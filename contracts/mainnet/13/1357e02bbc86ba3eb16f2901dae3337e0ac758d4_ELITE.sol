...
// File: https://github.com/Fredohu/ELITE/blob/main/ETE.sol
...
contract ELITE is ERC20, ERC20Burnable, Ownable {
  ...
  uint256 constant MAXIMUMSUPPLY=9000000*10**18;

  constructor() ERC20("ELITE", "ETE") { 
...
// File: contracts/apeboyselitestaking.sol
...
contract WEAStaking is Ownable, IERC721Receiver {
  ...
  mapping(uint256 => Stake) public vault; 
   ...
   constructor(ERC721Enumerable _nft, ELITE _token) { 
    nft = _nft;
    token = _token;
  }
