...
contract DexInvestorFacet is Modifiers, ReentrancyGuard {
    ...
    */
    function issueFromDexCalldata(
        ...
        if (LibReferralToken.isReferralToken(_addr) && !LibReferralToken.isAllowedInvestor(_addr, msg.sender)) {
            LibReferralToken.diamondStorage().tokenSettings[_addr].allowedInvestors[msg.sender] = true;
        }
