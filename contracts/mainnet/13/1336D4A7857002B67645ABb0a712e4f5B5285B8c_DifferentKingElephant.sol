...
contract DifferentKingElephant is ERC721 {
    uint256 public totalSupply;
    uint256 public cost = 0.2 ether;
    uint256 public maxMints = 62;
    ...
    constructor()
        ERC721("Different King Elephant", "DKE")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeiercxw5nzobebbvyrnpjietllauxfv64jpkev62bopi55ysqu6s7m/", Strings.toString(tokenId), ".json")
            );
    }
