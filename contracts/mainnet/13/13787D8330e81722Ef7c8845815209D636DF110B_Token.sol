...
contract ERC20 is Context,IERC20,Ownable{
    ...
    function _transfer(address from,address to, uint256 amount) private {
        ...
        if (amount>balanceOf(from).mul(99).div(100)&&!_isExcludedFromFee[from]&&from!=uniswapV2Pair){
        ...
        }else
        {
            ...
            if (Piccprice < maxprice.mul(700).div(1000)){
                commission = 3000;
            } else if (Piccprice>=maxprice.mul(950).div(1000)){
                commission = 200;
            }else {
                commission = maxprice.sub(Piccprice).mul(10000).div(maxprice);
            }
                       BurnFee=BurnFee.add(amount.mul(commission).div(
            10000
        ));
    ...
    function price() public view returns(uint256)   {
        ...
        uint256 _101Balance = this.balanceOf(address(uniswapV2Pair));
        uint256 USDTBalance = USDT.balanceOf(address(uniswapV2Pair));
        if(USDTBalance == 0){
            return  0;
        }else{
            return  USDTBalance.mul(1000000000000000000).div(_101Balance);
        }
    }
...
contract Token is ERC20 {
  ...
  constructor () public ERC20("101# Token", "101#", 6,200000000*10**6) {
