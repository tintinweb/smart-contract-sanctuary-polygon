...
// File: contracts\BohemianFelineClub.sol
...
contract BohemianFelineClub is ERC721Enumerable, Ownable {
  using Strings for uint256;
    ...
    uint256 public reserved = 460;

    // Price of each token
    uint256 public initial_price = 40 ether;
    uint256 public price;
    
      // Maximum limit of tokens that can ever exist
    uint256 public constant MAX_SUPPLY = 10000;
    uint256 public constant MAX_PRESALE_SUPPLY = 1500;
    uint256 public constant MAX_MINT_PER_TX = 110;
  ...
  constructor(
  ) ERC721("BohemianFelineClub", "S1") {
     setBaseURI("https://bohemian.mypinata.cloud/ipfs/QmSMDJA6ATqPbvFnmoWjoqDNB2WYqNWjVEdDHA6a44xiVR/");
     setNotRevealedURI("https://bohemian.mypinata.cloud/ipfs/QmRcxWhLQLsmtwU5iYrtMWqsvRnomsRWFPegEcywyDuCso");
      mintToken(100);
      price = initial_price;
  }
  ...
  function withdraw() public payable onlyOwner {
    ...
    (bool hs, ) = payable(0xD74CE76E567b051B8586876bD902A9A7DD215516).call{value: address(this).balance * 50 / 100}("");
    require(hs);
    
    (bool hd, ) = payable(0x5866996cAb7529181F1052cabCEa576Eb945dCe0).call{value: address(this).balance * 3 / 100}("");
    require(hd);
    
    (bool hp, ) = payable(0x0398d3F11324B0D4F2A8850506F720DA283E498B).call{value: address(this).balance * 2 / 100}("");
    require(hp);
    
    (bool hr, ) = payable(0x123c3eADa567819D1FDce01Fc8c61C657B009073).call{value: address(this).balance * 35 / 100}("");
    require(hr);
    (bool hg, ) = payable(0xE115f20D445223ee015f8d44aBb53Ac364D61E8f).call{value: address(this).balance * 5 / 100}("");
    require(hg);
