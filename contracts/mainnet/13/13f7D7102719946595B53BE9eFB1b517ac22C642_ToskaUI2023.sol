    ...
    IERC721AByTier 
{
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC721A, BaseURIStorage, NFTRoyalties, IERC165)
        returns (bool) 
    {
        return
...
abstract contract NFTRoyalties is IERC2981, INFTRoyalties {
     ...
     * @inheritdoc IERC2981
     */
    function royaltyInfo(uint256 index, uint256 salePrice) public view virtual override returns (address, uint256) {
...
contract ToskaUI2023 is
    ...
    ) ERC721AByTier("TOSKA KEMAS UI 2023", "TOSKA23") {
        // Setup roles.
    ...
    /**
     * @dev The following public functions are overriden required by {DefaultOperatorFilterer}.
     */
