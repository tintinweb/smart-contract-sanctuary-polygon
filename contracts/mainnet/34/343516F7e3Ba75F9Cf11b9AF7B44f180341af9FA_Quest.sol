    ...
    EIP712Upgradeable
{
    ...
    function claim(
        ...
        require(!claimed[questId][msg.sender], "Quest: already claimed");
        require(
            SignatureChecker.isValidSignatureNow(
                signerAddress,
                _hash(questId, rewardCoin, rewardAmount, msg.sender),
                _signature
            ),
        ...
        emit Claimed(questId, rewardCoin, rewardAmount, msg.sender);
    }
