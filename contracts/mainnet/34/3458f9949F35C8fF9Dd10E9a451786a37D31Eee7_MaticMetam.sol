...
contract MaticMetam {
  ...
  uint256 constant public INVEST_MIN_AMOUNT = 2 ether; // 3 MATIC
  ...
  uint256 constant public MAX_HOLD_PERCENT = 35; //3.5%
  uint256 constant public MIN_HOLD_PERCENT = 40; //0.4%
