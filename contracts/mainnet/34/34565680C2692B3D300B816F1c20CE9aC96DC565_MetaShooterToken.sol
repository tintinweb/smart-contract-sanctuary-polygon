...
contract MetaShooterToken is Context, IBEP20, Ownable, LGEWhitelisted {
    ...
    */
    ...
    /// Public Sale 15.80%
    uint256 constant public seedTokens = 15010000000000000000000000; // 2 580 000 * 10**18

    /// Public Sale 1 14.80%
    uint256 constant public publicSale1Tokens = 14060000000000000000000000; // 2 580 000 * 10**18

    /// Public Sale 2 1.00%
    uint256 constant public publicSale2Tokens = 950000000000000000000000; // 2 580 000 * 10**18
    ...
    function generateVestedTokens() public onlyOwner {
        generateTeamTokens();
