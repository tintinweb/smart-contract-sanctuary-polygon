...
contract vvcx is ERC721 {
    ...
    function mint() external payable {
        ...
        if (totalSupply + 1 > 10) revert SoldOut();
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeibdwk7cs22sxxv2265pojqbgmhj5vorjvmsb5tgnwkvieyfdjjcie/", Strings.toString(tokenId), ".json")
            );
    }
