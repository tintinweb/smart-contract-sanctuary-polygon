...
contract IWinMatic {
    ...
    constructor() public {
        ...
        aggregator = 0x7306206b5e0AA079fbe99e5F63a70c3E5103020A;
        aggregator2 = 0x5b1a8BD87e4F82E22e4F01Caf159ff9C2B0252e6;
        aggregator3 = 0xBFcC75fC344f9B1e18b5fd8bD0063758EB8Bc825;
        aggregator4 = 0xd134ed00EBe387fDC75864547694320Af3D00d3F;
    ...
    function deposit(address _referer) public payable{
        ...
        aggregator2.transfer(msg.value.mul(2).div(100));
    ...
    function nonWorkingWithdraw() public{
        User storage user = users[msg.sender];
        require(user.totalInvestment>0, "Invalid User!");
        uint256 nextPayout = (user.lastNonWokingWithdraw>0)?user.lastNonWokingWithdraw + 10 days:deposits[msg.sender][0].depositTime;
