...
contract SeaWorld is ERC721, ContextMixin {
    using SafeMath for uint256;

    uint256 private constant TOTAL_SUPPLY = 102;
    ...
    constructor() ERC721("SeaWorld", "SEAWRLD") {
    ...
    function _baseURI() internal view virtual override returns (string memory) {
        return "https://ipfs.io/ipfs/bafybeicoasjtys7ogqd5gyq5izczajo5itfbqnuwvz6yokkajsmnnu5xi4/";
    }
