...
contract TreasuryManager {
    ...
    function holdFundsToStartGame(address _player, address _tokenContract, uint256 _ante) internal {
        ...
        treasuryContract.debitPlayerBalance(_player, _tokenContract, _ante);
        treasuryContract.creditPlayerHold(_player, _tokenContract, _ante);
        treasuryContract.debitHouseBalance(_tokenContract, _ante * 2);
        treasuryContract.creditHouseHold(_tokenContract, _ante * 2);

    }

    function holdFundsForGotoWar(address _player, address _tokenContract, uint256 _ante, uint256 _sideBet) internal {
        
        treasuryContract.debitPlayerBalance(_player, _tokenContract, _ante + _sideBet);
        treasuryContract.creditPlayerHold(_player, _tokenContract, _ante + _sideBet);
        treasuryContract.debitHouseBalance(_tokenContract, _sideBet * 10);
        treasuryContract.creditHouseHold(_tokenContract, _sideBet * 10);
    }
    ...
    function refund(address _player, address _tokenContract, uint256 _playerAmount, uint256 _houseAmount) internal {
        ...
        treasuryContract.debitPlayerHold(_player, _tokenContract, _playerAmount);
    ...
    function singlePlayerPayout(
        ...
        treasuryContract.debitHouseHold(_singlePlayerPayoutArgs._tokenContract, _singlePlayerPayoutArgs._houseReleaseAmount);
        ...
        require(
            treasuryContract.playerHolds(_singlePlayerPayoutArgs._player, _singlePlayerPayoutArgs._tokenContract) >= _singlePlayerPayoutArgs._playerReleaseAmount,
        ...
        treasuryContract.debitPlayerHold(_singlePlayerPayoutArgs._player, _singlePlayerPayoutArgs._tokenContract, _singlePlayerPayoutArgs._playerReleaseAmount);
