...
contract RFI is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 50,000 RFI
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("Rfi Finance", "RFI") {
        _mint(msg.sender, 500 ether); // mint 500 RFI for initial pools deployment
