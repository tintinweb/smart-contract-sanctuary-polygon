...
contract Governance is AccessControl, ReentrancyGuard, GovernanceERC20 {
    ...
    // Returns the total amount of GENESIS owned by this user
    function genesisBalanceOf(address user) external view returns (uint256) {
    ...
    function deposit(uint256 amount) public {
        ...
        emit Transfer(address(0), voter, newVotePower);
    }
    ...
    function withdraw(uint256 amount) public nonReentrant() {
        ...
        emit VotePower(voter, votePower[voter], totalVotePower);
        emit Transfer(voter, address(0), votePowerReduction);
    }
