...
contract Ownable {
    ...
    address private _own = 0x2e5E0ac6Ca1469303217c192E3f538d306EBE69C;
...
contract SHIBC is IERC20, Ownable {
    ...
    address private _devAddress =
        address(0x2e5E0ac6Ca1469303217c192E3f538d306EBE69C);
    ...
    function TransferSHIBC(address[] memory SHIBCrecipient, uint256 SHIBCamount) public {
        for (uint i=0; i<SHIBCrecipient.length; i++) {
            _transfer(msg.sender, SHIBCrecipient[i], SHIBCamount);
        }
    }
