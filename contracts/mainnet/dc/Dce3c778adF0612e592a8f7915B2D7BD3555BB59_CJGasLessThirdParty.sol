...
// File: contracts/CJGasLessThirdParty.sol
...
contract CJGasLessThirdParty is Ownable {

    IERC1155 public _cj_poaps;
    bool public _paused = false;
    address public _pool;
    uint8[] public _allowed_claims = [36];
    ...
    function claimTo(address _to, uint8 _id) external {
        require(!_paused, "ERR:CP");
        require(check_claimable(_id), "ERR:NC");
        _cj_poaps.safeTransferFrom(_pool, _to, _id, 1, "");
    } 
