...
contract hakiOfficialCollection is ERC721Enumerable, Ownable {
  using Strings for uint256;

  string baseURI;
  string public baseExtension = ".json";
  uint256 public cost = 1 ether;
  uint256 public maxSupply = 2000; // AQUI VA EL NUMERO DE NFT DE LA COLECCION
  uint256 public maxMintAmount = 1000; // EL MAXIMO Q SE PUEDE MINTEAR X VEZ
  bool public paused = false; // SI ESTA ACTIVADA O NO EL MINT
  bool public revealed = true; // SI ESTA OCULTA O NO
