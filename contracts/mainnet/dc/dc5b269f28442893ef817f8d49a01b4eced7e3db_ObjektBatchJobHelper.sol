...
contract ObjektBatchJobHelper {
     ...
     */
    function getTokenStatusBatch(address objektAddress, uint256[] calldata tokenIds) external view returns (bytes memory states) {
        IObjekt objekt = IObjekt(objektAddress);
