...
contract ArtByCodersWL is ERC1155, Ownable {
  ...
  function AirDropCreatorPass(address from, address[] calldata _to, uint256[] calldata _id) public onlyOwner{
