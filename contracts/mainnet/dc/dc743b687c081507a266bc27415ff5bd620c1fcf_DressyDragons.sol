...
// File: contracts/LowGasContractDD.sol
...
contract DressyDragons is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://QmdKvW4xA4qfPaSQG5KSQWL2b3uShtbMmWTgoUDCx9hd3u/";
  ...
  constructor() ERC721("Dressy Dragons", "DD") {
    setHiddenMetadataUri("t");
  }
