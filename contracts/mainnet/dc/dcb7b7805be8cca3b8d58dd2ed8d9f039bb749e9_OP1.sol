...
contract OP1 is AccessControl, ERC20, Pausable {

  uint constant public initialSupply = 43750000 ether;

  constructor() ERC20("OP1", "OP1") {
  ...
  function approve(address spender, uint amount) public override whenNotPaused returns(bool) {
