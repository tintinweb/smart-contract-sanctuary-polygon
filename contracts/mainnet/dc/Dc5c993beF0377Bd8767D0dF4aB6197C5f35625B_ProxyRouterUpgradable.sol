...
interface FreeWheelContractInterface {
    function rootCaller() external view returns (address);
    ...
    ReentrancyGuardUpgradeable
{
    ...
    FreeWheelContractInterface internal freeWheelContract;
    address public freeWheelContractAddress;
        ...
        nonReentrant
    {
        ...
        if (freeWheelContractAddress != address(0)) {
    ...
    {
        require(
            FreeWheelContractInterface(_freeWheelContractAddress)
                .rootCaller() == address(this),
            "Root caller of that contract is different"
        );
        freeWheelContract = FreeWheelContractInterface(
            _freeWheelContractAddress
        );
        freeWheelContractAddress = _freeWheelContractAddress;
        emit UpdateGamesPoolContractAddress(_freeWheelContractAddress);
    }
