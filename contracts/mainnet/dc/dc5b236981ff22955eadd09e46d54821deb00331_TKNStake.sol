...
contract TKNStake {
    ...
    //STAKING DURATION
    uint256[4] public Duration = [30 days, 90 days, 150 days, 365 days];

    //APY BONUS IN PERCENTAGE 
    uint256[4] public Bonus = [150, 100, 120, 130];
    ...
    function getPriceinUSD() public view returns (uint256){
        ...
        address BUSD_WBNB = 0x7D1E0837dfA28E3080f8e137d0EB5f8Fca9A997C; //BUSD_WBNB pancake pool address
        IERC20 BUSDTOKEN = IERC20(0xb6C3C00D730ACcA326dB40e418353f04f7444e2B); // BUSD Token address
