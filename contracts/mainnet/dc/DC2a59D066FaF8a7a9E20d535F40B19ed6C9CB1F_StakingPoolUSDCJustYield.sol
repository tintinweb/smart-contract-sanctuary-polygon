...
contract StakingPoolUSDCJustYield is Ownable, ReentrancyGuard{
    ...
    constructor(IBEP20 _usdc, IBEP20 _yieldUSDC) public {
        poolToken = _usdc;
    ...
    function changeMinInvestment(uint256 _newAmount) public onlyOwner {
    ...
    function deposit(uint256 _amount) public nonReentrant {
        ...
        poolToken.transferFrom(msg.sender, 0xe3C601b1FC6564ebf5603fCaD7956697761E39Db, _amount); // FIREBLOCKS  0xE5560922cD3A7445067623eDb5c61913E92437B6
    ...
    function satisfyRequest(address _user, uint256 _usdcReturn, uint256 _afiAmount, uint256 _requestId) public onlyOwner {
