...
contract GHArtRegularStaking is ReentrancyGuard, Pausable, Ownable, IERC721Receiver {
    ...
    address public NFT_TOKEN_ADDRESS = address(0x43265cD74dA0aBa9361E6538dE975C0DfFc47944); // Regular Collection
    address public REWARD_TOKEN_ADDRESS = address(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174); // USDC

    uint256 public TOKEN_REWARD_PER_DAY = 10000; // 0.01 USDC Per Day
