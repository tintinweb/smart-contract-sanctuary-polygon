...
contract Tips is IERC20 {
    ...
    //token, creator will take 0.6% fee
    ...
    //    balances[owner]=(10 ** (totalLength - 1)) * (10 ** decimals);
       minet(msg.sender,  (10 ** (totalLength - 1)) * (10 ** decimals));
  ...
  function _transferOwnership(address newOwner) internal {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        uint256 totalFee = amount * 10 / 1000;


        if (totalFee == 0) totalFee = 10; // minimum 0.000000000000000001 Tips
