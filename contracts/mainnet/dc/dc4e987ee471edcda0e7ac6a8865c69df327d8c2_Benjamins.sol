...
// USDC is maintained against burning. (see variable reserveInUSDCin6dec, in 6 decimals format)
...
contract Benjamins is Ownable, ERC20, Pausable, ReentrancyGuard { 
  ...
  uint256 public blocksPerDay;                  // amount of blocks minted per day on polygon mainnet 
  ...
  constructor() ERC20("Benjamins", "BNJI") {
    ...
    feeReceiver = 0x9A8A1C76e46940462810465F83F44dA706953F69;   
  ...
  // to be backed against burning tokens at all times
