    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 13) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeicnjp3igr6nf4a2vlb7jz4auxni2s2ft27qmuf3vafg7c6oewlboi/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/TMYgDWa71Le27lJuSOlT/contract-metadata";
  }
...
// File: contracts/AnithinkContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AnithinkContract is ERC721APlus {
    constructor() ERC721APlus("Anithink", "Anithink"){}
}
  /*******************************************************/
  /*                                                     */
