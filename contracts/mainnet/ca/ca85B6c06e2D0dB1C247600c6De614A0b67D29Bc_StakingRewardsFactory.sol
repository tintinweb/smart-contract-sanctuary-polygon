...
contract StakingRewardsFactory is Ownable {
    ...
    function deploy(address stakingToken, address rewardsToken) public onlyOwner {
        require(stakingRewardsAddress[stakingToken] == address(0), 'StakingRewardsFactory::deploy: already deployed');
        stakingRewardsAddress[stakingToken] = address(new StakingRewards(rewardsToken, stakingToken, WETH));
