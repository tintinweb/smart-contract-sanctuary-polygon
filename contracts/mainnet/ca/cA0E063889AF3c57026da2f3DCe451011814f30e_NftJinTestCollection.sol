...
// NFTStandard: Error 4 : set multi minting condition with nonexistent key
...
// NFTStandard: Error 20 : given range is already set Or contains minted token id
...
abstract contract NFTStandard is ERC721Enumerable, ERC721Burnable, ERC721Pausable, IERC2981, Ownable, ReentrancyGuard {
    ...
    */
    ...
    function mint(uint256 _mintingConditionId, address[] calldata _receivers, uint256 _amountPerAddress, uint256[] calldata _clientIds, bytes32[] calldata _merkleProof) external payable nonReentrant {
        ...
        require(sales._contains(_mintingConditionId), string(abi.encodePacked("NFTStandard: Error 23, ", _mintingConditionId.toString())));
...
contract NftJinTestCollection is NFTStandard {
