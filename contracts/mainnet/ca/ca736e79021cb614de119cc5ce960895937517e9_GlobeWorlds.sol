...
// File: contracts/GlobeWorlds.sol
...
contract GlobeWorlds is ERC1155, Ownable {
  ...
  function mintBatch(address _to, uint[] memory _ids, uint[] memory _amounts, string[] memory _uri) external onlyOwner {
