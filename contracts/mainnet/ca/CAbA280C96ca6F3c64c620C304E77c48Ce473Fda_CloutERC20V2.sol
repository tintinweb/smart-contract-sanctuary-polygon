...
contract CloutERC20V2 is ERC20Permit, VaultOwned {
    using SafeMath for uint256;

    constructor() ERC20('Clout Token', 'CLOUT', 9) {
         _mint(msg.sender, 1000000*1e9); //mint tokens for AlphaLimelight (aLMLT) holders 
    }
