...
contract Rapaskalion is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;

  uint256 public currentSupply = 0;
  
  string public baseURI = "https://ipfs.io/QmPYeq8nQNL6sfJYGnr7BcELywiU2ZpHnUDn1AqYZPf5VW/";

  constructor() 
    ERC721("Rapaskalion", "RS1")
    RandomlyAssigned(1,1) 
    {
