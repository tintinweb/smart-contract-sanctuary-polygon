...
// File: contract-ed79269ead.sol


pragma solidity ^0.8.9;

contract StakedBellygomWorldOfficial is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl, ERC721Burnable {
    using Address for address;
    using Strings for uint256;
    ...
    constructor() ERC721("Staked Bellygom World Official", "sBELLYGOM") {
    ...
    function setContractURI(string memory _contractURI) public onlyRole(MINTER_ROLE) {
    ...
    {
        require(hasRole(MINTER_ROLE, to) == true || from == address(0) || hasRole(MINTER_ROLE, from) == true, "StakedBellygomWorldOfficial: transferable is false");
