    ...
    FxMessageProcessor
{
    ...
    address public constant FX_CHILD = 0x8397259c983751DAf40400790063935a11afa28a;

    IWMatic public constant WMATIC = IWMatic(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270);
    address public constant MRC20 = 0x0000000000000000000000000000000000001010;
    ...
    function swapNativeAndCall(
        ...
        if (router != address(0)) {
            ...
            address output = abi.decode(routerArguments, (address));
            if (output == address(WMATIC)) {
