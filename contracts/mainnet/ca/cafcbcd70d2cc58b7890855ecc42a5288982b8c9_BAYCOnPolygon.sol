...
contract BAYCOnPolygon is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("BAYC On Polygon", "BAYC") {
  ...
  address private constant payoutAddress1 =
    0x4288bc3b27E7A8905977d2e0d4fF4032Bb3D8446;
