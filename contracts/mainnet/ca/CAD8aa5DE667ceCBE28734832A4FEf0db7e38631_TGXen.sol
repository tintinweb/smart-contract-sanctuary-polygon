...
contract TGXen is ERC20, IERC165, IBurnRedeemable, Ownable { 
	...
	IBurnableToken public XEN_ADDRESS = IBurnableToken(0x2AB0e9e4eE70FFf1fB9D67031E44F6410170d00e);
	address public TGC_ADDRESS = address(0x6387b0100eD27B4f5276900BF39262412Ba0099d);
	...
	uint256 public LAUNCH_TIME = 1684934688;
    ...
    function onTokenBurned(address user, uint256 amount) public {
	   ...
	   if(currentDay == 0)
	   {
	       _transfer(address(this), address(_msgSender()), amount, false);
		   _transfer(address(this), address(_msgSender()), amount, true);
	   }
	   else
	   {
	       ...
	       mapTGXenClaim[_msgSender()][allocationDay].amount += amount; 
		   mapTGXenClaim[_msgSender()][allocationDay].bonus += bonus; 
	...
	function burnTGC(uint256 amount) external {
	   ...
	   require(block.timestamp >= LAUNCH_TIME, "TGXen: Burning not start yet");
	   require(block.timestamp <= (LAUNCH_TIME.add(172800)), "TGXen: Burn time is end for TGC");
