...
contract JuangNft is ERC721PresetMinterPauserAutoId, ERC2981ContractWideRoyalties, Ownable {
 ...
 mapping(address => bool) public whitelistedSource;
    ...
    constructor() public ERC721PresetMinterPauserAutoId("JUANG Silver", "JGFNFT", "") {
   ...
   function addToWhitelistedSource(address[] memory _addresses) public onlyOwner {
        ...
        returns (uint256)
    {
        ...
        whitelists[0] = receiver;
      
      if (!whitelistedSource[receiver]) {
        addToWhitelistedSource(whitelists);
      }
        return tokenId;
    }
 ...
 function tokenURI(uint256 tokenId) public view override(ERC721) returns(string memory) {
        ...
        return string(abi.encodePacked(_tokenBaseURI, Strings.toString(tokenId), _tokenURISuffix));
    }
