...
contract EshiCollection2023 is BaseNFT {
        ...
        whenNotPaused
    {
        ...
        require(
            _typeSupplies[tokenType_] + 1 <= _typeMaxSupplies[tokenType_],
            "EC2023: supply exceeds the upper limit"
        );
        ...
        whenNotPaused
    {
        ...
        require(
            _typeSupplies[tokenType_] + tos_.length <=
                _typeMaxSupplies[tokenType_],
            "EC2023: supply exceeds the upper limit"
        );
