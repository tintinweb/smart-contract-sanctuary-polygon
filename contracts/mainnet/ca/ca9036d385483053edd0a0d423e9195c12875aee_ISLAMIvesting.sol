...
contract ISLAMIvesting {
    ...
    function islamiBalance() public view returns (uint256 Balance){
        Balance = ISLAMI.balanceOf(address(this));
        return(Balance);
    }
    ...
    function addInvestor(address _investor, uint256 _amount, uint256 _lockTime) external onlyOwner{
        ...
        require(lockTime > 365 days, "Investor locking is at least 1 year!");
        IDinvestor++;
        investorCount++;
