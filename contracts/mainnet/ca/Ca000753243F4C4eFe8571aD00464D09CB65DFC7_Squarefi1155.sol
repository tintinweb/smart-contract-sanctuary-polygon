...
contract Squarefi1155 is ERC1155PresetMinterPauser {
    string private _name;
    string private _symbol;
    bool _publicMint;
    constructor(string memory uri, string memory name_, string memory symbol_, bool publicMint) ERC1155PresetMinterPauser(uri) {
        _name = name_;
        _symbol = symbol_;
