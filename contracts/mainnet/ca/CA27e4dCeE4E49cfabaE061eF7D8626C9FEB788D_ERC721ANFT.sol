...
contract ERC721ANFT is ERC721A, Ownable {
  ...
  uint256 public publicPrice = 12e14;   //0.12 ETH
  uint256 public whitelistPrice = 8e14; //0.08 ETH
  ...
  string private _baseOwnerURI;

  function _baseURI() internal view virtual override returns (string memory) {
    return _baseTokenURI;
  }
  
  function _ownerURI() internal view virtual returns (string memory) {
    return _baseOwnerURI;
  }
  ...
  function setOwnerURI(string calldata ownerURI) external onlyOwner {
    _baseOwnerURI = ownerURI;
  }
  ...
  function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
    ...
    if(ownerOf(tokenId) == msg.sender){
      preURI = strConcat(_ownerURI(), _tokenIdSTR);
    }
