...
contract ToppyMint is Ownable, ReentrancyGuard, IToppyMint {
    ...
    mapping(address => bool) public mysteryBoxWhitelisted;
    ...
    function mintMysteryBox(address _contract, address _to, uint256 _mintAmount) external override nonReentrant payable {
        ...
        //make payment
        if(mysteryBoxWhitelisted[msg.sender] != true) {
    ...
    function addMysteryBoxWhiteList(address _address) public onlyOwner {
        mysteryBoxWhitelisted[_address] = true;
    }

    function removeMysteryBoxWhiteList(address _address) public onlyOwner {
        mysteryBoxWhitelisted[_address] = false;
    }
