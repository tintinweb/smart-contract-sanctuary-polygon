...
contract GravityGradeGiveaways is IGravityGradeGiveaways, OwnableUpgradeable, EIP712Upgradeable {
    ...
    function updateGiveaway(
        ...
        GiveawayInfo storage giveawayInfo = s_idToGiveaway[_id];

        giveawayInfo.tokenId = _tokenId;
        giveawayInfo.amount = _amount;
        giveawayInfo.cap = _totalAmount;

        emit GiveawayUpdated(_id, _tokenId, _amount, _totalAmount);
    }
...
interface IGravityGradeGiveaways {
    ...
    */
    ...
    /**
    * @notice Event emitted when a giveaway is updated
    * @param _id The id of the giveaway
    * @param _tokenId The tokenId being given away
    * @param _amount The amount of token id being given away
    * @param _totalAmount The total number of addresses that can claim this giveaway
    */
    event GiveawayUpdated(uint256 _id, uint256 _tokenId, uint256 _amount, uint256 _totalAmount);
    /**
