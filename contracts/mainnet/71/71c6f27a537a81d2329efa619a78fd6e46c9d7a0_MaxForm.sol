...
contract MaxForm is ERC721A, Ownable {
    using Strings for uint256;
    ...
    // URI
    string public baseURI = "https://aarrohan.com/projects/nft-minting-dapps/max-form/collection/jsons/";

    // Costs
    uint256 public whitelistSaleCost = 0 ether;
    uint256 public publicSaleCost = 0.022 ether;

    // Per Address Limits
    uint256 public nftWhitelistSalePerAddressLimit = 75;
    ...
    // Constructor
    constructor() ERC721A("Max Form", "MF") {}
