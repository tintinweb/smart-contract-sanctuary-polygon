...
contract Investors is ERC721A, Ownable, ContextMixin {
    uint256 MAX_MINTS = 100;
    uint256 MAX_SUPPLY = 10000;
    uint256 public mintRate = 0.00 ether;
    address account = msg.sender;

    string public baseURI = "ipfs://bafybeifhu6uz7qdozxjiejngvm6qrclw354erxhy5s6rp4uablfuopgy5i/";

    constructor() ERC721A("SafeMarine Investors Collection", "SMIC") {}
