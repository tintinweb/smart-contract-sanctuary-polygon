...
contract MonsterNFT is ERC721, Ownable {
    ...
    constructor(string memory _name, string memory _symbol, uint256 _totalSupply) ERC721(_name, _symbol) {
    ...
    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        ...
        return
            bytes(currentBaseURI).length > 0
                ? string(abi.encodePacked(baseURI, "1", baseExtension))
                : '';
    }
