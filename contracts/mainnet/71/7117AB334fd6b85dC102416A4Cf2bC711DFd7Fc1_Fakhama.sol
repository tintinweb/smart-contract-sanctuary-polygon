...
contract Fakhama is IERC20
{
    ...
    address constant public marketingAddress=0xA9a2c94Ecd211235E553526a4FA4B411A019416c;
    ...
    function investInternal(address _SponsorAddress) internal
    {
        ...
        if(!doesUserExist(_senderAddress)){
            ...
            User memory u = User({
                ...
                SponsorId:SponsorId,
                Business:0,
                LevelBusiness:new uint[](3),
                Investment:0,
                RankId:1,
                DirectIds:new uint[](0),
                ROIDividend:0,
                LevelDividend:new uint[](3),
                DividendWithdrawn:0,
     ...
     function updateRank(uint _memberId) internal
    {
        ...
        if(userBusiness>=requireBusiness && currentRank<3)
        {
    ...
    constructor()
    {
        ...
        LevelPercentage[1] = 1500;
        LevelPercentage[2] = 900;
    ...
    function getUserInfo(uint memberId) public view returns(UserInfo memory userInfo)
    {
        ...
        string memory _nextRankName = _userInfo.RankId<3?map_ranks[_userInfo.RankId+1].Name:"";
    ...
    function getUserRanks(uint memberId) public view returns (RankInfo[] memory rankInfo)
    {
        ...
        RankInfo[] memory _rankInfo = new RankInfo[](3);
    ...
    {
        UserLevelInfo[] memory _info = new UserLevelInfo[](3);
        uint[] memory _levelPercentage = new uint[](3);
        for(uint8 i=1; i<=3; i++)
        {
