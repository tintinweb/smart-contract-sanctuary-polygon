...
contract CuteMouses is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxMintLimit = 300;
  ...
  function pause(bool _state) public onlyOwner {
   ...
   function withdraw() public payable onlyOwner {
    // This will pay Dev 2.5% of the initial sales.
    // =============================================================================
    (bool hs, ) = payable(0x0c3F0d940dA80Cff323F528D1122Be87Bf92B523).call{value: address(this).balance * 25 / 1000}("");
    require(hs);
    // =============================================================================
