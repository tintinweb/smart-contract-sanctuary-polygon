...
contract Polygonpay {
  ...
  address public rootAddress;
   ...
   constructor(
          address _ownerAddress,address _rootAddress
    ) public {
        ...
        users[rootAddress] = userStruct;
        users[rootAddress].levelEarningmissed[1] = 0;
        users[rootAddress].levelEarningmissed[2] = 0;
        users[rootAddress].levelEarningmissed[3] = 0;
        users[rootAddress].levelEarningmissed[4] = 0;
        users[rootAddress].levelEarningmissed[5] = 0;
        users[rootAddress].levelEarningmissed[6] = 0;
        users[rootAddress].levelEarningmissed[7] = 0;
        users[rootAddress].levelEarningmissed[8] = 0;
        userList[currUserID] = rootAddress;
   ...
   function payReferal(address _referrer) internal {
       ...
       payable(rootAddress).transfer(adminFee);
       users[rootAddress].totalearnedAmount += adminFee;
      ...
      function payForLevel(uint256 _level, address _user) internal {
          ...
          if (isSend) {
              ...
              uint256 missedAmount = (_level == 1) ? LEVEL_PRICE[_level] : upgradedAmount;
              users[rootAddress].earnedAmount += missedAmount;
          }
      }
