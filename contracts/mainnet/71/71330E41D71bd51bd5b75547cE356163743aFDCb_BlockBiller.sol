...
{
    event Withdrawal(string indexed _subscriptionId, uint256 _fee, uint256 _balance);
    event Renewal(string indexed _subscriberId, string indexed _subscriptionId, address walletAddress, uint256 expiration);
    event SubscriptionCreated(string indexed _subscriptionId, uint256 _price, uint256 _duration, IERC20 _token);
    event CurrencyAdded(IERC20 _paytoken, uint256 _costValue);
    event Subscribed(string indexed _subscriberId, string indexed _subscriptionId);
    event Cancelled(string indexed _subscriberId);
