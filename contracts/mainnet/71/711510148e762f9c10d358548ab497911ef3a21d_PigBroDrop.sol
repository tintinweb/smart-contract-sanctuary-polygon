...
// File contracts/PigBroDrop.sol

pragma solidity ^0.8.0;

contract PigBroDrop is
    Initializable,
    UUPSUpgradeable,
    OwnableUpgradeable,
    ERC1155Upgradeable
{
    ...
    function initialize() external initializer {
        ...
        __ERC1155_init(Uris[0]);
        __UUPSUpgradeable_init();
        __Ownable_init();

        ContractURIHash = "ipfs://QmQy1GCC1j1VqYbNVNHrDRRmhtBFmx5BcUBWDQFh3M7Rwt";
    }
    ...
    function dropTo(
        ...
        for (uint256 i = 0; i < _addresses.length; i++) {
            safeTransferFrom(msg.sender, _addresses[i], _tokenId, 1, _data);
        }
    }
