...
// File: contracts/JasperCollection.sol
...
contract JasperCollection is ERC721A, Ownable, ReentrancyGuard{
    uint256 public constant maxSupply = 211;
    uint public _price = 0.035 ether;
    uint256 public maxBuyPerTx = 5;
    bool public paused;
    

    constructor() ERC721A("Jasper Collection", "JC") {
        paused = true;
    }
    // Read the price
