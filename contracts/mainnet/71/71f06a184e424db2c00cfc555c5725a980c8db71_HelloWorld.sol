...
contract HelloWorld is Ownable, ERC721, NonblockingReceiver {
    ...
    constructor(string memory hiddenuri_, address _layerZeroEndpoint) ERC721("HelloWorld", "HW") {
        _owner = msg.sender;
    ...
    function mint(uint8 _mintAmount) external payable {
        ...
        require(nextTokenId + _mintAmount <= MAX_MINT_POLYGON, "Mint exceeds supply");
