...
ERC1155SupplyUpgradeable {
    ...
    function mintCornerWithToken(uint256 _howMany, address _paymentToken, uint256 _paymentMax, uint256 _poolFee) public {
        ...
        /*uint256 balancePreSwap = IERC20(wETH).balanceOf(address(this));*/
        swapExactOutputSingle(_paymentToken, _paymentMax, _howMany, _poolFee);
        /*uint256 balancePostSwap = IERC20(wETH).balanceOf(address(this));*/
        /*require(cost * _howMany == payment, "insufficient payment");*/
        /*uint256 balanceIncrease = balancePostSwap - balancePreSwap;*/
