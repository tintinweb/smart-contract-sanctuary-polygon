...
// File contracts/PDShare.sol


pragma solidity 0.6.12;
contract PDShare is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 100,000 tSHAREs
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("PDSHARE", "PDSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 PDDOLLAR Share for initial pools deployment
