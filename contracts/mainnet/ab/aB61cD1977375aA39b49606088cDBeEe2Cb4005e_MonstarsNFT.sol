...
contract MonstarsNFT is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  modifier mintForCompliance(uint256 _mintAmount) {
  ...
  function mintForAddress(uint256 _mintAmount, address _receiver) public mintForCompliance(_mintAmount) onlyOwner {
