...
contract CRYPTOMETEORIT is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_, address proxyRegistryAddress_)
    ERC721("CRYPTO METEORIT", "METEO")
  {
  ...
  function mint(uint256 count) public payable nonReentrant onlyOwner {
    ...
    require(msg.value >= PRICE * count, "Insufficient payment, 4 ETH per item");
