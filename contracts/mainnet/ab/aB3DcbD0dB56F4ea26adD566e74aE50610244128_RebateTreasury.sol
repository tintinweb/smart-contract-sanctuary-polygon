...
contract RebateTreasury is Ownable {
    ...
    uint256 public bondVesting = 5 days;
    ...
    address public constant WFTM = 0x2F800Db0fdb5223b3C3f354886d907A671414A7F;
    ...
    constructor(address tomb, address tombOracle, address treasury, address _bondTreasury) {
        Tomb = IERC20(tomb);
    ...
    function bond(address token, uint256 amount) external onlyAsset(token) {
        ...
        IERC20(token).transferFrom(msg.sender, bondTreasury, amount);
    ...
    function setBondTreasury(address treasury) external {
        require(msg.sender == bondTreasury);
