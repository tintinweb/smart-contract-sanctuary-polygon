...
/**
 * @title Paymaster contract to support gas-less transactions using OpenGSN. Only addresses that have been white listed
 * will be paid for. Target contracts and callers can be white listed.
 * @dev Only tested with OpenGSN 3.0.0-beta.3 on Polygon.
 * @author Dalton Tan
 */
contract WhitelistAnyPaymaster is BasePaymaster {

	/// @notice Target contract addresses to white list. true = allowed, false = not allowed.
    mapping(address => bool) public contractWhitelist;
	/// @notice Caller addresses to white list. true = allowed, false = not allowed.
	...
	/***
	 * @notice Setting contract white list for `addr` to `isAllowed`.
	 * @param addr Target contract to white list.
	 * @param isAllowed Wether to allow.
	 */
	...
	/***
	 * @notice Setting caller white list for `addr` to `isAllowed`.
	 * @param addr Caller address to white list.
	 * @param isAllowed Wether to allow.
	 */
