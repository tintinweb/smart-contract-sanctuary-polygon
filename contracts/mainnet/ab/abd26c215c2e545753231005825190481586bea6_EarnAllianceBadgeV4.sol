...
contract EarnAllianceBadgeV4 is Initializable, OwnableUpgradeable, PausableUpgradeable, ERC1155SupplyUpgradeable, UUPSUpgradeable, EIP712Upgradeable {
    ...
    function contractURI() public pure returns (string memory) {
        return "https://cdn-ea.earnalliance.com/metadata/earnalliancebadge.json";
    }
    ...
    function badgeMint(
        ...
        require(balanceOf(input.toAddress, t) < 1, "no repeats");
