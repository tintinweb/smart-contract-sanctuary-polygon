...
contract GameOwner is Ownable {
  ...
  modifier onlyGame {
    require(gameRoles[_msgSender()] == true, "VogonyangSpace: You are not the game");
    _;
  }
...
contract VogonyangsSpace is ERC1155Supply, GameOwner, Pausable {
    constructor() ERC1155("https://content.vogoplay.com/vogonyang/12k9as76x/{id}.json") payable {
