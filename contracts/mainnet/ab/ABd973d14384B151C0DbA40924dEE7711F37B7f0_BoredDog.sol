...
contract BoredDog is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("Bored Dog", "BD") {
  ...
  uint256 public constant MINT_LIMIT_PER_WALLET = 1050;
  ...
  uint256 public constant MAX_MULTIMINT = 1050;
  ...
  function mint(uint256 count) public nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 1050 at a time");
