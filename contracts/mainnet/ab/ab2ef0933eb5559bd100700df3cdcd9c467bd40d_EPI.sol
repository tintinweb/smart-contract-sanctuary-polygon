...
contract EPI is ERC20, Ownable {
    ...
    function updateFees(uint256 _RewardFee, uint256 _liquidityFee, uint256 _marketingFee) public onlyOwner {
        RewardsFee = _RewardFee;
        liquidityFee = _liquidityFee;
        marketingFee = _marketingFee;
        totalFees = RewardsFee.add(liquidityFee).add(marketingFee); // total fee transfer and buy
    }
