...
// File: contracts/goblinbastards.sol
...
contract GoblinBastards is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Goblin Bastards", "GB") {
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x9e1660D411B1a5BB94b9E72ccf054Bea75FD9606).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
