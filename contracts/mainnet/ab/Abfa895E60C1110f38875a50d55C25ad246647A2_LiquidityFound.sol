...
contract LiquidityFound is ILiquidityFound, AccessControl {
    ...
    IERC20Burnable public token0;
    IERC20Burnable public token1;
    IUniswapV3PoolState public v3Pool;
    uint256 public fee;
    int256 public initTick;
    uint256 public tokenCount;
    uint256 public remintCount;
    ...
    function setV3Pool(address pool) external onlyRole(DEFAULT_ADMIN_ROLE) {
        ...
        token0 = IERC20Burnable(v3Pool.token0());
        token1 = IERC20Burnable(v3Pool.token1());
    }
