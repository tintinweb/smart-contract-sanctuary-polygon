...
//  mapping(eventId => associated promoCodes[])
    ...
    function updateEvent(uint eventId, Event calldata updatedEventDetails) public whenNotPaused onlyOwner isValidTicketContract{
        ...
        _eventDetails[eventId] = updatedEventDetails;
    }
    ...
    function getTicketTypeValidDates(uint ticketTypeId) public view returns(uint[] memory){
        return _ticketTypeDetails[ticketTypeId].validDates;
    }
...
contract TicketsERC1155 is ERC1155, Ownable, Pausable, ERC1155Burnable {
    ...
    function mint(address account, uint256 id, uint256 amount, bytes memory data)
        public
        onlyAllowed(msg.sender) isValidAdminContract whenNotPaused
    {
