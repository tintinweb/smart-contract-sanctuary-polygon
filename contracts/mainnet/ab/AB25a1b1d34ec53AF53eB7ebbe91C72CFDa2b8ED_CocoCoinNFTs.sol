...
contract CocoCoinNFTs is ERC1155, Ownable, Pausable {
    ...
    uint256 public mintPrice = 20000000000000000000 wei;
    uint256 public minted;
    uint256 public totalSupply = 2222;
    ...
    function mint(uint256 amount) payable public whenNotPaused {
        require(amount > 0);
        require(msg.value >= amount * mintPrice, "Not enough ether sent");
        require(minted + amount <= totalSupply, "Not enought supply left");
