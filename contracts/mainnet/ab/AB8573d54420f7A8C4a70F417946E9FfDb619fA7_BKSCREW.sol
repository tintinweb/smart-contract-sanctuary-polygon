...
contract BKSCREW is ERC721, PaymentSplitter {
    uint256 public totalSupply;
    uint256 private cost = 1 ether;
    uint256 private whitelistCost = 0.05 ether;
    ...
    function mint() external payable {
        ...
        if (totalSupply + 1 > 5) revert SoldOut();
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked(
                    "ipfs://QmVnczUcQDJsa9eUGDAEif678yw785wKDD6RswJADM1S58/",
