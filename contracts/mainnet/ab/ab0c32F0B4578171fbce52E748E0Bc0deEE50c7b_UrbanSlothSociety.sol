...
abstract contract Ownable is Context {
    ...
    contract UrbanSlothSociety is ERC721A, Ownable {
    using Strings for uint256;


  string private uriPrefix ;
  string private uriSuffix = ".json";
  string public hiddenURL = "ipfs://QmYJuNtAQzsR5yoZqdYFxapbVjq8S93Gs2Q8nFJeKGeqc2" ;
  ...
  constructor() ERC721A("UrbanSlothSociety", "USS") {
