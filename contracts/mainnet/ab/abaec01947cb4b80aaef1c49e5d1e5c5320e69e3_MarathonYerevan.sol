...
contract MarathonYerevan is ERC721A, Ownable {
  event Mint(address indexed _from);
  uint256 public constant maxSupply = 107;

  constructor() 
    ERC721A("Yerevan 5k run for wounded soldiers - 2022", "MRT") {}
