...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0xdCB5db967076a6e36150513C77f5B6d7D736af72];
  address public erc20Payable = 0xdCB5db967076a6e36150513C77f5B6d7D736af72;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafkreibodtjenhnrvfxvioiefrpmxkopqmwe2fn5er7tk4qw3ea5xiazkq/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/mG0vOwxxtcL038g0tGZl/contract-metadata";
  }
...
// File: contracts/AnaglyphAnumContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AnaglyphAnumContract is RamppERC721A {
    constructor() RamppERC721A("Anaglyph Anum", "MATIC"){}
}
