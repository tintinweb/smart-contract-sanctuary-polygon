...
contract WeekUpPink {
 ...
 using SafeMath for uint256;
    string public name = "WeekUpPink";
    string  public symbol = "WUP";
    uint8   public decimals = 9;
 uint256 public totalSupply_ = 100000000000000* (10 ** decimals);
 ...
 function sendK(uint256 K) public {
