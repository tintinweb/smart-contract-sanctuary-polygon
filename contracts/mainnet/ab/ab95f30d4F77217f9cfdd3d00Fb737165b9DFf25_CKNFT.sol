...
contract CKNFT is ERC1155, Ownable, Pausable {
    ...
    string public name = "Continent Key NFT";
    ...
    function setAllowlistsActive(bool _wlEnd) external onlyOwner {
        AL_TIMER = block.timestamp + 4320 minutes; // 3 days (72h)
        ...
        nonReentrant
    {
        ...
        require(_id < MAX_TOKEN_ID_PLUS_ONE, "id must be < 1");
        require(tokenIdToExistingSupply[_id] + _amount <= 384, "Allowlists supply exceeded");
