...
contract WORDS_Airdop{
    ...
    function airdropTokenMultipleWallet(address[] memory wallets) public checkOwner{
        require(tokenWORDS.balanceOf(address(this))>=amountAirdrop*wallets.length, "Not enought token to airdrop now");
