    ...
    ReentrancyGuard
{
    ...
    address treasuryAddress = 0x1594b20413311F502789e0f03a5997F7A50d3D85;
    ...
    //     // Cut buy fee
    //     uint256 buyFee = buyPrice - listedPrice;
    ...
    //     uint256 sellFeeBasis = config.sellFee();
    //     uint256 sellFee = (listedPrice * sellFeeBasis) / 10000;
    //     rest = listedPrice - sellFee - royaltyFee;

    //     uint256 totalFee = buyFee + sellFee;
    //     if (treasuryAddress != address(0)) {
    //         payable(treasuryAddress).transfer(totalFee);
    //     } else {
    ...
    function withdraw() external onlyOwner {
        ...
        payable(treasuryAddress).transfer(feesCollected);
        feesCollected = 0;
    }
