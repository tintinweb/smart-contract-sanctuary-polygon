...
contract PGenieToken is IERC20, IERC20Metadata, Ownable{
    ...
    /**
     * Divided tokens for every purpose based on tokenomics
     */
    ...
    constructor(string memory name_, string memory symbol_) {
        ...
        //router = IDEXRouter(0x8954AfA98594b838bda56FE4C12a09D7739D179b); // Polygon Testnet address
        router = IDEXRouter(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff); // Polygon MainNet address
       // router = IDEXRouter(0x5757371414417b8c6caad45baef941abc7d3ab32); // quickswap MainNet address
