...
contract ChocoMintMintableWrapper {
  ...
  function freeMint() public payable {
    require(block.timestamp <= mintEndTimestamp, "MintableWrapper: mint period has ended");
    require(addressClaimed[msg.sender] != true, "MintableWrapper: you can only mint 1 token");
