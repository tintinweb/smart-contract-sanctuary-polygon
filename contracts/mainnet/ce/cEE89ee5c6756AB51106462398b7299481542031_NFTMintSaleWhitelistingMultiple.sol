...
contract NFTMintSaleWhitelistingMultiple is NFTMintSaleMultiple, BoringBatchable {
    ...
    function setMerkleRoot(bytes32[] calldata _merkleRoot, string[] calldata ipfsHash_) external {
        require(merkleRoot[0] == bytes32(0), "Already initialized");
        require(_merkleRoot.length == tiers.length, "unequal length");
