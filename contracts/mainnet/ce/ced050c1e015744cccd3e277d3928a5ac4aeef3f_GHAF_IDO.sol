...
contract GHAF_IDO is Ownable {    
    ...
    uint256 public MAX_PAY_LIMIT_WHITELIST_1 = 1000_000_000; // 1000 USDC
    uint256 public MAX_PAY_LIMIT_WHITELIST_2 = 1000_000_000; // 2000 USDC
    ...
    uint256 public GHAF_AMOUNT_PER_USDC_PUBLIC = 110 * 10**18 / 10**6; // 110 GHAF per 1 USDC
    ...
    uint256 public START_DATETIME_PUBLIC = 1654041600; // June 1, 2022 12:00:00 AM GMT
    uint256 public END_DATETIME_PUBLIC = 1656633600; // July 1, 2022 12:00:00 AM GMT
    ...
    function claimForGHOGHolder() public {
        ...
        GHAF_TOKEN.transfer(msg.sender, reservedTokenAmountForGHOGHolder(msg.sender));

        delete MAP_DEPOSIT_GHOG_HOLDER[msg.sender];
    }
    function claimForWhitelist1() public {
        require(IDO_ENDED , "IDO is not finished");
        
        GHAF_TOKEN.transfer(msg.sender, reservedTokenAmountForWhitelist1(msg.sender));

        delete MAP_DEPOSIT_WHITELIST_1[msg.sender];
    }
    function claimForWhitelist2() public {
        require(IDO_ENDED , "IDO is not finished");
        
        GHAF_TOKEN.transfer(msg.sender, reservedTokenAmountForWhitelist2(msg.sender));

        delete MAP_DEPOSIT_WHITELIST_2[msg.sender];
    }
    function claimForPublic() public {
        require(IDO_ENDED , "IDO is not finished");
        
        GHAF_TOKEN.transfer(msg.sender, reservedTokenAmountForPublic(msg.sender));

        delete MAP_DEPOSIT_PUBLIC[msg.sender];
    }
