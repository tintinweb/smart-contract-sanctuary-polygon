    ...
    ReentrancyGuardUpgradeable
{
    ...
    event AdminWithdrawNative(address recepient, uint256 amount);
    event Settlement(
 ...
 */
    ...
    */
    function adminWithdrawNative(
        ...
        IERCHandler handler = IERCHandler(handlerAddress);
        handler.withdrawNativeTokens(recipient, amount);
        emit AdminWithdrawNative(recipient, amount);
    }
    ...
    */
     ...
     */
    function setTokenToUSDx10e9(
        bytes32 resourceID,
        address token,
        uint256 priceInUSDx10e9
    ) external virtual onlyRole(FEE_SETTER_ROLE) {
        address handlerAddress = _resourceIDToHandlerAddress[resourceID];
        IERCHandler handler = IERCHandler(handlerAddress);
        require(handler.getFeeStatus(), "fee is not enabled");
        handler.setTokenToUSDx10e9(token, priceInUSDx10e9);
    }
    ...
    */
    ...
    /**
        @notice Used to get fee with swap functionality.
        @param  resourceID resource ID.
        @param  destinationChainID id of the destination chain.
        @param  srcTokenAddress address of the source token. Put address(0) if not configuring.
        @param  destTokenAddress address of the destination token. Put address(0) if not configuring.
    ...
    */
    ...
    function _deposit(
        ...
        depositHandler.deposit(resourceID, destinationChainID, swapDetails.depositNonce, swapDetails, msg.sender);
...
interface IERCHandler {
    ...
    */
    ...
    /**
        ...
        @param  token Address of the token.
     */
    function getTokenToUSDx10e9(address token) external view returns (uint256);
    ...
    /**
        ...
        @param  priceInUSDx10e9 Price in USD * 10**9.
     */
    function setTokenToUSDx10e9(address token, uint256 priceInUSDx10e9) external;
    ...
    /**
        ...
        @param  recipient Address of the recepient
        @param  amount Amount of native token to be withdrawn
     */
