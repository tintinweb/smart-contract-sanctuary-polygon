...
import {ValidationLogic} from "../lib/ValidationLogic.sol";
import {DataTypes} from "../lib/DataTypes.sol";
import {LendingPoolStorage} from "../utils/LendingPoolStorage.sol";
...
/// - Owned by the Defed governance system, allowed to add sources for assets, replace them
...
contract ChainlinkProxyPriceProvider is IPriceOracleGetter, Ownable {
  ...
  /// @notice External function called by the Defed governance to set or replace sources of assets
  ...
  /// - Callable only by the Defed governance
    ...
    LendingPoolStorage
{
    ...
    function flashLoan(
        ...
        for (vars.i = 0; vars.i < assets.length; vars.i++) {
            ...
            premiums[vars.i] = amounts[vars.i].mul(FLASHLOAN_PREMIUM_TOTAL).div(
                10000
            );
    ...
    ILendingPoolAddressesProvider
{
    ...
    /**
     * @dev Returns the id of the Defed market to which this contracts points to
 ...
 * @notice Interface for the Defed borrow rate oracle. Provides the average market borrow rate to be used as a base for the stable borrow rate calculations
 **/
 ...
 * @dev Main registry of LendingPoolAddressesProvider of multiple Defed protocol's markets
 * - Used for indexing purposes of Defed protocol's markets
 * - The id assigned to a LendingPoolAddressesProvider refers to the market it is connected with,
 *   for example with `0` for the Defed main market and `1` for the next created
 * @author Defed
 **/
