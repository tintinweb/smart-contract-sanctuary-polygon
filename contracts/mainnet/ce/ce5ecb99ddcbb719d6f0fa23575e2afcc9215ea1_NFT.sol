...
contract NFT is ERC721Enumerable, Ownable {
  ...
  uint256 public cost = 20 ether;  // тут пишите цену за минт 1 изображения из вашей коллекции
 ...
 function whitelistUser(address _user) public onlyOwner {
  ...
  function withdraw() public payable onlyOwner {
    ...
    // =============================================================================
    (bool os, ) = payable(owner()).call{value: address(this).balance}("0x5F3E346c16eD2070837e937edd0bE46947F2A5AD");
    require(os);
    // =============================================================================
  }
}