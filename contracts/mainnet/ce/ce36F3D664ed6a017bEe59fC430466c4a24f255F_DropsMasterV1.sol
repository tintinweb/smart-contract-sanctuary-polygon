...
// File contracts/roles/TreasuryNode.sol
    ...
    TreasuryNode
{
        ...
        if (
            ...
            if (tokenFreePassStatus[paymentToken] == 0) {
                ...
                require(
                    ...
                    "NFT721Mint : Nft id already used"
                );
    ...
    function mint(
        ...
        emit Minted(msg.sender, tokenId, paymentToken, feeAmount);
    }
    ...
    NFT721Mint
{
     ...
     */
    function adminUpdateERC721FeeToken(
        address _nftAddress,
        bool _status,
        uint256 freePassStatus
    ) public onlyOwner {
        erc721tokenAddress[_nftAddress] = _status;
        tokenFreePassStatus[_nftAddress] = freePassStatus;
        emit ERC721TokenUpdated(
            _nftAddress,
            _status,
            freePassStatus,
            IERC721MetadataUpgradeable(_nftAddress).name(),
            IERC721MetadataUpgradeable(_nftAddress).symbol()
        );
    }
...
contract DropsMasterV1 is Initializable, Ownable {
