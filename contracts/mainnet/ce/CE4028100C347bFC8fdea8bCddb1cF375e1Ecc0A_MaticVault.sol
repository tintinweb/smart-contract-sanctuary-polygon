...
contract MaticVault is OwnableUpgradeable {
    ...
    function transferEth(
        ...
        //transfer eth
        require(isController[msg.sender], "Error: Caller not allowed to withdraw funds");
        for (uint256 i = 0; i < _to.length; i++) {
            if (_to[i] != address(0) && _to[i].balance < _threshold) {
