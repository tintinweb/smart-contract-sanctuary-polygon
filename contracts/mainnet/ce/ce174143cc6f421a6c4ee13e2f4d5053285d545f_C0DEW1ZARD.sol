...
contract C0DEW1ZARD is ERC20, ERC20Burnable, ERC20Snapshot, AccessControl, Pausable, ERC20Permit, ERC20Votes {
    bytes32 public constant SNAPSHOT_ROLE = keccak256("SNAPSHOT_ROLE");
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");

    string private constant _baseTokenURI = "https://i.im.ge/2023/06/02/hCfRoy.wizard.png";

    constructor() ERC20("C0DEW1ZARD", "C0DE") ERC20Permit("C0DEW1ZARD") {
    ...
    function tokenURI(uint256 tokenId) public view returns (string memory) {
        return string(abi.encodePacked(_baseTokenURI, tokenIdToString(tokenId), ".png"));
    }    
