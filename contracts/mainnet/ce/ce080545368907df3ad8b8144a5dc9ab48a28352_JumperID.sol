...
contract JumperID is ERC721A, ERC721AQueryable, IERC721ABurnable, Context, OwnableRoles, Pausable, ERC2981 {
// contract JumperID is ERC721A, ERC721AQueryable, IERC721ABurnable, Context, OwnableRoles, Pausable, DefaultOperatorFilterer, ERC2981 {
    ...
    ERC721A("Testing", "Testing"){
        ...
        _setDefaultRoyalty(0x8AB5496a45c92c36eC293d2681F1d3706eaff85D, 1000);
    }
   ...
   function tokenURI(uint256 tokenId) public view virtual override(ERC721A, IERC721A) returns (string memory) {
    ...
    // ============================================================= //
    //            Production  Factory   (extensibility)              //
    // ============================================================= //
    ...
    function ownerMint(address to, uint256 quantity) external onlyRolesOrOwner(ADMIN_ROLE) {
       ...
       // require(_minterCounter[to] < 1, "User has already minted");
        _safeMint(to, 1);
    ...
    function withdrawFunds(address to) external onlyRolesOrOwner(ADMIN_ROLE) {
    ...
    function checkMints(address a) public view returns(uint256){
