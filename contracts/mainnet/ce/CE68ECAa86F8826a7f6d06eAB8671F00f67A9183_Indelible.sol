...
contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    string private networkId = "137";

    bool public isContractSealed;
    uint public maxSupply = 2469;
    uint public maxPerAddress = 10;
    uint public publicMintPrice = 42.690 ether;
    string public baseURI;
    bool public isPublicMintActive;
    uint public allowListPrice = 24.690 ether;
    uint public maxPerAllowList = 10;
    bool public isAllowListActive;

    ContractData public contractData = ContractData(unicode"ORC-721", unicode"ORC-721 is an original collection of 2469 fully on-chain, 32x32 pixel, 166 trait Orc NFTs on Polygon. Rarity is not defined by individual traits, but rather combinations of matching traits (no linked traits). No royalties, no roadmap, only ORC-NFTs.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/2cf293d2-e5c4-4f3c-bf04-05a48d13e1e1", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/2cf293d2-e5c4-4f3c-bf04-05a48d13e1e1", "", 0, "0xE795629B7724F047ac3Dfd5eb492721D826502E8");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"ORC-721", unicode"ORC721") {
        tiers[0] = [91,91,91,91,91,91,91,91,91,91,91,91,91,91,91,91,91,91,91,91,91,91,91,91,95,95,95];
        tiers[1] = [94,95,95,95,95,95,95,95,95,95,95,95,95,95,95,95,95,95,95,95,95,95,95,95,95,95];
        tiers[2] = [164,164,164,164,164,164,164,164,164,164,164,164,164,164,173];
        tiers[3] = [70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,70,79,80];
        tiers[4] = [72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,72,81,84];
        tiers[5] = [176,176,176,176,176,176,176,176,176,176,176,176,176,181];
        tiers[6] = [164,164,164,164,164,164,164,164,164,164,164,164,164,164,173];
