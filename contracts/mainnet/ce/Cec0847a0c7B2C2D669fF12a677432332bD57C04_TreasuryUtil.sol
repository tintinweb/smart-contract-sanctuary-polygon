...
/*
 * Errors table:
 * E2: newSandManSwapRouter can't be the zero address
...
contract TreasuryUtil is ReentrancyGuard, AccessControl {
    ...
    event SetSandManSwapRouter(address indexed operator, address indexed router);
    event SetDistributionRate(uint256 distributionRate);

    constructor(address _treasuryDAOAddress, address _treasuryLiquidityAddress, address _usdCurrency, address _routerAddress) {
