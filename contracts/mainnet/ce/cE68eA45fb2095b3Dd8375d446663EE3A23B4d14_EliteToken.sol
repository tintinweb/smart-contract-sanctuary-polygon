...
contract EliteToken is ERC31337
{
    ...
    constructor (IERC20 _wrappedToken, address _devAddress) ERC31337(_devAddress, _wrappedToken, "eToken", "eToke")
    {
    ...
    function setFreeParticipantController(address freeParticipantController, bool allow) public onlyController()
    {
    ...
    function setBurnRateController(address burnRateController, bool allow) public onlyController()
    {
