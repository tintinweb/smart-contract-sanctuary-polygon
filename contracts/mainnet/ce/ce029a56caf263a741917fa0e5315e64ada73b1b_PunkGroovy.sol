...
contract PunkGroovy is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Punk Groovy", "PG") {
    setHiddenMetadataUri("ipfs://QmWAsFsQUbid1vuuUW43FtGCgQovopG172PcXRBnWVZeum/hidden.json");
  }
