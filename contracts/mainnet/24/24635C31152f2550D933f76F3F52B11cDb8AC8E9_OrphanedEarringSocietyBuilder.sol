...
abstract contract SimpleDynamicBuilder is AbstractDynamicURI, BaseViciContract {
    ...
    /**
     * @dev updates the NFT attributes.
     *
     * Requirements:
     * - caller MUST be the contract owner or have the URI_MANAGER role.
     */
    function setAttributes(string memory newAttributes) public onlyURIManager {
...
// File: OrphanedEarringSocietyBuilder.sol

/**
 * @title Orphaned Earring Society Builder
 * @dev Intitial NFT content for Orphaned Earring Society NFTs
 * @notice This NFT content will be replace by the purchaser's story.
 *
 * Submit your Orphaned Earring story: https://orphanedearringsociety.com/nominate/

 * Purchase an NFT to share your own orphaned earring story with the
 * society. The author of the most popular story gets the opportunity to
 * meet Michelle Phillips and win her orphaned earring.

 * Each story will become an NFT to live forever on the blockchain and
 * potentially be published in the Orphaned Earring Society book when the
 * campaign is complete. The community would love to hear how you lost your
 * earring and what that earring meant to you.

 * In appreciation of your support, all community voters receive exclusive
 * community privileges. [Learn more](https://orphanedearringsociety.com/product/orphaned-earring-story/).
 */
contract OrphanedEarringSocietyBuilder is SimpleDynamicBuilder {
    ...
    function _initDefaults() internal override {
        ...
        setImageUri("https://storage.googleapis.com/arrival-shadow-motion-newman/vici/lost-earring/LESNFT1_1080x1080.png");
        setAttributes('[{"trait_type":"Type","Value":"Story"}]');
        setDesc(
            "Submit your Orphaned Earring story: https://orphanedearringsociety.com/nominate/"
            "\\n\\n"
            "Purchase an NFT to share your own orphaned earring story with the "
