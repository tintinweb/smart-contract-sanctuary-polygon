...
contract DMiner is Initializable, ERC20Upgradeable, OwnableUpgradeable {
    mapping(address => bool) minters;

    function __init(string calldata name, string calldata symbol)
        public
        initializer
    {
    ...
    function isMinter(address adr) public view returns (bool) {
        return minters[adr];
    }
}
