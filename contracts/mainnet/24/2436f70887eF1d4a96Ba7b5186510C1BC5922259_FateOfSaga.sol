...
contract FateOfSaga is ERC20,ERC20Burnable, Pausable, RoleControle {
    ...
    address first_CEO_Address = 0x8626f6940E2eb28930eFb4CeF49B2d1F2C9C1199;
    address first_CTO_Address = 0x4c352EaA501D487ae2744ACd69b6eB7BC625c7aD;
...
contract RoleControle is Ownable {
    ...
    uint public Num_of_RoleCEO = 1;
    uint public Num_of_RoleCTO = 2;
    uint public Num_of_RoleCFO = 3;
    uint public Num_of_RoleCMO = 4;
    uint public Num_of_RoleCOO = 5;
    ...
    constructor (   
        ...
        roles[_ctoaddr].push(ROLE.CTO_Role);
        roles[_ctoaddr].push(ROLE.CLevel_Role);
