...
abstract contract V2DfynRouter is IDfynRouterV2, DfynImmutable {
    ...
    /// @inheritdoc IDfynRouterV2
    function exactInputSingle(
        ExactInputSingleParamsDfyn calldata params
    ) external payable override returns (uint256 amountOut) {
        amountOut = exactInputInternal(
            params.amountIn,
            params.recipient,
            params.unWrapVault,
            SwapCallbackDataDfyn({path: abi.encodePacked(params.tokenIn, params.tokenOut), payer: msg.sender})
        );
        require(amountOut >= params.amountOutMinimum, 'Too little received');
    }
    ...
    /// @inheritdoc IDfynRouterV2
    function exactOutputSingle(
        ExactOutputSingleParamsDfyn calldata params
    ) external payable override returns (uint256 amountIn) {
        // avoid an SLOAD by using the swap return data
        amountIn = exactOutputInternal(
            params.amountOut,
    ...
    PeripheryImmutableStateV1
{
    ...
    function unwrapWrap(bool v1) public {
...
library PoolHelper {
    bytes32 internal constant POOL_INIT_CODE_HASH = 0x6b2c33d00e75afd81606ef4dc89a3fbdabbeb85187b206d3775d7eee1a6cef4a;
