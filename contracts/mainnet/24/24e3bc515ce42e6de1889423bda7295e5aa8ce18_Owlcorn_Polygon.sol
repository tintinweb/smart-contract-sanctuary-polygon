...
Owlcorn Polygon Collection NFT TOKEN 

https://owlcornpolygon.org/

https://opensea.io/Owlcornpolygon

https://t.me/owlcornpolygon

https://twitter.com/theowlcorn

https://github.com/OwlCornPolygon

https://discord.io/OwlcornPolygon

https://polygon.technology/ecosystem/1272/



======================================================

Owlcorn Collection NFT

This wonderful collection will help bring Polygon network to 
another level and at the same time can add to your wallet 
a measure of magic.

The main idea for this Collection is to raise funds so Polygon
can solve its slowness and scalability issues. Therefore 60%
 from all revenues will be donated to Polygon Matic.

Purchase some of the +10K exclusive NFTs and besides having 
a wonderful workart you will help Polygon to achieve its 
core objective: Bringing the world to Ethereum.


==============================================================

Owlcorn token (Owlcorn)


Owlcorn is a Reflection Token. Where Holders earn USDT Tether
 with every buy or sell transaction on QuickSwap.

You don't have to do anything other than buy and be a Holder. 
No need to add liquidity, no need to add at any Stake location.
...
💎 Supply: 50000000
💎 Circulating Supply: 40000000
💲 Symbol: $Owlcorn
💰 Rewards: 5% to Holders in any negotiation
⛏ Team: 0% of Tokens
🔐 Structure / DEV: Locked (10M Owlcorn)
🏦 Liquidity: Locked
...
contract Owlcorn_Polygon is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Owlcorn Polygon";
    string constant _symbol = "Owlcorn";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xc531900464Db2200181F5e1C824afa92E6682518;
