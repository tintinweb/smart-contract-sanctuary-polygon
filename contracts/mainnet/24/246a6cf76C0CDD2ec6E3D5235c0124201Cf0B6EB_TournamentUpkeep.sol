...
interface ITournamentCoordinator {
...
import { ITournamentCoordinator } from "./interfaces/ITournamentCoordinator.sol";
...
contract TournamentUpkeep is AutomationCompatibleInterface {
    ...
    ITournamentCoordinator coordinator;

    constructor(ITournamentCoordinator _coordinator) {
    ...
    {
        upkeepNeeded = coordinator.canUpdate();
    }
