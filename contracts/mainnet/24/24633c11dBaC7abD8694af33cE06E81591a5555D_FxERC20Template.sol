...
import {EIP712, ECDSA} from "./EIP712.sol";
...
import {ERC20Permit, IERC20Permit} from "../../libraries/ERC20Permit.sol";
import {ERC20, IERC20} from "../../libraries/ERC20.sol";
 ...
 */
contract FxERC20Template is IFxERC20, ERC20, ERC20Permit, ERC165 {
    address internal _fxManager;
    address internal _connectedToken;

    event WithdrawStart(address indexed user, uint256 amount);
    event DepositEnd(address indexed user, uint256 amount);
    ...
    function burn(address user, uint256 amount) public override {
        ...
        emit WithdrawStart(user, amount);
    }
