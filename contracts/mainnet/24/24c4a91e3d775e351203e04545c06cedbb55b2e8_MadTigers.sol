...
contract MadTigers is ERC721 , DefaultOperatorFilterer {
    uint256 public totalSupply;
    uint256 public cost = 3 ether;
    uint256 public maxMints = 9;
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeieuw4mynhlztbahbjeiggqnifi7vkyujfjfvmj5wjff3363fqdhbq/", Strings.toString(tokenId), ".json")
            );
    }
