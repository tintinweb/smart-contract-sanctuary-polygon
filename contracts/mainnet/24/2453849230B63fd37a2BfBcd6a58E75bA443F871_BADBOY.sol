...
contract BADBOY is FlashLoanSimpleReceiverBase {
    ...
    // address SUSHISWAP;
    bytes arbdata;
    enum Direction { UNISWAPTOSUSHISWAP, UNISWAPTOQUICKSWAP, SUSHISWAPTOUNISWAP, SUSHISWAPTOQUICKSWAP, QUICKSWAPTOUNISWAP, QUICKSWAPTOSUSHISWAP } 
    struct ArbInfo {
    Direction direction;
    }
    ...
    if (arbInfo.direction == Direction.UNISWAPTOSUSHISWAP){ 
        ...
        uint256 trade1Acquired = placeTrade(
            ...
            amount,
            UNISWAP_FACTORY,
            UNISWAP_ROUTER                                                                        //  uniswap to sushiswap         
    ...
    if (arbInfo.direction == Direction.UNISWAPTOQUICKSWAP) {
    ...
    if (arbInfo.direction == Direction.SUSHISWAPTOUNISWAP) {
        ...
        // Trade 2 // SELL                                                          //susiswap to uniswap 
        uint256 trade2Acquired = placeTrade(
            WETH,
            fromToken,
            trade1Acquired,
    ...
    if (arbInfo.direction == Direction.QUICKSWAPTOUNISWAP){
        ...
        // Trade 2 // SELL                                                                          //quickswap to uniswap
        uint256 trade2Acquired = placeTrade(
            WETH,
            fromToken,
            trade1Acquired,
    ...
    address me = 0x94B930CB2483FcD89076e13Bb1aE7284062afE31;
