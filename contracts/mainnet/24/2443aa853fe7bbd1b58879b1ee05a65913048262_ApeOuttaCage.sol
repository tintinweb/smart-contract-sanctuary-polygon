...
// File: contracts/ApeOuttaCage.sol
...
contract ApeOuttaCage is ERC721A, Ownable, ReentrancyGuard{
    uint256 public constant maxSupply = 5000;
    uint public _price = 30 ether;
    uint256 public maxBuyPerTx = 5;
    bool public paused;
    

    constructor() ERC721A("ApeOuttaCage", "NFTC") {
        paused = true;
    }
    // Read the price
