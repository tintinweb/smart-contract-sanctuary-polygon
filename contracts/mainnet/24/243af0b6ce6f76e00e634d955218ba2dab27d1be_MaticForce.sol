...
contract MaticForce {
   ...
   uint REGESTRATION_FESS=10 ether;
   uint pool1_price=10 ether;
   uint pool2_price=50 ether ;
   uint pool3_price=100 ether;
   uint pool4_price=500 ether;
   uint pool5_price=1000 ether;
   uint pool6_price=5000 ether;
   uint pool7_price=10000 ether ;
   uint pool8_price=50000 ether;
   uint pool9_price=100000 ether;
   uint pool10_price=500000 ether;
    ...
    UserStruct[] public requests;
      ...
      constructor() public {
        ...
        LEVEL_PRICE[6] = 0.20 ether;
      unlimited_level_price=0.20 ether;
      ...
      require(!pool1users[msg.sender].isExist, "Already in AutoPool");
       ...
       sent = address(uint160(pool1Currentuser)).send(pool1_price);
            ...
            if (sent) {
                ...
                if(pool1users[pool1Currentuser].payment_received>=8)
                {
                    pool1activeUserID+=1;
                }
      ...
      require(!pool2users[msg.sender].isExist, "Already in AutoPool");
       ...
       sent = address(uint160(pool2Currentuser)).send(pool2_price);
            ...
            if (sent) {
                ...
                if(pool2users[pool2Currentuser].payment_received>=8)
                {
                    pool2activeUserID+=1;
                }
      ...
      require(!pool3users[msg.sender].isExist, "Already in AutoPool");
       ...
       sent = address(uint160(pool3Currentuser)).send(pool3_price);
            ...
            if (sent) {
                ...
                if(pool3users[pool3Currentuser].payment_received>=8)
                {
                    pool3activeUserID+=1;
                }
      ...
      require(!pool4users[msg.sender].isExist, "Already in AutoPool");
       ...
       sent = address(uint160(pool4Currentuser)).send(pool4_price);
            ...
            if (sent) {
                ...
                if(pool4users[pool4Currentuser].payment_received>=8)
                {
                    pool4activeUserID+=1;
                }
      ...
      require(!pool5users[msg.sender].isExist, "Already in AutoPool");
       ...
       sent = address(uint160(pool5Currentuser)).send(pool5_price);
            ...
            if (sent) {
                ...
                if(pool5users[pool5Currentuser].payment_received>=8)
                {
                    pool5activeUserID+=1;
                }
      ...
      require(!pool8users[msg.sender].isExist, "Already in AutoPool");
       ...
       sent = address(uint160(pool8Currentuser)).send(pool8_price);
            ...
            if (sent) {
                ...
                if(pool8users[pool8Currentuser].payment_received>=8)
                {
                    pool8activeUserID+=1;
                }
      ...
      require(!pool9users[msg.sender].isExist, "Already in AutoPool");
       ...
       sent = address(uint160(pool9Currentuser)).send(pool9_price);
            ...
            if (sent) {
                ...
                if(pool9users[pool9Currentuser].payment_received>=8)
                {
                    pool9activeUserID+=1;
                }
      ...
      require(!pool10users[msg.sender].isExist, "Already in AutoPool");
       ...
       sent = address(uint160(pool10Currentuser)).send(pool10_price);
            ...
            if (sent) {
                ...
                if(pool10users[pool10Currentuser].payment_received>=8)
                {
