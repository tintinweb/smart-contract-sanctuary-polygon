 ...
 * beememe
 *
 * website: https://beememe.xyz
 * telegram: T.me/beememe
 *
*/
...
contract BeeMeme is ERC20, Ownable {
    uint256 private _totalSupply = 233769420 * (10 ** 18);
    uint256 private _tokenPrice = 200000 * (10 ** 18);

    constructor() ERC20("BeeMeme", "BME") {
