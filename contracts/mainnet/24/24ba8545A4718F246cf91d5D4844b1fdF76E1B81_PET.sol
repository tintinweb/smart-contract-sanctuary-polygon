...
contract PET is ERC721Base {
     ...
     */
    function mintPet(uint256 _numPets) external whenPublicSaleActive {
        require(_numPets > 0, "Must mint at least one pet");
        require(
            _numPets <= maxMintPerTx,
            "_numPets should not exceed maxMintPerTx"
        );
        ...
        emit PublicSaleMint(msg.sender, _numPets);
