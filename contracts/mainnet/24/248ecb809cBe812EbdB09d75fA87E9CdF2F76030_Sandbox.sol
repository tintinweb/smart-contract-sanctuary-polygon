...
import './interfaces/ISandbox.sol';
    ...
    Ownable
{
    ...
    constructor(string memory baseURI_) ERC721('Sandbox uNFT', 'SUNF') {
        baseURI = baseURI_;
    }
    ...
    function batchMint(address recipient, uint256[] calldata tokenIds)
        external
        onlyOperator
    {
