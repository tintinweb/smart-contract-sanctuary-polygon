...
import "./REXStakeDAOTokenHelper.sol";
    ...
    ISuperToken
{
    ...
    REXStakeDAOTokenStorage.sdam3CRVrex internal sdam3CRVrex;
    ...
    function setStakeDAOLP(
     IInstantDistributionAgreementV1 ida,
     IERC20 sdam3CRVAddress,
     ISuperToken sdtxAddress,
    ...
    {
       // TODO:
       sdam3CRVrex.host = _host;
       sdam3CRVrex.ida = ida;
       sdam3CRVrex.sdam3CRV = sdam3CRVAddress;
       sdam3CRVrex.sdtx = sdtxAddress;
       sdam3CRVrex.masterChef = masterChefAddress;
       sdam3CRVrex.pid = pid;
       sdam3CRVrex.owner = owner();

       // Unlimited approve MiniChef to transfer SLP tokens
       sdam3CRVrex.sdam3CRV.approve(address(masterChefAddress), 2**256 - 1);
       IERC20(sdam3CRVrex.sdtx.getUnderlyingToken()).approve(address(sdam3CRVrex.sdtx), 2**256 - 1);

       sdam3CRVrex.initializeIDA();
    }

    function _onlyScalable(uint256 amount) internal virtual {
      // Enforce speed limit on flowRate
      require(amount % 1e9 == 0, "notScalable");
      require(amount >= 1e9, "tooSmall");
    }
    ...
    function transferOwnership(address newOwner) public virtual override onlyOwner {
      ...
      // TODO: Must update IDA shares from old owner to new owner

       super.transferOwnership(newOwner);
       sdam3CRVrex.owner = newOwner;
    }
