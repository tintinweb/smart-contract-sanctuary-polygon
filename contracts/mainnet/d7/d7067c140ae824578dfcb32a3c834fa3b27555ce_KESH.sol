...
contract KESH is ERC20, Ownable {
    ...
    address public _teamWalletAddress = address(0xa1fAfF16E3ab4D7487cB12d2D20b211D5592a852); // Team Wallet
    address public _projectWalletAddress = address(0xa1fAfF16E3ab4D7487cB12d2D20b211D5592a852); //Project Wallet
    ...
    constructor() ERC20("KESH COIN", "KESH") {
        ...
        sellFee.projectFee = 20; // 2% project fee
    ...
    function updateUniswapV2Router(address newAddress) external onlyOwner {
        require(newAddress != address(uniswapV2Router), "KESH: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "KESH: The UniSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "KESH: Automated market maker pair is already set to that value");
