...
// File: contracts/Trippy Hippy Temple PRESALE&PRICE.sol
...
contract TrippyHippyTemple is ERC721Enumerable, Ownable {
  using Strings for uint256;
 ...
 function needToUpdateCost(uint256 _supply) internal view returns (uint256 _cost){
  ...
  function withdraw() public payable onlyOwner {
    ...
    // This will payout the owner (Jack Monsterbox) 100% of the contract balance.
