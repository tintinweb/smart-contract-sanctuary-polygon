...
contract Economics is IEconomics, AuthModifiers, OwnableUpgradeable, ReentrancyGuardUpgradeable, UUPSUpgradeable {
    ...
    {
        if (spentFuel.total == 0) return (0, 0, 0);
        ...
        uint256 _spentFuelOnCredit = spentFuelOnCredit;
        ...
        return (_spentFuel.total, _spentFuel.protocol, _spentFuelOnCredit);
    }
    ...
    /**
     * @notice Returns the version of the contracts, helpful for forcing updates.
     * @return _version semver contract version, matches git tag.
     */
