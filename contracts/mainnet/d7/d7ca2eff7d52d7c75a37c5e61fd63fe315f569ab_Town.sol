...
contract Town is ERC20Burnable, Operator, Ownable {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 60,000 TownSHAREs
    ...
    constructor(address _communityFund, address _devFund) ERC20("TOWN SHARES", "TOWN") {
        _mint(msg.sender, 1 ether); // mint 1 CITY Share for initial pools deployment
