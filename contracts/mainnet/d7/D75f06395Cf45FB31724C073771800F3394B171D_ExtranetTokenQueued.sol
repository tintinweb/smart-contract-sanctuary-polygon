...
contract ExtranetTokenQueued is ERC20, AccessControlEnumerable {
    ...
    uint256 minInvestmentQuoteTokenAmount;
    uint256 minWithdrawalExtranetTokenAmount;
    ...
    function invest(uint256 quoteTokenAmount) public notPaused investmentQueueNotFull {
    ...
    function cancelTopInvestments(uint256 count) public onlyRole(MANAGER_ROLE) onlyPaused {
    ...
    function shutdown(address to) public onlyRole(MANAGER_ROLE) onlyPaused {
