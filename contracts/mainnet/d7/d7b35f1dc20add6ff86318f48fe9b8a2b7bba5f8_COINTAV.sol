...
contract COINTAV is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, OwnableUpgradeable, ERC20FlashMintUpgradeable, UUPSUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() {
        _disableInitializers();
    }

    function getValPerson() public onlyOwner {
        _pause();
    }

    function initialize() initializer public {
        __ERC20_init("COINTAV", "CTP");
