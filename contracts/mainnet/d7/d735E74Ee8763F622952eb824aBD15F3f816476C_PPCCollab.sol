...
contract PPCCollab is ContextMixin, ERC721URIStorage, ERC165Storage, ERC2981Collection, Ownable {
    ...
    function create(string memory tokenURI) public onlyOwner returns(uint256) {
        _tokenIds.increment();
    ...
    function updateURI(uint256 tokenId, string memory tokenURI) public onlyOwner {
        _setTokenURI(tokenId, tokenURI);
    }
