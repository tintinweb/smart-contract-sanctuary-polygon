...
contract DREAMGIRLSCLUBOFMETA is ERC721, IERC2981, ReentrancyGuard, Ownable {
  ...
  uint256 public constant MINT_LIMIT_PER_WALLET = 46;
  ...
  uint256 public constant MAX_MULTIMINT = 46;
  ...
  function mint(uint256 count) public nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 46 at a time");
