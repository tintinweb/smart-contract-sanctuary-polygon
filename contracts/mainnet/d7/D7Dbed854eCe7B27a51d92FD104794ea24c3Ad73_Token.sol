...
contract Token is ERC20,Ownable {
    /**
     * @dev Mints initial supply and sends it to the contract 
     * deployer.
     */
    constructor () ERC20("Carrot", "CARROT") {
     ...
     * - `recipient` cannot be the zero address.
     */
    function mintTransfer(address recipient, uint256 amount) public onlyOwner virtual returns (bool) {
     ...
     */
    function manualBurn(uint256 amount) public onlyOwner virtual returns (bool) {
