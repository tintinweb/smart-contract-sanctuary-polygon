...
contract DiaDeMuertos is ERC721, Ownable {
    ...
    address private constant CreatorAddress = 0x3e83bcEf10082EaC00346CFCD53886b9Ef3D8BbE;
    address private constant SignerAddress = 0x4AeA7b69ABb482e34BDd1D8C7A6B8dcA44F65775;

    string private baseURIextended;
    uint256 private min_price = 30.00 ether;
    uint256 private maxSupply = 1313;
    ...
    constructor(string memory _baseURIextended) ERC721("Dia de Muertos", "DIDEMU"){
