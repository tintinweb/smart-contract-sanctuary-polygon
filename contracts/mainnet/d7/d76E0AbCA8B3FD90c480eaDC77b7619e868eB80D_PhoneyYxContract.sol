...
//*********************************************************************//
//
//  _______  __   __  _______  __    _  _______  __   __  __   __  __   __             ___      _______  ___       
// |       ||  | |  ||       ||  |  | ||       ||  | |  ||  | |  ||  |_|  |           |   |    |       ||   |      
// |    _  ||  |_|  ||   _   ||   |_| ||    ___||  |_|  ||  |_|  ||       |   ____    |   |    |____   ||   |      
// |   |_| ||       ||  | |  ||       ||   |___ |       ||       ||       |  |____|   |   |     ____|  ||   |      
// |    ___||       ||  |_|  ||  _    ||    ___||_     _||_     _| |     |            |   |___ | ______||   |___   
// |   |    |   _   ||       || | |   ||   |___   |   |    |   |  |   _   |           |       || |_____ |       |  
// |___|    |__| |__||_______||_|  |__||_______|  |___|    |___|  |__| |__|           |_______||_______||_______|  
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x7378F58bAC13cf896C65fFe9a46F17b772A74f5F];
  address public erc20Payable = 0x7378F58bAC13cf896C65fFe9a46F17b772A74f5F;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 30, 20000) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeie6dn6t6n4dmgd4z2qwo7nkaup65fsfs3uoh74kqjpxs5oovgl77y/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/luxpmgeWqgqhI2BQHsxq/contract-metadata";
  }
...
// File: contracts/PhoneyYxContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PhoneyYxContract is RamppERC721A {
    constructor() RamppERC721A("PhoneyYX", "Phoney"){}
}