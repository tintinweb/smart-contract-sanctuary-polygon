...
contract cryptolegal is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  constructor(
  ) ERC721("CryptoLegalLottery", "CLL") {
    setBaseURI("http://Ipfs.io/ipfs/Qmeoh6wjncPdnNzskvtDJ3Uph65uSCPhpTvvNaQEAk5bGJ");
    mint(msg.sender, 1);
  }
