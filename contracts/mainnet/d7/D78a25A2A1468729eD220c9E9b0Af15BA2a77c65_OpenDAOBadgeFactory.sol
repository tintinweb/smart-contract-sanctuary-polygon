...
import "./OpenDAOBadge.sol";
import "@openzeppelin/contracts/access/AccessControl.sol";

contract OpenDAOBadgeFactory is AccessControl {
    ...
    function createBadge(address _owner, address _builder, string memory baseURI_  ) public onlyRole(CONTRACTCREATE_ROLE) {
        OpenDAOBadge newContract = new OpenDAOBadge(_owner, _builder, baseURI_ );
...
contract OpenDAOBadge is ERC1238, ERC1238URIStorage, AccessControl {
    ...
    constructor(address owner_, address _builder, string memory baseURI_) ERC1238(baseURI_) {
        owner = owner_;
