    ...
    BaseRelayRecipient
{
    ...
    event ProductAdded(uint, uint, uint, bool, address);
    struct Product {
        uint price;
        uint maxSupply;
        uint currentSupply;
    ...
    constructor(string memory uri) ERC1155(uri) {
        ...
        modifyWhitelist(0xB24Ff220550f692B7C7E6126f45200D74377d915, true);
    }
    ...
    function addProduct(
        ...
        emit ProductAdded(productAvailable, price, maxSupply, start, artist);
        productAvailable += 1;
    }
