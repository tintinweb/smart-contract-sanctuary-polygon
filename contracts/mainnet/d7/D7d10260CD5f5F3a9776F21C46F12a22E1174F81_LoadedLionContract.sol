...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x6d6781f2df3A82c0b533bC7d35bAb41AA2050872];
  address public erc20Payable = 0x6d6781f2df3A82c0b533bC7d35bAb41AA2050872;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmVgBbb9p2v1nfmUcYaZeMA95nHV3MXtN2R22StsXJ2yFG/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/wRui93tndj23K8jlODAn/contract-metadata";
  }
...
// File: contracts/LoadedLionContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract LoadedLionContract is RamppERC721A {
    constructor() RamppERC721A("Loaded Lion", "LoadedLion"){}
}
