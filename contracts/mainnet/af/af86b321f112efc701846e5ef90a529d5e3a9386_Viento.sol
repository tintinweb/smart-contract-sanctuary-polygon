...
contract Viento is ERC721,ERC721URIStorage, Ownable {
   using Counters for Counters.Counter;
    Counters.Counter public _tokenIds;
    
    uint16 public constant maxSupply = 155;
    string private _baseTokenURI;


    constructor() ERC721("Alejandra Sieder x Soda Factory", "AXS") {        
        //30 for team
        for (uint8 i = 0; i < 155; i++) {
            _tokenIds.increment();
