...
// File: contracts/FreshBeets.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract FreshBeets is
    ERC1155,
    Ownable,
    Pausable,
    ERC1155Supply,
    ...
    Allowlist
{
    ...
    string public name = "Fresh Beets";
    string public symbol = "FreshBeets";
    string public contractURI = "ipfs://bafyreibobj6iq7rg6wsi77taemkclrlt7unr6r2oa43urrk4zxpgyxmy5y/metadata.json";
