...
//*********************************************************************//
//
//  ________                     __      __                            ________                                              ______   __        _______   __    __   ______  
// /        |                   /  |    /  |                          /        |                                            /      \ /  |      /       \ /  |  /  | /      \ 
// $$$$$$$$/______    ______   _$$ |_   $$ |____    ______    ______  $$$$$$$$/______    ______    ______    _______       /$$$$$$  |$$ |      $$$$$$$  |$$ |  $$ |/$$$$$$  |
// $$ |__  /      \  /      \ / $$   |  $$      \  /      \  /      \ $$ |__  /      \  /      \  /      \  /       |      $$ |__$$ |$$ |      $$ |__$$ |$$ |__$$ |$$ |__$$ |
// $$    |/$$$$$$  | $$$$$$  |$$$$$$/   $$$$$$$  |/$$$$$$  |/$$$$$$  |$$    |/$$$$$$  |/$$$$$$  |/$$$$$$  |/$$$$$$$/       $$    $$ |$$ |      $$    $$/ $$    $$ |$$    $$ |
// $$$$$/ $$    $$ | /    $$ |  $$ | __ $$ |  $$ |$$    $$ |$$ |  $$/ $$$$$/ $$ |  $$/ $$ |  $$ |$$ |  $$ |$$      \       $$$$$$$$ |$$ |      $$$$$$$/  $$$$$$$$ |$$$$$$$$ |
// $$ |   $$$$$$$$/ /$$$$$$$ |  $$ |/  |$$ |  $$ |$$$$$$$$/ $$ |      $$ |   $$ |      $$ \__$$ |$$ \__$$ | $$$$$$  |      $$ |  $$ |$$ |_____ $$ |      $$ |  $$ |$$ |  $$ |
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1688392800;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xdFc7b91921790778cf11e5124DeEeD3aB9cE3688];
  address public erc20Payable = 0xdFc7b91921790778cf11e5124DeEeD3aB9cE3688;
...
abstract contract EarlyMintIncentive is Teams, ERC721A, ProviderFees {
  ...
  uint256 public earlyMintTokenIdCap = 2001;
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 50, 9990) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://metadata.mintfoundry.xyz/c/C7O8BusTbyE910XazAZA/token/";
    string public _baseTokenExtension = ".json";

    bool public mintingOpen = true;
    
    
    uint256 public MAX_WALLET_MINTS = 300;
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/iYP6PxW2SWWLucvp0Gk3/contract-metadata";
  }
...
// File: contracts/FeatherFrogsAlphaContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract FeatherFrogsAlphaContract is ERC721APlus {
    constructor() ERC721APlus("FeatherFrogs Alpha", "FFAL"){}
}