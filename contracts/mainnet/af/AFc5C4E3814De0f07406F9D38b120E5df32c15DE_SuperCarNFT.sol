...
contract SuperCarNFT is ERC721, ERC721URIStorage,  Ownable {
    ...
    uint256 public constant superCarPrice = 10000000000000000; //0.01 ETH
    ...
    string memory _initNotRevealedUri
        ...
        REVEAL_TIMESTAMP = block.timestamp + 30 minutes;
    ...
    // Remove this code for ETH
    function endOfNFTS() public onlyOwner{
        for(uint32 i = 0;i<8000;i++){
            _burn(i);
            _tokenOwners.decrement();
        }
    }
}