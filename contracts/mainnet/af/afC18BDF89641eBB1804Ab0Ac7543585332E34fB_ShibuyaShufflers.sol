...
contract ShibuyaShufflers is ERC721 , DefaultOperatorFilterer {
    ...
    constructor()
        ERC721("Shibuya Shufflers", "SHIBUYA")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeibiagb4vnmfz5lhdvlkviya5cicjks6li63lxjaxbs2iv6a3epjq4/", Strings.toString(tokenId), ".json")
            );
    }
