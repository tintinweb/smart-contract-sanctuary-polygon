 ...
 * @notice This contract handles minting Beeloud - season 0 tokens.
 */
contract BeeloudSeason0 is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xB716274d1008231c4e39df129AEb5eFB767036d4;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x1D52afb293D543335F394bCd86Aca1E1D3ad3676;
    address[] public payoutAddresses = [
        0x1D52afb293D543335F394bCd86Aca1E1D3ad3676
    ];
    ...
    string public name = "Beeloud - season 0";
    string public symbol = "Bee 0";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeigxznd6eab2oml4lsltbfmbkaiclkng3u4fu63vu6pas5davoknye/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenPublicSaleStartTime[1] = 1681707600;
        tokenPublicSaleEndTime[1] = 1682838000;
