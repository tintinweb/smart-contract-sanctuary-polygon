...
contract ERC20Redemption is ChainlinkClient, ConfirmedOwner {
  ...
  function createCreateRedemptionRequest(
    ...
    string memory requestUrl = string.concat(
      "https://us-central1-huddl-in.cloudfunctions.net/createERC20Redemption?projectId=",
      iToHex(
        abi.encodePacked(
  ...
  function createRedeemRequest(
    ...
    string memory requestUrl = string.concat(
      "https://us-central1-huddl-in.cloudfunctions.net/updateXpScoreRedemption?projectId=",
      iToHex(
