...
contract Dimenzia is ERC721, Ownable{
    ...
    constructor() payable ERC721 ('Dimenzia','DMZ'){
        mintPrice = 100 ether;
        totalSupply = 0;
        maxSupply = 18000;
    }
    ...
    function withdraw() external onlyOwner{
        (bool succress,)= msg.sender.call{value: address(this).balance}("");
        require(succress, 'withdraw failed');
    }

    function mint(uint256 _tokenId) public payable{
        require(_tokenId >= 200, 'You cant mint this Dimenzia');
        require(isMintEnabled, 'Mint hasnt started');
        require(msg.value >= mintPrice, 'Not enough money');
        require(isMinted[_tokenId] == false, 'This NFT already minted');
