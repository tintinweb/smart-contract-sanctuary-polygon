...
/**
 * @title TrophyNFT
 * @dev ERC721 contract used by the LEVERADE TrophyVerse application.
 * @custom:security-contact [email protected]
 */
contract TrophyNFT is ERC721, ERC721Burnable, Ownable {
    /**
     ...
     */
    constructor(string memory baseTokenURI) ERC721("Test LEVERADE Trophy", "TTROPHY") {
        _baseTokenURI = baseTokenURI;
    }

    /**
     * @dev Safely mint new token `tokenId` and transfer it to `to`.
     *
