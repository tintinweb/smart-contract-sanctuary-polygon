    ...
    ReentrancyGuard
{
    ...
    function setFeePercentage(uint256 _feePercentage) external onlyAdmin {
        require(_feePercentage <= 100, "Fee cant exceed 1%");
    ...
    function updateDevWallet(address _addr) external onlyAdmin {
        ...
        require(hasRole(DEFAULT_ADMIN_ROLE, _addr), "admin role required");
        devWallet = _addr;
    }
    ...
    function updateMaintainer(address _addr) external onlyAdmin {
        ...
        require(hasRole(MAINTAINER_ROLE, _addr), "maintainer role required");
        maintainer = _addr;
    }
    ...
    function deposit(
        ...
        require(asset.balanceOf(msg.sender) >= assets, "Insufficient Assets");
    ...
    function redeem(
        ...
        require(
            ...
            "Insufficient withdrawal request"
        );
