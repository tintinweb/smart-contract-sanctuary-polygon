...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardCoin = IBEP20(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270);
...
contract HexInferno is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address RewardCoin = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270;
    address public WBNB = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "HexInferno";
    string constant _symbol = "HEXI";
    ...
    uint256 public swapThreshold = 10000 * 10 ** 18; // 0.005%
    bool inSwap;
    ...
    constructor (
        ...
        marketingFeeReceiver = 0xA040fa7897e322f5b8C3dd3444fAcF2333c1a081;
