...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x17F07af4852D60b688c6aaf027A2C40eaCdeC2Ff];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://Qmb2h8vJHkEhL37zKr7tmMmY95Z4REyh7TMWw7cN13PjsU/";
...
// File: contracts/SlotteryContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SlotteryContract is RamppERC721A {
    constructor() RamppERC721A("Slottery", "SLOT"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/wyL0Tjfevp35pw8b1Mnp/contract-metadata";
    }
}