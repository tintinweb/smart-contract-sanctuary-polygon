...
contract PiBirds is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 public constant PRICE_PER_TOKEN = 6 ether; // 6 MATIC
    ...
    constructor() ERC721("PiBirds", "PiBirds") {}
    ...
    function mint(uint32 num) public payable callerIsUser {
        ...
        require(
            num <= MAX_PUBLIC_MINT - minted[msg.sender],
            "Exceeded max token per purchase"
        );
        require(ts + num <= MAX_SUPPLY, "Purchase would exceed max tokens");
        require(
            PRICE_PER_TOKEN * num <= msg.value,
        ...
        emit NFTMint(msg.sender, ts + 1, num);
    }
