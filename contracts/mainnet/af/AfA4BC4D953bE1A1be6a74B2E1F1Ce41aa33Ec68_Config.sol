...
contract Config is AccessControl, Initializable, UUPSUpgradeable {
     ...
     */
    function setInfiTokenAddr(address newAddr)
        external
    ...
    function setMaxDevaluation(uint256 newValue)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
    ...
    function setMonitoringPeriod(uint256 newValue)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
    ...
    function setMaxPayoutPeriod(uint256 newValue)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
    ...
    function setValidationPreviousPeriod(uint256 newValue)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
