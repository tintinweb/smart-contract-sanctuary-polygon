...
contract MojoQuest is Initializable, UUPSUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable, VRFConsumerBaseUpgradeable{
    ...
    function getQuestInfo(uint256 tokenId, address tokenContract) public view returns(uint8, uint256){
        ...
        return(tokenToEntries[tokenId][tokenContract], timeRemaining);
    }
