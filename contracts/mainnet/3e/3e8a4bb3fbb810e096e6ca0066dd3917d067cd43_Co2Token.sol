...
contract Co2Token is ERC20Interface, SafeMath {
    string constant public name = "CO2 TOKEN";
    string constant public symbol = "CO2T";
    uint8 constant public decimals = 18;
    uint256 constant public _totalSupply = 20000000 * 10 ** 18;
