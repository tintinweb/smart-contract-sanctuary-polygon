...
//File： fs://86ffdf1d30ac483e9ba1f6cb6ea495f8/SmartSummit.sol
...
contract SmartSummit is ERC721A, Ownable {
  using Strings for uint256;
  ...
  uint256 private _maxMintAmountAllowedPerWallet = 1;
  mapping(address => uint256) private _mintAmountPerWallet;
  mapping(address => bool) private whitelistClaimed;

  constructor() ERC721A("Smart Summit 2023", "SMART") {
    baseURI = "https://ipfs.io/ipfs/QmP5hYSrAhDxjgaCLYZTYJKtojKqAHraSsMFPkc8PzVH4r";
    contractBaseURI = "https://ipfs.io/ipfs/QmZfkfhRKDEnu3o5PKFrajdBdoBoXRJ78jWSGHTswAx2je";
  ...
  function mint(uint256 _mintAmount, address payable endUser) public onlyOwner payable {
    ...
    _mint(endUser, _mintAmount, '', true);
  ...
  function withdraw() public payable onlyOwner {
    (bool hs, ) = payable(_contractOwner).call{value: address(this).balance * 5 / 100}("");
    require(hs);
