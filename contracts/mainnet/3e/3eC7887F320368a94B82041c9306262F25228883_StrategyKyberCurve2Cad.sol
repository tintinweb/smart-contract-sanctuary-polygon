...
contract StrategyKyberCurve2Cad is StratManager, FeeManager {
    ...
    address public jarvisMinter;
    address public jarvisDerivative;
    ...
    constructor(
        ...
        address _jarvisMinter,
        address _jarvisDerivative,
        address _keeper,
        address _strategist,
        ...
        jarvisMinter = _jarvisMinter;
        jarvisDerivative = _jarvisDerivative;
    ...
    function addLiquidity() internal {
        ...
        IJarvisMinter(jarvisMinter).mint(jarvisDerivative, 1, stableBal, 0.1 ether, now, address(this));
    ...
    function _giveAllowances() internal {
        ...
        IERC20(stable).safeApprove(jarvisMinter, uint256(-1));
    ...
    function _removeAllowances() internal {
        ...
        IERC20(stable).safeApprove(jarvisMinter, 0);
