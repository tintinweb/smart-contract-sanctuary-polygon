...
import "./AVGLTokenL2.sol";

contract AVGLBridgeL2 is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    using SafeMath for uint256;

    AVGLTokenL2 public avgl;
    ...
    function transferTokenOwnership(address _newOwner) external onlyOwner {
        avgl.transferOwnership(_newOwner);
    }
    ...
    function claimAVGL(
        ...
        txClaimed[txid] = true;
        avgl.mint(msg.sender, claimAmount);
    }
}
...
contract AVGLTokenL2 is ERC20("AVGL", "AVGL"), Ownable {
    using SafeMath for uint256;
