    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 100, 31415) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeidtdvpw4i36qidvzoi7yzhgbyag3ayflpyhenyuaqshx6srjzp5oe/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/iJ71Oo1Jp4BCknHxIkvD/contract-metadata";
  }
...
// File: contracts/SpacePiAstronautV2Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SpacePiAstronautV2Contract is RamppERC721A {
    constructor() RamppERC721A("Space Pi Astronaut V2 ", "PiNFT"){}
}
