...
contract mudrex is ERC721Enumerable, Ownable {
    using Strings for uint256;

    string public baseURI;
    uint256 public constant MAX_SUPPLY = 100;
    address private devAddress = 0x5a095129022145dEFb69AB9538e4Fd58a542367A;
    ...
    function _beforeTokenTransfer(
        ...
        // Ensure the token cannot be transferred once minted (Soulbound)
        require(from == address(0), "DegenDorms: token is non-transferable");
    }
