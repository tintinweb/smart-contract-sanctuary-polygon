...
contract AimGames_SpaceGuardian is ERC721Enumerable, Ownable {
    ...
    uint256 public PRICE =225 ether;
    uint256 public MAX_MINT = 1;

    mapping (address => uint256) public Minted;
    mapping (address => uint256) public VIPAmounts;
    string public baseTokenURI;
    constructor(string memory baseUR) ERC721("AimGames Space Guardian", "AGSG") {
        setBaseURI(baseUR);
    }
