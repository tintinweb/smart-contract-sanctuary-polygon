...
contract MATICStable {
	using SafeMath for uint256;

	uint256 constant private INVEST_MIN_AMOUNT = 5 ether; 
	uint256 constant private INVEST_MAX_AMOUNT = 100000 ether; 
	uint256[] private REFERRAL_PERCENTS = [50, 30, 20];
	uint256 constant private TOTAL_REF = 100;
	uint256 constant private CEO_FEE = 60;
