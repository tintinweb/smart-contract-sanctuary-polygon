...
Polygon Floki, following the hype on every chain, we're arrived on Polygon!
@PolygonFloki
...
contract POKI is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "POKI";
    ...
    constructor () {
        ...
        // 
        _teamWallet       = 0x6343cb0499f056feCE31CDc71057379867Aff094;
        _marketingWallet = 0x6343cb0499f056feCE31CDc71057379867Aff094;
        ...
        _isExcludedFromAntiWhale[address(0x6343cb0499f056feCE31CDc71057379867Aff094)]            = true; // constructor address
        _isExcludedFromMaxTx[owner()] = true;
        _isExcludedFromMaxTx[address(0x6343cb0499f056feCE31CDc71057379867Aff094)] = true; // constructor address
