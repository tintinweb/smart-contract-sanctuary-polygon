    ...
    ExtensionPause
{
    ...
    function _stake(uint256 amountLP, uint256 cost) internal {
        ...
        console.log("cost >= stakeCost", cost, stakeCost);
    ...
    function _swapStake(uint256 amountForSwap, address[] memory path)
        internal
        returns (uint256 amount, uint256 cost)
    {
        uint256[] memory amounts = IUniswapV2Router02(_adapter)
            .swapExactTokensForTokens(
                amountForSwap,
