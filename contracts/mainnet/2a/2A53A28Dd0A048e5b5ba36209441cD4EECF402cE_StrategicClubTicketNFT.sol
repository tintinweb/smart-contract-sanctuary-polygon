 ...
 * @notice NFT ticket data (i.e. location, date, etc...) will be specified in NFT metadata traits
 */
    ...
    Ownable
{
    ...
    function airdropSingle(
        ...
        uint256 minted_token_id = totalSupply();

        for (uint256 i = 0; i < amount; i++) {
            safeTransferFrom(owner(), receivers_[i], minted_token_id, 1, "");
        }

        emit TokensAirdropped(receivers_, minted_token_id, amount);
    }
