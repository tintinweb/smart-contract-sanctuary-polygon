...
contract CustomerWalletV1{
    ...
    function Withdraw() ownerAccessOnly external returns(bool){
        ...
        if(currentEarnings[fiskPayAddress] >= 1000000){
            ...
            uint256 devBalance = (currentEarnings[fiskPayAddress] * 9) / 1000 ;
        ...
        for(uint8 i = 1; i < tokenCount; i++){
            ...
            if(fisk.CheckIfTokenEnabled(tokenAddress)){
                ...
                if(currentEarnings[tokenAddress] >= 1000000){
                    ...
                    uint256 devBalance = (currentEarnings[tokenAddress] * 18) / 1000 ;
        ...
        if(currentCoins >= 1000000){
            ...
            uint256 devBalance = (currentCoins * 13) / 1000;
