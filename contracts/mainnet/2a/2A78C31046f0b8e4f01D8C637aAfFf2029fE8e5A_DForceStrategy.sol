...
abstract contract LendBorrowLendStrategy is UpgradeableBase, IStrategy {
     ...
     */
    function setSwapInfo(SwapInfo memory swapInfo, uint8 index)
        external
        onlyOwner
    {
    ...
    function claimRewards() public override onlyOwnerAndAdmin {
        ...
        // Get remained amount
        int256 diff = LendBorrowLendStrategyHelper.getDiffAmountForClaim(
            _strategyStatistics,
            _logic,
            multiLogicProxy,
            supplyXToken,
        ...
        if (diff > 0 && rewardsTokenKill == false) {
            ...
            // RepayBorrow
            ILendingLogic(_logic).repayBorrow(_strategyXToken, uint256(diff));
        }
        ...
        onlyMultiLogicProxy
    {
        ...
        ILendingLogic(_logic).redeemUnderlying(_supplyXToken, amount);
