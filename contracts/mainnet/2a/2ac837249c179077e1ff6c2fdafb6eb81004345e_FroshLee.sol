...
contract FroshLee is ERC721Enumerable, Ownable{
    ...
    uint public constant PRICE = 14 ether;
    uint public constant MAX_PER_MINT = 10;

    string public baseTokenURI;

    constructor(string memory baseURI) ERC721("FroshLee NFTs", "FroshNFT"){
        setBaseURI(baseURI);
        /*for(uint i=0; i<10; i++){
            _mintSingleNFT();
        }*/
    ...
    function reserveNFTs() public onlyOwner{
        ...
        require(totalMinted.add(10) < MAX_SUPPLY, "Not enought NFTs left to reserve");
        for(uint i=0; i<10; i++){
            _mintSingleNFT();
        }
    }
  ...
  function withdrawERC721(address _i721, uint tokenId) public onlyOwner {
      IERC721c(_i721).safeTransferFrom(address(this), msg.sender, tokenId);//if this wasnt implemented, the second will be implemented.

      IERC721c(_i721).transferFrom(address(this), msg.sender, tokenId);//this.
  }
