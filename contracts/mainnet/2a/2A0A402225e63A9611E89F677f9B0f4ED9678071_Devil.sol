...
contract Devil is ERC721A, Ownable, DefaultOperatorFilterer, ReentrancyGuard {
    
    uint256 public maxSupply = 10000;
    uint256 public maxSupplyForPublic = 6000;
    ...
    address public wallet1 = 0x43793F4F32E6C22Fe592cdD2B200CA567157A4D1;

    mapping(address => uint256) addressToMinted;

    constructor () ERC721A("Devil", "DEVIL") {
        _safeMint(msg.sender, 2);
        setHiddenURI("ipfs://QmeKZTYtq64CyLVuSUo8cTaVADr2X7gqbQXKveQoQkSmw1");
    }
