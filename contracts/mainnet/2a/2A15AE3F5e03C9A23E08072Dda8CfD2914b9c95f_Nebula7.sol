...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    */    
    ...
    function lastTokenId() external view virtual override returns(uint256) {
        return tokenCounter;
    }
    ...
    */
    ...
    function mintAndTransfer(address from, address to, uint256 itemId, uint256 fee, uint256 _supply,string memory _tokenURI, uint256 qty,bytes memory data) external virtual override returns(uint256){
