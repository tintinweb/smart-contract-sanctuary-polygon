    ...
    OwnableUpgradeable
{
    ...
    function unlistMarketItem(
        ...
        emit MarketItemUnlisted(itemId, nftContract, tokenId, seller, false);
    }

    /// Change Price

    event PriceChange(uint256 indexed itemId, address seller, uint256 price);
    ...
    function changePrice(
        ...
        emit PriceChange(itemId, seller, newPrice);
    }
