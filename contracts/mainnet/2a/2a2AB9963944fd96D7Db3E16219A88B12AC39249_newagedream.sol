...
contract newagedream is ERC721  {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeiemc7vytzcubw6bz35bl3zsd7y37outwigl2wwq74mj4kqiqu6uke/", Strings.toString(tokenId), ".json")
            );
    }
