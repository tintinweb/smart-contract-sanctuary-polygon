...
contract InstaAutomationImplementation is InstaAutomationHelper {
    ...
    function _submitAutomationRequest(
        address user_,
    ...
    function executeAutomation(
        ...
        emit LogExecuteAutomation(user_, id_, nonce_, isSafe_, metadata_);
    ...
    // function systemUpdateAutomation(
    //     address[] memory users_,
    //     bytes[] calldata metadatas_
    // ) public onlyExecutor {
...
abstract contract Events is Variables {
    ...
    event LogUpdateBufferHf(uint128 oldBufferHf, uint128 newBufferHf);

    event LogUpdateMinHf(uint128 oldMinHf, uint128 newMinHf);
