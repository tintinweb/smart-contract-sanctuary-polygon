...
contract Fruit is IERC20, Ownable {
    using SafeMath for uint256;

    address constant ROUTER        = 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff;
    address constant WBNB         = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270;
    address constant DEAD          = 0x000000000000000000000000000000000000dEaD;
    address constant ZERO          = 0x0000000000000000000000000000000000000000;

    string _name = "Fruit";
    string _symbol = "Fruit";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000 * (10 ** _decimals);
    uint256 public _maxWalletSize = (_totalSupply * 100) / 100;   // 3%
    ...
    constructor () {
        ...
        autoLiquidityReceiver = 0x5195625860227F3dA2a5db992925AF51B9C745cd;
        marketingFeeReceiver = 0x5195625860227F3dA2a5db992925AF51B9C745cd;
        devFeeReceiver = 0x5195625860227F3dA2a5db992925AF51B9C745cd;
