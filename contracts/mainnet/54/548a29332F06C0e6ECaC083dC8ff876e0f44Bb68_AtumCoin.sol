...
contract AtumCoin is ERC20, ERC20Burnable, Pausable, Ownable, ERC20Permit, ERC20Votes {
    constructor() ERC20("AtumCoin", "ATUM") ERC20Permit("AtumCoin") {
        _mint(msg.sender, 192000000 * 10 ** decimals());
    }
