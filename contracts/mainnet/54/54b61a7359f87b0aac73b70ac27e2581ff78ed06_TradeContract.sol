...
contract TradeContract {
   ...
   address public adminWallet = address(0x066bFd8588C211eaf72b77ce4C47DCf7B5844f47);

   function changeAdmin(address newAdminAddress) public{
       require(msg.sender == address(0x066bFd8588C211eaf72b77ce4C47DCf7B5844f47), "Only admin can perform this action");
