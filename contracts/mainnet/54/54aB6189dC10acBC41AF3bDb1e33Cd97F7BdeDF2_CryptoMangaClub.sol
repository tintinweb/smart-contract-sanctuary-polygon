...
contract CryptoMangaClub is ERC721AQueryable, Ownable, ReentrancyGuard {
    ...
    uint256 public nftsLimitPerAddress = 10;
    ...
    function giftNfts(address _reciever, uint256 _mintAmount) public onlyOwner {
        require(
