...
contract Pool is Ownable, ReentrancyGuard {
    ...
    uint256 public priceBand = 25e14; // = 0.0025; CR will be adjusted if XToken > 1.0025 ETH or XToken < 0.9975 ETH
    uint256 public minCollateralRatio = 1e6;
    uint256 public yTokenSlippage = 100000; // 10%
    bool public collateralRatioPaused = false;

    // fees
    uint256 public redemptionFee = 9000; // 6 decimals of precision
    uint256 public constant REDEMPTION_FEE_MAX = 9000; // 0.9%
    uint256 public mintingFee = 4000; // 6 decimals of precision
...
library WethUtils {
    ...
    IWETH public constant weth = IWETH(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270); //WMATIC
