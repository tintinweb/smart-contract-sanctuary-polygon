...
/* SapphireMine - Mine Sapphire, Earn MATIC. Repeat - Start mining now! https://www.sapphiremine.money/ */
...
contract Ownable is Context {
    ...
    */
    constructor () {
      ...
      _marketing = 0x00BaeDAb111C0A74b8390a89379cB616Ffa70E4f;
      _team = 0xf7E7Ffb53F0163E5fE2Ac2E9c8149c144e58C6aC;
      _web = 0xbD0d5DfB063693C9285e14fcD0432AC448132Ba2;
    }
...
contract TestorSapphireMine is Context, Ownable {
    using SafeMath for uint256;

    uint256 private SAPPHIRES_TO_HATCH_1MINERS = 1080000;//for final version should be seconds in a day
    ...
    function harvestSapphires(address ref) public {
        ...
        uint256 newMiners = SafeMath.div(sapphiresUsed,SAPPHIRES_TO_HATCH_1MINERS);
    ...
    function sellSapphires() public {
        ...
        uint256 fee3 = webFee(sapphireValue);
        uint256 fee4 = teamFee(sapphireValue);
        claimedSapphire[msg.sender] = 0;
        lastHarvest[msg.sender] = block.timestamp;
    ...
    function buySapphires(address ref) public payable {
        ...
        sapphiresBought = SafeMath.sub(sapphiresBought,webFee(sapphiresBought));
        sapphiresBought = SafeMath.sub(sapphiresBought,teamFee(sapphiresBought));
    ...
    function getSapphiresSinceLastHarvest(address adr) public view returns(uint256) {
        uint256 secondsPassed=min(SAPPHIRES_TO_HATCH_1MINERS,SafeMath.sub(block.timestamp,lastHarvest[adr]));
