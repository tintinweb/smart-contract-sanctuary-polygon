...
contract OnetickVault is IVault, IUniswapV3MintCallback, IUniswapV3SwapCallback, ERC20, ReentrancyGuard {
    ...
    constructor(
        ...
        IERC20(IUniswapV3Pool(_pool).token0()).approve(
            _nftPositionManager,
            0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff
        );
        IERC20(IUniswapV3Pool(_pool).token1()).approve(
            _nftPositionManager,
            0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff
        );
    ...
    {
        // TODO: debug single-sided initial deposit
