...
contract MrBrainWtf is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeiaegoegyazg42vpude7zjhmtpb2qlom7firxgj5ixwq7u5u4egdlm/", Strings.toString(tokenId), ".json")
            );
    }
