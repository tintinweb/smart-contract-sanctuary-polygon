...
contract MaticCropsFarmer {
    ...
    uint256 public MIN_INVEST_LIMIT = 1 * 1e17; /** 9.9 matic  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 25 * 1e18; /** 2000 matic  **/
    ...
    //fund contract with matic before launch.
    ...
    /** How many miners and eggs per day user will recieve based on matic deposit **/
