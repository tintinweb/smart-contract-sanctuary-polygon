...
contract GammaLPFarmV1 is BaseSiloAction {
    ...
    constructor(string memory _name, address _siloFactory) {
        name = _name;
        metaData = "address[5],address[5],uint256[2],uint256,address[2]";
    ...
    function prepareShareLp(
        ...
        if (inputAmounts[1] > 0 && inputAmounts[2] == 0) {
            ...
            if (price > 0) {
                ...
                price = getUniPrice(QUICK_V2_ROUTER, path, inputAmounts[2]);
    ...
    function enter(
        ...
        (
            ...
            address[2] memory rewarders
                ...
                configuration,
                (address[5], address[5], uint256[2], uint256, address[2])
            );
    ...
    function checkReward(
        address[2] memory rewarders
    ) internal returns (uint256[2] memory balances) {
        uint256 i;
    ...
    function createConfig(
        ...
        configData = abi.encode(_inputs, _outputs, _triggers, _pid, rewarders);
    }
