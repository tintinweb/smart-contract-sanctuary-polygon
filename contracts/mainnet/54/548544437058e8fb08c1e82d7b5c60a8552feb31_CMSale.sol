...
contract CMSale is Ownable {
  ...
  event CreateSale(uint256 saleID, string name, uint256 startTime, uint256 endTime, uint256 cap, uint256 price, uint256 currencyID, uint256 sharedCapID);
  ...
  event Buy(uint256 saleID, uint256 quantity, uint256 serialNo, address indexed buyer);
...
// ### Replace TEST currencies with real ones ##################################
...
currencies.push(Currency(bytes12(bytes("TEST_USDC")),0xc901743229645153d6d827f5F1fae0A95Ddc210D));
// #############################################################################
  }
