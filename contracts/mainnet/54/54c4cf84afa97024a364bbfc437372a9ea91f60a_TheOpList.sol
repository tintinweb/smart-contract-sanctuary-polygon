...
//constructor
    constructor(address creator) {
        ...
        posts.push(Post({id: 0, opinion: "Hello World", opTime: block.timestamp}));
        emit OpCreated(creator, "Hello World", block.timestamp);
    }
...
//events
    ...
    function create() public returns (OpList) {
        ...
        OpList oplist = new OpList(payable(msg.sender));
