...
contract StakeUpFarm is Ownable, ReentrancyGuard {
    // Token
    IERC20 public BUSD = IERC20(0xc2132D05D31c914a87C6611C10748AEb04B58e8F);
    ERC20Burnable public SUF = ERC20Burnable(0x3c059100d108Bd5ffBF55b4A777048077c22E6b9);

    // Configurables
    uint256 public MINTdaily = 10;
    uint256 public STAKEdaily = 5;
    ...
    address public feeWallet = 0x1AB5c60415e3bd5e9F9f0d7341A6571501Be0cbA;

    // Multiplier prices
    uint256 public x125 = 0.1 ether;
    uint256 public x150 = 0.2 ether;
    uint256 public x175 = 0.3 ether;
    uint256 public x2 = 0.4 ether;
