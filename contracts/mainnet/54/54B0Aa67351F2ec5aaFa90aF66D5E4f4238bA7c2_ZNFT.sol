 ...
 */
contract ZNFT is Ownable, ERC721A, EIP712 {
    ...
    string private _contractURI = "ipfs://Qmc48beSeEVEF3a22LKgRxwTA3Ti22hpmzzpix1Jjzj6zh";
    ...
    // token ID to nft config
    mapping(uint => NFTConfig) public _nftConfigs; 
    ...
    function whitelistMint(
        ...
        _nftConfigs[_currentIndex] = NFTConfig(block.timestamp, msg.sender, block.timestamp);
    }
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        return bytes(baseURI).length != 0 ? string(abi.encodePacked(baseURI, 'id=', tokenId.toString(), '&address=', _nftConfigs[tokenId].minter, '&mintTime=', _nftConfigs[tokenId].mintTime, '&lastTs=', _nftConfigs[tokenId].lastTs)) : '';
    }
