...
contract Bshare is ERC20Burnable, Operator {
    ...
    uint256 public constant DAO_FUND_POOL_ALLOCATION = 4500 ether;
    uint256 public constant TEAM_FUND_POOL_ALLOCATION = 4500 ether;
    ...
    constructor(uint256 _startTime, address _daoFund, address _teamFund) public ERC20("Butter Shares", "BSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 BSHARE Share for initial pools deployment
