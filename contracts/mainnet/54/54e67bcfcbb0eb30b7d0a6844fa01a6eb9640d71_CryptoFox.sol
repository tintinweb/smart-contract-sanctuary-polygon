...
contract CryptoFox is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("CryptoFox", "CF") {
    setHiddenMetadataUri("ipfs://QmSLM2EwRwrJ6SyPrg86S3ZQE3BxTm5ERpPCmTKEoSQ27a/hidden.json");
  }
