...
import "ERC721.sol";
import "Ownable.sol";
import "ToadPaymentSplitter.sol";

contract Toadz is ERC721, ToadPaymentSplitter, Ownable {
    uint256 public constant maxTokens = 365;    
    uint256 public constant maxMintsPerTx = 1;
    uint256 public tokenPrice = 6900000000000000; //0.0069 ether
 ...
 */
contract ToadPaymentSplitter is Context {
    using SafeMath for uint256;
