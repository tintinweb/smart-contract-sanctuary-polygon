 ...
 */
contract AvaxtarsClub is ERC721, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public constant apePrice = 8000000000000000000; //0.08 ETH
     ...
     */
    function reserveAva() public onlyOwner {        
    ...
    * Mints Bored Apes
    */
    function mintAva(uint numberOfTokens) public payable {
