...
contract TestBound is ERC721, ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("OrbSoulbound", "ORBSBT") {}
    ...
    function burn(uint256 tokenId) external {
        require(ownerOf(tokenId) == msg.sender, "Only Token Owner Can Burn This Token");
        _burn(tokenId);
    }
