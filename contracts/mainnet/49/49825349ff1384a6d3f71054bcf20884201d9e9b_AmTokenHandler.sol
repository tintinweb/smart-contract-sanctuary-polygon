 ...
 */
contract AmTokenHandler is IDepositExecute, HandlerHelpers, UpgradableOwnable, ERC20Safe {
    ...
    function executeProposal(
        ...
        uint256 amountToWithdraw = ILendingPool(AAVE_POLYGON_LP_ADDR).withdraw(tokenAddress, amount, erc20Handler);

        IBridge(_bridgeAddress).internalDeposit(LACHAIN_ID, amTokenResources[resourceID], amountToWithdraw, recipientAddress);
