...
contract CommunityTreasury is Treasury {
    ...
    */
    function initialize(address registry_, bytes memory signature_) public initializer {
        __Treasury_init(Constants.COMMUNITY_TREASURY, registry_, signature_);
    }
    /**
...
abstract contract Treasury is RegisterableUpgradeableBase {
    ...
    */
    ...
    @param signature_ Signature from deployer for Registry
    */
    function __Treasury_init(bytes32 key_, address registry_, bytes memory signature_) internal onlyInitializing {
    ...
    @param signature_ Signature from deployer for Registry
    */
    function __Treasury_init_unchained(bytes32 key_, address registry_, bytes memory signature_) internal onlyInitializing {
        __Treasury_init(key_, registry_, signature_);
    }
    /**
