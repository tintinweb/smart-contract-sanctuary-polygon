...
enum AmmData { APE, QUICK, SUSHI, DFYN, JET, WAULT, BONE, POLYCAT, NULL }
...
library AMMData {
    ...
    uint constant public NUM_AMMS = 8;
    
    address constant public APE_FACTORY = 0xCf083Be4164828f00cAE704EC15a36D711491284;
    address constant public QUICK_FACTORY = 0x5757371414417b8C6CAad45bAeF941aBc7d3Ab32;
    address constant public SUSHI_FACTORY = 0xc35DADB65012eC5796536bD9864eD8773aBc74C4;
    address constant public DFYN_FACTORY = 0xE7Fb3e833eFE5F9c441105EB65Ef8b261266423B;
    address constant public JET_FACTORY = 0x668ad0ed2622C62E24f0d5ab6B6Ac1b9D2cD4AC7;
    address constant public WAULT_FACTORY = 0xa98ea6356A316b44Bf710D5f9b6b4eA0081409Ef; 
    address constant public BONE_FACTORY = 0xf1F4d4C5F4C20DDAC22CF5FBEdEe025401645c95;
    address constant public POLYCAT_FACTORY = 0x477Ce834Ae6b7aB003cCe4BC4d8697763FF456FA;
    
    //used for internally locating a pair without an external call to the factory
    bytes32 constant public APE_PAIRCODEHASH = hex'511f0f358fe530cda0859ec20becf391718fdf5a329be02f4c95361f3d6a42d8';
    bytes32 constant public QUICK_PAIRCODEHASH = hex'96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f';
    bytes32 constant public SUSHI_PAIRCODEHASH = hex'e18a34eb0e04b04f7a0ac29a6e80748dca96319b42c54d679cb821dca90c6303';
    bytes32 constant public DFYN_PAIRCODEHASH = hex'f187ed688403aa4f7acfada758d8d53698753b998a3071b06f1b777f4330eaf3';
    bytes32 constant public JET_PAIRCODEHASH = hex'505c843b83f01afef714149e8b174427d552e1aca4834b4f9b4b525f426ff3c6';
    bytes32 constant public WAULT_PAIRCODEHASH = hex'1cdc2246d318ab84d8bc7ae2a3d81c235f3db4e113f4c6fdc1e2211a9291be47';
    bytes32 constant public BONE_PAIRCODEHASH = hex'06fd5cbbb236425013aaf86e956638e6888c10bea58ca23d9bef578c3df5b83d';
    bytes32 constant public POLYCAT_PAIRCODEHASH = hex'3cad6f9e70e13835b4f07e5dd475f25a109450b22811d0437da51e66c161255a';
    
    // Fees are in increments of 1 basis point (0.01%)
    uint constant public APE_FEE = 20; 
    uint constant public QUICK_FEE = 30;
    uint constant public SUSHI_FEE = 30;
    uint constant public DFYN_FEE = 30;
    uint constant public JET_FEE = 0;
    uint constant public WAULT_FEE = 20;
    uint constant public BONE_FEE = 20;
    uint constant public POLYCAT_FEE = 24;
    ...
    function factoryToAmm(address _factory) public pure returns(AmmData amm) {
        ...
        if (_factory == WAULT_FACTORY) return AmmData.WAULT;
        if (_factory == BONE_FACTORY) return AmmData.BONE;
        if (_factory == POLYCAT_FACTORY) return AmmData.POLYCAT;
        revert("");
    }
    ...
    function factory(AmmData _amm) public pure returns(address) {
        ...
        if (_amm == AmmData.WAULT) return WAULT_FACTORY;      
        if (_amm == AmmData.BONE) return BONE_FACTORY;      
        if (_amm == AmmData.POLYCAT) return POLYCAT_FACTORY;      
    ...
    function pairCodeHash(AmmData _amm) public pure returns(bytes32) {
        ...
        if (_amm == AmmData.WAULT) return WAULT_PAIRCODEHASH;      
        if (_amm == AmmData.BONE) return BONE_PAIRCODEHASH;      
        if (_amm == AmmData.POLYCAT) return POLYCAT_PAIRCODEHASH;      
        revert();
    }
    ...
    function fee(AmmData _amm) public pure returns (uint) {
        ...
        if (_amm == AmmData.WAULT) return WAULT_FEE;      
        if (_amm == AmmData.BONE) return BONE_FEE;      
        if (_amm == AmmData.POLYCAT) return POLYCAT_FEE;    
        revert();
    }
...
library PriceGetter {
    ...
    //Ape LP addresses
    address public constant WMATIC_USDT_PAIR = 0x65D43B64E3B31965Cd5EA367D4c2b94c03084797;
    address public constant WMATIC_DAI_PAIR = 0x84964d9f9480a1dB644c2B2D1022765179A40F68;
    address public constant WMATIC_USDC_PAIR = 0x019011032a7ac3A87eE885B6c08467AC46ad11CD;
    
    address public constant WETH_USDT_PAIR = 0x7B2dD4bab4487a303F716070B192543eA171d3B2;
    address public constant USDC_WETH_PAIR = 0x84964d9f9480a1dB644c2B2D1022765179A40F68;
    address public constant WETH_DAI_PAIR = 0xb724E5C1Aef93e972e2d4b43105521575f4ca855;
    ...
    function getRawLPPrice(address lp, uint maticPrice, uint ethPrice) public view returns (uint) {
    ...
    function getRawPrice(address token, uint maticPrice, uint ethPrice) public view returns (uint rawPrice) {
        uint pegPrice = pegTokenPrice(token, maticPrice, ethPrice);
        if (pegPrice != 0) return pegPrice;
    ...
    function pegTokenPrice(address token, uint maticPrice, uint ethPrice) public pure returns (uint) {
