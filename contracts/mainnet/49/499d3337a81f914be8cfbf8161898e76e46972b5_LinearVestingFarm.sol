        ...
        onlyOwner
    {
        if(!partialFunding){
            ...
            uint256 minNeededAmount = totalRewards
                ...
                .div(100);
            uint256 balanceOfFarm = vestedToken.balanceOf(address(this));
            if(totalRewardsPendingBalance.sub(balanceOfFarm) < minNeededAmount){
                minNeededAmount = totalRewardsPendingBalance.sub(balanceOfFarm);
            }
