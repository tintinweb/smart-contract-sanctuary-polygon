...
contract Accounts is Constant, Initializable{
    ...
    */
        ...
        )
    {
        ...
        // Ensure that the liquidator has deposited (borrower's borrowed tokens)
        ...
        // Ensure that borrower has really borrowed tokens
        ...
        // minimum of above two amt, to find the tokenAmount up for liquidation
        ...
        // repayAmount = liquidator re-paying borrowed-token amount on behalf of borrower
        ...
        // payAmount = liquidator getting collateral-token amount from borrower's account
