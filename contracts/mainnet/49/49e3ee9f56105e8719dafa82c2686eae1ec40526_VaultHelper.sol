...
contract VaultHelper  {
    ...
    function getLPTokenInfo(address _address) public view returns (LPTokenData memory tokenData){
        tokenData.Name  = getTokenName(_address);
        ...
        tokenData.token0Address = abi.decode(token0addr,(address));
        tokenData.token1Address = abi.decode(token1addr,(address));
        return tokenData;
    }
