...
contract AIrtisan005 is ERC721Tradable {
    constructor()
        ERC721Tradable("AIrtisan005", "AIRT5")
    {}
 ...
 */
abstract contract ERC721Tradable is ERC721, ERC721URIStorage, ContextMixin, NativeMetaTransaction, Ownable {
    using SafeMath for uint256;
    ...
    function tokenURI(uint256 _tokenId) override(ERC721, ERC721URIStorage) public view returns (string memory) {
        ...
        return string(abi.encodePacked(baseTokenURI(), super.tokenURI(_tokenId)));
    }
