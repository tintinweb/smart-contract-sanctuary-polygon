    ...
    ReentrancyGuardUpgradeable
{
    ...
    function createListing(ListingParameters calldata _params) public override {
        ...
        address tokenOwner = IERC721(_params.assetContract).ownerOf(
            _params.tokenId
        );
        ...
        // Find SaleType
        SaleType saleType = SaleType.Secondary;
        (address receiver, ) = IERC2981(_params.assetContract).royaltyInfo(
            _params.tokenId,
            _params.buyoutPrice
        );
        if (receiver == IERC721(_params.assetContract).ownerOf(_params.tokenId))
    ...
    function payout(
        ...
        transferCurrency(_currencyToUse, _payer, royaltyTreasury, marketCut);
    ...
    function withdrawFunds(address to, address currency) external onlyOwner {
