...
/** 
 *  SourceUnit: /Users/twy/Projects/union-contracts/contracts/asset/AssetManager.sol
*/
...
contract AssetManager is Controller, ReentrancyGuard, IAssetManager {
     ...
     *  @param tokenAddress ERC20 token address
     *  @param marketId MoneyMarkets array index
     *  @return tokenSupply, rate(compound is supplyRatePerBlock 1e18, aave is supplyRatePerYear 1e27)
     */
