...
contract NX175 is Ownable, ReentrancyGuard, IERC1155Receiver {
    ...
    function updateBonusElectrumAmount(uint amount) external onlyOwner {
    ...
    function depositNft(
        ...
        uint currentStakedNftCount = 0;
        uint availableIndex = maxSubNftLimit;
    ...
    event DepositCount(uint currentStakedNftCount, uint maxSubNftLimit);
    ...
    function getUserTotalBonus(address account) public view returns (
                uint256 boost
                // uint256 boost, 
                // uint bonusCount,
                // uint bonusThreshold,
