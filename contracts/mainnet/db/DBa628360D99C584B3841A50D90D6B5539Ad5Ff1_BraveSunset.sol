...
contract BraveSunset is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor(string memory _initBaseURI) ERC721A("Brave Sunset", "BVS") {
	...
	receive() external payable {
		(bool s1, ) = payable(owner()).call{value: address(this).balance}("");
