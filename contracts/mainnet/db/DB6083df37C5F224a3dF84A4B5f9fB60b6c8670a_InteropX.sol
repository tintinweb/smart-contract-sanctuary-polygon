...
contract Internals is Events {
     ...
     */
    function _getImplementationSigaturesSlot(address implementation_)
        internal
        pure
        returns (bytes32)
    {
     ...
     */
    function _getSignaturesImplementationSlot(bytes4 sig_)
        internal
        pure
        returns (bytes32)
    {
    ...
    function _setImplementationSigs(
        ...
        bytes32 slot_ = _getImplementationSigaturesSlot(implementation_);
        ...
        for (uint256 i = 0; i < sigs_.length; i++) {
            bytes32 sigSlot_ = _getSignaturesImplementationSlot(sigs_[i]);
            require(
    ...
    {
        bytes32 slot_ = _getSignaturesImplementationSlot(sig_);
...
contract Events {
    ...
    event LogSetNullImplementation(
        address oldDummyImplementation,
        address newDummyImplementation
    );
