 ...
 * @notice This contract handles minting MAHSA tokens.
 */
contract MAHSA is
    ERC721A,
    ERC721AQueryable,
    ...
    ERC2981
{
    ...
    string public baseTokenURI =
        "ipfs://bafybeifljfl3miw6rawc5lvpds4m2ubqelavasnrmkgfcucyxyaive6cc4/";
    // Maximum supply of tokens that can be minted
    uint256 public MAX_SUPPLY = 600;
    uint256 public publicMintsAllowedPerAddress = 5;
    uint256 public publicMintsAllowedPerTransaction = 600;
    ...
    uint96 public royaltyFee = 3000;

    constructor(address _blocklistContractAddress) ERC721A("MAHSA", "MAHSA") {
