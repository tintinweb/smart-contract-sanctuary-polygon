 ...
 */
contract EverydayAvatar is ERC721, ERC721URIStorage, ERC3664Updatable, Ownable, AccessControl {
    ...
    //Maintenance possible using URI_SETTER_ROLE
    ...
    constructor(address dataContract, address payable treasury) ERC721("Everyday Avatar", "EA") ERC3664("") {
