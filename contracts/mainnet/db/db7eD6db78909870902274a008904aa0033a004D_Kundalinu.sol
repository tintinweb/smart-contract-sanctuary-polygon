...
contract Kundalinu is ERC20, Ownable, CuratedByToken("1.0"), FeeProcessor{
constructor(address payable feeReceiver_) 
        payable 
        ERC20("Kundalinu", "Kunda")
        FeeProcessor(feeReceiver_){
            // Tokenomics
            //Owner
            _mint(0x0Feaa8A231D16357C633F9f505E30777d04F8Bec,  100000* 10 ** decimals());
