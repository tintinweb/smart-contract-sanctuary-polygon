...
contract theERC721Contract is ERC721Enumerable, PaymentSplitter, Ownable, ReentrancyGuard {
    ...
    uint public pricePresale = 50 ether;

    uint public priceSale = 55 ether;
    ...
    address[] private _team = [
        0x2c2820744684fef8d5c3C97116d051ef2A6Fc309,
        0x5C5bCe21eaCe9C50706C17ae00b613E135D4B3A0
    ];
    ...
    constructor(string memory _theBaseURI, string memory _notRevealedURI, bytes32 _merkleRoot) ERC721("UnKnOwNPunKsNFT", "UKPs") PaymentSplitter(_team, _teamShares) {
