...
// File: contracts/60 Days Sober/SobrietyCoin60DaysSober.sol
...
contract SobrietyCoin60DaysSober is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("SOBRIETY Coin for 60 DAYS SOBER", "SOBER60Day") {
    setHiddenMetadataUri("ipfs://QmYbwyFqgHhnb7vtzR4BNJ29XkdJawBW3wgrkNjdTCxs6A/hidden.json");
  }
