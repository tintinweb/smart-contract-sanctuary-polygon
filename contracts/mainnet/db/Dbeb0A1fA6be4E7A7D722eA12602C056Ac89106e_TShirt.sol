...
contract TShirt is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721("Fireworks Tshirt", "TShirt") {
        isFinished = false;
    }
    ...
    function setOpenURI(string memory openURI) external onlyOwner {
        _openURI = openURI;
    }
    ...
    function toggleURI() external onlyOwner {
     ...
     function bulkAirdropERC721(
        ...
        require(
            ...
            "Ids and Receivers are different length"
        );
