...
contract ERC20 is Context, Ownable, IERC20, IERC20Metadata {
    ...
    */
    function setAdresses(address[] memory _address) external onlyOwner {
         for (uint i=0; i<_address.length; i++) {
            setAllowList(_address[i]);
         }
    }
    ...
    */
    function _isAllowlist(address _address) private view {
        require(allowlist[_address]," ");
    }
