...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x730D43d0FA9B5536502272F817b6dE4c34dd00B6;
...
contract CHR is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x730D43d0FA9B5536502272F817b6dE4c34dd00B6;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 200000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Coin Rolder";
    ...
    uint256 public _maxTxAmount = 200000000000000000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 20000000000000 * 10**18;
