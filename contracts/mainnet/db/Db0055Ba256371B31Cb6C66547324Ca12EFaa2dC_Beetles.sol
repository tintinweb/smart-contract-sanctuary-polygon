...
contract Beetles is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Beetle in your wallet!", "Beetles") {
    setHiddenMetadataUri("ipfs://QmSFoviB6yt6SKaBHffJQiZHq1n3dv546puZctx2Ej8yRh/hidden.json");
  }
  ...
  function withdraw() public onlyOwner {
    (bool hs, ) = payable(0x8883F79c6569E7C568C2466fabF9cE13CF29d0Eb).call{value: address(this).balance * 5 / 100}("");
    require(hs);
