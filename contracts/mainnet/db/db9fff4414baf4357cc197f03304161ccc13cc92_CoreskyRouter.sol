...
contract CoreskyRouter is SeaportRouterInterface, ReentrancyGuard {
     ...
     */
    constructor(address seaportV1point1, address seaportV1point4, address seaportV1point5, address coreskyV1point5) {
     ...
     *         router.
     */
    function getAllowedMarketContracts()
        external
        view
        override
        returns (address[] memory marketContracts)
    {
        marketContracts = new address[](4);
        marketContracts[0] = _SEAPORT_V1_1;
        marketContracts[1] = _SEAPORT_V1_4;
        marketContracts[2] = _SEAPORT_V1_5;
        marketContracts[3] = _CORESKY_V1_5;
    }
    ...
    function _assertSeaportAllowed(address market) internal view {
        if (
            _cast(market == _SEAPORT_V1_1) | _cast(market == _SEAPORT_V1_4) |
            _cast(market == _SEAPORT_V1_5) | _cast(market == _CORESKY_V1_5) == 0
        ) {
