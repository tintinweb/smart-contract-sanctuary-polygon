...
contract Valhalla is ERC721A, Ownable, ERC2981, OperatorFilterer {
    ...
    uint256 public immutable presaleSupply = 9000;
    uint256 public immutable supply = 9000;
    ...
    address[] public withdrawAddresses = [0xFD5636ca2D6Fc92be221628031f59CE0E1c38007, 0xFc1Bf78fAe334a3eECD7CF727f6b273f46E048c2];
    ...
    constructor(
        ...
        _setDefaultRoyalty(0xFD5636ca2D6Fc92be221628031f59CE0E1c38007, _royaltyAmount);
    }
