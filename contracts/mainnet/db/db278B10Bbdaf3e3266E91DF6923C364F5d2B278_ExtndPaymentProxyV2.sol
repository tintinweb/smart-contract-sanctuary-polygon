...
import "../ExtndRedeem/IExtndRedeemV2.sol";

contract ExtndPaymentProxyV2 is Ownable, SignatureVerify {
    IExtndRedeemV2 internal _redeem;
    ...
    function setRedeemAddress(IExtndRedeemV2 _redeemAddress) external onlyOwner {
