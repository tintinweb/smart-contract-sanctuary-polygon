...
contract Yuga_Term5 is TermBase, ExpressTerms {
    ...
    function term(
        ...
        return
            "ii.  Licensee agrees that it will not do anything that might directly or indirectly tarnish, degrade, disparage or reflect adversely on Licensor or its business or reputation or that would be detrimental to any of Licensor's trademarks or their associated goodwill, and will not challenge the validity of any of Licensor's trademarks or make any claim adverse to Licensor, including but not limited to registering or attempting to register any of Licensor's trademarks or any mark incorporating any of Licensor's trademarks, the Licensee's Use, or a substantially similar mark, as a trademark or service mark for any goods or services.\n \n ";
    }
}