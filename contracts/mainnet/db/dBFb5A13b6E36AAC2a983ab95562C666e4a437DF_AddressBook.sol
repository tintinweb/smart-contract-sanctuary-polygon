...
contract AddressBook is IAddressBook, Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    mapping(uint16 => uint128) public override scoreGlobalLimit;
    ...
    function setScoreGlobalLimit(uint16 score, uint128 limit) public override onlyOwner {
        scoreGlobalLimit[score] = limit;
    }
