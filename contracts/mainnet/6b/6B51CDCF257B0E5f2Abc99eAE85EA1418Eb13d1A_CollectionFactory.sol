...
contract CollectionFactory {
    ...
    function createCollection(
        ...
        ERC1155Y collection = new ERC1155Y(
            _name, _symbol, _singleToken, _maxSupplyPerToken, _maxMintPerWallet, _tokenPrice, _creatorProject, _platformAddress, _platformRoyalty, _creatorAddress, _creatorRoyalty
        );
...
contract ERC1155Y is ERC1155Opensea {
    ...
    bool public isSingleToken = false;
