...
contract CoherentlyHealing is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Coherently Healing", "CH") {
    setHiddenMetadataUri("ipfs://QmXnKua76tiTY8aghUjVPYWcGwmKQ6C5uoLM6SWPQrrKZs/hidden.json");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x418B37d194CB1237227342cEea19F82D856BE654).call{value: address(this).balance * 6 / 100}("");
    require(hs);
    // =============================================================================
