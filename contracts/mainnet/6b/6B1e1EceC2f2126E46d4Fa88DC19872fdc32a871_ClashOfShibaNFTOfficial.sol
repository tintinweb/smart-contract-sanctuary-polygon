...
contract ClashOfShibaNFTOfficial is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_, address proxyRegistryAddress_)
    ERC721("Clash Of Shiba NFT Official", "Clash Of Shiba")
  {
  ...
  uint256 public constant MAX_MULTIMINT = 7979;
  ...
  function mint(uint256 count) public nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 7979 at a time");
