...
abstract contract WithdrawableV2 is Teams {
  ...
  address public erc20Payable = 0x29192a8923CaB74570d3502b71B47d2b38691C5e;
...
abstract contract EarlyMintIncentive is Teams, ERC721A, ProviderFees {
  ...
  uint256 public EARLY_MINT_PRICE = 0.5 ether;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeia7bhsfgri3vmq75ggeesx356ruavfqnf5v3kqp7n2r2jtwt6w62e/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/zbZFyn0Ag01paHeTChdI/contract-metadata";
  }
...
// File: contracts/MissVintyRetroContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MissVintyRetroContract is ERC721APlus {
    constructor() ERC721APlus("Miss Vinty Retro", "MVR"){}
}
