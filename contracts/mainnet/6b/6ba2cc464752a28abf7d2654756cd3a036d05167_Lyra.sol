...
contract Lyra is ERC721A, Ownable {
    ...
    uint256[] priceTiers = [0.04 ether, 0.05 ether, 0.06 ether, 0.07 ether, 0.08 ether];
    ...
    function wl_mint(uint256 quantity, bytes32[] calldata proof) public 
        payable
        maxSupplyCheck(quantity) 
        wlMintCheck 
    {
        ...
        returns (string memory)
    {
        ...
        return
            string(
                abi.encodePacked(baseURI, _toString(tokenId), extension)
            );
    }
