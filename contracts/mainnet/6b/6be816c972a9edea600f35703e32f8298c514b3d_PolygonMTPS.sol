...
// File contracts/PolygonMTPS.sol


pragma solidity >=0.7.6 <0.8.0;
contract PolygonMTPS is Recoverable, UsingUniversalForwarding, ChildERC20 {
using ERC20Wrapper for IWrappedERC20;
...
address initWallet
) ChildERC20("MetaPass", "MTPS", 18, "", childChainManager) UsingUniversalForwarding(forwarderRegistry, universalForwarder) Ownable(msg.sender) {
