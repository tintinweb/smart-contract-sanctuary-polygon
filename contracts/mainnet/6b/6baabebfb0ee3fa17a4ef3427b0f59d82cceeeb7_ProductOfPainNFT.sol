...
// File: contracts/ProductOfPainNFT.sol
...
contract ProductOfPainNFT is ERC721, Ownable, ReentrancyGuard, RoyaltiesV2Impl  {
...
//Setting up the contract state when deployed
  ...
  bool public revealImages = false;
...
*/
  ...
  modifier withdrawComplience(uint256 _amount){
      require(_amount < address(this).balance, "Contract balance can't be 0 ! Not enough funds");
      _;
  }
/*
...
/*
  @_addr -> removing 1 address from the whiteList
*/
...
function walletOfOwner(address _owner)
  ...
  function revealAllImages() public onlyOwner {
      revealImages = true;
  }
  function hideAllImages() public onlyOwner {
      revealImages = true;
  }
  /*
...
/*
  @_notRevealedURI Set's the hidenmetadata URI -> //ipfs://CDI/hidden.json/
*/
...
/*
  @_state Pauses the contract, no one can mint any more
*/  
...
*/
    function withdrawTo(address payable _to, uint256 _amount) public onlyOwner withdrawComplience(_amount){
