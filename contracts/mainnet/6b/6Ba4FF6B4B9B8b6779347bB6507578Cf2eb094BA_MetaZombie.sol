...
/**
Meta Zombie - The first FPS zombie game on Polygon
https://metazombietoken.com
https://t.me/metazombietoken
*/
...
contract MetaZombie is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 2500000 * 10**decimals();
    ...
    address private marketingWallet = 0x3A41f3Ef20b4a692225414153699d0d40F4A254b;

    address private devWallet = 0x3A41f3Ef20b4a692225414153699d0d40F4A254b;
    ...
    Taxes public taxes = Taxes(3, 4, 3);

    Taxes public sellTaxes = Taxes(5, 5, 5);
    ...
    constructor(address routerAdd, address serviceFeeReceiver) ERC20("Meta Zombie", "$ZOMBIE") payable {
    ...
    function updatedeadline(uint256 _deadline) external onlyOwner {
        ...
        require(!tradingEnabled, "Can't change when trading has been enabled");
    ...
    function bulkExemptFee(address[] memory accounts, bool state) external onlyOwner {
       ...
       function updateMaxWalletlimit(uint256 amount) external onlyOwner {
        ...
        require(amount >= 2000000, "Cannot set max wallet amount lower than 0.1%");
