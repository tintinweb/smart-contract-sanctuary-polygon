...
contract ZBITLIONS is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function setNftPerAddressLimit(uint256 _limit) public  {
    ...
    function setCostAddressFunc(address addressSetcost) public onlyOwner {
        setCostAddress = addressSetcost;
    }
