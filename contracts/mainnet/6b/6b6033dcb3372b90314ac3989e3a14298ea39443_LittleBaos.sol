...
// File: contracts/LittleBaoContract.sol
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    if (msg.sender != owner()) {
        ...
        if(onlyWhitelisted == true) {
            ...
            //use wlCost if onlyWhitelisted is true
            require(msg.value >= wlCost * _mintAmount, "insufficient funds");
        }
        else {
          //use cost if onlyWhitelisted is not true
