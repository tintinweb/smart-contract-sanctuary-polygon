...
contract StrategyClearpoolV2 is ReentrancyGuard, Ownable, CoreRef {
    ...
    address public CPOOL = 0xb08b3603C5F2629eF83510E6049eDEeFdc3A2D91;
    ...
    function setCPOOLAddress(address _cpool) public onlyGovernor {
        require(_cpool != address(0), "Zero address");
        CPOOL = _cpool;
    }

    function withdrawCPOOL(uint256 amount, address to) public onlyGovernor {
        IERC20(CPOOL).safeTransfer(to, amount);
    }
...
import "@openzeppelin/contracts/utils/ReentrancyGuard.sol";
import "../refs/CoreRef.sol";
import "../interfaces/IMasterWTFNoLock.sol";
import "../interfaces/IVotingEscrow.sol";

contract MasterWTFNoLock is IMasterWTFNoLock, CoreRef, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    function safeRewardTransfer(address _to, uint256 _amount) public onlyGovernor returns (uint256) {
