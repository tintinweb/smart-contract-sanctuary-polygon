...
ReentrancyGuard
{
    ...
    address _manager;
    string public name = "Crowdfunding Platform on Polygon";
    string public symbol = "CFPT";
    ...
    function emergencyRefund(uint256 targetDonationId) public onlyOwner
    {
    ...
    */
    ...
    function revokeDonation(uint256 targetDonationId)  public
    {
    ...
    /*
        ...
        existingDonationId  - this parameter should be 0 unless the backer has
                              ...
                              a new donation.
    */
    function donate(uint256 targetCampaignId, uint256 existingDonationId) payable public
    {
    ...
    */
    ...
    function closeCampaign(uint256 cid, uint256 supporterTokenId) public
    {
        require(campaign2End[cid] != 0, CFPS.STR_CAMPAIGN_CLOSED);
    ...
    */
    ...
    function createCampaign(uint startDate, uint endDate, uint256 target) public whenNotPaused
    {
