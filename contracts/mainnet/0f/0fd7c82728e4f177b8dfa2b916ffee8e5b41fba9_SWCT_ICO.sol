...
contract SWCT_ICO is Ownable {
    ...
    uint256 public MAX_CONTRIBUTE_PRIVATE = 50000 ether; // 50000 MATIC
    uint256 public MAX_CONTRIBUTE_PRESALE = 50000 ether; // 50000 MATIC
    uint256 public MAX_CONTRIBUTE_PUBLIC = 50000 ether; // 50000 MATIC
    ...
    uint256 public START_DATETIME_PRESALE = 1672556400; // January 01, 2023 12:00:00 AM GMT
    uint256 public END_DATETIME_PRESALE = 1677628740; // February 28, 2023 4:59:00 PM GMT
    uint256 public START_DATETIME_PUBLIC = 1677654000; // March 1, 2023 12:00:00 AM GMT
    uint256 public END_DATETIME_PUBLIC = 1682899140; // April 30, 2023 4:59:00 PM GMT
    ...
    function contributeForPrivate() external payable {
        require(block.timestamp >= START_DATETIME_PRIVATE && block.timestamp <= END_DATETIME_PRIVATE, "ICO is not activated");
    ...
    function contributeForPresale() external payable {
        require(block.timestamp >= START_DATETIME_PRESALE && block.timestamp <= END_DATETIME_PRESALE, "ICO is not activated");
    ...
    function claimForPrivate() external {
    ...
    function setSalePeriodPresale(uint256 _startTimestamp, uint256 _endTimestamp) external onlyOwner {
        START_DATETIME_PRESALE = _startTimestamp;
        END_DATETIME_PRESALE = _endTimestamp;
    }
    function setSalePeriodPublic(uint256 _startTimestamp, uint256 _endTimestamp) external onlyOwner {
        START_DATETIME_PUBLIC = _startTimestamp;
        END_DATETIME_PUBLIC = _endTimestamp;
    }


    function finishICO(bool isFinished) external onlyOwner {
        ICO_ENDED = isFinished;
    }
