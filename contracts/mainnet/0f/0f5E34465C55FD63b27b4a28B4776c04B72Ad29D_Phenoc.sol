...
contract Phenoc  is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'Phenoc';
    string private constant _symbol = 'PNC';
    uint8 private constant _decimals = 9;
    uint256 private _totalSupply = 10 * 10**14 * (10 ** _decimals);
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    uint256 public _maxTxAmount = ( _totalSupply * 150 ) / 10000000;
    uint256 public _maxWalletToken = ( _totalSupply * 500 ) / 1000000;
