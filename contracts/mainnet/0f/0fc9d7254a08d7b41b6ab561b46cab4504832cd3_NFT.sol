...
// File: contracts/Ranghmar bone warrior.sol
...
contract NFT is ERC721Enumerable, Ownable {
  ...
  uint256 public maxSupply = 11111; //тут пишите общее количество нфт в вашей коллекции
  uint256 public maxMintAmount = 11111;  // то количество нфт которое будет сминчено вместе с деплоем смарт контракта
 ...
 function whitelistUser(address _user) public onlyOwner {
  ...
  function withdraw() public payable onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x4D18b95009e71f9BcD10062fdbdc5311bc2aFC07).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
