...
contract PLGFactory is permission {

    address public owner;
    mapping(string => address) public getAddr;
    ...
    function updateFactoryAddress(string memory key,address account) public forRole("owner") returns (bool) {
        getAddr[key] = account;
        return true;
    }
