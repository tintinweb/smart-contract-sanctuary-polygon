...
contract TreasuryVault is UUPSUpgradeable, OwnableUpgradeable {
    /* ========== INITIALIZER ========== */
    function _authorizeUpgrade(address) internal override onlyOwner {}
    ...
    function withdraw(uint256 _amount) external onlyOwner {
        TransferHelper.safeTransferMATIC(msg.sender, _amount);
    }

    function withdrawAll() external onlyOwner {
        TransferHelper.safeTransferMATIC(msg.sender, address(this).balance);
    }
}