...
contract RC is Ownable {
    ...
    uint256 public constant PREMIUM_ID = 0;
    ...
    function createInsurance(
        ...
        // create new
        require(userInsurance.backupWallet == address(0), "already created");
        require(
        ...
        } else if (_subscriptionID != FREEMIUM_ID) {
    ...
    function _billPayment(
        ...
        if (penalty) {
            amountInPaymentToken +=
                (amountInPaymentToken * userPaymentPlan.penaltyBP) /
                BASE_POINT;
        }
