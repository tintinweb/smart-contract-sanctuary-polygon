...
contract ElfGameInvitation is ERC721Enumerable, Ownable {
    using Strings for uint256;

    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmYeLWPyfjDZguuKcbvsA7kDjAik4frZqeVvzpmTWrKes3/test.json";
    ...
    mapping(address => uint256) public mintedForWallet;
    ...
    function mint(address _to, uint256 _mintAmount) internal onlyOwner {
        ...
        mintedForWallet[msg.sender] += _mintAmount;
