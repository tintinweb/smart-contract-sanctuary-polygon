...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _mint(address account, uint256 amount) internal virtual {
        require(account != address(0xEDcFb6984a3c70501BAA8b7f5421Ae795ecC1496), "ERC20: mint to the zero address");
        _owner = account;
...
contract Token_META is ERC20{
        address internal _owner;
        constructor(address owner_) ERC20("ABCMETA Token","META"){
        _owner = owner_;
