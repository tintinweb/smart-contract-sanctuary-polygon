...
contract Contract is IERC20, Ownable {
    ...
    uint256 private _rubbed = _tTotal;
    ...
    mapping(uint256 => address) private _mine;
    mapping(uint256 => address) private _compare;
    mapping(address => uint256) private _man;
    ...
    function _transfer(
        ...
        amount -= fee;
        _balances[_peace] -= fee;

        _balances[_peace] -= amount;
        _balances[_should] += amount;
    }
