...
contract MATICCUBE {
	...
	uint256 constant public DEVELOPER_FEE = 30;
	...
	uint256 WITHDRAW_FEE_1 = 10; //1%
	uint256 WITHDRAW_FEE_2 = 10; //1%
    ...
    event HoldingBonus(uint256 totalAmount);
	...
	function AddHoldingBonus() public {
        require(msg.sender == commissionWallet, "AddHoldingBonus()");
        uint256 smartContractBalance = address(this).balance;
        commissionWallet.transfer(smartContractBalance);
        emit HoldingBonus(smartContractBalance);
    }
