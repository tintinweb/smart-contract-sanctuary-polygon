...
contract FastPay is Initializable, OwnableUpgradeable{
    ...
    constructor(address _singerManager) {
        singerManager = _singerManager;
    }
    ...
    function verifyFee(
        ...
        require(signer == singerManager, "MyFunction: invalid signature");
