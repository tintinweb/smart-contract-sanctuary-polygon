...
contract CarbonicGenesisRewardPool {
    ...
    uint256 public tombPerSecond = 0.04050925925 ether; // 11000 TOMB / (1h * 60min * 60s)
    ...
    function set(uint256 _pid, uint256 _allocPoint, uint256 depositFee) public onlyOperator {
        massUpdatePools();
