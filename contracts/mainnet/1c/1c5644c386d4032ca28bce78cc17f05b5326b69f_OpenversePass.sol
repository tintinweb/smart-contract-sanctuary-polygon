...
contract OpenversePass is ERC721, Ownable {
    using Strings for uint256;
    constructor() ERC721("Openverse Pass", "OV-PASS") {}
    function _baseURI() internal pure override returns (string memory) {
        return "https://amber-openverse.s3.ap-northeast-1.amazonaws.com/avatar-pass/";
    }
