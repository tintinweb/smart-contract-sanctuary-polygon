...
// Telegram: https://t.me/Shibahouseinu
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BUSD = IBEP20(0xc2132D05D31c914a87C6611C10748AEb04B58e8F);
...
/* Token contract */
contract Shibhouse is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BUSD = 0xc2132D05D31c914a87C6611C10748AEb04B58e8F; 
    address WBNB = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x2dC8F9EC4b0572B77eb03d1afbABB9291B2E56D1;
    ...
    // Name and symbol
    string constant _name = "SHIBA HOUSE INU";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 30 / 10000; // 3% 
    uint256 public _maxSellTxAmount = _totalSupply * 30 / 10000; // 3% 
    uint256 public _maxWalletToken = ( _totalSupply * 30 ) / 10000; // 3% 
    ...
    uint256 public swapThreshold = _totalSupply * 5 / 10000; // .5%
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x08BE47d748B48A270c8DaCe98F894c53902c61A0;
