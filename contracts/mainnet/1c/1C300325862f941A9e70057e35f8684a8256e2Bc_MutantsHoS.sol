...
contract MutantsHoS is Ownable, ERC721Enumerable, ReentrancyGuard, ERC2981 {
    ...
    ) ERC721("HoS - Neoteric Mutants", "HOSNM") {
        baseTokenURI = uri_;
    ...
    function airdrop(
        ...
        for (uint256 i = 0; i < tokens.length; ) {
            ...
            if (tokenId <= 0 || tokenId > MAX_SUPPLY) revert OverMint();
            _safeMint(to, tokenId);
