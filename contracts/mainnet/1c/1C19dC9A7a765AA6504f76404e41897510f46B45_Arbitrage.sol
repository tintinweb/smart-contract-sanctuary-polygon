...
contract Arbitrage {
    ...
    address owner;
    address token = 0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619;
    ...
    function arbitrage(address routerA, address routerB) external onlyOwner returns(bool){
        ...
        require(finalBalance > balance, "No profit");
        return true;
    }
    ...
    function withdraw(address _assetAddress) public onlyOwner {
        ...
        if (_assetAddress == WETH) {
            ...
            IERC20(_assetAddress).transfer(msg.sender, assetBalance);(msg.sender, assetBalance);
        }
