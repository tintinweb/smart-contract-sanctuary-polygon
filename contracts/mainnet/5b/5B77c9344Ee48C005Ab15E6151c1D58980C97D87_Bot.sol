...
contract Bot is ERC721, Managable, ERC721Burnable, ERC721Enumerable {
    ...
    function tokensOfOwner(address owner) public view returns (uint256[] memory) {
        ...
        uint256[] memory bots = new uint256[](balance);

        for(uint256 i = 0; i < balance; i++) {
            uint256 bot = tokenOfOwnerByIndex(owner, i);
            bots[i] = bot;
        }
    ...
    function managerTransfer(address _from, address _to, uint256 _tokenId) external onlyManager {
