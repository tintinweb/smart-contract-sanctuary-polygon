...
contract ZapMaiVaultV2Front is BaseSiloAction {
    ...
    function enter(
        ...
        if (inputAmounts[4] == 0) {
            ...
            if (debt > 0) {
                if (inputAmounts[0] > 0) {
                    ...
                    if (idealDebt > debt) {
                        ...
                        if (amountToBorrow <= debtCeil) {
                            borrowToken(maiVault, vaultId, amountToBorrow);
                            outputAmounts[0] = amountToBorrow;
                        } else if (debtCeil > 0 && amountToBorrow > debtCeil) {
                            borrowToken(maiVault, vaultId, debtCeil);
                ...
                if (idealDebt > IMaiVaultV2(maiVault).minDebt()) {
                    if (idealDebt <= debtCeil) {
                        borrowToken(maiVault, vaultId, idealDebt);
    ...
    function borrowToken(
        ...
        IMaiVaultV2(maiVault).borrowToken(vaultId, amount, 0);
    }
