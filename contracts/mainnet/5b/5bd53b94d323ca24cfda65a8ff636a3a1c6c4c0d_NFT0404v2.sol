...
contract NFT0404v2 is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  address public constant enforcerAddress = 0x4aEb94eF82241bA6dc0B4Fa6782d5F7ee17721AF;
  ...
  function _baseURI() internal view virtual override returns (string memory) {
    ...
    function verify(address _signer, address _to, uint _amount, uint _nounce, bytes memory signature) public pure returns (bool) {
  ...
  // public
  function NEWmint(uint nounce, bytes memory signature, uint256 _mintAmount) public payable {
    uint256 supply = totalSupply();
    require(verify(enforcerAddress, _msgSender(), _mintAmount, nounce, signature) == true, "Staking must be done from our website!");
