...
contract UpgradeabilityProxy is Proxy {
    ...
    bytes32 private constant IMPLEMENTATION_POSITION =
        keccak256("offchain.proxy.implementation");
...
contract OwnedUpgradeabilityProxy is UpgradeabilityProxy {
    ...
    bytes32 private constant PROXY_OWNER_POSITION =
        keccak256("offchain.proxy.owner");
...
contract MockConduitControllerInterface {
    function getConduit(bytes32 conduitKey)
    external
    view
    returns (address conduit, bool exists){
        return (address(0x1E0049783F008A0085193E00003D00cd54003c71),true);
    }
}
