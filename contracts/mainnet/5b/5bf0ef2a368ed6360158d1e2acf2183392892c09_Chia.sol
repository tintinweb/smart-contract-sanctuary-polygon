...
pragma solidity ^0.8.0;
contract Chia is ERC20, Ownable {
    ...
    constructor() ERC20("Chia", "Chia") {
        _mint(msg.sender, 1000000000*10**decimals());
        _mint(address(this), 9000000000*10**decimals());
        startSale(block.number, 999999999, 0,2000*10**decimals(), 2000000000000);
