 ...
 * @notice This contract handles minting ZOGGED Pepe tokens.
 */
contract ZOGGEDPepe is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x1353Ea9bEE139721C879254cedaFF20698eB11bd;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x98D5A126a502781944A33e549C50362653Cb5c6c;
    address[] public payoutAddresses = [
        0x98D5A126a502781944A33e549C50362653Cb5c6c
    ];
    ...
    string public name = "ZOGGED Pepe";
    string public symbol = "ZOGGED";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeidccpfzgcje7nts52viqt2xiev35ko4kc42dnhxlnxvaainp67iqq/{id}"
        )
        RevokableOperatorFilterer(
