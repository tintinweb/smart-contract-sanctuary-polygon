...
contract MUSIGREEN is Ownable, ERC721A, Royalty, ERC721AQueryable {
    ...
    uint256[] public maxSupplyEach = [5000, 1000];
    ...
    // Metadata uris
    string public baseURI = "https://core-items-images.s3.amazonaws.com/musigreen/metadatas/";
    // Amount minted at phases
    mapping(uint256 => uint256) public tokenIdsUris;
    mapping(uint256 => uint256) public currentSupply;
    
    constructor(address[] memory _addressWithdraw) ERC721A("MUSIGREEN", "MUSIGREEN") {
        _setupDefaultRoyaltyInfo(0x4E3c4cB1c2ecc0005C5980A5C09Ac5146529Ccb2, 200);
