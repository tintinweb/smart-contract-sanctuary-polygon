...
Minting these NFTs will give you access to Baldr Tokens Tier 3 equivalent to 5 $BALDR on airdrop

*/



contract BaldrINOFactoryTier3 is ERC721, ERC721Enumerable, Pausable, Ownable {
    ...
    uint256 public MAX_ELEMENTS = 1184;

    uint256 public PRICE = 50000000; // price in token dec

    string private constant TOKEN_URI = "/3.json"; //Metadata Id



    constructor(address _payableToken, address _baldrDeployer) ERC721("Baldr INO NFT Tier 3", "pBALDR") {
