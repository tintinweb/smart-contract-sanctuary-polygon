...
import { IAnyCallV7Endpoint } from './interfaces/IAnyCallV7Endpoint.sol';
import { IAnyCallV7Executor } from './interfaces/IAnyCallV7Executor.sol';
...
contract AnyCallV7Gateway is SystemVersionId, GatewayBase {
    ...
    function sendMessage(
        ...
        endpoint.anyCall{ value: msg.value }(
            ...
            '' // extra data for advanced use cases
        );
    }
