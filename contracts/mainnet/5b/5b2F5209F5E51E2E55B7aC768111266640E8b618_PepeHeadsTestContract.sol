...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x273b0DdA0FBfebaaA10C88a6C8c6184Fb4830feF];
  address public erc20Payable = 0x273b0DdA0FBfebaaA10C88a6C8c6184Fb4830feF;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeihky27shxtl33ug47ecybbnuotuqhlzi3hrw5vq2xkjazr4vo5baq/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/xceqMlavNXTNOKkYRIvW/contract-metadata";
  }
...
// File: contracts/PepeHeadsTestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PepeHeadsTestContract is ERC721APlus {
    constructor() ERC721APlus("Pepe Heads Test", "PHT"){}
}
