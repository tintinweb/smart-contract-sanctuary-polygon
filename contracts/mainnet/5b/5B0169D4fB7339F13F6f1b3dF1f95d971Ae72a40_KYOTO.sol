...
contract KYOTO is KYOTODeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private KYOTOTeam;
    address private CharityKYOTO;
    ...
    string public override name = "KYOTO";
    string public override symbol = "KYOTO";
    ...
    constructor(uint totalSupplyValue, address KYOTOTeamAddress, address CharityKYOTOAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        KYOTOTeam = KYOTOTeamAddress;
        CharityKYOTO = CharityKYOTOAddress;
        
        // split the tokens according to agreed upon percentages
        balances[KYOTOTeam] =  totalSupply * 4 / 100;
        balances[CharityKYOTO] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's KYOTOTeam pot
    ...
    function transfer(address to, uint value) public override returns(bool) {
        ...
        uint taxTBD = value * 12 / 100;
        uint burnTBD = value * 2 / 100;
