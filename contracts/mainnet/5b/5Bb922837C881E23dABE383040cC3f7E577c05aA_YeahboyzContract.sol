...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x68D152003C547359874B4F9efb59053FaDf2cA8D];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1000, 1000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeidxkorusjp3mxbucoxhuuyt3upbrl7wfeabqgh5kdxk47w6off2om/";
...
// File: contracts/YeahboyzContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract YeahboyzContract is RamppERC721A {
    constructor() RamppERC721A("YEAHBOYZ", "YBZ"){}
}
