 ...
 * @notice This contract handles minting KidsInNFT HUG Cohort tokens.
 */
contract KidsInNFTHUGCohort is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xE5De4146dE7cEe262b4F73B247EB55832807B1c5;
    address public royaltyAddress = 0x5CAC51a2624cb412578E6DC27D07936b3944e64a;
    address[] public payoutAddresses = [
        0x5CAC51a2624cb412578E6DC27D07936b3944e64a
    ];
    ...
    string public name = "KidsInNFT HUG Cohort";
    string public symbol = "KIDHUG";
    ...
    constructor()
        ERC1155(
            "ipfs://bafybeic24ka5aghmp7xcqfay623goaywhfuxh7ih3lpydbglvkcgem47qm/{id}"
        )
        RevokableOperatorFilterer(
