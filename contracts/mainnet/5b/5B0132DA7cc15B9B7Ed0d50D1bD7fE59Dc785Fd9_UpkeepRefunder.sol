...
contract UpkeepRefunder is ManageableUpgradeable, IUpkeepRefunder {
    ...
    function _approveLinkSpending() internal {
        ...
        address keeperRegistryAddress = address(keeperRegistry);
        IERC20Upgradeable(oracleLINK()).safeApprove(keeperRegistryAddress, 0);
        IERC20Upgradeable(oracleLINK()).safeApprove(keeperRegistryAddress, type(uint256).max);
    }
