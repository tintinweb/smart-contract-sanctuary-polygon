...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1685228400;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1685055600;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x3e6388F11E7CFb533e32a28D04A1b0c874591fCc];
  address public erc20Payable = 0x3e6388F11E7CFb533e32a28D04A1b0c874591fCc;
...
abstract contract EarlyMintIncentive is Teams, ERC721A, ProviderFees {
  ...
  uint256 public EARLY_MINT_PRICE = 1.5 ether;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiatesr6cnns5govbg2iec2ofumxuvyqd5a5ptgu7gc33az3z5picy/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/a0a7HPzXDBteRdaD0b6O/contract-metadata";
  }
...
// File: contracts/NinjaPandaContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NinjaPandaContract is ERC721APlus {
    constructor() ERC721APlus("NinjaPanda", "NJPD"){}
}
  /*******************************************************/
  /*                                                     */
