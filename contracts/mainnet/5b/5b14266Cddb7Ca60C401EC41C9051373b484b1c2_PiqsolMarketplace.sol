...
// File: contracts/piqsol-marketplace.sol
        ...
        FixedIsForSale(id)
    {
        ...
        if (_royaltiesRecipientAddress != address(0)) {
            uint256 royalityFee = calculateRoyaltyFee(
                ...
                FixedItemsForSale[id].percentageBasisPoints
            );
            uint256 finalAmount = (FixedItemsForSale[id].askingPrice).sub(
                royalityFee
            );
    ...
    function auctionEnd(uint256 id) public {
        ...
        AuctionActiveItems[AuctionItemsForSale[id].tokenAddress][
            ...
            if (_royaltiesRecipientAddress != address(0)) {
                ...
                uint256 finalAmount = (AuctionItemsForSale[id].highestBid).sub(
                    royalityFee
                );
