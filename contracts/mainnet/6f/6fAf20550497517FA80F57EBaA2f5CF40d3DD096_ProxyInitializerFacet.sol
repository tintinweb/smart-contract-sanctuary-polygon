...
contract ProxyInitializerFacet is IProxyInitializer {
    ...
    function proxyInit(bytes memory data) public override initializer {
        ...
        StorageAnticFee._initStorage(
            initData.antic,
            initData.anticJoinFeePercentage,
            initData.anticSellFeePercentage
        );
    }
