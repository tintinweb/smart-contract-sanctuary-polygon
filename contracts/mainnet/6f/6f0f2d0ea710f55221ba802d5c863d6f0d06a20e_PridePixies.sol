...
contract PridePixies is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor() ERC721A("PridePix","PridePix", MaxMintPerBatch_, TotalCollectionSize_) {
  ...
  function setReserve(uint256 r)external onlyOwner{
     ...
     function conf(uint256 s , uint256 MPA , uint256 MPT , uint256 P, uint256 Stop )external onlyOwner{
      status = s;
      stopat = Stop;
      PRICE = P;
      MAX_PER_Address = MPA;
