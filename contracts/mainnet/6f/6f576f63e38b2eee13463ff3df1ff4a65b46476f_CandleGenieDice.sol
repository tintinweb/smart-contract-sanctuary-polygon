...
//REFEREE
abstract contract CandleGenieDiceReferee
{
...
contract CandleGenieDice is Ownable, ReentrancyGuard 
{
    ...
    // Referee
    CandleGenieDiceReferee internal candleGenieDiceReferee;
    ...
    {
        require(msg.sender == address(candleGenieDiceReferee), "Only referee contract allowed");
        _;
    }
    ...
    {
        candleGenieDiceReferee = CandleGenieDiceReferee(_refereeAddress);
    ...
    function _safeRoll(address user, uint256 rollAmount, int position) internal
    {
        ...
        // Resolve
        candleGenieDiceReferee.Resolve(roll.id);
