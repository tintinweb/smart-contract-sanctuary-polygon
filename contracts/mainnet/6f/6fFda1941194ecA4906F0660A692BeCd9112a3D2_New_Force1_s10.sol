...
contract New_Force1_s10 is owned
{
    ...
    function regUser_(address msgsender, address _refAddress,bool pay, uint prc) internal returns(bool)
    {
        ...
        if(userPosition > 60 && userPosition < 63 ) 
        {
    ...
    function getPosition(address _user, uint _level) public view returns(uint recyclePosition_, uint recycleID)
    {
        ...
        if (a == 2 && b == 2 && c == 2 && d == 2 ) return (62, parent_);
        if (a == 1 && b == 2 && c == 2 && d == 2 ) return (61, parent_);
        if (a == 2 && b == 1 && c == 2 && d == 2 ) return (60, parent_);
        if (a == 1 && b == 1 && c == 2 && d == 2 ) return (59, parent_);
        if (a == 2 && b == 1 && c == 1 && d == 1 ) return (32, parent_);
        if (a == 1 && b == 2 && c == 1 && d == 1 ) return (31, parent_);
        if (a == 2 && b == 2 && c == 1 && d == 1 ) return (30, parent_);
        if (a == 1 && b == 1 && c == 2 && d == 1 ) return (29, parent_);        
    ...
    function buyLevel_(address msgsender, uint _level,bool pay,  uint prc) internal returns(bool)
    {
        ...
        //require(user4thParent<62, "not place under this referrer");        
