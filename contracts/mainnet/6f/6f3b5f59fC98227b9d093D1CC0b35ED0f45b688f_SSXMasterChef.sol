...
contract SSXMasterChef is Operator, ReentrancyGuard {
    ...
    uint256 public  SUBSCRIPTION_PERIOD = 10 minutes;
    uint256 public constant ONE_DAY_PERIOD = 5 minutes; // Max 10%
    ...
    function getUserFeeInfo(uint256 _pid, address _user) public view returns (
