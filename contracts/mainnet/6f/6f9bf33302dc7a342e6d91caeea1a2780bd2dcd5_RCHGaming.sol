...
//File： fs://01ad3f0fe4304f589b8f93e987293470/RCHGaming.sol
...
contract RCHGaming is DefaultOperatorFilterer, ERC721A, Ownable {
    using Address for address;
    using Strings for uint256;
    ...
    uint256 public _nftEther = 1000000000000000000;

    constructor() ERC721A("RCH Expo Web3 Gaming", "RCHG") {
        contractUri = "https://gateway.pinata.cloud/ipfs/QmQkCM9erVPzATRgwyWCViwKWBSzWJ8zuBnScUdzEySgB8";
    ...
    function mint(address payable _endUser, string memory _cid) public payable {
        ...
        if (msg.sender != walletsOwner[msg.sender]) {
            split();
        }
    ...
    function split() public payable {
        uint256 _nftEtherValueTemp = _nftEther;
        require(msg.value >= _nftEtherValueTemp, "Valor da mintagem diferente do valor definido no contrato");
