...
// File: contracts/AlphaPetsEventShopContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract AlphaPetsEventShopContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Alpha Pets Event Shop";
    string public symbol = "APEVENTS";
