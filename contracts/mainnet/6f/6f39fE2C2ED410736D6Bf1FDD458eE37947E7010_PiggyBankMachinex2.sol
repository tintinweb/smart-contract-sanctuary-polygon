...
contract PiggyBankMachinex2 is Token {
    
     // Configurables
     uint public startTime = 1649056725; // SATURDAY, February 12, 2022 13:00:00 GMT
    ...
    uint private constant ADV_FEE           = 40;                   // Base 1.5% multipled * 7 = 10.5% total
    ...
    constructor() public {
        ...
        ADMIN = msg.sender;
        DEV_1 = 0x14a19C9A86b005C4A81C3852355d6Fd6067339A4;                        // e
        DEV_2 = 0x14a19C9A86b005C4A81C3852355d6Fd6067339A4 ;  // N
        MAR_1 = 0x14a19C9A86b005C4A81C3852355d6Fd6067339A4;  // DESB      
    ...
    function stakeBUSD(address referrer,  uint256 _amount) public payable {
        ...
        token.transfer(MAR_1, fee);     // changed 1%
