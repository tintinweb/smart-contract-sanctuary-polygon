...
contract ppp3 is ERC20, ERC20Burnable, Pausable, AccessControl, ERC20Permit, ERC20Votes {
    ...
    constructor() ERC20("ppp3", "ppp3") ERC20Permit("ppp3") {
        ...
        _setRoleAdmin(KYCED_USER_ROLE, KYC_MANAGER_ROLE);
