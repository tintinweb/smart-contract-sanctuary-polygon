...
// File: xvmc-contracts/libs/masterchefLibs.sol
...
interface IERC20 {
	...
	//mint, burn and burnFrom for ERC20
    function mint(address to, uint256 amount) external;
	function burn(uint256 amount) external;
	
	//transfer ownership of token(to potentially new masterchef if need be)
...
// File: xvmc-contracts/masterchef.sol
