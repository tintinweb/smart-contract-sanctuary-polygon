...
contract BankRoll is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BankRoll";
    string constant _symbol = "BRoll";
    ...
    address public marketingFeeReceiver=0x86435343883De8b95aA020dc123C130bbBCDeA29;
    ...
    constructor (
        address _dexRouter, address _marketingAddress, address _WMATIC
    ) Auth(msg.sender) {
        router = IDEXRouter(_dexRouter);
        WMATIC=_WMATIC;
        pair = IDEXFactory(router.factory()).createPair(_WMATIC, address(this));
...
//        emit Transfer(sender, recipient, amount);
    ...
    event AutoLiquify(uint256 amountMATIC, uint256 amountBTO);
