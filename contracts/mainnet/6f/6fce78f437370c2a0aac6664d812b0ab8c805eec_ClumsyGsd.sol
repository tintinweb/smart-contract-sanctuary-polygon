...
contract ClumsyGsd is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://QmVfQZ9NsXTNHpT6UZt64MsjeqawgEqPvSXjkDkuR16CJu/";
  ...
  constructor() ERC721("ClumsyGSD", "CLUGSD") {
    setHiddenMetadataUri("ipfs://QmVfQZ9NsXTNHpT6UZt64MsjeqawgEqPvSXjkDkuR16CJu/1.json");
  }
