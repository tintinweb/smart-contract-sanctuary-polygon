...
//MADE WITH LOVE *v* SPECIAL THANKS TO
...
// File: contracts/PKMint.sol

pragma solidity ^0.8.9;

contract PKMint is Ownable, ERC721, ILayerZeroReceiver, NonblockingReceiver {
    ...
    uint256 nextTokenId;
    uint256 gas = 600000;
    uint256 gasForDestinationLzReceive = 650000;
    event ReceiveNFT(
        uint16 _srcChainId,
        address _from,
        uint256 _tokenId,
   ...
   // public
    function mint(address _to, uint256 _mintAmount) external payable {
        ...
        require(nextTokenId + 1 <= maxMintAmount, "PKMN: Max limit reached");
    ...
    function traverseChains(uint16 _chainId, uint256 tokenId) public payable {
        ...
        require(
            ...
            "PKMN: msg.value not enough to cover messageFee. Send gas for message fees"
        );
...
// internal
    ...
    function withdraw(uint256 amt) external onlyOwner {
        ...
        require(sent, "PKMN: Failed to withdraw");
    }
