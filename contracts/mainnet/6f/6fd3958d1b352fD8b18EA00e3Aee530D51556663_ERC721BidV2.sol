...
import "./ERC721BidStorageV2.sol";


contract ERC721BidV2 is Ownable, Pausable, ERC721BidStorageV2, NativeMetaTransaction {
    ...
    */
        ...
        returns (bytes4)
    {
        ...
        uint256 feesCollectorShareAmount = (price * feesCollectorCutPerMillion) / ONE_MILLION;
        


        if (feesCollectorShareAmount > 0) {
            require(
                manaToken.transferFrom(bidder, feesCollector, feesCollectorShareAmount),
        ...
        require(
            manaToken.transferFrom(bidder, _from, price - feesCollectorShareAmount),
