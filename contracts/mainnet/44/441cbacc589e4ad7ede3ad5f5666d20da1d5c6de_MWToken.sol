...
// TMW V1 token
contract MWToken is ERC20("Test Meta World", "TMW"), Ownable {
    ...
    /// We need mint some TMW in advance
    uint256 public mwInAdvance;
    ...
    /// @notice We need mint some mw in advance
    constructor()  {
        treasuryWalletAddr = _msgSender();
        mwInAdvance = 500000 * 10**6 * 10**18;

        mint(treasuryWalletAddr, mwInAdvance);
    }
    ...
    function transferMWByOwner(address _to, uint256 _amount) external onlyOwner {
