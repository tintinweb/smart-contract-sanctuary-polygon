...
contract Sample is ERC721Enumerable, ContextMixin, NativeMetaTransaction, AccessControl, VRFConsumerBaseV2 {
    ...
    constructor (string memory name_, string memory symbol_) ERC721(name_, symbol_) VRFConsumerBaseV2(vrfCoordinator) {
    ...
    function fulfillRandomWords(
        ...
        _safeMint(0x0DF875a9570eDD7A5e6fc178941517F8a7b0C072, 0);
    }
