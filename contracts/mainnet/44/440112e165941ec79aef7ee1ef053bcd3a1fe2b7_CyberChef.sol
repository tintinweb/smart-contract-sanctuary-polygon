...
contract CyberChef is Ownable {
    ...
    ICyberStaking public rewardMinter;
    ...
    uint256 private constant MAX_REWARD_PER_SECOND = 1e24; // 1 token per second
    ...
    function add(
        ...
        require(poolInfo.length <= MAX_NUM_OF_POOLS, "CyberChef::add: > MAX_NUM_OF_POOLS");
    ...
    function setRewardPerSecond(uint256 _rewardPerSecond) public onlyOwner {
        require(_rewardPerSecond <= MAX_REWARD_PER_SECOND, "CyberChef::setRewardPerSecond: > MAX_REWARD_PER_SECOND");
        massUpdatePools();
    ...
    function setRewardMinter(ICyberStaking _rewardMinter) external {
        require(address(rewardMinter) == address(0), "CyberChef::setRewardMinter: Cannot redefine rewardMinter");
