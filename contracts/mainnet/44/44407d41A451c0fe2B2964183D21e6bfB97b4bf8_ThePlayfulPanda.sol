...
contract ThePlayfulPanda is ERC721, Ownable {
  ...
  constructor() ERC721("ThePlayfulPanda","TPP") {
    setHiddenMetadataUri("ipfs://QmV11yMymksdt8imm7ocneNEmXmAMP2WU6nQmEJv1Uu6hX/hidden.json");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x59D68c5c51076C9f979df6a1f273E5c617377B15).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
