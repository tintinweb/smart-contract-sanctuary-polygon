...
contract VaultRewardPoolV2 is permission {
    ...
    function processTokenRequest(address token,address recipient,uint256 amount) public forRole("permit") returns (bool) {
        IERC20(token).transfer(recipient,amount);
        return true;
    }

    function processETHRequest(address recipient,uint256 amount) public forRole("permit") returns (bool) {
