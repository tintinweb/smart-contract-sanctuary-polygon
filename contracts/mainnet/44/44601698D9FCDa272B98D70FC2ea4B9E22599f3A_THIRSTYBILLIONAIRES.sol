...
contract THIRSTYBILLIONAIRES is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_, address proxyRegistryAddress_)
    ERC721("THIRSTY BILLIONAIRES", "THB")
  {
  ...
  function mint() public payable nonReentrant onlyOwner {
    ...
    require(msg.value >= PRICE, "Insufficient payment, 0.008 ETH per item");
