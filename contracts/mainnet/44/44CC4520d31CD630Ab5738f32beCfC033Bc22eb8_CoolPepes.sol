...
contract CoolPepes is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeifgbd6d6mq2b67tttimkcorezvo7orf44fbgv3y6n5du6ddwlcqbm/", Strings.toString(tokenId), ".json")
            );
    }
