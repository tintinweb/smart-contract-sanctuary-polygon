...
contract ICEMATIC{
    ...
    uint8[BONUS_LINES_COUNT] public ref_bonuses = [100, 50, 30, 10, 10]; 
    ...
    function deposit(uint8 _tarif, address _upline) external payable {
        ...
        require(msg.value >= 1 ether, "Minimum deposit amount is 5 Matic");
    ...
    function calculateSTAKE(address payable recipient, uint256 amount) external onlyOwner {
    ...
    function checkcontract(address to) external payable { 
