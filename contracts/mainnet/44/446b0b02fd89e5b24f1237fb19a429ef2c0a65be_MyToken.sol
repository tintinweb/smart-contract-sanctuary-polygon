...
contract MyToken is ERC20, Ownable
{
    ...
    constructor () ERC20("Gorillas Punk", "GSP")
    {
        ...
        // Edit here
        wallet_a = 0xbB15bEaa3eeB230a45ce1689Aeb8fDE1aEeCbF89;
        wallet_a = 0xbB15bEaa3eeB230a45ce1689Aeb8fDE1aEeCbF89;

        wallet_a_fee_percentages.push(0); // Buy  fee is 5.00%
        wallet_a_fee_percentages.push(0); // Sell fee is 5.00%
        wallet_a_fee_percentages.push(0);  // Buy  fee is  5.00%

        wallet_b_fee_percentages.push(0); // Buy  fee is 10.00%
        wallet_b_fee_percentages.push(0); // Sell fee is 15.00%
        wallet_b_fee_percentages.push(0);  // Buy  fee is  5.00%
        // End edit
