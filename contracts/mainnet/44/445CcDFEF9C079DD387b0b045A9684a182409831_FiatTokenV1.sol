...
// File src/interfaces/IVICToken.sol
 ...
 * @author Patrick
 */
interface IVICToken is IERC20Burnable, IERC20Upgradeable {
    /**
    ...
    Blacklistable
{
    ...
    modifier auth(address role) {
        require(msg.sender == role, "FiatToken: not-authorized");
        _;
    }
    ...
    modifier onlyOwnerOr(address role) {
        require(
            msg.sender == owner() || msg.sender == role,
            "FiatToken: not owner or role"
        );
        _;
    }
    ...
    /// Pause the contract.
    function pause() public onlyOwnerOrOperator {
        _pause();
    }
     ...
     * @param amount The amount to mint
     */
    function mint(uint256 amount) external whenNotPaused auth(minter) {
     ...
     * @param amount The amount to burn
     */
    function burn(uint256 amount) external override whenNotPaused auth(minter) {
    ...
    function transfer(
        ...
        public
        override(IERC20Upgradeable, VERC20)
