...
contract Codestorm is ERC20, ERC20Burnable, Ownable {
  ...
  constructor() ERC20( "Codestorm", "CD" ) { 
      _mint(msg.sender, 5000000 * 10 ** 18);
        marketingAddress = 0x7a8AfD9A92f5815473B4ffDFce4BDe698Aec4634;
  ...
  function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        _transfer(msg.sender, recipient, (amount * (100 - liqudityPercent - marketingPercent)) / 100 );
        return true;
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public virtual override  returns (bool){
        ...
        _transfer(sender, recipient,            (amount * (100 - liqudityPercent - marketingPercent)) / 100 );
        return true;
    }
