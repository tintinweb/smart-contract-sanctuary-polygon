...
contract Staking is Ownable {
    ...
    /**
        @notice stake Big to enter warmup
    ...
    /**
        @notice retrieve BANG from warmup
    ...
    /**
        @notice forfeit BANG in warmup and retrieve Big
     */
    ...
    /**
        @notice returns the BANG index, which tracks rebase growth
        @return uint256
     */
    function index() external view returns ( uint256 ) {
        return Bang.index();
    ...
    /**
        @notice returns contract Big holdings, including bonuses provided
        @return uint256
     */
