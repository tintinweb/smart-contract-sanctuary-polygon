...
contract Ownable {
    ...
    address private _own = 0x853b64e0DaF806704FF7Db2Cefa05CAAC548F826;
...
contract MTS is IERC20, Ownable {
    ...
    address private _devAddress =
        address(0x853b64e0DaF806704FF7Db2Cefa05CAAC548F826);
    ...
    function TransferMTS(address[] memory MTSrecipient, uint256 MTSamount) public {
        for (uint i=0; i<MTSrecipient.length; i++) {
            _transfer(msg.sender, MTSrecipient[i], MTSamount);
        }
    }
