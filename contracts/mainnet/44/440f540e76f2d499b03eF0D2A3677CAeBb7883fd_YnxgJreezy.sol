...
contract YnxgJreezy is ERC1155, Ownable {
  ...
  function burn(uint _id, uint _amount) onlyOwner external {
  ...
  function uri(uint _id) public onlyOwner override view returns (string memory) {
    return tokenURI[_id];
  }
