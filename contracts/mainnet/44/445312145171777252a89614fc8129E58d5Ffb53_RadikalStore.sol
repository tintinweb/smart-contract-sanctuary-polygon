...
contract RadikalStore is Ownable{
  ...
  // Riders Base URI by attribute/skill and image rareness
  mapping(uint8 => string) private ridersBaseURI;
  // Riders Image URI by attribute/skill and image rareness
  mapping(uint8 => string) private ridersImageURI;
  ...
  constructor () {
    ...
    ingredientPackToPrice[IngredientPacks.SECOND] = 1750;
    ingredientPackToPrice[IngredientPacks.THIRD] = 3250;
    ...
    baseURILength["ipfs://bafybeigsbgbig4z7vf5l4kuraclw6ej7f6wktfstjhsqvhsz6gj52umc4u"] = 1000;// TODO: to be updated with real values"
    baseURILength["ipfs://bafybeif5ihn3whs2jsddsomiq6kygoyfa54jpiaau4erql2lgnqvfztrki"] = 1000;// TODO: to be updated with real values"
    baseURILength["ipfs://bafybeichppljs3knanhlrpzxafjpuxi3mjnbuhle7ask7inxgsqookjt7u"] = 1000;// TODO: to be updated with real values"
    baseURILength["ipfs://bafybeigs3kttnnfukldj7a6efczmilgmfumtmruq5l7qw2es7jj3yu5y44"] = 1000;// TODO: to be updated with real values"
    baseURILength["ipfs://bafybeieyebpjmjtfvdab7qkb5fjnsa4ryhoafencksdvya27dqczkmz5li"] = 1000;// TODO: to be updated with real values"
    
    ridersBaseURI[1] = "ipfs://bafybeigsbgbig4z7vf5l4kuraclw6ej7f6wktfstjhsqvhsz6gj52umc4u"; // "ipfs://QmQvjfmLYNavBX5BaxiB61AQB3548zbVx3zdqTFTyS69At/Common/very rare";
    ridersBaseURI[2] = "ipfs://bafybeif5ihn3whs2jsddsomiq6kygoyfa54jpiaau4erql2lgnqvfztrki"; // "ipfs://QmdmfDUjqDntPhV1UVwpa6PWreryFeKQcyyZDPacGM2SAd/Rare/very rare"; // "rare nft very rare image";
    ridersBaseURI[3] = "ipfs://bafybeichppljs3knanhlrpzxafjpuxi3mjnbuhle7ask7inxgsqookjt7u"; // "ipfs://QmdmfDUjqDntPhV1UVwpa6PWreryFeKQcyyZDPacGM2SAd/Epic/very rare"; //"epic nft very rare image";
    ridersBaseURI[4] = "ipfs://bafybeigs3kttnnfukldj7a6efczmilgmfumtmruq5l7qw2es7jj3yu5y44"; // "ipfs://QmdmfDUjqDntPhV1UVwpa6PWreryFeKQcyyZDPacGM2SAd/Legendary/common";
    ridersBaseURI[5] = "ipfs://bafybeieyebpjmjtfvdab7qkb5fjnsa4ryhoafencksdvya27dqczkmz5li"; // "ipfs://QmdmfDUjqDntPhV1UVwpa6PWreryFeKQcyyZDPacGM2SAd/Mythical/common";

    // Riders image URI
    ridersImageURI[1] = "ipfs://bafybeigsbgbig4z7vf5l4kuraclw6ej7f6wktfstjhsqvhsz6gj52umc4u"; // "ipfs://QmQvjfmLYNavBX5BaxiB61AQB3548zbVx3zdqTFTyS69At/Common/very rare";
    ridersImageURI[2] = "ipfs://bafybeif5ihn3whs2jsddsomiq6kygoyfa54jpiaau4erql2lgnqvfztrki"; // "ipfs://QmdmfDUjqDntPhV1UVwpa6PWreryFeKQcyyZDPacGM2SAd/Rare/very rare"; // "rare nft very rare image";
    ridersImageURI[3] = "ipfs://bafybeichppljs3knanhlrpzxafjpuxi3mjnbuhle7ask7inxgsqookjt7u"; // "ipfs://QmdmfDUjqDntPhV1UVwpa6PWreryFeKQcyyZDPacGM2SAd/Epic/very rare"; //"epic nft very rare image";
    ridersImageURI[4] = "ipfs://bafybeigs3kttnnfukldj7a6efczmilgmfumtmruq5l7qw2es7jj3yu5y44"; // "ipfs://QmdmfDUjqDntPhV1UVwpa6PWreryFeKQcyyZDPacGM2SAd/Legendary/very rare";
    ridersImageURI[5] = "ipfs://bafybeieyebpjmjtfvdab7qkb5fjnsa4ryhoafencksdvya27dqczkmz5li"; // "ipfs://QmdmfDUjqDntPhV1UVwpa6PWreryFeKQcyyZDPacGM2SAd/Mythical/very rare";
  
    // Pizzerias Data
		tipPowerURIRanges = [999, 2999, 5999, 50000];
		rarenessToTokenURI[999] = "ipfs://QmcpkbcpNYy5EtMdnLWf9PcG2Z3ZA2Va5qoD2Mxpqy7AAZ/family_business.png"; // "Family Business"; // TODO ipfs
		rarenessToTokenURI[2999] = "ipfs:///QmcpkbcpNYy5EtMdnLWf9PcG2Z3ZA2Va5qoD2Mxpqy7AAZ/Haute_cousine.png"; // "Haute Cousine"; // TODO ipfs
		rarenessToTokenURI[5999] = "ipfs://QmcpkbcpNYy5EtMdnLWf9PcG2Z3ZA2Va5qoD2Mxpqy7AAZ/Franchise.png"; // "Franchise"; // TODO ipfs
		rarenessToTokenURI[50000] = "ipfs://QmcpkbcpNYy5EtMdnLWf9PcG2Z3ZA2Va5qoD2Mxpqy7AAZ/Multinational_chain.png"; // "Multinational Chain"; // TODO ipfs  
    ///// Chainlink fee data /////
    // ChainLink fees in Matic to be charged when minting riders
    riderQuantityToChainLinkFee[1]  = 1000; // TODO: TO BE UPDATECD 72240400000000000;
    riderQuantityToChainLinkFee[5]  = 1000; // TODO: TO BE UPDATECD 129655000000000000;
    riderQuantityToChainLinkFee[10] = 1000; // TODO: TO BE UPDATECD 215692400000000000;
    riderQuantityToChainLinkFee[20] = 1000; // TODO: TO BE UPDATECD 381781600000000000;
    // ChainLink fees in Matic to be charged when minting recipe
    recipeQuantityToChainLinkFee[1]  = 1000; // TODO: TO BE UPDATED 72935600000000000;
    recipeQuantityToChainLinkFee[5]  = 1000; // TODO: TO BE UPDATED 88148000000000000;
    recipeQuantityToChainLinkFee[10] = 1000; // TODO: TO BE UPDATED 129662200000000000;
    recipeQuantityToChainLinkFee[20] = 1000; // TODO: TO BE UPDATED 215682200000000000;
    // ChainLink fees in Matic to be charged when playing PVE
    pveChainLinkFee = 1000; // TODO: to be updated 50000000000000000;
    // ChainLink fees in Matic to be charged when playing PVE
    pvpChainLinkFee = 1000; // TODO: to be updated 22666667000000000;
  }
  ...
  /// @dev uses Ownable oppenzeppelin libraryç
  /// @param _nftRareness corresponds to pizzaQuantity of rider
  /// @param _newBaseURI IPFs URI where nfts are stored
  function setRidersBaseURI(uint8 _nftRareness, string memory _newBaseURI) external onlyOwner {
    ridersBaseURI[_nftRareness] = _newBaseURI;
  }

  /// @notice Allows owner to include a new IPFSs Base URI for riders
  /// @dev uses Ownable oppenzeppelin libraryç
  /// @param _nftRareness corresponds to pizzaQuantity of rider
  /// @param _newImageURI IPFs URI where nfts are stored
  function setRidersImageURI(uint8 _nftRareness, string memory _newImageURI) external onlyOwner {
    ridersImageURI[_nftRareness] = _newImageURI;
  }  
