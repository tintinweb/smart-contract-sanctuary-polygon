...
contract ParaswapAdapter is AdapterBase {
  ...
  address public paraswapTokenTransferProxy; //0x216B4B4Ba9F3e719726886d34a177484278Bfcae;
  address public augustusSwapper; //0xDEF171Fe48CF0115B1d80b88dc8eAB59176FEe57;
  ...
  */
  constructor(address _registry, address _paraswapTokenTransferProxy, address _augustusSwapper) AdapterBase(_registry) {
    paraswapTokenTransferProxy = _paraswapTokenTransferProxy;
    augustusSwapper = _augustusSwapper;
    feeRate = 1;
  }

  function setParaswapAddresses(address _paraswapProxy, address _augustusSwapper) public onlyRegistry {
