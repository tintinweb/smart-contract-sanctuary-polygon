...
/**
 *Submitted for verification at polygonscan.com on 2022-7-10
*/
...
// SPDX-License-Identifier: MIT 
 ...
 /*   Welcome
 *
 *	  The long term investment platform on the Polygon Network. Invest your MATIC and earn 5% daily rewards for 1825% APR, along with referral and compounding
 ...
 *   - Visit the official website at https://maticpro.net
 ...
 *   - Your daily income starts at 5% with a total payout of 365%. This is not including compounding or referrals, which will increase your payout.
 *   - You can claim or compound at anytime.
 *
 *    Referral Details
 *
 *   - There are 3 levels to our referral system: 8% - 5% - 2%
 *
...
contract MaticPro {
	...
	uint256 constant public INVEST_MIN_AMOUNT = 0.001 ether; // 0.001 matic minimum
	uint256[] public REFERRAL_PERCENTS = [80e2, 50e2, 20e2];
	uint256 constant public INVESTMENT_PROJECT_FEE = 50e2;
	...
	constructor(address payable wallet, uint256 startDate) public {
        ...
        plans.push(Plan(365, 50e2));  //stop  when 365percent profit   5percent daily roi
	}
