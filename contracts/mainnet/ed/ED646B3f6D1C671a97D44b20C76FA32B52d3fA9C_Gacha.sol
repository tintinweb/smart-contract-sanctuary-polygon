    ...
    UUPSUpgradeable
{
    ...
    function setData(address _address) public {
        ...
        _grantRole(UPDATER_REWARDS_ROLE, _address);
        _grantRole(UPDATER_ACTIVITIES_ROLE, _address);
        _grantRole(CLOSE_GACHA_ROLE, _address);
    }
    ...
    function checkRequireBalanceNft(
        ...
        if (
            ...
            return
                checkBalanceNft(challangerAddress) &&
    ...
    function _authorizeUpgrade(
        address newImplementation //onlyRole(UPGRADER_ROLE)
    ) internal override {}
