// SPDX-License-Identifier: MIT
    ...
    contract FoxBok is ERC721, Ownable, ERC721Enumerable {
      ...
      event FoxMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("FoxBok", "FBK") {}
      ...
      function mintFox(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit FoxMinted(id, msg.sender);
          }
        }
      }
    
      function presaleFox(uint256 numberOfTokens) external payable {
        ...
        returns (string memory)
      {
        ...
        if (isRevealed == false) {
          return
            "ipfs://QmdFco4RH1b38HUsAqtKo5xUidZHexjyqywe8tYHc2Qb2r/hidden.json";
        }
