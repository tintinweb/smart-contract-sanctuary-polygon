...
// File: contracts/RedeemablesFunctionsExisting1155.sol
...
contract RedeemablesFunctionsExisting1155 is
  Pausable,
  Ownable,
  BasicMetaTransaction
{
  ...
  function createRedeemableExisting1155(
    bytes32 _redeemableId,
    bytes32 _projectId,
    uint256 _amount,
    string memory _name,
    ...
    require(
      ERC1155(_contract).balanceOf(msgSender(), _token) >= _amount,
      "Balance of ERC1155 is too low."
    );

    require(
      ERC1155(_contract).isApprovedForAll(msgSender(), address(this)) == true,
      "Need to give the Redeemable contract approval for this ERC1155."
    );
