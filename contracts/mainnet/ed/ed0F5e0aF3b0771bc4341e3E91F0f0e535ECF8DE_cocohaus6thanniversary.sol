...
contract cocohaus6thanniversary is ERC721, ERC721Enumerable, ERC721Burnable, ERC721Royalty, Ownable {
    ...
    constructor(address trustedForwarder) ERC721("cocohaus6thanniversary", "C6A_E20") {
        _tokenIds.increment();
