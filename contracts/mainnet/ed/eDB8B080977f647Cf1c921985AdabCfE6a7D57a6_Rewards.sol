...
contract Rewards is ERC721, ERC721Enumerable, Ownable, RoyaltiesV2Impl {
    ...
    uint256 public constant PRICE_PER_TOKEN = 1250 ether;

    mapping(address => uint8) private _allowList;

    address public artist;

    constructor(address artist_) ERC721("Blox Rewards", "BLOXR") {
        artist = artist_;
    }
