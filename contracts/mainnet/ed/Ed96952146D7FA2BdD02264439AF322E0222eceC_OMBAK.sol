...
contract OMBAK is ERC721 {
    uint256 public totalSupply;
    uint256 public cost = 0.1 ether;
    uint256 public maxMints = 21;
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeif4wg6t57koa4yenyi7dzpkwch5nx7d5vxptsv4ui6fb6mfa5nbuu/", Strings.toString(tokenId), ".json")
            );
    }
