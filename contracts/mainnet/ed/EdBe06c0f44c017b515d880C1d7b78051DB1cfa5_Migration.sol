...
contract Migration is OwnableUpgradeable, PausableUpgradeable {
    ...
    function getMigratedTrollOwners() public view returns (address[] memory owners) {
    ...
    function getMigratedForgeOwners() public view returns (address[] memory owners) {
    ...
    function getMigratedMineOwners() public view returns (address[] memory owners) {
