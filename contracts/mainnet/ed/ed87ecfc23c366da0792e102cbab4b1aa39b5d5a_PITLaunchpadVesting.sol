...
// File contracts/main/interfaces/IPITLaunchpadVesting.sol
...
/**
 * @title IPITLaunchpadVesting. Works with PITLaunchpad
 * Create a vesting schedule for an PITLaunchpad.
 ...
 */
interface IPITLaunchpadVesting {
    // /**
    ...
    /**
     * @dev Add a user to the vesting contract. Comes from PITLaunchpad contract.
     * @param _pid: pool id
...
// File contracts/main/PITLaunchpadVesting.sol
...
/**
 * @title PITLaunchpadVesting. Works with PITLaunchpad
 * Create a vesting schedule for an PITLaunchpad.
 * All users, when harvesting, will have a portion of tokens sent for same vesting schedule.
 */
contract PITLaunchpadVesting is IPITLaunchpadVesting, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    // address of user => pool Id of PITLaunchpad => vesting info
