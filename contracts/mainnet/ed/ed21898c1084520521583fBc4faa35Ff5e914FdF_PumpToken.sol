...
contract PumpToken is ERC20Detailed, Ownable {
    ...
    address public liquidityReceiver = 0x2f1DdC20851E5662305eF87dcE360349465F3c98;
    address public treasuryReceiver = 0xd8070f711fF60b158BdA0489b0b6390DBF6Bb86c;
    address public riskFreeValueReceiver = 0x936a57b1e6CBf91D923815a3cDBEFDcC76588fcd;
    address public maiToken = 0xa3Fa99A148fA48D14Ed51d610c367C61876997F1;
    ...
    constructor() ERC20Detailed("PUMP Finance", "PUMP", uint8(DECIMALS)) {
        router = IDEXRouter(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff);
        pair = IDEXFactory(router.factory()).createPair(address(this), router.WETH());
        address pairmiMATIC = IDEXFactory(router.factory()).createPair(address(this), maiToken);
    ...
    function _swapAndLiquify(uint256 contractTokenBalance) private {
        ...
        if(isLiquidityInMatic){
            ...
            uint256 newBalance = IERC20(maiToken).balanceOf(address(this)).sub(initialBalance);
    ...
    function _addLiquiditymiMATIC(uint256 tokenAmount, uint256 miMATICAmount) private {
        router.addLiquidity(
            address(this),
            maiToken,
            tokenAmount,
    ...
    function _swapTokensFormiMATIC(uint256 tokenAmount, address receiver) private {
    ...
    event SwapAndLiquifymiMATIC(uint256 tokensSwapped, uint256 miMATICReceived, uint256 tokensIntoLiqudity);
