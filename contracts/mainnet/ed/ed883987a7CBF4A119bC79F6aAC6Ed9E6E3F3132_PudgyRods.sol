 ...
 * @notice This contract handles minting Pudgy Rods tokens.
 */
contract PudgyRods is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xCC91C20932a46A2E56Ce00d3f5f7A0041A7e6B4d;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xEe3f19e5f676d9E3e1c4E5D70875919508F381a0;
    address[] public payoutAddresses = [
        0xEe3f19e5f676d9E3e1c4E5D70875919508F381a0
    ];
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeibj4nbpn4qg47xwrh5xdrgswartgkqv7x5tihysoajhpbl5imfd4y/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[1] = 3000;
        tokenPublicPrice[1] = 0 ether;
        tokenPublicMintsPerAddress[1] = 3000;
        require(
