...
contract RoyaltySplitter is Ownable, IRoyaltySplitter {
    ...
    address public charity = 0x7Da69EC519510AE84F1F0586dD2d6463E940bC30;
    address public artist1 = 0x7c79ab569E1b08E3Bc1E06aeeAf4F4cDf5B6C479;
    address public artist2 = 0xadD817D88804E020675AE299eE1a85AE21880bD0;
    ...
    constructor() payable {
        ...
        //Set TQOE
        TQOEContracts[0x59B14516F43934E0e0a026F8A7Fc0f077A493B8a] = true;
    ...
    function transferFromShares(address from, address to, uint256 amount) public onlyOwner {
        ...
        require(from == msg.sender || isAdmin[msg.sender] || msg.sender == owner(), "Not Owner or Admin!");
        _shares[from] -= amount;
        _shares[to] += amount;
    }
