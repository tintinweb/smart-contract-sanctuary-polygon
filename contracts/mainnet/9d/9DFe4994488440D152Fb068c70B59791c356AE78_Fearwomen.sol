 ...
 * @notice This contract handles minting fearwomen tokens.
 */
contract Fearwomen is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0xc066bf8A318F3DAD00c735173549ca781C35Ce92;
    ...
    address public royaltyAddress = 0xE73e8F9518eBEA5f4fEa84A75E01EEE23d67F369;
    ...
    string public name = "fearwomen";
    string public symbol = "FW6";
    ...
    constructor(address _blocklistContractAddress)
        ERC1155(
            "ipfs://bafybeid33ha2v43kuwley7nsutd3brwua4n75a276ffdeznzxueivggtpq/{id}"
        )
    {
        ...
        tokenPublicSaleStartTime[1] = 1673262001;
        tokenPublicSaleEndTime[1] = 1673434800;
