...
contract OverrideMatrix is AccessControl {
    ...
    uint256 public baseRewardRate = 1e10;
    ...
    constructor(address _usdt, address _token, address _noReferPlatform, address _feePlatform, address _initAcc) {
        // 0x684e8B474Dc887Dd0ef45495ECdDDC969af58b6C
        _grantRole(DEFAULT_ADMIN_ROLE, 0x684e8B474Dc887Dd0ef45495ECdDDC969af58b6C);
        // 0x684e8B474Dc887Dd0ef45495ECdDDC969af58b6C
        _grantRole(SETENV_ROLE, 0x684e8B474Dc887Dd0ef45495ECdDDC969af58b6C);
        // 0x684e8B474Dc887Dd0ef45495ECdDDC969af58b6C
        _grantRole(REMOVE_ROLE, 0x684e8B474Dc887Dd0ef45495ECdDDC969af58b6C);
        // 0x684e8B474Dc887Dd0ef45495ECdDDC969af58b6C
        _grantRole(INIT_ROLE, 0x684e8B474Dc887Dd0ef45495ECdDDC969af58b6C);

        USDToken = IERC20(_usdt); // 0xc2132d05d31c914a87c6611c10748aeb04b58e8f
        Token = IERC20(_token); // 0x9100608EaE0Ea1d1CAcC01c632E256F0232eA944
        noReferPlatform = _noReferPlatform; // 0x9039FEdA4DB8F44218AC0b3b44301fa1baf424F1
        feePlatform = _feePlatform;  // 0x31793d3117A3530E654dE40b43e064c6960Ffd31

        accountInfoList[_initAcc].isRegister = true; // 0x9f8BCD076Cf5FD3a4a2B757FCEaB72c6385cb43F
