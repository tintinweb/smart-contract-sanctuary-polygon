...
// File: contracts/CryptoMonsterMarketplace.sol


/**
 * CryptoMonster - CryptoMonsterMarketplace
 */
pragma solidity ^0.8.3;

contract CryptoMonsterMarketplace is Ownable, ReentrancyGuard {
    using SafeERC20 for IERC20;

    using Counters for Counters.Counter;
    Counters.Counter private _itemIds;
    Counters.Counter private _itemsSold;
    IERC20 public CryptoMonsterToken;
    address public CryptoMonsterMonster;
    ...
    constructor() {
        marketplaceOwner = payable(0xD376420aBA13187f3A7f2D0e5362897A11B558DA);
    ...
    function setCryptoMonsterMonstersAddress(address _CryptoMonsterMonsters)
        public
        onlyOperators
    {
        CryptoMonsterMonster = _CryptoMonsterMonsters;
    }

    function setCryptoMonsterTokenAddress(address _CryptoMonsterToken) public onlyOperators {
        CryptoMonsterToken = IERC20(_CryptoMonsterToken);
    }
    ...
    function createMarketItem(
        ...
        require(nftContract == CryptoMonsterMonster, "Invalid ERC721 CA");
        ...
        nonReentrant
    {
        ...
        CryptoMonsterToken.safeTransferFrom(msg.sender, idToMarketItem[itemId].seller, price);
