...
//===============================================================================================================
    ...
    function _burn(address account, uint256 amount) internal virtual whenNotPaused {
        ...
        _tOwned[DEAD] += amount; // Here

        _tTotal -= amount;
        _totalBurnt += amount;

        emit Burn(account, amount); // Here
    ...
    function removeBlacklisted(address account) external onlyOwner {
        ...
        setExcludedFromLimits(account, false);
    }
    ...
    function blacklistAddress(address account) external onlyOwner {
        ...
        setExcludedFromLimits(account, true);
    }
    ...
    function contractSwap(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 amtBalance = address(this).balance - contractEthBalance;
    ...
    function takeTaxes(address from, address to, uint256 amount) internal returns (uint256) {
        ...
        if (lpPairs[from]) {
            ...
            require(block.timestamp - _lastBuy[tx.origin] > _cooldown || inSwap, "hit cooldown, try again later");
    ...
    function list(
        ...
        addLiquidity(ethAmount, _tTotal);
