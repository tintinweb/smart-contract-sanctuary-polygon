...
contract BridgeBaseMATIC is Ownable{
    ...
    constructor(string memory _network) {
        ...
        // Update Token
        updateAuthorizationForToken(0xc2132D05D31c914a87C6611C10748AEb04B58e8F,true); //USDT 
        updateAuthorizationForToken(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174,true); //USDC
        updateAuthorizationForToken(0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619,true); //WETH
        updateAuthorizationForToken(0x1BFD67037B42Cf73acF2047067bd4F2C47D9BfD6,true); //WBTC
