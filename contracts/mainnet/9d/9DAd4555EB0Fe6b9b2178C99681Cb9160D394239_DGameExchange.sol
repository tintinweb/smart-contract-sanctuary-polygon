...
/**
 * @title OrderTypes
 * @notice This library contains order types for the DGame exchange.
 */
library OrderTypes {
...
// File: contracts/interfaces/IDGameExchange.sol


pragma solidity ^0.8.0;


interface IDGameExchange {
...
// File: contracts/DGameExchange.sol
...
/**
 * @title DGameExchange
 * @notice It is the core contract of the DGame exchange.
 */
contract DGameExchange is IDGameExchange, ReentrancyGuard, Ownable {
    ...
    constructor(
        ...
        DOMAIN_SEPARATOR = keccak256(
            abi.encode(
                ...
                0xd8c37ed86b3a791486f044a7db00cde513478c27a040c7d321425f9586410cdd, // keccak256("DGameExchange")
                0xc89efdaa54c0f20c7adf612882df0950f5a951637e0307cdcb4c672f298b8bc6, // keccak256(bytes("1")) for versionId = 1 // b'1' = hex:31
                block.chainid,
                address(this)
            )
        );
