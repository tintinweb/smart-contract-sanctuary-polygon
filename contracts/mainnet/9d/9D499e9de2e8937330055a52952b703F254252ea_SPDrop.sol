...
contract SPDrop is ERC721 , DefaultOperatorFilterer {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeielcy4snznmpis6hfhpcjygckisd3cojrd6brfgcwxyhf2uasajre/", Strings.toString(tokenId), ".json")
            );
    }
