...
contract DropV2 is ERC165, DropV2DeployI, ReentrancyGuard, DropV2I {
    using Address for address payable;
    using Address for address;

    bool public isPrototype;
    MetaNanoDataI public metaNanoData;
    DropV2Factory public parent;
    ...
    AuctionV2[] public deployedAuctions;
    ...
    external
    {
        ...
        auctionPrototypeAddress = _auctionPrototypeAddress;
        require(address(metaNanoData) == address(0), "Cannot be initialized twice.");
        parent = DropV2Factory(msg.sender);
    ...
    external {
        ...
        AuctionV2DeployI(newAuctionAddress).initialRegister(prev);
        deployedAuctions.push(AuctionV2(newAuctionAddress));
    ...
    requireIsInstance
    {
        ...
        require(bidWei[_bidder] == 0, "there is an existing bid from this user, please call adjustBid");
