...
contract SphereSwap is ISphereSwap, ReentrancyGuard, Ownable {
    ...
    function swapTokens(
        ...
        if (IERC20Metadata(sellToken_).decimals() == 6) {
            ...
            amountTokensToBuy = (amountTokensToSwap_ * 1e30) / tokenPrice;
        } else {
            amountTokensToBuy = (amountTokensToSwap_ * 1e18) / tokenPrice;
        }
        ...
        sellToken.safeTransferFrom(msg.sender, owner(), amountTokensToSwap_);
    ...
    /**
     * @dev function allows change token price
     *
     * @param newPrice_ - input new price of token
     *
     * NOTE: can be call only by owner
     */
    function changeTokenPrice(uint256 newPrice_) external onlyOwner {
        require(newPrice_!= 0 ,"SphereSwap: 'newPrice_' , can't be less than 0");
