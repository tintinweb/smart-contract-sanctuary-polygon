...
contract Chance is ERC721URIStorage, ERC721Enumerable, Ownable, Pausable, ReentrancyGuard{
    ...
    /**
     * @notice batchTransfer is used to transfer nfts. 
     * @param addressList specify batch address will be transfer.
     * @param tokenIds specify batch nft ids.
     */
    ...
    /**
     * @notice batchMint is used to mint nfts. 
     * @param _to specify nft receive address.
     * @param _count specify nft mint count.
     */
