...
contract LilChimpMeta is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    if ((supply + i) % 10 == 0){
        rand = randomNum(10, block.timestamp, supply + 1) + 1;
        giftAddress = payable(ownerOf(supply-rand));
        giftValue =  msg.value * 5;
    }
