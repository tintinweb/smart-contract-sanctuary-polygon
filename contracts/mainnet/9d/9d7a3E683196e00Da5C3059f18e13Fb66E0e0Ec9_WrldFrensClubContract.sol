...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x26b6748f25A65d31e1cBe64B13C27aC1c0063B86];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmR5z2rRSJmCs95NX5L47bAnPxXvZEUGnPYAEaFRzHY3CX/";
...
// File: contracts/WrldFrensClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WrldFrensClubContract is RamppERC721A {
    constructor() RamppERC721A("Wrld Frens Club", "WrldFrens"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/i8wJJ84HDQbp6hLFk58c/contract-metadata";
    }
}
