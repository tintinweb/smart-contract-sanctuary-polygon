...
contract CervejaVersoERC721 is ERC721A, AccessControl, Ownable {
     ...
     *
     * @param tokenURIString_. The new base URL for the metadata of the collection.
     */
    function setURI(string memory tokenURIString_)
        external
        onlyOwner
        notFrozen
    {
        tokenURIString = tokenURIString_;
        emit setURIEvent(tokenURIString_);
    }
