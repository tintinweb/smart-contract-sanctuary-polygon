...
contract Bridge is IBridge, AccessControlUpgradeable, ERC721HolderUpgradeable, UUPSUpgradeable {
    ...
    function export(ExportData calldata exportData, GUID referenceId) external onlyRole(VOICE_EXPORTER) {
        ...
        simpleAssets.create(to, exportData.category, exportData.jsonMeta, exportData.baseUri);
...
type GUID is bytes32;
    ...
    function export(
        ExportData calldata exportData,
