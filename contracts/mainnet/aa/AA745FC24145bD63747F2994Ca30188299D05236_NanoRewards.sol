...
contract NanoRewards is ERC721A, ERC2981, NanoBase {

    constructor(address _metaNanoData)
    ERC721A("META NANOs Rewards", "NANO_REWARD")
    NanoBase(_metaNanoData, "NanoRewards")
    {}

    function mintFor(address destination, uint256 quantity) external only("rewardsMinter") {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return MetaNanoTokenMetaDataI(metananoData.getAddress("tokenMetaDataNanoRewards")).tokenURI(tokenId);
    }
}
