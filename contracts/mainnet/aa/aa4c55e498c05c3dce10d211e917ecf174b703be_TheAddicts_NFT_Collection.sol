...
// File: contracts/Simple_NFT_LOW_Gas.sol
...
contract TheAddicts_NFT_Collection is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("TheAddicts.NFT Collection", "THEADDICTS") {
    setHiddenMetadataUri("ipfs://QmcriRFrk4cGpRSzhwfPZ8bWHboCHphHRJXVrS6A72QWyr/hidden.json");
  }
