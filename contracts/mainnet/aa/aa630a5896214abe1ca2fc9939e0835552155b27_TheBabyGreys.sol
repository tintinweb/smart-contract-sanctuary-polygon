...
contract TheBabyGreys is ERC721Enumerable, Ownable {
	using Strings for uint256;
	...
	uint256 public totalMaxSupply = 5555;
	...
	address liquidity = 0x1C7733FE2327675C534A165AcB6BB56B14e2e597;
	...
	constructor (
		...
		giveAway(1, 0x1C7733FE2327675C534A165AcB6BB56B14e2e597); //RACKS
		giveAway(1, 0x1C7733FE2327675C534A165AcB6BB56B14e2e597); //DEV1
		giveAway(1, 0x1C7733FE2327675C534A165AcB6BB56B14e2e597); //DEV2
		giveAway(1, 0x1C7733FE2327675C534A165AcB6BB56B14e2e597); //DEV3
		giveAway(1, 0x1C7733FE2327675C534A165AcB6BB56B14e2e597); //PRESENT
		giveAway(1, 0x1C7733FE2327675C534A165AcB6BB56B14e2e597); //RACKS2
		giveAway(1, 0x1C7733FE2327675C534A165AcB6BB56B14e2e597); //DEV4

		giveAway(3, 0x1C7733FE2327675C534A165AcB6BB56B14e2e597); //RACKS
		giveAway(3, 0x1C7733FE2327675C534A165AcB6BB56B14e2e597); //YONA
		giveAway(3, 0x1C7733FE2327675C534A165AcB6BB56B14e2e597); //DEV2
		giveAway(3, 0x1C7733FE2327675C534A165AcB6BB56B14e2e597); //DEV3
		giveAway(3, 0x1C7733FE2327675C534A165AcB6BB56B14e2e597); //RACKS2
		giveAway(3, 0x1C7733FE2327675C534A165AcB6BB56B14e2e597); //DEV4
	}
	...
	function mint(uint256 _mintAmount) public payable {
		...
		if (msg.sender != owner())
			require(msg.value >= cost[phase] * _mintAmount);
	...
	function checkPhase(uint256 _supply) pure internal returns (uint256) {
		if (_supply <= 1000)
			return 0;
		if (_supply <= 4000)
			return 1;
