...
contract SpaceAnomaly is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeiewmehrrrau6hriu5rwbrwapyzvh42droickiaikxi7zuehbfpgl4/", Strings.toString(tokenId), ".json")
            );
    }
