...
contract VaultAdmin is VaultStorage {
    ...
    */
    function _setStrategyWithWeights(StrategyWithWeight[] calldata _strategyWithWeights) internal onlyGovernor {
        ...
        // Remove all strategyWithWeightPositions
...
|    * @param _payoutTimeRange duration to honor payout time. Ex: 15 * 60;
    ...
    */
    function _payout() internal {
        ...
        // uint256 _initDripper = IERC20(primaryStableAddress).balanceOf(dripperAddress);
        ...
        _t = cash.totalSupply();
        _nav = IVaultCore(address(this)).nav();
        console.log("B-TS: %s, NAV: %s", _t, _nav);
        ...
        require( (_finalCash - _initCash) > (_initCash * dailyExpectedYieldBps)/(1000000), string(abi.encodePacked("LOW_YIELD: ", (_finalCash - _initCash) )));
        emit Payout(0);
