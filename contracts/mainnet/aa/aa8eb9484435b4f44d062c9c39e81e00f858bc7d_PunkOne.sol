...
contract PunkOne is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("EthPunkV1", "EthPunkV1", maxBatchSize_, collectionSize_) {
  ...
  // For marketing etc.
  function mintMhOne(uint256 quantity) external onlyOwner {
    require(
