...
//        }
    ...
    function invest(address referrer, uint8 plan) public payable {
        ...
        require(msg.value >= INVEST_MIN_AMOUNT,"CS: too small");
        require(plan < 6, "CS: Invalid plan");

        uint256 fee = msg.value.mul(PROJECT_FEE).div(PERCENTS_DIVIDER);
        (bool success,) = commissionWallet.call{value: fee}(""); // forwarding gas okay here as commission wallet is guaranteed to be a wallet
        require(success, "CS: commission payment failed");
    ...
    function withdraw() public {
        ...
        require(totalAmount > 0, "CS:user has no dividends");
        ...
        require(success, "CS: payment failed");
