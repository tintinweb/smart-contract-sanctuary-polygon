...
/**
   ...
   1. Build a decentralized domain and universe. Let the memory mint in the blockchain, preserved forever. Describe these memories in an objective and unbiased way. It is not controlled, threatened, distorted or deleted by any government or person.

   2. Build a metaverse, use VR + AR technology to bring everyone into memory, experience and remember this period of history.

   3. We mint MTM tokens to reward those who provide us with memories. And the people who support us.

   4. In the process of casting memory, MTM tokens are constantly destroyed and burned to bring wealth to the holders.

   5. The proceeds will be used to establish a foundation, Connect with and help everyone in the memory.

   6. Build decentralized consensual communities, Pass the work on.
...
contract MintMemory is Context, IERC20, Ownable, ReentrancyGuard {
	...
	uint256 private _tTotal = 10000000000000000000000000 * 10**6 * 10**2;
	uint256 private _rTotal = (MAX - (MAX % _tTotal));
	uint256 private _tHODLrRewardsTotal;

	string private _name = "Mint Memory";
	...
	uint256 public _maxTxAmount = 10000000000000000000000000 * 10**6 * 10**2;

	event TransferBurn(address indexed from, address indexed burnAddress, uint256 value);
//Build a decentralized domain and universe. Let the memory mint in the blockchain, preserved forever. Describe these memories in an objective and unbiased way. It is not controlled, threatened, distorted or deleted by any government or person..
	constructor () {
