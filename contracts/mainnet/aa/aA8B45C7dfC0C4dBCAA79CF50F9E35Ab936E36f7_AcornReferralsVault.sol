...
/**
 * @title AcornReferralsVault
 * @notice 3% of Acorn casino profits distributed among the referents.
 */
contract AcornReferralsVault is ReentrancyGuard, Pausable, Ownable {
    //---------- Libraries ----------//
    using SafeMath for uint256;
    using Counters for Counters.Counter;

    //---------- Contracts ----------//
    IERC20 private CHIP; // Acorn CHIP token contract.
