    ...
    ERC2981
{
    ...
    ) ERC721("Request-response", "RR") AxelarExecutable(gateway_) {
    ...
    function safeMintBatch(
        ...
        require(
            _requestors.length == _uri.length && _feeNumerators.length == _creators.length && _creators.length == _requestors.length,
