...
import "../module1/events.sol";
import "../module2/events.sol";
import "../module3/events.sol";


contract InteropXNullImplementation is Module1Events, Module2Events, Module3Events{
...
contract Module2Events is Structs {
...
contract Module3Events is Structs {
    event LogRevert(
        Position position,
        string actionId,
        bytes32 indexed actionIdHashHash,
