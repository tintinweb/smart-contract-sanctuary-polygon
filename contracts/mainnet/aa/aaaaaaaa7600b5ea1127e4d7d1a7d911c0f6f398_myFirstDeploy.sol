...
contract myFirstDeploy is ISnowV1Program, OwnableUpgradeable {
    ...
    function changeIndex(uint8 newIndex) public onlyOwner {
        savedIndex = newIndex;
    }

    function changeSprite(uint256 newSprite) public onlyOwner {
