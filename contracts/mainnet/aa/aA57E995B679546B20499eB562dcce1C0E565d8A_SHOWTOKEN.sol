 ...
 * @notice This contract handles minting SHOW TOKEN tokens.
 */
contract SHOWTOKEN is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x4e403A9B3f432319D63B6d8bb416D1951Aa64972;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x4196cAa3725144BD3a6f1273C733352eba5Cd7d5;
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeia7kn7g2jcg6is74i2yysdk2h42chyppnqbxwivtiki2jdpfajpaa/{id}"
        )
        RevokableOperatorFilterer(
