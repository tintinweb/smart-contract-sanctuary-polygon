...
contract QuickSwapAdapter is DexAdapterCore {
    ...
    address public constant polycatRouter = address(0x94930a328162957FF1dd48900aF67B5439336cBD);
    ...
    function _getRouter(address _token) internal view override returns (address) {
        ...
        if (_token == address(0xFbdd194376de19a88118e84E279b977f165d01b8)) {
            // BiFi Token
            return comethRouter;
        }
        return router;
