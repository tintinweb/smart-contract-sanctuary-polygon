...
/**
 * @dev The Samsung MX1 GENESIS EDITION NFT is the first Samsung Europe NFT ever.
 * It functions as the Samsung Community Token for the Samsung web3 Eco System.
 * Learn more on https://nft.samsung.de
 */
contract MX1GenesisEdition is
    ...
    AccessControl
{
        ...
        MintVoucherValidator(name, "1")
    {
        ...
        // Define Services
        _grantRole(AIRDROPPER_ROLE, 0x9f69dEFF9cd21Cf82F6309256cb7499EE9B2ACdB);
        SIGNER_WALLET = 0x5ef2e3c016b76bF0d5584bEA3FBe206f36844514;
    }
    ...
    function allowlistMint(
        ...
        require(
            ...
            "MX1GenesisEdition: Signature already used"
        );
     ...
     */
    function airdrop(address minter, uint256 quantity)
        public
    ...
    modifier onlyMintingEnabled() {
        require(
            mintingEnabled == true,
            "MX1GenesisEdition: Minting is not Enabled"
        );
        _;
    }
