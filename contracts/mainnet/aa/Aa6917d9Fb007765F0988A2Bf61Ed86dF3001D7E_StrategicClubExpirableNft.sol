...
import "./ERC1155SingleURIStorage.sol";


/**
 * Strategic Club expirable NFT
 */
contract StrategicClubExpirableNft is
    ERC1155AutoId,
    ERC1155Pausable,
    ERC1155SingleURIStorage,
    Ownable
{
    ...
    // NFT name
    string constant private NFT_NAME = "Strategic Club Expirable NFT";
    // NFT symbol
    string constant private NFT_SYMBOL = "SCEX";
    ...
    constructor(
        ...
        ERC1155("")
        ERC1155SingleURIStorage(baseURI_)
    {
        name = NFT_NAME;
        symbol = NFT_SYMBOL;
    }
    ...
    function mintTo(
        ...
        emit SingleTokenMinted(totalSupply(), amount_);
    }

    /**
     * Mint multiple tokens to a specific address
     * @param to_      Receiver address
    ...
    function mintBatchTo(
        ...
        uint256 token_num = amounts_.length;
        emit MultipleTokensMinted(totalSupply() - token_num, token_num, amounts_);
    }
    ...
    function uri(
        uint256 tokenId_
    ) public view virtual override(ERC1155SingleURIStorage, ERC1155) returns (string memory) {
...
/**
 * ERC1155 token that stores and handles a single URI
 * It replaces the _uri used in openzeppelin contract, by handling the URI like in ERC721
 */
abstract contract ERC1155SingleURIStorage is ERC1155 {
    ...
    /**
     * Require a URI to be not empty
     * @param uri_ URI
     */
    modifier notEmptyURI(string memory uri_) {
        require(bytes(uri_).length > 0, "Cannot set an empty URI");
        _;
    }
     ...
     * Freeze URI
     */
    function _freezeURI() internal {
        require(!uriFreezed, "ERC1155SingleURIStorage: URI cannot be freezed anymore");
    ...
    /**
     * Set base URI, internal function
     * @param baseURI_ Base URI
     */
    function _setBaseURI(
        string memory baseURI_
    ) internal {
        require(!uriFreezed, "ERC1155SingleURIStorage: URI cannot be changed anymore");
    ...
    /**
     * Set contract URI, internal function
     * @param contractURI_ Contract URI
     */
...
/**
 * ERC1155 token with automatic token ID handling
 */
abstract contract ERC1155AutoId is ERC1155 {
    using Counters for Counters.Counter;
    ...
    /**
     * Batch mint to a specific address
     * @param to_      Receiver address
