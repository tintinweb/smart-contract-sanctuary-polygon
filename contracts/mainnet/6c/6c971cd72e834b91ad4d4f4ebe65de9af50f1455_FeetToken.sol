...
// File: contracts/FeetToken.sol

// contracts/FeetToken.sol

pragma solidity ^0.8.0;


contract FeetToken is ERC20 {
    constructor() ERC20("FeetToken", "FEET") {
        _mint(msg.sender, 666666666666 * (10 ** uint256(decimals())));
    }
