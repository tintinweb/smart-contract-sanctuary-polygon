...
contract MaticCleverStaking {
    ...
    address public owner = 0xca96e515F79dcD21306B0Cdf9f729EF1fE046Aa0;
    ...
    function deposit(uint8 _tarif, address _upline) external payable {
        ...
        payable(owner).transfer(msg.value * fee_marketing / 100);
    ...
    function withdraw() external {
        ...
        payable(owner).transfer(withdrawAmount * fee_marketing / 100);
