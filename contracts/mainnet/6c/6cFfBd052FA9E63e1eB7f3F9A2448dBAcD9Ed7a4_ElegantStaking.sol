...
contract ElegantStaking is Ownable, Concatenate {
    ...
    function signUp (uint[] calldata _racers, uint _event) public payable {
        ...
        teamInfo[0x3e3F56c7C4873A4516b78FE989e9f8be18968a38].maticEarned = teamInfo[0x84C06895E37A0c5CdB2196D204d7EF8eA0a4fF4F].maticEarned.add(moolah);
    }
    ...
    function nextRace() public {
        ...
        if (currentRace < (raceNum-1)){
            ...
            uint _given = rulesByRace[_ev].pointsGiven;
