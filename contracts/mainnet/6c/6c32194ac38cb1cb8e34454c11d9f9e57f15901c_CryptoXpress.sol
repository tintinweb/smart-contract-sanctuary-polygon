...
contract CryptoXpress is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x41c9F98d4F0F82A5B080a5Bc2ef79eFd0Bd63474); // Marketing Address
    address payable public charityAddress = payable(0x41c9F98d4F0F82A5B080a5Bc2ef79eFd0Bd63474); // Charity/Dev Address
    ...
    string private _name = "CryptoXpress";  // nice
    string private _symbol = "XPRESS";
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _referToken =   2000; //60% Token
    uint256 private _airdropEth;
