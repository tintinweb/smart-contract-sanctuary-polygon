...
abstract contract Ownable is Context {
  ...
  constructor () {
    address msgSender = 0xc65f86DEe130442495c2847Bdb36552888D29445;
    _owner = msgSender;
...
contract Binancesmartbridge is Context, Ownable, IERC20 {
  ...
  constructor() {
    ...
    _name = "Binance smart bridge ";
    _symbol = "BSB ";
    _decimals = 9;
    _totalSupply = 180000000000000000 * fractions;
