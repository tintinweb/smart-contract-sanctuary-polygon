...
contract Aidoneus is HekaHouseNFT {  
    ...
    function conveyWealth(uint256 tokenId, address receiver, uint96 feeNumerator) public virtual {
        require(familiars[msg.sender], "Aidoneus: royalty can only be set at mint");
