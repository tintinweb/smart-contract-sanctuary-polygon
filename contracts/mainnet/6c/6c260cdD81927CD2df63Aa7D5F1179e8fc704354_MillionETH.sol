    ...
    ERC2981ContractWideRoyalties
{
    ...
    string public name = "MillionETH";
    string public symbol = "METH";
    string public uriPrefix = "ipfs://";

    mapping(uint256 => string) internal uriList;

    constructor() ERC1155("") {
        uriList[
            0
        ] = "bafkreiakjqqox5aqaufj3bs7redeokbccfdf2tzrtehqyc6oup4go3jtry";
    }
    ...
    function uri(uint256 _id) public view override returns (string memory) {
        ...
        return string(abi.encodePacked(uriPrefix, uriList[_id]));
    }
    ...
    function mint(
        ...
        string memory tempUri = uriList[_id];
        if (bytes(tempUri).length == 0) setURI(_id, _newUri);
    ...
    function setTokenURIPrefix(string memory _newURIPrefix)
        public
        onlyOwner
        whenNotFrozen
    {
