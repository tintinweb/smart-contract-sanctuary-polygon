...
////////////////////////////////////////////////////////////////////////
// DNZN JUAN 0xPOLYGON TOKENS 001 //
////////////////////////////////////////////////////////////////////////
...
contract DnznJuan_0xP1 is ERC721, ERC721URIStorage, ERC721Burnable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    uint public currentTokenID = _tokenIdCounter.current();
    uint public maxTokenSupply = 111;

    constructor() ERC721("DnznJuan_0xP1", "DJP1") {}

    function mint(address to, string memory uri) public onlyOwner {
        require(_tokenIdCounter.current() < maxTokenSupply, "It's full fren, full of NFTs!!!");
