...
contract FMS is ERC721 , DefaultOperatorFilterer {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeidsjhq5a32dp4d2rv4ir62nxu3ujryoqbgpzlq5suhqlyfniycbs4/", Strings.toString(tokenId), ".json")
            );
    }
