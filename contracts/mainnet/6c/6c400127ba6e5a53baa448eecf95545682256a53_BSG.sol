...
contract BSG is Ownable {
    ...
    function _calLevelNow(address _user) private view returns(uint256) {
        ...
        if(total >= 5000e18 && user.teamNum >= 200 && maxTeam >= 50000e18 && otherTeam >= 50000e18){        
    ...
    function RewardDistribution(uint256 _amount, bool isIncludeOwnerFund) public onlyOwner returns(bool)
    {
