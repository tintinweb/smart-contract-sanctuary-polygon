    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeihhknahhpqsgivujrvadinqprnz3zrrueiz7eify4pzwb4z2adh7m/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/lKWGPCUZwINJJ2SpJ777/contract-metadata";
  }
...
// File: contracts/InvisibleFriends3DContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract InvisibleFriends3DContract is RamppERC721A {
    constructor() RamppERC721A("Invisible Friends3D", "3DFriends"){}
}
