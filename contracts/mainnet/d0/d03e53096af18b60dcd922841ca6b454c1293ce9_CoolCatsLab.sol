...
contract CoolCatsLab is ERC721, Ownable, Pausable {
	using Counters for Counters.Counter;
	using Strings for uint256;

	address 								_address_for_withdrawal = 0xe32e0A6878B171De74f99c7794Bc96cC529dE29A;
	...
	uint256 private 						_mint_reserved = 1000;
	uint256 private 						_mint_limit = 100;
	uint256 private 						_mint_limit_whitelist = 100;
	string private 							_base_url = 'https://gateway.pinata.cloud/ipfs/QmVWuW6PaNXsqKiG36YDPhZZ95Zen8qat5KimzizJrqnKp/';
	bool private							_is_whitelist_only = false;
	bool private							_mint_limit_by_addy = false;

	//construct
	constructor() ERC721('CoolCatsLab','CCLAB') {
