...
contract Lips is ERC721, NonblockingReceiver {

    string public baseURI = "ipfs://QmRxKbCPhgfYqXPJN3nCGh9WiRnF5jdsNQG5Yg7CVKqW5X/";
    string public contractURI = "ipfs://QmXVvuhUv8jr1XMobFbJz2LTwS5F9A1afn2dQBryj4idiJ";
    ...
    function mint(uint256 _amount) external payable {
        ...
        require(!paused, "lips: Paused");
        require(nextTokenId + _amount <= MAX_MINT, "lips: Mint exceeds supply");
        require(MAX_PER_TX >= _amount , "lips: Excess max per tx");
        require(MAX_PER_WALLET >= minted[_caller] + _amount, "lips: Excess max per wallet");
    ...
    function traverseChains(uint16 _chainId, uint256 tokenId) public payable {
        ...
        require(
            ...
            "lips: msg.value not enough to cover messageFee. Send gas for message fees"
        );
