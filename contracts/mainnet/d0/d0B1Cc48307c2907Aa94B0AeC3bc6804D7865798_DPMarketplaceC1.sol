...
contract DPMarketplaceC1 is ERC721URIStorage, ReentrancyGuard {
  ...
  address private contractOwner = 0x48aC16e239125957821CFE45dc6Ab0A7b84996aa;
  address private charity = 0xEe1189Cf81B3e2fe69f220Bd9c4134798D555726; 
  address private web3re = 0xe62999Ae2A44Faece55E82f7Ae0e9C6C49787B45;  
  ...
  constructor() ERC721("GoyaNFT", "GOYANFT") {
  ...
  function createMarketSale(
    ...
    uint price2 = idToMarketItem[tokenId].sellpriceUSD.getOrgUsdMatic();
    ...
    if (idToMarketItem[tokenId].initialList == true) {
      ...
      payable(creator).sendValue(creator_MATIC);
      payable(charity).sendValue(charity_matic_total);
      payable(web3re).sendValue(web3re_matic_total);
      ...
      payable(creator).sendValue(creator_MATIC);
      payable(seller).sendValue(seller_MATIC);
      payable(charity).sendValue(charity_matic_total);
      payable(web3re).sendValue(web3re_matic_total);
...
library PriceConverter {
    ...
    function getPrice() internal view returns (uint256) {
        AggregatorV3Interface priceFeed = AggregatorV3Interface(0xAB594600376Ec9fD91F8e885dADF0CE036862dE0); //Polygon mainnet
