...
contract Gamme {
    ...
    uint256 private constant luckPoolPercents = 50;                     //0.50%
    uint256 private constant starPoolPercents = 50;                     //0.50%
    uint256 private constant topPoolPercents = 50;                      //0.50%
