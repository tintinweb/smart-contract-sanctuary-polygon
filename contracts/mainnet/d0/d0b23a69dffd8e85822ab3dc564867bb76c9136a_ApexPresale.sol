...
contract ApexPresale is Context, Ownable {
  ...
  constructor(bool _seed,address _token,address _busd,uint256 _price,uint256 _maxsold,uint256 _maxhold,address _recaiver) public {
      saletoken = _token;
      busd = _busd;
  ...
  function buy(uint256 amount) external noReentrant returns (bool) {
      ...
      maxsold = maxsold.add(tokenbought);
