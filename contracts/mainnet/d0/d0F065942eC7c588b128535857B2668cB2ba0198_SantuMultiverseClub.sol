 ...
 * @notice This contract handles minting Santu Multiverse Club tokens.
 */
contract SantuMultiverseClub is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address public royaltyAddress = 0xBCe3B49436d24EAafac16639392Eaf468Df15ed5;
    address[] public payoutAddresses = [
        0xBCe3B49436d24EAafac16639392Eaf468Df15ed5
    ];
    ...
    string public baseTokenURI =
        "ipfs://bafybeifdwqu632xoybeytvsxi5wux2yshnf2gfiuqix4dqozhjdhjhzuee/";
    // Maximum supply of tokens that can be minted
    uint256 public MAX_SUPPLY = 1000000;
    // Fee paid to HeyMint per NFT minted
    uint256 public heymintFeePerToken;
    uint256 public publicMintsAllowedPerAddress = 1000000;
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC721A("Santu Multiverse Club", "SMCT")
        RevokableOperatorFilterer(
