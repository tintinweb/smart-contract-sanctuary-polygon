...
contract NFTAcademy is ERC721, ERC721Enumerable, Ownable
{
    ...
    uint public constant MAX_TOKENS = 100; // Supply Limit for your collection (in this case the suppy is 4,500)
    uint public constant NUMBER_RESERVED_TOKENS = 0; //This is where you set how many NFT's you want in your reserve (most projects use their reserved NFTs for marketing)
    uint256 public constant PRICE = 10000000000000000; //0.08 - The price to mint an NFT is written into the contract as WEI, but is equal to 0.08 ETH (You can check the conversion on https://eth-converter.com/). Feel free to change the price to fit your needs just make sure the value is entered as WEI in this specific contract.

    uint public constant OG_SALE_MAX_TOKENS = 50; // This is OG or WL Sale max supply set

    bool public saleIsActive = true; //Public Mint: You must activate each sale to open up minting it will not be active once you deploy (watch live training #1 for more details)
    bool public ogSaleIsActive = true; //Same as above
...
//The reason this is set at zero is because the contract has not been deployed and nothing has been minted so all values start at ZERO
    ...
    constructor() ERC721("Mint Test NFT", "MINTEST") {}  //Name of Project and Token "Ticker" in this Example it's NFT Academy and NFTAcademy
