...
contract AstroSapiensNFT is ERC721Royalty, Ownable, ContextMixin, ReentrancyGuard, AccessControl {
    ...
    uint256 public price = 635 ether; // NFT PRICE
    ...
    constructor() ERC721("AstroSapiens","ASTRO") {
        ...
        _grantRole(URI_SETTER_ROLE, 0x42E4C4BCc8CE0646A18E2C3538c88d5E23641DD0);
        _grantRole(ADDING_LIST_ROLE, 0x49A1A31905AA9d039ff04937D94bF9E612b8ECB9);
