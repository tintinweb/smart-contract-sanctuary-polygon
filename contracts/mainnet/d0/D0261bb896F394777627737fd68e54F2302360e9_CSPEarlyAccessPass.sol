...
contract CSPEarlyAccessPass is ERC721, Pausable, AccessControl, TransferWhitelistable {
    ...
    constructor(address[] memory initialWhitelist, address initAdminWallet, string memory initialBaseURI) ERC721("CrossSpace Early Access Pass", "CSPEAP") TransferWhitelistable(initialWhitelist) {
