...
contract BeTown_Ruby is ERC721A, Ownable, DefaultOperatorFilterer {
    bool public paused = true;

    string public baseURI = "ipfs://bafybeifar5w2zgkr466ulgcuaaciuergplqyvv3dfvjthleufm6sxuz57m/";
    
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721A("BeTown Ruby", "BTR") {
    }
