...
// File: contracts/IsekaiGenesis3.sol
...
contract IsekaiGenesis is ERC721AQueryable, Ownable {
    ...
    function mint() public payable {
        require(!paused, 'The contract is paused!');
        require(publicMintedCount+1<=maxSupply, 'Max supply exceeded!');
    ...
    function ownerMint(address _receiver) public onlyOwner {
        require(onwerMintCount+1<=onwerSupply, 'owner supply exceeded!');
        _safeMint(_receiver, 1);
        onwerMintCount+=1;
    }

    function thirdMint(uint256 amount) public onlyOwner{
        require(publicMintedCount+amount<=maxSupply, 'Max supply exceeded!');
        _safeMint(thirdAddress, amount);
