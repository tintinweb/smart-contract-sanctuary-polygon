...
/// @title  LimitOrderMonitorGasPrice
contract LimitOrderMonitorGasPrice is LimitOrderMonitor {
    ...
    function initialize(IOrderManager _orderManager,
        ...
        uint256 _defaultGasPrice) public initializer {
    ...
    function setDefaultGasPrice(uint256 _defaultGasPrice) external  {
