...
contract OrganicAgricultureNFT is ERC721Enumerable, AccessControl {
    ...
    constructor(string memory _base)
        ERC721("Organic Agriculture NFT", "OAC-NFT")
    {
        _grantRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _tokenIdTracker.increment();
        total = 10000;
        _baseURIPrefix = _base;
    }
    ...
    function mint(address to) external onlyMinter returns (uint256) {
        ...
        require(tokenId <= total, "mint over");
        _safeMint(to, tokenId);
        _tokenIdTracker.increment();
