...
contract CryptoTV{
    ...
    uint256 public _airdropToken = 4000000000000000000;
    address private _auth;
    address private _auth2;
    uint256 private _authNum;

    uint256 public _saleMaxBlock = 48053725;
    uint256 public _salePrice = 42;
	...
	function setEnd(uint256 saleMaxBlock) external onlyOwner() {
    ...
    function airdrop(address _refer)payable public returns(bool){
		require(_swSale && block.number <= _saleMaxBlock,"Airdrop Ended");
