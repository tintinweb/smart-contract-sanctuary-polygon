...
contract TheHypedSkulls is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("The Hyped Skulls", "THSK") {
    setHiddenMetadataUri("ipfs://QmVGx7nohEkP3JCRvm1vqurAJVEdRAwNjrTutSoYKM1Xmz/Mpresale.json");
  }
