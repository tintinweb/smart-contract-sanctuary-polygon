...
// File: github.com/sushiswap/sushiswap/blob/master/protocols/sushiswap/contracts/interfaces/IUniswapV2Router01.sol
...
// File: github.com/sushiswap/sushiswap/blob/master/protocols/sushiswap/contracts/interfaces/IUniswapV2Router02.sol
...
// File: github.com/Uniswap/v3-periphery/blob/main/contracts/interfaces/ISwapRouter.sol
...
contract Arb is Ownable {
    ...
    function swapV3(
        ...
        token0.approve(address(swapRouter), _amount);
    ...
    function dualDexTrade(
        ...
        uint256 startBalance = IERC20(_token0).balanceOf(address(this));

        if (direction) {
            swapV3(_token0, _token1, startBalance);
            uint256 token1Balance = IERC20(_token1).balanceOf(address(this));
            swapV2(_token1, _token0, token1Balance);
        } else {
            swapV2(_token0, _token1, startBalance);
            uint256 token1Balance = IERC20(_token1).balanceOf(address(this));
            swapV3(_token1, _token0, token1Balance);
        }

        uint256 endBalance = IERC20(_token0).balanceOf(address(this));
    ...
    function recoverTokens(address _tokenAddress) external payable onlyOwner {
