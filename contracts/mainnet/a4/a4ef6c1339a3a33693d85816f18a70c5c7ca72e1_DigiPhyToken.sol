...
contract DigiPhyToken is IBEP20, Ownable {
    ...
    */
    ...
    /*
     ...
     @param _amount uint256
    */
    function mint(address _wallet, uint256 _amount) onlyOwner public {
    ...
    */
    ...
    /*
     ...
     @param token amount uint256
    */
    function withdrawTestToken(address wallet, uint256 token) external onlyOwner{
        this.transfer(wallet, token);
    }
