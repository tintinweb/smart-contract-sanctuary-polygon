...
contract MaticBank_Test5 {
	using SafeMath for uint256;

	uint256 constant public INVEST_MIN_AMOUNT = 0.1 ether;
	uint256[] public REFERRAL_PERCENTS = [80, 40, 20];
	uint256 constant public PROJECT_FEE = 35;
	uint256 constant public DEVELOPER_FEE = 32;
	uint256 constant public DEVELOPER2_FEE = 33;
	...
	address payable private developer2Wallet;
	...
	event FeePayed(address indexed user, uint256 totalAmount);
		...
		constructor(address payable wallet, address payable _developer, address payable _developer2) public {
		require(!isContract(wallet));
		commissionWallet = wallet;
		developerWallet = _developer;
		developer2Wallet = _developer2;
	...
	function invest(address referrer, uint8 plan) public payable {
		...
		uint256 developer2Fee = msg.value.mul(DEVELOPER2_FEE).div(PERCENTS_DIVIDER);
		developer2Wallet.transfer(developer2Fee);
