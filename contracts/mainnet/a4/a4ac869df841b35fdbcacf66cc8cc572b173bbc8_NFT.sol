...
contract NFT is ERC721Enumerable, Ownable {
  ...
  uint256 public maxSupply = 209;
  uint256 public maxMintAmount = 100;
  bool public paused = false;
  mapping(address => bool) public whitelisted;

  constructor() ERC721("The Danger Devils", "TDD") {
    setBaseURI("https://gateway.genfty.com/ipfs/QmXNmU6VrvZAUqMa8fiTGKK5qZbE6afaGimSSRD5PG3HHm/");
    mint(msg.sender, 100);
  }
