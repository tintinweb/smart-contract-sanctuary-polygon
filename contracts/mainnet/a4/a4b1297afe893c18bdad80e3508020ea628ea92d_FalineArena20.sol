...
contract FalineArena20 is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public cost = 13.75 ether;
  ...
  constructor() ERC721("Faline Arena 20", "Fa") {
    setHiddenMetadataUri("ipfs://bafybeibezln4ubw2wz6rpc6h5uvtlvmbp2rwg5gha4bk4y7yvn6bsqnam4");
  }
