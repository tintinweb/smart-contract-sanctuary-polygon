 ...
 *  - anti-botting
 */
contract WorldChallengeGameMagicEden is IERC721M, ERC721AQueryable, Ownable, ReentrancyGuard, VRFConsumerBaseV2 {
    ...
    function ownerMintWithGen(uint256 gen, address to)
        ...
        hasSupply(1)
    {
        require(_minters[msg.sender], "YourContract: must have minter role to mint");
        ...
        idToGenetics[totalSupply()] = gen;
        geneticsToId[gen] = totalSupply();
