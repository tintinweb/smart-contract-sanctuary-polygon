...
//*********************************************************************//
//
//    _____ ___   _____ __  __   _____ __                               _                ______      _     
//   / ___//   | / ___// / / /  / ___// /_____ __________ _____ _____  (_)___  ____ _   / ____/___  (_)___ 
//   \__ \/ /| | \__ \/ /_/ /   \__ \/ __/ __ `/ ___/ __ `/ __ `/_  / / / __ \/ __ `/  / /   / __ \/ / __ \
//  ___/ / ___ |___/ / __  /   ___/ / /_/ /_/ / /  / /_/ / /_/ / / /_/ / / / / /_/ /  / /___/ /_/ / / / / /
// /____/_/  |_/____/_/ /_/   /____/\__/\__,_/_/   \__, /\__,_/ /___/_/_/ /_/\__, /   \____/\____/_/_/ /_/ 
//                                                /____/                    /____/                         
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xB34f7Fd4Ad111663c2Eaa944C583a0236c8B7a61];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 50, 50000 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmaJhh6UZvjNdkoZDPSsSVhDk36aBmibcJSfpGYWXQoA7G/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 50000");
        _safeMint(_to, 1);
    }
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 50000");
...
// File: contracts/SashStargazingCoinContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SashStargazingCoinContract is RamppERC721A {
    constructor() RamppERC721A("SASH Stargazing Coin", "SASHCOIN"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/M9QnFEDnbvbwVv54X4FS/contract-metadata";
    }
}
