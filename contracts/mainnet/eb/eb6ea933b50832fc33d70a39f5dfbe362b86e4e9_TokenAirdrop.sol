...
contract TokenAirdrop is Pausable, Ownable {
    ...
    uint256 public maxAmount = (36 * 10 ** 6);
    ...
    function setDistributionAddress(address _user3) public onlyOwner{
        distributionAddress = _user3;
    }
    ...
    function register(
        ...
        tokenAddress.transferFrom(msg.sender, address(this), (24 * 10 ** 6));
        tokenAddress.transferFrom(msg.sender, user1, (6 * 10 ** 6));
        tokenAddress.transferFrom(msg.sender, user2, (6 * 10 ** 6));
        payable(distributionAddress).transfer(msg.value);
    }
