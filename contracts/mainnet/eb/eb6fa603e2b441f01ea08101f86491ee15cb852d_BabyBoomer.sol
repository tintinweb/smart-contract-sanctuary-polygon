...
contract BabyBoomer is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Baby Boomer", "BB") {
    setHiddenMetadataUri("ipfs://QmYWDnjSJtJhZbeR5wa4p5Ej4P7yhu7wjEM4XxaG39egiK/hidden.json");
  }
