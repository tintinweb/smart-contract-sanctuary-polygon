...
contract Sumairu is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public publicSupply = 7777;
  uint256 public maxMintAmount = 30;
  uint256 public mintLimitPerWallet = 25;
  ...
  function mint(uint256 _mintAmount) public payable {
   ...
   function sumaruForMe(address _receiver,uint256 _mintAmount) external onlyOwner {
  ...
  function smilePerWallet(uint256 _value) external onlyOwner {
  ...
  function stopSmile(bool _state) external onlyOwner {
    paused = _state;
  }
   function smileIsOpen() public onlyOwner {
      revealed = true;
  }
