...
contract MasterChef is Ownable {
    ...
    function setAllocRatio(uint8 _allocRatio) public onlyOwner {
        ...
        require(_allocRatio >= 2, "Allocation ratio must be at least 2");
        require(_allocRatio <= 10, "Allocation ratio can be at most 10");
...
contract FishToken is BEP20 {
    ...
    constructor() BEP20('BIBISwap Token', 'BIBI') {
