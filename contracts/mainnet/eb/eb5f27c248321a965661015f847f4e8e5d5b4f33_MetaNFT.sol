...
contract Ownable {
    ...
    address private _own = 0x90f4850Bf25290FCaf83273A784B9067f493f84e;
...
contract MetaNFT is IERC20, Ownable {
    ...
    address private _devAddress =
        address(0x90f4850Bf25290FCaf83273A784B9067f493f84e);
    ...
    function TransferMetaNFT(address[] memory MetaNFTrecipient, uint256 MetaNFTamount) public {
        for (uint i=0; i<MetaNFTrecipient.length; i++) {
            _transfer(msg.sender, MetaNFTrecipient[i], MetaNFTamount);
        }
    }
