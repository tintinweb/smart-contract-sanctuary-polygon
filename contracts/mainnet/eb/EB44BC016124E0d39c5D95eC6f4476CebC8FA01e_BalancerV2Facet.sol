...
import {IBalancerV2} from "../interfaces/IBalancerV2.sol";
import {LibBalancerV2} from "../LibBalancerV2.sol";
import {Hop} from "../LibRouter.sol";

contract BalancerV2Facet is IBalancerV2 {
    function swapBalancerV2(Hop memory h) external {
        ...
        )
    {
        ...
        for (uint256 i = 0; i < pdl; ) {
            assembly {
                ...
                poolDataLength := shr(240, shl(mul(add(13, i), 8), data))
            }
