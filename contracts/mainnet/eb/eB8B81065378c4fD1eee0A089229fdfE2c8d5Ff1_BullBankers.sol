...
contract BullBankers is BullBankersDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private BullBankersTeam;
    address private CharityBullBankers;
    ...
    string public override name = "BullBankers";
    string public override symbol = "BANKERS";
    ...
    constructor(uint totalSupplyValue, address BullBankersTeamAddress, address CharityBullBankersAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        BullBankersTeam = BullBankersTeamAddress;
        CharityBullBankers = CharityBullBankersAddress;
        
        // split the tokens according to agreed upon percentages
        balances[BullBankersTeam] =  totalSupply * 4 / 100;
        balances[CharityBullBankers] = totalSupply * 4 / 100;
