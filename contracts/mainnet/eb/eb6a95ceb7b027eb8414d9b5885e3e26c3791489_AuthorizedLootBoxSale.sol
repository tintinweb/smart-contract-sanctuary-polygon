    ...
    GenericTypedMessage
{
    ...
    // new fields after upgrade
    bool public validatingAuthorization;
    ...
    function toggleAuthorizedSales(
        bool _newStatus
    )
        external
        onlyRole(ADMIN_ROLE)
    {
        validatingAuthorization = _newStatus;
    }
    ...
    function buy(
        ...
        whenNotPaused
    {
        require(!validatingAuthorization, "Authorization required");
        require(_offerIndex < offers.length, "Unknown offer");
