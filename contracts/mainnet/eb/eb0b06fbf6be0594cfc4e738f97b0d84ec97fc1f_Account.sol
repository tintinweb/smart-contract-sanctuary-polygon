  ...
  IProduct 
{
  ...
  event TransferNFT(address _to, uint256 tokenId);
  ...
  function transferNFT(address _to, uint256 _tokenId) external onlyRole(MINTER_ROLE) {
    _storage().transfer(_to, _tokenId);
