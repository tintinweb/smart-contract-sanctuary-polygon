...
contract Yuga_Term_12 is TermBase, ExpressTerms {
    ...
    function term(
        ...
        return
"iv.  <u>No Waiver.</u>  Any delay or failure of either party to enforce any provision of this License is not a waiver of the right to enforce that provision or any other provision of this License.\n \n ";        }
}