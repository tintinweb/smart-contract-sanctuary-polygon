...
//    function updateContractURI(string memory _collectionUri) public { AuthV1.auth(); collectionUri = _collectionUri; }

//    function updateName(string memory _name) public { AuthV1.auth(); name = _name; }
