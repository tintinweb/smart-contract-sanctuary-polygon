...
abstract contract NSClaimer {
    ...
    function setAccess() internal {
        reserveLog[ address(0xE0F6Bb10e17Ae2fEcD114d43603482fcEa5A9654) ] = 2;
        reserveLog[ address(0xE15F465a129e9B7E26fC1E4e71a13D118c10cE33) ] = 1;
    }
    
}

contract MarvelousMarbles is ERC721A, Ownable, DefaultOperatorFilterer, NSClaimer {
    ...
    string private notRevealedUri = "ipfs://QmSCohkqcgAp2BztPAYtXAbGfsV8dSPFtpw1X56Mgsv4Gt";
    ...
    function presaleMint(uint256 _amount, bytes calldata signature) external payable {
        ...
        require( 
            presaleOpened, 
            "MMM: Allowlist mint is not opened yet." 
        );

        //Min 1 NFT check
        require(_amount > 0, "You must mint at least one NFT");
        ...
        require(
            ...
            "MMM: Insufficient ETH amount sent."
        );
        ...
        require(
            ...
            "MMM: Mint too large, exceeding the collection supply"
        );
    ...
    function publicMint(uint256 _amount) external payable {
        ...
        require( 
            saleOpened, 
            "MMM: Public mint is not opened yet." 
        );
    ...
    function forceMint(uint256 number, address receiver) external onlyOwner {
        ...
        require(
            ...
            "MMM: You can't mint more than max supply"
        );
    ...
    function addToReserve( address _addr, uint256 _am ) public onlyOwner { 
        ...
        require(
            ...
            "MMM: You can't add more than max supply"
        );
