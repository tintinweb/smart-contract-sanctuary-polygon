...
contract TestTesting {
    ...
    uint256 public subscriptionMonthlyPriceDiscounted = 0.075 ether;
    ...
    event SubRenewal(address wallet, uint256 endtimestamp);
    ...
    function subscriptionRenewal() public payable {
        ...
        emit SubRenewal(msg.sender, users[msg.sender].subscriptionExpires);
    }
}