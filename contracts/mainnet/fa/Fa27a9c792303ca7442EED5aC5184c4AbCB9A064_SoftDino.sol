...
contract SoftDino is ERC721 {
    uint256 public totalSupply;
    uint256 public cost = 0.07 ether;
    uint256 public maxMints = 38;
    ...
    function mint() external payable {
        ...
        if (totalSupply + 1 > 36) revert SoldOut();
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeihehe6dgddplxx2vznzotd4uhftpmmyz4m23scylvi4s3vwb4ueja/", Strings.toString(tokenId), ".json")
            );
    }
