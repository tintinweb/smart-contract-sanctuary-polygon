...
contract NiioERC721SerialV2 is
Initializable,
PausableUpgradeable,
...
RolesUpgradeable {
    ...
    validNumberOfEditions(maxEditions, tokensIds.length) {
        require(seriesId < 100000, "SeriesId must be less than 100,000");  //TODO: check
    ...
    function burnSeriesInfo(uint256 seriesId)
    public 
    whenNotPaused
    onlyRole(SUPER_ADMIN_ROLE)
    {
        require(_seriesInfo[seriesId].maxEditions != 0, "SeriesInfo not found"); //TODO: check
         delete _seriesInfo[seriesId];
    }
    ...
    returns (string memory) {
        return "https://arweave.net/"; //TODO: check
    }
