...
/**
 *Official Wrapped BNB (WBNB) of TetherMoon (testnet)
*/
pragma solidity =0.8.5;

contract WxMATIC {
    string public name = "Wrapped xMATIC";
    string public symbol = "WxMATIC";
    uint8 public decimals = 18;
    address payable WrappedxMATIC = payable(address(this));
