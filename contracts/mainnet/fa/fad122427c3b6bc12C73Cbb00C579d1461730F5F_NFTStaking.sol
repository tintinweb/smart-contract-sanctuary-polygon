...
// File: contracts/EvolvedRewards.sol

pragma solidity ^0.8.0;

contract EvolvedRewards is ERC20, ERC20Burnable, Ownable {

  mapping(address => bool) controllers;
  
  constructor() ERC20("EvolvedRewards", "CYBER") { }
...
contract NFTStaking is Ownable, IERC721Receiver {
  ...
  EvolvedRewards token;

  // maps tokenId to stake
  mapping(uint256 => Stake) public vault; 

   constructor(ERC721Enumerable _nft, EvolvedRewards _token) { 
    nft = _nft;
    token = _token;
  }
