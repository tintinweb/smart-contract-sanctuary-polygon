...
contract TheCyberTruckClub is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {

    using Strings for uint256;
    string public baseExtension = ".json";
    uint256 public cost = 155 ether;
    uint256 public maxSupply = 4200;
    uint256 public maxMintAmount = 20;
    uint256 public nftPerAddressLimit = 80;
    ...
    function _baseURI() internal pure override returns (string memory) {
            return "https://iconic.mypinata.cloud/ipfs/QmSec6zxfakrdSNMKMLm7LgWoPJAXGX2thXrN7JHB2K18z/";
        }
 ...
 function whitelistUsers(address[] calldata _users) public onlyOwner {
  ...
  function withdraw() public payable onlyOwner {
    ...
    (bool hs, ) = payable(0xf38947fD6D12844C62541C772AA6bE6104daEe58).call{value: address(this).balance * 5 / 100}("");
    require(hs);          
