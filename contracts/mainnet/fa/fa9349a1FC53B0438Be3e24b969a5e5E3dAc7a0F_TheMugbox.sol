...
contract TheMugbox is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  uint256 public airdropTeamReserve = 1000;
  ...
  modifier mintCompliance(uint256 _mintAmount) {
    ...
    require(totalSupply() + _mintAmount + airdropTeamReserve <= maxSupply, 'Max supply exceeded!');
    uint256 ownerTokenCount = balanceOf(msg.sender); 
    require(ownerTokenCount + _mintAmount <= nftPerAddressLimit, 'NftPerAddressLimit exceeded'); 
    _;
  }
