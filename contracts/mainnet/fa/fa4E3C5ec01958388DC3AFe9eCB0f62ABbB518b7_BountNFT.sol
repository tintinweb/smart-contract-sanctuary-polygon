...
contract ERC721A is ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    function tokenOfOwnerByIndex(address owner, uint256 index) public view override returns (uint256) {
        ...
        for (uint256 i = 1; i < numMintedSoFar + 1; i++) {
...
// File contracts/BountNFT.sol

pragma solidity 0.8.6;


contract BountNFT is ERC721A, Ownable {
    string public tokenBaseURI;

    /// ============ Errors ============
    /// @notice Thrown if trying to construct with zero address
    error InvalideOwner();
    ...
    function updateTokenURI(string memory _newTokenBaseURI) external onlyOwner {
