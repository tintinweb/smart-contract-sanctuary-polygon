...
contract TequilaPartyBottlePass is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_)
    ERC721("TequilaParty BottlePass", "TPBP")
  {
  ...
  uint256 public constant PRICE = 140000000000000000000;
  ...
  function mint(uint256 count) public payable nonReentrant {
    ...
    require(
      msg.value >= PRICE * count, "Insufficient payment, 140 ETH per item"
    );
  ...
  address private constant payoutAddress1 =
    0x16e08BdB9da08fC50F59Af3B09eED20c6F5F1e7F;
