...
contract AiMfers is ERC721A, Ownable, ReentrancyGuard {

  string public        baseURI;
  uint public          price             = 0.49 ether;
  uint public          maxPerTx          = 3;
  uint public          maxPerWallet      = 10;
  uint public          totalFree         = 80;
  uint public          maxSupply         = 300;
  uint public          nextOwnerToExplicitlySet;
  bool public          mintEnabled;

  constructor() ERC721A("Ai Mfers", "AIM"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more Ai");
