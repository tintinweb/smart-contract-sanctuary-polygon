...
contract CloutTreasury is Ownable, ICloutTreasury {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        isLiquidityToken[_CLOUTDAI] = true;
        liquidityTokens.push(_CLOUTDAI);
        bondCalculator[_CLOUTDAI] = _bondCalculator;
