...
contract VelhallaCardRedeem is ERC1155Supply, Ownable {
    ...
    string public constant name = "VCs";
...
//                _mintBatch(msg.sender, idredeems, amounts, "");
     ...
     * id range of gold card start from 1000001 to 99999999 
    ...
    function burnGoldCard(address _account, uint256 _id) external {
        require(controllers[msg.sender], "Only controllers' routines can burn");
        require((_id > ID_GOLD_CARD_START) && (_id < 100000000), "token id is out of gold card range" );
    ...
    function uri(uint256 _id) public override view returns (string memory) {
        ...
        if ((tokenId > ID_GOLD_CARD_START) && (tokenId < 100000000))
		{
...
//    function initRedeemedSilverCardURI(string memory _uri) external onlyOwner {
...
/* set for 721 token uri like */
    function initGoldCardURI(uint256 _book, string memory _uri) external onlyOwner {
		...
		require(id < 100000000 ,  "out of Gold Card id range");
