...
contract AirChrysalis is VRFConsumerBaseV2 {
    ...
    bytes32 s_keyHash = 0x6e099d640cde6de9d40ac749b4b594126b0169747122711109c9985d47751f93;
    ...
    event giveawayWinnerVerified(uint256 indexed requestId, address indexed winnerAddress);
    ...
    function createGiveaway(address _contractAddr, uint256[2][] memory _tokensTuple) public {
        ...
        giveawaysMap[msg.sender][giveawayId] = Giveaway(_contractAddr, _tokensTuple, participants, false, address(0));
    ...
    function finishGiveaway(address account, uint256 _giveawayId) public {
        ...
        requestToGiveaway[requestId] = RequestGiveaway(account, _giveawayId);
        emit randomizingGiveawayWinner(requestId, account, _giveawayId);
    }
    ...
    function fulfillRandomWords(uint256 requestId, uint256[] memory randomWords) internal override {
        ...
        emit giveawayWinnerVerified(requestId, _giveaway.winner);
    }
    ...
    function resetGiveaways() public {
        for (uint256 idx = 0; idx < accounts.length; idx++) {
            ...
            for (uint256 j = 0; j< ids.length; j++) {
                ...
                giveawaysMap[accounts[idx]][ids[j]] = Giveaway(address(0), _tokenTuples, _participants, false, address(0));
            }
