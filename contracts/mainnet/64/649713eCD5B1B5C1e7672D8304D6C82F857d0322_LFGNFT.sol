...
contract LFGNFT is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("LFG NFT", "LFG") {
  ...
  {
    return (address(this), (salePrice * 9000) / 10000);
  }
