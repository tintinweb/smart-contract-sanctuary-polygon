...
contract RBAC is AccessControl {
    ...
    modifier onlyBurner {
        require(hasRole(BURNER_ROLE, _msgSender()), "Sender is not a burner");
        _;
    }
    ...
    function addBurnerRole(address account) external onlyAdmin {
...
contract RebelBotsXoilWarsMeteorLootcrate is RBAC, ERC721Enumerable {
    ...
    constructor() ERC721("Rebel Bots Xoil Wars Meteor Lootcrate", "RBXWML") {
    }
    ...
    function burnBatch(uint256[] memory tokenIds) public onlyBurner {
    ...
    function mint(address to) public onlyMinter {
        ...
        super._mint(to, _tokenIdCounter.current());
    }
    ...
    function setTokenURIPrefix(string memory newBaseURIPrefix) external onlyAdmin {
        baseURIPrefix = newBaseURIPrefix;
    }
