    ...
    UUPSUpgradeable
{
    ...
    function initialize(
        ...
        bool _mintPaused,
        bool _crosschainPaused,
        string memory _NFTPixel,
        ...
        crosschainPaused = _crosschainPaused;
        NFTPixel = _NFTPixel;
    ...
    function mint(uint256 _mintAmount) public payable lock {
        ...
        require(
            ...
            "You are not on the whitelist and cannot purchase"
        );
        ...
        for (uint256 i = 1; i <= _mintAmount; i++) {
            _safeMint(msg.sender, 5000 + i + supply);
        }
