...
contract Sva is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("Sva ", "SW") {
  ...
  uint256 public constant PRICE = 60000000000000000000;
  ...
  function mint() public payable nonReentrant {
    ...
    require(msg.value >= PRICE, "Insufficient payment, 60 ETH per item");
