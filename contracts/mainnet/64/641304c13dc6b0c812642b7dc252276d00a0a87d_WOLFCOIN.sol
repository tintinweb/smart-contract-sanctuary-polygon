...
// File: WOLFCOIN_flat_flat.sol


// File: WOLFCOIN_flat.sol
...
contract WOLFCOIN is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    constructor() ERC20("WOLFCOIN ", "WFC") ERC20Permit("WOLFCOIN ") {
        _mint(msg.sender, 750000000000000000000 * 10 ** decimals());
    }
