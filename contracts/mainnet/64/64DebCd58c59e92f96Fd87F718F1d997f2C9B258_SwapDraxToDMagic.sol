...
contract SwapDraxToDMagic is Ownable, DefiMagicPolygon, ReentrancyGuard {
    using SafeERC20 for IERC20;

    address private depositToken = 0x1Ba3510A9ceEb72E5CdBa8bcdDe9647E1f20fB4b;  // DRAX
    address private returnToken = 0x61dAECaB65EE2A1D5b6032df030f3fAA3d116Aa7;   // DMAGIC
    ...
    constructor() {
        IERC20(depositToken).approve(_dragonDirectSushi, type(uint256).max);
    }
    ...
    function depositTokens(uint256 _amount) external nonReentrant {
        ...
        DefiMagicPolygon.draxToDmagic(IERC20(depositToken).balanceOf(address(this)));
