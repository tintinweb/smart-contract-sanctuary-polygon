...
contract LiquidCZapCurve {
    ...
    function LiquidCIn (address liquidCVault, address pool, address tokenIn, uint256 poolSize, uint256 depositIndex, uint256 tokenInAmount, bool useUnderlying, bool useMetapool, address want, address lpToken) external {
    ...
    function LiquidCOut (address liquidCVault, uint256 withdrawAmount, address pool, address lpToken, address[] memory tokens) external {
        ILiquidCVaultV6 vault = ILiquidCVaultV6(liquidCVault);
    ...
    function LiquidCOutAndSwap(address liquidCVault, uint256 withdrawAmount, address pool, address lpToken, address desiredToken, int128 desiredIndex) external {
        ILiquidCVaultV6 vault = ILiquidCVaultV6(liquidCVault);
        ...
        uint256 amountLiquidity = IERC20(lpToken).balanceOf(address(this));
        ICurveSwap(pool).remove_liquidity_one_coin(amountLiquidity, desiredIndex, uint256(0));
