...
contract Controller {
    ...
    function deposit(
        ...
        pendTime[msg.sender] = block.timestamp + (1 * MULT);
    ...
    function withdraw(address _usddollar, address _aave) internal {
        require(
            IERC20(_usddollar).balanceOf(address(this)) > 1000000,
            "Balance should be greater than 1"
        );
        ...
        //uniswap buyback
        uniswapBuyback(_usddollar, IERC20(_usddollar).balanceOf(address(this)));
    }
