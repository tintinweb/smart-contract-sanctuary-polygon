...
contract ERC20 is OwnableUpgradeable, ERC20Upgradeable, PausableUpgradeable, Claimable {
    ...
    /**
     * @dev This Method permit getting Maximum total Supply .
     * See {ERC20-_burn}.
     */
    ...
    /**
     * @dev Creates `amount` tokens and assigns them to the owner, increasing the total supply.
    ...
    function mint(uint256 amount) public onlyOwner() {
        require(getMaxTotalSupply() >= totalSupply().add(amount), "ERC20: Can't Mint, it exceeds the maximum supply");
        _mint(owner(), amount);
    }
     ...
     * - `account` cannot be the zero address.
     */
    function mintToWallet(address account, uint256 amount) public onlyOwner() {
        require(getMaxTotalSupply() >= totalSupply().add(amount), "ERC20: Can't Mint, it exceeds the maximum supply");
