...
contract MBD is Initializable, ERC20Upgradeable, PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize() initializer public {
        ...
        timelock(lockaccount1,60,81720000000000000000000000);
        timelock(lockaccount2,360,68100000000000000000000000);
        timelock(lockaccount3,460,54480000000000000000000000);
        timelock(lockaccount4,560,40860000000000000000000000);
        timelock(lockaccount5,11160,27240000000000000000000000);
    }
