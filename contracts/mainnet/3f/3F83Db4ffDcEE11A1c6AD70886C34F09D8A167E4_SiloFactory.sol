...
//TODO add a way  to stop people from entering an action(like to stop people from entering a farm that has ended)
// maybe each strategy could have some implementable bool function? That either checks contract state(like a farms end block), and or looks to the facotry to see if it has been disabled
