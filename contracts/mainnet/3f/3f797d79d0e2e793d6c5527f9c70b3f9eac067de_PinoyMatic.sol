...
contract PinoyMatic{
	...
	uint256[] public INVEST_MIN_AMOUNT = [0.001 ether, 21 ether, 31 ether, 50 ether]; //0.001 Matic, 21 Matic, 31 Matic, 50 Matic
	uint256[] public INVEST_MAX_AMOUNT = [20 ether, 30 ether, 40 ether, 100 ether]; 
	uint256[] public REFERRAL_PERCENTS = [30]; //3% ref level1
	uint256 constant public TOTAL_REF = 20;
	uint256 constant public CEO_FEE = 25; //5 Dev
	uint256 constant public CEO_FEE2 = 25;  
	...
	constructor(address payable ceoAddr,address payable  ceoWallet2Addr, uint256 start) public {
        ...
        plans.push(Plan(1,  1020)); // 102% 24hours
        plans.push(Plan(1,  1030)); // 103% 24hours
        plans.push(Plan(1,  1040)); // 104% 24hours
        plans.push(Plan(1,  1050)); // 105% 24hours
	}
