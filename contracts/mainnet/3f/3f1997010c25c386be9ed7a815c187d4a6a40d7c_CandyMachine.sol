...
contract CandyMachine is Ownable, ERC721Enumerable, ReentrancyGuard {
  ...
  constructor() ERC721("LuLoNFT", "LuLoNFT") {manager = payable(msg.sender);}
  ...
  string private _baseTokenURI = 'https://gateway.pinata.cloud/ipfs/QmR4QUHW8Y6MxG5RLcPtKmg4cB3KhXMPJGYhPAw4bWPect';
