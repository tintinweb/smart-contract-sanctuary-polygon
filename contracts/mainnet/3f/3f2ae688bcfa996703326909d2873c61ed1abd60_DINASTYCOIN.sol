...
contract DINASTYCOIN is ERC20, Pausable, ERC20Detailed {
    
	address teamWallet = 0x9EA3bc08BD49A15aD7d44b8D89CA1E068F17c65B;
    address serviceWallet = 0xa873B4a624cAabBC3587d94453AD2C13aFaf4996;
    address partnerWallet = 0x12B28740C8aC2c242Cb45Fa0ffa3D11626839f81;
    address presaleWallet = 0x350eB52E28E21E5fbD89AE4974a04d38dF29fD71;
	...
	constructor() public ERC20Detailed("DINASTYCOIN", "DICO", 9) {  
	        
       
        totalCoins = 1000000000 * 10 ** uint256(decimals());
        _mint(owner(), totalCoins); // total supply fixed at 500 Million coins
        
        ERC20.transfer(teamWallet, 100000000 * 10 ** uint256(decimals()));  
        ERC20.transfer(partnerWallet, 100000000 * 10 ** uint256(decimals()));
        ERC20.transfer(serviceWallet, 300000000 * 10 ** uint256(decimals()));
        ERC20.transfer(presaleWallet, 300000000 * 10 ** uint256(decimals()));
