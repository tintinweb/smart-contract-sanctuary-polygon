...
contract Dxolw is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeidx7pgk2bj4ajnwqu6rr46o5bsliwwymgqartw4oaashmgr5namoa/", Strings.toString(tokenId), ".json")
            );
    }
