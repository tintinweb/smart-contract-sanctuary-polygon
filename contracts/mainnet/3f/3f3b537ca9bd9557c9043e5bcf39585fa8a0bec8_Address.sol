...
contract WhelpsBreed7 is ERC721Enumerable, Ownable {
    ...
    string public baseURI = "https://whelpsio.herokuapp.com/api7-poly/";
    ...
    function mintOwner(address[] calldata owners, uint256[] calldata tokenIds) public onlyOwner {
