...
contract Lottery is VRFConsumerBaseV2, Ownable, KeeperCompatibleInterface {    
    ...
    uint256 VRF_WAITING_BLOCKS      = 39273; // ~24 hours
    ...
    // Round parameters
    uint256 public _roundDuration               = 7*39273; // blocks
    ...
    //
    uint256 public _minJoiningAmount            = 500 * 10**18;
    uint256 public _minAutoJoiningAmount        = 1000 * 10**18;
    ...
    address _chainLinkVRFCoordinator = 0xAE975071Be8F8eE67addBC1A82488F1C24858067; // VRF Coordinator
    bytes32 _chainLinkVRFKeyHash = 0xcc294a196eeeb44da2888d17c0625cc88d70d9760a69d58d853ba6581a9ab0cd;  // The gas lane to use, which specifies the maximum gas price to bump to.
