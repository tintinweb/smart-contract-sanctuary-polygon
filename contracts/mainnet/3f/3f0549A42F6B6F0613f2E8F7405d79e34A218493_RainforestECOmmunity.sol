...
// File: RainforestECOmmunity.sol

/**
 * @title Rainforest ECOmmunity
 * As the founder of a non-profit reforestation project and environmental 
 * artist, Alana Lea is releasing the NFTs to help you understand why Brazilian 
 * forests matter to the entire planet. They are game changers for the climate 
 * change challenges we all face right now because of their ability to recover 
 * degraded land quickly, rebalance water cycles of drought and flooding, 
 * replenish biodiversity and wildlife, all while sinking atmospheric carbon.
 * 
 * Alana’s non-profit project iGiveTrees grew from the small actions of school 
 * children who baked cookies to fund the first donations of trees we made in 
 * 2010. Now you can do so much more than they did, thanks to our partnership 
 * with ViciNFT who carries our mission to the world.
 */
contract RainforestECOmmunity is ViciERC721 {
    constructor()
        ViciERC721(
    ...
    {
        setContractURI(
            "https://storage.googleapis.com/arrival-shadow-motion-newman/waterside/rainforest/metadata/Rainforest.json"
        );
    }
}