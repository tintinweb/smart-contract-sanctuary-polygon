...
contract StopMelting is Ownable, ERC721Royalty, ReentrancyGuard {

    using Counters for Counters.Counter;

    uint256 constant internal MAX_TOKENS = 100_000;
    uint256 public tokenSalePrice = 17 ether;
    ...
    constructor() ERC721("Million Voices", "STOPMELTING") {
    ...
    function buyToken(uint _tokenId) external payable nonReentrant returns (uint256) {
        ...
        require(msg.value >= tokenSalePrice, "Not enough funds");
    ...
    function setSalePrice(uint256 _tokenSalePrice) external onlyOwner {
