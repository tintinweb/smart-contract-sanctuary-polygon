...
/**
 * @title NotSoMutantApeYachtClub contract
...
contract NotSoMutantApeYachtClub is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("NotSoMutantApeYachtClub", "NMAYC"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more Mutants");
    require(mintEnabled, "Minting is not live yet, hold on Mutant.");
