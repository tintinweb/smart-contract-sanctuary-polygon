    ...
    DefaultOperatorFilterer
{
    ...
    constructor(
        ...
        bytes32 keyHash_,
        string memory baseURI_
    ) ERC721("GFMaskBox", "GFMB") VRFConsumerBaseV2(vrfCoordinator_) DefaultOperatorFilterer() {
    ...
    event ChainlinkSubscriptionUpdated(uint256 subId);
    
    function setSubscription(uint64 id) external only(DEFAULT_ADMIN_ROLE){
        subscriptionId = id;
        emit ChainlinkSubscriptionUpdated(id);
    }
