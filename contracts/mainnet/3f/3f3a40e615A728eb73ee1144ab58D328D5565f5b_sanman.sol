...
contract sanman is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "sanman";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x2dBf3a9473EcC09ebb3Ebc9Cc41f7bFE21d67943));
        marketingWalletAddress = payable(address(0x3e58ed3eC5C578f8581272E7268F3e40414D337a));

        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0xa97280893A4451d7655D36AB03422f7DF7b81E1c), _msgSender(), _totalSupply);
    }
