...
contract BalancerMaticXYA is BaseYA, ReentrancyGuardUpgradeable, OwnableUpgradeable, PausableUpgradeable, ERC2771ContextUpgradeable {
  ...
  address constant private MATICX_TOKEN = 0xfa68FB4628DFF1028CFEc22b4162FCcd0d45efb6;
  address constant private BX_TOKEN = 0xb20fC01D21A50d2C734C4a1262B4404d41fA7BF0;
  address constant private BXG_TOKEN = 0xdFFe97094394680362Ec9706a759eB9366d804C2;
  ...
  address constant private BALANCER_REWARDS = 0xdFFe97094394680362Ec9706a759eB9366d804C2;
  bytes32 constant private POOL_ID = 0xb20fc01d21a50d2c734c4a1262b4404d41fa7bf000000000000000000000075c;
  ...
  function getContractBalance() public view override returns (uint256) {
    return IERC20(BXG_TOKEN).balanceOf(address(this));
  }
  ...
  function joinPool(uint256 wmaticValue, bool query) private returns(uint256 amountOut) {
    ...
    if (query) {
      ...
      amountOut = IERC20(BX_TOKEN).balanceOf(address(this));
    }
  }
  ...
  function join(uint256 value) private returns(uint256 shares) {
    ...
    if (!IERC20(BX_TOKEN).approve(BALANCER_REWARDS, value)) {
      revert();
    }
