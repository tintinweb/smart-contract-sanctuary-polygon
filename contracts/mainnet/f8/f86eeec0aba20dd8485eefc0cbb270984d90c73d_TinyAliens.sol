...
contract TinyAliens is Ownable, ERC721, NonblockingReceiver {
    ...
    uint256 public nextTokenId = 3556;
    uint256 public MAX_MINT_SUPPLY = 5555;
    ...
    */
    ...
    function traverseChains(uint16 _chainId, uint256 tokenId) public payable {
        ...
        require(
            ...
            "The value of the send Message was not enough to cover the Message Fee. Send more gas for message fees"
        );
    ...
    function setMAX_MINT_SUPPLY(uint256 _newMAX_MINT_SUPPLY) public onlyOwner {
        MAX_MINT_SUPPLY = _newMAX_MINT_SUPPLY;
    }
