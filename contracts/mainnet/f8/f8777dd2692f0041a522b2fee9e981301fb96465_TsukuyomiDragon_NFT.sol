...
contract TsukuyomiDragon_NFT is ERC721, Ownable, Pausable
{
    ...
    uint256 public constant MAX_TOKEN_SUPPLY = 2001;
    ...
    //Mint value
    uint256 public sWhitelistMintValue = 17.4 ether;    // 1 USD = 1.74 MATIC, 10 x 1.74 = 17.4 x ether = 17400000000000000000 (wei) - 1 ether = 1000000000000000000 (or 10^18) wei
    uint256 public sLimitedMintValue = 34.8 ether;      // 34800000000000000000 (wei) - 1 ether == 1000000000000000000 (or 10^18) wei

    string public sBaseURI = "https://bafybeiaegmmtvesszsauw3uyst33l3fts7o6xgerfwpaidfs4qiqpudqoi.ipfs.nftstorage.link/";
