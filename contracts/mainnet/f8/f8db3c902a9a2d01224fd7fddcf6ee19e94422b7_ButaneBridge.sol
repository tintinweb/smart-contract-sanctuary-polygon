...
contract ButaneBridge is Context, Ownable {
    ...
    string private _name = "Butane Bridge";
    string private _symbol = "Butane Bridge";

    IERC20 public ButaneToken;
    ...
    constructor(address _butaneToken,uint _chainId, uint256 _fee, address [] memory operators) {
        ButaneToken = IERC20(_butaneToken);
    ...
    function transfer(
        ...
        ButaneToken.transfer(receiver, amount);
    ...
    function cross(
        ...
        ButaneToken.transferFrom(_msgSender(), address(this), amount);
