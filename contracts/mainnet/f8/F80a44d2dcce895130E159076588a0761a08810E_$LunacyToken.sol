...
contract $LunacyToken is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    constructor() ERC20("$Lunacy Token", "LNT") ERC20Permit("$Lunacy Token") {
