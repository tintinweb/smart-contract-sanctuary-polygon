...
import "./CryptoStampV3.sol";

contract CryptoStampPolygonV3 is CryptoStampV3 {
  address public childChainManager;

  constructor(string memory _uri, address _childChainManager) CryptoStampV3(_uri) {
...
contract CryptoStampV3 is Ownable, ERC1155Supply {
