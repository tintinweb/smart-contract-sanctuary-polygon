    ...
    BaseERC20
{
    ...
    function replacementOfCorporateTreasury(
        ...
        require(
            ...
            "STV2: Corporate Treasury can not be zero address"
        );
        ...
        require(
            ...
            "STV2: balance of Treasury was not transfered to new Corporate Treasury"
        );
        ...
        for (uint256 i = 0; i < fmList.length; i++) {
            _approveReset(oldTreasury, fmList[i]);
    ...
    function addFinancialManager(address _address) external onlySuperAdmin {
    ...
    function removeFinancialManager(address _address) external onlySuperAdmin {
        _revokeRole(FINANCIAL_MANAGER_ROLE, _address);
        _approveReset(_corporateTreasury, _address);
    }
    ...
    function _beforeTokenTransfer(
        ...
        require(
            ...
            "STV2: Available limit of transactions exceeded."
        );

        require(
            _availableLimit(_from) >= _amount,
            "STV2: Amount you want to transfer exceeds your Secondary Trading limit."
        );

        require(
            _availableBalance(_from) >= _amount,
            "STV2: transfer amount exceeds balance or you try to transfer locked tokens."
        );
...
abstract contract Utils is Context {
    ...
    function _equalArrays(
        ...
        require(
            ...
            "STV2: Arrays of addresses and according values have different quantity of elements"
        );
    }
...
abstract contract Deployerable is Context {
     ...
     */
    function renounceDeployership() public onlyDeployer {
...
abstract contract BaseERC20 is IERC20Metadata, Utils {
    ...
    function transferFunds(
        ...
        require(_from != address(0), "STV2: transfer from the zero address");
        require(_to != address(0), "STV2: transfer to the zero address");
    ...
    function _mint(
        ...
        require(_account != address(0), "STV2: mint to the zero address");
    ...
    function _burn(address _account, uint256 _amount) internal {
        require(_account != address(0), "STV2: burn from the zero address");
    ...
    function _approve(
        ...
        require(_owner != address(0), "STV2: approve from the zero address");
        require(_spender != address(0), "STV2: approve to the zero address");
    ...
    function _approveReset(address _owner, address _spender) internal {
        _allowances[_owner][_spender] = 0;
