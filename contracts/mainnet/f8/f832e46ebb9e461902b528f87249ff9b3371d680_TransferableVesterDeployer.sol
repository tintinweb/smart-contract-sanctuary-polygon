...
// hevm: flattened sources of src/TransferableVesterDeployer.sol
...
////// src/TransferableVester.sol
/* pragma solidity >=0.4.0; */

/* import "dss-vest/DssVest.sol"; */

contract TransferableVester is DssVestTransferrable {
  constructor (address _distributor, address _gem) public DssVestTransferrable(_distributor, _gem) {}
}

////// src/TransferableVesterDeployer.sol
/* pragma solidity >=0.4.0; */

/* import "./TransferableVester.sol"; */

contract TransferableVesterDeployer {

  TransferableVester public immutable vester;

  constructor(address _distributor, address _gem) public {
    TransferableVester vester_ = new TransferableVester(_distributor, _gem);
