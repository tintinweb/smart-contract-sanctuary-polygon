...
contract DeadLurkers is ERC721, ERC721Enumerable, Ownable {
    ...
    // Provenance hash
    string public DEADLURKERS_PROVENANCE;
    bool isProvenanceSet;

    constructor() ERC721("Dead Lurkers", "LURKERS") {
    ...
    function setProvenanceHash(string memory _provenanceHash) public onlyOwner {
        require(!isProvenanceSet ,"setProvenanceHash: ALREADY SET");
        DEADLURKERS_PROVENANCE = _provenanceHash;
