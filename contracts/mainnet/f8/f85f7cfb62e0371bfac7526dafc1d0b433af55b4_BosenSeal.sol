...
// File: contracts/testing-seal.sol
...
contract BosenSeal is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Bosen Seal", "BSSL") {
    setHiddenMetadataUri("ipfs://QmSiEiYFNkovJfqEUqG6P4G7hjo7yrtY9fR4tktNFDBnmT/hidden.json");
  }
