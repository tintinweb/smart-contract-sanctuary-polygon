...
contract Ripae_Genpool_Autocompounder {
    ...
    function compound() public onlyOwner {
        ...
        Router.swapExactTokensForTokens(
            pMATIC.balanceOf(address(this)) / 2, // bruh this was the mistake i forgot to divide by 2 i deployed 6 contracts cuz i thought sometoisjoetij;bijttaBAHHAHHHHHHHH WHY
            0,
            path,
            address(this),
