 ...
 * @dev Extends ERC721A Non-Fungible Token implementation
 763 自己的名稱、782 名稱和簡稱、772 12e16->12e13改掉
 MAXPERBATCHMINTSIZE_  每一次最大的mint數量 100
 MAXPERADDRESSSIZE_ 地址容量大小 1000
 COLLECTIONSIZE_ 可記錄的數量 100000
 */
contract HSY721aNFT is ERC721A, Ownable {
  ...
  uint256 public publicPrice = 12e13;   //0.12 ETH
  ...
  constructor(
    ...
    uint256 collectionSize_
  ) ERC721A("HSY721aNFT", "HSYaNFT", maxPerBatchMintSize_, collectionSize_) {
