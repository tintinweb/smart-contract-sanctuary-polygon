...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x1f836A75248Ca00C788d20355a8e4b903A918BcB];
  address public erc20Payable = 0x1f836A75248Ca00C788d20355a8e4b903A918BcB;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 384) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeihxe5xjbypp5zy7yeftfjxlimjnv36p6sqhqgqa35pdfh32jugt34/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/RYqAjZ2TvOMIr7EgdntE/contract-metadata";
  }
...
// File: contracts/HederianhipposContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract HederianhipposContract is ERC721APlus {
    constructor() ERC721APlus("HEDERIAN HIPPOS", "HHH"){}
}
  /*******************************************************/
  /*                                                     */
