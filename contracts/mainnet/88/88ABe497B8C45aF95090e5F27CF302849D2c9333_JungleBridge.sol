...
contract JungleBridge is Ownable {
    using SafeMath for uint256;
    ...
    //BridgeReward Token
    address public bridgeRewardToken = 0x605314B8eD6e874Ab73b8aAc06C9bd221AC69E33;

    //Fee Token address
    address public bridgeFeeToken = 0xe169613104656f1547161d905059d66BA69B3992;
    ...
    // Pay out full balance of any token from Contract
    function reveiveAllAnyToken (address _token) public onlyOwner {
        uint256 all = IERC20(_token).balanceOf(_token);
