...
contract MutantSumo is ONFT721 {

    address public metadata;
    uint256 public constant totalSupplyMax = 999;
    ...
    function walletOfOwner(address _owner) external view returns (uint256[] memory) {
        ...
        uint256 key = 0;
        for (uint256 i = 0; i < totalSupplyMax; i++) {
            if(_ownerOf(i) == _owner){ tokensId[key] = i; key++; if(key == tokenCount){break;} }
        }
        return tokensId;
    }
