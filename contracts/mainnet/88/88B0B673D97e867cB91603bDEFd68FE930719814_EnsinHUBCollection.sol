...
contract EnsinHUBCollection is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_, address proxyRegistryAddress_)
    ERC721("EnsinHUB Collection", "ENSHB")
  {
  ...
  uint256 public constant MAX_MULTIMINT = 50000;
  ...
  function mint(uint256 count) public nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 50000 at a time");
