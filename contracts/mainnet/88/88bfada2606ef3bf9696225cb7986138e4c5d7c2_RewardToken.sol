...
/**
 *Submitted for verification at FtmScan.com on 2021-07-31
*/

/* SPDX-License-Identifier: UNLICENSED  */
/* maxus.blog -- generalised SpiritChef with Token */
/* Change the Token Name and Symbol, DEV ADDRESS & FEE ADDRESS !!! */
/* Deploy the Token Contract */
/* Deploy the Chef Contract */
/* Transfer Ownership of the Token Contract to the Chef Contract */
/* Make your pools and enjoy */
/* join the squad https://snapshot.org/#/farmgod.eth */
/* ---- for a minimal react yield */
/* tequilafarm.io on xDai */
/* acres.maxus.blog farm template (on Fantom Opera)*/
/* moonwasp.io for some early xDai fun */
...
contract RewardToken is BEP20('TEST', 'TEST') {
...
contract TheChef is Ownable {
    ...
    constructor(
        ...
        rewardtoken = _rewardtoken;
        devaddr = address(0xAfca589D6505Bc33DE75263f391e73B1c86EbaBF);
        feeAddress = address(0xAfca589D6505Bc33DE75263f391e73B1c86EbaBF);
        rewardtokenPerBlock = 1 * 10 ** 18;
        startBlock = block.number + 3600;
    }
