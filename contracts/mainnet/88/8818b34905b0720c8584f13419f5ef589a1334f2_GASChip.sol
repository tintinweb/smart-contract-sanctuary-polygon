...
contract GASChip is ERC1155, Ownable, Minterable, Burnerable {
    ...
    function airdropSingleToSingle(address to_, uint256 id_, uint256 amount_,
    bytes calldata data_) external onlyMinter {
        _mint(to_, id_, amount_, data_);
    }
    function airdropManyToSingle(address to_, uint256[] calldata ids_, uint256[] calldata amounts_,
    bytes calldata data_) external onlyMinter {
