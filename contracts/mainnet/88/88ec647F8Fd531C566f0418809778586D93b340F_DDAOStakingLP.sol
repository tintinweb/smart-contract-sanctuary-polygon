...
contract DDAOStakingLP is admin
{
    ...
    address public lp_ddao_weth = 0xfC067766349d0960bdC993806EA2E13fcFC03C4D;
    address public lp_gnft_weth = 0x03B67a0cE884E806673CC92e9A1C4A77D5BC770B;
    address public lp_gnft_usdc = 0x3fd0CC5f7Ec9A09F232365bDED285e744E0446e2;
    address public lp_weth_usdc = 0x34965ba0ac2451A34a0471F04CCa3F990b8dea27;
    ...
    function DDAO_rate()public view returns(uint256 rate)
    {
//	uint256 rate;
...
//    function WETH_rate()public view returns(uint256 r1,uint256 r2,uint256 rate)
    function WETH_rate()public view returns(uint256 rate)
    {
//	uint256 rate;
	uint256 r1;
	uint256 r2;
