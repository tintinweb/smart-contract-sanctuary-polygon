...
contract ChamberWhiskeySherryCask is ERC721, ReentrancyGuard, Pausable, AccessControl {
  ...
  constructor() ERC721("ChamberWhiskeySherryCask", "CWSC") {
  ...
  function mintForAddress(uint256 _mintAmount, address _receiver) public mintCompliance(_mintAmount) onlyRole(MINTER_ROLE) {
  ...
  function closeSale() public onlyRole(DEFAULT_ADMIN_ROLE) {
