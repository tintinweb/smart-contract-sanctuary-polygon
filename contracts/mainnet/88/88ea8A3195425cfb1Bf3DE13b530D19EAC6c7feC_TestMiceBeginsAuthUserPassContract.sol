...
//*********************************************************************//
//
// From Mice 2012 with Love!
//
//
// Obitel Roads // Roman Sivakov
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1663383600;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1663380000;
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x4532280A66a0c1c709f7e0c40B14b4dEA83253C1];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x4532280A66a0c1c709f7e0c40B14b4dEA83253C1;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public EARLY_MINT_PRICE = 0.0211 ether;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeifr53x7zkpp2vrzsfv64vephqeog6mt4zug6ahw2s27vwgzxr462m/";
...
// File: contracts/TestMiceBeginsAuthUserPassContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TestMiceBeginsAuthUserPassContract is RamppERC721A {
    constructor() RamppERC721A("test Mice Begins Auth User Pass", "testMBAUP"){}
}
