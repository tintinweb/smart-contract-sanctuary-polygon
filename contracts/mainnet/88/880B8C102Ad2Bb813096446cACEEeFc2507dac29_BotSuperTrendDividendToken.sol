...
contract BotSuperTrendDividendToken is Ownable, ReentrancyGuard, ERC20 {

    uint256 constant public MAX_SUPPLY = 2e6 ether;
    ...
    modifier mintable(uint256 amount) {
        require(amount + totalSupply() <= MAX_SUPPLY, "BotSuperTrendDividendToken: amount surpasses max supply");
        _;
    }
    modifier isUnlocked() {
        require(!locked, "BotSuperTrendDividendToken: contract is currently locked");
        _;
    }

    receive() external payable {
        require(totalSupply() != 0, "BotSuperTrendDividendToken: No tokens minted");
    ...
    constructor() ERC20("BotSuperTrendDividend", "BSTD") {
        locked = true;
    }
    ...
    function withdraw() external nonReentrant isUnlocked {
        ...
        require(holderBalance != 0, "BotSuperTrendDividendToken: caller possess no shares");
        ...
        require(success, "BotSuperTrendDividendToken: Could not withdraw eth");
    }
