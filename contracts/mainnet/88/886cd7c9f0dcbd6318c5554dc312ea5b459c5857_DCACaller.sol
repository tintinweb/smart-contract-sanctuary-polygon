...
contract DCACaller {
    ...
    function doTrade(TradeInfo calldata tradeInfo) external returns (uint256 amountOut) {
        ...
        (
            ...
            address tokenOut,
            uint256 amountIn
        ) = (tradeInfo.user,tradeInfo.tokenIn,tradeInfo.tokenOut,tradeInfo.amountIn);

        TransferHelper.safeTransferFrom(tokenIn, user, address(this), amountIn);
