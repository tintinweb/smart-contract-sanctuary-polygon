...
contract CheckReward is Ownable {
   ...
   function rewardExist( address _user, uint256 _planetId, int256 _radius, int256 _x, int256 _y, int256 _z) public onlyOwnerOrAdmins returns(uint256 , uint256)
   {
       require ( _user != address(0) , " address of user couldn't be 0 ");
       ...
       if(rewardId == 0) {
        ...
        emit RewardExist(_x, _y , _z, rewardId , rewardDB.getRewardInfo(_planetId, rewardId).rewardAmount);
