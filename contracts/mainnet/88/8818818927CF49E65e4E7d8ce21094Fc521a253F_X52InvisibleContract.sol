...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x6E622048260FC53dfeD463828356bc93a836b6E0];
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 52, 52) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmWiyuoVqJ3ZubedDiHFfBDnCLF19xTyLhX2u6nna3YH8S/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 52");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 52");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 52");
...
// File: contracts/X52InvisibleContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract X52InvisibleContract is RamppERC721A {
    constructor() RamppERC721A("52 Invisible", "Inv"){}
}
