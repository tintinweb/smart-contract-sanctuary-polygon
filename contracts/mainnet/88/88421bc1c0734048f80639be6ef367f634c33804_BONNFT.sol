...
contract BONNFT is ERC721, Ownable {
    ...
    uint public price = 15000000000000000000;
    ...
    event NewBONNFTMinted(address sender, uint256 tokenId);

    constructor() ERC721("Bank of Nowhere NFTs -- Collection #1", "BON-NFT") {
        baseUri = "ipfs://bafybeicpsshi7rpaiqrkhyejxaixbqhuv6n4cnee5hx2aspbjoh7jfbpvu/";
    ...
    // Public Functions
    function mintBONNFT(uint256 _numTokens) external payable {
        require(isSaleActive, "The sale is paused.");
        require(_numTokens <= MAX_MINT_PER_TX, "You cannot mint that many in one transaction.");
        require(mintedPerWallet[msg.sender] + _numTokens <= MAX_MINT_PER_TX, "You cannot mint more than 5 NFTs per wallet.");
        ...
        emit NewBONNFTMinted(msg.sender, totalSupply);
    }
