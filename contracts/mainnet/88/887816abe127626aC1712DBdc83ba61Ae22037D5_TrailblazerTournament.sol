...
contract TrailblazerTournament is SkylabBase {
    ...
    function tournamentMint(address to, uint fuel, uint battery) external onlyOwner {
        ...
        _skylabResources.playTestNuke(to, ids);
        _skylabResources.mintBatch(to, ids, resourceAmounts, "");
    }
