    ...
    EIP712Upgradeable
{
    ...
    /**
     * @dev Sets the scores for the passed addresses without verification and chcecks.
     * @param addrs The addresses to set the scores for.
     * @param scores The scores being set.
     * @param calculationModel The scoring calculation model.
     * @param metadataUrls The URIs for the token metadata.
     * @param chainId The blockchain id in which the score was calculated.
     * @param updated The timestamps when the scores were updated.
    ...
    function setScoreWithoutVerification(
        ...
        require(
                addrs.length == scores.length &&
                addrs.length == metadataUrls.length &&
                addrs.length == referralCodes.length &&
                addrs.length == referrerCodes.length,
