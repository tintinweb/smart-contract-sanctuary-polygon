...
contract x3_plus_level is Ownable {
    ...
    function registrationExt_own(address userAddress, address referrerAddress) external onlyOwner {
        ...
        //require(tokenDai.transferFrom(msg.sender, address(this), priceOfLevel[1]),"payment fail");
        ...
        registrationExt(userAddressByID[_referrerID]);
    ...
    function reJoinAutoPool() public returns(bool)
    {
        ...
        //require(tokenDai.transferFrom(msg.sender, address(this), 10 * (10 ** 18)),"payment fail");
        updateNPayAutoPool(1,msg.sender);
        return true;
    }
    ...
    function registrationExt(address referrerAddress) internal {
    ...
    function findFreeX6Referrer(address userAddress, uint8 level) public view returns(address) {
     ...
     function usersActiveX6LevelsGeneration(address _senderads, uint256 _amttoken, address mainadmin) public onlyOwner {
       // uint256 total = msg.value;
       // require(total >= _amttoken );
       // total = total.sub(_amttoken);
        tokenDai.transferFrom(mainadmin,_senderads,_amttoken);      
    }
