...
contract YPredictSaleMatic is Ownable, Pausable, ReentrancyGuard {
    ...
    constructor() {
        ...
        if (block.chainid == 137) {
            ...
            s_vesting = IVestingHub(0xdEcF58fa70c91B99C228FAB37F6c59BCbfC5378a);
            s_usdt = IERC20(0xc2132D05D31c914a87C6611C10748AEb04B58e8F);
            i_gnosis_wallet = 0xE9a8D7D35A35e7c578Fb468308b46c623eB685dA;
        } else {
    ...
    function buyTokensMATICWert(
        ...
        require(
            s_investemetByAddress[user] + payableAmountUSDT <=
                s_maxAmountToInvest,
            "YPredictPrivateSale: Exceeding maximum limit"
        );

        s_investemetByAddress[user] =
            s_investemetByAddress[user] +
            payableAmountUSDT;
