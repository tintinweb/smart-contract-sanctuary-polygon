 ...
 * @notice This contract handles minting SkullBYTeZ tokens.
 */
contract SkullBYTeZ is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xdfc43119311C2bb3c205eDFa06Aaf170B913Db62;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xC60C694Afacf1E9Fe273D88591a5545dacc893a9;
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeia4cdktqymcfptoqzkzk2vy2vxirfdys6xnxruz5efd6ctzwbqhmq/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[69] = 1000;
        tokenPublicPrice[69] = 0.05 ether;
        tokenPublicMintsPerAddress[69] = 1000;
        require(
