...
// File: contracts/PTRN_smart_contract.sol
...
contract PathEarn is ERC20, ERC20Burnable, Pausable, Ownable {
    ...
    constructor
    (
        uint256 max_service_fee_,
        uint256 initial_service_fee_,
        uint256 single_mint_service_fee_,
        uint256 max_single_mint_service_fee_,
        address fee_wallet_) ERC20("PTRN smart contract", "PTRN"
    )

    {
        _cap = 300000000000000000000000000;
        _service_fee = initial_service_fee_;
        _max_service_fee = max_service_fee_;
        _single_mint_service_fee = single_mint_service_fee_;
        _max_single_mint_service_fee = max_single_mint_service_fee_;
        _total_minted = 0;
