    ...
    UUPSUpgradeable
{
    ...
    mapping(address => WhiteListItem) public _whiteList;
    ...
    function addToWhiteList(address toAddAddress) public onlyOwner {
        _whiteListCounter.increment();
        _whiteList[toAddAddress] = WhiteListItem(true, 0, false);
    }
