...
contract DegShipCommanderV2 is IDegShipCommanderV2, Ownable {
    ...
    bool public isNeedDegLaunch;
    bool public isNeedDegReLaunch;
    bool public isDao;
    bool public isNode;
    ...
    function setSwitcher(bool _dao, bool _node, bool _luck) external onlyOwner{
        isDao = _dao;
        isNode = _node;
        isLuckPool = _luck;
    }

    function setNeedDegLaunch(bool _launch, bool _relaunch) external onlyOwner{
        isNeedDegLaunch = _launch;
        isNeedDegReLaunch = _relaunch;
    }
}
