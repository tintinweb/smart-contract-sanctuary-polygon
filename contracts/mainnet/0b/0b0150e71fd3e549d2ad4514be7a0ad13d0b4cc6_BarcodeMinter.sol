...
contract BarcodeMinter is ERC721URIStorage , Ownable {
   using Counters for Counters.Counter;
    
   // 5. Setting Counters as token id
   Counters.Counter private _tokenIds;
   using Strings for uint256;
   uint256 public cost_public = 0.0 ether;
   ...
   function mint(string memory _tokenURIx) external payable {

        totalSupply++;
        uint256 tokenId = totalSupply;
        _safeMint(msg.sender, tokenId);
        _setTokenURI(tokenId,_tokenURIx);
