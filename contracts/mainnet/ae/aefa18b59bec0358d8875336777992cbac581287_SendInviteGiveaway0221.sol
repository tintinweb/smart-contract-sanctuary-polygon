...
// UTC+8 Feb-21, 2022 Giveaway Contract
...
contract SendInviteGiveaway0221 {
    ...
    constructor() {
        ...
        addGiveawayAddress(tmpAddr, 3);
        addTop10Address(tmpAddr);
        tmpAddr = 0x2EEF02bC3846bb9a05bFE82a65fbe41340d04Ba1;
        addGiveawayAddress(tmpAddr, 3);
        addTop10Address(tmpAddr);
        tmpAddr = 0xaF8e0e1dAC7c5b4236301758394d53954ecd63f5;
        addGiveawayAddress(tmpAddr, 2);
        addTop10Address(tmpAddr);
        tmpAddr = 0x2ebbd5a37Bca00ae65fE068a385F100729Bd7Bdb;
        addGiveawayAddress(tmpAddr, 2);
        addTop10Address(tmpAddr);
        tmpAddr = 0x1AAA7112bF497bD26efFBf9C30BaC6402AaD12E3;
        addGiveawayAddress(tmpAddr, 2);
        addTop10Address(tmpAddr);
