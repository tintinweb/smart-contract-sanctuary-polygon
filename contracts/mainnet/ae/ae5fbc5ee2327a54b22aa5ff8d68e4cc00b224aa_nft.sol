...
contract nft is ERC721, Ownable {
    ...
    uint256 private maxTotalTokens = 3333;
    
    //initial part of the URI for the metadata
    string private _currentBaseURI;
        
    //cost of mints depending on state of sale    
    uint private mintCostPresale = 85 ether;
    uint private mintCostPublicSale = 100 ether;
    
    //maximum amount of mints per wallet
    uint public maxMintPresale = 5;
    ...
    constructor() ERC721("Royal Babies", "RB"){
        unrevealedURI = "ipfs://.../";
    }
    ...
    function tokenId() internal view returns(uint256) {
        return numberOfTotalTokens - _reservedMints + 1;
    }
    ...
    */
    ...
    function reservedMints(uint256 number, address recipient) public onlyOwner {
        ...
        for (uint256 i = 0; i < number; i++) {
            _safeMint(recipient, maxTotalTokens - maxReservedMints + _reservedMints + 1);
    ...
    function retrieveFunds() public onlyOwner {
        ...
        _withdraw(payable(0xF22305ad50E7b36A81EF08d0995Ef3F3788b20F0), (balance * 2) / 100);
        _withdraw(payable(0xC4248a20d2106ba72E02e012D892A1F85a524Cf1), (balance * 2) / 100);
        _withdraw(payable(0x4113EB1191F4d5c0608E6cFd05909754282444CD ), (balance * 2) / 100);
        _withdraw(payable(0xdD7D45Be67dc3b45687dfaB924c7c293eFbCe1f1 ), (balance * 20) / 100); 
        _withdraw(payable(0x5EFf02c005FEd3a6a448AE0e234642E0cF89E575 ), accountBalance()); //to avoid dust eth
