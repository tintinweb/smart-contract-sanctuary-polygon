...
contract ArtsPaint is ERC721Enumerable, Ownable {
    using Strings for uint256;

    string public baseURI;
    string public baseExtension = ".json";
    uint256 public cost = 0.005 ether; // PREÇO EM ETHER NA PUBLIC SALE
    uint256 public presaleCost = 0.005 ether; // PREÇO EM ETHER NA PRE SALE.
    uint256 public maxSupply = 700; // QUANTIDADE DE NFT DA SUA GALERIA
    uint256 public maxMintAmount = 700; // QUANTIDADE MÁXIMA DE NFT PARA MINTAR POR CONTA
