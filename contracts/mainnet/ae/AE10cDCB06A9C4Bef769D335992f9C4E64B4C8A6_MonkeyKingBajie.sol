...
contract MonkeyKingBajie is Ownable, ERC721A, ReentrancyGuard {
    constructor(
    ) ERC721A("MonkeyKing_Bajie", "BAJIE", 10, 3600) {}
    ...
    uint256 public allowListMintAmount = 600;
    ...
    uint256 public amountForPublicSale = 2800;
