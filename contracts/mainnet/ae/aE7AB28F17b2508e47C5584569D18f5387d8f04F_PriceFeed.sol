    ...
    Version
{
    ...
    /**
     * @dev Method to get Chainlink price feed
     * @param from "from" token in Chainlink
     * @return Feed struct
     */
    function getFeed(IERC20MetadataUpgradeable from) external view returns (Feed memory) {
        return fromToFeed[from][IERC20MetadataUpgradeable(USD_ADDRESS)];
    }
...
string constant LOAN_MANAGER_VERSION = "2.0.2";
