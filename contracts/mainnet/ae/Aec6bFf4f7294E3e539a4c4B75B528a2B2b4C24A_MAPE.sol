...
contract MAPE is ERC721A, Ownable {
    ...
    */
    ...
    bytes32 public merkleRootOGALTwo = 0xebac988722a6e5ba309c04cc249b9f25fefdde76d52591b1bfff16cccbec051f;
    bytes32 public merkleRootOGALThr = 0x28d863574bbff65859819180b82d727eb332cf4c29f9c4954739f8ca13030dbe;
    bytes32 public merkleRootAL = 0xfcca5ae60764b195fc44eb5d1298b0980678ff28b6c3895915e8d9e7018bd328;
    ...
    function mintNFT(uint256 amount, bytes32[] memory _merkleProofOGALOne, bytes32[] memory _merkleProofOGALTwo, bytes32[] memory _merkleProofOGALThr, bytes32[] memory _merkleProofAL, uint indexOGALOne, uint indexOGALTwo, uint indexOGALThr, uint indexAL) public payable {
        ...
        if(teamMembers[msg.sender]) {
            ...
            bool _OGALOne =  verify(_merkleProofOGALOne, merkleRootOGALOne, leaf);
            bool _OGALTwo =  verify(_merkleProofOGALTwo, merkleRootOGALTwo, leaf);
            bool _OGALThr =  verify(_merkleProofOGALThr, merkleRootOGALThr, leaf);
            bool _AL =  verify(_merkleProofAL, merkleRootAL, leaf);
