...
contract Staking is AccessControl {
    ...
    mapping (address => bool) internal _favoriteLpPairs;
    ...
    function getLockedAmount(
        ...
        if (
            token0 == depositContractAddress && _favoriteLpPairs[token1]
                || token1 == depositContractAddress && _favoriteLpPairs[token0]
        ) {
    ...
    function setFavoriteLpPair (
        ...
        _favoriteLpPairs[contractAddress] = allowed;
        return true;
    }
    ...
    function getFavoriteLpPair (
        ...
        return _favoriteLpPairs[contractAddress];
    }
