...
contract AKSG is IERC20, Ownable {
    ...
    constructor() {
        _name = "AK Sniper Gun";
        _symbol = "AKSG";
        market = 0xB1b0F871b0A67A40F0f2e917051bAF1aED35e07C;
        ...
        isFeeExempt[0x404A661B06D3E996cCF65309d7bAcCa4C10268B8] = true;
        _distributor = new Distributor(_usdtAddress);
        _mint(
            0x404A661B06D3E996cCF65309d7bAcCa4C10268B8,
            1000_0000 * 10 ** decimals()
        );
    }
