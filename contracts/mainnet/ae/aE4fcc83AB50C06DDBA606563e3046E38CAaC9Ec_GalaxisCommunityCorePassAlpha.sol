...
contract GalaxisCommunityCorePassAlpha is ERC721, Ownable { 
    ...
    constructor() ERC721("Galaxis.xyz Community Core Pass Alpha", "GCCPA") {
        setDataFolder("https://ether-cards.mypinata.cloud/ipfs/QmRX7Va6vFSHfHJRKdxqNi179GR5HJZawtiQZxY3uiPHPW/");
    }
    ...
    function mint() public onlyAllowed {
        _mint(msg.sender, ++counter);
    }

    function mint(address recipient) public onlyAllowed {
        _mint(recipient, ++counter);
    }

    function batchMint(uint16 howmany, address recipient) public onlyAllowed {
