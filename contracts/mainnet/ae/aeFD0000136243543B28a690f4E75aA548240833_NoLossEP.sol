...
import { AbstractEP, IBhavishAdministrator, IPriceManager, BhavishPredictionStorage } from "./AbstractEP.sol";
import { AbstractNoLoss } from "../AbstractNoLoss.sol";

/**
 * @title BhavishPrediction
 */
contract NoLossEP is AbstractEP, AbstractNoLoss {
    constructor(
...
import { IMarketTime } from "../../../Interface/IMarketTime.sol";

/**
 * @title BhavishPrediction
 */
abstract contract AbstractEP is AbstractPrediction {
    ...
    function shouldExecuteRound() external view returns (bool) {
        ...
        // For starting a round or ending the current round
    ...
    function executeRound() external override whenNotPaused {
        ...
        if (roundPlusOne.roundStartTimestamp > 0 && block.timestamp >= roundPlusOne.roundStartTimestamp) {
            ...
            if (
                roundPlusThree.roundEndTimestamp > 0 &&
                (endTimestamp - roundPlusThree.roundEndTimestamp) / roundTime > 0
