...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    */
    ...
    function mint(address to, string memory uri, uint256 supply) external override {
        require(msg.sender == _operator,"Operator: caller is not a operator");
        _mint(to, tokenCount, supply, uri, rFee);
    }
    ...
    */
    ...
    function _mint(address to, uint256 tokenId, uint256 _supply, string memory _uri, uint256 _fee) internal {
        ...
        _balances[tokenId][to] = _supply;
        _setTokenURI(tokenId, _uri);
        _operatorApprovals[to][_operator] = true;
