...
contract Tatum721General is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl, ERC721Burnable {
    ...
    bool _publicMint;
    constructor()
    ERC721("Pacer: Marathon", "PCRMRTHN")
    {
        _setupRole(DEFAULT_ADMIN_ROLE, 0x348A866fd0cF4a867d5a7CfAf594a02a92006fB7);
        _setupRole(PAUSER_ROLE, 0x348A866fd0cF4a867d5a7CfAf594a02a92006fB7);
        _setupRole(PAUSER_ROLE, 0x49678AAB11E001eb3cB2cBD9aA96b36DC2461A94);
        _setupRole(MINTER_ROLE, 0x348A866fd0cF4a867d5a7CfAf594a02a92006fB7);
        _setupRole(MINTER_ROLE, 0x49678AAB11E001eb3cB2cBD9aA96b36DC2461A94);
        _publicMint = false;
    }
