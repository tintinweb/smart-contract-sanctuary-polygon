...
contract AnnuitCoeptisbyAI is ERC721 {
    ...
    constructor()
        ERC721("Annuit Coeptis by AI", "ACAI")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeiayj5ridb2vyh2etxytqvllpkyvnnlvmoga3dzhxb7v55zolhkijy/", Strings.toString(tokenId), ".json")
            );
    }
