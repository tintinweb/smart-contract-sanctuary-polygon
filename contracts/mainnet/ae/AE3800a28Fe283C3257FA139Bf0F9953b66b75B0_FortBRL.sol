...
/**
 * @title Fort BRL
 * @author Valfenda Computação (https://valfendacomputacao.com.br)
 * @dev StableCoin pareada ao Real Brasileiro (BRL)
 *
 * Token ERC20 voltado para a mintagem dos tokens FBRL na rede Polygon, que serão pareados
 * ao Real Brasileiro através da Fort Exchange, exchange cripto brasileira voltada para
 * o mercado P2P de balcão.
 * 
 * Mais detalhes: https://fort.exchange/
 */
