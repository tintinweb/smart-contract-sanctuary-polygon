...
contract NftizePoolLpManager is INftizePoolLpManager {
    ...
    function claimTheosLiquidity(address poolTokenAddress, LPData memory lpProvider) public {
        ...
        //        Disabled for the initial version
        //        if (
        //            theosReserveAmount > 2 * lpProvider.theosTokenAmount &&
