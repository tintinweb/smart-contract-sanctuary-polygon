...
contract Adorable_Avocado is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  {
      uint256 supply = totalSupply(); 
      require(_reserveAmount > 0 && _reserveAmount <= tokenReserve, "Reserving over max of 2 or not enough total supply.");
