 ...
 * @notice This contract handles minting RHDC May pass tokens.
 */
contract RHDCMayPass is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x5E0F09B859cfb5ce475a38Af3f53f42a64CD54E8;
    ...
    address public royaltyAddress = 0xDF51BcB662fcD6988B7453611D9618628E97aaC6;
    address[] public payoutAddresses = [
        0xDF51BcB662fcD6988B7453611D9618628E97aaC6
    ];
    ...
    string public name = "RHDC May pass";
    string public symbol = "RHDC-MAY";
    ...
    constructor(uint256 _heymintFeePerToken, address _crossmintAddress)
        ERC1155(
            "ipfs://bafybeiaqnecd4xe7heivy7kl2n2pb7bc7ynf6ubsrcmo7fj2kzex2a4mry/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[1] = 15;
        tokenPublicPrice[1] = 20 ether;
        tokenPublicMintsPerAddress[1] = 15;
        require(
