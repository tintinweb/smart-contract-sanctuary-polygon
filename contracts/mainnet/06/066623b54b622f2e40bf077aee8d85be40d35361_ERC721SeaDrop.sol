    ...
    DefaultOperatorFilterer
{
        ...
        nonReentrant
    {
        ...
        // Mint the quantity of tokens to the minter. and set the tokens to the holder
        for (uint256 i = 1; i <= quantity; i++) {
            ownerTokens[minter].push(totalSupply() + i);
        }
    ...
    function transferFrom(
        ...
        _transferOwnerTokens(from, to, tokenId);
    }
