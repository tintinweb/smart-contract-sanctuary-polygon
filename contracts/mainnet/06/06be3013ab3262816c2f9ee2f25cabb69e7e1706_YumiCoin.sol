...
contract YumiCoin {
    ...
    function transfer(address _to, uint256 _value, string memory _comment) public returns (bool success) {
        require(balanceOf[msg.sender] >= _value, "Insufficient balance");
        balanceOf[msg.sender] -= _value;
        balanceOf[_to] += _value;
        emit Transfer(msg.sender, _to, _value, _comment);
        return true;
    }
