...
contract FZN_NFT is ERC1155Tradable {
    constructor(address _proxyRegistryAddress) public ERC1155Tradable("fzn_nft", "fzn_nft", _proxyRegistryAddress) {
        _setBaseMetadataURI("http://fissionize.com/");
    }
