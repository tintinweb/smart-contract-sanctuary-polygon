...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x14A48BE0f14a16CA87392ecf192721C12DA916ef];
...
// File: contracts/FlavortownWtfContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract FlavortownWtfContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "FlavortownWTF";
    string public symbol = "FTWTF";
