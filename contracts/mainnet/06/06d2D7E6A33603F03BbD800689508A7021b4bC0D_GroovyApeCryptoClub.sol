...
contract GroovyApeCryptoClub is ERC721 {
    ...
    constructor()
        ERC721("Groovy Ape Crypto Club", "GACC")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeifkxnfqv3xjwdhpl365clwxxyp2a4yodxnktbao3bdjt36hy7x42y/", Strings.toString(tokenId), ".json")
            );
    }
