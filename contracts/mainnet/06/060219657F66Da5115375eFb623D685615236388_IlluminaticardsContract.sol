...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xB121bC72e8a1512c5BDce9B9bf61AC7Ca2266666];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xB121bC72e8a1512c5BDce9B9bf61AC7Ca2266666;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 417) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeie3gcmgyom36md4hpygoxvilooq25csgnhryhpy5g2s2z6atmbg2q/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 417");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 417");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 417");
...
// File: contracts/IlluminaticardsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract IlluminaticardsContract is RamppERC721A {
    constructor() RamppERC721A("illuminati cards", "IC"){}
}
