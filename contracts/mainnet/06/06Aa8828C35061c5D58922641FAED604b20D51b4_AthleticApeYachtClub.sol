...
contract AthleticApeYachtClub is ERC721 , DefaultOperatorFilterer {
    ...
    constructor()
        ERC721("Athletic Ape Yacht Club", "AAYC")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeicl6nvrx22z3mvrfa4w6wxnwg5slircgyk2bfewhesxlbskx35qbq/", Strings.toString(tokenId), ".json")
            );
    }
