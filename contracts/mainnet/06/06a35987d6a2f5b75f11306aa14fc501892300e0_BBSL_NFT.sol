...
// File: contracts/nft_test_burn_man.sol
...
contract BBSL_NFT is ERC721, Ownable {
    ...
    string public description = "A Smart contract to generate Burner Bear Soical League (BBSL) NFTs.";

    // the name and symbol for the NFT
    constructor() public ERC721("BBSL", "BBSL") {}
   ...
   // receiver takes a type of address. This is the wallet address of the user that should receive the NFT minted using the smart contract
    ...
    function withdrawFunds(IERC20 token) public onlyOwner {
