...
contract Incrowd is ERC721, Ownable, ReentrancyGuard {
    ...
    uint256 public nftPrice = .4 ether;
    uint256 public wlNftPrice = .4 ether;

    uint public maxNftPurchase = 2;
    uint public maxNftWallet = 2;
    ...
    constructor() ERC721("InCrowd Alpha", "INCROWDALPHA") {
        MAX_NFTS = 1500;
        setBaseURI("https://pin.ski/3gyfFEu/");
    }
