...
contract NewLuckyFinanceUpgradeable is IERC721ReceiverUpgradeable, OwnableUpgradeable  {

    using SafeMathUpgradeable for uint256;
    using SafeERC20Upgradeable for IERC20Upgradeable;
    
    uint256 public  CHANGE_POWER_SIZE; //更改算力次数
    uint256 public  stakingMaxId; //支持质押的nft最大ID 
    ...
    function setLuckyMetaToken(address _newLuckyMetaToken) external onlyOwner(){
        lmt = IERC20Upgradeable(_newLuckyMetaToken);
    }
