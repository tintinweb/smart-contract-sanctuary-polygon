...
abstract contract CustomRoyalties is RoyaltiesV2, IERC2981 {
    event RoyaltiesForAllSet(address prevRecipient, uint256 prevRoyalties, address newRecipient, uint256 newRoyalties);
    ...
    function _setRoyaltiesForAll(
        ...
        emit RoyaltiesForAllSet(royaltyRecipient, royaltyPercentageBasisPoints, recipientAddress, percentageBasisPoints);
