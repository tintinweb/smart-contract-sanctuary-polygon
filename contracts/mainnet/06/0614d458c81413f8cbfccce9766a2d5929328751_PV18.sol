...
contract PV18 is ERC20Interface, Owned {
   ...
   function GetMemberCodebyOrder(uint _index)public Lev2 view returns(uint){
   ...
   function ReadMemberFromOrder(uint _index) public Lev2 view returns
   ...
   //update member data
   function updateMemberCode(uint _index, uint _Code)public Lev2 {
   ...
   function updateMemberName(uint _index, string memory _Name)public Lev2{
    ...
    function updateAddr(uint _index, address _addr)public Lev2{
    ...
    function updateStatus(uint _index, uint8 _status)public Lev2{
    ...
    function updateRight(uint _index, uint8 _right)public Lev2{
   ...
   function SetStartPoint(uint _point)public Lev1 {
    ...
    public Lev1 returns(string memory){
     ...
     function MintPoint(uint _point, string memory _reasons)public Lev1{
