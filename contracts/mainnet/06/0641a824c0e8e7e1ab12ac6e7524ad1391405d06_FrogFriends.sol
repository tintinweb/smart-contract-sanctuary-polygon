...
contract FrogFriends is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Frog Friends", "FG") {
    setHiddenMetadataUri("ipfs://QmcYMhqtFX4FTqPAam8ZWmtfh28NdskXHNPmxZyQTHNgik/hidden.json");
  }
