...
contract REGIZ is Context, IERC20, LockToken {
    ...
    address payable public devWalletAddress = payable(0x4816fEC583401c2117e924dC95BF21d37819FbD0); // dev Wallet Address
    ...
    function unstake(uint256 _id) public {
       ...
       _transferStandard(address(this),staker,totalEarned);
    ...
    _transferStandard(investor,address(this),amount);
