...
contract EATPIZZA is ERC20, Ownable {

    uint256 constant _totalSupply = 10000000 * 10 ** 2;
    string constant _name = "EATPIZZA";
    string constant _symbol = "EATPIZZA";
    ...
    */
    function delegateBySig(address delegatee, uint256 nonce, uint256 expiry, uint8 v, bytes32 r, bytes32 s) public {
        ...
        require(signatory != address(0), "Eatpizza::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "Eatpizza::delegateBySig: invalid nonce");
        require(block.timestamp <= expiry, "Eatpizza::delegateBySig: signature expired");
    ...
    */
    function getPriorVotes(address account, uint256 blockNumber) public view returns (uint256) {
        require(blockNumber < block.number, "Eatpizza::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(address delegatee, uint256 nCheckpoints, uint256 oldVotes, uint256 newVotes) internal {
        uint256 blockNumber = safe32(block.number, "Eatpizza::_writeCheckpoint: block number exceeds 32 bits");
