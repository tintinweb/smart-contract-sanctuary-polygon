...
contract HOMGOLDToken is BEP20, MinterRole {
    ...
    uint256 public sellFee = 10;   // default 10%
    uint256 public minSwapAmount = 10000000000;   //1 HOMGOLD tokens
    ...
    // address public immutable lpcontract;


    /**z
     * @notice Constructs the HOMGOLD token contract.
     */
    constructor(address _treasury) public BEP20("HOM-GOLDToken", "HOM-GOLD") {
        operator = _msgSender();
    ...
    // function getReserves1() public view returns (uint112 reserve0) {
    //     reserve0 = IUniswapV2Pair( lpcontract ).getReserves()[0];
    //      return reserve0;
    // }
