...
interface kyberswapV2 {
    ...
    function swapExactInputSingle(SwapExactInputSingleParams calldata params) external payable returns (uint256 amountOut);
    ...
    function swapExactOutputSingle(SwapExactOutputSingleParams calldata params) external payable returns (uint256 amountIn);
    ...
    function swapExactOutput(SwapExactOutputParams calldata params) external payable returns (uint256 amountIn);  
}
...
contract FlashLoanAAVE is Ownable {
    ...
    function _sellAsset(address asset_) internal {
        ...
        if(sellV3){
            ...
            kyberSwapRouter.swapExactInputSingle{value: 0}(
                kyberswapV2.SwapExactInputSingleParams({
                    tokenIn: asset_,
                    tokenOut: buyToken,
                    fee: kyberFee,
                    recipient: address(this),
    ...
    function _buyAsset(address asset_) internal {
        if(buyV3){
            ...
            IERC20(buyToken).approve(address(kyberSwapRouter), IERC20(buyToken).balanceOf(address(this)));
            kyberSwapRouter.swapExactInputSingle{value: 0}(
                kyberswapV2.SwapExactInputSingleParams({
                    tokenIn: buyToken,
                    tokenOut: asset_,
