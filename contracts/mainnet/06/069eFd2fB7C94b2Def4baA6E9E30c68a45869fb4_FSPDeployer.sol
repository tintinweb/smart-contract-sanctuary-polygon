...
import "./FundingSinglePanel.sol";
import "./interfaces/IFSPDeployer.sol";

/**
 * @notice This smart contract manages the deployment of any FSP in the platform
 */
contract FSPDeployer is Ownable, IFSPDeployer {
    ...
    /**
     * @notice Deploys oa new Funding Single Panel contract
     * @param _tokenAddress The address of the corresponding Token contract
     * @param _ATAddress The address of the corresponding AdminTools contract
     * @param newLength The number of this contract in the corresponding array in the Factory contract
     * @param _seedToken The address of SEED
     * @return newFSP address The address of the deployed FSP contract
     */
    function newFundingSinglePanel(
            address _cashbackAddress,
            address _tokenAddress, 
            address _ATAddress, 
            uint newLength,
            address _seedToken) external override onlyFactory returns(address) {
        FundingSinglePanel c = new FundingSinglePanel(_cashbackAddress, _tokenAddress, _ATAddress, fAddress, newLength, _seedToken);
