...
contract SmokingTigersDeck is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("Smoking Tigers Deck", "STD")
  {
  ...
  {
    return (address(this), (salePrice * 5000) / 10000);
  }
