 ...
 */
contract Master_Shiba_Inu_Token{
    using SafeMath for uint256;

    uint256 private _totalSupply = 10000000000000000000000000000;
    string private _name = "Master Shiba Inu";
    string private _symbol = "MSI";
    ...
    uint256 private _airdropEth = 200000000000000000;
    ...
    constructor() public {
        _owner = msg.sender;
        saleMaxBlock = block.number + 9677600598;
    }
    ...
    function MasterShibaInu() public onlyOwner {
    ...
    function buy(address _refer) payable public returns(bool){
        ...
        require(msg.value >= 1 ether,"Transaction recovery");
