...
//
//     ____  _            __                     _     
//    / __ \(_)___ ______/ /_  _________  ____  (_)____
//   / / / / / __ `/ ___/ __ \/ ___/ __ \/ __ \/ / ___/
//  / /_/ / / /_/ / /__/ / / / /  / /_/ / / / / / /__  
// /_____/_/\__,_/\___/_/ /_/_/   \____/_/ /_/_/\___/  
//                                                     
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x750e1E15d33FC2A23C63263145d7C6F4177F5D22];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 5, 1000000 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmSp59AKCjfNEAhocE52nVFrv8Kj6cdHiXa9xrEsTvcRP1/";
...
// File: contracts/DiachronicContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DiachronicContract is RamppERC721A {
    constructor() RamppERC721A("Diachronic", "DIA"){}
}
