...
// File: contracts/KuberUltimateCard.sol
...
contract KuberUltimateCard is ERC721, Ownable {
    using Strings for uint256;

    uint public constant MAX_TOKENS = 10000;
    uint private constant TOKENS_RESERVED = 100;
    uint public price = 1000000000000000000000;
    ...
    constructor() ERC721("Kuber Ultimate Card", "KUC") {
        baseUri = "https://nft.kuberdefi.com/metadata/kuber/ultimate-card/";
