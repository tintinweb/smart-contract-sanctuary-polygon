...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xD94f5B2704aC4509E0611d617b3FC622cc3E9769];
  address public erc20Payable = 0xD94f5B2704aC4509E0611d617b3FC622cc3E9769;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1000, 8888) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeif3ugct6xx47c5cii3pd6bamurrfkqxcg3kdv36h67h6jgmiwlrxi/";
...
contract PiDaoClubContract is RamppERC721A {
    constructor() RamppERC721A("Pi DAO Club", "Pi NFT"){}
}
