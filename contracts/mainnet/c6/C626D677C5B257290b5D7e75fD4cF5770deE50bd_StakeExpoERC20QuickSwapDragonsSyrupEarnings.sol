...
contract StakeExpoERC20QuickSwapDragonsSyrupEarnings is StakeExpoERC20QuickSwapDragonsSyrup {
	constructor(address _owner, address _stakingContract) StakeExpoERC20QuickSwapDragonsSyrup(_owner, _stakingContract) {
...
abstract contract StakeExpoERC20QuickSwapDragonsSyrup {
	...
	constructor(address _owner, address _stakingContract) {
		owner = _owner;
	...
	function transferTokenToOwner(address token) external {
