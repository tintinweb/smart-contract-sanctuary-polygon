...
//   / ___// /_(_)____/ /_______   / ____/___  ________ _   _____  _____
//   \__ \/ __/ / ___/ //_/ ___/  / /_  / __ \/ ___/ _ \ | / / _ \/ ___/
//  ___/ / /_/ / /__/ ,< (__  )  / __/ / /_/ / /  /  __/ |/ /  __/ /    
// /____/\__/_/\___/_/|_/____/  /_/    \____/_/   \___/|___/\___/_/     
//                                                                      
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xD7d863930950B8EA429A32d18fE593b886265B02];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2000, 2000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmcquCER9p8ZgNUM4evvFcDKGH8ArhYutSvJKJQw5NXu3q/";
...
// File: contracts/SticksForeverContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SticksForeverContract is RamppERC721A {
    constructor() RamppERC721A("Sticks Forever", "SF"){}
}
