...
contract GravityFeeConfigurator is Ownable {
    struct FeeCategory {
    ...
    constructor(address _keeper, uint256 _totalLimit) {
        keeper = _keeper;
    ...
    function getFeeCategory(
        ...
        if (_adjust) {
            ...
            fees.manager = (fees.manager * _totalFee) / DIVISOR;
            fees.call = (fees.call * _totalFee) / DIVISOR;
            fees.partner = (fees.partner * _totalFee) / DIVISOR;
        }
    }
    ...
    function setFeeCategory(
        ...
        uint256 _gravity = DIVISOR - _call - _strategist;
