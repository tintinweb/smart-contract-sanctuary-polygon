...
/**
* @title Implementation of IOracle that keeps track of prices on uniswap
*/
contract UniV2Oracle is IOracle {
    ...
    * @param factory Address to the IUniswapV2Factory
    * @param tokenA Address to the first token
    * @param tokenB Address to the second token
    * @param weth_ Address to the weth contract
    */
    constructor(
        address factory,
        address tokenA,
    ...
    /**
    * @notice Updates the average prices
    */
