...
contract Tiditada is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    /**@dev This variable holds the address for
    ...
    */
     ...
     *
     * 2. It lso checks if the state of the tidiTada raffle is open.
     * If not open, it also reverts with and error.
     *
     * 3.  Finally, it funds the contract if both conditions above are true,
     * and emits and event. These event are indexed using the Moralis Server, to
     * give playres real-time status if the tidiTada Raffle.
     */
     ...
     *
     * the following should be true for this function to perform 'upKeep':
     * 1. The time interval (7 days) has passed between Tiditada runs.
     * 2. The Tiditada Raffle  is open.
     * 3. The contract has funds.
     * 4. The number of players should be > 9
    ...
    /**
     * @dev This is the function picks the winner of the tidiTada Raffle
     * This function receives a Random Number (RN) from Chainlink VRF which is
     * used to pick the winner. The Random number generation is a multi-step process
     ...
     * Arithmetic
     *
     * 4. The picked winner recieved 86 percent of the total prize money in the smart
     * contract balance.
     *
     * 5. 14 percent of the remaining balance goes to Vangalabs maintaining the
     * tidiTada Raffle. Maintenance fees are listed below:
     *
