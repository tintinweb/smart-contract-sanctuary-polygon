...
import "./token/onft/extension/TwitterNFT721.sol";

contract TwitterNFT is TwitterNFT721 {
    constructor(address _layerZeroEndpoint, uint _startMintId, uint _endMintId, string memory _notRevealedUri) TwitterNFT721("TwitterNFT", "TwitterNFT", _layerZeroEndpoint, _startMintId, _endMintId, _notRevealedUri) {}
}
...
contract TwitterNFT721 is ONFT721 {
    ...
    function mint(uint8 numTokens) external payable {
        require(saleIsActive, "TwitterNFT : Sale must be active to mint token");
        require(numTokens < 100, "TwitterNFT : Max 30 NFTs per transaction");
        require(nextMintId + (numTokens - 1) <= maxMintId, "TwitterNFT : Max Mint limit reached");
