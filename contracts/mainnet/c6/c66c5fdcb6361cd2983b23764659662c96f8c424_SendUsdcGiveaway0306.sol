...
// UTC+8 March-06, 2022 Giveaway Contract
...
contract SendUsdcGiveaway0306 {
    ...
    function sendGiveaway() public {
        require(contractOwner==msg.sender, "Permission Denied");
        sendUsdc(0x5C1Bc5dbb20ACd4a4D0143099acd807f7b06FD49, 1); // 皇帝肝 | Sy#8016, 1U
        ...
        sendUsdc(0xFef3fE9290124216D956C5bb3Cda7057872acE57, 1); // PongPong🚀🚀#5958, 1U
        sendUsdc(0x2ebbd5a37Bca00ae65fE068a385F100729Bd7Bdb, 1); // SnowLober#4176, 1U
        sendUsdc(0xc30d285c5661019303A4B1e2A88dD88e43a60FFa, 5); // whilelist gang | v2#3428, 5U
        sendUsdc(0x8392530a45A7964F2b3a38dA7bB0d27D9d91ea49, 10); //  玄兔#1299, 10U
    }
