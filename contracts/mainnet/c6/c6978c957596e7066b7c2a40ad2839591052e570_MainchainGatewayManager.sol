...
// File: @recon/contract-library/contracts/cryptography/ECVerify.sol
...
// File: @recon/contract-library/contracts/math/SafeMath.sol
...
// File: @recon/contract-library/contracts/token/erc20/IERC20.sol
...
// File: @recon/contract-library/contracts/token/erc20/IERC20Mintable.sol
...
// File: @recon/contract-library/contracts/token/erc721/IERC721.sol
...
// File: @recon/contract-library/contracts/token/erc721/IERC721Mintable.sol
...
// File: @recon/contract-library/contracts/util/AddressUtils.sol
...
// File: @recon/contract-library/contracts/token/erc20/ERC20.sol
...
// File: @recon/contract-library/contracts/token/erc20/IERC20Detailed.sol
...
// File: @recon/contract-library/contracts/token/erc20/ERC20Detailed.sol
...
// File: @recon/contract-library/contracts/access/HasAdmin.sol
...
// File: @recon/contract-library/contracts/access/HasMinters.sol
...
// File: @recon/contract-library/contracts/token/erc20/ERC20Mintable.sol
...
// File: contracts/chain/mainchain/WMATIC.sol
...
contract WMATIC is ERC20Detailed {
  ...
  constructor () ERC20Detailed("Wrapped Matic", "WMATIC", 18)
    public
  {}
...
// File: @recon/contract-library/contracts/proxy/ProxyStorage.sol
...
// File: @recon/contract-library/contracts/lifecycle/Pausable.sol
...
contract Registry is HasAdmin {
  ...
  string public constant WMATIC_TOKEN = "WMATIC_TOKEN";
...
contract MainchainGatewayManager is MainchainGatewayStorage {
  ...
  // Should be able to withdraw from WMATIC
  function()
    external
    payable
  {}
  ...
  function depositMatic()
    ...
    returns (uint256)
  {
    return depositMaticFor(msg.sender);
  }
  ...
  function depositMaticFor(address _owner)
    public
    whenNotPaused
    payable
    returns (uint256)
  {
    address _wmatic = registry.getContract(registry.WMATIC_TOKEN());
    WMATIC(_wmatic).deposit.value(msg.value)();
    return _createDepositEntry(_owner, _wmatic, 20, msg.value);
  }
    ...
    onlyMappedToken(_token, 20)
  {
    ...
    if (_token == registry.getContract(registry.WMATIC_TOKEN())) {
      _withdrawMATICFor(_user, _amount);
    } else {
  ...
  {
    address _wmatic = registry.getContract(registry.WMATIC_TOKEN());
    WMATIC(_wmatic).withdraw(_amount);
