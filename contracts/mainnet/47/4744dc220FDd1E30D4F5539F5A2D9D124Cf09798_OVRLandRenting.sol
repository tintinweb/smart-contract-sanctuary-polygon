    ...
    PausableUpgradeable
{
    ...
    function activateNoRentFromHosting(
        ...
        noRentsParams[_address][_nftId] = NoRentParams(2**256 - 1, 12, 12); // TODO DA VALUTARE SE VA BENE COSI
        // prettier-ignore
        ...
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        ...
        /*
		  TODO LASCIAREI LIBERO QUI
		  Se per qualsiasi motivo volessimo disattivare l'hosting cosi almeno possiamo resettare a 0
		*/
    ...
    function placeOfferInternal(
        ...
        // priceOVR = priceOVR >= floorPrice ? priceOVR : floorPrice;
        // feeUSD.div(priceOVR).mul(1e14);
...
// TODO FUNZIONALITA' DI PAUSA, IMPEDIRE DI FARE OFFERTE
