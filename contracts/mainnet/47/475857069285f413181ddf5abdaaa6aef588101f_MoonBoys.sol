...
contract MoonBoys is ERC721, Ownable {
    ...
    constructor() ERC721("Moon Boy", "MOON") {
        _tokenIds.increment();
    }

    modifier isMintable() {
        require(mintable, "Moon Boy: NFT cannot be minted yet.");
        _;
    }

    modifier isPreSaleMintable() {
        require(preSaleMintable, "Moon Boy: NFT cannot be minted yet.");
        _;
    }
    ...
    modifier isNotExceedMaxMintPerTx(uint256 amount) {
        require(
            ...
            "Moon Boy: Mint amount exceeds max limit per tx."
        );
        _;
    }
    ...
    modifier isNotExceedAvailableSupply(uint256 amount) {
        require(
            ...
            "Moon Boy: There are no more remaining NFT's to mint."
        );
        _;
    }
    ...
    modifier isPaymentSufficient(uint256 amount) {
        require(
            ...
            "Moon Boy: There was not enough/extra ETH transferred to mint an NFT."
        );
        _;
    }
    ...
    modifier isAllowList() {
        require(
            ...
            "Moon Boy: You're not on the list for the presale."
        );
        _;
    }
