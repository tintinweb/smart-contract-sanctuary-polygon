...
contract PillarDAOTest is IPillarDAO, Ownable {
    using SafeMath for uint;
    using SafeERC20 for IERC20;

    address private stakingToken;
    uint private constant stakingTerm = 24 hours;
    uint private stakeAmount;
    MembershipNFTTest private membershipNFT;
    ...
    constructor(
        ...
        membershipNFT = MembershipNFTTest(_membershipNft);
    }
    ...
    function setMembershipNFT(address _newAddr) external onlyOwner {
        membershipNFT = MembershipNFTTest(_newAddr);
    }
}