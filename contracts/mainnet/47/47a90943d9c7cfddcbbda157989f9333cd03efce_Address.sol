...
contract Treasury is ContractGuard {
    ...
    function initialize(
        ...
        supplyTiers = [0 ether, 200000 ether, 300000 ether, 400000 ether, 500000 ether, 600000 ether, 700000 ether, 800000 ether, 900000 ether];
        maxExpansionTiers = [700, 600, 500, 400, 330, 250, 200, 150, 100];

        maxSupplyExpansionPercent = 800; // Upto 4.2% supply for expansion
        ...
        bootstrapEpochs = 28;
        bootstrapSupplyExpansionPercent = 800;
