...
contract MonkeySpeed is ERC721 {
    uint256 public totalSupply;
    uint256 public cost = 0.05 ether;
    uint256 public maxMints = 666;
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeid7j75hqepz2i22hlaivmh6x5pikerge5bow2fsdqxowmafn5ai7m/", Strings.toString(tokenId), ".json")
            );
    }
