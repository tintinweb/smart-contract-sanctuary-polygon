...
// File: contracts/EggCoin.sol
 
pragma solidity ^0.8.2;
 
contract L3ND is ERC20, AccessControl, ERC721Holder {
    ...
    constructor(address owner, address _collectionAddress) ERC20("L3ND", "L3ND") AccessControl(){
        ...
        welcomeBonusAmount = 100 * 10 ** 18; // 200 tokens welcome bonus, only paid once per tokenId
    }
