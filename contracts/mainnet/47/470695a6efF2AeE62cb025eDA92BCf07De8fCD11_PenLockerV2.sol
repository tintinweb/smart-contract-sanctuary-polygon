...
/**
 * @title PEN Locking contract
 * @author Convex Finance / Penrose
 * @dev PEN locked in this contract will be entitled to voting rights for the Penrose platform
    ...
    ProxyImplementation
{
     ...
     */
    function initializeProxyStorage(address _rewardsDistributor, IERC20 _pen)
        public
        checkProxyInitialized
    {
        // Re-entrancy guard has a constructor, but that one can be ignored.

        _name = "Vote Locked PEN";
        _symbol = "vlPEN";
