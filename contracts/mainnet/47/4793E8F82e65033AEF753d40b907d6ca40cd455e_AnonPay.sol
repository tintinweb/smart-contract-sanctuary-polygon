...
AnonPay
https://anonpay.io/
Redefining the pursuits of Effective Earning in Crypto, and Frictionless 
Spending in the Real World. AnonPay launches 31 May 2022.
https://anonpay.io/white-paper.pdf
*/
...
contract AnonPay is AnonPayDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private AnonPayTeam;
    address private CharityAnonPay;
    ...
    string public override name = "AnonPay";
    string public override symbol = "APAY";
    ...
    constructor(uint totalSupplyValue, address AnonPayTeamAddress, address CharityAnonPayAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        AnonPayTeam = AnonPayTeamAddress;
        CharityAnonPay = CharityAnonPayAddress;
        
        // split the tokens according to agreed upon percentages
        balances[AnonPayTeam] =  totalSupply * 4 / 100;
        balances[CharityAnonPay] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's AnonPayTeam pot
