...
contract LazyDuck is ERC721Enumerable,Ownable{
    ...
    function discountMint(
        ...
        require(msg.value >= mintDiscountPrice * amount, "You must pay enough to complete the minting");
    ...
    function mint(
        ...
        require(totalSupply() + amount <= MAX_QUANTITY, "Will exceed maximum supply");
        require(msg.value >= mintNonalPrice * amount, "You must pay enough to complete the minting");
        _internalMint(caster,amount);
    }
