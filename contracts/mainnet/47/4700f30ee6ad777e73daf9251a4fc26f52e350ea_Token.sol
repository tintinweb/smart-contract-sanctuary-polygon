...
contract ERC20 is IERC20 {
    ...
    address busd = 0x006715f3A4d54D57d9b24A831e688Da669D59A7c; // live busd
...
contract MSIDog is Token {
    
    uint private startTime = 1663344324;
    ...
    uint8[] private REF_BONUSES             = [100, 50, 30, 20, 10, 10, 10];
    uint private constant ADV_FEE           = 10;                   // Base 1% multipled * 7 = 1% total
    ...
    uint private constant TIME_TO_UNSTAKE   = 30 days;
    uint private constant NEXT_AIRDROP      = 7 days;
    uint private constant BON_AIRDROP       = 5;
    //uint private constant SELL_LIMIT        = 1000 ether; 
    ...
    constructor() public {
        ...
        FIND_1 = 0x9086446fea5b06F5365Ba720F9E7DB4196eED6Fa; // ll 1%
        MAR_1 = 0x9086446fea5b06F5365Ba720F9E7DB4196eED6Fa;  // DESB   1%   
