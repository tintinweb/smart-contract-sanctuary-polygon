 ...
 * @notice This contract handles minting We are SMATY tokens.
 */
contract WeAreSMATY is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xb39225F007706668d62f7574D5cd7EbCC415F5cc;
    address public royaltyAddress = 0x6ae72Fe22f714B231805e8A0ba72A8afe587E9a5;
    address[] public payoutAddresses = [
        0x6ae72Fe22f714B231805e8A0ba72A8afe587E9a5
    ];
    ...
    string public name = "We are SMATY";
    string public symbol = "WEARESMATY";
    ...
    constructor()
        ERC1155(
            "ipfs://bafybeihgecbnctzikjk7a76bnf5kjbxlbb6r7mt7ayq4jttrckho6yqw7y/{id}"
        )
        RevokableOperatorFilterer(
