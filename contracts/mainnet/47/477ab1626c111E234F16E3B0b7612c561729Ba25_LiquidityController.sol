...
contract LiquidityController is TokensRecoverable, ILiquidityController
{
    ...
    constructor(address _dev, IPancakeRouter02 _pancakeRouter, IERC20 _base, IERC20 _rooted, IERC31337 _elite, IFloorCalculator _calculator, RootedTransferGate _gate) 
    {
        dev = _dev;
        ...
        gate = _gate;
        liquidityControllers[_dev] = true;
    ...
    {
        require(liquidityControllers[msg.sender] || msg.sender == dev, "Not a Liquidity Controller");
        _;
    }

    // Owner function to enable other contracts or addresses to use the Liquidity Controller
    function setLiquidityController(address controlAddress, bool controller) public liquidityControllerOnly()
    {
        liquidityControllers[controlAddress] = controller;
    }

    function setCalculatorAndGate(IFloorCalculator _calculator, RootedTransferGate _gate) public liquidityControllerOnly()
    {
        calculator = _calculator;
        gate = _gate;
    }
