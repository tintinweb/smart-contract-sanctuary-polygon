...
contract Meta_Tiger_S6DAI is Ownable {
    ...
    constructor(address ownerAddress, address _token) public {
         levelPrice[1] = 3 * ( 10  ** 18 );
         levelPrice[2] = 6 * ( 10  ** 18 );
         levelPrice[3] = 12 * ( 10  ** 18 );
         levelPrice[4] = 24 * ( 10  ** 18 );
         levelPrice[5] = 48 * ( 10  ** 18 );
         levelPrice[6] = 96 * ( 10  ** 18 );
         levelPrice[7] = 192 * ( 10  ** 18 );
         levelPrice[8] = 384 * ( 10  ** 18 );
         levelPrice[9] = 768 * ( 10  ** 18 );
         levelPrice[10] = 1536 * ( 10  ** 18 );
         levelPrice[11] = 3072 * ( 10  ** 18 );
         levelPrice[12] = 6144 * ( 10  ** 18 );  
    ...
    function sendETHDividends(address userAddress, address _from, uint8 matrix, uint8 level, bool pay) private {
       ...
       if(pay==false)
       {
            if (!tokenDai.transferFrom(msg.sender, receiver, levelPrice[level])) {
            tokenDai.transferFrom(msg.sender, owner, levelPrice[level]);
        }
       }
       else{
    ...
    function sendETHDividendsskip(address userAddress, address _from, uint8 matrix, uint8 level) private {
       ...
       // }
        ...
        if (!tokenDai.transferFrom(msg.sender, address(this), levelPrice[level])) {
        tokenDai.transferFrom(msg.sender, owner, levelPrice[level]);
        }
