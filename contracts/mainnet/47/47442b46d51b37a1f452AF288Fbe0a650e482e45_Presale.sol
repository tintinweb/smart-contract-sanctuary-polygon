...
contract Presale is Ownable, VRFConsumerBaseV2 {
  ...
  address payable presale;
  address payable chainLinkRDKFeeAddress;

  // Events
  event MysteryBoxBought(address indexed user, uint _mBoxType, string referral, uint price);
  event MysteryBoxToBeOpened(address indexed user, uint mysteryBoxId);
    ...
    Ownable()   
  {
    ...
    presale = payable(_presaleAddress);
    ...
    chainlinkFeeMatic = 6000; // TODO: to be updated60000000000000000
    ...
    mysteryBoxTypeLimit[MBoxTypeTop.SP] = 15000;
    // typeMidToTop init
    ...
    // riders Base URIs init First uint is number of pizzas to deliver (nft rareness)
    // riders Base URIs init second uint is image rareness --> (0 = common, 1 = rare, 2 = very rare)
    ridersBaseURI[2] = "ipfs//:bafybeif5ihn3whs2jsddsomiq6kygoyfa54jpiaau4erql2lgnqvfztrki"; // "ipfs://QmdmfDUjqDntPhV1UVwpa6PWreryFeKQcyyZDPacGM2SAd/Rare/common"; // "rare nft common image";
    ...
    ridersBaseURI[4] = "ipfs//:bafybeigs3kttnnfukldj7a6efczmilgmfumtmruq5l7qw2es7jj3yu5y44"; // "ipfs://QmdmfDUjqDntPhV1UVwpa6PWreryFeKQcyyZDPacGM2SAd/Legendary/very rare";
    ridersBaseURI[5] = "ipfs//:bafybeieyebpjmjtfvdab7qkb5fjnsa4ryhoafencksdvya27dqczkmz5li"; // "ipfs://QmdmfDUjqDntPhV1UVwpa6PWreryFeKQcyyZDPacGM2SAd/Mythical/very rare";
    ridersBaseURI[10] = "ipfs//:bafybeigwn3pzttl2kcxpuj6qmblixxychl5sxeypeelzi6o2mq5jqwkjr4"; // "ipfs://QmdmfDUjqDntPhV1UVwpa6PWreryFeKQcyyZDPacGM2SAd/Special/very rare";

    // Riders image URI
    ridersImageURI[2] = "ipfs//:bafybeif5ihn3whs2jsddsomiq6kygoyfa54jpiaau4erql2lgnqvfztrki"; // "ipfs://QmdmfDUjqDntPhV1UVwpa6PWreryFeKQcyyZDPacGM2SAd/Rare/common"; // "rare nft common image";
    ...
    ridersImageURI[10] = "ipfs//:bafybeigwn3pzttl2kcxpuj6qmblixxychl5sxeypeelzi6o2mq5jqwkjr4"; // "ipfs://QmdmfDUjqDntPhV1UVwpa6PWreryFeKQcyyZDPacGM2SAd/Special/very rare";
    ...
    baseURILength["ipfs//:bafybeigwn3pzttl2kcxpuj6qmblixxychl5sxeypeelzi6o2mq5jqwkjr4"] = 1000;// TODO: to be updated with real values"

    // ridersBaseURI[2][0] = "rare nft common image"; // TODO: update with real value
    // ridersBaseURI[2][1] = "rare nft rare image";
    // ridersBaseURI[2][2] = "rare nft very rare image";
    // ridersBaseURI[3][0] = "epic nft common image";
    // ridersBaseURI[3][1] = "epic nft rare image";
    // ridersBaseURI[3][2] = "epic nft very rare image";
    // ridersBaseURI[4][0] = "legendary nft common image";
    // ridersBaseURI[4][1] = "legendary nft rare image";
    // ridersBaseURI[4][2] = "legendary nft very rare image";
    // ridersBaseURI[5][0] = "mythical nft common image";
    // ridersBaseURI[5][1] = "mythical nft rare image";
    // ridersBaseURI[5][2] = "mythical nft very rare image";
    // ridersBaseURI[10][0] = "special nft common image";
    // ridersBaseURI[10][1] = "special nft rare image";
    // ridersBaseURI[10][2] = "special nft very rare image";
    
    // ridersImageURI[2][0] = "image: rare nft common image"; // TODO: update with real value
    // ridersImageURI[2][1] = "image: rare nft rare image";
    // ridersImageURI[2][2] = "image: rare nft very rare image";
    // ridersImageURI[3][0] = "image: epic nft common image";
    // ridersImageURI[3][1] = "image: epic nft rare image";
    // ridersImageURI[3][2] = "image: epic nft very rare image";
    // ridersImageURI[4][0] = "image: legendary nft common image";
    // ridersImageURI[4][1] = "image: legendary nft rare image";
    // ridersImageURI[4][2] = "image: legendary nft very rare image";
    // ridersImageURI[5][0] = "image: mythical nft common image";
    // ridersImageURI[5][1] = "image: mythical nft rare image";
    // ridersImageURI[5][2] = "image: mythical nft very rare image";
    // ridersImageURI[10][0] = "image: special nft common image";
    // ridersImageURI[10][1] = "image: special nft rare image";
    // ridersImageURI[10][2] = "image: special nft very rare image";

    // // Number of NFT images per image rareness
    
    // baseURILength["rare nft common image"] = 1000;// TODO: to be updated with real values
    // baseURILength["rare nft rare image"] = 1000;// TODO: to be updated with real values
    // baseURILength["rare nft very rare image"] = 1000;// TODO: to be updated with real values
    // baseURILength["epic nft common image"] = 1000;// TODO: to be updated with real values
    // baseURILength["epic nft rare image"] = 1000;// TODO: to be updated with real values
    // baseURILength["epic nft very rare image"] = 1000;// TODO: to be updated with real values
    // baseURILength["legendary nft common image"] = 1000;// TODO: to be updated with real values
    // baseURILength["legendary nft rare image"] = 1000;// TODO: to be updated with real values
    // baseURILength["legendary nft very rare image"] = 1000;// TODO: to be updated with real values
    // baseURILength["mythical nft common image"] = 1000;// TODO: to be updated with real values
    // baseURILength["mythical nft rare image"] = 1000;// TODO: to be updated with real values
    // baseURILength["mythical nft very rare image"] = 1000;// TODO: to be updated with real values
    // baseURILength["special nft common image"] = 1000;// TODO: to be updated with real values
    // baseURILength["special nft rare image"] = 1000;// TODO: to be updated with real values
    // baseURILength["special nft very rare image"] = 1000;// TODO: to be updated with real values
    ...
    riderQuantityToChainLinkFee[1]  = 1000; // TODO: TO BE UPDATED 72240400000000000;  
    riderQuantityToChainLinkFee[2]  = 1000; // TODO: TO BE UPDATED 79845200000000000;
    riderQuantityToChainLinkFee[3]  = 1000; // TODO: TO BE UPDATED 96452800000000000;
    riderQuantityToChainLinkFee[4]  = 1000; // TODO: TO BE UPDATED 119051400000000000;
    riderQuantityToChainLinkFee[5]  = 1000; // TODO: TO BE UPDATED 129655000000000000;
    riderQuantityToChainLinkFee[6]  = 1000; // TODO: TO BE UPDATED 146257000000000000;
    riderQuantityToChainLinkFee[7]  = 1000; // TODO: TO BE UPDATED 162867000000000000;
    riderQuantityToChainLinkFee[8]  = 1000; // TODO: TO BE UPDATED 179472600000000000;
    riderQuantityToChainLinkFee[9]  = 1000; // TODO: TO BE UPDATED 196075000000000000;
    riderQuantityToChainLinkFee[10] = 1000; // TODO: TO BE UPDATED 215692400000000000;
    riderQuantityToChainLinkFee[11] = 1000; // TODO: TO BE UPDATED 232296800000000000;
    riderQuantityToChainLinkFee[12] = 1000; // TODO: TO BE UPDATED 254902200000000000;
    riderQuantityToChainLinkFee[13] = 1000; // TODO: TO BE UPDATED 265509200000000000;
    riderQuantityToChainLinkFee[14] = 1000; // TODO: TO BE UPDATED 279112200000000000;
    riderQuantityToChainLinkFee[15] = 1000; // TODO: TO BE UPDATED 295724600000000000;
    ...
    recipeQuantityToChainLinkFee[2]  = 1000; // TODO: to be updated  63239600000000000;
    recipeQuantityToChainLinkFee[3]  = 1000; // TODO: to be updated  71541400000000000;
    recipeQuantityToChainLinkFee[4]  = 1000; // TODO: to be updated  88855600000000000;
    recipeQuantityToChainLinkFee[5]  = 1000; // TODO: to be updated  88148000000000000;
    recipeQuantityToChainLinkFee[6]  = 1000; // TODO: to be updated  99456200000000000;
    recipeQuantityToChainLinkFee[7]  = 1000; // TODO: to be updated  107753400000000000;
    recipeQuantityToChainLinkFee[8]  = 1000; // TODO: to be updated  128055600000000000;
    recipeQuantityToChainLinkFee[9]  = 1000; // TODO: to be updated  121354400000000000;
    recipeQuantityToChainLinkFee[10] = 1000; // TODO: to be updated  129662200000000000;
    recipeQuantityToChainLinkFee[11] = 1000; // TODO: to be updated  137961200000000000;
    recipeQuantityToChainLinkFee[12] = 1000; // TODO: to be updated  146259400000000000;
    recipeQuantityToChainLinkFee[13] = 1000; // TODO: to be updated  154566600000000000;
    recipeQuantityToChainLinkFee[14] = 1000; // TODO: to be updated  162867000000000000;
    recipeQuantityToChainLinkFee[15] = 1000; // TODO: to be updated  174167200000000000;
  }
  ...
  function buyMysteryBox (uint _mBoxType, string memory _referral) external payable {
    ...
    mysteryBoxTypeCounter[typeBotToTop[MBoxTypeBot(_mBoxType)]] += getTypeQuantity(_mBoxType);
    ...
    presale.transfer(mysteryBoxPriceMatic - mysteryBoxPriceMatic/2);
    ...
    // Event emitted
    emit MysteryBoxBought(msg.sender, _mBoxType, _referral, mysteryBoxPriceMatic);
  }
    ...
    internal override 
  {
    ...
    emit MysteryBoxToBeOpened(user, _mysteryBoxId);
  }
  ...
  function getMysteryBoxIdToTopTypeRider(address _user, uint _mysteryBoxId) external view returns (uint _riderTopType) {
    TypeCounter memory presaleTypes = presaleCounter[_user][_mysteryBoxId];
    _riderTopType = uint(typeMidToTop[MBoxTypeMid(presaleTypes.riderMidType)]);
  }

  function getMysteryBoxIdToTopTypeRecipe(address _user, uint _mysteryBoxId) external view returns (uint _recipeTopType) {
    TypeCounter memory presaleTypes = presaleCounter[_user][_mysteryBoxId];
    _recipeTopType = uint(typeMidToTop[MBoxTypeMid(presaleTypes.recipeMidType)]);
  }
