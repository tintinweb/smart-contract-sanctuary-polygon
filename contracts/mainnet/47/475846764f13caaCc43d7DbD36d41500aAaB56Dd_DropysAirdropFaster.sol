...
// File: contracts/DropysAirdropFaster.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract DropysAirdropFaster is 
    ERC1155,
    Ownable, 
    Pausable, 
    ERC1155Supply, 
    ...
    Allowlist
{
    ...
    string public name = "Dropys  Airdrop Faster";
    string public symbol = "DropysAirdropFaster";
    ...
    */
    ...
    function contractURI() public pure returns (string memory) {
      return "ipfs://bafyreiaxwwdrnm5pvase64jyqcnvnenzij6gkd35ccomctrcsfgcay3t3u/metadata.json";
    }
