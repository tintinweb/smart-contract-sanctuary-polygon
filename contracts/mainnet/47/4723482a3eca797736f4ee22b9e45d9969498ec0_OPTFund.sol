...
contract OPTFund is Ownable, ReentrancyGuard {
    ...
    uint256 public discountPercent = 3000;
    ...
    function redeemDiscount() public nonReentrant {
        ...
        uint256 realOPT3Price = currentOPT3Price.div(priceDivisor);

        uint256 dcDivPrice = discountBought.div(realOPT3Price);

        uint256 amountToSend = dcDivPrice.add(dcDivPrice.mul(discountPercent).div(percentRate));
