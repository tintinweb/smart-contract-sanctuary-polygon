...
contract fudere is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x60ead0Bd36796463136bf80687d6653A7f0d5fd6); 
    address payable public Wallet_Dev = payable(0x57772f15E3A05319E2fa6780ee9192A13FC396Fd);
    ...
    string private constant _name = "fuder"; 
    string private constant _symbol = unicode"fuder"; 
