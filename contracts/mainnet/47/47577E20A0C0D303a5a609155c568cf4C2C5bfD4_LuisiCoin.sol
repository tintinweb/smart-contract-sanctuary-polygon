...
contract LuisiCoin is ERC20, Ownable, CuratedByToken("1.0"), FeeProcessor{
constructor(address payable feeReceiver_) 
        payable 
        ERC20("LuisiCoin", "LUIGI")
        FeeProcessor(feeReceiver_){
            // Tokenomics
            //Owner
            _mint(0x2F1bd2D825862d3fA6f2824C17F68B5e08971309,  21000000* 10 ** decimals());
