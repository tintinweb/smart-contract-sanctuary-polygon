...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0xaEA392E894186cC86d1264a0581b6247bDD40aDC,0x5d33792EE709682fdD91924163d520238045445b,0x10484efCb02F7C06414c516D73477264771312D8,0x02c726254CACBD82245040F2039db252A6D92387];
  address public erc20Payable = 0xaEA392E894186cC86d1264a0581b6247bDD40aDC;
  uint256[] public payableFees = [2,48,20,10,20];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 50, 2920) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeidyluumkb7njyytsrve3vywgt5uwcn25d7doviar32yfxd3fs4oj4/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/KD1sszrnB5PSUBz0SJFP/contract-metadata";
  }
...
// File: contracts/PepeMusicNftThemeSongContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PepeMusicNftThemeSongContract is ERC721APlus {
    constructor() ERC721APlus("PEPE Music NFT Theme Song", "PEPE"){}
}
  /*******************************************************/
  /*                                                     */
