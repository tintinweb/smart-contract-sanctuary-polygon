 ...
 */
contract ChicADeesPolygon is IERC721A, Ownable {
    ...
    constructor() {
     ...
     function mint(uint16 _count, address _to) public payable {
        ...
        require(total + _count <= maxChics, "Max limit");
    ...
    function websiteMint(uint16 _count, uint256 _nonce, bytes memory _sig) public payable {
        ...
        require(totalAfter <= maxChics, "Max total limit");
        if(saleOn != true) {
    ...
    */
    ...
    function setMaxChics(uint256 _max) public onlyOwner {
        maxChics = _max;
    }
