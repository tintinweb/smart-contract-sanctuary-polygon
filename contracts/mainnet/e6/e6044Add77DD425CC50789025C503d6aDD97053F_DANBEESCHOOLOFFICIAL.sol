...
abstract contract NFTStandard is
    ...
    */
     ...
     /**
     * UPDATE: Initialize DefaultOperatorFiltererUpgradeable in constructor
     * following this format. After making NFTStandard upgradable, the 
     * initialization would be moved to initialize() along with it.
     */
    constructor(
        string memory _name,
        string memory _symbol,
        string memory _contractUri
    ) ERC721(_name, _symbol) initializer {
    ...
    */
    ...
    // UPDATE: a set of ERC721 functions added modifiers from OpenSea making the Contract Royalty configurable in their marketplace
...
contract DANBEESCHOOLOFFICIAL is NFTStandard {
