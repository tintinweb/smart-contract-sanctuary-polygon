...
// File: contracts/tpa_airdrop_nc.sol


// prepared with love by WiggleWork.eth

pragma solidity >=0.7.0 <0.9.0;



contract tpa_airdrop_nc is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public nftPerAddressLimit = 555;
  ...
  function withdraw() public payable onlyOwner {
    ...
    // =============================================================================
    //(bool hs, ) = payable(0x785c49Be9AC1c552d3615e0eA826cc443A6C36Dc).call{value: address(this).balance * 10 / 100}("");
