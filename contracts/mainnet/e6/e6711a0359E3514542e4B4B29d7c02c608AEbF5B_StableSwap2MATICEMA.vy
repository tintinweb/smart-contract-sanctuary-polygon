...
@dev ERC20 support for return True/revert, return True/False, return None
     Uses native Matic as coins[0] and can rebase ERC20
"""
...
MATIC_ADDR: constant(address) = 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE
...
oracle_method: public(uint256)  # Only for one coin which is not MATIC
...
def initialize(
    ...
    # additional sanity checks for MATIC configuration
    assert _coins[0] == MATIC_ADDR
