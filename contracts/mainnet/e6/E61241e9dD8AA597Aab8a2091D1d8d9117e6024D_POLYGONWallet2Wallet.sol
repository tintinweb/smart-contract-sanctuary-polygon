...
import './POLYGONFeeLogic.sol';


contract POLYGONWallet2Wallet is Wallet2Wallet {
    ...
    internal override returns(uint, uint _referralFee, address _referrer) {
        ...
        if (_fee > 0 && !POLYGONFeeLogic.buybackWithUniswap(_token, _fee, _feeSwapPath, _feeOutMin, buyBacker)) {
...
library POLYGONFeeLogic {
    using SafeERC20 for IERC20;

    IERC20 constant internal USDT = IERC20(0xc2132D05D31c914a87C6611C10748AEb04B58e8F);
    IERC20 constant internal WMATIC = IERC20(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270);
    IERC20 constant ETH = IERC20(0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE);
    IUniswapV2Router02 constant internal ROUTER = IUniswapV2Router02(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff);
    IUniswapV2Factory constant internal FACTORY = IUniswapV2Factory(0x5757371414417b8C6CAad45bAeF941aBc7d3Ab32);
    ...
    function buybackWithUniswap(
        ...
        if (_token == ETH) {
            (bool result, ) = payable(address(WMATIC)).call{value: _amountToSwap}('');
            if (!result) {
                return false;
            }
            _token = WMATIC;
