...
// File: UNISWAP_LiquidityExamples/UniswapV3Liquidity.sol


pragma solidity ^0.8.17;
//0xe00b6940FEffB67dCC82e0d625eC5Dc883Bc07a1 uniswap v3 liquidity
...
contract UniswapV3Liquidity is IERC721Receiver {
   ...
   INonfungiblePositionManager posMan = INonfungiblePositionManager(0xC36442b4a4522E871399CD717aBDD847Ab11FE88);
        ...
        )
    {
        ...
        uint amount0ToMint = 5000 * 1e18;
        uint amount1ToMint = 5000 * 1e6;

        // Approve the position manager
        TransferHelper.safeApprove(DAI, address(posMan), amount0ToMint);
        TransferHelper.safeApprove(USDC, address(posMan), amount1ToMint);
        ...
        (_tokenId, liquidity, amount0, amount1) = posMan.mint(params);

        // Create a deposit
        //_createDeposit(msg.sender, _tokenId);

        // Remove allowance and refund in both assets.
        if (amount0 < amount0ToMint) {TransferHelper.safeApprove(DAI,address(posMan), 0);
            uint refund0 = amount0ToMint - amount0;
            TransferHelper.safeTransfer(DAI, msg.sender, refund0);
        }

        if (amount1 < amount1ToMint) {TransferHelper.safeApprove(USDC,address(posMan), 0);
        ...
        )
    {
        ...
        TransferHelper.safeApprove(DAI, address(posMan), amountAdd0);
        TransferHelper.safeApprove(USDC, address(posMan), amountAdd1);
        ...
        (liquidity, amount0, amount1) = posMan.increaseLiquidity(params);
    ...
    */
    ...
    function decreaseLiquidity(uint128 liquidity) external returns (uint amount0, uint amount1) {
        ...
        (amount0, amount1) = posMan.decreaseLiquidity(params);
