...
contract STREAMER is ERC20, ERC20Burnable, Ownable, Pausable, TokenRecover {
    ...
    constructor()
        ERC20(unicode"STREAMER", unicode"STREAMER") 
    {
        address supplyRecipient = 0x232d423b9A79b4227f518f189c75e2776eC07E2A;
        
        updateSwapThreshold(50000000 * (10 ** decimals()));

        marketingAddressSetup(0x14Ff3fdBcE9E8FFfB175C7F11b20e00CEb9AfB53);
        ...
        _transferOwnership(0x232d423b9A79b4227f518f189c75e2776eC07E2A);
    }
