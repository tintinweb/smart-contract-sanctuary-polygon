...
contract MetaShibaInu is ERC721AQueryable, ReentrancyGuard, ERC2981, Ownable {
    string private _baseTokenURI;
    uint public maxSupply = 20000;   

    uint public price = 0.15 ether;     // Price need to adjust
    ...
    constructor() ERC721A("MetaShiba Inu", "MSHIB") {}
