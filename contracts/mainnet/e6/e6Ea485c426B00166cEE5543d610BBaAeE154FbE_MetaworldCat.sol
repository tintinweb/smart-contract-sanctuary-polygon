...
contract MetaworldCat is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeiaibxxe7q5udok6irtz2omyh5e3wk3ufzrvdz6c4zsnm7tkjpvjvi/", Strings.toString(tokenId), ".json")
            );
    }
