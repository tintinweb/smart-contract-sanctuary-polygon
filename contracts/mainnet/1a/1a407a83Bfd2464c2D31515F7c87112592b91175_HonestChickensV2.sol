	...
	ERC1155SupplyUpgradeable
{
	...
	function setPrice(MintPriceType _mintPriceType, uint256 _mintPrice) external onlyOwner{
		mintPricePotatoByPriceType[_mintPriceType] = _mintPrice;
	}
