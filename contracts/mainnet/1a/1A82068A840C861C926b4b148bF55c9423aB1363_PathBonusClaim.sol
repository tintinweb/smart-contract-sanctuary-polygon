...
contract PathBonusClaim is Ownable{
    ...
    constructor (address _tokenAddress, address rewardSourceAddress) {
    ...
    */
    function setAllocation(
        ...
        require(token.balanceOf(rewardSource) >= amountToTransfer, "Not enough balance");
    }
    ...
    * @param _recipient recipient of allocation
    ...
    function transferTokens(address _recipient) external {
        ...
        require(token.transferFrom(rewardSource, _recipient, tokensToClaim), "Token transfer failed");
