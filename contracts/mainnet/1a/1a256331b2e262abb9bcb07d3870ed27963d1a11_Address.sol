...
contract NFT is ERC721Enumerable, Ownable {
  ...
  uint256 public maxMintAmount = 200;  // количество нфт которое можно сминтить при 1 транзакции
 ...
 function whitelistUser(address _user) public onlyOwner {
  ...
  function withdraw() public payable onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0xBFBB5AfC8c53424e6d7a15c6e0f2219806d264C3).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
