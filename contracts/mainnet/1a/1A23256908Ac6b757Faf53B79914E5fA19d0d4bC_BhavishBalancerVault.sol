...
contract BhavishBalancerVault is AccessControl, BaseVault {
    ...
    function _performPrediction(
        ...
        bhavishSDK.predict{ value: _predictAmount / 2 }(
            IBhavishSDK.PredictionStruct(assetPair.underlying, assetPair.strike, _roundId, true),
            address(this),
            address(this)
        );
        bhavishSDK.predict{ value: _predictAmount / 2 }(
            IBhavishSDK.PredictionStruct(assetPair.underlying, assetPair.strike, _roundId, false),
            address(this),
            address(this)
        );
    }
