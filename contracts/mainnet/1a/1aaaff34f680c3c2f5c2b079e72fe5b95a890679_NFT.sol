...
contract NFT is ERC721Enumerable, Ownable {
  ...
  uint256 public cost = 0.02 ether;  // тут пишите цену за минт 1 изображения из вашей коллекции
  uint256 public maxSupply = 3000; //тут пишите общее количество нфт в вашей коллекции
