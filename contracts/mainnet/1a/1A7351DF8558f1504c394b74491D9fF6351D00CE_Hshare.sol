...
contract Hshare is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 60,000 Hshare
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 3000 ether;
    uint256 public constant LIQUIDITY_ALLOCATION = 1 ether;
    uint256 public constant BOT_FUND_POOL_ALLOCATION = 400 ether;
    ...
    uint256 public constant MULTIPLIER = 100;
        ...
        function setWhiteList(address _WhiteList, bool exempt) public onlyAdmin {
		whitelist[_WhiteList] = exempt;
    }
        ...
        require(_taxRate <= 10 ,"taxrate has to be between 0% and 10%" );
        taxRate = _taxRate;
    }
    ...
    // tax implemtation end

    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("HeartShare", "HSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 Heart Share Share for initial pools deployment
        ...
        communityFundRewardRate = BOT_FUND_POOL_ALLOCATION.div(VESTING_DURATION);
