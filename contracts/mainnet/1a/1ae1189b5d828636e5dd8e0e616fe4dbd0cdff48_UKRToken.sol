...
contract UKRToken is ERC20("UKR", "UKR"), Ownable {
    using SafeMath for uint256;
    // dev address
    address public constant FEE_ADDRESS = 0xF1e50Fbe71f8aa02BBC93969691beaA9a61A276b;
    
    function mint(address _to, uint256 _amount) public onlyOwner {
        _mint(_to, _amount);
    }
     // @dev overrides transfer function to meet tokenomics of UKR
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        if (sender == FEE_ADDRESS) {
            ...
            require(amount == sendAmount + taxAmount, "UKR::transfer: Tax value invalid");
