...
contract VICEANDBAD is ERC721A, Ownable {
    using Strings for uint256;
    ...
    // URI
    string public baseURI = "https://aarrohan.com/projects/nft-minting-dapps/vice-and-bad/collection/jsons/";
    string public hiddenURI = "https://aarrohan.com/projects/nft-minting-dapps/vice-and-bad/collection/placeholder.json";

    // Costs
    uint256 public whitelistSaleCost = 660 ether;
    uint256 public publicSaleCost = 660 ether;
    ...
    // Constructor
    constructor() ERC721A("VICE AND BAD", "VAB") {}
