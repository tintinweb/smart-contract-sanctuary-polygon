...
import "../../utils/ERC721/ERC721ClaimableV2.sol";
import "../../utils/libs/IERC20.sol";
import "../../utils/uniq/Ierc20.sol";

contract UniqPeacefulGroupies is ERC721ClaimableV2 {
    ...
    event MintTokens(address indexed requester, bytes indexed transactionHash, uint256[] indexed TokenIds, uint256 _networkId, uint256 tokenType);
    ...
    function contractURI() public pure returns (string memory) {
        return "https://uniqly.io/nft-collections/tradeableNFT";
    }
    ...
    // ----- OWNERS METHODS ----- //
    function mintNFTTokens(address _requesterAddress, uint256 _bundleId, uint256[] memory _tokenIds, uint256 _chainId, bytes memory _transactionHash) external onlyOwner{
