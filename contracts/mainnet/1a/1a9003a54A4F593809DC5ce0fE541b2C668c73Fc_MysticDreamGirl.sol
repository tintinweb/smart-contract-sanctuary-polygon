// SPDX-License-Identifier: MIT
    ...
    contract MysticDreamGirl is ERC721, Ownable, ERC721Enumerable {
      using SafeMath for uint256;
      using Strings for uint256;
    
      uint256 public constant tokenPrice = 200000000000000000000; // 100 ether
      uint256 public constant maxTokenPurchase = 7;
      uint256 public constant MAX_TOKENS = 12345;
      ...
      uint256 public presaleMaxMint = 25;
      uint256 public devReserve = 123;
    
      event MdgMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("MysticDreamGirl", "MDG") {}
      ...
      function mintMdg(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit MdgMinted(id, msg.sender);
          }
        }
      }
    
      function presaleMdg(uint256 numberOfTokens) external payable {
