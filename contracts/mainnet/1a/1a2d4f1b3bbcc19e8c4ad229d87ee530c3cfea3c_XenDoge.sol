...
contract XenDoge is ERC20Capped, IERC165, IBurnRedeemable { 
    address public constant XEN_ADDRESS = 0x2AB0e9e4eE70FFf1fB9D67031E44F6410170d00e;

    constructor() ERC20("XTEST", "XTEST") ERC20Capped(150000042069000000000000000000) {}
    ...
    function onTokenBurned(address user, uint256 amount) external {
        require(_msgSender() == XEN_ADDRESS, "XENDogecoin: Caller must be XEN Crypto.");
        require(user != address(0), "XENDogecoin: Address cannot be the 0 address.");

        _mint(user, amount);
        emit Redeemed(user, XEN_ADDRESS, address(this), amount, amount);
    }
