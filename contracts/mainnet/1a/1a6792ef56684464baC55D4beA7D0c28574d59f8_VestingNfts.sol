...
// File contracts/VestingNfts.sol
...
contract VestingNfts is Ownable, ReentrancyGuard{
    ...
    */
    function createVestingSchedule(
        ...
        public {
            require(_roles.hasRole(_roles.getHashRole("ICO_ADDRESS"),msg.sender) || _roles.hasRole(DEFAULT_ADMIN_ROLE,msg.sender),"Caller is not crowdsale contract nor the owner");
        require(
