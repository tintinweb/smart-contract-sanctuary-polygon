...
contract BorrowedNFT is IRewardsSplitter, ERC721 {
    ...
    constructor(address _rentalProtocol, address _originalNFT) ERC721("Borrowed NFT", "vNFT") {
...
interface IRentalProtocol {
    ...
    event RentalEnded(address indexed maker, address indexed taker, address token, uint256 tokenId);
...
contract LentNFT is ERC721 {
    ...
    constructor(address _rentalProtocol, address _originalNFT) ERC721("Lent NFT", "aNFT") {
        rentalProtocol = _rentalProtocol;
        originalNFT = ERC721(_originalNFT);
    }
