...
abstract contract ImmutablePeripheryStorage {
  ...
  constructor(address _factory, address _WETH) {
    ...
    poolImpl = IFactory(_factory).poolImpl();
  }
}
...
abstract contract LiquidityHelper is IMintCallback, RouterTokenHelper {
  ...
  function _getPool(
    ...
    return IPool(PoolAddress.computeAddress(factory, tokenA, tokenB, fee, poolImpl));
  }
}
...
library PoolAddress {
  ...
  /// @param poolImpl implementation address of pool contract
