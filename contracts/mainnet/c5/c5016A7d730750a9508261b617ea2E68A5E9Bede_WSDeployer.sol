...
contract WearablesStorage is ERC721Holder, AccessControlEnumerable, EIP712MetaTransaction("Golfcraft Storage","3") {
    ...
    function setCollectionName(string memory _collectionName) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, msgSender()), "WearablesStorage: Sender should be admin");
...
contract WSDeployer is ERC721Holder, AccessControlEnumerable, EIP712MetaTransaction("Golfcraft Deployer","3") {
    ...
    function deployWearablesStorage(string memory _collectionName) public returns (address) {
        require(hasRole(DEFAULT_ADMIN_ROLE, msgSender()), "WSDeployer: Sender should be admin");

        WearablesStorage newc = new WearablesStorage(_collectionName, msgSender());
    ...
    function sendNFT(address _contract, address to) public {
        require(hasRole(MINTER_ROLE, msgSender()), "WSDeployer: Sender should be minter");
