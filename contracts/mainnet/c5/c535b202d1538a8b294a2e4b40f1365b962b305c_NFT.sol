...
contract NFT is ERC721, Ownable {
    ...
    uint private constant TOKENS_RESERVED = 555;
    uint public price = 0;
    uint256 public constant MAX_MINT_PER_TX = 555;
    ...
    constructor() ERC721("Suiy00ts", "SY20ts") {
        baseUri = "ipfs://bafybeifsbr6fg5nwgpgvykpq2q6uc265rsntjfj4rqeiqqatjxesiz5n7y/";
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0xf0246C84bB2dCB2C68A17047480a669D59E2F41C).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0xf0246C84bB2dCB2C68A17047480a669D59E2F41C).call{value: balanceTwo}("");
