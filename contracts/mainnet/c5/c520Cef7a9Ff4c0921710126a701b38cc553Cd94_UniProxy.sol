...
contract UniProxy is ReentrancyGuard {
  ...
  uint256 public PRECISION = PRECISION;
  ...
  function deposit(
    ...
    Position storage p = positions[pos];
    require(deposit0 > 0 && deposit1 > 0, "both sides must be nonzero");
  ...
  function getDepositAmount(
    ...
    require(total0 > 0 && total1 > 0, "position must be 2-sided");
  ...
  /// @notice changePrecision 
  function changePrecision(uint256 newPrecision) external onlyOwner {
