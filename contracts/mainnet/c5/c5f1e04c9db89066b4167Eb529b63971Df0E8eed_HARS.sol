...
contract HARS is HARSDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private HARSTeam;
    address private CharityHARS;
    ...
    string public override name = "Home Mars";
    string public override symbol = "HARS";
    ...
    constructor(uint totalSupplyValue, address HARSTeamAddress, address CharityHARSAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        HARSTeam = HARSTeamAddress;
        CharityHARS = CharityHARSAddress;
        
        // split the tokens according to agreed upon percentages
        balances[HARSTeam] =  totalSupply * 4 / 100;
        balances[CharityHARS] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's HARSTeam pot
