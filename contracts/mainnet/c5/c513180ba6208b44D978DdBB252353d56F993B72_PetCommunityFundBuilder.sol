...
// File: PetCommunityFundBuilder.sol

/**
 * @title Pet Community Fund Dynamic Content Contract
 */
contract PetCommunityFundBuilder is ReliefDAOBuilder {
    constructor(INominator _tokens, IReliefDaoOracle _oracle)
        ReliefDAOBuilder(_tokens, _oracle)
    {}

    function _initDefaults() internal override {
        regularURL = "http://petcommunityfund.io/";
        nominationURL = "http://petcommunityfund.io/nominate";

        logoElement
            .dPath = "M67.901,37.047c0,5.362-.894,10.285-2.681,14.769-1.788,4.485-4.299,8.346-7.536,11.583-3.237,3.237-7.132,5.75-11.684,7.537-4.552,1.788-9.61,2.681-15.174,2.681H2.955V.477H30.825c5.564,0,10.622,.903,15.174,2.706,4.552,1.805,8.447,4.317,11.684,7.537,3.237,3.221,5.749,7.073,7.536,11.558,1.787,4.485,2.681,9.408,2.681,14.769Zm-13.96,0c0-4.013-.531-7.612-1.593-10.799-1.062-3.187-2.597-5.884-4.603-8.093-2.007-2.208-4.435-3.903-7.284-5.083-2.85-1.18-6.062-1.77-9.636-1.77h-14.213V62.792h14.213c3.574,0,6.786-.589,9.636-1.77,2.849-1.18,5.277-2.875,7.284-5.083,2.006-2.208,3.541-4.906,4.603-8.093,1.062-3.186,1.593-6.785,1.593-10.799Z";
        logoElement
            .aPath = "M138.294,73.616h-10.521c-1.181,0-2.142-.295-2.883-.885-.742-.59-1.298-1.323-1.669-2.2l-5.463-14.921h-30.298l-5.463,14.921c-.27,.776-.793,1.484-1.568,2.125-.776,.641-1.737,.961-2.883,.961h-10.622L95.705,.477h13.859l28.73,73.14Zm-24.026-27.617l-8.902-24.329c-.439-1.079-.894-2.36-1.366-3.844-.473-1.483-.945-3.085-1.416-4.805-.439,1.72-.894,3.331-1.366,4.831-.473,1.501-.928,2.807-1.366,3.92l-8.852,24.228h23.267Z";
        logoElement
            .oPath = "M172.198,0c-20.783,0-37.63,16.848-37.63,37.63s16.848,37.63,37.63,37.63,37.63-16.848,37.63-37.63S192.981,0,172.198,0Zm8.077,29.586c.298-3.487,2.494-6.04,4.904-5.701s4.122,3.44,3.824,6.927-2.494,6.04-4.904,5.701c-2.41-.339-4.122-3.44-3.824-6.927Zm-8.238-11.642c2.268-.563,4.926,2.075,5.936,5.891,1.01,3.816-.01,7.366-2.278,7.929-2.268,.563-4.926-2.075-5.936-5.892-1.01-3.816,.01-7.366,2.278-7.929Zm-11.634,4.542c2.022-1.175,5.164,.578,7.019,3.915,1.855,3.337,1.72,6.994-.302,8.169-2.022,1.175-5.164-.578-7.019-3.915-1.855-3.337-1.72-6.994,.302-8.169Zm3.447,22.056c-1.625,1.713-4.905,1.05-7.325-1.482-2.42-2.532-3.065-5.973-1.44-7.686s4.905-1.05,7.325,1.482c2.42,2.532,3.065,5.973,1.44,7.686Zm22.104,6.367c-5.901,1.221-8.485,1.1-11.78,4.688-3.295,3.587-11.239,.267-8.518-7.109,.676-1.833,1.769-3.235,2.184-4.681,1.271-4.437,.55-7.377,4.508-8.912,5.501-2.134,5.982,4.28,12.341,5.319,5.689,.929,7.173,9.473,1.265,10.696Z";
        logoElement.logoTransform = "translate(330 120) scale(2)";
        logoElement.logoTextY = "320";
        logoElement.logoTextClass = "logo";
        logoElement.logoText = "Pet Community Fund";
        ...
        noNomElement.nomAskLinkText = "http://petcommunityfund.io/nominate";
