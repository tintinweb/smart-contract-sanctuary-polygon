...
contract NFT is Ownable, IERC2981, OERC721R, ONFT721Core {
    ...
    // uint256 public saleStartTimestamp = 1652824800;
    uint256 public whitelistEndTimestamp = 1652911200;
    ...
    //         address owner = _exists(i) ? ownerOf(i) : address(0x0);
...
contract OERC721R is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function flow() public view virtual returns (int256) {
        return _flow;
    }
    
    function totalSupply() public view virtual returns (uint256) {
        return uint256(int256(totalMint()) + flow());
    }
    ...
    function _mintRandom(address to, uint _numToMint) internal virtual {
        ...
        require(_numAvailableTokens >= _numToMint);
