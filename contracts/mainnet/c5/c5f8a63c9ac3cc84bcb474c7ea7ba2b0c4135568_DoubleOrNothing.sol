...
contract DoubleOrNothing is ERC721TokenReceiver, Ownable, randoms {
    ...
    function tryChance10() public payable {
        // require(isContract(msg.sender), "you contract !!!!!!! whate????");
    ...
    function setAmounts(uint256[] memory _amounts, uint256 _gasFeesForLink)
        external
        onlyOwner
    {
    ...
    function _disableBalance5() external onlyOwner {
        if (!balance5Enable) {
    ...
    function _disableBalance10() external onlyOwner {
        if (!balance10Enable) {
    ...
    function _disableBalance25() external onlyOwner {
        if (!balance25Enable) {
    ...
    function _disableBalance50() external onlyOwner {
        if (!balance50Enable) {
    ...
    function _disableBalance100() external onlyOwner {
        if (!balance100Enable) {
