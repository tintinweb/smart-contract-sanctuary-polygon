...
contract CAKP is ERC20Base, ReentrancyGuard {
    uint256 maxSupply = 200000000 * (10 ** uint256(decimals())); //maximum amount of tokens that can be minted 1,000,000,000

    constructor() payable ERC20Base("CAKP", "CAKP") {
