...
contract ContractName is ERC721, PaymentSplitter {
    uint256 public totalSupply;
    uint256 private cost = 300 ether;
    ...
    constructor(address[] memory _payees, uint256[] memory _shares)
        ERC721("My Nft Collection name bisz", "nemlesz")
    ...
    function mint() external payable {
        ...
        if (totalSupply + 1 > 3) revert SoldOut();
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked(
                    "ipfs://QmVfPHr9dVVzTopjRZ6KGLh6cwkqP9PhnosCpgcWu3zCwk/",
