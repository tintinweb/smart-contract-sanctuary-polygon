    ...
    TransactionFee
{
        ...
        returns (uint256 tokenAmount)
    {
        ...
        uint256 COPtoUSD = tokenSendDLY * uint256(getLatestPriceCOPUSD());
    ...
    TransactionFee
{
        ...
        returns (uint256 tokenAmount)
    {
        ...
        // @dev log the  operation
        require(historyPerSell(tokenAmountToSell), "failed to save record");
    ...
    TransactionFee
{
        ...
        returns (uint256 tokenAmount)
    {
        ...
        // @dev log the operation
        require(historyPerBuy(amountToBuyDLY), "failed to save record");
        ...
        returns (uint256 tokenAmount)
    {
        ...
        // @dev log the operation
        require(historyPerBuy(tokenAmountToSell), "failed to save record");
    ...
    TransactionFee
{
        ...
        returns (uint256 tokenAmount)
    {
        ...
        // @dev log the operation
        require(historyPerBuy(amountToBuy), "failed to save record");
