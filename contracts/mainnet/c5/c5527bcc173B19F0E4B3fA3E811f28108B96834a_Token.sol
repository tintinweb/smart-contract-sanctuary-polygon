...
contract Token is ERC20, Ownable {
    ...
    constructor() ERC20("TOKEN", "TOKEN") {
        ...
        maxWallet = (totalSupply * 1 / 100) + (1 * 1e18); // 2% maxWallet
        ...
        feeWallet = address(0xbe3669A8680aCc2e17f9d837d93D2c998f34DAed); // set as fee wallet
    ...
    function updateBuyFees(uint256 _buyTotalFees) external onlyOwner {
        ...
        require(buyTotalFees <= 40, "Must keep total buy fees at 20% or less");
    }
