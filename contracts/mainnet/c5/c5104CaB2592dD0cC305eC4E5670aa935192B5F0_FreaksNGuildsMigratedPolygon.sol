...
contract FreaksNGuildsMigratedPolygon is Initializable, Controllable, UUPSUpgradeable, OwnableUpgradeable, PausableUpgradeable, ERC721Upgradeable, ERC721EnumerableUpgradeable{
  ...
  //////////////////////////////////////////////////////////////*/ 
    ...
    /** 
        @notice admin function for setting the maximum supply
        @param newMaxSupply new maximum supply of fng tokens
    */
    ...
    */
    function mint(uint256 amount) external whenNotPaused noCheaters{
        require(_currentIndex + amount <= (maxSupply + 1), "max");
