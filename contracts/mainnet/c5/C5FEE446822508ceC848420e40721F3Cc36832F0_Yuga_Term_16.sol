...
contract Yuga_Term_16 is TermBase, ExpressTerms {
    ...
    function term(
        ...
        return
            "<br> IN WITNESS WHEREOF, the parties have duly executed this License as of the Effective Date.<br>\n\n > ${ONCHAIN_PROMISOR_SIGNATURE}\n\n **Yuga Labs, Inc.**\n\n > Licensor <br><br> ${ONCHAIN_OFFERER_SIGNATURE}\n\n > **BAYC ${TOKEN_ID} NFT Holder**\n\n > Licensee\n";
    }
}