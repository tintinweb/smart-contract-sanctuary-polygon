...
contract TheLuckyClub is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("The Lucky Club", "TLC") {
    setHiddenMetadataUri("ipfs://bafybeihgz7mt37rcotrgjsrb3s3ditx54qyb5lbum4bgqbxsditlms752a/hidden.json");
  }
