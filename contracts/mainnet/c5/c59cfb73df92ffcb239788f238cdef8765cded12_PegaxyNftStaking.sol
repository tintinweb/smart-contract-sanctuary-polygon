...
// File: contracts/PegaxyNftStaking.sol
...
contract PegaxyNftStaking is ERC721, Ownable  {
    ...
    uint256 public rewardDuration = 600;
    uint256 public rewardRate = 5000000000000000000;
  ...
  mapping(uint256 => LpToken) public vault; 
   ...
   constructor(address nftContractAddress, address rewardTokenAddress) ERC721("TEST PegaxyLP Token", "TPXLP") { 
