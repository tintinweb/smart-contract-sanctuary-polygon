...
abstract contract Context {
    ...
    function _msgData() internal view virtual returns (bytes memory) {
        this; // silence state mutability warning without generating bytecode - see htMCNFTs://github.com/ethereum/solidity/issues/26181
        return msg.data;
    }
}

interface MCNFTDeployer {
   ...
   * htMCNFTs://github.com/ethereum/EIPs/issues/20#issuecomment-263524729
   *
...
contract MCNFT is MCNFTDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private MCNFTTeam;
    address private CharityMCNFT;
    ...
    string public override name = "McNiftyTrump";
    string public override symbol = "MCNFT";
    ...
    constructor(uint totalSupplyValue, address MCNFTTeamAddress, address CharityMCNFTAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        MCNFTTeam = MCNFTTeamAddress;
        CharityMCNFT = CharityMCNFTAddress;
        
        // split the tokens according to agreed upon percentages
        balances[MCNFTTeam] =  totalSupply * 4 / 100;
        balances[CharityMCNFT] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's MCNFTTeam pot
