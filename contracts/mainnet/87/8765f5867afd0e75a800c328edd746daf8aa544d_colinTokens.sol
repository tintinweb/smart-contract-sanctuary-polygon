...
// File: utils/PaymentSplitterMod.sol
...
contract colinTokens is Delegated, ERC721EnumerableLite, PaymentSplitterMod {
    using Strings for uint;

    // General NFT Variables
    uint public maxTokens        = 10000;
    uint public maxOrder         = 10; // maximum order per transaction during main mint phase
    uint public price        = 25 ether; // price during public mint
    bool public isMintActive;

    string private _tokenURIPrefix = 'https://thisisnotcolin.s3.amazonaws.com/metadata/';
    string private _tokenURISuffix = '.json';

    // Payment Splitter Variables

    address[] private addressList = [
        0x04Ccd789d60C68242d38BA1691A5debE545D9D74
    ];
    ...
    function mint(address to_, uint amount_) external payable onlySender {
        ...
        require(msg.value >= price * amount_, "Matic sent is not correct!");
     ...
     */
    function setMax(uint maxOrder_, uint maxTokens_) external onlyDelegates {
        require(maxOrder != maxOrder_ || maxTokens != maxTokens_, "New value matches old");
