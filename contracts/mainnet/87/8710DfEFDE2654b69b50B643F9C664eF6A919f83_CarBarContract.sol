...
contract AddressItems {
    ...
    function filledCheck(address user, uint32 collectionId, uint32 index) public view returns (bool) {
    ...
    function removeItem(uint32[] storage array, uint32 index) internal {
    ...
    function getFreeId(
        ...
        uint32 collectionId,
        uint32 index
    ) public view onlyFilledFreeIds(user, collectionId, index) returns (uint32) {
        return _addressItems[user][collectionId].freeIds[index];
    }

    function removeFreeId(address user, uint32 collectionId, uint32 index) public {
        ...
        removeItem(addressItem.freeIds, index);
    }
    ...
    function removeFreeIdByTokenId(address user, uint32 collectionId, uint32 tokenId) public {
    ...
    function pushFreeId(address user, uint32 collectionId, uint32 tokenId) public {
    ...
    function transferFreeId(address from, address to, uint32 collectionId, uint32 tokenId) public {
        removeFreeId(from, collectionId, 0);
