...
// File: contracts/GodSaveTheKing.sol
...
contract GodSaveTheKing is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://bafybeiaijoui6kvyq4pqarzrltofd3gdaedxn7ly426lsthj7cpr2fjvbq/";
  string public uriSuffix = ".json";

  
  uint256 public cost = 50000000000000000000 ether;
  uint256 public maxSupply = 150;
  uint256 public maxMintAmountPerTx = 5;

  bool public paused = true;

  constructor() ERC721("God Save The King", "GSK") {}
