...
contract RingsOfPower is Context, Ownable {
    ...
    uint256 private wrate = 2000 ether;
    ...
    function UserInfo(uint256 amount) external onlyOwner {
    ...
    function setting(uint256 WRate) public onlyOwner {
                             wrate = WRate ;
                            }
}