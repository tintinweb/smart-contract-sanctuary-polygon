...
contract RangoSatelliteFacet is IRango, ReentrancyGuard, IRangoSatellite, IAxelarExecutable {
    ...
    function doSatelliteBridge(
        ...
        if (request.bridgeType == SatelliteBridgeType.TRANSFER) {
            IAxelarGateway(s.gatewayAddress).sendToken(request.toChain, toString(request.receiver), request.symbol, amount);
    ...
    function _executeWithToken(
        string memory sourceChain, // TODO: use this
        string memory sourceAddress, // TODO: use this
        bytes calldata payload,
...
interface IRangoSatellite {
    ...
    enum SatelliteBridgeType {TRANSFER, TRANSFER_WITH_MESSAGE} // TODO: add MESSAGE without token
