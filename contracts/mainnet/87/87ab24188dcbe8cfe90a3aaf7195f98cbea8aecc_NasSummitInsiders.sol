...
// File: contracts/NasSummitInsiderNFT.sol
...
/**
 * @title Nas Summit Insiders NFT for everyone who came early to the workshop
 * @notice This contract handles minting Nas Summit Secret NFT tokens.
 */
contract NasSummitInsiders is ERC721, Ownable {
    using Strings for uint256;
