...
contract SpaceStaking is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable, AccessControlEnumerableUpgradeable {
    ...
    function sudoUpdateEffectiveTime(address staker_, uint256 timestamp_)
    public
    onlyRole(DEFAULT_ADMIN_ROLE)
    {
        require(staker_ != address(0x0), "ERR_ADDRESS");
        stakedEffectiveTime[staker_] = timestamp_;
    }
    ...
    public 
    {
        ...
        if (stakedEffectiveTime[sender] == 0) {
            ...
            stakedEffectiveTime[sender] = stakedEffectiveTime[sender] + elapsedTime - (elapsedTime * stakedNftsCount[sender] / count);
        }
