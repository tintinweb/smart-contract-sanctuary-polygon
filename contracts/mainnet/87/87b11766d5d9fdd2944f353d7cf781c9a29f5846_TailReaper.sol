...
contract TailReaper is ERC721, ERC721Enumerable, Ownable {
    constructor() ERC721("4 Tail Reaper", "FTR") {}

    uint256 supply = 0;

    function _baseURI() internal pure override returns (string memory) {return "ipfs://QmPU6bRFeAw7MKT8ZkpFnMew4MekZx3eigihVsPX4dRr6j/";}
