...
contract Yuga_Term_14 is TermBase, ExpressTerms {
    ...
    function term(
        ...
        return
            "vi.  <u>Entire Agreement</u> This License constitutes the entire agreement between the Parties concerning the Mark(s).  The terms of this License may be changed only by agreement of both parties in writing.\n \n ";
    }
}