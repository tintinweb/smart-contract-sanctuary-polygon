...
contract PeggsColl is ERC721 {
    ...
    constructor()
        ERC721("Pixel eggs Collection", "PeggsColl")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeic726ad7c2gkkincofdqg5glgdvlmzr6idvah72o6ebypv7fzkdai/", Strings.toString(tokenId), ".json")
            );
    }
