...
// File: contracts/lib/utils/Roles.sol
...
// File: contracts/lib/interface/IERC721Receiver.sol
...
// File: contracts/lib/utils/Ownable.sol
...
// File: contracts/lib/utils/SignerRole.sol
...
// File: contracts/lib/utils/Counters.sol
...
// File: contracts/lib/contracts/HasSecondarySaleFees.sol
...
// File: contracts/lib/interface/IERC721.sol
...
// File: contracts/lib/interface/IERC721Enumerable.sol
...
// File: contracts/lib/contracts/ERC721.sol
...
// File: contracts/lib/contracts/ERC721Enumerable.sol
...
// File: contracts/lib/contracts/ERC721Base.sol
...
// File: contracts/token/NFT721.sol
...
contract NFT721 is Ownable, SignerRole, IERC721, ERC721Base {
    ...
    event SetTokenURIPrefix(string tokenURIPrefix);
    ...
    function mint(uint256 tokenId,uint256 amount,uint256 nonce, uint8 v, bytes32 r, bytes32 s, Fee[] memory _fees, string memory tokenURI) public {

        require(creatorIndex[msg.sender]==nonce,"nonce have be used!");
        require(isSigner(ecrecover(keccak256(abi.encodePacked("\x19Ethereum Signed Message:\n32", keccak256(abi.encodePacked(this,tokenId,msg.sender,amount,nonce,tokenURI)))), v, r, s)), "owner should sign tokenId");
        _mint(msg.sender, tokenId, _fees);
        creatorIndex[msg.sender] = creatorIndex[msg.sender].add(1);
        _setTokenURI(tokenId, tokenURI);
    }

    function mintTarget(address account,uint256 tokenId,uint256 amount,uint256 nonce, uint8 v, bytes32 r, bytes32 s, Fee[] memory _fees, string memory tokenURI) public {
        require(creatorIndex[account]==nonce,"nonce have be used!");
        require(isSigner(ecrecover(keccak256(abi.encodePacked("\x19Ethereum Signed Message:\n32", keccak256(abi.encodePacked(this, tokenId,account,amount,nonce,tokenURI)))), v, r, s)), "owner should sign tokenId");
        _mint(account, tokenId, _fees);
        creatorIndex[account] = creatorIndex[account].add(1);
        _setTokenURI(tokenId, tokenURI);
    }

    function setTokenURIPrefix(string memory tokenURIPrefix) public onlyOwner {
        _setTokenURIPrefix(tokenURIPrefix);
        emit SetTokenURIPrefix(tokenURIPrefix);
    }
