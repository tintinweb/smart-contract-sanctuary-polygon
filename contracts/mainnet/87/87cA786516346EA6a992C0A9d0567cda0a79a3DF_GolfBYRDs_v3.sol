        ...
        if (!_hasRole[role][account]) {
            revert(
                string(
                    abi.encodePacked(
                        "Permissions: account ",
                        GDStrings.toHexString(uint160(account), 20),
                        " is missing role ",
                        GDStrings.toHexString(uint256(role), 32)
                    )
                )
            );
        }
    ...
    ERC721AUpgradeable
{
    ...
    uint256 private constant MAX_BPS = 20_000;
    ...
    function initialize() external initializer {
        ...
        _defaultAdmin = 0x24B33d5D3D78fA1Fc0c04CBaE1297E1762e4d6DA;
        _name = "GolfBYRDs Flight Launch";
        _symbol = "BYRD";
        _saleRecipient = msg.sender;
        ...
        _setupOwner(0x24B33d5D3D78fA1Fc0c04CBaE1297E1762e4d6DA);

        _setupRole(DEFAULT_ADMIN_ROLE, 0x24B33d5D3D78fA1Fc0c04CBaE1297E1762e4d6DA);
        _setupRole(_minterRole, 0x24B33d5D3D78fA1Fc0c04CBaE1297E1762e4d6DA);
        _setupRole(_transferRole, 0x24B33d5D3D78fA1Fc0c04CBaE1297E1762e4d6DA);
...
//These contracts are based on the ThirdWeb OpenSource Repo
