...
/**
 * https://obot.games
 * Contract for WL invitation only! Created by O-bot team for marketing purposes.
 * Discord https://discord.gg/5uw3kxJW43
 * Welcome to 3D O-Bot Fighting Club
 * The ultimate play-to-earn gaming battleground.
 * Mint your 3D NFT Avatar, join the O-Verse and start earning by fighting online.
*/
...
abstract contract Ownable is Context {
    ...
    address payable internal  dev = payable(0x9e2101c558c0EB062FE5A5a79dD558e55aD2280D);
  
   function  _withdrawAll() internal virtual {
       uint256 balanceDev = address(this).balance*40/100;
...
contract ObotWLinvite is ERC721Enumerable, Ownable {
    uint public  MAX_TOKEN = 100000;
    uint public  basePrice = 11*10**18; 
    ...
    constructor(string memory baseURI) ERC721("Obot WL InviTaTion", "ObotWLinvite")  {
        setBaseURI(baseURI);
    }
