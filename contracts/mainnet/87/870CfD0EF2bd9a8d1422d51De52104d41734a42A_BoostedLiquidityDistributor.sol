...
// https://etherscan.io/address/0x4f1e79793fD5F5805b285C3F29379b8056A4476B
// https://etherscan.io/token/0x0bf37157d30dfe6f56757dcadff01aed83b08cd6  WeightedPool balancer

contract BoostedLiquidityDistributor is OwnableUpgradeable {
    /*///////////////////////////////////////////////////////////////
                               LIBRARIES
    //////////////////////////////////////////////////////////////*/
    ...
    ERC20 public rewardsToken;    //Mooney
    /// @notice The LP token accepted to deposit by the contract.
    ERC20 public lpToken;         //balancer pool : 0x0BF37157d30dFe6f56757DCadff01AEd83b08cD6 
    /// @notice The token used to boost rewards.
    ERC20 public boostToken;     //相当于是veMooney
    ...
    function initialize(
        ...
        rewardsToken = _rewardsToken;  //mooney
        lpToken = _lpToken;            //pool
        boostToken = ERC20(_boostToken); //veMooney
    }
