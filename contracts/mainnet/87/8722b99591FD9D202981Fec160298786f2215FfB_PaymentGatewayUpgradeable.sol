...
import { IPaymentGateUpgreadeable } from "./interfaces/IPaymentGateUpgreadeable.sol";
...
contract PaymentGatewayUpgradeable is IPaymentGateUpgreadeable, BaseUpgradeable {
    ...
    function execute(
        ...
        Operation calldata afterExchange_
    ) external payable {
        ...
        Operation memory afterExchange = afterExchange_;
        afterExchange.value = uint96(address(this).balance);
        _call(afterExchange);
    }
