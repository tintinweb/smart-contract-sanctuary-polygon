...
contract Force1_3Core is owned
{
    ...
    function subCore_(address msgsender, address _refAddress,bool pay, uint prc) internal returns(bool)
    {
        ...
        require(user4thParent<62, "no place under this referrer");
        ...
        if(userPosition > 122 && userPosition < 125 ) 
        {
    ...
    function getPosition(address _user, uint _level) public view returns(uint recyclePosition_, uint recycleID)
    {
        ...
        if (a == 2 && b == 2 && c == 2 && d == 2 ) return (125, parent_);
        if (a == 1 && b == 2 && c == 2 && d == 2 ) return (124, parent_);
        if (a == 2 && b == 1 && c == 2 && d == 2 ) return (123, parent_);
        if (a == 1 && b == 1 && c == 2 && d == 2 ) return (122, parent_);
        if (a == 2 && b == 1 && c == 1 && d == 1 ) return (64, parent_);
        if (a == 1 && b == 2 && c == 1 && d == 1 ) return (65, parent_);
        if (a == 2 && b == 2 && c == 1 && d == 1 ) return (66, parent_);
        if (a == 1 && b == 1 && c == 2 && d == 1 ) return (67, parent_);        
    ...
    function findFreeParentInDown(uint  refID_ , uint _level) public view returns(uint parentID, bool noFreeReferrer)
    {
        ...
        address[63] memory childss;
        uint[63] memory parenT;
    ...
    function buyCore_(address msgsender, uint _level, bool pay,  uint prc) internal returns(bool)
    {
        ...
        if(userPosition > 123 && userPosition < 126 ) 
        {
    ...
    {
        uint[6] memory percentPayout;
        percentPayout[0] = 10;
        percentPayout[1] = 10;
        percentPayout[2] = 10;
        percentPayout[3] = 10;
        percentPayout[4] = 10;        
        if(payAll) percentPayout[5] = 50;
