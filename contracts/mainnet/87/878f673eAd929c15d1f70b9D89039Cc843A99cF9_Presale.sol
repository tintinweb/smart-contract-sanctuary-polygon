...
contract Presale is Ownable {
    ...
    uint256 public min_contribution = 50 * 10 ** 6;

    // maximum contribution for public
    uint256 public max_contribution_public = 2000 * 10 ** 6;

    // maximum contribution for alpha
    uint256 public max_contribution_alpha = 25000 * 10 ** 6;

    // maximum contribution for beta
    uint256 public max_contribution_beta = 10000 * 10 ** 6;

    // soft / hard cap
    uint256 public hardCap = 2_000_000 * 10 ** 6;
