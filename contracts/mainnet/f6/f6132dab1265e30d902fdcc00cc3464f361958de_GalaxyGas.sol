...
contract GalaxyGas is ERC20, AccessControl, ERC721Holder {
    ...
    constructor(address owner, address _collectionAddress) ERC20("GalaxyGas", "GGAS") AccessControl(){
        ...
        coinAmountPerRewardUnit = 8 * 10 ** 18; // 8 ERC20 coins per rewardUnit, may be changed later on
        numberOfBlocksPerRewardUnit = 20571; // 12 hours per reward unit , may be changed later on
        welcomeBonusAmount = 50 * 10 ** 18; // 170 tokens welcome bonus, only paid once per tokenId
    }
