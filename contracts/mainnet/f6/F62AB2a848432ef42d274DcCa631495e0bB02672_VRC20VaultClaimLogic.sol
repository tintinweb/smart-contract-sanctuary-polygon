...
contract VaultClaimResolverVRC20 is Helpers {
     ...
     */
    function claim(IERC4626 vault, uint256 setId) external {
        ...
        uint256 _claimed = IERC20(distToken).balanceOf(address(this)) - initialBal;

        // set rewards received
        if (setId > 0) {
            setUint(setId, _claimed);
        }
    }
}

contract VRC20VaultClaimLogic is VaultClaimResolverVRC20 {
    string public constant name = "VRC20VaultClaimLogic";
