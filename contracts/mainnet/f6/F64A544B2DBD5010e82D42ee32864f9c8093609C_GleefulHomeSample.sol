...
contract GleefulHomeSample is ERC721, IERC2981, ReentrancyGuard, Ownable {
  ...
  constructor(string memory customBaseURI_)
    ERC721("Gleeful Home Sample", "TTKN")
  {
    customBaseURI = customBaseURI_;

    allowedMintCountMap[owner()] = 375;
  }
  ...
  uint256 public constant MINT_LIMIT_PER_WALLET = 375;
  ...
  uint256 public constant MAX_MULTIMINT = 375;
  ...
  function mint(uint256 count) public payable nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 375 at a time");
