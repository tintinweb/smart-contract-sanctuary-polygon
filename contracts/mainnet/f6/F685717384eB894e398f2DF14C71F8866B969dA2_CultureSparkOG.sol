    ...
    ReentrancyGuard
{
    ...
    string private constant baseTokenURI = "https://ipfs.io/ipfs/";
    string private _name = "Culture Sparks OG";
    string private _symbol = "CSOG";
        ...
        returns (uint256 _tokenId)
    {
        ...
        require(_tokenId <= 11, "Limit exceeds");
    ...
    function _beforeTokenTransfer(
        ...
        require(
            from == address(0) || whitelist[from] || !_paused,
            "Transfer disabled"
        );
