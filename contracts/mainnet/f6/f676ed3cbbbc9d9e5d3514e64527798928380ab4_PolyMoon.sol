...
// SPDX-License-Identifier: MIT 
 ...
 /*   PolyMoon - investment platform based on Polygon Smart Chain blockchain smart-contract technology. Safe and legit!
 
 *
 *   [USAGE INSTRUCTION]
 *
 *   1) Connect browser extension Metamask
 *   2) Choose one of the tariff plans, enter the MATIC amount (5 MATIC minimum) using our website "INVEST" button
 ...
 *   - Total income: based on your tarrif plan (from 9.5% to 13% daily!!!) + Basic interest rate !!!
 ...
 *   [AFFILIATE PROGRAM]
 *
 *   - 3-level referral commission: 20% - 3% - 2%
 *
 */
...
contract PolyMoon {
	...
	uint256 constant public CHARITY_FEE = 500;
  ...
  _;
	...
	function isContract(address addr) internal view returns (bool) {
        ...
        function Polymoon() public onlyOwner {
