...
// This token is for entertainment purposes and utility purposes only
// This token is not meant for profit. 
// Read through disclaimer before swapping
...
contract HubrisNetwork is Context, IERC20, Ownable 
{
    ...
    string private _name = "Hubris Network Token";
    string private _symbol = "HUBRIS";
    ...
    address public charityWallet =  0x5ce53FeC4cd3ccb3f7272Fe10a8269F37e535c45;  
    address public developmentWallet =  0x40b9816e32C4B80FC238d63A2825b4cAE82Ad8EC;
    address public marketingWallet =  0xA971de8d3a9Fdc54810d5E2e666743D9599309E2;
    ...
    constructor () public {
        ...
        // Quickswap Router instead of uniswap
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private 
    {
        ...
        uint256 amtWalletS = amount.mul(_charityFee).div(100);
        ...
        if(amtWalletS>0)
        {
           _transferStandard(sender, charityWallet, amtWalletS.div(3));
           _transferStandard(sender, developmentWallet, amtWalletS.div(3));
           _transferStandard(sender, marketingWallet, amtWalletS.div(3));
        }
