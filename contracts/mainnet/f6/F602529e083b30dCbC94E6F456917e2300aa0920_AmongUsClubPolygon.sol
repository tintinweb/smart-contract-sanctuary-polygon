...
contract AmongUsClubPolygon is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_, address proxyRegistryAddress_)
    ERC721("Among Us Club Polygon", "AUCP")
  {
  ...
  uint256 public constant MAX_MULTIMINT = 2001;
  ...
  function mint(uint256 count) public nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 2001 at a time");
