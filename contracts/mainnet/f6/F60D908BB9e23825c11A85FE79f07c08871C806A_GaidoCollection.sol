...
contract GaidoCollection is Ownable, DefaultOperatorFilterer, AccessControl, ERC721Enumerable, ERC721URIStorage, ERC721Royalty, CantBeEvil(LicenseVersion.PERSONAL_NO_HATE) {
    constructor(string memory _name, string memory _symbol, address[] memory admin, uint256 _maxAmount, address royaltyRecipient, uint96 basisPoints)
