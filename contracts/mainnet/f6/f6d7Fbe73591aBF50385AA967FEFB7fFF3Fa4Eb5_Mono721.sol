...
contract Mono721 is Logion, ERC721 {
    string private monoTokenURI;
    ...
    constructor(
        ...
        address _tokenOwner,
        string memory _monoTokenURI
    ) ERC721(_name, _symbol) Logion("", _collectionLocId, _certHost) {
        _mint(_tokenOwner, 1);
        monoTokenURI = _monoTokenURI;
    }
