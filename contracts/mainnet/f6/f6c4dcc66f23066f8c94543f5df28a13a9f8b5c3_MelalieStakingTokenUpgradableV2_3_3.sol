...
// File contracts/child/MelalieStakingTokenUpgradableV2_3_3.sol
...
contract MelalieStakingTokenUpgradableV2_3_3 is ERC20Upgradeable, OwnableUpgradeable, PausableUpgradeable
{
    ...
    //new variable v2_3_3
    bool private _upgradedV2_3_3;
   
   function upgradeV2_3_3() public {
    require(!_upgradedV2_3_3, "MelalieStakingTokenUpgradableV2_3_3: already upgraded");

    //0x031Ad46E26ca18D44572E6d938e1cF2C35eC51C7  receives for 6 days rewards: 2092.5 from amount: 837000.0 apy:15 (91 days old)
    rewards[address(0x031Ad46E26ca18D44572E6d938e1cF2C35eC51C7)] = rewards[address(0x031Ad46E26ca18D44572E6d938e1cF2C35eC51C7)] + 2092500000000000000000;
    stake_times[0x031Ad46E26ca18D44572E6d938e1cF2C35eC51C7].push(Stake(1653035687,837000000000000000000000)); //Fri May 20 2022 13:34:47 GMT+0500 (Jekaterinburg-Normalzeit) 
    //here are 10000 MEL included to have 90 days even tho they were staked on March 30 2022! (good will decision)
    totalDistributions+=2092500000000000000000;
    emit RewardsDistributed(2092500000000000000000);

    _upgradedV2_3_3 = true;
   }
