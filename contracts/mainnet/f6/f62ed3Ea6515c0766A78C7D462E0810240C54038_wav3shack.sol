...
contract wav3shack {
    ...
    // The address of WMatic currency.
    ...
    function processMirror(
        ...
        uint256 minFollowers = dataByPublication[pubId].minFollowers;
        ...
        if (minFollowers > followersCount) {
            revert('wav3s__NeedMoreFollowers()');
        }
    ...
    function fundMySuperReach(
        ...
        // Check: Reward for mirroring must be 0 or higher, and can't be
        // higher than the budget for the publication.
        ...
        // Check: Only accept WMatic as a paying currency.
