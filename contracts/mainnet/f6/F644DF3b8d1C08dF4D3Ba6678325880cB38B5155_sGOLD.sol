...
contract sGOLD is ERC20, Ownable {
    ...
    constructor() ERC20("sGOLD", "sGOLD", 18) {}

    /* ========== MODIFIERS ========== */

    modifier onlyOwnerOrStakingContract(){
        require(msg.sender == owner() || msg.sender == stakingContract, "Not authorized");
        _;
    }
    ...
    function mint(uint256 amount, address receiver) external onlyOwnerOrStakingContract {
        require(totalSupply + amount <= MAX_SUPPLY, "Max supply reached");
        _mint(receiver, amount);
    }

    function burn(uint256 amount) external onlyOwnerOrStakingContract {
