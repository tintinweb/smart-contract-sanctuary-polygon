...
contract UniswapPairOracle is Ownable {
    ...
    uint256 public PERIOD = 10; // 1 hour TWAP (time-weighted average price)
    uint256 public CONSULT_LENIENCY = 10; // Used for being able to consult past the period end
    ...
    function setConsultLeniency(uint256 _leniency) external onlyOwner {
        CONSULT_LENIENCY = _leniency;
    }
