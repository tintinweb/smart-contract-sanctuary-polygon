...
contract MANADAO is MANADAODeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private MANADAOTeam;
    address private CharityMANADAO;
    ...
    string public override name = "MANA DAO";
    string public override symbol = "MANA DAO";
    ...
    constructor(uint totalSupplyValue, address MANADAOTeamAddress, address CharityMANADAOAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        MANADAOTeam = MANADAOTeamAddress;
        CharityMANADAO = CharityMANADAOAddress;
        
        // split the tokens according to agreed upon percentages
        balances[MANADAOTeam] =  totalSupply * 4 / 100;
        balances[CharityMANADAO] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's MANADAOTeam pot
