...
contract Migrator is ERC20 {
    ...
    function add(uint _amount) external {
        // deposit toAsset
        SafeERC20.safeTransferFrom(toAsset, msg.sender, address(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174), _amount);
        // mint LP shares
    ...
    function migrate(uint _amount) external {
        // deposit fromAsset
        SafeERC20.safeTransferFrom(fromAsset, msg.sender, address(0x649438142441a4f168A2a1B3A2a14B08cd80D7CE), _amount);
        // send out toAsset
