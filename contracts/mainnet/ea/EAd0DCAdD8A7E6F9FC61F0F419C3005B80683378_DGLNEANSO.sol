...
contract DGLNEANSO is ERC721Mintable, ERC721Permit("DGLNEANSO") , Ownable, ERC721URIStorage{
    string public _defaultURI;
    event UpdateDefaultURI(string defaultURI);

    constructor() ERC721("DGLNEANSO", "DGLNEANSO") {
        setDefaultURI("https://api01.genso.game/api/land_metadata/");
    }
