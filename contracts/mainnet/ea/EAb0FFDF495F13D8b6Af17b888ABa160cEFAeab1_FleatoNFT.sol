...
// File contracts/ERC1155Pauser.sol

// Fleato Contracts v1.0 (ERC1155Pauser.sol)
 ...
 */
contract ERC1155Pauser is Context, AccessControlEnumerable, ERC1155Burnable, ERC1155Pausable {
    ...
    function pause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "ERC1155Pauser: must have pauser role to pause");
        _pause();
    }
    ...
    function unpause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "ERC1155Pauser: must have pauser role to unpause");
        _unpause();
    }
...
// File contracts/ERC1155AutoMinter.sol

// Fleato Contracts v1.0 (ERC1155AutoMinter.sol)
 ...
 */
abstract contract ERC1155AutoMinter is AccessControlEnumerable, ERC1155 {
 ...
 * Fleato NFT contract
 */
contract FleatoNFT is AccessControlEnumerable, ERC1155Pauser, ERC1155AutoMinter,ERC1155Supply, ERC1155Royalty {
    /**
    ...
    constructor(
        address owner
    ) ERC1155Pauser('https://nft.fleato.com/{id}.json') {
    ...
    function _beforeTokenTransfer(
        ...
        uint256[] memory amounts,
        bytes memory data
    ) internal virtual override(ERC1155Royalty, ERC1155Supply, ERC1155Pauser, ERC1155) {
        super._beforeTokenTransfer(operator, from, to, ids, amounts, data);
    }
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(AccessControlEnumerable, ERC1155Royalty, ERC1155Pauser, ERC1155AutoMinter, ERC1155)
        returns (bool)
    {
        return super.supportsInterface(interfaceId);
    }
