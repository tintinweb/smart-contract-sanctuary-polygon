...
contract SoftballStats is Ownable {
    ...
    function leaderByCategory() external view returns (string memory runsLeader, string memory doublesLeader, string memory triplesLeader, string memory homeRunsLeader, string memory rbisLeader) {
        ...
        for (uint i; i < totalPlayers;) {
            ...
            if (stats[player[i]].runs > runsLead) {
                runsLead = stats[player[i]].runs;
            }
            unchecked { 
                ++i; 
            }
        ...
        for (uint j; j < totalPlayers;) {
            ...
            if (stats[player[j]].doubles > doublesLead) {
                doublesLead = stats[player[j]].doubles;
            }
            unchecked {
                ++j;
            }
        ...
        for (uint k; k < totalPlayers;) {
            ...
            if (stats[player[k]].triples > triplesLead) {
                triplesLead = stats[player[k]].triples;
            }
            unchecked {
                ++k;
            }
        ...
        for (uint l; l < totalPlayers;) {
           ...
           if (stats[player[l]].homeRuns > homeRunsLead) {
              homeRunsLead = stats[player[l]].homeRuns;
           }
            unchecked {
                ++l;
            }
        ...
        for (uint m; m < totalPlayers;) {
            ...
            if (stats[player[m]].rbis > rbisLead) {
                rbisLead = stats[player[m]].rbis;
            }
            unchecked {
                ++m;
            }
