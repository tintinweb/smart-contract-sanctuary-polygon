...
contract PixelToken is ERC20, AccessControl, ERC721Holder {
    ...
    constructor(address owner, address _collectionAddress) ERC20("Pixel Token", "PIXT") AccessControl(){
        ...
        numberOfBlocksPerRewardUnit = 1715; // 12 hours per reward unit , may be changed later on
