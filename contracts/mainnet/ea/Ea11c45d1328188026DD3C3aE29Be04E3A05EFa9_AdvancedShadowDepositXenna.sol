...
contract AdvancedShadowDepositXenna is Ownable {
    ...
    function getClosedDate(address _user, uint _pid)
        public
        view
        returns (uint)
    {
    ...
    function positionExists(address _user, uint256 _pid)
        internal
        view
        returns (bool result)
    {
    ...
    function _getPositionIndexByPid(address _user, uint256 _pid)
        internal
        view
        returns (uint256)
    {
