...
contract Dex is Initializable, OwnableUpgradeable {
        ...
        public
    {
        ...
        require(paymentToken.balanceOf(msg.sender) >= price * 1e18, "Not enough funds");

        // Check Allowance - tx to approve
        require(paymentToken.allowance(msg.sender, address(this)) >= price * 1e18, "Check allowance");

        // Token Transfer
        paymentToken.transferFrom(msg.sender, address(this), price * 1e18);
