...
// File: contracts/EdgarSocialCartel.sol
...
contract EdgarSocialCartel is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Edgar Social Cartel", "ESC") {
    setHiddenMetadataUri("ipfs://QmVN4VrKWwVjRhNaK6ASddLXTdaXKpG1JfVfC98LUeoFYp/hidden.json");
  }
