...
// File contracts/interfaces/IRouterTokenHelper.sol
...
// File contracts/interfaces/IBasePositionManagerEvents.sol
...
// File contracts/interfaces/IOcarioSwapV3LMEvents.sol


pragma solidity >=0.8.0;

interface IOcarioSwapV3LMEvents {
  event AddPool(
    uint256 indexed pId,
    address poolAddress,
    uint32 startTime,
...
// File contracts/interfaces/IOcarioSwapV3LM.sol


pragma solidity >=0.8.0;


interface IOcarioSwapV3LM is IOcarioSwapV3LMEvents {
  struct RewardData {
    address rewardToken;
...
// File contracts/interfaces/IOcarioRewardLockerV2.sol


pragma solidity 0.8.9;

interface IOcarioRewardLockerV2 {
  /**
...
// File contracts/OcarioSwapV3LM.sol
...
contract OcarioSwapV3LM is IOcarioSwapV3LM, AccessControl, LMHelper, ReentrancyGuard {
  ...
  IOcarioRewardLockerV2 public immutable rewardLocker;
  ...
  constructor(IERC721 _nft, IOcarioRewardLockerV2 _rewardLocker) {
    nft = _nft;
