...
contract FCNProduct {
    ...
    constructor(address _asset, string memory _name, uint _managementFeeBps, uint _yieldFeeBps) {
    ...
    function setManagementFeeBps(uint _managementFeeBps) public {
        // TODO: onlyOperatorAdmin
        managementFeeBps = _managementFeeBps;
    }

    function setYieldFeeBps(uint _yieldFeeBps) public {
        // TODO: onlyOperatorAdmin
        yieldFeeBps = _yieldFeeBps;
    }

    function createVault(string memory _tokenName, string memory _tokenSymbol) public returns (address vaultAddress) {
        // TODO: onlyTraderAdmin
        ...
        vaults[newVaultAddress] = FCNVaultMetadata({
    ...
    function setVaultMetadata(address vaultAddress, FCNVaultMetadata calldata metadata) public {
        // TODO: onlyTraderAdmin
...
struct OptionBarrier {
    string asset;
    // enum OptionBarrierType; // [KnockIn, KnockOut]
    uint barrierBps;
...
struct FCNVaultMetadata {
    ...
    // Want to iterate over all options & check for KI/KO
