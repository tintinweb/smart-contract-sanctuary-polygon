 ...
 */
contract DRC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = DRC721.ownerOf(tokenId);
    ...
    function _transfer(address from, address to, uint256 tokenId) internal virtual {
        require(DRC721.ownerOf(tokenId) == from, "ERC721: transfer of token that is not own");
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(DRC721.ownerOf(tokenId), to, tokenId);
    }
...
abstract contract DRC721Enumerable is DRC721, IERC721Enumerable {
     ...
     * @dev See {IERC165-supportsInterface}.
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(IERC165, DRC721) returns (bool) {
    ...
    function tokenOfOwnerByIndex(address owner, uint256 index) public view virtual override returns (uint256) {
        require(index < DRC721.balanceOf(owner), "ERC721Enumerable: owner index out of bounds");
        return _ownedTokens[owner][index];
    }

    function tokensOfOwner(address owner) public view returns (uint256[] memory) {
        uint256 count = DRC721.balanceOf(owner);
    ...
    function tokenByIndex(uint256 index) public view virtual override returns (uint256) {
        require(index < DRC721Enumerable.totalSupply(), "ERC721Enumerable: global index out of bounds");
    ...
    function _addTokenToOwnerEnumeration(address to, uint256 tokenId) private {
        uint256 length = DRC721.balanceOf(to);
    ...
    function _removeTokenFromOwnerEnumeration(address from, uint256 tokenId) private {
        ...
        uint256 lastTokenIndex = DRC721.balanceOf(from) - 1;
...
contract DNFT is DRC721Enumerable, Pausable {
    using Strings for uint256;
    ...
    function _beforeTokenTransfer(
        ...
        require(!paused(), "DRC721Pausable: token transfer while paused");
    }
}