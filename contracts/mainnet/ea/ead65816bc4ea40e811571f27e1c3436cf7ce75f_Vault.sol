...
contract Vault
{
    ...
    //Constants
    string  private constant NAME = "\x56\x61\x75\x6c\x74";
    ...
    address private constant ETHEREUM_TOKEN_ADDRESS = 0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619; 
    ...
    {
        require(usdAmount > 0, "Vault: USD+ amount cannot be 0");
    ...
    function harvest() public 
    {
        ...
        require(blocksStaking > HARVEST_COOLDOWN_BLOCKS, "Vault: harvest cooldown in progress");
