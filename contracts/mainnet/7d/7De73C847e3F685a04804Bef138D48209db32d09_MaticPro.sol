...
contract MaticPro {
	...
	uint256 constant private INVEST_MIN_AMOUNT = 0.001 ether; 
	uint256 constant private INVEST_MAX_AMOUNT = 100000000000000 ether; 
	uint256[] private REFERRAL_PERCENTS = [80, 50, 20];
	uint256 constant private TOTAL_REF = 100;
	uint256 constant private CEO_FEE = 25;
	uint256 constant private DEV_FEE = 25;
