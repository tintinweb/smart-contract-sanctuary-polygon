...
/**
 * @title   Onetick Vault V3
 * @notice  A vault that provides liquidity on Uniswap V3 without using external contract to rebalance.
 */
contract OnetickVaultV3 is IVault, IUniswapV3MintCallback, IUniswapV3SwapCallback, ERC20, ReentrancyGuard {
    ...
    /**
     * @notice Updates vault's positions. Can only be called by governance
    ...
    function rebalance(
        ...
        // Calculate limit order bounds from limitThreshold
        int24 _bidLower = tickFloor - _limitThreshold;
        int24 _bidUpper = tickFloor;
        int24 _askLower = tickCeil;
        int24 _askUpper = tickCeil + _limitThreshold;
