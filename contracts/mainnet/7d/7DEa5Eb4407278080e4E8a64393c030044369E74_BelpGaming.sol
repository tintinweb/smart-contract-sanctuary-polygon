...
contract BelpGaming is Ownable, ReentrancyGuard {
    ...
    event SetReward(address indexed owner, address[] _listAddress, uint256[] _listRanking, Tier _tier);
    ...
    event UpdateGamerInfo(address indexed owner, address _to, bool _hasReward, uint256 _ranking, Tier _tier);
    event DeleteGamerInfo(address indexed owner, address _to, Tier _tier);

    /* ========== VARIABLES ========== */
    IERC20 public tier1Token = IERC20(0x3dE47E17A09e48e40d27a6b6cD8e60Cd5272d872);
    IERC20 public tier2Token = IERC20(0xcf5e79A5Ad474Bb8b280D6D7888A02bB5cdb9979);
    IERC20 public tier3Token = IERC20(0xb8A475c0197b477bb1c41671ACA22986EA8765D2);
    IERC20 public tier4Token = IERC20(0x6829ebbaDC0D84B487cA549a6691F5660321E3ae);
    IERC20 public tier5Token = IERC20(0x81426E27690C4bfc722F876e758024ACf3884aC7);
    IERC20 public maticToken = IERC20(0xeDB0fDC47A1094B081e9d38e2b8581C0354Dd464);
    ...
    uint256 public rewardMatic = 1 ether;
     ...
     */
    function getGamerInfo(address to, Tier _tier) public view returns(address,bool,uint256,Tier) {
        ...
        return (gamerInfo.to, gamerInfo.hasReward, gamerInfo.ranking, gamerInfo.tier);
    }
    ...
    /**
     * @dev Function to get balance matic token of contract
     */
    function balanceMaticToken() public view returns(uint256) {
    ...
    /**
     * @dev Function to withdraw Matic Token.
     */
    function withdrawMaticToken() external onlyOwner {
        uint256 bal = balanceMaticToken();
        require(bal > 0, "you dont have a Matic token");
        maticToken.transfer(owner(), bal);
     ...
     */
    function updateGamerInfo(address _to, bool _hasReward, uint256 _ranking, Tier _tier) external onlyOwner {
        ...
        gamerInfo.ranking = _ranking;
        gamerInfo.tier = _tier;
        
        emit UpdateGamerInfo(msg.sender, _to, _hasReward, _ranking, _tier);
    }
     ...
     * @param _tier is a tier type.
     */
    function setReward(address[] calldata _listAddress, uint256[] calldata _listRanking, Tier _tier) external onlyOwner {
        ...
        emit SetReward(msg.sender, _listAddress, _listRanking, _tier);
    }
    ...
    function claim(Tier _tier) public nonReentrant {
        ...
        if(_tier == Tier.tier1) {
            ...
            if(gamerInfo.ranking == 1) {
                maticToken.transfer(gamerInfo.to, rewardMatic);
            }
