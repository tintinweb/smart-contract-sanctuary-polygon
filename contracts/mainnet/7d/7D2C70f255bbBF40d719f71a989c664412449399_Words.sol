...
contract Words is ERC721BaseInternal, WordsInternal, VRFInternal {
    ...
    function takeBackWord(uint256 tokenId) public {
        require(
    ...
    function setCategories(uint8[] calldata category, string[] calldata catStr) public onlyOwner {
...
abstract contract VRFInternal is VRFRequestIDBase {
    ...
    function _init() internal {
        ...
        l.vrfCoordinator = 0x3d2341ADb2D31f1c5530cDC622016af293177AE0;
        l.LINK = LinkTokenInterface(0xb0897686c545045aFc77CF20eC7A532E3120E0F1);
        l.keyHash = 0xf86195cf7690c55907b2b611ebb7343a6f649bff128701cc542f0569e2c549da;
        l.fee = 0.0001 * 10 ** 18; // 0.1 LINK (Varies by network)
    }
