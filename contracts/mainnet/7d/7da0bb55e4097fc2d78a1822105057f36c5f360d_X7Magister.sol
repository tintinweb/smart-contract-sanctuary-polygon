...
contract X7Magister is ERC721Enumerable, ERC721Holder, Ownable {
    ...
    // 45000 Matic
    uint256 public mintPrice = 45000 ether;
    ...
    constructor(address mintFeeDestination_, address treasury_, address magisterDistributor) ERC721("X7 Magister (Polygon)", "mX7MAGISTER") Ownable(msg.sender) {
