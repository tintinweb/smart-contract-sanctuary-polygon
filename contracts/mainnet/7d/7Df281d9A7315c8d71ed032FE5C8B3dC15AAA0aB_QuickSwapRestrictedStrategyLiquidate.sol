...
contract QuickSwapRestrictedStrategyLiquidate is OwnableUpgradeSafe, ReentrancyGuardUpgradeSafe, IStrategy {
  ...
  modifier onlyWhitelistedWorkers() {
    require(okWorkers[msg.sender], "QuickSwapRestrictedStrategyLiquidate::onlyWhitelistedWorkers:: bad worker");
    _;
  }

  /// @dev Create a new liquidate strategy instance.
  /// @param _router The PancakeSwap Router smart contract.
  function initialize(IQuickRouter02 _router) external initializer {
  ...
  function execute(
    ...
    require(
      ...
      "QuickSwapRestrictedStrategyLiquidate::execute:: insufficient baseToken received"
    );
