...
contract OpenGameCoin is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, ERC20SnapshotUpgradeable, AccessControlDefaultAdminRulesUpgradeable, PausableUpgradeable {
    ...
    function initialize(uint256 initialSupply,uint256 maxSupply) public initializer {

        //initialization
        __ERC20_init("OpenGameCoin", "OGC");
        __ERC20Burnable_init();
        __ERC20Snapshot_init();
        __AccessControlDefaultAdminRules_init(10 minutes, msg.sender);
        __Pausable_init();
    ...
    function mint(address to, uint256 amount) public onlyRole(MINTER_ROLE) {
        require(totalSupply() + amount <= MAX_SUPPLY, "Minting this amount would exceed the maximum supply");
        _mint(to, amount);
    }
