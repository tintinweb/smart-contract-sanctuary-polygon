...
contract HAHA is Ownable, ERC721AQueryable, ReentrancyGuard, IERC721ABurnable {
    using Address for *;
    string private _baseTokenURI;
    uint256 public immutable maxSupply = 1111;
    uint256 public immutable maxFree = 1111;
    uint256 public reserved = 30;
    uint256 public immutable freeLimit = 2;
    uint256 public immutable buyLimit = 4;
    uint256 public immutable phase2price = 10000000000000000 wei;
    string public contractURI; /// @dev collection metadata

    constructor() ERC721A("HAHA", "HH") {}
    ...
    function mint() public payable nonReentrant {
        ...
        if (_totalMinted() + reserved >= maxFree) {
            ...
            require(_numberMinted(msg.sender) + amount - userAlreadyMintedFree <= buyLimit, "limit 4");
        } else {
