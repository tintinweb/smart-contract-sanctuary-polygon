...
contract BloomThis is ERC721, Ownable, ERC2981 {
    ...
    mapping(address => uint256) private _perTokenCumulativeRewardForUser;
    uint256 private _perTokenCumulativeReward;
    ...
    constructor (string memory name, string memory symbol, bool transferable, uint256 maxTokens, string memory _uri) ERC721 (name, symbol) payable {
