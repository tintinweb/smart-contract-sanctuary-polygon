...
contract MaticPrinter is IERC20 {
    ...
    string constant private _name = "MaticPrinter";
    string constant private _symbol = "MATICP";
    ...
    address payable public marketingWallet = payable(0x88C6442A0Cb7fB20F8B4FB2Decc33Cd33dcD96E1);
