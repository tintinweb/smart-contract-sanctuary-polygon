  ...
  IMagpiePool
{
  ...
  function _bridgeOutToken(
    ...
    uint256[4] memory transferDetails = _getBridgeAmountOut(gasFee, tokenAddress, amount, relayerAddress);
    magpieProviders.decreaseLiquidity(tokenAddress, transferDetails[0]);
    tokenAddress.transfer(payable(receiver), transferDetails[0]);
  ...
  function _bridgeOutTokenWormhole(
    ...
    // uint256[2] memory transferDetails = _getBridgeAmountOutWormhole(gasFee, tokenAddress, amount, relayerAddress);

    _getBridgeAmountOutWormhole(gasFee, tokenAddress, amount, relayerAddress);
    tokenAddress.transfer(payable(receiver), amount);
  ...
  function _getBridgeAmountOutWormhole(
    ...
    gasFeeAccumulated[tokenAddress][relayerAddress] += gasFee; //the caller of swapOut address instead of msg.sender.
  ...
  function _getBridgeAmountOut(
    ...
    gasFeeAccumulatedByToken[tokenAddress] += gasFee;
    gasFeeAccumulated[tokenAddress][relayerAddress] += gasFee;
