...
contract bombom is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x5307e8116a8f0842d2D05CAbbD18F67243252a5f;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "boboho";
    string private _symbol = "biboho";
