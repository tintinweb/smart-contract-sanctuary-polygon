    ...
    Pausable
{
    ...
    function startChickenOwnerSale(uint256 _daysAfter)
        public
        onlyOwner
        whenNotPaused
    {
    ...
    function setPublicSale(bool _state) public onlyOwner whenNotPaused {
        require(
    ...
    function pauseSale(bool _pauseState) public onlyOwner {
