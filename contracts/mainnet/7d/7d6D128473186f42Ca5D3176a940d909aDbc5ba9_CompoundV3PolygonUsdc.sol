...
contract CompoundV3PolygonUsdc is Defii {
    IERC20 constant USDC = IERC20(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174);
    IERC20 constant COMP = IERC20(0x8505b9d2254A7Ae468c0E9dd10Ccea3A837aef5c);

    ICometRewarder constant cometRewarder =
        ICometRewarder(0x45939657d1CA34A8FA39A924B71D28Fe8431e581);
    ...
    function hasAllocation() public view override returns (bool) {
        return comet.balanceOf(address(this)) > 0;
    }
    ...
    function _exit() internal override {
        _harvest();
        comet.withdraw(address(USDC), type(uint256).max);
    }

    function _harvest() internal override {
        cometRewarder.claim(address(comet), address(this), true);
