...
import { ChildERC721 } from "./child/ChildToken/ChildERC721.sol";

contract Oddities is ChildERC721("Moonbirds Oddities POS", "ODDITIES", address(0xA6FA4fB5f76172d178d61B04b0ecd319C5d1C0aa)) {
    constructor() public {
        _setBaseURI("https://live---metadata-5covpqijaa-uc.a.run.app/oddities/");
    }
}
