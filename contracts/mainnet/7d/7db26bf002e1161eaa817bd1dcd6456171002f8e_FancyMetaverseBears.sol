...
// File: contracts/FancyMetaverseBears.sol
...
contract FancyMetaverseBears is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Fancy Metaverse Bears", "FMB") {
    setHiddenMetadataUri("ipfs://QmYFpNAJToH2VKqG6a8huu28FzpLqYdxUN1mPiE68ui31h/hidden.json");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0xB7fE390b40C4aa0cFa413104d86583a112D1b9e0).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
