...
contract ILProtectionConfig is ILProtectionConfigInterface, BaseController {
  ...
  function setPolicyPeriodsInDays(uint256[] calldata _policyPeriods) external override onlyAdmin {
  ...
  function getPolicyPeriodsInDays() external view override returns (uint256[] memory) {
