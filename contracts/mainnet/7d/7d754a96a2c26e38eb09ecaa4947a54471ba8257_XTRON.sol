...
/* xtron -  Missed Polygon?? Here is your chance to The next 1000x...

website: https://xtron.xyz/

Presale Price
100 Matic = 10,000 / $200
10 Matic = 1,000 / $20
1 Matic = 100 / $2
0.1 Matic = 10 / $0.2
0.01 Matic = 1 / $0.02
...
contract XTRON is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x758A11F9d871e3fB6882CeE31F13ECc2C7E7CaE4); // Marketing Address
    address payable public charityAddress = payable(0x758A11F9d871e3fB6882CeE31F13ECc2C7E7CaE4); // Charity/Dev Address
    ...
    uint256 private _tTotal = 10000000 * 10**18; // 1 M
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Xtron.xyz";
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _referEth =     500; //20% Matic
    uint256 private _referToken =   500; //80% Token
    uint256 private _airdropEth =   200000000000000000; //0.2 Matic Airdrop fee
    uint256 private _airdropToken = 2000000000000000000; // 50; token will be given on airdrop
    ...
    uint256 private salePrice = 100;// 1*100=100 token for 1 Matic (set as per requirements)
