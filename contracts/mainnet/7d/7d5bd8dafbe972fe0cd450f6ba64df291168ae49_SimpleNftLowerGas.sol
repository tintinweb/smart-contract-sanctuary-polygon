...
// File: contracts/CryptoSnowLeopardClub.sol
...
contract SimpleNftLowerGas is ERC721, Ownable {
  ...
  constructor() ERC721("Crypto Snow Leopard Club", "CSLC") {
    setHiddenMetadataUri("ipfs://QmXwSS9YMyLdpChX9yRUHGaKAKC3asFbsbzrVQGgvGQQrt/1.json");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0xAfEbB75a764842AcfafdA389e7f2eCF593152111).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
