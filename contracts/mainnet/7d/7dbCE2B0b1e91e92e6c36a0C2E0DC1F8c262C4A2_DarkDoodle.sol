...
contract DarkDoodle is ERC721 {
    ...
    constructor()
        ERC721("Doodle in the Dark", "DITD")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeias6qrfrdgxilx3ow4zls3izxbvbc6zbevuhqegbfj2arwqd6mxca/", Strings.toString(tokenId), ".json")
            );
    }
