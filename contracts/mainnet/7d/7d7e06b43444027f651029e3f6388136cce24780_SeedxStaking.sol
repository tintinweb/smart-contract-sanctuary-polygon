...
contract States {
   ...
   bool public isUnStakeActive = true;
    ...
    // mainnet
    // seedx token
    IERC20 public stakingToken = IERC20(0x58aFAD5758126C15d7f099E46cd0522FB0ce2571);
    // usdt token
    IERC20 public rewardingToken = IERC20(0x9417669fBF23357D2774e9D421307bd5eA1006d2);


    mapping(uint256=>uint256) public lockPeriod;

// apy for different timelock
    ...
    address public rewardingTokenWallet = address(0x16B1ce2e5642d4861D3208DD18E9302677c9546b);
...
contract SeedxStaking is States, Ownable {
    ...
    constructor(){
      ...
      lockPeriod[2] = 1080 days;
      lockPeriod[3] = 1680 days;
    ...
    function _stakeTokens(uint256 _amount, uint256 _tier)  internal {
        ...
        require(_tier<=3 && _tier >0, "select correct tier");
    ...
    function changeAPYTiers(uint256 _apy1,uint256 _apy2,uint256 _apy3) public onlyOwner {
      apyTier1 = _apy1;
      apyTier2 = _apy2;
      apyTier3 = _apy3;
    }

    function changeLockPeriods(uint256 _lockPeriod1,uint256 _lockPeriod2,uint256 _lockPeriod3) public onlyOwner {
