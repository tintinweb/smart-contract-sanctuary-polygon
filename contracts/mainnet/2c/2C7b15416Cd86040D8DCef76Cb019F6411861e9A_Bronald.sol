...
contract Bronald is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Bronald", "BRON") {
    setHiddenMetadataUri("ipfs://QmcPCPrn2guBKcVw8PM4t2ZsePE9EMo2EZbKVeNmR22V2Q/Bronald_Hidden_Metadata.json");
  }
