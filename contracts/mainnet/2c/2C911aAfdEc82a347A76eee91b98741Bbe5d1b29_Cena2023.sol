 ...
 * @notice This contract handles minting Cena_2023 tokens.
 */
contract Cena2023 is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xf136265D9e317cDA638004f0e86b58493C683c8F;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xCe12D248d5Ad5fC7B042F9Da4A5974D8D1aF0e21;
    address[] public payoutAddresses = [
        0xCe12D248d5Ad5fC7B042F9Da4A5974D8D1aF0e21
    ];
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeif44ynico7fwe5qeajhkfoxt55md4rzahucc7rrakoaxpl5nnpx5q/{id}"
        )
        RevokableOperatorFilterer(
