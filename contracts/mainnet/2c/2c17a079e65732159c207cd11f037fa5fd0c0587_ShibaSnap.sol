...
Renounced Contract
http://shibasnap.com/
https://nomics.com/assets/shibasnap-snap-shiba
...
contract ShibaSnap is ShibaDeployer, Context, ShibaMatic  {
    ...
    string public override name = "Shiba Snap";
    string public override symbol = "SnapShiba";
    ...
    // Get the address of the token's ShibaMatic pot
