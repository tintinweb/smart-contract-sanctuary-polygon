...
// File: contracts/testingairdrop.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract testingairdrop is
    ERC1155,
    Ownable,
    Pausable,
    ERC1155Supply,
    ...
    Allowlist
{
    ...
    string public name = "testing airdrop";
    string public symbol = "testingairdrop";
    string public contractURI = "ipfs://bafyreihg3ohleig24ploz2z4yzo4dfvaiqua2nrphstlmfuvpi5rqaqteq/metadata.json";
