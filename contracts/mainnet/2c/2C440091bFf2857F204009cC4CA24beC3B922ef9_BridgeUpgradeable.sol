 ...
 */
    ...
    /**
        @notice Used to remove chain support or start supporting chain again.
        @param handlerAddress Address of handler to withdraw from.
        @param destChainId chainId of dest chain.
        @param isUnsupported true to remove support and false to restart supporting the chain.
     */
    function adminSetUnsupportedChain(
        address handlerAddress,
        uint8 destChainId,
        bool isUnsupported
    ) public virtual nonReentrant onlyRole(DEFAULT_ADMIN_ROLE) {
        IERCHandler handler = IERCHandler(handlerAddress);
        handler.setUnsupportedChain(destChainId, isUnsupported);
        emit AdminUnsupportChain(destChainId, isUnsupported);
    }
...
interface IERCHandler {
    ...
    */
    ...
    function setUnsupportedChain(uint8 destChainId, bool isUnsupported) external;
