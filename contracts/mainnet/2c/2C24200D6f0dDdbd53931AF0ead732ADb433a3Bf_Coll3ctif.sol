...
contract Coll3ctif is ERC1155, Ownable, ERC1155Supply {
    using Strings for uint256;
    
    string public constant name = "Coll3ctif";
    ...
    constructor() ERC1155("https://gateway.pinata.cloud/ipfs/QmSvVfYaPFbL9CSZheVFWoBAofEcy8vsYsjwGpJXTBzy8M/") {
        _currentSupply = 0;
    }
    ...
    function mintBatch(address account, uint256 amount) public onlyOwner {
        require(_currentSupply + amount <= MAX_SUPPLY, "Exceeded maximum overall token supply");
        
        for (uint256 i = 0; i < amount; i++) {
            uint256 tokenId = _currentSupply + 1;
            require(totalSupply(tokenId) < 1, "Exceeded maximum mints for token");
