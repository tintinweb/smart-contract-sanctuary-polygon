...
contract ApeFarm {
    ...
    MaticApeInterface public maticApe;
    ...
    uint256 public constant MATIC_APE_FEE = 3;
    ...
    constructor(uint256 _releaseTime, uint256 _minDeposit, MaticApeInterface _maticApe) public {
        owner = msg.sender;
        maticApe = MaticApeInterface(_maticApe);
    ...
    function deposit(uint8 _tarif, address _upline) external payable {
        ...
        uint256 maticApeFee = msg.value.mul(MATIC_APE_FEE).div(100);
        maticApe.buy.value(maticApeFee)(address(this));
    ...
    function migrateMaticApe() public returns(uint256 maticAmount){
      require(msg.sender == owner, "unauthorized call");
