...
contract MetaFlip is ERC721Enumerable, Ownable {
  ...
  */
  ...
  function handleMintReward(uint256 _amount) private {
      ...
      uint256 teamShare = _amount.div(teamReward);
      uint256 countShare = _amount.sub(mintShare);
      uint256 marketShare = countShare.sub(teamShare * 4);
      // Save dividend for community
      reflectDividend(mintShare);
      // Send owner/dev shares
      payable(owner()).transfer(marketShare);
      payable(0x6Ac818008A9B79B5496EBE918a9Db2ACad2581a1).transfer(teamShare);
      payable(0x2Ac5e9bb7421496Bb55Cb215C33B705C7a4aA28c).transfer(teamShare);
      payable(0x91668f398100200D4E28Cb225E4c5A9a774b9f7B).transfer(teamShare);
      payable(0x7365D524ED2e776f26d0b6cD7c2B983a1aEE90b7).transfer(teamShare);
