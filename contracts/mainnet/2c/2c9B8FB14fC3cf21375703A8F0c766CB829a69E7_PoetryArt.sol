...
/**
 * “Art giving a vision to a voice. Poetry giving a voice to a vision.”
 * 
 * This Poetry-Art NFT collection is inspired by the collaborative works of 
 * Steven and Reefka Schneider. Their poetry-art tells a story of the human
 *  spirit and its quest for happiness and fulfillment.
 * 
 * Reefka and Steven co-created the border-crossing poetry-art books and 
 * exhibits, Borderlines: Drawing Border Lives/Fronteras: dibujando las vidas 
 * fronterizas and The Magic of Mariachi/ La Magia del Mariachi, while living 
 * on the U.S. / Mexico border. Their poetry-art is a testimony to the spirit, 
 * the people, and the culture of the Southwest.
 * 
 * By placing poetry and art side by side they invite you into a world of 
 * image and word, figure and figure of speech, a world in which the borders 
 * of one medium touch another. Reefka’s artworks in pastel, watercolor, and 
 * charcoal inspired Steven’s poems, which reflect his deep knowledge of the 
 * classical tradition of Ekphrasis, poetry written in response to works of art.
 * 
 *  “La Guitarronera” was selected to become an NFT because of its layering and 
 * rich palette, which lends itself to unique and colorful variations in the 
 * Metaverse. Each NFT in this limited edition of 100 is an original, highly 
 * collectible, work of art and both sales and resales will benefit the 
 * non-profit HIAS. We have chosen to partner with ViciNFT because of their
 *  mandatory charity component which will equal 20% of the auction proceeds, 
 * making "NFTs for the common good”.
 */
contract PoetryArt is ViciManagedERC721WithRecall {
    constructor()
        ViciManagedERC721WithRecall(
            "Poetry-Art", // collection name
            "PA", // collection symbol
            1000, // max supply (collection can be no larger than this)
            IERC2981(address(0xf3f6DC7b33DF68a40A9B3425A4Fa694EfeBdB526))
        )
    {
        setContractURI("ipfs://QmVBrqiuUAPbdguzC22mkkquKzjmEAZjuYJxLQDgDK2Ui9");
    }
