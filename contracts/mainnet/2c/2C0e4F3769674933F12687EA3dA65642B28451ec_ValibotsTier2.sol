...
contract ValibotsTier2 is ERC721EnumerableUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable, ERC2981 {
    ...
    function initialize(address _usdcToken) initializer public {
        ...
        __ERC721_init("VALIBOTS Tier 1", "VBOTS2");
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        return string(abi.encodePacked(string(abi.encodePacked(_baseTokenURI, tokenId)), ".json"));
    }
    ...
    function mintNft(address _to) private noBlacklist(_to) {
        nftSupply += 1;
        _mint(_to, nftSupply);
        emit Mint(_to, 1);
    }
    ...
    function mint(uint256 _amount) public nonReentrant noBlacklist(_msgSender()) {
        ...
        require(nftSupply + _amount <= 5_000, "NFT: Mint limit reached");
