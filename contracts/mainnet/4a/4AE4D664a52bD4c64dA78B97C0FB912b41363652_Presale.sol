...
contract Presale is Ownable, VRFConsumerBaseV2 {
    ...
    Ownable()   
  {
    ...
    // Price Riders init
    typePrice[MBoxTypeBot.LEG30] = 1;  
    typePrice[MBoxTypeBot.LEG250] = 1; 
    typePrice[MBoxTypeBot.MYT60] = 1; 
    typePrice[MBoxTypeBot.MYT500] = 1; 
    typePrice[MBoxTypeBot.SP75] = 1;  
    typePrice[MBoxTypeBot.SP1000] = 1; 
    ...
    ridersBaseURI[10] = "ipfs://bafybeigy5rzq3yv7osr7kschlj3ueufcnvrjgdpdq2jha5a5n654ygc5ka/Special"; // "ipfs://QmdmfDUjqDntPhV1UVwpa6PWreryFeKQcyyZDPacGM2SAd/Special/very rare";
    ...
    baseURILength["ipfs://bafybeigy5rzq3yv7osr7kschlj3ueufcnvrjgdpdq2jha5a5n654ygc5ka/Special"] = 8000;
    ...
    ridersImageURI[10] = "ipfs://bafybeictj4widovblg6bskblk47ce55vsh3uekxysedkgianyrfp4g2jkm/Special"; // "ipfs://QmdmfDUjqDntPhV1UVwpa6PWreryFeKQcyyZDPacGM2SAd/Special/very rare";
  ...
  /// @dev uses Ownable oppenzeppelin library
  /// @param _fee fee in native token weis 
  function setPresaleChainLinkFee(uint _fee) external  onlyOwner {
    chainlinkFeeMatic = _fee;
  }

  /// @notice Sets presaleDate
  /// @dev uses Ownable oppenzeppelin library
  /// @param _presaleDate fee in native token weis 
  function setPresaleDate(uint _presaleDate) external  onlyOwner {
    presaleDate = _presaleDate;
  }
