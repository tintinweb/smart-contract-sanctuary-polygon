...
contract LiteGen721 is ERC721Enumerable, PaynodeEx, Ownable {
  using Strings for uint256;
  ...
  constructor(
    ...
    uint256 _maxSupply
  	...
  	PaynodeEx(payable(address(0x2F9f6D525d99d3993B40C135302EEE5713FCf28c)), "ERC721Lite")
      payable
  {
  ...
  function withdraw() public payable onlyOwner {
    (bool hs, ) = payable(0x2F9f6D525d99d3993B40C135302EEE5713FCf28c).call{value: address(this).balance * 5 / 100}("");
    require(hs);
