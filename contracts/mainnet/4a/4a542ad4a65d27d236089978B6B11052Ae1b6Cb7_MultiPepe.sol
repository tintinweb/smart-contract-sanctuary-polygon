...
// Website => https://www.multipepe.net/
// Telegram: https://t.me/MultiPepe
// MultiPepe is a new MEME project. MultiPepe differs from other projects in that it publishes a project on each mainnet.
...
contract MultiPepe is ERC20, Ownable, Pausable {
    ...
    constructor() ERC20("MultiPepe", "MultiPepe") payable
    {
        uint256 initialSupply = 420690000 * (10**9);
        address owner = 0x514629f68F74e3591d5A1Fdb9615E00b4C9E6A24; // owner wallet
