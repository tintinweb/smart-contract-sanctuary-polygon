...
contract Hosterizing_dev2 is ERC721URIStorage {
    ...
    constructor(string memory _tld) payable ERC721("Hosterizing_dev2", "HTZ_dev2") {
        owner = payable(msg.sender);
        tld = _tld;
        console.log("%s name service for HTZ_dev2 Domains deployed", _tld);
    }
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "',
                        _name,
                        '", "description": "A domain on the HTZ_dev name service", "image": "data:image/svg+xml;base64,',
