...
// File: contracts/FOM/FOM Funding Member.sol
...
contract FoundingMember is ERC721A, Ownable {
    using Strings for uint256;
    ...
    uint256 public WHITELIST_COST = 1500 ether;

    bool public PAUSED = true;

    mapping(address => uint256) public MAPPING_WHITELIST_MINT;

    constructor() ERC721A("FOM Founding Member", "FOMFM") {}
