...
contract Canelas is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, ERC721BurnableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function royaltyInfo(uint256 _tokenId, uint256 _salePrice) external view returns (address, uint256) {
        uint256 royaltyAmount = (_salePrice * 6) / 100;
    ...
    {
        return
            interfaceId == 0x2a55205a || // ERC2981 - NFT Royalty Standard
            super.supportsInterface(interfaceId);
    }
}