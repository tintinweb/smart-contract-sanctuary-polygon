...
contract Vault is Operator, ReentrancyGuard 
{
    ...
    uint256 public constant MIN_TAX_RATE = 100;
    ...
    function updateTokenPerSec(uint256 _new_tokenPerSec) public onlyOperator {
        require(_new_tokenPerSec >= 0, "Invalid amount");
        tokenPerSecond = _new_tokenPerSec;
    }
