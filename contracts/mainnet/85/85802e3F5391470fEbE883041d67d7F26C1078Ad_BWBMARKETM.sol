...
contract BWBMARKETM is Initializable , IERC721ReceiverUpgradeable  ,  OwnableUpgradeable {
    ...
    modifier isStart(address _NFTAddress , uint256 _TokenID , uint256 _startPrice) {
        ...
        require(msg.sender == IERC721Upgradeable(_NFTAddress).ownerOf(_TokenID) , "MSG.SENDER is not the NFT owner");
