...
contract vCOP {
    ...
    constructor() {
        name = "vCOP Stablecoin peso colombiano"; // Sets the name of the token, i.e Ether
        symbol = "vCOP"; // Sets the symbol of the token, i.e ETH
        decimals = 0; // Sets the number of decimal places
        uint256 _initialSupply = 0; // Holds an initial supply of coins
