...

{
    ...
    */
    ...
    function burnCollection(uint256 from, uint256 to) external returns (bool){
        require(address(_msgSender()) == address(owner()), "Only the owner can call this function");
    ...
    /*function emergencyTransferNft(uint256 from, uint256 to) external returns (bool){
        require(address(_msgSender()) == address(owner()), "Only the owner can call this function");

        for(uint i=from; i < to; i++){
            _sellerContract.emergencyTransferNft(i);
        }
    ...
    function launchSale(uint256 from, uint256 to, uint256 price, address payable curatorWallet, uint256 curatorFeeInBasisPoints, address payable sellerWallet) external returns (bool){
        require(address(_msgSender()) == address(owner()), "Only the owner can call this function");

        for(uint i=from; i < to; i++){
            _sellerContract.launchSale(price, i, curatorWallet, curatorFeeInBasisPoints, sellerWallet);
        }
