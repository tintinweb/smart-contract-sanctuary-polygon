...
contract HShare is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 29,000 hSHAREs
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("HSHARE", "HSHARE") {
        _mint(msg.sender, 1000 ether); // mint 1000 HELIO Share for initial pools deployment
