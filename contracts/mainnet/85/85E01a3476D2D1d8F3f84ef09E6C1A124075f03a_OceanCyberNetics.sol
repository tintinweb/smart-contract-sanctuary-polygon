...
contract OceanCyberNetics {
    ...
    constructor(address ownerAddress, address payable _commissionAddress, address payable _devAddress, ERC20 _OCN) public 
    {
        owner = ownerAddress;
     ...
     function buyGameSlot(uint256 amount) payable public 
    {
        ...
        OCN.transferFrom(msg.sender,owner,amount); 
        emit BuyGameSlot(msg.sender, gameSize);
    }
    ...
    function withdrawMintedToken() public {
        ...
        users[msg.sender].lastTokenWithdraw=block.timestamp;
        OCN.transfer(msg.sender,totalReward);
