...
///////////////////////////////////////////////////////////////////////////
//                                                                       //
//     00021xcv!00021xcv!       00021xcv!                   00021xcv!    //
//     00021xcv!00021xcv!       00021xcv!                   00021xcv!    //
//     00021xcv!00021xcv!       00021xcv!                   00021xcv!    //
//     00021xcv!00021xcv!       00021xcv!              00021xcv!         //
//     00021xcv!00021xcv!       00021xcv!            00021xcv!           //
//     00021xcv!00021xcv!       00021xcv!        00021xcv!               //   
//     00021xcv!00021xcv!       00021xcv!00021xcv!00021xcv!              //
//     00021xcv!00021xcv!       00021xcv!00021xcv!00021xcv!              //   
//     00021xcv!00021xcv!       00021xcv!00021xcv!00021xcv!              //
//     00021xcv!00021xcv!       00021xcv!00021xcv!00021xcv!              //
//                              00021xcv!         00021xcv!              //
//                              00021xcv!            00021xcv!           //  
//         00021xcv!            00021xcv!              00021xcv!         //              
//     00021xcv! 00021xcv!      00021xcv!                  00021xcv!     //                  
//  00021xcv!00021xcv!00021     00021xcv!                  00021xcv!     //
//     00021xcv! 00021xcv!      00021xcv!                  00021xcv!     //
//         00021xcv!            00021xcv!                  00021xcv!     //
//                                                                       //
///////////////////////////////////////////////////////////////////////////
//////////////////////by Kusho Development Team////////////////////////////
///////////////////////////////////////////////////////////////////////////

contract KushoStaking is Ownable, ReentrancyGuard {
    ...
    // 3 $MINKA/day
    uint256 public rewardsPerHour = 125000000000000000;

    // Pause the NFT Staking Contract
    ...
    // Pause NFT Staking Contract
    function pauseStaking() external onlyOwner{
        if(!paused){
            timeOfLastPause = block.timestamp;
        } 
        paused = !paused;
    }

    // Enable rewards claiming
    function toggleRewardsClaimable() external onlyOwner{
        rewardsClaimable = !rewardsClaimable;
    }

    // Set rewards per hour
    function setRewards(uint256 reward) external onlyOwner{
        rewardsPerHour = reward;
    }
    ...
    function unstake(uint256[] calldata tokenIds) external nonReentrant {
        ...
        for (uint256 i; i < tokenIds.length;) {
            ...
            if (paused) {
                stakers[msg.sender].timeOfLastUpdate = timeOfLastPause;
            } else {
                stakers[msg.sender].timeOfLastUpdate = block.timestamp;
            }
            ++i;
    ...
    function claimRewards() external {
        ...
        require(rewardsClaimable, "Rewards are not yet claimable");
        require(rewards > 0, "You have no rewards to claim");
        require(block.timestamp >= stakers[msg.sender].timeOfLastClaim + 86400, "Wait 24 hours to claim again");
        if (paused) {
            stakers[msg.sender].timeOfLastUpdate = timeOfLastPause;
            stakers[msg.sender].timeOfLastClaim = timeOfLastPause;
        } else {
            stakers[msg.sender].timeOfLastUpdate = block.timestamp;
    ...
    function canClaim(address _staker) public view returns (bool) {
        // 24 hour check
        if ((block.timestamp >= stakers[_staker].timeOfLastClaim + 86400) && rewardsClaimable) {
            return true;
        } else {
            return false;
        }
        ...
        returns (uint256 _rewards)
    {
        if(paused) {
            return (((
                ((timeOfLastPause - stakers[_staker].timeOfLastUpdate) *
