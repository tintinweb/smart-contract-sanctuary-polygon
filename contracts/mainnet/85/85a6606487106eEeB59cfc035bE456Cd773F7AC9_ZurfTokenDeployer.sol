...
contract ZurfTokenDeployer is Ownable {
    ...
    constructor(address _usdtAddress, uint256 _feeAmount, address _vaultAddress) {
  ...
  // Check if the user has approved the transfer of USDT
    require(IERC20(usdtAddress).allowance(msg.sender, address(this)) >= feeAmount, "User has not approved the transfer of USDT");
    ...
    function withdrawUSDT() external onlyOwner {
        ...
        usdtToken.safeTransfer(vaultAddress, balance);
    }
}