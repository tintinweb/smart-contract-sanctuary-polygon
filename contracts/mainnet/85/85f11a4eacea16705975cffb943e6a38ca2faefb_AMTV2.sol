...
/** 
 *  SourceUnit: c:\Users\ASUS\Desktop\RebaseWithDividend\contracts\AMTV2.sol
*/
...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public constant USDT = address(0xc2132D05D31c914a87C6611C10748AEb04B58e8F); //USDT
...
contract AMTV2 is ERC20Detailed, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    address public liquidityReceiver =
        0x39C5637D7CE6E0D0156F1db2537588c473578923;
    address public treasuryReceiver =
        0x0D8e5dC5e2F75a3c088240F0949285D77c3494a0;
    address public marketingReceiver =
        0x8Ec274bD44cC4cA443b44B957EdF51170A74e70f;
    ...
    AMTV2DividendTracker public dividendTracker;
    ...
    constructor() ERC20Detailed("Agro-Matic", "AMTV2", uint8(DECIMALS)) {
        router = IDEXRouter(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff); //mainnet

        dividendTracker = new AMTV2DividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "AMTV2: The dividend tracker already has that address"
        );

        AMTV2DividendTracker newDividendTracker = AMTV2DividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "AMTV2: The new dividend tracker must be owned by the AMTV2 contract"
        );
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "AMTV2: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "AMTV2: Cannot update gasForProcessing to same value"
        );
...
contract AMTV2DividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()
        DividendPayingToken("AMTV2_Dividen_Tracker", "AMTV2_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "AMTV2_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "AMTV2_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main AMTV2 contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "AMTV2_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "AMTV2_Dividend_Tracker: Cannot update claimWait to same value"
        );
