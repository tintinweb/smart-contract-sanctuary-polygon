...
contract LRC is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  // uint256 public requested;
  uint256 public currentSupply = 0;
  
  string public baseURI = "https://lrc.mypinata.cloud/ipfs/QmU59HaEcdyv19w4mbdyTnhYvTdYZ4c3yAV5jbjSbxV78Y/";
  ...
  constructor() 
    ERC721("Llama Royal Club", "LRC")
    RandomlyAssigned(9999,1)
    {
       for (uint256 a = 1; a <= 30; a++) {
            mint(msg.sender);
        }
    }
