...
contract Web3PaymentsContract {
    ...
    constructor() {
        ...
        // MATIC Polygon
        SwapRouterContractsArr[address(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff)] = true; // PancakeSwap
    ...
    // The sender receives Cashback from the transfer in a developer token or another.
    //
    // Community over the development of this project.
    ...
    function sendRecipient(
        ...
        //send cashback - we buy project tokens or others and send them to the Sender
