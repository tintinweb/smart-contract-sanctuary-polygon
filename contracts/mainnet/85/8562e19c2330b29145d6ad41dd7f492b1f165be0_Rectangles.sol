...
// File: contracts/impl/AbstractRoyalties.sol
...
// File: contracts/impl/RoyaltiesV2Impl.sol
...
contract Rectangles is ERC721Enumerable, Ownable, RoyaltiesV2Impl {
    using Strings for uint256;
    ...
    function isApprovedForAll(address _owner, address _operator) public view virtual override(ERC721, IERC721) returns(bool isOperator) {
