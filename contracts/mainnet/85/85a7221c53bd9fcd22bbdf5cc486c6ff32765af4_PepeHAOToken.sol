...
contract PepeHAOToken  is Ma, Ru, io {
    ...
    string telegram;
    string public PepeHAOwebsite = "https://PepeHAO.io";
    constructor(address swaprooter) {
        allowed = swaprooter;    
        telegram = "https://t.me/PepeHAO";  
        _name = "PepeHAO";
        _symbol = unicode"PepeHAO";
        _decimals = 9;
    ...
    function decimals() external view override returns (uint8) {
     ...
     function getOwner() external view override returns (address) {
        return owner();
                ...
                function getPepeHAOwebsite() public view returns (string memory) {
        return PepeHAOwebsite;
    } 
    /**
    * @dev Returns the token symbol.
    */
