...
// Moonrunners Remixed by dakky.eth ... just for fun...
...
contract MRremixed is Ownable, DefaultOperatorFilterer, ERC721A {

    uint256 public walletMax = 10;
    using Strings for uint256;

    mapping(uint256 => string) private _tokenURIs;
    bool public publicSaleOpen = false;
    string public baseURI = "ipfs://bafybeicou367jercpafjicn4mdtsyj3e7h7hve5ygqrc7q44lhcrpusgze/";
    string public _extension = ".json";
    uint256 public price = 0 ether;
    uint256 public maxSupply = 2000;

    constructor() ERC721A("MR Remixed", "MRREMIX"){}
   ...
   function sendGiftsToWallet(address _wallet, uint256 _num) external onlyOwner{
    ...
    function setmaxSupply(uint256 _supply) public onlyOwner() {
        require(_supply <= 2000, "Error: New max supply cant be higher than original max.");
        maxSupply = _supply;
    }
