...
contract MrPotatoNFTlowgas is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Mr Potato NFT", "Mr Potato") {
    setHiddenMetadataUri("ipfs://QmaMvPrN4WfuJhYSzWyx9JnqSV2gEtNNDH4ZF6vkSe97Qd.json");
  }
