...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x5AE19d04013C02c01952E45a03E9f07C3aF88C62];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x5AE19d04013C02c01952E45a03E9f07C3aF88C62;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmcYvxb8TcHrRDMp8uJb59UuXhoypY746tnpb37i6KoWzz/";
...
// File: contracts/WojciechCollectionContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WojciechCollectionContract is RamppERC721A {
    constructor() RamppERC721A("Wojciech Collection", "WOJ"){}
}
