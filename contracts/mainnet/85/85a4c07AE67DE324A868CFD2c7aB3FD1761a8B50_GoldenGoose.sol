...
contract GoldenGoose is Context, Ownable {
    ...
    constructor(
        address payable _marketingAdd
    ) {
        recAdd = payable(msg.sender);
        marketingAdd = _marketingAdd;
    }
    ...
    function sellEggs() public {
        ...
        marketingAdd.transfer(SafeMath.div(fee, 2));
    ...
    function getMyGeese(address adr) public view returns(uint256) {
