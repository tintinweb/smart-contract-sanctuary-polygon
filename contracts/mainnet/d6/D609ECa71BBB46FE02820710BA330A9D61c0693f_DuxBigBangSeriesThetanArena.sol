...
// File contracts/DuxBigBangSeriesThetanArena.sol
...
contract ERC721ContractWrapper is Proxy {
    address internal constant _IMPLEMENTATION_ADDRESS = 0x143927eADB846D7BF3c70f51e20B427e628440F7;
    bytes32 internal constant _IMPLEMENTATION_SLOT = 0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc;
...
///
contract DuxBigBangSeriesThetanArena is ERC721ContractWrapper {
  constructor(
    string memory _name,
    string memory _symbol,
    uint256 _totalSupply,
