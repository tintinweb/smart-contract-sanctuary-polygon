...
contract Relay1 is Ownable, ReentrancyGuard {
    ...
    constructor() {
        ...
        _aaveContract = 0x794a61358D6845594F94dc1DB02A252b5b4814aD;
    ...
    function depositETHAave(
        address pool,
        address onBehalfOf,
        uint16 referralCode
    ) external payable {
   aaveContract = IWETHGateway(pool);
   aaveContract.depositETH(pool, onBehalfOf, referralCode);
