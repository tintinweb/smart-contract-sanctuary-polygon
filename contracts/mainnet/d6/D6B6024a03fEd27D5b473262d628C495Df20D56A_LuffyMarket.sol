...
contract LuffyMarket is Ownable, ReentrancyGuard {
    ...
    function purchaseWithFixedPrice(
        ...
        try nftInstance.transferFrom(thisSale.seller, msg.sender, tokenId) {} catch (
            bytes memory _error
        ) {
    ...
    function finishAuction(
        ...
        if (thisAuction.highestBidder != address(0) && thisAuction.winPrice > 0) {
            ...
            try nftInstance.transferFrom(address(this), highestBidder, tokenId) {} catch (
                bytes memory _error
            ) {
                emit ErrorLog(_error);
            ...
            try nftInstance.transferFrom(address(this), msg.sender, tokenId) {} catch (
                bytes memory _error
            ) {
                emit ErrorLog(_error);
                revert("FINISH AUCTION FAIL");
