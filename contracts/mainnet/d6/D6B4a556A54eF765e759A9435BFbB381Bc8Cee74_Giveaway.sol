...
contract Giveaway is Ownable, Pausable, SignatureHelper {
    using SafeERC20 for IERC20;

    mapping(string => bool) public isHashUsed;
    ...
    constructor(address _signer) payable SignatureHelper(_signer) {}
    ...
    function _getMessageHash(
        ...
        return keccak256(abi.encodePacked(hash, token, amount, account, nonce));
    }
    ...
    function claim(
        ...
        emit Claim(hash, token, msg.sender, amount, signature);
    }
