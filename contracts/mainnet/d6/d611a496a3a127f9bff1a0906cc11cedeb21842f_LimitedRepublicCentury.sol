...
// File: contracts/LimitedRepublicCentury.sol
...
contract LimitedRepublicCentury is Ownable, ERC721 {
    using Strings for uint256;
    ...
    string public hiddenMetadataUri = "ipfs://QmXMW5SFartaSUKVcXYeG5pKUjBu4inmD1MCx1BDCAfat4";
    uint16 public maxSupply = 19;
    uint16 public maxTokenPerMint = 3;
    uint16 public firstDiscount = 50;
    uint16 public secondDiscount = 20;
    uint256 public saleCost = 0.08 ether;

    constructor(string memory _baseTokenURI)
        ERC721("Limited Republic 3x4", "LP3x4")
    {
    ...
    function setSaleCost(uint256 _salCost) public onlyOwner returns (uint256) {
        saleCost = _salCost;
        return saleCost;
    }
}