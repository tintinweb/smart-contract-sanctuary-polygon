...
// File: contract/TheAdeptusNFT.sol
...
contract TheAdeptusNFT is ERC1155, Ownable {
  string public name;
  ...
  function setBatchTokenURI(uint256[] memory tokenIds,string memory _uri)external onlyOwner {
    for(uint256 i = 0; i < tokenIds.length; i++){
      setTokenURI(tokenIds[i], _uri);          
    }  
  }
