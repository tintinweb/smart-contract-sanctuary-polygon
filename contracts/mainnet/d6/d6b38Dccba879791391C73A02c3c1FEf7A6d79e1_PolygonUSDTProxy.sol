...
contract INSURANCE {
    ...
    address private tokenAddr = 0xc2132D05D31c914a87C6611C10748AEb04B58e8F; // POLYGON USDT Contract Address
    IERC20 public token;
...
contract PolygonUSDTProxy {
    ...
    uint constant public            INVEST_MIN_AMOUNT               = 10 ether;             // 10 USDT
