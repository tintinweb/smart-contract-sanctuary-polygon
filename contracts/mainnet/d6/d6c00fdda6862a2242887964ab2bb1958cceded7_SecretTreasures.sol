...
// File: contracts/Molly/SecretTrasures.sol

//SPDX-License-Identifier: UNLICENSED
/**
    SecretTreasures NFT Collection 1.0 : 4444 Unique 3D NFTs with one simple,
...
contract SecretTreasures is ERC721, Ownable {
    using Strings for uint256;
    using ECDSA for bytes32;

    uint256 public MAX_PRESALE = 100;
    ...
    string private notRevealedUri = "ipfs://QmdqTBsi2xaTabUg8tMXgxARjWoSL3PXWXtZnTcicVY5x5";
    ...
    function freeMint(uint256 _amount) external {
        ...
        require(
            ...
            "SecretTreasures: Mint too large, exceeding the maxSupply"
        );
    ...
    function presaleMint(
        ...
        require(
            ...
            "SecretTreasures: Presale is not currently active."
        );
        ...
        require(
            ...
            "SecretTreasures: You have exceeded the max per wallet amount!"
        );
        
        require(
            presaleCount + amount <= MAX_PRESALE,
            "SecretTreasures: Selected amount exceeds the max presale supply"
        );
    ...
    function publicSaleMint(uint256 amount) external payable {
        ...
        require( supply < maxSupply, "SecretTreasures: Sold out!" );
        require( supply + amount <= maxSupply, "SecretTreasures: Selected amount exceeds the max supply.");

        require(
            workflow == WorkflowStatus.Sale,
            "SecretTreasures: Public sale has not active."
        );

        require(
            msg.value >= salePrice * amount,
            "SecretTreasures: Insuficient ETH amount sent."
        );
    ...
    function forceMint(uint256 number, address receiver) external onlyOwner {
        ...
        require(
            ...
            "SecretTreasures: You can't mint more than max supply"
        );
