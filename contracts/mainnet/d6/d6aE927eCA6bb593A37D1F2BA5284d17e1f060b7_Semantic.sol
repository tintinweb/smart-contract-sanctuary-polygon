...
contract Semantic is ISemantic, AccessControl, Semantic721 {
     ...
     * @param operateDatas the datas for operate
     */
    ...
    function claim(ClaimOperateData[] memory operateDatas) external {
        for (uint256 i = 0; i < operateDatas.length; i++) {
            ...
            string memory signOriginalData = string.concat(
                ...
                operateData.subjectId.toString(),
                operateData.predicateId.toString(),
                operateData.object
            );
    ...
    function _mint(
        ...
        tokenDataForId[triple.subjectId][triple.predicateId][
            triple.object
        ] = tokenId;
    ...
    function _mintTurtle(
        ...
        for (uint256 i = 0; i < predicateAndObjects.length; i++) {
            PredicateAndObject memory predicateAndObject = predicateAndObjects[
                i
            ];
