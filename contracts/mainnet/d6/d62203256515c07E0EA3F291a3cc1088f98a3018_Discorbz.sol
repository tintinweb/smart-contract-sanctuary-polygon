...
contract Discorbz is ERC721A, Ownable {
    ...
    constructor(string memory _initBaseURI,bytes32 _merkleRoot) ERC721A("Discorbz", "DO") {
        ...
        payable
    {
        ...
        require(msg.value >= presaleCost * quantity, "Not enough Matic!");
