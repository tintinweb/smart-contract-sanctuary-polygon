/**
 *Submitted for verification at Arbiscan on 2021-11-02
*/
...
contract PickleJar is ERC20 {
    ...
    public
    ERC20(
        string(abi.encodePacked("sphere ", ERC20(_token).name())),
        string(abi.encodePacked("sph", ERC20(_token).symbol()))
    )
    {
        _setupDecimals(ERC20(_token).decimals());
        token = IERC20(_token);
        governance = _governance;
        timelock = _governance;
