...
contract Y068 is ERC20, ERC20Burnable, Ownable {
  ...
  constructor() payable ERC20("Y068", "Y068")      {
...
uint public tiempoJ=60;              uint private constant MAX_TIEMPOJ = 86300;        event changeTiempoJ(uint tiempoJ);
...
if(block.timestamp >= comienzo[msg.sender])             {           
    ...
    horaAviso[msg.sender]=comienzo[msg.sender]+(numerA*2);
