...
contract UniV3LimitedRangeAdapter is AdapterBase, IUniV3Adapter {
  ...
  /// @dev Inverse tolerance for senior deposits in basis points; see depositTolerance()
  ...
  /// @notice Tolerance value for senior deposits in basis points
  /// @dev Senior depositor's resulting liquidity value may be lower than the required amount according to this tolerance
