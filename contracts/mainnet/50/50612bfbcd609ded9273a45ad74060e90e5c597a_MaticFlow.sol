...
contract MaticFlow is ReentrancyGuard {
    ...
    uint256 private constant SECONDARY_BENIFICIARY_INVESTMENT_PERC = 100;
    uint256 private constant PRIMARY_BENIFICIARY_REINVESTMENT_PERC = 50;
    uint256 private constant SECONDARY_BENIFICIARY_REINVESTMENT_PERC = 50;
    uint256 private constant PLAN_TERM = 100 days;
    uint256 private constant TIME_STEP_DRAW = 1 days;
    uint256 private constant DAILY_INTEREST_RATE = 20;
    uint256 private constant DAILY_AUTO_REINTEREST_RATE = 50;
    uint256 private constant ON_WITHDRAW_AUTO_REINTEREST_RATE = 250;
    uint256 private constant MIN_WITHDRAW = 0.0001 ether;
