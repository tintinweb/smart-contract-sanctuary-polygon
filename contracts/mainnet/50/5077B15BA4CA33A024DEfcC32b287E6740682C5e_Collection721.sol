...
contract Collection721 is Ownable, ERC721AURIStorage {
    ...
    constructor()
        ERC721AURIStorage("Universal Stallion Hourse NFT", "UNISTA")
    {}
     ...
     */
    function mint(address _to, uint256 _quantity, bytes memory _data) public {
        require(
            _msgSender() == controller || _msgSender() == owner(),
            "GoharaNFT: only owner or controller are allowed"
        );
