...
contract MrCandlestick is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_, address proxyRegistryAddress_)
    ERC721("Mr. Candlestick", "MCS")
  {
  ...
  uint256 public constant MINT_LIMIT_PER_WALLET = 6500;
  ...
  uint256 public constant MAX_MULTIMINT = 6500;
  ...
  function mint(uint256 count) public nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 6500 at a time");
