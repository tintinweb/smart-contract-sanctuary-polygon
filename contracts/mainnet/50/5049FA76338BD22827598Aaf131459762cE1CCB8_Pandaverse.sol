...
contract Pandaverse is ERC721A, ERC2981, ReentrancyGuard, Ownable {
    uint256 public maxSupply = 1000;

    bool private _paused = false;

    // Mint price
    uint256 public constant SALE_PRICE = 10 ether;

    // Base URI
    string public uriPrefix =
        "ipfs://QmPD9YrXAdGSbmjW4YyK4rPNHJ3JJbpVjgbvFHKgQZ3ei5/";
    using Strings for uint256;

    constructor() ERC721A("Pandaverse NFT", "PVN") {}
