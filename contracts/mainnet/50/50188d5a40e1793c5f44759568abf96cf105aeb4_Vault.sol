...
interface IMasterChef {
    ...
    function getUserInfo(uint256 _poolId, address _user) external view returns (uint256 amount, uint256 rewardDebt);
...
contract Vault is VaultBase {
    ...
    function _getSwapRoute(address _fromToken, address _toToken)
        internal
        view
        returns (address _router, address[] memory _path)
    {
