...
contract NFTStudio1089Token2 is ERC721Mintable, ERC721Permit("NFTStudio_1089_2:Token") , Ownable, ERC721URIStorage{
    string public _defaultURI;
    
    event UpdateDefaultURI(string defaultURI);

    constructor() ERC721("NFTStudio_1089_2:Token", "STH") {
        setDefaultURI("https://metadata.nft-studio.com/1089_2/");
    }
