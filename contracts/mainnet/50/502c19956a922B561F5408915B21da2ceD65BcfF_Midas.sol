...
contract Midas is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 50,000 tSHAREs
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 42500 ether;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("MIDAS", "MIDAS") {
        _mint(msg.sender, 1 ether); // mint 1 tShare for initial pools deployment
