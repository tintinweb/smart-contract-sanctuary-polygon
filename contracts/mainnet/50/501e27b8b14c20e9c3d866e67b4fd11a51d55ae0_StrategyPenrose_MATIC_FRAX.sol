...
contract StrategyPenrose_MATIC_FRAX is Strategy0xDAOMaximizer {

    address matic_frax_diff;

    function initializeStrategy(
        address _store,
        address _vault
    ) public initializer {
        address matic_frax_lp = address(0x04f9EE08C2C9c0E6DAD5e07F4Ae0201D8dbEebdE);
        ...
        __Strategy_init(
            ...
            _vault,
            rewards,
            0xAE2c3B4c1e93D6ddC4daf26a7eFF1cD09E7700fB,
            false,
