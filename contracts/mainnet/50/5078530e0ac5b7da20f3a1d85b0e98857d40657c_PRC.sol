...
contract PRC is ERC721, ERC721Enumerable, Ownable {

    using SafeMath for uint256;

    string public PROVENANCE;
    uint256 public constant tokenPrice = 0 ; // 0 matic
    uint public constant maxTokenPurchase = 1900;
    uint256 public MAX_TOKENS = 1900;
    ...
    function reserveTokens() public onlyOwner {
        ...
        require(supply < 0, "More than 0 tokens have already been reserved or minted.");
        uint i;
        for (i = 0; i < 0; i++) {
