...
import "./extension/WithOwnerUpgradeable.sol";
import "./extension/WithSuperOperators.sol";
import "./extension/ERC2771HandlerUpgradeable.sol";
import "./extension/ERC20BasicApproveExtension.sol";
import "./utils/BytesUtil.sol";

contract DTT is Initializable, ERC20Upgradeable, ERC20BasicApproveExtension, WithOwnerUpgradeable, WithSuperOperators, ERC2771HandlerUpgradeable {

    // constructor() {
    //     _disableInitializers();
    // }

    function initialize(address beneficiary,uint256 amount,address owner,address trustedForwarder) external initializer {
    ...
    function approveFor(
        ...
        require(_msgSender() == owner || _superOperators[_msgSender()] || _msgSender() == _owner, "NOT_AUTHORIZED");
...
contract ERC2771HandlerUpgradeable is Initializable {
    address internal _trustedForwarder;

    function __ERC2771Handler_init(address trustedForwarder_) internal onlyInitializing {
        __ERC2771Handler_init_unchained(trustedForwarder_);
    }

    function __ERC2771Handler_init_unchained(address trustedForwarder_) internal onlyInitializing {
