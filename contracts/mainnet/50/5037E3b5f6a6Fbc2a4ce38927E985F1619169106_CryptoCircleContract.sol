...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x503184bd914257a157e6825A3dD87ed90d9e7263];
  address public erc20Payable = 0x503184bd914257a157e6825A3dD87ed90d9e7263;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 202) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiaijgs3rwuqy7cq3j3px2tnkxr44o7maqajkstjdqokj7peyyuq3a/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/SPzN1g7ywc6rwii8ewsK/contract-metadata";
  }
...
// File: contracts/CryptoCircleContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CryptoCircleContract is RamppERC721A {
    constructor() RamppERC721A("CryptoCircle", "TC"){}
}
