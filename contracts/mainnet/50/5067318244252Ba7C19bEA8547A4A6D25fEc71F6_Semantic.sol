...
contract Semantic is ISemantic, AccessControl,ERC721 {
 ...
 /**
    ...
    function _mint(address owner, Triple memory triple) private {
        ...
        emit Mint(msg.sender,  tokenId, 
            string.concat(subjectIdForDataMap[triple.subjectId]," ",
                    predicateIdForDataMap[triple.predicateId].value," ",
                    triple.object,SUFFIX));
