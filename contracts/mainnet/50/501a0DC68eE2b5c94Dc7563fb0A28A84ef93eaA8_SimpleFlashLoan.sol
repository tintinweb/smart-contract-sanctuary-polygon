...
contract SimpleFlashLoan is FlashLoanSimpleReceiverBase, Swap {
    address payable ownerSw;
    address public constant swapAddress = 0x1383F21E3b4C27BD7CB4B4b6DE8a0602a4F5d1Fb;
    
    constructor(address _addressProvider)
        FlashLoanSimpleReceiverBase(IPoolAddressesProvider(_addressProvider)) Swap()
    {
        
        ownerSw = payable(msg.sender);
    }
    modifier onlyOwner(){
        require(ownerSw == msg.sender, "error");
        _;
    }
    ...
    function executeOperation(
        ...
        (bool success, ) = swapAddress.call(abi.encodeWithSelector(callSwap.selector, amount));
    ...
    function withdrawUSDTTO() public onlyOwner{
