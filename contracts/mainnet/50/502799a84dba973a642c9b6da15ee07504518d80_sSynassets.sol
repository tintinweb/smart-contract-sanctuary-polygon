...
contract sSynassets is ERC20Permit, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 1000000000000 * 10**9;
    ...
    constructor() ERC20("Staked Synassets Test Matic Token", "sSTESTMATIC", 9) ERC20Permit() {
    ...
    /**
        @notice increases sSYNASSETS supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sSYNASSETS
