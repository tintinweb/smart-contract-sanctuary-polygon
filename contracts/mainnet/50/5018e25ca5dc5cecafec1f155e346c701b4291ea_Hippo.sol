...
contract Hippo is ERC721Enumerable, Ownable {
  ...
  uint256 public maxSupply = 1001; //тут пишите общее количество нфт в вашей коллекции
  uint256 public maxMintAmount = 50;  // количество нфт которое можно сминтить при 1 транзакции
