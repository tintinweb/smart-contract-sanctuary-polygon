...
*/
        ...
        contract PolyKanos is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
            ...
            constructor(uint256 _price, uint256 __maxSupply, string memory _initBaseURI, uint256 _maxMintAmountPerTx, uint256 _maxMintAmountPerWallet) ERC721A("Polykanos", "polyka") {
