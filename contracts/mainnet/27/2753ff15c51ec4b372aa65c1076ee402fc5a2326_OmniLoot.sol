...
contract OmniLoot is ERC721A, ReentrancyGuard, Ownable, NonblockingReceiver{
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Omni Loot #', toString(tokenId), '", "description": "Loot is randomized adventurer gear generated and stored on chain. Stats, images, and other functionality are intentionally omitted for others to interpret. Feel free to use Loot in any way you want.", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
    ...
    function mint(uint8 numTokens) external payable {
        ...
        require(nextTokenId + numTokens <= MAX_MINT_ETHEREUM, "OmniLootTest2: Mint exceeds supply");
    ...
    constructor(address _layerZeroEndpoint) ERC721A("OmniLootTest2", "OmniLootTest2") Ownable() {
        _owner = msg.sender;
