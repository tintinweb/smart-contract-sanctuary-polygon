...
contract NotaryShot is INotaryShot, UUPSUpgradeable, ERC721EnumerableUpgradeable, OwnableUpgradeable, ChainlinkClient {
    ...
    */
    ...
    function name() public view override(ERC721Upgradeable, IERC721MetadataUpgradeable) returns (string memory) {
        return "Quantum Oracle Alpha Release NFTs: Verified Discoveries";
    }
}
