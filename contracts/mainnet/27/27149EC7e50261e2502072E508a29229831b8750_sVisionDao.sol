...
contract sVisionDao is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Vision DAO of Value", "sVISIONDAO", 9) ERC20Permit() {
    ...
    /**
        @notice increases sVISIONDAO supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sVISIONDAO
