...
contract Arbitrator is IZodiacArbitrator, Ownable {
    ...
    function submitAnswer(bytes32 question_id, bytes32 answer, address answerer) external onlyOwner {
        IZodiacReality(realitio).submitAnswerByArbitrator(question_id, answer, answerer);
    }
}