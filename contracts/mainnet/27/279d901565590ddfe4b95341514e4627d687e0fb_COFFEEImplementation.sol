...
// File: contracts/COFFEEImplementation.sol
...
/**
 * @title COFFEEImplementation
 * @dev this contract is a Pausable ERC20 token with Burn and Mint
 * controlled by a central SupplyController. By implementing SOYImplementation
...
contract COFFEEImplementation {
    ...
    string public constant name = "COFFEE"; // solium-disable-line
    string public constant symbol = "CFE"; // solium-disable-line uppercase
    ...
    */
    ...
    /**
     * @dev Reclaim all SOYBEAN at the contract address.
     * This sends the SOYBEAN tokens that this contract add holding to the owner.
