...
contract LotteryController is TimelockController, Pausable, ReentrancyGuard {
  ...
  function getUnclaimedRevenue() public view returns (uint256) {
    ...
    uint256 cumulatedTotalValue = _cumulatedTotalValue + _totalValue * (
        block.number - _lastDrawBlock);
    return cumulatedShares * cumulatedTotalValue / cumulatedTotalSupply - _withdrawn[msg.sender];
  }
