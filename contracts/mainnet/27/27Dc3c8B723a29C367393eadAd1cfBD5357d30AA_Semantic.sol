...
contract Semantic is ISemantic, AccessControl, Semantic721 {
    ...
    function checkTurtleExist(uint256 tokenId,uint256 predicateId,string memory object) external view returns (bool){
        Turtle storage turtle = tokenIdForTurtleData[tokenId];
        return turtle.predicateIdToObject[predicateId][object];
    }
