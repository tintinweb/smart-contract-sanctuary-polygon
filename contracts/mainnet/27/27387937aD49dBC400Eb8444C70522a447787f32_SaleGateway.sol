  ...
  AdminProxyManager
{
  ...
  event Finalize(address sale, uint16 dstId, address dstContract, bytes dstPayload);
  ...
  function finalizeRemote(
    ...
    _lzSend(dstChainId, _payload, payable(address(this)), address(0x0), _adapterParams, crossFee);
