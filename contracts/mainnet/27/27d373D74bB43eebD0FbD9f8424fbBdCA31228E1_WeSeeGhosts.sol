...
contract WeSeeGhosts is ERC721Enumerable, Ownable, NonblockingReceiver  {
    ...
    uint128 public constant GHOST_PRICE = 184 ether;
    uint128 public constant DISCOUNT_GHOST_PRICE = 152 ether;
    uint16 public constant MAX_GHOSTS = 778;
    uint16 public constant MAX_DEV_GHOSTS = 60;
    uint16 public constant MAX_PURCHASABLE_GHOSTS = 4;
    uint16 public nextTokenId = 445;
