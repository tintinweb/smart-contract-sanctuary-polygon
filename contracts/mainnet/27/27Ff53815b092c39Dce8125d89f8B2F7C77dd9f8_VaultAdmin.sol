...
contract VaultAdmin is VaultStorage {
    ...
    *************************************/
    ...
    function sortWeightsByTarget(StrategyWithWeight[] memory weights) internal pure returns(StrategyWithWeight[] memory) {
        ...
        Array.quickSort(targets, 0, int(targets.length-1), indices);
    ...
    */
    function setQuickDepositStrategies(address[] calldata _quickDepositStrategies) external onlyGovernor {
        require(_quickDepositStrategies.length > 0, "!QD");
        // Check _quickDepositStrategies contains duplicate
        for (uint8 i = 0; i < _quickDepositStrategies.length; i++) {
            require(strategies[_quickDepositStrategies[i]].isSupported, "!SPTD");
            // for (uint8 j = i + 1; j < _quickDepositStrategies.length; j++) {
            //     require(_quickDepositStrategies[i] != _quickDepositStrategies[j], "DPLCT");
            // }
        }
...
|    * @param _payoutTimeRange duration to honor payout time. Ex: 15 * 60;
    ...
    */
    function _balance() internal {
        ...
        require(stratsWithWeights.length > 0, "!WGT");
