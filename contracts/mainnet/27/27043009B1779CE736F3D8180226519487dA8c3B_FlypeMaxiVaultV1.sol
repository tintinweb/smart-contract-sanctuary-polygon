...
import {FlypeMaxiVaultV1Storage} from "./abstract/FlypeMaxiVaultV1Storage.sol";
    ...
    // XXXX DONT MODIFY ORDERING XXXX
{
    ...
    function initialize(
        ...
        maxRebalancePayoutFeeBPS = 100; // default: only rebalance if tx fee is lt 2% reinvested
