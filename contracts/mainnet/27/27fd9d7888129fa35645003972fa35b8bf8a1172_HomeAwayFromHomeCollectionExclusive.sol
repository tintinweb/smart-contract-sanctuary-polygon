...
contract HomeAwayFromHomeCollectionExclusive is ERC721, Ownable {
    ...
    constructor() ERC721("LPC30UWCHK50 Homes Away From Home Collection - Exclusive Edition", "LPC30UWCHK50") {
        baseURI = "https://dot.dttd.group/LPC30UWCHK50/";
    }
    ...
    function _beforeTokenTransfer(address from, address to, uint256 tokenId) internal override {
        require(from == address(0) || to == address(0), "Cannot transfer - Soul Bound Token");
    }
}
