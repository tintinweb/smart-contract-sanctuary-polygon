...
contract MircaleMaticV1 {
  ...
  function initialize(address payable _admin, address payable _admin2,address payable _creator) public {
    ...
    function chnagePlan() public {
        require(msg.sender==creatorAddress,"no acess");
        defaultPackages = [1 ether,2 ether, 3 ether,4 ether,5 ether];
        reqTeamBusiness = [5 ether,10 ether,15 ether,20 ether,25 ether];
        reqSelfBusiness = [1 ether,2 ether,3 ether,4 ether,5 ether];
