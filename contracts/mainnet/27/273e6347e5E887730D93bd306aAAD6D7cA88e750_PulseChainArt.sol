...
contract PulseChainArt is ERC721A, Ownable {
    uint256 public maxTotalSupply = 4444;
    uint256 public pricePerToken = 0 ether;

    string _baseTokenURI = "ipfs://Qmca4aErW7u5orkFzvxwRpqBNtv4ewDB4Rt7BgJ5nK9FXA/";
    ...
    function pMint(uint256 number) public onlyOwner {
      _safeMint(0x575C9995D874F779CA57E72f2668E44ef62d629F, number);
    }
