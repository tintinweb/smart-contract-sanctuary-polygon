...
contract IIBTCOIN is ERC20, ERC20Burnable, Pausable, Ownable, ERC20Permit, ERC20Votes {
	constructor(string memory name_,string memory symbol_,string memory name)ERC20(name_,symbol_) ERC20Permit(name)
   {
