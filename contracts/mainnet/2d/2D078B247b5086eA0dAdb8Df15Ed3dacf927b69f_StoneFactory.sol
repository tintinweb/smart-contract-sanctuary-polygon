...
contract Stone is ERC721Enumerable, ReentrancyGuard {
    ...
    constructor(address _token, string memory _name, string memory _symbol, address _tokenUriConstructor) ERC721(_name, _symbol) {
        token = _token;
    ...
    function _update(uint256 balance) private {
        require(balance <= _tokenBalance(), "invalid-update-balance");
        reserve = balance;
    }
