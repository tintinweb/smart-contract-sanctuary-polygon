...
contract LANC is ERC721 {
    ...
    constructor()
        ERC721("LASERED APE NIGHT CLUB", "LANC")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeia34lvaaptg4ho5uh4cna4twqpxlgsr4gj5pj57xte26hu7akkgju/", Strings.toString(tokenId), ".json")
            );
    }
