...
// File: interfaces/IKamiFactory.sol


pragma solidity >=0.8.0;

interface IKamiFactory {
...
// File: interfaces/IKami.sol


pragma solidity >=0.8.0;


interface IKami is IERC20 {
...
contract Unwindooor is Auth {
    ...
    IKamiFactory public immutable factory;
    ...
    constructor(
        ...
        factory = IKamiFactory(factoryAddress);
    }
    ...
    function unwindPairs(
        ...
        for (uint256 i = 0; i < tokensA.length; i++) {
            ...
            if (_unwindPair(IKami(pair), amounts[i], keepToken0, tokenB) < minimumOuts[i]) revert SlippageProtection();
        }
    }
...
contract WethMaker is Unwindooor {
    ...
    function _swap(
        ...
        IKami pair = IKami(factory.getPair(tokenIn, tokenOut));
