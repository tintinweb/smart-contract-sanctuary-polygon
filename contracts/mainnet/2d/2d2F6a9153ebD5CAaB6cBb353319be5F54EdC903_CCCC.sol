...
contract CCCC is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("CCCC", "CCCC") {
  ...
  string private customContractURI =
    "https://gateway.pinata.cloud/ipfs/QmXQefNatsrAVk85cV71bHN9BYsxzdxF4mkFgBxqviik5c/";
