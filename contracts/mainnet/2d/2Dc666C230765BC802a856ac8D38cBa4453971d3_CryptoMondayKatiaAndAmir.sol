...
contract CryptoMondayKatiaAndAmir is ERC721, ERC721Enumerable, ERC721Burnable, ERC721Royalty, Ownable {
    ...
    constructor(address trustedForwarder) ERC721("CryptoMondayKatiaAndAmir", "CMKA_E10") {
        _tokenIds.increment();
    ...
    function mint(uint ammount) public payable {
        uint8 purchased = _holders[_msgSender()];
        uint8 newPurchaseTotal = purchased + 1;
        ...
        require(_tokenIds.current() <= MAX_SUPPLY, "Purchase would exceed max tokens");
