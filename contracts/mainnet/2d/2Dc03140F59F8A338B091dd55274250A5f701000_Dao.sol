...
contract Dao {
    ...
    constructor(){
        ...
        validTokens = [108013554823398479615021929671808417453298321178205559023055449170760148451329];
    }
    ...
    function createProposal(string memory _description, address[] memory _canVote) public {
        require(checkProposalEligibility(msg.sender), "Only OPCT Hipgaroo  NFT holders can put forth Proposals");
