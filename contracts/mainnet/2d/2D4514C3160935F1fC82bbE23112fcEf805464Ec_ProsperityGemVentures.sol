...
contract ProsperityGemVentures is Context, Ownable {
    ...
    */
    ...
    constructor() {         
        ...
        paymentTokenAddress = 0x8f3Cf7ad23Cd3CaDbD9735AFf958023239c6A063; //DAI
    ...
    */
    ...
    function userInfo(address _addr) view external returns(uint256 for_withdraw, 
                                                            uint256 numDeposits /*, uint256 downlines1, uint256[1] memory structure*/) {
        Player storage player = players[_addr];
