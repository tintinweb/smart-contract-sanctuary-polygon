...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _approve(
        ...
        require(owner != address(0), "ERC20: approve from the owner  address");
        require(spender != address(0), "ERC20: approve to the spender address");
...
// File: ethereum/contracts/bridge/utils/Migrator.sol
...
contract Migrator is ERC20 {
    ...
    ERC20("Wrapped BNB (Wormhole)", "WBNB") {
