...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _setPause(uint256 oneOrZero) internal virtual {
        pause = oneOrZero;
    }
...
contract FF721Pro is ERC721Enumerable, Controllable {
        ...
        function postSetTokenURI(uint256 tokenId, string memory _tokenURI) external onlyController {
            require(_exists(tokenId), "ERC721Metadata: URI set of nonexistent token");
            _tokenURIs[tokenId] = _tokenURI;
        }
        ...
        function setpause(uint256 oneOrZero) external onlyOwner {
            _setPause(oneOrZero);
        }
        ...
        function mint(
            ...
            _mint(_to, counter);
            _setTokenURI(counter, tokenURI_);
            counter++;
        }
    }