...
DOGOCOIN  A next evolution DEFI -GAME - METAVERSE exchange on Binance Smart Chain (BSC) BEEP20 - FANTOM (FTM) - POLYGON (MATIC) 
...
contract DOGOCOIN is Context, IERC20, Ownable {
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x156deB7033D40e41C7c5Cf8071CEc16A9F8c7EcE, 'We can not exclude Uniswap router.');
