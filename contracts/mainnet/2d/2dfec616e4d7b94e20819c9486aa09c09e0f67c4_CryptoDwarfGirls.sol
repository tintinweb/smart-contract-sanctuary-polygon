...
Crypto Dwarf Girls https://dwarfs.digital/girls/
Discord https://discord.gg/U9dUN9vMYq
...
contract CryptoDwarfGirls is ERC721Enumerable, Ownable {
    ...
    uint public  basePrice = 1*10**16; // 0.01 ETH
    uint public  PriceWhitelist = 1*10**16; // 0.01 ETH
    ...
    constructor(string memory baseURI) ERC721("Crypto Dwarf Girls", "CDG")  {
        setBaseURI(baseURI);
    }
