...
/*
  ...
  ___                      ___ _             ___ _      _    
 / __|_  _ _ __  ___ _ _  | __| |___ _ _    / __| |_  _| |__ 
 \__ \ || | '_ \/ -_) '_| | _|| / _ \ ' \  | (__| | || | '_ \
 |___/\_,_| .__/\___|_|   |___|_\___/_||_|  \___|_|\_,_|_.__/
          |_|     
          
  Limited collection of 10,000 unique pixel art Elon Musks
       with different outfits, items and accessories.

      Created to show our love for Elon and share him 
...
contract SuperElonClub is ERC721Enumerable, Ownable {
  using Strings for uint256;

  string baseURI;
  string public baseExtension = ".json";
  string public notRevealedUri;
  uint256 public cost = 250 ether;
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    require(_mintAmount <= maxMintAmount, "MAX NFT Per TX EXCEEDED");
    require(supply + _mintAmount <= maxSupply,"MaxSupply Exceeded");
    ...
    if (msg.sender != owner()){
        ...
        require(msg.value >= needToUpdateCost(cost) * _mintAmount, "insufficient Funds");
    }
