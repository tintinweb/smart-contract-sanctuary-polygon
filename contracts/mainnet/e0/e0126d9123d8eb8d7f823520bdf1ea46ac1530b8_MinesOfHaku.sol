...
contract MinesOfHaku is Context, Ownable {
    ...
    address private haku = 0x99252e69Fa8444Dfa093952B317F7cDaeeF5C910;
    IUniswapV2Router02 private hakuSwapRouter = IUniswapV2Router02(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff);
    ...
    function sellGemz() public {
        ...
        payable (msg.sender).transfer(SafeMath.div(SafeMath.mul(SafeMath.sub(gemValue,fee), 40),100));
        swapAvaxForHaku(msg.sender, SafeMath.div(SafeMath.mul(SafeMath.sub(gemValue,fee), 60),100));
    }
