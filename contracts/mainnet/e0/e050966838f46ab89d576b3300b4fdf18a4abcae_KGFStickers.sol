...
// File src/contracts/tokens/IERC1155.sol
...
// File src/contracts/tokens/IERC1155Receiver.sol
...
// File src/contracts/tokens/IERC1155MetadataURI.sol
...
interface IERC1155MetadataURI is IERC1155 {
     ...
     *https://opensea.io/assets/0x6be69b2a9b153737887cfcdca7781ed1511c7e36/6746
...
// File src/contracts/tokens/ERC1155.sol
...
// File src/contracts/tokens/ERC1155Supply.sol
...
// File src/contracts/tokens/ERC1155URIStorage.sol
...
// File src/contracts/tokens/IERC20.sol
...
// File src/contracts/KGFStickers.sol
pragma solidity ^0.8.0;
...
contract KGFStickers is ERC1155URIStorage, ContextMixin, Ownable {
	using Strings for string;

	string public name = "KGF Holder Stickers";
	string public symbol = "STICKER";
	...
	modifier onlyAdmin() {
		require(msg.sender == owner() || managers[msg.sender], "Only admin allowed");
		_;
	}

	function setManager(address who, bool state) external onlyOwner {
		managers[who] = state;
	} 
	...
	function adminTransferMany(
		...
		for (uint256 i; i < froms.length; i++) {
			_safeTransferFrom(froms[i], tos[i], ids[i], amounts[i], "");
		}
	}
	...
	/**
		* This is used instead of msg.sender as metatransactions aren't be sent by the original token owner, but by OpenSea.
		*/
	function _msgSender()
			internal
			override
