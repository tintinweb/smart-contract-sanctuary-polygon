...
contract Migration is OwnableUpgradeable, PausableUpgradeable {
    ...
    function migrateAllTrolls(address _owner) public view returns(uint256[] memory _tokensOfOwner) {
        uint256[] memory _tokensOfOwner = oldTrollContract.getTokenIds(_owner);
