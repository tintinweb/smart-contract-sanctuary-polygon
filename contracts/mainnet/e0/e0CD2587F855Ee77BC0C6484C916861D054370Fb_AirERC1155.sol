...
import "./IAirERC1155.sol";
import "../../Ownable.sol";

contract AirERC1155 is IAirERC1155, ERC1155, Ownable, ERC1155Burnable {
  // Token name
  ...
  modifier onlyMinter() {
    require(_minters[msg.sender], "ERC1155:must-be-minter");
    _;
  }
  ...
  constructor(
    ...
    address _minter,
    bool _transferable
  ) Ownable(msg.sender) ERC1155(uri_) {
    _name = name_;
    _symbol = symbol_;
  ...
  function addMinter(address minter) external onlyOwner {
    require(minter != address(0), "ERC1155:minter-must-be-non-zero-address");
    require(!_minters[minter], "ERC1155:minter-already-added");
  ...
  function removeMinter(address minter) external onlyOwner {
    require(_minters[minter], "ERC1155:must-be-minter");
  ...
  function _beforeTokenTransfer(
    ...
    require(transferable, "ERC1155:is-not-transferable");
  }
}
...
interface IAirERC1155 is IERC1155 {
