...
contract ghost786 is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Ghost.786", "G786") {
    setHiddenMetadataUri("ipfs://QmVDqd726Y2DZg1hwsTNkwFJz73WdPFYGsVmogv53JYGix/hidden.json");
  }
