...
import { BaseVault, IBhavishAdministrator, IBhavishPrediction, IERC20Metadata, SafeERC20, IERC20 } from "./BaseVault.sol";
...
contract BhavishLossyVault is AccessControl, BaseVault {
    ...
    function withdrawAsset(uint256 shares) external nonReentrant {
        ...
        require(_amount <= IERC20(asset()).balanceOf(address(this)), "cannot withdraw > contract balance");
