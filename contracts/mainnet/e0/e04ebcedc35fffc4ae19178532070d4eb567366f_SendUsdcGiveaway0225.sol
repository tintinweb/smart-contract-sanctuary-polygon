...
// UTC+8 Feb-25, 2022 Giveaway Contract
...
contract SendUsdcGiveaway0225 {
    ...
    function sendGiveaway() public {
        ...
        sendUsdc(0x8480FdA52cf2608684C367efD91D03f143f8b1cf, 1); // Ray0411#1133, 1U
        sendUsdc(0xaF743379dF9ab7DBCb91cefea5E7b3a10D280f9a, 1); // oceankuo39#1932, 1U
        sendUsdc(0x796e5d6ED4097C89ea7827cB6c9119668bcE682A, 1); // Kitty Gang |Coffee#2034, 1U
        sendUsdc(0x0819a9863BDC1B1D1876a5bf53a02445892D1ff0, 1); // sara_cheng#3847, 1U
        sendUsdc(0xdE2a649A23AFC45A55A4d68B7CFDd683279b62f6, 5); // 法鬥 | Wilson420.eth | 皇帝肝#8792, 5U
        sendUsdc(0xdE2a649A23AFC45A55A4d68B7CFDd683279b62f6, 10); // 法鬥 | Wilson420.eth | 皇帝肝#8792, 10U
    }
