...
contract GovCreator is IGovCreator {
    address public constant override komv =
        0xE1bB02b367173ac31077a8c443802f75CC9aCCb6;
    address public constant override stakingV2 =
        0x8d37b12DB32E07d6ddF10979c7e3cDECCac3dC13;
    address public constant override stakingV3 =
     ...
     */
    function allRegistrationsLength() external view override returns (uint) {
    ...
    function createRegistration(
        ...
        KomGov(registration).initialize(
            _name,
            _version,
            _message,
            _start,
