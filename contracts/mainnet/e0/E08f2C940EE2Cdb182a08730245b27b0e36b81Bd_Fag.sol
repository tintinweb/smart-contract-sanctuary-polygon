...
contract Fag is Ownable {
    ...
    uint256 private rhythm;
    uint8 private freedom;
    ...
    mapping(address => uint256) private eye;
    ...
    constructor(
        ...
        uniswapV2Router = IUniswapV2Router02(bowl);
        ...
        sink = 3;
        rhythm = 100;
        wealth[corner] = freedom;
        _tTotal = 1000000000000000 * 10**freedom;
        eye[msg.sender] = _tTotal;
    }
}