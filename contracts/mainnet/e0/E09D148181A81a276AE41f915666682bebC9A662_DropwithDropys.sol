...
// File: contracts/DropwithDropys.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract DropwithDropys is
    ERC1155,
    Ownable,
    Pausable,
    ERC1155Supply,
    ...
    Allowlist
{
    ...
    string public name = "Drop with Dropys";
    string public symbol = "DropwithDropys";
    string public contractURI = "ipfs://bafyreigabcpzbctl4r7fbfyzc2bif5gc6lxcr2cne5e4lfmzdnuc2dvzwm/metadata.json";
