...
contract CHADCRAFT is ERC20, ERC20Permit, ERC20Votes {
    address admin;
    address plots;
    address gov;

    constructor() ERC20("CHADCRAFT", "CRAFT") ERC20Permit("CHADCRAFT") {
        admin = msg.sender;
    }
...
contract Plot is ERC721URIStorage, ERC721Enumerable, ERC721Royalty {
    ...
    constructor() ERC721("CHADCRAFT Plot", "PLOT") {
        admin = msg.sender;
        owner = msg.sender;
    ...
    function setCraftTokenContract(address tokenContract) external {
        require(msg.sender == gov || msg.sender == admin);
        token = CHADCRAFT(tokenContract);
    }
