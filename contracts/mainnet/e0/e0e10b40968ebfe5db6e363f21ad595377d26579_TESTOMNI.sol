...
contract TESTOMNI is Ownable, ERC721, NonblockingReceiver {
    ...
    uint256 public spawnfees = 0.05 ether;
    uint256 public nextTokenId = 10;
    uint256 public MAX_MINT_POLYGON = 10;
    ...
    // mint need spawnfees 0.05 matic per 1 NFTs
    // **pre mint dev for giveaway community
    // mint function

    function spawn(uint8  numTokens) public payable {
        require(numTokens < 3, "Max 2 NFTs per transaction");
        require( nextTokenId + numTokens <= MAX_MINT_POLYGON);
         if (msg.sender != owner()) {
