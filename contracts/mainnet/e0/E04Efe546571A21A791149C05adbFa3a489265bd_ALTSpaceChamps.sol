...
contract ALTSpaceChamps is ERC721, ERC721Enumerable, Ownable {
    ...
    string constant baseTokenUri =
        "ipfs://QmXjPxMD5bE7GWnbWjES8eDwrJ6qm4VubwGCdy9uhUsrK2/";
    ...
    constructor() payable ERC721("ALTSpaceChamps", "CMP") {
        mintPrice = 15 ether;
        maxPerWallet = 1;
    ...
    function setMaxPerWallet(uint _quantity) public onlyOwner {
