...
contract REPLACE_ME is Executor {
     ...
     * 
     */
    constructor(address vrfCoordinator) Executor("ReplaceMe", "REPLACE_ME", vrfCoordinator) {
        _admin = msg.sender;
    }
...
contract MintBurn is Core {
    ...
    constructor(string memory name_, string memory symbol_) Core(name_, symbol_) {
        ...
        mintPrice = 4200000000000000000; //4.2 MATIC
    }
    ...
    function _mint(address to, uint256 tokenId) internal virtual {
        ...
        _baseline[tokenId] = int256(mintPrice); //TODO: casting...
