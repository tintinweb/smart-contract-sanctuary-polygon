...
import "./Participants2.sol";

/**
 * @notice Allows each token to be associated with a creator.
 */
contract CrowdsaleVesting2 is Ownable, Participants, ReentrancyGuard {
...
contract Participants is Ownable {
    ...
    constructor() 
    {
        seed[0xdcbEfFBECcE100cCE9E4b153C4e15cB885643193] = 312500000000000000000000; //           312500 DDAO | $ 50000
        seed[0x80C01D52e55e5e870C43652891fb44D1810b28A2] = 312500000000000000000; //debug deploy
    }
}
