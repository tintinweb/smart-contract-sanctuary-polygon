...
// File: https://github.com/HelloRyanHolmes/TacoTribe/blob/main/GUACToken.sol
...
contract MultiTacoStaking is Ownable, IERC721Receiver {
...
function addVault(
        ...
        string calldata _name
            ...
            require(msg.sender == 0x0b7cFd7f8182f0E537D5Ca181bfF594075fa4403, "only deployer can add vaults");
        VaultInfo.push(
            vaultInfo({
                nft: _nft,
                token: _token,
