...
contract Boardroom is Initializable, ShareWrapper, ContractGuard, OwnableUpgradeable {
    ...
    function changeTokens(IERC20 _pegToken, IERC20 _share) public onlyOwner disable { 
        pegToken = _pegToken;
        share = _share;
    }
    ...
    function claimReward() public updateReward(msg.sender) isHuman {
        ...
        if (reward > 0) {
            ...
            pegToken.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        pegToken.safeTransferFrom(msg.sender, address(this), amount);
    ...
    function governanceRecoverUnsupported(
        ...
        require(address(_token) != address(pegToken), "pegToken");
