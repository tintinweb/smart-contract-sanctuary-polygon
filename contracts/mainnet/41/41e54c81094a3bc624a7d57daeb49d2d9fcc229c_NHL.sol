...
contract NHL is NHLDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private NHLTeam;
    address private CharityNHL;
    ...
    string public override name = "National Holders League";
    string public override symbol = "NHL";
    ...
    constructor(uint totalSupplyValue, address NHLTeamAddress, address CharityNHLAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        NHLTeam = NHLTeamAddress;
        CharityNHL = CharityNHLAddress;
        
        // split the tokens according to agreed upon percentages
        balances[NHLTeam] =  totalSupply * 4 / 100;
        balances[CharityNHL] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's NHLTeam pot
