...
contract Gen3Controller is AccessControl{
    ...
    modifier canMint(address _address){
        require(viewTimeUntilNextMint(_address) == 0, "Slow down there bub! Come back later." );
        _;
    }

    // MINT .............................................................................

    function mintWithTrash() public canMint(msg.sender) returns(bool){
        ...
        mint(msg.sender);
        recentMint[msg.sender] = block.timestamp;
        return true;
    }

    function mintWithMatic() public payable canMint(msg.sender) returns(bool){
    ...
    function hatch(uint _tokenId) public returns(bool){
        ...
        // require(viewTokenHatched(_tokenId) == false, "This token has already been hatched.");
    ...
    function viewTimeUntilNextMint(address _address) public view returns(uint){
        uint _time = block.timestamp - recentMint[_address];
        if (_time<mintCooldown){
            _time = mintCooldown - _time;
            return _time;
        }
        else{
            return 0;
    ...
    function viewTokenHatched(uint256 tokenId) public view returns (
            string memory image,
            uint birthday,
            bool hatched,
            uint seed,
        ...
        return IGen3Token(gen3_tokenContract).tokens(tokenId);
    }
