...
/**
 ________  ________  ___  __    ___  ___  _______   ________      
*/

pragma solidity ^0.8.0;

contract ranque is ERC721A, Ownable {
    using Strings for uint256;
    ...
    uint256 public mintableSupply = 50;
    bool public revealed = false;
    bool public saleStarted = false;
    bool public onlyWhitelisted = false;
    bool public onlyOrigin = true;
    ...
    constructor(
        ...
        uint256 maxBatchSize_, // maxMintAmount
        uint256 collectionSize_ // maxSupply
    ) ERC721A(_name, _symbol, maxBatchSize_, collectionSize_) {
        maxPerMint = maxBatchSize_;
    ...
    //origin sale
    function setOnlyOrigin() public onlyOwner {
        onlyWhitelisted = false;
        onlyOrigin = !onlyOrigin;
    }

    function isOrigin(address _user) public view returns (bool) {
        for (uint256 i = 0; i < originAddresses.length; i++) {
            if (originAddresses[i] == _user) {
                return true;
            }
        }
        return false;
    ...
    function mint(uint256 tokens) public payable {
        ...
        require(
            totalSupply() + tokens <= mintableSupply,
            "Minting would exceed max supply"
        );

        if (msg.sender != owner()) {
            if (onlyOrigin) {
                require(isOrigin(msg.sender), "User is not Origin");
                uint256 ownerMintedCount = balanceOf(msg.sender);
                require(
                    ownerMintedCount + tokens <= 1,
    ...
    address[] public originAddresses = [
        0x6EB38E55816eA81CdEF385Bd319d15b7fC512C65,
        0xA86350A8Cb77718A9580Dadd0aB6e3f0b34bD36b
    ];

    address[] public whitelistedAddresses = [
        0x6EB38E55816eA81CdEF385Bd319d15b7fC512C65,
        0xA86350A8Cb77718A9580Dadd0aB6e3f0b34bD36b,
        0x413556236aE34653E1ed716D83cfe132B3F3bc0d,
        0xb78a6997Db1EA4d509C1CeEE4F1F1d3e7ae8F728
    ];
}