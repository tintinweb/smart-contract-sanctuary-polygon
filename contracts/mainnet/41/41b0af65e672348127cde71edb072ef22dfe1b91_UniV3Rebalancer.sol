...
contract UniV3Rebalancer is OwnableUpgradeable, IUniV3Rebalancer {
  ...
  function inRangeCalc(IStrategyRebalanceStakerUniV3 _dysonStrategy) public view returns (bool) {
    IUniswapV3Pool uniPool = IUniswapV3Pool(_dysonStrategy.pool());
    (, int24 _currentTick, , , , , ) = uniPool.slot0();

    return _currentTick > _dysonStrategy.tick_lower() && _currentTick < _dysonStrategy.tick_upper();
  }
