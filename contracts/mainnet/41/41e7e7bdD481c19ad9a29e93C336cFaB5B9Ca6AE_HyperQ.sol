...
contract HyperQ is IERC20Upgradeable, OwnableUpgradeable {
    ...
    {
        address owner_ = 0x3A21B0B6C3A7727980a590F5Cc527B93E438c256;    // Owner address.        
        _router = 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff;           // QuickSwap router.
        _marketingAddress = 0xf30f37c790f968B793d0d6c04F6508A034e9b9E5; // Marketing wallet.
        _name = "HyperQ";
        _symbol = "HPQ";                          
    ...
    function setTxFees(uint256 liquidityFeeBps, uint256 taxFeeBps, uint256 marketingFeeBps) external onlyOwner()
    {
          ...
          require(taxFeeBps <= 500, "Set Lower Fees Max Fees is Set to 5%");
          require(marketingFeeBps <= 500, "Set Lower Fees Max Fees is Set to 5%");
          require(liquidityFeeBps + taxFeeBps + marketingFeeBps <= 500);
