...
contract Hypervisor is IAlgebraMintCallback, ERC20Permit, ReentrancyGuard {
    ...
    int24 public baseLower = -6000;
    int24 public baseUpper = 6000;
    int24 public limitLower = -600;
    int24 public limitUpper = 600;
   ...
   event Deposit(
    ...
    function zeroBurn() public returns(uint128 baseLiquidity, uint128 limitLiquidity) {
