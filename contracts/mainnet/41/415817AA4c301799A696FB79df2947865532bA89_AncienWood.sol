...
contract AncienWood is ERC20, EIP712, Ownable {

    bool public isMintOpen = true;
    bool public isBurnOpen = true;
    ...
    string public SIGNING_DOMAIN_NAME = "AncienWood";
    ...
    constructor() ERC20("AncienWood", "ANCIENWOOD") EIP712(SIGNING_DOMAIN_NAME, SIGNING_DOMAIN_VERSION){
        isMintOpen = true;
        isBurnOpen = true;
    }
