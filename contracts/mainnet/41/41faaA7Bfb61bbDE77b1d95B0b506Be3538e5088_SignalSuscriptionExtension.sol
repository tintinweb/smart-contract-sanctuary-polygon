...
contract SignalSuscriptionExtension is BaseGlobalExtension {
    ...
    //      address target
    // );
    event SetSubscribeStatus(IJasperVault indexed _jasperVault, bool status);
    ...
    //jasperVault subscribe address
    // mapping(IJasperVault=>address) public subscribeTargetList;

    //jasperVault subscribe  status
    // mapping(IJasperVault=>bool) public subscribeStatusList;
        ...
        onlyOperator(_jasperVault)
    {
        ...
        _manager(_jasperVault).setSubscribeStatus(true);
        emit SetSubscribeStatus(_jasperVault, true);
    }
        ...
        onlyOperator(_jasperVault)
    {
        ...
        _manager(_jasperVault).setSubscribeStatus(false);
        emit SetSubscribeStatus(_jasperVault, false);
    }
