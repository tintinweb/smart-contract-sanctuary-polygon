...
// File: contracts/Herminius_Shell.sol
...
contract Herminius_Shell is ERC2981, ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, ERC721Burnable, Ownable {
    ...
    function setRoyalties(uint256 _tokenId, address _receiver, uint256 _percentage) public onlyOwner {
        setRoyalties(_tokenId, _receiver, _percentage);
    }
    ...
    function getSupply() public view{
        totalSupply();
    } 
