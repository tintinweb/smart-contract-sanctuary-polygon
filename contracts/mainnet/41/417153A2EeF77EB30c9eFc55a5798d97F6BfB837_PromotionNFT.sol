...
contract PromotionNFT is ERC721Mintable, ERC721Permit("PromotionNFT:Token") , Ownable, ERC721URIStorage{
    string public _defaultURI;
    
    event UpdateDefaultURI(string defaultURI);

    constructor() ERC721("PromotionNFT:Token", "PR") {
        setDefaultURI("https://nft-studio.com/api/metadata/promotion/");
    }
