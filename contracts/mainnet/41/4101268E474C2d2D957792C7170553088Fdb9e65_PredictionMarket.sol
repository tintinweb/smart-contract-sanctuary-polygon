...
contract PredictionMarket is OptimisticOracleV3CallbackRecipientInterface {
    ...
    OptimisticOracleV3Interface public immutable optimisticOracleV3; // Optimistic Oracle V3 used to resolve markets.
    ...
    function initializeMarket(
        ...
        ExpandedIERC20 outcome1Token = new ExpandedERC20(string(abi.encodePacked(outcome1, " Token")), "O1T", 6);
        ExpandedIERC20 outcome2Token = new ExpandedERC20(string(abi.encodePacked(outcome2, " Token")), "O2T", 6);
    ...
    function assertMarket(bytes32 marketId, string memory assertedOutcome) public returns (bytes32 assertionId) {
        ...
        uint256 minimumBond = optimisticOracleV3.getMinimumBond(address(currency)); // OOv3 might require higher bond.
    ...
    function assertionResolvedCallback(bytes32 assertionId, bool assertedTruthfully) public {
        require(msg.sender == address(optimisticOracleV3), "Not authorized");
