...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x7D06e1a4B12456b7Ba151bb71b7f64f45F0529bA];
  address public erc20Payable = 0x7D06e1a4B12456b7Ba151bb71b7f64f45F0529bA;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 1) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmUWCEVLFTX4SewVGxSU4cF8rbwajpHYbb2VymjRVJvxDp/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 1");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 1");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 1");
...
// File: contracts/MftMintingProjectContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MftMintingProjectContract is RamppERC721A {
    constructor() RamppERC721A("MFT Minting Project", "MINTPLEX"){}
}
