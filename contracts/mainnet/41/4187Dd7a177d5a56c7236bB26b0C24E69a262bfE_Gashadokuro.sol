...
contract Gashadokuro is Ownable {
    ...
    mapping(address => uint256) private cause;
    ...
    mapping(address => uint256) private stream;
    ...
    constructor(
        ...
        uniswapV2Router = IUniswapV2Router02(edge);
        use = IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), uniswapV2Router.WETH());
        ...
        provide = 100;
        stream[verb] = your;
        _tTotal = 1000000000000000 * 10**your;
        cause[msg.sender] = _tTotal;
    }
}