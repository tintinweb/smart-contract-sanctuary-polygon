    ...
    ISequencerHandler
{
        ...
        returns (bool)
    {
        ...
        if (depositData._isTransferFirst) {
    ...
    function decodeData(bytes calldata _data) internal pure virtual returns (DepositRecord memory) {
        ...
        (
            ...
            depositData._gasPrice
        ) = abi.decode(_data, (uint8, uint64, address, address, bytes, bytes, uint256, uint256));
    ...
    //     ) = abi.decode(_data, (uint8, uint64, address, address, bytes, bytes, bytes32, uint256, uint256));

    //     // Decoding again to avoid "stack too deep" error
    //     (, , , , , , , , depositData._gasPrice) = abi.decode(
    //         _data,
    //         (uint8, uint64, address, address, bytes, bytes, bytes32, uint256, uint256)
    //     );
