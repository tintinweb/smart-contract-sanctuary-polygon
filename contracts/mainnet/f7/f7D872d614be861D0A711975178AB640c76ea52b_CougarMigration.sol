...
contract CougarMigration is ReentrancyGuard 
{
    ...
    // Price of presale COUGAR: 10000 = 1 BuyToken
    uint256 private constant BuyTokenPerCGS = 333;
    ...
    // Max Buy Per User
    uint256 public maxBuyPerUser = 4000000*(1e18); // decimal 18

    uint256 public firstHarvestTimestamp;

    address payable owner;

    uint256 public constant COUGAR_HARDCAP = 4000000*(1e18);
    ...
    function buy(uint256 _amount, address _buyer, address _referrer) public nonReentrant {
        ...
        uint256 tokens = _amount.div(BuyTokenPerCGS).mul(10000);
