...
contract Claimer is IClaimer, Ownable, GeneralClaimer, WithDiamondHands {
    ...
    function batchAddAllocation(address[] calldata addresses, uint256[] calldata allocations) external override onlyOwner {
...
abstract contract WithDiamondHands is Ownable, AccessControl, GeneralClaimer {
    ...
    function getIneligibleAccounts() external view returns (address[] memory) {
...
abstract contract GeneralClaimer is IClaimer, Ownable {
    ...
    function getAccounts() public view override returns (address[] memory) {
        return accounts;
    }
