...
contract Property{
    ...
    function sushiSwapper(address[] memory path,uint amountIn,uint amountOut) public{
        address token = path[0];
        IERC20(token).approve(SushiSwapRouterAddr,amountIn);
    ...
    function sushiSwapper_1(address[] memory path,uint amountIn,uint amountOut) public{
