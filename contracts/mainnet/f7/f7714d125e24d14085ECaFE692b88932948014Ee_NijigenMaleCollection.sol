...
contract NijigenMaleCollection is ERC721A, ERC2981 ,ReentrancyGuard, Ownable, Pausable, DefaultOperatorFilterer {
    using Strings for uint256;

    string private baseURI = "ar://MjKXvYbxw9VO_hJ2m6hAYxDzx-3lzFmlNsT1zBaJNoU/";

    uint256 public publicCost = 0.013 ether;
    ...
    constructor() ERC721A("NijigenMaleCollection", "NIJIGEN") {
    ...
    /**
     * @notice DefaultOperatorFilterer
     */
