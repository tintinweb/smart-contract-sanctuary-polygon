...
/**
 * Main EIP4337 module.
 * Called (through the fallback module) using "delegate" from the Safe as an "IAccount",
 * so must implement validateUserOp
 * holds an immutable reference to the EntryPoint
 * Inherits Safe so that it can reference the memory storage
 */
contract EIP4337Manager is IAccount, SafeStorage, Executor {
    ...
    /**
     * Validate this Safe is callable through the EntryPoint.
