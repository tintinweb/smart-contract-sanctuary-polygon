...
contract NVMTimelock is INVMTimelock {
    ...
    constructor(address _admin, uint256 _delay) {
        ...
        require(_delay <= MAXIMUM_DELAY, "Delay is too long");
    ...
    function queueTransaction(
        ...
        require(_eta >= getBlockTimestamp().add(delay), "ETA to small");
    ...
    function executeTransaction(
        ...
        bytes32 _txHash = keccak256(abi.encode(_target, _value, _signature, _data, _eta));
        require(queuedTransactions[_txHash], "Transaction hasn't been queued");
        require(getBlockTimestamp() >= _eta, "Transaction is still locked");
        require(getBlockTimestamp() <= _eta.add(GRACE_PERIOD), "Transaction is stale");
