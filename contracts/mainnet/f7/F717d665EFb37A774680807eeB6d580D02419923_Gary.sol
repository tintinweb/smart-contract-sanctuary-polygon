...
contract Gary is ERC20, Ownable {
    ...
    address public devWallet;
     address public CompaignsAddress;
    ...
    constructor() ERC20("$GARY", "$GARY") {
        ...
        uint256 _sellDevFee = 1;
          ...
          uint256 _sellCompaignsFee=5;
 
        uint256 decimals = 18;
        uint256 totalSupply = 480000000000000 * (10 ** decimals);


 
        maxTransactionAmount = totalSupply * 20 / 1000; // 2.0%
        maxWallet = totalSupply * 20 / 1000; // 2.0% 
        swapTokensAtAmount = totalSupply * 5 / 1000000; // 0.05%
        ...
        marketingWallet = address(0xE4135A78FD565985284B4dDed9C846Eaf9000d15);
        devWallet = address(0xb6C3feBe04581a87676aA450941b23EfC4aE60b0);
             CompaignsAddress=address(0xb194499388175ea396ABD69bBB8494a30AE4f757);
    ...
    function updateBuyFees( 
        ...
        buyCompaignsFee=_CompaignsFee;
        buyTotalFees = buyDevFee + buyLiquidityFee + buyMarketingFee+buyCompaignsFee;
    ...
    function updateSellFees(
        ...
        sellCompaignsFee=_CompaignsFee;
        sellTotalFees = sellDevFee + sellLiquidityFee + sellMarketingFee+sellCompaignsFee;
    ...
    function swapBack() private {
        ...
        uint256 ethForCompaigns = ethBalance.mul(tokensForCompaigns).div(totalTokensToSwap);

        uint256 ethForLiquidity = ethBalance - ethForMarketing - ethForDev - ethForCompaigns;
