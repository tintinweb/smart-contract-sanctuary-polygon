...
contract GoodFortuneRabbit is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    address private _w1 = 0x84392D10FbbF55C21d5A3265f484886cf6DB384a;

    constructor() ERC721('Good Fortune Rabbit', 'GFR') {
    }
