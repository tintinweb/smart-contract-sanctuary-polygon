...
contract SkinRewards is IDescriptorUser, AccessControlEnumerableUpgradeable, PausableUpgradeable {
  ...
  function readMyBalance() public view returns(uint) {
    return _skill.balanceOf(address(this));
  }

  function sendBalance(address to, uint amount) public onlyRole(PAUSER_ROLE) {
