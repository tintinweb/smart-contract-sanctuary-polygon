...
contract S1CombinationToken is ICombinationToken, Basis {
    ...
    uint256 public maxTotalSupply = 380;
    ...
    */
    ...
    /*
        ...
        @dev Function calls validateCombination in BaseToken.sol smart contract for Combination
             NFT validation and gets "True" response if combination is a trophy one
        @dev Save Combination token name, "is trophy" flag and 13 parent of newly minted Combination token
        @param _parents - array of Base token IDs 13 Base NFT from which Combination NFT should be minted
    ...
    */
    ...
    function payoutReward() external virtual {
        ...
        require(!paidOut, "S1CombinationToken: reward is already paid out");
        paidOut = true;
