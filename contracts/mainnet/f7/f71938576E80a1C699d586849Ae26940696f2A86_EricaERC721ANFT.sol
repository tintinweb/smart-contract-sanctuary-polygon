  ...
  IERC721Enumerable
{
  ...
  function totalSupply() public view override returns (uint256) {
    return currentIndex;//目前鑄造數量 多一個就+1
  }
  ...
  function _numberMinted(address owner) internal view returns (uint256) {
    require(
      owner != address(0),
      "ERC721A: number minted query for the zero address"//鑄造很多如多都是同一個地址就只在一開始寫入，減少gasfee
    );
 ...
 */
contract EricaERC721ANFT is ERC721A, Ownable {
  ...
  constructor(
    ...
    uint256 collectionSize_
  ) ERC721A("EricaERC721ANFT", "ENFT", maxPerBatchMintSize_, collectionSize_) {
