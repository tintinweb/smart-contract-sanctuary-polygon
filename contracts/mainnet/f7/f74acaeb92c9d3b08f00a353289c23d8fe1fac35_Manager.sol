...
* the project is developed in solidity, react, nosql, node.js and c#
*****************************************************************************
...
contract Manager is VRFConsumerBaseV2 
{
  ...
  */
  ...
  event EventRandomResult(address indexed raffle, uint id, uint quant, uint256 requestId, uint256 randomWords, uint256 result, uint256 timestamp); 
...
/// @notice creation init raffle contract 
  ...
  function resultRandom(uint256 requestId, uint256 randomWord) private
  {
    ...
    //
    uint result = (randomWord % tokenCount);
