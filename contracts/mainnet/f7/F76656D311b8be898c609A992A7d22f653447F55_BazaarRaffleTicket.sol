    ...
    MultiAccessControl
{
    ...
    uint256 private currentTradeId;
    ...
    function executeTrade(uint256 tradeId) external returns (uint256) {
        ...
        emit FinishTrade(
            msg.sender,
            tradeId,
            uint8(_transactions[tradeId].tradeStatus)
        );
        return tradeId;
    }
    ...
    function startTrade(
        ...
        currentTradeId++;
        _transactions[currentTradeId].id = currentTradeId;
        _transactions[currentTradeId].creator = creatorAddress;
        _transactions[currentTradeId].executor = executerAddress;
        ...
        _transactions[currentTradeId].tradeStatus = TradeStatus.TRADE_CREATED;
        _allTradesPerUser[creatorAddress].push(currentTradeId);
        _allTradesPerUser[executerAddress].push(currentTradeId);
        emit NewTrade(creatorAddress, executerAddress, currentTradeId);
        openTradeCount = openTradeCount + 1;
...
// File: full-tokens/BazaarGiveaway.sol
    ...
    ERC721Holder
{
    ...
    uint256 public BRONZE_PRICE = 500000000000000000; // 0.5 stable
    uint256 public SILVER_PRICE = 2500000000000000000; // 2.5 stable
    uint256 public GOLD_PRICE = 5000000000000000000; //  5  stable
        ...
        )
    {
        ...
        _bazaarContract = 0xa80e4eA13aC0d8Fb1bfD1f57697cB49B445eF8Db;
    }
