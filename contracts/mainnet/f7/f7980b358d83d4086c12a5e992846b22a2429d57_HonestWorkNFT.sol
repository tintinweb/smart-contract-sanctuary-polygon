            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        '" }, { "display_type": "boost_number", "trait_type": "Gross Revenue ($)", "value": "',
...
contract HonestPayLock is Ownable, ReentrancyGuard, SigUtils {
    ...
    function createDeal(
        ...
        unlockPayment(_dealId, _downPayment, 0);
        return _dealId;
    }
    ...
    function unlockPayment(
        ...
        if (hw721.balanceOf(msg.sender) == 1) {
            ...
            uint256 token_id = hw721.tokenOfOwnerByIndex(msg.sender, 0);
            hw721.recordGrossRevenue(token_id, grossRev);
        }
