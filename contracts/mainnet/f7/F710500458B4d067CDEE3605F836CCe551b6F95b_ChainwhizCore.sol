...
contract ChainwhizCore is ReentrancyGuard {
    ...
    uint256 public MAX_REWARD_AMOUNT = 6000000 ether;
    ...
    uint256 public MAX_COMMUNITY_REWARD_AMOUNT = 6000000 ether;
    ...
    /// @notice Used to set the minimum and maximum reward amount
    ...
    function setMaximumRewardAmount(uint256 _newRewardAmount)
        external
        onlyChainwhizAdmin
        onlyActiveContract
    {
        MAX_REWARD_AMOUNT = _newRewardAmount;
    }
    ...
    /// @notice Used to set the minimum and max community reward amount
    /// @dev The modifier onlyChainwhizAdmin is used so that the current admin can change the minimum stake
        ...
        onlyActiveContract
    {
        ...
        function setMaximumCommunityRewardAmount(uint256 _newCommunityRewardAmount)
        external
        onlyChainwhizAdmin
        onlyActiveContract
    {
        MAX_COMMUNITY_REWARD_AMOUNT = _newCommunityRewardAmount;
    }
    ...
    function initiateEscrow(
        ...
        Bounty storage bounty = bountyDetail[publisher][_bountyUrl];
