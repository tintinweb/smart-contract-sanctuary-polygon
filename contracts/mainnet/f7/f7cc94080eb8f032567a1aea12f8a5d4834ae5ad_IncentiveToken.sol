...
contract IncentiveToken is ERC20, ERC20Burnable, Ownable, ERC20Permit, ERC20Votes {
    constructor()
        ERC20("Incentive token", "TOKIN")
        ERC20Permit("Incentive token")
    {
