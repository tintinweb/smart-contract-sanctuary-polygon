...
contract LibertarianBeerCoin is ERC20, ERC20Burnable, Pausable, Ownable, ERC20Permit {
    constructor()
        ERC20("Libertarian Beer Coin", "LBC")
        ERC20Permit("Libertarian Beer Coin")
    {
