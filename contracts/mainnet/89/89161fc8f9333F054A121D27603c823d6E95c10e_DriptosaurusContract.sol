...
//   _____       _       _                                       
//  |  __ \     (_)     | |                                      
//  | |  | |_ __ _ _ __ | |_ ___  ___  __ _ _   _ _ __ _   _ ___ 
//  | |  | | '__| | '_ \| __/ _ \/ __|/ _` | | | | '__| | | / __|
//  | |__| | |  | | |_) | || (_) \__ \ (_| | |_| | |  | |_| \__ \
//  |_____/|_|  |_| .__/ \__\___/|___/\__,_|\__,_|_|   \__,_|___/
//                | |                                            
//                |_|                                            
//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x9a9b47F127bFc80644386d87b2C4f377a066cbEC];
  address public erc20Payable = 0x9a9b47F127bFc80644386d87b2C4f377a066cbEC;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeicuixlt6ufzrojy7ium72hk34h7u6dqgcxaqtzl2z4r4netzezgpq/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/D2VAEOsWeUYWi8H4aWQZ/contract-metadata";
  }
...
// File: contracts/DriptosaurusContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DriptosaurusContract is ERC721APlus {
    constructor() ERC721APlus("Driptosaurus", "DRPS"){}
}
