...
contract HBDTokenCommunityMinerGlobal {
    using SafeMath for uint256;

    IERC20 public token_BUSD;
	address erctoken = 0xa41B2B17589851fb56DA25b22DdFa415Da184a09; /** mainnet CMG **/
    ...
    uint256 public MIN_INVEST = 10 ether; /** 10 CMT  **/
	uint256 public WITHDRAW_COOLDOWN = 12 * 60 * 60; /** 12 hours  **/
    uint256 public WITHDRAW_LIMIT = 6000 ether; /** 6000 CMT  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 30000 ether; /** 30,000 CMT  **/
