...
contract crackers1 is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("crackers1", "C1") {
    setHiddenMetadataUri("ipfs://bafybeigcji37lzxsctf4krdh7pofz7hdqttcciuxsafbfwbc6byitab73m/hidden.json");
  }
