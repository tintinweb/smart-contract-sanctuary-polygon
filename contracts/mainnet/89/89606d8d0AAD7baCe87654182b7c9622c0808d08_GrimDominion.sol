...
contract GrimDominion is ERC721Enumerable, Ownable, ContextMixin {
  using Strings for uint256;

  string baseURI;
  string public baseExtension = ".json";
  uint256 public mintingCost = 34 ether;
  ...
  //Override isApprovedForAll to auto-approve OpenSea's proxy contract (gasless transactions on OpenSea)
