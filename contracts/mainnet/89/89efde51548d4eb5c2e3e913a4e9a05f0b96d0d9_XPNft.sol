...
// File: contracts/NFT/BridgeNFT.sol
...
contract XPNft is Ownable, ERC721Enumerable, BridgeNFT {
    ...
    modifier onlyBridge() {
        require(_msgSender() == _bridge, "Unauthorised call.");
        _;
    }
    ...
    function updateBridgeAddress(address bridge_) external onlyOwner {
        _bridge = bridge_;
    }
