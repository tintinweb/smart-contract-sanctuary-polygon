...
import { HUNDER_PERCENT, DISTRIBUTOR_ROLE, OPERATOR_ROLE, SERVER_ROLE, UPGRADER_ROLE } from "./libraries/Constants.sol";
    ...
    PaymentUpgradeable
{
    ...
    function distribute(ICryptoPaymentUpgradeable[] calldata instances_) external override onlyRole(DISTRIBUTOR_ROLE) {
    ...
    function setRoleManager(address roleManager_) external onlyRole(UPGRADER_ROLE) {
        roleManager = roleManager_;
    }
