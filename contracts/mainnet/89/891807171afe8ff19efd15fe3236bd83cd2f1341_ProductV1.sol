...
contract ProductV1 is Initializable, NFTV1, IProductV1 {
    ...
    function amendVariantInventory(bytes32 variantId, uint256 newInventory) public onlyRole(ADMIN_ROLE) {
    ...
    function freezeSupply() public onlyRole(OPERATOR_ROLE) {
    ...
    /// @inheritdoc IProductV1
    function freezeSupply(bytes32 variantId) public onlyRole(OPERATOR_ROLE) {
        uint256 index = _variantIndex(variantId);
        uint256 supply = totalSupply(variantId);
    ...
    /// @inheritdoc IProductV1
    function issue(address recipient, bytes32 variantId) public onlyRole(OPERATOR_ROLE) returns (uint256) {
    ...
    /// @inheritdoc IProductV1
    function issueRandom(address recipient, uint256 seed) public onlyRole(OPERATOR_ROLE) returns (uint256) {
    ...
    /// @inheritdoc IProductV1
    function setIssueLimit(uint256 newIssueLimit) public onlyRole(OPERATOR_ROLE) {
    ...
    /// @inheritdoc IProductV1
    function tokenVariant(uint256 tokenId) public view returns (bytes32) {
    ...
    /// @inheritdoc IProductV1
    function totalSupply(bytes32 variantId) public view returns (uint256) {
    ...
    /// @inheritdoc IProductV1
    function variantInventory(bytes32 variantId) public view returns (ProductV1Types.Inventory memory) {
        uint256 index = _variantIndex(variantId);
    ...
    IRoyaltySubscriberV1
{
    ...
    function setRoyaltyProvider(address newRoyaltyProvider) public onlyRole(ADMIN_ROLE) {
