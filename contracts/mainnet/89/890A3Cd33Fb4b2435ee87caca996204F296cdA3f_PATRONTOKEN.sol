 ...
 * @notice This contract handles minting PATRON TOKEN tokens.
 */
contract PATRONTOKEN is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xAf26d11BC98Ee012F045aE668B39D43C45c6671A;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x96e6AC93CC7f0bbeCF80336E2dEde93275fF82A5;
    address[] public payoutAddresses = [
        0x96e6AC93CC7f0bbeCF80336E2dEde93275fF82A5
    ];
    ...
    string public name = "PATRON TOKEN";
    string public symbol = "PATRON";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeiaazppmpizvopj7bf7lp4mhphtdk5suwcsposvmefoujsubpbjih4/{id}"
        )
        RevokableOperatorFilterer(
