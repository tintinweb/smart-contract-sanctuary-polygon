...
contract MintableERC721New is Ownable, ERC721BaseNew {
    ...
    function setMintWhitelist(address account, bool knob) external onlyOwner {
        mintWhitelist[account] = knob;
    }
    ...
    */
    ...
    function safeTransferFrom(
        ...
        if (_exists(tokenId)) {
            ...
            require(
                msg.sender == delegator || mintWhitelist[_msgSender()],
                "MintableERC721New::safeTransferFrom: msg.sender should be a delegator or in mint white list."
            );
