...
contract CBridgeZapv1 is Ownable {
  ...
  function swap2(address _token, uint256 _amount, address _unirouter, address[] memory _path, address[] memory _feepath, address _to, uint64 _desChain) public payable {
  ...
  function swap3(address _token, uint256 _amount, address _unirouter, address[] memory _path, address[] memory _feepath, address _to, uint64 _desChain) public payable {
