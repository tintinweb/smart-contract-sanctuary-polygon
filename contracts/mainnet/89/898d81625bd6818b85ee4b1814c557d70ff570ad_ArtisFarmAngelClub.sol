...
// File: contracts/AngelClubArtisFarm.sol
...
contract ArtisFarmAngelClub is IERC777Recipient {
    ...
    */
    ...
    function compoundYield(address staker) private {
        ...
        require(
            angelClubNFT.balanceOf(staker, angelClubNFTid) > 0,
    ...
    function setArtisAddress(address newAddress) external onlyAdmin{
        artisToken = ERC777(newAddress);
    }
    ...
    function setAngelClubNFTAddress(address newAddress) external onlyAdmin {
        angelClubNFT = ERC1155(newAddress);
    }

    function setNewOwner(address newAddress) external onlyAdmin { 
        ADMIN_ROLE = newAddress;
    }
