...
contract SolarSystem is ERC721, ContextMixin {
    using SafeMath for uint256;

    uint256 private constant TOTAL_SUPPLY = 9;
    ...
    constructor() ERC721("SolarSystem", "SOLSYS") {
    ...
    function _baseURI() internal view virtual override returns (string memory) {
        return "https://ipfs.io/ipfs/QmWDBDTkApJdms6AgWt6cJBJnNTPZXmBzSt2sfEsDjGRwb/";
    }
