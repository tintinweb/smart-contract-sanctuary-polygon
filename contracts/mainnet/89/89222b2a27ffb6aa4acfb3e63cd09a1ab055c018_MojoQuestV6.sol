...
contract MojoQuestV6 is Initializable, UUPSUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable, VRFConsumerBaseUpgradeable{
    ...
    function sendToQuest(uint256 _locationId, uint256 _tokenOne, address _tokenOneContract, uint256 _tokenTwo, address _tokenTwoContract) external nonReentrant{
        ...
        uint256 cost = uint256(loc.hghCost) * 1 ether;
