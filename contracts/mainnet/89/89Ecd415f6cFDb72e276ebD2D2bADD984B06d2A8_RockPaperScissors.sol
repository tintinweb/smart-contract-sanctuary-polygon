...
contract RockPaperScissors is Common {
    ...
    function RockPaperScissors_Play(
        ...
        _transferWager(tokenAddress, wager * numBets, 1100000);
     ...
     */
    function RockPaperScissors_Refund() external {
        ...
        emit RockPaperScissors_Refund_Event(msg.sender, wager, tokenAddress);
    }
