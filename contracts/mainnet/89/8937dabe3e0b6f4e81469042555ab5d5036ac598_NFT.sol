...
/* 
'Art' and 'IP' of Non-Toxic Fun Guys by @fairusabalk follows https://www.nftlicense.org/ 
(Version 2.0 Last Revised: November 5, 2018) Used with permission from Dapper Labs.
*/
...
contract NFT is ERC721Enumerable, Ownable {
  ...
  string public baseExtension = ".json"; //usually .json
  uint256 public cost = 20 ether; // Set this to your cost per NFT
  uint256 public maxSupply = 1000; // Set this to your max # of NFTs for the collection
  uint256 public maxMintAmount = 333; // Set this to your max # of NFTs for any wallet
  address public owner1 = 0x84297370EeC80b64f0248C83fF4b360c2B0D48A2; // Set this to first team member address
  //address public owner2 = 0x66EDC5E13109b9D499EE38b6593994E7CD3217a0; // Set this to second team member address (different address)
