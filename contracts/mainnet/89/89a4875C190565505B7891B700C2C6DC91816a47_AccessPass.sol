...
contract AccessPass is URISwitchable, ERC721, AccessControl, Ownable {  
    ...
    constructor(address[] memory operators, bool approveProxy, address[] memory proxies) ERC721("AccessPass", "AccessPass") {
        ...
        for (uint256 i = 0; i < proxies.length; i++) {
            ...
            _setupRole(PROXY_ROLE, proxies[i]);
        }
    }
    ...
    function _isApprovedOrOwner(address spender, uint256 tokenId)
        ...
        returns (bool)
    {
        return super._isApprovedOrOwner(spender, tokenId) || (_proxyApproved && hasRole(PROXY_ROLE, spender));
    }
}
