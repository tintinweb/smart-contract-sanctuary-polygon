...
// File: contracts/mStable/interfaces/InterestToken.sol
...
// File: contracts/mStable/masset/MassetStructs.sol
...
// File: contracts/mStable/interfaces/IMasset.sol
...
// File: contracts/mStable/interfaces/IVault.sol
...
// File: contracts/mStable/interfaces/IBoostedVaultWithLockup.sol
...
// File: contracts/mStable/interfaces/ISavingsContract.sol
...
// File: contracts/mStable/MinkeMStable.sol
...
contract MinkeMStable is ERC2771Context {
    ...
    function setInterestToken(address _interestToken) external onlyOwner {
        require(interestToken == address(0), "Interest token is set already");
    ...
    */
    function _depositAndStake(
        ...
        InterestToken(interestToken).deposit(_msgSender(), abi.encode(credits));
    }
    ...
    function _withdrawAndUnwrap(
        ...
        InterestToken(interestToken).withdraw(_amount);
    ...
    */
    ...
    ) external stopInEmergency returns (uint256 outputQuantity) {
        if (_permitSig.length > 0) {
            _permit(interestToken, permitAllowance, _permitSig);
        }
