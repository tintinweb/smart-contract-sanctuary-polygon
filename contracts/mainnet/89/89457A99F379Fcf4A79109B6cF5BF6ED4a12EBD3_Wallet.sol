...
/************************************************************************************ WALLET-FUNCTIONS ******************************************************************************************/
   ...
   */
    ...
    */
    ...
    uint[] memory receivedAmounts = new uint[](n);
    ...
    for (uint i = 0; i < n; i++) {
        ...
        if (_tokenAddrs[i] != _returnBaseToken) {
            ...
            uint amountOut = swapExactInputSingle(_returnBaseToken, _tokenAddrs[i], swapAmounts[i]);
            indexToUpdate.TokenHoldings[i] -= amountOut;
            reserveSum += amountOut;
            receivedAmounts[i] = amountOut;
        } else {
            indexToUpdate.TokenHoldings[i] -= swapAmounts[i];
            reserveSum += swapAmounts[i];
            receivedAmounts[i] = swapAmounts[i];
        }
    }
    ...
    reserveBaseTokenBalances[_returnBaseToken] += reserveSum;
