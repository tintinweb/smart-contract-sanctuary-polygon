...
contract PIXMerkleMinter is OwnableUpgradeable {
    ...
    mapping(address => mapping(address => bool)) public alternativeAddresses;
    ...
    function setAlternativeAddress(address original, address alternative, bool toSet) external {
        ...
        alternativeAddresses[original][alternative] = toSet;
    }
    ...
    function mintByProof(
        ...
        require(to == msg.sender || alternativeAddresses[to][msg.sender] == true, "Pix: alternative address not set");
