...
contract LionXWagmi is ERC721, Ownable {
    ...
    //metadatas
    string public baseURI = "ipfs://QmYBu1coSHmKybgnbWsQFUNr15YPzpedPvszZUAUTSk6Lg";

    constructor()
    ERC721("Lion dans la galaxie de Wagmi Studio", "WAGMI LION")
        {
            _dropperAddress = msg.sender;
        }
