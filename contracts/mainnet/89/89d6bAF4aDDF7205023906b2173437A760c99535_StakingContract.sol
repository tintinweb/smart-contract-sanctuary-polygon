...
contract StakingContract is Ownable {
    ...
    constructor(address _goldenAddress, address _rewardTokenAddress, uint256 _RewardTokenPerBlock) {
        require (_goldenAddress != address(0), "NFT token can't be adress (0)");
        require (_rewardTokenAddress != address(0), "Reward token can't be adress (0)");

        goldenAddress = _goldenAddress;
