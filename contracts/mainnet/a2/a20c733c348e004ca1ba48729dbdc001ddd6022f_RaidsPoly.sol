...
contract RaidsPoly {
    ...
    function setRaids() external {
        ...
        Raid memory skeletonHorde = Raid({ minLevel:  75, maxLevel: 75,  duration:  192, cost: 230, grtAtMin: 0, grtAtMax: 0, supAtMin: 0, supAtMax: 0, regReward: 1000, grtReward: 1000, supReward: 1000, minPotions: 5, maxPotions: 6});
        Raid memory wraithGeneral = Raid({ minLevel:  260, maxLevel: 280,  duration:  336, cost: 350, grtAtMin: 0, grtAtMax: 500, supAtMin: 0, supAtMax: 500, regReward: 2000, grtReward: 3000, supReward: 3500, minPotions: 12, maxPotions: 12});
