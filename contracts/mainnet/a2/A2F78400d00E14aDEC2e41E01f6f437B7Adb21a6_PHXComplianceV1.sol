...
contract PHXComplianceV1 is CountryRestrictions, DayMonthLimits {
    ...
    constructor () public {
        ...
        uint16[35] memory inputRestrictedCountries = [uint16(4), 112,180,368,408,364,760,862,156,643,586,70,108,140,192,818,624,332,422,434,807,466,498,499,104,558,688,706,728,729,788,792,804,887,716];
