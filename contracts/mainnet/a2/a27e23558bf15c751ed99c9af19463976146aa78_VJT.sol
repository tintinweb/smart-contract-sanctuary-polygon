...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB06EB1cbEf4f51aCe8e426bAcc9726B40D7E2B76;
...
contract VJT is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x356E9203aEE3B8851964a68945b6f564FC73Faf1;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Viajero Token";
    string private _symbol = "VJT";
    ...
    uint256 public _maxTxAmount = 1453000000000 * 10**18;
