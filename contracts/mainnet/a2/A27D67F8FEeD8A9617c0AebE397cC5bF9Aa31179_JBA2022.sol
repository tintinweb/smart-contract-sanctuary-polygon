...
contract JBA2022 is ERC721, Ownable {
  using Strings for uint256;
  ...
  string public uriEndPoint = "https://justbox-1310937423.cos.ap-guangzhou.myqcloud.com/collection/";
  string public uriCollection = "";
  string public uriHiddenMetadata = "";
  ...
  constructor() ERC721("Elora", "JBA-S1C4-ELA") {
    uriCollection = "S1C4-ELA-Elora";
    uriPrefix = string(abi.encodePacked(uriEndPoint, uriCollection, "/metadata/"));
    uriHiddenMetadata = string(abi.encodePacked(uriPrefix, "1.json"));

    setHiddenMetadataUri(uriHiddenMetadata);
