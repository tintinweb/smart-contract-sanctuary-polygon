...
/*
                                ...
                                ██   ██ ██     ███████    ██    ███████ 
*/
contract aeye is ERC721URIStorage, Ownable {
    ...
    function mint(address _to, string memory tokenURI) public payable {
        require(msg.value >= mintingPrice, "Invalid payment amount.");
    ...
    function withdrawEth() external onlyOwner {
        ...
        require(payable(owner()).send(balance), "Transfer failed");
    }
}