...
import "./CNPRwanshouSandaiAdmin.sol";

contract CNPRwanshouSandai is CNPRwanshouSandaiAdmin, ERC721A("CNP Rookies Wanshou Sandai", "CNPRWS") {
    constructor() {
...
import "./interface/ICNPRwanshouSandaiDescriptor.sol";
import "./CNPRwanshouSandaiConfig.sol";
import "@openzeppelin/contracts/access/AccessControl.sol";

abstract contract CNPRwanshouSandaiAdmin is CNPRwanshouSandaiConfig, AccessControl {
    /**
     ...
     */
    function setDescriptor(ICNPRwanshouSandaiDescriptor _descriptor) external onlyAdmin {
...
abstract contract CNPRwanshouSandaiConfig is Ownable {
    // The Project token URI descriptor
    ICNPRwanshouSandaiDescriptor public descriptor;
...
interface ICNPRwanshouSandaiDescriptor {
