...
contract SpaceToken is ERC20, Operator {
    ...
    uint256 public constant INITIAL_LIQUIDITY_ALLOCATION = 100 ether; // 20.000 xShare
    ...
    constructor(uint256 _startTime, address _devFund, address _daoFund) public ERC20("XSHARE", "XSHARE") {
