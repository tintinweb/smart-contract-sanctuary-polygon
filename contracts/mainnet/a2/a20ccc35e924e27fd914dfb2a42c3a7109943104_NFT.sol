...
contract NFT is ERC721Enumerable, Ownable {
    ...
    uint256 public PRE_PRICE = 0.4 ether;
    ...
    constructor(string memory baseURI, string memory _unrevealedURI, uint256 _presaleStartDate) ERC721("CREATURES OF WEALTH", "CREWLTH") {
        setBaseURI(baseURI);
        setUnrevealedURI(_unrevealedURI);
        
        presaleStartDate = _presaleStartDate;
        presaleEndDate = _presaleStartDate + 6 * 86400;
    }
    ...
    function mintNFTs(uint256 _count) public payable {
        ...
        require(block.timestamp > presaleStartDate, "Pre sale not started yet!");
        require(block.timestamp < presaleEndDate, "Pre sale ended!");
        require(totalMinted.add(_count) <= 1000, "Not enough NFTs left!");
