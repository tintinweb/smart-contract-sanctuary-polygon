...
contract Diamond {    
    ...
    //allows a proxy to use this diamond as an implementation and "reconstruct" the initial diamond constructor
    ...
    //allows us to declare functions within the diamond contract so they show up on polygonscan
