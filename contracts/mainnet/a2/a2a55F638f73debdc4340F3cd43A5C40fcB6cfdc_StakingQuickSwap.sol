...
// File: contracts_ETH/main/StakingQuickSwap.sol
...
contract StakingQuickSwap is Ownable {
    using SafeERC20 for IERC20;
    ...
    function stake(
        ...
        ERC20(_stakingToken).approve(_stakingRewards, _amount);
...
// **** GET REWARD ****
    function getReward(
        ...
        stakingRewardsFactory.stakingRewardsInfoByStakingToken( _stakingToken).stakingRewards;
        IStakingRewards _stakingContract =  IStakingRewards(_stakingRewards);
        uint256 _reward = _stakingContract.earned(address(this));
        return _reward;
    }
