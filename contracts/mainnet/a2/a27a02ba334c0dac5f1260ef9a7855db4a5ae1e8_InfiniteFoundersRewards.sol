...
// File: InfiniteFoundersRewards.sol
...
contract InfiniteFoundersRewards is ERC1155, AccessControl, Pausable, ERC1155Supply {
    bytes32 public constant URI_SETTER_ROLE = keccak256("URI_SETTER_ROLE");
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    uint256 public constant ALPHA_BETA = 0;
    uint256 public constant BETA_ONLY = 1;
    uint256 public constant ACCESSORY = 2;
    uint256 public constant BRONZE = 3;
    uint256 public constant SILVER = 4;
    uint256 public constant GOLD = 5;


    constructor() ERC1155("ipfs://bafybeianmq7zbs7qrs3m4qszk4rmm22antgj36d52ycfhpiqte2uhk5ugi/{id}.json") {
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _grantRole(URI_SETTER_ROLE, msg.sender);
        _grantRole(PAUSER_ROLE, msg.sender);
        _grantRole(MINTER_ROLE, msg.sender);

        _mint(msg.sender, ALPHA_BETA, 250, "");
        _mint(msg.sender, BETA_ONLY, 500, "");
        _mint(msg.sender, ACCESSORY, 250, "");
        _mint(msg.sender, BRONZE, 10, "");
