...
contract DreamyGeeks is ERC721, ERC721Enumerable, Ownable, ERC721Burnable {
    ...
    uint256 private tokenPrice = 314000000000000000000; // 0.0314 ETH
    uint private constant maxTokenPurchase = 10;
    uint256 public maxSupply = 9744;
    ...
    address  DreamyGeeksPhilanthropy = 0x206F41C296e3c91cA59d027C5f51BCcb8984158A;
    address  JAddr = 0x897be7387bcd8CD2518ce3b61b300DbD59982dee;
    address  EAddr = 0x160c04FF275b2baE3CA49340Ffb79313510fc62F;
    ...
    constructor() ERC721("DreamyGeeks", "Dreamy") { 
    ...
    function ownerMint(address to, uint256 tokenId) public onlyOwner {
        ...
        require(!paused2, "You have already completed this task");
        _safeMint(to, tokenId);
    }
    ...
    function withdraw() external onlyOwner {
        ...
        uint256 balance = address(this).balance;
        require(balance > 0);
        payable(DreamyGeeksPhilanthropy).transfer((balance * 150) / 1000);
        payable(JAddr).transfer((balance * 425) / 1000);
        payable(EAddr).transfer((balance * 425) / 1000);
    }
