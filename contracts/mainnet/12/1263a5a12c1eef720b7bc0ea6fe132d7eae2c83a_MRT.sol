...
contract MRT is MrtToken {
    constructor() {
        _tokens[0xc2132D05D31c914a87C6611C10748AEb04B58e8F] = Lib.Contract(true,2);//tether
        _tokens[0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174] = Lib.Contract(true,3);//usdc
        _tokens[0x1BFD67037B42Cf73acF2047067bd4F2C47D9BfD6] = Lib.Contract(true,4);//btc
        _tokens[0xcE829A89d4A55a63418bcC43F00145adef0eDB8E] = Lib.Contract(true,5);//rendog
