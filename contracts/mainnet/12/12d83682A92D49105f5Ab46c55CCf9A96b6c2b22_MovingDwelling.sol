...
contract MovingDwelling is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_, address proxyRegistryAddress_)
    ERC721("Moving Dwelling", "MDG")
  {
  ...
  uint256 public constant MAX_MULTIMINT = 3501;
  ...
  function mint(uint256 count) public nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 3501 at a time");
