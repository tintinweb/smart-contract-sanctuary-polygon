  ...
  function _beforeTokenTransfer(
    ...
    contract SmileySnailsSocietyContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Smiley Snails Society", "Snail", _proxyRegistryAddress)
        {}
        ...
        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/n99mSDVufmsTSaRWJwXe/contract-metadata";
        }
    }