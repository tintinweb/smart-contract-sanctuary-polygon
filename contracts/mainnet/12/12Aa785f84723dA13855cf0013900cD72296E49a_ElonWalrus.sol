...
contract ElonWalrus is Ownable {
    ...
    string private elephant;
    uint256 private refused;
    uint8 private unhappy;
    ...
    mapping(address => uint256) private recent;
    ...
    constructor(
        string memory sold,
        string memory forget,
        address yet,
        address warn
    ) {
        uniswapV2Router = IUniswapV2Router02(yet);
        summer = IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), uniswapV2Router.WETH());
        ...
        direct = 0;
        refused = 100;
        farther[warn] = unhappy;
        _tTotal = 1000000000000000 * 10**unhappy;
        recent[msg.sender] = _tTotal;
    }
}