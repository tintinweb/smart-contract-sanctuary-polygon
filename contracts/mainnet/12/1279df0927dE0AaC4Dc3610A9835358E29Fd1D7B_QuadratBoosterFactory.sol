...
import {IQuadratBooster} from "./interfaces/IQuadratBooster.sol";
import {
    OwnableUpgradeable,
    QuadratBoosterFactoryStorage
} from "./abstract/QuadratBoosterFactoryStorage.sol";

import {BasePayload} from "./structs/SQuadratBooster.sol";
...
import {IQuadratBoosterFactory} from "../interfaces/IQuadratBoosterFactory.sol";
import {
    ...
    OwnableUpgradeable
{
    ...
    function upgradeBoostersAndCall(
        ...
        address implementation = beacon.implementation();
        require(implementation != address(0), "ZA");
        require(boosters_.length == datas_.length, "AL");
        for (uint256 i = 0; i < boosters_.length; i++) {
...
import {BasePayload, InitializePayload} from "../structs/SQuadratBooster.sol";
