...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x0D402B54Da3b171c5a7AafC7FaF3e2E94B78CE0a];
  address public erc20Payable = 0x0D402B54Da3b171c5a7AafC7FaF3e2E94B78CE0a;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 500, 6166) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeid46yyznvwmacata7xtevcbyul5is2dlu6ryy74p5yks6edsgyf5q/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/BvsbfsnAZmjRB4UNoJYi/contract-metadata";
  }
...
// File: contracts/CzYachtCLubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CzYachtCLubContract is ERC721APlus {
    constructor() ERC721APlus("CZ Yacht CLub", "CZYC"){}
}
