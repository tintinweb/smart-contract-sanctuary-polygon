...
contract ProfileSetup {
    ...
    ) external payable returns(uint256 profileId, uint256 tierSetId) {
        profileId = BBProfiles.createProfile(address(this), address(this), profileCid);
        tierSetId = BBTiers.createTiers(profileId, tierPrices, tierCids, tierDeprecations, tierCurrencies, tierMultipliers);    
