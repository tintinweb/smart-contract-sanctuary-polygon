...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7B8c763C4eA50c3fF5b5EE9e18fF661C14629677;
...
contract ShitcoinMoon is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x455676762cAc3c45Dd02355e288Ef0684c147E3F;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Shitcoin Moon";
    string private _symbol = "SHITCOIN MOON";
    uint8 private _decimals = 18;
    uint256 public _taxFee = 54;
