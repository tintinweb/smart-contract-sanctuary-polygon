...
contract MaticMagic {
    ...
    uint256[5] public defaultPackages = [50 ether,100 ether,200 ether ,500 ether,1000 ether];
  ...
  function _refPayout(address _addr, uint256 _amount) internal {
    ...
    function invest(address referrer) public payable {
		...
		require(msg.value >= INVEST_MIN_AMOUNT,'Min invesment 5000 Elite');
    ...
    function reinvest(address _user, uint256 _amount) private{
       ...
       //_users DownlineIncome
        ...
        _usersDownlineIncomeDistribution(_user,_amount.div(2));
  ...
  function getEligibleWithdrawal(address _user) public view returns(uint8 reivest, uint8 withdrwal){
      ...
      if(TotalDeposit >=defaultPackages[2] && TotalDeposit < defaultPackages[3]){
          reivest = 50;
          withdrwal = 50;
