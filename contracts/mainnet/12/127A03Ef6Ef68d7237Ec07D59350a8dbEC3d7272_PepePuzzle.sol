...
contract PepePuzzle is ERC721 , DefaultOperatorFilterer {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeic5ohw2paazg4utg635nkdxg4bshxmbtvmbmfgfsvutvc4s46jr7m/", Strings.toString(tokenId), ".json")
            );
    }
