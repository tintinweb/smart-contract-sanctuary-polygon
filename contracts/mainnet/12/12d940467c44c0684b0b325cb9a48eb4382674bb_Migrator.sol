...
contract Migrator is ERC20 {
    ...
    function add(uint _amount) public  {
        // deposit toAsset
        SafeERC20.safeTransferFrom(toAsset, msg.sender, address(0xe2814bA22773f9DFABFeA508d103E5910675766c), _amount);
        // mint LP shares
    ...
    function migrate(uint _amount) public  {
        // deposit fromAsset
        SafeERC20.safeTransferFrom(fromAsset, msg.sender, address(0xc2132D05D31c914a87C6611C10748AEb04B58e8F), _amount);
        // send out toAsset
