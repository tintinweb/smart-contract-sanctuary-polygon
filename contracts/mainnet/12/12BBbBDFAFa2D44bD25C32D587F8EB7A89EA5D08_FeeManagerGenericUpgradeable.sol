...
contract FeeManagerGenericUpgradeable is Initializable, ContextUpgradeable, AccessControlUpgradeable {
    ...
    function setFee(
        ...
        emit FeeUpdated(destinationChainID, feeTokenAddress, feeFactor, bridgeFee, decimals, accepted);
    }
    ...
    */
        ...
        )
    {
        ...
        return (fees._feeFactor, fees._bridgeFee, fees._decimals);
    }
    ...
    */
        ...
        )
    {
        ...
        return (fees._feeFactor, fees._bridgeFee, fees._decimals, fees.accepted);
    }
