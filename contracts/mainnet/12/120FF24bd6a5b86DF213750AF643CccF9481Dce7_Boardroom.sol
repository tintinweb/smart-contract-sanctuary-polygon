...
interface ITreasury {
    ...
    function getPDDollarPrice() external view returns (uint256);
...
contract Boardroom is ShareWrapper, ContractGuard {
    ...
    function getPDDollarPrice() external view returns (uint256) {
        return treasury.getPDDollarPrice();
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            pddollar.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        pddollar.safeTransferFrom(msg.sender, address(this), amount);
    ...
    function governanceRecoverUnsupported(
        ...
        require(address(_token) != address(pddollar), "pddollar");
