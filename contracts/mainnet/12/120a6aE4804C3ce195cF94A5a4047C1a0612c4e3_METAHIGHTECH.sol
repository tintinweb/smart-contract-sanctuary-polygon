...
contract METAHIGHTECHToken is IPOLY20 {
...
contract METAHIGHTECH {
    address payable admin;
    METAHIGHTECHToken public tokenContract;
    ...
    constructor(METAHIGHTECHToken _tokenContract, uint256 _tokensSold)  {
