...
// File: contracts/TestPatternNFT.sol
...
contract TestPatternNFT is ERC721, Ownable {
    ...
    constructor() payable ERC721("Test Pattern - Testing on Polygon", "TP") {
        ...
        charityWallet = owner();
        mintPriceWL = 0.01 ether;      // Even though 'ethers' is specified, the value is in matic
        mintPricePS = 0.02 ether;     // Even though 'ethers' is specified, the value is in matic
        totalSupply = 0;
        maxSupply = 300;         // Total number of NFTs
        maxPerWalletWL = 3;
        maxMintAmountPS = 10;
        percentCharity = 0;
        percentCommunity = 0;
