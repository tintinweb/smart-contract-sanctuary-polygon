...
// File: contracts/iGotThisMashroom.sol
...
contract iGotThisMushroom is ERC721, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721("iGotThisMushroom", "IGTM") {
        baseUri = "ipfs://bafybeiebw2k7cvqnuyoe6jr37f5zb6pi3nd5ayjyw2pf24aus5udz2qcna/";
    ...
    function mint(uint256 _numTokens) external payable {
        require(isSaleActive, "The Mint is pause");
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0x3CC127ebe89600426371006248d39b6F063ce5F1).call{value: balanceOne}("");
