...
contract KuardiNFT is ERC721  {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeigrzz2ht5ddvyr4cwimoiliaymzzjshgsb3qhepx5xpm2vlowu43y/", Strings.toString(tokenId), ".json")
            );
    }
