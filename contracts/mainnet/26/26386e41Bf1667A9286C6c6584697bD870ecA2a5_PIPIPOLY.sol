...
contract PIPIPOLY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PIPI POLY";
    string private _symbol = "PIPI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x51449cd6Cdef68EcAae3e9BF753E47b5aED230a2);
    address payable public teamWalletAddress = payable(0x51449cd6Cdef68EcAae3e9BF753E47b5aED230a2);
    ...
    constructor () {
        ...
        //0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506E
        //0x10ED43C718714eb63d5aA57B78B54704E256024EB
        //0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ffM
