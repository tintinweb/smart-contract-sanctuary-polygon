...
import "./CryptoStampV2.sol";

contract CryptoStampPolygonV2 is CryptoStampV2 {
  address public childChainManager;

  constructor(string memory _uri, address _childChainManager) CryptoStampV2(_uri) {
...
contract CryptoStampV2 is Ownable, ERC1155Supply {
