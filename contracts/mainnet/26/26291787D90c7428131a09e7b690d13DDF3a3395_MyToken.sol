...
{    
    ...
    constructor () ERC20("Control", "CTL")
    {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff);//Router
        pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), _uniswapV2Router.WETH());

        vault_address = 0x656288857627435d53307fFF75C151F247C21dFA; //Creador

        fee_percentages.push(100); // Buy  fee is 1.00%
        fee_percentages.push(300); // Sell fee is 3.00%
        fee_percentages.push(200);  // P2P  fee is  2.00%

        //No fees
        is_taxless[msg.sender] = true; //Bobedaa
        is_taxless[vault_address] = true; //Creador
        is_taxless[address(this)] = true; //Contrato
        is_taxless[address(0)] = true; //burn
