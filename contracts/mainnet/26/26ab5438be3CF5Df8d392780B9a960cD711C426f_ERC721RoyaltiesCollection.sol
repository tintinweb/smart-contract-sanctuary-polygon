...
contract ERC721RoyaltiesCollection is  ERC721Enumerable, BridgeNFT, ERC2981, DefaultOperatorFilterer {
	...
	constructor(
        ...
        baseUri = "https://murderheaddeathclub.com/api/nft/";
        owner=0x6f7C0c6A6dd6E435b0EEc1c9F7Bce01A1908f386;
		_setDefaultRoyalty(0x6f7C0c6A6dd6E435b0EEc1c9F7Bce01A1908f386, 150);
    }
	...
	function mint(address to, uint256 id, bytes calldata rawInfo) override external onlyOwner {
		if (rawInfo.length != 0) {
			SetRoyalityInterface.SetRoyalty memory setRoyaltyInfo = abi.decode(rawInfo, (SetRoyalityInterface.SetRoyalty));
