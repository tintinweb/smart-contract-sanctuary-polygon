...
contract LetchumiPretty is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_, address proxyRegistryAddress_)
    ERC721("Letchumi Pretty", "LPLP")
  {
  ...
  uint256 public constant MINT_LIMIT_PER_WALLET = 32;
  ...
  uint256 public constant MAX_MULTIMINT = 32;
  ...
  function mint(uint256 count) public nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 32 at a time");
