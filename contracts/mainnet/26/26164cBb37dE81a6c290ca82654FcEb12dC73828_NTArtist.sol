...
// File contracts/ArtistCreator.sol
...
// File contracts/ArtistCreatorProxy.sol
...
// File contracts/NonTransArtist.sol

pragma solidity 0.8.7;

contract NTArtist is
    ERC721Upgradeable,
    IERC2981Upgradeable,
    OwnableUpgradeable
{
    ...
    function buyEdition(address to, uint256 _editionId) external payable {
        require(editions[_editionId].quantity > 0, "Edition does not exist");
