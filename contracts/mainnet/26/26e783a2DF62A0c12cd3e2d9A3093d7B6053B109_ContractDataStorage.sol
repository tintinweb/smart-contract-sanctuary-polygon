...
contract ContractDataStorage {
    ...
    function saveData(
        ...
        saveDataForDeployedContract(_key, _pageNumber, dataContract, uint128(_b.length), 0);
    }
    ...
    function saveDataForDeployedContract(
        ...
        _cdPages.pages[_pageNumber] = ContractData(dataContract, _size, _offset);
    }

    function revokeContractData(string memory _key) public {
    ...
    function getDataForAll(string[] memory _keys) public view returns (bytes memory) {
