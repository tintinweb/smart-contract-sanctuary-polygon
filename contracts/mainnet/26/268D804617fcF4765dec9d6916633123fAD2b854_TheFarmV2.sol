	...
	ERC1155HolderUpgradeable
{
	...
	function stakeCharacter(
		...
		stakeByCharacterByCharacterId[character][characterId] = stake;
	...
	function _claimEpochs(Character character, uint256 characterId) private {
		...
		if (boostedRewardPotato > 0) {
			_mintStakingReward(msg.sender, boostedRewardPotato);

			emit MintStakingReward(character, characterId, boostedRewardPotato);
		}
