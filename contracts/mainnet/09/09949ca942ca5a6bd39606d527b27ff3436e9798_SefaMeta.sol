...
contract SefaMeta is ERC721, Ownable {
  using Strings for uint256;
 ...
 Building [] public buildings;
  ...
  constructor() ERC721("SefaMeta", "SF") {
    setHiddenMetadataUri("ipfs://__CID__/hidden.json");
    buildings.push(Building("ZERO", 0,0,0,0,0,0));
    buildings.push(Building("House", 1,3,2,2,0,3));
    buildings.push(Building("Hadi House", 2,5,4,10,0,6));
    buildings.push(Building("Galery", 1,6,2,10,0,0));
    ...
    buildings.push(Building("DeDe House", 2,5,2,-2,0,5));
    buildings.push(Building("House", 4,1,4,5,0,0));
