 ...
 */
contract MowseTokenCreatorRegistry is  Initializable,OwnableUpgradeable, IERC721TokenCreator {
     ...
     */
    function initialize(address[] memory _iERC721Creators) initializer public {
         __Ownable_init();
        require(
