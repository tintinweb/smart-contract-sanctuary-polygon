...
contract NFTStudio1089Token is ERC721Mintable, ERC721Permit("NFTStudio_1089:Token") , Ownable, ERC721URIStorage{
    string public _defaultURI;
    
    event UpdateDefaultURI(string defaultURI);

    constructor() ERC721("NFTStudio_1089:Token", "STH") {
        setDefaultURI("https://metadata.nft-studio.com/1089/");
    }
    ...
    function setApprovalForAll(address operator, bool approved) public virtual override {
        ...
        require(operator == address(0), "can't approve");
    }

    function approve(address to, uint256 tokenId) public virtual override {
        super.approve(to, tokenId);
        require(to == address(0), "can't approve");
    }
}
