...
contract Procon is Ownable, ERC721A{
    uint256 public MAX_AMOUNT = 500;
    uint256 public MAX_PER_WALLET = 10;
    bool public _saleIsActive = true;
    string private _nftBaseURI = "ar://r7bZ7W1cYaenrUQO80AsRC2oXRVY9weZSAxQCpRB9nA";
    ...
    function mint(uint256 _amount) external payable {
        ...
        require(msg.value >= (_listingPrice * _amount), "not enough funds submitted");
        require(balances[msg.sender] + _amount <= MAX_PER_WALLET, "can`t claim more than 10 tokens per wallet");
