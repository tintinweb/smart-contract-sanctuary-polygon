...
// File: AquariumOfTheBay.sol

/**
 * @title Aquarium of the Bay
 * 
 * Aquarium of the Bay is the only Smithsonian Affiliated Aquarium in California. Home to 
 * over 24,000 animals from 200 different species, the Aquarium offers an important lens 
 * into the marine and terrestrial life of the San Francisco Bay & California Coast. Our mission 
 * is to enable climate resilience and ocean conservation on local and global scales through 
 * actionable change.
 * 
 * This collection is intended to thoughtfully engage a community of interested aquarium 
 * supporters in which to provide high-level value opportunities, including private invitations 
 * to feed the sharks.
 * 
 * Aquarium of the Bay is focused on enabling efforts for climate action and ocean conservation. 
 * We are passionate about supporting the company 4Ocean and their efforts to remove plastic 
 * from the sea.
 * 
 * We believe the partnership with ViciNFT is beneficial to engage a new community with 
 * meaningful, engaging, impactful Aquarium experiences.
 */
contract AquariumOfTheBay is ViciManagedERC721WithRecall {
    constructor()
    ...
    {
        setContractURI("ipfs://QmRj3H4Ljcwo8ZxuFN9B72tJiWw1ijWCDTP7qXpSw18kZ3");
    }
