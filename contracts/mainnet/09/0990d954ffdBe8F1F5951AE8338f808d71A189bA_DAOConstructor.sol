...
contract SalesController is ISalesController, App, __with_semver(uint8(1), uint8(0), uint8(0)) {
    ...
    constructor(
        ...
        address whiteListSaleImpl,
        address publicSaleImpl
    ...
    function initialize(IKernel _kernel) external initializer {
        __App_init(_kernel);
        beacons[SaleType.Open] = beaconOpenSale;
        beacons[SaleType.Whitelist] = beaconWhiteListSale;
    }
...
//    }
    ...
    function _deploySalesController(Kernel kernel) internal {
        address salesControllerCode = updateManager.getLastAppCode(AppsIds.SALES_CONTROLLER);
        SalesController salesController = SalesController(
            kernel.deployApp(
                AppsIds.SALES_CONTROLLER, salesControllerCode,
