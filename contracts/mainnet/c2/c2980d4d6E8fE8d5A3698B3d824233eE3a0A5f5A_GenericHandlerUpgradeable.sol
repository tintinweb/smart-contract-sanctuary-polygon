...
contract GenericHandlerUpgradeable is Initializable, AccessControlUpgradeable {
    ...
    event ReplayEvent( uint8 indexed destinationChainID, bytes32 indexed resourceID, uint64 indexed depositNonce , uint256 widgetID );
    ...
    **/
    function replayGenericDeposit(
        ...
        require(preGasLimit <= _gasLimit, "Router Generichandler : Gas Limit on replay must be equal to greater than previous GasLimit");
        require(preGasPrice < _gasPrice, "Router Generichandler : Gas Price on replay must be greater than previous Price");
    ...
    **/
    function setFees(
        ...
        feeManager.setFee(destinationChainID, feeTokenAddress, feeFactor, bridgeFee, defaultGasLimit , defaultGasPrice , decimals , accepted);
    }
    ...
    **/
    function calculateFees(
        ...
        (uint256 feeFactor, uint256 bridgeFees , uint256 defaultGasLimit , uint256 defaultGasPrice , uint8 feeTokenDecimals ) = feeManager.getFee(destinationChainID, feeTokenAddress);
