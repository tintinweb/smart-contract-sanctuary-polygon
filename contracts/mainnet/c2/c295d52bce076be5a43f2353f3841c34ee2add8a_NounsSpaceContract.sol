...
//
//           _   __                        _____                     
//    / | / /___  __  ______  _____ / ___/____  ____ _________ 
//   /  |/ / __ \/ / / / __ \/ ___/ \__ \/ __ \/ __ `/ ___/ _ \
//  / /|  / /_/ / /_/ / / / (__  ) ___/ / /_/ / /_/ / /__/  __/
// /_/ |_/\____/\__,_/_/ /_/____(_)____/ .___/\__,_/\___/\___/ 
//                                    /_/                      
//
//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xB7c29E1865A916Af82Eac70e9cf42Dff19ecDF7F];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 100, 1000000 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://nouns.space/metadata/";

    bool public mintingOpen = true;
    
    uint256 public PRICE = 2 ether;
    
    uint256 public MAX_WALLET_MINTS = 10000;
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 1000000");
        _safeMint(_to, 1);
    }
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 1000000");
...
// File: contracts/NounsSpaceContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NounsSpaceContract is RamppERC721A {
    constructor() RamppERC721A("NounsSpace", "NOUNS"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/z7M6RF1bUC8MaNfFpxgz/contract-metadata";
    }
}
