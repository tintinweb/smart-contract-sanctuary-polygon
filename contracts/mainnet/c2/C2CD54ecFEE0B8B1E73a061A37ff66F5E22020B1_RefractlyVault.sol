 ...
 */
contract RefractlyVault is ERC20, Ownable, ReentrancyGuard {
  ...
  function setInitialStrategy(address _strategy) public onlyOwner {
    require(strategy == IStrategy(address(0)), "Strategy already set for Vault");

    require(address(this) == IStrategy(_strategy).vault(), "Strategy not valid for this Vault");
