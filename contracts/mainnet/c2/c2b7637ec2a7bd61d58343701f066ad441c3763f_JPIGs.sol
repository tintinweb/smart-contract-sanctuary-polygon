...
contract JPIGs is ERC721, ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;
    IERC20 public tokenAddress;

    uint256 public MAX_TOKENS_PER_MINT = 10; // Maximum per transaction
    ...
    constructor(address _tokenAddress) ERC721("JPIGs", "JPIG") {
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        require(_mintAmount < MAX_TOKENS_PER_MINT + 1, "max transaction exceeded");
        require(supply + _mintAmount < MAX_SUPPLY + 1, "max supply exceeded");
