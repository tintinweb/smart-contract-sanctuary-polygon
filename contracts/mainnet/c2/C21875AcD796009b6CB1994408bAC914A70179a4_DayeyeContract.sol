...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x000000000000000000000000000000000000dEaD,0x7e6447575923d4D11a2b6D43283CB041f36Ea40F];
  address public erc20Payable = 0x000000000000000000000000000000000000dEaD;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmW9ob9VaJdUKar7a6eySRaw5zMZiHbkU3yTTpmZRn1ufa/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/hG9WA4HkqqivzwckvExS/contract-metadata";
  }
...
// File: contracts/DayeyeContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DayeyeContract is RamppERC721A {
    constructor() RamppERC721A("dayeye", "MINTPLEX"){}
}
