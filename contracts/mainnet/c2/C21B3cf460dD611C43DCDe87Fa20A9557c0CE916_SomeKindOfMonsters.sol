 ...
 * @notice This contract handles minting Some kind of Monsters tokens.
 */
contract SomeKindOfMonsters is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x583231BAB086EDD0fF6ba78AD45b9C19Bed835F6;
    ...
    string public name = "Some kind of Monsters";
    string public symbol = "SKOM";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeidqsk6cklq6elbtujaol3nclfdzyanmuyllax2cakwunvaajef3km/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[3] = 1000;
        tokenPublicPrice[3] = 0 ether;
        tokenPublicMintsPerAddress[3] = 1000;
        tokenMaxSupply[4] = 1000;
        tokenPublicPrice[4] = 0 ether;
        tokenPublicMintsPerAddress[4] = 1000;
        tokenMaxSupply[5] = 1000;
        tokenPublicPrice[5] = 0 ether;
        tokenPublicMintsPerAddress[5] = 1000;
        require(
