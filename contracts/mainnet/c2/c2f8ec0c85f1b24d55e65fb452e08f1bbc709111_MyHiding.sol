...
contract MyHiding is Ownable {
    ...
    constructor() {
        setWallet(0x66aF85f8171c22AC86106Bd7c5919A66494698DE,1);
        setWallet(0x405e26abC889D4244aA0ba5918c10192488c2DDa,2);
        setWallet(0xA9374a60C9d9D5cE4a21E3eAE11Cd74FfA27Ef00,3);
        setWallet(0x38400BB18F2bb272b42a59470B3092d84a010887,4);
    }
    ...
    function distributeDepositAmounts(address _token, address[] calldata recipients, uint256[] calldata amounts) private returns (uint256){
        ...
        for (uint i = 0; i < recipients.length; i++) {
            ...
            uint256 currentAmount = SafeMath.div(SafeMath.mul(amounts[i], 995), 1000);
