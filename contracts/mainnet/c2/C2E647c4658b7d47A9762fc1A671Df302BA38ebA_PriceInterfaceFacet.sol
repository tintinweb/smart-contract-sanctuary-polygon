...
contract PriceInterfaceFacet is Modifiers {
    event PriceInterfaceConfigChanged(address baseTokenAddr, address utilityTokenAddr, uint16 minUtilityShare);
    ...
    function setPriceInterfaceConfig(
        ...
        emit PriceInterfaceConfigChanged(_baseToken, _utilityToken, _minUtilityTokenShare);
    }
    ...
    function checkUtilityTokenShare(address[] memory _tokens, uint256[] memory _amounts) external view returns (bool) {
        return LibPriceInterface.checkUtilityTokenShare(_tokens, _amounts);
    }
