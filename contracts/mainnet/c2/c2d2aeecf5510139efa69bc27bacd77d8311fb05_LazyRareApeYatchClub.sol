...
contract LazyRareApeYatchClub is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Lazy Rare Ape Yatch Club", "LRAYC") {
    setHiddenMetadataUri("ipfs://QmY8T1cxtFWPNr3SFE6SxAicvz8HMtMUCAa9pMwa1NqGFG/hidden.json");
  }
