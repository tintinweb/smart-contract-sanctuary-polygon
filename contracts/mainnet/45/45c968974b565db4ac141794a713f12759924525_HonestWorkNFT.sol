...
contract HonestWorkNFT is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor(
        ...
        _mint(0x1672444269a0E204fCFBE7B2320576515675093e, 3);
        _mint(0x619CF67A64d25F3279eD4faEd36C03DF3aa04108, 4);
        tier[1] = 1;
        tier[2] = 2;
        tier[3] = 3;
        tier[4] = 1;
        grossRevenue[1] = 100e18;
        grossRevenue[2] = 2500e18;
        grossRevenue[3] = 300000e18;
        grossRevenue[4] = 60000e18;
    }
