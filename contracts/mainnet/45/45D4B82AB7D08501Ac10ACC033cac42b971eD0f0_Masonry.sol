...
import "../Lib/ZoneWrapper.sol";

contract Masonry is ZoneWrapper, ContractGuard {
    ...
    IERC20Upgradeable public _ozone;
    ...
    function initialize(
        IERC20Upgradeable _ozoneToken,
        IERC20Upgradeable __oShare,
        ITreasury _treasury
        ...
        rewardLockupEpochs = 1; // Lock for 3 epochs (18h) before release claimReward TOMB ON STEROIDS
    ...
    function getZonePrice() external view returns (uint256) {
        return treasury.getZonePrice();
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            _ozone.safeTransfer(msg.sender, reward);
        ...
        onlyOperator
    {
        ...
        _ozone.safeTransferFrom(msg.sender, address(this), amount);
    ...
    function governanceRecoverUnsupported(
        ...
        require(address(_token) != address(_ozone), "OZONE");
        require(address(_token) != address(_oShare), "OSHARE");
...
contract ZoneWrapper {
    using SafeMathUpgradeable for uint256;
    using SafeERC20Upgradeable for IERC20Upgradeable;

    IERC20Upgradeable public _oShare;
    ...
    function stake(uint256 amount) public virtual {
        ...
        _oShare.safeTransferFrom(msg.sender, address(this), amount);
    }
    ...
    function withdraw(uint256 amount) public virtual {
        ...
        _oShare.safeTransfer(msg.sender, amount);
    }
}
