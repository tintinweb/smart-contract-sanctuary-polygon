...
contract MeekMittis is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_, address proxyRegistryAddress_)
    ERC721("Meek Mittis", "MKMTS")
  {
  ...
  uint256 public constant MINT_LIMIT_PER_WALLET = 255;
  ...
  uint256 public constant MAX_MULTIMINT = 255;
  ...
  function mint(uint256 count) public nonReentrant {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 255 at a time");
