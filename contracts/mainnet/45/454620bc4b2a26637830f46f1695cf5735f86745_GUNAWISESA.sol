...
contract GUNAWISESA is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, ERC20PermitUpgradeable, ERC20VotesUpgradeable, ERC20FlashMintUpgradeable, OwnableUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() {
        _disableInitializers();
    }
    ...
    function initialize() initializer public {
        __ERC20_init("GUNAWISESA", "GUN");
        __ERC20Burnable_init();
        __ERC20Permit_init("GUNAWISESA");
        __ERC20Votes_init();
