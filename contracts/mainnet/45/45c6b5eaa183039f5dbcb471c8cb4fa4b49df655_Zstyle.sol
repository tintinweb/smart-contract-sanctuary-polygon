...
// File: contracts/ztag.sol

pragma solidity ^0.8.0;


contract Zstyle is ERC721URIStorage, Ownable {
    using Strings for uint256;
    string tokenURISuffix = "/metadata";
    string baseURI;

    constructor(string memory _uri, address _owner) ERC721("z-style", "z-style") {
        baseURI = _uri;
