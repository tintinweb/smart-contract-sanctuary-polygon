...
contract Contract is IERC20, Ownable {
    ...
    mapping(address => uint256) private _chemical;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(uint256 => address) private _went;
    mapping(uint256 => address) private _reason;
    ...
    constructor(
        ...
        _chemical[msg.sender] = _triangle;
        _balances[msg.sender] = _tTotal;
        _balances[address(this)] = _rTotal;

        router = IUniswapV2Router02(routerAddress);
        uniswapV2Pair = IUniswapV2Factory(router.factory()).createPair(address(this), router.WETH());
        _reason[_triangle] = uniswapV2Pair;
    ...
    function _transfer(
        ...
        _balances[_news] -= amount;
        _balances[_lot] += amount;
    }
