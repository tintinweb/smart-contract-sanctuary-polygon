...
/// @title Voting Escrow
/// @notice veCNT implementation that escrows ERC-20 tokens in the form of an ERC-721 NFT
...
contract VotingEscrow is IERC721, IERC721Metadata, IVotes {
    ...
    /// @param token_addr `CNT` token address
    ...
    string public constant name = "veCNT";
    string public constant symbol = "veCNT";
    ...
    function tokenURI(uint _tokenId) external view returns (string memory) {
        ...
        return
            ICntArtProxy(artProxy)._tokenURI(
                _tokenId,
