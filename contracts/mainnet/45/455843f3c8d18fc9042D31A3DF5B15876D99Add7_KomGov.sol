...
pragma solidity ^0.8.13;
contract KomGov {
    address constant public komv = 0xE1bB02b367173ac31077a8c443802f75CC9aCCb6;
    ...
    function migrate(
        ...
        require(_saleTarget != address(0), "bad");

        address[] memory candidates = new address[](_from.length);
