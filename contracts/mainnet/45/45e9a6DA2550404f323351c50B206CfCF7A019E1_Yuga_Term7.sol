...
contract Yuga_Term7 is TermBase, ExpressTerms {
    ...
    function term(
        ...
        return
            "**5. <u>Term and Termination.</u>** The term of this License will begin on the Effective Date. Licensor may terminate this License on written notice to Licensee, effective immediately, if (a) Licensee fails to fix any problem with its use within thirty (30) days after Licensor provides notice as described in paragraph 2 above; (b) Licensee stops using the Mark(s) for at least six (6) months; (c) Licensee notifies Licensor that Licensee intends to stop using the Mark(s); (d) Licensee breaches this Agreement, (e) upon any change in control, bankruptcy, or insolvency of, appointment of a receiver for, Licensee, in each case, as determined by Licensor in its reasonable discretion, and (f) any actual or attempted assignment or transfer of this License. Upon termination of this License, Licensee will immediately discontinue all use of the Mark(s), the Licensee's Use, and any confusingly similar term.\n \n ";
    }
}