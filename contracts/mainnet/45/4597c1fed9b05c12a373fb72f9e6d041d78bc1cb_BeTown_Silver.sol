...
contract BeTown_Silver is ERC721A, Ownable, DefaultOperatorFilterer {
    bool public paused = true;

    string public baseURI = "ipfs://bafybeiawftnj57tr347ftds7lzbcld3oolpzcqkr6m6rfs53cusmi6zut4/";
    
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721A("BeTown Silver", "BTS") {
    }
