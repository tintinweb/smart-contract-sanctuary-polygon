...
// File: contracts/SlylyFoxesEvents.sol
...
contract SlylyFoxesEvents is ERC1155, Ownable, ERC1155Supply, ReentrancyGuard {
    ...
    function foxDrop (address[] calldata recipients, uint256 _tokenId) public onlyOwner {
        require(!paused, "Contract is paused");
        require(recipients.length > 0, "No addresses");
