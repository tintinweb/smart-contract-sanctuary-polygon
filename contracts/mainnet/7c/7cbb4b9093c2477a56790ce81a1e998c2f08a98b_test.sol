...
contract test is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x08BE47d748B48A270c8DaCe98F894c53902c61A0); 
    address payable public Wallet_Dev = payable(0x08BE47d748B48A270c8DaCe98F894c53902c61A0);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1**10 * 10**_decimals;
    ...
    constructor () {
        ...
        _owner = 0x08BE47d748B48A270c8DaCe98F894c53902c61A0;
