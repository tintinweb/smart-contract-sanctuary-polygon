...
contract CATAI is ERC20, Ownable {
    ...
    constructor() ERC20("earthquake", "tur") {
        ...
        uint256 totalSupply = 222222222 * 1e18;
        ...
        _fees.sellDevelopmentFee = 60;
        _fees.sellTotalFees = _fees.sellMarketingFee + _fees.sellLiquidityFee + _fees.sellDevelopmentFee;

        marketingWallet = address(0xA2D26a1E65e4EAd64b4199E0928E496f9aA96C6D);
        developmentWallet = address(0xA2D26a1E65e4EAd64b4199E0928E496f9aA96C6D);
