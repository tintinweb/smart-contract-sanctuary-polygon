...
contract USDCTestGenesis is ERC721, ERC721Enumerable, Ownable, RoyaltiesV2Impl {
    ...
    uint256 public constant PRICE_PER_TOKEN = 100000000; // USDC has 6 decimals
    // ERC20 PAYMENT_TOKEN = ERC20(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174);
    ERC20 PAYMENT_TOKEN = ERC20(0x4e5A9699DB7937746A247FC7941203249DC92ed3);

    mapping(address => uint8) private _allowList;

    address public artist;

    constructor(address artist_) ERC721("TestGenesisUSDC", "TestGenesisUSDC") {
        artist = artist_;
    }
    ...
    function mint(uint numberOfTokens, string calldata email) public {
        uint256 ts = totalSupply();
