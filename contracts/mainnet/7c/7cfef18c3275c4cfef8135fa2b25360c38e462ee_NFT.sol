...
contract NFT is ERC721Enumerable, Ownable {
  ...
  constructor() ERC721("Friends Forever", "FRIENDS") {
    setBaseURI("https://ipfs.io/ipfs/QmcCwGm4pV8fSaSvDKaoAgX2PZuvErnPdbvHrdvSbWu9RQ/");
  }
  ...
  function mint(address _to, uint256 _mintAmount) public payable {
    ...
    require(_mintAmount <= maxMintAmount , 'Minting limit exceed');
    require(supply + _mintAmount <= maxSupply, 'Sold out');
    require(balanceOf(msg.sender) + _mintAmount <= maxperwallet , 'Minting limit exceed');
