...
contract Pricer {
    ...
    function getPair(address token0, address token1, address router) external view returns(address pair){ //works 
    ...
    function getLpTokens(address lp) public view returns(address token0, address token1){ //WORKS
