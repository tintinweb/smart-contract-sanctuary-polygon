...
//*********************************************************************//
//
// ooooooooo.    o8o                                                      oooooooooo.                     .o8            
// `888   `Y88.  `"'                                                      `888'   `Y8b                   "888            
//  888   .d88' oooo   .ooooo.   .oooo.    .oooo.o  .oooo.o  .ooooo.       888      888 oooo  oooo   .oooo888   .ooooo.  
//  888ooo88P'  `888  d88' `"Y8 `P  )88b  d88(  "8 d88(  "8 d88' `88b      888      888 `888  `888  d88' `888  d88' `88b 
//  888          888  888        .oP"888  `"Y88b.  `"Y88b.  888   888      888      888  888   888  888   888  888ooo888 
//  888          888  888   .o8 d8(  888  o.  )88b o.  )88b 888   888      888     d88'  888   888  888   888  888    .o 
// o888o        o888o `Y8bod8P' `Y888""8o 8""888P' 8""888P' `Y8bod8P'     o888bood8P'    `V88V"V8P' `Y8bod88P" `Y8bod8P'
//                                                                   
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xB011a2e7E6FE9EC2887054b635eB1998BF3A1a56];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 5000, 10000 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmejvHnaFg5GQtGN5TjCY6HNjXuC1SXbTAAGpfNVQ1NyHD/";
...
// File: contracts/PicassoDudeContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PicassoDudeContract is RamppERC721A {
    constructor() RamppERC721A("Picasso Dude", "PD"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/Bf4ydpYHobfKe4Y7xiuy/contract-metadata";
    }
}
