...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xac6E0cD22Ae63F5b82ba33d27DDC824Ba7BD9554];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 1000, 6000 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmQvv6GRG3mD69khUbERx5GaTwUrsizQ5WyCWq5PL9Vod2/";
...
// File: contracts/PutinisaclownContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PutinisaclownContract is RamppERC721A {
    constructor() RamppERC721A("Putin is a clown", "PTNCLWN"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/eocIbtZegE544Xt312O8/contract-metadata";
    }
}
