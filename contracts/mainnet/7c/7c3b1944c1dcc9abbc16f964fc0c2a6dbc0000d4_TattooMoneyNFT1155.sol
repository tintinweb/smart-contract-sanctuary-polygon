...
interface TattooMoneyMultiple {
    function getServiceFee() external returns (uint256);
    function getOwner() external returns (address);
}

contract TattooMoneyNFT1155 is
    ERC1155,
    Ownable,
    ERC1155Burnable
{
    ...
    TattooMoneyMultiple public  TattooMoneyNFT1155Many;
    ...
    constructor(    
        ...
        string memory type2,
        address address2
    ) ERC1155("", "TattooMoneyMultiple", "TAT2M") { 
        _tid = id;
        deci = 18;
        ...
        TattooMoneyMultiple _TattooMoneyNFT1155 = TattooMoneyMultiple(adminContract);
        // set the rest of the contract variables
        TattooMoneyNFT1155Many = _TattooMoneyNFT1155;
    ...
    function _saleToken(
        ...
        serviceValue = TattooMoneyNFT1155Many.getServiceFee();
        address payable admin =  payable(TattooMoneyNFT1155Many.getOwner());
