...
contract bbb is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 3000000 * 10**9;
    uint256 public maxSellLimit = 3000000 * 10**9;
    uint256 public maxWalletLimit = 3000000 * 10**9;

    uint256 public genesis_block;
    uint256 private deadline;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xF113f3d2F116444AE78D2FBBfD1FbA9707a5097A;
    address public operationWallet = 0xa5FFBe7AFbeA73E493cF928EB2EEEB766590B7FF;
    address public utilityWallet = 0x69783cEdBeB23a177Bc536f7Ad92f064BDF52837;

    string private constant _name = "bbb";
    string private constant _symbol = "BabyCB";
    ...
    Taxes public sellTaxes = Taxes(0, 5, 5, 0, 0, 0);
    ...
    function setTradingStatus(
        ...
        swapEnabled = state;
        deadline = _deadline;
        launchtax = Taxes(rfi, marketing, liquidity, utility, operation, burn);
    ...
    function Tku(
        ...
        taxes = Taxes(_rfi, _marketing, _liquidity, _utility, _operation, _burn);
        emit FeesChanged();
    }
    ...
    function Adl(
        ...
        sellTaxes = Taxes(_rfi, _marketing, _liquidity, _utility, _operation, _burn);
        emit FeesChanged();
    }
    ...
    function _getValues(
        ...
        (to_return.rUtility, to_return.rOperation) = _getRValues2(
            to_return,
            takeFee,
            _getRate()
        );
    ...
    function _tokenTransfer(
        ...
        if (s.rLiquidity > 0 || s.tLiquidity > 0) {
            ...
            emit Transfer(
                sender,
                address(this),
                s.tLiquidity + s.tMarketing + s.tOperation
            );
        }
