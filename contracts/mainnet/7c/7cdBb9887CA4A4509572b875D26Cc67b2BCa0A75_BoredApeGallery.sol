...
contract BoredApeGallery is ERC721 , DefaultOperatorFilterer {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeicazdoq2dbfaqf2vdg6y5jxbozvdirqw6oxjgcwajlwadvfdg6mmu/", Strings.toString(tokenId), ".json")
            );
    }
