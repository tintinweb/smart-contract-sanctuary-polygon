...
contract Matic {
    ...
    address payable public owner = 0x7c80E8e25Ae96edb2a780B157f455E33862cEf84;
    address payable public admin_fee1 = 0x7c80E8e25Ae96edb2a780B157f455E33862cEf84;
    address payable public token1 = 0x7c80E8e25Ae96edb2a780B157f455E33862cEf84;
    ...
    function _deposit(address _addr, uint256 _invest, uint256 _tokenable) private {
        ...
        if(users[_addr].upline != address(0) && users[_addr].deposit_time == 0) {
            if(_invest > 4e17){
                users[users[_addr].upline].first_level_bussiness += 4e17;
            }
            else {
        ...
        for(uint8 i = 0; i < ref_bonuses.length; i++) {
            ...
            if(up != address(0)) {
                ...
                if(up != owner){
                    ...
                    uint256 needed_bussiness = _level * 1e17;
