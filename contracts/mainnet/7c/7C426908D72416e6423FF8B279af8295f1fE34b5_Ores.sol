...
contract Ores is Ownable, ERC20 {

    uint256 constant MAX_ORE = 4_000_000_000 ether;
    ...
    constructor() ERC20("SpaceGame Ores", "ORES") {
        
    }

    function mintFor(address to, uint256 amount) external onlyOwner {
        uint256 currentSupply = totalSupply();
        if(currentSupply + amount > MAX_ORE) revert MaxMinted(currentSupply, amount);
        _mint(to, amount);
