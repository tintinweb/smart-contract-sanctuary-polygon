...
// File: contracts/RisingLands.sol
...
contract CheckBirds is ERC721A, Ownable {
    ...
    string public baseURI = "ipfs://storage.retroassets.xyz/";
    ...
    function mint(uint256 count) external payable {
        ...
        bool isFree = ((totalSupply() + count < maxFreeMintSupply + 1) &&
            (_mintedFreeAmount[msg.sender] + count <= maxFreeMintPerAddr) || msg.sender == owner());
    ...
    function setFree(uint256 _newPrice) external onlyOwner {
        maxFreeMintSupply = _newPrice;
    }
