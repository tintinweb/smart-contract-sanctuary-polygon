...
// Created by Ryuzaki01

contract Actibot is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("Actibot", "ACTB") {}
  ...
  function creatorMint(address _to, uint256 _amount) public onlyOwner {
