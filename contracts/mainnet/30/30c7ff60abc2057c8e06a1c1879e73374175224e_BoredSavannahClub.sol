...
contract BoredSavannahClub is Ownable, ERC721A {
    using Strings for uint256;

    uint256 public maxSupply = 1111;
    uint256 public maxPerTransaction = 2;
    uint256 public whitelistPrice = 4 ether;
    uint256 public publicPrice = 7 ether;
    uint256 public airdropReserve = 50;
    ...
    constructor() ERC721A("Bored Savannah Club", "BSC") {
        baseURI = "ipfs://Qmec3z4hNnkJPndbN2Hi9CsN2GfnCFb46cszZU3UiuRgc8/";
        hiddenURI = "ipfs://";
    }
     ...
     *
     * @param _config 0 = pause mint, 1 = whitelist mint, 2 = public mint
     */
    ...
    function manageWhitelist(address[] calldata addresses, uint256 _amount) external onlyOwner {
        for(uint256 i; i < addresses.length; i++){
            whitelist[addresses[i]] = _amount;
        }
    }
