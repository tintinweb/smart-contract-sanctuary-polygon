...
contract Cryptoshizzle is ERC721A, Ownable {
     ...
     uint256 public mintedAmount = 70;
    ...
    constructor(string memory _notRevealedUri) ERC721A("Crypto Fries", "CF") {
        ...
        oldCollection = IERC721A(0xCf463Fe8DF9c7e6b623d24AB02bDDEA74fdE7d06);
    }
   ...
   function mint(uint256 quantity) external payable {
    ...
    function claimNFT(uint256[] memory tokenIds) external {
        for (uint256 i = 0; i < tokenIds.length; i++) {
            ...
            _safeMint(oldCollection.ownerOf(tokenId), tokenId);
        }
    }
