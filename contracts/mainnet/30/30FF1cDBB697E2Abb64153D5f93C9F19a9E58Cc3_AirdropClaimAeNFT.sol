...
contract AirdropClaimAeNFT is ReentrancyGuard {
    ...
    /// @notice claim aex given amount and send to _to. Checks are done by merkle tree contract. (eg.: 40% veAEX 60% $AEX)
    function claim(address _who, uint _amount, address _to) external nonReentrant onlyMerkle returns(bool){
        ...
        uint256 _aexShare = _amount - _veShare;
        token.safeTransfer(_to, _aexShare);
    ...
    */
    ...
    /// @notice set aex % amount claimable early. The remaining is vested linearly
