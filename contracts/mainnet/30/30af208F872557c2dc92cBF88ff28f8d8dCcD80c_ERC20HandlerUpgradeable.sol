    ...
    ILiquidityPool
{
    ...
    */
     ...
     */
    function withdrawNativeTokens(address recipient, uint256 amount) public virtual override onlyRole(BRIDGE_ROLE) {
        feeManager.withdrawNativeTokens(recipient, amount);
    }
...
contract HandlerHelpersUpgradeable is Initializable, ContextUpgradeable, AccessControlUpgradeable, IERCHandler {
    ...
    */
     ...
     */
    function getTokenToUSDx10e9(address token) public view override returns (uint256) {
     ...
     */
    function setTokenToUSDx10e9(address token, uint256 priceInUSDx10e9)
        external
        virtual
        override
        onlyRole(BRIDGE_ROLE)
    {
        _tokenToUSDx10e9[token] = priceInUSDx10e9;
     ...
     */
    function withdrawNativeTokens(address recipient, uint256 amount) public virtual override {}
