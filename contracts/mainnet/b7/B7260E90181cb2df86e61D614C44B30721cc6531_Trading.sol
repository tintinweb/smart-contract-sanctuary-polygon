...
contract Trading is MetaContext, ITrading {
        ...
        external
    {
        ...
        IPosition.Trade memory trade = position.trades(_id);
        uint256 _price = TradingLibrary.verifyAndCreatePrice(minNodeCount, validSignatureTimer, trade.asset, chainlinkEnabled, pairsContract.idToAsset(trade.asset).chainlinkFeed, _priceData, _signature, nodeProvided, isNode);
