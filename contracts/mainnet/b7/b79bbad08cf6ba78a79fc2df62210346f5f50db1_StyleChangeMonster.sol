...
// File contracts/StyleChangeMonster.sol
...
contract StyleChangeMonster is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
  ) ERC721A("StyleChangeMonster", "SCM", mintLimit, _totalSupply) {
     tokenCount = 0;
  }
