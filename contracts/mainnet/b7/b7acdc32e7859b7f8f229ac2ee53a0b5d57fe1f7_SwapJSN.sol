...
contract SwapJSN is Context {
    ...
    constructor(address _WMATIC, address _swapRouter) {
    ...
    function swap(address _tokenIn, address _tokenOut, uint256 _amountIn, uint24 _feeTier) external payable returns (uint256) {
        ...
        uint256 amountOut = swapInternal(who, who, tokenIn, _tokenOut, amountIn, _feeTier);
        return amountOut;
    }
    ...
    function swapTo(address _tokenIn, address _tokenOut, address _sendTo, uint256 _amountIn, uint24 _feeTier) external payable returns (uint256) {
        ...
        uint256 amountOut = swapInternal(who, _sendTo, tokenIn, _tokenOut, amountIn, _feeTier);
        return amountOut;
    }
    
    function swapInternal(address who, address _sendTo, address _tokenIn, address _tokenOut, uint256 _amountIn, uint24 _feeTier) internal returns (uint256 amountOut) {
