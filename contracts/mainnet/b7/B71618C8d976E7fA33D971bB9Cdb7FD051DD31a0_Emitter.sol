...
contract Emitter is Initializable, AccessControl {
    ...
    function changedUSDCAddress(address _newUSDC) external payable onlyOwner {
    ...
    function createDao(
        ...
        uint256 leng = _daoAdmins.length;
    ...
    function createDaoNftTemplate(
        ...
        _grantRole(EMITTER, _nftContractAddress);
        _grantRole(EMITTER, _proxy);
    ...
    function updateUSDCTokenAddress(
        address _proxy,
    ...
    function mintNft(
        ...
        emit MintNft(_to, _implementation, _nftAddress, _tokenURI, _tokenId);
    }
    ...
    function whitelistAddress(
        ...
        emit WhitelistAddress(_implementation, _nftAddress, _address);
    }
    ...
    function removeWhitelistAddress(
        ...
        emit RemoveWhitelistAddress(_implementation, _nftAddress, _address);
    }
}