...
contract WaiolaClub is ERC721Enumerable, Ownable {  
    ...
    uint256 public reserved = 1500;

    // Price of each token
    uint256 public initial_price = 0.07 ether;
    ...
    string public baseTokenURI = "http://69.55.55.118";
    ...
    constructor () ERC721 ("Waiola Club", "WC") {
        price = initial_price;
    }
