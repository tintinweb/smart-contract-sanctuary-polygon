...
contract UnifarmAccountsUpgradeable is Initializable, OwnableUpgradeable {
    ...
    function getSecondaryWalletAccount(
        address _account,
        uint256 _dappId
    ) public view returns (address) {
        return userWallets[_account][_dappId].account;
    }
...
contract MessagingUpgradeable is Initializable, OwnableUpgradeable {
    ...
    function _isValidSender(
        ...
        require(_msgSender() == _from || 
                _msgSender() == unifarmAccounts.getSecondaryWalletAccount(_from, dappId), "INVALID_SENDER");
    }
