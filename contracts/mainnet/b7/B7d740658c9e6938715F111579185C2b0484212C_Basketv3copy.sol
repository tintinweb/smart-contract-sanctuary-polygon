...
contract Basketv3copy is Ownable {
  ...
  function withdraw0(uint256 _basketId, address _account, PoolInfo[] calldata _pools, StragateSwapInfo calldata _stgSwap, BridgeSwapInfo calldata _lcbrgSwap, uint256 _fee) public onlyManager {
