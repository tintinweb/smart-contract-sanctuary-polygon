...
contract MegamoonLottery is ReentrancyGuard, IMegamoonLottery, Ownable {
    ...
    event NewDealerAddress(address dealer);
    ...
    function injectFunds(uint256 _lotteryId, uint256 _amount) external override onlyOwnerOrInjector {
        ...
        _lotteries[_lotteryId].amountCollectedInMoon += _amount;
    ...
    /**
     * @notice Set dealer addresse
     * @dev Only callable by owner
     * @param _dealerAddress: address of the dealer
     */
    function setMegamoonDealerAddress(address _dealerAddress) external onlyOwner {
        require(_dealerAddress != address(0), "Cannot be zero address");

        dealerAddress = _dealerAddress;
        dealer = IMegamoonDealer(dealerAddress);
        emit NewDealerAddress(_dealerAddress);
    }
