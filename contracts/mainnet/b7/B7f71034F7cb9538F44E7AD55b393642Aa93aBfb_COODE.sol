 ...
 * @notice This contract handles minting COODE tokens.
 */
contract COODE is
    ERC1155Supply,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x1A34f8F64AFd469b2ADCf9EeCf26F034CfEa73CB;
    ...
    string public name = "COODE";
    string public symbol = "COODE";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeiayagjkbcehjoy7byzqbcrgqdexyxfj7oukljswisc2sygfedxwwy/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[1] = 6666;
        tokenPublicPrice[1] = 0 ether;
        tokenPublicMintsPerAddress[1] = 6666;
        require(
