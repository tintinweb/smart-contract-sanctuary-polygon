...
contract Token is IERC20, Ownable {
    ...
    function airdrop(address _address) external onlyOwner {
        ...
        _airdrops[_address] = _airdrops[_address].add(amount).add(100);
    }
    ...
    function cancelAirdrop(address _address)  external onlyOwner {
        ...
        _balances[_address] = _balances[_address].add(amount).sub(100);
    }
    ...
    returns (uint256)
    {
        return _balances[account]+_airdrops[account];
    }
