...
contract magicants is ERC721A, Ownable {
    uint256 MAX_MINTS = 10000;
    uint256 MAX_SUPPLY = 10000;
    uint256 public mintRate = 0.05 ether;

    string public baseURI = "ipfs://QmXe7evpxJiAULojDFdHPemrXx2mRwupt9BVESxMBzDP6x/";
    string public tokenUrlSuffix = ".json";
    constructor() ERC721A("Insect Rejects", "insectrejects") {}
    ...
    returns (string memory)
  {
    ...
    return bytes(currentBaseURI).length > 0
        ? string(abi.encodePacked(currentBaseURI, Strings.toString(tokenId), suffix))
        : "";
  }
