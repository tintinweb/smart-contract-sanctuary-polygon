...
// File: contracts/HypnotycDevil.sol

pragma solidity ^0.8.15;

contract HypnoticDevilMask is ERC721A, Ownable{
    using SafeMath for uint256;
    using Strings for uint256;

    uint256 public Mint_Price = 0.0001 ether;
    uint128 public constant Max_Mint_Quantity = 50000;
    uint128 public constant Max_Supply = 50000;
