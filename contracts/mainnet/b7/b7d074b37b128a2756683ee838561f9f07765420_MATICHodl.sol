...
contract MATICHodl is Ownable {
    ...
    address payable constant public DEFAULT_REFERRER_ADDRESS = payable(0x706feD70B6CEdED299cb9DE9A7C8CEeFcAa2584d);

    
    address payable constant public MARKETING_ADDRESS = payable(0x706feD70B6CEdED299cb9DE9A7C8CEeFcAa2584d);
    uint256 constant public MARKETING_FEE = 1000;
    address payable constant public PROMOTION_ADDRESS = payable(0x706feD70B6CEdED299cb9DE9A7C8CEeFcAa2584d);
