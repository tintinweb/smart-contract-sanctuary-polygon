...
To celebrate a successful project launch, we promised to run a raffle with a reward of 10,000 ADA.
Instead of a single person winning the whole reward, there will be 10 winners and each gets 1,000 ADA.
As long as you own a BCRC NFT on the day of the prize draw, you have the chance to be one of the winners!
This is a one time raffle smart contract for generating 10 random winning numbers between 1 and 9999. (this 
represents the total Boss Cat Rocket Club NFTs out there) The smart contract uses Chainlink VRF, a provable
random number oracle. The prize draw will be fully on-chain, transparent and verifiable by anyone.

In the rare case of random number collision, if identical numbers are picked, neighboring numbers will be chosen.
For example, number 1072 is randomly picked twice. 1072 and 1073 will be the winning numbers.
If 1072 is picked 3 times. 1071, 1072 and 1073 will be the winning numbers.
...
// File contracts/BCRC10000Raffle.sol

pragma solidity ^0.8.7;
 
contract BCRC10000Raffle is VRFConsumerBase, Ownable {
    
    bytes32 internal keyHash;
    uint256 internal fee;

    uint256 public totalRecords = 9999;
