...
contract KHANBannedCountries is CountryRestrictions {
    uint[] public features;

    constructor () public {
        features = [1];

        uint16[] memory restrictedCountries = new uint16[](21);
        uint16[21] memory inputRestrictedCountries = [uint16(8), 112,70,100,180,384,191,192,364,368,408,430,807,499,104,642,688,705,729,760,716];
