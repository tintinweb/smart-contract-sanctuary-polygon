...
contract FeeConfigurator is OwnableUpgradeable {
    ...
    function getFees(address _strategy) external view returns (FeeCategory memory) { //TODO: CALL THIS FROM STRAT
    ...
    function setFeeCategory(
        ...
        FeeCategory memory category = FeeCategory(_total, _owner, _label, _active);
        feeCategory[_id] = category;
        emit SetFeeCategory(_id, _total, _label, _active);
    }
