...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
    ...
    address public constant farmToken1Addr = 0xfe4546feFe124F30788c4Cc1BB9AA6907A7987F9;
    // Fee token
        ...
        )
    {
        ...
        rewardToken0ToRewardToken1 = new address[](2);
        rewardToken0ToRewardToken1[0] = rewardToken0Addr;
        rewardToken0ToRewardToken1[1] = rewardToken1Addr;
...
contract StrategyTwoAssets is StrategyFarmTwoAssets {
    // Token addresses
    address public FARM_MASTER_CHEF = 0xD8F0af6c455e09c44d134399eD1DF151043840E6;
    address public LP_TOKEN = 0xda7cd765DF426fCA6FB5E1438c78581E4e66bFe7;
    constructor()
        public
