    ...
    DefaultOperatorFilterer
{
    ...
    constructor() ERC721A("Vaultd Collection", "Vaultd") {
        admins[msg.sender] = true;
    }

    modifier onlyAdmin() {
        require(admins[_msgSender()], "Vaultd: Caller is not the admin");
        _;
    }
    ...
    function claimNFT() external {
        ...
        require(total < MAX_ELEMENTS, "Vaultd: Max limit");
        ...
        onlyAdmin
    {
        ...
        require(total + totalQuantity <= MAX_ELEMENTS, "Vaultd: Max limit");
