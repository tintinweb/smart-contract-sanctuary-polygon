...
import "../interfaces/ICyberStaking.sol";

/*  CyberTreasury.sol ============================================
    The contract is to store the reserve of Cyber Protocol
...
contract CyberTreasury is Ownable {
    ...
    ICyberStaking public staking;

    constructor(ICyberStaking _staking) {
        staking = _staking;
    }

    // ========== PUBLIC VIEW FUNCTIONS ============

    /// @notice Return ERC-20 balance of CyberTreasury
    /// @param _token Address of the ERC-20 token
    /// @return Balance of the CyberTreasury
    ...
    function requestFund(address _token, uint256 _amount) external {
        require(strategies[msg.sender], "CyberTreasury::requestFund: Only strategies can request fund");
        require(_amount <= balanceOf(_token), "CyberTreasury::requestFund: Request more fund than balance");
    ...
    function addStrategy(address _strategy) external onlyOwner {
        require(_strategy != address(0), "CyberTreasury::addStrategy: invalid address");
        require(!strategies[_strategy], "CyberTreasury::addStrategy: strategy was previously added");
    ...
    function removeStrategy(address _strategy) external onlyOwner {
        require(strategies[_strategy], "CyberTreasury::removeStrategy: strategy not found");
    ...
    function allocateFee(address _token, uint256 _amount) external onlyOwner {
        require(address(staking) != address(0), "CyberTreasury::allocateFee:Fee distributor not set");
        require(_amount > 0, "CyberTreasury::allocateFee: invalid amount");
