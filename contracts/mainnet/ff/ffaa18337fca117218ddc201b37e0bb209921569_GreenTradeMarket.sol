...
contract GreenTradeMarket is Ownable, ERC721Holder {
    ...
    function buyToOther(uint256 _id, address toAddr) external payable {
		...
		nftCollection.safeTransferFrom(address(this), toAddr, pair.token_id);
