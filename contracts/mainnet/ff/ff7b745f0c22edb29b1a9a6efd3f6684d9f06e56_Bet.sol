...
contract Bet {
    ...
    function betA(uint _question_no) payable public check_betac(_question_no){
        payable(address(this)).transfer(msg.value);
        question_records[_question_no-1].totalA+=msg.value;
        question_records[_question_no-1].total+=msg.value;
        ...
        question_records_balances[_question_no-1].balancesA[msg.sender]+=msg.value;
        question_records_balances[_question_no-1].balancesA_record[msg.sender]+=msg.value;
    }

    function betB(uint _question_no) payable public check_betac(_question_no){
        payable(address(this)).transfer(msg.value);
        question_records[_question_no-1].totalB+=msg.value;
        question_records[_question_no-1].total+=msg.value;
        if (question_records_balances[_question_no-1].balancesA[msg.sender]==0 && question_records_balances[_question_no-1].balancesB[msg.sender]==0){
            question_records[_question_no-1].participant_add.push(msg.sender);
        ...
        question_records_balances[_question_no-1].balancesB[msg.sender]+=msg.value;
        question_records_balances[_question_no-1].balancesB_record[msg.sender]+=msg.value;
    }
