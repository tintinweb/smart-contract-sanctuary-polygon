...
contract PROPERTIES is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, PausableUpgradeable,ERC2981Upgradeable, OwnableUpgradeable, ERC721BurnableUpgradeable, UUPSUpgradeable {
    uint currentTokenId;
    ...
    function initialize(string memory _contractURI) initializer public {
        ...
        propertyPrice[0] = 120 ether;
        propertyPrice[1] = 150 ether;
        propertyPrice[2] = 250 ether;
        propertyPrice[3] = 1250 ether;
        currentTokenId = 1;
        MAX_SUPPLY = 50000;
        MAX_PER_WALLET = 50000;
        setRoyaltyInfo(0x10c34C3EBeA5163EfAe92D6A36a7b93249beCb45, 500);
        contractURI = _contractURI;        
        wallet1 = payable(0x0DcEa79Ce1aF147Ee40873c5516Fd18b34440871);
    }
    ...
    function withdrawMoney() public onlyOwner {
        require(wallet1 != address(0), "Assign wallet1, wallet2 and royaltyAddress addresses properly");
