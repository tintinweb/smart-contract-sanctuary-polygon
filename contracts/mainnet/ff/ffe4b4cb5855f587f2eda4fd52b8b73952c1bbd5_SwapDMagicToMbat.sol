...
// File: contracts/SwapDMagicToMbat.sol
...
contract SwapDMagicToMbat is Ownable, ReentrancyGuard {
    using SafeERC20 for IERC20;

    address private depositToken=0x61dAECaB65EE2A1D5b6032df030f3fAA3d116Aa7; //DMAGIC
    address private returnToken;
    uint256 private returnRatio;     
    uint256 private depositRatio;
    address private outputAddress=0xD99223236EF9576E28d3856514257dd1Df3A4A74;
    uint256 public depositCount;
    uint256 public depositTotal;
    uint256 public returnTotal;

    constructor(address _returnToken, uint256 _returnRatio, uint256 _depositRatio) {
    ...
    function depositTokens(uint256 _amount) external nonReentrant {
        ...
        uint256 returnAmount = _amount * returnRatio / (depositRatio*10**9);
    ...
    function getMaximumDeposit() public view returns(uint256) {
        ...
        return bal * (depositRatio*10**9) / returnRatio;
    }

    function getOutputAmount(uint amount_) public view returns(uint256) {
        return amount_ * returnRatio / (depositRatio * 10**9);
    }    
