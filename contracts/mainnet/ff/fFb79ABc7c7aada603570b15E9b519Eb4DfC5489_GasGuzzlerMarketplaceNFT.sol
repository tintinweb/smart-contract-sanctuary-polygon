...
contract GasGuzzlerMarketplaceNFT is
ERC1155Upgradeable,
...
OwnableUpgradeable
{
    ...
    /**
        @notice This is initializer function is used to initialize this contract
    */
...
/**
        @notice This function is used toggle the controller status of an address
        @param _controller The address of the controller
    */
    function toggleController(address _controller) public onlyOwner {
        isController[_controller] = !isController[_controller];
    }

    /**
        @notice This function is used to mint NFTs
        @param _to address of the receiver
        @param _tokenId The tokenId of NFT to mint
    ...
    */
    ...
    /**
        @notice This function is used to mint NFTs in batch
        @param _to The address where the tokenIds will be minted
        @param _tokenIds The tokenId of NFTs to mint
        @param _amounts The amount of NFTs to be mint
    */
    function batchMint(
        address _to,
    ...
    /**
        @notice This function is used to burn NFTs
        @param _from The user whose token will be burnt
        @param _tokenId The tokenId of NFT to burn
        @param _amount The amount of NFTs to be burned
    */
    function burn(
        address _from,
        uint256 _tokenId,
    ...
    /**
        @notice This function is used to burn NFTs in batch
        @param _from The user whose token will be burnt
        @param _tokenIds The tokenId of NFTs to burn
        @param _amounts The amount of NFTs to be burned
    */
    function batchBurn(
        address _from,
        uint256[] memory _tokenIds,
    ...
    /**
        @notice This function is used to show the token URI of the NFTs
    ...
    */
    ...
    /**
        @notice This function is used to set the base token URI
        @param _uri The base token URI
    */
    ...
    /**
        @notice  These functions are the OS implementation of  Operator Filter Registry
    */
...
abstract contract OperatorFiltererUpgradeable is Initializable {
    ...
    function __OperatorFiltererRegisterAndSubscribe(address subscriptionOrRegistrantToCopy) internal {
        operatorFilterRegistry.registerAndSubscribe(address(this), subscriptionOrRegistrantToCopy);
    }
