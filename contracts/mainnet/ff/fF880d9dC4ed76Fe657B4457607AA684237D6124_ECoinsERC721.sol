...
interface IECoinsLogic
{
    ...
    function burnedTokenURI(uint256 tokenId) external view returns (string memory);
...
contract ECoinsERC721 is Pausable, Ownable, ECoinsAccessControl, IECoinsERC721, ERC721
{
    IECoinsLogic internal _logic;
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    constructor() ERC721("EmojiCoins", "ECoin")
    {
    }
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        require(tokenId < _tokenIds.current(), "ECoinsERC721: URI query for nonexistent token");
        if (!_exists(tokenId)) return _logic.burnedTokenURI(tokenId);
    ...
    function _beforeTokenTransfer(address from, address to, uint256 tokenId) internal virtual override { 
        _logic.beforeTokenTransfer(from, to, tokenId);
    }
