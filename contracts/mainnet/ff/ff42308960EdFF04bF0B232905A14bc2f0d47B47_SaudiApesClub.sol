...
contract SaudiApesClub is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeigmjifnjtx2a6bmtujqe5s23e44twzoeousvwecujfz7kf4hfjwim/", Strings.toString(tokenId), ".json")
            );
    }
