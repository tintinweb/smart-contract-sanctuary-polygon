...
contract FalineArena12 is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public cost = 5.50 ether;
  uint256 public maxSupply = 735;
  uint256 public maxMintAmountPerTx = 20;

  bool public paused = true;
  bool public revealed = false;

  constructor() ERC721("Faline Arena 12", "FA12") {
    setHiddenMetadataUri("ipfs://bafybeigiots5wyfb6jow5byze3vpwxgpmmrsvzog5ya3xa5ylab3to2hta");
  }
