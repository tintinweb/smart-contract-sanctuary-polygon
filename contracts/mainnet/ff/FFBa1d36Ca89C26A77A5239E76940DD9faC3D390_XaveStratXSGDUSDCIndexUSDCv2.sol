...
contract XaveStratXSGDUSDCIndexUSDCv2 is Ownable {
        ...
        returns (uint256[] memory)
    {
        ...
        (uint256[] memory tokenAmounts, address[] memory tokenAddresses) = removeLiquidity(lpTokensReceived);
    ...
    function removeLiquidity(uint256 lpTokenAmount) internal returns (uint256[] memory, address[] memory) {
        bytes32 poolId = IFXPool(addresses.lpToken).getPoolId();
