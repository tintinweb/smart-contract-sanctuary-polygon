...
contract PlantTree is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xabBdB1145d16bd727965Bc2C7E665E2A647E256e); // Marketing Address
    address payable public airdropAddress = payable(0x07390e7506d0dB9834237B0b9Ae0e0e5a84CB987
); // Airdrop Address
    ...
    string private _name = "PlantTree";
    ...
    uint256 public airdropDivisor = 3;
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap 
    {
        ...
        uint256 airdropBnb =  transferredBalance.div(_liquidityFee).mul(airdropDivisor);
        transferToAddressETH(marketingAddress, marketingBnb);
        transferToAddressETH(airdropAddress, airdropBnb);
    }
    ...
    function setAirdropAddress(address _newaddress) external onlyOwner() {
        airdropAddress = payable(_newaddress);
    }
