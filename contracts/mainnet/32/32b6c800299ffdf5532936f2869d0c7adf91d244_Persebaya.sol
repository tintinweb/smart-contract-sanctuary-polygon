...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC9a6b9a061Ef874c2E155936092F867F57b0A044; // owner address
...
contract Persebaya is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Persebaya Fan Token";
    string private _symbol = "PSBY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0AC26ad9229218FD94105DF4261766cAb78dfA44); // Marketing Address
    address payable public teamWalletAddress = payable(0xDcf294340b0D4C45A9C857D0c3d1B2A962033a4d); // Team Address
    ...
    uint256 public _teamShare = 4; // original 12

    uint256 public _totalTaxIfBuying = 12;  // original 12
    uint256 public _totalTaxIfSelling = 14;  // original 12
    uint256 public _totalDistributionShares = 12;  // original 12

    uint256 private _totalSupply = 100000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 2000000000 * 10**_decimals; 
    uint256 public _walletMax = 7000000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 100000000000 * 10**3; 
