...
interface IERC4626 {
    ...
    function convertToAssets(uint256 shares)
        ...
        function activeWithdraw(uint256 amount) external;
        function activeDeposit(uint256 amount) external;
...
contract Superstate3 is UniswapV2ERC20{
...
// update controller
    ...
    function swap(
        ...
        (uint112 _reserve0, uint112 _reserve1) = (uint112(getBalances0()),uint112(getBalances1())); // gas savings
        require(
        ...
        uint256 balance1;
        {
            ...
            balance0 = getBalances0()+ IERC20(token0).balanceOf(address(this));
            balance1 = getBalances1()+ IERC20(token1).balanceOf(address(this));
        }
