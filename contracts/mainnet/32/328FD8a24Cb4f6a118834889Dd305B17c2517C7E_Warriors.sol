...
contract Warriors is ERC721, ReentrancyGuard, Ownable {
  ...
  uint256 public constant MAX_MULTIMINT = 5001;
  ...
  function mint(uint256 count) public nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 5001 at a time");
