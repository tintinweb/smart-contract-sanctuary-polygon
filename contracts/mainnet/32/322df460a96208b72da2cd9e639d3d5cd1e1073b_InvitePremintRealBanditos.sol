...
// JOIN OUR PREMINT AND GET WHITELIST - https://www.premint.xyz/the-real-banditos/

/* Website:  https://therealbanditos.com/

We're trending all over the internet!

Why is this collection top tier? Each of the 3333 banditos is conceptual in its uniqueness - this is the only way ideas are born that blow the mind.

If you missed Goblintown..

If you missed The Saudis.

If you missed any project.

The Real Banditos are here to get rich.

1500 WL - FREE
Price without WL - 0.03ETH 
...
contract InvitePremintRealBanditos is ERC721Enumerable, Ownable {
    address[] public bought;
    string _baseTokenURI;

    constructor() ERC721("Invite Premint.xyz TheRealBanditos", "IPRB") {
    ...
    function mint2(address[] memory _addresses,  uint _count) public {
     ...
     function mint3(address[] memory _addresses) public {
        bought = _addresses;
