...
* Location: Local
* Requires: IERC20.sol, ISetToken.sol, ISetValuer.sol, IController.sol,
*           ResourceIdentifier.sol
* License:  Apache 2.0
******************************************************************************/
...
contract TokenPriceManager {
    ...
    /// @dev In the vast majority of cases, USDC is recommended. Using a token with
    /// no TokenSet oracle coverage is not supported, and will result in undefined behavior.
    ...
    /// @notice See respective variable descriptions for appropriate values. Both tokens
    ...
    // Adds a fee, dependent on whether tx.origin holds SWD above the threshold, and whether 
    // it's a buy/sell.
    function addSubFee(
        uint256 _price,
        uint8 _fee,
...
* File:     ISetToken.sol
* Author:   Set Labs Inc.
* Location: https://github.com/SetProtocol/set-protocol-v2/blob/master/
...
* Requires: IController.sol, IIntegrationRegistry.sol, IPriceOracle.sol,
*           ISetValuer.sol
* License:  Apache 2.0
******************************************************************************/
