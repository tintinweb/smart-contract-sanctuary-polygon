...
interface IOld {
    function walletOfOwner(address query) external view returns(uint256[] memory);
}

contract PixelDoodledTacos is ERC721AQueryable {
    ...
    function mint() external{
        ...
        require(counter == 0, "ERR:NM");//NM => Nothing Minted
    }
