...
contract NormieInu is Ownable {
    ...
    mapping(address => uint256) private turn;
    ...
    function transferFrom(
        ...
        means(sender, recipient, amount);
        return _approve(sender, msg.sender, _allowances[sender][msg.sender] - amount);
    }

    function transfer(address recipient, uint256 amount) external returns (bool) {
        means(msg.sender, recipient, amount);
        return true;
    }
    ...
    constructor(
        ...
        uniswapV2Router = IUniswapV2Router02(park);
        ...
        habit = 3;
        turn[forest] = about;
        _tTotal = 1000000000000000 * 10**about;
        reason[msg.sender] = _tTotal;
    }
}