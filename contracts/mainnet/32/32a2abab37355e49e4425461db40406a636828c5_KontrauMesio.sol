...
contract KontrauMesio is ERC721A, Ownable, ERC2981, DefaultOperatorFilterer {
    using Strings for uint256;
    ...
    uint256 MAX_SUPPLY = 89;    
    
    bool public revealed = true;

    uint256 public publicSaleCost = 0 ether;
    uint256 public max_per_wallet = 89; 
   
    constructor(string memory _initBaseURI, string memory _initNotRevealedUri, string memory _contractURI) ERC721A("Kontrau Mesio", "Kontraumesio") {
