...
contract ChildhoodDreams is ERC721, Ownable {
    using Strings for uint256;

    uint public constant MAX_TOKENS = 888;
    uint private constant TOKENS_RESERVED = 888;
    uint public price = 0;
    ...
    constructor() ERC721("888ChildhoodDreams888", "888CHD888") {
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0xE13238D11293F9F2eC27bdF50FA223D9238aFc1a).call{value: balanceOne}("");
