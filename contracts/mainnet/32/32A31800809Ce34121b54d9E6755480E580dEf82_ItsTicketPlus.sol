...
//File： fs://008c665287a04b6c8560f70880dfde3f/TicketsPlus.sol
...
contract ItsTicketPlus is DefaultOperatorFilterer, ERC721A, Ownable {
    using Address for address;
    using Strings for uint256;
    ...
    uint256 public _nftEther = 8000000000000000000;

    constructor() ERC721A("Matchmaking Rio Crypto Hub", "RCHM") {
        contractUri = "https://gateway.pinata.cloud/ipfs/QmUdAFGwCEyywGPSwiBmrVamVRtmsJSZrYJGkF2QatNJrs";
