...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, Ownable{
    ...
    function mint(address to, uint256 tokenId, string memory ticketUri) public {
...
contract MutantApe is ERC721 {
    constructor() ERC721(
        "MutantApe", "APE", "https://gateway.pinata.cloud/ipfs/QmPBDvjBBdBW1uGSB6L1QTZULs8VgCv8iPQ6erPokhnGdK"
    ){
