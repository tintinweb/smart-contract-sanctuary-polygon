// NOTE: Copied from https://github.com/OpenZeppelin/openzeppelin-contracts-upgradeable/blob/e48b7beb4cf3eecfbb956d79fc9bdd8f0a850ea2/contracts/utils/structs/DoubleEndedQueueUpgradeable.sol as it is not released yet
...
contract LockedApocryphToken is Initializable, ERC20Upgradeable, AccessControlUpgradeable, ERC20BurnableUpgradeable, ERC20PermitUpgradeable, ERC20VotesUpgradeable, UUPSUpgradeable {
    ...
    function initialize() initializer public {
        __ERC20_init("Locked Apocryph", "LCRYPH");
        __AccessControl_init();
        __ERC20Burnable_init();
        __ERC20Permit_init("Locked Apocryph");
...
/// @custom:security-contact [email protected]
contract CommunityDAO is Initializable, GovernorUpgradeable, GovernorSettingsUpgradeable, GovernorCountingSimpleUpgradeable, GovernorVotesUpgradeable, GovernorVotesQuorumFractionUpgradeable, GovernorTimelockControlUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() initializer {}
        ...
        initializer public
    {
        ...
        __GovernorSettings_init(1 /* 1 block */, 288000 /* 1 week */, 1e17);
