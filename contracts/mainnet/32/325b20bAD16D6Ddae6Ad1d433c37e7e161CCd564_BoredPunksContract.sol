...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xd6d1f904B120395A5fa9406Aa32518840B287333];
  address public erc20Payable = 0xd6d1f904B120395A5fa9406Aa32518840B287333;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1000, 2222) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeihc2oyggslfdlxgwmk32zmvlfphd3x4roijloaqezap3tldxnhpua/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/r65LoDwQrFGhIPGmmgR9/contract-metadata";
  }
...
// File: contracts/BoredPunksContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BoredPunksContract is ERC721APlus {
    constructor() ERC721APlus("Bored Punks", "BoredPunks"){}
}
