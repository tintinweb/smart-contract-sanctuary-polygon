...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
    ...
    uint256 public gohmCutoffBps = 10**8;
    // The reward --> fee token path
    address[] public rewardToFeeTokenPath;
    address[] public rewardToFeeTokenPath2;
        ...
        )
    {
        ...
        rewardToFeeTokenPath2 = new address[](3);
        rewardToFeeTokenPath2[0] = farmToken0Addr;
        rewardToFeeTokenPath2[1] = farmToken1Addr;
        rewardToFeeTokenPath2[2] = rewardTokenAddr;
    ...
    function set_gohmCutoff(uint256 newCutoff) external onlyOwner {
        gohmCutoffBps = newCutoff;
        emit SetHarvestCutoff(gohmCutoffBps);
    }
    ...
    function harvest() public override nonReentrant {
        ...
        swapAmount = calculateSwapAmount(farmToken0Addr, 10000);
        if (swapAmount > gohmCutoffBps) {
            _swapUniswapWithPathForFeeOnTransferTokens(
                rewardToFeeTokenPath2,
                swapAmount,
                swapRouter0Addr
            );
        }
