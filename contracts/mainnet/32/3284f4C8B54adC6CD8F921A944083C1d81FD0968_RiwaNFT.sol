...
contract RiwaNFT is ERC721Enumerable, Ownable, ReentrancyGuard {
    // variables
    address public contractOwner;
    string private currentBaseURI;
    address public signerAddress =
    address(0x650D19819c7290398A60F22cF3B0d00690FDB310);
    ...
    // grant role to user as admin by admin
    function revokeAccess(address to) public onlyAdmin {
        isOwnerShip[to] = false;
    }
