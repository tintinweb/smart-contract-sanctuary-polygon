...
contract RichMutantGoats is ERC721A, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721A("RichMutantGoats", "RMG", maxMintAmountPerTx) {
    setHiddenMetadataUri("ipfs://QmPzwMspcP1aEXBqGiCY37JkeD9YWANp52uLs8BoXwa5JL/hidden.json");
  }
