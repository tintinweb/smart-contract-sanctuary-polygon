...
contract TxnTransferV0 is UpgradableOwnableV1 {
    ...
    function _testShareSignature(uint256 shareId, address provider, uint256 amount, uint256 fee, bytes calldata signature) public view returns (bool, address) {
    ...
    function _testReceiveSignature(uint256 shareId, address provider, address shareContract, bytes calldata signature) public view returns (bool, address) {
        bytes memory prefix = "\x19Ethereum Signed Message:\n32";
