...
contract PowerPigs is ERC721A, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721A("PowerPigs", "PwrPigs", maxMintAmountPerTx) {
    setHiddenMetadataUri("ipfs://QmURM9DZeDRQ2gfTTgeQQnJekc94RrUvzgyBGV7RHdAAc6/hidden.json");
  }
