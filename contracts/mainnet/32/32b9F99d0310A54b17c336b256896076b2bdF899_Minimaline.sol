...
contract Minimaline is ERC721 {
    uint256 public totalSupply;
    uint256 public cost = 0.1 ether;
    uint256 public maxMints = 28;
    ...
    constructor()
        ERC721("Minimaline", "MNML")
    {}

    function mint() external payable {
        
        if (userMints[msg.sender] >= maxMints) revert MintLimit();
        if (totalSupply + 1 > 29) revert SoldOut();
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeig5sxf25q2i3hcggjts4ucksgsdwtzc2blokahyia2cq45ntccfum/", Strings.toString(tokenId), ".json")
            );
    }
