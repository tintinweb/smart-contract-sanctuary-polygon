...
contract VELOCIRAPTOR is Context, IERC20 {
    ...
    string private constant _name = "VELOCIRAPTOR";
    ...
    uint256 public _Raptor_maxWallet = (_tTotal * 6) / 100;
    uint256 private _previousMaxWalletToken = _Raptor_maxWallet;

    uint256 public _Raptor_maxTx = (_tTotal * 3) / 100;
    uint256 private _previousMaxTxAmount = _Raptor_maxTx;

    uint8 private txCount = 0;
    uint8 private swapTrigger = 10;

    address payable public _Raptor_Dev__Wallet =
        payable(0x6F8e0C1B6Ec841a66bFf7c87c90A75ccB83be0F8);
    address payable public constant __Burn__Wallet =
        payable(0x000000000000000000000000000000000000dEaD);
    address payable public _Raptor_Dream__Wallet =
        payable(0x6F8e0C1B6Ec841a66bFf7c87c90A75ccB83be0F8);

    uint256 public _Auto_Burn__ = 0;
    uint256 public _Auto_LP__ = 20;
    uint256 public _Auto_Marketing__ = 50;
    uint256 public _Auto_Dev__ = 30;
    ...
    constructor() {
        _owner = 0x65095e4daE5cF6A43d6D6eA12Bc52CC56Af17b61;
        ...
        _isExcludedFromFee[_Raptor_Dream__Wallet] = true;
    ...
    function _transfer(
        ...
        if (
            ...
            require(
                (heldTokens + amount) <= _Raptor_maxWallet,
                "Over wallet limit."
            );
        }

        if (from != owner())
            require(amount <= _Raptor_maxTx, "Over transaction limit.");
        ...
        if (
            ...
            if (contractTokenBalance > _Raptor_maxTx) {
                contractTokenBalance = _Raptor_maxTx;
            }
            txCount = 0;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        sendToWallet(_Raptor_Dream__Wallet, BNB_M);

        BNB_Total = address(this).balance;
        sendToWallet(_Raptor_Dev__Wallet, BNB_Total);
    }
