...
contract Celtapay {
    //uint256 public constant ticketPrice = 2 ether;
    uint256 public ticketPrice; 
    uint256 public constant maxTickets = 100; // maximum tickets per lottery
    uint256 public constant ticketCommission = 0.4 ether; // commition per ticket
    ...
    //events
    event PriceTicketChange(uint256 newTicketPrice);
    ...
    function ChangePrice(uint256 _newTicketPrice) public isOperator {
        ticketPrice = _newTicketPrice;
        emit PriceTicketChange(_newTicketPrice);
    }
}