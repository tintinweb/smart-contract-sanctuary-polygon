...
contract PrincessANT is ERC721, Ownable {
    ...
    uint256 public immutable MATE_DURATION = 1 minutes;
    ...
    function getMatedPrincesses(address _user) public view returns(uint256[] memory) {
        uint256[] memory matedPrincessList;
        uint256[] memory _princessList = playerToPrincesses[_user];
        uint256 matedPrincessCount;
    ...
    function burn(address _user, uint256 _index) public {
        ...
        playerToPrincesses[_user][_index] =  playerToPrincesses[_user][ playerToPrincesses[_user].length - 1];
