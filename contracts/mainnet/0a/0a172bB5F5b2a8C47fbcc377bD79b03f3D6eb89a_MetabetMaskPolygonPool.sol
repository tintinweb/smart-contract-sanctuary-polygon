...
import "./interfaces/IMetabetMaskPolygon.sol";
 ...
 */
contract MetabetMaskPolygonPool is 
    Ownable, 
    ReentrancyGuard{
    ...
    */
     ...
     * @param _metabet metabet token address
     */
    constructor(
    ...
    */
        ...
        external nonReentrant
    {
        ...
        for(uint i; i < _eventIds.length; i++){
            ...
            ITokenPool(events[i].metabetPool).withdrawToken(
                _token, 
                msg.sender, 
                reward
            );
