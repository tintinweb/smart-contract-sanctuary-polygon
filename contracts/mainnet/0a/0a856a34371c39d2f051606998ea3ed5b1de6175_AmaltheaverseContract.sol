...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xb6A9cb146cc85CD9659F66d6eE5859B51a622153];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 50, 3000 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmbXmxRAWbp3HebDFasK74SZZmdufjNmRQqF8cSdwHBLde/";
...
contract AmaltheaverseContract is RamppERC721A {
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/u5rGuEHpwpyvhMxMNmP7/contract-metadata";
    }
}
