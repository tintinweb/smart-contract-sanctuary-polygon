...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xec2bef2dC3ECCabb2923E5e024d12b6b2F8FAcD2;
...
contract LNI28 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xec2bef2dC3ECCabb2923E5e024d12b6b2F8FAcD2;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 7500000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Lobo Nickel Investments 28";
    ...
    uint256 public _maxTxAmount = 7500000000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 7500000 * 10**18;
