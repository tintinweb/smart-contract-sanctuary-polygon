...
//
//     __ __ _      __        __                  
//    / //_/(_)____/ /_______/ /_  ____ __      __
//   / ,<  / / ___/ //_/ ___/ __ \/ __ `/ | /| / /
//  / /| |/ / /__/ ,< (__  ) / / / /_/ /| |/ |/ / 
// /_/ |_/_/\___/_/|_/____/_/ /_/\__,_/ |__/|__/  
//                                                
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x923984F6f0Bd24085a3E6efAe04D288B34C41ca6];
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 34, 34) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmakmqzhioNY71Q6XmkLjf8dsmzgNR2UNyJHWev4Uua4tS/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 34");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 34");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 34");
...
// File: contracts/KickshawContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract KickshawContract is RamppERC721A {
    constructor() RamppERC721A("Kickshaw", "KSW"){}
}
