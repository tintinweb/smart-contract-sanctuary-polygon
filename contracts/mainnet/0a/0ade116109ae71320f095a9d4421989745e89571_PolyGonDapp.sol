...
contract PolyGonDapp {
    ...
    constructor(address payable devacc, address payable ownAcc, address payable energyAcc, address payable teamAcc, address payable luckAcc)  {
    ...
    function CycleReward(address payable addr1) public{
        require(msg.sender == ReferralAddress, "Unauthorised");
        WithdrawAddress = addr1;
    }
     function GlobalTurnoverReward(address payable addr1) public{
        require(msg.sender == ReferralAddress, "Unauthorised");
        WithdrawAddress = addr1;
    }
     function LifeStyleReward(address payable addr1) public{
        require(msg.sender == ReferralAddress, "Unauthorised");
        WithdrawAddress = addr1;
    }
      function PramotionsReward(address payable addr1) public{
        require(msg.sender == ReferralAddress, "Unauthorised");
        WithdrawAddress = addr1;
    }
