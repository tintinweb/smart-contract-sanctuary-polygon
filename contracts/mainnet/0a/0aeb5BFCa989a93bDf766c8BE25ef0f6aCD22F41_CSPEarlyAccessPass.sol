...
contract CSPEarlyAccessPass is ERC721, Pausable, AccessControl, TransferWhitelistable {
    ...
    constructor(address[] memory initialWhitelist, address initAdminWallet, string memory initialBaseURI, string memory contractName, string memory contractShortName) ERC721(contractName, contractShortName) TransferWhitelistable(initialWhitelist) {
