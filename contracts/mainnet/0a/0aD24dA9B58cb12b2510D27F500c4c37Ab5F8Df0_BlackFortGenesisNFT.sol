...
contract BlackFortGenesisNFT is ERC721RaribleRoyalty, ERC721Enumerable, Ownable {
    ...
    constructor(
        ...
        LibPart.Part[] memory lp = new LibPart.Part[](1);
        lp[0].account = payable(msg.sender);
        lp[0].value = 1000;
        _setDefaultRoyalties(lp);
    }
    ...
    function supportsInterface(bytes4 interfaceId) public view override(ERC721Enumerable, ERC721RaribleRoyalty) returns (bool) {
        return super.supportsInterface(interfaceId);
    }

    receive() external payable {
        uint256 amountOfTokens = msg.value / PRICE;
