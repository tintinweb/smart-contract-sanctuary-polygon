    ...
    OwnableUpgradeable
{
    ...
    struct CommunityContainer {
        string uniqId;              // should be a unique identifier, can be uuid
        string name;
    ...
    event RegisteredCommunity(string uniqId, string displayId);

    /// @dev This event allows us to track which community metadata was modified.
    event ModifyCommunityMetadata(string uniqId, string displayId, string name, string logoUrl, string discordId, string discordServerName);
    ...
    function createCommunityAndAddInitialAdmin(
        ...
        emit RegisteredCommunity(uniqId, displayId);
    }
    ...
    function modifyCommunityMetadata(
        ...
        if (!compareStringsbyBytes(displayId, "")) {
            cc.displayId = displayId;
        }
        ...
        emit ModifyCommunityMetadata(uniqId, displayId, name, logoUrl, discordId, discordServerName);
    }
