...
contract X7EcosystemMaxi is ERC721Enumerable, ERC721Holder, Ownable {
    ...
    // 130 Matic
    uint256 public mintPrice = 130 * 10**18;
    ...
    constructor(address mintFeeDestination_, address treasury_) ERC721("X7 Ecosystem Maxi (Polygon)", "mX7EMAXI") Ownable(msg.sender) {
