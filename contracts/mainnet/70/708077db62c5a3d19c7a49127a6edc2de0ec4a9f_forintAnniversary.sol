...
contract forintAnniversary is ERC721A, Ownable, ReentrancyGuard {
    ...
    function forintBalance() public returns(uint256){
        balanceForint[_msgSender()] = ERC20(0x5CEeBB0947d58Fabde2fc026Ffe4B33ccFE1bA8B).balanceOf(_msgSender());
        return balanceForint[_msgSender()];}
