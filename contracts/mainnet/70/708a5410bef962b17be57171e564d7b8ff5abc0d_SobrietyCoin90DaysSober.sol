...
// File: contracts/90DaysSober/Sobriety90DaysSober.sol
...
contract SobrietyCoin90DaysSober is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("SOBRIETY Coin for 90 DAYS SOBER", "SOBER90Day") {
    setHiddenMetadataUri("ipfs://QmcecDiVHRgrRehwexac7UTyemfe2rpYjfZKpzrEt4M2NT/hidden.json");
  }
