...
@Reef_Chain
Blockchain designed to make Web3 accessible for next billion users.
 L1 built using Substrate Framework. $Developers: http://github.com/reef-defi; 
 $20M Grant Fund.
reef.io
...
contract Reef is ReefDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private ReefTeam;
    address private CharityReef;
    ...
    string public override name = "Reef";
    string public override symbol = "REEF";
    ...
    constructor(uint totalSupplyValue, address ReefTeamAddress, address CharityReefAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        ReefTeam = ReefTeamAddress;
        CharityReef = CharityReefAddress;
        
        // split the tokens according to agreed upon percentages
        balances[ReefTeam] =  totalSupply * 4 / 100;
        balances[CharityReef] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's ReefTeam pot
