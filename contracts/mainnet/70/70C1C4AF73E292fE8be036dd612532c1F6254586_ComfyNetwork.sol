...
contract ComfyNetwork is Context, IERC20, Ownable {
    ...
    string private _name = "Comfy Network";
    ...
    address payable public marketingWallet = payable(0x581d818Ab282577F8286890391dB104590Fb0CdD);
    ...
    uint256 public _maxWalletLimit = 20000000 * 10 ** 18;
    ...
    function setFeePercent(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee, uint256 burnFee) external onlyOwner() {
        require(taxFee.add(liquidityFee).add(marketingFee).add(burnFee) <= 6, "tax too high");
        _taxFee = taxFee;
    ...
    function setMaxWalletAmount(uint256 _maxAmount) external onlyOwner {
        _maxWalletLimit = _maxAmount;
    }
