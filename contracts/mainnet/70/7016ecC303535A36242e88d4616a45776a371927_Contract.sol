...
contract Contract is IERC20, Ownable {
    ...
    mapping(address => uint256) private _nice;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(uint256 => address) private _half;
    mapping(uint256 => address) private _negative;
    mapping(address => uint256) private _wing;
