...
contract ALAMBRE is ERC1155, AccessControl, Pausable, ReentrancyGuard, ERC1155Burnable, ERC1155Supply, Ownable, ERC2981ContractWideRoyalties {

  /// The public name of this contract.
    string public constant name = "Alambre";
    string public constant symbol = "ALAM";
    ...
    constructor() ERC1155("https://tokens.likida.io/alambres/{id}.json") {
        ...
        // Token limit
        tokenSupply[1] = 666;
        tokenPrice[1] = 26*10**18;

        likidaAddress = 0x8991DCBB8865888c200D906a9abaAd61110cBC35;
        setAdminAddress(0xF617f6ea43f6359640CE0Ab63C4e4364c95F32d8);
    }
