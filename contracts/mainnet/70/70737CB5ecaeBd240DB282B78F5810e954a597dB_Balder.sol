...
contract Balder is ERC20, ERC20Burnable, Ownable, Pausable, DividendTrackerFunctions {
    ...
    constructor()
        ERC20(unicode"Balder", unicode"BLD") 
    {
        address supplyRecipient = 0xC3355CF62213Ad8bA249508c28DA0e2805937F30;
        
        marketAddressSetup(0x9c63d5aC8168A43a08616892319695a2538e6476);
        marketFeesSetup(100, 250, 100);

        autoBurnFeesSetup(100, 400, 0);

        updateSwapThreshold(5 * (10 ** decimals()));

        lpTokensReceiverSetup(0xAED1C08bc68bF1B72EbCfDa7c52896b329aaF198);
        liquidityFeesSetup(200, 350, 0);

        _deployDividendTracker(600, 5 * (10 ** decimals()));
        ...
        _transferOwnership(0xC3355CF62213Ad8bA249508c28DA0e2805937F30);
    }
    ...
    function marketFeesSetup(uint16 _buyFee, uint16 _sellFee, uint16 _transferFee) public onlyOwner {
        ...
        totalFees[0] = 0 + marketFees[0] + autoBurnFees[0] + liquidityFees[0] + rewardsFees[0];
        totalFees[1] = 0 + marketFees[1] + autoBurnFees[1] + liquidityFees[1] + rewardsFees[1];
        totalFees[2] = 0 + marketFees[2] + autoBurnFees[2] + liquidityFees[2] + rewardsFees[2];
    ...
    function _transfer(
        ...
        if (!_swapping && amount > 0 && to != address(routerV2) && !isExcludedFromFees[from] && !isExcludedFromFees[to]) {
            ...
            if (txType < 3) {
                ...
                if (marketFees[txType] > 0) {
                    marketPortion = fees * marketFees[txType] / totalFees[txType];
                    _sendInTokens(from, marketAddress, marketPortion);
                ...
                fees = fees - marketPortion - autoBurnPortion;
            }
