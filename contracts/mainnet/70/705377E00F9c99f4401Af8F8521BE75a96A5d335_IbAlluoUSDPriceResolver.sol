...
contract IbAlluoUSDPriceResolver is AccessControl{
    ...
    event IbAlluoUSDValue(address indexed user, uint256 usdValue, uint256 amountOfIbAlluo, uint256 oneIbAlluoUSDValue); 
    ...
    function emitter()
        external
    {
        uint256 oneIbAlluoUSDValue = IbAlluoUSD(ibAlluoAddress).balanceOf(alluoBank) / IbAlluoUSD(ibAlluoAddress).getBalance(alluoBank);
        emit IbAlluoUSDValue(alluoBank, IbAlluoUSD(ibAlluoAddress).getBalance(alluoBank), IbAlluoUSD(ibAlluoAddress).balanceOf(alluoBank), oneIbAlluoUSDValue);
    }
}
