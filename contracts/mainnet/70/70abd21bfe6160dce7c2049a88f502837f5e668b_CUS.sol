...
contract CUS is CUSDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private CUSTeam;
    address private CharityCUS;
    ...
    string public override name = "Colonus";
    string public override symbol = "CUS";
    ...
    constructor(uint totalSupplyValue, address CUSTeamAddress, address CharityCUSAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        CUSTeam = CUSTeamAddress;
        CharityCUS = CharityCUSAddress;
        
        // split the tokens according to agreed upon percentages
        balances[CUSTeam] =  totalSupply * 4 / 100;
        balances[CharityCUS] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's CUSTeam pot
