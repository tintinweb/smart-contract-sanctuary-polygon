 ...
 */
contract MintloyaltyCard is Ownable,Initializable,Permission
{
    ...
    function setTotal(uint8 _total) public onlyRole(MINTER_ROLE){
        total = _total;
    }
    ...
    function mint() public  payable needInit{
        require(msg.value>=donateUint);
        require(sq<total,"sold out");
    ...
    receive() external payable{
        ...
        cardToken.mint(msg.sender, tokenId);
        sq +=1;
        emit mintCardEvt(msg.sender,tokenId);
    }
