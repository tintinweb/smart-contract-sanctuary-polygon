...
/**
 * @title The TicketSaleOracle is a permissioned oracle that reports the amount of tickets sold by an EventImplementation contract.
 * NOTE: This is a placeholder solution for a more decentral and trustless way of reporting the total ticket sales of an event.  
