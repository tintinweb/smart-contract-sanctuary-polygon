...
contract X7BorrowingMaxi is ERC721Enumerable, ERC721Holder, Ownable {
    ...
    // 1300 Matic
    uint256 public mintPrice = 1300 * 10**18;
    ...
    constructor(address mintFeeDestination_, address treasury_) ERC721("X7 Borrowing Maxi (Polygon)", "mX7BMAXI") Ownable(msg.sender) {
