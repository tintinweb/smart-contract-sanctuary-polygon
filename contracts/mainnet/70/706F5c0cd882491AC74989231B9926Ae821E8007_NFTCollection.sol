...
contract NFTCollection is ERC721, Ownable, ERC721Burnable, ERC721Enumerable, ERC2981Collection {
 ...
 mapping(uint256 => string) private _tokenURIs;
  ...
  mapping(address => bool) private registCreators;
  ...
  constructor(address _marketplaceAddress) ERC721("FOR CHILD", "MARKETSTORE") {
  ...
  function airDrop(address[] memory _accounts, uint256 _mintAmount) public onlyOwner {
  ...
  function editCreator(address account) public onlyOwner {    
     registCreators[account] = false;
  }

  function addCreator(address account) public onlyOwner {    
     registCreators[account] = true;
  }

  function mintToken(string memory _tokenURI) public returns (uint256) {
     require(registCreators[_msgSender()], "Unregistered Creator!");
     _tokenIds.increment();
