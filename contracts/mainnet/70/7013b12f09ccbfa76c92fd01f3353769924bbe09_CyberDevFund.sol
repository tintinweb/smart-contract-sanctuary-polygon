...
contract CyberDevFund is Fund {
    uint256 public constant ALLOCATION = 3_000_000 * 1e24; // 10%
...
abstract contract Fund is Ownable, Initializable {
    ...
    function initialize(address _cyber) external initializer {
        require(_cyber != address(0), "Fund::constructor: Invalid address");
        cyber = IERC20(_cyber);
    }
    ...
    function currentBalance() public view returns (uint256) {
        return cyber.balanceOf(address(this));
    }
    ...
    function transfer(address receiver, uint256 amount) external onlyOwner {
        ...
        cyber.safeTransfer(receiver, amount);
    }
}
