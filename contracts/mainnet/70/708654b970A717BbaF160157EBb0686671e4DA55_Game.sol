...
abstract contract GameBase is GameRole, ReentrancyGuard, StringUtil {
    ...
    {   
        ...
        Gem memory gem = Gem({
            ...
            fromOne: gem1,
            fromTwo: gem2,
            success: (gemQuality(uri1) + gemQuality(uri2) + 20) / 2,
            isSettled: false
        });
        ...
        emit GemCombine(_msgSender(), gem1, gem2, gem.success, gemId);
        ...
        nonReentrant
    {
        ...
        emit GemSettled(gem.maker, gem.fromOne, gem.fromTwo, success, gem.id, uri);
    }
}
