...
contract X7DEXMaxi is ERC721Enumerable, ERC721Holder, Ownable {
    ...
    // 650 Matic
    uint256 public mintPrice = 650 * 10**18;
    ...
    constructor(address mintFeeDestination_, address treasury_) ERC721("X7 DEX Maxi (Polygon)", "mX7DMAXI") Ownable(msg.sender) {
