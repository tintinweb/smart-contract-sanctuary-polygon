...
import "../buildings/AncientStonemine.sol";

//STAKER FOR MULTIPLE CITIES (COLONIES)
contract AncientStakerSMV2 is Ownable, IERC721Receiver {
    ...
    AncientStonemine public building;

    

    constructor(address bld_) {
        building = AncientStonemine(bld_);
...
contract AncientStonemine is ERC721Enumerable, Ownable {
    ...
    uint256 private MAX_STONEMINE = 4000;
    ...
    constructor() ERC721 ("AncientStonemine", "ASM") {
        //baseURI = baseURI_;
        foundersWallet = 0x02367e1ed0294AF91E459463b495C8F8F855fBb8;
        WRLD_TOKEN = IToken(0xD5d86FC8d5C0Ea1aC1Ac5Dfab6E529c9967a45E9);
        WRAPPED_ETHEREUM = IToken(0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619); // 0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619
    }
    ...
    modifier onlyMinter(address player, uint256 _numberOfTokens,  bytes32[] calldata merkleProof){
        ...
        require(totalSupply() + _numberOfTokens <= MAX_STONEMINE,"max-supply-reached");
        ...
        if(!isPublicMint){
            ...
            if(isPrivateOneMint){
                require( _numberOfTokens == 1, "mint-number-out-of-range");
                require(maxMintsPerAddress[player] + _numberOfTokens <= 1, "max-mint-limit");
            }
        }
        _;
    }
    ...
    function mint(address player, uint256 _numberOfTokens,  bytes32[] calldata merkleProof) external payable onlyMinter(player, _numberOfTokens, merkleProof){
        ...
        require(msg.value >= mintPrice * _numberOfTokens, "incorrect-poly-value");
    ...
    function gift(address player) external {
        ...
        require(totalSupply() + 1 < MAX_STONEMINE, "max-supply-reached");
        _safeMint(player, totalSupply());
    } 
