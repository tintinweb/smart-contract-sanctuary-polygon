...
contract WINUsersWhitelist is AccessControl {
    ...
    function editWhitelist(address[] calldata _users, bool _add)
        external
    {
        require(hasRole(OWNER_ADMIN, msg.sender), "WINUsersWhitelist: Restricted to OWNER_ADMIN role");
        require(_users.length <= 100,"WINUsersWhitelist: batch size must be equal or less than 100 users");
