...
contract NFT721HaveMaxSupply is
    Ownable,
    IERC721,
    IERC721Metadata,
    ReentrancyGuard
{
    ...
    function _isLaunchpadPlatform(
        address spender
    ) internal view virtual returns (bool) {
        return (spender == platform);
    }

    function setBaseURIByLaunchpadPlatform(
        string calldata _baseURI
    ) external nonReentrant {
        require(_isLaunchpadPlatform(_msgSender()), "permission denied!");
        _setBaseURI(_baseURI);
    }
