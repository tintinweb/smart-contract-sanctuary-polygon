...
contract MysteryBoxNFTs is NFTokenMetadata, Ownable {
  ...
  function mintTo(uint256 _tokenId, address _to, string calldata _uri) external payable returns (bool) {
    super._mint(_to, _tokenId);
