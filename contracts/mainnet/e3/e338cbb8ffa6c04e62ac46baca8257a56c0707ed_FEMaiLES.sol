...
//  ______________________   _____         .__.____     ___________ _________
//  \_   _____/\_   _____/  /     \ _____  |__|    |    \_   _____//   _____/
//   |    __)   |    __)_  /  \ /  \\__  \ |  |    |     |    __)_ \_____  \ 
//   |     \    |        \/    Y    \/ __ \|  |    |___  |        \/        \
//   \___  /   /_______  /\____|__  (____  /__|_______ \/_______  /_______  /
//       \/            \/         \/     \/           \/        \/        \/      
//  ... Proof-of-Concept how AI generated NFT collections can have traits ...                                           
...
contract FEMaiLES is Ownable, DefaultOperatorFilterer, ERC721A {
    ...
    string public baseURI = "ipfs://bafybeidzb3fgizpna3mxfzslbkkjwh7plbtgn4kcq6h7qkfsaipwbwng4a/";
    string public _extension = ".json";
    uint256 public price = 0 ether;
    uint256 public maxSupply = 5555;

    constructor() ERC721A("FEMaiLES", "FMLAI"){}
    ...
    function mintNFT(uint256 _quantity) public payable {
        ...
        require(msg.value == price * _quantity, "Needs to send more MATIC!");
   ...
   function sendGiftsToWallet(address _wallet, uint256 _num) external onlyOwner{
    ...
    function setmaxSupply(uint256 _supply) public onlyOwner() {
        require(_supply <= 5555, "Error: New max supply cant be higher than original max.");
        maxSupply = _supply;
    }
