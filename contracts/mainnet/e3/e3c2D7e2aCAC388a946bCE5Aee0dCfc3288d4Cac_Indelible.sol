...
contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    string[] private layerNames = [unicode"D accessories", unicode"Accessories", unicode"Eyes", unicode"Mouth", unicode"Hats", unicode"Type", unicode"Background"];
    ...
    ContractData public contractData = ContractData(unicode"Chad Lads", unicode"1569 Chadlads. Show your peens.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/7586129e-8bb9-4b04-8577-13d928f635cd", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/7586129e-8bb9-4b04-8577-13d928f635cd", "", 500, "0x2B8454f668669c9C888C8346416E10be86BB7620");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"Chad Lads", unicode"CHADLADS") {
        tiers[0] = [42,196,344,987];
        tiers[1] = [78,199,201,265,277,549];
        tiers[2] = [20,28,35,36,37,45,50,65,80,83,100,193,240,262,295];
        tiers[3] = [10,15,30,35,50,107,118,222,272,349,361];
        tiers[4] = [14,17,22,27,29,32,35,36,37,43,46,49,49,52,61,66,67,70,75,90,121,124,127,130,150];
        tiers[5] = [10,15,30,172,278,281,368,415];
        tiers[6] = [94,188,191,192,414,490];
