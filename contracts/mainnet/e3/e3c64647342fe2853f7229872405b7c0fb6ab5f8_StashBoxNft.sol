...
contract StashBoxNft is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    string public unrevealURI = "https://stashboxnft.mypinata.cloud/ipfs/QmTCp5ESNcT5yuRxy5xdYNXxcKwY1zXywWkvgCDCDpAEn8/unrevealed.json";
    bool public reveal = false;

    bool private endSale = false;

    string private _baseURIextended = "https://ipfs.io/ipfs/";
    uint256 private _priceextended = 35000000000000000000;
    ...
    constructor() ERC721("StashBoxNft", "SBN") {
    }
    ...
    function mintNFT(uint256 _cnt) public payable {
        ...
        for(uint256 i = 0; i < _cnt; i++) {
            _tokenIdentifiers.increment();
            _safeMint(msg.sender, _tokenIdentifiers.current());
            _priceextended += 350000000000000000; 
            tokenMinted += 1;
        }
    }
