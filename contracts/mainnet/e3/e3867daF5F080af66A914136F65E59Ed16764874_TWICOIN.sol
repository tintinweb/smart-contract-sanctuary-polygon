...
interface ITWICOIN {
     ...
     * @dev getTwiByAddress
     */
    function getTwiByAddress(address address_) external view returns (string memory);

    /**
     * @dev getAddressByTwi
     */
    function getAddressByTwi(string memory twi_string_) external view returns (address);
...
contract TWICOIN is ITWICOIN, VERIFY, TIP{
  ...
  uint256 constant SEC_PER_DAY = 86400;
    ...
    */
    function getTwiByAddress(address address_) override public virtual view returns (string memory){
    ...
    */
    function getAddressByTwi(string memory twi_string_) override public virtual 
        _isStrValid(twi_string_, twiUserNameMinLength, twiUserNameMaxLength, NOT_ALL_NUM) 
    ...
    */
    function transferToTwi(
        ...
        address toAddress = getAddressByTwi(twi_string_);
    ...
    */
    function getBalanceByTwi(string memory twi_string_) 
        ...
        address twi_address = getAddressByTwi(twi_string_);
