    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 45) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeieduzgdbbbm3j3qxmubyrxhri3v7w5f2os7zwferln5u2aojoymjm/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/gEdZyjrvCr5xi1GzfIr7/contract-metadata";
  }
...
// File: contracts/SupertrumpContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SupertrumpContract is ERC721APlus {
    constructor() ERC721APlus("SUPERTRUMP", "SUPRT"){}
}
  /*******************************************************/
  /*                                                     */
