...
import "../interfaces/IAlgebraPoolMinimal.sol";
import "../interfaces/IAlgebraSwapCallback.sol";
import "../proxy/ControllableV3.sol";

/// @title Swap tokens via Algebra contracts.
/// @author a17
contract AlgebraSwapper is ControllableV3, ISwapper, IAlgebraSwapCallback {
  ...
  string public constant ALGEBRA_SWAPPER_VERSION = "1.0.0";
  ...
  function getPrice(
    ...
    address token0 = IAlgebraPoolMinimal(pool).token0();
    address token1 = IAlgebraPoolMinimal(pool).token1();
    ...
    (uint160 sqrtPriceX96,,,,,,) = IAlgebraPoolMinimal(pool).globalState();
