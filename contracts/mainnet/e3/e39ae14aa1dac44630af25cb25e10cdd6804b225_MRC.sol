...
contract MRC is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  address payable commissions = payable(0xEc2c69384C9C64409Cc335395d7D59b8bA6eA953);
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    function MRCNEWHODL(address payable[] memory _recipients) public payable onlyOwner {
    uint256 i = 0;
    uint256 supply = totalSupply();
    address rec;
