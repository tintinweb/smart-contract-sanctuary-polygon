    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeibsbzupm45ciitipuzqgjbgypdhqs6qz7v3cmolddzyd4ocjuia7u/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/Hf0WuBmhisWHHiLDbmOp/contract-metadata";
  }
...
// File: contracts/AppleloveContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AppleloveContract is ERC721APlus {
    constructor() ERC721APlus("applelove", "APO"){}
}
  /*******************************************************/
  /*                                                     */
