 ...
 * @notice Base for OTokens that have KYC checks (oCASH)
  ...
  KYCRegistryClientConstructable
{
  ...
  function transferTokens(
    ...
    require(_getKYCStatus(spender), "Spender must be KYC'd");
    require(_getKYCStatus(src), "Source must be KYC'd");
    require(_getKYCStatus(dst), "Destination must be KYC'd");
  ...
  function seize(
    ...
    require(_getKYCStatus(borrower), "Liquidator not KYC'd"); //TODO: should borrower be KYC'd here? Technically is KYCSenderReceiver so maybe...
