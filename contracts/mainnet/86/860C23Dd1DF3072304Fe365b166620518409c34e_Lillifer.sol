...
contract Lillifer is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("Lillifer #", "LILI") {
  ...
  uint256 public constant MAX_MULTIMINT = 9999;
  ...
  function mint(uint256 count) public nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 9999 at a time");
