 ...
 * @notice This contract handles minting Alchemist NFT Collection tokens.
 */
contract AlchemistNFTCollection is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x2f7815a3ccCE5C304774C89ed564e720B84db616;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x7A21FE7E1815ad187AF746aCc2B2E7196a8aEe40;
    ...
    string public name = "Alchemist NFT Collection";
    string public symbol = "ALCHEMY";
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeigk5vtfvtgsfxaa3jfgmhwxewfanadcn4uutp4kzj5wjkbk7ofchm/{id}"
        )
        RevokableOperatorFilterer(
