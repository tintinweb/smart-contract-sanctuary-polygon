 ...
 */
contract MetabetMaskPolygon is IMetabetMask, Ownable {
    ...
    */
        ...
        public onlyAdmin returns (bytes32)
    {
        ...
        ITokenPool metabetPool = new METABETPool(adminAddress);
...
contract METABETPool is AccessControl, ITokenPool{
    ...
    modifier onlyAuthorized() {
        ...
        "METABETPool:Restricted to only authorized accounts.");
        _;
    }
