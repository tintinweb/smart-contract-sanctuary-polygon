...
contract Keafarm is ERC20, ERC20Burnable, Pausable, Ownable, ERC20Permit, ERC20Votes {
    constructor() ERC20("Keafarm", "KEA") ERC20Permit("Keafarm") {
        _mint(msg.sender, 470000000 * 10 ** decimals());
    }
