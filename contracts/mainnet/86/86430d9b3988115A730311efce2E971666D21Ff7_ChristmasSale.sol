...
contract ChristmasSale is Ownable {
    // LootBox Address
    ...
    // Asset Sale Start Time
    uint256 public assetSaleStartTime;

    // Asset Sale End Time
    uint256 public assetSaleEndTime;

    // LootBox Sale Start Time
    uint256 public lootBoxSaleStartTime;

    // LootBox Sale End Time
    uint256 public lootBoxSaleEndTime;

    // LootBox Max Purchase Per Account
    uint256 public LOOTBOX_MAX_PURCHASE = 5;

    // Asset Max Purchase Per Account
    uint256 public MAX_ASSET_PURCHASE = 1;

    // Is Asset Sale Limit Activated
    bool public ASSET_LIMIT_STATUS = true;

    // Is Loot Sale Limit Activated
    bool public LOOTBOX_LIMIT_STATUS = true;

    // Asset Selling Token Id
    uint256 public saleAssetTokenId;

    // LootBox Selling Token Id
    uint256 public saleLootBoxTokenId;

    // Asset Buy Price
    uint256 public ASSET_PRICE = 10000 * 10 ** 18;

    // LootBox Buy Price
    uint256 public LOOTBOX_PRICE = 5000 * 10 ** 18;
