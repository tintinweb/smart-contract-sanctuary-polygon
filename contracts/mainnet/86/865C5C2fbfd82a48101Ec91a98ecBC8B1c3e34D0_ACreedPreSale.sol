...
// SPDX-License-Identifier: The Kohelet Of Dao2Utopia In Blockchains

// @@@@@@@@@@@@@@@@@@@@@@@@@[\]/[[]]]]/@@@\]]]][[\]/[@@@@@@@@@@@@@@@@@@@@@@@@
// @@@@@@@@@@@@@@@@@@@@/\/[][email protected]@@@@@@@@@@@@@@@@oooo][\/\@@@@@@@@@@@@@@@@@@@
// @@@@@@@@@@@@@@@@@\/\/[email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@@@oo\/\/@@@@@@@@@@@@@@@@
// @@@@@@@@@@@@@@[/\[email protected]@@@@@@@@@[email protected]@@@@@@[email protected]@@@@@@@@@oo/\[@@@@@@@@@@@@@
// @@@@@@@@@@@@\\/[email protected]@@@@@@@oo/\]/[[`/[email protected]@@oo\,[[\]/\[email protected]@@@@@@@o\//@@@@@@@@@@@
// @@@@@@@@@//\[email protected]@@@@@oo/]/\/@@@@@^@[email protected]@@[email protected][email protected]@@@@\/\]\[email protected]@@@@@oo/\\@@@@@@@@
// @@@@@@@@\\[email protected]@@@@@oo//\/@@@@@@@@@^@[email protected]@@[email protected][email protected]@@@@@@@@\/\\[email protected]@@@@@o//@@@@@@@
// @@@@@@\//[email protected]@@@@oo\[/@@@@@@@@@@@@^@[email protected]@@[email protected][email protected]@@@@@@@@@@@\[/[email protected]@@@@o\\/@@@@@
// @@@@@\\[email protected]@@@@oo\\@@@@@@@@@@@@@@@^@[email protected]@@[email protected][email protected]@@@@@@@@@@@@@@//[email protected]@@@@o//@@@@
// @@@///[email protected]@@@@o\\@@@@@@@@@@@@@@@@@^@[email protected]@@[email protected][email protected]@@@@@@@@@@@@@@@@//[email protected]@@@@o\\\@@
// @@///[email protected]@@@o///@@@@@@@@@@@@@@@@@@^@[email protected]@@[email protected][email protected]@@@@@@@@@@@@@@@@@\\\[email protected]@@@o\\\@
// @///[email protected]@@@o///@@@@@@@@@@@@@@@@@@@^@[email protected]@@[email protected][email protected]@@@@@@@@@@@@@@@@@@\\\[email protected]@@@o\\\
// @[email protected]@@@o^//@@@@@@@@@@@@@@@@@@@@^@[email protected]@@[email protected][email protected]@@@@@@@@@@@@@@@@@@@\\[email protected]@@@o^^
// \^[email protected]@@@o///@@@@@@@@@@@@@@@@@@@@@^@[email protected]@@[email protected][email protected]@@@@@@@@@@@@@@@@@@@@\\\[email protected]@@@o=
...
// [email protected]@@[email protected]@@@@@@@@@@@@@@@@@//\[email protected]@@@@@@@@@@@@o/\\@@@@@@@@@@@@@@@@@@^^[email protected]@@o
// [email protected]@@@[email protected]@@@@@@@@@@@@@@@//][email protected]@@@@@@@@@@@@@@@@o]\\@@@@@@@@@@@@@@@@^^[email protected]@@@o
// ^[email protected]@@@o^^@@@@@@@@@@@@@@///[email protected]@@@@@[email protected]@@@@[email protected]@@@@@o\\\@@@@@@@@@@@@@@[email protected]@@@o
// \\[email protected]@@@[email protected]@@@@@@@@@@///[email protected]@@@@@o///[email protected]@@o\\\[email protected]@@@@@o\\\@@@@@@@@@@@^^[email protected]@@@o/
// /^[email protected]@@@o\\\@@@@@@@@\//[email protected]@@@@@o//`@[email protected]@@[email protected],\\[email protected]@@@@@o\\/@@@@@@@@///[email protected]@@@o=
// @[email protected]@@@o^\\@@@@@\//[email protected]@@@@@o///@^@[email protected]@@[email protected][email protected]\\\[email protected]@@@@@o\\/@@@@@//[email protected]@@@o^^
// @\\\[email protected]@@@o\\\@@\//[email protected]@@@@@o///@@@^@[email protected]@@[email protected][email protected]@@\\\[email protected]@@@@@o\\/@@///[email protected]@@@o///
// @@\\\[email protected]@@@o\\\\[email protected]@@@@@o///@@@@@^@[email protected]@@[email protected][email protected]@@@@\\\[email protected]@@@@@oo////[email protected]@@@o///@
// @@@\\\[email protected]@@@@[email protected]@@@@@o\//@@@@@@@^@[email protected]@@[email protected][email protected]@@@@@@\\/[email protected]@@@@@[email protected]@@@@o///@@
// @@@@@//[email protected]@@@@@@@@@@o\//@@@@@@@@@^@[email protected]@@[email protected][email protected]@@@@@@@@\\/[email protected]@@@@@@@@@@o\\@@@@
// @@@@@@/\\[email protected]@@@@@@o\[/@@@@@@@@@@@^@[email protected]@@[email protected][email protected]@@@@@@@@@@\[/[email protected]@@@@@@o//\@@@@@
// @@@@@@@@//[email protected]@@@@@@o\\/\@@@@@@@@@^@[email protected]@@[email protected][email protected]@@@@@@@@/\//[email protected]@@@@@@o\\@@@@@@@
// @@@@@@@@@\\/[email protected]@@@@@oo\[\/\@@@@@^@[email protected]@@[email protected][email protected]@@@@/\/[/[email protected]@@@@@oo\//@@@@@@@@
...
contract ACreedPreSale is Ownable, NoDelegateCall {
    using SafeMath for uint256;
        ...
        returns (bool)
    {
        ...
        require(block.timestamp > endTimestamp, "IDO is not over yet");
        require(saleStarted, "Sermon End");
        require(_val >= minAmount, "Below minimum allocation");
        require(
            _val <= maxAmount * Leap_Of_Faith,
            "More than maximum allocation"
        );

        uint256 sermonAmount = _val.div(Leap_Of_Faith);
        require(
            sermonAmount > 0 && sermonAmount <= maxAmount,
            "sermon::sermonAmount too little"
        );
        ...
        require(
            realAmount > 0 && realAmount < (type(uint256).max - 88888888),
            "realAmount::Nothing is true, everything is permitted."
        );
        ...
        returns (bool)
    {
        ...
        require(_val >= minAmount, "Below minimum allocation");
        require(_val <= maxAmount, "More than maximum allocation");
