...
contract CyanPaymentPlanV2 is AccessControlUpgradeable, ReentrancyGuardUpgradeable {
     ...
     */
    function revive(uint256 planId, uint256 penaltyAmount, bytes memory signature) external payable nonReentrant {
     ...
     */
    function transferItemAndLock(Item memory item, address from, address cyanWalletAddress) private {
        if (item.itemType == 1) {
            // ERC721
     ...
     */
    function setLockState(Item memory item, address cyanWalletAddress, bool state) private {
    ...
    function verifyRevivalSignature(uint256 planId, uint256 penaltyAmount, bytes memory signature) internal view {
    ...
    function hotFix_0x1a94c6921d3acd66478d7b9f3200ed80f2749bed() external onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function hotFix_0x22ec97503f9aa4ba17b4aa2a8ed36af96a943518() external onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function hotFix_0x9f4de26feef04adb5218dbe6752f71dd87496e8c() external onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function hotFix_0x839166403dcaa4923f78a6be4a64ae866bd85531() external onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function hotFix_0x352d83067625e55af0550231a2114c807a84d284() external onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function hotFix_0x5be152232b0c59fa88496b7d6b9093ebf91fbb3c() external onlyRole(DEFAULT_ADMIN_ROLE) {
