...
// File: contracts/contracts/ERC721A/IERC721A.sol
...
// File: contracts/contracts/ERC721A/ERC721A.sol
...
// File: contracts/contracts/polygon/DoubleDucksHK.sol
 ...
 * {ERC721Enumerable}.
 */
contract DoubleDucksHK is DefaultOperatorFilterer, ERC721A, IERC2981, Ownable {
    // Admin role
    address private _admin;

    // Metadata
    string private _baseURI_ = "https://nft.thefwenclub.com/nft/doubleducks/";

    // Royalties
    address private _royaltyAddress;
    uint256 private _royaltyPercent = 0;

    constructor(string memory name_, string memory symbol_, address admin, address royaltyAddress) ERC721A(name_, symbol_)  {    
        _admin = admin;
     ...
     * - `to` cannot be the zero address.
     * - `quantity` must be greater than 0.
     * - caller must be `_admin`.
     *
     * Emits a {Transfer} event for each mint.
     */
    function mint(address to, uint256 quantity) external onlyAdmin {
        _mint(to, quantity);
    }
