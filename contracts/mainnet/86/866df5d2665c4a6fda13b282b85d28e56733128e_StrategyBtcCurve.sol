...
contract StrategyBtcCurve {
    ...
    address public constant want = address(0xf8a57c1d3b9629b77b6726a042ca48990A84Fb49);
    ...
    address public constant pool = address(0xC2d95EEF97Ec6C17551d45e77B590dc1F9117C67);
    address public gauge = address(0x8D9649e50A0d1da8E939f800fB926cdE8f18B47D);
    address public sushiRouter = address(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506);
    Mintr public constant liquidityGaugeFactory = Mintr(0xabC000d88f23Bb45525E447528DBF656A9D55bf5);
    ...
    constructor(address _controller, address[] memory _crvToWbtcPath) {
        governance = msg.sender;
        strategist = msg.sender;
        controller = _controller;
        crvToWbtcPath = _crvToWbtcPath;
    }
    ...
    external
    {
        ...
        // Swap on Sushi
        if (_crv > 0) {
            _swapOnSushi(crvToWbtcPath, _crv, maxSlippage);
            _zap();
        }
    }

    function harvestExtra(
        address[] calldata _pathToWbtc, 
        uint256 _amount
    ) external {
        require(
            msg.sender == strategist || msg.sender == governance,
        ...
        if (Gauge(gauge).reward_tokens(0) != address(0)) {
            ...
            _swapOnSushi(_pathToWbtc, _amount, maxSlippage);
            _zap();
        }
    }

    function _zap() internal {
        // add liquidity on curve in wbtc
    ...
    function setCrvToWbtcPath(address[] calldata _crvToWbtcPath) external onlyGovernance {
        crvToWbtcPath = _crvToWbtcPath;
    }
}