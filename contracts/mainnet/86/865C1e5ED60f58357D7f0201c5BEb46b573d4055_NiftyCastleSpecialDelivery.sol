...
contract NiftyCastleSpecialDelivery is Context, AccessControlEnumerable, ERC1155Burnable, ERC1155Supply, Ownable {
    ...
    constructor(string memory name_, string memory symbol_, string memory _baseTokenURI, address admin) ERC1155(_baseTokenURI) {
