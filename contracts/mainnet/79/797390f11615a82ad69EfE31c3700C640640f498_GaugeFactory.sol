...
// Gauges are used to incentivize pools, they emit reward tokens over 3 days for staked LP tokens
contract Gauge is IGauge {
    ...
    uint internal constant DURATION = 3 days; // rewards are released over 3 days
