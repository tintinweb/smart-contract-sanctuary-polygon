...
/**
 * @title Omega Particle - OMP
 */
contract PolygonOMP is Recoverable, UsingUniversalForwarding, IERC20Mintable, MinterRole, PolygonChildERC20Burnable {
    constructor(IForwarderRegistry forwarderRegistry, address childChainManager)
        PolygonChildERC20Burnable("Omega Particle", "OMP", 18, childChainManager)
