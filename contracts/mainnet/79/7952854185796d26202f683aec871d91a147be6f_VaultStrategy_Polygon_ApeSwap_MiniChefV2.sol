    ...
    IVaultStrategy
{
    ...
    function swapAdditionalRewardToReward(uint256 _index) internal
    {
        //check if swap required
        if (_index == 0
            || additionalRewardToken(_index) == depositToken)
        {
            return;
        }
        ...
        swap(
            ...
            createSwapPath(
                address(additionalRewardToken(_index)),
                address(rewardToken()),
    ...
    VaultStrategyV2
{
    ...
    function swapRewardToDeposit() internal virtual override
    {
        ...
        {
            swapRewardToDepositTokenChild(0, halfReward);
        }
