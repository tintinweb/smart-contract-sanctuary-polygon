...
//Transfer ownership to `MeshDepositor`
contract AdMesh is ERC20, Ownable  {

    address public creator;

    constructor() public ERC20('Adamant MESH', 'AdMESH') {
        creator = msg.sender;
    }
    ...
    //Transfer any tokens accidentally sent to the token address to the owner so it can be returned
