...
// File: github/jiang-yuan/Solidity/TYMeta.sol
...
contract TYMeta is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    // Constants
    uint256 public constant MAX_SUPPLY = 4002;
    ...
    constructor(string memory initBaseURI, string memory initNotRevealedUri)
        ERC721("Midnight Minor", "MM")
    {
        setBaseURI(initBaseURI);
        setNotRevealedURI(initNotRevealedUri);
    }

    function mintMeta(uint256 tokenQuantity) public payable onlyOwner {
        require(
