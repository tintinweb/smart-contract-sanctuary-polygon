...
contract OnChainNFT is ERC1155, ERC2981, Ownable, ERC1155Supply, VRFConsumerBaseV2, ReentrancyGuard {
    ...
    uint256 public discountedTokensLeft = 1000;
    uint256 public mintPrice = 1000000000; // $1000 USDC
    uint256 public discountPrice = 800000000; // $800 USDC
    bool public mintingEnabled;  // Disabled until turned on
    address private treasuryWallet = 0x1a294b3b16a195d65D0D12eaE69e25d98E812564;
    address private teamWallet = 0xc20AE501972E7d159Cfde6F3a047Cb0c8D37806A;
    // Royalties
    ...
    function getDiscountedTokensLeft() public view returns(uint256){
        return discountedTokensLeft;
    }
  ...
  function requestRandomWords(uint256 _amount) public payable nonReentrant() returns(uint256) {
    ...
    require(supplyLeft - _amount >= 0, "No more tokens can be minted");
    require(_amount <= 9, "Max mint is 9");
    
    if(discountedTokensLeft - _amount >= 0){
    require(_amount <= discountedTokensLeft, "Discounted tokens left, but are less than your mint amount. Please check how many are left.");    
