...
contract Locker is ERC20 {
    ...
    mapping(address => bool) migrateState;
    ...
    function getReward() public {
        ...
        require(
            holder.epochTime > block.timestamp,
    ...
    function migrate() public {
        require(migrateState[msg.sender] == false, "already migrated");
        ...
        holders[msg.sender] = Holder({
            holderAddress: holder.hodlerAddress,
            balance: holder.balance,
            unlockTime: holder.unlockTime,
            rate: holder.rate,
            epochTime: holder.epochTime,
            id: holder.id
        });

        migrateState[msg.sender] = true;
    }
