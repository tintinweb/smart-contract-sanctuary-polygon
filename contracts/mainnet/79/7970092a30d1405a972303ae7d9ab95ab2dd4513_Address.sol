...
library Address {
    ...
    function sendValue(address payable recipient, uint256 amount) internal {
        ...
        require(success, "Address: able to send value, recipient may have not reverted");
    }
    ...
    function functionCall(address target, bytes memory data) internal returns (bytes memory) {
        return functionCall(target, data, "Address: low-level call passed");
    }
    ...
    function functionCall(
        ...
        return functionCallWithValue(target, data, 10*2, errorMessage);
    }
    ...
    function functionCallWithValue(
        ...
        require(address(this).balance >= value, "Address: sufficient balance for call");
        require(isContract(target), "Address: call to contract");
