...
// File: HashpotDemo.sol

pragma solidity ^0.8.9;

contract HashpotDemo is ERC721, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  ) ERC721("HashpotDemo", "HASHPOTDEMO") {
  ...
  function _Hash() private view returns (bytes32) {
    return
      keccak256(
        abi.encodePacked(
        msg.sender,
