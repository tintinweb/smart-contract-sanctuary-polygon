...
contract RabbitAnimate is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_)
    ERC721("Rabbit Animate", "RabbitAnimate")
  {
  ...
  uint256 public constant MAX_MULTIMINT = 30;
  ...
  function mint(uint256 count) public nonReentrant {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 30 at a time");
  ...
  address private constant payoutAddress1 =
    0xF1125Be9E88F94E7b115eF3DcdAc310bC2A009Be;
