...
contract ERC1155Mintable is ERC1155 {
    ...
    event metadataLog(string metadata, uint256 timestamp, uint256 royalties, uint256 indexed tokenId);
    ...
    function mint(uint256 _initialSupply, uint256 _royalties, string memory _tokenUri) public returns(uint256 _id) {
        require(_royalties >= 0 && _royalties <= 2500 && _initialSupply > 0 && _initialSupply <= 10000 && bytes(_tokenUri).length > 0);
