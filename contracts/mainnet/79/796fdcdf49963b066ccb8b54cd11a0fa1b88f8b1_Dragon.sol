...
contract Dragon is ERC721URIStorage, Ownable {
  ...
  constructor() ERC721 ("Thootless dragons", "Dragons") {
    _customBaseURI = "https://ipfs.io/ipfs/QmUD8UyFFT5tLnJk5t7VUHXrNEbjT5eQrEkjN86pWftNqZ/";
    _maxMintable = 170; // 170 max supply
    _royaltyAmount = 500; // 5% royalties
    _mintActive = false; // start paused
    _maxMintPerTx = 5;
    _price = 0.01 ether;
    _artist =  0x095Fc820bf9bc4049742209F172De442c8471A0B;

    _privateMint(_artist);
  }
  ...
  function setArtist(address artist_) public onlyOwner {
    _artist = artist_;
  }
  ...
  function mint(uint256 quantity) public payable {
    ...
    require(msg.value >= (quantity * _price), "Not enough MATIC sent.");
