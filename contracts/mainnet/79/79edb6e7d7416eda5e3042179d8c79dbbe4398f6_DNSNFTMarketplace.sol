...
contract DNSNFTMarketplace is Ownable, IERC721Receiver, ReentrancyGuard {
    ...
    constructor(ICryptoNFT _originContract) {
        ...
        contracter = 0xd90FBc29A96319C1564FCEa40853f1FF0808083b;
    ...
    function setOnAuction(address payable _minter, uint256 _tokenId, string memory label, bytes32 labelhash) external onlyContract {
    ...
    function claim(uint256 _tokenId) external nonReentrant {
        ...
        if (msg.sender == tempWordInfo.minter && tempCurrentBid.currentBidAmount == 0) {
            require(tempWordInfo.isClaimed == false, "claim::NFT has already been claimed");

            wordsNFT.reclaim(_tokenId , tempWordInfo.minter);
            wordsNFT.transferFrom(address(this), tempWordInfo.minter, _tokenId);
            ...
            if (msg.sender == tempCurrentBid.currentBidder) {
                ...
                wordsNFT.reclaim(_tokenId , tempCurrentBid.currentBidder);
    ...
    modifier onlyContract {
        require(msg.sender == contracter, "onlyContract::Only Registrar Contract can call this function");
        _;
    }
