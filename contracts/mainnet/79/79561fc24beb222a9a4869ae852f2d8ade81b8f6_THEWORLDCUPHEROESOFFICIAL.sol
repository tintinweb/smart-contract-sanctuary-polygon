...
// File: TheWorldCupHeroesOfficial.sol
...
contract THEWORLDCUPHEROESOFFICIAL is ERC721Enumerable, Ownable, RoyaltiesV2Impl {
  using Strings for uint256;
...
//set the max supply of NFT's
  uint256 public maxSupply = 20012;

//set the maximum number an address can mint at a time
  uint256 public maxMintAmount = 20012;
