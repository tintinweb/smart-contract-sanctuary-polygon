...
contract FastVaultBitcoin is IFastVault {
    SafeCallee internal constant SAFE_CALLEE = SafeCallee(0x44A0a9CF602E076eDE16b83E1cbe6997D3e99895);
    address public constant override TOKEN = 0xDBf31dF14B66535aF65AaC99C32e9eA844e14501;
    ...
    function borrowFor(address receiver, uint256 amount, bytes calldata _sig) external override returns (uint256) {
        {
            ...
            bytes memory _msg = abi.encode("vault-BTC", msg.sender, amount);
...
interface IGateway {
    ...
    function status(bytes32 _sigHash) external view returns (bool);
}
