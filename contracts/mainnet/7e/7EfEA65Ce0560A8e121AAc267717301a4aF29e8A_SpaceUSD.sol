...
contract SpaceUSD is ERC20, Operator {
    ...
    address public dexRouter = address(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff);
    address public aUSDC = address(0xA48aD8b964BBf2C420e964B648146567ceB6d5E1);
    ...
    constructor(address _daoFund, address _devFund) ERC20("sUSD", "sUSD") {
        ...
        taxTiersRates = [500, 500, 500, 0];
        taxRateAfterRebase = 1000;
        // 20%
        ...
        address dexPair = IUniswapV2Factory(_dexRouter.factory()).createPair(address(this), aUSDC);
