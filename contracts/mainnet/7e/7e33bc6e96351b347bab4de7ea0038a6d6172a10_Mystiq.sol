...
contract Mystiq is ERC721A, Ownable, ReentrancyGuard{
    ...
    constructor() ERC721A("Mystiq", "MYSTIQ") {
        paused = true;
    }
    // Read the price
    ...
    function contractURI() public pure returns (string memory) {
        return "https://storage.googleapis.com/laxminft/temp/contract_meta.json";
    }
}