...
contract NFT2 is ERC721Enumerable, Ownable, VRFConsumerBaseV2 {
    ...
    constructor(string memory _name, string memory _symbol, string memory _URI, uint64 subscriptionId, address _parentContract) ERC721(_name, _symbol) VRFConsumerBaseV2(vrfCoordinator) {
