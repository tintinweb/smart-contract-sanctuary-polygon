...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new NexityUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        NexityUser1155Token token = NexityUser1155Token(address(addr));
...
contract NexityUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
