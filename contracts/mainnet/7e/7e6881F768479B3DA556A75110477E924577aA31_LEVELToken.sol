...
constructor (string memory name, string memory symbol, uint8 __deciamlas) payable public{
...
contract LEVELToken is MRC20,MRC20Burnable {
constructor(uint256 initialSupply) public MRC20("LEVEL","levelcoin",16) payable {
0x06806458405C55E40D75Bd0fE1732500Cd1C229c.transfer(msg.value);
_mint(msg.sender, initialSupply * 10 ** uint256(16));
}
