...
contract HuoJ is Context, IERC20, Ownable {
  ...
  uint256 public _Buying;
  uint256 public _Selling;
  ...
  function setBuy(uint256, uint256 newMarketingTax) external onlyOwner {
    _Buying = newMarketingTax;
  }

  function setSell(uint256, uint256 newMarketingTax) external onlyOwner {
    _Selling = newMarketingTax;
  }
