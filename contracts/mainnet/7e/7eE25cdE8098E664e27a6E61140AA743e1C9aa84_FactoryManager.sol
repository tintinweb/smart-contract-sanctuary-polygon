...
contract FactoryManager is Owned, TokensRecoverable {
    ...
    function feeLiqSetup(address _artist) public onlySignedAdmin() {
        ...
        _collectors[len-1] = _artist;
        _collectors[len-2] = deployData[counter].liquidityController;
        _collectors[len-3] = deployData[counter].staking;
