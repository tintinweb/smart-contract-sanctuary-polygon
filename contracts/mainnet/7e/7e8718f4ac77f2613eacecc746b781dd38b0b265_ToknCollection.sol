...
contract ToknCollection is Initializable, ERC1155Upgradeable, UUPSUpgradeable, OwnableUpgradeable, IERC2981Upgradeable {
    ...
    function initialize(string calldata _uri, string calldata _contractUri, address _treasury) public initializer{
        __ERC1155_init(_uri);
