...
contract Lucy is ERC721, Ownable {
    using Strings for uint256;

    uint public constant MAX_TOKENS = 5000;
    uint private constant TOKENS_RESERVED = 150;
    uint public price = 0.00005 ether;
    uint256 public constant MAX_MINT_PER_TX = 2000;
    ...
    constructor() ERC721("Lucy", "ROG") {
        baseUri = "ipfs://bafybeidlbrg3ezz46bjyanwtccs3zdj4ujocvc63xs336ijx36jhp2icei/";
