...
/// @author Portals.fi
/// @notice This contract removes liquidity from Aave like pools into any ERC20 token or the network token.
...
contract AavePortalOut is PortalBaseV1 {
    ...
    /// @notice Remove liquidity from Aave like pools into network tokens/ERC20 tokens
    /// @param sellToken The Aave like market address (i.e. the aToken)
