...
contract GammaGiddyWethQuery is GiddyQueryV2, Initializable, OwnableUpgradeable {
  ...
  function getDepositRatios() external view override returns (uint256[] memory ratios) {
    ...
    (ratios[0], ratios[1]) = IUniProxy(UNI_PROXY).getDepositAmount(POS, GIDDY_TOKEN, 1000e18);
