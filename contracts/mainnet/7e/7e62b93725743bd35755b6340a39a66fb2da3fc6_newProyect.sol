...
interface SecondCollection {
  function mintFromBurning(uint256 _mintAmount) external;
}

// File: contracts/newProyect.sol

pragma solidity >=0.8.0 <0.9.0;

contract newProyect is ERC721AQueryable, ERC721ABurnable, Ownable, ReentrancyGuard, OperatorFilterer {
  ...
  uint256 public maxPerWallet = 31;
  uint256 public maxPerTx = 31;
  ...
  //Reference to the Second collection contract.
  SecondCollection secondCollectionContract;

  constructor(SecondCollection _secondCollectionContract) ERC721A ( "Collection_Name", "Symbol" ) OperatorFilterer(address(0x3cc6CddA760b79bAfa08dF41ECFA224f810dCeB6), false) {
    secondCollectionContract = _secondCollectionContract;
...
// ~~~~~~~~~~~~~~~~~~~~ Modifiers ~~~~~~~~~~~~~~~~~~~~
  modifier mintCompliance(uint256 _mintAmount) {
    ...
    require(_mintAmount + mintedByOwner[msg.sender] <= maxPerWallet, "Max per wallet exceeded!");
...
// ~~~~~~~~~~~~~~~~~~~~ Mint Functions ~~~~~~~~~~~~~~~~~~~~
  ...
  function mintFree() public payable {
    require(!paused, "The contract is paused!");
    require(freeClaimed[msg.sender] < maxFree, "Free mint already claimed.");
...
// ~~~~~~~~~~~~~~~~~~~~ Burn Function ~~~~~~~~~~~~~~~~~~~~
  ...
  secondCollectionContract.mintFromBurning(tokensAmount);
  }
