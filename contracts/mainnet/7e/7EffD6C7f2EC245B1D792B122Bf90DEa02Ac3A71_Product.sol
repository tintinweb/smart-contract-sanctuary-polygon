...
import {RevokableOperatorFiltererUpgradeableV2} from "./RevokableOperatorFiltererUpgradeableV2.sol";

abstract contract RevokableDefaultOperatorFiltererUpgradeableV2 is
    RevokableOperatorFiltererUpgradeableV2
{
    ...
    function __RevokableDefaultOperatorFilterer_init()
        ...
        onlyInitializing
    {
        RevokableOperatorFiltererUpgradeableV2.__RevokableOperatorFilterer_init(
 ...
 */
abstract contract RevokableOperatorFiltererUpgradeableV2 is
    OperatorFiltererUpgradeable
{
    ...
    function revokeOperatorFilterRegistry() external {
        ...
        _setOperatorFilterRegistryRevoked(true);
    }
    ...
    function unRevokeOperatorFilterRegistry() external {
        ...
        _setOperatorFilterRegistryRevoked(false);
    }

    /**
     * @dev Check if the registry has been revoked (disabled) from the current contract.
     */
    ...
    /**
     * @dev Set _isOperatorFilterRegistryRevoked value to either true or false.
     * @param value boolean
     */
    function _setOperatorFilterRegistryRevoked(bool value) internal {
...
import {RevokableDefaultOperatorFiltererUpgradeableV2} from "../../OpenSea/RevokableDefaultOperatorFiltererUpgradeableV2.sol";
...
abstract contract ERC721Upgradeable is
    ...
    RevokableDefaultOperatorFiltererUpgradeableV2
{
...
import "../Openzeppelin/ERC721/ERC721Upgradeable.sol";
import "../Openzeppelin/ERC721/extensions/ERC721URIStorageUpgradeable.sol";
import "../Openzeppelin/ERC721/extensions/ERC721EnumerableUpgradeable.sol";
import "@openzeppelin/contracts-upgradeable/access/OwnableUpgradeable.sol";
import "@openzeppelin/contracts-upgradeable/proxy/utils/Initializable.sol";
import {RevokableOperatorFiltererUpgradeableV2} from "../OpenSea/RevokableOperatorFiltererUpgradeableV2.sol";
    ...
    OwnableUpgradeable
{
    ...
    // Custom errors
    error SupplyLimitExceeded(uint256 supplyLimit);
    ...
    /**
     * @dev Admin function that sets the supply limit
     * @param supplyLimit_ The supply limit
     * Access: Only the contract owner can call this function. (To be removed when integrated with the Registry)
     */
    function setSupplyLimit(uint256 supplyLimit_) public onlyOwner {
        _supplyLimit = supplyLimit_;
    }

    /**
     * @dev Admin function that sets the name and symbol of the token.
    ...
    /**
     * @notice Admin function that transfers a token from one address to another.
    ...
    /**
     * @dev Admin function that sets the URI for a token.
    ...
    /**
     * @dev Admin function that sets the URI for the contract.
     * @param uri_ The new URI for the contract.
     * Access: Only the contract owner can call this function. (To be removed when integrated with the Registry)
     */
    ...
    /**
     * @dev Admin function that mints a new token and assigns ownership to a specified address.
     * @param to The address that will be assigned ownership of the new token.
     * @param tokenId The ID of the new token being minted.
     * @param uri The URI for the new token being minted.
     * Access: Only the contract owner can call this function. (To be removed when integrated with the Registry)
     */
    function mint(
        address to,
        ...
        if (totalSupply() >= _supplyLimit) {
            revert SupplyLimitExceeded(_supplyLimit);
        }
        _safeMint(to, tokenId);
        _setTokenURI(tokenId, uri);
    }
    ...
    /**
     * @dev Admin function that sets royalty values for ERC-2981: NFT Royalty Standard
     * @param royaltyRecipient_ Receiver wallet address
     * @param royaltyPercent_ Royalty percentage e.g. 1000 = 10%
     */
    ...
    /**
     * @dev Implements https://eips.ethereum.org/EIPS/eip-2981
    ...
    function royaltyInfo(
        ...
        return (
            ...
            (salePrice * _royaltyPercent) / 10000
        );
    }

    /**
     * @return The contract URI that is required by OpenSea.
     */
    ...
    /**
     * @return The product supply limit
     */
    ...
    /**
     * @dev Returns whether a given interface is supported.
     ...
     * @return The address of the current contract owner.
     */
    function owner()
        public
        view
        virtual
        override(OwnableUpgradeable, RevokableOperatorFiltererUpgradeableV2)
        returns (address)
    {
