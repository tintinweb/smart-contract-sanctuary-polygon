...
contract KiPool is IERC721Receiver
{
    struct UserData 
    { 
    ...
    address private _ethereumTokenAddress = 0x229b1b6C23ff8953D663C4cBB519717e323a0a84; //BLOK
    ...
    {
        return _ethereumToken.balanceOf(address(this));
    }
    ...
    function updateRewardsFund() private
    {
        ...
        if (elapsedBlocks > _updateCooldownBlocks)
        {
            ...
            if (wingsAmount > 0)
            {
                ...
                _jetSwapRouter.swapExactTokensForTokens(wingsAmount, 0, wingsEthereumPairMemory, address(this), block.timestamp + _swapWaitingSeconds);
            }
