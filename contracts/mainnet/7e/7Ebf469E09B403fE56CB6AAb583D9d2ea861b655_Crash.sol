...
abstract contract Manager is Ownable {
    ...
    // Events
    event BetPlaced(uint indexed betId, address indexed player, uint amount, uint choice, bool isBonus);
...
contract Crash is ReentrancyGuard, Random, Manager {
    function placeBet(uint multiplierChoice, uint bonus) external payable nonReentrant {
        ...
        emit BetPlaced(bets.length, msg.sender, amount, multiplierChoice, isBonus);   
        bets.push(Bet({
