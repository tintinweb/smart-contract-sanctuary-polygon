...
contract ADMATIC is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("WinMatic", "WMATIC") {
        ...
        buyTotalFees = buyMarketingFee + reward + buyDevFee;
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            // on buy
        	    ...
        	    tokensForLiquidity += fees * reward / buyTotalFees;
