    ...
    EIP712Upgradeable
{
    ...
    function verify(
        bytes32 hash_,
        uint256 deadline_,
        Types.Signature[] calldata signs_
    ) external view override returns (bool) {
        // ExpiredSignature
        if (deadline_ < block.timestamp) return false;
...
bytes32 constant DISTRIBUTOR_ROLE = 0xfbd454f36a7e1a388bd6fc3ab10d434aa4578f811acbbcf33afb1c697486313c;
...
import { OPERATOR_ROLE, DISTRIBUTOR_ROLE, SERVER_ROLE, UPGRADER_ROLE } from "./libraries/Constants.sol";
    ...
    SignatureVerifierUpgradeable
{
    ...
    function initialize(
        ...
        __SignatureVerifier_init(name_, version_, threshold_, signers_);
        _grantRoles(OPERATOR_ROLE, operators_);
        _grantRole(DEFAULT_ADMIN_ROLE, admin_);
        _grantRole(DISTRIBUTOR_ROLE, 0xa8D7B6545C9f3609E0E9B1113Ce7e1481F2CD32E);
        _grantRole(SERVER_ROLE, 0xE963374d2574faD0194A857E132CcC5d52c713f4);
    }
