...
contract AlchemicaFacet is Modifiers {
  ...
  function channelAlchemica(
    ...
    //Check access rights
    AavegotchiDiamond diamond = AavegotchiDiamond(s.aavegotchiDiamond);
    InstallationDiamondInterface installationDiamond = InstallationDiamondInterface(s.installationsDiamond);
    require(installationDiamond.getAltarLevel(_realmId) != 0, "AlchemicaFacet: No Altar");
