...
contract EverOwnFactory is Context, Ownable {
    ...
    address payable public everRiseContractAddress = payable(0xC17c30e98541188614dF99239cABD40280810cA3);
    ...
    function setEverOwnFee(uint256 fee) public onlyOwner {
        _fee = fee;
    }
