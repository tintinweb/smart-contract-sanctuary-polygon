...
contract QuantumPolyPen is ERC20, Ownable { 
    address public taxAddress;
    uint256 public taxRate;
    uint256 public burnRate;

    constructor() ERC20("Quantum PolyPen", "qPPN") { 
        uint256 initialSupply = 100000000000000000000 * 10**decimals(); 
        _mint(msg.sender, initialSupply); 
        taxAddress = msg.sender;
        taxRate = 12; // 12% tax rate by default
        burnRate = 2; // 2% burn rate by default
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        _approve(sender, _msgSender(), allowance(sender, _msgSender()) - amount + netAmount);
        return true;
    }
}