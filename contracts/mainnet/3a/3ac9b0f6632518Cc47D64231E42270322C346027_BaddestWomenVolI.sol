...
contract BaddestWomenVolI is ERC721 , DefaultOperatorFilterer {
    ...
    constructor()
        ERC721("Baddest Women Vol.1", "BWVI")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeiewes7opgmrhjqg7n2cg4iyzuarnsavzuzjzt5ke3qv7g6zgkcafy/", Strings.toString(tokenId), ".json")
            );
    }
