...
contract Footprint is ERC721, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("Footprint", "footprint") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://guileless-malabi-ddb137.netlify.app/";
    }
