...
contract TESTROIMATIC {
    ...
    uint public startTime = 1657034500; // Tue Jul 05 2022 15:13:20 GMT+0000 https://www.unixtimestamp.com/
	...
	constructor(address payable _dev1, address payable _dev2, address payable _dev3, address payable _prtnr1, address payable _prtnr2, address payable _mkt) {
        ...
        plans.push(Plan(200, 20,  1 * 1e17, 1000 ether, 0, 0, 0, 0, true));
        plans.push(Plan( 90, 25,  2 * 1e17, 5000 ether, 0, 0, 0, 0, true));
        plans.push(Plan( 60, 30,  3 * 1e17, 10000 ether, 0, 0, 0, 0, true));
	}
