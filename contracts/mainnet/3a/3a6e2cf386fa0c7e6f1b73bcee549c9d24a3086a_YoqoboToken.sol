 ...
 */
 ...
 contract YoqoboToken is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable, ERC721URIStorage, Ownable {
      ...
      * See {ERC721-tokenURI}.
      */
     constructor() ERC721("Yoqobo Token", "YQBT") {
          _setupRole(DEFAULT_ADMIN_ROLE, 0x86082Cb99C91785aEE6FFF632b55F566F798C42C);
          _setupRole(MINTER_ROLE, 0x86082Cb99C91785aEE6FFF632b55F566F798C42C);
          _setupRole(MINTER_ADMIN_ROLE, 0x86082Cb99C91785aEE6FFF632b55F566F798C42C);
          _setRoleAdmin(MINTER_ROLE, MINTER_ADMIN_ROLE);
          _baseTokenURI = "ipfs://";
         transferOwnership(0x86082Cb99C91785aEE6FFF632b55F566F798C42C);
     }
     ...
     function mint_by_id(address to, uint256 tokenId, string memory tokenIPFSURI) public virtual {
         require(hasRole(MINTER_ROLE, _msgSender()), "YoqoboToken/minter-role-required");
         _mint(to, tokenId);
