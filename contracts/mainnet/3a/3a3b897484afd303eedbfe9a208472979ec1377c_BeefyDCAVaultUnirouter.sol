...
pragma solidity ^0.8.0;
contract BeefyDCAVaultBase is ERC721, Ownable, ReentrancyGuard {
    ...
    uint256 public underlyingBalanceTotal;
    ...
    function deposit(uint256 _id, uint256 _amount) public nonReentrant updateReward(_id) returns (uint256) {
        ...
        underlyingBalanceTotal = underlyingBalanceTotal + _amount;
        mooVault.deposit(want.balanceOf(address(this)));
    ...
    // Withdraw: Withdraws amount from beefy v
    ...
    function interestAccrued() public view returns (uint256) {
        return convertToUnderlying(mooBalance()) - underlyingBalanceTotal;
    }
...
// File: contracts/BIFI/strategies/DCA/BeefyDCAVaultUnirouter.sol

pragma solidity ^0.8.0;
contract BeefyDCAVaultUnirouter is BeefyDCAVaultBase, Pausable {
    using SafeERC20 for IERC20;
    ...
    ) BeefyDCAVaultBase(_name, _symbol, _mooVault, _reward, _keeper)  {
