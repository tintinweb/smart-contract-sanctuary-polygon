...
contract Marketplace is Initializable, MarketplaceContracts {
    ...
    contractsAreSet
    {
        ...
        if(_collection == TradeableCollection.ETHER_ORCS_ITEMS) {
            require(etherOrcsItems.balanceOf(msg.sender, _tokenId) >= _quantity, "Marketplace: Must hold enough items");
    ...
    function _buyItem(BuyItemParams calldata _buyItemParams) private {
        ...
        _payFees(listedItem, _buyItemParams.quantity, msg.sender, _buyItemParams.owner);
    ...
    function _payFees(Listing memory _listOrBid, uint256 _quantity, address _from, address _to) private {
