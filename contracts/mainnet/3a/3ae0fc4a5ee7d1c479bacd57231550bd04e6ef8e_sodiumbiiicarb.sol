...
contract sodiumbiiicarb {

	uint256 constant private FLOAT_SCALAR = 2**64;
	uint256 constant private INITIAL_SUPPLY = 1e17; // 1B
	uint256 constant private BURN_RATE = 1; // 8% per tx
	uint256 constant private SUPPLY_FLOOR = 1; // 1% of 1M = 10K

	string constant public name = "based on what";
	string constant public symbol = "BASEDONWHAT";
