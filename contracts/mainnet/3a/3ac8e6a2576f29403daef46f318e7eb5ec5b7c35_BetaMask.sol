...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x3E61d4D16d1250646106F4fF6A0f2C3a396C72E9);
...
contract BetaMask is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BetaMask";
    string constant _symbol = "BTM";
    ...
    uint256 public totalFee        = marketingFee + reflectionFee + liquidityFee + teamFee + burnFee + buybackFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x092418be3eBB83ecd9d9C434456Cf15609069CAb;
        marketingFeeReceiver = 0xd45b21ddFe055eF997D41a025461AacB8e774830;
        teamFeeReceiver = 0xB0c0a8168013DE366ADdC7Ce1d875F139e81cd2d;
        buybackFeeReceiver = 0x4256291Ad04379A6C82c8904Fe4f38b3F522ed81;
    ...
    function clearStuckBalance(uint256 amountPercentage) external authorized {
        ...
        payable(marketingFeeReceiver).transfer(amountMATIC * amountPercentage / 100);
    }
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountMATICTeam = amountMATIC.mul(teamFee).div(totalMATICFee);
        uint256 amountMATICBuyback = amountMATIC.mul(buybackFee).div(totalMATICFee);

        try distributor.deposit{value: amountMATICReflection}() {} catch {}
        (bool tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountMATICMarketing, gas: 30000}("");
        (tmpSuccess,) = payable(teamFeeReceiver).call{value: amountMATICTeam, gas: 30000}("");
        (tmpSuccess,) = payable(buybackFeeReceiver).call{value: amountMATICBuyback, gas: 30000}("");
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _teamFee, uint256 _burnFee, uint256 _buybackFee, uint256 _feeDenominator) external authorized {
        ...
        burnFee = _burnFee;
        totalFee = _liquidityFee + _reflectionFee + _marketingFee + _teamFee + _burnFee + _buybackFee;
