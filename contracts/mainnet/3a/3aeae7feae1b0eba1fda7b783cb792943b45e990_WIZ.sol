...
//  Deflationary Token Powered by Polygon Network.
...
contract WIZ is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x5bDd9842778abf5cEf0900A4A09fF6aC7069cFd2); // Marketing Address
    address payable public charityAddress = payable(0x5bDd9842778abf5cEf0900A4A09fF6aC7069cFd2); // Charity/Dev Address
    ...
    uint256 private _tTotal = 3000000000 * 10**18; // 1B
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "WIZ";
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _referEth =     500; //5% MATIC
    uint256 private _referToken =   1000; //10% $WIZ
    ...
    uint256 private salePrice = 2500;// 1*2500=2500 token for 1 MATIC (set as per requirements)
