...
✅ First Asset Multiplication Protocol - Get reward in every 10 minutes 🤑🤑-
 144 times in a day - Auto Staking Upto 1,284,615.72% APY! ✅ 
 $1,000 USD of $B24 invested you can earn up to $1,103,035.12 USD in one year 🤑🤑 - 
 | - ✅KYC - | - ✅ Audit by Freshcoins - | - 🤑 Dapp - | - 💸 AutoStaking - | - 💰 Fixed APY 1,284,615.72% APY ✅
*/
...
contract BOXFI is Context, Binance, Ownable {
    ...
    string private _name = 'BOXFI';
    string private _symbol = 'BOXFI';
