...
contract NFTree is ERC721URIStorage, ERC2981, Ownable {
    ...
    function mint(uint256 count) public payable {
        require(isSaleLive, "NFTree: sale is not currently live");
    ...
    function setMaxSupply(uint256 newMaxSupply) public onlyOwner {
        require(
            ...
            "NFTree: cannot set max supply less than current minted supply"
        );
    ...
    function _mintFromAllowList(uint256 count) internal {
        ...
        require(
            ...
            "NFTree: max allow list was reached"
        );
    ...
    function _mint() internal {
        require(_tokenIds.current() < MAX_SUPPLY, "NFTree: no NFTrees left");
        ...
        onlyOwner
    {
        require(
            ...
            "NFTree: cannot set allowlist amount greater than maxMint per address"
        );
    ...
    function withdraw() public onlyOwner {
        ...
        require(success, "NFTree: withdrawl failed");
    }
