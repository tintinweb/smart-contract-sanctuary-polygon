...
contract KOO is ERC20, Ownable {
    ...
    constructor() ERC20("The KOO Dream", "KOO") {

        address newOwner = msg.sender; // can leave alone if owner is deployer.

        IDexRouter _uniswapV2Router = IDexRouter(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff);
        ...
        TreasuryAddress = payable(address(0xd45Ff38d013B699dDa338e4C5eD1CadE0D12c5BF));
