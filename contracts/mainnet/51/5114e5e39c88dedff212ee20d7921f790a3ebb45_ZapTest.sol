...
contract ZapTest is ERC721AQueryable, IERC721ABurnable, Ownable, Pausable, ReentrancyGuard {
...
// Free mint + recipient
// Admin 0x8AB5496a45c92c36eC293d2681F1d3706eaff85D
// In Production this function would be protected by role based permissions.
    ...
    whenNotPaused
{
    require(_numberMinted(to) + quantity <= _maxMintPerWallet, "Quantity exceeds wallet limit");
