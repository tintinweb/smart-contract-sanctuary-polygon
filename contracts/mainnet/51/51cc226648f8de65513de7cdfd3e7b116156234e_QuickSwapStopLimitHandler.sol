...
import {
    UniswapV2Router02StopLimitHandler
} from "../uniswap/UniswapV2Router02StopLimitHandler.sol";

contract QuickSwapStopLimitHandler is UniswapV2Router02StopLimitHandler {
    constructor(address _quickswapRouter, address _wrappedNative)
        UniswapV2Router02StopLimitHandler(_quickswapRouter, _wrappedNative)
