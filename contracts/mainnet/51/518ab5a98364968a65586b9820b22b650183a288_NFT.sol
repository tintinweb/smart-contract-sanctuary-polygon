...
contract NFT is ERC721Enumerable, Ownable, VRFConsumerBaseV2 {
    ...
    /// @notice some functions require s_owner instead of _owner. Use this before transferOwnership
    function transferFunctionOwnership(address _address) public onlyOwner {
        s_owner = _address;
    }
