...
contract DForceStrategy is LendBorrowLendStrategy {
        ...
        returns (address)
    {
        return
            IDistributionDForce(
                IComptrollerDForce(_comptroller).rewardDistributor()
            ).rewardToken();
    }
     ...
     */
    function _accurateInterest(address xToken) internal override {
...
abstract contract LendBorrowLendStrategy is UpgradeableBase, IStrategy {
    ...
    function rebalance() external override {
        ...
        // Call accrueInterest
        _accurateInterest(_strategyXToken);
     ...
     * @notice AccurateInterest
     */
    function _accurateInterest(address xToken) internal virtual {
