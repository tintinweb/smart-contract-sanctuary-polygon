...
contract Geometric3DShape is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Geometric 3D Shape", "GEO3DSP") {
    setHiddenMetadataUri("ipfs://QmTcLyD9LGEkuyyWWJJeJxzG58RSXj5GMfLkABBBuVJbDp");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0xEd9fed712d05A9AF61f44b6ebC01Bb44E1B37e5A).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
