...
contract InuProject is ERC721Enumerable, Ownable {
  ...
  function toggleMintEnabled(bool _state) public onlyOwner {
  ...
  function mint(address _to, uint256 _mintAmount) public payable {
        ...
        if (msg.sender != owner()) {
            if (whitelisted[msg.sender] != true) {
				...
				require(_mintAmount <= maxMintAmount, 'Exceeds max mint abount');
