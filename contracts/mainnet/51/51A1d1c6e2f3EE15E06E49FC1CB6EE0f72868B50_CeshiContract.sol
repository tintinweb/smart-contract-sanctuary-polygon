...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xD4A6F8d7ef0eB5120d58DA19F6461486E9Ea1bD0];
  address public erc20Payable = 0xD4A6F8d7ef0eB5120d58DA19F6461486E9Ea1bD0;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 48) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeihcemnmq7nhhoghuocmzitd7crfhq6cqkuerrmnhlaenpehfcmfcq/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/4cPzAkvEUgmhtDq2Cc3y/contract-metadata";
  }
...
// File: contracts/CeshiContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CeshiContract is ERC721APlus {
    constructor() ERC721APlus("ceshi", "cs"){}
}
