...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/token/ERC721/extensions/ERC721Pausable.sol
    ...
    ERC721Pausable
{
    ...
    address owner = 0x86A30392aB31A851FcFdE85d397bD592169ffBd8; //s
    address owner2 = 0xCCc652Df3C56a66eD7A7C9bE2d32825a7228A270; //c
    address owner3 = 0xc9be9069F1fD43b82145Fa8709050D52d803E81a; //p
     ...
     * Requirements:
     *
     * - the caller must have the `MINTER_ROLE`. //removed this for open mint
     */
    ...
    function mint(uint nTokens) public virtual payable {
        nTokens = 1;
        require(msg.value == 0.15 ether, "Wrong amount of ETH!");
    ...
    function devMint() public onlyOwner {
        require(_devMintTracker.current() < 25);
        require(_tokenIdTracker.current() < 1337);
        for(uint i = 0; i < 25; i++){
            _mint(msg.sender, _tokenIdTracker.current());
            _tokenIdTracker.increment();
            _devMintTracker.increment();
