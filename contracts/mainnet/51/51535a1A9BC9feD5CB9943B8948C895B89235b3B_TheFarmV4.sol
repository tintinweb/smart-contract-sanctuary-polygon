	...
	ERC1155HolderUpgradeable
{
	...
	mapping(Character => uint256) public potatoPerEpochByCharacter; // Character => uint256
	mapping(Character => mapping(uint256 => Stake)) stakeByCharacterByCharacterId; // Character => CharacterId => Stake
