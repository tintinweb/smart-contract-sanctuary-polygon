...
contract Refibound is Context, IERC20, Ownable {
    ...
    string private _name = "Refibound";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x0000000000000000000000000000000000000000, 'We can not exclude Uniswap router.');
