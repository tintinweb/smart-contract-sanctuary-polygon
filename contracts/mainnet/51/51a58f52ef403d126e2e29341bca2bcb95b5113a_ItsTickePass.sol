...
contract ItsTickePass is DefaultOperatorFilterer, ERC721A, Ownable {
  using Address for address;
  using Strings for uint256;
  ...
  uint256 private mintPercentage = 10;  
  ...
  uint256 private _nftEtherValue = 47 ether;

  event _transferSend(address _from, address _to, uint _amount);

  constructor() ERC721A("ItsTickePass", "ITP") {    
    setBaseURI("https://ipfs.io/ipfs/QmUMCbap8CmNb4S8hSh7Dx2Xi5vagsByHBPs1Jg7yfZfF8");    
    _contractUri = "https://ipfs.io/ipfs/QmVyBYQ3XC4oCZSX8CH9GBkGvkx4kQic4FS9DG1RftJ3at";
    ...
    function mint(
      ...
      for (uint256 i = 1; i <= _mintAmount; i++) {
        ...
        --updatedNumAvailableTokens;
        _addressLastMintedTokenId[endUser] = Id;
      ...
      returns (uint)
    {
     ...
     function split(uint256 _mintAmount ) public payable{
      ...
      uint256 amountM = ownerAmount * mintPercentage / 100;
