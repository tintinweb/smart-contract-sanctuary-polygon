...
contract CryptoDadsStakeChild is FxBaseChildTunnel, Ownable {
        ...
        returns (uint256)
    {
        ...
        uint256 dadRewards = _calculateReward(
            stake.amount,
            periodsPassed,
            false
        );

        uint256 momRewards = _calculateReward(
            stake.momAmount,
            periodsPassed,
            true
        );

        console.log(stake.momAmount, periodsPassed, momRewards);

        uint256 reward = dadRewards + momRewards;
