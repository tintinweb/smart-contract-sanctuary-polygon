...
contract StudioPortraitShotsLxn is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_)
    ERC721("Studio Portrait Shots Lxn", "SPS")
  {
  ...
  uint256 public constant MAX_SUPPLY = 2900;

  uint256 public constant MAX_MULTIMINT = 2900;
  ...
  function mint(uint256 count) public payable nonReentrant {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 2900 at a time");
