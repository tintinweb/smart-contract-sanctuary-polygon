...
// File src/strategies/polygon/stargate/strategy-stargate-usdt.sol
// License-Identifier: MIT
pragma solidity ^0.8.6;
...
contract StrategyPolyStargateUsdt is StrategyStargateFarmBase {
  // Token addresses
  address public constant usdt = 0xc2132D05D31c914a87C6611C10748AEb04B58e8F;
  address public constant _lp = 0x29e38769f23701A2e4A8Ef0492e19dA4604Be62c;
  ...
  {
    IERC20(usdc).approve(am3CrvPool, type(uint256).max);
    IUsdt(usdt).approve(starRouter, type(uint256).max);
    am3CrvTokensOrder[usdt] = 2;
  }

  // **** Views ****

  function getName() external pure override returns (string memory) {
    return "StrategyPolyStargateUsdt";
  }
}