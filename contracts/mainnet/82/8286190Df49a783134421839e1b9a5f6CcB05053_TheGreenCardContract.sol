...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xf47f905995BFE8c589Ad1e5208d6c98d46d5969b];
  address public erc20Payable = 0xf47f905995BFE8c589Ad1e5208d6c98d46d5969b;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, type(uint256).max) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmetQRVbnTiBdZTxTmgJy7ytpuFnwkVWffnDHeyAmZRhiR/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/RqLBKo5rBJU8roXGyiE2/contract-metadata";
  }
...
// File: contracts/TheGreenCardContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheGreenCardContract is RamppERC721A {
    constructor() RamppERC721A("The Green Card", "SER"){}
}