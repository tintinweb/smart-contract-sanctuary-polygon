...
contract MidnightBreeze is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("MidnightBreeze", "MNB") {
  ...
  uint256 public constant MAX_MULTIMINT = 69;
  ...
  function mint(uint256 count) public payable nonReentrant {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 69 at a time");
