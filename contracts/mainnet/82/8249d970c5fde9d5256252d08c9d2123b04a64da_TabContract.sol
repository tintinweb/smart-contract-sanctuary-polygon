...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x543652118D9A2f74A7d792265DfB79B4Efe9d371];
...
// File: contracts/TabContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TabContract is RamppERC721A {
    constructor() RamppERC721A("tab", "tb"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/3qg54oSD5Kb54vxUmcr7/contract-metadata";
    }
}
