...
contract LotteryChainGame is Ownable {
    ...
    address lotteryChainTokenAddress = 0x338e4DECa107925A7FeBEc7c11598f5368D1d616;
    LotteryChainTokenInterface lotteryChainTokenInstance = LotteryChainTokenInterface(lotteryChainTokenAddress);

    address lotteryBalanceAddress = 0x9225f98bC623D7cb8FeE6C93465AB2306c24C740;
    ...
    uint256 public startAt = 30;
    uint256 public numberOfWinners = 2;
