...
// File: contracts/GeneratedToken.sol
...
contract GeneratedToken is ERC20 {
  ...
  //* @dev set value of the minted token to one ETHER
  //  @dev minted tokens are listed in polygon block chain with a value of the token is  'one ETHER'
