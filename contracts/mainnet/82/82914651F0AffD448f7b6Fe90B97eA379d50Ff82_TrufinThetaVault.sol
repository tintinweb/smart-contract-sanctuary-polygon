...
contract TrufinThetaVault is TrufinVault, TrufinThetaVaultStorage {
    ...
    function setStrikePrice(uint128 strikePrice) external onlyOwner {
        require(strikePrice > 0, "t11" /*"strikePrice should be greater than zero"*/);
    ...
    function setWhiteList(address _newWhiteList) external onlyOwner {
        require(_newWhiteList != address(0), "t12" /*"Whitelist can't be zero address"*/);
    ...
    function withdrawInstantly(uint256 amount) external nonReentrant {
        ...
        require(amount > 0, "t13" /*"amount should be greater than zero"*/);
        require(depositReceipt.round == currentRound, "t14" /*"Invalid round"*/);
        require(
        ...
        require(receiptAmount >= amount, "t16" /*"Exceed amount"*/);
