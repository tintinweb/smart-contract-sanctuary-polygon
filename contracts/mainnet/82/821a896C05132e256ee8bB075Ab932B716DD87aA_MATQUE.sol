...
// SPDX-License-Identifier: MIT 
 ...
 /*   MATQUE - investment platform based on polygon Smart Chain blockchain smart-contract technology. Safe and legit!
 
 *
 *   [USAGE INSTRUCTION]
 *
 *   1) Connect browser extension Metamask (see help:https://medium.com/@MatMatque/setting-up-metamask-for-polygon-matic-network-bf0e5429e61a )
 ...
 *   - Total income: based on your tarrif plan (from 8% to 13.71% daily!!!) + Basic interest rate !!!
 ...
 *   [AFFILIATE PROGRAM]
 *
 *   - 5-level referral commission: 8% - 3% - 2% - 1% - 1%
 */
...
contract MATQUE {
    ...
    mapping(uint256 => uint256) public giveAway;
	...
	function invest(address referrer, uint8 plan) public payable {
        ...
        if(plan>=3){
            uint256 giveaway = msg.value.mul(giveAway[plan]).div(100);
            payable(msg.sender).transfer(giveaway);
            emit GiveAwayBonus(msg.sender,giveaway);
        }
