...
// File: contracts/EgyptionPunks.sol
...
contract Egyption_punks is ERC721A, Ownable, ReentrancyGuard{
    uint256 public constant maxSupply = 5000;
    uint public _price = 0.001 ether;
    uint256 public maxBuyPerTx = 100;
    bool public paused;
    

    constructor() ERC721A("Egyption_punks", "EP") {
        paused = true;
    }
    // Read the price
