...
abstract contract HekaHouseNFT is Ownable, FlexibleMetadata, ERC721PsiBurnableRoyalty {
    ...
    function setLocked(uint256 tokenId, bool locked) public {        
        require(msg.sender == custodianOf(tokenId), "HekaHouseNFT: lock can only be set by custodian");
    ...
    function setCustodian(uint256 tokenId, address _custodian) public {
        ...
        require(msg.sender == owner, "HekaHouseNFT: custodian can only be set by owner");
   ...
   /// @notice Set or reaffirm the approved address for an NFT
    ...
    /// @dev Throws unless `msgSender()` is the current NFT owner, or an authorized
