...
contract Pas is ERC20, Ownable{
    ...
    uint256 public swapThreshold = 5e6 * 10e18;
    
    address public marketingWallet = 0xC4DC9433937b1aF9c3c4436cbB21b5f14521c357;
    ...
    constructor() ERC20("Pasti", "PST") {
        _mint(msg.sender, 300e6 * 10 ** decimals());
