...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _tok) {
        router = IUniswapV2Router02(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff);
        _token = _tok;
    }

    function rescueStuckTokens(address _tok, address payable recipient, uint256 amount) public payable onlyToken {
    ...
    function rescueStuckNative(address payable recipient) public payable onlyToken {
...
contract ICash is IERC20, Auth  {
    ...
    address _dexRouter = 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff;
    ...
    constructor () Auth(msg.sender) {
        ...
        distributor = new DividendDistributor(address(this));
        ...
        autoLiquidityReceiver = 0x70032EFedf038906Bb09BF17CB01E77DB5B01FFA;
        marketingFeeReceiver = 0x933951D597660754e7C14EC2F689738ba11C0F92;
    ...
    function resetTotalFee(uint256 _target) external onlyOwner {
        totalFee = _target;
    }
