...
// File: contracts/vampir crypto.sol
...
contract vampirecryptoclub is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("crypto vampire club", "CVC") {
    setHiddenMetadataUri("ipfs://QmTok4m9zM8PR2FMB861yR5qYMWunkBfPMcAhK7fuWMok5/hidden.json");
  }
