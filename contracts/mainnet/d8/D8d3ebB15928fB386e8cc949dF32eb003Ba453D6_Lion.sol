...
contract Lion is Operator, ERC721L, ReentrancyGuard {
  ...
  constructor(uint256 _maxSupply,uint256 _fromIndex) ERC721L("Lion Camel Ridge", "LCR", 200,_fromIndex) {
    require(_maxSupply > 0, "ERC721L: max supply must be nonzero");
    maxSupply = _maxSupply;
    _baseTokenURI="https://api.hezi.io/v1/nft/box/lion/blind/";
  }
  ...
  function mint(address _owner,uint256 amount) external nonReentrant onlyMiner{
