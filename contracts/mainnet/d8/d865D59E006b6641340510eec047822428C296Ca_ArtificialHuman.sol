...
// File: contracts/ArtificialHuman.sol
...
contract ArtificialHuman is Ownable, ERC721 {
    using Strings for uint256;
    ...
    string private _nftURI = "ipfs://bafybeib7fwd5nbodxmtqfezvqpshhfr5rpjga3asn76nyxgepjiapa43ne/metadata/";
    uint256 private _counter = 0;
    
    bool public paused = false;

    constructor() ERC721("Artificial Human", "AH") {}
    ...
    function mint(uint256 count) public payable {
        ...
        require(msg.value >= count * price, "Incorent ETH value sent");
