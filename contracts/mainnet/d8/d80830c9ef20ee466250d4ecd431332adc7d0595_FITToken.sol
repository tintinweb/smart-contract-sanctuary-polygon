...
abstract contract ERC20CappedBurnablePausableUpgradeable is
    ...
    ERC20PausableUpgradeable
{
    ...
    function __ERC20CappedBurnablePausable_init(string memory name, string memory symbol, uint256 supply)
        internal
        onlyInitializing
    {
    ...
    // solhint-disable-next-line
    function __ERC20CappedBurnablePausable_init_unchained() internal onlyInitializing {}
    ...
    {
        require(ERC20Upgradeable.totalSupply() + burned() + amount <= cap(), "ERC20CappedBurnablePausable: 001");
...
import {
    ERC20CappedBurnablePausableUpgradeable,
    ERC20Upgradeable
} from "dappcomposer-contracts-upgradeable/token/ERC20CappedBurnablePausableUpgradeable.sol";
    ...
    UUPSUpgradeable
{
    ...
    function initialize(address owner_) public initializer {
        uint256 cap_ = 10e6 ether;
        __ERC20CappedBurnablePausable_init("FIT Token", "FIT", cap_);
    ...
    function _mint(address account, uint256 amount)
        internal
        virtual
        override(ERC20CappedBurnablePausableUpgradeable, ERC20Upgradeable)
    {
        ERC20CappedBurnablePausableUpgradeable._mint(account, amount);
    }
    ...
    function _burn(address account, uint256 amount)
        ...
        override(ERC20CappedBurnablePausableUpgradeable, ERC20Upgradeable)
    {
        ERC20CappedBurnablePausableUpgradeable._burn(account, amount);
    }

    function _beforeTokenTransfer(address from, address to, uint256 amount)
        internal
        override(ERC20CappedBurnablePausableUpgradeable, ERC20SnapshotUpgradeable)
    {
        ERC20CappedBurnablePausableUpgradeable._beforeTokenTransfer(from, to, amount);
    }
