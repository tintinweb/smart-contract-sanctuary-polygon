...
// File: contracts/darkmatter/DarkMatterPlanets.sol
...
contract DarkMatterPlanets is ERC721, ERC721Enumerable, Ownable {
    ...
    */
    ...
    function safeMint(uint256 _quantity) public {
        ...
        if (block.timestamp < presaleEndTime) {
            ...
            whitelistAccounts[msg.sender] -= _quantity;
              ...
              IERC20(0xe4671844Fcb3cA9A80A1224B6f9A0A6c2Ba2a7d5).transferFrom(msg.sender, owner(), mintPrice*_quantity);
        }
