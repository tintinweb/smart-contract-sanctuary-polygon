...
contract EvmRentsTemplate is ERC721Holder, ERC1155Holder, Ownable, ReentrancyGuard, TokensHandler {
    uint public id;
    uint public fee = 20;
    ...
    function setParams(uint _fee, address _discounts, address _tokensHandler, address _methods) external onlyOwner {
