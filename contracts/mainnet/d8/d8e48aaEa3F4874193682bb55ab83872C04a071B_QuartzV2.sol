 ...
 * bridge's ChildChainManager when a cross-chain transaction is made or migrating QuartzV1
 *
 ...
 */
contract QuartzV2 is
    ERC20("Sandclock V2", "QUARTZ"),
    AccessControl,
    IQuartz,
    IChildToken
{
    ...
    address private constant BURN_HOLE =
    ...
    // Quartz V1 token
    IERC20 public immutable quartzV1;
    ...
    constructor(
        ...
        require(_quartzV1 != address(0), "QUARTZ: v1 address is zero");

        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _setupRole(DEPOSITOR_ROLE, _childChainManager);

        quartzV1 = IERC20(_quartzV1);
    }
    ...
    /**
     * Migrate Quartz V1 to V2
     */
    function migrate() external {
        uint256 v1Balance = quartzV1.balanceOf(msg.sender);
        require(v1Balance != 0, "QUARTZ: Nothing to migrate");
        quartzV1.safeTransferFrom(msg.sender, BURN_HOLE, v1Balance);
        _mint(msg.sender, v1Balance);
        emit Migrated(_msgSender(), v1Balance);
    }
