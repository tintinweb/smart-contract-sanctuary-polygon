...
contract KAI is
    ...
    UUPSUpgradeable
{
    uint256 private constant INITIAL_SUPPLY = 500 * 10 ** 6 * 10 ** 18; // 500 MILLION INITIAL SUPPLY
...
// File contracts/token/TokenV2.sol

// SPDX-License-Identifier: GNU General Public License v3.0
pragma solidity ^0.8.7;

contract KAIRA is KAI {
    string private _newName;
    string private _newSymbol;

    function updateNameAndSymbol() public onlyOwner {
        _newName = "Kaira";
        _newSymbol = "KAIRA";
    }
