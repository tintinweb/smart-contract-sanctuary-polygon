 ...
 */
contract PolygonERC20v2 is TokenERC20v2 {

	/**
	 * @dev Constructs/deploys Polygon ALI instance,
	 *      assigns initial token supply to the address specified
	 */
	constructor(address _initialHolder) TokenERC20v2(_initialHolder) {}
 ...
 *      - Name: Token
 *      - Decimals: 18
 *      - Initial/maximum total supply: 10,000,000,000 AIC
 ...
 *      - Voting delegation and delegation on behalf via EIP-712 (like in Compound CMP token) - gives token
 ...
 *      were changed for better code readability (Name <- Comp/Zeppelin name):
 ...
 */
contract TokenERC20v2 is ERC1363, EIP2612, EIP3009, AccessControl {
	/**
	...
	/**
	 * @notice Name of the token: Token
	 *
	...
	/**
	 * @notice Symbol of the token: AIC
	 *
	 ...
	 *      it is implied version is concatenated to the name field, like "TokenERC20v2"
	 */
	...
	constructor(address _initialHolder) {
		...
		DOMAIN_SEPARATOR = keccak256(abi.encode(DOMAIN_TYPEHASH, keccak256(bytes("TokenERC20v2")), block.chainid, address(this)));
