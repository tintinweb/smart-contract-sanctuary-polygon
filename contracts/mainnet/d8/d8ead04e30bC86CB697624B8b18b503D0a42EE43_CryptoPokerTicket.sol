    ...
    IERC2981
{
    ...
    constructor(
        ...
        royaltyWallet = payable(_royaltyWallet);
    }

    function mintBatchForTokenId(
        uint256 id,
        ...
        for (uint256 i = 0; i < tos.length; i++) {
            assembly {
                ...
                to := calldataload(add(tos.offset, offset))
                amount := calldataload(add(amounts.offset, offset))
            }
            _mint(to, id, amount, "");
        }
    }
