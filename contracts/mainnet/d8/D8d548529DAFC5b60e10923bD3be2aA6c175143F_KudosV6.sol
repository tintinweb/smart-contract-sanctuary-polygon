    ...
    ERC1155NonTransferableUpgradeable
{
    ...
    function claim(
        ...
        _validateClaimability(id, claimee, v, r, s);
        ...
        if (tokenIdToKudosContainer[id].claimabilityAttributes.isAllowlistRequired) {
            ...
            for (uint256 i = 0; i < tokenIdToContributors[id].addressContributors.length; i++) {
                if (claimee == tokenIdToContributors[id].addressContributors[i]) {
    ...
    function unsafeClaim(
        ...
        if (tokenIdToKudosContainer[id].claimabilityAttributes.isAllowlistRequired) {
	        ...
	        for (uint256 i = 0; i < tokenIdToContributors[id].stringContributors.length; i++) {
	            if (compareStringsbyBytes(tokenIdToContributors[id].stringContributors[i], contributor)) {
