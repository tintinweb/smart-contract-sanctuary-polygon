...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public EARLY_MINT_PRICE = 3 ether;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 150) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeigegqmtgn3v6nxjtlwqtprrm2btaodl6uzgxbcffnfswvcexnmjwe/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/Cf9PK3dyKiH1BGfXG6Fd/contract-metadata";
  }
...
// File: contracts/RebornedCatContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract RebornedCatContract is RamppERC721A {
    constructor() RamppERC721A("RebornedCAT", "RCT"){}
}
