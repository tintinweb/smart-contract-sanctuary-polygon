...
contract GotchiManagementFacet is Modifiers{
    ...
    function AddUnstakedLending(uint256[] calldata _tokenIds) public{
        ...
        for(uint256 i = 0; i < _tokenIds.length; ){
            ...
            emit UnstakedLending(msg.sender,_tokenIds[i],true);
            unchecked{
                i++;
            }
        }
    ...
    function RemoveUnstakedLending(uint256[] calldata _tokenIds) public{
        ...
        for(uint256 i = 0; i < _tokenIds.length; ){
            ...
            emit UnstakedLending(msg.sender,_tokenIds[i],false);
            unchecked{
                i++;
            }
        }
