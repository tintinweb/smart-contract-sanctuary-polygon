...
// File: SimpleDynamicBuilder.sol

abstract contract SimpleDynamicBuilder is AbstractDynamicURI, BaseViciContract {
    ...
    constructor(INominator _tokens) {
        tokens = _tokens;
        _initDefaults();
    }
     ...
     */
    function setExternalURL(string memory newURL) public onlyURIManager {
        externalURL = newURL;
    }
     ...
     * - caller MUST be the contract owner or have the URI_MANAGER role.
     */
    function setImageUri(string memory newURI) public onlyURIManager {
        imageUri = newURI;
    }
...
// File: OrphanedEarringVoteBuilder.sol

/**
 * @title Orphaned Earring Vote Builder
 * @dev Intitial NFT content for Orphaned Earring Society Voting NFTs
 * 
 * You are entitled to vote for one submitted story for each Voting NFT
 * purchased. Vote for your friend or the story you want to support. Join
 * the community!
 * 
 * Every story will eventually be converted to an NFT to live forever on
 * the blockchain. Your story will replace this copy and become the NFT
 * description, and the title of your story will become the NFT image. The
 * community would love to hear how you lost your earring and what that
 * earring meant to you.
 * 
 * In appreciation of your support, all community voters receive exclusive
 * community privileges. [Learn more](https://orphanedearringsociety.com/faq/).
 */
contract OrphanedEarringVoteBuilder is SimpleDynamicBuilder {
    constructor(INominator _tokens, address) SimpleDynamicBuilder(_tokens) {}

    function _initDefaults() internal override {
        setExternalURL("https://orphanedearringsociety.com/");
        setImageUri("https://storage.googleapis.com/arrival-shadow-motion-newman/vici/lost-earring/LESNFT2_1080x1080.png");
        setDesc(
            "You are entitled to vote for one submitted story for each Voting NFT "
            "purchased. Vote for your friend or the story you want to support. Join "
            "the community!"
