...
contract ItemShop is OwnableUpgradeable {
    ...
    function initialize() public initializer {
        ...
        setShopInfo(1, true, 10, 2, 100 ether);
        setShopInfo(2, true, 10, 2, 200 ether);
        setShopInfo(3, true, 10, 2, 300 ether);
        setShopInfo(4, true, 10, 1, 100 ether);
        setShopInfo(5, true, 10, 1, 200 ether);
        setShopInfo(6, true, 10, 1, 300 ether);
        setShopInfo(7, true, 10, 1, 100 ether);
        setShopInfo(8, true, 10, 1, 200 ether);
        setShopInfo(9, true, 10, 1, 300 ether);
        setShopInfo(10, true, 10, 1, 4000 ether);
        setShopInfo(11, true, 10, 1, 8000 ether);
        setShopInfo(12, true, 10, 1, 12000 ether);
        setShopInfo(14, true, 10, 1, 300 ether);
    }
    ...
    function buyItem(uint itemId, uint amount) external {
        ...
        if (info.pay == 1) {
            BVT.safeTransferFrom(msg.sender, address(0x000000000000000000000000000000000000dEaD), payAmount);
        } else {
