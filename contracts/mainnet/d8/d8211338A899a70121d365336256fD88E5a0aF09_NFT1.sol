...
contract NFT1 is TokenBase, ERC721Enumerable {

    mapping(uint256 => string) private _tokenURIs;

    constructor(string memory name_, string memory symbol_, address config_) ERC721(name_, symbol_) {
    ...
    function mint(address to, uint256 tokenId, string memory _tokenURI) external onlyAdmin {
        _mint(to, tokenId);
        _tokenURIs[tokenId] = _tokenURI;
    }
