// SPDX-License-Identifier: MIT
    ...
    contract FoxesBok is ERC721, Ownable, ERC721Enumerable {
      ...
      event FoxesMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("FoxesBok", "FBK") {}
      ...
      function mintFoxes(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit FoxesMinted(id, msg.sender);
          }
        }
      }
    
      function presaleFoxes(uint256 numberOfTokens) external payable {
