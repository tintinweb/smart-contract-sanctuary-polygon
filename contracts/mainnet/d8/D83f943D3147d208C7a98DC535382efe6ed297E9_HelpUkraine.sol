...
contract HelpUkraine is ERC1155PackedBalance, Ownable, ReentrancyGuard {
    ...
    string private baseURI = "https://gateway.pinata.cloud/ipfs/QmUQFbM5sAfX9Qwhko4UWhJLrSHKiNcZ9LV1SWQ6K1u5nN/";

    uint256 public priceBronze = 10 ether;
    uint256 public priceSilver = 100 ether;
    uint256 public priceGold = 1000 ether;
    ...
    */
    ...
    /*
     * Function to set Price of each token 
    */
    function setPrice(uint256 p1, uint256 p2, uint256 p3) external onlyOwner {
        priceBronze = p1;
        priceSilver = p2;
        priceGold = p3;
    }
