...
contract GameOwner is Ownable {
  ...
  modifier onlyGame {
    require(gameRoles[_msgSender()] == true, "PimpYourCodeGame: Its not your Game");
    _;
  }
...
contract PYCToken is ERC20Pausable, GameOwner {
  address private team;

  constructor() payable ERC20("PYC Token", "PYC") {
      team = msg.sender;
