...
/// @title GenericAdapter Contract
/// @author Enzyme Council <[email protected]>
/// @notice Generic Adapter that accepts arbitrary external calls
/// @dev Does not support sequential calls with replacement, where a call depends on a previous call's output
contract GenericAdapter is AdapterBase {
