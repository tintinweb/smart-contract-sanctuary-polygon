...
contract OtterQiLocker is LockerOwnedUpgradeable, UUPSUpgradeable, IStrategy {
    ...
    IStrategy public constant maiUsdcStrategy =
        IStrategy(0x31e79E57fE7287dCa5285354338caB63A3C2b830);
    ...
    /// @notice Reinvest Qi into USDC/MAI
    /// @param amount_ the reinvest amount in USDC
    function _reinvest(uint256 amount_) internal returns (uint256) {
        qi.approve(address(maiUsdcStrategy), amount_);
        return maiUsdcStrategy.invest(address(qi), amount_);
    }
