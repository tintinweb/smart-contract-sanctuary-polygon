...
contract GodV3 is Context, IERC20, Ownable {
    ...
    string private constant _name = "GodV3";
    string private constant _symbol = "GV3";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        if (!airdrop){
            require(from == owner() || to == owner(), "Airdrop is not active.");
        }
