...
contract BoobaERC1155 is ERC1155PresetMinterPauser, Ownable, RoyaltyByToken {

    //Open sea metadata URI
    string private _metadata_uri;

    string private constant _name = 'Silver Chrome - Booba';
    string private constant _symbol = 'B2OSC';

    //Constructor : msg.sender will be the minter and the royaltyRecipient
    constructor(string memory uri, string memory contractUri) ERC1155PresetMinterPauser(uri) RoyaltyByToken() {
