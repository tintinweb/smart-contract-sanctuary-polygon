...
contract Alphalips is Ownable, ERC721A, ERC721ABurnable, ReentrancyGuard {
    ...
    address payable public immutable royaltyAccount;
    string public provenance;

    uint256 public immutable devReserve = 2; //5% - 10% of total NFTs in the final contract
    uint256 public whitelistQuantityMinted = 0;
    uint256 public immutable maxMintLimit = 10; // 10 per account
    uint256 public immutable whiteReserve = 10; // 50% of total NFTs in final contract
    uint256 public immutable totalAvailableQuantity = 20; // 1000 to 10000 in final contract
    ...
    function withdraw() external onlyOwner nonReentrant {
        (bool success, ) = royaltyAccount.call{value: address(this).balance}(
            ""
        );
    ...
    function contractURI() public pure returns (string memory) {
        return
            "https://api.control.nftmarket.mayaloka.io/get-contract-metadata";
    }
}
