...
contract HappyOrSad is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uri = "ipfs://QmV6qjAVsLXdUqfchheh8ACAawBSrvuCwPd2J7oQvdfL4k";
  ...
  constructor() ERC721("HappyOrSad", "HOS") {
      _mintLoop(0x73398E59a9A147Eb4AE3B8a31Aa8fAc4973843AF, 10);
  }
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    // Can be used by contract owner to mint freely (max of 3 per tx)
