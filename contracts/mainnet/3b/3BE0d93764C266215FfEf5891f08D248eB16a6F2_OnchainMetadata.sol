...
contract OnchainMetadata is ERC721BaseInternal {
    ...
    function _image2(
        ...
        string memory imageString = string.concat(
            ...
            tag2,
            '</tspan></text><text class="cls-14" transform="matrix(0.813628, 0, 0, 1.01345, 91.365326, 304.546661)" style="fill: rgb(118, 155, 44); paint-order: fill; " bx:origin="0.494311 0.497584">notification</text><text class="cls-14" transform="matrix(0.994492, 0, 0, 1, 88.111488, 322.839996)">',
            notification,
            '</text></g></svg>'
        );
