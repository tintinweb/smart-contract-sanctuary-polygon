...
contract InstaAutomationImplementation is Helpers {
    ...
    function submitAutomationRequest(uint256 safeHealthFactor) public {
        // require(
        //     instaList.accountID(msg.sender) != 0,
        //     "zero-caller: not-valid-dsa"
        // );
        require(safeHealthFactor >= 105 * 1e16, "safe-health-factor < 1.05"); // TODO: update
    ...
    function systemRevert(address user) external {
        // onlyOwner
        // require(instaList.accountID(user) != 0, "zero-caller: not-valid-dsa");
    ...
    function updateAutomation(uint256 safeHealthFactor) external {
        // require(
        //     instaList.accountID(msg.sender) != 0,
        //     "zero-caller: not-valid-dsa"
        // );
        ...
        require(safeHealthFactor >= 105 * 1e16, "safe-health-factor < 1.05");
...
abstract contract Events is Variables {
    ...
    event LogCancelAutomation(address user, uint256 vnonce, uint256 safeHF);

    event LogExecuteAutomation(address user, uint256 vnonce, uint256 safeHF);
