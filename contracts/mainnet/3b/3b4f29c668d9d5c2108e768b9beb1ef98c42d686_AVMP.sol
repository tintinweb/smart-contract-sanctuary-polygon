...
contract AVMP is ERC721, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;

    uint256 public constant MAX_TOKENS = 10000;
    uint256 public TOKEN_PRICE = 800 ether;
    ...
    constructor() ERC721("AlphaVerse Membership Pass", "AVMP") {
    }
    ...
    function _checkMintRequirements(uint256 quantity) internal {
        require(quantity > 0, "invalid quantity: zero or greater than mint allowance");
