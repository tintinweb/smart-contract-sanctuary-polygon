...
contract Semantic is ISemantic, AccessControl,ERC721 {
 ...
 /**
    ...
    function verifyMessage(string memory originalData, uint8 _v, bytes32 _r, bytes32 _s) public   view returns (address) {

        return _verifyMessage(keccak256(abi.encodePacked(originalData)),
                _v,
                _r,
                _s);
    }
