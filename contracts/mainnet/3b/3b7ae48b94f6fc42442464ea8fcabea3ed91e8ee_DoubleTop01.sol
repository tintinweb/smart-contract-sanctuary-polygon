...
contract DoubleTop01 is ERC721, ERC721Enumerable {
    using Counters for Counters.Counter;

    // Apr 11, 2022 - 16:30 UTC
    uint256 public constant START = 1649694600;
    // Apr 11, 2022 - 17:00 UTC
    uint256 public constant END = 1649696400;

    Counters.Counter private tokenIds;

    constructor() ERC721("2TOP x KYVE AMA #01", "") {}
    ...
    function tokenURI(uint256) public view virtual override returns (string memory) {
        return "https://arweave.net/9nf0AhkfqkQxZCEWXANJkEzu9u6bwrBMdHpq6LaM7Ac";
    }
