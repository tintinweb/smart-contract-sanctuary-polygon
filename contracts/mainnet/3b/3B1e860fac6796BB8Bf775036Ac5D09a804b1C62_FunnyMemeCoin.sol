...
contract FunnyMemeCoin is ERC20, Ownable {
    ...
    uint256 private _startSupply = 1000000000 * (10**3);
    uint256 private swapTokensAtAmount = 2400 * (10**3);
