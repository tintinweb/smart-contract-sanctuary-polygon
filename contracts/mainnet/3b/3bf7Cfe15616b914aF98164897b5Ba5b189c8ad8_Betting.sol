...
contract Betting is Ownable, AccessControl, ReentrancyGuard, Pausable {
    ...
    */
    ...
    modifier tournamentEntryExist(string memory _tournamentId, string memory _teamId) {
        require(
            ...
            "[Betting.tournamentEntryExist] Tournament entry not exist"
        );
        _;
    }
    ...
    */
    function calculateTournamentReward(string memory _tournamentId) internal {
        ...
        tournament.rewardPerBet = entry.entryBetAmount != 0? (tournament.tournamentBetAmount  * REWARDPRECISION) / entry.entryBetAmount: 0;
    }
    ...
    */
    function getUserTournamentClaimableReward(
        ...
        claimableReward = tournament.userClaimAmount[_userAddress] == 0? (tournament.rewardPerBet * entry.userBetAmount[_userAddress]) / REWARDPRECISION: 0;
    }
