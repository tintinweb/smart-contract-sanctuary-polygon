...
abstract contract BaseStrategyMasterChef is BaseStrategy {
    ...
    event SetWmaticCutoff(uint256 value);
...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
    ...
    // Other constants
    uint256 public constant underlyingPoolId = 47;
    address public constant sushi = 0x0769fd68dFb93167989C6f7254cd0D766Fb2841F; // Sushi
    address public constant weth = 0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619; // WETH
    ...
    uint256 public wmaticCutoffBps = 10**12;
        ...
        )
    {
        ...
        rewardToFeeTokenPath[0] = sushi;
        rewardToFeeTokenPath[1] = rewardTokenAddr;
    ...
    function set_wmaticCutoff(uint256 newCutoff) external onlyOwner {
        wmaticCutoffBps = newCutoff;
        emit SetWmaticCutoff(wmaticCutoffBps);
    }
    ...
    function harvest() public override nonReentrant {
        ...
        swapAmount = calculateSwapAmount(sushi, 10000);
        if (swapAmount > wmaticCutoffBps) {
            _swapUniswapWithPathForFeeOnTransferTokens(
                rewardToFeeTokenPath,
                swapAmount,
                swapRouter0Addr
