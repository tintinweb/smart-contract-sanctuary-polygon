...
contract FlashloanV2 is FlashLoanReceiverBaseV2, Withdrawable {
    ...
    function flash1(
        ...
        // bytes memory params = params1;
        // (
        //     address collateral,
        //     address debt,
        //     address user,
        //     uint256 debtToCover
        // ) = abi.decode(params1, (address, address, address, uint256));
        ...
        bytes memory params = abi.encode(collateral, debt, user, debtToCover);
    ...
    //     bytes calldata params1
    // ) internal {
    //     address receiverAddress = address(this);

    //     address onBehalfOf = address(this);
    //     bytes memory params = abi.encode(params1);
    //     (
    //         address collateral,
    //         address[] debt,
    //         address user,
