...
/**
 * This ICO Presale  was made by Hickory Blockchain Development.
 * Web: https://hicchain.one
 * Telegram: 
 */
 ...
 // File contracts/HickoryPresale.sol
 // SPDX-License-Identifier: MIT

 pragma solidity ^0.8.0;

 contract HickoryLaunchpad is OwnerWithdrawable {
     using SafeMath for uint256;
