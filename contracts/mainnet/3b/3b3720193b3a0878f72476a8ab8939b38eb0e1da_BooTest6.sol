...
contract BooTest6 is ERC721Enumerable, Ownable 
{
    using Strings for string;

    uint public constant MAX_TOKENS = 1111;
    uint public PRESALE_LIMIT = 1111;
    uint public presaleTokensSold = 0;
    uint public constant NUMBER_RESERVED_TOKENS = 11;
    uint256 public PRICE = 50000000000000000; //0.05 eth
    uint public perAddressLimit =11;
    ...
    constructor() ERC721("BooTest6th", "BT6") {}
