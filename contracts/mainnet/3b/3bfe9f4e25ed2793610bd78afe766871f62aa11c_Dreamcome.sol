 ...
 * 
 */
contract Dreamcome is IERC20 {
    
    using SafeMath for uint256;
    
    //DREAM token, creator will take 0.8% fee
    address public feeTo = 0xd1dD211e1bd8057e58b003Ed9476c14b6095C568;

    string public name = "Dreamcome";
    string public symbol = "Dream";
    uint256 public decimals = 18;
    uint256 private _totalSupply = 0;
    
    //DREAM Token supply max length
    uint256 private totalLength = 17;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        uint256 fee = amount * 8 / 1000;
        if (fee == 0) fee = 1; // minimum 0.000000000000000001 DREAM
