...
// File: contracts/OwnableBase.sol
...
contract FairPriceLaunch is OwnableBase {
    ...
    // The Non-transferable token used for sale, redeemable for CLOUT
    ...
    constructor(
        ...
        fundsRedeemer = 0x14683076786A9995D17C7e8444Ed9a36AbC43Cd6; //multisig wallet
        investToken = 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174; //usdc
        //times
        launchStartTime = 1644598800;
           require(
            launchStartTime > block.timestamp,
            "Start time must be in the future."
        );
        saleDuration = 3 days;
        launchEndTime = launchStartTime.add(saleDuration);
        
        investRemovalDelay = 3600;
        //limits
        maxInvestAllowed = 50000000000; //50k
        minInvestAllowed = 0;
        maxGlobalInvestAllowed = 1000000000000; //1m
        maxInvestRemovablePerPeriod = 1000000000000; //1m
        maxRedeemableToIssue = 5000000000000000; //5m CLOUT
        startingPrice = 50000; //50 cents
    ...
    **/
    ...
    function withdrawInvestablePool() public onlyOwner {
        ...
        //CLOUTTreasury(fundsRedeemer).deposit(amount, investToken, amount.div(1e9));
    }
