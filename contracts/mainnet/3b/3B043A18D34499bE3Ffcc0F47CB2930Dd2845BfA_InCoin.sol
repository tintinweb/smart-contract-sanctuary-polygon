    ...
    AccessControl
{
    ...
    function _mint(address account, uint256 amount) internal {
        ...
        console.log("netAmount: %s", netAmount);
        console.log("tresouryAmount: %s", tresouryAmount);
        ...
        _totalMint += (netAmount + tresouryAmount);
        _totalBurn += burnAmount;

        emit Transfer(address(0), account, netAmount);
    ...
    function _burn(address account, uint256 amount) internal {
        ...
        _totalSupply -= (netAmount + burnAmount);
        _balances[account] -= amount;
        _balances[address(_treasury)] += tresouryAmount;

        _totalBurn += (netAmount + burnAmount);
