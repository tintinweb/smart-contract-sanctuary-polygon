 ...
 *
 */
contract REPLACE_ME is Executor, TermsOfService {
...
contract Executor is Bidder {
    ...
    function purchase(uint256 tokenId) public payable {
        ...
        require(valueInWei >= ask.valueInWei, "Polygods: didn't send enough ETH");
    ...
    function acceptBid(uint256 tokenId, int256 minValueInWei) public {
        ...
        require(bidValueInWei != 0, "Polygods: invalid bid value");
...
contract VRF is VRFConsumerBaseV2, ListBurn {
    ...
    mapping(uint256 => PendingWithdrawal) private holdingWithdrawals; //has to be private
...
contract ListBurn is MintInit, DataStructure {
    ...
    function _updateListing(uint256 tokenId, int256 minSalePriceInWei, address seller) private {
        Heap.Node memory node = _getById(tokenId); //if it isn't there it'll return [0,0]
        if(node.tokenId != 0){ //it _is_ in there
            _extractById(tokenId);
            _noLongerForSale(tokenId);
        } // it isn't...
...
contract MintInit is Core {
    ...
    bool public active; //TODO: make private
    bool public assigned; //TODO: make private
    bool public initialized; //TODO: make private
    ...
    function initialize() external onlyAdmin {
        ...
        /* * */
        //uint256 reserve = 202; // (production)
        uint256 reserve = 2; // (testing)
    ...
    */
     ...
     *
     */
    function mint__I_UNDERSTAND_AND_ACCEPT_TERMS_OF_SERVICE(uint256 countCreate) public payable {
...
contract DataStructure {
    ...
    /**
     * TODO: what happens if you call this and it isn't there...
     */
