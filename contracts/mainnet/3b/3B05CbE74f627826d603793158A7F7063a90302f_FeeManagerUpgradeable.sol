    ...
    IFeeManager
{
    ...
    mapping(uint64 => mapping(address => bool)) private _feeTokenWhitelisted;

    // feeTokens list on destination chains
    mapping(uint64 => address[]) private _chainFeeTokens;
    ...
    function initialize(
        ...
        __FeeManagerUpgradeable_init(handlerAddress, twapAddress, usdcAddress);
    }
    ...
    /**
        @notice Used to fetch fee denominator.
     */
     ...
     */
    function USDC() external view virtual override returns (address) {
        return usdc;
    }
    ...
    */
    function getChainFeeTokens(uint64 destChainId)
        public
        view
        virtual
        override
     ...
     */
    function getFeeTokenToOracle(address feeToken)
        public
        view
        virtual
        override
     ...
     */
    function getFeeStruct(bytes32 feeConfigID)
        public
        view
        virtual
        override
     ...
     */
    function getLpFeeInBps(bytes32 feeConfigID)
        public
        view
        virtual
        override
     ...
     */
    function getValidatorFeeInBps(bytes32 feeConfigID)
        public
        view
        virtual
        override
     ...
     */
    function getProtocolFeeInBps(bytes32 feeConfigID)
        public
        view
        virtual
        override
     ...
     */
    function getWidgetFeeInBps(uint256 widgetID)
        public
        view
        virtual
        override
     ...
     */
    function getBaseFee(bytes32 feeConfigID)
        public
        view
        virtual
        override
    ...
    /**
        ...
        @param  srcChainId id of the source chain. Put 0 if not configuring.
        @param  destChainId id of the destination chain.
    ...
    /**
        ...
        @param  feeToken address of the fee token.      */
    function getPoolAddressWithUSDC(address feeToken)
        public
        view
        virtual
        override
    ...
    {
        pool = IUniswapV3Twap(_twapAddress).getPoolAddress(
            feeToken,
            usdc,
            3000
        );
    ...
    /**
        ...
        @param  feeToken address of the fee token.      
    */
    function getFeeTokenToPrice(address feeToken)
        public
        view
        virtual
        override
     ...
     */
    function setUniTwapAddress(address twapAddress)
        external
        virtual
        override
        onlyRole(DEFAULT_ADMIN_ROLE)
     ...
     */
    function setUSDC(address usdcAddress)
        external
        virtual
        override
        onlyRole(DEFAULT_ADMIN_ROLE)
     ...
     */
    function setValidatorFeeInBps(
        bytes32 feeConfigID,
        uint256 validatorFeeInBpsX1000
    ) public virtual override onlyRole(FEE_SETTER_ROLE) {
        _fees[feeConfigID].lpValidatorAndProtocolFeeInBps[
                1
            ] = validatorFeeInBpsX1000;
        ...
        onlyRole(FEE_SETTER_ROLE)
    {
        ...
        require(
            fees.feeToken != address(0),
            "FeeManager: Fee not set for this config"
        );
    ...
    /**
        ...
        @param  data Contains an array of [lpFee, validatorFee, protocolFee] 
                along with baseFeeInUSD and maxFeeInUSD.
    ...
    */
    ...
    function setFee(
        ...
        (
            uint256[3] memory lpValidatorProtocolWidgetFeeInBps,
            uint256 baseFeeInUSDx1000,
            uint256 maxFeeInUSDx1000
        ) = abi.decode(data, (uint256[3], uint256, uint256));

        bytes32 feeConfigID = getFeeConfigID(
            srcChainId,
            destChainId,
            srcToken,
            destToken,
        ...
        _fees[feeConfigID] = Fees(
            ...
            feeTokenDecimals,
            [
                lpValidatorProtocolWidgetFeeInBps[0],
                lpValidatorProtocolWidgetFeeInBps[1],
                lpValidatorProtocolWidgetFeeInBps[2]
            ],
            baseFeeInUSDx1000,
            maxFeeInUSDx1000
        );
        ...
        emit FeeSet(
            ...
            destToken,
            feeToken,
            lpValidatorProtocolWidgetFeeInBps,
            [baseFeeInUSDx1000, maxFeeInUSDx1000]
        );
    }
    ...
    */
    function getFee(
        ...
        require(
            fees.feeToken != address(0),
            "FeeManager: fees not set for this token"
        );
        ...
        additionalFeesInUSD +=
            (totalBps * transactionVolumeInUSDx1000 * 1000000000) /
            _feeDenominator;

        if (_widgetFeeInBps[widgetID] != 0) {
            additionalFeesInUSD +=
                (_widgetFeeInBps[widgetID] *
        ...
        lpValidatorProtocolWidgetFee[0] +=
            ((feeInUSD - fees.baseFeeInUSD * 1000000000) *
        ...
        if (_feeTokenToOracle[fees.feeToken] != address(0)) {
            ...
            (int256 latestPrice, uint256 decimals) = getLatestPrice(
                _feeTokenToOracle[fees.feeToken]
            );
            ...
            lpValidatorProtocolWidgetFee[0] = ((lpValidatorProtocolWidgetFee[
                0
            ] *
                (10**decimals) *
                10**fees.feeTokenDecimals) / uint256(latestPrice));

            lpValidatorProtocolWidgetFee[1] = ((lpValidatorProtocolWidgetFee[
                1
            ] *
                (10**decimals) *
                10**fees.feeTokenDecimals) / uint256(latestPrice));

            lpValidatorProtocolWidgetFee[2] = ((lpValidatorProtocolWidgetFee[
                2
            ] *
                (10**decimals) *
                10**fees.feeTokenDecimals) / uint256(latestPrice));
            ...
            if (pool != address(0)) {
                ...
                require(
                    _feeTokenToPriceX10e9[fees.feeToken] != 0,
                    "Fee Manager: Fee not set!"
                );
