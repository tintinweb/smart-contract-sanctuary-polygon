...
contract FalineArena2 is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxSupply = 196;
  uint256 public maxMintAmountPerTx = 15;

  bool public paused = true;
  bool public revealed = false;

  constructor() ERC721("Faline Arena 2", "FA2") {
    setHiddenMetadataUri("ipfs://bafybeids36f42bfizwqfs2i4x4zok6kanct5hvh6pessuzlzjpbiawfl34");
  }
