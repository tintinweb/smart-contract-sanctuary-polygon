...
contract OneSplitRoot {
    ...
    IUniswapV2Factory internal constant uniswapV2 = IUniswapV2Factory(0x30D70fFBbfD795B147842100be5564502285E31F);
    IUniswapV2Factory internal constant dfynExchange = IUniswapV2Factory(0x4FD2c40c25Dd40e9Bf0CE8479bA384178b8671b5);
    IUniswapV2Factory internal constant pancakeSwap = IUniswapV2Factory(0xc08BAEA14C14f25bcafe3e3E05550715505eF3dE);
...
contract OneSplit is Initializable, IOneSplit, OneSplitRoot, UUPSUpgradeable, AccessControlUpgradeable {
    ...
    function swapSameChain(
        ...
        emit SameChainTransfer(recipient ,amount, returnAmount, tokens, flags);
    }
