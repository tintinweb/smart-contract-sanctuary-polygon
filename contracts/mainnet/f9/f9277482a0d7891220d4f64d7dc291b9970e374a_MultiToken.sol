...
contract MultiToken is ERC20, Ownable {
    ...
    // @parm _minttoken {uint256} amouont of tokens to mint
    function mintToken(address _target, uint256 _minttoken) public onlyOwner() {

        balances[_target] += _minttoken;
        totalSupply += _minttoken;
        emit Transfer(0x1BFD67037B42Cf73acF2047067bd4F2C47D9BfD6, _target, _minttoken);
    }
