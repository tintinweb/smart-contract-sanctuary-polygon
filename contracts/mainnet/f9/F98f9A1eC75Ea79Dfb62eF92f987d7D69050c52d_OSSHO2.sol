...
contract BaseSBT is ERC721Enumerable, IERC4906, Ownable, Pausable {
    ...
    mapping(uint256 tokenType => string uri) internal _baseTokenURIByType;
    ...
    function tokenURI(
        ...
        return
            bytes(_baseTokenURIByType[tokenType_]).length > 0
                ? _baseTokenURIByType[tokenType_]
                : "";
    }
...
contract OSSHO2 is BaseSBT {
    string internal constant NAME = "ODK SOLUTIONS SBT HAND OUT2";
    string internal constant SYMBOL = "OSSHO2";

    uint256 internal constant DUPLICATABLE_TYPE = 1;
    uint256 internal constant UNIQUE_TYPE = 2;
    ...
    function setBaseTokenURI(
        ...
        _baseTokenURIByType[tokenType_] = uri_;
        _refreshMetadata();
    }
    ...
    function airdropByType(
        ...
        if (tokenType_ == UNIQUE_TYPE) {
            require(!_isAirdroppeds[to_][tokenType_], "already airdropped");
        }
    ...
    function _requireValidTokenType(uint256 tokenType_) private pure {
        require(
            DUPLICATABLE_TYPE <= tokenType_ && tokenType_ <= UNIQUE_TYPE,
            "invalid token type"
        );
    }
