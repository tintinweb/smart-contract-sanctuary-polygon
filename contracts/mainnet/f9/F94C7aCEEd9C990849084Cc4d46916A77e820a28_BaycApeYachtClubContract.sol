    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1000, 10000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeib47mbfde3ay7fyhrnxlafhohdubqeialumvpmg65eheehlco7jwa/";
...
// File: contracts/BaycApeYachtClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BaycApeYachtClubContract is RamppERC721A {
    constructor() RamppERC721A("BAYC Ape Yacht Club", "BAYC  Club"){}
}
