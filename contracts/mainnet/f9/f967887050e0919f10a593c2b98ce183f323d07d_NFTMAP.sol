...
contract NFTMAP is ERC1155, Ownable {
    string public name = "co-mapper";
    string public symbol = "comap";


    constructor() ERC1155("https://gateway.pinata.cloud/ipfs/QmTJtQA32yaeSuUr93ZJQC4M8md5Z2SbX34AiCQHWVWhd5") {
    }
