...
import "./ERC721Capped.sol"; // ERC721 token with a cap on the maximum supply one can mint
import "./ERC721Mintable.sol"; // ERC721 token that allows minting
import "./ERC721Permit.sol"; // ERC721 token that implements permit for gasless transactions
import "./ERC721URI.sol"; // ERC721 token with support for metadata
