...
// File: CertCollectible.sol

contract CertCollectible is ERC721, Ownable {
    uint256 public tokenCounter;

    // DPU GRADUATION 2022 (DPU22)
    // constructor() public ERC721("DPU GRADUATION 2022", "DPU22") {
    constructor() public ERC721("Beta Univ2 Cert", "BetaCert") {
        tokenCounter = 0;
    }

    function createCollectible(string memory tokenURI, address to_address)
        public
        onlyOwner
        returns (uint256)
    {
        uint256 newItemId = tokenCounter;
        _safeMint(to_address, newItemId);
