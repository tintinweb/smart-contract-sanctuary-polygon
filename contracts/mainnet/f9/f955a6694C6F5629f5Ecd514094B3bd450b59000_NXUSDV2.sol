...
/// @title NXUSDV2
/// @notice added withdraw(recovery) function
contract NXUSDV2 is ERC20, BoringOwnable {
    ...
    function withdraw(address token, address to, uint256 value) public onlyOwner {
        ...
        require(balanceToken >= value, 'Insufficient token balance');
    ...
    function _EIP712DomainName() internal view override virtual returns (string memory) {
        return name;
    }
...
abstract contract Domain {
    ...
    bytes32 private constant DOMAIN_SEPARATOR_SIGNATURE_HASH = keccak256("EIP712Domain(string name,string version,uint256 chainId,address verifyingContract)");
    ...
    function _EIP712DomainName() internal view virtual returns (string memory);
}
