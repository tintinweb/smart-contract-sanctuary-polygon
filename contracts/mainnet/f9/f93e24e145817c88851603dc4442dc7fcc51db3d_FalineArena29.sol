...
contract FalineArena29 is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public cost = 18.30 ether;
  uint256 public maxSupply = 418;
  uint256 public maxMintAmountPerTx = 50;

  bool public paused = true;
  bool public revealed = false;

  constructor() ERC721("Faline Arena 29", "FA29") {
    setHiddenMetadataUri("ipfs://bafybeid5rwujknqgz5ybp3qmkxh6b4vgcoitxgsj7xwkjxotlwqd4wgnmi");
  }
