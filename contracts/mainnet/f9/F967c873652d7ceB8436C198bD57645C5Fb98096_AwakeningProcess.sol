...
contract AwakeningProcess is Ownable {
    ...
    function awakening(uint256 tokenId) public {
        ...
        GuardiansAwake.mint(tokenOwner, tokenId);
    }
    ...
    function batchMintAwake(address[] memory recipients, uint256[] memory tokenIds) public onlyOwner {
        IGuardiansAwake(s_guardiansAwake).batchMint(recipients, tokenIds);
    }
