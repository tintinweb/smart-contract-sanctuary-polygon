...
contract NETU21 is ERC20, AccessControl   {
    ...
    uint256 public tokensFaucetMint = 21000; //amount requested in faucet
    ...
    constructor() ERC20("NET for U of 21", "NETU21") {

        totalSupplyToken = 2100 * (10 ** decimals());
    ...
    function mint(address to, uint256 amount) public onlyRole(MINTER_ROLE) {
        require(amount < remainYear(currentYear), "EXCEEDED_AMOUNT_TO_MINT_THIS_YEAR");
        _mint(to, amount);
    ...
    function updateTokensMintFaucet(uint256 amount) public onlyRole(DEFAULT_ADMIN_ROLE){
        require(amount > 2100, "NO_VALID_AMOUNT");
    ...
    function buy() public payable returns (bool){
        ...
        uint256 _div21 = (tokensFaucetMint / 21);
