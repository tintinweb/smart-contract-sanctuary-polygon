...
/**************************************************************************************** MODIFIERS *********************************************************************************************/
    ...
    modifier lock() {
        require(unlocked == 1, 'CLAMPV1: LOCKED');
        unlocked = 0;
        _;
        unlocked = 1;
    }
...
/************************************************************************************ WALLET-FUNCTIONS ******************************************************************************************/
   ...
   */
   function update( address[] memory _tokenAddresses, uint[] memory _tokenAmounts, uint[] memory _amountsOut) external onlyClampContract lock{
    ...
    */
function internalSwap(uint _indexIdentifier, uint _percentage, address _returnBaseToken) external onlyOwner lock {
    ...
    */
    function externalMultiWithdraw(uint _indexIdentifier, uint _percentage) external onlyOwner lock{
        require(userIndexes[_indexIdentifier].Exists, "CLAMPV1: INDEX-NOT-FOUND");
    ...
    */
    function withdrawReseveBaseTokens(address _token, uint _amount) external onlyOwner lock {
