...
// File: contracts/MyCustomERC721NFTContract1.sol
...
contract MyCustomERC721NFTContract1 is ERC721URIStorage, AccessControl {
    ...
    // Constants
    uint256 public constant TOTAL_SUPPLY = 40_000;
    ...
    constructor(
        ...
        _setupRole(DEFAULT_ADMIN_ROLE, ownerOfNft);
        _setupRole(MINTER_ROLE, ownerOfNft);
    ...
    function tokenOfOwnerByIndex(address ownerOfToken, uint256 index) public view virtual returns (uint256) {
        require(index < balanceOf(ownerOfToken), "ERC721: owner index out of bounds");
        return _ownedTokens[ownerOfToken][index];
    }
