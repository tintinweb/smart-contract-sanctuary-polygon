...
// File: contracts/GeoCollectible.sol
...
contract GeoCollectible is ERC1155URIStorage, ERC1155Supply, Ownable  {
    ...
    function mintCollectible(string memory tokenURI, uint256 quantity) external onlyOwner returns (uint256 index) {
