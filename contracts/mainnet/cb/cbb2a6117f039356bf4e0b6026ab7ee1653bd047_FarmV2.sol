...
contract TokenV2 is ERC20, ERC20Burnable {
  ...
  constructor() payable ERC20("My Little Farm", "MLF") {
    owner = msg.sender;
  }
...
contract FarmV2 {
    ...
    function createFarm(address payable _charity) public payable {
        ...
        require(
            // Charity 1  - double check
            _charity == address(0xff88e558f4eA45D7D68c96C4E79EF67f7E4311a5)
            // Charity 2
            || _charity == address(0xcBF0F135597fd6DA6EbF3418CebacFc98eF8Cab4)
            // Charity 3
            || _charity == address(0x340e2482ed104B0A85e1E2A87627d155A64f1C8D),
            "INVALID_CHARITY"
        );
        ...
        (bool success, ) = _charity.call{value: msg.value}("");
        require(success);
