...
contract StrategyPenrose_USDC_DAI is Strategy0xDAOMaximizer {

    address usdc_dai_diff;

    function initializeStrategy(
        address _store,
        address _vault
    ) public initializer {
        address usdc_dai_lp = address(0xFec23508fE4b5d10A3eb0D83b9947CAa56F39463);
        ...
        __Strategy_init(
            ...
            _vault,
            rewards,
            0xB7cB4f198Bf4FCa182b6e541a7875A64b576b5E7,
            false,
