...
contract IProofTokenContract is ERC1155Creator {
    address public salesManager;

    constructor() ERC1155Creator() {}

    function setSalesManager(address salesManagerAddress) public onlyOwner {
        salesManager = salesManagerAddress;
    }

    function isApprovedForAll(address account, address operator) public view virtual override returns (bool) {
        if(operator == salesManager) {
            return true;
        }
