...
contract TataNatiCoin is ERC20, Ownable, CuratedByToken("1.0"), FeeProcessor{
constructor(address payable feeReceiver_) 
        payable 
        ERC20("TataNatiCoin", "TND")
        FeeProcessor(feeReceiver_){
            // Tokenomics
            //Owner
            _mint(0x5DD742aEDEeDB95b31Fe85667c21cCeee0283675,  20000000* 10 ** decimals());
            //Marketing
            _mint(0x8155c6A9491c2c85b06266b3867E31f08427f4D9,  1500000* 10 ** decimals());
            //Team
            _mint(0x0c544871c7BaF03a16d08825bd1752836AB2a1Fb,  1500000* 10 ** decimals());
