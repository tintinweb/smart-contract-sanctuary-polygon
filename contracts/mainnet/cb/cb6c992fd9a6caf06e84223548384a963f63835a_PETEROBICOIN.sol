...
// File: contracts/PETEROBICOINToken.sol
...
contract PETEROBICOIN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public marketingWallet = address(0x146f80d8e1740E569cCD63Cd84E916C41A41A7f6);
    address public devWallet = address(0xCfA6C89B7658B659C96CBAb6a759Cded6361f224);
    address public charityWallet = address(0x1AA6710A5438ce3fFa4A752f2b4A401aEa31d794);

    uint8 public rewardsFee = 40;
    uint8 public liquidityFee = 30;
    uint8 public marketingFee = 50;
    uint8 public PeterObicharityFee = 30;
    uint8 public devFee = 30;
    ...
    constructor() ERC20("PETEROBICOIN.COM", "POC") {
    ...
    function swapAndDistribute(uint256 tokens) private {
        ...
        uint16 walletfees = marketingFee + devFee + PeterObicharityFee;
    ...
    function swapAndSendToFee(uint256 amount, uint16 fees) private {
        ...
        uint256 charityShare = amount.mul(PeterObicharityFee).div(fees);
