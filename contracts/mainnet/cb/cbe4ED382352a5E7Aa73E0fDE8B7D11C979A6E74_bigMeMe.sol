...
// File: contracts/eth_project/bigEmojiNft.sol
...
// yinru Counters
contract bigMeMe is ERC721A, Ownable {
    ...
    // 注意 构造函数参数 5 要和变量 MAX_PER_MINT 一致
    constructor() ERC721A("Big MeMe", "Big MeMe", 10) {
        setHiddenMetadataUri("ipfs://QmUXd2GcwHcUNhV1Spd3n5YTChDuBvQqxEa3QV9VRbW91A/hidden.json");
    }
