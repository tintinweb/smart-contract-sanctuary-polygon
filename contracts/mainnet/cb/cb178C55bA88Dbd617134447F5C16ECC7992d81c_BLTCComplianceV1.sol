...
contract BLTCComplianceV1 is CountryRestrictions, DayMonthLimits {
    ...
    constructor () public {
        ...
        uint16[35] memory inputRestrictedCountries = [uint16(408), 4,760,862,70,108,156,112,586,643,140,364,180,192,818,624,332,368,422,434,807,499,104,558,688,706,728,729,788,792,804,887,716,498,466];
