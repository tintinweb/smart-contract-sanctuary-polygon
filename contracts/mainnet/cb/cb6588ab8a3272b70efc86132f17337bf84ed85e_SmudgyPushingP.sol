...
contract SmudgyPushingP is IERC721L, ERC721AQueryable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
    ...
    constructor() ERC721A("Smudgy PushingP", "SMDG") {
        _mintStages.push(MintStageInfo({cost: 4000000000000000000, walletLimit: 8, merkleRoot: 0x0, maxStageSupply: 0, startTimeUnixSeconds: 1687446743, endTimeUnixSeconds: 1692544344}));
    }
