...
contract DSofArt is ERC1155, Ownable {
    // Contract name
    string public name = "Yama (Yamaraja)";
    uint256[] supplies = [1];
    uint256[] minted = [0];
    constructor() ERC1155("https://gateway.pinata.cloud/ipfs/QmX2Ki3rYt44XosPbkvAwa2T3TSpRroKBcXUAyEoMsNBei") {}
