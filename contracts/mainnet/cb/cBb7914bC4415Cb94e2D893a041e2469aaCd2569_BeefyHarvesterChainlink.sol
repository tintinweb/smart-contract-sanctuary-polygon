...
contract BeefyHarvesterChainlink is BeefyHarvesterBase, KeeperCompatibleInterface {
    ...
    function getUpkeepTxPremiumFactor() public view override returns (uint256 upkeepTxPremiumFactor_) {
        (uint32 paymentPremiumPPB, , , , , , ) = keeperRegistry.getConfig();
        upkeepTxPremiumFactor_ = uint256(paymentPremiumPPB);
    }
}
...
import "./libraries/hardhat/console.sol";
...
abstract contract BeefyHarvesterBase is ManageableUpgradeable, PausableUpgradeable {
    ...
    uint256 public upkeepTxPremiumFactor; // deprecated, must keep same storage layout for proxy upgrade. Will dynamically pull from registry everytime instead.
        ...
        )
    {
        ...
        console.log("Can Harvest", canHarvestVault);
        ...
        )
    {
        ...
        console.log("Does call reward fail");
        ...
        console.log("Checking _shouldHarvestVault()", vaultAddress_);
        console.log("harvestThreshold", harvestThreshold);
        console.log("callRewardAmount_", callRewardAmount_);
    ...
    function _performUpkeep(
        ...
        console.log("_runUpkeep()", vault_);
        console.log("newStartIndex", newStartIndex_);
    ...
    function _reportHarvestSummary(
        ...
        console.log("oldStartIndex_", oldStartIndex_);
        console.log("newStartIndex_", newStartIndex_);
        console.log("checkUpkeepGasPrice_", checkUpkeepGasPrice_);
        console.log("tx.gasprice", tx.gasprice);
        console.log("gasUsedByPerformUpkeep_", gasUsedByPerformUpkeep_);
        console.log("estimatedTxCost_", estimatedTxCost_);
        console.log("estimatedCallRewards_", estimatedCallRewards_);
        console.log("estimatedProfit", estimatedProfit);
        console.log("calculatedTxCost", calculatedTxCost);
        console.log("calculatedCallRewards_", calculatedCallRewards_);
    ...
    function _calculateTxCostWithPremium(uint256 gasOverhead_) internal view returns (uint256 txCost_) {
        return UpkeepLibrary._calculateUpkeepTxCost(tx.gasprice, gasOverhead_, getUpkeepTxPremiumFactor());
    }
