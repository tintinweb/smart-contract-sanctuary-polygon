...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xE2612978Ddc3F3ffdCAFcD462d8A435b7BaE3e65,0x9dE051A357f24C609de8627A8A1E38709C36B429];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 2001, 2001 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmckbeYEcKVuDzykgdgH64C5yJ3Ettb6iPrGc8PEE1E1tX/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 2001");
        _safeMint(_to, 1);
    }
...
contract SmileySnailsSocietyContract is RamppERC721A {
    constructor() RamppERC721A("Smiley Snails Society", "Snailll"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/HwCqmGN5zB9G5Pk5K2cf/contract-metadata";
    }
}