...
contract BedroomNft is VRFConsumerBaseV2, ERC1155, Ownable, ERC1155URIStorage {
    ...
    /// @notice Returns the data of a NFT 
    /// @param _tokenId The id of the NFT
    /// @return ambiance Score 1
    /// @return quality Score 2
    /// @return luck Score 3
    /// @return confortability Score 4
    /// @return owner NFT Owner
    /// @return level NFT Level
    function getScores(
        uint256 _tokenId
        ...
        ambiance = uint16(spec.scores);
        quality = uint16(spec.scores >> 16); 
        luck = uint16(spec.scores >> 32); 
        confortability = uint16(spec.scores >> 48); 
        owner = spec.owner;
        level = spec.level;
    }
        ...
        override
    {
        ...
        address owner = tokenIdToNftSpecifications[_tokenId].owner;
        _mint(
            owner, 
            _tokenId, 
