...
contract LicensTransactionContract is Ownable{
    ...
    function createListing(string memory _listingCID, string memory _creativeCID, string memory _licenseCID, uint256 _price, bool _isExclusive, uint256 _quantity, uint256 _exclusivitySurcharge, bool _isUnlimitedSupply) external {
    ...
    function updateListing(uint256 _listingId, string memory _listingCID, string memory _creativeCID, string memory _licenseCID, uint256 _nftTokenId, uint256 _price, bool _isExclusive, uint256 _quantity, uint256 _exclusivitySurcharge, bool _isUnlimitedSupply) external {
    ...
    function license(uint256 _listingId, bool _exclusivePurchase) external{
        ListingDetails memory listing = listingInfo[_listingId];
        ...
        emit LicenseIssued(_listingId, _listingId, msg.sender, listing.licenseCid, _exclusivePurchase);
    }
