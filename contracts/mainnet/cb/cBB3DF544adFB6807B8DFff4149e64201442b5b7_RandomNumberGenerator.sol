...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the BarSwap lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == barSwapLottery, "Only BarSwapLottery");
    ...
    /**
     * @notice Set the address for the BarSwapLottery
     * @param _barSwapLottery: address of the BarSwap lottery
     */
    function setLotteryAddress(address _barSwapLottery) external onlyOwner {
        barSwapLottery = _barSwapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IBarSwapLottery(barSwapLottery).viewCurrentLotteryId();
    }
}