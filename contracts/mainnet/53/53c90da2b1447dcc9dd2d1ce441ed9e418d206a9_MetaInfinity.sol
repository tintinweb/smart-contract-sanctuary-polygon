...
interface MetaInfinityGame {
  ...
  /**
   * @dev InfinityGame `amount` tokens from the caller's account to `recipient`.
   *
  ...
  /**
   * @dev InfinityGame `amount` tokens from `sender` to `recipient` using the
...
contract InfinityGame  is Context {
...
contract MetaInfinity is MetaInfinityGame, Context, InfinityGame  {
  
    // common addresses
    address private _owner;
    address private InfinityChain;
    address private InfinityNFT;
    ...
    string public override name = "MetaInfinity";
    string public override symbol = "MetaInfinity";
    ...
    constructor(uint totalSupplyValue, address InfinityChainAddress, address InfinityNFTAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        InfinityChain = InfinityChainAddress;
        InfinityNFT = InfinityNFTAddress;
        
        // split the tokens according to agreed upon percentages
        balances[InfinityChain] =  totalSupply * 45 / 100;
        balances[InfinityNFT] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's InfinityGame pot
    function getDeveloper() public view returns(address) {
        return InfinityChain;
    }
