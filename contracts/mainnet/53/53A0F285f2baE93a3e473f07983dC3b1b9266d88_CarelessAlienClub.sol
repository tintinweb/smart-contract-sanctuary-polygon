...
contract CarelessAlienClub is ERC721AQueryable, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "https://www.carelessaliens.com/nft/json/";
  string public uriSuffix = ".json";
  string public _contractURI = "https://www.carelessaliens.com/nft/contract.json";
  ...
  uint256 public whitelistCost = 15000000000000000000;
  uint256 public publicCost = 20000000000000000000;
  ...
  constructor() ERC721A("Careless Alien Club", "CAC") {
    _startTokenId();
    setHiddenMetadataUri("https://www.carelessaliens.com/nft/hiddenMeta.json");
    setContractURI("https://www.carelessaliens.com/nft/contract.json");
  }
...
// ---------------! BASELINE FUNCTIONS !---------------
  ...
  function withdrawSplit(address o, address d) public onlyOwner 
  {
    uint256 oAm = address(this).balance/100 * 95;
    uint256 dAm = address(this).balance - oAm;

    payable(o).transfer(oAm);
    payable(d).transfer(dAm);
  }
