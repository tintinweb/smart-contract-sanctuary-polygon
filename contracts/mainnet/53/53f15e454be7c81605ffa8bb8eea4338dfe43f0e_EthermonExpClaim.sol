...
contract EthermonExpClaim is BasicAccessControl, SafeMathEthermon  {
    ...
    // function getVerifyAddress(bytes32 _token, uint8 _v, bytes32 _r, bytes32 _s) public pure returns(address) {
       
    // return ecrecover(_token, _v, _r, _s);
    ...
    function incExp(uint64 monster_id, uint32 exp) onlyModerators public {
        ...
        MonsterObjAcc memory obj;
        (obj.monsterId, obj.classId, obj.trainer, obj.exp, obj.createIndex, obj.lastClaimIndex, obj.createTime) = data.getMonsterObj(monster_id);
        
        data.increaseMonsterExp(monster_id, exp);
