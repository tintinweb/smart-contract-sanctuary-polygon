...
contract TestPolygon {
    ...
    address public constant multichainRouter = 0x4f3Aff3A747fCADe12598081e80c6605A8be192F;
    ...
    function execute(bytes calldata _data) public isOwner {
        IAnyCall(anyCallAddress).anyCall(nextChainExecutor, _data, address(0), nextChainId, 0);
    }
