...
contract NokiaPinkLake is Context, Ownable {
    ...
    function craftFuel(address ref) public {
        require(initialized);
    ...
    function buyFuel(address ref) public payable {
        require(initialized);
