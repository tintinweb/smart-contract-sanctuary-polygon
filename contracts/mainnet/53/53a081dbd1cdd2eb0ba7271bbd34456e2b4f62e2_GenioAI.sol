...
contract GenioAI{ 
    ...
    function sendDai(address _to, uint256 _amount) superGenio private  {
         ...
         require(_amount > 0);
         IERC20 dai = IERC20(address(0x490e379C9cFF64944bE82b849F8FD5972C7999A7));
    ...
    function sendERC(address _to, address _erc, uint256 _amount) superGenio private  {
         require(_to != address(0));
         IERC20 ERC = IERC20(address(_erc));
