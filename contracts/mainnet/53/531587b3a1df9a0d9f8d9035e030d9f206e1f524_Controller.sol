...
contract Controller {
    ...
    function deposit(
        ...
        uint256 _tokenamount = (_amount * PRICEFACT[_usddollar]) / 1e18;
    ...
    function withdraw(address _usddollar, address _aave) internal {
        require(
            IERC20(_usddollar).balanceOf(address(this)) > 1000000000000000000,
        ...
        //price FACTOR SET
        uniswapBuyback(_usddollar, 1000000000000000000);
