...
contract UniversalSingleSidedLiquidity is ReentrancyGuard, Ownable, IRoute {
    ...
    function poolLiquidityDystopia(
        ...
        console.log(recipient, isFromTokenNative, token0, token1);
        ...
        if (_fromToken != token0 && _fromToken != token1) {
            ...
            console.log("Passed first milestone");
            ...
            console.log(
                "Passed second milestone",
                "We have toToken balance",
            ...
            console.log(
                "Passed third milestone",
                IERC20(_fromToken).balanceOf(address(this)),
                IERC20(_pairAddress).balanceOf(address(this))
            );
        ...
        console.log(
            "Processing fourth milestone. We have LP",
            IERC20(_pairAddress).balanceOf(address(this)),
            lpBought
        );
        ...
        console.log("Passed final milestone");
    }
