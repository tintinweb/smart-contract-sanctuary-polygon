...
contract OANNES is Context, IERC20, Ownable {
    ...
    string private _name = "OANNES";
    string private _symbol = "OANNES";
    ...
    uint256 public _treasuryFee = 200; // 2%
    ...
    uint256 public numTokensSellToAddToLiquidity = 5000 * 10**8;
    uint256 public minNumTokensSellToAddToLiquidity = 50 * 10**8;
