...
contract TokenCondensor is BaseSiloAction {
    constructor(string memory _name, address _siloFactory) {
        name = _name;
        metaData = "address[4],address[4],address,address[][4]";
        ...
        returns (uint256[4] memory outputAmounts)
    {
        ...
        //         configuration,
        //         (address[4], address[4], address, address[][4])
        //     );
        ...
        )
    {
        ...
        // console.log("############## directTokenCondense   inputAmounts0: %s  inputAmounts1: %s", inputAmounts[0],inputAmounts[1]);

        // console.log("############## directTokenCondense   inputAmounts2: %s  inputAmounts3: %s", inputAmounts[2],inputAmounts[3]);
        ...
        // console.log("############## directTokenCondense   outputAmounts0: %s  outputAmounts1: %s", outputAmounts[0],outputAmounts[1]);

        // console.log("############## directTokenCondense   outputAmounts2: %s  outputAmounts3: %s", outputAmounts[2],outputAmounts[3]);
        ...
        if (amountOut > 0) {
            ...
            if (amountOut > 0) {
                ...
                if (amountOut > 0) {
                    ...
                    amountOut = oracle.getUniPrice(router, path3, amountIn);
                    if (amountOut > 0) {
                        (amounts, result) = swapTokens(
                            router,
                            path2,
        ...
        returns (bool)
    {
        ...
        //     exchanges = oracle.getExchanges(inputs[0], outputs[0]);
