...
contract StrategyUsdcUsdtUniV3StakerPoly is StrategyRebalanceStakerUniV3 {
  ...
  constructor(
    ...
    public
    StrategyRebalanceStakerUniV3(priv_pool, _tickRangeMultiplier, _governance, _strategist, _controller, _timelock)
  {
...
abstract contract StrategyRebalanceStakerUniV3 {
  ...
  /**
   * @notice  Set new incentives for the pool
   * @param   _rewardToken  tokens given as incentive
   * @param   _startTime  start time of the event
   * @param   _endTime  end time of the event
   * @param   _refundee  who receives the refund
   */
  ...
  /**
   * @notice  This assumes rewardToken == token0
  ...
  /**
   * @notice  Need to call this at end of Liquidity Mining This assumes rewardToken is token0 or token1
   */
  ...
  /**
   * @notice Rebalance assets for liquidity and swpa if necessary
