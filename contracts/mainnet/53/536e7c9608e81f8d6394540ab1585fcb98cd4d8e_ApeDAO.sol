...
contract OwnableMATIC is Context {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableMATIC: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableMATIC: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract ApeDAO is Context, MATICNFT, OwnableMATIC {
    ...
    string private _name = 'ApeDAO';
    string private _symbol = 'APEDAO';
