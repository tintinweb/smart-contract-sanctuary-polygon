 ...
 * @title CachedNFT
 * @dev CachedNFT is a ERC721 token that extends the OpenZeppelin ERC721 standardß
 */
contract CachedNFT is Ownable, ERC721 {
    using Strings for uint256;
    ...
    string public baseURI =
        "ipfs://QmT33U25LMgc8Wg4huxMXkhXHZ8PjnK2Czjw3igqS2a3Wa/";

    // Constructor
    constructor() ERC721("CachedNFT", "CACHED") {}

    // Event emission on mint
    event Minted(address indexed _address, uint256 indexed _tokenId);
    ...
    function mint(address _addr) public onlyOwner {
        ...
        _safeMint(_addr, totalSuply);
        emit Minted(_addr, totalSuply);
    }
    ...
    function tokenURI(
        ...
        if (!_exists(_tokenId)) revert NonExistantToken(_tokenId);
        return baseURI;
    }
}