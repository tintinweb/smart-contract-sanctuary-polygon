...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
    ...
    // Other constants
    uint256 public constant underlyingPoolId = 6;
        ...
        )
    {
        ...
        rewardToFarmTokenPath0 = new address[](3);
        rewardToFarmTokenPath0[0] = rewardTokenAddr;
        rewardToFarmTokenPath0[1] = farmToken1Addr;
        rewardToFarmTokenPath0[2] = farmToken0Addr;

        // Token1 is equal to token reward
        rewardToFarmTokenPath1 = new address[](2);
        rewardToFarmTokenPath1[0] = rewardTokenAddr;
        rewardToFarmTokenPath1[1] = farmToken1Addr;
    }
    ...
    function harvest() public override nonReentrant {
        ...
        if (_rewardBalance > harvestCutoffBps) {
            ...
            // We don't need to swap for the token1
            // Since token1 is acquired via the rewardToken
            // Calculate the amount to swap for the farm token.
...
contract StrategyTwoAssets is StrategyFarmTwoAssets {
    ...
    address public FARM_MASTER_CHEF =
        0x9682D175830643658798ac3367915e57bDdB506A;
    address public LP_TOKEN = 0xC8Ecb75D92De09fF8E7f4D93675E253eC6B08519;
