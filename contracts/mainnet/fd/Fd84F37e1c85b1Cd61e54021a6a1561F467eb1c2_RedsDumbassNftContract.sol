...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xF8cDA941245af8755769F060FaE28D0DD23067Ce];
  address public erc20Payable = 0xF8cDA941245af8755769F060FaE28D0DD23067Ce;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 1977) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiayi5b2mmpx5xxujgoqdqqtm3z5xmuvdsppfwsec5qecfapg4zdey/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/F5I9NEkVIEd4BDW9M3Il/contract-metadata";
  }
...
// File: contracts/RedsDumbassNftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract RedsDumbassNftContract is ERC721APlus {
    constructor() ERC721APlus("Reds Dumbass NFT", "DUMB"){}
}
