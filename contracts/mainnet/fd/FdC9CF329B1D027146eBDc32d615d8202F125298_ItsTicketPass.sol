...
//File： fs://19ed1ed8957a454b9ff659c6f13564ad/ItsTicketPass.sol
...
contract ItsTicketPass is ERC1155, Ownable {
    ...
    address[] addressMintedBalance;
    uint256[] addressMintedBalanceToken;

    mapping(address => address) private walletsOwner;

    constructor() ERC1155("https://ipfs.io/ipfs/QmUMCbap8CmNb4S8hSh7Dx2Xi5vagsByHBPs1Jg7yfZfF8") {
        _contractUri = "https://ipfs.io/ipfs/QmcZvKyHx8U3c7tQchoSYXDhsuPikWLCjhqbKTFjaYkePa";
        _contractOwner = msg.sender;
        _name = "Its Ticket Pass";
        _symbol = "ITP";
    ...
    function airDrop(
        ...
        addressMintedBalance.push(endUser);
        addressMintedBalanceToken.push(Id);
        
        _mint(endUser, Id, _mintAmount, "");
    ...
    {
        return (addressMintedBalanceToken, addressMintedBalance);
    }
    ...
    function burn(address wallet, uint256 tokenId, uint256 amount) external onlyOwner {
