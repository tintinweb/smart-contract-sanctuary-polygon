...
contract Skulloids is ERC721PresetMinterPauserAutoId {

    string private constant NAME = "Skulloids";
    string private constant SYMBOL = "SKULLOIDS";
    ...
    function _minterRoleHash() internal view override returns (bytes32) {
        return _rolesManagerConsts().SKULLOIDS_MINTER_ROLE();
    }
    ...
    function _beforeTokenTransfer(
        ...
        require(
            _getPlatformSettingsValue(_settingsConsts().SKULLOIDS_PAUSED()) == 0,
