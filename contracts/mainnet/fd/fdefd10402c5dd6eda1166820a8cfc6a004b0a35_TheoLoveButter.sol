...
contract TheoLoveButter is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Theo Love Butter", "THEO") {
    setHiddenMetadataUri("ipfs://QmUsrgTXoCHpgMgENUdJDNtUH9Bp3m98gW9hz7iQ3bsFZq/hidden.json");
  }
