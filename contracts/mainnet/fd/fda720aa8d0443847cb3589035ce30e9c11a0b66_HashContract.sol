...
// Use this to create a hashed password.
contract HashContract {
    ...
    function getHash() public view returns(bytes32) {
        ...
        require(msg.sender == getAddressFromHash(userHashes[msg.sender]), "Caller cannot access this hash");
        return userHashes[msg.sender];
    }
    
    function getAddressFromHash(bytes32 hash) private pure returns(address) {
