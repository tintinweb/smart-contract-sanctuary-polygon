...
contract BLACKWOLF is Context, Ownable, IERC20 {
  ...
  string private _name = "BLACK WOLF";
  string private _symbol = "BWF";

  uint8 private _decimals = 18;
  uint256 private _totalSupply = 1000000000000 * 10**_decimals; // 1 000 000 000 000
  uint256 public periodDuration = 1 days;
  uint256 public minTokensForLiquidityGeneration = _totalSupply / 10000; // 0.001% of total supply
  ...
  */
  ...
  uint16 public sellLiquidityFee = 100; // sell liquidity fee 1%
  uint16 public buyLiquidityFee = 100; // buy liquidity fee 1%
