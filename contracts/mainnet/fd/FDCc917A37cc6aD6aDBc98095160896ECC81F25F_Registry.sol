...
contract Registry is IRegistry, Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function setFuelDistributor(address _fuelDistributor) external isContract(_fuelDistributor) onlyOwner {
        emit UpdateFuelDistributor(address(fuelDistributor), _fuelDistributor);
