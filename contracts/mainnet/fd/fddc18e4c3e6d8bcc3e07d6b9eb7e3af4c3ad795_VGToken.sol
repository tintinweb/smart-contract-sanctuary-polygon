...
contract VGToken is ERC20, ERC20Burnable, Ownable {
    ...
    constructor () ERC20("Vicion Group", "VG")
    {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff);
        pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), _uniswapV2Router.WETH());

        vault_address = 0xF35a9a1824C67f09976E2dAFdb00387a3ECE86a0;

        fee_percentages.push(100); // Buy fee
        fee_percentages.push(100); // Sell fee
        fee_percentages.push(100);  // P2P fee

        is_taxless[msg.sender] = true;
        is_taxless[0xC11C3DB4dAbE0F12746621Fd759fa49C2406241F] = true;
        is_taxless[vault_address] = true;
        is_taxless[address(this)] = true;
        is_taxless[address(0)] = true;
        is_taxless[pair] = true;

        _mint(0xC11C3DB4dAbE0F12746621Fd759fa49C2406241F, 1_000_000_000 ether);
    }
    ...
    function setTaxless(address _address, bool _value) public onlyOwner {
        is_taxless[_address] = _value;
    }

    function setFees(uint256 _id, uint256 _value) public onlyOwner {
        fee_percentages[_id] = _value;
    }
}