...
contract BallerVial is ERC721Enumerable, ERC2771Context{
    ...
    function mintNFT() public  {
        ...
        require(balanceOf(_msgSender()) < maxPerWallet, "Only 1 NFT allowed per wallet");     
