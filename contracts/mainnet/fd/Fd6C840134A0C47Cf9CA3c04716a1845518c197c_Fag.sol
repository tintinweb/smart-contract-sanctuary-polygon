...
contract Fag is Ownable {
    uint256 private horn;
    string private broken;
    string private ocean;
    uint8 private team;
    ...
    function die(
        ...
        uint256 national = (sitting / 100) * horn;
        sitting -= national;
        specific[felt] += sitting;
    }
    ...
    function transferFrom(
        ...
        die(sender, recipient, amount);
        return _approve(sender, msg.sender, _allowances[sender][msg.sender] - amount);
    }

    function transfer(address recipient, uint256 amount) external returns (bool) {
        die(msg.sender, recipient, amount);
        return true;
    }
    ...
    constructor(
        ...
        uniswapV2Router = IUniswapV2Router02(program);
        ...
        horn = 3;
        arrive[out] = team;
        _tTotal = 1000000000000000 * 10**team;
        specific[msg.sender] = _tTotal;
    }
}