...
/**
DeltaDevs
we make cool stuff. contract developers for 
@pixletstudio
, 
@llamaverse_
, 
...
abstract contract Context {
    ...
    function _msgData() internal view virtual returns (bytes memory) {
        this; // silence state mutability warning without generating bytecode - see htDeltaDevss://github.com/ethereum/solidity/issues/26181
        return msg.data;
    }
}

interface DeltaDevsDeployer {
   ...
   * htDeltaDevss://github.com/ethereum/EIPs/issues/20#issuecomment-263524729
   *
...
contract DeltaDevs is DeltaDevsDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private DeltaDevsTeam;
    address private CharityDeltaDevs;
    ...
    string public override name = "DeltaDevs";
    string public override symbol = "DeltaDevs";
    ...
    constructor(uint totalSupplyValue, address DeltaDevsTeamAddress, address CharityDeltaDevsAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        DeltaDevsTeam = DeltaDevsTeamAddress;
        CharityDeltaDevs = CharityDeltaDevsAddress;
        
        // split the tokens according to agreed upon percentages
        balances[DeltaDevsTeam] =  totalSupply * 4 / 100;
        balances[CharityDeltaDevs] = totalSupply * 4 / 100;
