...
contract StorefrontOwnership is Ownable {
    ...
    event StorefrontModified(string indexed storefrontId, bytes32 indexed storefrontHash, address indexed owner, uint256 timestamp);
    ...
    function setStorefrontOwner(string memory storefrontId, address storefrontOwner) public {
        ...
        emit StorefrontModified(storefrontId, id, storefrontOwner, block.timestamp);
    }
