    ...
    ContextMixin
{
     ...
     */
    function makeUnrecallable(uint256 _tokenId) public virtual {
 ...
 */
contract SanLeandroCDJR is ViciERC721v4 {
    constructor()
        ViciERC721v4(
            "San Leandro CDJR",
            "SLCDJR",
    ...
    {
        setContractURI(
            "https://storage.googleapis.com/arrival-shadow-motion-newman/vici/vinpass/vinpass.json"
        );
    }

    function maxRecallPeriod() public view virtual override returns (uint256) {
        return
            0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF;
    }
