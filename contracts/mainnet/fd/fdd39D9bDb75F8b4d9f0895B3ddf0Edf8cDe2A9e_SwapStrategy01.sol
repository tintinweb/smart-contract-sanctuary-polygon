...
contract SwapStrategy01 is ISwapStrategy01 {    
    ...
    mapping(string => address[]) public coinPath;
    ...
    constructor() {
        ...
        longPath(coin["DAI"],"DAI");
        longPath(coin["WBTC"],"WBTC");
        longPath(coin["USDC"],"USDC");
        ethPath();
    }
    function longPath( address Coin, string memory coin_name) private {
        address[] memory path = new address[](3);
        path[0] = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270;
        path[1] = 0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619;
        path[2] = Coin;
        coinPath[coin_name] = path;
    }
    function ethPath() private {
    ...
    function swapTo( string memory Coin, uint256 _amountIn ) public override returns(uint256 amountOut) {
        ( amountOut ) = swapByIndex03( _amountIn, 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506, coinPath[Coin] );
    }
