...
/** 
    ...
    @dev This contract helps people swap unsellable tokens to the TAX token on Polygon network.
...
contract CryptoTaxReducer is Ownable {
    ...
    constructor(address taxTokenAddr) {
        usdcFee = 15 * 10 ** 6; // Initial fee set to 15 USDC.
        usdc = IERC20(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174); // USDC on Polygon.
