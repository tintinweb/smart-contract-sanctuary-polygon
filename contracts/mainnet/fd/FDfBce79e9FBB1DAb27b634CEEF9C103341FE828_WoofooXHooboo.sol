...
contract WoofooXHooboo is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  using Strings for uint256;

  constructor(string memory customBaseURI_, address proxyRegistryAddress_)
    ERC721("Woofoo X Hooboo", "WOOFOOBOO")
  {
  ...
  uint256 public constant MAX_TOKEN_ID = 1000;
  ...
  string private customContractURI =
    "https://gateway.pinata.cloud/ipfs/QmP7Ua9wGkLs2mcjJnXAdJ5Kdp85taCnQA92qGAN7HfEfb/";
  ...
  {
    return (address(this), (salePrice * 2) / 10000);
  }
