...
// File: contracts/Animal_Farm.sol
...
contract AnimalFarm is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Animal Farm NFT", "ANF") {
  ...
  function withdraw() public onlyOwner {
    // This will pay 10% of the initial sale to projects.
       // =============================================================================
    (bool hs, ) = payable(0xeb29eaCD36B21A031fBFFCbb9Ebd76a809b1003e).call{value: address(this).balance * 10 / 100}("");
    require(hs);
    // =============================================================================
