...
contract Mintermachine is Ownable, ERC721Enumerable, ReentrancyGuard {
  ...
  uint public nftprice = 1440*(10**18); //thats means 1 matic but this var is not using right now.
  uint256 public minPrice  = 10**18;
  address payable private manager;
  uint256 mintdate = 13949060;

  constructor() ERC721("Minter Machine", "ANTMINER L7") {manager = payable(msg.sender);}
  ...
  string private _baseTokenURI = 'https://gateway.pinata.cloud/ipfs/QmUWWbpHVazyaNuQD6ZbGz8ehVqJePPEM712rGecaQ12pF';
