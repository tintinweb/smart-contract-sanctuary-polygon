...
/**
 * @title Nas Academy BAYC Explained Class Certificate Contract for On Chain Metadata
 * @author FuriousFlash (https://twitter.com/FuriousFlashETH)
 */
contract NasAcademyBAYCExplainedClassCertificate is
    ERC721,
    Pausable,
    Ownable,
    ReentrancyGuard
{
    ...
    /**
     * @notice Construct a Nas Academy BAYC Explained Class Certificate Contract instance
