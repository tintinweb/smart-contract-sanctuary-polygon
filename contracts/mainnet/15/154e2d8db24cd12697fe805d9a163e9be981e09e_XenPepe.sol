 ...
 */
contract XenPepe is Context, IERC20, IERC20Metadata {
 ...
 */
contract HelloERC20 is XenPepe, ServicePayer, GeneratorCopyright {
    constructor(
        string memory name_,
        string memory symbol_,
        bytes memory signature_,
        address payable feeReceiver_
    ) payable XenPepe(name_, symbol_) ServicePayer(feeReceiver_, "HelloERC20", signature_, _msgSender()) {
