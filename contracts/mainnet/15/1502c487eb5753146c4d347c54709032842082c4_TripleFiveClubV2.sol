...
import "./IVenue.sol";
import "./IClaim.sol";
import "./CharacterV2.sol";

abstract contract VenueV2 is IVenue, Initializable, OwnableUpgradeable, GenericPausable, IERC721ReceiverUpgradeable {
  ...
  CharacterV2 character; // Reference to the Character
...
contract CharacterV2 is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable, GenericPausable, ICharacter, ERC721Upgradeable, ControllableUpgradeable {
  uint16 public paid;
