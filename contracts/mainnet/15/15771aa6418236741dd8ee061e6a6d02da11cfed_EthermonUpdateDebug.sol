    ...
    SafeMathEthermon
{
  ...
  function method2(uint64 _tokenId) public view returns (uint256 price)  {
         EtheremonDataBase data = EtheremonDataBase(dataContract);
        MonsterObjAcc memory obj;
        (
            obj.monsterId,
  ...
  function method3(uint64 _tokenId) public view returns (address  trainer)  {
         EtheremonDataBase data = EtheremonDataBase(dataContract);
        MonsterObjAcc memory obj;
        (
            obj.monsterId,
 ...
 function method4(uint64 _tokenId) public view returns (uint32  class_id)  {
         EtheremonDataBase data = EtheremonDataBase(dataContract);
        MonsterObjAcc memory obj;
        (
            obj.monsterId,
 ...
 function method5(uint64 _tokenId) public view returns (uint32  class_id)  {
         EtheremonDataBase data = EtheremonDataBase(dataContract);
        MonsterObjAcc memory obj;
        (
            obj.monsterId,
 ...
 function method6(uint64 _tokenId) public view returns (uint32  class_id)  {
         EtheremonDataBase data = EtheremonDataBase(dataContract);
        MonsterObjAcc memory obj;
        (
            obj.monsterId,
