 ...
 * @notice This contract handles minting Lut's nakamas tokens.
 */
contract LutsNakamas is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xceBb55C4bdC51ffA4c7b906F2CB92DaCC065e826;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x18CE9803a0B10158aD44C8AC076ce86275a957c1;
    address[] public payoutAddresses = [
        0x18CE9803a0B10158aD44C8AC076ce86275a957c1
    ];
    ...
    string public name = "Lut's nakamas";
    ...
    uint96 public royaltyFee = 1500;

    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeifz5qd3eb7pd6lnx5h25jfokn7w4ard5e6urlhumnhkzvj2dhnsyy/{id}"
        )
        RevokableOperatorFilterer(
