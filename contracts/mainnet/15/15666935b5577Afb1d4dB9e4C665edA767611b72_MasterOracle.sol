...
contract MasterOracle is Ownable {
    ...
    constructor(
        ...
        require(_dollar != address(0), "MasterOracle::constructor: Invalid dollar address");
        require(_share != address(0), "MasterOracle::constructor:Invalid share address");
        require(_shareEthPairOracle != address(0), "MasterOracle::constructor: Invalid shareEthPairOracle address");
        require(_dollarUsdcPairOracle != address(0), "MasterOracle::constructor:Invalid dollarUsdcPairOracle address");
        require(_usdcToUsdChainlink != address(0), "MasterOracle::constructor: Invalid usdcToUsdChainlink address");
        require(_ethToUsdChainlink != address(0), "MasterOracle::constructor: Invalid ethToUsdChainlink address");
