...
contract ZapAnalyzer is IZapAnalyzer {
        ...
        returns (SwapReturns memory returnValues)
    {
        ...
        returnValues.minAmountSwap1 = vars.inputToken == vars.token0
            ? 1e18
            : getWeightedPrice(params.swapPath0, returnValues.swapToToken0, true);
        returnValues.minAmountSwap0 = vars.inputToken == vars.token1
            ? 1e18
            : getWeightedPrice(params.swapPath1, returnValues.swapToToken0, true);
