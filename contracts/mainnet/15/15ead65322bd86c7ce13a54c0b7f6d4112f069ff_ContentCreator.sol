...
// File contracts/ContentCreator.sol
...
contract ContentCreator is ERC721, ERC721URIStorage, Ownable {
    ...
    function transferAfterRoyalty(
        ...
        require(
            msg.value == salePrice,
            "Transfer value must be equal to the sale price"
        );
        uint256 royaltyFee = (salePrice * royaltyPercentage) / 100;
        uint256 transferAmount = salePrice - royaltyFee;
        _transfer(msg.sender, buyer, tokenId);
        royaltyReceiver.transfer(royaltyFee); // Royalties go to the royaltyReceiver
