...
contract Swap is BaseContract {
  ...
  function testSell(uint _amount) external {
    ...
    uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(swappedToken, 0, path, msg.sender, block.timestamp);
  }
