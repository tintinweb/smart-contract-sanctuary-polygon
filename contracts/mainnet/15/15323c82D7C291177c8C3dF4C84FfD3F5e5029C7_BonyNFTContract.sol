...
contract  BonyNFTContract is ERC721Enumerable, ContextMixin, Ownable {
  using Strings for uint256;

  string baseURI = "ipfs://bafybeigoufpqwhqmuq6mjpozyrac3pe42rbuk3p5r7xkj4mbfqcwqwmdee/";
  ...
  constructor(string memory _initBaseURI) ERC721("BonyNFT", "BONY") {
