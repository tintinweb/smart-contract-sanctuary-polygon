...
// File: contracts/PassiveFund.sol
    ...
    contract Passive is ERC20, Ownable, ReentrancyGuard, Pausable {
        // Basic details
        ...
        modifier whenNotTerminated() {
            require(!terminated, "PassiveFund: Fund is terminated.");
            _;
        }
        ...
        function pause() external whenNotPaused whenNotTerminated {
            require(
                ...
                "PassiveFund: Only allowed to Pauser"
            );
            _pause();
        }
        ...
        function revertInvestment() external nonReentrant {
            require(terminated, "PassiveFund: Fund is not terminated yet");
        ...
        function updateComposits(
            ...
            // Validate shares
            {
                ...
                require(
                    ...
                    "PassiveFund: The length for swapping must be same."
                );
            }
            currencies = _currencies;
            shares = _shares;
