...
contract Richape  is Initializable, EIP712Upgradeable, ERC721EnumerableUpgradeable, OwnableUpgradeable {
  using StringsUpgradeable for uint256;

    string private constant SIGNING_DOMAIN = "Richape";
    ...
    function initialize() initializer public {
        __ERC721_init("Richape Mile", "R-M");
        __EIP712_init(SIGNING_DOMAIN, SIGNATURE_VERSION);
        __Ownable_init();
        baseExtension = ".json";
        baseURI = "http://127.0.0.1:1111/richape_assets/";
        notRevealedUri = "http://127.0.0.1:1111/richape_assets/prereveal.json";
        cost = 0.02 ether;
        maxSupply = 5711;
        maxMintAmount = 20;
    ...
    function testmint(uint256 _mintAmount) public payable{
