    ...
    ReentrancyGuardUpgradeable
{
    ...
    function withdrawEmergency(uint256 amount, uint256 index) public override nonReentrant {
        ...
        uint256 weightFactor = (_userVault.weight * 10**18) / _userVault.amount;
        _userVault.weight = _userVault.weight - ((amount * weightFactor) / 10**18);
        _totalWeightSupply = _totalWeightSupply - ((amount * weightFactor) / 10**18);
