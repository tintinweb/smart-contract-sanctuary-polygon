...
// File: contracts/testingbug.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract testingbug is
    ERC1155,
    Ownable,
    Pausable,
    ERC1155Supply,
    ...
    Allowlist
{
    ...
    string public name = "testing bug ";
    string public symbol = "testingbug";
    string public contractURI = "ipfs://bafyreid4mjyb6qvjpofgmgytkigfvquzc2gp2oz6cxngpv2clhnsmgw2xm/metadata.json";
