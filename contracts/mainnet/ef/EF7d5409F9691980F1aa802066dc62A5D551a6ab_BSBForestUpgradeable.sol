...
contract BSBForestUpgradeable is Initializable, BSBBaseGameModeUpgradeable, VRFConsumerBaseUpgradeable {
    ...
    uint constant public notInTreeHouseYieldPenalty = 30;
    ...
    function _calculateDailyYieldWithBonus(
        ...
        return yield_ +
        percentageBonus * yield_ / 100 -
        (!tokenHouseAppartenance[collection_][tokenId_] ? notInTreeHouseYieldPenalty : 0) * yield_ / 100;
    }
    ...
    function _pickWinnerFromElites(
        ...
        EnumerableSetUpgradeable.UintSet storage gen0Elites = elites[opposingFaction_][gen0Address];
        EnumerableSetUpgradeable.UintSet storage gen1Elites = elites[opposingFaction_][gen1Address];
