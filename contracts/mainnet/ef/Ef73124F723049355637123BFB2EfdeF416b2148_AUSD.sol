...
contract AUSD is IERC20, Ownable {
    ...
    string public constant name = "AUSD";
    ...
    function setFeePercentage(uint8 feePercentage_) external onlyOwner {
        require(feePercentage_ <= 10, "ausd: transaction fee percentage exceeds 10");
        require(feePercentage_ >= 0, "ausd: transaction fee percentage equals 0");
