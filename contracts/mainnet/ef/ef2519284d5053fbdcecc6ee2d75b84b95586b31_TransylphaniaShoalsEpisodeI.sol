...
contract TransylphaniaShoalsEpisodeI  is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721( "Transylphania Shoals (Episode I)", "SHOAL") {
    setHiddenMetadataUri("ipfs://QmTPV196LL7QngCgQxk6C8xhkZ5Ce2F8VBBxZqJ7NZSLAj/hidden.json");
  }
  ...
  function withdraw() public onlyOwner {
    // This will pay Morgandy 10% of the initial sale.
    // You can remove this if you want, or keep it in to support HashLips and his channel.
    // =============================================================================
    (bool hs, ) = payable(0xfa844AD0bcE71A944f24d775Ac1Fd436F5d5Be9B).call{value: address(this).balance * 10 / 100}("");
    require(hs);
    // =============================================================================
