...
import "../Marketplace/TaxExchange.sol";
import "../ERC20/interfaces/IOperable.sol";

contract CruExchange is ReentrancyGuard, TaxExchange {
...
abstract contract CollateralWrapperExchange is
    Security2Base,
    DecimalUtils,
    CriticalTracer
{
    ...
    bool private isCollateralSet = false;
    ...
    function setCollateralAddress(
        ...
        require(!isCollateralSet, "Collateral is already set"); // 
...
import "@openzeppelin/contracts/token/ERC20/IERC20.sol";
import "./CollateralWrapperExchange.sol";
import "./../ISimpleStaking.sol";

import "hardhat/console.sol";

contract TaxExchange is CollateralWrapperExchange {
    uint256 tax = 5;
    ...
    constructor(
        ...
        IECDSASignature2 _signature,
        IUAC _uac
    ) CollateralWrapperExchange(_collateral, _signature, _uac) {
