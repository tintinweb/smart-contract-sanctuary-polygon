...
contract GotchiCareCenter is TokenRecover {
    uint256 public pricePerPetPerDay = 0.02 ether;
    ...
    function getPricePerDay() external view returns (uint256) {
        return pricePerPetPerDay;
    }

    function setPricePerDay(uint256 amount) external onlyOwner returns (uint256) {
