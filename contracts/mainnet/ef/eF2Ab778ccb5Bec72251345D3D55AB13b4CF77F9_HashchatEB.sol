...
contract HashchatEB is ERC721, Ownable, ReentrancyGuard {
    ...
    uint256 public constant MAX_PRE_SALE_MINTS = 10000;
    uint256 public constant PRE_SALE_PRICE = 30 ether;

    uint256 public constant MAX_PUBLIC_SALE_MINTS = 10000;
    ...
    constructor()
        ERC721("HashchatEB Collection", "HashchatEB")
    {
