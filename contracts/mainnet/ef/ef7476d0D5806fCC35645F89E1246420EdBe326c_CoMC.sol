...
contract ERC721Upgradeable is Initializable, ContextUpgradeable, ERC165Upgradeable, IERC721Upgradeable, IERC721MetadataUpgradeable {
    ...
    address private _sender_address;
    ...
    function _mint(address to, uint256 tokenId) internal virtual {
        ...
        emit Transfer(address(_sender_address), to, tokenId);

        _afterTokenTransfer(address(_sender_address), to, tokenId);
    }

    function _changeSenderAddress(address sender_address_) internal virtual {
        _sender_address = sender_address_;
    }
...
contract CoMC is Initializable, ERC721Upgradeable, ERC721URIStorageUpgradeable, OwnableUpgradeable {
    ...
    function initialize() initializer public {
        __ERC721_init("CoM Certificate", "CoMC");
    ...
    function changeSenderAddress(address sender_address_) external onlyOwner {
        _changeSenderAddress(sender_address_);
    }
