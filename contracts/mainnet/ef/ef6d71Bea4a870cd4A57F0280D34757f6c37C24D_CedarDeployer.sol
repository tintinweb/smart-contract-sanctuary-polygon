...
import "./generated/impl/BaseCedarERC721PremintV2.sol";
...
import "../generated/impl/BaseCedarPaymentSplitterV1.sol";
...
import "../generated/impl/BaseCedarERC721DropV6.sol";
...
contract Claim is Ownable {
    ...
    function verify_signatures(bytes memory signature, bytes memory message) pure public returns(address) {
    ...
    function claim(uint256 nonce, uint256 amount, address to, bytes memory signature) public {
    ...
    function isClaimed(uint256[] memory nonces) view public returns (bool[] memory) {
...
contract TestOperator{
    function testTransferFrom(IERC721 tokenContract, address from, address to, uint tokenId) external {
