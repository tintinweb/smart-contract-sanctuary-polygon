...
contract KYCVerify is Initializable, ContextUpgradeable {
    ...
    modifier onlyKyCVerifierRole() {
        if (!MarketRegistry(_marketRegistry).hasKYCVerifierRole(_msgSender())) {
            revert AmberfiLib.KYCVerify_NotKYCVerifier();
        }
        _;
    }
        ...
        initializer
    {
        if (marketRegistry_ == address(0)) {
            revert AmberfiLib.KYCVerify_ZeroAddress();
        }
    ...
    function requestAccountVerify() external {
        emit AmberfiLib.AccountVerifyRequested(_msgSender());
    }
    ...
    function setTokenStatus(
        ...
        emit AmberfiLib.TokenStatusChanged(_msgSender(), account_, tokenId_, status_);
    }
        ...
        onlyKyCVerifierRole
    {
        ...
        emit AmberfiLib.AccountStatusChanged(_msgSender(), account_, status_);
    }
