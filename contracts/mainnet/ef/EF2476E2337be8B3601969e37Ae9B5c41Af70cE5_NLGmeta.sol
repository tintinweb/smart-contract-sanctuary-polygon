...
contract NLGmeta is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20FlashMint {
    constructor() ERC20("NLGmeta", "NMT") {
            _mint(msg.sender, 450000000000 * 10 ** decimals());
                }
