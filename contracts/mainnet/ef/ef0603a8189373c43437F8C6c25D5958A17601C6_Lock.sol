...
//        console.log("!deposit:devMultiplicator", _dep.devMultiplicator);
    ...
    function _claim(DepositInfo storage _dep, address _depUserAddress) internal returns (uint256 _reward) {
        ...
        // unlock starts - rewards stops
        // TODO: move to reward controller logic
//      if (rewardController.getUnlockSpeed(_depUserAddress) > 0) return 0;
...
//                IAuction(controller.getContractByRole("Auction")).removeUserFromDistribution(msg.sender);
            }
        }
...
interface IGovernanceToken is IERC20 {
    ...
    function unlock(address _userAddress) external returns(uint256 _unlockedAmount);
}
