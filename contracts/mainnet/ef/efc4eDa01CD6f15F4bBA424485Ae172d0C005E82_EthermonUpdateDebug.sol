...
// File: contracts/EthermonUpdateDebug.sol
...
interface EthermonRerollPriceDataInterface
 {
    function getEmonPriceFromOracle (uint32 _classId)
        ...
        returns (uint256);
         ...
         function getEmonPriceFromOracle1(uint32 _classId)
        external
        view
        returns (uint256);


           function getEmonPriceFromOracle2(uint256 eth)
        external
        view
        returns (uint256);
...
interface EtheremonUpdateDataInterface {
...
contract EthermonUpdateDebug is
    EthermonEnum,
    BasicAccessControl
    
{
    ...
    address public tradeDataContract; //TODO: Confirm with Idon if needed to place it.
    address public monsterNFT;
    address public updateData;
    ...
    function setContract(        address _updateData
,address _rerollPriceData)
        external
        onlyModerators
    {
    ...
    function method1(uint64 _tokenId) public view returns (uint256 price)  {
 ...
 function method11(uint32 class_id) public view returns (uint256 price)  {

        EthermonRerollPriceDataInterface rprice = EthermonRerollPriceDataInterface(rerollPriceData);
        
        uint256 finalPrice = rprice.getEmonPriceFromOracle1(class_id);
 ...
 function method22(uint256 eth) public view returns (uint256 price)  {

          EthermonRerollPriceDataInterface rprice = EthermonRerollPriceDataInterface(rerollPriceData);
        
        uint256 finalPrice = rprice.getEmonPriceFromOracle2(eth);
 ...
 function method5(uint256 eth) public view returns (uint256 price)  {

          EtheremonOracleInterface oi = EtheremonOracleInterface(oracleContract);
        
        uint256 emonPrice = oi.getEmonRatesFromEth(eth);
        return emonPrice;
  ...
  function method7(uint32 class_id) public view returns (uint256 price)  {
        
        EthermonRerollPriceDataInterface rprice = EthermonRerollPriceDataInterface(rerollPriceData);
        
        uint256 finalPrice = rprice.getEmonPriceFromOracle(class_id);
