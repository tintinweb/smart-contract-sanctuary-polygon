...
/**
 *Submitted for verification at PolygonScan.com on 23-02-2022
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd4a15681B696Dd5c5d80C4421C77326FaAA942E1;
...
contract HYNA is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x406584b3D8D56A36BbB1E8066725E995aAeF743F;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 20000000000000 * 10**18;
    uint256 public _tTotalSupply = 20000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Hyena Howls";
    string private _symbol = "HYNA";
    ...
    function Set_WETH(address _WETH) public onlyOwner {
        WETH = _WETH;
    }
    constructor () {
