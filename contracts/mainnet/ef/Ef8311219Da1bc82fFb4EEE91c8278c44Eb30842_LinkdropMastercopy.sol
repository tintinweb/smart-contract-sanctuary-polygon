...
contract LinkdropCommon is ILinkdropCommon, LinkdropStorage {
    ...
    */
    ...
    returns (bool)
    {
        ...
        require(_transferPattern == 0 || _transferPattern == 1, "UNKNOWN_TRANSFER_PATTERN");        
        owner = _owner;
        linkdropMaster = _linkdropMaster;
        isLinkdropSigner[linkdropMaster] = true;
        version = _version;
        chainId = _chainId;
        transferPattern = _transferPattern;
        initialized = true;
        return true;
    }
...
contract LinkdropERC20 is ILinkdropERC20, LinkdropCommon {
    ...
    */
    ...
    returns (bool)
    {
        ...
        if (_tokenAddress != address(0) && transferPattern != 1) {
            require
            (
