...
contract FalineArena16 is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public cost = 6.05 ether;
  ...
  constructor() ERC721("Faline Arena 16", "FA16") {
    setHiddenMetadataUri("ipfs://bafybeigkgnlbehymetkf4iduonbw5j64h7mtqc3qtwpcimm6mcfqke7i3y");
  }
