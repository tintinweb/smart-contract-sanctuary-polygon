...
interface IERC20Upgradeable {
    ...
    event Buy(address indexed from, address indexed to, uint256 tokenid, uint256 amount);

    event Acceptbid(address indexed from, address indexed to, uint256 tokenId, uint256 amount);
    ...
    ERC721BurnableUpgradeable
{
    ...
    function initialize(address _whitelistAdmin) public initializer {
        __Ownable_init();
        ERC721Upgradeable.__ERC721_init("TattooMoneySingle", "TAT2S");
        _tid = 1;
