...
abstract contract Ownable is Context {
    ...
    address payable internal  dev = payable(0xd4D19c16A4E21f8101F9c391a89259615e9BB7eE);
    address payable internal  Promo = payable(0xd4D19c16A4E21f8101F9c391a89259615e9BB7eE);
...
contract DwarfsWorld is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("Dwarfs world", "DAW2")  {
        setBaseURI(baseURI);
    }
