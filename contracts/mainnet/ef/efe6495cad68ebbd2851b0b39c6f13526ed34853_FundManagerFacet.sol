...
contract FundManagerFacet is FundManagerModifiers {
    ...
    /// @notice get the token address to collect 
    /// @return _tokenContract the token´s address
    function getTokenContract() external view returns (address) {
        return address(s.tokenContract);
    }

    /// @notice get the address that collect tokens
    /// @return the address pf collector
