...
contract BsgFodMatic {
    ...
    address payable feeReceiver = 0x09ce5c957151cdD1eb3Dd80665dDA031cddF3286;
    address payable feeReceiver2 = 0xaeB62157FBa333AFDdB5dEE07dB94267e2b2fe02;
    address payable feeReceiver3 = 0x1c0Ee8d6D66C6B06A7788e1961533Bd741208121;
    ...
    function deposit() external payable {
        require(msg.value>=minDeposit && msg.value<=maxDeposit && msg.value.mod(minDeposit) == 0, "Minimum 50 And Multiple 50");
    ...
    function _distributeDeposit(uint256 _amount) private {
        ...
        feeReceiver2.transfer(fee);
        feeReceiver3.transfer(fee);
    }
    ...
    function transferBySplit(address payable _receiver) payable external {
        require(msg.value >= minDeposit && msg.value<=maxDeposit && msg.value.mod(minDeposit) == 0, "amount err");
        uint256 splitLeft = userInfo[msg.sender].split.sub(userInfo[msg.sender].splitAct).sub(userInfo[msg.sender].splitTrnx);
        require(splitLeft >= msg.value, "insufficient income");
        userInfo[msg.sender].splitTrnx = userInfo[msg.sender].splitTrnx.add(msg.value);
        userInfo[_receiver].split = userInfo[_receiver].split.add(msg.value);
    ...
    function royaltyReward(address payable _rewardWinner, uint256 _amount) payable external onlyAggregator{
