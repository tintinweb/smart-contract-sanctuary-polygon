...
contract MockStaker is Owned {
  ...
  UserClaimableRewards public userClaimableReward;
    ...
    function claimAllRewards(address user) external returns (UserClaimedRewards[] memory) {
        if (msg.sender != owner && msg.sender != vault) revert Errors.InvalidFee();
...
contract MockVault is Owned {
    ...
    constructor(address _operator, address _swapRouter, address _tokenProxy, address _staker, address _feeToken) Owned(msg.sender) {
        operator = _operator;
...
contract GelatoScript is Script {
    ...
    function run() external {
        ...
        staker.setClaimableRewards(MockStaker.UserClaimableRewards(0x8f3Cf7ad23Cd3CaDbD9735AFf958023239c6A063, 31772877444427778));
        MockVault vault = new MockVault(0x223e2e64C2489754e0e2033a40952fbd9Bab353D, 0xDEF171Fe48CF0115B1d80b88dc8eAB59176FEe57, 0x216B4B4Ba9F3e719726886d34a177484278Bfcae, address(staker), 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174);
        ERC20(0x8f3Cf7ad23Cd3CaDbD9735AFf958023239c6A063).transfer(address(vault), 31772877444427778);
