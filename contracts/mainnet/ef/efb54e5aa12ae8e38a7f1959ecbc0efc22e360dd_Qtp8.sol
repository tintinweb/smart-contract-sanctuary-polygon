...
contract Qtp8 is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Qtp8", "Qt8") {
    setHiddenMetadataUri("ipfs://Qmen3BX6wpAk6JQgvjR378dV8imPotJvmouFnqWLGDeYWf/hidden.json");
  }
