...
contract WhahDudeCoin is ERC20, ERC20Burnable, Ownable {
  ...
  constructor() ERC20("Whahdude", "WDC") { 
...
contract WDStaking is Ownable, IERC721Receiver {
  ...
  mapping(uint256 => Stake) public vault; 
   ...
   constructor(WhahDude _nft, WhahDudeCoin _token) { 
    nft = _nft;
    token = _token;
  }
