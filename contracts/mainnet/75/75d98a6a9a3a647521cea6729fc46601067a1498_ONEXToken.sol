...
contract ONEXToken is ERC20, Ownable {
    ...
    uint256 public MINIMUM_MINT_FOR_REFERRAL = 1000 * 10 ** 18;
    uint256 public MAX_TOTAL_REWARDS = MAX_SUPPLY / 10; // 10% of MAX_SUPPLY
    uint256 public totalRewards = 0;
    mapping(address => address) public referrers;

    constructor() ERC20("OneX Token", "ONEX") {}
    ...
    function setReferralRewardPercent(uint256 _newPercent) external onlyOwner {
        REFERRAL_REWARD_PERCENT = _newPercent;
    }

    // Allow the contract owner to update the minimum mint for referral
    function setMinimumMintForReferral(uint256 _newMinimum) external onlyOwner {
    ...
    function unstake() public {
        ...
        uint256 stakingReward = (stakeInfo.amount *
            stakingRewardPercent) / 10000;
