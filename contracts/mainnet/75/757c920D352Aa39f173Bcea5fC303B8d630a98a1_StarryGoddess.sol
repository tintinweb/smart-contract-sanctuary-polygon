 ...
 * @notice This contract handles minting Starry Goddess tokens.
 */
contract StarryGoddess is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x1A3673dA3388CB6D1bd7b6c334Cb192adD817EF1;
    ...
    string public name = "Starry Goddess";
    string public symbol = "STARRYG";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeifrglqlzw55exfgi6zgdqurwsvxel6g45tkejz7dsdqmkqdrmme5e/{id}"
        )
        RevokableOperatorFilterer(
