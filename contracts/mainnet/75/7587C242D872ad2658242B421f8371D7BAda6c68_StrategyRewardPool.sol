...
// File contracts/UniswapInterfaces.sol
...
// File contracts/StrategyRewardPool.sol
...
contract StrategyRewardPool is StratManager {
    ...
    function withdraw(address account, uint256 share, uint256 totalShares) external {
        ...
        IERC20(want).safeTransfer(systemFeeRecipient, systemFeeAmount);
        IERC20(want).safeTransfer(treasuryFeeRecipient, treasuryFeeAmount);
    }
