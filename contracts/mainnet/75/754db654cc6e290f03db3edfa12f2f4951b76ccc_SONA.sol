...
contract SONA is ERC20, Pausable, ERC20Detailed {
    
	address teamWallet = 0x4c1b1567a0ef93Bce954Aa4E54af3A0fa3cabA44;
    address stakingWallet = 0x3576077459Fe0577906e6Fd7A0A03C1408B4F382;
    address partnerWallet = 0x3De7439632a9905858b139da6C0859Fbe37384Ff;
    address ecosystemWallet = 0x5Fa88bEEC1Db9cd8cE07cDe032FCE6BE35f3055d;
	...
	constructor() public ERC20Detailed("SONA", "SONA", 9) {  
	        
       
        totalCoins = 9999999 * 10 ** uint256(decimals());
        _mint(owner(), totalCoins); // total supply fixed at 9.999999 million coins
        
        ERC20.transfer(teamWallet, 500000 * 10 ** uint256(decimals()));  
        ERC20.transfer(stakingWallet, 5000000 * 10 ** uint256(decimals()));
        ERC20.transfer(partnerWallet, 1000000 * 10 ** uint256(decimals()));
        ERC20.transfer(ecosystemWallet, 3000000 * 10 ** uint256(decimals()));
