...
contract OmniCounter is NonblockingLzApp {
    ...
    function incrementCounter(uint16 _dstChainId, uint256 gas, address airdropReceiver) public payable {
        address toAirdrop;
        ...
        bytes memory adapterParams = abi.encodePacked(uint16(2), gas, uint256(1000), toAirdrop);
