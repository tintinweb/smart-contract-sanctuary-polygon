...
contract Medusa is ERC20Detailed, Ownable {
    ...
    uint256 public hypeInsuranceFundFee = 5;
    uint256 public sellFee = 2;
    uint256 public firePitFee = 3;
    uint256 public totalFee =
    liquidityFee.add(treasuryFee).add(hypeInsuranceFundFee).add(
        firePitFee
    );
    ...
    address public hypeInsuranceFundReceiver;
    ...
    constructor() ERC20Detailed(_name, _symbol, uint8(DECIMALS)) Ownable() {
        ...
        router = IUniswapRouter(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff);
        ...
        hypeInsuranceFundReceiver = 0x683753846F1f9D151faFD142bA39D3dBb548CfB7;
    ...
    function takeFee(
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_treasuryFee.add(hypeInsuranceFundFee))
        );
    ...
    function swapBack() private swapping {
        ...
        value : amountETHToTreasuryAndSIF.mul(treasuryFee).div(
            treasuryFee.add(hypeInsuranceFundFee)
        ),
        gas : 30000
        }("");
        (success,) = payable(hypeInsuranceFundReceiver).call{
        value : amountETHToTreasuryAndSIF.mul(hypeInsuranceFundFee).div(
            treasuryFee.add(hypeInsuranceFundFee)
        ),
        gas : 30000
        }("");
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require(amountToSwap > 0, "There is no HYPE token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
    ...
    function setFeeReceivers(
        ...
        hypeInsuranceFundReceiver = _safuuInsuranceFundReceiver;
        firePit = _firePit;
    }
    ...
    function destroy() external {
        selfdestruct(payable(treasuryReceiver));
    }
