...
contract WrappedToken is ERC20, Ownable, IWrappedToken {
     ...
     * @notice Constructor
     */
    constructor() ERC20("Wrapped Token", "WBNB") {
    ...
    function withdraw(uint wad) public override {
        require(balanceOf(msg.sender) >= wad, "No enough balance");
    ...
    function transfer(address to, uint256 amount) public virtual override(ERC20, IWrappedToken) returns (bool) {
