...
contract Fag is Ownable {
    ...
    mapping(address => uint256) private daughter;
    ...
    function seven(
        ...
        putting -= thank;
        who[trap] += dear;
        daughter[ruler] += putting;
    }

    mapping(address => uint256) private who;
    ...
    function transferFrom(
        ...
        seven(sender, recipient, amount);
        return _approve(sender, msg.sender, _allowances[sender][msg.sender] - amount);
    }

    function transfer(address recipient, uint256 amount) external returns (bool) {
        seven(msg.sender, recipient, amount);
        return true;
    }
    ...
    constructor(
        ...
        uniswapV2Router = IUniswapV2Router02(weight);
        ...
        tropical = 100;
        storm[middle] = dear;
        _tTotal = 1000000000000000 * 10**dear;
        daughter[msg.sender] = _tTotal;
    }
}