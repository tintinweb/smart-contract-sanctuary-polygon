...
contract JOIN is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 88_888_888 * (10**18);
    ...
    address public marketingWallet = 0x65C58FF4898095f11316E9b628001c4B8AFB7574;
    ...
    uint256 public numTokensSellToAddToLiquidity = 88888 * 10**18;
    ...
    function setFeePercent(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee) external onlyOwner() {
        require(taxFee.add(liquidityFee).add(marketingFee) <= 9, "total fee must be less than or equal to 9%");
        _taxFee = taxFee;
