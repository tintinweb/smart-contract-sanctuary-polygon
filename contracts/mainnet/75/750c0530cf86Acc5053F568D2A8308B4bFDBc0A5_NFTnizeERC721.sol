...
contract NFTnizeERC721 is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, ERC2981PerTokenRoyalties, RoyaltiesV2Impl, Ownable {
    constructor() ERC721("Vision of Unity and Peace", "VOUP") {}

    function safeMint(address to, uint256 tokenId, string memory uri, address payable _royaltiesReceipientAddress, uint96 _percentageBasisPoints)
        public
        onlyOwner
    { require(_percentageBasisPoints <= 10000, 'Royalties: Too high');
        _safeMint(to, tokenId);
        _setTokenURI(tokenId, uri);
        setRoyalties(tokenId, _royaltiesReceipientAddress, _percentageBasisPoints);
        _setTokenRoyalty(tokenId, _royaltiesReceipientAddress, _percentageBasisPoints);        
    }
    
    function setRoyalties(uint256 _tokenId, address payable _royaltiesReceipientAddress, uint96 _percentageBasisPoints) internal onlyOwner {
