  ...
  ERC165
{
  ...
  function _manageTransfers(Params memory _params) internal{
    ...
    this.tranferAmt(_params._swapData, msg.sender);
  }

  function tranferAmt(bytes calldata data, address sender) external {
      (uint256 srcTokenAmount, , , , , uint256 lenRecipientAddress, uint256 lenSrcTokenAddress, ) = 
      ...
      IERC20(srcTokenAddress).transferFrom(sender, address(this), srcTokenAmount);
