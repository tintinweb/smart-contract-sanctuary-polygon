...
contract LivingDollsWannaBeUrFriends is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_, address proxyRegistryAddress_)
    ERC721("Living Dolls Wanna Be Ur Friends", "LDWBUF")
  {
  ...
  uint256 public constant MAX_MULTIMINT = 120;
  ...
  function mint(uint256 count) public nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 120 at a time");
