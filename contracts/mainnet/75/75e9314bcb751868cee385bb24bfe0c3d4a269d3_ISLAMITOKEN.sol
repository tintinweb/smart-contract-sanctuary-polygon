...
/**
 * ISLAMITOKEN Official smart contract / Date: 14/03/2022
 * 
 * Website: https://ISLAMITOKEN.finance
 * 
 * Official Social Accounts for ISLAMITOKEN
 * 
 * 
 * Email: [email protected]
 * Facebook: https://facebook.com/ISLAMITOKEN
 * Twitter: https://twiter.com/ISLAMITOKEN
 * Reddit: https://www.reddit.com/r/ISLAMITOKEN
 * Youtube: https://www.youtube.com/channel/UCPdg9Cx2g9DyTR_xD5S_lXA
 * Discord: https://discord.gg/5Ya8gDwaUr
 * Telegram: https://t.me/ISLAMITOKEN1
 * Instagram: https://www.instagram.com/ISLAMITOKEN
 * LinkedIn: https://www.linkedin.com/company/ISLAMITOKEN
 */
...
abstract contract IslamiMatic is Ownable, IMatic, IMaticMetadata {
    ...
    function _mint(address account, uint256 amount) internal {
        require(_totalSupply < _finaltotalsupply, "ISLAMITOKEN Total Supply is 30 Billions Only");
 ...
 */
contract ISLAMITOKEN is IslamiMatic {
    ...
    uint256 internal tMint = 1725580799; // After 3 Years / "Team Mint"
    ...
    address AirDropAD = address(0x66c6A8974b2Fd41aB0ff49B2f14E316e50495cd5);   // AirDrop contract    
    address CharityAD = address(0x4f0E2747a8FC1EE1bcC39dB371DD75d4444f649a); // contract for charity
    
    
    constructor() IslamiMatic("ISLAMITOKEN", "ISLAMI", 0) payable {
        
        _mint(msg.sender,     7999999990  * sonbola);    // ISLAMITOKEN contract creator 
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        ...
        else if(balanceOf(address(this)) > givecharity) {        // if ISLAMITOKEN contract is not empty (ISLAMI Tokens)                                 
            super._transfer(sender,recipient, transferAmount);
 ...
 * 
 * 
 * Edited by: ISLAMITOKEN Developers
 */