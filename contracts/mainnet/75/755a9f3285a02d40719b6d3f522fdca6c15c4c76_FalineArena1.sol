...
contract FalineArena1 is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxSupply = 327;
  uint256 public maxMintAmountPerTx = 30;

  bool public paused = true;
  bool public revealed = false;

  constructor() ERC721("Faline Arena 1", "FA1") {
    setHiddenMetadataUri("ipfs://bafybeidbeyslpcozfb47mk754ltv5bzy36dpy2sbsebpopypldieobmboa");
  }
