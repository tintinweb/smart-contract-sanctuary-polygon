...
library Utils {
    ...
    */
    function wavefnNormalise(
        int256[2][] memory _wavefn
    ) public pure returns (DecomposedWaveFunction memory) {
    ...
    */
    function wavefnDenormalise(
        int256[2][] calldata _phase,
        int256 _amplitude
    ) external pure returns (int256[2][] memory) {
