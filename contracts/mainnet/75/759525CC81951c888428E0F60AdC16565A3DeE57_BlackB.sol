 ...
 * @notice This contract handles minting black b tokens.
 */
contract BlackB is
    ERC1155Supply,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x19673e8C88209Ee3c6c77c06CA84FD416FFDFC39;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x1F45bb64F6b5d64ebc227a6Bc22DbFaF49774882;
    address[] public payoutAddresses = [
        0x1F45bb64F6b5d64ebc227a6Bc22DbFaF49774882
    ];
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeieac5r3x7d2edwtrpjev6jw6obeswjjxxzlsvr6ibvsbel5szlvdm/{id}"
        )
        RevokableOperatorFilterer(
