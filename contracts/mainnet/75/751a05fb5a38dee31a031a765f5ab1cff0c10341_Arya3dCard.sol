    ...
    ERC2981
{
    ...
    string private _name = "Arya 3d NFT Card";
    string private _symbol = "Arya3dCard";
    ...
    constructor(address creator, uint256[] memory tokenID, string[] memory _tokenURI
    ) ERC721(_name, _symbol) {
        require( tokenID.length == _tokenURI.length,"Length mismatch");
        _setRoyalty(_msgSender(), 500);
        for(uint i = 0; i < tokenID.length; i++) {
        _mint(creator, tokenID[i]);
