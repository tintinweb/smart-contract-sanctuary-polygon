...
import "./ERC1155SelfMinter.sol";

contract ERC1155SelfMinterFactory {
    event CreatedTemplateERC1155SelfMinter(address addr);
    function createTemplate(
        ...
        ERC1155SelfMinter clone = new ERC1155SelfMinter();
        clone.initialize(_multisig, _token, _baseURI, _name, _symbol, _fees, tiersNumbers, limitPerWalletPerTier, starts, ends, merkleRoots, isTierPublic);
        emit CreatedTemplateERC1155SelfMinter(address(clone));
    }
}
