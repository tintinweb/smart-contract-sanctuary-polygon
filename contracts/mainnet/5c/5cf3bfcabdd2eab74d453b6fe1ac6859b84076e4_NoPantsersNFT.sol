...
// File: tests/NoPantsersNFT.sol

//SPDX-License-Identifier: MIT

/***************************************************************************************************************
 ...                               (●>●)                   _                   ('~')
(°з°)  _    _______    _______    __/____   (ᵔᴥᵔ)  _    _(•̪●)__    _(.-■-■    ┐__\|_┌_   ______      _(.-■-■
|  |  | |  |       |  |       |  |       |  |  |  | |  |       |  |       |  |       |  |    _ |    |       |
|   |_| |  |  ___  |  |    _  |  |   _   |  |   |_| |  |_     _|  |  _____|  |    ___|  |   | ||    |  _____|
|       |  | |▀-▀| |  |   |_| |  |  |_|  |  |       |    |   |    | |_____   |   |___   |   |_||_   | |_____
|  _    |  | |___| |  |    ___|  |       |  |  _    |    |   |    |_____  |  |    ___|  |    __  |  |_____  |
| | |   |  |       |  |   |      |   _   |  | | |   |    |   |     _____| |  |   |___   |   |  | |   _____| |
|_|  |__|  |_______|  |___|      |__| |__|  |_|  |__|    |___|    |_______|  |_______|  |___|  |_|  |_______|
***************************************************************************************************************/
...
contract NoPantsersNFT is ERC721, ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    uint256 public earlybirdCost = 0.02 ether;
    uint256 public earlybirdAmount = 1000;
    uint256 public displayAmount = 100;
    uint256 public maxMintAmount = 15;

    constructor(
        string memory _initBaseURI
    ) ERC721("NoPantser", "NOPANTSER") {
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        require(_mintAmount <= maxMintAmount, "Hey, mint amount is too large lol.");
    ...
    // Check your tokens.
    function getMyTokens(address _owner) public view returns (uint256[] memory)
    {
