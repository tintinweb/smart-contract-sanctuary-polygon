...
contract Mintermachine is Ownable, ERC721Enumerable, ReentrancyGuard {
  ...
  uint public nftprice = 350*(10**18); //thats means 1 matic but this var is not using right now.
  uint256 public minPrice  = 10**18;
  address payable private manager;
  uint256 mintdate = 13949060;

  constructor() ERC721("Minter Machine", "RTX 3090") {manager = payable(msg.sender);}
  ...
  string private _baseTokenURI = 'https://gateway.pinata.cloud/ipfs/QmPmHm7YxQE5TVNZyHqGpq7V5zDEjtatpCFaa7MJYmDXkF';
