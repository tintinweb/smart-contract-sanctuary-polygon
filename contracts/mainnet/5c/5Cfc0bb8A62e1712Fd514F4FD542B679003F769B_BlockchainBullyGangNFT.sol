...
contract BlockchainBullyGangNFT is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    function withdraw() public payable onlyOwner {
        (bool hs, ) = payable(0x2eFB17453c7563066D2F32b2Dff07e40909A17cE).call{value: address(this).balance * 5 / 100}("");
        require(hs);
