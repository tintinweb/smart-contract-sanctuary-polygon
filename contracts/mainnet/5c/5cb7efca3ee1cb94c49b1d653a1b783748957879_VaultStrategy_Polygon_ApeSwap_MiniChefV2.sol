...
abstract contract VaultStrategy_withPoolInfo is IVaultPoolInfo
{
    //========================
    ...
    ML_TransferHelper
{
    ...
    function takeWithdrawFee(address _user, uint256 _amount) private pure returns (uint256)
    {
    ...
    function takeRewardFee(address _compoundUser, uint256 _amount) private pure returns (uint256)
    {
    ...
    VaultStrategyV2
{
    ...
    SwapPath public rewardToToken0;
    SwapPath public rewardToToken1;
