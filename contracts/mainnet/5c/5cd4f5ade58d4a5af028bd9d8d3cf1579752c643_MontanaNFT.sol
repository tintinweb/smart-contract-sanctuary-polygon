...
/**
  Montana NFT is a dedication to farmers. An original collection of 5555 unique Montana frogs
  created by farmers son to build a just and prosperous community in technology empowerment.
  The word Montana is taken from the Latin name for "the Javanese Katak-tanduk", Megophrys montana. 
  The frog looks brave, sturdy and dignified and friendly with the farmers while looking for water sources for the rice fields.

  - Make Farmer's Dream Come True
*/
...
contract MontanaNFT is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
...
// ================== Variables Start =======================
  ...
  string public hiddenMetadataUri = "ipfs://QmVYNBb8WDK9aCdBT4nY1JSsywaBAxorXMYwRstAej3V9A/hidden.json";
...
// ================== Withdraw Function Start =======================
  ...
  function withdraw() public onlyOwner nonReentrant {
    // This will pay PeryogiLabs 5% of the initial sale.
    (bool rs, ) = payable(0x9Cb01913ff344b31870de1E7b62c4f11c2C44C43).call{value: address(this).balance * 5 / 100}('');
    require(rs);
