...
// File: contracts/Cap3CollectiveMultiPassContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract Cap3CollectiveMultiPassContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Cap3 Collective MultiPass";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/dwbw0P0KKAw9uxIStilZ/contract-metadata";
  }
