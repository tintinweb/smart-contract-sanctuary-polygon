...
contract BCANcoin is ERC20, ERC20Burnable, Ownable {

  mapping(address => bool) controllers;
  
  constructor() ERC20("BCANcoin", "BCAN") { }
...
contract BCANStaking is Ownable, IERC721Receiver {
  ...
  mapping(uint256 => Stake) public vault; 
   ...
   constructor(ERC721Enumerable _nft, BCANcoin _token) { 
    nft = _nft;
    token = _token;
  }
