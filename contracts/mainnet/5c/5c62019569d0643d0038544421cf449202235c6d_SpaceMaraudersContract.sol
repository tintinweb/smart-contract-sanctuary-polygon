...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmbaGTnzcQceyX9vmNHi1uQvTPgGqjhT9D9ggcJXVGRU4r/";
...
// File: contracts/SpaceMaraudersContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SpaceMaraudersContract is RamppERC721A {
    constructor() RamppERC721A("Space Marauders", "SPACE"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/O88ugZsMVFjcsNn7bSiH/contract-metadata";
    }
}
