...
/// @title ERC-20 Token for GMFTTT
contract GreenMetaFitTokenTestTarget is ERC20, ERC20Burnable, Ownable, ReentrancyGuard {
    address public gameContractAddress;
    
    /// maximum token allowed to be 1 Billion GMFTTT * decimals()
    uint256 public constant maxTokenSupply = 1e9*1e18;
    ...
    constructor() ERC20("Green Meta Fit Token Test Target", "GMFTTT") {
    }
    ...
    function setGameAddress(address _gameContractAddress) public onlyOwner {
    ...
    function mintTokens(uint256 tokenAmount) public onlyOwner{
        ...
        require(tokenAmount <= maxTokenSupply - totalSupply(), "Total supply can be a maximum of 1 Billion GMFTTT tokens");
