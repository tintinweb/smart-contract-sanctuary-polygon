...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new AfrofuturismUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        AfrofuturismUser721Token token = AfrofuturismUser721Token(address(addr));
...
contract AfrofuturismUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
