...
contract DFXSnapshot {
    ...
    IERC20 public constant DFX_BALANCER_LP = IERC20(0x2dbC9Ab0160087AE59474FB7bed95B9E808fA6bc);
    bytes32 public constant DFX_BALANCER_POOL_ID = 0x2dbc9ab0160087ae59474fb7bed95b9e808fa6bc0001000000000000000003db;
    ...
    function balanceOf(address _voter) public view returns (uint256) {
        ...
        // 40TEL/40DFX/20USDC Balancer LP
        uint256 blpAmount = DFX_BALANCER_LP.balanceOf(_voter);

        uint256 votePower = getAmountFromSLP(slpAmount) + getAmountFromBLP(blpAmount) + bareAmount;
    ...
    function getAmountFromBLP(uint256 _blpAmout) public view returns (uint256) {
        uint256 tokenSupply = DFX_BALANCER_LP.totalSupply();
