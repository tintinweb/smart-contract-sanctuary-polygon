...
*/
contract TitanLayers is AccessControlEnumerable, ERC1155URIStorage, Ownable, SignedTokenVerifier {
    using Strings for uint256;

    string constant NAME = "KOIOS Titan Layers";
    string constant SYMBOL = "TAL";
