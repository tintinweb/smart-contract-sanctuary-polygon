...
contract DeGems is VRFConsumerBaseV2, ERC721A, Ownable, ReentrancyGuard {
    ...
    bytes32 keyHash = 0x6e099d640cde6de9d40ac749b4b594126b0169747122711109c9985d47751f93; //polygon mainnet 200gwei key hash
    //bytes32 keyHash = 0xd89b2bf150e3b9e13446986e571fb9cab24b13cea0a43ea20a6049a85cc807cc; //local
    uint32 callbackGasLimit = 500_000;
    uint16 requestConfirmations = 3;
    string public baseTokenURI;
    string public baseTokenRemote = "https://polygon.degemerates.com/api/metadata?id=";
    ...
    uint256 private constant MIN_MINT_PRICE = 2 ether; // 0.1 Ether
    uint256 private constant INCREMENT = 1 ether;
    ...
    function getGemType(
        ...
        if (sentEther > MIN_MINT_PRICE) {
            diamondBoost = (sentEther - MIN_MINT_PRICE) / 2 ether;
        }
