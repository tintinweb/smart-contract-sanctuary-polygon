...
contract WShare is ERC20Burnable, Operator {
    ...
    /*
        ...
        - Allocate 4500 WSHAREs to DAO wallet for linear vesting
        - Airdrop 360 WSHAREs to Dev wallet
        - Allocate 4640 WSHAREs to Dev wallet for linear vesting
    */
    ...
    constructor(uint256 _startTime, address _daoFund, address _devFund) public ERC20("WSHARE", "WSHARE") {
        _mint(msg.sender, 2 ether);         // mint 2 Wlrs Share for initial pools deployment and Boardroom initialization
