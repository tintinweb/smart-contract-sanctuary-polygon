...
contract Marketplace is Tokens {
    ...
    function tokenURI(string memory tokenId) public view virtual returns (string memory) {
        return string(abi.encodePacked("https://us-central1-glorysmacks.cloudfunctions.net/metadata?tokenid=", tokenId));
    }
