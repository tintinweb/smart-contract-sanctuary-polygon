...
contract ONEXCoin is ERC20, Ownable {
    uint256 public MAX_SUPPLY = 100000000 * 10 ** 18;
    uint256 public MINT_PRICE = 0.0015 ether; // BNB has the same decimals as Ether
    uint256 public USDT_MINT_PRICE = 0.5 ether; // BSC USDT has the same decimals as Ether
    uint256 public REFERRAL_REWARD_PERCENT = 10;
    ...
    bool public isUSDTMintingEnabled = true;
    bool public isMintingEnabled = true;
    uint256 public mintTime;
    uint256 public RESTRICTED_TRANSFER_PERIOD = 30 days;

    constructor(address _initialOwner) ERC20("ONEX Coin", "ONEX") {
    ...
    uint256 public INCREMENTAL_DAILY_REWARD_PERCENT = 280;
    ...
    function setMaxStakingRewardPercent(
        uint256 _newPercent
    ) external admin {
