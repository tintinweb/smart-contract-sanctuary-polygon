...
contract OBOND is ERC20BurnableUpgradeable, Operator {
    /**
     * @notice Constructs the BOND Bond ERC-20 contract.
     */
    function __init_Token() public initializer {
        __ERC20_init("OBOND Token", "OBOND");
        createOperator();
    }
