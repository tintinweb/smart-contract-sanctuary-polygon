...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAc92FB16cD113056E1111302B4b4895356C1fE1D;
...
contract LUNAR is Context, IERC20, Ownable {
    ...
    address public _developmentWalletAddress = 0x4Da241aEE56D851b98abC894D741c091146c5db7;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 38000000 * 10**12;
    uint256 public _tTotalSupply = 38000000 * 10**12;
    ...
    function Set_Development_Wallet(address _developmentwallet) public onlyOwner {
        _developmentWalletAddress = _developmentwallet;
    }
    ...
    function Set_Swap_Router(address _swaprouter) public onlyOwner {
    ...
    constructor () {
        ...
        burn_address[0x0000000000000000000000000000000000000000] = true;
