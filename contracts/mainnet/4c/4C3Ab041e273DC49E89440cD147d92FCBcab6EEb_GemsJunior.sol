    ...
    ERC2981
{
    ...
    string private constant baseTokenURI = "https://arweave.net/";
    string private _name = "Gems Junior NFT";
    string private _symbol = "GJN";
    ...
    constructor(address admin, address _operator) ERC721(_name, _symbol) {
    ...
    function changeOperator(
        ...
        require(operator != address(0), " new operator is the zero address");
    ...
    {
        if (!isApprovedForAll(_creator, operator)) {
            _setApprovalForAll(_creator, operator, true);
        }
        _tokenId = _tokenIdTracker.current();
        require(_tokenId <= 17_500, "Limit exceeds");
