...
// File contracts/interfaces/IDaoStaking.sol
...
// File contracts/farms/DaoChef.sol
...
contract DaoChef is Ownable {
    ...
    IDaoStaking public rewardMinter;
    ...
    function setRewardPerSecond(uint256 _rewardPerSecond) public onlyOwner {
        require(_rewardPerSecond <= MAX_REWARD_PER_SECOND, "DaoChef::setRewardPerSecond: > MAX_REWARD_PER_SECOND");
        massUpdatePools();
    ...
    function setRewardMinter(IDaoStaking _rewardMinter) external {
        require(address(rewardMinter) == address(0), "DaoChef::setRewardMinter: Cannot redefine rewardMinter");
