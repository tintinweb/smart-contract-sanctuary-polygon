...
abstract contract BaseStrategyMasterChef is BaseStrategy {
    ...
    address public constant gaugeFactory = 0xabC000d88f23Bb45525E447528DBF656A9D55bf5;
    ...
    function _getReward() internal {
        IGaugeFactory(gaugeFactory).mint(rewards);
...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    address public constant swapToken = 0x1d8b86e3D88cDb2d34688e87E72F388Cb541B7C8;
...
contract StrategyBase is StrategyFarmBase {
    // Token addresses
    address public CURVE_MASTER_CHEF = 0xBb1B19495B8FE7C402427479B9aC14886cbbaaeE;
    address public atricrypto3_LP = 0xdAD97F7713Ae9437fa9249920eC8507e5FbB23d3;
