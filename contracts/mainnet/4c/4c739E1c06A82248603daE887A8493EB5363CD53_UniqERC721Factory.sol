...
import "./UniqERC721.sol";

contract UniqERC721Factory {
    address public pp;
    string public tt;

    event StoreCreated(address creator, address newStore);
    ...
    function createStore( string memory _name, string memory _symbol) external {
        UniqERC721 c = new UniqERC721(_name, _symbol, tt, pp);
        emit StoreCreated(msg.sender, address(c));
    }
}
