...
contract LiquidationBot is PoolInit {
    ...
    constructor(address _provider, address _router) PoolInit(_provider) {
        ...
        returns (bool) 
    {
        (address collateral, 
         ...
         address[] memory swapPath) = abi.decode(params, (address, address, uint256, address[]));
    ...
    function liquidateLoan(
        ...
        public 
    {
        require(IERC20(_debt).approve(address(LENDING_POOL), _amount), 
                "LENDING POOL Approval failed");

        LENDING_POOL.liquidationCall(_collateral, _debt, _user, _amount, _receiveAtokens);
        ...
        public 
    {
        ...
        require(IERC20(tokenIn).approve(address(Router02), amountIn), 
        ...
        onlyOwner 
    {
        ...
        bytes memory params = abi.encode(collateral, user, amountOutmin, swapPath);
