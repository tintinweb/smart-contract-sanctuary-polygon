...
contract NatGeoGenesis is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    
    address private _mechaMonkeyContract; //Companion 
    uint   private _totalStake;
    bool   public NatGeoGenesis = false; // Key owners reveal phase 2
    ...
    constructor() ERC721A("Nat Geo Genesis", "NGG") {}
   ...
   function setBaseUri(string memory baseuri_) public onlyOwner {
    ...
    function toggleNatGeoGenesis() public onlyOwner {
        NatGeoGenesis = !NatGeoGenesis;
    }
