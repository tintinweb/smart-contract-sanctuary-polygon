...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function checkSupply(uint256 tokenId) internal view {
        if (_maxSupply != 0) {
            require(tokenId <= _maxSupply, "NFT721Mint : SUPPLY_LIMIT_REACHED");
        }
    }
...
// File: contracts/OpenseaERC721.sol

contract Buddy721 is ERC721, Ownable {
    /**
    ...
    function initialize(
        ...
        ERC721._initialize(name, symbol, maxSupply);
        Ownable.ownable_init();
    }

    /**
     * @dev Mint to add tokens to supply
     */
    ...
    /**
     * @dev Burn to sub tokens from supply
     */
    ...
    /**
     * @notice Allows a admin to update NFT config variables.
