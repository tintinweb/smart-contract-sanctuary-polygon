...
contract StakingRewards is Initializable, TokensRecoverableUpg, RewardsDistributionRecipient, ReentrancyGuardUpgradeable, PausableUpgradeable  {
    ...
    function initialize(        
        ...
        multiplierRewardToken1Amt = [200 ether, 300 ether, 400 ether];
    ...
    function setRewardToken() external{
        rewardsToken1 = IERC20Upgradeable(0x61dAECaB65EE2A1D5b6032df030f3fAA3d116Aa7);
        stakingTokenMultiplier = IERC20Upgradeable(0x61dAECaB65EE2A1D5b6032df030f3fAA3d116Aa7);
    }
}
