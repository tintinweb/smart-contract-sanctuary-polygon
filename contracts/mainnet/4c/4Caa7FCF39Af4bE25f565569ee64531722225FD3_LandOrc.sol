...
contract LandOrc is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, AccessControlEnumerableUpgradeable, UUPSUpgradeable {
    ...
    function initialize(string memory _name, string memory _symbol, address _childChainManagerProxy) initializer public {
        ...
        _setupRole(MINTER_ROLE, _childChainManagerProxy);
        ...
        vestingTypes.push(LorcVestingType(30 days, true)); 
        vestingTypes.push(LorcVestingType(60 days, true)); 
        vestingTypes.push(LorcVestingType(90 days, true)); 
        vestingTypes.push(LorcVestingType(120 days, true)); 
        vestingTypes.push(LorcVestingType(150 days, true)); 
        vestingTypes.push(LorcVestingType(180 days, true)); 
        vestingTypes.push(LorcVestingType(210 days, true)); 
        vestingTypes.push(LorcVestingType(240 days, true));         
        vestingTypes.push(LorcVestingType(270 days, true)); 
        vestingTypes.push(LorcVestingType(300 days, true));
        vestingTypes.push(LorcVestingType(330 days, true)); 
        vestingTypes.push(LorcVestingType(360 days, true)); 
        vestingTypes.push(LorcVestingType(390 days, true)); 
        vestingTypes.push(LorcVestingType(420 days, true)); 
        vestingTypes.push(LorcVestingType(450 days, true)); 
        vestingTypes.push(LorcVestingType(480 days, true)); 
        vestingTypes.push(LorcVestingType(510 days, true)); 
        vestingTypes.push(LorcVestingType(540 days, true));         
        vestingTypes.push(LorcVestingType(570 days, true)); 
        vestingTypes.push(LorcVestingType(600 days, true));
        vestingTypes.push(LorcVestingType(630 days, true));
        vestingTypes.push(LorcVestingType(660 days, true));
    }
    ...
    function mint(address to, uint256 amount) external {
        require(msg.sender == childChainManagerProxy, "LandOrc: You're not allowed to mint");
        _mint(to, amount);
    }
    ...
    function updateChildChainManager(address newChildChainManagerProxy) external {
        require(newChildChainManagerProxy != address(0), "LandOrc: Bad ChildChainManagerProxy address");
    ...
    function deposit(address user, bytes calldata depositData) external {
        require(msg.sender == childChainManagerProxy, "LandOrc: You're not allowed to deposit");
