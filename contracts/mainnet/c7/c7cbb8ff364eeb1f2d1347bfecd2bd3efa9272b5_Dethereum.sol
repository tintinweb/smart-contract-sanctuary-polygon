...
import "src/RayMath.sol";
import "src/Math.sol";
import "forge-std/console.sol";

contract Build {
    function costRatio(uint256 costMultiplier) public pure returns (uint256) {
    ...
    function _upgradeMetal(DataStructures.Player storage player) internal {
        ...
        uint256 costMultiplier = costRatio(metal.costMultiplier);
    ...
    function _upgradeCrystal(DataStructures.Player storage player) internal {
        ...
        uint256 costMultiplier = costRatio(crystal.costMultiplier);
...
contract Dethereum is Build {
    ...
    function getMetal() public view returns (DataStructures.Resource memory metal) {
        return players[msg.sender].playerResources.metal;
    }

    function getCrystal() public view returns (DataStructures.Resource memory crystal) {
        return players[msg.sender].playerResources.crystal;
    }
