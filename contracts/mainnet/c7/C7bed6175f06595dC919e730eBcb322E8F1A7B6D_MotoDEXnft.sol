...
contract MotoDEXnft is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    constructor(uint256 networkId, address _gameServer) ERC721("motoDEXnft", "MOTO") {
        ...
        setupType(RED_BULLER, 2 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmTfCQ4cposTtYQy79G1RAxXQTN85TPw5qJSdnff1GnAty/RedBuller");
        setupType(ZEBRA_GRRR, 3 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmTfCQ4cposTtYQy79G1RAxXQTN85TPw5qJSdnff1GnAty/ZebraGrrrr");
        setupType(ROBO_HORSE, 4 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmTfCQ4cposTtYQy79G1RAxXQTN85TPw5qJSdnff1GnAty/RoboHorse");
        setupType(METAL_EYES, 5 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmTfCQ4cposTtYQy79G1RAxXQTN85TPw5qJSdnff1GnAty/MetalEyes");
        setupType(BROWN_KILLER, 6 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmTfCQ4cposTtYQy79G1RAxXQTN85TPw5qJSdnff1GnAty/BrownKiller");
        setupType(CRAZY_LINE, 7 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmTfCQ4cposTtYQy79G1RAxXQTN85TPw5qJSdnff1GnAty/CrazyLine");
        setupType(MAGIC_BOX, 4 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmTfCQ4cposTtYQy79G1RAxXQTN85TPw5qJSdnff1GnAty/MagicBox");

        setupType(TRACK_LONDON, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmTfCQ4cposTtYQy79G1RAxXQTN85TPw5qJSdnff1GnAty/London");
        setupType(TRACK_DUBAI, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmTfCQ4cposTtYQy79G1RAxXQTN85TPw5qJSdnff1GnAty/Dubai");
        setupType(TRACK_ABU_DHABI, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmTfCQ4cposTtYQy79G1RAxXQTN85TPw5qJSdnff1GnAty/AbuDhabi");
        setupType(TRACK_BEIJIN, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmTfCQ4cposTtYQy79G1RAxXQTN85TPw5qJSdnff1GnAty/Beijing"); // TODO - change back
        setupType(TRACK_MOSCOW, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmTfCQ4cposTtYQy79G1RAxXQTN85TPw5qJSdnff1GnAty/Moscow");
        setupType(TRACK_MELBURN, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmTfCQ4cposTtYQy79G1RAxXQTN85TPw5qJSdnff1GnAty/Melburn");
        setupType(TRACK_PETERBURG, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmTfCQ4cposTtYQy79G1RAxXQTN85TPw5qJSdnff1GnAty/Peterburg");
        setupType(TRACK_TAIPEI, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmTfCQ4cposTtYQy79G1RAxXQTN85TPw5qJSdnff1GnAty/Taipei");
        setupType(TRACK_PISA, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmTfCQ4cposTtYQy79G1RAxXQTN85TPw5qJSdnff1GnAty/Pisa");
        setupType(TRACK_ISLAMABAD, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmTfCQ4cposTtYQy79G1RAxXQTN85TPw5qJSdnff1GnAty/Islamabad");

        setupType(HEALTH_PILL_5, 0.5 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmTfCQ4cposTtYQy79G1RAxXQTN85TPw5qJSdnff1GnAty/HealthCapsule5");
        setupType(HEALTH_PILL_10, 1 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmTfCQ4cposTtYQy79G1RAxXQTN85TPw5qJSdnff1GnAty/HealthCapsule10");
        setupType(HEALTH_PILL_30, 3 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmTfCQ4cposTtYQy79G1RAxXQTN85TPw5qJSdnff1GnAty/HealthCapsule30");
        setupType(HEALTH_PILL_50, 5 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmTfCQ4cposTtYQy79G1RAxXQTN85TPw5qJSdnff1GnAty/HealthCapsule50");
        ...
        if (networkId == 80001) {
            ...
            setupType(TRACK_LONDON, 0.05 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmTfCQ4cposTtYQy79G1RAxXQTN85TPw5qJSdnff1GnAty/London");
        }
    ...
    function setHealthForId(uint256 tokenId, uint256 health) public {
        require(msg.sender == gameServer || msg.sender == owner(),'MotoDEXnft: only server account can change health');
    ...
    function purchase (uint8 typeNft, address referral) payable public {
        require(msg.value > valueInMainCoin(typeNft).sub(1000000), "MotoDEXnft: wrong value to send");
    ...
    function purchaseBatch(uint8[] memory typesNft, address referral) payable public {
        ...
        require(msg.value >= totalValueToPay.sub(1000000), "MotoDEXnft: wrong value to send");
    ...
    function addHealthMoney(uint256 tokenId) payable public nonReentrant {
        require(msg.value > valueInMainCoin(getTypeForId(tokenId)).sub(100000), "MotoDEXnft: must be a price value to restore");
