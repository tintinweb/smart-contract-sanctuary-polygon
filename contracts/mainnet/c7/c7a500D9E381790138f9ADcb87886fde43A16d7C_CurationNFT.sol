...
contract CurationNFT is ERC721, IERC2981, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721("Curation of 0xCreator", "0xCu") {
    }
    ...
    {
        require(!claimed[msg.sender], "0xCu already claimed by this wallet");
