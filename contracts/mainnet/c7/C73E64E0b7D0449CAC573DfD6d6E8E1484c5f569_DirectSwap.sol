...
contract DirectSwap is FeeModel, IRouter {
    ...
    function afterBuy(
        ...
        {
            if (
                _getFixedFeeBps(partner, feePercent) != 0 &&
                !_isTakeFeeFromSrcToken(feePercent) &&
                !_isReferral(feePercent)
            ) {
                takeToTokenFeeAndTransfer(toToken, toAmount, beneficiary, partner, feePercent);
                ...
                if (_getFixedFeeBps(partner, feePercent) != 0 && _isTakeFeeFromSrcToken(feePercent)) {
                    ...
                    takeFromTokenFeeAndTransfer(fromToken, amountIn, remainingAmount, beneficiary, partner, feePercent);
