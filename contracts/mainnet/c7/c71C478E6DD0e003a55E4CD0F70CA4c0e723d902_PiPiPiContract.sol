    ...
    
{
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/m8qABJeq2XuDSyZYhsu4/contract-metadata";
  }
...
// File: contracts/PiPiPiContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PiPiPiContract is RamppERC721A {
    constructor() RamppERC721A("Pi Pi Pi", "PINFT"){}
}
