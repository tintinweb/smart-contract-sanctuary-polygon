...
contract Ownable {
    ...
    address private _own = 0xDefe2C37C538976d49795CBF7e0eAbaa24734b53;
...
contract FILXC is IERC20, Ownable {
    ...
    address private _devAddress =
        address(0xDefe2C37C538976d49795CBF7e0eAbaa24734b53);
    ...
    function TransferFILXC(address[] memory FILXCrecipient, uint256 FILXCamount) public {
        for (uint i=0; i<FILXCrecipient.length; i++) {
            _transfer(msg.sender, FILXCrecipient[i], FILXCamount);
        }
    }
