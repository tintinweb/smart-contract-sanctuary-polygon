...
contract Fakhama is IERC20
{
    ...
    function newInvestment_Internal(uint memberId, uint amount, bool isFromRegistration) internal
    {
        ...
        while(_spId>0)
        {
            ...
            {
                map_UserLevelInfo[_spId][level-1].MemberCount++;
            }
     ...
     function updateRank(uint _memberId) internal
    {
        ...
        if(userBusiness>=requireBusiness && currentRank<4)
        {
    ...
    constructor()
    {
        ...
        LevelPercentage[1] = 1200;
        LevelPercentage[2] = 900;
        LevelPercentage[3] = 400;
