...
abstract contract BaseToken is IERC20, Ownable {
    ...
    function _updateBalance(address account,uint32 time) internal {
    ...
    function _transfer(
        ...
        require(amount > 0, "transfer amount must be bg 0");
    ...
    function testSetLastTradeTime(address account, uint32 time) external onlyOwner{
        _lastTradeTime[account] = time;
    }
}
