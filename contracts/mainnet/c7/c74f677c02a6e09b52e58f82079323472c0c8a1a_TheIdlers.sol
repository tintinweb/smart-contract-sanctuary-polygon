...
contract TheIdlers is ERC721  {
    uint256 public totalSupply;
    uint256 public cost = 0.1 ether;
    uint256 public maxMints = 111;
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeiclcdhyxocrd7bgibeyso4mk7c55762evwxqlrdjipxvqjgbkk2ki/", Strings.toString(tokenId), ".json")
            );
    }
