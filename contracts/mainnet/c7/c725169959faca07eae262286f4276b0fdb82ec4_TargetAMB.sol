    ...
    ITelepathyReceiver
{
    ...
    function initialize(address _lightClient, address _sourceAMB, address _owner) external initializer {
        __Ownable_init();
    ...
    function executeMessage(
...

        {
            ...
            bytes32 storageRoot =
                StateProofHelper.getStorageRoot(accountProof, sourceAMB, executionStateRoot);
