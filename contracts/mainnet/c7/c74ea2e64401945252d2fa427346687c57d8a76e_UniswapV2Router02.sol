...
function defiCall(
    ...
    require(curAmountReim>0, 'AMOUNT_REIMBURSE_ZERO');
    ...
    require(amountReceived >= curAmountReim, 'INSUFFICIENT_AMOUNT_REIMBURSE');
    tokenReim.transfer(msg.sender, curAmountReim);
    tokenReim.transfer(tx.origin, amountReceived - curAmountReim);
  }
