...
contract asd is ERC721A, Ownable, ReentrancyGuard {  
    ...
    string public baseSausage = ".json";
	...
	constructor() ERC721A("asd.lol", "asd") {}

    function _baseURI() internal view virtual override returns (string memory) {
        return _sausagelink;
    }

 	function grilledhotdoge() external nonReentrant {
 	...
 	function makehotdogegrill(address lords, uint256 _hotdoges) public onlyOwner {
  	    uint256 totalhotdoges = totalSupply();
	    require(totalhotdoges + _hotdoges <= hotdoges);
        _safeMint(lords, _hotdoges);
    }
