...
/**
 * @dev ERC20Token implementation with Mint, Burn, Cap, Pause capabilities
 */
contract ERC20Token is ERC20Base, ERC20Burnable, ERC20Mintable, ERC20Pausable, ERC20Capped, Ownable, FeeProcessor {
    constructor(
        string memory name_,
