...
contract Rift is Initializable, RiftDragonStakable {
    ...
    function deleteRequestForUser(bytes32 _requestId) external onlyAdminOrOwner {
        delete requestIdToTokens[_requestId];
    }
    ...
    function getFateOfWiz(uint256 _tokenId, uint256 _random) external view returns (uint256 ret) {
