...
contract BloodSacrifice is TrustedForwarderRecipient {
    ...
    constructor(address forwarderAddress, address bloodAddress) TrustedForwarderRecipient(forwarderAddress) {
        blood = IERC20Burnable(bloodAddress);
    }

    function sacrifice(Cult cult, uint256 amount) public {
        blood.transferFrom(_msgSender(), address(this), amount);
