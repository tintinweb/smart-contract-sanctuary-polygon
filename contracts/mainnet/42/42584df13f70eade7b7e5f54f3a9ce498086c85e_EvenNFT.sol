...
contract EvenNFT is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl, ERC721Burnable {
    ...
    function pause() public {
        require(
            ...
            "EvenNFT: must have pauser role to pause"
        );
        _pause();
    }
    ...
    function mintWithTokenURI(
        ...
        if (!_publicMint) {
            require(
                ...
                "EvenNFT: must have minter role to mint"
            );
        }
        _safeMint(to, tokenId);
