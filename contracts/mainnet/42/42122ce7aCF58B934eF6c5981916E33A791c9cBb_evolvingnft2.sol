...
contract evolvingnft2 is ERC1155Drop {
    ...
    function setPrice(uint256 tokenId, uint256 price) public onlyOwner {
        if (tokenId == 0) {
            TYPE_1000_PRICE = price;
        } else if (tokenId == 1) {
            TYPE_2500_PRICE = price;
        } else if (tokenId == 2) {
            TYPE_5000_PRICE = price;
        } else if (tokenId == 3) {
            TYPE_10000_PRICE = price;
        } else {
            revert("Invalid token ID");
        }
    }
    ...
    function getTokenPrice(uint256 _tokenId) public view returns (uint256) {
        if (_tokenId == 0) return TYPE_1000_PRICE;
        if (_tokenId == 1) return TYPE_2500_PRICE;
        if (_tokenId == 2) return TYPE_5000_PRICE;
        if (_tokenId == 3) return TYPE_10000_PRICE;
