...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
    ...
    address public adminAddress = 0x1BFE64d1FdDFFe0054f3C39030B065897f89B638;
...
contract EverUSDC is ERC20, Ownable {
    ...
    address public toBurnEverUsdcAddress = 0x664fC1e7c522d73f7b57aC61845Fc617476ae512;
    uint256 public toBurnEverUsdcFee = 2;
    ...
    constructor() ERC20("EverUSDC", "EverUSDC") {
        ...
        teamWallet = 0xB0c0a8168013DE366ADdC7Ce1d875F139e81cd2d;
        a80DividendToken = 0x3E61d4D16d1250646106F4fF6A0f2C3a396C72E9;
        b20DividendToken = 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174;
    ...
    function updateBurnEverUsdcAddress(address _newAddress) external onlyOwner {
        toBurnEverUsdcAddress = _newAddress;
    }
    ...
    function setToBurnEverUsdcFee(uint256 newFee) external onlyOwner {
        require(newFee <= MAX_FEE_RATE, "wrong");
        toBurnEverUsdcFee = newFee;
        _updateTotalFee();
    }
    ...
    function _updateTotalFee() internal {
        totalFees = buyBackAndLiquidityFee.add(marketingFee).add(a80DividendRewardsFee).add(b20DividendRewardsFee).add(toBurnEverUsdcFee);
    }
    ...
    function updateA80DividendTracker(address newAddress) external onlyOwner {
        ...
        require(newA80DividendTracker.owner() == address(this), "must be owned by EverUSDC");
    ...
    function updateB20DividendTracker(address newAddress) external onlyOwner {
        ...
        require(newB20DividendTracker.owner() == address(this), "must be owned by EverUSDC");
    ...
    function _transfer(
        ...
        if (
            ...
            if (!swapping && contractTokenBalance >= swapTokensAtAmount) {
                ...
                if(marketingEnabled && buyBackAndLiquifyEnabled && toBurnEverUsdcFee > 0 && buyBackMode){

                    uint256 total3Fees = marketingFee.add(buyBackAndLiquidityFee).add(toBurnEverUsdcFee);
                    ...
                    if(increaseAmount > 0){
                        ...
                        uint256 maticToBurnEverUsdc = increaseAmount.mul(toBurnEverUsdcFee).div(total3Fees);
                        useMaticToBurnEverUsdc(maticToBurnEverUsdc);
                    }
                }else{
                    if (marketingEnabled) {
                    ...
                    if(toBurnEverUsdcFee > 0){
                        uint256 swapTokensToBurnEverUsdc = contractTokenBalance.mul(toBurnEverUsdcFee).div(totalFees);
                        buyBackEverUsdcAndBurn(swapTokensToBurnEverUsdc);
                    }
                }
    ...
    function useMaticToBurnEverUsdc(uint256 amount) private {
        // generate the uniswap pair path of token -> weth
        address[] memory path = new address[](2);
        path[0] = uniswapV2Router.WETH();
        path[1] = toBurnEverUsdcAddress;
    ...
    function buyBackEverUsdcAndBurn(uint256 amount) private {
        address[] memory path = new address[](3);
        path[0] = address(this);
        path[1] = uniswapV2Router.WETH();
        path[2] = toBurnEverUsdcAddress;
...
contract A80DividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("Alpha80_Dividend_Tracker", "Alpha80_Dividend_Tracker", 0x3E61d4D16d1250646106F4fF6A0f2C3a396C72E9) {
        claimWait = 3600;
...
contract B20DividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("USDC20_Dividend_Tracker", "USDC20_Dividend_Tracker", 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174) {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 10000+ tokens
    }
