...
contract Elliment  {
    ...
    uint256 private constant dayRewardPercents = 190;
    ...
    function distributePoolRewards() public {
       ...
       function _distributeExecutivePool() private {
        ...
        for(uint256 i = 0; i < executiveUsers.length; i++){
            if(userInfo[executiveUsers[i]].level == 3 && userInfo[executiveUsers[i]].isactive == true){
 ...
 function _distributeSeniorExecutivePool() private {
        ...
        for(uint256 i = 0; i < seniorexecutiveUsers.length; i++){
            if(userInfo[seniorexecutiveUsers[i]].level == 4 && userInfo[seniorexecutiveUsers[i]].isactive == true){
 ...
 function _distributeChiefExecutivePool() private {
        ...
        for(uint256 i = 0; i < chiefexecutiveUsers.length; i++){
            if(userInfo[chiefexecutiveUsers[i]].level == 5 && userInfo[chiefexecutiveUsers[i]].isactive == true){
    ...
    function getexecutiveusersLength() external view returns(uint256) {
        return executiveUsers.length;
    }
    function getseniorexecutiveusersLength() external view returns(uint256) {
        return seniorexecutiveUsers.length;
    }
    function getchiefexecutiveusersLength() external view returns(uint256) {
        return chiefexecutiveUsers.length;
    }
