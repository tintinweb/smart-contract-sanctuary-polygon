...
contract Bush is  ReentrancyGuard, ERC721Enumerable, Ownable{
    ...
    constructor() ERC721("Slide Bush", "SB"){
       _storedTrees.push(Tree(0,1,0)); //default metadata;
       _batchCID.push("ipfs://bafybeifq2mfg3j36p7mz45diu34jxdblsquepjvi2sf4qinq63giyb5ww4/"); //default tree holder
       _storedTreesCounter++;
       _tokenIdCounter++;
       batchCat.push(0);
    }
