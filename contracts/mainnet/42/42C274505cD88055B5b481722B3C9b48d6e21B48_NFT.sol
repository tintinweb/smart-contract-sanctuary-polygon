...
contract NFT is ERC721, PullPayment, ERC721Burnable, Ownable {
    using Counters for Counters.Counter;
    
    // Constants
    uint256 public constant TOTAL_SUPPLY = 45_001;
    
    Counters.Counter private currentTokenId;
    
    constructor() ERC721("Super Hero Biden", "Biden") {}
    ...
    function tokenURI(uint256 tokenId) public pure virtual override returns (string memory) {
        return string(
            abi.encodePacked("https://anybet.me/nft-biden/metadata/",
