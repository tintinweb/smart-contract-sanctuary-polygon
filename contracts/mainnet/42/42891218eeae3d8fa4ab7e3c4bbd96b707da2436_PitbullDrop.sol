 ...
 */
contract PitbullDrop {
  using SafeERC20 for IERC20;

  /**
   * @dev SweatDrop is the main method for distribution
   ...
   */
  function SweatDrop(IERC20 token, address[] calldata addresses, uint256 [] calldata values) external returns (uint256) {
    uint256 i = 0;
