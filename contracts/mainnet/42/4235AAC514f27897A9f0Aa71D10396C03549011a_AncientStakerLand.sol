...
contract AncientStakerLand is Ownable, EIP712, IERC721Receiver {
    ...
    constructor() EIP712(SIGNING_DOMAIN_NAME, SIGNING_DOMAIN_VERSION){
        ...
        manager = 0x72f42ECa685185Fcfe0f0644E5ddf8d799659AF6;
...
contract AncientLand is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721 ("AncientLand", "ALD") {
    ...
    //MINTING FUNCTIONS
    function airdop(address player) external {
        require(msg.sender == owner() || msg.sender == signerWallet, "Not owner or signer");
        require(totalSupply() + 1 < MAX_LAND, "max-supply");
