...
contract BoredApePunksClub is ERC721 , DefaultOperatorFilterer {
    uint256 public totalSupply;
    uint256 public cost = 0.1 ether;
    uint256 public maxMints = 500;
    ...
    constructor()
        ERC721("Bored Ape Punks Club", "BAPCLUB")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeibyrbgw5ytfaw4ej6hz4xwzuekuuiqcne7yuelfcvbelxo5cdpk5y/", Strings.toString(tokenId), ".json")
            );
    }
