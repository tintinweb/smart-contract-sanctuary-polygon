...
contract ExchangeRouterLiquidationTesting {
    modifier onlyOwner() {
    ...
    uint256 public decreasePercent;
    ...
    function setDecreasePercent (
        uint256 decreasePercent_
    ) external onlyOwner returns (bool) {
        decreasePercent = decreasePercent_;
        return true;
    }
    ...
    function getSwapAmount (
        ...
        return amounts[1] * decreasePercent / 10000;
    }
