    ...
    EIP712MetaTransactionUpgradeable
{
    ...
    function sell(
        ...
        for (uint256 i = 0; i < _tokenIds.length; i++) {
            ...
            order = orderbook[_nftAddress][_tokenIds[i]];
            order.price = _prices[i];
    ...
    function buy(
        ...
        for (uint256 i = 0; i < _tokenIds.length; i++) {
            ...
            beneficiaries[i] = order.beneficiary;
        }
    ...
    function processPurchase(
        ...
        order = orderbook[_nftAddress][_tokenId];
        ...
        require(
            beneficiary == IERC721(_nftAddress).ownerOf(_tokenId),
