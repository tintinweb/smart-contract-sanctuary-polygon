...
// File: https://github.com/PolyBlockheads/PBHHStaking/PBHRewards.sol
...
contract PBHRewards is ERC20, ERC20Burnable, Ownable {

  mapping(address => bool) controllers;
  
  constructor() ERC20("PBHRewards", "PBHR") { }
...
contract NFTStaking is Ownable, IERC721Receiver {
  ...
  mapping(uint256 => Stake) public vault; 
   ...
   constructor(ERC721Enumerable _nft, PBHRewards _token) { 
    nft = _nft;
    token = _token;
  }
...
// rewardmath = 1000 ether .... (This gives 10 tokens per day per NFT staked to the staker)
  ...
  function _claim(address account, uint256[] calldata tokenIds, bool _unstake) internal {
    ...
    for (uint i = 0; i < tokenIds.length; i++) {
      ...
      rewardmath = 4000 ether * (block.timestamp - stakedAt) / 86400 ;
      earned = rewardmath / 4000;
      vault[tokenId] = Stake({
        owner: account,
        tokenId: uint24(tokenId),
        timestamp: uint48(block.timestamp)
