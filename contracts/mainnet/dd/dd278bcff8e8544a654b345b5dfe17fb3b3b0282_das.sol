...
// File: contracts/TheHypedSkulls.sol
...
contract das is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public cost = 0.000043 ether;
  ...
  constructor() ERC721("das", "das") {
    setHiddenMetadataUri("ipfs://Qmd9VRktLnTcr7TBgrfRL2rrBak6WGXbNrZt7ovsGKhnmi/1.json");
  }
