...
// File: contracts/LowGassFee NFT Contract.sol
...
contract LegendaryPotatoSociety is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://bafybeiciovkrkmwtexiustp5ys3ct45xk2zcsc4oy3epn56dmd3p4wb63u/";
  string public uriSuffix = ".json";
  string public hiddenMetadataUri;
  
  uint256 public cost = 93.00 ether;
  ...
  constructor() ERC721("The Legendary Potato Society", "LPS") {
