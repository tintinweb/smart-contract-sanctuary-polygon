...
contract WLDYCoin is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, AccessControlUpgradeable, UUPSUpgradeable, NativeMetaTransaction {
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant UPGRADER_ROLE = keccak256("UPGRADER_ROLE");
    bytes32 public constant METATXNEXECUTOR_ROLE = keccak256("METATXNEXECUTOR_ROLE");

    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() initializer {}

    function initialize() initializer public {
        __ERC20_init("WLDYTEST Coin", "WLDYT1");
        // __ERC20_init("WLDY Coin", "WLDY");
    ...
    function executeMetaTransaction(
        ...
        bytes32 sigS,
        uint8 sigV
    ) external onlyRole(METATXNEXECUTOR_ROLE) returns (bytes memory) {
        return _executeMetaTransaction(userAddress, functionSignature, functionInfo, sigR, sigS,sigV);
    }

    function initializemetatxns() external onlyRole(METATXNEXECUTOR_ROLE) {

        _initializeEIP712('WLDYCoin', '1');
    }
}