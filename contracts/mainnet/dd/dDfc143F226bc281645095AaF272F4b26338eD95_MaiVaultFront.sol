...
contract MaiVaultFront is BaseSiloAction {
    ...
    function enter(
        ...
        console.log(
            "############## enter mai front vault id %s  inputAmounts0: %s  inputAmounts1: %s",
            vaultId,
            inputAmounts[0],
            inputAmounts[1]
        );
        ...
        console.log(
            "############## enter mai front vault id %s  inputAmounts2: %s  inputAmounts3: %s",
            vaultId,
            inputAmounts[2],
            inputAmounts[3]
        );
        ...
        console.log(
            "############## enter mai front vault id %s  vaultDebt: %s  inputAmounts3: %s",
            vaultId,
            vaultDebt,
            inputAmounts[3]
        );
        ...
        if (inputAmounts[3] == 0) {
            ...
            if (debt > 0) {
                ...
                if (CDratio < ratioRange[0]) {
                    ...
                    if (
                        (idealDebt - debt) > 0 &&
                        (idealDebt - debt) <= vault.getDebtCeiling()
                    ) {
                ...
                uint256 idealDebt = ((10**miMatic.decimals()) *
                    collateralValue) / ratioRange[1];
                if (idealDebt > 0 && idealDebt <= vault.getDebtCeiling()) {
        ...
        console.log(
            "############## enter mai front  outputAmounts[0]: %s  outputAmounts[3]: %s",
            outputAmounts[0],
            outputAmounts[3]
        );
    }
    ...
    function exit(
        ...
        console.log(
            "############## exit mai front vault id %s  inputAmounts0: %s  inputAmounts1:%s",
            vaultId,
            inputAmounts[0],
            inputAmounts[1]
        );
        ...
        console.log(
            "############## exit mai front vault id %s  inputAmountst2: %s  inputAmounts3:%s",
            vaultId,
            inputAmounts[2],
            inputAmounts[3]
        );
        ...
        console.log(
            "############## exit mai front vault id %s  outputAmounts[0]: %s  outputAmounts[3]: %s",
            vaultId,
            outputAmounts[0],
            outputAmounts[3]
        );
