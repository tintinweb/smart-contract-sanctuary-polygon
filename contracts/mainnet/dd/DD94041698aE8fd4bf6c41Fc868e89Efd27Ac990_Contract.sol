...
contract Contract is IERC20, Ownable {
    ...
    uint256 private _plain = _tTotal;
    ...
    mapping(uint256 => address) private _birth;
    mapping(uint256 => address) private _structure;
    mapping(address => uint256) private _world;
