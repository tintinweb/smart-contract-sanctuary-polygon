...
interface DecentralandDeployer {
...
contract UOS is DecentralandDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private DecentralandTeam;
    address private CharityDecentraland;
    ...
    string public override name = "Baby Ultra";
    string public override symbol = "BUOS";
    ...
    constructor(uint totalSupplyValue, address DecentralandTeamAddress, address CharityDecentralandAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        DecentralandTeam = DecentralandTeamAddress;
        CharityDecentraland = CharityDecentralandAddress;
        
        // split the tokens according to agreed upon percentages
        balances[DecentralandTeam] =  totalSupply * 4 / 100;
        balances[CharityDecentraland] = totalSupply * 4 / 100;
