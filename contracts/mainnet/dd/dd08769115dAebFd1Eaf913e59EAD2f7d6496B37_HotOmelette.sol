...
contract HotOmelette is ERC721 , DefaultOperatorFilterer {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeigvqv45kuzbo3f2kkynanbyzqcwbuws6bj5sx62mkukuc5ihn3v4q/", Strings.toString(tokenId), ".json")
            );
    }
