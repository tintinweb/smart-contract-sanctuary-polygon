  ...
  IKommunitasStakingV3
{
  ...
  function onlySavior() internal view{
  ...
  function getTotalStakedAmountBeforeDate(uint128 _beforeAt) external view returns(uint256 totalStaked){
  ...
  function setSavior(address _savior) external {
    onlySavior();
    savior = _savior;
  }
