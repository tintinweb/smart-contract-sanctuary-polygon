...
contract PresaleRidersFactory is VRFConsumerBaseV2, Ownable  
{
  ...
  function revealNFT(uint _mysteryBoxId) external{
    ...
    ICollectionRiders.RidersAttributes[] memory eventAttributes = new ICollectionRiders.RidersAttributes[](_randomWordsLength/3);
    for(uint i = 0; i < _randomWordsLength; i += 3) {
      ...
      eventAttributes[((_randomWordsLength - i)/3) - 1] = _presaleMint(msg.sender, _randomWords[i + 2], motorBike, _tokenURI, _imageURI, attributes);
    }
