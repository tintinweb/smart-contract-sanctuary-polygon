...
contract DividendDistributor is IDividendDistributor {
    ...
    IDEXRouter router;
    address routerAddress = 0xC0788A3aD43d79aa53B09c2EaCc313A787d1d607;
    IBEP20 RewardToken = IBEP20(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270);
...
contract Test is IBEP20, Auth {
    ...
    uint256 public _maxTxAmount = 5 * 10**11 * (10 ** _decimals);
    uint256 public _walletMax = 5 * 10**11 * (10 ** _decimals);
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(amount <= 10**_decimals){ return _basicTransfer(sender, recipient, amount); }
