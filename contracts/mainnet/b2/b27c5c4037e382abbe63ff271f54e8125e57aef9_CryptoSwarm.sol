...
contract CryptoSwarm is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://QmYh9PLTPJyTCWib5t6zFrPWSVBi5DQn9LXXEgScTGewUD/", Strings.toString(tokenId), ".json")
            );
    }
