...
contract AccessVault is Initializable, Storage {
    ...
    function setMarginSwap (
        ...
        require(amount > 0 && amountOut > 0, '4.1');
        ...
        _marginSwapRegistryNew[baaAddress][reversed].amountOut = amountOut;
    ...
    function disableMarginSwap (
        ...
        emit MarginSwapNewSet(
            ...
            _marginSwapRegistryNew[baaAddress][reversed].amountOut,
            reversed,
...
contract Storage {
    ...
    struct MarginSwapNew {
        uint256 amount;
        uint256 amountOut; // minimal amount user wants to get when swap
        uint8 status; // 0 - disabled, 1 - waiting, 2 - completed
    }
