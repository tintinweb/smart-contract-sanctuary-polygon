...
//*********************************************************************//
//
//     _   ____________________           __            _______________________
//    / | / / ____/_  __/ ____/___ ______/ /____  _____/ ____/ ____/ ____/ ___/
//   /  |/ / /_    / / / __/ / __ `/ ___/ __/ _ \/ ___/ __/ / / __/ / __ \__ \ 
//  / /|  / __/   / / / /___/ /_/ (__  ) /_/  __/ /  / /___/ /_/ / /_/ /___/ / 
// /_/ |_/_/     /_/ /_____/\__,_/____/\__/\___/_/  /_____/\____/\____//____/  
//                                                                            
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 5, 3222 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmRpQkDToKJNPHFXbTgrJ6XHXeN37un1H8RAb9QV941ajZ/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 3222");
        _safeMint(_to, 1);
    }
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 3222");
...
// File: contracts/NftEasterEggsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NftEasterEggsContract is RamppERC721A {
    constructor() RamppERC721A("NFTEasterEGGS", "EGG"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/09xG1ZOVxjtHOhZL5BtT/contract-metadata";
    }
}
