...
contract GenericHandlerUpgradeable is Initializable, EIP712Upgradeable, ContextUpgradeable, AccessControlUpgradeable {
    ...
    /**
        ...
        @param _sign Signed signature of the voucter
    **/
    ...
    **/
    ...
    /**
        @notice Function Generates the digest of the linker address.
        @param linker Linker object to be hashed
    **/
    ...
    **/
    ...
    /**
        @notice Function verifies the linker address.
        @param linker Linker object to be verified
        @param signature Signed signature of the voucter
    **/
    ...
    /**
        ...
        @param signature Signed signature of the voucter
    **/
    function verifySignature(RouterLinker calldata linker, bytes memory signature) external view returns (address) {
        return _verify(linker, signature);
    }
    ...
    **/
    ...
    /**
        ...
        @param  _srcChainID Source CHainID of the deposit
    ...
    **/
    function calculateFees(
        ...
        if (gas < defaultGas[destinationChainID]) {
            return ((feeFactor * defaultGas[destinationChainID]) + bridgeFees);
        } else {
            return ((feeFactor * gas) + bridgeFees);
        }
    }
    ...
    **/
    function deductFee(
        ...
        uint256 fee = 0;
        if (gas < defaultGas[destinationChainID]) {
            fee = ((feeFactor * defaultGas[destinationChainID]) + bridgeFees);
        } else {
            fee = ((feeFactor * gas) + bridgeFees);
        }
