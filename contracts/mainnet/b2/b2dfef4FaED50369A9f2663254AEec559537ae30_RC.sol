...
contract RC is Ownable {
    ...
    function addSubscription(
        ...
        if (_subscription.priceInQuoteToken > 0) {
            ...
            require(
                (token0 == quoteTokenAddress || token1 == quoteTokenAddress) &&
    ...
    function createInsurance(
        ...
        uint256 prevPrice = subscriptions[userInsurance.subscriptionID]
            .priceInQuoteToken;
    ...
    function _billPayment(
        ...
        if (penalty) {
            amountInPaymentToken +=
                (amountInPaymentToken * userPaymentPlan.feeAmountBP) /
                BASE_POINT;
        }
        ...
        for (uint256 i = 0; i < erc20Tokens.length; i++) {
            ...
            if (balance > 0) {
                erc20PenaltyAmount = penalty
                    ? (balance * userPaymentPlan.erc20AmountBP) / BASE_POINT
                    : 0;
