...
contract APECLUB is ERC721, ReentrancyGuard, Ownable {
  ...
  uint256 public constant MAX_MULTIMINT = 51;
  ...
  function mint(uint256 count) public nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 51 at a time");
