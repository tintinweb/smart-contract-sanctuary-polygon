    ...
    UsesContractRegistry
{
    ...
    uint256 private constant AUCTION_BID_TIME_EXTENSION = 10 minutes;
    ...
    constructor(address contractRegistry)
        ...
        for (uint256 i = 0; i < allAuctionsLength; i++) {
            ...
            AuctionsForLSP8Contract
                memory auctionsForLSP8Contract = AuctionsForLSP8Contract({
                    ...
                    auctions: new AuctionForTokenId[](
                        auctionsForLSP8ContractLength
                    )
                });
            ...
            allAuctions[i] = auctionsForLSP8Contract;
        }
    ...
    function openAuctionFor(
        ...
        if (
            duration < AUCTION_MIN_DURATION || duration > AUCTION_MAX_DURATION
        ) {
    ...
    function submitBid(
        ...
        if (block.timestamp + AUCTION_BID_TIME_EXTENSION > auction.endTime) {
            endTime = auction.endTime + AUCTION_BID_TIME_EXTENSION;
