...
contract team is ERC20, Ownable{
    ...
    function rescueBRB20(address tokenAddress, uint256 amount) external onlyOwner{
        IERC20(tokenAddress).transfer(owner(), amount);
    }

    function rescueBRB(uint256 weiAmount) external onlyOwner{
