...
contract cryptomancollection is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_, address proxyRegistryAddress_)
    ERC721("cryptoman collection", "CRM")
  {
  ...
  uint256 public constant MAX_MULTIMINT = 100210;
  ...
  function mint(uint256 count) public nonReentrant {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 100210 at a time");
