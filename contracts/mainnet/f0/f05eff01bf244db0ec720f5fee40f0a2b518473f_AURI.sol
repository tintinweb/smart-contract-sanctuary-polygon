...
contract AURI is ERC20, Ownable {
    ...
    uint256 public maxTransactionAmount = 1000000000 * (10**6);
    ...
    address payable public marketingWallet = payable(0xA4d3Db20Ec37300f728958E506aD693d62Cd8A0C);
    ...
    constructor(address _owner) ERC20("AURI Token", "AURI") {
        ...
        _createSupply(_owner, 1000000000 * (10**6));
    }
