 ...
 * #Gopo Finance (GOPO)
 *
 * Market name: Gopo Finance
 * Web: https://gopo.finance
 *
 * Tokenomics:
 * -   sell/buy transaction will have different tax percent
 *     +  Buying Tax (10%): 3% Reflection, 2% Burn, 1% Marketing/Development, 1% Gopo Foundation
 *     +  Selling Tax (10%): 3% Reflection, 2% Burn, 1% Marketing/Development, 1% Gopo Foundation  
 * Features: 
 * -   +  Anti-Whale Dump
...
contract Gopo is Context, IERC20, Ownable {
    ...
    string constant private _name = "Gopo Finance";
    string constant private _symbol = "GOPO";
    ...
    constructor() {
        ...
        address _uniswapV2RouterAddr=0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff; // QuickSwap
