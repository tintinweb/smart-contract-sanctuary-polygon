...
contract Drone is Context, IERC20, Ownable, Whitelistable, Restrictable {
    ...
    function transfer(address recipient, uint256 amount) public override notRestricted(msg.sender, recipient, amount) returns (bool) {
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override notRestricted(sender, recipient, amount) returns (bool) {
