...
// File: contracts/DigitalFirstNFT.sol
...
contract DigitalFirstNFT is ERC721, IERC4907, Ownable, DefaultOperatorFilterer, ERC2981 {
    struct UserInfo
    {
    ...
    string private _base_uri = "https://nfthooks.xyz/api/LTD/";
  ...
  function batchMint(address _addr, uint _amount) public onlyOwner {
    for (uint i = 0; i < _amount; i++) {
      _safeMint(_addr, _currentIndex);
      _currentIndex += 1;
    }
  }
