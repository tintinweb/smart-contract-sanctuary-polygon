...
contract BanderaSmoothie is ERC1155, Ownable {
    
    string public constant name = "BanderaSmoothie";
    ...
    function mint(uint32 count) public payable {
        ...
        require(msg.value >= cost * count, "Not enough ether.");
