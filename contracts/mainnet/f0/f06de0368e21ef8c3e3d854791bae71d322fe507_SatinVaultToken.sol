...
interface ISatinPair {
    function swapFee() external view returns (uint256);
}

pragma solidity >=0.5.0;

interface ISatinVaultToken {
    /*** Tarot ERC20 ***/
...
import "./interfaces/ISatinPair.sol";
import "./interfaces/ISatinVaultToken.sol";
...
contract SatinVaultToken is ISatinVaultToken, PoolToken {
    ...
    function _optimalDepositA(
        ...
        uint256 swapFee = ISatinPair(underlying).swapFee();
