...
contract Clothing is AbstractERC1155Factory {
    uint256 private constant MAX_SUPPLY = 55;
    uint256 private constant MAX_TYPE = 6;
    ...
    */
    function exists(uint256 tokenId) public pure override returns (bool) {
        return tokenId >= 1 && tokenId <= MAX_TYPE;
    }
    ...
    function totalSupply() public view returns (uint256) {
        uint256 tSupply = 0;
        for (uint256 index = 1; index <= MAX_TYPE; index++) {
