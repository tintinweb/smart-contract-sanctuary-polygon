...
contract Furystaker {
	...
	uint256 constant public PROJECT_AND_DEV_FEE = 150;
	uint256 constant public PERCENT_STEP = 5;
	uint256 constant public WITHDRAW_FEE = 500;
	...
	function withdraw() public payable {
		...
		uint256 fee = msg.value.mul(PROJECT_AND_DEV_FEE).div(PERCENTS_DIVIDER).div(2);
		projectWallet.transfer(fee);
		devWallet.transfer(fee);
		emit FeePayed(msg.sender, fee.add(fee));
	}
