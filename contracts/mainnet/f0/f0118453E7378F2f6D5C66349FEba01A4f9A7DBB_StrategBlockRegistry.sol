...
import "./interfaces/IStrategCommonBlock.sol";
...
contract StrategBlockRegistry is Ownable, IStrategyBlockRegistry {
    ...
    /**
     * @dev Initializes the StrategBlockRegistry contract.
     * @param _degenMode  Boolean indicating whether the contract is operating in degen mode.
     */
