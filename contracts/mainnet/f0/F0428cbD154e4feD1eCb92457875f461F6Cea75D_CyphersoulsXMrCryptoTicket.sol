...
contract CyphersoulsXMrCryptoTicket is
    Ownable,
    FundsManagementOwnable,
    ERC721URIStorage,
    ERC721Burnable
{
    bool public constant IS_SECRET_MR_CRYPTO = true;

    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    constructor() ERC721("Cyphersouls x Mr.Crypto Ticket", "CMT") {
        // Save gas for the first minter: https://shiny.mirror.xyz/OUampBbIz9ebEicfGnQf5At_ReMHlZy0tB4glb9xQ0E
        _tokenIds.increment();
    }

    function mint(address _to, string calldata _tokenURIPrefix)
        external
        onlyOwner
        returns (uint256)
    {
        ...
        require(mintTokenId <= 10000, "ALL_TOKENS_MINTED");
