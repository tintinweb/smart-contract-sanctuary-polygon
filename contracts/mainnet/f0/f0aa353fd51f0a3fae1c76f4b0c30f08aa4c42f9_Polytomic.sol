...
contract Polytomic {
    ...
    function deposit(address _referer) public payable{
        ...
        _setReferral(msg.sender,_referer, msg.value,true);
    ...
    function _setReferral(address _addr, address _referral, uint256 _amount, bool maketeam) private {
    ...
    function workingWithdraw() public{
        ...
        _setReferral(msg.sender,user.referral,levelShare,false);
    }
