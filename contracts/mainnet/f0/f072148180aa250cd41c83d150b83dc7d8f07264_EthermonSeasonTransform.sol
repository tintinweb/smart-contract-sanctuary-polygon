...
// File: contracts/EthermonSeasonTransform.sol
...
interface EthermonSeasonTransformSettingInterface {
...
contract EthermonSeasonTransform is
    EthermonEnum,
    BasicAccessControl,
    SafeMathEthermon
{
    ...
    */
    ...
    function getLevel(uint256 exp) public view returns (uint8) {
        uint8 minIndex = 1;
        uint8 maxIndex = 100;
        uint8 currentIndex;
        ...
        )
    {
        ...
        uint256 season_exp = seasonData.getCurrentSeasonExp(_objId);
        return (obj.classId, obj.trainer, season_exp);
    }
    ...
    //     (transformClass, transformLevel) = EthermonSeasonTransformSettingInterface(
