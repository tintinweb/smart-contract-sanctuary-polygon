 ...
 * @notice This contract handles minting Retro Mods tokens.
 */
contract RetroMods is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeifw5n7p3fxy7tilcboeilkde7hnopnq52p6kp262hpz25p3xzye4y/{id}"
        )
        RevokableOperatorFilterer(
     ...
     */
    function setAllTokensSoulbound(
        bool _allTokensSoulbound
    ) external onlyOwner {
