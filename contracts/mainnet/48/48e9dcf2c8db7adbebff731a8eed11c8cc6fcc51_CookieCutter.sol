...
contract CookieCutter is Context, IERC20, Ownable, BaseToken {
    ...
    struct ConstructorArgument {
     ...
     constructor(
        ...
        minimumTokensBeforeSwap = infoArg.totalSupply_.div(5000); // 0.02%
        swapMaxAmountOfTokens = infoArg.totalSupply_.div(1000); // 0.1%
    ...
    function _transfer(
        ...
        if (
            ...
            uint256 taxForSwap = _liquidityFee + _marketingFee;
		    uint256 amountToLiquify = contractTokenBalance * _liquidityFee / taxForSwap / 2;
            ...
            uint256 totalBNBFee = taxForSwap - (_liquidityFee / 2);
            uint256 amountBNBLiquidity = bnbBalanceAfterSwap * _liquidityFee / totalBNBFee / 2;
            uint256 amountBNBMarketing = bnbBalanceAfterSwap - amountBNBLiquidity;
    ...
    function setMinimumTokensBeforeSwap(uint256 newAmount) external onlyOwner() {
