...
contract oxWunks is ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  uint256                     public constant TOKEN_PRICE = 600000000000000000;

 
  uint                        public constant MAX_TXN_WUNK_PURCHASE = 15;
  uint256                     public constant MAX_WUNKS = 6000;
  uint256                     public constant MAX_FREE_PER_USER_WUNKS = 10;
  uint256                     public constant FREE_WUNKS = 500;
  
  constructor() ERC721("0xWunks", "0xWUNKS") {
    setBaseURI("ipfs://QmU6ri1R5q6AYbbJ1kg5kXuRr5ngLaqR6d7TPs7RCfxgAv/hidden.json");
  ...
  function mintToken(uint numberOfTokens) public payable nonReentrant {
    ...
    require(numberOfTokens < MAX_TXN_WUNK_PURCHASE, "You can only mint 15 Wunks per transaction.");
