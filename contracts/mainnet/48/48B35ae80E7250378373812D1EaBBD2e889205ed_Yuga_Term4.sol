...
contract Yuga_Term4 is TermBase, ExpressTerms {
    ...
    function name() external pure override returns (string memory) {
        return "Acknowledgement of Ownership";
    }
    ...
    function term(
        ...
        return
            "**3. <u>Acknowledgement of Ownership</u>**.\n \n > i.  Licensee acknowledges that Licensor owns all right, title, and interest in and to the Mark(s), including all goodwill associated with the Mark(s), which such goodwill shall inure solely to the benefit of the Licensor. Notwithstanding the foregoing, in the event that Licensee is deemed to own any rights, title or interest in or to the Mark(s), Licensee hereby assigns such right, title and interest in and to the Licensor, in each case, without any additional compensation of any kind.\n \n";
    }
}