...
contract PolyTheParrot is IERC721L, ERC721AQueryable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {

    // Whether base URI is permanent. Once set, base URI is immutable.
    bool private _baseURIPermanent;

    // The total mintable supply.
    uint256 internal _maxMintableSupply = 333;
    ...
    constructor() ERC721A("Poly The Parrot", "PTP") {
        _mintStages.push(MintStageInfo({cost: 25000000000000000000, walletLimit: 5, merkleRoot: 0x0, maxStageSupply: 0, startTimeUnixSeconds: 1687359633, endTimeUnixSeconds: 1692502233}));
    }
