    ...
    EIP712MetaTransaction("VendingMachine", "1")
{
    ...
    uint256 public burnedFossil = 1200;
    uint256 public daoFossil = 300;
    uint256 public devFossil = 300;
    uint256 public burnedBone = 1200;
    uint256 public daoBone = 300;
    uint256 public devBone = 300;
    ...
    function breed(address _breedee,
                   ...
                   bytes calldata _varData) external {
    ...
    ) external override(IERC721Receiver) returns (bytes4)
    {
        ...
        require(address(breedNFTContract) == tokenContract, "Only receives BREED NFTs");
        require(_vardata.length > 0, "Must receive breeding data on transfer");
