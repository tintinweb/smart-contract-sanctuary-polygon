...
// File: contracts/interfaces/IDFXStrat.sol
...
// File: contracts/GrimVaultV2.sol
 ...
 */
contract GrimVaultV2 is ERC20, Ownable, ReentrancyGuard {
    ...
    function balance() public view returns (uint) {
        return want().balanceOf(address(this)) + IDFXStrat(strategy).balanceOf();
    }
    ...
    function proposeStrat(address _implementation) public onlyAdmin {
        require(address(this) == IDFXStrat(_implementation).vault(), "!Valid proposal");
    ...
    function upgradeStrat() public onlyAdmin {
        ...
        strategy = IDFXStrat(stratCandidate.implementation);
