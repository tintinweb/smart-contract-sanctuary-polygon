...
// UTC+8 March-05, 2022 Giveaway Contract
...
contract SendUsdcGiveaway0305 {
    ...
    function sendGiveaway() public {
        require(contractOwner==msg.sender, "Permission Denied");
        sendUsdc(0x69eC1584050d038410E7b9C7290F16E0e737f7Ea, 1); // Yama | Meta Tycoon#7045, 1U
        // sendUsdc(NULL, 1); // nancy#8753, 1U
        sendUsdc(0x2EEF02bC3846bb9a05bFE82a65fbe41340d04Ba1, 1); // TW54#5747, 1U
        // sendUsdc(NULL, 1); // Wilson420.eth#8792, 1U
        // sendUsdc(NULL, 1); // mkmkmkit | HuntCoins#9200, 1U
        sendUsdc(0x51561af41C3426A45a95652b44107C226467e973, 5); // leo0002#1199, 5U
        sendUsdc(0x8480FdA52cf2608684C367efD91D03f143f8b1cf, 10); // Ray0411#1133, 10U
    }
