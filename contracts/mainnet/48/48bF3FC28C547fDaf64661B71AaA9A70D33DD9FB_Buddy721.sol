...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
     ...
     */
    function _initialize(string memory name_, string memory symbol_, uint256 maxSupply_) public  initializer{
        _name = name_;
        _symbol = symbol_;
    ...
    function adminUpdate(string memory name_, string memory symbol_) public {
        _name = name_;
        _symbol = symbol_;
    }
...
contract Buddy721 is ERC721, Ownable {
    ...
    function adminUpdateConfig(string memory name,
        string memory symbol) public onlyOwner{
            ERC721.adminUpdate(name,symbol);
        }
