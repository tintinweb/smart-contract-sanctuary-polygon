...
contract Clu3Genesis is ERC721Base, ERC721MaxSupplyExtension, ERC721SoulboundExtension, ERC721LimitedExtension, ERC721FreeMintExtension {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override (ERC721Base, ERC721MaxSupplyExtension, ERC721SoulboundExtension, ERC721FreeMintExtension, ERC721LimitedExtension) returns (bool) {
    ...
    function _beforeTokenMint(address to, uint256 firstTokenId, uint256 batchSize) internal virtual override (ERC721BetterHooksUpgradeable, ERC721MaxSupplyExtension, ERC721FreeMintExtension, ERC721LimitedExtension) {
