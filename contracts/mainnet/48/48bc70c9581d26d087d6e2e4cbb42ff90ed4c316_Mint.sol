...
contract Mint is Ownable{
    ...
    constructor(uint256 rate, address serviceFeeReceiver, uint256 serviceFee, address serviceFeeReceiverX, uint256 serviceFeeX){
        //_token = IERC20(token); // Mint token address
        _rate = rate;
    ...
    function startMint(address refer, address _token) public payable {
