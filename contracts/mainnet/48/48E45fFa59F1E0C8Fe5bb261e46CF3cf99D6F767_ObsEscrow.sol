...
// File contracts/obs/ObsEscrow.sol
pragma solidity ^0.8.4;
...
contract ObsEscrow is Context, Ownable, ERC1155Holder {
    string public name = "OBS Escrow V1";
    ...
    function purchase(uint256 listingId, uint256 quantity, address receiver) public payable {
        ...
        if (tokenContract.supportsInterface(type(IERC2981).interfaceId)) {
            address royaltyReceiver;
            uint256 royalties;
            (royaltyReceiver, royalties) = tokenContract.royaltyInfo(listing.tokenId, toPay);
