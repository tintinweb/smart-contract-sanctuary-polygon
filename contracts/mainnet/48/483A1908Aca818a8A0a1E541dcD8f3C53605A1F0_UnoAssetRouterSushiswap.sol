...
contract UnoAssetRouterSushiswap is Initializable, PausableUpgradeable, UUPSUpgradeable, IUnoAssetRouterSushiswap {
    ...
    function _addLiquidity(
        ...
        IERC20(tokenA).approve(address(SushiswapRouter), amountA);
        IERC20(tokenB).approve(address(SushiswapRouter), amountB);
    ...
    function _removeLiquidity(
        ...
        IERC20(lpPair).approve(address(SushiswapRouter), amount);
