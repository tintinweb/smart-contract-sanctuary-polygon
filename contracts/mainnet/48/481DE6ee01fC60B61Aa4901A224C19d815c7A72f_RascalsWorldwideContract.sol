...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x9822F70356C4a8C0B2773129EBAD8bCb908B3559];
  address public erc20Payable = 0x9822F70356C4a8C0B2773129EBAD8bCb908B3559;
...
abstract contract EarlyMintIncentive is Teams, ERC721A, ProviderFees {
  uint256 public PRICE = 79 ether;
  uint256 public EARLY_MINT_PRICE = 59 ether;
  uint256 public earlyMintTokenIdCap = 30;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 80) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeid7d4725hj7r6viu22rfxldkn2qvciw346ck7pnv77boeilhgsiwm/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/euggyzwamZwuPUE9FiNy/contract-metadata";
  }
...
// File: contracts/RascalsWorldwideContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract RascalsWorldwideContract is ERC721APlus {
    constructor() ERC721APlus("Rascals Worldwide", "RASCWW"){}
}
