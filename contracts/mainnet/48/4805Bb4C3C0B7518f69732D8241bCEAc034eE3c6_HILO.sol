...
contract HILO is ERC1155Supply, Ownable, Pausable, ReentrancyGuard {
    ...
    // mumbai: 0xe11A86849d99F524cAC3E7A0Ec1241828e332C62 + 18 decimals
    // matic: 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174 + 6 decimals
    IERC20 public usdc = IERC20(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174);
    uint256 private usdcDecimals = 1000000;
    ...
    constructor(
        ...
        uint256 _jackpot
    ) ERC1155("https://hilo-beige.vercel.app/api/tokens/{id}") {
    ...
    function payout() public onlyOwner {
        ...
        uint256 jackpotPayout = jackpot * usdcDecimals;
