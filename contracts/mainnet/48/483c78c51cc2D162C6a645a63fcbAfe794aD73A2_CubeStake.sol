    ...
    TowerProtocol
{
    ...
    uint256 public lockDuration = 86400 * 7; // 7 days
    ...
    function stake(uint256 _amount) public nonReentrant {
        ...
        uint256 _unlockTime = block.timestamp.add(lockDuration);
    ...
    function setLockDuration(uint256 _duration) public onlyOwnerOrOperator {
...
interface IProfitController {
    function distributeStake(uint256 _amount) external;
}
