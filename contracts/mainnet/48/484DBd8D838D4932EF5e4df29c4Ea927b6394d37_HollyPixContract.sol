    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://metadata.mintfoundry.xyz/c/v3IJiJAB26Uwinve2CrI/token/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/hoc3QJyszvjBOuInQi71/contract-metadata";
  }
...
// File: contracts/HollyPixContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract HollyPixContract is ERC721APlus {
    constructor() ERC721APlus("HollyPix", "HLLYPX"){}
}
