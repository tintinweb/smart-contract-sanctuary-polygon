 ...
 * @notice This contract handles minting Minds Box tokens.
 */
contract MindsBox is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x55b294057eb49b30038209Cf104f4c0b500022b0;
    ...
    string public name = "Minds Box";
    string public symbol = "Mbox";
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeiecoqkcy5pen2wibpu4v7bqlcaoiuv6chpmrktg7jgwwodmoqxuja/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenPublicMintsPerAddress[1] = 140;
        require(
