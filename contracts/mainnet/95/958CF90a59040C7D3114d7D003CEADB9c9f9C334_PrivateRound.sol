...
contract PrivateRound {
     ...
     */
    function buyBITS(uint256 amount) external returns (bool) {
        require(amount >= _minAmount, "Amount must be greater than or equal to the 500 MATIC");
        ...
        if (success) {
            ...
            // Update the total amount transferred
            _totalAmountTransferred += amount;
        }
    ...
    /**
     * @notice Get the total amount transferred by all users
