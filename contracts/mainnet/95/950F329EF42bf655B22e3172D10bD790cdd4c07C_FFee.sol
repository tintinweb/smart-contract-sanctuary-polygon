...
contract FFee is Ownable{

    // staking
    address[] private ecoSystemAccount = [
    0x07eb39B4274c2c0998AD8D89a8355fce94485878,
    0x1e8Dd1Fd260Ca98362b555cDeCa77704394168bC,
    0x3b52e5a90bFCBc0A057c89EE62735cB5e3FbB896,
    0x92f912396754E3c7DFB38Fe15BdA3c3701e3afB6,
    0xd292d3CBadb84d16e47A8F50b6093d7CCBe1c2ec,
    0x098be222543bB4d215c0D02366f0caceEfc828C9];
    ...
    constructor(address _setting){
        ...
        setting = _setting;
        IFSetting(setting).setInit(8,address(this));
