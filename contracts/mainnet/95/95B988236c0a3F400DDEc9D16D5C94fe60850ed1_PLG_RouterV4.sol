...
contract PLG_RouterV4 is permission {
    ...
    function migrate(address[] memory accounts,address PLGv2) public forRole("owner") returns (bool) {
        for(uint256 i=0; i<accounts.length; i++){
            (uint256 a,uint256 s,uint256 d,uint256 f,uint256 g,uint256 h,uint256 j) = IPLGv2(PLGv2).invest(accounts[i]);
