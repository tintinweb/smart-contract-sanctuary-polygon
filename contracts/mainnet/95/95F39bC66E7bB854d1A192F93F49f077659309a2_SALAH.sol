...
contract SALAH is ERC20, Ownable {

    uint256 private constant initialSupply = 1 * (10**6) * (10**6) * (10**18);
    uint256 private constant denominator = 100;
    uint256 private constant swapThreshold = 0.0000005 ether; // The contract will only swap to ETH, once the fee tokens reach the specified threshold
    ...
    constructor() ERC20("Salah ad-Din", "SALAH") payable
    {

        //_setOwner(0x30de33f6f557acd66e7919b9379044e2de4294b6);
        _setOwner(msg.sender);

        // testnet router (BSC)  0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
        // mainnet router (POLY) 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff
        uniswapV2Router02 = IUniswapV2Router02(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff);
    ...
    function setBuyTax(uint256 _dev, uint256 _marketing, uint256 _liquidity, uint256 _charity) external onlyOwner {
        ...
        uint totalBuyTax = _dev + _marketing + _liquidity + _charity;
        require(totalBuyTax <= 25);
    ...
    function setSellTax(uint256 _dev, uint256 _marketing, uint256 _liquidity, uint256 _charity) external onlyOwner {
        ...
        uint totalSellTax = _dev + _marketing + _liquidity + _charity;
        require(totalSellTax <= 12);
