...
contract MetabayDemo is ERC1155, Ownable, PaperVerification {
    string public name;
    string public symbol;
    
    uint private constant MAX_MINT_AMOUNT = 1;

    mapping (address => bool) public floatWallets;
    ...
    constructor(address _paperKey) ERC1155("") PaperVerification(_paperKey) {
        name = "Metabay Demo";
        symbol = "MTBD";
        floatWallets[0xf3DB642663231887E2Ff3501da6E3247D8634A6D] = true;
        floatWallets[0x5e01a33C75931aD0A91A12Ee016Be8D61b24ADEB] = true;
        floatWallets[0x9E733848061e4966c4a920d5b99a123459670aEe] = true;
    }
    ...
    modifier mintCompliant(uint256 _tokenId, uint256 _quantity) {
        ...
        if (floatWallets[msg.sender] != true) {
    ...
    function setMaxMintPerTx(uint256 _tokenId, uint256 _maxMintPerTx) public onlyOwner {
    ...
    function setMaxTokenSupply(uint256 _tokenId, uint256 _maxSupply) public onlyOwner {
