...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x303e330FbE0a50677C9ab8A7141E4F6434cB98A2];
...
// File: contracts/XFiContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract XFiContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/lvrgbOlmV4M1BnfSptPd/contract-metadata";
  }
