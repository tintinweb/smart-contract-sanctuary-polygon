...
contract DGTStaking is Initializable {
	...
	function initialize(address _project, address _leader, address _developer) external initializer {
	    ...
	    oldContract = OldContract(0x4eEfb25bc035189b91cC5CE7d54E1a4DDcfcfBEe);
	    crowdMargin = CrowdMargin(0xD1bd2235105CE95e6C1E88990b57c4aF30421850);
	...
	function getPercent() public view returns (uint256 PERCENT_TOTAL) {
		...
		downlines += crowdMargin.totalBoxes(msg.sender);
		if(downlines <= 20) {
...
interface CrowdMargin {
	...
	function totalBoxes(address) external view returns(uint32);
}