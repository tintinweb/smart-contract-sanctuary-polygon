...
contract ZenLlama is ERC721A, Ownable {
    ...
    constructor() ERC721A("ZenLlama", "ZenLlama") {}
     ...
     */
    function toAttributesProperty() internal pure returns (string memory) {
        string[] memory attributes = new string[](4);

        attributes[0] = toJSONNumberAttribute("Trait 1", "1");

        attributes[1] = toJSONAttribute("Trait 2", "2");

        attributes[2] = toJSONAttribute("Trait 3", "3");

        attributes[3] = toJSONAttribute("Trait 4", "4");
                ...
                abi.encodePacked(
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                "{",
                                toJSONProperty("name", "ZenLlama"),
                                ",",
                                toJSONProperty(
                                    "description",
                                    "NFTs with no Metadata - the part that actually costs money."
                                ),
                                ",",
                                toJSONProperty(
                                    "image",
                                    "ipfs://bafybeifsi7qwsht5mnbzibstfifxck2smwqxk2zfwv4do3234tafjtpkvq/0TeSE-6X_400x400.jpg"
                                ),
                                ",",
                                toJSONProperty(
                                    "animation_url",
