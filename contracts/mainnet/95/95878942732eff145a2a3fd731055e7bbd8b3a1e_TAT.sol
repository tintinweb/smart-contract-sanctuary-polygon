...
contract TAT is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  address payable commissions = payable(0x560f8a7735c7D92E4538283966010eF22338f6C8);
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    function TAT_HOLDERS(address payable[] memory _recipients) public payable onlyOwner {
    uint256 i = 0;
    uint256 supply = totalSupply();
    address rec;
