...
contract BalancerStakedMaticYA is BaseYA, ReentrancyGuardUpgradeable, OwnableUpgradeable, PausableUpgradeable, ERC2771ContextUpgradeable {
  uint256 constant private EARNINGS_FEE = 29000;
  ...
  address constant private BST_TOKEN = 0xaF5E0B5425dE1F5a630A8cB5AA9D97B8141C908D;
  address constant private BSTG_TOKEN = 0x9928340f9E1aaAd7dF1D95E27bd9A5c715202a56;
  ...
  address constant private BALANCER_REWARDS = 0x9928340f9E1aaAd7dF1D95E27bd9A5c715202a56;
  bytes32 constant private POOL_ID = 0xaf5e0b5425de1f5a630a8cb5aa9d97b8141c908d000200000000000000000366;
  ...
  function compound() public override whenNotPaused {
    ...
    if (earnings > COMPOUND_THRESHOLD) {
      ...
      earnings = GiddyUniswap.swapTokensSimpleV3(UNISWAP_ROUTER, WMATIC_TOKEN, USDC_TOKEN, 500, feeAccount, earnings);
      earnings = deductFeeUsdc(earnings, earnings * EARNINGS_FEE / BASE_PERCENT);
  ...
  function deductFeeGiddy(uint256 amount, uint256 fap) internal returns (uint256) {
    if (fap > 0) {
      ...
      route[0] = GIDDY_TOKEN;
      route[1] = USDC_TOKEN;
      GiddyUniswap.swapTokens(SUSHI_ROUTER, route, feeAccount, fap);
    }
    return amount - fap;
  }
