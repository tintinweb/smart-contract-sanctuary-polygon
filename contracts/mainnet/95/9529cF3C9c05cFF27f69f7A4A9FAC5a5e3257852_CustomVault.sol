...
contract ERC1363 is ERC20, IERC1363, ERC165 {
    ...
    function approveAndCall(
        ...
        console.log("hello in approve and all");
    ...
    StandardAccessControlEnumerableUpgradeable
{
    ...
    //         _finder
    //     );
    //     //console.log("base sy agya wo");
    //     // //console.log("start of custom vault constructor done");
    //     // TODO : add zero address validation

    //     // _setMaintainer(_initialOwner);
    //     // //console.log("Custom vault constructor done");
    // }
    ...
    function _burn(address _from, uint256 _amount) internal virtual {
        (_from);
        xToken.safeTransferFrom(msg.sender, address(this), _amount);
    ...
    function withdraw(
        ...
        xToken.safeTransferFrom(msg.sender, address(this), xtokens);
        _burn(msg.sender, xtokens);
    ...
    function borrow(uint amount) external onlyMarketplaceBorrowerRole {
        console.log("amount in borrow", amount);
        // uint scaledXAmount = amount * (10 ** (18 - stakeTokenDecimal));
        // console.log("scaled x amount in borrow", scaledXAmount);
        console.log(xToken.balanceOf(msg.sender), "balance of x");
        xToken.safeTransferFrom(msg.sender, address(this), amount);
        console.log("stf hogya");
