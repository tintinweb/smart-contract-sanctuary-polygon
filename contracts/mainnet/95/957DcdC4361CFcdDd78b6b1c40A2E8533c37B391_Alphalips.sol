    ...
    ReentrancyGuard
{
    ...
    event SetDefaultRoyalty(address _receiver, uint256 _fraction);
    ...
    function contractURI() public pure returns (string memory) {
        return "https://api.dev.mayaloka.io/meta-data-opensea";
    }

    // @dev returns approval status of operator on the given owner's tokens
    ...
    // @dev sets default royalty
    function setRoyaltyInfo(address _reciever, uint96 _royaltyBips)
        external
        onlyOwner
    {
        super._setDefaultRoyalty(_reciever, _royaltyBips);
        emit SetDefaultRoyalty(_reciever, _royaltyBips);
    }

    // @dev sets token level  roayalty
