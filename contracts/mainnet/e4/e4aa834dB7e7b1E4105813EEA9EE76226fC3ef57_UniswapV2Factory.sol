...
library SafeMath {
    ...
    function sub(uint x, uint y) internal pure returns (uint z) {
        z = x - y;
        require(z <= x, 'SafeMath: subtraction overflow');
    }
    ...
    function mul(uint x, uint y) internal pure returns (uint z) {
        ...
        z = x * y;
        require(z / y == x, 'SafeMath: multiplication overflow');
    }

    function mul(uint x, uint y, string memory errorMessage) internal pure returns (uint z) {
        if (y == 0) {
            return 0;
        }
        z = x * y;
        require(z / y == x, errorMessage);
    }
    ...
    function div(uint x, uint y, string memory errorMessage) internal pure returns(uint z) {
    ...
    function mod(uint x, uint y, string memory errorMessage) internal pure returns(uint z) {
        require(y != 0, errorMessage);
        return x % y;
    }
}
