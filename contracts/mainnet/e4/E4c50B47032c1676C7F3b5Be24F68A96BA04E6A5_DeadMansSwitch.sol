...
contract DeadMansSwitch is Ownable {
    ...
    function mint(address _onlyOwner, uint256 _cadence) payable external returns (uint256) {
        ...
        uint256 cost = 4 * uint256(getUSD());
        require(msg.value >= cost, string.concat("You need to at least send ", Strings.toString(cost)));
     ...
     */
    function getUSD() public view returns (int) {
        (
            /*uint80 roundID*/,
            int price,
            /*uint startedAt*/,
