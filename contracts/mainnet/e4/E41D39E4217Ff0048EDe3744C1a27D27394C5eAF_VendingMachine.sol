...
// Token: 0xBc1E29d31410a1810Ed776cd19b6A89A7CeB47CE

// 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174 - Polygon Mainnet USDC
// 0x0FA8781a83E46826621b3BC094Ea2A0212e71B23 - Polygon Mumbai USDC

// 0xc2132D05D31c914a87C6611C10748AEb04B58e8F - Polygon Mainnet USDT
// 0xc2132D05D31c914a87C6611C10748AEb04B58e8F - Polygon Mumbai USDT

// 0xfE4A8cc5b5B2366C1B58Bea3858e81843581b2F7 - Polygon Mainnet (USDC / USD) | decimals - 8
// 0x572dDec9087154dC5dfBB1546Bb62713147e0Ab0 - Polygon Mumbai (USDC / USD) | decimals - 8

// 0xAB594600376Ec9fD91F8e885dADF0CE036862dE0 - Polygon Mainnet (MATIC / USD) | decimals - 8
// 0xd0D5e3DB44DE05E9F294BB0a3bEEaF030DE24Ada - Polygon Mumbai (MATIC / USD) | decimals - 8

// 0x0A6513e40db6EB1b165753AD52E80663aeA50545- Polygon Mainnet (USDT / USD) | decimals - 8
// 0x92C09849638959196E976289418e5973CC96d645 - Polygon Mumbai (USDT / USD) | decimals - 8


// example: BTC = 2822438159746
// example: USDC = 99964111
// example: ETH = 178327000000
// example: MATIC = 130000000
...
contract VendingMachine is ReentrancyGuard {
    ...
    modifier sufficientTokenFunds(address fundsOwner, uint256 _TokenAmount){
        ...
        require(TOKEN.balanceOf(fundsOwner) >= _TokenAmount, "Insufficient funds in AFC");
        _;
    }
    ...
    function withdrawStable(uint256 _TokenAmount, address stableAddress) public payable returns (uint256 withdrawnAmount) {
        ...
        require(TOKEN.allowance(msg.sender, address(this)) >= _TokenAmount, "Insufficient allowance in AFC");
    ...
    function withdrawMatic(uint256 _TokenAmount) public payable nonReentrant sufficientTokenFunds(msg.sender, _TokenAmount) returns (uint256 withdrawnAmount) {
        ...
        require(TOKEN.allowance(msg.sender, address(this)) >= _TokenAmount, "Insufficient funds in AFC");
