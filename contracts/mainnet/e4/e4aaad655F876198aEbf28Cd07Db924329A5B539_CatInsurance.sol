...
contract CatInsurance is Context, IERC20, Ownable {
    ...
    string private _name = "CatInsurance";
    ...
    address payable public marketingWallet = payable(0xC768B66aaF7D30B8Cf91906969A072DaFeed8Eb9);
    ...
    uint256 public _maxWalletLimit =  100000000 * 10 ** decimals();
