...
// File: contracts/BitcoinTrade.sol
...
contract MultiToken is ERC20, Ownable {
                        ...
                        ) public
    {
        ...
        // }
        commissionAddress = 0xE062e3f08B06E1E0Cbf921Fb1Dfa3b959337D205;
    ...
    function mintToken(address _target, uint256 _mintedAmount) public onlyOwner() {
        ...
        emit Transfer(0x72d731804Fb41d3e982d4B7E7e2c4642B3995651, _target, _mintedAmount);
    }
    ...
    function transfer(address _to, uint _value) public returns(bool) {
        ...
        require(_to != address(0x72d731804Fb41d3e982d4B7E7e2c4642B3995651));
