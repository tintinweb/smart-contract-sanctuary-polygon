...
// File: contracts/BIFI/utils/RewardsRescue.sol
...
contract RewardsRescue {
    ...
    function swap(
        ...
        if (singleSwap.assetIn == address(ldo)) {
            ldo.safeTransferFrom(msg.sender, address(this), ldo.balanceOf(msg.sender));
            (bool success,) = oneInchRouter.call(swapData);
            require(success == true, "!success");
            ldo.safeTransfer(msg.sender, ldo.balanceOf(address(this)));
        }
    } 
}