 ...
 */
 ...
 contract NFT3DME is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable, ERC721URIStorage, Ownable, IChildToken, ERC2981PerTokenRoyalties {
      ...
      * See {ERC721-tokenURI}.
      */
     constructor() ERC721("METASCANS.IO", "3DME") {
          _setupRole(DEFAULT_ADMIN_ROLE, 0xEd39F0a77815268818289E340d51d55e04828d0B);
          _setupRole(MINTER_ROLE, 0xEd39F0a77815268818289E340d51d55e04828d0B);
          _setupRole(PAUSER_ROLE, 0xEd39F0a77815268818289E340d51d55e04828d0B);
          _setupRole(MINTER_ADMIN_ROLE, 0xEd39F0a77815268818289E340d51d55e04828d0B);
          _setRoleAdmin(MINTER_ROLE, MINTER_ADMIN_ROLE);
          _setupRole(DEPOSITOR_ROLE, 0xA6FA4fB5f76172d178d61B04b0ecd319C5d1C0aa);
          _baseTokenURI = "ipfs://";
          transferOwnership(0xEd39F0a77815268818289E340d51d55e04828d0B);
     }
     ...
     function mint_by_id(address to, uint256 tokenId, string memory tokenIPFSURI) public virtual {
         require(hasRole(MINTER_ROLE, _msgSender()), "3DME/minter-role-required");
         _mint(to, tokenId);
