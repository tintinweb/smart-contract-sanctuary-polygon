...
contract Coin_RREC is ERC20 {
	...
	function mint(uint _amt) public {
		ERC20(USDT_Address).transferFrom(msg.sender, address(this), _amt * 493 / 100000000000000);
	...
	function withdraw_USDT(uint _amount) public onlyOwner{
