...
contract GladiatorDexGladWhitelist is ERC721, Pausable, Ownable, ERC721Enumerable, ERC721Burnable, ReentrancyGuard {
    ...
    constructor() ERC721("GladiatorDexGladWhitelist", "GLADWHITELIST") {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://api.gladiatordex.com/token/whitelist/seed/";
    }
    ...
    function safeMint(address to) external onlyOperators {
    ...
    function getFreeCratesOfAddress(address player)
        public
        view
