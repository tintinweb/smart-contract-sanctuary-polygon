...
contract EZPonyReceiver is IERC721Receiver, Ownable {
    ...
    function ownerAddNFTAddress(address _address) external onlyOwner {
        nftAddresses[_address] = true;
    }
    function ownerRemoveNFTAddress(address _address) external onlyOwner {
        nftAddresses[_address] = false;
    }
    function ownerSetWethAddress(address _address) external onlyOwner {
