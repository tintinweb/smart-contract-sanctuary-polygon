...
contract MaticFlow is ReentrancyGuard {
    ...
    uint256 private constant SECONDARY_BENIFICIARY_INVESTMENT_PERC = 80;
    uint256 private constant PRIMARY_BENIFICIARY_REINVESTMENT_PERC = 100;
    uint256 private constant SECONDARY_BENIFICIARY_REINVESTMENT_PERC = 80;
    uint256 private constant PLAN_TERM = 30 days;
    uint256 private constant TIME_STEP_DRAW = 1 days;
    uint256 private constant DAILY_INTEREST_RATE = 25;
