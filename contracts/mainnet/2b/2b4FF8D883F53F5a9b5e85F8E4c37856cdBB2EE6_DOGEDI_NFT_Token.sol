...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
    ...
    uint256 public tokenPrice = 80 ether;//80 MATIC
    uint256 constant public MAX_SUPPLY = 10_000;//10000 NFTs
    string public baseURI = "ipfs://QmU48YTycPDqnX76B4YRxM8DZ5NRLDMMBdPRAzM1AqE6UD/";
...
/* custom functions */
    ...
    function mintTokenNFT (uint256 _numTokens)  public payable returns (bool success){
         require((mintingIsLive == true)||(admin == msg.sender), "Minting is not available");
         require(totalSupply()+(_numTokens) <= MAX_SUPPLY,"Collection is not more available");
         require (_numTokens <= 100 || admin == msg.sender ,"Max 100 Mints each transaction");
    ...
    function setMintingIsLive (bool _isLive) public  returns (bool ){
    require(admin == msg.sender , "Only Admin can act here");
    mintingIsLive = _isLive;
    return _isLive;
}
    ...
    /*Admin withdraw the contract balance*/
...
contract DOGEDI_NFT_Token is ERC721A {
    
  //Name symbol   
    constructor() ERC721A("DOGEDI NFT", "DOGEDI")  {
