...
//taken from the v 2.5 and updated for current solidity 0.8.0
...
contract CrowdSale is Context, ReentrancyGuard {
     ...
     */
    constructor (uint256 rate, address payable wallet, uint256 minInvest, uint256 maxInvest, IERC20 token) {
    ...
    function buyTokens(address beneficiary) public nonReentrant payable {
        ...
        require(msg.value >= _minInvest && msg.value <= _maxInvest);
