...
contract ValireumToken is ERC20, ERC20Burnable {
    ...
    uint16 _paymentMatches = 300; // How many match payment required for the seeders to get paid
    uint8 _maxPayment = 100; // Seed payment percentage a 100 of 1%
    uint8 oldSeedCount = 197; // number of old VLM holders
