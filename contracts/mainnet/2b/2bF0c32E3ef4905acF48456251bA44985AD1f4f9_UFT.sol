...
contract UFT is ERC20, Ownable {
    ...
    constructor () ERC20("Ultra AI", "UFT") 
    {   
        ...
        marketingWallet = 0xB69b3a9A3937961AF818562679bEea2B7Dd20dFf;
    ...
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to] || swapping) {
            ...
            require(!isContract(to), "Contracts not allowed.");
        } else if (to == uniswapV2Pair) {
            _totalFees = _totalFeesOnSell;
            require(!isContract(from), "Contracts not allowed.");
        } else {
            _totalFees = 0;
        }
