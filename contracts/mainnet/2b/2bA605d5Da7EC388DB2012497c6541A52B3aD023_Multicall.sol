...
contract Multicall is Initializable, OwnableUpgradeable {
    ...
    IIDOExtra public constant iIDOExtra=IIDOExtra(0x266583dd8a76Fb87b608e3119C10a50a75334630);
    address public constant IDOAddress =
        address(0x876cDf2c514D1a9e6Ca3161537ef9fA25796971d);
    address public constant LockAddress =
        address(0xEFbB917893d8D6Edea7D256ef7ee397Fc8C2369e);
