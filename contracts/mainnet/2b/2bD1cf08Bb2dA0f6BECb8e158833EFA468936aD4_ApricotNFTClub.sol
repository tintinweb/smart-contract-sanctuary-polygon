...
contract ApricotNFTClub is ERC721A, Ownable {
  using Strings for uint256;

  string public baseURI;
  string public baseExtension = ".json";
  string public notRevealedUri;
  uint256 public cost = 235000000000000000000;
  uint256 public maxSupply = 4444;
  uint256 public maxPublicSaleMint = 13;
  bool public publicsale = false;
  bool public revealed = false;

  mapping(address => uint256) public publicMintedBalance;

  constructor() ERC721A("Apricot NFT Club", "ANC") {
  }
