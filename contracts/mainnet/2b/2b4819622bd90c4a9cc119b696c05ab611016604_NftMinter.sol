...
contract NftMinter is ERC721, AccessControl {
    ...
    constructor(
        ...
        _setupRole(PAYOUT_ROLE, msg.sender);
    ...
    /**
     * @dev Allows administrators to mint a number of tokens at no cost.
     *
     * This is typically used to create NFTs for sale on third-party marketplaces like OpenSea.
     *
     */
    ...
    /**
     * @dev Allows administrators to burn administrator owned tokens.
     */
