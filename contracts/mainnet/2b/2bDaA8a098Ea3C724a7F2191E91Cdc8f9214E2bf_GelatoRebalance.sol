...
contract GelatoRebalance is Ownable {
    IQiStrat public strat = IQiStrat(0x8627D7239D9c2ade3D9B366465f7aa710B7a1C5E);

    function updateStrat(IQiStrat _strat) external onlyOwner {
        strat = _strat;
    }
    ...
    function checker() external view returns (bool canExec, bytes memory execPayload) {
        ...
        execPayload = abi.encodeWithSelector(IQiStrat.rebalanceVault.selector, true);
    }
}
