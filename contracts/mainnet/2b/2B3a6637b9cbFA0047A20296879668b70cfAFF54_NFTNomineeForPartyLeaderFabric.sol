...
/// @title NFTNomineeForPartyLeader fabric
contract NFTNomineeForPartyLeaderFabric is
    Base,
    Access,
    ...
    SaleTaxNumeratorStorage
{
    ...
    /// @param implementationAddress implementation of NFTNomineeForPartyLeader
    /// @param treasuryAddress treasury
    /// @param coinAddress coin
    /// @param mintPriceValue mintPrice
    /// @param transferTaxValue transferTax
    /// @param saleTaxNumeratorValue saleTaxNumerator
    ...
    function _init(
        ...
        NFTNomineeForPartyLeader(result).initialize({
            nameValue: string(abi.encodePacked("NFT Nominee For Party Leader", tokenId.toString())),
            symbolValue: string(abi.encodePacked("NfPL", tokenId.toString())),
            versionValue: "1",
    ...
    function _init2(
        ...
        NFTNomineeForPartyLeader(result).initialize2({
