...
contract BIGBondDepository is Ownable {
    ...
    function payoutFor( uint _value ) public view returns ( uint ) { // bondPayout
        // 3.7087835 * 1e40 = 7.1428571e+24
        // 7.1428571 * 1e+24 / 1e16 = 7.1428571 * 1e8 = 714285714

        // payout = 456000 / bondPrice = 45600
        // payout = 456000 / 1800000 = 45600
    ...
    function _bondPrice() internal returns ( uint price_ ) {
        // price_ = BCV * debtRatio() + 1000000000
        // debtRatio = 0.1
        // BCV = 40
        // Total Supply - BIG
