...
contract LimitOrderManagerV3 is
    ...
    function setNextMonitor(uint32 _nextMonitorIndex) public {
        isAuthorizedController();
        require(_nextMonitorIndex <= monitors.length - 1, 'Monitor index does not exist');
        nextMonitor = _nextMonitorIndex;   
    }
