...
// todo: switch name
contract TESTBC1 is Ownable, ERC20, Pausable, ReentrancyGuard { 
  ...
  modifier wontBreakTheBank(uint256 amountBNJItoBurn) {        
    ...
    // todo: switch name
  constructor() ERC20("TESTBC1", "TPJ4") {
    // Manage Benjamins
    ...
    feeReceiver = 0x9A8A1C76e46940462810465F83F44dA706953F69;   // todo: set to correct address
