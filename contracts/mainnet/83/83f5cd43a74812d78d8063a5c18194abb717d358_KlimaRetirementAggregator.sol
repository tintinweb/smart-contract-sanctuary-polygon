    ...
    OwnableUpgradeable
{
    ...
    /**
     * @notice Functionally the same as the retireCarbon function with one
     * additional variable passed through to the Toucan retirement function
     * for recording the string of the retiring entity.
     *
     * @param _retiringEntityString String value of the retiring entity passed to Toucan NFT.
     */
    function retireCarbonWithRetiringEntity(
        address _sourceToken,
        address _poolToken,
        uint256 _amount,
        bool _amountInCarbon,
     ...
     *          carbon to offset or the total source to spend. See _amountInCarbon.
     * @param _amountInCarbon Bool indicating if _amount is in carbon or source.
     * @param _retiringEntityString String for the retiring entity used in Toucan NFT.
     * @param _beneficiaryAddress Address of the beneficiary of the retirement.
     * @param _beneficiaryString String representing the beneficiary. A name perhaps.
     * @param _retirementMessage Specific message relating to this retirement event.
    ...
    /**
     * @notice Functionally the same as the retireCarbonSpecific function with one
     * additional variable passed through to the Toucan retirement function
     * for recording the string of the retiring entity.
     *
     * @param _retiringEntityString String value of the retiring entity passed to Toucan NFT.
     */
    function retireCarbonSpecificWithRetiringEntity(
        address _sourceToken,
        address _poolToken,
        uint256 _amount,
        bool _amountInCarbon,
