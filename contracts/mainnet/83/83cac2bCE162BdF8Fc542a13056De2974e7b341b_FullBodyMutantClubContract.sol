...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x4660d3a79083088E8301bafC9C8DC02F20C114c2];
  address public erc20Payable = 0x4660d3a79083088E8301bafC9C8DC02F20C114c2;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 100, 1077) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeigcemldqhev7w5kc7whjw6pftxpo3ke2zshp5oxrplrsuvsju3iy4/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/WcxFWrR5WqfKKsR0CjEc/contract-metadata";
  }
...
// File: contracts/FullBodyMutantClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract FullBodyMutantClubContract is RamppERC721A {
    constructor() RamppERC721A("Full Body MutantClub", "FBMC"){}
}
