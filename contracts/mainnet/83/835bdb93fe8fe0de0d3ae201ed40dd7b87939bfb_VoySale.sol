...
// File: EnvoyNew/Polygon/VoySale.sol
...
/**
 * VoySale contract in the Polygon network
 */
 contract VoySale is Ownable, Pausable {
    uint256 public priceMatic = 130000000000000000; //Equivalent to USD 0.12
    ...
    function buy(uint256 _amount) public payable whenNotPaused {
        ...
        require(msg.value == _amount * priceMatic / 1e18, "Invalid value");
    ...
    function updatePrice(uint256 _priceMatic) public onlyOwner {
