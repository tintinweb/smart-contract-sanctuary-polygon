...
contract FalineArena8 is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxSupply = 2612;
  uint256 public maxMintAmountPerTx = 200;

  bool public paused = true;
  bool public revealed = false;

  constructor() ERC721("Faline Arena 8", "FA8") {
    setHiddenMetadataUri("ipfs://bafybeic2cm54fzqjmmzekrduyprbvctfnary7q7bx236d3jyo5tgx3wp64");
  }
