...
contract StrategyPenrose_USDPLUS_USDC is Strategy0xDAOMaximizer {

    address usdplus_usdc_diff;

    function initializeStrategy(
        address _store,
        address _vault
    ) public initializer {
        address usdplus_usdc_lp = address(0x421a018cC5839c4C0300AfB21C725776dc389B1a);
        ...
        __Strategy_init(
            ...
            _vault,
            rewards,
            0x39b3a36d7d6b2bae6e13d2Ceb00f847Aa3E6990A,
            false,
