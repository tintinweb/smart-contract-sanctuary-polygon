...
import '@openzeppelin/contracts/token/ERC20/IERC20.sol';
import '@ascentexchange/v3-core/contracts/libraries/LowGasSafeMath.sol';
...
interface IPeripheryImmutableState {
    /// @return Returns the address of the AscentExchange V3 deployer
    function deployer() external view returns (address);

    /// @return Returns the address of the AscentExchange V3 factory
    function factory() external view returns (address);
...
import '@ascentexchange/v3-core/contracts/interfaces/callback/IAscentV3SwapCallback.sol';

/// @title Router token swapping functionality
/// @notice Functions for swapping tokens via AscentExchange V3
interface ISwapRouter is IAscentV3SwapCallback {
...
library PoolAddress {
    bytes32 internal constant POOL_INIT_CODE_HASH = 0x51a50a9e2f72703fa46b376173ad83ea804c80a82d815ea5f7cfcafc1d1d0f27;
    ...
    /// @param deployer The AscentExchange V3 deployer contract address
...
import '@ascentexchange/v3-core/contracts/libraries/SafeCast.sol';
import '@ascentexchange/v3-core/contracts/libraries/TickMath.sol';
import '@ascentexchange/v3-core/contracts/interfaces/IAscentV3Pool.sol';
...
/// @title Ascent V3 Swap Router
/// @notice Router for stateless execution of swaps against Ascent V3
    ...
    SelfPermit
{
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IAscentV3Pool) {
        return IAscentV3Pool(PoolAddress.computeAddress(deployer, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }
    ...
    /// @inheritdoc IAscentV3SwapCallback
    function ascentV3SwapCallback(
        int256 amount0Delta,
        int256 amount1Delta,
