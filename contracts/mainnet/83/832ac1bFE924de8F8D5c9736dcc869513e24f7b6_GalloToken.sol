...
// File: contracts/Gallo_0.2.sol/Gallo.sol
...
contract GalloToken is ERC20, Ownable {
    ...
    uint256 public hardcap = 200_000_000_000000000000000000;
    ...
    modifier onlyMinter() {
        require(minters[msg.sender], "Gallo:NOT_MINTER");
        _;
    }

    function setMinter(address minterAddress, bool state) public onlyOwner {
        minters[minterAddress] = state;
    }
