...
contract OMUSUBI is ERC1155, Ownable {
    string public name = "OMUSUBI";
    string public symbol = "OMSB";


    constructor() ERC1155("https://gateway.pinata.cloud/ipfs/QmTDamFabzKmMbsvBbrsJSc77VQaqtHWGsZc1H6phR5vcp") {
    }
