...
contract ITS_DZBV1 is ERC721Enumerable, Ownable {
    ...
    //Pricing
    //***************************************************************************************************
    uint256 public pricePublic = 10 * 10 ** 18; // 10 Matic Default

    //***************************************************************************************************
    //Supply and Reserve
    //***************************************************************************************************
    uint256 public maxSupply = 100000; // set max supply
    uint256 public reserve = 10; // reserve token amount
    ...
    //Public Mint
    //***************************************************************************************************
    function publicMint(uint256 __count) external payable {

        uint256 supply = totalSupply();
        require(!paused, "The Contract is not active at the moment.");
