...
contract VoteModule is Module
{
	...
	uint256 public constant DEFAULT_QUORUM = 90e16; // 90%
	uint256 public constant DEFAULT_ABSTENTION = 30 days;

	mapping(address => Data) public data;
	function data_votes(address _fractions, bytes32 _actionId) external view returns (uint256 _votes) { return data[_fractions].votes[_actionId]; }
	function data_timestamp(address _fractions, address _account) external view returns (uint256 _timestamp) { return data[_fractions].timestamp[_account]; }
