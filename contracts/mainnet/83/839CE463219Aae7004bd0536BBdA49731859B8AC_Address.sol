...
// File: contracts/SPACE_CROCOS_APPAREL_COLLECTION.sol
...
contract SPACE_CROCOS_APPAREL_COLLECTION is
    ERC1155,
    ERC1155Burnable,
    ERC2981,
    Ownable,
    ...
    DefaultOperatorFilterer
{
    ...
    function mint(address to, uint256 id) public nonReentrant whenNotPaused {
        _mint(to, id, 1, "");
    }
