 ...
 * @notice This contract handles minting Poko test tokens.
 */
contract PokoTest is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xf222FCC5686285E3311837Be8203673E178d6C55;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xF17A89fE3f9A64bb9b260832E7c0e64cc85f3095;
    address[] public payoutAddresses = [
        0x564f01C35941F276d523A9953939A1304a0a56fd,
        0xF17A89fE3f9A64bb9b260832E7c0e64cc85f3095
    ];
    ...
    string public name = "Poko test";
    string public symbol = "testpoko";
    ...
    uint256[] public payoutBasisPoints = [100, 9900];
    uint96 public royaltyFee = 10000;

    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeiaf7aaurus2ax3kn65w2b7yb6ax7bseh7g2bpshc4ufr4gu5ensry/{id}"
        )
        RevokableOperatorFilterer(
