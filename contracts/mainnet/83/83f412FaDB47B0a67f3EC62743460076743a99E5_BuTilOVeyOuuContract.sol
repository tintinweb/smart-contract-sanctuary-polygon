...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1674877200;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0xBA577b65E22430064f24F63E726B61b08528DB5B];
  address public erc20Payable = 0xBA577b65E22430064f24F63E726B61b08528DB5B;
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 25, 250) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeib5e3phs7glx2rxqkznb4tcexfeatxw263sj2juf3vmp5aagjcp7q/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/edo9Q0uMTkw8i8oJmNm7/contract-metadata";
  }
...
// File: contracts/BuTilOVeyOuuContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BuTilOVeyOuuContract is RamppERC721A {
    constructor() RamppERC721A("BuT i lOVe yOUU", "WLDFLRVL"){}
}
