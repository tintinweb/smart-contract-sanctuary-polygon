...
contract MockERC20 is ERC20, AccessControl {
    ...
    function transfer(address to, uint256 amount) public virtual override whitelisted returns (bool) {
    ...
    function whitelist(bool status, address[] calldata addresses) external onlyRole(DEFAULT_ADMIN_ROLE) {
