...
contract TestA is Ownable, ERC721Enumerable, ERC2981, AccessControlEnumerable, ERC721URIStorage {
    ...
    event SetLocked(uint16 tokenId, bool _locked);
    ...
    function setLocked(uint16 tokenId, bool _locked) external onlyOwner {
        ...
        emit SetLocked(tokenId, _locked);
    }
