...
contract NyscMarketTime2022 is IMarketTime {
    ...
    function setOffsets(uint256 start, uint256 end) public {
        startTimeOffsetEDT = start;
        endTimeOffsetEDT = end;
        startTimeOffsetEST = start + 1 hours;
        endTimeOffsetEST = end + 1 hours;
    }
