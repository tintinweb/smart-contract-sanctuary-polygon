...
contract ClubVirtual is ERC1155 {
    ...
    constructor() ERC1155("https://clubvirtual.io/") {}
    ...
    function transferAmount(address creator, address admin, address owner, uint256 _amount, uint256 adminpercent, uint256 royaltypercent) public payable{   
        require(msg.value == _amount);
        uint256 ownerpercent=(1000000000000-adminpercent-royaltypercent);
        uint256 creatoramount = (_amount * royaltypercent)/1000000000000;
        uint256 adminamount = (_amount*adminpercent)/1000000000000;
        uint256 owneramount = (_amount*ownerpercent)/1000000000000;
