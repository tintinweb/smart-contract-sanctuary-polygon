...
contract APC is Context, IERC20, Ownable {
    ...
    string private _name = "AnimatedPunkzCoin";
    ...
    address public MarketingWallet = 0x5f42E79570bA8d79A466403ea28399B032C97aEF;
    ...
    uint256 public _maxTxAmount = 10000000000 * 10**18; // 10% Max transaction from total supply
