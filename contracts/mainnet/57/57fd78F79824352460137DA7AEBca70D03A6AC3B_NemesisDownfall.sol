...
contract NemesisDownfall is Context, NemesisDownfallECO, Ownable {
    ...
    string private _name = 'Nemesis Downfall';
    string private _symbol = 'NMSIS';
