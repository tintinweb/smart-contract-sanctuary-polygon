...
contract MATICFARMS {
	...
	uint constant public			INVEST_MIN_AMOUNT				= 20 ether;				// 1 MATIC
	uint[] public					REFERRAL_PERCENTS				= [50, 30, 20, 5, 5];	// 7% 2% 1% 0.5% 0.5%
	uint constant public			DEV_FEE							= 190;					// dev fee 10% of deposit
	...
	uint constant public			GUARD_LOWBALANCE_PERCENT	= 400;					// protection kicks in at 25% or lower
	uint constant public			REINVEST_PERCENT			= 300;					// auto reinvest 10% of claim
    uint constant public			LOWBALANCE_REINVEST_PERCENT	= 500;					// auto reinvest 30% of claim when low balance
