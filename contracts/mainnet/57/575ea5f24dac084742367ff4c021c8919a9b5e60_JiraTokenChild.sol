...
/// @title Jira Token Child
/// @author phaze (https://github.com/0xPhaze)
contract JiraTokenChild is UUPSUpgrade, OwnableUDS, ERC20BurnableUDS, FxERC20UDSChild, AccessControlUDS {
    string public constant override name = "Jira Token";
    string public constant override symbol = "JIRA";
