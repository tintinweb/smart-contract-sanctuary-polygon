    ...
    RevokableOperatorFilterer
{
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeiayewqttuhtys4ibsb7b5s7kbaxxu4kces4gtoix5enooeaulxlka/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenPublicPrice[1] = 72 ether;
        tokenPublicMintsPerAddress[1] = 1;
        tokenPublicSaleStartTime[1] = 1688022000;
        tokenPublicSaleEndTime[1] = 1696057140;
        tokenUsePublicSaleTimes[1] = true;
        tokenPresaleMaxSupply[1] = 108;
        tokenPresalePrice[1] = 36 ether;
        tokenPresaleMintsPerAddress[1] = 1;
        tokenPresaleSaleStartTime[1] = 1686553200;
        tokenPresaleSaleEndTime[1] = 1688020200;
