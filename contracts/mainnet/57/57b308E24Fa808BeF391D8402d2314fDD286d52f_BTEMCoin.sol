...
*/
    function withdrawToken(IERC20 contractToken, uint256 amount) public onlyOwner{
    ...
    */
    ...
    /**
     * @dev Mint new tokens
     * @param account to which to send the new minted tokens
     * @param amount tokens to be minted
     */
    function mint(address account, uint256 amount) public withGrant {
    ...
    /**
     * @dev Burn tokens
     * @param account to which to burn the tokens
     * @param amount tokens to be burned
     */
    function burn(address account, uint256 amount) public withGrant {
    ...
    function _mint(address account, uint256 amount) internal {
        ...
        //_beforeToke nTransfer(address(0), account, amount);
    ...
    function deleteContract() public payable withGrant{
