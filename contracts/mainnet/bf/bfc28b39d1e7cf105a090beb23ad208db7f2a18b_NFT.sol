...
contract NFT is ERC721Enumerable, Ownable {
  ...
  uint256 public maxMintAmount = 8000;
  bool public paused = false;
  mapping(address => bool) public whitelisted;

  constructor() ERC721("Ape of Crypto", "AOC") {
    setBaseURI("ipfs://Qmf6foQJFFweJpHErVbwveFjzH8vYdvJXxCq2TKxf7cR6m/");
    mint(msg.sender, 50);
  }
  ...
  function withdraw() public payable onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0xB59AD82957baCe8E968aD5a79A14b0392F8a17ff).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
