...
contract PublicGovSale is
    ...
    function buyToken(
        ...
        uint128 boosterFee = booster[running].fee_d2;

        _amountIn = (_amountIn * 1e4) / (1e4 + boosterFee); // retrieve amountIn - tax
        ...
        uint128 feeCharged = amountInFinal.calcPercent2Decimal(boosterFee);
