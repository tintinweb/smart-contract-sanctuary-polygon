...
contract MaiVaultBack is BaseSiloAction {
    ...
    function enter(
        ...
        console.log("############## enter mai back vault id %s  inputAmounts[0]: %s  inputAmounts[1]:%s", vaultId,inputAmounts[0],inputAmounts[1]);

        console.log("############## enter mai back vault id %s  inputAmounts[2]: %s  inputAmounts[3]:%s", vaultId,inputAmounts[2],inputAmounts[3]);

        console.log("############## enter mai back vault id %s  vaultDebt: %s", vaultId,vaultDebt);
    ...
    function exit(
        ...
        console.log("############## exit mai back vault id %s  inputAmounts[0]: %s  inputAmounts[1]: %s", vaultId,inputAmounts[0],inputAmounts[1]);

        console.log("############## exit mai back vault id %s  inputAmounts[2]: %s  inputAmounts[3]: %s", vaultId,inputAmounts[2],inputAmounts[3]);

        console.log("############## exit mai back vault id %s  vaultDebt: %s  miBalance: %s", vaultId,vaultDebt, miBalance);
