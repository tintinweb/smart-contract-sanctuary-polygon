...
import "./interfaces/IDokolet.sol";
import "./interfaces/IDokoletToken.sol";
...
contract NFTStakingVault is Ownable, IERC721Receiver {
    ...
    IDokolet immutable nft;
    IDokoletToken immutable token;
    ...
    constructor(address _nftAddress, address _tokenAddress) {
        nft = IDokolet(_nftAddress);
        token = IDokoletToken(_tokenAddress);
    }
