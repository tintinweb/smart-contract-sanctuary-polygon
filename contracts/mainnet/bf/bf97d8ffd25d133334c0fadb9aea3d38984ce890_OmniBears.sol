...
contract OmniBears is Ownable, ERC721, NonblockingReceiver {
    ...
    uint256 MAX_MINT_POLYGON = 2000;
    uint256 public mintPrice = 90 ether;
    ...
    // first 100 NFTs for free then for 90 MATIC ( MAX 3 NFT PER WALLET)
