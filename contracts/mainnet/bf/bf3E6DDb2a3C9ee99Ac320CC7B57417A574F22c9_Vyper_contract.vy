...
def __init__(_name: String[32], _symbol: String[32], _decimals: uint8, _supply: uint256):
    # Probaly want to add admin_address and vault_address to separate concerns according to vault design,
    # There will be multiple vaults but only 1 admin. Only admin can mint and burn.
