...
contract AAPE is AAPEDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private AAPETeam;
    address private CharityAAPE;
    ...
    string public override name = "ALPHA APE";
    string public override symbol = "AAPE";
    ...
    constructor(uint totalSupplyValue, address AAPETeamAddress, address CharityAAPEAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        AAPETeam = AAPETeamAddress;
        CharityAAPE = CharityAAPEAddress;
        
        // split the tokens according to agreed upon percentages
        balances[AAPETeam] =  totalSupply * 4 / 100;
        balances[CharityAAPE] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's AAPETeam pot
