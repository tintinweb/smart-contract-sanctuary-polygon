...
contract VaultCore is VaultStorage {
    ...
    function _rebase() internal whenNotRebasePaused {
        ...
        console.log("@deposit: Total MATICPlus Supply: ", maticPlusSupply);
        if (maticPlusSupply == 0) {
            return;
        }
        uint256 vaultValue = _checkBalance();
        console.log("@deposit: vaultValue ", vaultValue);
        ...
        if (vaultValue > maticPlusSupply) {
            console.log("@deposit: Still vault value greater than supply, changing supply of MATICPlus for vaultValue ", vaultValue);
    ...
    function _calculateRedeemOutput(uint256 _amount) internal view returns (uint256, uint256, uint256) {
        ...
        uint256 primaryStableDecimals = Helpers.getDecimals(primaryStableAddress);
        uint256 totalBalance = primaryStableBalance;
        uint256 redeemFee = 0;
        ...
        console.log("@deposit: _calculateRedeemOutput called!");
