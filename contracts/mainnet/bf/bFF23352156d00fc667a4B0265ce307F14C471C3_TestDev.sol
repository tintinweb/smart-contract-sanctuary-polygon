...
abstract contract FTStandard is ERC20, ERC20Burnable, AccessControlEnumerable {
    ...
    // @notice Override `decimals()` function of ERC20
...
contract TestDev is FTStandard {
    constructor(string memory _name, string memory _symbol, uint8 _decimals)
        FTStandard(_name, _symbol, _decimals) {
        // do nothing
    }
}
