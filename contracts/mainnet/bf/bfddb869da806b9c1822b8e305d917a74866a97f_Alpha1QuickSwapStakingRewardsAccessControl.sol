...
contract Alpha1QuickSwapStakingRewardsAccessControl {
    ...
    // ACL methods
    function getReward() external view onlySelf {
        require(_checkedValue == 0, "invalid value");
    }

    function stake(uint256 amount) external view onlySelf {
        require(_checkedValue == 0, "invalid value");
    }

    function withdraw(uint256 amount) external view onlySelf {
        require(_checkedValue == 0, "invalid value");
    }
