...
contract PolyMagic is ERC721 {
    uint256 public totalSupply;
    uint256 public cost = 1 ether;
    uint256 public maxMints = 103;
    ...
    function mint() external payable {
        ...
        if (totalSupply + 1 > 103) revert SoldOut();
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeihqzffdn3z5st5uqkqqgquhkgkigc3gze3pdvsu2f7w3bqxal5h3u/", Strings.toString(tokenId), ".json")
            );
    }
