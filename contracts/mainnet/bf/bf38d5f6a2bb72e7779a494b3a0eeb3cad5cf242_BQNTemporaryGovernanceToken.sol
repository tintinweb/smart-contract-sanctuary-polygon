...
// File: contracts/BQNTemporaryGovernanceToken.sol
...
contract BQNTemporaryGovernanceToken is ERC721Enumerable, Ownable {

    mapping(address => bool) public mintedAddressMap;
    bool public paused = false;
    string public baseURI = 'https://nakada-files.s3.ap-northeast-1.amazonaws.com/BQN/BTG/metadata.json';

    modifier disabled { revert("Disabled"); _; }

    constructor() ERC721("BQN Temporary Governance Token", "BTG") {}

    function mint() public {
        if (paused) revert("paused");
        if (!mintedAddressMap[msg.sender]) {
            mintedAddressMap[msg.sender] = true;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        require(_exists(tokenId), "BQNTemporaryGovernanceToken: URI query for nonexistent token");
        return baseURI;
    }
