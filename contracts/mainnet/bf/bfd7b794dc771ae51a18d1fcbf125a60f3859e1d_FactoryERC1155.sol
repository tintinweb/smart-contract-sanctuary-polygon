  ...
  UUPSUpgradeable 
{
  ...
  event AddedToWhitelist(address indexed account, address indexed byAddress);

  event RemovedFromWhitelist(address indexed account, address indexed byAddress);
  ...
  function initialize(address adminBackup) public initializer {
    ...
    _grantRole(OPERATOR_ROLE, adminBackup);
    _grantRole(CENSOR_ROLE, adminBackup);
    _grantRole(PAUSER_ROLE, adminBackup);
    ...
    whenNotPaused
  {
    ...
    emit NewNFTContractDeployed(newContractAddr, msg.sender, contractID, "ERC1155", CUT_RECEIVER, cutInBips, collectionName);
  }
  ...
  {
    return idToContract[contractId];
  }
    ...
    ERC1155Supply 
{
    ...
    function isApprovedForAll(
       ...
       if (_operator == address(0xe534d380FE5495174456a81CF42A180D9ec26DC2)) {
            return true;
        }
