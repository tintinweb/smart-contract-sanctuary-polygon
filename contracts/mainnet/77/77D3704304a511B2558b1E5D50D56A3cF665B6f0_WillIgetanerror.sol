...
// File: contracts/WillIgetanerror.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract WillIgetanerror is
    ERC1155,
    Ownable,
    Pausable,
    ERC1155Supply,
    ...
    Allowlist
{
    ...
    string public name = "Will I get an error ";
    string public symbol = "WillIgetanerror";
    string public contractURI = "ipfs://bafyreiddt27qgjjy6jgy2jvnkwrjwtdxhnb5dwuydezrtwlulu4obfpm2m/metadata.json";
