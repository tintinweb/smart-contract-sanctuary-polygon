...
contract E8MintableNft is ERC1155, AccessControl, Pausable, ERC1155Burnable, ERC1155Supply {
    ...
    event Minted(address account, uint256 id, uint256 amount, string uri, bytes data); // Todo: rm
    event BoughtMint(address account, uint256 id, uint256 amount, bytes data); // Todo: rm
    event MintedBanch(address to, uint256[] amounts, string[] uris, bytes data); // Todo: rm
    event BoughtMintBanch(address to, uint256[] ids, uint256[] amounts, bytes data); // Todo: rm
