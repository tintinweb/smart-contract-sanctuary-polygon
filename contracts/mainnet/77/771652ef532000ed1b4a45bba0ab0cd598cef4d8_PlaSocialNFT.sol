...
contract PlaSocialNFT is ERC721, Ownable {
    ...
    modifier collectionExists(string memory collection) {
        require(
            _collectionMinter[collection] != address(0),
    ...
    function _updateCollectionGroupId(
        ...
        require(
            _collectionMinter[collection] == msg.sender,
        ...
        collectionVaild(collection)
    {
        ...
        batchMint(msg.sender, to, collection, groupId, socialType, amount);
    ...
    function mintByWhiteAddress(
        ...
        collectionVaild(collection)
    {
        batchMint(to, to, collection, groupId, socialType, amount);
    }
    /**
    ...
    function batchMint(
        ...
        if (_collectionMinter[collection] != address(0)) {
            require(
                _collectionMinter[collection] == owner,
                "PlaNFT: collection minter can't match"
            );
            require(
                _groupIdForCollection[collection][socialType] == groupId,
