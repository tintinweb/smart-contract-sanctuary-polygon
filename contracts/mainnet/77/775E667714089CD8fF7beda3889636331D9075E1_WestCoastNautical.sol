...
// File: WestCoastNautical.sol

/**
 * @title West Coast Nautical
 *
 * Welcome to the West Coast Nautical Watercraft Information Repository.
 * The vessels in this collection have been authenticated by West Coast
 * Nautical and will be preserved on the blockchain with manufacturer data,
 * boat registration information, service and repairs.
 * 
 * West Coast Nautical is a charter boat company specializing in marine
 * tours, sportfishing and eco-tours in and around San Francisco Bay,
 * Monterey Bay, Farallon Islands, Bodega Bay and the Northern Coast.
 */

contract WestCoastNautical is ViciERC721v4 {
    constructor()
        ViciERC721v4(
            "West Coast Nautical",
            "NAU",
    ...
    {
        setContractURI(
            "https://storage.googleapis.com/arrival-shadow-motion-newman/vici/boat/metadata/WestCoastNautical.json"
        );
    }
}