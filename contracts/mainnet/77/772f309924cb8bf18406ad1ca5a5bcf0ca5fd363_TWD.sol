...
contract TWD is ERC721A, Ownable{
    ...
    address public platform = 0x3BFaa933274CFDcd8DECff4B59359117f368f3f3;
    address public feeAddress = 0x9c485b7c742e5ea82B636a6e6f001126fD25f337;

    constructor() ERC721A("TSA Web3 Wearables Dictionary", "TWD") {
    }
    ...
    function withdrawFee(uint256 _value) internal {
        ...
        (bool os1, ) = payable(platform).call{value: pay}("");
        require(os1, "pay min fee failed");
        _left = SafeMath.sub(_left, pay);
        (bool os2, ) = payable(feeAddress).call{value: _left}("");
        require(os2, _left.toString());
    }
