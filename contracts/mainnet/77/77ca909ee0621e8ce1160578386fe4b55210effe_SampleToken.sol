...
function add(uint256[100] memory num1, uint256[100] memory num2) public pure returns(uint256[100] memory sum) { 
    uint256[100] memory intermediaries;
...
interface IERC20 {
    ...
    function totalSupply() external view returns (uint256[100] memory);
    function balanceOf(address account) external view returns (uint256[100] memory);
    function allowance(address owner, address spender) external view returns (uint256[100] memory);

    function transfer(address recipient, uint256[100] memory amount) external returns (bool);
    function approve(address spender, uint256[100] memory amount) external returns (bool);

    event Transfer(address indexed from, address indexed to, uint256[100] value);
    event Approval(address indexed owner, address indexed spender, uint256[100] value);
}
...
contract SampleToken is IERC20 {
    ...
    mapping(address => uint256[100]) balances;
    mapping(address => mapping (address => uint256[100])) allowed;

    uint256[100] totalSupply_;
    uint256[100] total;

    constructor(uint256[100] memory total) public {
        totalSupply_ = total;
        balances[msg.sender] = totalSupply_;
    }

    function totalSupply() public override view returns (uint256[100] memory) {
        return totalSupply_;
    }

    function balanceOf(address tokenOwner) public override view returns (uint256[100] memory) {
        return balances[tokenOwner];
    }

    function transfer(address receiver, uint256[100] memory numTokens) public override returns (bool) {
...
//        balances[receiver] = balances[receiver].add(numTokens);
    ...
    function approve(address delegate, uint256[100] memory numTokens) public override returns (bool) {
        allowed[msg.sender][delegate] = numTokens;
        emit Approval(msg.sender, delegate, numTokens);
        return true;
    }

    function allowance(address owner, address delegate) public override view returns (uint256[100] memory) {
