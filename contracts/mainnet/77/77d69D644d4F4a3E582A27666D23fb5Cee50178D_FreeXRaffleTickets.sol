 ...
 * @notice This contract handles minting Free X Raffle Ticket's tokens.
 */
contract FreeXRaffleTickets is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0x0c2623Ca93e7DcaF4a64732fa95ec54Ffac52a70;
    ...
    address public royaltyAddress = 0x94E8DD058D4B86a0060812d1f11eD8514d3C5C03;
    address[] public payoutAddresses = [
        0x94E8DD058D4B86a0060812d1f11eD8514d3C5C03
    ];
    ...
    string public name = "Free X Raffle Ticket's";
    string public symbol = "FXRT";
    ...
    constructor(address _blocklistContractAddress)
        ERC1155(
            "ipfs://bafybeiaavroupuzqyesy3qkrsnv3hegs2xkc6fqpwldtllkykxgfdazze4/{id}"
        )
    {
        ...
        tokenPublicSaleStartTime[1] = 1674061200;
        tokenPublicSaleEndTime[1] = 1989420773;
