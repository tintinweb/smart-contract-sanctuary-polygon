...
import {ITimeswapV2PeripheryCollectTransactionFeesAfterMaturity} from "@timeswap-labs/v2-periphery/contracts/interfaces/ITimeswapV2PeripheryCollectTransactionFeesAfterMaturity.sol";

import {INativeWithdraws} from "./INativeWithdraws.sol";
import {IMulticall} from "./IMulticall.sol";

import {TimeswapV2PeripheryUniswapV3CollectTransactionFeesAfterMaturityParam} from "../structs/Param.sol";
...
import {TimeswapV2PeripheryCollectTransactionFeesAfterMaturity} from "@timeswap-labs/v2-periphery/contracts/TimeswapV2PeripheryCollectTransactionFeesAfterMaturity.sol";

import {TimeswapV2PeripheryCollectTransactionFeesAfterMaturityParam} from "@timeswap-labs/v2-periphery/contracts/structs/Param.sol";

import {UniswapV3PoolLibrary} from "./libraries/UniswapV3Pool.sol";

import {ITimeswapV2PeripheryUniswapV3CollectTransactionFeesAfterMaturity} from "./interfaces/ITimeswapV2PeripheryUniswapV3CollectTransactionFeesAfterMaturity.sol";
...
import {TimeswapV2LiquidityTokenCollectParam} from "@timeswap-labs/v2-token/contracts/structs/Param.sol";

import {ITimeswapV2LiquidityToken} from "@timeswap-labs/v2-token/contracts/interfaces/ITimeswapV2LiquidityToken.sol";

import {ITimeswapV2PeripheryCollectTransactionFeesAfterMaturity} from "./interfaces/ITimeswapV2PeripheryCollectTransactionFeesAfterMaturity.sol";

import {TimeswapV2PeripheryCollectTransactionFeesAfterMaturityParam} from "./structs/Param.sol";
...
import {TimeswapV2LiquidityTokenMintParam, TimeswapV2LiquidityTokenBurnParam, TimeswapV2LiquidityTokenAddFeesParam, TimeswapV2LiquidityTokenCollectParam} from "../structs/Param.sol";
...
interface ITimeswapV2LiquidityToken is IERC1155Enumerable {
  ...
  event TransferFees(
    address from,
    address to,
    TimeswapV2LiquidityTokenPosition position,
    uint256 long0Fees,
    uint256 long1Fees,
    uint256 shortFees
  );
  ...
  /// @dev add long0, long1, and/or short into fees storage
  /// @param param The TimeswapV2LiquidityTokenAddFeesParam
  /// @return data Arbitrary data
