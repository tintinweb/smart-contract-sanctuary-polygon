...
contract BQOM is BQOMDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private BQOMTeam;
    address private CharityBQOM;
    ...
    string public override name = "BabyQom";
    string public override symbol = "BQOM";
    ...
    constructor(uint totalSupplyValue, address BQOMTeamAddress, address CharityBQOMAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        BQOMTeam = BQOMTeamAddress;
        CharityBQOM = CharityBQOMAddress;
        
        // split the tokens according to agreed upon percentages
        balances[BQOMTeam] =  totalSupply * 4 / 100;
        balances[CharityBQOM] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's BQOMTeam pot
