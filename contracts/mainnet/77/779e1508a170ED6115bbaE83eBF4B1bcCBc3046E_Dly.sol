    ...
    WrappedBTCToken
{
    ...
    // @dev Allow the owner of the contract to withdraw MATIC
...
contract DlyToken is Context, Ownable, Pausable, PriceConsumerV3 {
    ...
    function buyDLY() public payable returns (uint256 tokenAmount) {
        ...
        uint256 amountToBuy = (price_fiat_cop *
        ...
        returns (uint256 tokenAmount)
    {
        ...
        uint256 amountOfMATICToTransfer = tokenAmountToSell / price_fiat_cop;
        ...
        (sent, ) = _msgSender().call{value: amountOfMATICToTransfer}("");
