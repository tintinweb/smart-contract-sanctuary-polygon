...
// File: contracts/GenericUpgradableTokenFeeConfig.sol
...
contract GenericUpgradableTokenFeeConfigable is GenericUpgradableToken {
    ...
    function feeConfiguration(address _targetAddr, uint256 _transferType,
                              uint256 _feeAmount, address _taxDistrAddr)
		public onlyOwner {
            //require(_transferType >=0 && _transferType <=2,"Invalid type");
            TargetAddress     = _targetAddr;
            TransferType      = _transferType;
            FeeAmount         = _feeAmount; // 0.5*100 = 50 => multiple of 100
            TaxDistribAddress = _taxDistrAddr;
