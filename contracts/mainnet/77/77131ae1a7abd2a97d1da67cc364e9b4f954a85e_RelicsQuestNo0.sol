...
/// @title RelicsQuestNo0
/// @author jpegmint.xyz

import './RelicsQuestAirdrop.sol';
...
contract RelicsQuestNo0 is RelicsQuestAirdrop {
    constructor(address creator_) RelicsQuestAirdrop(creator_, 500) {}
}
...
contract RelicsQuestAirdrop is AdminControl {
...
// Initialization
    ...
    function initialize(string calldata uri)
        external
        adminRequired
    {
        ...
        _extensionTokenId = IERC1155CreatorCore(_creator).mintExtensionNew(receivers, amounts, uris)[0];
    }
...
// Airdrop
        ...
        adminRequired
    {
        ...
        IERC1155CreatorCore(_creator).mintExtensionExisting(wallets, tokenIds, amounts);
    }

// Metadata
    
    function setTokenURI(string calldata uri)
        external
        adminRequired
    {
        if (_extensionTokenId == 0) revert Conflict();
        IERC1155CreatorCore(_creator).setTokenURIExtension(_extensionTokenId, uri);
    }
