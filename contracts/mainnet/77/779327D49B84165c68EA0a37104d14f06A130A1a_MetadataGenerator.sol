...
contract MetadataGenerator is OwnableUpgradeable {
    ...
    function resetAddresses (
        ...
        address traitGetterContract) external onlyOwner {
        cards = icards(cardsContract);
        SmelterDrillerThruster = iSmelterDrillerThruster(smelterDrillerThrusterContract);
        ...
        TraitGetter = ITraitGetter(traitGetterContract);
    }
