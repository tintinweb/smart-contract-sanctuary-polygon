...
contract SiloFactoryUIHelper is Ownable{
    ...
    */
    ...
    function getWithdrawLimitSiloInfo(uint siloId) external view returns(bool, uint amount,uint availableBlock){
        ISilo silo = ISilo(SiloFactory.siloMap(siloId));
...
interface ISilo{
    ...
    function getWithdrawLimitSiloInfo() external view returns(bool, uint amount,uint availableBlock);
}
