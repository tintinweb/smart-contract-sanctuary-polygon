    ...
    ISharedData
{
        ...
        whenNotPaused
    {
        ...
        if (
            currency == IERC20(0xdAC17F958D2ee523a2206206994597C13D831ec7) ||
            currency == IERC20(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48) ||
            currency == IERC20(0xc2132D05D31c914a87C6611C10748AEb04B58e8F) ||
            currency == IERC20(0x9BDc7359691cd34c64229B87a3A012e4Fc7055D2)
        ) {
            amountToProcess = amount / 1000000000000;
        }
        ...
        whenNotPaused
    {
        ...
        if (isMainTokenAllowed) {
            ...
            if (
                address(tokenInfo[tokenId].token) ==
            ...
            uint256 balanceToTransfer = IERC20(tokenInfo[tokenId].token)
