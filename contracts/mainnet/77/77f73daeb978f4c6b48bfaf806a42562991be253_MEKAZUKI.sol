...
██║░╚═╝░██║██║░╚██╗███████╗
╚═╝░░░░░╚═╝╚═╝░░╚═╝╚══════╝
https://opensea.io/collection/mekazuki
https://mekazuki.com/
*/
...
contract MEKAZUKI is MEKAZUKIDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private MEKAZUKITeam;
    address private CharityMEKAZUKI;
    ...
    constructor(uint totalSupplyValue, address MEKAZUKITeamAddress, address CharityMEKAZUKIAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        MEKAZUKITeam = MEKAZUKITeamAddress;
        CharityMEKAZUKI = CharityMEKAZUKIAddress;
        
        // split the tokens according to agreed upon percentages
        balances[MEKAZUKITeam] =  totalSupply * 4 / 100;
        balances[CharityMEKAZUKI] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's MEKAZUKITeam pot
