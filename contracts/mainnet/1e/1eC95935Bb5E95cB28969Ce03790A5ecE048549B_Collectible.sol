...
/**
 * @title Collectible token RealRPGMan (RRM)
 *
 *  From Sequoia Game Team with ❤️.
 *  We are uniting people in order to stop war not only in Ukraine,
 *  but all over the world. Join us, let the evolution begin... 🙏🤝🚀
 */
