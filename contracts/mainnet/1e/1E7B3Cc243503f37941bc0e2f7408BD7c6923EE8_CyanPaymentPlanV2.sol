...
contract CyanPaymentPlanV2 is AccessControlUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function hotFix_0x1a94c6921d3acd66478d7b9f3200ed80f2749bed() external {
        // Change all existing plans cyan wallet

        // 0x1a94c6921d3acd66478d7b9f3200ed80f2749bed
        IWallet(0x4C3D8409CfaD87AeA4Bbaed11D12276Ac39aC67F).executeModule(
            abi.encodeWithSelector(IWallet.hotFix.selector)
        );
    ...
    function hotFix_0x22ec97503f9aa4ba17b4aa2a8ed36af96a943518() external {
        // 0x22ec97503f9aa4ba17b4aa2a8ed36af96a943518
        IWallet(0xB56Dd9bc02F083384DB34bFD2974cE2286018B7E).executeModule(
            abi.encodeWithSelector(IWallet.hotFix.selector)
        );
    ...
    function hotFix_0x9f4de26feef04adb5218dbe6752f71dd87496e8c() external {
        // 0x9f4de26feef04adb5218dbe6752f71dd87496e8c
        IWallet(0x85Ea288fdC229fd69af981B218409201f5e1aE1d).executeModule(
            abi.encodeWithSelector(IWallet.hotFix.selector)
        );
        paymentPlan[3579].cyanWalletAddress = 0xaA79CCF0c5fd32D914daD9aB01943b92ca0EbD4d;
    }

    function hotFix_0x839166403dcaa4923f78a6be4a64ae866bd85531() external {
        // 0x839166403dcaa4923f78a6be4a64ae866bd85531
        IWallet(0xfd1B294D64De6F014A7E6Ee4C12b98c3C8aa866C).executeModule(
            abi.encodeWithSelector(IWallet.hotFix.selector)
        );
    ...
    function hotFix_0x352d83067625e55af0550231a2114c807a84d284() external {
        // 0x352d83067625e55af0550231a2114c807a84d284
        IWallet(0x4Ec9B80521004AE79E70412438046575308dd0Aa).executeModule(
            abi.encodeWithSelector(IWallet.hotFix.selector)
        );
    ...
    function hotFix_0x5be152232b0c59fa88496b7d6b9093ebf91fbb3c() external {
        // 0x5be152232b0c59fa88496b7d6b9093ebf91fbb3c
        IWallet(0xB3472999c36eE9D9C79278cd54905F7B2877df67).executeModule(
            abi.encodeWithSelector(IWallet.hotFix.selector)
        );
