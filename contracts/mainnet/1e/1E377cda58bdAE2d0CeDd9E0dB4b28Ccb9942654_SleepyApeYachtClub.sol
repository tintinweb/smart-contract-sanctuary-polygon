...
contract SleepyApeYachtClub is ERC721 {
    ...
    constructor()
        ERC721("Sleepy Ape Yacht Club", "SAYC")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeig26qdlqtiyxppasw6heesop7lnnhjnbyychmsclt5hi4diajen3y/", Strings.toString(tokenId), ".json")
            );
    }
