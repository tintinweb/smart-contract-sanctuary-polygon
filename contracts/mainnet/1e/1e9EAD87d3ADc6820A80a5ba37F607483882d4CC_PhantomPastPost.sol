    ...
    ERC2981Upgradeable
{
    ...
    string public imagenNfts;
    mapping(uint256 => uint256) public tokenDNA;

    function initialize() external initializer {
        __ERC721_init("PhantomPastPost", "PPN");
    ...
    function tokenURI(
        ...
        string memory image = imagenNfts;

        string memory jsonURI = Base64Upgradeable.encode(
            abi.encodePacked(
                '{ "name": "NftsPunks #',
                tokenId.toString(),
                '", "description": "Mensaje de past-post para toda la vida: ", "image": "',
                image,
                '"}'
            )
        );
