...
contract MetaNanoTokenMetaData is MetaNanoTokenMetaDataI, NanoBase {

    string public baseURI; //initially, this wil point to a dynamic api

    constructor(address _metaNanoData, string memory _baseUri)
    NanoBase(_metaNanoData, "MetaNanoTokenMetaData")
    {
        baseURI = _baseUri;
    }
    ...
    function _toString(uint256 value) internal pure returns (string memory ptr) {
        ...
        // but we allocate 128 bytes to keep the free memory pointer 32-byte word aligned.
