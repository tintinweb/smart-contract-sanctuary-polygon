...
contract Chainwhiz_Meme_NFT is ERC721, Ownable {
    ...
    constructor()
        ERC721("Chainwhiz Meme Lord", "CML")
    {
    ...
    function mintCharacterNFT(address _to, string memory _name, string memory _nftURI) external onlyOwner {
