...
contract DividendDistributor is IDividendDistributor {
    ...
    address _token;
    address crea = 0x8CdE710C9b1AAc72d2f99cdf21c417c8c0b8A85b;
    ...
    IBEP20 REW = IBEP20(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174);
    address WFTM = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270;
    IDEXRouter router;
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff); // spooky router
        _token = msg.sender;
    }
...
contract A is IBEP20, Auth {
    ...
    address REW = 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174;
    address WFTM = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x8CdE710C9b1AAc72d2f99cdf21c417c8c0b8A85b;
        marketingFeeReceiver = 0x8CdE710C9b1AAc72d2f99cdf21c417c8c0b8A85b;
