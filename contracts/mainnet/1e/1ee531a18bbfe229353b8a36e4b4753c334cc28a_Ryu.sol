...
contract Ryu is ERC721URIStorage, ReentrancyGuard
{
    ...
    uint256 private constant MINT_PRICE = 1000000000000000000; //1 DAI
    ...
    function mintNFT() public nonReentrant returns (uint256) 
    {
    ...
    function safeTransferFrom(address from, address to, uint256 tokenId, bytes memory data) public override 
    {
    	...
    	_stakingBlock[from] = block.number;        
    	_stakingBlock[to] = block.number;
    }   

    function mintBatch(uint256 nftAmount) external nonReentrant        
	{
