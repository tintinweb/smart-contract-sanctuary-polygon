...
// File: contracts/ChildMintableERC20.sol
    ...
    ContextMixin
{
    ...
    function setPaused(bool _paused) public only(DEFAULT_ADMIN_ROLE) {
        paused = _paused;
    }
...
// File: contracts/fossil/Fossil.sol

pragma solidity 0.6.6;

contract FossilToken is ChildMintableERC20 {
    address CHILD_MANAGER = 0xA6FA4fB5f76172d178d61B04b0ecd319C5d1C0aa;

    constructor()
        public
        ChildMintableERC20("DapperDinos.com FOSSIL", "FOSSIL", 0, CHILD_MANAGER)
    {}
}