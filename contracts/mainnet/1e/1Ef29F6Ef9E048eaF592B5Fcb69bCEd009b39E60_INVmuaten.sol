...
contract INVmuaten is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_, address proxyRegistryAddress_)
    ERC721("INV muaten", "IM")
  {
  ...
  uint256 public constant MAX_MULTIMINT = 10008;
  ...
  function mint(uint256 count) public nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 10008 at a time");
