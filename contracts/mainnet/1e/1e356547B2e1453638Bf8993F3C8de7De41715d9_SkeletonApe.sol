...
contract SkeletonApe is Ownable, ERC721, ERC721Burnable, ERC721Enumerable, ERC721Royalty, EIP712, ERC721Votes {
    ...
    constructor(address payable payee_, uint256 maxSupply_, uint256 price_) ERC721("Skeleton Ape", "SAPE") EIP712("Skeleton Ape", "1") {
    ...
    function batchMint(address to, uint256 amount) external onlyOwner {
        require(totalSupply() + amount <= maxSupply, "Insufficient supply");
