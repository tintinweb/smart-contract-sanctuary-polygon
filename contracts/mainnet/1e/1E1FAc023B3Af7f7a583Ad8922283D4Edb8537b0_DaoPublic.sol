...
contract DaoPublic is Initializable, LinkedList, OwnableUpgradeable {
    ...
    function initialize( address _daoCommittee, uint _timer ) public initializer {
        __LinkedList_init();
        __Ownable_init();
    ...
    function setTime (uint _timeInSeconds) public onlyOwner {
        timer = timer+ _timeInSeconds;
    }
}
