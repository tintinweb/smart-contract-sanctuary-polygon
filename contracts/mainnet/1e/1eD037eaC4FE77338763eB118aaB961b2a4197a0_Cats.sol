...
contract Cats is ERC721 , DefaultOperatorFilterer {
    uint256 public totalSupply;
    uint256 public cost = 0.05 ether;
    uint256 public maxMints = 9999;
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeif5dvoi5wxahur7kz6wrocn7yuvambapynf57umfpdwopv7xgpagu/", Strings.toString(tokenId), ".json")
            );
    }
