...
contract CryptWear is ERC721, Ownable, ReentrancyGuard {
    ...
    function setMintSettings(
        ...
        require(_maxId <= 2000, "maxId <= 2000");
    ...
    constructor(string memory _baseURI, string memory collectionURI)
        //ERC721("CryptWear", "C-WEAR")//TODO !!!!!!!
    ERC721("DeadNull404", "DADNL4")
    {
        ...
        mintSettings.allowlistSalePrice = 2;
        //TODO !!!!!!!
        mintSettings.publicSalePrice = 5;
        //TODO !!!!!!!

        mintSettings.publicMint = true;
        //TODO !!!!!!!

        //mintSettings.maxPreMintPerWallet = 10;
        //mintSettings.maxAllowlistMintPerWallet = 10;
        mintSettings.maxPreMintPerWallet = 2000;
        //TODO !!!!!!!
        mintSettings.maxAllowlistMintPerWallet = 2000;
        //TODO !!!!!!!
        ...
        withdrawSettings.withdrawAddress1 = 0xEE1d49DCD28ef6006F2d3f6B0Fac1767516C796d;
        //TODO !!!!!!!
        withdrawSettings.withdrawAddress2 = 0x8dEA2B989bB18077Af86877bf2e789696c52882a;
        //TODO !!!!!!!
        ...
        preMerkleRoot = 0x2de5a56fc5c133937efff01885d6c3f6318dfea98796ac38d201af363eae62a2;
        //TODO !!!!!!!
        giftMerkleRoot = preMerkleRoot;
        //TODO !!!!!!!
        allowlistMerkleRoot = giftMerkleRoot;
        //TODO !!!!!!!
    }
    ...
    canMint(amount, MintType.PREMINT) nonReentrant
    {
        ...
        require(!claimedPre[msg.sender], "NFT is already claimed by this wallet");
    ...
    {
        // Throw if address has already claimed tokens
        require(!claimedAllowlist[msg.sender], "NFT is already claimed by this wallet");
    ...
    {
        // Throw if address has already claimed tokens
        require(!claimedGift[msg.sender], "NFT is already claimed by this wallet");
