...
// File contracts/CandyBabyNFT/ICandyBabyNFTMint.sol

pragma solidity ^0.8.0;

// for CandyBabyNFTMint
interface ICandyBabyNFTMint {

    function mint(address to, uint256 quantity) external;
}


// File contracts/CandyBabyNFT/ICandyBabyNFTBatchTransfer.sol

pragma solidity ^0.8.0;

// for CandyBabyNFT
interface ICandyBabyNFTBatchTransfer {
...
// File contracts/CandyBabyNFT/CandyBabyNFT.sol

pragma solidity ^0.8.0;
contract CandyBabyNFT is 
        AccessControlEnumerable,
        ERC721Psi,
        ICandyBabyNFTMint,
        ICandyBabyNFTBatchTransfer
{

    bytes32 public constant URI_SETTER_ROLE = keccak256("URI_SETTER_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    uint32 public constant TOTAL_SUPPLY = 60000;
    string private _baseTokenURI;
    // Mapping owner address to token count
    mapping(address => uint256) private _balances;

    constructor() ERC721Psi ("Candy Babies", "Candy Baby"){
    ...
    function safeBatchTransferFrom(
        ...
        require(accounts.length == ids.length, "CandyBabyNFT: accounts and ids length not match");
        for (uint256 i = 0; i < ids.length; i++) {
    ...
    function mint(address to, uint256 quantity)
        ...
        override
    {
        require(quantity > 0, "CandyBabyNFT: quantity must be greater than 0");
        require(
            totalSupply() + quantity <= TOTAL_SUPPLY,
            "CandyBabyNFT: quantity exceeds total supply"
        );
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(AccessControlEnumerable, ERC721Psi)
        returns (bool)
    {
