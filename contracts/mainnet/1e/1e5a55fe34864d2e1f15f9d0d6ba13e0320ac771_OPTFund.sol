...
contract OPTFund is Ownable, ReentrancyGuard {
    ...
    function calculateRewards(address _address) public view returns (uint256) {
        ...
        uint256 allClaimableAmount = (lastRoiTime * deposit[_address].stakedAmount * dailyStakingReward).div(percentRate * rewardPeriod);
    ...
    function compoundRewards() public {
        ...
        deposit[msg.sender].stakedAmount = deposit[msg.sender].stakedAmount.add(rewardsToClaim);
    }
    ...
    mapping(address => LoanStruct) adrToLoanStruct;
