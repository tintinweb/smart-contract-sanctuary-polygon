...
contract ChamberOfCommerce is 
    ...
    // Counters.Counter private _actorIndexCount;
    bytes32 public constant CLERK_ROLE = keccak256("CLERK_ROLE"); // NOTE this has no function as of now
    ...
    address public stableToken; // USDC contract address
    
    // Backup address / emergency address TODO LOOK INTO THIS
    ...
    uint256 public defaultDeposit = 10 * 1e18; // 10 GET is the minimum TODO LOOK INTO THIS
    ...
    /**
     * Internal function that checks if the USD value of the integrator is sufficient to ticket 
     */
    ...
    */ 
    function getIntegratorFuelPrice(
        ...
        // (,,,,_price,,,,) = EconomicsMirror(economics).integratorData(_integratorIndex);
    ...
    */ 
    ...
    // NOTE probably slighly redundant
...
contract EconomicsMirror is Ownable, IEconomicsDataTypes {
    ...
    function setupIntegrator(
        ...
        address _relayerAddress
    ) external isDAOController returns(uint32){
...
interface IEconomics is IEconomicsDataTypes {
    ...
    // function integratorData(uint32 _integratorIndex) external returns (uint32, uint32, bool, bool, uint256, uint256, uint256, uint256, string memory);
