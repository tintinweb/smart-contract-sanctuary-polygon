...
// File: opensea/StringLibrary.sol
...
// File: opensea/Testilluvium-tryID.sol
...
contract MyTestCollection is ERC1155, Ownable {
    using StringLibrary for string;

    string public constant name = "Test XYZ Collection";
    string public constant symbol = "XYZ-NFT";
    string public constant description = "How's everything going? Welcome to my NFT collection!";
    ...
    function mint(
        ...
        emit URI(_tokenURIs[id], id);
    }

    function burn(address _account, uint256 _tokenId, uint256 _amount) public onlyOwner {
        require(balanceOf(_account, _tokenId) > 0, "Nothing to burn");
