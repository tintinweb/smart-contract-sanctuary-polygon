...
contract AaveV3SupplyStrategy is InitializableAbstractStrategyFromStabl {
    ...
    function _deposit(address _asset, uint256 _amount) internal {
        ...
        token[_asset].approve(address(pool), _amount);
