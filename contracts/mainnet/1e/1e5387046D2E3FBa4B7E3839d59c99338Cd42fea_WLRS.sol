...
contract WLRS is ERC20Burnable, Operator {
    ...
    /**
     * @notice Constructs the WLRS ERC-20 contract.
     */
    constructor() public ERC20("WLRS", "WLRS") {
        // Mints 1 WLRS to contract creator for initial pool setup
        _mint(msg.sender, 1 ether);

    }

    /**
     * @notice Operator mints WLRS to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of WLRS to mint to
     ...
     */
    function distributeReward(address _genesisPool, address _airdropWallet) external onlyOperator {
