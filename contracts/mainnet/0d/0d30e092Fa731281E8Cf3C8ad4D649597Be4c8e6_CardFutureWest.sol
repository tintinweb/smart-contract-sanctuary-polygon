...
contract CardFutureWest is ERC20, ERC20Burnable, Pausable, Ownable, ERC20Permit, ERC20Votes {
    constructor()
        ERC20("Card:future west", "CFW")
        ERC20Permit("Card:future west")
    {
