...
contract CANTOPHUNKS is ERC721Enumerable, Ownable, ReentrancyGuard {
 ...
 //   uint256 public constant PRICE = 20_000_000_000_000_000; // 0.02 ETH
    ...
    constructor() ERC721("CANTOPHUNKS", "CPHNKS") {
    ...
    function mintAllowList(uint256 numberOfTokens) external payable nonReentrant {
        require(
