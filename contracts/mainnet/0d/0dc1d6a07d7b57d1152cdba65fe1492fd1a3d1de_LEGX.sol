...
contract LEGX is ERC20, Ownable {
    ...
    constructor() ERC20("Testing", "TEST"){
        ...
        marketingWallet = address(0x7c70239C0a77D1Db7Fc7d6759DAeec1A7B161020);

        // Project Expenses Wallet | In case of compromise, updateable
        expensesWallet = address(0x7c70239C0a77D1Db7Fc7d6759DAeec1A7B161020);

        // Project Management Wallet | Static variable
        managementWallet = address(0x7c70239C0a77D1Db7Fc7d6759DAeec1A7B161020);
        ...
        // Router settings for Ethereum, Arbitrum, Optimism, Mumbai, Polygon:
        ...
        // SushiSwap mainnet: 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506
        // QuickSwap mainnet: 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff | Polygon

        IUniswapV3Router02 _uniswapV3Router = IUniswapV3Router02(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff);
