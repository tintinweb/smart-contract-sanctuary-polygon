...
contract ForLootAndGloryRoyalty is AccessControl, ReentrancyGuard, Pausable {
        ...
        whenNotPaused
    {
        ...
        totalWeightedStakedSupply = totalWeightedStakedSupply.add(
        ...
        userWeightedStakes[msg.sender] = userWeightedStakes[msg.sender].add(
            _amount.mul(multiplier)
        );
    ...
    function withdrawRewards(uint256 _amount)
        external
