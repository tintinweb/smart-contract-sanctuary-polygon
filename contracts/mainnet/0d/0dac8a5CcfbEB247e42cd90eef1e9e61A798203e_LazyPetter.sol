...
contract LazyPetter {
  ...
  constructor(address _authorizedExecutor, address gotchiDiamond, address _gotchiOwner) {
    ...
    gotchiIds = [
      ...
      // tier 1 (needs reset)
      8364, 7026, 2967, 3201, 2674, 5514, 6169, 185, 8634, 5017
      ...
      // tier 3 ()
      // 17495, 15079,24941,24935,24936,23309,23098,24564,23861,24004,22929,24004,24564,22934,10055,23085,23591,23810,17443,18812,22530,24559,13608,19943,21586,10566
