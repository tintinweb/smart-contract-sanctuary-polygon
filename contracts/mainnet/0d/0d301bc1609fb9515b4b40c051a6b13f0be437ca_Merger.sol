...
contract Merger is IERC20 {
	string constant public name = "Drawership Merger";
	string constant public symbol = "DRXM";
						...
						uint256 _swapFundSupply_1)
	{
		...
		_totalSupply = _holdersSupply_0 + _swapFundSupply_0;
		_balances[_SWAP_FUND] = _swapFundSupply_0;
		_balances[_owner] = _holdersSupply_0;

		emit Transfer(address(0), _SWAP_FUND, _balances[_SWAP_FUND]);
		emit Transfer(address(0), _owner, _balances[_owner]);

		PAIRED_TOKEN = address(new Splitter(
						_SWAP_FUND,
						_owner,
						_SWAPRATE_1,
						_holdersSupply_1,
