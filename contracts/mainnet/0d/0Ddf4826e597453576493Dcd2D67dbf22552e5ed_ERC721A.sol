...
contract sillystoneheads is ERC721A, TheOperatorFilterer {
    // opensea
    ...
    constructor() ERC721A("MATIC GOBBLERS", "GOOIER") {
        owner = msg.sender;
        maxPerTx = 1;
        price = 0.005 ether;
        maxSupply = 2000;
    ...
    function tokenURI(uint256 tokenId) public pure override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeiasdo4avoo6wjt5wxz6cik2rwk775ofqmefq4su2ykgjj5p7ywvtu", _toString(tokenId), ".json"));
    }
