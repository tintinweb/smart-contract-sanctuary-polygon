...
contract FlashloanV2 is FlashLoanReceiverBase {
    ...
    address owner;
    IUniswapV2Router02 routerA = IUniswapV2Router02(routerA_);
    IUniswapV2Router02 routerB = IUniswapV2Router02(routerB_);
    ...
    function executeOperation(
        ...
        IERC20(WETH).approve(routerA_, balance);  
        IERC20(token).approve(routerA_, tokenBalance);
        ...
        IERC20(WETH).approve(routerB_, balance);
        IERC20(token).approve(routerB_, tokenBalance);
