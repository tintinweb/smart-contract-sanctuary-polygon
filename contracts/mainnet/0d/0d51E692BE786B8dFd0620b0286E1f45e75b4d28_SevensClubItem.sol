...
import {AbstractERC1155} from "./extensions/AbstractERC1155.sol";
 ...
 *
 * @title SevensClub Items
 * @custom:website www.7sclub.io
 * @author @lozzereth (www.allthingsweb3.com)
 * @notice SevensClub Items specifically for airdrops
 */
contract SevensClubItem is AbstractERC1155 {
    constructor(string memory _metadataUri)
        AbstractERC1155("7sClub Item", "7SCLUBITEM")
    {
     ...
     * @param accounts Accounts to airdrop
     * @param id Token Id
...
abstract contract AbstractERC1155 is ERC1155Burnable, Ownable {
    /// @dev Token name
    ...
    /**
     * @notice Returns the URL of the ERC1155 NFT
