...
contract StellumToken is ERC20, Ownable {

  mapping(address => bool) public minters;

  uint256 public lastTeamMintTime;
  uint256 public lastTeamMintSupply;
  uint256 public lastTeamMintAmount;
  ...
  bool public firstTeamMint = true;

  constructor() ERC20("Stellum Token", "STM") {
    lastTeamMintTime = block.timestamp;

    _mint(owner(), 8_000_000 * 1e18);
  }
