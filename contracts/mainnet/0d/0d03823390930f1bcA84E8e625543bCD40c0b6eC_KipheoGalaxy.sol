 ...
 * @notice This contract handles minting Kipheo Galaxy tokens.
 */
contract KipheoGalaxy is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xD1B99B573485eBa0200Bc1580C4EFC7A767aF14d;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x1AA082360D170156C5281E9dbdf180cf9102B91A;
    ...
    string public name = "Kipheo Galaxy";
    string public symbol = "KGALAXY";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeidy4557vmrirwfvkwrsudvomgsy27x55y4voemn2puuco4mtztdly/{id}"
        )
        RevokableOperatorFilterer(
