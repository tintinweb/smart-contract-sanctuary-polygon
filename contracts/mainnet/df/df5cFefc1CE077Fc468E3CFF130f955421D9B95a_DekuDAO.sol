...
contract DekuDAO is IPillarDAO, Ownable {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    address private stakingToken;
    uint256 private constant stakingTerm = 52 weeks;
    uint256 private stakeAmount;
    DekuNFT private membershipNFT;
    ...
    constructor(
        ...
        membershipNFT = DekuNFT(_membershipNft);
    }
    ...
    function setMembershipNFT(address _newAddr) external onlyOwner {
        membershipNFT = DekuNFT(_newAddr);
    }
...
contract DekuNFT is ERC721Enumerable, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
