...
contract RangoStargateFacet is IRango, ReentrancyGuard, IRangoStargate, IStargateReceiver {
    ...
    address private stargateRouterEth;
    ...
    constructor(address _stargateRouter, address _stargateRouterEth) {
    ...
    function doStargateSwap(
        ...
        address router = fromToken == LibSwapper.ETH ? stargateRouterEth : stargateRouter;
