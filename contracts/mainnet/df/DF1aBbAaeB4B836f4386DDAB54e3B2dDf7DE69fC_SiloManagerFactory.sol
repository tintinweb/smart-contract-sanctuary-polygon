...
contract SiloManagerFactory is Ownable {
    ...
    event SiloManagerFund(address owner, address manager, uint256 upkeepId, uint256 amount);
    event SiloManagerWithdraw(address owner, address manager, uint256 upkeepId, uint256 amount);
