...
/*
    __    _            _ __        
   / /   (_)___  _____(_) /______ _
  / /   / / __ \/ ___/ / //_/ __ `/
 / /___/ / /_/ (__  ) / ,< / /_/ / 
/_____/_/ .___/____/_/_/|_|\__,_/  
       /_/                  
*/
    ...
    ReentrancyGuard
{
    ...
    SaleState public saleStatus = SaleState.DevMint;
    ...
    function devMint() external onlyOwner {
        require(saleStatus == SaleState.DevMint, "not in dev mint phase");
