    ...
    OwnableUpgradeable
{
    ...
    function initialize(
        ...
        collectionId = 4;
        buyBackValue = 250000 * 10 ** 18; // 250.000 Matic
        ...
        mintBasePrice = 2427213350000000000; //2.42721335;
    ...
    function setFreeMintCount(uint32 _freeMintCount) external onlyOwner{
