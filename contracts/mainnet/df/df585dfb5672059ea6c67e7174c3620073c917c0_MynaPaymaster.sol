...
import {UserOperationLib} from "./interfaces/UserOperation.sol";
 ...
 */
contract MynaPaymaster is BasePaymaster {
        ...
        returns (bytes memory context, uint256 validationData)
    {
        ...
        require(allowedAddresses[userOp.getSender()], "VerifyingPaymaster: sender not allowed");
