...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x043931dD371Aa766abEa19C25DD6C51347c026Fd];
  address public erc20Payable = 0x043931dD371Aa766abEa19C25DD6C51347c026Fd;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://metadata.mintfoundry.xyz/c/WjoMTNkabZ0nPeZv8F2F/token/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/NFnfrAFmDX4AKFh5eWWC/contract-metadata";
  }
...
// File: contracts/DayMakersContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DayMakersContract is ERC721APlus {
    constructor() ERC721APlus("DayMakers", "DYMKRS"){}
}
