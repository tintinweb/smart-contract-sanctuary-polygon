...
contract VestingModule is Initializable, OwnableUpgradeable, UUPSUpgradeable, AccessControlUpgradeable{
    ...
    function _authorizeUpgrade(address newImplementation)
        ...
        onlyOwner
    {}
    function grantReleaserRole(address account) public onlyRole(ADMIN_ROLE) returns (bool) {
    _grantRole(RELEASER_ROLE, account);
    return true;
     }
