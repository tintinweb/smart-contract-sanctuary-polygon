...
contract RealmsOfEthernity is ERC20, ERC20Burnable, Pausable, AccessControl {
    ...
    address internal _safe = 0x5a1a41d613676780f6E9684F1C9Fb89e116013f2;
    uint internal maxSupply = 1000000000 * 1e18;

    constructor() ERC20("Realms Of Ethernity", "RETH") {
        _setupRole(DEFAULT_ADMIN_ROLE, _safe);
        _setupRole(CFO, _safe);
        _setupRole(CTO, 0x9Cdc34E9f2Ba2bb35452d7088bab9ed11B0a4258);
    }
    ...
    function burn(address to, uint256 amount) public validate {
    ...
    function move(address from, address to, uint256 amount) public validate {
