...
// File: StarStyleCommunity.sol

/**
 * @title StarStyle® Community
 * When you purchase an NFT, you become a member of the StarStyle® community.  
 * As a member, you are entitled to participate in exciting events exclusive to  
 * the community including hangouts, storytelling, book readings, sneak peeks,  
 * classes, discussions, and good old down-on-the-farm fun, all virtually from  
 * the comfort of your couch. Check the Roadmap for our calendar of happenings!
 * 
 * The first NFT’s will be from the first book in the series, *No Barnyard  
 * Bullies*. Every purchase is a surprise NFT. You will see what NFT you have 
 * purchased on the day of the NFT DROP. You own your purchased unique and  
 * original NFT which you can trade or sell.
 * 
 * You will be making a difference by empowering women, families, and youth  
 * through increased literacy and positive media messages. Your purchase will  
 * benefit [Be the Star You Are!®](www.BetheStarYouAre.org), a 501c3 charity.
 */
contract StarStyleCommunity is ViciERC721v4 {
    constructor()
        ViciERC721v4(
            "No Barnyard Bullies",
            "SSC",
    ...
    {
        setContractURI(
            "https://storage.googleapis.com/arrival-shadow-motion-newman/waterside/starstyle/metadata/StarStyle.json"
        );
    }
}