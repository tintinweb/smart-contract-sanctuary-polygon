...
contract GBRToken is IPOLY20 {
	
	uint256 private _totalSupply;
    uint8 private _decimals = 8;
    string private _symbol = "GBR";
    string private _name= "GBR COIN";
...
contract GBRTokenSale {
    address payable admin;
    GBRToken public tokenContract;
    ...
    constructor(GBRToken _tokenContract, uint256 _tokensSold)  {
    ...
    function multiply(uint x, uint y) internal pure returns (uint z) {
   	...
   	function buyTokens(uint256 _numberOfTokens) public payable {
		uint256 _bnbvalue = (_numberOfTokens/100000000)*tokenPrice;
