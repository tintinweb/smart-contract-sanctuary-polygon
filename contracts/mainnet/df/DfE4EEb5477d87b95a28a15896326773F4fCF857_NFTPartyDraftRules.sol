    ...
    AddPowerPointsOnFinalize
{
    ...
    event Vote(uint256 indexed tokenId, uint256 indexed partyMembershipId, uint256 indexed passportId, bool yes);
    ...
    function vote(uint256 tokenId, bool yes) external {
        ...
        emit Vote(tokenId, partyMembershipTokenId, passportId, yes);
