...
abstract contract VestingUpgradeable is Initializable {
    ...
    event UpdateVesting(uint8 vestingType, uint256 totalAmount, uint256 startDate, uint256 endDate, uint256 increment);
    ...
    function updateVesting(uint8 vestingType_, uint256 totalAmount_, uint256 startDate_, uint256 endDate_)
        external
        virtual
    {
        _authorizeUpdateVesting();
        _updateVesting(vestingType_, totalAmount_, startDate_, endDate_);
    }
    ...
    function _authorizeUpdateVesting() internal virtual;

    function _updateVesting(uint8 vestingType_, uint256 totalAmount_, uint256 startDate_, uint256 endDate_) internal {
        ...
        emit UpdateVesting(vestingType_, totalAmount_, startDate_, endDate_, _increment);
    }
    ...
    UUPSUpgradeable
{
    ...
    // solhint-disable-next-line
    function _authorizeUpdateVesting() internal view override onlyOwner {}
