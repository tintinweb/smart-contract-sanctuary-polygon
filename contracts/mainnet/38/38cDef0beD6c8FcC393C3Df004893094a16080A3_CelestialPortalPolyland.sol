...
contract CelestialPortalPolyland is Ownable, IFxMessageProcessor {
	...
	/// @notice emited when a message arrives from mainland
	event MessageFromMainland(address rootSender, bytes data);
    ...
    ICelestialCastle public castlePolyland;
    ...
    function processMessageFromRoot(
		...
		emit MessageFromMainland(rootSender, data);
    }
