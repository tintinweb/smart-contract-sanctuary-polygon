...
abstract contract EarlyMintIncentive is Teams, ERC721A, ProviderFees {
  ...
  uint256 public EARLY_MINT_PRICE = 30 ether;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiahcpbsth4ej3bd23epzbcl26wjoyteudnie4htgu3wts66t3yjau/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/ROOOlrNOXg9AGdat60Sz/contract-metadata";
  }
...
// File: contracts/SunnyglassesgirlContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SunnyglassesgirlContract is ERC721APlus {
    constructor() ERC721APlus("sunny glasses girl", "sgg"){}
}
  /*******************************************************/
  /*                                                     */
