...
contract Quiz {
    ...
    event CreateQuiz(uint256 _quizId, string[] questions, IERC20Metadata _rewardToken, uint256 _totalReward, 
    uint256 _startTime, uint256 _activeTime, uint256[] _lotteries );
    ...
    function createQuiz(uint256 _quizId, string[] memory _questions, IERC20Metadata _rewardToken, 
    uint256 _totalReward, uint256 _startTime, uint256 _activeTime,uint256[] memory _lotteries, string memory _title, string memory _photo) public onlyAdmin {
        require(_quizId != 0, "invalid quizId 0");
        ...
        quizzes[_quizId] = QuizDetail(_quizId,_questions, _rewardToken, _totalReward, true, false,_startTime, _activeTime, _lotteries, _title, _photo);
