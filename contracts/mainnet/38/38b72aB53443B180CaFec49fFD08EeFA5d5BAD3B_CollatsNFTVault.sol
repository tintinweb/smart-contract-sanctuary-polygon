...
//TODO: use the Safe Transfer thing
contract CollatsNFTVault is OwnableUpgradeable {
    ...
    //TODO: check in the Collats mint collats that the msgSender() is this contract and not the person calling this contract.
    //TODO: Test
        ...
        returns (uint256 collatsBought)
    {
        ...
        //Call buyCollats and get the amount
        collatsBought = collats.buyCollats{value: msg.value}();
        console.log("collatsBought ", collatsBought);
    ...
    function withdrawCollats(
        ...
        require(
            collats.transfer(_msgSender(), amount),
