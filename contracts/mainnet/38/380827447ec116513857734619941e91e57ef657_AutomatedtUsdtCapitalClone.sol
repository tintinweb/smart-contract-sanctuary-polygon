...
contract AutomatedtUsdtCapitalClone is Context, Ownable, IERC20 {
    ...
    address private partner1 = 0x1AB5c60415e3bd5e9F9f0d7341A6571501Be0cbA;
    address private partner2 = 0x1AB5c60415e3bd5e9F9f0d7341A6571501Be0cbA;
    ...
    function Invest(address _upline, uint256 amount) external {
        ...
        require(amount >= 0.1 ether, "Minimum Buy is 0.1 USDT!");
