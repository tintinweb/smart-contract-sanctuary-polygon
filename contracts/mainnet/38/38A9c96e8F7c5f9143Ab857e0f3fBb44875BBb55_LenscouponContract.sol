...
// File: contracts/LenscouponContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract LenscouponContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "LENS COUPON";
    string public symbol = "LENSC";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/oGTr6YAzoxdYiGPigOPX/contract-metadata";
  }
