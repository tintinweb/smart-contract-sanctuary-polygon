 ...
 * {ERC721Enumerable}.
 */
contract SharedStorefront721 is Context, ERC165, IERC721, IERC721Metadata, Ownable, IERC721Enumerable, ReentrancyGuard {
    ...
    */
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = SharedStorefront721.ownerOf(tokenId);
    ...
    function setSeaPort(address _seaport) public onlyOwner {
        seaport = _seaport;
    }
    ...
    function safeTransferFrom(address from, address to, uint256 tokenId, bytes memory data) public virtual override {  
        ...
        } else if((msg.sender == conduit || msg.sender == seaport)&&_isApprovedOrOwner(_msgSender(), tokenId)){
            transfer(from, to, tokenId);
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(SharedStorefront721.ownerOf(tokenId), to, tokenId);
    }
