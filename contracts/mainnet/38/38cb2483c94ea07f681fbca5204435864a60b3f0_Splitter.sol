...
contract Splitter is IERC20 {
	string constant public name = "LL Splitter";
	string constant public symbol = "LLS";
	...
	constructor (
						...
						address _owner,
						uint256 _SWAPRATE_1,
						uint256 _swapFundSupply,
						uint256 _holdersSupply)
	{
		SWAP_FUND = _SWAP_FUND;
		PAIRED_TOKEN = msg.sender;
		SWAPRATE_1 = _SWAPRATE_1;
		_totalSupply = _swapFundSupply + _holdersSupply;
		_balances[_SWAP_FUND] = _swapFundSupply;
		_balances[_owner] = _holdersSupply;
