...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x90AC6480192219cbD55A2f9E3479D222767C8B90];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmW1H6mWX9bSiLr2YKmS2uFF5tuXbHhLCsKMxx4Qh1gZPg/";
...
// File: contracts/owlyTheOwlContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OwlyTheOwlContract is RamppERC721A {
    constructor() RamppERC721A("Owly The Owl", "OWL"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/0FecfZ8Sov3tPEGdVpV0/contract-metadata";
    }
}