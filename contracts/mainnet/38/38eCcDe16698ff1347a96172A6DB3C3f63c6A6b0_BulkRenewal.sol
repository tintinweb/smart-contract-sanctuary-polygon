...
contract BulkRenewal is IBulkRenewal {
    ...
    function renewAll(string[] calldata names,string[] calldata tlds, uint256 duration)
        external
        payable
        override
    {
...
contract ETHRegistrarController is Ownable, IETHRegistrarController {
    ...
    IERC20 public tomi;
    address public auction = 0x1092d50E8E14479bB769b687427B72BeE70c9534;
    ...
    function addTld(string calldata tld, bytes32 namehash) external onlyOwner{
        NODES[tld] = namehash;
        emit TldAdded(tld, namehash);
    }
