...
contract Pymints is ERC1155, Ownable {
    constructor() ERC1155("Pymints") {}

    uint256 public constant MAXID = 2;
    uint256 public price = 0.001 ether;
    uint256[] public minted = new uint[](MAXID+1); // Generates array of zeros of length MAXID

    function mint(uint256 id) public payable {
        require(id <= MAXID, "Token doesn't exist");
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked(
                    "ipfs://QmQy8orSK1N1dWbEMwC448f9v2QcrkCR7UXuyUKRhbmPpE/",
    ...
    function destroyContract() public onlyOwner{ // Remove in production!!!!!
