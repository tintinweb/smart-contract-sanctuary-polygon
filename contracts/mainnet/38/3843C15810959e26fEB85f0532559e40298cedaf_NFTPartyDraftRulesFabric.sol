...
import "contracts/NFTPartyDraftRules.sol";
...
/// @title NFTPartyDraftRules Fabric
contract NFTPartyDraftRulesFabric is
    Base,
    Access,
    ...
    SaleTaxNumeratorStorage
{
    ...
    function _init(
        ...
        NFTPartyDraftRules(result).initialize({
            nameValue: string(abi.encodePacked("NFT Draft Party Rule", tokenId.toString())),
            symbolValue: string(abi.encodePacked("DPR", tokenId.toString())),
            versionValue: "1",
            treasuryAddress: treasury,
            coinAddress: coin,
            mintPriceValue: mintPrice,
            transferTaxValue: transferTax,
            saleTaxNumeratorValue: saleTaxNumerator,
    ...
    function _init2(
        ...
        NFTPartyDraftRules(result).initialize2({
            nftPassportAddress: nftPassport,
            nftPartyAddress: nftParty,
            partyIdValue: tokenId
        });
    }
    ...
    /// @param nftPassport nftPassport address to set on instance
    /// @param nftParty nftParty address to set on instance
    /// @param tokenId nftParty token id to set on instance
    function create(
