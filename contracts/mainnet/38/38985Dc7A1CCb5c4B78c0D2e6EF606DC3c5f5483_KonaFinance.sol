...
contract KonaFinance is KonaStorage, IKonaFinance {
    ...
    function createLoan(uint256 _providerID, uint256 _loanID, uint256 _amount, address _borrower, string memory _borrowerInfo, uint256 _maturity, uint256 _repayments, uint256 _apy, uint256 _interestRate, uint256 _amountPlusInterest, uint256 _excessCollateral) external {
        ...
        require(_amount > 0 && _interestRate > 0 && _apy > 0 && _amountPlusInterest >= _amount, "Invalid conditions");
    ...
    function updateLoanInfo(uint256 _providerID, uint256 _loanID, uint256 _amount, address _borrower, string memory _borrowerInfo, uint256 _maturity, uint256 _repayments, uint256 _apy, uint256 _interestRate, uint256 _amountPlusInterest, uint256 _excessCollateral) external {
        require(providers[_providerID].valid, "Invalid provider");
