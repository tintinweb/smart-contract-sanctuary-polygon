...
// File: contracts/IERC20Snapshot.sol


// Code credits:https://github.com/leovigna/erc20-snapshot-vault
...
contract LeeToken is ERC20, ERC20Snapshot, Ownable, IERC20Snapshot {

    mapping(address => bool) public isGame;
    
    constructor() ERC20("LEE TOKEN", "LEE") {
    ...
    function snapshot() public override onlyGame returns (uint256) {
        return _snapshot();
    }
