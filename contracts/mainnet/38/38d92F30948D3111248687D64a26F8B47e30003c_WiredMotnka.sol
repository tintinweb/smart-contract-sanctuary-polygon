...
/**
 * @title WiredMotnka
 * WiredMotnka - ERC721 NFT contract.
 */
contract WiredMotnka is ERC721 {
    // Using.
    ...
    /**
     * @dev Create collectible for specific address.
     */
    function createCollectibleFor(address to) public payable returns (uint256) {
        uint256 tokenId = _nextTokenIdToMint;
        require(tokenId <= _maxTokenId, "All tokens already minted.");
        require(msg.value >= _minMintPrice, "Not enough funds.");
