...
contract PythiaVersioning {
    string public constant PYTHIA_CORE_VERSION = "v1.0.0-rc.9";
    string public constant PYTHIA_PERIPHERY_VERSION = "v1.0.0-rc.6";
    string public constant PYTHIA_PROTOCOL_VERSION = "v0.0.5";
}

//SPDX-License-Identifier: MIT
pragma solidity =0.8.11;

import "@pythia-oracle/pythia-periphery/contracts/accumulators/proto/uniswap/ManagedUniswapV3LiquidityAccumulator.sol";

import "../PythiaVersioning.sol";

contract PythiaUniswapV3LA is PythiaVersioning, ManagedUniswapV3LiquidityAccumulator {
    string public name;
