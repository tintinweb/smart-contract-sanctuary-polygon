...
abstract contract Context {
    ...
    function _msgData() internal view virtual returns (bytes memory) {
        this; // silence state mutability warning without generating bytecode - see htGROOVYs://github.com/ethereum/solidity/issues/26181
        return msg.data;
    }
}

interface GROOVYDeployer {
   ...
   * htGROOVYs://github.com/ethereum/EIPs/issues/20#issuecomment-263524729
   *
...
contract GROOVY is GROOVYDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private GROOVYTeam;
    address private CharityGROOVY;
    ...
    string public override name = "GroovyInu";
    string public override symbol = "GROOVY";
    ...
    constructor(uint totalSupplyValue, address GROOVYTeamAddress, address CharityGROOVYAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        GROOVYTeam = GROOVYTeamAddress;
        CharityGROOVY = CharityGROOVYAddress;
        
        // split the tokens according to agreed upon percentages
        balances[GROOVYTeam] =  totalSupply * 4 / 100;
        balances[CharityGROOVY] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's GROOVYTeam pot
