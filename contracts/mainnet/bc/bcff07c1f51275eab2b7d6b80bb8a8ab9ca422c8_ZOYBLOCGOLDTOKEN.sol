...
contract ZOYBLOCGOLDTOKEN is Ownable, ERC20PresetMinterPauser {
    constructor ()
        ERC20PresetMinterPauser("ZOYBLOC GOLD TOKEN", "ZGT")
        public
    {
    ...
    function OwnerSetupMinterRole(address account) public virtual onlyOwner {
        setupRole(MINTER_ROLE, account);
    }

    function OwnerRevokeMinterRole(address account) public virtual onlyOwner {
