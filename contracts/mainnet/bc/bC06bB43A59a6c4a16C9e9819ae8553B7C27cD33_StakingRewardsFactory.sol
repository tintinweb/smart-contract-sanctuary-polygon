...
contract StakingRewardsFactory is Ownable {
    ...
    function deploy(address rewardsToken, uint rewardAmount, uint256 rewardsDuration) public onlyOwner {
        StakingRewardsInfo storage info = stakingRewardsInfoByRewardToken[rewardsToken];
