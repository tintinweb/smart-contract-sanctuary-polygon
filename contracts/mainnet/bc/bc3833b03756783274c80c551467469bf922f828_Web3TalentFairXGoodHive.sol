...
contract Web3TalentFairXGoodHive is Ownable, ERC1155Supply {
    using Strings for uint256;

    string public name = "Web3TalentFair x GoodHive 2022";

    string public symbol = "WTF-GOODHIVE";
    ...
    constructor()
    ERC1155("ipfs://QmPYmJLeWgEtMHSqa8VY4n9wqgu5y1cNDDbBYnXJZHyP5V/")
        {
        }
