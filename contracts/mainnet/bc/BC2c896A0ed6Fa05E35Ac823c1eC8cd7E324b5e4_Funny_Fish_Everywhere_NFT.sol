...
/// @title FunuyFishEverywhereNFT
/// @notice A contract for pixelnauts in the starlink ecosystem
contract Funny_Fish_Everywhere_NFT is Ownable, ERC721A, ReentrancyGuard {
    using   Strings for uint256;

    uint256 public maxSupply = 7777;
    string private _baseTokenURI;

    constructor (string memory _pendingURI) ERC721A("Funny Fish Everywhere NFT", "FFE", maxSupply, maxSupply) {
    ...
    function mint(uint256 _mintAmount, address recipient) external payable callerIsUser{
