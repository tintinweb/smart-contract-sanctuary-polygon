...
contract OXXR is Initializable, ERC721Upgradeable, ERC721BurnableUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function setBaseTokenURI(string memory uri) public onlyRole(UPGRADER_ROLE) {
        tokensURI = uri;
    }
...
contract OXXRV2 is OXXR {
    ...
    function safeMint(address to, uint256 tokenId, string memory name) public virtual onlyRole(MINTER_ROLE) {
    ...
    // V2
    function  getDiamondName(uint256 tokenId) public view returns(string memory){
