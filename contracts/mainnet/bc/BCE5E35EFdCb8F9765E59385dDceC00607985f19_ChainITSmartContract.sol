...
contract ChainITSmartContract is
    Initializable,
    ERC721Upgradeable,
    ...
    OwnableUpgradeable
{
    ...
    // constructor() ERC721("ChainITSmartContract", "CHAINITSC") {}
    function initialize() public initializer {
        __ERC721_init('ChainIT Smart Contract', 'CHAINITSC');
    ...
    function mintNFT(
        ...
        string memory vdtTokenURI
    ) public onlyOwner returns (uint256) {
        _tokenIds.increment();

        uint256 newItemId = _tokenIds.current();
        _mint(businessRecipient, newItemId);
        _setTokenURI(newItemId, vdtTokenURI);
    ...
    function updateTokenURI(
        ...
        _setTokenURI(tokenId, vdtTokenURI);
        return true;
    }
