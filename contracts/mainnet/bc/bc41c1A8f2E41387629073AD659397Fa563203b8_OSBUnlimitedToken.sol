...
import "../../contracts/libraries/OSBUnlimitedToken.sol";

contract $OSBUnlimitedToken is OSBUnlimitedToken {
...
contract OSBUnlimitedToken is ERC20Upgradeable, OwnableUpgradeable {
    ...
    event ContractDeployed(address owner, string name, string symbol, uint256 issueAmount);
    ...
    function initialize(
        ...
        emit ContractDeployed(_owner, _name, _symbol, _issueAmount);
    }
