...
contract DividendDistributor is IDividendDistributor {
    ...
    IDEXRouter router;
    address routerAddress = 0x51aBA405De2b25E5506DeA32A6697F450cEB1a17;
    IBEP20 RewardToken = IBEP20(0x22a31bD4cB694433B6de19e0aCC2899E553e9481);
...
contract BabyMeerkat is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BabyMeerkat";
    ...
    address routerAddress = 0x51aBA405De2b25E5506DeA32A6697F450cEB1a17;
    address RewardToken = 0x22a31bD4cB694433B6de19e0aCC2899E553e9481;
    ...
    constructor () Auth(msg.sender) {
        ...
        devWallet = 0x869bA8bFD4fc493b11CE16ede396449f65B555d4;
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 amountMATICMarketing = amountMATIC.sub(amountMATICLiquidity).sub(amountMATICReflection);

        try dividendDistributor.deposit{value: amountMATICReflection}() {} catch {}
        
        uint256 marketingShare = amountMATICMarketing.mul(3).div(4);
        uint256 devShare = amountMATICMarketing.sub(marketingShare);
