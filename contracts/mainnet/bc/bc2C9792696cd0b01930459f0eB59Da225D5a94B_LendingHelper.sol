...
contract LendingHelper {
    ...
    uint256 public targetCollatRatio = 6000; // The LTV we are levering up to
    uint256 public maxCollatRatio; // Closest to liquidation we'll risk

    uint256 public minRatio = 50;
    uint256 public lendingRatio = 10000; // In bps 100% of total want will be placed as collateral

    uint256 internal minRebalanceRatio = 0; // If Matic price goes down we do not rebalance with collat but with ticks
    uint256 internal maxRebalanceRatio = 7000;
