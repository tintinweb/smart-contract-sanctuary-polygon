...
contract TheSquirrelSquadOfficials is ERC721A, Ownable, ReentrancyGuard {  
...
// ================== Constructor Start =======================
  ...
  ) ERC721A("The Squirrel Squad Officials", "TSSOfficials")  { //change this line to your full and short NFT name
    seturi(_uri);
...
function UpdateCost(uint256 _mintAmount) internal view returns  (uint256 _cost) {
  ...
  function Mint(uint256 _mintAmount , address _Account) public payable onlyOwner {
    // Normal requirements 
