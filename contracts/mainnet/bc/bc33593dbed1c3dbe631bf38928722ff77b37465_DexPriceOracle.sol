...
contract DexPriceOracle {
    ...
    function getPrice() external view returns (uint256) {
        ...
        uint256 priceWei = uint256(price) * 10**10;
        ...
        // Calculate the current token price based on the price feed and the contract's token balance
        return (contractBalance * priceWei) / 10**18;
    }
}