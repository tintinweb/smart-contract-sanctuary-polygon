...
contract Viden is DefaultOperatorFilterer, ERC721A, Ownable {
    ...
    uint256 public maxMintAmountWaitList = 5000;
    ...
    uint256 public _nftEtherValue = 33000000000000000000;
    uint256 public _nftEtherValueWaitList = 26000000000000000000;

    uint256 private splitInst   = 50;    
    address private wSplit      = 0x8Ceb9e7d28D387DE9f17ef2FEd19D59A9ff90A41;
    address private SplitEduca  = 0x15D20FAf3aBD46154E913c7925e307047381B5A5;
    ...
    ) ERC721A("W3 Books", "PMW3") {
        setBaseURI("http://ipfs.io/ipfs/QmXavsixQLAzAwX13qVKdResb2UXoSELfSxghgxLLk43F4/");
        _contractUri = "https://ipfs.io/ipfs/QmVcYDyG3MdnwNSQb8vixzB3bkR4w8F7ij4SwF4SW7jJpy";
    ...
    function split(uint256 _mintAmount) public payable {
        ...
        payable(SplitEduca).transfer(address(this).balance);
    }
