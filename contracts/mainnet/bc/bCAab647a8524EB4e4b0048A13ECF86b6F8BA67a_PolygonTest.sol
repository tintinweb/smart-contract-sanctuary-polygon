...
contract PolygonTest is ERC721A, Ownable, ContextMixin {
    enum SaleStatus{ PAUSED, PRESALE, PUBLIC }

    uint public constant COLLECTION_SIZE = 5400;
    ...
    string public preRevealURL = "ipfs://QmbJzi7d3hLbdjPKtknMP4bDzNqj7vtQWxHx3e7UCmn9sU";
    mapping(address => uint) private _mintedCount;
    

    constructor() ERC721A("PolygonTest", "Azuki"){}
    /// @notice Polygon OpenSea overrides    
	function _msgSender()
            internal
            override
            view
    ...
    function isApprovedForAll(
          ...
          // if OpenSea's ERC721A Proxy Address is detected, auto-return true
