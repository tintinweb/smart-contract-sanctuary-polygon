...
contract LeaguePassNFT is ERC721Upgradeable, SeasonSync {
    ...
    function setWhitelistedAddr(address _addr, bool _val) public onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function setIsInMarketingList(address _addr, bool _val) public onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function setIsAllowedToFillLastDivision(address _addr, bool _val) public onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function setOneTokenPerAccount(bool _state) public onlyRole(DEFAULT_ADMIN_ROLE) {
