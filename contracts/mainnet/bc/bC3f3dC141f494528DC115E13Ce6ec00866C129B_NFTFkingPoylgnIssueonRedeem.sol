 ...
 */
interface INFTFkingPoylgnIssueonRedeem {
    /**
...
contract NFTFkingPoylgnIssueonRedeem is
    INFTFkingPoylgnIssueonRedeem,
    ERC721AQueryable,
    ERC2981,
    Ownable,
    ReentrancyGuard
{
    ...
    constructor(
        ...
        bytes32 _root
    ) ERC721A("NFT0 Fking Poylgn Issue on Redeem", "NFPIOR") {
