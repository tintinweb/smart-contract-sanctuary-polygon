...
contract NFTX7 is ERC721A, Ownable, ReentrancyGuard , ERC721ABurnable {
 ...
 IERC20 public usdt = IERC20(0xc2132D05D31c914a87C6611C10748AEb04B58e8F); 
  ...
  //enough funds to buy NFTS
   ...
   function publicMint(uint256 _mintAmount) public nonReentrant mintCompliance(_mintAmount)  {
...
// SETTERS DONE BY OWNER ONLY
  ...
  function setpublicEnabled (bool choice) public onlyOwner nonReentrant { 
   ...
   function withdrawUSDT() external onlyOwner nonReentrant {
    ...
    require(usdt.transfer(msg.sender, balance), "USDT transfer failed");
}
...
function withdrawMATIC() external onlyOwner nonReentrant {
