...
contract Vsaki is ERC721 , DefaultOperatorFilterer {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeicbaa56vq6ohqakr7wqurqsi7vflmssgnbcgb2spuup7wqdjksj2u/", Strings.toString(tokenId), ".json")
            );
    }
