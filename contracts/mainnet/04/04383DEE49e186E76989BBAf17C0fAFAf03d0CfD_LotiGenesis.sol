 ...
 *   / _  | / _  )|  _ \  / _  ) /___)| | /___)
 *  ( ( | |( (/ / | | | |( (/ / |___ || ||___ |
 *   \_|| | \____)|_| |_| \____)(___/ |_|(___/ 
 *  (_____|                                    
 *
 * @title LotiGenesis
 * @notice LotiGenesis - a contract for Loti Genesis NFTs.
 */
contract LotiGenesis is ERC1155URIStorage, Ownable {
    ...
    /**
     * @dev We revok this function to allow contract owner to move NFTs
     */
    function setApprovalForAll(
        address,
        bool
    ) public virtual override {
        revert("Loti Genesis: Removed function.");
    }
