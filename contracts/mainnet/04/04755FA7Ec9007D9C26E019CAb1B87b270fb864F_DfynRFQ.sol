...
*/
contract DfynRFQ is Ownable, Pausable {
    ...
    event WhitelistAdded(address custodian);
    event WhitelistRemoved(address custodian);
    ...
    function updateFeeAddress(address _newFeeAddress) external onlyOwner {
        require(_newFeeAddress != address(0));//solhint-disable reason-string
    ...
    */
    function removeSigner(address _signer) external {
        require(signers[msg.sender][_signer], "Invalid signer");
    ...
    */
    function addWhitelist(address _custodian) external onlyOwner {
        ...
        emit WhitelistAdded(_custodian);
    }
    ...
    */
    function removeWhitelist(address _custodian) external onlyOwner onlyWhitelisted(_custodian) {
        ...
        emit WhitelistRemoved(_custodian);
    }
