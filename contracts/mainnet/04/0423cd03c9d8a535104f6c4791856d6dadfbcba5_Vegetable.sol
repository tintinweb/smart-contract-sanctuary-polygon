...
contract Vegetable is ERC721, ContextMixin {
    using SafeMath for uint256;

    uint256 private constant TOTAL_SUPPLY = 13;
    ...
    constructor() ERC721("Vegetable", "VGTBL") {
    ...
    function _baseURI() internal view virtual override returns (string memory) {
        return "https://ipfs.io/ipfs/QmXRpzHVcV7VCwqMhpNVFmedG1yuJDPv2ovB4iMwxnDPtD/";
    }
