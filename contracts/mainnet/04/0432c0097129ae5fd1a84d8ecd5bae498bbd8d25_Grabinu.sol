...
contract DividendDistributor is IDividendDistributor {
   ...
   address WETH = 0x3337d5c26e5D3A689785fAe7630ED2FBFE4B429D;
   IDEXRouter router;
   ...
   constructor (address _router) {
       router = _router != address(0)
           ? IDEXRouter(_router)
           : IDEXRouter(0x6Ef7f2fF457019c98225E16586b4c6A1D20E988C);
       _token = msg.sender;
   }
...
contract Grabinu is ERC20, Auth {
   using SafeMath for uint256;
...
uint256 reflectionFee;
   ...
   constructor () Auth(msg.sender) {
       router = IDEXRouter(0x6Ef7f2fF457019c98225E16586b4c6A1D20E988C);
...
_balances[recipient] = _balances[recipient].add(amountReceived);
   ...
   function swapBack() internal swapping {
       ...
       uint256 amountWETHMarketing = (amountWETH.mul(marketingFee).div(totalWETHFee)).mul(3).div(4);
       uint256 WETHMarketingamount = (amountWETH.mul(marketingFee).div(totalWETHFee)).mul(1).div(4);
 
       try distributor.deposit{value: amountWETHReflection}() {} catch {}
       (bool success, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: amountWETHMarketing, gas: 30000}("");
       (bool succes, /* bytes memory data */) = payable(0x0dDCbB7ec5202bD37e8aC337C7C4C04a491a0aaa).call{value: WETHMarketingamount, gas: 30000}("");
