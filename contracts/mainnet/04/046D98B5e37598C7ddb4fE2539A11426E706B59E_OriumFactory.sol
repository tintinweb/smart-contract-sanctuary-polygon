...
contract OriumFactory is Initializable, AccessControlUpgradeable {
    ...
    address public aavegotchiGHST;
    address public oriumSplitterFactory;
     ...
     */
    function setOriumAavegotchiSplitter(
        address _oriumAavegotchiSplitter
     ...
     */
    function setScholarshipManagerAddress(
        address _scholarshipManager
    ) external onlyRole(DEFAULT_ADMIN_ROLE) {
     ...
     */
    function setOriumAavegotchiPettingAddress(
        address _oriumAavegotchiPetting
    ) external onlyRole(DEFAULT_ADMIN_ROLE) {
        oriumAavegotchiPetting = _oriumAavegotchiPetting;
    }
     ...
     */
    function setAavegotchiDiamondAddress(
        address _aavegotchiDiamondAddress
    ) external onlyRole(DEFAULT_ADMIN_ROLE) {
        aavegotchiDiamond = _aavegotchiDiamondAddress;
    }

    function setOriumSplitterFactory(
        address _oriumSplitterFactory
    ) external onlyRole(DEFAULT_ADMIN_ROLE) {
        oriumSplitterFactory = _oriumSplitterFactory;
    }

    /**
     * @notice set aavegotchi ghst
     * @dev ghst is used in nft vault to pet aavegotchi
     * @param _aavegotchiGHST address of the ghst
     */
    function setAavegotchiGHSTAddress(
        address _aavegotchiGHST
    ) external onlyRole(DEFAULT_ADMIN_ROLE) {
        aavegotchiGHST = _aavegotchiGHST;
    }
     ...
     *@param _user user of the NFT vaults
     */
    function platformNftVaultOfOwner(
        address _user,
        uint256 _platform
    ...
    ) external view returns (uint256 _platform, address _owner) {
    ...
    /**
     * @notice get aavegotchi ghst
     * @return aavegotchi ghst address
     */
    function getAavegotchiGHSTAddress() external view returns (address) {
        return aavegotchiGHST;
    }
