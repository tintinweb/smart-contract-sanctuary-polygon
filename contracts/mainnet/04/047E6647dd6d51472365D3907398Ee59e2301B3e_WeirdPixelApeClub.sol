...
contract WeirdPixelApeClub is ERC721 {
    ...
    constructor()
        ERC721("Weird Pixel Ape Club", "WPAC")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeidsddyzjeb2sdoykx7ovqr75drspwekwpwv7ntz3v2n3zhsglqiim/", Strings.toString(tokenId), ".json")
            );
    }
