...
// File: contracts/pillowcats-poly.sol
...
contract pillowcats is Ownable, ERC721, NonblockingReceiver {
    ...
    uint256 nextTokenId = 6420;
    uint256 MAX_MINT_POLYGON = 8469;
    ...
    function mint(uint8 numTokens) external payable {
        require(numTokens < 3, "pillow cats: Max 2 NFTs per transaction");
        require(
            nextTokenId + numTokens <= MAX_MINT_POLYGON,
            "pillow cats: Mint exceeds supply"
        );
