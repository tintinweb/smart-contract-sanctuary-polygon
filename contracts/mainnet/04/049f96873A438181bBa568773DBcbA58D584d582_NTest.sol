...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x14db5E1ce67D8Df5E515dAfE9FbA2587aC87afAF;
...
contract NTest is Context, IERC20, Ownable { 
    ...
    // owners address made payable to collect contract balance
    address payable private WalletOwner = payable(0xC29576653f746f89dd2cCf77d441f59623C83626);
    ...
    // Setting the initial fees in bips
    ...
    constructor () {
        ...
        // Create pair address for QuickSwap
    ...
    */
    ...
    function setFeesOff() external onlyOwner() {
        _sellFee = 0;
        _buyFee = 0;
    }
    ...
    */
    ...
    // Toggle on and off to auto process tokens to Matic wallet 
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        sendToWallet(WalletOwner,contractETH);
    }
    ...
    // Change Owner payable address to manage liquidity
    function setWalletOwner(address payable newWallet) external onlyOwner{
        require(newWallet != address(0),"Invalid address entered");
    ...
    */
    ...
    UPDATE QuickSwap ROUTER AND LIQUIDITY PAIRING
    ...
    */
    ...
    // Set new address - This will be the 'LP' address for the token pairing
    ...
    */
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256) {
        uint256 tDev = tAmount*_TotalFee/1000;
