...
contract AirDrop is ERC721, Ownable {
    ...
    // metadata URIs
    string public _contractURI; // initially set at deploy
    string public _currentBaseURI; // initially set at deploy
     ...
     */
    function ownerMint(address[] memory _addresses) external onlyOwner {
        _mintNFT(_addresses);
    }
     ...
     */
    function _mintNFT(address[] memory _addresses) private {
