...
contract MagicLipsDeployer is ERC721 , DefaultOperatorFilterer {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeidop7kk2qtnpmpjnstqahbc7gnuvlcydbuitsstzuakl5k6e3tdpm/", Strings.toString(tokenId), ".json")
            );
    }
