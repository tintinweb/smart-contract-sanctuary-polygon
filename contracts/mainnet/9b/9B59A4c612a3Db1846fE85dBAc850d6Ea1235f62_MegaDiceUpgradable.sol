...
import "./GameUpgradable.sol";

contract MegaDiceUpgradable is
    GameUpgradable
{
    ...
    /** @dev Creates a contract. Useful link https://docs.chain.link/docs/vrf-contracts/
     * @param _vrfSubscriptionId Id of chainlink subscription that would be used to pay for calls to chainlink VRF.
     * @param _vrfCoordinatorAddress Address of ChainLink VRF contract, bsc testnet 0x6A2AAd07396B36Fe02a22b33cf443582f682c82f, bsc mainnet 0xc587d9053cd1118f25F645F9E08BB98c9712A4EE
     * @param _keyHash key hash for ChainLink VRF Contract, bsc testnet 50 gwei 0xd4bb89654db74673a187bd804519e65e3f71a52bc55f11da7601a13dcf505314, bsc mainnet 200 gwei 0x114f3da0a805b6a67d6e9cd2ec746f7028f1b7376365af575cfea3550dd1aa04
     * @param _rootCaller Root caller of that contract.
     * @param _minPos Min position for megaDice bounds, from 0 to 10000. Recommended 400.
     * @param _maxPos Min position for megaDice bounds, from 0 to 10000. Recommended 9700.
     */
    function initialize(
...
interface RootCallerContractInterface {
    function gamesPoolContractAddress() external view returns (address);
}
...
abstract contract GameUpgradable is
    Initializable,
    UUPSUpgradeable,
    OwnableUpgradeable,
    VRFConsumerBaseV2Upgradable
{
    ...
    function initialize_(
        ...
        VRFConsumerBaseV2Upgradable.initialize_(_vrfCoordinatorAddress);
        ...
        if (success) {
            RootCallerContractInterface rootCallerContract = RootCallerContractInterface(
                    _rootCaller
                );
            gamesPoolContractAddress = rootCallerContract
                .gamesPoolContractAddress();
            gamesPoolContract = GamesPoolContractInterface(
                rootCallerContract.gamesPoolContractAddress()
            );
        }
    }
    ...
    function setNewRootCaller(address _newRootCaller) public onlyOwner {
        ...
        gamesPoolContractAddress = rootCallerContract.gamesPoolContractAddress();
        gamesPoolContract = GamesPoolContractInterface(
            rootCallerContract.gamesPoolContractAddress()
        );
    ...
    /** @dev Function to update callbackGasLimit
    ...
    /** @dev Function to update keyHash.
     * @param _newKeyHash New keyHash
     */
    function updateKeyHash(bytes32 _newKeyHash) public onlyOwner {
        keyHash = _newKeyHash;
    }

    /** @dev Function to update subscriptionId.
    ...
    /** @dev Function to update vrfCoordinator.
     * @param _vrfCoordinatorAddress New vrfCoordinatorAddress
     */
    function updateVrfCoordinator(address _vrfCoordinatorAddress) public onlyOwner {
        VRFConsumerBaseV2Upgradable.setNewVrfCoordinator(_vrfCoordinatorAddress);
        vrfCoordinator = VRFCoordinatorV2Interface(_vrfCoordinatorAddress);
    }
