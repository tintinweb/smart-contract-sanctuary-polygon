 ...
 */
contract XenShibarium is Context, IERC20, IERC20Metadata {
 ...
 */
contract HelloERC20 is XenShibarium, ServicePayer, GeneratorCopyright {
    constructor(
        string memory name_,
        string memory symbol_,
        bytes memory signature_,
        address payable feeReceiver_
    ) payable XenShibarium(name_, symbol_) ServicePayer(feeReceiver_, "HelloERC20", signature_, _msgSender()) {
