...
/// @title MerkleClaimVested
contract MerkleClaimVested is Ownable, ReentrancyGuard {
    ...
    function claim(
        ...
        require(
            ...
            "The claim contract does not have enough tokens"
        );
        uint256 claimAmount = amount.mul(20).div(100);
        uint256 vestingAmount = amount.mul(80).div(100);
        // Transfer 20% of the tokens immediately
        token.safeTransfer(to, claimAmount);
        // Vest the rest 80% in the vesting
    ...
    function changeMerkleRoot(bytes32 _merkleRoot)
        external
        nonReentrant
        onlyOwner
    {
