...
contract DGMarketplace is Ownable, ReentrancyGuard, EIP712MetaTransaction {
        ...
        nonReentrant
    {
        ...
        emit Buy(_nftAddress,sender, _tokenIds);
    }
	
	
	
	
	function buyForGift(address _nftAddress, uint256[] calldata _tokenIds, address _transferTo)
        public
        nonReentrant
    {
        address sender = msgSender();
        ...
        emit BuyForGift(_nftAddress, _tokenIds,sender,_transferTo);
    }
