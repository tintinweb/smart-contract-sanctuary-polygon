...
contract BeHuman is ERC721, ReentrancyGuard, Ownable {
  ...
  uint256 public constant MINT_LIMIT_PER_WALLET = 6986;
  ...
  uint256 public constant MAX_SUPPLY = 6986;

  uint256 public constant MAX_MULTIMINT = 6986;
  ...
  function mint(uint256 count) public nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 6986 at a time");
