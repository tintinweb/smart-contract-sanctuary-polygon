...
contract EarlyWolf is ERC721Enumerable, Ownable {
    using Strings for uint256;
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    string public uri = "https://alphawolf.mypinata.cloud/ipfs/QmaP4YHdM5Zg9KhpDQv1zBbXhrcbyXHkeCArkTn8mdhoCB/";
    ...
    address teamWallet = 0x6FA6DA462CBA635b0193809332387cDC25Df3e8D;

    constructor() ERC721("Early Wolf", "EWF") {
    }
    ...
    function reserve(uint256 _mintAmount) public mintCompliance(_mintAmount) {
        _mintLoop(teamWallet, _mintAmount);
    }
