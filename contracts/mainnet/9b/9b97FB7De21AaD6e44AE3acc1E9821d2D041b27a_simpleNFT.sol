...
contract simpleNFT is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable{
    ...
    constructor() ERC721 ("Meta-Circles-NFT-Testing-1", "MCNFT"){
        token = 0;
    }
    ...
    function mint(address _to, string memory _tokenURI) public onlyOwner {
        _safeMint(_to, token);
        _setTokenURI(token, _tokenURI);
        token+=1;
    }


    //OVER-RIDES REQUIRED BY SOLIDITY
    ...
    function mintWithToken (address _to, string memory _tokenURI, uint256 _tokenId) public onlyOwner {
    ...
    function transfer(address _to, uint256 _tokenId) public tokenExist(_tokenId) {
