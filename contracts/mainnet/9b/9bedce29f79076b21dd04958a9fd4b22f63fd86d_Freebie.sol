...
//for presale (Phase 1)
    ...
    uint256 hardCap = 18375000000000000000000; // 18375 MATIC
...
//start presale manualy
    function EndPresaleManualy()public ownerOnly {
        endPresale = true;
    }
...
//Function to purchace in presale
    function sendToContract()external payable {
        require(startPresale, "Presale is not active!");
        require(msg.value == 875000000000000000000, "Amount must be 875 MATIC");
        require(investors[msg.sender] == 0, "You already invest!");
...
// Function to buy tokens from contract and provide liquidity
    function buyFromContractAndProvideLP()external payable {
        ...
        require(msg.value == 1312500000000000000000, "Amount must be 1312.5 MATIC!");
        require(investors2[msg.sender] == 0, "You already buy from contract!");

        uint256 _ETHvalueLP = 1312500000000000000000;
