...
contract ChanceVault is Ownable, Pausable, ReentrancyGuard {
    event withdrawInvite(address _addr, uint256 amount);
    ...
    function inviteWithdrow(address _to) public nonReentrant {
        ...
        emit withdrawInvite(msg.sender, amount);
    }

    function withdrow(address _to, uint256 amount) external nonReentrant {
        require(allowMap[msg.sender] == true, "Permission Denied");
