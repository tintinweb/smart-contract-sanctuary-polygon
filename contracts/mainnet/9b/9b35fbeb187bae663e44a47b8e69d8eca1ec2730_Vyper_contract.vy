...
@external
def createDao(governance: address, name: String[64], token_symbol: String[12], token_supply: uint256, reward_token: address):
    ...
    RewardPoolAPI(reward_pool).initialize(governance, token, reward_token, 86400, fee_batch)
