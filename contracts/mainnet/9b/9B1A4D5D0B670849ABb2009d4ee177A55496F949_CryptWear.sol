...
contract CryptWear is ERC721, Ownable, ReentrancyGuard {
    ...
    enum MintType{PRESALE, WHITELIST, PUBLIC, GIFT}
    ...
    function setMintSettings(
        ...
        uint256 _maxWhitelistMintPerWallet,
        ...
        mintSettings.maxWhitelistMintPerWallet = _maxWhitelistMintPerWallet;
    ...
    ERC721("DeadNull404", "DADNL4")
    {
        ...
        mintSettings.whitelistSalePrice = 2; //TODO !!!!!!!
        mintSettings.publicSalePrice = 5;//TODO !!!!!!!

        mintSettings.maxPresaleMintPerWallet = 10;
        mintSettings.maxWhitelistMintPerWallet = 10;
        ...
        withdrawSettings.withdrawAddress1 = 0xEE1d49DCD28ef6006F2d3f6B0Fac1767516C796d;//TODO !!!!!!!
        withdrawSettings.withdrawAddress2 = 0x8dEA2B989bB18077Af86877bf2e789696c52882a;//TODO !!!!!!!
        ...
        presaleMerkleRoot = 0x1ed81f797662b4eda551b8b8c3f3981570a6befdbee9cc9da1b6cb0e599693ae;//TODO !!!!!!!
        giftMerkleRoot = presaleMerkleRoot;//TODO !!!!!!!
        whitelistMerkleRoot = giftMerkleRoot;//TODO !!!!!!!
    }
    ...
    modifier canMint(uint256 numberOfTokens, MintType mintType) {
        if (mintType == MintType.PRESALE)
            ...
            if (mintType == MintType.WHITELIST)
                require(numberOfTokens <= mintSettings.maxWhitelistMintPerWallet, "Max wallet amount reached");

            if (mintType == MintType.PUBLIC)
                require(numberOfTokens <= mintSettings.maxWhitelistMintPerWallet, "Max wallet amount reached");

            if (mintType == MintType.GIFT)
    ...
    function mintPresale(address to, uint256 amount, uint256 amountMaxByLeaf, bytes32[] calldata proof)
    external
    canMint(amount, MintType.PRESALE) nonReentrant
    {
        require(amount <= mintSettings.maxPresaleMintPerWallet, "Max wallet amount reached");
