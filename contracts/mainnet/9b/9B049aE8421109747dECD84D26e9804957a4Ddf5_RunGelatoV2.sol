...
contract RunGelatoV2 is AccessControl{
    ...
    address public resolver = address(0x72e5A421225c1d2d1c743549F9FdC1bcCC2CeCA2); //Gelato Matic
    address constant public adminAddress = address(0xe026c89D9C4872118076466610b8f3CfD8822825);
    address constant public pandaRewardAddress = address(0x9f4EDb4f59E0281967700B27b09248C0b5E85b99);
    ...
    constructor() {
        ...
        pandaRewardContract = IPandaReward(pandaRewardAddress);
    }
