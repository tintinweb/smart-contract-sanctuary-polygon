...
contract FlashloanV2 is FlashLoanReceiverBase {
    ...
    {   
        address owner = 0xe25bf122bc1369754edEC5318AF399EB9D0857CB;
        address rouerA = _routerA;
        address routerB = _routerB;
    ...
    function executeOperation(
        ...
        IUniswapV2Router02(routerB).swapExactTokensForTokensSupportingFeeOnTransferTokens(
            ...
            (IERC20(token).balanceOf(address(this))  / 1000) * 20, 
            path, 
            address(this), 
            120000
        );
    ...
    function returnOwner() external returns(address){
        return owner;
    }
}
