...
contract TestUupsTokenV2 is ERC20CappedUpgradeable, UUPSUpgradeable, OwnableUpgradeable, Router {
    ...
    function upgradeFunction(address _abacusConnectionManager, string memory newNname, string memory newSymbol, uint256 _supply) reinitializer(2) onlyOwner public {
      __Router_initialize(_abacusConnectionManager);
      __ERC20Capped_init(_supply);
      __ERC20_init();
      _name = newNname;
      _symbol = newSymbol;
    }
...
contract ERC20Upgradeable is Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable {
     ...
     * construction.
     */
    function __ERC20_init() internal onlyInitializing {
    // function __ERC20_init(string memory name_, string memory symbol_) internal onlyInitializing {
        __ERC20_init_unchained();
        // __ERC20_init_unchained(name_, symbol_);
    }

    function __ERC20_init_unchained() internal onlyInitializing {
        // _name = name_;
        // _symbol = symbol_;
    }
