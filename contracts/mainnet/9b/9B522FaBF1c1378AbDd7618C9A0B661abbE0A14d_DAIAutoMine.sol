...
contract DAIAutoMine {
    using SafeMath for uint256;
    uint256 constant launch = 1663351200;
    ...
    function stakeStablecoins(uint256 amtx, address ref) external {
        ...
        DAI.safeTransferFrom(msg.sender, address(this), amtx);
        ...
        DAI.safeTransfer(owner, stakeFee);
    }
    ...
    function withdrawDivs() external returns (uint256 withdrawAmount) {
        ...
        DAI.safeTransfer(msg.sender, adjustedAmt);
        DAI.safeTransfer(owner, withdrawFee);
    ...
    function withdrawInitial(uint256 keyy) external {
        ...
        if (currDays < FeesKey[10].daysInSeconds){ // LESS THAN 10 DAYS STAKED
            ...
            DAI.safeTransfer(msg.sender, transferAmt);
            DAI.safeTransfer(owner, minusAmt);
    ...
    function withdrawRefBonus() external {
        ...
        DAI.safeTransfer(msg.sender, amtz);
    }
