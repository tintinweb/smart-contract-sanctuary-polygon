...
/*
            ...
            --m-m-------------------------m-m--
*/
contract HoF is Initializable, ERC1155Upgradeable, ERC1155SupplyUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    event NewRewards(address[] addrs, uint[] ids);
    using Strings for uint256;
    string public constant name = 'Hall of Fame';
    string public constant symbol = 'HoF';
    ...
    function initialize() initializer public {
        __ERC1155_init("ipfs://QmY4r4sbYErYQDCRQDj5R7QhoMxypMnEFP7FFEud5WKc4H/");
    ...
    {
        if (!ERC1155SupplyUpgradeable.exists(id)) revert DoesntExist();
