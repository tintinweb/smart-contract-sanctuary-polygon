...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x791200a3c2CdabEc4e58cD4B8C97545Ad86F1c74];
...
// File: contracts/MicelandstestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract MicelandstestContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "MICE LANDS TEST";
    string public symbol = "MLTEST";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/q7M7GMOkeSoHvHUFVeNl/contract-metadata";
  }
