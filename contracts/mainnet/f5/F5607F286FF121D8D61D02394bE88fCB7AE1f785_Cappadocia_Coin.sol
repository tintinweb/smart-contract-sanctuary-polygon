...
contract Cappadocia_Coin is ERC20, ERC20Burnable, Ownable, Mintable, Pausable, TokenRecover, DividendTrackerFunctions {
    ...
    constructor()
        ERC20("Cappadocia Coin", "DOCI") 
        Mintable(1000000000)
    {
        address supplyRecipient = 0xf7C2E55a98F03227Ba1ecA8F3142e44c7a9E4B19;
        
        taxAddressSetup(0x7bd79daDD039c8Ee9Ab08707A539a5900aaCB296);
        taxFeesSetup(50, 50, 50);

        updateSwapThreshold(15000 * (10 ** decimals()));

        lpTokensReceiverSetup(0xE42799Ca79aff244c4a2e537F14f4f85CCA1c1E8);
        liquidityFeesSetup(100, 100, 100);

        _deployDividendTracker(86400, 100000 * (10 ** decimals()), address(this));
        ...
        _mint(supplyRecipient, 30000000 * (10 ** decimals()));
        _transferOwnership(0xBA43f315a46B273c26D3872B133fE22371B114E4);
    }
    ...
    function taxFeesSetup(uint16 _buyFee, uint16 _sellFee, uint16 _transferFee) public onlyOwner {
        ...
        totalFees[0] = 0 + taxFees[0] + liquidityFees[0] + rewardsFees[0];
        totalFees[1] = 0 + taxFees[1] + liquidityFees[1] + rewardsFees[1];
        totalFees[2] = 0 + taxFees[2] + liquidityFees[2] + rewardsFees[2];
    ...
    function _transfer(
        ...
        bool canSwap = 0 + _liquidityPending + _rewardsPending >= swapThreshold;
