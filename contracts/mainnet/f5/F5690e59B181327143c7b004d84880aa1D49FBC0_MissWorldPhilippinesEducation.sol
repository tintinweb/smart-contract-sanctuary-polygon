...
// File: contracts/MissWorldPhilippinesEducation.sol
...
contract MissWorldPhilippinesEducation is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  // uint256 public requested;
  uint256 public currentSupply = 0;
  
  string public baseURI = "https://ipfs.io/ipfs/Qmb9SYR8PioVVgtCgVy1xoiXt7xSMZNwbipD3h6X1aWdsP/";
  uint256 public cost = 224 ether;

  constructor() 
    ERC721("MISS WORLD PHILIPPINES EDUCATION NFT", "MWPNFT")
