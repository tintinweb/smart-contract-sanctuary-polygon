...
contract Incrowd is ERC721, Ownable, ReentrancyGuard {
    ...
    uint256 public nftPrice = .75 ether;
    ...
    constructor() ERC721("InCrowd Alpha", "INCROWDALPHA") {
        MAX_NFTS = 1850;
    ...
    */
    ...
    function mint(uint numberOfTokens) isHuman nonReentrant external payable {
        ...
        require(balanceOf(_msgSender()).add(numberOfTokens) >= maxNftWallet, "Can only mint 2 per wallet");
