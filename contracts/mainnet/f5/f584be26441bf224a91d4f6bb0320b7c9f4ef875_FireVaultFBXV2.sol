...
contract FireVaultFBXV2 is ERC20, ERC20Burnable, ERC20Permit {
    ...
    address public constant EP_CONTRACT_ADDRESS = 0xFb0F33679639d7BfC9cfb80d4eE519F21552F504; // <<TESTING to set before deployment>>
    ...
    constructor() ERC20("FireVault FBX", "fireFBX") ERC20Permit("FireVault FBX") {
        _mint(msg.sender, 1687812698951972464115539); // Airdrop for current fireFBX owners <<TESTING to calculate before deployment>>
    ...
    function withdraw(uint256 amountFireFBX) public {
        ...
        SAFE_FBX.safeTransfer(msg.sender, amountFireFBX * withdrawalRate / 1e18);
    }
