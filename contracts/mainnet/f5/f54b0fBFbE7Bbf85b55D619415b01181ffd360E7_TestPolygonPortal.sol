...
import "./PolygonPortal.sol";

contract TestPolygonPortal is PolygonPortal {
    constructor() PolygonPortal() {}

    function processRequest(bytes calldata rawRequestData) external {
        _processRequest(rawRequestData);
    }
}