...
contract Thumbumbs is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("Thumbumbs", "THMBS") {
    customBaseURI = customBaseURI_;

    allowedMintCountMap[owner()] = 99999999999;
  }
  ...
  uint256 public constant MAX_SUPPLY = 184;

  uint256 public constant MAX_MULTIMINT = 184;
  ...
  function mint(uint256 count) public payable nonReentrant {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 184 at a time");
