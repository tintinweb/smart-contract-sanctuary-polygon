...
// File: contracts/BudiliciousPlayerself.sol
...
contract HeroesNFT is Context, AccessControlEnumerable, ERC1155Pausable {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    string private _uri;
    string public name = "Heroes Edition X Budilicious";
    ...
    function setMinter(address user) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "Must have admin role to toggle user as minter.");
