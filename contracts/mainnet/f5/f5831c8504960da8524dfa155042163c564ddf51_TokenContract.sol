...
contract TokenContract is ERC20, Ownable, Pausable {
    ...
    constructor () ERC20("TEST.finance", "TEST") {
        ...
        maxTransactionAmount = 10000 * (10**18);
    ...
    */
    ...
    function updateMaxTxnAmount(uint256 newMaxTxn) external onlyOwner {
        require(
            newMaxTxn >= 1000,
            "Cannot set maxTransactionAmount lower than 0.1%"
        );
         maxTransactionAmount = newMaxTxn;
    }
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "Already Set To That Value");
