...
contract BMortis is ERC721, Ownable {
    ...
    string baseURI = "ipfs://bafybeiak53e5bvkdtngeqdcicrk4abctibvhyl2qhmb4rpbw4w7eszbney/";
    uint256 public maxSupply = 666;
    uint256 public cost = 20 ether;
    uint256 private premint = 11;
    uint256 private startRndCount = premint + 1;

    constructor() ERC721("Beauty Mortis", "BMORT") {
        // mint to dev
