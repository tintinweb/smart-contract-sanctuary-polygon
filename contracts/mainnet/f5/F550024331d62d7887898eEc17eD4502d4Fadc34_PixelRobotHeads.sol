...
contract PixelRobotHeads is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Pixel Robot Heads", "PRH") {
    setHiddenMetadataUri("ipfs://QmZyRFCKhpf2XDeEeLF3EcV7sq5HrQmWThYJY9LaE9mc8m/PRH.json");
  }
