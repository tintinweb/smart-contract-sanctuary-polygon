...
contract Menudo is ERC721Enumerable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
  uint256 public MAX_SUPPLY = 555;
  string private baseURI;
  uint256 public publicMintPrice = 90 ether;
  bool public publicMintEnabled = true;
  mapping(address => uint256) public publicMinted;

  constructor(string memory uri) ERC721("Menudo", "Menudo") {
    baseURI = uri;
  }
