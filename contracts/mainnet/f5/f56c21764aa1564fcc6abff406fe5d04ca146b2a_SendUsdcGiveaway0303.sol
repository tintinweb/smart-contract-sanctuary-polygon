...
// UTC+8 March-03, 2022 Giveaway Contract
...
contract SendUsdcGiveaway0303 {
    ...
    function sendGiveaway() public {
        require(contractOwner==msg.sender, "Permission Denied");
        // sendUsdc(NULL, 1); // whilelist gang | v2#3428, 1U 
        // sendUsdc(NULL, 1); // ray#4105, 1U
        // sendUsdc(NULL, 1); // 製杖，持盾又販劍#9877, 1U
        // sendUsdc(NULL, 1); // xxivx#8833, 1U
        sendUsdc(0xc4318D20B5bDF5809bcdF2e20c7773dbBF77572D, 1); // DownDiver#3084, 1U .
        sendUsdc(0xda48bd546f0eEf43149bB941b14eC58B0E287D51, 5); //  XiiaoXiangg#2623, 5U .
