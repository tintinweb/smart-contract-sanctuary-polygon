    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeibmihyx7y7hhs2maz3shn25yiz3fm4arj4a4iindmuze3hgklzdua/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/Hf49tqWagRojFq3ys3wG/contract-metadata";
  }
...
// File: contracts/GenesisGangstaGoonzContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GenesisGangstaGoonzContract is RamppERC721A {
    constructor() RamppERC721A("Genesis Gangsta Goonz", "GGG"){}
}
