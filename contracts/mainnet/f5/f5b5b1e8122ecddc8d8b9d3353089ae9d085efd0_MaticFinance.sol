...
contract MaticFinance {
	receive() external payable {}
	uint256 constant public INVEST_MIN_AMOUNT = 15 ether; // 15 MATIC
	uint256 constant public WITHDRAW_MIN_AMOUNT = 30 ether; // 30 MATIC
	...
	uint256 constant public WITHDRAW_STEP = TIME_STEP / 2;
	...
	function withdraw() public {
		...
		require((totalAmountL + totalAmountU) >= WITHDRAW_MIN_AMOUNT, "min withdraw is 30 MATIC");
