...
// File: PetCommunityFundNFT.sol

/**
 * @title Pet Community Fund NFT
 * 
 * Nominate pet rescue non-profits and nationally recognized animal rescue
 * organizations that care for pets to receive funds raised by the
 * community. http://petcommunityfund.io/

 * The mission of the Pet Community Fund is to provide funds to support
 * animal rescue organizations, animal shelters and adoption agencies while
 * also providing the opportunity for pet owners to share their pet’s photo
 * and story with the community.

 * The Pet Community Fund is a decentralized autonomous organization or
 * DAO, created by ViciNFT to raise funds to distribute to animal rescue
 * organizations according to the community’s input.

 * 80% of net proceeds go into the Pet Community Fund (PCF) controlled by
 * the community. For each NFT purchased, the buyer can nominate an animal
 * rescue organization to support.

 * Thank you for your participation
 */
contract PetCommunityFundNFT is ReliefDAONFT {
    constructor() ViciERC721v4("Pet Community Fund", "PCF", 1000000) {
        setContractURI(
            "https://storage.googleapis.com/arrival-shadow-motion-newman/vici/pet-fund/PetCommunity.json"
        );
    }
}