...
contract PoolsMaticDebug is Ownable, ReentrancyGuard {
    ...
    constructor(IRefferal _refer, address gnosisSafeAddress, IPancakeRouter pancakeRouteAddress, address _wBnbAddress, address _usdAddress) {
        ...
        usd = _usdAddress;
        // user default rank 0
        rankRewards[1] = RankReward(10000 ether, 20000 ether, 5484 ether, 0, 0, 0);
        rankRewards[2] = RankReward(20000 ether, 5000 ether, 1371 ether, 0, 0, 0);
        rankRewards[3] = RankReward(20000 ether, 5000 ether, 1371 ether, 0, 0, 0);
        rankRewards[4] = RankReward(20000 ether, 5000 ether, 1371 ether, 0, 0, 0);
        rankRewards[5] = RankReward(20000 ether, 5000 ether, 1371 ether, 0, 0, 0);
    }
