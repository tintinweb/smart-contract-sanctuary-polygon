...
contract Birdz is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("BirdPunkz Classic Collection", "BPCNFT") {
    setHiddenMetadataUri("ipfs://QmQzFYvpDnC5vqMs4R5qZA3NLXCMzYKmNJozdiDfXMCzKc/hidden.json");
  }
