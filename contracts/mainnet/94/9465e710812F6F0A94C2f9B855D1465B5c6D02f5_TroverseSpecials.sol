...
contract TroverseSpecials is ERC1155, Ownable {
    mapping(address => bool) public operators;
    
    string public constant name = "Troverse Specials";
    string public constant symbol = "SPECIAL";
