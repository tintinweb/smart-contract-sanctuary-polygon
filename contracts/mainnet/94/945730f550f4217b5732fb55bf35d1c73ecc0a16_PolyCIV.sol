...
contract PolyCIV is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000000 * 10**9;       //tong cung 1 ty
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "NFTArena";                  //ten token
    string private _symbol = "NFTA";                   //ky hieu token
