...
contract BatToken is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 2e11 * 10**9;
    ...
    string private constant _name = "BatToken";
    string private constant _symbol = "BATT";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x1A8231E2fFb37A491Fc7BE9Dc9B8852d301Cf441);
        _feeAddrWallet2 = payable(0xE817879d529e151cBe2B0DBF4Ca6c65b5cBF0558);
