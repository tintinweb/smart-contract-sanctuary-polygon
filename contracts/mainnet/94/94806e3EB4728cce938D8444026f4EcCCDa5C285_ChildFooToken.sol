...
/**
 * @title Layer 2 FooToken
 * @dev See [email protected][TODO]
 * @custom:security-contact [email protected]
 */
contract ChildFooToken is ERC777, IChildToken, AccessControl, Multicall {
    bytes32 public constant DEPOSITOR_ROLE = keccak256("DEPOSITOR_ROLE");

    constructor(address depositor) ERC777("FooToken", "FOO", new address[](0)) {
