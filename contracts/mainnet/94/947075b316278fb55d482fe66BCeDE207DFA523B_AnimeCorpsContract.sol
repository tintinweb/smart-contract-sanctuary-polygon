...
//
//     ___          _                   ______                     
//    /   |  ____  (_)___ ___  ___     / ____/___  _________  _____
//   / /| | / __ \/ / __ `__ \/ _ \   / /   / __ \/ ___/ __ \/ ___/
//  / ___ |/ / / / / / / / / /  __/  / /___/ /_/ / /  / /_/ (__  ) 
// /_/  |_/_/ /_/_/_/ /_/ /_/\___/   \____/\____/_/  / .___/____/  
//                                                  /_/            
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x3304E7D41e4677EB4254A06437AD2C8c6D19aCa0];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmRUYMo5yyMEgMKVDs33WZWPsUticFAs7e1TRFihBc8m6t/";
...
// File: contracts/AnimeCorpsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AnimeCorpsContract is RamppERC721A {
    constructor() RamppERC721A("Anime Corps", "ACN"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/ByzTYEpBB1kiNRXBnlbZ/contract-metadata";
    }
}
