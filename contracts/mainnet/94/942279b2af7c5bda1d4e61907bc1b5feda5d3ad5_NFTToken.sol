...
contract ERC721Enumerable is Context, ERC165, ERC721, IERC721Enumerable {
    ...
    function _mint(address to, uint256 tokenId) internal {
       ...
       require(supply  < _maxSupply , "max supply exceeded");
       require(tokenId < _maxSupply +1, "token Id exceeded");
    ...
    function _setMaxSupply(uint256 max) internal {
        _maxSupply=max;
    }
...
contract NFTToken is ERC721Full, Governance {
    ...
    constructor() public ERC721Full("Yuanhuashe0003", "YHS0003") {
