 ...
 *
 *   - Basic interest rate: +7% every 24 hours - only for new deposits
...
contract MATICHOLD {
	...
	constructor(address payable marketing, address payable dev, address payable project, uint256 startDate)  {
		...
		startUNIX = startDate; // 1649102400 // Date and time (GMT): Monday, 04 April 2022 20:00:00
		...
		plans.push(Plan(14, 147)); // 14.7% per day for 14 days (at the end)
        plans.push(Plan(21, 141)); // 14.1% per day for 21 days (at the end)
        plans.push(Plan(28, 124)); // 12.4% per day for 28 days (at the end)
	}
