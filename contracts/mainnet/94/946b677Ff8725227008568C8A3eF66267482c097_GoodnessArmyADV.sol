...
contract GoodnessArmyADV is ERC721, ERC2981Base, Ownable {
    ...
    address constant treasureAddress = 0xD54F24577a9bE8C7205e830f6067B470740100Ba;
    address payable immutable public TreasureAddress;
    
    // Base NFT url
    string public constant contractURI = "https://src.goodness.army/manifest/goodness-army-adv-metadata";
    
    constructor() ERC721("Goodness Army ADV", "ADV") {
        TreasureAddress = payable(treasureAddress);
    }

    // nft base URI
    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://Qmd6Vh4wiV9VQuqRj7HmdHndrCgxRBPPQSah4Eut95R6d9/";
    }

    // Mint NFT
    function bunchMint(uint amount) public onlyOwner {
    ...
    function _permanentMint(uint256 tokenId) private {
        ...
        // Set Permanent url ...
        emit PermanentURI( string(abi.encodePacked(_baseURI(),tokenId.toString())), tokenId);
        // token ID increment
