...
contract RTKStaking is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize(
        ...
        setRewardsWallet(_msgSender());
        setStakesWallet(_msgSender());
    }
     ...
     * @param _day10 initial 10 Days staking Reward
     * @param _day30 initial 30 Days staking Reward
     * @param _day60 initial 60 Days staking Reward
     */
    function initializeStakingContract(
        ...
        require(_dayTime > 0, "Time should be greater than zero");
        setMinimumStakingAmount(_amount);
        setRewardParameters(_day10, _day30, _day60, _day120, _day180);
        initialized = true;
    ...
    function changeTimeLimits(uint256 _dayTime) public onlyOwner {
        days10 = _dayTime;
        days30 = _dayTime * 3;
        days60 = _dayTime * 6;
        days120 = _dayTime * 12;
    ...
    function setRewardParameters(
        ...
        tokenRewards.days10 = _day10;
        tokenRewards.days30 = _day30;
        tokenRewards.days60 = _day60;
        tokenRewards.days120 = _day120;
        tokenRewards.days180 = _day180;
    }
    ...
    function _stakeInternal(
        ...
        if (_stakingTime == days10) {
            dailyReward = (amount * tokenRewards.days10) / 100 / (10);
        } else if (_stakingTime == days30) {
            dailyReward = (amount * tokenRewards.days30) / 100 / (30 * 1);
        } else if (_stakingTime == days60) {
            dailyReward = (amount * tokenRewards.days60) / 100 / (30 * 2);
        } else if (_stakingTime == days120) {
            dailyReward = (amount * tokenRewards.days120) / 100 / (30 * 4);
        } else if (_stakingTime == days180) {
            dailyReward = (amount * tokenRewards.days180) / 100 / (30 * 6);
        }
