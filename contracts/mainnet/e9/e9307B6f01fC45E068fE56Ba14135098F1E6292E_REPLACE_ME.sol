...
contract Lister is MintBurn, DataStructure {
    ...
    mapping(uint256 => Ask) public activeListing; //active_listing...
     ...
     *
     * TODO: i guess you call this more than once to offer it for sale... 
     * how to cancel an offer for sale???
     */
    ...
    /**  
     * The '_insert' function prolly breaks if you try to add it more than once... 
     * prolly need to canel the existing one first...
     */
...
contract MintBurn is Core {
    ...
    function initialize() external onlyAdmin {
        require(!reserved, "Polygods: operation invalid");
        /* * */
