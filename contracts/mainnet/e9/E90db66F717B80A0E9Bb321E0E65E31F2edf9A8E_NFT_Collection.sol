...
contract NFT_Collection is ERC721, ReentrancyGuard {
  ...
  constructor (string memory name, string memory symbol, uint256 _royalty, uint256 basePrice, uint256 _startMint, uint256 _max, string memory _twitter, string memory _website, string memory _tgram) ERC721(name, symbol) payable {
      owner = msg.sender;
      royalty = _royalty;
