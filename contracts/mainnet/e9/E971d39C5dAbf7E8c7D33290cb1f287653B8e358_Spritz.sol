...
contract Spritz is Ownable {
    ...
    /**
     * @notice Pay by swapping token or native currency. Uses 0x for swap liquidity
     * @param to Transfer recipient
     * @param sourceTokenAddress Address of the token being sold for payment
     * @param sourceTokenAmount Amount of the token being sold for payment
     * @param paymentTokenAddress Address of the target payment token
    ...
    function payWithSwap(
        ...
        if (allowanceTarget != address(0)) {
            prepareTokenSwap(sourceTokenAddress, sourceTokenAmount, allowanceTarget);
        }
        ...
        logPayment(to, sourceTokenAddress, sourceTokenAmount, paymentTokenAddress, paymentTokenAmount, paymentReference);
