...
contract PolyOpepen is ERC1155, Ownable, Pausable, ERC1155Burnable, ERC1155Supply {
    
    uint256 public cost = 1.00 ether;
    uint256 public maxSupply = 100000;

    constructor()
        ERC1155("ipfs://bafybeidzsoeg4ojeanvbhgya6pn7qmynufjgb6ftekbj6wcq2ispwg5ny4/PolyOpepen.json")
    {}
