...
contract Wrejects is Ownable, ERC1155Supply, ERC2981 {
    ...
    constructor( string memory uri, string memory contractURI_, address feeReceiver, uint96 feeNumerator) ERC1155(uri) {
    ...
    function setContractURI(string memory contractURI_) public virtual onlyAdminAccess {
        _contractURI = contractURI_;
    }
