...
contract Semantic is ISemantic, AccessControl, Semantic721 {
    ...
    function getTurtle(uint256 tokenId) external view returns (Turtle memory turtle){
        return tokenIdForTurtleData[tokenId];
    }
    ...
    function _mintTurtle(
        ...
        for (uint256 i = 0; i < predicateAndObjects.length; i++) {
            ...
            turtle.predicateAndObjects.push(predicateAndObject);
