...
██████╔╝██║░░██║╚██████╔╝███████╗░░░██║░░░
╚═════╝░╚═╝░░╚═╝░╚═════╝░╚══════╝░░░╚═╝░░░
https://opensea.io/collection/SHUEY
https://SHUEY.com/
*/
...
contract SHUEY is SHUEYDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private SHUEYTeam;
    address private CharitySHUEY;
    ...
    string public override name = "Shuey Rhon Inu";
    string public override symbol = "SHUEY";
    ...
    constructor(uint totalSupplyValue, address SHUEYTeamAddress, address CharitySHUEYAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        SHUEYTeam = SHUEYTeamAddress;
        CharitySHUEY = CharitySHUEYAddress;
        
        // split the tokens according to agreed upon percentages
        balances[SHUEYTeam] =  totalSupply * 4 / 100;
        balances[CharitySHUEY] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's SHUEYTeam pot
