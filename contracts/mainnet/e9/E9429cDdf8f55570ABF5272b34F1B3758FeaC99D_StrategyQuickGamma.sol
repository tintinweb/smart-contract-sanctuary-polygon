...
contract StrategyQuickGamma is StratFeeManagerInitializable, GasFeeThrottler {
    ...
    function initialize(
        ...
        gammaProxy = IGammaUniProxy(IHypervisor(want).whitelistedAddress());
    ...
    function setUniProxy() external onlyManager {
        address uniProxy = IHypervisor(want).whitelistedAddress();
        require(uniProxy != address(gammaProxy), "Already Set");
        _removeAllowances;
        gammaProxy = IGammaUniProxy(uniProxy);
        _giveAllowances;
    }
