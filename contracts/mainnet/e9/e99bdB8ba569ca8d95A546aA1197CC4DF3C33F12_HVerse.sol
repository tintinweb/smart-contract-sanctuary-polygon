...
contract HVerse is ERC721, Ownable {
  ...
  constructor() ERC721("HVerse", "HVS") {
    ...
    buildings.push(Building("Marti House", 2,5,4,10,0,6));
    ...
    buildings.push(Building("Music House", 1,3,3,-4,0,2));
    buildings.push(Building("Adameus House", 2,5,2,-2,0,5));
    buildings.push(Building("Ghost House", 2,6,1,-10,0,4));
    buildings.push(Building("Beach House", 4,1,4,5,0,0));
    buildings.push(Building("Library", 3,1,3,-4,0,-5));
    buildings.push(Building("Church", 2,2,3,-10,0,0));
