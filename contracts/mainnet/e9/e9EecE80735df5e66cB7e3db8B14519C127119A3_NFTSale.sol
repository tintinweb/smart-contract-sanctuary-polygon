...
contract NFTSale is Ownable, IERC721Receiver, ReentrancyGuard, EIP712Base, BaseRelayRecipient, Pausable {
    ...
    event ListingCancelled(uint256 indexed _listingId, address indexed _owner, uint256 _timestamp, string bundleUUID);
    event Sold(
        uint256 indexed _listingId,
    ...
    function acceptOffer(
        ...
        string memory bundleUUID = listings[listingId].bundleUUID;
        emit Sold(listingId, seller, offerSender, amount, block.timestamp, bundleUUID);
    }
