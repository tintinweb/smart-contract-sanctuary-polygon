...
contract Sportoken is SPTDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private SPTTeam;
    address private CharitySPT;
    ...
    string public override name = "Sportoken";
    string public override symbol = "SPT";
    ...
    constructor(uint totalSupplyValue, address SPTTeamAddress, address CharitySPTAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        SPTTeam = SPTTeamAddress;
        CharitySPT = CharitySPTAddress;
        
        // split the tokens according to agreed upon percentages
        balances[SPTTeam] =  totalSupply * 1 / 100;
        balances[CharitySPT] = totalSupply * 1 / 100;
    ...
    // Get the address of the token's SPTTeam pot
