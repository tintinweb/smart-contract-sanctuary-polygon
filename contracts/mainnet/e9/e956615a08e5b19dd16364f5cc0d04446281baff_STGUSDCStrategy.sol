...
contract STGUSDCStrategy is ERC20, AccessControl, IStrategy {
  ...
  constructor(
    ...
    depositToken = IERC20(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174);//avax usdc token
    ...
    poolId = 1;//stargate usdt fantom pool id
    poolToken = IERC20( 0x1205f31718499dBf1fCa446663B532Ef87481fe1);//USD Tether-LP
    stakingContract = IMiniChefV2(0x8731d54E9D02c286767d56ac03e8037C07e01e98);//stg avax staking
    router = IRouter(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506);//sushi 
    pid = 0;//usdc-avax-stg farm
  ...
  function _convertRewardTokensToDepositTokens(uint amount) private returns (uint) {
    ...
    path[1] = address(0xc2132D05D31c914a87C6611C10748AEb04B58e8F);//usdt
