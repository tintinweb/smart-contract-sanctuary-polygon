...
WVRPS_Drops by WarpSound
https://warpsound.ai/

 */
contract WVRPS_Drops is ERC1155Supply, Ownable {
  event PermanentURI(string _value, uint256 indexed _id);
  string public constant name = "WVRPS Drops";
  string public constant symbol = "WVRPSD";
