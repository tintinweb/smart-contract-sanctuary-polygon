...
contract Corent is ERC20, ERC20Permit, ERC20Votes {
    constructor() ERC20("Corent", "CRT") ERC20Permit("Corent") {
        _mint(msg.sender, 138000000 * 10 ** decimals());
    }
