...
contract MutantYeti is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    function mint(uint256 tokenQuantity) public payable {
        if(msg.sender != owner()){
            ...
            require(_isSaleActive, "Sale must be active to mint Mutant Yeti Dao");
            require(
    ...
    function _mintXboxFans(uint256 tokenQuantity) internal {
        for (uint256 i = 0; i < tokenQuantity; i++) {
            uint256 mintIndex = totalSupply()+102;
