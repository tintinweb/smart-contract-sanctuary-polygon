...
contract ShogunPool is IERC721Receiver
{
    ...
    {
        require(wingsAmount > 0, "ShogunPool: Wings amount cannot be 0");
    
        address[] memory wingsGoPairMemory = _wingsGoPair;
        
        //Swap Wings for Gō
        _wingsToken.approve(_jetSwapRouterAddress, wingsAmount);
        _jetSwapRouter.swapExactTokensForTokens(wingsAmount, 0, wingsGoPairMemory, address(this), block.timestamp + _swapWaitingSeconds);
