...
contract MOTIBiTSKingdom {
    ...
    IERC20 constant BUSD_TOKEN = IERC20(0x0deDb4d343A7e60c522DEb49efF6D4Ca77AfBE46);
    ...
    function getUpgradePrice(uint256 towerId, uint256 chefId) internal pure returns (uint256) {
        if (chefId == 1) return [400000, 4000000, 12000000, 24000000, 40000000][towerId];
        if (chefId == 2) return [600000, 6000000, 18000000, 36000000, 60000000][towerId];
        if (chefId == 3) return [900000, 9000000, 27000000, 54000000, 90000000][towerId];
        if (chefId == 4) return [1360000, 13500000, 40500000, 81000000, 135000000][towerId];
        if (chefId == 5) return [2040000, 20260000, 60760000, 121500000, 202500000][towerId];
        if (chefId == 6) return [3060000, 30400000, 91140000, 182260000, 303760000][towerId];
        revert("Incorrect chefId");
    }

    function getYield(uint256 towerId, uint256 chefId) internal pure returns (uint256) {
        if (chefId == 1) return [5000, 56000, 179000, 382000, 678000][towerId];
        if (chefId == 2) return [8000, 85000, 272000, 581000, 1030000][towerId];
        if (chefId == 3) return [12000, 128000, 413000, 882000, 1564000][towerId];
        if (chefId == 4) return [18000, 195000, 628000, 1340000, 2379000][towerId];
        if (chefId == 5) return [28000, 297000, 954000, 2035000, 3620000][towerId];
        if (chefId == 6) return [42000, 450000, 1439000, 3076000, 5506000][towerId];
        revert("Incorrect chefId");
    }

    function getTreasure(uint256 treasureId) internal pure returns (uint256, uint256) {
      if(treasureId == 0) return (0, 24); // price | value
      if(treasureId == 1) return (200000, 30);
      if(treasureId == 2) return (250000, 36);
      if(treasureId == 3) return (300000, 42);
      if(treasureId == 4) return (400000, 48);
