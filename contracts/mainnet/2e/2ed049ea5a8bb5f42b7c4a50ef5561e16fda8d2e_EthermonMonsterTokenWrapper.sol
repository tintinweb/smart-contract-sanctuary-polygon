...
// File: contracts/EthermonMonsterTokenWrapper.sol
...
interface EtheremonMonsterNFTInterface {
 ...
 function getPrice(uint32 _classId)
        external
        view
...
contract EthermonMonsterTokenWrapper is
    IERC721,
    ERC721,
    ...
    SafeMathEthermon
{
    ...
    function setOperationContracts(
        address _emon,
        address _monsterNFT,
        address _dataContract,
        address _tradeContract
    ...
    function approve(address _approved, uint256 _tokenId) external override {
        EtheremonMonsterNFTInterface nft = EtheremonMonsterNFTInterface(monsterNFT);
  ...
  function balanceOf(address _owner)
   ...
   function getApproved(uint256 _tokenId)
        ...
        returns (bool)
    {
        ...
        nft.isApprovedForAll(_owner, _operator);
    }
...
//will be cleaned up to utils contract
  ...
  function baseTokenURI() public view returns (string memory) {
    return "https://ethermon.io/api/matic/monster/get_metadata/v2?monster_ids=";
  }
