...
// File contracts/farms/DaoStaking.sol
...
contract DaoStaking is ReentrancyGuard, Ownable {
    ...
    uint256 public constant groupedDuration = 86400; // 1 day
    ...
    function stake(uint256 amount, bool lock) external nonReentrant updateReward(msg.sender) {
        ...
        if (lock) {
            ...
            uint256 unlockTime = block.timestamp.div(groupedDuration).mul(groupedDuration).add(lockDuration);
