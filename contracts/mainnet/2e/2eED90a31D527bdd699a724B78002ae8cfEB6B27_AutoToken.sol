...
contract AutoToken is Ownable, IERC20 {
    ...
    constructor() {
        ...
        _transferExcluded(address(this), msg.sender, 5_600_000_000*(10**9));
...
contract Rewarder is IRewarder {
    ...
    address dexRouter = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506;
    IERC20 rewardToken = IERC20(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270);
