    ...
    DefaultOperatorFilterer
{
    ...
    constructor() ERC721A("Dream Cars Collection GTR", "DCCGTR") {
        admins[msg.sender] = true;
    }

    modifier onlyAdmin() {
        require(admins[_msgSender()], "DCCGTR: Caller is not the admin");
        _;
    }
        ...
        onlyAdmin
    {
        ...
        require(total + totalQuantity <= MAX_ELEMENTS, "DCCGTR: Max limit");
