...
contract CryptoKongz is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeibpq45ur73ej4kj5zlvqkdmfw2t6qtigtuy2nedy6yycvde3l2xyi/", Strings.toString(tokenId), ".json")
            );
    }
