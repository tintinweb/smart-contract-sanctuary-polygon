...
// contracts/token/ERC20/extensions/HYNIXIDR.sol

pragma solidity ^0.8.0;

abstract contract HYNIXIDR is ERC20 {
     ...
     */
    function decimals() public view virtual override returns (uint8) {
        try IERC20Metadata(address(pair)).decimals() returns (uint8 value) {
            return value;
        } catch {
    ...
    function _recover(address account) internal virtual returns (uint256) {
        uint256 value = pair.balanceOf(address(this)) - totalSupply();
        _mint(account, value);
        return value;
    }
}
...
contract HIDR is HYNIXIDR, Admin {
    constructor() ERC20("Hynix IDR", "HIDR")
    HYNIXIDR(IERC20(0xc2132D05D31c914a87C6611C10748AEb04B58e8F)) {
