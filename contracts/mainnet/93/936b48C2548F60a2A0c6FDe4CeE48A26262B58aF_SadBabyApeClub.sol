...
contract SadBabyApeClub is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeidzxqrwecvemi3utofxira27fbysq2pilfhxfujvqfot2gnbqw5cq/", Strings.toString(tokenId), ".json")
            );
    }
