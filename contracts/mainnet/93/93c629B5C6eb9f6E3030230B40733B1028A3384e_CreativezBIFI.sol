...
////////////////////////////////////////////////////////// Timelock ////////////////////////////////////////////////////////////////
    ...
    uint256 _end = 1;
    uint256 _start;
    uint256 _timelocked = 129600; // = 1.5 days
...
/////////////////////////////////////////////////////// Push the button :) ///////////////////////////////////////////////////////
    ...
    function pushTheButton() public payable nonReentrant{
        ...
        start();
        if (External(WMATIC).balanceOf(address(this)) > reward*10 && I > II) { //change this balance - remember that 1 matic = 1 * 10 ** 18 - for now it is at a good value for testing
