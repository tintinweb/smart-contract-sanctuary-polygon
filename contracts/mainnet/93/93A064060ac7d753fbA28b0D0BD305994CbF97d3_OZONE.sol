...
contract OZONE is ERC20BurnableUpgradeable, Operator {
    ...
    // Sender addresses excluded from Tax evmoon
    ...
    function __init_oracle(address ozoneOracle) public onlyOperatorOrTaxOffice {
        require(
            ozoneOracle != address(0),
            "oracle address cannot be 0 address"
        );
        _ozoneOracle = ozoneOracle;
    }
