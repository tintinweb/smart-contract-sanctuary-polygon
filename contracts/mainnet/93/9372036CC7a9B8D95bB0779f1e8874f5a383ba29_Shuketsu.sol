...
contract Shuketsu is ERC721 , DefaultOperatorFilterer {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeigiqb7mnxcjjrew4z6kwfvvjqjg55gyamunlgm23swhma7gob54kq/", Strings.toString(tokenId), ".json")
            );
    }
