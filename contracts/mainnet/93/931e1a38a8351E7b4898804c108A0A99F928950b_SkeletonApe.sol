...
contract SkeletonApe is Ownable, ERC721, ERC721Enumerable, ERC721Royalty, EIP712, ERC721Votes {
    ...
    constructor(address payable payee_) ERC721("Skeleton Ape", "SAPE") EIP712("Skeleton Ape", "1") {
        require(payee_ != address(0), "SkeletonApe::constructor: payee cannot be zero address");
    ...
    function batchMint(address to, uint256 amount) external onlyOwner {
        require(totalSupply() + amount <= maxSupply, "SkeletonApe::batchMint insufficient supply");
    ...
    function mint() external payable {
        require(msg.value >= price, "SkeletonApe::mint: insufficient payment");
        require(totalSupply() < maxSupply, "SkeletonApe::mint: insufficient supply");
