...
abstract contract Withdrawable is Ownable, Dropysable {
  address[] public payableAddresses = [DROPYSADDRESS,0x3e789dCc2c94f79E9EFcADe8b380D98fEe26baC6];
...
// File: contracts/DavcsPhotography.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract DavcsPhotography is
    ERC1155,
    Ownable,
    Pausable,
    ERC1155Supply,
    ...
    Allowlist
{
    ...
    string public name = "Davcs Photography ";
    string public symbol = "DavcsPhotography";
    string public contractURI = "ipfs://bafyreiax54a53gzohznfqj2bah6junrjbw7fyhhrknckxbzqwx4qnn5uue/metadata.json";
