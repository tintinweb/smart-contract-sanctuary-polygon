...
* Bitcoin Pro (BTCP) - Official Coin on Polygon Network. Always verify the contract on the official website:
* https://BitcoinPro.money/
*/
...
contract BitcoinPro is ERC20, ERC20Burnable, Ownable {
    constructor() ERC20("BitcoinPro", "BTCP") {
