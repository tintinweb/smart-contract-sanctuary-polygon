...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x4ceD7FdA23f465920DaaC0874a504029bdf5D0f4];
  address public erc20Payable = 0x4ceD7FdA23f465920DaaC0874a504029bdf5D0f4;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1000, 45000) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeihii6d24emjo53f67gkhxycbgksyfjym647emm6x54la6heytddia/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/E1CMoCenWwjLhjeuiMdz/contract-metadata";
  }
...
// File: contracts/TrumpDigitalTradingCardsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TrumpDigitalTradingCardsContract is RamppERC721A {
    constructor() RamppERC721A("Trump Digital Trading Cards", "TRUMP"){}
}
