...
contract AmateurFunkyPandasNFT is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_)
    ERC721("Amateur Funky Pandas NFT", "AFPN")
  {
  ...
  uint256 public constant PRICE = 30000000000000000000;
  ...
  function mint(uint256 count) public payable nonReentrant onlyOwner {
    ...
    require(
      msg.value >= PRICE * count, "Insufficient payment, 30 ETH per item"
    );
