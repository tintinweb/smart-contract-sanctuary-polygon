...
contract TWAPOracle is BridgeAppBase {
    ...
    event SentPrice(address _pool, uint32 _twapDuration, int24 price, uint256 blockNumber);
    event ReceivedPrice(address _pool, int24 price, uint256 blockNumber);
    ...
    function getV3TWAP(
        ...
        autoParams.data = abi.encodeWithSelector(this.onBridgedMessage.selector, _pool, price);
