...
contract PaymentUpgradableV2 is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
  ...
  function claim(address usd, address recipient) external onlyOwner() returns(bool) {
    uint256 balance = ERC20(usd).balanceOf(address(this));
    bool success = ERC20(usd).transfer(recipient, balance);
