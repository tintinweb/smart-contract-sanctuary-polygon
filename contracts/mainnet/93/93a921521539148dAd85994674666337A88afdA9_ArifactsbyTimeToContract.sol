...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0xFace9207847E347c60b53ec12Ef4728A683faAcc];
...
// File: contracts/ArifactsbyTimeToContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract ArifactsbyTimeToContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Arifacts by TimeTo";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/rhaS7FIYB1i68jgIIPaR/contract-metadata";
  }
