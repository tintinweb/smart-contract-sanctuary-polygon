...
// File contracts/polygon/MPToken.sol

// contracts/MPToken.sol
 ...
 * `ERC20` functions.
 */
contract MPToken is Context, ERC20, ERC20Detailed {

    /**
     * @dev Constructor that gives _msgSender() all of existing tokens.
     */
    string tokenName = "Matic Pro Token";
    string tokenTicker = "$MP";
