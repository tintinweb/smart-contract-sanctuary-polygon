...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x3C90B8E28F080E7C75D70dB776ec9950D5Fa5167];
  address public erc20Payable = 0x3C90B8E28F080E7C75D70dB776ec9950D5Fa5167;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmV24FQyjhNzUZUFoKjH8MifGBaHsZUN1aFm5T3UraxWFt/";
...
// File: contracts/MyMftTeamLogoContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MyMftTeamLogoContract is RamppERC721A {
    constructor() RamppERC721A("My MFT Team Logo", "MFT"){}
}
