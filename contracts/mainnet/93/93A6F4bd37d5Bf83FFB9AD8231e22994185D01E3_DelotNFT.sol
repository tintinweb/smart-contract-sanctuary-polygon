...
contract DelotNFT is ERC721, ContextMixin, NativeMetaTransaction, Ownable, IDelotNFT {
    ...
    constructor(string memory _name, string memory _symbol) ERC721(_name, _symbol) {        
        proxyRegistryAddress = 0x58807baD0B376efc12F5AD86aAc70E78ed67deaE; // Polygon's Mainnet  

        // nextTokenId is initialized to 1, since starting at 0 leads to higher gas cost for the first minter
        _nextTokenId.increment();
        _initializeEIP712(_name);
        
        baseURI = "ipfs://bafybeicwitgvp7tc3m5vcyyzgfvl4slq5h3sokut2leeig53zytl4d62yq/";
