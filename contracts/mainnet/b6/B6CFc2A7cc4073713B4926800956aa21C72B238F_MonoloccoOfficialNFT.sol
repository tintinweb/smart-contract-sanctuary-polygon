...
contract MonoloccoOfficialNFT is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_, address proxyRegistryAddress_)
    ERC721("Mono locco Official NFT", "Mono Locco")
  {
  ...
  uint256 public constant MAX_MULTIMINT = 6666;
  ...
  function mint(uint256 count) public nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 6666 at a time");
