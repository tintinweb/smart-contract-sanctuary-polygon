...
contract TestContract is Ownable, MathFunctions, Claimable {
    ...
    payable
  {
    ...
    emit InsufficientFee(ethToUsd(msg.value), price);
  ...
  function claimNativeTokens(address _to)
    external
    onlyOwner
  {
    _claimNativeCoins(_to);
  ...
  event InsufficientFee(uint256 given, uint256 price);
