...
contract Craft is ERC20, Ownable, ReentrancyGuard{    
    ...
    function mintTokens(address purchaser, uint256 amount) public onlyOwner {
        require(maxSupply >= totalSupply() + amount, "Insufficient supply");
        _mint(purchaser, amount);
        emit TokensMinted(purchaser, amount);
    }
