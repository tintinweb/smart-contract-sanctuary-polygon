...
contract GlobalTransactionPaymentSolution is ERC20, ERC20Burnable {
    constructor() ERC20("Global Transaction Payment Solution", "$GTPS") {
        _mint(msg.sender, 473176473 * 10 ** decimals());
    }
}