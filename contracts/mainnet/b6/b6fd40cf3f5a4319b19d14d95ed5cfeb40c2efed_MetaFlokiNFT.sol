...
contract MetaFlokiNFT is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("MetaFloki NFT", "MetaFloki") {
    setHiddenMetadataUri("ipfs://QmQvCNFx59NzDEncngpUAgge5BJepKjNvMaED8A22YCHih/hidden.json");
  }
