...
//*********************************************************************//
//
//  ____  _____  ____  ____    _     _  ____  _     ____  _      ____  _____
// / ___\/__ __\/  _ \/  __\  / \ |\/ \/  _ \/ \   /  _ \/ \  /|/   _\/  __/
// |    \  / \  | / \||  \/|  | | //| || / \|| |   | / \|| |\ |||  /  |  \  
// \___ |  | |  | \_/||  __/  | \// | || \_/|| |_/\| |-||| | \|||  \_ |  /_ 
// \____/  \_/  \____/\_/     \__/  \_/\____/\____/\_/ \|\_/  \|\____/\____\
//                                                                          
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x794Aa8AC451e0f03832c9635e157e67c9Cc6d2B6];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmPXwEGFYpYnS1tvEVxxct5VdxeSaMqNk6dzLEKRBS6qu6/";
...
// File: contracts/AaaaaaaContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AaaaaaaContract is RamppERC721A {
    constructor() RamppERC721A("aaaaaaa", "aaaaaa"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/A5KlCEbmL45OkTcZS057/contract-metadata";
    }
}
