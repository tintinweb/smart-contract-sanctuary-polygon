...
contract NFTMarket is ERC721, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    constructor() ERC721("Ordinal Bay", "OBAY") {}

    function createNFT(string calldata newTokenURI) public {
        _tokenIDs.increment();
        uint256 currentID = _tokenIDs.current();
        _safeMint(msg.sender, currentID);
        _setTokenURI(currentID, newTokenURI);
        emit NFTTransfer(currentID, address(0), msg.sender, newTokenURI, 0);
    }
...
// Verified: https://goerli.etherscan.io/address/0xA58654F7F836812F2D68af3E6c87AD7a608538E9#code

// With burn function: https://goerli.etherscan.io/address/0x0C92146f108be47E376B05b055Ce6839b789301C#code
