...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 EP = IERC20(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174); // ETH
...
contract DCTI is IERC20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174; // ETH
    address public WETH = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "DCTI";
    ...
    address public autoLiquidityReceiver=0xd4a636bdfEa9032Ae1C50CfcC6d5C7B155e88122; //liq address
    address public marketingFeeReceiver=0xd4a636bdfEa9032Ae1C50CfcC6d5C7B155e88122; // marketing address
    ...
    constructor () Auth(msg.sender) {
        address _router = 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff;
