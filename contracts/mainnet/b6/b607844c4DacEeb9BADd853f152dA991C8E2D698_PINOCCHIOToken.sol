...
contract PINOCCHIOToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public maxBuyTransactionAmount = 10**9 * (10**18);
    ...
    constructor() ERC20("PINOCCHIO Token ", "PINO") {
        ...
        uint256 totalSupply = 12000000000 * 1e18;
        ...
        sellBurnFee = _buyBurnFee;
        sellLiquidityFee = _buyLiquidityFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellBurnFee;
        
    	marketingWallet = address(0x282934492636f7CC5Db9F28A6C70bBDd8fe5484c); // set as marketing wallet
    ...
    function updateFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _burnFee) external onlyOwner {
