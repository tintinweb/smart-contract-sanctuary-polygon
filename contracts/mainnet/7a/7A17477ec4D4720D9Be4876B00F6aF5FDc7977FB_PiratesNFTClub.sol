...
contract PiratesNFTClub is ERC721, IERC2981, ReentrancyGuard, Ownable {
  ...
  uint256 public constant MAX_MULTIMINT = 7900;
  ...
  function mint(uint256 count) public payable nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 7900 at a time");
