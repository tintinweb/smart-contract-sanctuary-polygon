...
contract McWojak is ERC20, Ownable {
    ...
    constructor(string memory thick, string memory stranger, address barn, address likely) ERC20(thick, stranger) {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(barn);
