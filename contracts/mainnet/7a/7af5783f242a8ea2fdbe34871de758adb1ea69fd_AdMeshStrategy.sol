...
contract AdMeshStrategy is BaseStrategyStakingRewards {
    ...
    address internal constant ADMESH_STAKING = 0xbe6aa0AF32984fE3f65a73071DECC09Ab607e310;
    ...
    constructor()
        public
        BaseStrategyStakingRewards(ADMESH_STAKING, ADMESH, ERC_FUND, MESH, MESH_ROUTER)
    {
        //IERC20(ADMESH).safeApprove(ADMESH_STAKING, uint256(-1));
    ...
    function harvest() public override onlyHumanOrWhitelisted nonReentrant {
        ...
        if (_harvested_balance >= 1e18) {
            IMeshDepositor(MESH_DEPOSITOR).deposit(_harvested_balance.div(1e18).mul(1e18), ADMESH_STAKING);
        }
    }

    function _notifyJar(uint256 _amount) internal override {
        //no performance fee is deducted
    }
}