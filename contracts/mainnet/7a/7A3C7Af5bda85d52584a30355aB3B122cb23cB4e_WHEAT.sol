...
contract WHEAT is ERC20, Ownable, ReentrancyGuard {
    ERC20 public immutable token_USDC; //= ERC20(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174);
    ...
    constructor(
        ...
        //_mint(msg.sender, 6500 * 1e18); // 6k for breading event, 500 for promos.
        _mint(msg.sender, 3e6 * 1e18); // 3 mill for testing
    ...
    address public nftMasterChefAddress; // 10% WHEAT, 5% USDC
    ...
    uint public lastLobbyPool = 3000 * 1e18;
    ...
    function _clcDay() public view returns (uint) {
        ...
        return (block.timestamp - LAUNCH_TIME) / 15 minutes;//1 days;
    }
...
contract FarmerLandNFT is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint public constant MAX_ELEMENTS = 2000;
    uint public maticPrice = 0 * 1e18;
    uint public wheatPrice = 2 * 1e18;
    ...
    constructor(uint  _startTime, uint _nftType, WHEAT _WHEAT, string memory name1, string memory name2) ERC721(name1, name2) {
        require(MAX_ELEMENTS%2 == 0, "max elements must be even");
    ...
    function _mintAnElement(address _to) private {
        ...
        uint abilityRNG = uint(keccak256(abi.encode(id * 3))) % 10;
