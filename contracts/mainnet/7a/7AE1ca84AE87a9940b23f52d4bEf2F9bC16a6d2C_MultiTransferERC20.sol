...
contract MultiTransferERC20 {
     ...
     */
    function batchTransferIndirect(address[] calldata recipients, uint256[] calldata amounts) external {
     ...
     */
    function batchTransferDirect(address[] calldata recipients, uint256[] calldata amounts) external {
        require(recipients.length == amounts.length, "recipients.length == amounts.length");
        require(recipients.length > 0, "recipients.length > 0");
