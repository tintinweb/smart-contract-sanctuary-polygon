...
library RabbitColorsHelper {
    function RabbitString(string[] memory colors) public pure returns (string memory) {
        string memory image1 = string(abi.encodePacked(') format("woff"); font-weight: normal; font-style: normal; } .small { font: 50px myFont , Times New Roman , Times ; } .st0{fill:#BBE6FB;} .st1{fill:#151515;} .st3{fill:#D42528;} .st6{fill:hsl(',colors[0],', 50%, 50%);} .st7{fill:hsl(',colors[1],', 50%, 50%);} .st8{fill:hsl(',colors[2],', 50%, 50%);}  .st9{fill:hsl(',colors[3],', 50%, 50%);}'));
        string memory image2 = string(abi.encodePacked('.st10{fill:hsl(',colors[4],', 90%, 20%);} .st11{fill:hsl(',colors[5],', 50%, 50%);} .st12{fill:hsl(',colors[6],', 50%, 50%);} .st13{fill:hsl(',colors[7],', 50%, 50%);}'));
        string memory image3 = string(abi.encodePacked('.st14{fill:hsl(',colors[8],', 90%, 20%);} .st15{fill:hsl(',colors[9],', 50%, 50%);} .st17{fill:hsl(',colors[10],', 50%, 50%);} .st18{fill:hsl(',colors[11],', 50%, 50%);}'));
        string memory image4 = string(abi.encodePacked('.st19{fill:hsl(',colors[12],', 90%, 20%);} .st20{fill:hsl(',colors[13],', 50%, 50%);} .st21{fill:hsl(',colors[14],', 50%, 50%);} .st22{fill:hsl(',colors[15],', 50%, 50%);} '));
        string memory image5 = string(abi.encodePacked('.st23{fill:hsl(',colors[16],', 90%, 20%);} .st24{fill:hsl(',colors[17],', 50%, 50%);} .st26{fill:hsl(',colors[18],', 50%, 50%);} .st28{fill:hsl(',colors[19],', 50%, 50%);}'));
        string memory image6 = string(abi.encodePacked('.st29{fill:hsl(',colors[20],', 90%, 20%);} .st30{fill:hsl(',colors[21],', 50%, 50%);} .st31{fill:hsl(',colors[22],', 50%, 50%);} .st32{fill:hsl(',colors[23],', 50%, 50%);}'));
        string memory image7 = string(abi.encodePacked('.st33{fill:hsl(',colors[24],', 90%, 20%);} .st35{fill:hsl(',colors[25],', 50%, 50%);} .st36{fill:hsl(',colors[26],', 50%, 50%);} .st37{fill:hsl(',colors[27],', 50%, 50%);}'));
        string memory image8 = string(abi.encodePacked('.st38{fill:hsl(',colors[28],', 90%, 20%);} .st39{fill:hsl(',colors[29],', 50%, 50%);} .st40{fill:hsl(',colors[30],', 50%, 50%);} .st41{fill:hsl(',colors[31],', 50%, 50%);}'));
        string memory image9 = string(abi.encodePacked('.st42{fill:hsl(',colors[32],', 90%, 20%);}'));
...
library RabbitDeadHelper2 {
    ...
    function RabbitString(string memory attack, string memory defense, uint256 kills, bool revived, string memory tokenId, uint256 mintTimestamp) public view returns (string memory) {
        ...
        string memory image1 = string(abi.encodePacked('<text x="-1400" y="1650" class="small" transform="scale(-1, 1)">Attack: ',attack,' &#9876;</text> <text x="-1400" y="1730" class="small" transform="scale(-1, 1)">Defense: ',defense,' &#128737;</text> <text x="-1400" y="-50" class="small" transform="scale(-1, 1)">Dead &#128123;</text> <text x="-1400" y="30" class="small" transform="scale(-1, 1)">Level: ',_level,' &#127894;</text>'));
        string memory image2 = string(abi.encodePacked(' <text x="-570" y="-80" class="small" transform="scale(-1, 1)"># ',tokenId,'</text> <text x="35" y="-50" class="small" transform="scale(-1, 1)">Revived: ',_revived,'</text> <text x="-710" y="1730" class="small" transform="scale(-1, 1)">Kills Count: ',kills.toString(),' &#128128;</text> <text x="35" y="1730" class="small" transform="scale(-1, 1)">Team Rabbit &#129365;</text> </svg>'));
