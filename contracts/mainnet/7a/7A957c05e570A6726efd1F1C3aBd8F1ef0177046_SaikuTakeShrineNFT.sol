...
contract SaikuTakeShrineNFT is ERC721Mintable, ERC721Permit("Saiku Take Shrine NFT:Token") , Ownable, ERC721URIStorage{
    ...
    constructor() ERC721("Saiku Take Shrine NFT:Token", "SAIKU TAKE") {
        setDefaultURI("https://nft-studio.com/api/metadata/saikutake/");
    }
