...
//import 'https://github.com/Uniswap/v3-core/blob/0.8/contracts/UniswapV3Pool.sol';
...
//import 'https://github.com/Uniswap/v3-periphery/blob/0.8/contracts/base/LiquidityManagement.sol';
import "./abstracts/BaseContract.sol";
import "./libs/uniswap-periphery/contracts/interfaces/ISwapRouter.sol";
import "./libs/zeppelin/token/BEP20/IBEP20.sol";

contract TestUni is BaseContract, IERC721Receiver {
//  INonfungiblePositionManager public immutable nonfungiblePositionManager;
  ISwapRouter public constant swapRouter = ISwapRouter(0xE592427A0AEce92De3Edee1F18E0157C05861564);
  IBEP20 constant mockUsdt = IBEP20(0x9796B57676A40cc880507bCeda42E9a6349b48a4);
  IBEP20 constant mockUsdc = IBEP20(0x7edb5851b7C073F68073B56951263A8eE5FC28B0);
...
//  function initialize(INonfungiblePositionManager _nonfungiblePositionManager) public initializer {
//    BaseContract.init();
...
//  }
  ...
  function initialize() public initializer {
    BaseContract.init();
    mockUsdc.approve(address(swapRouter), type(uint).max);
    mockUsdt.approve(address(swapRouter), type(uint).max);
  }

  function testSwapUsdtToUsdc(uint amountIn) external {
    _takeFund(mockUsdt, amountIn, address(this));
    ISwapRouter.ExactInputSingleParams memory params =
      ISwapRouter.ExactInputSingleParams({
      tokenIn: address(mockUsdt),
