...
contract OPTFundSpin is Ownable, VRFConsumerBaseV2 {
    ...
    address constant OPT3 = 0xCf630283E8Ff2e30C29093bC8aa58CADD8613039;
    ...
    function auditInvestorAddStake(address _address, uint256 _amount) external onlyOwner {
      require(totalAmountAddedAudit + _amount <= 15000 * 10**18, "Added amount exceeds what investor paid.");
