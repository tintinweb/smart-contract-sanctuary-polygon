...
contract SiloFactoryUIHelper is Ownable{
    ...
    */
    ...
    /***************************************public view *************************************/
    function getManagerStats(address _user) public view returns(uint currentBalance, uint minimumBalance, uint riskAdjustedBalance, uint warningBalance,uint96 riskBuffer, uint96 rejoinBuffer,uint96 minRisk, uint96 minRejoin){
    ...
    */
    ...
    function getWithdrawLimitSiloInfo(uint siloId) external view returns(bool isLimit, uint amount,uint availableBlock){
        ISilo silo = ISilo(SiloFactory.siloMap(siloId));
