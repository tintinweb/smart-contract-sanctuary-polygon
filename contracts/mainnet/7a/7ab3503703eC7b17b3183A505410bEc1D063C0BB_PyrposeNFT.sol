...
contract PyrposeNFT is Initializable, ERC721Upgradeable, ERC721URIStorageUpgradeable, OwnableUpgradeable {
    using CountersUpgradeable for CountersUpgradeable.Counter;

    event Mint(uint256 tokenId);

    IERC20 public usdc;
    address public crossmintAddress; // Mumbai: 0xDa30ee0788276c093e686780C25f6C9431027234;
    ...
    function initialize(address _usdcAddress, address _crossmint, string memory _clientId, string memory _baseUri) initializer public {
        __ERC721_init("PyrposeNFT", "PYR");
    ...
    modifier isAvailable(uint256 _quantity) {
        require(_tokenIdCounter.current() + _quantity <= MAX_SUPPLY, "Not enough tokens left for quantity");
        _;
    }
    ...
    {
        usdc.transferFrom(msg.sender, address(this), (_price * 10 ** 6) * _quantity);
    ...
    function setCrossMintAddress(address newCrossMintAddress) public onlyOwner {
        crossmintAddress = newCrossMintAddress;
    }
