...
contract GUTOPToken is ERC721, Ownable {
    // The base uri
    string public constant BASE_URI = "ipfs://QmSzEfTZWnftayYmPjmw1mDPNVhfCGDvs5K6FY7qvuMDYQ/";
    // The base uri
    string public constant NFT_COLLECTION_URI = "https://ipfs.io/ipfs/QmegwibdEHD9q21dYeHYxKpKaekmvt2nQ4hWtKy45vU2aT";
    address public constant OWNER = 0xe7463F674837F3035a4fBE15Da5D50F5cAC982f4;
    // Name of the token
    string public constant TOKEN_NAME = "GUTOPToken";
    // Symbol of the token
    string public constant TOKEN_SYMBOL = "GUTOP";

    // Address of the issuer
    address internal aIssuer;
    // If the contract is fully initialized
