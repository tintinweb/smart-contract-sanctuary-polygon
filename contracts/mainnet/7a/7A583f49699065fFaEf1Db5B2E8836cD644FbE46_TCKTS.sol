...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata{
    ...
    string baseUri = "ipfs://QmNnThi5Y7fuj65muVxnjRrqbD6bhwjtpc6rCDukL9hAYX/"; 

    // metadata api before reveal
    string notRevealedUri = "ipfs://QmdLJMMhrqMheGgYfE7GWap1YhynkxMaBdn6AVgdjqrdqU/unknown"; 
...
contract TCKTS is ERC721, Ownable{
    uint256 public totalSupply = 0; 
    uint256 private constant totalSale = 2000; 
    ...
    constructor() ERC721("TCKTS", "TKT"){}
    
    
    function mintByUser(uint256 quantity) public payable checkPublicSaleIsActive{
        ...
        require(userMinted[msg.sender] + quantity <= 5, "You can mint only five NFTs");
        require(quantity > 0 && quantity <=3, "You can 3 NFTs per transaction");
