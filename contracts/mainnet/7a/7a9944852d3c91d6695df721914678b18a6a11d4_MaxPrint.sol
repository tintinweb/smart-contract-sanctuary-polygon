...
contract MaxPrint is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public cost = 0.96 ether;
  ...
  constructor() ERC721("MaxPrint", "MX") {
    setHiddenMetadataUri("ipfs://QmX1EmUrRDpiQYBJ7WWB6vYrTAUA2g7fFuQyM9FdVmZfPt/hidden.json");
  }
