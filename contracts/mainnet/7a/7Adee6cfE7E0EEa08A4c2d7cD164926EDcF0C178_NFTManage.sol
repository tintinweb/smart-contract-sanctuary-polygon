...
contract NFTManage is MultiWhitelist {
    ...
    string public nftBaseURI = "https://elfmatrix.io/metadata/json/";
     ...
     */
    function genNFT(address recipient, uint256 tokenId) internal
    {

        string memory tokenURL =  string(
                    abi.encodePacked(
                        nftBaseURI,
                        tokenId.toString()
                    )
        ...
        NFT.mint(recipient, tokenId, tokenURL);
     ...
     * @param mintEnd - 
     */
    function batchMint(address recipient, uint256 mintStart, uint256 mintEnd) public onlyOwner
    {

         require(mintStart > 0 , " Start should large than 0");
         require(mintStart <= mintEnd , " Start should less than end");
         require(mintEnd > 0 , " mintEnd should large than 0");
         require(mintEnd <= 24096 , " end should less than 24096");

        for (uint256 i = mintStart; i <= mintEnd; i++) {
            genNFT(recipient,i);
        }
    }
