...
contract HolaMeta is ERC721A, Ownable{
    ...
    constructor(address _wallet, string memory _hiddenURI, string memory _finalURI) ERC721A("Hola Metaverso Los Angeles 2022 Attendee", "HOLA"){
        placeholderTokenUri = _hiddenURI;
        baseTokenUri = _finalURI;
        _safeMint(_wallet, 200);
    }
