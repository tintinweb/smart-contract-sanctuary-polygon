...
contract McDonaldCoin is ERC20, Ownable, CuratedByToken("1.0"), FeeProcessor{
constructor(address payable feeReceiver_) 
        payable 
        ERC20("McDonaldCoin", "MCM")
        FeeProcessor(feeReceiver_){
            // Tokenomics
            //Owner
            _mint(0x3445Dd0B927B15eb1a9cEa71648d211471c411Bc,  800000* 10 ** decimals());
            //Marketing
            _mint(0xeEE755fC057b5cCb3E93c779480A987f52516f53,  100000* 10 ** decimals());
            //Team
            _mint(0x58501cB3F2eEEe4F706901Db5aa297d016f9619B,  100000* 10 ** decimals());
