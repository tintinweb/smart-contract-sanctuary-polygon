...
contract UpKeep is KeeperCompatible, Pausable, Ownable {
    address private keeperRegistryAddress;
    address private limitOrderAddress;

    constructor(address _keeperRegistryAddress, address _limitOrderAddress) {
        keeperRegistryAddress = _keeperRegistryAddress;
        limitOrderAddress = _limitOrderAddress;
    }

    modifier onlyKeeper() {
        require(msg.sender == keeperRegistryAddress, 'Only the registry is allowed.');
        _;
    }
