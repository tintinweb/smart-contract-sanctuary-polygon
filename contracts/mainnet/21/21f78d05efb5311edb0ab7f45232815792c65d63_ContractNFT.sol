...
contract ContractNFT is ERC721Enumerable, Ownable{
    ...
    // Delcaring variable
    uint public constant MAX_SUPPLY = 10; // total amount needs to change as per the requirement
    uint public PRICE = 5 ether; //price needs to reset as per the requirement

    string public baseTokenURI;
    
    constructor(string memory baseURI) ERC721("ABCTEST", "TESTABC"){  //Name and Symbol needs to change as per the requirement
        setBaseURI(baseURI);
    }
