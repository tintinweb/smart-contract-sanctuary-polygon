    ...
    CallbackValidation
{
    ...
    function exactInputSingle(ExactInputSingleParamsAlgebra memory params)
        external
        payable
        override
        contractWhitelisted(params.factory)
    ...
    /// @inheritdoc IAlgebraSwapRouter
    function exactInput(ExactInputParamsAlgebra memory params)
        external
        payable
        override
        contractWhitelisted(params.factory)
    ...
    /// @inheritdoc IAlgebraSwapRouter
    function exactInputSingleSupportingFeeOnTransferTokens(ExactInputSingleParamsAlgebra memory params)
        external
        override
        contractWhitelisted(params.factory)
        checkDeadline(params.deadline)
    ...
    /// @inheritdoc IAlgebraSwapRouter
    function exactOutputSingle(ExactOutputSingleParamsAlgebra memory params)
        external
        payable
        override
        contractWhitelisted(params.factory)
    ...
    /// @inheritdoc IAlgebraSwapRouter
    function exactOutput(ExactOutputParamsAlgebra memory params)
        external
        payable
        override
        contractWhitelisted(params.factory)
...
interface IAlgebraSwapRouter is IAlgebraSwapCallback {
    ...
    /// @return amountOut The amount of the received token
    function exactInputSingle(ExactInputSingleParamsAlgebra calldata params)
        external
        payable
        returns (uint256 amountOut);
    ...
    /// @return amountOut The amount of the received token
    function exactInput(ExactInputParamsAlgebra calldata params) external payable returns (uint256 amountOut);
    ...
    /// @return amountIn The amount of the input token
    function exactOutputSingle(ExactOutputSingleParamsAlgebra calldata params)
        external
        payable
        returns (uint256 amountIn);
    ...
    /// @return amountIn The amount of the input token
    function exactOutput(ExactOutputParamsAlgebra calldata params) external payable returns (uint256 amountIn);

    /// @notice Swaps `amountIn` of one token for as much as possible of another along the specified path
    /// @dev Unlike standard swaps, handles transferring from user before the actual swap.
    /// @param params The parameters necessary for the multi-hop swap, encoded as `ExactInputParamsAlgebra` in calldata
    /// @return amountOut The amount of the received token
    function exactInputSingleSupportingFeeOnTransferTokens(ExactInputSingleParamsAlgebra calldata params)
        external
        returns (uint256 amountOut);
}
