...
/// @title Zombie Country Club Contract
/// @author Elliott Williams, with some loving emotional support from Earn Alliance
/// @notice This contract mints Zombies but and lets you into the most exclusive country club on the wrong side of heaven
/// @dev Zombies are dangerous, make sure to sufficiently damage their noggins, little else works
/// @custom:security-contact [email protected]
contract ZombieCountryClub is
  Initializable,
  OwnableUpgradeable,
  PausableUpgradeable,
  ...
  EIP712Upgradeable
{
  ...
  /// @notice burn a zombie, can only be called by owner
