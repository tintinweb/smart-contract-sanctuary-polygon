    ...
    ERC721Pausable
{
    ...
    function getOwnedTokens(
        ...
        require(
            offset + count <= ownedTokens[user].length,
            string.concat(_name, ": user haven't enough tokens")
        );
    ...
    function mint(address to) public {
        require(
            ...
            string.concat(_name, ": must have minter role to mint")
        );
    ...
    function pause() public {
        require(
            ...
            string.concat(_name, ": must have pauser role to pause")
        );
        _pause();
    }
    ...
    function unpause() public {
        require(
            hasRole(PAUSER_ROLE, _msgSender()),
            string.concat(_name, ": must have pauser role to unpause")
        );
        _unpause();
    }
    ...
    function _beforeTokenTransfer(
        ...
        if (from != address(0)) {
            ...
            uint256[] memory temp_owned_tokens = new uint256[](
