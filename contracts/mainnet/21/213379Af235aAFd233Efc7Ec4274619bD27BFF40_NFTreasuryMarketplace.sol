...
interface INFTreasuryMarketplace is IThirdwebContract, IPlatformFee {
    ...
    **/
     ...
     */
    function createListing(ListingParameters memory _params, address tokenOwner) external;
    ...
    IERC1155ReceiverUpgradeable
{
    ...
    /// @dev the increase in listing price after every sale. default os 1_000 == 10%
    uint64 public LIST_PRICE_BPS_INCREASE;
    ...
    function executeSale(
        ...
        _targetListing.buyoutPricePerToken =
          _targetListing.buyoutPricePerToken + (_targetListing.buyoutPricePerToken * LIST_PRICE_BPS_INCREASE / MAX_BPS);
