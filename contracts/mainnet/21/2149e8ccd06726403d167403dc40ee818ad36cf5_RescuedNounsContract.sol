...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 1000, 999999 ) {}
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 999999");
        _safeMint(_to, 1);
    }
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 999999");
...
// File: contracts/rescuedNounsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract RescuedNounsContract is RamppERC721A {
    constructor() RamppERC721A("Rescued Nouns", "NOUNS"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/zmc8bnU7TqLR1pBmFUhP/contract-metadata";
    }
}