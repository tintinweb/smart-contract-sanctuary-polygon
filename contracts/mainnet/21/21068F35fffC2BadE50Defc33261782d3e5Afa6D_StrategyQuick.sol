...
// File contracts/BIFI/interfaces/quick/IRewardPool.sol
...
// File contracts/BIFI/strategies/Common/VoteManager.sol



pragma solidity ^0.6.12;
abstract contract VoteManager is StratManager {
    bytes32 public approvedHash;

    function approveHash(bytes32 _hash) external onlyManager {
        approvedHash = _hash;
    }
...
// File contracts/BIFI/strategies/QuickSwap/StrategyQuick.sol



pragma solidity ^0.6.0;
pragma solidity ^0.6.12;
contract StrategyQuick is StratManager, FeeManager, VoteManager {
    ...
    address public want = address(0x831753DD7087CaC61aB5644b308642cc1c33Dc13);
