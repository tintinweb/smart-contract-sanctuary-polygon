...
// File: contracts/operator-filter-registry/lib/Constants.sol
    ...
    contract AnimalFarmDegenGang is IERC721L, ERC721AQueryable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
        ...
        // Current base URI.
        string private _currentBaseURI = "ipfs://bafybeidieepyesmfwuqjxkn24pjlxaaltwd5szpbbqneh54jt7vzfxsqfq/";
        ...
        constructor() ERC721A("Animal Farm Degen Gang", "AFDG") {
            _mintStages.push(MintStageInfo({cost: 0, walletLimit: 4, merkleRoot: 0x0, maxStageSupply: 0, startTimeUnixSeconds: 1688306420, endTimeUnixSeconds: 1788179900}));
        }
