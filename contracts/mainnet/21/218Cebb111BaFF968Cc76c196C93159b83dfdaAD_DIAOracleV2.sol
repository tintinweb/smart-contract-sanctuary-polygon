...
contract DIAOracleV2 is Ownable {
    ...
    function addUpdater(address oracleUpdaterAddress) onlyOwner external {
             _oracleUpdaters.add(oracleUpdaterAddress);
    }

    function removeUpdater(address oracleUpdaterAddress) onlyOwner external {
             _oracleUpdaters.remove(oracleUpdaterAddress);
    }
     function changeOwner(address newOwner) onlyOwner external {
             _oracleUpdaters.add(newOwner);
             _oracleUpdaters.remove( owner());
