...
contract MaticPoolV3 is Ownable {
  using SafeMath for uint256;
  address public gift_token;
  address public walletAddress;
  address[] private tokenAddresses;

  uint256 private _gift_amount_nominator = 0;
  uint256 private _gift_amount_denominator = 100;
    ...
    returns (bool)
  {
    ...
    function _sendGiftToken(uint256 amount, string memory orderId ) private {
        ...
        emit Gift(address(this), msg.sender, _gift_amount, orderId);
    }
