...
contract StrategyBalancerAC is Initializable, StratManagerUpgradeableCommon, DynamicFeeManager {
    ...
    function setFeeOnProfits(uint256 feeOnProfits) external onlyManager {
        require(feeOnProfits <= 100, "Dynamic Fees can be set to maximum of 10% (100)");
        feeOnProfits = feeOnProfits;
    }
}
