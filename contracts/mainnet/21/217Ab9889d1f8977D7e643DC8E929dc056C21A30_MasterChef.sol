...
contract MasterChef is Ownable {
    ...
    struct PoolInfo {
        ...
        uint256 lastRewardTime;  // Last block time that AXOs distribution occurs.
    ...
    uint256 public constant maxAxoPerBlock = 3e18;
    uint256 public constant MaxAllocPoint = 12000;
    ...
    // Changes axo token reward per second, with a cap of maxaxo per second
    // Good practice to update pools without messing up the contract
    function setAxoPerBlock(uint256 _axoPerBlock) external onlyOwner {
        require(_axoPerBlock <= maxAxoPerBlock, "setAxoPerBlock: too many axos!");

        // This MUST be done or pool rewards will be calculated with new axo per second
...
contract AxoToken is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, OwnableUpgradeable, ERC20PermitUpgradeable, UUPSUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() initializer {}

    function initialize() initializer public {
        __ERC20_init("Axoswap", "AxO");
        __ERC20Burnable_init();
        __Pausable_init();
        __Ownable_init();
        __ERC20Permit_init("Axoswap");
