...
// ABull Woman Edition ERC721 

contract ABW999 is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  uint256 public currentSupply = 0;
  
  string public baseURI = "https://gateway.pinata.cloud/ipfs/QmcXS3Ar6AFrkzafBnBV1qpYu2bG92aCGCq5xdGgpLqF1M/";

  constructor() 
    ERC721("ABull Woman 999 Samba", "ABW999S")
    RandomlyAssigned(999,1) 
    {
       for (uint256 a = 1; a <= 555; a++) {
         mint(msg.sender);  //mint();  
        }
    }
