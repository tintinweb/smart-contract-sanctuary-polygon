...
import '@ascentexchange/v3-core/contracts/libraries/BitMath.sol';
import '@ascentexchange/v3-core/contracts/libraries/FullMath.sol';
...
library NFTDescriptor {
    ...
    function generateDescriptionPartOne(
        ...
        return
            string(
                abi.encodePacked(
                    'This NFT represents a liquidity position in a AscentExchange V3 ',
                    quoteTokenSymbol,
                    '-',
                    baseTokenSymbol,
                    ' pool. ',
...
/// @title NFTSVG
/// @notice Provides a function for generating an SVG associated with a AscentExchange NFT
library NFTSVG {
    using Strings for uint256;
    ...
    function generateSVG(SVGParams memory params) internal pure returns (string memory svg) {
        ...
        msg: "Forged in SVG for AscentExchange in 2021 by 0xe8ab59d3bcde16a29912de83a90eb39628cfc163",
