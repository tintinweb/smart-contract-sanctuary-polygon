...
contract Emergency is Pausable{
  ...
  constructor()  {
    ...
    one = 0x6E1DA38F9d9D87ce228234a570D992D4DB294fA1; // B
    two = 0x9Cf779014f5017c5473f5D8Cc1c46A80834dbD09;// Test D
    three = 0x55B50cCd840cF815E5C4d01C51a6Cb43b1395C0D ;//Test2 J
...
contract MyStream is Emergency, Ownable{
    ...
    mapping(address => uint256) public balancesOfHolders;
    ...
    function cancelStreamInternal(uint256 streamId) internal {
       ...
       // delete streams[streamId];
        ...
        IERC20 token = IERC20(stream.tokenAddress);
            ...
            balancesOfHolders[one] = balancesOfHolders[one] + fee60;
            balancesOfHolders[two] = balancesOfHolders[one] + fee25;
            balancesOfHolders[three] = balancesOfHolders[one] + fee15;
   ...
   function withdrawForHolders (address _tokenAddress, uint256 _amount) external{
