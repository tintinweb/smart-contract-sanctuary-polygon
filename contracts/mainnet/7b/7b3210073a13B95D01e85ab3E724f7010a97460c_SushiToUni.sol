...
contract SushiToUni is Ownable {
    ...
    IUniswapV2Router02 private sushiswapRouter = IUniswapV2Router02(SUSHISWAP_ROUTER_ADDRESS);    
    ...
    function executeOperation(
        ...
        uint24 poolFee = paramsDecoded.poolFee;

        console.log("Borrowed amount");
        console.log(borrowedAmount);
        console.log("Premium");
        console.log(premium);
        console.log("borrowedToken");
        console.log(borrowedToken);
        ...
        uint256 tokenAuxAmount = sushiSwap(
            borrowedToken,
            tokenAux,
            borrowedAmount
        );
        
        uint256 arbitragedAmount = uniSwap(
            tokenAux,
            borrowedToken,
            tokenAuxAmount,
            poolFee
        ...
        require(arbitragedAmount > borrowedAmount + premium, "There is no profit! Reverting!");
