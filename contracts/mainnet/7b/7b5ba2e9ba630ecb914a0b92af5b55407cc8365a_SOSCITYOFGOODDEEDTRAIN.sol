...
contract SOSCITYOFGOODDEEDTRAIN is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("SOS Children's Villages -CITY OF GOOD DEEDS- Trains", "SOSTTRAIN") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://www.sos-satelecopiilor.ro/city-of-good-deeds-collectibles410/Train/metadata/Train_";
    }
