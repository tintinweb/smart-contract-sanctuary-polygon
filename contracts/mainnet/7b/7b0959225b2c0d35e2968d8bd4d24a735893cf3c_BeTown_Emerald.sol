...
contract BeTown_Emerald is ERC721A, Ownable, DefaultOperatorFilterer {
    bool public paused = true;

    string public baseURI = "ipfs://bafybeidyzmedn2yxq3xyc5pocofreaxqwltd2xf6vlcctewluxctl23upe/";
    
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721A("BeTown Emerald", "BTE") {
    }
