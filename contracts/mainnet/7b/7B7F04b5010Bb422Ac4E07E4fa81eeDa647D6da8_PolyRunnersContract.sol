...
//
//     ____        __      ____                                  
//    / __ \____  / /_  __/ __ \__  ______  ____  ___  __________
//   / /_/ / __ \/ / / / / /_/ / / / / __ \/ __ \/ _ \/ ___/ ___/
//  / ____/ /_/ / / /_/ / _, _/ /_/ / / / / / / /  __/ /  (__  ) 
// /_/    \____/_/\__, /_/ |_|\__,_/_/ /_/_/ /_/\___/_/  /____/  
//               /____/                                          
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x400a12F360c49d916fd39a3607ff46B060BFcDd7];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmPFCDYHaW7krZL5LxTgTWNfeQAAUnNbBgA8CugmaUHWig/";
...
// File: contracts/PolyRunnersContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PolyRunnersContract is RamppERC721A {
    constructor() RamppERC721A("PolyRunners", "PR"){}
}
