...
contract MintXAndBorrowY {
    ...
    IUniswapV2Pair constant pair = IUniswapV2Pair(0xCD578F016888B57F1b1e3f887f392F0159E26747);
   ...
   address constant nativeToken = 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE;
    ...
    function exec(uint amount) public {
        ...
        uint amount1 = pair.token0() == tokenY ? amount : 0;
...
contract Arbitragor {
    ...
    function exec(uint amount) public{
        MintXAndBorrowY deployed = new MintXAndBorrowY(owner);
        list.push(address(deployed));
        deployed.exec(amount);
    }
