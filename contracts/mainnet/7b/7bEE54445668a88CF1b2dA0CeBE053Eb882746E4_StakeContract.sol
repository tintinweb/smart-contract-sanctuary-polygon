...
contract StakeContract is Owner, ReentrancyGuard, ERC1155Holder {
    ...
    constructor(address _rewardToken, address _nfts, address _referrals) {
        ...
        setStakeType(0, 1, 72, 2500*mulByDec, true); // recreacion y turismo 6%/month = 72%/year
        setStakeType(1, 2, 84, 12500*mulByDec, true); // transporte 7%/month = 84%/year
        setStakeType(2, 3, 108, 50000*mulByDec, true); // hoteleria 9%/month = 108%/year
    }
