...
contract SphereToolbox is OwnableUpgradeable {
    ...
    IERC20 public wMaticInstance;

    IUniswapV2Router02 public router;

    address public constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address public constant WMATIC = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270;
    address public constant BURNTOKEN = 0x17e9C5b37283ac5fBE527011CeC257b832f03eb3;
    address public constant ROUTER = 0xBCA055F25c3670fE0b1463e8d470585Fe15Ca819;
    ...
    function initialize() public initializer {
        ...
        tokenInstance = IERC20(BURNTOKEN);
        wMaticInstance = IERC20(WMATIC);
        router = IUniswapV2Router02(ROUTER);
        wMaticInstance.approve(ROUTER, type(uint256).max);
    }
    ...
    onlyOwner
    {
        ...
        uint256 amountToSwap = wMaticInstance.balanceOf(address(this));

        uint256 beforeBalance = IERC20(BURNTOKEN).balanceOf(DEAD);
        ...
        uint256 burntBalance = IERC20(BURNTOKEN).balanceOf(DEAD) - beforeBalance;
    ...
    {
        uint256 burnTokenAmount = tokenInstance.balanceOf(address(this));
        success = tokenInstance.transfer(DEAD, burnTokenAmount);
