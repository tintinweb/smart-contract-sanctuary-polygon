...
contract TriangleFlash is IUniswapV3FlashCallback, PeripheryPayments {
    ...
    function uniswapV3FlashCallback(
        ...
        TransferHelper.safeApprove(token0, address(swapRouter), decoded.amount1);
        uint256 amountOut0 =
    ...
    function flashArbitrage(FlashParams memory params) external {
