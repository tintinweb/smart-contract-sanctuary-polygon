...
contract STCOPUNKS is ERC721  {
    uint256 public totalSupply;
    uint256 public cost = 0.03 ether;
    uint256 public maxMints = 9998;
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeicck5qgxii6fizgy5fp5okbkpbtjxz7kbafrrnoyssqxzpjsukinq/", Strings.toString(tokenId), ".json")
            );
    }
