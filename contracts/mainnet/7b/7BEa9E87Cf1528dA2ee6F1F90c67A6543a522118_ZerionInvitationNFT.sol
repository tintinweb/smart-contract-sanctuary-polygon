...
interface IZerionInvitationNFT is IAccessControlEnumerable, IERC1155MetadataURI {
    /**
...
import { IZerionInvitationNFT } from "./IZerionInvitationNFT.sol";

contract ZerionInvitationNFT is AccessControlEnumerable, ERC1155Burnable, ERC1155Supply, IZerionInvitationNFT {
    /// @inheritdoc IZerionInvitationNFT
    ...
    constructor() ERC1155("") {
        name = "Zerion Extension Invitation Pass";
        symbol = "IVTZER";
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        returns (bool)
    {
        if (interfaceId == INTERFACE_ID_CONTRACT_URI) return true;
    ...
    function _beforeTokenTransfer(
        ...
        return ERC1155Supply._beforeTokenTransfer(operator, from, to, ids, amounts, data);
    }
}