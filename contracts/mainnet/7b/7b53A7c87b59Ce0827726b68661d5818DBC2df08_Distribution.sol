...
contract Distribution {
  ...
  address public OMHToken = 0x6c4544017B681CCFa5255143610385FEd3A0a445;
  ...
  uint256 public constant totalSupply = 17 * 10**9 * 10**18;  // 17 billion
  ...
  function getWithdrawalAmount(address _holder) public view returns (uint256, uint256) {
    ...
    uint256 withdrawalAmount = totalSupply * _info.percent * num / 1_000_000;
