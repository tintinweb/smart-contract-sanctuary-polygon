...
contract CloneApes is ERC721, Ownable {
    ...
    uint256 public constant MAX_MINT_PER_TX_PRESALE = 5;
    ...
    constructor() ERC721("Clone Ape", "CAPE") {
        _tokenIds.increment();
    }

    modifier isMintable() {
        require(mintable, "Clone Ape: NFT cannot be minted yet.");
        _;
    }

    modifier isPreSaleMintable() {
        require(preSaleMintable, "Clone Ape: NFT cannot be minted yet.");
        _;
    }
    ...
    modifier isNotExceedMaxMintPerTx(uint256 amount) {
        require(
            ...
            "Clone Ape: Mint amount exceeds max limit per tx."
        );
        _;
    }
    ...
    modifier isNotExceedAvailableSupply(uint256 amount) {
        require(
            ...
            "Clone Ape: There are no more remaining NFT's to mint."
        );
        _;
    }
    ...
    modifier isPaymentSufficient(uint256 amount) {
        require(
            ...
            "Clone Ape: There was not enough/extra ETH transferred to mint an NFT."
        );
        _;
    }

    modifier isPreSalePaymentSufficient(uint256 amount) {
        require(
    ...
    modifier isAllowList() {
        require(
            ...
            "Clone Ape: You're not on the list for the presale."
        );
        _;
    }
    ...
    function preSaleMint(uint256 amount)
        ...
        isPreSalePaymentSufficient(amount)
    {
