...
/**
 * @title MATICPlus VaultInitializer Contract
...
contract VaultInitializer is VaultStorage {
    function initialize(address _priceProvider, address _maticPlus) external onlyGovernor initializer {
        require(_priceProvider != address(0), "PriceProvider address is zero");
        require(_maticPlus != address(0), "maticPlus address is zero");

        maticPlus = MATICPlus(_maticPlus);
        ...
        vaultBuffer = 0;
        // Initial allocate threshold of 25,000 MATICPlus
...
contract VaultAdmin is VaultStorage {
    ...
    *************************************/
    ...
    function sortWeightsByTarget(StrategyWithWeight[] memory weights) internal pure returns (StrategyWithWeight[] memory) {
        ...
        Sort.quickSort(targets, 0, int256(targets.length - 1), indices);
