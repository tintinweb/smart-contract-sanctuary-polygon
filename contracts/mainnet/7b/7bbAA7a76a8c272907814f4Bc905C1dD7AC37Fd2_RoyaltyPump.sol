...
contract RoyaltyPump is TokensRecoverable
{
    ...
    constructor(address _devAddress, IPancakeRouter02 _router, address _signedLiquidityController, address _stakingContract, address _artistToken)
    {
    ...
    function depositRoyalties() public payable onlyRoyaltyCollector() 
    {
        ...
        chainToken.depositTokens(msg.value);
    ...
    //rates out of 10,000
    function testDepositRoyalties() public payable onlyRoyaltyCollector() 
    {
        require (msg.value > 0, "Must deposit some amount");
        totalRoyaltiesCollected = totalRoyaltiesCollected + msg.value;
        uint256 stakingRate = 5000;
...
//todo make below private
    function buyArtistToken(uint256 amountToSpend) internal returns (uint256)
    {
    ...
    function addLiq(uint256 chainTokenAmount) internal 
    {
    ...
    function buyPath() public view returns (address[] memory) 
    {
