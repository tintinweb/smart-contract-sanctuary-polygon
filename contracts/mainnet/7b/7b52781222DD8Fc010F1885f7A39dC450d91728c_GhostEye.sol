...
contract GhostEye is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeidojz4hahmfrxwvg3rvbw47k75gmo76at5endou23bxdocjz5io2e/", Strings.toString(tokenId), ".json")
            );
    }
