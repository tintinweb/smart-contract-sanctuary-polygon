...
contract MADDROIDSEDITION1 is ERC721Enumerable, Ownable, ERC721Pausable, ERC721Burnable {
    ...
    // 25%
    address private madWallet = 0xF59EFc866Bb76EF4A9a5D509E0676DFB57726024;
    ...
    function updateMadWallet(address _address, bool principal) public onlyOwner {
     ...
     function updateBaseURI(string memory _baseURI_) public onlyOwner {
        baseURI = _baseURI_;
    }
    ...
    function withdrawAll() public onlyOwner {
        ...
        // 75%
        _widthdraw(devWallet, ((balance * 90) / 100));
    }
    ...
    function mintTokenApp(address _to, uint256 _count) public onlyOwner {
        for (uint256 i = 0; i < _count; i++) {
            _mintToken(_to);
        }
    }
