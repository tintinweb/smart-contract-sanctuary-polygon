...
contract PresentToken is ERC20, Ownable, AccessControl {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    string private _name = "NFTPresents Token";
    string private _symbol = "PRESENT";
    uint8 private _decimals = 18;

    uint256 private immutable _cap = 21 * (10 ** 6) * (10 ** _decimals);
    uint256 private _initialSupply = 1 * (10 ** 6) * (10 ** _decimals);
    ...
    * failsafe function to emergency recover ERC tokens
    ...
    function withdrawErc20(address tokenAddress) external payable onlyOwner() {
        ...
        bool success = token.transfer(_msgSender(), balance);
        require(success, "Transfer failed.");
    }
}