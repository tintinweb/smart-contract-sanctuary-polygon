...
contract Orders is Ownable, IOrders {
    ...
    uint256 private printingPrice = 93_900_000;
    ...
    constructor(
        ...
        shippingFee[0] = 6_000_000;
        shippingFee[1] = 37_000_000;
        shippingFee[2] = 38_000_000;
        shippingFee[3] = 34_000_000;
        shippingFee[4] = 48_000_000;
        shippingFee[5] = 35_000_000;
        shippingFee[6] = 81_000_000;
    }
    
    function createOrder(bytes32 _hash, address _recipient, address _collection, uint256 _nftId, uint256 _timestamp, address _token, uint256 _amount, uint _destination) public payable {
