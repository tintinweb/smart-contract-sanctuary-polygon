...
abstract contract Auth {
    ...
    function canCall(address user, bytes4 functionSig) public view virtual returns (bool);
}
...
contract RolesAuthority is Auth {
    ...
    function canCall(address user, bytes4 functionSig) public view virtual override returns (bool) {
...
contract WGMC is ERC20Permit, ERC20Burnable, RolesAuthority {
    string private constant NAME = "Wagmi Competition";
    string private constant SYMBOL = "WGMC";

    uint256 private constant INITIAL_SUPPLY = 5_000_000_000 ether;

    constructor() ERC20Permit(NAME) ERC20(NAME, SYMBOL) RolesAuthority(msg.sender) {
