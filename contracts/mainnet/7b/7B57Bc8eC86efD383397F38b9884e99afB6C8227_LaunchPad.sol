...
contract LaunchPad is Operator, ILaunchPad {
    ...
    function updateInvestorInfo(address investor) internal {
        ...
        investorInfo.rTokenToBeSpent = priceNumerator.div(priceDenominator).mul(investorInfo.sTokenAllocation).div(10 ** missing_decimal);
