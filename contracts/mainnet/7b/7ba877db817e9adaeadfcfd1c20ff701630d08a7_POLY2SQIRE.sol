...
contract POLY2SQIRE is owned {
    ...
    constructor(address payable ownerAddress, address payable ID1address, address _magicPoolAddress) public {
        ...
        PriceOf10x[1] = 5 * 1e18;
        PriceOf10x[2] = 10 * 1e18;
        PriceOf10x[3] = 20 * 1e18;
        PriceOf10x[4] = 30 * 1e18;
        PriceOf10x[5] = 50 * 1e18;
        PriceOf10x[6] = 100 * 1e18;
        PriceOf10x[7] = 250 * 1e18;
        PriceOf10x[8] = 500 * 1e18;
        ...
        for(uint128 i = 0; i < 8; i++) {
            ...
            uint128 fct = (PriceOf10x[i+1] * 70)/100;
...
*/
    ...
    function processRefPay(address _user, uint128 _level) internal returns(bool)
    {
         ...
         uint prc = (PriceOf10x[_level]*30)/100;
