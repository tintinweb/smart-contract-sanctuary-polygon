...
contract VlinnRental is ReentrancyGuard, Ownable {
    ...
    constructor(address _feeRecipient, IVlinnNFTFactory _vlinnNFTFactory) {
    ...
    function listNFT(
        ...
        require(isRentableNFT(nftContract), "Contract is not Rentable");
        ...
        payable(feeRecipient).transfer(_listingFee);
