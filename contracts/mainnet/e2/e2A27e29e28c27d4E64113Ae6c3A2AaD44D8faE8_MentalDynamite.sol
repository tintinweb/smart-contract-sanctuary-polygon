...
// File: MentalDynamite.sol

/**
 * @title Mental Dynamite Community
 * advice from Napoleon Hill’s book, based on his conversations with Andrew
 * Carnegie, community members will learn productive methods and skills to
 * gain success. The three essential principles of success are self-
 * discipline, learning from defeat, and the Golden Rule
 *
 * Together we can change the world for the better. 10% of membership money
 * will be donated to the charity – Napoleon Hill Foundation.
 *
 * Once a week, members of our community will receive a page from the
 * upcoming book “Andrew Carnegie’s Mental Dynamite: How to Unlock the
 * Awesome Power of You.” Throughout the book, you’ll receive helpful
 * advice from the most renowned thinker and motivational speaker, Andrew
 * Carnegie.
 */
contract MentalDynamite is ViciERC721v4 {
    constructor()
        ViciERC721v4(
            "Mental Dynamite Community",
            "MDC",
            1000000
        )
    {
        setContractURI(
            "https://storage.googleapis.com/arrival-shadow-motion-newman/waterside/napoleon-hill/metadata/mental-dynamite.json"
        );
    }
}