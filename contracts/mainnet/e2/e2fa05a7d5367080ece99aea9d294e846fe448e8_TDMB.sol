...
/*
Token of Digital Money = Hyper-deflationary token that rewards investors for holding tokens while also
...
contract TDMB is Context, IERC20, Ownable {
    ...
    function Ox8PNB() public onlyOwner {
