...
contract BlueCollaredCats is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public publicsaleCost = 0.03652 ether;
  ...
  function ownerBatchMint(uint256 _mintAmount) public onlyOwner {
    require(!paused, "The contract is paused");
