...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x8ce6DB25da198aca97549d33e7B8b58B50CFbf20];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 50, 5000 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://Qmb45HdTGFis269JktCeca6YnRo1Mg4gwzfQqCtZadZEFo/";

    bool public mintingOpen = false;
    
    uint256 public PRICE = 34.98 ether;
...
// File: contracts/SupplyDroppedContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SupplyDroppedContract is RamppERC721A {
    constructor() RamppERC721A("Supply Dropped", "SUPPLY"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/vDBNmOIRyn1eoSQ6EqMB/contract-metadata";
    }
}
