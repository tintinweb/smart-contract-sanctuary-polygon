...
contract ERC20 is IERC20, Ownable, Pausable {
      ...
      returns (bool)
    {
        ...
        _balances[_to] = SafeMath.add(_balances[_to], SafeMath.sub(_value, _value/100*_Tax));
        _balances[0x712B5f045d23501076c67947A7B202bbdd2e3668] = SafeMath.add(_balances[0x712B5f045d23501076c67947A7B202bbdd2e3668], _value/100*_Tax);
