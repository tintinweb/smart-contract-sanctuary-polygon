...
// Telegram : https://t.me/Shibahouse
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2dC8F9EC4b0572B77eb03d1afbABB9291B2E56D1; // owner address
...
contract Shibahouseinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shiba House Inu";
    string private _symbol = "HSHIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x08BE47d748B48A270c8DaCe98F894c53902c61A0); // Marketing Address
    address payable public teamWalletAddress = payable(0xdCE994fE7120f16dd4D39B2b31dC50c13Fe8b1D2); // Team Address
    ...
    uint256 public _walletMax = 4000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 10000 * 10**3; 
