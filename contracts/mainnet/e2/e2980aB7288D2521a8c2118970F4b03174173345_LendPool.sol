  ...
  LendPoolStorageExt
{
  ...
  function getOracle() public view returns(address){
    return _addressesProvider.getNFTOracle();
  }
  ...
  function _borrow(
...

   {
    ...
    uint256 nftPrice = GenericLogic.calculateNftPrice(
      vars.nftOracle,
      nftAsset,
      nftTokenId  // new added
    ); 
  ...
  function getNftCollateralData(address nftAsset, address reserveAsset)
    ...
    {
      return getNftCollateralDataInternal(nftAsset , reserveAsset , 0);
    }


  // function getNftCollateralData(address nftAsset, address reserveAsset , uint256 nftTokenId)
  //   external
  //   view
  //   returns (
  //     uint256 totalCollateralInETH,
  ...
  //   )
  //   {
  //     return getNftCollateralDataInternal(nftAsset , reserveAsset , nftTokenId);
  //   }
   ...
   **/
  function getNftCollateralDataInternal(address nftAsset, address reserveAsset , uint256 nftTokenId)
    internal
    view
    returns (
      uint256 totalCollateralInETH,
...
interface INFTOracleGetter {
  ...
  // new added
  function getAssetPriceWithTokenId(address asset , uint256 tokenId) external view returns (uint256);
}
...
interface ILendPoolAddressesProvider {
  ...
  event ERC1155GATEWAYProviderUpdated(address indexed newAddress);  // new added
  ...
  // new added
  function getERC1155GATEWAY() external view returns (address);

  // new added
  function setERC1155Gateway(address provider) external;
...
library GenericLogic {
  ...
  function calculateNftPrice(
    ...
    return INFTOracleGetter(nftOracle).getAssetPriceWithTokenId(nftAddress , nftTokenId);
  }
  ...
  function calculateNftCollateralData(
    ...
    vars.totalCollateralInETH = nftPrice;
    ...
    )
  {
    ...
    vars.nftPriceInETH = INFTOracleGetter(nftOracle).getAssetPriceWithTokenId(nftAsset , nftTokenId);
