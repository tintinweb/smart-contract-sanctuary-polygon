...
contract CrazyBabyMonsters is ERC721 {
    ...
    constructor()
        ERC721("Crazy Baby Monsters", "CBM")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeidnnji3du7lwxa3bm4udtfe5b7cu4wp5xf4me3tokeeosqprui6xu/", Strings.toString(tokenId), ".json")
            );
    }
