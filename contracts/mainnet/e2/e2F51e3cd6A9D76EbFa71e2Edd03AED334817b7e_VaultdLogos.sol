...
///            \ \/ / _` | | | | | __/ _` |    | |    / _ \ / _` |/ _ \/ __|            ///
///             \  / (_| | |_| | | || (_| |    | |___| (_) | (_| | (_) \__ \            ///
///              \/ \__,_|\__,_|_|\__\__,_|    |______\___/ \__, |\___/|___/            ///
///                                                          __/ |                      ///
///                                                         |___/                       ///
///                                                                                     ///
///////////////////////////////////////////////////////////////////////////////////////////
    ...
    DefaultOperatorFilterer
{
    ...
    uint256 public MAX_ELEMENTS = 18000;
    ...
    constructor() ERC721A("Vaultd Logos Collection", "VaultdLogo") {
    }

    function setBaseURI(string[] memory _baseURIs) public onlyOwner {
        ...
        returns (string memory)
    {
        ...
        return
            baseTokenURIs.length > 0
                ? baseTokenURIs[tokenId % baseTokenURIs.length]
                : "";
    }
    ...
    function claimNFT() external {
        ...
        require(total < MAX_ELEMENTS, "VaultdLogos: Max limit");
        ...
        onlyOwner
    {
        ...
        require(total + totalQuantity <= MAX_ELEMENTS, "VaultdLogos: Max limit");
