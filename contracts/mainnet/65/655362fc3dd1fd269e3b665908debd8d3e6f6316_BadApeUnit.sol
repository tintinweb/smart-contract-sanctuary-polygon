 ...
 */
contract ERC721r is  Context, ERC165, IERC721,IERC721Metadata , Ownable {
    ...
    // Maximum Supply of tokens in the colletion
    ...
    // set Base Extension for tokenURI
     ...
     */
    function totalSupplyEnumerable() public view virtual returns (uint256) {
    ...
    function tokenByIndex(uint256 index) public view virtual returns (uint256) {
        require(index < totalSupplyEnumerable(), "ERC721Enumerable: global index out of bounds");
    ...
    // Get list of TokenId by owner address
...
// File: PublicSalesActivation.sol
...
contract BadApeUnit is
    Ownable,
    PublicSalesActivation,
    ERC721r,
    Withdrawable
{
    uint256 public constant TOTAL_MAX_QTY = 10001;
    uint256 public constant GIFT_MAX_QTY = 101;
    uint256 public constant FREE_MINT_MAX_QTY = 458;
    uint256 public constant SALES_MAX_QTY = TOTAL_MAX_QTY - GIFT_MAX_QTY - FREE_MINT_MAX_QTY;
    uint256 public constant MAX_QTY_PER_MINTER = 7;
    uint256 public constant MAX_FREE_QTY_PER_MINTER = 1;
    uint256 public constant PUBLIC_SALES_PRICE = 21;
        
    mapping(address => uint256) public publicSalesMinterToTokenQty;
    mapping(address => uint256) public freeSalesMinterToTokenQty;

    uint256 public publicSalesMintedQty = 0;
    uint256 public freeSalesMintedQty = 0;
    uint256 public giftedQty = 0;

    bool public isSalesPaused = true; 
    bool public isFreeMintPaused = true; 

    constructor() ERC721r("Bad Ape Unit", "BAU" , TOTAL_MAX_QTY)   {}

    
    function setSalesState(bool _state) external onlyOwner {
        isSalesPaused = !_state;
    }

    function setFreeMintState(bool _state) external onlyOwner {
        isFreeMintPaused = !_state;
    }
        ...
        isPublicSalesActive
    {
        ...
        require(msg.value >= _mintQty * PUBLIC_SALES_PRICE, "Insufficient funds");
...
function freeMint()
         ...
         
    {
        require(
         ...
         require(
            freeSalesMintedQty + 1 <= FREE_MINT_MAX_QTY,
            "Exceed free mint max limit"
        );
        require(
            freeSalesMinterToTokenQty[msg.sender] + 1 <=
                MAX_FREE_QTY_PER_MINTER,
            "Exceed max mint per minter"
        );
