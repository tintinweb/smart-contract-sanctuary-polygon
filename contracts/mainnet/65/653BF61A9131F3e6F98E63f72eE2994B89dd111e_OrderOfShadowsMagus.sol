...
contract OrderOfShadowsMagus is AMPowerPassCore{
  string public name = "Order of Shadows: Magus Power-Pass";
  string public symbol = "AM: OOS:M";
  ...
  constructor()
    ...
    setToken( 0,
      "Order of Shadows: Magus Power-Pass",
      "https://herodev.mypinata.cloud/ipfs/QmctGRRtUnyh9ogZgCjgw4mG2v58RSuJJMFqNzw4jfB7Y1/oos-magus.json",
      false, 0,
      false, 0,
      2000 );
  }
