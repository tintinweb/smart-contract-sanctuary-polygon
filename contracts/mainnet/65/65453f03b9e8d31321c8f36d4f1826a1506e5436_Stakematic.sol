...
contract Stakematic {
	...
	uint256 constant public PROJECT_FEE = 10; // Marketing 
	uint256 constant public PROJECT_FEE1 = 10; //  Dev Fee
	uint256 constant public PROJECT_FEE2 = 10; // Marketing & Dev Fee
	...
	function invest(address referrer, uint8 plan) public payable {
		...
		msg.value.mul(PROJECT_FEE1).div(PERCENTS_DIVIDER);
		msg.value.mul(PROJECT_FEE2).div(PERCENTS_DIVIDER);
