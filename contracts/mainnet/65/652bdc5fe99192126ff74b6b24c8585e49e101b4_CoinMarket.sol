...
contract CoinMarket is Pausable{
    ...
    function presentOrders() external view returns(uint256[] memory, uint256[] memory, uint256[] memory, uint256[] memory, uint256[] memory, address[] memory, bool[] memory){
    ...
    function setSell(uint256 coinType, uint256 amount, uint256 unit, uint256 price) external whenNotPaused {
    ...
    function setBuy(uint256 coinType, uint256 amount, uint256 unit, uint256 price) external payable whenNotPaused {
        require(amount>unit && unit>0 && amount%unit==0,WRONG_PARAMETER);
