...
contract WeedPunksBanner is ERC721A, Ownable, ReentrancyGuard, Pausable  {
    using Strings for uint256;
    string public baseUri = "";
    uint256 public supply = 2500;
    string public extension = ".json";  
    bool public freeclaimLive;
    bool public greenlistLive;
    address public WeedPunksAddr;
    ...
    constructor() ERC721A("WeedPunksBanner", "WPB") { 
        _pause();
      
        config.freeClaimPrice = 0.000 ether; 
        config.glPrice = 0.00 ether;
        config.maxgreenlist = 1;
        config.maxfreeClaim = 10;
        config.maxfreeClaimPerTx = 1;
        config.maxgreenlistPerTx = 1;
