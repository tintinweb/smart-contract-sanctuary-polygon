...
// File: contracts/BIFI/strategies/BIFI/StrategyBifiMaxiV5.sol

pragma solidity ^0.8.0;
contract StrategyBifiMaxiV5 is StratFeeManager {
    ...
    function chargeFees(address callFeeRecipient) internal {
        ...
        uint256 callFeeAmount = IERC20(output).balanceOf(address(this)) * fees.call / DIVISOR;
    ...
    function callReward() external view returns (uint256) {
        ...
        return outputBal * fees.call / DIVISOR;
    }
