...
// File: contracts/PolygonLowGasStagedMintLive.sol
...
contract PolygonLowGasStagedMintLive is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Polygon Low Gas Staged Mint Live", "PLGSML") {
...
//================================================================================================
// THIS ALLOWS US TO INCREASE THE CURRENT MAX SUPPLY (THE MAX ITEMS THAT CAN BE MINTED RIGHT NOW)
