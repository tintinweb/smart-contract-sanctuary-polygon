...
contract OpxOracleSale is ReentrancyGuard, OwnableUpgradeable {
    ...
    mapping(address => uint256) public tokenRaisingWei;
    ...
    function buyFromOtherChain(uint256 chainId, address _user, uint256 _amount, bytes32 _txHash) public nonReentrant onlyAdmin {
    ...
    function buy(address _token, uint256 _amount) public onlyActive nonReentrant notContract {
        ...
        require(_amount * latestPrice / decimals[_token] > minBuyWei, "must > min");
        ...
        tokenRaisingWei[_token] += _amount;
        tokenRaisingValue[_token] += _amount * latestPrice / decimals[_token];
