...
contract Timelock is Permissions {
  ...
  function queueTransaction(
    ...
    external
    onlyRoleMalt(GOVERNOR_ROLE, "Timelock::queueTransaction: Call must come from governor.")
    returns (bytes32)
  {
    require(
  ...
  function cancelTransaction(
    ...
    external
    onlyRoleMalt(GOVERNOR_ROLE, "Timelock::cancelTransaction: Call must come from governor.")
  {
    bytes32 txHash = keccak256(
      abi.encode(target, value, signature, data, eta)
    );
  ...
  function executeTransaction(
    ...
    external
    payable
    onlyRoleMalt(GOVERNOR_ROLE, "Timelock::executeTransaction: Call must come from governor.")
