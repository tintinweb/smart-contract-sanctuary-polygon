...
contract MauinaDeSonrisas is ERC721, ERC721Enumerable, ERC721Burnable, ERC721Royalty, Ownable {
    ...
    constructor(address trustedForwarder) ERC721("MaquinaDeSonrisas", "MDS_E1") {
        _tokenIds.increment();
