...
/**
 * @title NetU21NFTs - previous ERC721Suika
 * ERC-721 Marketplace with tokens and royalties support
 */

contract NetU21NFTs is ERC721Mochi, ReentrancyGuard {
    ...
    function canWithdraw(uint256 tokenId) external nonReentrant returns (bool) {
