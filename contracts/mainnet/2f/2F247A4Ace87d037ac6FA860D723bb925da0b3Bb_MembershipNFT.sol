...
contract MembershipNFT is ERC721URIStorage, Ownable, ConsensusAdminable {
  ...
  function updateNFT(
    ...
    string memory finalTokenUri = getTokenURI(_imageURI, _companyName);
  ...
  function getTokenURI(
    ...
    string memory _name = "ANRI 10th Anniversary NFT";
    string memory _description = "ANRI 10th Anniversary NFT is a commemorative token to celebrate ANRI\'s decade-long history. Not only are we celebrating our 10th birthday, but we are also celebrating the upcoming adventures awaiting us for many more years to come. This NFT is distributed to qualified individuals - primarily the founders of ANRI\'s portfolio companies.";

    bytes memory _attributes = abi.encodePacked(
      '"attributes": [{"trait_type": "Company name", "value": "',
      _companyName,
      '"}]'
    );
...
contract ConsensusAdminable is AccessControl {
  ...
  uint256 public constant PERCENTAGE_OF_CONSENSUS = 3;
  ...
  uint256 private _numberOfAdmins;
