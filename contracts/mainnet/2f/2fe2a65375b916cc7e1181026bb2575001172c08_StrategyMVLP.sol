...
// File: contracts/contracts/interfaces/gmx/IGMXStrategy.sol
...
// File: contracts/contracts/interfaces/gmx/IGravityVault.sol
...
// File: contracts/contracts/interfaces/gmx/IGLPManager.sol
...
// File: contracts/contracts/interfaces/gmx/IGMXTracker.sol
...
// File: contracts/contracts/interfaces/mvx/IMVXRouter.sol
    ...
    PausableUpgradeable
{
    ...
    uint256 constant WITHDRAWAL_FEE_CAP = 500; // Withdrawal fee cap is up to 5%
...
// File: contracts/contracts/StrategyMVLP.sol
...
contract StrategyMVLP is StratFeeManagerInitializable, UUPSUpgradeable {
    ...
    function chargeWithdrawalFees(uint256 _feeAmount) internal {
        uint256 managerFee = (_feeAmount * harvestFees.managerFee) /
            FULL_PERCENT;
        uint256 partnerFee = (_feeAmount * harvestFees.partnerFee) /
            FULL_PERCENT;
