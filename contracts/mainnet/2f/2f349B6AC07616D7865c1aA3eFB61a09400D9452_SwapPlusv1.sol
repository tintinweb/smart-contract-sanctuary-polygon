...
import "./interfaces/IQuickSwapRouterv3.sol";
...
contract SwapPlusv1 is Ownable {
  ...
  constructor(
    ...
    routers["QuickswapV3"] = 0xf5b509bB0909a69B1c207E495f687a596C168E12;
    routers["QuickswapV2"] = 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff;
    routers["Sushiswap"] = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506;
    routers["Jetswap"] = 0x5C6EC38fb0e2609672BDf628B1fD605A523E5923;
  ...
  function _swap(swapLine memory line, uint256 amount) internal returns(uint256) {
    ...
    for (uint256 x=0; x<swLen; x++) {
      ...
      if (_compareStrings(line.swaps[x].platform, "UniswapV3")) {
      ...
      else if (_compareStrings(line.swaps[x].platform, "QuickswapV3")) {
        IQuickSwapRouterv3.ExactInputSingleParams memory pm = IQuickSwapRouterv3.ExactInputSingleParams({
          tokenIn: line.swaps[x].tokenIn,
          tokenOut: line.swaps[x].tokenOut,
          recipient: address(this),
        ...
        outAmount = IQuickSwapRouterv3(routers["QuickswapV3"]).exactInputSingle{value:0}(pm);
      }
