...
contract PermissionProviderInitializer {
    function setPermissionProvider(address permissionProvider) external {
        LibDiamond.enforceIsContractOwner();
        LibPermissions.setPermissionProvider(permissionProvider);
    }
    function getPermissionProvider() external view returns(IDelegatePermissions){
        return LibPermissions.getPermissionProvider();
    }
}
