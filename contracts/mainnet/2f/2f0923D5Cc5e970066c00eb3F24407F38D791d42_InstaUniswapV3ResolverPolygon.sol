...
// File contracts/protocols/polygon/uniswap/contracts/interfaces/pool/IUniswapV3PoolState.sol
...
// File contracts/protocols/polygon/uniswap/helpers.
...
abstract contract Helpers is DSMath {
        ...
        )
    {
        ...
        amountAMin = getMinAmount(
            TokenInterface(tokenA),
            amountA,
            slippage
        );
        amountBMin = getMinAmount(
...
// File contracts/protocols/polygon/uniswap/main.sol
