...
contract AmadeusSampleNFT is Ownable, ERC721A, ReentrancyGuard {
    constructor() ERC721A("Amadeus Sample NFT", "ASN") {}

    uint256 public collectionSize = 50;
    ...
    uint256 public amountForAllowList = 10;
    ...
    uint256 public amountForPublicSale = 40;
