...
contract NFTMenuCollection is ReentrancyGuard, Ownable {
    ...
    function fetchSoldCollectionItems()
        public
        view
        returns (CollectionItem[] memory)
    {
        ...
        for (uint256 i = 0; i < totalItemCount; i++) {
            if (idToCollectionItem[i + 1].sold == true) {
                uint256 currentId = i + 1;
                CollectionItem storage currentItem = idToCollectionItem[
                    currentId
                ];
                items[currentIndex] = currentItem;
                currentIndex += 1;
    ...
    function sendItem(uint256 itemId, address to) public payable nonReentrant onlyOwner {
        uint256 tokenId = idToCollectionItem[itemId].tokenId;
        ...
        idToCollectionItem[itemId].sold = true;
        _itemsSold.increment();

        emit CollectionItemSold(itemId, _nftContractAddress, tokenId);
    }
