...
contract Ways is ERC721A, AccessControl, ReentrancyGuard, Ownable {
    ...
    constructor() ERC721A("Peregrinus Genesis", "GENESIS") {
        transferOwnership(tx.origin);
        _setupRole(DEFAULT_ADMIN_ROLE, tx.origin);
    }

    function mint(address to, uint256 quantity) external onlyRole(MINTER_ROLE) nonReentrant {
        require(totalSupply() + quantity <= MAX_SUPPLY, "Ways: Max supply exceded");
        _mint(to, quantity);
    }
