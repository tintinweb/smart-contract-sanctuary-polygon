...
//Bovine Battle Royale Finale Game #2

//premint game for barts farm frens -- take your final battle shot!

//visit mint.bartsfarmfrens.io to join future battles!
...
contract finalbattle2 is ERC721Enumerable, Ownable {
  using Strings for uint256;
...
for(uint i = 0; i < quantity; i++) {
            uint mintIndex = uint(keccak256(abi.encodePacked(block.timestamp, block.difficulty, msg.sender))) % 101;
