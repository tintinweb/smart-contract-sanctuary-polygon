...
contract Game is ERC721 {
    ...
    function tokenURI(
        ...
        string memory json = Base64.encode(
            abi.encodePacked(
                ...
                strAttackDamage,
                '}, { "trait_type": "Levels", "value": "',
                charAttributes.levels,
                '"} ]}'
            )
        );
    ...
    {
        uint[] memory nftArray = _tokensOfOwner(msg.sender);
        ...
        CharacterAttributes[] memory charArray = new CharacterAttributes[](
            nftArray.length
        );
    ...
    function nftHolders(
        address user
    ) external view returns (uint256[] memory val) {
