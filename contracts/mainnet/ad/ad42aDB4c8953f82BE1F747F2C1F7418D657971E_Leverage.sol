...
contract Leverage is Ownable {
    ...
    address public ADDR_curveProvider;
    ...
    constructor(
        ...
        ADDR_curveProvider = _curveProvider;
        ADDR_weth = _weth;
    ...
    function _swapOnCurve(
        ...
        address[4] memory _pools;
        amountOut = ICurveSwaps(ADDR_curveProvider)
            .get_exchange_multiple_amount(_route, _swap_params, _amount);
        ICurveSwaps(ADDR_curveProvider).exchange_multiple(
            _route,
            _swap_params,
            _amount,
            0,
