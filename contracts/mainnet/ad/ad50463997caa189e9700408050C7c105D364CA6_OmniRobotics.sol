...
contract OmniRobotics is ERC721, NonblockingReceiver, ILayerZeroUserApplicationConfig {
    ...
    uint256 maxMint;
    uint maxMintPerAddress = 10;
    uint256 tokenPrice = 3 ether;
    ...
    function mint(uint256 numberOfTokens) external payable{
        require(numberOfTokens > 0 && numberOfTokens + mintedBy[msg.sender] <= maxMintPerAddress,"Can only mint one or more at a time");
