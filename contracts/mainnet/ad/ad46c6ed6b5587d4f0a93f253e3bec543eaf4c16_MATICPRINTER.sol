...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 MP = IERC20(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = MP.balanceOf(address(this));
        ...
        uint256 amount = MP.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            MP.transfer(shareholder, amount);
...
contract MATICPRINTER is IERC20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address MP = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270; // MP
    ...
    string constant _symbol = "MATICP";
    ...
    address public autoLiquidityReceiver=0x942e99638179b34dC6163289647f84E75d0AF00D;
    address public marketingFeeReceiver=0x88C6442A0Cb7fB20F8B4FB2Decc33Cd33dcD96E1;
