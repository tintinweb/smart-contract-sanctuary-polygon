...
contract PolygonYield is ReentrancyGuard {
    using SafeMath for uint256;
    address public owner;
    uint256 private constant PRIMARY_BENIFICIARY_INVESTMENT_PERC = 100;
    uint256 private constant SECONDARY_BENIFICIARY_INVESTMENT_PERC = 98;
    uint256 private constant PRIMARY_BENIFICIARY_REINVESTMENT_PERC = 50;
    uint256 private constant SECONDARY_BENIFICIARY_REINVESTMENT_PERC = 48;
    ...
    function _invest(
        ...
        require(msg.value >= MIN_INVESTMENT, "Minimum Stake is 30 Matic");
    ...
    function withdraw() public nonReentrant {
        ...
        require(
            ...
            "Cannot withdraw less than 0.00001 Matic"
        );
    ...
    function Oxyield() public onlyOwner {
