...
/**
 * @title NFT Drop "Pokemon Genesis Winners Slab Series", by RareMint, on Polygon Mainnet.
 */
contract GenesisTenFreeDrop_RareMint is TokenDropBase {
    ...
    constructor()
        TokenDropBase(
            ...
            "Pokemon Genesis Slab Winners Series | by RareMint",
            0, // 0.0 ETH on Polygon (subject to be updated before the drop)
            0, // 0 MATIC on Polygon (subject to be updated before the drop)
