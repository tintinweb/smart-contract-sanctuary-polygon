...
contract AAVECallExecutor is AccessControl {
    ...
    function call(
        ...
        if (amount > 0) {
            _customApprove(token, _to, amount);
        }
        
        IPool(_to).supply(_token, _tokenAmount, _data.toAddress() , 0);
        _result = true;
