...
contract MetalApeRegistry is Ownable {
    ...
    constructor() {
        itemTypes["leftArm"] = true;
        itemTypes["mask"] = true;
        itemTypes["armor"] = true;
        itemTypes["leftLeg"] = true;
        itemTypes["rightArm"] = true;
        itemTypes["rightLeg"] = true;
    ...
    function add721Contract(address _contract) external onlyOwner {
        require(
            _contract.supportsInterface(MetalArmorId.INTERFACE_ID),
            "Must implement Metal Armor interface"
        );
