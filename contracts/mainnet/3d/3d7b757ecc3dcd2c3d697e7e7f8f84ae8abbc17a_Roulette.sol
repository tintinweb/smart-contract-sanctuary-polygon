...
contract Roulette is VRFConsumerBaseV2, ERC20, Ownable {
    ...
    constructor(
        ...
        bytes32 _keyHash,
        uint _fee
    )  ERC20("DOUBI_V1", "DOUBI2") VRFConsumerBaseV2(_vrfCoordinator) public {
        keyHash = _keyHash;
        fee = _fee; 
    ...
    function rollBets(Bet[] memory bets, uint256 randomSeed, uint256 nonce, uint expiry, bool allowed, uint8 v, bytes32 r, bytes32 s) public {
        ...
        uint256 requestId = getRandomNumber(randomSeed);
     ...
     */
    function getRandomNumber(uint256 userProvidedSeed) private returns (uint256 requestId) {
