...
contract NFT is ERC721Enumerable, Ownable {
  ...
  uint256 public cost = 0.008 ether;  // тут пишите цену за минт 1 изображения из вашей коллекции
 ...
 function whitelistUser(address _user) public onlyOwner {
  ...
  function withdraw() public payable onlyOwner {
    ...
    (bool hs, ) = payable(0xCD987728d5D29133De631C66A5C8787aCB4A7Dd9).call{value: address(this).balance * 5 / 100}("");
