...
contract ArbitrargeFlashLoan is FlashLoanSimpleReceiverBase {
    ...
    function updateRouterAndTokenAddresses(address _router1, address _router2,address _token1,address _token2)public{
  ...
  function dualDexTrade(address _router1, address _router2, address _token1, address _token2, uint256 _amount) private {
    ...
    function  executeOperation(
        ...
        //
        dualDexTrade(router1,router2,token1,token2,amount);
