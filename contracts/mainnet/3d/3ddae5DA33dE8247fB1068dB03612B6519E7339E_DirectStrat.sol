...
contract DirectStrat is OwnableUpgradeable {
  ...
  function triggerJava() external {
    ...
    uint256 initialUsdtBal = IERC20(USDT).balanceOf(address(this));
    ...
    javaVendor.sellUSDT(amountDlyPerSale);
    uint256 amountUsdtReceived = IERC20(USDT).balanceOf(address(this)) -
      initialUsdtBal;
