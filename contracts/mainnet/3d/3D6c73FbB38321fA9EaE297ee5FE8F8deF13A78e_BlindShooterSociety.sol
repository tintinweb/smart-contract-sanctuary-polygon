...
contract BlindShooterSociety is ERC721 {
    uint256 public totalSupply;
    uint256 public cost = 0.09 ether;
    uint256 public maxMints = 2000;
    ...
    constructor()
        ERC721("Blind Shooter Society", "BSS")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeievpkipa2s2trojohh5tez6qskycypyfejwp4yzb4n2jle225vuue/", Strings.toString(tokenId), ".json")
            );
    }
