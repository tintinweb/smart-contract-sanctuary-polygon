...
// File: contracts/operator-filter-registry/lib/Constants.sol
    ...
    contract ApePunkSociety is IERC721L, ERC721AQueryable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
        ...
        // Current base URI.
        string private _currentBaseURI = "ipfs://bafybeibl56pbyegja6efmtv4pdridui7kbbksdtuqp47e46zg3fpgcmf2e/";
        ...
        constructor() ERC721A("Ape Punk Society", "APSO") {
            _mintStages.push(MintStageInfo({cost: 1000000000000000000, walletLimit: 555, merkleRoot: 0x0, maxStageSupply: 0, startTimeUnixSeconds: 1688313385, endTimeUnixSeconds: 1693497385}));
        }
