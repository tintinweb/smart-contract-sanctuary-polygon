...
contract KlimtKandinsky is ERC721 {
    uint256 public totalSupply;
    uint256 public cost = 0.2 ether;
    uint256 public maxMints = 34;
    ...
    constructor()
        ERC721("Klimt Kandinsky", "KK")
    {}

    function mint() external payable {
        
        if (userMints[msg.sender] >= maxMints) revert MintLimit();
        if (totalSupply + 1 > 34) revert SoldOut();
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeihj2jyygn5ygn7b5eijdvfbicgakl26wx36tm47pl533ho3ztqt5e/", Strings.toString(tokenId), ".json")
            );
    }
