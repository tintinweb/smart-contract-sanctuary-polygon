...
contract AboDAOPool {
    ...
    modifier active {
        require(totalPoolShares > 0, "AboDAOPool: Not active");
        _;
    }

    modifier noReentrancy() {
        require(!locked, "AboDAOPool: Reentrant call");
        locked = true;
        _;
        locked = false;
    }
    ...
    function activate(uint256 initialTokens, uint256 initialPoolShares) public noReentrancy {
        require(totalPoolShares == 0, "AboDAOPool: Already active");

        require(
            approvedToken.transferFrom(msg.sender, address(this), initialTokens),
            "AboDAOPool: Initial tokens transfer failed"
        );
    ...
    function sync(uint256 toIndex) public active noReentrancy {
        require(
            ...
            "AboDAOPool: Proposal index too high"
        );
        ...
        while (i < toIndex) {
            ...
            (, applicant, sharesRequested, , , , processed, didPass, aborted, tokenTribute, , maxTotalSharesAtYesVote) = abodao.proposalQueue(i);
            ...
            if (!aborted && didPass && tokenTribute == 0 && sharesRequested > 0) {
                ...
                //   2. sharesRequested is <= 10**18 (see AboDAO.sol:172), and
    ...
    function deposit(uint256 tokenAmount) public active noReentrancy {
        ...
        require(
            ...
            "AboDAOPool: Deposit transfer failed"
        );
    ...
    function keeperWithdraw(uint256 sharesToBurn, address recipient) public active noReentrancy {
        require(
            ...
            "AboDAOPool: Sender is not a keeper"
        );
    ...
    function _mintSharesForAddress(uint256 sharesToMint, address recipient) internal {
        ...
        require(
            ...
            "AboDAOPool: Max number of shares exceeded"
        );
    ...
    function _withdraw(address recipient, uint256 sharesToBurn) internal {
        ...
        require(
            ...
            "AboDAOPool: Not enough shares to burn"
        );
        ...
        require(
            ...
            "AboDAOPool: Withdrawal transfer failed"
        );
