...
abstract contract Ownable is Context {
    ...
    address payable internal  dev = payable(0xfB513D461166b1b2050F06b0F814FC797441632A);
...
contract slimeforest is ERC721Enumerable, Ownable {
    uint public  MAX_TOKEN = 5555;
    uint public  basePrice = 1*10**13; 
    ...
    constructor(string memory baseURI) ERC721("slimeforest", "SLIME")  {
        setBaseURI(baseURI);
    }
    ...
    function FreeMint(address[] memory _addresses) public onlyOwner {
