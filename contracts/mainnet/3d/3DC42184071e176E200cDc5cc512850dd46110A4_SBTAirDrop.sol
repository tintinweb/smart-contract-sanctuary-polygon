...
contract SBTAirDrop is ERC721A, Ownable {
    using Strings for uint256;
    address public admin;   // Upgradable admin (only by owner)

    uint256 public maxSupply = 10000;
    string public baseURI = "https://data.dao-heaven.com/tomatokingdom/metadata/";
    string public baseExtension = ".json";

    constructor() ERC721A('Tomatoo KINGDAM', 'TMT') {
        admin = owner();
    }
    ...
    function _beforeTokenTransfers(
        ...
        require(to == address(0) || from == address(0),"This token is SBT, so this can not transfer.");
    }
    ...
    function airdropMint(address _airdropAddresses , uint256 _mintAmount) external onlyAdmin{
