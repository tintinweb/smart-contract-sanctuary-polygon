...
// File: DourDarcels/MerkleDistributor.sol
...
contract MerkleDistributor {
    ...
    modifier tokensAvailable(
        ...
        require(
            claimed + numberOfTokens <= totalTokenAmount,
...
// File: DourDarcels/DourDarcels.sol
    ...
    AccessControl
{
    ...
    {
        require(
            reserveSupply + numberOfTokens <= MAX_RESERVE_SUPPLY,
            "Number would exceed max reserve supply"
        );
