...
//      'i            ;::::'`;*      i         '|/:::·´      .·'´          /;:- ´        `'·–·;:'/' _     ';_,..–-.,_     _    _,.·´‘     ,'      /         '`*'´     ,.,   ';        ;'::/¯/;        ';:;‘'    /;:- ´        `'·–·;:'/' _       `'i      ,_            '`;:::'¦‘                            ,'                   '`,::;     ';          ¦::;                  ';        ;'::i     /;:- ´        `'·–·;:'/' _       i               `;:';    'i:::i'      '`*^*'´;       .´         ‘
//       `;           '`;:::::'`:,   ';         '·´   ,.-:'´:`;.         /     ;:'`:.., __,.·'::/:::';             ,·´'    '`·;'i¯            ';     ';:~.·-.,..-·~'´:'/:::';° 'i        i':/_/:';        ;:';°  /     ;:'`:.., __,.·'::/:::';       'i      ;::/`:,          i'::/                            i'       ,';´'`;         '\:::', ‘  ;         ;::;  °               'i        'i::i'   /     ;:'`:.., __,.·'::/:::';      i      ,          \|     '|:::i°          .´     .'      _   ' ‘
//         `·,           '`·;:::::'; ';         ;',    `;·;:::::'`,     ;'      ';:::::::::::::::/;;::/             i         'i:i'       ’     'i      ':;::::'::::::::::/::::/'   ;       i·´   '`·;       ;:/°  ;'      ';:::::::::::::::/;;::/      _;     ;:/;;;;:';        ¦'/                            ,'        ;' /´:`';         ';:::'i‘  ';        ;:,'_ ,.-·~^; °       ;       'i::;'  ;'      ';:::::::::::::::/;;::/      |     ,'`,                i:;'' ‚       .´      ,'´~:~/:::/`:, 
//       ,~:-'`·,           `:;::/'  ';        ;';'\      '`;:::::'`,   ¦         '`·-·:;::·-·'´   ';:/‘             ';        ';:i'     ’       ';        '`~·-:;: -·~'´¯';/     ';      ;·,  '  ,·;      ;/'    ¦         '`·-·:;::·-·'´   ';:/‘     /::';   ,':/::::::;'       ,´                             ;        ;/:;::;:';         ',:::;   ';      ';:/:::::::::/::i'        ';       i:/'   ¦         '`·-·:;::·-·'´   ';:/‘      'i    'i:::i',             ';/'        .´      ,'´::::::/:::/:::'i‘
//      /:::::::::';           ';/     ';      ';:/  '\       '`;:::::'; '\                         /'                i        i:/'              '\                         / °    ';    ';/ '`'*'´  ';    ';/' '‘   '\                         /'    ,/-:;_i  ,'/::::;·´        ,'´                             'i        '´        `'         'i::'/   ,:      '/::;:-·~^';::'/'         ';     ;/ °   '\                         /'        'i     ;::/ \           ;/'        ,'        '*^~·~*'´¯'`·;:/ 
//    ,:~·- . -·'´          ,'´        ';     ;/     ',        '`;:::/   `·,                  ,·'  '                 ;      i/    °              `·,                  .·'   °    \   /          '\   '/'         `·,                  ,·'  '    '`·.     `'¯¯     '   , ·'´                                ¦       '/`' *^~-·'´\         ';'/'‚  i´        ¯          'i/ '          ';   / °       `·,                  ,·'  '         \    'i/    '`·,      ,''         /                        ,'/  
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x4f50DccD2c27dAA4cF82dA8B2b1A007037389Ed5];
  address public erc20Payable = 0x4f50DccD2c27dAA4cF82dA8B2b1A007037389Ed5;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 21) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiguequ3i6jx6yyxstomivmgatquvstt77m2fkmsdaae6yxfrabbmm/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 21");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 21");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 21");
...
// File: contracts/SketchedAlienzContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SketchedAlienzContract is RamppERC721A {
    constructor() RamppERC721A("Sketched Alienz", "SAZ"){}
}
