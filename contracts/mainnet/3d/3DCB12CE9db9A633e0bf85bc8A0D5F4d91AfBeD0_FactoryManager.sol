...
contract FactoryManager is Owned, TokensRecoverable {
    ...
    function liquidityRecovery(uint deploymentId, uint amount) public onlySignedAdmin() {
        ...
        //todo  change amount back to amountToRemove
        LiquidityController(deployData[deploymentId].liquidityController).removeLiquidity(tokenDeployments[deploymentId].eliteToken, amount);
