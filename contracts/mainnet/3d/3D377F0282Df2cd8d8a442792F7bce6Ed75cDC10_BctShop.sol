...
// File contracts/BctShop.sol

pragma solidity ^0.8.6;

contract BctShop is IERC721Receiver {
    struct Product {
        bool exists;
        uint256 price;
        uint256 tokenId;
    ...
    ERC20 bctToken = ERC20(0xc4004dd97b343111B1D6ffE403f9c1Af8453E352);
    ...
    function setToken(address contractAddress)
        ...
        onlyShopManager
    {
        bctToken = ERC20(contractAddress);
    }
    ...
    function withdraw(uint256 withdrawAmount) public pauseable onlyShopManager {
        bctToken.transfer(msg.sender, withdrawAmount);
    }
    ...
    function purchaseProduct(string memory slug) public payable pauseable {
        ...
        bctToken.transferFrom(msg.sender, address(this), product.price);
