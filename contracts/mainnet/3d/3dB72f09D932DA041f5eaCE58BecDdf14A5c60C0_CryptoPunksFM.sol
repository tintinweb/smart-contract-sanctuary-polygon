...
contract CryptoPunksFM is ERC721  {
    ...
    constructor()
        ERC721("Crypto Punks FANMADE", "CPFM")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeiae6ryx4pgldbsqiuzg4si2gzyoq4t2akpttt2qpwwci3uwqspami/", Strings.toString(tokenId), ".json")
            );
    }
