...
contract CuteFox is ERC721, Ownable{
    ...
    function mintAirdrop(uint256 quantity_) external onlyOwner{
    ...
    function Airdrop( address[] calldata _to, uint256[] calldata _id) onlyOwner public {
    ...
    constructor() payable ERC721('CuteFox', 'CFX'){
        mintPrice = 15 ether;
        totalSupply = 0;
        maxSupply = 4444;
        maxPerWallet = 3;
    ...
    function mint(uint256 quantity_) public payable {
        ...
        require(walletMints[msg.sender] + quantity_ < (maxPerWallet + 1), 'exceed max wallet');
