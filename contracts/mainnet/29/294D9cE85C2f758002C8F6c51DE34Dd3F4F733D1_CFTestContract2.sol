...
contract CFTestContract2 is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  uint256 public currentSupply = 0;
  
  string public baseURI = "https://ipfs.io/ipfs/QmbabWzXzmUKDozfZ9bMtjQiUHfGD89s7jSHm3Wkk5epYy/";

  constructor() 
    ERC721("Abstract Me", "ABSTRACTME")
  ...
  function mint (address _to)
      ...
      payable
  {
      require( tokenCount() + 1 <= totalSupply(), "YOU CAN'T MINT MORE. ALL TOKENS HAVE BEEN MINTED");
