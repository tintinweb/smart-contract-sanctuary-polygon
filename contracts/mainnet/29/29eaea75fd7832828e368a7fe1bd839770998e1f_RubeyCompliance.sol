...
// File: contracts/compliance/features/CountryWhitelisting.sol
...
// File: contracts/compliance/features/MaxBalance.sol
...
// File: contracts/compliance/test/RubeyCompliance.sol
...
contract RubeyCompliance is CountryWhitelisting, MaxBalance {
    /**
    ...
    */
    ...
    function canTransfer(address _from, address _to, uint256 _value) external view override returns (bool) {
        ...
        || !complianceCheckOnMaxBalance(_from, _to, _value))
        {
            return false;
        }
        return true;
