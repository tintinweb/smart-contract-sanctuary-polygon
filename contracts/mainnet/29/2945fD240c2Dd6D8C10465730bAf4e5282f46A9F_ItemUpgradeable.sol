...
interface IItemTypeUpgradeable {
...
import { IItemTypeUpgradeable } from "../interfaces/IItemTypeUpgradeable.sol";
import { BaseUpgradeable } from "./BaseUpgradeable.sol";
import { OPERATOR_ROLE } from "../libraries/Constants.sol";

abstract contract ItemTypeUpgradeable is IItemTypeUpgradeable, BaseUpgradeable {
    mapping(uint256 => uint256) internal _limited;
    mapping(uint256 => uint256) internal _sold;

    function __ItemType_init(uint256[] calldata types_, uint256[] calldata limits_) internal onlyInitializing {
        __ItemType_init_unchained(types_, limits_);
    }

    function __ItemType_init_unchained(
...
import { ItemTypeUpgradeable } from "./internal-upgradeable/ItemTypeUpgradeable.sol";
...
import { IItemUpgradeable } from "./interfaces/IItemUpgradeable.sol";

contract ItemUpgradeable is
    IItemUpgradeable,
    BaseUpgradeable,
    ItemTypeUpgradeable,
