...
contract CatsOdysseyPacks is ERC1155("https://catsodyssey.com/api/metadata/packs/{id}.json") {
  function mint(address to, uint256 tokenId, uint256 amount) public onlyOwner {
    _mint(to, tokenId, amount, "");
  }

  function batchMint(address[] memory addresses, uint256 tokenId, uint256 amount) public onlyOwner {
