...
import "./721_HeroesShared_MKII.sol";

contract RGCCH is RGCHS
{
    constructor() RGCHS("UNIOVERSE CLONES", "UNIOH6")
    {
        collectionNameUriEncoded = "UNIOVERSE%20CLONES";

        _tokenIdCounter = 950000000;
    }
}
