...
contract Marketplace is BaseContract {
  ...
  function makeOrder(
    ...
    if (nftListings[_nftContractAddress].canRental) {
  ...
  function getNftListed(address _nftContractAddress) external view returns(
    ...
    return (nftListing.user, nftListing.uri, nftListing.paymentAddresses, tmpPoolAddresses, tmpIsUniSwapV3, tmpIsR0DivR1, tmpIsStableCoin, nftListing.enable, nftListing.canRental);
  }
