...
contract KANIKA is Initializable, ERC20Upgradeable, PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize() initializer public {
        __ERC20_init("KANIKA", "KNK");
        __Pausable_init();
        __Ownable_init();
        __UUPSUpgradeable_init();
        _mint(msg.sender, 454000000 * 10 ** decimals());

        address lockaccount1 = 0x3139adB13Ccdf29Ed77541eD754F2A7a9db8016C;
        address lockaccount2 = 0x8CC52B156cb87dC9A4E8C49Ee2C48151A08503A1;
        address lockaccount3 = 0xeF6C323e1fb55Bd751aD4356b119d38dAB1bddc5;
        address lockaccount4 = 0x26abce55c2eFD1610A3b4B020124bE2A11765DD5;
        address lockaccount5 = 0x5dfd3357030f62BC5db40f9240Eace58Cf8704da;   

        timelock(lockaccount1,39828136,81720000000000000000000000);
        timelock(lockaccount2,71450536,68100000000000000000000000);
        timelock(lockaccount3,102986536,54480000000000000000000000);
        timelock(lockaccount4,134522536,40860000000000000000000000);
        timelock(lockaccount5,166058536,27240000000000000000000000);
    }
        ...
        onlyOwner
    {
     ...
     function timelock(address _lockAccount, uint time, uint amount) public onlyOwner returns (bool) {
        require(amount > 0, "KANIKA: Amount cannot be zero");
