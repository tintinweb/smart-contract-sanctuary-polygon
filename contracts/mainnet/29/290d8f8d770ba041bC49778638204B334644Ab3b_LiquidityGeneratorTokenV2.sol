...
contract LiquidityGeneratorTokenV2 is IERC20, Ownable, BaseToken {
    ...
    constructor(
        ...
        if (block.chainid == 61) {
            //etc
            nativeCurrency = _uniswapV2Router.WETC();
        } else if (block.chainid == 128) {
            //heco chain
            nativeCurrency = _uniswapV2Router.WHT();
        } else if (block.chainid == 42262) {
            //oasis
            nativeCurrency = _uniswapV2Router.WROSE();
        } else if (block.chainid == 43114 || block.chainid == 43113) {
            //avalance
            nativeCurrency = _uniswapV2Router.WAVAX();
        } else {
            nativeCurrency = _uniswapV2Router.WETH();
        }
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), nativeCurrency);
