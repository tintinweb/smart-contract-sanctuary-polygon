 ...
 * @notice This contract handles minting Hidden Dreams at Waking Life tokens.
 */
contract HiddenDreamsAtWakingLife is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x1196532387c4b43218b9425DFD1883922A754e32;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x111f3a371f92271a2b95065047176f6E99e566a2;
    address[] public payoutAddresses = [
        0x111f3a371f92271a2b95065047176f6E99e566a2
    ];
    ...
    string public name = "Hidden Dreams at Waking Life";
    string public symbol = "HDWL";
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeibpt6xsam35k3npeb6dsc26yi7yh65ox4kybkt44dw6zhjowabmyq/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenPublicMintsPerAddress[2] = 3;
        tokenPublicPrice[3] = 0 ether;
        tokenPublicMintsPerAddress[3] = 3;
        tokenPublicPrice[4] = 0 ether;
        tokenPublicMintsPerAddress[4] = 0;
        tokenPublicPrice[5] = 0 ether;
        tokenPublicMintsPerAddress[5] = 3;
        tokenPublicPrice[6] = 0 ether;
        tokenPublicMintsPerAddress[6] = 3;
        tokenPublicPrice[7] = 0 ether;
        tokenPublicMintsPerAddress[7] = 3;
        tokenPublicPrice[8] = 0 ether;
        tokenPublicMintsPerAddress[8] = 3;
        tokenPublicPrice[9] = 0 ether;
        tokenPublicMintsPerAddress[9] = 3;
        tokenPublicPrice[10] = 0 ether;
        tokenPublicMintsPerAddress[10] = 1;
        tokenPublicSaleStartTime[10] = 1686265200;
        tokenPublicSaleEndTime[10] = 1688166000;
        tokenUsePublicSaleTimes[10] = true;
        require(
