...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x59b6A034159ee81e7a2dd0c979253f8381332c32];
  address public erc20Payable = 0x59b6A034159ee81e7a2dd0c979253f8381332c32;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeigbhcpxbvqk6sltm3x37yvrh7imzxa6ljmbikg4vnotuw2jjjvgbi/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/jrDBGptqKr8c9hBvL04R/contract-metadata";
  }
...
// File: contracts/DukatoBearsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DukatoBearsContract is RamppERC721A {
    constructor() RamppERC721A("Dukato Bears", "DB"){}
}
