...
contract Octobaby is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Octobaby Universe", "OU") {
  ...
  function withdraw() public onlyOwner {
    ...
    (bool pd, ) = payable(0x555A5f65e0990De60eaFac45b5207a3eB13152F1).call{value: address(this).balance * 40 / 100}("");     
    require(pd);      
    
    (bool cr, ) = payable(0x92DA4Bd5762942974356ef165Cd386e548e069c6).call{value: address(this).balance * 40 / 100}("");     
    require(cr);
