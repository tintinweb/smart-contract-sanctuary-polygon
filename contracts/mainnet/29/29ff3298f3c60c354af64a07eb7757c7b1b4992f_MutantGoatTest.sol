...
contract MutantGoatTest is ERC721A, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721A("MutantGoatTest", "MGT", maxMintAmountPerTx) {
    setHiddenMetadataUri("ipfs://QmZckj1xqkoCEvEL6uCjYH5ELw6oRcNfBKVYNobKcow8WA/hidden.json");
  }
