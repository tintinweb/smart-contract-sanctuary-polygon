...
// File: contracts/SmartContractEKS.sol


pragma solidity ^0.8.15;

//@author Step Company
//@title Colection of Empire Kangaroo Step
...
contract NFTERC721A is Ownable, ERC721A, PaymentSplitter {
    ...
    uint private constant MAX_SUPPLY = 5055;
    uint private constant MAX_WHITELIST = 600;
    uint private constant MAX_PUBLIC = 4425;
    ...
    uint public saleStartTime = 1659094140;
    
    mapping(address => uint) public amountNFTsperWalletWhitelistSale;

    uint private teamLength;

    constructor(address[] memory _team, uint[] memory _teamShares, bytes32 _merkleRoot, string memory _baseURI) ERC721A("Empire Kangaroo Step", "EKS")
    ...
    function whitelistMint(address _account, uint _quantity, bytes32[] calldata _proof) external payable callerIsUser {
        ...
        require(amountNFTsperWalletWhitelistSale[msg.sender] + _quantity <= 4, "You can only get 4 NFT on the Whitelist Sale");
