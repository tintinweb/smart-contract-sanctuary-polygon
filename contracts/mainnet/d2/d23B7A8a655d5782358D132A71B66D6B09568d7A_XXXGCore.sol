...
abstract contract Programs is Referal {
  ...
  constructor(){
   ...
   for (uint i = 0; i < 12; i++) {
    ...
    s9LevelPrice[1] = 10 * 1e18;
    s9LevelPrice[2] = 20 * 1e18;
    s9LevelPrice[3] = 40 * 1e18;
    s9LevelPrice[4] = 80 * 1e18;
    s9LevelPrice[5] = 160 * 1e18;
    s9LevelPrice[6] = 320 * 1e18;
    s9LevelPrice[7] = 640 * 1e18;
    s9LevelPrice[8] = 1280 * 1e18;
    s9LevelPrice[9] = 2560 * 1e18;
    s9LevelPrice[10] = 5120 * 1e18;     
