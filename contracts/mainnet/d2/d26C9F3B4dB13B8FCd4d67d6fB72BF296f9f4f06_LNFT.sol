...
contract LNFT is Ownable, ERC721A, ReentrancyGuard {
    constructor(
    ) ERC721A("LNFT", "LNFT", 50, 5000) {}
    ...
    function getAllowListPrice(uint256 offset) public view returns(uint256){
        if (1000 < 88 + amountForAllowList - offset){
    ...
    uint256 public immutable maxPerAddressDuringMint = 50;
