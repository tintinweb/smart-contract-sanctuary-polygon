...
// File: https://github.com/ldcnft/LDC/blob/main/ERC721A.sol
...
contract FancyDragons is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://bafybeiczpe3h7bpshzbyy3bmz6aos43gaj7nwsmtbnkudmhyepwnsio7rm/";

  uint256 public  maxSupply = 6666;
  uint256 public  MAX_MINTS_PER_TX = 66;
  uint256 public  FREE_MINTS_PER_TX = 3;
  uint256 public  PUBLIC_SALE_PRICE = 0 ether;
  uint256 public  TOTAL_FREE_MINTS = 1000;
  bool public isPublicSaleActive = true;

  constructor() ERC721A("Fancy Dragons", unicode"🐉") {
      _mint(msg.sender, 6);
  }
