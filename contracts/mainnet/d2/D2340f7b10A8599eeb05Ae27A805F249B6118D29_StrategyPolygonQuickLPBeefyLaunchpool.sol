...
contract StrategyPolygonQuickLPBeefyLaunchpool is StratManager, FeeManager {
    ...
    address[] public outputToLpRoute;
    ...
    constructor(
        ...
        // setup lp routing
        outputToLpRoute = _outputToLp0Route;
    ...
    // Converts Boosted rewards back into MATIC
    function addLiquidity() internal {
        uint256 outputAmount = IERC20(output).balanceOf(address(this));
        IUniswapRouterETH(unirouter).swapExactTokensForTokens(outputAmount, 0, outputToLpRoute, address(this), now);
        outputAmount = IERC20(matic).balanceOf(address(this));
        IBeefyUniV2Zap(beefyZapper).beefIn(want, 0, matic, outputAmount);
    }
