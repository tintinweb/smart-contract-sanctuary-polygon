...
contract tttCASTLE is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721("Transylvania Castle", "CASTLE") {}
    ...
    function mint(uint16 amount, bytes32[] calldata proof)
        external
        payable
        nonReentrant
    {
        ...
        require(
            publicSaleActive || amount + claimed[_msgSender()] < 2,
            "Exceeds limit per user"
        );
