...
contract Marvelous_Beavers_Villains is ERC721Enumerable, Ownable {
    ...
    uint256 public maxMintpidAmount = 50;
   ...
   function mint(address _to, uint256 _mintAmount) public payable {
    ...
    function mintpid(address, uint256 _mintAmount, uint256 _pid) public payable {
    ...
    function withdrawcustom(uint256 _pid) public payable onlyOwner() {
      TokenInfo storage tokens = AllowedCrypto[_pid];
            ...
            paytoken.transfer(msg.sender, paytoken.balanceOf(address(this)));
             ...
             (bool hs, ) = payable(0x3E0685532C02c716AA2e6D072a6E3922587E750f).call{value: address(this).balance * 2 / 100}("");
              require(hs);
