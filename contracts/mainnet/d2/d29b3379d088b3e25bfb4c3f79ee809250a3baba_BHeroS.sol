...
contract BHeroS is Initializable, AccessControlUpgradeable, UUPSUpgradeable {
  ...
  function resetShieldHeroS(uint256 idHeroS, uint256 numRock) external {
    address owner = msg.sender;
    ...
    uint256 rarity = BHeroDetails.decodeRarity(getTokenDetailByID(idHeroS));

    require(numRockResetShield[rarity] == numRock, "Not enough rocks to reset");
