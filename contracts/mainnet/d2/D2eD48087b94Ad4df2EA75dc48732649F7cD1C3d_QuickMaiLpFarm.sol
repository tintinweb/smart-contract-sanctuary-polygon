...
contract QuickMaiLpFarm is BaseSiloAction, IIncentiveKey {
    ...
    function _act(
        ...
        if (
            ...
            if (inputAmounts[0] > 1000000000 gwei) {
                ...
                uint256 swapAmount = _getSwapAmountForV3Lp(
                    inputAmounts[0] - 1000000000 gwei,
                    protocol
                );
        ...
        )
    {
        ...
        console.log("stakeV3 tokenId: %s",tokenId);
        if (tokenId > 0) {
            protocol.positionManager.increaseLiquidity(
            ...
            console.log("stakeV3 add original position manager: %s",tokenId);
        } else {
            ...
            (tokenId, liquidity, amount0, amount1) = protocol
                ...
                .mint(
                 ...
                 console.log("stakeV3 mint new: %s",tokenId);
        }

        enterFarming(tokenId, protocol);
        console.log("stakeV3 enterFarming");
    }
