...
library DodoConfig {
  ...
  function getTokenContract() internal pure returns (IDodoCoin) {
...
contract DodoLogicV1 {
  ...
  function getDataContract() internal pure returns (DodoStorageInterface) {
    return DodoConfig.getDataContract();
  }

  function getTokenContract() internal pure returns (IDodoCoin) {
    return DodoConfig.getTokenContract();
  }

  
  function name() public view returns (string memory) {
    return getTokenContract().name();
  }

  function symbol() public view returns (string memory) {
    return getTokenContract().symbol();
  }

  function decimals() public view returns (uint8) {
    return getTokenContract().decimals();
  }

  function balanceOf(address account) public view returns (uint256) {
    return getTokenContract().balanceOf(account);
  }

  function totalSupply() public view returns (uint256) {
    return getTokenContract().totalSupply();
  }
  ...
  function upgradeIncomeLevel() public {
    ...
    uint256 balance = getTokenContract().balanceOf(player);
    ...
    getTokenContract().deductTokens(player, address(getDataContract()), upgradeCost);
  }
  ...
  function buyProp(uint256 propId) public {
    ...
    getTokenContract().deductTokens(player, address(getDataContract()), prop.price);
  ...
  function casinoBet(uint256 amount) public {
    ...
    if(odds == 0) {
      ...
      getTokenContract().deductTokens(player, address(getDataContract()), amount);
    } else if (odds > 1) {
