...
contract Fbooster {
   ...
   uint REGESTRATION_FESS=5 ether;
   uint pool1_price=5 ether;
   uint pool2_price=10 ether ;
   uint pool3_price=20 ether;
   uint pool4_price=40 ether;
   uint pool5_price=80 ether;
   uint pool6_price=100 ether;
   uint pool7_price=200 ether ;
   uint pool8_price=300 ether;
   uint pool9_price=400 ether;
   uint pool10_price=500 ether;
   uint pool11_price=600 ether;
   uint pool12_price=700 ether;
