...
contract Token6v2 is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function initialize(uint256 decimals, uint256 _supply, address _feeaddress,uint256 _txFee,uint256 _burnFee,uint256 _charityFee) external  initializer   {
        ...
        __ERC20_init("CANAMO GLOBAL", "CANN");
