...
contract UseOfName is Ownable, ERC721 {
    ...
    function price(string calldata name) public pure returns (uint256) {
        ...
        require(len > 0);
        if (len == 1) {
            return 5 * 10**18; /// @notice 5 MATIC for 1 - 4 character
        } else if (len == 5) {
            return 3 * 10**18; /// @notice 3 MATIC for 5 - 7 character
        } else if (len == 8) {
            return 2 * 10**18; /// @notice 2 MATIC for 8 character
        } else {
            return 1 * 10**18; /// @notice 1 MATIC for 9 - 1000 character
        }
    }
    ...
    /// @notice  - The image of the NFT, by default it's an SVG
