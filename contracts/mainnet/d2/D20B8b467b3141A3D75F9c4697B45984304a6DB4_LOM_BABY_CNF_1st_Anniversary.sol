...
// File: contracts/LOM_BABY_CNF_1st_Anniversary.sol
...
contract LOM_BABY_CNF_1st_Anniversary is Ownable, ERC721A, Pausable, ReentrancyGuard {
    uint256 public mintedSize = 0;
    string private baseURI;

    constructor() ERC721A("LOM BABY CNF 1st Anniversary", "LOM BABY") {}
    ...
    function mint(
        address to,
        uint256 quantity
    ) external validateMintable(quantity) onlyOwner {
        _safeMint(to, quantity);
        mintedSize += quantity;
    }
}