...
contract WalletFacet is IWallet {
    ...
    function propositionToTypedDataHash(IWallet.Proposition memory proposition)
        ...
        returns (bytes32)
    {
        return LibWallet._toTypedDataHash(proposition);
    }
}
...
library LibReceive {
    ...
    function _withdraw() internal {
        ...
        ds.withdrawable[account] -= withdrawable;
...
library LibWallet {
    ...
    function _untrustedEnactProposition(
        ...
        bytes32 propositionHash = _toTypedDataHash(proposition);
