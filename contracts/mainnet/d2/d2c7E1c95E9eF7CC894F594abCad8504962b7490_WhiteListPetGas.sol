...
contract WhiteListPetGas is ERC721A, Ownable, ReentrancyGuard,Pausable {
    ...
    constructor() ERC721A("WhitelistPetGas", "WLPTG") {
           _pause();
        config.tokenPrice = 0.00 ether;
        ...
        notBots
    {
        ...
        require(msg.value >= config.tokenPrice * count, "more $$  required");
