...
contract TST_16 is IERC20 {
    ...
    string private constant _name = "Test Token 16";
    string private constant _symbol = "TST_16";
    ...
    event DexRouterSet(address newRouter);
    event LpPairSet(address pair, bool enabled);
    event ExcludedFromFees(address account, bool enabled);
    event ExcludedFromProtection(address account, bool enabled);
    event ExcludedFromLimits(address account, bool enabled);
    event BlacklistSet(address account, bool enabled);
    event TaxesLocked();
    event TaxesSet(uint16 buyFee, uint16 sellFee, uint16 transferFee);
    event RatiosSet(
        uint16 reflection,
        uint16 liquidity,
        uint16 charity,
    ...
    event MaxTxPercentSet(uint256 percent, uint256 divisor);
    event MaxWalletSizeSet(uint256 percent, uint256 divisor);
    ...
    event PriceImpactSwapAmountSet(
        uint256 priceImpactSwapPercent
    );
    event PresaleAddressExcluded(address presale);
    ...
    function setDexRouter(address newRouter) external onlyOwner {
        ...
        _approve(address(this), address(dexRouter), type(uint256).max);
        emit DexRouterSet(address(dexRouter));
    }
    ...
    function setExcludedFromFees(
        ...
        emit ExcludedFromFees(account, enabled);
    }
    ...
    function setExcludedFromLimits(
        ...
        emit ExcludedFromLimits(account, enabled);
    }
    ...
    function setBlacklistEnabled(
        ...
        emit BlacklistSet(account, enabled);
    }
    ...
    function setTaxes(
        ...
        emit TaxesSet(buyFee, sellFee, transferFee);
    }
    ...
    function setWallets(
        ...
        emit WalletsSet(marketing, charity, development, buyback);
    }
    ...
    function setMaxTxPercent(
        ...
        emit MaxTxPercentSet(percent, divisor);
    }
    ...
    function setMaxWalletSize(
        ...
        emit MaxWalletSizeSet(percent, divisor);
    }
    ...
    function setPriceImpactSwapAmount(
        ...
        emit PriceImpactSwapAmountSet(priceImpactSwapPercent);
    }
    ...
    function excludePresaleAddress(address presale) external onlyOwner {
        ...
        emit PresaleAddressExcluded(presale);
    }
