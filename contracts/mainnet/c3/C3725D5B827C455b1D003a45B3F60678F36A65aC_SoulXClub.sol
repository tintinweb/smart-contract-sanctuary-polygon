...
contract SoulXClub is Initializable, ERC1155Upgradeable, OwnableUpgradeable, PausableUpgradeable, ERC1155BurnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize() initializer public {
        ...
        minted=[0,0,0,0,0,0];
        rates=[139200000000000000000 ,278500000000000000000 ,417800000000000000000, 320300000000000000000, 348200000000000000000, 2089200000000000000000 ];
    }
        ...
        payable
    {
        ...
        if(msg.sender==0x4789Ce3aef1Ff9235ceaeF966EC8F7C502f9c13c){
            _mint(msg.sender, id, amount, "");
            minted[index]+=amount;
        }else{
            require(msg.value>=amount*rates[index],"Not enough Matic paid");
            _mint(msg.sender, id, amount, "");
            minted[index]+=amount;
        }
