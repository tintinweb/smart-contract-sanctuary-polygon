...
contract BITEINU is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal =40000000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Bite inu";
    string private _symbol = "BITE";
    ...
    address wallet = address(0xA3820Ca28E075388E05B45E86027D9B3A0852bDE);
    address rewardsWallet = address(0x4AA81A88ce952C8726ce4f3eAacA833f4e869AfA);
    IPancakeRouter02 public pancakeRouter;
    address public pancakePair;
    
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = false;
    uint256 public minTokensBeforeSwap = 8 * 10**9;
    ...
    function updateMinTokensBeforeSwap(uint256 amount) external onlyOwner {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        payable(wallet).transfer(oneThird);
        payable(rewardsWallet).transfer(oneThird);
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
         require(taxFee <= 5, "Maximum fee limit is 5 percent");
        _taxFee = taxFee;
    }
    
    function setLiquidityFeePercent(uint256 liquidityFee) external onlyOwner() {
        require(liquidityFee <= 0, "Maximum fee limit is 0 percent");
