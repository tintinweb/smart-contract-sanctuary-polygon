...
contract SignedStake is ISignedStake, TokensRecoverable
{
    ...
    function calculatePayouts(uint256 amount) internal {
        ...
        uint levelOnePayout = (stakerRates[0] * amount / 10000) / stakerTracker.levelOneCalc;
        uint levelTwoPayout = (stakerRates[1] * amount / 10000) / stakerTracker.levelTwoCalc;
        uint levelThreePayout = (stakerRates[2] * amount / 10000) / stakerTracker.levelThreeCalc;
        uint levelFourPayout = (stakerRates[3] * amount / 10000) / stakerTracker.levelFourCalc; 
        uint levelFivePayout = (stakerRates[4] * amount / 10000) / stakerTracker.levelFiveCalc;
