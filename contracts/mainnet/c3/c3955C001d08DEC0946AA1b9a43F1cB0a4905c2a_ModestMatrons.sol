...
contract ModestMatrons is ERC721A, Ownable {

    uint256 _currentIndex = 1; //Make first tokenId = first json file.
    string baseExtension = ".json";
    uint256 _mintamount = 10000; //It will be equal to quantity.
    

    uint256 public maxPerWallet = 10000;
    uint256 public maxPerTransaction = 10000;
    uint256 public immutable supply = 10000;
    uint256 public price = 0.000001 ether;
    uint256 public presalePrice = 0.000001 ether;    
    uint256 public presaleMaxPerWallet = 10000;
    uint256 public presaleMaxPerTransaction = 10000;
