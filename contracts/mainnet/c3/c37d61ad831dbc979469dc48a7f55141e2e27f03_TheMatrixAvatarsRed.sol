...
// File contracts/v2/utils/NiftysMetadataERC721.sol
...
// File contracts/v2/NiftysERC721.sol
    ...
    DefaultOperatorFilterer
{
    ...
    constructor(
        ...
        uint24 royaltyvalue,
        address owner
    ) ERC721(name, symbol) DefaultOperatorFilterer(owner) {
...
/**
  _____ _          __  __       _        _          _             _                 ____          _ 
 |_   _| |__   ___|  \/  | __ _| |_ _ __(_)_  __   / \__   ____ _| |_ __ _ _ __ ___|  _ \ ___  __| |
   | | | '_ \ / _ \ |\/| |/ _` | __| '__| \ \/ /  / _ \ \ / / _` | __/ _` | '__/ __| |_) / _ \/ _` |
   | | | | | |  __/ |  | | (_| | |_| |  | |>  <  / ___ \ V / (_| | || (_| | |  \__ \  _ <  __/ (_| |
   |_| |_| |_|\___|_|  |_|\__,_|\__|_|  |_/_/\_\/_/   \_\_/ \__,_|\__\__,_|_|  |___/_| \_\___|\__,_|
                                                                                                    
*/

contract TheMatrixAvatarsRed is NiftysERC721 {
    constructor(
        string memory name,
        string memory symbol,
        string memory baseTokenURI,
        ...
        address owner,
        address relay
    ) NiftysERC721(name, symbol, baseTokenURI, contractURI, royaltyrecipient, royaltyvalue, owner) {
