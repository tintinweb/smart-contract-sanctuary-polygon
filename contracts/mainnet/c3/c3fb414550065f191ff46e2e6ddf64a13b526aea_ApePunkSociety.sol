...
// File: contracts/operator-filter-registry/lib/Constants.sol
    ...
    contract ApePunkSociety is IERC721L, ERC721AQueryable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
        ...
        // Current base URI.
        string private _currentBaseURI = "ipfs://bafybeib2umtlaq3rdzm4thmiiuhtln3dzszhm6gxixflybnkezh7sc2d4a/";
        ...
        constructor() ERC721A("Ape Punk Society", "APSO") {
            _mintStages.push(MintStageInfo({cost: 1000000000000000000, walletLimit: 555, merkleRoot: 0x0, maxStageSupply: 0, startTimeUnixSeconds: 1688317893, endTimeUnixSeconds: 1693501893}));
        }
