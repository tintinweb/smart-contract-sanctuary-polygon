...
contract Kodachi is KodachiDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private KodachiTeam;
    address private CharityKodachi;
    ...
    string public override name = "Kodachi";
    string public override symbol = "KODACHI";
    ...
    constructor(uint totalSupplyValue, address KodachiTeamAddress, address CharityKodachiAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        KodachiTeam = KodachiTeamAddress;
        CharityKodachi = CharityKodachiAddress;
        
        // split the tokens according to agreed upon percentages
        balances[KodachiTeam] =  totalSupply * 4 / 100;
        balances[CharityKodachi] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's KodachiTeam pot
