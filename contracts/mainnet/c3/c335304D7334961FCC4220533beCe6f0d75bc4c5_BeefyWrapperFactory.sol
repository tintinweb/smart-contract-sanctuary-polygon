...
contract BeefyWrapper is ERC4626Upgradeable {
    ...
    /**
     * @dev Hardcode decimals to match Beefy Vaults which are always 18 decimals.
     * @return decimals the decimals of the vault.
     */
    ...
    /**
     * @dev Override the initial conversion to use the correct decimals for initial shares.
     * @param assets the amount of assets to convert to shares.
     * @param rounding the direction of rounding.
     * @return shares the amount of shares returned given the assets.
     */
    ...
    /**
     * @dev Override the initial conversion to use the correct decimals for initial assets.
     * @param shares the amount of shares to convert to assets.
     * @param rounding the direction of rounding.
     * @return assets the amount of assets returned given the shares.
     */
