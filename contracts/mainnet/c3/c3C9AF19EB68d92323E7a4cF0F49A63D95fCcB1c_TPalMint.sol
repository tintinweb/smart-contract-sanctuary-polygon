...
contract TPalMint is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("TPaladinMint", "TPM") {
        setBaseURI(baseURI);
    }
    ...
    function mint(uint chosenAmount) public payable isSaleOpen {
        ...
        require(totalSupply() + chosenAmount <= MAX_SUPPLY, "Quantity must be lesser then remaining NFTs");
        ...
        require(price.mul(chosenAmount) == msg.value, "Sent bnb value is not correct");
