...
contract OmniLoot is ERC721Enumerable, ReentrancyGuard, Ownable, NonblockingReceiver{
    ...
    constructor(address _layerZeroEndpoint) ERC721("OmniLoot", "OMNILOOT") Ownable() {
