...
contract StrategAaveLeverageBlock is IStrategStrategyBlock, IStrategOracleBlock {
    using SafeERC20 for IERC20;
    ...
    function oracleExit(OracleResponse memory _before, bytes memory _parameters) external view returns (OracleResponse memory) {
        ...
        uint256 collateralReturned = IStrategAaveV3PositionManager(parameters.positionManager).returnedAmountAfterUnleverage();
        
        return LibBlock.addTokenAmount(parameters.collateral, collateralReturned, _before);
    }
}
