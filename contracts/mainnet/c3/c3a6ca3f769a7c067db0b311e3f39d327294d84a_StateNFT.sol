...
contract StateNFT is ERC721, Ownable {
  constructor(string memory _name, string memory _symbol)
    ERC721(_name, _symbol)
  {}

  uint256 COUNTER;
  address allowmintcontract;
  string url = "ipfs/baseurl/";
  ...
  function updateAllowMintContract(address _allowmintcontract) public onlyOwner {
    allowmintcontract = _allowmintcontract;
  }
  ...
  function _createNft() internal {
    ...
    Nft memory newNft = Nft( COUNTER, randDna);
    Nfts.push(newNft);
  ...
  function createNft() external {
    require( msg.sender == allowmintcontract , "BEP721: only mintable from contract");
    _createNft();
  }
