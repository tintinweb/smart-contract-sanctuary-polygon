...
/** EVENTS */
    ...
    event depositedFunds(uint indexed amount, address indexed account);
    event withdrawnFunds(uint indexed amount, address indexed account);
    event transferredFunds(uint indexed amount, address indexed account, address indexed beneficiary);
...
/** MODIFIERS */
    ...
    //modifier to check if there is enough money in the bank-account
