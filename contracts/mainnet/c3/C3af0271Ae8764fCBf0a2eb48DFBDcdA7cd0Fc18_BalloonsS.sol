...
contract BalloonsS is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeicnbmwjugildk7jo6qm3myx2zbmqtpvfrmfcszm6zirjxuox3ydta/", Strings.toString(tokenId), ".json")
            );
    }
