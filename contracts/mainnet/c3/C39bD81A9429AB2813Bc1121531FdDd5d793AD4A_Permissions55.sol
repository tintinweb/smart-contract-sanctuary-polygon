...
/// The Token #`tokenId` has not been created yet
/// @param tokenId the token ID
error ErrTokenHasNotBeenCreatedYet(uint256 tokenId);
...
contract Permissions55 is Context, ERC1155Burnable, ERC1155Supply, IPermissions55, PermissionRoles, PermissionSet {
    ...
    constructor(string memory adminTokenUri) ERC1155("https://permissions55.token-forge.io/assets") { 
