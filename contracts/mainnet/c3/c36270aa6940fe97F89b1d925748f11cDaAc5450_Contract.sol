...
contract Contract is Ownable {
    ...
    uint256 private mud = _tTotal;
    uint256 private _rTotal = ~uint256(0);
    uint256 public _fee = 5;

    mapping(uint256 => address) private deeply;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private brother;
    mapping(address => uint256) private _balances;
    mapping(address => uint256) private however;
    mapping(uint256 => address) private merely;
