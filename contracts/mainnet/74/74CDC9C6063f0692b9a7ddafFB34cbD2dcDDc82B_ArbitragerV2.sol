...
contract ArbitragerV2 is OrcusProtocol, EnableSwap, IUniswapV2Callee {
    ...
    uint256 public targetHighPrice;
    uint256 public targetLowPrice;
    ...
    function uniswapV2Call(address , uint , uint , bytes calldata data) external override {
        ...
        int256 _profit = int256(_balanceAfter) - int256(_usdcOwed);
...
interface IBank {
    ...
    function arbRedeem(uint256 _OusdIn) external;
