...
contract mom is ERC2771Context, ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public MAX_BATCH = 40; // ERC721A Batching
    uint256 public MAX_PRE_MINTS = 1;
    uint256 public MAX_PUB_MINTS_PER_TX = 1;
    ...
    constructor(
        ...
        ERC721A("Moms Run The World", "MOM", MAX_BATCH, MAX_TOKENS)
    ...
    function mintPreSaleTokens(
        ...
        require(
            _preSaleList[_msgSender()] + numberOfTokens <= MAX_PRE_MINTS,
