...
/**
 * @title Token Oracle contract
 * @notice Calculates exchange rate based on Chainlink price feed
 **/
contract TokenOracle is IOracle {
    ...
    constructor(
        ...
        rateDividend = 10**(assetDecimals_ + priceFeed.decimals());
    }
    ...
    function _get() internal view returns (uint256) {
        ...
        return rateDividend / uint256(answer);
    }
