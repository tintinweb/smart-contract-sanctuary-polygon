...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmbsFhKnRggujE4r3kZ2SDrysehBDZKrTowb7bVUxzGdqa/";
...
// File: contracts/WonderLambContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WonderLambContract is RamppERC721A {
    constructor() RamppERC721A("WonderLamb", "WONDERLAMB"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/SQH0laW4ytnunE3T91wq/contract-metadata";
    }
}
