...
/*
 ______  _____    _____    __ __      _____  _____    _____    ______    _____  
/ ____/\/\ __/\  /\___/\  /_/\__/\  /\_____\/\ __/\  /\___/\  / ____/\ /\_____\ 
) ) __\/) )__\/ / / _ \ \ ) ) ) ) )( (_____/) )__\/ / / _ \ \ ) ) __\/( (_____/ 
 \ \ \ / / /    \ \(_)/ //_/ /_/ /  \ \__\ / / /    \ \(_)/ /  \ \ \   \ \__\   
 _\ \ \\ \ \_   / / _ \ \\ \ \_\/   / /__/_\ \ \_   / / _ \ \  _\ \ \  / /__/_  
)____) )) )__/\( (_( )_) ))_) )    ( (_____\) )__/\( (_( )_) ))____) )( (_____\ 
\____\/ \/___\/ \/_/ \_\/ \_\/      \/_____/\/___\/ \/_/ \_\/ \____\/  \/_____/ 
                                                                                
*/

contract Scapecase is ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter public _tokenIds;

    uint256 public _price = 0 ether;
    uint256 public _price_Public = 0 ether;
    uint256 public _maxMintable = 888;
    ...
    function mint(uint256 quantity) public payable {
        ...
        require(quantity <= _maxMintPerTx && quantity > 0, "Cannot mint that many at once.");
        if(isMaxPerWallet){
            mintPerWallet[msg.sender] += quantity;
            require(mintPerWallet[msg.sender] <= _maxMintPerWallet, "Cannot mint more on your wallet.");
        }
    ...
    function _internalMint(address recipient) public onlyOwner {
        _tokenIds.increment();
