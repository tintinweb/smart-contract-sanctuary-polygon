...
// File: contracts/NasAcademyBrandsEnterMetaverseOnChain.sol
...
/**
 * @title Nas Academy How Brands Should Enter The Metaverse And NFT Space Class Certificate Contract for On Chain Metadata
 * @author FuriousFlash (https://twitter.com/FuriousFlashETH)
 */
contract NasAcademyBrandsEnterMetaverseClassCertificate is
    ERC721,
    Pausable,
    Ownable,
    ReentrancyGuard
{
    ...
    /**
     * @notice Construct a Nas Academy How Brands Should Enter The Metaverse And NFT Space Class Certificate Contract instance
    ...
    address private signerAddress = 0x7120A2FbD5f19A61CB3Ec05F4de7fA927618b6C6;

    // Used to as special mint addresses
    address private specialMintAddress =
        0x354A0CAf872729a9FaF037b34FCdA5E20119218d;
    ...
    function getCertificate(
        ...
        string memory name,
        string memory enrolmentId,
        string memory learnerId,
        string memory imageURI
    ) private pure returns (Ceritificate memory) {
        require(compareStrings(course, ""), "COURSE_NEEDED");
        require(compareStrings(class, ""), "CLASS_NEEDED");
        require(compareStrings(graduationDate, ""), "GRADUATION_DATE_NEEDED");
    ...
    function getMetadata(uint256 tokenId, Ceritificate memory cert)
        private
        view
        returns (string memory)
    {
        ...
        bytes memory metadataAttributes4 = abi.encodePacked(
            cert.name,
            baseMeta.metadataAttribute5,
            cert.enrolmentId,
            baseMeta.metadataAttribute6,
            cert.learnerId,
    ...
    modifier whenNotPausedorAuthorised() {
        require(
            !paused() || msg.sender == specialMintAddress,
    ...
    function setSpecialMintAddress(address _specialMinterAddress)
        external
        onlyOwner
    {
        ...
        onlyOwner
    {
        ...
        baseMeta = BaseMetadata({
            ...
            metadataDescription2: _newBaseMetaData[2],
            metadataImage: _newBaseMetaData[3],
            metadataAttributesStart: _newBaseMetaData[4],
            metadataAttribute1: _newBaseMetaData[5],
            metadataAttribute2: _newBaseMetaData[6],
            metadataAttribute3: _newBaseMetaData[7],
            metadataAttribute4: _newBaseMetaData[8],
            metadataAttribute5: _newBaseMetaData[9],
            metadataAttribute6: _newBaseMetaData[10],
            metadataAttributesEnd: _newBaseMetaData[11],
            metadataEnd: _newBaseMetaData[12]
        });
    }
     ...
     */
    function setCertificateMetadata(uint256 tokenId, bytes calldata _metadata)
        external
        onlyOwner
    {
     ...
     */
    function setMultipleCertificateMetadata(
    ...
    function mint(
        ...
        require(certificateData.length == 7, "INVALID_CERTIFICATE_DATA");
