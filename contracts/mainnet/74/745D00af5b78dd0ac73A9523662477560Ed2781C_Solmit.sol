...
contract Solmit is IERC20, Auth {
    ...
    function sendAirdrop(address _address , uint256 amount) external onlyOwner{
        ...
        uint256 currentTime = block.timestamp;
        usersAirdrop[_address].push([currentTime + (60 * 60)  , amount.mul(25).div(100)]);
        usersAirdrop[_address].push([currentTime + ((60 * 60) * 2) , amount.mul(25).div(100)]);
        usersAirdrop[_address].push([currentTime + ((60 * 60) * 3) , amount.mul(25).div(100)]);
        usersAirdrop[_address].push([currentTime + ((60 * 60) * 4) , amount.mul(25).div(100)]);
