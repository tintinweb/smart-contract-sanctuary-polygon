...
// File: contracts/BOTR_SmartContract.sol
...
contract BOTR_SmartContract is ERC1155, Ownable {
    ...
    function claimNFT(uint256 id, uint256 amount) public {
        _safeTransferFrom(ownerAddress, msg.sender, id, amount, "");
    }
