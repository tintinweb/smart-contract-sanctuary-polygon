...
contract UNIUM is UNIUMDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private UNIUMTeam;
    address private CharityUNIUM;
    ...
    string public override name = "UNIUM";
    string public override symbol = "UNM";
    ...
    constructor(uint totalSupplyValue, address UNIUMTeamAddress, address CharityUNIUMAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        UNIUMTeam = UNIUMTeamAddress;
        CharityUNIUM = CharityUNIUMAddress;
        
        // split the tokens according to agreed upon percentages
        balances[UNIUMTeam] =  totalSupply * 4 / 100;
        balances[CharityUNIUM] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's UNIUMTeam pot
