...
contract NilERC721FactoryV1 {
    ...
    function createERC721Contract(
        ...
        NilERC721TemplateV1(clone).initialize(
            ...
            owner,
            protocolFeesInBPS,
            INilERC721V1.ContractAddresses(nil, dao, operator, nOwnerResolver, signer)
        );
    ...
    IERC2981Upgradeable
{
    ...
    function withdrawProceeds() public {
        if (nftParameters.isNilSale) {
            contractAddresses.nil.transfer(_owner, contractAddresses.nil.balanceOf(address(this)));
        } else {
