...
contract TESTToken is ERC20, Ownable, Pausable{
    ...
    function transfer(address recipient, uint256 amount) public whenNotPaused override returns (bool) {
        ...
        uint32 restPercent = 100 - feePercent / 10;

        super.transfer(feeAddress, amount * feePercent / 100);
        super.transfer(recipient, amount * restPercent / 100);
        return true;
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public  whenNotPaused override returns (bool) {
        ...
        super.transferFrom(sender, feeAddress, amount * feePercent / 100);
        super.transferFrom(sender, recipient, amount * restPercent / 100);
        return true;
    }
}