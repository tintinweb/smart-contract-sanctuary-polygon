...
contract MagicEdenSale is AccessControl {
    ...
    uint256 private mysteryBoxKind;

    uint256 public mysteryBoxPrice;
    uint256 public currentBoxPosition;
    uint256 public totalMinted;

    event BoxBought(address owner, uint256 qty, uint256 price);
    ...
    function mint() public payable {
        ...
        require(msg.value % mysteryBoxPrice == 0, "Quantity was not an integer");

        uint256 qty = msg.value / mysteryBoxPrice;

        totalMinted += qty;
        currentBoxPosition += qty;
        collection.mintBatch(msg.sender, mysteryBoxKind, qty, currentBoxPosition);
