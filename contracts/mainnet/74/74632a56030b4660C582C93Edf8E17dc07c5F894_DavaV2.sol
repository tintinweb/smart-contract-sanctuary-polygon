    ...
    ERC721
{
        ...
        returns (address avatarAddress)
    {
        ...
        uint256 newID = _newId(originalId);
    ...
    function refreshToken(uint256 tokenId) public override {
        ...
        require(
            msg.sender ==  avatarOwner || msg.sender == getAvatar(originalTokenId),
            "Dava: msg.sender is not the owner of avatar"
        );
    ...
    function ownerOf(uint256 tokenId)
        ...
        returns (address)
    {
        (uint256 originalId, uint256 newTokenId) = _getOriginalAndNewId(
            tokenId
        );
        ...
        returns (uint256 newTokenID)
    {
        ...
        newTokenID = _newId(originalTokenId);
    ...
    function _newId(uint256 tokenId) private view returns (uint256) {
        return 10000 + nonceCounter;
    }
...
interface IUniqueController {
    ...
    function setRegisterRole(address dava) external;
}
