...
contract Mutual is FDFRisk{
    ...
    function _unfreezeCapitalOrReward(address _userAddr, uint256 _amount) private returns(bool isUnFreeze,uint256 newAmount) {
        ...
        (,bool isRisk,bool isStaticRisk) = userTotalRevenue(_userAddr);
...
contract FDFRisk is Initializable{
    ...
    function initRiskLevel() private {
        RiskLevel memory rl1 = RiskLevel(50_000e6,35_000e6,20_000e6,75_000e6);
        riskLevels.push(rl1);
        RiskLevel memory rl2 = RiskLevel(250_000e6,150_000e6,100_000e6,250_000e6);
        riskLevels.push(rl2);
        RiskLevel memory rl3 = RiskLevel(500_000e6,250_000e6,100_000e6,500_000e6);
        riskLevels.push(rl3);
    }
