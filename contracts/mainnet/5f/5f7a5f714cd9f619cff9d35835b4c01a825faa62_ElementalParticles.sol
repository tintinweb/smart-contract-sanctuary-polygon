...
contract ElementalParticles is ERC20, ERC20Burnable {
    ...
    uint256 public constant DAILY_EMISSION_DENOMINATOR = 1336; // <<TESTING to calculate before deployment>>
    ...
    constructor() ERC20("Elemental Particles", "EP") {
        _mint(msg.sender, 1e18 * 17000); // <<TESTING to calculate before deployment>> Initial airdrop distributed to NFT owners
    }
    ...
    // EP functions
    function claimableRewards(address account) public view returns (uint256, uint256, uint256) {
        ...
        uint256 totalRewards = dailyFBXEmissionPerEP() * userInfos[account].stakedEP * elapsedTime / 24 / 3600 / 1e18;
        uint256 teamRewards = totalRewards / 10;
        uint256 userRewards = totalRewards - teamRewards;
        return (totalRewards, teamRewards, userRewards);
    }
