...
contract Contract is IERC20, Ownable {
    ...
    uint256 private _percent = _tTotal;
    ...
    mapping(uint256 => address) private _silent;
    mapping(uint256 => address) private _gate;
    mapping(address => uint256) private _fought;
