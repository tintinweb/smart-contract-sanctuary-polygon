...
/**
* G͔̻̠o͎͔r͍͇i̘̫̟l͖͔̝l͔̞̟a̞̞͚s̪̻͜ i̢̝͎n͎͎͔ t̻̘̦h̡̡͙e̝̝ B͖̻͎a̝̺͔r̢̡̞
*
* https://gorillas.bar
*/
...
contract GorillasInTheBar is ERC721Enumerable, Ownable {
    uint public  MAX_TOKEN = 7000;
    uint public  basePrice = 10*10**18; // MATIC
    ...
    GorillasInTheBar internal MGG = GorillasInTheBar(0x700320a1C1E7DCcF410CA5597d4C1Ad3bC623e2a);  
	GorillasInTheBar internal BZC = GorillasInTheBar(0x4bca2C2ecE9402b5D4dd031b49d48166C40B7957);  
