...
contract AnimatedClipartNFTs is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function setmintPerAddressLimit(uint _mintPerAddressLimit) public onlyOwner {
