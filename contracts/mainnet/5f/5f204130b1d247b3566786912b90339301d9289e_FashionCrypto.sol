...
contract FashionCrypto is ERC721, Ownable , RandomlyAssigned {
    using Strings for uint256;
    string public baseURI= "http://fashioncrypto.ricorean.kr/data/nft/json/";
    string baseExtension = ".json";

    uint256 preSaleStartTime = 1653390000; //May 24, 8PM
    uint256 preSaleEndTime = 1653476400; //May 25, 8PM
    uint256 public cost = 0.1 ether;

    address[] private whitelistedAddressesOne =[0xe03895910e1190d846AeD3BEB317A84E1Ff892d2,
...
0x5a3d6C4642E7F575030a6e9B41Bcc60719AF2A18
    ...
    RandomlyAssigned(1000, 1000) 
    {
    }

    function mint(uint8 amount) ensureAvailability public payable     {
