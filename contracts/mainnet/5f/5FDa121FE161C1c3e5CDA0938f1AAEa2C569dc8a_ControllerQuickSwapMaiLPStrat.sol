...
contract SolidlyZap is PiAdmin, ReentrancyGuard {
    ...
    function _getRoute(address _from, address _to, bool _stable) internal view returns (route[] memory _route) {
        if (
            ...
            console.log("En la penultima opcion");
            _route = new route[](1);
            _route[0].from = _from;
            _route[0].to = _to;
            _route[0].stable = _stable;
        } else {
            console.log("En la ultima opcion");
            _route = new route[](2);
            _route[0].from = _from;
            _route[0].to = WFTM;
            _route[0].stable = _stable;
...
contract FeeManager is Swappable, ReentrancyGuard {
    ...
    address public constant piToken = address(0xaa2155059f631fD7dae8c82B9073405869393D78); // Test
...
contract CurvePoolMock is ERC20 {
    ...
    IERC20 public constant BTC = IERC20(0x1BFD67037B42Cf73acF2047067bd4F2C47D9BfD6);
...
contract ControllerCurveStrat is ControllerStratAbs {
    ...
    address constant public ETH = address(0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619); // same than wNative
    address constant public BTCCRV = address(0xf8a57c1d3b9629b77b6726a042ca48990A84Fb49); // same than CurvePool
    ...
    constructor(address _controller, address _exchange, address _treasury)
        ControllerStratAbs(
            IERC20Metadata(0x1BFD67037B42Cf73acF2047067bd4F2C47D9BfD6), // BTC
            _controller,
            _exchange,
            _treasury
        ) {}
