...
contract PunkGallery is ERC721 , DefaultOperatorFilterer {
    ...
    constructor()
        ERC721("Punk Gallery", "PUNKGALLERY")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeih7wdb3muinyne5vkjn3yqkc7cuwdpkziwxlccf6ggtqgymxi5dwq/", Strings.toString(tokenId), ".json")
            );
    }
