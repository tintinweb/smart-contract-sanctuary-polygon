...
// a proxied contract can't have a constructor
// idempotent অক্ষমতা


contract AccessControlUpgradeable is Initializable, ContextUpgradeable {
   ...
   bytes32 public constant DEFAULT_ADMIN_ROLE = keccak256(abi.encodePacked("DEFAULT_ADMIN_ROLE"));
