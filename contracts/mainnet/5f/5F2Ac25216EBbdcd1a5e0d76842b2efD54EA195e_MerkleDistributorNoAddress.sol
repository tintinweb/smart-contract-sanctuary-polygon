...
interface IMerkleDistributor {
    ...
    function claim(address account, uint256 index, string memory id, uint256 amount, bytes32[] calldata merkleProof) external;
...
contract MerkleDistributorNoAddress is IMerkleDistributor {
    ...
    function claim(address account, uint256 index, string memory id, uint256 amount, bytes32[] calldata merkleProof) external override {
