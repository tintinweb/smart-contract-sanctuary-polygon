 ...
 * @dev {ERC721} token
 */
contract Opie is ContextMixin, ERC721, ERC721Enumerable, NativeMetaTransaction, Ownable {
    ...
    /**
     * @dev Creates `amount` of new tokens for `to`. Its token ID will be automatically
     * assigned (and available on the emitted {IERC721-Transfer} event), and the token
     * URI autogenerated based on the base URI passed at construction.
     *
     * See {ERC721-_mint}.
    ...
    // The following functions are overrides for OpenSea.
