...
contract InstaAutomationImplementation is Helpers {
    ...
    function submitAutomationRequest(
        ...
        uint256 currentHf;
        (, , , , , currentHf) = aave.getUserAccountData(msg.sender);
    ...
    function systemRevert(address user) external onlyDSA(user) {
        // onlyOwner
    ...
    function _buildSpell(
        ...
        if (loanAmt_ > 0) {
            ...
            if (isIsolated) {
                 ...
                 */
                (_spell._targets[0], _spell._datas[0]) = (
                    "AAVE-V3-A",
                ...
                (_spell._targets[1], _spell._datas[1]) = (
                    "AAVE-V3-A",
                    abi.encodeWithSignature(
                ...
                (_spell._targets[2], _spell._datas[2]) = (
                    "INCH-A",
                    abi.encodeWithSignature(
                ...
                (_spell._targets[3], _spell._datas[3]) = (
                    "INSTAPOOL-C",
                    abi.encodeWithSignature(
                ...
                (_spell._targets[1], _spell._datas[1]) = (
                    ...
                    abi.encodeWithSignature(
                        "withdraw(address,uint256,uint256,uint256)",
                        swap.sellToken, // withdraw the debt now
                        swap.sellAmt, // the amount of debt token to withdraw
                        0,
                        0
                    )
                );
                ...
                (_spell._targets[2], _spell._datas[2]) = (
                    ...
                    abi.encodeWithSignature(
                        "sell(address,address,uint256,uint256,bytes,uint256)",
                        swap.buyToken, // collateral token
                        swap.sellToken, // debt that we withdrawn
                        swap.sellAmt, // amount of debt withdrawn to swap
                        swap.unitAmt,
                        swap.callData,
                        0
                    )
