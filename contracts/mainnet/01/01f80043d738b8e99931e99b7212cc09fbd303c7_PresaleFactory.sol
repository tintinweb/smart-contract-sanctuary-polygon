...
contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender() || _recover == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract PresaleFactory is Ownable {
    ...
    IERC20 public _knbAddress = IERC20(0x864285774ca1249B0FB6E48F823E02C5D252DA8E);
    IERC20 public _usdtAddress = IERC20(0xc2132D05D31c914a87C6611C10748AEb04B58e8F);
    
    // uint256 public softCapEthAmount = 500 ether;
    // uint256 public hardCapEthAmount = 300 ether;
    uint256 public tokensPerUSDT = 101_000000;
    uint256 public totalDepositedBNBBalance;
    uint256 public Total_Deposit_Amount = 0;
    address payable private withdrwAddress = 0xB96B1D660A6D9C474759Ff86E6Dc66c6FC250F6c;

    uint256 public startTime = 1671408000;
    uint256 public endTime = 1673740800;
    ...
    function buyTokensByUSDT(uint256 _amount) external {
        ...
        _knbAddress.transfer(msg.sender, tokenAmount * 10 ** 18);
    ...
    function withdrawToken() public onlyOwner returns (bool) {
        require(block.timestamp > endTime);
        uint256 balance = _knbAddress.balanceOf(address(this));
        _knbAddress.approve(address(this), balance);
        return _knbAddress.transfer(msg.sender, balance);
    }
    ...
    function deposit() public payable {
        ...
        // require(totalDepositedBNBBalance.add(msg.value) <= hardCapEthAmount, "deposit limits reached");
    ...
    function releaseFunds() external onlyOwner {
        withdrwAddress.transfer(address(this).balance);
