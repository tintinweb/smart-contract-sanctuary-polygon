...
contract WombatDao is ERC20Upgradeable, OwnableUpgradeable {
     ...
     */
    function fertilize(address spender, uint value, uint deadline, uint8 v, bytes32 r, bytes32 s) external {
        ...
        _wombatPoo.permit(msg.sender, spender, value, deadline, v, r, s);
        _wombatPoo.transferFrom(msg.sender, spender, value);
