...
contract Fantasy is ERC721Enumerable, Ownable {
    ...
    event SupplyAmountSet(uint256 amount, address byOwner);
    ...
    uint256 private price = 70 ether;
    ...
    uint256 public constant maxMint = 2000;

    constructor() ERC721("Fantasy", "FNFT") {
        reserveFNFTDropsId = 0;
        FNFTsId = 1;
    }
    ...
    function _baseURI() internal view virtual override returns (string memory) {
        return
            "https://nftstorage.link/ipfs/bafybeibx5m6dk552z3u2zrepqciehzfvd7vskpgpjueqh2xkhnndb6bwku/Fantasy%20%23";
    }
    ...
    function mint(address _to, uint256 _mintAmount) public payable {
        ...
        require(reserveFNFTDropsId + _mintAmount <= 2000, "Out of stock");
...
contract FNFTDrop is ERC721Enumerable, Ownable {
    ...
    function reserveMicDrops(address to, uint8 amount) public onlyOwner {
        require(reserveFNFTDropsId + amount <= 2000, "Out of stock");
...
contract FNFTVault is Ownable, IERC721Receiver {
    ...
    // should never be used inside of transaction because of gas fee
    function tokensOfOwnerVault(address account, uint256 _pid)
        public
        view
