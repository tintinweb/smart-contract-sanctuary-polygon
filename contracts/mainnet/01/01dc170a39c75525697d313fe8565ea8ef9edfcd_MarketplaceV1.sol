...
error InvalidAmount(uint256 required, uint256 passed);
/**
...
contract MarketplaceV1 is Initializable, ERC721Holder, OwnableUpgradeable {
    ...
    function fulfillSellOrder(  
        ...
        // Ensure ETH sent is equal to sell order ask value with fee
         if (sellOrder.ask + marketplaceBuyerFeeValue != msg.value){
            revert InvalidAmount({
                required: sellOrder.ask + marketplaceBuyerFeeValue,
                passed: marketplaceBuyerFeeValue
            });
         }
