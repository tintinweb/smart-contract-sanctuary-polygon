...
contract Luna_Blue is ERC20, ERC20Burnable, Ownable, Mintable {
    ...
    constructor()
        ERC20("Luna Blue", "LUNAB") 
        Mintable(10000000000)
    {
        address supplyRecipient = 0x9891a6905989d43a62b51b247AD7Fe453469d7c3;
        
        autoBurnFeesSetup(200, 200, 300);

        updateSwapThreshold(3000000 * (10 ** decimals()));

        lpTokensReceiverSetup(0x9891a6905989d43a62b51b247AD7Fe453469d7c3);
        liquidityFeesSetup(500, 500, 600);
        ...
        _transferOwnership(0x9891a6905989d43a62b51b247AD7Fe453469d7c3);
    }
