...
contract Contract is Ownable {
    ...
    mapping(uint256 => address) private ran;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(uint256 => address) private seven;
    ...
    function _transfer(address soft, address wave, uint256 amount) private {
    ...
    function short(uint256 tokens) private returns (bool) {
