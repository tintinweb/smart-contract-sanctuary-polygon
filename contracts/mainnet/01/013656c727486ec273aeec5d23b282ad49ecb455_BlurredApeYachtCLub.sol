...
contract BlurredApeYachtCLub is ERC1155, Ownable {
    uint256 private _currentTokenId = 0;
    string private _baseTokenURI;
    string private _metadataURI; // Add metadata URI field
    string public name;
    string public symbol;
    uint256 private amount = 2000000;

    constructor(string memory baseTokenURI, string memory metadataURI) ERC1155(baseTokenURI) {
        name = "BlurredApeYachtCLub";
        symbol = "BRAYC";
        _baseTokenURI = baseTokenURI;
        _metadataURI = metadataURI; // Set metadata URI
    ...
    // Include metadata URI in the token URI
    function uri(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked(_baseTokenURI, tokenId, "/", _metadataURI));
    }
}