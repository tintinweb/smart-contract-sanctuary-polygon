...
contract NFTStudio1089Token3 is ERC721Mintable, ERC721Permit("NFTStudio_1089_3:Token") , Ownable, ERC721URIStorage{
    string public _defaultURI;
    
    event UpdateDefaultURI(string defaultURI);

    constructor() ERC721("NFTStudio_1089_3:Token", "STH") {
        setDefaultURI("https://metadata.nft-studio.com/1089_3/");
    }
