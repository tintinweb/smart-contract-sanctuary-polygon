...
contract GaslessNFT is ERC721, GelatoRelayContext {
    ...
    function mint(address to, uint256 amount, uint256 deadline, uint8 v, bytes32 r, bytes32 s) external onlyGelatoRelay {
        require(address(token) == _getFeeToken(), "GaslessNFT.mint: incorrect fee token");
        ...
        require(fee <= maxFee, "GaslessNFT.mint: insufficient fee");
