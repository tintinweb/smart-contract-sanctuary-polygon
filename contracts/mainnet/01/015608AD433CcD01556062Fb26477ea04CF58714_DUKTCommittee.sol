...
contract DUKTCommittee is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable, EIP712, ERC721Votes {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor()
        ERC721("DUKT Committee ", "DUKT-C")
        EIP712("DUKT Committee ", "1")
    {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://bafkreieybnj7sck2krbumn7wj362apqm25dha5xse5iseaayst76lozs7u.ipfs.nftstorage.link/";
    }
