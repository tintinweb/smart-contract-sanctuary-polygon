...
contract AIP is ERC20, Ownable {
    ...
    constructor () ERC20("Panthera AI", "AIP") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        developmentWallet = 0x3975D75fa7B2a5c15BC3EaD024aFA7cf3565BAAf;
    ...
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        if (canSwap &&
            ...
            swapAndSendDevelopment(swapTokensAtAmount);     
