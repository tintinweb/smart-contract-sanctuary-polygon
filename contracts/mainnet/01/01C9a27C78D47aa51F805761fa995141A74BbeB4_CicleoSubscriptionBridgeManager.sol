...
contract BridgeFacet {
    ...
    function bridgeSubscribe(
        ...
        require(subscriptionId != 0 && subscriptionId != 255, "Invalid Id !");
        ...
        //Save user referrer
        LibPayment.setUserReferral(subscriptionManagerId, msg.sender, referral);
        ...
        emit SelectToken(subscriptionManagerId, msg.sender, paymentToken);
    }
