...
contract WunderProposalZeta {
    ...
    function createJoinProposal(
        ...
        contractAddresses[0] = _governanceToken;
        contractAddresses[1] = msg.sender;

        string[] memory actions = new string[](3);
        actions[
            0
        ] = "swapTokenToGovTokens(address,address,uint256,uint256,bytes)";
        actions[1] = "addMember(address)";
