...
// Girls Riding Things Airdrops (GRTAirdrops.sol)

/*
 *   GRTAirdrops is an ERC-1155 Smart Contract
 *   Deployed on the Polygon Layer-2 Ethereum network
 *   It was created for Girls Riding Things by Ryan Meyers (@sreyeMnayR)
...
// File: GRTAirdrops.sol


// GRTAirdrops (GRTAirdrops.sol)

pragma solidity ^0.8.2;

contract GRTAirdrops is ERC1155, ERC2981, AccessControl, Ownable, Pausable, ERC1155Burnable, ERC1155Supply {
    ...
    constructor() ERC1155("ipfs://QmcspBfz2bPnV9zXQgANxDNsNarXiRVSRCzKJMVk12CJy4/{id}.json") {
