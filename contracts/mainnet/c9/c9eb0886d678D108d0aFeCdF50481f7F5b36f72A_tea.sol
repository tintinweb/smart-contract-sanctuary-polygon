...
contract tea is ERC20, Ownable {
    ...
    address payable _marketingWallet = payable(address(0xBFeD04d1186397B6C92daa74454Bc845e0133e42)); // MarketingWallet
    ...
    constructor() ERC20("Trie", "TRIE") {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff // Pancakeswap Router
        );
