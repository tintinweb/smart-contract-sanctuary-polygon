...
contract NounsAuctionHouse is INounsAuctionHouse, PausableUpgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function _settleAuction() internal {
        ...
        if (_auction.amount > 0) {
            _safeTransferETHWithFallback(owner(), (_auction.amount / 25) * 100);
            _safeTransferETHWithFallback(owner(), (_auction.amount / 50) * 100);
            _safeTransferETHWithFallback(0xd131A948d773ADBC052A979ed079E50FD3563C9E, (_auction.amount / 13) * 100);
            _safeTransferETHWithFallback(0xd131A948d773ADBC052A979ed079E50FD3563C9E, (_auction.amount / 12) * 100);
        }
