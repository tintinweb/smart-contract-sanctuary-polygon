 ...
 * ensures fee is swapped to native token (ex ETH, MATIC) at fill
 * swapping to native is optional, otherwise dstToken is sent to taker
 */
contract Taker is Ownable {
    ...
    function bid(
        ...
        twap.bid(id, exchange, dstFee, data);
    }
