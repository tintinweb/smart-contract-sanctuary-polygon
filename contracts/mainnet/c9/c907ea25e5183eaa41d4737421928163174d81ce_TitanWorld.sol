...
contract TitanWorld is Ownable, ERC721, NonblockingReceiver {

    address public _owner;
    string private baseURI;
    uint256 nextTokenId = 2048;
    uint256 MAX_MINT_POLYGON =3072;
    ...
    constructor(string memory hiddenuri_, address _layerZeroEndpoint) ERC721("TitanWorld", "TW") {
        _owner = msg.sender;
