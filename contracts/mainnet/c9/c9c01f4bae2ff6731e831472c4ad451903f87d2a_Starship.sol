...
contract Starship is IStarship, ERC721EnumerableUpgradeable, WarpBase {
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                ...
                                planet,
                                '"},',
                                URIIntegrityComponents(ship),
                                URIDmgComponents(ship),
                                ']}'
                            )
                        )
                    )
    ...
    function URIDmgComponents(Ship memory ship) internal pure returns (string memory) {
        uint256 totalDmg = ship.bridgeDmg + ship.engineDmg + ship.hullDmg;
        uint256 totalIntegrity = ship.bridgeIntegrity + ship.engineIntegrity + ship.hullIntegrity;

        return
            string(
                abi.encodePacked(
                    '{ "trait_type": "Bridge Damage", "value": "',
                    ship.bridgeDmg.toString(),
                    '", "display_type": "number"},',
                    '{ "trait_type": "Hull Damage", "value": "',
                    ship.hullDmg.toString(),
                    '", "display_type": "number"},',
                    '{ "trait_type": "Engine Damage", "value": "',
                    ship.engineDmg.toString(),
                    '", "display_type": "number"},'
                    '{ "trait_type": "Fuel", "value": "',
                    ship.fuel.toString(),
                    '", "display_type": "number"},',
                    '{ "trait_type": "Ship Integrity", "value": "',
                    (totalIntegrity).toString(),
                    '", "display_type": "number"},'
                    '{ "trait_type": "Current Integrity", "value": "',
                    (totalIntegrity - totalDmg).toString(),
                    '", "display_type": "number"}'
                )
            );
    }

    function URIIntegrityComponents(Ship memory ship) internal pure returns (string memory) {
        return
            string(
                abi.encodePacked(
                    '{ "trait_type": "Hull Integrity", "value": "',
