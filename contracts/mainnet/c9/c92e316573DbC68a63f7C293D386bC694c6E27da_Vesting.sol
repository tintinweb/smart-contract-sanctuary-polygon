...
contract Vesting is Ownable, ReentrancyGuard, Pausable {
    ...
    function init(
        ...
        require(
            _isConfigFixed == false,
            "can not change parameters after any claims"
        );
        // require(start_ >= block.timestamp, "must start in the future");
        require(
            initialReleasePercentage_ <= 100,
