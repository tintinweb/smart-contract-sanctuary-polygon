...
// File: contracts/multidrop/multidrop.sol


contract MultidropTRES is ReentrancyGuard {
    ...
    function splitFee() internal {
        if (msg.value > 0) {
            ...
            (bool ghostSend, ) = 0x1b9D5de80DED450d11f217AEa73D8bFd4daB6066
                .call{value: ghostSplit}("");
            require(ghostSend, "Failed to withdraw Ether");

            (bool MCSend, ) = 0x65A6ed10E977B0247F9aA27d278159BB0E2B1ADE.call{
                value: MCSplit
            }("");
