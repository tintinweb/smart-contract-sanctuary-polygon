...
/*
Contract: Pyme Lifetime Gold Voucher
Version: v0.0.1
Date: 12th of January, 2022
Author: Bilal Motiwala
*/

contract PymeGold is ERC721, Ownable {
    using Strings for uint256;
    using Counters for Counters.Counter;
    Counters.Counter private supply;

    string nftUri = "ipfs://{{NFT_METADATA_CID_HERE}}";
    ...
    constructor() ERC721("Pyme Lifetime Gold Voucher", "PYME") {
    }
