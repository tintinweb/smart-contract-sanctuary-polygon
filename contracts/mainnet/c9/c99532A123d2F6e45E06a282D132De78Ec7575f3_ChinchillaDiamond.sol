...
contract ChinchillaDiamond is ERC721, Ownable {
    constructor() ERC721("Chinchilla Diamond", "CHINCHILLADIAMOND") {}
    ...
    returns (string memory)
    {
        ...
        string memory json = Base64.encode(
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "Chinchilla Diamond NFT", "description": "This NFT represents participation in Chinchilla.", "image": "data:image/svg+xml;base64,',
