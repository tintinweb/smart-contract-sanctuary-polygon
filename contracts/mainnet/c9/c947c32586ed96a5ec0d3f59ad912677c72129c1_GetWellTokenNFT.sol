...
contract GetWellTokenNFT is ERC1155("https://getwelltoken.nft4all.com/metadata/{id}.json") {
  bool public publicMint = false;
  uint256 public mintPrice = 1000 ether;

  uint256 public supplyCount = 0;
  uint256 public supplyMax = 600000;

  address public minterAddress = 0x0000000000000000000000000000000000000000;

  string public name = "Get Well Token";
  string public symbol = "NFUT";

  function setURI(string memory newURI) public virtual onlyOwner {
    _setURI(newURI);
  }

  function setPublicMint(bool publicMint_) public onlyOwner {
  ...
  function setSupplyMax(uint256 supplyMax_) public onlyOwner {
  ...
  function mint(address to) public payable {
    ...
    if (_msgSender() != owner() && _msgSender() != minterAddress) {
  ...
  function withdraw() external payable {
    require(_msgSender() == owner(), "Ownable: caller not authorized");
