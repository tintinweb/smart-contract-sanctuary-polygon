...
/**
 *Submitted for verification at polygonscan.com on 2022-08-2
*/
...
contract Test {
	...
	uint constant public			INVEST_MIN_AMOUNT				= 2 ether;				// 2 MATIC
	uint[] public					REFERRAL_PERCENTS				= [50, 40, 30, 20, 10];	// 5% 4% 3% 2% 1%
	uint constant public			PROJECT_FEE						= 20;					// Smart Contract Audit & Marketing fee 2% of Deposit
	uint constant public			PROJECT2_FEE					= 20;					// Dev fee 2% of deposit 
	uint constant public			DEV_FEE							= 20;					// CEO fee 2% of deposit
