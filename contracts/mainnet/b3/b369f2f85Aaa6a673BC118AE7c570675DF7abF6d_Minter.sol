...
contract Minter is ReentrancyGuard, AccessControl{
    ...
    constructor(address _tree, address _cause){
        tree = ITree(_tree); 
        cause = ICauses(_cause);
        reserve = _owner;
        tokens.push();
        _setupRole(ADMIN_ROLE, _owner);
		_setupRole(GATEWAY_ROLE, _owner);
