...
contract BaseSample is GasHelper, ERC20 {
  string public constant URL = "https://www.BaseSample.com";
  ...
  string constant NAME = "BaseSample";
  string constant SYMBOL = "BaseSample";
