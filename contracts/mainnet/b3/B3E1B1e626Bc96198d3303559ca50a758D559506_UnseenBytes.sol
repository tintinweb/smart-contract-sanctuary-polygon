...
// File: contracts/UnseenBytes.sol
...
contract UnseenBytes is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Unseen Bytes", "UNXBXX") {
    setHiddenMetadataUri("ipfs://QmQKFqAs7MfN1K4SiL4YtBqqusX9JcJwzERJAsQxe99gw4/hidden.json");
  }
