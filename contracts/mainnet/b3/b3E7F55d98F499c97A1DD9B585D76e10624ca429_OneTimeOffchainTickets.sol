...
/**
 * @dev Use binary claims/tickets signed off-chain by validator wallet, to distribute one-time rewards.
 */
contract OneTimeOffchainTickets is AbstractConditionOracle {
    ...
    /**
     * @dev Constructor allows setting an initial configuration and consumer contract.
...
/**
 * @dev EIP712 helpers to check off-chain signatures.
 */
library EIP712 {
    /**
