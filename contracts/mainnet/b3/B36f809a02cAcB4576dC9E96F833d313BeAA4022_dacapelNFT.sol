...
contract dacapelNFT is ERC721, ERC721Enumerable, AccessControlEnumerable, IERC2981Royalties {
    ...
    constructor(string memory _theBaseURI) ERC721("dacapelNFT", "NFT") {
    ...
    function _setTokenRoyalty(
        ...
        require(creators.length > 0, "dacapelNFT: Must have creators");
        require(creators.length == royaltyPercent.length, "dacapelNFT: Length mismatch");
        uint256 totalPercent;
