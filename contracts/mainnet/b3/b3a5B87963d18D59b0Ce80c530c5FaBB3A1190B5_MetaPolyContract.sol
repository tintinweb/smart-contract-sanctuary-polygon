...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x29EfCe783955fe14Efc0692A4924cB71f6610C96];
  address public erc20Payable = 0x29EfCe783955fe14Efc0692A4924cB71f6610C96;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 33, 2090) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmQk5KvdvQycqQkwbWPfKEGrnpoTQv7jckTYJMs4WjNCPD/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/QSHXEbp3gUJ00aoUdZGF/contract-metadata";
  }
...
// File: contracts/MetaPolyContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MetaPolyContract is ERC721APlus {
    constructor() ERC721APlus("MetaPoly", "MtpOG"){}
}
  /*******************************************************/
  /*                                                     */
