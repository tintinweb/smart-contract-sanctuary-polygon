...
contract CROWDMATIC {
    ...
    event Investment(address indexed userwallet,uint256 amountbuy,address refadd);
    event LevelIncome(address indexed user,address fromuser,uint256 income,uint8 level,uint256 package);
