...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x1F833F27C022dd24AEfcC41F71880Ab9A8Ff5291];
...
// File: contracts/Dl3ArnContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract Dl3ArnContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "DL3ARN";
    string public symbol = "DL3ARN";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/gCeYXOLxSGH7JpRyQQCJ/contract-metadata";
  }
