...
contract DoppioSwap {
   ...
   event AmmontareRicevuto(uint256 _ammontare);
    ...
    function swapExactInputSingle(uint256 amountIn) external returns (uint256 amountOut) {
        ...
        path[0] = DAI;
        path[1] = WMATIC;
        amountOut = QuickIV2SwapRouter(QuickROUTER).swapExactTokensForTokens(amountIn, 0, path, address(this), 115792089237316195423570985008687907853269984665640564039457584007913129639935);
        ...
        path[0] = WMATIC;
        path[1] = DAI;
        amountOut = UniIV2SwapRouter(UniROUTER).swapExactTokensForTokens(amountOut, 0, path, msg.sender);
