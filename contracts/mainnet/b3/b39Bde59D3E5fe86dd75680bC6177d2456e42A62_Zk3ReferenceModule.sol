...
/**
 * @title Zk3 Reference Module
 * @author Zk3.io
 *
 * @notice A simple reference module that validates the embedded zk proof within Lens posts, comments, and mirrors.
 */
contract Zk3ReferenceModule is ModuleBase, IReferenceModule {
    ...
    /**
     * @dev When a user creates a post, the zk proof is validated.
     * @param profileId The profile ID of the profile that is creating the post.
     * @param pubId The publication ID of the publication that is being posted.
     * @param data The data that is being passed to the module. This is the Zk3InitData.
     */
    ...
    /**
     * @notice Validates that the comment has a valid zk proof from the same circle as the original post.
     * @param profileId The profile ID of the profile that is commenting.
     * @param profileIdPointed The profile ID of the profile that is being commented on.
     * @param pubIdPointed The publication ID of the publication that is being commented on.
     * @param data The data that is being passed to the module.
     */
    ...
    /**
     * @notice Validates that the comment has a valid zk proof from the same circle as the original post.
     * @param profileId The profile ID of the profile that is mirroring the post.
     * @param profileIdPointed The profile ID of the profile that is being mirrored.
     * @param pubIdPointed The publication ID of the publication that is being mirrored.
     * @param data The data that is being passed to the module.
     */
