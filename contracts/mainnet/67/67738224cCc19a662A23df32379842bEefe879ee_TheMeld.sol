...
contract TheMeld is Ownable, ERC721, NonblockingReceiver {
    ...
    function traverseChains(uint16 _chainId, uint tokenId) public payable {
        ...
        require(msg.value >= messageFee, string(abi.encodePacked("You have to send some/more MATIC to cover traversal gas fee estimate. You will be refunded the difference. Estimate: ", Strings.toString(messageFee))));
