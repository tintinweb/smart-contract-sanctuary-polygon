...
library TidePoolMath {
    ...
    function getWindowSize(int24 _previousWindow, uint256 _lastRebalance, bool _outOfRange) public view returns (int24 windowSize) {
        uint256 diff = (block.timestamp - _lastRebalance) / 1 days;
        windowSize = _outOfRange ? _previousWindow + 4 : _previousWindow - int24(diff);
