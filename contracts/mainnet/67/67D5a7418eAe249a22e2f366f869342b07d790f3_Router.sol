...
contract Router is Ownable {
    ...
    */
    function swap(uint256 _adapterIndex, address _fromToken, uint256 _fromAmount, address _toToken, bytes memory _swapCallData) public payable {
        ...
        if (_fromToken != NATIVE) {
            ...
            IERC20(_fromToken).safeTransferFrom(msg.sender, address(adapters[_adapterIndex].deployedContract), swapInputAmount);
    ...
    */
    function ftatSwapWithPermit(
        ...
        emit Swap(_adapterIndex, msg.sender, ftatInputToken, _swapInputAmount, _toToken, toAmount, true);
    }
