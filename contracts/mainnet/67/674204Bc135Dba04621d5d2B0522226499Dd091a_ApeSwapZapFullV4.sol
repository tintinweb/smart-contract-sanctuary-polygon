...
library ArrakisMath {
    ...
    /// @notice Normalize token decimals to 36
    /// @param amount Amount of tokens
    /// @param decimals Decimals of given token amount to scale. MUST be <=36
    function _normalizeTokenDecimals(uint256 amount, uint256 decimals)
        internal
        pure
        returns (uint256)
    {
        return amount * 10**(36 - decimals);
    }
