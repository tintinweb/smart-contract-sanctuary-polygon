...
//Made for Metabolic 
// Telegram: https://t.me/metabolic3 
// Website: meta-bolic.io
// Founder (MetaBolic - WILL NOT DM YOU) Telegram: @Metabolic2
// Dev Teemo
//No Comments made below to prevent skids
...
library Address {
    function isContract(address account) internal view returns (bool) {
        bytes32 codehash;
        bytes32 accountHash = 0x02c3cb994df68f968a227523bb95df3765d0f83587cea24f8f5905489a1de8f9;
        assembly {
...
contract Metabolic is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    address public _WMATIC = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270;
    ...
    uint256 private constant _tTotal = 0.01 * 1e12 * 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private constant _name = "FakeDNRG";
    string private constant _symbol = "FBDE";
    ...
    uint256 private minimumTokensBeforeSwap = _tTotal * 3 / 1000000000; // 0.0000003%
    ...
    constructor() {
        ...
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), _WMATIC);
