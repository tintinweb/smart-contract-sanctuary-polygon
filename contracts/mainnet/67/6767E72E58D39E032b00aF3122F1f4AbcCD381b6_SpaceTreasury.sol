...
contract SpaceTreasury is ContractGuard {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;

    /* ========= CONSTANT VARIABLES ======== */
    uint256 public constant PERIOD = 300;
    ...
    uint256 public bootstrapSupplyExpansionPercent = 200;
    ...
    modifier checkOperator() {
        require(
            Operator(mainToken).operator() == address(this) &&
    ...
    function allocateSeigniorage() external onlyOneBlock checkCondition checkEpoch checkOperator {
        ...
        if (rebaseStarted && previousEpochMainPrice < mainTokenPriceOne) {
            ...
            rebaseStarted = false;
            // twap <= 0.8 aUSDC => rebase
            // {consecutiveEpochHasPriceBelowOne} consecutive epoch has twap < 1 aUSDC => rebase
