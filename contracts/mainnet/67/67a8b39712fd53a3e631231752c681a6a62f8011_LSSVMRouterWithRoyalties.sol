...
import {PoolType} from "./PoolType.sol";
...
import {CurveErrorCode} from "./bonding-curves/CurveErrorCode.sol";
import {ERC1155Holder} from "../../lib/openzeppelin-contracts/contracts/token/ERC1155/utils/ERC1155Holder.sol";
import {IUpshotPool} from "../upshot/interface/IUpshotPool.sol";
...
import {CurveErrorCode} from "./CurveErrorCode.sol";
...
import {PoolType} from "../../sudoswap/PoolType.sol";
...
// this file is annoyingly, frustratingly necessary because you cannot override the constant variable ROYALTY_REGISTRY
// and we need the polygon deployment of the registry which for whatever reason manifold's team was not competent enough
// to deploy on the same address
...
import {LSSVMRouter, IERC721, ERC20, SafeTransferLib, LSSVMPair, ILSSVMPairFactoryLike, CurveErrorCode} from "../../contracts/sudoswap/LSSVMRouter.sol";
import {LSSVMPairERC20} from "../../contracts/sudoswap/LSSVMPairERC20.sol";
...
contract LSSVMRouterWithRoyalties is LSSVMRouter {
    ...
    IRoyaltyRegistry public constant ROYALTY_REGISTRY =
        IRoyaltyRegistry(0xe7c9Cb6D966f76f3B5142167088927Bf34966a1f);
