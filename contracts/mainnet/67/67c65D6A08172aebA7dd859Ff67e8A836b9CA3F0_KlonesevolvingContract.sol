    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 117) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeicvbly7w5io234lpnmsfnrgayduadkouqzzdvtkyjofnytaozvyr4/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/84ZgkU6KJz8mGptpOZC2/contract-metadata";
  }
...
// File: contracts/KlonesevolvingContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract KlonesevolvingContract is ERC721APlus {
    constructor() ERC721APlus("KLONES EVOLVING", "KEV"){}
}
  /*******************************************************/
  /*                                                     */
