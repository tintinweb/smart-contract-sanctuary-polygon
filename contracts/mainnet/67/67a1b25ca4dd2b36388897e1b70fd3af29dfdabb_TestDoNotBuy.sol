...
contract TestDoNotBuy is ERC20, ERC20Burnable, Ownable {
    uint256 BURN_TIMER = 5 minutes;
    uint256 LAUNCH_TIME;
    uint256 public purchaseTax = 5;
    uint256 public sellTax = 5;
    uint256 public burnTax = 25;
    address public _uniswapV2Router = 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff;
    uint256 constant MAX_WALLET_PERCENTAGE = 5; 
    uint256 constant MAX_TX_PERCENTAGE = 2; 
    uint256 constant SWAP_TOKENS_AT_AMOUNT_PERCENTAGE = 2;
    ...
    constructor() ERC20("TESTDONOTBUY", "\xF0\x9F\x9A\x80 \xF0\x9F\x93\x88 \xF0\x9F\x92\xB0") {
    ...
    function burnIfInLaunch(uint256 amount) internal returns (uint256) {
        if (_msgSender() == uniswapV2Pair) {
            uint256 currentTime = block.timestamp;
            uint256 timeSinceLaunch = currentTime - LAUNCH_TIME;
            if (timeSinceLaunch < BURN_TIMER) {
    ...
    function adjustBurnTax(uint256 newBurnTax) external onlyOwner {
        require(newBurnTax <= 10, "Burn tax cannot be more than 10%");
        burnTax = newBurnTax;
    }
