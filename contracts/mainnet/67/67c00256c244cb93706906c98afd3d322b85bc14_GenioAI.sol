...
contract GenioAI{ 
    ...
    function updateStates(address _upline, address _donor) internal superGenio{
       ...
       if(traject[upline_new][0].leftDNA == 0){ 
           ...
           //select leftDNA and Update left_leg Traject[]
           uint LEFT =  traject[upline_new][0].leftDNA;
           traject[upline_new][0].left_leg = traject[LEFT][0].myaddress;  
           ...
           //select leftDNA and Update right_leg Traject[]
           uint RIGHT =  traject[upline_new][0].rightDNA;
           traject[upline_new][0].right_leg = traject[RIGHT][0].myaddress;  
