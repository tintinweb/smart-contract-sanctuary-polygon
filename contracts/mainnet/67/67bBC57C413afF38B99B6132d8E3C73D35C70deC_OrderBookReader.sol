    ...
    function getDecreaseOrders(
        ...
        while (vars.i < _indices.length) {
            vars.index = _indices[vars.i];
             ...
             try  orderBook.getDecreaseOrder(vars.account, vars.index) returns (address collateralToken, uint256 collateralDelta, address indexToken, uint256 sizeDelta, bool isLong, uint256 triggerPrice, bool triggerAboveThreshold, uint256 executionFee) {
                ...
                uintProps[vars.i * vars.uintLength] = 0;
                uintProps[vars.i * vars.uintLength + 1] = 0;
                uintProps[vars.i * vars.uintLength + 2] = 0;
                uintProps[vars.i * vars.uintLength + 3] = 0;
                uintProps[vars.i * vars.uintLength + 4] = 0;

                addressProps[vars.i * vars.addressLength] = address(0);
                addressProps[vars.i * vars.addressLength + 1] = address(0);
              }
