...
contract EthDenverBadge is ERC721, ERC721URIStorage, AccessControl {
    ...
    uint256 public immutable maxSupply; // 7
    ...
    constructor(address childChainManager) ERC721("EthDeneverBadge", "EDB") {
    ...
    function airdrop(address _to) external onlyRole(MINTER_ROLE) {
        require(_tokenIdCounter.current() < maxSupply, "MAX_SUPPLY_REACHED");
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://QmUMr5iA4jb6kWwJK1PexboMWTeHDSeT4hShxSENLLqVHL/";
    }

    // support polygon mintable asset
    ...
    {
        require(!withdrawnTokens[tokenId], "TOKEN_EXISTS_ON_ROOT_CHAIN");
        _mint(user, tokenId);
    }
