...
/** Davide Lacerenza Ginto Club
 * @title Counters
 * @author SilkBoard (@silk.board)
...
contract GintoCardMembership is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("Ginto Card Membership", "GCM") {}
