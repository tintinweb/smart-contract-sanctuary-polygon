...
contract X2OrNothing is VRFConsumer, OwnableUpgradeable, IX2OrNothing {
     ...
     */
    function changeVrf(address newVrf, uint64 newConsumerId)
        external
        onlyOwner
    {
        ...
        emit VrfChanged(newVrf, newConsumerId);
    }
...
interface IX2OrNothing is IOwnable {
    ...
    event VrfChanged(address newVrf, uint64 newCondumerId);
    ...
    function changeVrf(address newVrf, uint64 newConsumerId) external;
