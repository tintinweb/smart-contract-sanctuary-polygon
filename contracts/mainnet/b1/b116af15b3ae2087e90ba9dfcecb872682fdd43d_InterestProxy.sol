...
//// Commissioned by Fishy#0007 on 6/17/2022
    ...
    VaultController Vault = VaultController(0x385E2C6b5777Bc5ED960508E774E4807DDe6618c);
    uint VaultID;
    uint bounty;
    uint public MINLTV;
    ...
    constructor(){
        ...
        admin = msg.sender;
        VaultID = 28; // <------- MAKE SURE THIS IS RIGHT!!!!!!!
        MINLTV = 60;
    }
    ...
    function CalculateLTV() public view returns(uint){
        ...
        Vault.vaultLiability(VaultID);
        Vault.vaultBorrowingPower(VaultID);
