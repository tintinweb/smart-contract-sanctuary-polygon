...
Rhyot Genesis Music NFT Collection 
Smart contract written by rhyot.eth in Dec 2022 - Jan 2023
...
RHYOT
    web: https://officialrhyot.com
    ens: rhyot.eth
    social: @Rhyot or visit https://solo.to/rhyot

BIO:
    Rhyot is an American-Canadian electronic musician known for his dark, cinematic, and dystopian style. 
    Drawing influence from techno, electro, industrial, and progressive electronica, Rhyot creates evocative 
    and thought-provoking music that has earned him a growing following and critical acclaim.

RELEASE INFO:
    "Genesis" is a powerful and evocative track that showcases Rhyot's unique blend of electro, industrial, and progressive electronica influences. 
    This epic single calls back to Rhyot’s creative origins, recounts the journey, and welcomes the conclusion of a metaphorical chapter, 
    signalling a reflective departure from the past and a contemplative yearning for the future.
    
    Label: Emercive Recordings Limited
    Catalogue No: EMRCV032
    Release: Genesis
    Artist: Rhyot
    ...
    Stream and download "Genesis" at https://lnk.to/emrcv032.
    Emercive Recordings online https://emercive.com or @Emercive on socials
*/    
...
// File: contracts\RhyotGenesisNFT.sol
    ...
    Ownable
{
    ...
    /// Constructor
    constructor() ERC721("Rhyot Genesis Music Collection", "RHYGEN") {
        _tokenIdCounter.increment();
    }

    // Set the base URI for the collection to the json folder in IPFS
    function _baseURI() internal pure override returns (string memory) {
        return "https://ipfs.filebase.io/ipfs/QmctgvWnAbgkPMz4tgNRXHxt6XhhBrSdRVspkY9Zm45hzt/";
    }
    ...
    function safeMintBatch(address to, uint256 batchSize) public onlyOwner {
        ...
        // Check if the total number of NFTs plus the batch size is greater than the maximum supply
            require(_tokenIdCounter.current() + batchSize -1 <= MaxSupply, "Minting this batch would exceed the maximum supply");
...
/*
Ok dude, holy hell, this is the end. What are you expecting to find in here? Nuclear launch codes? Onlyfans link? Personal fulfilment?

You're gonna have to settle for free download codes for Genesis on Bandcamp:
    
    Step 1: go to https://rhyot.bandcamp.com/yum
    
    Step 2: enter one of the codes below - if the one you enter is already redeemed, try another! Good luck!
...
That'll save you about $3. Know what's crazy? That's the equivalent to over 700 streams on Spotify. F*cked, right?

Thanks for buying the NFT, downloading on Bandcamp, and supporting my music. Give me a shout on socials @Rhyot. 
