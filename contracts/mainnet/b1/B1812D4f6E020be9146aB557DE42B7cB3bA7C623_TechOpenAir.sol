...
/**
 * @title Tech Open Air ERC721A Smart Contract
 */
contract TechOpenAir is ERC721A, BaseTokenV2, AuthorizerV1 {
    constructor(
    ...
    uint256 public constant MINT_LIMIT_PER_ADDRESS = 1000;
    ...
    /**
     * @dev Open3 Qualified Airdrop, triggers a mint based on the amount to the sender
     */
    function qualifiedAirdrop(
        address to_,
        uint256 amount_,
        ...
        require(
            qualifiedWalletList[to_] + amount_ <= MINT_LIMIT_PER_ADDRESS,
        ...
        requireRecovery(to_, nonce_, signature_);

        qualifiedNonceList[nonce_] = true;
        qualifiedWalletList[to_] += amount_;
