...
contract SameTokenConverter {
    using SafeERC20 for IERC20;

    address public assetConverter;

    constructor(address _assetConverter) {
    ...
    function swap(
        ...
        require(source == destination, "this converter only swaps between same tokens");
        IERC20(source).safeTransfer(beneficiary, value);
        return value;
    }
