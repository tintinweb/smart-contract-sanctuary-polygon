...
contract NftMarket is IERC721Receiver, ReentrancyGuard, Ownable {
    ...
    constructor(address payable _feeReceiver, uint256 _feeRate) public payable{
        ...
        payable
    {
        ...
        if (obj.currency == address(0x0) || obj.currency == address(0x0000000000000000000000000000000000001010)) {
