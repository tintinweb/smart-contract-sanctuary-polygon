...
contract HUMAN is ERC1155, Ownable {
    string public name = "human";
    string public symbol = "hyu";


    constructor() ERC1155("https://gateway.pinata.cloud/ipfs/QmX7LojQQH93VAE6E8eqhcXMSmZpqwkA89WdUqtP8Mt3CF") {
    }
