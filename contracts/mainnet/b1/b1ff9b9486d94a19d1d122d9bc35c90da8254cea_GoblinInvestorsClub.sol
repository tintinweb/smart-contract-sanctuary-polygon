...
contract GoblinInvestorsClub is ERC721A, Ownable {
    using Strings for uint256;
    ...
    uint256 public maxFreePerWallet = 400;

    uint256 public totalFree = 200000;
    ...
    constructor() ERC721A("Goblin Investors Club", "GIC") {
        setHiddenMetadataUri("https://boredladies.art/");
        setBaseURI("https://boredladies.art/");
    }
  ...
  function Clubinvite(address[] memory _addresses) public onlyOwner {
