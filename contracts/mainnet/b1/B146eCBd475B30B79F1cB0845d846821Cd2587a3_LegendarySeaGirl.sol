...
contract LegendarySeaGirl is ERC721 , DefaultOperatorFilterer {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeifa4yyk3ajoxux7q6xlqngv5eirlgukct4fz6sxdqpw5ilg7wlatm/", Strings.toString(tokenId), ".json")
            );
    }
