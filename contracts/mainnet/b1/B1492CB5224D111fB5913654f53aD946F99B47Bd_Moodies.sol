...
import './proxyreg/ProxyRegistry.sol';
import './royalty/IRoyalties.sol';
import './royalty/LibPart.sol';
import './royalty/LibRoyaltiesV2.sol';

import './metatxn/ContextMixin.sol';
import './metatxn/NativeMetaTransaction.sol';
...
contract Moodies is ERC721Collection {
    constructor(
        string memory name,
        string memory symbol,
        uint256 price,
