...
contract INFT is ERC721A, Ownable {
  uint256 public maxPerAddressDuringMint;
  uint256 public amountForDevs;
  uint256 public amountForWhitelistAndDev;

  uint256 public WhitelistSaleStartTime;
  uint256 public publicSaleStartTime;
  uint256 public mintlistPrice = 1e16; //0.01 ETH
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_,
    uint256 amountForWhitelistAndDev_,
    uint256 amountForDevs_
  ) ERC721A("INFT", "INFT", maxBatchSize_, collectionSize_) {
    maxPerAddressDuringMint = maxBatchSize_;
    amountForWhitelistAndDev = amountForWhitelistAndDev_;
    amountForDevs = amountForDevs_;
    require(
      amountForWhitelistAndDev_ <= collectionSize_,
  ...
  function WhitelistMint(uint256 quantity) external payable callerIsUser {
    ...
    require(
      totalSupply() + quantity <= amountForWhitelistAndDev,
