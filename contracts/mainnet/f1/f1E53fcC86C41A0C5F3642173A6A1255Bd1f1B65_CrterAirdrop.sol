...
contract CrterAirdrop is ERC721Enumerable, Ownable {
    ...
    constructor (string memory _URI) ERC721("Crter Postcard Airdrop", "CPA") {
        setRevealedWithURI(_URI, "");
    }
    ...
    function airdrop(address[] memory _addresses) public onlyOwner {
        ...
        for (uint i = 0; i < _addresses.length; i++) {
            _safeMint(_addresses[i], (_supply + i + 1));
        }
    }
