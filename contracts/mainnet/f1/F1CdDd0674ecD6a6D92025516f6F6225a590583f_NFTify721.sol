...
// File: contracts/experiments/collections/IERC721Permit.sol
...
// File: contracts/experiments/collections/ERC721Permit.sol
...
// File: contracts/experiments/collections/NFTify721.sol
...
contract NFTify721 is Ownable, Pausable, ERC721Permit, ERC721Enumerable {
    ...
    // * EVENTS
    event Mint(address indexed account, uint256 id, string internalTxId);
    ...
    function mint(
        ...
        // TODO: consider to add a `Mint` event in this function
        emit Mint(account, id, string(data));
    }
    ...
    function burn(uint256 id) public virtual {
        ...
        // TODO: consider to add a `Burn` event in this function
        emit Burn(ownerOf(id), id);
    }
