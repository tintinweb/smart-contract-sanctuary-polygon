...
contract IOCGENESIS is ERC721, Ownable, RoyaltiesV2Impl {
    using Strings for uint256;
    
    uint256 public PRICE = 0; 
    uint256 public PRICE150 = 170000000000000000000;
    uint256 public PRICE800 = 210000000000000000000;
    uint256 public constant MAXNFT = 1000;
    uint256 public lastTokenId = 0; 

    bytes4 private constant _INTERFACE_ID_ERC2981 = 0x2a55205a;

    constructor() ERC721("IOCGENESIS", "IOC") {}

    function mint(uint256 tokenId) public payable {
        require(tokenId < MAXNFT, "Purchase would exceed max supply of NFT");
        ...
        setRoyalties(tokenId, payable(owner()), 1000); // 1000 = 10%
        lastTokenId = tokenId;
    }

    function _baseURI() internal view virtual override returns (string memory) {
        return "https://nft.imitationofchristofficial.com/meta/";
    }
