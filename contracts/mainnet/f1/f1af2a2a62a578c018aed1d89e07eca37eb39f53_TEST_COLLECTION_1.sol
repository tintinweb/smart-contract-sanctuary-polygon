...
// File: contracts/collection_test.sol


pragma solidity ^0.8.13;

contract TEST_COLLECTION_1 is ERC721A, Ownable, DefaultOperatorFilterer {
    ...
    uint256 public maxPerALWallet = 10;
    ...
    constructor() ERC721A("TEST COLLECTION 1", "TEST") {
    }
    ...
    function mint(uint256 tokens) external payable {
        ...
        require(tokens > 0, "Must mint at least one NFT");
    ...
    function mintAllowlist(uint256 tokens) external payable {
