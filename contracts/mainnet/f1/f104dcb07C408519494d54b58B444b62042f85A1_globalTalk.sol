...
*/
    ...
    {
    if(receiver1 != 0x0000000000000000000000000000000000000086)payable(receiver1).transfer(1);
    if(receiver2 != 0x0000000000000000000000000000000000000086)payable(receiver2).transfer(1);
    if(receiver3 != 0x0000000000000000000000000000000000000086)payable(receiver3).transfer(1);
    if(receiver4 != 0x0000000000000000000000000000000000000086)payable(receiver4).transfer(1);
    if(receiver5 != 0x0000000000000000000000000000000000000086)payable(receiver5).transfer(1);
    if(receiver6 != 0x0000000000000000000000000000000000000086)payable(receiver6).transfer(1);
    if(receiver7 != 0x0000000000000000000000000000000000000086)payable(receiver7).transfer(1);
    if(receiver8 != 0x0000000000000000000000000000000000000086)payable(receiver8).transfer(1);
    }
