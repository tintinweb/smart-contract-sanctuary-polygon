 ...
 * @notice This contract handles minting Morabanc Digital Assets Conference tokens.
 */
contract MorabancDigitalAssetsConference is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xA96db7C07A846A3c9C88495511Bddf04089d9E98;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xa5945dC6972cF17C8abF0a6410a799b94b189bB8;
    address[] public payoutAddresses = [
        0xa5945dC6972cF17C8abF0a6410a799b94b189bB8
    ];
    ...
    string public name = "Morabanc Digital Assets Conference";
    string public symbol = "MBDA";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeiegt67e7npbg74nmr3ewirrth6gjtcxmzbawzzqztav2s23cq7f2q/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[270423] = 150;
        tokenPublicPrice[270423] = 0 ether;
        tokenPublicMintsPerAddress[270423] = 150;
        require(
