...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 PEPE = IERC20(0xdAC17F958D2ee523a2206206994597C13D831ec7);
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619);
        _token = msg.sender;
    }
...
contract CerberPepe is IERC20, Auth {
    ...
    string constant _name = "CerberPEPE";
    ...
    uint256 public reflectionFee   = 250;
    uint256 public marketingFee    = 250;
    uint256 public DEVFee          = 250;
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        ...
        require(totalFee < feeDenominator/3, "Fees cannot be more than 33.333333333333333333333333333333333333333333333333333333333%");
    }
