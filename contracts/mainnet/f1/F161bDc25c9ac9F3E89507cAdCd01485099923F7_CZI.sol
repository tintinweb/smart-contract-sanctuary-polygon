...
contract CZI is CZIDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private CZITeam;
    address private CharityCZI;
    ...
    string public override name = "CATZILLA INU";
    string public override symbol = "CZI";
    ...
    constructor(uint totalSupplyValue, address CZITeamAddress, address CharityCZIAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        CZITeam = CZITeamAddress;
        CharityCZI = CharityCZIAddress;
        
        // split the tokens according to agreed upon percentages
        balances[CZITeam] =  totalSupply * 4 / 100;
        balances[CharityCZI] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's CZITeam pot
