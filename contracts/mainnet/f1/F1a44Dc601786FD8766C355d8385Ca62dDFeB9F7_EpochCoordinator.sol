...
// hevm: flattened sources of src/EpochCoordinator.sol
...
abstract contract AssessorLike_1 is FixedPoint {
    // definitions
...
contract EpochCoordinator is Auth, Math, FixedPoint {
    ...
    function depend (bytes32 contractName, address addr) public auth {
        if (contractName == "juniorTranche") { juniorTranche = TrancheLike_1(addr); }
        else if (contractName == "seniorTranche") { seniorTranche = TrancheLike_1(addr); }
