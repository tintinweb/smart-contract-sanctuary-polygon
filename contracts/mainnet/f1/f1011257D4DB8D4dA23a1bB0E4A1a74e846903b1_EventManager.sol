...
contract EventManager is Ownable {
    ...
    mapping(uint256 => string) eventNames;
    mapping(uint256 => address) eventCoordinators;
    mapping(uint256 => uint256) eventPrices;
    mapping(uint256 => address) eventContracts;
    mapping(uint256 => uint256) eventIndexes;
