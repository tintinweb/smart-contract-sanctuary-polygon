...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x0142B27B469bb2bb1257D8e077EFd6d8b666CF1e];
  address public erc20Payable = 0x0142B27B469bb2bb1257D8e077EFd6d8b666CF1e;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 31415, 31415) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeier5qnbosul7z4plbtbxypd3odk726f6ggnxlrhtlwq76r3yhwdsa/";
    string public _baseTokenExtension = ".json";

    bool public mintingOpen = false;
    
    
    uint256 public MAX_WALLET_MINTS = 31415;
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/2bdBaHhAltrRqks1fwu1/contract-metadata";
  }
...
// File: contracts/PiDkdaoContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PiDkdaoContract is ERC721APlus {
    constructor() ERC721APlus("PiDKDAO", "PiDB"){}
}
