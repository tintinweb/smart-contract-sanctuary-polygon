...
/// @title NarfexToken v2 (FOR TESTING ONLY!!! mint is open for owner)
/// @author Vladimir Smelov
contract MockNarfexToken is NarfexToken {
    constructor(address oldToken_, address masterChef_) NarfexToken(oldToken_, masterChef_) {
    }
