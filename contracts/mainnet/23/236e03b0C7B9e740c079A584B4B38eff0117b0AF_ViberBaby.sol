...
contract ViberBaby is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Viber Baby", "VBVB") {
    setHiddenMetadataUri("ipfs://QmZnx1JcFPaAsCdMhuLBgC7SNttw4RpmWEn1Aw59MoErDi/hidden.json");
  }
