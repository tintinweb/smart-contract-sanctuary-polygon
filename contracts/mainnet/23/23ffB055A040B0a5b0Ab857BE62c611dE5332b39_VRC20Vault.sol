...
contract VRC20Vault is ERC20, Ownable, ReentrancyGuard {
    ...
    /// @dev Update withdrawal fees for Vault
    /// @param _fee updated withdrawal fee
    function updateWithdrawalFee(uint256 _fee) external onlyOwner {
    ...
    function updateEarlyWithdrawalPenalty(uint256 _fee) external onlyOwner {
        require(_fee <= WITHDRAWAL_FEE_CAP, "WITHDRAWAL_FEE_CAP");
    ...
    function updateMinimumDepositPeriod(uint256 _minPeriod) external onlyOwner {
