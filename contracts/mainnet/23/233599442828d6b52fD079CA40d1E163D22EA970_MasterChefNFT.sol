...
contract MasterChefNFT is Ownable, ReentrancyGuard, ERC721Holder {
    ...
    function _payPendingUSDReward() internal {
        ...
        uint256 usdPending = (((user.amount * accDepositUSDRewardPerShare) / 1e24) - user.usdRewardDebt) + user.usdRewardLockup;
    ...
    function _payPendingTheEndlessSandMan(uint256 _pid) internal {
        ...
        uint256 pendingTheEndlessToken = ((user.amount * pool.accTheEndlessPerShare) / 1e24) - user.theEndlessRewardDebt;
        ...
        if (canHarvest(_pid, msg.sender)) {
            ...
            } else if (pendingTheEndlessToken > 0 || user.theEndlessRewardLockup > 0) {
            ...
            if (_pid == theEndlessPID) {
                uint256 pendingUSDReward = ((user.amount * accDepositUSDRewardPerShare) / 1e24) - user.usdRewardDebt;
