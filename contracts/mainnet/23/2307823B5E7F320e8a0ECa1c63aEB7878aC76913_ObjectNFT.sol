...
contract ObjectNFT is ERC1155TradableUpgradeable {
    ...
    function createNFT(address recipient, uint256 initialSupply, string memory tokenURI, address erc_20, int256 price, uint256 max)
    external
    returns (uint256)
    {
        _tokenIds.increment();
        ...
        create(recipient, newItemId, initialSupply, tokenURI, "0x", erc_20, price, max);
