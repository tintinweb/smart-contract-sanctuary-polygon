...
import "./access/MarketplaceAccess1155.sol";

contract MutualAccess is
    MarketplaceAccess1155,
    Ownable,
    ReentrancyGuard,
    IERC2981
{
    ...
    {
        return content[contentId].tickets;
    }
    ...
    function setContentAnticFees(
        ...
        if (
            getInitialTicketSupply(contentId) !=
    ...
    function getCurrentSaleFees(uint256 contentId)
        internal
        view
    ...
    {
        return content[contentId].royalties;
    }
        ...
        nonReentrant
    {
        ...
        ) = getCurrentSaleFees(contentId); // 5678 ==> 0.5678%
...
/// @author Amit Molek
/// @dev This contract overrides the setApprovalForAll for ERC1155
/// to only allow access for permitted marketplaces/operators
abstract contract MarketplaceAccess1155 is ERC1155, BaseMarketplaceAccess {
