...
contract BaseNFT is Mintable, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Operatorable, Blacklist {
  // Base token URI
  ...
  function mint(
    ...
    super._safeMint(_account, newTokenId);
  ...
  /**
    * @dev Layer 2 minting (see https://www.npmjs.com/package/@imtbl/imx-contracts)
    * Override {Mintable:_mintFor}
   */
  function _mintFor(
    address _user,
    uint256 _id,
  ...
  /**
    * @dev Disable token transfer from and to blacklisted wallets
    */
