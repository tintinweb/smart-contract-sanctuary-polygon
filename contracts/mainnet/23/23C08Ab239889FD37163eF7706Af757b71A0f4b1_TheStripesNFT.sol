...
contract TheStripesNFT is ERC721Enumerable, Ownable {
    ...
    uint256 public maxSupply = 5500; // how many NFT you have could be 10,000
    uint256 public maxMintAmount = 130; // how many NFT can be per wallet
    ...
    constructor(
        ...
        mint(msg.sender, 130);// how much can you mint (the owner)
    }
