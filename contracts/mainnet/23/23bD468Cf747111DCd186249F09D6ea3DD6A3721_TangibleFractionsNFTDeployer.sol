    ...
    Ownable
{
    ...
    function deployFractionTnft(
        ...
        tangibleFractionsNFT.grantRole(DEFAULT_ADMIN_ROLE, admin);
        tangibleFractionsNFT.grantRole(FACTORY_ROLE, factory);
        tangibleFractionsNFT.revokeRole(DEFAULT_ADMIN_ROLE, address(this));
