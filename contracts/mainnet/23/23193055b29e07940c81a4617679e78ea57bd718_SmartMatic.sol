...
contract SmartMatic is Context, Ownable, IBEP20 {
    ...
    uint256 constant SELLRATE = 100;
    uint256 constant POOLRATE = 20;
   
    constructor() {
	    _name = "SmartMatic Token";
        _symbol = "TMS";
        _decimals = 18;
    ...
    function Invest(address referral) public payable {
        ...
        require(msg.value >= 10 ether, "Minimum Buy is 10 MATIC!");
