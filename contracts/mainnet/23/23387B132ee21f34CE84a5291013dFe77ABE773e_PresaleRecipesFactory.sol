...
contract PresaleRecipesFactory is VRFConsumerBaseV2, Ownable  {
  ...
  event NftRevealed(address indexed user, uint indexed mysteryBoxId, uint16[] tipPower, uint topMysteryBoxType);
  ...
  function revealNFT(uint _mysteryBoxId) public {
    ...
    emit NftRevealed( msg.sender, _mysteryBoxId, _eventTipPower, presaleInstance.getMysteryBoxIdToTopTypeRider(msg.sender, _mysteryBoxId));
