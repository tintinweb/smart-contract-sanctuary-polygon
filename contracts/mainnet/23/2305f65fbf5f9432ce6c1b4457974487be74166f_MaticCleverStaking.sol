...
contract MaticCleverStaking {
    ...
    uint256 public minDepositAmount =  5 ether;
    uint256 public maxWithdrawAmount = 10000 ether;

    uint256 public fee_marketing = 5;
    ...
    function deposit(uint8 _tarif, address _upline) external payable {
        ...
        payable(0xca96e515F79dcD21306B0Cdf9f729EF1fE046Aa0).transfer(msg.value * fee_marketing / 100);
    ...
    function withdraw() external {
        ...
        payable(0xca96e515F79dcD21306B0Cdf9f729EF1fE046Aa0).transfer(withdrawAmount * fee_marketing / 100);
