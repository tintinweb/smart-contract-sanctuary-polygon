    ...
    ERC1155Pausable
{
    ...
    constructor(string memory walletAddr) ERC1155(walletAddr) {
        ...
        name = "Blockshow tickets #";
        symbol = "Blockshow tickets #";
    ...
    {
        require(
            msg.sender == ownerAddress, "you are not owner"
        );
        require(
            whitelists[to] > balancesOfAddress[to],
        ...
        balancesOfAddress[to]++;
        balanceOwns[to].push(newItemId);
    ...
    function setName(string memory _name) external {
        require(msg.sender == ownerAddress, "onlyOwner can set Name");
        name = _name;
    }

    function setSymbol(string memory _symbol) external {
        require(msg.sender == ownerAddress, "onlyOwner can set Symbol");
        symbol = _symbol;
    }

    function transferOwnership(address _newOwner) external {
        require(msg.sender == ownerAddress, "onlyOwner can transfer ownership");
