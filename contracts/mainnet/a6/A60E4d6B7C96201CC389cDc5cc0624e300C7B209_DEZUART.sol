...
contract DEZUART is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("DEZU ART", "DEZU") {
    customBaseURI = customBaseURI_;

    allowedMintCountMap[owner()] = 1000000000000000000;
  }
