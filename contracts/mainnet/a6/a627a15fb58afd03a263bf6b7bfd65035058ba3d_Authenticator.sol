...
contract Authenticator is ERC721A, Ownable {
    ...
    function verifiedProfile(string memory uri, address payable endUser, string memory instagram, string memory linkedin, string memory facebook, string memory name) public onlyOwner payable {
    ...
    function analyzeProfile(address payable endUser, string memory instagram, string memory linkedin, string memory facebook, string memory name) public onlyOwner payable {
        uint256 _mintAmount = 1;
        uint256 supply = totalSupply();
