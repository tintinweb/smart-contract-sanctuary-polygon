...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == sphereLottery, "Only SphereLottery");
    ...
    /**
     * @notice Set the address for the SphereLottery
     * @param _sphereLottery: address of the PancakeSwap lottery
     */
    function setLotteryAddress(address _sphereLottery) external onlyOwner {
        sphereLottery = _sphereLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IPancakeSwapLottery(sphereLottery).viewCurrentLotteryId();
    }
}