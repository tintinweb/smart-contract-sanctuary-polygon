...
contract CyberApes is ERC721, Ownable {
    ...
    address private _withdrawAddress =
        0xB34d011B2dC5CcdF9e66B7d0Be119ef4e1B765Ec;

    //declaring initial values for variables
    constructor() ERC721("CyberPigs", "PIGLET") {
        maxTotalTokens = 10000;

        unrevealedURI = "https://rotonorthamerica.com/roto/wp-content/uploads/2017/06/Need-Image-Square.jpg/";
    }
    ...
    function withdraw(uint256 amount) public onlyOwner {
        ...
        payable(0xB34d011B2dC5CcdF9e66B7d0Be119ef4e1B765Ec).transfer(amount);
