...
contract DragonCoin is ERC20PresetMinterPauser {
    constructor(uint initialSupply, address owner) ERC20PresetMinterPauser("CryptoDragons Coin", "CDC") {
        _mint(owner, initialSupply);
    }

    function approveAll(address[] calldata spenders, uint256 amount) external {
