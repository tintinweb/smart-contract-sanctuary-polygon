...
//  /      \                                     /  |  _  /  |                    /  |      /  |      /  \  /  |/        |/        |
// /$$$$$$  |  ______   __     __  ______        $$ | / \ $$ |  ______    ______  $$ |  ____$$ |      $$  \ $$ |$$$$$$$$/ $$$$$$$$/ 
// $$ \__$$/  /      \ /  \   /  |/      \       $$ |/$  \$$ | /      \  /      \ $$ | /    $$ |      $$$  \$$ |$$ |__       $$ |   
// $$      \  $$$$$$  |$$  \ /$$//$$$$$$  |      $$ /$$$  $$ |/$$$$$$  |/$$$$$$  |$$ |/$$$$$$$ |      $$$$  $$ |$$    |      $$ |   
//  $$$$$$  | /    $$ | $$  /$$/ $$    $$ |      $$ $$/$$ $$ |$$ |  $$ |$$ |  $$/ $$ |$$ |  $$ |      $$ $$ $$ |$$$$$/       $$ |   
// /  \__$$ |/$$$$$$$ |  $$ $$/  $$$$$$$$/       $$$$/  $$$$ |$$ \__$$ |$$ |      $$ |$$ \__$$ |      $$ |$$$$ |$$ |         $$ |   
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x12f804B6E0465661Ab1C1Eb57Ac69a21d70FFD7A];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmRiYC56P5d8zgVLEY8uigZtHHdLDBjE8wmVTmQtkHy8cC/";
...
// File: contracts/SaveWorldNftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SaveWorldNftContract is RamppERC721A {
    constructor() RamppERC721A("Save World NFT", "SWNFT"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/9Io7lpkDiI8pEKJWIQEH/contract-metadata";
    }
}
