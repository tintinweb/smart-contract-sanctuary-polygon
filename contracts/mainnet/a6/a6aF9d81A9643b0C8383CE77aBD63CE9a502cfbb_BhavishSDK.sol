...
contract BhavishSDK is IBhavishSDK, BaseRelayRecipient, AccessControl {
    ...
    function claim(PredictionStruct memory _predStruct, uint256[] calldata roundIds) external override {
        _claim(predictionMap[_predStruct.underlying][_predStruct.strike], roundIds, msg.sender);
    }
