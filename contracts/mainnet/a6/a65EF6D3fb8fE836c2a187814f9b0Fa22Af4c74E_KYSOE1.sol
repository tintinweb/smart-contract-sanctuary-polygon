...
contract KYSOE1 is ERC721, ERC721Enumerable , Ownable {
    ...
    constructor(string memory _contractUri,string memory _basemetadata) ERC721("KYSO EDITION 1", "E1") {
        contractUri = _contractUri;
        royalityFeeInBips = 1000;
        RoyalityReciever = 0xDB1F5178e2916320595fb73d8166d2037a1e16F7;
        uriPrefix = _basemetadata;
    }
    ...
    function setAuth(bool _status) public onlyOwner {
        authenticity = _status;
    }
