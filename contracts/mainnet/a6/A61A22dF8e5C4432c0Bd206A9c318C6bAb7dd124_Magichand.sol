...
contract Magichand is ERC721 {
    uint256 public totalSupply;
    uint256 public cost = 0.5 ether;
    uint256 public maxMints = 88;
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeif4jzs7mqcjrjkgiwswhyw42yv452z3cy64hjlnq7qlybmjhqgohy/", Strings.toString(tokenId), ".json")
            );
    }
