...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xE16847D2847B06f235c4a17Ca80DF6e5E39eCc27];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmSt4pJt4QLU1u8GiNg6HrkHt8hDyBM1czqpcTrSjqKa4r/";
...
// File: contracts/ChickFriendsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ChickFriendsContract is RamppERC721A {
    constructor() RamppERC721A("ChickFriends", "CHICK"){}
}
