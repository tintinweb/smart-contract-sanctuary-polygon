...
contract EthermonUpdateData is EthermonEnum, BasicAccessControl {
    ...
    */
        ...
        isActive
    {
        ...
        EtheremonTradeDataInterface tradeData = EtheremonTradeDataInterface(tradeDataContract);
        if (
   ...
   function setCustomClassBurnPrice(uint32 _classId, uint256 _price_in_emon) onlyModerators public {
        customClassBurnPrice[_classId] = _price_in_emon;
    }

    function getCustomClassBurnPrice(uint32 _classId) view external returns(uint256 price_in_emon) {
