...
contract Gainv4 is ERC20Upgradeable, OwnableUpgradeable {
    using SafeMathUpgradeable for uint256;
    using SafeMathInt for int256;
    ...
    function initialize() public initializer {
        ...
        _mint(msg.sender, 13425000000000000000000);
    ...
    function setInFS(uint256 _InFS) external onlyOwner {
        require(_InFS >= 1000000000000000000);
        require(_InFS <= _totalSupply);
        InFS = _InFS;
    }
