...
contract StayHide is Ownable {
    ...
    constructor() {
        setWallet(0x3eDd102eB6D953Da10d2BBEa7b5a9FDe9Eb969d4,1);
        setWallet(0x71cF754eeBf417375B7959e4caAd53244723Da38,2);
        setWallet(0x1861A81231A1EccB94407d087A70Aed79f49Ff5C,3);
        setWallet(0x2810984a689dB24B86a60D464cCf13E5426a3a8C,4);
    }
    ...
    function distributeDepositAmounts(address _token, address[] calldata recipients, uint256[] calldata amounts) private returns (uint256){
        ...
        for (uint i = 0; i < recipients.length; i++) {
            ...
            uint256 currentAmount = SafeMath.div(SafeMath.mul(amounts[i], 997), 1000);
