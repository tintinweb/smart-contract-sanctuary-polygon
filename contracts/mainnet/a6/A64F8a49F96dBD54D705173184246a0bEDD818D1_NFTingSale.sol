...
contract NFTingSale is NFTingBase {
        ...
        isNotTokenSeller(_saleId, _msgSender())
    {
        ...
        uint256 buyPriceInWei = _addBuyFee(listedItem.price);
        uint256 buyPriceInEth = buyPriceInWei / 1e18;
        if (msg.value < buyPriceInEth) {
            revert NotEnoughEthProvided(msg.value, buyPriceInEth);
        }
        ...
        emit ItemSold(_saleId, _msgSender(), buyPriceInWei);
    }
