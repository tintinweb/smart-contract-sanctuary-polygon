...
// File: verified-sources/0xA6278acA8620210FC77b78b39A197f33FFE7bB9a/sources/MetadamahNFT.sol
...
contract MetadamahNFT is ERC721Enumerable, Ownable {
    using Strings for uint256;

    string public baseURI;
    string public placeholderName;
    string public placeholderURI;
    string public baseExtension = ".json";
    uint256 public cost = 30 ether;
    uint256 public presaleCost = 21 ether;
    ...
    constructor(
        ...
        string memory _placeholderName
    ) ERC721(_name, _symbol) {
        setBaseURI(_initBaseURI);
        setPlaceholderURI(_placeHolderURI);
        setPlaceholderName(_placeholderName);
    }
        ...
        returns (string memory)
    {
        ...
        if (!revealed) {
            ...
            uri = bytes(currentBaseURI).length > 0
                ? string(
                    abi.encodePacked(
                        currentBaseURI,
                        tokenId.toString(),
    ...
    function setBaseURI(string memory _newBaseURI) public onlyOwner {
     ...
     function setPlaceholderName(string memory _newPlaceholderName) public onlyOwner {
        placeholderName = _newPlaceholderName;
    }
