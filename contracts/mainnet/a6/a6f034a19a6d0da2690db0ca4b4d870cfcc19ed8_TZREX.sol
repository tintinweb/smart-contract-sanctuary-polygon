...
// File: contracts/TZREX.sol

pragma solidity ^0.8.7;

contract TZREX is Ownable, ERC721, NonblockingReceiver {
    address public _owner;
    string private baseURI;
    uint256 nextTokenId = 7000;
    uint256 MAX_MINT_POLY = 10000;

    uint256 gasForDestinationLzReceive = 350000;

    constructor(string memory baseURI_, address _layerZeroEndpoint)
        ERC721("TZREX EX", "TZREX")
    {
        _owner = msg.sender;
    ...
    function mint(uint8 numTokens) external payable {
        require(numTokens < 3, "TZREX EX: Max 2 NFTs per transaction");
        require(
            nextTokenId + numTokens <= MAX_MINT_POLY,
            "TZREX EX: Mint exceeds supply"
        );
    ...
    function traverseChains(uint16 _chainId, uint256 tokenId) public payable {
        ...
        require(
            ...
            "TZREX EX: msg.value not enough to cover messageFee. Send gas for message fees"
        );
    ...
    function withdraw(uint256 amt) external onlyOwner {
        ...
        require(sent, "TZREX EX: Failed to withdraw Ether");
    }
