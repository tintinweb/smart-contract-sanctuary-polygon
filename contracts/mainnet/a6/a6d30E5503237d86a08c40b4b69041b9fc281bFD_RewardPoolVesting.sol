...
contract RewardPoolVesting {
    ...
    function initVestingStages () internal {
        ...
        stages[0].tokensUnlockedPercentage = 2;

        for(uint256 i = 1; i < 50; i++){
            stages[i].tokensUnlockedPercentage = 2;
