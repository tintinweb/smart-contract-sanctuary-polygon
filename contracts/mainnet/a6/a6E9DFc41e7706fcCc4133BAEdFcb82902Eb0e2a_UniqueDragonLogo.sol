...
contract UniqueDragonLogo is ERC721, PaymentSplitter {
    ...
    constructor(address[] memory _payees, uint256[] memory _shares)
        ERC721("Dragon Layer Logo", "DLL")
        PaymentSplitter(_payees, _shares)
    {}

    function mint() external payable {
        if (totalSupply + 1 > 156) revert SoldOut();
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked(
                    "ipfs://QmYx2MNk4vUe2wXodGaMGUHECNus88VnQuuhTKka5c8z8g/",
