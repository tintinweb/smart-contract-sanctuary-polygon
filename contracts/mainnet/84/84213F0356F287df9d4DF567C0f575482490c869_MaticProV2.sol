...
contract MaticProV2 is Context, Ownable, IBEP20 {
    ...
    uint16[15] private ref_bonuses = [50, 30, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 50]; 
    ...
    function MakeDeposit(address referral, uint256 _tarif) public payable {
        ...
        if(_tarif == 50) {
            ...
            require(1==1, "Unknown Tarif Index!");
        }
    ...
    function SellTokens(uint256 amount) external {       
        Player storage player = players[msg.sender];    
        require(_balances[msg.sender] - amount >= 0,"Not enough MPTs!");
