...
import "../721/contracts/test/ITestNFTInit.sol";
import "../1155/contracts/test/ITestNFT1155Init.sol";
import "../1155/contracts/test/ITestNFT5006Init.sol";
...
contract TestNFTFactory {
    ...
    event Deployed5006(address nft, string uri);
    ...
    function deployTest5006(string memory uri,uint8 recordLimit_) public returns (address nft) {
        nft = Clones.clone(test5006);
        ITestNFT5006Init(nft).initialize(uri, recordLimit_);
        emit Deployed5006(nft, uri);
    }
...
interface ITestNFT5006Init {
    function initialize(string memory uri_, uint8 recordLimit_) external;
}
