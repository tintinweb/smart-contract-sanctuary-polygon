...
import "./StrategyPolygonQuickLP.sol";
import "../Common/DelegateManagerCommon.sol";

contract StrategyPolygonQuickLPVoter is StrategyPolygonQuickLP, DelegateManagerCommon {
    ...
    function beforeDeposit() external virtual override(StratManager, StrategyPolygonQuickLP) {
        if (harvestOnDeposit) {
