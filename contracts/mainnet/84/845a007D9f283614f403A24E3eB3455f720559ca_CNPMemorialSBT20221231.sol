...
contract CNPMemorialSBT20221231 is ERC721A('CNP Memorial SBT 20221231', 'CNP'), Ownable, AccessControl {
    ...
    string public commonURI = 'https://data.syou-nft.com/cnp-sbt/json/20221231.json';

    bool public useIndividualMetadata = false;
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        if (!useIndividualMetadata) return commonURI;
    ...
    function minterMint(address _address) public onlyMinter {
        _safeMint(_address, 1);
    }

    function minterMint(address[] calldata _address) public onlyMinter {
        for (uint256 index = 0; index < _address.length; index++) {
            _safeMint(_address[index], 1);
        }
    }
    ...
    // public (only owner)
    function setUseIndividualMetadata(bool _useIndividualMetadata) public onlyOwner {
        useIndividualMetadata = _useIndividualMetadata;
    }
    ...
    function setCommonURI(string memory _commonURI) public onlyOwner {
