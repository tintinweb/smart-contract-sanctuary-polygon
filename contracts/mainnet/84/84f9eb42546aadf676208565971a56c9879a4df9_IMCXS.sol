...
contract IMCXS is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  // public
  function mint(uint256 _mintAmount, address receiver) public onlyOwner {
