    ...
    ReentrancyGuardUpgradeable
{
    ...
    uint256 private _selletFeeTier;
    uint256 private _buyerFeeTier; // Seller fee tier plus buyer fee tier should be 10,000
    ...
    function initialize(
        ...
        uint256 sellerFeeTier_,
        uint256 buyerFeeTier_,
        ...
        if (sellerFeeTier_ + buyerFeeTier_ != 10000) {
            revert Market_InvalidFeeTiersSum();
        }

        _selletFeeTier = sellerFeeTier_;
        _buyerFeeTier = buyerFeeTier_;
     ...
     * @param sellerFeeTier_ (uint256)
     * @param buyerFeeTier_ (uint256)
     */
    function setFeeTiers(
        ...
        if (_selletFeeTier + _buyerFeeTier != 10000) {
            revert Market_InvalidFeeTiersSum();
        }
