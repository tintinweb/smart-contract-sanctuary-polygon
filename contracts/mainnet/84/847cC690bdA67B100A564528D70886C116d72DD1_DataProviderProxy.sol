...
import {DataProviderBaseStorage} from "./DataProviderStorage.sol";

// solhint-disable max-line-length

/**
 * @title DataProviderCore
 * @dev Storage for the DataProvider is at this address, while execution is delegated to the `implementation`.
 */
contract DataProviderProxy is DataProviderBaseStorage {
    /**
    ...
    /**
     * @notice Emitted when pendingImplementation is accepted, which means DataProvider implementation is updated
     */
    ...
    /**
     * @notice Accepts new implementation of DataProvider. msg.sender must be pendingImplementation
