 ...
 * @notice This contract handles minting Aisthesis tokens.
 */
contract Aisthesis is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x0E54b8BE556f0c0B231034D885aFf8D5C2B3A1C6;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x302A018728F6c7C89e92CD8fEC746F5A6Fdab635;
    address[] public payoutAddresses = [
        0x5522e6a26F8B091145322307970a27dAb9337773
    ];
    ...
    uint96 public royaltyFee = 360;

    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeihxfos3awss5exyuzbq4ovw25e4lshyv3bbgfdjjxvsbacsx6p4jm/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[1] = 1080;
        tokenPublicPrice[1] = 0.036 ether;
