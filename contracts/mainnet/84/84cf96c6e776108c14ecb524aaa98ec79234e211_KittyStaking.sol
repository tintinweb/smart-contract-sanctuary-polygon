...
contract KittyStaking is ERC20, AccessControl, ERC721Holder {
    ...
    constructor(address owner, address _collectionAddress) ERC20("Grumpy Krypto Coin v1", "GKC") AccessControl(){
