...
interface IGogoRewards {
    ...
    function getRewardByLoss() external; //note: function will fail if no one stakes every 180 days
    function stake(uint256 amount) external;
    function withdraw(uint256 amount) external;
}

contract GogoUsdcStrategy is BaseStrategy {
    ...
    constructor()
        public
        BaseStrategy(
            0xe33Dd0C0534189b66B9872425189399e2B9c169D, //GOGO/USDC LP
            FUND,
            GOGO,
            QUICKSWAP_ROUTER,
            0x5DC4FFc0F9c2261DCAae7F69e1A8837aFbd577bc //GOGO/USDC rewards
        )
    {
    ...
    function harvest() public override onlyHumanOrWhitelisted nonReentrant {
        ...
        //Convert some GOGO to WMATIC and distribute fee
        ...
        //Swap 1/2 of the remaining GOGO for USDC
    ...
    function _getReward() internal {
        IGogoRewards(rewards).getRewardByLoss();
    }
