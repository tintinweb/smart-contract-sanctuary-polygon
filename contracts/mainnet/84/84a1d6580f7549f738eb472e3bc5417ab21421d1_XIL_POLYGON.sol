...
import "./lib/SignerVerification.sol";

error Incorrect_Signature(); 

contract Token is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, AccessControlUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant UPGRADER_ROLE = keccak256("UPGRADER_ROLE");

    SignerVerification public s_signerVerification;
    ...
    function initialize(
        ...
        s_signerVerification = SignerVerification(_signerVerification);
        s_signer = msg.sender;
    }
    ...
    function claimXil(uint256 _amount, bytes calldata _signature) external {
         string memory concatenatedParams = s_signerVerification.concatParams(msg.sender, _amount);

         bool isVerified = s_signerVerification.isMessageVerified(s_signer, _signature, concatenatedParams);  
    ...
    function setSigner(address _signer) external onlyOwner {
     ...
     function setSignerVerification(address _signerVerification) external onlyOwner {
         s_signerVerification = SignerVerification(_signerVerification);
    }
...
import "./LibraryV2.sol";

contract XIL_POLYGON is ERC20 {}