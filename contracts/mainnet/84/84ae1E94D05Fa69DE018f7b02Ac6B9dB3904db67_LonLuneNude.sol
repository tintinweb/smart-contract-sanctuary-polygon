...
contract LonLuneNude is ERC721  {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeie7pztjdut7lvpqepolzdirx4hhayzjnkzs6ogm63nqh26ivftisi/", Strings.toString(tokenId), ".json")
            );
    }
