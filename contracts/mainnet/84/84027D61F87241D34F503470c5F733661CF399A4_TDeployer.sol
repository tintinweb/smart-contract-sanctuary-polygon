...
/**
 * @notice This smart contract manages the deployment of any Fund Token in the platform
 */
contract TDeployer is Ownable, ITDeployer {
    ...
    /**
     * @notice Deploys a new Fund Token contract and transfer ownership to _caller address
     * @param _caller The address that will take the ownership of the contract
     * @param _name The name of the Fund Token
     * @param _symbol The symbol of the Fund Token
     * @param _ATAddress The address of the corresponding Admin Tools contract
     * @return newT address The address of the deployed Fund Token contract
     */
    function newToken(address _caller, 
            string calldata _name, 
            string calldata _symbol, 
            address _ATAddress
            /*uint8 _tokenDecimals*/) external override onlyFactory returns(address) {
        Token c = new Token(_name, _symbol, _ATAddress, fAddress/*, _tokenDecimals*/);
