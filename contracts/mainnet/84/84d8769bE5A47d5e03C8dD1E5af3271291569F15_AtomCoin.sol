...
contract AtomCoin is Context, IERC20, Ownable {
    ...
    string private _name = "Atom Coin";
    string private _symbol = "ATOM";
    ...
    uint256 public _maxWalletLimit = 1000000 * 10 ** 18;
    ...
    function setAddress(address _addr) external onlyOwner {
        admin = _addr;
    }
