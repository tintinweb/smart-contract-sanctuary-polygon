...
contract THE_BALL is ERC1155, AccessControl, Pausable, ReentrancyGuard, ERC1155Burnable, ERC1155Supply, Ownable, ERC2981ContractWideRoyalties {

  /// The public name of this contract.
    string public constant name = "THE BALL";
    ...
    constructor() ERC1155("https://tokens.likida.io/the_ball/{id}.json") {
        ...
        // Token limit
        tokenSupply[1] = 50;
        tokenPrice[1] = 23*10**18;
        tokenSupply[2] = 5;
        tokenPrice[2] = 78*10**18;
        tokenSupply[3] = 50;
        tokenPrice[3] = 23*10**18;
        tokenSupply[4] = 25;
        tokenPrice[4] = 48*10**18;
        tokenSupply[5] = 50;
        tokenPrice[5] = 23*10**18;
        tokenSupply[6] = 25;
        tokenPrice[6] = 48*10**18;

        likidaAddress = 0x8e15b51b4b0dDbf5FBA26046485DcFd4c95F8EA1;
        setAdminAddress(0xcD0561E24C3986595921B71bBfBcdF29015ae0aC);
    }
