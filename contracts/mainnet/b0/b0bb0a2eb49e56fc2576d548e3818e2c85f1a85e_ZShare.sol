...
contract ZShare is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("ZSHARE", "ZSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 BEE Share for initial pools deployment
