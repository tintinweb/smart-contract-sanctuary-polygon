    ...
    function canPerformTask() external view returns (bool canPerform) {
        for (uint256 i = 0; i < predictionMarkets.length; i++) {
            ...
            canPerform =
                ...
                round.roundState == IBhavishPrediction.RoundState.STARTED || round.roundState == IBhavishPrediction.RoundState.ENDED || round.roundState == IBhavishPrediction.RoundState.CANCELLED;
...
contract BhavishEquitiesPrediction is IBhavishPrediction, AccessControl, Pausable, ReentrancyGuard {
    ...
    function shouldExecuteRound() external view returns (bool) {
        ...
        console.log("---",roundPlusOne.roundStartTimestamp, curRound.roundEndTimestamp, startTimestamp);
        console.log("---",startTimestamp, block.timestamp + roundTime * 2, uint256(curRound.roundState));
        if (
