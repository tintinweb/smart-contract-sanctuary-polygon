    ...
    Ownable
{
    ...
    constructor() public ERC721("Mint More", "ART") {
        tokens = 0;
    }
    ...
    function mint(string calldata _uri) 
        ...
        payable
    {
        require(msg.value >= mint_price, "Insufficient funds for minting..try get_price()");
        tokens++;
        _mint(msg.sender, tokens);
        _setTokenURI(tokens, _uri);
    }
