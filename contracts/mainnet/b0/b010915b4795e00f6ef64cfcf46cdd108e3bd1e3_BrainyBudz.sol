...
// File @openzeppelin/contracts/token/ERC721/extensions/[email protected].3
...
// File contracts/doopad/DooDrop.sol


// PWS Contracts v1.0.0

pragma solidity ^0.8.15;
abstract contract DooDrop is ERC721Enumerable, Ownable, ReentrancyGuard {
    // PwsPad
    address private immutable croDooWallet;
    uint256 private immutable croDooRoyalties = 1;
    ...
    function mint(uint256 amount) external payable nonReentrant {
        ...
        uint256 launchpadRoyalties = (msg.value * croDooRoyalties) / 100;
...
pragma solidity ^0.8.15;
contract BrainyBudz is DooDrop {
    constructor(address projectWallet_, address croDooWallet_)
        DooDrop(
            "BrainyBudz",
            "BB",
            "ipfs://brainybudzeieeky2tnflplvhgld3esazeggbsbfxeotoaph5nhxlv2sflorkfrmu/",
            projectWallet_,
            croDooWallet_,
            8420,
            20,
