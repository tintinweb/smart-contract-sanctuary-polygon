...
contract DogeVIPClub is ERC721Enumerable, Ownable {
    using Strings for uint256;

    string public baseURI;
    string public baseExtension = ".json";
    uint256 public cost = 500.00 ether;
    uint256 public presaleCost = 500.00 ether;
    uint256 public maxSupply = 100000;
    uint256 public maxMintAmount = 100000;
