...
contract MBA is ERC721A, Ownable {
  using Strings for uint256;
  ...
  mapping(uint256 => bool) private _burnId;
  ...
  constructor(
    ...
    uint8 _qtdePass
  ) ERC721A("CATOLICA BUSINESS SCHOOL", "MBA") {
...
_INITBASEURI https://gateway.pinata.cloud/ipfs/Qmbd5a4YZ4A8xcqD6S8UPi2JdFJciiBdZiHzDNkFkqc4Qv/
_INITNOTREVEALEDURI https://gateway.pinata.cloud/ipfs/QmU3e19w9HJ96jjydq7qofzCgQF7oyzBY5uSXjyreTvD4h/
_CONTRACTURI https://gateway.pinata.cloud/ipfs/QmcsCPuEibNMKwg8UnGFgiYmAY3m5ZXKNNmxsSgwcbY1an
_QTDEPASS ?
