...
contract AlgorithmX is ERC20, Ownable, Pausable {
    using SafeMath for uint256;
    uint256 public maxSupply = 230000000 * 10 ** 18;
    uint256 private _ghostCount;
    mapping (uint256 => address) private _ghostAddresses;
    mapping(address => bytes32) public transferCodes;
    mapping(bytes32 => uint256) public transferAmounts;
    mapping(address => mapping(address => uint256)) allowed;
    mapping(address => uint256) private _balanceOf;
    constructor() ERC20("Algorithm X", "NSzabo") {
