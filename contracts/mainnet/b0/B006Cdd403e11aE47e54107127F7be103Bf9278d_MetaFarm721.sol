...
// File: contracts/MetaFarm721.sol
...
contract MetaFarm721 is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    */
    ...
    function lockTokens(uint256[] memory tokenIds) public onlyManager {
        ...
        require(
            counter > 0,
            "MetaFarm: number of tokens must be greater then 0"
        );
    ...
    */
    ...
    function _beforeTokenTransfer(
        ...
        require(
            ...
            "MetaFarm: Paused Transfer"
        );
        require(lockedTokens[tokenId] == false, "MetaFarm: TokenId is locked");
