...
contract SaveWorldNFT is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("SaveWorldNFT", "SNFT") {
  ...
  uint256 public constant PRICE = 50000000000000000000;
  ...
  function mint() public payable nonReentrant {
    ...
    require(msg.value >= PRICE, "Insufficient payment, 50 ETH per item");
