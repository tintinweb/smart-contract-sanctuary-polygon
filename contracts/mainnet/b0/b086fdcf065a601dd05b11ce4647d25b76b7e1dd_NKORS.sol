...
contract NKORS is ERC1155, ERC1155URIStorage, ERC2981, Ownable, Pausable, ERC1155Burnable, ERC1155Supply {

    mapping(address => bool) private admins;

    constructor()
        ERC1155("https://batistaonthebeat.com/nkor/tokens/{id}.json")
    {
        _setBaseURI("ipfs://");
    ...
    modifier onlyOwnerOrAdmin() {
        require((owner() == _msgSender() || admins[_msgSender()]), "NKORS: caller is not the owner or admin");
        _;
    }
