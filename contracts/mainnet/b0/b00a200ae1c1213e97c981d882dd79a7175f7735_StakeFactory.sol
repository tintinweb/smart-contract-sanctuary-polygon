...
contract StakeFactory is IStakeFactory, Ownable {
    ...
    mapping(address => mapping(address => address)) public override getStake;
    ...
    /**
     * @notice Creates a new StakingRewards contract, stores the farm address by creator and the given LP token.
    ...
    function createNewStake(
        ...
        require(
            getStake[msg.sender][_stakingTokenAddress] == address(0),
            "StakeFactory: FARM_EXISTS"
     ...
     * @notice This is available in case any updates are made to the StakeManager contract.
    ...
    function _takeFee() private {
        require(
            ...
            "StakeFactory: INSUFFICIENT_BALANCE"
        );
    ...
    function _transferFarmOwnership(address _farmAddress, address _newOwner) private {
        ...
        StakingRewards rewardsContract = StakingRewards(
            _farmAddress
        );
