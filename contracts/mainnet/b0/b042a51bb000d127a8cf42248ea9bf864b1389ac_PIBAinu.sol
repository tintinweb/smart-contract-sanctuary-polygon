...
// https://t.me/PibaInu
// https://twitter.com/PibaInuPolyg
...
contract  PIBAinu is IBEP20, Auth {
    ...
    string constant _name = "Piba Inu";
    string constant _symbol = "PIB";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 12) / 200; //6% 
    uint256 public _maxWalletSize = (_totalSupply * 6) / 100; //6%
    ...
    address private marketingFeeReceiver = 0x9DB49D0267F87B90eC777b56C091b99E9b9326B6;
    address private developmentFeeReceiver = 0x9DB49D0267F87B90eC777b56C091b99E9b9326B6;
