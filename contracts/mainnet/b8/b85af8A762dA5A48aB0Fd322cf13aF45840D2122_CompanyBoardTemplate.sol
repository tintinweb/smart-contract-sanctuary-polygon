...
contract CompanyBoardTemplate is BaseTemplate {
    ...
    * @param _companyName String with the name for the organization
    * @param _companySymbol String with the symbol of the organization
    ...
    */
        ...
        external
    {
        ...
        string memory boardTokenName = string(abi.encodePacked(_companyName, " Executive Token"));
        string memory boardTokenSymbol = string(abi.encodePacked(_companySymbol, "ET"));
        string memory shareTokenName = string(abi.encodePacked(_companyName, " Company Token"));
        string memory shareTokenSymbol = string(abi.encodePacked(_companySymbol, "CT"));


    MiniMeToken shareToken = _createToken(shareTokenName, shareTokenSymbol, SHARE_TOKEN_DECIMALS);
        MiniMeToken boardToken = _createToken(boardTokenName, boardTokenSymbol, BOARD_TOKEN_DECIMALS);
        ...
        _createEvmScriptsRegistryPermissions(acl, shareVoting, boardVoting);
    ...
    */
        ...
        external
    {
        ...
        _transferCreatePaymentManagerFromTemplate(ACL(dao.acl()), finance, boardVoting);
        _transferRootPermissionsFromTemplateAndFinalizeDAO(dao, boardVoting);
        ...
        internal
    {
        ...
        _createTokenManagerPermissions(acl, shareTokenManager, _boardVoting, _boardVoting);
        _createTokenManagerPermissions(acl, boardTokenManager, _boardVoting, _boardVoting);

        // Assign permissions for votings
        _createVotingPermissions(acl, _shareVoting, _shareVoting, shareTokenManager, _boardVoting);
        _createVotingPermissions(acl, _boardVoting, _boardVoting, boardTokenManager, _boardVoting);
    }
