 ...
 * @notice This contract handles minting DeGods tokens.
 */
contract DeGods is
    ERC1155Supply,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x53d20edf303f4Fe3a408C00805E51A2d93509282;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x7adA73674AB29948302B89db97B93723262355Fa;
    address[] public payoutAddresses = [
        0x7adA73674AB29948302B89db97B93723262355Fa
    ];
    ...
    string public name = "DeGods";
    string public symbol = "DEGODS";
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeifnxw2pbmgpmnh7bycvz6glniwh353o3qowfb3jjw6a5j5u27bkri/{id}"
        )
        RevokableOperatorFilterer(
