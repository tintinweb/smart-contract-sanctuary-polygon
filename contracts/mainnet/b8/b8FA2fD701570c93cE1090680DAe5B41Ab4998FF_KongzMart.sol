...
contract KongzMart is Ownable {
    ...
    ///// Interfaces /////
    IERC1155 public PNKAssets = IERC1155(0x3C2Eb40D25a4b2B5A068a959a40d57D63Dc98B95);
    function O_setPNKAssets(address address_) external onlyOwner {
        PNKAssets = IERC1155(address_);
    }

    IERC721 public KONGZVX = IERC721(0x3C2Eb40D25a4b2B5A068a959a40d57D63Dc98B95);
