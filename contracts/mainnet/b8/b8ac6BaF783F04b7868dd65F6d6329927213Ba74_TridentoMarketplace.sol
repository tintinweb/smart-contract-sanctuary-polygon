...
interface ITridentoMarketplaceV2 {
    struct Listing {
        uint256 tokenId;
        uint256 value;
        address seller;
...
interface ITridentoMarketplaceRoyalty {
    ...
    // Who can set: ERC721 owner and Tridento owner
    event SetRoyalty(
        address indexed erc721Address,
...
contract TridentoMarketplaceRoyalty is ITridentoMarketplaceRoyalty, Ownable {
...
/**
 * @title Tridento Marketplace contract V2
 * Note: Payment tokens usually is the chain native coin's wrapped token, e.g. WETH, WBNB
 */
contract TridentoMarketplace is
    ITridentoMarketplaceV2,
    Ownable,
    TridentoMarketplaceRoyalty,
    ReentrancyGuard
{
    using Address for address;
    ...
    /**
     * @dev See {ITridentoMarketplace-listToken}.
    ...
    /**
     * @dev See {ITridentoMarketplace-delistToken}.
    ...
    /**
     * @dev See {ITridentoMarketplaceV2-buyToken}.
    ...
    /**
     * @dev See {ITridentoMarketplace-enterBidForToken}.
    ...
    /**
     * @dev See {ITridentoMarketplace-withdrawBidForToken}.
    ...
    /**
     * @dev See {ITridentoMarketplaceV2-acceptBidForToken}.
    ...
    /**
     * @dev See {ITridentoMarketplace-isTradingEnabled}.
     */
    ...
    /**
     * @dev See {ITridentoMarketplace-getTokenListing}.
     */
    function getTokenListing(address erc721Address, uint256 tokenId)
        public
        view
    ...
    /**
     * @dev See {ITridentoMarketplace-numTokenListings}.
     */
    function numTokenListings(address erc721Address)
        public
        view
    ...
    /**
     * @dev See {ITridentoMarketplace-getTokenListings}.
     */
    function getTokenListings(
        address erc721Address,
        uint256 from,
    ...
    /**
     * @dev See {ITridentoMarketplace-getBidderTokenBid}.
     */
    function getBidderTokenBid(
        address erc721Address,
        uint256 tokenId,
    ...
    /**
     * @dev See {ITridentoMarketplace-getTokenBids}.
     */
    function getTokenBids(address erc721Address, uint256 tokenId)
        external
        view
    ...
    /**
     * @dev See {ITridentoMarketplace-getTokenHighestBid}.
     */
    function getTokenHighestBid(address erc721Address, uint256 tokenId)
        public
        view
    ...
    /**
     * @dev See {ITridentoMarketplace-numTokenWithBids}.
     */
    function numTokenWithBids(address erc721Address)
        public
        view
    ...
    /**
     * @dev See {ITridentoMarketplace-getTokenHighestBids}.
     */
    function getTokenHighestBids(
        address erc721Address,
        uint256 from,
    ...
    /**
     * @dev See {ITridentoMarketplace-actionTimeOutRangeMin}.
     */
    ...
    /**
     * @dev See {ITridentoMarketplace-actionTimeOutRangeMax}.
     */
    ...
    /**
     * @dev See {ITridentoMarketplace-paymentToken}.
     */
    ...
    /**
     * @dev See {ITridentoMarketplace-serviceFee}.
     */
