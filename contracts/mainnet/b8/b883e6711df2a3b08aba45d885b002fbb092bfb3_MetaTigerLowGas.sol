...
contract MetaTigerLowGas is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Meta Tiger", "Meta Tiger") {
    setHiddenMetadataUri("ipfs://QmdwyyWXXrPtcyCCChE8nUFizSkKChLACLpUK3jLvpvt5U.json");
  }
