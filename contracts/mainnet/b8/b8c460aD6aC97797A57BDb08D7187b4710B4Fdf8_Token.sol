...
contract Token is Ownable, ERC20{
    ...
    constructor(string memory name_, string memory symbol_) Ownable() ERC20(name_,symbol_){  
        ...
        __mint(address(adLockToken), 120 * 1e6 * 1e18);
        __mint(address(communityLockToken), 80 * 1e6 * 1e18);
        __mint(address(teamLockToken), 100 * 1e6 * 1e18);
