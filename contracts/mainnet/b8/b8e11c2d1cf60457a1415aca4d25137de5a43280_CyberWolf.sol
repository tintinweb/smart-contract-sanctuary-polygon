...
contract PresaleOwnableMATIC is Context {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "PresaleOwnableMATIC: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "PresaleOwnableMATIC: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract CyberWolf is Context, Presale, PresaleOwnableMATIC {
    ...
    string private _name = 'CyberWolf';
    string private _symbol = 'CyberWolf';
