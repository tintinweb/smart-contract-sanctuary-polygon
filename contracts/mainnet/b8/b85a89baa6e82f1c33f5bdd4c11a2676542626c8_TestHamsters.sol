...
// File: TestHamsters.sol


pragma solidity ^0.8.17;

contract TestHamsters is ERC721A, Ownable, ReentrancyGuard {

  using Strings for uint;

  string public uriPrefix = "ipfs://QmNedoEpFZXPSpB9aUVTiKKEDm7MaMaupC2rNwEn9iUZ6j/";
  string public uriSuffix = ".json";
  
  uint public cost = 0.0015 ether;
  ...
  constructor() ERC721A("Test Hamsters", "TH") {
  }
