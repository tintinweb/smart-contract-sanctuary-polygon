...
contract HyperLPFactory is HyperLPFactoryStorage, IHyperLPFactory {
    ...
    /// @notice createManagedPool creates a new instance of a HyperLP token on a specified
    ...
    /// @param deployer address that has potentially deployed HyperLP pools (can return empty array)
    ...
    /// @notice getPool fetches the HyperLP pool address deployed by `deployer` with parameters
    /// @param deployer address that has potentially deployed HyperLP pools (can return empty array)
    /// @param manager for managed pools owtherwise a zero address
    /// @param tokenA one of the tokens in the uniswap pair
    /// @param tokenB the other token in the uniswap pair
    /// @param uniFee fee tier of the uniswap pair
    /// @return pool the list of HyperLP pool addresses deployed by `deployer`
    function getPool(
        address deployer,
        address manager,
        address tokenA,
    ...
    /// of a HyperLP pool. For most all pools either this contract address or the zero address will
