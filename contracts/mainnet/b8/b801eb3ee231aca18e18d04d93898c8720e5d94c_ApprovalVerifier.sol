...
contract ApprovalVerifier {
    ...
    function decodeSignedTxLegacy(bytes memory rlpSignedTx, uint chainID) internal pure returns (SignedTransaction memory t) {
        ...
        fields[6] = encodeUint(chainID).toRlpItem(); // 137 Polygon ChainID // probably needs to be 0 or 1
    ...
    function validateTxProof(
        ...
        if (rlpTx.length == 0) {
            ...
            return (
                ...
                proof.txIndex,
                decodeSignedTxLegacy(rlpTx, chainID)
    ...
    function txProof(
        ...
        (result, index, t) = validateTxProof(blockHash, proofBlob, chainID);
        nonce = t.nonce;
        gasprice = t.gasprice;
        startgas = t.startgas;
        to = t.to;
    ...
    */
    function validateApproveMPT(
        ...
        (result, index, t) = validateTxProof(blockHash, _proofBlob, chainID);
        //nonce = t.nonce;
        //gasprice = t.gasprice;
        //startgas = t.startgas;
        //to = t.to;
        ...
        */
        ...
        ecsender = ecrecover(t.unsignedHash, uint8(t.v), bytes32(t.r), bytes32(t.s));
        ...
        //require(t.to == token, "token not matched");
        //require(toAddress(t.data, 4) == spender, "spender not matched");
