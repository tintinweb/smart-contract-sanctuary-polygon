...
contract ContractFlashTri {
    ...
    address private constant DYFN = 0xC168E40227E4ebD8C1caE80F7a55a4F0e6D66C97;
    address private constant BZB = 0x462D8d82C2B2D2DDabf7f8a93928De09d47A5807;
    address private constant ICE = 0x4A81f8796e0c6Ad4877A51C86693B0dE8093F2ef;
    address private constant WETH = 0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619;
    address private constant POLYDOGE =
    ...
    function triangularArbitrage(
        ...
        address dummyToken;
        if (
            _tokens[0] != WMATIC && _tokens[1] != WMATIC && _tokens[2] != WMATIC
        ) {
            dummyToken = WMATIC;
        } else if (
            _tokens[0] != DYFN && _tokens[1] != DYFN && _tokens[2] != DYFN
        ) {
            dummyToken = DYFN;
        } else if (
            _tokens[0] != ICE && _tokens[1] != ICE && _tokens[2] != ICE
        ) {
            dummyToken = ICE;
        } else if (
        ...
        // Passing data triggers panICECall as this is what constitutes a loan
