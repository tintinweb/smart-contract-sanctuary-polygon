...
contract StonedYoots is ERC721 , DefaultOperatorFilterer {
    uint256 public totalSupply;
    uint256 public cost = 0 ether;
    uint256 public maxMints = 900;
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeig42gopomzxdzzbwgvfbkmrto7wa5l6hmsxezikdfgnoygo7udrbu/", Strings.toString(tokenId), ".json")
            );
    }
