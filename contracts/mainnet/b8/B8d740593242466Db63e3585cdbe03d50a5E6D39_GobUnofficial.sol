 ...
 * @notice This contract handles minting Gob Unofficial tokens.
 */
contract GobUnofficial is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xc0491C2Da1174837B854DBF478370Ae4515C321b;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x87466Cda3c43D4AbeB630Ce5F8d3B80c8a86fCD4;
    ...
    address[] public payoutAddresses = [
        0x87466Cda3c43D4AbeB630Ce5F8d3B80c8a86fCD4
    ];
    ...
    string public name = "Gob Unofficial";
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeibziigvjrzzquk4x2qeutcllw4qlnjyojwnyrdonossijxjy57cz4/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenPublicMintsPerAddress[1] = 25;
        require(
