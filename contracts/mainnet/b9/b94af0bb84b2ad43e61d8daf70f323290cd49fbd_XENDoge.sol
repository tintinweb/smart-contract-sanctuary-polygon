...
contract XENDoge is ERC20Capped, IERC165, IBurnRedeemable { 
    ...
    address payable public constant DONATION_ADDRESS = payable(0x6292A83BDdaE068E6cF4d242c858d5b1e0629f0C);
    uint256 public constant XEN_BURN_RATIO = 1000;
    uint256 public totalXenBurned = 0;
    uint256 public totalDonated = 0;

    constructor() ERC20("XENDoge", "mXDOGE") ERC20Capped(50000000000000000000000000000) {}
