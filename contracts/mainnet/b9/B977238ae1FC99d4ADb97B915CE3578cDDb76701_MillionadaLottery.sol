 ...
 * @title Millionada Crypto Lottery 
  * https://millionada.github.io/polygon/
 */
...
contract MillionadaLottery is ERC20 {
    ...
    constructor(
    )  ERC20("millionada.github.io/polygon", "MILN") {
    ...
    address payable dev_fund  = payable(0x80448bBF434609aa141A7cd01b51D33fAA78dc66);
    ...
    {
        uint256 value = msg.value - msg.value / 100;
        uint256 send_tickets = value / ticketPrice;
    ...
    function scratch() public payable  {
        ...
        totalPot += (msg.value - (ticketPrice /100));
            ...
            if(jackpot == 1000) 
            {
                ...
                payable(msg.sender).transfer(win - dev);
                dev_fund.transfer(dev);
                totalPot -= win;
                emit drawEvent(win);
            }
