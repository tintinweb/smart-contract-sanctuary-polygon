...
contract Marketplace {
    ...
    struct User {
        uint256 totalSpend; // total spend by user in token
        mapping(uint256 => uint256) stockOwned; // stock owned for product by user
        uint256[] ownedProducts; // products owned by user
    }
     ...
     * @param _start start timestamp of product
     * @param _end end timestamp of product
