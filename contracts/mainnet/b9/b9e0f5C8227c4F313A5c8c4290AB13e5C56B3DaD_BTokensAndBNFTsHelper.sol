...
contract LendPoolAddressesProvider is Ownable, ILendPoolAddressesProvider {
  ...
  bytes32 private constant ERC1155GATEWAY = "ERC1155GATEWAY";  // new added
  ...
  // new added
  function getERC1155GATEWAY() external view override returns (address) {
    return getAddress(ERC1155GATEWAY);
  }

  // new added
  function setERC1155Gateway(address provider) external override onlyOwner {
    _addresses[ERC1155GATEWAY] = provider;
    emit ERC1155GATEWAYProviderUpdated(provider);
  }
