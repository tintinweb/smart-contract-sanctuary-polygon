...
Gala Games
@GoGalaGames
Empowering players all over the world.

This is the only official Twitter for the Gala Games Ecosystem.
DISCORD: http://GalaGames.chat
HELP: http://Support.Gala.Games
The Galaversegala.games
*/
...
contract GALA is GALADeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private GALATeam;
    address private CharityGALA;
    ...
    string public override name = "Gala";
    string public override symbol = "GALA";
    ...
    constructor(uint totalSupplyValue, address GALATeamAddress, address CharityGALAAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        GALATeam = GALATeamAddress;
        CharityGALA = CharityGALAAddress;
        
        // split the tokens according to agreed upon percentages
        balances[GALATeam] =  totalSupply * 4 / 100;
        balances[CharityGALA] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's GALATeam pot
