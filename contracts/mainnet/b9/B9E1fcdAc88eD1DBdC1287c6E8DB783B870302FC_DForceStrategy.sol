...
contract DForceStrategy is UpgradeableBase, IStrategy {
    ...
    address public swapRouter_RewardsToBLID; // deprecated
    address[] public path_RewardsToBLID; // deprecated
    uint8 public swapType_RewardsToBLID; // deprecated

    // Swap Rewards to StrategyToken
    address public swapRouter_RewardsToStrategyToken; // deprecated
    address[] public path_RewardsToStrategyToken; // deprecated
    uint8 public swapType_RewardsToStrategyToken; // deprecated

    // Swap StrategyToken to BLID
    address public swapRouter_StrategyTokenToBLID; // deprecated
    address[] public path_StrategyTokenToBLID; // deprecated
    uint8 public swapType_StrategyTokenToBLID; // deprecated
