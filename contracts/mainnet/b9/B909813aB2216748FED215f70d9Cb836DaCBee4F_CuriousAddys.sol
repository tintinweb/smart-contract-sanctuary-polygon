    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x0efeB0993e52b5a4C8613939Ac2a36893BDEAdA9;
    address public crossmintAddress;
    address public royaltyAddress = 0xf2f441007A4a6b88ba6115b615D7E575E937304A;
    ...
    string public name = "Curious Addys";
    string public symbol = "CATC";
    // The respective share of funds to be sent to each address in payoutAddresses in basis points
    uint256[] public payoutBasisPoints = [7500, 2500];
    uint96 public royaltyFee = 0;

    constructor()
        ERC1155(
            "ipfs://bafybeifg2qd4bddhmda7xxh7r6qnmfhxdxsvx4s4t24d7ihy3l7bb54fpu/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenPublicPrice[1] = 0.01 ether;
        tokenPublicMintsPerAddress[1] = 100;
        tokenPresaleMaxSupply[1] = 100;
        tokenPresalePrice[1] = 0.01 ether;
        tokenPresaleMintsPerAddress[1] = 0;
        tokenPublicPrice[2] = 0 ether;
        tokenPublicMintsPerAddress[2] = 0;
        tokenPresaleMaxSupply[2] = 0;
        tokenPresalePrice[2] = 0 ether;
        tokenPresaleMintsPerAddress[2] = 0;
        require(
