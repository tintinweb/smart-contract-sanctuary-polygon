...
//*********************************************************************//
//
//     __  ___________________  ____  ____  ____  __    _________
//    /  |/  / ____/_  __/ __ \/ __ \/ __ \/ __ \/ /   /  _/ ___/
//   / /|_/ / __/   / / / /_/ / / / / /_/ / / / / /    / / \__ \ 
//  / /  / / /___  / / / _, _/ /_/ / ____/ /_/ / /____/ / ___/ / 
// /_/ _/_/_____/ /_/ /_/ |_|\____/_/    \____/_____/___//____/  
//    / /_  __  __                                               
//   / __ \/ / / /                                               
//  / /_/ / /_/ /                                                
// /_.___/\__, /                                                 
//     __/____/_____  __ ____  ____  _____  __                   
//    / __ \/ ____/ |/ // __ \/ __ \/  _/ |/ /                   
//   / / / / __/  |   // /_/ / / / // / |   /                    
//  / /_/ / /___ /   |/ _, _/ /_/ // / /   |                     
// /_____/_____//_/|_/_/ |_|\____/___//_/|_|                     
//                                                               
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xAE1Fb99E8AC2E569B94e52C82E488B6CDaEe2D98];
  address public erc20Payable = 0xAE1Fb99E8AC2E569B94e52C82E488B6CDaEe2D98;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 108) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmfPbLgGthtefbFUNCZjKcrvK6n7HdAkdyHJsLZsDhrSjT/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/tEew2pVyd8JG0xWo06he/contract-metadata";
  }
...
// File: contracts/MetropolisContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MetropolisContract is ERC721APlus {
    constructor() ERC721APlus("METROPOLIS", "METROPOLIS"){}
}
