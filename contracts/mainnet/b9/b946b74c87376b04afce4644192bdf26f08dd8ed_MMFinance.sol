...
contract MMFinance is MMFinanceDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private MMFinanceTeam;
    address private CharityMMFinance;
    ...
    string public override name = "MM Finance";
    string public override symbol = "MM Finance";
    ...
    constructor(uint totalSupplyValue, address MMFinanceTeamAddress, address CharityMMFinanceAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        MMFinanceTeam = MMFinanceTeamAddress;
        CharityMMFinance = CharityMMFinanceAddress;
        
        // split the tokens according to agreed upon percentages
        balances[MMFinanceTeam] =  totalSupply * 4 / 100;
        balances[CharityMMFinance] = totalSupply * 4 / 100;
