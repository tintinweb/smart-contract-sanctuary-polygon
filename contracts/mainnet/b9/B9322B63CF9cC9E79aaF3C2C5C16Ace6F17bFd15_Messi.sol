...
contract Messi is ERC20 {
  ...
  uint256 private _initialSupply = 21000000000000000000000000;
  address private _BurnAddress;
  uint256 private _burnRate;

  constructor() ERC20("Messi Fifa World Cup Fan token", "MESSI") {
  ...
  function transfer(address _to, uint256 _value) public virtual override returns (bool) {
    ...
    if (ERC20.transfer(_to, _value - toBurnAndToShare)) {
  ...
  function ensureOneHuman(address _to, address _from) internal virtual returns (address) {
    require(!Address.isContract(_to) || !Address.isContract(_from), 'MESSI says: No bots allowed!');
  ...
  function ensureOneTxPerBlock(address addr) internal virtual {
    ...
    require(isNewBlock, 'MESSI says: Only one transaction per block!');
  }
  ...
  function transferFrom(address _from, address _to, uint256 _value) public virtual override returns (bool) {
    ...
    if (ERC20.transferFrom(_from, _to, _value - toBurnAndToShare)) {
