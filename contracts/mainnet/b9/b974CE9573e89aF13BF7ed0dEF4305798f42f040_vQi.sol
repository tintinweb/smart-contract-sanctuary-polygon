...
contract vQi is Initializable, ERC20Upgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable{
    ...
    address public eQiAddress = 0x880DeCADe22aD9c58A8A4202EF143c4F305100B3;
    address public QiAddress = 0x580A84C73811E1839F75d86d75d88cCa0c241fF4;

    uint256 constant MAX_INT = 115792089237316195423570985008687907853269984665640564039457584007913129639935;

    IeQi eQi = IeQi(eQiAddress);
    ERC20Upgradeable Qi = ERC20Upgradeable(QiAddress);
