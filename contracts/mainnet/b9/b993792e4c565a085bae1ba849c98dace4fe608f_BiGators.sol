...
contract BiGators is ERC721A, Ownable {
    using Strings for uint256;
...
constructor() ERC721A("BillionaireGatorSClub", "BiC") {
        setHiddenMetadataUri("https://api.billionairegator.club/");
        setBaseURI("https://api.billionairegator.club/");
    }
