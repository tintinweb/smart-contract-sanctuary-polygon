...
// File: contracts/MechGamePolygon.sol

pragma solidity ^0.8.9;



contract MechGamePolygonNFT is
    ERC721A("Mech Game", "MECH"),
    Owned(msg.sender)
{
    enum MintStatus {
        // 0 = closed
    ...
    function claim(
        uint256 limit,
        bytes32[] calldata proof,
        uint256 path) external {
            require(mintStatus != MintStatus.PUBLIC, "claim closed.");
    ...
    function _startTokenId() internal pure override returns (uint256) {
        // the original mech game contract token id started at 0 not 1
        return 0;
    }
}