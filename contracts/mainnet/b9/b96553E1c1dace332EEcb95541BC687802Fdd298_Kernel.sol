...
contract ACL is BaseStorage, ERC165Upgradeable, IACL {
...
contract AppManager is ERC165Upgradeable, ACL, IAppManager {
     ...
     * Add support ERC-165 interface checks.
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(ACL, ERC165Upgradeable) returns (bool) {
...
contract Kernel is Initializable, ERC165Upgradeable, AppManager, IKernel, __with_semver(uint8(1), uint8(0), uint8(1)) {
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(AppManager, ERC165Upgradeable)
        returns (bool)
    {
