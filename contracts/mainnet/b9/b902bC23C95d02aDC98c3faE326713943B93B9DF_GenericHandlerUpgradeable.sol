...
contract GenericHandlerUpgradeable is Initializable, AccessControlUpgradeable {
    ...
    function replayGenericDeposit(
        ...
        DepositRecord memory record = _depositRecords[_destChainID][_depositNonce];
    ...
    function decodeData(bytes calldata _data) internal pure returns (DepositRecord memory) {
        ...
        (
            ...
            depositData.data
        ) = abi.decode(_data, (uint8, uint64, address, address, bytes4, bytes));
    ...
    **/
    ...
    function deductFee(
        ...
        require(defaultGas[destinationChainID] != 0, "Router Generichandler : Destination Gas Not Set");
        require(defaultGasPrice[destinationChainID] != 0, "Router Generichandler : Destination Gas Price Not Set");
        ...
        if (feeTokenDecimals < 18) {
            ...
            fees = (feeFactor * _gasLimit * _gasPrice) + bridgeFees;
        }
