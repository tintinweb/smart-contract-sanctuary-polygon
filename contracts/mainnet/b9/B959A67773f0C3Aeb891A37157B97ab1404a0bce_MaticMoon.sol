...
// SPDX-License-Identifier: MIT 
 ...
 /*   MaticMoon - investment platform based on Polygon Smart Chain blockchain smart-contract technology. Safe and legit!
 
 *
 *   [USAGE INSTRUCTION]
 *
 *   1) Connect browser extension Metamask
 *   2) Choose one of the tariff plans, enter the MATIC amount (10 MATIC minimum) using our website "INVEST" button
...
contract MaticMoon {
	...
	function invest(address referrer, uint8 plan) public payable {
		...
		uint256 donation = fee.mul(CHARITY_FEE).div(PERCENTS_DIVIDER);
