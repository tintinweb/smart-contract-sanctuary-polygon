...
contract ContractRegistry is Ownable, IContractRegistry {
    ...
    function getRegisteredContract(bytes32 nameHash)
        ...
        returns (address)
    {
        address target = _registeredContracts[nameHash];
        ...
        onlyOwner
    {
        ...
        _registeredContracts[nameHash] = target;

        emit RegisteredContract(nameHash, target);
    }
    ...
    function removeRegisteredContract(bytes32 nameHash)
        ...
        onlyOwner
    {
        delete _registeredContracts[nameHash];

        emit RegisteredContract(nameHash, address(0));
    }
