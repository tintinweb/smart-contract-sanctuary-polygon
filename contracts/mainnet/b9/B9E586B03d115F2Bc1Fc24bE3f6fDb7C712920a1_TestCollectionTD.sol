 ...
 * @notice This contract handles minting Test Collection TD tokens.
 */
contract TestCollectionTD is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x7a64b54804896747E9d49DE145d83a9F44b59864;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x177d0565A5E9b511a38DF29f591FAc1135Ec5022;
    address[] public payoutAddresses = [
        0x177d0565A5E9b511a38DF29f591FAc1135Ec5022
    ];
    ...
    string public name = "Test Collection TD";
    string public symbol = "TCTD";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeie57qqxscdfqozgnunha7py2sap2xcgrsonrj2ao4kdqyca2k3cge/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[1] = 5000;
        tokenPublicPrice[1] = 0 ether;
        tokenPublicMintsPerAddress[1] = 1;
        tokenPublicSaleStartTime[1] = 1684263600;
        tokenPublicSaleEndTime[1] = 1684265400;
        tokenUsePublicSaleTimes[1] = true;
        tokenPresaleMaxSupply[1] = 5000;
