...
/**
 * @title The PalletRegistry manages the inventoryPallets creation, the collateal deposited. 
...
contract PalletRegistry is IPalletRegistry, IPalletRegistryEvents {
    ...
    /**
     * Emergency function that transfers any funds in this contract to the emergencyMultisig
