...
contract ERC721Factory is IERC721Factory {
    ...
    function createERC721(string memory _name,string memory _symbol,string memory _uri,string memory _primaryKey) external override returns(address erc721) {
        ...
        ERC721YuanChuang(erc721).initialize(_name, _symbol, _uri, msg.sender);
