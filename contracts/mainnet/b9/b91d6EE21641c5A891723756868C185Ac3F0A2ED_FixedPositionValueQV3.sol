...
interface IDataStorageOperator {
  ...
  event FeeConfiguration(Configuration feeConfig);
  ...
  function changeFeeConfiguration(Configuration calldata feeConfig) external;
...
/// @title Returns information about the token value held in a Quickswap V3 NFT
library FixedPositionValueQV3 {
    uint256 internal constant Q128 = 0x100000000000000000000000000000000;

    /// @notice Returns the total amounts of token0 and token1, i.e. the sum of fees and principal
    /// that a given nonfungible position manager token is worth
    /// @param positionManager The Quickswap V3 NonfungiblePositionManager
