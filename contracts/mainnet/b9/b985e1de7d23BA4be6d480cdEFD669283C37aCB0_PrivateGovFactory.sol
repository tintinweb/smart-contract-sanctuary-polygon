  ...
  IGovFactory
{
  ...
  address public override saleGateway; // sale gateway
  ...
  function init(
    ...
    address _savior,
    address _keeper,
    address _saleGateway, // sale gateway at another chain
  ...
  function createProject(
    ...
    require(
      _payment != address(0) && _payment == allPayments[getPaymentIndex[_payment]] && _calculation < _start,
      "bad"
    );
