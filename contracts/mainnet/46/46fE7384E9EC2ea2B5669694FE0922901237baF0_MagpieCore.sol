    ...
    IMagpieCore
{
        ...
        )
    {
        ...
        address[] memory intermediaries = useTokenBridge ? config.wormholeIntermediaries : config.hyphenIntermediaries;
        

        require(
            intermediaries.includes(args.swapArgs.getToAssetId()) ==
                true,
        ...
        returns (uint256[] memory amountOuts)
    {
        ...
        address[] memory intermediaries = payload.useTokenBridge == true ? config.wormholeIntermediaries : config.hyphenIntermediaries;
