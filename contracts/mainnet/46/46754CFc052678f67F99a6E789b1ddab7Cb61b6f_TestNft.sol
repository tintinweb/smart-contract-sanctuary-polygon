...
//addmodimport {Strings} from "openzeppelin-contracts/utils/Strings.sol";
...
contract MetadataGenerator {
    ...
    constructor() {
        address00 = Strings.toHexString(uint256(uint160(msg.sender)), 20); //abi.encodePacked(msg.sender);
        address01 = Strings.toHexString(uint256(uint160(address(this))), 20);
    }
    ...
    function _getComponentA() public view returns (string memory) {
        string memory svg00 = string(abi.encodePacked(
