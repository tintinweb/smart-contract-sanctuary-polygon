...
contract ControllerV6 {
  ...
  /**
   * @notice  Set the new dev fund address, only by governance
   * @param   _devfund  new address
   */
  ...
  /**
   * @notice  Set the new treasury address, only by governance
  ...
  /**
   * @notice  Set the new strategist address, only by governance
  ...
  /**
   * @notice  Set the new governance address, only by governance
  ...
  /**
   * @notice  Set the new timelock address, only by timelock
  ...
  /**
   * @notice  Set vault for certain pool
   * @param   _pool  uniswapV3 pool
   * @param   _vault  vault address
   */
  function setVault(address _pool, address _vault) public {
    require(msg.sender == strategist || msg.sender == governance, "!strategist");
    vaults[_pool] = _vault;
  }

  /**
   * @notice  Appprove strategy for pool & strategy
   * @param   _pool  uniswapV3 pool
  ...
  /**
   * @notice  revoke address of strategy with pool
   * @param   _pool  uniswapV3 pool
   * @param   _strategy  strategy address
   */
  ...
  /**
   * @notice  in case of strategy stuck and if we need to relink the new strategy
   * @param   _pool  uniswapV3 pool
   */
  ...
  /**
   * @notice  Updates to new strategy, and withdraws from previous address
   *          requires to nobe approved anymore
   * @param   _pool  corresponding Uni V3 strategy
   * @param   _strategy strategy address
   */
  ...
  /**
   * @notice  Deposit into new strategy
   * @param   _pool  uniswap V3 pool
   * @param   _token0Amount  token0 amount
   * @param   _token1Amount  token1 amount
   */
  function earn(
    address _pool,
  ...
  /**
   * @notice  Liquidity of strategy
   * @param   _pool  pool address
   * @return  uint256  amount of liquidity
   */
  ...
  /**
   * @notice  Withdraw all assets from pool
   * @param   _pool  Uniswap V3 pool
  ...
  /**
   * @notice  unstuck tokens from this contract
   * @param   _token  address of the token to be unstuck
   * @param   _amount  amount of the token to be unstuck
   */
  ...
  /**
   * @notice  unstuck tokens from specified strategy
   * @param   _strategy  amount of the token to be unstuck
   * @param   _token  address of the token to be unstuck
   */
   ...
   * @return  a0  token0 amount withdrawn
   * @return  a1  token1 amount withdrawn
   */
