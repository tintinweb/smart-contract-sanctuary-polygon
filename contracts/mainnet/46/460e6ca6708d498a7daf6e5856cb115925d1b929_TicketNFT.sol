...
contract POAP is ERC721 {
    ...
    uint256 public poapCounter;      // deafault value: 0
    ITicketNFT public ticketNFT;     // deafault value: 0x0000...
...
contract TicketNFT is ERC721, ITicketNFT {
    ...
    // Initialize the inherited ERC721 contract with _neme and _symbol
    ) ERC721(_name, _symbol) {
