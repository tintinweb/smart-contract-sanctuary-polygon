...
contract MATICAUTOFARM {
	using SafeMath for uint256;
	
	IBEP20 public BUSD = IBEP20(0xc2132D05D31c914a87C6611C10748AEb04B58e8F); 
	...
	uint256 public constant BNB_PER_TICKET = 1e17; // 0.1 MATIC
    ...
    uint256 public constant STAKE_MIN_AMOUNT = 1e17; // 0.1 USDT
...
function invest(address payable referrer,uint8 plan) public payable {
	...
	function stake(uint256 busdAmount) public {
	    require(busdAmount >= STAKE_MIN_AMOUNT, "Min. is 0.1 USDT");
