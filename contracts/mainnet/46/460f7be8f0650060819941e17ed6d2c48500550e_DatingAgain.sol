...
contract DatingAgain is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721("DatingAgain", "DAS") {}
    ...
    function mint(address _to, uint256 _mintAmount) public payable {
        ...
        require(
            msg.value == cost,
            "Transaction value is not equal the mint price"
        );
    ...
    function checkClaimEligibility(uint256 quantity)
        external
        view
        returns (string memory)
    {
        ...
        } else if (supply + quantity > maxSupply) {
