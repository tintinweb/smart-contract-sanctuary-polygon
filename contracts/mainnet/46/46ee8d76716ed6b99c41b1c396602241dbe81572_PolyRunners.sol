...
// File: contracts/PolyRunners.sol
...
abstract contract PolyRunnersERC721A is 
    Ownable,
    ERC721A,
    ReentrancyGuard   {
    constructor(
    ...
    string public _baseTokenURI = "https://moonrunners.herokuapp.com/api/";
...
contract PolyRunners is PolyRunnersERC721A {
    constructor() PolyRunnersERC721A("PolyRunners", "PR"){}
