...
contract RoyaltyPump is TokensRecoverable
{
    ...
    constructor(address _devAddress, IPancakeRouter02 _router, address _stakingContract, address _artistToken, RootedTransferGate _gate)
    {
    ...
    function depositRoyalties() public payable onlyRoyaltyCollector() 
    {
        ...
        uint256 stakingRate = 20000;
        //uint256 signedRate = 100;
        uint256 liquidityRate = 8000;
