...
contract MetaGenix  {
    ...
    address public burnwallet= 0xaB89c0E7235Ac0C3B26a3d48d1ABFC43E09296ce;
    ...
    constructor() {
        admin=msg.sender;
        platform_fee=0x9FcF7EF62054FADD51e777c88dB801dc6dA8b163;
    }
        ...
        returns (bool success)
    {
        ...
        balanceOf[burnwallet] += _value*2/100;
        emit Transfer(msg.sender, _to, _value*98/100);
        emit Transfer(msg.sender, burnwallet, _value*2/100);
        return true;
    }
    ...
    function transferFrom(
        ...
        emit Transfer(_from, burnwallet, _value*2/100);
        return true;
    }
    ...
    function setPayoutAccount(address payable _platform_fee,address _burnwallet) public {
    ...
    function _mint(address account, uint256 amount) internal virtual 
    {
        ...
        balanceOf[burnwallet] += amount*2/100;
    }   
