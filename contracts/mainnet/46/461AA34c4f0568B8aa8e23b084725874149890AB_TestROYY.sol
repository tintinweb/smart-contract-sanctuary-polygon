...
contract TestROYY is Ownable, ERC721A, PaymentSplitter, DefaultOperatorFilterer {
    ...
    uint public  MAX_TOTAL_WL = 300;

    uint public MAX_PER_WALLET = 1;

    uint public wlSalePrice = 385000000000000000000;
    uint public publicSalePrice = 445000000000000000000;
    ...
    constructor(uint96 _royaltyFeesInBips, address[] memory _team, uint[] memory _teamShares, bytes32 _merkleRootWL , string memory _baseURI) ERC721A("TESTROY", "TRY")
   ...
   function whitelistMint(address _account, uint _quantity, bytes32[] calldata _proof) external payable callerIsUser {
        ...
        require(balanceOf(msg.sender) + _quantity <= MAX_PER_WALLET, "Max per wallet reached.");
