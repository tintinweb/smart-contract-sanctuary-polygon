...
contract sMATIC is Owned, ReentrancyGuard {
    string public name     = "SHIBNOBI MATIC";
    string public symbol   = "sMATIC";
    ...
    uint256 private Devtax = 50; // Oogway tax, dev tax, burn tax and markettax sum must be 1000
    uint256 private Markettax = 450; //
    ...
    address public TOKEN = 0xab167E816E4d76089119900e941BEfdfA37d6b32;
    ...
    function setTOKENAddress(address _Oogway) external onlyOwner {
        require(_Oogway != address(0), "Error: Please Set valid address");
        TOKEN = _Oogway;
    }


    function setWETHAddress(address _Oogway) external onlyOwner {
        require(_Oogway != address(0), "Error: Please Set valid address");
        WETH = _Oogway;
    }

    function setUNISWAPAddress(address _Oogway) external onlyOwner {
        require(_Oogway != address(0), "Error: Please Set valid address");
        UNISWAP_V2_ROUTER = _Oogway;
    }
    //-------------------------------
    ...
    function deposit() public nonReentrant payable {
        ...
        /// burn start here
         ...
         if(burn_value > 0){
         swap(WETH, TOKEN, burn_value, address(0x000000000000000000000000000000000000dEaD));
         }
        ///-------------------------
