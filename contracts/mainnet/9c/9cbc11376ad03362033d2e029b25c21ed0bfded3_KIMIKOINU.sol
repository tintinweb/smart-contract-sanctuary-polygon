...
// Telegram - https://t.me/KIMIKOINU_Portal

// Anti-rug feature - max tx and max wallet cannot be set below 0.5%
...
contract KIMIKOINU is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KIMIKO-INU";
    string private _symbol = "$KI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x460E21d7515D44426a9417219E0463a29bDe3A12);
    address payable public TeamWalletAddress = payable(0xF822a05D931748225a0F5402298d1C671513afb8);
    ...
    uint256 public _totalSupply = 1000 * 10**5 * 10**9;
    uint256 public _maxTxAmount = 20 * 10**5 * 10**9;
    uint256 public _walletMax = 30 * 10**5 * 10**9;
    uint256 public minimumTokensBeforeSwap = 33000 * 10**9; 
    ...
    constructor (address msgsender) {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(msgsender); 
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= (5 * 10**5 * 10**9));
