...
contract Treasury is ContractGuard {
    ...
    address[] public excludedFromTotalSupply = [
        address(0x4BCc7618F8248f0A6F011b47D707756a18bA9e4f) // TombGenesisPool
    ];
    ...
    function initialize(
        ...
        supplyTiers = [0 ether, 250000 ether, 500000 ether, 750000 ether, 1000000 ether, 2500000 ether, 5000000 ether, 10000000 ether];
        maxExpansionTiers = [250, 200, 150, 120, 100, 80, 60, 50];
        ...
        maxDebtRatioPercent = 9900; // Upto 99% supply of tBOND to purchase

        premiumThreshold = 110;
        premiumPercent = 7000;

        // First 1 epochs with 2.5% expansion
        bootstrapEpochs = 1;
    ...
    function setSupplyTiersEntry(uint8 _index, uint256 _value) external onlyOperator returns (bool) {
        ...
        require(_index < 8, "Index has to be lower than count of tiers");
        if (_index > 0) {
