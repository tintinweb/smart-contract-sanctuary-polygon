...
contract Usofnem is Ownable, ERC721 {
    ...
    /// @notice 2.5 MATIC for 1 - 4 character
    /// @notice 2 MATIC for 5 - 7 character
    /// @notice 1.5 MATIC for 8 character
    /// @notice 1 MATIC for 9 - 1000 character
        ...
        returns (string memory)
    {
        ...
        if (uptodate(records[id[tokenId]].tld)) {
            ...
            tld = string(abi.encodePacked(".gram"));
        }
