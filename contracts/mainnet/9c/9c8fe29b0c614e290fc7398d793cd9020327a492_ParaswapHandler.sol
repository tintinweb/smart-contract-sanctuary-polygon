...
abstract contract AllowanceHelper {
    ...
    function _allow(IERC20 token, address spender) internal {
...
import {IERC20, SafeERC20, AllowanceHelper} from "src/common/AllowanceHelper.sol";
...
contract ParaswapHandler is AllowanceHelper, ContextHelper {
    ...
    function exchange(
        ...
        if (srcToken == ETH_ADDRESS) {
            ...
            _allow(IERC20(srcToken), TOKEN_TRANSFER_PROXY);
        ...
        if (recipient == Constants.MSG_SENDER) {
            ...
            if (destToken == ETH_ADDRESS) {
                ...
                received = IERC20(destToken).balanceOf(address(this));
                IERC20(destToken).safeTransfer(recipient, received);
            }
        }
