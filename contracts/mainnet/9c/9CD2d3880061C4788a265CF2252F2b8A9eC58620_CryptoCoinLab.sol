...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8aCeb59D4Ab69CEac23dA7E01C1b6A0238C0D716;
...
contract CryptoCoinLab is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x968817e173b71A17d030Df6e7e745E4e4AAa8FDA;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Coin Lab";
    string private _symbol = "coinlab.ml";
