...
contract DCAAction is BaseSiloAction {
  ...
  constructor(string memory _name, address _siloFactory) {
    name = _name;
    metaData = "address[4],address[4],uint[4],bytes[]";
  ...
  function exit(
    ...
    // outputAmounts = dacAction(implementation, configuration, outputData);
  }
