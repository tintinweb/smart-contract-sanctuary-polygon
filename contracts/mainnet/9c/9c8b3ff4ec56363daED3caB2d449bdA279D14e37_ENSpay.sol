...
contract ENSpay {
    ...
    function addToBlockchain(address receiver, uint amount, string memory message) public {
        transactionCount += 1;
        transactions.push(TransferStruct(msg.sender, receiver, amount, message, block.timestamp));
        emit Transfer(msg.sender, receiver, amount, message, block.timestamp);
    }

    function transferAndRecord(address recipient, uint256 amount, string memory message) public {
