...
contract BaseRegistrarImplementation is ERC721, IBaseRegistrar, Ownable  {
    ...
    function _register(uint256 id, address owner, uint duration, bool updateRegistry) internal live onlyController returns(uint) {
        ...
        _mint(owner, id);
        if(updateRegistry) {
            ens.setSubnodeOwnerRegistrar(bytes32(id), owner);
        }
...
contract ETHRegistrarController is Ownable, IETHRegistrarController {
    ...
    function register(
        ...
        IPriceOracle.Price memory price = rentPrice(name.name, duration);
        require(
        ...
        tomi.transferFrom(msg.sender, address(this), price.base + price.premium);
