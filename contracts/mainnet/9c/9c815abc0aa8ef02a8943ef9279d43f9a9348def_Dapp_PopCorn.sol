...
contract Dapp_PopCorn {
    using SafeMath for uint256;
    uint256 constant launch = 1662667200;
  	uint256 constant hardDays = 86400;
    uint256 constant minStakeAmt = 5 * 10**18;
    uint256 constant percentdiv = 1000;
    uint256 refPercentage = 140;
    uint256 devPercentage = 75;
    ...
    constructor() {
            owner = msg.sender;
            PercsKey[10] = DivPercs(864000, 50);
            PercsKey[20] = DivPercs(1728000, 60);
            PercsKey[30] = DivPercs(2592000, 70);
            PercsKey[40] = DivPercs(3456000, 80);
            PercsKey[50] = DivPercs(4320000, 90);
            FeesKey[10] = FeesPercs(864000, 300);
            FeesKey[20] = FeesPercs(1728000, 280);
            FeesKey[30] = FeesPercs(3456000, 250);
            FeesKey[40] = FeesPercs(4320000, 220);
    ...
    function stakeStablecoins(uint256 amtx, address ref) external {
        ...
        require(amtx >= minStakeAmt, "You should stake at least 5.");
