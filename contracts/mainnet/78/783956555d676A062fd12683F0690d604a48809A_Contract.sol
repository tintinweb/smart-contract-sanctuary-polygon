...
contract Contract is IERC20, Ownable {
    ...
    mapping(address => uint256) private _neck;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(uint256 => address) private _travel;
    mapping(uint256 => address) private _too;
    mapping(address => uint256) private _chosen;
