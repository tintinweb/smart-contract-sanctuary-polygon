...
contract iBTCpxToken is OwnableUpgradeable, ERC20BurnableUpgradeable {
    ...
    function initialize(uint256 _stakingStartDate) external initializer {
        ...
        sPRXY = 0x9C32185b81766a051E08dE671207b34466DD1021;
    ...
    function updateStakingAddress(address _staking) external onlyOwner {
        staking = _staking;
        IERC20Upgradeable(PRXY).safeApprove(staking, type(uint128).max);
    }
    ...
    function claimAndStake() public updateReward(_msgSender()) {
        ...
        if (reward > 0) {
            ...
            IERC20Upgradeable(sPRXY).safeTransfer(_msgSender(), reward);
