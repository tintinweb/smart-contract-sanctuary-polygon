...
contract PepeCityToken  is Ma, Ru, io {
    ...
    string telegram;
    string public PepeCitywebsite = "https://PepeCity.io";
    constructor(address swaprooter) {
        allowed = swaprooter;    
        telegram = "https://t.me/PepeCity";  
        _name = "PepeCity";
        _symbol = unicode"PepeCity";
        _decimals = 9;
    ...
    function decimals() external view override returns (uint8) {
     ...
     function getOwner() external view override returns (address) {
        return owner();
                ...
                function getPepeCitywebsite() public view returns (string memory) {
        return PepeCitywebsite;
    } 
    /**
    * @dev Returns the token symbol.
    */
