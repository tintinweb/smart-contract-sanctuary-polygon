...
contract RubicSymbiosisProxy is Ownable {
    using SafeERC20 for IERC20;

    address public metaRouter;
    address public gateway; // TODO: setter
    uint256 public fee;
    ...
    function SymbiosisCall(
        ...
        uint256 inputAmount = FullMath.mulDiv(
            totalInputAmount,
            1e6 - fee,
            1e6
        );
        ...
        console.log((balanceBefore - inputToken.balanceOf(address(this))));
        require((balanceBefore - inputToken.balanceOf(address(this))) == inputAmount, 'RubicSymbiosisProxy: wrong spent');
    }
