...
contract TinyOwls is ERC721A, Ownable {
    uint256 public oWLS_PRICE = 0 ether;
    ...
    constructor() ERC721A("Tiny Owls", "TOWLS", MAX_MINTS, MAX_SUPPLY) { 
    ...
    function mint(uint256 numTokens) public payable {
        ...
        require(msg.value >= numTokens * oWLS_PRICE, "Invalid funds provided");
