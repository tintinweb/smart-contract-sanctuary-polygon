...
import './interfaces/IAscentV3PoolDeployer.sol';
import './interfaces/IAscentV3Factory.sol';
import './interfaces/IERC20Minimal.sol';
import './interfaces/callback/IAscentV3MintCallback.sol';
import './interfaces/callback/IAscentV3SwapCallback.sol';
import './interfaces/callback/IAscentV3FlashCallback.sol';

import '@ascentexchange/v3-lm-pool/contracts/interfaces/IAscentV3LmPool.sol';

contract AscentV3Pool is IAscentV3Pool {
    ...
    /// @inheritdoc IAscentV3PoolImmutables
    ...
    modifier onlyFactoryOrFactoryOwner() {
        require(msg.sender == factory || msg.sender == IAscentV3Factory(factory).owner());
        _;
    }

    constructor() {
        int24 _tickSpacing;
        (factory, token0, token1, fee, _tickSpacing) = IAscentV3PoolDeployer(msg.sender).parameters();
    ...
    /// @inheritdoc IAscentV3PoolDerivedState
    ...
    /// @inheritdoc IAscentV3PoolActions
    ...
    function mint(
        ...
        IAscentV3MintCallback(msg.sender).ascentV3MintCallback(amount0, amount1, data);
    ...
    function swap(
        ...
        if (zeroForOne) {
            ...
            IAscentV3SwapCallback(msg.sender).ascentV3SwapCallback(amount0, amount1, data);
    ...
    function flash(
        ...
        IAscentV3FlashCallback(msg.sender).ascentV3FlashCallback(fee0, fee1, data);
    ...
    /// @inheritdoc IAscentV3PoolOwnerActions
    ...
    function setLmPool(address _lmPool) external override onlyFactoryOrFactoryOwner {
      lmPool = IAscentV3LmPool(_lmPool);
...
contract AscentV3PoolDeployer is IAscentV3PoolDeployer {
    struct Parameters {
        address factory;
        address token0;
        address token1;
    ...
    /// @inheritdoc IAscentV3PoolDeployer
    ...
    /// @param factory The contract address of the AscentExchange V3 factory
    ...
    function deploy(
        ...
        pool = address(new AscentV3Pool{salt: keccak256(abi.encode(token0, token1, fee))}());
        delete parameters;
    }
}
...
/// @title Callback for IAscentV3PoolActions#flash
/// @notice Any contract that calls IAscentV3PoolActions#flash must implement this interface
interface IAscentV3FlashCallback {
    /// @notice Called to `msg.sender` after transferring to the recipient from IAscentV3Pool#flash.
    ...
    /// @param data Any data passed through by the caller via the IAscentV3PoolActions#flash call
    function ascentV3FlashCallback(
        uint256 fee0,
        uint256 fee1,
        bytes calldata data
    ) external;
...
/// @title Callback for IAscentV3PoolActions#mint
/// @notice Any contract that calls IAscentV3PoolActions#mint must implement this interface
interface IAscentV3MintCallback {
    /// @notice Called to `msg.sender` after minting liquidity to a position from IAscentV3Pool#mint.
    /// @dev In the implementation you must pay the pool tokens owed for the minted liquidity.
    /// The caller of this method must be checked to be a AscentV3Pool deployed by the canonical AscentV3Factory.
    /// @param amount0Owed The amount of token0 due to the pool for the minted liquidity
    /// @param amount1Owed The amount of token1 due to the pool for the minted liquidity
    /// @param data Any data passed through by the caller via the IAscentV3PoolActions#mint call
    function ascentV3MintCallback(
        uint256 amount0Owed,
        uint256 amount1Owed,
        bytes calldata data
    ) external;
...
/// @title Callback for IAscentV3PoolActions#swap
/// @notice Any contract that calls IAscentV3PoolActions#swap must implement this interface
interface IAscentV3SwapCallback {
    /// @notice Called to `msg.sender` after executing a swap via IAscentV3Pool#swap.
    ...
    /// @param data Any data passed through by the caller via the IAscentV3PoolActions#swap call
...
/// @title The interface for the AscentExchange V3 Factory
/// @notice The AscentExchange V3 Factory facilitates creation of AscentExchange V3 pools and control over the protocol fees
interface IAscentV3Factory {
...
/// @title An interface for a contract that is capable of deploying AscentExchange V3 Pools
/// @notice A contract that constructs a pool must implement this to pass arguments to the pool
/// @dev This is used to avoid having constructor arguments in the pool contract, which results in the init code hash
/// of the pool being constant allowing the CREATE2 address of the pool to be cheaply computed on-chain
interface IAscentV3PoolDeployer {
...
/// @title Minimal ERC20 interface for AscentExchange
/// @notice Contains a subset of the full ERC20 interface that is used in AscentExchange V3
...
interface IAscentV3PoolActions {
    ...
    /// @dev The caller of this method receives a callback in the form of IAscentV3MintCallback#ascentV3MintCallback
    ...
    /// @dev The caller of this method receives a callback in the form of IAscentV3SwapCallback#ascentV3SwapCallback
    ...
    /// @dev The caller of this method receives a callback in the form of IAscentV3FlashCallback#ascentV3FlashCallback
...
interface IAscentV3PoolDerivedState {
...
interface IAscentV3PoolImmutables {
    /// @notice The contract that deployed the pool, which must adhere to the IAscentV3Factory interface
...
interface IAscentV3PoolOwnerActions {
