...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x192bBd7EFC868ac484c4E960de7c33974e09B3D9];
  address public erc20Payable = 0x192bBd7EFC868ac484c4E960de7c33974e09B3D9;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 20, 20000) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeif6c4pj2i7tzrixvu7a527ucm3ves6w2duvbjtvrjufyc5vubsqsy/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/SVe9hcYKfMp2gcgPSwtx/contract-metadata";
  }
...
// File: contracts/AlphabetBallClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AlphabetBallClubContract is RamppERC721A {
    constructor() RamppERC721A("Alphabet Ball Club", "ABC"){}
}
