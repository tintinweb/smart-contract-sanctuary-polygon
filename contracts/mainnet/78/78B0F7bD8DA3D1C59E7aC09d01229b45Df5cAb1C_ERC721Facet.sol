...
contract ERC721Facet is ERC721WithDiamondStorage {
    ...
    function _mintNextToken(address _to)
        internal
...
contract ERC721WithDiamondStorage is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    function _burn(uint256 tokenId) internal virtual {
        LibERC721.enforceUnicornIsTransferable(tokenId);
        address owner = ERC721WithDiamondStorage.ownerOf(tokenId);
