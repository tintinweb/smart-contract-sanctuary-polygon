...
contract BUNY is ERC721 {

  using Counters for Counters.Counter;
  Counters.Counter private _tokenIds;

  
  uint256 public _maxSupply = 77;
  uint256 public cost = 50000000000000000 wei; 


  constructor(bytes32[] memory assetsForSale) public ERC721("The Buny Project", "BUNY") {
    _setBaseURI("https://buni.mypinata.cloud/ipfs/");
