...
contract OPCTCOIN is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    constructor() ERC20("OPCT COIN", "OPC") ERC20Permit("OPCT COIN") {
        _mint(msg.sender, 8500000000 * 10 ** decimals());
    }
