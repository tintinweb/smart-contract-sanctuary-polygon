...
contract FalineArena9 is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public cost = 3.2 ether;
  uint256 public maxSupply = 247;
  uint256 public maxMintAmountPerTx = 20;

  bool public paused = true;
  bool public revealed = false;

  constructor() ERC721("Faline Arena 9", "FA9") {
    setHiddenMetadataUri("ipfs://bafybeihvdnu2kfnubl2w4egeicnwipsimrkx3rgu5btbiqofykhoxlajey");
  }
