...
contract MetaWomen is ERC721, Ownable, ContextMixin {
    ...
    uint public MINT_PRICE = 150 ether;
    SaleStatus public saleStatus = SaleStatus.PAUSED;
    
    string private _baseURL;
    string private _hiddenURI = "ipfs://QmZNMaskx5aqoiqQfZ7918bYU581VQrJqc4enKLvZmPY5T";
    mapping(address => uint) private _mintedCount;
    

    constructor() ERC721("MetaWomen",
    "MW"){}
    ...
    function contractURI() public pure returns (string memory) {
        return "https://zerocodenft.azurewebsites.net/api/marketplacecollections/22de431b-4399-4a98-6946-08da2cbfdff6";
    }
    ...
    function withdraw() external onlyOwner {
        ...
        payable(0x19b731220A923B4A3F58EAB4dF8141570430Ce70).transfer((balance * 4700)/10000);
        payable(0x4b32398996959F5D3A10B628C1EB862FEe194E30).transfer((balance * 3000)/10000);
        payable(0x06DD41e3370d2Db6614c0029DC2B2085cE1Cd061).transfer((balance * 2200)/10000);
        payable(0x083D0F364E37ED93156c3CD4d1172d263b29400b).transfer((balance * 100)/10000);
    }
