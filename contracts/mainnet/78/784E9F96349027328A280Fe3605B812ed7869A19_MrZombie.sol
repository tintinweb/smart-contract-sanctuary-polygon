...
contract MrZombie is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeieep45octzferxrruy4bq73lqygyj3vqajqz3d26d2uj3ffuta5uy/", Strings.toString(tokenId), ".json")
            );
    }
