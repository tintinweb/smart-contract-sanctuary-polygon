...
/**
    ...
    SPECS:
    - 3-6% daily
    - 35000 MATIC Max Wallet TVL
    - 2000 MATIC Max Reward Accumulation 
...
contract PTest {
    ...
    uint256 private MIN_DEPOSIT = 1000000000000000000; // 5 MATIC
    uint256 private MIN_BAKE = 1000000000000000000; // 5 MATIC
    ...
    uint256 private MIN_REF_DEPOSIT_FOR_BONUS = 5000000000000000000; // 150 MATIC
