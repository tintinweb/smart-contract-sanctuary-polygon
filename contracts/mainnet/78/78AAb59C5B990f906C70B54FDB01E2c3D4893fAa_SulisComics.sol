...
// Crafted by Zalgo for SulisNFT on 3/18/2022
...
contract OGs is Ownable {
  mapping(address=>bool) public ogs;

  function addOG(address h) public onlyOwner {
    ogs[h] = true;
  }
  ...
  modifier isOG() {
    ...
    require(owner() == sender || ogs[sender], "OGs: Unauthorized");
    _;
  }
}
// File: SulisComics.sol
...
contract SulisComics is Ownable, ERC1155, OGs {
