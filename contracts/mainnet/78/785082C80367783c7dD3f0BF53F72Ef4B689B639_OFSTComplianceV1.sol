...
contract OFSTComplianceV1 is CountryRestrictions, DayMonthLimits {
    uint[] public features;

    constructor () public {
        features = [1,2];

        uint16[] memory restrictedCountries = new uint16[](35);
        uint16[35] memory inputRestrictedCountries = [uint16(408), 364,760,862,156,643,4,586,70,112,108,140,180,192,818,624,332,368,422,434,807,466,498,499,104,558,688,706,728,729,788,792,804,887,716];
