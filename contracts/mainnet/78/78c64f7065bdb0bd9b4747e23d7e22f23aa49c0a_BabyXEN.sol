...
/**
             			 BabyXENCrypto | Cryptocurrency for the Apes!
# BabyXENCrypto is a deflationary baby token with XEN Crypto ($XEN) as the main underlying function.
# BabyXENCrypto was created to be a gathering place for the community of EVM chain lovers and so that they can create an extraordinary community!
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 XEN = IBEP20(0x2AB0e9e4eE70FFf1fB9D67031E44F6410170d00e);
...
contract BabyXEN is IBEP20, Auth {
    using SafeMath for uint256;

    address XEN = 0x2AB0e9e4eE70FFf1fB9D67031E44F6410170d00e;
    address WMATIC = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Baby XEN Crypto";
    string constant _symbol = "BABYXEN";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xDFba402881a5b5703f10A352e6994dDb3B05F291;
