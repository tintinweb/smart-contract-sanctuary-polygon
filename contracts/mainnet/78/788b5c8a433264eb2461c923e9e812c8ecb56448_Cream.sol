...
contract Cream is ERC20Burnable, Operator, Ownable {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 60,000 CreamSHAREs
    ...
    bool public startTimeset = false;

    
    constructor(address _communityFund, address _devFund) ERC20("CREAM SHARES", "CREAM") {
        _mint(msg.sender, 1 ether); // mint 1 MILK Share for initial pools deployment
    ...
    function setStartTime(uint256 _startTime) external {
        require(!startTimeset, "you can only set startTime once");
