...
/**
 * @title XEQ : 0xEquity ERC20 token
 */
contract XEQ is MintableBurnableSyntheticTokenPermit {
    /// @notice Maximum supply of XEQ token.
    uint256 private immutable _cap = 100 * 10 ** 6 * (10 ** 18); // 100 million;
    ...
    function mint(
        ...
        require(totalSupply() + value <= _cap, "XEQ: cap exceeded");
        _mint(recipient, value);
        return true;
    }

    /**
     * @dev Returns the cap on the XEQ's total supply.
     */
