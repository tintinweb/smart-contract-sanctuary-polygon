...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0xbF698C6d8F53498eCC0c6DB713c5a5f314Def018];
  address public erc20Payable = 0xbF698C6d8F53498eCC0c6DB713c5a5f314Def018;
...
abstract contract EarlyMintIncentive is Teams, ERC721A, ProviderFees {
  ...
  uint256 public EARLY_MINT_PRICE = 15 ether;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeigpntwoc2zhk4bwours2yzc4te3qbteips7gwclbjva4hujiqj3tq/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/b9bnRVhLyMBchHQxmlPg/contract-metadata";
  }
...
// File: contracts/BonanzaContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BonanzaContract is ERC721APlus {
    constructor() ERC721APlus("Bonanza", "T10"){}
}
  /*******************************************************/
  /*                                                     */
