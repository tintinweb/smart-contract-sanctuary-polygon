...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1685616900;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x5A001963e42dd882182dB37462F3cb65d260aa2a];
  address public erc20Payable = 0x5A001963e42dd882182dB37462F3cb65d260aa2a;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeifpwar6hapy43t6zb5kzra5ys2dcnzd63jy27wv5ck6jygz4bb3k4/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/3YexFefMFmMKwIFkmVxP/contract-metadata";
  }
...
// File: contracts/SpaceboyWomaContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SpaceboyWomaContract is ERC721APlus {
    constructor() ERC721APlus("Space boy Woma", "SBWO"){}
}
  /*******************************************************/
  /*                                                     */
