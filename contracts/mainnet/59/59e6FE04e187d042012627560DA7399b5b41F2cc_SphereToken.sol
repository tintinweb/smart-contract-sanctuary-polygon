...
contract SphereToken is ERC20Upgradeable, OwnableUpgradeable, ISphereToken {
    ...
    function _transferFrom(
        ...
        if (sphereGamesCheck[recipient] && isGameDepositLimited) {
            ...
            gameDepositHistory.push(GameDeposit({timestamp : block.timestamp, depositAmount : amount}));
        }
    ...
    function getUserTotalOnDifferentContractsSphere(address sender) public view returns (uint256) {
    ...
    function takeGameFee(
        ...
        ISphereSettings.GameFees memory fees = settings.currentGameFees();
