...
// File: contracts/a_test.sol

pragma solidity >=0.8.0 <0.9.0;

contract A_TEST is ERC721AQueryable, Ownable, ReentrancyGuard, OperatorFilterer {
  ...
  uint256 public PHASE_MAX_SUPPLY = 666;
  ...
  constructor( address _signerAddress ) ERC721A ( "A_TEST", "AT" ) OperatorFilterer(address(0x3cc6CddA760b79bAfa08dF41ECFA224f810dCeB6), true) {
