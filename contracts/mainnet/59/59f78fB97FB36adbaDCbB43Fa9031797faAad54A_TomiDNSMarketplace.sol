...
interface IBaseRegistrarImplementation is IERC721 {
...
contract TomiDNSMarketplace is ERC721Holder, ReentrancyGuard, Ownable {
    ...
    IBaseRegistrarImplementation public constant tomiDNS =
        IBaseRegistrarImplementation(0xcA9978B3EB8497B5e50dD65a6194981d0F9d32fE);
    ...
    /// @notice Base price for auctioning
    ...
    function updateContractor(address _contractor) external onlyOwner {
        require(_contractor != contractor, "TomiDNSMarketplace: Contractor is already this value");
    ...
    function setOnAuction(
        ...
        auction.mintAmount = reservePrice;
    ...
    function bid(uint256 _tokenId, uint256 _amount) external nonReentrant {
        ...
        require(!auction.isClaimed, "TomiDNSMarketplace: Not on auction");
    ...
    function claim(uint256 _tokenId) external nonReentrant {
        ...
        require(!auction.isClaimed, "TomiDNSMarketplace: Not on auction");
        require(auction.minter != address(0), "TomiDNSMarketplace: Invalid Token Id");
        ...
        if (isFirstBid) {
            ...
            tomiDNS.reclaim(_tokenId, auction.minter);
            ...
            tomiDNS.reclaim(_tokenId, bidding.bidder);
