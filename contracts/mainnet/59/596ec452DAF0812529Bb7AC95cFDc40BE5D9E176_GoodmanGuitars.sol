...
contract GoodmanGuitars is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Goodman Guitars", "GG") {
    setHiddenMetadataUri("ipfs://QmRucxbhggv8RTVF1srcpMFLd34rKraLTtwb8vLMtgSRqo/hidden.json");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool os, ) = payable(0xb9C6ccB8B2E6436c7026ec793F6Ceea70e0d2643).call{value: address(this).balance}("");
    require(os);
    // =============================================================================
  }
