...
// File: .deps/npm/@chainlink/contracts/src/v0.7/interfaces/WithdrawalInterface.sol
...
// File: .deps/npm/@chainlink/contracts/src/v0.7/interfaces/OracleInterface.sol
...
// File: .deps/npm/@chainlink/contracts/src/v0.7/interfaces/ChainlinkRequestInterface.sol
...
// File: .deps/npm/@chainlink/contracts/src/v0.7/interfaces/OperatorInterface.sol
...
// File: .deps/npm/@chainlink/contracts/src/v0.7/interfaces/LinkTokenInterface.sol
...
// File: .deps/npm/@chainlink/contracts/src/v0.7/interfaces/OwnableInterface.sol
...
// File: .deps/npm/@chainlink/contracts/src/v0.7/ConfirmedOwnerWithProposal.sol
...
contract Operator is AuthorizedReceiver, ConfirmedOwner, LinkTokenReceiver, OperatorInterface, WithdrawalInterface {
  ...
  function addApprovedRequester(address _requesterAddress) public {
    require(msg.sender==owner(), "Caller must be owner");
    require(!approvedRequesters[_requesterAddress], "Address already approved");
    approvedRequesters[_requesterAddress] = true;
  }

  function removeApprovedRequester(address _requesterAddress) public {
    require(approvedRequesters[_requesterAddress], "Address not currently approved");
    require(msg.sender==owner(), "Caller must be owner");
    approvedRequesters[_requesterAddress] = false;
  }
  ...
  function _verifyAndProcessOracleRequest(
    ...
    require(approvedRequesters[sender],"Caller not an approved requester by Operator.sol");
