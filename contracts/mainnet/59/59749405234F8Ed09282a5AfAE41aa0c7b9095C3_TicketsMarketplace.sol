...
contract TicketsMarketplace is Initializable, OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function claimFreeTicket(
        ...
        _claimFreeTicket(ticketId, claimer, allowanceId);
    }

    function _claimFreeTicket(
        uint256 ticketId,
        address claimer,
        uint256 allowanceId
    ...
    function _buyMarketTicket(
        ...
        if (tokenPaymentType[seller][ticketId] == address(0)) {
            ...
            require(
                IERC20(tokenPaymentType[seller][ticketId]).allowance(owner(), msg.sender) >= amount * offers[seller][ticketId].price,
