...
contract MegamoonLottery is ReentrancyGuard, IMegamoonLottery, Ownable {
        ...
        nonReentrant
    {
        ...
        uint256 amountToWithdrawToDealer;
        ...
        amountToWithdrawToDealer += (_lotteries[_lotteryId].amountCollectedInMoon - amountToShareToWinners);

        // Transfer MOON to treasury address
        if (amountToWithdrawToDealer > 0) {
            moonToken.safeTransfer(dealerAddress, amountToWithdrawToDealer);
            dealer.returnFunds(currentLotteryId, amountToWithdrawToDealer);
        }
