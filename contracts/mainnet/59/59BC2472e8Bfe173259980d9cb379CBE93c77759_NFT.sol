...
contract NFT is ERC721, Ownable, ReentrancyGuard, RoyaltiesV2Impl {
    ...
    uint public maxPurchasePreSale;
    uint public maxPurchasePublicSale;
    ...
    constructor(string memory name, string memory symbol, uint256 _maxSupply, uint256 _maxPurchasePreSale, uint256 _maxPurchasePublicSale, uint256 _preSalePrice, uint256 _publicSalePrice) ERC721(name, symbol) ReentrancyGuard() {
        maxSupply = _maxSupply;
        preSalePrice = _preSalePrice;
        publicSalePrice = _publicSalePrice;
        maxPurchasePreSale = _maxPurchasePreSale;
        maxPurchasePublicSale = _maxPurchasePublicSale;
    ...
    function preSaleMint(uint256 _amount)external payable nonReentrant{
        ...
        require(balanceOf(msg.sender).add(_amount) <= maxPurchasePreSale, "NFT: You can't mint so much tokens in presale");
        mint(_amount, true);
    }
    ...
    function publicSaleMint(uint256 _amount)external payable nonReentrant{
        ...
        require(balanceOf(msg.sender).add(_amount) <= maxPurchasePublicSale, "NFT: You can't mint so much tokens in public sale");
        mint(_amount, false);
    }
