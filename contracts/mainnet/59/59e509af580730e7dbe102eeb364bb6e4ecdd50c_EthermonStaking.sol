...
contract EthermonStaking is EthermonStakingBasic {
    ...
    uint256 public maxDepositeValue = 30000 * 10**decimal;
    ...
    function updateDaysArray(uint16[] calldata _daysToStake)
        ...
        onlyModerators
    {
        require(_daysToStake.length < 11, "Days length are too long");
    ...
    function updateDaysAdvantageArray(uint16[] calldata _daysAdvantage)
        ...
        onlyModerators
    {
        require(_daysAdvantage.length < 11, "Days Advantage length are too long");
