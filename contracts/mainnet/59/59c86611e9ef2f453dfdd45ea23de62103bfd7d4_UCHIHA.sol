...
contract UCHIHA is ERC20 {
    ...
    string public constant name = "uchiha";
    string public constant symbol = "uchiha";
    uint public constant decimals = 18;
    uint public deadline = now + 370 * 1 days;
    uint public round2 = now + 190 * 1 days;
    uint public round1 = now + 190 * 1 days;
    
    uint256 public totalSupply = 90000000000000e18;
    ...
    address multisig = 0xA60659e28Ac1EE327A98fA0884B64384e68FcD52;
    ...
    constructor() public {
        uint256 teamFund = 99000000000000e18;
        owner = msg.sender;
