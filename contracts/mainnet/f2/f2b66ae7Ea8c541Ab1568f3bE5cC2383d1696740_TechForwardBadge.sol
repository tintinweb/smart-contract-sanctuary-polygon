...
/**
 * @title TechForwardBadge NFT
 */
contract TechForwardBadge is
    ERC721URIStorage,
    ERC2981,
    ...
    Ownable
{
    ...
    /**
     * @dev Constractor of TechForwardBadge contract.
     * @param _baseTokenURI Initial setting of base token URI.
     */
    constructor(
        string memory _baseTokenURI
    ) ERC721("TechForwardBadge", "TechForwardBadge") {
    ...
    /**
     * @dev Mint TechForwardBadge NFT. Transfer it to the specified address.
     */
    function mint(
        address _to,
        string memory _tokenUri,
        ...
        isLocked[nextTokenId] = _isLocked;
    }

    /**
     * @dev Batch Mint TechForwardBadge Medal NFT. Transfer it to the specified address.
     */
    function batchMint(
        address[] memory _to,
        string memory _tokenUri,
     ...
     * @dev When isLocked is true, transfer is not allowed.
     */
