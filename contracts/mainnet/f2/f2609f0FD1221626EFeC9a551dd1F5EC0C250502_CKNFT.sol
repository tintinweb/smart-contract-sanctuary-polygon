...
contract CKNFT is ERC1155, Ownable, Pausable {
    ...
    address public companyTreasuryWallet = 0x583d2A624acFC4a01ad93cdDE2a759ad344992A6;
        ...
        nonReentrant
    {
        ...
        require(_id < MAX_TOKEN_ID_PLUS_ONE, "id must be < 1");
        require(tokenIdToExistingSupply[_id] + _amount <= 1550, "Allowlists supply exceeded");
