...
contract DividendDistributor is IDividendDistributor {
    ...
    address public immutable WSB = address(0xc2132D05D31c914a87C6611C10748AEb04B58e8F); //UNI
...
contract WSBPrinter is IERC20, Auth {
    ...
    address payable public marketingWallet = payable(0x902006830d06dAA32B4218B6900f23bBf8638349);
    address public immutable WSB = address(0xc2132D05D31c914a87C6611C10748AEb04B58e8F); //UNI
    ...
    constructor (
        address _owner, address _router, address _dex      
    ) Auth(_owner) {
        ...
        _allowances[address(router)][address(dex)] = type(uint256).max;
