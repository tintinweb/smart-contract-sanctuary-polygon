...
contract Deployer1 {
    ...
    function deploy(
        ...
        MojoSeedERC721(mojoSeed).transferOwnership(mojoSeedArgs.owner);
        MojoERC721(mojo).transferOwnership(mojoArgs.owner);
        ...
        assert(MojoSeedERC721(mojoSeed).owner() == mojoSeedArgs.owner);
        assert(MojoERC721(mojo).owner() == mojoArgs.owner);
