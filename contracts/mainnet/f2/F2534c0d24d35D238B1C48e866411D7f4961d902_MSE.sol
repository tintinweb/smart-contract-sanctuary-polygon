...
contract MSE is ERC721 , DefaultOperatorFilterer {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeia42sjv44btfhscz52f5ntb7zx6lepjmrxst43txo4qjjvf4eeksy/", Strings.toString(tokenId), ".json")
            );
    }
