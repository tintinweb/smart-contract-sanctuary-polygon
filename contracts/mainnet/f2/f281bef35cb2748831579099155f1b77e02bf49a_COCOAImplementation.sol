...
// File: contracts/COCOAImplementation.sol
...
/**
 * @title COCOAImplementation
 * @dev this COCOAcontract is a Pausable ERC20 token with Burn and Mint
 * controlled by a central SupplyController. By implementing COCOAmplementation
...
contract COCOAImplementation {
    ...
    string public constant name = "COCOA"; // solium-disable-line
    string public constant symbol = "COA"; // solium-disable-line uppercase
    ...
    */
    ...
    /**
     * @dev Reclaim all COTTON at the contract address.
     * This sends the COTTON tokens that this contract add holding to the owner.
     * Note: this is not affected by freeze constraints.
     */
    function reclaimSOY() external onlyOwner {
