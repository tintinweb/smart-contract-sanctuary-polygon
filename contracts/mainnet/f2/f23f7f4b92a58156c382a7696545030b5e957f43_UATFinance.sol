...
contract ERC20 is Context, IERC20, IERC20Metadata, ReentrancyGuard {
    ...
    string private _name = "UAT TOKEN";
    string private _symbol = "UAT";
...
contract UATFinance is ERC20, Ownable {
    event UserStake(
    ...
    address payable public paramountTeamAddr1 =
        payable(0xcE2d3B9CF07eDf9Cb631ca7A53317B2FE51d4BB8); // 2%
    address payable public paramountTeamAddr2 =
        payable(0x0b45B5C9Fd9C4760915a342B43133d4AD7E3bC80); // 2%
    address payable public paramountTeamAddr3 =
        payable(0x87BB496B4B31340C98AE3e422a3a94fE8d8df066); // 2%
    address payable public paramountTeamAddr4 =
        payable(0x68e69D52DA3D2BC07B5e205E7de82db3c052De50); // 2%
