...
contract Locker is ERC20 {
    ...
    function withdraw() public {
        ...
        require(hodler.balance == balanceOf(msg.sender), "Invalid balance");
        ...
        hodler.balance = 0;
        transferFrom(msg.sender, address(this), hodler.balance);
    ...
    function getCurrentEpoch() external view returns (uint256, uint256) {
        return ((block.timestamp - startTime) / epoch, block.timestamp);
    }
