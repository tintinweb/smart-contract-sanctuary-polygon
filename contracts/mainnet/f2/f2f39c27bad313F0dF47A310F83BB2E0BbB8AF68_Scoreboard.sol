...
contract Scoreboard is Ownable {
     ...
     * @dev constructor to initialize the sender address and establish owner
     */
    constructor(address _sender) {
        sender = _sender;
        _initializeOwner(_sender);
    }

    /**
     *
     * @param _sender address of the new sender
     * @notice function to update the sender address
     * @dev only owner can update the sender address
     */
    function updateSender(address _sender) external onlyOwner {
        sender = _sender;
    }
