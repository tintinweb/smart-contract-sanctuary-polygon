...
// File: contracts/GreatGlobeFoundation.sol
...
contract GreatGlobeFoundation is ERC1155Supply, Ownable {
    string public name;
     ...
     */
    function adminBatchMint(address[] calldata accounts, uint256 id, uint256 amount) external onlyOwner
    {
        require(!collectionLocked[id], "CANNOT_MINT_LOCKED_TOKEN_ID");
        for (uint256 i = 0; i < accounts.length; i++) {
