...
contract FuriousFolks is ERC721 {
    uint256 public totalSupply;
    uint256 public cost = 0.09 ether;
    uint256 public maxMints = 2500;
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeibrk57hi3wrestovtwlcqe6wpkebrb7s7t5jxxyftuup5vckgjmg4/", Strings.toString(tokenId), ".json")
            );
    }
