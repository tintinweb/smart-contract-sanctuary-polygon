...
contract DForceStrategy is LogicUpgradeable {
    ...
    address public rewardsSwapRouter;
    address public rewardsToken;
    address public logic;
    address[] public pathToSwapRewardsToBLID;
    address public multiLogicProxy;

    bool public rewardsInit;
    ...
    modifier isUsedToken(address token) {
        require(iTokens[token] != address(0), "DF2");
        _;
    }
    ...
    function init(address token, address iToken) public onlyOwner {
        require(iTokens[token] == address(0), "DF10");
    ...
    function claimRewards(address token, uint256 minimumBLIDPerRewardToken)
        ...
        isUsedToken(token)
    {
        require(pathToSwapRewardsToBLID.length >= 2, "DF9");
    ...
    function createCircles(
        ...
        require(collateralFactor > 0, "DF11");
...
contract DForceStrategyOld is LogicUpgradeable {
    using SafeERC20Upgradeable for IERC20Upgradeable;
