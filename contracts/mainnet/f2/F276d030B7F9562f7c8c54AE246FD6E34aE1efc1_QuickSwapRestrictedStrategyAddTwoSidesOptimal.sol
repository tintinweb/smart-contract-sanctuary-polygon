...
contract QuickSwapRestrictedStrategyAddTwoSidesOptimal is
  OwnableUpgradeSafe,
  ...
  IStrategy
{
  ...
  modifier onlyWhitelistedWorkers() {
    require(
      ...
      "QuickSwapRestrictedStrategyAddTwoSidesOptimal::onlyWhitelistedWorkers:: bad worker"
    );
    _;
  }
  ...
  function initialize(IQuickRouter02 _router, IVault _vault) external initializer {
  ...
  function execute(
    ...
    require(
      ...
      "QuickSwapRestrictedStrategyAddTwoSidesOptimal::execute:: insufficient LP tokens received"
    );
    require(
      lpToken.transfer(msg.sender, lpToken.balanceOf(address(this))),
      "QuickSwapRestrictedStrategyAddTwoSidesOptimal::execute:: failed to transfer LP token to msg.sender"
    );
