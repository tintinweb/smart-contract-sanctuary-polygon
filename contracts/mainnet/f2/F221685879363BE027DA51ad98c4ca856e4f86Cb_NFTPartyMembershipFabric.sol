...
/// @title NFTPartyMembership Fabric
contract NFTPartyMembershipFabric is
    Access,
    ...
    SaleTaxNumeratorStorage
{
    ...
    function _init(
        ...
        NFTPartyMembership(result).initialize({
            nameValue: string(abi.encodePacked("NFT Party Membership Card", tokenId.toString())),
            symbolValue: string(abi.encodePacked("PMC", tokenId.toString())),
            versionValue: "1",
    ...
    function _init2(
        ...
        NFTPartyMembership(result).initialize2({
