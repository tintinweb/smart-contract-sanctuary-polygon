...
KeeperBase {
    ...
    /// @dev when limit order manager is changed
    event LimitOrderManagerChanged(address _newLimitOrderManager);
    ...
    function changeLimitOrderManager(address _limitOrderManager) external {
        isAuthorizedController();
        orderManager = IOrderManager(_limitOrderManager);
        emit LimitOrderManagerChanged(_limitOrderManager);
    }
