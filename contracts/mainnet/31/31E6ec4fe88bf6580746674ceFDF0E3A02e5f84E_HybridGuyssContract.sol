...
//*********************************************************************//
//
//  __    __  ____    ____ .______   .______       __   _______       _______  __    __  ____    ____  _______.     _______.
// |  |  |  | \   \  /   / |   _  \  |   _  \     |  | |       \     /  _____||  |  |  | \   \  /   / /       |    /       |
// |  |__|  |  \   \/   /  |  |_)  | |  |_)  |    |  | |  .--.  |   |  |  __  |  |  |  |  \   \/   / |   (----`   |   (----`
// |   __   |   \_    _/   |   _  <  |      /     |  | |  |  |  |   |  | |_ | |  |  |  |   \_    _/   \   \        \   \    
// |  |  |  |     |  |     |  |_)  | |  |\  \----.|  | |  '--'  |   |  |__| | |  `--'  |     |  | .----)   |   .----)   |   
// |__|  |__|     |__|     |______/  | _| `._____||__| |_______/     \______|  \______/      |__| |_______/    |_______/    
//                                                                                                                          
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1654038000;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1653951600;
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x5Aa44c39dC77DA42B695295b7D110Ef78Ca6D922];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 5, 9999 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmQAc81qQSSYE1MyDFSXDTQa92suFm4YWsWGv8e5PzJqTX/";
...
// File: contracts/HybridGuyssContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract HybridGuyssContract is RamppERC721A {
    constructor() RamppERC721A("Hybrid Guyss", "HGS"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/nkv0N2jOUNLHKtySg7C3/contract-metadata";
    }
}
