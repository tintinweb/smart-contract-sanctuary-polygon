...
contract GiveawayDraw is VRFConsumerBaseV2, Ownable {
    ...
    VRFCoordinatorV2Interface constant VRF_COORDINATOR = VRFCoordinatorV2Interface(0xAE975071Be8F8eE67addBC1A82488F1C24858067);
    bytes32 constant KEY_HASH = 0x6e099d640cde6de9d40ac749b4b594126b0169747122711109c9985d47751f93;
    ...
    function fulfillRandomWords(uint256 requestId, uint256[] memory randomWords) internal override {
        ...
        uint256 winnerIndex = (randomWords[0] % (1 + maxIndex - minIndex)) + minIndex;
    ...
    function createGiveawayBucket(uint256 bucketIndex, uint80 minIndex, uint80 maxIndex) external onlyOwner {
    ...
    function replaceGiveawayEntries(uint256[] calldata indexes, address[] calldata addresses) external onlyOwner {
