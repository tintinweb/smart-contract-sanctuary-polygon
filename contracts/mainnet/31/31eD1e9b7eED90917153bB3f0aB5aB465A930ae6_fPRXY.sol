...
contract fPRXY is Ownable, ERC20Burnable {
    ...
    //7.5% = 750
    uint256 private apy = 750;
    uint256 public userCount;
    uint256 public unstakeLockingPeriod = 30 days;
    ...
    function getReward() public updateReward(_msgSender()) {
        ...
        if (reward > 0) {
            ...
            IERC20(BTCpx).safeTransferFrom(btcpxTreasury, _msgSender(), reward);
    ...
    function getTotalRewardForYear() public view returns (uint256) {
        return
            apy
                .mul(totalSupply())
                .mul(getPrxyPriceInUsd())
                .div(getBtcPriceInUsd())
                .div(10000);
    }
