...
/**
 *Submitted for verification at bscscan on 06-04-2022
*/
...
contract HXC is Context, IERC20, Ownable {
    ...
    //hello world
    string _helloWorld = "Hello World from HaxionChain CrossContract Calls";
    ...
    uint256 public _maxTxAmount = 40266547200  * 10**9;
    ...
    function helloWorldFromCrossChain(bool success) public view returns(string memory)
    {
        if(success == true)
        {
            return _helloWorld;
    ...
    function crosschainInit() public pure returns(bool)
    {
        return true;
    }
