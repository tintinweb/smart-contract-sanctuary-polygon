...
contract PondsListingContract is Ownable{
    ...
    function license(uint256 _listingId) external{
        ...
        usdt.transferFrom(msg.sender, listing.owner, listing.price - (listing.price * 10 ** 6 * taxPercent / 100));
        usdt.transferFrom(msg.sender, address(this), listing.price * 10 ** 6 * taxPercent / 100);
