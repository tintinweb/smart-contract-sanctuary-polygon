...
import "./ICOZMICUser721Token.sol";
...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new ICOZMICUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        ICOZMICUser721Token token = ICOZMICUser721Token(address(addr));
...
contract ICOZMICUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
