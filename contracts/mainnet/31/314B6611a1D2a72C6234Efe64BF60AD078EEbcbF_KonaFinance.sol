...
contract KonaFinance is KonaStorage, IKonaFinance {
    ...
    function updateLoanInfo(uint256 _providerID, uint256 _loanID, uint256 _amount, address _borrower, string memory _borrowerInfo, uint256 _maturity, uint256 _repayments, uint256 _totalLocked, uint256 _apy, uint256 _interestRate, uint256 _collateralFactor) external onlyRole(LOAN_MANAGER_ROLE) {
        providers[_providerID].loans[_loanID].amount = _amount;        
        providers[_providerID].loans[_loanID].borrower = _borrower;        
        providers[_providerID].loans[_loanID].borrowerInfo = _borrowerInfo;        
        ...
        providers[_providerID].loans[_loanID].conditions.interestRate = _interestRate;
        providers[_providerID].loans[_loanID].conditions.collateralFactor = _collateralFactor;
