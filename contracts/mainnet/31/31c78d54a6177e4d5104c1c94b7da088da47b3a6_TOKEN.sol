...
// SPDX-License-Identifier: Unlicensed
    ...
    contract TOKEN is ERC20 {
        ...
        constructor () ERC20("Fallen Days Token", "FLND"){
            ...
            _marketingWalletAddress = 0x6bca93A757BA749e0e98566ea2d8C8Db8CfE1551;
        ...
        function _transfer(
            ...
            {
                uint256 lpAndMarketingTokens = amount.mul(_liquidityFee.add(_marketingFee)).div(1000);
                uint256 burnTokens = amount.mul(_burnFee).div(1000);
                amount= amount.sub(lpAndMarketingTokens).sub(burnTokens);
                super._transfer(from, address(this), lpAndMarketingTokens);
        ...
        // Send funds to marketing wallet into MATIC
