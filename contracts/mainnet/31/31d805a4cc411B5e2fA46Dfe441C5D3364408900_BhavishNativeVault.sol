...
contract BhavishNativeVault is AccessControl, BaseVault {
    ...
    function deposit(address _provider) external payable whenNotPaused nonReentrant {
        _depositToVault(msg.value, _provider);
    }
...
abstract contract BaseVault is Pausable, AccessControl, ReentrancyGuard {
    ...
    function _depositToVault(uint256 _assetAmount, address _provider)
        internal
        whenNotPaused
        ...
        returns (uint256 shares)
    {
        ...
        emit DepositProcessed(msg.sender, _assetAmount, shares, _provider);
    }
