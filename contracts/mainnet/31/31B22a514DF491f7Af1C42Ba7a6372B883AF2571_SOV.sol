...
contract SOV is SOVDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private SOVTeam;
    address private CharitySOV;
    ...
    string public override name = "Super Ordinary Villains";
    string public override symbol = "SOV";
    ...
    constructor(uint totalSupplyValue, address SOVTeamAddress, address CharitySOVAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        SOVTeam = SOVTeamAddress;
        CharitySOV = CharitySOVAddress;
        
        // split the tokens according to agreed upon percentages
        balances[SOVTeam] =  totalSupply * 4 / 100;
        balances[CharitySOV] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's SOVTeam pot
