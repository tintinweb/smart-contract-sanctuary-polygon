...
contract MoonPayWallet is Ownable {
    ...
    function setMoonPayPayment(address _wallet, uint256 _amount) external {
        require((msg.sender == IFrameItFactory(factory).marketplace() || msg.sender == IFrameItFactory(factory).packsMarketplace() || msg.sender == IFrameItFactory(factory).auctionMarketplace()), "OnlyMarketplaces");
