...
contract ChanceWin is Ownable, Pausable, ReentrancyGuard{
    ...
    /**
     * @notice Set chance win game drop minter address
     * @dev Callable by admin
     */
    ...
    /**
     * @notice Set chance nft mint price
     * @dev Callable by admin
     */
    ...
    /**
     * @notice Set chance vault address
     * @dev Callable by admin
     */
    ...
    /**
     * @notice Set chainlink vrf address
     * @dev Callable by admin
     */
     ...
     * @notice allotAmount
     * @param amount: amount
     * @param community_amount: community amount
     * @param invite_amount: invite amount
     */
    ...
    /**
     * @notice dropChanceWinner
     * @param _timestamp: real now timestamp
     */
    ...
    /**
     * @notice batchMintWIN
     * @param _inviteCode: inviter code
    ...
    /**
     * @notice batch check withdraw able 
     * @param rs: game round id
     * @return wd_able: result of withdraw able 
     */
    ...
    /**
     * @notice withdraw by winner 
     * @param _r: game round id
    ...
    /**
     * @notice withdraw by winner list
     * @param rs: game round ids
     * @param _to: receive address
     */
