...
contract omnigoblintown is Ownable, ERC721Burnable, ERC721Enumerable, LayerZeroable {
    using Strings for uint256;
    ...
    constructor(string memory baseURI_, address _layerZeroEndpoint)
        ERC721("omnigoblintown", "omnigoblintown")
    {
        baseURI = baseURI_;
        layerZeroEndpoint = ILayerZeroEndpoint(_layerZeroEndpoint);
    }
    ...
    function mint(uint8 numTokens) public payable mintActive {
        ...
        require(numAlreadyMinted + numTokens <= MAX_MINT_PER_WALLET, "50 NFTs max per wallet");
