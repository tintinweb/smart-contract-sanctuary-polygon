...
contract SharedPigeon{
    ...
    function deleteAllMyData() internal {
        delete _message[msg.sender];
        delete _answer[msg.sender];
        delete _messageTimestamp[msg.sender];
        delete _answerTimestamp[msg.sender];
        delete _hasFlown[msg.sender];
        delete _isRead[msg.sender];
        ...
        if (senderToAddressExists[msg.sender] == true)
        {
        deleteToAddress (msg.sender, _toAddress[msg.sender]);
        senderToAddressExists[msg.sender] = false;
        }
    }
