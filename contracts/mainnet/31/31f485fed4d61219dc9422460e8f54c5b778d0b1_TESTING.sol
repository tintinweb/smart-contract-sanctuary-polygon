...
contract TESTING is ERC721A, Ownable, ReentrancyGuard, ERC2981 {
    ...
    constructor() ERC721A("TESTING", "TTT") {
        // Opensea Proxy Address for gasless listing
        // can be turned of by calling setIsOperatorProxyActive()
        operatorProxyAddress = 0x58807baD0B376efc12F5AD86aAc70E78ed67deaE;
    }

    function mint(uint256 _quantity) external payable {
        require(_quantity > 0, "need to mint at least 1 NFT");
        require(totalSupply() + _quantity <= maxSupply, "Supply Reached");
