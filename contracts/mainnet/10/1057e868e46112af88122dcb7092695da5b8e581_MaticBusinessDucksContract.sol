...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmbTsVrvpjbooN8CcRVWMsPN9cGGYi18c3Ef28AmqsfMLL/";
...
// File: contracts/MaticBusinessDucksContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MaticBusinessDucksContract is RamppERC721A {
    constructor() RamppERC721A("Matic Business Ducks", "MBD"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/wEjeoKg7OiHNyYKOmbDb/contract-metadata";
    }
}
