...
contract ChainPots {
    ...
    uint256 public dailyPotEntryPrice = 5 ether;
    ...
    uint256 public silverLotteryEntryPrice = 5 ether;
    uint256 public silverLotteryPotMaxAmount = 50 ether;
    uint256 public silverLotteryMaxEntries = 10;
    bool public silverLotteryIsLive = true;

    address payable[] public playersGoldLottery;
    uint256 public goldLotteryEntryPrice = 25 ether;
    uint256 public goldLotteryPotMaxAmount = 250 ether;
    uint256 public goldLotteryMaxEntries = 10;
    bool public goldLotteryIsLive = false;

    address payable[] public playersDiamondLottery;
    uint256 public diamondLotteryEntryPrice = 100 ether;
    uint256 public diamondLotteryPotMaxAmount = 1000 ether;
    ...
    uint256 public silverBattleEntryPrice = 10 ether;
    uint256 public silverBattlePotMaxAmount = 20 ether;
    uint256 public silverBattleMaxEntries = 2;
    bool public silverBattleIsLive = true;

    address payable[] public playersGoldBattle;
    uint256 public goldBattleEntryPrice = 50 ether;
    uint256 public goldBattlePotMaxAmount = 100 ether;
    uint256 public goldBattleMaxEntries = 2;
    bool public goldBattleIsLive = false;

    address payable[] public playersDiamondBattle;
    uint256 public diamondBattleEntryPrice = 200 ether;
    uint256 public diamondBattlePotMaxAmount = 400 ether;
