...
contract Oracle {
    address public pool = 0x5645dCB64c059aa11212707fbf4E7F984440a8Cf; // USDC / DAI 0.01%

    function getPrice() public view returns (int24 arithmeticMeanTick, uint128 harmonicMeanLiquidity) {
        (arithmeticMeanTick, harmonicMeanLiquidity) = OracleLibrary.consult(pool, 10);
    }
}