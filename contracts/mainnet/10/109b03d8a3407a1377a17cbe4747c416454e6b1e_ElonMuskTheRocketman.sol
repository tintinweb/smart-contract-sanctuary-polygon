...
// File: ElonMuskTheRocketman.sol

pragma solidity >=0.8.0 <0.9.0;


contract ElonMuskTheRocketman is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public cost = 130 ether;
  uint256 public maxSupply = 10000;
  uint256 public maxMintAmountPerTx = 10;
  uint256 public maxWalletLimit = 1000;
  ...
  constructor() ERC721A("Elon Musk The Rocketman", "EMTR") {
    setUriPrefix("");
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    require(balanceOf(msg.sender) + _mintAmount <= maxMintAmountPerTx, "Max mint amount per wallet reached");
