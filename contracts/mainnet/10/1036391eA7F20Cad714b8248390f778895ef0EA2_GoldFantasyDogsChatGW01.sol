 ...
 * @notice This contract handles minting GoldFantasyDogsChatGW01 tokens.
 */
contract GoldFantasyDogsChatGW01 is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x2c99bB7C97e3670571dE9f557a25f48ecA8177b4;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xc86269B436f7B8bd6CEf348EA594FA1eB77996ea;
    ...
    string public name = "GoldFantasyDogsChatGW01";
    string public symbol = "gdcg";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeihd2ov7yguvckszp3ez2g6lp7clxjllxpe2l2vwic4nwds62574pq/{id}"
        )
        RevokableOperatorFilterer(
