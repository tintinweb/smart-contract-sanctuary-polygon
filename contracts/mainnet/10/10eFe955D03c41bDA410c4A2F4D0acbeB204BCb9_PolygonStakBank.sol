...
import "./interfaces/IPolygonStoreStakingUsers.sol";
    ...
    OwnableUpgradeable
{
    ...
    // Staking Users
    IPolygonStoreStakingUsers public storeStakingUsers;
    ...
    uint256 private _multiplierLockDate;
    ...
    function initialize(
        ...
        IJSTAK _jStak,
        IPolygonStoreStakingUsers _storeStakingUsers
    ) public initializer {
        ...
        _multiplierLockDate = block.timestamp + 60 days;
     ...
     * @return Returns amount of remaining tokens to be distributed
     */
        ...
        updateReward(_msgSender())
    {
        ...
        if(storeStakingUsers.getUser(_msgSender()) > 0 && userInfo[_msgSender()].baseDate == 0 && block.timestamp <= _multiplierLockDate )
        {
            uint _currStakingTime = storeStakingUsers.getUser(_msgSender());
...
interface IPolygonStoreStakingUsers {
