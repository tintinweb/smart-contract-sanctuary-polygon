...
// File: contracts/TokenERC721BaseEnum.sol
...
contract TokenERC721BaseEnum is ERC721, ERC721Enumerable, Ownable {
    ...
    address private MINT_DESTINATION = 0x5a24618D0583d925AF4772E51f2dFedc60e9bC35;

    constructor(string memory name_, string memory symbol_) ERC721(name_, symbol_) {
        for (uint i = 1; i <= 114; i++){
                _safeMint(MINT_DESTINATION, i);
        }
    }

    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://bafybeifkczcgdqcqjppqovf3hm5rdlmoi7c3pp46xehhbrjboauh7qdoxa/elBulli/";
    }
