...
contract PUNKSofGALAXY is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Punks of Galaxy", "GP") {
    setHiddenMetadataUri("ipfs://QmVJRzpFpcBy6qWrGuA79NAvjm6cuhXfUrQezHKjdtUbhe/hidden.json");
  }
