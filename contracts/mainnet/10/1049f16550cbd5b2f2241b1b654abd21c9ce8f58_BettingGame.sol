...
contract BettingGame {
    ...
    uint32 public maximumGamePlayer = 70000;
    ...
    function bet(uint256 _gameId, uint256 _handIndex) public payable {
        ...
        require(game.playerAddresses.length <= maximumGamePlayer, "Number of players has reached the upper limit");
    ...
    function _randomNumber(uint256 _gameId, address _userAddress, uint256 _handIndex) internal {
        ...
        if(_handIndex > game.players[msg.sender].numberOfHand) { 
            ...
            require(game.players[msg.sender].numberOfHand == _handIndex - 1 && _handIndex > 0, "The hand index is out of range"); 
    ...
    // @import from https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/utils/Strings.sol
