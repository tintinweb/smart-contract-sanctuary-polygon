...
contract StrategyQuickGamma is StratFeeManagerInitializable, GasFeeThrottler {
    ...
    function setUniProxy(IGammaUniProxy _gammaProxy) external onlyOwner {
        emit SetGammaUniProxy(address(gammaProxy), address(_gammaProxy));
        _removeAllowances;
        gammaProxy = _gammaProxy;
        _giveAllowances;
    }
