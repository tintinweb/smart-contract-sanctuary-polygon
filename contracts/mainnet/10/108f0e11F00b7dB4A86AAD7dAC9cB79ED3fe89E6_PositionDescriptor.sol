...
contract PositionDescriptor is IPositionDescriptor {
  ...
  function setPoolIdentifier(string calldata poolIdentifier, bytes32 poolHash) public override {
    require(keccak256(abi.encode(poolIdentifier)) == poolHash, Errors.POD_BAD_INPUT);
        ...
        abi.encodePacked(
          ...
          Base64.encode(
            abi.encodePacked(
              ...
              "This NFT represents your share of the pool, its price depends on the status of the pool, "
              " the amount of tokens you originally deposited and the different rewards allocated to it."
              ' You should be extra careful when setting your position price.",'
