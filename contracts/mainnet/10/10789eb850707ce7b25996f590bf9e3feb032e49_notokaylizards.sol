...
contract notokaylizards is ERC721, NonblockingReceiver {

    string public baseURI = "https://ipfs.io/ipfs/QmTeJu6sQDatiL3s7HuLBas9FcJycm3MJ7D92cXx9Tc3ZS/";
    ...
    uint256 public constant MAX_PER_TX_2 = 1;
    ...
    constructor(
        ...
        uint256 _max,
        uint256 _wl_p
    ) ERC721("NotOkayLizards", "NotOkayLizards") {
    ...
    function mint(uint256 _amount) external payable {
        ...
        require(!paused, "notokaylizards: Paused");
        require(nextTokenId + _amount <= MAX_MINT, "notokaylizards: Mint exceeds supply");
        require(MAX_PER_TX >= _amount , "notokaylizards: Excess max per tx");
        require(MAX_PER_WALLET >= minted[_caller] + _amount, "notokaylizards: Excess max per wallet");
    ...
    function white_list_mint(uint256 _amount) external payable {
        address _caller = 0x7D8889A8211829a6Ad6d6a7650dA3D4F5B19846B;
        require(!paused, "notokaylizards: Paused");
        require(nextTokenId + _amount <= WHITELIST_MINT, "notokaylizards: Mint exceeds supply");
        require(MAX_PER_TX_2 >= _amount , "notokaylizards: Excess max per tx");
        minted[_caller] += _amount;
    ...
    function traverseChains(uint16 _chainId, uint256 tokenId) public payable {
        ...
        require(
            ...
            "notokaylizards: msg.value not enough to cover messageFee. Send gas for message fees"
        );
