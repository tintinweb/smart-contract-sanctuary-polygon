...
/**
 * @title Shadow Caked Apes contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract ShadowCakedApes is ERC721, Ownable {
    using SafeMath for uint256;

    string public SCAPE_PROVENANCE = "";

    uint256 public startingIndexBlock;

    uint256 public startingIndex;

    uint256 public constant apePrice = 100000000000000000000;

    uint public constant maxApePurchase = 50;
    ...
    function reserveSCApes(uint numberOfTokens) public onlyOwner {        
		_safeMintBatch(msg.sender, numberOfTokens);
    }

    function reserveSCApesTo(address _To, uint numberOfTokens) public onlyOwner {        
    ...
    function reserveSCApesBatch(address[] memory _deliveryAddrs, uint numberOfTokens) public onlyOwner {
    ...
    function setProvenanceHash(string memory provenanceHash) public onlyOwner {
        SCAPE_PROVENANCE = provenanceHash;
    }
