...
contract Alphalips is Ownable, ERC721A, ERC721ABurnable, ReentrancyGuard {
    ...
    uint256 public immutable devReserve = 5; //5% - 10% of total NFTs in the final contract
    ...
    uint256 public immutable totalAvailableQuantity = 30; // 1000 to 10000 in final contract
