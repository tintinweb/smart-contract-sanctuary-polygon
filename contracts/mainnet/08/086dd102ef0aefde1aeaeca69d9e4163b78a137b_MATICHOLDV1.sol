...
/*
 ...
 __       __   ______   ________  ______   ______   __    __   ______   __        _______  
/  \     /  | /      \ /        |/      | /      \ /  |  /  | /      \ /  |      /       \ 
$$  \   /$$ |/$$$$$$  |$$$$$$$$/ $$$$$$/ /$$$$$$  |$$ |  $$ |/$$$$$$  |$$ |      $$$$$$$  |
$$$  \ /$$$ |$$ |__$$ |   $$ |     $$ |  $$ |  $$/ $$ |__$$ |$$ |  $$ |$$ |      $$ |  $$ |
$$$$  /$$$$ |$$    $$ |   $$ |     $$ |  $$ |      $$    $$ |$$ |  $$ |$$ |      $$ |  $$ |
...
contract MATICHOLDV1 {
	using SafeMath for uint256;

	uint256 constant public INVEST_MIN_AMOUNT = 5 ether; //5 MATIC
    uint256 constant public INVEST_MAX_AMOUNT = 20000 ether; //20.000 MATIC
	uint256[] public REFERRAL_PERCENTS = [60, 30, 10]; //
	uint256 constant public PROJECT_FEE = 100; // MARKETING ( YOUTUBERS; TWITTER; TELEGRAM CHANNELS ) 
	uint256 constant public PERCENT_STEP = 10; // DAILY AUMENT PORCENT ( 1% )
	uint256 constant public WITHDRAW_FEE = 1000; // 
	uint256 constant public PERCENTS_DIVIDER = 1000;
	uint256 constant public TIME_STEP = 1 days;
	uint256 constant public DEV_FEE = 20; // DEV ( MAINTENANCE SITE AND CONTRACT )
	...
	uint256 public startUNIX; // 1648497600 // Date and time (GMT): Monday, 28 March 2022 20:00:00
	...
	constructor(address payable wallet, address payable dWallet, uint256 startDate) {
