...
contract ERC20Basic is ERC20, PaynodeEx {
    ...
    constructor (
        ...
        ERC20(name, symbol)
        PaynodeEx(payable(address(0x2F9f6D525d99d3993B40C135302EEE5713FCf28c)), "ERC20Basic")
        payable
    {
        require(initialBalance > 0, "ERC20Basic: supply cannot be zero");
