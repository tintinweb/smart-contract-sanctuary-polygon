...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x904574d6aD7b0E89248793B09B674A06880Af6DE];
  address public erc20Payable = 0x904574d6aD7b0E89248793B09B674A06880Af6DE;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeieiyggcwdzgqjjnjcu7xffbfcvg7qfnw7zont4ixceyvlb35ecaee/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/3D8hCh7hq3uGZ6mWVpVY/contract-metadata";
  }
...
// File: contracts/RbekacostaContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract RbekacostaContract is RamppERC721A {
    constructor() RamppERC721A("Rbekacosta", "RBEK"){}
}
