...
contract FirePolygon is ERC721 {
    ...
    constructor(string memory _baseTokenURI) ERC721("Fire", "FIRE") {
        // default settings
        isSaleActive = false;
        limitPerWallet = 1;
    ...
    function mint() external {
        ...
        if (
            balanceOf(msg.sender) >= limitPerWallet ||
            mintAmount[msg.sender] >= limitPerWallet
        ) revert LimitPerWalletReached();

        uint256 toMint = minted;
        minted += 1;
