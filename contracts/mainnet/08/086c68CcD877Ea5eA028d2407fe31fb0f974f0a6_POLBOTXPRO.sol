...
/**
TELEGRAM: t.me/polbotxpro
Website : https://polbot.pro
Twitter : twitter.com/POLBOTPRO
*/
...
contract POLBOTXPRO is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "POLBOT X PRO";
    string private _symbol = "POLBOT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0xEBc226283C3e1dEA6FAEe094ed3CB6e6921dfC82);
    ...
    uint256 private _totalSupply = 1000000 * 10**8 * 10**_decimals;
