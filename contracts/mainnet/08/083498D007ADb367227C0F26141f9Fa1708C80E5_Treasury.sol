...
contract Treasury is ContractGuard {
    ...
    function initialize(
        ...
        supplyTiers = [0 ether];
        maxExpansionTiers = [50];

        maxSupplyExpansionPercent = 50; // Upto 1.5% supply for expansion
        ...
        bootstrapEpochs = 6;
        bootstrapSupplyExpansionPercent = 75;
    ...
    function governanceRecoverUnsupported(
        ...
        require(address(_token) != address(tomb), "CO2");
        require(address(_token) != address(tbond), "CBN");
        require(address(_token) != address(tshare), "SCO2");
