 ...
 * @notice This contract handles minting Babes in Waffle Cones tokens.
 */
contract BabesInWaffleCones is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    string public baseTokenURI =
        "ipfs://bafybeic2cppkgcqhcfjmva347u2svdfb3a66tnpwqkplbvycfly4whgk3y/";
    // Maximum supply of tokens that can be minted
    uint256 public MAX_SUPPLY = 31;
    uint96 public royaltyFee = 600;

    constructor(address _blocklistContractAddress)
        ERC721A("Babes in Waffle Cones", "BABES")
    {
