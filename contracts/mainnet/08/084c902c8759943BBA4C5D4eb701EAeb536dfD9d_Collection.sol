...
contract Collection is Ownable {
  ...
  address public designAddr = 0x8242F9b587cab126b11A8D672e1aB604ed483767;
  address public CheckQuaAddr = 0xc34D2bbD29a2D763e73EDFbdCb6904B55a8ff512;
  ...
  function PreviewTokenURI(uint _BcardID, string memory _title, string[] memory _tagName, string[] memory _tagValue,
    string memory _content) public payable returns (string memory){
        ...
        Design designContract = Design (designAddr);
        return designContract.buildMetadata(uint256(collectionID).toString(), _title, _tagName, _tagValue, 
          getDate(block.timestamp), _content, 
...
abstract contract Design is Ownable{
    function buildMetadata(string memory collectionID, string memory _title, string[] memory _tagName, string[] memory _tagValue, string memory _editTime, string memory _content, uint _tkId, string memory _ethName) 
