...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x61eAB96df549241DC00a5958F729fb5Bb3D27db3];
...
// File: contracts/LarvaButterfliesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract LarvaButterfliesContract is RamppERC721A {
    constructor() RamppERC721A("Larva Butterflies", "LarB"){}
}
