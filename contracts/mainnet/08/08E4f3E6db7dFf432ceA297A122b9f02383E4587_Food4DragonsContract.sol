...
//
//   _____                 .___ _____     .___                                    
// _/ ____\____   ____   __| _//  |  |  __| _/___________     ____   ____   ____  
// \   __\/  _ \ /  _ \ / __ |/   |  |_/ __ |\_  __ \__  \   / ___\ /  _ \ /    \ 
//  |  | (  <_> |  <_> ) /_/ /    ^   / /_/ | |  | \// __ \_/ /_/  >  <_> )   |  \
//  |__|  \____/ \____/\____ \____   |\____ | |__|  (____  /\___  / \____/|___|  /
//                          \/    |__|     \/            \//_____/             \/ 
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 20;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmQ5Tj4tFVLA3cZh9Ti8suEgorwQeLCp1a2N3KiMMSk3ac/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 123");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 123");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 123");
...
// File: contracts/Food4DragonsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Food4DragonsContract is RamppERC721A {
    constructor() RamppERC721A("Food4Dragons", "DRAGON"){}
}
