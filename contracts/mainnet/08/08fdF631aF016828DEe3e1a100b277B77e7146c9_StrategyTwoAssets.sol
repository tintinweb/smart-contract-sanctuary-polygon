...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
    ...
    address public constant rewardToken0Addr = 0x8f3Cf7ad23Cd3CaDbD9735AFf958023239c6A063;
    address public constant rewardToken1Addr = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270;
    // One or more farm tokens
    address public constant farmToken0Addr = 0x13748d548D95D78a3c83fe3F32604B4796CFfa23;
    ...
    // Other
    address public constant ethAddr = 0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619;
    ...
    address[] public rewardToken0ToRewardToken1;
        ...
        )
    {
        ...
        rewardToken0ToRewardToken1 = new address[](3);
        rewardToken0ToRewardToken1[0] = rewardToken0Addr;
        rewardToken0ToRewardToken1[1] = ethAddr;
        rewardToken0ToRewardToken1[2] = rewardToken1Addr;
    ...
    function harvest() public override nonReentrant {
        ...
        if (_reward0Balance > harvestCutoffBps){
            ...
            _swapUniswapWithPathForFeeOnTransferTokens(rewardToken0ToRewardToken1, swapAmount, swapRouter0Addr);
        }
        // Figure out how much reward we collected
...
contract StrategyTwoAssets is StrategyFarmTwoAssets {
    // Token addresses
    address public FARM_MASTER_CHEF = 0x7B8d4B5E4c9e51416e282699e1F649087424789F;
    address public LP_TOKEN = 0x3885503aEF5E929fCB7035FBDcA87239651C8154;
    constructor()
        public
