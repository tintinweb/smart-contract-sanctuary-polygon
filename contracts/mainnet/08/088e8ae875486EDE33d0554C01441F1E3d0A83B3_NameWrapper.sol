...
interface IAuction {
    function setOnAuction(address payable _minter, uint256 _tokenId, string memory label, bytes32 labelhash , string memory tld) external;
}
    ...
    IERC721Receiver
{
    ...
    IAuction public auction = IAuction(0x1092d50E8E14479bB769b687427B72BeE70c9534);
    ...
    function registerAndWrapETH2LD(
        ...
        auction.setOnAuction(payable(wrappedOwner), tokenId, name.name, labelhash, name.tld);
    }
