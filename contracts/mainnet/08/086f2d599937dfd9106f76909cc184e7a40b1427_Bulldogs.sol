...
contract Bulldogs is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    function mint(address[] calldata recipients) external onlyOwner {
        ...
        require(totalSupply() + recipients.length <= maxTotalTokens, "Not enough NFTs left to mint..");
