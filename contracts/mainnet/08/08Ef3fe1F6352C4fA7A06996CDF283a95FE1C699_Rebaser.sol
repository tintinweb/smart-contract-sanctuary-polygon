...
abstract contract RebaseToken is Context, IBEP20 {
    ...
    string private constant _name   = "Organizacion Economica Anonima";
    string private constant _symbol = "OEA";
...
contract Rebaser is RebaseToken {
    ...
    function setRebaseTime(uint256 new_RebaseDate) external onlyAdmin {
        nextRebase= new_RebaseDate;
    }
