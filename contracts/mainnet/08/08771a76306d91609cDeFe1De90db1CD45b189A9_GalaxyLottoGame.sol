...
contract GalaxyLottoGame is VRFConsumerBaseV2, ConfirmedOwner {
    ...
    uint256[6] public hitsAndRewards = [0, 0, 0, 1*1e6, 10*1e6, 500*1e6];
        ...
        ConfirmedOwner(msg.sender)
    {
        ...
        NftMint = NftMintInterface(0xAdEF07726A19ec8542f0b7f013aa4E6ef2933e02);
    ...
    function getResult(uint256 _gameId) external {
        require(msg.sender == authAddress, "Only owner can declare result");
