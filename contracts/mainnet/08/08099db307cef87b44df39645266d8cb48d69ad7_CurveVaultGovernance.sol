...
contract CurveVaultGovernance {
  ...
  function earn(uint256 id) external {
    ...
    if (vaults[id].isAave){
      ...
      ICurveStableSwapAave(curvePool).add_liquidity([0, IERC20(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174).balanceOf(address(this)), 0], 0, true);
    } else {
      ICurveStableSwap(curvePool).add_liquidity([0, _amount, 0, 0, 0], 0);
    }
