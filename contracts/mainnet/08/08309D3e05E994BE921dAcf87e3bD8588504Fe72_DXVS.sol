...
contract DXVS is Initializable, ERC20Upgradeable, OwnableUpgradeable, ERC20PermitUpgradeable, ERC20CappedUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() {
        _disableInitializers();
    }
    ...
    function initialize() initializer public {
        __ERC20_init("Dexvers", "DXVS");
        __Ownable_init();
        __ERC20Permit_init("Dexvers");
        __ERC20Capped_init(1_500_000_000 * 10**decimals());
    }
