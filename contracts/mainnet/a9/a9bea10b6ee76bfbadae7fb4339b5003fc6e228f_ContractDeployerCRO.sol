...
contract LiqAndMarketingCRO is IBEP20, Auth, IDeployableContract {
    ...
    function automaticLaunch(address client, uint256 lockTime) external payable {
        ...
        if(lockTime>0){
            ...
            IBEP20(pcs2BNBPair).approve(0x5fb71Dbf7248a01bf96cE2AB2DA34EEAbE58c261, type(uint256).max);
        
            pinkLockId = IPinkLock(0x5fb71Dbf7248a01bf96cE2AB2DA34EEAbE58c261).lock{value: 0}(
                client,
                address(pcs2BNBPair),
                true,
    ...
    function unlockLpAfterLockExpires() external onlyOwner{
        IPinkLock(0x5fb71Dbf7248a01bf96cE2AB2DA34EEAbE58c261).unlock(pinkLockId);
    }
}
