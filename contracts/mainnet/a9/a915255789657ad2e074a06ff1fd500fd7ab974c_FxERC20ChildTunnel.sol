...
// File: PolygonTechnology/FxChild.sol
...
// File: PolygonTechnology/FxERC20ChildTunnel.sol
...
contract FxERC20ChildTunnel is FxBaseChildTunnel, Create2 {
    ...
    string public constant SUFFIX_NAME = " (Uniswap (PoS))";
    string public constant PREFIX_SYMBOL = "UNI";
    ...
    function _withdraw(address childToken, address receiver, uint256 amount) internal {
        ...
        // withdraw tokens
        //childTokenContract.burn(address(0), amount);
    ...
    function deposit(address rootToken, address to, uint256 amount) external payable {
        address childToken = rootToChildToken[rootToken];
