...
contract ShibaInu is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x062329a9f5D785c14f5Eff9b43aB731dD624f707); // Marketing Address
    address payable public charityAddress = payable(0x062329a9f5D785c14f5Eff9b43aB731dD624f707); // Charity/Dev Address
    ...
    uint256 private _tTotal = 400000000 * 10**18; // 1 Qud
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "SHIBA INU";
    string private _symbol = "ShibaInu";
    ...
    uint256 public _maxTxAmount = 400000000 * 10**18;  //Maximum amount can be used for transaction (antiwhale setup))
    uint256 private minimumTokensBeforeSwap = 10000 * 10**18;  //allow maximum sell amount(anti-dump setup)
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropEth =   200000000000000000; //0.2 BNB Airdrop fee
    uint256 private _airdropToken = 150000000000000000000000; // 15000; token will be given on airdrop
    ...
    uint256 private salePrice = 100000000;// 0.01*10000000=10,000 token for 0.01 bnb (set as per requirements)
