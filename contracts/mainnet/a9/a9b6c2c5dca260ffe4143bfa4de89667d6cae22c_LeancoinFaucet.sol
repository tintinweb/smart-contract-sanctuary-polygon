...
contract LeancoinFaucet {
    ...
    function withdraw() public {
        // Limit withdrawal amount to 100 tokens
        require(
            withdrawalAmount <= 100 * (10 ** 18),
            "Request exceeds maximum withdrawal amount of 100 SIPLEAN"
          );
    ...
    function setWithdrawalAmount(uint256 amount) public onlyOwner {
        // Limit max withdrawal amount to 100 tokens
