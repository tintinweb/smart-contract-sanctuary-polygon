    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 1400) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeif3koi2wcaoppas3ij2p644cq2ezlk4cdsijt4e7xrupveipexomu/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/sAuTybFpi7bfF1bUiUlP/contract-metadata";
  }
...
// File: contracts/PepeTheKingOfFrogContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PepeTheKingOfFrogContract is ERC721APlus {
    constructor() ERC721APlus("Pepe The King Of Frog", "PTKOF"){}
}
