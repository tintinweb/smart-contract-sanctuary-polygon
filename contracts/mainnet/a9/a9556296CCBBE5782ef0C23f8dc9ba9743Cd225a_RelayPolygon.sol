...
contract RelayPolygon is Ownable, ReentrancyGuard {
    ...
    function depositEth() public payable nonReentrant { // deposit eth to contract for user

        require(msg.value > 0, "You must send some ETH");
        userBalanceEth[msg.sender] += msg.value;
    }
    function depositUserToken(uint256 amount, address _tokenAddress) // deposit token to contract for user
        public
        nonReentrant
    {
        require(
