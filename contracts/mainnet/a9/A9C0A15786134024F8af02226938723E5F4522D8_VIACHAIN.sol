...
contract VIACHAIN is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 200_000_000 * 10**9;
    uint256 public maxSellLimit = 20_000_000 * 10**9;
    uint256 public maxWalletLimit = 2_000_000_000 * 10**9;
    
    uint256 public genesis_block;
    
    address public Viachain_Marketing = 0xf57e395f0Db65e0C65AbF4E2fed0A4E6a13DBB26;
    address public Viachain_Team = 0x22054Af1f8Fa514624C525C6bEd96DcB7914131F;


    string private constant _name = "VIA CHAIN";
    ...
    constructor (address routerAddress) {
        ...
        _isExcludedFromFee[Viachain_Marketing] = true;
        _isExcludedFromFee[Viachain_Team] = true;
        
        allowedTransfer[address(this)] = true;
        allowedTransfer[owner()] = true;
        allowedTransfer[pair] = true;
        allowedTransfer[Viachain_Marketing] = true;
        allowedTransfer[Viachain_Team] = true;
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        ...
        if(marketingAmt > 0){
            payable(Viachain_Marketing).sendValue(marketingAmt);
        }
        uint256 teamAmt = unitBalance * 2 * temp.team;
        if(teamAmt > 0){
            payable(Viachain_Team).sendValue(teamAmt);
        }
    }
    ...
    function Viachain_MpdateMarWallet(address newWallet) external onlyOwner{
        Viachain_Marketing = newWallet;
    }
    
    function updateViachain_Team(address newWallet) external onlyOwner{
        Viachain_Team = newWallet;
    }
