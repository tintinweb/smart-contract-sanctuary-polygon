...
contract SHIBASTORMKINGDOM {
    ...
    IERC20 constant BUSD_TOKEN = IERC20(0x368c3b4c72Ab53A3c74A117170a0dCF302fffad1);
    ...
    function getUpgradePrice(uint256 towerId, uint256 chefId) internal pure returns (uint256) {
        if (chefId == 1) return [4000, 40000, 120000, 240000, 400000][towerId];
        if (chefId == 2) return [6000, 60000, 180000, 360000, 600000][towerId];
        if (chefId == 3) return [9000, 90000, 270000, 540000, 900000][towerId];
        if (chefId == 4) return [13600, 135000, 405000, 810000, 1350000][towerId];
        if (chefId == 5) return [20400, 202600, 607600, 1215000, 2025000][towerId];
        if (chefId == 6) return [30600, 304000, 911400, 1822600, 3037600][towerId];
        revert("Incorrect chefId");
    }

    function getYield(uint256 towerId, uint256 chefId) internal pure returns (uint256) {
        if (chefId == 1) return [50, 560, 1790, 3820, 6780][towerId];
        if (chefId == 2) return [80, 850, 2720, 5810, 10300][towerId];
        if (chefId == 3) return [120, 1280, 4130, 8820, 15640][towerId];
        if (chefId == 4) return [180, 1950, 6280, 13400, 23790][towerId];
        if (chefId == 5) return [280, 2970, 9540, 20350, 36200][towerId];
        if (chefId == 6) return [420, 4500, 14390, 30760, 55060][towerId];
        revert("Incorrect chefId");
    }
