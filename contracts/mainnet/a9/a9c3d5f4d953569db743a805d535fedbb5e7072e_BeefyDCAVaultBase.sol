...
// File: @openzeppelin-4/contracts/token/ERC721/extensions/IERC721Metadata.sol
...
// File: @openzeppelin-4/contracts/utils/Strings.sol
...
// File: @openzeppelin-4/contracts/utils/introspection/ERC165.sol
...
// File: @openzeppelin-4/contracts/token/ERC721/ERC721.sol
...
// File: @openzeppelin-4/contracts/utils/math/SafeMath.sol
...
// File: contracts/BIFI/strategies/DCA/IMooStrategy.sol


pragma solidity >=0.6.0 <0.9.0;
interface IMooStrategy {
...
// File: contracts/BIFI/strategies/DCA/IMooVault.sol


pragma solidity >=0.6.0 <0.9.0;
interface IMooVault is IERC20 {
    ...
    function want() external view returns (IERC20);
    function strategy() external view returns (IMooStrategy);
}

// File: contracts/BIFI/strategies/DCA/IDCAStrategy.sol
...
// File: @openzeppelin-4/contracts/token/ERC721/extensions/IERC721Enumerable.sol
...
// File: contracts/BIFI/strategies/DCA/BeefyERC721Enumerable.sol
...
// File: contracts/BIFI/strategies/DCA/BeefyDCAVaultBase.sol
...
contract BeefyDCAVaultBase is BeefyERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    function userInfo(uint256 _id) external view returns (address user, uint256 principal, uint256 interest) {
        user = ownerOf(_id);
        principal = underlyingBalance[_id];
        interest = earned(_id);
    }
