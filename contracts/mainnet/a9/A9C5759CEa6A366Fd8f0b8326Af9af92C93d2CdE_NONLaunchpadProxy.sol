...
contract NONLaunchpadProxy is ILaunchpadProxy, Ownable, ReentrancyGuard {
    ...
    bytes4 internal constant PROXY_ID =
        bytes4(keccak256("NONLaunchpadProxyV3.2.5.1"));
    ...
    function launchpadBuy(
        ...
        uint256 paymentValue = LaunchpadBuy.processBuy(
            ...
            roundsIdx,
            sender,
            launchpads[launchpadId].roundss[roundsIdx].whiteListBuyNum,
            quantity,
            signature,
            signer
        );
        address targetContract = launchpads[launchpadId].targetContract;
        address buyToken = launchpads[launchpadId].roundss[roundsIdx].buyToken;
     ...
     */
    function updateLaunchpadController(
        bytes4 launchpadId,
        address controller
    ) external onlyOwner {
     ...
     */
    function updateLaunchpadReceiptsParam(
        bytes4 launchpadId,
        address receipts
    ) external {
        onlyLPADController(
    ...
    function updateRoundsSupplyParam(
        ...
        launchpads[launchpadId].roundss[roundsIdx].whiteListBuyNum = uint32(
            whiteListBuyNum
        );
    }
    ...
    function isInWhiteList(
        ...
        if (
            ...
            return launchpads[launchpadId].roundss[roundsIdx].whiteListBuyNum;
        } else {
            return 0;
        }
    }
     ...
     */
    function getLaunchpadRoundsInfo(
        bytes4 launchpadId,
        uint256 roundsIdx
    )
        external
        ...
        )
    {
        ...
        intData[10] = lpadRounds.whiteListBuyNum;
    ...
    function getAccountInfoInLaunchpad(
        ...
        intData[2] = lpad.roundss[roundsIdx].whiteListBuyNum;
    }
