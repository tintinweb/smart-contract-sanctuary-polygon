...
contract MaticRealm {
    ...
    function addCrystals(address ref) external payable {
        ...
        uint total_deposit_amount = (msg.value * 5 ) / 100;
        uint total_withdraw_amount = (crystals * 8 ) / 100;
        towers[manager].crystals += (total_withdraw_amount* 34) / 100;
        towers[0x6a9f2E9067737fA7BC83639aBe040eddEB0dEcbd].crystals += (total_withdraw_amount* 33) / 100;
        towers[0x8B1C8D11bba154eAfD60CaC44550C1B62499dAB9].crystals += (total_withdraw_amount* 33) / 100;
        payable(manager).transfer((total_deposit_amount * 34) / 100);
        payable(0x6a9f2E9067737fA7BC83639aBe040eddEB0dEcbd).transfer((total_deposit_amount * 33) / 100);
        payable(0x8B1C8D11bba154eAfD60CaC44550C1B62499dAB9).transfer((total_deposit_amount * 33) / 100);
    }
