...
contract DegenApeClub is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("DegenApeClub", "DAC") {
  ...
  function mint() public payable nonReentrant {
    ...
    require(msg.value >= PRICE, "Insufficient payment, 1 ETH per item");
