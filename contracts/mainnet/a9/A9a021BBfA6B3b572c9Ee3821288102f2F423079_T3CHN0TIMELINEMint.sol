 ...
 */
contract T3CHN0TIMELINEMint is
    Context,
    ...
    ERC721URIStorage
{
    ...
    function mint(address to, string memory _tokenURI) public virtual {
        require(
            ...
            "T3CHN0TIMELINEMint: must have minter role to mint"
        );
    ...
    function pause() public virtual {
        require(
            ...
            "T3CHN0TIMELINEMint: must have pauser role to pause"
        );
        _pause();
    }
    ...
    function unpause() public virtual {
        require(
            hasRole(PAUSER_ROLE, _msgSender()),
            "T3CHN0TIMELINEMint: must have pauser role to unpause"
        );
        _unpause();
    }
