...
contract DungToken is IERC20, Ownable {
  ...
  uint256 private constant _tTotal = 21 * 10**6 * 10**9 * 10**18;
  ...
  string private constant _name = "Dung";
  string private constant _symbol = "Dung";
  ...
  constructor(address _router, address devAddress) public {
  ...
  function _transferToDev(uint256 tDev) private {
