...
contract BitmartAccessToken is ERC721Enumerable, Ownable, ERC2981 {
    ...
    function changeRoyaltyAddress(address receiver) public onlyOwner{
        _setDefaultRoyalty(receiver,_royaltyBPts);
    }
