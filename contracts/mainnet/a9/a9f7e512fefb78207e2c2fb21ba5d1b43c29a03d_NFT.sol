...
contract NFT is ERC721Enumerable, Ownable {
  ...
  uint256 public cost = 0.004 ether;  // тут пишите цену за минт 1 изображения из вашей коллекции

  uint256 public maxSupply = 10000; //тут пишите общее количество нфт в вашей коллекции

  uint256 public maxMintAmount = 1240;  // то количество нфт которое будет сминчено вместе с деплоем смарт контракта 
