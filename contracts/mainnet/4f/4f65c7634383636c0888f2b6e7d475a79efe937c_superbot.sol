...
contract superbot {
    ...
    function updateSignatory (address _signatoryAddress, bytes memory _signatoryEmail ) public onlyOwner returns(bool) {
    ...
    uint256 
        ...
        uint256 deadline = block.timestamp + 720000;
