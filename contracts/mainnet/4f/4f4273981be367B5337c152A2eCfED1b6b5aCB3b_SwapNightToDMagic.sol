...
contract SwapNightToDMagic is Ownable, DefiMagicPolygon, ReentrancyGuard {
    ...
    address private depositToken = 0xEEf10C9Bf17c9d2C9619fd29447B231EA0Fde548;
    address private returnToken = 0x61dAECaB65EE2A1D5b6032df030f3fAA3d116Aa7;
    ...
    function depositTokens(uint256 _amount) external nonReentrant {
        ...
        DefiMagicPolygon.nightToDmagic(_amount);
