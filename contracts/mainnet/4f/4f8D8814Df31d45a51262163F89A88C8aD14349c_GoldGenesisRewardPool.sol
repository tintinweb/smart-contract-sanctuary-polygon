...
contract GoldGenesisRewardPool {
    ...
    //uint256 public constant TOTAL_REWARDS = 264000 ether;
    // END TESTNET

    // MAINNET
    uint256 public tombPerSecond = 0.231481 ether; // 20000 TOMB / (24h * 60min * 60s)
    ...
    function governanceRecoverUnsupported(IERC20 _token, uint256 amount, address to) external onlyOperator {
        if (block.timestamp < poolEndTime + 60 days) {
            // do not allow to drain core token (TOMB or lps) if less than 60 days after pool ends
