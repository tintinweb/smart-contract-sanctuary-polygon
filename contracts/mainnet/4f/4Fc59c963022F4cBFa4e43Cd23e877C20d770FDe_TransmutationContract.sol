    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 434) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://metadata.mintfoundry.xyz/c/j2U6h3vhrGX4DMht4asj/token/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/gNPNDyRcJDcg5SnoWr0j/contract-metadata";
  }
...
// File: contracts/TransmutationContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TransmutationContract is ERC721APlus {
    constructor() ERC721APlus("Transmutation", "TRSM"){}
}
