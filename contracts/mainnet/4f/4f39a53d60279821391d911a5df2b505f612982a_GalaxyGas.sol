...
contract GalaxyGas is IERC721Receiver, Ownable {
    using Strings for uint256;

    address public constant collectionAddress = 0x3f4626A985c67A4C0A06810CD74F2ef02740B5af;
    uint256 public constant GRACE_PERIOD = 60 * 60 * 24 * 1;
    uint256 public constant STAKE_MAX_PERIOD = 60 * 60 * 24 * 1;
