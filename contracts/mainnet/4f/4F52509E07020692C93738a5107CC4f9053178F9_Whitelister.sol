...
contract Whitelister is Initializable{
    ...
    function setBorrowLimit(uint32 _whitelistId, uint256 _borrowlimit) public onlyApproved {
        IAavegotchi(im_diamondAddress).setBorrowLimit( _whitelistId,  _borrowlimit);
    }
}
