...
contract RobotPunkCollection is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_)
    ERC721("Robot Punk Collection ", "RPK")
  {
  ...
  uint256 public constant MINT_LIMIT_PER_WALLET = 3555;
  ...
  uint256 public constant MAX_SUPPLY = 3555;

  uint256 public constant MAX_MULTIMINT = 3555;
  ...
  function mint(uint256 count) public payable nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 3555 at a time");
