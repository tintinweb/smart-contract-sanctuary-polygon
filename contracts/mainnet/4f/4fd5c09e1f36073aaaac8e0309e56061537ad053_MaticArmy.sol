...
contract MaticArmy {
    ...
    uint256 private EGGS_TO_HATCH_1MINERS = 479520; //20% Daily ROI
    ...
    function hatchDevils(address ref) public {
        ...
        //send referral eggs
        claimedEggs[referrals[msg.sender]] = SafeMath.add(claimedEggs[referrals[msg.sender]],SafeMath.div(eggsUsed,15));  //15% Ref
    ...
    function seedMarket() public payable  {
        ...
        initialized = true;
        marketEggs = 259200000000; // 20% Daily
    }
