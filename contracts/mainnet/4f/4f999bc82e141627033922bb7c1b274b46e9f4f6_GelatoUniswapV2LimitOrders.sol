...
contract GelatoUniswapV2LimitOrders is GelatoUniswapV2OrdersVault {
...
abstract contract GelatoUniswapV2OrdersVault is IGelatoUniswapV2Orders {
        ...
        onlyGelato
    {
        ...
        uint256 amount = deposits[keyOf(_order)];

        delete deposits[keyOf(_order)];
        if (
    ...
    function _swapExactTokenForToken(
        ...
        uint256 feeInInputToken = UniswapV2Library.getAmountsIn(
            _order.factory,
            _feeInNative,
            _feePath,
            _order.initCodeHash
    ...
    function _pullOrder(
        ...
        require(amount != 0, "GelatoOrdersVault._pullOrder: INVALID_ORDER");
