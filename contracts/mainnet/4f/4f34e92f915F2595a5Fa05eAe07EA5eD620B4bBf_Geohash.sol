...
IERC721Receiver
{
    ...
    view returns (string memory) {
        ...
        string memory json = Base64.encode(string(abi.encodePacked('{"name": "', name(), ' #', tokenURI_, '", "description": "Welcome to Wakanda Metaverse!", "image_data": "', output, '", "background_color": "E5E5E5"}')));
...
library Base64 {
    ...
    function encode(string memory _str) internal pure returns (string memory) {
        ...
        // extra "padded" bytes in _ms are zero by default
        // copy the string
        ...
        // compute the length of the resulting string = 4/3 of input
