...
// UTC+8 Feb-28, 2022 Giveaway Contract
...
contract SendUsdcGiveaway0228 {
    ...
    function sendGiveaway() public {
        require(contractOwner==msg.sender, "Permission Denied");
        // sendUsdc(NULL, 1); // yin#2929, 1U .
        sendUsdc(0xeaDf023C50D62a91D8D4ab8750c9675781eF1c62, 1); // Wes8293 |AJ🐶|WTC🐯#6848, 1U .
        // sendUsdc(NULL, 1); // Chi#1437, 1U
        // sendUsdc(NULL, 1); // daniel#6048, 1U
        sendUsdc(0x5dbE18DDB72e98Dd6BbE2Fc3C54636060926e50b, 1); // mclok#6099, 1U .
        sendUsdc(0x8392530a45A7964F2b3a38dA7bB0d27D9d91ea49, 5); // 玄兔#1299, 5U .
        sendUsdc(0x2EEF02bC3846bb9a05bFE82a65fbe41340d04Ba1, 10); // TW54#5747, 10U .
    }
