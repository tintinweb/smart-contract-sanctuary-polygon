    ...
    EIP712MetaTransaction
{
    ...
    uint256 public constant TEAM_FEE = 500; // 3%
        ...
        nonReentrant
    {
        ...
        uint256 amountToWithdrawToTeam = (_lotteries[_lotteryId]
            .amountCollectedInCake * TEAM_FEE) / 10000;

        // Calculate the amount to share post-treasury fee
        uint256 amountToShareToWinners = _lotteries[_lotteryId]
            .amountCollectedInCake - amountToWithdrawToTreasury;
        ...
        cakeToken.safeTransfer(treasuryAddress, amountToWithdrawToTreasury - amountToWithdrawToTeam);

        cakeToken.safeTransfer(teamAddress, amountToWithdrawToTeam);
        ...
        onlyOwnerOrInjector
    {
        ...
        emit LotteryInjection(msg.sender, _lotteryId, _amount);
    }
    ...
    function startLottery(
        ...
        require(_treasuryFee >= TEAM_FEE, "Treasury fee too low");
    ...
    function viewUserParticipatingLottery()
        external
        view
        returns (uint256[] memory)
    {
        return _userParticipatingLotteryId[_msgSender()].values();
    }
...
interface IPancakeSwapLottery {
     ...
     * @param _lotteryId: lotteryId
     * @param _ticketNumbers: array of ticket numbers between 1,000,000 and 1,999,999
     * @param _referralNumber: referral number
     * @dev Callable by users
     */
    function buyTickets(
        uint256 _lotteryId,
