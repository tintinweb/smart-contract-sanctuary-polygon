...
function addOp(address account) external onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function inputCanExactOutput(uint256 amountIn) external  returns (uint256 amountOut,uint256 fee) {
       ( amountOut,,,fee) = quoterV2.quoteExactInputSingle(
    ...
    function swapExactInputSingle(address receiver,uint256 amountIn,uint256 bizId)  external onlyRole(DEFAULT_OP_ROLE) returns (uint256 amountOut) {
