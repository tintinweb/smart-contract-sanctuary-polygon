...
// File: contracts/MissWorldPhilippinesMentalHealth.sol
...
contract MissWorldPhilippinesMentalHealth is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  // uint256 public requested;
  uint256 public currentSupply = 0;
  
  string public baseURI = "https://ipfs.io/ipfs/QmUMuQJHvBwDbFfxTLEsVxAMDVChaqeC5jwVCz2smpJfpW/";
  uint256 public cost = 224 ether;

  constructor() 
    ERC721("MISS WORLD PHILIPPINES MENTAL HEALTH NFT", "MWPNFT")
