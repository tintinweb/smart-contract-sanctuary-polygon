...
// File contracts/tokens/polygon/LOVE.sol

pragma solidity 0.8.4;

contract LOVE is YToken {
    uint256 public constant MAX_TOTAL_SUPPLY = 10_000_000 ether;
    ...
    constructor(
        ...
        _mint(msg.sender, 352_500 ether);
        _mint(_daoFund, 800_000 ether); // 8%
        _mint(_devFund, 800_000 ether); // 8%
        _mint(_treasuryFund, 400_000 ether); // 4%
        _mint(_reserve, MAX_TOTAL_SUPPLY - 400_000 * 5 ether - 352_500 ether);
        operator = msg.sender;
    }
