...
interface Engine {
    ...
    function createEvent(uint _id, address _conCheck, uint _conValue) external;
}

contract ORL_Staking is Ownable, Concatenate {
    ...
    function createEvent(uint _id, uint _size, address _conCheck, uint _conValue, uint _matP, uint _nutP) public {
        ...
        if (_id == 1){
            ...
            for(i; i < 19; i ++){
                ...
                rulesByRace[i] = _rules;
                _engine.createEvent(i,_conCheck,i);
            }
        } else {
            _rules.gridSize = _size;
            _rules.conCheck = _conCheck;
            ...
            _engine.createEvent(_id,_conCheck,_conValue);
        }      
    }
