...
contract Indelible is ERC721AX, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    bytes32 private constant TIER_2_MERKLE_ROOT = 0xbf4bd4178cbc8c63867fd92be43108c0a45c651ebb29386daca8d943a03b2b70;
    ...
    bytes32 private merkleRoot = 0xbf4bd4178cbc8c63867fd92be43108c0a45c651ebb29386daca8d943a03b2b70;
    ...
    ContractData public contractData = ContractData(unicode"Puppy 1/1", unicode"a puppy onchain has never been so cute.", "https://files.indelible.xyz/profile/649cd12b-3976-44f0-b064-1e8b9e9df7ad", "https://files.indelible.xyz/banner/649cd12b-3976-44f0-b064-1e8b9e9df7ad", "", 0, "0xf376A6a24B0c36A86024AeA15841893B43cF35f8");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"Puppy 1/1", unicode"pup") {
        tiers[0] = [5];
        tiers[1] = [5];
        tiers[2] = [5];
        tiers[3] = [5];
