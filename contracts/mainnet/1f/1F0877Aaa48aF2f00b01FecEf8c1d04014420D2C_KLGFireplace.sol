...
// File: KLGFireplace.sol

/**
 * @title KLG Fireplace
 * 
 * Kathie Lee Gifford’s Fireside Chat NFTs are the second drop in the KLG 
 * Pioneer Community. These NFTs provide access to all Fireside Chats and 
 * select community events. #KLGFiresideChat
 * 
 * To get all the benefits of the KLG Pioneer Community, such as a virtual 
 * happy hour and lunch with KLG in Nashville, become a Star NFT holder. 
 * 
 * This collection supports her philanthropic missions through the Association 
 * to Benefit Children in New York City and The Rock, The Road and the Rabbi 
 * Foundation. 
 * 
 * Check out KathieLeeGiffordNFT.com for more details.
 */
contract KLGFireplace is ViciManagedERC721WithRecall {
    constructor()
    ...
    {
        setContractURI("ipfs://QmNQLQEmfb4wGG78RtGfYnX8vnWRPzQ7jbUB9SaBXKhMoE");
        setBaseURI("ipfs://QmfQiswF4AHvWxtdh9t4DSzjwDCCqWJz3Vj8A1oCWbzREX/");
    }
