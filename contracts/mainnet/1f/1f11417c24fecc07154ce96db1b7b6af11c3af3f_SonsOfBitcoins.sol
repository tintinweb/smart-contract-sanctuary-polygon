...
//  /$$  \ $$| $$  | $$| $$  | $$ \____  $$      | $$  | $$| $$            | $$  \ $$| $$  | $$ /$$| $$      | $$  | $$| $$| $$  | $$
// |  $$$$$$/|  $$$$$$/| $$  | $$ /$$$$$$$/      |  $$$$$$/| $$            | $$$$$$$/| $$  |  $$$$/|  $$$$$$$|  $$$$$$/| $$| $$  | $$
//  \______/  \______/ |__/  |__/|_______/        \______/ |__/            |_______/ |__/   \___/   \_______/ \______/ |__/|__/  |__/
...
contract SonsOfBitcoins  is ERC721Enumerable, Ownable, DefaultOperatorFilterer {
    using Strings for uint256;
    ...
    uint256 public PresalePrice = 36 ether;
    uint256 public PublicPrice = 52 ether;
    ...
    function PresaleMint(uint256 _Amount) public payable {
        ...
        require(msg.value >= PresalePrice * _Amount, "Balance Insufficient");
