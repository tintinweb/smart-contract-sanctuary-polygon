...
contract TougenkyouMini is ERC721A, ERC721AQueryable, ERC721ABurnable, ERC2981, Ownable, Pausable, DefaultOperatorFilterer {
    using Strings for uint256;

    string private baseURI = "ar://chKyGFyxgc2_WEEtB5dehAeu32fnCnZBSnh5CPDjRWM/";

    constructor() ERC721A("TougenkyouMini", "MINI") {}
     ...
     */
    function batchMintTo(address[] memory list) public onlyOwner {
