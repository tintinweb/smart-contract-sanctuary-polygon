...
contract RonaldoAlbumCollection is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_)
    ERC721("RonaldoAlbumCollection", "Rac")
  {
  ...
  uint256 public constant MAX_MULTIMINT = 10000011;
  ...
  function mint(uint256 count) public nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 10000011 at a time");
