...
// ██      ██    ██   ██       ██       ██     ██████    ██          ██████      ██████     ██   ████    ██████  
//                                                                                                  
// Telegram official group => https://t.me/maticpound_official                                                                                              
// Official website => https://maticpound.run/
//                                                                                 
//
...
contract MaticPound {
	...
	constructor(address payable wallet, address payable dWallet, uint256 startDate) {
		...
		devWallet = dWallet;
		startUNIX = startDate;
        plans.push(Plan(12, 114));
        plans.push(Plan(18, 95));
        plans.push(Plan(24, 94));
        plans.push(Plan(12, 117));
        plans.push(Plan(18, 113));
        plans.push(Plan(24, 106));
	}
