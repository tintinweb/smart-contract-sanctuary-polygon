...
//       / /___  / /_____  _____   / __ \____  / /_____  _____   / ___/___  ____ __________  ____     <  /
//  __  / / __ \/ //_/ _ \/ ___/  / /_/ / __ \/ //_/ _ \/ ___/   \__ \/ _ \/ __ `/ ___/ __ \/ __ \    / / 
// / /_/ / /_/ / ,< /  __/ /     / ____/ /_/ / ,< /  __/ /      ___/ /  __/ /_/ (__  ) /_/ / / / /   / /  
// \____/\____/_/|_|\___/_/     /_/    \____/_/|_|\___/_/      /____/\___/\__,_/____/\____/_/ /_/   /_/   
//                                                                                                        
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x69BE378d6BaB44181FA7885DC68E76BbFC54F089,0x225eda4423B9522ade57bb73C9E00d305401BF6f,0x588Fe7E8E2B3EB19e701091332A2f5110AE79CA4];
...
abstract contract EarlyMintIncentive is Ownable, ERC721A {
  uint256 public PRICE = 52 ether;
  uint256 public EARLY_MINT_PRICE = 42 ether;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 224) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmZwKjxQL7UGbqzmiYJMMFXYC1woFGxUC5NvLr4d8VHZEJ/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 224");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 224");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 224");
