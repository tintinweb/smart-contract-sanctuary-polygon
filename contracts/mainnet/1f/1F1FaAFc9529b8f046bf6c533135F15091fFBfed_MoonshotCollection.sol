...
import "../../layerzero/upgradeable/NonblockingLzAppUpgradeable.sol";
...
contract Loot8UpgradeableCollection is ERC721Upgradeable, ERC721RoyaltyUpgradeable, ILoot8Collection, ILoot8BurnableCollection, NonblockingLzAppUpgradeable {
    ...
    CountersUpgradeable.Counter public collectionCollectibleIds;
    ...
    function __Loot8UpgradeableCollection_init(
        string memory _name, 
        ...
        __NonblockingLzAppUpgradeable_init(_layerZeroEndpoint);
    ...
    */
     ...
     * @param _patron address Address of the patron
     */
    function mintNext(address _patron) external {
    ...
    function burn(uint256 tokenId) external {
        require(
            ...
            (_msgSender() == manager && !disabled), "UNAUTHORIZED OR BURN DISABLED"
        );
        _burn(tokenId);
    }
    ...
    */
    function estimateFees(uint16 _dstChainId, address _userApplication, bytes calldata _payload, bool _payInZRO, bytes calldata _adapterParams) external virtual view returns (uint256 nativeFee, uint256 zroFee) {
        return
            ILayerZeroEndpointUpgradeable(lzEndpoint).estimateFees(
                _dstChainId,
                _userApplication,
                _payload,
                _payInZRO,
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721Upgradeable, ERC721RoyaltyUpgradeable) returns (bool) {
        return  interfaceId ==  0x01ffc9a7 || // IERC165
                ...
                interfaceId ==  0xfc45651b || // ILoot8Collection
...
import "./Loot8UpgradeableCollection.sol";

contract MoonshotCollection is Loot8UpgradeableCollection {
    ...
    event GovernorSet(address _newGovernor);
    ...
    function initialize(
        ...
        require(_governor != address(0), "ZERO ADDRESS(0): GOVERNOR");
        require(_trustedForwarder != address(0), "ZERO ADDRESS(0): FORWARDER");
        __Loot8UpgradeableCollection_init(_name, _symbol, _transferable, _governor, _governor, _trustedForwarder, _layerZeroEndpoint);
        contractURI = _contractURI;
    }

    function setContractURI(string memory _contractURI) external virtual {
        require(_msgSender() == governor, "UNAUTHORIZED");
        require(!locked, "COLLECTION LOCKED");
        contractURI = _contractURI;
    }
    ...
    function setTokenURI(uint256 _tokenId, string memory _tokenURI) external virtual {
        require(_msgSender() == governor, "UNAUTHORIZED");
        require(!locked, "COLLECTION LOCKED");
    ...
    function lockCollection() external {
        require(_msgSender() == governor, "UNAUTHORIZED");
        require(!locked, "COLLECTION ALREADY LOCKED");
        locked = true;
    }

    function setNewGovernor(address _newGovernor) external virtual {
        require(_msgSender() == governor, "UNAUTHORIZED");
        require(!locked, "COLLECTION LOCKED");
        require(_newGovernor != address(0), "ZERO ADDRESS(0): GOVERNOR");
        require(_newGovernor != governor, "INVALID NEW GOVERNOR");
...
// SPDX-License-Identifier: MIT
// Source Link https://github.com/LayerZero-Labs/solidity-examples/blob/main/contracts/contracts-upgradable/lzApp/LzAppUpgradeable.sol

pragma solidity ^0.8.2;

import "../../../util/BytesLib.sol";
import "@openzeppelin/contracts-upgradeable/access/OwnableUpgradeable.sol";
import "../../../interfaces/layerzero/upgradeable/ILayerZeroReceiverUpgradeable.sol";
import "../../../interfaces/layerzero/upgradeable/ILayerZeroEndpointUpgradeable.sol";
import "../../../interfaces/layerzero/upgradeable/ILayerZeroUserApplicationConfigUpgradeable.sol";
...
// SPDX-License-Identifier: MIT
// Source Link https://github.com/LayerZero-Labs/solidity-examples/blob/main/contracts/contracts-upgradable/lzApp/NonblockingLzAppUpgradeable.sol
...
// SPDX-License-Identifier: MIT
// Source Link https://github.com/LayerZero-Labs/solidity-examples/blob/main/contracts/contracts-upgradable/interfaces/ILayerZeroEndpointUpgradeable.sol
...
// SPDX-License-Identifier: MIT
// Source Link https://github.com/LayerZero-Labs/solidity-examples/blob/main/contracts/contracts-upgradable/interfaces/ILayerZeroReceiverUpgradeable.sol
...
// SPDX-License-Identifier: MIT
// Source Link https://github.com/LayerZero-Labs/solidity-examples/blob/main/contracts/contracts-upgradable/interfaces/ILayerZeroUserApplicationConfigUpgradeable.sol
...
interface ICollectionManager is ICollectionData, ILocationBased {
    ...
    function getAllCollections(CollectionType _collectionType, bool _onlyActive) external view returns(IExternalCollectionManager.ContractDetails[] memory _allCollections);
...
// Source Link https://github.com/LayerZero-Labs/solidity-examples/blob/main/contracts/util/BytesLib.sol
/*
