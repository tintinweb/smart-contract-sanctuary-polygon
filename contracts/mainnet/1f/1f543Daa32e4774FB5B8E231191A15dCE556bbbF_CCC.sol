...
contract CCC is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeifrcvaz2tgi2v2bfzw3h4ypz75uqnny5hey3mlznsbfpy25qm4d2e/", Strings.toString(tokenId), ".json")
            );
    }
