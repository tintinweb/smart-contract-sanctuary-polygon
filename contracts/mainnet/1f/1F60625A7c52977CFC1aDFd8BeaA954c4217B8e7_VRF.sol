...
contract VRF is Ownable, AccessControl, ReentrancyGuard {
    ...
    function request() onlyRole(CONSUMER_ROLE) nonReentrant external returns (uint256) {
        _requestId++;
    ...
    function oracleCallback(uint256 id, uint256 value) onlyRole(ORACLE_ROLE) nonReentrant public {
