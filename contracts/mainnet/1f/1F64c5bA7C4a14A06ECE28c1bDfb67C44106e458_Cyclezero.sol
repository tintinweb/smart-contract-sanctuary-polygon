...
contract Cyclezero is ERC20, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    constructor() ERC20("cyclezero", "CZ") ERC20Permit("cyclezero") {
        _mint(msg.sender, 933120000 * 10 ** decimals());
    }
