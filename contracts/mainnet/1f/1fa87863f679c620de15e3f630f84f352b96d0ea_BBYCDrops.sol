...
contract BBYCDrops is ERC1155, AccessControl {
    bytes32 public constant BBYC_ADMIN_ROLE = keccak256("BBYC_ADMIN_ROLE");
    ...
    constructor() ERC1155("") {
        _setupRole(BBYC_ADMIN_ROLE, msg.sender);
    ...
    function setTokenSupply(uint256 id, uint supply)
        public
        onlyRole(BBYC_ADMIN_ROLE) {
        maxTokenSupply[id] = supply;
    }

    function setURI(string memory newURI) public onlyRole(BBYC_ADMIN_ROLE) {
        _setURI(newURI);
    }
