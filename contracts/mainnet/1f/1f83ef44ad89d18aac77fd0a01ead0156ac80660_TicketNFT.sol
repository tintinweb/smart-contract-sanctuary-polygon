...
contract POAP is ERC721 {
    ...
    uint256 public poapCounter;      // default value: 0
    ITicketNFT public ticketNFT;     // default value: 0x0000...
    ...
    function mint(uint256 ticketId) external {
        require(ticketNFT.ownerOf(ticketId) == msg.sender, "Caller is not the ticket holder.");
...
contract TicketNFT is ERC721, ITicketNFT {
    IERC20 public cJPYToken;         // default value: 0x0000...
    address public owner;            // default value: 0x0000...
    uint256 public startTime;        // default value: 0
    uint256 public ticketCounter;    // default value: 0
    uint256 public ticketPrice;      // default value: 0
