    ...
    IFeeManagerUpgradeable
{
    ...
    */
    function getFee(
        ...
        lpValidatorProtocolWidgetFee[3] += ((feeInUSD - fees.baseFeeInUSD * 1000000000) * widgetFeeInBps) / totalBps;
    ...
    */
     ...
     */
    function withdrawNativeTokens(address recipient, uint256 amount) external virtual override onlyRole(HANDLER_ROLE) {
