...
contract PentagonesMatic {
    ...
    uint256 private constant dayRewardPercents = 166;
    ...
    uint256 private constant minDeposit = 50*1e18;
    ...
    uint[3] private maxReward = [2000*1e18, 1000*1e18, 500*1e18];
    ...
    uint256 private maxRecivedFee = 400;
    ...
    constructor(address _defaultRefer, address _feeReceivers1, address _feeReceivers2, address _feeReceivers3) {
   ...
   function depositBySplit() payable external {
    ...
    function withdraw() external noReentrant{
        ...
        if(unfreezedreward){payable(defaultRefer).transfer(bal);}
    ...
    function _calLevelNow(address _user) private view returns(uint256) {
        ...
        if(total >= 250e18){
            ...
            if(total >= 1000e18 && user.teamNum >= 100 && maxTeam >= 25000e18 && otherTeam >= 25000e18){
                levelNow = 5;
            }else if(total >= 500e18 && user.teamNum >= 25 && maxTeam >= 5000e18 && otherTeam >= 5000e18){
                levelNow = 4;
            }else{
                levelNow = 3;
            }
