...
// Metabytes with Governance.
contract Metabytes is BEP20('MetaBytes', 'MByte') {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "Metabytes::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "Metabytes::delegateBySig: invalid nonce");
        require(now <= expiry, "Metabytes::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "Metabytes::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "Metabytes::_writeCheckpoint: block number exceeds 32 bits");
