...
contract iDoCrypto is IERC20, Auth {
    ...
    string constant _name = "iDoCrypto";
    string constant _symbol = "IDC";
    ...
    constructor () Auth(payable(msg.sender)) payable {
    ...
    function addReflectionsPair() external authorized returns(bool) {
