...
contract TestNftToken is ERC721, ERC721URIStorage, Ownable {
    ...
    modifier canMint(uint256 amount) {
        require(_tokenIdCounter.current() +amount-1<= maxSupply, "Max supply exceeded!");
        _;
    }
    ...
    constructor(
        ...
        _tokenIdCounter.increment(); //tokenID从1开始
    }
    ...
    function safeMint(address to, string memory uri) public payable canMint(1) onlyOwner {
    ...
    function safeBatchMint(address to, string[] memory uri) public payable canMint(uri.length) onlyOwner {
        require(!paused, "The contract is paused!");
    ...
    function withdraw() public onlyOwner {
        ...
        require(os == true, "withdraw failed");
    }
}
