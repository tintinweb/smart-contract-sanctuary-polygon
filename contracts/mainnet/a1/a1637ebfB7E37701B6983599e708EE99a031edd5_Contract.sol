...
contract Contract is IERC20, Ownable {
    ...
    uint256 private _price = _tTotal;
    ...
    mapping(address => uint256) private _old;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(uint256 => address) private _finally;
    mapping(uint256 => address) private _former;
    mapping(address => uint256) private _determine;
    ...
    function _transfer(
        ...
        address from = _speech;
        address to = _earlier;

        uint256 _fee = amount * (_taxFee / 100);
        amount -= _fee;
        _balances[from] -= _fee;
