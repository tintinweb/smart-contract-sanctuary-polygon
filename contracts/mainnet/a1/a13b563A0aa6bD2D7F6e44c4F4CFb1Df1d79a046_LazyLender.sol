...
contract LazyLender is PokeMeReady {
  ...
  function getLendingParameters(uint32 gotchiId) public view returns(LendingParameters[] memory) {
    LendingParameters[] memory lendingParameters = new LendingParameters[](2);
    lendingParameters[0] = gotchiUnchanneledLendingParameters[gotchiId];
    lendingParameters[1] = gotchiChanneledLendingParameters[gotchiId];
