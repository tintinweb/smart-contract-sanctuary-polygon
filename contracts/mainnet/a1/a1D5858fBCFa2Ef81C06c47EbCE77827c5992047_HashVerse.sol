...
contract HashVerse is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("HashVerse", "HASHVERSE") {
    setHiddenMetadataUri("ipfs://Qmb8GL341p7RouevpsTDFbsZeDJRnWB85ss9kzCW4QePTY/hidden.json"); //to set
    buildings.push(Building("ZERO", 0,0,0,0,0,0));
    buildings.push(Building("House", 1,3,2,2,0,3));
    buildings.push(Building("]immyHouse", 2,5,4,10,0,6));
    buildings.push(Building("Gallery", 1,6,2,10,0,0));
    buildings.push(Building("House", 1,1,2,7,0,-7));
    buildings.push(Building("CoolHouse", 2,3,1,-9,0,-9));
    buildings.push(Building("House", 1,3,3,-4,0,2));
    buildings.push(Building("RayHouse", 2,5,2,-2,0,5));
    buildings.push(Building("House", 2,6,1,-10,0,4));
    buildings.push(Building("Ghosthouse", 4,1,4,5,0,0));
    buildings.push(Building("BeachHouse", 3,1,3,-4,0,-5));
  ...
  function withdraw() public onlyOwner {
    // This will pay HashWhale 5% of the initial sale.
    // =============================================================================
