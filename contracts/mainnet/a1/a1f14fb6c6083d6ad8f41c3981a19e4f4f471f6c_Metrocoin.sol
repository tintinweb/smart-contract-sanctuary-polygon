...
contract Metrocoin is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 25 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = 'Metrocoin';
    ...
    uint constant MEV_COOLDOWN_TIME = 10 minutes;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if (_cooldownWhitelist[sender] != true) {
            require(_cooldowns[sender] <= uint32(block.timestamp), "Please wait 10 minutes before transferring or selling your tokens.");
        }
