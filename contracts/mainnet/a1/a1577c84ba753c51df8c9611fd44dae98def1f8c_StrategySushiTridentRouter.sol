...
// File contracts/BIFI/strategies/Sushi/StrategySushiTridentRouter.sol
...
contract StrategySushiTridentRouter is StratFeeManagerInitializable, GasFeeThrottler {
    ...
    function assignParams(
        ...
        ITridentRouter.ExactInputParams storage _params
    ) internal {
