    ...
    EIP712MetaTransaction
{
    ...
    function safeMint(string memory uri, uint96 royaltyFee) external {
        address sender = msg.sender;
        require(royaltyFee <= 10000, "Royalty exceeds maxium");
        uint256 tokenId;
        ...
        _setTokenRoyalty(tokenId, sender, royaltyFee);
