...
// | $$    $| $$     | $$  | $| $$  | $$ | $$ /$| $$  | $| $$  \ $| $| $$  | $| $$      \____  $$       /$$  \ $| $$  | $$
// |  $$$$$$| $$     |  $$$$$$| $$$$$$$/ |  $$$$|  $$$$$$| $$$$$$$| $|  $$$$$$| $$      /$$$$$$$/      |  $$$$$$| $$$$$$$/
//  \______/|__/      \____  $| $$____/   \___/  \______/|_______/|__/\______/|__/     |_______/        \______/|_______/ 
//                    /$$  | $| $$                                                                                        
//                   |  $$$$$$| $$                                                                                        
//                    \______/|__/                                                                                        
//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x1b7bdED8c825Ff833b0CF0C71099465FFe0a37c2];
  address public erc20Payable = 0x1b7bdED8c825Ff833b0CF0C71099465FFe0a37c2;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeid7rpt3ou5v4nmyxfeozyhxv5pj4rrbgr75n7c6nh6feiexkdpaam/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/N8HVBrIEI8delyeKqTdb/contract-metadata";
  }
...
// File: contracts/CryptoBlurs3DContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CryptoBlurs3DContract is ERC721APlus {
    constructor() ERC721APlus("CryptoBlurs 3D", "CBLUR3D"){}
}
