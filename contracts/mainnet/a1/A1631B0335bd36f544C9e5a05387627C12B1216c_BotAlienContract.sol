...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1674945540;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1674874140;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0xE249f1a12B9102f93C0B1221ff8030CF5DA732f9];
  address public erc20Payable = 0xE249f1a12B9102f93C0B1221ff8030CF5DA732f9;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeicqs5tmjbzcxmwbbb6ilwzwltj7cm4netnkptksa37rpmnyexglsm/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/mYHZNdqnTOULN9zitcHj/contract-metadata";
  }
...
// File: contracts/BotAlienContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BotAlienContract is RamppERC721A {
    constructor() RamppERC721A("BotAlien", "BotAlien"){}
}
