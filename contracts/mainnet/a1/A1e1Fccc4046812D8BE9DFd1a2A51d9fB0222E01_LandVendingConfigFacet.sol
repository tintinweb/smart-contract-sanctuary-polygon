...
contract LandVendingConfigFacet  {
    function loadLandVendingConfig() external {
        ...
        // LibLandVendingEnvironmentConfig.configureForMumbaiTestnet(LibDiamond.contractOwner());
        LibLandVendingEnvironmentConfig.configureForPolygonMainnet(LibDiamond.contractOwner());
    }
}
...
library LibLandVendingEnvironmentConfig {
    ...
    function initialLandVendingLoad() private {
        ...
        //owedRBW
        LibLandVending.setOwedRBW(50000000000000000000);
