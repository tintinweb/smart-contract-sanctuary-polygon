...
contract AttendeeNFT_V2 is ERC721URIStorageUpgradeable {
    ...
    /**
        @dev    batch mint
    */
    function batchMint(address[] calldata _attendees) external _onlyOwner {
    ...
    function mint(address _attendee) external _onlyOwner {
        _mintNFT(_attendee);
    }
