...
contract VogoSpace is ERC721Enumerable, Ownable {
	...
	address liquidity = 0x8975aBbA158B510bAAc487e5502001400B00f08A;
	...
	constructor (
		...
		giveAway(1, 0x8975aBbA158B510bAAc487e5502001400B00f08A); //RACKS
		giveAway(1, 0x2C278aA121a06D5952F6D05f1b4819a5542C1b38); //DEV1
		giveAway(1, 0x2c5669ECC8D7C7eA7113B5629E3E36b74f1F9223); //DEV2
		giveAway(1, 0x9c1cC9FA8c5a1Bf5023c927fAD995B07e019c3Cf); //DEV3
		giveAway(1, 0xbe7A0e3aa705B893DD458445e29ada77B98d20b5); //PRESENT
		giveAway(1, 0xC2667c8c825A3FfC7b74c680023D6977f1c810a0); //RACKS2
		giveAway(1, 0x4312F157D85fc3DE46a13df30a16E6B1c880fA70); //DEV4

		giveAway(3, 0x8975aBbA158B510bAAc487e5502001400B00f08A); //RACKS
		giveAway(3, 0x2C278aA121a06D5952F6D05f1b4819a5542C1b38); //YONA
		giveAway(3, 0x2c5669ECC8D7C7eA7113B5629E3E36b74f1F9223); //DEV2
		giveAway(3, 0x9c1cC9FA8c5a1Bf5023c927fAD995B07e019c3Cf); //DEV3
		giveAway(3, 0xbe7A0e3aa705B893DD458445e29ada77B98d20b5); //RACKS2
		giveAway(3, 0xC2667c8c825A3FfC7b74c680023D6977f1c810a0); //DEV4
	}
	...
	function withdraw() public payable onlyAdmin {
		...
		// =============================================================================
			(bool DEV2, ) = 0x2c5669ECC8D7C7eA7113B5629E3E36b74f1F9223.call{value: each}("");
			require(DEV2, "transaction failed");
			(bool DEV3, ) = 0x9c1cC9FA8c5a1Bf5023c927fAD995B07e019c3Cf.call{value: each}("");
			require(DEV3, "transaction failed");
			(bool DEV1, ) = 0x2C278aA121a06D5952F6D05f1b4819a5542C1b38.call{value: each}("");
			...
			require(DEV4, "transaction failed");
			 (bool PRESENT, ) = 0xC2667c8c825A3FfC7b74c680023D6977f1c810a0.call{value: help}("");
