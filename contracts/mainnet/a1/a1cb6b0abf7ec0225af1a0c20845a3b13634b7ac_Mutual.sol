...
contract Mutual is FDFRisk{
    ...
    function withdraw() external lock {
        ...
        UserRewardInfo memory  uri = userRewardInfo(msg.sender);
        debtWithdrawInfos[msg.sender] = DebtWithdrawInfo(
        uri.totalCapitals,uri.totalStatic,uri.totalLevel1,uri.totalLevel25,uri.totalLevel68,uri.totalLevel910);
    }
    ...
    function userRewardInfo(address _user) public view returns(UserRewardInfo memory) {
        RewardInfo memory ri = rewardInfo[_user];
        ...
        uri.totalLevel68 = uri.totalLevel68 - debtu.totalLevel68;
        uri.totalLevel910 = uri.totalLevel910 - debtu.totalLevel910;
