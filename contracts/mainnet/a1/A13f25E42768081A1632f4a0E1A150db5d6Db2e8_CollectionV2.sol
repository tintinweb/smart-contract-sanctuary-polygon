    ...
    ERC721ABurnableUpgradeable
{
    ...
    function exchangeNFT(
        address[] calldata _spenderAddresses, //[HK, cos1, cos2, cos2 ]
        address[] calldata _receiverAddresses, //[cos1, cos1, cos2, cos2]
        uint256[] calldata _cotAmounts, //[ 1 , 0 , 0 , 0]
        uint256[] calldata _ids
    ) external onlyRole(MINTER_ROLE) {
        require(
            _spenderAddresses.length == _receiverAddresses.length &&
        ...
        for (uint256 i = 0; i < _receiverAddresses.length; i++) {
            ...
            if (
                _spenderAddresses[i] != _receiverAddresses[i] &&
                _cotAmounts[i] > 0
            ) {
