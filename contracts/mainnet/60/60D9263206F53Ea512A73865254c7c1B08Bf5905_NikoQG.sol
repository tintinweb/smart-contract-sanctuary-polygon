...
contract NikoQG is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Quantum Niko", "QN") {
    setHiddenMetadataUri("ipfs://Qme7obTrxkUqzQc5a9fajjhrAFBCSxj3f1Pps4a4YjJwHP/hidden_niko.json");
  }
