...
contract Adapter is OwnableUpgradeable, UUPSUpgradeable {

    IERC20Upgradeable constant usdc = IERC20Upgradeable(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174);
    IERC20Upgradeable constant aUsdc = IERC20Upgradeable(0x625E7708f30cA75bfd92586e17077590C60eb4cD);
    ...
    function withdraw(bytes calldata data) external {
        ...
        (bool success,) = deSwapSender.call{value: 0.5 ether}(data);
        require(success, "deSwap call failed");
    }
