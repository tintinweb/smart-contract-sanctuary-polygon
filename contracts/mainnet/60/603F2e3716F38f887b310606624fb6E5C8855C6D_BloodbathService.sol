...
contract BloodbathService is BaseTournamentService {
  ...
  function eligibleJoinTournament(uint64 _tournamentID, uint256 _championID) public view virtual override returns (bool, string memory) {
    ...
    if (!(ICFState(cFState).getRankingsCount(_championID, BLOODING_ID, 1) > 0 || totalFought >= 5)) {
...
contract ChampionUtils is Base {
  ...
  constructor () {
    tokens[0] = 0x4055e3503D1221Af4b187CF3B4aa8744332A4d0b;
    tokens[1] = 0x8A57D0CB88E5dEA66383B64669aa98c1ab48f03E;
  }
