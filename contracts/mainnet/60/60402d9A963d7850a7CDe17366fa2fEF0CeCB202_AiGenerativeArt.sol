...
contract AiGenerativeArt is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeick7mfljsrzscnduphg7i6luizgfghucsj6uolxq33jcqyi5rqjze/", Strings.toString(tokenId), ".json")
            );
    }
