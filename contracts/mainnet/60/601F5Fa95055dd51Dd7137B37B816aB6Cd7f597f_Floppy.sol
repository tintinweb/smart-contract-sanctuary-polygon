...
// File: contracts/TestProfilePicture.sol
...
contract Floppy is ERC721 {
    ...
    constructor() ERC721("Floppy", "FLOP") {}
            ...
            Base64.encode(
                bytes(
                    abi.encodePacked(
                        ...
                        '<image href="https://thispersondoesnotexist.com/image" height="400" width="400">',
						"</image>",
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                '{"name":"Floppy", "image":"',
                                image,
                                unicode'", "description": "This NFT marks the bound address as a member of the Floppy. The image is a fully-onchain dynamic profile picture."}'
                            )
                        )
                    )
                )
