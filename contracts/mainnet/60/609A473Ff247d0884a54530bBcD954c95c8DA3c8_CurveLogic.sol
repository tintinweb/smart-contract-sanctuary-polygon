...
contract CurveResolver is Helpers {
    ...
    address public constant DATA = 0x2F417a997fE47354A7d39Eea198d0F472CA93706;
    ...
    function swap(
        ...
        uint256 feesPaid = _payFees(IERC20(dest), received);
        ...
        emit LogSwap(pool.underlying_coins(i - 1), pool.underlying_coins(j - 1), realAmt);
    }
    ...
    function addLiquidity(
        ...
        ICurvePool pool = ICurvePool(IData(DATA).curvePools(lpToken));
        ...
        emit LogLiquidityAdd(token, address(0), realAmt, 0);
    }
    ...
    function removeLiquidity(
        ...
        address pool = IData(DATA).curvePools(lpToken);
        ...
        emit LogLiquidityRemove(ICurvePool(pool).underlying_coins(tokenId), address(0), amountReceived, 0);
    }
    ...
    function removeLiquidity2(
        ...
        emit LogLiquidityRemove(ICurvePool(pool).coins(tokenId), address(0), amountReceived, 0);
    }
}
