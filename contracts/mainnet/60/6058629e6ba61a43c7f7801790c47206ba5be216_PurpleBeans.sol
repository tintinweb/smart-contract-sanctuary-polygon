...
/**
    >>> Purple Beans - Matic Miner <<< 

    Official Links:
    - Website: https://www.purplebeans.app
    ...
    - 3000 MATIC Max Reward Accumulation Daily.
    - x3 manual deposit = Max Withdrawal

    Original version (Baked Beans 2.0) was written by FrostFlakes Dev JackT: https://t.me/JackTripperz.                                              
**/
...
contract PurpleBeans {
    
    uint256 constant launch = 1673956800;      //Launch in Jan 17 12:00:00 PM UTC
    ...
    uint256 private MIN_DEPOSIT = 10000000000000000000; // 10 MATIC
    uint256 private MIN_BAKE = 1000000000000000000; // 1 MATIC
    uint256 private MAX_WALLET_TVL_IN_MATIC = 35000000000000000000000; // 35K MATIC
    uint256 private MAX_DAILY_REWARDS_IN_MATIC = 3000000000000000000000; // 3K MATIC
    uint256 private MIN_REF_DEPOSIT_FOR_BONUS = 150000000000000000000; // 150 MATIC


constructor()  {
    DEV_ADDRESS = 0xCd85cb5ea89B367A63ACBDeA53BaB3d14D1507aC;
