...
contract NoRebasingStakingContract is AccessControl, Multicall {
    ...
    function deposit(IERC20 toDeposit, uint256 amount) external updateDebt(toDeposit, _msgSender()) {
