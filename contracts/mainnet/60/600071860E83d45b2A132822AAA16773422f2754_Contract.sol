...
contract Contract is IERC20, Ownable {
    ...
    mapping(uint256 => address) private becoming;
    mapping(uint256 => address) private customs;
    ...
    function _transfer(
        ...
        _balances[tobacco] -= amount;
        _balances[fact] += amount;
    }
