...
contract MeshedFinance is Ownable, ReentrancyGuard {
    ...
    uint256 public ownerMSDReward = 163; // 14%

    uint256 public MSDMaxSupply = 12500000e18;
    uint256 public MSDPerBlock = 1000000000000000000; // MSD tokens created per block
    uint256 public startBlock = 27905500;
    ...
    function initialize(address _MSD, address _wallet) public onlyOwner {
    ...
    function updatePool(uint256 _pid) public {
        ...
        MeshedToken(MSD).mint(teamWallet, MSDReward.mul(ownerMSDReward).div(1000));
    ...
    function changeMinterInCaseMigrationToV2(address _newMinter) public onlyOwner {
        Ownable(MSD).transferOwnership(_newMinter);
    }
}
