...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0xe6cFACb20CAaF709055837A285FB20752662723a];
...
// File: contracts/TestlandgamebeableContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract TestlandgamebeableContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "TEST LAND GAME BEABLE";
    string public symbol = "TLGB";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/Yx6Bvs0vHLysLil1hBhM/contract-metadata";
  }
