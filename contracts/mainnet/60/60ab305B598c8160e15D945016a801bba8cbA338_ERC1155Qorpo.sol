...
contract TokenAccessControl {
    ...
    modifier onlyAuthorizedUser {
        require(authorizedContracts[msg.sender], "caller is not an authorized user");
        _;
    }

    modifier onlyOwnerOrAuthorizedUser {
        require(authorizedContracts[msg.sender] || msg.sender == owner, "caller is not an authorized user or an owner");
        _;
    }
    ...
    function setAuthorizedUser(address _operator, bool _approve) public onlyOwner {
        if (_approve) {
...
contract ERC1155Qorpo is ERC1155, TokenAccessControl, ERC2981{
