 ...
 * @notice This contract handles minting Kachina Kiva tokens.
 */
contract KachinaKiva is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address public royaltyAddress = 0x5fa6b2bf6e0047914b520619726417a6cBB942E4;
    // Permanently freezes metadata so it can never be changed
    bool public metadataFrozen;
    string public baseTokenURI =
        "ipfs://bafybeidxzkownfjznf5wkdd63jqgsovovp6taraeta663tiztw2nxowmoi/";
    // Maximum supply of tokens that can be minted
    uint256 public MAX_SUPPLY = 56;
