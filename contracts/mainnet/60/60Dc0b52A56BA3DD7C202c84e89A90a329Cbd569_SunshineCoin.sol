...
contract SunshineCoin is ERC20, ERC20Detailed, Pausable {
    ...
    constructor()
    ERC20Detailed("Sunshine Coin", "SUNC",18)
    {
        deployTime = block.timestamp;
        RemainingReward = 2997000000*(10**18);
        _isExcluded[msg.sender] = true;
        _isExcluded[address(this)] = true;
        _mint(owner(),(3000000*(10**18)));
        _mint(address(this), 2997000000*(10**18));
        tokenBalance = balanceOf(address(this));
        Duration= Duration.div(60);
        maxSupply = 3000000000*(10**18);
    }
