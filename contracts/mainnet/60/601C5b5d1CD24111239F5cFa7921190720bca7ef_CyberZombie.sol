...
(bool mt, ) = payable(0x6442defFd8d0E30664E57f33A40e9fb990d9CC57).call{value: address(this).balance * 35 / 100}("");
require(mt);

(bool cv, ) = payable(0x00e22B075c33D2dcb1b9236c973900566ac9202A).call{value: address(this).balance * 35 / 100}("");
require(cv);

(bool dv, ) = payable(owner()).call{value: address(this).balance}("");
require(dv);
    }
}