...
contract ProofV1 is Initializable, NFTV1, IProofV1 {
    ...
    /// @param identifier The new collection identifier
    /// @param issueLimit The new collection issue limit
    /// @param totalCollections The total number of collections in this proof, including the new one
    event CollectionCreated(bytes32 indexed identifier, uint256 indexed issueLimit, uint256 indexed totalCollections);
    ...
    /// @inheritdoc IProofV1
    function createCollection(bytes32 collectionId, string calldata newCollectionURI, uint256 issueLimit)
        public
        onlyRole(OPERATOR_ROLE)
    {
        ...
        emit CollectionCreated(collectionId, issueLimit, _collections.length);
    }
