...
/**
 * @title   VestingLinear
 * @notice  VestingLinear contract
 * @dev     VestingLinear is constantly releasing vested tokens every block every second
 */
contract VestingLinear is Ownable, Lockable {
