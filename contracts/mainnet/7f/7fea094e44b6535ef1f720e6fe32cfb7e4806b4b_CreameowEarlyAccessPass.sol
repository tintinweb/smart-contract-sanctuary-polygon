...
contract CreameowEarlyAccessPass is
    ERC721,
    ERC721Enumerable,
    ERC721URIStorage,
    IERC2981,
    ...
    ClampedRandomizer
{
    ...
    address  public royaltyAddress = 0xf6e7Ee5260E982E70eD5e3C84bd34f8f90Bb5Bc6;
    ...
    constructor(address[] memory _devList,  uint256[] memory _fees) ERC721("CreameowEarlyAcessPass", "CEAP") ClampedRandomizer(maxSupply) {     
