...
contract NFTBurnMint is Ownable, ReentrancyGuard {
    ...
    function set_burnMintingIsPaused(bool _burnMintingIsPaused) external onlyOwner() {
    ...
    function set_NFT_COST_INCREASE_INTERVAL(uint _NFT_COST_INCREASE_INTERVAL, bool forceMintCountReset) external onlyOwner() {
    ...
    function set_NFT_BURN_COST(uint _NFT_BURN_COST) external onlyOwner() {
        require(_NFT_BURN_COST > 0, "NFT_COST_INCREASE_INTERVAL can't be 0!");
...
contract WHEAT is ERC20, Ownable, ReentrancyGuard {
    ERC20 public constant token_USDC = ERC20(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174);
