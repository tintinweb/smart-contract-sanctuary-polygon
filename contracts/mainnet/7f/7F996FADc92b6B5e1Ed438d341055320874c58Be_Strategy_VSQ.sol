...
contract Strategy_VSQ is Ownable {
    ...
    address public VESQ = 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174; // token0 - decimals 9
    ...
    function _getToken0Price() public view returns (uint256) {
        ...
        path[0] = DAI;
        path[1] = VESQ;
        return 1e18 / (_getAmountsOut(router, 100 * 1e18, path) / 100);
    }
    ...
    function _getToken1Price() public view returns (uint256) {
        ...
        path[0] = VESQ;
        path[1] = DAI;
        return 1e36 / (_getAmountsOut(router, 100 * 1e9, path) / 100);
    }
