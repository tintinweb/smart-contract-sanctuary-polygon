...
// UTC+8 Feb-20, 2022 Giveaway Contract
...
contract SendInviteGiveaway0220 {
    ...
    constructor() {
        ...
        addTop10Address(tmpAddr);
        tmpAddr = 0xdE2a649A23AFC45A55A4d68B7CFDd683279b62f6;
        addGiveawayAddress(tmpAddr, 3);
        addTop10Address(tmpAddr);
        tmpAddr = 0x1f72d8BC601eeef1C6b3b9A23EF3EB902C4878C8;
        addGiveawayAddress(tmpAddr, 2);
        addTop10Address(tmpAddr);
        tmpAddr = 0xE61975F13ebaa392cf2Ae31172072c2A3Fcfb8Dd;
        addGiveawayAddress(tmpAddr, 1);
        addTop10Address(tmpAddr);
        tmpAddr = 0xaF8e0e1dAC7c5b4236301758394d53954ecd63f5;
        addGiveawayAddress(tmpAddr, 1);
        addTop10Address(tmpAddr);
        tmpAddr = 0x700667eA93f0a43D41e26B093806d12F90c62fD1;
        addGiveawayAddress(tmpAddr, 1);
        addTop10Address(tmpAddr);

        addGiveawayAddress(0xb694a38be2a9FDd8bb199f3158b9C701747A0a8a, 1);
        addGiveawayAddress(0x2ebbd5a37Bca00ae65fE068a385F100729Bd7Bdb, 1);
    }
