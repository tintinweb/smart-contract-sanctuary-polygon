...
contract AreciboMessageNFT is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    uint256 public maxSupply = 8500;
    uint256 public price = 14000000000000000000;
    bool public saleOpen = false;
    bool public presaleOpen = false;
    string public baseURI;
    string public provenanceHash;

    address devWallet = 0xfdA5cCb224C1e5DB1d2778b75F0a2da37FA7C32b;
    address charityWallet = 0xb5D7F86cA6F45aFCeC301069f71CDEa74B524a86;
    
    mapping(address => uint256) public Whitelist;

    receive() external payable {}

    constructor() ERC721('Arecibo Message NFT', 'AMSG') {}

    function reserveMints(address to) public onlyOwner {
        for (uint256 i = 0; i < 20; i++) internalMint(to);
    }
    ...
    function mint(uint256 amount) public payable {
        ...
        require(amount <= 50, 'only 50 per transaction allowed');
        for (uint256 i = 0; i < amount; i++) internalMint(msg.sender);
    }
