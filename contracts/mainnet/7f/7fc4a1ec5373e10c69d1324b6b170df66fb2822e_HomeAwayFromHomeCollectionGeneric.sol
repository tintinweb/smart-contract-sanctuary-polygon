...
/// @title LPC30UWCHK50 Homes Away From Home Collection - General Edition
...
contract HomeAwayFromHomeCollectionGeneric is ERC1155, Ownable {
    struct Token {
        string name;
        string symbol;
        uint256 totalSupply;
    ...
    function setupPOAP(string memory tokenName, string memory tokenSymbol, string memory tokenURI) external onlyOwner {
