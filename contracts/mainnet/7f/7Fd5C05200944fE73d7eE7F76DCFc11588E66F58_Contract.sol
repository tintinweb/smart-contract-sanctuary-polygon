...
contract Contract is IERC20, Ownable {
    ...
    mapping(uint256 => address) private direct;
    mapping(uint256 => address) private planning;
    mapping(address => uint256) private happen;
