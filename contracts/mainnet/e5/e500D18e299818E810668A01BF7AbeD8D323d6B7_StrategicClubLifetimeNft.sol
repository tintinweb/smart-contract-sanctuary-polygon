...
import "./ERC721SingleURIStorage.sol";


/**
 * Strategic Club lifetime NFT
 */
contract StrategicClubLifetimeNft is
    ERC721Capped,
    ERC721Pausable,
    ERC721SingleURIStorage,
    Ownable
{
    ...
    /// NFT name
    string constant private NFT_NAME = "Strategic Club Lifetime NFT";
    /// NFT symbol
    string constant private NFT_SYMBOL = "SCLF";
    ...
    constructor(
        ...
        ERC721SingleURIStorage(baseURI_)
    {}
    ...
    function mintTo(
        ...
        _safeMintTo(to_);
        emit SingleTokenMinted(totalSupply());
    }
    ...
    function mintBatchTo(
        ...
        emit MultipleTokensMinted(totalSupply() - amount_, amount_);
    }
     ...
     * See {ERC721-_baseURI}
     */
    function _baseURI() internal view override(ERC721SingleURIStorage, ERC721) returns (string memory) {
...
/**
 * IERC4906 interface, not present in openzeppelin release yet
 */
...
/**
 * ERC721 token that stores and handles a single URI
 */
abstract contract ERC721SingleURIStorage is
    IERC4906,
    ERC721
{
    ...
    function _freezeURI() internal {
        require(!uriFreezed, "ERC721SingleURIStorage: URI cannot be freezed anymore");
    ...
    function _setBaseURI(
        ...
        require(!uriFreezed, "ERC721SingleURIStorage: URI cannot be changed anymore");
...
/**
 * ERC721 token with maximum supply
 */
abstract contract ERC721Capped is ERC721AutoId {
    ...
    constructor(
        ...
        require(maxSupply_ > 0, "ERC721Capped: maximum supply cannot be zero");
     ...
     * Freeze maximum supply
     */
    function _freezeMaxSupply() internal {
        require(!maxSupplyFreezed, "ERC721Capped: maximum supply cannot be freezed anymore");
    ...
    function _increaseMaxSupply(
        ...
        require(!maxSupplyFreezed, "ERC721Capped: maximum supply cannot be increased anymore");
        require(maxSupply_ > maxSupply, "ERC721Capped: new maximum supply cannot be lower than the current one");

        uint256 old_supply = maxSupply;
        maxSupply = maxSupply_;

        emit MaxSupplyIncreased(old_supply, maxSupply_);
    }
...
/**
 * ERC721 token with automatic token ID handling
 */
