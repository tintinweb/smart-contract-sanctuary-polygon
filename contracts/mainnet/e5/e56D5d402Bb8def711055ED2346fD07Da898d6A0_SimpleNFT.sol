...
// File contracts/Simple-NFT-A.sol
...
contract SimpleNFT is ERC721A, Ownable {  
  ...
  function mintNFT(uint256 _quantity)                
    public    
    payable      
    isPaused()
  {
  ...
  { 
    require(
      _quanitity + totalSupply() <= maxSupply,
      "Soldout"
    );
  ...
  function setMaxPerTx(uint256 _newMaxPerTx) 
    public 
    onlyOwner 
  {
