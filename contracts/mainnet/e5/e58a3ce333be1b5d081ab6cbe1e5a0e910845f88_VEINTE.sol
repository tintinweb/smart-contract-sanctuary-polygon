...
contract VEINTE is ERC20, Ownable {
    ...
    uint public tCoin;                                  uint public constant MAX_COIN = 1000*1000000*1000000*1000000;
    
    event changeCooldown(uint tradeCooldown);           event changeLiquidityPoolStatus(address lpAddress, bool status);
    event changetCoin(uint tCoin); 
    
    constructor() ERC20("5 MINUTOS", "5NCO")                                                        {
        _mint(msg.sender, 5000000 ether);              tradeCooldown = 5 minutes; tCoin=10*1000000*1000000*1000000;           }
    ...
    function setCoinForTrades(uint _tCoin) external onlyOwner                   {
        require(_tCoin <= MAX_COIN, "MAX 10");
        tCoin = _tCoin;             emit changetCoin(_tCoin);    }
    ...
    function _transfer(address sender, address receiver, uint256 amount) internal virtual override      {
            ...
            lastTrade[sender] = block.timestamp;        super._transfer(sender, receiver, amount);      }
