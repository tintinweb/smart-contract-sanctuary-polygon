...
// File: contracts/Teddieverse.sol
...
contract TeddieVerse is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("TeddieVerse", "TTVV") {
   ...
   buildings.push(Building("Trap house", 2,5,4,10,0,0));
   ...
   buildings.push(Building("School", 2,2,3,-10,0,0));
   buildings.push(Building("Gallery", 3,2,2,-3,0,-2));
  ...
  function withdraw() public onlyOwner {
    // This will pay 5% of the intial sales to the ToughTeddez DAO
    // =============================================================================
    (bool hs, ) = payable(0xA8c1C82A50A93691c236f713da0Ed65492f9Ab4D).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
