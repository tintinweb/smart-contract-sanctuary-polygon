...
contract HonestWorkNFT is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor(
        ...
        // remove after tests
        _mint(msg.sender, 0);
        _mint(0xC370b50eC6101781ed1f1690A00BF91cd27D77c4, 1);
        _mint(0x1da95D8C65F8f3e139A68e4FA5318F62ccAB137B, 2);
        tier[0] = 1;
        tier[0] = 2;
        tier[0] = 3;
        grossRevenue[0] = 100e18;
        grossRevenue[1] = 2500e18;
        grossRevenue[2] = 300000e18;
    }
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        toString(grossRevenue[_tokenId] / 1e18),
