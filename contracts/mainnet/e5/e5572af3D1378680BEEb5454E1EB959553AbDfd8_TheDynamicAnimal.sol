...
/*
The Dynamic Animal was hand drawn by Beane Coetzer. This is the first edition of the release with much more unique caracters to come.
There are 148 NFTs and the pricing is dynamicaly update per 10 Mints.
**/
...
contract TheDynamicAnimal is ERC721Enumerable, Ownable {
  using Strings for uint256;

  string baseURI;
  string public baseExtension = ".json";
  uint256 public cost = 30 ether;
  uint256 public maxSupply = 148;
