...
// File: contracts/c11/11Condos.sol
...
contract Condos11 is Ownable, ERC721 {
    using Strings for uint256;
    ...
    constructor() ERC721("11Condos", "CONDOS")  {}
    ...
    function mintBatchOwnable(address to, uint amount) external onlyOwner {
