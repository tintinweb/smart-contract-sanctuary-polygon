    ...
    AccessControlUpgradeable
{
    ...
    function openMysteryBox(uint256 boxNumber) public {
        require(boxNumber < mysteryBoxMaxCount, "Mystery Boxes not exist");
        require(
            msg.sender == mysteryBoxes[boxNumber].owner ||
                mysteryBoxes[boxNumber].owner == address(0),
            "Not your mystery box"
        );
        require(preorderFinished);
