...
contract FantomHouse is VRFConsumerBaseV2, Ownable, ReentrancyGuard {
	...
	//
	address private constant TOKEN_ADDRESS = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270;
	...
	// Minimum Bet & Deposit=============================================================
    //
	uint256 minBet = 1000000000000000; // default 0.001 wMATIC, worth 0.09 Cents ATM.
    ...
    uint256 minDeposit = 100000000000000000; // default 0.1 wMATIC, worth 9 Cents ATM.
