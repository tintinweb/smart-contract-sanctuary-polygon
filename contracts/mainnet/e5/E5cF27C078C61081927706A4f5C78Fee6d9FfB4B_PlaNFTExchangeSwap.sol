...
contract ExchangeSwap is ExchangeCoreSwap {
    ...
    function ordersCanMatch_(
        ...
        uint8[4] memory sidesKindsHowToCalls,
        ...
        Order memory buy = Order(
            ...
            AuthenticatedProxy.HowToCall(sidesKindsHowToCalls[1]),  // how to call
            addrs[3],  // maker erc20 token
            uints[0],  // maker erc20 amount
            addrs[4],  // taker erc20 addr
            uints[1],  // taker erc20 amount
        ...
        Order memory sell = Order(
            ...
            addrs[7],  // maker
            addrs[8],  // taker
            SaleKindInterface.Side(sidesKindsHowToCalls[2]),  // side
            AuthenticatedProxy.HowToCall(sidesKindsHowToCalls[3]),  // how to call
