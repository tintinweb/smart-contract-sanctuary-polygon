...
contract DadsAtWork is ERC721, PaymentSplitter {
    uint256 public totalSupply;
    uint256 private cost = 4.5 ether;
    ...
    constructor(address[] memory _payees, uint256[] memory _shares)
        ERC721("Dads At Work Club", "DAWRK")
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked(
                    "ipfs://QmV8TmKswx3SmyH54aU8H2wqgt5A7ebfuiLGunrtieKaHk/",
