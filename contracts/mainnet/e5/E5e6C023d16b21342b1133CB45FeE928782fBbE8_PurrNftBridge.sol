...
// File contracts/PurrNftBridge.sol
...
contract PurrNftBridge is ERC721Holder,EIP712, Pausable, AccessControl {
    ...
    constructor(address _nft) EIP712("PurrNftBridge","1") {
        nft = IERC721(_nft);
    ...
    function transferTokenToOffchain(uint256[] calldata tokenIds) external whenNotPaused {
