...
contract ERC721Reward is Initializable, AccessProtectedUpgradeable, BaseRelayRecipient, ERC721Upgradeable {
    ...
    function initialize(
        ...
        __ERC721Reward_init(_name, _symbol, _uri);
    }
    ...
    function __ERC721Reward_init(
        ...
        __ERC721Reward_init_unchained(_uri);
    }

    function __ERC721Reward_init_unchained(
        string memory _uri
    ) internal initializer {
        baseURI = _uri;
    }
