...
/**
 * @title ApeLiquidityBridge
 * @author DeFi Basket
 *
 * @notice Swaps using the ApeSwapBridge contract in Polygon.
 *
 * @dev This contract adds or removes liquidity from ApeSwapBridge through 2 functions:
 *
 * 1. addLiquidity works with 2 ERC20 tokens
 * 2. removeLiquidity works with 2 ERC20 tokens
 *
 */
contract ApeLiquidityBridge is IUniswapV2Liquidity {

    address constant public routerAddress = 0xC0788A3aD43d79aa53B09c2EaCc313A787d1d607;
    address constant public factoryAddress = 0xCf083Be4164828f00cAE704EC15a36D711491284;
