    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 100, 8192) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeic7ynbca4sfqcutorl2el5mcapo37qtx25qupryvqx3jiail2d5wq/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 8192");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 8192");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 8192");
...
// File: contracts/HapeclubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract HapeclubContract is RamppERC721A {
    constructor() RamppERC721A("HAPE CLUB", "HAPE CLUB"){}
}
