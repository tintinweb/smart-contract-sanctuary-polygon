...
contract NextTrialRun is ERC721, Ownable {
    ...
    constructor() ERC721("NextTrialRun", "NTR") {
        baseURI = "ipfs://QmYT5rHDJPE3zY4rTu7wH8LJhwVmHPDCfaP9XXDVrkyESD/";
    }
    ...
    // public
    function batch_mint(address _to, uint256 _mintAmount) public onlyOwner {
