...
contract NXNX20 is Ownable, ReentrancyGuard, IERC1155Receiver {
    ...
    uint numSetCategory;    // number of set category
    mapping(uint => uint256) setItemCategoryBonus;    // bonus of set category
    ...
    function depositSubNft(
        ...
        require(
            getExtraBoost(_nftAddress, _nftTokenId) > 0,
    ...
    function updateExtraBoost(
        ...
        if (numSetCategory < _setItemCategory) {
            numSetCategory = _setItemCategory;
        }
