...
// todo: check if router is used in tx and not from user input.
// todo: check if bridging fee can be paid with tokens? should we take it from user to our own contract?
// todo: fix usages of msg.value
// Todo: wtf is native address? read here: https://dev.routerprotocol.com/asset-swap-api/end-to-end-code-snippet
// Note: feeToken and bridgeToken allowance is given to the reserve contract : 0x6e14f48576265272b6caa3a7cc500a26050be64e

// bridge from eth to arbitrum scenario:
// grant approval for weth? to 0x6e14f48576265272b6caa3a7cc500a26050be64e which is reserveHandler

// To bridge usdt:
// grant approval for usdt to 6e14f48576265272b6caa3a7cc500a26050be64e which is reserveHandler
