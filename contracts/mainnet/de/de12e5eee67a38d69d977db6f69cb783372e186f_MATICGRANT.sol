...
/*   MaticGrant - investment platform based on Polygon blockchain smart-contract technology. Safe and legit!	
 * 	
 *	
 *                    
 *	
 ...
 *   2) Choose one of the tariff plans, enter the MATIC amount (0.05 MATIC minimum) using our website "Stake MATIC" button	
 *   3) Wait for your earnings	
 *   4) Withdraw earnings when due using our website "Withdraw" button	
 *	
 *   [INVESTMENT CONDITIONS]	
 *	
 *   - Basic interest rate: +0.5% every 24 hours (~0.02% hourly) - only for new deposits	
 *   - Minimal deposit: 0.05 MATIC, no maximal limit	
 *	
 *   [AFFILIATE PROGRAM]	
 *	
...
contract MATICGRANT {
	...
	constructor(address payable wallet, uint256 startDate)  {
		...
		plans.push(Plan(7, 1)); // 1% per day for 7 days
        plans.push(Plan(20, 13)); // 1.3% per day for 20 days
        plans.push(Plan(90, 15)); // 1.5% per day for 90 days
		plans.push(Plan(10, 0)); 
        plans.push(Plan(15, 0));
