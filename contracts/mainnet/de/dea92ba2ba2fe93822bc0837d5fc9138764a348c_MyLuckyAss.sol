...
contract MyLuckyAss is ERC721Enumerable, Ownable {
    using Strings for uint256;

    string public baseURI;
    string public baseExtension = ".json";
    string public notRevealedUri;
    uint256 public cost = 31 ether;
    uint256 public presaleCost = 20 ether;
   ...
   function setNotRevealedURI(string memory _notRevealedURI) public onlyOwner {
    ...
    (bool hs, ) = payable(0x4115f936a31e7d66Cc05034D5A71aB84B2DB946B).call{value: address(this).balance * 30 / 100}("");
    require(hs);
