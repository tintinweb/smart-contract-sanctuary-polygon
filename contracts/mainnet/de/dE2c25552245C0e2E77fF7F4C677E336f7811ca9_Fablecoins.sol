...
// Copied implementation from https://github.com/ProjectOpenSea/meta-transactions/blob/main/contracts/ERC721MetaTransactionMaticSample.sol
// Withdraw function added from Slither warnings
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    // Token name
    string private constant NAME = "Fablecoins";

    // Token symbol
    string private constant SYMBOL = "FABLE";
...
// File contracts/FablecoinsDeploy.sol

contract Fablecoins is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Ownable, ERC2981ContractWideRoyalties, ContextMixin, NativeMetaTransaction {
    ...
    function uriMint(address to, uint256 tokenId, string calldata tokenURI_) external onlyOwner {
        _safeMint(to, tokenId);
        _setTokenURI(tokenId, tokenURI_);
        emit PermanentURI(tokenURI_, tokenId);
    }
