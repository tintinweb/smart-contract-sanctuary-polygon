...
contract SUPERLATIVEAPESPOLYGON is ERC721, Ownable {
...
contract SuperlativeMagicLaboratoryPolygon is ERC1155Burnable, Ownable, ReentrancyGuard {

    using Strings for uint256;
    SUPERLATIVEAPESPOLYGON public slapeContract;
    ...
    {
        setBaseURI(_initBaseURI);
        slapeContract = SUPERLATIVEAPESPOLYGON(slapesAddress);
...
contract SUPERLATIVEMUTANTSPOLYGON is ERC721, Ownable, ReentrancyGuard {
    ...
    SuperlativeMagicLaboratoryPolygon public serumContract;
    SUPERLATIVEAPESPOLYGON public slapeContract;
    ...
    uint256 public maxPresaleSupply = 4444;
    uint256 public maxSupply = 4444;
    ...
    bool public mainsaleOpen = true;
    bool public mutateOpen = true;

    constructor(string memory _initBaseURI, address serumAddress, address slapeAddress) ERC721("Superlative Mutated Apes", "SMAPE")
    {
        slapeContract = SUPERLATIVEAPESPOLYGON(slapeAddress);
        serumContract = SuperlativeMagicLaboratoryPolygon(serumAddress);
        setBaseURI(_initBaseURI);
