...
contract BurnHandlerPolygon is BurnHandlerBase {
    ...
    function UNISWAP_V2_ROUTER() internal pure override returns (IUniswapV2Router02) {
        return IUniswapV2Router02(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff);
    }

    function UNISWAP_FACTORY() internal pure override returns (IUniswapV2Factory) {
        return IUniswapV2Factory(0x5757371414417b8C6CAad45bAeF941aBc7d3Ab32);
    }
}
