...
contract NFTsForUkraine is ERC1155, Ownable {
    ...
    constructor() ERC1155("NFTs For Ukraine") {
        minimumDonation = 75 ether;
        donationActive = false;
        beneficiary = 0xE1939Fe81A15D927D397f387C3B92bf5E38B6cAD;
    }
    ...
    function mint()
        ...
        payable
    {
        require(msg.value >= minimumDonation, "mint: Must donate at least 75 MATIC");
