...
contract BullZWallet is Ownable {
    ...
    InterfaceM _matic = InterfaceM(0x0000000000000000000000000000000000001010);
    ...
    function makeRequest(string memory reason, uint amount) public {
    ...
    function withdraw(uint voteID) public {
        ...
        uint _balance = _matic.balanceOf(address(this));
        ...
        require (_balance >= reqAmt, "Not enough MATIC in contract!");

        voteInfo[voteID].done = true;

        (bool success, ) = (msg.sender).call{value: reqAmt}("");
