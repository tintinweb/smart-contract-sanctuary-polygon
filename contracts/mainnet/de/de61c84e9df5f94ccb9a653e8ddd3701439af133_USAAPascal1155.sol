...
// File: contracts/USAAPascal1155.sol
...
contract USAAPascal1155 is ERC1155, Ownable { 
    uint256[] public supplies = [5000];
    uint256[] public minted = [0];
    string public name = "USAA Pascal Mascot";
    string public symbol = "USAAPASCAL";
    mapping(uint256 => mapping(address => bool)) public member;

    constructor() ERC1155("ipfs://bafybeicqw3jhortb47sptxju5tdh6mrino45grczhzhdbi6zwy5mw4xxvq/{id}.json")
        {
        }
    ...
    // to Put NFT to Opensea
     function uri(uint256 _tokenId) override public view returns (string memory) {
        ...
        return string(
        abi.encodePacked(
            "ipfs://bafybeicqw3jhortb47sptxju5tdh6mrino45grczhzhdbi6zwy5mw4xxvq/",
     ...
     function mint(uint256 _tokenId) 
        public
        {
         require(
            ...
            "You have already claimed this Pascal NFT."
        );    
        require(_tokenId <= supplies.length-1,"NFT does not exist");
