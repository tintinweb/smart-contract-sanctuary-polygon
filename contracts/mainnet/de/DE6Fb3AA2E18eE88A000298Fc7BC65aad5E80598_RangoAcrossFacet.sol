...
contract RangoAcrossFacet is IRango, ReentrancyGuard, IRangoAcross {
    ...
    bytes internal constant ACROSS_REWARD = hex"d00dfeeddeadbeef854A396158C1dfA01A44061c471cC4720c463FFc";
    ...
    function initAcross(address[] calldata _addresses) external {
    ...
    function acrossBridge(
        ...
        uint amountWithFee = amount + bridgeRequest.affiliateIn + bridgeRequest.feeIn + bridgeRequest.destinationExecutorFee;
        ...
        // TODO: handle deposit of feeIn, affiliate fee...
    ...
    function doAcrossBridge(
        ...
        bytes memory callData = concat(acrossCallData, ACROSS_REWARD);
...
interface IRango {
    ...
    event RangoBridgeInitiated(
        ...
        uint8 indexed bridgeId, // TODO: create enum for this
