...
contract RsaAccount is BaseAccount {
    ...
    bytes internal modulus =
        "";
    ...
    IEntryPoint private constant _entryPoint = IEntryPoint(address(0x0576a174D229E3cFA37253523E645A78A0C91B57));
...
contract RsaAccountFactory {
     ...
     */
    function createAccount(uint256 salt) public returns (RsaAccount ret) {
        address addr = getAddress(salt);
        uint256 codeSize = addr.code.length;
        if (codeSize > 0) {
            return RsaAccount(payable(addr));
        }
        ret = new RsaAccount { salt: bytes32(salt) }();
    }
    ...
    function getAddr(uint256 salt) public view returns (address addr) {
        addr = getAddress(salt);
    }
}
