...
contract WVC is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeie7oc2yz4wa2524eeflltu37mjdcuxtnsjn33766dtpgkzm4w6tea/", Strings.toString(tokenId), ".json")
            );
    }
