...
contract MintNft is ERC721URIStorage, Ownable {
    ...
    */
    ...
    {
        require(
            creators[msg.sender].creationTime > 0,
    ...
    */
    ...
    function getCreator(address creator) public view virtual returns (uint[] memory, uint, uint){
        Creator memory c = creators[creator];
        return (c.tokens, c.creationTime, c.lastUpdated);
    }
}