...
//    address public _stakingContract;
    ...
    initializer
    {
        ...
        authorisedInteraction[l2MotherContract] = true;
        __ERC1155_init(uri);
    }
    ...
    function burnToken(uint id) external {
        require (mintBlocker[id],'Token Not Present');
        mintBlocker[id] = false;
        burnedTokensByUser[id] = msg.sender;
        _burn(msg.sender, id, 1);
        emit BurnOnL2(msg.sender, id);
    }
