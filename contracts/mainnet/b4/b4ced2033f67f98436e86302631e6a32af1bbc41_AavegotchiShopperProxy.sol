...
interface ERC1155MarketplaceDiamondFacet {
...
interface ERC721MarketplaceDiamondFacet {
...
contract AavegotchiShopperProxy {
    ...
    ERC1155MarketplaceDiamondFacet private diamondMarketplaceERC1155 = ERC1155MarketplaceDiamondFacet(diamondAddr);
    ERC721MarketplaceDiamondFacet private diamondMarketplaceERC721 = ERC721MarketplaceDiamondFacet(diamondAddr);
    ...
    constructor() {
        owner = msg.sender;
         ghstERC20.approve(diamondAddr, 1e29);
    }
    ...
    function executeERC721Listing(uint256 listingId, uint256 maxAttempts) public onlyOwner {
        ...
        require(foundListingId != 0, 'Proxy - Listing could not be found');
        diamondMarketplaceERC721.executeERC721Listing(listingId);
    }
