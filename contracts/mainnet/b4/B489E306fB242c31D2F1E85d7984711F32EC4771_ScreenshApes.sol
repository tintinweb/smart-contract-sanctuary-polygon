...
contract ScreenshApes is ERC721, ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;
    using Strings for uint256;
    Counters.Counter private _tokenIdCounter;
    
    constructor() ERC721("ScreenshApes", "SAPE") {}

    string baseExtension = ".json";
    string baseURI = "https://QmSDxBq4zzWYH2XJMXFuTXXeRDu4g7duUNEgRYhUVs4zeS/";
