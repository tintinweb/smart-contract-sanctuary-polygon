...
contract Swype is Initializable, UUPSUpgradeable, PausableUpgradeable, OwnableUpgradeable, ReentrancyGuard {
    ...
    function onrampUsdc(
        ...
        bytes32 txHash = getTxHash(bankingTxId, address(_USDC), amount, 0, msg.sender);
        ...
        _USDC.safeTransfer(msg.sender, usdcAmountAfterFee);
    ...
    function onrampNativeExactIn(
        ...
        bytes32 txHash = getTxHash(bankingTxId, address(0), amount, 0, msg.sender);
    ...
    function onrampNativeExactOut(
        ...
        bytes32 txHash = getTxHash(bankingTxId, address(0), amountOut, 1, msg.sender);
        _onrampChecks(bankingTxId, exchange, signature, txHash);
    ...
    function onrampTokenExactIn(
        ...
        bytes32 txHash = getTxHash(bankingTxId, tokenOut, amount, 0, msg.sender);
        _onrampChecks(bankingTxId, exchange, signature, txHash);
        ...
        // Swap USDC to token
        _exactInSwap(exchange, swapData, address(_USDC), tokenOut, msg.sender);
    ...
    function onrampTokenExactOut(
        ...
        bytes32 txHash = getTxHash(bankingTxId, tokenOut, amountOut, 1, msg.sender);
        _onrampChecks(bankingTxId, exchange, signature, txHash);
        ...
        // Swap USDC to token
        uint256 amountReceived = _exactOutSwap(exchange, swapData, tokenOut, amountOut, msg.sender);
