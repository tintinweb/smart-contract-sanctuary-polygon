...
contract HyperMETA is ERC721, ReentrancyGuard, Ownable {
  ...
  uint256 public constant MAX_MULTIMINT = 256;
  ...
  function mint(uint256[] calldata ids) public nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 256 at a time");
