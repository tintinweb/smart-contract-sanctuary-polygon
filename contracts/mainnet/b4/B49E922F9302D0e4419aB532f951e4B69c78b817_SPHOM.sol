...
contract SPHOM is ERC20Permit, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 800000 * 10**9;
    ...
    constructor() ERC20("SPHOM", "spHOM", 9) ERC20Permit() {
    ...
    /**
        @notice increases SPHOM supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess SPHOM
