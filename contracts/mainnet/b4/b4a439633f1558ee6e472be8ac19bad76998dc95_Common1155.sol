...
contract Common1155 is ERC1155, AccessControl, Pausable, ERC1155Burnable, ERC1155Supply {
    ...
    constructor(string memory name_, string memory symbol_) ERC1155("") {
        ...
        _name = name_;
        _symbol = symbol_;
        _setURI("https://t33ftmy2i6wtcsqnzjqhktgbgzqqxwdj3th4rdrcqfymc6r4enea.arweave.net/nvZZsxpHrTFKDcpgdUzBNmEL2Gncz8iOIoFwwXo8I0g/HuuYaowPolygon_");
    }
    ...
    function uri(uint256 id) public view override(ERC1155) returns (string memory) {
        ...
        return string(abi.encodePacked(baseUri, idStr, ".json"));
    }
}