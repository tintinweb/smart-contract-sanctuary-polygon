...
contract TheyMaybeApesClub is ERC721A, Ownable, DefaultOperatorFilterer, ReentrancyGuard {
    ...
    constructor () ERC721A("They May Be Apes Club", "TMBAC") {
    }
    ...
    function mint(uint256 mintAmount) public payable callerIsUser nonReentrant {
        ...
        if(freeMint[msg.sender]) {
            ...
            require(msg.value >= (mintAmount - 0) * mintCost, "Not enough funds");
