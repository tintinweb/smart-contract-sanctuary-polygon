...
contract ChibiCitizen is IChibiCitizen, ERC721Enumerable, Base {
    ...
    function setLevel(
        ...
        require(_citizens[tokenId].minted, "CHIBI::NONEXISTENT_TOKEN");
    ...
    function setMetadata(
        ...
        require(_citizens[tokenId].minted, "CHIBI::NONEXISTENT_TOKEN");
        _citizens[tokenId].generation = generation;
        _citizens[tokenId].class = citizenClass;
        _citizens[tokenId].classId = classId;
        _citizens[tokenId].level = level;
        _citizens[tokenId].exp = exp;
    ...
    {
        require(_exists(tokenId), "CHIBI::NONEXISTENT_TOKEN");
