...
contract BridgeFacet {
    ...
    function getMessageHash(
        ...
        return keccak256(abi.encodePacked(getMessage(subscriptionManagerId, subscriptionId, user, price, nonce)));
    }
    ...
    function verify(
        ...
        string memory messageHash = getMessage(subscriptionManagerId, subscriptionId, user, price, nonce);
...
contract CicleoSubscriptionBridgeManager {
    ...
    function getDestinationCalldata(
     ...
     bytes4 test = BridgeFacet.bridgeSubscription.selector;
        return
