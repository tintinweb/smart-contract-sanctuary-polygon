...
contract DAIFI is DAIFIDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private DAIFITeam;
    address private CharityDAIFI;
    ...
    string public override name = "DAIFI";
    string public override symbol = "DAIFI";
    ...
    constructor(uint totalSupplyValue, address DAIFITeamAddress, address CharityDAIFIAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        DAIFITeam = DAIFITeamAddress;
        CharityDAIFI = CharityDAIFIAddress;
        
        // split the tokens according to agreed upon percentages
        balances[DAIFITeam] =  totalSupply * 4 / 100;
        balances[CharityDAIFI] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's DAIFITeam pot
