...
contract FDF {
    ...
    uint256 private constant dayPerCycle = 1 days;//15 days;
    ...
    uint256[15] private level5Percents = [200, 200, 200, 100, 100];
    ...
    function _calLevelNow(address _user) private view returns(uint256) {
        ...
        if(total >= 2000e6){
            ...
            if(total >= 4000e6 && user.teamNum >= 10 && maxTeam >= 50000e6 && otherTeam >= 50000e6){//user.teamNum >= 100
                levelNow = 5;
            }else if(user.teamNum >= 5 && maxTeam >= 20000e6 && otherTeam >= 20000e6){//user.teamNum >= 50
                levelNow = 4;
            }else{
                levelNow = 3;
            }
