 ...
 */
contract CollectNFT is KayrosNFTBase, ICollectNFT {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        return IKayros(HUB).getContentURI(_profileId, _pubId);
    }
    ...
    function _beforeTokenTransfer(
        ...
        IKayros(HUB).emitCollectNFTTransferEvent(_profileId, _pubId, tokenId, from, to);
    }
}
