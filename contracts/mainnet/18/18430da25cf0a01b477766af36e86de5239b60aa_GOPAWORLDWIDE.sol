...
/**
 * OFFICIAL WEBSITE : https://gopa.tech/
 * GOPA INTERNATIONAL PRESENT
 * A World Wide Community That Will Help You Make A Better Future
*/
...
contract GOPAWORLDWIDE is ERC20, Pausable, ERC20Detailed {
    
	address teamWallet = 0xc10e26458CcC1d4DE2f3bF3bD229b68651f18Fd6;
    address presaleWallet = 0x42395CCB473D61561Dd237DCcE3Bd585d1730d65;
    address partnerWallet = 0x81a70f3249C6404Ab54E6f6B1e6A81733994d696;
    address airdropWallet = 0xdefdA6c94355Ca5912be7Db08fB6e34f6f9F5c7E;
	...
	constructor() public ERC20Detailed("GOPA WORLDWIDE", "GOPA", 8) {  
	        
       
        totalCoins = 100000000 * 10 ** uint256(decimals());
        _mint(owner(), totalCoins); // total supply fixed at 100 Million coins
        
        ERC20.transfer(teamWallet, 20000000 * 10 ** uint256(decimals()));  
        ERC20.transfer(presaleWallet, 30000000 * 10 ** uint256(decimals()));
        ERC20.transfer(partnerWallet, 20000000 * 10 ** uint256(decimals()));
