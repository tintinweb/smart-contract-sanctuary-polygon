...
contract StrategyDodoUSDCSingleSided is StrategyBase {
    ...
    IDystopiaRouter public dystRouter = IDystopiaRouter(0xbE75Dd16D029c6B32B7aD57A0FD9C1c20Dd2862e);
    ...
    function swapAssetToUSDT() external onlyGovernance {
    ...
    function _swapDodoToUsdt() internal {
        // Swap half USDC for DODO
        uint256 _dodo = IERC20(dodo).balanceOf(address(this));
    ...
    function _swapUsdtToUsdc() internal {
    ...
    function _stakeUsdcToDodo() internal {
    ...
    function _harvest(address callFeeRecipient) internal {
        ...
        //swap through Dystopia (lower swap fees).
        _swapUsdtToUsdc();
