...
/// @title Contract for One Bupa presents Health Hero Series NFT
...
contract BupaHHSContract is ERC721A, Ownable {
    uint256 constant public MAX_SUPPLY = 2000;
    string private baseTokenURI;

    mapping(bytes32 => bool) public tidMinted;

    constructor() ERC721A("One Bupa presents Health Hero Series", "BUPAHHS") {
        baseTokenURI = "https://dot.dttd.group/BUPAHHS/";
        _mint(msg.sender, 1);
    }
