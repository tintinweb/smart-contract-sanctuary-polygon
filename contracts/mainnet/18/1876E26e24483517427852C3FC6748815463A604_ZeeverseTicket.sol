...
contract ZeeverseTicket is ERC721A, Ownable {
    ...
    uint256 public SALE_TIME_START = 1663236000; // 2022-09-15 18:00:00
    uint256 public SALE_TIME_END = 1663495200 ;// 2022-09-18 18:00:00
    ...
    ) ERC721A("Lootex Arcade - Zeeverse Legendary Ticket", "LTAR_ZV") {
    ...
    function mint(TokenStatus memory tokenStatus) external {
        ...
        require(SALE_TIME_END > block.timestamp, "Sell time is over"); //todo
