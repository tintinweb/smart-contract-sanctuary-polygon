...
contract Microlea is Ownable, ERC721A {
    string uri = "https://microlea.vercel.app/api/nft/id/";
    uint256 _totalSupply = 0;

    constructor() ERC721A("MICROLEA KYC", "MKYC") {}
    ...
    function mint(address to) public onlyOwner {
        require(balanceOf(to) == 0, "MKYC: You may only mint 1 per account");
        _mint(to, 1);
        _totalSupply += 1;
    }
     ...
     * note This prevents safeTransferFrom from operating (see ERC721A.sol source)
     */
    function transferFrom(
        address from,
        address to,
        ...
        require(false, "MKYC: Tokens are soul bound");
        from = from;
        to = to;
        tokenId = tokenId;
    }
