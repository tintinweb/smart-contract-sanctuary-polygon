...
contract BondDepo is Ownable {
    ...
    bool public immutable isStrategyEnabled; // Mint USDC to USD+
    address public immutable bondCalculator; // calculates value of LP tokens
    address public immutable strategyAddress; // calculates value of LP tokens
    ...
    uint public availableDebt; // amount of assets that can be bonded against
    ...
    constructor (
        ...
        isStrategyEnabled = (_strategyAddress != address(0));
    }
    ...
    function bondPriceInUSD() public view returns (uint price_) {
        if (isLiquidityBond) {
            price_ = bondPrice().mul(IBondingCalculator(bondCalculator).markdown(principle)).div(1000);
        } else {
