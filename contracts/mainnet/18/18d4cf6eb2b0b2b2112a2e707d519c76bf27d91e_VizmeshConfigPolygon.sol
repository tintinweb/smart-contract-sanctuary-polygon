...
contract VizmeshConfigPolygon {
        ...
        public
    {
        ...
        require(isOwnerOfSmartContract(), "Must be FRM owner or smart contract owner to update FRM coordinates.");
    ...
    {
        require(isPauseds[_frmId] == false, "FRM must not be paused");
        require(isOwnerOfSmartContract(), "Must be FRM owner or smart contract owner to update FRM NFT.");
    ...
    {
        require(isPauseds[_frmId] == false, "FRM must not be paused");
        require(isOwnerOfSmartContract(), "Must FRM owner or smart contract owner to update FRM NFT.");
