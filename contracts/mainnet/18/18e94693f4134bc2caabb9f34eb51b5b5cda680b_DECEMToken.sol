...
contract DECEMToken is ERC20, Ownable {
    uint256 public buyTax = 3;

    constructor() ERC20("DECEM token", "DTM") {
        _mint(0x65d5e12dcB550C0792dF2A70D016493C0cB81512, 7500 * 10**decimals());
    }
    ...
    function setBuyTax(uint256 tax) public onlyOwner {
        require(tax <= 100, "Buy tax cannot exceed 100%");
        buyTax = tax;
    }
}