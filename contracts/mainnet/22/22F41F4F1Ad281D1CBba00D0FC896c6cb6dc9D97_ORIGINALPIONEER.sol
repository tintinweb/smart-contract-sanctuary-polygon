 ...
 * @notice This contract handles minting ORIGINAL PIONEER tokens.
 */
contract ORIGINALPIONEER is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xECc863aa02EFb9E9375E8bf27af344C3B4DfA819;
    ...
    string public baseTokenURI =
        "ipfs://bafybeif5i5ovd35fitenimridqiwbavzpqddvofd3ljmb6osrbyq4ixiuq/";
    uint256 private currentLoanIndex = 0;
    // Maximum supply of tokens that can be minted
    uint256 public MAX_SUPPLY = 99999;
    // Total number of tokens available for minting in the presale
    uint256 public PRESALE_MAX_SUPPLY = 99999;
    // Fee paid to HeyMint per NFT minted
    uint256 public heymintFeePerToken;
    uint256 public presaleMintsAllowedPerAddress = 9;
    uint256 public presaleMintsAllowedPerTransaction = 99999;
    uint256 public presalePrice = 9 ether;
