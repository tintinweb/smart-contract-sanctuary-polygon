...
contract Testll is ERC721A, Ownable{
    using Strings for uint256;
    ...
    constructor() ERC721A("Testll", "Testll"){
    }
    ...
    function mint(uint256 _quantity) external payable callerIsUser{
        ...
        require((totalPublicMint[msg.sender] +_quantity) <= MAX_PUBLIC_MINT, "Already minted beyond times!");
    ...
    function friendshipmint(uint64 _password, uint256 _quantity) external payable callerIsUser{
        ...
        require((totalSupply() + _quantity) <= MAX_SUPPLY, "Beyond Max Supply");
        require((totalPublicMint[msg.sender] +_quantity) <= MAX_PUBLIC_MINT, "Already minted beyond times!");
        require(msg.value >= (FRIENDSHIP_SALE_PRICE * _quantity), "Below ");
