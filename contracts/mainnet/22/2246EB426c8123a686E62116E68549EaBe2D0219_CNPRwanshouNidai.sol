...
import "./CNPRwanshouNidaiAdmin.sol";

contract CNPRwanshouNidai is CNPRwanshouNidaiAdmin, ERC721A("CNP Rookies Wanshou Nidai", "CNPRWN") {
    constructor() {
...
import "./interface/ICNPRwanshouNidaiDescriptor.sol";
import "./CNPRwanshouNidaiConfig.sol";
import "@openzeppelin/contracts/access/AccessControl.sol";

abstract contract CNPRwanshouNidaiAdmin is CNPRwanshouNidaiConfig, AccessControl {
    /**
     ...
     */
    function setDescriptor(ICNPRwanshouNidaiDescriptor _descriptor) external onlyAdmin {
...
interface ICNPRwanshouNidaiDescriptor {
...
abstract contract CNPRwanshouNidaiConfig is Ownable {
    // The Project token URI descriptor
    ICNPRwanshouNidaiDescriptor public descriptor;
