...
contract testmint is ERC5192, Context, OwnableRoles {
    ...
    function distributeBatch(address[] calldata recipients, uint256[] calldata amounts) public onlyRolesOrOwner(ADMIN_ROLE) {
    ...
    function toggledistribute() public onlyRolesOrOwner(ADMIN_ROLE) {
