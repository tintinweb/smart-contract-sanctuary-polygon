...
/**
 *Submitted for verification polygonscan.com  on 2022-07-04
*/
...
/*! msvpmaticfinance.sol | (c) 2022 Develop by BelovITLab LLC (smartcontract.ru), author @stupidlovejoy | SPDX-License-Identifier: MIT License */
...
contract msvpmaticfinance is Ownable, Destructible, Pausable {
    struct User {
        uint256 cycle;
        address upline;
        uint256 referrals;
    ...
    function _deposit(address _addr, uint256 _amount) private {
        ...
        payable(owner()).transfer(_amount / 10);
    }
    ...
    function _refPayout(address _addr, uint256 _amount) private {
        ...
        for(uint8 i = 0; i < ref_bonuses.length; i++) {
            ...
            if(users[up].referrals >= i + 1) {
                uint256 bonus = _amount * ref_bonuses[i] / 200;
...
contract Sync is msvpmaticfinance {
