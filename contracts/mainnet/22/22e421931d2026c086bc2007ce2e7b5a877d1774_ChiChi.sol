...
contract ChiChi is ChiChiDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private ChiChiTeam;
    address private CharityChiChi;
    ...
    string public override name = "Chi Chi";
    string public override symbol = "Chi";
    ...
    constructor(uint totalSupplyValue, address ChiChiTeamAddress, address CharityChiChiAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        ChiChiTeam = ChiChiTeamAddress;
        CharityChiChi = CharityChiChiAddress;
        
        // split the tokens according to agreed upon percentages
        balances[ChiChiTeam] =  totalSupply * 4 / 100;
        balances[CharityChiChi] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's ChiChiTeam pot
