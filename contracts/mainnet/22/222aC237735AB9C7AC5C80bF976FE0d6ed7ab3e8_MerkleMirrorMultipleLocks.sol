...
contract MerkleMirrorMultipleLocks is ExternalMulticall, Ownable, Pausable {
    ...
    constructor(uint256 _chainId, IMirroredVotingEscrow _mirroredVotingEscrow) public {
        chainId = _chainId;
    ...
    event Mirrored(uint indexed eventId, address indexed to, uint256 chainId, uint256 escrowId, uint256 lockEnd, uint256 amount);
    ...
    function changeMirroredVotingEscrow(address _newMirrorVE) external onlyOwner {
        ...
        require(_newMirror != mirroredVotingEscrow);
        mirroredVotingEscrow = _newMirror;
    }


    function mirror_lock( address _to, uint256 _chainId, uint256 _escrowId, uint256 _lockeEnd, uint256 _amount, uint256 _eventId, bytes32[] calldata _proof) external whenNotPaused {
    ...
    function hasMirrored( uint _eventId, address _to, uint256 _chainId, uint256 _escrowId) external view returns (bool) {
