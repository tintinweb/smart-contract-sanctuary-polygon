...
// File: SamsBootlegger.sol

/**
 * @title Sam's Bootlegger
 * @dev Sam’s Anchor Cafe, located on the water in Tiburon and famous for fresh 
 * seasonal seafood, a fun atmosphere and breathtaking views of the Bay, is now 
 * offering the NFT memberships! Sam’s Cafe NFTs will grant holders exclusive 
 * access to events and performances, unique privileges, and include airdropped 
 * gift cards and merchandise based on the rarity of your purchased Sam’s NFT!
 * 
 * Hit the deck with Sam’s by purchasing a Sam’s NFT and receive unique 
 * privileges, exclusive events and live performances just by showing your NFT 
 * at the door. You'll have exclusive access to the most non-exclusive yacht 
 * club in the Bay!
 */
contract SamsBootlegger is ViciERC721 {
    constructor() ViciERC721(unicode"Sam’s Bootlegger", "SB", 10000) {
        setContractURI(
            "https://storage.googleapis.com/arrival-shadow-motion-newman/Sams/metadata/CollectionMetadata.json"
        );
    }
}