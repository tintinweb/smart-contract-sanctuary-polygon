...
contract SoftballStats is Ownable {
    ...
    struct Leaders {
        string runsLeader;
        string doublesLeader; 
        string triplesLeader;
    ...
    function leaderByCategory() external view returns (Leaders memory leaders) {
        uint256 runsLead;
        for (uint i; i < totalPlayers;) {
            bool update = runsLead > stats[player[i]].runs ? false : true;
            if (update) {
                leaders.runsLeader = player[i];
            }
        }
        ...
        for (uint i; i < totalPlayers;) {
            ...
            if (update) {
                leaders.doublesLeader = player[i];
            }
        }
        ...
        for (uint i; i < totalPlayers;) {
            ...
            if (update) {
                leaders.triplesLeader = player[i];
            }
        }
        ...
        for (uint i; i < totalPlayers;) {
            ...
            if (update) {
                leaders.homeRunsLeader = player[i];
            }
        }
