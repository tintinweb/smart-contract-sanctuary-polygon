...
contract AMETA2 is ERC20 {

    using SafeMath for uint256;
    string constant public name = "AtlantisMeta";
    string constant public symbol = "AMETA2";
    uint8 constant public decimals = 18;
    uint256 constant public maxSupply = 1000000000 * 10**18;
    uint256 constant public initialSupply=  150000000 * 10**18;
    ...
    function mint(address to_, uint256 amount_) public onlyOwner {
        require(totalSupply().add(amount_)<=maxSupply, "Mint: exceeds maxSupply");
        _mint(to_, amount_);
    }
