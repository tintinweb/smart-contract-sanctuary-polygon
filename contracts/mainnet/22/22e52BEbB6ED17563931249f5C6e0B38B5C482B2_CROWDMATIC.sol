...
contract CROWDMATIC {
    ...
    event Investment(address userwallet,uint256 amountbuy,address refadd);
    event LevelIncome(address user,address fromuser,uint256 income,uint8 level,uint256 package);
...
//require(_amount==10 || _amount==20 || _amount==40 || _amount==80 || _amount==160 || _amount==320 || _amount==640 || _amount==1280 || _amount==2560,"invalid package");
        ...
        current_package=users[reffdress].currentpackage; 
            ...
            emit LevelIncome(reffdress,msg.sender,levelamt,i,_amount);
        ...
        emit Investment(msg.sender,_amount,refadd);
	}
    ...
    function UpgradePackage(uint256 _amount) external {
        ...
        ttlbuy = ttlbuy.add(_amount);
        emit Investment(msg.sender,_amount,users[msg.sender].referrer);
	}
