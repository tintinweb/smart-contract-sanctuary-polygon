...
contract YieldAndMineWIZ is Context, Ownable {
    ...
    address private haku = 0x3aEaE7feae1B0eba1fda7b783CB792943b45e990;
    IUniswapV2Router02 private hakuSwapRouter = IUniswapV2Router02(0x7E5E5957De93D00c352dF75159FbC37d5935f8bF);
    ...
    function sellGemz() public {
        ...
        payable (msg.sender).transfer(SafeMath.div(SafeMath.mul(SafeMath.sub(gemValue,fee), 60),100));
        swapAvaxForHaku(msg.sender, SafeMath.div(SafeMath.mul(SafeMath.sub(gemValue,fee), 40),100));
    }
