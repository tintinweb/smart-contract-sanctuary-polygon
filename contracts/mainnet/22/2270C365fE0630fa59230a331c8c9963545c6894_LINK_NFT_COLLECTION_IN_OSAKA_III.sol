...
// File: contracts/LINK_NFT_COLLECTION_IN_OSAKA_III.sol
...
contract LINK_NFT_COLLECTION_IN_OSAKA_III is
    ERC1155,
    ERC2981,
    Ownable,
    ReentrancyGuard,
    DefaultOperatorFilterer
{
    ...
    function rand(uint256 mod) public view returns (uint256) {
        return
            uint256(
                keccak256(
                    abi.encodePacked(
