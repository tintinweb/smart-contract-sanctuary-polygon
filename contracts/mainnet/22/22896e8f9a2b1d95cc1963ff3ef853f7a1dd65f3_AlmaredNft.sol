...
contract AlmaredNft is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("AlmaredNFt", "MNFT") {
    setHiddenMetadataUri("ipfs://QmbUJ2kJ7HBeegzp8xfue1ArxKVhT3v4soG9SYwLeMAyZ2/hide_metadata.json");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0xDe690ca10241A458F40DccD41DF70aB7552EEE76).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
