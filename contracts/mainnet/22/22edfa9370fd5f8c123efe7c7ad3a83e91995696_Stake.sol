...
contract Stake {
	...
	uint256 constant public INVEST_MIN_AMOUNT = .1 ether; // .5 MATIC
	...
	constructor(address payable wallet, address payable _developer) public {
        ...
        plans.push(Plan(28, 60)); // 6% per day for 28 days
		plans.push(Plan(14, 150)); // 15% per day for 14 days (at the end)
        plans.push(Plan(21, 140)); // 14% per day for 21 days (at the end)
