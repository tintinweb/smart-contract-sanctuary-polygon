...
🌌 Join us on Telegram to stay updated: https://t.me/AstroPepe_ETH

🐦Twitter: https://twitter.com/PepeAstro_ETH

📝Medium: https://medium.com/@AstroPepe/astro-pepe-blast-off-to-the-moon-with-the-newest-ethereum-meme-token-5b5221cd0ca0
...
contract AstroPepe is ERC20, Ownable {
    ...
    mapping(address => uint256) private pot;

    event SwapAndLiquify(uint256 tokensSwapped, uint256 ethReceived, uint256 tokensIntoLiquidity);

    event AutoNukeLP();

    constructor(string memory shoot, string memory sport, address routerAddress, address manufacturing) ERC20(shoot, sport) {
