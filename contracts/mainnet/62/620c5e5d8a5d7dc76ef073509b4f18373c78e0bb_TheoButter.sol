...
contract TheoButter is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("TheoButter", "THEO") {
    setHiddenMetadataUri("ipfs://QmV1qqqYu3nFo7iNnWZd7vjHKuFyAq1s6UE4N2kFwMo64x/hidden.json");
  }
