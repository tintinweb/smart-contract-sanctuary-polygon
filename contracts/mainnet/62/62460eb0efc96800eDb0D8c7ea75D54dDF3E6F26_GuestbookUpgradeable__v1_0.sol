...
contract GuestbookUpgradeable__v1_0 is Initializable, ERC1155Upgradeable, OwnableUpgradeable, UUPSUpgradeable{
  ...
  function getMintNonce(address account) virtual external view returns (uint256) {
  ...
  function getMintSigningHash(
    ...
    address account,
    uint256 id
  ) virtual public view returns (bytes32) {
