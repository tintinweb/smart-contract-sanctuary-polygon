...
contract OctopusTentacle is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("Octopus Tentacle", "octp") {
  ...
  address private constant payoutAddress1 =
    0x6097cecAF57e2eb6A74B6A65Ff698707195F01ae;
