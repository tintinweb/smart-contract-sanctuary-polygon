...
// File: contracts/CrazyCrowsAssets.sol
...
contract CrazyCrowsAssets is AbstractERC1155Factory {
    ...
    constructor(address _shinyBitsAddress, string memory _uri) ERC1155(_uri) {
        name_ = "Crazy Crows Assets";
        symbol_ = "CRAZY CROWS ASSETS";
        supplyByTokenId[0] = 8181;
        for(uint256 i = 1; i < 5; i++){
            supplyByTokenId[i] = 200;
        }
        priceTable[0][_shinyBitsAddress] = 35000000000000000000; // 35 $ShinyBits (or $SBS for short)
    }
