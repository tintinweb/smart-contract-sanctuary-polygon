...
contract Migration is OwnableUpgradeable, PausableUpgradeable {
    ...
    function migrateAllTrolls() external {
        ...
        //     // require(oldTrollContract.ownerOf(tokenIds[i]) == _msgSender(), "You must own the original token!");
        //     // require(oldTrollContract.isApprovedForAll(_msgSender(), address(this)), "You must first grant this contract full approval!");
        //     // require(!trollMigratedTokens[tokenIds[i]], "Hey! That one has already been migrated!");

        //     oldTrollContract.transferFrom(_msgSender(), address(this), tokenIds[i]);
        //     trollMigratedTokens[tokenIds[i]] = true;
        //     trollMigratedPlayers[_msgSender()].push(tokenIds[i]);
        //     // trollContract.migrationMint(tokenIds[i], _msgSender());
        // }
    }
