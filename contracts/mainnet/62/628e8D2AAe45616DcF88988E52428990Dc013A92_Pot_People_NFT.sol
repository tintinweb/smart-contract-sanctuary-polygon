...
contract Pot_People_NFT is ERC721Enumerable, Ownable {
  using Strings for uint256;

  string baseURI;
  string public baseExtension = ".json";
  string public notRevealedUri;
  uint256 public cost = 136 ether;
  uint256 public whitelistCost = 102 ether;
  uint256 public maxSupply = 4200;
  uint256 public maxMintAmount = 20;
  uint256 public whitelistMintLimit = 3;
  bool public paused = true;
  bool public revealed = false;
  bool public verifiedWhitelisted = true;
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    if (msg.sender != owner()) {
      if(verifiedWhitelisted == true) {
          require(isWhitelisted(msg.sender), "User is not whitelisted!");
          uint256 ownerMintedCount = addressMintedBalance[msg.sender];
          require(ownerMintedCount + _mintAmount <= whitelistMintLimit, "Max NFT per address exceeded");
          mintCost = whitelistCost;
      }
