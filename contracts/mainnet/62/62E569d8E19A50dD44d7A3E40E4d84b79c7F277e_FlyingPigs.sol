...
contract FlyingPigs is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721("The Flying Pigs NFT", "Flying Pigs") {

        baseURI = "https://nft-cdn-flyingpigs-ggy6xprbuq-uc.a.run.app/meta/";
