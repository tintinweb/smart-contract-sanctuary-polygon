...
//*********************************************************************//
//
//               / ____/ /_  (_)___  ____ _/ | / / ____/_  __/ ____/___ __________/ /
//  / /   / __ \/ / __ \/ __ `/  |/ / /_    / / / /   / __ `/ ___/ __  / 
// / /___/ / / / / / / / /_/ / /|  / __/   / / / /___/ /_/ / /  / /_/ /  
// \____/_/ /_/_/_/ /_/\__,_/_/ |_/_/     /_/  \____/\__,_/_/   \__,_/   
//                                                                     
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xAFA8C64E34c3de365216845E04e03f889eAE1AA6];
...
// File: contracts/ChinaNftCardContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract ChinaNftCardContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "ChinaNFTCard";
