...
contract WrappedERC4626UniswapV3 is ERC4626, Ownable, PricePerTokenMixin {
    ...
    mapping(int8 => int24) percent_to_ticks;
    ...
    constructor(
        ...
        require(depositToken == _token0 || depositToken == _token1);
        token0 = _token0;
        token1 = _token1;
        fee = _fee;
        ...
        percent_to_ticks[-10] = -1053;
        percent_to_ticks[-9] = -943;
        percent_to_ticks[-8] = -833;
        percent_to_ticks[-7] = -725;
        percent_to_ticks[-6] = -618;
        percent_to_ticks[-5] = -512;
        percent_to_ticks[-4] = -408;
        percent_to_ticks[-3] = -304;
        percent_to_ticks[-2] = -202;
        percent_to_ticks[-1] = -100;
        percent_to_ticks[0] = 0;
        percent_to_ticks[1] = 99;
        percent_to_ticks[2] = 198;
        percent_to_ticks[3] = 295;
        percent_to_ticks[4] = 392;
        percent_to_ticks[5] = 487;
        percent_to_ticks[6] = 582;
        percent_to_ticks[7] = 676;
        percent_to_ticks[8] = 769;
        percent_to_ticks[9] = 861;
        percent_to_ticks[10] = 953;
    }
        ...
        )
    {
        ...
        if (currentPositionTokenId == 0) {
            ...
            tickLower = currentTick + percent_to_ticks[percentDown];
            tickUpper = currentTick + percent_to_ticks[percentUp];
    ...
    function _readdLiquidity() internal {
        _addLiquidity(_removeLiquidity(_totalLiquidity()));
    }
