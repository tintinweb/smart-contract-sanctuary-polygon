...
contract TestS is Ownable, ERC721Enumerable, ERC2981, ERC721URIStorage {
    ...
    /// @dev OwnerMint a new ERC721 token with incremented id and custom url
    /// @param uri token metadata

    function mint(address[] memory to, string[] memory uri) external onlyOwner {
