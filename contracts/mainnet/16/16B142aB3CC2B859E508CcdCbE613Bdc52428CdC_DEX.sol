...
contract DEX is Ownable,ReentrancyGuard,Pausable {
    ...
    constructor(address _sender_wallet,address _receiver_wallet,uint256 _rate,IERC20 _com_address,IERC20 _usdt_address) {
    ...
    function setReceiverWallet(address rate) public onlyOwner {
        receiver_wallet = rate;
    }
    ...
    function buy(uint256 amount) public nonReentrant whenNotPaused {
        ...
        CoM.transferFrom(sender_wallet,msg.sender,ghost_amount);
        USDT.transferFrom(msg.sender,receiver_wallet,usdt_amount);
