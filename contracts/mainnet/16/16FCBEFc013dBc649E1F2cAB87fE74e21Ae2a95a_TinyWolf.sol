...
contract TinyWolf is Ownable, ERC721, NonblockingReceiver {
    ...
    uint256 public nextTokenId = 2800;
    ...
    function mint(uint8 numTokens) external payable {
        require(numTokens <= maxWalletLimit, "Tiny Wolf (Poly): Max NFTs per transaction limit reached");
        require(numTokens + balanceOf(msg.sender) <= maxWalletLimit, "Tiny Wolf (Poly): Max wallet limit reached");
        require(
