...
contract ERC4626Vault is BaseERC4626 {
    ...
    function buyPropertyTokens(
        ...
        //console.log("rewards notified to gauge");
        //console.log("_repayAmount in", _repayAmount);
        MintableBurnableSyntheticTokenPermitUpgradeable(_propertyToken)
            .safeTransfer(_marketPlace, _amountOfTokens);
        console.log("after tokens tranferred in BB");
        ...
        console.log("after approve in BB");
    }
    ...
    function notiftyRewardToGauge(
        ...
        console.log("before settle loss", _rewardAmount);
        console.log("after settle loss", _rewardAmount);
        console.log(
            "xtoken balance",
            MintableBurnableSyntheticTokenPermitUpgradeable(stakeToken)
                .balanceOf(address(this))
        );

        ////console.log("after _settleLossIfAny");
        if (_rewardToTransfer > 0) {
            console.log("iside of", _rewardAmount);
            ...
            //         _rewardToTransfer
            //     );
            //     //console.log("insdoe the if of gauge r");
            ...
            console.log("notify to gauge done");
        }
        console.log("notify to gauge done after if");

        ////console.log("after the if");
        return _rewardToTransfer / (10 ** 12); // TODO:
    ...
    function _notifyRentAsRewardToGauge(address _propertyAddress) internal {
        ...
        //console.log(rentAmount, "this is rentAmount");
        if (rentAmount > 0) {
            // ////console.log(
            //     "_rewardToTransfer***********************************************************************************************",
            //     _rewardToTransfer
            ...
            console.log("inside notify reward in IFFF");
            console.log(rentAmount, "amount of rent");
            console.log(decimals(), "decimals of tokens");
            MintableBurnableSyntheticTokenPermitUpgradeable(propertyRentToken)
                .safeApprove(gaugeAddress, rentAmount);
            console.log("after safe approve");

            //console.log("this is in if afterapprove");

            IGauge(gaugeAddress).notifyRewardAmount(
                propertyRentToken,
                rentAmount
            );
            console.log("after notify reward");

            //console.log("this is in if notidy");
        }
    }
