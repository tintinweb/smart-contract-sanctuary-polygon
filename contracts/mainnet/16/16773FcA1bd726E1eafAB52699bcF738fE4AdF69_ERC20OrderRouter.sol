...
contract ERC20OrderRouter {
    ...
    */
    ...
    function depositToken(
        ...
        IERC20(_inputToken).transferFrom(msg.sender, vaultAddress, _amount);

        // don't trust transferFrom
        uint256 vaultBalance = IERC20(_inputToken).balanceOf(vaultAddress);

        require(
            vaultBalance != 0,
            "ERC20OrderRouter.depositToken: BALANCE_ORDER_VAULT_ZERO"
        );
