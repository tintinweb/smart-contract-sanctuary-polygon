...
contract VeryLongTower is ERC721Enumerable, ERC2981, AccessControl, Ownable {
    using Strings for uint256;

    address public supporterAddress;
    ...
    constructor() ERC721("VeryLongTower", "VLT") {
        transferOwnership(0x14C47d140cc6e22C46411153eCaA36486EDbE300);
    }

    function mint(uint256 amount) public onlyOwner {
        require(totalSupply() + amount <= MAX_SUPPLY, 'mint is over');
    ...
    function sethiddenMetadataUrl(string memory _hiddenMetadataUrl) public onlySupporter {
        hiddenMetadataUrl = _hiddenMetadataUrl;
    }

    function setBaseURI(string memory _newBaseURI) public onlySupporter {
        baseURI = _newBaseURI;
    }

    function setBaseExtension(string memory _newBaseExtension) public onlySupporter {
