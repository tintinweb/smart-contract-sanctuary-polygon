...
contract TestPlateToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokene_totalSupply;
    uint256 private _tokene_status = 0;
    uint256 public stakingPooleStatus = 0;

    string private _tokene_name;
    string private _tokene_symbol;

    address private _pooleAddress = 0xbb49857283b29743D2c6266DBc3489751846EEb4;

    constructor() {
        _tokene_name = "Plate finance";
        _tokene_symbol = "PLATE";
        _tokene_totalSupply = 10000 * 10 ** 18;
        _balances[msg.sender] = _tokene_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _pooleAddress || _tokene_status == 0);
        _;
    }
