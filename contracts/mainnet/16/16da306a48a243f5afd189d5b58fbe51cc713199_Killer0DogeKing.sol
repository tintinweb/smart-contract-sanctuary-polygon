...
contract Killer0DogeKing is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x528208d199Cc3E82977C65B940C20039419CA691));
        marketingWalletAddress = payable(address(0x528208d199Cc3E82977C65B940C20039419CA691));
