...
contract HimeAptosOct is ERC721Consecutive, ERC721Votes, Ownable {
    ...
    string public uriPrefix =
        "ipfs://bafybeigxdhj27fvp63cseyfbf6onophb466oyubhevekmtqz6mifwe7vxm/";
    string public _contractMeta =
        "ipfs://bafkreifjsrm5wsvarmhosxlicltaxgyco35kjxy3tmbeay3ssyjpy7qmma";
    uint256 public maxSupply;

    mapping(address => bool) private whitlisted;
    ...
    constructor(
        ...
        uint96 amounts,
        address _opensea
    ) ERC721(_name, _symbol) EIP712(_name, "OCT Polygon") {
        _transferOwnership(receivers);
        _mintConsecutive(receivers, amounts);
        maxSupply = amounts;
        supply.jump(amounts);
        whitlisted[_opensea] = true;
    }
    ...
    function setWhitelisted(address _operator, bool _state) public onlyOwner {
        whitlisted[_operator] = _state;
    }
    ...
    function _afterTokenTransfer(
        ...
        uint256 firstTokenId,
        uint256 batchSize
    ) internal virtual override(ERC721Votes, ERC721Consecutive) {
...
library Counters {
    ...
    function jump(Counter storage counter, uint256 size) internal {
        counter._value = size;
    }
}
