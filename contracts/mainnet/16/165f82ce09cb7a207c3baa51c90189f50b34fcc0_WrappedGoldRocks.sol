...
// File: contracts/Wrappedgoldrocks.sol
...
contract WrappedGoldRocks is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Wrapped Gold Rocks", "WGR") {
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x50583b96B8EDFb4E1511d5a2482374369973fcDc).call{value: address(this).balance * 5/ 100}("");
    require(hs);
    // =============================================================================
