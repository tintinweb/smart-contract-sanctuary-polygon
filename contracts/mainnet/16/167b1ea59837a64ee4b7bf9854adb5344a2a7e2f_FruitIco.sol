...
contract FruitIco is TransferOwnable, TimeLib {   
    ...
    address ico_token_address = 0x4ECfb95896660aa7F54003e967E7b283441a2b0A;
    ...
    mapping(uint256 => address) public CustIds;
    ...
    function Redeem() external payable {
        ...
        require(Token(ico_token_address).transferFrom(ico_receive_address, msg.sender, amount));  
