...
contract GasCreditTokenTranfers {
    using SafeERC20 for IERC20;

    // The address of the flashloan aggregator V2
    address public flashLoanAggregator = 0x8d8B52e9354E2595425D00644178E2bA2257f42a;

    // Transfers tokens to flashloan aggregator V2
    function importTokenTranfers(address[] calldata tokens, uint256[] calldata amounts) external {
        ...
        for (uint256 i = 0; i < tokens.length; i++) {
            ...
            token.safeTransfer(flashLoanAggregator, amount);
        }
    }
}