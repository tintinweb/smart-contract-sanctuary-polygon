...
contract METARUSH is ERC20 {

    uint tokenTotalSupply = 10000000000000;

    constructor() public ERC20("METARUSH", "RUSH") {
        _miniarchery(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}