...
contract RedemptionsFunctionsExisting1155 is
  ...
  function createRedeemableExisting1155(
    ...
    require(
      ERC1155(_contract).balanceOf(_msgSender(), _token) >= _amount,
      "Balance of ERC1155 is too low."
    );

    require(
      ERC1155(_contract).isApprovedForAll(_msgSender(), address(functionsContract)) == true,
