    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeif6gos4w3uf2zdrol2p34iaozpbtxlscocg4bp25yfccobnr3wlda/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/IROrPFErLEPx7jT0sSmQ/contract-metadata";
  }
...
// File: contracts/AmazingAlienLuciferContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AmazingAlienLuciferContract is RamppERC721A {
    constructor() RamppERC721A("Amazing Alien Lucifer", "AAL"){}
}
