...
contract BitCereal is ReentrancyGuard {
 ...
 modifier onlyOwner {
    ...
    _giveAway = (GIVEAWAY_ADDRESS);
        ...
        MIN_DEPOSIT = 0.00002 ether; // 0.00002 btc
        MIN_BAKE = 0.00036 ether; // 0.00036 btc
        MAX_WALLET_TVL_IN_BNB = 4 ether; // 4 btc
        MAX_DAILY_REWARDS_IN_BNB = 0.15 ether; // 0.15 btc 
        MIN_REF_DEPOSIT_FOR_BONUS = 0.00641 ether; // 200 dolar
    }
