...
contract XShare is ERC20Burnable, Operator {
    ...
    uint256 public constant DEV_FUND_ALLOCATION = 10000000 ether; // 10.000.000 xShare
    uint256 public constant PROJECT_TREASURY_ALLOCATION = 10000000 ether; // 10.000.000 xShare
    uint256 public constant ADVISOR_ALLOCATION = 2500000 ether; // 2.5000.000 xShare
    uint256 public constant PRIVATE_SALE_ALLOCATION = 500000 ether; // 500.000 xShare
    uint256 public constant PUBLIC_SALE_ALLOCATION = 3000000 ether; // 3.000.000 xShare
    uint256 public constant INITIAL_LIQUIDITY_ALLOCATION = 2000000 ether; // 1.000.000 xShare
    ...
    function distributePublicSale(address _publicSaleContract) external onlyOperator {
        require(!publicSaleDistributed, "only can distribute once");
        require(_publicSaleContract != address(0), "invalid address");
        publicSaleDistributed = true;
