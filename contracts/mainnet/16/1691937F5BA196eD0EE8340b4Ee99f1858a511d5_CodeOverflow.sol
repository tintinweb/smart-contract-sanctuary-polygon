...
// importing openzeppelin libraries for controlling upgradability and access.
...
contract CodeOverflow is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    function initialize() public initializer {
        console.log("Deploying CodeOverflow");

        ///@dev as there is no constructor, we need to initialise the OwnableUpgradeable explicity
        __Ownable_init();
    }
