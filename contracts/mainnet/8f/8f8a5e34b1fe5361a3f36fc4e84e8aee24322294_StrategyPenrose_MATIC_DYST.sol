...
/// @title 0xDAO Autocompounding Strategy
/// @author Chainvisions
/// @notice Autocompounding strategy for 0xDAO.

contract Strategy0xDAO is BaseStrategy {
    using SafeTransferLib for IERC20;
    ...
    function withdrawAllToVault() public restricted {
        ...
        _liquidateReward();
        _underlying.safeTransfer(vault(), IERC20(address(_underlying)).balanceOf(address(this)));
    }
...
contract StrategyPenrose_MATIC_DYST is Strategy0xDAO {

    address matic_dyst_diff;

    function initializeStrategy(
        address _store,
        address _vault
    ) public initializer {
        address matic_dyst_lp = address(0x1e08A5B6A1694bC1A65395db6f4c506498DAA349);
        ...
        __Strategy_init(
            ...
            _vault,
            rewards,
            0xbb1bF0980a61Fc5dAf981B33543Fb54c8E04DFa0,
            false
        );

        SwapConfiguration memory dystToDyst;
        SwapConfiguration memory dystToWmatic;
        SwapConfiguration memory penToDyst;
        SwapConfiguration memory penToWmatic;

        // DYST -> DYST
        dystToDyst.swapLess = true;
        ...
        // PEN -> DYST
        penToDyst.swapLess = false;
        penToDyst.singlePair = false;
        penToDyst.stableswap = false;
        ...
        routes[pen][dyst].push(ISolidlyRouter01.Route(pen, wmatic, false));
        routes[pen][dyst].push(ISolidlyRouter01.Route(wmatic, dyst, false));

        swapConfig[dyst][dyst] = dystToDyst;
        swapConfig[dyst][wmatic] = dystToWmatic;
        swapConfig[pen][dyst] = penToDyst;
