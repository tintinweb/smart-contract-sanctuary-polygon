...
contract BlachHoleLoL is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("blackhole.lol", "BH.LOL"){
  }
  ...
  function mint(uint256 amount) external payable
  {
    ...
    require(totalSupply() + amount < maxSupply + 1,"No more in stock");
