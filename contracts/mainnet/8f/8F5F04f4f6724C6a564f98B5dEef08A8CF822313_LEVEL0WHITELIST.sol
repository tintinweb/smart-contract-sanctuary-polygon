...
contract LEVEL0WHITELIST is ERC1155Supply, Ownable, Pausable {
    ...
    constructor() ERC1155("") {
        name = "LEVEL.0 WHITELIST";
        symbol = "LEVEL.0 WHITELIST";
    }
    ...
    function mintBatchTos(address[] memory to, uint256 id) public onlyOwner {
