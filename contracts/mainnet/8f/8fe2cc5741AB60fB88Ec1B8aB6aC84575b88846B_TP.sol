...
contract TP is TPDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private TPTeam;
    address private CharityTP;
    ...
    string public override name = "TelePunks";
    string public override symbol = "TP";
    ...
    constructor(uint totalSupplyValue, address TPTeamAddress, address CharityTPAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TPTeam = TPTeamAddress;
        CharityTP = CharityTPAddress;
        
        // split the tokens according to agreed upon percentages
        balances[TPTeam] =  totalSupply * 4 / 100;
        balances[CharityTP] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's TPTeam pot
