...
contract CelsiusNetworkVideos is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, IERC2981, ERC165Storage {
  ...
  constructor() ERC721("Celsius Network Videos", "CNV") {
    mintCount = 0;
    price = 0.2 * 10**18;
  ...
  function _adminMint(uint256 quantity, address to) external onlyOwner {
  ...
  function changeMaxNftsPerTransaction(uint256 value) external onlyOwner {
