...
import {NoteKeeper} from "./NoteKeeper.sol";
...
contract DiatomBondDepositoryV2 is IBondDepository, NoteKeeper {
    /* ======== DEPENDENCIES ======== */
    ...
    constructor(
        ...
        IStaking _staking,
        ITreasury _treasury
    ) NoteKeeper(IDiatomAuthority(_authority), _diat, _gDiat, _staking, _treasury) {
        // save gas for users by bulk approving stake() transactions
        _diat.approve(address(_staking), 1e45);
    }
     ...
     * @return payout_     the amount of gdiat due
        ...
        )
    {
         ...
         * price = quote tokens : diat (i.e. 42069 DAI : diat)
         *
         * 1e18 = diat decimals (9) + price decimals (9)
         */
         ...
         *
         * this is either the number of diat that the market can sell
        ...
        // purchased, and how much diat has been sold
    ...
    function _tune(uint256 _id, uint48 _time) internal {
        ...
        if (_time >= meta.lastTune + meta.tuneInterval) {
            ...
            // diat decimals (9) + price decimals (9)
             ...
             * is 10,000 diat. max payout would be 1,000 diat (10,000 * 1 / 10).
             */
     ...
     * @param _market      [capacity (in diat or quote), initial price / diat (9 decimals), debt buffer (3 decimals)]
    ...
    function create(
         ...
         *
         * 1e18 = diat decimals (9) + initial price decimals (9)
         */
        uint64 targetDebt = uint64(_booleans[0] ? ((_market[0] * 1e18) / _market[1]) / 10**decimals : _market[0]);

        /*
         * max payout is the amount of capacity that should be utilized in a deposit
         * interval. for example, if capacity is 1,000 diat, there are 10 days to conclusion,
         * and the preferred deposit interval is 1 day, max payout would be 100 diat.
         */
        ...
        emit CreateMarket(id_, address(diat), address(_quoteToken), _market[1]);
    }
     ...
     * @param _id          ID of market
     * @return             price for market in diat decimals
     *
     ...
     * @param _id          ID of market
     * @return             amount of diat to be paid in diat decimals
     *
     * @dev 1e18 = diat decimals (9) + market price decimals (9)
     */
     ...
     * @param _id          ID of market
     * @return             current debt for market in diat decimals
     */
     ...
     * @param _id          ID of market
     * @return             control variable for market in diat decimals
     */
...
abstract contract NoteKeeper is INoteKeeper, FrontEndRewarder {
    ...
    IgDIAT internal immutable gDIAT;
    IStaking internal immutable staking;
    ITreasury internal treasury;

    constructor(
        IDiatomAuthority _authority,
        IERC20 _diat,
        IgDIAT _gDiat,
        IStaking _staking,
        ITreasury _treasury
    ) FrontEndRewarder(_authority, _diat) {
        gDIAT = _gDiat;
        staking = _staking;
        treasury = _treasury;
    }
     ...
     * @param _payout      the amount of DIAT due to the user
    ...
    function addNote(
        ...
        notes[_user].push(
            Note({
                payout: gDIAT.balanceTo(_payout),
        ...
        // note that only the payout gets staked (front end rewards are in DIAT)
     ...
     * @param _sendgDIAT    send payout as gDIAT or sDIAT
     * @return payout_     sum of payout sent, in gDIAT
     */
    function redeem(
        address _user,
        ...
        if (_sendgDIAT) {
            gDIAT.transfer(_user, payout_); // send payout as gDIAT
        } else {
            staking.unwrap(_user, payout_); // unwrap and send payout as sDIAT
        }
    }
     ...
     * @param _sendgDIAT    send payout as gDIAT or sDIAT
     * @return             sum of payout sent, in gDIAT
     */
    function redeemAll(address _user, bool _sendgDIAT) external override returns (uint256) {
        return redeem(_user, indexesFor(_user), _sendgDIAT);
    }
     ...
     * @return payout_     the payout due, in gDIAT
...
interface IBondDepository {
    ...
    struct Market {
        ...
        bool capacityInQuote; // capacity limit is in payment token (true) or in DIAT (false, default)
    ...
    struct Terms {
        ...
        uint64 maxDebt; // 9 decimal debt maximum in DIAT
    }
...
abstract contract FrontEndRewarder is DiatomAccessControlled {
    /* ========= STATE VARIABLES ========== */
    ...
    IERC20 internal immutable diat; // reward token

    constructor(IDiatomAuthority _authority, IERC20 _diat) DiatomAccessControlled(_authority) {
        diat = _diat;
    }
    ...
    function getReward() external {
        ...
        diat.transfer(msg.sender, reward);
    }
...
interface INoteKeeper {
    ...
    struct Note {
        uint256 payout; // gDIAT remaining to be paid
    ...
    function redeemAll(address _user, bool _sendgDIAT) external returns (uint256);
