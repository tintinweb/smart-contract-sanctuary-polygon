...
interface RulesInterface{
    ...
    function scoreGainCheck () external view returns (uint[] calldata);
}
...
contract ElegantSharkWeek is Ownable, Concatenate {
    ...
    function nextRace() public {
        ...
        if (currentRace < (raceNum-1)){
            ...
            uint[] memory scores = _rules.scoreGainCheck();
