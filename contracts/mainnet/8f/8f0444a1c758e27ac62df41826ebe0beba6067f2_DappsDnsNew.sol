...
contract DappsDnsNew is Initializable, ERC721Upgradeable, OwnableUpgradeable {
    ...
    function _registerDomain(
        ...
        if(_isForLifetime) {
            ...
            _rewardReferrer(_referrer, lifetimePrice, creditValue);
            ...
            _rewardReferrer(_referrer, annualPrice, creditValue);
            domains[domain] = Domain({
                tld: _tld,
                owner: _user,
    ...
    //         uint256 priceToPay = _domainPrice - _creditValue;
    //         // (bool success, ) = domains[_referrer].owner.call{value: _domainPrice / 4}("");
    //         (bool success, ) = domains[_referrer].owner.call{value: priceToPay / 4}("");
    //         require(success, "SEND_BACK_FAILED");
    //         // console.log("ref done2: ", success);
    //         uint256 finalPriceToPay = priceToPay - (_domainPrice / 10);
    //     }
    // }
