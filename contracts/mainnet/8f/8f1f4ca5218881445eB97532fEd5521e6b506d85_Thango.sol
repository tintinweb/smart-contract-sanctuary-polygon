...
contract Thango  is Initializable {
    string public name;
    ...
    uint256 public devTeamAllocation;
    ...
    function initialize () external initializer{
        name = "Thango";
        symbol = "THANGO";
        totalSupply = 500000000000 * 10**18; // 500 billion with 18 decimal places
        decimals = 18;
        nullAddress = address(0);
        devTeamAllocation =  totalSupply * 5 / 100; //5% Dev Team - 365 days lock time
        maxTransactionAmount = totalSupply * 1 / 100; //max 1% sell in a single transaction - anti-whale
