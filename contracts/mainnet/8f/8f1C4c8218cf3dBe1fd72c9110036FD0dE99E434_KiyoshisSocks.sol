...
import "default-nft-contract/contracts/tokens/NonFungibleSBT/BasicNonFungibleSBT.sol";

contract KiyoshisSocks is
    BasicNonFungibleSBT
{
    constructor() BasicNonFungibleSBT("Kiyoshi's socks", "KS", 0) {}
}
