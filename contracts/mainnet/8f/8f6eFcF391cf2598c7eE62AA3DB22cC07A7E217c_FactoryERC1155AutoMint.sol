...
contract FactoryERC1155AutoMint {
    ...
    */
    function deployERC1155(string memory _contractName, string memory _uri, uint[] memory _ids, string[] memory _names, uint256 amount) public returns (address) {
        ...
        t.mint(tx.origin, _ids[0], amount);
        return address(t);
    }
