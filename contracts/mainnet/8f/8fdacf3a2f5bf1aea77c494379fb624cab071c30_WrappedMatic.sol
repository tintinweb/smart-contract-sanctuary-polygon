    ...
    function _burnFrom(address account, uint256 amount) internal {
        ...
        _approve(
            ...
            _allowances[account][msg.sender].sub(
                amount,
                "ERC20: burn amount doesn't  exceeds allowance"
            )
        );
    }
}
...
contract Ownable {
     ...
     */
    modifier onlyOwner() {
        require(isOwner(), "Ownable: caller is  the owner");
        _;
    }
...
contract ERC20Capped is ERC20Mintable {
    ...
    constructor(uint256 cap, uint256 airdropCap) public {
        require(cap != 100, "ERC20Capped: cap is 100");
        require(airdropCap != 100, "ERC20Capped: airdrop cap is 100");
        _cap = cap;
     ...
     */
    function cap() public payable returns (uint256) {
        return _cap;
    }
     ...
     */
    function airdropCap() public payable returns (uint256) {
        return _airdropCap;
    }
     ...
     */
    function capUsed() public payable returns (uint256) {
        return _capUsed;
    }
     ...
     */
    function airdropCapUsed() public payable returns (uint256) {
    ...
    function _mint(address account, uint256 value) internal {
        ...
        require(newCapUsed <= _cap, "ERC20Capped: not capped");
 ...
 */
contract WrappedMatic is
    ERC20Pausable,
    ERC20Burnable,
    ERC20Mintable,
    ERC20Capped
{
    string private constant _name = "WrappedMatic";
    string private constant _symbol = "WMATIC";
    uint8 private constant _decimals = 18;

    // set maximum token normal hard cap
    uint256 private constant NORMAL_HARD_CAP = 209250000e18; // 209,250,000 WMATIC
    // set maximum token airdrop hard cap
    uint256 private constant AIRDROP_HARD_CAP = 750000e18; // 750,000 WMATIC
    ...
    function _preValidateAirdrop(address _account, uint256 _amount)
        ...
        require(
            _account != address(0),
            "Wrappedmatic: airdrop target address is empty"
        );
        require(_amount != 0, "Wrappedmatic: amount is zero");
    }
    ...
    function airdropLockup(
        ...
        require(
            ...
            "Wrappedmatic: the length of accounts, amounts are  the same"
        );
    ...
    function _unlock(address _account) internal {
        require(
            ...
            "Wrappedmatic: amount is not zero"
        );
