...
// File: contracts/VeryLongTinyDinos.sol
...
contract VeryLongTinyDinos is ERC721URIStorage, Ownable {
    ...
    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmPD3hxb28QdFbKHFTGi1juXYpv5Fu3aahvBF3QW3X1EEz/";
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        if (onlyTimeFlg == 2) {
            require(IERC721(tinyDinosContract).balanceOf(msg.sender) > 0 || IERC721(veryLongContract).balanceOf(msg.sender) > 0);
        }else if(onlyTimeFlg == 1){
            require(IERC721(tinyDinosContract).balanceOf(msg.sender) > 0);
        }
