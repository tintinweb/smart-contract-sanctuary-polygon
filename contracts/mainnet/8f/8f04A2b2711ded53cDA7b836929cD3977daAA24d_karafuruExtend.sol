...
// File: contracts/second/karafuru.sol
...
contract karafuruExtend is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("karafuru extend", "karafuru extend") {
    setHiddenMetadataUri("ipfs://QmdCZpcFrEUVNuNpznyiWRrGStMaDYA5as3XJJCTjSUCWU/unpac.json");
  }
