...
contract Coinflip is Ownable, VRFConsumerBase {
    ...
    uint public maxBetAmount = 30 ether;
    ...
    function placeBet(uint256 oneZero) public payable {
        ...
        require(betAmount <= maxBetAmount, "Max Bet Amount is 30 Matic");
    ...
    function changeFees(uint feechange) public  { fee=feechange; }

    function changeBetBounds(uint max,uint min) public { maxBetAmount=max; 
    minBetAmount=min;}
