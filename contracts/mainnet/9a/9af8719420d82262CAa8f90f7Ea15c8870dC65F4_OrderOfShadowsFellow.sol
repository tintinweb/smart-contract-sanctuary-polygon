...
contract OrderOfShadowsFellow is AMPowerPassCore{
  string public name = "Order of Shadows: Fellow Power-Pass";
  string public symbol = "AM: OOS:F";
  ...
  constructor()
    ...
    setToken( 0,
      "Order of Shadows: Fellow Power-Pass",
      "https://herodev.mypinata.cloud/ipfs/QmctGRRtUnyh9ogZgCjgw4mG2v58RSuJJMFqNzw4jfB7Y1/oos-fellow.json",
      false, 0,
      false, 0,
      2000 );
  }
