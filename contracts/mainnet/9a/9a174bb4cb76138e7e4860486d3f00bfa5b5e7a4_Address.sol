...
contract AlienBored is ERC721 {
    uint256 public totalSupply;
    uint256 public cost = .45 ether;
    uint256 public maxMints = 1000;
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeifd45ln5ibjtikr4cr6srsddbiaazfl5vii5yzmynwmr4tpighw3e/", Strings.toString(tokenId), ".json")
            );
    }
