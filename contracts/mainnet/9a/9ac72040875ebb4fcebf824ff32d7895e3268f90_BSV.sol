...
contract BSV is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeiexgzd72k77mbk23li4yzz7zdswrirpqjqwl3d75dlod7t4n7vx6q/", Strings.toString(tokenId), ".json")
            );
    }
