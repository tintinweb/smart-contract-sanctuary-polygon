...
/**
 * @dev ERC20Token implementation with AccessControl, Mint, Burn, Cap, Pause, Recover, AntiWhale capabilities
 */
contract BEKOToken is
    ERC20Base,
    AntiWhaleToken,
    ERC20Burnable,
    ERC20Mintable,
    ...
    Recoverable
{
    ...
    constructor(
        ...
        payable
        ERC20Base("Beko Coin", "BEKO", 18, 0x312f313638353630302f412f4d2f422f432f522f502f57)
