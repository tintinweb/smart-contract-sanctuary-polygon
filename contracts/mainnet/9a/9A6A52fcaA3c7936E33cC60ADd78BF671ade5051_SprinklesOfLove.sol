 ...
 * @notice This contract handles minting Sprinkles of Love tokens.
 */
contract SprinklesOfLove is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xFeB1945D5c87ec73791FC376b6F45487c4552312;
    ...
    string public name = "Sprinkles of Love";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeigthnnvtaphwmq5lcw42ktjj2zqduknozhpjz2gg46btomv5hc6ci/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[234201] = 108;
        tokenPresaleMaxSupply[234201] = 108;
        tokenPresalePrice[234201] = 0 ether;
        tokenPresaleMintsPerAddress[234201] = 2;
        tokenPresaleSaleStartTime[234201] = 1684134000;
