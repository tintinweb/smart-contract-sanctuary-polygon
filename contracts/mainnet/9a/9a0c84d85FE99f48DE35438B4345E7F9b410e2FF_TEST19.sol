...
contract TEST19 is ERC721Enumerable, Ownable {
    ...
    modifier mintCompliant(
        ...
        require(totalSupply() + 1 <= MAX_SUPPLY, "Max supply exceeded, contact support!");
        require(amountPerWallet[_recipient] >= 0, "You already purchased this pass!"); // TO CHANGE FOR NO TEST
    ...
    function withdrawCurrency(IERC20 _currency) external onlyOwner {
        uint256 balance = _currency.balanceOf(address(this));
        // bool success = _currency.transfer(msg.sender, balance*50/100);
        bool success = _currency.transfer(0x4588069c142A866C564541Dd3a29353cB08A4195, balance); // ADDRESS WALLET CREATOR
