...
contract Auth is IAuth, AccessControlUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function __Auth_init(
        ...
        address _topUp,
        address _fuelDistributor
    ) external initializer {
        __Ownable_init();
        __AccessControl_init();
        __Auth_init_unchained(_owner, _eventFactory, _topUp, _fuelDistributor);
    }
    ...
    function __Auth_init_unchained(
        ...
        _setupRole(_FUEL_DISTRIBUTOR_ROLE, _fuelDistributor);
    ...
    function hasFactoryRole(address _sender) external view senderHasRole(_FACTORY_ROLE, _sender) {}
    ...
    function hasFuelDistributorRole(address _sender) external view senderHasRole(_FUEL_DISTRIBUTOR_ROLE, _sender) {}
