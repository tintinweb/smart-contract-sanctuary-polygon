...
// File: contracts/CreaturesWorld.sol
...
contract CreaturesWorld is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Creatures World", "CW") {
    setHiddenMetadataUri("ipfs://QmZymtTHXJDqfH6PXNwX71oNizLchYCRugAMBx4UHLXLRP/hidden.json");
  }
