...
// File: contracts/KuberTokenCard.sol
...
contract KuberTokenCard is ERC721, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721("Kuber Token Card", "KTC") {
        baseUri = "https://nft.kuberdefi.com/metadata/kuber/token-card/";
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0xe4Cd210B7178E02A8f397C5f4F83f3BB5B47a498).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0x1a9870Fb1758A739E93690d2B0D391DaC55065BD).call{value: balanceTwo}("");
