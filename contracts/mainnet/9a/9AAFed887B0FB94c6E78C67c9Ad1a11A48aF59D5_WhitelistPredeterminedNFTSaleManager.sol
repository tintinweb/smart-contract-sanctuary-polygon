...
contract WhitelistPredeterminedNFTSaleManager is OwnerWithdrawable {
    ...
    event SaleCreate(uint256 indexed saleId, address nftContract, address treasuryAddress, bytes32 merkleRoot);
    ...
    function createSale(
        ...
        emit SaleCreate(saleCount, address(nftContract), treasuryAddress, merkleRoot);
    }
...
contract OwnerWithdrawable is Ownable {
    event Withdrawal(address indexed receiver, uint256 ethAmount, address[] erc20Addresses, uint256[] erc20Amounts);
