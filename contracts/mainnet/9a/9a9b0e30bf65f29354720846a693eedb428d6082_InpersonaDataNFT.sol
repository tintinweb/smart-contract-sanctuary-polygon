...
contract InpersonaDataNFT is Initializable, ERC721Upgradeable, ERC721URIStorageUpgradeable, PausableUpgradeable, AccessControlUpgradeable, ERC721BurnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize(string memory initName, string memory initSymbol) initializer public {
    ...
    function safeMint(address to, uint16 level, uint256 frequency, uint256 efficiency, uint256 datablocks, string memory uri, string memory mac) public onlyRole(MINTER_ROLE) {
    ...
    function getAttributes(uint256 tokenId) external view returns (Atrributes memory) {
        return tokenAttributes[tokenId];
    }

    function updateAttributes(uint256 tokenId, uint16 level, uint256 frequency, uint256 efficiency, uint256 datablocks, string memory uri) public onlyRole(MINTER_ROLE) {
    ...
    function bind(uint256 tokenId, string memory _macAddress) public onlyRole(MINTER_ROLE) {
        require(_exists(tokenId), "Please use an existing token");
    ...
    function unbind(uint256 tokenId) public onlyRole(MINTER_ROLE) {
        require(_exists(tokenId), "Please use an existing token");
