...
/**
 * @title USDA VaultInitializer Contract
...
contract VaultInitializer is VaultStorage {
    function initialize(address _priceProvider, address _usda)
        external
        onlyGovernor
        initializer
    {
        require(_priceProvider != address(0), "PriceProvider address is zero");
        require(_usda != address(0), "USDa address is zero");
        ...
        vaultBuffer = 0;
        // Initial allocate threshold of 25,000 USDA
...
/**
 * @title USDA Vault Admin Contract
...
contract VaultAdmin is VaultStorage {
    ...
    ****************************************/
    ...
    /**
     * @dev Sets the minimum amount of USDA in a mint to trigger an
     * automatic allocation of funds afterwords.
     * @param _threshold USDA amount with 18 fixed decimals.
     */
    ...
    /**
     * @dev Set a minimum amount of USDA in a mint or redeem that triggers a
     * rebase
     * @param _threshold USDA amount with 18 fixed decimals.
     */
