...
contract Liaa is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Hii im Liaa", "HIMLI") {
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x8C279784bd279e22f2d84589B90cd3f39B715824).call{value: address(this).balance * 1 / 100}("");
    require(hs);
    // =============================================================================
