...
contract ABArenaBattles is AccessControl {
    ...
    function startBattle(
        ...
        checkBattleParameters(angelId, petId, accessoryId, msg.sender);
    ...
    function checkBattleParameters(
        ...
        require(ABTokenData.ownerOf(angelId) == sender, 'Not Angel Owner');
        require(ABTokenData.ownerOf(petId) == sender, 'Not Pet Owner');
        require(
            ((ABTokenData.ownerOf(accessoryId) == sender) ||
                (accessoryId == 0)),
            'Not Accessort Owner'
        );
