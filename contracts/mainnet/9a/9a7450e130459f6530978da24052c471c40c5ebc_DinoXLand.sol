...
contract DinoXLand is ERC721, ERC721Enumerable, Ownable, IERC721Receiver {
    constructor() ERC721("DinoXLand", "DNXL") {}
    
    function mintDinoXLand(uint256 tokenId, address to) public onlyOwner {
        _safeMint(to, tokenId);
    }
