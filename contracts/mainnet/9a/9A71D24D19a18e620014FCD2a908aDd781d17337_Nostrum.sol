...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
     ...
     */
    function tokenOfOwnerByIndex(address owner, uint256 index) public view override returns (uint256 tokenIds)  {
...
contract Nostrum is ERC721A, Ownable{
    using Strings for uint256;

    uint256 public constant MAX_SUPPLY = 10000;
    uint256 public constant MAX_PUBLIC_MINT = 10000;
    uint256 public constant MAX_WHITELIST_MINT = 10000;
    uint256 public constant PUBLIC_SALE_PRICE = 25 ether;
    ...
    constructor() ERC721A("Nostrum", "Nostrum"){
    ...
    function mint(uint256 _quantity) external payable callerIsUser{
        ...
        require((totalPublicMint[msg.sender] +_quantity) <= MAX_PUBLIC_MINT, "Already minted 20 times!");
    ...
    function withdraw() external onlyOwner{
        //100% to utility/investors wallet
        uint256 withdrawAmount_35 = address(this).balance * 100/100;
        payable(0x0674aa3cece81E7868FB504A0F226EB799155ca7).transfer(withdrawAmount_35);
