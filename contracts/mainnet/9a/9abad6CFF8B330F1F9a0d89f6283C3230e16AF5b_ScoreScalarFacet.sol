...
contract ScoreScalarFacet {

    //POWER
    function getPowerScalar() public view returns (uint256) {
        return LibDiamond.diamondStorage().power_scalar;
    }

    function getPowerAttackScalar() public view returns (uint256) {
        return LibDiamond.diamondStorage().power_attack_scalar;
    }

    function getPowerAccuracyScalar() public view returns (uint256) {
        return LibDiamond.diamondStorage().power_accuracy_scalar;
    }

    function setPowerScalar(uint256 scalar) external {
        LibDiamond.enforceIsContractOwner();
        LibDiamond.diamondStorage().power_scalar = scalar;
    }

    function setPowerAttackScalar(uint256 scalar) external {
        LibDiamond.enforceIsContractOwner();
        LibDiamond.diamondStorage().power_attack_scalar = scalar;
    }

    function setPowerAccuracyScalar(uint256 scalar) external {
        LibDiamond.enforceIsContractOwner();
        LibDiamond.diamondStorage().power_accuracy_scalar = scalar;
    }

    //SPEED
    function getSpeedScalar() public view returns (uint256) {
        return LibDiamond.diamondStorage().speed_scalar;
    }

    function getSpeedMovespeedScalar() public view returns (uint256) {
        return LibDiamond.diamondStorage().speed_movespeed_scalar;
    }

    function getSpeedAttackspeedScalar() public view returns (uint256) {
        return LibDiamond.diamondStorage().speed_attackspeed_scalar;
    }

    function setSpeedScalar(uint256 scalar) external {
        LibDiamond.enforceIsContractOwner();
        LibDiamond.diamondStorage().speed_scalar = scalar;
    }

    function setSpeedMovespeedScalar(uint256 scalar) external {
        LibDiamond.enforceIsContractOwner();
        LibDiamond.diamondStorage().speed_movespeed_scalar = scalar;
    }

    function setSpeedAttackspeedScalar(uint256 scalar) external {
        LibDiamond.enforceIsContractOwner();
        LibDiamond.diamondStorage().speed_attackspeed_scalar = scalar;
    }

    //ENDURANCE
    function getEnduranceScalar() public view returns (uint256) {
        return LibDiamond.diamondStorage().endurance_scalar;
    }

    function getEnduranceVitalityScalar() public view returns (uint256) {
        return LibDiamond.diamondStorage().endurance_vitality_scalar;
    }

    function getEnduranceDefenseScalar() public view returns (uint256) {
        return LibDiamond.diamondStorage().endurance_defense_scalar;
    }

    function setEnduranceScalar(uint256 scalar) external {
        LibDiamond.enforceIsContractOwner();
        LibDiamond.diamondStorage().endurance_scalar = scalar;
    }

    function setEnduranceVitalityScalar(uint256 scalar) external {
        LibDiamond.enforceIsContractOwner();
        LibDiamond.diamondStorage().endurance_vitality_scalar = scalar;
    }

    function setEnduranceDefenseScalar(uint256 scalar) external {
        LibDiamond.enforceIsContractOwner();
        LibDiamond.diamondStorage().endurance_defense_scalar = scalar;
    }

    //INTELLIGENCE
    function getIntelligenceScalar() public view returns (uint256) {
        return LibDiamond.diamondStorage().intelligence_scalar;
    }

    function getIntelligenceMagicScalar() public view returns (uint256) {
        return LibDiamond.diamondStorage().intelligence_magic_scalar;
    }

    function getIntelligenceResistanceScalar() public view returns (uint256) {
        return LibDiamond.diamondStorage().intelligence_resistance_scalar;
    }

    function setIntelligenceScalar(uint256 scalar) external {
        LibDiamond.enforceIsContractOwner();
        LibDiamond.diamondStorage().intelligence_scalar = scalar;
    }

    function setIntelligenceMagicScalar(uint256 scalar) external {
        LibDiamond.enforceIsContractOwner();
        LibDiamond.diamondStorage().intelligence_magic_scalar = scalar;
    }

    function setIntelligenceResistanceScalar(uint256 scalar) external {
        LibDiamond.enforceIsContractOwner();
        LibDiamond.diamondStorage().intelligence_resistance_scalar = scalar;
    }
}
