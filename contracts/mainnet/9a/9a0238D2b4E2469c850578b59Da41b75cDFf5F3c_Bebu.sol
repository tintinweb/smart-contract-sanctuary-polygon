...
/*
    __         __              _______
   / /_  ___  / /_  __  __    / ____(_)___  ____ _____  ________
...
contract Bebu is ERC20Burnable, Operator {
    ...
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 42000 ether;
    uint256 public constant STABLE_FARMING_POOL_REWARD_ALLOCATION = 20000 ether;
    ...
    function distributeRewardToFarmingPool(address _farmingIncentiveFund) external onlyOwner {
        require(_farmingIncentiveFund != address(0), "!_farmingIncentiveFund");
        _mint(_farmingIncentiveFund, FARMING_POOL_REWARD_ALLOCATION);
    }

    function distributeRewardToStableFarmingPool(address _stableFarmingIncentiveFund) external onlyOwner {
        require(_stableFarmingIncentiveFund != address(0), "!_farmingIncentiveFund");
