...
contract Airdrop is ERC20, SismoConnect {
  ...
  bytes16 public constant APP_ID = 0x56f604cf4724d71d9303b74ebe6e6e30;
  ...
  constructor(
    ...
    ERC20(name, symbol)
    SismoConnect(buildConfig(APP_ID, false)) // <--- Sismo Connect constructor
  {}
  ...
  function claimWithSismo(bytes memory response) public {
    ...
    claims[0] = buildClaim({groupId: SISMO_COMMUNITY_MEMBERS_GROUP_ID});
    claims[1] = buildClaim({
