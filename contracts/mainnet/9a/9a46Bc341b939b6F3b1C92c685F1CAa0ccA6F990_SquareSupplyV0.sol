...
ERC1155SupplyUpgradeable {
    ...
    function mintCornerWithToken(uint256 _howMany, address _paymentToken, uint256 _paymentMax) public {
        uint256 balancePreSwap = address(this).balance;
        /*uniswap.swapExactOutputSingle(_paymentToken, _paymentMax);*/
        swapExactOutputSingle(_paymentToken, _paymentMax, _howMany);
    ...
    function mintCornerWithToken(uint256 _howMany, address _paymentToken) public {
        uint256 paymentMaxQuote = swapQuoter.quoteExactOutputSingle(
            _paymentToken,
            WETH,
            poolFee,
            cost * _howMany,
    ...
    function swapExactOutputSingle(address _paymentToken, uint256 _paymentMax, uint256 _numToMint)
        private
        returns (uint256 payment)
    {
        ...
        ISwapRouter.ExactOutputSingleParams memory params =
            ISwapRouter.ExactOutputSingleParams({
                ...
                amountOut: cost * _numToMint,      // just ask for what you want
                amountInMaximum: _paymentMax, // while offering up what you will
                sqrtPriceLimitX96: 0
            });
