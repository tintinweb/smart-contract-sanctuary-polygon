...
contract IWS is ERC721 {
    uint256 public totalSupply;
    uint256 public cost = 0.01 ether;
    uint256 public maxMints = 888;
    ...
    constructor()
        ERC721("Inverted Wolfy Society", "IWS")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeiaq5orwu44dyhc7zt5rk4urjzxl3fk5a5avb3hro46cyqvr5jjcqy/", Strings.toString(tokenId), ".json")
            );
    }
