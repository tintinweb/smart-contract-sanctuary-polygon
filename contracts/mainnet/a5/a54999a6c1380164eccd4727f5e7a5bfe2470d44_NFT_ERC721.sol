...
contract NFT_ERC721 is ERC721, ERC721Enumerable, ERC721Burnable, Pausable, Ownable, DefaultOperatorFilterer {
    using Strings for uint256;
    ...
    event Immigrate(address recipient, uint256[] tokenIds, string[] metadataUris);
    ...
    function immigrate(address recipient, uint256[] memory tokenIds, string[] memory metadataUris) external onlyMinter {
        ...
        emit Immigrate(recipient, tokenIds, metadataUris);
    }
    ...
    function setMinter(address _minter) public onlyOwner {
        require(_minter != address(0), "ERC721: wrong minter");
        minter = _minter;
    ...
    modifier onlyMinter() {
        require(msg.sender == minter, "ERC721: not from minter");
        _;
    }
