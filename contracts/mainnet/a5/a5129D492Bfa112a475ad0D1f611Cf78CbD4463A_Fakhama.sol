...
contract Fakhama is IERC20
{
    ...
    address constant public owner=0xA9a2c94Ecd211235E553526a4FA4B411A019416c;
    address constant public marketingAddress=0x4F20C16B8a20b251D7CbB5d94dfd18531c548cE4;
    ...
    constructor()
    {
        ...
        LevelPercentage[2] = 800;
        LevelPercentage[3] = 600;
        LevelPercentage[4] = 400;
        

        GapPercentage[1] = 900;
        GapPercentage[2] = 1700;
        GapPercentage[3] = 2300;
        GapPercentage[4] = 2700;
    ...
    function getUserRanks(uint memberId) public view returns (RankInfo[] memory rankInfo)
    {
        ...
        RankInfo[] memory _rankInfo = new RankInfo[](4);
    ...
    {
        UserLevelInfo[] memory _info = new UserLevelInfo[](4);
        uint[] memory _levelPercentage = new uint[](4);
        for(uint8 i=1; i<=4; i++)
        {
