...
contract TinyGhostesNFT is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("TinyGhostesNFT", "GHOSTES") {
    setHiddenMetadataUri("ipfs://QmefiWTBEjbBN6gyCgxWbwb3rpPRYTyfPs2mm3VrihdtSr/hidden.json");
  }
