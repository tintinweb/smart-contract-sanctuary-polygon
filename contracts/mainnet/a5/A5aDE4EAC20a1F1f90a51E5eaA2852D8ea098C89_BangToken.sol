...
contract BangToken is ERC20Permit, Ownable {
    ...
    /* 1000 BANG = 100 dYEL (10 SWAP RATIO) 1 dYel = $10000, tresury = $ 1 * 10^6
    // if rebase happens:
    //      2000 BANG minted = 100 dYel
    // if personB bought bond (added funds to tresury). tresury = tresury + $10000:
            minted 200 BIG => (through claim and autostake) => wrap 200 BANG to dYel => he got 10 dYEL
            total supply dYel = 110 dYEL. dYEL price = $10000 (tresury value in $ / 110)
    
    assume tresury stay same but rebase happes for one year
    22069 BANG = 110 dYEL
