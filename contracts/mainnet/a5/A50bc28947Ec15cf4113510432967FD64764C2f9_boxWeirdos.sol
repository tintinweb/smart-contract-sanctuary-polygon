...
contract boxWeirdos is ERC721Enumerable, Ownable {
  ...
  uint256 public costMATIC = 1 ether;
  uint256 public costTokenUWU1 = 350 ether;
 ...
 function mintBox1(uint256 _mintAmount) public payable {
  ...
  function mintBox2(uint256 _mintAmount) public payable {
    ...
    costTokenUWUP2 = (costTokenUWU2 *  0.1 ether) /100 ether;
    costTokenUWU2 = costTokenUWU2 + (costTokenUWUP2 * _mintAmount);
 ...
 return costMATIC;
  ...
  function Seeprice2()  public view returns (uint256){
    ...
    return costTokenUWU2;

  }
    function SeepriceP2()  public view returns (uint256){

    return costTokenUWUP2;

  }

    function Seeprice1()  public view returns (uint256){

    return costTokenUWU1;

  }
    function SeepriceP1()  public view returns (uint256){

    return costTokenUWUP1;
  ...
  function setCost(uint256 _costTokenUWU1,uint256 _costTokenUWU2, uint256 _costMATIC) public onlyOwner {
    costTokenUWU1 = _costTokenUWU1;
    costTokenUWU2 = _costTokenUWU2;
    costMATIC = _costMATIC;
  }
  ...
  function whitelistUsers(address[] calldata _users) public onlyOwner {
    ...
    function withdrawUWU(uint256 amount) public payable onlyOwner {
