...
contract M00se is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  uint256 whitelistAmountLimit = 4;
  ...
  function whitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    require(
      whitelistMintEnabled, 'The whitelist sale is not enabled!');

    
    require(
      whitelistClaimed[_msgSender()] + _mintAmount <= whitelistAmountLimit, 'Address already claimed!');
