...
contract FedSystem is ERC721URIStorage {
    ...
    constructor(string memory _tld) payable ERC721("Federal Reserve System", "FED") {
        owner = payable(msg.sender);
        tld = _tld;
        console.log("%s name service by Federal Reserve System deployed", _tld);
    }
