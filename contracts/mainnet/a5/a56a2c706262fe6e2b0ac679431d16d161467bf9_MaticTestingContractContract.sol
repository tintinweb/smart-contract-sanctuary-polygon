...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
    ...
    // File: contracts/maticTestingContractContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract MaticTestingContractContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Matic Testing Contract", "MATIC", _proxyRegistryAddress)
        {}
        ...
        function contractURI() public pure returns (string memory) {
            return "http://localhost:5001/nft-rampp/us-central1/app/rFLOB9DB4YohZRHixkSs/contract-metadata";
        }
    }