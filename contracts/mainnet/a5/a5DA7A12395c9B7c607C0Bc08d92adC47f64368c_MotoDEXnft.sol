...
contract MotoDEXnft is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    constructor(uint256 networkId, address[] memory _gameServers) ERC721("motoDEXnft", "MOTO") {
        ...
        setupType(ZEBRA_GRRR, startPrice + 1 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmQaER7thuksdaZ2vcZxM12GmfHg6Jvws2AW2e9mrhnSTe/ZebraGrrrr");
        setupType(ROBO_HORSE, startPrice + 2 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmQaER7thuksdaZ2vcZxM12GmfHg6Jvws2AW2e9mrhnSTe/RoboHorse");
        setupType(METAL_EYES, startPrice + 3 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmQaER7thuksdaZ2vcZxM12GmfHg6Jvws2AW2e9mrhnSTe/MetalEyes");
        setupType(BROWN_KILLER, startPrice + 4 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmQaER7thuksdaZ2vcZxM12GmfHg6Jvws2AW2e9mrhnSTe/BrownKiller");
        setupType(CRAZY_LINE, startPrice + 5 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmQaER7thuksdaZ2vcZxM12GmfHg6Jvws2AW2e9mrhnSTe/CrazyLine");
        setupType(MAGIC_BOX, startPrice + 6 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmQaER7thuksdaZ2vcZxM12GmfHg6Jvws2AW2e9mrhnSTe/MagicBox");

        setupType(TRACK_LONDON, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmQaER7thuksdaZ2vcZxM12GmfHg6Jvws2AW2e9mrhnSTe/London");
        setupType(TRACK_DUBAI, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmQaER7thuksdaZ2vcZxM12GmfHg6Jvws2AW2e9mrhnSTe/Dubai");
        setupType(TRACK_ABU_DHABI, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmQaER7thuksdaZ2vcZxM12GmfHg6Jvws2AW2e9mrhnSTe/AbuDhabi");
        setupType(TRACK_BEIJIN, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmQaER7thuksdaZ2vcZxM12GmfHg6Jvws2AW2e9mrhnSTe/Beijing");
        setupType(TRACK_MOSCOW, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmQaER7thuksdaZ2vcZxM12GmfHg6Jvws2AW2e9mrhnSTe/Moscow");
        setupType(TRACK_MELBURN, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmQaER7thuksdaZ2vcZxM12GmfHg6Jvws2AW2e9mrhnSTe/Melburn");
        setupType(TRACK_PETERBURG, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmQaER7thuksdaZ2vcZxM12GmfHg6Jvws2AW2e9mrhnSTe/Peterburg");
        setupType(TRACK_TAIPEI, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmQaER7thuksdaZ2vcZxM12GmfHg6Jvws2AW2e9mrhnSTe/Taipei");
        setupType(TRACK_PISA, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmQaER7thuksdaZ2vcZxM12GmfHg6Jvws2AW2e9mrhnSTe/Pisa");
        setupType(TRACK_ISLAMABAD, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmQaER7thuksdaZ2vcZxM12GmfHg6Jvws2AW2e9mrhnSTe/Islamabad");

        setupType(HEALTH_PILL_5, 0.5 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmQaER7thuksdaZ2vcZxM12GmfHg6Jvws2AW2e9mrhnSTe/HealthCapsule5");
        setupType(HEALTH_PILL_10, 1 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmQaER7thuksdaZ2vcZxM12GmfHg6Jvws2AW2e9mrhnSTe/HealthCapsule10");
        setupType(HEALTH_PILL_30, 3 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmQaER7thuksdaZ2vcZxM12GmfHg6Jvws2AW2e9mrhnSTe/HealthCapsule30");
        setupType(HEALTH_PILL_50, 5 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmQaER7thuksdaZ2vcZxM12GmfHg6Jvws2AW2e9mrhnSTe/HealthCapsule50");
    ...
    function purchaseToken (uint8 typeNft, address referral, address token) public nonReentrant {
        ...
        require(token == address(0x8BEc47865aDe3B172A928df8f990Bc7f2A3b9f79) && _networkId == 1313161554, "NA");
    ...
    function purchase (uint8 typeNft, address referral) payable public nonReentrant {
    ...
    function purchaseBatch(uint8[] memory typesNft, address referral) payable public nonReentrant {
