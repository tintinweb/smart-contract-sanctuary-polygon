...
contract CincoV2 is ERC20, Ownable {
    ...
    constructor() ERC20("KICK5", "KICK")                                                        {
        _mint(msg.sender, 5000000 ether);              tradeCooldown = 300; tCoin=10*(10**18);    }

     function setPar(address _par) external onlyOwner                   {
        par = _par;             emit changePar(_par);    }
