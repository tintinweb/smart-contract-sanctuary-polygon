...
contract Mangezjap is ERC721Enumerable, Ownable, ERC2981 {
    using Counters for Counters.Counter;
    using Strings for uint256;
    uint256 public constant MAX_TO_MINT = 999;
    uint256 public MINT_PER_PERS = 5;
    uint256 public tokenPrice;
    bytes32 public merkleRoot = 0x3a4e5d8443ae89f31faba1c2e7846def9663473e62d5eb196bec8dcc08336436;
    string public URI;
    ...
    ) ERC721("Mangezjap", "MJP") {
        URI = initialURI;
        setPrice(90000000000000000);
        setDefaultRoyalty(royaltyReceiver, 1000);
        updateSaleReceiver(royaltyReceiver);
    }
