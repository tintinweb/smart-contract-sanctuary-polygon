...
abstract contract Manager is Ownable {
    ...
    uint public maxBetAmount = 580 ether;
    ...
    // Events
    event BetPlaced(uint indexed betId, address indexed player, uint amount, uint indexed rollUnder, uint choice, bool isBonus);
...
contract Roulette is ReentrancyGuard, Random, Manager {
    uint constant POPCNT_MULT = 0x0000000000002000000000100000000008000000000400000000020000000001;
    uint constant POPCNT_MASK = 0x0001041041041041041041041041041041041041041041041041041041041041;
    uint constant POPCNT_MODULO = 0x3F;

    function placeBet(uint betChoice, uint bonus) external payable nonReentrant {
        ...
        emit BetPlaced(bets.length, msg.sender, amount, rollUnder, betChoice, isBonus);   
        bets.push(Bet({
