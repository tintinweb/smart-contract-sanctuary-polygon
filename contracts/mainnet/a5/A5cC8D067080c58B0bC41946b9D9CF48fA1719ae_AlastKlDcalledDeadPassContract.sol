...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x96106DA84933b3867BbB7C235243dDB0bc0D65D7];
...
// File: contracts/AlastKlDcalledDeadPassContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract AlastKlDcalledDeadPassContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "a last KlD called DEAD Pass";
    string public symbol = "ALKCDP";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/sO5mQyYokzPuAaJkkyLV/contract-metadata";
  }
