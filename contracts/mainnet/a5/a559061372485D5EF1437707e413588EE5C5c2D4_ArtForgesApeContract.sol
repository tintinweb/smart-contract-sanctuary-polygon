...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0xDFC370C2514b8e46f56695f50f5534F0106DeB3d];
  address public erc20Payable = 0xDFC370C2514b8e46f56695f50f5534F0106DeB3d;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 7500) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeieked5o35cwuofncalzfouytetrc5keyeqjewhowxodbrvlduapay/";
...
// File: contracts/ArtForgesApeContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ArtForgesApeContract is RamppERC721A {
    constructor() RamppERC721A("Art Forges Ape", "AFApe"){}
}
