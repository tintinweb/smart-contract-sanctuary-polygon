...
contract BONxRVLT is ERC721, Ownable{
    ...
    uint256 public erc20Price = 186900000000000000000000000; // 186_900_000 RVLT ERC20 token
    ...
    function mint(uint256 _numTokens) external payable {
        require(_numTokens > 0, "Mint amount must be > zero.");
        ...
        /*
        @dev -- users must APPROVE staking contract to use their erc20 before v-this-v can work
        */
