...
contract testb is Ownable, ERC20 {
    ...
    string private constant _name = "testb";
    string private constant _symbol = "testb";
    ...
    constructor() ERC20(_name, _symbol) {
        ...
        IRouter _uniswapV2Router = IRouter(0x49Ba5E1cB0911935E35245085b2916b85868752d);
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        require(from != address(0), "Brewlabs: transfer from the zero address");
        require(to != address(0), "Brewlabs: transfer to the zero address");
