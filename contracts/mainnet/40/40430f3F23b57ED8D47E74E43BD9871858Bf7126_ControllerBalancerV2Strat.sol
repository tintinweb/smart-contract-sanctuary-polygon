...
contract ControllerBalancerV2Strat is ControllerStratAbs {
    ...
    function identifier() external view returns (string memory) {
        return string(abi.encodePacked("1.0.0-BalancerV2-", poolId));
    }
            ...
            if (_balance > 0) {
                ...
                if (expected > 1) {
                    ...
                    IUniswapRouter(exchange).swapExactTokensForTokens(
                        _balance, 1, rewardToWantRoute[rewardToken], address(this), block.timestamp + 60
                    );
                    console.log("Exp:", expected, "Salida:", (wantBalance()-la));
                }
            }
        }
    }
