...
// File: contracts/Rshare/Operator.sol
...
// File: contracts/TShare/Tshare.sol
...
contract DFIx is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 60,000 DFIx
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("DFi FINANCEx", "DFIx") {
        _mint(msg.sender, 1 ether); // mint 1 DFIx for initial pools deployment
