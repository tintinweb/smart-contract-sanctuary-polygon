...
contract CyberFarm is Ownable {
    ...
    uint256[] public REFERRAL_LEVELS_MILESTONES = [0, 10_500 ether, 42_000 ether, 175_000 ether, 350_000 ether, 1_050_000 ether, 3_500_000 ether, 7_000_000 ether];
    uint8 constant public REFERRAL_DEPTH = 10;
    uint8 constant public REFERRAL_TURNOVER_DEPTH = 5;

    address payable constant public DEFAULT_REFERRER_ADDRESS = payable(0x1AB5c60415e3bd5e9F9f0d7341A6571501Be0cbA);

    
    address payable constant public MARKETING_ADDRESS = payable(0x1AB5c60415e3bd5e9F9f0d7341A6571501Be0cbA);
    uint256 constant public MARKETING_FEE = 500;
    address payable constant public PROMOTION_ADDRESS = payable(0x1AB5c60415e3bd5e9F9f0d7341A6571501Be0cbA);
    ...
    uint256 constant public CONTRACT_BALANCE_STEP = 35_000 ether; 
    uint256 constant public CONTRACT_HOLD_BONUS_PERCENT = 10; 

    
    uint256 constant public MAX_DEPOSIT_PERCENT = 10000; 
    uint256 constant public USER_DEPOSITS_STEP = 3_500 ether; 
    ...
    function invest(address referrer) public payable {
        ...
        require(msg.value >= INVEST_MIN_AMOUNT, "Minimum deposit amount 5 MATIC");
