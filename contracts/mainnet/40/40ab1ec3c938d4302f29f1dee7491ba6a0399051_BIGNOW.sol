...
contract BIGNOW {
    ...
    constructor(address _daiAddr) public {
        ...
        feeReceivers[0] = address(0xB33ecbe0bcba451bd96Fae13144E3417d004f5Ce);
        feeReceivers[1] = address(0x1784E34Cf378Fe32A588000352e01682c751104A);
        oldscPool=0x9B4C58b277f59d679F210e339211e97Ee6547d2c;
        startTime = block.timestamp;
        lastDistribute = block.timestamp;
        defaultRefer = 0x8B8E67Ac3FcE8bB8F231b9D10E0ff873CBBDfE28;
    }
    ...
    function _distributeClubPool800(uint256 _dayNow) private {
    ...
    function poolDistribution(uint256 _amount) external {
