...
/// @title NFTPartyLeader Fabric
contract NFTPartyLeaderFabric is
    Base,
    Access,
    ...
    SaleTaxNumeratorStorage
{
    ...
    function _init(
        ...
        NFTPartyLeader(result).initialize({
            nameValue: string(abi.encodePacked("NFT Party Leader", tokenId.toString())),
            symbolValue: string(abi.encodePacked("PL", tokenId.toString())),
            versionValue: "1",
    ...
    function _init2(
        ...
        NFTPartyLeader(result).initialize2({
