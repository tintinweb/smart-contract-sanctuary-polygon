...
contract OddzSwap {
    ...
    function swapExactTokensForETH(
        ...
        require(IERC20(path[0]).approve(UNISWAP_ROUTER, amountIn), "Approve failed");
    ...
    function swapExactETHForTokens(
        ...
        amounts = IUniswapV2Router02(UNISWAP_ROUTER).swapExactETHForTokens(amountOut, path, to, deadline);
    }
