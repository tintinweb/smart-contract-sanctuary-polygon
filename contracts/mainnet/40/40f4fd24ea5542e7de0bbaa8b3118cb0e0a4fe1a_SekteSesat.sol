...
contract SekteSesat is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Sekte Sesat", "SS") {}
  ...
  function setUriIpfs(string memory _uriIpfs) public onlyOwner {
    uriIpfs = _uriIpfs;
  }
