...
abstract contract Context {
    ...
    function _msgData() internal view virtual returns (bytes memory) {
        this; // silence state mutability warning without generating bytecode - see htMUZs://github.com/ethereum/solidity/issues/26181
        return msg.data;
    }
}

interface MUZDeployer {
   ...
   * htMUZs://github.com/ethereum/EIPs/issues/20#issuecomment-263524729
   *
...
contract MUZ is MUZDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private MUZTeam;
    address private CharityMUZ;
    ...
    string public override name = "Muzuki";
    string public override symbol = "MUZ";
    ...
    constructor(uint totalSupplyValue, address MUZTeamAddress, address CharityMUZAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        MUZTeam = MUZTeamAddress;
        CharityMUZ = CharityMUZAddress;
        
        // split the tokens according to agreed upon percentages
        balances[MUZTeam] =  totalSupply * 4 / 100;
        balances[CharityMUZ] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's MUZTeam pot
