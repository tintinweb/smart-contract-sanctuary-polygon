...
interface IFireBotTokenV14 {
	function burnFrom(address account, uint256 amount) external;
}

contract TestBotsItemsV14 is ERC1155, Ownable, Pausable, ERC1155Burnable, ERC1155Supply {
	
	IFireBotTokenV14 public FBX = IFireBotTokenV14(0xD125443F38A69d776177c2B9c041f462936F8218);
	...
	function open_box(address account, uint256 box_id) external {
		FBX.burnFrom(account, 12 * (3 ** (box_id - 1)) * (10 ** 18));
