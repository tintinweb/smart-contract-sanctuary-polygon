...
// File: contracts/GameBallerNFT.sol


// contracts/GameBallerNFT.sol
// Author: ChesterLee
/*
...
contract GameBallerNFT is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    uint256 public mintPrice = 0.168 ether;
    uint256 public maxMintAmountPerSession = 5;
    uint256 public mintPerAddressLimit = 5;
    
    address payable mintCommissionsAddress = payable(0xf4D1f39F45d54f48513c80690582e729A6009D33);
    uint256 private mintCommissionsPercentage = 5;
    ...
    function mint(uint256 mintAmount) public payable {
        ...
        (bool success, ) = payable(mintCommissionsAddress).call{value: msg.value * mintCommissionsPercentage / 100}("");
        require(success);
    }
