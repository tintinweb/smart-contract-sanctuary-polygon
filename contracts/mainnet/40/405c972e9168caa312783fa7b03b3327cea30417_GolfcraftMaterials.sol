...
//import "./ERC1155PresetMinterPauserUpgradeableMod.sol";
    ...
    ContextMixin
{
    ...
    */
    function setContractURI(string calldata __contractURI) public {
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC2981ContractWideRoyalties, ERC1155PresetMinterPauserUpgradeable)
        returns (bool)
    {
        return super.supportsInterface(interfaceId);
    }
    ...
    function initializeEIP712(string calldata name) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "admin");
        require(_eip712Initialized == false, "already initialized");
        super._setDomainSeperator(name);
