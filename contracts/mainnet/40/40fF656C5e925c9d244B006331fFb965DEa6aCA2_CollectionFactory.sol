...
contract CollectionFactory {
    ...
    address EPNS_CONTRACT = 0xb3971BCef2D791bc4027BbfedFb47319A4AAaaAa;
    ...
    function forkCollection(string memory _collectionName, string memory _sym, address parent) external returns (address) {
        ...
        address owner = Collection(parent).Owner();
        ...
        IPUSHCommInterface(EPNS_CONTRACT).sendNotification(
            ...
            bytes(
                ...
                // We are passing identity here: https://docs.epns.io/developers/developer-guides/sending-notifications/advanced/notification-payload-types/identity/payload-identity-implementations
                    abi.encodePacked(
                        ...
                        "+", // segregator
                        "Woo!!", // this is notificaiton title
                        "+", // segregator
                        "Your Collections is forked" // notification body
                    )
                )
            )
        );
