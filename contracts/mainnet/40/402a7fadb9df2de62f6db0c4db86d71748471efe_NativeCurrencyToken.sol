...
contract NativeCurrencyToken is Ownable, IBEP20 {
    ...
    uint256 private _tokenTotal = 100000000000000000000000000;
    uint256 private _reflectTotal = (MAX - (MAX % _tokenTotal));
    uint256 private _tokenFeeTotal;

    string public _name = "NCT";
    string public _symbol = "NCT";
    ...
    uint256 private _maxTokenHold = 100000000000000000000000000;
    uint256 private _maxTxAmount = 100000000000000000000000000;
