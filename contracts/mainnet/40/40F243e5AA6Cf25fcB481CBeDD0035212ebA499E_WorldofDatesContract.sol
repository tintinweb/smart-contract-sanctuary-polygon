    ...
    
{
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/FP1VSWTJ0BM33wOTs8MX/contract-metadata";
  }
...
// File: contracts/WorldofDatesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WorldofDatesContract is ERC721APlus {
    constructor() ERC721APlus("World of Dates", "WRLDDTS"){}
}
