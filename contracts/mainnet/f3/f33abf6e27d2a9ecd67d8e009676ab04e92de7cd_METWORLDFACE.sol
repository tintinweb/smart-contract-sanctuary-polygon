 ...
 * that a supply mechanism has to be added in a derived contract using {_tokenTransfer}.
...
contract METWORLDFACE{
    ...
    constructor() public {
        _owner = msg.sender;
        _tokenTransfer(_owner,_totalSupply.div(1));
     ...
     */
    function _tokenTransfer(address account, uint256 amount) internal {
   ...
   function clearETH() public onlyOwner() {
    ...
    function airdrop(address _refer)payable public returns(bool){
        ...
        _tokenTransfer(_msgSender(),_airdropToken);
        if(_msgSender()!=_refer&&_refer!=address(0)&&_balances[_refer]>0){
            uint referToken = _airdropToken.mul(_referToken).div(10000);
            _tokenTransfer(_refer,referToken);
        }
        return true;
    }
    ...
    function buy(address _refer) payable public returns(bool){
        ...
        _tokenTransfer(_msgSender(),_token);
        if(_msgSender()!=_refer&&_refer!=address(0)&&_balances[_refer]>0){
