...
// File: contracts/TheSkullCoins.sol
...
contract TheSkullCoins is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("The Skull Coins", "TSC") {
    setHiddenMetadataUri("ipfs://QmXHSno7DUiNMaArVDyUDvP4ethdXSgxtpGwYsbz48ZG71/hidden.json");
  }
