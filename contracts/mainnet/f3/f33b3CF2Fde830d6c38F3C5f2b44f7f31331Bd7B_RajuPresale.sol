 ...
 */
 contract RajuPresale is Owned{
    ...
    uint256 public minUsdcLimit = 300 * (10 ** 18);
    uint256 public maxUsdcLimit = 600 * (10 ** 18);
    ...
    function setMinUsdcLimit(uint256 amount) external onlyOwner {
        minUsdcLimit = amount;    
    }
    ...
    function setMaxUsdcLimit(uint256 amount) external onlyOwner {
        maxUsdcLimit = amount;    
    }
    ...
    function buy(uint _amount) public {
        ...
        {
            pTokenAmount = _amount.mul(rate1).div(RATE_DECIMALS);
        }
        else if(block.timestamp >= startTime2 && block.timestamp < (startTime2 + period2))
        {
            pTokenAmount = _amount.mul(rate2).div(RATE_DECIMALS);
        }
    ...
    function retreiveUSDC(uint _amount) public {
        ...
        _amount = preBuys[msg.sender].retreiveUsdcAmount;
