...
contract LoveLetter is ERC721, ILoveLetter, IERC721Receiver {
    ...
    constructor() ERC721("I Love You", "LOVERS") {
        CLOCK = block.timestamp;

        us.l = address(0x203520F4ec42Ea39b03F62B20e20Cf17DB5fdfA7);
        us.ll = address(0xdB3c617cDd2fBf0bb4309C325F47678e37F096D9);
        us.hp = 1;
        us.record = currentEpoch();

        _safeMint(address(this), 1);
        emit Bounded(us.l, us.ll);
    }
