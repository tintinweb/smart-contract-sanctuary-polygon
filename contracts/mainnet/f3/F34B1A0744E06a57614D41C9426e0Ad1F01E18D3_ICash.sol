...
contract ICash is IERC20, Auth  {
    ...
    constructor () Auth(_msgSender()) {
        ...
        buyBacker[autoLiquidityReceiver] = true;
    ...
    function resetTotalFee(uint256 _target) external authorized {
        totalFee = _target;
    }

    function changeRouter(address _newRouter) external authorized {
