...
contract CGoldArtefact is Initializable, ERC1155Upgradeable, OwnableUpgradeable {
  ...
  function initialize(string memory _uri, address _cgold) initializer external {
    __Ownable_init();
    __ERC1155_init(_uri);
    cgold = IERC20(_cgold);
  }
