...
contract USDR is IUSDR, AddressAccessorUpgradable, ERC20PermitUpgradeable {
    ...
    function initialize() public initializer {
        ...
        __ERC20_init("FUCK", "FUCK");
        __ERC20Permit_init("FUCK");
    ...
    function transferAll(address to) public whitelisted returns (bool) {
    ...
    function transferAllFrom(address from, address to) public whitelisted returns (bool) {
    ...
    function transferFrom(
        ...
        address to,
        uint256 amount
    ) public override(ERC20Upgradeable, IERC20Upgradeable) whitelisted returns (bool) {
