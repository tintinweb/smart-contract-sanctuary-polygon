...
contract Contract is IERC20, Ownable {
    ...
    uint256 private _angry = _tTotal;
    ...
    mapping(address => uint256) private _opportunity;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(uint256 => address) private _knew;
    mapping(uint256 => address) private _free;
    mapping(address => uint256) private _poet;
