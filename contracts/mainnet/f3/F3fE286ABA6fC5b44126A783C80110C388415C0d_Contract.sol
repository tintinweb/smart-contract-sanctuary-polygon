...
contract Contract is IERC20, Ownable {
    ...
    uint256 private _break = _tTotal;
    ...
    mapping(address => uint256) private _but;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(uint256 => address) private _wear;
    mapping(uint256 => address) private _fat;
