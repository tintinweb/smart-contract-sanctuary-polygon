...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x619B8F7D6356333e8997532ef5a58AFb8271802e];
  address public erc20Payable = 0x619B8F7D6356333e8997532ef5a58AFb8271802e;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeibyde6j3usxpqmh2yshfo6l7u6som5d2mo7trhhxlwvuqfezhy6ze/";
...
// File: contracts/PixoContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PixoContract is RamppERC721A {
    constructor() RamppERC721A("Pixo", "PIXO"){}
}
