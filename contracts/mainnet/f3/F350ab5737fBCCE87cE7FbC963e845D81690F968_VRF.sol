...
contract VRF is VRFInternal, Swapper {
    ...
    function rawFulfillRandomness(bytes32 requestId, uint256 randomness) external {
        ...
        swap_MATIC_LINK(word.initialValue / 10);
    }
}
...
contract Swapper {
    ...
    function swap_MATIC_LINK(uint256 amountIn) internal {
    ...
    function swap_MATIC_LINK(uint256 amountOut, uint256 amountInMaximum) internal {
        IwERC20 wMATIC = IwERC20(wMATIC_Token);
