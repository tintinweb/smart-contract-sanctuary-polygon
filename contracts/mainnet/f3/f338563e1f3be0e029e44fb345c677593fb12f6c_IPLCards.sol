...
contract IPLCards is ERC721URIStorage, ModeratorAccess {
    ...
    constructor(address _moderator) ERC721("IPLCards", "IPLC")  {
    ...
    function mintCards(Card[] memory _cards) public onlyModerator{
            ...
            )
    {
        ...
        (cardId,cardType, season,playerName,clubName,metadata) = (cards[_id].cardId,cards[_id].cardType,cards[_id].season,cards[_id].playerName,cards[_id].clubName,cards[_id].metadata);
    }
