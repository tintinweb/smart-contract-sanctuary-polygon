...
contract MarketDistribution is TokensRecoverable, IMarketDistribution
{
    ...
    modifier isController(){
        require(msg.sender == owner || msg.sender == devAddress, "Only controller or owner can do this");
        _;
    }
    ...
    function completeSetup() public isController()
    {   
    ...
    preBuyForReferralsPercent = _preBuyForReferralsPercent;
        ...
        rootedToken.transfer(devAddress, rootedTokenSupply.mul(5).div(100));
        ...
        baseToken.transfer(devAddress, baseToken.balanceOf(address(this)));      
