...
contract BettingGame is VRFConsumerBase {
    ...
    uint256 public constant MAX_DEPOSIT_AMOUNT = 160 ether;
    ...
    */
    function game(uint256 bet, uint256 seed) public payable returns (bool) {
        require(msg.value>=MIN_DEPOSIT_AMOUNT, 'Error, msg.value must be >= 5 matic');
        require(msg.value<=MAX_DEPOSIT_AMOUNT, 'Error, msg.value must be <= 160 matic');
