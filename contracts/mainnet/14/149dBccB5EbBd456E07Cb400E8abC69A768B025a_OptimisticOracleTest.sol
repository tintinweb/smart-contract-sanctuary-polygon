...
contract OptimisticOracleTest is Ownable {
    ...
    bytes32 private constant IDENTIFIER = bytes32("YES_OR_NO_QUERY");
    IERC20 private constant USDC =
        IERC20(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174);
    string private constant QUERY_TEMPLATE =
    ...
    uint256 public reward = 10_000000;
    uint256 public rounds;
    VoteRound[] public voteRounds;

    // Polygon address
    IUmaOptimisticOracleV2 public oo =
    ...
    function submitVotes(VoteResult[] memory results) external onlyOwner {
        ...
        voteRounds[currentRound].voteResults;
        ...
        if (callOo) {
            ...
            USDC.safeApprove(address(oo), reward);
            oo.requestPrice(
                IDENTIFIER,
                requestTime,
                ancillaryData,
            ...
            oo.setBond(IDENTIFIER, requestTime, ancillaryData, 100_000000);
    ...
    function getSettledData(uint256 round) public view returns (int256) {
        return
            oo
                .getRequest(
                    address(this),
    ...
    function createQuery(
        ...
        bytes memory query = bytes(QUERY_TEMPLATE);
