...
contract MossLandNFTWrapper is
    Initializable,
    ERC721Upgradeable,
    ...
    ERC721BurnableUpgradeable
{
    ...
    function initialize(
        ...
        public
    {
        __ERC721_init("Amazon Green Wall Club Wrapper", "wAGWC");
    ...
    function safeMint(
        ...
        IERC1155Upgradeable(tokenAddress).safeTransferFrom(msg.sender, address(this), nftId, 1, new bytes(0));
