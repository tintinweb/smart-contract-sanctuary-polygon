...
contract SharifRafaelGhostear is ERC721, ERC721Enumerable, ERC721Burnable, ERC721Royalty, Ownable {
    ...
    constructor(address trustedForwarder) ERC721("SharifRafaelGhostear", "SRG_E19") {
        _tokenIds.increment();
