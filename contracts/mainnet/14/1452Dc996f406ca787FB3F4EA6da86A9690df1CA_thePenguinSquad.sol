// SPDX-License-Identifier: MIT
    ...
    contract thePenguinSquad is ERC721, Ownable, ERC721Enumerable {
      using SafeMath for uint256;
      using Strings for uint256;
    
      uint256 public constant tokenPrice = 10000000000000000000; 
      ...
      uint256 public devReserve = 8;
    
      event nftMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("thePenguinSquad", "TPS") {}
        ...
        returns (string memory)
      {
        ...
        if (isRevealed == false) {
          return
            "ipfs://QmQSg5VYbYdMybVBnLyea4MTq52Z9ZWPcTCrd8dUhmyzgy/hiddenmetadata.json";
        }
