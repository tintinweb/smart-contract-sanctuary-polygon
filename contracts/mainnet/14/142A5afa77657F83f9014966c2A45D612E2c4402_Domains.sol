...
contract Domains is ERC721URIStorage {
  ...
  constructor(string memory _tld) ERC721 ("Football Name Service", "FNS") payable {
  ...
  function register(string calldata name) public payable {
    ...
    string memory json = Base64.encode(
      abi.encodePacked(
        '{"name": "',
        _name,
        '", "description": "an FNS name.", "image": "data:image/svg+xml;base64,',
