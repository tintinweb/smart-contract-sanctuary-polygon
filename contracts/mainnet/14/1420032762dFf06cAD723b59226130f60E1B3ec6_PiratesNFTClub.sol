...
contract PiratesNFTClub is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_, address proxyRegistryAddress_)
    ERC721("Pirates NFT Club", "PNFTC")
  {
  ...
  uint256 public constant MINT_LIMIT_PER_WALLET = 7900;
  ...
  uint256 public constant MAX_SUPPLY = 7900;
