...
// File: contracts/LostApeTreasureHunters_LowGas.sol
...
contract LostApeTreasureHunters is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Lost Ape Treasure Hunters", "LATH") {
    setHiddenMetadataUri("ipfs://QmdkLBsFWS8EXGzhaGiiEoaNfdeh41KGr8x9zBYLjDD594/hidden.json");
  }
