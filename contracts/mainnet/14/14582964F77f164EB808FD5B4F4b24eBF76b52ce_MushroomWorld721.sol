...
// File: contracts/721_Base/Base721 NoKill 65 DefaultME.sol
/*
...
contract MushroomWorld721 is ERC721, Ownable, ERC2981, DefaultOperatorFilterer, ContextMixin, RoyaltiesV2Impl { 
    ...
    constructor(string memory _name, string memory _symbol, string memory _uri, string memory _hiddenURI, string memory _burnURI, uint96 _royaltyFeesInBips, address payable _receiverRoyalty, address payable _AddressWithdrawBalanceOne, address payable _AddressWithdrawBalanceTwo, uint256 _MaxTokenInCollection) ERC721(_name, _symbol) {     
        baseURI = _uri; 
    ...
    function tokenURI(uint256 tokenId) public view override(ERC721) returns (string memory) {   
        ...
        if(burned[tokenId] == true) {
            ...
            return bytes(burnURI).length > 0 ? string.concat(currentBurnURI, tokenId.toString(), ".json" ): ""; 
        }
