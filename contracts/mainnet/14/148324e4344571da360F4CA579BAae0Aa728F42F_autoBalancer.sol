...
contract autoBalancer is KeeperCompatibleInterface {
    ...
    function checkUpkeep(bytes calldata /* checkData */) external view override returns (bool upkeepNeeded, bytes memory performData) {
        ...
        Coin memory sushi;
        wmatic.tokenAddress = SUSHI_ADDRESS;
        wmatic.oracleAddress = SUSHI_USD_ORACLE;
        Coin memory wbtc;
        wmatic.tokenAddress = WBTC_ADDRESS;
        wmatic.oracleAddress = BTC_USD_ORACLE;
        Coin memory weth;
        wmatic.tokenAddress = WETH_ADDRESS;
        wmatic.oracleAddress = ETH_USD_ORACLE;
