...
// File contracts/GoobersToken.sol
...
contract GooberToken is Ownable, ERC20 {
    ...
    constructor(
        ...
        //mint tokens
        _mint(msg.sender, _totalSupply - liquidityAmount);
        _mint(address(this), liquidityAmount);
    }

    function addLiquidity(address recipient, uint256 amount) external payable onlyOwner {
    ...
    function _beforeTokenTransfer(
        ...
        if (from == owner() || to == owner() || from == address(this)) return; // owner can transfer(buy) anytime
