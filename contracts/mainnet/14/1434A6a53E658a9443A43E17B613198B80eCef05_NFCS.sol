...
string constant LIMIT_MANAGER_VERSION = "1.0.0";
string constant LOAN_MANAGER_VERSION = "1.0.0";
string constant NFCS_VERSION = "1.0.4";
string constant POOL_VERSION = "1.0.0";
string constant PRICE_FEED_VERSION = "1.0.0";
string constant SCORE_DB_VERSION = "1.0.0";
string constant SETTINGS_PROVIDER_VERSION = "1.0.0";
...
library Errors {
    ...
    string public constant POOL_TOKEN_ADDRESS_ZERO = "100"; // Asset token address zero
    string public constant POOL_CONFIGURATOR_ADDRESS_ZERO = "101"; // Configurator contract address zero
    string public constant POOL_UPDATER_NOT_LOAN_MANAGER = "102"; // Not allowed updater
    string public constant POOL_VALUE_ZERO = "103"; // Zero value pool
    string public constant POOL_TOTAL_SUPPLY_ZERO = "104"; // Zero totalSupply() pool

    string public constant LOAN_MANAGER_NON_REGISTERED_POOL = "200"; //Non-registered pool
    ...
    string public constant COLLATERAL_MANAGER_FREEZER = "301"; // Provided contract address is not allowed to freeze/unfreeze collateral
    ...
    string public constant SETTINGS_PROVIDER_VERIFICATION = "502"; // Unverified score
    string public constant SETTINGS_PROVIDER_SCORE_NOT_GENERATED = "503"; // Score not yet generated.
    string public constant SETTINGS_PROVIDER_SCORE_GENERATING = "504"; // Error generating score.
    string public constant SETTINGS_PROVIDER_UNKNOWN_FETCHING_SCORE = "505"; //  Unknown error fetching score.
    ...
    string public constant ARGUMENTS_LENGTH = "1002"; // Length of two arrays differs
    string public constant ZERO_ADDRESS = "1003"; // Zero value
    string public constant ZERO_LTV = "1004"; //LTV zero
