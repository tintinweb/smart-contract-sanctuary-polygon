...
// File: smart-contract/contracts/MiaopaiNFT.sol
...
contract MiaopaiNFT is ERC721, Ownable {
    ...
    event SafeMint(address to, uint timestamp);

    constructor() ERC721("Miaopai", "MP") {}

    function safeMint(address to) public onlyOwner {
        _tokenIdCounter.increment();
        uint256 tokenId = _tokenIdCounter.current();
        _safeMint(to, tokenId);
        emit SafeMint(to, block.timestamp);
    }
