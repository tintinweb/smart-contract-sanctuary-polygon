...
contract PolyMinerV1 is ReentrancyGuard {
    using SafeMath for uint256;
    address public owner;
    uint256 private constant PRIMARY_BENIFICIARY_INVESTMENT_PERC = 100;
    uint256 private constant SECONDARY_BENIFICIARY_INVESTMENT_PERC = 90;
    ...
    uint256 private constant MIN_WITHDRAW = 0.0005 ether;
    ...
    function _invest(
        ...
        require(msg.value >= MIN_INVESTMENT, "Minimum Investment is 10 Matic");
    ...
    function OxPolyMiner() public onlyOwner {
