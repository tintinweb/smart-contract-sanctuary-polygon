...
contract OXBITCONTRACTPLAN is Ownable {
    ...
    function multisendmain(address payable _contributors, uint256 membcode, uint256 rcode, uint64 plan) public payable {       
    ...
    function multisendmain_mul(address payable[]  memory  _contributors, uint256[] memory _balances, uint256 membcode, uint256 rcode, uint64 plan) public payable {
