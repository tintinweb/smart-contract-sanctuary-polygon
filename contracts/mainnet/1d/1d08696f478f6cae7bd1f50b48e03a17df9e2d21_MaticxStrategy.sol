...
contract MaticxStrategy is BaseStrategy {
    ...
    bytes32 public wantPoolId = 0xb20fc01d21a50d2c734c4a1262b4404d41fa7bf000000000000000000000075c; //MATICX-WMATIC
    ...
    constructor()
        public
        BaseStrategy(
            0xb20fC01D21A50d2C734C4a1262B4404d41fA7BF0, //MATICX-WMATIC LP
            0x01fE07ce760DA7a025e4Cf3f950aE236F8e62120, //fee dist fund
            BAL,
            0xf5b509bB0909a69B1c207E495f687a596C168E12, //QS v3 router
            0xdFFe97094394680362Ec9706a759eB9366d804C2 //reward gauge
        )
    {
        harvestedToken2 = SD;
    ...
    function harvest() public override onlyHumanOrWhitelisted nonReentrant {
        ...
        if(underlyingBal > 0) {
            ...
            balancerSwap(wantPoolId, WMATIC, want, remaining);
        }
