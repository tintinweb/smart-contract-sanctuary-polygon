...
// File: contracts/TheAddicts_Low_Gas.sol
...
contract TheAddicts_Low_Gas_flat is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("The Addicts NFT Collection", "ADDICT") {
    setHiddenMetadataUri("ipfs://QmZqZHWgygvR1arptN3Gc29F7zrrZok1Ep6PEXZyXm73BM/hidden.json");
  }
