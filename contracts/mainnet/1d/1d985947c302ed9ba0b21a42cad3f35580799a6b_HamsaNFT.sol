...
contract HamsaNFT is ERC721Enumerable, Ownable {
    using Strings for uint256;

    address constant public solomonAddress = 0xb88a3E791e134AEe9f27168d167b140fe77425FD;
    ...
    function withdraw() public payable onlyOwner {
        ...
        uint256 solomon = address(this).balance * 7 / 10;
        uint256 owner = address(this).balance - solomon;

        (bool success2, ) = payable(msg.sender).call{
            value: owner
        }("");
        (bool success1, ) = payable(solomonAddress).call{
            value: solomon
        }("");
        require(success1);
        require(success2);
