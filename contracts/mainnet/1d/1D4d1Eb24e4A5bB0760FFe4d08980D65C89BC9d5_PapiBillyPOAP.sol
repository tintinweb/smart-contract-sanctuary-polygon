...
contract PapiBillyPOAP is ERC721, Ownable, ERC721Burnable, ERC2981 {
    ...
    constructor(uint96 _royaltyFeesInBips, string memory _URI, address _royalty) ERC721("Papi Billy", "Papi") {
