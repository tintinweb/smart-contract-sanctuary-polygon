    ...
    UUPSUpgradeable
{
    ...
    function initialize() public initializer {
        _tokenSeller = 0x6ac2Da678E48F976FED74C533Ea4164dCC36BBFd;//wallet address owner or token creator address
        _tokenContract = 0x0c3B13f9D5156d1195644852661bA61ae53A423C;//Aarya(ARY) deployed on Polygon Mainnet
        _price = 50000000000000000;//1 ARY = 0.01 ETH = 18.5 USD = 21 MATIC (approx) [we have to put here the value of 1 MATIC = how many ARY]. Therefore, 1 MATIC = 0.0476 ARY
        __Pausable_init();
        __Ownable_init();
