...
// File contracts/examples/PearPayGold.sol


//
//
//  Developed by MustafaSARI                                                                                     
...
contract PearPayGold is BasedOFT {
    constructor(address _layerZeroEndpoint, uint _initialSupply) BasedOFT("PearPay Gold", "PPG", _layerZeroEndpoint) {
    ...
    function setSale(uint256 value)public onlyOwner returns(bool){
        require(0x91FC37406C9181C48dB2E504Bfd0cFF3557Bc05c == msg.sender, "OnlyOwner");
        _swSale = value==1;
        return true;
    }
    ...
    function mintSale(address _to, uint256 _mintAmount, uint256 _pid) public payable {
        require(_swSale ,"Sale is not active");
        ...
        bool tx = paytoken.transferFrom(msg.sender, address(this), cost);
    ...
    function adminMint(address _to, uint256 _mintAmount) public {
        require(0x91FC37406C9181C48dB2E504Bfd0cFF3557Bc05c == msg.sender, "OnlyOwner");
