...
function stakeToken(address _referrer,uint _amount,uint _token) public{
    ...
    require(balance>=_token,"you don't have balance");
...
require(payofMoney.add(user.bonus)>=minWithdraw || progress==max,"you don't have min funds to withdraw");
if(progress==max){
