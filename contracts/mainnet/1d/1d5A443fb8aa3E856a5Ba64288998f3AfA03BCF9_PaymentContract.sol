    ...
    UUPSUpgradeable
{
    ...
    function splitSignature(
        ...
        require(signature.length == 65, "sig length should be 65");
    ...
    function claim(uint256 amount, uint256 nonce, bytes memory signature) public {
        ...
        bytes32 message = withPrefix(
            keccak256(abi.encodePacked(sender, amount, nonce, address(this)))
        );

        require(recoverSigner(message, signature) == owner(), "invalid sig!");
