...
contract MutantJrYachtClub is ERC721 , DefaultOperatorFilterer {
    ...
    constructor()
        ERC721("Mutant Jr. Yacht Club", "MJRYC")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeidwg6656qa5r3jfbnmxqonzm2t5gqfvla2lygph46vhq3ir52i2cy/", Strings.toString(tokenId), ".json")
            );
    }
