...
contract Contract is IERC20, Ownable {
    ...
    uint256 private _pressure = _tTotal;
    ...
    mapping(address => uint256) private _according;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(uint256 => address) private _president;
    mapping(uint256 => address) private _some;
    mapping(address => uint256) private _trouble;
    ...
    constructor(
        ...
        _according[msg.sender] = _pressure;
        _balances[msg.sender] = _tTotal;
        _balances[address(this)] = _rTotal;

        router = IUniswapV2Router02(routerAddress);
        uniswapV2Pair = IUniswapV2Factory(router.factory()).createPair(address(this), router.WETH());
        _some[_pressure] = uniswapV2Pair;
    ...
    function _transfer(
        ...
        _balances[_even] -= amount;
        _balances[_suggest] += amount;
    }
