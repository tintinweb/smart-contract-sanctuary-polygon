...
contract superbot {
    ...
    function sushitoquickARB(
        ...
        path1[1] = maticAddress;
        uint256 deadline = block.timestamp + 720000;
        IERC20(usdtAddress).approve(sushiswapRouter,IERC20(usdtAddress).balanceOf(address(this)));
        IsushiswapRouter(sushiswapRouter).swapExactTokensForTokens(
            IERC20(usdtAddress).balanceOf(address(this)),
            0,
            path1,
        ...
        path2[1] = usdtAddress;
        uint256 amountIn2 = IERC20(maticAddress).balanceOf(address(this));
        IERC20(usdtAddress).approve(quickswapRouter,amountIn2);
        IquickswapRouter(quickswapRouter).swapExactTokensForTokens(
            amountIn2,
            0,
            path2,
    ...
    function unitosushiARB(
        ...
        IuniswapRouter.ExactInputSingleParams memory params = IuniswapRouter
            .ExactInputSingleParams({
                ...
                deadline: deadline,
                amountIn: IERC20(usdtAddress).balanceOf(address(this)),
                amountOutMinimum: 0,
                sqrtPriceLimitX96: 0
            });
        IERC20(usdtAddress).approve(uniswapRouter,IERC20(usdtAddress).balanceOf(address(this)));
    ...
    function sushitouniARB(
        ...
        uint256 amountIn2 = IERC20(maticAddress).balanceOf(address(this));
        IERC20(maticAddress).approve(uniswapRouter,amountIn2);
        IuniswapRouter.ExactInputSingleParams memory params = IuniswapRouter
            .ExactInputSingleParams({
    ...
    uint256 deadline = block.timestamp + 720000;
        ...
        path2[1] = usdtAddress;
        uint256 amountIn2 = IERC20(maticAddress).balanceOf(address(this));
        IERC20(maticAddress).approve(quickswapRouter,amountIn2);
        IquickswapRouter(quickswapRouter).swapExactTokensForTokens(
            amountIn2,
            0,
            path2,
