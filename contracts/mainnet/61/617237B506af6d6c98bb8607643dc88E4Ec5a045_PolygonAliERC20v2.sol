...
/**
 * @title ERC20 Token (With Polygon Support)
 *
 * @notice Polygon extension contract ads the functions required to bridge original
 *      test token on Ethereum L1; these are mint and burn functions executed
 *      when the tokens are deposited from from Ethereum L1 into Polygon L2 (mint),
 *      and when the tokens are withdrawn back from Polygon L2 into Ethereum L1 (burn).s
 * @notice Read more:
 *      https://docs.polygon.technology/docs/develop/ethereum-polygon/mintable-assets
 */
contract PolygonAliERC20v2 is AliERC20v2 {

	/**
	 * @dev Constructs/deploys Polygon test instance,
...
/**
 * @title ERC20 Token (Test, TST)
 *
 * @notice TST is the native utility token of the Test AI Protocol.
 ...
 *      TST token powers up the governance protocol (Test DAO)
 *
 * @notice Token Summary:
 *      - Symbol: TST
 *      - Decimals: 18
 *      - Initial/maximum total supply: 10,000,000,000 TST
 ...
 *      - Voting delegation and delegation on behalf via EIP-712 (like in Compound CMP token) - gives TST token
 ...
 *      were changed for better code readability (Test Name <- Comp/Zeppelin name):
 ...
 *
 * @dev Includes resolutions for TST ERC20 Audit by Miguel Palhas, https://hackmd.io/@naps62/alierc20-audit
 *
 * @author Basil Gorin
 */
contract AliERC20v2 is ERC1363, EIP2612, EIP3009, AccessControl {
	...
	/**
	 * @notice Name of the token: Test Token
	 *
	...
	/**
	 * @notice Symbol of the token: TST
	 *
