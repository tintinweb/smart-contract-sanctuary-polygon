...
contract NFTMintSaleMultiple is Ownable {
    ...
    function init(bytes calldata data) external {
        (string memory symbol, string memory name, string memory baseURI, address royaltyReceiver_, uint16 royaltyRate_, uint32 beginTime_, uint32 endTime_, TierInfo[] memory tiers_, IERC20 paymentToken_) = abi.decode(data, (string, string, string, address, uint16, uint32, uint32, TierInfo[], IERC20));
        ...
        nft.setRoyalty(royaltyReceiver_, royaltyRate_, 0, false);
