...
contract NameOfCollection is ERC721A, Ownable {
    uint256 public MAX_MINTS = 10;
    uint256 public MAX_SUPPLY = 3000;

    bool public paused = true; 

    string public baseURI = "ipfs://QmYXMVVjyxscfL8k8x5z4tvGkxHQzPrVHLdrawUCupWVvn/";

    address[] public whitelistedAddresses;

    constructor() ERC721A("CollectionName", "CNTRS") {}
