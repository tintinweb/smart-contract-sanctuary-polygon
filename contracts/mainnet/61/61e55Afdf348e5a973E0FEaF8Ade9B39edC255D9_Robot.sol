...
contract Robot is ERC721, Ownable {
  ...
  uint256 totalSupplyOfTokens = 2 ;
  
  constructor() ERC721("Robot", "ROBO") {}
  ...
  function mint(address _contract, string memory uri, uint256 nftToken)
    public
    returns (uint256)
  {
    uint256 newItemId = nftToken;
    _mint(_contract, newItemId);
...
// File contracts/skyDance.sol


pragma solidity ^0.8.0;
contract SkyDance is ERC721, Ownable {
  using Counters for Counters.Counter;
  using Strings for uint256;
  Counters.Counter private _tokenIds;
  mapping (uint256 => string) private _tokenURIs;
  uint256 totalSupplyOfTokens = 5 ;
  
  constructor() ERC721("Sky Dance", "SDAAA") {}
