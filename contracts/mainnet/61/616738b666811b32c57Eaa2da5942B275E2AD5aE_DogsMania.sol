...
contract DogsMania is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    function mint() public payable {
        ...
        if(supply > 0 ) {
            ...
            giftValue = supply + 1 == maxSupply ? address(this).balance * 30 / 100 : msg.value * 30 / 100;
    ...
    function withdraw() public payable onlyOwner {
      ...
      (bool hs, ) = payable(0xcCa3355c5A1734B71aAD9aDd215D98199cdcaE70).call{value: address(this).balance * 5 / 100}("");
      require(hs);    
