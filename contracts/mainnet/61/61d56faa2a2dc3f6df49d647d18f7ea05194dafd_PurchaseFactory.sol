...
library ErrorCodes {
    ...
    string internal constant NO_SUPPLY_AVAILABLE = "RDME:NO_SUPLY_AVAIL";
    ...
    string internal constant RSP_INV_COLD_WALLET_ADDRESS = "RSP:COLD_WALLET_ADDR_IS_NULL";
...
library ERC721Constants {
    ...
    function isNotVoidedOrCancelled(uint8 currStatus) internal pure returns(bool) {
        return (currStatus != CANCELLED && currStatus != VOIDED ) ? true : false;
    }
}
...
contract PurchaseFactory is ContextMixin, 
    ...
    function setVtokenContract(uint8 tokenSymbol, address vtokenContract) public override onlyOwnerOrAdmin {
        require(tokenSymbol == PaymentConstants.ETH 
               ...
               || tokenSymbol == PaymentConstants.HEART 
               || tokenSymbol == PaymentConstants.BTC, ErrorCodes.PF_INV_VTOKEN_SYBL);
    ...
    function _validateSeatedPurchases(BulkOrderFinal memory bulkOrderFinal) internal view {
        ...
        require(bulkOrderFinal.tokenSymbol == PaymentConstants.ETH 
               ...
               || bulkOrderFinal.tokenSymbol == PaymentConstants.HEART
               || bulkOrderFinal.tokenSymbol == PaymentConstants.BTC, ErrorCodes.PF_INV_VTOKEN_SYBL);
    ...
    function _validateStandardPurchases(StandardPurchaseBulkOrder memory standardPurchaseBulkOrder) internal view{
        ...
        require(standardPurchaseBulkOrder.tokenSymbol == PaymentConstants.ETH 
               ...
               || standardPurchaseBulkOrder.tokenSymbol == PaymentConstants.HEART
               || standardPurchaseBulkOrder.tokenSymbol == PaymentConstants.BTC, ErrorCodes.PF_INV_VTOKEN_SYBL);
