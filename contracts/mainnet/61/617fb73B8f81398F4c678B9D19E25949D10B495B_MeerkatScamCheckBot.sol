...
library MeerkatLibrary {
    using SafeMathMeerkat for uint;
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        bytes32 hash = keccak256(abi.encodePacked(
                ...
                hex'7ae6954210575e79ea2402d23bc6a59c4146a6e6296118aa8b99c747afec8acf'
            ));
...
contract MeerkatScamCheckBot {

    address internal constant ROUTER_ADDRESS = 0x51aBA405De2b25E5506DeA32A6697F450cEB1a17;
    address internal constant FACTORY_ADDRESS = 0x7cFB780010e9C861e03bCbC7AC12E013137D47A5;
    ...
    IMeerkatRouter02 internal immutable router;

    constructor() {
        router = IMeerkatRouter02(ROUTER_ADDRESS);
    ...
    function checkInternalFee(address tokenAddress) public payable authorized {
        ...
        amounts = MeerkatLibrary.getAmountsOut(FACTORY_ADDRESS, msg.value, path);
