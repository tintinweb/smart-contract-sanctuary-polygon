...
contract NftApparel is ERC1155, Ownable {
    ...
    function mint(address account, uint256 id, uint256 amount, string memory _metadata,string memory _metadataClaimed) public onlyOwner {
    ...
    function burnAndClaim(uint256 id) public {
        ...
        require(flag == true, "Sorry, You do not own the token you are trying to claim");
        burn(msg.sender, id, 1);
        _customMint(msg.sender, id-1,1);
    }
