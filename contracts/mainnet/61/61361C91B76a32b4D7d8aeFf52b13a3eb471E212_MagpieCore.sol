...
contract MagpieCore is ReentrancyGuard, Ownable, Pausable, IMagpieCore {
    ...
    )
  {
    ...
    require(amountOut > args.payload.swapOutGasFee, "MagpieCore: invalid swapOutGasFee");
    ...
    IMagpiePool.BridgeInTokenArgs memory bridgeInArgs = IMagpiePool.BridgeInTokenArgs({
      ...
      receiver: args.payload.recipientPoolAddress,
      amount: amountOut,
      bridgeChainId: args.payload.recipientBridgeChainId,
