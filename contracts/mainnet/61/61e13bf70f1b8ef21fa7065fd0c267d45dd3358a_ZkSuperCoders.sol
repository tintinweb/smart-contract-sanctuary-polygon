...
// File: contracts/NFT_Contract_mainnet.sol
...
contract ZkSuperCoders is ERC721, ERC721Enumerable, Pausable, AccessControl, DefaultOperatorFilterer {
    ...
    constructor() ERC721("zkSuperCoders", "ZKSC") {
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _grantRole(MINTER_ROLE, msg.sender);
    }

    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://bafybeih2zfenehhrmopfwwtw6p74pcvcgogvu4ar527lgibssx4igqhwii/";
    }
    ...
    function enableTransfer() public onlyRole(MINTER_ROLE) {
        transferable = true;
    }

    function safeMint(address to, uint256 quantity) public onlyRole(MINTER_ROLE) returns (uint256) {
        require(totalSupply() < maxSupply, "Mint Complete");
    ...
    {
        require(transferable || hasRole(MINTER_ROLE, msg.sender), "Transfer is currently disabled.");
