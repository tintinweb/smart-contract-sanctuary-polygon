...
import "./NanoBase.sol";
import "./NonFungibleNanos.sol";
import "@openzeppelin/contracts/security/ReentrancyGuard.sol";
import "@openzeppelin/contracts/token/ERC20/IERC20.sol";


contract Minter is NanoBase, ReentrancyGuard {
    ...
    event TokenIssuedFromAlphaPass(address account, uint256 mintType, uint256 quantity, uint256 alphaPassId);
    ...
    mapping(address => uint256) public tokenMintPrice;
    ...
    function apiMintWithAlphaPass(address destination, uint256 quantity, uint256 mintType, uint256 alphaPassId) external only("apiNanos") {
        NonFungibleNanos nft = NonFungibleNanos(metananoData.getAddress("nft"));
