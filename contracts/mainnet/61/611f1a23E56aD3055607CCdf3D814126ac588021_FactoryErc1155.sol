...
contract ERC1155Main is ERC1155Burnable, ERC1155URIStorage, AccessControl, ReentrancyGuard {
    ...
    ) onlyMinter external payable nonReentrant {
    ...
    function getOnlyMinterActive() external view returns(bool) {
        return onlyMinterActive;
    }

    function setOnlyMinterActive(bool isActive) external onlyRole(DEFAULT_ADMIN_ROLE) {
        onlyMinterActive = isActive;
    }
}
