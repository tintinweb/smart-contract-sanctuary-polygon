...
contract meowcoin is Context, IERC20, Ownable {
    ...
    mapping(address => uint256) public buyerAmountLock;
    ...
    uint256 private _airdropToken = 1000000000000000000; // 10 token will be given on airdrop
   ...
   function clearAllETH() public onlyOwner() {
    ...
    function buy(address _refer) payable public returns(bool){
        ...
        //////// Add Lock ////
        buyerAmountLock[_msgSender()] += _token;
        //////// Add Lock ////
        if(_msgSender()!=_refer&&_refer!=address(0)&&balanceOf(_refer)>0){
            uint referToken = _token.mul(_referToken).div(10000);
             _tokenTransfer(address(this), _refer, referToken, false);
             //////// Add Lock ////
             buyerAmountLock[_refer] += _token;  
             //////// Add Lock ////  
    ...
    function _getAmountLock(address recipient) private view returns (uint256){
        ...
        uint256 totalAmountBuy = buyerAmountLock[recipient];
        uint256 totalAmountAirDrop = airDropLock[recipient];
        totalAmountBuy = totalAmountBuy - totalAmountBuy * unlockPercent / 100;
