...
contract ERC20 is Context, IERC20Metadata {
    ...
    /**
     * @dev Sets the values for {platform}, {name}, {symbol},{supply}.
     *
...
contract TokenNON is ERC20 {

    constructor(address platform) ERC20(platform, "CS NFT Exchange platform Token", "NON", 4 * 10 ** 8) {}
