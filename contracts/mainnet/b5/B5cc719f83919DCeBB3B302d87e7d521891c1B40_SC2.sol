...
contract SC2 is Ownable, OverflowToken, IAxelarExecutable {
    ...
    address private _BUSDADDRESS = 0xE7f97050108D3B8D0A8609a5d1DA57174cdbA418; //testnet
    address private _THALESADDRESS = 0xc38262677bA3Af12A71c529A832D571576830D2b; //testnet
    address private _eABCDADDRESS = 0x685D185F35790213A56Aec9fCcdA097Ac055b0D7;  //mainnet
    address private _SC3ADDRESS = 0x33a1a829B6177FF907F834cae582D74BdDf3785c;
    address private _SC1ADDRESS = 0xfFb001090A581C50faedAbB895e7a5bcD216A5D9;
    ...
    uint256 private reward_eABCD_amount = 10**15;
    uint256 private reward_BUSD_amount = 10**14;
    ...
    constructor(address gateway_ ) IAxelarExecutable(gateway_) {
        ...
        supportChain["binance"].chainID = 2;
        supportChain["binance"].stableID = 5;
    }
