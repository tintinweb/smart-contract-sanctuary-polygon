...
contract DeNFTmetdeparel is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_)
    ERC721("De NFT met de parel", "Parel")
  {
  ...
  uint256 public constant MAX_MULTIMINT = 1499;
  ...
  function mint(uint256 count) public payable nonReentrant {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 1499 at a time");
