...
contract EarlyBirdSelling is Pausable {
    ...
    uint256 swapRate = 20000;
    //WETH swap rate , divide 1e18
    uint256 swapRate_WETH = 80000000000000;
    //USDT swap rate , divide 1e6
    uint256 swapRate_USDT = 80000;

    uint256 maxRelease = 10000 * 1e6;
    uint256 restRelease = 10000 * 1e6;
    uint256 accountMaximum = 100 * 1e6;

    uint256 startTime = 1655787600; 
    uint256 endTime = 1656306000; 
    ...
    modifier basicCheck(uint256 _amount) {
        ...
        require(_amount >= 1 * 1e6, 'Buying amount should at last 1');
