...
// ACL functions
    ...
    // ETH Router
    function addLiquidityETH() external onlySelf {
        // nothing to restrict
    }
    ...
    function redeemRemote(
        ...
        bytes memory _to,
        lzTxObj memory ) external view onlySelf {
        require(allowed_pool_pid[_srcPoolId] == true, "pid not allowed");
        require(_refundAddress == safeAddress, "Refund address not safe address");
        require(bytesToAddress(_to) == safeAddress, "To not safe Address");
    }
