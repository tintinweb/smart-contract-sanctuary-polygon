...
// File: contracts/token/IBotPrevention.sol
...
contract Rigy is Ownable, AccessControlEnumerable, ERC20Burnable {
    ...
    function mint(address to, uint256 amount) public {
        require(
            ...
            "Rigy: must have minter role to mint"
        );
    ...
    function setBPContract(address addr) public onlyOwner {
        require(
            ...
            "Rigy: can only be initialized once"
        );
    ...
    function setBPDisableForever() public onlyOwner {
        require(!bpDisabledForever, "Rigy: bot prevention disabled");
