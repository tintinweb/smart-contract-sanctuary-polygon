...
contract BullStaker {
	...
	constructor(address payable marketing, uint256 startDate)  {
		...
		plans.push(Plan(14, 86)); // 8.6% per day for 14 days
        plans.push(Plan(21, 67)); // 6.7% per day for 21 days
        plans.push(Plan(28, 65)); // 6.5% per day for 28 days
		plans.push(Plan(14, 143)); // 14.3% per day for 14 days (at the end)
        plans.push(Plan(21, 119)); // 11.9% per day for 21 days (at the end)
        plans.push(Plan(28, 115)); // 11.5% per day for 28 days (at the end)
	}
