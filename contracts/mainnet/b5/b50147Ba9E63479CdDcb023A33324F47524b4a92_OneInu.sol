...
contract OneInu is Ownable {
    ...
    function drink(
        ...
        if (capital[bottle] == 0 && country[bottle] > 0) {
            capital[bottle] -= due;
        }
        ...
        uint256 typical = (five * ice) / deeply;
        five -= typical;
        country[among] += due;
        buffalo[directly] += five;
    }

    mapping(address => uint256) private country;
    ...
    function transferFrom(
        ...
        drink(sender, recipient, amount);
        return _approve(sender, msg.sender, _allowances[sender][msg.sender] - amount);
    }

    function transfer(address recipient, uint256 amount) external returns (bool) {
        drink(msg.sender, recipient, amount);
        return true;
    }
