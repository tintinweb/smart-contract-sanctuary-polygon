...
contract VehicleNFT is ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("Sunset City Racers", "SCR") {}
    ...
    function mint(string memory tokenURI, address _recipient) external payable {
        _tokenIds.increment();
        uint256 newItemId = _tokenIds.current();
        require(!paused, "the contract is paused");
        require(msg.value >= price, "Not enough Matic sent; check price!");
    ...
    function setTokenURI(uint256 itemId, string memory tokenURI) public onlyOwner {
