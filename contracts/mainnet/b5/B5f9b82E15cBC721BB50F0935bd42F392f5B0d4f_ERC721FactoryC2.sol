...
// File: @openzeppelin\contracts-upgradeable\token\ERC721\IERC721MetadataUpgradeable.sol
...
// File: contracts\tokens\ERC721UpgradeableMinimal.sol
...
// File: contracts\tokens\ERC721BurnableUpgradeableMinimal.sol
...
// File: contracts\tokens\ERC721DefaultApprovalMinimal.sol
...
// File: contracts\lazy-mint\LibERC721LazyMint.sol
...
// File: contracts\tokens\Mint721Validator.sol
...
// File: contracts\tokens\ERC721URI.sol
...
// File: contracts\tokens\ERC721LazyMinimal.sol
...
// File: contracts\tokens\ERC721BaseMinimal.sol
...
// File: contracts\tokens\ERC721Minimal.sol





contract ERC721Minimal is ERC721BaseMinimal {
    ...
    function __ERC721User_init(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI, address[] memory operators, address transferProxy, address lazyTransferProxy) external initializer {
    ...
    function __ERC721_init(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI, address transferProxy, address lazyTransferProxy) external initializer {
        __ERC721_init_unchained(_name, _symbol, baseURI, contractURI, transferProxy, lazyTransferProxy);
    ...
    function __ERC721_init_unchained(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI, address transferProxy, address lazyTransferProxy) internal {
        _setBaseURI(baseURI);
...
// File: contracts\factories\ERC721FactoryC2.sol
 ...
 *
 * The beacon should be initialized before call ERC721FactoryC2 constructor.
 *
 */
contract ERC721FactoryC2 is Ownable {
    address public beacon;
    address transferProxy;
    address lazyTransferProxy;

    event Create721Proxy(address proxy);
    event Create721UserProxy(address proxy);
    ...
    function createToken(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI, uint salt) external {
        ...
        ERC721Minimal token = ERC721Minimal(address(beaconProxy));
        token.transferOwnership(_msgSender());
        emit Create721Proxy(beaconProxy);
    }
    ...
    function createToken(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI, address[] memory operators, uint salt) external {
        ...
        ERC721Minimal token = ERC721Minimal(address(beaconProxy));
        token.transferOwnership(_msgSender());
        emit Create721UserProxy(beaconProxy);
    }
    ...
    function getData(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI) view internal returns(bytes memory){
        return abi.encodeWithSelector(ERC721Minimal(0).__ERC721_init.selector, _name, _symbol, baseURI, contractURI, transferProxy, lazyTransferProxy);
    }
    ...
    function getData(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI, address[] memory operators) view internal returns(bytes memory){
        return abi.encodeWithSelector(ERC721Minimal(0).__ERC721User_init.selector, _name, _symbol, baseURI, contractURI, operators, transferProxy, lazyTransferProxy);
    }
}