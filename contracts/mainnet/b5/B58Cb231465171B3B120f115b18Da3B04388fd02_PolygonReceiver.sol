...
contract PolygonReceiver is AccessControlEnumerable {
    ...
    event PolygonCommunityRegistryCreated(uint32 community_id,address community_proxy);
    ...
    event MessageReceived(uint256 community_id, address community_admin, string community_name);
    ...
    function processMessageFromRoot(
        ...
        require(data.length > 22,"invalid data length");
        ...
        createCommunity(community_id,community_admin,community_name);
    ...
    function createCommunity(
       ...
       emit PolygonCommunityRegistryCreated(community_id,address(community_proxy));
    }
