...
contract BeanBatz is ERC721 {
    uint256 public totalSupply;
    uint256 public cost = 0 ether;
    uint256 public maxMints = 13;
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeigx3gi3zjd2yogrzovudijowqapxjz4o5vh4oune4bakjfmb4musm/", Strings.toString(tokenId), ".json")
            );
    }
