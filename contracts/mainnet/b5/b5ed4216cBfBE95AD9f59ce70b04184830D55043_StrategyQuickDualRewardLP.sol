...
contract StrategyQuickDualRewardLP is Ownable, Pausable {
    ...
    constructor(
        ...
        require(_nativeToLp0Route[0] == output, "outputToLp0Route[0] != output");
    ...
    function chargeFees() internal {
        ...
        uint256 nativeBal = IERC20(native).balanceOf(address(this)).mul(totalFee).div(baseFee); //4.5% of total native balance
