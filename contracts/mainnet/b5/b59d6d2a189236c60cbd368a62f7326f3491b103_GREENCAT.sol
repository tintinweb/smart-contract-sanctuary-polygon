...
contract GREENCAT is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("GREEN CAT", "GA") {
    setHiddenMetadataUri("ipfs://QmXyumZGwLNzYcawgJGZLe5C66ySmpVacLjCXKnneusFiz/hidden.json");
  }
