...
contract DDAOCrowdsaleVestingTestnet is Ownable, Participants, ReentrancyGuard {
    ...
    // https://polygonscan.com/token/0x47a1162C73b565c7F0a5bD16168e3B2cA38942D5 
    IERC20 public ddao = IERC20(0x47a1162C73b565c7F0a5bD16168e3B2cA38942D5);

    // https://polygonscan.com/token/0xca1931c970ca8c225a3401bb472b52c46bba8382
    IERC20 public addao = IERC20(0x0EEAfFCfeA437f5822Fc1537b95Fc84EEBb3D9Db);
...
contract Participants is Ownable {
    ...
    constructor() {
        ...
        private2[0x627C125475d70bbB7eb138bd243851824c0865a1] = 53191000000000000000000; //   53191 DDAO
	...
	seed[0xa5B32272f2FE16d402Fe6Da4EDfF84cD6f8e4AA0]     = 2127659574468100000000 * 5;
	seed[0xB2207c34dE61f3018576cb637Fa90DAE0425D916]     = 625000000000000000000000;

	private2[0xF11Ffb4848e8a2E05eAb2cAfb02108277b56d0B7] = 2127659574468100000000;
	private2[0x97299ea1C42b3fA53b805e0E92b1e05500519762] = 21276595744681000000000;
	private2[0x9134408d47239DD81402723B8f0444cf66B82e5D] = 2127659574468100000000 * 2; 
	private2[0x675162726340338856a8Ff4923930e3A4b1e3Daf] = 2127659574468100000000 * 3;
	private2[0xe44b45E38E5Fe6d39c0370E55eB2453E25F7c3C5] = 2127659574468100000000 * 4;
	private2[0xa5B32272f2FE16d402Fe6Da4EDfF84cD6f8e4AA0] = 2127659574468100000000 * 5;

	private1[0xF11Ffb4848e8a2E05eAb2cAfb02108277b56d0B7] = 2127659574468100000000;
	private1[0x97299ea1C42b3fA53b805e0E92b1e05500519762] = 21276595744681000000000;
	private1[0x9134408d47239DD81402723B8f0444cf66B82e5D] = 2127659574468100000000 * 2; 
	private1[0x675162726340338856a8Ff4923930e3A4b1e3Daf] = 2127659574468100000000 * 3;
	private1[0xe44b45E38E5Fe6d39c0370E55eB2453E25F7c3C5] = 2127659574468100000000 * 4;
	private1[0xa5B32272f2FE16d402Fe6Da4EDfF84cD6f8e4AA0] = 2127659574468100000000 * 5;
    }
}
