...
contract HelloITX is ITXMixin, EIP712Allowlisting, ERC721PsiBurnableRoyalty {  

    mapping(address => uint256) internal _addressMinted;

    string tokenName = "HelloITX";
    string version = "1";
	string tokenSymbol = "HITX";
    uint256 maxSupply = 260;
    uint256 maxPerWallet = 1;
    uint96 feeNumerator = 100;

    string public message;
    address public writtenBy;

	constructor() ERC721Psi(tokenName, tokenSymbol) {
