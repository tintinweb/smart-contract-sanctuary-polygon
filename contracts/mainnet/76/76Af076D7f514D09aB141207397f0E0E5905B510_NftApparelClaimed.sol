//NFT-APPAREL-CLAIMED
/**
 *Submitted for verification at polygonscan.com on 13-03-2022
*/
...
contract NftApparelClaimed is ERC1155, Ownable {
    ...
    function claimNFT(address account, uint256 id, uint256 amount) public {
        require(account == _msgSender() || isApprovedForAll(account, _msgSender()), "Need operator approval for 3rd party burns.");
        
            NftApparel nftApparel = NftApparel(0x33b83B6D3179dCb4094c685C2418cab06372eD89);
            require(nftApparel.balanceOf(account,id) >= amount, "Not enough NFTs to claim.");
            
            nftApparel.burn(account, id, amount);
