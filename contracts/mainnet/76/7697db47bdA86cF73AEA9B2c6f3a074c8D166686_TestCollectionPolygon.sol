...
contract TestCollectionPolygon is Ownable, ERC721Enumerable {
    ...
    function mint(
        ...
        require(bytes(tokenURI_).length != 0, "TestCollectionPolygon: URI should not be empty");
    ...
    function tokenURI(uint256 tokenId_) public view override returns (string memory) {
        require(_exists(tokenId_), "TestCollectionPolygon: URI query for nonexistent token");
    ...
    function _beforeTokenTransfer(
        ...
        require(
            ...
            "TestCollectionPolygon: transfer is disabled"
        );
