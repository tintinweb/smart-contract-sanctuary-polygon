...
contract Mintermachine is Ownable, ERC721Enumerable, ReentrancyGuard {
  using Strings for uint256;

  uint256 public maxNFT = 10000;
  uint public nftprice = 1735*(10**18); //thats means 1 matic but this var is not using right now.
  uint256 public minPrice  = 10**18;
  address payable private manager;
  uint256 mintdate = 13949060;

  constructor() ERC721("Minter Machine", "Innosilicon A10 Pro") {manager = payable(msg.sender);}
  ...
  string private _baseTokenURI = 'https://gateway.pinata.cloud/ipfs/QmX3np21wJH4LQxhw6wpztyoY7yrHUBG56aEJMpR8Uqc3U';
