...
contract TContract
{
    ...
    function tokenByIndex(uint256 index) public returns (uint256)
    {
...
contract StorageContractInterface
{
...
contract LessonScheduler
{
    ...
    function TestStorageCall() public returns (uint256)
    {

        StorageContractInterface sCont = StorageContractInterface(0x1e48764196B8aF0c35175C9dD996785F8dBb0858);
        return sCont.RetrieveNumber();

    }

    function TestContractInteraction(uint256 indexToCheck) public returns(uint256)
    {

        TContract tCont = TContract(tAddress);
        return tCont.tokenByIndex(indexToCheck);
