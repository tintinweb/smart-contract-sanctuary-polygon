...
contract QueenzNFT is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://QmPFwKEy8LJUmT5GvzTxE8wu9aTkNfnn5kQ3zatRcYKTPR/";
  ...
  constructor() ERC721("Queenz NFT Collection", "QnZ") {
