...
contract CRIBOU is ERC20PresetMinterPauser, ERC20Capped {
    using SafeMath for uint256;
    
    
    constructor(string memory name, string memory symbol, uint256 supply, address beneficiary) ERC20PresetMinterPauser(name, symbol)  ERC20Capped(supply * 10 ** 18) public{
