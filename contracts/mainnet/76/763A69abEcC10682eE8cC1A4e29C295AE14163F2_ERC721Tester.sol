  ...
  DefaultOperatorFilterer
{
  ...
  uint256 public _mintPrice; // Mint price
  uint256 public _maxSupply; // Maximum number of NFTs available for sale
  uint256 public _maxMintPerWallet; // Maximum number of mints per wallet
  ...
  constructor(
    ...
    string memory contractMetadata,
    uint256 mintPrice,
    uint256 maxSupply,
