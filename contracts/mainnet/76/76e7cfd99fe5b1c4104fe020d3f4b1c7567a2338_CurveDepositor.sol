...
contract CurveDepositor is Ownable {
    ...
    function _sgReceive(
        ...
        if (exec.addLiquidityType == Type.POOL_SIZE_TWO) IWrappedNative(wNative).withdraw(amountLD);
    ...
    function _addLiquidity(address _token, address _pool, address _metaPool, uint256 _depositIndex, uint256 _depositBal, uint256 _minDepositAmt, Type _addLiquidityType) private {
        ...
        if (_addLiquidityType == Type.POOL_SIZE_TWO || _addLiquidityType == Type.POOL_SIZE_TWO_USE_UNDERLYING) {
