...
contract RoseOne is ERC721A, IERC2981, Admin {
    uint256 public _maxSupply;
    uint256 public _tempSupply;
    ...
    function mint(address to, uint256 qty, bool limitMint) public onlyAdmins {
        _mintCheck(qty);
        require(_totalMinted() + qty <= _tempSupply, 'Cohort supply reached');
    ...
    function setTempSupply(uint256 tempSupply) public onlyOwner {
        _tempSupply = tempSupply;
    }
