...
contract SaveWorldNFT is ERC721, ReentrancyGuard, Ownable {
  ...
  constructor(string memory customBaseURI_) ERC721("SaveWorld NFT", "SWNFT") {
  ...
  uint256 public constant PRICE = 70000000000000000000;
  ...
  function mint(uint256 count) public payable nonReentrant {
    ...
    require(
      msg.value >= PRICE * count, "Insufficient payment, 70 ETH per item"
    );
