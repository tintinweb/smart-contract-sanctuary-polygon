...
contract SDNFT_VIP is ERC721EnumerableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize(string memory _baseURI, string memory _baseExtension, address _factory) public initializer {
        ERC721Upgradeable.__ERC721_init("SDNFT_VIP", "SNV");
    ...
    function mint() external {
        ISDFactory(factory).checkIdentity(msg.sender, "nft.vip.mint");
