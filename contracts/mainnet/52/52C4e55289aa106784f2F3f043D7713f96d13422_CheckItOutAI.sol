...
contract CheckItOutAI is ERC721Upgradeable, OwnableUpgradeable {
  using CountersUpgradeable for CountersUpgradeable.Counter;
  CountersUpgradeable.Counter private _tokenIdCounter;
  address public crossmintManager;
  IERC20Upgradeable public usdc;
  uint256 public price;

  function initialize() public initializer {
    __ERC721_init("CheckItOutAI", "AI");
    __Ownable_init();
    price = 200000000;
  ...
  function setCrossmintManager(address _crossmintManager) external onlyOwner {
    crossmintManager = _crossmintManager;
  }
