    ...
    PausableUpgradeable
{
        ...
        returns (uint256 collatsBought)
    {
        ...
        //TODO: I should catch the error and revert with an "Failed to transfer error or something"
        //Maybe not and leave the original revert message which could vary depending on the token's contract.
        ...
        returns (uint256 amountOut)
    {
        uint256 amount;
        BackupAsset memory backUpAsset = getBackupAsset(from);
        console.log("backUpAsset.isAllowed: ", backUpAsset.isAllowed);
    ...
    function _execute(
        ...
        return _target.call{value: _value}(data);
    }
}
...
interface ICollatsMinter {
    ...
    // function swapWethForBackUpAsset(address to, uint256 amount)
    //     external
    //     returns (uint256);
