...
contract HippoFullAdmin is Ownable {
    ...
    constructor(IERC1155 _orareToken1155) {
    ...
    function pauseContract() public onlyAdmin returns (bool) {
        require(paused == false, "Already paused");
        paused = true;
        return true;
    }

    function unpauseContract() public onlyAdmin returns (bool) {
    ...
    function sendNfts(
        ...
        require(
            !_user.isContract(),
            "HippoFullAdmin: User should be an address"
        );
     ...
     */
    function recoverERC1155(uint256[] memory tokenId, uint256[] memory amount)
        external
        onlyOwner
    {
        orareToken1155.safeBatchTransferFrom(
