...
contract AxoToken is ERC20Permit, Ownable {
    constructor() ERC20("AxoToken", "AxO") ERC20Permit("AxoToken") {_mint(msg.sender, 1000 * 10 ** decimals());}

    uint256 private constant _maxTotalSupply = 50000000e18; // 13,666,000 max boos
        ...
        returns (uint256)
    {
        require(
            ...
            "BOO::getPriorVotes: not yet determined"
        );
