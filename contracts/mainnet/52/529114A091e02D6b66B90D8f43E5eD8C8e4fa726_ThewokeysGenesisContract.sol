...
//*********************************************************************//
//
// ooooooooooooo ooooo   ooooo oooooooooooo      oooooo   oooooo     oooo   .oooooo.   oooo    oooo oooooooooooo oooooo   oooo  .oooooo..o 
// 8'   888   `8 `888'   `888' `888'     `8       `888.    `888.     .8'   d8P'  `Y8b  `888   .8P'  `888'     `8  `888.   .8'  d8P'    `Y8 
//      888       888     888   888                `888.   .8888.   .8'   888      888  888  d8'     888           `888. .8'   Y88bo.      
//      888       888ooooo888   888oooo8            `888  .8'`888. .8'    888      888  88888[       888oooo8       `888.8'     `"Y8888o.  
//      888       888     888   888    "             `888.8'  `888.8'     888      888  888`88b.     888    "        `888'          `"Y88b 
//      888       888     888   888       o           `888'    `888'      `88b    d88'  888  `88b.   888       o      888      oo     .d8P 
//     o888o     o888o   o888o o888ooooood8            `8'      `8'        `Y8bood8P'  o888o  o888o o888ooooood8     o888o     8""88888P'  
//                                                                                                                                         
//                                                                                                                                         
//                                                                                                                                         
//
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 100, 300) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeicmw3v2z5i6qwlziftxrpvutrbs5krcljzgsuoupjagittpwxuice/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/vLJKw82hRnYYxYSNi59b/contract-metadata";
  }
...
// File: contracts/ThewokeysGenesisContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ThewokeysGenesisContract is RamppERC721A {
    constructor() RamppERC721A("THE WOKEYS Genesis", "WOKEYS"){}
}
