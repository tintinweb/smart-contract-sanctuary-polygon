 ...
 */
abstract contract ERC20Burnable is ERC20Simple {
    /**
 ...
 * the default admin role, which will let it grant both minter roles to other
 * accounts.
 */
abstract contract ERC20Minter is Context, AccessControlEnumerable, ERC20Burnable {
...
abstract contract ERC20Extended is ERC20Minter {
    /**
