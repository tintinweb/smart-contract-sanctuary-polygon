...
contract DoomWarriors is Ownable, ERC721Enumerable, ReentrancyGuard, ERC2981 {
    string private baseTokenURI;

    // Minting
    bool public paused;

    uint256 public whitelistStartTimestamp = 1686841200;
    uint256 public publicStartTimestamp = 1686848400;
    ...
    // Royalties
    uint256 public mintRoyalties = 50; // 1000 BASE
    ...
    uint256 public constant LAUNCHPAD_ROYALTIES = 100; // 1000 BASE
    ...
    constructor(
        ...
        address projectWallet2_,
        address royaltiesWallet_,
        address crodooWallet_
    ) ERC721("Doom Warriors", "DOOMWARS") {
        baseTokenURI = uri_;
        projectWallet = projectWallet_;
        projectWallet2 = projectWallet2_;
    ...
    function _payout(uint256 _amount, uint256 _amount2) private {
        ...
        (bool success2, ) = payable(projectWallet2).call{
            value: _amount2,
            gas: 50000
        }("");
        require(success2, "Cannot payout 2");
    }
    ...
    function mint(uint256 amount) external payable nonReentrant {
        ...
        if (currentSupply > 0 && mintRoyalties > 0) {
            royalties = (msg.value * mintRoyalties) / 1000;
        ...
        uint256 launchpadRoyalties = (totalPrice * LAUNCHPAD_ROYALTIES) / 1000;
        uint256 payout = (totalPrice * 475) / 1000;
        uint256 payout2 = (totalPrice * 375) / 1000;

        _payout(payout, payout2);
