    ...
    Common
{
    ...
    function mintOffset(address to, string memory _project, uint256 vintage, uint256 amount) external override virtual whenNotPaused {
...
interface IContractNFTOffset {
    ...
    function mintOffset(address to, string memory _project, uint256 vintage, uint256 amount) external;
