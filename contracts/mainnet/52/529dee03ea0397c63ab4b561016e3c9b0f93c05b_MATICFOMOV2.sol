...
contract MATICFOMOV2 {
	...
	uint256 constant public INVEST_MIN_AMOUNT = 0.001 ether; // 5 MATIC
	...
	constructor(address payable wallet, address payable _developer) public {
        ...
        plans.push(Plan(3, 80)); // 8% per day for 14 days
        plans.push(Plan(21, 75)); // 7.5% per day for 21 days
        plans.push(Plan(28, 70)); // 7% per day for 28 days
		plans.push(Plan(1, 80)); // 8% per day for 14 days (at the end, compounding)
