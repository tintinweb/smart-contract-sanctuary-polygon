...
contract NFTKEYGlobalOffer is INFTKEYGlobalOffer, Ownable, ReentrancyGuard {
        ...
        onlyAllowedExpireTimestamp(expireTimestamp)
    {
        ...
        emit OfferCreated(erc721Address, offer);
    }
        ...
        override
    {
        ...
        emit OfferCancelled(erc721Address, offer);
    }
...
interface INFTKEYGlobalOffer {
    ...
    event OfferCreated(address indexed erc721Address, Offer offer);
    event OfferCancelled(address indexed erc721Address, Offer offer);
    event OfferAccepted(
        address indexed erc721Address,
