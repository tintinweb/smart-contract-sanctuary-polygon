...
contract VOHAAMysteryBoxes is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxSupply = 22500;
  uint256 public maxMintAmountPerTx = 10;

  bool public paused = true;
  bool public revealed = false;

  constructor() ERC721("VOHAA Mystery Boxes", "VMB") {
    setHiddenMetadataUri("ipfs://QmPcmB2StUotZvs3d3LD1XnpzBrzcULVgDKCxKyd7Kvvau/hidden.json");
  }
