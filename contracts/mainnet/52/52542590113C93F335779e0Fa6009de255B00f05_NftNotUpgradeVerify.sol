...
contract NftNotUpgradeVerify is ERC721PresetMinterPauserAutoId, Ownable {
    using Counters for Counters.Counter;
    ...
    constructor() ERC721PresetMinterPauserAutoId("Contract NotUpgrade", "TES", "") {
    ...
    function safeMint(address account) public onlyRole(GATEWAY_ROLE) returns (uint256){
    ...
    function setTokenURI(uint256 tokenId, string memory _tokenURI) external onlyRole(ADMIN_ROLE) {
    ...
    function safeBatchMint(address account, uint256 quantity)
    external
