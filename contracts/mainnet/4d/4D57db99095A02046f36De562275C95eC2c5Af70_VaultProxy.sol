...
/**
 * @notice MATICPlusProxy delegates calls to an MATICPlus implementation
 */
contract MATICPlusProxy is InitializeGovernedUpgradeabilityProxy {

}

/**
 * @notice WrappedMATICPlusProxy delegates calls to a WrappedMATICPlus implementation
 */
contract WrappedMATICPlusProxy is InitializeGovernedUpgradeabilityProxy {
...
/**
 * @notice AaveSingleWMATICStrategyProxy delegates calls to a MeshswapStrategy implementation
 */
contract AaveSingleWMATICStrategyProxy is InitializeGovernedUpgradeabilityProxy {

}

/**
 * @notice DforceSingleWMATICStrategyProxy delegates calls to a MeshswapStrategy implementation
 */
contract DforceSingleWMATICStrategyProxy is InitializeGovernedUpgradeabilityProxy {
