...
contract ProofOfLearningExperienceProtocol is Initializable, ERC721Upgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    modifier onlyOnePerDay{
        ...
        require(!alreadyMinted, "You can only perform a single mint per day (up to 3 tokens per mint)");
    ...
    function upDate() external onlyUnpaused onlyRole(DATE_TRACKER_ROLE){
        date = (date + 1) % 7;
