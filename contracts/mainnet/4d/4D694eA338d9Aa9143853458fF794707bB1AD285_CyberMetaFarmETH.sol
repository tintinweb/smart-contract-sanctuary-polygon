...
//BURN____________________________________________________________________________________________________//
    function burn(address from, uint amount) public nonReentrant() {
...
//USER___________________________________________________________________________________________________//
    ...
    function transfer(address to, uint256 amount) public override virtual nonReentrant() returns (bool) {
    ...
    function transferFrom(address from, address to, uint256 amount) public override virtual nonReentrant() returns (bool) {
