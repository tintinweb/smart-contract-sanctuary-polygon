...
contract QuantumPolyPen is ERC20, Ownable, ReentrancyGuard { 
    ...
    constructor() ERC20("Quantum PolyPen", "qPPN") { 
        ...
        setTaxRate(12); // 8% tax rate by default
    }
    ...
    function setTaxRate(uint256 _taxRate) public onlyOwner {
        require(_taxRate <= 20, "Tax rate should be less than or equal to 8");
        taxRate = _taxRate;
