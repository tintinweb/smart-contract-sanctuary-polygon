...
contract TheRoyalLionsOfficial is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_)
    ERC721("The Royal Lions Official", "TRLION")
  {
  ...
  uint256 public constant MINT_LIMIT_PER_WALLET = 20000;
  ...
  uint256 public constant MAX_MULTIMINT = 20000;
  ...
  function mint(uint256 count) public nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 20000 at a time");
