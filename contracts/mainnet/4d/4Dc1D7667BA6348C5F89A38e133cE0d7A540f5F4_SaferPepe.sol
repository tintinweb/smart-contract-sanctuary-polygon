...
/*
   ...
   #LIQ+#RFI+#PEPE = #saferPEPE

   #SAFEPEPE features:
   5% fee auto add to the liquidity pool to locked forever when selling
   0% fee auto distribute to all holders
   I created a black hole so #saferPEPE token will deflate itself in supply with every transaction
...
contract SaferPepe is Context, IERC20, Ownable {
    ...
    string private _name = "SaferPepe";
    string private _symbol = "SAFERPEPE";
