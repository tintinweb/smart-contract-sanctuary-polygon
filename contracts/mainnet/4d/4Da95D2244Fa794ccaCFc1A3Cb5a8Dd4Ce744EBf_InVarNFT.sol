...
contract InVarNFT is ERC1155, Ownable {
    ...
    string public name = "InVarNFT HyFi3";
    
    constructor() ERC1155("https://vxlbviwcjm1x.usemoralis.com/hyfi3/{id}.json"){
    }
    ...
    function MultiMintNFT(address account, uint256 startId, uint256 endId) public onlyOwner {
