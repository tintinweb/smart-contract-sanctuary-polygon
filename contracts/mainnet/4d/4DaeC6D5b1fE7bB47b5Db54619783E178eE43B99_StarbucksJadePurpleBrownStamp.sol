 ...
 * @notice This contract handles minting Starbucks Jade Purple Brown Stamp tokens.
 */
contract StarbucksJadePurpleBrownStamp is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xc1C48d59d68077aa6c8081E1Db374C1d9f65877b;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x42D098CaBA11a002f6DD6CC0D2409e3B4Aa06b5e;
    address[] public payoutAddresses = [
        0x42D098CaBA11a002f6DD6CC0D2409e3B4Aa06b5e
    ];
    ...
    string public name = "Starbucks Jade Purple Brown Stamp";
    string public symbol = "JadePurpleBrown";
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeigrepmioloxnjm7bf4ofkevvesbu5valntzzjme42u6dfb3t67gea/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[1] = 2354;
        tokenPublicPrice[1] = 0 ether;
        tokenPublicMintsPerAddress[1] = 2354;
        require(
