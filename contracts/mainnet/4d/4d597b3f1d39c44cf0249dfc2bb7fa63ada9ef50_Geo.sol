...
contract Geo is  ERC721URIStorage, ERC721Enumerable, Ownable, IERC2981 { 
    uint256  gen_c; 
    ...
    //bytes4 private constant _INTERFACE_ID_ERC2981 = 0x2a55205a;
    constructor () ERC721 ("Project: Geometric","GEO") {
        ...
        nucleotide_m = 42;
        gen_b = 500;
        nucleotide_cl = ["#85C1E9", "#76448A", "#839192", "#17A589", "#F1C40F", "#2E4053", "#FF0000", "#D35400", "#F0F3F4", "#DC143C", "#DC143C"];
