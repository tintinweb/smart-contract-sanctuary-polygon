...
// The World’s Smartest Cat With Auto BuyBack, Hyper Deflationary Coin is here! 
// Kyoki is on a mission to help lost and scared animals find their way to the nearest animal shelter.

// 📱 Telegram: https://t.me/ItsKyoki
...
contract Kyoki is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xc09e3C13A2CC2c7358927F926a9dB5E6fB7Ce0ed); // Marketing Address
    ...
    string private _name = "Kyoki";
    string private _symbol = "KYOKI";
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x51aBA405De2b25E5506DeA32A6697F450cEB1a17);
