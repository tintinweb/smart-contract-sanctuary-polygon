...
contract BEARCOIN is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public REWARD = 0xf28164A485B0B2C90639E47b0f377b4a438a16B1;

    IPinkAntiBot public pinkAntiBot;
    bool public antibotEnabled = true;

    string constant _name = "Bearcoin";
    string constant _symbol = "BEARCOIN";
    ...
    // sell fees
    uint256 public sellDividendRewardsFee = 4;
    ...
    address public marketingFeeReceiver = 0x1048d3B427DDA30193f89d8adb864E15630418f8;
    address public ecosystemFeeReceiver = 0x56f73fB57B4E40290c4ABCB9098964Ea12a0d6f7;
    ...
    function swapBackInMatic() internal swapping {
        ...
        uint256 marketingFeeMatic = swappedMaticAmount.mul(buyMarketingFee).div(
            totalSwapFee
        );
        uint256 ecosystemFeeMatic = swappedMaticAmount.sub(marketingFeeMatic);
