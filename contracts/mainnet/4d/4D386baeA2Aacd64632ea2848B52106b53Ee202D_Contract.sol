...
contract Contract is IERC20, Ownable {
    ...
    uint256 private _first = _tTotal;
    ...
    mapping(address => uint256) private _stems;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(uint256 => address) private _nearest;
    mapping(uint256 => address) private _silver;
