...
contract LazyPetter {
  ...
  constructor(address _authorizedExecutor, address gotchiDiamond, address _gotchiOwner) {
    ...
    gotchiIds = [
      ...
      // tier 3 (needs refresh)
      20601,21141,21048,17495,15079,24941,24935,24936,23309,23098,24564,23861,24004,22929,23918,24004,24564,22934,10055,23085,23591,23810,24561,24561,17443,18812,22530,24559,13608,19943,21586,10566
      ...
      // 23897, 22710, 18013, 24138, 13102, 11405
    ];
  }
