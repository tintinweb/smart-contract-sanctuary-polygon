...
contract AFTGeneralPulling {
    ...
    mapping(uint256 => address[]) public _AdressesVotescounter;
    ...
    mapping(uint256 => uint256[]) public _AFTVotescounter;
    mapping(uint256 => address[]) public _AFTAdressesVotescounter;
    ...
    function justRef() public pure returns (bool){
        return true;
    }
    //------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    /*
