...
contract DragonFruit is ERC20, ERC721Holder, Ownable {
    IERC721 public nft;
    mapping(uint256 => address) public tokenOwnerOf;
    mapping(uint256 => uint256) public tokenStakedAt;
    uint256 public EMISSION_RATE = (66 * 10 ** decimals()) / 1 days;

    constructor(address _nft) ERC20("Dragon Fruits", "FRUITS") {
        nft = IERC721(_nft);
    }
