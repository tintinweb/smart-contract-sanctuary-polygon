...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new NexityUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        NexityUser721Token token = NexityUser721Token(address(addr));
...
contract NexityUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
