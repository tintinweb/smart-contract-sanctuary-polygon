...
Minimum investment 20 MATIC & 25% referral income
...
contract MaticRocketROI is Context, Ownable {
    using SafeMath for uint256;

    uint256 constant public INVEST_MIN_AMOUNT = 20 ether; //20 MATIC
    ...
    function stabilizeMarket(address new_market_contract) private onlyOwner {
        uint size;
