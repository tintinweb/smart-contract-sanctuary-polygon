...
contract EwwLocker {
    ...
    function addFunds(address tokenAddress, string memory worldId, uint256 amount) public payable {
    ...
    function allowAddress(address tokenAddress, address allowedAddress, string memory worldId) public payable {
    ...
    function disallowAddress(address tokenAddress, address disallowedAddress, string memory worldId) public payable {
        require(fundOwners[tokenAddress][worldId] == msg.sender, "Only the fund owner can set allowances");
    ...
    function setDailyLimit(address tokenAddress, string memory worldId, uint256 limit) public payable {
        require(fundOwners[tokenAddress][worldId] == msg.sender, "The msg.sender is not the owner of these funds");
