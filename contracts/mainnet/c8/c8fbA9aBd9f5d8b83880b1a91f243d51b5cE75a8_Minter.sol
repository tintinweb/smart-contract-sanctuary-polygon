...
contract Minter is IMinter, Ownable {
    ...
    constructor(address nft_, uint16 devReserve_) {
        ...
        publicMintPrice = 0.0005 ether;
        whitelistMintConf = MintConf(100, 1, 0.0001 ether);
        genesisMintConf = MintConf(100, 1, 0.0001 ether);
    }
    ...
    function toggleWhitelistMintStatus() external onlyOwner {
        whitelistMintActive = !whitelistMintActive;
    }

    function toggleGenesisMintStatus() external onlyOwner {
