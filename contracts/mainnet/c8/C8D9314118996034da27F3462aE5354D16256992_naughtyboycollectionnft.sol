...
contract naughtyboycollectionnft is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  using Strings for uint256;

  constructor(string memory customBaseURI_)
    ERC721("naughty boy collection nft", "nbcn")
  {
  ...
  uint256 public constant MINT_LIMIT_PER_WALLET = 3600;
  ...
  uint256 public constant MAX_MULTIMINT = 3600;
    ...
    onlyOwner
  {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 3600 at a time");
