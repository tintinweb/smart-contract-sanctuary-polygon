...
contract LazyKongs is ERC20, AccessControl, ERC721Holder {
    ...
    constructor(address owner, address _collectionAddress) ERC20("Lazy Kongs Coin", "LazyCoin") AccessControl(){
    ...
    function setCollectionAddress(address newAddress) external onlyRole(CONTRACT_ADMIN_ROLE){
        require (newAddress != address(0), "LazyCoin: update to zero address not possible");
