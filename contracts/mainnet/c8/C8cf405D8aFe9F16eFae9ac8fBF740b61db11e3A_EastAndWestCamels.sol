...
contract EastAndWestCamels is ERC721Enumerable, Ownable {  
    ...
    uint256 public reserved = 1001;

    // Price of each token
    uint256 public initial_price = 0.015 ether;
    uint256 public price;

    // Maximum limit of tokens that can ever exist
    uint256 public constant MAX_SUPPLY = 1001;
    uint256 public constant MAX_PRESALE_SUPPLY = 1001;
    uint256 public constant MAX_MINT_PER_TX = 1001;

    // The base link that leads to the image / video of the token
    string public baseTokenURI = "https://data.eawcamels.com/";
    ...
    constructor () ERC721 ("EastAndWestCamels", "EAWC") {
        price = initial_price;
    }
