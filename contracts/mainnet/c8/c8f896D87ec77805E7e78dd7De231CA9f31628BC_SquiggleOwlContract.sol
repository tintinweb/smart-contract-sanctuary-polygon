...
//
//            _____             _             __        ____           __
//   / ___/____ ___  __(_)___ _____ _/ /__     / __ \_      __/ /
//   \__ \/ __ `/ / / / / __ `/ __ `/ / _ \   / / / / | /| / / / 
//  ___/ / /_/ / /_/ / / /_/ / /_/ / /  __/  / /_/ /| |/ |/ / /  
// /____/\__, /\__,_/_/\__, /\__, /_/\___/   \____/ |__/|__/_/   
//         /_/        /____//____/                               
//     
//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xd80230895bC27772e819d58C4F5C7828eB7A54bB,0x09C64531a4a98d12285265e8c76A90d9c52665A0];
  address public erc20Payable = 0xd80230895bC27772e819d58C4F5C7828eB7A54bB;
...
abstract contract Feeable is Teams {
  uint256 public PRICE = 12.44 ether;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, type(uint256).max) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmZb6vaCXaaxW5mNBEb9dGp7xEJxuoMKtNyACX18Z8RTF1/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/oqfJAlABKWSUA7hluD5r/contract-metadata";
  }
...
// File: contracts/SquiggleOwlContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SquiggleOwlContract is RamppERC721A {
    constructor() RamppERC721A("Squiggle Owl", "SQGLOWL"){}
}
