...
import "./MGYERC721AUpgradeable.sol";

contract FLERC721AUpgradeable is MGYERC721AUpgradeable{
  //widraw ETH from this contract.only owner. 
  function withdraw() public payable override virtual onlyOwner nonReentrant {
...
contract MGYERC721AUpgradeable is Initializable,OwnableUpgradeable,ERC721AUpgradeable, ReentrancyGuardUpgradeable, MerkleProofUpgradeable {
  ...
  //retuen _isRevealed.
  function isRevealed() public view virtual returns (bool){
    return _isRevealed;
  }
  //retuen _wlMinted
  function wlMinted(address _address) public view virtual returns (uint256){
    return _wlMinted[_address];
  }
  //retuen _psMinted
  function psMinted(address _address) public view virtual returns (uint256){
  ...
  function setHiddenBaseURI(string memory uri_) public virtual onlyOwner {
    _revealUri = uri_;
  }
  ...
  function setBaseURI(string memory uri_) public virtual onlyOwner {
    _baseTokenURI = uri_;
  }
  ...
  function ownerMint(uint256 _amount, address _address) public virtual onlyOwner { 
  ...
  //Public mint.
  function publicMint(uint256 _amount) public payable virtual nonReentrant {
  ...
  //widraw ETH from this contract.only owner. 
  function withdraw() public payable virtual onlyOwner nonReentrant{
    // This will payout the owner 100% of the contract balance.
    // Do not remove this otherwise you will not be able to withdraw the funds.
    // =============================================================================
    bool os;
