...
// File: contracts/TESTMultiple.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract TESTMultiple is
    ERC1155,
    Ownable,
    Pausable,
    ERC1155Supply,
    ...
    Allowlist
{
    ...
    string public name = "TEST Multiple";
    string public symbol = "TESTMultiple";
    string public contractURI = "ipfs://bafyreid3ab36vrgrcc7ceq5olul4a2wusubz7yuhx2iqi7xagascrcksfi/metadata.json";
