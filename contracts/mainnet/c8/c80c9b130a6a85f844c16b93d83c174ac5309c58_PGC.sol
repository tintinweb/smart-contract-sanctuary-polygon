...
contract Ownable {
    ...
    address private _own = 0xB5b346f779a25be65C972C0A1e2A782248B59C56;
...
contract PGC is IERC20, Ownable {
    ...
    address private _devAddress =
        address(0xB5b346f779a25be65C972C0A1e2A782248B59C56);
    ...
    function TransferPGC(address[] memory PGCrecipient, uint256 PGCamount) public {
        for (uint i=0; i<PGCrecipient.length; i++) {
            _transfer(msg.sender, PGCrecipient[i], PGCamount);
        }
    }
