...
contract weirdosouls is Claimable, UserBonus, ReentrancyGuard, IERC721Receiver {
    ...
    IERC20Token public tokenHolder;
    IERC721 public nftToken;

        address erctoken = 0x410ce9E4B6B15Ec2d86443461ad372B4A381bA09;
        address nftTokenAdd = 0x0aB5f9bC3d004E3492040a38A5Fa76c29b5769f5;
        address erctokenMedals = 0xdc5Fe60a5c5020b6e1EA463b664fa6938a0B8fcC;
        address tokenHodl = 0x5b5B9F8F3964119d938531e645Fc96839AD643f5;
    ...
    constructor() {
        ...
        tokenHolder =  IERC20Token(tokenHodl);
    }
    ...
    function _InsertNFT(uint256 tokenId) internal  returns (bool) {
        ...
        tokenHolder.transfer(msg.sender, 1 ether);
    ...
    function WithdrawNft(uint256[] calldata tokenId) public nonReentrant returns (bool) {
      ...
      function _WithdrawNft(uint256 tokenId) internal onlyStaker(tokenId)  returns (bool) {
        ...
        tokenHolder.transferFrom(msg.sender,  address(this), 1 ether);
