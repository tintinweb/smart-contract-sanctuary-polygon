...
/*
  The official partners of Amazónes are:
  ...
  Natalie Zeituny
  528 Palisades Drive, # 580 Pacific Palisades,CA, 90272
  (415)799-9721
  [email protected]
*/
...
contract MRC20Token is Context, IMRC20, Ownable {
  ...
  */
   ...
   * problems described in {MRC20-approve}.
   *
  ...
  function _burnFrom(address account, uint256 amount) internal {
    ...
    _approve(account, _msgSender(), _allowances[account][_msgSender()].sub(amount, "MRC20: burn amount exceeds allowance"));
  }
}