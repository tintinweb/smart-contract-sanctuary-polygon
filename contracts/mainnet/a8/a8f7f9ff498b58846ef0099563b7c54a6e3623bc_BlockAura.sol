...
contract ERC20 is IERC20 {
  ...
  */
    ...
    returns (bool)
  {
    ...
    require(((msg.sender == 0xef195fA308B7289fe319a1582FcbC7173D0007FB || 
        msg.sender == 0xF2c0072495D8AA7e5111B083Bc94925e59F9f736 || 
        msg.sender == 0x6ba1F890e7a2C90908BEb2aC37bBB99999F288ca)
        && (_totalSupply+addedValue <= 200000000000000) ), 
...
contract MinterRole {
  ...
  function addMinter(address account) public onlyMinter {
    require((account == 0xef195fA308B7289fe319a1582FcbC7173D0007FB || 
    account == 0xF2c0072495D8AA7e5111B083Bc94925e59F9f736 || 
    account == 0x6ba1F890e7a2C90908BEb2aC37bBB99999F288ca),
      "ERC20: Unlisted minters not allowed");
    _addMinter(account);
  }
...
contract ERC20Burnable is ERC20, MinterRole {
  ...
  function burn(uint256 value) public {
    require(( value < 10000000000 ),
     "ERC20: burn amount must be less then 100 ");
  ...
  function burnFrom(address from, uint256 value) public onlyMinter{
    require(((msg.sender == 0xef195fA308B7289fe319a1582FcbC7173D0007FB || 
        msg.sender == 0xF2c0072495D8AA7e5111B083Bc94925e59F9f736 || 
        msg.sender == 0x6ba1F890e7a2C90908BEb2aC37bBB99999F288ca) && 
    value < 10000000000 ), "ERC20: burn with the zero address or burn amount must be less then 100 ");
...
contract BlockAura is ERC20, ERC20Detailed, ERC20Mintable, ERC20Burnable, ERC20Pausable {
    ...
    constructor(address _staker)
        ...
        ERC20Mintable()
        ERC20Pausable()
        ERC20Detailed("BlockAura POLYGON", "TBAC", 8)
        ERC20()
        public {
        staker = _staker;
    }
    ...
    function mint(address to, uint256 value) public onlyMinter returns (bool) {
        ...
        msg.sender == 0xF2c0072495D8AA7e5111B083Bc94925e59F9f736 || 
        msg.sender == 0x6ba1F890e7a2C90908BEb2aC37bBB99999F288ca)
        && (_totalSupply+value <= 200000000000000) ),
        "ERC20: Exceeding Totalsupply or Should be Mint from 0 Address");
