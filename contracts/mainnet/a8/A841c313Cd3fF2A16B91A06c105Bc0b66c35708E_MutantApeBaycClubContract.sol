...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x289b801ED6ce79E9b934a9bE45bE8A7CD05fC150];
  address public erc20Payable = 0x289b801ED6ce79E9b934a9bE45bE8A7CD05fC150;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 1000, 18068) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeieefopltvyeybcruvgu7cr7pfcvyzycnre6v7w7clhcyzp5r66ssm/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 18068");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 18068");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 18068");
...
// File: contracts/MutantApeBaycClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MutantApeBaycClubContract is RamppERC721A {
    constructor() RamppERC721A("Mutant Ape BAYC Club", "Mutant Ape"){}
}
