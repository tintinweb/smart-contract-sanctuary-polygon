...
// File: contracts/GrazeMan.sol
    ...
    contract GrazeMan is ERC721, Ownable, ERC721Enumerable {
      ...
      uint256 public maxTokenPurchase = 500;
      uint256 public MAX_TOKENS = 9999;
    
      string public baseURI = "ipfs://QmRmet7gCkV2PXBrZ4kXb4H7AXQFQ72R2N2LaTqfAEwMuL/"; // IPFS URI WILL BE SET AFTER ALL TOKENS SOLD OUT
      ...
      uint256 public presaleMaxMint = 500;
      uint256 public devReserve = 600;
    
      event GrazemanMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("GrazeManNew", "GM") {}
        ...
        returns (string memory)
      {
        ...
        if (isRevealed == false) {
          return
            "ipfs://QmTAyponqbJw6x3k2aBbRLxgg9SUUSTXg6oJxLf5zHkBZo/hidden.json";
        }
