...
contract Omar_Comin is ERC20, ERC20Burnable, Ownable, DividendTrackerFunctions {
    ...
    constructor()
        ERC20("Omar Comin", "OMAR") 
    {
        address supplyRecipient = 0xCcefFf0295e258d33A42240ab9cb3473Ba5793B1;
        
        updateSwapThreshold(21000000 * (10 ** decimals()));

        taxAddressSetup(0xF8cDA941245af8755769F060FaE28D0DD23067Ce);
        taxFeesSetup(100, 100, 0);

        autoBurnFeesSetup(100, 100, 0);

        lpTokensReceiverSetup(0xF8cDA941245af8755769F060FaE28D0DD23067Ce);
        liquidityFeesSetup(200, 200, 0);

        _deployDividendTracker(7200, 100000000 * (10 ** decimals()));
        ...
        _updateRouterV2(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff);
        ...
        updateMaxTxAmount(100000000 * (10 ** decimals()));

        _mint(supplyRecipient, 42000000000 * (10 ** decimals()));
        _transferOwnership(0xCcefFf0295e258d33A42240ab9cb3473Ba5793B1);
    }
    ...
    function taxFeesSetup(uint16 _buyFee, uint16 _sellFee, uint16 _transferFee) public onlyOwner {
        ...
        totalFees[0] = 0 + taxFees[0] + autoBurnFees[0] + liquidityFees[0] + rewardsFees[0];
        totalFees[1] = 0 + taxFees[1] + autoBurnFees[1] + liquidityFees[1] + rewardsFees[1];
        totalFees[2] = 0 + taxFees[2] + autoBurnFees[2] + liquidityFees[2] + rewardsFees[2];
    ...
    function _transfer(
        ...
        bool canSwap = 0 + _taxPending + _liquidityPending + _rewardsPending >= swapThreshold;
