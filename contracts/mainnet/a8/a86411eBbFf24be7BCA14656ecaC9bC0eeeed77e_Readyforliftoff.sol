...
// File: contracts/Readyforliftoff.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract Readyforliftoff is
    ERC1155,
    Ownable,
    Pausable,
    ERC1155Supply,
    ...
    Allowlist
{
    ...
    string public name = "Ready for liftoff";
    string public symbol = "Readyforliftoff";
    string public contractURI = "ipfs://bafyreibxtkx4cyqycvkuzsf4vvflchrmz4qfev3a3vbdgw3rniuojrf3ce/metadata.json";
