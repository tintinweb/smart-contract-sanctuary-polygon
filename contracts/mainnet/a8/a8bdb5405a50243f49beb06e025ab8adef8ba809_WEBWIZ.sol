...
contract WEBWIZ is ERC721Enumerable, Ownable, IRamperInterface721 {
    uint256 constant public MAX_TOKENS = 7777;
    uint256 constant public MAX_TOKENS_PER_TXN = 1;
    uint256 constant public MAX_TOKENS_PER_ADDRESS = 7;

    string public baseTokenURI = "ipfs://e5844e4daea4b3caad9b0676d6f2815ccfbe6434f6fb7fcec13fcf4064d59233/";

    address constant public CHAINLINK_AGGREGATOR_ADDRESS = 0xAB594600376Ec9fD91F8e885dADF0CE036862dE0;

    constructor() ERC721("WEB", "WIZ") {
    ...
    function availableTokens(address _userWallet) override external view returns (uint256 quantity) {
        ...
        // Where the limit returned is the lowest of these 3
    ...
    function fetchUSDPrice() internal view returns (uint256) {
        ...
        uint256 priceInUSD = uint256(priceValue) * (10**decimals);
        return priceInUSD;
    }

    function price() override external view returns (uint256) {
        uint256 nftPrice = fetchUSDPrice() * 33;
        return nftPrice;
    }

    function mint(address _userWallet, uint256 _quantity) override external payable {
        uint256 nftPrice = fetchUSDPrice() * 33;
        require(msg.value >= nftPrice * _quantity, "Insufficient funds for requested tokens");
  ...
  function withdraw() public payable onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x9E0ab3a40Ae7509146b17c7329b9CD23ae53D94d).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
