...
contract TESTtToken is ERC20, Ownable, Pausable{

    bool public isTradable = false;

    mapping(address => bool) public _isBlacklisted;

    uint32 public feePercent = 10;

    address public feeAddress = 0x781Df527dBEA1C56946627C2D059b3A0f906Aa24;

    constructor(
    ) ERC20("TesttToken", "TESTT") {
    ...
    function changeFeePercent(uint32 _feePercent) public onlyOwner() {
    ...
    function transfer(address recipient, uint256 amount) public whenNotPaused override returns (bool) {
        ...
        uint256 restPercent = 10000 - feePercent;

        super.transfer(feeAddress, amount * feePercent / 10000);
        super.transfer(recipient, amount * restPercent / 10000);
        return true;
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public  whenNotPaused override returns (bool) {
        ...
        super.transferFrom(sender, feeAddress, amount * feePercent / 10000);
        super.transferFrom(sender, recipient, amount * restPercent / 10000);
        return true;
    }
}