...
import "./CustomerWalletV1dot1.sol";
...
contract WalletFactoryV1dot1{
    ...
    function CreateWalletContract() external returns(bool){
        ...
        CustomerWalletV1dot1 newWalletContract = new CustomerWalletV1dot1(fiskPayAddress);
        ...
        require(fisk.AddNewWallet(address(newWalletContract), msg.sender), "Wallet could not be created");
