...
// File: https://github.com/NomicFoundation/hardhat/blob/master/packages/hardhat-core/console.sol
...
// File: contracts/HoALotteryEd1.sol
...
contract HoALotteryEd1 is ERC721, Ownable, RandomlyAssigned{
    using Strings for uint256;
    using Counters for Counters.Counter;
    ...
    function _mintSingleNFT(address wAddress) private {
        uint newTokenID = nextToken();
        _safeMint(wAddress, newTokenID);
    } 
    
    function withdraw() public payable onlyOwner {
        uint _balance = address(this).balance;
        payable(0xCC01966b96a2B4d78Bc197fF3F33a3F0a5Da0A9D).transfer(_balance * 5 / 100);
        payable(0x3ac2770b672865A0E4A6495e3676e34BF3004a16).transfer(_balance * 5 / 100);
