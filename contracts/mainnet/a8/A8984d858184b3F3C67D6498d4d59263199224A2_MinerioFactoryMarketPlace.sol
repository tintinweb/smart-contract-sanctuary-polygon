...
contract MinerioFactoryMarketPlace is Ownable {
    //////////////////////////////////////////////////////////////////////////////////////////////////// Variables

    address public nftHolder; //holder of NFTs
    ...
    function buyWithMatic(uint256 _nftId, uint256 _amount)
        ...
        isActive
    {
        uint256 balance = IERC1155(NFTAddress).balanceOf(nftHolder, _nftId);

        require(balance >= _amount, "Balance for the required NFT is less than amount you want to buy !!!");
