...
contract DSArt is ERC1155, Ownable {
    // Contract name
    string public name = "DS of Art";
    uint256[] supplies = [1];
    uint256[] minted = [0];
    constructor() ERC1155("https://ipfs.moralis.io:2053/ipfs/QmVftKRUA7C6pRSsmbu6NoGXG2WmTN9gD6Z8waN4hV9DRG/") {}
