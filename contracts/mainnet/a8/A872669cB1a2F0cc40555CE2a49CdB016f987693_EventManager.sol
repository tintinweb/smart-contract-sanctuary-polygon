...
contract EventManager is Ownable {
    ...
    function registerFighter(uint256 eventId, uint256 luchadorId) external {
        ...
        IFight(eventContracts[eventId]).registerFighter(eventIndex, luchadorId, price, msg.sender);
    }
}
...
interface IFight {
    ...
    function registerFighter(uint256 eventIndex, uint256 luchadorId, uint256 pricePaid, address payee) external;
