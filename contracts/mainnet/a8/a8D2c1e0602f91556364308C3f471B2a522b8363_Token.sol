    ...
    BasicMetaTransaction
{
    ...
    function mintNewPropertyToken(
        ...
        _mint(_propOwnerAddress, _estateId, _amount, "");
    }
    ...
    function updateTokenURI(uint256 _estateId, string memory __uri)
        external
        onlyOwner
    {
        require(bytes(__uri).length > 0, "URI not found");
    ...
    */
    ...
    function setDoc1(uint256 _tokenID, string calldata doc1)
        external
        onlyOwner
    {
        docs[_tokenID].doc1 = doc1;
    ...
    function setDoc2(uint256 _tokenID, string calldata doc2)
        external
        onlyOwner
    {
        docs[_tokenID].doc2 = doc2;
    ...
    function setDoc3(uint256 _tokenID, string calldata doc3)
        external
        onlyOwner
    {
        docs[_tokenID].doc3 = doc3;
    ...
    function setDoc4(uint256 _tokenID, string calldata doc4)
        external
        onlyOwner
    {
        docs[_tokenID].doc4 = doc4;
    ...
    function setAdmins(address _admin1, address _admin2) external onlyOwner {
        require(
            _admin1 != address(0) && _admin2 != address(0),
            "admin address cannot be a 0 address"
        );
        admin1 = _admin1;
        admin2 = _admin2;
    }
