...
contract FairxyzGifts is UUPSUpgradeable, ERC1155Upgradeable {
    ...
    function airdrop(address recipient, uint256 tokenId, uint256 amount) external onlyAdmin {
    ...
    function gift(address recipient) external {
        ...
        require(balance > 0, "Sender does not have any token ID 0");
