...
contract AaveHandler is IDepositExecute, HandlerHelpers, UpgradableOwnable, ERC20Safe {
    ...
    function executeProposal(
        ...
        approveERC20(tokenAddress, AAVE_POLYGON_LP_ADDR, amount);
        address aTokenAddress = ILendingPool(AAVE_POLYGON_LP_ADDR).getReserveData(tokenAddress).aTokenAddress;
        uint256 oldBalance = IAToken(aTokenAddress).scaledBalanceOf(amTokenHandler);
        ILendingPool(AAVE_POLYGON_LP_ADDR).deposit(tokenAddress, amount, amTokenHandler, 0x0);
