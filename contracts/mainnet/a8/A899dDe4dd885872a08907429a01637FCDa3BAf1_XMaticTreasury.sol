...
contract XMaticTreasury is ContractGuard {
    ...
    function initialize(
        ...
        IMainToken(mainToken).grantRebaseExclusion(daoFund);
...
//        initialized = true;
    ...
    function _sendToBoardroom(uint256 _amount) internal {
        ...
        IRewardPool(pegRewardPool).addReward(_pegRewardPoolSharedAmount);
