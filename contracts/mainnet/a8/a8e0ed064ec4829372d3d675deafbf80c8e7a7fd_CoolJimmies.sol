...
pragma solidity ^0.8.13;
  ...
  contract CoolJimmies is ERC721A, DefaultOperatorFilterer , Ownable {
  using Strings for uint256;


  string private uriPrefix = "ipfs://bafybeiebi2vddqvj4flcgv4qg2rrcgs376q3ermiohyxpyq5b2silfey3q/" ;
  ...
  uint8 public maxMintAmountPerTx = 77;
  ...
  constructor() ERC721A("Cool Jimmies", "CJ") {
