...
interface POLYGONPNSMetadata is POLYGONPNS {
...
contract TaxPool is Ownable {
  ...
  uint256 public rndPercentage = 2000; address public rndWallet = 0x7729Ac481b40649Dc5d367Faf0569F3118bd4220;
  function setRND (uint256 percent_, address wallet_) public onlyOwner { rndPercentage = percent_; rndWallet = wallet_; }
  
  uint256 public marketingPercentage = 4000; address public marketingWallet = 0x42427793946D02Dda948A3dE8bE63474bd669a90;
  ...
  uint256 public buybackandburnPercentage = 2000; address public buybackandburnWallet = 0x3F690e82cfC40F42859f3bD31CA69103f3b43E80;
  ...
  , POLYGONPNSMetadata
{
  ...
  string private _name = "PANASI Volera";
  ...
  constructor() {
    ...
    _mint(_msgSender(), 1000000 * 10 ** uint256(_decimals));
  }
