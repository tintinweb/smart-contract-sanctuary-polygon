...
contract NFTToken is ERC721Full, Governance {
    ...
    constructor() public ERC721Full("Yuanhuashe00117", "YHS00117") {
     ...
     */
    function mint(address to, uint256 tokenId) external onlyGovernance  returns (bool) {
        _mint(to, tokenId);
     ...
     * @return A boolean that indicates if the operation was successful.
     */
    function safeMint(address to, uint256 tokenId) public onlyGovernance  returns (bool) {
        _safeMint(to, tokenId);
        _setTokenURI(tokenId, MathwalletUtil.uintToString(tokenId));
        return true;
    }
