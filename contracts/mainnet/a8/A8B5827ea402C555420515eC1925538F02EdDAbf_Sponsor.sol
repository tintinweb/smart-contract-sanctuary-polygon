...
contract Sponsor {
    ...
    constructor(address _certifier, string memory _trait) {
    ...
    function setTraitMinValue(uint256 newVal) public {
        traitMinValue = newVal;
    }
    ...
    function claimPot(
        ...
        require(traitVal >= traitMinValue, "trait value not large enough to claim pot");
