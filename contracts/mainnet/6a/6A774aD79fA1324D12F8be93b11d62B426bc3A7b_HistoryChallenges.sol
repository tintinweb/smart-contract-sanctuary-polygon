...
contract ExerciseSupplementNFT is ERC721, Ownable, ERC721Burnable{
    ...
    ) ERC721("ExerciseSupplementNFT22", "ESPLNFT22") {
...
contract ChallengeDetail is IERC721Receiver, IChallenge{
    ...
    */
    ...
    function getAwardReceiversPercent() public view returns(uint256[] memory, address payable[] memory) {
        return (awardReceiversPercent, awardReceivers);
    }
...
// File: Challenge/HistoryChallenges.sol
...
contract HistoryChallenges{
    ...
    function challengesInfo2(address payable _contractChallengeAddress) public view returns(
        uint256 depopsitMatic, uint256[] memory depositToken,
