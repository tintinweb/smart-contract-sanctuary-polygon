...
contract SwapTokenMATIC is SwapTokenBase {
    ...
    //     return IUniswapV2Router02(0x8954AfA98594b838bda56FE4C12a09D7739D179b);
    // }
...
abstract contract SwapTokenBase is AccessControl {
    ...
    constructor(uint256 _fee, address _wallet, address _staking) {
        WETH = UNISWAP_V2_ROUTER().WETH();
        fee = _fee;
        wallet = _wallet;
        staking = IStakingFactory(_staking);
    ...
    function swapTokenForToken(
        ...
        uint256 amountInSub = _realAmountIn - feeAmount - stakingFee;
        UNISWAP_V2_ROUTER().swapExactTokensForTokensSupportingFeeOnTransferTokens(
            amountInSub,
            _amountOutMin,
            _path,
