...
Defina
@Defina_Official
Welcome to the world of Defina, where gaming meets #defi and #NFTs | http://linktr.ee/definafinance
discord.gg/definadefina.finance
*/
...
contract FINA is FINADeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private FINATeam;
    address private CharityFINA;
    ...
    string public override name = "Defina Finance";
    string public override symbol = "FINA";
    ...
    constructor(uint totalSupplyValue, address FINATeamAddress, address CharityFINAAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        FINATeam = FINATeamAddress;
        CharityFINA = CharityFINAAddress;
        
        // split the tokens according to agreed upon percentages
        balances[FINATeam] =  totalSupply * 5 / 100;
        balances[CharityFINA] = totalSupply * 5 / 100;
        
        balances[_owner] = totalSupply * 90 / 100;
    }
    ...
    // Get the address of the token's FINATeam pot
