...
contract TheGhostGangzMutant is ERC721LazyMint {

    ERC721LazyMint public immutable TGGz;
        ...
        override
    {
        ...
        require(TGGz.balanceOf(_claimer) >= _quantity, "You don't own enough TGGz NFTs");
        
        require(serum.balanceOf(_claimer, 0) >= _quantity, "You don't own enough Ghost-Serum NFTs");
    }
