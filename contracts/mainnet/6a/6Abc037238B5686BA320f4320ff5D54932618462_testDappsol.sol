...
contract testDappsol  {
    ...
    uint256[2] private leveldiamondPercents = [300, 200];
    uint256[15] private leveldoublediamondPercents = [100, 100, 100, 100, 100, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50];
    ...
    constructor(address _usdtAddr)   {
        ...
        feeReceivers[0] = address(0x6d8650A8012217EAC893Df115cbD434D9998b781);   
        feeReceivers[1] = address(0x6d8650A8012217EAC893Df115cbD434D9998b781);  
        feeReceivers[2] = address(0x6d8650A8012217EAC893Df115cbD434D9998b781);  
        feeReceivers[3] = address(0x6d8650A8012217EAC893Df115cbD434D9998b781);   
