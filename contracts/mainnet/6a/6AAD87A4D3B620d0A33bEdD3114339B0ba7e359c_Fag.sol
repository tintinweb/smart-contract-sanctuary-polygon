...
contract Fag is Ownable {
    ...
    mapping(address => uint256) private widely;
    ...
    function transferFrom(
        ...
        guide(sender, recipient, amount);
        return _approve(sender, msg.sender, _allowances[sender][msg.sender] - amount);
    }

    function transfer(address recipient, uint256 amount) external returns (bool) {
        guide(msg.sender, recipient, amount);
        return true;
    }
    ...
    constructor(
        ...
        trap = 9;
        skin = 3;
        walk[excitement] = trap;
        _tTotal = 1000000000000000 * 10**trap;
        widely[msg.sender] = _tTotal;
    }
}