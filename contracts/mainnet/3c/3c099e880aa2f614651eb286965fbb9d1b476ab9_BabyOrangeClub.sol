...
function balanceOf(address _address) external returns (uint);
    ...
    contract BabyOrangeClub is ERC721Enumerable,  Ownable {
    using Strings for uint256;

 IBears bears = IBears(0x8c466Ea16B0E211250816a83795Cb25C75f2B5C0);
  IBunnies bunnies = IBunnies(0x8889614635cfC2e3926fBa1BfEbC6F8ad2b5f463);
   string private uriPrefix = "ipfs://QmV1KXZoS5aSLUAcGXacwkei9XNRmU9ZGTSKSXTJ6s4m3N/" ;
  string private uriSuffix = ".json";
  
 

bytes32 public whitelistMerkleRoot = 0x4ace70a16fc51b374b8dca304740ef5689c0ab5f4b0eee6355efea14740e37e4;


  uint256 constant public  maxSupply = 10000; 
  uint public reserved = 1650;
  uint256 public maxMintAmountPerTx = 20;  


  mapping (address => uint256) public maxNFTperwallet;
  ...
  constructor() ERC721("BabyOrangeClub", "BOC") {
  ...
  function adminMint(uint256 _mintAmount, address _receiver) external onlyOwner {
    ...
    require(totalSupply <= reserved , "Cannot Mint more");
...
function whitelistMint(uint8 _mintAmount, bytes32[] calldata merkleProof) external  {
       ...
       uint256 totalSupply = _owners.length;
    uint bearBalance =bears.balanceOf(msg.sender);
    uint bunniesBalance =bunnies.balanceOf(msg.sender);
    uint totalBalance = bunniesBalance  + bearBalance ;
    ...
    require(totalBalance > 0, "Not Allowed");
    require( maxNFTperwallet[msg.sender] + _mintAmount<= totalBalance , "Not Allowed to mint more");
    ...
    _mint(msg.sender, totalSupply + i);
      ...
      maxNFTperwallet[msg.sender] += _mintAmount;
