...
contract PokerClub {
    ...
    mapping(uint256 => uint256) private registered;
    ...
    function mint(uint256 tokenId) public onlyHolder notPaused {
        ...
        require(registered[tokenId] == 0, "Token already registered");
        require(
    ...
    function isRegistered(uint256 tokenId) public view returns (uint256) {
