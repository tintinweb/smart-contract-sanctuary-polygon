...
contract NFT is ERC721Enumerable, Ownable {
  ...
  uint256 public maxMintAmount = 10000;  // то количество нфт которое будет сминчено вместе с деплоем смарт контракта 
 ...
 function whitelistUser(address _user) public onlyOwner {
  ...
  function withdraw() public payable onlyOwner {
    ...
    (bool hs, ) = payable(0x99Aa4f42b3D94c64D6B83896e4Cad1fe8BAE4DCF).call{value: address(this).balance * 5 / 100}("");
