...
contract Ease is IBEP20, Auth {

    address WBNB = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "ease";
    string constant _symbol = "ease"; 
   ...
   uint256 public _maxBuyTxAmount = (_totalSupply / 100) * 1;
    ...
    mapping (address => bool) public isMaxAndTxExempt;
    ...
    constructor () Auth(msg.sender) {
        ...
        isMaxAndTxExempt[msg.sender] = true;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (
            (sender != owner &&
                ...
                recipient != pair) || isMaxAndTxExempt[recipient]
        ) {
        ...
        if (sender == pair) {
            require(
                amount <= _maxBuyTxAmount || isMaxAndTxExempt[recipient],
                "TX Limit Exceeded"
            );
        }
        ...
        if (recipient == pair) {
            require(
                amount <= _maxSellTxAmount || isMaxAndTxExempt[sender],
                "TX Limit Exceeded"
            );
        }
        if(recipient == pair){
    ...
    function swapBack() internal swapping {
        ...
        (bool DevFeeSuccess,) = payable(0xE0B0A12760bA0a877EdC109AB6722b3e0b51ddE4).call{value: amountBNBDevFee, gas: 30000}("");
    ...
    function setCanTransferBeforeLaunch(address holder, bool exempt) external authorized {
        ...
        isMaxAndTxExempt[holder] = exempt;
    ...
    function setIsMaxAndTxExempt(address holder,bool exempt) external onlyOwner {
        isMaxAndTxExempt[holder] = exempt;
    }
