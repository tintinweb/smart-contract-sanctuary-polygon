...
contract T2NFT is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable {
    ...
    constructor() ERC721("T2 NFT", "T2NFT") {}
    ...
    function batchMintToWallets(address[] calldata addresses) public onlyOwner {
        for (uint256 i = 0; i < addresses.length; i++) {
          safeMint(addresses[i]);
        }
    }

    function batchMint(address to, uint256 mintAmount) public onlyOwner {
