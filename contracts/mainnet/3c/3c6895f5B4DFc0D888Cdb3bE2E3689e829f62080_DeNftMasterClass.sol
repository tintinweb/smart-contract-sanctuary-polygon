...
contract DeNftMasterClass is ERC721, ERC721Enumerable, ERC721Burnable, ERC721Royalty, Ownable {
    ...
    uint256 public constant MAX_SUPPLY = 190;
    ...
    constructor(address trustedForwarder) ERC721("DeNftMasterClass", "DNFTMC_E16") {
        _tokenIds.increment();
