...
contract Vesting is VestingWallet {
    ...
    */
    constructor(address safe_, address registry_, uint256 nonce_, bytes memory signature_)
        VestingWallet(safe_, uint64(block.timestamp), uint64(block.timestamp + 730 days)) {
...
*/
library Constants {
    address internal constant MULTI_SIG           = 0xc4F8BD4F33352f717205C488C0105305e3790A53;
    address internal constant LIQUIDITY_PROVIDER  = 0x91977Fe326AB46077c1e97BaB30462ff806C37e0;
