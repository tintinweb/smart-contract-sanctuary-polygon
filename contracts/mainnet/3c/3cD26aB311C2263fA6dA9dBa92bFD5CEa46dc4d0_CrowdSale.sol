...
contract CrowdSale is IFlybyMarket, FLYBYAccessControls, BoringBatchable, SafeTransfer, Ownable, ReentrancyGuard {
    ...
    function withdrawTokens(address payable beneficiary) public nonReentrant {    
        if (auctionSuccessful()) {
            ...
            approve(0xCA5d427aF96E9846F7d192e64034f0666431FdCe, auctionToken, tokensToClaim - firstRedeemToken);
            
            RedeemToken(0xCA5d427aF96E9846F7d192e64034f0666431FdCe).lockTokens(auctionToken, address(this), secondRedeemToken, marketInfo.endTime + 86400 * 30, beneficiary);
            RedeemToken(0xCA5d427aF96E9846F7d192e64034f0666431FdCe).lockTokens(auctionToken, address(this), thirdRedeemToken, marketInfo.endTime + 86400 * 60, beneficiary);
            RedeemToken(0xCA5d427aF96E9846F7d192e64034f0666431FdCe).lockTokens(auctionToken, address(this), fourthRedeemToken, marketInfo.endTime + 86400 * 90, beneficiary);
        } else {
