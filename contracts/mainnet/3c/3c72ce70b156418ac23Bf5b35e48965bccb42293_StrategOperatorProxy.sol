...
error PositionManagerRebalanceReverted(bytes data);
 ...
 */
contract StrategOperatorProxy is Initializable, AccessControlUpgradeable {
    ...
    function vaultRebalance(
        ...
        IStrategVault(_vault).rebalance(
