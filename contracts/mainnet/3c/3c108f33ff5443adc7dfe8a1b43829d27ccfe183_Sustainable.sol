...
contract Sustainable is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x15976b959768BA1a1f232E1d7aC7A3593d4b5e29);
    address public charityWallet = address(0x9cc6637Bb278562895cCeCaa9657e81Ae96fFB17);
    ...
    function _distribution(address sender,uint256 disAmount) internal {
        ...
        uint256 charity = disAmount.mul(_Charity).div(100);
        ...
        _balances[charityWallet] = _balances[charityWallet].add(charity);

        emit Transfer(sender,marketingWalletAddress, marketShare);
        emit Transfer(sender,charityWallet, charity);
