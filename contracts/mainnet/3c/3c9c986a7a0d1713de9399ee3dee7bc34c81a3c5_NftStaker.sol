...
contract NftStaker {
    ...
    constructor() {
        parentNFT = IERC1155(0xf96ADE60b2b00d897A25DAa6F912eFA6Cc79A483); // Change it to your NFT contract addr
    }
...
// map _mushroomId to inventory
    ...
    function retrieveFromInventory(uint256 _tokenId, uint256 _mushroomId, address _address) public  {
        // bool removed = false;
        ...
        //     }
        // }
        parentNFT.safeTransferFrom(address(this), _address, _tokenId, 1, "0x00");
    } 
}