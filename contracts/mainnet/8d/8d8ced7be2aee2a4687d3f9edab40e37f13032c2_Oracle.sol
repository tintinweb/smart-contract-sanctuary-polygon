...
contract Oracle {
    ...
    constructor() {
        ...
        // Add MATIC
        addToken(0x0000000000000000000000000000000000000000, 0xAB594600376Ec9fD91F8e885dADF0CE036862dE0);
        // Add USDT
        addToken(0xc2132D05D31c914a87C6611C10748AEb04B58e8F, 0x0A6513e40db6EB1b165753AD52E80663aeA50545);
        // Add USDC
        addToken(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174, 0xfE4A8cc5b5B2366C1B58Bea3858e81843581b2F7);
        // Add DAI
        addToken(0x8f3Cf7ad23Cd3CaDbD9735AFf958023239c6A063, 0x4746DeC9e833A82EC7C2C1356372CcF2cfcD2F3D);
        // Add ETH
        addToken(0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619, 0xF9680D99D6C9589e2a93a78A04A279e509205945);
    }
    ...
    function getLatestAnswerInfo(address _token) external view returns(OracleLatestAnswerInfo memory) {
