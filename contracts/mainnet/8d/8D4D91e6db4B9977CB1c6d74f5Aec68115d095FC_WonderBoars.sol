...
contract WonderBoars is ERC721  {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeiec7325tv7r4y3rkrtrutybqr322n52e7nrgrsvzyngpl273fs2iu/", Strings.toString(tokenId), ".json")
            );
    }
