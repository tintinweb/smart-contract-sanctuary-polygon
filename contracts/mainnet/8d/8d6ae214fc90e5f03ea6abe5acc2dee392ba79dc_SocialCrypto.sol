...
contract SocialCrypto is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    uint256 private constant BURN_FEE_PERCENT = 1;
    uint256 private constant TRANSACTION_TAX_PERCENT = 3;
    address private taxReceiveAddress;
    ...
    function initialize() initializer public {
        __ERC20_init("Social Crypto", "SCPT");
        ...
        taxReceiveAddress = owner();
    }

    function setTaxReceiveAddress(address _taxReceiveAddress) public onlyOwner {
    ...
    function _burn(address account, uint256 amount) internal override {
        ...
        uint256 burnAmount = amount - burnFee;

        super._burn(account, burnAmount);
        super._burn(account, burnFee);
    }

    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        uint256 taxAmount = (amount * TRANSACTION_TAX_PERCENT) / 100;
        uint256 transferAmount = amount - taxAmount;

        super._transfer(sender, recipient, transferAmount);
        super._transfer(sender, taxReceiveAddress, taxAmount);
    }
