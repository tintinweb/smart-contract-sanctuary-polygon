 ...
 * Staking of : Coin METAGPS
 * Coin Address : 0xEA22d7E2010ed681e91D405992Ac69B168cb8028
 * Number of schemes : 1
 ...
 * Notes for _minStakeAmt : 1 Coin METAGPS is represented by 10^18.
*/
 ...
 * ERC20 Transfer : 0xEA22d7E2010ed681e91D405992Ac69B168cb8028, _stakeAmt
...
*/
	function stake(uint256 _stakeAmt) public {
		...
		ERC20(0xEA22d7E2010ed681e91D405992Ac69B168cb8028).transferFrom(msg.sender, address(this), _stakeAmt);
...
*/
	function unstake(uint256 _unstakeAmt) public {
		...
		require((ERC20(0xEA22d7E2010ed681e91D405992Ac69B168cb8028).balanceOf(address(this)) >= (_unstakeAmt + interestToRemove)), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		ERC20(0xEA22d7E2010ed681e91D405992Ac69B168cb8028).transfer(msg.sender, (_unstakeAmt + interestToRemove));
...
*/
	function withdrawInterestWithoutUnstaking(uint256 _withdrawalAmt) external {
		...
		require((ERC20(0xEA22d7E2010ed681e91D405992Ac69B168cb8028).balanceOf(address(this)) >= _withdrawalAmt), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		ERC20(0xEA22d7E2010ed681e91D405992Ac69B168cb8028).transfer(msg.sender, _withdrawalAmt);
