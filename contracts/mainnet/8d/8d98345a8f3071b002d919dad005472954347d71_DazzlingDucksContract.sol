  ...
  abstract contract Allowlist is Ownable {
        ...
        Allowlist
    {
        ...
        constructor(
            ...
            payableAddresses.push(0xA939194D7412cc7d44d54E31607682EC6089FA16);
      ...
      require(mintingOpen == true && onlyAllowlistMode == false, "Public minting is not open right now!");    
        ...
        */
        function mintToMultiple(address _to, uint256 _amount) public payable {
            ...
            require(currentTokenId() + _amount <= SUPPLYCAP, "Cannot mint over supply cap of 2000");
    ...
    // File: contracts/dazzlingDucksContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract DazzlingDucksContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("DazzlingDucks", "DZD", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmXDMJkdEkmwyc7opG1EQn8HmQzb3poi8FtGuG8xJYjQdJ/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/wqN61fFGAwMlIGdrr3nD/contract-metadata";
        }
    }