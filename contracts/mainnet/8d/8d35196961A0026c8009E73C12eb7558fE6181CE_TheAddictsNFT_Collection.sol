...
contract TheAddictsNFT_Collection is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("TheAddicts.NFT", "TAC") {
    setHiddenMetadataUri("ipfs://Qmadyh21TabQyFdGZuGunsWQGEaMyG2dBgxGtC9AzueCxp/hidden.json");
  }
