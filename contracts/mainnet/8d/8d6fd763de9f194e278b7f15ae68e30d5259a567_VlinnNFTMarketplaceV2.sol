...
/// @custom:oz-upgrades-unsafe-allow constructor
    ...
    function buyNFT(
        ...
        //if(royaltyFeePercent > 0){
            uint256 royaltyFee = calculateCustomFee(listedNft.price, 1000);
            payable(0xe761b8eeAE2485db415D81EbEd7Fd48b22619604).transfer(royaltyFee);
            totalPrice -= royaltyFee;
        //}

        // Transfer to nft seller
