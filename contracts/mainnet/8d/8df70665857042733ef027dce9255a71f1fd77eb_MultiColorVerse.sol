...
contract MultiColorVerse is ERC721  {
    uint256 public totalSupply;
    uint256 public cost = 0 ether;
    uint256 public maxMints = 200;
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeib7avi3uvhqxw6xwmoqlavfyrmzpwpogrn7eickvtvohlr3g32jny/", Strings.toString(tokenId), ".json")
            );
    }
