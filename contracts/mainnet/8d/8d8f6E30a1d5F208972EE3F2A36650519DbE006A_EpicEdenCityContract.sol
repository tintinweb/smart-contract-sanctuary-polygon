...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x29192a8923CaB74570d3502b71B47d2b38691C5e];
...
// File: contracts/EpicEdenCityContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract EpicEdenCityContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Epic Eden City";
    string public symbol = "EEC1";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/YfA4nq0uFwuF6MEuoIAv/contract-metadata";
  }
