...
interface IERC721Mintable is IERC721, IERC2981 {
    ...
    function brokerage() external view returns (uint256);
    ...
    ReentrancyGuardUpgradeable
{
    ...
    function auctions(address _erc721, uint256 _tokenId)
        public
        view
        returns (auction memory auctionList)
    {
        ...
        if (
            ...
            auctionList = _auctions[_erc721][_tokenId]; 
    ...
    function setWETH(address _WETH) external onlyOwner {
        require(
            _WETH != address(0),
            "ERC721MarketPlace: WETH can't be null address"
        );
        WETH = _WETH;
    }
       ...
       // nonReentrant
    {
        ...
        // Transfer the funds for ERC20 token
            ...
            erc20Token.transferFrom(msg.sender, address(this), _auction.startingPrice);
