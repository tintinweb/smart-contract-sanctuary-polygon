...
contract MBGTokensV2 is ERC20, Pausable, AccessControl {
    using SafeMath for uint256;
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant BURNER_ROLE = keccak256("BURNER_ROLE");
    constructor() ERC20("MetaBadge Tokens", "MBG") {
...
contract MBStaking is Ownable, IERC721Receiver {
    ...
    constructor(ERC721Enumerable _nft, MBGTokensV2 _token) {
        nft = _nft;
        token = _token;
    }

     //Return reward of Tier1 NFT.
    function getTier1Reward() public view returns(uint256){
        return tier1Reward;
    }

    //Return reward of Tier2 NFT.
    function getTier2Reward() public view returns(uint256){
        return tier2Reward;
    }

    //Change reward of Tier 1 NFT
    function changeRewardTier1(uint256 newPrice) public onlyOwner {
        tier1Reward = newPrice;
    } 

    //Change reward of Tier 2 NFT
    function changeRewardTier2(uint256 newPrice) public onlyOwner {
        tier2Reward = newPrice;
    }
