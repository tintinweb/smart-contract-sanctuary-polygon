...
contract MonsterVerse is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("Monster Verse", "MVS") {
  ...
  function mint() public payable nonReentrant {
    ...
    require(msg.value >= PRICE, "Insufficient payment, 0.09 ETH per item");
  ...
  string private customContractURI =
    "ipfs://QmUrrdeQ5U7Z6wcEgVKkCB65pNR7MX2zcdpPP4JjVncc1b/";
  ...
  address private constant payoutAddress1 =
    0xBfe99804eeda860ab8a0F080aed9C0a99d8B9fA9;
