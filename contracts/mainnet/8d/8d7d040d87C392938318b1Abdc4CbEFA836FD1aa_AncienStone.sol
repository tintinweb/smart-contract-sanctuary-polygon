...
contract AncienStone is ERC20, EIP712, Ownable {
    ...
    string public SIGNING_DOMAIN_NAME = "AncienStone";
    ...
    constructor() ERC20("AncienStone", "ANCIENSTONE") EIP712(SIGNING_DOMAIN_NAME, SIGNING_DOMAIN_VERSION){
        isMintOpen = true;
        isBurnOpen = true;
    }
