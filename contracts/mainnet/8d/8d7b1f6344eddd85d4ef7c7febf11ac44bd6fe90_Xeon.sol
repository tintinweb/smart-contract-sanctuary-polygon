...
contract Xeon is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20FlashMint {
    constructor() ERC20("Xeon", "XEON") ERC20Permit("Xeon") {
        _mint(msg.sender, 99999999999999999999999999999999999999999999999999999999999*10**18);
    }
