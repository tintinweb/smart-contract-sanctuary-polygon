...
contract FloorHalloweenCandy is
    ERC721A,
    Ownable,
    Administrable,
    ERC721AQueryable
{
    ...
    mapping(uint256 => string) private _candyNames;
    mapping(uint256 => string) private _candyRarity;
    mapping(uint256 => string) private _candyEntries;
    ...
    constructor(
        ...
        imageExtension = ".jpg";
        externalUrl = "https://www.floornfts.io";
        tokenDescription = "Spooky Description";
        tokenName = "Floor Spooky Candy";

        _candyNames[0] = "Intentionally Left Blank";
        _candyNames[1] = "Floor Bar";
        _candyNames[2] = "Rare Hots";
        _candyNames[3] = "Degen Dots";
        _candyNames[4] = "Air Drop Heads";
        _candyNames[5] = "NFT Stoppers";
        _candyNames[6] = "Solana Sours";
        _candyNames[7] = "ETH Jellys";
        _candyNames[8] = "Gummy Bear";
        _candyNames[9] = "Missed Out Mints";

        _candyRarity[0] = "Super Rare, as this should not have been minted";
        _candyRarity[1] = "Rare";
        _candyRarity[2] = "Rare";
        _candyRarity[3] = "Rare";
        _candyRarity[4] = "Uncommon";
        _candyRarity[5] = "Uncommon";
        _candyRarity[6] = "Uncommon";
        _candyRarity[7] = "Common";
        _candyRarity[8] = "Common";
        _candyRarity[9] = "Common";
    ...
    function airdrop(address _recipient, uint256 _candyId)
        external
        onlyOperatorsAndOwner
    {
        uint256 tokenId = _nextTokenId();
        TokenData memory tokenData = TokenData(uint8(_candyId));

        _mint(_recipient, 1);
        _tokenData[tokenId] = tokenData;
    }

    function airdropMultiple(address _recipient, uint256[] memory _candyIds)
        external
        onlyOperatorsAndOwner
    {
        uint256 tokenId;
        ...
        for (uint256 i = 0; i < _candyIds.length; i++) {
            tokenId = _nextTokenId();
            tokenData = TokenData(uint8(_candyIds[i]));
    ...
    function setImageExtension(string memory _imageExtension)
        external
        onlyOwner
    {
    ...
    function setTokenDescription(string memory _tokenDescription)
        external
        onlyOwner
    {
        ...
        returns (string memory)
    {
        ...
        attributes = string(
            abi.encodePacked(
                '[ { "trait_type": "Candy", "value": "',
                _candyNames[tokenData.candyType],
                '"}, { "trait_type": "Rarity", "value": "',
                _candyRarity[tokenData.candyType],
                '"}, { "trait_type": "Entries", "value": "',
                _candyEntries[tokenData.candyType],
                '"} ]'
            )
        );
    ...
    function _imageURI(uint256 _tokenId) internal view returns (string memory) {
        ...
        uri = string.concat(
            baseImageURI,
            Utils.uintToString(tokenData.candyType),
            imageExtension,
            "?tokenId=",
            Utils.uintToString(_tokenId)
        );
    ...
    function supportsInterface(bytes4 interfaceId)
        public
        view
        override(IERC721A, ERC721A, AccessControlEnumerable)
        returns (bool)
    {
