...
contract PorkiGenesisNFT is ERC721A, Ownable {
    using Strings for uint256;
    using ECDSA for bytes32;

    string public baseURI = "ipfs://Qman7Nm1KJ7brtGsKkf4FPT6XYvZeh5VarkRCG8QY1AqCD/";
    ...
    address public FOUNDER_ADD = 0x25972e34E03B28e18fcFd938Edf785B76A948441;

    constructor() ERC721A("Porki Genesis NFT", "PGN") {}
    ...
    // public
    function mint(uint256 _mintAmt) external payable{
    ...
    function withdraw() public payable onlyOwner {
        ...
        payable(FOUNDER_ADD).transfer(finalFunds);
    }
}