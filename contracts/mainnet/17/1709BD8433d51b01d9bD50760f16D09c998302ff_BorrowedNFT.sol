...
interface IRentalProtocol {
     ...
     * @param nftSettings details about each NFT included in the rental offer
     ...
     * @param basisPoints percentage of rewards for this user, in basis points format
     ...
     */
    function setFeesBasisPoints(uint64 basisPoints) external;
}
