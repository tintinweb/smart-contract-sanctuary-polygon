...
contract SiloFactoryUIHelper is Ownable{
    ...
    function viewSiloStrategyMetaData(uint siloID) external view returns(string memory, uint, string memory, uint, address[] memory actions, bytes[] memory configData, string[4] memory){
