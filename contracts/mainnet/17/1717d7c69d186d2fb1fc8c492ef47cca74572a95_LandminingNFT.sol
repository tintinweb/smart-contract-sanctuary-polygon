...
uint256 constant public INVEST_MIN_AMOUNT = 5 ether; 
	...
	uint256 constant public LANDTITLE_FEE = 20;
	uint256 constant public LANDTAX_FEE = 20;
	...
	constructor(address payable wallet, address payable _permit, address payable _allocation, address payable _title,  address payable _tax) public {
