...
contract SingleNativeOPool is NativeOPool {
    ...
    function withdrawFee(address _user) external payable onlyRouter {
        ...
        if(userInfo[_user].totalFTpoint > 0){
          ...
          uint256 _totalStakeFTpoint = (_totalStakeFTfee * totalFTpoint) / (totalFTpoint + _totalStakeFTfee);
        ...
        if(userInfo[_user].totalNFTpoint > 0){
          ...
          uint256 _totalStakeNFTpoint = (_totalStakeNFTfee * totalNFTpoint) / (totalNFTpoint + _totalStakeNFTfee);
