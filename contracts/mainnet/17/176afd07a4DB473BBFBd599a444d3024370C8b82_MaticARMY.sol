...
/**
 *Submitted for verification at polygonscan.com on 2022-9-2
*/
...
contract MaticARMY{
    ...
    uint256 public EGGS_TO_HATCH_1MINERS=432000;// 20percent daily
    uint256 PSN=10000;
    uint256 PSNH=5000;
    ...
    function claimArmy(address to) external {
        require(msg.sender == ceoAddress, 'invalid call');
