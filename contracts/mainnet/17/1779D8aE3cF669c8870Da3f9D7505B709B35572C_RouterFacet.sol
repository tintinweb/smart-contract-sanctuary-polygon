...
import {DataTransferInArgs, DataTransferInProtocol, DataTransferOutArgs, LibDataTransfer, TransferKey, DataTransferType} from "../data-transfer/LibDataTransfer.sol";
import "../libraries/LibError.sol";
...
library LibAggregator {
    ...
    function simulateSwap(SwapArgs memory swapArgs) internal returns (uint256 amountOut) {
        ...
        s.depositsByUser[toAssetAddress][msg.sender] += amountOut;
