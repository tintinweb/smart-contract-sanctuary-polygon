    ...
    ERC721ABurnableUpgradeable
{
    ...
    event ClaimNFT(address spenderAddress, uint256 id, uint256 tokenId);

    function initialize(
        address _cotAddress
    ) public initializerERC721A initializer {
        __ERC721A_init("CurecosCosplayNFT", "CCN");
    ...
    function claimNFT(
        ...
        _mint(_spenderAddress, 1);
        
        emit ClaimNFT(_spenderAddress, _id, tokenId);
    }
    ...
    function exchangeNFT(
        ...
        require(
            _receiverAddresses.length == _cotAmounts.length &&
                _cotAmounts.length == _ids.length,
        ...
        // transfer COT from spender
        _mint(_spenderAddress, _cotAmounts.length);
