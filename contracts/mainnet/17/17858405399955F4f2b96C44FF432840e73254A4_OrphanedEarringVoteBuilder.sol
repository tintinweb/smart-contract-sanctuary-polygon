 ...
 * Orphaned Earring Voting
 * You are entitled to one vote for each Voting NFT purchased. Vote for
 * your friend or the story you want to support.

 * In addition to your vote, you will become a member of the Orphaned
 * Earring Society and receive exclusive community privileges.
 * [Learn more](https://orphanedearringsociety.com/product/orphaned-earring-story/).
 */
contract OrphanedEarringVoteBuilder is SimpleDynamicBuilder {
    ...
    function _initDefaults() internal override {
        ...
        setAttributes('[{"trait_type":"Type","Value":"Voting"}]');
        setDesc(
            "Submit your Orphaned Earring story: "
            "https://orphanedearringsociety.com/nominate/"
            "\\n\\n"
