...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xd7423532c1776c0e010f8cA9a2D599ee688cfEF3];
  address public erc20Payable = 0xd7423532c1776c0e010f8cA9a2D599ee688cfEF3;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 2589) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeifrujs4cwwfdwv2vrrzo3ljzxzlp3fa2g5i6cm4kojimcebl7tqoq/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/hVasHb00O1OJ9pP4l5kE/contract-metadata";
  }
...
// File: contracts/MilkCloudsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MilkCloudsContract is ERC721APlus {
    constructor() ERC721APlus("Milk Clouds", "MCLD"){}
}
