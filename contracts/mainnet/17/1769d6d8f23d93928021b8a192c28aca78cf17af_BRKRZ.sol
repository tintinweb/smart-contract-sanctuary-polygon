...
contract BRKRZ is BRKRZDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private BRKRZTeam;
    address private CharityBRKRZ;
    ...
    string public override name = "0xBROKERZ";
    string public override symbol = "BRKRZ";
    ...
    constructor(uint totalSupplyValue, address BRKRZTeamAddress, address CharityBRKRZAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        BRKRZTeam = BRKRZTeamAddress;
        CharityBRKRZ = CharityBRKRZAddress;
        
        // split the tokens according to agreed upon percentages
        balances[BRKRZTeam] =  totalSupply * 4 / 100;
        balances[CharityBRKRZ] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's BRKRZTeam pot
