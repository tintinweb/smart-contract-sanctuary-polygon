...
// File: contracts/CasaClub.sol

pragma solidity ^0.8.14;

contract CasaClub is ERC721A, Ownable {
    using Strings for uint256;

    uint256 public constant RESERVED_TOKENS = 0;
    uint256 public constant FOR_SALE_TOKENS = 10000 - RESERVED_TOKENS;
    address public constant RESERVED_TOKENS_ADDRESS = 0x1a8CE46662b41e3F7761c6865CB614415d61EcE5;
    ...
    uint256 public currentStageSupplyLimit = 50;

    mapping(address => bool) public whitelisted;

    string public tokenBaseURI = "ipfs://QmWYwrv6ZSzbVcBkVChV7NyaC8D1k1DA1LpgpyJM7EwdgT/";

    uint256 public soldAmount = 0;
    mapping(address => uint256) public purchased;

    constructor() ERC721A("Casa Club", "CASACLUB") {
    ...
    function setCurrentStageSupplyLimit(uint256 val) external onlyOwner {
        currentStageSupplyLimit = val;
    }
    ...
    function getMaxTokensAllowed(address target) public view returns (uint256) {
        ...
        uint256 currentStageTokensLeft = safeSub(currentStageSupplyLimit, soldAmount);
        maxAllowedTokens = min(maxAllowedTokens, currentStageTokensLeft);
        ...
        if(currentStage == STAGE_PRESALE && !whitelisted[target]){
            maxAllowedTokens = 0;
        }
    ...
    function getContractInfo(address target) external view returns (
        ...
        _currentStageSupplyLimit = currentStageSupplyLimit;
