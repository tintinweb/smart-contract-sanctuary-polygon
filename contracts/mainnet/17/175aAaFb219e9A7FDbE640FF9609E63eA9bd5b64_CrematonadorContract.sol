...
//   6MMMMb/                                                                                 `MM                  
//  8P    YM                                           /                                      MM                  
// 6M      Y ___  __   ____  ___  __    __      ___   /M      _____  ___  __      ___     ____MM   _____  ___  __ 
// MM        `MM 6MM  6MMMMb `MM 6MMb  6MMb   6MMMMb /MMMMM  6MMMMMb `MM 6MMb   6MMMMb   6MMMMMM  6MMMMMb `MM 6MM 
// MM         MM69 " 6M'  `Mb MM69 `MM69 `Mb 8M'  `Mb MM    6M'   `Mb MMM9 `Mb 8M'  `Mb 6M'  `MM 6M'   `Mb MM69 " 
// MM         MM'    MM    MM MM'   MM'   MM     ,oMM MM    MM     MM MM'   MM     ,oMM MM    MM MM     MM MM'    
// MM         MM     MMMMMMMM MM    MM    MM ,6MM9'MM MM    MM     MM MM    MM ,6MM9'MM MM    MM MM     MM MM     
// YM      6  MM     MM       MM    MM    MM MM'   MM MM    MM     MM MM    MM MM'   MM MM    MM MM     MM MM     
//  8b    d9  MM     YM    d9 MM    MM    MM MM.  ,MM YM.  ,YM.   ,M9 MM    MM MM.  ,MM YM.  ,MM YM.   ,M9 MM     
//   YMMMM9  _MM_     YMMMM9 _MM_  _MM_  _MM_`YMMM9'Yb.YMMM9 YMMMMM9 _MM_  _MM_`YMMM9'Yb.YMMMMMM_ YMMMMM9 _MM_    
//                                                                                                                
//                                                                                                                
//                                                                                                                
//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0xd0343cF182A90565d5D11d58B759fa04261b34A2];
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 20000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeihkz23s67az22u6cpghqcku7qnribngpwjgjv52hfyscsci2oo3tm/";
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 20000");
...
// File: contracts/CrematonadorContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CrematonadorContract is RamppERC721A {
    constructor() RamppERC721A("Crematonador", "CRMT"){}
}
