...
contract ILProtectionConfig is ILProtectionConfigInterface, BaseController {
  ...
  uint16 public override minILProtectedPercentage;
  uint16 public override maxILProtectedPercentage;
  uint16 public override expectedLPTokensValueGrowth;
  bool public override buyILProtectionEnabled;
  uint16 public override feePercentage;
  uint256[] public policyPeriods;

  function initialize(
    address _owner,
    uint16 _minILProtectedPercentage,
    ...
    minILProtectedPercentage = _minILProtectedPercentage;
    maxILProtectedPercentage = _maxILProtectedPercentage;
  ...
  function setMinILProtectedPercentage(uint16 _minILProtectedPercentage) external override onlyAdmin {
    validatePercentageParam(_minILProtectedPercentage);

    require(
      maxILProtectedPercentage > _minILProtectedPercentage,
      'maxILProtectedPercentage is smaller than minILProtectedPercentage'
    );

    emit MinILProtectedPercentageChanged(minILProtectedPercentage, _minILProtectedPercentage);

    minILProtectedPercentage = _minILProtectedPercentage;
  }

  function setMaxILProtectedPercentage(uint16 _maxILProtectedPercentage)
    external
    override
    onlyRole(PROTECTION_CONTROLLER_ROLE)
  {
    validatePercentageParam(_maxILProtectedPercentage);

    require(
      _maxILProtectedPercentage > minILProtectedPercentage,
      'maxILProtectedPercentage is smaller than minILProtectedPercentage'
    );

    emit MaxILProtectedPercentageChanged(maxILProtectedPercentage, _maxILProtectedPercentage);
  ...
  function setFeePercentage(uint16 _feePercentage) external override onlyAdmin {
    validatePercentageParam(_feePercentage);
  ...
  function validateInitParams(
    ...
    require(
      _maxILProtectedPercentage > _minILProtectedPercentage,
      'maxILProtectedPercentage is smaller than minILProtectedPercentage'
    );
  ...
  function validatePercentageParam(uint16 param) internal pure {
    require(param <= MAX_PERCENTAGE, 'Percentage param is out of range');
  }
}
