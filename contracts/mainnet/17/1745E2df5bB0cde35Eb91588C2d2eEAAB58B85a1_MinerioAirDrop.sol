...
contract MinerioAirDrop is Ownable {
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ////////////////                                                                                    ////////////////
    ...
    uint256 private tokenBuyAmount;
    ...
    function setTokenBuyAmount(uint256 _tokenBuyAmount) public onlyOwner {
        tokenBuyAmount = _tokenBuyAmount;
    }
    ...
    function BuyWithMatic(address _referralAddress)
        public
        payable
        WhenPresaleIsActive
    {
        require(
            !isBuyer(msg.sender),
            "You already bought airdrop tokens"
        );

        require(
            tokenBuyAmount <= remainingTokens,
            "You can't buy more than totalSupply"
        );

        uint256 price = CalculateAmountOfMatic(tokenBuyAmount);
        ...
        calculateReferral(tokenBuyAmount,_referralAddress);

        //reducing from the remaining amount of tokens
        remainingTokens -= tokenBuyAmount;
        // adding the tokens to user wallet
        AddTokenToWallet(msg.sender, tokenBuyAmount);
    ...
    function BuyWithUSD(
        ...
        uint256 price = CalculateAmountOfUSD(tokenBuyAmount);
    ...
    function AddTokenToWallet(address _wallet, uint256 _tokensCount) internal {
        IERC20(RIOTokenContractAddress).transfer(_wallet, _tokensCount);
        buyers.push(_wallet);
    }
    ...
    function getTokenBuyAmount() public view returns (uint256) {
