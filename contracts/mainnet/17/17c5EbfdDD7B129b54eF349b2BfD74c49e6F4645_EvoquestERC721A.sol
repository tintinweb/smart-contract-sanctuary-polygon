...
contract EvoquestERC721A is Ownable, ERC721A, PaymentSplitter {
    ...
    string private nomCollection = "Water EVO T";
    string private symboleCollection = "WETEST";

    uint private constant MAX_SUPPLY = 2;
    uint private constant MAX_GIFT = 0;
    uint private constant MAX_WHITELIST = 1;
    uint private constant MAX_PUBLIC = 1;
    uint private constant MAX_SUPPLY_MINUS_GIFT = MAX_SUPPLY - MAX_GIFT;

    uint public wlSalePrice = 0.0002 ether;
    uint public publicSalePrice = 0.0002 ether;

    uint public saleStartTime = 1663254596;
    ...
    address[] private _team = [
        0x1CF17D352d36dc137601a8da5F33b4Efc0F90313
    ];
    ...
    ERC721A(nomCollection, symboleCollection)
