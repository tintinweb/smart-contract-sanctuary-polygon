...
/**
 * @title SaduERC721
 * SaduERC721 - a contract for my non-fungible Sadu Summer by Stacie Ant.
 */
contract SaduERC721 is ERC721Tradable {
    constructor(address _proxyRegistryAddress)
        ERC721Tradable("Sadu Summer by Stacie Ant", "SADU", _proxyRegistryAddress)
    {}

    /*
     * Enforce the existence of only 250 of the Sadu Summer collection.
     */
    uint256 public constant MAX_SUPPLY = 250;
    address[] private whitelistedAddresses;
    string public uriPrefix = "https://sadu.infura-ipfs.io/ipfs/QmeLv3KBCBX2gFdhBss3qAY7To9X1Lu35S8BNrAjXP2aqS/";
