...
contract Artifacts is ERC1155, AccessControl, ERC1155Burnable, ERC1155Supply {
    ...
    constructor(address admin, address minter, address locker) ERC1155("Artifacts") {
    ...
    function setUriPrefix(string memory _uriPrefix) external onlyRole(METADATA_ROLE) {
        uriPrefix = _uriPrefix;
    }

    function setUriSuffix(string memory _uriSuffix) external onlyRole(METADATA_ROLE) {
