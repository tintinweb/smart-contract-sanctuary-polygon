...
contract CryptoRappers is ERC721  {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeicvzo77mjf4yzm6r5w5fitify3plrmicauzfixvemwoyacxisq6wq/", Strings.toString(tokenId), ".json")
            );
    }
