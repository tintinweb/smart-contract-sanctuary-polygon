...
library StrategyLib {
  ...
  function checkWithdrawImpact(
    ...
    console.log("checkWithdrawImpact.balance", balance);
    if (assetPrice != 0 && expectedWithdrewUSD != 0) {
      ...
      console.log("checkWithdrawImpact.withdrew", withdrew);
      console.log("checkWithdrawImpact.withdrewUSD", withdrewUSD);
      console.log("checkWithdrawImpact.expectedWithdrewUSD", expectedWithdrewUSD);
      console.log("checkWithdrawImpact.priceChangeTolerance", priceChangeTolerance);
      console.log("checkWithdrawImpact.difference", difference);
      console.log("checkWithdrawImpact.FEE_DENOMINATOR", FEE_DENOMINATOR);
      console.log("checkWithdrawImpact.difference * FEE_DENOMINATOR / expectedWithdrewUSD", difference * FEE_DENOMINATOR / expectedWithdrewUSD);
