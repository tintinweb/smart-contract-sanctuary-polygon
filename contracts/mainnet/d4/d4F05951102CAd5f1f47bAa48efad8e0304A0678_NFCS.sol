...
library Errors {
    ...
    string public constant NFCS_ADDRESS_BUNDLED = "1"; // Address already bundled
    string public constant NFCS_WALLET_VERIFICATION_FAILED = "2"; //  Wallet verification failed
    string public constant NFCS_NONEXISTENT_TOKEN = "3"; // Nonexistent NFCS token
    string public constant NFCS_ADD_ADDRESS_NOT_POLYGON = "4"; // it is not allowed to add address to bundle on chains except for Polygon
    string public constant NFCS_CROSS_CHAIN_GAS = "5"; // Not enough gas for cross chain transaction
