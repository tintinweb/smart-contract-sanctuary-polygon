...
contract SickApeYachtClub is ERC721 , DefaultOperatorFilterer {
    ...
    constructor()
        ERC721("Sick Ape Yacht Club", "SAYCLUB")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeih7rpxxtdbtgvdjm2xao3rjg675liy54fymmta3xygdgor5zejn2e/", Strings.toString(tokenId), ".json")
            );
    }
