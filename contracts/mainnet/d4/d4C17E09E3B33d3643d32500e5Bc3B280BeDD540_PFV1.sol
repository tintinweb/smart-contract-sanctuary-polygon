...
contract PFV1 is ERC721, ERC2981, Ownable, ReentrancyGuard {
    string public contractMetadataURI =
        "ipfs://Qmf3mACXPyWFunLwExovBM7TzDD2fQabFYj3ts1vaPg3Px";
    string public baseMetadataURI =
        "ipfs://QmQx9EASJjx155qE8T4Z1hAdV9ZKMn6wXxCMTfn7HmHbSb/";

    event Received(address sender, uint256 amount);
    event Withdrawal(address receiver, uint256 amount);

    constructor() ERC721("Pink Floyd V1", "PINKV1") {
        // setting royalty address to self for ERC 2981 standard
     ...
     * @param _baseTokenURI New base token URI to be set
     */
    ...
    /**
     * @dev Transfers contract available balance to the contact owner address
     */
     ...
     */
    function withdrawContractTokens(address _tokenAddress)
        external
        onlyOwner
        nonReentrant
    {
    ...
    // ROYALTY FUNCTIONS
    function setDefaultRoyalty(address _receiver, uint96 _feeBasisPoints)
        external
        onlyOwner
    {
