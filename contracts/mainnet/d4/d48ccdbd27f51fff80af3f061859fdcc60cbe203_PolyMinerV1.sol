...
contract PolyMinerV1 is ReentrancyGuard {
    ...
    uint256 private constant MIN_WITHDRAW = 0.1 ether;
    uint256 private constant MIN_INVESTMENT = 20 ether;
    ...
    function _invest(
        ...
        require(msg.value >= MIN_INVESTMENT, "Minimum Investment is 20 Matic");
