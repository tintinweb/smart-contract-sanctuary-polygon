...
contract Moody_Ghost is ERC721Enumerable, Ownable, RoyaltiesV2Impl {
  using Strings for uint256;
  ...
  string aUri = "ipfs://QmceJ4hhXPu96DgohLPHUKRAyaZKG9qvEWUsM4ahHfatNk/";
  string bUri = "ipfs://QmYoSb3Lg4bPfXhHRuZ9S4YVsYBFnTW8YXq2jRdGpza1z3/";
  string cUri = "ipfs://QmVvjDoq6TA8Pch7dkCHnFgm7Cr9iDMDfzuXmhmxzzU1TJ/";
    ...
    returns (string memory)
  {
    ...
    if(block.timestamp % 7 == 0) {
        return bytes(cUri).length > 0
        ? string(abi.encodePacked(cUri, tokenId.toString(), baseExtension))
        : "";
    }
