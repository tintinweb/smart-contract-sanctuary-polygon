...
/** 
*@title PolyTokenTraxx ERC20 Token contract based on Openzepplin smart contract
*@author Genesis Block Team Ashish Madan, Tanuj Nigam, Gokul, Jitin Jain 
*/
// This is the main building block for smart contracts.
contract PolyTokenTraxx is Context, AccessControlEnumerable, ERC20Pausable {
     ...
     * role, as well as the default admin role, which will let it grant pauser 
     ...
     * @param childChainManager address of the childchainmanagerproxy
     */
    constructor(
        string memory name_,
