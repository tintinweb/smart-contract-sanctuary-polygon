...
//   / ____/ __ \/ __ \____/ /__  __________/   |  /  _/
//  / / __/ / / / / / / __  / _ \/ ___/ ___/ /| |  / /  
// / /_/ / /_/ / /_/ / /_/ /  __(__  |__  ) ___ |_/ /   
// \____/\____/_____/\__,_/\___/____/____/_/  |_/___/
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x59435A0655956FF2D984755D8F628a0fBf294ad8];
  address public erc20Payable = 0x59435A0655956FF2D984755D8F628a0fBf294ad8;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 2500) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiauqoahjzgg6fhkyh6z2in36tcrkt43bxlotxcbmubjveveaqk2pi/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/BlE6YpReq7GKCKXGWTRN/contract-metadata";
  }
...
// File: contracts/GoDdessAiContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GoDdessAiContract is RamppERC721A {
    constructor() RamppERC721A("GODdessAI", "GODDESSAI"){}
}
