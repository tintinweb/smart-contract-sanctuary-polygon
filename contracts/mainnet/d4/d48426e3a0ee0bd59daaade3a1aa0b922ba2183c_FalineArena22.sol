...
contract FalineArena22 is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public cost = 15.55 ether;
  ...
  constructor() ERC721("Faline Arena 22", "FA22") {
    setHiddenMetadataUri("ipfs://bafybeiedq4c6immokqlyl7hutnygcspoabfhosixaa3u5dk2ywookg2oy4");
  }
