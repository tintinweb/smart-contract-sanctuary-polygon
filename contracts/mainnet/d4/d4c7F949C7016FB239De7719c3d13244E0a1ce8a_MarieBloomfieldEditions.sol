 ...
 * @notice This contract handles minting Marie Bloomfield Editions tokens.
 */
contract MarieBloomfieldEditions is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x49C87de341B453c167e8A34f276b71bE604d8aF9;
    ...
    address public royaltyAddress = 0x50b838bCaf17Ba0017e9234Db2FA0261B3fafa6e;
    address[] public payoutAddresses = [
        0x50b838bCaf17Ba0017e9234Db2FA0261B3fafa6e,
        0x983A102eA37a18B56C7d80d2B389129968303422
    ];
    ...
    string public name = "Marie Bloomfield Editions";
    string public symbol = "BLOOM";
    ...
    constructor(uint256 _heymintFeePerToken, address _crossmintAddress)
        ERC1155(
            "ipfs://bafybeigv4lidhlgfum6h5twrl22bzjgc4f2mqbpqtglttqfffwyjqamq7i/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenPublicPrice[1] = 11 ether;
        tokenPublicMintsPerAddress[1] = 11;
        require(
    ...
    /**
     * @notice Mint from crossmint (allow credit card payment)
     */
    function crossmintToken(
        uint256 _tokenId,
        uint256 _numTokens,
        address _to
    ) external payable originalUser nonReentrant {
        require(msg.sender == crossmintAddress, "NOT_CROSSMINT_ADDRESS");
        require(tokenPublicSaleActive[_tokenId], "PUBLIC_SALE_IS_NOT_ACTIVE");
        require(
            tokenPublicSaleTimeIsActive(_tokenId),
            "PUBLIC_SALE_TIME_IS_NOT_ACTIVE"
