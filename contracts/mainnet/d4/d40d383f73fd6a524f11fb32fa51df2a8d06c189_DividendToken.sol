...
contract DividendToken is Ownable, ReentrancyGuard, ERC20 {
    ...
    function withdraw() external nonReentrant isUnlocked {
        ...
        require(holderBalance != 0, "BotSuperTrendToken: caller possess no shares");
        ...
        require(success, "BotSuperTrendToken: Could not withdraw eth");
    }
