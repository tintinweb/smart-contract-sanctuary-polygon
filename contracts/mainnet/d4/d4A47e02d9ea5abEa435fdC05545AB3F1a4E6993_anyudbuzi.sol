...
contract anyudbuzi is ERC721, PaymentSplitter {
    uint256 public totalSupply;
    uint256 private cost = 250 ether;
    uint256 private whitelistCost = 0.01 ether;
    ...
    constructor(address[] memory _payees, uint256[] memory _shares)
        ERC721("Anyud tudja hogy buzi vagy?", "Anyud")
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked(
                    "ipfs://Qmf1pMtLcHHwULqF8RaSCxCh38Q9QBnUKFWPRgRWkioGQv/",
