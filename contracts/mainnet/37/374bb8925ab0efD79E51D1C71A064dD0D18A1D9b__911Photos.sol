 ...
 * @notice This contract handles minting 9/11 Photos tokens.
 */
contract _911Photos is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xe4d24009862aa2dA99E1F784c1a7e0a86A4ab868;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xB4B24881E98F2A6139496FFE887812091d5da12E;
    address[] public payoutAddresses = [
        0xB4B24881E98F2A6139496FFE887812091d5da12E
    ];
    ...
    string public name = "9/11 Photos";
    string public symbol = "nep";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeifdcgg5movn5otfhbch5imdpgdbdg2y4lx6eei3geux4dlyjexueu/{id}"
        )
        RevokableOperatorFilterer(
