...
import "./child/ChildToken/ChildMintableERC1155.sol";

/**
 * @title ConnectClubChildEvents
 * ConnectClubChildEvents - a child contract for connect.club events.
 */
contract ConnectClubChildEvents is ChildMintableERC1155 {
  constructor()
