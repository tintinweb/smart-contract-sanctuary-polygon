...
contract ForceUnlockCooldownLoader{
    function setForceUnlockLandCooldown(uint256 cooldownSeconds) external {
        LibDiamond.enforceIsContractOwner();
        LibDiamond.DiamondStorage storage ds = LibDiamond.diamondStorage();
        ds.erc721_forceUnlockLandCooldown = cooldownSeconds;
    }
    function getForceUnlockLandCooldown() external view returns(uint256) {
        return  LibDiamond.diamondStorage().erc721_forceUnlockLandCooldown;
    }
}
