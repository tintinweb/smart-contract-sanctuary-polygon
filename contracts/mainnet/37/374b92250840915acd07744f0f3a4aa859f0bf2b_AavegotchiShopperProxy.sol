...
contract AavegotchiShopperProxy is ERC20Upgradeable {
    ...
    function executeCallERC1155Listing(uint256 listingId, uint256 quantity,
        ...
        (bool success, bytes memory returnData) =
            diamondAddress.call(
                abi.encodeWithSignature("executeERC1155Listing(uint256, uint256, uint256)", 
                foundListingId, 
                quantity, 
                priceInWei
            )
