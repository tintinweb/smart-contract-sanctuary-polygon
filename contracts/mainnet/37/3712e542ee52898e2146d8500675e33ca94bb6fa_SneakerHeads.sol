...
/**
 *Submitted for verification at Polygonscan.io on 2022-05-01
*/
...
contract SneakerHeads is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    address devWallet = 0x738bb14A3223BFdb8f87c5EFfF432897c236f3BA;
    
    mapping(address => uint256) public Whitelist;

    receive() external payable {}

    constructor() ERC721('Sneaker Heads', 'SNKH') {}

    function reserveMints(address to) public onlyOwner {
        for (uint256 i = 0; i < 10000; i++) internalMint(to);
    }
    ...
    function withdraw() public onlyOwner {
        ...
        payable(devWallet).transfer((balance * 1000) / 1000);
    }
    ...
    function mint(uint256 amount) public payable {
        ...
        require(amount <= 10000, 'only 10000 per transaction allowed');
        for (uint256 i = 0; i < amount; i++) internalMint(msg.sender);
    }
