...
import "./GokaStaking.sol";
import {StakeholderLib} from "./StakeholderLib.sol";

/**
 * @title Partial ERC20 compatible wrapper for a GokaStaking contract.
 ...
 */
contract GokaStakingERC20 is Ownable{

    string public name = "Staked ENV"; 
    string public symbol = "sENV";
    uint public decimals = 18;

    GokaStaking stakingContract;

    constructor(address stakingContractAddress){
        stakingContract = GokaStaking(stakingContractAddress);
    }
