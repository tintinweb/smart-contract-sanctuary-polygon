...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI, Ownable {
    ...
    address payable internal  dev = payable(0x6C58456637501D63782256c0924C3E428be63655);
    address payable internal  iv = payable(0x6C58456637501D63782256c0924C3E428be63655);
...
contract MekaFightTest2 is ERC1155 {
    string public name;
    string public symbol;
    uint public  MAX_TOKEN = 10000;
    uint public  MAX_WL_TOKEN = 1000;
    uint public  basePrice = 1*10**15; // ETH
    uint public  basePriceWl = 1*10**15; // ETH
