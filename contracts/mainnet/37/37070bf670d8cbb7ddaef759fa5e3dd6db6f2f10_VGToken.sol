...
contract VGToken is ERC20, ERC20Burnable, Ownable, Pausable {
    ...
    constructor () ERC20("Vicion Group", "VG")
    {
        ...
        vault_address = 0xDB0C413736532FA99Ef6Fd254Fe64CD51f28920A;
        ...
        is_taxless[0xB22122B78275fF14A02868DcA30628bd53D7E179] = true;
        is_taxless[vault_address] = true;
        is_taxless[address(this)] = true;
        is_taxless[address(0)] = true;
        is_taxless[pair] = true;

        _mint(0xB22122B78275fF14A02868DcA30628bd53D7E179, 10_000_000_000 ether);
    }
