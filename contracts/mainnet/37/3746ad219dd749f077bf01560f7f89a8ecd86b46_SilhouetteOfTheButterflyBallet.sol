...
contract SilhouetteOfTheButterflyBallet is ERC721 {
    uint256 public totalSupply;
    uint256 public cost = 0.2 ether;
    uint256 public maxMints = 46;
    ...
    constructor()
        ERC721("Silhouette of the Butterfly Ballet", "SOTBB")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeierg655dyz3f732eds3b5fud2fxnslqm3i6ndiggkxaby5tgohgvm/", Strings.toString(tokenId), ".json")
            );
    }
