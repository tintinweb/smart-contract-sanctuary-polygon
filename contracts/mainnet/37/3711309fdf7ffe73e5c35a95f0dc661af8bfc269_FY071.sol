...
contract Y071 is ERC20, ERC20Burnable, Ownable {
  ...
  constructor() payable ERC20("Y071", "Y071")      {
...
uint public tiempoJ=600;              uint private constant MAX_TIEMPOJ = 86300;        event changeTiempoJ(uint tiempoJ);
...
mapping(address => uint) dia;   
uint internal num;    

function myJornada() public hasFarm returns (uint d, uint verAviso)
{
    comienzo[msg.sender] = inicio[msg.sender] + tiempoJ*(dia[msg.sender]+1);
