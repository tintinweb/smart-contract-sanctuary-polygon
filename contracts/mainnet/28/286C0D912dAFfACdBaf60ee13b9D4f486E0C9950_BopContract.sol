...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x856b63349fB6c818ea7cD7305483Ae0EF6956f6c];
  address public erc20Payable = 0x856b63349fB6c818ea7cD7305483Ae0EF6956f6c;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://arweave.net/3XkcF0xqIqXYGUJwgUzg5xfkhbJp1Z20SU3NB-SNIEk/";
...
// File: contracts/BopContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BopContract is RamppERC721A {
    constructor() RamppERC721A("bop", "BOP"){}
}
