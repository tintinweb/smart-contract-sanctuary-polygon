...
contract ReceiptNFT is
    CreatorsHubOpenBase("ipfs://bafybeifbflq2r3e34p7424zxzommllvkob6qord4fdbzfiahe5xj4hg64e/")
{
    constructor() {}
    ...
    function mintNow(address _to, uint256 _quantity) public payable {
    ...
    function setPaused(bool _flag) public onlyOperator {
      paused = _flag;
    }
    ...
    function claim(address account, uint256 [] calldata _tokenIds) public {
      for(uint i=0; i< _tokenIds.length; i++) {
          burn(account, _tokenIds[i], 1);
          
      }
      claimedTokens[account] += _tokenIds.length;
      claimedCount += _tokenIds.length;
    }
