...
// File: contracts/4_EventosNSUJPG.sol
...
contract FactoryEvents is ERC1155,ERC1155Burnable, Ownable {
    ...
    constructor(string memory initialContractURI, string memory name_, string memory symbol_, string memory uri_)
        ERC1155(uri_)
    {
        _uri = uri_; 
        _symbol= symbol_;
    ...
    function airdropEvent( uint256 _quantity, address _to, uint256 _event) public onlyAdmin {
            _mint(_to, _event, _quantity, "airdrop");
    }
