...
contract IAPED is IAPEDDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private IAPEDTeam;
    address private CharityIAPED;
    ...
    string public override name = "I APED";
    string public override symbol = "IAPED";
    ...
    constructor(uint totalSupplyValue, address IAPEDTeamAddress, address CharityIAPEDAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        IAPEDTeam = IAPEDTeamAddress;
        CharityIAPED = CharityIAPEDAddress;
        
        // split the tokens according to agreed upon percentages
        balances[IAPEDTeam] =  totalSupply * 4 / 100;
        balances[CharityIAPED] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's IAPEDTeam pot
