...
contract SingleAssetVault is ERC4626, Ownable {
    ...
    function rebalance(
        ...
        uint256 balanceAtVault = IERC4626(sourceVaultAddress).balanceOf(address(this));
        IERC4626(sourceVaultAddress).redeem(
            assets * balanceAtVault / IERC4626(sourceVaultAddress).convertToAssets(balanceAtVault),
            address(this),
            address(this)
        );
