...
// File: contracts/Seeker/SeekerRenderer.sol
...
contract SeekerRenderer is Ownable, TokenRenderer {
    ...
    function _getName(
        ...
        return string(abi.encodePacked(name, " #", Utils.toString(tokenId)));
    }
    ...
    function getTokenURI(
        ...
        bytes memory json = abi.encodePacked(
            ...
            '", "description": "The ',
            name,
            " rank is awarded to Daylight Scouts who have submitted one or more accepted abilities. ",
            name,
