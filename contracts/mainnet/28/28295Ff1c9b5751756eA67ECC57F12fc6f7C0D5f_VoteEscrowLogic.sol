...
contract VoteEscrowResolver is DSMath {
    ...
    function _payFees(
        ...
        (uint256 fee, uint256 maxFee, address feeRecipient) = getVaultFee(_vault);
    ...
    function deposit(
        ...
        etha.universalApprove(veEthaToken, realAmt);
    ...
    function withdraw(
        ...
        uint256 _claimed = IERC20(distToken).balanceOf(address(this)).sub(initialBal);
