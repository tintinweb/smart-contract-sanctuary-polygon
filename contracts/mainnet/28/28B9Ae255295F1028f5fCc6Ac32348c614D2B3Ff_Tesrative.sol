...
contract Tesrative is ERC721Enumerable, ERC2981, Ownable {
    using Strings for uint256;

    // FIXME: 
    constructor() ERC721("Tesrative", "TESRATIVE") {
        transferOwnership(msg.sender);
    }

    // TODO: Address をメタデータに記載
    // TODO: glb ファイルの表示の確認
    // TODO: かわいそう樽の確認
    ...
    function mint(uint256 amt) public payable {
        ...
        require(msg.value >= publicPrice * amt, '');
    ...
    function setCollabTaruInfo(uint256 tokenId, string calldata collaborator, string calldata url) public {
        ...
        collabTaruInfo[tokenId].imageUrl = url;
