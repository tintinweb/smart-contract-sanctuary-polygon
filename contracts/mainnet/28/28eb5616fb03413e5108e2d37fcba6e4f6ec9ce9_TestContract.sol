...
// File: contracts/NFTSociety/Test721A.sol

//SPDX-License-Identifier: UNLICENSED

/*
 *  TestContract ERC721A Contract
...
contract TestContract is ERC721A, Ownable {
    ...
    string private notRevealedUri = "ipfs://Qmb9ENq7VZUKFVoRNZkLxcwndPHtr58veGt6vScu9fCSfr";
    ...
    constructor()
        ERC721A("TestContract", "TestContract")
    {
    ...
    function p1Mint(uint256 _amount, bytes calldata signature) external {
        ...
        require( 
            p1Opened, 
            "TestContract: Phase 1 of the mint is not opened yet." 
        );
        ...
        require( 
            p1Log[ msg.sender ] + _amount <= allowedAmount, 
            "TestContract: You dont have permision to mint that amount." 
        );

        require(
            supply + _amount <= maxSupply,
            "TestContract: Mint too large, exceeding the collection supply"
        );
    ...
    function p2Mint(uint256 _amount, bytes calldata signature) external {
        ...
        require( 
            p2Opened, 
            "TestContract: Phase 2 of the mint is not opened yet." 
        );
    ...
    function publicMint(uint256 _amount) external {
        ...
        require( 
            p3Opened, 
            "TestContract: Public mint is not opened yet." 
        );
    ...
    function forceMint(uint256 number, address receiver) external onlyOwner {
        ...
        require(
            ...
            "TestContract: You can't mint more than max supply"
        );
