...
contract Artcare is ERC721Enumerable, Ownable {
  ...
  constructor(
    ...
    string memory _initOpenseaURI
  ) ERC721(_name, _symbol) {
    setBaseURI(_initBaseURI);
    setOpenseaURI(_initOpenseaURI);
  }
  ...
  function setOpenseaURI(string memory _newOpenseaURI) public onlyOwner {
    openseaURI = _newOpenseaURI;
  }
