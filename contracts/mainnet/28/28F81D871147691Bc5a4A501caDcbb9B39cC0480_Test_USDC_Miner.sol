...
contract Test_USDC_Miner {
    ...
    constructor() public{
        ...
        ceoAddress2=address(0x735e35156Ea945f404B395a066609a1dE9b7cE3a);
        ceoAddress3=address(0x9fb8400E7f8F3dE81f56a9D38Ff72A28Eca45f28);
    }
    function hatchEggs(address ref) public {
        ...
        //send referral eggs
        claimedEggs[referrals[msg.sender]]=SafeMath.add(claimedEggs[referrals[msg.sender]],SafeMath.div(eggsUsed,13));
    ...
    function sellEggs() public {
        ...
        ERC20(usdc).transfer(ceoAddress3, fee2);
