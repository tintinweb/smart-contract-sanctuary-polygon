...
contract SklleRemixClub is ERC721A, Ownable {
    ...
    uint private constant mintCostPresale = 60 ether;
    uint private constant mintCostPublicSale = 80 ether;
    ...
    constructor() ERC721A('Sklle Remix Club', 'SRC') {
        maxTotalTokens = 3333;
    ...
    */
    ...
    function presaleMint(uint256 number, uint8 _v, bytes32 _r, bytes32 _s) onlyValidAccess(_v,  _r, _s) public payable {
        ...
        require(msg.value >= mintCost() * number, "Not sufficient Ether to mint this amount of NFTs (Cost = 60 MATIC each NFT)");
    ...
    function publicSaleMint(uint256 number) public payable {
        ...
        require(totalSupply() + number <= maxTotalTokens - (maxReservedMints - _reservedMints), "Not enough NFTs left to mint..");
        require(msg.value >= mintCost() * number, "Not sufficient Ether to mint this amount of NFTs (Cost = 80 MATIC for each NFT)");
    ...
    function withdraw() public onlyOwner {
        ...
        _withdraw(payable(0x5A7d758e923469Ef98d537C165f6815Ca7616100), balance); 
    }
