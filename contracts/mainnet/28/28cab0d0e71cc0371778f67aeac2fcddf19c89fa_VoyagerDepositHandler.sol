...
contract VoyagerDepositHandler is AccessControl, ReentrancyGuard, Pausable {
    ...
    constructor(address _wrappedNativeTokenAddress, address _reserve) {
    ...
    function iSend(
        ...
        } else IERC20(srcToken).safeTransferFrom(msg.sender, reserve, amount);
        emit ISendEvent(msg.sender);
    }
