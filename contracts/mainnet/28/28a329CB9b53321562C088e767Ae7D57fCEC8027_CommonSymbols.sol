...
contract CommonSymbols {
    ...
    function b1(uint256 id, uint256 position) internal returns (int256 coin) {
        ...
        for (uint8 i = 0; i < adjacentPosition.length; ++i) {
            ...
            } else if (adjSymbol == Symbols.Symbols.M18) {
                baseLogic.b1_destroy(id, position);
                gameMap.boostPayout(id, adjPosition, 1);
            }
        }
    }
    ...
    function b2(uint256 id, uint256 position) internal {
        ...
        for (uint8 i = 0; i < adjacentPosition.length; ++i) {
            ...
            if (adjSymbol == Symbols.Symbols.T3) {
                baseLogic.t3_destroy(id, adjPosition);
                ++count;
            }
        }
        if (count > 0) gameMap.destroySymbol(id, position); // destroy itself
    }

    function b7(uint256 id, uint256 position)
        public
        view
        returns (int256 coin)
    {
        ...
        for (uint8 i = 0; i < adjacentPosition.length; ++i) {
            ...
            if (
                adjSymbol == Symbols.Symbols.F3 ||
                adjSymbol == Symbols.Symbols.B8 ||
                adjSymbol == Symbols.Symbols.H10
            ) {
    ...
    function b9(uint256 id, uint256 position) internal returns (int256 coin) {
        ...
        for (uint8 i = 0; i < adjacentPosition.length; ++i) {
            ...
            if (adjSymbol == Symbols.Symbols.D8) {
                int256 payout = gameMap.getPayout(id, adjPosition);
                coin += payout * 10;
                gameMap.destroySymbol(id, position);
            } else if (adjSymbol == Symbols.Symbols.P4) {
                gameMap.boostPayout(id, adjPosition, 1);
                gameMap.destroySymbol(id, position);
            }
        }
    ...
    function b13(uint256 id, uint256 position) internal returns (int256 coin) {
        ...
        for (uint8 i = 0; i < adjacentPosition.length; ++i) {
            ...
            if (adjSymbol == Symbols.Symbols.G2) {
                gameMap.destroySymbol(id, position);
                coin += 20;
                break;
            } else if (adjSymbol == Symbols.Symbols.T3) {
    ...
    function b15(uint256 id, uint256 position) internal returns (int256 coin) {
        ...
        for (uint8 i = 0; i < adjacentPosition.length; ++i) {
            ...
            if (adjSymbol == Symbols.Symbols.G6) {
                gameMap.destroySymbol(id, position);
                coin += 15;
            } else if (adjSymbol == Symbols.Symbols.T6) {
                gameMap.destroySymbol(id, position);
                coin += 20;
            }
        }
    ...
    function c1(uint256 id, uint256 position) internal returns (int256 coin) {
        ...
        for (uint8 i = 0; i < adjacentPosition.length; ++i) {
            ...
            if (adjSymbol == Symbols.Symbols.T6) {
                gameMap.destroySymbol(id, position);
                coin += 6;
            }
        }
    ...
    function c3(uint256 id, uint256 position) internal returns (int256 coin) {
        ...
        for (uint8 i = 0; i < adjacentPosition.length; ++i) {
            ...
            if (adjSymbol == Symbols.Symbols.M11) {
                gameMap.destroySymbol(id, adjPosition);
                coin += 9;
            }
        }
    ...
    function c4(uint256 id, uint256 position) internal returns (int256 coin) {
        ...
        for (uint8 i = 0; i < adjacentPosition.length; ++i) {
            ...
            if (adjSymbol == Symbols.Symbols.M17) {
                gameMap.destroySymbol(id, position);
                coin += 15;
            }
        }
    ...
    function c7(uint256 id, uint256 position) internal {
        ...
        for (uint8 i = 0; i < adjacentPosition.length; ++i) {
            ...
            if (adjSymbol == Symbols.Symbols.M18) {
                gameMap.destroySymbol(id, position);
                gameMap.boostPayout(id, adjPosition, 1);
            }
        }
    ...
    function c11(uint256 id, uint256 position) internal {
        ...
        if (countSpin == 20) {
            ...
            gameMap.addSymbol(id, position, uint256(Symbols.Symbols.D2));
        }
    }

    function c17(uint256 id, uint256 position)
        public
        view
        returns (int256 coin)
    {
        ...
        for (uint256 i = 0; i < 5; ++i) {
            uint256 pos = row * 5 + i;
            Symbols.Symbols symbol = Symbols.findSymbol(
                gameMap.atPosition(id, pos)
            );
            if (symbol == Symbols.Symbols.C17) {
                ++countCrab;
            }
        }
        if (countCrab > 1) {
    ...
    function c18(uint256 id, uint256 position)
        public
        view
        returns (int256 coin)
    {
    ...
    function c19(uint256 id) internal view returns (int256 coin) {
        uint256 countCultist = gameMap.countSymbol(
            id,
            uint256(Symbols.Symbols.C19)
        );
    ...
    function d5(uint256 id, uint256 position)
        public
        view
        returns (int256 coin)
    {
    ...
    function e1(uint256 id, uint256 position) internal returns (int256 coin) {
        uint256 percent = Random.random();
        if (percent < 10) {
            gameMap.removeSymbol(id, position);
            gameMap.addSymbol(id, position, uint256(Symbols.Symbols.C8));
        }
    }
    ...
    function g6(uint256 id, uint256 position) internal returns (int256 coin) {
        ...
        for (uint8 i = 0; i < adjacentPosition.length; ++i) {
            ...
            if (adjSymbol == Symbols.Symbols.B15) {
                gameMap.destroySymbol(id, adjPosition);
                coin += 15;
            }
        }
    ...
    function g8(uint256 id, uint256 position) internal returns (int256 coin) {
        uint256 percent = Random.random();
        if (percent == 5) {
            gameMap.addToInventory(id, uint256(Symbols.Symbols.G5), 1);
        }
    }
    ...
    function l1(
        ...
        for (uint8 i = 0; i < adjacentPosition.length; ++i) {
            ...
            if (baseLogic.contains("minerals", uint256(adjSymbol))) {
                int256 payout = gameMap.getPayout(id, adjPosition);
                coin += 2 * payout;
            }
        }
    ...
    function l2(uint256 id, uint256 position) internal returns (int256 coin) {
        ...
        for (uint8 i = 0; i < adjacentPosition.length; ++i) {
            ...
            if (adjSymbol == Symbols.Symbols.K1) {
                gameMap.destroySymbol(id, adjPosition);
                baseLogic.l2_destroy(id, position);
            } else if (adjSymbol == Symbols.Symbols.M1) {
                int256 payout = gameMap.getPayout(id, adjPosition);
                gameMap.destroySymbol(id, adjPosition);
                baseLogic.l2_destroy(id, position);
                coin += 3 * payout;
    ...
    function m2(uint256 id, uint256 position) internal returns (int256 coin) {
        ...
        if (countSpin == 4) {
            coin += 9;
            countSpin = 0;
            gameMap.updateCountSpin(id, position, 0);
        }
    }
    ...
    function m13(uint256 id, uint256 position) internal returns (int256 coin) {
        ...
        for (uint8 i = 0; i < adjacentPosition.length; ++i) {
            ...
            if (adjSymbol == Symbols.Symbols.O3) {
                baseLogic.o3_destroy(id, adjPosition);
                coin += 20;
            } else if (adjSymbol == Symbols.Symbols.B10) {
    ...
    function m15(uint256 id, uint256 position) internal returns (int256 coin) {
        ...
        for (uint8 i = 0; i < adjacentPosition.length; ++i) {
            ...
            int256 payout = gameMap.getPayout(id, adjPosition);
            if (adjSymbol == Symbols.Symbols.B1) {
                baseLogic.b1_destroy(id, adjPosition);
                coin += 6 * payout;
            } else if (adjSymbol == Symbols.Symbols.C12) {
                baseLogic.c12_destroy(id, adjPosition);
                coin += 6 * payout;
            } else if (adjSymbol == Symbols.Symbols.C13) {
                coin += 6 * payout;
                gameMap.removeSymbol(id, adjPosition);
            }
        }
    }
    ...
    function m17(uint256 id, uint256 position) internal returns (int256 coin) {
        ...
        for (uint8 i = 0; i < adjacentPosition.length; ++i) {
            ...
            if (adjSymbol == Symbols.Symbols.C4) {
                coin += 15;
                gameMap.removeSymbol(id, adjPosition);
            }
        }
    ...
    function o4(uint256 id, uint256 position)
        public
        view
        returns (int256 coin)
    {
    ...
    function o5(uint256 id, uint256 position) internal returns (int256 coin) {
        uint256 percent = Random.random();
    ...
    function p6(uint256 id, uint256 position) internal returns (int256 coin) {
        uint256 countSpin = gameMap.getProp(id, position);
        if (countSpin == 12) {
    ...
    function s4(uint256 id, uint256 position) internal {
        ...
        for (uint8 i = 0; i < adjacentPosition.length; ++i) {
            ...
            if (adjSymbol == Symbols.Symbols.F1 && percent < 50) {
                s4_grow(id, position);
                return;
            }
        }
    ...
    function s4_grow(uint256 id, uint256 position) internal {
        ...
        gameMap.addSymbol(id, position, baseLogic.at("fruits", randSymbol[0]));
    }
    ...
    function s8(uint256 id, uint256 position)
        public
        view
        returns (int256 coin)
    {
    ...
    function t6(uint256 id, uint256 position) internal returns (int256 coin) {
        ...
        for (uint8 i = 0; i < adjacentPosition.length; ++i) {
            ...
            if (
                adjSymbol == Symbols.Symbols.C1 ||
                adjSymbol == Symbols.Symbols.B15
            ) {
                coin += 6;
                gameMap.destroySymbol(id, adjPosition);
            } else if (adjSymbol == Symbols.Symbols.P5) {
    ...
    function t9(uint256 id, uint256 position)
        public
        view
        returns (int256 coin)
    {
