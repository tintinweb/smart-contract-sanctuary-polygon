...
This smart contract will pick one random winner out of the 1,111 Full Rockets and award 10% of the monthly royalties to the winner.
If the selected Full Rocket has not been assembled, the full amount will be rolled over to the next month. 
...
There are 943 total transactions in March 2022 from jpg.store.
The total amount of March 2022 royalties is 68,735.1 ADA.
10% of the monthly royalties, 6,873.51 ADA, goes to the raffle prize pool. 
...
// File contracts/BCRCRaffleMar2022.sol

pragma solidity ^0.8.7;
 
contract BCRCRaffleMar2022 is VRFConsumerBase, Ownable {
