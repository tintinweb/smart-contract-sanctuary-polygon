...
// File: contracts/TastySkullXYZ.sol
...
contract TastySkullXYZ is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Tasty Skull XYZ", "TSXYZ") {
    setHiddenMetadataUri("ipfs://QmPUYssKcinawfngUSYcikdZuUKSgM7wNpurXuxeVcjBuU/hidden.json");
  }
