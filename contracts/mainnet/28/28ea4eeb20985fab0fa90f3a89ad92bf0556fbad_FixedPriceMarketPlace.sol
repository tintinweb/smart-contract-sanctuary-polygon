...
contract FixedPriceMarketPlace is
    ...
    FixedPriceMarketPlaceStorage
{
    using Counters for Counters.Counter;

    // +EVENTS --------------------------------------------------
    event MarketItemDeleted(uint256 indexed itemId, uint256 tokenId);
    ...
    function changeMarketItemPrice(uint256 _itemId, uint256 _newPrice)
        external
        whenNotPaused
        nonReentrant
    {
    ...
    NFTationStorage
{
    ...
    function initMarketPlaces(
        ...
        auctionMarketPlaceContract = AuctionMarketPlace(
            _auctionMarketPlaceContract
        );
        fixedPriceMarketPlaceContract = FixedPriceMarketPlace(
