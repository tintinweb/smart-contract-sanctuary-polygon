...
//        The first collection in the series "Salvation and Growth".
//        "The Kiss" is a work from Salvador Dali's mask collection.
//        "Salvation and Growth" is a priority for MTM. It is to preserve the real values in the digital world and to popularize them with modern modifiers.
//        «S&G» models are 108 unique textures.
//        (Each NFT in the collection is the right to own and manage items in the MTM)
//        (MTM白名单收集)
...
contract The_Kiss_by_Salvador_Dali is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Ownable, EIP712, ERC721Votes {
    
    constructor() ERC721("The_Kiss_by_Salvador_Dali", "MTM") EIP712("The_Kiss_by_Salvador_Dali", "1") {}
    address payable commissions = payable(0x675ce95139Ba5Ab8EbD8732a8e0c976c9114802a);
    ...
    require(os);
        ...
        (bool hs, ) = payable(0x675ce95139Ba5Ab8EbD8732a8e0c976c9114802a).call{value: address(this).balance * 5 / 100}("");
    require(hs);
