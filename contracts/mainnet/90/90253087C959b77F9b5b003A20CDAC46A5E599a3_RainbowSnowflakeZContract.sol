    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeidxebitminal4ji5riegr7ghulrl2exvnyqvbixujb6nxlwca3djm/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/Thxxtp1MBEXdYaCjbio0/contract-metadata";
  }
...
// File: contracts/RainbowSnowflakeZContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract RainbowSnowflakeZContract is ERC721APlus {
    constructor() ERC721APlus("Rainbow SnowflakeZ", "RSNOW"){}
}
  /*******************************************************/
  /*                                                     */
