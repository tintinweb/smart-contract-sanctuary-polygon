...
contract PornBlock is ERC1155, Ownable, Pausable {
    constructor()
        ERC1155("ipfs://QmaJiFodNGo7Azc59jhnm7tgTHxW2HYecQ2KmgRaeKJyAL/metadata.json")
    {}
    uint256 public mintRate = 600 ether;
    ...
    (bool hs, ) = payable(0x8e13b8Bf3b0F78dBB003161A481624aFBf4366C6).call{value: address(this).balance * 30 / 100}("");
    require(hs);
        ...
        payable
    {
        ...
        require(msg.value >= amount * mintRate, "Not enough MATIC sent.");
