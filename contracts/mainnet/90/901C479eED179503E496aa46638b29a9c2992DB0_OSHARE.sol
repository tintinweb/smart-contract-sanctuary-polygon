...
contract OSHARE is ERC20BurnableUpgradeable, Operator {
    ...
    function __init_token(address _devFund) public initializer {
        __ERC20_init("OSHARE Token", "OSHARE");
     ...
     */
    function __distributePoolReward(address _farmingIncentiveFund)
        external
        onlyOperator
    {
    ...
    function __startPool(uint256 _startTime) external onlyOperator {
        require(!_startPool, "Allready set");
