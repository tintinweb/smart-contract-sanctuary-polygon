...
contract FangAndFur is ERC721, Ownable, Pausable, ERC721Enumerable {
    ...
    function brickBlock(uint256 _mintAmount) public onlyOwner {
        require(_mintAmount <= 250, "You can only mint up to 250 at a time.");
        // 0-99 = 250 total NFTs
