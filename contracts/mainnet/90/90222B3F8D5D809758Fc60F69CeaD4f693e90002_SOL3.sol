...
contract SOL3 is ERC20, ERC20Burnable, Pausable, Ownable {
    // DEBUG TESTING
    ...
    constructor() ERC20("SOLIDITY3", "SOL3") {
    ...
    function zcreateDEXPair() public onlyOwner {
        // MUMBAI TESTNET THIS FUNCTION RETRIEVES WRONG ADDRESS USE STATIC 0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889
        // address WETHaddress = address(0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889); Polygon Mumbai TESTNET
        address WETHaddress = IUniswapV2Router02(zdebugUniswapRouter).WETH();
        zdebugWETHaddress = WETHaddress;

        // Creates a pair for tokenA and tokenB if one doesn't exist already.
        // TokenA = WrappedToken (WETH, WBNB, WMATIC, etc) || TokenB = ContractToken
        address uniswapV2Pair = IUniswapV2Factory(zdebugUniswapFactory).createPair(address(this), WETHaddress);
        zdebugUniswapPair = uniswapV2Pair;
    }

    function zaddDEXLiquidityNative(uint256 tokenAmount, uint256 ethAmount) public payable {
    ...
    function zgetWrappedAddress() public view returns(address) {
        return address(IUniswapV2Router02(zdebugUniswapRouter).WETH());
    }

    function zgetLiquidityPairAddress(address tokenA, address tokenB) public returns(address) {
    ...
    function zgetDEXPairTotalLP(address pairaddress) public view onlyOwner returns(uint) {
