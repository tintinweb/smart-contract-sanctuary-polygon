...
interface ICombatable {
     ...
     * @return newHealth New current health of entityId after damage is taken
     */
    function decreaseHealth(uint256 entityId, uint256 amount)
        external
        returns (uint256 newHealth);
     ...
     * @return boolean if entityId can be attacked
     */
    function canBeAttacked(uint256 entityId, uint256[] calldata overloads)
        external
        view
        returns (bool);
     ...
     * @dev Helper func return current health of entityId without redeclaring TraitsProvider
     */
    function getCurrentHealth(uint256 entityId, ITraitsProvider traitsProvider)
        external
        view
        returns (uint256);
}
