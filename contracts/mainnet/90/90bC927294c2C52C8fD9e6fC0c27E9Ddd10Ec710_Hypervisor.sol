...
/// @notice A V2-like interface with fungible liquidity to Ascent
/// which allows for arbitrary liquidity provision: one-sided, lop-sided, and balanced
contract Hypervisor is IAscentV3MintCallback, ERC20Permit, ReentrancyGuard {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;
    using SignedSafeMath for int256;

    IAscentV3Pool public pool;
   ...
   event Deposit(
    ...
    /// @param _pool Ascent V3 pool for which liquidity is managed
    ...
    function withdraw(
        ...
        /// Withdraw liquidity from Ascent pool
    ...
    function rebalance(
        ...
        /// Withdraw all liquidity and collect all fees from Ascent pool
    ...
    /// @notice Callback function of AscentV3Pool mint
    ...
    /// @return tick Ascent pool's current price tick
