...
contract DOPE is ERC20, AccessControl, ERC721Holder {
    ...
    constructor(address owner, address _collectionAddress) ERC20("DOPE", "Dope") AccessControl(){
        ...
        coinAmountPerRewardUnit = .5 * 10 ** 18; 
        numberOfBlocksPerRewardUnit = 41142; 
        welcomeBonusAmount = 42 * 10 ** 18; 
    }
    ...
    function stake(uint256 tokenId) public {
        ...
        require(IERC721(collectionAddress).ownerOf(tokenId) == address(this),
            "DOPE: Error while transferring token");
    ...
    function setWelcomeBonusAmount(uint256 coinAmount) external onlyRole(CONTRACT_ADMIN_ROLE){
        ...
        require (newAddress != address(0), "DOPE: update to zero address not possible");
