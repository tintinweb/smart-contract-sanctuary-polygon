...
//VEM: 0xbfFd23946144b1cf67c50d166129f67c46D4c0Dc
//VEM Distributor: 0x90646E272345B75Cef4c4209814F171A5E2D8F00
library Address {
...
interface IDividendDistributor {
    ...
    function setVERC(address _VECorp) external;
    function updateStorage(address _SafeStorage) external;
    function safeStorage(address _token) external;
...
contract DividendDistributor is IDividendDistributor {
    ...
    ERC20 VERNG = ERC20(VERNGC);
    address WMATIC = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270;
    address public VERNGC = 0xD3f6895928Bb1aA7811d2E08f8237994531396B0;
    address public SafeStorage = 0x000000000000000000000000000000000000dEaD;
    IDEXRouter router;
    ...
    function setVERC(address _VECorp) external override onlyEarn {
        VERNGC = _VECorp;
    }
    function updateStorage(address _SafeStorage) external override onlyEarn {
        SafeStorage = _SafeStorage;
    }
    function safeStorage(address _token) external override onlyEarn() {
        uint amount = IERC20(_token).balanceOf(address(this));  
        IERC20(_token).safeTransfer(SafeStorage, amount);
    }
    ...
    function deposit() external payable override onlyEarn {
        uint256 balanceBefore = VERNG.balanceOf(address(this));
        address[] memory path = new address[](2);
        path[0] = WMATIC;
        path[1] = address(VERNG);
        ...
        uint256 amount = VERNG.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            VERNG.transfer(shareholder, amount);
...
contract VertuMaster is ERC20, Auth {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    address public VERNG = 0xD3f6895928Bb1aA7811d2E08f8237994531396B0;
...
address public decentralizedDevelopment;
    ...
    function setVERC(address _VERNG) external authorized {
        VERNG = _VERNG;
    }
