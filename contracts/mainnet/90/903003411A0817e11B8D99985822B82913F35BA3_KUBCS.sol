...
contract KUBCS is ERC721, Ownable {
    ...
    constructor(string memory _uriPrefix) ERC721("KUBCS Genesis Pass", "KUBCS") {
    ...
    function _airdrop(address[] calldata _whitelist) public onlyOwner{
    ...
    event SetPaused(address indexed caller, bool state);
