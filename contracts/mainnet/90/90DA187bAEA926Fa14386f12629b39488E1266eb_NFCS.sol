    ...
    Version
{
    ...
    function execute(
        ...
        // check that the caller is another NFCS contract
        require(
            chainNameToAddress[sourceChain] == sourceAddress.toAddress(),
            Errors.NFCS_CROSS_CHAIN_UNVERIFIED
        );
...
library Errors {
    ...
    string public constant NFCS_CROSS_CHAIN_UNVERIFIED = "6"; // The caller of cross chain transaction is not NFCS contract itself
