...
// File: .deps/npm/@openzeppelin/contracts/Random.sol
...
contract NFTRandom is ERC20Burnable, Ownable {
    ...
    constructor(address _nftToken)
        ERC20("League of Kingdom Items", "LOK_ITEMS")
    {
    ...
    function withdrawNFTs(uint256 _amount) external {
        require(last >= first + _amount - 1, "Not enough NFTs available for withdrawal");
