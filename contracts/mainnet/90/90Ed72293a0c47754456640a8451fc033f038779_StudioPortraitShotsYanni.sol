...
contract StudioPortraitShotsYanni is ERC721, IERC2981, ReentrancyGuard, Ownable
{
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_)
    ERC721("Studio Portrait Shots Yanni", "SPS")
  {
  ...
  uint256 public constant MAX_SUPPLY = 9469;

  uint256 public constant MAX_MULTIMINT = 9469;
  ...
  function mint(uint256 count) public nonReentrant {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 9469 at a time");
