...
// 
contract MilkMango is ERC721, Ownable {
//    string internal baseUri;
		string public baseTokenURI;

    uint256 public cost = 0.05 ether;
    uint32 public maxPerMint = 2;
    uint32 public maxPerWallet = 1;
    uint32 public supply = 0;
    uint32 public totalSupply = 1111;
    bool public open = false;
    mapping(address => uint256) internal addressMintedMap;

    uint32 private commission = 1; 
    address private author = 0x6231831DB104decC84B8096C0ACebfEDB2D7F26d; 
...
abstract contract Presaleable is MilkMango {
...
contract MilkMangoX is MilkMango, Presaleable {
    constructor(
        string memory _uri,
        string memory _name,
        string memory _symbol,
        ...
        uint256 _cost,
        bool _open
    ) MilkMango(_uri, _name, _symbol, _totalSupply, _cost, _open) {}
