...
contract CyberLycan is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("CyberLycan", "CL"){
  }
  ...
  function mint(uint256 amount) external payable
  {
    ...
    require(mintEnabled, "Mint is not live yet, hold on Lycan");
    require(totalSupply() + amount < maxSupply + 1,"No more Lycans in stock");
