 ...
 * @notice This contract handles minting Bada Club NFT tokens.
 */
contract BadaClubNFT is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xdDB937FA2a2E9E155D8c07Fc5A6dbC525DD77622;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x11c6882f82426B2168F1bb103DB1e1D7337981de;
    address[] public payoutAddresses = [
        0x11c6882f82426B2168F1bb103DB1e1D7337981de
    ];
    ...
    string public name = "Bada Club NFT";
    string public symbol = "BADA";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeidxtsvzxphou6hg3jauz3jmt37lqufnfppe2lr6pmm3ngfwaenm7u/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[1] = 500;
        tokenPublicPrice[1] = 0.2 ether;
        tokenPublicMintsPerAddress[1] = 20;
        tokenMaxSupply[2] = 2000;
        tokenPublicPrice[2] = 0.2 ether;
        tokenPublicMintsPerAddress[2] = 2000;
        tokenMaxSupply[3] = 1500;
        tokenPublicPrice[3] = 0.2 ether;
        tokenPublicMintsPerAddress[3] = 1500;
        tokenMaxSupply[4] = 1500;
        tokenPublicPrice[4] = 0.2 ether;
        tokenPublicMintsPerAddress[4] = 1500;
        tokenMaxSupply[5] = 1500;
        tokenPublicPrice[5] = 0.2 ether;
        tokenPublicMintsPerAddress[5] = 1500;
        tokenMaxSupply[6] = 500;
        tokenPublicPrice[6] = 0.2 ether;
        tokenPublicMintsPerAddress[6] = 20;
        tokenMaxSupply[7] = 1000;
        tokenPublicPrice[7] = 0.2 ether;
        tokenPublicMintsPerAddress[7] = 1000;
        tokenMaxSupply[8] = 2000;
        tokenPublicPrice[8] = 0.2 ether;
        tokenPublicMintsPerAddress[8] = 2000;
        tokenMaxSupply[9] = 2000;
        tokenPublicPrice[9] = 0.2 ether;
        tokenPublicMintsPerAddress[9] = 2000;
        tokenMaxSupply[10] = 1500;
        tokenPublicPrice[10] = 0.2 ether;
        tokenPublicMintsPerAddress[10] = 1500;
        tokenMaxSupply[11] = 1000;
        tokenPublicPrice[11] = 0.2 ether;
        tokenPublicMintsPerAddress[11] = 1000;
        tokenMaxSupply[12] = 1000;
        tokenPublicPrice[12] = 0.2 ether;
        tokenPublicMintsPerAddress[12] = 1000;
        tokenMaxSupply[13] = 1000;
        tokenPublicPrice[13] = 0.2 ether;
        tokenPublicMintsPerAddress[13] = 1000;
        tokenMaxSupply[14] = 1000;
        tokenPublicPrice[14] = 0.2 ether;
        tokenPublicMintsPerAddress[14] = 1000;
        tokenMaxSupply[15] = 1500;
        tokenPublicPrice[15] = 0.2 ether;
        tokenPublicMintsPerAddress[15] = 1500;
        tokenMaxSupply[16] = 500;
        tokenPublicPrice[16] = 0.2 ether;
        tokenPublicMintsPerAddress[16] = 20;
        tokenMaxSupply[17] = 2000;
        tokenPublicPrice[17] = 0.2 ether;
        tokenPublicMintsPerAddress[17] = 2000;
        tokenMaxSupply[18] = 1500;
        tokenPublicPrice[18] = 0.2 ether;
        tokenPublicMintsPerAddress[18] = 1500;
        tokenMaxSupply[19] = 1500;
        tokenPublicPrice[19] = 0.2 ether;
        tokenPublicMintsPerAddress[19] = 1500;
        tokenMaxSupply[20] = 2000;
        tokenPublicPrice[20] = 0.2 ether;
        tokenPublicMintsPerAddress[20] = 2000;
        tokenMaxSupply[21] = 1500;
        tokenPublicPrice[21] = 0.2 ether;
        tokenPublicMintsPerAddress[21] = 1500;
        tokenMaxSupply[22] = 2000;
        tokenPublicPrice[22] = 0.2 ether;
        tokenPublicMintsPerAddress[22] = 2000;
        tokenMaxSupply[23] = 1500;
        tokenPublicPrice[23] = 0.2 ether;
        tokenPublicMintsPerAddress[23] = 1500;
        tokenMaxSupply[24] = 1500;
        tokenPublicPrice[24] = 0.2 ether;
        tokenPublicMintsPerAddress[24] = 1500;
        tokenMaxSupply[25] = 1500;
        tokenPublicPrice[25] = 0.2 ether;
        tokenPublicMintsPerAddress[25] = 1500;
        tokenMaxSupply[26] = 1500;
        tokenPublicPrice[26] = 0.2 ether;
        tokenPublicMintsPerAddress[26] = 1500;
        tokenMaxSupply[27] = 1500;
        tokenPublicPrice[27] = 0.2 ether;
        tokenPublicMintsPerAddress[27] = 1500;
        tokenMaxSupply[28] = 1500;
        tokenPublicPrice[28] = 0.2 ether;
        tokenPublicMintsPerAddress[28] = 1500;
        tokenMaxSupply[29] = 1500;
        tokenPublicPrice[29] = 0.2 ether;
        tokenPublicMintsPerAddress[29] = 1500;
        tokenMaxSupply[30] = 1000;
        tokenPublicPrice[30] = 0.2 ether;
        tokenPublicMintsPerAddress[30] = 1000;
        tokenMaxSupply[31] = 1000;
        tokenPublicPrice[31] = 0.2 ether;
        tokenPublicMintsPerAddress[31] = 1000;
        tokenMaxSupply[32] = 1500;
        tokenPublicPrice[32] = 0.2 ether;
        tokenPublicMintsPerAddress[32] = 1500;
        tokenMaxSupply[33] = 1000;
        tokenPublicPrice[33] = 0.2 ether;
        tokenPublicMintsPerAddress[33] = 1000;
        tokenMaxSupply[34] = 2000;
        tokenPublicPrice[34] = 0.2 ether;
        tokenPublicMintsPerAddress[34] = 2000;
        tokenMaxSupply[35] = 1500;
        tokenPublicPrice[35] = 0.2 ether;
        tokenPublicMintsPerAddress[35] = 1500;
        tokenMaxSupply[36] = 2000;
        tokenPublicPrice[36] = 0.2 ether;
        tokenPublicMintsPerAddress[36] = 2000;
        tokenMaxSupply[37] = 2000;
        tokenPublicPrice[37] = 0.2 ether;
        tokenPublicMintsPerAddress[37] = 2000;
        require(
