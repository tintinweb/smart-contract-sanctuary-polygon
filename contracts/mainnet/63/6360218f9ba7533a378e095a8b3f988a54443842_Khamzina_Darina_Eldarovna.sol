 ...
 */
 ...
 contract Khamzina_Darina_Eldarovna is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable, ERC721URIStorage, Ownable, ERC2981PerTokenRoyalties {
      ...
      * See {ERC721-tokenURI}.
      */
     constructor(string memory name_, string memory symbol_, address _headAdmin, address _admin) ERC721(name_, symbol_) {
