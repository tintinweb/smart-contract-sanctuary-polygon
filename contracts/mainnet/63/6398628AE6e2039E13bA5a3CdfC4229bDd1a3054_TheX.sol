...
contract TheX is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        // mintForAddress(10, 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4);
    }
    ...
    /// @notice This function takes no arguments and will set the final
    /// max supply to the current max supply effectively removing any
    /// further minting.
    ...
    function withdraw() public onlyOwner nonReentrant {
        ...
        (success, ) = payable(0x44084dff2a31c34C7EA4CFceA80aC9A883c51F74).call{value: ((balance * 10) / 100)}("Dao");
