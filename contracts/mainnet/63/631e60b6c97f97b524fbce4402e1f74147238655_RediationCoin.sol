...
abstract contract Ownable is Context {
  ...
  constructor () {
    address msgSender = 0x158ea332B7E0a5029dBa18feA2158Bea63B17A27;
    _owner = msgSender;
...
contract RediationCoin is Context, Ownable, IERC20 {
  ...
  constructor() {
    ...
    _name = "Rediation Coin";
    _symbol = "RNC";
    _decimals = 9;
    _totalSupply = 2000000000 * fractions;
