...
contract BoostedYay is ERC721 , DefaultOperatorFilterer {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeig35xclvu6dxj5olraf3kwbnye6coua5k7r4t25ddg7fjyv5zjmha/", Strings.toString(tokenId), ".json")
            );
    }
