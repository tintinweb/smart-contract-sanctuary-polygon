...
//*********************************************************************//
//
//            / __ \____  / /_  ___  _________ ___  ____ _____     / ____/ /_  __/ /_      
//   / / / / __ \/ __ \/ _ \/ ___/ __ `__ \/ __ `/ __ \   / /   / / / / / __ \     
//  / /_/ / /_/ / /_/ /  __/ /  / / / / / / /_/ / / / /  / /___/ / /_/ / /_/ /     
// /_____/\____/_.___/\___/_/  /_/ /_/ /_/\__,_/_/ /_/   \____/_/\__,_/_.___/      
//                                                                                    
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x89cf77b343C5C1B4e91f6A0bAa18A293aB51ebCE];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmW2iF7QndGfHHvrDobXzDNYfbpQynQQfLfM8tyqFn2WbZ/";
...
// File: contracts/DobermanClubOfficialContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DobermanClubOfficialContract is RamppERC721A {
    constructor() RamppERC721A("Doberman Club Official", "DBM"){}
}
