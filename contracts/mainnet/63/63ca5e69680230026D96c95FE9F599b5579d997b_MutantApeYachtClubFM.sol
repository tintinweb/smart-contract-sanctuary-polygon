...
contract MutantApeYachtClubFM is ERC721  {
    uint256 public totalSupply;
    uint256 public cost = 0 ether;
    uint256 public maxMints = 199;
    ...
    constructor()
        ERC721("Mutant Ape Yacht Club FM", "MAYCFM")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeicy5trg7wdq4mdan6gfoktoarohu3cc2tuoevvgpgavoxrakcksgi/", Strings.toString(tokenId), ".json")
            );
    }
