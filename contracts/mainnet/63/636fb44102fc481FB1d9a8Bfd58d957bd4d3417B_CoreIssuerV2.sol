...
contract CoreIssuerV2 is AccessControl, Pausable {
    ...
    mapping(uint256 => uint256) public _fees; // SBT _id => fee
    ...
    constructor(address _ABT, address relayer, address withdrawAddress, uint256 id) {
    ...
    /// @notice Sets the attestation fee for SBT.
    /// @param id The id of the SBT.
    /// @param fee The fee.
    function setFee(
        uint256 id,
    ...
    ) external payable whenNotPaused feeCheck(tokenId) {
