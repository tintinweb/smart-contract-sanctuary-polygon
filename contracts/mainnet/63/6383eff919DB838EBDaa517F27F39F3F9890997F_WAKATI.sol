...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9189e4e751D1B0BB2967E6B129391e4baE8fc38C;
...
contract WAKATI is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xf00274Ca05fa65BbEec11486dab26fb3Ae26CC2b;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "WAKATI";
    string private _symbol = "WAKI";
