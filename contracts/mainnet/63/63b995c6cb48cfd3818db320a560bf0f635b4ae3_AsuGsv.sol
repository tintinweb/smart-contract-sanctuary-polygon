...
contract AsuGsv is ERC1155Supply, Ownable, Pausable {
    ...
    function setSaleState(bool newState) public onlyOwner {
        require(saleIsActive != newState, "NEW_STATE_IDENTICAL_TO_OLD_STATE");
    ...
    /**
     * @notice Allow minting of tokens by addresses authorized to mint
     */
     ...
     */
    function adminMint(address account, uint256 id, uint256 amount) external onlyOwner
    {
    ...
    function gift(address[] calldata receivers, uint256 numberOfTokens) external onlyOwner {
        for (uint256 i = 0; i < receivers.length; i++) {
            _mint(receivers[i], 1, numberOfTokens, "");
        }
    }
