...
contract MadMetaYen is ERC20, ERC20Burnable, Ownable {
    bool public paused;
    uint256 public burnedTokens;
    uint256 public totalClaimedTokens;
    address public adminRoleA;
    address public adminRoleB;
    mapping(address => uint256) public claimedTokens;


    constructor() ERC20("MadMetaYen", "MMYEN") {
    }

    function airdrop(address _to, uint256 _amount) public onlyOwner {
        require(!paused, "Smart contract is currently paused");
        _mint(_to, _amount);
    ...
    function claim(address _to, uint256 _amount) public {
        require(!paused, "Smart contract is currently paused");
        require(verifyRole(), "Unauthorized");
        _mint(_to, _amount);
        claimedTokens[_to] += _amount;
        totalClaimedTokens += _amount;
    }

    function verifyRole() internal view returns (bool) {
        return msg.sender == adminRoleA || msg.sender == adminRoleB;
    }
