...
contract GRGNFT is ERC721A, Ownable, ReentrancyGuard, RoyaltiesV2Impl {
    ...
    uint96 public        devPercent = 1000; // 10%

    bytes4 private constant _INTERFACE_ID_ERC2981 = 0x2a55205a;

    constructor() ERC721A("Glenn Robins", "GR"){
        devWallet = payable(0x7B7887059860a1A21f3C62542B6CE5c0a23c76d5);
    ...
    function mint(uint256 numberOfTokens) external {
        ...
        setRoyalties(totalSupply(), devWallet, devPercent);
        _safeMint(msg.sender, numberOfTokens);

    }

    function mintByOwner(address to, uint256 numberOfTokens) external onlyOwner {
        require(totalSupply() + numberOfTokens < maxSupply + 1, "we're sold out!");
    ...
    function setDevPercent(uint96 _percent) external onlyOwner {
        devPercent = _percent; // 1000 = 1%
    }
