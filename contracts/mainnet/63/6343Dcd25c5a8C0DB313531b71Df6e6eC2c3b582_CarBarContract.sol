    ...
    ReentrancyGuardUpgradeable
{
    ...
    function createCollection(
        ...
        createCollectionItem(collectionId, name, tokenCount, price, expiryDate);
    ...
    function createCollectionItem(
        ...
        _collectionItems[collectionId] = CollectionItem(collectionId, name, tokenCount, price, expiryDate);
        emit CollectionItemCreated(collectionId, name, tokenCount, price, expiryDate);
    ...
    function uri(uint256 tokenId) public pure override returns (string memory) {
        ...
        return string.concat("http://20.68.212.46:8081/nft_json/x1_", tokenId.toString(), ".json");
    }
}