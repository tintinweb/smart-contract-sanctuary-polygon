...
contract StakingModule is ReentrancyGuardUpgradeable, AccessControlEnumerableUpgradeable {
    ...
    ************************************************/
    ...
    function _partialExit(address account, address to, uint256 exitAmount) private {
        if (exitAmount == 0) {
            return;
        }
    ...
    ************************************************/
    ...
    function removePluginAdmin(uint256 index) external onlyRole(DEFAULT_ADMIN_ROLE) {
