...
contract OracleProviderFacet {
    WalletStorage internal s;

    /**
     * @notice Update address of the connector token
     * @param _oracleProvider new address of the oracle proivder
     */
    function setOracleProvider(address _oracleProvider) external {
        LibDiamond.enforceIsContractOwner();
        s.oracleProvider = _oracleProvider;
    }

    /**
     * @notice get oracle provider address
     */
    function oracleProvider() external view returns (address) {
        return s.oracleProvider;
    }
}
