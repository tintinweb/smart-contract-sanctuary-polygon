...
contract PinkHuntersSHIB {
	using SafeMath for uint256;
	using SafeERC20 for IERC20;

	address private tokenAddr = 0x6f8a06447Ff6FcF75d803135a7de15CE88C1d4ec; // Shib Inu Token
	IERC20 public token;

	uint256 constant public INVEST_MIN_AMOUNT = 1000 ether; //1000 Shib
	...
	constructor(address payable ownerAddr, address payable ceoAddr, address payable dev1Addr, address payable dev2Addr, uint256 start) public {
        ...
        plans.push(Plan(30,  50)); //30days 5% daily
	}
