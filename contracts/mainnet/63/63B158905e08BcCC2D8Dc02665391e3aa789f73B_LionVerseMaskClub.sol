...
contract LionVerseMaskClub is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("LionVerse Mask Club", "LMC") {
    setHiddenMetadataUri("ipfs:/QmWUxVvxgth62E1y4JhkCjc2yRnGrbzWbc44gBuu46avjh/hidden.json");
  }
