    ...
    RevokableDefaultOperatorFilterer
{
    ...
    string public uriPrefix = "ipfs://bafybeida7xpfwdfgrnbrfg4idgrsx2ouoz4rzjedawo6ptv77pnyj6ux5i/";

    uint256 public maxSupply = 7777;

    constructor() ERC721A("Nyoverse", "NYOVERSE") {
        royaltyReceiver = address(0x545Ff430b6EAb009f28c8035d84414c0453628fC);
    }
     ...
     * @param _royalties is new percentage of royalties. It should be 0 ~ 90
     */
        ...
        returns (address receiver, uint256 royaltyAmount)
    {
        ...
        return (royaltyReceiver, (_salePrice * royalties) / _feeDenominator());
    }
    ...
    function mintForAddress(
        ...
        uint256 _batch_size = 32;
        uint256 _batch_count = uint256(amount / _batch_size);
        for (uint256 i = 0; i < _batch_count; i++) {
            _safeMint(_receiver, _batch_size);
        }
        uint256 _remaining = amount - (_batch_count * _batch_size);
        if (_remaining > 0 && _remaining <= amount) {
            _safeMint(_receiver, _remaining);
        }
    }
