...
contract ERC20Basic is IERC20{
    ...
    string public constant name = "Derechos de Usufructo de Invierte en Venezuela";
    string public constant symbol = "INV.B";
    uint8 public constant decimals = 2;

    string public constant FormatoContrato = "Negociación de los Títulos Valores\
\
...
Valores: INV.B\
Monto Nominal: 16975000\
Símbolo: INV.B\
Monto de Efectivo: 1 INV.B en Central+ por cada 100 INV.B en la blockchain de Polygon o Binance SmartChain o cualquiera\
