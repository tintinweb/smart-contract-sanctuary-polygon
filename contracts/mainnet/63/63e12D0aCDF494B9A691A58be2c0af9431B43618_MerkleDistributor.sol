...
interface IMerkleDistributor {
     ...
     * @return true if claim is no longer valid.
     */
    function isClaimed(uint256 index) external view returns (bool);

    /**
     * @dev Claim the given amount of the token to the given address. Reverts if the inputs are invalid.
     * @param index merkle tree index for the claim.
     * @param account reward beneficiary address.
     * @param merkleProof claim if form of merkle proof.
     */
...
/**
 * @dev ERC20 token with minting interface.
 */
