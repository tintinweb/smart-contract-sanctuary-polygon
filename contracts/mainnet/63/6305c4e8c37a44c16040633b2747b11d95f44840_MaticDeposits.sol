...
contract MaticDeposits is Context, Ownable {
    ...
    constructor() {
        ...
        MPT = IERC20(0x9182e7DAdf061C5977918f88e57CAFDb81D2b80B);	// MATICProV2
    ...
    function Deposit(uint256 amount) public payable {        
        ...
        MPT.safeTransferFrom(msg.sender, dev, amount);
		Deposits[msg.sender] = SafeMath.add(Deposits[msg.sender],amount);
	    total_deposits = SafeMath.add(total_deposits,amount);
