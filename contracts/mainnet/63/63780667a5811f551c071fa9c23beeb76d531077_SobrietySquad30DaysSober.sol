...
// File: contracts/30DaysSoberCoin.sol
...
contract SobrietySquad30DaysSober is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("30 DAYS SOBER Coin", "SOBER30Day") {
    setHiddenMetadataUri("ipfs://Qma391YUJtwV7g748qMAB29sCDQGDvbupM1BsHLwzZXP1e/preview.json");
  }
