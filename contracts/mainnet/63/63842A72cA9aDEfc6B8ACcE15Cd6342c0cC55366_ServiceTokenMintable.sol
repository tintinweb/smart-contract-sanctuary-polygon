...
contract ServiceTokenMintable is BaseERC20Token, IMintable {
    /**
     ...
     * @dev creates `amount` tokens to `to`.
     */
    function mint(address to, uint256 amount) external override nonERC2771 onlyOwner {
        _mint(to, amount);
    }
    ...
    function version() external pure override returns (string memory) {
        return "service-token-mintable-v1.0.0";
    }
}