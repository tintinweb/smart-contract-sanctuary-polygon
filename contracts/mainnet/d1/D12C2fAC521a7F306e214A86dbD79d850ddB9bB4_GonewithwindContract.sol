    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 100, 98983001) { }
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 98983001");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 98983001");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 98983001");
...
// File: contracts/GonewithwindContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GonewithwindContract is RamppERC721A {
    constructor() RamppERC721A("Gone with wind", "GWW"){}
}