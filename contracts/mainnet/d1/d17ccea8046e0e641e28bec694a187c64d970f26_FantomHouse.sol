...
contract FantomHouse is VRFConsumerBaseV2, Ownable, ReentrancyGuard {
	...
	//
	address private constant TOKEN_ADDRESS = 0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619;
	...
	//  > 200 gwei 0x6e099d640cde6de9d40ac749b4b594126b0169747122711109c9985d47751f93
    ...
    uint64 private s_subscriptionId = 97;
    ...
    uint16 requestConfirmations = 3; // Minimum is 3 on POLYGON
    uint32 numWords = 1;
	...
	// Minimum Bet & Deposit=============================================================
    //
	uint256 minBet = 1000000000000; // default 0.000001 wETH, worth 0.15 Cents ATM.
    ...
    uint256 minDeposit = 100000000000000; // default 0.0001 wETH, worth 15 Cents ATM.
	...
	uint256 vrfFee= 15000000000000000; // default 0.015 MATIC. 1.35 Cents ATM
   ...
   function refund(uint256 _betId) external nonReentrant {
        ...
        // 100 Block is about 4~5 minutes in POLYGON
    ...
    function bet(uint256 _betAmount, uint256 _odd) external payable nonReentrant {
        ...
        if (_lastBetBlock != 0 && block.number - _lastBetBlock < 1) {
            revert("You are placing bet too fast. Please wait at least 2.5 seconds.");
        }
