...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x6A311793d0A1e82495e4A8fc2e137E709492cB18];
  address public erc20Payable = 0x6A311793d0A1e82495e4A8fc2e137E709492cB18;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmUhdk3E2NmsZNt3yk9ECakxYBe1saQv9BjRdvMUy175od/";
...
// File: contracts/NftLogoforMftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NftLogoforMftContract is RamppERC721A {
    constructor() RamppERC721A("NFT Logo for MFT", "MFT"){}
}
