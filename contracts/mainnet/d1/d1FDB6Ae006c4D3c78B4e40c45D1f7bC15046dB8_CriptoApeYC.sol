...
contract CriptoApeYC is ERC721  {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeidhaoiyo4vypnsu7q53gky5x67f6tukm5vlkvihykvmdzf5g6vjsa/", Strings.toString(tokenId), ".json")
            );
    }
