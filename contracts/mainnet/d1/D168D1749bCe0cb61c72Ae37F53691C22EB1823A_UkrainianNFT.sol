...
contract UkrainianNFT is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Ukrainian Pride official", "UKRPRD") {
    setHiddenMetadataUri("ipfs://QmUko6opgdwPDXpGUtr5rv59dsuTSdMTWrUzFBwJ4n6V3g/hidden.json");
  }
