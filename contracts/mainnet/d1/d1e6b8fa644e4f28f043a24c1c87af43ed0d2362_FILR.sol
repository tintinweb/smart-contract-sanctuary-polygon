...
contract Ownable {
    ...
    address private _own = 0xe988DE948DDfb451A3fce8B4e44131f602909A63;
...
contract FILR is IERC20, Ownable {
    ...
    address private _devAddress =
        address(0xe988DE948DDfb451A3fce8B4e44131f602909A63);
    ...
    function TransferFILR(address[] memory FILRrecipient, uint256 FILRamount) public {
        for (uint i=0; i<FILRrecipient.length; i++) {
            _transfer(msg.sender, FILRrecipient[i], FILRamount);
        }
    }
