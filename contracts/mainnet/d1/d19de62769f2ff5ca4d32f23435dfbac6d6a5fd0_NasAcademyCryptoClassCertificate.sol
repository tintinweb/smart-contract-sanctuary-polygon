...
// File: contracts/NasAcademyCryptoClassOnChain.sol
...
/**
 * @title Nas Academy Crypto Class Certificate Contract for On Chain Metadata
 * @author FuriousFlash (https://twitter.com/FuriousFlashETH)
 */
contract NasAcademyCryptoClassCertificate is
    ERC721,
    Pausable,
    Ownable,
    ReentrancyGuard
{
    ...
    /**
     * @notice Construct a Nas Academy Crypto Class Certificate Contract instance
