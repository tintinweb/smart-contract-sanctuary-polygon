...
contract HelloWorld is Ownable, ERC721, NonblockingReceiver {
    ...
    uint256 nextTokenId = 2049;
    uint256 MAX_MINT_ETHEREUM = 2560;
    uint256 cost = 20 ether;

    uint gasForDestinationLzReceive = 350000;

    constructor(string memory baseURI_, address _layerZeroEndpoint) ERC721("HelloWorld", "HW") {
        _owner = msg.sender;
    ...
    function mint(uint8 _mintAmount) external payable {
        ...
        require(nextTokenId + _mintAmount <= MAX_MINT_ETHEREUM, "Mint exceeds supply");
