...
contract BuyMinerNFT is Ownable {
    ...
    uint256 public ratePoint = 95;
    uint256 public basePoint = 100;
    uint256 public period = 1800;

    uint256 public upRate = 5;
    uint256 public upBase = 100;

    uint256 private _rangeAllowed = 200;
    ...
    function setDownPrice(uint256 _ratePoint, uint256 _basePoint, uint256 _period) public onlyOwner() {
