 ...
 * @dev
 */
interface IKIP37Receiver is IERC165 {
    /**
 ...
 * _Available since v3.1._
 */
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI, IERC1155Metadata {
    ...
    function _doSafeTransferAcceptanceCheck(
        ...
        bytes memory data
         ...
         require(_checkOnERC1155Received(operator, from, to, id, amount, data) ||
    ...
    function _doSafeBatchTransferAcceptanceCheck(
        ...
        require(_checkOnERC1155BatchReceived(operator, from, to, ids, amounts, data) ||
...
contract ERC1155Token is ERC1155, AccessControl, Pausable, ERC1155Burnable, ERC1155Supply, Ownable {
  ...
  function initialize(address _owner, string memory _name, string memory _symbol, string memory _baseUri) public {
    ...
    function uri(uint256 _id) public view virtual override returns (string memory) {
        require(exists(_id), "ERC1155: non exists");
