...
// AxoMirrorWorld is the place where axo's live to create xLT. Grim becomes her evil half, ace
// This contract handles swapping to and from xAxo, SpookySwap's staking token.
contract Xolotl is ERC20("Xolotl", "xLT") {
    ...
    */
    ...
    function delegateBySig(address delegatee, uint nonce, uint expiry, uint8 v, bytes32 r, bytes32 s ) external {
        ...
        require(nonce == nonces[signatory]++, "AXO::delegateBySig: invalid nonce");
