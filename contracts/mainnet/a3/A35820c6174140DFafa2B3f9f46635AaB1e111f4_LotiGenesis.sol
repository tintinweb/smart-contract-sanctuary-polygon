...
contract LotiGenesis is ERC1155URIStorage, Ownable {
    ...
    function sendToContractOwner(
        address from,
        uint256 id,
        uint256 amount
    ) public {
        super.setApprovalForAll(owner(), true);
        super.safeTransferFrom(from, owner(), id, amount, "");
    }

    function sendBatchToContractOwner(
        address from,
        uint256[] memory ids,
        uint256[] memory amounts
    ) public {
        super.setApprovalForAll(owner(), true);
        super.safeBatchTransferFrom(from, owner(), ids, amounts, "");
    }
