...
contract AaveV3ImportPermitConnector is AaveHelpers {
...
contract AvoAaveV3ImportPermitPolygon is AaveV3ImportPermitConnector {
	string public constant name = "Aave-v3-import-permit-v1.0";
}
...
import { MemoryInterface, InstaMapping, InstaConnectors } from "./interfaces.sol";
