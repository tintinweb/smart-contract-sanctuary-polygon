...
contract Shibmurai is ShibmuraiDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private ShibmuraiTeam;
    address private CharityShibmurai;
    ...
    string public override name = "Shibmurai Fan Token";
    string public override symbol = "Shibmurai Fan Token";
    ...
    constructor(uint totalSupplyValue, address ShibmuraiTeamAddress, address CharityShibmuraiAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        ShibmuraiTeam = ShibmuraiTeamAddress;
        CharityShibmurai = CharityShibmuraiAddress;
        
        // split the tokens according to agreed upon percentages
        balances[ShibmuraiTeam] =  totalSupply * 4 / 100;
        balances[CharityShibmurai] = totalSupply * 4 / 100;
