...
contract JoJonNFT is ERC721, ERC721Enumerable, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("JoJon NFT", "JoJon") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://i.seadn.io/gcs/files/ba246c4910b567885ecd62926f3f2c50.jpg?";
    }
