...
// File contracts/interfaces/IBarn.sol
...
contract Barn is Ownable, IERC721Receiver, Pausable, ReentrancyGuard {
   ...
   */
  function _addSheepToBarn(address account, uint256 tokenId) internal whenNotPaused _updateEarnings nonReentrant {
    barn[tokenId] = Stake({
      owner: account,
   ...
   */
  function _addWolfToPack(address account, uint256 tokenId) internal nonReentrant {
