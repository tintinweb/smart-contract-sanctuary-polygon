...
// File: ERC2981PerTokenRoyalties.sol
 ...
 */
 ...
 contract Cryptomusic is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable, ERC721URIStorage, Ownable, ERC2981PerTokenRoyalties {
      ...
      * See {ERC721-tokenURI}.
      */
     constructor(address payable _admin) ERC721("UNKI - Royalty", "UR") {
          _setupRole(DEFAULT_ADMIN_ROLE, _admin);
          _setupRole(MINTER_ROLE, _admin);
          _setupRole(MINTER_ADMIN_ROLE, _admin);
