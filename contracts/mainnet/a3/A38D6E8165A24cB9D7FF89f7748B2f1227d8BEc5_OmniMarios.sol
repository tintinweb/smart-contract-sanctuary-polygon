...
/***
 *    _______/\\\\\________/\\\\____________/\\\\___/\\\\\_____/\\\___/\\\\\\\\\\\_
 *     _____/\\\///\\\_____\/\\\\\\________/\\\\\\__\/\\\\\\___\/\\\__\/////\\\///__
 *      ___/\\\/__\///\\\___\/\\\//\\\____/\\\//\\\__\/\\\/\\\__\/\\\______\/\\\_____
 *       __/\\\______\//\\\__\/\\\\///\\\/\\\/_\/\\\__\/\\\//\\\_\/\\\______\/\\\_____
 *        _\/\\\_______\/\\\__\/\\\__\///\\\/___\/\\\__\/\\\\//\\\\/\\\______\/\\\_____
 *         _\//\\\______/\\\___\/\\\____\///_____\/\\\__\/\\\_\//\\\/\\\______\/\\\_____
 *          __\///\\\__/\\\_____\/\\\_____________\/\\\__\/\\\__\//\\\\\\______\/\\\_____
 *           ____\///\\\\\/______\/\\\_____________\/\\\__\/\\\___\//\\\\\___/\\\\\\\\\\\_
 *            ______\/////________\///______________\///___\///_____\/////___\///////////__
 *                        .-. .-.
 *                      (   |   )
 *                    .-.:  |  ;,-.
 *                   (_ __`.|.'__ _)
 ...
 *    __/\\\\____________/\\\\______/\\\\\\\\\________/\\\\\\\\\_______/\\\\\\\\\\\________/\\\\\___________/\\\\\\\\\\\___
 *     _\/\\\\\\________/\\\\\\____/\\\\\\\\\\\\\____/\\\///////\\\____\/////\\\///_______/\\\///\\\_______/\\\/////////\\\_
 *      _\/\\\//\\\____/\\\//\\\___/\\\/////////\\\__\/\\\_____\/\\\________\/\\\________/\\\/__\///\\\____\//\\\______\///__
 *       _\/\\\\///\\\/\\\/_\/\\\__\/\\\_______\/\\\__\/\\\\\\\\\\\/_________\/\\\_______/\\\______\//\\\____\////\\\_________
 *        _\/\\\__\///\\\/___\/\\\__\/\\\\\\\\\\\\\\\__\/\\\//////\\\_________\/\\\______\/\\\_______\/\\\_______\////\\\______
 *         _\/\\\____\///_____\/\\\__\/\\\/////////\\\__\/\\\____\//\\\________\/\\\______\//\\\______/\\\___________\////\\\___
 *          _\/\\\_____________\/\\\__\/\\\_______\/\\\__\/\\\_____\//\\\_______\/\\\_______\///\\\__/\\\______/\\\______\//\\\__
 *           _\/\\\_____________\/\\\__\/\\\_______\/\\\__\/\\\______\//\\\___/\\\\\\\\\\\_____\///\\\\\/______\///\\\\\\\\\\\/___
 *            _\///______________\///___\///________\///___\///________\///___\///////////________\/////__________\///////////_____
 *
 *
 *
 */
...
contract OmniMarios is ERC721, NonblockingReceiver, ILayerZeroUserApplicationConfig {

    using Strings for uint256;
    string public baseTokenURI;
    uint256 public nextTokenId;
    uint256 maxMint;
    uint256 maxMintPerTransaction = 15;
    uint256 tokenPrice = 5 ether;
    address _owner;
    uint256 devReserveAmount = 20;
    ...
    // Whitelist Dev Reserve
    function devReserve(uint256 numberOfTokens) external onlyOwner{
        require(devReserveAmount + numberOfTokens <= 20, "Dev reserve limit reached");
        require(nextTokenId + numberOfTokens <= maxMint,"Purchase would exceed max mint limit at this chain");
        for(uint256 i = 0; i < numberOfTokens; i++){
            uint256 id = ++nextTokenId;
            if(id <= maxMint){
