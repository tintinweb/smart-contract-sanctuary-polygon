...
contract bear is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeigkefpaw2fspa2y6cffydg5jgvr5pdxtjozm2fssdsag7zf33j2ea/", Strings.toString(tokenId), ".json")
            );
    }
