...
/// @title Beluga Vault Proxy
/// @author Chainvisions & Harvest.finance (Proxy forked from Harvest)
/// @notice Proxy for Beluga's vault contracts.
...
contract VaultProxy is BaseUpgradeabilityProxy {
    ...
    */
    ...
    /// @return The implementation of the vault proxy.
