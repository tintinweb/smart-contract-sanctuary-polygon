...
contract JacksPremix is ERC721A("Jack's Premix NFT", "JPNFT"), Ownable {
     ...
     function mintChunk(uint256 chunkSize) public onlyOwner { 
          require(chunkSize <= 450, "Chunk size must be <= 450"); //ERC721A quirk
          require(totalSupply() + chunkSize <= TOTAL_SUPPLY, "Cannot mint over total supply");
          _mint(owner(), chunkSize);
     }
