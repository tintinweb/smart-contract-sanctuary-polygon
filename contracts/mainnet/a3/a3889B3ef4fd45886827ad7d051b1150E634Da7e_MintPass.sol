...
{
    // ----------------------------------------ENUMS----------------------------------------
    enum PassType {INVALID, PAID, FREE}
    ...
    constructor(
        ...
        setURI(uint256(PassType.PAID), uri1);
        setURI(uint256(PassType.FREE), uri2);
    }

    function setURI(uint256 tokenId, string memory __uri) public onlyAdmin {
        _uris[tokenId] = __uri;
    }
        ...
        onlyAdmin
    {
        ...
        _mint(recipient, uint256(pass), amount, bytes(""));
    }
}
