...
contract BAPE is BAPEDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private BAPETeam;
    address private CharityBAPE;
    ...
    string public override name = "BabyApe";
    string public override symbol = "BAPE";
    ...
    constructor(uint totalSupplyValue, address BAPETeamAddress, address CharityBAPEAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        BAPETeam = BAPETeamAddress;
        CharityBAPE = CharityBAPEAddress;
        
        // split the tokens according to agreed upon percentages
        balances[BAPETeam] =  totalSupply * 4 / 100;
        balances[CharityBAPE] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's BAPETeam pot
