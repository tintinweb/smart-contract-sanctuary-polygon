...
contract CrossChainFrog is ONFT721 {

    uint32 constant minGasToTransfer = 250_000;
    uint8 constant maxSupply = 10;
    uint8 public supplyCounter = 0;
    address constant lzEdnpoint = 0x3c2269811836af69497E5F486A85D7316753cf62;

    // creation of new L0 NFT contract
    // _lzEndpoint - address of L0 endpoint contract on the deployment chain
    // Polygon, Avalanche, Arbitrum, Optimism - '0x3c2269811836af69497E5F486A85D7316753cf62'
    constructor() ONFT721('CrossChainFrog', 'CCF', minGasToTransfer, lzEdnpoint) {}

    function mint(address to) external {
        require(supplyCounter < maxSupply, 'Max supply reached');
