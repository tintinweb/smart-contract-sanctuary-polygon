    ...
    CompatibilityFallbackHandler
{
    ...
    /// @param accountVersion The Instadapp account version number (e.g. 2 is most recent).
    /// @param accountOrigin Address(0) is the default.
    /// @param _chainId Chain id of the chain (e.g. 137 for polygon)
    function initialize(IGnosisSafe _safe, IInstaIndex _index, uint accountVersion, address accountOrigin, uint256 _chainId) external {
        ...
        createAccount(accountVersion, accountOrigin);
        initialized = true;
    }
