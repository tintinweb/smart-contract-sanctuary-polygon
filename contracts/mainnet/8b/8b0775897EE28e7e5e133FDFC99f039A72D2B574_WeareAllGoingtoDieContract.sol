...
//*********************************************************************//
//
// __        __                         _    _ _    ____       _               _           ___       ____  _      
//  \ \      / /__    __ _ _ __ ___     / \  | | |  / ___| ___ (_)_ __   __ _  | |_ ___    / _ \__  _|  _ \(_) ___ 
//   \ \ /\ / / _ \  / _` | '__/ _ \   / _ \ | | | | |  _ / _ \| | '_ \ / _` | | __/ _ \  | | | \ \/ / | | | |/ _ \
//    \ V  V /  __/ | (_| | | |  __/  / ___ \| | | | |_| | (_) | | | | | (_| | | || (_) | | |_| |>  <| |_| | |  __/
//     \_/\_/ \___|__\__,_|_|  \___|_/_/   \_\_|_|  \____|\___/|_|_| |_|\__, |  \__\___/   \___//_/\_\____/|_|\___|
//                | __ ) _   _|  \/  | __ _ ___| |_ ___ _ __ / _ \ \/ / |___/                                      
//                |  _ \| | | | |\/| |/ _` / __| __/ _ \ '__| | | \  /                                             
//                | |_) | |_| | |  | | (_| \__ \ ||  __/ |  | |_| /  \                                             
//                |____/ \__, |_|  |_|\__,_|___/\__\___|_|   \___/_/\_\            
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x67167a1fcC3997880A4CA7A01989f287D4B7Ec5b];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 500, 1770 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmYi4vo6hwAgf6b3hAuCy2nKcgwPiz5jxQEoQaytsVti7f/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 1770");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 1770");
...
// File: contracts/WeareAllGoingtoDieContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WeareAllGoingtoDieContract is RamppERC721A {
    constructor() RamppERC721A("We are All Going to 0xDie", "0xDie"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/PuYfxxs01TZn55nA24Xw/contract-metadata";
    }
}
