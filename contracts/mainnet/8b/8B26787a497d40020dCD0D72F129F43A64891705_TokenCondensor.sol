...
contract TokenCondensor is BaseSiloAction {
        ...
        )
    {
        ...
        console.log(
            "############## directTokenCondense   inputAmounts0: %s  inputAmounts1: %s",
            inputAmounts[0],
            inputAmounts[1]
        );

        console.log(
            "############## directTokenCondense   inputAmounts2: %s  inputAmounts3: %s",
            inputAmounts[2],
            inputAmounts[3]
        );
        ...
        console.log(
            "############## directTokenCondense   outputAmounts0: %s  outputAmounts1: %s",
            outputAmounts[0],
            outputAmounts[1]
        );

        console.log(
            "############## directTokenCondense   outputAmounts2: %s  outputAmounts3:%s",
            outputAmounts[2],
            outputAmounts[3]
        );
