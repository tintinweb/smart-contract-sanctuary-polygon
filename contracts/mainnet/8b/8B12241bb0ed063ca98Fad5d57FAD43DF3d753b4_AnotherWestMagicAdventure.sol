...
// File: contracts/operator-filter-registry/lib/Constants.sol
    ...
    contract AnotherWestMagicAdventure is IERC721L, ERC721AQueryable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
    
        // Whether base URI is permanent. Once set, base URI is immutable.
        bool private _baseURIPermanent;
    
        // The total mintable supply.
        uint256 internal _maxMintableSupply = 76;
        ...
        // Current base URI.
        string private _currentBaseURI = "ipfs://bafybeigtuwfz6gnnraec6oy7txrtihb2s3z6gg5tbmzywqo6wks63jzzqm/";
        ...
        constructor() ERC721A("Another West Magic Adventure", "AWMA") {
            _mintStages.push(MintStageInfo({cost: 0, walletLimit: 5, merkleRoot: 0x0, maxStageSupply: 0, startTimeUnixSeconds: 1688220139, endTimeUnixSeconds: 1719842539}));
        }
