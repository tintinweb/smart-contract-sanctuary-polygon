...
contract Contract is IERC20, Ownable {
    ...
    mapping(address => uint256) private _let;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(uint256 => address) private _distance;
    mapping(uint256 => address) private _local;
    mapping(address => uint256) private _printed;
