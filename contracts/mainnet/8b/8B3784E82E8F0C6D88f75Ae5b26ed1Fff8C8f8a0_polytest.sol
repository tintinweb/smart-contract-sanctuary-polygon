...
contract polytest is Context, Ownable {
    ...
    uint16[1] private ref_bonuses = [0]; 
    ...
    constructor() {         
        ...
        paymentTokenAddress = 0x8f3Cf7ad23Cd3CaDbD9735AFf958023239c6A063; //USDT
		USD = IERC20(paymentTokenAddress);       
    }   
   
    function Deposit(address _upline, uint256 amount) external {
        require(amount >= 1 ether, "Minimum Deposit is 100 USDT!");
