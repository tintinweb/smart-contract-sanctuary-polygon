    ...
    RoyaltiesV2Impl
{
    ...
    function setRoyaltyInfo(
        ...
        require(
            ...
            "ERC1155: must have minter role to change royalties"
        );
        LibPart.Part[] memory _royalties = new LibPart.Part[](1);
        _royalties[0].value = _royaltyFeesInBips;
        _royalties[0].account = payable(_receiver);
    ...
    function supportsInterface(
        bytes4 interfaceId
    ) public view override(ERC1155PresetMinterPauser, ERC2981) returns (bool) {
