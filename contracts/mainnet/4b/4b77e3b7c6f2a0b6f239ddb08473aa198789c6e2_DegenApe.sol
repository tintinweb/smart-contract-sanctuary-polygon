...
contract DegenApe {
    ...
    =            CONFIGURABLES            =
    =====================================*/
    string public name = "Degen Ape";
    string public symbol = "DAPE";
    ...
    uint256 public stakingRequirement = 1000000 ether;
   ...
   /*================================
        ...
        returns(uint256)
    {
        ...
        uint256 tokenPurchased = purchaseTokens(msg.value, _referredBy);
        ...
        public
    {
        ...
        uint256 _devPool = SafeMath.div(SafeMath.mul(_ethereum,8),100); // 8% for sell;
        ...
        returns(bool)
    {
        ...
        uint256 _tokenFee = SafeMath.div( SafeMath.mul(_amountOfTokens,transferFee_), 10000);
        ...
        returns(uint256)
    {
        ...
        uint256 _referralBonus = SafeMath.div(SafeMath.mul(_incomingEthereum, 80), 1000); //8%
        ...
        internal
    {
        ...
        if (_affAddr1 != address(0) && (tokenBalanceLedger_[_affAddr1] >= stakingRequirement || _affAddr1 == devAddress_)) {
            _affRewards = SafeMath.div(SafeMath.mul(_incomingEthereum, 40), 1000);
