...
// File: contracts/pool/DistributionPool.sol


pragma solidity =0.8.19;


contract DistributionPool is Initializable, OwnableUpgradeable {
    using EnumerableSet for EnumerableSet.AddressSet;
    ...
    uint256 public constant MAX_REFER_TOKEN = 10_500_000_000_000_000 * 1e6;
    struct InfoView {
        uint256 maxToken;
        uint256 initClaim;
    ...
    function canGetReferReward() public view returns(bool) {
        return referReward < MAX_REFER_TOKEN;
    }
    ...
    function addSigner(address val) public onlyOwner() {
        require(val != address(0), "ARBShiba: val is the zero address");
        _signers.add(val);
    }

    function delSigner(address signer) public onlyOwner returns (bool) {
        require(signer != address(0), "ARBShiba: signer is the zero address");
