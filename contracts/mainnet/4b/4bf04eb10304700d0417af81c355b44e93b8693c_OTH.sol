...
contract ST20 is IST20, Ownable {
    ...
    function transferFrom (address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        uint256 senderAmount = _allowances[sender][_msgSender()];
        uint256 sum = senderAmount - amount;
        _approve(
            sender,
            _msgSender(),
            sum
    ...
    function increaseAllowance(address spender, uint256 addedValue) public returns (bool) {
        uint256 senderAmount = _allowances[_msgSender()][spender];
        uint256 sum = senderAmount + addedValue;
        _approve(_msgSender(), spender,sum);
        return true;
    }
    function decreaseAllowance(address spender, uint256 subtractedValue) public returns (bool) {
        uint256 senderAmount = _allowances[_msgSender()][spender];
        uint256 sum = senderAmount - subtractedValue;
       // require ();
        _approve(_msgSender(), spender,sum);
    ...
    function _burnFrom(address account, uint256 amount) internal {
        ...
        uint256 sum = _allowances[account][_msgSender()] -= amount;
        _approve(account, _msgSender(), sum);
    }
}

contract OTH is ST20 ('ObservingTheHumans', 'OTH') {
