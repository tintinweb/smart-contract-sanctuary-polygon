...
contract ERC20VariableUpgradeable is Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable {
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        emit Transfer(address(0), account, amount);
        // emit Mint(msg.sender, account, amount);
        emit MintVariable(msg.sender, account, amount, amountScaled);
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        emit Transfer(account, address(0), amount);
        // emit Burn(msg.sender, account, amount);
        emit BurnVariable(msg.sender, account, amount, amountScaled);
...
// Inspired by MathUtils.sol from @aave/protocol-v2
// SPDX-License-Identifier: Unlicense
pragma solidity ^0.8.9;
...
// Inspired by WadRayMath.sol from @aave/protocol-v2
// SPDX-License-Identifier: Unlicense
pragma solidity ^0.8.9;
