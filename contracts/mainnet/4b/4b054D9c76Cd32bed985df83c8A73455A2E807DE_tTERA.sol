...
This is the only official Twitter for the tTERA Games Ecosystem.
DISCORD: http://tTERAGames.chat
HELP: http://Support.tTERA.Games
The tTERAversetTERA.games
*/
...
contract tTERA is tTERADeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private tTERATeam;
    address private CharitytTERA;
    ...
    string public override name = "Tiny Tera";
    string public override symbol = "tTERA";
    ...
    constructor(uint totalSupplyValue, address tTERATeamAddress, address CharitytTERAAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        tTERATeam = tTERATeamAddress;
        CharitytTERA = CharitytTERAAddress;
        
        // split the tokens according to agreed upon percentages
        balances[tTERATeam] =  totalSupply * 4 / 100;
        balances[CharitytTERA] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's tTERATeam pot
