...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(baseURI).length > 0 ? string(abi.encodePacked(baseURI, tokenId.toString(), _suffix)) : "";
    }
...
// File: lib/ERC721iEnumerable.sol
...
// Demo of ERC721i
contract TheLastDragons is ERC721i, ReentrancyGuard {
