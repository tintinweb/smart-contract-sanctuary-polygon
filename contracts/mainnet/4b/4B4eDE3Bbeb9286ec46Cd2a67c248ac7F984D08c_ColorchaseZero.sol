 ...
 * @notice This contract handles minting Colorchase Zero tokens.
 */
contract ColorchaseZero is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x46a889230300da67D46B5619C3DFbCE6ce80053e;
    ...
    address public royaltyAddress = 0x0041795567E08D1fE44F66d0f5aF26F3BeE41982;
    address[] public payoutAddresses = [
        0x0041795567E08D1fE44F66d0f5aF26F3BeE41982
    ];
    ...
    string public name = "Colorchase Zero";
    string public symbol = "C0l0r";
    ...
    constructor(uint256 _heymintFeePerToken, address _crossmintAddress)
        ERC1155(
            "ipfs://bafybeiewokdmkcj3fay2hxmbqkxi2pureh363d2oayk6xjgdvsizxcbbeq/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[305] = 100;
        tokenPublicPrice[305] = 25 ether;
        tokenPublicMintsPerAddress[305] = 100;
        require(
