...
contract FungiballNFT is ERC721, AccessControl,Ownable {
    ...
    string private _contractUri = "https://nft.fungiball.io/collection/";
    string private _baseUri = "https://nft.fungiball.io/s1/";
    string private _extension = "";

    constructor() ERC721("Fungiball", "FUNGIBALL") {
    ...
    function batchMint(
        ...
        uint256 tokenId = totalSupply == 0 ? 0 : totalSupply ;
        ...
        require(tokenId - totalSupply == _receivers.length * amount,'error');
        totalSupply += _receivers.length * amount;
    }
