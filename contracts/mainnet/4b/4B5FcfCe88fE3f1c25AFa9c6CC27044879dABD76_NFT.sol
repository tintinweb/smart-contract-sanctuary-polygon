...
contract NFT is ERC721A, Ownable {
    ...
    uint private constant MAX_SUPPLY = 222;

    //The price of one NFT
    uint private constant PRICE = 0.16 ether;
    ...
    string public baseURI = "ipfs://bafybeiexze4xyuus2lux4tbn5ywrlgbtrvyuzitztzq2pm2qzj7opx7se4/";

    //Amount NFTs/Wallet
    uint private constant MAX_NFTS_PER_ADDRESS = 1;
    mapping(address => uint) public amountNFTsPerWallet;

    constructor() ERC721A("Cyberpunk Fighter", "CYPF") {}
