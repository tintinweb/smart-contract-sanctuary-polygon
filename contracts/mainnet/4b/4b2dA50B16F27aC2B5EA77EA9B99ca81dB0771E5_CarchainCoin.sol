...
contract CarchainCoin is    
    ...
    constructor() ERC20('Carchain Coin', 'CCC')
    {
        ...
        _initializeEIP712('CarchainCoin');

        _mint(msg.sender, 40069800 * 1e18);
    ...
    function mintForVehicleTokenization() public only(DEFAULT_ADMIN_ROLE) {
    ...
    function mintForDocuVerify() public only(DEFAULT_ADMIN_ROLE) {
