...
contract THEDepictedApes is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("THE DEPICTED APES", "Dape") {
    setHiddenMetadataUri("ipfs://bafybeicvkwnkvsgpyculgc6oa7nza6j4h4yqomoqq6apvgyswgwzyyizcm/18.json");
  }
