...
library EventHandlerV2 {
    ...
    function getEventStatus(bytes memory resultBytes)
        internal
        pure
        returns (Status.ResultStatus)
    {
        EventResultV2.Event memory result = abi.decode(
            resultBytes,
            (EventResultV2.Event)
    ...
    function getResultHash(
        ...
        (uint256 homeScore, uint256 awayScore) = getScore(
            sportType,
            betType,
            resource1,
            resultBytes
    ...
    function getEventId(bytes memory resultBytes)
        internal
        pure
        returns (uint256)
    {
