...
contract SignalSuscriptionExtension is BaseGlobalExtension {
    ...
    modifier ValidWhiteList(IJasperVault _jasperVault){
        require(whiteList[_jasperVault][msg.sender],"user is not in the whitelist");
        _;
    }
    /* ============ State Variables ============ */
    ...
    /* ============ External Functions ============ */
    function setWhiteList(IJasperVault _jasperVault,address user,bool status) external  onlyOperator(_jasperVault) {
         require(!isContract(user),"user is not wallet address");
         bool _status=whiteList[_jasperVault][user];
         require(_status==status,"status set invalid");
         whiteList[_jasperVault][user]=status;
         emit SetWhiteList(_jasperVault,user,status);
    }
    ...
    function subscribe(IJasperVault _jasperVault, address target)
        external
    ...
    function unsubscribe(IJasperVault _jasperVault, address target)
        external
