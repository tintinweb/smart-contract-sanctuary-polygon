...
contract CompLPERC20SushiDMiningStrat is fStrategy {
    ...
    constructor(
        ...
        address _stakingTokenAddr, // LP WETH WMATIC 0xc4e595acDD7d12feC385E5dA5D43160e8A0bAC0E
        ...
        )
    {
        ...
        _stakingLpBaseToken = IERC20(_stakingToken.token0()); // WMATIC
    ...
    function _invest(uint _amount) internal override whenNotPaused {
        _stakingContract.deposit(0, _amount, address(this));
    ...
    function _divest(uint _amount) internal override {
        _stakingContract.withdraw(0, _amount, address(this));
        ...
        onlyRole(MANAGER_ROLE)
    {
        ...
        _stakingContract.harvest(0, address(this));
        ...
        if (address(_rewardToken) == address(_pairedToken)) {
            ...
            swap.desiredAmountPairedToken = _stakingLpBaseToken
            ...
            _router.swapExactTokensForTokens(
                swap.desiredAmountPairedToken, // amount of _stakingLpBaseToken in
                swap.minAmountBaseToken, // minimum amonut of _pairedToken out
                _swapPath, // _router path
                address(this), // address to send matic to (this contract)
            ...
            swap.desiredAmountBaseToken = _pairedToken.balanceOf(address(this));
        }
