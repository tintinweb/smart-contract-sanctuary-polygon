...
contract Bank is Ownable {
    ...
    event Withdrawn(address indexed receiver);

    // Constructor that allows initial deposit
    ...
    function withdraw(
        ...
        require(_isValidSignature(data, signature), "Bank: invalid signature");
        require(!_signatures[signature], "Bank: signature already used");

        _signatures[signature] = true;
        receiver.transfer(AMOUNT);

        emit Withdrawn(receiver);
    }
