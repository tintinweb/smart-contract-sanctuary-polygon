...
/**
 * @notice XVaultMATICUSDProxy delegates calls to a Vault implementation
 */
contract XVaultMATICUSDProxy is InitializeGovernedUpgradeabilityProxy {
}
/**
 * @notice BoostXVaultMATICUSDProxy delegates calls to a Boost implementation
 */
...
/**
 * @notice MeshSwapWMATICUSDCProxy delegates calls to a MeshSwapStrategy implementation
 */
contract MeshSwapWMATICUSDCProxy is InitializeGovernedUpgradeabilityProxy {

}
/**
 * @notice DystopiaStableWMATICUSDCProxy delegates calls to a DystopiaStrategy implementation
 */
...
/**
 * @notice XHarvesterProxy delegates calls to a Harvester implementation
 */
contract XHarvesterMATICUSDProxy is InitializeGovernedUpgradeabilityProxy {
