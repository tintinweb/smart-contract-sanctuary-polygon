...
// File: didr-token/contracts/access/Admincontrol.sol
 ...
 */
abstract contract ERC20SEAFISH is ERC20 {
     ...
     */
    function decimals() public view virtual override returns (uint8) {
        try IERC20Metadata(address(main)).decimals() returns (uint8 value) {
            return value;
        } catch {
    ...
    function depositFor(address account, uint256 amount) public virtual returns (bool) {
        SafeERC20.safeTransferFrom(main, _msgSender(), address(this), amount);
    ...
    function withdrawTo(address account, uint256 amount) public virtual returns (bool) {
        _burn(_msgSender(), amount);
        SafeERC20.safeTransfer(main, account, amount);
        return true;
    }
...
// contracts/seafish.sol

pragma solidity ^0.8.0;

contract SEAFISH is ERC20SEAFISH, Admin {
    constructor() ERC20("Sea Fish", "SFH")
    ERC20SEAFISH(IERC20(0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619)) {
