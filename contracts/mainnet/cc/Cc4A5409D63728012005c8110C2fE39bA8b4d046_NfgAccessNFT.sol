...
contract NfgAccessNFT is ERC1155Upgradeable {
    uint256 public constant NFG_ADMIN_TOKEN_ID = 1;
    uint256 public constant NFG_MEMBER_TOKEN_ID = 2;
    uint256 public constant NBK_ADMIN_TOKEN_ID = 3;
    ...
    function initialize(string memory uri) public initializer {
        ...
        _mint(msg.sender, NBK_ADMIN_TOKEN_ID, 1, "");
    }
    ...
    function setURI(string memory newURI) external {
        require(
            isERC1155Holder(msg.sender, NFG_ADMIN_TOKEN_ID) || isERC1155Holder(msg.sender, NBK_ADMIN_TOKEN_ID),
            "You don't have the right to set uri"
        );
        _setURI(newURI);
    }
    ...
    function burn(address target, uint256 tokenId) external onlyERC1155Holder(NFG_ADMIN_TOKEN_ID) {
