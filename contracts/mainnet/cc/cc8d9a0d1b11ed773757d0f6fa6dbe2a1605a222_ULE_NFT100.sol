...
abstract contract Ownable is Context {
 ...
 contract ULE_NFT100 is ERC721Enumerable, Ownable   {
  using Strings for uint256;
  IBEP20 public Token;
  IBEP20 public BUSD;
  IPancakePair public bnbbusdlp;
  IPancakePair public whetobnblp;
  ...
  uint256 public MinitngPricein_token=100;    // 100 BUSD
  ...
  constructor(
    ...
    iswhitelist[msg.sender]=true;
        ...
        whetobnblp = _whetobnblp;
         ...
         ValueinWHE = a*MinitngPricein_token;
  ...
  function mint_with_BUSD(uint256 _count ,uint256 amount) public 
     {
        ...
        require(_count<=Whitelist_MaxLimitPerTransaction,"Whitelist Max Limit Per Transaction Exceed!");
         ...
         mintedNFTs[msg.sender] += _count;
          ...
          require(amount>=_count*(MinitngPricein_token*1e18) ,"please enter MATIC2");
        require(_count<=MaxLimitPerTransaction," Max Limit Per Transaction Exceed!");
          for (uint i = 0; i < _count; i++) 
              {
                 uint mintIndex = totalSupply();
...
// uletoken  0x3a549866a592C81719F3b714a356A8879E20F5d0
// busd 0xdAb529f40E671A1D4bF91361c21bf9f0C9712ab7
// bnbbusdlp 0x1680b6fbeCeAE147FA927EF4191CAa7fF1D5196C
// whetobnblp 0xc2d2647786C22200c73F1dBee5798Aad86F54c44