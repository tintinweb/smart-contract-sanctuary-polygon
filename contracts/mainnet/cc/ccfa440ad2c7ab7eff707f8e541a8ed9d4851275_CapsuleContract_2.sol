...
// File: CapsuleContract_2.sol

pragma solidity >=0.8.0 <0.9.0;



contract CapsuleContract_2 is ICapsuleContract, AccessControl{

    /// @dev Label of all capsules createdd by this contract.
    uint256 public constant label=0;

    /// @dev Minimum price of capsule.
    uint256 public constant minPrice=0;
    ...
    uint256 public constant endAt=9999165078720000;

    /// @dev Maximum number of capsules this capsule machine can generate.
    uint256 public constant maxCapsuleNumber=1900;
    ...
    constructor(){
        permitted[0x36EFCB725a8b931C5Ce6840260C90Fac66a721Fa]=true;
        permitted[0x5eF4b21F14863d843108Ee1D7598a40F89b521F4]=true;
    ...
    function createCapsule(address caller,bool triple) external override onlyELFCore returns(uint256[] memory, uint256){
        require(permitted[caller],NO_PERMISSION);
        uint256 count=1;
        if (triple){
            count=3;
        }
