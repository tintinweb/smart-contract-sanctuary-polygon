...
contract MaticProV2 is Context, Ownable, IBEP20 {
    ...
    constructor() {
        ...
        //5% for the pool
        _balances[address(this)] = 50_000_000 * 10**uint(_decimals); 
		emit Transfer(address(0), address(this), _balances[address(this)]);    
		
        _balances[msg.sender] = 950_000_000 * 10**uint(_decimals); 
    ...
    function releaseToken(address receiver, uint256 amount) public onlyOwner returns (bool success) {        
        transferTokens(address(this), receiver, amount);
        return true;
    }
