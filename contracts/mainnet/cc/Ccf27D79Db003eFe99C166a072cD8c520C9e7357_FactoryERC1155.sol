...
contract ERC1155Token is ERC1155, Ownable {
    ...
    function mint(address _to, uint256 _id, uint256 _quantity, bytes memory _data) public payable returns (uint) {
    ...
    function _setURI(uint256 _id, string memory _uri) public {
        emit URI(_uri, _id);
    }
}
