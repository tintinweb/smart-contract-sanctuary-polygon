...
contract CarbonCreditCounter {
    ...
    address public constant HYPERLAND_MAILBOX = 0x35231d4c2D8B8ADcB5617A638A0c4548684c7C70;
    ...
    function sendCarbonCreditBalance(
        ...
        bytes memory encodedCredits = abi.encodePacked(getTotalCarbonCredits(msg.sender));
