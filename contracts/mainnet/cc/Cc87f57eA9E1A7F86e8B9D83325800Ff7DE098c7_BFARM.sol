...
contract BFARM is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {
        ...
        busdAddress = 0x8f3Cf7ad23Cd3CaDbD9735AFf958023239c6A063;
        
        _name = e_name;
        _symbol = e_symbol;

        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff /* Pancake Router */);
    ...
    function swap() private lockTheSwap {
        ...
        uint rewardsFee = _marketingFee[0];
    ...
    function setMarketingFees(uint256 buy, uint256 sell, uint256 p2p) external onlyOwner {
        require(buy < 1000 && sell < 1000 &&  p2p < 1000,"Fees are too high!");
        _marketingFee[0] = buy;
    ...
    function setBlacklist(address account, uint timeLimit) external onlyOwner {
        ...
        require(timeLimit < 10 days, "Can't blacklist pair");
