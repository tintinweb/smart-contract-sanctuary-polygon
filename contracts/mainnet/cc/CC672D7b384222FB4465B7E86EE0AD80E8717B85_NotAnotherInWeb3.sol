 ...
 * @notice This contract handles minting Not Another ______ in Web3 tokens.
 */
contract NotAnotherInWeb3 is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    address public royaltyAddress = 0x32baC40c555ed898F917A5Db53fB55E0dd932791;
    // Permanently freezes metadata so it can never be changed
    bool public metadataFrozen;
    string public baseTokenURI =
        "ipfs://bafybeihnplxzqxjnzduhmqsqiwtvdloahgyz42wankkorydatp7se5x5xa/";
    // Maximum supply of tokens that can be minted
    uint256 public constant MAX_SUPPLY = 5000;
    uint96 public royaltyFee = 0;

    constructor() ERC721A("Not Another ______ in Web3", "NAB") {
