...
import {GovernorVotes} from "./utils/GovernorVotes.sol";
import {GovernorVotesQuorumFraction} from "./utils/GovernorVotesQuorumFraction.sol";

import {ERC4973} from "./ERC4973/ERC4973.sol";

contract PopulusGovernor is
    Governor,
    ...
    GovernorVotesQuorumFraction
{
    constructor(IVotes _token)
        Governor("PopulusGovernor")
        GovernorVotes(_token)
        GovernorSettings(0, 45818, 100)
        GovernorVotesQuorumFraction(67)
    {}

    // function name() public pure override(ERC4973, IERC721Metadata, IERC721Metadata, Governor) returns (string memory) {
    //     return super._name;
    // }
...
abstract contract GovernorVotesQuorumFraction is GovernorVotes {
    ...
    {
        return
            (token.totalSupply() * quorumNumerator()) /
            quorumDenominator();
    }
