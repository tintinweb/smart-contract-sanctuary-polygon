...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new TopProspectNFTsUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        TopProspectNFTsUser1155Token token = TopProspectNFTsUser1155Token(address(addr));
...
contract TopProspectNFTsUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
