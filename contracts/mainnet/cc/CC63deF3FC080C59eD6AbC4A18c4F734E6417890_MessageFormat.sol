...
contract MessageFormat {
    ...
    */
    ...
    function buildMsg(uint256[] memory msgData, string memory message, address poster, string[] memory hashtags, address[] memory taggedAccounts, string memory asGroup) public view returns (string memory){
        ...
        string memory thisMsg = append('{"msgID": ',KUtils.toString(msgData[0]) , ',"asGroup": "',asGroup, '","poster": "');
        thisMsg = append(thisMsg, KUtils.addressToString(poster), '","message": "',message , '","timestamp": ');
        thisMsg = append(thisMsg, KUtils.toString(msgData[1]), ',"tip": ',KUtils.toString(msgData[3]) , ',"paid": ');
        thisMsg = append(thisMsg, KUtils.toString(msgData[4]),',"hashtags": [', hashtagsStr, '],"taggedAccounts": [');
        thisMsg = append(thisMsg, taggedStr, '],"postByContract": ', KUtils.toString(msgData[5]),',"likes": ');
        thisMsg = append(thisMsg, KUtils.toString(msgData[6]), ',"comments": ', KUtils.toString(msgData[8]), ',"reposts": ');
        thisMsg = append(thisMsg, KUtils.toString(msgData[7]), ', "block":', KUtils.toString(msgData[2]), '}');
