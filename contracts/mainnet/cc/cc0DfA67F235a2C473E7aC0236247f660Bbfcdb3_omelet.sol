...
contract omelet is ERC1155LazyMint {
    constructor(
        string memory _name,
        string memory _symbol
    ...
    function verifyClaim(
        ...
        require(_tokenId == 0, "Oh, hell nahhh! Only eggs are claimable!");
        require(_quantity == 1, "Don't get greedy Moby,leave some water for the fish! You can claim more than once but.. only 1 can be claimed at a time!");
        }
