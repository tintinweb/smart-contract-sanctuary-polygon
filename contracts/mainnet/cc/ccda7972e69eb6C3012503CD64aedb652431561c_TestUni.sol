...
//  INonfungiblePositionManager public immutable nonfungiblePositionManager;
  ...
  IBEP20 constant menToken = IBEP20(0x5cE09f648E1EE7ED72dB850017EB89ebf6C575a6);
  IBEP20 constant stMENToken = IBEP20(0x763bed355ec82450b5DC1503709eF73be0573850);
  struct Deposit {
    address owner;
    uint128 liquidity;
    address token0;
...
//  }
  ...
  function swapUsdcTostMEN(uint amountIn) external {
    _takeFund(mockUsdc, amountIn, address(this));
    ISwapRouter.ExactInputParams memory params =
      ISwapRouter.ExactInputParams({
      path: abi.encodePacked(address(mockUsdc), poolFee, address(mockUsdt), poolFee, address(stMENToken)),
      recipient: msg.sender,
      deadline: block.timestamp,
      amountIn: amountIn,
      amountOutMinimum: 0
