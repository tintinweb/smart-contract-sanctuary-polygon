...
contract MushroomPreview1155 is ERC1155, Ownable, ERC2981, DefaultOperatorFilterer, ContextMixin, RoyaltiesV2Impl { 
    ...
    function uri(uint256 tokenId) public view override(ERC1155) returns (string memory) {
        ...
        if(tokenIsHidden[tokenId] == true) {  
            ...
            return bytes(hiddenURI).length > 0 ? string.concat(currentHiddenURI, tokenId.toString(), ".json" ): ""; 
        }
