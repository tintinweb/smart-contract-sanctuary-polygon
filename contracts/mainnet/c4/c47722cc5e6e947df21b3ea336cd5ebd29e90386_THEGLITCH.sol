...
contract THEGLITCH is ERC721Base {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    constructor() ERC721Base("GLITCH EP8", "GLITCH8", 0x6765511B6FB8807523F83b3A40cE74661C7a2eEc, 0) {}

    function mintTo(address _to, string memory _tokenURI) public override virtual {
        _setTokenURI(nextTokenIdToMint(), _tokenURI);
        // safemint(to, quantity, data)
        _safeMint(_to, 1, "");
    }
}