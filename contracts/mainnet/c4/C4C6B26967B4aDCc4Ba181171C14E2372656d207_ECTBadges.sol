...
/**  
* @title ERC1155 implementation for Badges @KOIOSDAO
* @author PauwCrypto
...
*/
contract ECTBadges is AccessControlEnumerable, ERC1155URIStorage, ERC1155Burnable, Ownable, SignedTokenVerifier {
    using Strings for uint256;

    string constant NAME = "KOIOS ECT Badges";
    string constant SYMBOL = "ECTB";
    ...
    */
     ...
     * @return baseURI from the contract.
    */
    ...
    */
    function _beforeTokenTransfer(address operator, address _from, address _to, uint256[] memory _tokenId, 
        uint256[] memory _amount, bytes memory _data) internal virtual override(ERC1155) {
            ...
            if(_from == address(0) || hasRole(TRANSFER_ROLE,  _msgSender()) || _to == address(0)){
                return;
            }
