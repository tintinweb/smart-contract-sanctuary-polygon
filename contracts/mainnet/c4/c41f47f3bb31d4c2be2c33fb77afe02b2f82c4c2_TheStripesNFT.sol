...
contract TheStripesNFT is ERC721Enumerable, Ownable {
    ...
    mapping(address => bool) public presaleWallets;
        ...
        constructor() ERC721("Red Panda Club", "RPC")
        {
             setBaseURI("ipfs://QmdaY65WfBSuiUfyg2knZHMzWHUbJrM9jVoLDfgLk447qB/");
            mint(msg.sender,30);
        }

// constructor() ERC721("Red Panda Club", "RPC") {
 //   setHiddenMetadataUri("ipfs://Qmcaj8B7toNf7zSi4TiHApwXtQG9281xThhdKuqT4jkzXZ/hidden.json");
 // }
