...
contract TokenForTesting is IERC20 {
    ...
    string private constant _name = "TestToken_3";
    string private constant _symbol = "TST_3";
    ...
    function getMaxTX() external view returns (uint256) {
        return _maxTxAmount / (10 ** _decimals); // TODO: 
    }

    function getMaxWallet() external view returns (uint256) {
        return _maxWalletSize / (10 ** _decimals); // TODO: 
    }
    ...
    function setExcludedFromReflection(
        ...
        if (enabled) {
            require(
                !_isExcludedFromReflection[account],
