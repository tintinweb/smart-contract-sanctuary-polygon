...
contract ArbitragePool is UUPSUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable, Constants {
  ...
  function arbitrage(
    ...
    _deadline = _deadline > 0 ? _deadline : block.timestamp;
    ...
    router.swapExactTokensForTokens(_amountIn, _amountIn + 1, _path, address(this), _deadline);
