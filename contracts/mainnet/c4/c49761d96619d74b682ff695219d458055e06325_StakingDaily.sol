...
contract StakingDaily {
    using SafeMath for uint256;
    address public owner = 0xd4F453b7a06d2BBabEc3aA7A11dd7ef95f5351Ac;
    address public owner2 = 0xd4F453b7a06d2BBabEc3aA7A11dd7ef95f5351Ac;
    uint256 constant launch = 		1662746402
    ...
    uint256 constant min_invest = 50 ether;
    ...
    constructor() {
            ...
            FeesKey[20] = FeesPercs(1728000, 250);
            FeesKey[30] = FeesPercs(2592000, 300);
            FeesKey[40] = FeesPercs(3456000, 350);
            FeesKey[50] = FeesPercs(4320000, 400);
	...
	function payFees(uint256 amount) internal {
	    ...
	    BUSD.safeTransfer(owner, half);
	    BUSD.safeTransfer(owner2, amount - half);
	}
    ...
    function withdrawDivs() public returns (uint256 withdrawAmount){
        ...
        uint256 adjustedAmt = x - withdrawFee; 
