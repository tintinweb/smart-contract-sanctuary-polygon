...
contract LuchadorDataGetter {
    ...
    function getLuchadoresData(uint256 startIndex, uint256 endIndex) public view returns (LuchadorData[] memory) {
        uint256 range = endIndex - startIndex;
        LuchadorData[] memory luchadores = new LuchadorData[](range);
        ...
        for (uint i = startIndex; i < endIndex; i++) {
            ...
            luchadores[i - startIndex].owner = luchador.ownerOf(i);
        }
