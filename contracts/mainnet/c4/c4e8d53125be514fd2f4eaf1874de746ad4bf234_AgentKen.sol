...
// File: contracts/BluechipHalloween.sol
...
//   ╚═════╝░╚══════╝░╚═════╝░╚══════╝░╚════╝░╚═╝░░╚═╝╚═╝╚═╝░░░░░   //
//                                                                  //
//       Bluechip Halloween NFT contract by Charactor DAO           //
//                                                                  //
//////////////////////////////////////////////////////////////////////
...
contract AgentKen is ERC1155, Ownable, ERC2981 {
    string public name;
    string public symbol;
    // Creator fee 500=5%, 1000=10%
    uint96 public feeNumerator = 1000;
    // Each ID has BaseURI for day and night 
    string[] public dayBaseURI = ["ipfs://QmVG4GUxUdCdps9j7yw3pcJU7vciCp8X99RUCaxkUqJLVT/"];
    string[] public nightBaseURI = ["ipfs://Qmc6TAd1gwTc4XUBgMzKWebqbnhkm5oiw1wZRmrCNYkeqR/"];
    ...
    function mint(address to, uint256 id, uint256 amount) public onlySender{
        ...
        require(psMinted[msg.sender][id] == 0, "You have no mints remaining!");
        require(to != address(0), "ERC1155: mint to the zero address");
        require(amount == 1, "can mint only one token");
    ...
    function _metadataURI(uint256 _id) internal view returns (string memory) {
        if(((block.timestamp - 1665522000) /60 /60 /12) % 2 == 0 ) {
            return dayBaseURI[_id];
        }
            return nightBaseURI[_id];
    }
    ...
    function setDayBaseURI(string[] memory _uris) external onlyOwner {
        delete dayBaseURI;
        dayBaseURI = _uris;
    }
    function setNightBaseURI(string[] memory _uris) external onlyOwner {
        delete nightBaseURI;
        nightBaseURI = _uris;
    }
