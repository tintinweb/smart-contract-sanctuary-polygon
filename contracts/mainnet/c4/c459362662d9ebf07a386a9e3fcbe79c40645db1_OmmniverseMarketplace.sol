...
// File: contracts/ommniverse_marketplace/OmmniverseMarketplace.sol
...
contract OmmniverseMarketplace is ERC721Holder, ERC1155Holder, Ownable {
        ...
        onlyOwner
    {
        ...
        emit PlatformFeePercentageUpdated(oldPercentage, _newPlatformFeePercentage);
    }
 
    function updatePlatformFeeRecepient(address _newPlatformFeeRecepient)
        public
        onlyOwner
    {
        address oldRecipient = platformFeeRecipient;
        platformFeeRecipient = _newPlatformFeeRecepient;
        emit PlatformFeeRecipientUpdated(oldRecipient, _newPlatformFeeRecepient);
    }
