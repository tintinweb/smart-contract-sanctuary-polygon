...
import "./osd_coin_base_v2.sol";
import "../interfaces/osd_coin.sol";

contract OSDCoinV2 is
    Initializable,
    OwnableUpgradeable,
    OSDCoinBaseV2,
    IOSDCoin
{
    ...
    function removeDefaultOperator(address operator) external onlyOwner {
        _defaultAllowedOperator[operator] = false;
...
interface IOSDCoin is IOSDCoinDataTye {
    /**
     * @dev Returns the name of the token.
     */
 ...
 */
contract OSDCoinBaseV2 is Initializable, ContextUpgradeable, IOSDCoinDataTye {
