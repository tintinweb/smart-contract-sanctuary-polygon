...
contract BaseV1Pair is IERC20, IPair, ReentrancyGuard {
    ...
    uint256 internal constant SWAP_FEE_STABLE = 100;
    /// @dev 0.20% Volatile swap fee
    uint256 internal constant SWAP_FEE_VOLATILE = 2000;
    /// @dev 0.5% max allowed swap fee
    uint256 internal constant SWAP_FEE_MAX = 5000;
    /// @dev 25% of swapFee for partnerAddresses
    uint256 internal constant PARTNER_FEE = 250000;
    /// @dev 10% of swapFee for the Treasury
    uint internal constant TREASURY_FEE = 100_000;
