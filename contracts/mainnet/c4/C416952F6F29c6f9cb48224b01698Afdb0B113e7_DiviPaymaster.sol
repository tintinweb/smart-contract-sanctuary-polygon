...
// File: opengsn/contracts/DiviPaymaster.sol



contract DiviPaymaster is BasePaymaster {
  ...
  event RecipientPostCall(bool success, uint256 actualCharge);
  ...
  virtual
  {
    ...
    emit RecipientPostCall(success, gasUseWithoutPost);
  }
