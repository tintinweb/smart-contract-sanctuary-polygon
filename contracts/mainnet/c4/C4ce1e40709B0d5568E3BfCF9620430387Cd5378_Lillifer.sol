...
contract Lillifer is ERC721, ReentrancyGuard, Ownable {
  ...
  constructor(string memory customBaseURI_) ERC721("Lillifer #", "") {
  ...
  uint256 public constant MINT_LIMIT_PER_WALLET = 10199;
  ...
  uint256 public constant MAX_SUPPLY = 10199;

  uint256 public constant MAX_MULTIMINT = 10199;
  ...
  function mint(uint256 count) public nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 10199 at a time");
