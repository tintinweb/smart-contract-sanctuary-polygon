...
library LibAavegotchiNftVault {
    ...
    function _createValidAavegotchiListingStruct(
        ...
        uint8 lenderShare = uint8(shares[0] / 1 ether);
        uint8 borrowerShare = uint8(shares[1] / 1 ether);
        uint8 thirdPartyShare = uint8((shares[2] + shares[3] + shares[4]) / 1 ether);

        uint8[3] memory revenueSplit = [lenderShare, borrowerShare, thirdPartyShare];
        ...
        )
    {
        ...
        return (thirdPartyAddress, alchemicaTokens, shares);
    }
