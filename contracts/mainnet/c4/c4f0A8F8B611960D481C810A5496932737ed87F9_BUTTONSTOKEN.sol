...
contract DividendTracker is Ownable, DividendPayingToken {
    ...
    constructor(uint256 minBalance, address _rewardToken) DividendPayingToken("Reward Tracker", "DividendTrackerTitter", _rewardToken) {
        claimWait = 3600;
...
contract BUTTONSTOKEN is ERC20, Ownable, ReentrancyGuard {
    using SafeERC20 for IERC20;

    uint256 public devDistribution;
    uint256 public marketingDistribution;
    uint256 public rewardDistribution;

    uint256 public totalStateBuy;
    uint256 public totalStateSell;
    uint256 public totalStateTransfer;
    ...
    bool[10] public _toggleSellTax;
    bool[10] public _toggleBuyTax;
    bool[10] public _toggleTransferTax;
    ...
    event UpdateDistribution(uint256 dev, uint256 marketing, uint256 reward);
    ...
    constructor() ERC20("2BUTTONS BSC", "2BUTTONS") {
//        _transferOwnership(0x5069fFc76e101aE69187Be387242c9d0EbAfbffA);
...
//        _mint(owner(), 222_222_222_222_222 * (10 ** 18));
        ...
        devDistribution  = 10;
        marketingDistribution = 10;
        rewardDistribution = 10;

        totalStateSell = 10;
        totalStateBuy = 10;
        totalStateTransfer = 10;
...
//        swapTokensAtAmount = (totalSupply() * 1) / 10_000;
        ...
        dividendTracker.excludedFromDividends(address(uniswapV2Pair));
    ...
    function toggleSellTax(
        ...
        _toggleSellTax[0] = _state1;
        _toggleSellTax[1] = _state2;
        _toggleSellTax[2] = _state3;
        _toggleSellTax[3] = _state4;
        _toggleSellTax[4] = _state5;
        _toggleSellTax[5] = _state6;
        _toggleSellTax[6] = _state7;
        _toggleSellTax[7] = _state8;
        _toggleSellTax[8] = _state9;
        _toggleSellTax[9] = _state10;
        totalStateSell = 0;
        if(_state1) totalStateSell +=1;
        if(_state2) totalStateSell +=1;
        if(_state3) totalStateSell +=1;
        if(_state4) totalStateSell +=1;
        if(_state5) totalStateSell +=1;
        if(_state6) totalStateSell +=1;
        if(_state7) totalStateSell +=1;
        if(_state8) totalStateSell +=1;
        if(_state9) totalStateSell +=1;
        if(_state10) totalStateSell +=1;
        emit UpdateSellTax(_state1, _state2, _state3, _state4, _state5, _state6, _state7, _state8, _state9, _state10);
    }
    ...
    function toggleTransferTax(
        ...
        _toggleTransferTax[0] = _state1;
        _toggleTransferTax[1] = _state2;
        _toggleTransferTax[2] = _state3;
        _toggleTransferTax[3] = _state4;
        _toggleTransferTax[4] = _state5;
        _toggleTransferTax[5] = _state6;
        _toggleTransferTax[6] = _state7;
        _toggleTransferTax[7] = _state8;
        _toggleTransferTax[8] = _state9;
        _toggleTransferTax[9] = _state10;
        totalStateTransfer = 0;
        if(_state1) totalStateTransfer +=1;
        if(_state2) totalStateTransfer +=1;
        if(_state3) totalStateTransfer +=1;
        if(_state4) totalStateTransfer +=1;
        if(_state5) totalStateTransfer +=1;
        if(_state6) totalStateTransfer +=1;
        if(_state7) totalStateTransfer +=1;
        if(_state8) totalStateTransfer +=1;
        if(_state9) totalStateTransfer +=1;
        if(_state10) totalStateTransfer +=1;
        emit UpdateTransferTax(_state1, _state2, _state3, _state4, _state5, _state6, _state7, _state8, _state9, _state10);
    }

    function toggleBuyTax(
        bool _state1,
        bool _state2,
        bool _state3,
        bool _state4,
        ...
        _toggleBuyTax[0] = _state1;
        _toggleBuyTax[1] = _state2;
        _toggleBuyTax[2] = _state3;
        _toggleBuyTax[3] = _state4;
        _toggleBuyTax[4] = _state5;
        _toggleBuyTax[5] = _state6;
        _toggleBuyTax[6] = _state7;
        _toggleBuyTax[7] = _state8;
        _toggleBuyTax[8] = _state9;
        _toggleBuyTax[9] = _state10;
        totalStateBuy = 0;
        if(_state1) totalStateBuy +=1;
        if(_state2) totalStateBuy +=1;
        if(_state3) totalStateBuy +=1;
        if(_state4) totalStateBuy +=1;
        if(_state5) totalStateBuy +=1;
        if(_state6) totalStateBuy +=1;
        if(_state7) totalStateBuy +=1;
        if(_state8) totalStateBuy +=1;
        if(_state9) totalStateBuy +=1;
        if(_state10) totalStateBuy +=1;
        emit UpdateBuyTax(_state1, _state2, _state3, _state4, _state5, _state6, _state7, _state8, _state9, _state10);
    }
    ...
    function setDistribution(uint256 dev, uint256 marketing, uint256 reward) external onlyOwner {
        devDistribution = dev;
        marketingDistribution = marketing;
        rewardDistribution = reward;
        emit UpdateDistribution(dev, marketing, reward);
    }
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (_isAutomatedMarketMakerPair[from]) {
                totalTax = totalStateBuy;
            } else if (_isAutomatedMarketMakerPair[to]) {
                totalTax = totalStateSell;
            } else {
                totalTax = totalStateTransfer;
            }
    ...
    function swapBack() internal inSwap {
        ...
        uint256 contractTokenBalance = balanceOf(address(this));
        uint256 totalDistribution = devDistribution + marketingDistribution + rewardDistribution;
        uint256 totalForReward = rewardDistribution * contractTokenBalance / totalDistribution;
        if(totalForReward > 0){
            super._transfer(address(this), address(dividendTracker), totalForReward);
            dividendTracker.distributeDividends(totalForReward);
            emit SendDividends(totalForReward);
        }
        ...
        totalDistribution = devDistribution + marketingDistribution ;
        uint256 devBNB = (newBalance * devDistribution) / totalDistribution;
        uint256 marketingBNB = (newBalance * marketingDistribution) / totalDistribution;
