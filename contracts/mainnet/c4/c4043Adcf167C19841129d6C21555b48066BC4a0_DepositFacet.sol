...
import { Modifiers, RentalSettings, im_diamondAddress } from "../libraries/LibAppStorage.sol";
...
contract DepositFacet is Modifiers{
    ...
    function withdrawERC721(address _tokenAddress, uint256[] calldata _tokenId) public {
        ...
        require(_tokenId.length <= 10, "withdrawERC721: can only withdraw 10 at a time" );
