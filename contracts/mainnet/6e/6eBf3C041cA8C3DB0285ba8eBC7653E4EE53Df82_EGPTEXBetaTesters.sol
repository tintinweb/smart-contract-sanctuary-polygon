...
contract EGPTEXBetaTesters is ERC721  {
    ...
    constructor()
        ERC721("EGPTEX Beta Testers", "EBT")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeihgjvb6olcx5lnrqp5vvokm66rauhct66kppzdiajwbip3sf66ysm/", Strings.toString(tokenId), ".json")
            );
    }
