...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1681434000;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x2248fd58c7A6C78AE82D525c02D1E0dEE0d1d9B8];
  address public erc20Payable = 0x2248fd58c7A6C78AE82D525c02D1E0dEE0d1d9B8;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeifkma4xilky3n2fzlvyfv3pfar3bnxvkvgvgd5awn6lvmxl5c2ycm/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/B3bQjEWU3vAmVHmH4CGH/contract-metadata";
  }
...
// File: contracts/NoboruYContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NoboruYContract is ERC721APlus {
    constructor() ERC721APlus("Noboru Y", "NBRY"){}
}
  /*******************************************************/
  /*                                                     */
