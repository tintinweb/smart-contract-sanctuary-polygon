 ...
 * @notice This contract handles minting Limited Anniversary Merch (1 Year) tokens.
 */
contract LimitedAnniversaryMerch1Year is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x760D61EB9Ce9Da0FfD9328c254140D940Bf5911A;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xC1369f6f80C339b3C4DDce77C3a3120101011620;
    ...
    address[] public payoutAddresses = [
        0xC1369f6f80C339b3C4DDce77C3a3120101011620
    ];
    ...
    string public name = "Limited Anniversary Merch (1 Year)";
    string public symbol = "LAM1";
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeig5a6m3b6qzdfythc23znwjtkudrizdeqo5lg72vmipw7pux54v6u/{id}"
        )
        RevokableOperatorFilterer(
