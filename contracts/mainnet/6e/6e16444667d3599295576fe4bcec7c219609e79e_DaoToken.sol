...
contract DaoToken is ERC1155, Ownable {
  ...
  // Mint price
  uint256 public mintPrice = 4400 ether;
  ...
  function mint( uint256 _amount) public payable{
    ...
    IERC20(0x7cf12057804499A21A08c40B87E3DE9Ff237E566).transferFrom(msg.sender, owner(), mintPrice*_amount);
    minted=minted+_amount;
    _mint(msg.sender, 1, _amount, "https://cootiesv2.mypinata.cloud/ipfs/QmcBb46RxkRRafdEjndo6j3vyq2Sed4tW2k6pd9cfHgYQX", "");
    _tokenOwners[1].push(msg.sender);
    _tokenOwner[1][msg.sender] = true; 
    _tokenIDs[msg.sender].push(1);
    currentID++;
    emit minting(currentID,  "https://cootiesv2.mypinata.cloud/ipfs/QmcBb46RxkRRafdEjndo6j3vyq2Sed4tW2k6pd9cfHgYQX", _amount);
  }
