...
contract ExtndRedeemV3 is Ownable {
    ...
    /// ----- OWNER METHODS ----- ///
    constructor(IExtndOperator operatorAddress, uint256 networkId) {
    ...
    function editOperatorAddress(IExtndOperator newAddress) external onlyOwner {
        operator = newAddress;
    }
