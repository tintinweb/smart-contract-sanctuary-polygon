...
contract PausableCrowdsale is Crowdsale, Pausable, Ownable {
     ...
     */
    function setNewEthRate(uint256 __newEthRate) public onlyKeeper returns (bool) {
       bool success = super._setNewEthRate(__newEthRate);
       return success;
    }
...
contract Crowdsale is Context, ReentrancyGuard {
     ...
     * @param __newEthRate New rate of how many token units a buyer gets per wei.
     */
    function _setNewEthRate(uint256 __newEthRate) internal virtual returns(bool) {
        require(__newEthRate > 0, "_setNewEthRate: new rate can not be 0");
        _rate =  __newEthRate;
