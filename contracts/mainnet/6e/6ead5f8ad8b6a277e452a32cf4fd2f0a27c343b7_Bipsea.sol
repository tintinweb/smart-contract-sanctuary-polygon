...
contract Bipsea {
    ...
    event Revenue(  uint256 indexed _itemId, address indexed _address, uint256 _amount);
    ...
    function buy(uint64 _itemId) public payable {
        ...
        // Emit Revenue
        emit Revenue(_itemId, items[_itemId].seller, sellerValue);
        emit Revenue(_itemId, items[_itemId].investor, investorValue);
    }
