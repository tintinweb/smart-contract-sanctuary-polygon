...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x074E6dAf8e32348a93A0fe0BfD12d4E771711Bf5];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmSrZhUWhJ3mFtqNtSdXdXMPkpkK7EZ2LFvVkvihpKhbB3/";
...
// File: contracts/JtMcatContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract JtMcatContract is RamppERC721A {
    constructor() RamppERC721A("JTMcat", "JTMCAT"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/sM3S9eo1nHtjc0d3pHG5/contract-metadata";
    }
}
