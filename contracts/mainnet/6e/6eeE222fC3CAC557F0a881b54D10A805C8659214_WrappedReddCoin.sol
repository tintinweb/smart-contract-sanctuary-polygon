...
/// @custom:security-contact https://rarestake.dao
contract WrappedReddCoin is ERC20, ERC20Burnable, Pausable, Ownable, ERC20Permit {
    constructor()
        ERC20("Wrapped ReddCoin", "wRDD")
        ERC20Permit("Wrapped ReddCoin")
    {
