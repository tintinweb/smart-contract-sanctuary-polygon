// SPDX-License-Identifier: MIT
    ...
    contract Foxie is ERC721, Ownable, ERC721Enumerable {
      ...
      event FoxieMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("Foxie", "FX") {}
      ...
      function mintFoxie(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit FoxieMinted(id, msg.sender);
          }
        }
      }
    
      function presaleFoxie(uint256 numberOfTokens) external payable {
