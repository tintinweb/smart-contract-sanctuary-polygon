...
contract ERC1155Token is ERC1155Supply, ERC1155Burnable, Ownable {
    ...
    constructor(string memory contractName, string memory uri) ERC1155(uri) {
        name=contractName;
    }
...
contract ERC1155TokenFactory{
    ...
    function createERC1155(string memory contractName, string memory uri, string[] memory tokensName,uint256[] memory tokensMaxSupply) public {
        ERC1155Token erc1155Contract = new ERC1155Token(contractName, uri);
