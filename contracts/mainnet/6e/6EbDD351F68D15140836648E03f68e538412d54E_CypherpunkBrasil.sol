 ...
 * @notice This contract handles minting Cypherpunk Brasil tokens.
 */
contract CypherpunkBrasil is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xaCdCA62A60F3eC15Ce301e48c964dF591A6d6Db8;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x3dd22EAf7539dA00ee33811014E9BD14e9F40f8D;
    address[] public payoutAddresses = [
        0x3dd22EAf7539dA00ee33811014E9BD14e9F40f8D
    ];
    ...
    string public name = "Cypherpunk Brasil";
    string public symbol = "CPKB";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeiawwzmoiddqza73zb4hvxb27dzvekvylmkyga22wositn7xcjksmq/{id}"
        )
        RevokableOperatorFilterer(
