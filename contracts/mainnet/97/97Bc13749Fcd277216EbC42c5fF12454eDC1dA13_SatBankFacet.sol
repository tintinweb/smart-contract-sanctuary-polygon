...
contract SatBankFacet is ReentrancyGuard, DropperFacet {
    ...
    function claim(
        ...
        LibSatBank.addTxQueue(appIdentifier, token, amount);
    }
    ...
    /// @notice Get the RBW token address stored in satellite bank
    /// @return RBWAddress - The address of RBW token
    function getRBWAddress() external view returns (address RBWAddress) {
        return LibSatBank.rbwAddress();
    }

    /// @notice Get the UNIM token address stored in satellite bank
    /// @return UNIMAddress - The address of UNIM token
    function getUNIMAddress() external view returns (address UNIMAddress) {
        return LibSatBank.unimAddress();
    }

    /// @notice Get the WETH token address stored in satellite bank
    /// @return WETHAddress - The address of WETH token
    function getWETHAddress() external view returns (address WETHAddress) {
        return LibSatBank.wethAddress();
    }
