 ...
 * @notice This contract handles minting Love Kipheo tokens.
 */
contract LoveKipheo is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xa2C70c8A82E3eC0545552ed512068EfBA92f0fd3;
    ...
    string public name = "Love Kipheo";
    string public symbol = "LOVEKIPHEO";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeigjm63sysmgvjnc4mbwsrurf4qisbypoevx6ag56bupgbik5vxore/{id}"
        )
        RevokableOperatorFilterer(
