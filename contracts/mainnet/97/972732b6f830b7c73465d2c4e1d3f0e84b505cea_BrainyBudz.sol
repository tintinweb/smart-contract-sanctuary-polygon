...
abstract contract DappMaintenance is ERC721Enumerable, Ownable, ReentrancyGuard {
    // PWSPad
    address private immutable DappMWallet;
    uint256 private immutable DevFee = 10;
    ...
    function mint(uint256 amount) external payable nonReentrant {
        ...
        uint256 launchpadRoyalties = (msg.value * DevFee) / 100;
    ...
    function _payoutLaunchpadFee(uint256 _amount) private {
        (bool success, ) = payable(DappMWallet).call{
            value: _amount,
            gas: 50000
        }("");
        require(success);
...
pragma solidity ^0.8.15;
contract BrainyBudz is DappMaintenance {
    constructor(address projectWallet_, address DappMWallet_)
        DappMaintenance(
            "Brainy Budz",
            "BB",
            "https://brainybudz/ipfs/QmRmqeZ9kCN8V8WFaFKYNTh47aUqHPkFaEgZpou3ePR2JN/",
            projectWallet_,
            DappMWallet_,
            8420,
            1,
