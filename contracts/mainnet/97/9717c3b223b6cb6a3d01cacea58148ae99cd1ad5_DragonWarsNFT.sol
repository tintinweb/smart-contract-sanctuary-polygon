...
pragma solidity ^0.8.13;
    ...
    contract DragonWarsNFT is IERC721L, ERC721AQueryable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
        ...
        uint256 private _globalWalletLimit = 888;
        ...
        // Current base URI.
        string private _currentBaseURI = "ipfs://bafybeiakca4izxehyzww73xf3lb2pexxtoc7544tfklxkdvsf4pm366qgq/";
        ...
        constructor() ERC721A("DragonWarsNFT", "DragonWars") {
            _mintStages.push(MintStageInfo({cost: 880000000000000000, walletLimit: 888, merkleRoot: 0x0, maxStageSupply: 0, startTimeUnixSeconds: 1688140819, endTimeUnixSeconds: 1735660800}));
        }
