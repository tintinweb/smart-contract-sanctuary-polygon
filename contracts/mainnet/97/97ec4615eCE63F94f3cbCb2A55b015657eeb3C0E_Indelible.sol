...
contract Indelible is ERC721AX, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    bytes32 private constant TIER_2_MERKLE_ROOT = 0x91cf6c444e0acb8c88adaa249d132d467279986bef95a93e31affd084e1f71c3;
    ...
    string[] private layerNames = [unicode"1", unicode"2", unicode"3", unicode"4", unicode"5", unicode"6", unicode"7", unicode"8", unicode"9", unicode"10", unicode"11", unicode"12", unicode"13", unicode"14", unicode"15"];
    bool private shouldWrapSVG = true;
    address private indelibleProContractAddress = 0xf3DAEb3772B00dFB3BBb1Ad4fB3494ea6b9Be4fE;
    string private backgroundColor = "transparent";
    uint private randomSeed;
    bytes32 private merkleRoot = 0x0a5bbebd2921b0fb03e0c569f3ec654d3db8321b03781ddca2046b48c00f9e60;
    ...
    uint public publicMintPrice = 6.900 ether;
    string public baseURI;
    bool public isPublicMintActive;
    uint public allowListPrice = 2.400 ether;
    uint public maxPerAllowList = 1;
    bool public isAllowListActive;

    ContractData public contractData = ContractData(unicode"Lead Stone Decoy", unicode"Contains photosensitive imagery.  A glitch series of heavy on-chain deployment.  Buckle up.", "https://files.indelible.xyz/profile/6d1030bc-b397-46c0-bb8f-baf24f8c7330", "https://files.indelible.xyz/banner/6d1030bc-b397-46c0-bb8f-baf24f8c7330", "", 600, "0x06BBd9bDd711e2F4B87c6422176aD267Eb16a318");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"Lead Stone Decoy", unicode"TORP") {
        tiers[0] = [102,49,44,39,18,17,16,15,12,12,10,10,10,9,9,9,9,8,7,5,5,4,1];
        tiers[1] = [86,70,64,59,54,19,11,10,9,9,6,6,6,5,3,3,0];
        tiers[2] = [159,63,63,50,25,18,18,13,10,1,0];
        tiers[3] = [79,42,42,42,42,42,42,12,10,8,7,7,7,7,7,7,7,7,3,0];
        tiers[4] = [33,31,31,28,27,26,24,24,23,23,21,20,18,17,17,8,8,6,6,6,5,5,3,3,3,3,1,0];
        tiers[5] = [112,110,110,52,27,6,3,0];
        tiers[6] = [110,91,83,69,58,6,3,0];
        tiers[7] = [108,102,100,81,22,7,0];
        tiers[8] = [99,99,95,65,54,6,2,0];
        tiers[9] = [125,123,95,46,25,6,0];
        tiers[10] = [108,107,86,77,37,3,2,0];
        tiers[11] = [134,91,89,56,40,10,0];
        tiers[12] = [62,53,51,45,27,26,23,23,20,19,12,12,11,11,10,7,4,4];
        tiers[13] = [217,41,31,21,10,10,10,10,10,10,10,10,10,10,10];
        tiers[14] = [42,42,33,33,26,26,26,26,26,26,26,20,19,18,11,8,3,3,3,3];
