...
contract StrategPortalSwapRouterFacet {
    ...
    function swap(
        ...
        if(targetIsVault) {
            ...
            uint256 shares = IERC4626(_targetAsset).deposit(assetOutAmount, address(this));
            IERC4626(_targetAsset).transfer(msg.sender, shares);
        } else {
