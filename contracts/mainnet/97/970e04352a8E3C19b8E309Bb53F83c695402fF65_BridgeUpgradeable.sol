    ...
    ReentrancyGuardUpgradeable
{
    ...
    event AdminUnsupportChain(uint8 destChainId, bool isUnsupported);
    event Settlement(
    ...
    */
    ...
    modifier isProposalExists(
        ...
        _isProposalExists(chainID, depositNonce, dataHash);
        _;
    }

    // Functions for modifiers starts here
    ...
    // Functions for modifiers end here
 ...
 */
    ...
    */
    function genericDeposit(uint8 _destChainID, bytes32 _resourceID) external whenNotPaused returns (uint64) {
        require(_resourceIDToHandlerAddress[_resourceID] == msg.sender && _genericWhitelist[msg.sender] == true);
