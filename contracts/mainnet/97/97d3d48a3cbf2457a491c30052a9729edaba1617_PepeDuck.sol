...
contract PepeDuck is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0xaB906a881DFd4Ec949C95bb68e2f99cF3c5B1Eb5);// Add marketing wallet here
    ...
    uint256 maxWalletLimit = 30000000000 * 10 ** decimals();
