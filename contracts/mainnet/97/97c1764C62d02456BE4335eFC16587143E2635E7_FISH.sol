...
contract FISH is IMinter, ERC721A, Ownable {
    ...
    // ERC721A
    uint256 constant maxBatchSize_ = 10000;
    ...
    constructor(string memory _initNotRevealedUri) 
        ERC721A("Anglerfish", "FISH", maxBatchSize_, collectionSize_) {
        ...
        publicMintConf = MintConf(10000, 500, 100);
    }
