...
contract BouleMint is ERC721URIStorage, Ownable, VRFConsumerBase {
    ...
    uint256 public TOKEN_CAP = 1_000_000; // maximum tokens to be sold
    uint256 public COMMUNITY_TOKEN_CAP = 10_000; // maximum tokens that can be minted
    uint256 public MAX_TOKEN_PURCHASE_SIZE = 100; // maximum tokens that can be given to the community
    uint256 public TOKEN_PRICE = 1 * 10**18; // token price (1 MATIC)
    uint256 public WINNER_TAKE_HOME_PERCENTAGE = 90; // the percentage of the pot the winner gets (should be 0-100)
