...
contract AkinaCrew is ERC721Enumerable, Ownable {
    ...
    uint256 public cost = 0.03 * 10 ** 18;
    uint256 public costM;
    ...
    address token_Contract = 0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619;
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        if (msg.sender != owner()) {
            require(token.balanceOf(msg.sender) >= cost * _mintAmount,"You do not have enough tokens to perform the transaction");
            token.transferFrom(msg.sender, address(this), cost * _mintAmount);               
            }
    ...
    function setTokenContract(address _token_Contract) public onlyOwner {
    ...
    function withdrawTokens() public onlyOwner {
        token.transfer(mintFundsOwner, token.balanceOf(address(this)));
    }  
}
