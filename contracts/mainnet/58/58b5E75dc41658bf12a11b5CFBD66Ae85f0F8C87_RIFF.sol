...
contract RIFF is RIFFDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private RIFFTeam;
    address private CharityRIFF;
    ...
    string public override name = "MetaTariff";
    string public override symbol = "RIFF";
    ...
    constructor(uint totalSupplyValue, address RIFFTeamAddress, address CharityRIFFAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        RIFFTeam = RIFFTeamAddress;
        CharityRIFF = CharityRIFFAddress;
        
        // split the tokens according to agreed upon percentages
        balances[RIFFTeam] =  totalSupply * 4 / 100;
        balances[CharityRIFF] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's RIFFTeam pot
