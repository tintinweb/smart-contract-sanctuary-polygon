...
contract SuitTurtlesClub is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Suit Turtles Club", "STC6k") {
    setHiddenMetadataUri("ipfs://QmYF85byopA1CDnjLxEMsdmXJXKdLB3ZKj7JSQfNYvSX17/hidden.json");
  }
