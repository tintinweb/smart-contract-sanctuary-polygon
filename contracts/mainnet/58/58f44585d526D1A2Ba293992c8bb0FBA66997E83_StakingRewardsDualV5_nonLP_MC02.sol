...
// File: contracts/Staking/C3/C3_StakingRewardsDualV5_nonLP.sol
...
contract C3StakingRewardsDualV5_nonLP is Owned, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    function userStakedToken(address account) public view returns (uint256) {
        return _locked_liquidity[account];
    }

    function minVeC3ForMaxBoost(address account) public view returns (uint256) {
        return (userStakedToken(account)).mul(vec3_per_c3_for_max_boost).div(MULTIPLIER_PRECISION);
    }
...
// File: contracts/Staking/C3_Variants/C3_StakingRewardsDualV5_nonLP_MCO2.sol


pragma solidity >=0.6.11;


contract StakingRewardsDualV5_nonLP_MC02 is C3StakingRewardsDualV5_nonLP {
    constructor (
        address _owner,
        address _rewardsToken0,
