...
contract Pandra is Ownable, ERC721AQueryable, ReentrancyGuard {
    ...
    ) ERC721A("Pandra: PixelProwler", "Pandra: PixelProwler") {
    ...
    function mint() external nonReentrant isNotContract checkMintTimes {
        require(_numberMinted(msg.sender) + 1 <= mintLimit, "You have reached the claim limit(3)");
        require(_totalMinted() + 1 <= total, "Undersupply");
