...
// File: contracts\interfaces\CallbacksInterfaceV6_2.sol
...
// File: contracts\GNSPriceAggregatorV6_2.sol
    ...
    function tokenPriceDai() external returns(uint){ // PRECISION
        ...
        if (timeElapsed >= TWAP_PERIOD) {
            ...
            tokenPriceTWAP = FixedPoint.uq112x112(
                uint224((priceCumulative - tokenPriceCumulativeLast) * PRECISION / timeElapsed)
            ).decode();
