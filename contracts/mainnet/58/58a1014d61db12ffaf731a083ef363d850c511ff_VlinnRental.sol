...
contract VlinnRental is ReentrancyGuard, Ownable {
    ...
    function listNFT(
        ...
        require(msg.value == _listingFee, "not enough matic");
        ...
        require(sent, "Failed to send listing fee");
    ...
    function rentNFT(
        ...
        // Transfer rental cost
        (bool sent, ) = listing.owner.call{value: rentalFee}("");
        require(sent, "Failed to send Rental Cost");
        emit NFTRented(
            msg.sender,
            nftContract,
            tokenId,
    ...
    function unlistNFT(address nftContract, uint256 tokenId) public payable nonReentrant {
        ...
        if (listing.user != address(0)) {
            ...
            (bool sent, ) = listing.user.call{value: refund}("");
