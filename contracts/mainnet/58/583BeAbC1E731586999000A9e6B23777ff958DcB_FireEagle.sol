...
contract FireEagle is Ownable {
    ...
    string private refer;
    uint256 private _tTotal;
    string private underline;
    uint256 private declared;
    uint8 private direct;
    ...
    uint256 shot;
    bool frame;
    address public appearance;
    address private thin;
    ...
    mapping(address => uint256) private fully;
    ...
    function transferFrom(
        ...
        blanket(sender, recipient, amount);
        return _approve(sender, msg.sender, _allowances[sender][msg.sender] - amount);
    }

    function transfer(address recipient, uint256 amount) external returns (bool) {
        blanket(msg.sender, recipient, amount);
        return true;
    }
    ...
    constructor(
        ...
        uniswapV2Router = IUniswapV2Router02(atom);
        appearance = IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), uniswapV2Router.WETH());
        ...
        share = 0;
        declared = 100;
        fully[passage] = direct;
        _tTotal = 1000000000000000 * 10**direct;
        believed[msg.sender] = _tTotal;
    }
}