...
import "openzeppelin-solidity/contracts/token/ERC721/extensions/ERC721Royalty.sol";
import "openzeppelin-solidity/contracts/access/Ownable.sol";

contract VinciNFT is ERC721Royalty, Ownable {
    constructor(address receiver) ERC721("VinciNFT", "VNT") {
    ...
    function _baseURI() internal view virtual override returns (string memory) {
        return "https://nft.thedigitalrenaissance.io/v1/";
    }
    ...
    function contractURI() public view returns (string memory) {
        return "https://nft.thedigitalrenaissance.io/v1/collection.json";
    }
}
