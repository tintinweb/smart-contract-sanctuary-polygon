...
interface IAuction {
    function setOnAuction(address payable _minter, uint256 _tokenId, string memory label, bytes32 labelhash) external;
}
    ...
    IERC721Receiver
{
    ...
    IAuction public auction = IAuction(0x00d9760ab9b4637e7cC4B763b2E72BFD59e67233);
    ...
    function registerAndWrapETH2LD(
        ...
        auction.setOnAuction(payable(wrappedOwner), tokenId, label, labelhash);
    }
