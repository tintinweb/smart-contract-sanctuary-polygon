...
contract Distributor is IDistributor, EncountrAccessControlled {
    /* ========== DEPENDENCIES ========== */
    ...
    IERC20 private immutable encountr;
    ...
    function nextRewardAt(uint256 _rate) public view override returns (uint256) {
        return encountr.totalSupply().mul(_rate).div(rateDenominator);
    }
