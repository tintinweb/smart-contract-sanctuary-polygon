...
contract BCityv1 is ERC721PresetMinterPauserAutoId {
    HNYb public HNYb_TOKEN = HNYb(0xa029c11124d728D81a8c9d981d8C64E12eE85632);
    ...
    uint256 public price = 200000000000000000000; // start at 200MATIC
    address payable treasury = payable(0x1e93348bd40A9C55d315FC994b31649019BC7334); // bCity treasury
    address payable bank = payable(0xfe308073e77a75D5476642481d4fd522A170602A); // bCity bank
