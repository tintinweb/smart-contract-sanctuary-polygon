...
contract WFv2 is ERC20Detailed ,Owned {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "Whirl Finance v2";
  string constant tokenSymbol = "WHIRLV2";
  uint8  constant tokenDecimals = 18;
  uint256 _totalSupply = 500000000000000000000000000;
  uint256 public basePercent = 100;

  constructor() public payable ERC20Detailed(tokenName, tokenSymbol, tokenDecimals) {
    _mint(0x51145862817016717599340e55E420CE17EF82af, _totalSupply);
  }
