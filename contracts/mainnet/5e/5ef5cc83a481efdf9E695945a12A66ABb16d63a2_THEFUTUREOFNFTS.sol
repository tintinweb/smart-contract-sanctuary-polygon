 ...
 * @notice This contract handles minting THE FUTURE OF NFTS tokens.
 */
contract THEFUTUREOFNFTS is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xd3e0bA948ce730003080122c0c8D176490e13a90;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x311d61cD8310FEe771Db5C8D8352074E0e09591C;
    ...
    string public name = "THE FUTURE OF NFTS";
    string public symbol = "NFTROPICO";
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeihv5x2ut2ggahvwo5n4mr4ktxgrshr3m4bz25h7hzfie4cywv5nkm/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenPublicSaleStartTime[1] = 1685682000;
        tokenPublicSaleEndTime[1] = 1686286800;
