...
contract MinionsMegaverse is ERC721, PaymentSplitter {
    ...
    constructor(address[] memory _payees, uint256[] memory _shares)
        ERC721("Minions Megaverse", "MMVS")
        PaymentSplitter(_payees, _shares)
    {}

    function mint() external payable {
        if (totalSupply + 1 > 9876) revert SoldOut();
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked(
                    "ipfs://QmZ4r3z29eBfPcREP9RSoGEYMp1HvHsNxBQYfT4PmSWVtM/",
