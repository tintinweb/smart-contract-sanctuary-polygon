...
abstract contract ABIResolver is ResolverBase {
    ...
    /**
     * Returns the ABI associated with an DID node.
     * Defined in EIP205.
...
abstract contract ContentHashResolver is ResolverBase {
    ...
    /**
     * Returns the contenthash associated with an DID node.
     * @param node The DID node to query.
...
abstract contract PubkeyResolver is ResolverBase {
    ...
    /**
     * Sets the SECP256k1 public key associated with an DID node.
     * @param node The DID node to query
    ...
    /**
     * Returns the SECP256k1 public key associated with an DID node.
     * Defined in EIP 619.
     * @param node The DID node to query
...
abstract contract TextResolver is ResolverBase {
    ...
    /**
     * Sets the text data associated with an DID node and key.
     * May only be called by the owner of that node in the DID registry.
     * @param node The node to update.
    ...
    /**
     * Returns the text data associated with an DID node and key.
     * @param node The DID node to query.
