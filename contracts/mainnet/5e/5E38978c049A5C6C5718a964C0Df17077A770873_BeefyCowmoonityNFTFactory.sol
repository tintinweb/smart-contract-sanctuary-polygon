...
// @title BeefyCowmoonityNFTFactory.sol
// @author jackgale.eth
// @dev ERC-1155 NFT factory for generating NFT collections with a specified URI.
...
contract BeefyCowmoonityNFTFactory is ERC1155URIStorage, Ownable {
    using Strings for uint256;
