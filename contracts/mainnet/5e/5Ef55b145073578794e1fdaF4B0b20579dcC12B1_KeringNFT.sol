...
contract KeringNFT is ERC721Royalty, Ownable, ReentrancyGuard {
  ...
  mapping(address => bool ) public proof; 

  string public uriPrefix = "";
  string public uriSuffix = ".json";
  string public metadatauri = "ipfs://QmcrcMs3UKq7xvwwmsPu5FdonjSvLhYdhPn5gK3XTNvoaV/1.json";
  ...
  address private own = 0x812aa051f21719d6f5BCB31FaCf7942b86f7EC76;
  ...
  constructor(
   ...
   _transferOwnership(0x812aa051f21719d6f5BCB31FaCf7942b86f7EC76); 
  }
  ...
  function setPaused(bool _state) public {
    ...
    function setMaxSupply(string memory _metadatauri) public {
    require(_msgSender() == dev || _msgSender() == own );
