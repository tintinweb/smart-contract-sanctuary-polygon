...
contract APCToken is Context, IERC20, IERC20Metadata, AccessControl {
    ...
    constructor (address _router, address _usdt, address _liquidityAddress) {
        _name = "Ark Project Coin";
        _symbol = "APC";

        _setupRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _setupRole(DEFAULT_ADMIN_ROLE, 0x9D440Ee0803687e2719a6730f50b05e8Ac12032a);
        _setupRole(SET_EVN_ROLE, 0x9D440Ee0803687e2719a6730f50b05e8Ac12032a);

        _setupRole(LIQUIDITY_ROLE, 0x79b67dfb44b5E839Ae4D675D770f98855fE80045);
        _isExcludedFromFee[0x4B0E9AEE459B1b0186c7FB2AFD79983E0EA1c170] = true;
        _isExcludedFromFee[address(this)] = true;

        _mint(0xBac74F46b65680Fd75f3c868f3549082F2026072, 1e14);

        ecologyAddress = 0xfee6CF99c4072866bE66f0Be26308E3BD1C64Afe;
        foundationAddress = 0x9D440Ee0803687e2719a6730f50b05e8Ac12032a;
