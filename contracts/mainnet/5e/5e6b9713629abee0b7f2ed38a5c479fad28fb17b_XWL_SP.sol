...
// Xepa.World - Special Partners Edition
...
// File: xepa-26de016aea.sol

// @custom:security-contact [email protected]
contract XWL_SP is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    uint256 MAX_SUPPLY = 50;

    constructor() ERC721("XWL_SP", "XLP") {}
    ...
    function safeMint(address to, string memory uri) public onlyOwner {
        require(_tokenIdCounter.current() <= MAX_SUPPLY, "XWL_Special Partners Edition Sold Out");
