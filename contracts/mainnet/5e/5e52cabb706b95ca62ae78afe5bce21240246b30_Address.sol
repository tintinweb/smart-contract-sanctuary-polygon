...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAE0985757513E231940c2733b933A9A9413FA458;
...
contract tokenname is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0xAE0985757513E231940c2733b933A9A9413FA458);
    ...
    string private _name = "Torque Network"; 
    string private _symbol = "TORQUE";  
