...
contract CreadoreUniverse is Context, Ownable, ERC721Enumerable, ERC2981PerTokenRoyalties{
    ...
    function adrp(
        ...
        for (uint256 i = 0; i < count; i++){
            ...
            _setTokenRoyalty(idTracker + i, owner(), 600);
        }
        idTracker += count;
    }
    ...
    function updateRoyalty(uint256 id, address recipient, uint256 amount) public onlyAdmin{
