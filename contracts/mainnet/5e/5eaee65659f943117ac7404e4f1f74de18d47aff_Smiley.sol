...
// File: contracts/NaftyAngelsNFT/Smiley.sol
...
contract Smiley is ERC721, Ownable {
    using Strings for uint256;
    using ECDSA for bytes32;

    uint256 public MAX_EXCLUSIVE = 10;
    uint256 public MAX_PRESALE = 20;
    ...
    address private wallet = address(0xE15F465a129e9B7E26fC1E4e71a13D118c10cE33);
    ...
    function freeMint(uint256 _amount) external {
        ...
        require(
            ...
            "Smiley: Mint too large, exceeding the maxSupply"
        );
    ...
    function exclusiveMint(
        ...
        require(
            ...
            "Smiley: Exclusive presale has not been started yet!"
        );
        ...
        require(
            ...
            "Smiley: Selected amount exceeds the max exclusive presale supply."
        );

        require(
            msg.value >= exclusivePrice * amount,
            "Smiley: Insuficient ETH amount sent."
        );
    ...
    function presaleMint(
        ...
        require(
            ...
            "Smiley: Presale has not started yet!"
        );
        
        require(
            presaleCount + amount <= MAX_PRESALE,
            "Smiley: Selected amount exceeds the max presale supply"
        );
    ...
    function publicSaleMint(uint256 amount) external payable {
        ...
        require( supply < maxSupply, "Smiley: Sold out!" );
        require( supply + amount <= maxSupply, "Smiley: Selected amount exceeds the max supply.");

        require(
            workflow == WorkflowStatus.Sale,
            "Smiley: Public sale has not started yet."
        );
    ...
    function forceMint(uint256 number, address receiver) external onlyOwner {
        ...
        require(
            ...
            "Smiley: You can't mint more than max supply"
        );
