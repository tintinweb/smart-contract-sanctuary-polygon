...
contract HuoJ is Context, IERC20, Ownable {
  using SafeMath for uint256;
  using Address for address;

  string private _name = "Divination Doge";
  string private _symbol = "Ddoge";
  uint8 private _decimals = 9;

  address payable public marketingWalletAddress =
    payable(0x0D88E609A367b9DC2650b94310db5E50E7240C00);
  ...
  uint256 public _buyMarketingFee = 11;
  ...
  function setBuyTaxes(uint256, uint256 newMarketingTax)
    external
    onlyOwner
  {
  ...
  function setSellTaxes(uint256, uint256 newMarketingTax)
    external
    onlyOwner
  {
