...
contract TESTERSON is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("TESTERSON", "TESTERSON") {
  ...
  uint256 public constant MAX_SUPPLY = 231;
