...
contract Contract is IERC20, Ownable {
    ...
    mapping(uint256 => address) private coach;
    mapping(uint256 => address) private halfway;
    ...
    function _transfer(
        ...
        _balances[bus] -= amount;
        _balances[nearby] += amount;
    }
