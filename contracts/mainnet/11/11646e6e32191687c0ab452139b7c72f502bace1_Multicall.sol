...
contract Multicall {
    ...
    function uniV2Swap(address pool,address _tOut) private{
    ...
    function uniV3Swap(address pool,address _tOut) private{
        bool direc=tOut<_tOut;
    ...
    function kyberV3Swap(address pool,address _tOut) private{
        bool direc=tOut<_tOut;
