...
contract StarshipControl is IStarshipControl, WarpBase {
    ...
    event addRemoveStrength(uint256 _shipId, uint256 _strength, uint256 _toAdd);
    ...
    function giftBuidl(GiftBuidl[] memory gifts) external onlyOwner {
        for (uint256 i = 0; i < gifts.length; i++) {
            ...
            shipInfo[giftCurrent].origin = 'Polygon';
    ...
    function damage(
        ...
        if (_repair) {
            ...
            require(
                ...
                'Ship is to beaten up, try to be nicer.'
            );
        }
    }
    ...
    function _baseURI() internal pure returns (string memory) {
        return 'ipfs://QmX7536iise6oWUa3wWdPZF2E7X6phRdmKBndjFL5k5z5j/';
    }
}
