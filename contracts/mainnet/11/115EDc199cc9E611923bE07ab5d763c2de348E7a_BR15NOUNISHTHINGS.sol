 ...
 * @notice This contract handles minting BR 15 NOUNISH THINGS tokens.
 */
contract BR15NOUNISHTHINGS is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xe7B30f4C298492c11cC0e35722bf6914C25bEc32;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xDb47bD2FcA1237038aA2C542f64CfE08591463C4;
    address[] public payoutAddresses = [
        0xDb47bD2FcA1237038aA2C542f64CfE08591463C4
    ];
    ...
    string public name = "BR 15 NOUNISH THINGS";
    string public symbol = "BRNOUNISH";
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeibovuotvrgdkmcbbam5tpkmusmgdaph7zz7iahdct46xi4lhjuv4e/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[15] = 500;
        tokenPublicPrice[15] = 49 ether;
        tokenPublicMintsPerAddress[15] = 500;
        tokenPublicSaleStartTime[15] = 1687143600;
        tokenPublicSaleEndTime[15] = 1689822000;
        tokenUsePublicSaleTimes[15] = true;
        require(
