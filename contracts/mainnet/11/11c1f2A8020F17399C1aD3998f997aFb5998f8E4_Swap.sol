...
import "./interfaces/polygon/IUniswapV2Router02.sol";
...
library SwapHelper {
    ...
    function _isValidTwoTokensSwap(
        ...
        uint _amount = _getAmountsOut(_router, _amountIn, _path);
        success = _amount > _minimumAmountOut;
    }
    ...
    function _isValidTwoRoutersSwap(
        ...
        _path[0] = _inputToken;
        _path[1] = _secondPath;
        uint _amount = _getAmountsOut(_firstRouter, _amountIn, _path);
        
        _path[0] = _secondPath;
        _path[1] = _outputToken;
        uint _amount2 = _getAmountsOut(_secondRouter, _amount, _path);
    ...
    function _getAmountsOut(
        ...
        try IRouter02(_router).getAmountsOut(
            _amountIn, 
            _path
