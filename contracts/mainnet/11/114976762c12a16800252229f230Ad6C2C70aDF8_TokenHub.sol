    ...
    EIP712MetaTransaction
{
        ...
        onlyWorker
    {
        ...
        require(
            canDepositAgain(depositorAddress) == true,
            "TokenHub: DEPOSIT_COOLDOWN"
        );

        userFrames[depositorAddress] = block.timestamp;

        require(
            supportedTokens[_paymentTokenAddress] == true,
        ...
        userPurchases[depositorAddress] =
    ...
    function canDepositAgain(
        ...
        returns (bool)
    {
        return block.timestamp - userFrames[_depositorAddress] > depositFrame;
    }
}