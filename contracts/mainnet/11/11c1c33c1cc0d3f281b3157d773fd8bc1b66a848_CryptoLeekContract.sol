...
/// @title Contract for CryptoLeek NFT
...
contract CryptoLeekContract is ERC721A, Ownable {
    uint256 constant public MAX_SUPPLY = 100;
    string private baseTokenURI;

    mapping(bytes32 => bool) public tidMinted;

    constructor() ERC721A(unicode"韭菜兄弟 x DTTD", "LEEKXDTTD") {
        baseTokenURI = "https://dot.dttd.group/LEEKXDTTD/t";
        _mint(msg.sender, 1);
    }
