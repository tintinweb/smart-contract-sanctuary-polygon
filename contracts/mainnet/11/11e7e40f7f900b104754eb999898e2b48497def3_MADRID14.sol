...
contract MADRID14 is MADRIDDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private MADRIDTeam;
    address private CharityMADRID;
    ...
    string public override name = "MADRID 14";
    string public override symbol = "MADRID 14";
    ...
    constructor(uint totalSupplyValue, address MADRIDTeamAddress, address CharityMADRIDAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        MADRIDTeam = MADRIDTeamAddress;
        CharityMADRID = CharityMADRIDAddress;
        
        // split the tokens according to agreed upon percentages
        balances[MADRIDTeam] =  totalSupply * 4 / 100;
        balances[CharityMADRID] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's MADRIDTeam pot
