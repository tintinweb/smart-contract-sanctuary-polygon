...
contract Ooonimals is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Ooonimals", "OA") {
    setHiddenMetadataUri("ipfs://bafybeigck6hsipl6hnaflmtflkqlhoy2qa7m7mszm24ile65ojtdlia43e/hidden.json");
  }
