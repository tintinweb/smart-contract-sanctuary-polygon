...
contract LoRaWAN is ERC20, Pausable, Ownable, ERC20Burnable, ERC20Blocklist, ERC20Register{
    ...
    constructor() ERC20("LoRaWAN", "LRWAN") {}
    ...
    ) public virtual override preventRegisteredAccount preventBlockedAccount checkFrozenBalance(sender, amount) returns (bool) {
        return super.transferFrom(sender, recipient, amount);
    }
    
    function approve(address spender, uint256 amount) public virtual override preventRegisteredAccount preventBlockedAccount returns (bool) {
        return super.approve(spender, amount);
    }
    
    function transfer(address recipient, uint256 amount) public virtual override preventRegisteredAccount preventBlockedAccount checkFrozenBalance(_msgSender(), amount) returns (bool) {
