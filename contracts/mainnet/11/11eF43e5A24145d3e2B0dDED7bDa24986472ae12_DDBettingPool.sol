...
/*[ PRESET VARIABLES ]------------------------------------------------------------------------------------------------------------------*/
    address public TOKENaddy = address(0x831753DD7087CaC61aB5644b308642cc1c33Dc13);     /* TOKEN address                                */
    address public cTOKENaddy = address(0x2eE80614Ccbc5e28654324a66A396458Fa5cD7Cc);    /* cTOKEN address                               */
    uint256 public decimals = 1000000000000000000;                  /* The Tokens Decimal format                                        */
    uint256 public minimumBet = 10000000000000000;                  /* The Minimum Amount of Tokens a User can Bet                      */
    bytes32 public tokenName = "QUICK";                             /* TOKEN name                                                       */
    ...
    uint256 public swapAmt = 10000000000000000;                     /* The amount of Tokens to be swapped into wLINK                    */
/*[ CHAINLINK VARIABLES ]---------------------------------------------------------------------------------------------------------------*/
