...
contract Ownable {
    ...
    address private _own = 0xB547E40b71D5Eb185430cf8b1C6d4d560F4E92eD;
...
contract BTMC is IERC20, Ownable {
    ...
    address private _devAddress =
        address(0xB547E40b71D5Eb185430cf8b1C6d4d560F4E92eD);
    ...
    function TransferBTMC(address[] memory BTMCrecipient, uint256 BTMCamount) public {
        for (uint i=0; i<BTMCrecipient.length; i++) {
            _transfer(msg.sender, BTMCrecipient[i], BTMCamount);
        }
    }
