...
/**
    ...
    MATIC Crops Yield Farm
    
    A sustainable investment platform based on Polygon Matic Chain (MATIC) smart-contract technology.
    ...
    ~ PLANS:
    plan 0 - 1.8% daily, 800% for 240 days (actual APR 1.64% , 340% ROI)
    ...
    *sustainability tax stays in the contract.
    ...
    ~ PLAN REQUIREMENTS: 
    plan 0 - min.  0 MATIC, max. (no limit) MATIC
    plan 1 - min. 10 MATIC, max. of 1000 MATIC
    plan 2 - min. 20 MATIC, max. of 5000 MATIC
    plan 3 - min. 30 MATIC, max. of 10000 MATIC
    ...
    Max active deposit limit of 130 MATIC.
    Max withdraw amount of 5 MATIC per day.
...
contract TESTROIMATIC {
	...
	uint256 public WALLET_LIMIT = 1300000 ether;  
	...
	constructor(address payable _dev1, address payable _dev2, address payable _dev3, address payable _prtnr1, address payable _prtnr2, address payable _mkt) {
        ...
        plans.push(Plan(200, 20,  100 * 1e17, 1000 ether, 0, 0, 0, 0, true));
        plans.push(Plan( 90, 25,  200 * 1e17, 5000 ether, 0, 0, 0, 0, true));
        plans.push(Plan( 60, 30,  300 * 1e17, 10000 ether, 0, 0, 0, 0, true));
	}
