...
contract VirtualLandToken is ERC721, Ownable {
    ...
    constructor () ERC721("Virtualand", "VRV") {
        isSaleActive = true;
        totalSupply = 101;
        BASE_URI = "https://virtualand.technology/NFT-P/";
    }
    ...
    returns (string memory)
  {
   ...
   function mint(uint256 amount) external onlyOwner payable  {
