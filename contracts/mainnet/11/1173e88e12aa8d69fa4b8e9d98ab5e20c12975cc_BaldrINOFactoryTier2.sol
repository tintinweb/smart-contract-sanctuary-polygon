...
Minting these NFTs will give you access to Baldr Tokens Tier 2 equivalent to 10 $BALDR on airdrop

*/



contract BaldrINOFactoryTier2 is ERC721, ERC721Enumerable, Pausable, Ownable {
    ...
    uint256 public PRICE = 100000000; // price in token dec

    string private constant TOKEN_URI = "/2.json"; //Metadata Id



    constructor(address _payableToken, address _baldrDeployer) ERC721("Baldr INO NFT Tier 2", "pBALDR") {
