...
contract RubicSymbiosisProxy is ReentrancyGuard, AccessControl {
    ...
    function SymbiosisCallWithNative(address integrator, bytes memory data) external payable nonReentrant {
