...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xf9BAb2D7961b3E60f5566070b533Df82101B77Ae];
  address public erc20Payable = 0xf9BAb2D7961b3E60f5566070b533Df82101B77Ae;
...
abstract contract Feeable is Teams {
  uint256 public PRICE = 100.01 ether;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 25, 45) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeietlhwglw52mt3minbkg4sawenblxg54zs2cu6kiqievcnbvwebmi/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/acLszcqc6AtpxZ5vA3dw/contract-metadata";
  }
...
// File: contracts/FinlandsWonderlandSummerContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract FinlandsWonderlandSummerContract is RamppERC721A {
    constructor() RamppERC721A("Finlands Wonderland Summer", "FINSUM"){}
}
