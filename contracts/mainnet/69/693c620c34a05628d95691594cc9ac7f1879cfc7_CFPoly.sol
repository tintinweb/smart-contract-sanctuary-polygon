...
ReentrancyGuard
{
    ...
    */
    ...
    {
        _createCampaign(startDate, endDate, target);
    }

    function _createCampaign(uint startDate, uint endDate, uint256 target) private
    {
