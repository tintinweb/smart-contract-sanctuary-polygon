...
contract FoleArtMx is ERC721A, ApprovalsGuardDynamicOwner {
  string private baseURI;
  uint256 private _revelationTime;
  string private _hiddenURI = "https://ipfscdn.openarthub.io/ipfs/QmYLyQKQ1djorGyBQdkrzxSCuLR27ni2R4rFdhk9uKx9bv/";
  ...
  function setBaseUri(string memory uri) external onlyManagerOrOwner {
    baseURI = uri;
  }
  ...
  function mint(uint256 amount) external onlyManagerOrOwner {
    require(_totalMinted() + amount <= _maxSupply, "Amount exceeds max supply.");
