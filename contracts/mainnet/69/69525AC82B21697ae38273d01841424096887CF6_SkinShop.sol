...
contract SkinShop is OwnableUpgradeable {
    ...
    function buySkin(uint skinId, uint payWith) external {// 1 for usdt 2 for bvt
        ...
        if (payWith == 1) {
            ...
            BVT.transferFrom(msg.sender, address(0x000000000000000000000000000000000000dEaD), coutingCost(skinId));
        }
...
contract CattleSkin is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721('Cattle Skin', 'Cattle Skin') {
        ...
        level : 1,
        effect : eff,
        URI : 'QmaLdkowKALvuwTg4MKdgP8SuQo4C7z6rATYdXPMSjxP7q',
        burnAmount:0,
        currentAmount:0
        });
        ...
        level : 1,
        effect : eff,
        URI : 'QmTdhnQE53jf2sgnXC8R8jbG3n6hS6WCquNcG7LnEZBLi2',
        burnAmount:0,
        currentAmount:0
        });
        ...
        level : 2,
        effect : eff,
        URI : 'QmeS7seCbSrBvhhXGBtZ3qRW6QkqXop83wZtCvE1TNtKNX',
        burnAmount:0,
        currentAmount:0
        });
        ...
        level : 2,
        effect : eff,
        URI : 'QmRa5EXNGeMxhst2eMB57WvgojUbgpZTeWTSzHdZAhjb7H',
        burnAmount:0,
        currentAmount:0
        });
        ...
        level : 3,
        effect : eff,
        URI : 'QmdiUmRSAF1f5Q6VjW34puznFN74z5NTjyY2Nw7A62XGY3',
        burnAmount:0,
        currentAmount:0
        });
    }
    ...
    function tokenURI(uint256 tokenId_) override public view returns (string memory) {
        ...
        return string(abi.encodePacked(myBaseURI,"/",skinInfo[skinIdMap[tokenId_]].URI));
    }
