...
import "../interfaces/maximizer/IDysonMaximizerVault.sol";
import "../interfaces/IDysonVault.sol";
import "../interfaces/IPenroseMasterChef.sol";
import "../interfaces/IStakingPool.sol";
import "../interfaces/IUserProxyFactory.sol";
import "../interfaces/maximizer/IMaximizerRoutes.sol";

// TODO: pending rewards for secondary want
// TODO: only harvest when a certain time has elapsed?

contract Maximizer is Initializable, StratManagerUpgradeable, DynamicFeeManager {
    using SafeERC20Upgradeable for IERC20Upgradeable;
    using SafeERC20Upgradeable for IDysonVault;
    using SafeERC20Upgradeable for IDysonMaximizerVault;
    ...
    IDysonVault public primaryVault;
    IDysonMaximizerVault public maximizerVault;
    IMaximizerRoutes public maximizerRoutes;
    ...
    function __Maximizer_init(
        ...
        __Maximizer_init_unchained(_primaryVault, _secondaryWant, _rewards, _penroseAddresses, _native, _maximizerRoutesAddress);
    }

    function __Maximizer_init_unchained(
        address _primaryVault,
        address _secondaryWant,
        address[] memory _rewards,
        ...
        maximizerVault = IDysonMaximizerVault(vault);
        ...
        primaryVault = IDysonVault(_primaryVault);
        ...
        native = _native;
        maximizerRoutes = IMaximizerRoutes(_maximizerRoutesAddress);
    ...
    function deposit(address _sender, uint256 _shares) public whenNotPaused {
        ...
        uint256 userNewShare = maximizerVault.balanceOf(_sender) + _shares;
        // update reward debts
    ...
    function _harvestRewardAndSecondaryLP(address _sender) internal {
        UserInfo storage user = userInfo[_sender];
        uint256 userBalance = maximizerVault.balanceOf(_sender);
    ...
    )
    {
        ...
        uint256 userBalance = maximizerVault.balanceOf(msg.sender);
...
import "../maximizer/IMaximizer.sol";

interface IDysonMaximizerVault {
  function addTokenManager ( address _address ) external;
  ...
  function removeTokenManager ( address _address ) external;
  function renounceOwnership (  ) external;
  function setStrategy ( address _strategy ) external;
  function strategy (  ) external view returns ( IMaximizer );
...
interface IDysonVault is IERC20Upgradeable {
...
import "../IDysonVault.sol";
import "../maximizer/IDysonMaximizerVault.sol";
import "../maximizer/IMaximizerRoutes.sol";
import "@openzeppelin/contracts-upgradeable/token/ERC20/IERC20Upgradeable.sol";
import "../IDystopiaRouter.sol";
...
interface IMaximizer {
  ...
  function maximizerRoutes (  ) external view returns ( IMaximizerRoutes );
  function maximizerVault (  ) external view returns ( IDysonMaximizerVault );
  ...
  function primaryVault (  ) external view returns ( IDysonVault );
  function renounceOwnership (  ) external;
