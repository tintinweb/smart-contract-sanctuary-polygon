...
contract GREATROBOTS is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    uint256 public maxSupply = 4500;
    
    uint256 public PRICE = 9 ether;
    uint256 public WHITELIST_SALE_PRICE = 3 ether;
    uint256 public perAddressLimit = 50;
    ...
    constructor() ERC721A("GREAT ROBOTS", "GDAR") {}
