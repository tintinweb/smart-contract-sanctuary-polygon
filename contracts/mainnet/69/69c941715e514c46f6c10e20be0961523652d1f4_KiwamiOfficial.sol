...
contract KiwamiOfficial is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Kiwami Official", "KF") {
    setHiddenMetadataUri("ipfs://QmeDEP3e4S7GvhzudUtvFwdxofJHU7YZpgrpUQQs6JuciT/hidden.json");
  }
