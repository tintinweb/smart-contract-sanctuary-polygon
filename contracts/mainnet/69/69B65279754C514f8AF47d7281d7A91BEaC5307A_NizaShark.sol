...
contract NizaShark is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://Qmdazt49k82MzxWcELMnF4tmeipZPP2Ebb85B3G7mJgpmm/";
  ...
  constructor() ERC721("Niza Shark", "NISH") {
    setHiddenMetadataUri("ipfs://Qmdazt49k82MzxWcELMnF4tmeipZPP2Ebb85B3G7mJgpmm/1.json");
  }
