...
contract MetaInvestor is ERC721, Ownable {
    uint256 private _totalSupply;
    uint256 private _maxSupply = 2022;
    ...
    address private _wallet1 = 0x0b539075989582842Ff5564c19b3436A55f31B3E;
    address private _wallet2 = 0x276ea0AE53b3b2a931880A3b2809fc8087A55EED;
    ...
    constructor() ERC721("Meta Investor", "MIC") {}
    ...
    function mintPublicsale(uint256 count) external payable {
        ...
        require(count > 0 && count <= 50, "Out of per transaction mint limit");
    ...
    function mintPresale(uint256 count) external payable {
        require(msg.sender == tx.origin, "Reverted");
        require(count > 0 && count <= 10, "Out of per transaction mint limit");
        require(_totalSupply + count <= _maxSupply, "Can not mint more than max supply");
        require(msg.value >= count * price, "Insufficient payment");
    ...
    function mintGiveaway() external onlyOwner {
        require(msg.sender == tx.origin, "Reverted");
        require(_totalSupply < 22, "Out of limit");
