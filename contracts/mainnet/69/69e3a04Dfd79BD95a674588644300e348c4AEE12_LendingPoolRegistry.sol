...
contract LendingPoolRegistry is ILendingPoolRegistry {
  ...
  constructor(address _addressRegistry, address _timelockController) {
  ...
  function whitelistPool(
    ...
    address jCopTokenAddress = (ILPTokenDeployer(addressRegistry.get("LPTokenDeployer"))).deploy(
      _jCopName,
      _jCopSymbol,
      _lpAddress
    );
    address sCopTokenAddress = (ILPTokenDeployer(addressRegistry.get("LPTokenDeployer"))).deploy(
      _sCopName,
      _sCopSymbol,
      _lpAddress
    );
