...
contract TheCanadaCoin is BaseErc20, Taxable, Dividends {
    ...
    constructor () {
        ...
        // UniswapV2Router02
        //address UniswapV2Router02 = 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff; // TESTNET
        address UniswapV2Router02 = 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff; // MAINNET
        IDEXRouter router = IDEXRouter(UniswapV2Router02);
        address WMATIC = router.WETH();
        address pair = IDEXFactory(router.factory()).createPair(WMATIC, address(this));
        exchanges[pair] = true;
        taxDistributor = new TaxDistributor(UniswapV2Router02, pair, WMATIC);
        ...
        _allowed[address(taxDistributor)][UniswapV2Router02] = 2**256 - 1;
