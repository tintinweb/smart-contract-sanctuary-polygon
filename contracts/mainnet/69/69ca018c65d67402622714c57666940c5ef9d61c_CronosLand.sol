...
contract CronosLand is ERC721Enumerable, Ownable, ReentrancyGuard  {
  ...
  uint256 public bronzePrice = 0;
  uint256 public silverPrice = 0;
  uint256 public goldPrice = 0;
  ...
  function mintBronze(uint256 _mintAmount) public nonReentrant() {
    ...
    require(maxMintBronze + _mintAmount <= 2 , "SOLD OUT");
   ...
   function mintSilver(uint256 _mintAmount) public nonReentrant() {
    ...
    uint256 silver = 2;
    require(limit[msg.sender] + _mintAmount <= 30, "LIMIT REACHED");
    require(maxMintSilver + _mintAmount <= 1, "SOLD OUT");
    uint256 supply = totalSupply();
    require(_mintAmount > 0, "need to mint at least 1 NFT");
    require(_mintAmount <= maxMintAmount, "max mint amount per session exceeded");
    require(supply + _mintAmount <= maxSupply, "max NFT limit exceeded");
   ...
   if (msg.sender != owner()) {
    ...
    uint256 gold = 3;
    require(limit[msg.sender] + _mintAmount <= 30, "LIMIT REACHED");
    require(maxMintGold + _mintAmount <= 1, "SOLD OUT");
    uint256 supply = totalSupply();
    require(_mintAmount > 0, "need to mint at least 1 NFT");
    require(_mintAmount <= maxMintAmount, "max mint amount per session exceeded");
    require(supply + _mintAmount <= maxSupply, "max NFT limit exceeded");
  ...
  function mintDiamond(uint256 _mintAmount) public nonReentrant() {
    ...
    uint256 diamond = 4;
    require(limit[msg.sender] + _mintAmount <= 30, "LIMIT REACHED");
    require(maxMintDiamond + _mintAmount <= 5, "SOLD OUT");
    uint256 supply = totalSupply();
    require(_mintAmount > 0, "need to mint at least 1 NFT");
    require(_mintAmount <= maxMintAmount, "max mint amount per session exceeded");
    require(supply + _mintAmount <= maxSupply, "max NFT limit exceeded");
