...
contract Nyolings is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public publicSupply = 555;
    ...
    constructor() ERC721A("NataliaNFT", "Natalia NFT") {}
    ...
    function mintAllowList1(uint256 amount, uint256 allowance) public payable mintCompliance(amount) {
    ...
    function setCosts(uint256 _allowlistCost, uint256 _publicCost) public onlyOwner {
        allowlistCost = _allowlistCost;
        publicCost = _publicCost;
    }

    function setPublicSupply(uint256 _publicSupply) external onlyOwner {
        require(_publicSupply <= maxSupply, "Public supply can't be higher than max supply");
