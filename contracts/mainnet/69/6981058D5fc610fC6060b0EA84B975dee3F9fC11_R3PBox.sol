...
interface ITicket {
    ...
    function burn(uint256 tokenId, uint256 tickets) external;
}
...
import {RBAC} from "../utils/RBAC.sol";
import "../interfaces/ITicket.sol";
import "../interfaces/IBoxMintable.sol";

contract R3PBox is ERC1155Supply, ERC1155URIStorage, RBAC, ITicket, IBoxMintable {
    ...
    function mint(
        ...
        uint256 id,
        uint256 amount
    ) external override(ITicket, IBoxMintable) onlyRole(MINTER_ROLE) {
    ...
    // Payback method for not used tickets.
    function burn(uint256 _tokenId, uint256 _tickets) external onlyRole(BURNER_ROLE) {
        _burn(msg.sender, _tokenId, _tickets);
    }
    ...
    // @dev For IPFS only can brake your tokenURIs.
