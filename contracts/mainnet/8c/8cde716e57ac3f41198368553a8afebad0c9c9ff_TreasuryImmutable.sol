...
contract TreasuryImmutable is Treasury {
    ...
    /// @param _stablecoin Address of the stablecoin
    /// TODO for not mock contracts put back the modifier onlyGovernor
    function setStablecoin(IAgToken _stablecoin) public {
    ...
    /// TODO for not mock contracts put back the modifier onlyGovernor
    /// @inheritdoc Treasury
    function addVaultManager(address vaultManager) external override {
