...
contract OtterQiLocker is LockerOwnedUpgradeable, UUPSUpgradeable, IStrategy {
    ...
    IStrategy public constant tusdUsdcStrategy =
        IStrategy(0xB769AB096496594B7aa06e7eA50B18EA520d2297);
        ...
        returns (uint256)
    {
        ...
        if (reinvestAmount > 0) {
            IERC20(USDC).approve(address(tusdUsdcStrategy), reinvestAmount);
            tusdUsdcStrategy.invest(USDC, reinvestAmount);
        }
