...
// File: AmountDerivationErrors.sol
...
// File: ConsiderationErrorConstants.sol
...
// File: ConduitControllerInterface.sol
...
// File: ZoneInteractionErrors.sol
...
// File: CriteriaResolutionErrors.sol
...
// File: FulfillmentApplicationErrors.sol
...
// File: SignatureVerificationErrors.sol
...
// File: TokenTransferrerErrors.sol
...
// File: ViciNFTFulfillment.sol

// This contract doesn't need these imports, but they will make hardhat and
// brownie generate the artifacts.
    ...
    ConsiderationEventsAndErrors
{
    ...
    function preflightERC20Check(
        ...
        try token.allowance(participant, address(conduit)) returns (uint256 allowed) {
    ...
    function preflightERC721Check(
        ...
        try token.isApprovedForAll(participant, address(conduit)) returns (bool approved) {
