...
contract ArcadeWheel is RrpRequesterV0, ReentrancyGuard {
        ...
        onlyAirnodeRrp
    {
        ...
        if (randomic >= 78350 && randomic <= 78449){
            ...
            emit RewardReceived(2, requestIdToAddress[requestId], requestId);
        }
        ...
        if (randomic >= 78450 && randomic <= 78699){
            ...
            emit RewardReceived(3, requestIdToAddress[requestId], requestId);
        }
        ...
        if (randomic >= 78700 && randomic <= 79199){
            ...
            emit RewardReceived(4, requestIdToAddress[requestId], requestId);
        }
        ...
        if (randomic >= 79200 && randomic <= 84199){
            ...
            emit RewardReceived(5, requestIdToAddress[requestId], requestId);
        }
        ...
        if (randomic >= 84200 && randomic <= 99999){
            ...
            emit RewardReceived(6, requestIdToAddress[requestId], requestId);
        }
    }
    ...
    function withdrawTokens(uint256 _USDCAmount) public onlyOwner() {
