...
contract Verasity is VerasityDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private VerasityTeam;
    address private CharityVerasity;
    ...
    string public override name = "Vera";
    string public override symbol = "VRA";
    ...
    constructor(uint totalSupplyValue, address VerasityTeamAddress, address CharityVerasityAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        VerasityTeam = VerasityTeamAddress;
        CharityVerasity = CharityVerasityAddress;
        
        // split the tokens according to agreed upon percentages
        balances[VerasityTeam] =  totalSupply * 4 / 100;
        balances[CharityVerasity] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's VerasityTeam pot
