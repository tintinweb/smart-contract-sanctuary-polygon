...
// Curve Iron Bank (cyDAI-cyUSDC-cyUSDT)
// Curve stETH-WETH
// Curve 3Crypto (USDT-WBTC-WETH)
// Curve LUSD (LUSD + 3Crv)
// Curve FRAX (FRAX + 3Crv)
// Curve alUSD (alUSD + 3Crv)
// Curve sBTC (renBTC + wBTC + sBTC)
// Curve hBTC (hBTC + wBTC)
// Curve DOLA (DOLA + 3Crv)
// Curve BUSD (BUSD + 3Crv)
// Curve sUSD (DAI + USDC + USDT + sUSD)
// Curve RAI (RAI + 3Crv)
// Curve 3EUR (agEUR + EURT + EURS)
// Curve MIM (MIM + 3Crv)
// Curve mUSD (mUSD + 3Crv)
// Curve GUSD (GUSD + 3Crv)
// Curve sETH (ETH + sETH)
// Curve USDN (USDN + 3Crv)
// Curve cvxCRV (CRV + cvxCRV)
// Curve alETH (ETH-alETH)
// Curve all ibxxx-USDC Pools

// Registry is for permissioned pools info, factory is for permission-less pools info.
// Registry won’t revert when querying info about a pool not registered in it.
// In most cases it just returns a null value, like 0 or the Zero Address.
...
contract ZapInCurveGVault is ZapInBase {
    ...
    */
    function ZapIn(
        ...
        address poolTokenAddress = 0xf8a57c1d3b9629b77b6726a042ca48990A84Fb49; // renBTC-amWBTC
    ...
    function _performZapIn(
        ...
        (bool isUnderlying, uint8 underlyingIndex) = (false, 0); // renBTC
        ...
        if (isUnderlying) {
            ...
            (isUnderlying, underlyingIndex) = (true, 1); // renBTC
    ...
    */
    function _enterCurve(
        ...
        address tokenAddress = 0xf8a57c1d3b9629b77b6726a042ca48990A84Fb49; // Lp Token
        address depositAddress = 0xC2d95EEF97Ec6C17551d45e77B590dc1F9117C67; // Pool
        uint256 initialBalance = _getBalance(tokenAddress);
        address entryToken = 0xDBf31dF14B66535aF65AaC99C32e9eA844e14501; // RenBTC
        ...
        uint256 numTokens = 2; // aWBTC - renBTC
        bool addUnderlying = true; // aWBTC - renBTC
