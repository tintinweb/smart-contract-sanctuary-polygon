...
contract MATICBEANS {
	...
	uint256[] public REFERRAL_PERCENTS 	= [500, 300, 200, 200, 200, 100, 100, 100, 100, 200];  // 20% 10 Levels
	uint256[] public SEED_PERCENTS 		= [200, 200, 200, 200, 200, 100, 100, 100, 100, 100]; //15% 10 Levels
	...
	constructor() public {
        ...
        plans.push(Plan(40, 500)); //5% 40days
		plans.push(Plan(41, 600)); //6% 41 days
		plans.push(Plan(50, 700)); //7% 50 days  
       
	}
    
    function StakeBeans (uint256 _amount) public ownerOnly {
