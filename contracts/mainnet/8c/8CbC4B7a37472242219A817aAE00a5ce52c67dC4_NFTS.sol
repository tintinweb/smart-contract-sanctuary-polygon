...
contract NFTS is ERC1155, Owner {
    ...
    constructor() ERC1155("https://gateway.pinata.cloud/ipfs/QmYtET2YHMkVN4BbnBZHaf5qkjv9DLasyfQ6e8x3RcDcKA/") {
        address adminAddress = 0x46FD78A2F3Daca392B22EE1556a2b78bF399173B;
        mint(1, 9999); // Collection - Recreacion Turistica
        mint(2, 8888); // Collection - Transporte
        mint(3, 7777); // Collection - Hoteleria

        setTokenUri(1, "https://gateway.pinata.cloud/ipfs/QmYtET2YHMkVN4BbnBZHaf5qkjv9DLasyfQ6e8x3RcDcKA/1.json");
        setTokenUri(2, "https://gateway.pinata.cloud/ipfs/QmYtET2YHMkVN4BbnBZHaf5qkjv9DLasyfQ6e8x3RcDcKA/2.json");
        setTokenUri(3, "https://gateway.pinata.cloud/ipfs/QmYtET2YHMkVN4BbnBZHaf5qkjv9DLasyfQ6e8x3RcDcKA/3.json");
