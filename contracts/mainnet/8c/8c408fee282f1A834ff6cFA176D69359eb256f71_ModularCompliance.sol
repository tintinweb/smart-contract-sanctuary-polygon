...
contract ModularCompliance is IModularCompliance, OwnableUpgradeable, MCStorage {
    ...
    /**
     *  @dev retro compatibility with TREX V3 compliance 
     *  will not be there in v4
     *  event does nothing but avoid throwing errors on v3 process calls 
     */
     ...
     *  @dev retro compatibility with TREX V3 compliance 
     *  will not be there in v4
     *  function does nothing but avoid throwing errors on v3 process calls 
     */
    function addTokenAgent(address _agentAddress) external onlyOwner {
     ...
     *  function does nothing but avoid throwing errors on v3 process calls 
     */
    function removeTokenAgent(address _agentAddress) external onlyOwner {
