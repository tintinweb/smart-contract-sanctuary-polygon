...
contract TestPFI is ERC20, Ownable {
    uint256 limit;
    mapping (address => uint) timeouts;
    
    constructor() ERC20("Test pFi", "TPFI") {
    ...
    function requestFunds() external{
        require(timeouts[msg.sender] <= block.timestamp - 5 minutes, "You can only withdraw once every 5 minutes. Please check back later.");
        _mint(msg.sender, limit);
