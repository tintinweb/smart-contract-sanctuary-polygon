...
contract AirChrysalis is VRFConsumerBaseV2 {
    ...
    function prizeSent(address account, uint256 _giveawayId) public {
        require(msg.sender == account, "only created of giveaway can call this");
    ...
    function resetGiveaways() public {
        for (uint256 idx = 0; idx < accounts.length; idx++) {
            ...
            for (uint256 j = 0; j< ids.length; j++) {
                ...
                giveawaysMap[accounts[idx]][ids[j]] = Giveaway(address(0), _tokenTuples, _participants, false, address(0), false);
            }
