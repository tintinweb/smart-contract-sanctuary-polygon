...
contract Polybet_Profile is AccessControl, ERC721Holder {
    ...
    constructor(
        ...
        cakeToken = IBEP20(address(0));
        numberCakeToReactivate = 2 ether;
        numberCakeToRegister = 2 ether;
        numberCakeToUpdate = 2 ether;
