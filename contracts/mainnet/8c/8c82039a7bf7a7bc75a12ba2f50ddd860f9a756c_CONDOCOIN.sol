...
contract CONDOCOIN is ERC20, ERC20Burnable, Pausable, Ownable {
    constructor() ERC20("CONDOCOIN", "CDC") {
        _mint(msg.sender, 1750000 * 10 ** decimals());
    }
