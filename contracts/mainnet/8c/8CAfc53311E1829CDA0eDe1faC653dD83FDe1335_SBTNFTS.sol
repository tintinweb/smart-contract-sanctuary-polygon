...
contract SBTNFTS is Ownable, ERC721Enumerable {
    using Address for address;
    using Strings for uint256;
    ...
    constructor() ERC721("SBT-NFT", "SBT-NFT") {
    ...
    function setSuperMinter(address newSuperMinter_, bool b)
        public
        onlyOwner
        returns (bool)
    {
    ...
    function setCooperationURI(string calldata platform_, string calldata uri_)
        public
        onlySuperMinters
    {
    ...
    function mintFromMinters(address player_, uint cardId_)
        public
        returns (uint)
    {
        require(
    ...
    // mint Batch 2
    function mintFromMintersMulti(address[] calldata player_, uint cardId_)
        public
        returns (bool)
    {
        if (superMinter != _msgSender() && !superMinters[_msgSender()]) {
    ...
    function playerTokenURI(address account_)
        public
        view
        returns (string[] memory)
    {
    ...
    function _cooperationURI(string calldata s_)
        internal
        view
        returns (string memory)
    {
    ...
    function tokenPlatformURI(uint tokenId_)
        public
        view
        returns (string memory)
    {
    ...
    function checkCooperationURI(string calldata s_)
        public
        view
        returns (string memory)
    {
    ...
    function checkCardStatus(uint tokenId_)
        public
        view
        returns (
            bool _isMinted,
