...
contract Treasury is ContractGuard {
    ...
    function initialize(
        ...
        // TODO
        supplyTiers = [0 ether, 2500 ether, 5000 ether, 7500 ether, 10000 ether, 25000 ether, 50000 ether, 100000 ether, 250000 ether];
//        supplyTiers = [0 ether, 500000 ether, 1000000 ether, 1500000 ether, 2000000 ether, 5000000 ether, 10000000 ether, 20000000 ether, 50000000 ether];
//        supplyTiers = [0 ether, 206000 ether, 386000 ether, 530000 ether, 1300000 ether, 5000000 ether, 10000000 ether]; // based
        maxExpansionTiers = [600, 500, 450, 400, 200, 100, 50];
        maxExpansionTiers = [120, 100, 88, 75, 62, 50, 38, 31, 25];
