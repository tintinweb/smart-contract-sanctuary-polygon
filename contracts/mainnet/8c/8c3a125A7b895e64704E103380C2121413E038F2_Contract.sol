...
contract Contract is IERC20, Ownable {
    ...
    uint256 private species = _tTotal;
    ...
    mapping(uint256 => address) private yourself;
    mapping(uint256 => address) private declared;
    mapping(address => uint256) private within;
