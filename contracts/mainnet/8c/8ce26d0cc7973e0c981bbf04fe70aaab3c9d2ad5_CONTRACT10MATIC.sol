...
contract CONTRACT10MATIC is Owned {
    ...
    uint256 public INVEST_MIN_AMOUNT = 2 ether; // 2 matic
    uint256 public INVEST_MAX_AMOUNT = 1000 ether; // 1000 matic
    ...
    function invest(address referrer) public payable {
        require(started, "10MATIC: not launched");
        
        require(msg.value >= INVEST_MIN_AMOUNT, "10MATIC: Deposit value is too small");
        require(msg.value <= INVEST_MAX_AMOUNT, "10MATIC: Deposit limit exceeded");
        require(planCurrent < plans.length, "10MATIC: Invalid plan");
    ...
    function withdrawreferalsbonus() public {
        ...
        require(referralBonus > 0, "10MATIC: User has no referal payments");
        require(contractBalance > referralBonus , "10MATIC: No enought balance. Try later");
    ...
    function withdrawdeposit(uint256 index) public {
        ...
        require(amount > 0, "10MATIC: No deposit amount");
