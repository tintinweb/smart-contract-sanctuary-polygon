    ...
    IERC721Receiver
{
    ...
    IAuction public auction = IAuction(0x07B74b2A56DCE721d5128c137FB1CE6Bc4a98918);


    bytes32 private constant ETH_NODE =
        0x7bb8237b54e801cf108eb3efb5a3d06b2366985979ad8184e49263d2a74e6fd4;
    ...
    function registerAndWrapETH2LD(
        ...
        _addLabel(label, names[ETH_NODE]);
        registrarExpiry = registrar.register(tokenId, address(this), duration);
        bytes32 node = _makeNode(ETH_NODE, labelhash);
        ens.setResolver(node, resolver);
        registrar.reclaim(tokenId, wrappedOwner);
        registrar.transferFrom(address(this), wrappedOwner, tokenId);
        // auction.setOnAuction(payable(wrappedOwner), tokenId);
    }
