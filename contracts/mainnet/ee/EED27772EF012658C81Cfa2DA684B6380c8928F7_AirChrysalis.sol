...
contract AirChrysalis is VRFConsumerBaseV2 {
    ...
    event GiveawayWinnerVerified(uint256[] randomWords, uint256 indexed giveawayId);
    ...
    function createGiveaway(address _contractAddr, uint256[2][] memory _tokensTuple, uint32 winnersAmount) public {
        ...
        uint256 giveawayId = giveaways.length;
        giveaways.push(Giveaway(_contractAddr, _tokensTuple, new address[](0), new address[](0), false, winnersAmount, msg.sender, 0, new uint256[](0)));
    ...
    function fulfillRandomWords(uint256 requestId, uint256[] memory randomWords) internal override {
        ...
        giveaways[giveawayId].finished = true;
        giveaways[giveawayId].randomWords = randomWords;
        emit GiveawayWinnerVerified(randomWords, giveawayId);
    }
}
