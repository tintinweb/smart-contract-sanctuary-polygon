...
contract OBXExchange is Ownable {
        ...
        returns (bool)
    {
        ...
        if(tokenAddress == 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174){
            amount = amount / 10**12;
        } else if (tokenAddress == 0x491a4eB4f1FC3BfF8E1d2FC856a6A46663aD556f){
            amount = amount / 10**14;
        }
    ...
    function newSellOrder(
        ...
        if(tokenB == stableToken){
            if(tokenBaccumulatedFee >= 50 * 10 ** 6){
                distributeFees();
            }
        } else{
            if(tokenBaccumulatedFee >= 50 * 10 ** 4 ){
                distributeFees();
            }
        }
    ...
    function newBuyOrder(
        ...
        for (uint8 i = 0; i < len; i++) {
            ...
            if (buyAmount == 0) {
                ...
                if(tokenB == 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174){
                     tokenBaccumulatedFee += currentFee / 10**12;
                } else if (tokenB == 0x491a4eB4f1FC3BfF8E1d2FC856a6A46663aD556f){
                     tokenBaccumulatedFee += currentFee / 10**14;
                }
