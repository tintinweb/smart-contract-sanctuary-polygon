...
contract BMANA is BMANADeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private BMANATeam;
    address private CharityBMANA;
    ...
    string public override name = "BMANA";
    string public override symbol = "BMANA";
    ...
    constructor(uint totalSupplyValue, address BMANATeamAddress, address CharityBMANAAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        BMANATeam = BMANATeamAddress;
        CharityBMANA = CharityBMANAAddress;
        
        // split the tokens according to agreed upon percentages
        balances[BMANATeam] =  totalSupply * 4 / 100;
        balances[CharityBMANA] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's BMANATeam pot
