...
contract oxbeanznft is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("oxbeanznft", "oxbeanznft") {
    setHiddenMetadataUri("ipfs://QmQ6wRJ5PuRhMF5DuP8WHVMd6rkQFXysHbi1TDFCS3tgjK/hidden.json");
  }
