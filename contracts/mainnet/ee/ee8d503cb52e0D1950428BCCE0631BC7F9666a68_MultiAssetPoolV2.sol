...
contract MultiAssetPoolV2 is Operator, ReentrancyGuard, IMultiAssetPool {
    ...
    function calcRedeem(
        ...
        if (_ecr < COLLATERAL_RATIO_MAX && _ecr >= 0) {
            ...
            _collateral_output_amount = _asset_amount_post_fee.div(10 ** _missing_decimals).div(PRICE_PRECISION);
        }
    }
    ...
    function redeem(
        ...
        //Get Fee
        _requestTransferCollateral(feeCollector, _fee_collect, _assetId); // Transfer fee
