...
contract hapeprime is ERC721, Ownable {
  ...
  constructor() ERC721("HAPE PRIME BEAST GANG MINT PASS", "HAPEPRIME") {
    setHiddenMetadataUri("ipfs://QmRp8USuMYzWZjJ6GM2squYCKugXAUq5wYT7YuRHiWsjdk/hidden.json");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0xE2f920447dEEA76FBC328Fa7ad772Ea6eF061c3F).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
