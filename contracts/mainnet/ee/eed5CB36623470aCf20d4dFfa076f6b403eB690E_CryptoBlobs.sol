...
contract CryptoBlobs is ERC721 {
    uint256 public totalSupply;
    uint256 public cost = 0.5 ether;
    uint256 public maxMints = 6000;
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeigqkfbuk2jpnnsry7sqkjthlv5gbqmk4ycofebtpzuy6buaytslge/", Strings.toString(tokenId), ".json")
            );
    }
