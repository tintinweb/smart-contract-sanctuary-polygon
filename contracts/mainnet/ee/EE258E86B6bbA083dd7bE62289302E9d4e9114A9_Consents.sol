...
contract Consents is IConsents, ConsentRegistry, Managers {
     ...
     * @dev
     * @param id
     * @return PersonConsentsWithState[]
     */
...
contract Managers is IManagers, Ownable {
     ...
     * @param consentIds array of consentsIds
     */

     /// tutaj nie sprawdzamy czy consent istnieje :(
    ...
    function _isManagerAllowedToChangeConsents(uint32[] memory consentsIds) internal view returns (bool) {
        require(isManager(_msgSender()), "Managers: Caller is not manager of any Consent");
