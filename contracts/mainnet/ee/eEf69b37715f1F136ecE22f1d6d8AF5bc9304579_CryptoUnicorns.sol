 ...
 * @notice This contract handles minting Crypto Unicorns tokens.
 */
contract CryptoUnicorns is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xb5aA7195F7CB80BF4DEac30179c567e881ed0BEB;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x050c4E3AfE1DA73403548a020080ec0d8FF53b7E;
    ...
    address[] public payoutAddresses = [
        0x050c4E3AfE1DA73403548a020080ec0d8FF53b7E
    ];
    ...
    string public name = "Crypto Unicorns";
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeidqwhe2xpwaq3zqnglqivdquon6o7ouub5kurthofscybwp2astz4/{id}"
        )
        RevokableOperatorFilterer(
