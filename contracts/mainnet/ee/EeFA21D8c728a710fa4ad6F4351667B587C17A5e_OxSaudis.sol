...
abstract contract OxSaudisERC721A is 
    Ownable,
    ERC721A,
    ReentrancyGuard   {
    constructor(
    ...
    string public _baseTokenURI = "ipfs://QmXnjnZ4D8DDvCUqVDJ6QtBt1M3ZErsggNtBKmDD2oME3g/";
    
    bool public mintingOpen = true;
    uint256 public PRICE = 1 ether;
    
    uint256 public freeMax = 1000;
    uint256 public freeMintPerWalllet = 10;
    ...
    */
    ...
    function mint(uint256 _amount) public payable {
        ...
        if (currentTokenId() < freeMax) {
            require(currentTokenId() + _amount <= freeMax, "Cannot mint over free supply cap of 1000");
...
contract OxSaudis is OxSaudisERC721A {
    constructor() OxSaudisERC721A ("0xSaudis", "0xSaudis"){}
