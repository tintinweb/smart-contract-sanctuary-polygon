...
contract ConquestTreasureSilverFactory is RewardFactory {
  constructor(
...
// helper methods for safe transfer of ERC20 tokens
...
contract CardbacksFactory is RewardFactory {
  constructor(
    address _initialOwner,
    address _assetsAddr,
    uint256 _periodLength,
...
contract SkyweaverPaymentProxy is PaymentProxy {
  constructor(
    address _initialOwner
  ) PaymentProxy(_initialOwner, "Skyweaver Payment Proxy") public {}
}
