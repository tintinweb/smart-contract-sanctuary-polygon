...
contract HappykidsclubNFTs is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public cost = 0.024880 ether;
  ...
  constructor() ERC721("Happy kids club NFTs", "HKCN") {
    setHiddenMetadataUri("ipfs://Qme6yDRf4MiougqQ92QfWVqznmZ7FKqtSUtQdWGUQB2nK9/");
  }
