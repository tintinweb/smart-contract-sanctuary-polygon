...
contract ERC20Interface {
    ...
    function burn(address from, uint amount) public returns (bool success);
...
contract Yunnanilus is ERC20Interface {
    ...
    function burn(address from, uint256 amount) public returns (bool success) {
        require(from != address(0), "Kann nicht Tokens der null Adresse verbrennen");
        require(msg.sender == admin, "NICHT ADMIN");
        require(balances[from] >= amount, "Wallet besitzt nicht genug Tokens");
