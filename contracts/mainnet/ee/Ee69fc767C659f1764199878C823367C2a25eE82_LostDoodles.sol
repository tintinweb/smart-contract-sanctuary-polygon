...
contract LostDoodles is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeib3tgbo5oozpuys5y72baxfjd4mhnugj5diw5fvahq37za2drpd4i/", Strings.toString(tokenId), ".json")
            );
    }
