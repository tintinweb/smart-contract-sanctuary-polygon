...
contract MyNft is ERC721, Ownable, ERC2981 {
    ...
    address[] public withdrawAddresses = [0xb4082f8469795D49BD62DB1232561B4621BE127B, 0x8095263d3dcf7937BF7b3F798064BAbFf47f19f9];
    uint256[] public withdrawPercentages = [90, 10];


    bytes32 public merkleRoot = 0;

    constructor() ERC721("big", "b") {
        _baseTokenURI = "https://test-api.nftool.io/generator-server/api/contract/v1/oc5w4INT24jCRutX1/1607656728366039042/metadata/";
