...
contract FactoryManager is Owned {
    ...
    function deployNewERC20Token(
     ...
     function deployPartTwo(string calldata xtoken, string calldata xsymbol) private {
        ...
        StakingToken _staking = feeSplitterFactory.createStaking(RootedToken(tokenDeployments[counter].rootAddress), xtoken, xsymbol);
