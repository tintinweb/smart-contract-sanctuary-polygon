...
contract StashFacet {
    ...
    function setGameServer(address newGameServer) external {
        // This check is being performed in LibBank, but also doing it here defensively.
 ...
 *
 * This is a duplication/adaptation of the original LibServerSideSigning implemented in the CU-Contracts
