...
contract SAFEX is Context, IERC20, Ownable {
    ...
    string private constant _name = "SAFEX";
    string private constant _symbol = "SFX";
    ...
    address payable private _developmentAddress = payable(0xa888196212399A1104AAd6Fc141c92d44706C7e8);
    address payable private _marketingAddress = payable(0xa888196212399A1104AAd6Fc141c92d44706C7e8);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        require(taxFeeOnSell + redisFeeOnSell <= 5,"sell fee cannot be increased by more then 5 %");
        require(taxFeeOnBuy + redisFeeOnBuy <= 5,"buy fee cannot be increased by more then 5 %");
