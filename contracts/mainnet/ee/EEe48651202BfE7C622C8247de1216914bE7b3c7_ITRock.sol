...
contract ITRock is ERC721, Ownable {
    ...
    constructor() ERC721("IT Rock", "ITR") payable {
        // Max amount of tokens
        maxAmntTokens = 10000;
        // Max Mints per wallet
        maxMintsPerWallet = 1;
    ...
    function safeMint(address to) internal{
        ...
        tokensPerWallet[to].push(_tokenIdCounter.current());
    ...
    function mintNFT() public payable {
        //  Requires that available tokens
        require (checkMintedTokens() != maxAmntTokens, "No tokens left!");
        require (tokensPerWallet[msg.sender].length == 0, "You are allowed to mint a max of 1 NFT");
        safeMint(msg.sender);        
    }
}