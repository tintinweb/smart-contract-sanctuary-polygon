    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 77) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeigp4u7smunb6xy4eaj2a35ar35gnwfe3ft2ffxswufhsjh7ctcpo4/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/nXijsFoJKnSvincumNUx/contract-metadata";
  }
...
contract ChickenPillsContract is RamppERC721A {
    constructor() RamppERC721A("Chicken Pills", "bapmnft"){}
}
