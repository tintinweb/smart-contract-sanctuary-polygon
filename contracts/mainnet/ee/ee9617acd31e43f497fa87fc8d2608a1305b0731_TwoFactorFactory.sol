...
contract TwoFactorFactory is Ownable, CloneFactory {
  ...
  // function setFirstChildAddress(address _firstChildAddress) public onlyOwner {
  //   firstChildAddress = _firstChildAddress;
  // }

  function createTwoFactor(bytes32 _encryptedPassword) public {

    require(eoaToVaultMap[msg.sender] == address(0), "Vault already exists for user");
