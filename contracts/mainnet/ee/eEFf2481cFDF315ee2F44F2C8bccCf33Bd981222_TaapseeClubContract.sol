...
// File: contracts/TaapseeClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract TaapseeClubContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Taapsee Club";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/4S9vkoXDztZOYAUacHOD/contract-metadata";
  }
