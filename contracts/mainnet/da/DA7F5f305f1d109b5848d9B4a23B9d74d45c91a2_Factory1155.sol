...
import "./ICOZMICUser1155Token.sol";
...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new ICOZMICUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        ICOZMICUser1155Token token = ICOZMICUser1155Token(address(addr));
...
contract ICOZMICUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
