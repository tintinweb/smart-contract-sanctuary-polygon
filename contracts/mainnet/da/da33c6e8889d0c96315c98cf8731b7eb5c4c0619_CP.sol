...
contract CP {
    ...
    uint256 public silverLotteryEntryPrice = 0.00001 ether;
    uint256 public silverLotteryPotMaxAmount = 0.0001 ether;
    uint256 public silverLotteryMaxEntries = 10;
    bool public silverLotteryIsLive = true;

    address payable[] public playersGoldLottery;
    uint256 public goldLotteryEntryPrice = 0.00002 ether;
    uint256 public goldLotteryPotMaxAmount = 0.0002 ether;
    uint256 public goldLotteryMaxEntries = 10;
    bool public goldLotteryIsLive = false;

    address payable[] public playersDiamondLottery;
    uint256 public diamondLotteryEntryPrice = 0.00003 ether;
    uint256 public diamondLotteryPotMaxAmount = 0.0003 ether;
    ...
    uint256 public silverBattleEntryPrice = 0.00001 ether;
    uint256 public silverBattlePotMaxAmount = 0.00002 ether;
    uint256 public silverBattleMaxEntries = 2;
    bool public silverBattleIsLive = true;

    address payable[] public playersGoldBattle;
    uint256 public goldBattleEntryPrice = 0.00002 ether;
    uint256 public goldBattlePotMaxAmount = 0.00004 ether;
    uint256 public goldBattleMaxEntries = 2;
    bool public goldBattleIsLive = false;

    address payable[] public playersDiamondBattle;
    uint256 public diamondBattleEntryPrice = 0.00003 ether;
    uint256 public diamondBattlePotMaxAmount = 0.00006 ether;
