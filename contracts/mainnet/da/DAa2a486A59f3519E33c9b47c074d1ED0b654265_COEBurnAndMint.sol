  ...
  ReentrancyGuard
{
  ...
  function finishOpenFP() public nonReentrant {
    ...
    NftInterface(cardBacksAddress).adminMint(msg.sender, 0, 1, 1, false);
    NftInterface(cardBacksAddress).adminMint(msg.sender, 1, 1, 1, false);
  ...
  function removeRequest(uint256 _requestId) public onlyOwner {
