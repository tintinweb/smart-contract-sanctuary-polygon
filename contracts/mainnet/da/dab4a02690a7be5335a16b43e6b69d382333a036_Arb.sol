...
contract Arb is Ownable {
  ...
  address _token1, address _token2, address _token3, uint256 _amount) external {
    ...
    function _flashLoanCallBack(address sender, uint256, uint256, bytes calldata data) internal {
        (address flashLoanPool, address token1, address token2, address token3,
        address _router1, address _router2, address _router3, uint256 amount) = abi.decode(data, (address, address, address, address, address, address,address, uint256));
