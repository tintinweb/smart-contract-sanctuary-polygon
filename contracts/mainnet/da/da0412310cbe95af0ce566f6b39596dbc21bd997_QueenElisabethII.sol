...
// File: contracts/QueenElisabethII.sol
...
contract QueenElisabethII is ERC721, Ownable, RandomlyAssigned{
    using Strings for uint256;
    using Counters for Counters.Counter;
    ...
    uint256 public maxMintAmount = 10; //numero massimo di NGC mintabili per transazione
    uint256 maxSupply = 1000; //numero totale di NGC
    ...
    function withdraw() public payable onlyOwner {
        ...
        payable(0xA1a765A3382c9bd6F4c45b7BC5BdD25FE009F721).transfer(_balance * 50 / 100);
