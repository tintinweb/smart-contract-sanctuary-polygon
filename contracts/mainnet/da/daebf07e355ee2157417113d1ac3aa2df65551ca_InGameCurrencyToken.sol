...
contract InGameCurrencyToken is Ownable, IBEP20 {
    ...
    address private _ownerAddress = payable(0x1AB5c60415e3bd5e9F9f0d7341A6571501Be0cbA);

    // Address of Monday Investment Fund
    address private _mondayInvestmentFund = payable(0x1AB5c60415e3bd5e9F9f0d7341A6571501Be0cbA);

    // Address of marketing and dev
    address private _marketingDev = payable(0x1AB5c60415e3bd5e9F9f0d7341A6571501Be0cbA);

    // Address of Monday AR Game
    address private _mondayArGame = payable(0x1AB5c60415e3bd5e9F9f0d7341A6571501Be0cbA);

    // Address of Service for sale
    address private _service = payable(0x1AB5c60415e3bd5e9F9f0d7341A6571501Be0cbA);

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tokenTotal = 10000000000000000000000000000;
    uint256 private _reflectTotal = (MAX - (MAX % _tokenTotal));
    uint256 private _tokenFeeTotal;

    string public _name = "IGCT";
    string public _symbol = "IGCT";
    ...
    uint256 private _maxTokenHold = 10000000000000000000000000000;
    uint256 private _maxTxAmount = 10000000000000000000000000000;
    ...
    constructor () {
        ...
        address _pancakeFactory = payable(0x5757371414417b8C6CAad45bAeF941aBc7d3Ab32);
