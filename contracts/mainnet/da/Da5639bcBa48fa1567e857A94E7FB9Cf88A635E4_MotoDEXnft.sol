...
contract MotoDEXnft is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    constructor(uint256 networkId, address _gameServer) ERC721("motoDEXnft", "MOTO") {
        ...
        setupType(RED_BULLER, 2 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmctnvtvXTaeBsSNtHmcvooyZ3fJ3Nj9sk37iMGiDCVWmz/RedBuller");
        setupType(ZEBRA_GRRR, 3 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmctnvtvXTaeBsSNtHmcvooyZ3fJ3Nj9sk37iMGiDCVWmz/ZebraGrrrr");
        setupType(ROBO_HORSE, 4 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmctnvtvXTaeBsSNtHmcvooyZ3fJ3Nj9sk37iMGiDCVWmz/RoboHorse");
        setupType(METAL_EYES, 5 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmctnvtvXTaeBsSNtHmcvooyZ3fJ3Nj9sk37iMGiDCVWmz/MetalEyes");
        setupType(BROWN_KILLER, 6 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmctnvtvXTaeBsSNtHmcvooyZ3fJ3Nj9sk37iMGiDCVWmz/BrownKiller");
        setupType(CRAZY_LINE, 7 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmctnvtvXTaeBsSNtHmcvooyZ3fJ3Nj9sk37iMGiDCVWmz/CrazyLine");
        setupType(MAGIC_BOX, 8 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmctnvtvXTaeBsSNtHmcvooyZ3fJ3Nj9sk37iMGiDCVWmz/MagicBox");

        setupType(TRACK_LONDON, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmctnvtvXTaeBsSNtHmcvooyZ3fJ3Nj9sk37iMGiDCVWmz/London");
        setupType(TRACK_DUBAI, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmctnvtvXTaeBsSNtHmcvooyZ3fJ3Nj9sk37iMGiDCVWmz/Dubai");
        setupType(TRACK_ABU_DHABI, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmctnvtvXTaeBsSNtHmcvooyZ3fJ3Nj9sk37iMGiDCVWmz/AbuDhabi");
        setupType(TRACK_BEIJIN, 50 ether, 30, "https://openbisea.mypinata.cloud/ipfs/QmctnvtvXTaeBsSNtHmcvooyZ3fJ3Nj9sk37iMGiDCVWmz/Beijing"); // TODO - change back
        setupType(TRACK_MOSCOW, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmctnvtvXTaeBsSNtHmcvooyZ3fJ3Nj9sk37iMGiDCVWmz/Moscow");
        setupType(TRACK_MELBURN, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmctnvtvXTaeBsSNtHmcvooyZ3fJ3Nj9sk37iMGiDCVWmz/Melburn");
        setupType(TRACK_PETERBURG, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmctnvtvXTaeBsSNtHmcvooyZ3fJ3Nj9sk37iMGiDCVWmz/Peterburg");
        setupType(TRACK_TAIPEI, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmctnvtvXTaeBsSNtHmcvooyZ3fJ3Nj9sk37iMGiDCVWmz/Taipei");
        setupType(TRACK_PISA, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmctnvtvXTaeBsSNtHmcvooyZ3fJ3Nj9sk37iMGiDCVWmz/Pisa");
        setupType(TRACK_ISLAMABAD, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmctnvtvXTaeBsSNtHmcvooyZ3fJ3Nj9sk37iMGiDCVWmz/Islamabad");

        setupType(HEALTH_PILL_5, 0.5 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmctnvtvXTaeBsSNtHmcvooyZ3fJ3Nj9sk37iMGiDCVWmz/HealthCapsule5");
        setupType(HEALTH_PILL_10, 1 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmctnvtvXTaeBsSNtHmcvooyZ3fJ3Nj9sk37iMGiDCVWmz/HealthCapsule10");
        setupType(HEALTH_PILL_30, 3 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmctnvtvXTaeBsSNtHmcvooyZ3fJ3Nj9sk37iMGiDCVWmz/HealthCapsule30");
        setupType(HEALTH_PILL_50, 5 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmctnvtvXTaeBsSNtHmcvooyZ3fJ3Nj9sk37iMGiDCVWmz/HealthCapsule50");
        ...
        if (networkId == 80001) {
            ...
            setupType(TRACK_LONDON, 0.05 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmTxriTHJFZb3jK3RyBGZoXNr8BBFyXWo526x1n1krKbUJ/London");
        }
