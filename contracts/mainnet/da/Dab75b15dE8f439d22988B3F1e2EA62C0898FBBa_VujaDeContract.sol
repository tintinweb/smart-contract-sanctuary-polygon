...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1688166000;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x14ee462B62931d02E0f6370C123173Fb8be89e41,0x2199Bb1bcc51c0C06f237b7D5aE3FD54aaCbA61A];
  address public erc20Payable = 0x14ee462B62931d02E0f6370C123173Fb8be89e41;
  uint256[] public payableFees = [65,35];
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 259) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeib7kmmcgg7ok27cnhlpufy7kwmfjhe74ckevt3smrvzkg2ptsi33a/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/iFQmj6pBYoXdO31kcFn6/contract-metadata";
  }
...
// File: contracts/VujaDeContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract VujaDeContract is ERC721APlus {
    constructor() ERC721APlus("Vuja De", "Vuja"){}
}
