...
contract InfiniteApeSpaceshipClub is ERC721A, Ownable {
  ...
  constructor(
	...
	amountForGoldlist = amountForGoldlist_;
    amountForDevs = amountForDevs_;
    require(
      amountForWhitelist_ + amountForGoldlist_ <= collectionSize_,
    ...
    callerIsUser 
  {
    ...
    require(
      totalSupply() + quantity <= amountForGoldlist,
      "not enough remaining reserved for auction to support desired mint amount"
    );
