...
contract FrameItFactory is IFrameItFactory, FrameItContext, Ownable {
    ...
    function createCollection(
        ...
        IFrameItNFT(nft).initialize(_nftUri, _contractUri, _msgSender(), nftMinter, _royaltiesFeeInBips, salesSplitter);
...
interface IFrameItNFT {
    ...
    function initialize(string calldata _newuri, string calldata _contractUri, address _owner, address _minter, uint256 _royaltyFeeInBips, address _salesWallet) external;
