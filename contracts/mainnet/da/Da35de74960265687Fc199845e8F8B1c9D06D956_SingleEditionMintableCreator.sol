...
// File: contracts/IEditionSingleMintable.sol
...
// File: contracts/IPublicSharedMetadata.sol
...
// File: contracts/SharedNFTLogic.sol
...
// File: contracts/SingleEditionMintable.sol
    ...
    OwnableUpgradeable
{
    ...
    /// Address for admins fee account
    ...
    constructor(SharedNFTLogic _sharedNFTLogic, address _feeAccount) {
     ...
     */
    function purchase(string memory orderId)
        external
        payable
        returns (uint256)
    {
        ...
        payable(feeAccount).transfer((msg.value * 5) / 100);
        payable(owner()).transfer((msg.value * 95) / 100);
    ...
    function _isAllowedToMint() internal view returns (bool) {
        ...
        if (address(feeAccount) == address(msg.sender)) {
            return true;
        }
...
// File: contracts/SingleEditionMintableCreator.sol
