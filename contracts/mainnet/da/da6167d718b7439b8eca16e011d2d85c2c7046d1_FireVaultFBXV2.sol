...
contract FireVaultFBXV2 is ERC20, ERC20Permit {
    ...
    IEP public constant EP = IEP(0x898Fa6c1436A0C7514BD2215405591e71e665234); // <<TESTING to set before deployment>>
    ...
    constructor() ERC20("FireVault FBX", "fireFBX") ERC20Permit("FireVault FBX") {
        _mint(msg.sender, 1692536561815369699817855); // Airdrop for current fireFBX owners <<TESTING to calculate before deployment>>
    ...
    function totalAssetsValuation() public view returns (uint256) {
        return totalEPValuation() + totalFBXBalance();
    }
