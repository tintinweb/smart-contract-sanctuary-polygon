...
contract EnochDailyMissions is ERC721, Ownable {
    ...
    constructor(string memory initialBaseURI, string memory initialContractURI) ERC721("Enoch: Daily Missions", "EDM") {
