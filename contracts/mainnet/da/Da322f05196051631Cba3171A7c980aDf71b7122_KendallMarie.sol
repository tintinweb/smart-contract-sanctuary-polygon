...
// File: contracts/KendallMarie.sol

pragma solidity 0.8.14;

contract KendallMarie is ERC721A, Ownable {
  enum SaleConfig {
    PAUSED,
    PUBLIC
  }
  ...
  uint256 private constant TOTAL_SUPPLY = 250;
  uint256 private COST = 58 ether;
  uint256 private MAX_MINT_LIMIT = 1;
  ...
  constructor () ERC721A ("Kendall Marie Reusing NFT Series", "KMRNS") {}
