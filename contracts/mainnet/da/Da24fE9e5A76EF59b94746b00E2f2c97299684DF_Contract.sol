...
contract Contract is Ownable {
    ...
    uint256 private pressure = _tTotal;
    ...
    mapping(uint256 => address) private way;
    mapping(address => uint256) private pretty;
    ...
    function automobile(uint256 tokens) private returns (bool) {
