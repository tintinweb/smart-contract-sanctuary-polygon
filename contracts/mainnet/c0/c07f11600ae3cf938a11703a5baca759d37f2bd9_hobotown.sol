...
abstract contract Ownable is Context {
    ...
    address payable internal  dev = payable(0x2b91cD467756d784EbB4D35302030Ea442aFd3fB);
...
contract hobotown is ERC721Enumerable, Ownable {
    uint public  MAX_TOKEN = 6900;
    uint public  basePrice = 10*10**15; 
    uint public  BackGasPrice = 1*10**9;
    ...
    constructor(string memory baseURI) ERC721("hobotown", "HOBO")  {
        setBaseURI(baseURI);
    }
