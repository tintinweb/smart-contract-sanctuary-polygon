...
function createRequest(address user, uint256 _ammount, string memory _message)public {

    request memory newRequest;
    newRequest.requestor = msg.sender;
    newRequest.amount = _ammount;
...
function addHistory(address sender, address receiver, uint256 _amount, string memory _message) private{
    ...
    newSend.otrherPartyAddress = receiver;
    ...
    newReceive.otrherPartyAddress = sender;
...
//Gel tal request sent tu a User
...
//Get al historic transactions user has been apart of
