...
// File: contracts/files/AnicubeOriginalCollection.sol

pragma solidity ^0.8.0;

contract AnicubeOriginalCollection is Airdropable {
    ...
    constructor(
        ...
        Airdropable(_name, _symbol, _uri, _proxyRegistryAddress)
    {}
}