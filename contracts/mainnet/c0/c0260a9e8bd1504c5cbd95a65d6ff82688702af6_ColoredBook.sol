...
contract ColoredBook is ERC4973 {
    ...
    uint256 private _nftEtherValue = 1000000000000000000;
    ...
    constructor() ERC4973("Colored Books", "TRCB", "TRCB") {
        owner = msg.sender;
        setBaseURI("https://gateway.pinata.cloud/ipfs/QmR6ZcLybPWAo6hrqo6uJBgob5DQsMzAMLZqevXHLJp4Mf/");
    ...
    function split(uint256 _mintAmount) public payable {
        uint256 _nftEtherValueTemp = _nftEtherValue * _mintAmount;
        uint256 amountM = msg.value * 50 / 100;
        uint256 ethEnd = _nftEtherValueTemp - amountM;

        require(msg.value >= ethEnd, "Valor da mintagem diferente do valor definido no contrato");
