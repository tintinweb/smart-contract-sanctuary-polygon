...
// File contracts/AstarSignWitch.sol
...
contract AstarSignWitch is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    function preMint(uint256 _mintAmount) public payable {
        ...
        require(
            ...
            "CL: Five Witch max per address in Witchlist."
        );
    ...
    function withdraw() public virtual {
        // DAO account 0x2690381aBBE2bD89aE6318fC501746f92c0Eb2A8
        (bool dao, ) = payable(0x2690381aBBE2bD89aE6318fC501746f92c0Eb2A8).call{
            value: (address(this).balance * 30) / 100
        }("");
        require(dao);

        // TEAM account 0x2690381aBBE2bD89aE6318fC501746f92c0Eb2A8
        (bool team, ) = payable(0x2690381aBBE2bD89aE6318fC501746f92c0Eb2A8)
