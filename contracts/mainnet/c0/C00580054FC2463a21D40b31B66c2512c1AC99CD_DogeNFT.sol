...
// File: ERC721EnumerableCustom.sol
 ...
 * account.
 */
abstract contract ERC721EnumerableCustom is ERC721Custom, IERC721Enumerable {
    mapping(address => uint[]) internal _balances;

    function balanceOf(address owner) public view virtual override(ERC721Custom, IERC721) returns (uint256) {
        require(owner != address(0), "ERC721: balance query for the zero address");
     ...
     * @dev See {IERC165-supportsInterface}.
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(IERC165, ERC721Custom) returns (bool) {
    ...
    function tokenOfOwnerByIndex(address owner, uint256 index) public view virtual override returns (uint256 tokenId) {
        require(index < ERC721Custom.balanceOf(owner), "ERC721Enumerable: owner index out of bounds");
    ...
    function tokenByIndex(uint256 index) public view virtual override returns (uint256) {
        require(index < ERC721EnumerableCustom.totalSupply(), "ERC721Enumerable: global index out of bounds");
        return index;
    }
...
contract DogeNFT is ERC721EnumerableCustom, Ownable {
    ...
    string private _baseTokenURI = "ipfs://Qmb7qVZ4bWENSkw1doczGfA16EH3xiF4JpSPk61xVqi8UL/";
    string private _tokenURISuffix = ".json";

    bool isContractLocked = false;
    
    constructor() ERC721Custom("Doge to the Moon", "DOGE") {}
    
    function mintNFT(uint quantity, address recipient) public onlyOwner {
