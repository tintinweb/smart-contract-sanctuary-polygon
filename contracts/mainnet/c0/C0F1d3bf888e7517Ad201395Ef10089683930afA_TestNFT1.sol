 ...
 * @notice This contract handles minting Test NFT 1 tokens.
 */
contract TestNFT1 is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x7bCc3F18018f75ba11C5a8698269F5B90F864A07;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x25F98FDD1F17ad11c02f1463eC6A79e7b1f39B07;
    address[] public payoutAddresses = [
        0x25F98FDD1F17ad11c02f1463eC6A79e7b1f39B07
    ];
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeiex3wua5mt3xryary4ut7qlhtpjekhw6lohfidpqapckzaz5jsgwa/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenPublicPrice[554] = 0 ether;
        tokenPublicMintsPerAddress[554] = 0;
        tokenPublicSaleStartTime[554] = 1685368800;
        tokenPublicSaleEndTime[554] = 2000729298;
        tokenUsePublicSaleTimes[554] = true;
        require(
