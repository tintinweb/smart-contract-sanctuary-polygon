...
contract FloozOnRamp is BaseRelayRecipient {
    // address of 0x contract to forward swaps
    ...
    constructor(address payable _zeroEx, address _trustedForwarder) public {
        zeroEx = _zeroEx;
    ...
    function floozSwap(SwapData calldata swapData) external payable {
        TransferHelper.safeTransferFrom(swapData.fromToken, _msgSender(), address(this), swapData.amountFrom);
        ...
        TransferHelper.safeTransfer(swapData.toToken, _msgSender(), IERC20(swapData.toToken).balanceOf(address(this)));
    }
