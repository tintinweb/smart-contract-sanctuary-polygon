...
contract Polytomic {
    ...
    function getCurrentPriceold() public view returns(uint256 price){
        price = (totalHoldings>=1e18)?basePrice.mul(1e18).div(totalHoldings):basePrice;
        return price;
    }

    function getCurrentPrice() public view returns(uint256 price){
        if(totalHoldings<1e18){
           price = basePrice;
        }
        else if(totalHoldings>=1e18 && totalHoldings<10e18){
            price = basePrice*10;
        }
        else if(totalHoldings>=10e18 && totalHoldings<100e18){
            price = basePrice*100;
        }
        else if(totalHoldings>=100e18 && totalHoldings<1000e18){
            price = basePrice*1e3;
        }
        else if(totalHoldings>=1000e18 && totalHoldings<10000e18){
            price = basePrice*1e4;
        }
        else if(totalHoldings>=10000e18 && totalHoldings<100000e18){
            price = basePrice*1e5;
        }
        else if(totalHoldings>=100000e18 && totalHoldings<1000000e18){
            price = basePrice*1e6;
        }
        else if(totalHoldings>=1000000e18 && totalHoldings<10000000e18){
            price = basePrice*1e7;
        }
        else if(totalHoldings>=10000000e18 && totalHoldings<100000000e18){
            price = basePrice*1e8;
        }
        else if(totalHoldings>=100000000e18 && totalHoldings<1000000000e18){
            price = basePrice*1e9;
        }
        return price;
    }
