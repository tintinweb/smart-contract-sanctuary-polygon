...
contract Poching1 is ERC721, ReentrancyGuard, Ownable {
  ...
  uint256 public constant MAX_MULTIMINT = 1001120;
  ...
  function mint(uint256 count) public nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 1001120 at a time");
