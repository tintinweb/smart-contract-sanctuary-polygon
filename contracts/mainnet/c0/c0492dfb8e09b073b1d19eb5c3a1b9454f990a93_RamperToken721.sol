...
// File: contracts/ChatGPT Academy.sol
...
contract RamperToken721 is ERC721Enumerable, IRamperInterface721 {
    ...
    uint256 constant public MAX_TOKENS_PER_TXN = 500;
    uint256 constant public MAX_TOKENS_PER_ADDRESS = 100;
    uint256 public tokenPrice = 10 ether;

    string public baseTokenURI = "ipfs://xssdd/";

    address payable public owner;

    constructor() ERC721("ChatGPT Academy NFT", "CAN") {
    ...
    function setMintPrice(uint256 _price) external {
        require(msg.sender == owner, "Only the contract owner can set the mint price");
        tokenPrice = _price;
    }
