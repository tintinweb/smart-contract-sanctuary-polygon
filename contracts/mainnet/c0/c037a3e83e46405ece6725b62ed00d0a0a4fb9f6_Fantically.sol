...
contract Fantically is ERC721 {
    ...
    function Minting(string memory tokenURI, uint256 fee, address creator, bool lazy_mint, uint256 buy_amount, address payable lazy_creator) public returns (uint256) {
        ...
        if(lazy_mint == true)
        {
            lazy_creator.transfer(buy_amount);
        }
        return newItemId;
    }
