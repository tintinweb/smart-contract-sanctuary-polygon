            ...
            if (sell.feeMethod == FeeMethod.SplitFee) {
                ...
                if (sell.makerRelayerFee == 0 && sell.takerRelayerFee == 0) {
                    if (sell.paymentToken == address(0)) {
                        ...
                        Address.sendValue(payable(_rewardFeeRecipient), feeToExchange);
                    } else {
                ...
                if (sell.makerRelayerFee > 0) {
                    ...
                    if (sell.paymentToken == address(0)) {
                        ...
                        Address.sendValue(payable(sell.minter), makerRelayerFee);
                        Address.sendValue(payable(_rewardFeeRecipient), feeToExchange);
                    } else {
                ...
                if (sell.takerRelayerFee > 0) {
                    ...
                    if (sell.paymentToken == address(0)) {
                        ...
                        Address.sendValue(payable(sell.minter), takerRelayerFee);
                        Address.sendValue(payable(_rewardFeeRecipient), feeToExchange);
                    } else {
                ...
                if (sell.makerProtocolFee > 0) {
                    ...
                    if (sell.paymentToken == address(0)) {
                        ...
                        Address.sendValue(payable(protocolFeeRecipient), makerProtocolFee);
                    } else {
                ...
                if (sell.takerProtocolFee > 0) {
                    ...
                    if (sell.paymentToken == address(0)) {
                        ...
                        Address.sendValue(payable(protocolFeeRecipient), takerProtocolFee);
                    } else {
