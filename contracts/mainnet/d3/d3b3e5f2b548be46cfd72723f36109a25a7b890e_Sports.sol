...
import {ERC20Permit, IERC20Permit} from "@openzeppelin/contracts/token/ERC20/extensions/draft-ERC20Permit.sol";
import {ERC20Burnable} from "@openzeppelin/contracts/token/ERC20/extensions/ERC20Burnable.sol";
import {ERC20Capped} from "@openzeppelin/contracts/token/ERC20/extensions/ERC20Capped.sol";
import {SafeERC20} from "@openzeppelin/contracts/token/ERC20/utils/SafeERC20.sol";
import {ERC20, IERC20, ERC1363} from "@erc1363/contracts/token/ERC1363/ERC1363.sol";
import {AccessControl} from "@openzeppelin/contracts/access/AccessControl.sol";

contract Sports is ERC1363, ERC20Capped, ERC20Burnable, ERC20Permit, AccessControl {
    using SafeERC20 for IERC20;

    /// @notice The maximum amount of tokens that can be mint
    uint256 internal constant _CAP = 68_000_000e18;

    /// @notice The role that can mint new tokens
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    /// @notice Counter of burned tokens
    uint256 private _burnedAmount;

    /// @notice Emitted when any ERC20 tokens will be sweep from this contract
    ...
    /**
     * @notice Returns the maximum cup of tokens, taking into account the burned tokens
     */
    function cap() public view virtual override returns (uint256) {
        return super.cap() - _burnedAmount;
    }

    /**
     * @notice Sweep any ERC20 tokens from this contract
    ...
    /**
     * @notice Updates the burned token counter to decrease the cap
     * @dev See {ERC20 - _burn}
     */
