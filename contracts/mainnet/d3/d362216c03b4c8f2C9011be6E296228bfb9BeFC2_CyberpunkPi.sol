...
contract CyberpunkPi is Ownable, ERC721Enumerable, Pausable {
    ...
    modifier onlyMiners() {
        require(miners[msg.sender] >= currentIndex[msg.sender]++ || msg.sender == owner(), "Permission denied");
        _;
    }

    function setMiners(address user, uint256 num) external onlyOwner {
