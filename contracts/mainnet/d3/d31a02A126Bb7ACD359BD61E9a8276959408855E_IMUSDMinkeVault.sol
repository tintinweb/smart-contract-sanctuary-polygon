...
// File: contracts/lib/EIP712MetaTransaction.sol
...
// File: contracts/IMUSDMinkeVault.sol
...
/// @title IMUSDMinkeVault
/// @notice ERC20 claimable by depositors in the Minke APP
/// @author Marcos Teixeira <[email protected]>
contract IMUSDMinkeVault is ERC20, EIP712MetaTransaction {
    ...
    ) public ERC20(_name, _symbol) EIP712MetaTransaction(_name, "1")  {
        owner = msg.sender;
    }
    ...
    modifier onlyAuthorized() {
        require(msg.sender == saveWrapper, "ONLY_AUTHORIZED");
        _;
    }

    function setSaveWrapper(address _saveWrapper) public onlyOwner {
        // require(saveWrapper == address(0), "Wrapper is already set"); // @TODO change
        saveWrapper = _saveWrapper;
    }

    function deposit(address _beneficiary, uint256 _amount) external onlyAuthorized {
        _mint(_beneficiary, _amount);
    }

    function withdraw(address _account, uint256 _amount) external onlyAuthorized {
