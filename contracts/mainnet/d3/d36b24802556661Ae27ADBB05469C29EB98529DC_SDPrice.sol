...
contract SDPrice is Ownable, IEACAggregatorProxy {
    ...
    function getSqrtTwapX96() public view returns (uint160 sqrtPriceX96, uint256 price) {
        ...
        uint256 a = FullMath.mulDiv(sqrtPriceX96, 1, FixedPoint96.Q96);
        price = FullMath.mulDiv(a, a, 1);
