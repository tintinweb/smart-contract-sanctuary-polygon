...
contract NADAL is NADALDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private NADALTeam;
    address private CharityNADAL;
    ...
    string public override name = "NADAL Fan Token";
    string public override symbol = "NADAL Fan Token";
    ...
    constructor(uint totalSupplyValue, address NADALTeamAddress, address CharityNADALAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        NADALTeam = NADALTeamAddress;
        CharityNADAL = CharityNADALAddress;
        
        // split the tokens according to agreed upon percentages
        balances[NADALTeam] =  totalSupply * 4 / 100;
        balances[CharityNADAL] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's NADALTeam pot
