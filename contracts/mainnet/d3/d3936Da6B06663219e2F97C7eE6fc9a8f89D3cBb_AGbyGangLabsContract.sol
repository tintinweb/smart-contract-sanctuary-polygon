...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0xdb502a93B67356c7c08ba77386f1B89886DD8338];
  address public erc20Payable = 0xdb502a93B67356c7c08ba77386f1B89886DD8338;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 8, 3157) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeicjoopnva7kq2wpwec7zcnkv7hpm672dtd5wfs36zimbizd5wkmiu/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/NESJeC1bbusN0GiL3FH9/contract-metadata";
  }
...
// File: contracts/AGbyGangLabsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AGbyGangLabsContract is ERC721APlus {
    constructor() ERC721APlus("AG by Gang Labs", "AGGL"){}
}
  /*******************************************************/
  /*                                                     */
