 ...
 * @notice This contract handles minting Foodstyling tokens.
 */
contract Foodstyling is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x3B0B85df6bCefa40519d696B43981dc796895bd8;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xccE75B1389c005e33848BFda51eA37A28D4aD451;
    address[] public payoutAddresses = [
        0xccE75B1389c005e33848BFda51eA37A28D4aD451
    ];
    ...
    string public name = "Foodstyling";
    ...
    uint96 public royaltyFee = 25;

    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeidsuqphhltv67dvilnluvi3hzmcvpavczb7p25llqqmzpsqqonjpy/{id}"
        )
        RevokableOperatorFilterer(
