...
// File: contracts/AztTestforGsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract AztTestforGsContract is 
    ERC1155,
    Ownable, 
    Pausable, 
    ERC1155Supply, 
    ...
    Allowlist
{
    ...
    string public name = "AZT Test for GS";
    string public symbol = "GS Test";
    ...
    */
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/hJeqJjv43Pe6CPaAiJDR/contract-metadata";
    }
