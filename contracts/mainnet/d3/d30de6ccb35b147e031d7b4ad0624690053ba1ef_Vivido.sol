...
contract Vivido is ERC721A, ERC721AQueryable, Ownable, ERC2981 {
    uint256 public constant maxSupply = 48;
    string private _baseTokenURI = "https://anandita.fra1.cdn.digitaloceanspaces.com/nft/mint1/";
    bool public collectionMinted;

    constructor() ERC721A("Vivido.fit 2023 - yoga, movement, therapy", "VIVIDO23") {}
    ...
    function mint() external onlyOwner {
        ...
        for (uint256 i = 0; i < maxSupply / 10; i++) {
