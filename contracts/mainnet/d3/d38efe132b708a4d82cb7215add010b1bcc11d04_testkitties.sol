...
// File: contracts/test-polygon.sol
...
// File: contracts/testkitties-polygon.sol

pragma solidity ^0.8.7;

contract testkitties is Ownable, ERC721, NonblockingReceiver {
    address public _owner;
    string private baseURI;
    bool public paused = true;
    uint256 nextTokenId = 0;
    uint256 MAX_MINT_POLYGON = 50;

    uint256 gasForDestinationLzReceive = 350000;

    constructor(string memory baseURI_, address _layerZeroEndpoint)
        ERC721("testkitties", "omnitestkitties")
    {
        _owner = msg.sender;
    ...
    function mint(uint8 numTokens) external payable {
        ...
        require(numTokens < 3, "testkitties: Max 2 NFTs per transaction");
        require(
            nextTokenId + numTokens <= MAX_MINT_POLYGON,
            "testkitties: Mint exceeds supply"
        );
    ...
    function traverseChains(uint16 _chainId, uint256 tokenId) public payable {
        ...
        require(
            ...
            "testkitties: msg.value not enough to cover messageFee. Send gas for message fees"
        );
    ...
    function withdraw(uint256 amt) external onlyOwner {
        ...
        require(sent, "testkitties: Failed to withdraw Ether");
    }
