...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xe20B31E5423efF2CF2F4DB9967B7dF19D9010FF1];
  address public erc20Payable = 0xe20B31E5423efF2CF2F4DB9967B7dF19D9010FF1;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeia4ibxgpqyc4kuofqw7l5hgbs5nt6ok62owqkcq3abzbkkhei7ede/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/hSOvF3j2QEef49y3wKsA/contract-metadata";
  }
...
// File: contracts/Abc123Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Abc123Contract is RamppERC721A {
    constructor() RamppERC721A("abc123", "abc123"){}
}
