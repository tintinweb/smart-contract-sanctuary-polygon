...
contract JCT {
    ...
    IERC20 public usdt = IERC20(0xa960F71F40E4F376a3D9bdD6c9bE48Fe090EC808);
    ...
    uint256 private constant timeStep = 100;
    // uint256 private constant dayPerCycle = 15 days;
    uint256 private constant dayPerCycle = 500;
...
constructor(address _defaultRefer, address _feeReceiver70, address _feeReceiver30) public {
