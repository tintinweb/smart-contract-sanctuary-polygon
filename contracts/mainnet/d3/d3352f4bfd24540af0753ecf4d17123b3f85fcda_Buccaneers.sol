...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                          //
//      bbbbbbb    uu    uu  ccccccc ccccccc  aaaaaaa   nn    nn  eeeeeee  eeeeeee  rrrrrrr   sssssss       //
//      bb    b    uu    uu  cc      cc      aa     aa  nnn   nn  ee       ee       rr    rr  ss            //
//      bbbbbbb    uu    uu  cc      cc      aaaaaaaaa  nn nn nn  eeeee    eeeee    rrrrrrr   sssssss       //
//      bb     b   uu    uu  cc      cc      aa     aa  nn   nnn  ee       ee       rr   rr        ss       //
//      bbbbbbbb   uuuuuuuu  ccccccc ccccccc aa     aa  nn    nn  eeeeeee  eeeeeee  rr    rr  sssssss       //
//                                                                                                          //
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                          //
//                                                                                                          //
// //////////////////////////////  \Tired of all these jpegs things?/  ///////////////////////////////////////
// /////////////////////////////////          -Buy a GIF!-         ///////////////////////////////////////////
//                                                                                                          //
//                                                                                                          //
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
contract Buccaneers is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  // Lists 
  uint256[10000] public remainingIds;
  mapping(uint256 => uint256) public lastDividendAt;
  mapping(uint256 => address) public minters;

  // Whitelisted adresses balance
...
// The bonding curve, to enable early adopters to buy cheap, and raising funds for next steps

  function calculatePrice() public view returns (uint256 _cost) {
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    require(_mintAmount > 0, "Mint at least one NFT");
    require(_supply + _mintAmount <= maxSupply, "Max supply exceeded!");
    require(ownerTokenCount + _mintAmount <= maxMintAmountPerWallet, "Max NFT per address exceeded!");
    if (msg.sender != owner()) {
        if(onlyWhitelisted == true) {
            require(isWhitelisted(msg.sender), "User is not whitelisted");
            require(ownerTokenCount  + _mintAmount  <= nftPerAddressLimit, "Max NFT for presale exceeded!");
        }
    
    require(msg.value >= calculatePrice() * _mintAmount, "Not enough funds");
    }
    //Mint
 ...
 // Give a random NFT to a contest winner
  function randomGiveaway(address _winner, uint256 _amount) external onlyOwner {
    // Checks
    require(_winner != address(0), "Polybuccaneers: zero address");
    require(_amount > 0, "You have to mint at least one");
    require(lastSupply != 0,  "The collection is sold out");
  ...
  function tokenURI(uint256 _id) public view virtual override returns (string memory){
    require(_exists(_id),"PolyBuccaneers: URI query for nonexistent token");
...
//only owner
 ...
 // Max NFT amount mint for presalers, public sale and whitelist
...
// For return on investment, marketing, charity payouts and future development
