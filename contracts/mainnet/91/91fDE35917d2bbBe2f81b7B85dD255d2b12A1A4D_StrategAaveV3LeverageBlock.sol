 ...
 */
contract StrategAaveV3LeverageBlock is IStrategStrategyBlock, IStrategOracleBlock {
    using SafeERC20 for IERC20;
    ...
    function blockParameters() external pure returns (BlockParameters memory blockParams) {
        return blockParams;
    }
