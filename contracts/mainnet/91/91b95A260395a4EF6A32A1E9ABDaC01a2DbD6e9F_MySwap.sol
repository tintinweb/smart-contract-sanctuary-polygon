...
contract MySwap {
    ...
    /// @dev The calling address must approve this contract to spend atleast `amountIn` worth of its DAI for this function to succeed.
        ...
        returns (uint256 amountOut)
    {
        ...
        WMATIC(WETH9).deposit{value: msg.value}();
