...
contract XVMCgovernor {
    ...
    address public immutable token = 0x84F71F85202E84d27b42199a2cE8d65CeF1EA189; //XVMC token
    
    //masterchef address
    address public immutable masterchef = 0x45486f260709327a82ec0a945f33Ff85607E04e2;
    address public immutable oldChefOwner = 0xBC9fB5Bead50D3610664224e53f33cF1C121D529;
    ...
    address public immutable consensusContract = 0x83787475D4c89Bc0F34c986a55891df5C141a3DE;
    address public immutable farmContract = 0x5B0C008b9a552D4010C00766edC3A76f7F3B9BaF;
    address public immutable fibonacceningContract = 0x8418526b36ba5a552bFEb0Aec33ad9602C8D4391; //reward boost contract
    address public immutable basicContract = 0x3ff253cbA47dC019FF7FB1c1A936e8A854c6b27B;
	
	address public immutable nftStakingContract = 0x4a22909B5092fDec4ca7090321bE5869d2a3Be06;
	address public immutable nftAllocationContract = 0x958A43f7AA2134Ca8aEadee46dc481aaEd912E15;
    
    //Addresses for treasuryWallet and NFT wallet
    address public treasuryWallet = 0xB7A4aDd095369D10E08df51c1E5641aeA8c645Ef;
    address public nftWallet = 0xC79F74b1E9BFf3B8480Ed138A152050A69471559;
    
    //addresses for time-locked deposits(autocompounding pools)
    address public immutable acPool1 = 0x2f382391871Db57C85AD727a6f6Fa5bD9750a4a0;
    address public immutable acPool2 = 0x3649ded34Dbc14c1C1Ddfc937fA5F261B001EA38;
    address public immutable acPool3 = 0xde51C6619cD866B28C3360B13aCb9A3001dA02A7;
    address public immutable acPool4 = 0x5BF686107897cf37D8470500173D2760c85Ac109;
    address public immutable acPool5 = 0xa885428085CbEE295bBCe1ee0A89482482779541;
    address public immutable acPool6 = 0x198ee241416F257412f40d63A04Ab2ff30Aa9e94;
    ...
    */
	...
	// but just in case, creating a grace period of roughly 3 days to make changes/improvements
	...
	function wGracePeriod(address _new) external {
		...
		require(block.timestamp < 1654725599, "grace period expired");
