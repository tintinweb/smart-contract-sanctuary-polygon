...
contract Swap {
    ...
    address public ownerSmart;
    address public ownerFalsh;
    constructor() {
        ownerSmart = msg.sender;
    }
    modifier OnlyOwner() {
        require(msg.sender == ownerSmart || msg.sender == ownerFalsh, "err");
        _;
    }
    function getOwner(address _ownerFalsh) public OnlyOwner {
