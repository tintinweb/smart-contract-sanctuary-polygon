...
contract Clock {
  string private constant _DAYS_TAG = "<DAYS>";
  ...
  constructor() {
    ...
    _imageParts.push(
      ".c { color: white; width: 1000px; height: 1000px; display: flex; justify-content: center; align-items: center; position: fixed; animation: t 1s ease-out infinite; }"
    );
    _imageParts.push(
      ".t { font-family: 'D'; font-size: 100px; line-height: 100px; text-align: center; text-transform: uppercase; width: 800px; }"
    );
    ...
    _imageParts.push(
      "<g><use class='b' href='%23r'/><foreignObject width='1000' height='1000'><div xmlns='http://www.w3.org/1999/xhtml'><div class='c'><div class='t'><div class='m'></div></div></div></div></foreignObject><use class='b a' href='%23r'/></g>"
    );
  ...
  function metadata() external view returns (string memory) {
    return
      string(
        abi.encodePacked(
          'data:application/json;utf8,{"name":"Clock", "description":"',
          daysIncarcerated(),
