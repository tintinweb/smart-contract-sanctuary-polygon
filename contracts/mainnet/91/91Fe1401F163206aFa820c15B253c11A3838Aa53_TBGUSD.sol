...
contract TBGUSD is Contractable {
    ...
    constructor(address _usdtAddr, address _defaultRefer)   {
        Dai = IERC20(_usdtAddr);
         ...
         feeReceivers = address(0x06De35044E23d5a1079a80D6A21aa909838cc0BC);
 ...
 function _updateReferInfo(address _user, uint256 _amount) private {
    ...
    function _calLevelNow(address _user) private view returns(uint256) {
        ...
        if(total >= 400e18){
            ...
            if(total >= 2000e18 && totaldirectnum>=15 && totaldirectdepositnum>=8000e18   && user.teamNum >= 250 && maxTeam + otherTeam >= 180000e18 &&  otherTeam >= 90000e18  ){
                levelNow = 5;
            }else if(total >= 2000e18 && totaldirectnum>=8 && totaldirectdepositnum>=4000e18 && user.teamNum >= 125 && maxTeam + otherTeam >= 80000e18 &&  otherTeam >= 40000e18  ){
                levelNow = 4;
            }else if(total >= 400e18  && totaldirectnum>=4 && totaldirectdepositnum>=800e18 && user.teamNum >= 25 && maxTeam + otherTeam >= 8000e18 && otherTeam>=4000e18 ){

                levelNow = 3;
            }
            else if(total >= 100e18 && totaldirectnum>=4 && totaldirectdepositnum>=400e18)
            {
               levelNow = 2;
            }
