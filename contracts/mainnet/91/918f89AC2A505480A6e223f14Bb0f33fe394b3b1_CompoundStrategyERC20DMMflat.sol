...
contract CompoundStrategyERC20DMMflat is rStrategy {
        ...
        onlyRole(MANAGER_ROLE)
    {
        ...
        uint[] memory amounts;
        uint256[2] memory _vReserveRatioBounds; // DMM virtual Reserves for add liquidity
...

        {
            ...
            _vReserveRatioBounds[0] = 0;
            _vReserveRatioBounds[1] = 0;
