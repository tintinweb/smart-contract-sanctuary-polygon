...
contract Treasury is ContractGuard {
    ...
    uint256 public updatedTimes;
    uint256 public epoch = 0;
    uint256 public pegUpdateDelay = 120;
    uint256 public pegUpdateDelayEpoch = 60;
    ...
    function initialize(
        ...
        lastUpdated = _startTime;
        updatedTimes = 0;


        kittyPriceOne = 1**18; // This is to allow a PEG of 1 KITTY per AVAX
    ...
    function updateProgressivePeg() public {
        require(block.timestamp - lastUpdated > pegUpdateDelay + pegUpdateDelayEpoch*updatedTimes,"too early for updating");
        kittyPriceOne = kittyPriceOne + 10**17;
        kittyPriceCeiling = kittyPriceOne.mul(101).div(100);
        lastUpdated = lastUpdated + pegUpdateDelay + pegUpdateDelayEpoch*updatedTimes;
