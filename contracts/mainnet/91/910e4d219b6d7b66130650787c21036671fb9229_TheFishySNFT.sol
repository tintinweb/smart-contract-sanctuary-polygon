...
// File: contract-3b4ba58db0_flat.sol
...
contract TheFishySNFT is ERC721, ERC721Enumerable, Pausable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("TheFishySNFT", "TFC") {}

    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://QmP4tJehzJ9qEbaXRiyigAHkisMdUSD2MnN15veTypxHLh/";
    }
