...
abstract contract OwnableUpgradeable is Initializable, ERC2771ContextUpgradeable {
    ...
    /**
     * @dev update trust forwarder
     * @param tForwarder - new trust forwarder
     */
    function updateTrustForwarder(address tForwarder) external onlyOwner {
        _updateTrustedForwarder(tForwarder);
    }
