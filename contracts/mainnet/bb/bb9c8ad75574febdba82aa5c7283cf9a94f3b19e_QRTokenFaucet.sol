...
contract QRTokenFaucet {
    ...
    function distributeTokens() public {
        require(recipients[msg.sender] == false, "You have already claimed your tokens.");
        require(block.number - lastDistributedBlock >= 50, "You can only claim tokens once every 50 blocks.");
