...
contract Givellet is IGivellet, Ownable, ReentrancyGuard {
     ...
     * @param doNotConvert - true if msg.sender: wants to recive any token; if true :_desiredTokenAddress: is irrelevant
	 */
    struct Organisation {
        address recipient;
...
/// @title Interface for Givellet
interface IGivellet {
    /**
	 * @notice Sets the address of the BizzSwap Contract
	 *
	 * @notice Only Administrator multisig can call
	 *
	 * @param _contractAddress - the address of the BizzSwap Contract
	 *
    ...
    /**
	 * @notice Sets the address of the Wrapped Native
	 *
	 * @notice Only Administrator multisig can call
	 *
	 * @param _weth- the address of the Wrapped Native Contract
	 *
	 * No return, reverts on error
	 */
    ...
    /**
	 * @notice Creates new organisation
	 *
	 * @param _desiredTokenAddress - address of the desired token
	 * @param _isEthDesired - true if msg.sender: wants to receive native coin, false otherwise; if true, :_desiredTokenAddress: is irrelevant
     * @param _doNotConvert - true if msg.sender: wants to recive any token; if true :_desiredTokenAddress: is irrelevant
	 *
	 * @return organisationId - id of the newly created organisation
	 */
    function createOrganisation(
        address _desiredTokenAddress,
        bool _isEthDesired,
    ...
    /** 
	 * @notice Donates to the requested organisation
	 *
	 * @param _params - parameters necessary for the swap
     * @param organisationId - id of the organisation that the user wants to donate to
     ...
     * @param _emailAddress - email address of the user who donated
	 *
	 * No return, reverts on error
	 */
    function donate(
    ...
    /**
	 * @notice Changes desired token of the organisation
	 *
	 * @notice Only the creator of the organisation can call this function
     *
