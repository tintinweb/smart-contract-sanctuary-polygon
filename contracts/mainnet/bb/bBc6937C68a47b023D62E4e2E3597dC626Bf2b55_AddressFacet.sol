...
contract AddressFacet is BFacetOwner {
    ...
    function setFeeCollector(address _feeCollecor) external onlyOwner {
        _feeCollecor.setFeeCollector();
    }
    ...
    function getFeeCollector() external view returns (address feeCollector) {
        feeCollector = LibAddress.getFeeCollector();
    }
}
...
library LibAddress {
    ...
    function setFeeCollector(address _feeCollector) internal {
        LibAddress.addressStorage().feeCollector = _feeCollector;
    }
    ...
    function getFeeCollector() internal view returns (address) {
        return addressStorage().feeCollector;
    }
