...
// File: contracts/SigmaSquaredGovernor.sol

pragma solidity ^0.8.4;
/**
 * This is the governor for the Sigma Squared DAO.  This contract was created using the OpenZeppelin wizard.
 */
contract SigmaSquaredGovernor is Governor, GovernorSettings, GovernorCountingSimple, GovernorVotes, GovernorVotesQuorumFraction, GovernorTimelockControl {
    constructor(IVotes _token, TimelockController _timelock, uint256 votingPeriodBlocks)
        Governor("SigmaSquaredGovernor")
        GovernorSettings(1 /* 1 block */, votingPeriodBlocks, 0)
