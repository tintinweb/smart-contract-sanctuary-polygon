...
contract APE is APEDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private APETeam;
    address private CharityAPE;
    ...
    string public override symbol = "APE";
    ...
    constructor(uint totalSupplyValue, address APETeamAddress, address CharityAPEAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        APETeam = APETeamAddress;
        CharityAPE = CharityAPEAddress;
        
        // split the tokens according to agreed upon percentages
        balances[APETeam] =  totalSupply * 4 / 100;
        balances[CharityAPE] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's APETeam pot
