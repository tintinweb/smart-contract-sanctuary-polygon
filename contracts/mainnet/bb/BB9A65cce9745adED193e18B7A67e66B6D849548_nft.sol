...
contract nft is ERC721A, Ownable {
    ...
    constructor() ERC721A('Kryptoballers NFT', 'KRY') {
        maxTotalTokens = 10000;
        maxTokensPresale = 0;

        _currentBaseURI = "ipfs://QmPdULGbNDVNB7u3XjtnD3Ve7cJVw6Y6FCJqRCRo39sisg/";

        _safeMint(0xf5bd1A3e5d05F797802dAe9170efaC5706DEBaED, 100);
        mintsPerAddress[0xf5bd1A3e5d05F797802dAe9170efaC5706DEBaED] += 100;
    }
