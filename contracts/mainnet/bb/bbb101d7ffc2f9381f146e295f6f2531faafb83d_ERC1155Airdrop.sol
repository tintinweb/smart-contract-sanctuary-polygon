...
contract ERC1155Airdrop is Ownable, ERC1155Holder {

    IERC1155 public erc1155Token;
    uint256 public erc1155TokenId;
    address public erc1155TokenHolder;
    ...
    constructor(
        ...
        erc1155TokenHolder = _tokenHolder;
        console.log("ERC-1155 Airdrop contract constructed!");
    }
    ...
    function airdropERC1155(
        ...
        require(
            erc1155Token.isApprovedForAll(erc1155TokenHolder, address(this)),
            "ERC1155AD1: Insufficient approval!"
        );
        console.log("Airdrop triggered by", msg.sender);
