...
contract StrategyBalancerMultiRewardGauge is StratManager, FeeManager {
    ...
    constructor(
        ...
        inputSwapPoolId = _inputSwapPoolId;
    ...
    function chargeFees(address callFeeRecipient) internal {
        ...
        uint256 sphereFeeAmount = nativeBal.mul(sphereFee).div(MAX_FEE);
        IERC20(native).safeTransfer(sphereFeeRecipient, sphereFeeAmount);
