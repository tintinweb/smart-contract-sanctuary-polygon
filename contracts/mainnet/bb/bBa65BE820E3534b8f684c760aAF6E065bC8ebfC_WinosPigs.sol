...
contract WinosPigs is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Winos Pigs", "WP") {
    setHiddenMetadataUri("ipfs://QmXiR3nBWMEkgDwEfVGiXPL6Xkuxk8VMAWtFYibgHh7Hwh/hidden.json");
  }
