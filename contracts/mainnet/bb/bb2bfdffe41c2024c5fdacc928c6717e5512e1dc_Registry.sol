...
// File: contracts/Gassless_NFT.sol
...
contract Registry is ERC2771Context, ERC721URIStorage, Ownable {  
  event Registered(address indexed who, string name);
  event mintedToken(address indexed who, uint256 tokenId, string uri);
...
//NFT code
  ...
  constructor(MinimalForwarder forwarder,
            string memory _name,
            string memory _symbol)// Initialize trusted forwarder
    ERC721(_name, _symbol)
    ERC2771Context(address(forwarder)) {
        // 0x95Df469c0a286531f5eeC1ac0211eEaeF644FeC1 hqnfts.eth
  ...
  function mintByToken(address to, uint256 tokenId, string memory uri)
        public
    {
        _safeMint(to, tokenId);
        _setTokenURI(tokenId, uri);
        emit mintedToken(to, tokenId, uri);
    }
