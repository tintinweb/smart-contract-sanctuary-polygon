...
contract WeeniePalz is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function mint() public payable {
    ...
    if(supply + 1 == maxSupply){
      ...
      giftValue = address(this).balance * 50 / 100;
    }

    _safeMint(msg.sender, supply + 1);

    if(supply > 0) {
      (bool sucess, ) = payable(giftAddress).call{value: giftValue}("");
      require(sucess, "Could Not Send Value!");
    }
  }
  ...
  function withdraw() public payable onlyOwner {
    ...
    (bool d, ) = payable(0xe0906D67b9bF867FFEF1C4702d8774c4eE4Af45a).call{value: address(this).balance * 10 / 100}("");
    require(d);
    (bool b, ) = payable(0x943590A42C27D08e3744202c4Ae5eD55c2dE240D).call{value: address(this).balance * 5 / 100}("");
    require(b);
