...
contract CyberDiamond is ERC721Enumerable, Ownable {
    ...
    uint256 public specialPRICE =500 ether;

    // Pre-sale
    bool public presale = true;
    uint256 public PRE_PRICE =80 ether ;
    uint256 public specialPRE_PRICE =480 ether ;
    mapping (address => uint256) public preMinted;
    mapping (address => uint256) public preMintedSpecial;
    ...
    function mintNFTSpecial(uint256 _count) public payable {
        ...
        preMintedSpecial[msg.sender] += _count;
        require(preMintedSpecial[msg.sender] <= 2, "Address can't mint more NFTs in pre-sale.");
    ...
    function mintNFTs(uint256 _count) public payable {
        ...
        require(preMinted[msg.sender] <= 10, "Address can't mint more NFTs in pre-sale.");
        for (uint256 i = 0; i < _count; i++) {
            _mintSingleNFT();
        }
    }
