...
contract DVT is IERC20, Ownable {
    enum TAX_TYPE {
    ...
    string private constant _name = "DEXIVOTINGTOKEN";
    string private constant _symbol = "DVT";
    uint256 private constant max_supply = 300 * 1e6 * 10**uint256(_decimals);
    uint256 private constant POINTS_DIVISOR = 10000;
    uint256 public constant ANNUAL_MINTABLE_POINTS = 1000; // 10%
    uint256 private constant initialSupply = 100 * 1e6 * 10**uint256(_decimals);
