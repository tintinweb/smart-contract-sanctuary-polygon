    ...
    ReentrancyGuardUpgradeable
{
    ...
    function sellPropertyWithPermit(
        ...
        _require(tryB != _swapArgs.to, Errors.SAME_TOKENS);
        address tokensWhitelist = 0x8deCB9d6950e4b4bA9c697591AEdBe03b2d1D165;
        _require(
    ...
    function swapOnDfx(
        ...
        swappedAmount = _dfxSwapHelper(_swapArgs);
    ...
    function _dfxSwapHelper(
        ...
        address DFX_ROUTER = IFinder(finder).getDFXAddress();
        swappedAmount = IDFXRouter(DFX_ROUTER).originSwap(
    ...
    function buyProperty(
        ...
        emit PropertyBought(_swapArgs, _inputAmount, _isFeeInXeq);
    }
    ...
    function getPropertyPriceWithFees(
        ...
        console.log(_property.price, "_property.price in OCLR");
        ...
        if (isBuyProperty) {
            ...
            console.log(priceWithFees, "priceWithFees");
        } else {
            feePercentage =
