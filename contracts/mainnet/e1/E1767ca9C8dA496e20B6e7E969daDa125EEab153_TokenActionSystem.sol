...
uint256 constant ID = uint256(keccak256("game.piratenation.tokenactionsystem"));

/**
 * System that registers and tracks actions performable by tokens
 */
interface ITokenActionSystem {
