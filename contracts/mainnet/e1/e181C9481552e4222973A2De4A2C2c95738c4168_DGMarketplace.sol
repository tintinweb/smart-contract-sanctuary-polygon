...
*/
            ...
            require(acceptedToken.transfer(order.beneficiary,order.price - ( order.price  * fee) / BASE_FEE),"DGMarketplace#PaperCallBack: TRANSFER_PRICE_FAILED");
            require(acceptedToken.transfer(feeOwner, ( order.price  * fee) / BASE_FEE),"DGMarketplace#PaperCallBack: TRANSFER_FEES_FAILED");
