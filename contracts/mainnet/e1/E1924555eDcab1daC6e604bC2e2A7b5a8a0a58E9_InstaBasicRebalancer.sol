...
contract Rebalancer is InstaFlashReceiver {
    ...
    function basicRebalancer(
        ...
        // instadata - for the route 8 of FLA.
        // calldata - to use after taking the flashloan.
        ...
        this.flashBorrow(_tokens, _amount, route, callData, _instadata);
    }
}
...
contract InstaBasicRebalancer is Rebalancer {
    ...
    string public name = "InstaBasicRebalancer-v1.1";
}
...
contract InstaFlashReceiver {
    ...
    function flashBorrow(
        ...
        flashloan.flashLoan(_tokens, _amts, _route, _data, _instaData);
    }
