...
contract BunnyGirlsAirdrop is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("BunnyGirlsAirdrop2", "BunAir2") {
    setHiddenMetadataUri("ipfs://Qmcj7cB9B3ERt4Pa2LbFCEESzqxpPSs88YWDdH9dKYn6ej/hidden.json");
  ...
  function mint(uint256 _mintAmount) public onlyOwner payable mintCompliance(_mintAmount) {
