...
contract AnimalHero is Ownable, ERC721A, ReentrancyGuard {
    constructor(
    ) ERC721A("animal hero", "ANH", 8, 1500) {}
    ...
    // allowList mint
    uint256 public allowListMintPrice = 0.000200 ether;
    // default false
    bool public allowListStatus = false;
    uint256 public amountForAllowList = 50;
    ...
    uint256 public publicPrice = 0.005000 ether;
    uint256 public amountForPublicSale = 1450;
