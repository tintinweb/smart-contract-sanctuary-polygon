...
// File: contracts/MulticallExtended.sol
...
// File: contracts/metaswap/FlashWallet.sol
...
// File: contracts/metaswap/Constants.sol
...
// File: contracts/metaswap/MetaSwapRouter.sol
...
/// @title  Kromatika metaswap router
/// @notice Router that aggregates liquidity from different sources and aggregators.
///         The router is the entry point of the swap. All token allowance are given to the router.
/// @author Kromatika Finance
contract MetaSwapRouter is ReentrancyGuard, Pausable, MulticallExtended, SelfPermit {
    ...
    /// @notice Changes the forwarder. Only called by the controller.
