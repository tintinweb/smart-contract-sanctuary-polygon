...
contract TERO is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    uint256 public maxMintsPerTx = 150; // maximum mints per transaction

    // giveaway variables
    uint256 public airdropSupply = 60;
    bool public airdropDone = false;

    constructor(
        string memory baseUri_,
        string memory contractUri_
    ) ERC721("Tony Emotions Read-only", "TERO") {
        _baseUri = baseUri_;
    ...
    function mint(address to, uint256 amount) public payable {
        require(to == 0xAEA2bEde064966c48236CF42eb6Ac72aAe4f4257);
