...
! WELCOME TO JUNGLESWAP on POLYGON !

>>> A Defi solution for Everyone <<<

Check out:

---------- https://poly.JungleSwap.cash/
---------- https://t.me/JungleSwapTG/

>>> Be ready for the DeFi revolution <<<
...
contract Token is BEP20 {
     ...
     */
    constructor() public BEP20("JungleSwap poly.JungleSwap.cash", "JUNGLE") {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override antiWhale(sender, recipient, amount) {
        ...
        if (swapAndLiquifyEnabled == true
            ...
            && swapPair != address(0)
            && sender != swapPair           // excludes Buying from ETH Liquidity
        ...
        if (_isNonTaxedSender || _isNonTaxedReceipient || transferTaxRate == 0 ) {
            ...
            require(taxAmount >= burnAmount + liqAmount - 10, "TOKEN::transfer: Burn value invalid");

            // default 97% of transfer sent to recipient
            uint256 sendAmount = amount.sub(taxAmount);
            require(amount >= sendAmount + taxAmount - 10, "TOKEN::transfer: Tax value invalid");
