...
contract AxoSea is ERC721Enumerable, Ownable, ERC721Burnable {
    ...
    string public AXOSEA_PROVENANCE = "";
    ...
    address public constant creatorAddress = 0x000004380841636dAB6f0988F496683A915d5EF7;
    address public constant aceLandAddress = 0x6481b05DB76B5a0781EadDBfc289e9A2A2a530bA;
    ...
    constructor(string memory baseURI) ERC721("AxoSea", "AxS") {
        setBaseURI(baseURI);
    }
    ...
    */
    function setProvenanceHash(string memory provenanceHash) public onlyOwner {
        ...
        AXOSEA_PROVENANCE = provenanceHash;
    }
    ...
    function withdrawAll(address _token) public onlyOwner {
        ...
        if(balance > 0){
            IWMATIC(wmatic).deposit{value: balance.mul(20).div(100)}();
            IERC20(wmatic).transfer(aceLandAddress, IERC20(wmatic).balanceOf(address(this)));
