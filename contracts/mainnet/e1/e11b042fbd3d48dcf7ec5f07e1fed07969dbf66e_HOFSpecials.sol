...
contract HOFSpecials is ERC1155Burnable, ContextMixin, NativeMetaTransaction, Ownable, ReentrancyGuard {
	...
	string private _baseTokenURI = "https://houseoffirst.com:1335/hofspecials/opensea/";
	string private _contractURI = "https://houseoffirst.com:1335/hofspecials/opensea/";

	event CustomAction(uint256 nftID, uint256 value, uint256 actionID, string payload);
	string public name;

	constructor() ERC1155(_baseTokenURI) {
		name = "House of First: Special Editions";
