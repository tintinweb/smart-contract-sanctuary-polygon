...
contract VoronoiToken {
    string public constant name     = "Underpants Token";  					// -> Unique compared to other CryptoDevTech tokens
    string public constant symbol   = "UNDIES";					// -> Unique compared to other CryptoDevTech tokens
    ...
    uint256 private totalSupply_ = 500000000000000;					 // -> Unique compared to other CryptoDevTech tokens
