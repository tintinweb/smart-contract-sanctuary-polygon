...
contract StrategyStargateUniV3 is StrategyStargateInitializable {
    ...
    function initialize(
        ...
        address[] memory outputToDepositRoute = UniswapV3Utils.pathToRoute(_outputToNativePath);
...
library UniswapV3Utils {
    ...
    function quote(
        ...
        return IQuoter(_quoter).quoteExactInput(_path, _amountIn);
    }
}
...
contract StrategyStargateInitializable is StratFeeManagerInitializable {
    ...
    function _getAmountOut(uint256) internal virtual returns (uint256) {}
}
