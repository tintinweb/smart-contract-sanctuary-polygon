...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1653423840;
...
// File: contracts/MyNftRamppProject11Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MyNftRamppProject11Contract is RamppERC721A {
    constructor() RamppERC721A("My NFT Rampp Project11", "RAMPP11"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/LcW5SpbsILGTXll5Kl2z/contract-metadata";
    }
}
