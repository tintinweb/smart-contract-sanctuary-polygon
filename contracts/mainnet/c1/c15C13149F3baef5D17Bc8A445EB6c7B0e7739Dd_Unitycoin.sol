...
contract Unitycoin is ERC20, Ownable {
  ...
  uint256 public constant TOKEN_PRICE_INCREASING_MONTHLY_PERCENT = 6;
  uint256 public constant TOKEN_PRICE_INCREASING_PERIOD = 30 days;

  uint256 public BUY_TOKENS_MARKUP_PERCENT = 10;
  uint256 public REINVEST_TOKENS_MARKUP_PERCENT = 5;
  uint256 public SELL_TOKENS_DISCOUNT_PERCENT = 10;

  uint256[6] public REFERRAL_PERCENTS = [4, 2, 1, 1, 1, 1]; 
  ...
  address payable public constant DEFAULT_REFERRER = payable(0xa35868Aba36A9f3d852B9898BBaA321E4E710b5F);
  address payable public constant INITIAL_LIQUIDITY = payable(0xc30f15f84bd9b5347E1412438AeCD82B22a4d98E);
  ...
  constructor() ERC20("Unitycoin Community Token", "UNITY") {
  ...
  function trade(address to) external payable {
