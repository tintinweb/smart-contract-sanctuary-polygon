...
contract Mid is Royalty, AccessControl, BaseRegistrarImplementation, Pausable, TokenURISetting, Initializable {
    ...
    constructor(
        ...
        IERC20 usdt_) BaseRegistrarImplementation("MetaID", "MID", nns_) Royalty(erc20TransferHelper_, micTreasury_, midLandTreasury_, alchemistTreasury_) {
    ...
    function mintMid(string memory name) nonReentrant external {
        ...
        require(_usdt.allowance(_msgSender(), address(this)) >= currentPrice(), "Not enough approve tokens");
        ...
        _usdt.safeTransferFrom(msg.sender, _fundTreasury, currentPrice());
