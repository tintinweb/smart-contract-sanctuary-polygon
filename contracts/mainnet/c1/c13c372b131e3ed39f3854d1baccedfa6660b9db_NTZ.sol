...
contract NTZ is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 10 * 10**8 * (10**10);

    uint16 private totalBuyFee;
    uint16 private totalSellFee;

    address public _teamWalletAddress = address(0x6E2E6EA3c4e57ac24BEA5636D9cd47DACc87ef46); // Team Wallet
    address public _projectWalletAddress = address(0x6E2E6EA3c4e57ac24BEA5636D9cd47DACc87ef46); //Project Wallet
    ...
    constructor() ERC20("Netizen coin", "NTZ") {

    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff); // PCS V2 ROUTER
        ...
        buyFee.projectFee = 20; // 2% Project fee
    ...
    function updateUniswapV2Router(address newAddress) external onlyOwner {
        require(newAddress != address(uniswapV2Router), "NTZ: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "NTZ: The QuickSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "NTZ: Automated market maker pair is already set to that value");
