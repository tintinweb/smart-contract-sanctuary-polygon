...
contract StrategyPenrose_USDC_MAI is Strategy0xDAOMaximizer {

    address usdc_mai_diff;

    function initializeStrategy(
        address _store,
        address _vault
    ) public initializer {
        address usdc_mai_lp = address(0x5A31F830225936CA28547Ec3018188af44F21467);
        ...
        __Strategy_init(
            ...
            _vault,
            rewards,
            0x84BC319faFcD369a6C855d846dc0757544d23F0E,
            false,
