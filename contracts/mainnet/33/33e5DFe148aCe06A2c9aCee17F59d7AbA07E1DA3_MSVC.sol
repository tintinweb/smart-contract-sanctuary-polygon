...
contract MSVC is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ReentrancyGuard {
    ...
    ERC20("Mumbai.SVC", "MSVC") {    
        teamAddress = _teamAddress;
        _mint(teamAddress, 100000000 * 10** decimals());
    ...
    function withdrawMSVC() external onlyOwner {
