...
// File: contracts/orionConnect721.sol
...
contract OrionConnectNFTs is ERC721, ERC721URIStorage, Pausable, Ownable {
    using Counters for Counters.Counter;
    uint256 public constant MAX_SUPPLY = 1000000000;
    uint256 private _totalSupply;
    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("OrionConnectToken", "OCT") {}
...
function pause() public onlyOwner {
    ...
    function generateTokenId() internal view returns (uint256) {
        uint256 tokenId = uint256(keccak256(abi.encodePacked(
            ...
            _tokenIdCounter.current() // token counter
        )));
        return tokenId;
    }
    /**
     * @notice Orion Connect's free minting function
     * @param to The address to transfer to
     * @param uri The nft uri info
     */
    function mintOrionConnectNFT(address to, string memory uri) public onlyOwner {
