...
contract Timelock is ITimelock {
    ...
    function setTokenManager(address _manager) external onlyTokenManager {
        tokenManager = _manager; 
    }

    function setMintReceiver(address _receiver) external onlyTokenManager {
        mintReceiver = _receiver; 
    }

    function setGlpManager(address _glpManager) external onlyTokenManager {
        glpManager = _glpManager; 
    }
