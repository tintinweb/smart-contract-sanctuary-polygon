...
contract PlusConnect is Context, ERC165, Ownable, IERC721Metadata {
    ...
    uint public constant MAX_TOKENS_SUPPLY = 5000;

    string private constant NAME = 'plusconnect';

    string private constant SYMBOL = 'PLC';

    string private _baseURI;

    bool public _isTransferLocked = true;
    ...
    */
    ...
    /**
     * @dev Function mints one PlusConnect NFT and sends to the address
     *
     * @param to address of NFT reciever.
    */
    function mintToAddress(address to) external onlyOwner {
        require(totalSupply() < MAX_TOKENS_SUPPLY, "Token limit exceeded");
    ...
    */
    function _isApprovedOrOwner(address spender, uint tokenIndex) internal view returns (bool) {
        ...
        return (spender == tokenOwner || getApproved(tokenIndex) == spender || isApprovedForAll(tokenOwner, spender));
    }
    ...
    */
    function _transfer(address from, address to, uint tokenIndex) internal virtual {
        ...
        require(!_isTransferLocked, "Cannot transfer - transfer is currently locked");
