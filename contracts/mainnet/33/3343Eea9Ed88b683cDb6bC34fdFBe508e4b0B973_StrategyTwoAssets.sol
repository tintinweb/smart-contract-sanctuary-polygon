...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
    ...
    address public constant gohm = 0xd8cA34fd379d9ca3C6Ee3b3905678320F5b45195;
    address public constant eth = 0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619;
    
    // LP tokens
    address public constant token1 = 0xd8cA34fd379d9ca3C6Ee3b3905678320F5b45195;
        ...
        )
    {
        ...
        gohm_matic_path = new address[](3);
        gohm_matic_path[0] = gohm;
        gohm_matic_path[1] = eth;
        gohm_matic_path[2] = matic;
        ...
        matic_token2_path = new address[](2);
        matic_token2_path[0] = matic;
        matic_token2_path[1] = token2;
    }
    ...
    function set_harvestCutoffgOHM(uint256 newCutoff) external onlyOwner() {
        harvestCutoffgOHM = newCutoff;
    }
    ...
    function harvest() public override {
        ...
        //Swap gohm for matic
        uint256 _gohmBalance = IERC20(gohm).balanceOf(address(this));
        if (_gohmBalance > harvestCutoffgOHM){
            _swapUniswapWithPath(gohm_matic_path, _gohmBalance);
        }
...
contract StrategyTwoAssets is StrategyFarmTwoAssets {
    ...
    address public LP_Token = 0x1549E0E8127D380080aab448b82d280433CE4030;
