...
contract NFT is ERC721, Ownable {
    ...
    constructor() ERC721("PolygonMFERS", "POLYMFER") {
        baseUri = "ipfs://bafybeibkg43q4emayp6ew3mtvozpyxvmc64jp6ewm74msq6iy4valmsup4/";
...
function mint(uint256 _numTokens) external payable {
        ...
        require(_numTokens <= MAX_MINT_PER_TX, "Only 5 per txn");
        require(mintedPerWallet[msg.sender] + _numTokens <= 20, "You can only mint 20 nft.");
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0xd20DFde5cf547a44C904A1ae883fF8D4bA602040).call{value: balanceOne}("");
