...
contract LuxyLaunchpadFeeManager is OwnableUpgradeable {
    ...
    function mint(MCNNFT drop, uint256 amount) external payable {
    ...
    Pauser
{
    ...
    uint256 public constant LUXY_SALE_EXPIRE_TIME = 0;

    //Uncomment this section to enable whitelist
    uint256 public constant WHITELIST_EXPIRE_TIME = 0;
    ...
    function __MCNNFT_init_unchained(
        string memory baseURI_,
        address artist_,
        IERC20Upgradeable luxy_,
        address luxyLaunchpadFeeManagerProxy_,
    ...
    function totalFee(uint64 _dstChid, uint256 _id)
        external
        view
        returns (uint256)
    {
