...
contract EventFactory is IEventFactory, OwnableUpgradeable, AuthModifiers, UUPSUpgradeable {
    ...
    function createEvent(
        ...
        IEventImplementation.EventData memory eventData
        ...
        IEventImplementation(_eventAddress).setEventData(eventData);
        registry.auth().grantEventRole(_eventAddress);
        eventAddressByIndex[eventData.index] = _eventAddress;
        emit EventCreated(msg.sender, eventData.index, _eventAddress);
        eventCount++;
    }
