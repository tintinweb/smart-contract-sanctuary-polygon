...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
    ...
    address public constant rewardToken1Addr = 0xC3C7d422809852031b44ab29EEC9F1EfF2A58756;
    // One or more farm tokens
    address public constant farmToken0Addr = 0x3A58a54C066FdC0f2D55FC9C89F0415C92eBf3C4;
    ...
    address[] public rewardToken1ToWMatic;
        ...
        )
    {
        ...
        rewardToken0ToWMatic[1] = farmToken1Addr;

        rewardToken1ToWMatic = new address[](2);
        rewardToken1ToWMatic[0] = rewardToken1Addr;
        rewardToken1ToWMatic[1] = farmToken1Addr;

        rewardToFarmTokenPath0 = new address[](2);
        rewardToFarmTokenPath0[0] = farmToken1Addr;
    ...
    function harvest() public override nonReentrant {
        ...
        if (_reward1Balance > harvestCutoffBps1){
            ...
            _swapUniswapWithPathForFeeOnTransferTokens(rewardToken1ToWMatic, swapAmount, swapRouter0Addr);
        }

        // Figure out how much reward we collected
        uint256 _wMaticBalance = IERC20(farmToken1Addr).balanceOf(address(this));
        if (_wMaticBalance > harvestCutoffBps2){
          ...
          swapAmount = calculateSwapAmount(farmToken1Addr,5000);
...
contract StrategyTwoAssets is StrategyFarmTwoAssets {
    // Token addresses
    address public FARM_MASTER_CHEF = 0x8ECbc9B0741C000fd7aaE9cb559e5eEe1D1883F3;
    address public LP_TOKEN = 0x65752C54D9102BDFD69d351E1838A1Be83C924C6;
    constructor()
        public
