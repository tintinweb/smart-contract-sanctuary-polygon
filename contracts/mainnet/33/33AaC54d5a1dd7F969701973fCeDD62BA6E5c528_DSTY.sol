...
contract DSTY is ERC20Decimals, ERC20Mintable, ERC20Burnable, ERC1363, TokenRecover {
    constructor() payable ERC20("DustyWorlds", "DSTY") ERC20Decimals(18)  {
        address owner  = address(0x014e9a891176Bc4C7632d32D23B1473C017a0b6e);
        _mint(owner, 1000000*10**uint256(18));
        _owner  = owner;
    }
