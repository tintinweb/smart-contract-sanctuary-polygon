...
contract GotchiVault is IERC173, Initializable,PausableUpgradeable, IERC721ReceiverUpgradeable, IERC1155ReceiverUpgradeable {
    ...
    //by default, lending initial costs goes to the vault, so we need to claim this out
    function withdrawCosts() public onlyApproved{
        ERC20 ghst = ERC20(im_ghstAddress);
        uint256 balance = ghst.balanceOf(address(this));
        ERC20(im_ghstAddress).transfer(s.contractOwner, balance);
    }
