...
// File: contracts/Optibeef721.sol
...
contract Optibeef721 is Context, AccessControl, ERC721 {
    ...
    function setTokenParam(uint256 tokenID, uint256 i, uint32 v) public {
      require(hasRole(MINTER_ROLE, _msgSender()), "Optibeef721: must have minter role to update tokenparams");
    ...
    function setPrice(uint256 sid, uint256 p) public sidInRange(sid) {
      require(hasRole(MINTER_ROLE, _msgSender()), "Optibeef721: must have minter role to change price");
    ...
    function mint(uint256 sid, address to) public virtual returns (uint256 _tokenId) {
      require(hasRole(MINTER_ROLE, _msgSender()), "Optibeef721: must have minter role to mint");
