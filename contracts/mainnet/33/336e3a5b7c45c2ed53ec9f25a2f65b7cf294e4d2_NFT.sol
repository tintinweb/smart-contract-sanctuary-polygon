    ...
    ReentrancyGuardUpgradeable
{
    ...
    function mint(
        ...
        _lock(address(0), to_, newItemId, expired_);
...
interface IERC721PayoutAmberfiContentFactory is INFTPayoutsUpgradeable {
    ...
    /// @param storageLocationId_ (uint8)
    /// @param expired_ (uint256) This value is used to lock the nft for specific period
    function mint(
        address to_,
        uint256 tokenId_,
        PayoutTier calldata payoutInfo_,
