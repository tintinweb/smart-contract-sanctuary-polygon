...
interface BEP20Base {
 ...
 contract CCNFT is ERC721 {
     ...
     uint256 counter;
     uint256 minimumPrice = 6000000000000000000;
    ...
    bool activar = false;
     ...
     constructor()ERC721("NFT", "CCNFT") payable{
         ...
         crossmintAddress = 0xD7E024b704A32022596a15c853d4682248482bE8;
    ...
    function mint(address _to) public payable {
        ...
        require(msg.sender == crossmintAddress, "IS NOT CROSSMINT ADDRESS");
        require(counter < supply, "MAximum Supply");

        _mint(_to, counter);

        ownerToken[_to] = counter;
    ...
    function set_supply(uint256 _value) public onlyOwner returns(bool){
        supply = _value;
        return true;
    }
