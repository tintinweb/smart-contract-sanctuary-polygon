...
// File: contracts/HumansOfPlatzi.sol
...
contract HUMANSOFPLATZI is ERC721, ERC721Enumerable, AccessControl {
    using Counters for Counters.Counter;
    using Strings for uint256;

    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    Counters.Counter private _tokenIdCounter;
    uint256 public MAX_SUPPLY = 119;
    string public uriSuffix = ".json";

    constructor() ERC721("HUMANSOFPLATZI", "HOPLTZ") {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://gateway.pinata.cloud/ipfs/QmWXXccVJ6r9g9LLwpT1p4WUPH1B2mGkmcvemUWMevjVsL/";
    }
