    ...
    ERC2771Recipient
{
    ...
    function distributeTokens(
        ...
        for (uint256 i = 0; i < transferAddr.length; i++) {
            ...
            require(
                balanceOf(_msgSender(), ids[i]) >= quantity[i],
    ...
    ERC2771Recipient
{
    ...
    function initialize(
        ...
        eip721Info = Eip721Info(signDomain, signVersion);
        _setTrustedForwarder(_trustedForwarder);
    }
    ...
    function getEIP712Info() public view OnlyAdmin returns (Eip721Info memory) {
        return eip721Info;
    }

    function setEIP721Info(
        string memory signDomain,
        string memory signVersion
    ) public returns (bool) {
        __EIP712_init(signDomain, signVersion);
