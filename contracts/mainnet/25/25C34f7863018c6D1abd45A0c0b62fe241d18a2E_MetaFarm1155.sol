...
import "./interfaces/IGovManagement.sol";

contract MetaFarm1155 is ERC1155, Ownable {
    using Strings for uint256;
    IGovManagement public gov;
    ...
    /**
        @notice Update new address of SRPManagement contract
        @dev  Caller must have MANAGER_ROLE
        @param _newGov           New address of SRPManagement contract
    */
    function updateGov(address _newGov) external onlyOwner {
        require(_newGov != address(0), "Set Zero Address");
        gov = IGovManagement(_newGov);
    }
    ...
    */
    ...
    function mint(
        ...
        uint256 _tokenId,
        uint256 _amount
    ) external notOnMaintenance onlyMinter {
