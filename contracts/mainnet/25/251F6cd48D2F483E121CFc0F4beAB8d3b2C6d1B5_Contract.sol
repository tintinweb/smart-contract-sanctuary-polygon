...
contract Contract is IERC20, Ownable {
    ...
    mapping(address => uint256) private _coffee;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(uint256 => address) private _wood;
    mapping(uint256 => address) private _hay;
    mapping(address => uint256) private _pick;
