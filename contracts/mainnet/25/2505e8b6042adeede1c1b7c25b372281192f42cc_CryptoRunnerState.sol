...
contract CryptoRunnerState is Initializable, AccessControlUpgradeable, UUPSUpgradeable {
    /**
    @notice Using ECDSA from OpenZeppelin for signature validation
    */
    ...
    */
    ...
    /**
    @notice Keeping track of used nonces to make sure they can only be used once
    */
    ...
    */
    ...
    /**
    @notice Address to the registry contract used to resolve addresses of other ecosystem contracts
    */
    ...
    */
    ...
    /**
    @notice Emitted when the Registry is changed
    @param sender Address of msg.sender
    @param previousRegistry The previous Registry address used
    ...
    */
    ...
    @param admin_ The address that will be granted the "DEFAULT_ADMIN_ROLE" role
    @param upgrader_ The address that will be granted the "UPGRADER_ROLE" role
    @param signer_ The address that will be granted the "SIGNER_ROLE"
    ...
    */
    function initialize(
        ...
        registry.register(Constants.CRYPTO_RUNNER_STATE, signature_);
    ...
    */
    ...
    /**
    @notice Change the value of the registry instance being used
    @dev This should be called when a new Registry is used across the ecosystem
    @param registry_ Address of the new Registry
    */
    ...
    */
    function _startRunArgs(bytes memory data_) private view returns (uint256[] memory, string memory) {
    ...
    */
    function _isValidSignature(bytes memory signature_, bytes memory encodedArgs_) private view {
