...
contract Controllers {
    ...
    constructor(address _instaIndex, address chiefAddress) {
        instaIndex = _instaIndex;
        chief[chiefAddress] = true;
    }
...
contract InstaConnectorsV2 is Controllers {
    ...
    constructor(address _instaIndex, address chiefAddress) public Controllers(_instaIndex, chiefAddress) {}
