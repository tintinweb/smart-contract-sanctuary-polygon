...
contract Semantic is ISemantic, AccessControl, Semantic721 {
    ...
    function _mintTurtle(
        ...
        ownedTokensCount[owner] = ownedTokensCount[owner] + 1;
        ownedTokenId[owner][ownedTokensCount[owner]] = tokenId;
        ownedTokenIndex[owner][tokenId] = ownedTokensCount[owner];
    ...
    function _burn(
        ...
        uint256 lastTokenIndex = ownedTokensCount[owner];
