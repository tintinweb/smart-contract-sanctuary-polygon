...
// File: contracts/PolygonPunkzContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract PolygonPunkzContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Polygon Punkz";
    string public symbol = "PUNKZ";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/2qWhrIxSxubVYZuV9lU9/contract-metadata";
  }
