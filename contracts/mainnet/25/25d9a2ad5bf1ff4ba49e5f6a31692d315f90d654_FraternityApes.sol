...
/**
FRAT Fraternity Apes Fan Token
https://twitter.com/fratapesparty
*/
...
contract FraternityApes is FRATDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private FRATTeam;
    address private CharityFRAT;
    ...
    string public override name = "Fraternity Apes";
    string public override symbol = "FRAT";
    ...
    constructor(uint totalSupplyValue, address FRATTeamAddress, address CharityFRATAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        FRATTeam = FRATTeamAddress;
        CharityFRAT = CharityFRATAddress;
        
        // split the tokens according to agreed upon percentages
        balances[FRATTeam] =  totalSupply * 4 / 100;
        balances[CharityFRAT] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's FRATTeam pot
