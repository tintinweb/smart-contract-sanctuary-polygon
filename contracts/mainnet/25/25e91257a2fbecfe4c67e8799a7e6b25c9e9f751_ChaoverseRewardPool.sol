...
contract ChaoverseRewardPool is ERC1155Receiver, VeryBase {
    ...
    constructor() VeryBase("chaoverse.reward.pool", "0.0.2") {
        owner = msg.sender;
    }
    ...
    function nftBalance(uint256 _tokenid) public view returns (uint256) {
        IERC1155 _IERC1155 = IERC1155(_contract);
        return _IERC1155.balanceOf(msg.sender, _tokenid);
    }
    ...
    // 取回奖励的操作
    function getNFT(uint256 _tokenid) public onlyOwner {
        IERC1155 _IERC1155 = IERC1155(_contract);
        uint256 x = _IERC1155.balanceOf(address(this), _tokenid);
        _IERC1155.safeTransferFrom(
            address(this),
            msg.sender,
            info.reward_id,
