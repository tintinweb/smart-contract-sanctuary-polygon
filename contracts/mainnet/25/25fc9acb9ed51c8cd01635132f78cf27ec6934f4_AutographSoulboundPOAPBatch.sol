...
error AutographSoulboundPOAPError();

/// @notice ERC-721 implementation that does not allow transfers
contract AutographSoulboundPOAPBatch is
    ERC721Upgradeable,
    ...
    AccessControlEnumerableUpgradeable
{
    ...
    function mint(address[] memory recipients, string[] memory uris) external {
        require(
            hasRole(MINTER_ROLE, _msgSender()),
    ...
    function approve(address, uint256) public virtual override {
        revert AutographSoulboundPOAPError();
    }
