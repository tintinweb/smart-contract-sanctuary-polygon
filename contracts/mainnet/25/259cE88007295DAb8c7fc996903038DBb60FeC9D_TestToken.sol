...
contract TestToken is 
    ...
    uint256 private constant _MAX_TOTAL_SUPPLY = 700000000000000000000000000;
    ...
    function initialize(string memory name, string memory symbol, uint256 initialSupply, uint8 decimals, address _miningPoolAddress, uint256 _MAX_ALLOWED_BURN_AMOUNT, uint8 _commissionPercentage) initializer public {
    ...
    onlyRole(MINTER_ROLE) 
    {
        ...
        require(currentSupply + amount <= _MAX_TOTAL_SUPPLY, "Mint amount exceeds the maximum limit, cannot mint");
    ...
    onlyRole(MINTER_ROLE) 
    {
        require(amount <= MAX_ALLOWED_BURN_AMOUNT, "Burn amount exceeds the maximum limit");
    ...
    onlyRole(UPDATER_ROLE)
    {
        ...
        MAX_ALLOWED_BURN_AMOUNT = amount;
    ...
    function MAX_TOTAL_SUPPLY() public view virtual returns (uint256) {
