...
// token transfers
// ----------------------------------------------------------------------------
contract OnePlanetCarbonOffsetChildV5 is ERC20Interface, OwnableUpgradeable, UUPSUpgradeable {
...
function initialize() public initializer {
    ...
    //-------------------------------------------------------------------------------------------
    function buy1PLwithTether(uint256 tetherAmount) public returns (bool success) {
    ...
    // Verify transaction details at www.1PLANET.app
    //-------------------------------------------------------------------------------------------
    function offsetDirectWithMatic(string calldata message) external payable returns (bool success) {
