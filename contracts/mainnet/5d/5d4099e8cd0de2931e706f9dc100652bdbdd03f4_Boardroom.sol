...
interface ITreasury 
{
    ...
    function getLCKPrice() external view returns (uint256);
...
contract ShareWrapper {
    ...
    function stake(uint256 amount) public virtual {
        ...
        lcs.safeTransferFrom(msg.sender, address(this), amount);
    }
    ...
    function withdraw(uint256 amount) public virtual {
        ...
        lcs.safeTransfer(msg.sender, amount);
    }
}
...
contract Boardroom is ShareWrapper, ContractGuard {
    ...
    modifier onlyOperator() {
        require(operator == msg.sender || address(treasury) == msg.sender, "Boardroom: caller is not the operator");
        _;
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            lck.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        lck.safeTransferFrom(msg.sender, address(this), amount);
    ...
    function governanceRecoverUnsupported(
        ...
        require(address(_token) != address(lck), "lck");
        require(address(_token) != address(lcs), "lcs");
