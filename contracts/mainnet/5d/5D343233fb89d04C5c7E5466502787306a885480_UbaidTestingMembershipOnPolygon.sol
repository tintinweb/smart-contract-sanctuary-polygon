 ...
 */
interface IUbaidTestingMembershipOnPolygon {
    /**
...
contract UbaidTestingMembershipOnPolygon is
    IUbaidTestingMembershipOnPolygon,
    ERC721AQueryable,
    ERC2981,
    Ownable,
    ReentrancyGuard
{
    ...
    constructor(
        ...
        bytes32 _root
    ) ERC721A("UbaidTestingMembership On Polygon", "UOP") {
