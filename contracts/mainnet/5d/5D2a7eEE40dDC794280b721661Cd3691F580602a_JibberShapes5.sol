...
contract JibberShapes5 is ERC721A, PaymentSplitter, Pausable {
 ...
 struct PresaleConfig {
    ...
    address[] private _team = [
        0x00173a313c952b0A587cA44372091E337db4385F,
        0x7b07259e13015C8Cfc9719C54E58157f14d1FfB7
    ];    
    ...
    ) ERC721A("JibberShapes5", "JBSH5", _maxBatchSize, _maxTotalSupply)
      PaymentSplitter(_team, _teamShares)
    {
        ...
        reveal = false;
        revealURL = "https://www.nyron.ca/jibbershapes5/metadata/notRevealed.json";
        price = 0.1 ether;
        baseURI = "https://www.nyron.ca/jibbershapes5/metadata/";
    }
    ...
    function setRevealURL(string calldata _revealURL) external onlyOwner {
