...
contract DumbCryptoPunks is ERC721Enumerable, Ownable {
    using Strings for uint256;

    string public baseURI;
    string public baseExtension = ".json";
    uint256 public cost = 0.00001 ether;
    uint256 public presaleCost = 0.00001 ether;
    ...
    constructor() ERC721("Dumb CryptoPunks", "DC") {
        setBaseURI("ipfs://QmeTAvSVxoyx2TyLM2baUaCzJtfkpWRUYnMcdwP4dNMdBE/");
        mint(msg.sender, 100);
    }
