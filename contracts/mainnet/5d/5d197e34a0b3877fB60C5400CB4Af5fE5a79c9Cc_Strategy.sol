...
contract Strategy is BaseStrategy, IUniswapV3SwapCallback {
    ...
    IERC20 public wETH = IERC20(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270);
    ...
    function name() external view override returns (string memory) {
        return 'Strategy Uniswap V3 USDC-MATIC v0.4';
    }
    ...
    function _withdrawFromPrincipal(uint256 _amountNeeded) internal {
        ...
        if (balanceOfWeth() > 0) {
            ...
            lendHelper.unwindPosition(repayAmount); // NOTE in stead of unwind repayAmount with collatRatio the needed would be wethToWant(repayAmount, true)
        }
    }
