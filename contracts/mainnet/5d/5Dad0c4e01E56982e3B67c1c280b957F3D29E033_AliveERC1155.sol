    ...
    ERC1155Supply
{
        ...
        )
    {
        ...
        tokenURI[initialeTokenId] = newtokenURI;
...
aliveRegistry = _aliveRegistry;
 ...
 function contractURI() public view returns (string memory) {
    ...
    function setURI(string memory newuri, uint tokenID) public virtual onlyAdmin {
        // _setURI(newuri);
        require(isValidTokenId[tokenID] == true, "Invalid token");
