...
contract MinkeMStable is ERC2771Context {
    ...
    constructor(address _trustedForwarder, address _interestToken) ERC2771Context(_trustedForwarder) {
        owner = msg.sender;
    ...
    */
    function _depositAndStake(
        ...
        if (_stake && _referrer != address(0)) {
            ...
            credits = ISavingsContractV3(_save).depositSavings(_amount, _msgSender(), _referrer);
        } else {
            credits = ISavingsContractV3(_save).depositSavings(_amount, _msgSender());
        }
