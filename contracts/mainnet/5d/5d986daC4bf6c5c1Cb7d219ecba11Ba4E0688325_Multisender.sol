...
contract Multisender is Ownable{
    ...
    function transferERC20(address token, address[] memory tos, uint256[] memory amounts) external onlyOwner{
    ...
    function transferERC721(address nft, uint256[] memory ids, address[] memory tos) external onlyOwner{
    ...
    function transferERC1155(address nft, address[] memory tos, uint256[] memory ids, uint256[] memory amounts, bytes memory data) external onlyOwner{
