...
// File: contracts/ERC20CappedUpgradeable.sol
...
===============================================
Based on the OpenZeppelin Contract Wizard v4.x
===============================================
*/
...
contract BTest is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, ERC20SnapshotUpgradeable, OwnableUpgradeable, PausableUpgradeable, ERC20PermitUpgradeable, ERC20VotesUpgradeable, UUPSUpgradeable, ERC20CappedUpgradeable {
    constructor() {
        _disableInitializers();
    }
    ...
    function initialize() initializer public {
        ...
        __Ownable_init();
        __Pausable_init();
        __ERC20Permit_init("BTest");
        __ERC20Votes_init();
        __UUPSUpgradeable_init();
        __ERC20Capped_init(1000000000);
    }
