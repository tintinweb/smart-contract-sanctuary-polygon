...
// File: contracts/bets/BaseNFT.sol
...
contract BaseNFT is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 internal _price; // = 1 ether;

    uint256 public MAX_SUPPLY; // = 1000000;
    uint256 public MAX_TOKENS_PER_MINT; // = 100;

    uint256 public LAST_BLOCK_TO_MINE = 35955423; // Nov 18, 2022

    string public baseURI;

    address public distributionContract = 0xb316518a10a302Ce7B81D83a1f141d9149E503EE;
    ...
    function setDistributionContract(address newDistributionContract) public onlyOwner {
    ...
    function setLastBlockToMine(uint256 newLastBlockToMine) public onlyOwner {
        LAST_BLOCK_TO_MINE = newLastBlockToMine;
    }

    function getLastBlockToMine() public view returns (uint256) {
        return LAST_BLOCK_TO_MINE;
    }
    ...
    function mint(uint256 _nbTokens) external payable whenSaleStarted whenSaleAllowed(msg.sender) {
        ...
        require(block.number < LAST_BLOCK_TO_MINE, "Can't mint after due date");
    ...
    function withdraw() public{
        ...
        require(payable(distributionContract).send(_balance));
    }    

}

// File: contracts/bets/TeamNFT.sol


pragma solidity ^0.8.2;


contract TeamNFT is BaseNFT {

    constructor() BaseNFT(10 ether , 1000000, 100, "ipfs://", "ARG", "ARG") {}
}