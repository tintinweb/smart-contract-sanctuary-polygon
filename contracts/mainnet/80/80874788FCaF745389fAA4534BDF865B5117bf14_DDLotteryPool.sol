...
DDLotteryPool - Version 1.1 - Deployed by Rakent Studios, LLC on 05/07/2022
...
Referral System (On-Chain & Cross-Contract):
    ...
    -Referrals are tracked across all the DubbleDapp smart contracts using the DDDatabase smart contract, 
        so you will receive 1% from ANY Lottery Pool the WIN on!

UPDATES:
(1.1)[05/07/2022]
    - Prevented Deposit and Withdraw functions from being called in the same transaction.
    - Configurations are no longer hard coded, but are implemented through the initial Constructor. 
...
/*[ PRESET VARIABLES ]------------------------------------------------------------------------------------------------------------------*/
    ...
    uint256 public ticketPrice;                                                         /* The Required Deposit Amount for a Ticket     */
