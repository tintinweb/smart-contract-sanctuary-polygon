...
// File: contracts/TheBULBiMasksFamNFren.sol
...
contract TheBULBiMasksFamNFren is ERC721, ERC721URIStorage, Ownable {
    ...
    constructor(string memory _defaultURI) ERC721("TheBULBiMasksFamNFren", "BULBIMASKS_FAMNFREN") {
    ...
    function tokenURI(uint256 tokenId) public view override(ERC721, ERC721URIStorage) returns (string memory) {
        if (bytes(super.tokenURI(tokenId)).length > 0) { return super.tokenURI(tokenId); }
