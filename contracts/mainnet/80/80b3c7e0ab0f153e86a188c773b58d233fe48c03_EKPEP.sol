...
contract EKPEP is ERC721  {
    ...
    constructor()
        ERC721("Wrapped Evil Kongs - Pixel Edition", "EKPEP")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeibvcmkjvssmle3a2apwvixyyrfbzbjh2yovhfzzi6xdv5jcllv22u/", Strings.toString(tokenId), ".json")
            );
    }
