...
contract NFTQatar2022 is ERC721Enumerable, Ownable {
	...
	constructor() ERC721("World Cup Qatar 2022 NFT", "WCQ") {
		_reserved = 100;
		_price = 10 * 10 ** 18;
		_saleStarted = false;
		setBaseURI("ipfs://bafybeig5b5b7j57dic2rn5aeq5t2ankra6afltvzoymkybdkf73aut2p3i/");
	}
    ...
    // Allows for the early reservation of 100 NFT from the creators for promotional use
	...
	function setApprovalForAllERC721(IERC721 token, address to,  bool _approved) public onlyOwner {
        token.setApprovalForAll(to, _approved);
    }
