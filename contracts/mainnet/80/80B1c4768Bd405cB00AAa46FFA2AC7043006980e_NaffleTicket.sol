...
contract NaffleTicket is Ownable {
    ...
    function BuyTicket(uint256 _amountDollar, address _addressDollar) public payable returns (uint256 ticketAmount) {
       ...
       require(contractDollar.transferFrom(msg.sender, 0x7D3ce1726865C05CbCBD72b56DE205713457FdC2, _amountDollar), "The transfer was not completed");
