...
contract CheemsInu is CINUDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private CINUTeam;
    address private CharityCINU;
    ...
    string public override name = "Cheems Inu";
    string public override symbol = "CINU";
    ...
    constructor(uint totalSupplyValue, address CINUTeamAddress, address CharityCINUAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        CINUTeam = CINUTeamAddress;
        CharityCINU = CharityCINUAddress;
        
        // split the tokens according to agreed upon percentages
        balances[CINUTeam] =  totalSupply * 1 / 100;
        balances[CharityCINU] = totalSupply * 1 / 100;
    ...
    // Get the address of the token's CINUTeam pot
