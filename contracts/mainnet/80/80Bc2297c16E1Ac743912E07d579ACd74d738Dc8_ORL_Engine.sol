...
contract ORL_Engine is Ownable, Concatenate {
    ...
    mapping(address => uint) public ffaFilled;
    ...
    function addRacers(address _sender, address _con, uint[] calldata _id, uint[] calldata _ev) external { 
        ...
        for(uint i=0; i<_count; i++){
            ...
            } else if (_temp.tempEvent == 0){
                require(ffaFilled[_temp.tempOwner] < 19, "You've registered too many Racers in FFA.");
                ffaFilled[_temp.tempOwner] += 1;
            }
