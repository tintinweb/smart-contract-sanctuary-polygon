...
contract WTFBird is ERC721{
    uint256 public totalSupply = 10000; // 总量
    
    uint256[10000] public ids; // 用于计算可供mint的tokenId
    ...
    //月鸟的baseURI为: https://live---metadata-5covpqijaa-uc.a.run.app/metadata/
