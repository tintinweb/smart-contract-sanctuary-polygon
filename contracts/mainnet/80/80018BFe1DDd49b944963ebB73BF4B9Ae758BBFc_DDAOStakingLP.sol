...
*/
    function WETH_rate()public view returns(uint256 rate,uint112 r1,uint112 r2)
    {
//	uint256 rate;
	uint256 r1;
	uint256 r2;
	(r1,r2,) = IToken(lp_weth_usdc).getReserves();
//	rate = 10**18 * r1 / r2 / 10**12;
    }
    function getReserves(address addr)public view returns(uint112 r1,uint112 r2,uint32 time)
    {
