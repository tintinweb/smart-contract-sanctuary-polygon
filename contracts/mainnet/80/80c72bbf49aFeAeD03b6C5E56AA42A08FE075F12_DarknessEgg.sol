...
contract DarknessEgg is Ownable, ERC721A, ReentrancyGuard {
    ...
    constructor(uint256 _maxBatchMintSize, address _ores, address _mnaNFT) ERC721A("Darkness Egg", "Darkness Egg", _maxBatchMintSize) {
        ores = _ores;
        mnaNFT = IMnA(_mnaNFT);
    }

    function mint(uint256 numberOfTokens, uint256 tokenId) external payable onlyActive nonReentrant() {
        ...
        require(mnaNFT.ownerOf(tokenId) == msg.sender, "You don't own this token");
