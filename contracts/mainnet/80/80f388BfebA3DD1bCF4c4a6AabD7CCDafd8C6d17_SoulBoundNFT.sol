...
contract SoulBoundNFT is NFTAuth, ERC721Upgradeable {
  ...
  function _initDependentContracts() override internal {
    ...
    address citizenAddress = addressBook.get("citizen");
    require(citizenAddress != address(0), "SoulBoundNFT: citizen address invalid");
    citizen = ICitizen(citizenAddress);
  }
}
