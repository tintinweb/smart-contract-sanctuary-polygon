 ...
 */
contract JorgeArevalo is ERC721, AccessControl {
    ...
    uint256 public priceMATIC = 95 ether;     // 95 MATIC
    uint256 public priceUSDC = 120 * 10 ** 6; // 120 USDC
    string public baseURI = "https://bafkreiapoud6smh5tcmf2ocdgzda4gszgcalcdu6wmfz66loqri7u74r3e.ipfs.nftstorage.link/";

    bytes32 public constant ADMIN_ROLE = keccak256("ADMIN_ROLE");
    bytes32 public constant AIRDROPPER_ROLE = keccak256("AIRDROPPER_ROLE");
    
    constructor(address _usdcAddress) payable ERC721("ALEJANDRO", "JAM") {
    ...
    function mintMATIC(address _recipient, uint256 _quantity) 
        external  
        payable
    ...
    function mintUSDC(address _recipient, uint256 _quantity) 
        external  
        isActive()
        isAvailable(_quantity) 
    {
