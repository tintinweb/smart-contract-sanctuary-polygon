...
contract test is Context, IERC20, Ownable {
    ...
    function setTaxFeePercent(uint256 taxFee) internal onlyOwner() {
        _taxFee = taxFee;
    }
    
    function setLiquidityFeePercent(uint256 liquidityFee) internal onlyOwner() {
    ...
    function setSwapAndLiquifyEnabled(bool _enabled) internal onlyOwner {
