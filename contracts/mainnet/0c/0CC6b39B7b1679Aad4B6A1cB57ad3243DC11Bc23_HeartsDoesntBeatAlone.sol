...
contract HeartsDoesntBeatAlone is ERC721 {
    ...
    constructor()
        ERC721("Hearts Doesn't Beat Alone", "HDBA")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeidgkxqkkcpcj7gl7jzj227zmq3diyqq6ikcra6ldv6idotxlcdo44/", Strings.toString(tokenId), ".json")
            );
    }
