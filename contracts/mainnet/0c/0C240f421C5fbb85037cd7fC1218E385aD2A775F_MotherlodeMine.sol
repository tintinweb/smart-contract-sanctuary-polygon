...
/*
MotherLode Mine - Mine Polygon in the Motherlode mine for highest daily returns
...
contract MotherlodeMine is Context, Ownable {
    ...
    uint256 private constant MAX_INVESTMENT = 500 ether;
    ...
    function buyEggs(address ref) public payable {
        require(initialized);
        require(msg.value <= MAX_INVESTMENT, "Max investment is 500 Matic");
