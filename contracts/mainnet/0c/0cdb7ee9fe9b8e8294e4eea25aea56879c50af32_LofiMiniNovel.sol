...
contract LofiMiniNovel is OwnableUpgradeable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC2771ContextUpgradeable, Governance{
    ...
    constructor (){
        ...
        collect_description = "Onchain the mini-novel of Lofitown";
    }

    function initialize(address trustedForwarder) public initializer {
        __Ownable_init();
        __ERC721_init("LofiNovel", "LONV");
