...
contract PairFlash is Ownable,IUniswapV3FlashCallback, PeripheryImmutableState, PeripheryPayments {
    ...
    function uniswapV3FlashCallback(
        ...
        // Input variables
        uint256 amount = decoded.amount0;
        uint16 referral = 0;

        address lendingCore = address(0x8dFf5E27EA6b7AC08EbFdf9eB090F32ee9a30fcf);

        // Approve LendingPool contract to move your DAI
        IERC20(token0).approve(lendingCore, amount);

        // Deposit 1000 DAI
        lendingPool.deposit(token0, amount,address(this), referral);        
        ...
        // Input variables
        uint256 amount = decoded.amount1;
        uint16 referral = 0;
        ...
        // Deposit 1000 DAI
        lendingPool.borrow(token1, amount,2,0, address(this));   
