...
// File: experimental discounts/discount.sol
...
contract MintMoney is ERC721, Ownable {
    using Strings for uint256;
    ...
    address public contract1 = 0xb9F887D35F0b6142C7EA028031637784b2eaf83b;
    address public contract2 = 0x7D472746A2D11eEE364eb37cD07686e482b72EA4;
    uint256 public criteria1 = 0;
    uint256 public criteria2 = 0;
    ...
    uint256 public discount = 90 ether;
    uint256 public maxSupply = 400;
    uint256 public maxMintAmountPerTx = 200;
    uint256 public MaxgiveawayAmountperTx = 5;
    uint256 public giveawaylimit = 0;
        ...
        mintCompliance(_mintAmount)
    {
        ...
        uint256 _contract2 = walletOfOwnerOfOtherContract(
            ...
            if (
                ...
                //check if user has already claimed free token
                if (_contract1 >= criteria1 == true) {
                    // if user has not claimed free token, then he can mint for free
                    require(msg.value >= discount * _mintAmount, "Insufficient funds!");
