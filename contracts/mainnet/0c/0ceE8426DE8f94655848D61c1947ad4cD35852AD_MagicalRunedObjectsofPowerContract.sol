...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x1CC0aD2C9D6d2e7ACcb9EAEB36AC5263fb5fBFe7];
  address public erc20Payable = 0x1CC0aD2C9D6d2e7ACcb9EAEB36AC5263fb5fBFe7;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 20, 250) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeia5pz2ntuclm6b3dgiprenyjo5a52vmqvuorqikw7q2hupcltknay/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/WeyrIzOfFKc4clC7PEBq/contract-metadata";
  }
...
// File: contracts/MagicalRunedObjectsofPowerContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MagicalRunedObjectsofPowerContract is ERC721APlus {
    constructor() ERC721APlus("Magical Runed Objects of Power", ""){}
}
  /*******************************************************/
  /*                                                     */
