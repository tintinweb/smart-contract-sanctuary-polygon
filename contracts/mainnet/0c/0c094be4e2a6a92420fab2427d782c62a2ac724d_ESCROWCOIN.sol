 ...
 */
contract ERC20TA is Context, IERC20, IERC20Metadata, Ownable {
    ...
    uint8 internal _txTax = 10;
    uint8 internal _autoburnTax = 10;
 ...
 */
abstract contract ERC20Burnable is Context, ERC20TA {
    /**
...
contract ESCROWCOIN is ERC20TA, ERC20Burnable {
    constructor(address _reciever) ERC20TA("ESCROW COIN", "ESCRO") {
