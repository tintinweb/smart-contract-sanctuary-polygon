...
contract PolygonPortal is IPolygonPortal, Initializable, ERC721Receiver, FxMessageProcessor {
    ...
    function swapNativeAndCall(
        ...
        beneficiary.call{value: brydgeFee}("");
        ...
        (bool successsfulReimbursement, ) = user.call{value: overpayment}("");
        require(successsfulReimbursement, "Reimbursement failed");
    ...
    function _handleCalls(bytes memory callBytes) internal {
        ...
        for (uint256 i = 0; i < calls.length; i++) {
            ...
            require(success, toAsciiString(calls[i].target));
        }
    }
    ...
    function _swapERC20(
        ...
        token.transfer(beneficiary, brydgeFee);
        ...
        uint256 overPayment = amountIn - swapCost;
        token.transfer(user, overPayment);
    }
