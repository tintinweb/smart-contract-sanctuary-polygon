...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x8d4d6479830F59d50428412424172A18bB73C2A7];
...
// File: contracts/CarioLinkNftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract CarioLinkNftContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "CarioLink NFT ";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/uCVM8TUetamjUmDOXt1J/contract-metadata";
  }
