...
contract GiftBagDropper is Ownable {
    ...
    function drop(address targetAddress, bool bigBag) external onlyOwner {
        ...
        kalissaVisitCard.safeTransferFrom(0xbC1ae45C17A37133c1f3A83af0eB9689aeB03A75, targetAddress, 79171102851626454107633356906327179233133378767603269003632620124106024560400, 1, "");
    }
