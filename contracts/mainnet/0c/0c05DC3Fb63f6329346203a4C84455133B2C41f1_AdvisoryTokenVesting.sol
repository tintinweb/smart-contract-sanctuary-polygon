...
contract AdvisoryTokenVesting is Ownable {
    ...
    function cancelVesting(address _recipient) external onlyOwner {
        totalVestingAmount = totalVestingAmount.sub(
            vestingInfoMap[_recipient].totalAmount -
                vestingInfoMap[_recipient].paidAmount
        );
