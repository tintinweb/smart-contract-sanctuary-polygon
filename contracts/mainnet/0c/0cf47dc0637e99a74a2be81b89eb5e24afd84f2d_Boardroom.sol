...
contract Boardroom is ShareWrapper, ContractGuard {
    ...
    function getUnicornPrice() public view returns (uint256) {
        return treasury.getUnicornPrice();
    }
    ...
    function stake(uint256 amount) public override onlyOneBlock updateReward(msg.sender) {
        ...
        members[msg.sender].epochTimerStart = epochTimerStart;
        // reset timer
    ...
    function withdraw(uint256 amount) public onlyOneBlock memberExists updateReward(msg.sender) {
        ...
        claimReward();
        super.withdraw(amount, getUnicornPrice());
    ...
    function exit() external {
        require(members[msg.sender].epochTimerStart.add(withdrawLockupEpochs) <= treasury.epoch(), "Boardroom: still in withdraw lockup");
        claimReward();
        withdraw(balanceOf(msg.sender), getUnicornPrice());
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            unicorn.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        unicorn.safeTransferFrom(msg.sender, address(this), amount);
