...
contract NFTSaleCreator is NFTSaleLib {
    ...
    function createFixedPriceSale(
        ...
        require((_externalStorage.getBool(keccak256("allowNativeCurrency")) && keccak256(bytes(currency))==NATIVE_CURRENCY) || _getCurrencyAddress(currency) != address(0), "currency not found");
...
abstract contract NFTSaleLib is Pausable, ERC2771Context, AccessControl {
    using SafeERC20 for IERC20;
    bytes32 constant NATIVE_CURRENCY = keccak256(bytes("MATIC"));
