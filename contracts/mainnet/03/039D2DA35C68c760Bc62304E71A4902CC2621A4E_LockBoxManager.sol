...
import "@openzeppelin/contracts/token/ERC721/ERC721.sol"; //inherits the methods of the ERC-721 standard
import "@openzeppelin/contracts/utils/Counters.sol"; //inherited counter approach for security
import "@openzeppelin/contracts/access/Ownable.sol"; //only owner of contract can mint 
import "@openzeppelin/contracts/token/ERC721/extensions/ERC721URIStorage.sol"; //storage based URI management

contract LockBoxManager is ERC721URIStorage, Ownable {
    /*
    Assign Counters.Counter here e.g. Counters.Counter private _[someVar];
    */
    ...
    // TODO: Rename `Token` and `tokens` to something like `LockBox` and `lockBoxes`?
    struct LockBox {
        string LockBoxID;
        string LockBoxName;
...
//    StateType public State;
    ...
    function UploadDocuments(uint256 _lockBoxId, string memory lockBoxID, string memory image) public onlyReupCo("only reupCo can upload documents") {
        lockBoxes[_lockBoxId].LockBoxStatus = "Approved";
        lockBoxes[_lockBoxId].Image = image;
