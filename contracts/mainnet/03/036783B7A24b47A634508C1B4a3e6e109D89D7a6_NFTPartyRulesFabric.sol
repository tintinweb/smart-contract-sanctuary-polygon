...
import "contracts/NFTPartyRules.sol";
...
/// @title NFTPartyRules Fabric
contract NFTPartyRulesFabric is
    Access,
    ...
    SaleTaxNumeratorStorage
{
    ...
    function _init(
        ...
        NFTPartyRules(result).initialize({
            nameValue: string(abi.encodePacked("NFT Party Rule", tokenId.toString())),
            symbolValue: string(abi.encodePacked("PR", tokenId.toString())),
            versionValue: "1",
    ...
    function _init2(
        ...
        NFTPartyRules(result).initialize2({
