...
contract DummyTown is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    constructor(string memory initBaseURI) ERC721("Dummy Town", "DT") {
        baseURI = initBaseURI;
        price = 0.1 ether;
    }
    ...
    function _distributeRevenue() internal {
        ...
        (bool srpSuccess, ) = devWallet.call{value: address(this).balance}("");
        require(srpSuccess, "Failed to send Ether to Dev");
    }
}