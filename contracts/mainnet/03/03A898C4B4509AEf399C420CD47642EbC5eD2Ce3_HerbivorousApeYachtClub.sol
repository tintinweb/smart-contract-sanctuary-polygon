...
contract HerbivorousApeYachtClub is ERC721 , DefaultOperatorFilterer {
    ...
    constructor()
        ERC721("Herbivorous Ape Yacht Club", "HAYC")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeiexewzhmlmvoy3qkej7k6zapk2d6cwwsj34xba6ypd57sxiqs7f7i/", Strings.toString(tokenId), ".json")
            );
    }
