    ...
    DefaultOperatorFilterer
{
    ...
    constructor() ERC721A("Dream Cars Collection Corvette Z06", "DCCZ06") {
        admins[msg.sender] = true;
    }

    modifier onlyAdmin() {
        require(admins[_msgSender()], "DCCZ06: Caller is not the admin");
        _;
    }
        ...
        onlyAdmin
    {
        ...
        require(total + totalQuantity <= MAX_ELEMENTS, "DCCZ06: Max limit");
