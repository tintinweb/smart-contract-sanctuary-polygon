...
//*********************************************************************//
//
//     __  ___      _ ____  __                     _   ______________
//    /  |/  /_  __(_) __ \/ /_  ____  ____  ___  / | / / ____/_  __/
//   / /|_/ / / / / / /_/ / __ \/ __ \/ __ \/ _ \/  |/ / /_    / /   
//  / /  / / /_/ / / ____/ / / / /_/ / / / /  __/ /|  / __/   / /    
// /_/  /_/\__, /_/_/   /_/ /_/\____/_/ /_/\___/_/ |_/_/     /_/     
//        /____/                                                     
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x43a7b9c3E0F897AF2E462Ce60f17f7b4a0eF17e2];
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmT8wFc12drcXskVHhbXbrKAJPLvv9KXGXH5ALiKyxPcD8/";
...
// File: contracts/MyiPhoneNftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MyiPhoneNftContract is RamppERC721A {
    constructor() RamppERC721A("MyiPhoneNFT", "iPhn"){}
}
