...
contract FalineArena25 is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public cost = 14.90 ether;
  uint256 public maxSupply = 898;
  uint256 public maxMintAmountPerTx = 100;

  bool public paused = true;
  bool public revealed = false;

  constructor() ERC721("Faline Arena 25", "FA25") {
    setHiddenMetadataUri("ipfs://bafybeiducoafye33qkfpm5vaodbnuuuswxwruriyxjwzzzvonezhlxpv34");
  }
