            ...
            Base64Upgradeable.encode(
                bytes(
                    abi.encodePacked(
                        ...
                        '<polygon points="500,13 500,73 540,73 540,13" style="fill: #ff6624; filter: brightness(0.5);" />',
                        '<polygon points="773,180 773,280 700,280 700,180" style="fill: #ff6624; filter: brightness(0.5);" />',
                        originalImage,
                        '<polygon points="600,13 773,180 773,280 500,13" style="fill: #ff6624;" />',
                        '<text x="0" y="0" dominant-baseline="middle" text-anchor="middle" style="fill: black; font-size: 28px; transform: translate(660px,125px) rotate(45deg);">Lent</text>',
                        '</svg>'
                    )
                )
            )
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    Base64Upgradeable.encode(bytes(abi.encodePacked('{"animation_url":"', image, '"}')))
                )
            );
    }
}
    ...
    function _generateSVG(uint256 tokenId) internal view returns (string memory) {
            ...
            Base64Upgradeable.encode(
                bytes(
                    abi.encodePacked(
                        ...
                        originalImage,
                        '<polygon points="600,13 773,180 773,280 500,13" style="fill: #ff6624;" />',
                        '<text x="0" y="0" dominant-baseline="middle" text-anchor="middle" style="fill: black; font-size: 28px; transform: translate(660px,125px) rotate(45deg);">SubLent</text>',
                        '</svg>'
                    )
                )
            )
        ...
        return
            string(
                abi.encodePacked(
                    "data:application/json;base64,",
                    Base64Upgradeable.encode(bytes(abi.encodePacked('{"image":"', image, '"}')))
                )
            );
    }
}
