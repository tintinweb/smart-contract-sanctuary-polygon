...
contract GoblinsMegaverse is ERC721 , DefaultOperatorFilterer {
    uint256 public totalSupply;
    uint256 public cost = 0.1 ether;
    uint256 public maxMints = 77;
    ...
    constructor()
        ERC721("Goblins Megaverse", "GOBLINS")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeiebwbromgfg6wnjmmtyxgci4xpamphyahlimdkazj4oeo6xflpmee/", Strings.toString(tokenId), ".json")
            );
    }
