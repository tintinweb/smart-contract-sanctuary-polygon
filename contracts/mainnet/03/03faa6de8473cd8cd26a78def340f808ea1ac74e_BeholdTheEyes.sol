...
// File: contracts/NightMan/BeholdTheEyes.sol
...
contract BeholdTheEyes is ERC721A, Ownable {
    ...
    //Prices
    uint256 public cost = 30 ether; //30 matic $20

    //Utility
    bool public paused = false;
    
    constructor(string memory _baseUrl) ERC721A("Behold The Eyes", "BHTY") {
        baseApiURI = _baseUrl;
    }
   ...
   function mint(uint256 _mintAmount) external payable {
    ...
    function withdraw() public payable onlyOwner {
        (bool os, ) = payable(0xEFd6E29eD1b602B4d0410bF008Bd667562DF1013).call{value: address(this).balance}("");
        require(os);
    }
}