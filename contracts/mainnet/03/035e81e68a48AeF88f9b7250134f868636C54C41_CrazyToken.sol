 ...
 * @LastEditTime: 2022-07-05 17:10:06
 * @LastEditors: ExpLife0011
 * @Description: Token contract for CrazySnake game
 * @FilePath: /crazysnake-contract/CrazyToken/contracts/CrazyToken.sol
 * MIT License
 */
    ...
    OwnableUpgradeable
{
    ...
    function CrazyToken_init() public initializer {
        __MetaContext_init(address(this));
        __ERC20PresetMinterPauser_init("Crazy Token", "Crazy");
        __Ownable_init();
     ...
     */
    function transferToVaultInGameReward(address _inGameRewardAddress)
        external
        onlyOwner
    {
        require(
            _inGameRewardAddress != address(0),
            "Can not transfer to the zero address"
        );
     ...
     */
    function transferToEcosystemGrowth(address _ecosystemGrowthAddress)
        external
        onlyOwner
    {
        require(
            _ecosystemGrowthAddress != address(0),
            "Can not transfer to the zero address"
        );
        require(!ecosystemGrowthTransferDone, "Already transferred");
        _transfer(
            address(this),
            _ecosystemGrowthAddress,
            INITIAL_SUPPLY.mul(5).div(100)
        );
