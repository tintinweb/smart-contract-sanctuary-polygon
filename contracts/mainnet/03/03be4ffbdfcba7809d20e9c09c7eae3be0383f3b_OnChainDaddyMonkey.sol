...
// @title: OnChain Daddy Monkey
// @author: https://twitter.com/rataumicek
//
...
//   - all 10,000 OnChain Daddy Monkey are unique
...
// And did I say, OnChain Daddy Monkey?
...
// Bring on the OnChain Daddy Monkey!
contract OnChainDaddyMonkey is ERC721Enumerable, ReentrancyGuard, Ownable {
  using Strings for uint256;
  ...
  string[] private background = ["405","503","501","217","035","005","205","055","305","505"]; // only trait that is uniform, no need for rarity weights
  string[] private fur2 = ["800","a22","a52","841","d61","c83","b80","da2","fa6","639","fc0","000","088","48b","3c3","c18","f6b","f64","f40"];
  string[] private fur1 = ["532","feb","fdb","9e9","aec","653","b88","db8","fda","fec","ffd","322","bfa","fca","fab","764","744","8d8","da8"];
  ...
  string[] private clothes1 = ["35a","53a","83a","a38","a35","a53","123","113","213","313","312","311","355","345","435","535","9a2","29a","904","900","940","990","490","090","d02","d50","dc0","8d0","733","743","373","374","c38","c34","c73","cb3","8c3","4c3","73c","b3c","c34","c73","c89"];
  ...
  string[] private hat1 = ["170","073","076","057","017","307","047","077","074","070","470","770","c50","cb0","7c0","1c0","0c5","0cb","d20","d80","bd0","5d0","0d2","0d8","288","258","328","628","828","825","739","938","935","943","973","893",""];
  string[] private hat2 = ["4d2","2d6","2dc","29d","24d","62d","cc0","6c0","0c0","0c6","0cc","06c","f71","fe1","9f1","2f1","1f7","1fe","f31","fa1","df1","6f1","1f3","1fa","4ef","48f","54f","a4f","f4e","f48","94d","d4b","d47","d54","d94","bd4",""];  
  ...
  string[] private z = ['<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 500 500"><text x="2" y="35" style="fill:#3df;font-family:monospace;font-weight:800;font-size:45px">0nChain Daddy Monkey<animateMotion dur="5s" repeatCount="indefinite" path="M 498.132 3.63 L -0.165 3.099"/></text><text x="2" y="85" style="fill:#39f;font-family:monospace;font-weight:800;font-size:45px">0nChain Daddy Monkey<animateMotion dur="5s" repeatCount="indefinite" path="M -0.153 -0.115 L 499.467 -0.069"/></text><text x="2" y="135" style="fill:#33f;font-family:monospace;font-weight:800;font-size:45px">0nChain Daddy Monkey<animateMotion dur="5s" repeatCount="indefinite" path="M 498.132 3.63 L -0.165 3.099"/></text><text x="2" y="185" style="fill:#93f;font-family:monospace;font-weight:800;font-size:45px">0nChain Daddy Monkey<animateMotion dur="5s" repeatCount="indefinite" path="M -0.153 -0.115 L 499.467 -0.069"/></text><text x="2" y="235" style="fill:#f3f;font-family:monospace;font-weight:800;font-size:45px">0nChain Daddy Monkey<animateMotion dur="5s" repeatCount="indefinite" path="M 498.132 3.63 L -0.165 3.099"/></text><text x="2" y="285" style="fill:#f39;font-family:monospace;font-weight:800;font-size:45px">0nChain Daddy Monkey<animateMotion dur="5s" repeatCount="indefinite" path="M -0.153 -0.115 L 499.467 -0.069"/></text><text x="2" y="335" style="fill:#c24;font-family:monospace;font-weight:800;font-size:45px">0nChain Daddy Monkey<animateMotion dur="5s" repeatCount="indefinite" path="M 498.132 3.63 L -0.165 3.099"/></text><text x="2" y="385" style="fill:#517;font-family:monospace;font-weight:800;font-size:45px">0nChain Daddy Monkey<animateMotion dur="5s" repeatCount="indefinite" path="M -0.153 -0.115 L 499.467 -0.069"/></text><text x="2" y="435" style="fill:#715;font-family:monospace;font-weight:800;font-size:45px">0nChain Daddy Monkey<animateMotion dur="5s" repeatCount="indefinite" path="M 498.132 3.63 L -0.165 3.099"/></text><text x="2" y="485" style="fill:#712;font-family:monospace;font-weight:800;font-size:45px">0nChain Daddy Monkey<animateMotion dur="5s" repeatCount="indefinite" path="M -0.153 -0.115 L 499.467 -0.069"/></text><rect x="0" y="0" width="500" height="500" fill-opacity="98%" style="fill:#',
    ...
    '"/><circle cx="140" cy="230" r="65" style="fill:#', '"/><circle cx="140" cy="230" r="48" style="fill:#', '"/><circle cx="360" cy="230" r="65" style="fill:#',
    '"/><circle cx="360" cy="230" r="48" style="fill:#', '"/><rect x="110" y="110" width="280" height="250" rx="15" ry="450" style="fill:#', '"/><rect x="125" y="125" width="250" height="200" rx="55" ry="450" style="fill:#',
    '"/><rect x="160" y="175" width="75" height="85" rx="45" ry="45" style="fill:#fff"/><rect x="265" y="175" width="75" height="85" rx="45" ry="45" style="fill:#fff"/><circle cx="200" cy="220" r="20" style="fill:#',
    '"/><circle cx="300" cy="220" r="20" style="fill:#', '"/><circle cx="200" cy="220" r="7" style="fill:#fff"/><circle cx="300" cy="220" r="7" style="fill:#fff"/>',
    '<path d="M 152.008 374.303 L 152.176 263.619 L 347.433 264.011 L 346.932 375.058 L 339.974 389.976 L 160.007 390.054 Z" style="fill:#a52"/><rect x="160" y="270" width="180" height="120" style="fill:#',
    ...
    '</svg>'];
  string private cross='<rect x="95" y="255" width="10" height="40" style="fill:#872"/><rect x="85" y="265" width="30" height="10" style="fill:#872"/>';
  ...
  string private hh1='<path d="M 123.376 110.738 C 123.046 58.394 148.53 42.364 186.727 40.141 L 308.039 40.002 C 344.604 39.23 376.923 60.764 376.218 110.36 L 350.038 139.025 L 149.997 138.982 Z" style="fill:#';
  string private hh2='"/><path d="M 149.998 138.983 C 154.596 65.386 158.649 44.542 250.132 39.91 C 334.555 46.229 342.663 59.55 350.038 139.026 C 290.54 151.054 216.988 153.95 150.387 138.313 Z" style="fill:#';
  ...
  string private ey2='"/><rect x="265" y="190" width="75" height="15" style="fill:#';
  string private ey3='<rect x="160" y="235" width="180" height="50" style="fill:#';
  string private zz='"/>';
  string private ea1='<circle cx="100" cy="270" r="14" style="fill:#';
  string private ea2='fe7';
  string private ea3='999';
  string private ea4='"/><circle cx="100" cy="270" r="4" style="fill:#000"/>';
  string private ea5='<circle cx="100" cy="270" r="12" style="fill:#';
  ...
  string private co1=', ';
  string private rl1='{"name": "OnChain Daddy Monkey #';
  string private rl3='"}';
  string private rl4='data:application/json;base64,';

  struct Ape { // a nod to BAYC, "ape" was shorter to type than Onchain Daddy Monkey
    uint8 bg;
    uint8 fur;
    uint8 eyes;
    uint8 mouth;
  ...
  constructor() ERC721("OnChain Daddy Monkey", "OCDM") Ownable() {mint(msg.sender, 20);}
