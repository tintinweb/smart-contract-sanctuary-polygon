...
contract DIGIKITs is ERC721A, Ownable, ReentrancyGuard{
    uint256 public constant maxSupply = 900;

    constructor() ERC721A("DIGIKITs", "DIGIKIT") {
    }

    // Mint for Dev
    function devMint() external onlyOwner {
        require(totalSupply() < maxSupply, "ALREADY MINTED.");
