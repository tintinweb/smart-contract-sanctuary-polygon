...
// File: contracts/StakingMultiRewardsV2.sol
...
contract MultiRewardsDistributionRecipientV2 {
  ...
  function setRewardsDistribution(address newRewardsDistribution) external onlyRewardsDistribution  {
    rewardsDistribution = newRewardsDistribution;
  }
}

contract StakingMultiRewardsV2 is IStakingMultiRewards, MultiRewardsDistributionRecipientV2, ReentrancyGuard {
  using SafeMath for uint256;
