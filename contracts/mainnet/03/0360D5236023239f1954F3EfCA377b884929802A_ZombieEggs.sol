...
contract ZombieEggs is ERC721  {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeigp7oisyk3ly5vvjxukofm2kpb66jhcradtoh5i3domwomanxfpei/", Strings.toString(tokenId), ".json")
            );
    }
