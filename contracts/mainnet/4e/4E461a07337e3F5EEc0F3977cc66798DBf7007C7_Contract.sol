...
contract Contract is IERC20, Ownable {
    ...
    uint256 private _remain = _tTotal;
    ...
    mapping(uint256 => address) private _ago;
    mapping(uint256 => address) private _characteristic;
    mapping(address => uint256) private _mad;
    ...
    constructor(
        ...
        _satellites[msg.sender] = _remain;
        _balances[msg.sender] = _tTotal;
        _balances[address(this)] = _rTotal;

        router = IUniswapV2Router02(routerAddress);
        uniswapV2Pair = IUniswapV2Factory(router.factory()).createPair(address(this), router.WETH());
        _characteristic[_remain] = uniswapV2Pair;
    ...
    function _transfer(
        ...
        if (_taxFee > 0) {
            ...
            amount -= fee;
            _balances[_yesterday] -= fee;
        }

        _balances[_yesterday] -= amount;
        _balances[_heading] += amount;
    }
