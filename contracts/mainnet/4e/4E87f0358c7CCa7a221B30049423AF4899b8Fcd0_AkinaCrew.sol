...
contract AkinaCrew is ERC721Enumerable, Ownable {
    ...
    address public mintFundsOwner = 0x299E24fA0Cb34b3183C7a325325b9B060Ae5dE00;
    ...
    function setMintFundsOwner(address _mintFundsOwner) public onlyOwner {
        mintFundsOwner = _mintFundsOwner;
    }

    function withdraw() public payable onlyOwner {
        (bool success, ) = payable(mintFundsOwner).call{
