    ...
    OwnableUpgradeable
{
    ...
    function rentMiner(address referral) public payable nonReentrant {
        ...
        require(_isDepositEnough(maticAmount), "you need to send enough Matic");
    ...
    function feedMiner(uint256 _minerIndex) public payable nonReentrant {
        ...
        uint256 maticSentForFeeding = msg.value;
        require(
            _isFeedingDepositEnough(maticSentForFeeding) && canFeed,
