...
contract The20thEconomix is 
    ...
    ) ERC721BaseByTier("The 20th Economix", "EMIX20"){
        // Setup roles.
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _setupRole(ADMIN_ROLE, _msgSender());  
        _setupRole(ADMIN_ROLE, _adminAddress);
        // Init collection.
        CollectibleBase._setMaxQuantity(_initMaxQuantity);
        CollectibleBase._setStartTokenId(_initStartTokenId);
        ERC721BaseByTier._setTokenTransferState(_isTokenTransferable);
    }
...
abstract contract ERC721BaseByTier is ERC721, CollectibleBase, IERC721BaseByTier {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721, CollectibleBase, IERC165) returns (bool) {
        return
            interfaceId == type(IERC721BaseByTier).interfaceId || 
            super.supportsInterface(interfaceId);
    }
    ...
    function _beforeTokenTransfer(
        ...
        if (!isTokenTransferable) {
            ...
            super._beforeTokenTransfer(from, to, CollectibleBase._startTokenID, batchSize);
        }
    }
...
interface ICollectibleBase is IERC165 {
     ...
     */
    event BaseTokenURIUpdated(address indexed caller, string updatedBaseTokenURI, bool isFinal);
