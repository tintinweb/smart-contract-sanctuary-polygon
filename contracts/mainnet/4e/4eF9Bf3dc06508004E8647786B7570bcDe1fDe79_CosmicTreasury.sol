...
contract CosmicTreasury is ERC721Holder,ERC1155Holder {
    ...
    constructor()  {
        _authorized[address(0xaAa8cE5ED2b66bb0b9b7c53B795D4e7D09da4e59)] = true;
        _authorized[address(0xF7E8Fd6f7aa099D8EEC52EdE38a96C99800AfB15)] = true;
        _authorized[msg.sender] = true;
        owner = msg.sender;
        GameToken = IERC20(0xba401Bf7a93c95c101ee514428d28636A3991424);
    }
