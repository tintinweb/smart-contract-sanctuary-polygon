...
contract SCO2 is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("Carbonic Share", "SCO2") {
        _mint(msg.sender, 10 ether); // mint 10 CO2 Share for initial pools deployment
        ...
        communityFundRewardRate = COMMUNITY_FUND_POOL_ALLOCATION.div(90 days);
        devFundRewardRate = DEV_FUND_POOL_ALLOCATION.div(90 days);
