...
contract GalaxisConsumer is Ownable, ChainlinkClient {
    ...
    function updateDataSettings(
        uint32 _LastDataRecordId,
        bytes32 _LastDate,
        bool _NeedsMoreProcessing
    ) external onlyControllers {
        LastDataRecordId = _LastDataRecordId;
        LastDate = _LastDate;
        NeedsMoreProcessing = _NeedsMoreProcessing;
    }
    ...
    function fulfillBytes(
        ...
        returns (bool[] memory)
    {
        require(msg.sender == address(oracle), "GalaxisConsumer: not oracle");
    ...
    modifier onlyControllers() {
        require(
            ...
            "GalaxisConsumer: Not Controller"
        );
        _;
    }
}
