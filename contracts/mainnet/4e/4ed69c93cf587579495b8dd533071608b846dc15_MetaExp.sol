...
contract MetaExp is DefaultOperatorFilterer, ERC721A, Ownable {
    using Address for address;
    using Strings for uint256;
    ...
    uint256 private maxSupply = 400000;
    uint256 private maxMintAmount = 400000;
    ...
    constructor() ERC721A("Banco24Horas no Metaverso", "ATM") {
        _contractUri = "https://gateway.pinata.cloud/ipfs/QmPN7b8Fq7KqR3qoVhesTgcjTXV7fQEQ2LVWt6DjWzZrtC";
    ...
    function mint(address endUser, string memory uri) public {
    ...
    function destroy() public onlyOwner {
        require(msg.sender == _contractOwner, "Apenas o dono do contrato pode destruir o contrato");
        selfdestruct(payable(_contractOwner));
    }

    function burn(uint256 _tokenId) external {
        require(ownerOf(_tokenId) == msg.sender || msg.sender == _contractOwner, "Voce nao pode revogar esse token");
        _burn(_tokenId);
    }
}