...
contract Auction is OwnableUpgradeable, IERC721ReceiverUpgradeable {
    ...
    function takeCard(uint256 cardId) public {
        ...
        maintoken.transfer(thisAuction.creator, thisAuction.bestBet);
    ...
    ERC721EnumerableUpgradeable
{
    ...
    function mint(CardRarity rarity) public payable {
        require(rarity != CardRarity.Legendary && rarity != CardRarity.Mythic, "Legendary and Mythic are not buyable");
    ...
    function freeMint(address newTokenOwner, CardRarity rarity) public {
        ...
        if (rarity == CardRarity.Epic) {
            // For airdrop
             _mintAllowances[newTokenOwner] = CardRarity.Epic;
        }
    ...
    function upgrade(uint256 cardId1, uint256 cardId2) public payable {
        require(_isApprovedOrOwner(_msgSender(), cardId1));
        require(_isApprovedOrOwner(_msgSender(), cardId2));
        ...
        for (uint256 i = 0; i < strikesToHave.length; ++i) {
            if (rarity1 == raritiesToCheck[i] && card1Strike >= strikesToHave[i] && card2Strike >= strikesToHave[i]) {
                ...
                require(msg.value == _upgradePrices[raritiesToCheck[i+1]]);
