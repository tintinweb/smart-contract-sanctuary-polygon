...
contract ChainlinkRandoms is Randoms, Pausable, AccessControl, VRFConsumerBase {
    using SafeERC20 for IERC20;

    bytes32 public constant GETTER = keccak256("GETTER");
    ...
    function requestRandomNumber() external whenNotPaused {
        require(hasRole(GETTER, msg.sender), "Sender cannot request seed");
