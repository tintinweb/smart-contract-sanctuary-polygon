...
library MarketPlaceBorrowerLib {
    ...
    function _borrowTokensFromPool(
        ...
        console.log("Yahan borrow sy pehel");
        console.log(
            IERC20Metadata(xToken).balanceOf(address(this)),
            "X token balance in MPBL"
        );
        ...
        console.log("Yahan borrow k bad");
    ...
    function _repayToCustomVault(
        ...
        console.log(
            IERC20(stakeToken).balanceOf(_storageParams.poolToBorrowFrom),
        ...
        console.log("lastprofitofgauge", lastprofitofgauge);
