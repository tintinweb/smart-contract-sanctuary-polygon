...
contract AirDropper is Ownable, ERC1155Holder {
    ...
    function setTokenData(address _contractAddress, uint256 _tokenId)
        public
        onlyOwner
    {
        tokenId = _tokenId;
    ...
    function showBalance(address _address) public view returns (uint256) {
        uint256 currentBalance = currentToken.balanceOf(_address, tokenId);
        return currentBalance;
    }

    function testAddressArray(address[] memory _addresses) public pure {}
