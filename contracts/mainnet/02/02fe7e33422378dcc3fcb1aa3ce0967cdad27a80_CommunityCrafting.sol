...
contract CommunityCrafting {
    ...
    function payOut(uint sff, address owner) public payable {
        ...
        // WETH
        path[1] = 0x955d0ED59150fcF86c331a0Ba517ea9DaBE56CA3;
        ...
        ERC20(0x955d0ED59150fcF86c331a0Ba517ea9DaBE56CA3).transferFrom(msg.sender, address(this), values[1]);
        // Approve the router just in case
        ERC20(0x955d0ED59150fcF86c331a0Ba517ea9DaBE56CA3).approve(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff, values[1]);

        (uint amountToken, uint amountETH, uint liquidity) = uniswapV2Router.addLiquidityETH{ value: values[0] }(
            0x955d0ED59150fcF86c331a0Ba517ea9DaBE56CA3,
