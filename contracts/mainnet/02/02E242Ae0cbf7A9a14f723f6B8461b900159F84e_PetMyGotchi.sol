...
contract PetMyGotchi is TokenRecover {
    ...
    function addParent() external payable{
        ...
        uint256 _pricePerPetPerDay = getPricePerPetPerDayForParent(msg.sender);

        require(parent_balance[msg.sender] >= _pricePerPetPerDay || msg.value >= _pricePerPetPerDay, "Please send some funds!");
