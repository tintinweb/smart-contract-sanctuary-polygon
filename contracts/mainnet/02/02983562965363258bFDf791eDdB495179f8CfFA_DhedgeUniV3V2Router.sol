...
contract DhedgeUniV3V2Router is IUniswapV2RouterSwapOnly, Ownable {
  ...
  constructor(IUniswapV3Factory _uniV3Factory, IV3SwapRouter _uniV3Router) Ownable() {
  ...
  function swapExactTokensForTokens(
    ...
    require(amountOut == amountsOut[path.length - 1], "too much slippage");
  }
  ...
  function swapTokensForExactTokens(
    ...
    require(amountIn == amountsIn[0], "too much slippage");
  }
