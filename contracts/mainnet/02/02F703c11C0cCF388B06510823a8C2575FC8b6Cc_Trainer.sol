...
contract Trainer is ITrainer, Ownable {
    ...
    mapping(address => uint256[ATTRIBUTE_COUNT]) public trainersLuchadores;
    mapping(address => address[ATTRIBUTE_COUNT]) public trainersUserWhitelist;
    ...
    function luchadoresInTrainer(address trainerOwner) public view returns (uint256[ATTRIBUTE_COUNT] memory) {
        return trainersLuchadores[trainerOwner];
    }

    function trainerWhitelist(address trainerOwner) public view returns (address[ATTRIBUTE_COUNT] memory) {
