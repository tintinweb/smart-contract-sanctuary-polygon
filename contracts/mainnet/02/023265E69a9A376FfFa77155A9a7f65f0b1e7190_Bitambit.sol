...
contract Bitambit {
    ...
    constructor( address payable _ownerwallet) public {
		primaryAdmin = 0xF4a3EB9EAfAA3AE3958ac453e22Fb0Fee2866b50;
        deployer =_ownerwallet;
    ...
    function join(address registeruser,address referrer,uint256 joiningamount) public {
        require(primaryAdmin==msg.sender||deployer==msg.sender, 'Admin what?');
