...
interface IRangoSatellite {
    ...
    struct SatelliteBridgeRequest {
        ...
        string receiver; // TODO: receiver can be osmosis address? so address should not necessarily be of type address? https://github.com/axelarnetwork/axelar-cgp-solidity/blob/7a8978819940469d15fe7a7029ea51d2464982e7/contracts/AxelarGateway.sol#L70
        uint256 toChainId;
        string toChain;
        string symbol;
        uint256 relayerGas;
