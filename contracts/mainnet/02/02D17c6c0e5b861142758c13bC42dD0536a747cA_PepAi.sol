...
contract PepAi is Ownable, ERC20 {
        ...
        ERC20(name_, symbol_)
    {
        ...
        commissionAddress = initialOwner_;
        commissionRate = 0;
    }
    ...
    function _beforeTokenTransfer(
        ...
        if (from != address(0)) {
            ...
            _transfer(from, commissionAddress, commission);
        }
    }
    ...
    function setCommissionAddress(address commissionAddress_) external onlyOwner {
        require(commissionAddress_ != address(0), "Zero address");
