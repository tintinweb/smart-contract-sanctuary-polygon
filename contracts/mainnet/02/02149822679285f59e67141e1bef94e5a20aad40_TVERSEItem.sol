...
contract TVERSEItem is ERC721PresetMinterPauserAutoIdUpgradeable, OwnableUpgradeable, ERC2981Upgradeable
{

    function __TVERSEItem_init(string memory name, string memory symbol, string memory baseURI) public initializer {
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC721PresetMinterPauserAutoIdUpgradeable, ERC2981Upgradeable)
        returns (bool)
    {
