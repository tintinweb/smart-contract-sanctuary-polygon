...
contract StadiusNFT is ERC721Enumerable {
    ...
    constructor(
        ...
        tokenCounter = 1;
        owner = msg.sender;
        addUserAddressToWhitelist(msg.sender);
    }
    ...
    function mint(address recipient, string memory _tokenURI) public isWhitelisted(msg.sender) {
