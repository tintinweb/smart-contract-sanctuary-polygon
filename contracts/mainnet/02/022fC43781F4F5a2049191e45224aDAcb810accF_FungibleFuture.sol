...
contract FungibleFuture {
    ...
    function listFuture(uint256 _tokenId) external {
        ...
        considerationitems[0] = ISeaport.ConsiderationItem({
            ...
            startAmount: 975000000000000000, //done
            endAmount: 975000000000000000 , //done
            recipient: payable(address(this)) //????????????? polygon fee collector?????
        });
        ...
        considerationitems[1] = ISeaport.ConsiderationItem({
            ...
            token:  ZERO_ADDRESS, //done
            identifierOrCriteria:0, //done
            startAmount: 25000000000000000, //done
            endAmount: 25000000000000000 , //done
