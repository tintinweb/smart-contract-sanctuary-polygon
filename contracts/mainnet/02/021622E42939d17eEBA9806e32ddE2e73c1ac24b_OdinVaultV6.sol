...
import "../interfaces/beefy/IStrategy2.sol";
 ...
 */
contract OdinVaultV6 is ERC20, Ownable, ReentrancyGuard {
    ...
    function balance() public view returns (uint256) {
        return want().balanceOf(address(this)).add(IStrategy2(strategy).balanceOf());
    }
    ...
    function proposeStrat(address _implementation) public onlyOwner {
        require(address(this) == IStrategy2(_implementation).vault(), "Proposal not valid for this Vault");
    ...
    function upgradeStrat() public onlyOwner {
        ...
        strategy = IStrategy2(stratCandidate.implementation);
