...
contract LifeSaviorToken is Context, IERC20, Ownable {  
    ...
    string private _name = "Life Savior Token";
    ...
    constructor () public {
        ...
        marketingwallet = 0xAa894f0528EDE4b9f8BB54fB1dcF83A61E3eba26;
        submarketingWallet= 0xB3B2d5377f43A8f6f52BDe526cA3269fb42bfdBB;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 SplitMATICBalance = Balance.div(_marketingPer.add(_RewardPer));
        uint256 MarketingMATIC=SplitMATICBalance=SplitMATICBalance*_RewardPer;
        uint256 SubMarketing = MarketingMATIC.mul(5).div(100);
        uint256 Marketing = MarketingMATIC.sub(SubMarketing);
