...
// File contracts/Jewellery Shares.sol

pragma solidity 0.6.12;

contract Diamond is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 70,000 DIAMOND
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("Jewellery Shares", "DIAMOND") {
        _mint(msg.sender, 2 ether); // mint 2 DIAMOND Share for initial pools deployment
