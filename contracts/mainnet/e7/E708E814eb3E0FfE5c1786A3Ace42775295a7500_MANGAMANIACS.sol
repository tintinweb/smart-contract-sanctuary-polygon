...
contract MANGAMANIACS is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    uint256 public maxSupply = 2500;
    
    uint256 public PRICE = 10 ether;
    uint256 public WHITELIST_SALE_PRICE = 7 ether;
    ...
    constructor() ERC721A("MANGA MANIACS", "MM") {}
...
/// @dev White-listed mint
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x4efd4Ac73Af167962B056D58A37100D5a5E9A69A).call{value: address(this).balance * 40 / 100}("");
    require(hs);
    // =============================================================================
