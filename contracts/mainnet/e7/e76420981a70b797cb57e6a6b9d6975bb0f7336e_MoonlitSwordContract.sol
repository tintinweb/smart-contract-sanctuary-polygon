...
contract MoonlitSwordContract is ERC721, ERC721URIStorage, Ownable {
    uint256 price = 0 ether; 
    using Counters for Counters.Counter;
    Counters.Counter private _totalTokens;
    string private baseURI = "https://tradingwarriors.net/moonlitsword/";
    ...
    constructor() ERC721("Moonlit Sword", "MLS") {
    ...
    function mint() public payable {
        ...
        uint256 tokenId =  _totalTokens.current();
