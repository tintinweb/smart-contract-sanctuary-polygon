...
contract AInime is ERC721, Ownable  {
    ...
    uint256 private constant TOKENS_RESERVED = 1; // Reserved for Cosmos
    ...
    constructor() ERC721("AInime", "AINM") {
        baseUri = "ipfs://bafybeid5ffupq56t7jga52bdcwcajukx22akmiu55q2dovctj3die4j77a/"; //unreavealed metadata
        for(uint256 i = 1; i <= TOKENS_RESERVED; ++i) {
            _mint(0x1682E9378002D0623f0d4eF25C018C73AE098eDb, i); // Transfer the first NFT to Cosmos, only at launch.
        }
