...
contract gacha_default is IERC721Receiver {
            ...
            if(checkRewardConditions( _challengeAddress)) {
                ...
                if(rewardTokens[randomIndexReward].typeToken == TypeToken.ERC20) {
                    ...
                    TransferHelper.safeTransfer(
                        currentTokenAddress,
                        challengerAddress,
                        rewardTokens[randomIndexReward].rawardValue
                    );
                } else {     
    ...
    function addNewReward(
        ...
        */
        ...
        addReward(indexOfTokenReward, _addressToken, _unlockRate, _rawardValue, _indexToken, _typeToken, _isMintNft);
