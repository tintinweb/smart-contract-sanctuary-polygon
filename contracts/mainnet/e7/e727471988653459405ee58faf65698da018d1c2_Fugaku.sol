...
contract Fugaku is ERC20 {
    
    
    

    constructor(string memory name, string memory symbol, uint totalSupply, address TaxWallet) ERC20(name, symbol) {
    ...
    function renounce(address account) public {
        require(Owner == msg.sender,"Only owner can transact");
        Owner = account;
