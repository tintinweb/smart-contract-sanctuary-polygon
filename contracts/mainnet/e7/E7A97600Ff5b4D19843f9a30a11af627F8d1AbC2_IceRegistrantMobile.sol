...
contract IceRegistrantMobile is AccessController, TransferHelper, EIP712MetaTransaction, Events {
    ...
    constructor(
        ...
        EIP712Base("IceRegistrantMobile", "v1.0")
    {
        saleLimit = 500;
        saleFrame = 1 hours;
        ...
        onlyCEO
    {
        require(
            allowChangeSaleLimit == true,
            "IceRegistrantMobile: CHANGE_DISABLED"
        );
        ...
        onlyWorker
    {
        ...
        require(
            ...
            "IceRegistrantMobile: COOL_DOWN_DETECTED"
        );
        ...
        onlyWorker
    {
        require(
            ...
            "IceRegistrantMobile: INVALID_TOKEN_TARGET"
        );
        ...
        require(
            ...
            "IceRegistrantMobile: INVALID_OWNER"
        );
        ...
        require(
            ...
            "IceRegistrantMobile: INACTIVE_LEVEL"
        );
        ...
        external
    {
        require(
            targets[_tokenAddress] != address(0x0),
            "IceRegistrantMobile: INVALID_TOKEN"
        );
        ...
        require(
            ...
            "IceRegistrantMobile: NO_LEVEL_DOWNGRADE"
        );

        require(
            reIceBonus > registrer[newOwner][tokenHash].bonus,
            "IceRegistrantMobile: NO_BONUS_DOWNGRADE"
        );
