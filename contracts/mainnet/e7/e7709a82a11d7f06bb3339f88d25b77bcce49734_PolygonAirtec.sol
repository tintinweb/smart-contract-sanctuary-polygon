...
contract PolygonAirtec is IERC20
{
    ...
    address constant public owner=0xb4277d928e1eFC26cD876113b01Bd90A5bDbA21B;
    address constant public marketingAddress=0xb4277d928e1eFC26cD876113b01Bd90A5bDbA21B;
    address constant public vipCommunity=0xb4277d928e1eFC26cD876113b01Bd90A5bDbA21B;
    ...
    uint TotalUser = 0;
    uint VIPCommunityPercentage = 0;
    uint MarketingFeePercentage = 0;
    uint _initialCoinRate = 10000001;
    ...
    function WithdrawMatic(uint256 weiAmount) external onlyInitiator{
        require(address(this).balance >= weiAmount, "insufficient Matic balance");
    ...
    constructor(address _dep, address _initiator)
    {
        _name = "Polygon Airtec";
        _symbol = "ATH";
