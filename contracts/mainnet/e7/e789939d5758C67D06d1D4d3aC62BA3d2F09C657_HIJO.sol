...
contract HIJO is ERC1155, AccessControl, Pausable, ReentrancyGuard, ERC1155Burnable, ERC1155Supply, Ownable, ERC2981ContractWideRoyalties {

  /// The public name of this contract.
    string public constant name = "Hijo";
    string public constant symbol = "Hijo";
    ...
    constructor() ERC1155("https://tokens.likida.io/hijo/{id}.json") {
        ...
        // Token limit
        tokenSupply[1] = 70;
        tokenPrice[1] = 60*10**18;
        tokenSupply[2] = 1;
        tokenPrice[2] = 36*10**18;
        tokenSupply[3] = 1;
        tokenPrice[3] = 36*10**18;
        tokenSupply[4] = 1;
        tokenPrice[4] = 36*10**18;
        tokenSupply[5] = 1;
        tokenPrice[5] = 36*10**18;
        tokenSupply[6] = 1;
        tokenPrice[6] = 36*10**18;
        tokenSupply[7] = 1;
        tokenPrice[7] = 36*10**18;
        tokenSupply[8] = 1;
        tokenPrice[8] = 36*10**18;

        mint(0x051149ECC5e1605293764bFB27171D2CaaE1F92C, 1, 20, "");


        likidaAddress = 0x8991DCBB8865888c200D906a9abaAd61110cBC35;
        setAdminAddress(0x051149ECC5e1605293764bFB27171D2CaaE1F92C);
    }

    // Likida PS functions
    function setAdminAddress(address _newAddress) public onlyRole(ADMIN_ROLE){
        require(_newAddress != address(0), "Cant be set to address 0");
        adminAddress = _newAddress;
        setRoyalties(_newAddress, 700);
    }
    ...
    function tokenMint(uint256 _id) public payable nonReentrant whenNotPaused {
        ...
        uint256 amountLikida = (msg.value*31)/1000;
        payable(likidaAddress).transfer(amountLikida);
        payable(adminAddress).transfer(msg.value-amountLikida);
