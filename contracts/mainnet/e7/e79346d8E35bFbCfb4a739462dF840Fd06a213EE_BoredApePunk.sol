...
contract BoredApePunk is ERC721 {
    uint256 public totalSupply;
    uint256 public cost = 0.09 ether;
    uint256 public maxMints = 999;
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://QmaCaehaJzSStcypKGbLffmVtA5sR54YM12Z8BgLtjY2Kb/", Strings.toString(tokenId), ".json")
            );
    }
