...
contract Distributor is IDistributor, DiatomAccessControlled {
    /* ========== DEPENDENCIES ========== */
    ...
    constructor(
        ...
        require(_diat != address(0), "Zero address: OHM");
        diat = IERC20(_diat);
    ...
    function nextRewardAt(uint256 _rate) public view override returns (uint256) {
        return diat.totalSupply().mul(_rate).div(rateDenominator);
    }
