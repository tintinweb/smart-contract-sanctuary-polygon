...
contract Kekemons is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("Kekemons", "KEK") {
    customBaseURI = customBaseURI_;

    allowedMintCountMap[owner()] = 9000;
  }
