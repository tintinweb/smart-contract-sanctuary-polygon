...
/*[ PRESET VARIABLES ]------------------------------------------------------------------------------------------------------------------*/
    address public TOKENaddy = address(0x8f3Cf7ad23Cd3CaDbD9735AFf958023239c6A063);     /* TOKEN address                                */
    address public cTOKENaddy = address(0x4eCEDdF62277eD78623f9A94995c680f8fd6C00e);    /* cTOKEN address                               */
    uint256 public decimals = 1000000000000000000;                  /* The Tokens Decimal format                                        */
    uint256 public ticketPrice = 10000000000000000000;              /* The Required Deposit Amount to be given a Ticket                 */
    bytes32 public tokenName = "DAI";                               /* TOKEN name                                                       */
