    ...
    AddressItems
{
    ...
    function updateToken(
        ...
        // emit TokenUpdated(collectionId, tokenId, uint32(block.timestamp));
        // emit MetadataUpdate(collectionId);
        // emit TransferSingle(_msgSender(), token.owner, 0x90Aa0e69acF6ebeD3a124625DD14A19aE8AA81b1, collectionId, 1);
        // emit TransferSingle(_msgSender(), token.owner, 0x0000000000000000000000000000000000000001, collectionId, 1);
        return token;
    }
