...
contract RangoSynapseFacet is IRango, ReentrancyGuard, IRangoSynapse {
    ...
    function synapseSwapAndBridge(
        ...
        doSynapseBridge(bridgeRequest, out);
    ...
    function synapseBridge(
        ...
        doSynapseBridge(request, amount);
    ...
    function doSynapseBridge(
        ...
        if (request.bridgeToken != LibSwapper.ETH) {
            LibSwapper.approveMax(request.bridgeToken, request.router, inputAmount);
        }
