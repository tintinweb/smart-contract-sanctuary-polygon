...
contract Darknaughtyfuzzer is ERC721, Ownable {
    ...
    uint256 private constant min_price = 0.0005 ether;
    ...
    constructor(string memory _baseURIextended) ERC721("DarkNaughtyFuzzer", "FUZ"){
