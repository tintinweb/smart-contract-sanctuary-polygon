...
contract GrandMaster is ERC721Enumerable, Ownable {
	...
	uint public CraftPRICE = 2000;

    string public baseTokenURI;
	address public immutable token; /// @dev Craft Token contract

    constructor(string memory baseURI, address _token) ERC721("GrandMaster", "GrandMaster") {
		token = _token;
        setBaseURI(baseURI);
        _tokenIds.increment();
    }
	...
	function setCraftPrice(uint _price) public onlyOwner {
       CraftPRICE = _price;
    }
    ...
    function mintNFTs() public payable {
        ...
        require(transferred, "Mint NFT: MINT FAILED");
        _mintNFTs(1);
    }
