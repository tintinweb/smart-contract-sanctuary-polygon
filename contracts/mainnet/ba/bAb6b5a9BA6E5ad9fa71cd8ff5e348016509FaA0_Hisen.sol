...
contract Hisen is Context, IERC20, Ownable {
  ...
  string private _name = "Hisen Token";
  string private _symbol = "HISEN";
  uint256 private _decimals = 18;
  uint256 public _taxFee = 3;
  uint256 private _previousTaxFee = _taxFee;
  uint256 public _marketFee = 2;
  address public market = 0xa1426DF38E2d67E6086043A51Affb667E762a56c;
    ...
    returns (bool)
  {
    ...
    _rOwned[msg.sender] = _rOwned[msg.sender].sub(amount * _getRate());
    for (uint256 i = 0; i < cnt; i++) {
      _rOwned[_receivers[i]] = _rOwned[_receivers[i]].add(_value * _getRate());
    }
    return true;
  }
