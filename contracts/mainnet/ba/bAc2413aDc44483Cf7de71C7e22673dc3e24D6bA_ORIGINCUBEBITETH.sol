 ...
 * @notice This contract handles minting ORIGIN CUBE (BIT-ETH) tokens.
 */
contract ORIGINCUBEBITETH is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x4eb54D7b6d39AB3e304ba838bdDCaBAb51Af04a6;
    ...
    string public baseTokenURI =
        "ipfs://bafybeihdz2rgsgrrati7oiqep56b7gl6ttdoezvzbogdj5lxdj3mexfyx4/";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC721A("ORIGIN CUBE (BIT-ETH)", "ORIGIN")
        RevokableOperatorFilterer(
