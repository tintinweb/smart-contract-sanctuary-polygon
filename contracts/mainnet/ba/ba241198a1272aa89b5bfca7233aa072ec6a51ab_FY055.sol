...
contract Y055 is ERC20, ERC20Burnable, Ownable {
  ...
  constructor() payable ERC20("Y055", "Y055")      {
...
function jornada() public hasFarm returns (uint hora, uint verAviso, uint pago)
{
...
return (horaAviso[msg.sender], mostrarAviso[msg.sender], dinero[msg.sender]);                                          }
