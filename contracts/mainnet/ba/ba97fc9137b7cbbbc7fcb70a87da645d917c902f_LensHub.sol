 ...
 *
 * @custom:version v1.3
 * @custom:git-commit 920aeb0fe29ef0bb0f9bc20c43ced88b20dba0fd
 *
 ...
 */
contract LensHub is LensNFTBase, LensMultiState, LensHubStorage, ILensHub {
     ...
     * @param tokenGuardianCooldown The delay in seconds required for the token guardian disabling to take effect.
     */
    constructor(
    ...
    /**
     * NOTE: This function was temporarily removed for safety reasons until V2 is deployed with DE features.
     */
    function permit(
        address, /* spender */
        uint256, /* tokenId */
    ...
    /// @inheritdoc ILensHub
    function getTokenGuardianDisablingTimestamp(address wallet)
        external
        view
        override
        returns (uint256)
 ...
 * @author Lens Protocol
 *
 * @custom:git-commit 6398176b0abdb33496a301d46abcdcc62cbfa0be
 *
...
library InteractionLogic {
    ...
    function follow(
        ...
        for (uint256 i = 0; i < profileIds.length; ) {
            ...
            if (
                _profileIdByHandleHash[keccak256(bytes(handle))] != profileIds[i] ||
                profileIds[i] == 0
...
abstract contract LensMultiState {
    uint256 internal _lastInitializedRevision; // Slot 11
...
abstract contract LensHubStorage {
    ...
    // Added in Lens V1.3 for Profile Locking feature
