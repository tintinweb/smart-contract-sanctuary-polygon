...
contract HolaMetaversoSpeaker is ERC721A, Ownable{
    ...
    constructor(address _wallet, string memory _speakerURI) ERC721A("Hola Metaverso Los Angeles 2022 Speaker", "HOLASPKR"){
        baseTokenUri = _speakerURI;
       _safeMint(_wallet, 26);
    }
