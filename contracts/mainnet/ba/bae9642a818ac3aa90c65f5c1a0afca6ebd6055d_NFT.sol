...
contract NFT is ERC721Enumerable, Ownable {
  ...
  uint256 public maxMintAmount = 150; //количество нфт которое будет сминчено при деплое смарт контракта
  uint256 public nftPerAddressLimit = 1000; //максимальное колечество нфт которое может сминтить 1 адрес
