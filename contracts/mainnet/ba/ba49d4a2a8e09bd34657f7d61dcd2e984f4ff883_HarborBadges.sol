...
contract HarborBadges is ERC1155, Ownable, ERC1155Supply {
    ...
    modifier batchMintable(uint256[] memory ids) {
      require(mintActive, "HarborBadges: Minting paused.");
    ...
    function mintBatch(address to, uint256[] memory ids, uint256[] memory amounts, bytes memory data) public batchMintable(ids) {
