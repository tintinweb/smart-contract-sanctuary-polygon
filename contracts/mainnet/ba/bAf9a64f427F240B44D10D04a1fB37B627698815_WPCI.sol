...
contract WPCI is WPCIDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private WPCITeam;
    address private CharityWPCI;
    ...
    string public override name = "Wrapped Paycoin";
    string public override symbol = "WPCI";
    ...
    constructor(uint totalSupplyValue, address WPCITeamAddress, address CharityWPCIAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        WPCITeam = WPCITeamAddress;
        CharityWPCI = CharityWPCIAddress;
        
        // split the tokens according to agreed upon percentages
        balances[WPCITeam] =  totalSupply * 4 / 100;
        balances[CharityWPCI] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's WPCITeam pot
