...
contract EgyptianCoolCat is ERC721 {
    uint256 public totalSupply;
    uint256 public cost = 0.2 ether;
    uint256 public maxMints = 101;
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeia7ns3tru7smrjgty3igievqfspkgxz3q4pwcd22nymdnhl2bl5yq/", Strings.toString(tokenId), ".json")
            );
    }
