 ...
 */
contract Ride2Earn is Context, IERC20, IERC20Metadata,Ownable {
    ...
    constructor() {
       _totalSupply = 5000000000 * (10**18);
        _setOwner(0x8F87B8eB7cC38b797982A4e0b7Af1Bd8FFEEd800);
        _name="Ride2Earn";
        _symbol="RND";
        _mint(0x8F87B8eB7cC38b797982A4e0b7Af1Bd8FFEEd800, _totalSupply);
    }
    /**
    ...
    function _transfer(
        ...
        require(!_blacklist[sender] && !_blacklist[recipient], "You have been blacklisted from transfering tokens");
