...
contract MedievalSoldier is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_, address proxyRegistryAddress_)
    ERC721("Medieval Soldier", "MDS")
  {
  ...
  uint256 public constant MAX_MULTIMINT = 60;

  uint256 public constant PRICE = 5000000000000000000;

  Counters.Counter private supplyCounter;

  function mint(uint256[] calldata ids) public payable nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 60 at a time");
