...
contract CryptoMondayPacodelaIndia is ERC721, ERC721Enumerable, ERC721Burnable, ERC721Royalty, Ownable {
    ...
    constructor(address trustedForwarder) ERC721("CryptoMondayPacodelaIndia", "CMPI_E10") {
        _tokenIds.increment();
