...
contract TradingCompetitionApplication {
    ...
    mapping(address => bytes32) public referrer; 
     ...
     */
    function applyToTrade(bytes32 referrerParam) external {        
     ...
     */
    function applyToTradeMultiForRefferer(address[] calldata manualApplicants, bytes32 referrerParam) external onlyAdmin {
