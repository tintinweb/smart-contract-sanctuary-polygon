...
contract StakingRewardsFactory is Owned {
    ...
    event CreateStakingRewardsDual(address indexed stakingRewardFactory, address indexed stakingRewards, address rewardsTokenA, address rewardsTokenB, address stakingToken);
    ...
    onlyOwner
    {
        ...
        emit CreateStakingRewardsDual(address(this), info.stakingRewards, rewardsTokenA, rewardsTokenB, stakingToken);
    }
