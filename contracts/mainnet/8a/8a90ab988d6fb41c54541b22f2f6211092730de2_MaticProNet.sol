...
// SPDX-License-Identifier: MIT 
 ...
 /*   Welcome
 *
 *	  The long term investment platform on the Polygon Network. Invest your MATIC and earn 5% daily rewards.
 *    
 *
 *    
 *
 ...
 *   - Your daily income starts at 5% with a total payout of 150%. This is not including compounding or referrals, which will increase your payout.
 ...
 *
 *   - 80% Platform balance and investment payouts
 *   - 15% Referral program bonuses
...
contract MaticProNet {
	using SafeMath for uint256;

	uint256 constant public INVEST_MIN_AMOUNT = 0.01 ether; // 0.01 matic minimum
	...
	constructor(address payable wallet, uint256 startDate) public {
        ...
        plans.push(Plan(30, 50e2));  //stop  when 150percent profit   5percent daily roi
	}
