...
abstract contract PermissionedOnchainDatabase is Ownable {
    ...
    function _getPod(address addr) internal view returns(Data[] memory) {
    ...
    function _getDataByKey(address addr, string memory _key) internal view returns(Data[] memory) {
    ...
    /* A user can only get its own data */
    function getPod(address addr) public view returns(Data[] memory) {
        return _getPod(addr);
    }
    ...
    function isAuthorized(address addr, string memory accessType, string memory _key) public view returns(bool boolean) {
    ...
    /* Return readDelegations for this address */
    function challengeDelegations(string memory accessType, address addr, string memory _key) internal view returns(bool boolean) {
    ...
    function getDataSizeByKey(address addr, string memory _key) public view returns(uint count) {
