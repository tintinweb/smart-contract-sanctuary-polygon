...
contract CommunityCrafting {
    ...
    function payOut(uint sff, address owner) public payable {
        ...
        // WETH
        path[1] = 0x2B237D94dB7EC80C4248Af4f11F7209Da9F3E1f1;
        ...
        ERC20(0x2B237D94dB7EC80C4248Af4f11F7209Da9F3E1f1).transferFrom(msg.sender, address(this), values[1]);
        // Approve the router just in case
        ERC20(0x2B237D94dB7EC80C4248Af4f11F7209Da9F3E1f1).approve(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff, values[1]);

        (uint amountToken, uint amountETH, uint liquidity) = uniswapV2Router.addLiquidityETH{ value: values[0] }(
            0x2B237D94dB7EC80C4248Af4f11F7209Da9F3E1f1,
