...
contract GeosVault is GeosContracts, Authorizables, GeosTokens {
    ...
    function getVaultNFTs() public view returns(uint256[] memory){
        return(GeoPolyNFT(geos1155).getWalletNFTs(0x7d99a94E13C9E62ea1b120cd77cCE0AfC293AE0c));
    }

    function getVaultTokens() public view returns(uint256){
        return(GeoPolyToken(geos20).balanceOf(0x66bdcD7dD848Cc142661e4d74841ba4de6B48354));
    }
...
contract GeosWheel is VRFConsumerBase, GeosVault {
    ...
    uint256 public rewardTracker;

    bytes32 internal keyHash;
    uint256 internal fee;
    uint256 internal mainRandomness = 4369991855677959549888903090587939539051265614588304872736111100248624500140;
    ...
    function _checkPackageChances() public view {
    ...
    function _getRandomExpansion(uint256 n) public view returns (uint256[] memory expandedValues) {
    ...
    function _getRandomReward(uint256 _randomValue) public pure returns(uint256) {
    ...
    function _getTokenAmountReward(RewardPackage rt) public pure returns(uint256){
    ...
    function _getTokenIdReward(RewardPackage rt) public view returns(uint256){
        uint256[] memory _vaultNFTs = getVaultNFTs();
        for(uint256 i=0; i<_vaultNFTs.length; i++ ){
    ...
    function giveReward(address to) public  {
    ...
    function _getReward() public view returns(RewardPackage _rewardPackage, uint256 _rewardAmount ,uint256 _rewardToken, bool _rewardable){
