...
contract ADAPASS is IERC721L, ERC721AQueryable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {

    // Whether base URI is permanent. Once set, base URI is immutable.
    bool private _baseURIPermanent;

    // The total mintable supply.
    uint256 internal _maxMintableSupply = 501;
    ...
    constructor() ERC721A("ADA PASS free mint", "ADPASS") {
        _mintStages.push(MintStageInfo({cost: 7000000000000000000, walletLimit: 1, merkleRoot: 0x0, maxStageSupply: 0, startTimeUnixSeconds: 1687280003, endTimeUnixSeconds: 1692464003}));
    }
