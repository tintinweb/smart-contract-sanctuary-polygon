 ...
 */
contract Artiffine2022 is ERC721, ERC721Enumerable, Ownable, ERC721Royalty {
    using SafeMath for uint256;

    string private _baseURIextended;
    string public contractURI;

    constructor() ERC721('Artiffine2022', 'ARTF22') {}
    ...
    // free mint
    function airdrop(uint256 numberOfTokens, address to) public onlyOwner {
