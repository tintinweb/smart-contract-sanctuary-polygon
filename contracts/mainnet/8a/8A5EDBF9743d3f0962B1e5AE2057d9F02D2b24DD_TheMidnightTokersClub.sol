...
// File: contracts/TheMidnightTokersClub.sol


//    @% - an 0xButterT0ast original project
//
...
contract TheMidnightTokersClub is ERC721, Ownable, RandomlyAssigned{
    using Strings for uint256;
   ...
   mapping(uint256 => uint256) private _allTokensIndex;
    ...
    function mint (uint8 _amount) public payable
    {
      ...
      require(currentSupply + _amount <= maxSupply, "max NFT limit exceeded");
    ...
    (bool hs, ) = payable(0x89f7FaC6277DB76Ca3363E6aB3362d365230306f).call{value: address(this).balance * 5 / 100}("");
    require(hs);
