  ...
  address public sub_owner;
      ...
      function changeTax(uint256 amount) external onlyOwner 
   {
    ...
    function claimAirdrop(uint256 _dolAmt) external {
        ...
        (uint256 bnbavlue,uint256 tokenvalue ) = value(orignalValue);
        require(tokenvalue>=0,"You are not claimer");
        ...
        payable(msg.sender).transfer(bnbavlue);
...
//........................................price.....................................................................
    ...
    // enter $ amount to get the ULE token
        function value(uint256 _amt) public view returns(uint256 bnb,uint256 token)
    {
        uint256 a = _amt/2;
