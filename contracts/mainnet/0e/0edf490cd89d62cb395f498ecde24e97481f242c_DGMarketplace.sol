...
contract DGMarketplace is Ownable, ReentrancyGuard, EIP712MetaTransaction {
    struct Order {
        bool active;
        uint256 price;
        address beneficiary;
    ...
    event Cancel(address _nftAddress, uint256[] _tokenIds);
    event Buy(address _nftAddress, uint256[]  _tokenIds);
...
contract ERC721Mock is ERC721 {
    ...
    function transferCreatorship(address _newCreator) external virtual {
        require(msg.sender == creator, "transferCreatorship: CALLER_IS_NOT_CREATOR");
...
// File contracts/DGMarketplaceFlat.sol