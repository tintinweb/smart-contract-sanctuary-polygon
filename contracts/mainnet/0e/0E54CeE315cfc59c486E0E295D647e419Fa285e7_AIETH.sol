...
contract AIETH is ERC20, Ownable, ERC20Burnable {
    ...
    constructor() ERC20("AIETHEREUM", "AIETH") {
        _mint(msg.sender, 100000000000 * 10**decimals());
        emit tokensMinted(msg.sender, 100000000000 * 10**decimals(), "Initial supply of tokens minted.");
    }
