...
contract ERC721 is ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
     ...
     */
    constructor() {
        _name = "2022.02.14_FrontPageVictory";
        _symbol = "LA Times";
    }
     ...
     * @dev See {IERC721Enumerable-totalSupply}.
     */
    function assignedNFTS() public view virtual returns (uint256) {
    ...
    function createCollectible(address from, string memory _tokenURI) external override returns (uint256) {
...
contract FrontPageVictory is ERC721 {
