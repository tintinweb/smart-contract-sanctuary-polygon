...
contract PPcardPowerSeason3 is ERC721 {
  ...
  function tokenURI(uint256 _tokenId) public view override returns (string memory) {
    ...
    string memory json = Base64.encode(
      abi.encodePacked(
        '{"name": "',
        charAttributes.name,
        '",  "description": "PPCARD POWER - SEASON3 # www.psykotikpanda.com',
        Strings.toString(_tokenId),
        '", "image": "',
        charAttributes.imageURI,
        '", "attributes": [ { "trait_type": "attaque", "value": "',strStars,'"} , { "trait_type": "maxAttaque", "value": "3" } ]}'
      )
    );
