...
contract TropicalPowersPublica is ERC721, ERC721Enumerable, ERC721Burnable, ERC721Royalty, Ownable {
    ...
    constructor(address trustedForwarder) ERC721("TropicalPowersPublica", "TPP_E8") {
        _tokenIds.increment();
