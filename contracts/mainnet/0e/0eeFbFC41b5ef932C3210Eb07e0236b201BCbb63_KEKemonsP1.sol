...
contract KEKemonsP1 is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("KEKemons P1", "KEK-P1") {
    customBaseURI = customBaseURI_;

    allowedMintCountMap[owner()] = 333;
  }
  ...
  uint256 public constant MAX_MULTIMINT = 333;
  ...
  function mint(uint256 count) public payable nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 333 at a time");
