...
contract BorrowedSwap is Ownable {
    ...
    function BorrowandSwap(address _collateralToken, uint256 _collateralAmount,address _borrowedToken, uint256 _borrowedAmount,address _swapoutToken, uint256 _minimumOut) external onlyOwner returns (uint256 amountOut) {
    ...
    function swapExactInputSingle(uint256 amountIn,address _swapinToken,address _swapoutToken, uint256 _minimumOut) external onlyOwner returns (uint256 amountOut) {
