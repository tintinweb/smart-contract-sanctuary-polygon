...
import "../Providers/Helper.sol";
import "../Providers/ProviderRegistry.sol";

contract LayerZeroImpl is ILayerZeroReceiver, ICommLayer, Ownable, helper {
    ...
    function lzReceive(
        ...
        (address _provider, IdInfo memory idInfo) = abi.decode(
            _payload,
            (address, IdInfo)
        );

        ProviderRegistry(_provider).acquireIdentity(idInfo);
