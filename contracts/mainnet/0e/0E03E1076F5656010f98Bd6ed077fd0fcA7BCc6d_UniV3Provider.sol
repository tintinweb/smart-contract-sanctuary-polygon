...
contract UniV3Provider is IDex, Ownable{
    ...
    function swapERC20(address from, address _tokenIn, address _tokenOut, uint amountIn, bytes memory //extraData
        ) external returns (uint amountOut) {

            TransferHelper.safeTransferFrom(_tokenIn, from, address(this), amountIn);
