...
import "../3_Chainlink_VRF/VRFInternal.sol";
...
contract Words is ERC721BaseInternal, WordsInternal, VRFInternal {
    ...
    function mintVVord(
        ...
        _newWord(word, tags, externalURL, msg.sender, to, tokenId, paidAmount, category);
