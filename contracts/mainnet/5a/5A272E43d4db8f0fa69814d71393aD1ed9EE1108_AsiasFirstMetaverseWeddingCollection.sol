...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable, IERC2981 {
    ...
    string private _name = " Asias First Metaverse Wedding Collection";

    string private _symbol = "AsiasFirstMetaverseWeddingCollection";
...
contract  AsiasFirstMetaverseWeddingCollection  is ERC721 {
    ...
    function createCollectible(address creator, string memory tokenURI) public returns (uint256) {
        require(msg.sender == operator,"ERC721: caller doesn't operator role");
        require(tokenCount <= 10, "ERC721: Minting limit exceeds");
