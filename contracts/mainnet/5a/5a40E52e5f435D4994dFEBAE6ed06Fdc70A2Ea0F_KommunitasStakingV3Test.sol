...
contract KommunitasStakingV3Test is
  Initializable,
  UUPSUpgradeable,
  OwnableUpgradeable,
  PausableUpgradeable,
  ...
  IKommunitasStakingV3
{
  ...
  function init(
    ...
    do {
      lock[i] = Lock({
        lockPeriodInSeconds: _lockPeriodInDays[i],
        apy_d2: _apy_d2[i],
  ...
  function getStakedDetail(
    ...
    lockPeriodInSeconds = lock[stakeDetail.lockIndex].lockPeriodInSeconds;
  ...
  function _stake(
    ...
    emit Staked(
      _sender,
      lock[_lockIndex].lockPeriodInSeconds,
      _compoundType,
      _amount,
      reward,
  ...
  function _unstake(
    ...
    if(_isPremature){
      ...
      if(stakeDetail.compoundType == CompoundTypes.RewardOnly){
        ...
        emitUnstaked(
          _sender,
          lock[stakeDetail.lockIndex].lockPeriodInSeconds,
          stakeDetail.compoundType,
          stakeDetail.amount,
          stakeDetail.reward,
          0,
  ...
  function setPeriodInSeconds(
    uint16 _lockIndex,
    uint128 _newLockPeriodInSeconds
  ) external virtual onlyOwner {
    require(lockNumber > _lockIndex, "bad");
    lock[_lockIndex].lockPeriodInSeconds = _newLockPeriodInSeconds;
  }
