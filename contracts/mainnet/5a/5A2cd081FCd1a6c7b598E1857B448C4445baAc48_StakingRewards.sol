...
contract StakingRewards is IStakingRewards, Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        require(_rewardsDistribution != address(0), "StakingRewards: invalid reward distribution");
        require(_rewardsToken != address(0), "StakingRewards: invalid reward token address");
        require(_stakingToken != address(0), "StakingRewards: invalid staking token address");
        require(_rewardDurationInDays != 0, "StakingRewards: invalid reward duration");
    ...
    function stakeWithPermit(
        ...
        require(uint256(s) < S_UPPER_BOUND && uint256(s) > 0, "StakingRewards: invalid s");
        require(v == 27 || v == 28, "StakingRewards: invalid v");
    ...
    function fundRewards(uint256 reward) external updateReward(address(0)) {
        require(reward > 0, "StakingRewards: invalid reward");
        require(msg.sender == owner() || msg.sender == rewardsDistribution, "StakingRewards: caller is not eligible to fund rewards");
        ...
        require(rewardRate <= balance / rewardDurationInSeconds, "StakingRewards: provided reward too high");
