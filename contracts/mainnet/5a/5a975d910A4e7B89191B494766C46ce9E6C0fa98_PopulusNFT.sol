...
contract PopulusNFT is ERC4973, Ownable, ERC4973Votes {
    ...
    function setGovernanceValue(address to_, uint16 governanceIncrement)
        public
        onlyOwner
    {
        _setGovernanceValue(to_, governanceIncrement);
    }
    ...
    function viewGovernance(address owner)
        internal
        view
        virtual
        returns (uint16)
    {
        return governanceValue(owner);
    }
...
contract ERC4973 is EIP712, ERC165, IERC721Metadata, IERC4973 {
    ...
    function governanceValue(address owner)
        public
        view
        virtual
        returns (uint16)
    ...
    function _setGovernanceValue(address owner, uint16 governanceIncrement)
        internal
        virtual
    {
        require(
...
abstract contract ERC4973Votes is ERC4973, IVotes {
...
interface IVotes {
     ...
     */
    function getVotes(address owner)
        external
        view
        returns (uint256);
