...
contract Mourci is MourciDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private MourciTeam;
    address private CharityMourci;
    ...
    string public override name = "Mourci";
    string public override symbol = "Mourci";
    ...
    constructor(uint totalSupplyValue, address MourciTeamAddress, address CharityMourciAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        MourciTeam = MourciTeamAddress;
        CharityMourci = CharityMourciAddress;
        
        // split the tokens according to agreed upon percentages
        balances[MourciTeam] =  totalSupply * 4 / 100;
        balances[CharityMourci] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's MourciTeam pot
