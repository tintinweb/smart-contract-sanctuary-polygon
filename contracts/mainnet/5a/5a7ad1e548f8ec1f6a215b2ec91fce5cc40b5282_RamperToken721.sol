...
// File: contracts/HellBuds NFT.sol
...
contract RamperToken721 is ERC721Enumerable, IRamperInterface721 {
    uint256 constant public MAX_TOKENS = 6666;
    uint256 constant public MAX_TOKENS_PER_TXN = 100;
    uint256 constant public MAX_TOKENS_PER_ADDRESS = 200;
    uint256 constant public TOKEN_PRICE = 4.4 ether;

    string public baseTokenURI = "ipfs://bafybeihewrrlrfonnmlvq7lzxhitu5uqwfa7ionn3kwvy2higaw3vp2gfa/";

    constructor() ERC721("HellBUDS NFT", "HLB") {
