...
contract The10x is ERC721, ERC721Enumerable, ERC721URIStorage, WithdrawableOwnable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("The 10x", "10X") {}

    // this have to be public in order to anyone be able to interact and mint
