...
contract QuickMaiLpFarm is BaseSiloAction, IIncentiveKey {
                ...
                if (swapAmount > 0) {
...

                    {
                        ...
                        if (id == 0) {
                            ...
                            // }
                            console.log(
                                "add the liquidity to the original position mananger: %s:",
                                tokenId
                            );
...

                {
                    ...
                    if (id != 0) {
                        ...
                        if (inputAmounts[3] == 2**256 - 1) {
                            ...
                            console.log(" remove  total liquiidty of v3");

                            // protocol.farm.approve(address(this), id);

                            protocol.farm.exitFarming(key, tokenId, true);

                            console.log(" remove v3 after exitFarming");
                            ...
                            console.log(" remove v3  reward: %s", reward);
                        ...
                        if (removeLiquidity > 0) {
                            ...
                            // console.log(
                            //     " remove v3  liquidity: %s _removeLiquidityPosition : amount0: %s amount1:%s",
                            //     liquidity,
                            //     amount0,
                            //     amount1
                            // );
        ...
        )
    {
        ...
        console.log("stakeV3 after mint:");
        ...
        console.log("safeTransferFrom to quick v3 farm:");
        ...
        uint256 id = getUserLastFarm(address(this));
        console.log("stake farm nft id", id);
    }
