...
contract SunnyBoys is ERC721, Ownable {
    ...
    constructor() ERC721("Sunny Boy", "SUN") {
        _tokenIds.increment();
    }

    modifier isMintable() {
        require(mintable, "Sunny Boy: NFT cannot be minted yet.");
        _;
    }

    modifier isPreSaleMintable() {
        require(preSaleMintable, "Sunny Boy: NFT cannot be minted yet.");
        _;
    }
    ...
    modifier isNotExceedMaxMintPerTx(uint256 amount) {
        require(
            ...
            "Sunny Boy: Mint amount exceeds max limit per tx."
        );
        _;
    }
    ...
    modifier isNotExceedAvailableSupply(uint256 amount) {
        require(
            ...
            "Sunny Boy: There are no more remaining NFT's to mint."
        );
        _;
    }
    ...
    modifier isPaymentSufficient(uint256 amount) {
        require(
            ...
            "Sunny Boy: There was not enough/extra ETH transferred to mint an NFT."
        );
        _;
    }
    ...
    modifier isAllowList() {
        require(
            ...
            "Sunny Boy: You're not on the list for the presale."
        );
        _;
    }
