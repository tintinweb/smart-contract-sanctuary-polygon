...
contract Bluegirls is ERC721 {
    uint256 public totalSupply;
    uint256 public cost = 3 ether;
    uint256 public maxMints = 250;
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeia7cvcltk5uopaiz4a4c74vcvonwov77i3opdw56p5tk234rxc3la/", Strings.toString(tokenId), ".json")
            );
    }
