...
contract PEPEGAMEReward is Ownable {
    IERC20 public token;
    uint256 public rewardMultiplier;

    mapping(address => uint256) private _latestNonces;
    ...
    function claimTokens(
        ...
        // The nonce must be greater than the last one used
        require(nonce > _latestNonces[msg.sender], "Invalid nonce");
        ...
        _latestNonces[msg.sender] = nonce; // Update the stored nonce
