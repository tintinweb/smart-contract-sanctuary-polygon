...
contract POLYGONMATIC is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("POLYGON MATIC", "POMT") {
  ...
  uint256 public constant PRICE = 916000000000000000;
  ...
  function mint(uint256 count) public payable nonReentrant onlyOwner {
    ...
    require(
      msg.value >= PRICE * count, "Insufficient payment, 0.916 ETH per item"
    );
