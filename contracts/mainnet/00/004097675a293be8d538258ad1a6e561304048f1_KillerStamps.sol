...
contract KillerStamps is ERC1155URIStorage, Ownable {
	using Strings for string;

	string public name = "Killer GF Stamps";
	string public symbol = "STAMP";
	...
	function initializeStamp(uint256 tokenId, string memory _tokenURI) public onlyOwner {
		require(!exists(tokenId), "KillerStamps: Stamp already exists");
