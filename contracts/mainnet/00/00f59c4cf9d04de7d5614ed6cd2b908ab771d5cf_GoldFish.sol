...
contract GoldFish is ERC721Enumerable, Ownable {
	...
	constructor() ERC721("GoldFish Collections", "GF") {
		_reserved = 210;
		_price = 10 * 10 ** 18;
		_saleStarted = false;
		setBaseURI("https://goldfishcollection.site/api/v1/collections/");
	}
    ...
    // Allows for the early reservation of 210 NFT from the creators for promotional use
