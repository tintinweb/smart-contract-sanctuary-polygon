...
contract CAFC is ERC721Enumerable, Ownable {
  using Strings for uint256;

  string public baseURI;
  string public baseExtension = ".json";
  string public notRevealedUri;
  uint256 public cost = 68 ether;
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    if (msg.sender != owner()) {
        ...
        if(onlyEarlyPublicMint == true) {
            require(isEarlyPublicMint(msg.sender), "Sorry you are not on the Early Public Mint List");
            uint256 ownerTokenCount = balanceOf(msg.sender);
 ...
 function whitelistUser(address[] calldata _user) public onlyOwner {
  ...
  function withdraw() public payable onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0xBd2BA896Fd086CB22F190f6c467d6181462fFd7a).call{value: address(this).balance * 30 / 100}("");
    require(hs);
    // =============================================================================
