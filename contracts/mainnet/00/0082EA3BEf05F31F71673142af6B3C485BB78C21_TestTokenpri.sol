...
contract TestTokenpri is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("TestTokenpri", "TTKN1") {
    customBaseURI = customBaseURI_;

    allowedMintCountMap[owner()] = 1000;
  }
