...
contract Multitoken {
    ...
    address apeFactory = 0xCf083Be4164828f00cAE704EC15a36D711491284;
    ...
    function arbitrage(address routerA, address routerB, address token) external onlyOwner returns(bool){
        ...
        uint amount = IERC20(WETH).balanceOf(tokenAddress);
        ...
        uint tokenBalance = IERC20(token).balanceOf(tokenAddress);
        ...
        uint finalBalance = IERC20(WETH).balanceOf(tokenAddress);
