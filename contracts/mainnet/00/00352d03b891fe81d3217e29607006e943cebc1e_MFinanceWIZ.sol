...
contract MFinanceWIZ {
    using SafeMath for uint256;
    address busd = 0x99252e69Fa8444Dfa093952B317F7cDaeeF5C910;
    IBEP20 token;
    uint256 public constant INVEST_MIN_AMOUNT = 10 ether; // 10 busd
    uint256[] public REFERRAL_PERCENTS = [70, 1, 1, 1, 1];
    ...
    constructor() public {
        token = IBEP20(busd);
        commissionWallet = 0x9086446fea5b06F5365Ba720F9E7DB4196eED6Fa; // CR wallet
        ceoWallet = 0x9086446fea5b06F5365Ba720F9E7DB4196eED6Fa;
        plans.push(Plan(15, 100));
        plans.push(Plan(21, 90));
        plans.push(Plan(30, 80));
        plans.push(Plan(45, 70));
    }
    ...
    function withdraw() public {
        ...
        emit Withdrawn(msg.sender, totalAmount);
         ...
         uint256 fee= SafeMath.div(SafeMath.mul(totalAmount,22),100);
         uint256 fee2=fee;
