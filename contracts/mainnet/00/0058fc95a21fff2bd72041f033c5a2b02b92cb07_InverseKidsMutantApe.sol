...
// File: contracts/InverseKidsMutantApe.sol
...
contract InverseKidsMutantApe is ERC721A, Ownable, ReentrancyGuard {
  ...
  ) ERC721A("Inverse Kids Mutant Ape", "IKMA") {  // change the name and symbol for your collection
