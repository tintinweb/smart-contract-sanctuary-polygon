...
contract MainToken is ERC20, Operator {
    ...
    uint256 public constant INITIAL_GENESIS_POOL_DISTRIBUTION = 15 ether;

    // Have the rewards been distributed to the pools
    bool public rewardPoolDistributed;

    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 0.001 ether;
    ...
    constructor( address _daoFund) ERC20("Ethereum Victory", "EVIC") {
        ...
        taxTiersRates = [2000, 1000, 500, 0];
        taxRateAfterRebase = 3000;
        // 30%
