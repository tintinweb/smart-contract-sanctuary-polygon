...
contract iBTCpxToken is OwnableUpgradeable, ERC20BurnableUpgradeable {
    ...
    function initialize(uint256 _stakingStartDate) external initializer {
        __ERC20_init("Interest Bearing BTCpx", "iBTCpx");
        ...
        daoWallet = 0x522817505E9c558a4629f47A29A881E3c1DA205d;
        apy = 700;
    }
    ...
    function updateStaking(address _staking, bool _helper) external onlyOwner {
        ...
        IERC20Upgradeable(PRXY).safeApprove(_staking, type(uint128).max);
    }
    ...
    function stake(uint256 amount) external updateReward(_msgSender()) {
        ...
        IERC20Upgradeable(BTCpx).safeTransferFrom(_msgSender(), daoWallet, amount);
    ...
    function unstake(uint256 amount) public updateReward(_msgSender()) {
        ...
        _burn(_msgSender(), amount);
        IERC20Upgradeable(BTCpx).safeTransferFrom(daoWallet, _msgSender(), amount);
