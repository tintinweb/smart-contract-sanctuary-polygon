...
// File: SPepeTimelock.sol


pragma solidity 0.8.16;


contract SPepeTimelock is TimelockController {

    uint public constant timeDelay = 60 * 60 * 24;

    constructor(
        address[] memory proposers,
        address[] memory executors
    )
        TimelockController(timeDelay, proposers, executors, address(0))
    {}
