 ...
 */
contract Factory is ERC721Upgradeable, ERC721EnumerableUpgradeable, OwnableUpgradeable {
    using Clones for address;
    using Strings for *;
    using Power for address;

    string[] implNames; // a list of the name of all implementations existing in the factory
    string[] tempNames; // a list of the name of all template existing in the factory
    ...
    /**
     * @dev Clones a desired new ChanceRoom for the creator, mints its NFT and transfers it
     * to the creator address.
     *
     * the `tokenId` is the uint256 transformed type of the chanceRoom address.
     *
     * Requirements:
     *
     * - The address power(number of zeros in the beginning) should be more than 3.
     * - Selected `implName` must be verified by the factory.
     *
     * Emits a {Clone} event.
     */
    function newChanceRoom(
        ...
        // require(chanceRoomAddr.power() >= 3);
    ...
    /**
     * @dev predicts the next chanceRoom address cloned by the factory from certain salt
    ...
    function _template(
        ...
        return string.concat(
            '<?xml version="1.0" encoding="UTF-8" standalone="no" ?><!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="1080" height="1080" viewBox="0 0 1080 1080" xml:space="preserve"><desc>Created with Fabric.js 5.2.4</desc><defs></defs><rect x="0" y="0" width="100%" height="100%" fill="transparent"></rect><g transform="matrix(1 0 0 1 540 540)" id="4986d12a-790e-4824-8bcf-9f916fe017e3"  ><rect style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-dashoffset: 0; stroke-linejoin: miter; stroke-miterlimit: 4; fill: rgb(148,108,0); fill-rule: nonzero; opacity: 1;" vector-effect="non-scaling-stroke"  x="-540" y="-540" rx="0" ry="0" width="1080" height="1080" /></g><g transform="matrix(1 0 0 1 540 540)" id="efb3bcd6-59e5-46f6-8788-a35d7c05c233"  ></g><g transform="matrix(1.47 0 0 1.92 540 588.83)" style="" id="90874e9c-a547-473a-a196-aa3cb700eea4"  ><rect opacity="0.32" fill="rgb(0,0,0)" x="-338.6" y="-22.6" width="677.2" height="45.2"></rect><text xml:space="preserve" font-family="Lato" font-size="40" font-style="normal" font-weight="400" style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-dashoffset: 0; stroke-linejoin: miter; stroke-miterlimit: 4; fill: rgb(255,191,88); fill-rule: nonzero; opacity: 1; white-space: pre;" ><tspan x="-206.68" y="12.57" >template : ',
            template,
            '</tspan></text></g><g transform="matrix(1.15 0 0 1.15 540 240.12)" style="" id="803678fe-3e51-4350-b979-90f6b9ac5bd2"  ><rect opacity="0.62" fill="rgb(0,0,0)" x="-432.06" y="-135.6" width="864.13" height="271.2"></rect><text xml:space="preserve" font-family="Alegreya" font-size="80" font-style="normal" font-weight="700" style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-dashoffset: 0; stroke-linejoin: miter; stroke-miterlimit: 4; fill: rgb(255,237,209); fill-rule: nonzero; opacity: 1; white-space: pre;" ><tspan x="-309.48" y="-65.27" >',
            implementation,
            '</tspan><tspan x="-43.12" y="25.13" >on</tspan><tspan x="-292.28" y="115.53" >',
            nft,
            '</tspan></text></g><g transform="matrix(1.5 0 0 1.59 540 910.47)" style=""  ><text xml:space="preserve" font-family="Lato" font-size="40" font-style="normal" font-weight="400" style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-dashoffset: 0; stroke-linejoin: miter; stroke-miterlimit: 4; fill: rgb(0,0,0); fill-rule: nonzero; opacity: 1; white-space: pre;" ><tspan x="-69" y="12.57" >',
            status2,
            '</tspan></text></g><g transform="matrix(1.32 0 0 1.72 540 693.25)" style=""  ><rect opacity="0.32" fill="rgb(0,0,0)" x="-377.29" y="-22.6" width="754.58" height="45.2"></rect><text xml:space="preserve" font-family="Lato" font-size="40" font-style="normal" font-weight="400" style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-dashoffset: 0; stroke-linejoin: miter; stroke-miterlimit: 4; fill: rgb(255,191,88); fill-rule: nonzero; opacity: 1; white-space: pre;" ><tspan x="-327.66" y="12.57" >implementation : ',
            implementation,
            '</tspan></text></g><g transform="matrix(1.5 0 0 1.59 540 823.92)" style=""  ><text xml:space="preserve" font-family="Lato" font-size="40" font-style="normal" font-weight="400" style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-dashoffset: 0; stroke-linejoin: miter; stroke-miterlimit: 4; fill: rgb(0,0,0); fill-rule: nonzero; opacity: 1; white-space: pre;" ><tspan x="-69" y="12.57" >',
            status1,
            '</tspan></text></g><g transform="matrix(1.01 0 0 1.12 540.15 427.77)" style=""  ><rect opacity="0.6" fill="rgb(0,0,0)" x="-492.66" y="-22.6" width="985.32" height="45.2"></rect><text xml:space="preserve" font-family="Lato" font-size="40" font-style="normal" font-weight="400" style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-dashoffset: 0; stroke-linejoin: miter; stroke-miterlimit: 4; fill: rgb(255,255,255); fill-rule: nonzero; opacity: 1; white-space: pre;" ><tspan x="-484.72" y="12.57" >',
            nftAddr,
            '</tspan></text></g></svg>'
        );
    }
