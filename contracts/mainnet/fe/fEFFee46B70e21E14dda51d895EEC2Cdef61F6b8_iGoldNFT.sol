...
// File: Contracts/iGoldNFT_V1.sol
...
contract iGoldNFT is ERC721, Ownable {
    ...
    IiGoldToken public iGoldToken = IiGoldToken(0x9440146ea1dF0142eE1892602416DA896c7876E8);

    Counters.Counter private _tokenIdCounter;

    string private _baseTokenURI = "ipfs://QmSD7vD7qdkps4eMm6dr28axDHfLtYH9Z1Y6VoYyX5hzZ1/";
    ...
    constructor() ERC721("iGoldNFT", "iGoldNFT") {
    ...
    function setIGoldToken(address _iGold) external onlyOwner {
        ...
        emit MintershipTransferred(address(iGoldToken), _iGold);
    }
    ...
    function mint(address to) public returns (uint256 _tokenId) {
        ...
        _mint(to, newTokenId);
        _totalSupply++;
        string memory tokenIdString = "iGoldOunce"; //Strings.toString(newTokenId);
    ...
    function tesmint() public returns (uint256 _tokenId){
        _tokenIdCounter.increment();
        uint256 newTokenId = _tokenIdCounter.current();
    ...
    function receivePhysicalGold(
        ...
        require(
            _isApprovedOrOwner(_msgSender(), ounceId),
        ...
        burn(msg.sender, ounceId);
        
        usdtToken.transferFrom(msg.sender, feeCollector, feeInUSDT);
        feesCollected += feeInUSDT;
