...
contract Peagirl is ERC721 {
    uint256 public totalSupply;
    uint256 public cost = 0.19 ether;
    uint256 public maxMints = 31;
    ...
    function mint() external payable {
        ...
        if (totalSupply + 1 > 32) revert SoldOut();
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeickrspiqaoqv37kzbkgvwhlsnje4yn35dvhgfqybsxzklnr3lg4iy/", Strings.toString(tokenId), ".json")
            );
    }
