...
contract OASIS4BIRDS is Ownable, ERC721 {
    
    uint public tokenPrice = 99 ether;
    uint constant maxSupply = 2222;
    uint public presale_price = 99 ether;
    ...
    constructor() ERC721("OASIS 4 BIRDS", "O4B"){}
