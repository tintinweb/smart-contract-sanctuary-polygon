...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1682159460;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1681401600;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x4F7964d62D8B0AD630c8EF07Ffa309246e459F1c];
  address public erc20Payable = 0x4F7964d62D8B0AD630c8EF07Ffa309246e459F1c;
...
abstract contract EarlyMintIncentive is Teams, ERC721A, ProviderFees {
  ...
  uint256 public EARLY_MINT_PRICE = 12 ether;
  uint256 public earlyMintTokenIdCap = 1777;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmUwhNcM5EePrYzEVjT1qe4LRbAcwiQLoAPag63WhWyPJK/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/RbOaKcdmpVdzwoID2m0U/contract-metadata";
  }
...
// File: contracts/BpbClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BpbClubContract is ERC721APlus {
    constructor() ERC721APlus("BPBClub", "BPBC"){}
}
  /*******************************************************/
  /*                                                     */
