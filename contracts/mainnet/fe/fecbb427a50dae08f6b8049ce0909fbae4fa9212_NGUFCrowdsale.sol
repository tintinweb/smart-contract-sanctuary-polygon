...
/// @notice ERC-20 with a fixed supply of 100,000 tokens, transfer limit of 1%, and a 5 minute transfer cooldown  
contract NeverGibUpFren is ERC20, ERC20Permit {
  ...
  constructor(address deployer) ERC20("NeverGibUpFren", "NGUF") ERC20Permit("NeverGibUpFren") {
    deployooor = deployer;
  ...
  function _beforeTokenTransfer(
    ...
    require(
      ...
      "no whale transfer allowed (max. 1000)"
    );
...
contract NGUFCrowdsale {
  ...
  function finalizeCrowdsale() external {
    ...
    // deploy the tokeen
    tokeen = new NeverGibUpFren(address(this));
  ...
  function claimTokeens() external {
    ...
    require(
      block.timestamp >= ((end + 1 minutes) + (p.at - start)),
      "Not claimable yet"
    );
