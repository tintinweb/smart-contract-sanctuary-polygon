    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeifjjcrtuxwd4x3oxlnxqez4453eto6oerbqltmax7yo2qbjlsjira/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/BfkifITsR1B3vjQN6Hey/contract-metadata";
  }
...
// File: contracts/FunnySkeletonContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract FunnySkeletonContract is ERC721APlus {
    constructor() ERC721APlus("Funny Skeleton", "FS"){}
}
