    ...
    IAffiliate
{
    ...
    /**
     * @notice Owner: Set `reinforcement_` as the new maximum amount of reserves that can be locked by all bets
     *         for the same condition.
     */
    function changeReinforcement(uint128 reinforcement_) external onlyOwner {
        reinforcement = reinforcement_;
        emit ReinforcementChanged(reinforcement_);
    }
