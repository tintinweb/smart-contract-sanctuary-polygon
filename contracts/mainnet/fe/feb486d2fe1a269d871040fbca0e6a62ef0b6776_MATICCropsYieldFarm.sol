...
/**
    ...
    A sustainable investment platform based on Binance network (BSC) blockchain smart-contract technology.
    ...
    *sustainability tax stays in the contract.
    ...
    ~ PLAN REQUIREMENTS: 
    plan 1 - min. 60 MATIC, max. of 10,000 MATIC
    plan 2 - min. 120 MATIC, max. of 14,000 MATIC
    plan 3 - min. 180 MATIC, max. of 18,000 MATIC
    plan 4 - min. 240 MATIC, max. of 22,000 MATIC
    ...
    Max active deposit limit of 80000 MATIC.
    Max withdraw amount of 3000 MATIC per day.
...
contract MATICCropsYieldFarm {
	...
	uint256 public WALLET_LIMIT = 80000 ether;  
    ...
    address payable public mktAndBuyBack;
	address public contractOwner;
    uint public startTime = 1653746400; // Fri Jun 03 2022 14:00:00 GMT+0000 https://www.unixtimestamp.com/
	...
	constructor(address payable _dev1, address payable _dev2, address payable _dev3, address payable _prtnr1, address payable _prtnr2, address payable _mkt) {
        ...
        plans.push(Plan(200, 20,  60 ether, 10000 ether, 0, 0, 0, 0, true));
        plans.push(Plan(90,  25, 120 ether, 14000 ether, 0, 0, 0, 0, true));
        plans.push(Plan(60,  30, 180 ether, 18000 ether, 0, 0, 0, 0, true));
        plans.push(Plan(40,  35, 240 ether, 22000 ether, 0, 0, 0, 0, true));
	}
