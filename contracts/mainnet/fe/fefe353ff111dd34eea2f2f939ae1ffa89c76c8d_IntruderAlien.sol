...
// File: contracts/intruder_alien.sol
...
contract IntruderAlien is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Intruder Alien", "INTALN") {
    setHiddenMetadataUri("ipfs://Qme7VT99PgJQ8Le5AsqnYX4j94q7NXpcitAZ5TDFESySNN/hidden.json");
  }
