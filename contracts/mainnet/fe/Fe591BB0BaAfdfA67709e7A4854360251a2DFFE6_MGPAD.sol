...
contract MGPAD is ERC20, Ownable {
    ...
    constructor () ERC20("MergePad", "$MGPAD") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x4Cb83392BBc07E955A918aB3Be9a7d0686795252;
        ...
        maxTransactionAmountBuy     = totalSupply() * 50 / 1000;
    ...
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to] || swapping) {
            ...
            if (walletToWalletTransferFee > 0){
                uint256 burnFee = (amount * walletToWalletTransferFee) / 100;
