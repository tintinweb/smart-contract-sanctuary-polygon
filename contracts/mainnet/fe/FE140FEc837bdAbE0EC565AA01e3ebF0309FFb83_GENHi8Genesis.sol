 ...
 * @notice This contract handles minting GEN Hi8 Genesis tokens.
 */
contract GENHi8Genesis is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x1EBb83A0a77Be092daE9F3aDb8C10c19a992260c;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x0aF26bF7659136a9326D87D6A477d04b661A74D2;
    address[] public payoutAddresses = [
        0x0aF26bF7659136a9326D87D6A477d04b661A74D2,
        0xCfA28D0cDa43f43d0013f159a6804395B257C005
    ];
    ...
    string public name = "GEN Hi8 Genesis";
    string public symbol = "GENHi8G";
    ...
    uint256[] public payoutBasisPoints = [500, 9500];
    uint96 public royaltyFee = 500;

    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeia4rajptdopbpaqm3d6lyuw26z7s27jbt3pqc6akrfs2rbfp4wrxm/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[1] = 150;
        tokenPublicPrice[1] = 5 ether;
        tokenPublicMintsPerAddress[1] = 5;
        tokenPresaleMaxSupply[1] = 50;
        tokenPresalePrice[1] = 0 ether;
        tokenPresaleMintsPerAddress[1] = 1;
        require(
