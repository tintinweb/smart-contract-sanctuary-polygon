...
contract Metatest is ERC721, Ownable {
    using Strings for uint256;
    ...
    uint256 public cost = 0.000075 ether;
  ...
  constructor() ERC721("Metatest", "MTGt") {
    setHiddenMetadataUri("ipfs://QmWg7nGLmomTJ8hciLACkMhyhv9ncWR6zhqSUUsfGZhecP/hidden.json");
  }
