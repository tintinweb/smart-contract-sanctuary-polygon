...
contract GreenValueCoin is ERC20, ERC20Detailed, Pausable {

    using SafeMath for uint256;
    uint256 tokenBalance;
    uint256 deployTime;
    uint256 maxSlotTime = 5256000;


    uint256 public withdrawlAmount;
    uint256 public maxSupply;
    uint256 public RemainingReward;
    uint256 public Duration = 5256000 minutes; 
    ...
    constructor()
    ERC20Detailed("Green Value Coin", "GREC",18)
    {
        deployTime = block.timestamp;
        RemainingReward = 1998000000*(10**18);
        _isExcluded[msg.sender] = true;
        _isExcluded[address(this)] = true;
        _mint(owner(),(2000000*(10**18)));
        _mint(address(this), 1998000000*(10**18));
        tokenBalance = balanceOf(address(this));
        Duration= Duration.div(60);
        maxSupply = 2000000000*(10**18);
    }
