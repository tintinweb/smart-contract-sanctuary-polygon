 ...
 */
contract CoreskyRouter is SeaportRouterInterface, ReentrancyGuard {
    /// @dev The allowed v1.4 seaport contract usable through this router.
    address private immutable _SEAPORT_V1_4;
    /// @dev The allowed v1.5 seaport contract usable through this router.
    address private immutable _SEAPORT_V1_5;
    /// @dev The allowed v1.5 coresky contract usable through this router.
    address private immutable _CORESKY_V1_5;
     ...
     * @param coreskyV1point5 The address of the Coresky v1.5 contract.
     */
    constructor(address seaportV1point4, address seaportV1point5, address coreskyV1point5) {
        _SEAPORT_V1_4 = seaportV1point4;
        _SEAPORT_V1_5 = seaportV1point5;
        _CORESKY_V1_5 = coreskyV1point5;
    }
    ...
    function getAllowedSeaportContracts()
        ...
        view
        override
        returns (address[] memory marketContracts)
    {
        marketContracts = new address[](3);
        marketContracts[0] = _SEAPORT_V1_4;
        marketContracts[1] = _SEAPORT_V1_5;
        marketContracts[2] = _CORESKY_V1_5;
    }
    ...
    function _assertSeaportAllowed(address market) internal view {
        if (
            _cast(market == _SEAPORT_V1_4) | _cast(market == _SEAPORT_V1_5)
            | _cast(market == _CORESKY_V1_5) == 0
        ) {
