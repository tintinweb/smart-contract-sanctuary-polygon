...
contract UrbanCatsNFT is ERC721URIStorage {
    ...
    constructor() ERC721("Urban Cats AI", "UCAI") {
    ...
    function burn(uint256 tokenId) public {
        require(_isApprovedOrOwner(msg.sender, tokenId), "You are not authorized to burn this token.");
        _burn(tokenId);
        _totalSupply--;
