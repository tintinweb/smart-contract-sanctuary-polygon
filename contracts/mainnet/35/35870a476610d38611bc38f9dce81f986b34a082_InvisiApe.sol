...
contract InvisiApe is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    string public unrevealURI = "https://invisibleape.mypinata.cloud/ipfs/QmbZ9212gmMoCYhXzEBfL6NgqZ9DMxULVEAK2SJUK1a7W9/unrevealed.json";
    bool public reveal = false;

    bool public endSale = false;

    string private _baseURIextended = "https://ipfs.io/ipfs/";
    uint256 private _priceextended = 110000000000000000000;
    ...
    constructor() ERC721("Invisible Ape", "InvisiApe") {
    }
    ...
    function mintNFT(uint256 _cnt) public payable {
        ...
        require(!pauseMint, "Paused!");
        require(tokenMinted < MAX_NFT_SUPPLY, "Sale has already ended");
        require(balanceOf(msg.sender).add(_cnt) <= 10, "Exceded the Minting Count per Wallet");
        require(getNFTPrice().mul(_cnt) == msg.value, "Matic value sent is not correct");
