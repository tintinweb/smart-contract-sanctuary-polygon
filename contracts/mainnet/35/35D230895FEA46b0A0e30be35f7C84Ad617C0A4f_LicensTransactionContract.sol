...
contract LicensTransactionContract is Ownable{
    ...
    constructor(address _accountContract, address _artListingNFT, address _licenseNFT, address _usdt, address _treasuryWallet, uint256 _taxPercent){
    ...
    function updateListing(uint256 _listingId, string memory _listingCID, string memory _licenseCID, uint256 _nftTokenId, uint256 _price, bool _isExclusive, uint256 _quantity, uint256 _exclusivitySurcharge, bool _isUnlimitedSupply) external {
        ...
        ListingDetails memory _listingInfo = ListingDetails(_listingId, _listingCID, _licenseCID, _nftTokenId, msg.sender, _price,  _isExclusive, _quantity, _exclusivitySurcharge, _isUnlimitedSupply, 0, false);
    ...
    function license(uint256 _listingId) external{
        ...
        usdt.transferFrom(msg.sender, listing.owner, listing.price);
        usdt.transferFrom(msg.sender, treasuryWallet, listing.price  * taxPercent / 100);
        ...
        artLicenseNFT.safeMint(msg.sender, listing.licenseCid);
