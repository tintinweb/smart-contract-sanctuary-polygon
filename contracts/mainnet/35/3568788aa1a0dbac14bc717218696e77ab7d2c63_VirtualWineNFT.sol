...
import "../storage/VirtualWineStorage.sol";
...
contract VirtualWineNFT is ERC1155Base, UUPSUpgradeable, VirtualWineStorage, IVirtualWine, IUpgradeable {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC1155Base) returns (bool) {
        return interfaceId == type(IVirtualWine).interfaceId || super.supportsInterface(interfaceId);
    }
