...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 10, 283 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmXE2vQ4FEzCpETuahx85FrZc1h1dvsBqJ4b2Uh9GsrhiA/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 283");
        _safeMint(_to, 1);
    }
...
// File: contracts/metaverseArtsStudioContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MetaverseArtsStudioContract is RamppERC721A {
    constructor() RamppERC721A("Metaverse Arts Studio", "MAS"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/HWSqvwhmbmJdGi7LRwYK/contract-metadata";
    }
}