    ...
    Multicall
{
        ...
        returns (uint256 listingTermsId)
    {
        ...
        _listingTermsParams[listingTermsId] = Params(listingId, 0, address(0));
        ...
        onlyAuthorizedToAlterListingTerms
    {
        ...
        delete _listingTermsParams[listingTermsId];
    ...
    function registerUniverseListingTerms(
        ...
        listingTermsId = _registerListingTerms(terms);
        _listingTermsParams[listingTermsId] = Params(listingId, universeId, address(0));
    ...
    function registerWarperListingTerms(
        ...
        listingTermsId = _registerListingTerms(terms);
        _listingTermsParams[listingTermsId] = Params(listingId, 0, warperAddress);
     ...
     * @inheritdoc IListingTermsRegistry
     */
    function listingTermsWithParams(uint256 listingTermsId)
        external
        view
        onlyRegisteredListingTerms(listingTermsId)
        returns (ListingTerms memory, Params memory)
    {
        return (_listingTerms[listingTermsId], _listingTermsParams[listingTermsId]);
    }
    ...
    /**
     * @dev Returns all Listing Terms for Listing ID.
     ...
     * @return List of all Listing Terms.
     */
...
abstract contract ListingTermsRegistryStorage {
    ...
    /**
     * @dev Mapping from Listing Terms ID to its Listing Terms Params.
     */
    mapping(uint256 => IListingTermsRegistry.Params) internal _listingTermsParams;
}
