...
contract Algorithmics {
    ...
    uint public constant TOKEN_LIMIT = 2556; 
    uint public constant ARTIST_PRINTS = 1232; 
    uint public constant PRICE = 200 finney;

    // The beneficiary is 350.org
    address public constant BENEFICIARY = 0xd53B6196F526b2cf0a5F3a35a03B23B2D02b26c4;
    ...
    string internal nftName = "Algorithmics";
    string internal nftSymbol = "AGM";
    ...
    function createAlgorithmics(uint seed) external payable returns (string) {
