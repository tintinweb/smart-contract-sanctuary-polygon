...
contract DGTCrowdMargin is Initializable {
    ...
    function initialize(address _stakingFunder, address _a1, address _a2, address _a3) external initializer {
	    ...
	    daigon = DAIGON(0x5009877b2FDd887A06788F5797580C9A0E2F662f);
    	...
    	createPool(25 ether, 1, 0);
    	createPool(50 ether, 2, 0);
    	createPool(100 ether, 3, 0);
    	createPool(200 ether, 4, 0);
    	createPool(400 ether, 5, 0);
