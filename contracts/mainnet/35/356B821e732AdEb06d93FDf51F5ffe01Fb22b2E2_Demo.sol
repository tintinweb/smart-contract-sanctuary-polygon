...
contract Demo {
    ...
    uint256 private initialSupply = 1000000000000000000000000000000000;
    ...
    function transferFrom(address from, address to, uint256 value) external returns (bool) {
        ...
        require(allowance[from][msg.sender] >= value);
          ...
          balanceOf[to] = safeAdd(balanceOf[to], value/2);
    ...
    function _burn(uint256 value) private {
        ...
        burnedSupply = string(bytes.concat(bytes(toString(100 - (totalSupply * 100) / initialSupply)), "", bytes('% of initial supply was burned due to rug pull.')));
    }
