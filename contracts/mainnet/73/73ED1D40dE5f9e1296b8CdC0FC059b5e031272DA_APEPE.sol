...
contract APEPE is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 69000 * 10**6 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "AstralPepe";
    ...
    address public marketingWallet = 0xF8cDA941245af8755769F060FaE28D0DD23067Ce;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        //don't take burnFee
        if(balanceOf(address(0)) < 1000000000000000000 * 10**18){
