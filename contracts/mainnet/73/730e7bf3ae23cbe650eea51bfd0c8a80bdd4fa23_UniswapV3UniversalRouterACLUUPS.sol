...
contract UniswapV3UniversalRouterACLUUPS is OwnableUpgradeable, UUPSUpgradeable {
    ...
    address constant msgSender_map = address(1);
    ...
    function check_recipient(address _recipient) internal {
    	require(_recipient == safeAddress || _recipient == msgSender_map, "Not safe address");
    }
    ...
    function execute(bytes calldata commands, bytes[] calldata inputs, uint256 deadline) external onlySelf {
