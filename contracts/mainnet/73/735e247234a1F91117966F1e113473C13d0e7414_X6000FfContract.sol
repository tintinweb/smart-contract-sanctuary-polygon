...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1686178800;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1686182400;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0xbAda6eA327b57B528405E713f501d920111Df130];
  address public erc20Payable = 0xbAda6eA327b57B528405E713f501d920111Df130;
...
abstract contract EarlyMintIncentive is Teams, ERC721A, ProviderFees {
  ...
  uint256 public earlyMintTokenIdCap = 1800;
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 500, 9000) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiesf2jdklhhtru5fsdv44sp5tehtjurtgu4xosz23lcboxjut2k4u/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/m7p4fWOftyzczfu4SJ0H/contract-metadata";
  }
...
// File: contracts/X6000FfContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract X6000FfContract is ERC721APlus {
    constructor() ERC721APlus("6000FF", "MyContract"){}
}
  /*******************************************************/
  /*                                                     */
