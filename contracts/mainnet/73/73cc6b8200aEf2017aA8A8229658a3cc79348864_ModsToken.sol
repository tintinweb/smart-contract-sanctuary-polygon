...
contract ModsToken is ERC20, Ownable {
  ...
  constructor() ERC20('Mods', 'MODS') {
    address router;
    if (block.chainid == 56) {
      router = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // BSC Pancake Mainnet Router
    } else if (block.chainid == 97) {
      router = 0xDE2Db97D54a3c3B008a097B2260633E6cA7DB1AF; // BSC Pancake Testnet Router
    } else if (block.chainid == 1 || block.chainid == 5) {
      router = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // ETH Uniswap Mainnet % Testnet
    } else if (block.chainid == 137) {
      router = 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff; // MATIC Quickswap
    } else {
      
      revert("Chain ID not recognized");
    }
    ...
    maxWallet = 4_000_000_000_000 ether;

    developmentWallet = 0x36e478aFe02c521bed84Daf649C21515B9dBaEE7;
...
//     require(
//       _totalFeesOnBuy + _totalFeesOnSell <= 60,
...
//   ) external onlyOwner {
//     require(
//       _walletToWalletTransferFee <= 25,
//       'Wallet to Wallet Transfer Fee cannot exceed the maximum'
//     );
...
//   }
  ...
  function changeDevelopmentWallet(
    ...
    require(
      ...
      'Dev wallet is already that address'
    );
    require(
  ...
  function _transfer(
    ...
    if (
      ...
      uint256 ethShare = marketingFeeOnBuy +
        marketingFeeOnSell +
        developmentFeeOnSell +
        developmentFeeOnBuy;
      ...
      if (ethShare > 0) {
        uint256 tokens = (contractTokenBalance * ethShare) / totalFee;
  ...
  function swapAndSend(uint256 tokenAmount, uint256 ethFee) private {
    uint256 initialBalance = address(this).balance;
    ...
    uint256 newBalance = address(this).balance - initialBalance;
    uint256 marketing = (newBalance *
      (marketingFeeOnBuy + marketingFeeOnSell)) / ethFee;
