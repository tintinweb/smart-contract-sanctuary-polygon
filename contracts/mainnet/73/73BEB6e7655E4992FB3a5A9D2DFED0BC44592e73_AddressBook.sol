...
contract AddressBook is Initializable {
  address public bk;
  address public mn;
  ...
  function initialize() public initializer {
    bk = msg.sender;
    mn = msg.sender;
    contractCall = msg.sender;
  }

  function set(string calldata _name, address _address) external onlyMn {
  ...
  function transferOwnership(address _newValue) external onlyMn {
    require(_newValue != address(0x0));
    mn = _newValue;
    emit OwnershipTransferred(msg.sender, _newValue);
  }
  ...
  function updateBk(address _newValue) external onlyBk {
    require(_newValue != address(0x0));
    bk = _newValue;
  }
