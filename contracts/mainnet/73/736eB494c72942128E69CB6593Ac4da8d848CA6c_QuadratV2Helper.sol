...
/// @title QuadratV2Helper helpers for querying common info about QuadratV2 vaults
contract QuadratV2Helper is IQuadratV2Helper {
    ...
    /// @param vault_ Quadrat V2 vault to get underlying info about.
        ...
        returns (UnderlyingOutput memory underlying)
    {
        ...
        underlying.leftOver0 =
            ...
            IQuadratV2(underlyingPayload.self).managerBalance0();
        underlying.leftOver1 =
            IERC20(underlyingPayload.token1).balanceOf(underlyingPayload.self) -
            IQuadratV2(underlyingPayload.self).managerBalance1();
    }
    ...
    /// @param vaultV2_ address of Quadrat V2 vault.
