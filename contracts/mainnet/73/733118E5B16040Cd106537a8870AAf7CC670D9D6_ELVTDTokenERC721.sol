    ...
    ITokenERC721
{
    ...
    /// @dev Lets a module admin set the URI for token-level metadata.
    function setTokenURI(string calldata _uri, uint256 _tokenId) external onlyRole(DEFAULT_ADMIN_ROLE) {
        uri[_tokenId] = _uri;
    }
