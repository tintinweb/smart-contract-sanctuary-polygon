...
contract ParamountStaker {
    ...
    uint256 public constant MIN_AMOUNT = 8 ether;
    uint256 public constant MAX_AMOUNT = 5500 ether;
    uint256 public constant WITHDRAW_MAX_AMOUNT = 1800 ether;
    uint256 public constant MAXIMUM_NUMBER_DEPOSITS = 100;
    uint256[3] public REFERRAL_PERCENTS = [800, 400, 200];
    uint256 public constant MARKET_FEE = 500; // 5% market fee
    uint256 public constant MOUNT_FEE = 200; // 2% mount fee
    uint256 public constant DEV_FEE = 500; // 5% dev fee
    uint256 public constant INSURANCE_FEE = 200; // 2% insurance fee
    uint256 public constant REINVEST_PERCENT = 1000; // 10% insurance fee
