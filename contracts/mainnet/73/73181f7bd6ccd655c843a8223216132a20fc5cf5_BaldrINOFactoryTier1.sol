...
/* Baldr Nft ITO Contract Tier 1

Minting these NFTs will give you access to Baldr Tokens Tier 1 equivalent to 20 $BALDR on airdrop

*/



contract BaldrINOFactoryTier1 is ERC721, ERC721Enumerable, Pausable, Ownable {
    ...
    uint256 public MAX_ELEMENTS = 1036;

    uint256 public PRICE = 200000000; // price in token dec

    string private constant TOKEN_URI = "/1.json"; //Metadata Id



    constructor(address _payableToken, address _baldrDeployer) ERC721("Baldr INO NFT Tier 1", "pBALDR") {
    ...
    function _baseURI() internal pure override returns (string memory) {
        ...
        return "ipfs://QmRoL12iTYV3XEZyLNuhLG21CPLTYLLbcU9qevSZUSB8fX"; //metadata url
