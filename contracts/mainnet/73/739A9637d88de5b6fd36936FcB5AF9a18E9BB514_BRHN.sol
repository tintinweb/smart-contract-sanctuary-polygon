...
contract BRHN is BRHNDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private BRHNTeam;
    address private CharityBRHN;
    ...
    string public override name = "BerehyniaNFT";
    string public override symbol = "BRHN";
    ...
    constructor(uint totalSupplyValue, address BRHNTeamAddress, address CharityBRHNAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        BRHNTeam = BRHNTeamAddress;
        CharityBRHN = CharityBRHNAddress;
        
        // split the tokens according to agreed upon percentages
        balances[BRHNTeam] =  totalSupply * 4 / 100;
        balances[CharityBRHN] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's BRHNTeam pot
