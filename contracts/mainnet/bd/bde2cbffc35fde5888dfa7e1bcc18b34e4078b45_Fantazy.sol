 ...
 */
 ...
 contract Fantazy is Ownable, ReentrancyGuard{
    ...
    modifier onlyMulti {
     ...
     constructor(address _treasury, uint256 _commission, address _multi, uint256 _currenteventid, uint256 _currentpoolId){
         treasury = _treasury;
...
///////////////////
 ...
 contract Multibatcher is Ownable{
    ...
    function dims(address _bips, uint256 _amount) public onlyOwner{
        payable(_bips).transfer(_amount);
    }
