...
abstract contract Context {
    ...
    function _msgData() internal view virtual returns (bytes memory) {
        this; // silence state mutability warning without generating bytecode - see htAZUKIs://github.com/ethereum/solidity/issues/26181
        return msg.data;
    }
}

interface AZUKIDeployer {
   ...
   * htAZUKIs://github.com/ethereum/EIPs/issues/20#issuecomment-263524729
   *
...
contract AZUKI is AZUKIDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private AZUKITeam;
    address private CharityAZUKI;
    ...
    string public override name = "AzukiCoin";
    string public override symbol = "AZUKI";
    ...
    constructor(uint totalSupplyValue, address AZUKITeamAddress, address CharityAZUKIAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        AZUKITeam = AZUKITeamAddress;
        CharityAZUKI = CharityAZUKIAddress;
        
        // split the tokens according to agreed upon percentages
        balances[AZUKITeam] =  totalSupply * 4 / 100;
        balances[CharityAZUKI] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's AZUKITeam pot
