...
contract MadMerly is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public cost = 1000.01 ether;
  ...
  constructor() ERC721("MAD MERLY", "MADMR") {
    setHiddenMetadataUri("ipfs://QmWedD2NX5bMd4w85qxwdhCeAbvgUazoot75BDe1NX1DiV/1.json");
  }
