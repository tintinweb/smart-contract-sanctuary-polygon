    ...
    TokenWithdrawer
{
    ...
    event SetRaceFactory(
        address indexed oldRaceFactory,
        address indexed newRaceFactory
    );
    event SetRaceEventFactory(
        address indexed oldRaceEventFactory,
        address indexed newRaceEventFactory
    );
    event SetRewardFactory(
        address indexed oldRewardFactory,
        address indexed newRewardFactory
    );
    ...
    constructor(address[5] memory config_addrs) {
        require(config_addrs[0] != address(0), "Zero address");
        require(config_addrs[1] != address(0), "Zero address");
        require(config_addrs[2] != address(0), "Zero address");
        require(config_addrs[3] != address(0), "Zero address");
        require(config_addrs[4] != address(0), "Zero address");

        _setGame(config_addrs[0]);
    ...
    function setRewardFactory(address rewardFactory_)
        ...
        onlyOwner
    {
        require(rewardFactory_ != address(0), "Zero address");

        address oldRewardFactory = rewardFactory;
        rewardFactory = rewardFactory_;
        emit SetRewardFactory(oldRewardFactory, rewardFactory_);
    }
    ...
    function setRaceEventFactory(address raceEventFactory_)
        ...
        onlyOwner
    {
        require(raceEventFactory_ != address(0), "Zero address");
        address oldRaceEventFactory = address(raceEventFactory);
        raceEventFactory = IRaceEventFactory(raceEventFactory_);
        emit SetRaceEventFactory(oldRaceEventFactory, raceEventFactory_);
    }
    ...
    function setRaceFactory(address raceFactory_) external override onlyOwner {
        require(raceFactory_ != address(0), "Zero address");
        address oldRaceFactory = address(raceFactory);
        raceFactory = IRaceFactory(raceFactory_);
        emit SetRaceFactory(oldRaceFactory, raceFactory_);
    }
        ...
        onlyOwner
    {
        ...
        emit SetTreasuryWallet(oldTreasuryWallet, treasuryWallet_);
    }
