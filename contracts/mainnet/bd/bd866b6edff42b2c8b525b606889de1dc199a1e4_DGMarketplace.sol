...
contract DGMarketplace is Ownable, ReentrancyGuard, EIP712MetaTransaction {
    ...
    event Cancel(address indexed _nftAddress, uint256 indexed _tokenId);
    event Buy(address indexed _nftAddress, uint256 indexed _tokenId);
    ...
    function sell(
        ...
        for (uint256 i = 0; i < _tokenIds.length; i++) {
            ...
            emit Sell(_nftAddress, tokenId, price);
        }
        ...
        nonReentrant
    {
        ...
        for (uint256 i = 0; i < _tokenIds.length; i++) {
            ...
            emit Cancel(_nftAddress, tokenId);
        }
