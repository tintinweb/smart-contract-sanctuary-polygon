...
//File： fs://6e44ae68ad9e44ce94c8e14e33225036/LiveTheFuture.sol
...
contract LiveTheFuture is DefaultOperatorFilterer, ERC721A, Ownable {
    using Address for address;
    using Strings for uint256;
    ...
    uint256 public countDayOne = 0;
    uint256 public countDayTwo = 0;
    uint256 public countDayThree = 0;
    uint256 public countDayFour = 0;
    ...
    constructor() ERC721A("Web3InSummit", "LTF") {
        contractUri = "https://gateway.pinata.cloud/ipfs/QmfPyTXyumQSGqCtBDb4C7boQUUdkUcquQyp7wcaQqirnK";
