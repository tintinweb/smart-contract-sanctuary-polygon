    ...
    ReentrancyGuard
{
    ...
    function mint(
        ...
        _mint(fmCreatorAddress_, _newTokenId, amountForCreator, "");
        ...
        returns (string memory)
    {
        ...
        return
            fmCollection[tokenId_].fmHidden
                ? fmHiddenURL
    ...
    function fmCreatorAddress(uint256 tokenId_)
        ...
        returns (address)
    {
        return fmCollection[tokenId_].fmCreatorAddress;
    }
    ...
    function fmCharityFees(uint256 tokenId_)
        ...
        returns (uint256)
    {
        return fmCollection[tokenId_].mpCharityFees;
    }
    ...
    function fmFantasticoFees(uint256 tokenId_)
        ...
        returns (uint256)
    {
        return fmCollection[tokenId_].mpFantasticoFees;
    }
    ...
    function hideFm(uint256 tokenId_) public onlyRole(ADMIN_ROLE) {
        ...
        fmCollection[tokenId_].fmHidden = true;
    ...
    function unhideFm(uint256 tokenId_) public onlyRole(ADMIN_ROLE) {
        ...
        fmCollection[tokenId_].fmHidden = false;
    ...
    function isHidden(uint256 tokenId_)
        ...
        returns (bool)
    {
        return fmCollection[tokenId_].fmHidden;
    }
