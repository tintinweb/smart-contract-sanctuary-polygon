...
contract TAOMI is ERC721, Pausable, Ownable {
    ...
    uint256 public unitPrice = 45000000000000000000; //45 MATIC

    constructor() ERC721("The Art of Making It", "TICKET") {}
    ...
    function mintInternal(address [] memory to)
        public
        onlyOwner
    {
