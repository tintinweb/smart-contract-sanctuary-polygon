...
contract ApetimismLaunchpadNFT is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  uint256 public constant MAX_SUPPLY = 800000;
  uint256 private constant START_TOKEN_ID = 1;
  string private constant TOKEN_NAME = "VKura";
  string private constant TOKEN_SYMBOL = "VK";
  ...
  address public signerAddress = 0x7e1ecaFcc52Ed0BC79cBda81A0b9115e34C9E0EF;
