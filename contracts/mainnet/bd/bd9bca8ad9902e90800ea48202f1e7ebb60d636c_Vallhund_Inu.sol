...
///  |   /  |         /  |/  |/  |                                /  |      /      |                    
//$$ |   $$ | ______  $$ |$$ |$$ |____   __    __  _______    ____$$ |      $$$$$$/  _______   __    __ 
//$$ |   $$ |/      \ $$ |$$ |$$      \ /  |  /  |/       \  /    $$ |        $$ |  /       \ /  |  /  |
//$$  \ /$$/ $$$$$$  |$$ |$$ |$$$$$$$  |$$ |  $$ |$$$$$$$  |/$$$$$$$ |        $$ |  $$$$$$$  |$$ |  $$ |
// $$  /$$/  /    $$ |$$ |$$ |$$ |  $$ |$$ |  $$ |$$ |  $$ |$$ |  $$ |        $$ |  $$ |  $$ |$$ |  $$ |
//  $$ $$/  /$$$$$$$ |$$ |$$ |$$ |  $$ |$$ \__$$ |$$ |  $$ |$$ \__$$ |       _$$ |_ $$ |  $$ |$$ \__$$ |
...
// Vallhund Inu - 4% + 8% USDC Rewards for holding!
// Manual Buyback & Strong Marketing! 
// Dev team is Trusted + Live-Doxxed!
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 BETH = IBEP20(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174);
...
/* Token contract */
contract Vallhund_Inu is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BETH = 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174; 
    address WBNB = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xC14A90dd402232173596e1B8667B9d6a7A60c98e; // Development here
    address MARKETING = 0xbd828156c2353aEAA764996F2Ae16b52a3f93c12; // Marketing here                                                                                                                                   
    ...
    // Name and symbol
    string constant _name = "Vallhund Inu";
    string constant _symbol = "VHIN";
    uint8 constant _decimals = 9;

    // Total supply
    uint256 _totalSupply = 100_000_000_000 * (10 **9);

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 400 / 10000; // 4%
    uint256 public _maxSellTxAmount = _totalSupply * 50 / 10000; // 0,5%
    uint256 public _maxWalletToken = ( _totalSupply * 400 ) / 10000; // 4%
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xbd828156c2353aEAA764996F2Ae16b52a3f93c12;
    ...
    function getTotalFee(bool selling) public view returns (uint256) {
        if(launchedAt + quickScope >= block.number){ return feeDenominator.sub(1); }
