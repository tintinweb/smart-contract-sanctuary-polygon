...
contract EarlyAdopters is Ownable {
    ...
    /**
     *  @notice Adds a single address to the priorityList
    ...
    /**
     *  @notice Adds multiple addresses to the priorityList
     *  @param _addresses: dynamic array of addresses to add to the priorityList
     */
    ...
    /**
     *  @notice Removes an address from the priorityList
     *  @param _address: address to remove from the priorityList
     */
     ...
     *  @param _addresses: dynamic array of addresses to add to the whitelist
     */
    ...
    /**
     *  @notice Checks if an address is in the whitelist or priorityList
     *  @param _address: address to check
     *  @return status: string message indicating the user's status
     */
    function userStatus(address _address) external view returns (string memory) {
        if (whitelisted[_address]) {
            return "Congratulations! You are Pre-selected for Early-Adopters Reward";
        } else if (priorityList[_address]) {
            return "You are in PriorityList";
        } else {
