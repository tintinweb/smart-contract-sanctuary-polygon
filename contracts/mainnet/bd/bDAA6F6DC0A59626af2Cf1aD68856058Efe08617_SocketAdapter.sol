...
import "../interfaces/external/ISocket.sol";

contract SocketAdapter is AdapterBase {
    struct SocketArgs {
        address approveTo;
        ISocket.UserRequest request;
    }
    ...
    function call(
        ...
        SocketArgs memory socketArgs = abi.decode(args, (SocketArgs));
        socketArgs.request.amount = amountIn;

        Transfers.approve(tokenIn, socketArgs.approveTo, amountIn);
        ISocket(target).outboundTransferTo{
