...
contract TheCatDogClub is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://QmTMHDPMcrBdFuQdjrBBeNU7PJvHp3ZR1FSELReXSf5oME/", Strings.toString(tokenId), ".json")
            );
    }
