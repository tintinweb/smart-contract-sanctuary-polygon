...
/*
PRELUDE:
   While I believe this contract is safe and secure to use,
   ...
   for any other purposes, take this into consideration. DYOR. Yaya.

IMPORTANT NOTES:
   This contract is ONLY intended to be used with utility tokens that have no monetary value. 
...
*/
contract SmokeBattle_V1 is VRFConsumerBaseV2 {
    ...
    */
    function createGame(
        ...
        require(
            ...
            "Must require more than 25 SMOKE to enter"
        );
    ...
    */
    ...
    function _completeGame(uint256 _gameIndex, uint256 _randomWord) private {
        ...
        uint256 gameFeePerEntrant = game.entryFee / uint256(10); // 10% rake, with a minimum of 25 SMOKE safe for any values < 1
