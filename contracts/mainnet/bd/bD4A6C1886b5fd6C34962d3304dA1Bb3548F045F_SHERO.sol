...
contract SHERO is ERC721, Ownable {
  ...
  constructor() ERC721("Inception Hero Female", "SHERO") {
    setHiddenMetadataUri("ipfs://__CID__/hidden.json");
  }

    function baseTokenURI() public pure returns (string memory) {
        return "https://www.inceptionhero.com/shero/metadata/";
    }

    function contractURI() public pure returns (string memory) {
        return "https://www.inceptionhero.com/intro.json";
    }
