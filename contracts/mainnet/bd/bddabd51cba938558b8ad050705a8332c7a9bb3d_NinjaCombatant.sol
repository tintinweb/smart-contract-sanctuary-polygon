...
// File: contracts/NinjaCombatant.sol
    ...
    Ownable
{
    ...
    constructor(
    ) ERC721("Ninja Combatant", "NC") {
        setNotRevealedUri("ipfs://QmUHCJEBHL81RmtiW9aFakgx75WEfsk3V2VXrCjYnQRv1a/");
        setBaseUri("ipfs://QmUHCJEBHL81RmtiW9aFakgx75WEfsk3V2VXrCjYnQRv1a/");
    }
    ...
    function mintMany(uint256 ammount) public payable {
        require(msg.value == NFT_price, "Sent Amount Not Enough");
        _mintLoop(_msgSender(), ammount);
    }
