...
// File: .deps/contracts/Artion.sol
...
contract Artion is ERC721("Artion", "ART"), Ownable {
    ...
    function mint(address _beneficiary) external payable returns (uint256) {
        ...
        // Valid args
        _assertMintingParamsValid(_msgSender());
        ...
        emit Minted(tokenId, _beneficiary, _msgSender());
     ...
     */
    function _assertMintingParamsValid(address _designer) pure internal {
