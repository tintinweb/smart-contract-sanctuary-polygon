...
interface ISwapGateway {
    ...
    function uniswapV3ExactTokensForTokens(
        address swap,
        uint256 amountIn,
        uint256 amountOutMin,
        address[] memory path,
    ...
    function uniswapV3TokensForExactTokens(
        address swap,
        uint256 amountOut,
        uint256 amountInMax,
        address[] memory path,
    ...
    function getFarmingRewardsPancakeSwap(
        address holder,
        address swapMaster,
        uint256 poolID,
        bool isBalance
    ) external view returns (address rewardsToken, uint256 rewardsAmount);

    function getFarmingRewardsApeSwap(
        address holder,
        address swapMaster,
        uint256 poolID,
        bool isBalance
    ...
    function getFarmingRewardsBiSwap(
        address holder,
        address swapMaster,
        uint256 poolID,
        bool isBalance
    ...
    function uniswapV3QuoteExactInput(
        address token,
        uint256 amountIn,
        address uniswapV3Pool
    ) external view returns (uint256 amountOut, address tokenOut);

    function findUniswapV3Pool(
