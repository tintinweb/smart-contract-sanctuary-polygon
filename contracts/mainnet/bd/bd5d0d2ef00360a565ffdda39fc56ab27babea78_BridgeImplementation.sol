...
contract BridgeGovernance is BridgeGetters, BridgeSetters, ERC1967Upgrade {
    ...
    function verifyGovernanceVM(bytes memory encodedVM) internal  returns (IWormhole.VM memory parsedVM, bool isValid, string memory invalidReason){
...
contract Bridge is BridgeGovernance, ReentrancyGuard {
    ...
    function verifyBridgeVM(IWormhole.VM memory vm) internal  returns (bool){
