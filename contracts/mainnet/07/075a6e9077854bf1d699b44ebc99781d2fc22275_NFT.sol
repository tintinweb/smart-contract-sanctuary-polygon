...
contract NFT is ERC721Enumerable, Ownable {
  ...
  uint256 public maxSupply = 5; // количество нфт в вашей коллекции
  uint256 public maxMintAmount = 5; //количество нфт которое будет сминчено при деплое смарт контракта
