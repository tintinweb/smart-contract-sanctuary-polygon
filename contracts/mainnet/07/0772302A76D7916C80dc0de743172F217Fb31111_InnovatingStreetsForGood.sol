...
// File: InnovatingStreetsForGood.sol

/**
 * The Reimagining Cities Community focuses on civic innovation for 
 * good—harnessing big ideas to address things like transportation, 
 * housing, environmental sustainability, infrastructure, and economic 
 * regeneration. It features exclusive art and experiences from Billy 
 * Riggs, global expert and thought leader in the areas of future 
 * cities, transport, and the sustainability of our urban systems.
 */
contract InnovatingStreetsForGood is ViciManagedERC721WithRecall {
    constructor()
        ViciManagedERC721WithRecall(
            "Innovating Streets for Good",
            "ISfG",
            1000,
            IERC2981(address(0xf3f6DC7b33DF68a40A9B3425A4Fa694EfeBdB526))
        )
    {
        setContractURI("ipfs://Qmctz9umFTtSVA6wfwfgL15GdNi9kjxuBEcqmsSAPPmsiL");
    }
