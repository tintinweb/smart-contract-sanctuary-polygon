...
contract SimpleSwap is FeeModel, IRouter {
    ...
    ) public FeeModel(_partnerSharePercent, _maxFeePercent, _paraswapSlippageShare, _feeClaimer) {
    ...
    function performSimpleBuy(
        ...
        if (
            ...
            // Transfer remaining token back to beneficiary
            ...
            } else if (remainingAmount.add(expectedAmount) > fromAmount) {
                takeSlippageAndTransferBuy(
                    fromToken,
                    beneficiary,
                    partner,
                    remainingAmount.add(expectedAmount),
                    fromAmount,
                    remainingAmount,
                    feePercent
                );
