...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x1AFD4B41FD1fa8060037e01123f27C68CaD2D5e7,0x26828EB55c67644ba73F14BE1bD9624Ec1709080];
  address public erc20Payable = 0x1AFD4B41FD1fa8060037e01123f27C68CaD2D5e7;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 77, 7777) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeih4r5daacw4ccwx7wmmgp2bxhc23vktytbfsrjkkvz6s7qng2vdb4/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/fPWH8avfxjjWs5vNaAy9/contract-metadata";
  }
...
// File: contracts/BinaryBodiContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BinaryBodiContract is ERC721APlus {
    constructor() ERC721APlus("Binary Bodi", "BODI"){}
}
