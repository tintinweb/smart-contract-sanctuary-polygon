...
contract MutantAstronaut is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  constructor(
    ...
    function altMint(uint256 _mintAmount, address _token) public payable {
        ...
        uint256 allowance = transactionToken.allowance(msg.sender, address(this));
        require(allowance >= tokenPrices[_token] * _mintAmount, "Check the token allowance");
