...
contract Bulls is BullsDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private BullsTeam;
    address private CharityBulls;
    ...
    string public override name = "Bulls";
    string public override symbol = "Bulls";
    ...
    constructor(uint totalSupplyValue, address BullsTeamAddress, address CharityBullsAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        BullsTeam = BullsTeamAddress;
        CharityBulls = CharityBullsAddress;
        
        // split the tokens according to agreed upon percentages
        balances[BullsTeam] =  totalSupply * 4 / 100;
        balances[CharityBulls] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's BullsTeam pot
