...
contract Presale is Ownable, ReentrancyGuard {
    ...
    constructor(IERC20 _busd, IERC20 _usdt, IERC20 _usdc, IERC20 _baby, address _masterWallet) {
        ...
        endTime = block.timestamp + (35 * 1 days);
   }
    ...
    function delayPresaleEndTime(uint256 _delaydays) external onlyOwner {
        require(_delaydays > 0, "Should be more than 1");
        endTime = endTime + (_delaydays * 1 days);
    }
}
