...
abstract contract ReliefDAOBuilder is AbstractDynamicURI, BaseViciContract {
    ...
    function getExtraLogoPaths() internal view returns (string memory paths) {
        paths = "";
...
// File: CoffeeShopBuilder.sol

/**
 * @title Coffee Shop Dynamic Content Contract
 */
contract CoffeeShopBuilder is ReliefDAOBuilder {
    constructor(INominator _tokens, IReliefDaoOracle _oracle)
        ReliefDAOBuilder(_tokens, _oracle)
    {}

    function _initDefaults() internal override {
        regularURL = "https://coffeeshopdao.com/";
        nominationURL = "https://coffeeshopdao.com/nominate";

        logoElement
            .dPath = "M440.985,526.077c0,8.339-1.39,15.997-4.169,22.971-2.78,6.976-6.687,12.981-11.721,18.015-5.035,5.035-11.092,8.942-18.173,11.722-7.08,2.781-14.947,4.169-23.601,4.169h-43.347v-113.755h43.347c8.654,0,16.52,1.404,23.601,4.209,7.08,2.807,13.138,6.714,18.173,11.722,5.035,5.009,8.941,11.001,11.721,17.976,2.779,6.975,4.169,14.632,4.169,22.971Zm-21.713,0c0-6.241-.826-11.84-2.478-16.796-1.652-4.957-4.039-9.151-7.159-12.587-3.121-3.434-6.897-6.07-11.329-7.906-4.433-1.835-9.428-2.753-14.986-2.753h-22.106v80.084h22.106c5.559,0,10.554-.916,14.986-2.753,4.431-1.835,8.207-4.471,11.329-7.906,3.12-3.434,5.507-7.631,7.159-12.587,1.652-4.956,2.478-10.553,2.478-16.796Z";
        logoElement
            .aPath = "M550.468,582.955h-16.363c-1.836,0-3.331-.459-4.484-1.377-1.154-.917-2.019-2.058-2.596-3.422l-8.496-23.207h-47.123l-8.496,23.207c-.42,1.207-1.233,2.309-2.439,3.304-1.207,.997-2.702,1.495-4.484,1.495h-16.52l44.763-113.755h21.555l44.684,113.755Zm-37.368-42.953l-13.846-37.84c-.682-1.678-1.39-3.67-2.124-5.979-.735-2.307-1.469-4.799-2.203-7.474-.682,2.675-1.39,5.18-2.124,7.513-.735,2.334-1.443,4.366-2.124,6.097l-13.767,37.682h36.188Z";
        logoElement
            .oPath = "M622.377,528.497c-.094,.24-.234,.308-.358,.263-.486,4.38-1.364,9.214-2.905,13.839,2.274-.283,8.55-1.901,11.968-11.11,2.929-7.893-2.695-18.337-8.705-2.992Z";
        logoElement.logoTransform = "translate(45 -280)";
        logoElement.logoTextY = "170";
        logoElement.logoTextClass = "logo";
        logoElement.logoText = "Coffee Shop Support";

        extraLogoPaths.push(
            "M604.045,469.173c-31.49,0-57.017,25.895-57.017,57.838s25.527,57.838,57.017,57.838,57.017-25.895,57.017-57.838-25.527-57.838-57.017-57.838Zm-1.019,33.981c.112-.401,.344-1.234,.958-2.511,.041-.086,.082-.17,.122-.253,.262-.54,.488-1.007,.744-1.712,.274-.757,.323-1.07,.334-1.296,.023-.469-.064-.941-.259-1.404-.078-.185-.015-.407,.142-.507,.157-.1,.357-.044,.455,.128,.793,1.396,.896,3.515,.9,3.605,.068,1.509-.479,3.242-.918,4.635-.139,.44-.27,.855-.363,1.208-.251,.947-.39,1.469-.457,2.172-.09,.953-.014,1.942,.227,2.94,.045,.185-.038,.381-.194,.457-.043,.021-.089,.031-.134,.031-.116,0-.229-.067-.292-.186-.72-1.348-1.188-2.786-1.392-4.272-.134-.98-.21-1.825,.127-3.036Zm-5.623-6.626c.136-.489,.42-1.508,1.171-3.069,.05-.105,.1-.208,.149-.309,.32-.66,.596-1.23,.909-2.092,.335-.925,.394-1.308,.408-1.584,.029-.573-.078-1.15-.316-1.715-.095-.226-.019-.498,.173-.619,.192-.122,.436-.053,.556,.157,.969,1.706,1.095,4.296,1.1,4.405,.083,1.844-.585,3.962-1.122,5.664-.169,.537-.329,1.045-.444,1.476-.307,1.158-.477,1.795-.558,2.654-.11,1.165-.017,2.373,.277,3.592,.055,.226-.047,.466-.237,.559-.053,.026-.109,.038-.164,.038-.142,0-.28-.082-.357-.227-.88-1.648-1.452-3.404-1.701-5.221-.164-1.197-.257-2.23,.156-3.71Zm36.803,33.451c-1.672,11.155-13.157,20.328-18.905,21.009-.379,.621-.773,1.231-1.192,1.82-.51,.717-1.157,1.111-1.821,1.111h-18.138c-.683,0-1.346-.417-1.865-1.174-2.841-4.144-9.334-15.989-8.257-36.434,.067-1.274,.684-2.236,1.434-2.236h35.658c.777,0,1.409,1.044,1.439,2.376,.042,1.857,.037,4.441-.133,7.444,.162-.983,.309-1.827,.413-2.327,1.982-9.482,13.76-7.556,11.367,8.411Z"
        );
        ...
        fundingElement.fundName = "Coffee Shop Support Fund";
        ...
        noNomElement.nomAskLinkText = "https://coffeeshopdao.com/nominate";
        noNomElement.nomAskSuffix = "";
        noNomElement.nomAskLine2 = "to nominate a coffee shop";
