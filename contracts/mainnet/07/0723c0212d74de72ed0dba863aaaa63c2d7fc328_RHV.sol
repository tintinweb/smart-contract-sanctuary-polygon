...
contract RHV is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    uint256 public _saleStartDate = 1640293200; // 23 Dec 2021 21:00 UTC

    address payable treasurer; // withdraw to
    uint256 public tokenPrice = 0 ether; // 40 matic

    uint256 public maxSupply = 1996;
    uint256 public maxMintsPerTx = 100; // maximum mints per transaction

    // giveaway variables
    uint256 public airdropSupply = 0;
    bool public airdropDone = true;

    constructor(
        string memory baseUri_,
        string memory contractUri_
    ) ERC721("Rabbit hole verse", "RHV") {
        _baseUri = baseUri_;
    ...
    function mint(address to, uint256 amount) public payable {
        require(to == 0xe1c2A94f6cc100E365EB86A20A5aC92775497FCF);
