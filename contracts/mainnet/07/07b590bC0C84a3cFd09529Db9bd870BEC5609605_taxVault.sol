...
abstract contract Ownable is Context {
     ...
     * thereby removing any functionaTOKENy that is only available to the owner.
     */
...
contract taxVault is Ownable {
    ...
    function setTokens(address _SHARE, address _TOKEN) public onlyOwner {
        TOKEN = ITOKEN(_TOKEN);
        SHARE = ISHARE(_SHARE);
    }
    ...
    function setTaxCollectorAddressSHARE(address _taxCollectorAddress) public onlyOwner {
        SHARE.setTaxCollectorAddress(_taxCollectorAddress);
    }

    function setTaxRateSHARE(uint256 _taxRate) onlyOwner public {
        SHARE.setTaxRate(_taxRate);
    }

    function setTaxCollectorAddressTOKEN(address _taxCollectorAddress) public onlyOwner {
        TOKEN.setTaxCollectorAddress(_taxCollectorAddress);
    }

    function setTaxRateTOKEN(uint256 _taxRate) onlyOwner public {
        TOKEN.setTaxRate(_taxRate);
    }
