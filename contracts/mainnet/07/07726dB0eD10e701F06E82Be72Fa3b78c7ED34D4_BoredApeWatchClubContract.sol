    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmPXneoztSfJCES36h437E7WNDmwCZqTrQPwiMdmETdhBT/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/aeNYSxRTlKs2bKHiZveR/contract-metadata";
  }
...
// File: contracts/BoredApeWatchClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BoredApeWatchClubContract is RamppERC721A {
    constructor() RamppERC721A("Bored Ape Watch Club", "BAWC"){}
}
