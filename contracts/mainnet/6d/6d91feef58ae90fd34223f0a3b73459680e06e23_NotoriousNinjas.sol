...
contract NotoriousNinjas is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Notorious Ninjas", "NON") {
    setHiddenMetadataUri("ipfs://QmYUcFXie8YNyVTQkfY7Zf9fnVB5a49sfbDsTpKxbnhn7a/hidden.json");
  }
