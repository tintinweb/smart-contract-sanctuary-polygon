...
contract MaltRepository is AccessControl {
  ...
  function addNewContract(string calldata _name, address _contract)
    external
  ...
  function removeContract(string calldata _name)
    external
    onlyRole(TIMELOCK_ROLE)
  {
  ...
  function updateContract(string calldata _name, address _contract)
    external
    onlyRole(TIMELOCK_ROLE)
  {
