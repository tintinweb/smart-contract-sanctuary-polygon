...
interface IMarket{
    ...
    event Buy(address indexed seller, address buyer,uint256 quantity, uint256 indexed price,uint256 indexed tokenId);
    event MarketItemCreated(address indexed nftAddress, address indexed seller, uint256 price, uint256 indexed tokenId);
    event ApproveBid(address seller, address indexed bidder, uint256 indexed price, uint256 indexed tokenId);
    event Claim(address indexed seller, address bidder, uint256 indexed price, uint256 indexed tokenId);
...
contract EpikoMarketplace is IMarket,Ownable{
    ...
    function buyItem(
        ...
        if(IERC721(nftAddress).supportsInterface(ERC721InterfaceId)){
            ...
            emit Buy(sale.seller, buyer, quantity, price, tokenId);
