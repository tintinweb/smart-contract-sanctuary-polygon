    ...
    UUPSUpgradeable
{
    ...
    function initialize(address payable _theosProtocolAddress, uint256 _theosProtocolFee) public initializer {
    ...
    /// @notice Changes Theos protocol fee
    /// @param _newProtocolFee new protocol fee
    function setTheosProtocolFee(uint256 _newProtocolFee) public onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    /// @param tokenAddress NFT Collection address
    /// @param tokenId token id
    function unlistItem(address tokenAddress, uint256 tokenId) public {
    ...
    /// @notice Used to check what is the buy item price
    function getItemPriceWithFee(address tokenAddress, uint256 tokenId) public view returns (uint256) {
