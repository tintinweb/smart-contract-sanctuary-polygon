...
contract HealthClub is ERC1155Supply, IMintableERC1155, AccessControl {
    ...
    function mintToUser(
        ...
        require(amount != 0, "HealthClub: zero");
        require(
            totalSupply(id) + amount <= maxSupplies[id],
            "HealthClub: exceed supply"
        );
        _mint(to, id, amount, "");
    }
