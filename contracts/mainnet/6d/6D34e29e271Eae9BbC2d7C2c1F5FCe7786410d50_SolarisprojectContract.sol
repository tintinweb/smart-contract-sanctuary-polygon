...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x0a74070Fb9E9FF1AfCdeb6A51826a5422d464C66];
...
// File: contracts/SolarisprojectContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract SolarisprojectContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "SOLARIS PROJECT";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/8fv8mk5NYZwJgjnWB8vq/contract-metadata";
  }
