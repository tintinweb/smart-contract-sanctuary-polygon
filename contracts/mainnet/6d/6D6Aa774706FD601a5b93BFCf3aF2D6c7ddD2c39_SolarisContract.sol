...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x76CB1a3436cCB7C6B2356E408BFB35985E0436Ae];
...
// File: contracts/SolarisContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract SolarisContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/q8uBEGbaHVeT9ZmWiFCt/contract-metadata";
  }
