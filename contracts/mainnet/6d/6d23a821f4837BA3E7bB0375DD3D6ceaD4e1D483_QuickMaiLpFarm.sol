        ...
        returns (ActionBalance memory)
    {
        ...
        return
            ActionBalance({
                ...
                lpUnderlyingBalances: string(abi.encodePacked(Strings.toString(amount0), ",", Strings.toString(amount1))),
                lpUnderlyingTokens: string(abi.encodePacked(Strings.toHexString(uint160(pool.token0()), 20), ",", Strings.toHexString(uint160(pool.token1()), 20)))
            });
    }
