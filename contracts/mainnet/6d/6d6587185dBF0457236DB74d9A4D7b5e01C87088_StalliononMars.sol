...
contract StalliononMars is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_, address proxyRegistryAddress_)
    ERC721("Stallion on Mars", "SonM")
  {
  ...
  uint256 public constant PRICE = 70000000000000010;
  ...
  function mint(uint256 count) public payable nonReentrant onlyOwner {
    ...
    require(
      msg.value >= PRICE * count, "Insufficient payment, 0.07 ETH per item"
    );
