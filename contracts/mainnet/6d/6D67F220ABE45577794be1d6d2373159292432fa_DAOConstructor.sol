...
contract DAOConstructor is Ownable, __with_semver(uint8(1), uint8(1), uint8(0)) {
    ...
    function deploy(
        ...
        kernel.initialize(updateManager, address(this), deploymentSettings.adminSettings.releaseManager, oracle);
