...
contract MyNFT is ERC721, IERC2981, Ownable, ReentrancyGuard {
    ...
    uint256 public constant MAX_TOTAL_SUPPLY = 2;

    uint256 public constant MAX_PRE_SALE_MINTS = 1;
    uint256 public constant PRE_SALE_PRICE = 0.0000 ether;

    uint256 public constant MAX_PUBLIC_SALE_MINTS = 1;
    uint256 public constant PUBLIC_SALE_PRICE = 0.0000 ether;

    uint256 public constant MAX_RESERVE_TOKENS = 2;
