...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0xaEA392E894186cC86d1264a0581b6247bDD40aDC,0x10484efCb02F7C06414c516D73477264771312D8,0x5d33792EE709682fdD91924163d520238045445b];
  address public erc20Payable = 0xaEA392E894186cC86d1264a0581b6247bDD40aDC;
  uint256[] public payableFees = [2,68,20,10];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 390) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiaqedw5hvfrob6nanwjjma7bafgj2nyo6bwkor4ga33hpw6ifyqsy/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/VHYX03LzkkK65OopC1cx/contract-metadata";
  }
...
// File: contracts/SoundMasksContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SoundMasksContract is ERC721APlus {
    constructor() ERC721APlus("Sound Masks", "ASM"){}
}
  /*******************************************************/
  /*                                                     */
