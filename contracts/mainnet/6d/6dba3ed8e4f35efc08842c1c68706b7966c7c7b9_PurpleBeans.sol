...
contract PurpleBeans {
    ...
    uint256 constant launch = 1674230400;      //Launch in Jan 20 4:00:00 PM UTC
    ...
    uint256 private MAX_WALLET_TVL_IN_MATIC = 100000000000000000000000; // 100K MATIC
    uint256 private MAX_DAILY_REWARDS_IN_MATIC = 10000000000000000000000; // 10K MATIC
...
constructor()  {
    ...
    function calcGiveAwayAmount(address adr, uint256 maticWithdrawalAmount)
        ...
        returns (uint256)
    {
       return (percentFromAmount(maticWithdrawalAmount, hasBeanTaxed(adr)));
    }
