...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xfCE7d29836b27851f4f97E4b9fCE4d2031802Da1];
  address public erc20Payable = 0xfCE7d29836b27851f4f97E4b9fCE4d2031802Da1;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1000, 3500) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmNktfLgpcQQKw1SccPuvPxf4kP382WEYQC1r2YijMPQf7/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/tDdKvEIzpMcj1Sayx6j8/contract-metadata";
  }
...
// File: contracts/PiBirdsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PiBirdsContract is RamppERC721A {
    constructor() RamppERC721A("PiBirds", "PiBirds"){}
}
