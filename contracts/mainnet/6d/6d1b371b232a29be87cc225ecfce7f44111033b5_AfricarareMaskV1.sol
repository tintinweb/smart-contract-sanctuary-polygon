...
contract AfricarareMaskV1 is ERC721, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("Africarare Mask V1", "ARMASKV1") {}

    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://bafkreibgn3v2nqnxehvlbfvxzhxgbn6sf2bfrkk662tje4mdns7i4agkfy";
    }
    ...
    */
    function mintSingleMaskNFT() internal onlyOwner {
        safeMint(msg.sender);
    ...
    */
    function mintToAddressSingleMaskNFT(address receiverAddress) internal onlyOwner {
        safeMint(receiverAddress);
    }
    ...
    */
    function mintToAddressBatchOfMaskNFT(uint256 numToMint, address receiverAddress) external onlyOwner {
        for (uint i=0; i < numToMint; i++) {
            mintToAddressSingleMaskNFT(receiverAddress);
        }
    }
