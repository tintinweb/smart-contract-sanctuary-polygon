...
contract PolygonPixelClub is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeicfle74vr44eqp27z2wtj32kweh6r22catcusphwj2jodrkhjjdmm/", Strings.toString(tokenId), ".json")
            );
    }
