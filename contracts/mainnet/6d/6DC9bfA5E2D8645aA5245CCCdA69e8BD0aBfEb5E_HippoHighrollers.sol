    ...
    ERC2981
{
    ...
    uint256 public startTimestamp = 1683302400;
    ...
    uint256 public whitelistPrice = 20 ether;
    ...
    ) ERC721("Hippo Highrollers", "HIPPOHIGH") {
        baseTokenURI = uri_;
    ...
    function setTimestamp(uint256 startTimestamp_) external onlyOwner {
    ...
    function mint(uint256 amount) external payable nonReentrant {
        ...
        if (block.timestamp < startTimestamp) revert MintNotOpen();
