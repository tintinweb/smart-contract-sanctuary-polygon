...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0xcAd4F626C4042c95c6FCcbaeCFEeBb16eFf47d13];
...
// File: contracts/TestMiceGameLandBeableContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract TestMiceGameLandBeableContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Test Mice Game Land Beable";
    string public symbol = "TMGLB";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/LOmX2ovnnNXhAhIoJloR/contract-metadata";
  }
