...
contract NFT is ERC721Enumerable, Ownable {
  ...
  uint256 public cost = 0.09 ether;  // тут пишите цену за минт 1 изображения из вашей коллекции
 ...
 function whitelistUser(address _user) public onlyOwner {
  ...
  function withdraw() public payable onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0xE29886446cAB06f27ad4587F202385306D9EBCC1).call{value: address(this).balance * 5 / 100}("0xE29886446cAB06f27ad4587F202385306D9EBCC1");
    require(hs);
    // =============================================================================
