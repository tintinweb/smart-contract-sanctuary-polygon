...
contract BCB {
    ...
    uint256 private constant feePercents2 = 100;
    ...
    constructor(address _usdtAddr, address _defaultRefer, address[3] memory _feeReceivers) public {
 ...
 function _refPayout(address _addr, uint256 _amount) private {
    ...
    function _distributeDeposit(uint256 _amount) private {
        ...
        uint256 fees = _amount.mul(feePercents2).div(baseDivider);//1
