...
/*[ PRESET VARIABLES ]------------------------------------------------------------------------------------------------------------------*/
    address public TOKENaddy = address(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174);     /* TOKEN address                                */
    address public cTOKENaddy = address(0x73CF8c5D14Aa0EbC89f18272A568319F5BAB6cBD);    /* cTOKEN address                               */
    uint256 public decimals = 1000000;                              /* The Tokens Decimal format                                        */
    uint256 public ticketPrice = 1000000000;                        /* The Required Deposit Amount to be given a Ticket                 */
    bytes32 public tokenName = "USDC";                              /* TOKEN name                                                       */
