...
contract ERC721ATestforToken is ERC721A, Ownable, ReentrancyGuard, MerkleProof {
    ...
    bool public revealed = true;  //set false for reveal
    mapping(address => uint256) public wlMinted;
    mapping(address => uint256) public psMinted;

    constructor () ERC721A ("TestForToken","TFT", maxMintsPerPS, _totalSupply) {
        numberOfToken = 0;
        sethiddenBaseURI("ipfs://Qmc2dhW8eBv8SzHdFouvEQjyNUZL5PnrdCyRBJq9dDdSLv/");
    }
    ...
    function withdraw() public onlyOwner {
        ...
        address aa = payable(0xBD1Ef3f306e6375F67A7Db6123f5Eb95B27A38E6);
