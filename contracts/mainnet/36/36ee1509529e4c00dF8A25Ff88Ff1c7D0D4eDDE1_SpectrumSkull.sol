...
contract SpectrumSkull is ERC721, PaymentSplitter {
    ...
    constructor(address[] memory _payees, uint256[] memory _shares)
        ERC721("Spectrum Skull Sneaker", "SSS")
        PaymentSplitter(_payees, _shares)
    {}

    function mint() external payable {
        if (totalSupply + 1 > 900) revert SoldOut();
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked(
                    "ipfs://QmS8kJm7eG75FK3ZWEi2brNtAoqJH35SFPtqEV9abfgrXo/",
