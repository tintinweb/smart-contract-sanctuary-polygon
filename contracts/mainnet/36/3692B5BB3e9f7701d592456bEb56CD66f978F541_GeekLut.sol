 ...
 * @notice This contract handles minting Geek Lut tokens.
 */
contract GeekLut is
    ERC1155Supply,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x9610CdD46023Dccd00c109d38B2A9e83A5A091F6;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xEa30e027F7004e33227FD44192d98b5D268Bbaec;
    address[] public payoutAddresses = [
        0xEa30e027F7004e33227FD44192d98b5D268Bbaec
    ];
    ...
    string public name = "Geek Lut";
    string public symbol = "GLUT";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeigzzi2zxh6s5dybfxltypibythtudh62e4np7sedhsfmnmzzvrwfm/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenPublicSaleStartTime[1] = 1683061200;
        tokenPublicSaleEndTime[1] = 1998417547;
        tokenUsePublicSaleTimes[1] = true;
        tokenMaxSupply[61] = 10;
        require(
