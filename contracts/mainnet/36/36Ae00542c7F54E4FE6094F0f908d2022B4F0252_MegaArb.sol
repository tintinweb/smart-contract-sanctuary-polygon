  ...
  function optimize(
    ...
    while (_right - _left >= _precision) {
      ...
      if (_stats.reevaluateLeft) {
        ...
        (, _result) = address(this).call(abi.encodeWithSelector(MegaArb.arb.selector, _left, _tokenIn, _swaps, _funding, address(this)));
      ...
      if (_stats.reevaluateRight) {
        // Calls the arb function of the MegaArb contract
        (, _result) = address(this).call(abi.encodeWithSelector(MegaArb.arb.selector, _right, _tokenIn, _swaps, _funding, address(this)));
