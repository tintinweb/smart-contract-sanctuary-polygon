...
// File contracts/roles/AccessOperatable.sol
...
// File contracts/CryptoMaidsValentine.sol
...
contract CryptoMaidsValentine is Ownable, ERC721URIStorage, ERC721Enumerable, AccessOperatable, IERC721Mintable{
    ...
    constructor() ERC721("CryptoMaids:Valentine", "CMVL") {
        setDefaultURI("https://api.cryptomaids.tokyo/metadata/valentine/");
    }
    ...
    function burn(uint256 tokenId) virtual public onlyOperator() {
        _supply--;
        super._burn(tokenId);
    }

    function totalSupply() public view virtual override(IERC721Mintable, ERC721Enumerable) returns (uint256) {
        return _supply;
    }
