...
/// @title NFTSVG
/// @notice Provides a function for generating an SVG associated with a ApeSwap NFT
library NFTSVG {
    using Strings for uint256;
    ...
    function generateSVG(string memory defs, string memory body) internal pure returns (string memory svg) {
        ...
        msg: "Forged in SVG for ApeSwap in 2021 by 0xe8ab59d3bcde16a29912de83a90eb39628cfc163",
