...
contract RematicAdmin is UUPSUpgradeable, OwnableUpgradeable {
    ...
    function setRematic(address _address) public onlyOwner {
        ...
        pancakeSwapPair = IPancakeFactory(pancakeSwapV2Router.factory()).createPair(_address, pancakeSwapV2Router.WETH());
...
interface IFour01Programe {
    ...
    function withraw401KReward(address _address ) external;
