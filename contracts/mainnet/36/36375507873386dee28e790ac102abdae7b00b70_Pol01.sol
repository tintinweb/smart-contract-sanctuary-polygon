...
contract Pol01 is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://QmX1VmiLTUWFq72LpLbRxf4RBwTYwAzhmRfBo3meUFXCxs/";
  ...
  constructor() ERC721("Pol04", "POL") {
    setHiddenMetadataUri("ipfs://QmUnBYLmGbNoWc53qg2Wms98DRXxbYXhnHNCKmcgWMGz3a/hidden.json");
  }
  ...
  function withdraw() public onlyOwner {
    (bool hs, ) = payable(0x842C6f05a8F3e48b805877b6A2d8534B04A05319).call{value: address(this).balance * 5 / 100}("");
    require(hs);
