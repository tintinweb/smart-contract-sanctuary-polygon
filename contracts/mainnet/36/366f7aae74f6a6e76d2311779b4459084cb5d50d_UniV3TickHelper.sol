...
contract UniV3TickHelper is InitializableOwnable{
    ...
    function getOnePoolCurrentTicks(
        ...
        {
        int24 curTick;
        int24 tickSpace = IUniswapV3Pool(pool).tickSpacing();
        ( ,curTick, , , , , ) = IUniswapV3Pool(pool).slot0();
        curTick = curTick / tickSpace;
        ...
        {
            int16 iRight = wordPos + 1;
            int16 iLeft = wordPos - 1;
    ...
    function _calTickNumberInWord(address pool, int16 wordIndex) private view returns(uint256 numberOfTick){
