...
contract FSM is YToken {
    ...
    constructor(
        ...
        _mint(_daoFund, 1_000_000 ether); // 3.33%
        _mint(_devFund, 1_000_000 ether); // 3.33%
        _mint(_treasuryFund, 1_000_000 ether); // 3.33%
        _mint(_reserve, MAX_TOTAL_SUPPLY - 3_000_025 ether);
    }
