...
contract Winenwin is ERC1155, Ownable, ERC1155Burnable, ERC1155Supply, ERC1155URIStorage {
    ...
    */
    ...
    /*
     * @dev 배포자가 판매하려는 NFT를 컬렉션에 발급하는 기능
     * @param holder: 오너가 아닌 홀더인 이유는 특정 유저들에게 민팅할 수도 있는 상황에 대비
     * @param tokenId: 발급하려는 NFT의 ID
     * @param amount: 발급하려는 NFT의 숫자
    */
    function mintMembershipNFT(address holder,uint256 tokenId,uint256 amount,string memory _tokenURI) external onlyOwner {
        require(holder != address(0), "Invalid holder address");
        require(tokenId != 0, "tokenId must not be empty");
    ...
    */
    function transferMembershipNFT(address holder,uint256 tokenId,uint256 amount) external {
        require(holder != address(0), "Invalid holder address");
        require(tokenId != 0, "Value must not be empty");
    ...
    /*
     * @dev 민팅 일괄 전송 함수
     * @param holders: 오너가 아닌 홀더인 이유는 특정 유저들에게 민팅할 수도 있는 상황에 대비
     * @param tokenId: 발급하려는 NFT의 ID
     * @param amount: 발급하려는 NFT의 숫자
    */
    function mintMembershipBatchNFTs(address[] memory holders,uint256 tokenId,uint256 amount,string memory _tokenURI) external onlyOwner {
        require(tokenId != 0, "Value must not be empty");
        require(amount != 0, "amount must not be empty");
    ...
    /*
     * @dev 홀더분들이 이용하여 NFT들을 일괄 전송하는 기능
     * @param holder: 특정 유저의 계정
     * @param tokenId: 발급하려는 NFT의 ID
     * @param amount: 발급하려는 NFT의 숫자
    */
