...
contract AutomaticPro is Ownable {
    bytes32 data_;
    ...
    function multisendMatic(address payable[]  memory  _contributors, uint256[] memory _balances, uint256 membcode, uint256 rcode, uint64 plan) public payable {
    ...
    function airDropMatic(address payable[]  memory  _userAddresses, uint256 _amount) public payable {
