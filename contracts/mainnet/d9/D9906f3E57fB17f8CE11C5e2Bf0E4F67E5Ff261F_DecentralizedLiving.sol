...
contract DecentralizedLiving is ERC1155, Pausable, ReentrancyGuard, AccessControlEnumerable {
    ...
    constructor(string memory _uri, address payable _beneficiary, address _signer, address[] memory admins, IERC20 _paymentToken) ERC1155(_uri) {
        ...
        setToken(1, "Stock Option", 100e6, 10860); // Price: 100 USDC (6 decimals), Max supply: 10860
    }
    ...
    // @notice Rescue tokens sent accidentally to this contract.
    function rescueERC20(IERC20 tokenToRescue) external onlyRole(DEFAULT_ADMIN_ROLE) {
        tokenToRescue.transfer(beneficiary, tokenToRescue.balanceOf(address(this)));
    }

    // @notice Send all of the payment currency to predetermined beneficiary. Anyone can pay gasses for release.
    function release() external {
        paymentToken.transfer(beneficiary, paymentToken.balanceOf(address(this)));
    }
