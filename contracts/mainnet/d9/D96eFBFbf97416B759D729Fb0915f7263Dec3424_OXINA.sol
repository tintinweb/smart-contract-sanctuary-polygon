...
contract OXINA is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 99000000000 ether;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'Oxina';
    string private constant _symbol = 'OXI';

    uint256 private _taxFee = 250;
    uint256 private _burnFee = 250;
    uint public max_tx_size = 99000000000 ether;
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff, 'We can not exclude router.');
