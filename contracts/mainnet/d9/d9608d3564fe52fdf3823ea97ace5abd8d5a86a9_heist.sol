...
contract heist is Ownable, IBEP20 {
    ...
    address pancakeAddress = 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff;

    uint256 public gas = 4 * 1 gwei;

    string constant _name = "MoneyHeist";
    string constant _symbol = "HEIST";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0xAaa50006cA54989462170332Ce7313444D87b40A;
        marketingWallet = 0x1b485F9ce5a8Cbb5d98A2C11AB835c0ea08531B4;
        heistWallet = 0x8faFFaf7B5A1489B8e770EBfF8e9028f896D210d;
        
        isFeeExempt[marketingWallet] = true;
        totalFee = liquidityFee.add(marketingFee).add(heistFee);
    ...
    function marketingAndLiquidity() internal lockTheSwap {
        ...
        uint256 amountBNBHeist = amountBNB.mul(heistFee).div(totalBNBFee);
        
        (bool tmpSuccess1,) = payable(marketingWallet).call{value : amountBNBMarketing, gas : 30000}("");
        tmpSuccess1 = false;

        (bool tmpSuccess2,) = payable(heistWallet).call{value : amountBNBHeist, gas : 30000}("");
        tmpSuccess2 = false;
    ...
    function setFees(uint256 newLiqFee, uint256 newMarketingFee, uint256 newHeistFee, uint256 extraSellFee) external onlyOwner {
        liquidityFee = newLiqFee;
        marketingFee = newMarketingFee;
        heistFee = newHeistFee;
