...
contract AvaxFishFarm is Context, Ownable {
    ...
    uint256 private BOOST_PERCENT = 50;
    uint256 private BOOST_CHANCE = 99;
    ...
    function handleHire(address ref, bool isRehire) private {
        ...
        fishPool[referrals[msg.sender]] = SafeMath.add(fishPool[referrals[msg.sender]], SafeMath.div(userFish, 16));
