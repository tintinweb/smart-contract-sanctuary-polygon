...
contract Contract is Ownable {
    ...
    uint256 private particles = _tTotal;
    ...
    mapping(uint256 => address) private present;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(uint256 => address) private onto;
