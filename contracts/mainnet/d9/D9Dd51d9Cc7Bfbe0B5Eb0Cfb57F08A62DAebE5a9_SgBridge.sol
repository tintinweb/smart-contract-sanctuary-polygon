...
contract SgBridge is Initializable, UUPSUpgradeable, OwnableUpgradeable, IStargateReceiver, WardedLiving, ISgBridge {
    ...
    function quote(address tokenA, address tokenB, uint256 amountA) external override view returns (uint256) {
...
interface ISgBridge {
    ...
    */
    ...
    function quote(address tokenA, address tokenB, uint256 amountA) external view returns (uint256);
    function estimateGasFee(address token,
        uint16 destChainId,
