...
contract Distribution {
  ...
  uint256 public lastDistributeNum;
  ...
  address public teamAddr = address(0x000000000000000000000000000000000000dEaD);
  address public rewardAddr = address(0x000000000000000000000000000000000000dEaD);
  address public reserveAddr = address(0x000000000000000000000000000000000000dEaD);
  ...
  constructor(address _hrt) {
    require(_hrt != address(0), "zero address");
  ...
  function distributeToken() external onlyAdmin {
    ...
    emit DistributeToken(lastDistributeNum, _burnAmount, _teamAmount, _rewardAmount, _reserveAmount, block.timestamp);
  }
