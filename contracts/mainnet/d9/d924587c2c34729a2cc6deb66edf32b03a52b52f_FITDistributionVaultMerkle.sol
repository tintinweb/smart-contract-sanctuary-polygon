...
import {DistributionVaultMerkleUpgradeable} from
    "dappcomposer-contracts-upgradeable/distribute/DistributionVaultMerkleUpgradeable.sol";
import {Ownable2StepUpgradeable} from "openzeppelin-contracts-upgradeable/access/Ownable2StepUpgradeable.sol";
import {UUPSUpgradeable} from "openzeppelin-contracts-upgradeable/proxy/utils/UUPSUpgradeable.sol";

contract FITDistributionVaultMerkle is DistributionVaultMerkleUpgradeable, Ownable2StepUpgradeable, UUPSUpgradeable {
    constructor() {
        _disableInitializers();
    }

    function initialize(address owner_, address token_, bytes32 merkleRoot_, string memory uri_) public initializer {
        __DistributionVaultMerkleUpgradeable_init(token_, merkleRoot_, uri_);
        __Ownable2Step_init();
