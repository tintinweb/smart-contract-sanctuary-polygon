...
contract YoStrategy {
     ...
     */
    function rebalance(int24 _baseThreshold, int24 _limitThreshold, int256 swapAmount, uint160 minSQRTPrice) external {
        require(msg.sender == keeper, "keeper");

        int24 tick = getTick();
        _checkThresholdBeforeRebalance(tick, _baseThreshold, _limitThreshold);
    ...
    function _checkThresholdBeforeRebalance(int24 tick, int24 _baseThreshold, int24 _limitThreshold) internal view {
