...
/**
 * @title MechaniumPublicSaleVestingWallet - Hold $MECHA allocated to the launchpad buyers and realse it to the dev team according to the vesting schedule for multisend distribution
 * @author EthernalHorizons - <https://ethernalhorizons.com/>
 * @custom:project-website  https://mechachain.io/
 * @custom:security-contact [email protected]
 */
contract MechaniumPublicSaleVestingWallet is MechaniumVestingWallet {
