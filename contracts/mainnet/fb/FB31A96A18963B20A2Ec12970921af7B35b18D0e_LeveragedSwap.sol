...
contract LeveragedSwap is Ownable,IUniswapV3FlashCallback, PeripheryImmutableState, PeripheryPayments {
    ...
    function uniswapV3FlashCallback(
        ...
        address daiAddress = address(0x8f3Cf7ad23Cd3CaDbD9735AFf958023239c6A063); // mainnet DAI
        uint256 amount = 2 * 1e17;
        uint16 referral = 0;

        // Approve LendingPool contract to move your DAI
        IERC20(daiAddress).approve(address(0x8dFf5E27EA6b7AC08EbFdf9eB090F32ee9a30fcf), amount);

        // borrow 0.1 DAI
        lendingPool.borrow(daiAddress, amount,2,0,address(this));  

        address wethAddress = address(0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619); // mainnet WETH
        }
        ...
        uint256 amountOut0 =
            swapRouter.exactInputSingle(
                ISwapRouter.ExactInputSingleParams({
                    tokenIn: address(0x8f3Cf7ad23Cd3CaDbD9735AFf958023239c6A063),
                    tokenOut: address(0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619),
    ...
    function borrow(address _token,address _thisContract,uint256 _amount) external {
