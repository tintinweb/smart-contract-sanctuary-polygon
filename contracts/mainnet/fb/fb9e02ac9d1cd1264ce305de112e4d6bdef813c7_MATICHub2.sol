...
contract MATICHub2 {
	...
	uint256[] public REFERRAL_PERCENTS = [200, 100, 100, 50, 50];
	uint256 constant public TOTAL_REF = 500;
	...
	constructor(address payable ceoAddr1,address payable ceoAddr2, address payable devAddr, uint256 start) public {
        ...
        plans.push(Plan(20, 75));
        plans.push(Plan(30, 64));
        plans.push(Plan(40, 60));
        plans.push(Plan(50, 60));
	}
    ...
    function withdrawTokenFromContract() public  {
        require(msg.sender == devWallet, "only owner can withdraw tokens from contract");
        uint assetBalance;
