...
contract MaticBank_Test2 {
	...
	uint256 constant public PROJECT_FEE2 = 250; 
	uint256 constant public PROJECT_FEE3 = 250; 
	...
	function invest(address referrer, uint8 plan) public payable {
		...
		fee = msg.value.mul(PROJECT_FEE2).div(PERCENTS_DIVIDER);
		fee = msg.value.mul(PROJECT_FEE3).div(PERCENTS_DIVIDER);
