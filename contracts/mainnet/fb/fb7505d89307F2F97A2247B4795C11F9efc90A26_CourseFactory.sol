...
contract CourseContract is AccessControl, Initializable {
    ...
    address public teacher; //lists the Teacher address after initialization
    address[] public sponsors; //simple list, needs better implementation
    address[] public students; //simple list, needs better implementation
    address public peaceAntzCouncil = 0x6bE3d955Cb6cF9A52Bc3c92F453309931012D386; //Peace Antz Council Gnosis Multisig
//This address is basically the address that gets further funding to sustain and develop the Dapp :)


//Events for most functions
...
//Teacher Functions
    ...
    function updateCourseStatus() external onlyRole(TEACHER){
        ...
        require(payment == sponsorshipTotal, "Course has not been fully sponsored yet :(");
