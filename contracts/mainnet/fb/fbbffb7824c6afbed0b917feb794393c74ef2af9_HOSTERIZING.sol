...
contract HOSTERIZING is ERC721URIStorage {
    ...
    constructor(string memory _tld) payable ERC721("HOSTERIZING Name Service", "HTZ") {
    ...
    function price(string calldata name) public pure returns (uint256) {
        ...
        require(len > 0);
        if (len == 3) {
            return 5 * 10**18; // 5 MATIC = 5 000 000 000 000 000 000 (18 decimals). We're going with 0.5 Matic because the faucets don't give a lot
        } else if (len == 4) {
