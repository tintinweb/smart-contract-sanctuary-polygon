...
contract StargateFacet is ILiFi, Swapper, ReentrancyGuard {
        ...
        nonReentrant
    {
        ...
        _startBridge(_stargateData, _lifiData, msg.value);
    }
    ...
    function getTokenFromPoolId(address _router, uint256 _poolId) internal view returns (address) {
