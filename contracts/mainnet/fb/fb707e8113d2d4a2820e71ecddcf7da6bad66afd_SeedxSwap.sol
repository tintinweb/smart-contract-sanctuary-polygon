...
contract SeedxSwap is Ownable {
  ...
  */
  ...
  /**
  *  Sender requests to sell [amount] of tokens to the contract in return of USDT.
  */
...
/**
  *  Sender must be owner to requests to withdraw all [totalUsdt] of tokens from the contract.
  */
  ...
  /**
  *  Sender must be owner to requests to withdraw all [totalSeedX] of tokens from the contract.
  */
