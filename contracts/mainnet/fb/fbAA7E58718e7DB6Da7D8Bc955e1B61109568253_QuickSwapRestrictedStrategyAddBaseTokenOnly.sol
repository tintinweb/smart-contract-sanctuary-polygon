...
contract QuickSwapRestrictedStrategyAddBaseTokenOnly is OwnableUpgradeSafe, ReentrancyGuardUpgradeSafe, IStrategy {
  ...
  modifier onlyWhitelistedWorkers() {
    require(
      ...
      "QuickSwapRestrictedStrategyAddBaseTokenOnly::onlyWhitelistedWorkers:: bad worker"
    );
    _;
  }
  ...
  function execute(
    ...
    // Constants come from
    // 2-f = 2-0.0030 = 19970
    // 4(1-f) = 4*9970*10000 = 398800000, where f = 0.003 and 10,000 is a way to avoid floating point
    // 19970^2 = 398800900
    // 9970*2 = 19940
    uint256 aIn = KoalaMath.sqrt(rIn.mul(balance.mul(398800000).add(rIn.mul(398800900)))).sub(rIn.mul(19970)) / 19940;
    ...
    require(
      ...
      "QuickSwapRestrictedStrategyAddBaseTokenOnly::execute:: insufficient LP tokens received"
    );
    require(
      lpToken.transfer(msg.sender, lpToken.balanceOf(address(this))),
      "QuickSwapRestrictedStrategyAddBaseTokenOnly::execute:: failed to transfer LP token to msg.sender"
    );
