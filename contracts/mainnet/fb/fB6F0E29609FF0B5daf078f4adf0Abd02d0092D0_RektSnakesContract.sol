...
//*********************************************************************//
//
//     ____       __   __     _____             __               / __ \___  / /__/ /_   / ___/____  ____ _/ /_____  _____  / /_/ / _ \/ //_/ __/   \__ \/ __ \/ __ `/ //_/ _ \/ ___/ / _, _/  __/ ,< / /_    ___/ / / / / /_/ / ,< /  __(__  ) /_/ |_|\___/_/|_|\__/   /____/_/ /_/\__,_/_/|_|\___/____/                                                             
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 616, 616 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmWTHpFc78hZFGxzjpEQ6iLHBYsusiXWt9jYoR8Bz6M7Xt/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 616");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 616");
...
// File: contracts/RektSnakesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract RektSnakesContract is RamppERC721A {
    constructor() RamppERC721A("Rekt Snakes", "RSK"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/BhhfiAvN9InpTQx1di54/contract-metadata";
    }
}
