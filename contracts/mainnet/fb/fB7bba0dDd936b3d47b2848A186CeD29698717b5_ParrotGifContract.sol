...
//    / __ \____ _______________  / /_   / ____/  _/ ____/
//   / /_/ / __ `/ ___/ ___/ __ \/ __/  / / __ / // /_    
//  / ____/ /_/ / /  / /  / /_/ / /_   / /_/ // // __/    
// /_/    \__,_/_/  /_/   \____/\__/   \____/___/_/       
//                                                        
//
//*********************************************************************//
//*********************************************************************//
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 4, 7) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmbLC9fHZFHEPfQywtrkin2WEohZR4vpQfhqH4rqv4mxjw/";
...
// File: contracts/ParrotGifContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ParrotGifContract is RamppERC721A {
    constructor() RamppERC721A("Parrot GIF", "PGIF"){}
}
