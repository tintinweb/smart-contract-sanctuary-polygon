...
IERC20 public p2pptoken;
    ...
    function claimReward() external returns (bool){
        ...
        p2pptoken.transfer(_msgSender(), totalTokens);
    ...
    function stakeToken(uint256 stakeAmount) external  whenNotPaused {
        ...
        require(p2pptoken.balanceOf(_msgSender()) >= stakeAmount, "Insufficient Balance");
        
           p2pptoken.transferFrom(_msgSender(), address(this), stakeAmount);
            totalStakers++;
