...
contract DevelopersAfterHoursv3 is ERC721, ERC721Enumerable, ERC721Burnable, ERC721Royalty, Ownable {
    ...
    constructor(address trustedForwarder) ERC721("DevelopersAfterHoursv3", "DAH3_E15") {
        _tokenIds.increment();
