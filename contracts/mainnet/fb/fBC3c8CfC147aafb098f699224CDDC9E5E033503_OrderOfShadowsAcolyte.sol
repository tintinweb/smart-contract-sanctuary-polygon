...
contract OrderOfShadowsAcolyte is AMPowerPassCore{
  string public name = "Order of Shadows: Acolyte Power-Pass";
  string public symbol = "AM: OOS:A";
  ...
  constructor()
    ...
    setToken( 0,
      "Order of Shadows: Acolyte Power-Pass",
      "https://herodev.mypinata.cloud/ipfs/QmctGRRtUnyh9ogZgCjgw4mG2v58RSuJJMFqNzw4jfB7Y1/oos-acolyte.json",
      false, 0,
      false, 0,
      2000 );
  }
