...
// File: contracts/token/Riken.sol
...
contract Riken is Ownable, ERC20Burnable, ERC20Votes {
    ...
    function setBPContract(address addr) public onlyOwner {
        require(
            ...
            "Riken: can only be initialized once"
        );
    ...
    function setBPDisableForever() public onlyOwner {
        require(!bpDisabledForever, "Riken: bot prevention disabled");
