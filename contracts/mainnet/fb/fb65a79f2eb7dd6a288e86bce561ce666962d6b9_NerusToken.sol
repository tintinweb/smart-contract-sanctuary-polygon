...
// File: @openzeppelin/[email protected]9.2/utils/introspection/ERC165.sol
...
contract NerusToken is ERC20, ERC20Burnable, AccessControl, ERC20Permit {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    constructor() ERC20("Nerus Token", "NU") ERC20Permit("Nerus Token") {
        _mint(msg.sender, 1104000000 * 10 ** decimals());
