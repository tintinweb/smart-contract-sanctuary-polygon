...
contract AdrastiaVersioning {
    string public constant ADRASTIA_CORE_VERSION = "v3.0.0-beta.1";
    string public constant ADRASTIA_PERIPHERY_VERSION = "v3.0.0-beta.1";
...
contract AdrastiaAggregatedTwapOracle is AdrastiaVersioning, AggregatedOracle {
    ...
    constructor(
        ...
        AggregatedOracle(
            ...
            params.oracles,
            params.tokenSpecificOracles,
            params.period,
            params.granularity,
            params.minimumTokenLiquidityValue,
            params.minimumQuoteTokenLiquidity
        )
    {
        name = params.name;
    }
