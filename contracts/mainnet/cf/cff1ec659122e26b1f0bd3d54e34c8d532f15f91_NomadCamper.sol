...
// File contracts/NomadCamp/NomadCamper.sol

pragma solidity ^0.8.6;


contract NomadCamper is ERC1155URIStorageUpgradeable, OwnableUpgradeable {

  string public constant name = "Nomad Camper NFT Collection";
  string public constant symbol = "NCER";
  ...
  function airdrop(DropItem[] memory _items) public onlyOwner {
    for(uint256 i=0; i<_items.length; i++){
      DropItem memory item = _items[i];
