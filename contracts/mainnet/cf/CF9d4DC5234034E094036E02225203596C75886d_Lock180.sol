...
contract Lock180 {
    ...
    uint256 private diboInterestPerSecond = 25720164610; //formula: 10^18 * (interest/100) / lockPeriod
    uint256 private nasmgInterestPerSecond = 6944444445; //formula: 10^18 * (interest/100) / lockPeriod
    address public owner;
    address[] private stakers;
    uint256 public lockPeriod = 15552000;
