...
contract LIDCoin is Pausable, StandardToken, BlackList {
    ...
    //transfer method for LIDC token from a wallet to other wallet by owner
    function transferFromByOwner(address _from, address _to, uint _value)  external onlyOwner whenNotPaused{        
        require(balances[_from] >= _value && _value > 0, "Something went wrong");
