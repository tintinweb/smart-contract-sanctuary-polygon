...
contract CebuanaJewels is Ownable, AccessControl, ERC721 {
  // ============ Constants ============
  ...
  mapping(uint256 => string) fixedURI;

  // ============ Deploy ============

  constructor(address admin) ERC721("Cebuana Jewels", "BLING") {
  ...
  function tokenURI(
    ...
    return bytes(fixedURI[tokenId]).length > 0 ? fixedURI[tokenId] : "";
  }
