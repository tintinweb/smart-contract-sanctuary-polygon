...
contract SiloManagerFactory is Ownable {
    ...
    KeeperRegistryInterface public Registry;
    ...
    function checkId(uint256 blockNumber, uint256 nounce)
        external
        view
        returns (uint256 id)
    {
    ...
    function checkIdWithAddress(uint256 blockNumber, address registry,uint256 nounce)
        external
        view
        returns (uint256 id)
    {
