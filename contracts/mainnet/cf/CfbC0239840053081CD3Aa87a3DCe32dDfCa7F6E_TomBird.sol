...
contract TomBird is ERC1155, Ownable {
    ...
    constructor(IERC20 USDC_address, string memory _uri, address _treasuryAddress, uint256 _maxSupply) ERC1155("https://bafkreibfbvagddiut2oqbpgeg5y562zsdayjr3hjdt2njk3d3btqrldpne.ipfs.nftstorage.link/") {
        setURI(_uri);
    ...
    */
    ...
    function mint(uint256 id, uint256 amount) public
    {
        ...
        require(mintedAmount < maxSupply, "Max supply exceeded");
        require(amount == 1, "Wrong Mint function");

        // Must be approved the USDC before calling this function to contract
