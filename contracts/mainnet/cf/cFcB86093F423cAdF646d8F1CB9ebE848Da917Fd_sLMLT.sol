...
contract sLMLT is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Limelight", "sLMLT", 9) ERC20Permit() {
    ...
    /**
        @notice increases sLMLT supply to increase staking balances relative to profit_
