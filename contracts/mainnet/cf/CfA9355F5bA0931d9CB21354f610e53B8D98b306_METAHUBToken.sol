...
//  }
  ...
  function getLsdDiscountTaxPercentages(IMENToken.TaxType  _type) external view returns (uint) {
    return lsdDiscountTaxPercentages[_type];
  }
...
interface IMENToken is IBEP20 {
  ...
  function getLsdDiscountTaxPercentages(TaxType _type) external returns(uint);
}
