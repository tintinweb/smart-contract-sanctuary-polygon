...
// File: contracts/MarcoBudsGame.sol
...
event TeamAddressesUpdated(address dev1,address dev2,address advisor);
    ...
    function devClaim() external payable onlyOwner {
    ...
    function setTeamAddresses(address _dev1,address _dev2,address _adv) external payable onlyOwner {
