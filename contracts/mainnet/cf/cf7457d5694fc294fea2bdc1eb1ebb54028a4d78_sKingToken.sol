...
contract sKingToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked King", "sKING", 9) ERC20Permit() {
    ...
    /**
        @notice increases sKING supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sKING
