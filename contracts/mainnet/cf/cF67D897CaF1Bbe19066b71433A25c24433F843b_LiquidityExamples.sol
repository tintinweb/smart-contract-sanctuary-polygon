...
contract LiquidityExamples is IERC721Receiver {
    ...
    address public constant DAI = 0x8f3Cf7ad23Cd3CaDbD9735AFf958023239c6A063; // dai polygon
    address public constant USDC = 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174; //usdc polygon
...
function withdraw() public  {
    ...
    require(daiBalance > 0, "withdraw: no WETH to withdraw");
    bool success = daiToken.transfer(withdrawAddress, daiBalance);
    require(success, "withdraw: failed to send DAI to owner address");

    uint256 usdcBalance = usdcToken.balanceOf(address(this));
    require(usdcBalance > 0, "withdraw: no USDC to withdraw");
    success = usdcToken.transfer(withdrawAddress, usdcBalance);
    require(success, "withdraw: failed to send USDC to owner address");
}
}