 ...
 */
 ...
 contract DEEP_INSIDE_GHT is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable, ERC721URIStorage, Ownable, ERC2981PerTokenRoyalties {
      ...
      * See {ERC721-tokenURI}.
      */
     constructor(address _headAdmin, address _admin) ERC721("DEEP INSIDE/GHT", "DI") {
          _setupRole(DEFAULT_ADMIN_ROLE, _headAdmin);
