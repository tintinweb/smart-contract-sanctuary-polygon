...
contract RibbonLendDesk is IRibbonLendDesk, AdminUpgradeable {
  ...
  // RibbonLend Pool => Total Token Amount
  mapping(address => uint256) internal ribbonLendPoolTokenTotalAmountMapping;
  ...
  function provide(
    ...
    ribbonLendPoolTokenTotalAmountMapping[_vaultAddress] = ribbonLendPoolTokenTotalAmountMapping[_vaultAddress].add(shares);
    if (!vaultToRibbonLendPoolTokenAddresses[_vaultAddress].contains(_address)) {
  ...
  function redeem(
    ...
    ribbonLendPoolTokenTotalAmountMapping[_vaultAddress] = ribbonLendPoolTokenTotalAmountMapping[_vaultAddress].add(_amount);
