...
contract FlashloanV2 is FlashLoanReceiverBase {
    ...
    function executeOperation(
        ...
        IERC20(token).approve(routerA, IERC20(token).balanceOf(address(this)));
        ...
        IERC20(WETH).approve(routerB, balance);
        IERC20(token).approve(routerB, IERC20(token).balanceOf(address(this)));
