...
// File: contracts/etherum dolphins.sol
...
contract CryptoDolphins is ERC721Enumerable, Ownable, ContextMixin{
    ...
    constructor(string memory baseURI,string memory hiddenMetadataUri) ERC721("Crypto Dolphins", "CDOL") {
        setBaseURI(baseURI);
