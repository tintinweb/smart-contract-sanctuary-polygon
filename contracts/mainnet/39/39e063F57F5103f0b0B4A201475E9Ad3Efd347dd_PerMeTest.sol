...
contract PerMeTest {
  ...
  AggregatorV3Interface private priceEthFeed;
  AggregatorV3Interface private priceBusdFeed;


  // Costruttore: impostiamo l'indirizzo dell'Oracle Chainlink all'inizio
  constructor() {
    // Indirizzo dell'Oracle Chainlink per il prezzo WETH/USDT su Polygon
    priceEthFeed = AggregatorV3Interface(0x692f391bCc85cefCe8C237C01e1f636BbD70EA4D);
    priceBusdFeed = AggregatorV3Interface(0x692f391bCc85cefCe8C237C01e1f636BbD70EA4D);
  }

  // Funzione per ottenere il prezzo corrente WETH/USDT
  function getWETHUSDTPrice() public view returns (int256) {
  ...
  // Funzione per ottenere il prezzo corrente WETH/USDT
  function getBUSDUSDTPrice() public view returns (int256) {
    // Otteniamo l'ultimo round di prezzo dal Chainlink Oracle
    (, int256 price, , , ) = priceBusdFeed.latestRoundData();
