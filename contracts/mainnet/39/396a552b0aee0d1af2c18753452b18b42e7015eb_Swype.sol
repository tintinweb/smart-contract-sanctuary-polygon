...
contract Swype is Initializable, UUPSUpgradeable, PausableUpgradeable, OwnableUpgradeable, ReentrancyGuard {
    ...
    event OfframpRequest(address indexed token, uint256 tokenAmount, uint256 fiatAmountToReceive);
    ...
    function offrampUsdc(
        ...
        emit OfframpRequest(address(_USDC), usdcAmount, _amountAfterFee(usdcAmount));
    }
    ...
    function offrampNativeExactIn(
        ...
        // Emit successful off-ramp event
        emit OfframpRequest(address(_WETH), amount, _amountAfterFee(amountOut));
    }
    ...
    function offrampNativeExactOut(
        ...
        // Emit successful off-ramp event
        emit OfframpRequest(address(_WETH), expectedAmountIn - excessWeth, _amountAfterFee(amountOut));
    }
    ...
    function offrampTokenExactIn(
        ...
        // Emit successful off-ramp event
        emit OfframpRequest(token, amount, _amountAfterFee(amountOut));
    }
    ...
    function offrampTokenExactOut(
        ...
        // Emit successful off-ramp event
        emit OfframpRequest(token, expectedAmountIn - excessToken, _amountAfterFee(amountOut));
    }
