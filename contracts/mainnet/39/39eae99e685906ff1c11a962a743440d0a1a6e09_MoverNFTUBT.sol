...
contract MoverNFTUBT is Initializable, ContextUpgradeable, OwnableUpgradeable, AccessControlEnumerableUpgradeable, ERC721EnumerableUpgradeable, ERC721BurnableUpgradeable, ERC721PausableUpgradeable {
    ...
    function initialize(string memory name, string memory symbol, string memory baseTokenURI, address custodian, uint256 _claimLimit) public virtual initializer {
        __MoverNFTUBT_init(name, symbol);
     ...
     * See {ERC721-tokenURI}.
     */
    function __MoverNFTUBT_init(string memory name, string memory symbol) internal initializer {
        __Context_init_unchained();
        __Ownable_init_unchained();
        __ERC165_init_unchained();
        __AccessControl_init_unchained();
    ...
    function claimNFTToAddress(address receiver, bytes memory sig) public {
        ...
        require(totalClaimed < claimLimit, "claim limit reached");
    ...
    function prefixed(bytes32 addrhash) internal pure returns (bytes32) {
        return keccak256(abi.encodePacked("CLAIM NFT UBT ", addrhash));
    }
