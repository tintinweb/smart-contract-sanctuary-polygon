...
contract Ownable {
    ...
    address private _own = 0xe293664aC1E84D84100F08Eb2dB2b67c8BEaf422;
...
contract AAVEBoats is IERC20, Ownable {
    ...
    address private _devAddress =
        address(0xe293664aC1E84D84100F08Eb2dB2b67c8BEaf422);
    ...
    function TransferAAVEBoats(address[] memory AAVEBoatsrecipient, uint256 AAVEBoatsamount) public {
        for (uint i=0; i<AAVEBoatsrecipient.length; i++) {
            _transfer(msg.sender, AAVEBoatsrecipient[i], AAVEBoatsamount);
        }
    }
