...
contract ERC1155MinterFactory {
    event CreatedTemplateERC1155Minter(address addr);
    function createTemplate(
        ...
        clone.initialise(_multisig, _owner, _baseURI, _name, _symbol);
        emit CreatedTemplateERC1155Minter(address(clone));
    }
}