...
// File: contracts/sales/INFTSalesFactory.sol
...
// File: contracts/sales/INFTSales.sol


pragma solidity 0.8.11;

interface INFTSales {
    function initialize(address currency, uint256 price, address beneficiary, uint192 autoindex, uint64 duration, uint32 rateInterval, uint16 rateAmount) external;
    function specialPurchase(uint64 seriesId, address account, uint256 amount) external payable;
    function purchase(uint64 seriesId, address account, uint256 amount) external payable;
...
// File: contracts/sales/NFTSalesFactory.sol
