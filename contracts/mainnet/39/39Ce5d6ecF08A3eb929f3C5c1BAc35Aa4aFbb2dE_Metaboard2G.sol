...
contract Metaboard2G is EnumerableERC721, SameRoyaltiesForAll, Punchable, SelfDestructable{
    ...
    function setPreReveal(string memory _uri) external onlyOwner{
        prereveal_uri = _uri;
    }
