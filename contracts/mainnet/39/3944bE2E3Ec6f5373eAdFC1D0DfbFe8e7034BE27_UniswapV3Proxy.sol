...
contract UniswapV3Proxy {
    ...
    */
    function exactInputSingleWithWithdrawal(
        ...
        // Transfer the ERC20 from the user into this contract
        // NOTE: we'll have to approve the V2 Router for this contract, and approve this contract on USDC
        ...
        require(
            token.approve(swapRouterAddress, _amountIn),
