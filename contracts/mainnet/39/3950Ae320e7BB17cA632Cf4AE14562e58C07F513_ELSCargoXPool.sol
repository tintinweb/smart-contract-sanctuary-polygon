...
contract ELSCargoXPool is ReentrancyGuard, Ownable, DSMath {
    ...
    function changeFee(uint256 _newFee) external onlyOwner {
        // Fee that high will only be in case if Polygon network gets congested again and there will be high Polygon transaction fees, normaly it will be 10%
        require(_newFee <= 70, "Fee cannot be more that 70%.");
