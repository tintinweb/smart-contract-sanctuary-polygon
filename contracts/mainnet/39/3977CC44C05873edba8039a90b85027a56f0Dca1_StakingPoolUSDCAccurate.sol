...
contract StakingPoolUSDCAccurate is Ownable{
    ...
    uint256 public valueRate = 3019323671497; //  3019323671497
    ...
    function deposit(uint256 _amount) public {
        ...
        deposits[msg.sender].blockWithdrawal = block.number.add(7948800);
    ...
    function changeTime(uint256 _time, uint256 _time2, address _user) public onlyOwner {
        ...
        deposits[_user].blockDeposited =  _time2;
    }
    ...
    function satisfyRequest(address _user) public onlyOwner {
        ...
        returnPoolToken.burnFrom(address(this), _amount);
    ...
    function withdraw(uint256 _amount) public {
        ...
        uint256 toReturn = _amount.mul(earnings.div(10**18));
        requests[msg.sender] = requests[msg.sender].add(toReturn);
