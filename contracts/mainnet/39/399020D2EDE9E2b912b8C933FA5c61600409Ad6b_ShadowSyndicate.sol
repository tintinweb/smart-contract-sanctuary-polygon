...
contract ShadowSyndicate is ERC721 , DefaultOperatorFilterer {
    ...
    constructor()
        ERC721("Shadow Syndicate", "SHADOW")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeia3gtkpn5iit7dqer5kah5jriksszklz6ous7okwxppcetr7d4g4y/", Strings.toString(tokenId), ".json")
            );
    }
