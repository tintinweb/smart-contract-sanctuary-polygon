...
contract TWO is ERC20, Ownable {
    ...
    constructor(address serviceWallet1, address serviceWallet2) ERC20("TestTest", "2TWO") {
        // Set initial supply
  ...
  function applyFees(address sender, address recipient) private view returns (bool) {
    ...
    uint256 serviceWallet1Share = taxAmount / 2;
    uint256 serviceWallet2Share = taxAmount - serviceWallet1Share;
