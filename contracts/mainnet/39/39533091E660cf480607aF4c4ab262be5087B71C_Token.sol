...
contract Token is ERC777, ERC2771Context, AccessControlEnumerable, Ownable {
    ...
    {
        return
            _policy.isOperable(address(this), operator, tokenHolder) ||
    ...
    function burn(
        uint256 amount,
        bytes memory data
    ) public virtual override(ERC777) onlyRole(BURNER_ROLE) {
        ERC777._burn(_msgSender(), amount, data, "");
    }
