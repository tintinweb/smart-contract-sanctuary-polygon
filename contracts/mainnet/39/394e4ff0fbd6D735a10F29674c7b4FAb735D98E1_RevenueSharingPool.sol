...
contract RevenueSharingPool is Operator, ReentrancyGuard {
    ...
    uint256 public poolEndTime = 1767718800;
    ...
    function updateWeeklyRewardRate(uint256 _reward_collected) public onlyOperator {
        tokenPerSecond = _reward_collected.div(86400 * 7);
    }
