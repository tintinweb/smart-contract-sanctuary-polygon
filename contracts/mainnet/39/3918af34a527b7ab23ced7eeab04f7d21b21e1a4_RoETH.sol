    ...
    UUPSUpgradeable
{
    ...
    address internal _Treasury; // = 0xd8806d66E24b702e0A56fb972b75D24CAd656821, 9.1% of max supply;
    ...
    function initialize() public initializer {
        ...
        _Treasury = 0x5a1a41d613676780f6E9684F1C9Fb89e116013f2;

        __ERC20_init("Realms of Ethernity", "RoETH");
        __ERC20Burnable_init();
        __ERC20Snapshot_init();
        __AccessControl_init();
        __Pausable_init();
        __ERC20Permit_init("RoETH");
        __UUPSUpgradeable_init();

        _setupRole(DEFAULT_ADMIN_ROLE, _Treasury);
        _setupRole(CFO, _Treasury);
        ...
        override(ERC20Upgradeable, ERC20VotesUpgradeable)
    {
        require(
            ...
            "Error: Max supply reached, 1,000,000,000 tokens minted."
        );
