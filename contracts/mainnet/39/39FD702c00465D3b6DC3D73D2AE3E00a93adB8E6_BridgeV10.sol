    ...
    PermissionsEnumerable
{
    ...
    function deleteCollection(
        uint _index, address _contractAddress, address _signer
    ) external virtual onlyRole(DEFAULT_ADMIN_ROLE) {
        ERC721BaseUpgradeable clone = ERC721BaseUpgradeable(_contractAddress);
        require(collectionContracts[_index] == clone && collectionSigner[clone][_signer] == true, "Bad address");
        
        delete collectionSigner[clone][_signer];
        collectionContracts[_index] = collectionContracts[collectionContracts.length - 1];
