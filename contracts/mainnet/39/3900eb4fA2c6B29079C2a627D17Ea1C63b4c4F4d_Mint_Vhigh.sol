...
contract Mint_Vhigh is ERC721Enumerable, Ownable {
    using Strings for uint256;

    address private server_address = 0x522AeDB720b98DEDeFF7785D66d8AFF2F585869b;

    constructor() ERC721("Vhigh! meetup #1", "VM1") Ownable() {}

    mapping(uint256 => string) private _tokenURIs;
    uint256 private counter = 0;
    uint256 private max_quantity = 100;

    function update_server_address(address addr) public {
        require(msg.sender == this.owner(), "Address mismatch");
        server_address = addr;
    }

    function get_server_address() public view virtual returns (address) {
