...
contract ShipFuser is Managable, Pausable {
    ...
    function fuseWithEarlyClaim(uint256[] memory _botIds, address _token, IRewardsSpender.EarlyClaim calldata _earlyClaim, bytes calldata _signature) external whenNotPaused returns(uint256 totalShipsFused) {
