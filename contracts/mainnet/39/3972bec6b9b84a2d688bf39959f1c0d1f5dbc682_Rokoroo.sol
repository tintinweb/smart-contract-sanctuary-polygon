...
contract Rokoroo is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxMintAmount = 3500;
  uint256 public nftPerAddressLimit = 1000;
  bool public paused = false;
  bool public revealed = true;
  bool public onlyWhitelisted = true;
  address payable commissions = payable(0xE3f5170f81F85D371Bf15dCC7d19913Cb97B3FC1);
  address[] public whitelistedAddresses;
  mapping(address => uint256) public addressMintedBalance;

  constructor()
  ERC721("Rokoro Official", "rokoroo") 
  {
    setBaseURI("ipfs://bafybeigf7yzi6b6g4lchv7jp4panqfndwpca3suf2swu3qys6tgavekbya/");
  }
