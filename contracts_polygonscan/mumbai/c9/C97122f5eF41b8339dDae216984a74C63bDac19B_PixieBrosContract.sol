  ...
  abstract contract Allowlist is Ownable {
        ...
        , Allowlist
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x4a1edA70c3d64Cf2C352731573133C5Fcd0C70Ca);
    ...
    // File: contracts/pixieBrosContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract PixieBrosContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Pixie Bros", "PB", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "https://ipfs.io/ipfs/QmR7DT7dFrxu62pYsqcFbDzYcYRMCRTk2ysgQsBc8a9TaM/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/eoF42AjW7LNRgLPPKphP/contract-metadata";
        }
    }