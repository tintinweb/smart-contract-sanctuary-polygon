...
contract ElonatorV1 is ERC1155, IERC2981, Ownable, Pausable, ContextMixin {
    ...
    function contractURI() public pure returns (string memory) {
        return "ipfs://QmeuEiMuc4PqRAmvGhYBWVdrFE8pwNoPC6wPBFZZzR9sEZ"; // Contract-level metadata for ParkPics
    }
}
...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    constructor(string memory uri_) {
        ...
        _uriBase = "ipfs://QmYSKHPYT9UKqiVVkm4QZYNcEyxMm3PxJhxkg5htLHVNJn/"; // IPFS base for ParkPics collection
