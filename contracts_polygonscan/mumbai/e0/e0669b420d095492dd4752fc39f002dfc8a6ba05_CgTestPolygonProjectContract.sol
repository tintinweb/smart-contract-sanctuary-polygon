...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        string private IPFSTokenURI = "ipfs://QmXMDcVqo6NndyFtoPCj39ue3cPDkxwJxN419RBp7ZaQhy/";
        ...
        constructor(
            ...
            payableAddresses.push(0xf81F3a9ba796b555839255dEc420345dd6D79Ad4);
        ...
        */
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, "Cannot mint over supply cap of 3");
    ...
    // File: contracts/cgTestPolygonProjectContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract CgTestPolygonProjectContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("CG Test Polygon Project", "CG", _proxyRegistryAddress)
        {}

        

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/zOtgFLk202kh7lcncXNc/contract-metadata";
        }
    }