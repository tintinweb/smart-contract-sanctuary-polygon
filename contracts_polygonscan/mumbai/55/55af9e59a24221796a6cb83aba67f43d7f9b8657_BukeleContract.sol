  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x892cd8dA2125C1F6372e8Bf4435F10E599Bc6F43);
    ...
    // File: contracts/bukeleContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract BukeleContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Bukele", "BKL", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "https://ipfs.io/QmaMepMFgpQcTSvzZFyJtRH72AWStooBQvQ331iCCLuDcB/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/1y69TYJXKGU9OGWw6qdJ/contract-metadata";
        }
    }