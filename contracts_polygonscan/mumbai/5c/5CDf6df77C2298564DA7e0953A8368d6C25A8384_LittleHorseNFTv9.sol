...
contract LittleHorseNFTv9 is ERC721Enumerable, Ownable {  
    using Address for address;
    ...
    // Price of each token
    uint256 public initial_price = 0.05 ether;
