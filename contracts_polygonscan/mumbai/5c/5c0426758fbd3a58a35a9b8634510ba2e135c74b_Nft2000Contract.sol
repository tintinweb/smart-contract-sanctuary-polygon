...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        */
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, "Cannot mint over supply cap of 9999");
    ...
    // File: contracts/nft2000Contract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract Nft2000Contract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("NFT2000", "NFT2000", _proxyRegistryAddress)
        {}
        ...
        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/19qB5oId7R59KTfJhhKg/contract-metadata";
        }
    }