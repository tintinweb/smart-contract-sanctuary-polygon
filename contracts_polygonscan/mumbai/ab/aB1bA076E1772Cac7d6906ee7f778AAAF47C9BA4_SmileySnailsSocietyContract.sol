...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        uint256 public SUPPLYCAP = 2001;
        
        uint256 public MAX_MINT_PER_TX = 2001;
        ...
        constructor(
            ...
            payableAddresses.push(0xE2612978Ddc3F3ffdCAFcD462d8A435b7BaE3e65);
            payableFees.push(uint256(85));
    
            payableAddresses.push(0x9dE051A357f24C609de8627A8A1E38709C36B429);
            payableFees.push(uint256(10));
        ...
        */
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, "Cannot mint over supply cap of 2001");
        ...
        */
        function mintToMultiple(address _to, uint256 _amount) public payable {
            ...
            require(currentTokenId() + _amount <= SUPPLYCAP, "Cannot mint over supply cap of 2001");
    ...
    // File: contracts/smileySnailsSocietyContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract SmileySnailsSocietyContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Smiley Snails Society", "Smile", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmUYXZoWGhB29x33AS1AC5u2za7XeBxE9GM39muWtnd9c8/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/szJKnfskjFXyZOYSB7lS/contract-metadata";
        }
    }