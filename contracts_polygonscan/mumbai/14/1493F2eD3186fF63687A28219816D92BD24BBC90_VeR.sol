...
contract VeR is ERC1155Supply, Ownable {
    using Strings for uint256;

    string public constant name = "VeS13";
    string public constant symbol = "VS13";
...
/* set for 721 token uri like */
    ...
    function setMaxSilverCardCopy(uint256 _book, uint256 _maxCopy, uint256 _chapterNo) public onlyOwner {
        require(_book > 0, " book number should be bigger than 0 ");
