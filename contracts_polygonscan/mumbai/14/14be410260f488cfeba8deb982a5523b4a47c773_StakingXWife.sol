...
contract TokenSale is ERC20, Ownable, Pausable, ReentrancyGuard {
    ...
    constructor (address ownerAddress,
        ...
        adoptionPhaseDuration  = uint128(1643713200-block.timestamp);//adoptionPhaseLength * 24 * 60 * 60; //2 months
        inflationPhaseDuration = inflationPhaseLength  * 24 * 60 * 60; //6 months
...
contract StakingXWife is TokenSale, xWifeDistributionManager {
    ...
    uint128 private emissionPerSecond;
     ...
     *
     * @param ownerAddress Admin access of this contract
     * @param adoptionPhaseLength Duration of adoption phase in days
     * @param inflationPhaseLength Duration of inflation phase in days
     *
     */
    constructor (address ownerAddress,
   ...
   **/
    ...
    function updateEmissionRate() public {
        ...
        emit EmissionRateUpdated(emissionPerSecond*2);
    }
