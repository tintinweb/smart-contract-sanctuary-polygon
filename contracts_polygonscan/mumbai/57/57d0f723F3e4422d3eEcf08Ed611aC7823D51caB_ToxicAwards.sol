...
contract ToxicAwards is ERC1155, Ownable {
    ...
    constructor() ERC1155("https://storage.googleapis.com/toxicawards/meta/{id}") {
        ...
        configureAwardToken(1, 0.005 ether, 100, true);
        configureAwardToken(2, 0.01 ether, 20, true);
        configureAwardToken(3, 0.02 ether, 10, true);
        configureAwardToken(4, 0.05 ether, 5, true);
    }
