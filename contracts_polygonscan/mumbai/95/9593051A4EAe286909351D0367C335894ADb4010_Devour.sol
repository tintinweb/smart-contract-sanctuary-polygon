...
contract Devour is  ERC1155, Ownable, Pausable {

    uint16 internal totalCardNumber;

    uint256 private _currentTokenId = 0;

    uint256 public foundingMembers = 0;
    uint256 public goldTier = 1;
    uint256 public silverTier = 2;
    uint256 public bronzeTier = 3;
    ...
    constructor() ERC1155("https://mintstatecrypto.com/api/devour/card/{id}.json")
    {
        totalCardNumber = 0;
    }
