/**
 *Submitted for verification at Etherscan.io on Launch -> 2022-02-02 
*/
...
A Digital blending of Crypto Punks and Bored Apes into PUNKEYS.  
Part punk, part ape, These Punks have taken on the Style of their matching numbered ape. 1=1=1
PUNKEYSNFT.COM
PUNKEYS.NFT
...
contract PunkeysNFT is ContextMixin, Ownable, ERC721Enumerable {
  ...
  mapping(uint256 => bool) public mintedPunkeyIds;
  ...
  /*
      Public function for creating a new Punkey.
  */
  function mint(uint256 punkyNumber) public payable {
    require(!paused, "the contract is paused");
    require(mintedPunkeyIds[punkyNumber] == false, "Sorry, that Punkey has already been minted!");
  ...
  function contractURI() public pure returns (string memory) {
        return "https://metadata.punkeysnft.com/metadata/contractinfo";
  }
