...
contract ERC721ControlledUpgradeable is ERC721Upgradeable, ERC721URIStorageUpgradeable, 
                    ...
                    RoyaltiesV2Impl, OwnableUpgradeable {
    ...
    function safeMint(address payable to, uint256 _tokenId) public {
        _safeMint(to, _tokenId);

        setRoyalties(_tokenId, to, 1000);
    }
    ...
    //TO DO: Put the base uri before deploying
    function _baseURI() internal pure override returns (string memory) {
        return "https://be.pictos.io/publish-record/";
    }
