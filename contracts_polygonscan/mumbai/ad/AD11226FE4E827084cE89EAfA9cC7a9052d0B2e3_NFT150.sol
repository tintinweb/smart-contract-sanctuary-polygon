...
contract ERC1155Tradeble is ERC1155, ERC1155MintBurn, ERC1155Metadata, Ownable, MinterRole, WhitelistAdminRole {
	...
	function uri(uint256 _id) public view returns (string memory) {
		...
		// return string(abi.encodePacked(baseURI, tokenURI[_id]));
		return tokenURI[_id];
	}
	...
	function create(
		...
		string memory baseURI = 'https://yng30mk417.execute-api.ap-southeast-1.amazonaws.com/v1';
		tokenURI[_id] = string(abi.encodePacked(baseURI, _uri));
