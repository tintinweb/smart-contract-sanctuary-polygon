...
contract CustyMintpass is ERC1155, Ownable, IERC2981 {
    ...
    constructor() ERC1155("") {
        ...
        _metadataURLsByIds[MINTPASS_TOKEN_ID] =
    ...
    function mintUsingMintPass(uint256 _custyHashValue, address _recipient, string memory _tokenURI) public {
    ...
    function _mint(
        ...
        ethReceivedFromSales += 0.075 ether;
