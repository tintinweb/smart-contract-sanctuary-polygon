...
import "./aiyComplexGiftBox.sol";
import "./interfaces/IGiftRegistry.sol";

// @name AIY Complex Gift Box Factory
// @notice Used to create interest yielding gift boxes with complex redemption options
contract aiyComplexGiftBoxFactory {
  ...
  // @name Create AAVE Interest Yielding Complex Gift Box
  // @notice Complex redemption options along with auto-investing for native token with AAVE
  function createAIYComplexGiftBox(
    address _recipient,
    ...
    aiyComplexGiftBox box = new aiyComplexGiftBox(address(registry),
      _recipient,
      msg.sender,
      _conservator,
      _targetDate,
