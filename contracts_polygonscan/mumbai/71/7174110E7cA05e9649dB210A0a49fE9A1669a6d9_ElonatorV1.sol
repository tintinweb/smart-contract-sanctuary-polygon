...
contract ElonatorV1 is ERC1155, IERC2981, Ownable, Pausable, ContextMixin {
    ...
    function contractURI() public pure returns (string memory) {
        return "ar://WCQIkOGSBo1YihRUUhJbIICft4PnnbTNo9oCEQ-eU3o/contract.json"; // Contract-level metadata for ParkPics
    }
}
...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    constructor(string memory uri_) {
        ...
        _uriBase = "ar://WCQIkOGSBo1YihRUUhJbIICft4PnnbTNo9oCEQ-eU3o/"; // AR base for ElonatorV.1 collection
