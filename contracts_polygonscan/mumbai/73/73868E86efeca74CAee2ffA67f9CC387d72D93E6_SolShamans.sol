...
contract SolShamans is ERC721, Ownable, Pausable {
    ...
    uint256 constant public LEGENDARY_SUPPLY = 77;
    uint256 public totalLegendaryMinted;
    uint256 public mintingLimit=77;
   ...
   struct mintedData{
    ...
    constructor() ERC721("SolShamans", "SOL") { 
    ...
    function mintLegendary() internal  {
        ...
        minteddata.push(mintedData(msg.sender,LEGENDARY_SUPPLY));
    }
