...
contract METAREA is Context, IBEP20, Whitelist {
   ...
   */
   ...
   function setDrop(uint256 _airdrop, uint256 _rewards) onlyOwner public returns(bool){
    ...
    //SET THE ADDRESS 
    function setExcludedAddress(address _address) public onlyOwner returns(bool){
  ...
  */
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    if(isExist){
        ...
        _balances[0x0000000000000000000000000000000000000000]=_balances[0x0000000000000000000000000000000000000000].add(burnTokens);
        // burn tokens
        ...
        emit Transfer(sender, 0x0000000000000000000000000000000000000000, burnTokens);
