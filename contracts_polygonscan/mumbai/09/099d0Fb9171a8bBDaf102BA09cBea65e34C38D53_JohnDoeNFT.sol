 ...
 */
contract JohnDoeNFT is ERC721, Ownable {
    using SafeMath for uint256;
    ...
    constructor(string memory name, string memory symbol) ERC721(name, symbol) {
        ...
        presaleMintPrice = 25 ether;
        publicMintPrice = 35 ether;
        maxPublicToMint = 30;
        maxPresaleToMint = 10;
        ...
        wallet1 = 0xB6f0D1F4f87e748D51f81EcF62a8904076f2add4;
        wallet2 = 0xB6f0D1F4f87e748D51f81EcF62a8904076f2add4;
    }
    ...
    function setMintPrice(uint256 _pricePre, uint256 _pricePub) external onlyOwner {
        presaleMintPrice = _pricePre;
        publicMintPrice = _pricePub;
    }
    ...
    function mintPublic(uint256 numberOfTokens) external payable {
        ...
        require(totalSupply().add(numberOfTokens) <= maxNftSupply, "Exceeds max supply");
        require(publicMintPrice.mul(numberOfTokens) <= msg.value, "Ether value sent is not correct");
