...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
    ...
    // File: contracts/wataseAlohaGiveawayContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract WataseAlohaGiveawayContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Watase Aloha Giveaway", "WAG", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmYVuoHUbiNNvFPyXiNNrco8uJBsDJnwCJ5XUozwYRkcqj/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/COsaVmWC1WgkYOrYSNzD/contract-metadata";
        }
    }