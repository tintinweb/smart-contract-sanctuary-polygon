...
contract Honey is Context, IERC20, Ownable,Pausable{
    ...
    uint256 private _HiveSavingsTax = 10;
    ...
    function HiveSavingstax() public view returns (uint256) {
        return _HiveSavingsTax;
    }
    ...
    function _approve(address owner, address spender, uint256 amount) private {
       ...
       function SetHiveSavingTaxPercent(uint256 Hives) external onlyOwner() {
        _HiveSavingsTax =Hives;
    }
    
    function SetTreasuryTaxPercent(uint256 treasury) external onlyOwner() {
        _TreasuryTax = treasury;
    }
    ...
    function _getCalculatedFees(uint256 amount) internal view returns(  uint256, uint256, uint256) {
        ...
        fee.HiveFee = amount.mul(_HiveSavingsTax).div(100);
        fee.TreasuryFee = amount.mul(_TreasuryTax).div(100);
    ...
    constructor(address _Treasury, address _HiveSavings) {
