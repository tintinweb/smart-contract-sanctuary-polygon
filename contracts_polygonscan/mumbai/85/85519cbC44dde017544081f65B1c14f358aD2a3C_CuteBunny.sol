...
contract CuteBunny is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Cute Bunny", "CB") {
    setHiddenMetadataUri("ipfs://QmTJsHPSusecMS5jabmDwumx3hnHow4nYe8K4grAvQVne8/hidden.json");
  }
