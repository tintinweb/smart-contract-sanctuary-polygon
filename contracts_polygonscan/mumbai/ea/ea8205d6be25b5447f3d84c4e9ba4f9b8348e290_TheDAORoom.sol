...
contract TheDAORoom is ERC1155, Ownable, PaymentSplitter, ReentrancyGuard {
    using ECDSA for bytes32;

    // settings
    uint256 public constant daoRoomToken  = 0;
    uint256 public cost = 0.1 ether;

    bool public mintingEnabled = true;

    string private name_ = "TheDAORoom";
    string private symbol_ = "DGN";
    ...
    ERC1155(_initContractURI)
        PaymentSplitter(_sharesAddresses, _sharesEquity){
        setURI(_initContractURI);
        _signer = signer;
    }
    ...
    // set metadata
    function setURI(string memory _newContractURI) public onlyOwner {
    ...
    // minting function - for DAO members only
    function mint(uint8 v, bytes32 r, bytes32 s, uint256 amount, uint256 allowedAmount) public payable {
        ...
        _mint(_msgSender(), daoRoomToken, amount, "");
