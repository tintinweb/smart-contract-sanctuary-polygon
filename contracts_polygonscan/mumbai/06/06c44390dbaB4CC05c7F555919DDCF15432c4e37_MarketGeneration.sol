...
contract MarketGeneration is TokensRecoverable, IMarketGeneration, Whitelist
{
    ...
    function complete() public  isController() active()
    {
    ...
    function contribute(address referral) public payable active() onlyWhitelisted()
    {
        ...
        require(contribution[msg.sender] + msg.value <= whitelist[msg.sender].maxContribution, 'Contribution goes over limit');
