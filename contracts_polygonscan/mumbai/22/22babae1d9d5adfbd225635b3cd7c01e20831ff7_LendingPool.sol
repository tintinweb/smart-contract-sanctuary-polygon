...
contract LendingPool is IERC721Receiver {
    ...
    uint256  borrowInterestRate = 20;
    uint256  blocksPerDay = 6570; // 13.15 seconds per block
    uint256  daysPerYear = 365;
    uint256  lenderInterestRate = 10;
 
    uint256  collateral_factor = 30;
    uint256  discount_rate = 85;
    ...
    function borrow_usdc(uint256 _amount) public {
        ...
        uint256 borrow_limit = collateral_value * collateral_factor /100;
    ...
    function liquidate(address borrower) public {
        uint256  liquidation_price = NftOwnerToNumStaked[borrower] * floor_price * discount_rate / 100;
