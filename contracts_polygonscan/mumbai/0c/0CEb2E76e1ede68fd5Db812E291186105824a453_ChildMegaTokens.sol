...
import "./MegaTokens.sol";
import "./IERC1155ChildMintable.sol";

/**
 * @title ChildMegaTokens 
 * MegaTokens (ERC1155PresetMinterPauser) - See OpenZeppelin
 */
contract ChildMegaTokens is MegaTokens, IERC1155ChildMintable {
  bytes32 public constant DEPOSITOR_ROLE = keccak256("DEPOSITOR_ROLE");

  constructor(string memory uri, string memory contractUri, string memory collectionName, address royaltyFeeRecipient,
        uint8 royaltyFee, address childChainManager) MegaTokens(uri, contractUri, collectionName, royaltyFeeRecipient, royaltyFee) {
 ...
 * /// 
 */
contract MegaTokens is Ownable, AccessControlEnumerable, ERC1155Burnable, IERC2981, IMintableERC1155 {
...
/** Interface provided by Polygon (Matic) dev team to be optimized for use with POS and Plasma bridging between 
