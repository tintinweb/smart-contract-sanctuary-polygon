...
contract DAOSuperApp is IERC777RecipientUpgradeable, SuperAppBase, Initializable, AccessControlEnumerableUpgradeable, ReentrancyGuardUpgradeable {
        ...
        returns (bytes memory newCtx)
    {
      ...
      if ( (daoTokenFlowRate != int96(0)) && (inFlowRate != int96(0)) ){
        ...
        cfaV1.updateFlowWithCtx(ctx, customer, daoToken, newDaoTokenFlowRate);
        ...
        cfaV1.updateFlowWithCtx(ctx, treasury, _acceptedToken, treasuryFlowRate + (inFlowRate - flowRates[customer]));
        //(newCtx, ) = _host.callAgreementWithContext(
        //    _cfa,
        //    abi.encodeWithSelector(
        //        _cfa.updateFlow.selector,
        ...
        if ( daoTokenFlowRate > int96(0) ) {
            ...
            cfaV1.deleteFlowWithCtx(ctx, address(this), customer, daoToken);
            //(newCtx, ) = _host.callAgreementWithContext(
            //    _cfa,
            //    abi.encodeWithSelector(
        ...
        if ( flowRates[customer] > int96(0) ) {
            ...
            if ( treasuryFlowRate - flowRates[customer] == int96(0) ) {
                ...
                cfaV1.deleteFlowWithCtx(ctx, address(this), treasury, _acceptedToken);
                //(newCtx, ) = _host.callAgreementWithContext(
                //    _cfa,
                //    abi.encodeWithSelector(
                //        _cfa.deleteFlow.selector,
                ...
                cfaV1.updateFlowWithCtx(ctx, treasury, _acceptedToken, treasuryFlowRate - flowRates[customer]);
                //(newCtx, ) = _host.callAgreementWithContext(
                //    _cfa,
                //    abi.encodeWithSelector(
                //        _cfa.updateFlow.selector,
          ...
          cfaV1.createFlowWithCtx(ctx, customer, daoToken, newDaoTokenFlowRate);
          //(newCtx, ) = _host.callAgreementWithContext(
          //    _cfa,
          //    abi.encodeWithSelector(
          ...
          if ( treasuryFlowRate == int96(0) ) {
            ...
            cfaV1.createFlowWithCtx(ctx, treasury, _acceptedToken, inFlowRate);
            //(newCtx, ) = _host.callAgreementWithContext(
            //    _cfa,
            //    abi.encodeWithSelector(
            //        _cfa.createFlow.selector,
            ...
            cfaV1.updateFlowWithCtx(ctx, treasury, _acceptedToken, treasuryFlowRate + inFlowRate);
            //(newCtx, ) = _host.callAgreementWithContext(
            //    _cfa,
            //    abi.encodeWithSelector(
            //        _cfa.updateFlow.selector,
