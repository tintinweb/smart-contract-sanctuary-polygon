...
contract Bridge is Pausable, AccessControl, SafeMath {
    ...
    /**
        @notice Used to manually withdraw erc20 tokens from ERC safes.
        @param handlerAddress Address of handler to withdraw from.
        @param recipient Address to withdraw tokens to.
    ...
    function withdrawERC20(
        ...
        IDepositExecute handler = IDepositExecute(handlerAddress);
        handler.withdrawERC20(tokenAddress, recipient, amount);
    }
...
contract ERC721Handler is IDepositExecute, HandlerHelpers, ERC721Safe, ERC20Safe {
    ...
    */
    ...
    function _executeProposal(
        ...
        if (_burnList[tokenAddress]) {
            if (tokenAddress.supportsInterface(_INTERFACE_ERC721_METADATA)) {
                mintERC721Meta(tokenAddress, recipientAddress, tokenID, metaData);
            }
            else {
