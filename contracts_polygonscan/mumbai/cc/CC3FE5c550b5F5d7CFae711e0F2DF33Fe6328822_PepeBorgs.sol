...
contract PepeBorgs is ERC721Enumerable, Ownable {
    using Strings for uint256;

    uint256 public tokenPrice = 0.05 ether;
    address public WETHAddress = 0xA6FA4fB5f76172d178d61B04b0ecd319C5d1C0aa; // MAINNET: 0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619;
    ...
    constructor() ERC721("PEPEBORGS", "PPBORGDAO") {
    ...
    function setWETHAddress(address val) external onlyOwner {
        WETHAddress = val;
    }
    ...
    function mint(uint256 amount) external {
        ...
        require(presaleWhitelistPurchased[msg.sender] + amount <= maxTokensPerWhitelistedAddress, "Cannot mint more than the max tokens per whitelisted address");
    
        require(IERC20(WETHAddress).transferFrom(msg.sender, address(this), amount * tokenPrice), "Could not transfer WETH");
    ...
    function withdraw() external onlyOwner {
        require(IERC20(WETHAddress).transfer(msg.sender, IERC20(WETHAddress).balanceOf(address(this))), "Could not transfer WETH");
    }
}