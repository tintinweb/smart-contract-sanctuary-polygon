...
contract SphereToken is ERC20Detailed, Ownable {
    ...
    address public maiToken = 0xe6b8a5CF854791412c1f6EFC7CAf629f5Df1c747;
    ...
    constructor() ERC20Detailed("Sphere Finance", "SPH", uint8(DECIMALS)) {
    ...
    function manualRebase() external onlyOwner{
        ...
        uint256 circulatingSupply = getCirculatingSupply();
        int256 supplyDelta = int256(circulatingSupply.mul(rewardYield).div(rewardYieldDenominator));
        rebaseIndex = rebaseIndex.mul(rewardYield).div(rewardYieldDenominator);
