...
contract LuckyFaiChun is ERC721, Ownable {
    uint16 public version=2;
    uint public MAX_TOKENS = 6888;
    uint constant public MINT_PER_TX_LIMIT = 50;
    ...
    string private _apiURI = "https://api.luckyfaichun.art/";
   

    constructor() ERC721("LuckyFaiChun", "LuckyFaiChun"){

        phasePrice[0] = 0 ether;
        phasePrice[1] = 1 ether;
        phasePrice[2] = 2 ether;
        phasePrice[3] = 3 ether;
    ...
    function mintPrice(uint _amount) public view returns (uint) {
        ...
        }else if(2889<=tokensMinted&&tokensMinted<=6888){
