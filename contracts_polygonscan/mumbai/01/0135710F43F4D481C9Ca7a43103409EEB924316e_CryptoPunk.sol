...
contract CryptoPunk is ERC721URIStorage, Ownable {
    struct CryptoPunk {
        string name;
    }

    CryptoPunk[] public cryptoPunks;
    ...
    function mintToken(string memory name, string memory metadataURI)
        external
        payable
        onlyOwner
    {
        require(msg.value >= fee, "Invalid value");
        cryptoPunks.push(CryptoPunk(name));
