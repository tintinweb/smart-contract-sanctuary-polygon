...
contract DexUpdates is Ownable, DexStorage {
  ...
  function getLists(uint256 tokenId, address collection) isValid(collection) public view returns(address[10] memory addresses, uint256[10] memory amounts, uint256[10] memory timestamps, uint256[10] memory ids){
