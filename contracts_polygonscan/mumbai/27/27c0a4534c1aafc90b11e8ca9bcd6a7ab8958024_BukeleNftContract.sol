...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
    ...
    // File: contracts/bukeleNftContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract BukeleNftContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Bukele NFT", "Bukele", _proxyRegistryAddress)
        {}
        ...
        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/9gGsBmMuJx2Kur40ihME/contract-metadata";
        }
    }