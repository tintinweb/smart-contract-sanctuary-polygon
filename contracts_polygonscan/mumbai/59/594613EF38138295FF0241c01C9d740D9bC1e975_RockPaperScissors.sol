...
contract RockPaperScissors {
    ...
    function getPlayerParameters() public view onlyRegisteredPlayer onlyRoomClose returns(address OpponentAddress, uint TimeLeftToPlay, bool PlayerPlayed, bool OpponentPlayed, bool PlayerRevealed, bool OpponentRevealed) {
        return (getOpponentAddress(), timeLeftToPlay(), plays[msg.sender].played, plays[getOpponentAddress()].played, plays[msg.sender].revealed, plays[getOpponentAddress()].revealed);
    }

    // TODO : Merge forceEndRound logic with getMatchResult
    function forceEndRound() public onlyRoomClose returns(string memory){
    ...
    // TODO : Change logic store Game Started time and compare with current block time
    function timeLeftToPlay() private view returns(uint){
    ...
    // TODO : Automatic variable updates depending on games history
    // TODO Remove some Parameters like updateFees
    ...
    // TODO : DELETE once automatic owner fees will be done
