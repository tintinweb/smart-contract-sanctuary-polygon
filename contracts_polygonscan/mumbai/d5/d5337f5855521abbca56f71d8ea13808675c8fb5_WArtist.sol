	...
	Whitelist
{
	...
	// URI's available f artists of each rarity
	...
	function fulfillRandomness(bytes32 requestId, uint256 randomNumber) internal override {
		...
		removeMintedURI(index, artistsURIByRarity[rarity]);
	...
	function removeMintedURI(uint256 index, string[] storage array) private {
