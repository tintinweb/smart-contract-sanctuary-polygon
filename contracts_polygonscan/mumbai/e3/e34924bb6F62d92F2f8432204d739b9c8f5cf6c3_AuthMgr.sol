...
contract AuthMgr {
    ...
    function Add(bytes32 ContractName, bytes32 FuncName, address Sender) external virtual modcanDo("Add") {
    ...
    function Remove(bytes32 ContractName, bytes32 FuncName, address Sender) external virtual modcanDo("Remove") {
        FuncName = ContractName;  //ToDo: Check on ContractName and on FuncName;
