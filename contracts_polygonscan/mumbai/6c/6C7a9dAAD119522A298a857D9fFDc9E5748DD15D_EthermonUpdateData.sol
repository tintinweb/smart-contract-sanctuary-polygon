    ...
    NativeMetaTransaction
{
    ...
    function updateMonsterClassBasic(
        uint32 _classId,
        uint8 _type,
        //uint256 _price,
    ...
    function getMonsterStartStats(uint64 _monsterId)
        external
        view
        returns (
            uint256 _ss1,
    ...
    function getMonsterStepStats(uint64 _monsterId)
        external
        view
        returns (
            uint256 _st1,
