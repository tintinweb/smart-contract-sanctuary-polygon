...
/**
 * @dev contract module which defines myContract NFT Collection
...
contract myContract is ERC1155, Ownable {
    ...
    /**
     * @dev Create an instance of myContract contract
     */
    constructor(
    ...
    function mint(address _to, uint256 _mintAmount) public payable {
        ...
        require(_mintAmount <= maxMintAmount, "Only 10 myContract are Allowed Per Transaction");
        require(
