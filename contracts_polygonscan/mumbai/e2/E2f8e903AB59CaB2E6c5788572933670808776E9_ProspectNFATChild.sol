...
/**
 * This contract handles Prospect Non-Fungible Athlete Tokens (NFATs).
 * The NFATs are mintable on Polygon and can be transferred to the Ethereum network.
 * https://docs.polygon.technology/docs/develop/ethereum-polygon/mintable-assets/
 */
contract ProspectNFATChild is
    ERC1155,
    ERC1155Burnable,
    IChildToken,
    AccessControlMixin,
    ...
    ContextMixin
{
    ...
    constructor(string memory uri_, address childChainManager)
        ERC1155(uri_)
    {
        _setupContractId("ProspectNFATChild");
