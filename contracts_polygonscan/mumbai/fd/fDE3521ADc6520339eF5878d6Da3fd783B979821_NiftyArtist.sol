...
contract NiftyArtist is ERC721EnumerableUpgradeable,  AccessControlUpgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    // Max NFTs total.
    uint public constant MAX_TOKENS = 880;
    ...
    address public mintPassAddr;
    mapping(uint => bool) usedMintPassNFTs;
    ...
    */
    ...
    /*
    * Allow mint pass holders to mint NFTs.
    */
    function mintWithMintPass(address to, uint256 mintPassID) public {
        // Make sure we still have tokens.
        require(totalSupply() < MAX_TOKENS,
                "We're at max supply!");
        
        // Ensure you have a mint pass.
        IERC721 mintPass = IERC721(mintPassAddr);
        require(mintPass.ownerOf(mintPassID) == msg.sender, "You don't have any mint passes!");

        //Ensure mintPassId is not in usedMintPassNFTs
        require(usedMintPassNFTs[mintPassID] == false, "Mint pass already used!");

        // Add mintPassID to usedMintPassNFTs array
        usedMintPassNFTs[mintPassID] = true;
    ...
    /**
    * Check if a mint pass is used.
    */
    function isMintPassUsed(uint256 mintPassID) public view returns (bool) {
        return usedMintPassNFTs[mintPassID];
    }
    ...
    function setMintPassAddress(address addr) public {
        require(hasRole(ADMIN_ROLE, msg.sender), "Caller is not admin");
