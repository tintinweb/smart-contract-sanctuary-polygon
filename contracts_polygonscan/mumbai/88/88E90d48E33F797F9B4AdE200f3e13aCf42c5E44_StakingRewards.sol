...
contract StakingRewards is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    function stake(uint _amount, uint256 timestamp) external {
        ...
        if (stakeholders[msg.sender].exist) {
            ...
            stakeholders[msg.sender].stakeTime = timestamp;
        } else {
            stakeholders[msg.sender] = Stakeholder(_amount, timestamp, true);
