...
contract Urbs is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000000000 * 10**2;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Urbs";
    string private _symbol = "URBS";
    ...
    address  public marketingAddress = 0x2efDf683c44A10D5ED6e4B0888dcb5Cb13648df0;
    ...
    uint256 private numTokensSellToAddToLiquidity = 1000000000 * 10**2;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        _transferStandard(sender, marketingAddress, fundingPiece);
