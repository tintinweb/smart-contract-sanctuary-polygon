...
contract XNToken is ERC20PresetMinterPauser, Ownable {
  ...
  constructor(
    ...
    require(cap > 0, "XNToken: cap is 0");
    _cap = cap;
  ...
  function transferMultiple(address[] memory dests, uint256[] memory values) external onlyOwner
  returns (uint256) {
      uint256 i = 0;
