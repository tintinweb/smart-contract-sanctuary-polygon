...
contract AddrMgr {
    ...
    function get(bytes32 ContractName) public view returns (address) {
        ...
        address PANICAuthMgr = 0x21d78f144F1C82d46EAc5d93300F23e442c9E353;  //ToDo: Impostare l'indirizzo di un AuthMgr con Address e Permessi su indirizzi Base Speciali
