...
contract MelXNFTPayment is Initializable, AccessControlUpgradeable {
    ...
    function _fee(address _payer) internal {
        ...
        emit PayFee(_msgSender(), feeReceiver, feeAmount);
    }
...
contract MelXNFTV1 is IMelXNFT, MelXNFTPayment, MelXNFTBasic {
    ...
    mapping(uint256 => bool) public nftToSetTokenUri;
        ...
        returns (uint256 nftTokenId)
    {
        ...
        _fee(_to); // Paying fee with Mel
        nftToSetTokenUri[tokenId] = false;
        return tokenId;
    }
        ...
        onlyRole(URI_SETTER_ROLE)
    {
        ...
        nftToSetTokenUri[_tokenId] = true;
