...
contract Merchant is Pausable {
    ...
    IBEP20 public constant USDT =
        IBEP20(address(0x98F7aDb95Ad50E6f53282C9d7178d96b86DC3658));
    ...
    IUniswapV2Router02(address(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff)); // Pancake V2 router
    ...
    function swapBnbToWeb3(uint256 etherAmount) private {
        ...
        path[0] = address(0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889);
        ...
        returns (uint256)
    {
        ...
        address WETH = address(0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889);
    ...
    function swapTokenToUsdtAndTransferToMerchantWallet(
        ...
        if (_tokenAddress == address(USDT)) {
        ...
        } else if (_tokenAddress == address(0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889)) {
            if (isPathValid) {
                // make the swap
                pancakeV2Router
                ...
                defaultPath[0] = address(0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889);
            ...
            if (isPathValid) {
                ...
                defaultPath[1] = address(0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889);
    ...
    function getFeeAmount(
        ...
        if (
            ...
            feePath[feePath.length - 1] == address(0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889)
        ) {
            ...
            path[1] = address(0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889);
            uint256[] memory amounts = pancakeV2Router.getAmountsOut(
                amountIn,
                path
            );
