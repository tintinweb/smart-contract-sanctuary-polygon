...
// File: contracts\GNSTestnetTradingV6.sol


pragma solidity 0.8.11;

contract GNSTestnetTradingV6{
    ...
    // Params (adjustable)
    uint public maxPosDai = 25000 * 1e18;   // 1e18 ($)
    ...
    // Modifiers
    modifier onlyGov(){ require(msg.sender == storageT.gov()); _; }
    ...
    function setMarketOrdersTimeout(uint _marketOrdersTimeout) external onlyGov{
        require(_marketOrdersTimeout > 0);
