...
/**
 * Testnet smart contract for use by the MASQ Network and their community - used as test utility token in MASQ
 * decentralized mesh network solution, for internet freedom
 * 
...
contract tMASQ is ERC20Burnable, Ownable {
    string public constant name = "tMASQ";
    string public constant symbol = "tMASQ";
    uint8 public constant decimals = 18;

    // 1 million tokens * decimal places (10^18)
