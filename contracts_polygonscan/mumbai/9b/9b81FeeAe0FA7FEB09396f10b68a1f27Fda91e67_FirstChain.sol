...
contract FirstChain is IERC20, Ownable{
    ...
    function setMaximumTotalSupply(uint256 _maximum) public onlyOwner {
        max_total_supply = _maximum;
    }

    function mint(address account, uint256 amount) public onlyMinter {
        require (SafeMath.add(totalSupply(), amount) <= getMaxTotalSupply(), "Cannot mint because maximum supply has been reached");
