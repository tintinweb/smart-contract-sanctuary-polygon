...
contract ConditionalTokenGovernance is GovernorVotes, Roles {
    ...
    function _countVote(
        ...
        require(weight >= proposalThreshold(), "GovernorVotingSimple: Minimum Holding not reached");
     ...
     */
    function setProposalThreshold(uint256 newProposalThreshold) public virtual onlyRole(GUARDIAN_ROLE) {
