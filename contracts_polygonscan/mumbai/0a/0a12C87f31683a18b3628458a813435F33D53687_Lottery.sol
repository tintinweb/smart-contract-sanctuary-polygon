...
contract Lottery is VRFConsumerBase, Ownable, ERC1155 {
    ...
    event NFTMinted(address receiver, uint rarity);
    ...
    function mintEntrantNFT() private returns (bytes32 requestId) {
...
*/
    ...
    function mintTicket(uint256 rarity) public {
    ...
    function drawWinner(uint256 rarity) public payable {
        require(balanceOf(msg.sender, rarity) == 1, "Address does not possess valid ticket");
    }
