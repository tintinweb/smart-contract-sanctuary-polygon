...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        */
        function mintToMultiple(address _to, uint256 _amount) public payable {
            ...
            require(currentTokenId() + _amount <= SUPPLYCAP, "Cannot mint over supply cap of 7000");
    ...
    // File: contracts/cocoonCritterzClubContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract CocoonCritterzClubContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Cocoon Critterz Club", "CCC", _proxyRegistryAddress)
        {}
        ...
        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/3Gf8huKuwZqluV4BddJg/contract-metadata";
        }
    }