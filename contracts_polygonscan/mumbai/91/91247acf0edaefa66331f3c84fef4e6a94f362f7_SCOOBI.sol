 ...
 */
contract SCOOBI is Context, IERC20 {
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        require(currentAllowance >= amount, "SCOOBI: transfer amount exceeds allowance");
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        require(sender != address(0), "SCOOBI: transfer from the zero address");
        require(recipient != address(0), "SCOOBI: transfer to the zero address");

        _beforeTokenTransfer(sender, recipient, amount);

        uint256 senderBalance = _balances[sender];
        require(senderBalance >= amount, "SCOOBI: transfer amount exceeds balance");
    ...
    function _approve(address owner, address spender, uint256 amount) internal virtual {
        require(owner != address(0), "SCOOBI: approve from the zero address");
        require(spender != address(0), "SCOOBI: approve to the zero address");
