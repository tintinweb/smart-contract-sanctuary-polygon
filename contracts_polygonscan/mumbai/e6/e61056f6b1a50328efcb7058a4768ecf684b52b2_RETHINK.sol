...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xA0c68C638235ee32657e8f720a23ceC1bFc77C77);
    address WAVAX = 0x462C98Cae5AffEED576c98A55dAA922604e2D875;
    IDEXRouter router;
    ...
    constructor (address _router) {
        ...
        ? IDEXRouter(_router)
        : IDEXRouter(0xbdd4e5660839a088573191A9889A262c0Efc0983);
        _token = msg.sender;
    }
...
contract RETHINK is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xA0c68C638235ee32657e8f720a23ceC1bFc77C77; // EP
    //address public WAVAX = 0x462C98Cae5AffEED576c98A55dAA922604e2D875;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "RETHINK";
    string constant _symbol = "$RETH";
    ...
    address public autoLiquidityReceiver=0xCc12fa85d6dfaB1D786699A5854594B46db68fC8;
    address public marketingFeeReceiver=0xCc12fa85d6dfaB1D786699A5854594B46db68fC8;
    ...
    constructor () Auth(msg.sender) {
        address _router = 0xbdd4e5660839a088573191A9889A262c0Efc0983;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // Max  tx check
        address routerAddress = 0xbdd4e5660839a088573191A9889A262c0Efc0983;
