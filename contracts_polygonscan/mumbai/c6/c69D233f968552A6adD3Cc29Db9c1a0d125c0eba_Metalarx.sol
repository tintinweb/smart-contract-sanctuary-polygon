...
contract Metalarx is ERC721, Ownable, RandomlyAssigned {
    using Strings for uint256;
    uint256 public currentSupply = 0;
    mapping(address => uint256) public mintedWallets;
    string public baseURI = "https://ipfs.io/ipfs/Qmbi93LDJYrB7jPkQAEJrYYasi1wWfjzNr8m5hoyWApoo9/";

    constructor() ERC721("Metalarx", "LARX") RandomlyAssigned(10,1) {
    ...
    function mint(address _to) public payable {
        require( tokenCount() + 1 <= totalSupply(), "You can't mint more than the maximum supply");
        require( availableTokenCount() - 1 >= 0, "You can't mint more than the available NFT count."); 
        require( tx.origin == msg.sender, "You can't mint through a custom contract.");

        if (msg.sender != owner()) {  
            require( msg.value >= 0.0005 ether, "Not enough ether.");
            require(mintedWallets[msg.sender] < 1, "Exceeds max NFT per wallet.");
        }
