...
contract Indradex is Ownable {
  uint256 private _apr;

  event APRUpdated(uint256 indexed previousApr, uint256 indexed newApr);
  ...
  /**
    * @dev Returns the number of decimals used to get APR user representation.
    */
  function aprDecimals() public pure returns (uint8) {
    return 18;
  }
