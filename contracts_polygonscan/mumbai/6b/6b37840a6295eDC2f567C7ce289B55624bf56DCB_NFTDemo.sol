...
contract NFTDemo is ERC721Enumerable, ERC2981Collection, ERC165Storage, Ownable {
  using Strings for uint256;

  string public baseURI;
  string public baseExtension = ".json";
  uint256 public cost = 100000000000000000; // in WEI = 0.1 matic
  ...
  function withdraw() public payable onlyOwner {
    require(payable(msg.sender).send(address(this).balance), "error withdraw");
  }
}
