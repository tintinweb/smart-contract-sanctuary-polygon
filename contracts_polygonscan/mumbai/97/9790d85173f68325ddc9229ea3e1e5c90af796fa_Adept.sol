...
{
    uint256 private constant cap = 100 ether; // 1000000000 ether
    ...
    function getCapValue() public view virtual returns (uint256) {
        return cap;
    }

    function mint(uint256 amount) external onlyMinter {
        require(
            ERC20Upgradeable.totalSupply() + amount <= getCapValue(),
