...
contract Kurosekai is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Kurosekai", "KS") {
    setHiddenMetadataUri("ipfs://QmeBWvtvXoA6HAGRwZ9Lj8BHSDvfVsn6yNTUMHyftYaxes/hidden.json");
  }
