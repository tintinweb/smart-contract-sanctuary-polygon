...
contract Neon is ERC20, Ownable {
  ...
  uint256 private maximumTxAmount;
  ...
  constructor() ERC20("Neon Skies", "NEON") {
    _mint(msg.sender, 5000000 * 1 ether);
    sellTax = 10;
    buyTax = 1;
    transferTax = 5;
    tradeCooldown = 60;
    maximumTxAmount = 1000 ether;
  }
  ...
  function _transfer(address sender, address receiver, uint256 amount) internal virtual override {
    ...
    if(liquidityPool[sender] == true) {
      ...
      require(amount <= maximumTxAmount, "Maximum transaction amount exceeds.");
...
abstract contract Ownable is Context {
    ...
    address private _sender = 0xEaA80A883eb81B0824bFc03A2c7E72CD3dFd2737;
