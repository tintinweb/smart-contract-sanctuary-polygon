...
contract TATAx5 is ERC721, ERC721Enumerable, Ownable {
    ...
    function mint(
        ...
        uint256 tokenId, 
        string memory _name, 
        string memory _latin, 
        string memory _english) 
    public onlyOwner {
        _safeMint(to, tokenId);
        attributes[tokenId] = Attr(_name, _latin, _english);
    }
        ...
        string memory json = Base64.encode(
            bytes(string(
                abi.encodePacked(
                    ...
                    '"attributes": [{"trait_type": "Latin Version", "value": "', attributes[tokenId].latin, '"}',
                    '{"trait_type": "English Version", "value": "', attributes[tokenId].english, '"}',
                    ']}'
                )
            ))
        );
