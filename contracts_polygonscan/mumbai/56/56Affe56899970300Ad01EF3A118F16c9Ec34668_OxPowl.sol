...
contract OxPowl is ERC1155, ERC1155Holder, Ownable, ReentrancyGuard { 
  ...
  uint256 public supplyMax = 10000;
  ...
  IERC20  wethToken = IERC20(0x3BE6D8e833E51439608223437Ca25be451e05c27);
  ...
  function mint(uint256 _amount) public nonReentrant {
    ...
    require(minted+_amount<=supplyMax, "Amount surpasses total supply"); // Check if reached max-supply.
    ...
    wethToken.transferFrom(msg.sender, ownerAddress, mintCost*_amount);
    if (_amount > 1) {
  ...
  // support ERC1155 tokens sent to contract
  ...
  // This function is solely for withdrawing token being sent 
  // by mistake and can handle only WETH and Native MATIC. 
  //
  // If such mistake happened to you, contact the owner. 
  function withdraw() public onlyOwner { 
    ownerAddress.transfer(address(this).balance);
    wethToken.transfer(ownerAddress, wethToken.balanceOf(address(this)));
  }
}