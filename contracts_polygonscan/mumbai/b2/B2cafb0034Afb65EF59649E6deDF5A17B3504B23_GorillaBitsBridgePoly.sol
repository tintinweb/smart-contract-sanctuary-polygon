 ...
 */
contract GorillaBitsBridgePoly is ERC1155Holder, Ownable, ReentrancyGuard {
  ...
  /***********Emergency**************/
  /**
   * @dev transfer GB 1155 from bridge in case token gets stuck or someone is sending by mistake
   */
