...
contract DPSShipyard is Ownable, ReentrancyGuard {
    ...
    function claimFlagship(uint16 _dpsId) external nonReentrant {
        require(gameSettings.isPaused(2) == 0, "Paused");
        require(dps.ownerOf(_dpsId) == msg.sender, "You don't owe this DPS Pirate");
        require(!flagship.exists(_dpsId), "Flagship already minted");
    ...
    function repairFlagship(uint256 _flagshipId) public {
        require(flagship.ownerOf(_flagshipId) == msg.sender, "You don't owe this Flagship");
