...
contract Thels is Ownable {
    ...
    function startStream(
        ...
        require(
            addFee(totalBorrow, FEE + BUFFER) < getBorrowableAmount(msg.sender),
            "Cannot borrow more than allowed."
        );
        borrowAmounts[msg.sender] += addFee(totalBorrow, FEE + BUFFER);
        addStream(
            stream,
            receiver,
            flowRate,
