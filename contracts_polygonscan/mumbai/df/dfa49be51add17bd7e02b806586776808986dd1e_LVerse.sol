...
contract LVerse is ERC721, Ownable {
  using Strings for uint256;
  ...
  Bulding[] public buildings;

  constructor() ERC721("LVerse", "LIND") {
    setHiddenMetadataUri("ipfs://__CID__/hidden.json");
    buildings.push(Bulding("ZERO", 0,0,0,0,0,0));
    buildings.push(Bulding("House", 1,3,2,2,0,3));
    buildings.push(Bulding("Jimmy House", 2,5,4,10,0,6));
  }
  ...
  modifier mintCompliance(uint256 _mintAmount) {
    ...
    function getBuildings() public view returns (Bulding[] memory) {
    return buildings;
  }
