...
contract ApeironPlanet is Initializable, ERC721Upgradeable, PausableUpgradeable, OwnableUpgradeable, ERC721BurnableUpgradeable {
    ...
    function initialize() initializer public {
        __ERC721_init("ApeironPlanet", "APP");
        __Pausable_init();
        __Ownable_init();
