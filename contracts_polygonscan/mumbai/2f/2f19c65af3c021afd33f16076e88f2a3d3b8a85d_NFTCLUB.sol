...
contract NFTCLUB is ERC721, Ownable {
    ...
    using SafeMath for uint256;
    uint256 public price = 1000000000000000; //0.03 ETH
    uint public constant maxItems = 20;
    uint256 public MAX;
    bool public saleIsActive = false;
     mapping (
    address => uint) public Leaderboard;
    ...
    function mintItems(uint numberOfTokens,address referral) public payable {
        require(saleIsActive, "Sale must be active to mint NFT");
        require(numberOfTokens <= maxItems, "Can only mint 20 tokens at a time");
        ...
        Leaderboard[referral]=Leaderboard[referral]+numberOfTokens;
        emit Increment(msg.sender);
    }
