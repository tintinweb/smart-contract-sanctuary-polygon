...
contract Elixir is ERC721, ERC721Burnable, AccessControl  {
    ...
    function tokenURI(uint256 tokenId) 
        ...
        returns (string memory) 
        {
            ...
            uint256 currentPrice = uint256(IAcademy(academy).priceFromOracle(oracleAddress));
                    uint256 ForgeConstant = elements[tokenId].forgePrice * ratioOfSteady / 100;
            string memory elixirCurrentSteadyValue = toString((currentPrice  
                                                                    - ForgeConstant) 
