  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0xA1320Eb8ffAf3f00921801299F3FEe2BF1f749c1);
    ...
    // File: contracts/myNftTtContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract MyNftTtContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("My NFT TT", "TTTT", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://Qma8Jm8wiHkGnfnsJrCWq9VGePkcsjfgRKtkHz4gGjH1Wp/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/OU55CsEu77KDScZceNY3/contract-metadata";
        }
    }