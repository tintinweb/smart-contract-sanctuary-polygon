...
contract ICO is Ownable, ReentrancyGuard {
    ...
    constructor(address _tokenAddress, address owner){
        ...
        vestingAddress = address(new Vesting(tokenAddress, owner));
    ...
    function _getAmountForETH(uint amountETH) private view returns (uint256){
        ...
        uint256 usdAmount = amountETH.div(uint256(rate));
        ...
        if (amountTokens > current_allocatedTokens) {
            ...
            while (usdAmount > 0) {
                ...
                if (amount > current_allocated) {
                    ...
                    uint256 usdForAllocated = ethForAllocated.div(uint256(rate));
    ...
    function buy() public payable whenIcoStart allowedInvestor {
        ...
        if (currentIterationOfICO > 101 && currentIterationOfICO < 201) {
            ...
            Vesting(vestingAddress).startVesting(msg.sender, amount, currentIterationOfICO);
        } else {
    ...
    function buyFor(uint256 value, address buyer) public payable onlyOwner whenIcoStart {
        ...
        if (currentIterationOfICO > 101 && currentIterationOfICO < 201) {
            ...
            Vesting(vestingAddress).startVesting(buyer, amount, currentIterationOfICO);
        } else {
...
contract Vesting is Ownable, ReentrancyGuard {
    ...
    uint256 public constant START_ITERATION = 102;
    uint256 public constant LAST_ITERATION = 201;
