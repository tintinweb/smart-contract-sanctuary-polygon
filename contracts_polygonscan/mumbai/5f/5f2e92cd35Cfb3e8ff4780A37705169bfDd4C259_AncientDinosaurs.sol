...
contract AncientDinosaurs is ERC721, Ownable, ERC721Enumerable {
    ...
    uint256 public constant tokenPrice = 190000000000000000; // 0.19 Polygon
    uint256 public constant presaleTokenPrice = 90000000000000000; // 0.09 Polygon
    uint256 public constant maxTokenPurchase = 100;
    uint256 public constant MAX_TOKENS = 10000;

    string public baseURI = ""; // IPFS URI WILL BE SET AFTER ALL TOKENS SOLD OUT - http://ancientdinosaurs.com/arts/
