...
// File: contracts/MetaSharksComicBook.sol
...
contract MSTest is ERC1155Burnable {
    ...
    address private sharkAddress;

    constructor() ERC1155("https://metasharks.mypinata.cloud/ipfs/QmVNL2yZiuWVxJTmNJYUViqitXMddeNWoXmsAvzFJNER7Z/{id}.json") 
    {
        owner = msg.sender;
    }
