...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 WBAN = IBEP20(0xe20B9e246db5a0d21BF9209E4858Bc9A3ff7A034);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = WBAN.balanceOf(address(this));
        ...
        uint256 amount = WBAN.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            WBAN.transfer(shareholder, amount);
...
contract GLYCINE is IBEP20, Auth {
    using SafeMath for uint256;

    address WBAN = 0xe20B9e246db5a0d21BF9209E4858Bc9A3ff7A034;
    address WMATIC = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Glycine";
    string constant _symbol = "GLYCINE";
    ...
    function swapBack() internal swapping {
        ...
        payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 300000}("");
        payable(charityFeeReceiver).call{value: amountBNBCharity, gas: 300000}("");
