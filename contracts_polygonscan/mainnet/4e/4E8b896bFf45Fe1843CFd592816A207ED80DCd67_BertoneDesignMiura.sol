...
import "./interfaces/IBertoneDesignMiura.sol";

contract BertoneDesignMiura is
    IBertoneDesignMiura,
    Ownable,
    ERC1155,
    MerkleProofVerify
{
    /**
     * @dev See {IBertoneDesignMiura-name}
     */
    string public constant override name = "The Ghost of Miura";

    /**
     * @dev See {IBertoneDesignMiura-symbol}
     */
    string public constant override symbol = "GSTMR";

    /**
     * @dev See {IBertoneDesignMiura-maxSupply}
     */
    uint32 public constant override maxSupply = 500;

    /**
     * @dev See {IBertoneDesignMiura-price}
     */
    ...
    /**
     * @dev See {IBertoneDesignMiura-wallet}
     */
    address public immutable override wallet;

    /**
     * @dev See {IBertoneDesignMiura-totalSupply}
     */
    ...
    /**
     * @dev See {IBertoneDesignMiura-claims}
    ...
    /**
     * @dev See {IBertoneDesignMiura-tokensPrice}.
     */
    ...
    /**
     * @dev See {IBertoneDesignMiura-mint}.
     *
    ...
    /**
     * @dev See {IBertoneDesignMiura-claim}.
     *
     * Emits a {NFTMinted} event indicating the mint of amount of a new NFT.
     *
    ...
    /**
     * @dev See {IBertoneDesignMiura-freeMint}.
     *
     * Emits a {NFTMinted} event indicating the mint of amount of a new NFT.
     *
    ...
    /**
     * @dev See {IBertoneDesignMiura-setTokenURI}.
     *
    ...
    /**
     * @dev See {IBertoneDesignMiura-setRoot}.
     *
