...
/** 
 *  SourceUnit: ..\Museo\contracts\MuseoNFT.sol
*/
...
contract MuseoNFT is ERC721 {
    ...
    constructor (string memory _name,
        string memory _uri,
        address creator,
        bool bPublic) ERC721(_name,_name) {
        factory = msg.sender;
        collection_uri = _uri;
    ...
    function addItem(string memory _tokenURI, uint256 royalty) public returns (uint256){
        require(royalty <= FEE_MAX_PERCENT, "Royalty requested too large");
        require(royalty >= FEE_MIN_PERCENT, "Royalty requested too small");
