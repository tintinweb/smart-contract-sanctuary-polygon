...
This is the Pulsar Contract
You can use it for free if you own an invader
   ...
   using SafeERC20 for IERC20;
    ...
    function executeOperation(
        ...
        for (uint256 tid = 0; tid < sequence.target.length; ++tid) {
            _executeCall(sequence.target[tid], sequence.callData[tid], sequence.value[tid]);
        }
    ...
    function _executeCall(address target, bytes memory callData, uint256 value)
        internal
        returns (bytes memory)
    {
        ...
        (success, _res) = target.call{value: value}(callData);
        ...
        returns (Sequencer.TradeSequence memory)
    {
        ...
        return Sequencer.TradeSequence(target, callData, value);
    }
...
library Sequencer {
    ...
    struct TradeSequence {
        ...
        uint256[] value;  // the asset the contract send you back at the end
    }
