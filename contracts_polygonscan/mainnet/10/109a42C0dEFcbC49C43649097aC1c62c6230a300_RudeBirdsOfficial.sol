...
contract RudeBirdsOfficial is ERC721Enumerable, Ownable { // contract name to yours
  ...
  uint256 public cost = 150 ; // change price per unit
  ...
  uint256 public maxMintAmount = 211; // max allowed to mint at one time N.O.T.E must be => than line 1241 - mint(msg.sender, 10);
