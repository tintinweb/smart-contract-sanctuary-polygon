...
/*
    Museo tokenomics:
        ...
        - Max TX: 2,500,000 (.25%)
        - Min TX: 1 
        - 4% fee is automatically added to the liquidity pool on buys/sells
        - 4% fee goes to a "developer address" on sells only
*/

contract Museo is Context, IERC20, Ownable {
    ...
    /* Naming */
    string private _name = "Museo";
    string private _symbol = "MSE";
    ...
    uint256 private _tTotal = 10**9 * _decimalFactor; // Tokens total
    ...
    uint256 public _maxTxAmount = 25 * 10**5 * _decimalFactor;
