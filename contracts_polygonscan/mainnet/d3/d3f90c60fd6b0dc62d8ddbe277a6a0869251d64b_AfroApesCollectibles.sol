...
contract AfroApesCollectibles is ERC1155, Pausable, Ownable {
    ...
    constructor() ERC1155("https://api.afroapes.com/v1/collections/afro-apes-collectibles/{id}"){
    ...
    function mintMany(address[] memory accounts, uint256 id, uint256 amount) public onlyOwner {
