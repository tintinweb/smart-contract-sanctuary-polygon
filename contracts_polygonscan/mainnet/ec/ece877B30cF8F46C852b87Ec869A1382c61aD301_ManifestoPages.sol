...
// INCLUDED IS THE SOURCE CODE FOR THE WEB3 FASHION MANIFESTO ON THE MATIC NETWORK
// SPDX-License-Identifier: DO WHATEVER THE FUCK YOU WANT WITH THIS!
// still has some random digitalax naming, that's ok, it's part of the story i guess, also no time to change all that 
/**
 ...
 */
contract ManifestoPages is DigitalaxERC721("ManifestoPages", "MFP"), ERC1155Receiver, IERC998ERC1155TopDown, BaseChildTunnel, BaseRelayRecipient, Initializable {
