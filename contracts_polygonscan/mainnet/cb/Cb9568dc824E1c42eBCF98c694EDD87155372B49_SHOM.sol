...
contract SHOM is ERC20Permit, Ownable {
    ...
    constructor() ERC20("SHOM", "sHOM", 9) ERC20Permit() {
    ...
    /**
        @notice increases SHOM supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess SHOM
