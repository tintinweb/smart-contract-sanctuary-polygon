...
contract SpeakerHeadsLIVE is ERC1155, ERC1155Supply, Ownable {
    ...
    function addToken(string memory _name, string memory _metadataUrl, uint256 _maxSupply) public onlyOwner {
        require(_maxSupply > 0, "Invalid maxSupply");
        uint256 newTokenId = totalTokens;
        SpeakerToken memory token = SpeakerToken(_maxSupply, 0, _name, _metadataUrl);
