...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x470b2e24fC4B51fe7664DDE1B6CcaA9f1F37aE00;
...
contract BitblocksDAO is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 244400000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BitblocksDAO";
    string private _symbol = "XBBX";
    ...
    uint256 public _maxTxAmount = 244400000 * 10**18;
