...
contract MintPass is ERC721EnumerableUpgradeable,  AccessControlUpgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function initialize(string memory name, string memory symbol, string memory uri, address tokenAddress) public virtual initializer {
        ...
        contractMeta = "https://jrmeta.niftyunderground.app/ipfs/QmeQPN85QSrbo3rMYTkisz1W8yDdejRaRtekm1AU9v7dQE";
    ...
    */
    ...
    // Need a method to take an address and return a list of tokens the address owns.
    function getTokensByOwner(address owner) public view returns (uint256[] memory) {
        uint256[] memory result = new uint256[](100);
        uint256 index;
        for (index = 1; index < _tokenIds.current(); index++) {
            if (owner == ownerOf(index)) {
                result[index] = index;
            }
        }
        return result;
