...
library LibRoyalties2981 {
    ...
    function calculateRoyalties(address _to, uint256 amount) internal view returns (LibPart.Part[] memory) {
...
contract TheLostSocks is ERC721, Ownable, RandomlyAssigned, RoyaltiesV2Impl {
  using Strings for uint256;
  ...
  string public baseURI = "ipfs://QmQGvJRjUqozepFxHfbjq72uKfuiEf9LZpjokEMgmjAPS4/";

  constructor() 
    ERC721("TheLostSocks", "TLS")
