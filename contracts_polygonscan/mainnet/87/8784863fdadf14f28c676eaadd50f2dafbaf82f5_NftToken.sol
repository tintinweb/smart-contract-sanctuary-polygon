...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _safeMint(
        ...
        _mint(to, tokenId);
        tokenURIList[tokenId] = _tokenURI;
        require(
...
contract NftToken is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    constructor(string memory name_, string memory symbol_,uint256 _startNum) ERC721(name_, symbol_) Ownable() {
        addMiner(msg.sender);
    ...
    function mintForMiner(address _to,string memory _tokenURI) public nonReentrant returns (bool, uint256) {
        require(MinerList[msg.sender] == true, "e002");
        require(_to != address(0), "e003");
        tokenIdNow = tokenIdNow + 1;
        _safeMint(_to, tokenIdNow, _tokenURI);
        return (true, tokenIdNow);
    }
    
    
     //**https://xx.com/api/123.json
     function MassMintForMiner0(address _to,uint256 num,string memory _MetaStr) public nonReentrant returns (bool) {
        require(MinerList[msg.sender] == true, "e002");
        require(_to != address(0), "e003");
      ...
      //**https://xx.com/api/123*
      function MassMintForMiner1(address _to,uint256 num,string memory _baseStr) public nonReentrant returns (bool) {
        require(MinerList[msg.sender] == true, "e002");
        require(_to != address(0), "e003");
