    ...
    AccessControl
{
    ...
    // Event
    event welcomeToT2M(uint256 indexed id);
    ...
    uint256 public walletRestrictionCount = 1;

    //Set release limit count
    uint256 public releaseLimit = 100;
    ...
    // Set release limit
    function setReleaseLimit(uint256 _releaseLimit) public onlyOwner {
    ...
    function safeMint(
        ...
        require(totalSupply() < MAX_SUPPLY, "Total supply is ex");
    ...
    function publicMinting(
        ...
        require(totalSupply() < releaseLimit, "Limit is existed..");
        require(totalSupply() < MAX_SUPPLY, "Total supply is ex");
        require(!nftExists[_tokenURI]);
        nftList.push(_tokenURI);
