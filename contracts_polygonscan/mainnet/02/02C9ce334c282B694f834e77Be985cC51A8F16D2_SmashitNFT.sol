...
contract SmashitNFT is ERC721URIStorageUpgradeable, OwnableUpgradeable {
    ...
    function initialize(string memory name_, string memory symbol_, string memory _URI) external initializer {
        baseURI = _URI;
