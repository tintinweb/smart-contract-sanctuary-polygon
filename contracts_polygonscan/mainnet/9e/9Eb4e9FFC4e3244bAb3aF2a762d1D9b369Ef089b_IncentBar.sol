...
// File contracts/IncentBar.sol


// NOTE: used code from sushiswap https://etherscan.io/address/0x8798249c2E607446EfB7Ad49eC89dD1865Ff4272#code

pragma solidity ^0.8.0;

contract IncentBar is ERC20 {
    IERC20 public token;

    constructor(IERC20 _token, string memory name, string memory symbol) ERC20(name, symbol) {
        token = _token;
    }
