...
contract BdapContract is ERC1155, Ownable, ERC2981Base {
    RoyaltyInfo private _royalties;
    
    constructor() ERC1155("ipfs://Qmd7nFBBGK9U27dKaUnyLUeuqECNxckQ3u29ZEUBEsm3mC/metadata/{id}.json")
    {
        _royalties = RoyaltyInfo(msg.sender, 2500);
    ...
    function contractURI() public pure returns (string memory) {
        return
            "ipfs://Qmd7nFBBGK9U27dKaUnyLUeuqECNxckQ3u29ZEUBEsm3mC/metadata/contract.json";
    }

    // Value is in basis points so 10000 = 100% , 100 = 1% etc
    function _setRoyalties(address recipient, uint256 value) internal {
        require(value <= 2500, 'ERC2981Royalties: Too high');
