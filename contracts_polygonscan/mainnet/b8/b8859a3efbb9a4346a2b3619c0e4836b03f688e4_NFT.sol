...
contract NFT is ERC721Enumerable, Ownable {
  ...
  address payable commissions = payable(0x8dD89D378d878dea0843ECBEFA8EA8Ab2030cafE); // адрес куда будут поступать коммисии с перепродаж ваших нфт, вместо моего адреса напиши свой
  ...
  //}
    ...
    constructor()
     ERC721("123 NFT", "123NFT") {
    setBaseURI("ipfs://QmXGvXEUyQKhDS3oj3Z9mRdNuKSpS3UtXHrTdwnVVqT9U1/");
 //   setNotRevealedURI(_initNotRevealedUri);
  }
