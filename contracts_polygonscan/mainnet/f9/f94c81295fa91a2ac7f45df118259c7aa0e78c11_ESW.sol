...
contract ESW is ProxiedERC20, Initializable, Priviledgeable {    
    ...
    string public codeVersion = "ESW-matic v1.1-244-g12a4a3c"; 
    ...
    /*********************** admin functions *****************************/
    function getEmilistWallet() public view onlyAdmin returns(address) {
        return(_emiList);
    }
    ...
    function mint(address walletTo, uint256 amount) public onlyAdmin {
        require(
            totalSupply().add(amount) <= MAXIMUM_SUPPLY,
            "ESW-matic:supply_exceeded"
        );
        super._mint(walletTo, amount);
    }
}