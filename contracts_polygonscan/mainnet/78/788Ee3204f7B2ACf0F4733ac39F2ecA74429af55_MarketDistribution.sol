...
contract MarketDistribution is TokensRecoverable, IMarketDistribution
{
    ...
    address signedMarketingWallet = 0x6AB2c06c6AFB288B6709bFb85f6eA3fCc9822067;
        ...
        uint16 _preBuyForMarketStabilizationPercent) public override 
    {
        ...
        // add 5% of supply to liquidityController for Burns, and another 5% for stakeholder rewards, and another 9.1% to the liquidity controller for private sale investors
       rootedToken.transfer(liquidityController, rootedTokenSupply.mul(191).div(1000));//
        
        //transfer 6% of SIGN tokens to signedTrade for Marketing and also 8% for the alloted token allocation per whitepaper.
        rootedToken.transfer(signedMarketingWallet, rootedTokenSupply.mul(16).div(100)); 
        rootedToken.transfer(signedTradeAddress, rootedTokenSupply.mul(8).div(100)); 
        ...
        uint256 devCut = totalBaseTokenCollected * devCutPercent / 10000; //dev cut == 5% of raised matic
        baseToken.transfer(devAddress, devCut);
        //transfer rest of matic to liquidity controller for buybacks and marketing
...
contract RootedToken is LiquidityLockedERC20("Signed", "SIGN")
{
