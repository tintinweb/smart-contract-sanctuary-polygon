...
contract WarbotMarketplace is Ownable  {
    ...
    constructor( address _engineecosystem) {
        ...
        EngineEcosystemContract _ec = EngineEcosystemContract ( _engineecosystem );       
    ...
    function listWarbot ( uint256 _warbotid, uint256 _askingpriceinmatic, uint256 _minimumconsideration ) public {
       ...
       WarbotManufacturer _wm = WarbotManufacturer ( WarbotManufacturerAddress );
    ...
    function acceptOffer ( uint256 _offerid ) public  {
        ...
        require ( Offers[_offerid]._expiration < block.timestamp , "Offer expired" );
    ...
    function setWarbotManufacturerAddress( address _address ) public onlyOwner {
        WarbotManufacturerAddress = _address;
    }
