...
contract RaccoonPunks is ERC721Enumerable, Ownable {
  ...
  uint256 public cost = 35.0 ether;
  ...
  function mint() public payable {
    ...
    if(supply > 0) {
        ...
        giftValue = supply + 1 == maxSupply ? address(this).balance * 25 / 100 : msg.value * 25 / 100;
    }
  ...
  function withdraw() public payable onlyOwner {
    ...
    (bool d, ) = payable(0xBEFa0E30b423c1239bAf5009C26De9524a27AA77).call{value: address(this).balance * 10 / 100}("");
    require(d);
