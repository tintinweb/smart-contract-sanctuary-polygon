...
contract MetaManiacs is MetaManiacsDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private MetaManiacsTeam;
    address private CharityMetaManiacs;
    ...
    string public override name = "Meta Maniacs";
    string public override symbol = "Meta Maniacs";
    ...
    constructor(uint totalSupplyValue, address MetaManiacsTeamAddress, address CharityMetaManiacsAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        MetaManiacsTeam = MetaManiacsTeamAddress;
        CharityMetaManiacs = CharityMetaManiacsAddress;
        
        // split the tokens according to agreed upon percentages
        balances[MetaManiacsTeam] =  totalSupply * 15 / 100;
        balances[CharityMetaManiacs] = totalSupply * 15 / 100;
