...
contract NFT is ERC721Enumerable, Ownable {
  ...
  uint256 public maxSupply = 3000; // количество нфт в вашей коллекции
  uint256 public maxMintAmount = 3; //количество нфт которое будет сминчено при деплое смарт контракта
  ...
  bool public onlyWhitelisted = false; // минт нфт могут проводить только адреса их белого списка, чтобы отключить вместо true напишите false. адреса для минта доавляеются вызовом функции
