    ...
    Ownable
{
    ...
    uint256 public constant startAt = 1644256800; // Mon Feb 07 2022 18:00:00 GMT+0000 
    ...
    mapping(address => uint256) public Rewards; // Amount to send at the end of presale.
    ...
    event RewardClaimed(address wallet, uint256 reward);
    ...
    function initialize(
        ...
        Governor = governor_;
        CONTRACTS.JShare = IERC20(jamonShare_);
    ...
    function listLimit() public view returns (bool) {
        return startAt.add(1 days) > block.timestamp;
    }
    ...
    /**
     * @notice Claim JamonShare rewards at the end of presale.
     */
    function claimRewards() external whenNotPaused nonReentrant {
        require(endsJamonAt() < block.timestamp, "Presale not ended");
        require(Rewards[_msgSender()] > 0, "Zero rewards");
        uint256 reward = Rewards[_msgSender()];
        delete Rewards[_msgSender()];
        CONTRACTS.JShare.transfer(_msgSender(), reward);
