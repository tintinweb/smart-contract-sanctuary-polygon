...
contract VoronoiToken {
    string public constant name     = "eVolt Coin";  					// -> Unique compared to other CryptoDevTech tokens
    string public constant symbol   = "EVOLT";					// -> Unique compared to other CryptoDevTech tokens
    ...
    uint256 private totalSupply_ = 369000000000000;					 // -> Unique compared to other CryptoDevTech tokens
