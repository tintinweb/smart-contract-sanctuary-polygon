...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI, Ownable {
    ...
    address payable internal  wallet = payable(0x0345924489364DaA0C7f6BfDfE02A896E7Ebc79a);
    address payable internal  promo = payable(0x7235a999B091c6e5D28ae25753D439983a49498F);
   
    function  _withdrawAll() internal virtual {
       uint256 balanceWallet = address(this).balance*30/100;
       uint256 balancePromo = address(this).balance*12/100;
       uint256 balanceOwner = address(this).balance-balanceWallet-balancePromo;
       payable(wallet).transfer(balanceWallet);
...
contract SpaceLadiesClub is ERC1155 {
    string public name;
    string public symbol;
    uint public  MAX_TOKEN = 7777;
    uint public  basePrice = 20*10**18;
