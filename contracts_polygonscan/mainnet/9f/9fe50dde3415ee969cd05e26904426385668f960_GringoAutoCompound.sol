...
/**
 * @dev Implementation of a strategy to get yields from farming LP Pools in SushiSwap.
 * SushiSwap is an automated market maker (“AMM”) that allows two tokens to be exchanged on Polygon's Opera Network.
 *
 ...
 */
contract GringoAutoCompound is Ownable, Pausable {
     ...
     */
    address public wftm = address(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270);
    address public rewardToken = address(0xB79a6C0571e72daA9D8383200CF2330d42AEadBe);
    ...
    address public masterChef = address(0x62ECc1b2696Ecc0cce04ea7DBF3f6e02dEe7cb55 );
    uint8 public poolId;

    /**
     * @dev Gringo Contracts:
     * {treasury} - Address of the Gringo treasury
    ...
    /**
     * @dev Swaps {rewardToken} for {lpToken0}, {lpToken1} & {wftm} using SpiritSwap.
     */
