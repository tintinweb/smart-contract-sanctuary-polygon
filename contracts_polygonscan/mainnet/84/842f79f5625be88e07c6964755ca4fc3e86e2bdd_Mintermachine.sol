...
contract Mintermachine is Ownable, ERC721Enumerable, ReentrancyGuard {
  ...
  uint public nftprice = 1790*(10**18); //thats means 1 matic but this var is not using right now.
  uint256 public minPrice  = 10**18;
  address payable private manager;
  uint256 mintdate = 13949060;

  constructor() ERC721("Minter Machine", "ANTMINER S19 XP") {manager = payable(msg.sender);}
  ...
  string private _baseTokenURI = 'https://gateway.pinata.cloud/ipfs/QmPZrZwECRjGmsTCyKuVfDXRXTXdqt82NBd5C83Ffp7KkK';
