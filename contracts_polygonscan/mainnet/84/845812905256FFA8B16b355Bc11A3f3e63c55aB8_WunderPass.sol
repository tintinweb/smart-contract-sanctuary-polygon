...
// File contracts/external/WunderSafeMath.sol
...
/**
 * @title WunderSafeMath
 * @dev Math operations with safety checks that revert on error
 * Combination of GnosisSafeMath and SafeMath of OpenZeppelin, renamed to WunderSafeMath to avoid conflicts
 * WARNING: This contract should not be used with solidity compiler version  under 0.8.0, because as build on 
 * SafeMath from openzeppelin, it relys on a function that came in with 0.8
 * TODO from Gnosis: remove once open zeppelin update to solc 0.5.0
 */
library WunderSafeMath {
    /**
...
contract WunderPass is ERC721, VRFConsumerBase, AccessControl, Ownable, Pausable {
    ...
    /// @dev Just send us an email at [email protected] with the subject: "WunderPass Smart Contract"
}