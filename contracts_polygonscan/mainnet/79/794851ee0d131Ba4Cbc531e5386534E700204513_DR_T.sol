...
contract DR_T is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public cost = .00000075 ether;
  uint256 public maxSupply = 4999;
  uint256 public maxMintAmount = 4000;
  uint256 public nftPerAddressLimit = 10;
  bool public paused = false;
  bool public revealed = false;
  bool public onlyWhitelisted = true; //format to enter white listers ["xxx","xxxx"]
