...
// File: contracts/BehindNeonMasksT.sol



/**
    Documentation used for this contract:
        HashLips    => https://github.com/HashLips
        DEXExchange => https://github.com/DEXExchange/ERC721-NFT-OptmizedGas-WhitelistMapping/blob/main/BAACGenesis.sol
    
    Most of the reaserch has been done on: 
                                        https://ethereum-blockchain-developer.com/, 
    Royalties part has been implemented from: 
                                        https://ethereum-blockchain-developer.com/

    *********************************************************
    ************DO YOUR OWN RESEARCH !!!!********************
    *****NEVER TAKE FOR GRANTED WHAT IS OUT THERE !!!!!******                                    
    *********************************************************
*/
...
contract BehindNeonMasks is ERC721, Ownable, ReentrancyGuard, RoyaltiesV2Impl  {
...
function walletOfOwner(address _owner)
    ...
    returns (string memory)
  {
    ...
    return bytes(currentBaseURI).length > 0
        ? string(abi.encodePacked(currentBaseURI, Strings.toString(_tokenId), uriPrefix))
        : "";
  }
