...
contract NFTStakingRewards is ReentrancyGuard, Ownable {
    ...
    function stake(uint256 tokenId) external nonReentrant updateReward(msg.sender) {
        ...
        IERC1155(stakingNFTCollection).safeTransferFrom(msg.sender, address(this), tokenId, 1, "");
    ...
    function withdraw(uint256 tokenId) public nonReentrant updateReward(msg.sender) {
        ...
        IERC1155(stakingNFTCollection).safeTransferFrom(address(this), msg.sender, tokenId, 1, "");
