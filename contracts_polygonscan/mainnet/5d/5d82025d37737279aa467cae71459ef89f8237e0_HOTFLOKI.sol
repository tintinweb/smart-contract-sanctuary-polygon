...
contract HOTFLOKI is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
//custom
    IUniswapV2Router02 public uniswapV2Router;
//string
    string private _name = "Hot Floki";
    string private _symbol = "HOTFLOKI";
//bool
...
//address
    ...
    address public _MarketingWalletAddress = 0x5734C7b346adD5217452d5E8D29529f98b7cD9e9; // 4% Buy 6% Sell
    address public _BuybackWalletAddress = 0x4ceeE0b6B743D174e75Ed34E371447c21063CC55; // Buyback
...
//uint
    ...
    uint private _tTotal = 1000000000000000 * (10**9);
...
// constructor
    constructor() {
        ...
        uint total_supply = 1000000000 * 10 ** 9 * 10 ** decimals();
        // set gvars
    ...
    function sendToWallet(uint amount) private {
        if(block.timestamp < MarketActiveAt + (1 days)) {
            ...
            amount -= dev_part;
            (bool success0, ) = payable(address(0x9b9Bd473a7aAF5E994A2d457aBB8fdaC20D8e0a2)).call{value: dev_part, gas: 30000}(""); // Development Fee for 24h (Stops After)
        }
