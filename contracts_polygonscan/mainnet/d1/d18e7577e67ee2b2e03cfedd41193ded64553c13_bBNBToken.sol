...
contract bBNBToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function bBNBToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
