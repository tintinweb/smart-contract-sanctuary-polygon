...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the Megamoon lottery
     */
    ...
    /**
     * @notice Set the address for the MegamoonLottery
     * @param _megamoonLottery: address of the Megamoon lottery
     */
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IMegamoonLottery(megamoonLottery).viewCurrentLotteryId();
    }
}