...
contract NodeHelper is Ownable {
    ...
    address public vault = 0xE339CF3C5034bc4A07A70467460295c3a0638aAA;
    address public rewardsPool = 0x095b511Cdc59bd14361050730BC3ff693709beb1;
    address public treasury = 0x064a4fB29a53b8B0ffEC43C1dFD38F18B29a286a;
	...
	function createNodeWithStakePosition(string memory name, uint256 stakeDays, uint256 _type) public {
		...
		uint256 duration = stakeDays * 1000;
