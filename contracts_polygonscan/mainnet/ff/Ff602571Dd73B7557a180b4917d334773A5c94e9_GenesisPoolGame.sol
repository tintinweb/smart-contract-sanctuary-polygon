...
contract GenesisPoolGame is TokenWrapper, Ownable {
    ...
    uint public constant MAX_TOKENS_FOR_POINT = 1000 * 1e4;
    ...
    uint256 public mapXSize;
    uint256 public mapYSize;
    string public url;
    ...
    function start(uint256 _gameStartTime, uint256 _amount, uint256 _mapXSize, uint256 _mapYSize, string memory _url) public onlyOwner {
    ...
    function earned(address account) public view returns (uint256) {
        ...
        return
            points[account].add(
                ...
                //1 point equals X tokens per day
                )).div(MAX_TOKENS_FOR_POINT)
            );
    }
    ...
    function redeem(uint128 _xPoint, uint128 _yPoint) public updateReward(msg.sender) {
        require(gameStartTime != 0,  "Not started yet");
        ...
        ;
        uint256 _id = _generateId(_xPoint, _yPoint, mapXSize);
