...
contract VVerse is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("VVerse", "VVS") {
    setHiddenMetadataUri("ipfs://__CID__/hidden.json");
    buildings.push(Building("ZERO", 0,0,0,0,0,0));
    buildings.push(Building("Dentist", 1,3,2,2,0,3));
    buildings.push(Building("Cafe", 2,5,4,10,0,6));
    ...
    buildings.push(Building("Bank", 1,3,3,-4,0,2));
    buildings.push(Building("Bakery", 2,5,2,-2,0,5));
    buildings.push(Building("Coffe Shop", 2,6,1,-10,0,4));
    buildings.push(Building("Arcade", 4,1,4,5,0,0));
    buildings.push(Building("Lake Home", 3,1,3,-4,0,-5));
    buildings.push(Building("Library", 2,2,3,-10,0,0));
    buildings.push(Building("Salon", 3,2,2,-3,0,-2));
  }
