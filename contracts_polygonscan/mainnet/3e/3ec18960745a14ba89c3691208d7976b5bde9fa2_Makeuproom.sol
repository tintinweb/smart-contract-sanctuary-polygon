...
//| $$\  $ | $$ /$$__  $$| $$_  $$ | $$_____/| $$  | $$| $$  | $$      | $$  \ $$| $$  | $$| $$  | $$| $$ | $$ | $$
//| $$ \/  | $$|  $$$$$$$| $$ \  $$|  $$$$$$$|  $$$$$$/| $$$$$$$/      | $$  | $$|  $$$$$$/|  $$$$$$/| $$ | $$ | $$
//|__/     |__/ \_______/|__/  \__/ \_______/ \______/ | $$____/       |__/  |__/ \______/  \______/ |__/ |__/ |__/
//                                                     | $$
//                                                     | $$
//
...
// File: contracts/Makeuproom.sol


pragma solidity ^0.8.0;

contract Makeuproom is ERC721, ERC721Enumerable, Ownable {

    using SafeMath for uint256;

    uint256 public constant maxSupply = 5000;
    // MATIC as this contract is being deployed on polygon
    uint256 private _price = 60 ether;
    ...
    constructor() ERC721("Makeup room nft", "MR") {
        _saleStarted = false;
    }
    ...
    // Helper to list all the Divas of a wallet
    ...
    function ownerClaim(uint256 _number, address _receiver) external onlyOwner {
        uint256 supply = totalSupply();
        require(supply + _number <= maxSupply , "Not enough Tokens left.");
