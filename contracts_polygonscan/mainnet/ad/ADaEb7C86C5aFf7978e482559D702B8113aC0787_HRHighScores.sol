...
contract HRHighScores is Ownable {
  ...
  function racersByPage(uint256 page) public view returns (Racer[] memory) {
    uint256 length = racers.length >= page * 1000 ? 1000 : racers.length - ((page - 1) * 1000);
    Racer[] memory list = new Racer[](length);
    uint256 base = page == 1 ? 0 : ((page - 1) * 1000);
  ...
  function hensByPage(uint256 page) public view returns (Hen[] memory) {
    uint256 length = hens.length >= page * 1000 ? 1000 : hens.length - ((page - 1) * 1000);
