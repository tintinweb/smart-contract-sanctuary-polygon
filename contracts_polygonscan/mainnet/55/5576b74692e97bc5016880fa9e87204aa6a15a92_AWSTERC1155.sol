    ...
    PausableUpgradeable
{
    ...
    function initialize() public virtual initializer {
        _name = "Woke Workaholics";
        _symbol = "AWST-WOKE";
        __ERC1155_init("https://artwallstreet.mypinata.cloud/ipfs/");
        __Ownable_init();
    ...
    function mintBatch(
        ...
        _approveBatch(owner(), ids);
        currentTokenID = currentTokenID + ids.length;
    }
    ...
    function giftTransfer(
        ...
        require(
            from == _msgSender() || getApproved(id) == _msgSender(),
    ...
    /**
     * @dev Batch Approve `to` to operate on `tokenId`
     */
    function _approveBatch(address to, uint256[] memory tokenIds)
        internal
        virtual
    {
