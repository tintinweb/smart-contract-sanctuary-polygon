...
contract PixelCritters is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function withdraw() public payable onlyOwner {
    (bool c, ) = payable(0x11c7B2351D416E098d94ca6C0a132d3aCc964cB2).call{value: address(this).balance * 1 / 4}("");
    require(c);
    (bool t, ) = payable(0x53CB72579D94F46208F13D856aA4c241BA41a96D).call{value: address(this).balance * 1 / 4}("");
    require(t);
