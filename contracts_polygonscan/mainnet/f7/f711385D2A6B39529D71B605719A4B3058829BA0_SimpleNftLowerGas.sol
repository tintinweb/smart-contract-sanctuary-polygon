...
contract SimpleNftLowerGas is ERC721, Ownable {
  ...
  constructor() ERC721("CryptoSquaries", "CSQR") {
    setHiddenMetadataUri("ipfs://QmXeECjTcnga9PpgCj6uhU3fcgcvhyw6DCDPFFPT5RyaHB/1.json");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x12af0670F33c46eC755fc35300d6eCE284b8744a).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
