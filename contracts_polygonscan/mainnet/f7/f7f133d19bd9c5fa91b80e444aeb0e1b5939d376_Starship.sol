...
contract Starship is IStarship, ERC721EnumerableUpgradeable, WarpBase {
    ...
    function mint(address _to, uint256 _tokenId) external override {
        ...
        require(msg.sender == starshipControl, 'Not starship control');
    ...
    /** @notice setStarships */
    function setStarshipControl(address _address) external onlyOwner {
        starshipControl = _address;
    }
        ...
        returns (string memory)
    {
        ...
        Ship memory ship = IStarshipControl(starshipControl).getShip(tokenId);
        (, string memory planet) = IStarshipControl(starshipControl).getShipPlanet(tokenId);
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                ...
                                ship.ipfs,
                                '",',
                                '"attributes": [{ "trait_type": "Hull Integrity", "value": "',
                                ship.hullIntegrity.toString(),
                                '", "display_type": "number"},',
                                '{ "trait_type": "Engine Integrity", "value": "',
                                ship.engineIntegrity.toString(),
                                '", "display_type": "number"},',
                                '{ "trait_type": "Bridge Integrity", "value": "',
                                ship.bridgeIntegrity.toString(),
                                '", "display_type": "number"},',
                                '{ "trait_type": "Fuel", "value": "',
                                ship.fuel.toString(),
                                '", "display_type": "number"},',
                                '{ "trait_type": "Ship Integrity", "value": "',
                                (ship.bridgeIntegrity + ship.engineIntegrity + ship.hullIntegrity)
                                    .toString(),
                                '", "display_type": "number"},',
                                ...
                                ship.origin,
                                '"},',
                                '{ "trait_type": "Docked Planet", "value": "',
                                planet,
                                '"}',
                                ']}'
                            )
