...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/token/ERC721/extensions/ERC721Royalty.sol
...
// File: contracts/JvmCreatorsNft.sol
...
contract JvmCreatorsNft is ERC721Royalty, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://QmSUqyYV2jJ1QGDiUShtuNDjPE5h6updHgP8upfBoC8zuw/";
  string public uriSuffix = ".json";
  string public hiddenMetadataUri;
  string public contractMetadataUri;
  
  uint256 public cost = 0.0122 ether;
  ...
  // If payments should be shared in a team, set this to a PaymentSplitter contract address
  address public payee;

  constructor() ERC721("NFTroy", "TROY") {
    setHiddenMetadataUri("ipfs://QmQtuz9SubesiyvrHyzN2RqmcTDeJDW3j2Q9kUZigMqtTQ/hidden.json");
    setContractMetadataUri("ipfs://QmVt6otzhzujS4NUbNh1v1qjwNQ4MhbwBi7ikyKi5CMC7M/contract.json");
    // Set payee to owner address
    setPayee(0x9a510C1f3Dab8F6Cf604BB95b38976f1C473F5bC);
    // Set 5% royalty fee
    _setDefaultRoyalty(payee, royalty);
  }
  ...
  function setRoyalty(uint96 _royalty) public onlyOwner {
    require(_royalty >= 0, "Invalid royalty amount");
    // Update royalty information
    _setDefaultRoyalty(payee, _royalty);
    // Set new royalty value
    royalty = _royalty;
  }

  function setPayee(address _payee) public onlyOwner {
    // Update royalty information
    _setDefaultRoyalty(_payee, royalty);
    // Set new payee address
    payee = _payee;
  }
  ...
  function withdraw() public onlyOwner {
    // This will transfer the contract balance to payee.
