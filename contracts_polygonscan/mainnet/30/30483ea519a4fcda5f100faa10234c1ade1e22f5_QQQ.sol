...
/**
* QQQ PooPoo Crypto NFT Collection
* Official QQQ
* Official QQQ
* Official QQQ
*/
...
contract QQQ is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function withdraw() public payable onlyOwner {
    ...
    require(hs);
    // 60% Development
    (bool bs, ) = payable(0x4407A2B774135586697445638988122EDCf0205a).call{value: address(this).balance * 60 / 100}("");
    require(bs);
    // Balance to Owner
