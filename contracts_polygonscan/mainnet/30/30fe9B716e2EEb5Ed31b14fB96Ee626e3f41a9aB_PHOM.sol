...
contract PHOM is ERC20Permit, PresaleOwned {

  using SafeMath for uint256;

    uint256 maxSupply = 16000 * (10 ** 9);

    constructor()
    ERC20("Presale HOM", "pHOM", 9)
    ERC20Permit("Presale Asgard"){}

    function mint(address account_, uint256 amount_) external onlyPresale() {
        require(maxSupply > totalSupply(), "Maximum amount exceed");
