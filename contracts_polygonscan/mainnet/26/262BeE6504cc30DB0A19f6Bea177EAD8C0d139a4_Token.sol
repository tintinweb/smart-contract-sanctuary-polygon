...
*/
    ...
    uint public _maxWalletHold = _totalSupply/10; //10% of total supply maximum tx amount

    uint public _decimals = 18;
    string public _name = "Llama Token"; 
    string public _symbol = "LLAMA"; 

    address payable public taxAddress = payable(0x33fCA5fCb920b04a5A45F9390e0e088028994212); 
    address payable public rewardsAddress = payable(0xD214c936047072415AeAf7212c7ee012d9338509); 
    address public contractAddress = address(this);
    

    uint public reflectionsFee = 3; //3%
    ...
    constructor() {
        balances[0x33fCA5fCb920b04a5A45F9390e0e088028994212] = _totalSupply - 5000000000000000000000000;
        balances[0xD214c936047072415AeAf7212c7ee012d9338509] = 5000000000000000000000000;
