...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.4.0/contracts/utils/structs/EnumerableSet.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.4.0/contracts/token/ERC1155/extensions/ERC1155Burnable.sol
...
// File: contracts/library/Mintable.sol
...
contract Airdrops is ERC1155Supply, ERC1155Burnable, ERC1155Pausable, Mintable {

    mapping(uint256 => string) private tokenUri;
    
    string constant private _name="Kiki's Airdrops";
    string constant private _symbol="KAD";
    ...
    *  @dev mint a reserve
    */
    function mintReserve(uint256 token, uint256 amount) public onlyMinter {
     ...
     */
    function airdrop(address[] calldata addresses, uint256 token, uint amt_each) public onlyMinter {
