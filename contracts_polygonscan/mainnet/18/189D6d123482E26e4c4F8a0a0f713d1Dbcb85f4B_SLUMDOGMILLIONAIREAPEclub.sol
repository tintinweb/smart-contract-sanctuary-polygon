...
contract SLUMDOGMILLIONAIREAPEclub is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("SLUMDOG MILLIONAIRE APE club", "SLA") {
    setHiddenMetadataUri("ipfs://QmRnVozmV4KzoxKyuU1sh9pd7LoWkTKa3oKVAUf5pmbzLg/hidden.json");
  }
