...
/** 
 *  SourceUnit: d:\GitWork\YorkyNFT\contracts\contracts\YorkyMarket.sol
*/
...
contract YorkyMarket is Ownable, ERC721Holder {
    using SafeMath for uint256;
	using EnumerableSet for EnumerableSet.AddressSet;
	...
	IYorkyNFT public nftCollection;
	...
	uint256 public totalEarning; /* Total Yorky Token */
	...
	constructor (address _governanceToken, 
		...
		nftCollection = IYorkyNFT(_nftCollection);	
	}
    ...
    function buy(uint256 _id) external ItemExists(_id) {
		...
		// transfer Yorky token to adminAddress
