...
contract BorrowedSwap is Ownable {
    ...
    function BorrowandSwap(address _collateralToken, uint256 _collateralAmount,address _borrowedToken, uint256 _borrowedAmount) external returns (uint256 amountOut) {

        TransferHelper.safeTransferFrom(_collateralToken, msg.sender, address(this), _collateralAmount);
