...
/** 
 *  SourceUnit: ..\Museo\contracts\MuseoMarketplace.sol
*/
...
contract MuseoMarket is Ownable, ERC721Holder {
    using SafeMath for uint256;
	using EnumerableSet for EnumerableSet.AddressSet;
	...
	uint256 public totalEarning; /* Total Museo Token */
	...
	constructor (address _governanceToken, 
		...
		nftCollection = IMuseo(_nftCollection);	
	}
    ...
    function buy(uint256 _id) external ItemExists(_id) {
		...
		// transfer Museo token to adminAddress
		...
		// transfer Museo token to creator
